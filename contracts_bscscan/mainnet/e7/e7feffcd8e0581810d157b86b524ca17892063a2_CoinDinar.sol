...
//  CoinDinar - DinarCoin is a Digital assets for a stable currency with Binance Smart Chain Network! This Will become The world’s only enterprise blockchain solution for global payments
...
contract CoinDinar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x52a7E34b73191F587a41e46bc61eD36EF8314d4d); // Marketing Address
    address payable public charityAddress = payable(0x52a7E34b73191F587a41e46bc61eD36EF8314d4d); // Charity/Dev Address
    ...
    string private _name = "DINAR";
    string private _symbol = "DINAR";
