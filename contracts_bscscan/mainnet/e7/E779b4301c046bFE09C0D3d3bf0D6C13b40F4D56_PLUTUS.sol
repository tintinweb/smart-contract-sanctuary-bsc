...
contract PLUTUS is ERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 25000000000 * (10**18);
    uint256 public _maxTxAmount = 25000000000 * (10**18);
    uint256 public _tokenSwapThreshold = 25000000000 * (10**18);
    ...
    constructor() ERC20("PLUTUS CAPITAL HOLDINGS", "PCH") {
...
contract PLUTUSDividendTracker is DividendPayingToken, Ownable {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000000 * (10**18); //must hold 10000+ tokens
    }
