...
contract MrsSafemoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x430F2a07B973EB34A5ED450E5F94e2C373D5a9F1); // Marketing Address
        
    address payable public teamAddress =
        payable(0xbA6Bfa20e0D94A80345d1E4260989d3D36bb0690); // Team Address
        
    address payable public liquidityAddress =
        payable(0xbA6Bfa20e0D94A80345d1E4260989d3D36bb0690); // Liquidity Address
    ...
    string private constant _name = "Mrs.Safemoon";
    string private constant _symbol = "MRSSafe";
