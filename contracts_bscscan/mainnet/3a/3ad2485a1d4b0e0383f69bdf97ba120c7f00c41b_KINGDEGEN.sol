...
library Address{
 ...
 contract KINGDEGEN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x97aE47D5EB8f714cbB9A4453d2AE83499f8eb9dB;
    address public donationWallet = 0x97aE47D5EB8f714cbB9A4453d2AE83499f8eb9dB;

    string private constant _name = "KING DEGEN";
    string private constant _symbol = "$KDEGEN";
    ...
    Taxes public sellTaxes = Taxes(1, 5, 5, 5);
