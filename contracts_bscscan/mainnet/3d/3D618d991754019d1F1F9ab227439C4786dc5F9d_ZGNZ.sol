...
contract ZGNZ is Context, IERC20, Ownable {
    ...
    string private _symbol = "ZGNZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe1743e1421900114aeA253C63C2e7aDC4AB6Cb34); // Marketing Address
    address payable public teamWalletAddress = payable(0x673681d119E03431Aa57093C2e5191ff896828e0); // Team Address
	address public OwnerAddress =0x292aDad7feF44488CDecdc1aDF818eAA9229191D;
