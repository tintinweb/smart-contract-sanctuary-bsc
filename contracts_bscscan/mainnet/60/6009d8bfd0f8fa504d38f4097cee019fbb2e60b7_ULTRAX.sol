    ...
    Ownable
{
        ...
        onlyOwner
    {
        require(
            ...
            "UltraX: The router already has that address"
        );
...
contract ULTRAX is ERC20, Ownable {
    ...
    UltraXDividendTracker public dividendTracker;
    ...
    uint256 public maxSellTransactionAmount = 1000 * (10**9);
    uint256 public maxWalletBalance = 2000 * (10**9);
    ...
    uint256 public liquidityFee = 7; // This fee must be a TOTAL of LP, Marketing Fee AND Buyback fee (Note, Buyback has been disabled)
    ...
    constructor() ERC20("ULTRA-X", "UTX", 9) {
        dividendTracker = new UltraXDividendTracker();
        ...
        onlyOwner
    {
        require(
            ...
            "UltraX: setWhiteListAMM:: AMM is a wallet, not a contract"
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "UltraX: The dividend tracker already has that address"
        );

        UltraXDividendTracker newDividendTracker = UltraXDividendTracker(
                payable(newAddress)
            );

        require(
            newDividendTracker.owner() == address(this),
            "UltraX: The new dividend tracker must be owned by the UltraX token contract"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "UltraX: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "UltraX: The liquidity wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "UltraX: The marketing wallet is already this address"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(
            ...
            "UltraX: The buyback wallet is already this address"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "UltraX: updateFees:: Liquidity Perc must be equal to or higher than marketing and buyback combined."
        );
        emit FeesUpdated(
            bnbRewardPerc,
            liquidityPerc,
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "UltraX: gasForProcessing must be between 200,000 and 600,000"
        );
        require(
            newValue != gasForProcessing,
            "UltraX: Cannot update gasForProcessing to same value"
        );
    ...
    function setRewardToken(address rewardTokenAddress) public returns (bool) {
        require(
            ...
            "UltraX: setRewardToken:: Address is a wallet, not a contract."
        );
        require(
            rewardTokenAddress != address(this),
            "UltraX: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        );
        require(
            !isIgnoredToken(rewardTokenAddress),
            "UltraX: setRewardToken:: Reward Token is ignored from being used as rewards."
        );
    ...
    function setRewardTokenWithCustomAMM(
        ...
        require(
            ammContractAddress != address(uniswapV2Router),
            "UltraX: setRewardToken:: Use setRewardToken to use default Router"
        );
        require(
            rewardTokenAddress != address(this),
            "UltraX: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        ...
        require(
            ...
            "UltraX: setRewardToken:: AMM is not whitelisted!"
        );
        dividendTracker.setRewardToken(
            msg.sender,
            rewardTokenAddress,
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(
            ...
            "UltraX: buyBackTokensWithNoFees:: Cannot Spend more than earned."
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "UltraX: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function swapAndLiquify(uint256 tokens) private {
        if (liquidityFee > 0) {
            ...
            if (marketingFee > 0) {
                ...
                require(
                    success,
                    "UltraX: SwapAndLiquify:: Unable to send BNB to Marketing Wallet"
                );
            }
            ...
            if (buyBackFee > 0) {
                ...
                require(
                    success,
                    "UltraX: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet"
                );
            }
...
contract UltraXDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken(
            "UltraX_Dividend_Tracker",
            "UltraX_Dividend_Tracker",
            9
        )
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100 * (10**9); //must hold 100+ tokens to get dividends
    }
    ...
    function _transfer(
        ...
        require(false, "UltraX_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "UltraX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UltraX contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "UltraX_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "UltraX_Dividend_Tracker: Cannot update claimWait to same value"
        );
