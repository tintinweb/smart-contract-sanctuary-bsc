...
// CHANGE
contract BabyMetaRuffy  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMetaRuffy";
    string constant _symbol = "BMRUFFY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 200,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2B02d8670D646f986CDf13e67456b4a7299a63C9); // Change
