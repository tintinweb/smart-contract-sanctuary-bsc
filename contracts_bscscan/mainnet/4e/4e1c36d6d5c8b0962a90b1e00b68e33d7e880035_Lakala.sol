...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Lakala shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract Lakala is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Lakala";
    string private constant _symbol = "Lakala";
    ...
    address payable public marketingWallet = payable(0xd753a28BBc60aE4e4A62bAf882896903b2057C3b);
    address payable public treasury = payable(0x49260E90cfCBC2Ab54197f53386E1f4205131528);
    ...
    constructor (    ) Auth(0x87284C2753a13475066e292DC36543f1d8A28A98) {
        address _owner = 0x87284C2753a13475066e292DC36543f1d8A28A98;
