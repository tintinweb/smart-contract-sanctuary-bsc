...
contract SUPERCHARGERCHEEMSINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPERCHARGER CHEEMS INU";
    string private _symbol = "SUPERCINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC32B3055E2A57356ed379c83DD4b3B64c765d0AD); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC32B3055E2A57356ed379c83DD4b3B64c765d0AD); // buyback Address
