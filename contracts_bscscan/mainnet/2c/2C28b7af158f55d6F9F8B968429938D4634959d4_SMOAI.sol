...
contract SMOAI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xF385774F03b51C793a1232171CC894831d76ac55));
    address payable public devWallet =
        payable(address(0xc2d3524b0C44AF08Cb4CD0F2a2635329235D3D19));
    address public liquidityReceiver =
        0xA236754A5D5b894Ed4E29A7E0c2c208C2EbDfD39;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "SMOAI";
...
Decimals: 9
Telegram: https://t.me/smoaitoken
Website: https://smoaitoken.ml
