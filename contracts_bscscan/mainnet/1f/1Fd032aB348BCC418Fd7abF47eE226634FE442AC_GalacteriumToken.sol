 ...
 *
 */
contract GalacteriumToken is ReleasableToken, MintableToken, UpgradeableToken {
   ...
   * @param _guardianMasterWallet Wallet tokens will be minted to and ownership of token must be set to this wallet
   */
  constructor(string _name, string _symbol, uint _initialSupply, uint _decimals, bool _mintable, address _guardianMasterWallet) public
    ...
    balances[_guardianMasterWallet] = totalSupply;
    emit Minted(_guardianMasterWallet, totalSupply);
    emit Transfer(address(this), _guardianMasterWallet, totalSupply);
