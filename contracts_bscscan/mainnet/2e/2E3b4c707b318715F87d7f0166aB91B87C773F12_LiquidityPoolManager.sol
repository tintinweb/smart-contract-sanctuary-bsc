...
UniverseImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x1b132a8402582B7c13fEFBE8EBaC385075d3ccAb), // Treasury investments (30%)
        address(0xAE4a179E93186d2C7948451349E885FF6faf9cCa), // Dev (30%)
        address(0x140966AaEed3175ad4c115BD74375183de39c5f1), // Marketing (30%)
        address(0x4A7f71d42a1f7c481B12d24d7F86d5b40Ee61CB1) // Buyback (10%)
    ];
    ...
    function createPairWith(address[2] memory path) private returns (IUniswapV2Pair) {
...
abstract contract UniverseImplementationPointer is Ownable {
    ...
    modifier onlyUniverse() {
        require(
            ...
            "Implementations: Astralis is not set"
        );
        address sender = _msgSender();
        require(
            sender == address(universe),
            "Implementations: Not Astralis"
        );
        _;
    }
