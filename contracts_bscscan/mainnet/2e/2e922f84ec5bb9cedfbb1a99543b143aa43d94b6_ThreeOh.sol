...
contract ThreeOh is Ownable {
    ...
    uint256 public maxWalletHolding = 875 * 10**7 * 10**9;
    uint256 public maxTxLimit = 175 * 10**7 * 10**9;
    ...
    constructor (address payable _devWallet, address payable _advocacyWallet, address _marketingDevWallet) public {
      dev = _devWallet;
    ...
    function setLimits(uint256 _maxTxLimit, uint256 _maxWalletHolding) public onlyOwner() {
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
          ...
          if (from == uniswapV2Pair) {
            require(amount < maxTxLimit, "Max Transaction Buy Limit exceeded");
