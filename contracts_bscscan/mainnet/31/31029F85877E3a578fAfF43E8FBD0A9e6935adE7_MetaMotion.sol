...
contract MetaMotion is IBEP20, Auth {
    ...
    string constant _name = "MetaMotion";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 1) / 50;  
    ...
    address private marketingFeeReceiver = 0x5e54AD524F2419b9bea0110631fe4E6eb8F826D3;
    address private buybackFeeReceiver = 0x5e54AD524F2419b9bea0110631fe4E6eb8F826D3;
    ...
    uint256 public swapThreshold = 1000 * 10**6 * 10**9; // 0.3%
    bool inSwap;
