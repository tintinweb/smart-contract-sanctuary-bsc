...
/**
OnlyOneToken Official!

10% Buy/Sell tax

NO Max wallet 
NO Max buy/sell 
Based DEV / https://t.me/theonlyonetoken
...
contract OnlyOneToken is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "OnlyOneToken";
    string constant _symbol = "O1T";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * (10 ** _decimals); 
    uint256 public _maxTxAmount = (_totalSupply * 900) / 1000; 
    uint256 public _maxWalletSize = (_totalSupply * 900) / 1000; 
    ...
    uint256 public swapThreshold = _totalSupply / 900;
    bool inSwap;
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x6A297a5640b1a1b41A23C17a1a1B1E927dFE7023);
