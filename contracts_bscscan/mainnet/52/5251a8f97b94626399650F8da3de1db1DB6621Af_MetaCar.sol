...
contract MetaCar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tumbling dog";
    string private _symbol = "Tumbling dog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD46330e34bfE72234C6F2c4Cb7bc081d4ee6C65C);
    address payable public teamWalletAddress = payable(0xD46330e34bfE72234C6F2c4Cb7bc081d4ee6C65C);
