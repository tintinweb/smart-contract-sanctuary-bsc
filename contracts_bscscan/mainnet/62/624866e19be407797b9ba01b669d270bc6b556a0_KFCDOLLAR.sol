...
library Address{
 ...
 contract KFCDOLLAR is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7d0D5e2B1C453709237108d37a6C35877565935A;
    address public donationWallet = 0x7d0D5e2B1C453709237108d37a6C35877565935A;

    string private constant _name = "KFC Dollar";
    string private constant _symbol = "KFCD";
