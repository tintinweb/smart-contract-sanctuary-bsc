...
contract YMF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yao Ming Fan";
    string private _symbol = "YMF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9598837Be720a0805D9341Aa4c2e067f22D1C57); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xA9598837Be720a0805D9341Aa4c2e067f22D1C57); // buyback Address
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**9; // 0.1%
