...
contract DONTBUY is Context, IBEP20, Ownable {
    ...
    string private _symbol = "DONT BUY";                                 
    ...
    uint256 public maxTransactionAmount = _tTotal * 1 / 100; // 1.0% maxTransactionAmount
    ...
    address public  pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   // Pancake Router Version 2 addres
   ...
   function excludeFromMaxWallet(address account) public onlyOwner {
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "$DNB is not live yet");
