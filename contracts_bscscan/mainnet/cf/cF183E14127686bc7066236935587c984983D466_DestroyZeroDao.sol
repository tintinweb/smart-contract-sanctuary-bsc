...
contract DestroyZeroDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DestroyZeroDao";
    string private _symbol = "DZD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x575E98ccC40d271Ab433d0eAf9fFC3785B84B956); // Marketing Address
    address payable public teamWalletAddress = payable(0xeA6812985790681d1A861BFc344c72B098A5d13f); // Team Address
    ...
    uint256 private _totalSupply = 10 *  10**16 * 10**_decimals;
