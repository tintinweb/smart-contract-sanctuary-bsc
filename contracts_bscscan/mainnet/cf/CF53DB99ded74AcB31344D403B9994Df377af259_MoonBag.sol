...
contract MoonBag is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2Aa634391463F02e6dF90d67a62F749543A2AD68);//
    address payable private _marketingAddress = payable(0x14cF4419e60eDC8e217ce7847bb00E3b6Ad4e837);//
    ...
    uint256 public _maxTxAmount = 1000000 * 10**12; // 1% of supply
    uint256 public _maxWalletSize = 1000000 * 10**12; // 1 % of supply
