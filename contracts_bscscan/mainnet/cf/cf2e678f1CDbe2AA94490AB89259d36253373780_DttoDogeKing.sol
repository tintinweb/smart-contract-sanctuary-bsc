...
contract DttoDogeKing  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DttoDogeKing";
    string private _symbol = "DDK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7159C401f85342E94ccEEF5f6D6fbD0d8E5b214e); // Marketing Address
    address payable public teamWalletAddress = payable(0x2EBc978e411FAEabBAfb3C163c940090d8B2D4d5); // Team Address
