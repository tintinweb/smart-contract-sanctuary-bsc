...
contract TTSKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TTSKing";
    string private _symbol = "TTSKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbfb5e8F2C9787330ce6Ae8bd0839B7e8F6a401d8);
    address payable public teamWalletAddress = payable(0xF37c15fEB2Fb0A73991193D7edc2345F7b07bF70);
