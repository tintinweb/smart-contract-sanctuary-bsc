...
/**
//// DogeFlame - the hottest Doge Token
//// DogeFlame.io 
//// 5% BUSD rewards, 3% liquidity, 2% marketing - launching Wednesday 9 February
//// 
*/
...
contract DogeFlame is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x9Fb9F83032D1Cb709f8b859CBcDcc805FD693513;
 
    string constant _name = "DogeFlame";
    string constant _symbol = "DOGEFLAME";
    uint8 constant _decimals = 6;
 
    uint256 _totalSupply = 1 * 10**16 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 9 / 100;
 
    uint256 public _maxWalletToken = ( _totalSupply * 9 ) / 100;
