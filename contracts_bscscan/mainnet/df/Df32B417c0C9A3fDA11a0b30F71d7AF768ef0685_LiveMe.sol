...
library Address{
 ...
 contract LiveMe is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA09b5D8FFAD950e142303e742ffD3e51c606270A;
    address public developmentWallet = 0xA09b5D8FFAD950e142303e742ffD3e51c606270A;

    string private constant _name = "LiveMe";
    string private constant _symbol = "LiveMe";
    ...
    Taxes public sellTaxes = Taxes(3, 7, 2, 5);
