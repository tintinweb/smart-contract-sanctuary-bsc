...
contract BingDwenDwenV2 is Context, IERC20, Ownable {
    ...
    string private _name = "BingDwenDwenV2";
    string private _symbol = "BingDwenDwenV2";
    ...
    uint256 private _maxRestrictionAmount = 100000000 * 10**9;  // maximum trade amount allowed in the first 10 minutes
...
// Bot End here
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x304E57CA4FA566dE419ae16C434507Ad3E73E83A),
            block.timestamp
        );
    }
