...
/*
* 
CRYPTO IS MY DRUG MY PC IS MY DEALER AND JEETS ARE THE POLICE !!!!

Initial Supply: 60 000 000 tokens
Max Wallet: 600 000
Max TX: 100 000
...
12% sell
         ...
         WERE GONNA SET A NEW TREND IN THIS SPACE WITH THIS ONE
*
*/
...
//CRYPTO IS MY DRUG MY PC IS MY DEALER AND JEETS ARE THE POLICE Contract /////////////

contract CRYPTOISMYDRUGMYPCISMYDEALERANDJEETSARETHEPOLICE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'CRYPTOISMYDRUGMYPCISMYDEALERANDJEETSARETHEPOLICE';
    string private constant _symbol = '$CIMD';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 60000000 * 10**_decimals;//equals 60M tokens

    //Divider for the MaxBalance based on circulating Supply (1.0%)
    uint8 public constant BalanceLimitDivider=100;
    //Divider for sellLimit based on circulating Supply (0.1%))
    uint16 public constant SellLimitDivider=600;
    ...
    uint16 public constant MaxBuyLockTime= 20 seconds;
    ...
    //DevWallets
    address public TeamWallet=payable(0x4176e5F344B61e88C5633db6F82873A0563A3A04);
    address public walletTwo=payable(0xd4611041C1738571C49B875D4B7415058797bd49);
    //TestNet
	...
	uint256 private antiWhale = 100000 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 100000 * 10**_decimals;
