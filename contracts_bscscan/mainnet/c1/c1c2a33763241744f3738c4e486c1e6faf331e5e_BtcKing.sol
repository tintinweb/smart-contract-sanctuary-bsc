...
interface IUniswapV2Pair {
    ...
    function _price0CumulativeLast() external view returns (uint);
    function _price1CumulativeLast() external view returns (uint);
    ...
    function _price(address token, uint256 baseDecimal) external view returns (uint256);
...
contract BtcKing is Context, IERC20, Ownable {
    ...
    address public devAddress = address(0xE13Ce5D354387b30237d3C8245789D8e8381F7A0);
