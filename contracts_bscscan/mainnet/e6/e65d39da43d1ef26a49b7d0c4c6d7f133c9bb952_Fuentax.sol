...
contract Fuentax is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "FUENTAX";
    string private constant _symbol = "FUEN";
    ...
    address payable private _developmentAddress = payable(0x246453451a2bFd1509be781DDc28d0623215F009);
    address payable private _marketingAddress = payable(0x6D389f9c95cD824f79d64865500CCBd8e8f45F5a);
