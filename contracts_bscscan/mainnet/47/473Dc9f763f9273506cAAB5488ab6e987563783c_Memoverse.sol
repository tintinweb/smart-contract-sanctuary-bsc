...
contract Memoverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x1024574D339ea9908fd4d0676b916d7F75e1DE89); 
    address payable public developmentAddress = payable(0x1024574D339ea9908fd4d0676b916d7F75e1DE89); 
    address payable public charityAddress = payable(0x1024574D339ea9908fd4d0676b916d7F75e1DE89); 
    address payable public vaultRewardAddress = payable(0x1024574D339ea9908fd4d0676b916d7F75e1DE89); 
    address payable public liquidityWallet = payable(0x1024574D339ea9908fd4d0676b916d7F75e1DE89); 
    ...
    uint256 private constant _tTotal = 2000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Memoverse";
    ...
    uint256 public _bMaxTxAmount = 2000000000  * 10**2;
    uint256 public _sMaxTxAmount = 2000000000  * 10**2;
    uint256 private _trigger = 2000000000  * 10**2;
    uint256 private minimumTokensBeforeSwap = 5000  * 10**2; 
    uint256 public buyBackSellLimit = 2 * 10**11;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 2000000000 * 10**2; // 1000000
        _sMaxTxAmount = 2000000000 * 10**2;
    }
