...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x573155D007Cfacdf52b02b95744D42664654aFCc;
...
contract DefPace is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x70B4BF7c971EdfF96EB227973FB544E695504CC7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DefPace";
    string private _symbol = "DPACE";
