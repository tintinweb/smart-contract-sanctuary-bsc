...
contract DOGEKINGWARRIOR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeKing Warrior";
    string private _symbol = "DOGEKINGWARRIOR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2210835Dc5544358f27E66292daCc147960476C2);
    address payable public teamWalletAddress = payable(0x2210835Dc5544358f27E66292daCc147960476C2);
