...
contract DogeLover is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public maxBuybackFee = 11;            // Transaction fee % that would be used to buyback tokens on sell (Hyper-deflation) (0-10)
