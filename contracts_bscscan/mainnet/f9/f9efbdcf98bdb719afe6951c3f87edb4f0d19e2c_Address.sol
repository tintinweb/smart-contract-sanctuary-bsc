...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x18fed6920db824e31c7055da898b16f679e0fadc57bc36b4b000239a5566e95f is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x18fed6920db824e31c7055da898b16f679e0fadc57bc36b4b000239a5566e95f;
...
contract ShibaToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x560E0FD3acb5FC1938A16132Cf4cd37DcaC7FaaA); // Marketing Address
    address payable public DevWalletAddress = payable(0x740866843c54f6469EAF55a9011755AC11540f2B); // Dev Address
    ...
    uint256 public _maxTxAmount = 0; //5000 * 10**6 * 10**9;
    uint256 public _walletMax = 30000 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (40000 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
