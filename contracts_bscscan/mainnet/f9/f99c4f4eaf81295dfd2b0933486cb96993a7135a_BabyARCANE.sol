...
contract BountyDistributor is IBountyDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x477565B356B3973d16e8CD837C6970613f13e24A);
...
contract BabyARCANE is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x477565B356B3973d16e8CD837C6970613f13e24A;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BABY ARCANE";
    string constant _symbol = "BARC";
