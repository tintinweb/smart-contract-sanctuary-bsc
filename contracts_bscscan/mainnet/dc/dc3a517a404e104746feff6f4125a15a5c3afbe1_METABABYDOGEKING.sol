...
contract METABABYDOGEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetababyDogeKing";
    string private _symbol = "MetababyDogeKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA88B9F3B09f2CEf01F76E373FB4a34C943C0CF83); 
    address payable public buyBackWalletAddress = payable(0x71A5062B788EC3655e4A69B9072ae6b9BD301Fa5); 
