...
Tokenomics
    💵 1% Max Buy Tx ( 1,000,000,000 $DPTF )
    💵 0.5% Max Sell Tx ( 500,000,000 $DPTF )
    💰 2% Max Bag ( 2,000,000,000 $DPTF )
...
/* Token contract */
contract Helpmetity is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "Help Me Tity";
    string constant _symbol = "$HELPTITY";
