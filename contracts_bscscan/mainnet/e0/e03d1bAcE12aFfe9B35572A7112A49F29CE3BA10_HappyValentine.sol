...
/*
    ...
    Name: Happy Valentine Inu
    Symbol: HVI
    Telegram HappyValentineInu
    BUY/SELL TAX:
    ===============
    - 2% Liquidity
    - 1% Giveaways
...
contract HappyValentine is IERC20, Ownable {
    ...
    string constant _name = "Happy Valentine Inu";
    string constant _symbol = "HVY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);  // 10,000,000,000
    uint256 public _transferLimit = (_totalSupply * 20) / 2000;  // 2% 
    uint256 public _maxWalletSize = (_totalSupply * 20) / 2000;  // 2% 
