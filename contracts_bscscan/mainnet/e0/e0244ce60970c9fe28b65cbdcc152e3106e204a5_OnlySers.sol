...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC41D1857523063aECb5ca4e992156F4096e6F4F8;
...
contract OnlySers is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7797B223Ef945f3F336c8bACf115Da5e213aD039;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OnlySers";
    string private _symbol = "OSERS";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 900;
