...
// $DINU
//WELCOME TO THE DARK SIDE!!!!!!!!!!!!!"//. www.darthinu.com
...
contract darthinu is Context, IERC20, Ownable {
    ...
    address payable public marketingaddress = payable(0xe08E40b468D50d46EDfbfdb1257F232cd2f04081); // marketing Address
    ...
    // MAX Wallet amount is 1% of the total supply.
    uint256 private maxWalletPercent = 7;
    ...
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 5) / 1000000000;
