...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6cf04A20dD262b9Ce517FFCf1DE1Ae16d82C9ceF;
...
contract TFFCOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x34E76f4eF6722fe63a736F49097F0e3134d313e5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TruckersForFreedom";
    string private _symbol = "TFF";
