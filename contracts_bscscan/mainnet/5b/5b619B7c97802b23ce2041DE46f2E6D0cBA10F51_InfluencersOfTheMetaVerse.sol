...
contract InfluencersOfTheMetaVerse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x95ffdd94b5675bAc2897FD611C4c05C6273f320C); // Marketing Address
    ...
    string private _name = "InfluencersOfTheMetaVerse";
    string private _symbol = "ITMV";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x95ffdd94b5675bAc2897FD611C4c05C6273f320C);
    }
