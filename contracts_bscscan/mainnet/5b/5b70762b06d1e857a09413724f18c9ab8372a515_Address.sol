...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4078ccE651A15232cC6111A5f97e19B40141f00C;
...
contract Example is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2E935CfAa9a9372bF2772d58e70ed05C6D99AEF3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Example Token";
    string private _symbol = "EXMP";
