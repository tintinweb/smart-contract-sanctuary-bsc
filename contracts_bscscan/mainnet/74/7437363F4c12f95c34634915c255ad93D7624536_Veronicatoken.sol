 ...
 */
contract Veronicatoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "VeronicaToken";
    string private _symbol   = "Veron";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xE0d83F87302d70cA6d3f6873De3d2e64B02c1212); // Marketing address used to pay for marketing
    address payable public _charityAddress = payable(0x1C7C548ffa2D2C0A6a09dd97EDC9Db326e244608); // Marketing address used to pay for marketing
    address payable public _prizzeAddress = payable(0xca35D9963d17f14153ff2Adc7f67FfDf74282Aa9); // Marketing address used to pay for marketing
    address payable public _lpAddress      = payable(0xE759ae5B272955d87F9D8Fb3fd85b3Df78C25aA3); // Burn address used to burn a portion of tokens
