...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xfbd57367524B389425C4ADFb5a6F97b0E7ad3690); // SAFUCOIN 0xfbd57367524B389425C4ADFb5a6F97b0E7ad3690
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 5 * 1e7 * 1e18; //must hold 50,000,000+ tokens
    }
...
contract SAFEORACLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SAFEORACLE v2", "SFO"){
        address newOwner = address(0x1d6b2129fd5c93F530e590A9e125e6ac452DcEdf);
    	...
    	marketingWallet = address(0xB7C2a6B3df83520a231F291Bc94BC2064D8657a9); // set as marketing wallet
        charityWallet = address(0xB7C2a6B3df83520a231F291Bc94BC2064D8657a9); // set as charity wallet
        liquidityWallet = address(0x1d6b2129fd5c93F530e590A9e125e6ac452DcEdf); // set as liquidity wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _charityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 2000, "Must keep fees at 20% or less");
    }
