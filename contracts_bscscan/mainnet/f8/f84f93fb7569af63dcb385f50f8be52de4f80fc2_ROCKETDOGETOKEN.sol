 ...
 *🚀 ROCKET DOGE 🐶
  ...
  [$RocketDoge]  | Launching Soon | building holders | LOW Mc💰 | Active SOCIALS 👀| ongoing giveaways | Lp locked  🔐 |⏳ Big Marketing Plans 🙌 - Join the best REWARDS community 

  Welcome to 🚀 ROCKET DOGE 🐕 

 Rocket Doge is on a mission to go to the Moon. Rocket Doge bites harder than all the rewards coins out there, and will attain its rightful spot as top DOG. It's an homage to the meme tokens of old, where the community come together, spread memes and collect rewards. 

  With Rocket Doge you now have the chance to SNAP YOUR LEAD and MOON your way to financial freedom. 🌙 
  Tokenomics:
  Total Supply 100T
  Max TX TBA%, MaxWallet % ❌🐳!! 🔥 

  14% TAX 8% Reward 2% Marketing 4% Liquidity 
...
contract ROCKETDOGETOKEN is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ROCKET DOGE TOKEN";
