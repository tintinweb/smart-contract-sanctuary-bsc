...
/* Token contract */
contract LALALAND is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x22b3C0e6654bFA6a87260a4178813788050c4600;
    ...
    // Name and symbol
    string constant _name = "La La Land";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.5% or 5M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xdd0390E942c890079e0937D25356a43db09a6b4F;
