...
contract Reward is IERC20, Ownable {
    ...
    string constant _name = "Purikyua Inu";
    string constant _symbol = "PURI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1000) / 1000; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 5% MAX 300,000
    ...
    uint256 devFee = 8; // 8%
    uint256 totalFee = 16; // liquidityFee + reflectionFee + devFee
