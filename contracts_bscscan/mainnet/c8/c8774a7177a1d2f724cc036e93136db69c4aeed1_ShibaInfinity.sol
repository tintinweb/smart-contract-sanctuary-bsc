...
contract ShibaInfinity is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shiba Infinity";
    string constant _symbol = "INF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * 10*9 * (10 * _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 4 )  / 1000000000;

    //max wallet holding of 2%
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 1000000000;
