...
contract SuperChargersInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperChargersInu";
    string private _symbol = "SCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8245088A1855073A5532C743209F7E5Ce44aB479); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8245088A1855073A5532C743209F7E5Ce44aB479); // BuyBack Address
