...
contract MCDOGEHAMBURGLAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MCDOGE HAMBURGLAR";
    string private _symbol = "MCDOGEHAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x981145C07cCf5A0CCA5fce22345a30dF1Cc4a424);
    address payable public teamWalletAddress = payable(0x981145C07cCf5A0CCA5fce22345a30dF1Cc4a424);
