...
contract FreeWorldElon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x13aF031196cCF5943F5719e1f106704EF4251996); // Marketing Address
        
    address payable public teamAddress =
        payable(0x96300E296Bf8D7d3f6155B8A04632483B20D6296); // Team Address
        
    address payable public liquidityAddress =
        payable(0x94ADfd71A270A7EF9BaCc48769D442cD798413f7); // Liquidity Address
    ...
    string private constant _name = "FreeWorldElon";
    string private constant _symbol = "FWE";
