...
contract BabyRihanna is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "BabyRihanna";
    string private _symbol = "$RiRi";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0xB0351F88Da722aEeF169f317fD32024F79851Cb2;
    address public _BuybackWalletAddress = 0xB0351F88Da722aEeF169f317fD32024F79851Cb2;
...
//uint
    ...
    uint public minimumTokensBeforeSwap = 500000000 * (10**18);
    uint private MarketActiveAt;
    uint private constant MAX = ~uint256(0);
    uint private _tTotal = 100000000000 * (10**18);
...
// constructor
    constructor() {
        ...
        uint total_supply = 100000000000 * 10 ** decimals();
        // set gvars
