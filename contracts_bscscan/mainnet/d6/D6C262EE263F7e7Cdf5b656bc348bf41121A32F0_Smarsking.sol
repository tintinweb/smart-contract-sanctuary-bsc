...
contract Smarsking is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function swapTokensForRew(uint256 tokenAmount) public {
        ...
        uint old = IERC20(u).balanceOf(address(this));
        ...
        uint newBalance = IERC20(u).balanceOf(address(this));
        uint tempAmount = newBalance - old;
        IERC20(u).approve(address(router), tempAmount);
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tempAmount,
            0,
            path2,
