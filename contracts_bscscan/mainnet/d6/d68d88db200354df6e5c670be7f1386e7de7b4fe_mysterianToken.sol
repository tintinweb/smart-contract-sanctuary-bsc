...
contract mysterianToken is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xD48FD76dC5F48cf01bb3e508dc2BBd3555dE2628));
    address payable public _teamwallet =
        payable(address(0xB7E0cdEC991C59bB60f5276b02345B47896426Ec));
    address _partnershipswallet =
        payable(address(0x9f88Fe045c22b8820d86967570f6DC711d6D89F3));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Mysterian";
