...
|  \  /  \|  \          |  \              |        \                                
| $$ /  $$ \$$  _______ | $$____   __    __\$$$$$$$$______   ______ ____    ______  
| $$/  $$ |  \ /       \| $$    \ |  \  |  \ | $$  |      \ |      \    \  |      \ 
| $$  $$  | $$|  $$$$$$$| $$$$$$$\| $$  | $$ | $$   \$$$$$$\| $$$$$$\$$$$\  \$$$$$$\
| $$$$$\  | $$ \$$    \ | $$  | $$| $$  | $$ | $$  /      $$| $$ | $$ | $$ /      $$
| $$ \$$\ | $$ _\$$$$$$\| $$  | $$| $$__/ $$ | $$ |  $$$$$$$| $$ | $$ | $$|  $$$$$$$
...
contract KishuTamaBSC is KishuTamaETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtKishuTamaETR;
    address private CharityKishuTamaETR;
    ...
    string public override name = "KishuTama";
    string public override symbol = "KISHUTAMA";
    ...
    constructor(uint totalSupplyValue, address TeamtKishuTamaETRAddress, address CharityKishuTamaETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtKishuTamaETR = TeamtKishuTamaETRAddress;
        CharityKishuTamaETR = CharityKishuTamaETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtKishuTamaETR] = totalSupply * 4 / 100;
        balances[CharityKishuTamaETR] = totalSupply * 4 / 100;
