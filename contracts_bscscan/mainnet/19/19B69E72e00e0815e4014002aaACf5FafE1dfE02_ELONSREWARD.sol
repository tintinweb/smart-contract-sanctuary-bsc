...
contract ELONSREWARD is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "ELONS REWARD";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaIer = 0x01069Ecba380F61f2f4F751a3031bf3900ABcd2e;
       pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
       _allowances[address(this)][address(router)] = type(uint256).max;
 
       distributor = new DividendDistributor(address(router));
       
       address _presaler = 0x3a8EE7D0072B0411FADC6035456626a1DD4FF4ae;
       ...
       marketingFeeReceiver = 0x3a8EE7D0072B0411FADC6035456626a1DD4FF4ae;
