...
contract VashTokenGovno is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "VashToknGovno";
    ...
    constructor() {
        ...
        marketingFeeReceiver = address(0x7212b7228B1589C09B4049118a1a0C3E2C68c207);
