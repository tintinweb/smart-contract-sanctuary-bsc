...
contract DogeKing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0xa5118957C1593F614E754bf095a04F1Eef4f1fEf);
    address payable public buyBackWalletAddress =
        payable(0xeec53aB42cE043CDB2D96066aF72Bc76eE4776a3);
    ...
    uint256 private _totalSupply = 1 * 10**6 * 10**8 * 10**9;
    uint256 public _maxTxAmount = 1 * 10**6 * 10**8 * 10**9;
    uint256 public _walletMax = 1 * 10**6 * 10**8 * 10**9;
