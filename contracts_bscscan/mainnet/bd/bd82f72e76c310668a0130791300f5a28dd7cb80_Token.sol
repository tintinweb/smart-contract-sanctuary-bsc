...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "ETH Fan Token Ecosystem";
    string private _symbol = "EFT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xab80a775cf235E8c4cB48703Ff7f981FcC754d23);
    ...
    uint256 public _maxTxAmount = 800000000000000 * (10**18);
    uint256 public _walletMax = 800000000000000 * (10**18);
