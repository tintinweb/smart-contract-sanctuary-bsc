...
contract CheemsMcDonald is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Cheems McDonald";
    string constant _symbol = "McCHEEMS";
