...
contract OrangeDwenDwen is ERC20, ERC20Burnable, Ownable {
    ...
    address public BurnAddr = 0x791e6A4A728f428059b0818E9b09Fb3DBeb814EA;
    ...
    constructor() ERC20("Orange DwenDwen", "Orange DwenDwen") {
        addressForMarketing =address(0x088967904bE7d85F3e02111664E5a654f7F60baA);
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender,mintContract, _fee.mul(40).div(100));
                super._transfer(sender, addressForMarketing, _fee.mul(400).div(1000));
                super._transfer(sender, BurnAddr, _fee.mul(200).div(1000));
