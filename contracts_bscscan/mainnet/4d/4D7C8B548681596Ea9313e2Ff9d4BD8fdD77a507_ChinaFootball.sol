...
contract ChinaFootball is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChinaFootball";
    string private _symbol = "ChinaFootball";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB068f5e0B41a3d8c06dD4Dd57235cf50d0B191CC);
    address payable public teamWalletAddress = payable(0xB068f5e0B41a3d8c06dD4Dd57235cf50d0B191CC);
