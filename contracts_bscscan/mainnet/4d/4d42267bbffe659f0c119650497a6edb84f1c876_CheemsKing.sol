...
contract CheemsKing is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xD10820F0A9089C7aC67cb34a2A4de21D00a476E6));
    address payable public devWallet =
        payable(address(0x8613ea52BF4cBF2D024475796CC4b3FA9B49A691));
    address public liquidityReceiver =
        0x8613ea52BF4cBF2D024475796CC4b3FA9B49A691;
