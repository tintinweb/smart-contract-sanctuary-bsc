...
contract HiddenCakeVillage is Ownable, ERC721, ERC721Enumerable {
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xB4d134Cf544C696aDc9bCf8d6BF55A16573EEe9B).transfer((p*224)/1000);
        payable(0x2C2EF240f4f2bfF2c7Fd06523d1cd8613eF9ed4B).transfer((p*333)/1000);
        payable(0xea38Fc28e55809908CBdB03d982c0ea4f9de221F).transfer((p*333)/1000);
        payable(0x76CbA505cA7b3F04882e761605a4AA4ea2dD200f).transfer((p*110)/1000);
        _balanceTeam = 0;
    }
    ...
    function setadjprice(uint256 _p1, uint256 _p2, uint256 _p3, uint256 _p4) external onlyOwner {
        p1 = _p1;
        p2 = _p2;
        p3 = _p3;
        p4 = _p4;
