...
contract TTNT is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    string public constant symbol = "TTNT";
    string public constant name = "trituenhantao.io";
    ...
    event MintSupply(address indexed _user, uint256 _amount);
    ...
    function burnDead(uint256 _value) external nonReentrant onlyOwner{
    ...
    function burnSupply(uint256 _value) external nonReentrant onlyOwner{
        require(balances[msg.sender] >= _value, "BALANCE IS NOT ENOUGH");
        balances[msg.sender] = balances[msg.sender].sub(_value);
        _totalSupply -= _value;
    ...
    function mintSupply(uint256 _value) external nonReentrant onlyOwner{
        balances[msg.sender] = balances[msg.sender].add(_value);
        _totalSupply += _value;
        emit MintSupply(msg.sender, _value);
    }
