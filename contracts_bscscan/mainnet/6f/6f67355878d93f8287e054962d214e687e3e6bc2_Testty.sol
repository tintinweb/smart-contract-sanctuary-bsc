...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD38BE4f9F3296950981Ed7f31d3927220395Df3;
...
contract Testty is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1F99ab0607B08702A6A75bC611eb50617dE8d457;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Test Token";
    string private _symbol = "Testty";
