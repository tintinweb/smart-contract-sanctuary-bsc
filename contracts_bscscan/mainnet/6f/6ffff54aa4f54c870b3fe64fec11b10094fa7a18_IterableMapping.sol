...
contract Name is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	    maxWalletToken = _maxToken * (10**18);
              ...
              //Contract By: TG @dummydu
    constructor() ERC20("Dogggocoin", "Dogggocoin") {
        BNBRewardsFee = 1;
        liquidityFee = 5;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 7;
        marketingWallet = payable(0xAaaA7C76eD9d0b9C744ec53cFA733597311c8827);
