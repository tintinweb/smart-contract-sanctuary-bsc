...
contract FTOMB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Frozentomb Token";
    string private constant _symbol = "FTOMB";

    address public _PancakeSwapV1RouterUniswap = 0x30CF064A283af9d705996B55752d5eDae9b1848a; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x30CF064A283af9d705996B55752d5eDae9b1848a; //can be the same

    uint256 private _tTotal = 2201 * 10**_decimals;
