...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x5fAc926Bf1e638944BB16fb5B787B5bA4BC85b0A); // JFI BEP20
...
contract AveDogeKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AveDogeKing";
    string constant _symbol = "AVEDK";
    ...
    uint256 burnFee = 0;
    uint256 previousBurnFee = burnFee;
    uint256 reflectionFee = 3;
    uint256 previousReflectionFee = reflectionFee;
    ...
    function updateSellFee() internal {
        ...
        marketingFee = 3;
        totalFee = liquidityFee.add(burnFee).add(reflectionFee).add(marketingFee);
    }

    function recoverFee() internal {
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        if (burnFee > 0) {
            uint256 burnAmount = feeAmount.mul(burnFee).div(getTotalFee(receiver == pair));
