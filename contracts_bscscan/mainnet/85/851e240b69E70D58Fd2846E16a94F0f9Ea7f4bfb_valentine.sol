...
contract valentine is Context, IERC20, Ownable {
    ...
    string private _name = "Valentine Kabosu";
    string private _symbol = "Valentine Kabosu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B0A413f98940Fcd9904807Ef99a630609184125); // Marketing Address
    address payable public teamWalletAddress = payable(0x2B0A413f98940Fcd9904807Ef99a630609184125); // Team Address
