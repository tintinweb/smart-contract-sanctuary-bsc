...
/**
   ...
   Welcome McDogeValentine

 
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @McDogeValentine
...
contract McDogeValentine is Context, IERC20, Ownable {
    ...
    string private _name = "McDogeValentine";
    string private _symbol = "McDogeV";
    ...
    uint256 private minimumTokensBeforeSwap = 1554251 * 10**6 * 10**9; 
