...
contract sAsgardV2Token is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5000000000 * 10**9;
    ...
    constructor() ERC20("Staked AsgardV2", "sASGARDV2", 9) ERC20Permit() {
    ...
    /**
        @notice increases sASGARDV2 supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sASGARDV2
