...
//Valentine Cheems Inu is a super low cap gem launched by a based dev known in the bsc space. The really really low MCAP with the huge marketing plans in store could easily make this the next huge //coin.
// Telegram : https://t.me/ValentineCheemsInu
// Website : http://valentinecheemsinu.site
...
contract VCHEEMSINU is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x5d2fCDC35f308c5F517e6150b4e7d7BbF26FBcF2; 
    ...
    string private _name = "VALENTINES CHEEMS INU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**8 * 10**18;
