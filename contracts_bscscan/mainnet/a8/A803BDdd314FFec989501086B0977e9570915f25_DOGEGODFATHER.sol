...
contract DOGEGODFATHER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeGodFather";
    string private _symbol = "$DGF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c922c2930A7c8F89f07666c0412FD8D9855cDD4);
    address payable public teamWalletAddress = payable(0x6c922c2930A7c8F89f07666c0412FD8D9855cDD4);
