...
/**
Telegram : https://t.me/bezosjet
webiste : https://bezosjet.com/
*/
...
contract BEZOSJET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BEZOS JET";
    string private _symbol = "BEZOSJET";
