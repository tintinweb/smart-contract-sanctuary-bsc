...
contract OnlyFoolsRushIn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Only Fools Rush In";
    string private _symbol = "OFRI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA64d9E3F5f44Ea8FF352B82924c96C82544ccb90); 
