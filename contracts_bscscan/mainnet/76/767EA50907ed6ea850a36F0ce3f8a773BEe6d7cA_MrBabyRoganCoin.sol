...
contract MrBabyRoganCoin  is IBEP20, Auth {
    ...
    string constant _name = "MrBabyRoganCoin ";
    string constant _symbol = "MrBabyRoganCoin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 60) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; //2%
    ...
    address private marketingFeeReceiver = 0x52FB499BfAE11FBCeD9B1a3596c03224Baad7a9C;
    address private developmentFeeReceiver = 0x52FB499BfAE11FBCeD9B1a3596c03224Baad7a9C;
