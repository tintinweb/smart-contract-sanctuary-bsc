...
contract KINGDWENDWEN is Context, IERC20, Ownable {
    ...
    string private _name = "KingDwenDwen";
    string private _symbol = "KingDwenDwen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA88B9F3B09f2CEf01F76E373FB4a34C943C0CF83); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3F230779351f089722e9789585f47B5e0026a728); // buyback Address
