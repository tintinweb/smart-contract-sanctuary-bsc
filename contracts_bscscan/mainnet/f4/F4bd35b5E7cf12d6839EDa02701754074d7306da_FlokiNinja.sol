...
WEBSITE: https://flokininja.space/
Telegram :https://t.me/flokininjaBSC
FlokiNinja Token
$FLOJA is the newest ninja meme on the market!
Developed by an experienced team that have several successful meme projects.
*/
...
contract FlokiNinja is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FlokiNinja";
    string constant _symbol = "FLOJA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x588213d12AC3B74eE9B757C790F00c0088594FEc;
