 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/StarterPackKing
 * 
 * 
 * StarterPackKing token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract StarterPackKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarterPackKing";
    string constant _symbol = "PACKKING";
