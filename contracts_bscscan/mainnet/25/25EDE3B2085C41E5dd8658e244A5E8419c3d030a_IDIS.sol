...
contract IDIS is Context, IBEP20, Ownable {
    ...
    constructor (){
		_NAME = "I Discover Stars Token";
		_SYMBOL = "IDIS";
		_DECIMALS = 18;
		_DECIMALFACTOR = 10 ** _DECIMALS;
		_tTotal = 2 * 10**12 * _DECIMALFACTOR;
		_rTotal = (_MAX - (_MAX % _tTotal));
		_TAX_FEE = 1 * 100; 
        _BURN_FEE = 1 * 100;
		ORIG_TAX_FEE = _TAX_FEE;
		ORIG_BURN_FEE = _BURN_FEE;
		_owner = address(0xD342B501D36EDEAA740FBB39956D95e2Ff69E156);
    ...
    function setTaxFees(uint256 _taxfee,uint256 _burnfee) external onlyOwner(){
        require(_taxfee.add(_burnfee) <= 15);
         _TAX_FEE = _taxfee * 100; 
