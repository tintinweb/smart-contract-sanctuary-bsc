...
contract BabyGreenWhales is ERC20, Authorized {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyGreenWhales", "$BGWS") {
        ...
        uint256 totalSupply = 1 * 1e18; // 1 $BGWS
        ...
        marketingWallet = address(0x397aeb903e35EF0656970Ee1FeA73369D2c9682A); 
        buybackWallet = address(0x397aeb903e35EF0656970Ee1FeA73369D2c9682A);   
