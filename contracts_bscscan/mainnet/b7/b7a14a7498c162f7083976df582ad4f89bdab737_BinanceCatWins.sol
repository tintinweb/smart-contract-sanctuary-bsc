...
/**
   ...
   Welcome Binance CAT Wins

 
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @BinanceCATWins
   ...
   Can you make #BinanceCAT 10000X? 
...
contract BinanceCatWins is Context, IERC20, Ownable {
    ...
    string private _name = "Binance Cat Wins";
