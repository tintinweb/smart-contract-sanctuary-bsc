...
contract GrimaceElonCheems is IBEP20, Auth {
    ...
    string constant _name = "Grimace Elon Wagmi Cheems";
    string constant _symbol = "GEWC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 7) / 200; //2.5% 
    uint256 public _maxWalletSize = (_totalSupply * 7) / 100; //4%
