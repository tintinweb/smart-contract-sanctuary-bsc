...
/**
 *
/**   TG: https://t.me/BTCkeepGoing
 *  
 *     100% SAFU stealth launch with 100% locked liquidity and renounced contract ownership.
 *    Tokenomic
/*     
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETHEREUM = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract BTCkeepGoing is IERC20, Ownable {
    using SafeMath for uint256;

    address BTC = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BTCkeepGoing";
    string constant _symbol = "BTCG";
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 3000}("");
