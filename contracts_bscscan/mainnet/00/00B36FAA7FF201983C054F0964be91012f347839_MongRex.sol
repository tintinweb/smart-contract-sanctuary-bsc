...
Riding on the hype of Mongoose Token, we present to
you the hybrid beast MongRex. Don't let the innocent
Mongoose face trick you, because the body of the 
monstrous T-Rex is still there and ready to kill 🦖

Join us NOW @ https://t.me/MongRexBSC
*/
...
contract MongRex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public buybackAddress = payable(0xDf9Ab929E11fa7C6f5B1126Ac6087CFF5EE15Ed6); // BuyBack Address
    address payable public MarketingAddress = payable(0xDf9Ab929E11fa7C6f5B1126Ac6087CFF5EE15Ed6); // Marketing Address

    address payable public liquidityAddress = payable(0xDf9Ab929E11fa7C6f5B1126Ac6087CFF5EE15Ed6); // Liquidity Address
    ...
    string private constant _name = "MongRex";
