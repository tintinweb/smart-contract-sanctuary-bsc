...
contract Munro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MUNRO";
    string private _symbol = "MUNRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x247144191068Dd258119b181d3285c3bAFEF759b);
    address payable public teamWalletAddress = payable(0x247144191068Dd258119b181d3285c3bAFEF759b);
