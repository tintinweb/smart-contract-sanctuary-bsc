...
contract  GMDK is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0x356398fceD6099706Ad00D210E965234D293F43b;
    mapping(address => bool) public isbook;
      uint256 private _maxTxAmount = 1 * 10**7 * 10**2;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     address public owe = 0xc8Ba64Dea21ca9eD5F75aE6bD6FbbAEd48650687;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x5104b1e04F1196f7968084F84928e63b525489a8;


    constructor() public ERC20("Gold Medal Doge King", "GM DogeKing",2) {
        ...
        _totalSupply = (10000000000000) * (10**2);
        _balances[owner()] = (10000000000000) * (10**2);
          emit Transfer(address(0), owner(), (10000000000000) * (10**2));
    }
