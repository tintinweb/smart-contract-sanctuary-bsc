...
contract BrightKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bright King";
    string private _symbol = "BrightKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB94cF1bc2a2fA93Be8dfA941BF08DfbA4046eE4f); // Marketing Address
    address payable public DevWalletAddress = payable(0x25A0d1D17B27ca92c89B0414D0423C4dFA97b43F); // Dev fee
    ...
    uint256 public _walletMax = 2000 * 10**9;
