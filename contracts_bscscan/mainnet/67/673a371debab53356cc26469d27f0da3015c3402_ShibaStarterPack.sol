...
/**
/** Stealth Launch . Tg will be public 
...
/* Token contract */
contract ShibaStarterPack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "ShibaStarterPack";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 3%
