...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa829cdF56A1e5f72c5E10396F14e1861c18804F6;
...
contract SKURIRREL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2C89281E306E5Fc268d5366285c9333C703CbBd5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SKURIRRELToken";
    string private _symbol = "SKLT";
