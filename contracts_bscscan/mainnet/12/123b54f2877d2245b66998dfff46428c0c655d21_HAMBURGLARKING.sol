...
contract HAMBURGLARKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HamBurglarKing";
    string private _symbol = "BURGLARKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcDd1e378c6A24A56ee223c8B9E23e9c027b7de9b);
    address payable public buyBackWalletAddress = payable(0x795F54703ff5E1AABec9A48417E38Be8E67BcE22); 
