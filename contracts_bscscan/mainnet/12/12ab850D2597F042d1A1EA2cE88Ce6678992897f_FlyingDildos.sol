...
/* Token contract */
contract FlyingDildos is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "FlyingDildos";
    string constant _symbol = "Fds";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 4% on launch or 1M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe6894F6706b66efd1428DB59e0b45CD11fe1570d;
