...
contract KINGSHARK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x219d5A5390986361b3fe4aDcfF93705eE57aa7b1); // Marketing Address
    ...
    string private _symbol = "KINGSHARK";
