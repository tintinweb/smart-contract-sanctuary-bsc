...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0xfa79Da049A69894E080Fc2556d5D39ea4e6bb7Fb;
    IDEXRouter router;
...
contract WagmiDollar is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Wagmi Dollar";
    string constant _symbol = "WagmiDollar";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 10000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(5).div(100); //Max tx 
    uint256 public _maxWalletHold = 2000000000000;// Maxwallet
