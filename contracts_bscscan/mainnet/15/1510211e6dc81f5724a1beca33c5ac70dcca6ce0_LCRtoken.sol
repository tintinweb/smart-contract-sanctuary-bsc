...
contract LCRtoken is ERC20 {
    ...
    // address public lcrFundDeposit = 0x34CfbB3a3533De9D2574cBfd8e8aeE1119273233;  // Lucrar company main wallet      
    ...
    constructor() ERC20("Lucrar", "LCR")
    {
		...
		uint256 hoursUntilMidnight = 6;

		uint256 startBlock = block.number + ((daysUntilFirstRelease * 24 + hoursUntilMidnight) * 60 * 60 / 3); // April 1, 2022 aprox.	
