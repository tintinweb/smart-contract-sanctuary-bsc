...
contract BLING is Context, IBEP20, Ownable {
    ...
    string private _name = "Bling Inu";
    string private _symbol = "BLING";
    ...
    address payable public buybackAddress = payable(0x2e3b9661d65e03845Bea09EF04c82C1211167F82);
    address payable public devAddress = payable(0xedA476CcD454ac2BE6f8195F1594b71828D9712a);
    address payable public lpAddress = payable(0x5805e76AF0064eF69c3aC42E898637Ba753527Dc);
    address payable public stakingAddress = payable(0x4Fa42347579C773b838ED044C7eCd74b3D25715f);
