...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC045149aee539212fF3d779A05f33854c41A411f;
...
contract RTNK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBD4ff92B62b54088DBb93aaf33C18C49F371B621;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RareTanksClub";
    string private _symbol = "RTNK";
