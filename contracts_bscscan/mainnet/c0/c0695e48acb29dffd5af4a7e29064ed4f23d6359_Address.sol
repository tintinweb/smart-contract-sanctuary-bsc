...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 AETH = IERC20(0x55d398326f99059fF775485246999027B3197955);
...
contract BabyAetherius is IERC20, Ownable {
    using SafeMath for uint256;

    
    address AETH = 0x55d398326f99059fF775485246999027B3197955;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "flutch";
    string constant _symbol = "flutch";
    ...
    uint256 totalFee = 1200; // liquidityFee + reflectionFee + marketingFee + buybackFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x0aBC20A54633065904e3F9029057d5FB3F19D5E8);
        marketingFeeReceiver = address(0x0aBC20A54633065904e3F9029057d5FB3F19D5E8);
