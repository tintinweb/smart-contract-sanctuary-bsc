...
contract Sonofdogeking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELVKING";
    string private _symbol = "ELVKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE1FF6A3F027CF5592df320258E2fD474793695dC); 
    address payable public BuybackWalletAddress = payable(0xE1FF6A3F027CF5592df320258E2fD474793695dC); 
