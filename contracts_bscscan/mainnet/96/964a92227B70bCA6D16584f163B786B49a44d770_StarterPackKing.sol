...
contract StarterPackKing is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 70_000 * 10**_decimals;
    uint256 public maxTxAmount = 150_000 * 10**_decimals;
    uint256 public maxWalletAmount = 200_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3c48a9DF5544042c43a6D6A93901FFfac611168E;

    string private constant _name = "StarterPackKing";
    ...
    Taxes public taxes = Taxes(0,12,3,0);
