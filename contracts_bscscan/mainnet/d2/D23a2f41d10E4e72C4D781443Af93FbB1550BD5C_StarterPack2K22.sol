 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/StarterPack2K22
 * 
 * 
 * StarterPack2K22 token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract StarterPack2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarterPack2K22";
    string constant _symbol = "PACK2K22";
