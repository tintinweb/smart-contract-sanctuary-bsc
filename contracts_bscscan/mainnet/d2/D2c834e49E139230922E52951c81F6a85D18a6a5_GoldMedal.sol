...
contract GoldMedal is ERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 1000000 * (10**18);
    ...
    address public _marketingWalletAddress = 0x1E87876A9F0A77506B47B24834d063aB84E6Be40;
    ...
    constructor() public ERC20("GoldMedal", "GoldMedal") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BaByUSDT: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BaByUSDT: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BaByUSDT: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            " newValue >= 200000 && newValue <= 500000, 200,000 and 500,000"
        );
        require(
