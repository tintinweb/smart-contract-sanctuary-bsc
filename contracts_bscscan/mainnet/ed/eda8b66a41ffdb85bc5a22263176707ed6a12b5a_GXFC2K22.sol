...
/**
 welcome to : Gong Xi Fa Cai 2K22
 Telegram : @GongXiFaCai2K22BSC
 website  : http://gongxifacai2k22.com/
...
contract GXFC2K22 is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_000_00 * 10**9; //
    string private constant _name = "Gong Xi Fa Cai 2K22"; // 
    string private constant _symbol = "GXFC2K22"; //    
