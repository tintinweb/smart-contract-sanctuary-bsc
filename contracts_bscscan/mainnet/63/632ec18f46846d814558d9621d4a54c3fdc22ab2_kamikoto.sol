...
/**
  ...
  kamikoto
https://sites.google.com/view/kamikoto                                                          
...
contract kamikoto is kamikotoDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private kamikotoTeam;
    address private Charitykamikoto;
    ...
    string public override name = "kamikoto";
    string public override symbol = "KAMIKOTO";
    ...
    constructor(uint totalSupplyValue, address kamikotoTeamAddress, address CharitykamikotoAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        kamikotoTeam = kamikotoTeamAddress;
        Charitykamikoto = CharitykamikotoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[kamikotoTeam] =  totalSupply * 4 / 100;
        balances[Charitykamikoto] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's kamikotoTeam pot
