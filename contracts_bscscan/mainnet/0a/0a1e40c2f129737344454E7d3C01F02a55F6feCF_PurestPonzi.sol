...
// - 4% BURN
// - 4% LIQUIDITY
// - 1% "MARKETING" (I PLAN TO USE THIS TO FUND A PROJECT CALLED REFLEX. THAT'S https://t.me/reflexbsc)
//
// Telegram: https://t.me/purestponzi
...
contract PurestPonzi is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "THIS IS ANOTHER PONZI SCHEME";
    string constant _symbol = "PurestPonzi";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10 ** 12 * (10 ** _decimals);
    uint256 public reflectionFee = 400;
    uint256 public burnFee = 10;
    uint256 public liquidityFee = 40;
    uint256 public marketingFee = 40; // Again, I will be using this to fund Reflex. Not this project
