...
/**
 ******************* CRISPO CURRENCY BSC *********************
  Crispo Currency is now on Binance Smart Chain Network.
  Crispo Currency is a decentralized financial payment network that rebuilds the traditional payment stack on the block chain.
  It utilizes a basket of fiat-pegged stablecoins,algorithmically stabilized by its reserve currency Crispo Currency,
  to facilitate programmable payments and open financial infrastructure development.
  JOIN US ON
  Telegram:https://t.me/Crispocurrencybsc
  Twitter:https://twitter.com/currencybsc
  Instagram:https://instagram.com/CrispoCurrencyBSC
  OFFICIAL EMAIL:[email protected]
  DISCORD SERVER :https://discord.gg/4g7vDNC7rg
  WE ARE HERE TO EXPLODE ...........
*/
...
contract CRISPOCURRENCYBSC is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CRISPO CURRENCY BSC";
    string constant _symbol = "$CCBSC";
