...
Telegram: https://t.me/lootboxcoin

LootBoxCoin is here!

A token that's rewarding holders with NFT. Just Hold $LootBoxCoin to get free NFT each day! (Minimum 10$ worth of tokens are requested).

Maximum Supply - 1,000,000,000,000,000
💎Pancakeswap Liquidity - 100%
💎Dev - NONE
💎8% Reward reflections
💎3% Treasure
💎2% Marketing wallet
💎13% slippage
...
contract LootBoxCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7A8AADeaf22d7D71076c90d6538c9dF3627a0a73); // Marketing Address
    ...
    string private _name = "LootBoxCoin";
    string private _symbol = "LootBoxCoin";
