...
contract ElonHoverInu is IBEP20, Auth {
    ...
    string constant _name = "Elon Hover Inu";
    string constant _symbol = "Elon Hover Inu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 30) / 100; //1% 
