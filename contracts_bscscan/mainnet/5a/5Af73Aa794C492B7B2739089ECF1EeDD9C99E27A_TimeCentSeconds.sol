...
//SPDX-License-Identifier: MIT      https://t.me/TimeCentSeconds       
...
/* Token contract */
contract TimeCentSeconds is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "TimeCent";
    string constant _symbol = "TCS";
