...
library Address{
 ...
 contract FamilyVerse is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8470E96174b3d698Cc54b6709aa76955ac8e6605;
    address public developmentWallet = 0x8470E96174b3d698Cc54b6709aa76955ac8e6605;

    string private constant _name = "FamilyVerse";
    string private constant _symbol = "FMV";
    ...
    Taxes public sellTaxes = Taxes(1, 8, 1, 8);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        if(state == true && genesis_block == 1) genesis_block = block.number;
    }
