...
library Address{
 ...
 contract AntiBotBaby is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 10000000000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 150000000000 * 10**9;
    uint256 public maxBuyLimit = 150000000000 * 10**9;
    uint256 public maxSellLimit = 150000000000 * 10**9;
    uint256 public maxWalletLimit = 10000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xc4F1eA586a4c2305946ab26DCdEaC98B11CF531F;
    address public developmentWallet = 0xc4F1eA586a4c2305946ab26DCdEaC98B11CF531F;
    ...
    Taxes public taxes = Taxes(1, 2, 5, 3);
    Taxes public sellTaxes = Taxes(1, 2, 5, 3);
