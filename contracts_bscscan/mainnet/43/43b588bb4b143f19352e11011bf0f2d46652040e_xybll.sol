...
contract xybll is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "xybll";
    string private _symbol = "xybll";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0x6b33F5411fed8a2559Fb441b9eE7D46b5bAaCA89); 
    address payable public BurnedWalletAddress = payable(0x4F1EEE0AcBd24C8f71E62BDf165411Be2c415721); 
    ...
    uint256 private _totalSupply = 1000000000**_decimals;
    uint256 public _maxTxAmount = _totalSupply.div(1);
    uint256 public _walletMax = _totalSupply.div(1);
    uint256 private minimumTokensBeforeSwap = 1000**_decimals; 
