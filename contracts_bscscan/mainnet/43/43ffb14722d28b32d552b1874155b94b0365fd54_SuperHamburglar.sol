...
contract SuperHamburglar is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REFLECTION = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    ...
    address devMarketingWallet = 0x0AdA4aF0a7d595B7974ae03D3076C909310d265A;
   
    string constant _name = "Super Hamburglar";
    string constant _symbol = "SuperHamburglar";
    uint8 constant _decimals = 6;
 
    uint256 _totalSupply = 1 * 10**16 * (10 ** _decimals);

    //max transaction of 2.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = devMarketingWallet;
