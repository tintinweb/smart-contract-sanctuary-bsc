...
contract ApeInu is Context, IERC20, Ownable {
    ...
    address payable public buybackAddress = payable(0x6e7B0127B9b1BA50d3E17A7867128425feDcF5DB); // BuyBack Address
    address payable public MarketingAddress = payable(0x6e7B0127B9b1BA50d3E17A7867128425feDcF5DB); // Marketing Address

    address payable public liquidityAddress = payable(0x6e7B0127B9b1BA50d3E17A7867128425feDcF5DB); // Liquidity Address
