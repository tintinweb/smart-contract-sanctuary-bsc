...
contract DAOPAD is IERC20, OwnableUpgradeSafe, LGEWhitelisted {
    ...
    function initialize(uint256 cap, uint256 feeBurnPct, uint256 feeRewardPct, address feeRewardAddress)
    public
    initializer
    {
