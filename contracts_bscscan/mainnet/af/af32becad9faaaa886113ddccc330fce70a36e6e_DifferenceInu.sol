...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C059abD09a08251266F56901793dB25a241a71e;
...
contract DifferenceInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3C059abD09a08251266F56901793dB25a241a71e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Difference Inu";
    string private _symbol = "DIFF INU";
