...
contract BirdNestToken is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xF4238715807FbEde7dC22955f29E805CFe30Bf94); 
    ...
    uint256 private _totalSupply = 91000 * 10**_decimals;
    uint256 public _maxTxAmount = 4550 * 10**_decimals; 
    uint256 public _walletMax = 4550 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 4550 * 10**3; 
