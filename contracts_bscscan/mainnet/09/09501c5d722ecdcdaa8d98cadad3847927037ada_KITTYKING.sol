...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDA6A65252B029860de4Fbf5c6Dc00DE4c4b8D178;
...
contract KITTYKING is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x925d583135C614999476D0e750f986E1e59512f9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KITTY KING";
    string private _symbol = "$KITTYK";
    ...
    uint256 public maxWalletLimit = 14985000000000 * 10**18;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public _maxTxAmount = 14985000000000 * 10**18;
