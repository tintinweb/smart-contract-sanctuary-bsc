...
contract BDDRB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BDDRB";
    string private _symbol = "BDDRB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x402dC1351161eE284380856fc21B8eE9C97d424F); // Marketing Address
    address payable public teamWalletAddress = payable(0xA7805fAfb11D9E622Ef786FE3E18c96DcFECab32); // Team Address
