...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x465ab3b775A107BEE16008a686223f013FC7caB1;
...
contract FirstStrikeGamme is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC5725d84772b91fBc79F9EcA0FF89F93c005D156;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "First Strike";
    string private _symbol = "FSgame";
