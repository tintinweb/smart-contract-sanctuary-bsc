...
New safe degen BSC play that has huge potential. 
Starting on low initial  liq it can easily go x50.

Did you just missed dogeking, dogequeen and elses?
No worries, join us now. BUFFDOGEKING new gem on BSC. 
...
Telegram: https://t.me/BuffDogeKing
*/
...
contract BuffDogeKing is Context, IERC20, Ownable {
    ...
    string private _name = "BuffDogeKing";
    string private _symbol = "BuffDogeKing";
