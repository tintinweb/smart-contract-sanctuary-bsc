...
LiveME is designed to be secure. Initial liquidity (2.5 BNB) will be locked for 2 years on Mudra to provide holders with peace of mind that the token can always be exchanged. 
A trusted 3rd party will operate as the middle man to ensure that all raised liquidity is locked in a secure locker for the full timeframe. This creates a sense of security for investors who want to invest in this project.
We reward long term investors with a 3% tax on transactions which puts $LiveME tokens directly into their wallets every time someone buys or sells. 

Website: https://www.liveme.io/
Telegram: https://t.me/LiveMeBSC
...
contract LiveMe is Context, IERC20, IERC20Metadata, Ownable {   
