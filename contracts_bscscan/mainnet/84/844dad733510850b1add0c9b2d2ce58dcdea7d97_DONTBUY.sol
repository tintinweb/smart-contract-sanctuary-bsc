...
contract DONTBUY is Context, IBEP20, Ownable {
    ...
    string private _symbol = "TACOBELL";                                 
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 6 / 1000;
   ...
   function isExcludedFromMaxWallet(address account) public view returns(bool) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForBNB(liquifyHalves[0]); // <- this breaks the MATIC -> DNB swap when swap+liquify is triggered
