...
contract ElonmuskSmoking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonMusk Smoking";
    string private _symbol = "EMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96Ca7fb4F1DB7844a78d4Be4068B19DD350afd50); 
    address payable public teamWalletAddress = payable(0x96Ca7fb4F1DB7844a78d4Be4068B19DD350afd50); 
