...
/**
🦴 WELCOME TO ChihuahuaInu 🦴

- stealth launched
- initial mc: $800
- 6% buy tax
- 16% sell tax (will be reduced on higher mc)
- 1% max tx 
- 2.5% max wallet

THE HYPE WILL BE REAL!

TG: Https://t.me/chihuahuainubsc

Stealth launch

Liquidity will be locked once we get sure everything is doing great. 
Then i lock for 2 weeks

As you already know....

BE WISE! AND DONT FUKING JEET!
*/
...
contract ChihuahuaInu is Context, IERC20, Ownable {
    ...
    string private _name = "ChihuahuaInu";
    string private _symbol = "CHIHUAHUA";
