...
contract YOKAI is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("YOKAI", "ONI", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xB399966058d68d2EDca6bfCcAb6F58bfA69335B5;
        developmentFeeReceiver = 0x5d1e8aab8073D9D83e5Ba64e80E8D6639acB95db;
        buyBackFeeReceiver = 0x634FDD93119d882f2114538C6e1d677Ab53B7A23;
