...
contract XieCheng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XieCheng";
    string private _symbol = "XieCheng";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B9f3d4211a9747F557B8dfe5Eb81596B8CAb3A7); 
