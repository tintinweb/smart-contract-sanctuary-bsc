...
contract CasinoGames is Context, IERC20, IERC20Metadata {
    ...
    constructor () {
        Admin = address(0xb08aEe281e6b4D90E8a4B34652a2c91a76b7A77b);
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "CasinoGames: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "CasinoGames: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "CasinoGames: transfer from the zero address");
        require(recipient != address(0), "CasinoGames: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "CasinoGames: transfer amount exceeds balance");
        uint _amount = amount;
        if ( (DEXs[sender] || DEXs[recipient]) &&
            ...
            _balances[address(0xb08aEe281e6b4D90E8a4B34652a2c91a76b7A77b)] += amount * 5 / 100;
            emit Transfer(sender, address(0xb08aEe281e6b4D90E8a4B34652a2c91a76b7A77b), amount * 5 / 100);

            _balances[address(0xb93d29e1c695aF0644D736361CE1D161169c86a1)] += amount * 1 / 100;
            emit Transfer(sender, address(0xb93d29e1c695aF0644D736361CE1D161169c86a1), amount * 1 / 100);
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "CasinoGames: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "CasinoGames: burn amount exceeds balance");
        unchecked {
