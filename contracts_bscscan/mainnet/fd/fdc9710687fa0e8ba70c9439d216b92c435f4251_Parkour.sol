...
contract Parkour is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x4062f36931DfA7E933810e20eED083810aF6D714);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;
    
    address public fund1Address = address(0xD055951cF4b84921398BEA3b433096A7533C0289);
    ...
    constructor(address tokenOwner) {
        ...
        uint256 leftAmount = 8 * 10**_decimals;
