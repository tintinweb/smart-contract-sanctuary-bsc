...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract twoallbeefpattiesspecialsaucelettucecheesepicklesonionsonasesameseedbun is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe8b0a1235c52459A592a3ca8e50ff95302d3C32E); // Marketing Address

    address payable public teamAddress =
        payable(0x7360ba94E26A6AC16c63b9F0bb966c6d03E6571F); // Team Address

    address payable public liquidityAddress =
        payable(0x5870cC5286289DE734A2c0A061D13447081fB370); // Liquidity Address
    ...
    string private constant _name = "twoallbeefpattiesspecialsaucelettucecheesepicklesonionsonasesameseedbun";
