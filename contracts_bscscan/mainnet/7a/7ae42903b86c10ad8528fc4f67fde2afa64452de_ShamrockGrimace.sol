...
contract ShamrockGrimace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShamrockGrimace";
    string constant _symbol = "ShamrockGrim";
    ...
    uint256 public swapThreshold = _totalSupply * 2 / 1000; //Token sold for true trade
    bool inSwap;
