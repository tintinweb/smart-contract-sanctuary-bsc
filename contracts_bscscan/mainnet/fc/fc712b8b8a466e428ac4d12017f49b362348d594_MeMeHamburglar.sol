...
contract MeMeHamburglar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MeMeHamburglar"; 
    string private _symbol = "MeMeHamburglar"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0a5Ebec128267609f5Abd3829EBFBCbA15785585); // Marketing Address
    address payable public teamWalletAddress = payable(0x0a5Ebec128267609f5Abd3829EBFBCbA15785585); //  Team Address
