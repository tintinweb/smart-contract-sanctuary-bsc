...
/**
TG : https://t.me/riseshinfloki
🚀Total token supply - 1,000,000,000,000
🔥30% Burn Supply
♻️2% Team Tokens
💵5% Marketing & Promotions
🎯60% Initital Liquidity
🪙3% Giveaways & Contests

Website : https://riseshinfloki.com/*/
...
contract RISESHINFLOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RISESHINFLOKI";
    string private _symbol = "RCF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf1F5A5bd0940693F30F3AF61D90551E02B0ECa4F); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf1F5A5bd0940693F30F3AF61D90551E02B0ECa4F); // BuyBack Address
    ...
    uint256 public _sellBuyBackFee = 8;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000000 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
