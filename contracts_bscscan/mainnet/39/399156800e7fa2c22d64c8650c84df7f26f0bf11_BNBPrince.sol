...
// Submitted for Telegram: https://t.me/BnbPrinceEN
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BNBPrince is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BNB Prince ";
    string private _symbol = " BNBPrince ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe23bB2Bcb8b4d7da6636bd754221fa841C112C34);
    address payable public teamWalletAddress = payable(0xe23bB2Bcb8b4d7da6636bd754221fa841C112C34);
