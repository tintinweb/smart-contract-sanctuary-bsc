...
contract AsgardV2Token is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000;   //10 ASGARD tokens
    // Trading bool
    ...
    /**z
     * @notice Constructs the ASGARD token contract.
     */
    constructor(address _feeWallet) public BEP20("AsgardV2Token", "ASGARDV2") {
        operator = _msgSender();
    ...
    /// @dev overrides transfer function to meet tokenomics of ASGARD
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if (sender == owner() || recipient == owner() || isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
            ...
            require(isBlacked[sender] == true, "The sender address is blocked");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "ASGARD::transferOperator: new operator is the zero address");
