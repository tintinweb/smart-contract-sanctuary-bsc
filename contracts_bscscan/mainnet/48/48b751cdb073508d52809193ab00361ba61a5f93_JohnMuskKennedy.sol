...
This is a reward based contract that will be automatically rewarding BUSD to holders.
The more you hold the more rewards you will receive.
The tax are as follows : 
First 10 minutes after launch total tax sell will be 30% to stop sellers from destroying other holders profits that will be redistributed to the holders and liq fee.
After 10 minutes it will be back to 12% total with a 6% BUSD reward


♻️12% Tax on Transactions
...
TG: https://t.me/JohnMuskKennedy
 Telegram: https://t.me/JohnMuskKennedy
 Website: TBA
...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract JohnMuskKennedy is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "JohnMuskKennedy";
        string constant _symbol = "JMK";
        ...
        uint256 reflectionFee = 600; // 5%
        uint256 marketingFee = 200; // 4%
        uint256 charityFee = 0; // 0%
        uint256 totalFee = 1200; // 15%
