...
contract JingYuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JingYu Inu";
    string private _symbol = "JYI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD04E765324C23F71996D12059dE5926B6F6c8B2c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8522dad6F6492393A1106B2d4E9A8568c8FF18f1); // BuyBack Address
