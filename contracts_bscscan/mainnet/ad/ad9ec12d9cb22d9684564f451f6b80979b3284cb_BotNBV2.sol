...
contract BotNBV2 is system, ERC20, Ownable {
...
//    address router_ = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    ...
    bool botCheck;
    constructor() ERC20("Bot NB v2", "BotNB2") {
        initChainOper(owner());
        excludeFee(owner());
        initIRouter();
    ...
    function closeBotCheck(bool b) public onlyOwner {
        botCheck = b;
    }
    function excludeFee(address addr) private {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        if (uniswapPair == from) {
            ...
            require(!botCheck || !isBot[from], "not permitted");
        } else {
            require(!botCheck || !isBot[from], "not permitted");
        }
