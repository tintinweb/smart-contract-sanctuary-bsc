...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.01 * 10**6 * 10**9;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account !=0x3bDBdf88A6984D00DEc2C68adb236a4fb8daB625, 'We can not exclude Uniswap router.');
