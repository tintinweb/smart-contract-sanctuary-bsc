...
contract MooJigsaw is ERC1155PresetMinterPauserUpgradeable {
  string private _uri;
  ...
  function initialize(string memory _uri) public override initializer {
    ERC1155PresetMinterPauserUpgradeable.initialize(_uri);
  ...
  function _beforeTokenTransfer(
    ...
    if (AddressUpgradeable.isContract(to)) {
      require(wlContract[to], "MooJigsaw: Only whitelist contract");
    }
