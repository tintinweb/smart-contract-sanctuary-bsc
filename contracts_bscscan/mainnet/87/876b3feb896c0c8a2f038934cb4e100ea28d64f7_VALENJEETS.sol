...
40% SELL TAX
99% BUY AND SELL TAX
 Dont jeet at launch bro
HE’S TOO BUSY FOR DATING, THE BLOCKCHAIN IS HIS ONLY LOVE. FOR VALENTINE’S DAY ALL HE WANTS IS ROSE BOT. JOIN OUR COMMUNITY OF JEETS AND FOR THIS VALENTINE’S DAY , LETS ALL FINALLY GET OUR 1000x!
...
/* Token contract */
contract VALENJEETS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x9FfEFDdC1e0199795800a8A7e1110e72199E995d;
    ...
    // Name and symbol
    string constant _name = "ValenJeet";
    string constant _symbol = "VJAY";
