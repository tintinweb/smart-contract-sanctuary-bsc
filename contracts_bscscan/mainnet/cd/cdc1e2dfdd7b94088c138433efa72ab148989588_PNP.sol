...
contract PNP is ERC20, Ownable {

    constructor () ERC20("PICKNPAYS TOKEN", "PNP") public {
        _mint(0x0B8A34B39dBfb0af3d2E871c58C9320F02451106, 51000000 * (10 ** uint256(decimals())));
    }
}