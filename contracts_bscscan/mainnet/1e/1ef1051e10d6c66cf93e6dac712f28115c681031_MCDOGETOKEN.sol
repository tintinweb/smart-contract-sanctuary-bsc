...
contract MCDOGETOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MC Dogetoken";
    string private _symbol = "MCDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10E4866F9dC6Ba429EA8bAbA6cf9a5588ca785eE);
    address payable public teamWalletAddress = payable(0x10E4866F9dC6Ba429EA8bAbA6cf9a5588ca785eE);
