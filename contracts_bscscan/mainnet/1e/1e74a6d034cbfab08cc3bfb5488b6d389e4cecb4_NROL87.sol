...
contract NROL87 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NROL-87";
    string private _symbol = "NROL87";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa8b4bDC8D0F0e95f469CC1a7359E9012324B08B1);
    address payable public teamWalletAddress = payable(0xa8b4bDC8D0F0e95f469CC1a7359E9012324B08B1);
