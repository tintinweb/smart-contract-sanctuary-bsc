...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CHIBA = IBEP20(0xC4CdC643a3BA49d5cD296Db591ef0a56a9080886);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CHIBA.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CHIBA);
        ...
        uint256 amount = CHIBA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHIBA.transfer(shareholder, amount);
...
/* Token contract */
contract SuperChiba is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CHIBA = 0xC4CdC643a3BA49d5cD296Db591ef0a56a9080886; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xc8a7E018095fb92087eF973956C9AbceAc813b69;
    ...
    // Name and symbol
    string constant _name = "Super Chiba";
    string constant _symbol = "SChiba";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 3%
  ...
  // Sell fees
    ...
    uint256 public swapThreshold = _totalSupply * 70 / 10000; // 0.1% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAd5b383AFCe173e97078DE42BceF6802366B63BA;
