...
contract DegethalIdo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Degethal IDO";
    string private _symbol = "DTM";
    ...
    uint256 public selcraeLiquidityFee = 3;
    uint256 public selcraeMarketingFee = 8;
    uint256 public selcraeBuyBackFee = 1;
    ...
    uint256 public _walletMax = 1000000000*10**18;
    ...
    constructor (address MarketingWalletAddress, address buyBackWalletAddress) {
      ...
      BuyBackWalletAddress = payable(buyBackWalletAddress);
        ...
        _totalTaxIfSelling = selcraeLiquidityFee.add(selcraeMarketingFee).add(selcraeBuyBackFee);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        ...
        selcraeLiquidityFee = newLiquidityTax;
        selcraeMarketingFee = newMarketingTax;
        selcraeBuyBackFee = newBuyBackTax;
        _totalTaxIfSelling = selcraeLiquidityFee.add(selcraeMarketingFee).add(selcraeBuyBackFee);
    }
