    ...
    Pausable
{
    ...
    // mapping of certificate id with rates
    ...
    // mapping of certificate id with claim price
    ...
    function claimRewards(uint256[] calldata tokenIds) public whenNotPaused {
        ...
        if (reward > 0) {
            ...
            IERC20(erc20Address).transferFrom(locker, msg.sender, reward);
