...
contract FLOKIBABYDOGEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokibabyDogeKing";
    string private _symbol = "FlokibabyDogeKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2d6c122bca5d5CF7B18aD7583676B090C81AfcF4);
    address payable public buyBackWalletAddress = payable(0xc7B37cC6180F0dDb2cCFF613141a48aDfc29ed73); 
