...
contract StarBaseFloki is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Star Base Floki';
    string private constant _symbol = 'SBFloki';
    ...
    //DevWallets
    address public TeamWallet=payable(0x2Ea9C66df844862f100B937ca7eDa10dF32Fd5bB);
    address public walletTwo=payable(0xb61e6421e058B458dED607e3B92be5a3ddea9f21);
    //TestNet
