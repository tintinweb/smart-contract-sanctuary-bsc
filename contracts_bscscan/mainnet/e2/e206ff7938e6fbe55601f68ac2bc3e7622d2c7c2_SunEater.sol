...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract SunEater is Context , IERC20, Ownable {
    ...
    string private _name = "Sun Eater Network";
    string private _symbol = "SEN";
    ...
    address public devWallet = 0x7EE23a0A02A8C7DFb70D8cc8B2382938f385d04d; //1% for marketing ,1% for giveaways
    ...
    uint256 public _maxWalletToken = 20 * 10**9 * 10**9; //2% of total supply
