 ...
 *
 *		https://lastkingdoms
 *		https://t.me/lastkingdoms
 *		https://twitter.com/last_kingdoms
 *
 *
 *
 */
...
contract LASTKINGDOMS is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 50 * 10**6 * 10**9;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;
    string private _name = "LASTKINGDOMS";
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "Exceeds maximum wallet token amount (50,000,000)"
            );
        }
