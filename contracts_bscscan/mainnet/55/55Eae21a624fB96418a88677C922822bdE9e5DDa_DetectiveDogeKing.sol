...
contract DetectiveDogeKing is IBEP20, Auth {
    ...
    string constant _name = "DogeKing INU";
    string constant _symbol = "DOGEKING";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; //3.5% 
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100; //7%
