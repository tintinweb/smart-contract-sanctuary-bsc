...
contract MET is Context, IERC20, Ownable {
    ...
    string private _name = "bxb";
    string private _symbol = "bxb";
    ...
    address public ownerAddres = address(0xe39f1b8Afcc268d969a94393dfBfc9BBF26A7b20);
    address public devAddress = address(0x5E765a30C5174d99385F189Cf7132f329385EFB1);
    address public foundAddress = address(0x50A854075aDeB4F2cca19500d4117B714cB94516);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 90000000000 * 10 ** 18 && !_isExcludedFromFee[sender]) {
