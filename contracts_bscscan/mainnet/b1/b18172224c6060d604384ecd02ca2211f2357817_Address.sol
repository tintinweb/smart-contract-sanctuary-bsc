...
contract Doko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doko";
    string private _symbol = "doko";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x83db456c29107Ad108278C12f607C9C9696785D0);
    address payable public teamWalletAddress = payable(0x83db456c29107Ad108278C12f607C9C9696785D0);
