...
contract Woof22k is IBEP20, Auth {
    ...
    string private constant _name = "Woof22k";
    string private constant _symbol = "$W22k";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 50,000,000,000
    ...
    address private marketingFeeReceiver = 0x6cCE121f7edD3E3ED6e2f0221320D1AF4fB8834a;
    address private devFeeReceiver = 0xb1Ec755E703C64B57099a6b1F5b6d0696BC70243;
