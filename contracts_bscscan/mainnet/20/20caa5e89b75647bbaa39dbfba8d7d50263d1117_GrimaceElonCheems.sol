...
contract GrimaceElonCheems is IBEP20, Auth {
    ...
    string constant _name = "WaitButWhy INU";
    string constant _symbol = "WBW INU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; //2.5% 
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; //4%
    ...
    address private marketingFeeReceiver = 0x6c82Bac2c65A58D1D4b9835fE0f8CCdF5fA08110;
