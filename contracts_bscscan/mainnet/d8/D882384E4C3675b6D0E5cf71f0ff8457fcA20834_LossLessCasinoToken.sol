...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LTC = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
contract LossLessCasinoToken is IBEP20, Auth {
    using SafeMath for uint256;

    address LTC = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LOSSLESS";
    string constant _symbol = "LossLessCasinoToken";
