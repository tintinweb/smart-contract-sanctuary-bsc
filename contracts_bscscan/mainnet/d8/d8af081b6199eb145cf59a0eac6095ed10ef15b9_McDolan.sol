...
- Contract renounced
- LP locked
- No mint, set tax, set tx limits etc.
- No max wallet and max transaction - BTC style

GRIMACE IS NOT SAFU:
- Contract NOT renounced
- changeTxLimit present (can be honeypot)

Be wise. Eat in McDolan pls

https://mcdolanbsc.fun/
https://t.me/McDolanBSC
...
contract McDolan is IBEP20, Auth {

    using SafeMath for uint256;

    string _name = "McDolan";
    string _symbol = "McDolan";
    ...
    constructor () Auth(msg.sender) {
        ...
        anotherMarketingWallet = 0xf42582D0a7B71620f4D15de48105F152827e0362;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(6).div(10);
