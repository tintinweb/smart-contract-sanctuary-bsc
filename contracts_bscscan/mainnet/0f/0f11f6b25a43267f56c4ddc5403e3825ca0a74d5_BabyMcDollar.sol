...
/**
 Do you miss for McDollar ? so, dont missed for the baby.
 Telgram. https://t.me/BabyMcDollarOfficial
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 McdollarReward = IBEP20(0x9aa5Ff9F2dD113F291487c83fBe54350dD12274e);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = McdollarReward.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(McdollarReward);
        ...
        uint256 amount = McdollarReward.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            McdollarReward.transfer(shareholder, amount);
...
contract BabyMcDollar is IBEP20, Auth {
    using SafeMath for uint256;

    address McdollarReward = 0x9aa5Ff9F2dD113F291487c83fBe54350dD12274e;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyMcDollar";
    string constant _symbol = "Baby McDollar";
