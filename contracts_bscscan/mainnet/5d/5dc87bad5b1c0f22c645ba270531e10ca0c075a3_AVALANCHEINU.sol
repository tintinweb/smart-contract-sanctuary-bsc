 ...
 *AVALANCHE INU
  ...
  LOW MARKETCAP GEM.
  SMART CONTRACT VERIFIED THROUGH BINANCE SMART CHAIN.
  LIQUIDITY LOCKED AT LAUNCH VIA MUDRA LOCKER.
  BUSD REWARD WILL BE DISTRIBUTED TO LOYAL HOLDERS FOR EVERY TRANSACTION.

  BUY ON PANCAKESWAP OR POOCOIN. 

  FOR FURTHER INFORMATION JOIN OUR COMMUNITY ON-
  TG:https://t.me/Avalancheinu
*/
...
contract AVALANCHEINU is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AVALANCHE INU";
    string constant _symbol = "$AVIN";
