 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BonfireKing
 * 
 * 
 * BonfireKing token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BonfireKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BonfireKing";
    string constant _symbol = "BONFKING";
