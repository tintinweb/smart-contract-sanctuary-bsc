...
contract NeobankDAO is IBEP20, Ownable
{
    ...
    mapping (address => uint256) private _wdPause;

    EnumerableSet.AddressSet private _excluded;
    EnumerableSet.AddressSet private _excludedFromStaking;

    string private constant _name = "Neobank DAO";
    ...
    address public constant TeamWallet=0xcC4aBCb0E0a4be248e993D02302f6dF34168D311;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function getAddressWdPauseTimeInSeconds(address AddressToCheck) public view returns (uint256){
       uint256 lockTime=_wdPause[AddressToCheck];
    ...
    function getWdPauseTimeInSeconds() public view returns(uint256){
        return wdPauseTime;
    }
    

    function AddressResetWdPause() public{
        _wdPause[msg.sender]=block.timestamp+wdPauseTime;
    }


    bool public wdPauseDisabled;
    bool public wdPauseEnabled;
    uint256 public wdPauseTime;
    ...
    function TeamDisableWdPause(bool disabled) public onlyOwner{
        wdPauseDisabled=disabled;
    }

    function TeamEnableWdPause(bool enabled) public onlyOwner{
        wdPauseEnabled=enabled;
    }
