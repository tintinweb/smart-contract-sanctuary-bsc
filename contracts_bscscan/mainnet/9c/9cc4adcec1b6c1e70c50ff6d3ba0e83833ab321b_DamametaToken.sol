...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    address public T = 0xB383EE114355510C79e37Ea34D6aDda730F67820;  // team address
    address public A = 0x6ff7E6a1683C58be44427617761c5D9Bb09e993e;  // transition address
    address public M = 0x27485279F726E310588f1b607a8377437a08a803;  // market address
...
contract DamametaToken is BEP20Detailed {

    constructor() BEP20Detailed("Damameta coin", "Damameta", 18) public {
		require(_msgSender() != address(0), "BEP20: transfer from the zero address");
