...
contract MemeKing is IERC20, Ownable {
    ...
    address public receiveReward2Token = address(0x3DD1df1066dae0aCEf44C64BCF54e73f5a215a16);
    address public fund1Address = address(0x6856AF951eE93f8AE98e3A83759d4bD4d8b7996D);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee + _liquidityFee + _destroyFee + _inviterFee + _fund1Fee;
        }
    ...
    function _takeInviterFee(
        ...
        for (int256 i = 0; i < 3; i++) {
            ...
            if (cur == address(0)) {
                ...
                _rOwned[receiveReward2Token] = _rOwned[receiveReward2Token].add(curRAmount);
                emit Transfer(sender, receiveReward1Token, curTAmount);
                emit Transfer(sender, receiveReward2Token, curTAmount);
            }else{
