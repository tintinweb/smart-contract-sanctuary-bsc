...
contract TacoBellInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TacoBellInu";
    string constant _symbol = "TBI";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x60adBb1d88ee6394f1b78851fd60F3468F31927e;
