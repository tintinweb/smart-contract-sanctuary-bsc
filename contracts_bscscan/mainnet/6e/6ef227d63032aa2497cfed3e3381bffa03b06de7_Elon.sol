...
contract Elon is IBEP20, Auth {
    ...
    string constant _name = "Elon King";
    string constant _symbol = "ElonK";
    ...
    address private marketingFeeReceiver = 0xED77377Cd2BEAeE035A1eabA5472c271CCB7b874;
    address private buybackFeeReceiver = 0xED77377Cd2BEAeE035A1eabA5472c271CCB7b874;
    ...
    uint256 public swapThreshold = 100 * 10**9 * (10 ** _decimals); // 0.3%
    bool inSwap;
