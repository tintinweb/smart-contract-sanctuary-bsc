...
contract Astralis is ERC20, ERC20Burnable, Ownable, OwnerRecovery, LiquidityPoolManagerImplementationPointer, WalletObserverImplementationPointer {
    ...
    constructor(address _planetsManager) ERC20("Astralis", "STAR") {
        require(
