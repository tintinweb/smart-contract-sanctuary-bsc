...
contract BabyDoge1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Doge1"; //
    string private constant _symbol = "BABYDOGE1"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address private _marketingWallet = 0xE1e2633Ae54862CcB217Ea30B2b31d3299C6F4Bc ;
