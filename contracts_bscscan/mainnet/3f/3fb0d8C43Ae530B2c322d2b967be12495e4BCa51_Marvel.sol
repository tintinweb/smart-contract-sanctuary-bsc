...
/**
 *Marvel-Inu has come to take out all the evildoers and go on a epic Run through the DeFi Markets! Join the Squad and lets take this to the Moon!
 * 
 */
...
contract Marvel is Context, IERC20, Ownable {
    ...
    string private _symbol = "Marvel-Inu";
