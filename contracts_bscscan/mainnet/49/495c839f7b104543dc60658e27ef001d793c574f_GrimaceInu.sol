...
contract GrimaceInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Grimace Inu"; 
...
//address
    ...
    address public _MarketingWalletAddress = 0x137649C95D97FF5f30A9886eCF6Ff52d8298dC10;
    address public _DevelopmentWalletAddress = 0xE1DCe63c001A068286624129fDE9d83A69FB596b; 
    address[] private _excluded;
//uint
    uint public buyReflectionFee = 1;
    uint public sellReflectionFee = 1;
    uint public buyDevelopmentFee = 5;
    ...
    uint public maxWallet = 10000000 * (10 ** 9); //0.2% supply
    uint public minimumTokensBeforeSwap = 900000 * (10**9);
    uint private MarketActiveAt;
    uint private constant MAX = ~uint256(0);
    uint private _tTotal = 500000000 * (10 ** 9);
...
// constructor
    constructor() {
        ...
        uint total_supply = 500000000 * 10 ** decimals();
        // set gvars
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        uniswapV2Router = _uniswapV2Router;
        maxSellTxAmount = total_supply/100; // 0.1% supply
    ...
    function setMaxTxPercent(uint buy, uint sell) external onlyOwner() {
        require( ((_tTotal * sell) / 10**2) <= 2, "max sell tx limited to 1% of the supply" );
