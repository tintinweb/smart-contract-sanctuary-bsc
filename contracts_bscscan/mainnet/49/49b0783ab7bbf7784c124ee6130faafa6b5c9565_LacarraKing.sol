...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a LacarraKing shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract LacarraKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "LacarraKing";
    string private constant _symbol = "LacarraKing";
