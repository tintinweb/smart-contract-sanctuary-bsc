...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52863ba6CfeBe7e236951a2ccbf388FFFA9107bf;
...
contract TROYINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC30600E51c01B73c4E4322a1c93c19dc1108e7a1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 75000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TROY INU";
    string private _symbol = "$TROY";
    ...
    uint256 public maxWalletLimit = 1125000000 * 10**18;
    ...
    uint256 private numTokensSellToAddToLiquidity = 37500000 * 10**18;
