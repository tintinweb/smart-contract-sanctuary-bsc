...
contract BNBBACK is ERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xfc35Ea6Ff13D0df342A477506314bD58576530bB);
    ...
    function updateBuyFees(
        ...
        uint256 newBNBRewardsFee
         ...
         require(newMarketingFee <= MAX_BUYFEE_RATE, "new marketing fee cannot be > 25");
        require(newLiquidityFee <= MAX_BUYFEE_RATE, "new marketing fee cannot be > 25");
        require(newBNBRewardsFee <= MAX_BUYFEE_RATE, "new marketing fee cannot be > 25");
