...
TELEGRAM : T.ME/CUPIDDOGEKING
Website : WWW.CUPIDDOGEKING.SITE
...
/* Token contract */
contract CupidDogeKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "CupidDogeKing";
    string constant _symbol = "CUPIDKING";
