...
contract DOGEKING2K22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE KING 2K22";
    string private _symbol = "DOGEKing2k22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4844a7B129EA10BFcb7DfD6d525f5C827dbf8183);
    address payable public teamWalletAddress = payable(0x4844a7B129EA10BFcb7DfD6d525f5C827dbf8183);
