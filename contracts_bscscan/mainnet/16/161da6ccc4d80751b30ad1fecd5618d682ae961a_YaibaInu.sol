...
contract YaibaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x69e09AE9612412FF54967D64D2278B02CDd8Fd8E;
 
    string constant _name = "Yaiba Inu";
    string constant _symbol = "YAIBA";
