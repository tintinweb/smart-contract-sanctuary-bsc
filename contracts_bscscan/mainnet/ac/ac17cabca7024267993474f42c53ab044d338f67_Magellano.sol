...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x33307f2521E2679B44Af8AcfACA0d784f5306E1f;
        _owner = msgSender;
...
contract Magellano is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public marketingAddress = 0x3ef2d17603dD7F8Da5Cb497698dF8Cf28c5e41a7; // Marketing wallet Address.
    ...
    string private _name = "Magellano";
    string private _symbol = "MGL";
    uint8 private _decimals = 18;

    uint256 public _taxFee = 1; //auto distribution to holders in native token. 
