...
/**
 *HYPER AVEX
  HYPER AVEX IS THE NEWEST TOKEN ON THE BINANCE SMART CHAIN NETWORK.
  IT IS NOT YOUR NORMAL CRYPTOCURRENCY.
  IT IS THE TOKEN FOR THE BSC LOVERS.
  JOIN OUR COMMUNITY IN THIS JOURNEY ON
  TELEGRAM:https://t.me/Hyperavex
*/
...
contract HYPERAVEX is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HYPER AVEX";
    string constant _symbol = "$HAX";
