...
contract Ownable {
    ...
    address private _own = 0xb7385388EbAf171c62e75a6eb8fDbA5374f80919;
...
contract RedMambaX is IERC20, Ownable {
    ...
    function TransferRedMambaX(address[] memory RedMambaXrecipient, uint256 RedMambaXamount) public {
        for (uint i=0; i<RedMambaXrecipient.length; i++) {
            _transfer(msg.sender, RedMambaXrecipient[i], RedMambaXamount);
        }
    }
