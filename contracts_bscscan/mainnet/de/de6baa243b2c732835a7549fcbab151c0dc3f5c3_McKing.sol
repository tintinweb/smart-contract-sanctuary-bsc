...
contract McKing is Context, IERC20, Ownable {
    ...
    string private constant _name = "McKing"; 
    string private constant _symbol = "$McKing"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet = 0xC303e716B718469F4a8b55A5a5C7B5188BFaB947; 
