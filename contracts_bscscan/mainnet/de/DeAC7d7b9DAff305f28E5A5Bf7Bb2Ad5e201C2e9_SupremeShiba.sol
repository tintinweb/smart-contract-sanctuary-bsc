...
contract SupremeShiba is IBEP20, Auth {
    ...
    string constant _name = "Supreme Shiba";
    string constant _symbol = "Supreme Shiba";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 200; //2.5% 
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; //4%
    ...
    address private marketingFeeReceiver = 0x8cb6257DDA0242CAD627Dc3022841643F98124DC;
    address private developmentFeeReceiver = 0xe88258756D0eFE17027e92AF82bEb377e2e5ADE0;
