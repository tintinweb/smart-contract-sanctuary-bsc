...
contract NROL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NROL-87 Mission";
    string private _symbol = "NROL-87";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAfD0F433B4533a2a35452674abb60F88e6859069); // Marketing Address
    address payable public DevWalletAddress = payable(0x0D2854049d83de51Ab5c931946AAd08F7d8c9923); // Dev fee
