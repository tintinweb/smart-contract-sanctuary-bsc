...
// Shibaroo
//
// Shibaroo got the bounce you need brutha
//
//              ▄              ▄    
//             ▌▒█           ▄▀▒▌   
//             ▌▒▒█        ▄▀▒▒▒▐   
...
//
// Best Contract Ever
//   - Anti-Bot no clowning around
//   - Got claims and compounding for future rewards
//   - Market taxes to rocketship to the moon
//   - Sell tax bump to keep the rocket steady
//
//
//////////////////////////////////////////////////////////
...
contract Shibaroo is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "Shibaroo";
    string private _symbol = "$SHIROO";
    ...
    // Explicit Sales Fee
    uint256 public totalSaleFeeBPS = 3500;
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Shibaroo: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "Shibaroo: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Shibaroo: Sender is blacklisted");
        require(!isBlacklisted[recipient], "Shibaroo: Recipient is blacklisted");

        require(sender != address(0), "Shibaroo: transfer from the zero address");
        require(recipient != address(0), "Shibaroo: transfer to the zero address");
        ...
        require(
            ...
            "Shibaroo: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "Shibaroo: approve from the zero address");
        require(spender != address(0), "Shibaroo: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "Shibaroo: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "Shibaroo: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "Shibaroo: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Shibaroo: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Shibaroo: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Shibaroo: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Shibaroo: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "Shibaroo: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "Shibaroo_DividendTracker";
    string private _symbol = "Shibaroo_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "Shibaroo_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "Shibaroo_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "Shibaroo_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "Shibaroo_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("Shibaroo_DividendTracker: method not implemented");
    }
