...
contract TheNothingProject is IERC20 {
    ...
    string constant private _name = "The Nothing Project";
    string constant private _symbol = "$NOTHING";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        development: payable(0xb3A621a310C905885b1896Bae24281Ac24034210)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 development) external onlyOwner {
        ...
        _ratios.total = liquidity + development;
    }
