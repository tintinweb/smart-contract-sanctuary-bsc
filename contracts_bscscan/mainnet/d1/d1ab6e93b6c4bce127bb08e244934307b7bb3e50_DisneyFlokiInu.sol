...
contract DisneyFlokiInu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Disney Floki Inu';
    string private constant _symbol = '$DFInu';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000 * 10**_decimals;//equals 500B tokens

    //Divider for the MaxBalance based on circulating Supply (2.1%)
    ...
    //DevWallets
    address public TeamWallet=payable(0x137649C95D97FF5f30A9886eCF6Ff52d8298dC10);
    address public walletTwo=payable(0xE1DCe63c001A068286624129fDE9d83A69FB596b);
    //TestNet
