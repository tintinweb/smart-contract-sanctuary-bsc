...
/**
 Telgram. https://t.me/Mrspolkabsc
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PolkadotReward = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PolkadotReward.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(PolkadotReward);
        ...
        uint256 amount = PolkadotReward.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PolkadotReward.transfer(shareholder, amount);
...
contract MrsPolka is IBEP20, Auth {
    using SafeMath for uint256;

    address PolkadotReward = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mrs Polka";
    string constant _symbol = "MRSPOLKA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    
    //max transaction holding of 2% 
    ...
    // turn On Anti Bot
    function swapAntiBot(bool _status) public onlyOwner {
        swapBaby = _status;
    }
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit InvitedAllow(amountBNBLiquidity, amountToLiquify);
        }
    }
...
/* Airdrop Begins */
 ...
 function airdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    event InvitedAllow(uint256 amountBNB, uint256 amountBOG);
