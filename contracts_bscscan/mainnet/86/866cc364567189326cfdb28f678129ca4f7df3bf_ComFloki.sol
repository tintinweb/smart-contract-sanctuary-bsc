...
contract ComFloki is TRC20 {
    address public owner;
    bool public stopmint;

    modifier onlyOnwer() {
        require(msg.sender == owner, "ComFloki: ACCESS_DENIED");
        _;
    }
    ...
    constructor() public {
        ...
        name = "Community Floki";
        symbol = "ComFloki";
        decimals = 18;
    }

    function mint(address to, uint256 value) external onlyOnwer {
        require(!stopmint, "ComFloki: MINT_ALREADY_STOPED");

        _mint(to, value);
    }

    function burn(uint256 value) external onlyOnwer {
        require(balanceOf[msg.sender] >= value, "ComFloki: INSUFFICEINT_FUNDS");
