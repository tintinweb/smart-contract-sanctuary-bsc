...
contract GuailingDAO is Context, Ownable{
    mapping (address => uint256) public balance;
    mapping (address => mapping(address => uint256)) public allowance;
    mapping (address => bool) private isFrozen;
    uint256 public totalSupply = 8000000 * 10 ** 9;
    string public name = "Guailing";
    string public symbol = "Guailing";
    uint256 public decimals = 9;

    uint256 public burnTaxPercent = 2;
