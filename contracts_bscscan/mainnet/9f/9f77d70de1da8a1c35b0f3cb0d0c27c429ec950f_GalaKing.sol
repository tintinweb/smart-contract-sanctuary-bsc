...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GALABEP20 = IBEP20(0x7dDEE176F665cD201F93eEDE625770E2fD911990);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GALABEP20.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(GALABEP20);
        ...
        uint256 amount = GALABEP20.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GALABEP20.transfer(shareholder, amount);
...
contract GalaKing is IBEP20, Auth {
    using SafeMath for uint256;

    address GALABEP20 = 0x7dDEE176F665cD201F93eEDE625770E2fD911990;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GalaKing";
    string constant _symbol = "GALAKING";
    ...
    function BalanceLiq(bool _status) public onlyOwner {
        swapBaby = _status;
    }
