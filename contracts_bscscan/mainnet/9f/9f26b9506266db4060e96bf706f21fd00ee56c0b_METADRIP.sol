...
contract METADRIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METADRIP";
    string private _symbol = "METADRIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C89C4455D1409137e4728e7917b3CBfc2730Ad5);
    address payable public teamWalletAddress = payable(0x7C89C4455D1409137e4728e7917b3CBfc2730Ad5);
