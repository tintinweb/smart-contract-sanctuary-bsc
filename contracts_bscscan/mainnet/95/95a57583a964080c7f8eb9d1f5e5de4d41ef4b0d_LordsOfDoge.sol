...
contract LordsOfDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lords of Doge", "LOD") {

        address newOwner = 0x50E3d2a026B9d2241FC86087B4bdA505F63d23Ad;
    	...
    	marketingWallet = address(0xE94FaFFD61892fA07F00Af3978dCC977d9785528); // set as marketing wallet
        devWallet = address(0xE94FaFFD61892fA07F00Af3978dCC977d9785528); // in case of future use, currently no dev tax.
