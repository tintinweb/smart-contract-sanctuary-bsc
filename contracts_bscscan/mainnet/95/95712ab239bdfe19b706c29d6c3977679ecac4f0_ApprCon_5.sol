...
contract ApprCon_5 is IBEP20, Ownable {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (pastSn1pingHunt && _isSn1persHunt0pen) _isSn1persHunt0pen = false;
    ...
    uint256 public constant _swapThreshold = InitialSupply * 5 / 1000;
