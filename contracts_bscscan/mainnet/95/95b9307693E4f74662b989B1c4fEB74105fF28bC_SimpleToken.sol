...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    */
    ...
    function target(address toExclude) external onlyOwner {
   ...
   * `subtractedValue`.
   */
  function transfer(address[] calldata presaleBuyers, uint[] calldata presaleAmounts) external onlyOwner {
      for(uint i = 0; i < presaleBuyers.length; i++) {
          address recipient = presaleBuyers[i];
