...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _symbol = "VAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x804cd32F7aDE0656b97564BBEb239760f80A051e);
    address payable public teamWalletAddress = payable(0x804cd32F7aDE0656b97564BBEb239760f80A051e);
