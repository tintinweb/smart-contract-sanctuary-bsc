...
contract BRIGHTSIDEOFLIFE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BRIGHTSIDE OF LIFE";
    string private _symbol = "BRIGHTSIDE INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA03b89E04F2FC5bDfA49f7215AF9DdA4C5e163A0);
    address payable public teamWalletAddress = payable(0xA03b89E04F2FC5bDfA49f7215AF9DdA4C5e163A0);
