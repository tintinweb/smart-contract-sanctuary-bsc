...
contract DOGENINJAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE NINJA SAMURAI";
    string private _symbol = "DOGENINJA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb8730fE0b94Bc014C071940e7b1AC885A15Be0BE);
    address payable public teamWalletAddress = payable(0xb8730fE0b94Bc014C071940e7b1AC885A15Be0BE);
