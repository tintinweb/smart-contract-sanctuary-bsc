...
contract Visit is IBEP20, Auth {
    ...
    string constant _name = "CloverBUSD";
    string constant _symbol = "CLOVER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xb446e6C2CbF33c4945cf79AC33B0376C534dA12C;  // teamwallet
        lotteryWallet = 0xb446e6C2CbF33c4945cf79AC33B0376C534dA12C;  // lotterywallet
