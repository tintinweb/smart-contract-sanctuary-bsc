...
// Root file: contracts/v3/JuiceToken.sol
...
contract MUICE is Context, IERC20, Ownable {
    ...
    string private constant _name = "MUICE";
    string private constant _symbol = "MUICE";
    ...
    function _swapTokens(uint256 _contractTokenBalance) private lockTheSwap {
        ...
        uint256 rewardsBNBBalance  = bnbBalanceUpdate.mul(bnbRewardsFee).div(
            _liquidityFeeTotal
        );
        ...
        uint256 committeeBNBBalance = bnbBalanceUpdate.mul(committeeFee).div(
            _liquidityFeeTotal
        );
        ...
        uint256 leaderboardBNBBalance = bnbBalanceUpdate.mul(leaderboardFee).div(
            _liquidityFeeTotal
        );
