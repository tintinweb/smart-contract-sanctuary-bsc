...
library Address{
 ...
 contract GongXiFaChai is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x13F41D457902464AB27b638b41857BdF0c7A82Ba;
    address private buybackWallet = 0x5De5d9e1F3986e82DF6FF38184B97A750adcCa84;

    string private constant _name = "Gong Xi Fa Chai";
    string private constant _symbol = "GXFC";
    ...
    Taxes public taxes = Taxes(1, 5, 5, 5);
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(buybackWallet).sendValue(donationAmt);
        }
    }
