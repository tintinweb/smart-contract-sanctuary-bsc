...
🟥TOKENOMICS: 
🔵 11% Tax for each Buy/Sell: 
⏰ Fair Launch 4PM UTC 31/01/2022
🧧 4% BNB Reward to Holders 
🧧 4% Marketing to increase our exposure  
🧧 2% Add to LP creating a stable price floor  
🧧 1% Auto Burn to the moon it in the long haul 

📌MAX TX is 3%
*TG: https://t.me/LunarTiger
*/
...
contract LunarTiger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "LunarTiger";
    string private _symbol = "LunarTiger";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**9 * (10 ** _decimals);//1,000,000,000,000 1T

    uint256 public _maxTxAmount = ( _totalSupply * 2 )  / 100;//10,000,000,000

    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100;//20,000,000,000
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 300000; // 3% of supply
    bool inSwap;
