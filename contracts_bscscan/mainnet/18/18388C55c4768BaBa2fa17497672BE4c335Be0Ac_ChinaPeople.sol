...
contract ChinaPeople is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChinaPeople";
    string private _symbol = "ChinaPeople";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFFD49368247Fde17D73CF12Fe1b62F18d5c27777);
    ...
    uint256 private _totalSupply = 14 *  10**8 * 10**_decimals;
