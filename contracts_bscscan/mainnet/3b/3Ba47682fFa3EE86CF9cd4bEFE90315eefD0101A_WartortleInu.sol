...
contract WartortleInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WartortleInu";
    string constant _symbol = "WTI";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x84C02d62b4400670f9fC8C406599d08D43A1e7F2;
