...
contract EpliepticParrot is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "EpilepticParrot";
    string constant _symbol = "EPTP";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10_000_000_000_000_000 * (10 ** _decimals);
	...
	uint256 private liquidityFee = 120;
    uint256 public liquidityTax = 50;
    ...
    address payable  public marketingWallet = payable(0xDDa0FC28E5E81089885368f8F9C945a3802bd111);
