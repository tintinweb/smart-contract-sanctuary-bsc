...
//  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
// | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
// | | ____    ____ | || |      __      | || | ____    ____ | || |     _____    | || | ____    ____ | |
// | ||_   \  /   _|| || |     /  \     | || ||_   \  /   _|| || |    |_   _|   | || ||_   \  /   _|| |
// | |  |   \/   |  | || |    / /\ \    | || |  |   \/   |  | || |      | |     | || |  |   \/   |  | |
// | |  | |\  /| |  | || |   / ____ \   | || |  | |\  /| |  | || |      | |     | || |  | |\  /| |  | |
// | | _| |_\/_| |_ | || | _/ /    \ \_ | || | _| |_\/_| |_ | || |     _| |_    | || | _| |_\/_| |_ | |
// | ||_____||_____|| || ||____|  |____|| || ||_____||_____|| || |    |_____|   | || ||_____||_____|| |
// | |              | || |              | || |              | || |              | || |              | |
// | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
//  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
contract MAMI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x8A267C25e05820Ea1C71A22A425275E6C874Cc83));
    address payable public devWallet =
        payable(address(0x14EA74Fa84A201dE3a6bc465E3BC167652c37AD4));
    address public liquidityReceiver =
        0x8A267C25e05820Ea1C71A22A425275E6C874Cc83;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Mamim Inu";
    string private _symbol = "MAMIM";
