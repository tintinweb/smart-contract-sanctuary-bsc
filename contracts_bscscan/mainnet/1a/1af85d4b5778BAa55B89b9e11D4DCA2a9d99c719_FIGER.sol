...
contract FIGER is IERC20Metadata, Ownable {
    ...
    address public marketingWallet = 0x407D464275B3AA6c0DFdb6B66D29516A49F423F4;
    address public devWallet = 0x4Ee4dF10797Cf7333ad4262080152A2C68BbCd61;
    address public teamWallet = 0x17aDE00a598270E8c564358e21fA724AB38eEB66;
    
    string constant _name = "Flaming Tiger";
    string constant _symbol = "FIGER";
    ...
    uint256 public maxTxAmount = _totalSupply / 200; // 0.5% of the total supply
    uint256 public maxWalletBalance = _totalSupply / 100; // 0.5% of the total supply
