...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a E-CNY shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract ECNY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "E-CNY";
    string private constant _symbol = "E-CNY";
    ...
    uint256 private maxBuy = 1000000000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0xe25aa447073273e4F9C6E3D4fd18E430E51b7E1B) {
        address _owner = 0xe25aa447073273e4F9C6E3D4fd18E430E51b7E1B;
