...
contract SGC is IBEP20, Auth {
    ...
    string constant _name = "Super Gold Crown";
    string constant _symbol = "SGC";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2100 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(1000);
    uint256 public _maxWalletToken = _totalSupply.mul(3).div(1000);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xB241c10BfF4c3d229f57dfDbAc70362b6b778141;
        ecosystemfeeReceiver = 0xB241c10BfF4c3d229f57dfDbAc70362b6b778141;
