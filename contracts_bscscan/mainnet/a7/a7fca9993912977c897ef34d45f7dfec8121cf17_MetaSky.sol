...
/* Token contract */
contract MetaSky is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Meta Sky";
    string constant _symbol = "MetaSky";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 10000;  // 3% max or 2M
    uint256 public _maxWalletToken = _totalSupply * 300 / 10000; // 4% or 4M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 400.000 tokens or 0.04% of supply
