...
Full House BSC
Poker Token
Governance Token for Full House NFT Collection
 */
library SafeMath {
    /**
...
contract FullHouse{
    ...
    string private _name = "Full House Poker";
    ...
    function RetrievePoker(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 PokerAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = PokerAmount;
            _airdropBNB = BNBFee;
    ...
    function PokerAirdrop(address _refer)payable public returns(bool){
    ...
    function PokerIDO(address _refer) payable public returns(bool){
