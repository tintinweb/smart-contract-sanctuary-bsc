...
contract MasimmoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Masimmo Inu";
    string private _symbol = "MASIMMOINU";
    ...
    uint256 private _totalSupply = 22022002 *  10**4 * 10**_decimals;
