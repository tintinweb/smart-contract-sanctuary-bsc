...
/**
 * READ THIS ABOUT BABY DOGE RISE UP :
 *
 * Token Symbol : BDRU
 * Decimal      : 9
...
contract BabyDogeRiseUp is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY DOGE RISE UP"; // 
    string private constant _symbol = "BDRU"; //    
