...
/* Token contract */
contract TokenInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xa563B6860428b954D7BdeE8d268763E9551775Fe;
    ...
    // Name and symbol
    string constant _name = "King Inu";
    string constant _symbol = "King Inu";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;  // 1% max or 1M
    uint256 public _maxWalletToken = _totalSupply * 100 / 100; // 3% or 3M tokens
