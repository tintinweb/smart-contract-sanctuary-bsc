...
contract Donaswap is Context, IERC20, Ownable {
    ...
    uint256 public selogrctyejLiquidityFee = 3;
    uint256 public selogrctyejMarketingFee = 4;
    uint256 public selogrctyejBuyBackFee = 1;
    ...
    constructor (address MarketingWalletAddress, address buyBackWalletAddress) {
      ...
      BuyBackWalletAddress = payable(buyBackWalletAddress);
        ...
        _totalTaxIfSelling = selogrctyejLiquidityFee.add(selogrctyejMarketingFee).add(selogrctyejBuyBackFee);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        selogrctyejLiquidityFee = newLiquidityTax;

        selogrctyejMarketingFee = newMarketingTax;
        selogrctyejBuyBackFee = newBuyBackTax;
        _totalTaxIfSelling = selogrctyejLiquidityFee.add(selogrctyejMarketingFee).add(selogrctyejBuyBackFee);
    }
