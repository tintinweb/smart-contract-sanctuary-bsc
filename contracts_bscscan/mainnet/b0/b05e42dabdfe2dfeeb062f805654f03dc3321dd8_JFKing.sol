...
contract JFKing is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("JFKing", "JFKing") {
        addressForMarketing =address(0x54bBB81830A0D72a7bcFA2F9978978683408F71d);
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender, addressForMarketing, _fee.mul(600).div(1000));
