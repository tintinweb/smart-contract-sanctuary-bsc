...
DESKRIPTION: MoonBase 🌘

Preparation for the mission to fly to the moon !

Unique project with a website-based, MoonBase will run projects that focus on determining the launch agenda safely with secure Dev 


TG: https://t.me/Moonbases
...
contract Moonbase is Context, IERC20, Ownable { 
    ...
    string private _name = "Moon Base"; 
    string private _symbol = "MBases";  
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x88aA5BD7f8B691eaAD7f5e28254b13E8155329BB);
