 ...
 * 
 */
contract HUMAN is IERC20 {
    
    using SafeMath for uint256;
    
    //LB token, creator will take 1.2% fee
    ...
    constructor() {
       mint(msg.sender,  (10 ** (totalLength - 2)) * (10 ** decimals));
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 fee = amount * 12 / 1000;
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 LB
