...
contract HolderCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Holder Coin";
    ...
    address  public communityAddress = 0x4AB479b54B9281f191C20812196e8f6216Aa8C48;
    ...
    if(saleend==true)
    {
        ...
        uint256 numTokensSellToAddToLiquidity = (_tTotal.div(10**9)<100 ? 100 : _tTotal.div(10**9));
