...
contract DragonZillaKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DragonZillaKing";
    string private _symbol = "DragonZillaKing";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x79A42a534163b8bA25B9d9d1915f2bb5B94a4506);
    address payable public teamWalletAddress = payable(0x8EF0a13f7578F4322988DBff497b5331416de7A2);
