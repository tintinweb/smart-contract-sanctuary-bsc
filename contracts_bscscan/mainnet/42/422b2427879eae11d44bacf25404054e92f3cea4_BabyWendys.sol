...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEB88BbDdC536a41CCdBc582F0C5b2Ea38c3da48e;
...
contract BabyWendys is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xEB88BbDdC536a41CCdBc582F0C5b2Ea38c3da48e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyWendys";
    string private _symbol = "BBYWendys";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**7;
