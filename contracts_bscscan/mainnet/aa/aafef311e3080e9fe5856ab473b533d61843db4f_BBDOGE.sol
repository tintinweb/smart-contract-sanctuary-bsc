...
abstract contract Auth {
   ...
   constructor(address _owner) {
       owner = 0xa814C6a4be53E31e33e0a473eDF510a950D2f622;
...
contract BBDOGE is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BABY DOGECOIN";
   ...
   // Buy Fees
    uint256 liquidityFeeBuy = 30; 
    uint256 buybackFeeBuy = 50;
    uint256 reflectionFeeBuy = 0;
    uint256 marketingFeeBuy = 50;
    uint256 totalFeeBuy = 130;

    // Sell fees
    uint256 liquidityFeeSell = 40;
    uint256 buybackFeeSell = 50;
    uint256 reflectionFeeSell = 0;
    uint256 marketingFeeSell = 60;
    uint256 totalFeeSell = 150;
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = msg.sender; //dev wallet
