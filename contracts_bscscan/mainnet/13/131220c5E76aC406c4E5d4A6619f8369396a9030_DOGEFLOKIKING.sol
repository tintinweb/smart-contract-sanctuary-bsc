...
contract DOGEFLOKIKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE FLOKI KING";
    string private _symbol = "$DFK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCF840a72260bdb1073e4aBD513230844ce746E06);
    address payable public teamWalletAddress = payable(0xCF840a72260bdb1073e4aBD513230844ce746E06);
