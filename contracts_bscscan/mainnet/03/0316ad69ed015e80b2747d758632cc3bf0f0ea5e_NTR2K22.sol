...
contract NTR2K22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " NoToRug2k22 ";
    string private _symbol = "NTR2K22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x041904CF5f0F42FC04CaDdE6Ae93933ff7f89777);
    address payable public teamWalletAddress = payable(0x20Efc77b9428a3a3459cB7E9FE43E463C531d9fa);
