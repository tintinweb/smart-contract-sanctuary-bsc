...
contract OneHundred is Context, IERC20, Ownable {
    ...
    string private _name = "One Hundred";
    string private _symbol = "100";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07d500942601Ba0C749761A245aFC1445B2d9115);
    address payable public teamWalletAddress = payable(0x07d500942601Ba0C749761A245aFC1445B2d9115);
