...
contract AlwaysLiveBurgers is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Always Live Burgers";
    string constant _symbol = "ALB";
    ...
    uint256 public swapThreshold = _totalSupply / 200000; // 0.00005%
    bool inSwap;
