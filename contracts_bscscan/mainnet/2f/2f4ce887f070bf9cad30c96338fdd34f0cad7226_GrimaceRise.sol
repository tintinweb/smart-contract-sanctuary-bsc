...
contract GrimaceRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2Ea9C66df844862f100B937ca7eDa10dF32Fd5bB); // Marketing Address
    ...
    string private _name = "GRIMACE RISE";
    string private _symbol = "GRIMR";
