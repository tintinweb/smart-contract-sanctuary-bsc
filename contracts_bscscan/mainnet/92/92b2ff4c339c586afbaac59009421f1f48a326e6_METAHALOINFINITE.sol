...
/**
WELCOME TO META HALO INFINITE 

 STEALTH LAUNCH TODAY !


Its a community token that have highly sustainable growth for investors 
with its huge marketing plans. $MHI guarantees to have our liquidity
locked and provide a rug-proof environment throughout the process.


$MHI is a deflationary token that intends to reward its holders 
...
pragma solidity ^0.6.12;
    ...
    contract METAHALOINFINITE is Context, IERC20, Ownable {
        ...
        string private _name = 'METAHALOINFINITE';
