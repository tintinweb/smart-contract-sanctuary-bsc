...
contract Spacepanda is Context, IERC20, Ownable {
    ...
    string private _name = "Space panda coin";
    string private _symbol = "Space Panda";
    ...
    address public ownerAddres = address(0xd2da85d68fCe03aD6470900AA79A4231c833D354);
    address public devAddress = address(0xcE72B7C09707aAdFAA5cdaA2b5E9E8e7Da2bFadB);
