...
TOKENOMICS:
Supply: 15,000,000,000 tokens
5% marketing
3% LP
5% Hyperflate mechanism

1% max wallet

TG: https://t.me/OniOfficial
Website: https://yokaioni.com/
###################################################################################
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 AETH = IERC20(0x5A3B6f18Dc79D50ab208af2fCd61D10BF7e4896F);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AETH.balanceOf(address(this));
        ...
        uint256 amount = AETH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AETH.transfer(shareholder, amount);
...
contract Yokai is IERC20, Ownable {
    ...
    address AETH = 0x5A3B6f18Dc79D50ab208af2fCd61D10BF7e4896F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Yokai";
    string constant _symbol = "ONI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 150_000_000_000 * (10 ** _decimals); // 
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x2510f509C845a18Da3786af6404529d1c5A6B0C2);
        marketingFeeReceiver = address(0x2510f509C845a18Da3786af6404529d1c5A6B0C2);
