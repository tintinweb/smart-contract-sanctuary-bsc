...
contract ShinjaKing is Context, IERC20, Ownable { 
    ...
    string private _name = "ShinjaKing"; 
    string private _symbol = "SJKing"; 
    ...
    address public devWallet = 0x56F4E7afc35066b8F7D9115e673dB303E5173f56; 
    ...
    uint256 public _maxTxAmount = 2 * 10**6 * 10**9; //none 
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**5 * 10**9; 
    uint256 public _maxWalletToken = 3 * 10**6 * 10**9; 
