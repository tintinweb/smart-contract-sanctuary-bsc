...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract PajeetKing is Context, IERC20, Ownable {
    ...
    string private _name = "PajeetKing";
    string private _symbol = "Pajeet王";
    ...
    uint256 public _maxWallet = 40000000000000 * 10**9; //4% of TS
    uint256 public _maxTxAmount = 20000000000000 * 10**9; //2% of TS
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0xabe16a2D26727C1D1A4937594E8A2CbbA583D9F8;
        _developerAddress = 0xE9DC17148249e468a4A131bB8Fcee0eF6E5617E9;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "FantomInu: cannot burn from zero address");
    require(_balances[account] >= amount, "FantomInu: Cannot burn more than the account owns");
