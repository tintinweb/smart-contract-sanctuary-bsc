...
contract LaunchPadMetamall is Ownable {
    ...
    function round2Allowance(address _address) public view returns (uint256) {
        ...
        if (_hasParticipated[_address]) {
            ...
            result = round1Allowance[_address].mul(100);
        }
        return result;
    }

    uint256 public tokenTarget = 20000000 * 1E18;
    uint256 public stableTarget = 100000 * 1E18;
    uint256 public multiplier = 20000; // div per 100
    ...
    function buyRound1Stable(uint256 _amount) external {
        ...
        if (!_hasParticipated[msg.sender]) {
            ...
            _round2Allowance[msg.sender] = round1Allowance[msg.sender].mul(100);
        }
