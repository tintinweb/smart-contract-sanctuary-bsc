...
📌Twitter : https://twitter.com/folk_comfloki/status/1488421745916841990?s=24

👾Discord : https://discord.gg/NEE3TWXu

🔮Website :
https://communityfloki.vercel.app
...
library Address{
 ...
 contract ComFloki is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 1_500_000_000 * 10**9; //2%
    uint256 public maxSellLimit = 500_000_000 * 10**9; //1%
    uint256 public maxWalletLimit = 5_000_000_000 * 10**9; //5%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xD9540fc36A3d1294Ff8C694b49d179EC0B32B7B7;
    address public donationWallet = 0xD9540fc36A3d1294Ff8C694b49d179EC0B32B7B7;

    string private constant _name = "NewCOMFLOKI";
    string private constant _symbol = " ComFloki ";
    ...
    Taxes public taxes = Taxes(1, 4, 5, 0);
    Taxes public sellTaxes = Taxes(3, 7, 5, 0);
