...
contract GmDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gold medal doge king";
    string private _symbol = "GmDogeKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x356398fceD6099706Ad00D210E965234D293F43b); 
    address payable public teamWalletAddress = payable(0x5104b1e04F1196f7968084F84928e63b525489a8); 
