...
contract GRIMACEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrimaceKing";
    string private _symbol = "GrimaceKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA88B9F3B09f2CEf01F76E373FB4a34C943C0CF83); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6f77274052e7A272EF62C4b0E836011CA1b17cF0); // buyback Address
    ...
    uint256 public _marketingFee = 91;
    ...
    uint256 public _maxTxAmount = 10000000 * 10**9; // Max TX 1%
    uint256 public _walletMax = 30000000 * 10**9; // Max Wallet 3%
