...
contract Lovely is Context, ERC20, Ownable {
    ...
    function setTaxes(
        ...
        require(_sellTax <= 40, "Must keep taxes below 40%");
        require(_buyTax <= 40, "Must keep taxes below 40%");
        require(_transferTax <= 40, "Must keep taxes below 40%");
        sellTax = _sellTax;
        buyTax = _buyTax;
