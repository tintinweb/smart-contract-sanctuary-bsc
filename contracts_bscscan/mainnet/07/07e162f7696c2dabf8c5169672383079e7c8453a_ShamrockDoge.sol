...
/**
   ...
   Welcome ShamrockDoge

 
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @ShamrockDoge
   ...
   I will add .3 BNB and all the left 50% total supply to the pool
   Can you make #ShamrockDoge 10000X? 
...
contract ShamrockDoge is Context, IERC20, Ownable {
    ...
    string private _name = "ShamrockDoge";
    string private _symbol = "ShamrockDoge";
