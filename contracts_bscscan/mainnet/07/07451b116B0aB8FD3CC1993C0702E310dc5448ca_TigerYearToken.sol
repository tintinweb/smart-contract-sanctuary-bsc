...
/*
    Telegram : https://t.me/tigeryearbsc
...
contract TigerYearToken is Context, IERC20, Ownable {
    ...
    string private _symbol = "TYEAR";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**2 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x09398cF5045aCf4aD22623BDd5785d38dA071892);
    address public marketingWalletToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public constant developmentAddress = 0x09398cF5045aCf4aD22623BDd5785d38dA071892;
    ...
    constructor () {
        ...
        _liquidityThreshhold = 1000 * 10**2 * 10**_decimals;
        _isMaxBalanceWallet = 1000000 * 10**2 * 10**_decimals;
