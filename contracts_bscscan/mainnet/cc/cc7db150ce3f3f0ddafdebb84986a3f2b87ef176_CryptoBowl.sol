...
/**
Wait...What? - Cryptobowl

Telegram: https://t.me/cryptobowlofficial
*/
...
contract CryptoBowl is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "CryptoBowl";
    string constant _symbol = "SuperBowl";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 33;
	...
	uint256 private liquidityFee = 140;
    uint256 public liquidityTax = 40;
    ...
    address payable  public marketingWallet = payable(0x6960dBAE76864f3917567480a7acCc235e612F5d);
    ...
    function setFees(uint256 _liquidityFee, uint256 _totalTax, uint256 _feeDenominator, uint256 _sellMultiplier, uint256 _sellDenominator) external authorized {
        ...
        require(totalFee * sellMultiplier / sellDenominator < feeDenominator / 3, "Maximum allowed selltax on this contract is 33%.");
    }
