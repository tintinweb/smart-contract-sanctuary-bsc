...
contract DogeOwner is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xDCBB125A0211c6d64B034D924cB4Dc72d13218A5); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x0867c1520498B574cbE9BF772f8217bCbd7200Aa); // Liquidity Address
    ...
    uint256 private constant _tTotal = 690000000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "DogeOwner";
    string private constant _symbol = "DogeOwner";
    ...
    constructor() {
        address newOwner = address(0x0867c1520498B574cbE9BF772f8217bCbd7200Aa);
