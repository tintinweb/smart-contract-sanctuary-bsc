...
contract EXWALL is Context, IERC20, Ownable {
    ...
    address private _ExWalletAddress;     // TEAM WALLET ADDRESS
    ...
    constructor (
    ...
    
     {
        ...
        //exclude devWallet, owner and this contract from fee
    ...
    function excludeWall(address account) public onlyOwner {
        _isExcludedWall[account] = true;
    }
    
    function includeWall(address account) public onlyOwner {
        _isExcludedWall[account] = false;
    }   
    ...
    function isExcludedWall(address account) public view returns(bool) {
        return _isExcludedWall[account];
    }
