 ...
 */
contract HULKPRE is Ownable, IERC20 {
    using Address for address;
     ...
     * construction.
     */
    constructor(address cOwner, uint256 _basePrice) Ownable(cOwner) {
    ...
    function coinToTokens(uint256 _amountIn, address _coin) public view returns (uint256){
        ...
        uint256 result = _amountIn * rate / _prices[_currentRound] / 10 ** 12;
    ...
    function tokensToCoin(uint256 _amountIn, address _coin) public view returns (uint256) {
        ...
        uint256 result = _amountIn * _prices[_currentRound] * 10 ** 12 / rate;
        return result;
    }
    ...
    function buyTokens(uint256 _amount, address _coin) public payable {
        ...
        if (_coin == address(0)) {
            ...
            IERC20 coin_contract = IERC20(_coin);
