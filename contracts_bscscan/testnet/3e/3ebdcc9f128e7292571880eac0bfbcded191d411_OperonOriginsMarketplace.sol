...
contract OperonOriginsMarketplace {
        ...
        payable
    {
        ...
        if (
            ...
            address nftCreator = hostContract.getTokenOwner(
            ...
            (uint256 _adminfee, uint256 roy, uint256 netamount) = calc(
                ...
                _royal[offeringRegistry[_offeringId].tokenId],
                serviceValue
            );
            ...
            uint256 royaltyAmount = _royal[
                offeringRegistry[_offeringId].tokenId
            ];
            if (royaltyAmount == 0) {
                royaltyAmount = defaultRoy * 1e18;
            }
            (uint256 _adminfee, uint256 roy, uint256 netamount) = calc(
                offeringRegistry[_offeringId].price,
                royaltyAmount,
    ...
    function percentageCalc(uint256 value1, uint256 value2)
        ...
        returns (uint256)
    {
        uint256 result = (value1 * value2) / 1e20;
        return (result);
    }
