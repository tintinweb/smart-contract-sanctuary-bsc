...
// File: contracts/interfaces/IBeefLottery.sol

pragma solidity ^0.8.4;

interface IBeefLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in BEEF per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in BEEF token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInBeef: price of a ticket in BEEF
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Beef lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == BeefLottery, "Only BeefLottery");
    ...
    /**
     * @notice Set the address for the BeefLottery
     * @param _beefLottery: address of the Beef lottery
     */
    function setLotteryAddress(address _beefLottery) external onlyOwner {
        BeefLottery = _beefLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBeefLottery(BeefLottery).viewCurrentLotteryId();
    }
}