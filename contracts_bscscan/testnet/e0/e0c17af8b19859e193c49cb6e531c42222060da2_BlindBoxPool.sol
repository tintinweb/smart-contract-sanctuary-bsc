...
interface IBBT721 is IERC721 {
    function categories(uint256) external view returns (uint8);
    function levels(uint256) external view returns (uint8);
}
...
//    IERC721 public blindBox;

    mapping(address => bool) public minters;

    constructor(address _ticketToken) public {
    ...
    function getLevel(uint256 tokenId) public view returns (uint8) {
        return ticket721.levels(tokenId);
    }
}