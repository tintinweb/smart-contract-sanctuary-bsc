...
contract DRUMANDBASS is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "DRUMANDBASS";
    ...
    uint256 private _tTotal = 10**14 * _decimalFactor; // Tokens total
    ...
    uint256 public _maxTxAmount = 10 * 10**10 * _decimalFactor;
    ...
    /* Payable fee wallets */
    address payable public _developerAddress =
        payable(address(0xE3a0d9eFB62f91aA3E3666C4709c7D64b2d35ea9));
    address payable public _marketingAddress = 
        payable(address(0x750D629014BdF42bB1B86D99E87c9522016AEBec));
