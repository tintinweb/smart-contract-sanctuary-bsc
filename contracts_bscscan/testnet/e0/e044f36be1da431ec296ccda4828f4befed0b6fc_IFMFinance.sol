...
//=================================================================================================================================
    ...
    function New_St1_Miner(address payable Invitee_Address) payable public {
...
//=================================================================================================================================
    ...
    function New_St2_Miner(address payable Invitee_Address) payable public {
        require (msg.sender == tx.origin, "All Miners should be EOA!");
        bool paid = payable(FeeFunds).send(MiningFee);
        require(paid, "Not enough funds!");
...
//=================================================================================================================================
    ...
    function New_St3_Miner(address payable Invitee_Address) payable public {
        require (msg.sender == tx.origin, "All Miners should be EOA!");
        bool paid = payable(FeeFunds).send(MiningFee);
        require(paid, "Not enough funds!");
...
//=================================================================================================================================
    ...
    function New_St4_Miner(address payable Invitee_Address) payable public {
        require (msg.sender == tx.origin, "All Miners should be EOA!");
        bool paid = payable(FeeFunds).send(MiningFee);
        require(paid, "Not enough funds!");
...
//=================================================================================================================================
     ...
     function New_St5_Miner(address payable Invitee_Address) payable public {
        require (msg.sender == tx.origin, "All Miners should be EOA!");
        bool paid = payable(FeeFunds).send(MiningFee);
        require(paid, "Not enough funds!");
