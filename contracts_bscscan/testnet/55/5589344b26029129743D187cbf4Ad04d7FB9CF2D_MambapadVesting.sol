...
contract MambapadVesting is Auth {
  ...
  function approveDeposit(uint256 _amount) public onlyOwner {
    MambaContract.approve(address(this), _amount);
  }
  ...
  function initialDepositVestingAmountsP() public onlyOwner {
    ...
    require(MambaContract.balanceOf(msg.sender)>totalVestingAmount, "owner balance is not sufficient");
  ...
  function initialDepositVestingAmountsPP() public onlyOwner {
    ...
    require(MambaContract.balanceOf(msg.sender)>totalVestingAmount, "owner balance is not sufficient");
    MambaContract.transferFrom(msg.sender, address(this), totalVestingAmount);
    isInitialDeposit = true;
    vestedCount = 1;
