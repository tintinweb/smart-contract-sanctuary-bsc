...
interface IERC20 {
	...
	contract test is ERC20, Ownable {
		...
		address payable public devFundingWallet = payable(0x4F7ad9FeBE0D8E419951EC4205797267AE36B693); 
        ...
        // Transaction Limit
		uint256 public maxInitTxLimit = 1000000 * (10**9); 
		uint256 public maxInitWalletLimit = 10000000 * (10**9);
		...
		uint256 private sniperBlock = 2;
		uint256 private sniperGasLimit = 5000000;
		...
		function setTxLimit(uint256 maxTx) external onlyOwner() {
            maxInitTxLimit = maxTx * 10**9;
			
		}
		
		// Set max Wallet 
		function setMaxWallet(uint256 maxWallet) external onlyOwner() {
            maxInitWalletLimit = maxWallet * 10**9;
