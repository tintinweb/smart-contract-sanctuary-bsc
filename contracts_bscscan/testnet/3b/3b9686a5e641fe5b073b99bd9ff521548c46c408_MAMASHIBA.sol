...
contract MAMASHIBADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("MAMASHIBA_Dividend_Tracker", "MAMASHIBA_Dividend_Tracker") {
        claimWait = 14400;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MAMASHIBA_Dividend_Tracker: No transfers allowed");
    }
    ...
    function withdrawDividend() public pure override {
        require(false, "MAMASHIBA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MAMASHIBA contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MAMASHIBA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
        require(newClaimWait != claimWait, "MAMASHIBA_Dividend_Tracker: Cannot update claimWait to same value");
...
contract MAMASHIBA is ERC20, Ownable, SafeToken, LockToken {
    ...
    constructor() ERC20("MAMA SHIBA", "MAMA") {
        BNBRewardsFee = 5;
        liquidityFee = 3;
	    ...
	    //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Test 
