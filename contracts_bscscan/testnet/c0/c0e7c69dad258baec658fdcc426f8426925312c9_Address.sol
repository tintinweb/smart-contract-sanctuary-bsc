...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    uint256 private _totalSupply = 69000000000  * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _totalSupply));
    uint256 private _tFeeTotal;
    
    
    string private _name = "One Inu";
    string private _symbol = "ONEINU";
    ...
    uint256 public _maxWallet = 1035000000 * 10**9; //1.5% of TS
    uint256 public _maxTxAmount = 345000000 * 10**9; //0.5% of TS
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 172500000* 10**9;
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x19dE5d6109b1E0b3F92ee35be8C347582ad35c72;
        _developerAddress = 0xb0D4bA2409eb852E5c461901ddcACA8D96dc7EBB;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Son Of Baby Doge Coin: cannot burn from zero address");
    require(_balances[account] >= amount, "Son Of Baby Doge Coin: Cannot burn more than the account owns");
