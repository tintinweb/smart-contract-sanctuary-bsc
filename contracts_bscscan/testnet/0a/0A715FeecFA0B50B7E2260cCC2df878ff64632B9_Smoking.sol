...
contract Smoking is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Smoking Kills";
    string constant _symbol = "SMKK";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xDEF743Db60F8cC457C25E1d7A4216C8770E7170f;
