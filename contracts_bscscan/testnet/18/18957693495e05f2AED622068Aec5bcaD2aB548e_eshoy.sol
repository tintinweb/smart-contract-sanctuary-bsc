...
contract eshoy is IBEP20, Auth {
    ...
    function setName(string memory newName) public authorized {
        _name = newName;
    }

    function setSymbol(string memory newSymbol) public authorized {
        _symbol = newSymbol;
    }
