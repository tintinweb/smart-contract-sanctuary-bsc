...
contract Flare is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5_000_0000 * 10**9; 

    string private constant _name = "KingFlare"; 
...
struct BuyFee {
    ...
    function setSellFee(
        ...
        sellFee._marketingFee = marketing;
        sellFee._liquidityFee = liquidity;
    ...
    function setBuyFee(
        ...
        buyFee._marketingFee = marketing;
        buyFee._liquidityFee = liquidity;

    }

    function setBothFees(
 
        uint16 buy_liquidityfee,
        uint16 buy_marketingfee,

        uint16 sell_liquidityfee,
        uint16 sell_marketingfee


    ) external onlyOwner {
 
        buyFee._marketingFee = buy_marketingfee;
        buyFee._liquidityFee = buy_liquidityfee;



        sellFee._marketingFee = sell_marketingfee;
        sellFee._liquidityFee = sell_liquidityfee;
