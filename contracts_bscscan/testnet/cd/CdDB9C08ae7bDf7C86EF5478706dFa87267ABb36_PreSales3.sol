...
contract PreSales3 is Context {
    ...
    bool private _forceClosed = false;
    ...
    /**
     * @dev Force close the sale.
     */
    function forceClose() public{
        require(_msgSender() == wallet(), 'PreSales: No authorization');
        require(isOpen(), 'PreSales: Already closed');
        _forceClosed = true;
    }
    ...
    function isOpen() public view returns (bool) {
        return block.timestamp >= _openingTime && block.timestamp <= _closingTime && !forceClosed();
    }
    ...
    /**
     * @return true if the crowdsale is force closed, false otherwise.
     */
    function forceClosed() public view returns (bool) {
        return _forceClosed;
    }
