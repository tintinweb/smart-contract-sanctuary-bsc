...
contract BnbStake {
	...
	constructor(address payable wallet, address payable developer, uint256 startDate) public {
	...
	function invest(address referrer, uint8 plan) public payable {
        require(uint256(block.timestamp) > startUNIX, "bnbStake will launch soon");
