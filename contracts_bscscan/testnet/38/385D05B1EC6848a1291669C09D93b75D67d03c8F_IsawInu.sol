...
contract IsawInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "IsawInu";
    string constant _symbol = "ISAW";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xA9b72133008cA3df9405dC55A5e1c042Ce6d456a;
                                 
       
        
        totalFee = liquidityFee.add(marketingFee);     //edit by ME
