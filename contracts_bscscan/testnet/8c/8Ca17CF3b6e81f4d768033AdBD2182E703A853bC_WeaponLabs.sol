...
contract WeaponLabs is Ownable, ECIOHelper {
    ...
    function setRatePerPiece(uint256 rate) public onlyOwner {
        ratePerPieces = rate;
    }

    //Forge Fragment
    function forgingWeapon(uint256 tokenAmount) public {
        uint256 rate = tokenAmount * ratePerPieces;
