...
contract StakingBNB {
    ...
    address payable private development_wallet;
    ...
    function stake(address _referrer, uint256 plan_index) external payable {
        ...
        require(plan_index < 24, "Invalid staking duration.");
    ...
    function withdraw() external {
        ...
        for (uint256 i = 1; i < user.stake_count; i++) {
            ...
            (block.timestamp >
                    user.user_stakes[i].withdraw_time + time_step)) {
        ...
        insurance_funds+=total_withdrawable_bonus.mul(insurance_fee).div(PERCENTS_DIVIDER);
