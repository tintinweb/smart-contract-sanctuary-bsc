...
import "IPlearnRouter02.sol";
import "IWETH.sol";
import "PlearnLibrary.sol";
import "TransferHelper.sol";

contract MainRouter02 is IPlearnRouter02 {
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"024fc03504bded41eca645ee0f5b304ac3d9efa238b62610a87e605297b57595" // init code hash
                        )
                    )
                )
            )
