...
contract WW_Miner {
    ...
    mapping(address => User) public users;
     ...
     function initialize(address _waltAddress, address payable _owner, address payable _project, address payable _marketing) public{
        require(!isContract(_owner) && !isContract(_project) && !isContract(_marketing));
