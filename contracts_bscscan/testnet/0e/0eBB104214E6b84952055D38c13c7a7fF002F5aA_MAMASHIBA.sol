...
contract MAMASHIBA is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("MAMA SHIBA FIXED 3", "MAMAFIX3") {
        BNBRewardsFee = 5;
        liquidityFee = 3;
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            super._burn(from,burntaxamount);
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbToAddLiquidityWith = deltaBalance.mul(liquidityFee).div(totalFees.mul(2).sub(liquidityFee)).div(2);
