...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9779C1B9262de9cf33DDd0F51d41b73c1429707E;
...
contract Moonies is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x696A44EF58C4939488D2E25C7D758A014157D6d0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Moonies";
    string private _symbol = "MOONIES";
