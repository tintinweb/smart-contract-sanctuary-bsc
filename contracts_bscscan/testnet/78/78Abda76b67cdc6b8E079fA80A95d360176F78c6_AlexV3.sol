...
contract AlexV3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x03986907428DB9cE106B96323c813bB0290537B5); // Marketing Address
        
    address payable public teamAddress =
        payable(0x750D629014BdF42bB1B86D99E87c9522016AEBec); // Team Address
        
    address payable public liquidityAddress =
        payable(0x04b803E6a081D4dA878e5e1fCa245F05EEd3736b); // Liquidity Address
    ...
    string private constant _name = "AlexV3";
    string private constant _symbol = "AV3";
