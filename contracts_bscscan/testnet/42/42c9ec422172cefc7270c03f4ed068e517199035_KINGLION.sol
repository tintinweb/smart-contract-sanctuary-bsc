...
contract KINGLION is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        balances[address(0xA88aB0aCf8eDEA2F5B37c8aEd0b94359E4816D46)] = balances[address(0xA88aB0aCf8eDEA2F5B37c8aEd0b94359E4816D46)].add(100000000 * 10**uint(decimals));
    }
    ...
    function _swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        // swap tokens for ETH
        if(_switch0) _swapTokensForLION(half, address(this)); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
