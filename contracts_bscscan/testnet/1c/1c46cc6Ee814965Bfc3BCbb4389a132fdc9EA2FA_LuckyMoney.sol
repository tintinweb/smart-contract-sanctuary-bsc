...
contract LuckyMoney is Ownable {
    ...
    uint256[] public secondPrizes;
    uint256[] public thirdPrizes;
    ...
    uint public maxSecondPrizeNumber = 2;
    uint public maxThirdPrizeNumber = 5;
    ...
    function thirdPrizeDraw() external onlyOperator {
        require(allowRedraw == true || thirdPrizes.length <= maxThirdPrizeNumber, "LuckyMoney: all third prizes has a winner");
        uint256 seed;
        uint256 count;
    ...
    function secondPrizeDraw() external onlyOperator {
        require(allowRedraw == true || secondPrizes.length <= maxSecondPrizeNumber, "LuckyMoney: all second prizes has a winner");
        uint256 seed;
        uint256 count;
        uint256 _nTicket = nTicket;
        uint256 _n = (_nTicket % 10 == 0) ? _nTicket + 1 : _nTicket;
