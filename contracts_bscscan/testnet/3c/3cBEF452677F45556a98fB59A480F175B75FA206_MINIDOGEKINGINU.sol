...
//Contract
contract MINIDOGEKINGINU is IBEP20, Ownable {
    ...
    string private constant _name = 'MINIDOGEKINGINU';  
    string private constant _symbol = 'MINIDOGEKINGINU';    
...
/////////////////////////////   TRANSFERS  /////////////////////////////////////////
    ...
    function WithdrawAllTax() public authorized{
        uint256 amount=TaxBalance;
        TaxBalance=0;
    ...
    function WithdrawTax(uint256 amount) public authorized{
        require(amount<=TaxBalance);
        TaxBalance-=amount;
        (bool sent,) =MarketingWallet.call{value: (amount)}("");
        require(sent,"withdraw failed");
    }     
...
/////////////////////////////   DISPLAY INFO  /////////////////////////////////////////
    ...
    function getTaxes() public view returns(uint256 devTax, uint256 marketingTax, uint256 liquidityTax,uint256 rewardsTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
        return (_devTax, _marketingTax,_liquidityTax,_stakingTax,_buyTax,_sellTax,_transferTax);
    }  
