...
/**
 * https://t.me/xxxx v4 - CR7FanTestssol4
*/
...
contract CR7FanTest is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string private constant _name = "Cristiano Ronaldo CR7 Fan Token TT";
    string private constant _symbol = "CR7T5";
    ...
    // Transaction Limits
    uint256 private _maxTxAmount = _tTotal / 100 * 1; //changed
    uint256 private _maxWalletSize = _tTotal / 1000 * 25; //changed
    ...
    // Fee ReceivermarketingFeeReceiver
    ...
    function setBuyFees(uint16 liq, uint16 market, uint16 tax) external onlyOperator {
        require(liq + market + tax <= 7, "Total fees must be below 30%");
