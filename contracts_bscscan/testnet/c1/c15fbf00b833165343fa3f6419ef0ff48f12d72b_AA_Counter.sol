...
STOP Wallet_Counter from buying or selling! 
change all 8 to 256
add emits
Make certik friendly 
fix process maths
...
contract AA_Counter is Context, IERC20 { 
    ...
    */
    ...
    Wallet_Team:    Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_Counter = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828);  // 4.GEN1
    address payable public Wallet_Team = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0); // 1
    ...
    string private constant _name = "AA_Counter"; 
    string private constant _symbol = "AA_Counter"; 
    ...
    constructor () {
        ...
        */
        ...
        _isLimitExempt[Wallet_Team] = true; 
    ...
    */
    ...
    function Wallet_Update_FoxGirl(address payable wallet) external onlyOwner() {
        ...
        emit updatedFoxGirlWallet(Wallet_Team,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_Team] = false; 
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if(
            ...
            balanceOf(Wallet_Counter) >= swapTrigger &&
        ...
        {  
            ...
            // reset counter wallet
            _tOwned[Wallet_Counter] = 0;
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && !_isPair[to] && !_isPair[from])){
            ...
            // Add token to counter wallet

            _tOwned[Wallet_Counter] = _tOwned[Wallet_Counter] + 1; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_FoxGirl != 0){
            ...
            sendToWallet(Wallet_Team, BNB_M);
