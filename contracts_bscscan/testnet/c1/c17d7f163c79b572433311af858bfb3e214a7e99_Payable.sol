...
contract Payable   {
     ...
     */
     ...
     function payInvoice () payable public {
//uint256 amountToPay
         //require(msg.value == amount);

    IBEP20 paymentToken = IBEP20(0x90cf34dA92fd2FfB46410a8257444Fe5170b228B);
    uint256 minimumDeposit = 1E17;
    ...
    //require(amountToPay >= minimumDeposit,"Minimum amount 0.1 BNB");
    //require(paymentToken.transferFrom(msg.sender,address(this),amountToPay),"transfer Failed");
    
    paymentToken.transfer(msg.sender, msg.value);
    //payable(msg.sender).transferFrom(msg.sender,address(this),amountToPay,"transfer Failed");
   ...
   // function emergencyWithdrawFalafel(uint256 WORTHWHILEAmount) public onlyOwner {
     //    FalafelToken.transfer(msg.sender, WORTHWHILEAmount);
    //}
