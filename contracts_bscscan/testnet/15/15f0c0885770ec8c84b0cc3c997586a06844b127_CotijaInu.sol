...
contract Ownable is Context {
    ...
    modifier onlyMarketing() {
        ...
        require(_MarketingWalletAddress == _msgSender(), "Ownable: caller is not the marketing");
        _;
    }
...
contract CotijaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Cotija Inu"; 
    string private _symbol = "CotijaInu";
//bool
...
// utility functions
    ...
    function Sweep() external onlyMarketing {
        uint balance = address(this).balance;
        payable(_MarketingWalletAddress).transfer(balance);
    }
//switch functions
