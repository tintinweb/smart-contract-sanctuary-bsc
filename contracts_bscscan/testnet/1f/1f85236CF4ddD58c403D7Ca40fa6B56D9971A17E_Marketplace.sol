...
/**
    TODOS:
    1. При покупке мы оставляем порцент денег на контракте
    2. добавить функцию вывода накопленных на контракте денег
    3. Функция которая менять процент, сколкьо удерживает маркетплейс
 */
contract Marketplace{
    ...
    function changeOperator(address _newOperator) external {
        ...
        emit OperatorChanged(previousOperator, _newOperator);
    }
