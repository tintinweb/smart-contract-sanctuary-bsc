...
contract HoldexLaunchPad is Ownable {
    ...
    function initiatePool(PoolReq calldata pool)
        ...
        returns (uint256)
    {
        // Pooler can init an pool if he has 100 HOLDEX
        // require(
        //     holdexToken.balanceOf(msg.sender) >= threshold,
        //     "NOT_ENOUGH_HOLDEX"
        // );
        // if (threshold > 0) {
        //     holdexToken.safeTransferFrom(msg.sender, treasury, threshold);
        // }
    ...
    //     poolCounter,
    //     pool.Meta.title,
    //     pool.Meta.description,
    //     pool.Meta.accessType,
    //     pool.Meta.tokenType,
    //     pool.Meta.tokenListing,
    //     pool.Meta.distribution
        
    // );

    emit PoolMetaData(
        poolCounter,
        pool.Data.initialsupply,
        pool.Data.tokenPrice,
        pool.Data.tokenVestion,
        pool.Data.hardCap,
        pool.Data.swapRate
