...
contract CustomBillFactory is Policy {
    ...
    function createBillAndTreasury(
        ...
        customTreasury.initialize(_payoutToken, _initialOwner);
...
interface ICustomTreasury {
    ...
    function initialize(address _payoutToken, address _initialOwner) external;
