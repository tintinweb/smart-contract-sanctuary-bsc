...
contract TESTANO is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "TESTANO";
    string private constant _symbol   = "TANOO";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 1400;
    uint256 private  _percentageOfLiquidityForMarketing = 6700;

    // transfer fee
    uint256 public  _taxFee       = 2; // tax fee is reflections
    uint256 public  _liquidityFee = 8; // ZERO tax for transfering tokens
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0xc9f5A812745357D4730A71EAF8361941C931644A;
        _marketingWallet = 0xc9f5A812745357D4730A71EAF8361941C931644A;
