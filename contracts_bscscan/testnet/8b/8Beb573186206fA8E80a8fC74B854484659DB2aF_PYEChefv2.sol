...
contract Cherry is BEP20, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant FEE_SETTER_ROLE = keccak256("FEE_SETTER_ROLE");
...
contract PYEChefv2 is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        apple.mint(address(cherry), appleReward);
    ...
    function safeAppleTransfer(address _to, uint256 _amount) internal {
        cherry.safeAppleTransfer(_to, _amount);
    }
