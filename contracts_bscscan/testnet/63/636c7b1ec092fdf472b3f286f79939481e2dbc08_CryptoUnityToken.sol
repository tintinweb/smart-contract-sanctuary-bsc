...
contract CryptoUnityToken is Context, IERC20, Ownable {
    ...
    address payable public liquidityWallet = payable(0x60cc208040D701abaC5403853eF0e52eABE7ebB0); 
    ...
    uint256 public _liquidityFee = 7; // liquidity + all team fees
    ...
    uint256 public _buyVaultFee = 2;
    uint256 public _buyLiquidityFee = 1;
    
    uint256 public _sellTaxFee = 6;
    uint256 public _sellVaultFee = 2;
    ...
    uint256 public researchDivisor = 3;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to research address 
        transferToAddressETH(researchAddress, convertedBalance.div(_liquidityFee).mul(researchDivisor));
    ...
    function setresearchDivisor(uint256 divisor) external onlyOwner {
        researchDivisor = divisor;
    }
