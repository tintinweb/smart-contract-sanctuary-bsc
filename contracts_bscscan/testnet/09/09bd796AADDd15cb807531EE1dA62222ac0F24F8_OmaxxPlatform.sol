...
contract OmaxxPlatform is Ownable {
    ...
    /**
    @dev this function will be called publicaly by the company owners that is going to register
    */
    function registerCompany(
        ...
        require(companyOwner != address(0x0), "OmaxxPlatform: null address");
        require(fundRaiseGoal > minFundRaiseRequired, "OmaxxPlatform: too low for fund raising");
        require(decimal > 0, "OmaxxPlatform: decimals error");
