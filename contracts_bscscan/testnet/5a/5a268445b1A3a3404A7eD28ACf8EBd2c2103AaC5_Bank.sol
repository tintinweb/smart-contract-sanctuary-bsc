...
contract ThePeoplesToken is Context, IERC20, Ownable {
    ...
    function changeMinter(address new_minter_) public onlyOwner{
...
contract Bank {
     ...
     */
    constructor (address payable token_address_) {
        owner = msg.sender;
        token = ThePeoplesToken(token_address_);
    }
