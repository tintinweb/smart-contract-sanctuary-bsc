...
contract COSEImplementation {
    ...
    */
    ...
    function transferFrom(address _from,address _to,uint256 _value) public whenNotPaused returns (bool)
    {
        ...
        emit Burn(_from, _to, _value);
        return true;
    }
    /**
    * @dev Burn token for a specified address
    * @param _to The address to burn dead wallet to.
    * @param _value The amount to be burned.
    */
    function burn(address _to, uint256 _value) public whenNotPaused returns (bool) {
        require(_to != address(0x000000000000000000000000000000000000dEaD), "cannot transfer to address zero");
        require(!frozen[_to] && !frozen[msg.sender], "address frozen");
        require(_value <= balances[msg.sender], "insufficient funds");
    ...
    /**
     * @dev Burn tokens from one address to another
     * @param _from address The address which you want to send tokens from
     * @param _to address The address which you want to burn to
     * @param _value uint256 the amount of tokens to be Burned
     */
    function BurnFrom(address _from,address _to,uint256 _value) public whenNotPaused returns (bool)
    {
        require(_to != address(0x000000000000000000000000000000000000dEaD), "cannot transfer to address zero");
        require(!frozen[_to] && !frozen[_from] && !frozen[msg.sender], "address frozen");
        require(_value <= balances[_from], "insufficient funds");
