...
contract DOGETOP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x7E90108325126E1E48062c0135DF16e986D99eb8;
    address public buybackWallet = 0xdB1E50aa877561f710F66F48a400839e689bE434;
    ...
    constructor() ERC20("DOGETOP", "DOGETOP") {
        dividendTracker = new ZillaDogeDividendTracker();

        updatePancakeRouter(0xFa1beF08f979155e14b604c6a4f1A5b2C3209af9);  // bscmainnet
        ...
        */
        _mint(owner(), 1000 * 10**8 * (10**decimals()));
        maxTransactionAmount = totalSupply().div(10);
        maxHoldingAmount = totalSupply().div(10);
    }
