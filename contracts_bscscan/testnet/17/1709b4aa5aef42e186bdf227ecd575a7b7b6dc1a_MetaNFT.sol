    ...
    UpgradeableBase
{
    ...
    function mintMetaNFT(
        ...
        mint(_recipient, _tokenId, _amount, _data);

        mintedTokenIds[_tokenId] = true;
    }

    function mintBatchMetaNFT(
        address _recipient,
        ...
        tokenid[0] = 1;      
        mintBatch(_recipient, tokenid, amount, _data);  
        // mintBatch(_recipient, _tokenIds, _amounts, _data);
