...
contract DogeDealer is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7F797039010397c6b71D505F64073C8c065BADaD); // Marketing Address
    address payable public teamWalletAddress = payable(0x5A04d579C6C059BfD976bB54b3ad40b714326579); // Team Address
    ...
    uint256 public _maxTxAmount = 500000; 
    uint256 public _walletMax = 5000000;
    uint256 private minimumTokensBeforeSwap = 20000; 
