...
contract PornVerse is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;
    address public marketingWallet = 0xEeE24561F7CF7675D99c505C11e7f12Ce9B88d87; 
    address public treasuryWallet = 0xB899dd2822b2fc60403ad8fFb34914d710823f3B; 
    ...
    string private _name = "PornVerse"; //token name
    string private _symbol = "PORN"; // token symbol. 
    ...
    uint256 private _saleTreasuryFee = 1;
    uint256 private _saleBurnFee = 1;

    uint256 public _maxTxAmount = 5_000_000_000 * 10**18; // 5%
    uint256 private minimumTokensBeforeSwap = 100_000_000_000 * 10**18; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 treasuryTokens = amount.mul(_treasuryFee).div(100);
        uint256 burnTokens = amount.mul(_burnFee).div(100);

        amount = amount.sub(marketingTokens).sub(treasuryTokens).sub(burnTokens);
        ...
        _transferStandard(sender, treasuryWallet, treasuryTokens);
    ...
    function setAllSaleFeesPercents(uint256 liquidityFee, uint256 marketingFee, uint256 treasuryFee, uint256 burnFee) 
    external onlyOwner
    {
    ...
    function setTreasuryWalletAddress(address _treasuryAddress) external onlyOwner() 
    {
