...
contract PRUEBAFINAL is Context, IERC20, Ownable {
    ...
    //mapping (address => bool) private _isExcludedWall;
    ...
    address private _devWalletAddress;     // TEAM WALLET ADDRESS
    address private _liqWalletAddress;     // TEAM WALLET ADDRESS
    address public _ExWalletAddress;        // EX MAX WALLET ADDRESS
    ...
    constructor (
    ...
    
     {
        ...
        _liqWalletAddress = liqAddress;
        //_ExWalletAddress = _ExWalletAddress;
        //_CONTACT = _CONTACTNAME;
        ...
        numTokensSellToAddToLiquidity = ( _tTotal * 10 ) / 100;
                
        _rOwned[tokenOwner] = _rTotal;

        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(routerAddress);         // Create a uniswap pair for this new token
    ...
    */
    ...
    function setLiqWalletAddress(address _addr) public onlyOwner {
        _liqWalletAddress = _addr;
    }

    function setExWalletAddress(address _addr) public onlyOwner {
    ...
    function setMaxWalletToken(uint256 maxWalletToken) public onlyOwner {
    ...
    function setNumTokensSellToAddToLiquidity(uint256 amountToUpdate) external onlyOwner {
        numTokensSellToAddToLiquidity = amountToUpdate * 10 ** _decimals;
    }
