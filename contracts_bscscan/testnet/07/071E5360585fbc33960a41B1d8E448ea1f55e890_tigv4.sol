...
/**
 * @dev The official tigv4 smart contract
 */
contract tigv4 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "tigv4";
    string private _symbol   = "tigv4";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for tigv4/WBNB
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $tigv4 will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-tigv4 tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts tigv4 balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns tigv4 tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of tigv4 tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from tigv4)
