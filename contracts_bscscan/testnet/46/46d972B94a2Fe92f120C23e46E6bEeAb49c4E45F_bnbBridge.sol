...
contract bnbBridge is Multiownable {
    ...
    function recieveTokens(uint256[] memory commissions) public payable {
        ...
        require(msg.value >= howManyWritesToRefund[msg.sender] * owners.length * minimumCommissionGas, "Not enough BNB (The amount of BNB is less than the internal commission.)");
