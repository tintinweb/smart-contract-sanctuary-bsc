...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function Check_If_Price_Impacts_Feature_Is_Used(bool enter_the_word_true) external view returns (
                ...
                string memory Status_Price_Impact1, 
                string memory Status_Price_Impact2, 
                bool) {
                ...
                bool input_true = enter_the_word_true; 
                
                if (price_impact1 != 0) {Status_Price_Impact1 = "Price Impact1 feature is used";} 
                else {Status_Price_Impact1 = "Price Impact1 feature is NOT used";}

                if (price_impact2 != 0) {Status_Price_Impact2 = "Price Impact2 feature is used";} 
                else {Status_Price_Impact2 = "Price Impact2 feature is NOT used";}

                return (Price_Impact1_Percentage_Multiplied_by_100,
                        Price_impact2_Percentage_Multiplied_by_100,
                        Status_Price_Impact1, 
                        Status_Price_Impact2, 
                        input_true);
        }
