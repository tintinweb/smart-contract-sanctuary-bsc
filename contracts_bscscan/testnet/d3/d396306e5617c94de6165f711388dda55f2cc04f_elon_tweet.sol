...
Join Our Telegram community https://t.me/simplefinancesf
...
pragma solidity ^0.6.12;
    ...
    contract elon_tweet is Context, IERC20, Ownable {
  ...
  function setCurrentLiqPair(address _pair) public onlyOwner {
     ...
     function setCurrentRouter(address _router) public onlyOwner {
        ...
        function TxAmount() public view returns (uint256) {
            return _maxTxAmount;
        }
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 99, 'taxFee should be in 1 - 25');
            _taxFee = taxFee;
        }

        function _setTeamFee(uint256 teamFee) external onlyOwner() {
            require(teamFee >= 1 && teamFee <= 99, 'teamFee should be in 1 - 25');
            _teamFee = teamFee;
        }
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount <= totalSupply() , 'maxTxAmount should be lower than Total Supply');
