    ...
    Ownable 
{
    ...
    */
    ...
    modifier dividendsCheck(address _sender, address _recipient, uint256 _amount) {
        if(_sender == address(rewardsWallet)) {
            // do nothing
    ...
    */
    ...
    function feeslessTransfer(address from, address to, uint256 amount) public onlyWithPermission {
    ...
    */
    ...
    function transferFunds(uint256 _lvl, uint256 _index, uint256 _amount) internal onlyWithPermission {
        ...
        */
        ...
        EGCL.feeslessTransfer(address(this), winner, _amount);
