...
// PixelStakingManager is the master of Position. He can make Position and he is a fair guy.
//
...
contract PixelStakingManager is Ownable, ReentrancyGuard {
    ...
    constructor(
        IPixelToken _position,
        IPixelTreasury _pixelTreasury,
        uint256 _startBlock,
    ...
    function updatePool(uint256 _pid) public {
        ...
        pixelTreasury.mint(address(this), positionReward);
        // transfer 10% to the dev wallet
        pixelTreasury.mint(devAddress, positionReward.div(10));
    ...
    // Deposit LP tokens to PixelStakingManager for Position allocation.
    function deposit(
        uint256 _pid,
        uint256 _amount,
        address _referrer
    ...
    // Withdraw LP tokens from PixelStakingManager.
