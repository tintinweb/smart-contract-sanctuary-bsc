...
// REbeer BEP20 Token Available on PancakeSwap
...
contract REBEERDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("REBEER_Dividend_Tracker", "REBEER_Dividend_Tracker", 9) {
    	claimWait = 14400;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "REBEER_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "REBEER_Tracker: withdrawDividend disabled. Use the 'claim' function on the main REBEER contract.");
    }
...
contract REBEER is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x93F8A75F34500386425d9ea6F5b52F8d44bb4bb7;
    ...
    constructor() public BEP20("Rebeer", "REBEER", 9) {
    	...
    	IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 (testnet) or 0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F //0x10ED43C718714eb63d5aA57B78B54704E256024E (pk)
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "REBEER: The new dividend tracker must be owned by the ScooBNBDoo token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "REBEER: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "REBEER: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "REBEER: The liquidity wallet is already this address");
