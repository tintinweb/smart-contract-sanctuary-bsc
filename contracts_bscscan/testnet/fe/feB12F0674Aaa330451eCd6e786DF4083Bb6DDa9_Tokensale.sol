...
contract Tokensale is AccessControl {
    ...
    // For market GHOT/USD => GHOT base asset, USD - quote asset
    ...
    function swap(
        ...
        ERC20(quoteAsset).safeTransferFrom(msg.sender, address(this), _value);
        uint256 amountInBaseAsset = _value * factor * ratesPrecision / swapRate;
        ERC20(baseAsset).safeTransfer(msg.sender, amountInBaseAsset);
    ...
    /**
     * @dev update minimal order limit in quote asset
     */
    ...
    function migrateUsers(
        ...
        for (uint256 i = 0; i < _users.length; i++) {
            ERC20(baseAsset).safeTransfer(_users[i], _amounts[i]);
        }
    }
