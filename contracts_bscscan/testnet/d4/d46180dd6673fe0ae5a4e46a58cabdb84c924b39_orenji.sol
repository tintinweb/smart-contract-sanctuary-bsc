...
contract 	orenji is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'orenji';
    string private constant _symbol = 'ORENJI';
   ...
   //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //Wrapped BNB (WBNB)
    ...
    uint256 public _maxTxAmount = ( _tTotal * 100000 ) / 10000000;
    uint256 public _maxWalletToken = ( _tTotal * 200000 ) / 1000000000;
