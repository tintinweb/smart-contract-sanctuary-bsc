...
contract MetaFarm1155 is ERC1155PresetMinterPauser, Ownable {
    ...
    function addApprovalWhitelist(address proxy) public onlyOwner {
        require(
            ...
            "MetaFarm1155: invalid proxy address"
        );
    ...
    function mint(
        ...
        require(
            ...
            "MetaFarm1155: must have minter role to mint"
        );
        require(
            fixedTotalCap[id] == 0 ||
                currentCap[id] + amount <= fixedTotalCap[id],
            "MetaFarm1155: exceed maximum fixed cap"
        );
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !blacklists[from],
            "MetaFarm1155: can not transfer because owner is in blacklist"
        );

        require(
            !blacklists[to],
            "MetaFarm1155: can not transfer because receiver is in blacklist"
        );
