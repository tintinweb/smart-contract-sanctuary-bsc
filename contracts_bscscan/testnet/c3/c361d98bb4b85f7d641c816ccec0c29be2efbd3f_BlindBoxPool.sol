...
contract BlindBoxPool is Ownable, VRFConsumerBase {
    ...
    event ExchangeBlindBox(uint256 indexed from, uint256 indexed to, uint256 indexed random);
    ...
    constructor(address _ticketToken, address _boxToken,address _vrfCoordinator, address _link,bytes32 _keyHash, uint256 _fee) VRFConsumerBase(
    ...
    function exchangeBlindBox(uint256 tokenId) public returns (uint256) {
        ...
        emit ExchangeBlindBox(tokenId,boxId,randomResult);
        return boxId;
    }
}