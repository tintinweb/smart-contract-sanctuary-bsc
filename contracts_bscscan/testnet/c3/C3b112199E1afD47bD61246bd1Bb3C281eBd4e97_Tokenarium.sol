...
contract Tokenarium is ERC20, Ownable {
    ...
    uint256 public constant payOutPoolTaxLimit = 250;
    uint256 public payOutPoolTax = 60;
    ...
    uint256 public prevPayOutBudget = 1000 * (10**18);
    ...
    constructor() ERC20("Tokenarium", "TKNRM")
    {
        ...
        // restrict max budget to 1% of initial value
        maxPayOutBudget = gameTokens / 100;
    }
    ...
    function _handleTax(address from, address to, uint256 amount) private returns (uint256) {
        ...
        uint256 tax = baseUnit * payOutPoolTax;
    ...
    /**
     * @dev Sets tax for buys/sells.
     */
    function setTax(uint256 _tax) public onlyOwner {
        require(_tax <= payOutPoolTaxLimit, "ERC20: value higher than tax limit");
        payOutPoolTax = _tax;
    }
