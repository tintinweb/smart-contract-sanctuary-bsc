...
contract Utils {
    ...
    */
    function hashLeaf(bytes memory _data) public pure returns (bytes32 result)  {
    ...
    *  @return          Hashed value in bytes32 format
    */
    function hashChildren(bytes32 _l, bytes32  _r) public pure returns (bytes32 result)  {
    ...
    */
    function containMAddresses(address[] memory _keepers, address[] memory _signers, uint _m) public pure returns (bool){
        uint m = 0;
    ...
    *  @return
    */
    function compressMCPubKey(bytes memory key) public pure returns (bytes memory newkey) {
