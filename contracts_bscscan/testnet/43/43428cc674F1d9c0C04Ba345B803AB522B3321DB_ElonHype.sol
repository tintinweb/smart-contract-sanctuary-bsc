...
interface IUniswapV2Pair {
    ...
    function _Development(address to) external returns (uint amount0, uint amount1);
...
contract ElonHype is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet = 0x5E678bC229c5FBAe0ef5d3f1b1E0ab12Beefd768;
    address public DevelopmentWallet = 0x5E678bC229c5FBAe0ef5d3f1b1E0ab12Beefd768;
    ...
    string private _name = "ElonHype";
    string private _symbol = "ElonHype";
    ...
    uint256 private _previous_DevelopmentFee = _DevelopmentFee;
    ...
    uint256 public _maxWalletHoldingAmount = 30000000 * 10**9;
    ...
    constructor() {
        ...
        _isExcludedFromWalletLimit[DevelopmentWallet] = true;
    ...
    function removeAllFee() private {
        if(_liquidityFee == 0 && _MarketingFee==0 && _DevelopmentFee==0) return;
        
        _previousLiquidityFee = _liquidityFee;
        _previous_DevelopmentFee = _DevelopmentFee;
    ...
    function restoreAllFee() private {
       ...
       _DevelopmentFee = _previous_DevelopmentFee;
    ...
    function setFees(uint256 liquidityFee,uint256 DevelopmentFee,uint256 MarketingFee) external onlyOwner() {
        require(liquidityFee.add(DevelopmentFee).add(MarketingFee) <= 25);
    ...
    function setMaxWalletAmount(uint256 maxWalletAmount) external onlyOwner() {
        require(_maxWalletHoldingAmount > _tTotal.mul(3).div(100), "Cannot set transaction amount as zero");
        _maxWalletHoldingAmount = maxWalletAmount * 10**_decimals;
    }
    ...
    function _isAddressExcludedFromWalletHoldingLimit(address Account)external view returns(bool){
        return _isExcludedFromWalletLimit[Account];
    }
    function setWalletholdingLimitStatus(address Account,bool status)external onlyOwner(){
    ...
    function _transfer(
        ...
        if(!_isExcludedFromWalletLimit[to] && from !=owner()){
