...
contract BTC_DISTRIBUTOR is IDividendDistributor { 
    ...
    IBEP20 BTC = IBEP20(0x9222D24274E912F4d5E889b460924C4fEFe97954); // Reward address
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IPANCAKERouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1);
        _token = msg.sender;
    }
...
contract TumbleWeave is Context, IBEP20, Ownable { 
    using SafeMath for uint256;

    address public BTC = 0x9222D24274E912F4d5E889b460924C4fEFe97954; //Reward address
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address zeroAddress = 0x0000000000000000000000000000000000000000;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress = 0x5C976F29F024a506e623Db5Bd9c26b6a0C9F2619;
    address public autoLiquidityReceiver = 0x0000000000000000000000000000000000000000;

    string constant _name = "TumbleWeave";
    string constant _symbol = "WEAVE";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**6 * 10**_decimals; // 0.5%
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 2000; // 0.005%
    ...
    constructor () {
        router = IPANCAKERouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1);
    ...
    */
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection.add(balanceBefore)}() {} catch {}
            payable(externalAddress).call{value: amountBNBExternal, gas: 50000};
