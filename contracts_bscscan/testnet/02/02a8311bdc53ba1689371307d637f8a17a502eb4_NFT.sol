...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('FamilyVerse NFT', 'FMV-NFT') {
        ...
        numberOfTokens = 0;
        maxTokens = 500;
        FMVToken = 0xD080eCfd8B1CC769d2dc045cbD1eB426B2cBEDD1;
        FMVFarm = 0xD080eCfd8B1CC769d2dc045cbD1eB426B2cBEDD1;
    ...
    function setMaxReservedMints(uint256 _maxReservedMints) public onlyOwner {
        maxReservedMints = _maxReservedMints;
    }

    function setMinCost(uint256 _minCost) public onlyOwner {
        mintCost_ = _minCost;
    }
    function setNewToken(address _FMVToken) public onlyOwner {
        FMVToken = _FMVToken;
    }
       function setNewFarm(address _FMVFarm) public onlyOwner {
        FMVFarm = _FMVFarm;
    }
