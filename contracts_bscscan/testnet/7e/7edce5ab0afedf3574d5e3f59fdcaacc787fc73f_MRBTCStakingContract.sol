...
contract MRBTCStakingContract {
    ...
    constructor (IBEP20 _token){
        ...
        endPool = 1644361200;       // Feb 9 00:00 utc timezone.
        lockTokenPeriod = 18000;  // lock token time for 5 hours.
        APY = 300;
    }
    ...
    function stake(uint256 _amount) public {
        ...
        require(curBlock < endPool, "can not stake any more after Feb 9 00:00 utc timezone");
