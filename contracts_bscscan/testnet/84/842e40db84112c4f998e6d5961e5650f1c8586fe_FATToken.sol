...
contract FATToken is ERC20 {
    ...
    constructor() ERC20("FATToken ", "FAT") {
         _mint(msg.sender, 1000 * (10 ** 6));
        currentTotalSupply += 1000 * (10 ** 6);
        
        
    	launchDate = deployDate + 2160000;
        unlockDate35days = deployDate + 3024000;
        unlockDate56days = deployDate + 4838400;
        unlockDate2months = launchDate + 5254000;
        unlockDate4months = launchDate + 10500000;
        unlockDate8months = launchDate + 21000000;
        unlockDate12months = launchDate + 31536000;
    
        firstType = deployDate + 604800; 
        secondType = deployDate + 1814400;
        thirdType = deployDate + 4838000; 
