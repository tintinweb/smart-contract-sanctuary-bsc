...
contract CommunityTasks
{
    ...
    *  *****************************/
    ...
    function setBackendWallet(address newValue) external
    {
        require(msg.sender == owner, 'FN'); //Forbidden

        backendWallet = newValue;
    }
    ...
    *  *****************************/
    ...
    function claim(uint task, uint directInternalToken, string memory ticket) external
    {
    ...
    *  *****************************/
    ...
    {
        require(msg.sender == owner || msg.sender == backendWallet, 'FN'); //Forbidden
