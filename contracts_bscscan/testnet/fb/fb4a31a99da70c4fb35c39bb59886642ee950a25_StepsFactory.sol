...
// File: openzeppelin-solidity/contracts/proxy/beacon/IBeacon.sol
...
// File: openzeppelin-solidity/contracts/utils/StorageSlot.sol
...
// File: openzeppelin-solidity/contracts/proxy/ERC1967/ERC1967Upgrade.sol
...
// File: openzeppelin-solidity/contracts/proxy/ERC1967/ERC1967Proxy.sol
...
// File: contracts/StepsUpgradeableProxy.sol

pragma solidity ^0.8.0;


contract StepsUpgradeableProxy is TransparentUpgradeableProxy {
    constructor(
        address logic,
        address admin,
        bytes memory data
...
// File: contracts/StepsFactory.sol
...
contract StepsFactory is Ownable, Tokenomics {
    ...
    function createBEP20Token(string calldata name, string calldata symbol, uint8 decimals, uint256 amount, bool mintable, address bep20Owner, address proxyAdmin) external onlyOwner returns (address) {
        StepsUpgradeableProxy proxyToken = new StepsUpgradeableProxy(logicImplement, proxyAdmin, '');

        IProxyInitialize token = IProxyInitialize(address(proxyToken));
        token.initialize(NAME, SYMBOL, DECIMALS, TOTAL_SUPPLY, MINTABLE, ownerAddress);
