...
// File: contracts/IORMToken.sol


pragma solidity ^0.8.0;


contract IORMToken is ERC20 {
    ...
    constructor() ERC20("IORMToken", "IORM") {
         _mint(msg.sender, 1000 * (10 ** 6));
        currentTotalSupply += 1000 * (10 ** 6);
        
        
    	launchDate = 1643823416;
        unlockDate35days = 1643823416;
        unlockDate56days = 1643823416 + 7000;
        ...
        firstType = 1643820416 ; 
        secondType = 1643823416;
        thirdType = 1643826416; 
