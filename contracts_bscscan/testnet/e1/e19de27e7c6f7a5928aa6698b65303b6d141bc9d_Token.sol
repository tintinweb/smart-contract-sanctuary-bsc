...
contract ERC20 is Context, IERC20,IERC20Metadata {
    ...
    constructor (string memory name_, string memory symbol_, uint256 totalSupply_,uint256 maxSupply_, address owner)  {
         require(owner != address(0), "Zero owner address");
        require(
            maxSupply_ >= totalSupply_,
            "Total Supply should be less than max supply"
        );
...
contract Token is ERC20, IToken, AccessControl {
    ...
    constructor(
        ...
        uint256 _maxSupply,
        address admin
    ) ERC20(_name, _symbol,_totalSupply,_maxSupply,admin) {
