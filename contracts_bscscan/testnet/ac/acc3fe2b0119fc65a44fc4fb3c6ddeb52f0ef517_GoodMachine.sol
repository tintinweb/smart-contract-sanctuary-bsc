...
contract GoodMachine is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xE89340e5467111d199B962011F84B075328fCac4);
    ...
    string private constant _name = "Good Machine";
    string private constant _symbol = "GoMa";
