...
contract BigBrotherNations is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public _isVoteAddress;

    address[] private _excluded;

    address payable _devAddress = 0xE95b6f42652d33B65748DC07842b98b811Ee37ce;
    address payable _marketingAddress = 0x0b5F844106077E481090C5715341afb2927aE698;
    ...
    string private _name = "Big Brother Nations";
    string private _symbol = "BBNT";
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000 * 10**8;
    ...
    function setMinTokensToSwap(uint256 _minTokens) external onlyOwner {
        numTokensSellToAddToLiquidity = _minTokens * 10**8;
    }
    ...
    function setVoteAddress(address account) public onlyOwner {
        require(!_isVoteAddress[account], "user already vote address");
        _isVoteAddress[account] = true;
    }

    function removeVoteAddress(address account) public onlyOwner {
        require(_isVoteAddress[account], "user not vote address");
        _isVoteAddress[account] = false;
    }
    ...
    function _transfer(
        ...
        // if any account belongs to _isVoteAddress account, then add fee
        if (_isVoteAddress[from]) {
            takeFee = true;
        }
