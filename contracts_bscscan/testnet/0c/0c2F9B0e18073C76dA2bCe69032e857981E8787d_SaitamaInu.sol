...
interface IERC20 {
    ...
    // Devuelve la cantidad tokens propios por `account`.
...
contract SaitamaInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Jhoanny Inu4';
    string private _symbol = 'SAIJG4';
    ...
    uint256 public constant _tTotal = 100 * 10**6 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 1 * 10**6 * 10**9; //0.01
    ...
    function tTotal() public view returns (uint256) {
        return _tTotal;
    }
