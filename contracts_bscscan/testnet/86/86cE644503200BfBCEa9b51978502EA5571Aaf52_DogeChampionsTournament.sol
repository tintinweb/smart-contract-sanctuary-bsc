...
contract DogeChampionsTournament is ReentrancyGuard, ITournament
{
    ...
    uint256 constant private tournamentMintLimit = 9400; // with 20600 DogeChampionsNFTs minted from sales and giveaways, we will have 30K total supply
    ...
    function endCurrentTournament() public override onlyAdmin
    {
        ...
        // TODO uncomment following after tests are finished also add MODIFIER ^^^^^^^^^^
        //require(tournamentIdToEndTimestamp[currentId] - block.timestamp <= 0, "Current tournament should expire first.");
    ...
    function setTournament(uint256 endTimestamp, uint256 tournamentType, uint256[4] memory elements, bool isPaid, bool isConsumableOnly) public override onlyAdmin
    {
        ...
        //require(timeUntilEnd < 1209600, "A new tournament can be set to 2 weeks later");
