...
contract AAA is ERC20, Ownable {
    ...
    constructor() ERC20("AAA", "AAA") {
        ...
        address newOwner = address(0x4cE8666987a7296B3c9cd1e2045CFb320De53C49);
        ...
        swapTokensAtAmount = totalSupply; // 0.05% swap wallet
        maxWallet = totalSupply; // 2.5% max wallet
