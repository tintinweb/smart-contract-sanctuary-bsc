...
contract TestToken is ERC20, Ownable {
    ...
    constructor(address router_) ERC20("TestToken", "TEST") {
        _router = router_;
        ...
        _isAutomatedMarketMakerPairs[pair] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        if (_shouldTakeFees(sender, recipient)) {
            uint256 feesAmount = amount * 1_000 / 10_000;
            amount -= feesAmount;
    ...
    function _shouldTakeFees(address sender, address recipient) private view returns (bool) {
        return !_inSwap && sender != owner() && recipient != owner();
    }
    
    function _shouldSwapBack(address sender, address recipient) private view returns (bool) {
        return _swapEnabled && !_inSwap && sender != owner() && recipient != owner() && !_isAutomatedMarketMakerPairs[sender];
    }
