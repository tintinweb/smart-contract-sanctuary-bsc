...
contract DistributionPool is Ownable, TokenPaymentSplitter {
    using SafeERC20 for IERC20;
    ...
    function drainTo(address _transferTo, address _token) public onlyOwner {
        require(
        _token != paymentToken,
        "DistributionPool: Token to drain is PaymentToken"
        );
        uint256 balance = IERC20(_token).balanceOf(address(this));
        require(balance > 0, "DistributionPool: Token to drain balance is 0");
