...
contract SpaceShib is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9fD18E9e1bc78D9FFF050f332Ae11CeC42A9EBE3;
    address public devWallet = 0x724e70a70a3Ba0E7421b0C52F1c3Be4ef4C7833c;
 
    string private constant _name = "SpaceShib";
    ...
    Taxes public taxes = Taxes(4,6,2,1);
    ...
    function _getValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi, to_return.rMarketing, to_return.rLiquidity, to_return.rDev) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi, uint256 rMarketing, uint256 rLiquidity, uint256 rDev) {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        uint256 denominator = (taxes.liquidity + taxes.marketing + taxes.dev) * 2;
        ...
        uint256 devAmt = unitBalance * 2 * taxes.marketing;
        if(devAmt > 0){
    ...
    function updateWallets(address newMarketing, address newDev) external onlyOwner{
