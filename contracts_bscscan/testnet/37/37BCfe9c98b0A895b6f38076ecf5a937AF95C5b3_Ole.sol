...
contract Ole is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ole";
    ...
    uint256 public _maxTxAmount = 10 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**4;
