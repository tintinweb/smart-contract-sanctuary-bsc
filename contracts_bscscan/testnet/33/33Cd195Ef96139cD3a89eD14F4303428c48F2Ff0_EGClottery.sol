    ...
    Ownable 
{
    ...
    */
    ...
    modifier onlyWithPermission {
        require(permissionedUsers[_msgSender()] == true, "Access denied");
        _;
    }
    ...
    */
    ...
    function _claimDividends(address _beneficiary) internal onlyWithPermission returns(bool) {
