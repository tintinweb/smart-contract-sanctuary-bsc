...
// File: contracts/NaftyAngelsNFT/NaftyAngels.sol
...
contract NaftyAngels is ERC721, Ownable {
    ...
    uint256 public MAX_EXCLUSIVE = 600;
    ...
    function getExclusivePrice() public view returns (uint256) {
    ...
    function exclusiveMint(
        ...
        require(
            ...
            "NaftyAngels: Insufficient ETH Amount"
        );
    ...
    function presaleMint(
        ...
        require(
            ...
            "NaftyAngels: Presale is not started yet!"
        );
        
        require(
            presaleCount + amount <= MAX_PRESALE,
            "NaftyAngels: PRESALE SOLD OUT"
        );

        require(
            msg.value >= presalePrice * amount,
            "NaftyAngels: INVALID PRICE"
        );
    ...
    function publicSaleMint(uint256 amount) external payable {
        ...
        require(supply + amount <= maxSupply, "NaftyAngels: Sold out!");

        require(
            workflow == WorkflowStatus.Sale,
            "NaftyAngels: public sale not started."
        );

        require(
            msg.value >= salePrice * amount,
            "NaftyAngels: Insuficient funds"
        );
