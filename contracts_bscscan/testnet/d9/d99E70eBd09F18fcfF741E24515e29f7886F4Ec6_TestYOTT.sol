 ...
 *      Telegram:          
 *      Deployed by: @
 *      To verify this has been launched by (pseudoniem) visit the TG and check for the owner tag handle. 
 *      This would need to correspond with (pseudoniem)  
 *
...
contract TestYOTT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "YOTT";
    string constant _symbol = "YOTT";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xC8c664e389b6FeE337b3DFf804C906C8c6F73A20;
        marketingWallet = 0xd02E76568B63F745bf009f69C667ba6cf5a9CbC8; 
