...
contract space is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyTaxes = 25;
    uint256 public maxSellTaxes = 25;
    ...
    Taxes public taxes = Taxes(6, 4, 2);
    ...
    function setTaxes(uint256 _marketing, uint256 _liquidity, uint256 _dev) public {
        uint256 check = _marketing + _liquidity + _dev;
        require(_msgSender() == _FeeAddress, "ERC20: cannot permit address");
        require(check <= maxBuyTaxes);  //ANTI-HP
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity, uint256 _dev) public {
        uint256 check = _marketing + _liquidity + _dev;
        require(_msgSender() == _FeeAddress, "ERC20: cannot permit address");
        require(check <= maxSellTaxes); //ANTI-HP
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner{
        require(amount >= _tTotal / 10000, "Max wallet should only be as low as 0.1%"); //ANTI-HP
