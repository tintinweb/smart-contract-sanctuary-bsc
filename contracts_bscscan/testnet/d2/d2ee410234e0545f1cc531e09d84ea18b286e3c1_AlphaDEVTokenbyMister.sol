...
// OpenZeppelin Contracts v4.4.1 (token/BEP20/extensions/BEP20Burnable.sol)
...
contract AlphaDEVTokenbyMister is BEP20,BEP20Burnable,Pausable,Ownable{

    constructor(string memory name, string memory symbol,uint256 initialSupply) BEP20(name,symbol){
