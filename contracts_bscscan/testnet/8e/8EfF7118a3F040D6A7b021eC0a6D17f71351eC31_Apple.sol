...
contract Apple is IPYE, AccessControl, Ownable {
    ...
    string constant _name = "APPLE";
    string constant _symbol = "APPLE";
    ...
    constructor(address _router, address _marketing) public {
        ...
        .createPair(WBNB, address(this), true);
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.marketing);
        return values;
    }
    ...
    function depositLPFee(uint256 amount, address token) public onlyExchange {
        ...
        if(tokenIndex < pairsLength) {
            ...
            if(allowance >= amount) {
                ...
                uint256 marketingFeeAmount = amount.mul(_defaultFees.marketingFee);
