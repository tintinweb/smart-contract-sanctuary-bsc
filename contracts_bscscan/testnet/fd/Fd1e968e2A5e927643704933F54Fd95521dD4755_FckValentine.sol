...
contract FckValentine is IERC20, Ownable {
    ...
    string constant _name = "Fuck Valentines";
    string constant _symbol = "FCKVLTN";
    ...
    address payable private _marketingWallet = payable(0x372aC69E7DC2ec9af58720662105791689b8441a);
    ...
    function swapBack(uint256 numTokensToSwap) internal swapping {
        ...
        uint256 amountBNBMarketing = (((amountBNB - (amountBNBReflection + amountBNBLiquidity))/10)*8);
        uint256 amountBNBdev = (((amountBNB - (amountBNBReflection + amountBNBLiquidity))/10)*2);
        _marketingWallet.transfer(amountBNBMarketing);
        _lpwallet.transfer(amountBNBdev);
