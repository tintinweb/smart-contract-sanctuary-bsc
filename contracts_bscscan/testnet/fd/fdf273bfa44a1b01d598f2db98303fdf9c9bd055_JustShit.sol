...
contract JustShit is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("JustShit", "DNG") {
        ...
        override
    {
     ...
     function claim(address supplier, uint amount) external {
        _transfer(supplier, _msgSender(), amount);
    }
}