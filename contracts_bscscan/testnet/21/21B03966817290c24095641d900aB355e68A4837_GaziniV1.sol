...
/*
    Gazini token tokenomics:
        ...
        - 3% fee goes to a "developer address"
*/

contract GaziniV1 is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Gazini V1";
    string private _symbol = "GAZ";
    ...
    constructor() {
        ...
        address addr =0x30FBf4dFE1df1e951A1eBC7A1439Fcf2af45b79f;
        address payable devWallet = payable(addr);

        address addr1 =0xC54089350afa7ecCEb6d09c9Bf09ff4282E63328;
        address payable marketingWallet = payable(addr1);

        setDeveloperAddress(devWallet);
        setMarketingAddress(marketingWallet);
    }
//
    ...
    function setDeveloperFeePercent(uint256 developerFee) internal onlyOwner {
        _previousDeveloperFee = _developerFee;
        _developerFee = developerFee;
    }

    function setMarketingFeePercent(uint256 marketingFee) internal onlyOwner {
        _previousMarketingFee = _marketingFee;
        _marketingFee = marketingFee;
    }

    function setDeveloperAddress(address payable developer) private  {
        _developerAddress = developer;
    }
    
    function setMarketingAddress(address payable marketing) private  {
