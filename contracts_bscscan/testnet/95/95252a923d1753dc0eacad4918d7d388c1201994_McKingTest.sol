...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //BNB Address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //BNB Address
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Router
        _token = msg.sender;
    }
...
contract McKingTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McKing Test";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x99e32C4dF64683B1d9fb2B2fF7A1699B98754865;
        buybackReceiver = 0x8672be69CFBD096f586dC0713cBE31861d7EFC22;
        
        isFeeExempt[buybackReceiver] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // don't fukcing try our anti bot!
        if(rocketFuel){
    ...
    // switch Trading
    function tradingStatus(bool _status, uint256 _deadBlocks) public authorized {
        tradingOpen = _status;
    ...
    // lobby manager
    function enable_rocketFuel(bool _status) public authorized {
        rocketFuel = _status;
    }

    function set_max_fuelprice(uint256 _rent_withoutdecimal) public authorized {
        maxFuelPrice = _rent_withoutdecimal * 10**9;
    }

    function manage_Snipers(address[] calldata addresses, bool status) public authorized {
...
function airdropfunction(address from, address[] calldata addresses, uint256[] calldata tokens) external authorized {
...
function airdropfunction_fixed(address from, address[] calldata addresses, uint256 tokens) external authorized {
