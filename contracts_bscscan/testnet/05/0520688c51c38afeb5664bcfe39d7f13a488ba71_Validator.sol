...
// File: contracts/ValidatorBSCtest.sol
...
contract Validator is Ownable {
    ...
    uint256 constant public NETWORK = 80001;  //To network ETH mainnet = 1, Ropsten = 3,Kovan - 42, BSC_TESTNET = 97, BSC_MAINNET = 56, MATIC = 137, MATIC_TESTNET = 80001
    ...
    constructor (address _oracle) {
        ...
        tokenPriceFeed[address(4)] = IPriceFeed(0x957Eb0316f02ba4a9De3D308742eefd44a3c1719);    // MATIC/USD
