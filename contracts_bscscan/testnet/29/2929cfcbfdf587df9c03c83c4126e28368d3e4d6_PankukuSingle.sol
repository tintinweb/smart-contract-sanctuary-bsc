    ...
    ERC721BurnableUpgradeable
{
    ...
    uint256 private kukuserviceValue;
    address private KukuAddress;
    string private _currentBaseURI;
    uint256 public _tid;
    uint256 deci;
    function initialize() public initializer  {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("KUKU", "KUKU");
        _tid = 1;
    ...
    function kukuserviceFunction(uint256 _kukuserviceValue) public onlyOwner{
        kukuserviceValue = _kukuserviceValue;
    }
    function getKukuServiceFee() public view returns(uint256){
        return kukuserviceValue;
    }
    ...
    function newtokenasbid(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress) internal {
        ...
        if(tokenAddress == KukuAddress ){
            fee = kukuserviceValue;
        }
