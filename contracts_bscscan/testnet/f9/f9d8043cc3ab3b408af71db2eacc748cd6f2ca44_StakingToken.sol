...
contract ERC20 is Context, IERC20 {
 ...
 function _transferWithoutDeflationary(address sender, address recipient, uint256 amount) internal virtual {
        ...
        returns (uint256, uint256)
    {
            ...
            uint256 extractAmount = (amount * 30) / 1000;
...
contract StakingToken is ERC20, ERC20Detailed, ERC20Burnable {
    constructor(uint256 initialSupply)
        public
        ERC20Detailed("StakingToken", "SKT", 18)
    {
        _deploy(msg.sender, initialSupply, 1644451201);
    }
