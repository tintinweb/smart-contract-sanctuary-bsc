...
contract MOONMAN is Context, IERC20, Ownable {
    ...
    string private _symbol = "Moon Man";
    ...
    address public _marketingWallet =
        payable(address(0xBa0cFfa69A87b8Bae5C6b35FB6dA26B1ebF61a05)); //TODO: change it
    address public _rewardWallet =
        payable(address(0xEa338fe57024F2d463E8991d4A4223e5A3E847ac)); //TODO: change it
    ...
    constructor() public {
        ...
        buyFee.marketingFee = 0; //BNB received
        buyFee.rewardFee = 4; // token received
        buyFee.taxFee = 6; // token reflection
