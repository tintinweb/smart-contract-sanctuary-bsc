...
contract Cherry is IPYE, AccessControl, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    modifier onlyExchange() {
        ...
        constructor(address _router, Apple _apple, address _marketing) public {
    ...
    function setMarketingPercent(uint256 _marketingFee) external {
        require(hasRole(FEE_SETTER_ROLE, msg.sender), "CHERRY: NOT_ALLOWED");
    ...
    function setMarketingAddress(address _marketing) external {
        require(hasRole(FEE_SETTER_ROLE, msg.sender), "CHERRY: NOT_ALLOWED");
        require(_marketing != address(0), "CHERRY: Address Zero is not allowed");
