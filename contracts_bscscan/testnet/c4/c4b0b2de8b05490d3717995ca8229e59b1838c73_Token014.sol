...
contract Token014 is IBEP20 {

    uint public constant MAX = type(uint256).max;

    string public name = "Token 014";
    string public symbol = "T014";
    ...
    constructor() {
        ...
        // must also exempt token pair ??? - need to get token pair address ***********************************
...
// on a buy, 'from' is pair (giving tokens to holder)
...
// on a sell,'to' is pair (gets tokens from holder)
