...
struct betdata{
    ...
    function bet_data(string memory player1_address, string memory player1_coin_side, string memory player2_address, string memory player2_coin_side, string memory result) public{
        betCount += 1;    
        betRecords[betCount]= betdata(betCount, player1_address, player1_coin_side, player2_address , player2_coin_side, result);
    }
