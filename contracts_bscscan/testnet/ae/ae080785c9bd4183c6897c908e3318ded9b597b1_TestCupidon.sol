...
contract TestCupidon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0x5F247D114139e213596372A67a70d552A22a019D); // Marketing Address
        
    address payable private teamAddress =
        payable(0x8b9B1fe269b89Ac5B73783c351CbC09D096981e5); // Team Address
        
    address payable private liquidityAddress =
        payable(0xd255Fbd57cB4Ab3e72F91A37A0C281096Df9078C); // Liquidity Address
    ...
    string private constant _name = "TestCupidon";
    string private constant _symbol = "TCupiD";
