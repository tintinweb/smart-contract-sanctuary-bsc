...
contract GameFaucet is Initializable, AccessControlUpgradeable {
    ...
    function initialize(
        ...
        maxMintedBunicorn = 10;
        maxMintedTrainer = 10;
        maxMintedBur = 10000 ether;
        maxMintedBuni = 10000 ether;
        maxMintedGacha = 100;
    }
...
interface IBuniGachaShard is IERC20 {
    function mint(address _to, uint256 _value) external;
    function burn(uint256 amount) external;
    function burnFrom(address account, uint256 amount) external;
}
