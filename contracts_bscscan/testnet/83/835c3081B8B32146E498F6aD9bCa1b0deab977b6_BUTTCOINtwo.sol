...
contract DividendDistributor {
    ...
    IERC20 ftm = IERC20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe); // Binance wrapped BNB
...
contract BUTTCOINtwo is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Butterstwo coin";
    string constant _symbol = "BUTTCOIN";
    ...
    uint256 public _liquidityFeeSell = 1300;
    uint256 public _reflectionFeeSell = 0;
    uint256 public _marketingFeeSell = 1300;
    ...
    address payable private _marketingWallet = payable(0x34c8A28B87E93189192Ad9237eb9217090644B21);
