...
contract PawSwap is Ownable {
    ...
    function buyOnPawSwap (
        ...
        swapEthForTokens(ethToSwap, minTokensToReceive);
        ...
        if (_taxes.liquidityTax != 0) {
            ...
            addLiquidity(liquidityTokens, liquidityEth, taxStructure.lpTokenHolder());
    ...
    function sellOnPawSwap (
        ...
        swapTokensForEth(tokensToSwap, minEthToReceive);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount, address lpTokenHolder) private {
    ...
    function swapEthForTokens(uint256 ethToSwap, uint256 minTokensToReceive) private {
    ...
    function swapTokensForEth(uint256 tokenAmount, uint256 minEthToReceive) private {
        address[] memory path = new address[](2);
