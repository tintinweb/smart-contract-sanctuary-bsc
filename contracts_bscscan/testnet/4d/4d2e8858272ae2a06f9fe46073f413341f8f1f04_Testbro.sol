...
contract Testbro is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xc1C6c347AaA391E240F30701692a459C7e323671));
    address payable public devWallet =
        payable(address(0xc1C6c347AaA391E240F30701692a459C7e323671));
    address public liquidityReceiver =
        0xc1C6c347AaA391E240F30701692a459C7e323671;
    address private fixedBurnAddress =
        0x0000000000000000000000000000000000000000;
    
    bool public burnDeductSupply = true;

    string private _name = "TestBro";
