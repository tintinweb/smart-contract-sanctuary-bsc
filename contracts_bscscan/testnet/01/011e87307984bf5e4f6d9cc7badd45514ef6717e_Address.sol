...
contract Tiger is Context, IERC20, Ownable {
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xE14CC4183a8bE89b783c55aBc438c577A7771503); // Marketing address used to pay for marketing
    ...
    uint256 public  _sellTaxFee       = 7; // 14% tax 
    uint256 public  _whaleSellTaxFee  = 14; // 21% tax 
