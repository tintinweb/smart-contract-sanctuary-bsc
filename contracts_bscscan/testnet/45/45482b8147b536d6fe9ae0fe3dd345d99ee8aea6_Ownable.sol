...
contract xiba is Context, IERC20, Ownable {
    ...
    string private _name = "xiba";
    string private _symbol = "xiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x405F4f8B233a70cf1d6b8c16a06FA76305d662ae); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2343d3D0a1E6D7504BEc8275B041349654A99E27); // buyBack Address
