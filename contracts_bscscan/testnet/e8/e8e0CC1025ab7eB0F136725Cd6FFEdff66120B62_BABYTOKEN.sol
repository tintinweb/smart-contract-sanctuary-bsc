...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    uint256 public constant TOTALSUPPLY = 1 * 10**15 * 10**18;
    ...
    function setBlacklist(address account, bool b) external onlyOwner {
        blacklist[account] = b;
    }
    ...
    function _transfer(
        ...
        require(!blacklist[from], "ERC20: transfer from the blacklist address");
