...
contract BoxNFTBuyRound1 is OwnableUpgradeable, PausableUpgradeable  {
    ...
    function initialize() public initializer {
        ...
        limitFlashSales[1]=3000;
        limitFlashSales[2]=1000;
        limitFlashSales[3]=300;
        limitFlashSales[4]=1;
        limitFlashSales[5]=1;
        limitFlashSales[6]=1;
        limitFlashSales[7]=1;
  ...
  function listWhitelist(uint from,uint256 to) external view whenNotPaused returns (address[] memory ) {
...
function buyBox(uint256 rank, uint256 _usdt) external  whenNotPaused returns (uint256) {
  ...
  function getConfigByRank(uint256 _rank )public view returns(uint256 limit, uint256 totalBuy, uint256 priceSale,uint256 priceFlashSale, uint256 saleOff,uint256 totalBuyFlashSale){
