        ...
        if (tokenPricePublic != 0) {
            if (amountRaisedPublic >= softCapPublic) {
                if (!profitClaim) {
                    ...
                    refundToken = totalTokenPublic - soldTokensPublic - liquidityToken - _adminTokenFee;
        ...
        if (tokenPricePrivate != 0) {
            if (amountRaisedPrivate >= softCapPrivate) {
                if (!profitClaim) {
                    ...
                    refundToken = totalTokenPrivate - soldTokensPrivate - liquidityToken - _adminTokenFee;
        ...
        if (tokenPriceSeed != 0) {
            if (amountRaisedSeed >= softCapSeed) {
                if (!profitClaim) {
                    ...
                    refundToken = totalTokenSeed - soldTokensSeed - liquidityToken - _adminTokenFee;
                    if (refundToken > 0)
                        token.transfer(tokenOwner, refundToken);
