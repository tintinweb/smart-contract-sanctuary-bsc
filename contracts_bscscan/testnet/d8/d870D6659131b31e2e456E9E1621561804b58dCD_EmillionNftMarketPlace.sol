  ...
  ERC721Holder
{
  ...
  function getc(uint256 idd) public view returns (address) {
  ...
  function _createOrder(
    ...
    emit OrderCreated(orderId, assetOwner, _nftAddress, _assetId, _priceInWei);
  }
  ...
  function _purchaseOrder(
    ...
    IWETH(WETH).transfer(getc(_assetId), (order.price).mul(375).div(10000));
