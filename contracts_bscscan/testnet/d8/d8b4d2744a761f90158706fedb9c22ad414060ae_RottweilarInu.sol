...
contract RottweilarInu is Context, IBEP20, Ownable  {
    ...
    constructor () Ownable() {
        ...
        TradingStatus = true;
        maxTransactionAmount = _totalSupply * 25/10000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(amount <= maxTransactionAmount, "Transfer amount must be lower than maxTransactionAmount");
    ...
    function SwapStatus() public view onlyOwner returns(bool) {
