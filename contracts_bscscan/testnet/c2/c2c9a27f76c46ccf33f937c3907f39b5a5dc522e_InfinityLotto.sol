...
contract InfinityLotto is IBEP20, Auth {
    ...
    uint256 public totalsellFee    = marketingFee + teamFee + reflectionFee + liquidityFee + lotteryFee + burnFee;
    ...
    function setIsFeeExempt(address holder, bool exempt) external authorized {
        ...
        function setGoldenTaxMode(bool _GoldenTaxMode) external authorized {
    ...
    function setContractFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _lotteryFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/2, "50% Max Fees");
    }
