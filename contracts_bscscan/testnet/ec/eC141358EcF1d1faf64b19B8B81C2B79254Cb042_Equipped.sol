...
contract Equipped is ERC20("Equipped Token", "EQP"), Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        IERC20(_baseAsset).approve(address(_masterChef), type(uint256).max);
   ...
   //     _stabiliseOf();
    ...
    function balanceassetof(address _user) public view returns (uint256) {
return IERC20(baseAsset).balanceOf(_user);
    }
   ...
   //     emit Harvest(msg.sender, currentPerformanceFee, currentCallFee);
    ...
    IMasterChef(masterChef).deposit(bal);
       ...
       //     IMasterChef(masterChef).deposit(stakingPid, bal);
    ...
    function withdraw(uint256 _amount) public nonReentrant {
        ...
        IMasterChef(masterChef).withdraw(bal);




//            IMasterChef(masterChef).withdraw(stakingPid, bal);
...
function harvest() external whenNotPaused nonReentrant {
  //      IMasterChef(masterChef).claim(stakingPid);
     //   uint256 bal = rewardAssetBalance();
//Convert reward Asset to Stable Asset
