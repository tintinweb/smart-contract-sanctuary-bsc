            ...
            if(isMarketPair[recipient]){
                ...
                if (delta > 0 && delta < _whaleSellTimer && _lastSellTime[sender] != 0 && _numberOfSells[sender] != 0) {
                    if (_numberOfSells[sender]==1) {
                        _sellMarketingFee = _totalTaxIfSelling.mul(_secondSellMultiplier);
                        _totalTaxIfSelling = _sellMarketingFee.add(_sellLiquidityFee);
                    } else if (_numberOfSells[sender]==2) {
                        _sellMarketingFee = _totalTaxIfSelling.mul(_thirdSellMultiplier);
                        _totalTaxIfSelling = _sellMarketingFee.add(_sellLiquidityFee);
                    } else if (_numberOfSells[sender]>=3) {
                        _sellMarketingFee = _totalTaxIfSelling.mul(_fourthSellMultiplier);
                        _totalTaxIfSelling = _sellMarketingFee.add(_sellLiquidityFee);
                    }
