...
contract ERC20 is IERC20 {
    ...
    address busd = 0x892DBD2Ca7Dd429Aa72d636e2aF5E9927c58a310; // testnet busd
    IERC20 token;
...
contract MOUSENETWORK is Token {
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0xC84D471a48ce70ac3f7ca5eF56302f0B71981FB9;  // N
        DEV_3 = 0x015fe6BDa2910BbC662Dd043B77CDCe2B94CE03F;  // Ig
        ADV_1 = 0x12765cbD5CFeE2faAEF2567745267c9a686Bfb27;  // Mu         
        ADV_2 = 0xf55029Ccc38f726B9fF7681aa161af45D7123600;  // Ma        
        ADV_3 = 0xCfAC4FE1339Ce1C9d5F32897634a4bdF577e2502;  // Cr     
        ADV_4 = 0x5cBe1c90f5d7898aB8183f3985338971703d197B;  // Ol   
        ADV_5 = 0x387D05057E13e93A4188eE03395D7B2C895Da346;  // Wa      
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > 1644588000);                // February 11, 2022 2:00:00 PM
