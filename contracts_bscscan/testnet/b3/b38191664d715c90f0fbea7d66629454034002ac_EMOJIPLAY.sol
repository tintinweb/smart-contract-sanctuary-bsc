...
contract EMOJIPLAY  is IBEP20, Auth {
    ...
    string constant _name = "EMOJI PLAY";
    string constant _symbol = "EMOPLAY";
    ...
    address private marketingFeeReceiver = 0xEf860Dd9D25b1D56DA89Fc2b8ac6DD02753CE916;
    address private buybackFeeReceiver = 0x60aBA8b67A7f5c8691f8a87A96D636d124109190;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000000000 * 3; // 0.3%
    bool inSwap;
