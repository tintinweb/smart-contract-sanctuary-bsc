...
contract TweakTOKEN is IBEP20, Auth {
    using SafeMath for uint256;

    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address PULL = 0x1c6a40cAb3B9218b948451b70f6C943689D581d0;

    string constant _name = "TweakTOKEN";
    string constant _symbol = "TWEAK";
    ...
    constructor () Auth(msg.sender) {
        //address public routerAddress testnet = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
        //address public routerAddress mainnet = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        ...
        marketingFeeReceiver = PULL;
        teamFeeReceiver = PULL;
        devFeeReceiver = PULL;
        burnFeeReceiver = DEAD;


        uint256 half = _totalSupply / 2;
        _balances[msg.sender] = _totalSupply - half;
        emit Transfer(address(0), msg.sender, _totalSupply - half);
