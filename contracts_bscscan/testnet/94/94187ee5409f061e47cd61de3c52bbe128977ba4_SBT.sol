...
contract SBT is ERC20 {
    ...
    constructor() ERC20('Simba Lion', 'SBL') {
    ...
    function Get_Whale_Tax_Address_Transfer() public view returns(address){
        return wta.wta_t;
    }
    ...
    function Set_Whale_Tax_Address(address _wta_t, address _wta1, address _wta2, address _wta3, address _wta4, address _wta5) public onlyOwner {
        wta = Whale_Tax_Address(_wta_t, _wta1, _wta2, _wta3, _wta4, _wta5);
    }
