...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    /*function bookRegistration() external {
        require(isRegistred[_lotteryDistributionDay][_msgSender()] == false, "You've already registred!");
        require(EGCL.checkWhenBought(_msgSender()) != _lotteryDistributionDay, "You can't register today, comeback tomorrow!");
        require(winnersExcludedFromLottery[_msgSender()] < _lotteryDistributionDay, "You can't participate in the lottery 48 hours after winning");
        require(state == LotteryState.Registration, "You can't register yet");
    ...
    */
    ...
    function lvlsDistribution(uint256 _number) public pure returns(uint256 lvl) {
        ...
        */
        ...
        if (_number > 1000000000000 && _number < 10000000000000) {
            /* 
            share - 0.001 % - <0.01%
            C = 0.0001
            */
    ...
    Ownable 
{
    ...
    */
    ...
    mapping(address => uint256) private latestUserBalance;
    ...
    */
    ...
    modifier randNumCheck {
        if (lotteryPool.getRandomNumber() > 0) {
    ...
    function _transfer(
        ...
        if (excludedFromFee[sender] == true || excludedFromFee[recipient] == true) {
            ...
            require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
                ...
                latestUserBalance[sender] = _balances[sender];
                ...
                latestUserBalance[recipient] = _balances[recipient]; 
    ...
    */
    ...
    /*
        LOTTERY FUNCTIONS
    */
    /*function bookRegistration(uint256 _days) external {
        transfer(address(Lottery), balanceOf(_msgSender()));
