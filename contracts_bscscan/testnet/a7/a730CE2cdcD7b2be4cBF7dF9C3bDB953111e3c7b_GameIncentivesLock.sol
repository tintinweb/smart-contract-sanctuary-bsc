...
contract GameIncentivesLock is TimeLock  {

  string contractType = "Game Incentives Timelock";

  function lockContractAddress(address _walletAddress, uint256 _qty) public onlyOwner {
    require(_walletAddress != address(0), "Address zero detected");
    addToLockVault(_walletAddress, _qty, contractType );

  }

  function removeContractAddress() public onlyOwner {
