...
contract BITCOINKING is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BITCOINKING", "BitCoinKing") {
        rewardToken = payable(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function _transfer(
        ...
        if (takeFee) {
            uint256 fees = amount.mul(tokenRewardsFee).div(100);
