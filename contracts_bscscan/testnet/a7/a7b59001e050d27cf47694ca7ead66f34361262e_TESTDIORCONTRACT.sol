...
contract TESTDIORCONTRACT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TESTDIOR";
    //change the token symbol
    string constant _symbol = "DIOR";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x00b4C7231f4694B9424E13590ce0C64bC99e0445;
