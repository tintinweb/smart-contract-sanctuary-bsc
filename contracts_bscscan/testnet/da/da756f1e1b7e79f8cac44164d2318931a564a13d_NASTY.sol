...
contract NASTY is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x275D4589f460b4cE5eeb6ED608D44C985d041D69); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xC7fc786Fd5bCe1adb3e3CAA6C70c6d019c0bB532); // Buyback Address
        
    address payable public liquidityAddress =
        payable(0xaE8De059cB9dBdc31979b68312575DE71E162605); // Liquidity Address
    ...
    string private constant _name = "We Are Nasty";
    string private constant _symbol = "NASTY";
    ...
    function setBuybackAddress(address _buybackAddress) external onlyOwner {
        ...
        _isExcludedFromFee[buybackAddress] = true;
        emit UpdatedBuybackAddress(buybackAddress);
    }
