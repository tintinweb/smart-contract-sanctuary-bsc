...
contract IMAToken is ERC20 {
    ...
    constructor() ERC20("IMAToken ", "IMA") {
         _mint(msg.sender, 1000 * (10 ** 6));
        currentTotalSupply += 1000 * (10 ** 6);
        
        
        launchDate = 1643819616;
        unlockDate35days = 1643820616;
        unlockDate56days = 1643820616+ 7000;
