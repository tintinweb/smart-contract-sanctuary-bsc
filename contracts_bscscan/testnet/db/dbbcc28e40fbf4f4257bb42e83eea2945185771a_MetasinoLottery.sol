 ...
 */
contract MetasinoLottery is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    // Contract global variables.
    uint256 public constant mintPrice = 1*10**18; // 1 BUSD
    uint256 public constant maxMint = 100;
    uint256 public MAX_TOKENS = 10000000000;
    ...
    constructor() ERC721("Metasino Lottery", "ML") {}
    ...
    function mint(uint256 numberOfTokens) public {
        ...
        busd.transferFrom(msg.sender, address(this), mintPrice.mul(numberOfTokens));
    ...
    function getBusdFromContract(uint256 amount) external onlyOwner() {
