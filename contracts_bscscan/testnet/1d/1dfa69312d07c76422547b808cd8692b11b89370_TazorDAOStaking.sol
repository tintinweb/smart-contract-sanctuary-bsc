...
contract TazorDAOStaking is OlympusAccessControlled, ReentrancyGuard {
    ...
    uint256 public constant lockupTime  = 240 ;               // lockup time which is updated when user stake | unstake | getReward.
    ...
    function calcReward(address account) public returns (uint256) {
        ...
        uint256 newEarned = user.tazorNum.mul(rate);
