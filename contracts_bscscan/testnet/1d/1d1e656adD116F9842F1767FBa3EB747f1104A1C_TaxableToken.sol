...
// File: erc20/taxable-erc20.sol

contract TaxableToken is ERC20, Ownable, ServicePayer {
    ...
    constructor(
        ...
        payable
        ERC20(name_, symbol_)
        ServicePayer(serviceFeeReceiver_, tpl_, msg.sender)
    {
        _decimals = decimals_;
        _burnFee = burnFee_;
        ...
        //exclude owner, fee account and this contract from fee
    ...
    function setFeeAccount(address feeAccount_) public onlyOwner {
        _feeAccount = feeAccount_;
        _isExcludedFromFee[feeAccount_] = true;
    }
