...
contract LuckyMoney is Ownable {
    ...
    function thirdPrizeDraw() external onlyOperator {
        ...
        while (seed == special || seed == first || seed == second || blacklist[seed]) seed = seed + 1;
    ...
    function secondPrizeDraw() external onlyOperator {
        ...
        while (seed == special || seed == first || seed == third || blacklist[seed]) seed = seed + 1;
    ...
    function firstPrizeDraw() external onlyOperator {
        ...
        while (seed == special || seed == second || seed == third || blacklist[seed]) seed = seed + 1;
    ...
    function specialPrizeDraw() external onlyOperator {
        ...
        while (seed == first || seed == second || seed == third || blacklist[seed]) seed = seed + 1;
