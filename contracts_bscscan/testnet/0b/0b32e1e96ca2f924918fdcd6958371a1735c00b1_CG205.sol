...
contract CG205 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "CG205";
    string private constant _symbol = "CG205";
    ...
    uint256 public _blackListFee = 90; 
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        if (buyOrSellSwitch == BUY) {
            ...
            _liquidityTokensToSwap = 1;
            _buyBackTokensToSwap = 1;
