...
/**
    ...
    */
    ...
    contract PrivateSaleBEP20 is Ownable {
        ...
        uint256 public privateMinDepositBNB = 0 ether;
        uint256 public privateMaxDepositBNB = 0.15 ether;
        uint256 public privateMaxCap = 0.5 ether;
        ...
        constructor() {
            ...
            privateSale = block.timestamp.add(5 minutes);
            //privateSale = block.timestamp.add(5 days + 1 hours + 30 minutes);
            lockTime = block.timestamp.add(10 minutes);
            //lockTime = block.timestamp.add(366 days);
        ...
        function depositPrivateSale() public payable {
            ...
            privateSalePrice = 0.0000375 ether;  // 1 token / BNB price
