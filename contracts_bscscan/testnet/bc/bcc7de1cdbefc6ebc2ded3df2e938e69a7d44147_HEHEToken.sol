        ...
        if(info.length > 0){
            ...
            for (uint256 i = 0; i < info.length; i++) {
                if(_type == 1){ //singleSmall
                    ...
                    if(info[i].num == 0 || info[i].num == 2 || info[i].num == 4 || info[i].num == 10 || info[i].num == 13){
                        total += info[i].amount.mul(5);
                    } 
                } else if(_type == 3){ //doubleBig
                    if(info[i].num == 6 || info[i].num == 8 || info[i].num == 10 || info[i].num == 12){
                        total += info[i].amount.mul(5);
                    } 
                } else if(_type == 4){ //singleBig
                     if(info[i].num == 5 || info[i].num == 7 || info[i].num == 9 || info[i].num == 11 || info[i].num == 12){
                        total += info[i].amount.mul(5);
                    }
                }
            }
