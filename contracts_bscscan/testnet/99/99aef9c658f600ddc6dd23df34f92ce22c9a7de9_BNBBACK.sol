...
contract BNBBACK is ERC20, Ownable {
    ...
    uint256 public marketingBuyFees = 4;
    uint256 public marketingSellFees = 4;
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            if (canSwap && !automatedMarketMakerPairs[from]) {
                ...
                swapAndSendDividendsAndMarketingFunds(countBNBRewardsFee, countMarketingFees);
            ...
            countMarketingFees += countMarketingFees;
