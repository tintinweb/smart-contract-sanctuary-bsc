...
/// @author Vasiliy Sergeevich
/// @notice This contract can be used for auctioning any NFTs, and accepts any ERC20 token as payment
contract BrewlabsNFTAuction is Ownable {
    mapping(address => mapping(uint256 => Auction)) public nftContractAuctions;
    mapping(address => uint256) failedTransferCredits;
    IUniswapV2Router02 public uniswapV2Router;
    address public teamWallet = 0x2526853A90Ae564384a21a4aEa04602F4C9e6b2c;
    ...
    // constructor
    constructor(address _bep20, address router) {
        ...
        _swapToken = _bep20;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);// main: 0x10ED43C718714eb63d5aA57B78B54704E256024E, test: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function _payFeesAndSeller(
        ...
        uint256 feesPaid = _highestBid * fee / 10000;
    ...
    function swapTokensForEth(uint256 tokenAmount) public {
        ...
        IERC20(_swapToken).approve(address(uniswapV2Router), tokenAmount);
    ...
    function updateSwapToken(address _bep20) public onlyOwner {
        _swapToken = _bep20;
    }

    function updateTeamWallet(address _addr) public onlyOwner {
        teamWallet = _addr;
    }

    function updateV2router(address _router) public onlyOwner {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_router);// main: 0x10ED43C718714eb63d5aA57B78B54704E256024E, test: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        uniswapV2Router = _uniswapV2Router;
    }
