...
// File: contracts/INRMToken.sol


pragma solidity ^0.8.0;


contract INRMToken is ERC20 {
    ...
    constructor() ERC20("INRMToken", "INRM") {
         _mint(msg.sender, 1000 * (10 ** 6));
        currentTotalSupply += 1000 * (10 ** 6);
        
        
    	launchDate = 1643822616;
        unlockDate35days = 1643822616;
        unlockDate56days = 1643812616 + 7000;
        ...
        firstType = 1643815616 ; 
        secondType = 1643818616;
        thirdType = 1643821616; 
