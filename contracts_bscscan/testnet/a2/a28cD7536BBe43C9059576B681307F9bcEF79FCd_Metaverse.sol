...
import "./interfaces/IMetaverseNftContract721.sol";
import "./interfaces/IMetaverseNftContract1155.sol";
...
contract Metaverse is Ownable {
    ...
    function claim1155Event(uint256 _id) external {
        ...
        IMetaverseNftContract1155 nftContract = IMetaverseNftContract1155(
    ...
    function claim721Event(uint256 _id, uint256 _tokenId) external {
        ...
        IMetaverseNftContract721 nftContract = IMetaverseNftContract721(
...
interface IMetaverseNftContract721 is IERC721 {
...
interface IMetaverseNftContract1155 is IERC1155 {
    function mint(
        address to,
        uint256 id,
        uint256 amount,
