...
// ---------------------------------------- GOMAx -------------------------------------------
// ------------------------------------------------------------------------------------------
contract A_VAULT_Test_Token is ERC20, Ownable {
	...
	// ---------------------------- CONSTRUCT -----------------------------
    constructor() ERC20("VAULT Test Token", "iiVTT") Ownable() {
        BNBRewardsFee = 0;
        liquidityFee = 0;
		buyBackFee = 0;
        ...
        setLiquidityWallet(0xf7a6799E164685Ef752e7121eC6CBf47D6B67dD5);
