...
contract JETSTAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1F089E9f3BF854C6f661292E81e15823C4535968); // Marketing Address
    address payable public charityAddress = payable(0x1F089E9f3BF854C6f661292E81e15823C4535968); // Charity/Dev Address
    ...
    string private _name = "Zetstar Token";
    string private _symbol = "ZETS";
    ...
    uint256 public _maxTxAmount = 48000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 48000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   0; //0 BNB Airdrop fee
    uint256 private _airdropToken = 40000000000000000000; // 40; token will be given on airdrop
    ...
    uint256 private salePrice = 48000;// 0.01*480 token for 0.01 bnb (set as per requirements)
