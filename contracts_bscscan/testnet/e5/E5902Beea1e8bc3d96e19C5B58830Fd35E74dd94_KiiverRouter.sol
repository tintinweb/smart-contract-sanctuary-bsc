...
import "./interfaces/IKiiver.sol";
import "./interfaces/IKiiverRouter.sol";

// SPDX-License-Identifier: Unlicensed
contract KiiverRouter is IKiiverRouter {
...
interface IKiiver is IERC20 {
    function burn(uint256 amount) external returns (bool);
}

pragma solidity ^0.6.12;

interface IKiiverRouter {
    function addLiquidityBypassingFee(
        address tokenA,
        address tokenB,
        uint amountADesired,
