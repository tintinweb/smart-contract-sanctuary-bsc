...
contract KryxiviaMysteryBoxes is AccessControl, Pausable, VRFConsumerBase {
     ...
     */
    function createBox(string calldata _name, uint256 _price, string[] memory _fixItems) public payable {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "KryxiviaMysteryBoxes: Must have ADMIN_ROLE to create a box");
     ...
     */
    function addRandomItemsBatchToBox(string calldata _name, RandomItem[] memory _randomItems) public payable {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "KryxiviaMysteryBoxes: Must have ADMIN_ROLE to fill a box");
     ...
     */
    function open(string calldata _name) public payable {
        require(boxes[_name].price > 0, "KryxiviaMysteryBoxes: This box does not exist");
    ...
    function pause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "KryxiviaMysteryBoxes: Must have ADMIN_ROLE to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "KryxiviaMysteryBoxes: Must have ADMIN_ROLE to unpause");
        _unpause();
    }
}
