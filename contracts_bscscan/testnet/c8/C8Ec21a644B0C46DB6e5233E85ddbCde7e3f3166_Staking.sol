...
contract Staking is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint256 private _totalClaimambleAmount;
    ...
    function totalClaimambleAmount() external view returns (uint256) {
    ...
    function updateSilverLockPeriod(uint256 lockPeriod) external {
        _silverLockPeriod = lockPeriod;
    }

    function updateGoldLockPeriod(uint256 lockPeriod) external {
        _goldLockPeriod = lockPeriod;
    }

    function updateDiamondLockPeriod(uint256 lockPeriod) external {
