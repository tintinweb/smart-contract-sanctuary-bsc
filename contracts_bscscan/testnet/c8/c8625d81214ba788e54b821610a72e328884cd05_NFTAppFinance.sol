...
contract NFTAppFinance is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xf0aa9e64e2Da0f42fb0bA420fF742A6F6A248c68);
        
    address payable public teamAddress =
        payable(0x30206a34D876eEdffeE6138e6054c17641644ce6);
    ...
    uint256 private constant _tTotal = 64800000 * (10**9);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "NFTApp.Finance";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 2 / 1000; // 0.2%
    ...
    function setMinimumTokensBeforeSwapAmount(uint256 _minimumTokensBeforeSwap) external onlyOwner {
