    ...
    IERC1155Tradeable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165Upgradeable, ERC1155Collection, Royalties)
        returns (bool)
    {
        return
    ...
    ERC165Upgradeable
{
        ...
        internal
    {
        for (uint256 i = 0; i < _royalties.length; i++) {
            require(_royalties[i].account != address(0x0), "NO_RECIPIENT");
            require(_royalties[i].value != 0, "VALUE_NOT_POSITIVE");
    ...
    function updateRoyaltiesAccount(
        ...
        require(_msgSender() == from, "NOT_ALLOWED");
