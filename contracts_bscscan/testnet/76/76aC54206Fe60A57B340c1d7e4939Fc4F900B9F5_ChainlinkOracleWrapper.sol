...
abstract contract CoreRef is ICoreRef, Pausable {
    ...
    function gov() public view override returns (IERC20) {
        return _core.gov();
    }

    /// @notice gov balance of contract
    /// @return gov amount held
    function govBalance() public view override returns (uint256) {
...
interface ICoreRef {
    ...
    function govBalance() external view returns (uint256);
