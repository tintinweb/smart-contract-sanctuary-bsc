 ...
 * 
 */
contract fistgoldogeToken is IERC20 {
    
    using SafeMath for uint256;
    
    //fist goldoge token, creator will take 8% fee
    address public feeTo = 0x2B9D9dc9d4d938a386A3b4CD594175f5dDD2f60B;

    string public name = "fist goldoge Token";
    string public symbol = "fist goldoge";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //fist goldoge Token supply max length
    uint256 private totalLength = 19;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 fist goldoge
