...
contract PrivateSale is Auth {
  ...
  function joinPool() public payable {
    ...
    uint256 totalAmountNoFee = (msg.value).div(rateMAMPperBNB);
    uint256 FeeExempt = totalAmountNoFee.mul(fee).div(percDenominator);
    uint256 amountToBuy = totalAmountNoFee - FeeExempt;
    require(
