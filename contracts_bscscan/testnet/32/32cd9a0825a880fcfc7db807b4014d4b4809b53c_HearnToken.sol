...
contract HearnToken is ERC20("HEARN", "HEARN") {
    ...
    uint16 public _liquidityFee = 0; // Fee for Liquidity
    uint16 public _marketingFee = 0; // Fee for Marketing
    ...
    function setNumTokensTo(uint256 numTokensSellToAddToLiquidity) external onlyOwner {
    ...
    function _transfer(
        ...
        if (
            !_inSwapAndLiquify &&
            (to == _hearnBnbPair || to == _hearnBusdPair) &&
