...
// Dependency file: contracts/baby/DOGKINGTOKENDividendTracker.sol
...
contract DOGKINGTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DOGKINGTOKEN contract."
        );
    }
...
// Root file: contracts/baby/DOGKINGTOKEN.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/DOGKINGTOKENDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract DOGKINGTOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    DOGKINGTOKENDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = DOGKINGTOKENDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DOGKINGTOKEN: The dividend tracker already has that address"
        );

        DOGKINGTOKENDividendTracker newDividendTracker = DOGKINGTOKENDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "DOGKINGTOKEN: The new dividend tracker must be owned by the DOGKINGTOKEN token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "DOGKINGTOKEN: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DOGKINGTOKEN: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DOGKINGTOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DOGKINGTOKEN: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DOGKINGTOKEN: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DOGKINGTOKEN: Cannot update gasForProcessing to same value"
        );
