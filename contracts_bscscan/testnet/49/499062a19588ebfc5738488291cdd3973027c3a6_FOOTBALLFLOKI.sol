...
contract FOOTBALLFLOKI is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0x016Ba94d432141bF1460Bd01C5f6a4785b9c48fF);
    address payable public team1Address = payable(0x1bE5643ED94166E44BcA4c179148809e13ce0149);
    address payable public team2Address = payable(0x2D47746532bc7cdde653Ac768b1242Ff45Ec4EAf);
    address payable public team3Address = payable(0xc50CAfB1A3cb6730257472ec207003A4A5E82c0d);
    ...
    bool public feesOnSellersAndBuyers = true;   // SORRY JEETS
    bool public isTokenLive = false;      // LFGGGGG!
    bool private gasLimitActive = true;  //NOT GONNAHAPPEN JEETS
    bool public limitsInEffect = true;  //SORRY JEETS
    ...
    //THE GOOD STUFF REFLECTIONS BABY!!!
    ...
    modifier lockTheSwap {
       ...
       // excludeFromMaxTx(address(_uniswapV2Pair), true);
    ...
    function setCharityDivisor(uint256 _charityDivisor) public onlyOwner {
        charityDivisor = _charityDivisor;
    }

    function setTeam1Divisor(uint256 _team1Divisor) public onlyOwner {
        team1Divisor = _team1Divisor;
    }

    function setTeam2Divisor(uint256 _team2Divisor) public onlyOwner {
        team2Divisor = _team2Divisor;
    }

    function setTeam3Divisor(uint256 _team3Divisor) public onlyOwner {
        team1Divisor = _team3Divisor;
    }
   ...
   function excludeFromMaxWallet(address account) public onlyOwner {
    ...
    function _transfer(
       ...
       require((heldTokens + amount) <= _maxWallet,"Over wallet limit.");
        ...
        if (gasLimitActive && from != uniswapV2Pair) {
            require(tx.gasprice <= gasPriceLimit, "Gas price exceeds limit.");
        }


          //when buy
        // if (from != uniswapV2Pair && !_isExcludedMaxTxAmount[to]) {
         //require(amount <= _maxTxAmount, "Buy transfer amount exceeds the MaxTransactionAmount.");
         //}

        // if (to != uniswapV2Pair && !_isExcludedMaxTxAmount[from]) {
           // require(amount <= _maxTxAmount, "Buy transfer amount exceeds the MaxTransactionAmount.");
       // }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(team1Address, transferredBalance.div(_liquidityFee).mul(team1Divisor));
        transferToAddressETH(team2Address, transferredBalance.div(_liquidityFee).mul(team2Divisor));
        transferToAddressETH(team3Address, transferredBalance.div(_liquidityFee).mul(team3Divisor));
