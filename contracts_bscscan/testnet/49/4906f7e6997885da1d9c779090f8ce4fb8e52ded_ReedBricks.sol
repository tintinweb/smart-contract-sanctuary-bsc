...
// Authorised Voters to manage the Treasury Account //
// This feature will be aded in futiure upgrades of the Token //
contract Votable is Ownable {
    ...
    /** 1. Engr. Agu Chux [ CO-FOUNDER & CEO ] : */
    ...
    function clearVote() internal virtual onlyOwner {
        totalVotes = 0;
    }
}
...
contract ReedBricks is Context, Ownable, ERC20Burnable, ERC20Pausable, Votable {
    using SafeMath for uint256;
    ...
    uint256 public developerFee = 3; // 0 - 10
    ...
    //Maximum Token Sell to reach to activate Liquidity (50% of _maxTxAmount)
    uint256 private numTokensSellToAddToLiquidity = 150 * 10**6 * 10**_decimals;
    ...
    // We mint to CAP to the treasury (TRS) account //
    // Mint2CAP must happen and can only happen only if all team member voted //
    function mint2cap(address to) public virtual onlyOwner withTeamVote {
