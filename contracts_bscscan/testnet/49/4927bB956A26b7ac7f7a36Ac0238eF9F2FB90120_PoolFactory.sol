...
contract Pool is Ownable, ReentrancyGuard {
    ...
    function buy(uint256 weiAmount) public {
       ...
       // IERC20(weiToken).approve(address(this), weiAmount);
        IERC20(weiToken).safeTransferFrom(msg.sender, address(this), weiAmount);
       // IERC20(weiToken).transfer(msg.sender, weiAmount);
      //  IERC20(weiToken).allowance(msg.sender, address(this));
      //  require(IERC20(weiToken).balanceOf(msg.sender) != 0, "sender have not test USDT");
