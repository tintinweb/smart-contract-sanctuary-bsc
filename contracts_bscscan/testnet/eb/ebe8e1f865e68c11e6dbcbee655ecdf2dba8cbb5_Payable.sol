...
contract Payable   {
     ...
     */
     ...
     function payInvoice (address token, uint256 amountToPay) payable public {

    IBEP20 paymentToken = IBEP20(token);
    ...
    require(amountToPay >= minimumDeposit,"Minimum amount: 1 BNB");
