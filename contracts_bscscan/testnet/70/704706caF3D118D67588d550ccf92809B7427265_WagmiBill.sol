...
/**
    Telegram: https://t.me/WagmiBillionaire

        Token Name: Wagmi Bilionaire
        Symbol: WagmiBill
        Decimal: 18
...
contract WagmiBill is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Wagmi Billionaire";
    string constant _symbol = "WagmiBill";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x390ec04EfB425037aCb035f99D553cF530AE1A9f; //marketingwallet
        BuybackWallet = 0x4Ac577E33E0065415f345799D03E7Fa1040543d1;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 BuybackWalletShare = amountBNBMarketing.sub(marketingShare);
        
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 30000}("");
        (bool tmpSuccess1,) = payable(BuybackWallet).call{value: BuybackWalletShare, gas: 30000}("");
