...
contract PEPEFA2 is IBEP20, Ownable {
    ...
    uint256 private _buyTaxFee = 1; // Reflections Fee
    uint256 private _buyBurnFee = 1; // Burn Fee
    uint256 private _buyLiquidityFee = 1; // LP Fee
    uint256 private _buyMarketingFee = 1; // Marketing Fee
    uint256 private _buyBuybackFee = 1; // Buyback Fee - TO DO: FIX Buyback in BNB

    uint256 private _sellTaxFee = 1; // Reflections Fee
    uint256 private _sellBurnFee = 1;
    uint256 private _sellLiquidityFee = 1;
    uint256 private _sellMarketingFee = 1;
    uint256 private _sellBuybackFee = 1;

    string private   _name = "PEPEFA2";
    string private  _symbol = "PEPEFA2";
    uint8 private  _decimals = 18;
    uint256 private constant _tTotalSupply = 1000 * 10**3 * 10**18;
	uint256 private constant _buyMaxTxAmount = 50 * 10**3 * 10**18;
    uint256 private constant _sellMaxTxAmount = 50 * 10**3 * 10**18;
    ...
    // wallet for buybacks
    address public constant buybackWallet = 0x0EbdeCEad2d8150d5Ca9d7d92188f147BED58acd; 

    // wallet for marketing
    address payable public marketingWallet = payable(0x0EbdeCEad2d8150d5Ca9d7d92188f147BED58acd);
