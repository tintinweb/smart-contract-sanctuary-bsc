...
contract $CGCHART is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHEEMS GREEN CHART";
    string private _symbol = "$CGCHART";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa094DEC74E539593f8EBc708bcc213B9c7B612f4);
    address payable public teamWalletAddress = payable(0xa094DEC74E539593f8EBc708bcc213B9c7B612f4);
