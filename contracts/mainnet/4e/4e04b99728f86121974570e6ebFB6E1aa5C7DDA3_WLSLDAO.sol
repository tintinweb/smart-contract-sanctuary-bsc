...
contract WLSLDAO is ERC20 {
	...
	address payable _receive = payable(address(0xd190175F2BEceAE7B90C2aF709f33Ea372D6135b));
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    
    address private _fundAddress = address(0xd190175F2BEceAE7B90C2aF709f33Ea372D6135b);
    ...
    constructor(address tokenOwner) ERC20("WLSL DAO", "WLSLDAO") {
