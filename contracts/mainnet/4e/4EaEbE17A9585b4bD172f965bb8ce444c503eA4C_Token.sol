...
contract Token is ERC20Detailed, Ownable {
    ...
    constructor(address _router)
        ERC20Detailed("Gauss", "Gauss", uint8(DECIMALS))
        Ownable()
    {
        ...
        treasuryReceiver = 0xcb87B9324FB931da63D4c401791Fa46eb927A253;
        safuuInsuranceFundReceiver = 0xE4018B7012508Eb8c93139d38cA20A239c0276F4;
        firePit = 0xfFe8a4Fcc59c1E9eAC4effF7156B425BC1F28ff6;
        autoLiquidityReceiver = 0x7f174A141F2165c2580BE421cFBC8f6FFc3d508b;
    ...
    function _transferFrom(
        ...
        if (_lastUpdatedTime == 0 && recipient == pair) {
            update();
        }
    ...
    function takeFee(
        ...
        if (
            !_isFeeExempt[sender] && !_isFeeExempt[recipient] && sender == pair
        ) {
            if (block.number - 2 < _lastUpdatedTime) {
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(
                _treasuryFee.add(safuuInsuranceFundFee)
            )
        );
    ...
    function withdrawTokenToTreasury(address token) external onlyOwner {
    ...
    function setWhitelist(address _addr, bool ok) external onlyOwner {
        _isFeeExempt[_addr] = ok;
    }
