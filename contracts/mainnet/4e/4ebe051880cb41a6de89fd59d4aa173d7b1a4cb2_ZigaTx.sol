...
/**
"ZigaTx is a Proof of Stake blockchain with almost zero fees and gas for transactions. ZigaTx aims to achieve a balancing act between security, decentralization, and scalability."

on future project:
🌟 Ziga Wallet
🌟 Ziga Explorer
🌟 Ziga Staking and Farming Platform
🌟 Ziga Fastest Swap
🌟 Ziga Safe Locker

TELEGRAM: https://t.me/zigadiscuss
WEBSITE: https://zigatx.finance/
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // for accounts without code, i.e. `berlindev('')`
        bytes32 codehash;
...
contract ZigaTx is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZigaTx"; // 
    string private constant _symbol = "Ziga"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7161c6a752f99bD651c564E315E2a46285661afc;
