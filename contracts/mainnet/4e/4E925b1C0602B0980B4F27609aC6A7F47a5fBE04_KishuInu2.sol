...
contract KishuInu2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KishuInu 2.0";
    string constant _symbol = "$KISHU 2.0";
    ...
    uint256 public swapThreshold = _totalSupply * 65083 / 1000000; // 0.15% of supply
    bool inSwap;
