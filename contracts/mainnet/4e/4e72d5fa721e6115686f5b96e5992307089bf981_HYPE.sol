...
contract HYPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD7D5e411718C68C8904c9F456d6194167b669356); 
    address payable public Wallet_Dev = payable(0xD2158f6D3990F1682F05562c7F78d9e985C9763a);
    ...
    string private constant _name = "This Is Hype"; 
    ...
    constructor () {
        ...
        _owner = 0xD7D5e411718C68C8904c9F456d6194167b669356;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbE82e5dd3484e0772531A50Da6778dBef9F921ac); // Testnet
        uniSwapV2Pair = payable(0x6A056c5d4f832AB35832927496b894fEfBBF249e);
