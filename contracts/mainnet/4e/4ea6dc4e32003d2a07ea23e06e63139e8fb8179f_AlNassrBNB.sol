...
Al-NassrBNB is a coin project created for Al-Nassr lovers and football fans. 
Especially in this season, Cristiano Ronaldo's debut at Al-Nassr. 
the project will present a product that can help users get a ticket prize to watch Club Al-Nassr

Support AlNassr BNB for digital advancement with Binance smart chain

https://t.me/AlNassrBNB
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x572c970F5AF788Eded14F3CF7Ca88C93FbeFFcB0;
...
contract AlNassrBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Al-NassrBNB"; // 
    string private constant _symbol = "Al-Nassr"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xD2165c568BE325d0821ce37561551Af8Ff0477fE);
