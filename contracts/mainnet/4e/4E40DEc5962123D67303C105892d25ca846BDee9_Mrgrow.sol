...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xde169ea999B9ef192B75642EabAbA047c053F42F; // owner address
...
contract Mrgrow is Context, IERC20, Ownable {
    ...
    string private _name = "Mister Grow";
    string private _symbol = "MG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xde169ea999B9ef192B75642EabAbA047c053F42F); // Marketing Address
    address payable public teamWalletAddress = payable(0xde169ea999B9ef192B75642EabAbA047c053F42F); // Team Address
