...
contract PEARLToken is ERC20, Ownable {
    ...
    string private name_ = "MiToken";
    string private symbol_ = "MiToken";
    ...
    uint256 public lpRewardPeriod = 10 * 60;
    uint256 public lpRewardSendCount= 200;
    uint256 public swapTokensAtAmount = 100 * 10 ** 18;
    uint256 public miningPeriod = 10 minutes;
    uint256 public miningStartTime = 1670000400;
