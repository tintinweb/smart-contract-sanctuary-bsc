...
contract TaxTest2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TaxTest3";
    string constant _symbol = "TaxTest3";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf592c44928f472Ad36A8eF2B9d077dFEE5f2A6e8;
