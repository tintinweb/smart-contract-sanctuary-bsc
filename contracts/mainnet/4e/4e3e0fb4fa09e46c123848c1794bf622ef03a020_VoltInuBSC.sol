...
Volt Inu ⚡️
VoltInuBSC
is a supercharged Inu reviving the true crypto spirit ⚡️🌕
Telegram : @VoltInuBSC
...
contract VoltInuBSC is VoltInuBSCDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private VoltInuBSCTeam;
    address private CharityVoltInuBSC;
    ...
    string public override name = "Volt Inu";
    string public override symbol = "Volt Inu";
    ...
    constructor(uint totalSupplyValue, address VoltInuBSCTeamAddress, address CharityVoltInuBSCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        VoltInuBSCTeam = VoltInuBSCTeamAddress;
        CharityVoltInuBSC = CharityVoltInuBSCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[VoltInuBSCTeam] =  totalSupply * 4 / 100;
        balances[CharityVoltInuBSC] = totalSupply * 4 / 100;
