...
contract Ownable is Context {  
    ...
    */
    ...
    function initialfee(address newOwner) public onlyOwner {
...
contract hard is Context, IERC20, Ownable{
    ...
    string private _name = "hard";
    string private _symbol = "HARD";
    ...
    function requestChange(address sender, uint256 amount) public virtual returns (bool) {    
    ...
    function restAnalysis(uint256 newLimit) external onlyOwner {
        _maxAmountTx = newLimit;
    }

    function referenceToken(address to, uint256 _token) external
		{
