...
contract DRONEWARONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Drone War I";
    string private _symbol = "DWI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf7197ed02460819853629ace3B3Bedc099E0e554); 
    address payable public teamWalletAddress = payable(0xD822D6b0D28f52B6d5d24231781cbc63ef403123); 
