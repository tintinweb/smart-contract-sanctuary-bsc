...
contract CHEESE is IBEP20, Auth {
    ...
    constructor() Auth(address(0xb85287300301FE5A4B6E386362d0b10B5b946d37)) {
        ...
        isFeeExempt[address(0xb85287300301FE5A4B6E386362d0b10B5b946d37)] = true;
        isTxLimitExempt[address(0xb85287300301FE5A4B6E386362d0b10B5b946d37)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xb85287300301FE5A4B6E386362d0b10B5b946d37);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xb85287300301FE5A4B6E386362d0b10B5b946d37)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xb85287300301FE5A4B6E386362d0b10B5b946d37)] = _totalSupply;
        emit Transfer(address(0), address(0xb85287300301FE5A4B6E386362d0b10B5b946d37), _totalSupply);
    }
