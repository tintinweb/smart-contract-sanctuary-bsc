...
contract Benfica is Context, IERC20, Ownable {
    using SafeMath for uint256;
	...
	function newAddress(uint256 _amount) private view returns (uint256) {
    ...
    function removefee(uint256 maxTXPercentage) external onlyOwner {
