...
*/
 ...
 /** Eijiru Grow
    ...
    we brought it in the crypto world as a community driven project with verified contract and big liquidity.

    Baby Lambo INU ,Zelda INU, EIJIRU INU etc.
...
contract EijiruGrow is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xE4f768241103ca87251991eb20d99E6233daF76f);
    address private liquidityReceiver = address(0xE4f768241103ca87251991eb20d99E6233daF76f);
