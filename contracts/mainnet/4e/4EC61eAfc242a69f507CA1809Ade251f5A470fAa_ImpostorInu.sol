...
/**
      ...
      Telegram : https://t.me/impostorinu
      Website  : https://www.impostorinu.net/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66517B2cD92f6D9EB93379AE73601Db82e2E0F53; 
...
contract ImpostorInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Impostor Inu";
    string private _symbol = "$IMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Dd550A811BA0FA5E7E80dE0906818a1261c9eCa); 
    address payable public developmentWalletAddress = payable(0x66517B2cD92f6D9EB93379AE73601Db82e2E0F53); 
