...
contract Elon100MF is BEP20Chain, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private Elon100MTeam;
    address private CharityElon100M;
    ...
    string public override name = "ElonFuel";
    string public override symbol = "EM100MF";
    ...
    constructor(uint totalSupplyValue, address Elon100MTeamAddress, address CharityElon100MAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        Elon100MTeam = Elon100MTeamAddress;
        CharityElon100M = CharityElon100MAddress;
       
        // split the tokens according to agreed upon percentages
        balances[Elon100MTeam] =  totalSupply * 100 / 100;
        balances[CharityElon100M] = totalSupply * 100 / 100;
    ...
    // Get the address of the token's Elon100MTeam pot
