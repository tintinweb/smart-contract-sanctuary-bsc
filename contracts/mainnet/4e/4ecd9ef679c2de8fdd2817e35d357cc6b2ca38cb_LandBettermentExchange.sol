...
contract BEP20 is Ownable, IBEP20, IBEP20Metadata {
    ...
    function mint(uint256 amount) public onlyOwner virtual returns (bool) {
        require(_totalSupply >= _supply.add(amount), "BEP20: mint exceeded to the total supply");
...
contract LandBettermentExchange is BEP20 {
    using SafeMath for uint256;
    constructor(string memory coinName, string memory symbol, uint256 initialSupply, uint256 totalSupply) BEP20(coinName, symbol, initialSupply, totalSupply) {
