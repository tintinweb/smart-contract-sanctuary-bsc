...
contract BANDAINAMCOCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BANDAI NAMCO COIN";
    string private _symbol = "BANAM";
    ...
    address payable private _marketingWallet = payable(0x6C2A481E132a50a2F48f571930e4d4B84c243201);
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(0x72CdBCeDF5561501d9bb6571B2040fddf5aF78e5).transfer(amountBNB * amountPercentage / 100);
    }
