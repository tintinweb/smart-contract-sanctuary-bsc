...
/**
Telegram : https://t.me/SafemoonShark
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcB1316f569765435e64d820f5D7f18160a53306b; // owner address
...
contract Safemoonshark is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon Shark";
    string private _symbol = "SS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcB1316f569765435e64d820f5D7f18160a53306b); 
    address payable public teamWalletAddress = payable(0xcB1316f569765435e64d820f5D7f18160a53306b); 
    ...
    uint256 public _maxTxAmount = 1380000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 1380000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000000000000000000 * 10**_decimals; 
