...
contract KaBONKsu is Context, IERC20, Ownable {
    ...
    string private _name = "KaBONKsu";
    string private _symbol = "KABONKSU";
    ...
    address public charityWallet = 0x2e445B2080B4E1830CFf2940905c3Ee0DC1d02a2;
    ...
    constructor () public {
        ...
        //maxTxAmountSell = totalSupply() * 40 / 1000; // 4% maxTx for sell
        _maxWalletSize = totalSupply() * 40 / 1000; // 4% maxWallet
