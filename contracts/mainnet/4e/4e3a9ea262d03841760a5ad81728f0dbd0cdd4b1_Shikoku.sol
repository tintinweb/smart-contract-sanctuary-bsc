...
contract Shikoku is Context, IERC20, Ownable {
    ...
    string private _name = "ShikokuCoin";
    string private _symbol = "$SHIK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06FB2A1Da3de0ff2f36b708378Ebfe34D96aB97b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x06FB2A1Da3de0ff2f36b708378Ebfe34D96aB97b); // BuyBack Address
