...
/** 1% fee auto add to the liquidity 1%market 
  MADE IN CHINA Moon TG：https://t.me/Zhongguozhizaozilla
  */
...
contract SS is Context, IERC20, Ownable {
    ...
    string private _name = "\u4e2d\u56fd\u5236\u9020Zilla";
    string private _symbol = "\u4e2d\u56fd\u5236\u9020Zilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0bFAb5D656bb50DB4e59F71907aB4D37E227cc13); 
    address payable public teamWalletAddress = payable(0x0bFAb5D656bb50DB4e59F71907aB4D37E227cc13); 
    ...
    uint256 public _maxTxAmount = _totalSupply.div(2); 
    uint256 public _walletMax = _totalSupply.div(2);
    uint256 private minimumTokensBeforeSwap = _totalSupply.div(10000000); 
