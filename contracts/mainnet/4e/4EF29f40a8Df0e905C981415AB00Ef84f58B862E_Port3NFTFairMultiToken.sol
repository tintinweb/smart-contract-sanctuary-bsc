...
contract Port3NFTFairMultiToken is Initializable, AccessControl, ERC1155Supply, IPort3NFTFairMultiToken {
    ...
    function initialize(address _admin, address _minterAndSigner, uint256 _tokenIdCount, bool _transferrable, string memory _uri) public initializer {
        _setupRole(DEFAULT_ADMIN_ROLE, _admin);
        _setupRole(MINTER_ROLE, _minterAndSigner);
        _setupRole(MINTING_SIGNER_ROLE, _minterAndSigner);
