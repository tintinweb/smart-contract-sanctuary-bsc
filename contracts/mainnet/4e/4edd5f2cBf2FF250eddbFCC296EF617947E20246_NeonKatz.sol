...
contract NeonKatz is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xD06200e107072d3DF5A3996287eA31Da0D573F0a));
    address payable public devWallet =
        payable(address(0xE26E930cD7bdd92b87369F4226Dd7C5eA34Fe157));
    address public liquidityReceiver =
        0xE26E930cD7bdd92b87369F4226Dd7C5eA34Fe157;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Neon Katz";
