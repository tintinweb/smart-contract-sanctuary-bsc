...
contract Astro is ERC721Enumerable, Ownable {
    ...
    // Lists
    uint256[700] public remainingIds;
    ...
    address public RewardToken = 0x7a11F27B79BDc0FD69E9E94F52d108078F490563;
    address public FeeReceiver = 0xe8E4f018753CC47ea4176389bd973eDe9e8D1577;
    ...
    function mint(uint256 _mintAmount) public payable {
        // Checks
        require(!paused, "Astro: minting has not started yet");
        require(_mintAmount > 0, "Astro: you have to mint at least one");
        require(
            _mintAmount <= maxMintAmount,
            "Astro: you can only mint 10 at a time"
        );
        require(
            lastSupply >= _mintAmount,
            "Astro: the collection is sold out"
        );
        if (msg.sender != owner()) {
            require(
                msg.value >= cost * _mintAmount,
                "Astro: total cost isn't match"
            );
        }
        // Minting
    ...
    {
        // Checks
        require(_winner != address(0), "Astro: zero address");
        require(_amount > 0, "Astro: you have to mint at least one");
        require(lastSupply != 0, "Astro: the collection is sold out");
    ...
    function tokenURI(uint256 _id)
        ...
        returns (string memory)
    {
        require(_exists(_id), "Astro: URI query for nonexistent token");
  ...
  */
    ...
    function claimRewards() public {
        require(!paysInTokens, "Astro: rewards are paid in tokens");
