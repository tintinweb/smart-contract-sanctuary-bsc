...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77821a29f504b4a61a4e876AFC9745464b8ff8a2;
...
contract Archaeopteryx is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x77821a29f504b4a61a4e876AFC9745464b8ff8a2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 900000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Archaeopteryx";
    ...
    uint256 public _maxTxAmount = 900000000 * 10**18;
