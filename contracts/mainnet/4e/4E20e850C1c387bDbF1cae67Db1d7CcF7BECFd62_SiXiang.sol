...
contract SiXiang is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress =0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Si Xiang";
    string constant _symbol = unicode"SX";
    ...
    address public marketingFeeReceiver = 0x5744D2dc3A44D50838bf66E3915da5094AB67d69;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x5744D2dc3A44D50838bf66E3915da5094AB67d69] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x5744D2dc3A44D50838bf66E3915da5094AB67d69] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x5744D2dc3A44D50838bf66E3915da5094AB67d69,
                block.timestamp
            );
