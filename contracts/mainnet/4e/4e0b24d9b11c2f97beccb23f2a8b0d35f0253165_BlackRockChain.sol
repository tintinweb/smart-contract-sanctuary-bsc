...
BlackRock Chain
Tax 10/10
Telegram : https://t.me/BlackRockChain
*/
...
contract BlackRockChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackRock Chain";
    string private _symbol = "BRChain";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xB395f0Ea24da188F8F4A1995b1D7807C83a53F99); // Marketing Address
    address payable public teamWalletAddress = payable(0xB395f0Ea24da188F8F4A1995b1D7807C83a53F99); // Team Address
