...
contract CAKRS is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0x5373081702763755c6EdF228CB1dFe7EDB845175;
    address private devWallet = 0x5373081702763755c6EdF228CB1dFe7EDB845175;
    address public Charity = 0x5373081702763755c6EdF228CB1dFe7EDB845175;

    string private constant _name = "CAKRS";
    string private constant _symbol = "CAK";
    ...
    Taxes public taxes = Taxes(1, 6, 0, 0, 0);
    Taxes public sellTaxes = Taxes(1, 6, 0, 0, 0);
