...
contract SwapInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Swap Inu"; 
    string private _symbol = "SWAP INU"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87b8625BD18953c47bA83220877513a922882d47); 
    address payable public teamWalletAddress = payable(0x316Ffd06303FefD4739034a1aEC561742463a134); 
