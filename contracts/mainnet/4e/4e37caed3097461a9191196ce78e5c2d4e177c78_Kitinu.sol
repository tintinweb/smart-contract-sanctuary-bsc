...
Hyper-deflationary token whose aim is to invest in multiple asset classes such as NFTs, nodes, altcoins, staking & farming of stablecoins. This investement diversity allows to mitigate the risk while taking advantage of the possible non-correlated growth of the trending assets. Pumpin! Plan your entry.
...
contract Kitinu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x57619b50e7778CC313679ECf359947C9a1c764e4); 
    address payable public Wallet_Dev = payable(0x3a8b3cc80CEbc961490c9cD79fcAC5607352cF73);
    ...
    string private constant _symbol = unicode"$KITINU"; 
    ...
    constructor () {
        ...
        _owner = 0x3a8b3cc80CEbc961490c9cD79fcAC5607352cF73;
