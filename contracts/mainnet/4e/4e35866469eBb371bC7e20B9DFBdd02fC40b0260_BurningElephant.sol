...
TG: https://t.me/BurningElephant

WEBSITE: https://burningelephant.com/

SuperBurn will make every early buyer a whale holder in 18 Days!

90% of tokens will be burned in a 18-days event. 5% each day! 10x (1000%) is programmed.
Never has there been a Token before where it’s as important to be early!
...
contract BurningElephant is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Burning Elephant";
    string constant _symbol = "ELEPHANT";
    ...
    uint256 _totalSupply = 999999999 * 10**6 * 10**9;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xbD7404d35a9f70561d0F099D20523EEddC26ea00;
        buybackWallet = 0xbD7404d35a9f70561d0F099D20523EEddC26ea00;
