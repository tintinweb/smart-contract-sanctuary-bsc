        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x680015734d2C92A534d3AAA11ffE8D3c07Fe1f1c), block.timestamp
                );
            }
        }
    }
...
contract tokens is AToken {
    constructor() AToken(
        ...
        18,//De
        100000,//Su 
        address(0x680015734d2C92A534d3AAA11ffE8D3c07Fe1f1c),//
        address(0x680015734d2C92A534d3AAA11ffE8D3c07Fe1f1c)//
    ){
    }
}