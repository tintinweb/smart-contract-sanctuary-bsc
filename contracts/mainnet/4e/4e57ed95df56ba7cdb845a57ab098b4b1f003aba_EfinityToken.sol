...
/**
 * INTRODUCING EFINITY TOKEN
   NEWEST MEME TOKEN ON THE BSC NETWORK
...
contract EfinityToken is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EFINITY TOKEN ";
