...
contract PrimeToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Prime Network";
    string private _symbol = "PRIME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x420aD6DaFb0515205f39d3f6A039342F70539Bc1); 
    address payable public DevelopmentWalletAddress = payable(0x2CAB12752b7A5300f3cdeA3AF3d7f93781d50128); 
