...
👩‍⚕️HealerDoge - Utility token on BSC


This is a project about an online bot where you can consultate your pet's health.

8% Taxes fully spent on marketing

Socials🌐

TG : http://t.me/HealerDoge
 Website http://healerdoge.online
...
contract HealerDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HealerDoge";
    ...
    address public Owner=0x87A260b6a64996AC7eb8c95CDeC01bA807dA9aAB; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x87A260b6a64996AC7eb8c95CDeC01bA807dA9aAB;
