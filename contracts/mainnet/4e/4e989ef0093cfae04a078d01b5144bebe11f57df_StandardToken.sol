...
contract StandardToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    IPancakeCaller public constant pancakeCaller =
        IPancakeCaller(0xFF44DD7f232Bf7F778C059FC7171ce1DE58381A4);
    ...
    function initialize(
        ...
        minAmountToTakeFee = _totalSupply / (100000000);
