...
contract MagicDegen is IBEP20, Auth {
    ...
    string constant _name = "MagicDegen";
    string constant _symbol = "MagicDegen";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100;  //6% max wallet
    ...
    address private marketingFeeReceiver =0xFe03049BA3E5bA6128c0aCF774D0AB4D7a47BD6C;
    address private teamFeeReceiver =0xFe03049BA3E5bA6128c0aCF774D0AB4D7a47BD6C;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xFe03049BA3E5bA6128c0aCF774D0AB4D7a47BD6C;
