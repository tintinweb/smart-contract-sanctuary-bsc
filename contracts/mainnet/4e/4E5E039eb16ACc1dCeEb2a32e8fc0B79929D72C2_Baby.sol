...
contract Baby is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x560158431058b4A119DB430e0a5eaBEA00a58cC7);
    address payable public teamWalletAddress = payable(0x560158431058b4A119DB430e0a5eaBEA00a58cC7);
