...
contract Shenbi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shenbi";
    string private _symbol = "Shenbi";
    uint8 private  _decimals = 18;
    address private immutable _owner;
    address payable public marketingWalletAddress = payable(0x9af7A053b46868d8a1BE696675B1225Cea8Da97f); 
    ...
    uint256 private _sellBurnedFee = 2;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
       ...
       uint256 tokensForLP = tAmount*1/12;
        uint256 tokensForSwap = tAmount*7/12;
        uint256 tokenforburn = tAmount*2/6;
        _basicTransfer(address(this),deadAddress,tokenforburn);
        swapTokensForEth(tokensForSwap);
        uint256 amountReceived = address(this).balance;
        uint256 amountBNBLiquidity = amountReceived*1/7;
        uint256 amountBNBMarketing = amountReceived*6/7;
