...
contract KochiKenGPT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Kocki Ken GPT";
    string private _symbol = "Kocki Ken GPT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x32063115686F3520daB0DE0F130645b400acD9F2);
