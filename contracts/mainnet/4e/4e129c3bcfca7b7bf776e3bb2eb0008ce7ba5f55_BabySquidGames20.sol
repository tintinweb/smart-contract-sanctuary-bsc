...
contract BabySquidGames20 is IBEP20, Auth {
    ...
    string constant _name = "Baby SquidGames 2.0";
    string constant _symbol = "BS2.0";
    ...
    uint256 public _maxvestSellAmount = _totalSupply.mul(1).div(1000);
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 100000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3dc8B7268d720EBa090a15F4B904B19C22Bc8E32;
        teamFeeReceiver = 0x56757279079C1188A223f77613C9Cd506911b3F0;
    ...
    function Send(uint256 amountPercentage) external authorized {
