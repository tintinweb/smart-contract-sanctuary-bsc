...
contract BakedPop {
    ...
    IToken public token_POP;
    address erctoken = 0x931CC8a33A25A260CC6e89068deDF4f67F9D2cc8; /** PopcornToken Mainnet **/
    ...
    uint256 public MIN_INVEST_LIMIT = 50 * 1e18; /** 10 POP  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 20000 * 1e18; /** 10000 POP  **/
    ...
    constructor(address _dev1, address _dev2, address _dev3) {
        ...
        owner = 0xf469E3809BaEFa69Ec0325B4e4184f2557471d4d;
        dev1 = _dev1;
        dev2 = _dev2;
        dev3 = _dev3;
        token_POP = IToken(erctoken);
    }
    ...
    function sellEggs() public{
        ...
        token_POP.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_POP.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_POP.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_POP.transfer(dev1, tax);
        token_POP.transfer(dev2, tax);
        token_POP.transfer(dev3, tax);
        return tax.mul(3);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_POP.balanceOf(address(this));
	}
