...
contract DOGERRANZAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogerranza Inu";
    ...
    address payable public buyBackWalletAddress = payable(0x4f0e55451accd06fD5eFE4a57006dd948583291C); // buyback Address
