...
contract AdvisorTimelockContract is Ownable {
	...
	/* the balances (in INERY) of all advisor members */
	mapping(address => uint256) public balanceOfINERY;

	/* the whitelist of the Advisor Timelock Contract */
    ...
    function allocation(address addr) external afterClosed {
