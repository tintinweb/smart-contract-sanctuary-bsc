...
// File: SpookyBabyDoge.sol

pragma solidity ^0.8.10;

contract SpookyBabyDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**9 * 10**9; //1 Billion Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string internal constant _name = "Spooky Baby Doge";
    string internal constant _symbol = "$SBD";
    ...
    address payable public _marketingWallet =
        payable(address(0x99947dC46978e50000ACE0c79130d1C5A39E466f)); // Marketing Wallet 

    bool internal inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 1 * 10**8 * 10**9; // 1% Of the supply
    uint256 public numTokensSellToGetBnb = 2 * 10**5 * 10**9; //20000 Tokens
    ...
    function setMaxTxAmount(uint256 value) external onlyOwner {
        require(
            value >= 5000000,
            "Max Tx should be greator than equal to 0.5% of the supply"
        );
