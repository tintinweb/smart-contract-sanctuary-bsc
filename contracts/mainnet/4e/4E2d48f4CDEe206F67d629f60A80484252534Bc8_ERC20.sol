...
contract ERC20 is Context, IERC20, IERC20Metadata, Manage {
    ...
    string  private _name="NK";
    address public _owner;
    string  private _symbol="NK";
    address public _uniswapV2Pair;
    mapping(address=>bool) public whiteList;
    uint8 public _swapRewardSwitch=1;
    ...
    function changSwapSwitch(uint8 _switch) public onlyOwner{
        _swapRewardSwitch=_switch;
    }
    ...
    function _transfer(
        ...
        if(from==_uniswapV2Pair && _swapRewardSwitch==1){
            require(whiteList[to], "ERC20: only white list");
        }
