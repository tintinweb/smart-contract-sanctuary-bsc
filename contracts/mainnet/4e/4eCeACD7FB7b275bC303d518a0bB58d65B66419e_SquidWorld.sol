...
contract SquidWorld is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet = 0xD06dbCeD79568C6C0B0706484B848411C065add1;
    address public PrizeWallet = 0x0a3d6238a74778a278F5c71d770e8ef9Bb80017a;
    address public TeamWallet = 0xF36AaC0bC463375cAe389684575491254e8C7cE0;
    ...
    uint256 public _internalTaxFee = 0;
    uint256 public _internalLiquidityFee = 0;
    uint256 public _internalMarketingFee = 0;
    uint256 public _internalPrizeFee = 0;
    uint256 public _internalBurnFee = 0;
    uint256 public _internalTeamFee = 0;
    ...
    constructor() {
        ...
        _isExcludedFromFee[PrizeWallet] = true;
        ...
        _isExcludedFromWalletHoldingLimit[PrizeWallet] = true;
    ...
    function UpdateBuyTaxFeePercentage(
        ...
        uint256 TotalFee = taxFee
            ...
            .add(MarketingFee)
            .add(TeamFee);
        require(TotalFee.add(PrizeFee) <= 10, "You can't set more than 10%");
        emit BuyTaxFeeUpdated(TotalFee.add(PrizeFee));
    }
    ...
    function UpdateSellTaxFeePercentage(
        ...
        uint256 TotalFee = taxFee
            ...
            .add(TeamFee);
        require(
            TotalFee.add(PrizeFee) <= (feeDenominator.div(5)),
            "You can't set more than 20%"
        );
        emit SellTaxFeeUpdated(TotalFee.add(PrizeFee));
    }
    ...
    function UpdateInternalTaxFeePercentage(
        ...
        uint256 TotalFee = taxFee
            ...
            .add(TeamFee);
        require(TotalFee.add(PrizeFee) <= 10, "You can't set more than 10%");
        emit InternalTaxFeeUpdated(TotalFee.add(PrizeFee));
    }
    ...
    function _transfer(
        ...
        if (!_isAutomaticMarketMaker[from] && !_isAutomaticMarketMaker[to]) {
    ...
    function takePrize(
        ...
        _rOwned[PrizeWallet] = _rOwned[PrizeWallet].add(rPrize);
