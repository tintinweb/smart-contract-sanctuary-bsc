...
abstract contract FL is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundUsdt >0) {
            ...
            USDT.transferFrom(address(_tokenDistributor), dev, fundUsdt/2);
        }
...
contract SWK is FL {
    constructor() FL(
        ...
        18,
        10000,
        address(0xF133Cb24CFB63D9F3ee05aa191da8B97b983cA26),
        address(0xC98D52AB9Bd4E46E74c3351b8218455f210e397e)
    ){
