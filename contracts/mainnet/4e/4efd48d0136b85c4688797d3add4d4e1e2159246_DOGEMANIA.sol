...
TG: https://t.me/DogeManiaRewards

STAKE BUSD AND WIN DOGES

WEBSITE REVEALED AT 30 MEMBERS

The sustainability of the DogeMania project will ultimately bring cryptocurrency users, miners and 
investors under one platform to bet, refer, play and earn seed income with unlimited opportunities making 
use of decentralization becomes a seamless performance platform 
that operates every second! With no time limit for withdrawal you can immediately access your funds.

DogeMania项目的可持续性将最终把加密货币用户、矿工和投资者带到一个平台上。
投资者在一个平台上进行投注、推荐、游戏和赚取种子收入的无限机会，使得 
利用去中心化成为一个无缝的性能平台 
每一秒钟都在运作! 由于没有提款的时间限制，你可以立即获得你的资金。
*/
...
contract DOGEMANIA is IBEP20, Auth {
    ...
    string constant _name = "DOGEMANIA";
    string constant _symbol = "DMAN";
    ...
    address public MarketingWallet = 0x15BC2180bFc228B108589C82839aC8d0c705043f;
    address public devFeeReceiver = 0x15BC2180bFc228B108589C82839aC8d0c705043f;
