...
contract TSUKABOY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Tsuka Boy";
    string private constant _symbol = unicode"TSUKABOY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xE49cd1b6e9f04833AA447B8fA0a0fbCd0266C025);
    address payable public MarketingWallet = payable(0x5514fC31374c663b21e53F9b599F3aad4d24bbea);
