...
contract SocialMiner {
    using SafeMath for uint256;

    IERC20 public token_BUSD;
	address erctoken = 0xF7d5960D6abdbc50DA1754c5aF0AE04FDb98024B; /** mainnet SOCIAL **/
    ...
    uint256 public MIN_INVEST = 10 ether; /** 10 SOCIAL  **/
	uint256 public WITHDRAW_COOLDOWN = 12 * 60 * 60; /** 12 hours  **/
    uint256 public WITHDRAW_LIMIT = 6000 ether; /** 6000 SOCIAL  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 30000 ether; /** 30,000 SOCIAL  **/
    ...
    function buyEggs(address ref, uint256 amount) public payable{
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                /** referral rewards will be in SOCIAL **/
                ...
                /** referral rewards will be in SOCIAL value **/
