...
contract Steamcoin is Context, IBEP20, LockToken {
    ...
    string private _name = "Steamcoin"; // token name
    string private _symbol = "SIG"; // token ticker
    uint8 private _decimals = 18; // token decimals

    IPancakeRouter02 public pancakeRouter;
    address public pancakePair;
    address payable public marketWallet = payable(0xF76Abf5AbCcABfd6f08275867d86Fdee851E04Ae);
    address payable public roadmapWallet = payable(0xF76Abf5AbCcABfd6f08275867d86Fdee851E04Ae);
    uint256 minTokenNumberToSell = 10 ether; // 1000000 max tx amount will trigger swap and add liquidity
    ...
    // buy tax fee
    uint256 public redistributionFeeOnBuying = 0; // 2.5% will be distributed among holder as token divideneds
    uint256 public liquidityFeeOnBuying = 0; // 1.5% will be added to the liquidity pool
    uint256 public marketingwalletFeeOnBuying = 0; // 2% will go to the marketingwallet address
    uint256 public roadmapFeeOnBuying = 0; // 1% will go to the roadmap wallet address

    // sell tax fee
    uint256 public redistributionFeeOnSelling = 0; // 2.5% will be distributed among holder as token divideneds
    uint256 public liquidityFeeOnSelling = 0; // 2.5% will be added to the liquidity pool
    uint256 public marketingwalletFeeOnSelling = 0; // 2% will go to the market address
    uint256 public roadmapFeeOnSelling = 0; // 2% will go to the roadmap wallet address
