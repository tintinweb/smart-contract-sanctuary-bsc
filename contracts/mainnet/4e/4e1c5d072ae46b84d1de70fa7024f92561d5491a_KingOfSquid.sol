...
contract KingOfSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KING OF SQUID";
    string private _symbol = "$KOSQUID";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x0a8Ef47cA0328510A076AE477a72f97136EaA06d); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x0a8Ef47cA0328510A076AE477a72f97136EaA06d); // Team Address
