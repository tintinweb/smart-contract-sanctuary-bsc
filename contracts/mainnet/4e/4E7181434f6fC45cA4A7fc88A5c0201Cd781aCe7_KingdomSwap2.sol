...
/**
 * Kingdom-Swap is a Binance Smart Chain native MMORPG P2E NFT GAME.
 * Our platform brings together NFT trading and play-to-earn gaming in one all-encompassing environment. 
 * You get to live the magic of the Kingdom Swap World: complete your favorite quests, visit long-forgotten locations, and most of all – take part in wars! 
 * You can feel the game adventures and earn some money on the side!
 * Players can choose between four different vocations to begin their open-world adventures. 
 * To gain experience and reach higher levels, you need to slay monsters, defeat magicians and much more...
 * To improve your the skills you need to fight or train, which will you make you stronger.
 *
 * Buy tax: 6% - Goes to LP
 * Sell tax: 6% - Goes to project development and marketing
 *
 * Visit our website for more information: https://kingdom-swap.com/
 */
...
contract KingdomSwap2 is Context, IERC20, Ownable {
    ...
    string private _name = "Kingdom Swap 2.0";
    string private _symbol = "KS2";
    ...
    uint256 public _maxTxAmount = 15000000 * 10**18; //no max tx limit rn
