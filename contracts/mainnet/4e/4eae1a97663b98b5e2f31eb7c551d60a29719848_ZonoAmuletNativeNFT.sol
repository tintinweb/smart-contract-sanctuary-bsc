...
contract ZonoAmuletNativeNFT is ERC721A, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    uint256 public _nftPrice = 0.3 ether; // NFT price in ETH
    uint256 public _maxSupply = 600;
    uint256 public _maxMintPerTx = 0;
    uint256 public _maxPerWallet = 0;

    uint256 public _mintActiveTime = 1659528000; // (GMT): Wednesday, August 3, 2022 12:00:00
    ...
    constructor() ERC721A("Zono Amulet Native", "ZANB") {}
