...
contract Inugami is IBEP20, Auth {
    ...
    string constant private _symbol = "INUGI";
    ...
    address public _sellFeeReceiver = 0x6BC1F6935794a76Ba36d0A771570deB9dBf162c0;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _taxLiquidity, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxLiquidity = _taxLiquidity;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _taxLiquidity.add(__sellFee).add(_devFee);
