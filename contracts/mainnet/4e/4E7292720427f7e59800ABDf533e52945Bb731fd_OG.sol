...
Telegram : https://t.me/OGBNBOFFICIAL
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAff40C34AD1eCd5Da132faeC9Ccb729Cf4515654;
...
contract OG is Context, IERC20, Ownable {
    ...
    string private constant _name = "OG BINANCE"; // 
    string private constant _symbol = "$OGBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xAff40C34AD1eCd5Da132faeC9Ccb729Cf4515654);
