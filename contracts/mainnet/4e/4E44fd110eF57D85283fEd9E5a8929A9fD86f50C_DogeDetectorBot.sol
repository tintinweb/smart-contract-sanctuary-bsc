...
/**
https://t.me/DogeDetectorBot
🤖 DOGE DETECTOR BOT 🤖

$DDB Bot helps you to follow up what DOGE is  doing! 
🤖 DDB Functionality

🔎Show which TX's in  DOGE are related to the ECO

🔎DOGE Chain Launch Alert System

🔎 You get a notification of Doge buybacks, transfers from MW, transfers from developer wallet, If You hold the Token + OURS
...
contract DogeDetectorBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DogeDetectorBot";
    string private _symbol = unicode"DDB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x94cf794ddFFF524574E5841c71014fb75a64fD9A));
        marketingWallet = payable(address(0x340b756Ea9D66582BF26793d2Eb2eBd96e628c03));
