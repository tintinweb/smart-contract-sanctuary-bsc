...
contract DividendDistributor is IDividendDistributor {
    ...
    contract BABYTATE is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Baby Tate";
    string constant _symbol = "TOP G";
    ...
    uint256 marketingFeeBuy = 5;   //Marketing 
    uint256 devFeeBuy = 1;         //Dev Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE429d4bA8537B759a432eE27F5d56976d0729E7D; //Marketing wallet
        devFeeReceiver = 0x3fd2716014d9D46Dd2B70c1C6eb836d3df136F0C; //Dev fee
