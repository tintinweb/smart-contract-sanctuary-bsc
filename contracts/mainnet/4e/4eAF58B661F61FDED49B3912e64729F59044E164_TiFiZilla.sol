...
contract TiFiZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "TiFiZilla";
    string private _symbol = "TiFiZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8Badb2145c48Ecc6C32C2e7806605b3907b3D5b4));
        m = payable(address(0x8Badb2145c48Ecc6C32C2e7806605b3907b3D5b4));
