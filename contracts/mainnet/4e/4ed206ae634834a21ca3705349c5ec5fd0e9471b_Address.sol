...
// File: contracts\alitestCoin.sol

// contracts/alitestCoin.sol
pragma solidity 0.8.0;
...
contract StorepayCoin is ERC20Burnable {
    ...
    constructor() ERC20("alitest Coin", "alitest") {
        

        // Founders, team and advisors
        teamTimelock = new TokenTimelock(this, 0xCB47dD72EcCE1A39D69e8160d000d4ED25D59073, block.timestamp + 1*365*24*60*60);
        _mint(address(teamTimelock), 30000000000*10**18);

        // Strategic resource
        _mint(0xEec31f22AE31ad8Cf62A0509Ff282b4Bb5ddAF0D, 60000000000*10**18);
    }
}