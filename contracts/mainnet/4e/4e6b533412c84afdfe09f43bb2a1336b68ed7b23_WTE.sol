...
contract WTE is Context, IERC20, Ownable, IERC20Metadata {
     ...
     * @dev set market div.
     */
    function setMarketDiv(uint256 mDiv) public onlyDev {
        _marketingDivFee = mDiv;
    }

    /**
     * @dev set system div.
     */
    function setSystemDiv(uint256 sDiv) public onlyDev {
        _systemDivFee = sDiv;
    }
     ...
     * @dev set flex fee.
     */
    function setFlexFee(uint256 fFee) public onlyDev {
        _flexFee = fFee;
    }
