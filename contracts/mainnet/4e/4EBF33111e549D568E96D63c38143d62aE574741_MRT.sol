...
contract MRT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MRT2.0";
    string private _symbol = "MRT2.0";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x55ddde959bBBF8852E0ca727e0C3aE4A1c381F2B); 
    address payable private teamWalletAddress = payable(0x575f3626001b549fa2658267b62Ab3c0AB9CE5bC); 
