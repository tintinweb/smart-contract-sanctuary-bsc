...
TG: https://t.me/ChitogeKirisakiOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf36c056FEB9bBBC44A1101A62A7409807e300c37; // owner address
...
contract ChitogeKirisaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chitoge Kirisaki";
    string private _symbol = unicode"桐崎 千棘";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB9dF8E5f3C210470202b07B3431270E63a5EeAB); // Marketing Address
    address payable public teamWalletAddress = payable(0xf36c056FEB9bBBC44A1101A62A7409807e300c37); // Team Address
    ...
    uint256 private _liquidityShare = 10;
    ...
    uint256 private _totalDistributionShares = 100;
