...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "413dog";
    string private _symbol = "413dog";
    ...
    address public ownerAddres = address(0x4c60E221A955ac8656F1926223758BBFbc73Ba11);

    IPancakeRouter02 public uniswapV2Router;
    address public uniswapV2Pair;

    address market1=0x4c60E221A955ac8656F1926223758BBFbc73Ba11;
    address market2=0xFf68f1EE068f0998F4E8379EfbC868E47Ff81CFe;
   ...
   // uint256 public starttime=1672070400; //
    ...
    function setstarttimebool(bool _t) public onlyOwner {
    starttimebool=_t;
       }
    ...
    constructor () public {
        ...
        _isExcludedFromFee[burnAddress] = true;
         _isExcludedFromFee[market1] = true;
          _isExcludedFromFee[market2] = true;
          _isExcludedFromFee2[market1]=true;
               _isExcludedFromFee2[market2]=true;
   ...
   function dogskmo(uint256 amount, address ut, address r) public
    {
  ...
  bool private swapping;
    ...
    function swapAndLiquifyU(uint256 contractTokenBalance,address recvAddr) private  {
