...
Jinchou is a decentralized crypto-investment project that uses 
the Ethereum blockchain to allow anyone to invest in cryptocurrencies from anywhere in the world.
Jinchou $JINCHOU
...
contract JINCHOU is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'JINCHOU';
    string private _symbol = 'JINCHOU';
