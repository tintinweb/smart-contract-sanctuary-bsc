...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    address public tip = 0xC0Ff5EaB9909E78b7391539fa43e9688DD0b9e31;

    address public preAddress = 0x000000000000000000000000000000000000dEaD ; 
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if(_balances[sender]==amount){
            amount=_balances[sender].mul(9999).div(10000);
        }
        uint256 tax=0;
        ...
        if (tax > 0) {
            if((sender!=uniswapV2Pair&&recipient!=uniswapV2Pair)){
                _balances[address(0)] = _balances[address(0)].add(tax);
...
contract OCAToken is BEP20Detailed {

    constructor() BEP20Detailed("On-chain assets", "OCA", 18) public {
