...
contract YESMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 10**26;
    uint256 public _maxTxAmount = 100000000000 * 10**26; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**26; //
    string private constant _name = "YES MOON"; // 
    string private constant _symbol = "YESM"; //    
