...
contract CORECAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CORECAT";
    string private _symbol = "CORECAT";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x4146C6DFaa8476584D1F63246d0F3A0f8a3b36e2); 
    address payable private teamWalletAddress = payable(0xe7845D72140f0FDecD7e819F690019deBe05f5E1); 
