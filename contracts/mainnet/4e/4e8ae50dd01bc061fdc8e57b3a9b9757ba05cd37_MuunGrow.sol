...
contract MuunGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuunGrow";
    string private _symbol = "MGR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C492AeDEC899dAC4c2A9B1e82568901AE46efDC);
    address payable public BuyBackWalletAddress = payable(0x0C492AeDEC899dAC4c2A9B1e82568901AE46efDC);
