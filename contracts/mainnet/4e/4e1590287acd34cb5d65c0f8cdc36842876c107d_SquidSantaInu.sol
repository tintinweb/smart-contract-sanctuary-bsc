...
contract SquidSantaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Santa inu";
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccessDev,) = payable(BuyBackReceiver).call{value: amountBNBDev, gas: 30000}("");
