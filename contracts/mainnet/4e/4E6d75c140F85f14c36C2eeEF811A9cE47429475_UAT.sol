...
contract UAT is Ownable, IBEP20 {
    ...
    address public marketing = 0xC5D39f4E5308B0FABaA2656130eADB2F916D9eA5; // 营销地址
    uint256 public buyFeeToDifidend = 2;
    uint256 public buyFeeToMarketing = 1;
    uint256 public buyFeeToInviter = 0;
    uint256 public sellFeeToDifidend = 2;
    uint256 public sellFeeToMarketing = 1;
    uint256 public sellFeeToInviter = 0;

    uint256 public feeToLpDifidend = 3;
    uint256 public feeToLiquidity = 0;
    ...
    constructor() {
        ...
        _symbol = "UAT";
        _decimals = 18;
        _totalSupply = 1000000000 * (10**18); //总供应量
        ...
        amountToStopBurn = _totalSupply.div(10); //销毁一半时就不再销毁
        amountToAddLiquidity = _totalSupply.div(1000); //LP回流的阀值
        amountTodifidend = _totalSupply.div(1000); //获得分红的最小持币量
        amountToDifidendWBNB = _totalSupply.div(1000); //分红wbnb的阀值
