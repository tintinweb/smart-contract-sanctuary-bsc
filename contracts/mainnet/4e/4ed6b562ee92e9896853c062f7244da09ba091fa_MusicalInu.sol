...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75B0EC399044cAc1A6a5755bc5BEd0446799cdF6; // owner address
...
contract MusicalInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Musical Inu";
    string private _symbol = "Musical Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable (0x648754F5D75773B129f8B5D5bE42DAEC90487719); // Marketing Address
    address payable public teamWalletAddress = payable (0x6517de079FFad10470C9d1Cf3c49136254BdE8AC); // Team Address
