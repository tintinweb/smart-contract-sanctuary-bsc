...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = " ROBONETWORK ";
    string private _symbol = " RNET ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x133e8fe773509D55A02968fD91cB82D1ABE98cfa);
    address payable public teamWalletAddress = payable(0x133e8fe773509D55A02968fD91cB82D1ABE98cfa);
