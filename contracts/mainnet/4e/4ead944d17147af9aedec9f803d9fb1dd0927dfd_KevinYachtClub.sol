...
/**
TG: https://t.me/kevinyachtclubb

KEVIN NOW A HAS A YACHT CLUB BECAUSE HE's ALREADY A RICH KEVIN!
LOW LP, LP WILL BE BURNED. OWNERSHIP WILL BE RENOUNCED
3% MAX BUY AND SELL AND WALLET LIMIT
...
contract KevinYachtClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kevin Yacht Club";
    ...
    uint256 public totalFee = 2; //Total Fee
    ...
    uint256 public totalFeeSell = 3; //Total Fee
