...
contract FamilyCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FamilyCat";
    string private _symbol = "FamilyCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2E9A60fd3140aCDBDF61Baf828f234ba7109A801); 
    address payable public buyBackWalletAddress = payable(0x9Ba75D83A4F58364fB0B90fEE0Be273Ffa99D9C4); 
    ...
    uint256 public _walletMax = 80000000000 * 10**9; // 8%
    ...
    function reward(address account, bool newValue) public onlyOwner {
