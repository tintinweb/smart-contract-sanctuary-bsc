...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5201314 * 10**9;

    string private _name = "1314520";
    string private _symbol = "1314520";
    ...
    uint256 public _maxTxAmount = 5201314 * 10**9;
    uint256 public _maxHavAmount = 5201314 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 500 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market = 0x40558DE352AE34fFbD2651D15a9083017BF625cb;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x40558DE352AE34fFbD2651D15a9083017BF625cb),
            _msgSender(),
            _tTotal
        );
    }
