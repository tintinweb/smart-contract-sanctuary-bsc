...
contract Test52 is ERC20Detailed, Ownable {
    ...
    string public _name = "TestSubject2";
    string public _symbol = "T52";
    ...
    constructor() ERC20Detailed("Test subject2", "52", uint8(DECIMALS)) Ownable() {
 ...
 function setMaxTransactionAmount(
    ...
    function rebase() internal {
        ...
        uint dayRebaseRate = 25018221 * 10**18; //calculate these correctly
    ...
    function BurnIT(uint _amount) public onlyOwner {
        IERC20(address(this)).transfer(firePit, _amount);
    }
