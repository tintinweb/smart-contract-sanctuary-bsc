...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDac2E6EAeb23e92B80CFaD0E571955EA2FF4401C; 
...
contract YogiInu is Context, IERC20, Ownable {
    ...
    string private _name = " Yogi Inu ";
    string private _symbol = " YOGI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDac2E6EAeb23e92B80CFaD0E571955EA2FF4401C); // 
    address payable public teamWalletAddress = payable(0xDac2E6EAeb23e92B80CFaD0E571955EA2FF4401C); // 
