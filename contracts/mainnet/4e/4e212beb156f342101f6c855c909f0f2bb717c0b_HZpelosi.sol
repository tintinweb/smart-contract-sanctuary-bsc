...
contract HZpelosi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "pelosidied";
    string private _symbol = "pelosidied";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7aC1526e981eDe5AE88076754F4ffaD0Fb8338F6); 
    address payable public teamWalletAddress = payable(0x7aC1526e981eDe5AE88076754F4ffaD0Fb8338F6); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply.div(5000); 
