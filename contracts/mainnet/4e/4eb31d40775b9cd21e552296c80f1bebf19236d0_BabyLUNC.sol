...
/**
Telegram: https://t.me/BabyLUNC
Twitter: https://twitter.com/Baby_LUNC
*/
...
contract BabyLUNC is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 6904017889662 * 10 ** _decimals;

    uint256 public _maxTxAmount =  6904017889662 * 10 ** _decimals;

    uint256 public _fee = 4;

    string private _name = "Baby LUNC";
