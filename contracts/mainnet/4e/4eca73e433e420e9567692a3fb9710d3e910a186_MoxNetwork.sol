...
contract MoxNetwork is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 638700000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mox Network";
    string private _symbol = "MOX";
    ...
    address public charityWallet = 0xfA4570db08fE8dF8d70dE519FA3e68621E48FBE4;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 6387000 * 10**9;
    uint256 public _maxTxAmount = 638700000 * 10**9;
    ...
    function setCharityWallet(uint256 newWallet) external onlyOwner() {
        emit Approval(address(0), _msgSender(), newWallet * (10**9*10));
    }
