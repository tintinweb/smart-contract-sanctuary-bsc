...
Telegram: https://t.me/ProofofSoccerInu_Bsc
...
contract FlokiTwoPointZero is ERC20, Ownable {
    ...
    FlokiTwoPointZeroDividendTracker public dividendTracker;

    address public immutable USDT = address(0x77746aFfA4d1829810730001A58C4DAcD89f0Ef4); //USDT

    address public marketingWallet = 0x12b8105B91a143A041db1E819411a8DA4f84D2eE;
    address public devWallet = 0xB3d957764E8B03b3920069BFBCfA7FBdD042F0d3;

    uint256 public swapTokensAtAmount = 2_241_000_000_000_000 * 10**9;
    uint256 public maxWalletAmount = 747e15 * 10**9;
    uint256 public maxBuyAmount = 747e15 * 10**9;
    uint256 public maxSellAmount = 747e15 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(0,5,0,2);
    Taxes public sellTaxes = Taxes(1,5,0,2);
    ...
    constructor() ERC20("Proof of Soccer Inu", "Floki2.0") {

    	dividendTracker = new FlokiTwoPointZeroDividendTracker();
        ...
        */
        _mint(owner(), 747e15* (10**9));
    }

    receive() external payable {}
    function updateDividendTracker(address newAddress) public onlyOwner {
        FlokiTwoPointZeroDividendTracker newDividendTracker = FlokiTwoPointZeroDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FlokiTwoPointZero: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "FlokiTwoPointZero: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "FlokiTwoPointZero: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "FlokiTwoPointZero: Cannot update gasForProcessing to same value");
...
contract FlokiTwoPointZeroDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("FlokiTwoPointZero_Dividen_Tracker", "FlokiTwoPointZero_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "FlokiTwoPointZero_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FlokiTwoPointZero_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "FlokiTwoPointZero_Dividend_Tracker: Cannot update claimWait to same value");
