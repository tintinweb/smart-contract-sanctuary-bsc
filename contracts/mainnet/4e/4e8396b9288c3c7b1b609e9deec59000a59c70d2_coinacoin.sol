...
contract coinacoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "coin a coin";
    string private _symbol = "coin a coin";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xDc62a6961Bd8DB78999De9d3684630a6838cB4E5); 
    address payable private teamWalletAddress = payable(0xDc62a6961Bd8DB78999De9d3684630a6838cB4E5); 
    ...
    uint256 private _totalSupply = 1 * 8000000000000*  10**_decimals;
