...
// File: contracts/PubCoinToken.sol
...
/*
    ...
    The smart community token with custom made features and utility. The fully featured website details the information.
*/
...
// Main Contract
contract PubCoinToken is IERC20Metadata, Ownable {
    ...
    // General
    string private _name = 'PubCoin Token';
    string private _symbol = 'PUB';
    ...
    address payable public liqWallet = payable(0xf6F7DFA2a552b68b8c0B89EAA646b4Fb55418472);

    // Max wallet size
    uint256 public maxWalletSize = 3;
    ...
    uint256 public clubEntryPrice = 5000000000;
    bool public enablePubClub = false;
    ...
    uint256 public taxTaxB  = 1;
    uint256 public taxTaxT  = 0;
    uint256 public clubTaxS = 5;
    uint256 public clubTaxB = 5;
    uint256 public clubTaxT = 0;
    uint256 public liqTaxS = 3;
    uint256 public liqTaxB = 2;
    uint256 public liqTaxT = 0;

    // Tax options
    bool public taxesOnSell = true;
    bool public taxesOnBuy = true;
    bool public taxesOnTran = false;
    bool private doTaxes = true;

    // Swap
    uint256 public taxSwapAt  = 5000000000;
    uint256 public liqSwapAt  = 5000000000;
    ...
    function renounceOwnership() public override onlyOwner {
        if (_walletBalance[address(this)] == 1337){ // Added a check to stop accidental renounce
            _transferOwnership(address(0));
        }
    }
    ...
    function changeEnablePubClub(bool clubEn) public virtual onlyOwner {
        enablePubClub = clubEn;
    }
