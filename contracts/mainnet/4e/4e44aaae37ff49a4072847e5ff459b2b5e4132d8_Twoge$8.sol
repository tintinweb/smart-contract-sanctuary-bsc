...
contract Twoge$8 is Context, IERC20, Ownable {
    ...
    string private constant _name = " Twoge$8 "; // 
    string private constant _symbol = " $TWOGE$8 "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x4e3DEd259BcA7De09Fb9f9A70BE8dAAf8219E8dA;
