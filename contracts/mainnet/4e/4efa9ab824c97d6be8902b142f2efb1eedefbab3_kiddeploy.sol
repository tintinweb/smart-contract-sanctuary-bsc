...
// Kid Deployer Inu is brand new gem finder on BSC. Mint our NFT to use our KidDeployBot and make plenty profits within our ecosystem.
// official channel  - kiddeploy
...
contract kiddeploy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kid DeployerInu";
    string private _symbol = "KID DEPLOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x566308Be4f27D610958A414Eb9EFB98eeF37019E); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x566308Be4f27D610958A414Eb9EFB98eeF37019E); // buyback Address
