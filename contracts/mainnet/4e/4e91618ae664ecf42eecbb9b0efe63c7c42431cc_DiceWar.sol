...
contract DiceWar is ERC20, Ownable {
    constructor() ERC20("DiceWar Token", "DWT") {
    ...
    function burn(address _addr, uint256 amount) external admin {
        _burn(_addr, amount);
    }

    function balanceOfToken(address _addr) external view returns (uint256) {
