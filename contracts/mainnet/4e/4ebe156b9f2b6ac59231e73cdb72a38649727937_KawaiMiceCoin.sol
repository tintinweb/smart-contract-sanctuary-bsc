 ...
 *Submitted for verification at BscScan.com on 2022-07-08
*/
// Telegram : https://t.me/kawaimicecoin
...
contract KawaiMiceCoin is IBEP20, Auth {
    ...
    string constant _name = "Kawai Mice Coin";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x08215aaD2e0b9E60d779483d7677CB22cb1559f4;
        teamFeeReceiver = 0x08215aaD2e0b9E60d779483d7677CB22cb1559f4;
        devFeeReceiver = 0x08215aaD2e0b9E60d779483d7677CB22cb1559f4;
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator/2, "Fees cannot be more than 99%");
    }
