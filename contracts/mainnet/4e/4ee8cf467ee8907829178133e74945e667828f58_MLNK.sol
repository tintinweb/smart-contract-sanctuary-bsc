...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Malinka';

    string constant public symbol = 'MLNK';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 88000000000*10**uint256(decimals);
