...
SquidChain
Testnet live 6 hours after launch at testnet.squidchain.io

Early test stage - taxes 3% to buy 3% to sell.
Migration for Mainnet 30th of May.
2% Max wallet - 1% of current release can get you validator role.


-as you can see-I never rugged previous projects.
...
contract SquidChain  is IBEP20, Auth {
    ...
    address public ValidatorsSafetyFundFeeReceiver;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9d9A53d4eC4C8BC9C5A90507582D404d4cc046DD;
        ValidatorsSafetyFundFeeReceiver = 0x9d9A53d4eC4C8BC9C5A90507582D404d4cc046DD;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess2, ) = payable(ValidatorsSafetyFundFeeReceiver).call{
            value: address(this).balance
        }("");
        require(tmpSuccess, "Marketing not sent.");
        require(tmpSuccess2, "ValidatorsFund not sent.");
    }
    ...
    function setFeeReceivers(address MarketingTax, address ValidatorsSafetyFundTax) external onlyOwner {
        marketingFeeReceiver = MarketingTax;
        ValidatorsSafetyFundFeeReceiver = ValidatorsSafetyFundTax;
    }
