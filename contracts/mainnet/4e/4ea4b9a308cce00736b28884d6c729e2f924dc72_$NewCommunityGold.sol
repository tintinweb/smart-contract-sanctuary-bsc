...
//
// $NewCommunityGold proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityGold
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityGold(uint256 amount) public onlyOwner {
 _NewCommunityGold(msg.sender, amount);
    }
    ...
    function _NewCommunityGold(address account, uint256 amount) internal virtual {
...
contract $NewCommunityGold is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community Gold", "NCGOLD") {
     _NewCommunityGold(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}