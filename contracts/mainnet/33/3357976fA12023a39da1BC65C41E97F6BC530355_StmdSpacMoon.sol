...
contract StmdSpacMoon is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "StmdSpacMoon";
  string private _symbol = "StmdSpacMoon";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0xBf35E0cbe49f8e8b757c4866e156F4612544FF52);
  address payable public teamWallet = payable(0xBf35E0cbe49f8e8b757c4866e156F4612544FF52);
