...
contract FanETHking  is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FanETHking";
    string constant _symbol = "FEK";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8CBd32b0FaB37cf1bd0317b72762b306FF94A0A1; //marketingwallet
        anothermarketingWallet = 0x8CBd32b0FaB37cf1bd0317b72762b306FF94A0A1;
