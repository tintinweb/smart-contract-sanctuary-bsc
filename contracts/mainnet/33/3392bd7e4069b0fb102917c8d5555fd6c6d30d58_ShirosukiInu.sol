...
/**
Telegram https://t.me/ShirosukiInu_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x928cACE81781cFDd9A12270e30590bBf66156Ff1; // owner address
...
contract ShirosukiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shirosuki Inu";
    string private _symbol = "Shinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x928cACE81781cFDd9A12270e30590bBf66156Ff1); // Marketing Address
    address payable public teamWalletAddress = payable(0x928cACE81781cFDd9A12270e30590bBf66156Ff1); // Team Address
