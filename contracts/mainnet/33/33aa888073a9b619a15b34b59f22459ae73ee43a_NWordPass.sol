...
// OpenZeppelin Contracts (last updated v4.8.0) (token/BEP721/BEP721.sol)
...
abstract contract BEP721Enumerable is BEP721, IBEP721Enumerable {
    ...
    function _beforeTokenTransfer(
        ...
        if (batchSize > 1) {
            ...
            revert("BEP721Enumerable: consecutive transfers not supported");
        }
...
contract NWordPass is BEP721Enumerable, Ownable {

    struct PaymentMethod {
        IBEP20 acceptedCrypto;
        uint256 costvalue;
    }
    ...
    constructor() BEP721("N Word Pass", "NWP") {}

    function addCurrency(
        IBEP20 _acceptedCrypto,
        uint256 _costvalue
    ) public onlyOwner {
        AllowedCrypto.push(
            PaymentMethod({
    ...
    return "ipfs://QmV58tjHdhUt4gCk5hUogYK9x9HukpEvCtqoaUoeCuU8dL/";
