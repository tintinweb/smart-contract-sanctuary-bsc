...
contract ZZSH is ERC20 {
	...
	address public _fundAddress = address(0xDbCc72B9Db7CAEf90ABd5562906141aEe3369488);
    address public _fund1Address = address(0xDbCc72B9Db7CAEf90ABd5562906141aEe3369488);
    ...
    constructor(address tokenOwner) ERC20("ZZSH", "DH") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, _fund1Address, amount.div(100).mul(4));
