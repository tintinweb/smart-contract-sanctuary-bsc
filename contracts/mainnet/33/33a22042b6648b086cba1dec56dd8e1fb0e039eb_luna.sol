...
contract luna is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        if (takeFee) {
            uint256 fees = amount.mul(4).div(100);
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        IERC20(rewardToken).transfer(_marketingWalletAddress, newBalance.div(2));
        IERC20(rewardToken).transfer(_teamWalletAddress, newBalance.div(2));
    }
