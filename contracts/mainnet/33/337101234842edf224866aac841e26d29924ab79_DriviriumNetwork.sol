...
contract DriviriumNetwork is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x7F256ac05F3ec7625CF0Af96985E32d2D8ca995B); 
    address payable private Wallet_Dev = payable(0x7F256ac05F3ec7625CF0Af96985E32d2D8ca995B);
    ...
    string private constant _name = "Drivirium Network"; 
    string private constant _symbol = unicode"DRIVIRIUM"; 
    ...
    constructor () {
        ...
        _owner = 0x7F256ac05F3ec7625CF0Af96985E32d2D8ca995B;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7F256ac05F3ec7625CF0Af96985E32d2D8ca995B); // Testnet
