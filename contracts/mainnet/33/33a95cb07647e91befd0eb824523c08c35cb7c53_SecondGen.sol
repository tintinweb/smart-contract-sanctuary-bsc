...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x00817F75Cd27E11Be6bE85482755115CF565D19b;
...
contract SecondGen is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x00817F75Cd27E11Be6bE85482755115CF565D19b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SecondGen";
    string private _symbol = "SecGen";
