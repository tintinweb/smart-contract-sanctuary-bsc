...
contract RichShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RichShiba ";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "RichShiba";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6de447F3d73AFAB2EAEC88b5Dc75fd4a0D1D0dC5;
        marketingFeeReceiver = 0x6de447F3d73AFAB2EAEC88b5Dc75fd4a0D1D0dC5;
