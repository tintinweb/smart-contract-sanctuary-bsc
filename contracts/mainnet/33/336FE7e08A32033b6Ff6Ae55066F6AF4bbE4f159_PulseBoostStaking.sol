...
contract PulseBoostStaking is Ownable, Pausable, ReentrancyGuard {
    ...
    function deposit(uint256 amount) external nonReentrant whenNotPaused updateReward updateUserList {
        require (block.timestamp < endTime, "expired");
        require(IERC721(0x5eA51b23eA6F1223adF15E1E5534C3A0f95F247e).balanceOf(msg.sender) > 0, "You need to own NFT to stake!");
