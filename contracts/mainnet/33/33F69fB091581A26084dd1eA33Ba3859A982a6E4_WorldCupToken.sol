...
contract WorldCupToken is Context, IERC20, Ownable {
    ...
    string private _name = "World Cup Token";
    string private _symbol = "$WCT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7ca6F690D72038FF980D3a471Ca32Dc0C50E3930); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xc255317d1A5e69c280A1885124388337F53f93cE); // Development Address
