...
contract MPP is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 100000000 * 10**9;
    uint256 public maxSellAmount = 100000000 * 10**9; 
    ...
    address public  _marketingWallet = payable(address(0x6E5A4D5DB23af13BBABdADF6B5FE69014a219cDA)); //change youyr marketing wallet
    ...
    constructor() ERC20("Meta Poo Pad", "MPP") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MPP: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "MPP: The new dividend tracker must be owned by the MPP token contract"
        );
    ...
    require(newAddress != address(uniswapV2Router), "MPP: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "MPP: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MPP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MPP: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "MPP: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MPP: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        require(from != address(0), "MPP: transfer from the zero address");
        require(to != address(0), "MPP: transfer to the zero address");
        require(
...
contract DividendTrackerAI is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("MPP_Dividend_Tracker", "MPP_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "MPP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MPP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MPP contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "MPP_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "MPP_Dividend_Tracker: Cannot update claimWait to same value"
        );
