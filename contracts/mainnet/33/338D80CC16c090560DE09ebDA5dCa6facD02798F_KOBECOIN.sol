...
/**
Welcome To KobeCoin $Kobe  HOLD $KOBE and Earn BUSD Rewards
*/
...
/* Token contract */
contract KOBECOIN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x893535ED1b5C6969E62a10bABfED4F5fF8373278; // Binance-Peg  Coin 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x4281D633A61Abc8eff003a99854824fe727e1552;
    ...
    // Name and symbol
    string constant _name = "KOBE COIN";
    string constant _symbol = "$KOBE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 24000 * (10 ** _decimals); // 24K 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; 	 // max % transactions on buy
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; 	 // max % transactions on sell
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // max % wallet in general
