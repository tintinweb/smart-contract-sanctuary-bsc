...
contract DogeShitInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Shit Inu";
    string private _symbol = "DSHIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe7d5be71f34F004e4eFeA851642Ae2c42157000a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe7d5be71f34F004e4eFeA851642Ae2c42157000a); // BuyBack Address
