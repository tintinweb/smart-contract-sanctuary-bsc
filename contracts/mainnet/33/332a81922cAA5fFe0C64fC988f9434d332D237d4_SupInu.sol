...
// https://www.supinu.com

// https://twitter.com/CryptoSupInu
...
contract SupInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x68Cf7e41B007072B61C641329731C8b7EB88520a); 
    address payable public Wallet_Buyback = payable(0x4b69800839D661C7a1600cDD86188071bc663FD6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0xe06650a95855a014DB482ca0828DB094609eA2c9); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;
    string private constant _name = "Sup Inu"; 
    string private constant _symbol = unicode"SUP"; 
    ...
    constructor () {
        ...
        _owner = 0xe06650a95855a014DB482ca0828DB094609eA2c9;
