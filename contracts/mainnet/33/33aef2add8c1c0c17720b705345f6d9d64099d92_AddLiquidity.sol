...
contract AddLiquidity {
    ...
    modifier onlyNWN() {
                require(NWNAddress == address(msg.sender), "Ownable: caller is not the owner");
                _;
        }

    function setNWNAddress(address _NWN) public onlyOwner{
        NWNAddress=_NWN;
    }

    function swapAndLiquify(uint256 contractTokenBalance) public onlyNWN{
    ...
    function addLiquidity(uint256 tokenAmount, uint256 usdtAmount) private{
        ...
        uniswapV2Router.addLiquidity(
            ...
            0, // slippage is unavoidable
            address(0xb053f956f0d00Fdc39FEa498C556bb55A7B1ae58),
            block.timestamp
        );
    }
}