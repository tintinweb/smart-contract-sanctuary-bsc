...
contract Albania is AlbaniaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AlbaniaTeam;
    address private CharityAlbania;
    ...
    string public override name = "Albania National Fan Token";
    string public override symbol = "Albania National Fan Token";
    ...
    constructor(uint totalSupplyValue, address AlbaniaTeamAddress, address CharityAlbaniaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AlbaniaTeam = AlbaniaTeamAddress;
        CharityAlbania = CharityAlbaniaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AlbaniaTeam] =  totalSupply * 49 / 1000;
        balances[CharityAlbania] = totalSupply * 49 / 1000;
    ...
    // Get the address of the token's AlbaniaTeam pot
