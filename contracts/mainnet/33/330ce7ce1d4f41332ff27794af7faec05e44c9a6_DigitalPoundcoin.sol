...
contract DigitalPoundcoin is DigitalPoundTokenDeployer, Context, Ownable {
    ...
    string public override name = "Digital Pound";
    string public override symbol = "Digital Pound";
