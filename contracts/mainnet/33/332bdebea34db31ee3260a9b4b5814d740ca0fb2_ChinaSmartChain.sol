...
/**
    ...
    China Smart Chain is a community-driven token and decentralized coin in Binance Smart Chain
    Destined for a millions market cap
    Team has a lot of plans for this project
    Get in early!
    https://t.me/ChinaSmartChain

    Every process on China Smart Chain will be updated on Github
    https://github.com/CSC-DEVS/
