...
contract DubaiClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DubaiClub";
    string private _symbol = "DCLUB";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address kmtch
    address payable private TeamWallet = payable(0x7b687DF7B591BD05719F0B27D44cd85C0df16489); // Buy Back Address
