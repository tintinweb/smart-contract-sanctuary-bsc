...
contract CBC2
 is Context, IERC20, Ownable {
    ...
    string private _name = "CBC2.0";
    string private _symbol = "CBC2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76C876e01B2F7e15ec6EDdb3167c9281deEE9d82);
    address payable public teamWalletAddress = payable(0x76C876e01B2F7e15ec6EDdb3167c9281deEE9d82);
    address public immutable deadAddress = 0x76C876e01B2F7e15ec6EDdb3167c9281deEE9d82;
