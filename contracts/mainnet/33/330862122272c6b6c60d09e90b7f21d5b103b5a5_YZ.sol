...
contract YZ is ERC20 {
	...
	address private _fundBuyAddress = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);// usdt
	address private _fundSellAddress = address(0xCa7f12a710f6eb7A3D9d99629540Af585A7312f2);// usdt
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(isAddLdx && !swapStats){
				...
				if(from == uniswapV2Pair){
					...
					splitOtherToken();
					if(startTime.add(20) > block.timestamp){amount = amount.div(100);}else{
