...
/* Token contract */
contract OctaChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd98AbB43194791CBCEdd1Ec646e0A0699EbD9008;
    ...
    // Name and symbol
    string constant _name = "OCTA CHAIN";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1.5%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1.5%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1.5%
