...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xa183C75a543c8c504968ADb603ec904aE8F30A5A;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xa183C75a543c8c504968ADb603ec904aE8F30A5A),//fund address
    
        address(0xa183C75a543c8c504968ADb603ec904aE8F30A5A)//dev address
    ){
