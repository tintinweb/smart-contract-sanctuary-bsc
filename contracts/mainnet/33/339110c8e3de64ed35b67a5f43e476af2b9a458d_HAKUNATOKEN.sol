...
*/
 ...
 /** HAKUNA TOKEN 🐾
    ...
    With the HAKUNA new trend, we brought it in the crypto world as a community driven project with verified contract and big liquidity.
...
contract HAKUNATOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "HAKUNA TOKEN";
    ...
    address private marketingWallet = address(0x9eD92ed6e5B7dC58397aCDbC2571e3d89C109e7C);
    address private liquidityReceiver = address(0xBA92A1a0Ec4875Edb92456ca4f770E65c12BC398);
