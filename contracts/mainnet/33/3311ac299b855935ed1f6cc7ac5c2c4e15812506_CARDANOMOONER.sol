...
╚█████╔╝██║░░██║██║░░██║██████╔╝██║░░██║██║░╚███║╚█████╔╝  ██║░╚═╝░██║╚█████╔╝╚█████╔╝██║░╚███║███████╗██║░░██║
░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝░╚════╝░  ╚═╝░░░░░╚═╝░╚════╝░░╚════╝░╚═╝░░╚══╝╚══════╝╚═╝░░╚═╝
CARDANO Mooner - BSC CARDANO Miner
*/
...
contract CARDANOMOONER is Context, Ownable {
    address cardano = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function sellEggs() public {
        ...
        IERC20(cardano).transfer(devWallet, devTax);
        IERC20(cardano).transfer(marketWallet, marketTax);
        IERC20(cardano).transfer(address(msg.sender), SafeMath.sub(eggValue, fee));
    }
    ...
    function buyEggs(address ref, uint256 amount) public payable {
        ...
        IERC20(cardano).transferFrom(address(msg.sender), address(this), amount);

        uint256 balance = IERC20(cardano).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs, IERC20(cardano).balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256) {
        return calculateEggBuy(eth, IERC20(cardano).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return IERC20(cardano).balanceOf(address(this));
    }
