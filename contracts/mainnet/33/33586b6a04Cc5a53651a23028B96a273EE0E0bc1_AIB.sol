...
// 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/AIBportal

// 𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://www.aibot.icu

// 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/AllInclusiveBot
...
contract AIB is ERC20, Ownable {
    ...
    AIBDividendTracker public dividendTracker;
    ...
    constructor() ERC20("All Inclusive Bot", "AIB") {
        UtilityWallet = payable(0x2deeCF222320C10d640B6A40FbA77c23e7bCc5b9);
        DevelopmentWallet = payable(0x94b38D76F354102cF3FA3845ae0167ba0cf2C0aF);
        ...
        dividendTracker = new AIBDividendTracker(
            payable(this),
            router,
...
contract AIBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "AIB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "AIB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AIB contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AIBContract);

            uint256 prevBalance = AIBContract.balanceOf(address(this));
            ...
            {
                uint256 received = AIBContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AIBContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
