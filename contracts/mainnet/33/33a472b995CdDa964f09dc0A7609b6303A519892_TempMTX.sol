...
contract TempMTX is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("Species Coin", "SPCC") AccessControl(){
        ...
        coinAmountPerRewardUnit = 320 * 10 ** 18; // 320 BEP20 coins per rewardUnit, may be changed later on
        numberOfBlocksPerRewardUnit = 28700; // 2 hours per reward unit , may be changed later on
        welcomeBonusAmount = 0; // 200 tokens welcome bonus, only paid once per tokenId
    }
