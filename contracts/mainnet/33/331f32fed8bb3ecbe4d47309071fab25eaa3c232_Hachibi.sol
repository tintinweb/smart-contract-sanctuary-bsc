...
/*
Hachibi, brought to you by its Jinchuriki Killer B, just launched in bsc. 
Join our community
https://t.me/HachibiBSC
8%/8% tax
3% Max wallet
**/
...
contract Hachibi is IBEP20, Auth {
    ...
    string constant _name = "Hachibi";
    string constant _symbol = "HACHIBI";
    ...
    address public marketingFeeReceiver = 0x203D19197583FF74D67fCbf5d62e482339EEfe65;
    ...
    function setTaxNormal() external onlyOwner{
    ...
    function setTxLimit(uint256 amountBuy) external onlyOwner {
         require(_maxTxAmount <= (40 * 10**6 * 10**9), "Max wallet should be less or equal to 4% totalSupply");
