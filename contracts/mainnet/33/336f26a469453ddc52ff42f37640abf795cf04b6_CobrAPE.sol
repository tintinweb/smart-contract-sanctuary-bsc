...
contract CobrAPE is IBEP20, Auth {
    ...
    string constant _name = "CobrAPE BSC";
    string constant _symbol = "$COBRAPEBSC";
    ...
    address private teamFeeReceiver =0xFccD900BDaa8Cb02Fd06Ff73a34530259C471FA9;
