...
library Address{
 ...
 contract BerookeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5825691cA31b9954f11Dc8E9143F579BB0Abbad6;
    address public donationWallet = 0x5825691cA31b9954f11Dc8E9143F579BB0Abbad6;
    string private constant _name = "Berooke Inu";
    string private constant _symbol = "BEROOKE";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 1);
    Taxes public sellTaxes = Taxes(1, 3, 2, 1);
