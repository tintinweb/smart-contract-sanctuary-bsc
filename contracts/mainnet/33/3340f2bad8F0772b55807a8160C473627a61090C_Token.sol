...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _numOfTokensToExchange = 100 * 10**3;
     ...
     function _transfer(
        ...
        if (contractTokenBalance > 0) {
            ...
            if (
                ...
                uint tokensToSwap = contractTokenBalance;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 Portion = contractTokenBalance;
        ...
        TransferETH(payable(_mkt), address(this).balance);
        
        emit TokensSwapped(Portion, BalanceReceived, totalBalanceToSend, _mkt);
    }
