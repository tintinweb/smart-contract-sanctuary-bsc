...
contract allotDAO is  Auth , IallotDAO {
    ...
    function setusers(address[] calldata users_,uint i) public onlyOwner{
        users=users_;
        index=i;
    }
...
contract  SuperSoca is IBEP20 , Auth { 
    using SafeMath for uint256;
    string internal _name;
    string internal _symbol;
    uint8   internal _decimals;
    uint256 internal _totalSupply;
    string public tokenType="SuperSoca";
    ...
    function setPair(address _token) public onlyOwner {
    ...
    constructor(  
        ...
        fA=new allotDAO(ceo);
        marketingAddress = [address(fA),0x7E3988338C38c91999Cb21165cd3992813c32114,0x3B90a75b9Ee3c4c2F338EF10381598390E901670,0x77b4a67E816EeD8d44A7AE196716940f513e4870];
        marketingShare=[10,30,5,5];  
