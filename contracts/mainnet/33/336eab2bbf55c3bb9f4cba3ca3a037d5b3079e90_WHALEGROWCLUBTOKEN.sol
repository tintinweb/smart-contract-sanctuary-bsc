...
contract WHALEGROWCLUBTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whale Grow Club";
    string private _symbol = "WGC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x278f4DF8D34D587ef6EE65D87Ea7FAed733956ba); 
    address payable public buyBackWalletAddress = payable(0x6254F9CcAbD6BffBCD80b92D326cB2be2ca3830a); 
    ...
    uint256 private _totalSupply = 9000000 * 10**9;
    uint256 public _maxTxAmount = 270000 * 10**9;
    uint256 public _walletMax = 270000 * 10**9; 
