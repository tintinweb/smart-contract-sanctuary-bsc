...
contract Piggish is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() BEP20("Piggish", "PIG") {
        marketingWallet = payable(0xCDE9F79623c2baAE53e7f13868F240CC443eeC01);
        devWallet = payable(0xCDE9F79623c2baAE53e7f13868F240CC443eeC01);
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 liquidityBuy,
        ...
        require(marketingBuy <= 5 && marketingSell <= 5, "Marketing fees can't exceed 5%");
