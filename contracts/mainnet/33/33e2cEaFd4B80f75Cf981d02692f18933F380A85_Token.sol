...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 150;//y
    uint256 public _buyLPDividendFee = 150;//f
    uint256 public _sellLPDividendFee = 150;//f
    uint256 public _sellFundFee = 150;//y
    uint256 public _sellLPFee = 0;//h
    ...
    constructor (
        ...
        holderRewardCondition = 5 * 10 ** IERC20(FISTAddress).decimals();//hysl
...
contract Token is AbsToken {
    ...
    //
        3650,
    //
        address(0xF7670A9Af1E7b3305112E458FF134b392a172bdF),
    //
        address(0xA0a59705A93f9f33A8a4C78896Ef67a05699a6Bf)
    ){
