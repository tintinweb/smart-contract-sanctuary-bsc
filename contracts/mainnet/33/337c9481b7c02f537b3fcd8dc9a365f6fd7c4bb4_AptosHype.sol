...
contract AptosHype is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aptos Hype";
    string private constant _symbol = unicode"AH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xafE4f950e13578010188470aB69Dc7f5EB5B8D9a); // Marketing Address
    address payable public teamWalletAddress = payable(0xCd8fD0A9eB367837993E7F022d765152ff90d768); // Team Address
