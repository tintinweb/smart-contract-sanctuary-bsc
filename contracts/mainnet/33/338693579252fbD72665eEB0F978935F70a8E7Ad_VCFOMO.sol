...
contract VCFOMO is Ownable {
    ...
    uint256 constant internal tokenPriceIncremental_ = 0.004 ether;
    uint256 constant internal incTokensPerTicket = 0.1 ether;

    uint256 public maxlatestholders = 6;
    uint256 public hoursForRound = 72;
...
/// Calculate owner of ticket
    ...
    function buyTicket(uint256 _amount) external payable returns(uint256){
      ...
      rounds[roundCount].claimList[msg.sender] += ticketPrice.div(10);
