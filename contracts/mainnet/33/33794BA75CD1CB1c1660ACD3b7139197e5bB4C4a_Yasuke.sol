...
Twitter: https://twitter.com/Yasuke_bsc
...
contract Yasuke is Context, IBEP20, Ownable {
    ...
    function setLiquidityPercentages(uint256 teamFee, uint256 _marketingFee) external onlyOwner {
        _percentageOfLiquidityForTeam        = teamFee;
        _percentageOfLiquidityForMarketing  = _marketingFee;
    }
