...
//Telegram : https://t.me/ShibaSantaOfc
//Website : https://shinta.website/
//Twitter : https://twitter.com/ShibaSantaOfc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4635915C6047c490dD901fB7e9F2cC7934437ce;
...
contract SHINTA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Shiba Santa ";
    string private _symbol = " SHINTA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77D50C4B9Ff3576Dafeeada3Df6f41f86C967689);
    address payable public teamWalletAddress = payable(0xD4635915C6047c490dD901fB7e9F2cC7934437ce);
    ...
    uint256 private minimumTokensBeforeSwap = 7500000 * 10**_decimals; 
