...
contract RatMoonBSC is Context, IBEP20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4035538D9a56C841526ed4fbfB24c6987ba431dc); 
    address payable private Wallet_Dev = payable(0x4035538D9a56C841526ed4fbfB24c6987ba431dc);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Rat Moon BSC"; 
    ...
    constructor () {
        _owner = 0x4035538D9a56C841526ed4fbfB24c6987ba431dc;
