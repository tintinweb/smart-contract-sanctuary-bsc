...
abstract contract ABSToken is IERC20, Ownable {
    ...
    uint256 public _LPDividendsFee = 1;
    uint256 public _fundAddressFee = 2;
    uint256 public _invitorFee = 200;
    uint256 public _invitor0Fee = 100;
    uint256 public _invitor1Fee = 50;
    ...
    function _tokenTransfer(
        ...
        if (fee > 0) {
            ...
            uint256 perInviteAmount = feeAmount * _invitorFee / fee / 100;
            for (uint256 i; i < 3; ++i) {
                ...
                if (0 == i) {
                    inviterAmount = perInviteAmount  /_invitorFee * _invitor0Fee;
                } else {
                    inviterAmount = perInviteAmount /_invitorFee * _invitor1Fee;
                }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 USDTFee = (_fundAddressFee + _LPDividendsFee);
        USDT.transferFrom(address(_tokenDistributor), fundAddress, usdtBalance * _fundAddressFee / USDTFee);
        USDT.transferFrom(address(_tokenDistributor), address(this), usdtBalance * _LPDividendsFee / USDTFee);
    }
...
contract YuanXiaoYe is ABSToken {
    constructor() ABSToken(
        ...
        address(0xf5d2B2c10ea59D80287A302256AB30E871e57B99)
    ){
