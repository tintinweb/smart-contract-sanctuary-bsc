...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73e466981b91f52E93F69e4B5457AA0493C0d40d; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Spooky Qatar";
    string private _symbol = "spookyqatar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73e466981b91f52E93F69e4B5457AA0493C0d40d); // Marketing Address
    address payable public teamWalletAddress = payable(0x73e466981b91f52E93F69e4B5457AA0493C0d40d); // Team Address
