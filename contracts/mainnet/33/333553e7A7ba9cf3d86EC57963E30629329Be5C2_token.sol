...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "LonelyShib";
    string private _symbol = "LonelyShib";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x35C523239FF852D7ca8cF14e93DdB87385B669Cd); // Marketing Address
