...
/*
    ...
    Telegram: https://t.me/KingDogeArabian
...
contract DogeKingArabian is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeKingArabian";
    string private _symbol = "DKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40105f50ecd8edeaE1ECAFAc2D7b9e0D16899733); 
    address payable public DevOutsourceWallet = payable(0x8D6EDeC33BaA6Ce7710aaa36a46C8b95fEdbCDBb); 
