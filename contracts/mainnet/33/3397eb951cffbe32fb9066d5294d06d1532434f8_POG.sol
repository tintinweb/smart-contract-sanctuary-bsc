...
contract POG is Context, ITRC20, Ownable {
    ...
    string private _name = 'Proof of Game';
    string private _symbol = 'POG';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 18000000 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 1800000 * 10**uint256(_decimals);
