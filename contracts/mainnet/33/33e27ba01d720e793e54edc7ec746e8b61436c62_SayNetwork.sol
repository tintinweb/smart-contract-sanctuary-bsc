...
contract SayNetwork {
    ...
    string private _name = "Saynetwork";
    string private _symbol = "SAYNETWORK";
    ...
    uint256 private salePrice = 5500; // 1 BNB
    ...
    constructor() public {
        _devAddress = 0x831b7ef67F37903F876b80881E5125f57492B0B8; // LA
        _presaleAddress = 0x0f266E3F2a5A4b38c5251ffC80B5c992bfa2DDE4; // TO
        address _BurnAddress = 0x4bfF953B4A7eE25839Facb59E22777f236721678; // MA
        _owner = msg.sender;
        ...
        _mint(_devAddress, 69500000*10**18);

    
        _mint(_BurnAddress,500000*10**18);
    }
