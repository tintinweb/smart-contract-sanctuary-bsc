...
contract TeslaGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tesla Gold";
    string private _symbol = "TSG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdf56C7e821923D0fb5841cCebf5de0ae38998B86);
    address payable public BuyBackWalletAddress = payable(0xdf56C7e821923D0fb5841cCebf5de0ae38998B86);
