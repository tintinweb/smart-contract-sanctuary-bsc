...
/**
   ...
   WE ALL WANT TO SEE OUR SOCCER TEAM TO BE TOP 1 IN QATAR !

       LET'S MAKE THIS ONE TREND ON BSC FOR THEM ALL ! 

 3% Taxes fully spent on marketing

 Socials🌐

  TG : http://t.me/QatarLaeeb
  Website http://QatarLaeeb.finance
...
contract QatarLaeeb is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "QatarLaeeb";
    string constant _symbol = "QLB";
    ...
    address public Owner=0x9e01bE8e4416419ae433cebe258f718cB327B3e0; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x9e01bE8e4416419ae433cebe258f718cB327B3e0;
