...
contract watersquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Water Squid";
    string private _symbol = "WTRSquid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD3117aa92800601b4d759CBbDCeF091a10D67728); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD3117aa92800601b4d759CBbDCeF091a10D67728); // buyback Address
