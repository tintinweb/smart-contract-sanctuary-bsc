...
/* Token contract */
contract FortunaBet is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x5b7d8080CBeeB9232C94ed5CdFbD70a0f7B3F697; // dev wallet
    ...
    // Name and symbol
    string constant _name = "Fortuna Bet";
    string constant _symbol = "Fortuna Bet";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc7C4e65cd7E8BC500D0603f7049b08403D5253Bd; //marketing wallet
