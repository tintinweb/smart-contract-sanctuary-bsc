...
// https://t.me/Stopbegginginmycoins
...
contract SBIMC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STOP BEGGING IN MY COINS";
    string private _symbol = "SBIMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6679Ec8d205eEDFA252097e18c516aBe782f568d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6679Ec8d205eEDFA252097e18c516aBe782f568d); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (30 * 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
