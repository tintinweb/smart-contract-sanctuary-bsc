...
// TG : https://t.me/kingpintoken

// BE KingPin, made decisions of marketing...
...
contract KINGPIN is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "KingPin";
   string constant _symbol = "KINGPIN";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 600; // 4% marketing 2% Kingpin
    ...
    uint256 marketingFeeSell = 600; // 4% marketing 2% Kingpin
