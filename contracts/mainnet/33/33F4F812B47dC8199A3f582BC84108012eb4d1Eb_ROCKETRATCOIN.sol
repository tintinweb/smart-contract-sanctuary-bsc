...
contract ROCKETRATCOIN is IBEP20, Auth {
    ...
    string constant _name = "ROCKET RAT COIN";
    string constant _symbol = "RocketRat";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  //2% MAX tx
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver = 0x72c5f006420E8aa71AB83E82b6C6477D78dE85de;
    address private teamFeeReceiver = 0x72c5f006420E8aa71AB83E82b6C6477D78dE85de;
