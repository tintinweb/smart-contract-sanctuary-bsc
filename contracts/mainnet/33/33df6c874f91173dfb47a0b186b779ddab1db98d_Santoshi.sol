...
library Address{
 ...
 contract Santoshi is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x44A4256A7C65513Dc872cBA2737ae4873526eae2;
    address public donationWallet = 0xC1Af80b86D592466CD54F20A463597750C39faAf;

    string private constant _name = "Santoshi";
    string private constant _symbol = "SANTO";
    ...
    Taxes public taxes = Taxes(0, 1, 5, 5);
