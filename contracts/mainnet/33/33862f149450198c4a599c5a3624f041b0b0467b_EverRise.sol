...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x603BD9B37b015804383Bcce5812560757801F193); // Marketing Address
    ...
    string private _name = "xiaohaimian";
    string private _symbol = "xiaohaimian";
