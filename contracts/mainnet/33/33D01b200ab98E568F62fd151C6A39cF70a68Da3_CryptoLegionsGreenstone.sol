...
contract CryptoLegionsGreenstone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Legions Greenstone";
    string private _symbol = "GRST";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xd416F29D2969d816Bf49600787B07FC46767390e); 
