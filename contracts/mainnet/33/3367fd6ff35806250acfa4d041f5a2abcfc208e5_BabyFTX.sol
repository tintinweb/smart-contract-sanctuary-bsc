...
contract BabyFTX is Context, IERC20, Ownable {
    ...
    string private _name = "Baby FTX";
    string private _symbol = "BFTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8DE97315dA396307301970e6b9aD43dDb418Ea7c); 
    address payable public DevWalletAddress = payable(0xACf38817ae6a5C146f48b9d94ff93884974269c0); 
