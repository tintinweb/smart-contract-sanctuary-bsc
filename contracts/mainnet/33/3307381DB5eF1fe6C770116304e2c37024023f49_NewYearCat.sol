...
contract NewYearCat is IERC20 {
    ...
    string constant private _name = "New Year Cat";
    string constant private _symbol = "NYCAT";
    ...
    uint256 constant public maxRoundtripTax = 600;
    ...
    address payable public marketingWallet = payable(0xa909865f0C0DBD36A32029F1E55f0BaF05BAB8F5);
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 buyback) external onlyOwner {
    ...
    function triggerBuyback(uint256 amount, uint256 multiplier) external onlyOwner {
        uint256 bnbAmount = amount * 10**multiplier;
