...
//Project: Crypto kill (kill)
//Web: https://cryptokill.io/
...
contract kill is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xA70f11df9589648362b4fea647e0D4C6F587F600);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 4000 * 10**18;
    ...
    constructor () BEP20Detailed("Crypto kill", "kill", 18) {
      _owner = msg.sender ;
