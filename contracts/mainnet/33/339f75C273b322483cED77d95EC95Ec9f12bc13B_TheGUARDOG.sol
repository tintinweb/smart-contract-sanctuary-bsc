...
//PROJECT BY GUARD DOG

//https://t.me/GuardDogofficial
//GUARD DOG will present you guys with a lot of marketing with an experienced team in the bsc ! 
//The team has had many projects that have mooned in the millions of market cap !                      
...
contract TheGUARDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7ef8D3643f70A2Fb5f6C0134b014D385c9D52B9a); 
    address payable public Wallet_Dev = payable(0x7ef8D3643f70A2Fb5f6C0134b014D385c9D52B9a);
    ...
    string private constant _name = "GUARD DOG"; 
    string private constant _symbol = unicode"GUARDDOG"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 100000000000 * 10**9;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 1000000000000 * 10**9;
    ...
    constructor () {
        ...
        _owner = 0xDb3A4f3B282FA12D5B839BC8a53Cd004Dc3535E3;
