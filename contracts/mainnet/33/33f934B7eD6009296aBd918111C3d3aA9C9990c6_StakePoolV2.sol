    ...
    Ownable
{
    ...
    constructor(
        ...
        levelRewardRatio[TYPELEVEL.LEVEL1] = 4; //8%
        levelRewardRatio[TYPELEVEL.LEVEL2] = 6; //10%
        levelRewardRatio[TYPELEVEL.LEVEL3] = 8; //12%
        levelRewardRatio[TYPELEVEL.LEVEL4] = 10; //15%
