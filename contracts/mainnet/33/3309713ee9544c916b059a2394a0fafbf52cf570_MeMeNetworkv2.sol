...
/*
Name: MeMe Network v2
Symbol: MNETv2
Supply: 1.000.000 MNETv2

Telegram: https://t.me/MemeNetwork_Bsc
Website: https://www.memenetwork.fun/
*/
...
contract MeMeNetworkv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MeMe Network v2";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "MNETv2";
