 ...
 ** BNBMillionaires **
 ...
 Future will be bright for everyone in the club - you hold, you earn - you sell, you will miss the next big opportunity

 Whales will be much appreciated - Whales will be in the end who run the show and make everyone become BNBMillionaires

 We aim to be the next big thing - utility is us

 BNB Rewards are in place to share the revenue to all holders

 This project launched with max wallet 1%, max tx 0,1%. 

 Taxes: LP2% - Rewards 2% - Development, Buyback and marketing 4% = Total tax 8%

 TG: https://t.me/bnbmillion
...
contract BNBMillionaires is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BNBMillionaires";
    string constant _symbol = "BNBM";
