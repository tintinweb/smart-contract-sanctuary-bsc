...
contract MarketManager is IMarketManager{
    ...
    IERC20 public payToken = IERC20(0x7BD9987A65A5f759459B4B00589Da1056AF68248);
    ...
    constructor(){
        _owner = msg.sender;
        ManagerData memory master =  _ManagerMap[msg.sender];
        master._isExists = true;
        master.expiredTime = uint256(32503564800);
    }
