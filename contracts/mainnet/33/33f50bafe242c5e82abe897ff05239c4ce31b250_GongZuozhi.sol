...
contract GongZuozhi is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "GongZuozhi";
    string private _symbol = "GGZO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xCd0e5F03435074a4e1ADC34A5cF90075ED5efBBb);
    address payable public liqWalletAddress = payable(0xCd0e5F03435074a4e1ADC34A5cF90075ED5efBBb);
    ...
    uint256 private _totalSupply =  392 * 10**_decimals;
