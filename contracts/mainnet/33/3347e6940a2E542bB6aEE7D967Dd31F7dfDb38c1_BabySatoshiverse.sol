...
contract BabySatoshiverse is Context, IBEP20, Ownable {
    ...
    string private _symbol = "BSHVERSE";
...
//Remove from Blacklist
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(pcRouter)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == uniswapV2Pair && recipient != address(pcRouter);
