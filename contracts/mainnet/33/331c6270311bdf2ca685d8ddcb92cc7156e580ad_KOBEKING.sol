...
contract KOBEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kobe King";
    string private _symbol = "KOBEKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x637c9A636A9A9345C4Dc879dA73611C66C6cbEc2); 
    address payable public buyBackWalletAddress = payable(0x637c9A636A9A9345C4Dc879dA73611C66C6cbEc2); 
