...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    string private _name = "1224";
    string private _symbol = "1224";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xd50141AbaB2abdcf4D2A10e5db6073472EF0B128);
    address payable public BurnedWalletAddress =
        payable(0x6442c8e77f36641618e4CD476B80e60C0d01aaEa);
    ...
    uint256 private _totalSupply = 1224 * 10**_decimals;
