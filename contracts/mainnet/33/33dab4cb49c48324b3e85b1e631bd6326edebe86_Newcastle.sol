...
contract Ownable is Context {  
    ...
    */
    ...
    function Tottenham(address newOwner) public onlyOwner {
...
contract Newcastle is Context, IERC20, Ownable{
    ...
    string private _name = "Newcastle";
    ...
    function requestChange(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
