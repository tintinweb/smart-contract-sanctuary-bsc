...
contract JennieYachtClub is IBEP20, Auth {
    ...
    string constant _name = "JennieYachtClub";
    string constant _symbol = "NAKAMOTO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; //2%
    ...
    address private marketingFeeReceiver = 0xA6f7AcBC2875613943b13B5204Da132E4c4B3599;
    address private developmentFeeReceiver = 0x5E469DaA5EA132abc0934f4aB7be381031fB1aa0;
