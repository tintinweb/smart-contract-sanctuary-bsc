...
/**
    ...
    Telegram: https://t.me/inupay
    Website: http://inupay.xyz
...
contract InuPay is Context, IERC20, Ownable {
    ...
    string private constant _name = "Inu Pay"; // 
    string private constant _symbol = "InuPay"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee =4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x7fB87350691a29A6577aB4b1E22858b156489F33;
    ...
    function includeInFee(address account) public onlyOwner {
        ...
        function Banned_Bot(address account, bool value) external onlyOwner{
        Bot_FUCKER[account] = value;
