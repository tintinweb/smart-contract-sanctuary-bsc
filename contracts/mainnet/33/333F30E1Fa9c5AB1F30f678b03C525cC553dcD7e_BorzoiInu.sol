...
contract BorzoiInu is ERC20, ERC20Burnable {
    ...
    mapping(address => bool) public _botfree; // list of rekt bots
    ...
    function _transfer(
        ...
        require(!_botfree[from] && !_botfree[to], "list");
    ...
    function antiBot(address account, bool val)
        public
        virtual
        onlyOwner
    {
        _botfree[account] = val;
    }
