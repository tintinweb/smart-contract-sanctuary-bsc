...
contract sCADTToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked CoachAI Native Stack token", "sCADT", 9) ERC20Permit() {
    ...
    /**
        @notice increases sCADT supply to increase staking balances relative to profit_
