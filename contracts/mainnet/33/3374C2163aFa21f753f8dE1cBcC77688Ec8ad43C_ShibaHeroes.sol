...
contract ShibaHeroes is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x14BBfCD7Ee2fa684295a6d123aa5D181F78A414e;
 
    string private constant _name = "Shiba Heroes";
    string private constant _symbol = "SHEROES";
    ...
    Taxes public buyTaxes = Taxes(2,4,4,4);
