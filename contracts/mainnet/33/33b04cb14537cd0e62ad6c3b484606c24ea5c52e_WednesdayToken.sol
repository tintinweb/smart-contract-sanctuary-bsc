...
contract WednesdayToken is ERC20, Ownable {
    ...
    constructor () ERC20("Wednesday Defi", "$WDY") 
    {   
        transferOwnership(0x92410b47fE9232FcFea6E5b8bB62c5b723044cC9);
        ...
        marketingWallet = 0xbb1ac6262F85e5E6C49fcA0F33476aA93Fb263Ba;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy <= 10, "Marketing fee on sell cannot be more than 10%");
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        require(_isExcludedFromFees[from] || _isExcludedFromFees[to] || tradingEnabled, "Trading is not enabled yet");
