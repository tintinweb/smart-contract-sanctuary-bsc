...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc1157eD3bf33627793BD154726f75f7d0CDD99Ab;
...
contract MetaXrp is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta Xrp"; // 
    string private constant _symbol = "MXRP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xc1157eD3bf33627793BD154726f75f7d0CDD99Ab);
