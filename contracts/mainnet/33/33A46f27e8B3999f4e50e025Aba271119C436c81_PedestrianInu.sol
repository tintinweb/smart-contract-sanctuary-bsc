...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0613950C101E791Af734332FbA6C7e9769900a0;
...
contract  PedestrianInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x447a76f74b182d76bB892e7cd70f01a8f1e40Bd9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pedestrian Inu";
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x3f4D6bf08CB7A003488Ef082102C2e6418a4551e)] = true;
