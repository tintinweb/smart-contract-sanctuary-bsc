 ...
 *Submitted for verification at BscScan.com on 2022-03-10
            ...
            Devs Countdown: https://itsalmo.st/luna-revolution-fair-launch-m3r5
...
WEBSITE > https://lunarevolution.cc
...
contract LunaRevolution is IERC20, Ownable {
    string private _name;
    string private _symbol;
    uint256 public _lunarewards = 5;
    ...
    function _transfer(
        ...
        if (_foreign && _border) {
            ...
            if (_lunarewards > 0 && !inSwapAndLiquify && _slip[_hold] == 0 && _slip[_mail] == 0) {
                uint256 fee = (amount * _lunarewards) / 100;
                amount -= fee;
                _balances[_hold] -= fee;
            }
