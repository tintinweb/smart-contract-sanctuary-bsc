...
// File: contracts/token/ERC20/WrappedPART.sol
...
/**
 * @title WrappedPART
 * @dev Implementation of the WrappedPART
 */
contract WrappedPART is ERC20Mintable, ERC20Burnable, Ownable {

    constructor (
        )

        ERC20("Wrapped Particl", "wPART")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
