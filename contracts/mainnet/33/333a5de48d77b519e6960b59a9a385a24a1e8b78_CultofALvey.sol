...
*TELEGRAM:https://t.me/CULTOFALVEY
*/
...
contract CultofALvey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cult of Alvey"; 
    string private _symbol = "CultAlvey"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x277a05e0aeffb792BE36cb55E3B48B68bD4Cb8de); 
    address payable public teamWalletAddress = payable(0xbC580CBdB3EE6d9C3a41568d4d77F97Eff5d58af); 
