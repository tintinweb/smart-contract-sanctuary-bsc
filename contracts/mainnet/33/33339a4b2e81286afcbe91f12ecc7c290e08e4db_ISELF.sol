...
contract ISELF is Ownable {
    ...
    /**
     * @notice calculate iSELF credit per user.
    ...
    function getUserCredit(address _user) external view returns (uint256) {
        ...
        ISELFPool.UserInfo memory userInfo = SELFPool.userInfo(_user);
    ...
    /**
     * @notice update ceiling thereshold duration for iSELF calculation.
