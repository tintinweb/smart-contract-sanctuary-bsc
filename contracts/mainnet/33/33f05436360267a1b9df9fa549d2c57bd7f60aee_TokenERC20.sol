...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        ...
        emit OwnershipTransferred(_ownerAddress, newOwner);
    ...
    function unlock() public virtual {
        ...
        emit OwnershipTransferred(_ownerAddress, _previousOwner);
        _ownerAddress = _previousOwner;
    }
}
...
contract TokenERC20 is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        isWalletLimitExempt[ownerAddress] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;

        isTxLimitExempt[ownerAddress] = true;
