...
contract VENOMINU is IBEP20, Auth {
    ...
    string constant _name = "Venom Inu";
    string constant _symbol = "Venom";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 200; //2% 
    ...
    address private marketingFeeReceiver = 0x9a51cd94d4C49d09056DfE52916B35780016C079;
    address private developmentFeeReceiver = 0x9a51cd94d4C49d09056DfE52916B35780016C079;
