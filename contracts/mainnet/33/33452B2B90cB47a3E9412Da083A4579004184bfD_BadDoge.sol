...
Max Tx     - 0.5% (50M tokens on launch)
Max Wallet - 0.5% (50M tokens on launch)

Max Tx     - 1% (100M tokens after launch)
Max Wallet - 1% (100M tokens after launch)
...
ANTIBOT
BLACKLIST
 Telegram - https://t.me/baddogecoin
...
/* Token contract */
contract BadDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8fE6Aa2aC199d4acbC7BC882dbA956bca0bEdFA0;
    ...
    // Name and symbol
    string constant _name = "Bad Doge";
    string constant _symbol = "BDDG";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // .5% or 50M tokens on launch
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // .5% or 50M tokens on launch
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // .5% or 50M tokens on launch
