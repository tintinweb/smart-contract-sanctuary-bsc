...
TELEGRAM : https://t.me/australiaBSC
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbfCD1B139cAD75cd6888BAf16F00DBB53Bb3c511; // owner address
...
contract AUSTRALIA is Context, IERC20, Ownable {
    ...
    string private _symbol = " FFA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1342Beb32634b2C8c67930893A609d0fD7723bA3); // Marketing Address
    address payable public teamWalletAddress = payable(0xbfCD1B139cAD75cd6888BAf16F00DBB53Bb3c511); // Team Address
