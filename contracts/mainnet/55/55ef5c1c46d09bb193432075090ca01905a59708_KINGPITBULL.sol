...
/**
Welcome to King Pitbull

Telegram : https://t.me/KingPitbullChat
Website  : https://kingpitbull.net
*/
...
contract KINGPITBULL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Pitbull";
    string private _symbol ="KING P";
