...
contract BoringApe is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1A6a45De5C76a6A06453444B1F1a94183087A73a); // Marketing Address
    address payable public teamWalletAddress = payable(0x1A6a45De5C76a6A06453444B1F1a94183087A73a); // Team Address
    ...
    uint256 public _maxTxAmount = (_totalSupply * 2) / 20; 
