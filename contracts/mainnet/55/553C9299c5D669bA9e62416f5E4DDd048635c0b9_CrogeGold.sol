...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1CA3F130C752206Ca3d0379b7A29E112EB9Bd89b; // owner address
...
contract CrogeGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Croge Gold";
    string private _symbol = "CG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x795a0b2Cb104f7a7088cFB4Ce0e2322Dcfc2dd5C); // Marketing Address
    address payable public teamWalletAddress = payable(0x795a0b2Cb104f7a7088cFB4Ce0e2322Dcfc2dd5C); // Team Address
