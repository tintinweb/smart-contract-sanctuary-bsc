...
TELEGRAM : https://t.me/CryptoTelegramPortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a7842cd27921A28182EF94D314008Fc961B3e1e; // owner address
...
contract CryptoTelegram is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Crypto Telegram ";
    string private _symbol = " CT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a7842cd27921A28182EF94D314008Fc961B3e1e); // Marketing Address
    address payable public teamWalletAddress = payable(0x7a7842cd27921A28182EF94D314008Fc961B3e1e); // Team Address
