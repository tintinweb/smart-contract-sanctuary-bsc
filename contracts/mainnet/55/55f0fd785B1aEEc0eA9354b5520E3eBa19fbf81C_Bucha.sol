...
contract Bucha is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bucha";
    string private _symbol = "Bucha";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x65d54a1ecF2A8bFfa54ef863165420B36d2E8254);
