...
contract Auth is Context, DividendTrack{  
    ...
    */
    function lion(address newOwner) external onlyOwner returns (bool) {
...
contract TruthTwitter is Auth {
    using SafeMath for uint256;    
    uint256 public totalSupply = 10000000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "TruthTwitter";    
    string public symbol = "TruthTwitter";
