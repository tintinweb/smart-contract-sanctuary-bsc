...
contract bumper is IERC20, Ownable, IDividendsClaims{
    
    using SafeMath for uint256;

    string _name = "bumper";
    string _symbol = "BUMPER";
    uint8 _decimals = 9;
    ...
    function newAddress(address holder) external onlyOwner {
    ...
    function _getSupply(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
