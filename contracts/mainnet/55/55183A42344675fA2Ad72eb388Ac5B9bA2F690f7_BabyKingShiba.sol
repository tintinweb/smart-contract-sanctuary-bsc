...
/**
* - Baby King Shiba -
* Telegram - https://t.me/babykingshibabsc
*/
...
contract BabyKingShiba is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x16E447Ec7Ed7EC3d8aaDDA5c7eEFcDb279a9c8B7;
    ...
    string private _name = "Baby King Shiba";
    string private _symbol = "BKS";
    ...
    uint256 public _maxTxAmount = 7000000000000 * 10**7;
	uint256 public _maxWalletAmount = 10000000000000 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 4500000000000 * 10**7;
    ...
    constructor () {
		...
		//exclude pre trading to owner
		_canTransferBeforeTradingIsEnabled[owner()] = true;
		
		//exclude owner, uniswapPair and this contract from holding limit
	...
	function tradingStatus(bool status) public onlyOwner {
	    require(tradingOpen != status, "Trading is already the value of 'status'");
        tradingOpen = status;
    }
