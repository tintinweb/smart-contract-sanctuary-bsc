...
/**
TELEGRAM:  https://t.me/bsc05burngpt
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B6A9b9c491235e7B1AD5847369Cf2EfA46aFA40; //
...
contract ZeroFiveGPT is Context, IERC20, Ownable {   //
    ...
    string private constant _name = "0.5 Burn GPT"; // 
    string private constant _symbol = "05 GPT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x7B6A9b9c491235e7B1AD5847369Cf2EfA46aFA40); //
