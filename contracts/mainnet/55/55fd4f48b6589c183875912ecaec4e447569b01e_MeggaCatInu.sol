...
/**
https://t.me/meggacatinu 🇺🇸
🇨🇳 https://t.me/meggacatinucn
*/
...
contract MeggaCatInu is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MeggaCatInu"; // 
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (2); // 3%
    uint256 public _maxWalletToken = _totalSupply / (100) * (3); // 2%

    // Fees receivers
    address private autoLiquidityReceiver = 0xe7594A55fa7B3639D629FB266cFe11e7eEd1905E; //LP receiver
    address private marketingFeeReceiver = 0xB42C9e47eC7eBcB81C8A532d870d5312AE334503; //mkt
    address private devFeeReceiver = 0xB42C9e47eC7eBcB81C8A532d870d5312AE334503; //31 BuyBack
    address private teamFeeReceiver = 0xB42C9e47eC7eBcB81C8A532d870d5312AE334503; //32 
