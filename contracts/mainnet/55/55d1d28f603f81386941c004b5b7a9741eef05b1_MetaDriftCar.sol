...
contract MetaDriftCar is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Staking = 0x9C695562b025Be6495F77578013e1706F805Eb1F;

    string constant _name = "Meta Drift Car";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x448040C60FfD2314F328B9f203c34bb2462b1b64;
        marketingFeeReceiver = 0xBD182b26A9BEBaE148Fcc16C1843e7dB70eDF0E6;
        rewardPoolFeeReceiver = 0xe2051D5379AAC87A274148F4d20783c5ad0Ba204;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 amountMDCRewardPool = amountBNB.mul(rewardPool).div(totalBNBFee);

            (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
            ( success, /* bytes memory data */) = payable(rewardPoolFeeReceiver).call{value: amountMDCRewardPool, gas: 30000}("");
