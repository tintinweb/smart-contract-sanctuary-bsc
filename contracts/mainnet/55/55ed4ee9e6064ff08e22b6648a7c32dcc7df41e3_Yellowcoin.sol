...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x91843DE629C0Ca350218Bd74322E3e5010c69c32;
...
contract Yellowcoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x92cdf11b4a38d900766703623dF33a818c7d4480;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Yellow Coin";
    string private _symbol = "YCOIN";
