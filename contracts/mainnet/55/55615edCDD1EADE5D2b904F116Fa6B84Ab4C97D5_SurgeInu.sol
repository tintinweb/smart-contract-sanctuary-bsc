...
contract SurgeInu is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeInu";
    ...
    //Tax wallets
    address public teamWallet = 0x4253C2bB97CeC435c555feA1df71ea54cEf7de2E;
    address public treasuryWallet = 0x4253C2bB97CeC435c555feA1df71ea54cEf7de2E;
