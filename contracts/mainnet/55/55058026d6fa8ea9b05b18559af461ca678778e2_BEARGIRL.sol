...
/*
    #SteamX - https://BEARGIRL.com/
    Total Fees: 14%
    2% fee is added to the BEAR GIRL Inu developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the BEAR GIRL Inu marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract BEARGIRL is Context, IERC20, Ownable {
    ...
    string private _name = "BEAR GIRL Inu";
    string private _symbol = "BGI";
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x3d485Db2641509c3875DBA506Bc259A4806cA8F0;
        _developerAddress = 0xa2e550e007cc8FA906558B37c2aDF81B84B6dc67;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "BEAR GIRL Inu: cannot burn from zero address");
    require(_balances[account] >= amount, "BEAR GIRL Inu: Cannot burn more than the account owns");
