...
contract DRIVE2EARN is Context, IERC20, Ownable {
    ...
    string private constant _name = "DRIVE2EARN";
    string private constant _symbol = "D2E";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xf5c3E4f8CCe28583D37BEAEe96DB6953eeBCdBcf);
    address payable private _marketingAddress = payable(0xd2aA7e3587941bE5fdbD889B2f35ba8E14841682);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 11, "Redis cannot be more than 6.");
	    require(redisFeeOnSell < 11, "Redis cannot be more than 6.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 10.");
	    require(taxFeeOnSell < 7, "Tax cannot be more than 10.");
