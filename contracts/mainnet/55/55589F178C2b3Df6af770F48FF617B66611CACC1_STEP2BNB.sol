...
contract STEP2BNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STEP2BNB";
    string private _symbol = "STEP2BNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1aAdA81Ff0aDCda66A34e0cc619c40F8D18d6af4);
    address payable public teamWalletAddress = payable(0x1073f9Ee03bE2687267043a08c01039D616cD310); 
