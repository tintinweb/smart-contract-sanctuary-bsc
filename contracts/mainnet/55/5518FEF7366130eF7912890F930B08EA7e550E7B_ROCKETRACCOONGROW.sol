...
TG: https://t.me/rocketraccoongrow
...
/* Token contract */
contract ROCKETRACCOONGROW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb559FAe7938E82D28B41E5046e287a7958fd5ec1;
    ...
    // Name and symbol
    string constant _name = "ROCKET RACCOON GROW";
    string constant _symbol = "RONGROW";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 800 / 10000; // 3% (300 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 800 / 10000; // 3% (300 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 800 ) / 10000; // 3% (300 mil)
