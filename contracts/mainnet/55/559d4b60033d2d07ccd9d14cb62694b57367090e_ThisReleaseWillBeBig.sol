...
contract ThisReleaseWillBeBig  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x38FC7fAb966827EABcF68E6E6997d2d419801456); 
    address payable public Wallet_Dev = payable(0x6E132cBcEe2BAe65c3D4e4802c68426d5F32F19e);
    ...
    string private constant _name = "This release will be big"; 
    string private constant _symbol = unicode"TRWBB"; 
    ...
    constructor () {
        ...
        _owner = 0x6E132cBcEe2BAe65c3D4e4802c68426d5F32F19e;
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            require(keyBot==true, "keyBot Must Be True");
            }
