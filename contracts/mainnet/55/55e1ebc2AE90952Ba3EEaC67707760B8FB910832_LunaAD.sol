...
contract LunaAD is Ownable {
	
    string public name = "Luna Air Drop";
    string  public symbol = "LunaAD";
    uint8   public decimals = 9;
	uint256 private totalSupply_ = 6151072613161 * (10 ** decimals);
	
	address public pairs;
	IDEXRouter public router;
	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address hAddr = 0x672e5B9a80Adb0A8eFa0A362ACa6b7d4da896004;
