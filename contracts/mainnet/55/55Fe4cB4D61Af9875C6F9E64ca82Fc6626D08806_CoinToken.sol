...
contract CoinToken is Context, IERC20, Ownable, Pausable {
    ...
    constructor(string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS,
        uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _MAXAMOUNT,
        uint256 SELLMAXAMOUNT, address routerAddress, address tokenOwner) public {
    ...
    function setMaxTxAmount(uint256 _MAXAMOUNT) public onlyOwner {
        _maxTxAmount = _MAXAMOUNT * 10 ** _decimals;
    }

    function setSellMaxAmount(uint256 SELLMAXAMOUNT) public onlyOwner {
        numTokensSellToAddToLiquidity = SELLMAXAMOUNT * 10 ** _decimals;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private whenNotPaused notBlacklisted {
