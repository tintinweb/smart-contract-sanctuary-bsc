...
contract  ALG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALG" ;
    ...
    address payable public teamWalletAddress = payable(0x9127AdE737FbAf72bda3e9fd02036D4484A9cC39);
