   ...
   \\         //   /  \\   \//   /\\    \  |______          /
    \\       //___/    \\___\___/  \\____\_______/         /
     \\___________________________________________________/ 
            ...
            AxeFi a Secure and Dynamic Defi Ecosystem.
                Efficient | Empowering | Equal
                      Lets Join Us !!!


website     : https://AxeFi.tech
telegram    : https://t.me/AxeFi_OfficialChannel
...
contract AxeFiV2 is Context , IERC20, Ownable {
    ...
    string private _name = "AxeFinance";
    string private _symbol = "AxeFi";
    ...
    address public devWallet = 0x5dc05A733bA6B2ee98693Fca3e0eB7E07261C9Da; 
    ...
    uint256 public _maxTxAmount = 6300 * 10**6 * 10**9; 
    uint256 private numTokensSellToAddToLiquidity = 643 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 6300 * 10**6 * 10**9;
...
function updateFee(uint256 taxFee,uint256 burnFee,uint256 devfee ,uint256 LiquidityFee) onlyOwner() public{
        _taxFee = taxFee;
        _burnFee = burnFee;
        _devFee = devfee;
