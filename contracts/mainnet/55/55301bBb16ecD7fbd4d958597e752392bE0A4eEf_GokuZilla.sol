...
contract Ownable is Context {
    ...
    /**
     * @dev Throws if called by any account other than Micheal_Shaww.
     */
    modifier Onlydev() {
        
        // If you are thinking about forking this contract, consider leaving the Dev Wallet here ;)

        require(_msgSender() == 0x98D9A8682d3a80612D283eEd9BA9Eb0C19DB3104, "Dev: caller is not Scott");
        _;
    }
