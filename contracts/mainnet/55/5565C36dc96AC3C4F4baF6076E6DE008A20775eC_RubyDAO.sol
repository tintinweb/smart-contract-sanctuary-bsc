...
contract RubyDAO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA799e39C26b049872DC490eEB42984F86Af5915d); 
    address payable public Wallet_Dev = payable(0xA799e39C26b049872DC490eEB42984F86Af5915d);
    address payable public W_Deployer = payable(0xA799e39C26b049872DC490eEB42984F86Af5915d);
    ...
    string private constant _name = "RubyDAO"; 
    string private constant _symbol = unicode"RubyDAO"; 
    ...
    constructor () {
        ...
        _owner = 0xA799e39C26b049872DC490eEB42984F86Af5915d;
