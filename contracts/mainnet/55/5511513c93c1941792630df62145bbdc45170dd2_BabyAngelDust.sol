...
contract BabyAngelDust is Context, IERC20, Ownable {
    ...
    string private _name = "BabyAngelDust";
    string private _symbol = "$babydust";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE9688d78237e4f0304591D77424c34D40CEc7eB1); // Marketing Address
    address payable public teamWalletAddress = payable(0xE9688d78237e4f0304591D77424c34D40CEc7eB1); // Team Address
