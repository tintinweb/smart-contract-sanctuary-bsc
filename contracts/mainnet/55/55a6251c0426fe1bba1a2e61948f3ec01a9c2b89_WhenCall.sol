...
/**
 ...
 telegram : https://t.me/WhenCallPortal
...
contract WhenCall is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD1f207A99374e60E6cE3feaF5439aCB4D2EdE626); 
    address payable public Wallet_Dev = payable(0xD1f207A99374e60E6cE3feaF5439aCB4D2EdE626);
    ...
    string private constant _name = "Travladd,Gollum,Maythous,Venom,Caesar,Messiah,ShillSeals,Pythagoras,Cowboy,Comet,Thunder,Sapphire,Gubbin,GodsCrypto,BSCSafeSniper,CeloHumbleFamily,LowtaxBSC,ChinaPumpCapital,Achilles,SeaDoggs,Kobes,CrypticMaestro,Phillips,Valhalla,Shrek,Shrimpy,Medusa,Clown,Lemon,AEShitcoin,Stonky,CFSbot,AceVentura"; 
    string private constant _symbol = unicode"When Call"; 
