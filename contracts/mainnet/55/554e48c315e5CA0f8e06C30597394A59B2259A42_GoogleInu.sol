...
/*
            ...
            Google Inu
            Google Accept crypto !!!!

     ♦️ Telegram: https://t.me/GoogleInuBSC
...
contract GoogleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Google Inu"; // Edit Name
    string constant _symbol = "GINU"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 1000000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public liquidityFee    = 4; // Edit Liquidity Fee
    uint256 public reflectionFee   = 0; // Edit BUSD Reward Fee
    uint256 public marketingFee    = 4; // Edit Marketing Fee
    uint256 public devFee          = 2; // Edit Dev Fee
