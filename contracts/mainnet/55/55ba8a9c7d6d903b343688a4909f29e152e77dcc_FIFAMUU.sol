...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x526e253F72a57E3B6d97a1e2F48Ee870e0558c23; // owner address
...
contract FIFAMUU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA MUU";
    string private _symbol = "FIMUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x526e253F72a57E3B6d97a1e2F48Ee870e0558c23); // Marketing Address
    address payable public teamWalletAddress = payable(0x526e253F72a57E3B6d97a1e2F48Ee870e0558c23); // Team Address
