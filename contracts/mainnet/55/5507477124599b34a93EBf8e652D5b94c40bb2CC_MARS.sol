...
contract MARS is ERC20, Ownable {
    ...
    address public swapFeeAddr = 0x9A65ECEF5a6858bF6769541fE935Bf26BB326dE8;
        ...
        ERC20("MARS", "MARS")
    {
        ...
        lpRewardToken = 0x57CA2436f9f54F4909a521e24768E21E322cAe88;
        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this),0x57CA2436f9f54F4909a521e24768E21E322cAe88); 
        ...
        _cast(0xF3022B30B01308b13A57075895748352A3bd7FFa, totalSupply);
    }
    ...
    function setFee(uint256 _deadFee,uint256 _deadFeeL,uint256 _lpRewardFee, uint256 _transferFee) public onlyOwner {
        deadFee=_deadFee;
        deadFeeL=_deadFeeL;
    ...
    function setSwapFeeAddr(address _addr) public onlyOwner {
        swapFeeAddr = _addr;
        isExcludedFromFees[_addr] = true;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(lpRewardFee>0 && (isEqual("buy",tradeType) || isEqual("contract",tradeType) || isEqual("sale",tradeType))){
              ...
              uint256 swapFee = amount.mul(transferFee).div(1000);
              amountAfter = amountAfter.sub(swapFee);
              super._transfer(from, swapFeeAddr, swapFee);
