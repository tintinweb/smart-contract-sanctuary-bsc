...
contract whaleCommunity is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whale Community";
    string private _symbol = "WC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9EF4FaB6D967D01AD78C35f7D40F2Ff74480FA9C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9EF4FaB6D967D01AD78C35f7D40F2Ff74480FA9C); // BuyBack Address
