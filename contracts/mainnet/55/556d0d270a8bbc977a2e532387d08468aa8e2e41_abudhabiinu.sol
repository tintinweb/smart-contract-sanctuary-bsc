...
interface IDEXRouter {
 ...
 contract abudhabiinu is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Abu dhabi Inu";
    string constant _symbol = "AbuDhabiI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 19204012 * (10 ** _decimals);
    ...
    address public devFeeReceiver = 0x3C39d15d7e0e371e9e3E9ba06836a07c32cd88ca;
    address public buybackFeeReceiver = 0x3C39d15d7e0e371e9e3E9ba06836a07c32cd88ca;
