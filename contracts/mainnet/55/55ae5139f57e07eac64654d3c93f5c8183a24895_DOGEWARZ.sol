...
contract DOGEWARZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGE WARZ";
    string private constant _symbol = "DOGEWARZ";
