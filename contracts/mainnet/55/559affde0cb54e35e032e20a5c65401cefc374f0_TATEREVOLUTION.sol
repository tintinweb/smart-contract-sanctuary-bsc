...
contract TATEREVOLUTION is Context, IERC20, Ownable {
    ...
    uint256 private whenEat;
    uint256 private cantEatCake;
    ...
    uint256 private _maxOnceEat; 
    uint256 private _maxTotalEat;
