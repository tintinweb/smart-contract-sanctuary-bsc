...
contract LEAGONGPt is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Leagon GPT', 'LGC') {
        require(
            feeAccount != address(0),
            'Leagon GPT: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Leagon GPT: incorrect fee percent');
        require(owner != address(0), 'Leagon GPT: incorrect owner address');
        require(mintToAddr != address(0), 'Leagon GPT: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Leagon GPT: transfer from the zero address');
        require(recipient != address(0), 'Leagon GPT: transfer to the zero address');
