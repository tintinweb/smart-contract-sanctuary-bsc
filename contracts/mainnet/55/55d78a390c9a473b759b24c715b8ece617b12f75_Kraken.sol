...
contract Kraken is ERC20Taxable {
    ...
    /**
     * @notice Constructs the KRAKEN ERC-20 contract.
     */
    constructor() public ERC20Taxable("Kraken", "KRAKEN") {
        // Mints 4_000 KRAKEN to contract creator for initial pool setup.
