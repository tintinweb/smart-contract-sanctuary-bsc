...
SEBASTIEN ESPINOSA FANZOUZ TOKEN                                                                                    
                                                                                      

ROAD TO MILLION - ON VA SE BLINDER LES COUILLES 

NEXT 1000X GEMS 

Total Supply : 1 000 000 000 ROADM Tokens
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBf63be90f859B152ea3FcfeD100f37B6279502ec;
...
contract ESPINOSATOKEN is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xB9636488EF20B92C855c7D21121C1d1A9D7CBabd);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ESPINOSA TOKEN | ROAD TO MILLION";
    string private _symbol = "ROADM";
