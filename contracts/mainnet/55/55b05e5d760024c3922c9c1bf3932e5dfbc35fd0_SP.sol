...
contract SP is ERC20 {
    ...
    address _fundAddress = address(0x49CFaab103197805FBfAD455451CD5587940ff39);
    address fundAddress1 = address(0x0523b05815cb3183a6bdD4f2005d9dC204E75130);
    ...
    constructor(address tokenOwner) ERC20("SP", "SP") {
	...
	function changeSwapWarp(SpWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(from == uniswapV2Pair){
				...
				super._transfer(from, _destroyAddress, amount.div(100).mul(4));
    ...
    function swapAndLiquify(uint256 tokenAmount) private {
        uint256 halfAmount = tokenAmount.div(2);
        swapTokensForOther(halfAmount);
        uint256 allUsdt = USDT.balanceOf(address(this));
        addLiquidityUsdt(halfAmount,allUsdt);
    }
	...
	function _takeInviterFee(
        ...
        for (int256 i = 0; i < 6; i++) {
            ...
            if (cur != address(0)) {
				...
				_receiveD = address(fundAddress1);
			}
