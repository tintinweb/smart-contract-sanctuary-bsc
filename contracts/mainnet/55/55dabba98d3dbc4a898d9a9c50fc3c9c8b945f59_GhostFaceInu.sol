...
// CHANGE
contract GhostFaceInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GhostFace Inu";
    string constant _symbol = "GHOSTFACE";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xe03b5cb7c1A4c55F3db7F14E1ae70e31d4488d3C);
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 1 && multiplier * totalFee <= 4900, "Multiplier too high");
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 newExtraSellFee, uint256 _feeDenominator) external onlyOwner {
