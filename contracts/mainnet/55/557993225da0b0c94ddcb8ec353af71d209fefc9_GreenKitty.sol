...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SINU = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SINU.balanceOf(address(this));
        ...
        uint256 amount = SINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SINU.transfer(shareholder, amount);
...
contract GreenKitty is IBEP20, Auth {
    using SafeMath for uint256;

    address SINU = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GreenKitty";
    string constant _symbol = "GKITTY";
