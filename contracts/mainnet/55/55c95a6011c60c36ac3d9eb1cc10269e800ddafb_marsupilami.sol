...
/**
 welcome to : Marsupilami coin
 Telegram : @marsupilamicoin
 BASED : DEV+TEAM
...
contract marsupilami is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5_000_0 * 10**9; //
    string private constant _name = "Marsupilami Coin"; // 
    string private constant _symbol = "Marsupilami"; //    
