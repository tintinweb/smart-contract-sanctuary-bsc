...
/**
💎🦴$shiZilla | Shibarium Zilla 🦴💎
The Intermediary building trust between Investors and Teams on #SHIBARIUM

The verified contract will be renounced, and the liquidity will be locked shortly after deployment. Buy/Sell taxes will be elevated prior to the contract being renounced. The taxes will be lowered to 3/2 (2% Tax, 1% LP Burn) afterwards.  Max wallet will be 1%.

✅ Ownership Renounced | Locked 1 month
...
contract shibZilla is Context, BEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 69000000000000000 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;
  uint256 private mia = 100;
   uint256 private TSmia = 90; 
    string private _name = 'Shibarium Zilla';
