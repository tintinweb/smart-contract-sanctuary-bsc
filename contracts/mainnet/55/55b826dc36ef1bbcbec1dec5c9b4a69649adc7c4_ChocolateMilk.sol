...
contract ChocolateMilk is IERC20, Ownable {
    ...
    string _name = "Chocolate Milk Token";
    string _symbol = "$CHOCO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = 100_000_000 * (10 ** _decimals);   // 2% 
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x0f3318971F29996d8677ceCb9ce9B30c7D75c54C;
