...
/* Token contract */
contract Wagmigrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa1B3e8d3B87D72C4533DD22c987070DfE3bDfF59;
    ...
    // Name and symbol
    string constant _name = "Wagmi Grow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 5000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xfcE05d982874Dd09a4Cb9eE9CED3866795A6f78d;
