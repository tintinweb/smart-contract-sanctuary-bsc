...
TELEGRAM:  https://t.me/Twitter_Dump
*/
...
contract TwitterDump is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwitterDump"; // 
    string private constant _symbol = "TwitterDump"; //    
