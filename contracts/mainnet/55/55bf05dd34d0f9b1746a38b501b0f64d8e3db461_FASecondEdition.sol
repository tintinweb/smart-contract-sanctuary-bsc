...
contract ERC4907 is ERC721Full, IERC4907 {
    struct UserInfo 
    {
    ...
    constructor(string memory name_, string memory symbol_, bool _anyoneCanMint) 
     ERC721Full(name_, symbol_, _anyoneCanMint) internal
     {
         _registerInterface(_INTERFACE_ID_ERC4907);
     }
...
contract FASecondEdition is ERC4907, ReentrancyGuard {
    ...
    */
    ...
    constructor() public 
        ERC4907("Fantasy Arena Edition 2", "FA EDITION 2", false) {
    ...
    function sell(uint256 tokenId, uint256 price, address payable wallet) public {
        ...
        require(!auctions[tokenId].open, "ERC721Matcha: Cannot sell an item which has an active auction or rental");
