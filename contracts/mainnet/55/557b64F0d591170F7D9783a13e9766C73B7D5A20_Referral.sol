...
contract Referral is Ownable{
    ...
    function bindParent(address _parent) external{
        ...
        require(!isBindParent(msg.sender),"User is bind");
        _referrals[msg.sender] = _parent;
        _referralCount[_parent]++;
        emit BindParent(_parent,msg.sender);
    }
