...
/**
    Telegram https://t.me/CrogiInuBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE15A00716157aE8CB85D57549D6055ba709E44c1; // owner address
...
contract CrogiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crogi Inu";
    string private _symbol = "$CINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE15A00716157aE8CB85D57549D6055ba709E44c1); // Marketing Address
    address payable public teamWalletAddress = payable(0xE15A00716157aE8CB85D57549D6055ba709E44c1); // Team Address
