...
contract LiveTokenParty is Context, IBEP20, Ownable {
    ...
    string private _name = "Live Token Party";
    ...
    constructor() {
        ...
        // Create a pancake pair for this new LTP
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "LTP: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "LTP: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function addToBlackList(address _account) external onlyOwner {
        require(
            ...
            "LTP: We can not blacklist dexRouter"
        );
        require(!_isBlackListed[_account], "LTP: sniper already exist");
        _isBlackListed[_account] = true;
    }

    function removeFromBlackList(address _account) external onlyOwner {
        require(_isBlackListed[_account], "LTP: Not a sniper");
    ...
    function _approve(
        ...
        require(owner != address(0), "LTP: approve from the zero address");
        require(spender != address(0), "LTP: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "LTP: transfer from the zero address");
        require(to != address(0), "LTP: transfer to the zero address");
        require(amount > 0, "LTP: Amount must be greater than zero");
        require(!_isBlackListed[to], "LTP: Sniper detected");
        require(!_isBlackListed[from], "LTP: Sniper detected");
