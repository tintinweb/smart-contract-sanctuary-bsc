...
contract Yutu is ERC20, Ownable {
    ...
    function setSwapEnabled (bool _flag) public isAuth {
        swapEnabled = _flag;
    }
    ...
    function setMinimumTokenBalanceForDividends (uint256 newAmount) public isAuth {
    ...
    function updateStakingWallet(address newStakingWallet) external isAuth {
