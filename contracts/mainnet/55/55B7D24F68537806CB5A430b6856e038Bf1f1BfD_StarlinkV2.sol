...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2657258B6c478c560942f8A47CF09E159a505660; // owner address
...
contract StarlinkV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarlinkV2";
    string private _symbol = "SV2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2657258B6c478c560942f8A47CF09E159a505660); // Marketing Address
    address payable public buybackWalletAddress = payable(0x2657258B6c478c560942f8A47CF09E159a505660); // Buyback Address
    ...
    uint256 private _buybackShare = 20; 
