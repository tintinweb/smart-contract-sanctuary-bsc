...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC59b9759D8dD31C4ad84CF125384b5D1e7F90EbF; 
...
contract GabimaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Gabimaru Inu ";
    string private _symbol = " $GINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC59b9759D8dD31C4ad84CF125384b5D1e7F90EbF); // 
    address payable public teamWalletAddress = payable(0xC59b9759D8dD31C4ad84CF125384b5D1e7F90EbF); // 
