...
// Swap 2.0, Ownable, 1 Wallet

contract ERC20_Swap2_Own_OneWal is IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.wallet1);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.wallet1Fee;
        }
    }
