...
contract AREZART_BADGE is ERC721, ERC721Enumerable, Ownable {
    bool public IsActive = true;
    string private _baseURIextended;
    address payable public immutable contract_owner;
    uint256 public _price = 0;//價格

    constructor(address payable _owner) ERC721("AREZART BADGE", "AREZART BADGE") {
