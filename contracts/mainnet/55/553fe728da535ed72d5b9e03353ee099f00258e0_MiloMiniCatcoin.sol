...
contract MiloMiniCatcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiloMiniCatcoin";
    string private _symbol = "MiloMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfFDb0C9009Acc74F23E8aa2322aBC4B63250DFA3); // Marketing Address
    address payable public teamWalletAddress = payable(0xfFDb0C9009Acc74F23E8aa2322aBC4B63250DFA3); // Team Address
