...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3941Fc074B146860864C2d0Ad430B2B0DA923C8C; // owner address
...
contract Xshiba is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Xshiba";
    string private _symbol = unicode"XSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3941Fc074B146860864C2d0Ad430B2B0DA923C8C); // Marketing Address
    address payable public teamWalletAddress = payable(0x3941Fc074B146860864C2d0Ad430B2B0DA923C8C); // Team Address
