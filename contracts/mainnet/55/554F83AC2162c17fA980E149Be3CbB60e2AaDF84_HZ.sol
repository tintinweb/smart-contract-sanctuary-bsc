...
contract HZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hair Zilla";
    string private _symbol = "Hair Zilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3D1aA5c5b8E1AC07e2Da92956f08C23F69C71bD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xa3D1aA5c5b8E1AC07e2Da92956f08C23F69C71bD); // BuyBack Address
    ...
    function manage_add(address newAddress) external virtual {
