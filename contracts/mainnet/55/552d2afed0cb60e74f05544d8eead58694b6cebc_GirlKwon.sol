...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xa0D901e73ee3237C7006DA8DCA26c2235040d601;
        _token = msg.sender;
    }
...
contract GirlKwon is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x00f54B56246A206EFf60cdb5B538223eF9763516; //mw dj
    address DevWallet       = 0x00f54B56246A206EFf60cdb5B538223eF9763516; //dw sfz

    string constant _name = "GirlKwon";
    string constant _symbol = "GirlKwon";
