...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9f2577c5F04Ed63115ABF37F1c7563712e114ac8; // owner address
...
contract VIKINGCAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5a317e24eEcc2Be9C8A0C20c828E9a12d5ff1e72); // Marketing Address
    address payable public teamWalletAddress = payable(0x01863a2e99560Be9bF53ea3E479C3d9c5D962cE8); // Team Address
