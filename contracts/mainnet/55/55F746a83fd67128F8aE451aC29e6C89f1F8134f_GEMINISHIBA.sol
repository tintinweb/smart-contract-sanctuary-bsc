...
contract GEMINISHIBA is Context, IERC20, Ownable {
    ...
    string private constant _name = "GEMINI SHIBA";
    string private constant _symbol = "$GMSB";
