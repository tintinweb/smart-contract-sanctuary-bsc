...
// 
//
// 📱 Telegram:https::https://t.me/+hQsOu7YFFAAwOTI1
//
...
contract $FOOTBALLNPC is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("FOOTBALL NPC", "FOOTBALLNPC") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FOOTBALLNPC";
    string private _symbol = "FOOTBALLNPC";
