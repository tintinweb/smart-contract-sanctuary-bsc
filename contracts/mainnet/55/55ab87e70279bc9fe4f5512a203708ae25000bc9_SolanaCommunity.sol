...
// TG : https://t.me/SolanaCommunity_Bsc            
...
contract  SolanaCommunity is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solana Community";
    string private _symbol = "SOLC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc8d4b8852db19171606fdFE21e66b450C6044ACB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc8d4b8852db19171606fdFE21e66b450C6044ACB); // BuyBack Address
