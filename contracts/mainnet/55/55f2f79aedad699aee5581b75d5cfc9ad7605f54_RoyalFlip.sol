...
contract RoyalFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0xD4b77c5A1C7162aC4f2ac3876AB0879291bC22F5);
    uint8 public _houseFeePercentage = 30; // In 0.1% increments

    address public _devFeeReceiver = address(0xD4b77c5A1C7162aC4f2ac3876AB0879291bC22F5);
