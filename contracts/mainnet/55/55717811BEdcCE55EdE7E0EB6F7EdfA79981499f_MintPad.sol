...
/*
*
* Telegram Group: https://t.me/mintpad
*
...
* Taxes structure:
*
* 2% reflected to HODLERS EVERY 60 MIN
* 3% marketing wallet
*
...
contract MintPad is Context, IERC20, Ownable {
    ...
    string private constant _name = "MintPad";
    ...
    uint256 private minx = 1 * 10**40 * 10**_decimals;
    uint256 private ton = 1 * 10**9 * 10**_decimals;
    ...
    feeRatesStruct public feeRates = feeRatesStruct(
     {rfi: 0,
      liquidity: 0,
      research: 0,
      dev: 5}); //32 bytes - perfect, as it should be
