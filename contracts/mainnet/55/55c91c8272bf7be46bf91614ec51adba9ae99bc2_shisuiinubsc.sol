...
// TWITTER : https://twitter.com/shisuiInu
...
contract shisuiinubsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$Shisui Inu";
    string private _symbol = "$shisui";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x60cd6624b022C7fc8dbe7EB727FCB1DA505F04f8); // Marketing Address
    address payable public teamWalletAddress = payable(0x33273Ede9F70bb887CA163c4A7972B0d15529922); // Team Address
