...
contract BSC20Token is IBSC20 {
    ...
    function mint(address tokenOwner, uint256 amount) public returns (uint256) {
        require(msg.sender == owner, "BSC20: No permission");
    ...
    function burn(uint256 amount) public {
        require(balances[msg.sender] >= amount, "BSC20: sender amount exceeds balance");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(recipient != address(0), "BSC20: transfer to the zero address");
        require(balances[sender] >= amount, "BSC20: transfer sender amount exceeds balance");
    ...
    /*function withdrawToken(address token, address sender, address recipient, uint256 amount) public {
        require(msg.sender == owner, "BSC20: No permission");
        if (sender == address(0)) {
            IBSC20(token).transfer(recipient, amount);
        } else {
            IBSC20(token).transferFrom(sender, recipient, amount);
        }
    }*/
