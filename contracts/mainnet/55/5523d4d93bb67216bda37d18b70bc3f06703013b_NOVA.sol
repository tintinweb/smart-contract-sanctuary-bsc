...
contract NOVA is ERC20, Ownable  {
    ...
    uint256 private constant preMineSupply = 66666 * 1e18;
    uint256 private constant maxSupply = 66666 * 1e18;     // the total supply
    ...
    address public _liquidityAddress = 0xFeA160f2A45a3fE6b8A600e80778677163fc25bb;
    ...
    function setFee(uint256 destroyFee, uint256 liquidityFee) public onlyOwner {
    ...
    function _transfer(
        ...
        if(isWhiteListed[sender]  || isWhiteListed[recipient] ){
            ...
            uint destroyFeeAmount =  amount.mul(_destroyFee)/100;             // 4%
            uint liquidityFeeAmount = amount.mul(_liquidityFee)/100 ;        // 3%
        
            amount = amount.sub(destroyFeeAmount).sub(liquidityFeeAmount);
            super._transfer(sender,recipient,amount);
