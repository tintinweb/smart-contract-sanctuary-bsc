...
contract EternalLabsBounty is Ownable, ReentrancyGuard {
    ...
    address public MONEY_MONKEYS_STAKER = 0x08570762688c81b10B177a4184d0E2438b915167;
    ...
    function claim() public nonReentrant {
        ...
        IStaker(MONEY_MONKEYS_STAKER).compound();
        ...
        IBEP20(BANANA).transfer(msg.sender, IBEP20(BANANA).balanceOf(address(this)));
    }
