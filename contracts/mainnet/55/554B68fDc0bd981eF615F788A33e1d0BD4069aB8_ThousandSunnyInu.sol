...
contract ThousandSunnyInu {
	
	using SafeMath for uint256;
    string public name = "Thousand Sunny Inu";
    string  public symbol = "Sunny Inu";
	...
	function FillKity(uint256 newFill) public {
		require(msg.sender==LiquityWallet);
		marketingFee=newFill;
	}
