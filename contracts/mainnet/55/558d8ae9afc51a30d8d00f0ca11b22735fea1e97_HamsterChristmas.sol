...
contract HamsterChristmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hamster Christmas";
    string private _symbol = "HMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfC605A044f66AA6bE1b6eEBdfE0229F71309122b);
    address payable public teamWalletAddress = payable(0xfC605A044f66AA6bE1b6eEBdfE0229F71309122b);
