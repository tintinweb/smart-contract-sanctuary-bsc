...
/**
PIXIU Finance
The newest meme token community to take over BNB. Join us. 
Dedicated Pixiu Features . Useful utilities!
Telegram -https://t.me/PIXIUFinanceBSC
*/
...
interface PIXIUFinanceDeployer {
...
contract PIXIUFinance is PIXIUFinanceDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PIXIUFinanceTeam;
    address private CharityPIXIUFinance;
    ...
    string public override name = "PIXIU Finance";
    string public override symbol = "PIXIUFinance";
    ...
    constructor(uint totalSupplyValue, address PIXIUFinanceTeamAddress, address CharityPIXIUFinanceAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PIXIUFinanceTeam = PIXIUFinanceTeamAddress;
        CharityPIXIUFinance = CharityPIXIUFinanceAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PIXIUFinanceTeam] =  totalSupply * 4 / 100;
        balances[CharityPIXIUFinance] = totalSupply * 4 / 100;
