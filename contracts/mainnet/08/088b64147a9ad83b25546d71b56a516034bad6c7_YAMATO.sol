...
/**
 */
//Yamato is a female character in the one piece anime who has a beautiful and sexy face, but has very great strength. We hope that Yamato can show its prowess in the Binance Smart Chain network project.

//$YAMATO is a meme token on the Binance Smart Chain Network that never stops growing through marketing techniques that will be implemented gradually to form a strong Community to grow and grow to be big.
...
contract YAMATO  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd67f26c50505FEd01C28f165f22Bbb28E6BA44DC); 
    address payable public Wallet_Dev = payable(0x2Ceba4746e20c0f80484c882B374D982401Ea68D);
    ...
    constructor () {
        ...
        _owner = 0x3216a2686255682Fa21f49dfca1aC671d345046c;
