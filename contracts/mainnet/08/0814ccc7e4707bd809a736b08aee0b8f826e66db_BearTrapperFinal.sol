...
//  _______    _______       __        _______       ___________  _______        __         _______   _______    _______   _______   
// |   _  "\  /"     "|     /""\      /"      \     ("     _   ")/"      \      /""\       |   __ "\ |   __ "\  /"     "| /"      \  
// (. |_)  :)(: ______)    /    \    |:        |     )__/  \\__/|:        |    /    \      (. |__) :)(. |__) :)(: ______)|:        | 
// |:     \/  \/    |     /' /\  \   |_____/   )        \\_ /   |_____/   )   /' /\  \     |:  ____/ |:  ____/  \/    |  |_____/   ) 
// (|  _  \\  // ___)_   //  __'  \   //      /         |.  |    //      /   //  __'  \    (|  /     (|  /      // ___)_  //      /  
// |: |_)  :)(:      "| /   /  \\  \ |:  __   \         \:  |   |:  __   \  /   /  \\  \  /|__/ \   /|__/ \    (:      "||:  __   \  
// (_______/  \_______)(___/    \___)|__|  \___)         \__|   |__|  \___)(___/    \___)(_______) (_______)    \_______)|__|  \___) 
//
// https://t.me/BEARTRAPPERPORTAL
...
contract BearTrapperFinal is IBEP20, Ownable {
    ...
    string private _name = "BearTrapper";
    string private _symbol = "$BTRAP";
    uint256 private constant INITIAL_SUPPLY = 1_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //Trapper can never set tax higher than this value
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 60,
        rewards: 0
        //@Trapper. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        Trapper: 0xd6782f53FF23288d82D916fb2F2Ff49B28E6fc29,
        Dev: 0xd6782f53FF23288d82D916fb2F2Ff49B28E6fc29,
        marketing: 0xA48d922a30eE1f8545ECDeF3ba1723Fa94Dac948
    });
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdateTrapperWallet(address newTrapperWallet);
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on Trapper's chosen ratios
        ...
        _excluded.add(_taxWallet.Trapper);    
    ...
    //allows Trapper to change token name and symbol. 
...
///// AUTHORIZED FUNCTIONS /////
    ...
    //Allows Trapper to change reward
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external authorized {
        ...
        //Trapper can never set sells below 0.1% of circulating/initial supply
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newTrapper + newLiquidity + newDev + newmarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newTrapper, newLiquidity, newDev, newmarketing, newRewards);
    }
    ...
    function withdrawTrapper() external authorized {
        ...
        uint256 amount = lostBalance ? TrapperBalance + remaining : TrapperBalance;
        TrapperBalance = 0;
        _sendBnb(_taxWallet.Trapper, amount);
    } 
...
///// OWNER FUNCTIONS /////  
    ...
    function setTrapperWallet(address payable addr) external onlyOwner {
        address prevTrapper = _taxWallet.Trapper;
        _excluded.remove(prevTrapper);
        _taxWallet.Trapper = addr;
        _excluded.add(_taxWallet.Trapper);
        emit UpdateTrapperWallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Trapper, uint256 Dev, uint256 marketing) {
        return (buybackBalance, TrapperBalance, DevBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    uint256 private TrapperBalance;
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 TrapperSplit = (bnbAmount*_taxRatios.Trapper) / distributeRatio;
