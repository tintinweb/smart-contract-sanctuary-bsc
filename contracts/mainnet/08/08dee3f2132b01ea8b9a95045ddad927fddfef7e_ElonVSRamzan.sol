...
/**
TAX 5%
All funds raised will go to help Ukraine, we will help the whole world!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xfB02884142C8927FdbFEe460697149D171A62575); 
...
contract ElonVSRamzan is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ElonVSRamzan";
    string constant _symbol = "EVSR";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xfB02884142C8927FdbFEe460697149D171A62575;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 10;
    uint256 public _walletMax = _totalSupply * 3 / 10;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x19DF507f1a97dc0C99f34A67773ac5AAe36f40F6;
