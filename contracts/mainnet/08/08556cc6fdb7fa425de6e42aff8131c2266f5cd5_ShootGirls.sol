...
Telegram https://t.me/shootgirlsbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2A277d1C5974c3325fb776Ef208f9cC4F6ecbE41; // owner address
...
contract ShootGirls is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shoot Girls";
    string private _symbol = "SGirls";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2A277d1C5974c3325fb776Ef208f9cC4F6ecbE41); // Marketing Address
    address payable public teamWalletAddress = payable(0x2A277d1C5974c3325fb776Ef208f9cC4F6ecbE41); // Team Address
