...
contract CatCLOUD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatCLOUD";
    string private _symbol = "CAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbD41b109AE0EEBEFC45d68c8ff0d9DF3ABe291A2); // Marketing Address
