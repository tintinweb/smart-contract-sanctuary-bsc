...
/**
 Welcome to Scammer Detector Bot, this bot is used to detect possible scams through the blockchain.
 The bot will read all the tx of the wallets related to the token and will analyze if it had previous movements in scams.

 Our telegram group -> https://t.me/scammerdetectortoken
 Telegram bot -> https://t.me/scammerdetectorbot

 Twitter -> https://twitter.com/ScamdetectorBot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d959668Cff0089789AF29324C8ea0b34F517171; // owner address
...
contract scamdetectorbot is Context, IERC20, Ownable {
    ...
    string private _name = "Scammer Detector Bot";
    string private _symbol = "SDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8d959668Cff0089789AF29324C8ea0b34F517171); // Marketing Address
    address payable public teamWalletAddress = payable(0xF16EC8Ae5B56f51efE5FcC6A260c8902caBd5901); // Team Address
