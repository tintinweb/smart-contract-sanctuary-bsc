...
contract Yatogami is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yatogami";
    string private _symbol = "YGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9A86EB37dD5FE04e33156dD1130cefc0765ff3B4);
    address payable public BuyBackWalletAddress = payable(0x9A86EB37dD5FE04e33156dD1130cefc0765ff3B4);
