...
contract UNKAI is Context, IERC20, Ownable {
    ...
    string private _name = "UNKAI";
    string private _symbol = "UNKAI";
    ...
    address payable private marketingWalletAddress = payable(0x1F566F8C81752352b9ae2f12B8aa8e76101ABFbF);
    address payable private activityWalletAddress = payable(0x6b25Cb9338b4cEC5632aFd12B905C9C25a71BB4b);
    address payable private liquidityWalletAddress = payable(0x1F566F8C81752352b9ae2f12B8aa8e76101ABFbF);
