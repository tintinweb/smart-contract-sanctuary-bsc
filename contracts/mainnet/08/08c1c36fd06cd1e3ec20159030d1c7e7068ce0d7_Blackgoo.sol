...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x952Afc37DB352E197B6c0325c23f432f4C1728fA; // owner address
...
contract Blackgoo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Goo";
    string private _symbol = "Black G$";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x952Afc37DB352E197B6c0325c23f432f4C1728fA); // Marketing Address
    address payable public teamWalletAddress = payable(0x952Afc37DB352E197B6c0325c23f432f4C1728fA); // Team Address
