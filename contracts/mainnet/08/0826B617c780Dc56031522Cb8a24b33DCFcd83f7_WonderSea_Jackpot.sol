...
contract WonderSea_Jackpot is Ownable {
    address public WSF_Token = 0x71F9033EcbaD23737c298e654303F76FEe57AFfF; 
    address public mainContract;
    uint256 public moment;
    uint256 public minDeposit = 10000 * 1e16; /** min  10,000 $WSF (1% for Jackpot) **/
    ...
    function setMinDeposit(uint256 value) external onlyOwner {
        require(value >= 5000 && value <= 100000); /** max 100,000 $WSF **/
        minDeposit = value * 1e16;
    }
    ...
    function getReward(address _user) private {
        ...
        IERC20(WSF_Token).safeTransfer(_user, poolSize());
        lastUser = address(0);
        moment = 0;
        amountPerHour = 0;
    }
    ...
    function poolSize() public view returns (uint256) {
        return IERC20(WSF_Token).balanceOf(address(this));
    }
}