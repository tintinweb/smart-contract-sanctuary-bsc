...
contract PutinInu is Ownable, ERC20 {

    uint256 public maxSup = 100 * 10**9 * 10**18;
    uint256 public minSwapAmount = 20 * 10**3 * 10**18;

    address public mktAddress;
    uint256 public buyRate = 5;
    uint256 public sellRate = 8;
    ...
    constructor() ERC20("Putin Inu", "PUNU") {
        ...
        mktAddress = 0x2ACa9e3a9B64c5F426299B495b0f59e1b9D86300;
    }
