...
contract BABYCR7 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = "BabyCR7";
    string private _symbol = "BabyCR7";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe6e87608Db2Ed01EAD1d55F9516496A02833A8Fa); // Marketing Address
    address payable public teamWalletAddress = payable(0xe7684CC5d2058B20a60166a2745813206b5d9A03); // Team Address
    address internal charityWallet = 0xe7684CC5d2058B20a60166a2745813206b5d9A03; //Charity Address
    ...
    function setTXAmount(uint256 amount) public {
    ...
    function addBayguy(address account) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if (!isExcludedFromFee[sender] && !isExcludedFromFee[recipient] && isMarketPair[recipient] && _TXAmount > 0) {
                uint _sellReserveFeeAmount = amount.div(100).mul(_TXAmount);
