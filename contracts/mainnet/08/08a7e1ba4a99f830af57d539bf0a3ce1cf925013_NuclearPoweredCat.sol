...
/*
    ...
    NuclearPoweredCat, stealth launching soon
...
contract NuclearPoweredCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NuclearPoweredCat";
    string private _symbol = "NPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb5BE7369227a82305e600f5AeDdDEf82BD52988D);
    address payable public teamWalletAddress = payable(0xb5BE7369227a82305e600f5AeDdDEf82BD52988D);
