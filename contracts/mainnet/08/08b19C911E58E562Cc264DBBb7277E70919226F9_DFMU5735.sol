...
contract Ownable is Context {
    address private _owner = 0xfa27AcF1354a8Df8d5d859175B24b504EE70f5De;
...
contract DFMU5735 is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x4fe53Af98c04c4C35fD2173d8f3fB2E6Bc29294b); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "DNMU5735"; // token name
    string private _symbol = "DNMU5735"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 10 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
