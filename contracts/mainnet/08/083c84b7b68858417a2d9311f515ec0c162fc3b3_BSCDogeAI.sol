...
contract BSCDogeAI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 180000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BSC Doge AI";
    string private _symbol = "BSCDogeAI";
