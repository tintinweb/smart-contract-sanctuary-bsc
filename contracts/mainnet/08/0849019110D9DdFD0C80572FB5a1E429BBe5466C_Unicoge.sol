...
contract Unicoge is IERC20, Ownable {
    ...
    string _name = "Unicoge";
    string _symbol = "UNICOGE";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(113945130).div(100000000000);
    ...
    function changeFeeees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _giveawayFee) external onlyOwner {
