...
/**
Telegram: https://t.me/FlokiOurQueen
Website: 

We give honor to the most influential Queen of all time. Join the community and do not miss FlokiOurQueen Moonshot!!!
...
contract FlokiOurQueen is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiOurQueen"; // 
    string private constant _symbol = "FOQ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xFaF8caD74E9a97888753599aD28678820C9366B7;
