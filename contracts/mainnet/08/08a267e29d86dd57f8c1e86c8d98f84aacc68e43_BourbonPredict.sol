...
pragma abicoder v2;
/**
 * @title BourbonPredict
 */
contract BourbonPredict is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public bonusAmount; // bonus amount for each round
    ...
    function userExecuteRound() external whenNotPaused {
        require(
            genesisStartOnce && genesisLockOnce,
            "Can only run after genesisStartRound and genesisLockRound is triggered"
        );
    ...
    function _calculateRewards(uint256 epoch) internal {
        ...
        // Add to treasury
        treasuryAmount += treasuryAmt / 2;
        bonusAmount += treasuryAmt / 2;
    ...
    function _startRound(uint256 epoch) internal {
        ...
        round.epoch = epoch;
        round.totalAmount = 0 + bonusAmount;
        bonusAmount = 0;
