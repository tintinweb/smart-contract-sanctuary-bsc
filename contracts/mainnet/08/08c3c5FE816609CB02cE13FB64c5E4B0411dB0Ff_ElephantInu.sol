...
/**
Wait...What? - ElephanInu

Telegram: https://t.me/ElephantInu
*/
...
contract ElephantInu is IBEP20, Auth {
	...
	string constant _name = "ElephantInu";
    string constant _symbol = "ElephantInu";
	...
	uint256 private liquidityFee = 180;
    uint256 public liquidityTax = 70;
    ...
    address payable  public marketingWallet = payable(0x42105Ff5429725D112164C6838548959Da0e9F2b);
    ...
    function setFees(uint256 _liquidityFee, uint256 _totalTax, uint256 _feeDenominator, uint256 _sellMultiplier, uint256 _sellDenominator) external authorized {
        ...
        require(totalFee * sellMultiplier / sellDenominator < feeDenominator / 4, "Maximum allowed selltax on this contract is 10%.");
    }
