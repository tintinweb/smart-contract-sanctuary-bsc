...
contract Rhoades is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Rhoades";
    string private _symbol = "RHAD";
    ...
    function requestChange(bool _enabled) external onlyOwner{
        swapEnabled = _enabled;
    }

    function effectclear(uint256 rLiquidity) external onlyOwner {       
	...
	function withdrawtoken(uint256 _amount) private view returns (uint256) {
