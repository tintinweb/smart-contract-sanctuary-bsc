...
contract glassesdoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "glassesdoge";
    string private _symbol = "glassesdoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x27AaD9DF166c351776e88d973a10820597AD54c2);
    address payable public liqWalletAddress = payable(0x27AaD9DF166c351776e88d973a10820597AD54c2);
