...
library Address{
 ...
 contract Koji is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7e13 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 70_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 700_000_000_000 * 10**9;
    uint256 public maxSellLimit = 700_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 700_000_000_000 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(sender, address(this), s.tLiquidity + s.tMarketing + s.tBurn);
        }
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.burn) * 2;
    ...
    function airdropTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
        ...
        for(uint256 i = 0; i < accounts.length; i++){
            _tokenTransfer(msg.sender, accounts[i], amounts[i] * 10**_decimals, false, false);
        }
    }
