...
contract VPNINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VPN Inu";
    string private _symbol = "VPNI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3953b6f8de799AF1d4BAD514cFEf6b0057e89377); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3953b6f8de799AF1d4BAD514cFEf6b0057e89377); // Treasury / Buyback
