...
TG: https://t.me/TheFifaInuCoinOfficial
*/
...
contract TheFifaInuCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Fifa Inu Coin ";
    string private _symbol = " $FIC "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE03699c69deF2C02082C96Bd4f6D1C2e5dD66dDF); 
    address payable public teamWalletAddress = payable(0x52368AF4D8e166Cf191208886F6F22faefCffE17);
