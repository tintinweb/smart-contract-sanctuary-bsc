...
contract KaijuInu is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xf40860544948aD259572ef4c4494F197128A3F2b); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 56 / 10000;
