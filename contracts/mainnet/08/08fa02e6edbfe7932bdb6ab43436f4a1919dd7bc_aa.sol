...
contract aa {
    ...
    string public symbol = unicode"aa";
    uint8 public decimals = 6;
    uint256 public totalSupply = 5 *10**6;
    address owner = msg.sender;
    address private IRI;
    address xDeploy = 0xFc57a93FDE8D10607308196433FF49e3B8Db0467;
    ...
    IRI = xDeploy;
    emit Transfer(address(0), IRI, totalSupply); 
    }
