...
contract random is Governance {
    ...
    uint public leftAmounts2 = 400;
    uint public leftAmounts5 = 400;                                           
    ...
    function getRandom(uint num) external onlylock {
        ...
        {
            price = desNum5;
            require(leftAmounts5 > 0,"left Amounts");
            leftAmounts5 = leftAmounts5.sub(1);
        }
    ...
    function setLeftAmount(uint new_leftAmounts2,  uint new_leftAmounts5) external onlyGovernance {      
        leftAmounts2 = new_leftAmounts2;
        leftAmounts5 = new_leftAmounts5;
    }
