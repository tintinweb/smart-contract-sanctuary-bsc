...
// Telegram https://t.me/athtoathbsc
...
contract AthtoAthbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AthtoAthbsc";
    string private _symbol = "$ATA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd34E0Ef4A18098944c52B45b4755167Ab6FAf494); // Marketing Address
    address payable public teamWalletAddress = payable(0x5EA63A315B3F25d8EA7c1fA3B65fE8395c537cbF); // Team Address
