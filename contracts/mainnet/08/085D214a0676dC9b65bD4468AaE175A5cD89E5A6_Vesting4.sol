...
contract Vesting4 is IVesting, Ownable, Destory {
  ...
  constructor(address __tokenAddress, address __beneficiaryAddress, uint64 startAt, uint64 firstPercentage, uint64 durationSeconds) {
