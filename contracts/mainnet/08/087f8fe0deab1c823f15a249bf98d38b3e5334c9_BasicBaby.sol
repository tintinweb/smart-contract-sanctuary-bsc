...
TELEGRAM: https://t.me/basicbabybsc
|
*/
...
contract BasicBaby   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Basic Baby ";
    string private _symbol = " BBABY "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe7e64d297Cf246b1a4Dd5e76d1617fe497746C5a); 
