...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xe472E0b18077CC4AaBc85A8Cab2f061915276F9d;
...
contract BabyOnlyInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Baby Only Inu"; 
    string private constant _symbol = unicode"BABYONLYINU"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xe472E0b18077CC4AaBc85A8Cab2f061915276F9d), BNB_Tot);
            }
