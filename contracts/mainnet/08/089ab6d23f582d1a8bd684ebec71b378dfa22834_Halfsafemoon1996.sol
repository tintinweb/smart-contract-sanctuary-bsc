...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x531E3cD0D5008f8e0eA41E086988fE72460ec7EF; 
...
contract Halfsafemoon1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Safemoon 1996";
    string private _symbol = "HSM96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x531E3cD0D5008f8e0eA41E086988fE72460ec7EF); 
    address payable public teamWalletAddress = payable(0x531E3cD0D5008f8e0eA41E086988fE72460ec7EF); 
    ...
    uint256 public _walletMax = 240000000 * 10**_decimals;
