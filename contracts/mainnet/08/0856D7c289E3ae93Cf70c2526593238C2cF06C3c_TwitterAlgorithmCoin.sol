...
/**
 *    HungApe (HAPE)
 *    The commander in charge is pronounced the hungest of them all. Do you have what it takes to be a Hung Ape?
 *    LP locked
 *    5% tax
 *
 *    https://t.me/TwitterAlgorithmCoin
 */
...
contract TwitterAlgorithmCoin is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 15 * 10**8 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**_decimals;
    string private constant _name = "TwitterAlgorithmCoin";
    string private constant _symbol = "TAC";
    uint8 private constant _decimals = 9;

    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x1AC53DfaE7eC8d0c5CE3Fc91949A0c8C1DBC043C;
