...
//Telegram : https://t.me/wcqatarbetofficial
//TBot : @wclaeebbetbot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b1E41CfC93cA68e3a8F7CDe3160A763A0304576; // owner address
...
contract WCLaeebBetBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WC Laeeb Bet Bot";
    string private _symbol = "WCL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b1E41CfC93cA68e3a8F7CDe3160A763A0304576); // Marketing Address
    address payable public teamWalletAddress = payable(0xeb14c651F9B6145A4a90D3564B55914A2B9cd34C); // Team Address
