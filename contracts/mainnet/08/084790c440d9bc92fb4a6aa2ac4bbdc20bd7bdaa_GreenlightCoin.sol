...
contract GreenlightCoin is IERC20, Ownable {
    ...
    string _name = "GreenLight COIN";
    string _symbol = "GREENLIGHT";
    ...
    function viewFees() external view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        return (taxFeeVar, _sellFee, giveawayFee, reflectionFee, totalFee, feeDenominator);
    }
    ...
    function changeFees(uint256 _taxFeeVar, uint256 _reflectionFee, uint256 __sellFee, uint256 _giveawayFee) external onlyOwner {
        taxFeeVar = _taxFeeVar;
        reflectionFee = _reflectionFee;
        _sellFee = __sellFee;
        giveawayFee = _giveawayFee;
        totalFee = taxFeeVar.add(reflectionFee).add(_sellFee).add(giveawayFee);
