...
contract BitzenStaking is ReentrancyGuard, Ownable {
    ...
    constructor(
       ...
       uint256 _emergencyWithdrawFees
        ...
        pooldata[30].returnPer = 6000; // 60%

        //90 days
        pooldata[90].lockupDuration = 90;
        pooldata[90].returnPer = 11000; // 110%

        //180 days

        pooldata[180].lockupDuration = 180;
        pooldata[180].returnPer = 15000; // 150%

        //270 days
        pooldata[270].lockupDuration = 270;
        pooldata[270].returnPer = 18000; // 180%
   ...
   function pendingRewards(uint256 _orderId ) external view returns (uint256) {
    ...
    function setBaseToken(uint256 _basetime) public onlyOwner{
        baseTime = _basetime;
    }
}