...
/**
 * SQUIDWARD INU
 * Low MC Reach millions of MC
 * https://t.me/squidwardInucoin
*/
...
/* Token contract */
contract  SquidwardInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x465fBeCdCbBfC528862413108EFF017C0450DA71;
    ...
    // Name and symbol
    string constant _name = "Squidward Inu";
    string constant _symbol = "SQUIDWARD";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2000 / 1000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 2000 / 1000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 2000 ) / 1000; // 2% 
    ...
    uint256 private marketingFeeBuy = 11;
    ...
    uint256 private marketingFeeSell = 11;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x465fBeCdCbBfC528862413108EFF017C0450DA71;
