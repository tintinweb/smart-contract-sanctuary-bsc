...
contract PPVToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd8E8ff8b773321C4dEF31c54C65D0770E2D7cED4); // Marketing Address
    ...
    string private _name = "Pay Per View Token";
    string private _symbol = "PPV";
    ...
    uint256 public _maxTxAmount = 900000 * 10**6 * 10**18;
    uint256 private minimumTokensBeforeSwap = 2000 * 10**6 * 10**18; 
