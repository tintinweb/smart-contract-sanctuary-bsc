...
/**
 DOGS KOMBAT is a P2E game
 Fight, win and earn DK tokens
 Website Official : https://dogskombat.com/
*/
...
contract DogsKombat{
    ...
    string private _name = "DogsKombat";
    string private _symbol = "DOGK";
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9184000;
    }
