...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f);
    address private _MarketAddress2 = address(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;
    mapping (address => bool) private _isblackList;

    constructor(address tokenOwner) ERC20("TTT", "TTT") {
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f, "");
        _;
    }
