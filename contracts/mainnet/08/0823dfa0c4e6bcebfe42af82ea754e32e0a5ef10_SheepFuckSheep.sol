...
contract SheepFuckSheep is ERC20 {
    using SafeMath for uint256;
    ...
    constructor(address tokenOwner) ERC20("Sheep Fuck Sheep", "Sheep Fuck Sheep") {
	...
	function changeSwapWarp(SheepFuckSheepWarp _warp) public onlyOwner {
        warp = _warp;
	...
	function changeMaxNum(uint256 _maxNum) public onlyOwner {
        maxNum = _maxNum;
    }
