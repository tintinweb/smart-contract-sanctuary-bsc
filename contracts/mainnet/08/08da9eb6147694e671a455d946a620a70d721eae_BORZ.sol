...
// Borzoi Inu - Decentralized wolfhound living on the Binance Smart Chain
// $BORZ
// https://borztoken.com/
...
contract BORZ is Context, IERC20 { 
    ...
    address payable public walletMarketing = payable(0xD562C9a51a60E7d1F4aDB63d25716e7AA1CF0B3b);

    // Token Information
    string private constant _tokenName = "Borzoi Inu";
    string private constant _tokenSymbol = "BORZ";
    ...
    // Used to modify the Marketing/Burn percentage split.
    function percentageSplitChanger(uint256 mSplit, uint256 bSplit) public {
        require(msg.sender == walletMarketing, "Error: Split percentage can only be modified by the marketing team.");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Marketing Split
        uint256 MarketingSize = SplitMarketing * 100 / SplitMarketing;
