...
contract UHGT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "unlocked Hooked Gold Token";
    string private _symbol = "uHGT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8765848Ba772468AD05B1CEfbE81F9010173733C); 
    address payable public BurnedWalletAddress = payable(0x8765848Ba772468AD05B1CEfbE81F9010173733C); 
