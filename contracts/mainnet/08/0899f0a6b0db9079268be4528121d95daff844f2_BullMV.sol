...
contract BullMV is Context, IERC20 {
    ...
    string private _name = "BullMETAverse";
    string private _symbol = "Bullmetaverse";
    ...
    address payable private _marketingWallet = payable(0x694A15d9a34C3162d95Ae1f350AF8F2B7e701D5A);
    address payable private _ecosystemWallet = payable(0x694A15d9a34C3162d95Ae1f350AF8F2B7e701D5A);
