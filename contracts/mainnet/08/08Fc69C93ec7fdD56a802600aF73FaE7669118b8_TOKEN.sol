...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "420 Snoop Doge";
    string private _symbol = "$420 SD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72bB6995957d48b0d61AD8b6249b49F6BA92Cdd5);
    address payable public teamWalletAddress = payable(0x72bB6995957d48b0d61AD8b6249b49F6BA92Cdd5);
