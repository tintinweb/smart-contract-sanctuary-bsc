...
/**
 *Submitted for verification at BscScan.com on 2023-16-02
*/
...
contract RATCEO is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "RatCEO.Finance";
    string constant _symbol = "RATCEO";
