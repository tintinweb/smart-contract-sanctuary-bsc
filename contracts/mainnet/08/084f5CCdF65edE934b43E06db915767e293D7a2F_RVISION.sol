...
contract RVISION is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x3Db03d398BB2dc2d27BAfa8E7Ac5e745013FddC3);
    ...
    */
    ...
    string private _name = "RYOSHI VISION"; 
    string private _symbol = "RVISION";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/3000000000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/3000000000;
    }
