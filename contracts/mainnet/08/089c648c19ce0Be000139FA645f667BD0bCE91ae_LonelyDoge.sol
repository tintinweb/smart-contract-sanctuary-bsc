...
contract LonelyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "OSKYH";
    string private _symbol = "OSKYH";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xb4f7cd21AC881F19A824a72a7DB325cE07888888); // Marketing Address
