...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x935Ac1c8A7A2D77608Edb8522951CF947a0eB2Ff;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x935Ac1c8A7A2D77608Edb8522951CF947a0eB2Ff),//fund 

        address(0x935Ac1c8A7A2D77608Edb8522951CF947a0eB2Ff)//dev 
    ){
