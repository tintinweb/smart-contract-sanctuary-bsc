...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDf1Ba1127A8C75Dc67cFDBdD811A37B30BA7CAA3;
...
contract ElonToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x77E231e2Cd0DEC16201715247B545b6b9f250800;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KW";
    string private _symbol = "KanyeWestInu";
