...
/**
SHIBP is a token that grows on the BSC network with great utilities that it has, the project runs perfectly and is fully controlled by a smart and careful community.
website www.shibapink.com
telegram https://t.me/shibapink
*/
...
contract ShibaPink is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE5D8069A4ed16F96b1E16B70f79C036F0E7c5E89); 
    address payable public Wallet_Dev = payable(0x66862c5EECdCefF0349a8519d8f288eD407DabB2);
    ...
    string private constant _name = "Shiba Pink"; 
    ...
    constructor () {
        ...
        _owner = 0x66862c5EECdCefF0349a8519d8f288eD407DabB2;
