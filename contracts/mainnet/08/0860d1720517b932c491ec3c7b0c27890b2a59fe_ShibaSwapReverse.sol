...
Telegram : https://t.me/ShibaSwapReverse
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0F0fd732378dBbFd2B6618dCf8C581C0822F717;
...
contract ShibaSwapReverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaSwapReverse"; // 
    string private constant _symbol = "$ShibSwap"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xF0F0fd732378dBbFd2B6618dCf8C581C0822F717);
