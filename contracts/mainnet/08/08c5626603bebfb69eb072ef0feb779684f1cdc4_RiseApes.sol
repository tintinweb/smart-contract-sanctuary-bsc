...
contract RiseApes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RiseApes";
    string private _symbol = "rAPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97393Af743cd479513b6cF2b935765709f1f42A5); 
    address payable public buyBackWalletAddress = payable(0x97393Af743cd479513b6cF2b935765709f1f42A5); 
