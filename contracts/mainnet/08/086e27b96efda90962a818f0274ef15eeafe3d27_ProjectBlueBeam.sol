...
Telegram : https://t.me/ProjectBIueBeamBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb438FBCF67B5EBb6eFF37d058b583dAB5b18dF87; // owner address
...
contract ProjectBlueBeam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ProjectBlueBeam";
    string private _symbol = "$BLUEBEAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb438FBCF67B5EBb6eFF37d058b583dAB5b18dF87); // Marketing Address
    address payable public teamWalletAddress = payable(0xb438FBCF67B5EBb6eFF37d058b583dAB5b18dF87); // Team Address
