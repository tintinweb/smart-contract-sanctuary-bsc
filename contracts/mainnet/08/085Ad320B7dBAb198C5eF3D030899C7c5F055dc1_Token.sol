...
contract Token is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0x3b87a105FC8B216F2ceE3b5DDF5A76Da11985926);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _takeLiquidity(sender, tElseFee / 1); 
        _takeBurn(sender, tElseFee / 2);      
        _takeMarket(sender, tElseFee / 1);   
        _takeFund(sender, tElseFee / 2);     
