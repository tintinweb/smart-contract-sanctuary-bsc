...
contract Dao111 is IERC20, Ownable {
    ...
    address marketAddress = address(0x8a6b788A1545D5A2cdEf4A76e6f93856d05dAd97);
    address fundAddress = address(0xEeb47906Cf337201cf01F7006effe34cbB0c2137);
    address hideAddress;
    ...
    uint256 public lpdamount;

    constructor(address tokenOwner,address _hideAddress) {
        _name = "111 Dao";
        _symbol = "111 Dao";
        _decimals = 18;
        _tTotal = 4500000 * 10**_decimals;
        lpdamount = 1000 * 10**_decimals;
    ...
    function changelpdamount(uint256 _lpdamount) public onlyOwner {
        lpdamount = _lpdamount;
    }
    ...
    function _splitOtherTokenSecond(uint256 thisAmount) private {
        ...
        if(buySize>0){
            ...
            uint256 rate;
            if(buySize >30){
                startIndex = block.number.mod(buySize-29);
