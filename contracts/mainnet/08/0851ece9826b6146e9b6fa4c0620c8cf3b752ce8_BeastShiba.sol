...
contract BeastShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Beast Shiba";
    string private _symbol = "$BShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf3706EE26750DD2778dEbE00e346167d1A7eD45f); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xf3706EE26750DD2778dEbE00e346167d1A7eD45f); // Team Address
