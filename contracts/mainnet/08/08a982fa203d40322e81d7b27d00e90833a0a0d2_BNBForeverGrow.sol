...
Telegram: https://t.me/BNBForeverGrow

Twitter: https://twitter.com/BNBForeverGrow
...
contract BNBForeverGrow is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BNBForeverGrow";
    string constant _symbol = "BNBFG"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 150 / 10000; //Initial 1.5%
    uint256 public _maxWalletSize = _tTotal * 200 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0x57B79d56A0c4DbDf6e21BC19235ad94cD9419BAD;
    address public marketingFeeReceiver = 0x57B79d56A0c4DbDf6e21BC19235ad94cD9419BAD;
    address public liquidityFeeReceiver = 0x57B79d56A0c4DbDf6e21BC19235ad94cD9419BAD;
