...
interface IBEP20 {
   ...
   * Returns a boolean value indicating whether the operation succeeded.
   *
   * IMPORTANT: BeNEWe that changing an allowance with this method brings the risk
   * that someone may use both the old and the new allowance by unfortunate
   * transNEW ordering. One possible solution to mitigate this race
   * condition is to first reduce the spender's allowance to 0 and set the
   * desired value afterNEWds:
...
contract BNBNEWToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private BNBNEWBSC;
    address private BNBNEWCoin;
    address private BNBNEWs;
    ...
    string public override name = "BNB2.0";
    string public override symbol = "BNB2.0";
    ...
    constructor(uint totalSupplyValue, address BNBNEWBSCAddress, address BNBNEWCoinAddress, address BNBNEWsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BNBNEWBSC = BNBNEWBSCAddress;
        BNBNEWCoin = BNBNEWCoinAddress;
        BNBNEWs = BNBNEWsAddress;
        balances[BNBNEWBSC] =  totalSupply * 5 / 100;
        balances[BNBNEWCoin] = totalSupply * 15 / 100;
        balances[BNBNEWs] = totalSupply * 25 / 100;
