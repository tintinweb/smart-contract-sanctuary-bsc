...
contract  VenomKitten is Context, IERC20, Ownable {
    ...
    string private _name = "Venom Kitten";
    string private _symbol = "VKTN";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD73463114De2FFaAB0e53b86eADe99852D30098E));
        ruinWalletAddress = payable(address(0xD73463114De2FFaAB0e53b86eADe99852D30098E));
