...
/**
Solana Hex - Solanahex.xyz
To exchange between Solana and BSC use beta.solanahex.xyz (needs Beta VPN)

Metamask is the supported wallet.

The In-Game NFT-s can't be transfered yet.
...
// File: contracts\aBase.sol


// Base class that implements: BEP20 interface, fees & swaps
abstract contract aBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	// MAIN TOKEN PROPERTIES
	string private constant NAME = "SOLHEX";
	string private constant SYMBOL = "wSOLHEX";
	...
	constructor () {
		...
		// 1% liquidity fee, 2% reward fee, 5% additional sell fee
		setFees(1, 2, 5);
