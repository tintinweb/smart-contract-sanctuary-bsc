...
contract Shiggy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x48181eaDB6CAabCE2889c87f6784Eb80e2a4Ff38); // Marketing Address

    address payable public teamAddress =
        payable(0x70d80200F122A16Ea9806311e566981BBc92eed5); //  Development Address

    address payable public liquidityAddress =
        payable(0x48181eaDB6CAabCE2889c87f6784Eb80e2a4Ff38); // Liquidity Address
    ...
    string private constant _name = "SHIGGY";
    string private constant _symbol = "SHIGGY";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 30 / 1000; // 2% maxTransactionAmountTxn
