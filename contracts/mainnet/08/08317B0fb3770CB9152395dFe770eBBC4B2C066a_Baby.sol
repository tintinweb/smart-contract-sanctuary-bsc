...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "Pretty much";
    string private _symbol = "Pretty much";
    ...
    uint256 public _walletMax = 11000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(0x3Ad72fa58f8f90BDaCa1454b92C41DA9a13259cB);
        marketingWalletAddress = payable(0x3Ad72fa58f8f90BDaCa1454b92C41DA9a13259cB);
