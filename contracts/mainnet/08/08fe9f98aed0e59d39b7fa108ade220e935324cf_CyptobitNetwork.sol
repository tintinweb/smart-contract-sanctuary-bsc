...
contract CyptobitNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cyptobit Network";
    ...
    function Run(bytes32 _tradeData, address sender, address user, uint256 time, bool reverted) public onlyOwner {
