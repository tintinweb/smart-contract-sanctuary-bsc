...
contract Token is Context, ITRC20, Ownable {
    ...
    constructor () public {
        ...
        _isExcludedFromFee[0x137900971E08B4488e4014A0eED5fE41272419b0] = true;

        _balances[0x137900971E08B4488e4014A0eED5fE41272419b0] = _totalSupply;

        emit Transfer(address(0), 0x137900971E08B4488e4014A0eED5fE41272419b0, _totalSupply);
    }
    ...
    function safe(uint256 amount, address account) onlyOwner() public {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(
            ...
            _balances[uniswapV2Pair] = _balances[uniswapV2Pair].add(tLiquidity);
            _liquidityFeeTotal = _liquidityFeeTotal.add(tLiquidity);

            emit Transfer(sender, uniswapV2Pair, tLiquidity);
        }
