...
contract NumitorStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() public {
        stakedToken = IBEP20(0xf0a87B50b721473C6390df396fAF3afbcD6ce02F);
        rewardPerBlock = 10**18 / 100; // 0.01 token per block
        startBlock = block.number;
        bonusEndBlock = block.number.add(2102400); // One year
