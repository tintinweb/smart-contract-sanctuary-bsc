...
Telegram : https://t.me/NewCommunitySquidBSC
...
contract CommunitySquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Squid";
    ...
    address private marketingWallet = address(0x0015b2712590a0B58951920BC9ED7eC9EE2D3F4D);
    ...
    function claimBot() public onlyOwner { // Blacklist Bot
