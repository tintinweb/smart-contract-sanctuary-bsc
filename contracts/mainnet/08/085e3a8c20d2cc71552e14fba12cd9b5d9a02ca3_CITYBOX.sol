...
City Box Official Smart Contract
...
contract CITYBOX is Context, IERC20, Ownable {
    ...
    string private constant _name = "City Box";
    string private constant _symbol = "CBOX";
    
    address public CBOX_TeamWallet = 0x7ed6b2Ac3e4E241fe7Dfa25d0FAe8B6785511111;
    ...
    address public CBOX_MarketingWallet = 0xf7704Bdaf5ed03125a4CBE3a281eBA40a5012345;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[CBOX_MarketingWallet] = true;
        _isExcludedFromFee[CBOX_TeamWallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[CBOX_MarketingWallet] = true;
        allowedTransfer[CBOX_TeamWallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(CBOX_MarketingWallet).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(CBOX_TeamWallet).sendValue(teamAmt);
        }
    }
    ...
    function CBOX_UpdateMarketingWallet(address newWallet) external onlyOwner{
        CBOX_MarketingWallet = newWallet;
    }
    
    function CBOX_UpdateTeamWallet(address newWallet) external onlyOwner{
        CBOX_TeamWallet = newWallet;
    }
