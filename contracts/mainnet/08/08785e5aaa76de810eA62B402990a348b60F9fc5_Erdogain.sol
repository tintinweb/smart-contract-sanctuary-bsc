 ...
 */
contract Erdogain is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant _tTOTAL = 3 * 1e12 * 10**_DECIMALS;
     ...
     * construction.
     */
    string private constant _NAME = "Erdogain";
    string private constant _SYMBOL = "ERGAIN";
    ...
    address public developmentWallet = 0x211Ec24c66e6714D260c67C961D9371Ad736f396;
     ...
     * Whale actions.
     */       
    uint256 public _maxTxAmount = 1e11 * 10**_DECIMALS;
    
    /**
     * @dev The number of tokens sell, to add to the liquidity.
     */     
    uint256 public numTokensSellToAddToLiquidity = 1e11 * 10**_DECIMALS;
    ...
    constructor () {
        ...
        // og: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external onlyOwner() {
        require(newAmount <= 1e11 * 10**_DECIMALS, 
