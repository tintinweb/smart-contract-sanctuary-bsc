...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xC487b2cdC39fD45C4ee1b36eDd74cef9533123B6;
...
contract MG is Context, IERC20, Ownable {
    ...
    address private _treasuryWallaetAddress = 0xeA24FF726eeCC959e18c50F6fBaC5Ff00B4e71F3;   
    ...
    string private _name = "MICRO GLOBAL TOKEN";
  ...
  function settreasuryFeePercent(uint256 treasuryFee) external onlyOwner() {
   ...
   //to recieve ETH from uniswapV2Router when swaping
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_treasuryWallaetAddress] = _rOwned[_treasuryWallaetAddress].add(rCharity);
        if(_isExcluded[_treasuryWallaetAddress])
            _tOwned[_treasuryWallaetAddress] = _tOwned[_treasuryWallaetAddress].add(tCharity);
    }
