...
/* Token contract */
contract EXPERIMENTZERO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xc96A605Ef41356F86611B9109D1AaA0c1Cf93fbc;
    ...
    // Name and symbol
    string constant _name = "Experiment Zero";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 10000; // 4% or 2m tokens
