...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public RWRD = IBEP20(0xFAE8E64cDDE73550e7d7f0469557a33a417B2868);
...
/* Token contract */
contract NEWCROGECOINBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "New CrogeCoin BSC";
    string constant _symbol = "NCROGE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 300) / 10000; // 3% on launch or 3M tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x05E5bDc0d15fcDCDdEA9020821c17503aF93b527;
