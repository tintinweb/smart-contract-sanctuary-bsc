...
contract SubarashiINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Subarashi Inu";
    string private _symbol = "SUB";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xc0B50a7FFA850b4b01E3af5cA01BE5d93e425C58);
