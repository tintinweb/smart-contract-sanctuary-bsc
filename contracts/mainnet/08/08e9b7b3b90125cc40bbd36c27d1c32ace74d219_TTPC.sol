...
contract TTPC is IERC20, Ownable {
    ...
    address public marketAddress = 0x8C1A8Aa379b795E030869eF1780431D7D76705A9;

    uint256 private _tFeeTotal;

    string private _name = "TTPC";
    string private _symbol = "TTPC";
    ...
    address public swapWhiteAddr = 0x2a336F4582D068A84027E2e5e3032e657c67e361;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 9990000 * 10**9)_burnFee = 0;
