...
contract RatPapa is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "RPAPA";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 35000000 * 10**_decimals;
    uint256 public _maxTxAmount = 5000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 5000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x1Ba475830E1CB28ce234E28991e9a99B92ed4C96);
