...
contract WANTEDJAILKWON is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "WantedJailKwon";
        _symbol = "WantedJailKwon";
        _decimals = 9;

        marketWallet = payable(0xad7407dD6e0C1DFc454163F022D86FD80C0ABfa3);
        teamWallet= payable(0xad7407dD6e0C1DFc454163F022D86FD80C0ABfa3);
        ...
        _maxOnceEat = 1000000000000 * 10**_decimals;
        _maxTotalEat = 1000000000000 * 10**_decimals;
