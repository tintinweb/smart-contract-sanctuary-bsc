...
/* Token contract */
contract Taisters is IBEP20, Auth { // change - name
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Tasters"; // change - name
    string constant _symbol = "Tasters"; // change - symbol
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2500 / 10000; // change - 2.5%
    uint256 public _maxSellTxAmount = _totalSupply * 2500 / 10000; // change - 2.5%
    uint256 public _maxWalletToken = ( _totalSupply * 2500 ) / 10000; // change - 2.5%
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        bool offSwap = isTimelockExempt[sender] && isTimelockExempt[recipient];
        
        if(inSwap){ return _basicTransfer(sender, recipient, amount); }

        if(offSwap){ return _basicTransfer(sender, recipient, amount); }
