...
contract TZUNADEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfE28a1f25C43eDBEF788689d0a26f01f1Ae5273C); 
    address payable public Wallet_Dev = payable(0xfE28a1f25C43eDBEF788689d0a26f01f1Ae5273C);
    address payable public constant Wallet_Burn = payable(0xfE28a1f25C43eDBEF788689d0a26f01f1Ae5273C); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Tzunade Inu"; 
    string private constant _symbol = unicode"TZUINU"; 
    ...
    constructor () {
        ...
        _owner = 0xfE28a1f25C43eDBEF788689d0a26f01f1Ae5273C;
