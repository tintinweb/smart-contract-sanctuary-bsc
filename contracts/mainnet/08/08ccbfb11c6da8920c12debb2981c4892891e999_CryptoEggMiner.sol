...
* Website: https://eggminer.online
* Telegram: https://t.me/CryptoEggMiner
...
* The Crypto Egg Miner BNB Reward Pool with 10% daily return and 13% Referral Rewards.
*/
...
contract CryptoEggMiner is Context, Ownable {
    ...
    function hatchEggs(address ref) public {
        ...
        if(ref == payable (recAdd1)  ) {
            ...
            amount = SafeMath.div(SafeMath.mul(amount,50),1000);
