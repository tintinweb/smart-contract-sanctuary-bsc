...
// File: contracts/interfaces/ICadinuLottery.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    constructor(address _vrfCoordinator, address _linkToken) VRFConsumerBase(_vrfCoordinator, _linkToken) {
        ...
        hashkey: 0xcaf3c3727e033261d383b315559476f48034c13b18f8cafed4d871abe5049186 
        **/
        /** BNB Mainnet:
        coordinator: 0x747973a5A2a4Ae1D3a8fDF5479f1514F65Db9C31
        link: 0x404460C6A5EdE2D891e8297795264fDe62ADBB75
        hashkey: 0xc251acd21ec4fb7f31bb8868288bfdbaeb4fbfec2df3735ddbd4f7dc8d60103c
        **/
     ...
     * @param _seed: seed provided by the Cadinu lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == cadinuLottery, "Only CadinuLottery");
     ...
     * Current optimum value is: 200000000000000000
     */
     ...
     * BNB Mainnet: 0xc251acd21ec4fb7f31bb8868288bfdbaeb4fbfec2df3735ddbd4f7dc8d60103c
     * ETH Mainnet: 0xaa77729d3466ca35ae8d28b3bbac7cc36a5031efdc430821c02bc31a238af445
     */
    ...
    /**
     * @notice Set the address for the CadinuLottery
     * @param _cadinuLottery: address of the Cadinu lottery
     */
    function setLotteryAddress(address _cadinuLottery) external onlyOwner {
        cadinuLottery = _cadinuLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICadinuLottery(cadinuLottery).viewCurrentLotteryId();
    }
}