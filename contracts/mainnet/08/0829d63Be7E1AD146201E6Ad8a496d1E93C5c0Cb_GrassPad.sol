...
// Telegram : https://t.me/GrassPad
// Website : https://grasspad.finance
...
contract GrassPad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrassPad";
    string private _symbol = "GPAD";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x13DbA2a7e3DbEB7a4EE3EA3B4F392AEc3Efe7A2F); // Marketing Address
    address payable public teamWalletAddress = payable(0x13DbA2a7e3DbEB7a4EE3EA3B4F392AEc3Efe7A2F); // Team Address
