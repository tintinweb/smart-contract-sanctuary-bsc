...
/**
TG: https://t.me/+mvxkowz0zPc4N2J 
Join us for the 10000x token.. everytime Elon tweet we burn!
0 Tax Token
*/
...
contract $Tweetlon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tweelon inu"; 
    string private _symbol = "TWI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfa520dF8f5b8AEe2744Fb24FdDa81621667a552C); 
    address payable public teamWalletAddress = payable(0xfa520dF8f5b8AEe2744Fb24FdDa81621667a552C); 
