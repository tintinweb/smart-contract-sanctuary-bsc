...
contract rrq is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RRQ";
    string private _symbol = "RRQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0239E88FAb923d7134f8c9de0E27a6F122A50C46); // Marketing Address
    address payable public teamWalletAddress = payable(0x0239E88FAb923d7134f8c9de0E27a6F122A50C46); // maxTxAmount
	address public OwnerAddress =0x65Bc16490544FBb1eFE7f7837f42063480310493;
    ...
    uint256 private _totalSupply = 1688 * 10**_decimals;
