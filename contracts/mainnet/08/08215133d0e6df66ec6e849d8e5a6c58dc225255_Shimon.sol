...
contract Shimon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SHIMON";
    string private constant _symbol = unicode"$SHIMON";
    ...
    address payable public DevWallet = payable(0x7643784c75697a357Eb952b9EBEAB4109C04E6fD);
    address payable public MarketingWallet = payable(0xDFE90d78c2EEfCDe295DEBEc3A572C4181c80a36);
