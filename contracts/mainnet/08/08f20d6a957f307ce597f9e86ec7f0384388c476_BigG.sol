...
TG: @TheBigGCoin
Twitter: twitter.com/TheBigGCoin
Website: www.thebiggcoin.com
...
contract BigG is Context, IERC20, Ownable {
    ...
    address public developmentWallet = 0xf7A1d890200c95CE419D6714D81f9e7eCc1B9e44;


    string private constant _name = "Big G";
    string private constant _symbol = "BIGG";
    ...
    Taxes public taxes = Taxes(5, 3, 1, 1);
    Taxes public sellTaxes = Taxes(5, 3, 1, 1);
