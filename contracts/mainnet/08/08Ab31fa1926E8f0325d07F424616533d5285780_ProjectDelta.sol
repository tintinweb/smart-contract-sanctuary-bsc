...
.s5SSSs.  .s5SSSs.  .s        .s5SSSSs. .s5SSSs.  
      SS.       SS.              SSS          SS. 
sS    S%S sS    `:; sS           S%S    sS    S%S 
SS    S%S SS        SS           S%S    SS    S%S 
SS    S%S SSSs.     SS           S%S    SSSs. S%S 
SS    S%S SS        SS           S%S    SS    S%S 
SS    `:; SS        SS           `:;    SS    `:; 
SS    ;,. SS    ;,. SS    ;,.    ;,.    SS    ;,. 
;;;;;;;:' `:;;;;;:' `:;;;;;:'    ;:'    :;    ;:' 
...
Project Delta, the complete WEB3 package, tying together NFTs, Play-to-Earn gaming and Cryptocurrency 
under a single community driven, safe and secure project.

TG: https://t.me/projdelta
...
contract ProjectDelta is Context, IERC20, Ownable {
    ...
    string private _name = "Project Delta";
