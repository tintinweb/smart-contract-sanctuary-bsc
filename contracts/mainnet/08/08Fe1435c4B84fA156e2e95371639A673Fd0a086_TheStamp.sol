...
contract TheStamp is Context, Ownable {
    ...
    uint256 private constant maxRewards = 1000 ether;
    ...
    function poolLastDeposit(address userAddress, uint256 amount) private {
        ...
        uint256 poolShare = amount.mul(100).div(dividerPercent);
    ...
    function contractInfo() view external returns(uint256 networkInvestors, uint256 networkDeposits, uint256 totalWithdrawnAmount, uint256 totalCompoundedAmount, uint256 networksCreated, uint256 contractBalance, uint256 launchTime) {
        return (totalInvestors, totalDeposited, totalWithdrawn, totalCompounded, totalNetworksCreated, token.balanceOf(address(this)), contractLaunchTime);
    }
