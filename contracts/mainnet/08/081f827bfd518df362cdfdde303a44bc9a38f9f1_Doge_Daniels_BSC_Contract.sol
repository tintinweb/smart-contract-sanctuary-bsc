...
contract Doge_Daniels_BSC_Contract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Doge Daniels BSC Contract";
    string constant _symbol = " DDBC ";
