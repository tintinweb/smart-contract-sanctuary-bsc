...
contract ANDYLAU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x46E85A0c687Ac494e75d262b6C51960BF2e85644); // Marketing Address
    address payable public teamWalletAddress = payable(0x46E85A0c687Ac494e75d262b6C51960BF2e85644); // Team Address
    ...
    uint256 private _totalSupply = 2300 * 10**_decimals;
    uint256 public _maxTxAmount = 2300 * 10**_decimals; 
    uint256 public _walletMax = 2300 * 10**_decimals;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x46E85A0c687Ac494e75d262b6C51960BF2e85644),
            block.timestamp
        );
    }
