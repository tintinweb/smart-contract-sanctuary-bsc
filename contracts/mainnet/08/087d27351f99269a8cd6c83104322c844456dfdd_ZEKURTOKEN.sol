...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7FC09adc01dc3fBA93bB97F6c07637a0bfa4a45c;
...
contract ZEKURTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x314c2A5e7B71b18a8CA57Ec2bbA94Dd3Dc0C85D8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZEKUR TOKEN";
    string private _symbol = "ZKRT";
