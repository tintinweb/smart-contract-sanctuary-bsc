...
contract HoneyBearsToken is ERC20 {
...
contract HoneyBears is HoneyBearsToken {
    uint256 public startTime = 1660930000; /*   Fri Aug 19 2022 17:26:40    */
    uint256 public MIN_INVEST_AMOUNT = 5 ether;
    uint256 public SELL_LIMIT = 40000 ether;
    uint256 public BUSD_DAILYPROFIT = 50;
    uint256 public TOKEN_DAILYPROFIT = 80;
    uint256 public ENABLE_AIRDROP = 1;
    uint256 public AIRDROP_VALUE = 100 ether;
    ...
    uint256[] private REF_BONUSES = [150, 120, 100];
    uint256 private constant MARKETING_FEE = 10;
    uint256 private constant LIMIT_AIRDROP = 100000 ether;
    uint256 private constant MANUAL_AIRDROP = 10000 ether;
    uint256 private constant MANUAL_AIRDROP_MARKETING = 10000 ether;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        MARKETING = 0x29f5b564ED56730ad5aEE64ad5195d6d415511C1;
        _mint(MARKETING, 80e3 ether);
        _mint(ADMIN, 30e3 ether);
        _mint(0x5fD7B836E7E031E878C17b1db466065f00372e36, 30e3 ether);
        _mint(0x4e1cfa8c6e0D4a681cDb362027c61E650D2aaAC0, 30e3 ether);
        _mint(0x9AfC202Bff8c60FDd8677b09299b66c379491055, 30e3 ether);
    }
    ...
    function stakeBUSD(address referrer, uint256 _amount) public payable {
        ...
        uint256 fee = _amount.mul(MARKETING_FEE).div(PERCENT_DIVIDER);
