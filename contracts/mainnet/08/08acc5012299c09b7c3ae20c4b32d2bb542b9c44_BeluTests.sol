...
contract BeluTests is ERC20, Ownable {
    ...
    Priceandliqaccounts public PriceandliqAccounts = Priceandliqaccounts({
        priceandliqaccount1: payable(address(_priceandliqAccount1)),
        priceandliqaccount2: payable(address(_priceandliqAccount2)),
        priceincrease: payable(address(_priceIncrease))
    });
