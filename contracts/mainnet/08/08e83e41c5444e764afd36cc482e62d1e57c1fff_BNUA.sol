...
contract BNUA  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNUA ";
    string private _symbol = "BNUA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa53AaF966470162C98dEcbfAB20573f1512CF4fa);
    address payable public teamWalletAddress = payable(0xa53AaF966470162C98dEcbfAB20573f1512CF4fa);
    address public immutable deadAddress = 0xa53AaF966470162C98dEcbfAB20573f1512CF4fa;
