...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe); //the reward token you want distributed 
...
contract Picasso is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xAD29AbB318791D579433D831ed122aFeAf29dcfe; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Picasso";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PICA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xDf0E24564ec0906dc320B2219CE9643dAF19C759;
        marketingFeeReceiver = 0x42E547b1a701EBe3F74833066D241395faB737fd;
