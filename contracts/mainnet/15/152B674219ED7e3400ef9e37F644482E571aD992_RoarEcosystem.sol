...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA4C9a6e602a10fB90e67B6b1678A12119Ef5Bef4; // owner address
...
contract RoarEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"ROAR Ecosystem";
    string private _symbol = unicode"$ROAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA4C9a6e602a10fB90e67B6b1678A12119Ef5Bef4); // Marketing Address
    address payable public teamWalletAddress = payable(0xA4C9a6e602a10fB90e67B6b1678A12119Ef5Bef4); // Team Address
