...
/**
   Token Name: DragonMusk Grow
   Token Supply: 1,000,000,000,000,000
   Max per Transaction: 5,000,000,000,000
   Burn: 500,000,000,000,000
   Liquidity Pool: 4 BNB
   
   Token features:
      10% taxFee
      5% for directly add to the LP
      5% for directly add to all diamond hands HOLDERS
...
contract DragonmuskGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dragonmusk Grow"; 
    string private constant _symbol = "DmuskGrow"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 15;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x11F5D8144b6b3DcBA3f530Bc47c9aD5EeE6e5711; 
