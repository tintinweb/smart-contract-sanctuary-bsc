...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD54e80b68fb89eFC79e35f2a6E8aDe91801858B2; // owner address
...
contract GreatWhiteInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Great White Inu";
    string private _symbol = "GREATWHITE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD54e80b68fb89eFC79e35f2a6E8aDe91801858B2); // Marketing Address
    address payable public teamWalletAddress = payable(0xD54e80b68fb89eFC79e35f2a6E8aDe91801858B2); // Team Address
