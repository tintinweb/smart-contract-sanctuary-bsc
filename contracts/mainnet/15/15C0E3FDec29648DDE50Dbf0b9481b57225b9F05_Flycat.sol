...
contract Flycat is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa59C49e18206937aDFd8E75D3F09b1756f988F29); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x7258720629359D1962Ed4C83C97e8c537909f7Cf); // Development Address
    ...
    uint256 private _totalSupply = 1 * 10**21 * 10**9;
    uint256 public _maxTxAmount = 100 * 10**18 * 10**9;
    uint256 public _walletMax = 100 * 10**18 * 10**9;
