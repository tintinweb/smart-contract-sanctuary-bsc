...
*/
// tg: t.me/santapoocoin
// Christmas Vibes with SantaPooCoin! Join Our Community on Telegram!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x791839c72C9946cEF07221E978b54F6f0F0bfFC1; // owner address
...
contract SantaPooCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaPooCoin";
    string private _symbol = "SPCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8EC2B31D25d7D6a89b0360022A77Ab508efB672F); // Marketing Address
    address payable public teamWalletAddress = payable(0x791839c72C9946cEF07221E978b54F6f0F0bfFC1); // Owner
    ...
    uint256 private _teamShare = 6; // original 12
