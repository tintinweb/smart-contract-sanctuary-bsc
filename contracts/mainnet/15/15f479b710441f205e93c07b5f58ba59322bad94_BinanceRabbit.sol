...
contract BinanceRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"🐰BINANCE RABBIT"; // 
    string private constant _symbol = unicode"BinanceRabbit";  //    
