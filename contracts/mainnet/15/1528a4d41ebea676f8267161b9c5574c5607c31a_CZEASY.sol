...
contract CZEASY is CZEASYDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CZEASYTeam;
    address private CharityCZEASY;
    ...
    string public override name = "CZEASY";
    string public override symbol = "CZEASY";
    ...
    constructor(uint totalSupplyValue, address CZEASYTeamAddress, address CharityCZEASYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CZEASYTeam = CZEASYTeamAddress;
        CharityCZEASY = CharityCZEASYAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CZEASYTeam] =  totalSupply * 4 / 100;
        balances[CharityCZEASY] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's CZEASYTeam pot
