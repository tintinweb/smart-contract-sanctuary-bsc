...
contract MoonXCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoonXCoin"; // 
    string private constant _symbol = "MXC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x974e41F350A7B64A27c6c99A8B8d4A5992Da8701;
