...
library Address{
 ...
 contract ApeCheems is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8000000000000 * 10**9;
    uint256 public maxBuyLimit = 50000000000000 * 10**9;
    uint256 public maxSellLimit = 40000000000000 * 10**9;
    uint256 public maxWalletLimit = 50000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x395c86C8671D029FFA38a4F45A0FF24e685e4A6D;
    address public donationWallet = 0xeB6BcE5995764dF71dDF01a834a26fA7e7e92822; 

    string private constant _name = "APECHEEMS";
    ...
    Taxes public taxes = Taxes(1, 4, 2, 5);
    Taxes public sellTaxes = Taxes(1, 8, 2, 5);
