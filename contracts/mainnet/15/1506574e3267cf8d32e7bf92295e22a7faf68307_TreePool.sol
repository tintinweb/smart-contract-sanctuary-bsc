...
contract TreePool is TokenRecover {
    ...
    IBEP20 stakeToken;
    uint256 public feeInBNBPerStakedToken;
    ...
    constructor(
        ...
        uint256 _feeInBNBPerStakedToken
    ) public { 
        ...
        feeInBNBPerStakedToken = _feeInBNBPerStakedToken;
    ...
    function deposit(uint256 _amount) public payable {
        ...
        uint256 _stakingFee = (_amount * feeInBNBPerStakedToken) / (10**uint256(stakeToken.decimals()));
        
        // Transfer fees to the owner
        payable(owner()).transfer(_stakingFee);
