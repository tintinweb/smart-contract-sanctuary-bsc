...
contract MergeFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "MergeFloki";
    string private constant _symbol = "MERFLOKI";
    ...
    uint256 public swapTokenAtAmount = 9_000_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver;
    address public marketingWallet = address(0xb7D3e11c1d394Cf59E9579692466F0C2db850a24);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 2100 && !phaseOne) {
            phaseOne = true;
            burnSniper();
        }
