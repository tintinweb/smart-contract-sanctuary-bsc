...
Telegram : https://t.me/solananomadgrowbsc
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6941d038160219CF0b74bB967Acb349036754d4E;
...
contract Solana is Context, IERC20, Ownable {
    ...
    string private constant _name = "SOLANA NOMAD GROW"; // 
    string private constant _symbol = "$SNOMAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x6941d038160219CF0b74bB967Acb349036754d4E);
