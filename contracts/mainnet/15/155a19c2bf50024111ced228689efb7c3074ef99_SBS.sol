...
contract SBS is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xeC07bf6f9fE849f4Bf2cfA56a66f050cdef7967b;
    address public devWallet = 0x761dB4b90773493BA12294e29690236dCF4366D5;
    address public buybackWallet = 0x967024f1838b50f804a7236FF1aa5C7007Ce2A9a;
    ...
    Taxes public taxes = Taxes(0, 4, 3, 0, 0);
    Taxes public sellTaxes = Taxes(0, 4, 3, 0, 14);
