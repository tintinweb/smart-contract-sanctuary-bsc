...
contract Token is Context, IERC20 { 
    ...
    uint256 public _maxBuy = _tTotal * 1 / 100;
    uint256 public _maxSell = _tTotal * 1 / 100;
    uint256 public _maxWalletToken = _tTotal * 1 / 100;

    uint256 public _swapTrigger = 5;
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 100;

    address payable public DevWallet = payable(0xe97B061B644FC4D13e21D8086A3Eb6228Ff83f6C);
    address payable public MarketingWallet = payable(0x2b3234B947625f2cccEd71198a28369cA6e5000F);
