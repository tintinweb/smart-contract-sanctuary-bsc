...
contract MetastepN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta StepN";
    string private _symbol = "STEPN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9f703210e0f243577d2716b3667E4c9F6f5EE4Da); // Marketing Address
