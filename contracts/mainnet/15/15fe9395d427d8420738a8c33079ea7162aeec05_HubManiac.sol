...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd97d0Cb12a9cA7f394c54829ef2DC71361B42a8b;
...
contract HubManiac is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD382e6A322Bf968b0cea4447594F04279cBFD9Be;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 700000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HubManiac";
    string private _symbol = "Hubi";
