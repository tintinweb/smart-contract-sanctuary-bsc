...
contract TwilloweenInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 600000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7 * 10**9; //
    string private constant _name = "Twilloween Inu"; // 
    string private constant _symbol = "TWEEN Inu"; //    
    uint8 private constant _decimals = 9; // 
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3B6fed0505c9aaFd3c56e86359FDF807A610A1e8;
    ...
    function setLiqua(uint256 liqui, uint256 marke) public onlyOwner {
        _liquidityFee = liqui;
        _marketingFee = marke;
    }
