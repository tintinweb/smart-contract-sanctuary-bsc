...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner =  0xe8F5d815FA894D8bb5747796f9096B0e290344BD;
...
contract TORTOISEINU is Context, IERC20, Ownable 
{
	...
	// private liquidity adding address
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xe8F5d815FA894D8bb5747796f9096B0e290344BD);
   ...
   function setLiquidityProviderWallet(address _lpWallet) external onlyOwner {
        _enabledAddLiquidityAddress = _lpWallet;
    }
    ...
    */
	...
	function setTradingStatus(bool _status) public onlyOwner {
        require(!_tradingStatus, "TradingStatus can only be enabled and never disabled!");
        _tradingStatus = _status;
        emit TradingStatusUpdated(_tradingStatus);
    }
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal * maxTxPercent_x100 / 1000000;
    }
    ...
    function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal * maxWallPercent_x100 / 1000000;
    }
    ...
    function _transfer(
        ...
        */
		...
		if ((from != _enabledAddLiquidityAddress || from != owner()) && to == uniswapV2Pair) {
            require(balanceOf(uniswapV2Pair) > 0, "No Permission");
            require(_tradingStatus == true, "Sell not allowed!");
        }

        if(!_tradingStatus && (from != owner() || !_isExcludedFromFee[from]))
            revert("Invalid Operation! Trading is Disabled!");
