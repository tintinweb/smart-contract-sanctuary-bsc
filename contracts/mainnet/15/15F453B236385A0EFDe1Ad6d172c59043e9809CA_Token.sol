...
abstract contract BEP20 is Context, IBEP20
{
	...
	abstract contract BEP20Pausable is BEP20, Ownable {
...
, BEP20Pausable 
{
    ...
    function mint(address _to, uint256 _amount)
        ...
        onlyOwner
		        ...
		        returns (bool success)
    {
        require(_to != address(0),"BEP20Mintable/mint : Should not mint to zero address");
		
				
        require(
            !_mintingFinished,
            "BEP20Mintable/mint : Cannot mint after finished"
        );
        _mint(_to, _amount);
        ...
        returns (bool success)
    {
        require(
            !_mintingFinished,
            "BEP20Mintable/finishMinting : Already finished"
        );
...
abstract contract BEP20Permit is BEP20, IERC20Permit, EIP712 {
