...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x26759CcA96b30417A962D2a6E2180F8DcEe73528;
...
contract GHOST is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xec3DC981D116c1c7028c94104422150c97C67024;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GHOST";
    string private _symbol = "GHST";
