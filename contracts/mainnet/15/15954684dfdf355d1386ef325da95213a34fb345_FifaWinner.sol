...
1 BNB Liquidity Pool
Welcome to FifaWinner, a new football token where you can bet and win money off football games.⚽️ 🚀

Our Huge dapp is in the final stages of testing and Will be relased very soon.🖥👾

Join us and Win amazing rewards, only by holding and guess the 3 right results in daily FIFA Matches.💰🤑
Dont miss this moonshot,
5% Tax is going directly to BETTING POOL!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E); 
...
contract FifaWinner is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FifaWinner";
    string constant _symbol = "$FiWi";
    ...
    constructor () Auth(msg.sender) {
		...
		marketingWallet = 0xd4537182AA6a56FF95DC0a4dc3B3fff68Bb60E61;
        anothermarketingWallet = 0xA9D72514CFa5cA20ed9A78e75111Ea72BfEC65DB;
