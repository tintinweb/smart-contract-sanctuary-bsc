...
contract BabySincereDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Baby SincereDoge";
    string private _symbol = "BabySDoge";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd86B7418e936A069126f51229b5DB9b9e98C9103;
    ...
    function transferToken(address tokenAddress, uint256 tokens, address payable _recipient)
      public
      authorized
      returns (bool success)
    {
      return IBEP20(tokenAddress).transfer(_recipient, tokens);
    }

    function transferBNB(address payable _recipient) public authorized {
