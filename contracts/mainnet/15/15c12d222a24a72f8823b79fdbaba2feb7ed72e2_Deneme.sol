...
contract Deneme is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    DenemeDividendTracker public dividendTracker;
    ...
    uint256 public swapTokensAtAmount = 290000 * (10**18); 
    ...
    address payable public _marketingWalletAddress = payable(0xb71962366d66f8ddadf868681Ae1013b1F627B17);
    ...
    constructor() BEP20("Deneme", "DNM") 
    {
        dividendTracker = new DenemeDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "Deneme: The dividend tracker already has that address");
        DenemeDividendTracker newDividendTracker = DenemeDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "Deneme: The new dividend tracker must be owned by the Deneme token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Deneme: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Deneme: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Deneme: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Deneme: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Deneme: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Deneme: Cannot update gasForProcessing to same value");
...
contract DenemeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Deneme_Dividend_Tracker", "Deneme_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "Deneme_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "Deneme_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Deneme contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Deneme_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Deneme_Dividend_Tracker: Cannot update claimWait to same value");
