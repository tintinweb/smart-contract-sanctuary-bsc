...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd95Eda70f614025047C2d1128B2126D4Af65e59b; 
...
contract Osmox2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OsmoX2";
    string private _symbol = "$X2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4bA700b18BBF183F551E3B506730B41Fc98aEAe1); 
    address payable public teamWalletAddress = payable(0xd95Eda70f614025047C2d1128B2126D4Af65e59b); 
    ...
    uint256 public _marketingShare = 133;
    ...
    uint256 public _maxTxAmount = 7250000000 * 10**_decimals; 
    uint256 public _walletMax = 7250000000 * 10**_decimals;
