...
contract KOOS is Context, IERC20, Ownable {
    ...
    address public  deadAddress = 0xba9009BbF0b8a8bE728e0F66af8bb26e6f52E7b6;
    ...
    uint256 internal _liquidityShare = 2;
    uint256 internal _marketingShare = 3;
    uint256 internal _teamShare = 0;

    uint256 public _total =3;
    uint256 internal _totalDistributionShares = 3;
