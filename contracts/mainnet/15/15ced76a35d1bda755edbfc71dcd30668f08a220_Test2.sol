...
contract Test2 is IBEP20, Ownable {
    ...
    address WDOGE = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Fees receivers
    address public autoLiquidityReceiver = 0x9D5652804cD8B1E75691Ea82D2a12dD1436C3590;
    address public marketingFeeReceiver = 0x543a6482bCDAcC2E261771Ef2Fe5E321b3656121;
    address public devFeeReceiver = 0x543a6482bCDAcC2E261771Ef2Fe5E321b3656121;
    address public buybackFeeReceiver = 0x543a6482bCDAcC2E261771Ef2Fe5E321b3656121;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(marketingFeeReceiver).call{value: amountDOGEMarketing, gas: 300000}("");
        require(MarketingSuccess, "receiver rejected WDOGE transfer");
        (bool buybackSuccess,) = payable(buybackFeeReceiver).call{value: amountDOGEbuyback, gas: 300000}("");
        require(buybackSuccess, "receiver rejected WDOGE transfer");
        (bool devSuccess,) = payable(devFeeReceiver).call{value: amountDOGEDev, gas: 300000}("");
