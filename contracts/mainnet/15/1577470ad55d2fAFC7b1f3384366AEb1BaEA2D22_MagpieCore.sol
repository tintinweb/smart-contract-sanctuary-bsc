    ...
    IMagpieCore
{
        ...
        returns (uint256[] memory amountOuts)
    {
        ...
        uint256 amountIn = payload.bridgeType == IMagpieBridge.BridgeType.Wormhole
            ...
            : deposits[payload.senderNetworkId][payload.senderAddress][coreSequence][payload.fromAssetAddress];
