...
contract Imhotep {
	...
	address erctoken = 0xeC983fd304640FfC69AeCac3C32D57dA5c937257; 
    ...
    uint256 public LOTTERY_TICKET_PRICE = 3 ether; /** 3 IMTP **/
    ...
    uint256 public MIN_INVEST = 10 ether; /** 10 IMTP  **/
	uint256 public WITHDRAW_COOLDOWN = 12 * 60 * 60; /** 12 hours  **/
    uint256 public WITHDRAW_LIMIT = 6000 ether; /** 6000 IMTP  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 30000 ether; /** 30,000 IMTP  **/
    ...
    function buyFactories(address ref, uint256 amount) public payable{
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                /** referral rewards will be in IMTP **/
                ...
                /** referral rewards will be in IMTP value **/
