...
contract TrickorTreatBNB is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "Trick or Treat BNB";
    string constant _symbol = "TOTBNB";
    ...
    uint256 public marketingFeeSell = 90;
    ...
    address public marketingWallet = 0x0aAad0ab5C05e9Ba7E09789CAA3Cc50b8Eeeebb2;
    address private teamWallet = 0x553966cBc48689b3a9a89F3B54A3a57C48D30253;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newteamFee) external authorized {
        ...
        require(newMarketingFee <= 90, "Marketing Tax on buys can not be higher than 90%");
