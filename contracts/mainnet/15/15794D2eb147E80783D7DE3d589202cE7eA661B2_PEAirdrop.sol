...
contract PEAirdrop is ReentrancyGuard, Ownable, Pausable {
    address public AIRDROP_TOKEN = 0x76b5ea2A75E96f629d739537e152062B4B89eeE9; // PEXO
    address public PE_AIRDROP_SERVICE = 0x2A3EAf3567254dF74ECb38F8355ed7E1D0F810d1;

    uint256 public POOL_TYPE = 1;

    uint256 public CLAIMED_AIRDROP_BEGIN_AT = 1657584000;
    uint256 public CLAIMED_AIRDROP_END_AT = 1657756800;
    ...
    function setAirdropToken(address _contract) external onlyAdmins {
        AIRDROP_TOKEN = _contract;
    }

    function setPEAirdropService(address _contract) external onlyAdmins {
