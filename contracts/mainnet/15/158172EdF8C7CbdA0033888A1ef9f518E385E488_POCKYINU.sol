...
contract POCKYINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc9157E2A6361f52e5CA0fC7d1d3df407dE7d0cd3); 
    address payable public Wallet_Dev = payable(0xc9157E2A6361f52e5CA0fC7d1d3df407dE7d0cd3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    string private constant _name = "POCKY INU"; 
    string private constant _symbol = unicode"POCKY INU"; 
    ...
    constructor () {
        ...
        _owner = 0xc9157E2A6361f52e5CA0fC7d1d3df407dE7d0cd3;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (to != owner() && to != address(this) && to != uniswapV2Pair && from != owner()){
