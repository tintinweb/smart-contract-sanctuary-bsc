...
contract MoonKitty20 is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"MK2";
    ...
    address private marketingWallet = 0x01eDb0Df591625eEa12c23746FDfd24449826Cd9;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 7, 2, 0);
    Fees public sellFees    = Fees(1, 7, 2, 0);
