...
/*
 Welcome to SquidVenom !
 SquidVenom is here to takeover the crypto space and become the leader by surpassing all other
 Squidgame projects

 Finally after all these rugs and farms on BSC in the name of Squidgame hype
 SquidVenom is here to prove whos the realking!
 SquidVenom will take the crown by surpassing and eliminating all those other fake Squidgame projects
 ...
 MAX TRANSACTION - 5.000.000
 MAX WALLET - 20.000.000
 
 Find us on TG: https://t.me/squidVenomOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c3ce45aBDc943F517332beA91660D3dE8C52d8d; // owner address
...
contract SquidVenom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidVenom";
    string private _symbol = "$SVENOM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA420E64FFF7118E4331F0Eb1C660DC7a6c01Ca05); // Marketing Address
