...
contract GENStaking {
    ...
    uint256[3] public Duration = [7 days, 14 days, 30 days];
    uint256[3] public Bonus = [80, 400, 3000];
    ...
    constructor() {
        owner = payable(0x5D5f0c3e15dD763774Ed285f669Adc7ee3567eeD);
        stakeToken = IERC20(0xC52d731EaD9fbE213037d6D0E9126B44Dc995cb7);
        unstakePercent = 1500;
