...
contract MetaBabyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaBabyDoge";
    string private _symbol = "MetaBabyDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xca4e4A505c4dC5920706910a1648888D8ABE83f8); 
    address payable private teamWalletAddress = payable(0xB68aa6cE3BE605609a55592A8e588065028A1D7C); 
