...
contract GME is Context, IERC20, Ownable {
    ...
    string private _name = "GME";
    string private _symbol = "GME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB49fAbea438DFa4f017510549AA7D947431e20f7);
    address payable public teamWalletAddress = payable(0xB49fAbea438DFa4f017510549AA7D947431e20f7);
