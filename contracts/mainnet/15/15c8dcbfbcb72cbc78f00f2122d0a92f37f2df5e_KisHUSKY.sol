...
/**
Https://t.me/kishusky
Https://twitter.com/huskishu
Https://www.kishusky.com
*/
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
...
contract KisHUSKY is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   KisHUSKYDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("KisHUSKY", "KisHUSKY") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 3;
		_buyMarketingFee = 3;
        _buyDevFee = 2;
    	...
    	dividendTracker = new KisHUSKYDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x64f38A6A56b0F1E8a0f2148357749cf8A9539fCB);
        _devWallet = payable(0x6136a075f9Aeb47645C7f67854f0ed73B767d148);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "KisHUSKY: The dividend tracker already has that address");

        KisHUSKYDividendTracker newDividendTracker = KisHUSKYDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "KisHUSKY: The new dividend tracker must be owned by the KisHUSKY token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "KisHUSKY: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "KisHUSKY: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "KisHUSKY: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "KisHUSKY: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "KisHUSKY: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "KisHUSKY: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "KisHUSKY: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "KisHUSKY: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "KisHUSKY: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "KisHUSKY: Cannot update gasForProcessing to same value");
...
contract KisHUSKYDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("KisHUSKY_Dividend_Tracker", "KisHUSKY_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "KisHUSKY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main KisHUSKY contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "KisHUSKY_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "KisHUSKY_Dividend_Tracker: Cannot update claimWait to same value");
