...
Telegram : https://t.me/DejitaruTsukaexclamation3x
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5229228e09C4cd52c0Ef8C9d4833485beA64501b;
...
contract DEJITARUTSUKA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$DTSUKA!!!"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x5229228e09C4cd52c0Ef8C9d4833485beA64501b);
