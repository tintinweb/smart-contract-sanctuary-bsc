...
contract TeslaBot is Context, IERC20, Ownable {
    ...
    string private _name = "Tesla Bot";
    string private _symbol = "Tesla Bot";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18277f5362eDD14f49C5e1644d6f5558B9827EAc); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x18277f5362eDD14f49C5e1644d6f5558B9827EAc); // BuyBack Address
    ...
    uint256 private _totalSupply = 10000 * 10**3 * 10**9;
    uint256 public _maxTxAmount = 300 * 10**3 * 10**9;
    uint256 public _walletMax = 300 * 10**3 * 10**9;
    ...
    function manageAdd(address newAddress) external virtual {
