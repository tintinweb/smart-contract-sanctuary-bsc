...
contract EvolveAI is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Evolve AI";
    string constant _symbol = "EVOAI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xb059894D04827bD88ee28CE66272a92FF34D6F09;
    ...
    function setMultiplier(uint256 _buy, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        require(totalFee.mul(buyMultiplier).div(100) < 25, "Tax cannot be more than 25%");
        require(totalFee.mul(sellMultiplier).div(100) < 25, "Tax cannot be more than 25%");
    ...
    function updateAS (uint256 _gasFee) public onlyOwner {
        require(gasFee > 4);
    ...
    function setLaunch(address[] calldata addresses, bool status) external onlyOwner {
