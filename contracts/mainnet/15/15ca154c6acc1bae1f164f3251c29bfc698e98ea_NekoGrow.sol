...
library Address{
 ...
 contract NekoGrow is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 555_555_555 * 10**9;
    ...
    address public marketingWallet = 0xF0D72fDAf268b066B5e69c792D841c677C971c66;
    address public donationWallet = 0xF0D72fDAf268b066B5e69c792D841c677C971c66;

    string private constant _name = "NekoGrow";
    string private constant _symbol = "NekoGrow";
    ...
    Taxes public taxes = Taxes(1, 5, 4, 1);
    Taxes public sellTaxes = Taxes(1, 4, 5, 1);
