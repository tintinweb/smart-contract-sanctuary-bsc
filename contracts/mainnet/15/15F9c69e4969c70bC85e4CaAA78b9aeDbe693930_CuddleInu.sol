...
contract CuddleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cuddle Inu";
    string constant _symbol = "CuddI";
    ...
    address public MarketingFeeReceiver =
        0x59621BD749b0378032E0D421328151cE0A587ba2;
    ...
    constructor() Auth(address(0x59621BD749b0378032E0D421328151cE0A587ba2)) {
        ...
        isFeeExempt[address(0x59621BD749b0378032E0D421328151cE0A587ba2)] = true;
        isTxLimitExempt[address(0x59621BD749b0378032E0D421328151cE0A587ba2)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0x59621BD749b0378032E0D421328151cE0A587ba2);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0x59621BD749b0378032E0D421328151cE0A587ba2)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0x59621BD749b0378032E0D421328151cE0A587ba2)] = _totalSupply;
        emit Transfer(address(0), address(0x59621BD749b0378032E0D421328151cE0A587ba2), _totalSupply);
    }
