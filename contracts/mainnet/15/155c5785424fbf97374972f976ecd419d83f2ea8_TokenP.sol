...
contract TokenP is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000e18;
    ...
    string private constant _name = "TokenP";
    string private constant _symbol = "TKP";
    uint8 private constant _decimals = 18;
    
    address payable private _developmentAddress = payable(0xa29B124FCa92178FA601a22cBa39201e2beD0B53);
    address payable private _marketingAddress = payable(0xa29B124FCa92178FA601a22cBa39201e2beD0B53);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 11, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 11, "Tax cannot be more than 6.");
