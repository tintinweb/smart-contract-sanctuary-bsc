...
abstract contract Auth {
 ...
 contract DODOCEO is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "DODO CEO ";
    string constant _symbol = "DOCEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x8fe4C5da15c2fcA3e7a58a5BD2919437d57fDAfd; // liquidity
