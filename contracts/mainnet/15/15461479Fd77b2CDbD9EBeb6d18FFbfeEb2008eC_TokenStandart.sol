...
contract TokenStandart  is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x359cE5f6bebd4DF81D1f68E5857E9C1e529A4b16);
    address payable private  constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 120 * 10**6 * 10**_decimals;
    string private constant _name = "Medal Finance"; 
    string private constant _symbol = unicode"MDFI"; 
    ...
    function claimStuckTokens(address token, uint256 value) external onlyOwner {
        ...
        ERC20token.transfer(Wallet_Marketing, value);
    }
