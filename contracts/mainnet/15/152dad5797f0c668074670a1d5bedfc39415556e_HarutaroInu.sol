...
/**
    Telegram: https://t.me/HarutaroInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA61BaeF908064FF8e2D6Bf5ffCe5BAfB043a5313; // owner address
...
contract HarutaroInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Harutaro Inu";
    string private _symbol = "HINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA61BaeF908064FF8e2D6Bf5ffCe5BAfB043a5313); // Marketing Address
    address payable public teamWalletAddress = payable(0xA61BaeF908064FF8e2D6Bf5ffCe5BAfB043a5313); // Team Address
