...
contract BeeGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "BeeGrow"; // 
    string private constant _symbol = "BeeGrow"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0a0ee51C484c76200eC4Eedb4bee3A686BBFdbb4;
