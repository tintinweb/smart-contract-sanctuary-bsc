...
Telegram https://t.me/kyranetwork
Website https://kyra.network
...
contract KyraNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KYRA NETWORK";
    string private _symbol = "KYRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2093D74d39B39f06F92eB8907cb8B5309333c0e3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xff58a49379C8aB7b17Fca7ad455bd12F6c52852F); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (2 * 10**5 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
