...
contract SUC is ERC20 {
	...
	address public WHT = address(0x947ff74C844320df898642f9DCf56F2096e4B042);  
	address public ROUTER = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    constructor(address tokenOwner) ERC20("CCS", "CCS") { 
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			ldxAmount = ldxAmount.add(amount.div(100).mul(1));
