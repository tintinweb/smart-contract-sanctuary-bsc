...
contract KETAMIN is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private constant _name = "Ketaminlagi";
    string private constant _symbol = "2/3KEM";
    uint8 private constant _decimals = 9;

    address payable private _devAddress =
        payable(0x99943CceE901789BFAFa8F86a8179049d5121F47);
    address payable private _marketingAddress =
        payable(0x6C4AF2693B01C6F3f20C97dA6e304e3783DCdfe3);
    address payable private _charityWallet =
        payable(0x73d7630b2F1c002bB2F5C723552f1A0711Fe2781);
    ...
    function setFee(
        ...
        require(redisFeeOnBuy < 11, "Redis cannot be more than 15");
        require(redisFeeOnSell < 11, "Redis cannot be more than 15");
        require(taxFeeOnBuy < 11, "Tax cannot be more than 15");
        require(taxFeeOnSell < 11, "Tax cannot be more than 15");
