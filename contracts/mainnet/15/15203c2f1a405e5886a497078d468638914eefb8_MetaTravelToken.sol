...
contract MetaTravelToken is ERC20Capped, Orchestrated {
	using SafeMath for uint256;

	uint public marketFee = 100;
	uint public burnFee = 200;

	address public marketFeeWallet = address(0x7143E6367c6504Fd501afd2196272cA08Ff508D5);
	...
	constructor() ERC20Capped(1300000000 * 1e18) ERC20("Meta Travel", "MT") {
		ERC20._mint(msg.sender, 1300000000 * 1e18);
