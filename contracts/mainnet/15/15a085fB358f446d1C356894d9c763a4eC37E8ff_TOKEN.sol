...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = wsdgj * usdtDecimals;
        holderCondition = wsdgj * tokenDecimals;
        _limitAmount = 3 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell && !inSwap) {
                ...
                uint256 numToSell = swapAmount * 900 / 100;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x10154ddDBB1555fE70476Ce40665dFC70DF742C1),
    
        address(0xe446c6FBaa8eaFD5204a4A82355482992b53157D)
    ){
