...
/**
    ...
    Has become one of the most loved currency of all time and is probably the most famous country
    Bringing in all kinds of people

    If you fans of United States, dont miss $USD!
...
contract USD is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x046503145CC117C5505D70DD9D29e5754580e0A2);
    address payable public DevelopmentWalletAddress = payable(0x046503145CC117C5505D70DD9D29e5754580e0A2);
