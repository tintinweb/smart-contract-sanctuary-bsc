...
contract METAPOOL is ERC20, ERC20Burnable, Ownable {
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require(amount > 0, "METAPOOL: Amount too low");
        _mint(to, amount);
    }
    ...
    function tokenSaleSecondRound(uint256 amount) external {
        require(amount > 0, "METAPOOL: Amount too low");
        require(busdRaisedSecond < secondRoundCap, "METAPOOL: Round ended or not yet started");
        uint256 allowance = busd.allowance(msg.sender, address(this));
        require(allowance >= amount, "METAPOOL: You should approve BUSD spending first");
