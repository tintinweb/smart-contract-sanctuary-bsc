...
contract TESTMAIN is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x16AA451f1644fC258f20fe9CCd58a0928b73DC6C;
    address public devFeeReceiver = 0x215a85163c71BcB6e01089A150eB0508501BfdfF;

    string constant _name = "TESTMAIN";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBlacklisted[sender], "Bot Address");
    ...
    function manageBlacklist(address Address, bool status) external onlyOwner {
        isBlacklisted[Address] = status;
    }

   function addBlacklist(address[] memory Address) public onlyOwner {
        for (uint256 i = 0; i < Address.length; i++) {
            isBlacklisted[Address[i]] = true;
        }
    }
    ...
    function setFeeReceivers(address _marketingFeeReceiver,address _autoliquidityreceiver,address _devFeeReceiver) external onlyOwner {
