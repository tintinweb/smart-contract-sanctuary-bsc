...
contract ABORTION is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "ABORTION";       //Full name
    string public symbol_ = "ABORTION";      //abbreviation
    ...
    uint256 public maxburn = 98000000000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0xD637607438f069Cb8D7237bb82335e5018691882;  //Marketing address
    address private foundationWalletAddress = 0x000000000000000000000000000000000000dEaD;  //Buyback Guard
    address private liquidityReceiveAddress = 0x3e7AEd8209C5aB720d1A463d4EfD2aF6bc2B8788;   // burn
    ...
    constructor(
        ...
        uint256 totalSupply = 100000000000 * (10**18);       //Supply
