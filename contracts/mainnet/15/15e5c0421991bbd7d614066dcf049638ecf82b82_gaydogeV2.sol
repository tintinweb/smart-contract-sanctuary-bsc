...
/* Token contract */
contract gaydogeV2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB6920aA3672aAFf900CA2d25352D996824dffE7E;
    ...
    // Name and symbol
    string constant _name = "GAYDOGEV2";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 1,5%
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; // 1,5%
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 3%
