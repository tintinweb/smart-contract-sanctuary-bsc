...
contract RoyalShibInuTest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Royal Shib Inu Test";
    string private _symbol = "RYSIT";
    ...
    uint256 private minimumTokensBeforeSwap = 0; // _totalSupply * 1 / 10000000;
