...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8965426bce987c9600b6A7F06FC44483F72fD88C; // owner address
...
contract CATS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8965426bce987c9600b6A7F06FC44483F72fD88C); // Marketing Address
    address payable public teamWalletAddress = payable(0x8965426bce987c9600b6A7F06FC44483F72fD88C); // Team Address
