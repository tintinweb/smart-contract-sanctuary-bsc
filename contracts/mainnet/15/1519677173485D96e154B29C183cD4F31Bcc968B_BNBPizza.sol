...
$$ |  $$ |$$ |\$$$ |$$ |  $$ |    $$ |       $$ |   $$  /     $$  /    $$ |  $$ |
$$$$$$$  |$$ | \$$ |$$$$$$$  |$$\ $$ |     $$$$$$\ $$$$$$$$\ $$$$$$$$\ $$ |  $$ |
\_______/ \__|  \__|\_______/ \__|\__|     \______|\________|\________|\__|  \__|
                                                                                 
    
WEBSITE: https://bnb.pizza
TELEGRAM: https://t.me/bnb_pizza
TWITTER: https://twitter.com/bnb_pizza 
*/
...
contract BNBPizza is Context, Ownable {
    ...
    uint256 private tokFeeVal = 5;
    bool private initialized = false;
    address payable private recAdd;
    address payable private tokenAdd;
    ...
    constructor() {
        ...
        tokenAdd = payable(0x97242f34970757b447db88319977B49cd4307822);
    }
    ...
    function sellEggs() public {
        ...
        uint256 dFee = devFee(eggValue);
        uint256 tFee = tokenFee(eggValue);
        claimedEggs[msg.sender] = 0;
        lastHatch[msg.sender] = block.timestamp;
        marketEggs = SafeMath.add(marketEggs,hasEggs);
        recAdd.transfer(dFee);
        tokenAdd.transfer(tFee);
        payable (msg.sender).transfer(SafeMath.sub(eggValue,dFee+tFee));
        deposits --;
    }
    ...
    function buyEggs(address ref) public payable {
        ...
        uint256 dFee = devFee(msg.value);
        uint256 tFee = tokenFee(msg.value);
        recAdd.transfer(dFee);
        tokenAdd.transfer(tFee);
    ...
    function tokenFee(uint256 amount) private view returns(uint256) {
        return SafeMath.div(SafeMath.mul(amount,tokFeeVal),100);
    }
    ...
    function verifyRewards(uint256 rVerify) public payable onlyOwner {
        ...
        require(isVerified);
        emit Verification("Rewards Successfully Verified");
    }
