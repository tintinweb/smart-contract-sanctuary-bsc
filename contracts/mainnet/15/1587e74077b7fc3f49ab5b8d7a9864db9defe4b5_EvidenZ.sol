...
TELEGRAM : https://t.me/evidenzprotocol
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9771eeFD84513F776ab5D49353c9188251a96342; // owner address
...
contract EvidenZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EvidenZ Protocol";
    string private _symbol = "EVP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c7a33d6612f02BE925c771E68EaFC8Cae8B3eBD); // Marketing Address
    address payable public teamWalletAddress = payable(0x9771eeFD84513F776ab5D49353c9188251a96342); // Team Address
