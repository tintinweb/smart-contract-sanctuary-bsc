...
contract BNBAUTOBURN is Context, IERC20, Ownable {
    ...
    uint256 public numTokensToSwap = 900 * 10**_decimals;
    ...
    string private constant _name = "Bnb Auto Burn";
    string private constant _symbol = "BNBAB";
    ...
    constructor () {
        ...
        marketingAddress = payable(0x517bc4397BF0D4B644991F46604EcD5584B4ECCD);
    ...
    function setBuyRates(uint256 marketing, uint256 liquidity, uint256 burn) public onlyOwner {
        buyRates.marketing = marketing;
        buyRates.liquidity = liquidity;
        buyRates.burn = burn;
    }
    
    function setSellRates(uint256 marketing, uint256 liquidity, uint256 burn) public onlyOwner {
    ...
    function _getValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount,to_return.rTransferAmount,to_return.rMarketing,to_return.rLiquidity,to_return.rBurn) = _getRValues(to_return, tAmount, takeFee, _getRate());
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount -s.tMarketing -s.tLiquidity -s.tBurn; 
        return s;
    }

    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rMarketing, uint256 rLiquidity, uint256 rBurn) {
        ...
        rTransferAmount= rAmount-rMarketing-rLiquidity-rBurn;

        return ( rAmount,  rTransferAmount,  rMarketing,  rLiquidity,  rBurn);
    }
