...
contract ChiHuaHuaZilla
 is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x77E5D16020153a380fDFEa41A088bBfD2b92af65));
        _secondWallet = payable(address(0x77E5D16020153a380fDFEa41A088bBfD2b92af65));

        _bbq[_msgSender()] = _totalSupply;
...
= intint;}receive() external payable {}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            _bbq[sender] = _bbq[sender].sub(amount);
            ...
            _bbq[recipient] = _bbq[recipient].add(finalAmount);
...
_secondWallet)
{
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _bbq[sender] = _bbq[sender].sub(amount, "Insufficient Balance");
        _bbq[recipient] = _bbq[recipient].add(amount);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {
            _bbq[address(this)] = _bbq[address(this)].add(feeAmount);
