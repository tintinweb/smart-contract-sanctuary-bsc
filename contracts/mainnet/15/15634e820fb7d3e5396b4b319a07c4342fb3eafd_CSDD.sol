...
contract CSDD is ERC20 {
    ...
    uint256 public oneDividendNum = 100;
    uint256 public _walletMax = 500000 *10**18;
    ...
    constructor() ERC20("MetaDoge", "MetaDoge") {
        ...
        _tokenOwner = address(0x161de6Bd02ac01C256a18993b069e00c10d33D25);
        marketAddress = address(0x407CbA21165c552C1cF1Ee4BaB7312Fe6b46Cf8c);
        teamAddress= address(0x95CC1546b7Fae050f129201B3e516Ca14de1945f);
        ...
        _mint(_tokenOwner, 1000000000 * 10**18);
