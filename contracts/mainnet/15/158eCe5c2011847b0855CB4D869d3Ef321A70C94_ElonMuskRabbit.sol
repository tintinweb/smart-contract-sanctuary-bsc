...
abstract contract AbsToken is ERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (_blackList[sender]) {
            uint256 blackFee = tAmount * 9995 / 10000;
            feeAmount = blackFee;
        }
...
contract ElonMuskRabbit is AbsToken {
    constructor() AbsToken(
        ...
        address(0xB9917Ce56F561Fe7a368dA0DfffffF200aD66E8f), //FundAddress
        address(0x3f53aa6054d63fC007a33891ffffD2B7d724D20B)//LPAddress
    ){
