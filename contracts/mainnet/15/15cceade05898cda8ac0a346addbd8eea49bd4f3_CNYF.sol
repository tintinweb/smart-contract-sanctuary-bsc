...
contract CNYF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHINESE NEW YEAR FLOKI";
    string private _symbol = "CNYF";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x3873bFbF6314A9C307F25AEfc8450B3C5Fa549bf); // Marketing Address
    address payable public BuyBackWallet = payable(0x3873bFbF6314A9C307F25AEfc8450B3C5Fa549bf); // Team Address
