...
contract SPACBAODoge is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "SPACBAODoge";
  string private _symbol = "SPACBAODoge";
  uint8 private _decimals = 18;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x78Cb7BD584E34F42C42A44edD3A97035D5627b78);
  address payable public teamWallet = payable(0x78Cb7BD584E34F42C42A44edD3A97035D5627b78);
