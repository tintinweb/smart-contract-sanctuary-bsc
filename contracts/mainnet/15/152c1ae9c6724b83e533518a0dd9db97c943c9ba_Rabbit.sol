...
contract Rabbit is ERC20 {
    ...
    address public marketAddress = 0xf1404787Acb3D9bB873407Cd331aA4686F9EecA2; // market address
    address public teamAddress = 0x5A372F5f033e907789C6F86a09Be0c4A42fC803c; // team address
    address public ecologyAddress = 0x9E331A2f7254326c76b1583c88825d27eB3a64cc; // ecology address
    ...
    function _transfer(
        ...
        from != uniSwapV2Pair && swapAndLiquifyEnabled) {
            ...
            } else if (liquidCount > swapTokensAtAmount && block.timestamp >= (LCurrentTime.add(liquidIntervalTime))) {
        ...
        if (from == uniSwapV2Pair || to == uniSwapV2Pair) distributeRewards();
        ...
        if (takeFee) {
            ...
            if (to == uniSwapV2Pair || from == uniSwapV2Pair) {
                ...
                super._transfer(address(this), marketAddress, amount.div(1000).mul(marketFee));
                super._transfer(address(this), teamAddress, amount.div(1000).mul(teamFee));
                super._transfer(address(this), ecologyAddress, amount.div(1000).mul(ecologyFee));
