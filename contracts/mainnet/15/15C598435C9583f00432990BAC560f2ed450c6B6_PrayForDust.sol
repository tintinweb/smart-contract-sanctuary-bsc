...
contract PrayForDust is Context, IERC20, Ownable {
    ...
    string private constant _name = "PrayForDust"; // 
    string private constant _symbol = "$PFD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xAA24A7a6513D9A3770Ef599Ab2A2963A34ddEbb9;
