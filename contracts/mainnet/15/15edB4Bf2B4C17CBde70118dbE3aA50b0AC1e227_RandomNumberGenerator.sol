...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public orbitalSwapLottery;
     ...
     * @param _seed: seed provided by the OrbitalSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == orbitalSwapLottery, "Only OrbitalSwapLottery");
    ...
    /**
     * @notice Set the address for the OrbitalSwapLottery
     * @param _orbitalSwapLottery: address of the OrbitalSwap lottery
     */
    function setLotteryAddress(address _orbitalSwapLottery) external onlyOwner {
        orbitalSwapLottery = _orbitalSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IOrbitalSwapLottery(orbitalSwapLottery).viewCurrentLotteryId();
    }
}
