...
contract Dragonomics is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Dragonomics";
    string constant _symbol = "DOMICS";
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x286f2Bc60ba71d982C3AA29CB1641627F73Fc2C4;  
        anothermarketingWallet = 0x110FA2Ef510Af0664f15dfD000EdDA3Dba7B8fFC;
