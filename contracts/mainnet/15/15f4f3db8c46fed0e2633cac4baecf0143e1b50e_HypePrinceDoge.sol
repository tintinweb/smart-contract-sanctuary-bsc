...
contract HypePrinceDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 MAX_INT =
        115792089237316195423570985008687907853269984665640564039457584007913129639935;
    string private constant _name = "Hype Prince Doge";
    string private constant _symbol = "Hype Prince Doge";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; //5
    ...
    function FuckSniipers() public onlyOwner lockTheSwap {
