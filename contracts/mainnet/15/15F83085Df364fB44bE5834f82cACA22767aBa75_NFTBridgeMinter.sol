...
contract NFTBridgeMinter is Managed {
  ...
  function withdraw(address _wallet, uint256 _cloneId, uint32 _lastTrade, uint32 _lastPayment, uint32 _upgrades, uint32 _gameDetails, uint256 _chainFrom, uint256 _chainTo, uint256 _logIndex, bytes memory _sig) public {
