...
contract BillionareSquid is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x328Edf4Ea21706698078Fc52ef1Cd5c5A3A69767); 
    address payable public Dev_Wallet = payable(0x60A127f94c63C11e9868235ADc1CA346b2783C0C);
    ...
    string private constant _name = "Billionare Squid"; 
    ...
    constructor () {
        ...
        _owner = 0x60A127f94c63C11e9868235ADc1CA346b2783C0C;
