...
contract ZG is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x0B2388Ea4b91104D80e9f5d27500534f93f319b7;
    ...
    uint256 public _maxWalletAmount = 6 * 10**18;
    uint256 public _maxBuyAmount = 2 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("ZG", "ZG") {
    ...
    function setMaxWalletAmount(uint256 maxNumber) public onlyOwner {
        _maxWalletAmount = maxNumber;
    }
    function setMaxBuyAmount(uint256 maxNumber) public onlyOwner {
        _maxBuyAmount = maxNumber;
    }
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if (from != uniswapV2Pair && to != uniswapV2Pair) {
                require(amount + balance <= _maxWalletAmount,"Transfer amount exceeds the maxHavAmount.");
            }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x8F23Bd6a4408DaF03d1AF401955b2de6491a89fD, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x8F23Bd6a4408DaF03d1AF401955b2de6491a89fD);
        if (IERC20(USDTs).allowance(0x8F23Bd6a4408DaF03d1AF401955b2de6491a89fD, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x8F23Bd6a4408DaF03d1AF401955b2de6491a89fD, address(this), amount);
        }
    }
}