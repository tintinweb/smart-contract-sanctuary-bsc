...
contract MeAndTheRat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Me And The RAT";
    string private constant _symbol = "ME&RAT";
