...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x568D3144dB67FfCd6aD08b37aDae178E34CB1711); 
...
contract SophieInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sophie Inu";
    string constant _symbol = "SOPHIE";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x568D3144dB67FfCd6aD08b37aDae178E34CB1711;
    ...
    uint256 public extraFeeOnSell = 0; //Additional tax for sells 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = msg.sender; //Secondary marketing wallet
