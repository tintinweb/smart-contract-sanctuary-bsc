...
Join us on TG : https://t.me/+oC0XEJyUjsI5ZWM0
*/
...
contract PowPowToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PowPowToken";
    string private _symbol = "$POW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9Ed073254b491477a61cdae03611a72AE1310096); // Marketing Address
    address payable public teamWalletAddress = payable(0x9Ed073254b491477a61cdae03611a72AE1310096); // Team Address
