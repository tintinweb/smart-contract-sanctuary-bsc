...
contract NDBStaking is Ownable {
    ...
    function getStakingPeriodInNumbers(stake memory _investor) internal pure returns (uint256){
        return _investor.stakePeriod == StakingPeriod.ONE_YEAR ? 365 days : _investor.stakePeriod == StakingPeriod.TWO_YEARS ? 730 days : _investor.stakePeriod == StakingPeriod.THREE_YEARS ? 1095 days : _investor.stakePeriod == StakingPeriod.FOUR_YEARS ? 1460 days : _investor.stakePeriod == StakingPeriod.FIVE_YEARS ? 1825 days : 0; 
    }
