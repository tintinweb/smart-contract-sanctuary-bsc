 ...
 * MESSHIB INU 
 *
 * The Most Revolutionary Football Memecoin in honor of the G.O.A.T Messi ! 
 * 
 * New and Innovative Tax Fee System
 * 
 * FEES:
 *
 *  8% tax fee (6% Back to the Liquidity Pool, 1%  Redistributed to Holders, 1% Burned From Supply)
 * 
 * Total Supply 10,000,000,000 AL MESSHIB INU Tokens 
 * Max amount permited per wallet  1,000,000,000 MESSHIB INU Tokens 
 * Max transaction size            1,000,000,000 MESSHIB INU Tokens 
 * 
 * Official Telegram Account: https://t.me/MesshibaInu
 */
...
contract MesshibInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Messhib Inu";
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**9;   // Max Tx Size: (10%)
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**9;  // numTokensSellToAddToLiquidity (1%)
    uint256 public _maxWalletToken = 1000000000 * 10**9; // Max Wallet: (10%)
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet router address Pancake V2
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        // uint256 tLiquidity = tAmount.div(10**2).mul(_liquidityFee).mul(multiplier);
