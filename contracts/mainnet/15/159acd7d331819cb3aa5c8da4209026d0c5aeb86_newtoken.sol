...
contract newtoken is Context, IERC20, Ownable {
    ...
    string private _name = "HuoJieZi";
    string private _symbol = "HJZ";
    ...
    function setHuoJieZiLimit(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function setHuoJieZiMax(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
