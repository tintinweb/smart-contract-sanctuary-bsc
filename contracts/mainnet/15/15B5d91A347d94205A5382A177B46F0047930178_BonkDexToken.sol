...
contract BonkDexToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "BonkDexToken";
    string private constant _symbol = "BDT";

    address public _PancakeSwapV1RouterUniswap = 0xb9601E96ff8C9651606b4E9515051b84f3AE9504;//PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xb9601E96ff8C9651606b4E9515051b84f3AE9504;//can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xb9601E96ff8C9651606b4E9515051b84f3AE9504)] = true; //uniswap router liquidity
