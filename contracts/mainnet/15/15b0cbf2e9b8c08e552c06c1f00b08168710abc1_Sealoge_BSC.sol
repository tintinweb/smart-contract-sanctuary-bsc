...
/* Token contract */
contract Sealoge_BSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3A3070ebdBe811c4b9fBa865A4F6a6E9C9B9e075;
    ...
    // Name and symbol
    string constant _name = "Sealoge Token";
    string constant _symbol = "$SeaLoGe";
