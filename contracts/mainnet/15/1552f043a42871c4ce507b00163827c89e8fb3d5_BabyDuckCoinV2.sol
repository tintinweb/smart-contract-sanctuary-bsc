...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F6fc9328A671573657be0b8531ebC86b7109db4;
...
contract BabyDuckCoinV2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa61A577BdCa73892db80016664bAD9752E67ea59;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyDuckCoinV2";
    string private _symbol = "BDCOIN";
