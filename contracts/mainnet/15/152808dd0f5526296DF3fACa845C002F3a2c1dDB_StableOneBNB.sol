...
contract StableOneBNB is Ownable {
    ...
    function _invest(address _addr, address _ref, uint256 _amount ) private returns (bool){
        require(msg.value >= MIN_INVESTMENT, "Minimum investment is 0.05 BNB");
    ...
    function withdraw() public {
        ...
        require(dividendAmount >= MIN_WITHDRAW, "min withdraw amount is 0.02 BNB");
