...
contract DOGE9 is Ownable, IBEP20 {
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public {
        require(isTxLimitExempt[msg.sender]);
