...
/**
  ...
  Choi Network - Choi Token (CHOI)

  Choi Network aims to develop and release an artificial intelligence that it has
  produced for blockchain technologies, completely for the blockchain and crypto
  money industry. This artificial intelligence, created for its main purpose, develops
  itself synchronously with Web 3.0 technologies and compiles all the data it has learned
  algorithmically and applies it on the Choi Token.

  To put it briefly, Choi Network is an experimental community and development project,
  and Choi Token, on the other hand, provides project continuity by having a structure
  managed by an artificial intelligence, leaving emotional factors aside and making
  decisions based on true-false and statistical data only.

  Total Fee (Buy/Sell): 3%
  Auto-LP (Liquidity Pool) Fee: 1%
  Marketing & Charity Fee: 2%

  Website: https://choi.network
  Website (Chinese): https://choi.network/chinese
  Twitter: https://twitter.com/ChoiToken
  Telegram: https://t.me/ChoiToken
...
contract ChoiToken is Context, IERC20, Ownable {
    ...
    string private _name = "Choi Token";
    string private _symbol = "CHOI";
    ...
    address public charityWallet = 0x807b16AF5B55768782480e43c391650dF0cf7aAa;
