...
/*
* 
The name is Flamingo, Green Flamingo
9999 supply

https://t.me/GreenFlamingoBsc
...
contract GreenFlamingo is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Green Flamingo';
    string private constant _symbol = 'GRNFLMN';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 9999 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x3cb0295F43d4cA760F134d80e21Af16a01dfD426);
    address public walletTwo=payable(0x068414F3a6699537Fb6aa24DcfcF6f763447869C);
    //TestNet
	...
	uint256 private autoBanTime = 5; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
