...
/**
 ...
 TG :- @shibaKingPrincess

 Holders will receive Shibainu Reward
...
contract shibaKingPrincess  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaKing Princess";
    string private _symbol = "ShibaKing Princess";
