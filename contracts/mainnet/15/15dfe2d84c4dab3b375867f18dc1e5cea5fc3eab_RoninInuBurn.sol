...
*TELEGRAM:https://t.me/ronininuburnofficial
*/
...
contract RoninInuBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RoninInuBurn"; 
    string private _symbol = "RIB"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC6763dA2e821bd7229b45c99056A9BEb74E9bE67); 
