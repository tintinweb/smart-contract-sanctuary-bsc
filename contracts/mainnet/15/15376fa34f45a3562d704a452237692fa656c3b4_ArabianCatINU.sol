...
twitter : https://twitter.com/ArabianCatINU
...
contract ArabianCatINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Cat INU"; //
    string private constant _symbol = "ARABIANCI"; //
