...
contract CASHLAB is Context, IERC20, Ownable {
    ...
    string private constant _name = "CASHLAB"; // 
    string private constant _symbol = "CA$H"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7; //
    uint256 public _liquidityFee = 2; //
    address payable public  _marketingWallet = payable(0x85e4F4CDEe369e410EAEC197936Ec5179836FdC0); //
