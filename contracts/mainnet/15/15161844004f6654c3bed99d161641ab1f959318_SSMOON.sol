...
/*
 ...
 - 6% TAXES, With a 1 Bean on marketing wallet !
 Dev reached 23k Mc before !

 Join the community!   https://t.me/SafeSlowMoon
...
contract SSMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeSlowMoon";
    ...
    address public Owner=0x56f680905787D135607e8e238a78b1F224903EF3; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x56f680905787D135607e8e238a78b1F224903EF3;
