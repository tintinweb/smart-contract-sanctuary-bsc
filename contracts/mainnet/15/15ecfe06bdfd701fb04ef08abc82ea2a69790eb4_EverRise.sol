...
WELCOME TO EverRise 3.0

https://t.me/EverRise2bsc
...
/* Token contract */
contract EverRise is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0c80eFD8076cFf4d13C899c220f56E7a7E3b352e;
    ...
    // Name and symbol
    string constant _name = "EverRise 3.0";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 100; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 100; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 100; // 3% or 5m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 100; // 1% of supply
