...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x122CFe68ddBc8b00959D2CAF5f2f2572A8cFF0cc; //
...
contract BullishShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bullish Shiba"; // 
    string private constant _symbol = "Bullish Shiba"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x122CFe68ddBc8b00959D2CAF5f2f2572A8cFF0cc); //
