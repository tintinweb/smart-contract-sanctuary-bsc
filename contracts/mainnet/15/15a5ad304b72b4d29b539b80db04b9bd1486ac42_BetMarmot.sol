...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 tokenReflection = IBEP20(0xd59f1Ce6114D6F28f0dCCcbF69b457BC2B3f5d27);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = tokenReflection.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(tokenReflection);
        ...
        uint256 amount = tokenReflection.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            tokenReflection.transfer(shareholder, amount);
...
contract BetMarmot is IBEP20, Auth {
    using SafeMath for uint256;

    address tokenReflection = 0xd59f1Ce6114D6F28f0dCCcbF69b457BC2B3f5d27;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BetMarmot";
    string constant _symbol = "BetMarmot";
    ...
    // kick bots 
    function kickBots(bool _status) public onlyOwner {
        botsOut = _status;
    }
