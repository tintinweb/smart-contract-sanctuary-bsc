...
contract EternalSavior is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Eternal Savior";
    string private constant _symbol = unicode"ES";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0xEFAe006c86EAE8316CeD273eF4f654b7d0FA0d5a); // Marketing Address
    address payable public teamWalletAddress = payable(0x23e9483682504bf3C74455BCFa0F2CB6B5508Be6); // Team Address
