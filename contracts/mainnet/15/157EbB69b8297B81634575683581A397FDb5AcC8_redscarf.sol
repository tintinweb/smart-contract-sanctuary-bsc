...
contract redscarf is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "redscarf";
    string private _symbol = "SCARF";
    uint8 private _decimals = 9;

    uint8 public rateBuy;
  
    uint8 public resttoken;
    ...
    function reducefee(uint256 maxWallPercent) external onlyOwner {
