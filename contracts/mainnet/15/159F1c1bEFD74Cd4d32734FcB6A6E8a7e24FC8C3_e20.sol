...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x505b151eE3727fa74Bc27E3C60F58A1CcA169009;
...
contract e20 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"EthToZero"; 
    string private constant _symbol = unicode"E20"; 
    ...
    uint256 public _maxWalletToken = _tTotal.div(40);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x505b151eE3727fa74Bc27E3C60F58A1CcA169009), BNB_Tot);
