...
contract LFLOKI is Context, IERC20, Ownable, IERC20Metadata {
    ...
    string private constant _name = "Lucky Floki";
    string private constant _symbol = "Lfloki";
    uint8 private constant _decimals = 9;

    address payable private _devAddress =
        payable(0xe4BbaCe223dD748BCE88d36b89A40E2B5d73aa48);
    address payable private _marketingAddress =
        payable(0xAA78Ab4Fa07Eb8f53A1B65BaAfC06E43376026Ec);
    address payable private _charityWallet =
        payable(0xEE265ea7DB171BBb93673eDCa7591ebf29e11d94);
