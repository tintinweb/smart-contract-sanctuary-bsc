...
contract NUGeneissFuel is BEP20, BEP20Detailed {
    ...
    constructor (address _governance) public BEP20Detailed("NUGeneiss Fuel", "NUF", 18) {
        governance = _governance;
        super._mint(_governance, 100000000000  * (10 **18));
    }
