...
contract CyberKishu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CyberKishu";
    ...
    uint256 public _walletMax = _totalSupply * 37 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x10432903FE3C4a19D1C85373ABB846A5D64f6D1b;
