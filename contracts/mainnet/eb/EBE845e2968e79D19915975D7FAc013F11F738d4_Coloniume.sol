...
// File: @openzeppelin\contracts-upgradeable\token\ERC20\extensions\ERC20FlashMintUpgradeable.sol
...
// File: contracts\Coloniume.sol

pragma solidity ^0.8.4;
/// @custom:security-contact [email protected]
contract Coloniume is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20FlashMintUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("Coloniume", "CLNX");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Coloniume");
