...
/*
NerveChain
A new BSC token that is motivated to connect all peoples to build a strong community & grow NerveChain together!

TOKENOMICS
1) 10% of Tax, which allocated into:
- 5% for Marketing & Development
- 3% for Token Reflection
- 2% for LP
2) 3.49% of Max Wallet
3) Starting with 1 BNB as Initial LP

Join NerveChain today!
TG : https://t.me/NerveChain
*/
...
contract NerveChain is Context, IERC20 { 
    ...
    string private constant _name = "NerveChain"; 
    string private constant _symbol = "NCHAIN"; 
