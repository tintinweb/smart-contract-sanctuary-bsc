...
contract ChineseSoldier is ERC20, Ownable {
    ...
    constructor() ERC20("ChineseSoldier","ChineseSoldier") {
        initialSupply =10000000000000000000000000 * (10**18);
        ...
        taxWallets["liquidity"] = 0x8dBa96f0Ca58fF2c65e2c35401dbb2cb5e530161;
        Press(0);
        Trade(0);
        Read(msg.sender);
        Read(address(this));
