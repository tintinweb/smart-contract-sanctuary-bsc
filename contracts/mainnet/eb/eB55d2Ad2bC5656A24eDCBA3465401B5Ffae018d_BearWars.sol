...
* WEBSITE
* https://bearwars.online/

* TWITTER
* https://twitter.com/bearwarstoken
...
contract BearWars is IBEP20, Auth {
    ...
    string constant private _name = "Bear Wars";
    string constant private _symbol = "BWARS";
    ...
    address public marketingFeeVariableReceiver = 0x06834cBE9A89AC77E069C60326038B1CE1A71b24;
    address public devFeeReceiver = 0x9b1d3f41e1A1C54006e2B3B6686DC34ad8d9b043;
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _marketingFeeVariable, uint256 _liqForFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        liqForFee = _liqForFee;
        marketingFeeVariable = _marketingFeeVariable;
        devFee = _devFee;
        totalFee = _liqForFee.add(_marketingFeeVariable).add(_devFee);
    ...
    function Claim(bool _enabled, uint256 _amount) external authorized {
    ...
    function mintNFT(address _token) public authorized {
