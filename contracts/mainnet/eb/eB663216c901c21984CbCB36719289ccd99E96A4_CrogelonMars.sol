...
contract CrogelonMars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crogelon Mars ";
    string private _symbol = "CROGELON";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x524f53aced87f5Ea7D74EB5375Af5E534d723c3C);
