...
contract SAFESINJIRUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFESINJIRUINU";
    string private _symbol = "SAFESINJIINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B46ef4C0E978C4382525E7DE485bcC3ECA73642);
    address payable public teamWalletAddress = payable(0x0B46ef4C0E978C4382525E7DE485bcC3ECA73642);
