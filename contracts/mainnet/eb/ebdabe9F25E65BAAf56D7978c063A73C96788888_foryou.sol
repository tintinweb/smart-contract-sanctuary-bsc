...
contract foryou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "for you";
    string private _symbol = "for you";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe86982e316B89FB06fA988aCfC8059e90bfe1534); 
