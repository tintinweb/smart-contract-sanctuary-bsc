...
contract Yaweicapital is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yaweicapital";
    string private _symbol = "Yaweicapital";
    uint8 private _decimals = 9;
    address payable private marketingWalletAddress = payable(0x92c110f102912c4e3786d269Fd9A10d1857064C5); // Marketing Address
    address payable public teamWalletAddress = payable(0x2bC9D7932DD98644396378E2d24F6BBEeaF29498); // Team Address
    ...
    constructor (address NewOwner,address recipient) {
        _owner = NewOwner;
