...
contract BLACKSWAN2022 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x2e6FadA094544f232AF03E7581164D58Cd72B8eF); // Marketing Address

    address payable public teamAddress =
        payable(0xA24f28DEa7c9614d6d5eBA4d8e4B7b782c16AdF4); // Team Address

    address payable public liquidityAddress =
        payable(0x6d30637F39E53A80694aF3e410889b9b0021E26F); // Liquidity Address
    ...
    string private constant _name = "BLACKSWAN";
