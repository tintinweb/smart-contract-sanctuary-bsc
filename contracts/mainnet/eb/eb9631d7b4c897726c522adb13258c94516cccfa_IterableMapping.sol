...
// 🐱🐱 Kat Token 🐱🐱
// 
// Introducing Kat Token, featuring an ever increasing price floor and simple yet effective rewarding system giving ALL holders a massive 3% BNB rewards.
//
// Telegram: https://t.me/katbsc
// Website: https://www.katbsc.club
// Twitter: https://twitter.com/kattokenbsc
//
...
contract KatDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("Kat_Dividend_Tracker", "Kat_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "Kat_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "Kat_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Kat contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Kat_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
        require(newClaimWait != claimWait, "Kat_Dividend_Tracker: Cannot update claimWait to same value");
...
contract Kat is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    KatDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Kat", "KAT") {
    	...
    	dividendTracker = new KatDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "kat: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Kat: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Kat: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Kat: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Kat: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Kat: Cannot update gasForProcessing to same value");
