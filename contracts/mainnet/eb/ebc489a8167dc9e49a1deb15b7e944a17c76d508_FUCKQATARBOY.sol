...
contract FUCKQATARBOY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FUCK QATAR BOY";
    string constant _symbol = "$FuckQB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x6121e0953B720aD4eF6F7B85c2ed3E9FA310B7EF;
