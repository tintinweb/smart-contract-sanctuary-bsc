...
contract Goblinthree is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0E3890627C5c37D3a3F6fce8BDdd884d61E29BEf); 
    address payable public Wallet_Dev = payable(0x0E3890627C5c37D3a3F6fce8BDdd884d61E29BEf);
    ...
    string private constant _name = "Goblin 3.0"; 
    string private constant _symbol = unicode"GOBLIN3"; 
    ...
    constructor () {
        ...
        _owner = 0x0E3890627C5c37D3a3F6fce8BDdd884d61E29BEf;
