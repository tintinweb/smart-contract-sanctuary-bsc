...
contract LipzerToken is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = 'Lipzer Token';
    ...
    uint256 public constant BASE_MINT = 1 * 10**5 * 10**18; //100 mil
    ...
    constructor () public {
        ...
        uint256 amount =  BASE_MINT.div(10); //10 mil
        _tTotal = amount;
