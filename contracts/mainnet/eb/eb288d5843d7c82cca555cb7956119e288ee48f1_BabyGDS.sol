...
contract BabyGDS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x179dfac867818345D6e35D6341F06c5e927a754c); // Marketing Address
        
    address payable public teamAddress =
        payable(0x179dfac867818345D6e35D6341F06c5e927a754c); // Team Address
    ...
    string private constant _name = "BabyGDS";
    string private constant _symbol = "BabyGDS";
