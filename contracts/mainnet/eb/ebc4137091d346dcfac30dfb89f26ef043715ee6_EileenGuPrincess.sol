...
contract EileenGuPrincess is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EileenGu Princess";
    string private _symbol = "EGP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A0D58337949742Aa2DbAe29D0d0785bcd8fa351); 
    address payable public BuybackWalletAddress = payable(0x5A0D58337949742Aa2DbAe29D0d0785bcd8fa351); 
