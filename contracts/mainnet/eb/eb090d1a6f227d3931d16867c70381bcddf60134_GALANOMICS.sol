...
contract GALANOMICS is IERC20, Context, Ownable {
    ...
    address private Marketing_Wallet = 0x40d38Fd8A70a0407F39ff4dF9CB94DB19FE2CdEd;
    address private Team_Wallet = 0xd0d5A0daDC23C5A029FbFa663A3aAF8E4DDD87A8;
    
    string private constant _symbol = "GALANOMICS";
    string private constant _name = "GALANOMICS";

    uint256 public max_BuyLimit = 20000000 * 10**9;
    uint256 public max_SellLimit = 20000000 * 10**9;

    uint256 public max_WalletLimit = 20000000  * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 2, 1, 4);
    Taxes public taxes = Taxes(0, 2, 1, 4);
