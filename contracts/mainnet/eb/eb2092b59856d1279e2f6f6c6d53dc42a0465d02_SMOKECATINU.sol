...
contract SMOKECATINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Smoke Cat Inu";
    string private _symbol = "SCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x603f416d5F450Ed5408E5CB39c5acfd0a861A8D1); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xA86fFe2a9c44a6407009fada5d0EEa5a18a7722b); // buyback Address
