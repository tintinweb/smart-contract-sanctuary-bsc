...
contract ShibaWinu is ERC20, Ownable, LockToken {
    ...
    constructor() ERC20("SHIBA WINU", "$WINU")  {
        ...
        // exclude from paying fees, max wallet or having max transaction amount
    ...
    function setJackpotRewardPercent(uint256 _vlue) public onlyOwner {
