...
Name: VOLT GROW 
Network bsc 
The next moonshot GROW META!

TG: https://t.me/VOLTGROW
*/
...
contract VOLTGROW is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1f44c6f9AF7d249b10D7af679212EA8dD29F93E2;

    string private constant _name = "Volt Grow";
    string private constant _symbol = "VOLTGROW";
    ...
    function Blacklist(address[] memory account, bool TorF) public onlyOwner {
    ...
    function Whitelist(address[] memory account, bool TorF) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++){
            address wallet = account[i];
            _isExcludedFromFee[wallet] = TorF;
        }
    }
