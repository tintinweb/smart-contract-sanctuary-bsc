...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xea40FeAaCD3E30e42AcC26C36f6d27796028363f;
...
contract NextBigGem is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x270Dde9E5d08ab7Cd1F1337715C0084f9477b0CD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NextBigGem";
    string private _symbol = "NBIG";
