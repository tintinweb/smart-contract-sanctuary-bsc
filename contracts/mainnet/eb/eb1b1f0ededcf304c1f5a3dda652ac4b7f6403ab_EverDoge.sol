...
// https://twitter.com/EverDogeToken  
...
contract EverDoge is IBEP20, Auth {
    ...
    mapping (address => bool) public SetBlacklisted;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9f5061D90c5f7B7885C33A6A4e3032E4dD3C6cc3;
        buybackfeeReceiver = 0x9F0470a19DDbe73e91e4840170136B96E8554b3A;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Blacklist
        if(blacklistMode){
            require(!SetBlacklisted[sender] && !SetBlacklisted[recipient],"Blacklisted");    
        }
    ...
    function manage_blacklist(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            SetBlacklisted[addresses[i]] = status;
        }
    }
