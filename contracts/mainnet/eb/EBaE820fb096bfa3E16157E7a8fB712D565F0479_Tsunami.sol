...
contract Tsunami is Context, IERC20, Ownable {
    ...
    string private _name = "Tsunami";
    string private _symbol = "TS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc0Bd526ce5eEd0D60662229098257d4A2dAaf9cb); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc0Bd526ce5eEd0D60662229098257d4A2dAaf9cb); // BuyBack Address
