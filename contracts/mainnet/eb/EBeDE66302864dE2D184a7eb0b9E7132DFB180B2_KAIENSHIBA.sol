...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6a9819d8Ab7A382A196663224F6ecec9c1bBd41; // owner address
...
contract KAIENSHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kaien Shiba";
    string private _symbol = "KAIENSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe6a9819d8Ab7A382A196663224F6ecec9c1bBd41); // Marketing Address
    address payable public teamWalletAddress = payable(0xe6a9819d8Ab7A382A196663224F6ecec9c1bBd41); // Team Address
