...
contract Token is IERC20, CommunityRole {
    ...
    string private _name = "Love and dedication";
    ...
    IERC20 GRA = IERC20(0x35C5EcA4436D64203219598D44E8A7E4f5152132);
    IERC20 GRA1 = IERC20(0x35C5EcA4436D64203219598D44E8A7E4f5152132);
    

    address private deadsWalletAddress = 0x000000000000000000000000000000000000dEaD; 
    address public communityAddress = 0x2a6044BE4F9D88cC11d23945949E6D9B87Af5B07;


    uint256 public _lpFee = 100;
    uint256 public _backflowsFee = 200;
    uint256 public _marketingsFee = 200;

    uint256 private _previousLpFee;


    uint256 private _backflowFee = 0;
    ...
    constructor() {
        ...
        swapTokensAtAmount = _tTotal.mul(1).div(50000);
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this),FIST);
    ...
    function handleBuyBack() private {
        ...
        swapTokensForDestroy(award,address(GRA)); 
        swapTokensForDestroy(award,address(GRA1));
    ...
    function handleMarketing() private {
        swapTokensSellUSDT(amountMarketingFee,deadsWalletAddress);
    ...
    function _takeMarketingFee(address sender,uint256 tAmount) private {
        ...
        uint award = tAmount.mul(80).div(100);
        uint awards = tAmount.mul(20).div(100);
        _tOwned[communityAddress] = _tOwned[communityAddress].add(award);
        emit Transfer(sender, communityAddress, award);
        
        amountMarketingFee += awards;
        _tOwned[address(this)] = _tOwned[address(this)].add(awards);
        emit Transfer(sender, address(this), awards);
    }
    ...
    function setdeadsWalletAddress(address _addr) public onlyOwnere {
        deadsWalletAddress = _addr;
    }
