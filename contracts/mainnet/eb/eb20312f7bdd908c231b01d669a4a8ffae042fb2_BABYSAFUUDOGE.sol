...
contract BABYSAFUUDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySafuuDoge";
    string private _symbol = "BSAFUUD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf686CCB75c6E11596a36F3A2dC3f611cDce8B795); 
    address payable public DevWalletAddress = payable(0xdac30143f65126D2949B0d374616eb0e5324B0AA); 
    ...
    uint256 public _walletMax = 500000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 30000000 * 10**9;
