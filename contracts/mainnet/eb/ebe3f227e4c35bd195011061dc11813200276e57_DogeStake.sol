...
contract DogeStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [3 days, 5 days, 7 days, 10 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [50, 50, 50, 50];
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        totalFee = 10;
        maxStakeableToken = 1000000000000;
        percentDivider = 1000;
        minimumStakeToken = 20000000000000;
    }
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xc6f064E2F60eED5A0B662Af21b887102496a2A8F; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x24f3Cef3eC197139EC571F7518E47e6eCa621F23); // TKN Token address 
