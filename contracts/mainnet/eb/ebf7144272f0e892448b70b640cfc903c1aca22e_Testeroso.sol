...
contract ShizzleDistributor is IDividendDistributor {
...
contract Testeroso is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Testoroso";
    ...
    ShizzleDistributor public distributor;
    ...
    constructor (address _BuyBackReceiver) Auth(msg.sender) {
        ...
        distributor = new ShizzleDistributor(address(router));
