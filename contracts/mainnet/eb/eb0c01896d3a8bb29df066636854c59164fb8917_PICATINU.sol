...
/*
Telegram: https://t.me/picatinubsc
Website: https://picatinu.com/
...
contract PICATINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PICAT INU";
    string private _symbol = "PICAT INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6e2F92ADF766c1727e7D20d9C3e0eA72F508ddD3);
    address payable public teamWalletAddress = payable(0x6e2F92ADF766c1727e7D20d9C3e0eA72F508ddD3);
