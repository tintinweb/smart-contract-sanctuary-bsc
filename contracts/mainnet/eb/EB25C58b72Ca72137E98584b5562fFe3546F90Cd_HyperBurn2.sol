...
contract HyperBurn2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HyperBurn2DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Hyperburn2", "HB2") {
        marketingWallet = payable(0x97a1f067407ed51C66f39Da433D3D26daCd8F42F);
        devWallet = payable(0xfCAE4a5d0FAD60439F42064283e7172e4442bCb2);
        ...
        dividendTracker = new HyperBurn2DividendTracker(
            payable(this),
            router,
...
contract HyperBurn2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HyperBurn2 public HyperBurn2Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        HyperBurn2Contract = HyperBurn2(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HyperBurn2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HyperBurn2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HyperBurn2 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HyperBurn2Contract);

            uint256 prevBalance = HyperBurn2Contract.balanceOf(address(this));
            ...
            {
                uint256 received = HyperBurn2Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HyperBurn2Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
