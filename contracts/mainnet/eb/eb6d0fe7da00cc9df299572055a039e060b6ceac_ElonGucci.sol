...
// CHANGE
contract ElonGucci is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Elon Gucci";
    string constant _symbol = "EGucci";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x50f4363839C6C2c2e8a9A8244DF530C78461735A);
