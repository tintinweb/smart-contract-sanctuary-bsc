...
contract ShibaInuKage is IBEP20, Ownable {
    ...
    string constant _name = "Shiba Inu Kage";
    string constant _symbol = unicode"SHIKAGE";
    ...
    address private marketingWallet = 0xdda00c5312B25D6718e13B2D22C658aB94C2C573;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(2, 6, 0, 0);
    Fees public sellFees    = Fees(2, 6, 0, 0);
