...
contract BearCatInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BearCatInu";
    string private _symbol = "BearCatInu";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xd8E14B69bf76b027a4689b5b8A918181D0515F37);
