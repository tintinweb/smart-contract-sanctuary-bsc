...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CR7 = IBEP20(0x41A6CaFaFC4956C347F91Bf7d7fe2245A8eFeA9c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CR7.balanceOf(address(this));
        ...
        uint256 amount = CR7.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CR7.transfer(shareholder, amount);
...
contract HelpUkraineNow is IBEP20, Auth {
    using SafeMath for uint256;
    address CR7 = 0x41A6CaFaFC4956C347F91Bf7d7fe2245A8eFeA9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
