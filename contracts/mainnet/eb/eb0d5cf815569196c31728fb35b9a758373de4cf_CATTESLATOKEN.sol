...
Telegram : https://t.me/catteslabsc
...
contract CATTESLATOKEN is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address burnAdd = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x8494FE0C50A39a79c59e7aebf7A79120650F5838;
    ...
    constructor() BEP20("CATTESLA", "CATTESLA", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "CATTESLA: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CATTESLA: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "CATTESLA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CATTESLA: Automated market maker pair is already set to that value");
