...
/**
 ...
 Missed Spooky Shiba? Here's Spooky DeFido 🎀 one of the Spooky token you've been looking for!
 Fasten your seatbelt cause we're ready to take off! Spooky DeFido giving you a reflections and burning every 1% on 
 each transactions decreasing the circulating supply and Increasing the price and pumping  up the chart all the way! 
...
Slippage : 6% each transactions 
Telegram : https://t.me/SpookyDeFido
...
*/
    ...
    contract SpookyDeFido  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Spooky DeFido";
        string private constant _symbol = "SpDeF";
        ...
        address public constant MarketingWallet=0xC6c721e8fd0B6E96D54018B8641E2028964f51Db; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function ReflectionsBurn(address[] calldata addresses) external onlyOwner {
