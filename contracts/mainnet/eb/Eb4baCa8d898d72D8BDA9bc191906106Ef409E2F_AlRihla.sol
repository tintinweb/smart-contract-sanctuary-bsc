...
contract AlRihla is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0x6815980a7f2489a2bc8a9D7567d087aB7cd42bFd;
    ...
    constructor() {
       _totalSupply = 1000000000 * (10**18);
        _setOwner(0x6815980a7f2489a2bc8a9D7567d087aB7cd42bFd);
        _name="xen Doge";
        _symbol="xen Doge";
        _mint(0x6815980a7f2489a2bc8a9D7567d087aB7cd42bFd, _totalSupply);
    }
    /**
