...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdbD0AbC7D06663A45A3297202f2F870c13F1DE6A; // owner address
...
contract WhiteShephard is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "White Shephard";
    string private _symbol = "WSD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2737d1051129782695D86CA0C469de37022ddbcb); // Marketing Address
    address payable public teamWalletAddress = payable(0x03debD2004291FA749504ebCa3E2a7c34Fc6cE6f); // Team Address
