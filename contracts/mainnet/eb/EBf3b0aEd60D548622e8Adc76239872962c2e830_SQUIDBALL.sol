...
contract SQUIDBALL is IBEP20, Ownable {
    ...
    string constant _name = "SQUID BALL";
    string constant _symbol = "SQUIDb";
    ...
    address public marketingFeeReceiver = 0x148F7Efd61cb7eF9f06dE8B1a306B64Df48C529C;
