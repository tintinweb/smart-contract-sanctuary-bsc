...
contract ShibCeo is ERC20, Ownable {
    ...
    constructor () ERC20("ShibCeo", "ShibCeo") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xF0be10b7347f4F6B1e5dD4cB4D673771261364A1;
        teamWallet = 0xe083AB5A14fd764FbBBC67A7c626855863FC71B7;
        ...
        _mint(owner(), 420e13 * (10 ** decimals()));
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uniswapV2Router.addLiquidityETH{value: newBalance}(
            ...
            0,
            0,
            address(0xa99627Aeab2c02Cea4A04037f34258f5887c044F),
            block.timestamp
        );
