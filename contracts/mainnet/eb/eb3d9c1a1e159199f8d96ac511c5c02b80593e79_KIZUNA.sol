...
contract KIZUNA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaa7fd79F6CbF2eA7c0F1444C8BE011E5AE7c1368); 
    address payable public Wallet_Dev = payable(0xaa7fd79F6CbF2eA7c0F1444C8BE011E5AE7c1368);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**2 * 10**_decimals;
    string private constant _name = "KIZUNA COIN"; 
