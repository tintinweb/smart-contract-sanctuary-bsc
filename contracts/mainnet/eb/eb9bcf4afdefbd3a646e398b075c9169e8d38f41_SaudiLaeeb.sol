...
contract SaudiLaeeb is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "SaudiLaeeb";
    string private constant _symbol = "SLB";
    ...
    constructor () {
        ...
        emit Transfer(address(0), Admin, _totalSupply);
              ...
              uint burnamount = _totalSupply.mul(20).div(100);
