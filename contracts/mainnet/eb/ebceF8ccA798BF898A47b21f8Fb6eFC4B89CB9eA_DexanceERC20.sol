...
contract DexanceERC20 is IAnyswapV3ERC20 {
    using SafeERC20 for IERC20;
    string public name;
    string public symbol;
    uint256 private constant CAP = 567000000e18;
    ...
    function setDxMinter(address _auth) external onlyVault {
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        //@dev additional check for dexance token
