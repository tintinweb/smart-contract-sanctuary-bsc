...
/**
METFX - Watch2Earn & Metaverse
MetFX is the first watch -to- earn global plaorm that harnesses the power and the value of content. The input (x) is the player and the (f) function is entertainment for each guest of the MetFX World.
