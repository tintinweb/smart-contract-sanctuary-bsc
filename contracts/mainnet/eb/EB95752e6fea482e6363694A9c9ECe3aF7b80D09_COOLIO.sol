...
/**
https://amp.tmz.com/2022/09/28/coolio-dead-dies-los-angeles/

TG https://t.me/CoolioInu
*/
...
contract COOLIO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coolio Inu";
    string private constant _symbol = "COOLIO";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000 * 10**_decimals;

    uint256 public _maxWalletAmount = 3000* 10**_decimals;
    uint256 public _maxTxAmount = 3000* 10**_decimals;
    uint256 public swapTokenAtAmount = 3000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x806b87F21eDa9FAAA21B13F32A77d2e72dd9c420);
    address private liquidityReceiver = address(0x806b87F21eDa9FAAA21B13F32A77d2e72dd9c420);
