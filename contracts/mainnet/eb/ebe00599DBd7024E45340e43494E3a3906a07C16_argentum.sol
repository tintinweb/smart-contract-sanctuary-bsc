...
contract argentum is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Argentum";
    string private constant _symbol = unicode"$ARTUM";
    ...
    address payable public DevWallet = payable(0x3aEa113C17D13c5Ea402ce566873f715EcF6b152);
    address payable public MarketingWallet = payable(0x080Fbc234485841522b00e75B5a8C659DCfe5C3F);
