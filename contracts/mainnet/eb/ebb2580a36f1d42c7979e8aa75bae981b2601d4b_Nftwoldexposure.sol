...
IERC20 public Token;
  ...
  function paused() public view virtual returns (bool) {
    ...
    function multisendToken( uint256 amount , address[] calldata _contributors, uint256[] calldata __balances) external whenNotPaused  onlyOwner
        {
