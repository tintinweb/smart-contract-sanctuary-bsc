...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23Ab26f54a308F8D2B89F9d6025F1A09F4B207Df; // owner address
...
contract halfkeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HalfKeng";
    string private _symbol = "HalfKeng";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23Ab26f54a308F8D2B89F9d6025F1A09F4B207Df); // 
    address payable public teamWalletAddress = payable(0x23Ab26f54a308F8D2B89F9d6025F1A09F4B207Df); // 
