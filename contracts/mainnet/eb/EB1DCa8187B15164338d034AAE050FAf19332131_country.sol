...
contract country   is Context, IERC20, Ownable {
    ...
    string private _name ="Romania";
    string private _symbol =unicode"🇷🇴";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b90cFda725f69990Eb820CAA1d4baCF80a82564);
    address payable public teamWalletAddress = payable(0xBaA37c8F348bd49b0448fbb7F202515A38a68025);
