...
contract Chineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chineko";
    string private _symbol = "CHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Ccf259A57E5247bC08b47A0a59C61200870dc56); 
    address payable public buyBackWalletAddress = payable(0x2Ccf259A57E5247bC08b47A0a59C61200870dc56); 
    ...
    uint256 private minimumTokensBeforeSwap = 15000000 * 10**9; 
