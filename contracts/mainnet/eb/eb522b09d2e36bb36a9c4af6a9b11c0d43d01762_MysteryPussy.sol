...
contract MysteryPussy is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Mystery Pussy";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 50; //2%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 50; //2%
    ...
    uint256 devmarketingFee = 150;
    uint256 totalFee = 150;
    uint256 sellBias = 0;

    //Higher tax for a period of time from the first purchase only, per address
    uint256 sellPercent = 167; //20% Sell Tax
    uint256 sellPeriod = 24 hours;

    uint256 antiDumpTax = 300; //45% Sell Tax
    uint256 antiDumpPeriod = 120 minutes;
