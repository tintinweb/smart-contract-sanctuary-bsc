...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6);
...
contract ProbetsJr is IBEP20, Auth {   
    using SafeMath for uint256;

    address RWD = 0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Probets Jr";
    string constant _symbol = "PJR";
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        teamFee = _teamFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_teamFee).add(_reflectionFee).add(_marketingFee);
