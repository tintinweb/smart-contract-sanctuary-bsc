...
contract DrogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Droge Inu";

    string private _symbol = "DRONU";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0x3dF6792132de443B88b563c8FeD5427B22B3E5f2;
