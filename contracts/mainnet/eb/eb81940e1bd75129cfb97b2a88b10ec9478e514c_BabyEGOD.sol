...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xc852A20db80B7a225E6C78207E61dD4C13Fae435); //EGOD
...
contract BabyEGOD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Egod";
    string constant _symbol = "Baby Egod";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xc852A20db80B7a225E6C78207E61dD4C13Fae435;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2757C4a4A7CaE3D11986c8B3D0D781C81A5Fa68A;  //marketingwallet
        anothermarketingWallet = 0xE28199000e9D7e56C68aA9B20754Cf3dB9ebc78f; // 
