...
contract WFON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WFON";
    string private _symbol = "WFON2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x00c7E45845f44b9243C03B823d3d41D1e614AC5C); 
    address payable public BurnedWalletAddress = payable(0x00c7E45845f44b9243C03B823d3d41D1e614AC5C); 
