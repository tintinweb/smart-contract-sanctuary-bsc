...
contract SurgeEarn is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeEarn";
    string private constant _symbol = "$SURE";
    ...
    //Tax wallets
    address public marketingWallet = 0xe31Dc38E87b0681a8BE870d8F09735aACBdE1f32;
    ...
    //tax Split Sell
    uint256 public sellMarketingShare = 400;
    uint256 public sellRewardShare = 600;
