...
contract XJD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XJD";
    string private _symbol = "XJD";
    ...
    uint256 private _totalSupply =  800 * 10**_decimals;
    uint256 public _maxTxAmount =   800 * 10**_decimals; 
    uint256 public _walletMax =     800 * 10**_decimals;
