...
contract Moonkeycoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonkey coin";
    ...
    uint256 public _teamShare = 2; // original 15
    ...
    uint256 private _totalSupply = 1020000000 * 10**_decimals;
