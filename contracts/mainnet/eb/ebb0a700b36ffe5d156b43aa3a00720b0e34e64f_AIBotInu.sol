...
contract AIBotInu is Context, IERC20, Ownable {
    ...
    string private constant _name = " AI Bot Inu"; // 
    string private constant _symbol = "$ABI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xAA71efECeA5512c401e0743ee1C24AFadADdc5c9;
