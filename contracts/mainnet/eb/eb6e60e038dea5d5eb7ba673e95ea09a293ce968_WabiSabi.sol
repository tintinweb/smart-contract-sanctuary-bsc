...
Telegram: https://t.me/WabiSabiCoin
*/
...
contract WabiSabi is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "WabiSabi";
    string private _symbol = "WabiSabi";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _marketingfee = 3;
    address private _marketingaddress = 0x41e2ba97CfD4Ff61FAe63F472C377Eec7c61d159;
