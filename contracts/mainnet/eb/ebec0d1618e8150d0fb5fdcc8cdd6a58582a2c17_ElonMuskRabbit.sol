...
abstract contract AbsToken is ERC20, Ownable {
    ...
    constructor (
        ...
        _mint(address(LPAddress),Supply * (60) / (100));
...
contract ElonMuskRabbit is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        "Elon Musk Rabbit",//Name
        "EMR",//Symbol
        10000000000 * 10**18,//Supply
        address(0x1429552FC5Ee935383160B5F0AbA9d8279FB32E1),//FundAddress
        address(0x999eada0b2eE046cab21C44726e791aE1EcCf4F7)//LPAddress
    ){
