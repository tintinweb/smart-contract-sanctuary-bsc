...
contract Test22 is ERC20, Ownable {                                                                                          ///////////////
    ...
    uint256 private constant TOTAL_SUPPLY = 1000000; // 1 M tokens                                                                         /////////////
    ...
    constructor() ERC20("TEST2", "$TEST2") {                                                     /////////////////////////////////
    	...
    	marketingAddress = address(0x92DBb46f406b1370Ac07223b808ce6A8E238Fd41);
        devAddress = address(0x863314D550f91cb6860575F319aCc09858041Bd1);
        treasuryAddress = address(0x851F32D5f260a8B892fbC110561B0AA17C522f06);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 120000 && newValue <= 200000, "Test: gasForProcessing must be between 120,000 and 200,000");
