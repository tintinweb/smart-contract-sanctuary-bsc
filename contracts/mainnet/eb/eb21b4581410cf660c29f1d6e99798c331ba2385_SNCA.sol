...
contract SNCA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Seneca Coin";
    string private _symbol = "SNCA";
    ...
    uint256 public _charityFee = 200; // 2%
    ...
    uint256 public numTokensSellToAddToLiquidity = 250 * 10**8;
    uint256 public minNumTokensSellToAddToLiquidity = 2 * 10**8;
