...
contract BULLPEL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BULL PEi";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "BLP";
