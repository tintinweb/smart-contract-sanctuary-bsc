...
contract NekoPoi is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7D602d023Bef788C7BFF6a754d85C723eAb40144;
        charityFeeReceiver = 0x7D602d023Bef788C7BFF6a754d85C723eAb40144;
        giveawayFeeReceiver = 0x7D602d023Bef788C7BFF6a754d85C723eAb40144;
 ...
 /*   // switch Trading
    ...
    function swapBack(bool isSell) internal swapping {
        ...
        uint256 amountBNBLiquidity = amountBNB.mul(dynamicLiquidityFee).div(totalBNBFee).div(2);
        {
            ...
            uint256 amountBNBTeam = amountBNB.mul(_charityFee).div(totalBNBFee).div(2);
            ...
            (status,) = payable(charityFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
    ...
    function setFeesBuy(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee,uint256 _charityFeeBuy,uint256 _giveawayFeeBuy,
        ...
        totalFeeBuy = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_charityFeeBuy).add(_charityFeeBuy);
    ...
    function setFeesSell(uint256 _liquidityFee, uint256 _reflectionFee,
        uint256 _marketingFee, uint256 _charityFeeSell, uint256 _giveawayFeeSell,
        uint256 _feeDenominator) external authorized {
        ...
        totalFeeSell = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_charityFeeSell).add(_giveawayFeeSell);
