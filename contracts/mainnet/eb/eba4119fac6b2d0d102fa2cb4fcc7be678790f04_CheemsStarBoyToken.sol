...
/*
    ...
    Telegram    : https://t.me/CheemsStarBoy
    Twitter     : https://twitter.com/CheemsStarBoy
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01894C7237a3C3Fa059d4f0627C33778C7A4e1E8; // owner address
...
contract CheemsStarBoyToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cheems Star Boy";
    string private _symbol = "$CSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01894C7237a3C3Fa059d4f0627C33778C7A4e1E8); // Marketing Address
    address payable public teamWalletAddress = payable(0x01894C7237a3C3Fa059d4f0627C33778C7A4e1E8); // Team Address
