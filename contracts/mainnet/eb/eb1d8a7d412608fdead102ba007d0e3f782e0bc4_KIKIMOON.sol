...
contract KIKIMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = "KIKIMOON";
    string private constant _symbol = "KIKIMOON";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xeAd4375190A1a76Bb787c5c341e11DB5C09f8481);
    address payable private _marketingAddress = payable(0xeAd4375190A1a76Bb787c5c341e11DB5C09f8481);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 91, "Redis cannot be more than 91.");
