...
contract BulldozerInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x596B2740f29c9291Cf605c571fa30080B88dBe14); // Marketing Address
    address payable private teamWalletAddress = payable(0xEa2a997A65CcB79bC2DD98DCF55F2b6d066062D5); // Team Address
