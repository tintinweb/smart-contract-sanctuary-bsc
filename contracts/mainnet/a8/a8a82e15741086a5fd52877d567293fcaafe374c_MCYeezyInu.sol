...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdC85Cf924E6F5d348a52Fc4C7FC60843b65A95DC;
...
contract MCYeezyInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdC85Cf924E6F5d348a52Fc4C7FC60843b65A95DC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MCYeezyInu";
    string private _symbol = "$MCYZY";
