...
contract WorldWarDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WorldWarDoge";
    string private _symbol = "WWDCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x54f9dE87941c77F64005f603927e79AA1C2d3584); // Marketing Address
    address payable public DevWalletAddress = payable(0x1309b7adf4CF373e90db24915D80A66a2da98a04); // Dev fee
    ...
    uint256 public _walletMax = 4000 * 10**9;
