...
/* Token contract */
contract METANOMICS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd92CDFd35fd92F8FfC99aEB89AfC75aBBB87E342;
    ...
    string constant _symbol = "METANOMICS";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000 * (10 ** _decimals); // 1T 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // .1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xd92CDFd35fd92F8FfC99aEB89AfC75aBBB87E342;
