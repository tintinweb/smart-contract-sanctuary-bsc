...
contract SivCoin is ERC20, Ownable {
    ...
    constructor() ERC20("SivCoin", "ASIV") {
        ...
        transferTotalFees = transferMarketingFee + transferLiquidityFee + transferBuyBackFee + transferDevFee;

    	marketingWallet = 0xeBa3Dc63218fD6e6d6d0123ebb1312E751581c77; // set as marketing wallet
    	devWallet = 0xeBa3Dc63218fD6e6d6d0123ebb1312E751581c77; // set as dev wallet
    ...
    function updateTransferFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _devFee) external onlyOwner {
        transferMarketingFee = _marketingFee;
        transferLiquidityFee = _liquidityFee;
        transferBuyBackFee = _buyBackFee;
        transferDevFee = _devFee;
        transferTotalFees = transferMarketingFee + transferLiquidityFee + transferBuyBackFee + transferDevFee;
        require(transferTotalFees <= 150, "Must keep fees at 15% or less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            fees = amount.mul(transferTotalFees).div(1000);
            tokensForLiquidity += fees * transferLiquidityFee / transferTotalFees;
            tokensForBuyBack += fees * transferBuyBackFee / transferTotalFees;
    ...
    function swapBack() private {
        ...
        if(transferBuyBackFee == 0 && address(this).balance >= 1 ether){
