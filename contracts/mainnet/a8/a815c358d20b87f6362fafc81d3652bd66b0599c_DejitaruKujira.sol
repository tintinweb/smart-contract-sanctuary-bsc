...
/**
 *  Telegram: https://t.me/dejitarukujirabsc

 Welcome. All holders of $KUJIRA will aid in this process of liberation and in return will reap the rewards of the Kujira. 
 This beast has been there since the beginning, his returns will be enormous. 
 Dejitaru Kujira $KUJIRA will reach the surface of, not only the sea, but also the moon. 
 $KUJIRA is set to launch and ready to hit its meteoric rise….
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x046766675522Da8c41678FF6C571d575c35A50Ac; // owner address
...
contract DejitaruKujira is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dejitaru Kujira";
    string private _symbol = "KUJIRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x046766675522Da8c41678FF6C571d575c35A50Ac); // 
    address payable public teamWalletAddress = payable(0x046766675522Da8c41678FF6C571d575c35A50Ac); // 
