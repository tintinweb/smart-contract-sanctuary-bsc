...
contract UakraCoin is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x28F103Db425a82E5D5BeEF57B8ea02e7F4F557A8); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x93B9eedAbFCBB35Da2d0B0143c21cb48a185B30c); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x2C175B0D35aeaF983CD21c4083D94482e45B2A91); // charity Wallet Address
    address payable public devWalletAddress = payable(0xB35C0fc9199B37FA7b317cDB4419E38983EEc9C1); // dev Wallet Address
    ...
    string private constant _name = "Uakra Coin";
    string private constant _symbol = "UAKRA";
    ...
    constructor () {
        address _owner = 0xB35C0fc9199B37FA7b317cDB4419E38983EEc9C1;
