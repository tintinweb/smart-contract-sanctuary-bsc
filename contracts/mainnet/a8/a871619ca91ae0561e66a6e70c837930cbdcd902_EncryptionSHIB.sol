...
contract EncryptionSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Encryption Shib"; 
    string private _symbol = "ENSHIB"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x682DB5D5D0ee7851ff7d85016915e7BDDb24f021); // Marketing Address
    address payable public teamWalletAddress = payable(0x682DB5D5D0ee7851ff7d85016915e7BDDb24f021); //  Team Address
