...
contract JoyBoyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Joy Boy Inu"; // 
    string private constant _symbol = "JOY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x97db04735dBb395c3177b7BE9aa55eC3a1dA481b;
