...
contract FIFAToken is IERC20 {
    ...
    uint256 constant private startingSupply = 100_00_0;
    string constant private _name = "FIFA Token";
    ...
    address payable public marketingWallet = payable(0x0Ad6b8d35ccBF300636C85cAB2504A60A3b3bF51);
