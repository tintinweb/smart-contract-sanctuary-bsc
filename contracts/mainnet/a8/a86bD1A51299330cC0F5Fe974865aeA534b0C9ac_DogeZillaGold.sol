...
contract DogeZillaGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeZillaGold";
    string private _symbol = "DogeZillaGold";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2ff2E5030CC541aEf8Ed9A95AE76fdF8131FE030); 
    address payable private teamWalletAddress = payable(0x8380d1cd68473Df127D8E625FD2F8800C5c235Ef); 
