...
contract PunkKishu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PUNKKISHU";
    string constant _symbol = "PK";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  //BUSD REWARD

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;
    uint256 public _walletMax = _totalSupply * 47 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x8A52d394e247EAc7deC1F0618C854ea1a1A7EBdA;
