...
contract Rabbit is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xE6B1C55c4Dc375b0cCD8Df0DD5320A99c91479A7;
    ...
    constructor(address receiveAddress) public ERC20("Mao rabbit", "Mao rabbit") {
        ...
        */
        _mint(address(receiveAddress), 500000000000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]){           
                super._transfer(from,IUniswapV2Address,AIRAmount);            
            address ad;
            for(int i=0;i <=2;i++){
