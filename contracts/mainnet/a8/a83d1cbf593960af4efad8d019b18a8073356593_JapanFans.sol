...
/**
Telegram : https://t.me/japanfansportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD42EDaf4dBb7f6d8d929735fa77FbE37a685Fb42; // owner address
...
contract JapanFans is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Japan Fans";
    string private _symbol = "JAVHD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD42EDaf4dBb7f6d8d929735fa77FbE37a685Fb42); // Marketing Address
    address payable public teamWalletAddress = payable(0xD42EDaf4dBb7f6d8d929735fa77FbE37a685Fb42); // Team Address
