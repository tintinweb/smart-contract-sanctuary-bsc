...
contract ZHANGYISHAN is Context, IERC20, Ownable {
   
    using SafeMath for uint256;
    using Address for address;
   
    string private _name = "ZHANG YI SHAN";
    string private _symbol = "ZYS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09d64C1B99F907Dd198B25f78f6819881b43818C); // Marketing Address
    address payable public teamWalletAddress = payable(0x09d64C1B99F907Dd198B25f78f6819881b43818C); // Team Address
