...
contract BullishDragontest is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; //100%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 25; //4%
    ...
    uint256 antiDumpPeriod = 720 minutes;
