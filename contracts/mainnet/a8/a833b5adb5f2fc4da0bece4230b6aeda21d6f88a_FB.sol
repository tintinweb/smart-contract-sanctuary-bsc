...
contract FB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc5c54EE4063051a43c6f46D2e337fEc03B0aCEb8); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 10**1 * 10**9; 
