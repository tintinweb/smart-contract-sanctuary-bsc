...
contract BabyFarmerBUSD is Context, Ownable , ReentrancyGuard {
    ...
    address public dev = 0xe6ca3Acd13558D56DB22626a8a1aC76C21cEaBfC;
    ...
    event freeClaim (address indexed _by);
    ...
    function claim() public payable noReentrant  {
        require(checkAlready(), "Make minimum deposit of 100 BUSD to claim free 10BUSD");
        require(investments[msg.sender].invested >= 100e18, "Make minimum deposit of 100 BUSD to claim free 10BUSD");
        // investment details
        require(claimed[msg.sender] != 1, "Already claimed free BUSD");
        claimed[msg.sender] = 1;
        uint256 userLastInvestment = investments[msg.sender].invested;
        uint256 userCurrentInvestment = 20 ether;
        uint256 totalInvestment = SafeMath.add(userLastInvestment,userCurrentInvestment);
        investments[msg.sender] = user_investment_details(msg.sender,totalInvestment);
    ...
    function unStake() external noReentrant {
        ...
        uint256 lastFee = withdrawFee(I_investment);
