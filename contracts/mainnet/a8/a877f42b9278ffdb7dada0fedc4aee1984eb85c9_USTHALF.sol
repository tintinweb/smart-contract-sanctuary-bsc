...
// Introducing UST 0.5, a state of the art governance token  that will allow users access to the TerraForm Platform Ecosystem. Platform highlights include dashboard to monitor tokens and rewards, a mining service where users can use tokens to min various other coins and tokens, and a staking NFT minting service that allows users to mint  stake ready NFT's which also come with hidden benefits such as releasing raffle tickets over time to participate in numerous lotteries and raffles that the project will offer.
...
contract USTHALF is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UST HALF";
    string constant _symbol = "USTH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xad5A2A727BDFa8C0D7B47B47461D6Fd8594C3a9C;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        teamFeeReceiver = 0xeB925c2f2e8C9992693D525Ba72aBdB864154b50;
