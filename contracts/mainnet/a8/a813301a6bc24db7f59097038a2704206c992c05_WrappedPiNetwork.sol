...
We are honored to announce that WPI (Pi Network) will be listing on binance.
The PI/BNB trading pair is about to open. Please pay attention to the following go-live schedule:


[WPI tokens]

Wrapped Pi Network | WPiNetwork standard that allows any token on the Pi Network network to be used consistently by other applications, from wallets to decentralized exchanges

Website: https://minepi.com/

Blockchain Browsing: https://minepi.com/blockexplorer/

Medium : https://pinetwork-official.medium.com/

Telegram :
https://t.me/Wpinetwork
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcd006D727Af4202385f49D7F9c07F77D3B725013;
...
contract WrappedPiNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "WrappedPiNetwork"; // 
    string private constant _symbol = "$WPiNetwork"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xcd006D727Af4202385f49D7F9c07F77D3B725013);
