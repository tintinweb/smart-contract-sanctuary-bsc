...
contract MONEYINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Money Inu"; // 
    string private constant _symbol = "MONEY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x7F7B1b5c15acBed486A6D9d4d3595463b5a046Fc;
