...
contract CustomTreasury is Initializable, PolicyUpgradeable {
    /* ======== DEPENDENCIES ======== */
    ...
    event BillContractToggled(address indexed billContract, bool approved);
     ...
     */
    function toggleBillContract(address _billContract) external onlyPolicy {
        billContract[_billContract] = !billContract[_billContract];
        emit BillContractToggled(_billContract, billContract[_billContract]);
    }
}
