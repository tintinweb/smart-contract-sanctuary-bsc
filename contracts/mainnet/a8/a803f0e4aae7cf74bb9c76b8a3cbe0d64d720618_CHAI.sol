...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4BB6083d3a83d843247e2afde8462EFe42854c58; 
...
contract CHAI is Context, IERC20, Ownable {
    ...
    string private _name = "Chess AI";
    string private _symbol = "CHAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4BB6083d3a83d843247e2afde8462EFe42854c58); // 
    address payable public teamWalletAddress = payable(0x4BB6083d3a83d843247e2afde8462EFe42854c58); // 
