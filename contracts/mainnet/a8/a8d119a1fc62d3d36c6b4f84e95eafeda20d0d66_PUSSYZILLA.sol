...
/**
       ...
       WELCOME TO PUSSYZILLAOFFICIAL ! ! !
       
        


Telegram : https://t.me/PussyZilla
...
pragma solidity ^0.6.12;
    ...
    contract PUSSYZILLA is Context, IERC20, Ownable {
        ...
        string private _name = 'PussyZillaOffcial';
        string private _symbol = 'PUSSYZILLA';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x78b7a1Af6054107C05c26D0d48a9139eB56CCD16, 'We can not exclude Uniswap router.');
