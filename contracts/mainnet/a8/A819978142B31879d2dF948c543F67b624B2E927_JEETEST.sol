...
/**
 Telegram : https://t.me/Jeet_destroyer
*/
...
contract JEETEST is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = ( _tTotal * 3 ) / 100; // 1%

    uint256 public _maxWalletToken = ( _tTotal * 3 ) / 100; // 3%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "JEETTEST"; // 
    string private constant _symbol = "JEETEST"; //    
