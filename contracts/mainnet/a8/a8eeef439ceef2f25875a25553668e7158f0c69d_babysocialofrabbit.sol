...
/**
    Daddy token is mooning. We are the official baby version
    Dev is ELON MUSK !

    Telegram portal: https://t.me/BabySocialOfRabbit_Portal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfE5563f99933B825457b3986b67531cB7B60832a; // owner address
...
contract babysocialofrabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Baby Social Of Rabbit ";
    string private _symbol = " BabySocialRabbit ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfE5563f99933B825457b3986b67531cB7B60832a); // Marketing Address
    address payable public teamWalletAddress = payable(0xfE5563f99933B825457b3986b67531cB7B60832a); // Team Address
