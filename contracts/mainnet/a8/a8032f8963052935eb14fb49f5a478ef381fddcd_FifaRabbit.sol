...
contract FifaRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa Rabbit";
    string private _symbol = "Fifa Rabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC10e0a841B2CC957d9a2eD9a5a08a9b188316671); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC10e0a841B2CC957d9a2eD9a5a08a9b188316671); // buyback Address
