...
contract test1 is IBEP20, Auth {
    ...
    uint256 _totalSupply = 10 * 10**6 * 10 ** uint256(_decimals);
    ...
    address public marketingFeeReceiver = 0x590c17c746EE9776142E34272D6Af73Fb6eC8aCb;
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        totalFeeBuy = _liquidityFeeBuy.add(_reflectionFeeBuy).add(_marketingFeeBuy).add(devFeeBuy);
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _feeDenominator) external authorized {
        ...
        totalFeeSell = _liquidityFeeSell.add(_reflectionFeeSell).add(_marketingFeeSell).add(devFeeSell);
        feeDenominator = _feeDenominator;
    }
