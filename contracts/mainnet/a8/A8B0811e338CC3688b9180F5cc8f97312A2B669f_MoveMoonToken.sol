...
contract MoveMoonERC20 is Ownable, ERC20 {
...
contract MoveMoonToken is MoveMoonERC20, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public antiBotAmount = 100 * 10**6 * 10**18;
    ...
    function _transfer(
        ...
        if (amount > antiBotAmount || bots[sender]) {
            revert("MoveMoon Anti Bot");
        }
    ...
    function moveMoonAntiBot(uint256 amount) external onlyOwner {
