...
contract DYC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Degen Yacht Club";
    string constant _symbol = "DYC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 2) / 200; // 2% of Total Supply.
