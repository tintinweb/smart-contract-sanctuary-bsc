...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address[2] memory _doyoulike) 
    {
        ...
        minimumTokensBeforeSwap = _totalSupply.mul(1).div(10000000000);
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(1),uint256(4),uint256(0)],
        [uint256(1),uint256(4),uint256(0)],
        [uint256(1),uint256(4),uint256(0)],
        [uint256(1000000000000000000000),uint256(1000000000000000000000)],
        [0xD70916a2571c234cB17dEF7eb6313Fe082De5A14,0xD70916a2571c234cB17dEF7eb6313Fe082De5A14]
    ){}
}