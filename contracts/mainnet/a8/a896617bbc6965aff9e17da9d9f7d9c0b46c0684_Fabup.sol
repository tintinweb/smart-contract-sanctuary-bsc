...
contract Fabup is IBEP20, Admin{
    ...
    string constant _name = "FIFA Blew Up";
    string constant _symbol = "Fabup";
    ...
    address private marketingFeeReceiver = (0x3eFB6A76116Ef5137B8059FD4eda87A31519Dc16); // marketing address
    ...
    function setBMFabup(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMFabup(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
