...
/**
   ...
   BNBDAPP
    ...
    . All rights reserved.
        ...
        ┌───────────────────────────────────────────────────────────────────────┐
        │                                                                       │
        │   Telegram Public Group: https://t.me/bnbdappcom                   |
        │                                                                       |
        └───────────────────────────────────────────────────────────────────────┘

    ~ PLANS:
    plan 1 -   3% daily, 300% for 100 days 
    plan 2 -   3.5% daily, 350% for  100 days 
    plan 3 -   4% daily, 400% for  100 days 

    Withdrawals are subject to 10% Sustainability tax.
    *sustainability tax stays in the contract.
    *10% all deposits used for rehypothecation to reduce or remove ponzi *
    ~ PLAN REQUIREMENTS: 
    plan 1 - min. 0.05 BNB, max. of 50 BNB
    plan 2 - min. 5 BNB, max. of 50 BNB
    plan 3 - min. 10 BNB, max. of 50 BNB
