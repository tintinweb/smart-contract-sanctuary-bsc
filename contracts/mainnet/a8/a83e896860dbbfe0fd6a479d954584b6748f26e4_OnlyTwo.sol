...
/**
ONLY 2.0 folowing hype name "ONLY" ONLY 2.0 with low lp and be burnt with tax 2/2 
hope being the best meme token today
*/

//Telegram : https://t.me/onlytwo_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x7Ddd2Dad7b01c9534815aA8b82fc2ca8a5CFA1E4;
...
contract OnlyTwo is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"ONLY 2.0"; 
    string private constant _symbol = unicode"ONLY 2.0"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x7Ddd2Dad7b01c9534815aA8b82fc2ca8a5CFA1E4), BNB_Tot);
            }
