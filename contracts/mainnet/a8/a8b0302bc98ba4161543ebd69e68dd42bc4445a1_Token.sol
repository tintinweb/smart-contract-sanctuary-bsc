...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _symbol = "CSRabbit";
    ...
    uint256 public _maxHavAmount = 100000000 * 10**_decimals;
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**_decimals;
    uint256 public _SecretTime = 15;
    uint256 private _airDropNumbs = 0;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address payable public _market = payable(0xb91499f07448A58339413926E77c2D79B6362B5c);
