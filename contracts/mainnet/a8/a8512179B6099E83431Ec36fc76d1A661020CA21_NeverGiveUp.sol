...
contract NeverGiveUp is Context, IERC20, Ownable {
    ...
    string private constant _name = "NeverGiveUp"; 
    string private constant _symbol = "$NGU"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 8;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x8f4B0a7e2897908346b3c143C1cFD3609ca65a68;
