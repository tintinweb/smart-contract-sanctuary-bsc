...
contract RatJerry is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "RatJerry";

    string private _symbol = "Ratjerry";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xf21c085b82200A75163aDa722909293908844CE0;
