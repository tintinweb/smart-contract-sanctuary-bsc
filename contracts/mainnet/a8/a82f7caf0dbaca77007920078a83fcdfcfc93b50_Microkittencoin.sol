...
contract Microkittencoin is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Microkittencoin";
    string private _symbol = "MKC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60E68E45a59873621713F4533B1c8007b84300CA); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x60E68E45a59873621713F4533B1c8007b84300CA); // BuyBack Address
