...
contract FIFADAO is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address DEAD                                = 0x000000000000000000000000000000000000dEaD;
    address ZERO                                = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver         = 0x05f1B5Ff139F1353EA094DaBf28CA03a3B74Be85;

    string  _name                               = "FIFA DAO";
    string  _symbol                             = "$FIDAO";
