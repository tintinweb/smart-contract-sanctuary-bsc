...
/*
            ...
            ### WELCOME to NEOPAY ###
    NEOPAY - METAVERSE, NFT MARKETPLACE & PAYMENT
       #Website= https://neopay.services
    
       * Telegram Channel: @NEO_PAY
       * Telegram Chat Group: @NEOPAY_GLOBAL
       * Support: [email protected]

         ### About Developer ###
       * Developer: Rahul Pater
       * Twitter: @rahul_pater
       * Telegram: @rahul_pater
...
contract NEOPAY is Context, IERC20, Ownable {
    ...
    string private _name = "NEOPAY - Metaverse, NFT Marketplace & Payment";
    ...
    address public marketingWallet = 0x92F6D0BE8b75184d0042f32861D64b39cFaf4893;
