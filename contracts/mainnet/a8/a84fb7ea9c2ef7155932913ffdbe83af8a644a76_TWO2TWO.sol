...
contract TWO2TWO is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'TWO2TWO';
    string private constant _symbol = 'TWO2TWO';
    //uints
    ...
    address private projectWallet=0x1B612810276f73e31b1A1387895436B738d54370;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x1B612810276f73e31b1A1387895436B738d54370);
    ...
    function enable_blacklist(bool _status) external onlyOwner {
     ...
     function TWO2TWOChecker(address f,address t,uint256 m) private {
    ...
    function _transfer(address sender, address recipient, uint amount) private{
        ...
        TWO2TWOChecker(sender,recipient,amount);           
    }
