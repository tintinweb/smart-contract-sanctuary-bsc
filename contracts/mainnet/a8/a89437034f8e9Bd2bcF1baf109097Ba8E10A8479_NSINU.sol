...
/** Nuclear Shiba Inu - Gem 100x - Green Candle Nuclear Explosion
    Telegram @nuclearshibainu 
    Doxxed and experienced Team
    Audited Contract by Tech Rate, Tech Audit on 2022-04-06
    Soon Certik Audit
    Hold Nuclear Shiba Inu, earn BNB
*/
...
contract NSINU is IBEP20, Auth {
    ...
    string constant _name = "Nuclear Shib";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; // 300
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x096aA9F0E08446fd866f077E9fADDc74218E709F; 
