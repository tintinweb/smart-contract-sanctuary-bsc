...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE5837554A1d5a6f4e80AA7D66f1f4a290BB810CA; //
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "OneApe"; // 
    string private constant _symbol = "OneApe"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0xE5837554A1d5a6f4e80AA7D66f1f4a290BB810CA); //
