...
contract BurgerGrow is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "BurgerGrow"; //  Name
        _symbol = "BurgerGrow"; //  Symbol
        ...
        _marketingWalletAddress = 0x855Ed066a8065d6B4f3064caF9b821036C492DEB; // Marketing wallet 
        _devWalletAddress = 0xd9bBd9D1E747F5E32Afe7B7a94d1B763f9Bd0a5b; // Dev wallet 
