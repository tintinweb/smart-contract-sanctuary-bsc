...
*/
    ...
    function stake(string calldata pool, uint256 amount) public nonReentrant whenNotPaused {
        ...
        if (keccak256(abi.encodePacked(pool)) == keccak256(abi.encodePacked(SILVER))) {
            ...
            if (userStake[msg.sender].silverAmount == amount) totalSilverStakers ++;
        }
            ...
            if (userStake[msg.sender].goldAmount == amount) totalGoldStakers ++;
        }
            ...
            if (userStake[msg.sender].diamondAmount == amount) totalDiamondStakers ++;
        }
        else revert();
    }
