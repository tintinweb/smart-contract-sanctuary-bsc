...
/**
Telegram : https://t.me/CoinWarsBSC

Daily polls including the most trending projects in BSC, the winner gets a buyback 
with a part of our token's taxes, and this bought tokens are given randomly to our holders
*/
...
contract CoinWars is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Coin Wars';
    ...
    //DevWallets
    address public Development=payable(0x62A8Ab1472DB31B84cbFdA607502Cca11049d699);
    address public Marketing=payable(0xC49E5a89ba212ECd31fd091094B58a525113A3e4);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
