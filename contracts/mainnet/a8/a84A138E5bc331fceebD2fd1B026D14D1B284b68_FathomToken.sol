...
contract FathomToken is IERC20, Ownable {
    ...
    address public jetStreamWallet = 0x0F68B5d8EBA7A1673501939b559E42f08169A35f;
    address public devopsWallet = 0x121c05510F15469C5353C88be6a7f7363FF0E301;
    ...
    constructor() {
        router = IUniswapV2Router02(0x39255DA12f96Bb587c7ea7F22Eead8087b0a59ae);
        // pair = IUniswapV2Factory(router.factory()).createPair(
        //     router.WETH(),
        //     address(this)
        // );

        address _owner = 0x01A5F664DD1f3F016cD417bA96109C4cA7c0B894;
