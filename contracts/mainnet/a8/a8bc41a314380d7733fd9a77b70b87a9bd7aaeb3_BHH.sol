...
contract BHH is ERC20 {
	...
	address payable _fund1011Address = payable(address(0x3dcdFdE2e96B90942e261F9F390b2701f40A49De));
    address payable _fund1012Address = payable(address(0xB8E5b7A582BeF8A6d29E9450Dde36cFCcE8F5415));
    address payable _fund0711Address = payable(address(0x8E1781484c384EF1aF3D19bfaEa31d15E45eAc83));
    address payable _fund0312Address = payable(address(0x525beAb64fF14Fc148C14F61157e03Fe66733d56));
    address payable _fundhideAddress = payable(address(0xFf08511580582aA8ae6B0E3De4319FB9dDf72b0f));
    ...
    constructor(address tokenOwner) ERC20("BHH", "BHH") {
        ...
        doge = IERC20(0x55d398326f99059fF775485246999027B3197955);
        uint256 total = 10**25;
    ...
    function swapAndLiquifyV1(uint256 contractTokenBalance) public {
        ...
        _fund1011Address.transfer(balance);
    }
