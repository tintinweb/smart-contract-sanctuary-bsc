...
contract Ecuador is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ecuador";
    string private _symbol = "Ecuador";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63446a39E39aC706637663636cF800DF3d775A72); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x63446a39E39aC706637663636cF800DF3d775A72); // buyback Address
