...
contract LogiInuBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Logi Inu";
    string private constant _symbol = "$LOGI";
    ...
    address payable public DonationsAddress = payable(0xC25021C90B25CAD8ade5f624ffcB5519f3811Fd8);
    ...
    address public DonationsWallet = 0xC25021C90B25CAD8ade5f624ffcB5519f3811Fd8;
