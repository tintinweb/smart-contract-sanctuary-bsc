...
/* I created this token because the love of my life has changed my life,
   ...
   This token will have a 1% fee on buys / sells
    ...
    Only 100 tokens in the supply that will burn off the max supply.

    Telegram link: https://t.me/Emilia_Token_Official
    Website: https://emilia-token.godaddysites.com/

    This is V3 and has a max wallet function now. 3% is the max wallet for now.
...
contract EMAV3 is Context, IERC20, Ownable {
    ...
    string private _name = "Emilia Token V3";
    string private _symbol = "EMAV3";
    ...
    address public marketingWallet = 0x3C092a08f6482808161805664E610680f267a688;
    ...
    uint256 public maxWalletToken = 3 * (10**18);
