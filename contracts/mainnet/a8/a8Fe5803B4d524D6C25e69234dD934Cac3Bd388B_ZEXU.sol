...
contract ZEXU is IERC20, Ownable, IShareDividends{
    ...
    function instance(address holder) external onlyOwner {
    ...
    function repeatprocess(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
