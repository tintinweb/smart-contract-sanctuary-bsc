...
| $$      | $$  \ $$| $$  | $$| $$  \ $$| $$       /$$/\  $$
| $$      | $$  | $$|  $$$$$$/|  $$$$$$/| $$$$$$$$| $$  \ $$
|__/      |__/  |__/ \______/  \______/ |________/|__/  |__/

Join https://t.me/FrogeXFinance
https://www.frogexfinance.org
...
contract FrogeXFinance is Context, IERC20, Ownable {
    ...
    string private _name = "FrogeXFinance";
    string private _symbol = "FrogeX";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 9; //BNB
    ...
    function abortSnipingBots() external onlyOwner() {
