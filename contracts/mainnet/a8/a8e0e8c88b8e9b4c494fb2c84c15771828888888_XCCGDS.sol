...
contract XCCGDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-CCGDS";
    string private _symbol = "X-CCGDS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x273530fBb017FE40670f49f8518f651cb7791BCc); 
    address payable public BurnedWalletAddress = payable(0x273530fBb017FE40670f49f8518f651cb7791BCc); 
