...
contract LPTokenWrapper {
    ...
    IERC20 public x = IERC20(0x47B01e12e3E2ec419eaD7595e31295397CD4C4D2);
    address public PlatformAccount = 0xA13Db39BdcE5d0Ca42cAd9B41b9485ed12646f16;
...
contract ElronFarm is LPTokenWrapper, Ownable{
    ...
    address public ElronlpFarm = 0x4dAb33fbda418348f8990395C1C9A7903EC93fB6;
    ...
    function OwnerDeposit(address _userAddress, uint amount) public onlyOwner{
        require(amount > 0, "Cannot stake 0");
