...
/* lepricon.net Binance launch Pad- BNB Reward Token

website: https://lepricon.net
Listing 1 LRC = 1.2 USD
...
contract LRC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9483e7658e66dAE9352FCA3aF2f19f45cBce60FF); // Marketing Address
    address payable public charityAddress = payable(0x9483e7658e66dAE9352FCA3aF2f19f45cBce60FF); // Charity/Dev Address
    ...
    string private _name = "Lepricon Token";
    string private _symbol = "LRC";
