...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xc0F3B26025921b844ef7323c686cffbC2fDeb624;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0xc0F3B26025921b844ef7323c686cffbC2fDeb624),//fund 

        address(0xc0F3B26025921b844ef7323c686cffbC2fDeb624)//dev 
    ){
