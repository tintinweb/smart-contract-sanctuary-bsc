...
// 
//
// 📱 Telegram:https::https://t.me/+r5ic6VISk9E0YjBl
...
contract $BetCheems is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Bet Cheems", "BetCheems") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BetCheems";
    string private _symbol = "BetCheems";
