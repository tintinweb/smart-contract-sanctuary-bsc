...
contract SS3 is Context, IERC20, Ownable {
    ...
    string private _name = "ZILA2.0PLUS";
    string private _symbol = "ZILA2.0PLUS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public BCblock = 4;            
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xFe76c6395323DD458821b22DE5cADEBE9fB4B834); 
    address payable public BurnWalletAddress = payable(0xFe76c6395323DD458821b22DE5cADEBE9fB4B834); 
    ...
    uint256 public _buyMarketingFee = 3;  //买营销税
    uint256 public _buyBurnFee = 4;      //买销毁税
    
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 3; //卖营销税
    uint256 public _sellTeamFee = 4;      //卖营销税
