...
$$ |  $$ |$$   ____|$$  _$$<  $$ |  $$ | $$  $$<  $$ |  $$ |$$ |  $$ |$$  _$$<  $$   ____|
$$ |  $$ |\$$$$$$$\ $$ | \$$\ \$$$$$$  |$$  /\$$\ $$$$$$$  |\$$$$$$  |$$ | \$$\ \$$$$$$$\ 
\__|  \__| \_______|\__|  \__| \______/ \__/  \__|$$  ____/  \______/ \__|  \__| \_______|
                                                  $$ |                                    
                                                  $$ |                                    
                                                  \__|                                    
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C55b8154261909aF8e36Bf5B91018dD630424e8;
...
contract nekoXpoke is Context, IERC20, Ownable { 
    ...
    string private _name = "nekoXpoke"; 
    string private _symbol = "nXp";  
    uint8 private _decimals = 6;
    uint256 private _tTotal = 300000000 * 10**6 * 10**6;
    ...
    address payable private buybackAddress = payable(0xEd1b6b9e5a13108dFB6031Ce7A6021Fd31e29939);
    address payable public walletburn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public walletrenounce = payable(0x0000000000000000000000000000000000000000); 
    ...
    function setDivs(uint256 Div1, uint256 Div2) external onlyOwner() {
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/40000;
    }    
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        ...
        sendToWallet(buybackAddress,contractBNB);
    }
