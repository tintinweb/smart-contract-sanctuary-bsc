...
interface FOREVERSHIBAOfficial {
...
contract FOREVERSHIBAOfficialToken is FOREVERSHIBAOfficial {
    ...
    string public override name = unicode"FOREVER SHIBA";
    string public override symbol = unicode"FOREVER SHIBA";
