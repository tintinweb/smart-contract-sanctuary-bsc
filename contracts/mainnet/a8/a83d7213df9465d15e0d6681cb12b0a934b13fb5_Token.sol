...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address private safeWallet = 0x1d43dEa23511aCC5a4828C9259A2a8029F4534c2;
    ...
    address[2] memory _walletParam) 
    {
        ...
        _buyLPFee = _BUYFEE[0];
        _buyMKTFee = _BUYFEE[1];
        _buyTeamFee = _BUYFEE[2];

        _sellLPFee = _SELLFEE[0];
        _sellMKTFee = _SELLFEE[1];
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [0x1d43dEa23511aCC5a4828C9259A2a8029F4534c2,0x1d43dEa23511aCC5a4828C9259A2a8029F4534c2]
    ){}
}