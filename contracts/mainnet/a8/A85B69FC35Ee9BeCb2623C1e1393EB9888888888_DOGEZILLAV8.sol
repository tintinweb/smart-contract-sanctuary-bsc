...
contract DOGEZILLAV8 is ERC20, Ownable {
    ...
    uint256 public sellDecreaseFeeBegin = 1678096800;
    ...
    constructor() ERC20("DOGEZILLAV8", "DOGEZILLAV8") {
        ...
        globalLimit = 7_000_000_000_000 ether;
    ...
    function setBeginTime(uint256 time_) public onlyOwner {
        sellDecreaseFeeBegin = time_;
    }

    function setTimeDuring(uint256 time_) public onlyOwner {
        sellDecreaseFeeTimeDuring = time_;
    }

    function setSellDecreaseFee(uint16 sellDecreaseFee_) public onlyOwner {
        sellDecreaseFee = sellDecreaseFee_;
    }
}