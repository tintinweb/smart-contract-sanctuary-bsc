...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    bool private BurnReward1Option = true;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("BabyCatInu_Track", "BCIT", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract BabyCatInu is Main {

    constructor() Main (
        "Baby Cat Inu",       // Name
        "BCI",        // Symbol
        9,                  // Decimal
        0x6Bf4C52BBE0D303C411fA74AECE49A2D5Ced722b,     // Reward 1
        0xbfD8D655ad3dfA22eAe4fa9a1F4B8b57714999D8,     // Marketing address
        0xbfD8D655ad3dfA22eAe4fa9a1F4B8b57714999D8,     // Team address
        0xbfD8D655ad3dfA22eAe4fa9a1F4B8b57714999D8,     // Multi Use address
        100_000_000,      // Initial Supply
        80_000_000,       // Dispatch Supply
        20     // Max Tax
        ) {} 
}
