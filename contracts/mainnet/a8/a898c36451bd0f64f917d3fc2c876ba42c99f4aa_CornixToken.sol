...
/*
CORNIX TOKEN 
Cornix Token is a secure decentralized cryptocurrency platform that enables users to make 
the most out of their crypto by simplifying trading and earning rewards, while being in full 
control of their funds. CORNIX is a versatile token allowing users to trade, pool, earn and more. 
Over the last few years, there have been an explosion in new crypto assets that have emerged. 
It's becoming increasingly difficult to determine a scam from an honest crypto business. 
Unfortunately, the crypto space is riddled with scammers and grifters alike, taking advantage 
of unique gaps in a growing market. As the crypto market matures and DeFi becomes a stronger 
factor, trust in a platform is essential. The Cornix was created by industry professionals to address 
and mitigate such issues. The platform aims of establishing a unique, secure and swift trading experience. 
Vision 
We're here to help the world develop a genuinely free decentralized ecosystem. Our commitment 
is to provide the best value by creating a safe and secure experience for our users.  We are bringing 
traditional industries into the crypto space with new innovative ideas, allowing users to reach the 
corners of the digital marketplace. The Cornix app has unique features that are unavailable on other platforms.   

Cornix App 
Cornix app is a  software that automates trading on the biggest crypto exchanges. Set up a bot and 
save your time by automating trading routine with Cornix app. Cornix bots execute user-specified 
algorithms and place new orders 24/7. Select a trading pair, customize bots’ settings and you will 
never miss on a trade. Cornix app crypto trading bot supports 4 major exchanges: Binance, 
HitBTC, Huobi and UPbit.
*/
...
contract CornixToken is Context, IBEP20, Ownable {
    ...
    string  public Website = "www.cornix-token.com";
