 ...
 *                
 *                  
 *      Fees on Buy: 10%   Sell:12% 
 *                          
 *      https://t.me/ImportantWarningInu
 *         
 * 
*/         
...
contract ImportantWarningInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ImportantWarningInu";
    string constant _symbol = "StarLinkRussia";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3c5CCbD0A4Cc950AFB6C66E8A6C77b9053a2e76b;
