...
contract BRBSC is Context, IERC20, Ownable {
    ...
    string private _name = "Interwork";
    string private _symbol = "INT";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xC38A9Ee9037aE0040cb2857dA9Ee2aE5A86C9Dc5); // Marketing Address
    address payable public BuyBackWallet = payable(0x953374F4A97951f636615e1c7dbC5B4a4E908056); // Team Address
