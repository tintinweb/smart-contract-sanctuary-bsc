...
contract PinkMuuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pink Muu Inu";
    string private _symbol = "PINKMUUINU";
    uint8 private _decimals = 9;
    
    address payable public marketingWallet = payable(0x1d08c9B420c4fe9482b64964Bfa2C274664b15A1); // Marketing Address
    address payable public BuyBackWallet = payable(0x1d08c9B420c4fe9482b64964Bfa2C274664b15A1); // BuyBack Address
