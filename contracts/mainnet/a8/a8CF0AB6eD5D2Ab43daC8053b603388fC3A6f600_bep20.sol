...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f7F74Ade7105d44b427531238979C7db81b73E4; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Shikonga Inu";
    string private _symbol = "shikongaInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25F85a512199eb8271148f63Ed763baC1AE7EFd8); // Marketing Address
    address payable public teamWalletAddress = payable(0x25F85a512199eb8271148f63Ed763baC1AE7EFd8); // Team Address
