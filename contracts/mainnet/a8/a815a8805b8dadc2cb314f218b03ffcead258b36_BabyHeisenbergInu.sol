 ...
 *Submitted for verification at BscScan.com on 2022-08-14
*/
/** BabyHeisenbergInu - An honoring token to the GOAT TV Series. Freshly Launched

    BabyHeisenbergInu is a unique meme token with ultimate aim to storm the crypto space with 
    its super powers and inventions
    Won't stand for nothing because moon is the goal!

//  https://t.me/BabyHeisenbergInu
/*
*/
...
contract BabyHeisenbergInu is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("BabyHeisenbergInu", "BabyHeisenbergInu") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyHeisenbergInu";
