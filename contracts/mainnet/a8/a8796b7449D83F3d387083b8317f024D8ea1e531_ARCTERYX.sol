...
contract ARCTERYX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ARCTERYX";
    string private _symbol = "$ARX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x33aB6AfA213da9662C66310D761D4F81f931fAF1);
    address payable public teamWalletAddress = payable(0x33aB6AfA213da9662C66310D761D4F81f931fAF1);
    ...
    function blacklist(address account, bool value) public  returns(bool){
