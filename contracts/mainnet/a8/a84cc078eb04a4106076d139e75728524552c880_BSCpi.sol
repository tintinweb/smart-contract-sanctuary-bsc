...
contract BSCpi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSCpi";
   
    string private _symbol = "BSCpi";

    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x1D7ad2bE3e47DeA0b67b269c12831032975f88ec); 
    address payable public ttWal = payable(0x1D7ad2bE3e47DeA0b67b269c12831032975f88ec); 
