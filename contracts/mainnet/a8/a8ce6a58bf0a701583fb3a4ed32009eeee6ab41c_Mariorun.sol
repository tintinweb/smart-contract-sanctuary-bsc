...
Telegram: https://t.me/officialmariorun
Twitter: https://twitter.com/Mariorunbsc
...
contract Mariorun is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x098e276aAE45FFAca534c4cBE5B609B0e5bEa894); // Marketing Address
        
    address payable public teamAddress =
        payable(0x098e276aAE45FFAca534c4cBE5B609B0e5bEa894); // Team Address

    address payable public liquidityAddress =
        payable(0x098e276aAE45FFAca534c4cBE5B609B0e5bEa894); // Liquidity Address
    ...
    string private constant _name = "Mario Run ";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x098e276aAE45FFAca534c4cBE5B609B0e5bEa894).call{value: bnbForDev}("");
