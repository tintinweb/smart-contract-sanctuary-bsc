...
contract MergeGirl_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "MergeGirl";
    string private constant _symbol = "MERGIRL";
