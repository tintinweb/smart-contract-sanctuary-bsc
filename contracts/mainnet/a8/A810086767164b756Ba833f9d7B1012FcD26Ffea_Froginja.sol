...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x657f0B710464549c2c3c5557187C666165919557; // owner address
...
contract Froginja is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Froginja";
    string private _symbol = "$Froginja";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16690AdB4e68E553dd56ae97509033054C905AD8); // Marketing Address
    address payable public teamWalletAddress = payable(0x16690AdB4e68E553dd56ae97509033054C905AD8); // Team Address
