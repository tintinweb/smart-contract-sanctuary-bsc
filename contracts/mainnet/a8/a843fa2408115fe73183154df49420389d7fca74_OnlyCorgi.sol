...
contract OnlyCorgi is Context, IERC20 { 
    ...
    string private constant _name = "Only Corgi"; 
    string private constant _symbol = unicode"OnlyC"; 
