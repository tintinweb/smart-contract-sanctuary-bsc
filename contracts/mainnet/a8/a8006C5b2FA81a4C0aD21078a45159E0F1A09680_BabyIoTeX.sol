 ...
 *               NEXT 100X GEM!
 *                 Baby IoTeX
 * Dividend Token that reward $ETHEREUM every 120 minutes!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //ETHEREUM
...
contract BabyIoTeX is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "BabyIoTeX";
    string constant _symbol = "BabyIoTeX";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x9678E42ceBEb63F23197D726B29b1CB20d0064E5;  //IoTex
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9692589Ff1690f803586dc49E06Fc5918F1B5aC8;  // marketingwallet
