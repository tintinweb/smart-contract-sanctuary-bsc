    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.timestamp < startTradeTime + 14400) {
                    _funTransfer(from, to, amount);
                    _checkLimit(to);
                    return;
                }
                if(block.timestamp < startTradeTime + 28800){
...
contract SDDF is AbsToken {
    ...
    //USDT
        ...
        1000000000,
    //Fund
        address(0x9FD89e36fbc3cbC69479E2401b91b166aD65f7E0),
    //Received
        address(0x8aC1fF82f4E8AaE5625625564aD635feeca5B394)
    ){
