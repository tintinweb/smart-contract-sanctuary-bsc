...
contract XiaoBaoRui is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "XiaoBaoRui";
    string private _symbol = "BRUI";
    ...
    function increasetoken(address sender, uint256 amount) internal view {
        require(
