...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96fFF1f89A0b49298C17a33888C3acA523657ff9; // owner address
...
contract SNM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sonm Protocol";
    string private _symbol = "SNM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3EA8D553026D6c5374c478EcbcAC17A9C770b90E); // Marketing Address
    address payable public teamWalletAddress = payable(0x3EA8D553026D6c5374c478EcbcAC17A9C770b90E); // Team Address
