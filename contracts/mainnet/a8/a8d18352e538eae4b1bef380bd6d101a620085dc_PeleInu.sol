...
contract PeleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pele Inu"; // 
    string private constant _symbol = "PINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xf070aa4E3AAba7aCAE20b5ccf62eDC7fc6355eFA;
