...
contract BugsInu is IBEP20, Auth {
    using SafeMath for uint256;

    address BNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;// Rewards Wbnb
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Bugs Inu";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 29 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 383 / 100000; 
    bool inSwap;
