...
contract JINDO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1de46a8d582C48f5D0705B175064fDADa03F44f4); 
    ...
    string private constant _symbol = unicode"JINDO";
    ...
    address payable public UniSwapV1_W = payable(0x1de46a8d582C48f5D0705B175064fDADa03F44f4);
    ...
    constructor () {
        ...
        _owner = 0x1de46a8d582C48f5D0705B175064fDADa03F44f4;
