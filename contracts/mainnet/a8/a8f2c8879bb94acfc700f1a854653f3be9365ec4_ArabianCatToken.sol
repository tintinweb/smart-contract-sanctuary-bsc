...
/**
Arabican Cat's vision is to create a platform that gathers the most popular dapps in the same place. Our highest priority is creating a staking platform that offers one of the highest yields on the Ethereum network, which in turn will incentivize staking and contribute to the long-term success of the Vision

Tokenomics
Token $ACAT supply: 1,000,000,000,000

Tax Buy 2 %
Tax sell 3 %
Max wallet 3 %
💬 PORTAL : https://t.me/ArabianCatToken
...
contract ArabianCatToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF1F119Dc34F978eEf83D3c2Aad48489976D82A9C); 
    address payable public Dev_Wallet = payable(0x82bD83B6c828ae15367d96724Adc87D59bf05EfB);
    ...
    string private constant _name = "ArabianCatToken"; 
    string private constant _symbol = unicode"ACAT"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public Counter = 10**27;
    ...
    uint256 public tAmounT = Counter;
    ...
    constructor () {
        ...
        _owner = 0x82bD83B6c828ae15367d96724Adc87D59bf05EfB;
