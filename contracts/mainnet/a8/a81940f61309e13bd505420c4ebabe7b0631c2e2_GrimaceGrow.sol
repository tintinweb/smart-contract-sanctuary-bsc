...
contract GrimaceGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Grimace Grow";
    string private _symbol = "$GG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBcc5A20B17F36f62c5f4Dd2465cF4B5Adf907A64); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBcc5A20B17F36f62c5f4Dd2465cF4B5Adf907A64); // BuyBack Address
