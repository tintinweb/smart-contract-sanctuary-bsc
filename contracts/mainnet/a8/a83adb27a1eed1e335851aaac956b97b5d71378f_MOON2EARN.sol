...
//start
contract MOON2EARN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MOON2EARN"; 
    string constant _symbol = "MOON2EARN"; 
    ...
    uint256 public liquidityFee = 3; //Fees to Liquidity 
    uint256 public marketingFee = 3; // Fees to marketing wallet
    uint256 public rewardsFee = 3; // Fees for Reward Tokens
    uint256 public extraFeeOnSell = 0; //Extra fees

    uint256 public totalFee = 9; //Total fee (changes based on liq + marketing + reward fees)
    uint256 public totalFeeIfSelling = 9; //Total selling fee.
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3656411D787467452cf12d2e06bfb96a378981f6; //Change
