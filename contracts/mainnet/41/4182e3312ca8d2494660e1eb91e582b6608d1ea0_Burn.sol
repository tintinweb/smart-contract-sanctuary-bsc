...
// An inu that truly burns.
// 10% Of sells are burnt forever from the token supply.
// https://t.me/RealBurnInu
...
contract Burn is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("The Real Burn Inu", "BINU") {
        ...
        maxTransactionAmount = totalSupply * 101 / 10000; // 1% maxTransactionAmountTxn
