...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable {
    ...
    function updateTotalSupply(uint amount) internal {
        _totalSupply = amount;
    }
...
// File: contracts/doggy/Doggy.sol




contract Doggy is ERC20PausableUpgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;
    ...
    function transferAnyERC721Token(address tokenAddress, uint256 tokenId) public onlyOwner {
        IERC721Upgradeable(tokenAddress).transferFrom(address(this), owner(), tokenId);
    }
