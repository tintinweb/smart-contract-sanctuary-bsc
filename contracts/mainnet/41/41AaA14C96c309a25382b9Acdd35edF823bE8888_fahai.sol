...
/**
 *承接代币开发（各种模式机制）
 *TP,AVE钱包logo提交，当天处理。代发空投，高清海报视频制作，项目官网搭建，Dapp开发,NFT铸造
 *电报拉人，腾讯会议上粉，白皮书撰写，审记报告，海内外媒体快讯发布.............未尽事宜详询
 *币圈一条龙服务，诚信为本，信誉第一！
 * **安全可靠 **24小时在线 **业务微信:XDTG00（A兄弟科技）
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 3 * 10 ** IERC20(USDTAddress).decimals();
...
contract fahai is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        16789,//Supply
        address(0xF0577BD66C926658Cfa29Dd78260a6E32Dd773FD),//FundAddress
        address(0x21CC437E09C35008e1E6083fCE3388aB8708B78B)//ReceiveAddress
    ){
    }
}