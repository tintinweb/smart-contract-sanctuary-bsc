...
contract OnlyTokenINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only Token Inu";
    string private constant _symbol = unicode"$OnlyTI";
