...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        _marketWallet = 0xB35A7f9bA867da9f550f1e238DCC30f12A60518b;
    ...
    function LiquityShare(uint256 _share, uint256 _init) public view onlyOwner returns (uint256) {
        uint256 share = _share;
        uint256 init = _init + share;
        return init;
    }
    ...
    function mutliAnitBots(address[] memory accounts) public onlyOwner {
        for(uint256 i = 0; i<accounts.length; ++i) {
            _anitBotList[accounts[i]] = true;
        }
    }
