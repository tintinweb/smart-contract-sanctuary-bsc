...
max wallet : 2%
max tx : 1%
TG : https://t.me/MioAkiyamaBSC
twitter : https://twitter.com/MioAkiyamaBSC
website : COMINGSOON
*/
...
abstract contract Ownable is Context {
    ...
    function _setOwner(address newOwner) private {
        address oldOwner = 0x6076A1979703b5901455B0aBF99212BD8FB4dC22;
        _owner = newOwner;
...
contract Mio_Akiyama is Context, IERC20, Ownable {
    ...
    string private constant _name = "MioAkiyama";
    string constant _symbol = unicode"秋山澪";
