...
contract LEAG is ERC20 {
	...
	address private _fundAddress = address(0x5d084c0a95E265d887215C223393984ced7f8752);
    ...
    constructor(address tokenOwner) ERC20("LEAG", "LEAG") {
			...
			if(from == uniswapV2Pair){
				if(startFee > 25){
					...
					if(_startFee > 25){
						...
						amount = amount.div(1000).mul(975);
					}
