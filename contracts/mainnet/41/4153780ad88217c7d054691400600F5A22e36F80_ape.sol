...
//🐸 No, I don’t have a gambling addiction, Mom! 😦

//🦍🍻 Ape-o-Holics 🍻🦍

//Ape-o-Holics is a meme token with a goal of building a die-hard community consisted of only the most diamon-handed apes and degens 😮‍💨
//https://t.me/ape_o_holics
//https://www.ape-o-holics.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x06EB9A83502e54394D9630c7c386d5Ef114aC5b4;
...
contract ape is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Ape-o-Holics"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x06EB9A83502e54394D9630c7c386d5Ef114aC5b4), BNB_Tot);
