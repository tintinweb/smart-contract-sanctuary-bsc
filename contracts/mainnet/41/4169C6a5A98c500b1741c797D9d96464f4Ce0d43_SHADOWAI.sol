...
contract SHADOWAI is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'SHADOWAI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'SHADOWAI: incorrect fee percent');
        require(owner != address(0), 'SHADOWAI: incorrect owner address');
        require(mintToAddr != address(0), 'SHADOWAI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'SHADOWAI: transfer from the zero address');
        require(recipient != address(0), 'SHADOWAI: transfer to the zero address');
