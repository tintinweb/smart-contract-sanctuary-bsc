...
library Address{
 ...
 contract RoninInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 300_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xc8C032D3a1dB6C6d52aD3faC2A4Aa86b35aE4192;
    address public donationWallet = 0xc8C032D3a1dB6C6d52aD3faC2A4Aa86b35aE4192;

    string private constant _name = "RoninInu";
    string private constant _symbol = "RoninInu";
    ...
    Taxes public sellTaxes = Taxes(1, 4, 2, 5);
