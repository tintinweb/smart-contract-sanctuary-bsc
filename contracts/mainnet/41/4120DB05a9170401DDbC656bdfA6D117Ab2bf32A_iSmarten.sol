...
contract iSmarten is ERC20, Ownable,Pausable {
    ...
    constructor() ERC20("iSmarten", "iSmart") {
        ...
        maxTransactionAmount = 250000000 * 1e18; // 250M maxTransactionAmountTxn
        maxWallet = 250000000 * 1e18; // 250M maxWallet
        ...
        marketingWallet = address(0x1F16F537d394E3EbeC064E9a2672015121c622Dc); // set as marketing wallet
        CharityWallet = address(0x1F16F537d394E3EbeC064E9a2672015121c622Dc); // set as dev wallet
