...
contract Burracoinprototype is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Burracoinprototype";
    string constant _symbol = "PREBURRA";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //0.5%maxtax
    uint256 public _walletMax = _totalSupply * 2 / 100; //1%maxwallet
