...
contract SquixInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squix Inu";
    string constant _symbol = "SQUIX";
    ...
    uint256 public swapThreshold = _totalSupply * 39083 / 1000000; // 0.15% of supply
    bool inSwap;
