...
contract EmptyV1 is OwnableUpgradeable {
    ...
    IERC721ABurnable
{
    ...
    function setTokenOverride(uint256 tokenId, string calldata uri_) external {
        ...
        tokenUriOverrides[tokenId] = uri_;
    }
...
contract EndpointSignerManager is Initializable, OwnableUpgradeable {
    ...
    function reInitialize(string memory name_, string memory symbol_)
        public
        onlyOwner
    {
        name = name_;
    ...
    function editEndpoint(string memory key, string memory endpoint) public {
        require(currentSigner[key] == msg.sender, "access denied");
        currentEndpoint[key] = endpoint;
    }
}