...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xff426f53679B09e3cA2d908F0086b55e031b2EAe); //Tige Inu Reward
...
contract DADDYTIGEINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Daddy Tige Inu";
    string constant _symbol = "DADDYTIGE";
    uint8 constant _decimals = 4;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xff426f53679B09e3cA2d908F0086b55e031b2EAe; //Tige Inu Reward
    ...
    uint256 public swapThreshold = _totalSupply * 8 / 2000;
    ...
    require (newGas >= 199, "Max gas should be higher than 199 gwei");
        gas = newGas * 1 gwei/2;
    }
