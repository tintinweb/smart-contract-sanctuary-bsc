...
contract Maxim is ERC20 {
    ...
    uint256 public _maxTxAmount = 5 * 10**decimals();
    ...
    constructor(address tokenOwner) ERC20("MAXIM", "MAXIM") {
        ...
        USDT.approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E),total.mul(100000));
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount && LPFeefenhong.add(minPeriod) <= block.timestamp){
            if (!swapping &&
            _tokenOwner != from &&
            _tokenOwner != to &&
            from != uniswapV2Pair &&
        ...
        if (takeFee) {
            ...
            super._transfer(from, address(this), amount.div(10000).mul(200));
            super._transfer(from, address(this), amount.div(10000).mul(300));
            super._transfer(from, address(uniswapV2Pair), amount.div(10000).mul(120));
            super._transfer(from, address(this), amount.div(10000).mul(120));
            super._transfer(from, address(this), amount.div(10000).mul(30));
            super._transfer(from, address(this), amount.div(10000).mul(30));
