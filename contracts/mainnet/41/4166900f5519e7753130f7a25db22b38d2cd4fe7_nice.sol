...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xDe97aFc2d719de0178520d21A36557474567188c;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0xDe97aFc2d719de0178520d21A36557474567188c),//fund 

        address(0xDe97aFc2d719de0178520d21A36557474567188c)//dev 
    ){
