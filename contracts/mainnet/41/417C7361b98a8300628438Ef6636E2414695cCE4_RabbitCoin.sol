...
abstract contract RabbitCoinToken is IERC20, Ownable {
    ...
    uint256 private fundFee = 600; 
    uint256 private dividendFee = 800;
    uint256 private lpFee = 400; 
...
contract RabbitCoin is RabbitCoinToken {
    constructor()
        RabbitCoinToken(
            "RabbitCoin",
            "RabbitCoin",
