...
contract MOCO {
    ...
    string public name = "MOCO";
    string  public symbol = "MOCO";
	...
	solHelper help = solHelper(0x94e9D25E9Cd2F46858Db638e6D4eeAb14e1A44Aa);
	...
	constructor() {
        ...
        help.initToken(totalSupply_, address(this), tokenOwner,pairs);
