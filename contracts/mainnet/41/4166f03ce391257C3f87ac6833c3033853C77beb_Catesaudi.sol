...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x204eD685d85679a974bbC8f0Dc62Fc4C82807E97; // owner address
...
contract Catesaudi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cate Saudi";
    string private _symbol = "CS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbBCa83031A498A609f6402F8A6Ead8f1fcf076c1); // Marketing Address
    address payable public teamWalletAddress = payable(0xbBCa83031A498A609f6402F8A6Ead8f1fcf076c1); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 93;  // original 12
