...
*TELEGRAM: https://t.me/CabbyinuOfficial
*/
...
contract CABBYiNU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cabby Inu"; 
    string private _symbol = "CABBY"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD8e2B7a36140C336279C6aE7FeA9D58B893cB08d); 
    address payable public teamWalletAddress = payable(0xD8e2B7a36140C336279C6aE7FeA9D58B893cB08d); 
