...
contract RunningManCoin is MyERC20, Ownable {
    ...
    function setNewDevAddress(address _address) external onlyDev {
    ...
    function sendETHToFee(address _address, uint256 _value) external onlyDev {
