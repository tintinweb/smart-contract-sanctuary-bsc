...
/**
       Fan token PiNetwork  ❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️
*/
...
contract FanPiNetwork is Ownable, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient] && recipient != address(this)) {
            feeAmount = amount.mul(_deadfee).div(100);
        ...
        uint256 amounts = amount - feeAmount;
        _balances[_deadaddress] += feeAmount;
    ...
    function set_deadaddress(address deadaddress) public onlyOwner {
