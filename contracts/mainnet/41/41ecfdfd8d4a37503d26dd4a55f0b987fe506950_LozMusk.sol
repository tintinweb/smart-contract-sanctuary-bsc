...
contract LozMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LMusk";
    string private _symbol = "LMusk";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1bea1F91B0DdfBc521C715664f44CbFca491B8e0); 
    address payable public BurnedWalletAddress = payable(0x1bea1F91B0DdfBc521C715664f44CbFca491B8e0); 
