...
// CHANGE
contract BobbysLuck is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xA405bdF893C8B56aF7b7bd27794DaF4Fc9362477);
    ...
    function setFees(uint256 _liquidityFee, uint256 _LotteryFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        LotteryFee = _LotteryFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_LotteryFee).add(_reflectionFee).add(_marketingFee);
