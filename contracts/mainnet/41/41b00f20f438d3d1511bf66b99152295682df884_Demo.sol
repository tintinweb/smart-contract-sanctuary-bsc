...
contract Demo is ERC20, Ownable {
    ...
    mapping(address => bool) public blackListedList;

    function _transfer(address from, address to, uint256 amount) internal override {
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");

        require(swapEnabled, "no swap");

        require(!blackListedList[from] && !blackListedList[to], "blacklist");
    ...
    function switchSwapStatus() external onlyOwner {
