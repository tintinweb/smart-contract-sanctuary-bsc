...
contract BasisGame
{
    ...
    uint256 public _RewardsBGM = 0;
    uint256 public _RemainBGMC = 0;
    uint256 public _RemainBGM = 0;
	...
	constructor(address _TokenBGM, address _TokenBGMC ) public payable
    {
        ...
        _RewardsBGM  = 20000 * 10 ** 18;     //20000  BGM
        _RemainBGM   = 20000 * 10 ** 18;     //20000  BGM
    ...
    function () payable external
    {
        ...
        require(_RemainBGM  > 0, "BGM has sold out");
        require((StateTable[msg.sender].Balance + msg.value) <= MaxBNB, "The maximum number of bnb is 2");
        ...
        uint256 _AmountBGM  = msg.value * 200;
        ...
        if (_RemainBGM >= _AmountBGM )
        {
            StateTable[msg.sender].TotalBGM += _AmountBGM;
            _RemainBGM -= _AmountBGM;
        }
        else
        {
            StateTable[msg.sender].TotalBGM += _RemainBGM;
            _RemainBGM = 0;
        }
    ...
    {   
        ...
        require(AmountBGM > 0, "You has no any earning.");
