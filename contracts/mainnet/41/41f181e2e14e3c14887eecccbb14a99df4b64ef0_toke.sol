...
abstract contract Token is IERC20, Ownable {
    ...
    uint256 public _waishui = 200;   //卖税
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xC37FB19f971167132561377f2057B7c5FfD189Fb;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xC37FB19f971167132561377f2057B7c5FfD189Fb),//fund address
    
        address(0xC37FB19f971167132561377f2057B7c5FfD189Fb)//dev address
    ){
