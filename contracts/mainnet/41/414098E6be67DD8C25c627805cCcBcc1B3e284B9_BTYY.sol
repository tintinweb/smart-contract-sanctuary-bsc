...
contract BTYY is TradingManager, Excludes, DividendFairly {
...
//        address to = _msgSender();
        ...
        setSwapTokensAtUSDT(100 ether, 500 ether);   // min u max u
//        setSwapTokensAtUSDT(1 ether, 1113 ether); // min u max u
        ...
        super.__FeeManager_init(_router[1], 800, 800);
        super.__FeeLP_init(to, 400);
        super.__FeeToken_init(addressDEAD, 200);
        // burn
        // __DividendFairly_init(uint256 _feeDividend, address _holdToken, uint256 _holdToken4RewardCondition, uint256 _dividendAtUSDT, address[] memory path)
        super.__DividendFairly_init(200, address(pair), 1 ether, 200 ether, _sellPath);
