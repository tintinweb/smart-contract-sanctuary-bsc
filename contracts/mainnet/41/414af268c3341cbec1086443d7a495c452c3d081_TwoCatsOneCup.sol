...
2Cats1cup | -18 Porn Cats.

BIG SHITPROJECT ABOUT 2 CATS AND 1 CUP.

NEXT 100X SHITGEMS 

Total Supply : 1 000 000 000 2C1C Tokens
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x870B9eb1102bE43c3d289c5D12b22570EaC85761;
...
contract TwoCatsOneCup is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x460346ac88716FD129875B5148aeb71616c0e32F);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "2Cats1Cup";
    string private _symbol = "2C1C";
    ...
    uint256 public _maxWalletToken = 20000000 * 10**9;
