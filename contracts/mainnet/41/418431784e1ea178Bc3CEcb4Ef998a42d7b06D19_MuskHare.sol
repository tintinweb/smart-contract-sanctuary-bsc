...
contract MuskHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuskHare";
    string private _symbol = "MuskHare";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xD3Ae797f1B4F5bffA484b498b33c34D9c3FB21e5); 
