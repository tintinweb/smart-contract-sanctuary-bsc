...
contract SUEKICHI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUEKICHI";
    string private _symbol = "SUEKICHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB238422EAa1bC6FbF7Cb983bEC0471E60f0a15ac
); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xB238422EAa1bC6FbF7Cb983bEC0471E60f0a15ac
); // Team Address
