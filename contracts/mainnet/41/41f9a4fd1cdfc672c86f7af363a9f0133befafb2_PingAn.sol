...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function initializer(address newOwner) external onlyOwner returns (bool) {
...
contract PingAn is Ownable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "PingAn";    
    string public symbol = "PingAn";
    ...
    function setPingAnCoolDown(uint256 newCoolWait) external onlyOwner {
        require(
