...
contract PradaNetwork is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xfF0897E602a33de252745DaD87E5735CA09EC208);

    string private _name = "PradaNetwork";
    string private _symbol = "PRADA";
