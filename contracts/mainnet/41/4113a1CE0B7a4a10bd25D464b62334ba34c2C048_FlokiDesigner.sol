...
contract FlokiDesigner is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x12d454B100C87cEbC1cC7Aa0F1834727d2256165); 
    address payable public Wallet_Dev = payable(0x12d454B100C87cEbC1cC7Aa0F1834727d2256165);
    ...
    string private constant _name = "Floki Designer"; 
    string private constant _symbol = unicode"FDESIGN"; 
    ...
    function setPercentTax (uint256 Marketing, uint256 Team,uint256 Burn, uint256 Liquidity) public onlyOwner{
    ...
    function claimToken() external onlyOwner {
        uint256 ClaimToken = balanceOf(address(this)) * Percent_Marketing / (Percent_Marketing + Percent_AutoLP);
        _basicTransfer(address(this), Wallet_Marketing, ClaimToken);
    }
