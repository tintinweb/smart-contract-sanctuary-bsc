 ...
 * An extensive variety of security measures for the user's and community's safety have been implemented from our part but you need to exercise due diligence. No action, suit or proceeding before or by any court or governmental agency or body, domestic or foreign, can be taken against the developers of this contract.
 * We hope you have fun with the coinbird and please abide by our principles: Always be kind to one another and friendly to other communities, especially genuine ones.
 */
 ...
 * No part of this smart contract may be copied, redeployed or modified without permission from the developers.
 * If you wish to copy or modify and use parts of the smart contract contact "Gustav the Coinbird" directly at [email protected]
 */
...
contract Coinbird is ferocious, feathery
{
    ...
    address public immutable Goose = 0xF40f982A53F4418F2186195e50FA551e72deb2e2;
    address public immutable Lettuce = 0xD51711e3Fb51acD5E0a81e6FD585562A288a414f;
    address public immutable IceGoose = 0x5d8FD9aC7dbbb7532BDDA1283E5923FB6D39444D;
