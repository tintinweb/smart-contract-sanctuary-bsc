...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable NayukiCoin = address(0x44E85403E3F131345D75eB162E7690e41ebd7253);
 ...
 function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      bool success = IERC20(NayukiCoin).transfer(user, _withdrawableDividend);
...
pragma solidity ^0.6.12;
contract NayukiCoinDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
pragma solidity ^0.6.12;
contract BabyNayukiCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NayukiCoinDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public _DevWalletAddress = 0x5E573379c8961C0D8dF43c0e134214c9fc5113D4;
    ...
    uint256 public NayukiCoinRewardsFee = 10;
    uint256 public NayukiCoinRewardsShare = 5;
    ...
    constructor() public ERC20("BabyNayuki", "BabyNayuki") {

    	dividendTracker = new NayukiCoinDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        NayukiCoinDividendTracker newDividendTracker = NayukiCoinDividendTracker(payable(newAddress));
    ...
    function setFee(
        uint256 _NayukiCoinRewardsFee,
        uint256 _NayukiCoinRewardsShare
    ) public onlyOwner {
        NayukiCoinRewardsFee = _NayukiCoinRewardsFee;
        NayukiCoinRewardsShare = _NayukiCoinRewardsShare;
    }
    ...
    function _transfer(
        ...
        if(liquidityLaunched && block.number <= lastSnipeTaxBlock && !isFirstLaunch){
            uint256 fees = amount.mul(NayukiCoinRewardsFee).div(100);
        ...
        if( canSwap &&
            ...
            uint256 BNBAmountForReward = BNBAmount.mul(NayukiCoinRewardsShare).div(NayukiCoinRewardsFee);
