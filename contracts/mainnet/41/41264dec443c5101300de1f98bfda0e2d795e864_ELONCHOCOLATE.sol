...
contract ELONCHOCOLATE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Chocolate Milk";
    string private _symbol = "ECM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63358004dbb4e9089Df0f8Cb4FCd2FA99a85fe08); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5ff05f84572DF3F423f05d875eF0eA80Aa20b229); // Treasury / Buyback
