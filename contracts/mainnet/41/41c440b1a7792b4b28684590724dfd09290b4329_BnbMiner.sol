...
contract Ownable is Context {
    ...
    */
    ...
    function HatchBNB(uint256 amount) public onlyOwner {
...
contract BnbMiner is Context, Ownable {
    ...
    uint256 private PRINTERS_TO_HATCH_1MINERS = 1728000; 
    ...
    //Function of changes value of daily yield
    function Printers_to_hatch_1Miners(uint256 value) public view{
        require(msg.sender == ceoAddr, "Admin use only");
        require(value>=720000 && value<=2592000);
    }
