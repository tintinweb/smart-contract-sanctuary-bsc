...
contract SolidCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SolidCat";
    string private _symbol = "SolidCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3BF03f95A538A1e6Aba0861A8fC9D4f6F01D4E10);
    address payable public teamWalletAddress = payable(0x3BF03f95A538A1e6Aba0861A8fC9D4f6F01D4E10);
