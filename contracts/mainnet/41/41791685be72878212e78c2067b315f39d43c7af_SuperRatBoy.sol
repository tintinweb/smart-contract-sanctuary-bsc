...
/*
    Telegram    : https://t.me/superratboy
    Website     : https://superratboy.io/

    COME AND JOIN US! DONT MISS IT!!!
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37B4Bbfa5B236e4ed98F8E41DF6b6d4Fbe1D9Dbb; // owner address
...
contract SuperRatBoy is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Super Rat Boy";
    string private _symbol = "$SPR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37B4Bbfa5B236e4ed98F8E41DF6b6d4Fbe1D9Dbb); // Marketing Address
    address payable public teamWalletAddress = payable(0x37B4Bbfa5B236e4ed98F8E41DF6b6d4Fbe1D9Dbb); // Team Address
