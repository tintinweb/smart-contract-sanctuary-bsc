...
// TG:@MogulChain
// Huge callers behind this, alpha launch. CAMEL IS DEV
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MogulChain1 is  Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mogul Chain";
    string private _symbol = "MOGUL";
