...
contract test  is ERC20, Ownable {
    ...
    constructor() ERC20("TEST", "TEST") {
        ...
        buyTotalFees = buyVaultFee + buyLiquidityFee + buyDevFee;

        sellVaultFee = _sellVaultFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellVaultFee + sellLiquidityFee + sellDevFee;

        VaultWallet = address(0x8545b223f10a64282a3540cF571dF585e20AD89A); // set as vault wallet
        devWallet = address(0x8545b223f10a64282a3540cF571dF585e20AD89A); // set as dev wallet
    ...
    function updateVaultWallet(address newVaultWallet)
        external
        onlyOwner
    {
    ...
    function swapBack() private {
        ...
        uint256 ethForVault = ethBalance.mul(tokensForVault).div(
            totalTokensToSwap
        );
        uint256 ethForDev = ethBalance.mul(tokensForDev).div(totalTokensToSwap);

        uint256 ethForLiquidity = ethBalance - ethForVault - ethForDev;
        ...
        (success, ) = address(VaultWallet).call{
