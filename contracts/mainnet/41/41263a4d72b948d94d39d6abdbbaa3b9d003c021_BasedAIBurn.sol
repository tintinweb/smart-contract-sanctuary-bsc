...
contract BasedAIBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Based AI Burn";
    string private constant _symbol = "BAIBURN";
