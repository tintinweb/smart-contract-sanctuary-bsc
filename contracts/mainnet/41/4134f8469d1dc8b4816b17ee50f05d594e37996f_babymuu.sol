...
contract babymuu is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyMuu 2.0"; // 
    string private constant _symbol = "BM2.0"; //    
    uint8 private constant _decimals = 9; // 
    bool private trading = true;
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xC2F6007470f20345C15f06b9aAd241b474fD431b;
