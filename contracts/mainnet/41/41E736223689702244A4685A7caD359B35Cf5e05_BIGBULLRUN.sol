...
contract BIGBULLRUN is ERC20, Auth {
    ...
    string constant _name = "BIGBULLRUN";
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 1000; //total amount of tokens contract will sell each time
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x08427b61be6C639AF4C0c8e862Dfdc68729a3313;
        devFeeReceiver = 0x4a4397f56a7544D52793Ea51aD5BEAb07abf74F8;
    ...
    function enable_VIP (bool _status) public onlyOwner {
        VIPmode = _status;
    }
