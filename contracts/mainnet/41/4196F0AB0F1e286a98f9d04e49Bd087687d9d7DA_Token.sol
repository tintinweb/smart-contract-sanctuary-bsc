...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _blackAddress = 0xCA2b92B8F90F008559f8da861BA5e326DfCE7c09;
    address private ddddAddress = 0x000000000000000000000000000000000000dEaD;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _tradeAddress, lpAmount, lpFist, 0, 0, ddddAddress, block.timestamp
                );
            }
        }
    }
    ...
    function setddddAddress(address addr) external onlyOwner {
        ddddAddress = addr;
        _feeWhiteList[addr] = true;
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x99d8Fc197b7d7338316b1ea2365CeaE37374A9c9),
