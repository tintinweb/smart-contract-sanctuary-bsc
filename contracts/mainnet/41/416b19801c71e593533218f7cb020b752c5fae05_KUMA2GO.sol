...
contract KUMA2GO is Context, IERC20, Ownable {
    ...
    string private constant _name = "KUMA2GO";
    string private constant _symbol = "KUMA2GO";
    ...
    address private marketingWallet = address(0x008161e0BBb0cAe487a2711E4df50313e6b0C990);
