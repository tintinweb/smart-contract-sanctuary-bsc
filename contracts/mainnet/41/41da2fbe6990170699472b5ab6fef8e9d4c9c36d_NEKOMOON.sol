...
contract NEKOMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xf4F0F1df20ecE8582c9666F8119Ad9DCE4C84f9a;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "NEKO MOON";
    string constant _symbol = "$neko moon";
