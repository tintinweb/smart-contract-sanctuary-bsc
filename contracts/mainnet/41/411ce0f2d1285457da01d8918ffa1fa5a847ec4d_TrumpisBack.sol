...
telegram : https://t.me/trumpisback
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd923d0366CcD3606c63a5A13D13D38c0E259E601; // whatDOGE
...
contract TrumpisBack is Context, IERC20, Ownable {
    ...
    string private _name = "Trump is Back";
    string private _symbol = "TIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5617c80185441a6A90bAa3BCe075C7a19f351b11); // Marketing Address
    address payable public teamWalletAddress = payable(0x5617c80185441a6A90bAa3BCe075C7a19f351b11); // Team Address
