...
contract Kangaroo {
    ...
    address usdt = 0x1303Ca271f86D7FB25D6f2d0D3BeF274E2319B37;
    ...
    function mineUSDT(address ref) public {
        ...
        //send referral eggs
        claimedUSDT[referrals[msg.sender]] = SafeMath.add(
            claimedUSDT[referrals[msg.sender]],
    ...
    function buyMiners(address ref, uint256 amount) public {
        ...
        ERC20(usdt).transfer(ceoAddress, fee2);
        ERC20(usdt).transfer(ceoAddress2, fee - fee2);
        claimedUSDT[msg.sender] = SafeMath.add(
            claimedUSDT[msg.sender],
            minersBought
        );
        mineUSDT(ref);
    }
