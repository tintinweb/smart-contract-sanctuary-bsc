...
contract PURPLECAT is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('PURPLE CAT', 'PCAT') {
        require(
            feeAccount != address(0),
            'PURPLE CAT: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'PURPLE CAT: incorrect fee percent');
        require(owner != address(0), 'PURPLE CAT: incorrect owner address');
        require(mintToAddr != address(0), 'PURPLE CAT: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'PURPLE CAT: transfer from the zero address');
        require(recipient != address(0), 'PURPLE CAT: transfer to the zero address');
