...
contract GWEI is Context, IERC20, Ownable {
    ...
    string private _name = "GWEI";
    string private _symbol = "GWEI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0c46b4544B0B6565Bd099C85715a15fE5DB42532);
    address payable public developmentWalletAddress = payable(0xC0b69d67d674936E9278CAc647Df6b85542E4E48);
    ...
    uint256 private minimumTokensBeforeSwap = 21000000000 * 5 **_decimals; 
