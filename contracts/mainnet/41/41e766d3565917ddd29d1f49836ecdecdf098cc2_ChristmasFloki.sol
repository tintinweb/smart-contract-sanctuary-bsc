...
// 
//WEBSITE: will be live today 
//long hold for xmas guys 
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("ChristmasFloki_Track", "XMF", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
    ...
    function Launch(uint256 Blocks) external onlySharedOwners {
        ...
        require(Blocks <= 240, "Not more than 1mn");
        tradingEnabled = true;
...
contract ChristmasFloki is Main {
    ...
    constructor() Main (
        ...
        0x913Fc06F65DCf446992470ef51B82a4B6ACf26F9,     // Marketing address
        0x913Fc06F65DCf446992470ef51B82a4B6ACf26F9,     // Team address AND DEV
        0x913Fc06F65DCf446992470ef51B82a4B6ACf26F9,     // Multi Use address (CHARITY)
