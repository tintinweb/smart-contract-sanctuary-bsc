...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x94D3EDdb157AF68b8D7ceda78647F0Bd7bc26Ea5; // owner address
...
contract sonicbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SonicXBSC";
    string private _symbol = "SXB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1408451C90698C518311de98C0DD341dBFc34Add); // Marketing Address
    address payable public teamWalletAddress = payable(0x1408451C90698C518311de98C0DD341dBFc34Add); // Team Address
