...
contract shihtzuak47 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShihTzu AK47"; // 
    string private constant _symbol = "$ShihTzuak47"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xC2C4C3022e6C3A854e60154fb62557eB78eDE4ed;
