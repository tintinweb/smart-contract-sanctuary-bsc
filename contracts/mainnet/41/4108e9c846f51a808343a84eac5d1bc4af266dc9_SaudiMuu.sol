...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x94465D2a3e2Db589f8D988c4133BAed63Ed401FC;
...
contract SaudiMuu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Muu"; // 
    string private constant _symbol = "S'MUU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x94465D2a3e2Db589f8D988c4133BAed63Ed401FC);
