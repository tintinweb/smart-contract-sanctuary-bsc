...
contract OfficialSquidCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidCoin";
    string private _symbol = "$SQUIDS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7ea75e7159bd1c939d9f6241E0811039089F94eB); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0x59a55A4777EAA755b8447e229eA555652a2e2380); // BuyBack Address
