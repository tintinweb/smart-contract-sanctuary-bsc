...
contract TOKEN is IERC20, Ownable {
    ...
    address private sat = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address private projectAddress = 0xfA72686A6B86Ea4A19c035709D7CB9FEdd9B67A7;
   

    uint256 private _tFeeTotal;

    string private _name = "LEEDS";
    string private _symbol = "LEEDS";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 300;
    uint256 private _previousburnFee;

    uint256 public _LPFee = 700;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 1 * 10**2 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 999 * 10**5 * 10**9)_burnFee = 0;
    ...
    function swapEthForToken(uint256 ethAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 TestE = IERC20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);//doge代币地址--
    ...
    function swapThisTokenForToken(uint256 thisTokenAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 SAT = IERC20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);//doge代币地址--
