...
/**
 *       🔥HOLD BabyLuckyBlock  AND EARN LuckyBlock  🔥
The original LuckyBlock reflection token 	
✅  VERIFIED CONTRACT
✅  LOCKED LIQUIDITY 
✅  5% LUCKYBLOCK REWARDS

TG Group  https://t.me/BabyLuckyBlockBSC
...
“Our focus is to develop further transparency and fairness in gaming”
The internet has created a demand for online gambling, with companies offering easily accessible online wagering. 
...
Lucky Block envisions a worldwide lottery with players using Blockchain Protocols, operating on the binance smart chain.
 We believe the lottery should not be bound geographically or tied to local financial systems. 
 Instead, our focus is to develop further transparency and fairness in gaming, creating a lottery where every player has better win odds while providing 
 a solid investment strategy for token holders while contributing to the community.
...
☑️ 𝕋𝕆𝕂𝔼ℕ𝕆𝕄𝕀ℂ𝕊 
🟣 1.000.000.000
🟣 5% 🔥luckyblock tokens For rewards🔥
 
☑️ 𝕋𝔸𝕏𝔼𝕊 15% 
🟣 5% Redistribution of holders As luckyblock tokens
🟣 10%  Liquid Pool and marketing wallet
🟣 2% MAX WALLET

How To :
1-☑️ Download & setup MetaMask or TrustWallet
2-☑️ Buy and send BNB to MetaMask
3-☑️ Head on to PancakeSwap and swap for $BabyLuckyBlock
4-☑️ View $BabyLuckyBlock and HODL
Swap BNB for BabyLuckyBlock . Now you need to add BabyLuckyBlock to your MetaMask  or Trust Wallet to view your BabyLuckyBlock . 
5-☑️ Our unique reward system is triggered by volume (buy + sell activity to cover gas fees) 💯
Pay-outs to holders may not occur every hour if trading volume is low. When this is the case, the amount of rewarded LuckyBlock each holder will receive does not decrease 🥳
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2cD96e8C3FF6b5E01169F6E3b61D28204E7810Bb); //LUCKYBLOCK
...
contract BabyLuckyBlock is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyLuckyBlock";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2cD96e8C3FF6b5E01169F6E3b61D28204E7810Bb;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1e7d63DDE54f9aEA12495B0F47012bFA34bbd40f;
