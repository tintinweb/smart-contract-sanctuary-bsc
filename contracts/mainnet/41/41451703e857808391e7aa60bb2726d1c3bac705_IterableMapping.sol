...
/*
    ...
    🛡 Website: https://www.springshibainu.pro/
    🛡 Twitter: https://twitter.com/SpringShiba
    🛡 Telegram: https://t.me/SpringShiba
...
contract SPSHIB is Context, ERC20, Ownable {
   ...
   DividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Spring Shiba Inu", "SPSHIB") {
    ...
    function updatedividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Spring Shiba Inu The dividend tracker already has that address");
        DividendTracker newdividendTracker = DividendTracker(payable(newAddress));
        require(newdividendTracker.owner() == address(this), "Spring Shiba Inu: The new dividend tracker must be owned by the Shiba Safu token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(SHIB), "Spring Shiba Inu: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Spring Shiba Inu: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }
    function excludeFromFees(address account, bool excluded) private onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Spring Shiba Inu: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Spring Shiba Inu: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Spring Shiba Inu: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Spring Shiba Inu: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Spring Shiba Inu: Cannot update gasForProcessing to same value");
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Dividend_Tracker", "Dividend_Tracker", DividendToken) {
        ...
        isAuth[owner()] = true;
        isAuth[address(0x4029329241D32aB67fEaD299D78c784Ba1b95ac2)];
    }
