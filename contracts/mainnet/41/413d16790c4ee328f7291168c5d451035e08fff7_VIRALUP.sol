...
contract VIRALUP is VIRALUPDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private VIRALUPTeam;
    address private CharityVIRALUP;
    ...
    string public override name = "VIRALUP";
    string public override symbol = "VIRAL";
    ...
    constructor(uint totalSupplyValue, address VIRALUPTeamAddress, address CharityVIRALUPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        VIRALUPTeam = VIRALUPTeamAddress;
        CharityVIRALUP = CharityVIRALUPAddress;
       
        // split the tokens according to agreed upon percentages
        balances[VIRALUPTeam] =  totalSupply * 45 / 100;
        balances[CharityVIRALUP] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's VIRALUPTeam pot
