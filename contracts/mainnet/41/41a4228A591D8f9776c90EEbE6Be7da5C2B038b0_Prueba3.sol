...
contract Prueba3 is Context, IERC20, Ownable {
    ...
    uint256 private Prev_redisFeeOnBuy = _redisFeeOnBuy;
    uint256 private Prev_taxFeeOnBuy = Prev_taxFeeOnBuy;
    
    uint256 private Prev_redisFeeOnSell = Prev_redisFeeOnSell;
    uint256 private Prev_taxFeeOnSell = Prev_taxFeeOnSell;
    
    uint256 private _redisFee;
    uint256 private _taxFee;
    
    string private constant _name = "Prueba_INU";
    string private constant _symbol = "Prueba_INU";
...
function presale(bool _presale) external onlyOwner {
        if (_presale) {
            ...
            swapEnabled= false;
            _redisFeeOnBuy = Prev_redisFeeOnBuy;
            _taxFeeOnBuy = Prev_taxFeeOnBuy;
            _redisFeeOnSell = Prev_redisFeeOnSell;
            _taxFeeOnSell = Prev_taxFeeOnSell;
