...
contract VoltGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Volt Grow"; 
    string private _symbol = "VoltGrow"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D90abd8ff3B81C09230a262E03bCC716f2F6365); 
    address payable public teamWalletAddress = payable(0x84D3f1CA24d3E6AcCf679223aD9B3E34460EACbe); 
