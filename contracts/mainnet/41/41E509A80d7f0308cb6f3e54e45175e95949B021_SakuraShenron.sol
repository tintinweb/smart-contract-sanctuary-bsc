...
/**
 Sakura Shenron: Prepare yourself to a New Generation of Meme Token.It is set to be the one of the largest Meme Coin on Binance Smart Chain, The grow will not stop and we will reach the top! 

We have a solid line up before and after launch and Big Marketing Plan ahead! SakuraShenron is a New Generation of Meme Token,This will be driven by the team and the supporting community to become the next big thing on BSC. 
...
☎️TELEGRAM PORTAL: https://t.me/SakuraShenron
🐉TWITTER: https://twitter.com/SakuraShenron
🌐WEBSITE: https://www.sakurashenron.com
...
contract SakuraShenron is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sakura Shenron"; 
    string private constant _symbol = "SASHEN"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 12;
    address public _marketingWallet = 0x990af8F6bEFE48FB8e4F007c67EfbF9233E811bb; 
