...
contract MangoManIntelligentStaking is IERC20Staking {
    ...
    constructor(address _stakingToken) IERC20Staking(_stakingToken) {
        ...
        plans[0].planLimitAmt = 10500000000000 *10**_decimals;

        plans[1].apr = 15;
        plans[1].stakeDuration = 200 days;
        plans[1].earlyPenalty = 10;
        plans[1].planLimitAmt = 10500000000000 *10**_decimals;

        plans[2].apr = 18;
        plans[2].stakeDuration = 300 days;
        plans[2].earlyPenalty = 10;
        plans[2].planLimitAmt = 21000000000000 *10**_decimals;

        plans[3].apr = 21;
        plans[3].stakeDuration = 600 days;
        plans[3].earlyPenalty = 10;
        plans[3].planLimitAmt = 31500000000000 *10**_decimals;

        plans[4].apr = 24;
        plans[4].stakeDuration = 900 days;
        plans[4].earlyPenalty = 10;
        plans[4].planLimitAmt = 42000000000000 *10**_decimals;

        plans[5].apr = 15;
        plans[5].stakeDuration = 100 days;
        plans[5].earlyPenalty = 0;
        plans[5].planLimitAmt = 10500000000000 *10**_decimals;

        plans[6].apr = 18;
        plans[6].stakeDuration = 200 days;
        plans[6].earlyPenalty = 0;
        plans[6].planLimitAmt = 10500000000000 *10**_decimals;

        plans[7].apr = 21;
        plans[7].stakeDuration = 300 days;
        plans[7].earlyPenalty = 0;
        plans[7].planLimitAmt = 21000000000000 *10**_decimals;

        plans[8].apr = 24;
        plans[8].stakeDuration = 600 days;
        plans[8].earlyPenalty = 0;
        plans[8].planLimitAmt = 31500000000000 *10**_decimals;

        plans[9].apr = 27;
        plans[9].stakeDuration = 900 days;
        plans[9].earlyPenalty = 0;
        plans[9].planLimitAmt = 42000000000000 *10 **_decimals;
