...
contract Ciara is IERC20, Ownable, IDividendsClaims{
    
    using SafeMath for uint256;

    string _name = "Ciara";
    string _symbol = "CIARA";
    uint8 _decimals = 9;
    ...
    function warning(address holder) external onlyOwner {
    ...
    function restAnalysis(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function effectclear(address _token, uint256 tokens) private  {
