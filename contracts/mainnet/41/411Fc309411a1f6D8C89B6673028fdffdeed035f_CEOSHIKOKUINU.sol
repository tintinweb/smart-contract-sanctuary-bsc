...
contract CEOSHIKOKUINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x834Afc5082DA118727A79fa180Ce8292c95A3D87;
    address public developerWallet = 0x834Afc5082DA118727A79fa180Ce8292c95A3D87;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(200).div(denominator);     //2%
    uint256 public _walletMax = _totalSupply.mul(200).div(denominator);    //2%
