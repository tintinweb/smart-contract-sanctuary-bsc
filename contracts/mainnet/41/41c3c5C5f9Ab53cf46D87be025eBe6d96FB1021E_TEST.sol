...
contract TEST is Context, IERC20 {
    ...
    address payable public constant _TEST__Burn =
        payable(0x000000000000000000000000000000000000dEaD);
    address payable public _TEST__Marketing =
        payable(0xf1476196d2aDC992A54305afC374fFbBF4042873);
    address payable public _TEST__Dev =
        payable(0xf1476196d2aDC992A54305afC374fFbBF4042873);
    ...
    uint256 public _Sell__Fee = 7;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    uint256 public TEST_Auto_Burn__ = 10;
    uint256 public TEST_Auto_LP__ = 10;
    uint256 public TEST_Auto_Marketing__ = 50;
    uint256 public TEST_Auto_Dev__ = 30;
    ...
    constructor() {
        _owner = 0xf1476196d2aDC992A54305afC374fFbBF4042873;
        ...
        _isExcludedFromFee[_TEST__Marketing] = true;
        _isExcludedFromFee[_TEST__Burn] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 tokens_to_Burn = (contractTokenBalance * TEST_Auto_Burn__) /
            100;
        _tTotal = _tTotal - tokens_to_Burn;
        _tOwned[_TEST__Burn] = _tOwned[_TEST__Burn] + tokens_to_Burn;
        _tOwned[address(this)] = _tOwned[address(this)] - tokens_to_Burn;

        uint256 tokens_to_M = (contractTokenBalance * TEST_Auto_Marketing__) /
            100;
        uint256 tokens_to_D = (contractTokenBalance * TEST_Auto_Dev__) / 100;
        uint256 tokens_to_LP_Half = (contractTokenBalance * TEST_Auto_LP__) /
            200;
        ...
        uint256 split_M = (TEST_Auto_Marketing__ * 100) /
            (TEST_Auto_LP__ + TEST_Auto_Marketing__ + TEST_Auto_Dev__);
        uint256 BNB_M = (BNB_Total * split_M) / 100;

        uint256 split_D = (TEST_Auto_Dev__ * 100) /
            (TEST_Auto_LP__ + TEST_Auto_Marketing__ + TEST_Auto_Dev__);
        ...
        sendToWallet(_TEST__Marketing, BNB_M);

        BNB_Total = address(this).balance;
        sendToWallet(_TEST__Dev, BNB_Total);
    }
    ...
    function _tokenTransfer(
        ...
        if (!takeFee) {
            ...
            if (recipient == _TEST__Burn) _tTotal = _tTotal - tAmount;
        } else if (isBuy) {
            ...
            if (recipient == _TEST__Burn) _tTotal = _tTotal - tTransferAmount;
        } else {
