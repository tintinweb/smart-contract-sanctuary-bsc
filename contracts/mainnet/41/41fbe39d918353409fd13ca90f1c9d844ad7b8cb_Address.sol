...
contract SilvaInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 4_000_000_000_000 * 10**9;
    ...
    string private constant _name = "SilvaInu";
    string private constant _symbol = "Silva";
    ...
    Taxes public taxes = Taxes(0, 14, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 14, 0, 0, 0);
