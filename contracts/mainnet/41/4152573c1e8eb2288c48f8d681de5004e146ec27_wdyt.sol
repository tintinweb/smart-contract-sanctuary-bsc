...
contract wdyt is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Blocky Doge";
    string private _symbol = "Blocky Doge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xa0D05B17b5CA125857AD62737EE988B98E257dDb);
