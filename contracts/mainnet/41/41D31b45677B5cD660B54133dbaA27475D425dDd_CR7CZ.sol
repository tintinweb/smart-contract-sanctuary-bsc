...
contract CR7CZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "CR7CZ";

    string private _symbol = "CR7CZ";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x3C537Ce2Ae6F33335B2399cBC3dF750Befa6576a;
