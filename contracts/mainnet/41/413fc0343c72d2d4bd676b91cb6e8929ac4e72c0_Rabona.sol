...
contract Rabona is ERC20, Ownable {
    ...
    address public marketingWallet = 0xf599c6B076C8A82A952b327BC4947846524C0b3f;
    ...
    constructor(address newOwner) ERC20("Rabona", "RA") {
    ...
    function updateBuyFees(
        ...
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy <= 0,
    ...
    function updateSellFees(
        ...
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell <= 0,
            "Fees must be less than 25%"
        );
