...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F698abFe47d3a11f456bc68043199e88006bEba; // owner address
...
contract lunaworldcup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luna World Cup";
    string private _symbol = "LWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x520DAA002802908f0c76CE2faC78bcEe187dB8fB); // Marketing Address
    address payable public teamWalletAddress = payable(0x520DAA002802908f0c76CE2faC78bcEe187dB8fB); // Team Address
