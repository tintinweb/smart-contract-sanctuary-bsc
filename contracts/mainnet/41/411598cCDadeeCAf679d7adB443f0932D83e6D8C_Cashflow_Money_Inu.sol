...
contract Cashflow_Money_Inu is IBEP20, Ownable {
    string private constant _name = "C-test1"; // Name
    string private constant _symbol = "Ctest1"; // Symbol
    ...
    constructor() {
        ...
        liquedityReceiver = address(0x2C08B4b5F6F952bE504DEC5826C17FC6cb5C04e4);
