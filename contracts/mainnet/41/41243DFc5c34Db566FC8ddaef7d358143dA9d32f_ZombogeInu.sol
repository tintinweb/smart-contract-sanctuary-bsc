...
/**
Why did the zombie apocolypse hit the doge we will never know!
P2E Walking Dead style decision based game with you Walking Doge NFT!
Game released at 250k
NFT and Tokens used in game to buy power-ups and attributes!
Weapons and upgrades also!
Google Play And Apple Store Version already being applied!
...
CONTRACT WILL BE RENOUNCED AND LP WILL BE BURNED!
We will keep the extra tokens in a reserve so that we can use for in game and staking purposes!
*/
...
contract ZombogeInu  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Zomboge Inu';
