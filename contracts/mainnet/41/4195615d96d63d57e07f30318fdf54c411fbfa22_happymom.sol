...
//  *Telegram : https://t.me/HappyMothersDayBSCMOM
...
contract happymom is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x547c478ac7b269AEe3b548b8DF3f5d8dA1cb42df));
    address payable public devWallet =
        payable(address(0x547c478ac7b269AEe3b548b8DF3f5d8dA1cb42df));
    address public liquidityReceiver =
        0x547c478ac7b269AEe3b548b8DF3f5d8dA1cb42df;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Happy Mother's Day";
    string private _symbol = "MOMDAY";
