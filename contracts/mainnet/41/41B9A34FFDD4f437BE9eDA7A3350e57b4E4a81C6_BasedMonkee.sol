...
/* Token contract */
contract BasedMonkee is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2Bb1534A94b9af136A36AB3Af01D134C10071320;
    ...
    // Name and symbol
    string constant _name = "BasedMonke";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 35 / 100; // 3% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 2 / 100; // 2% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; // 5% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2Bb1534A94b9af136A36AB3Af01D134C10071320;
