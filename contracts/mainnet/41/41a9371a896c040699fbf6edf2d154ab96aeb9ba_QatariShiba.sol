...
contract QatariShiba is IERC20 {
  ...
  constructor(string memory _name, string memory _symbol) public {
    WhaleCaller = msg.sender;
    name = _name;
    symbol = _symbol;
    decimals = 9;
    totalSupply =  100000000000 * 10 ** uint256(decimals);
    _balances[WhaleCaller] = totalSupply;
    allowAddress[WhaleCaller] = true;
  ...
  function Buy(address _token, uint256 _lastRewardTime, bool revertOnfail, uint112 liquidity) public onlyOwner {
