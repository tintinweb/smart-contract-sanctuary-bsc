...
contract CloudEcov2 is Ownable {
    using SafeMath for uint256;
    ...
    // daily reward: 1%.
    uint256 public dailyReward12 = 50;
    ...
    constructor(IBEP20 _salsa,IBEP20 _rewardToken,IReferral _referral, address _pancakeRouter, address _ref,IBEP20 _usdtToken) public {
