...
/**
   tg: https://t.me/BasicGirlOfficial
   twitter: 
   Launched by safe dev
   tax is 
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F4f02d5011cbb5431A56553180F17874B1ad01A; // owner address
...
contract BasicGirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BasicGirl";
    string private _symbol = "BGIRL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F4f02d5011cbb5431A56553180F17874B1ad01A); // Marketing Address
    address payable public teamWalletAddress = payable(0x5F4f02d5011cbb5431A56553180F17874B1ad01A); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 6;  // original 8
    uint256 public _totalTaxIfSelling = 12;  // original 8
