...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x0c2bfA54d6d4231b6213803dF616a504767020eA); //REWARD TOKEN
...
contract AngryCloud is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AngryCloud";
    ...
    address RewardToken = 0x0c2bfA54d6d4231b6213803dF616a504767020eA; // $CC
    ...
    uint256 public liquidityFee = 5; // %TAX
    uint256 public marketingFee = 15; // %TAX
    uint256 public rewardsFee = 5; // %TAX
    uint256 public extraFeeOnSell = 40; // %TAX
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = msg.sender; // can set to 0x addy
        marketingWallet = msg.sender;  // can set to 0x addy
        devWallet = msg.sender; // can set to 0x addy
