...
library Address{
 ...
 contract StardenBurdenHardenBart is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1378edecCc9165603cc0DB7B8a33dC4B02C32C67;
    address public donationWallet = 0x1378edecCc9165603cc0DB7B8a33dC4B02C32C67;

    string private constant _name = "StardenBurdenHardenBart";
    string private constant _symbol = "STARDENBURDENHARDENBART";
