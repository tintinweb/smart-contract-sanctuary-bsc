...
contract JK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JK";
    string private _symbol = "JK";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xb90bC07A80997D02b169e578f5856D4AdA3F0fcb); // Marketing Address
    address payable public teamWalletAddress = payable(0x3C7a15F6d7a659FFD55Cb57c22b96aa5B180A55A); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xa6589Ed72423A4b803BF51243707027a04e8786F),
            block.timestamp
        );
    }
