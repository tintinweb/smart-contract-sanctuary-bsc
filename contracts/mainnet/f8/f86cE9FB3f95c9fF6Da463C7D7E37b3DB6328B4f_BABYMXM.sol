...
contract BABYMXM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BABYMXM";
    string private _symbol = "BABYMXM";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xFb1faccCFEd6212354bB749a5228d561C667ef5f));
        m = payable(address(0xFb1faccCFEd6212354bB749a5228d561C667ef5f));
