...
/**
 The fastest wallet in the crypto space.

  TELEGRAM:
  https://t.me/flashwalletbsc
    TAX 3%
    LOW TAX
...
contract FlashWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flash Wallet"; // 
    string private constant _symbol = "$FLASH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x74f7e8e82c705f12eA991E63C60C855d98361473;
