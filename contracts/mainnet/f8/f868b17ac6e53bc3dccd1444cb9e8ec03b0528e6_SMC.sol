...
contract SMC is ERC20 {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx || balanceOf(_destroyAddress) >= 999 * 10**23) {
            takeFee = false;
        }else{
    ...
    function swapTokensForOtherGMC(uint256 tokenAmount) private {
		...
		path[2] = address(0xE64302898E10B5C7089Ce13347Bb5FAf47Ee1937);
