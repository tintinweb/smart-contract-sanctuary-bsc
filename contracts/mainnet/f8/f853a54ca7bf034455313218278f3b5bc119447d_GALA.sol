...
contract GALA is Context, IERC20, Ownable {
    ...
    string private constant _name = "GALA";
    string private constant _symbol = "GALA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7C75BA47E6A948023dE608E78A564257C014cA64);
    address payable private _marketingAddress = payable(0x7C75BA47E6A948023dE608E78A564257C014cA64);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 97, "Redis cannot be more than 97.");
	    require(taxFeeOnBuy < 5, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 97, "Tax cannot be more than 97.");
