...
contract ScareBears is IBEP20, Auth {
    ...
    string constant _name = "ScareBears";
    string constant _symbol = "$scare";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 3 / 1000; // 0.3% max transaction amount buy
    uint256 public _maxTxAmountSell = _totalSupply * 3 / 1000; // 0.3% max sell

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 1000; // 0.3% nax wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x67665B9f88e501FAB3DB1EC53eB5FB1E85bec752;
        marketingFeeReceiver = 0x39bf6b6f07278c55727f3d8C8FC43751D49BdcD1;
        devFeeReceiver = 0x72903204846d2Efdf1840E886AE2aD1F57f08D21;
