...
contract TrueShibaInuKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "True Shiba Inu King";
    string private _symbol = "TrueShibaInuKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1bA413Bf3cc229C8855b3B4C477d9eA3308A62CB); // Marketing Address
    address payable public teamWalletAddress = payable(0x94ba286c6230BE2796c9c0d22edf7e72D673404f); // Team Address
