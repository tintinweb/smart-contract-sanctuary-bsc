...
abstract contract Authorization {
     ...
     */
    function unauthorizeSilk(address adr) public onlyOwner {
        authorizations[adr] = false;
    }
    /**
     * init authorization. Owner only
     */
    function iniAuthorize(address _auth) public onlyOwner {
...
contract Silk is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Silk";
    string constant _symbol = "SILK";
	...
	function processSilkIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
	...
	function timeSilkClaim(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function SilkEnabled(bool _status, uint8 _interval) public onlyOwner {
        buyCooldownEnabled = _status;
        cooldownTimerInterval = _interval;
    }

    function TxLimitSilk(address holder, bool exempt) external authorized {
