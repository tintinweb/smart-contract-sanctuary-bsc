...
interface IPresaleContract {
    function getContractVersion() external view returns (uint16);
}
...
contract PresaleFactory is Ownable {
    ...
    event presaleRegistered(address presaleContract, uint16 contractVersion);
    ...
    function registerPresale (address _presaleAddress) public {
        ...
        emit presaleRegistered(_presaleAddress, IPresaleContract(_presaleAddress).getContractVersion());
    }
