...
//Telegram: https://t.me/kuzuryuinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfD025555ab08B04bef06C185d551866C7975f1c9; // owner address
...
contract kuzuryuinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kuzuryu Inu";
    string private _symbol = "$KINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfD025555ab08B04bef06C185d551866C7975f1c9); // Marketing Address
    address payable public teamWalletAddress = payable(0xfD025555ab08B04bef06C185d551866C7975f1c9); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 49999 * 10**_decimals; 
