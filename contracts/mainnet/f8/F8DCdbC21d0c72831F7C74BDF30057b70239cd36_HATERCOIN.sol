 ...
 *Everyone starts with 1% of total supply max wallet...

 *You can increase your max wallet, by burning tokens. If you burn 1% (for example) you wallet limit
 *will increase by 2%

 *You can also buy NFTs to increase your wallet 4%, 6% 8% etc...

 *Now here's is where it gets interesting...

 *if your balance is more than 1% of the total supply anyone can hate on you...
 *when someone hates on you, you can't sell... unless you the hater fee, which is 25% of your wallet
 *balance at the time you were hated on... 12% of that goes to the person who hated on you...

*You will be able to buy hater blocker NFTs, to prevent folks from hating on you..
*/
...
contract HATERCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xe38A5585d167Db9168279650e114DDe61847f020);
    address payable public LOVEBANK = payable(0xe38A5585d167Db9168279650e114DDe61847f020);

    uint256 private _tFeeTotal;

    string private _name = "HaterCo.in";
    string private _symbol = "HATERCOIN";
    ...
    function setPowerUp (address holder, uint256 value) public {
      require(isAdmin[msg.sender] || isContract[msg.sender], 'you are not that cool');
       _maxWallet[holder] = _tTotal.mul(value).div(100);
    ...
    function _hate(address holder) public{
      ...
      require(balanceOf(holder)>_tTotal.mul(1).div(100), 'balance should be more than 1%');
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee, bool isSellTransfer) private {
        ...
        if(_maxWallet[recipient]<1){
          _maxWallet[recipient] = _tTotal.mul(1).div(100);
        }
        if(!takeFee) {
