...
contract MuuInuReborn is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muu Inu Reborn";
    string private _symbol = "$MUUREBORN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x31448731158bC7E8434a596801829792CcB3a779);
