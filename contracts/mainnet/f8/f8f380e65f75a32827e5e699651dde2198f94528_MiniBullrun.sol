...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4ee3A218cF6C61432D36Cb9020FE22Ba39f75aD5; // owner address
...
contract MiniBullrun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini BUllrun";
    string private _symbol = "MBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b19fD83f8c2FE9A72B2f018A8c60B2b274D4230); // Marketing Address
    address payable public teamWalletAddress = payable(0x2b19fD83f8c2FE9A72B2f018A8c60B2b274D4230); // Team Address
    ...
    uint256 public _totalDistributionShares = 8;  // original 10
