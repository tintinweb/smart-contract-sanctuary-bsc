...
contract SquidGold is Context, IERC20, Ownable {
    ...
    string private _name = "Squid Gold";
    string private _symbol = "SquidGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBA8fA67C27fa7Dead83422c2F8EEaD7448fb547F);
    address payable public BuyBackWalletAddress = payable(0xBA8fA67C27fa7Dead83422c2F8EEaD7448fb547F);
