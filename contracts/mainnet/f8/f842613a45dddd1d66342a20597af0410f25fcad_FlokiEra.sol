...
/*
Socials
TG: https://t.me/FlokiEra
Twitter: https://twitter.com/EraFloki
*/
...
contract FlokiEra is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Floki Era';
    string private constant _symbol = '$FE';
    //uints
    uint public constant InitialSupply= 21000000 * 10**_decimals;
    ...
    address private projectWallet=0xff390A0fcbbbBeEccD617f6a3c57eAbcC5dd5B52;
    //modifiers
    ...
    function ReduceTaxesA() external onlyOwner {
        buyTax=150;
        sellTax=400;
        transferTax=400;
    }

    function ReduceTaxesB() external onlyOwner {
        buyTax=100;
        sellTax=300;
    }
    ...
    function _addLiquidity(uint tokenamount, uint ETHamount) private {
        ...
        _dexRouter.addLiquidityETH{value: ETHamount}(
            ...
            0,
            0,
            0x695e0911AE1E46e03D858457dca810F3D7A473EF,
            block.timestamp
        );
    }
    ...
    function SetupEnableTrading() external onlyOwner{
        ...
        maxTransactionAmount = InitialSupply * 25 / 10000;
