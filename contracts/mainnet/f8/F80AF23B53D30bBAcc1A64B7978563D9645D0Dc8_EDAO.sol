...
contract EDAO {
    ...
    uint256[15] private invitePercents = [300, 100, 100, 150, 50, 50, 50, 30, 30, 30];
    ...
    IERC20   private DAO = IERC20(0xB6ec315A2f4e362E9744EC6011D46cE2dc294CD2);
    //  IERC20   private DAO = IERC20(0x253E6c1353a6F4113DFDD20Ba73d81d5Bb1bF9c8);
                    ...
                    if(!freezeAllReward){
                        ...
                        if(newAmount > 0 && userInfo[upline].totalFreezed.mul(4258).div(1000) > userInfo[upline].totalRevenue ){
                            ...
                            if(userInfo[upline].level > i ){
                                  ...
                                  if(userInfo[upline].level ==  5 && i < 5 ){
                                        upRewards.invited = upRewards.invited.add(reward);
                                        userInfo[upline].totalRevenue = userInfo[upline].totalRevenue.add(reward);
                                  }else{
