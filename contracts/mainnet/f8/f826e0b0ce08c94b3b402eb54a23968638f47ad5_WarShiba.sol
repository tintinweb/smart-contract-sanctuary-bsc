...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x0b079B33B6e72311c6BE245F9f660CC385029fc3);
    IDEXRouter router;
...
contract WarShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WarShiba";
    string constant _symbol = "$WS";
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7, msg.sender);
        ...
        marketingFeeReceiver = 0x68C3D85e04C9b6d21039d31FE35BD57e443a7Bf1;
        devFeeReceiver = 0x68C3D85e04C9b6d21039d31FE35BD57e443a7Bf1;
