...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0x486f0CEBe9dbeb73b16DA0b492beB47873fbF76d);
...
contract BAT is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 188 * 1e18;
    ...
    constructor() ERC20("BAT", "BAT", 18) DividendFee() {
