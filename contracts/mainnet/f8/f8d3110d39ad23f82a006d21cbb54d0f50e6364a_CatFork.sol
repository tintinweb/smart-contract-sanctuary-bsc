...
contract CatFork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Catfork 2.0"; // 
    string private constant _symbol = "CatFork"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x176e1a8aCE648aA5Fd89F55b7De2f6f043537832;
