...
contract CLOUDNETWORK is ERC20, Ownable {
    ...
    constructor() ERC20("Cloud Network", "CLOUD") {
        _mint(msg.sender, 1000000000000 * 10**decimals());

        marketingFeeAddress = payable(
            0x10b4954D839DD6A1eB9873A1E33AFaF851593B5F
        );
        stakingFeeAddress = payable(0x10b4954D839DD6A1eB9873A1E33AFaF851593B5F);
