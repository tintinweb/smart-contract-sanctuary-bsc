...
contract HOLYINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOLY INU"; //
    string private constant _symbol = "HOLY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xc73547670e76Ef20Db8366BbD5cCcFa41A81F1a1;
