...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xADC32b0FEDc142FB4741Ea6080034C9a23AfE745;
...
contract Stokvelcoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x06Dc45648Cb97003fbc40729E72C77D6026c9b0D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Stokvelcoin";
    string private _symbol = "SKV";
