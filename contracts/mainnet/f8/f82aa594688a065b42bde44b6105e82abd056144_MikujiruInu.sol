...
contract MikujiruInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x325354677D1ecD7186F24dfa89104b8660041235); 
    address payable public Wallet_Dev = payable(0x626d785ef93f4F32C7735aCf59c1Cf120119a34B);
    ...
    string private constant _name = "Mikujiru Inu"; 
    string private constant _symbol = unicode"Mikujiru"; 
    ...
    constructor () {
        ...
        _owner = 0x626d785ef93f4F32C7735aCf59c1Cf120119a34B;
