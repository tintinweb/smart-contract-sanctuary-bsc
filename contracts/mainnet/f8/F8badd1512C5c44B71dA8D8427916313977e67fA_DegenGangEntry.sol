...
A group that still live the degen life, sippin' on that sweet JPEG juice, chilling in the bar and always craving an opportunity to ape in.

telegram: https://t.me/degengangEntry
website: https://linktr.ee/degenganglinks
...
contract DegenGangEntry is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"DEGEN GANG";
    string private _symbol = unicode"$DECRED";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xBB637Ef485286098eE7AFFa1B8f287e325693e04);
    address payable private taxWallet2 = payable(0xBB637Ef485286098eE7AFFa1B8f287e325693e04);
