...
contract EarlyApeAlphaClub is Context, IERC20, Ownable {
    ...
    string private _name = "EarlyApeAlphaClub";
    string private _symbol = "EAAC";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x99620C5bb4e262e6b6Bd8B8e1e9fc810819428D3);
