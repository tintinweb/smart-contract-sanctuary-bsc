...
contract BABYPENTA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY PENTA";
    string private _symbol = "BPENTA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf686CCB75c6E11596a36F3A2dC3f611cDce8B795); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0xFB8190dDF87af8F40c19ED0B2E62dA68355466B5); // Developmental Address
