...
TELEGRAM: https://t.me/vulcaniumglobal
WEBSITE : http://vulcanium.pro/
...
contract Vulcanium is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 0 * 15**9; //
    string private constant _name = "Vulcanium"; // 
    string private constant _symbol = "VUL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x81132B94706996523D998B60abD19E6a2655f738;
