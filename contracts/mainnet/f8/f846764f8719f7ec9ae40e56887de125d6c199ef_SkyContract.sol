...
contract SkyContract is ERC20Detailed, Ownable {
    ...
    uint256 public skyInsuranceFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public supplyControlFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(skyInsuranceFundFee).add(
            supplyControlFee
        );
    ...
    address public skyInsuranceFund;
    ...
    constructor() ERC20Detailed("Sky", "SKY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x838FB86635346066aC5a5042d366dbd82A6be3df;
        treasuryFund = 0x4057cbaA2889220E90B2b1b48BEA4e23709b645d;
        skyInsuranceFund = 0x5341f4C26f4D3B8e14a8cf12CBD872402e20d791;
        supplyControl = 0x8b344413A519A2f8C2658Ac388dbBad9560BC560;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(skyInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(skyInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(skyInsuranceFund).call{
            value: amountETHToTreasuryAndSIF.mul(skyInsuranceFundFee).div(
                treasuryFee.add(skyInsuranceFundFee)
            ),
            gas: 30000
        }("");
