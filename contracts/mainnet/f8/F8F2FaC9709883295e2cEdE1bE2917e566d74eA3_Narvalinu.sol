...
contract Narvalinu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE9382196eD2C1Dc57caee97Fe33b8B7D513195AA);
    address payable public teamWalletAddress = payable(0x0301d8F0eF220d8ccaC217673360CDE027F40b7a);
