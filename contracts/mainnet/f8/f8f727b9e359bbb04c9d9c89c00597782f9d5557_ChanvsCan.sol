...
contract ChanvsCan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChanvsCan";
    string private _symbol = "ChanvsCan";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xe0F043BCf849CC2E5815AE5B66dc28d72618197f);
    address payable public teamWalletAddress = payable(0xe0F043BCf849CC2E5815AE5B66dc28d72618197f);
    ...
    uint256 private _totalSupply =  202206030000 * 10**_decimals;
    uint256 public _maxTxAmount =   202206030000 * 10**_decimals;     
    uint256 public _walletMax =     202206030000 * 10**_decimals;      
