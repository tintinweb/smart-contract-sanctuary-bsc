...
//Official baby token for Virtual Reality Game World. 
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xfDD2374be7ae7a71138B9f6b93d9eF034a49edB6);
...
/* Token contract */
contract BabyVRGW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x44f49a02C5E6D23F8c37F6a0a6145d8AC521cB4a;
    ...
    // Name and symbol
    string constant _name = "Baby VRGW";
    string constant _symbol = "$BVRGW";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC49522f4790c1e35304c0A0396e57Df15De33B4d;
