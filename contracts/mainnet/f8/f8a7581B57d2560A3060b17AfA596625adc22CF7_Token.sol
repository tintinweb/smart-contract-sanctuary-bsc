...
contract RichDogePoorDoge is Ownable {
    using SafeMath for uint256;

    string constant public name = 'RichDoge PoorDoge';

    string constant public symbol = 'RPDoge';
    ...
    address public projectAddress = 0x545C35A92397b0f0Be14FB126482981181B8d5e9;
...
contract Token is RichDogePoorDoge {
