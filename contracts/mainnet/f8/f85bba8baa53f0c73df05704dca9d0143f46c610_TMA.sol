...
/**
 * The Moon Ape Is a Dual Rewards with BUSD Dividends & Auto-staking
 * First Dual Reward with Auto-Staking, Auto-Compounding & BUSD Reflections
 *
 * Website: https://themoonape.com
 * Twitter:  https://twitter.com/themoonape_o
 * Telegram : t.me/themoonape_official
 */
...
contract TMA is ERC20Detailed, Ownable {
    ...
    uint256 public TMADividendFee = 70;
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(TMADividendFee).add(
            autofirePitFee
        );
    ...
    address public TMADividendReceiver;
    ...
    constructor() ERC20Detailed("The Moon Ape", "TMA", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x8Aeace7025782A2E333e5840d37ff9d5D214a8cb;
        treasuryReceiver = 0x8Aeace7025782A2E333e5840d37ff9d5D214a8cb;   
        ...
        TMADividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(TMADividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(TMADividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(TMADividendFee).div(treasuryFee.add(TMADividendFee))
        } () {} catch {}        
    }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TMA token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
