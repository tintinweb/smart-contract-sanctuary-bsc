...
library Address{
 ...
 contract MiniBirdInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2e9 * 10**9;
    uint256 public maxBuyLimit = 2e9 * 10**9;
    uint256 public maxSellLimit = 2e9 * 10**9;
    uint256 public maxWalletLimit = 3e9 * 10**9;
    
    uint256 public genesis_block;

    address public marketingWallet = 0x6E0B8384e554B60F813b022CB7C3E73810c4a76e;
    address public donationWallet = 0x6E0B8384e554B60F813b022CB7C3E73810c4a76e;

    string private constant _name = "MiniBirdINU";
