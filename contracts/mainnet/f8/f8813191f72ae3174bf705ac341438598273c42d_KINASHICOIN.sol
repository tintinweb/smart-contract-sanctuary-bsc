...
Microcap, just launched and on a dip, this is the first promo with this team, lp locked but ownership not renounced, ape wisely
...
Telegram : https://t.me/kinashiCoin
...
contract KINASHICOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KINASHICOIN"; 
    string private _symbol = "KASHICOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75843721c41aeC6D5b9268f6F8212DFd3AB0c564);
    address payable public teamWalletAddress = payable(0x75843721c41aeC6D5b9268f6F8212DFd3AB0c564);
