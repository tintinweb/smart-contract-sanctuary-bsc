...
contract catstack is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public cstackwallet = payable(0xAdF38847d5a40cab95269d43eA18aa8667d4D819);
    ...
    string private constant _name = unicode"CatStack"; 
    string private constant _symbol = unicode"CSTACK"; 

    uint256 public P_DevReward = 70;
    uint256 public Part_AutoLiquidity = 30; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(cstackwallet, BNB_Tot);
