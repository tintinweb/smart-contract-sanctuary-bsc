...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc2756f3363baAF72E5Ac940feE7D44Db2f65f733; // owner address
...
contract RabbitProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Protocol";
    string private _symbol = "RABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc2756f3363baAF72E5Ac940feE7D44Db2f65f733); // Marketing Address
    address payable public teamWalletAddress = payable(0xc2756f3363baAF72E5Ac940feE7D44Db2f65f733); // Team Address
