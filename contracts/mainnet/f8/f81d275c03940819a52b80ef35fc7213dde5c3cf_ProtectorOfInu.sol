...
contract ProtectorOfInu is IBEP20, Auth {
    ...
    string constant _name = "Protectors of Inu";
    string constant _symbol = "WeRInu";
    uint8 constant _decimals = 9; //Decimal value

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); //Total Supply
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; //Max Tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100;  //Max Wallet
    ...
    uint256 public additionalSellTax = 3; //Additional sell tax; 0 implies Buy tax = Sell tax
    
    //Set wallets below 
    address private marketingFeeReceiver = 0xB0d555f52EC606da19e023C77C807382B3D840a5;
    address private teamFeeReceiver = 0xC6dE6327364D8e7d7F46c6B0738bab6668DBf39D;
    address private autoLiquidityReceiver = 0xC6dE6327364D8e7d7F46c6B0738bab6668DBf39D;
