...
contract DelegateFarm is Ownable, ReentrancyGuard {
    ...
    IHeadAstronaut private headAstronaut;
    ...
    constructor(address _rewards, address _fee, IPancakeChef _pancake, IHeadAstronaut _astronaut, 
    ...
    function deposit(uint256 _pid,uint256 _amount) public nonReentrant {
        ...
        if(_amount > 0) {
            ...
            headAstronaut.deposit(poolId, netTokenStaked);
    ...
    function pendingReward(address _user) public view returns(uint256){
        ...
        uint256 pendingBalance = headAstronaut.pendingBuzz(poolId, address(this));
    ...
    function updateShares(bool isWithdraw, uint256 _amount) internal {
        ...
        if(isWithdraw) {
            ...
            headAstronaut.withdraw(poolId, _amount);
            ...
            headAstronaut.deposit(poolId, 0);
        }
    ...
    function initialApprovals() internal {
        ...
        stakingToken.approve(address(headAstronaut), ~uint256(0));
    }
    ...
    function getheadAstronaut() public view returns(IHeadAstronaut) {
        return headAstronaut;
    }
    ...
    function withdrawRBSStaking(uint256 _amount, uint256 _pid) public onlyOperator {
        headAstronaut.withdraw(_pid, _amount);
