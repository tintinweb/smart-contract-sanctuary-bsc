...
*TELEGRAM: https://t.me/littleredbull_inu
*/
...
contract LITTLEREDBULLINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LITTLE RED BULL INU"; 
    string private _symbol = "LRBI"; 
