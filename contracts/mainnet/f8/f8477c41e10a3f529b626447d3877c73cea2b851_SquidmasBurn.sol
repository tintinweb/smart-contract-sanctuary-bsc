...
2% LP
 ...
 TG:https://t.me/SquidmasBurn_Official
...
contract SquidmasBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SquidmasBurn", "SMASBURN") {
        marketingWallet = payable(0x08E04D3822A51B06D6d426B9E962Fa1295fe851A);
        devWallet = payable(0x8A1D74D8499015bafabEbC610f53C23808dB7202);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    SquidmasBurn public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = SquidmasBurn(mainContract);
