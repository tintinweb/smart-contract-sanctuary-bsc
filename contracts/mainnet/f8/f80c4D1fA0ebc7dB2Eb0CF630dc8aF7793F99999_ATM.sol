...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 10 ** IERC20(FISTAddress).decimals() / (10**4);

        _tokenDistributor = new TokenDistributor(FISTAddress);
    }

    function restoreTxAmount() public onlyOwner{
        //用于给项目方一键解除所有限购
    ...
    uint256 public airdropAmount = 3;
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to] && airdropAmount != 0){
            address ad;
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == starBlock) {
                    require(0 < addLPBlock && isAddLdx, "!goAddLP");
                }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= maxTxAmount,"over max sell amount");
            } else {
    ...
    function starAddLP() external onlyOwner {
        require(0 == addLPBlock, "startedAddLP");
...
contract ATM is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        999,//Supply
        address(0x3587b5dcB4a67b27353F4b5b89e01a9F3d51A10E),
        address(0x5045744906951756f805acB3D157C56EB4E0B628),
        address(0x32159bB60c371f3edcfeC2A83977B8DB09C4Ad1B)
    ){
    }
}