...
contract MetaMusk is IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;   // 3%
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;     // 3%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xF7a8cdcca7bEdCBd6dEc7110e997Dc1dCE9ec039;
        marketingFeeReceiver = 0xF7a8cdcca7bEdCBd6dEc7110e997Dc1dCE9ec039;
        devFeeReceiver = 0xF7a8cdcca7bEdCBd6dEc7110e997Dc1dCE9ec039;
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalFee < 100, "Fees must be less than 25%");
    }
