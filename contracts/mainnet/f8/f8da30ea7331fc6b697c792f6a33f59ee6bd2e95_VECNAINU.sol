...
contract VECNAINU is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        _TeamWallet       = 0xD3b9C13Bc481baE3A78013fD8F8E342A0b80A09B;

        _marketingWallet = 0xD3b9C13Bc481baE3A78013fD8F8E342A0b80A09B;
        ...
        _isExcludedFromAntiWhale[address(0x66D1c6E1AC241D4980c1DcfD7b90d53f2F2ffD83)]            = true; // Deployer

        _isExcludedFromMaxTx[owner()] = true;

        _isExcludedFromMaxTx[address(0x66D1c6E1AC241D4980c1DcfD7b90d53f2F2ffD83)] = true; // Deployer
