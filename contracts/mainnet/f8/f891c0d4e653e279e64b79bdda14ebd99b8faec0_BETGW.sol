...
contract BETGW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BETCOIN Grow";
    string private _symbol = "BETGW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x984fa681CF0248B1F323418fea273A8D8D3bFD87); // Marketing Address
    address payable private TeamWallet = payable(0x984fa681CF0248B1F323418fea273A8D8D3bFD87); // Buy Back Address
