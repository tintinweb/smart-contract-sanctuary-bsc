...
contract BNB_Instant {
	...
	uint constant public			PROJECT_FEE						= 200;					// project fee 2% of deposit
	...
	uint constant public			INSURANCE_PERCENT				= 100;					// insurance fee 1% of claim
	...
	function invest(uint8 _planIdx) public payable {
