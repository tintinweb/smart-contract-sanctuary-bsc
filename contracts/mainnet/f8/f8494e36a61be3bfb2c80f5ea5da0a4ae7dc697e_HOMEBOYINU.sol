...
contract HOMEBOYINU is IBEP20, Auth {
    ...
    string constant _name = "HOMEBOY INU";
    string constant _symbol = "HBOY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 60) / 100; //60% 
    uint256 public _maxWalletSize = (_totalSupply * 70) / 100; //70%
    ...
    address private marketingFeeReceiver = 0x0208A78DE8075dF6Fa43F475D503e4ADb7418f80;
    address private developmentFeeReceiver = 0x0208A78DE8075dF6Fa43F475D503e4ADb7418f80;
