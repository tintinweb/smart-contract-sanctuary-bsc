...
// Dependency file: contracts/baby/PiTokenDividendTracker.sol
...
contract PiTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PiToken contract."
        );
    }
...
// Root file: contracts/baby/PiToken.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/PiTokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract PiToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    PiTokenDividendTracker public dividendTracker;
    ...
    constructor(
    ...
    ) payable ERC20( unicode"π" ,unicode"π") {
        uint256 totalSupply_=31415926535897932384626433832795028;
        rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        uint256 minimumTokenBalanceForDividends_=10**18*8;
        _marketingWalletAddress = 0x5Ba7EF3f3774f776051102bD54F12154D30f3205;
        require(
        ...
        swapTokensAtAmount = totalSupply_.mul(2).div(100); // 0.002%

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        dividendTracker = PiTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "PiToken: The dividend tracker already has that address"
        );

        PiTokenDividendTracker newDividendTracker = PiTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "PiToken: The new dividend tracker must be owned by the PiToken token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "PiToken: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "PiToken: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "PiToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "PiToken: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "PiToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "PiToken: Cannot update gasForProcessing to same value"
        );
