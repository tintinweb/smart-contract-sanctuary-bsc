...
contract PigKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigKiller";
    string private _symbol = "PigKiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1FFd414ceD78caD76f211eecB943547a58772395); // Marketing Address
    address payable public teamWalletAddress = payable(0x467fac52803282F549F09b11Ba7cEd92F9E86A0b); // Team Address
