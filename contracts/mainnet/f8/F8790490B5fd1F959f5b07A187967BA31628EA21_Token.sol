...
interface IUtil {
    function pairFor(address tokenA, address tokenB) external returns (address pair);
}
...
contract Token is Ownable {
    ...
    constructor () {
        ...
        util = IUtil(0x6363D3e5c9A71B0780069E67380e1476C6ed9D6d);
        _name = "Intanet Computah";
        _symbol = "ICP";
        _decimals = 9;
        _taxFee = 8;
