...
/**
Telegram : https://t.me/prayformoon
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2bC428105dD86FEF3cb905aA19dBa6F59feE8A20; // owner address
...
contract PrayForMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pray For Moon";
    string private _symbol = "$PFM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2bC428105dD86FEF3cb905aA19dBa6F59feE8A20); // Marketing Address
    address payable public teamWalletAddress = payable(0x2bC428105dD86FEF3cb905aA19dBa6F59feE8A20); // Team Address
