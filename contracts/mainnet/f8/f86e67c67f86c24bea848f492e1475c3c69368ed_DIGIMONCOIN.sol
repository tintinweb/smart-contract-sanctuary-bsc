...
telegram: https://t.me/DigimonBSC_Global
Website : https://www.digimonbsc.com
Twitter : https://twitter.com/DIGIMONBSC

🗨 DIGIMON COIN 🗨
Welcome to 🗨Digimon community!🗨 
AnimeCoin
💯Organic Growth 
💯community Token
🚀Next 10x #Animecoin
...
contract DIGIMONCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "DIGIMON COIN";
    string private _symbol = "DIGIMON";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x30bf070d638e0701a81E1d8a436aBc7C26567169);
