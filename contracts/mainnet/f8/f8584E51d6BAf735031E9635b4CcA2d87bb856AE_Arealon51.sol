...
contract Arealon51 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Arealon51";
    string constant _symbol = "A51";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x86db9A7692A263D718d7287124031B8B8AF0b100   ;
