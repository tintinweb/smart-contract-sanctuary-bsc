...
contract ObitoUchihaInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Obito Uchiha Inu";
    string private _symbol = "ObitoInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2944692a2bF1d3BEc345eBd5D07fB5F8BEeDCCDa); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2944692a2bF1d3BEc345eBd5D07fB5F8BEeDCCDa); // BuyBack Address
