...
contract AptosBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aptos Burn";
    string private _symbol = "APBURN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x67E56b7769e29D0A04ef18e97d6e2C90C64f4c60); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x67E56b7769e29D0A04ef18e97d6e2C90C64f4c60); // Team Address
