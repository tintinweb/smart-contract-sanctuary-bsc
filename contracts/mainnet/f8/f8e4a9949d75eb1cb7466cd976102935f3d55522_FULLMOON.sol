...
contract FULLMOON is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x96FA625CB4eb1C7faA97bFbC8a4Ef59B4CB489Eb); // Marketing Address
    address payable public teamWalletAddress = payable(0x1AFdA53F35Ef6F83C694A9eC8C7ff1079177acd9); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x9716aAC1550e5608DB92fb9812A5a3f2336E07eF),
            block.timestamp
        );
    }
