...
contract King is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE1f1C13A68e6576931fC62EEe3FC397293185FD9));
        marketingWalletAddress = payable(address(0xE1f1C13A68e6576931fC62EEe3FC397293185FD9));
