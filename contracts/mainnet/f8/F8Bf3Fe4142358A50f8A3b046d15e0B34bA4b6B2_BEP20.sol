...
/**
https://t.me/sustainableenergytoken
*/
...
abstract contract Auth {
    ...
    function renounceOwnership(address payable adr) public onlyOwner {
        ...
        emit OwnershipTransferred(adr); //DEAD ADRESS
    }
...
contract BEP20 is IBEP20, Auth {
    ...
    string constant _name = "Sustainable Energy Token";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x8EA23d346Eb0e9F4cc6BEBaBF1fb8eAC74062276;
        marketingWallet = 0x8EA23d346Eb0e9F4cc6BEBaBF1fb8eAC74062276;
        devWallet = 0x8EA23d346Eb0e9F4cc6BEBaBF1fb8eAC74062276;
