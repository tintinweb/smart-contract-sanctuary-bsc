...
contract AOO is ERC721, Ownable, Pausable {
    using Strings for uint256;

    string private baseURI = '';
    uint private maxSupply = 101;
    uint private mintedSupply = 1;
    uint private basePrice = 0;
    bool public revealed = false;
    string public hiddenMetadataUri =  'ipfs://bafkreia4yxquuphmigo3vlbp23i4kh5rionxlsyoonzspkgxpvmiynwdqy';
    constructor() ERC721("AOG Wine x NFTOO", "AOO") {
        pause();
    }
