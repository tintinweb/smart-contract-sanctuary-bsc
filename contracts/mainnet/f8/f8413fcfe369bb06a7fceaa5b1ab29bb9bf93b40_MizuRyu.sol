...
Telegram  : https://t.me/MizuRyuBSC
...
contract MizuRyu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Mizu Ryu";
    string constant _symbol = "RYUZHIN";
    ...
    uint256 public swapThreshold = 3000 * (10 ** _decimals);
