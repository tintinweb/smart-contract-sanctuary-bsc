...
contract BabaLooey is IERC20 {
    ...
    uint256 constant private startingSupply = 1_123_655_212;
    string constant private _name = "Baba Looey";
    string constant private _symbol = "LOO";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x2FC8b17A7A918B5469938DDd4D6e1616760B897f),
        team: payable(0xA01485e9f0a108212F399Ad0dAe63D385d91eff7)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 marketing, uint16 team) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.totalSwap = marketing + team;
