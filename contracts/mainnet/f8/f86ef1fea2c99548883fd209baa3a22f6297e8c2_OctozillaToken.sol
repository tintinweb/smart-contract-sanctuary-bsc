...
/*
   🐙 OCTOZILLA 🐙
    ...
    Octozilla is a community-driven token and decentralized meme coin in Binance Smart Chain with Safu Dev & Team
...
contract OctozillaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "OCTOZILLA"; //
    string private constant _symbol = "OCTOZILLA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x197224e00210026E87850e8815688c1547Df5626;
