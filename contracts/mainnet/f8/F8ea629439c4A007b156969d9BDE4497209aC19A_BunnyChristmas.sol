...
Big Marketing before Launch 

Stealth Launch Today at 3-4PM UTC

Getting ready for the Christmas season will push it till the real hype start do an entry early and hold for ill do slow marketing but once the hype is on will start the massive marketing.

Telegram: https://t.me/BunnyChristmas
*/
...
/* Token contract */
contract  BunnyChristmas is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x35848ed2A5242FaC986C6f68608B0da2b37dC247;
    ...
    // Name and symbol
    string constant _name = "Bunny Christmas";
    ...
    uint256 private marketingFeeSell = 7;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x35848ed2A5242FaC986C6f68608B0da2b37dC247;
