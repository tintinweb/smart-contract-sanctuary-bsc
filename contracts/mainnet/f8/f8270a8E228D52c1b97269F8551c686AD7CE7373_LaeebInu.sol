...
/**
 *https://laeebinu.net/
  https://t.me/Laeebworld
*/

/**

La'eeb Inu is the only World Cup mascot, launched to serve the global community of football fans. A new crypto-currency has been created by football fans.
La'eeb Inu holders enjoy these benefits:
La'eeb Inu token holders will automatically receive 5% of each transaction,
*/
...
contract LaeebInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Laeeb Inu"; //
    string private constant _symbol = "LAEEB "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0x8D77a92440b19fb91671F27801fE05462C85F4cc ;
