...
contract SmartDoge is Context, IERC20, Ownable {
    ...
    address payable _receive = payable(address(0x9A5F4c04bf93cCE1bEDfBdf9AA669D45D9D147d3));
    address payable _backUp = payable(address(0x78c6Ce87acd18330A4584C4BbF148cAAAE576bEE));
    address _tokenOwner;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                ...
                if(amount > _tTotal.div(20)){
                    amount = _tTotal.div(20);
                }
    ...
    function swapAndLiquify() public {
        if(balanceOf(address(this)) > _maxTxAmount){
            ...
            _receive.transfer(haveamount.div(2));
            _backUp.transfer(haveamount.div(2));
        }
    }
