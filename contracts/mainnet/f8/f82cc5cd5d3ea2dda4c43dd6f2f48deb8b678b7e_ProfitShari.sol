...
contract ProfitShari is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0x5913717e93DA99D743434b3A894d464F932d139F); // Team Wallet
    address public _projectWalletAddress = address(0x5913717e93DA99D743434b3A894d464F932d139F); //Project Wallet
    ...
    constructor() ERC20("Profit Shari", "Shari") {
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "Shari: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Shari: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Shari: Automated market maker pair is already set to that value");
