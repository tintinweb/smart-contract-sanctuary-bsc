...
contract Yellow is IERC20 {
    ...
    string constant _name = "Yllow";
    string constant _symbol = "Yell";
    ...
    uint256 public _reflectionRatio = 0;
    ...
    address payable private _marketingWallet = payable(0xBae35ecDb08146BaA364A4a631890D0A20bd14f9);
...
//===============================================================================================================
    ...
    function setRatios(uint256 reflection, uint256 liquidity, uint256 marketing) external onlyOwner {
        ...
        if (marketing > 0) {
            require(marketing <= 100, "Marketing cannot be more than 40% of the distribution.");
        }
