...
contract MissRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name =  "MissRabbit";
    string private _symbol = "MissRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cCDcc3e2E6fc4172753Dcd3938Bd4B963BD4054);
    address payable public teamWalletAddress = payable(0x7cCDcc3e2E6fc4172753Dcd3938Bd4B963BD4054);
