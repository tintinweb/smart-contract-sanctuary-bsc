...
TG: https://t.me/Storror_STOR_bsc
...
contract STORROR is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Storror";
    string constant _symbol = "STOR$";
    ...
    uint256 _totalSupply = 0.5 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = 0.015 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 0.015 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0x8F7F6Ec89062Fe5B2cEB0CB1F07F09B60aB1259d;
        marketingWallet = 0xCA71101deefd54d27ea7Aba1b9C5E0be815882ee;
        devWallet = 0x3Ad0DC664B619578b0796D611047c9Bd2ecA78B3;
