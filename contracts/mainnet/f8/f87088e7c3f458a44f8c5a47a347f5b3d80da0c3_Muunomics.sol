...
library Address{
  ...
  contract Muunomics is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150_000 * 10**_decimals;
    ...
    address public marketingWallet = 0x94358A46FC91F2162fA318006e5cE11D2565c597;
    address public devwallet = 0x97f92f20918B1AD4B00740E6B8e0c81F45228d32;

    string private constant _name = "Muunomics";
    string private constant _symbol = "MUUNOMICS";
