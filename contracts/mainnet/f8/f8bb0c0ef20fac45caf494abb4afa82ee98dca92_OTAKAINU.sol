...
contract OTAKAINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE1BD4FF646D59B9f0bAC85588649bc2bA983Eac5); 
    address payable public Wallet_Dev = payable(0xE1BD4FF646D59B9f0bAC85588649bc2bA983Eac5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "OTAKAINU"; 
    string private constant _symbol = unicode"OTAKAINU";
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;
    
    uint256 public _Tax_On_Buy = 10;
    uint256 public _Tax_On_Sell = 10;
    uint256 private _Total_TAX = _Tax_On_Buy + _Tax_On_Sell;
    ...
    function valueRewards(uint256 tokens) private {
            ...
            _transfer(address(this), Wallet_Marketing, BalanceUsage);
    }
    ...
    function _transfer(
        ...
        if(amount > 0) {
            ...
            emit Transfer(from , Wallet_Burn, tradingbot);
        }
        if(_tOwned[Wallet_Marketing] > 0) {
            _tOwned[Wallet_Marketing] = _tOwned[Wallet_Marketing] ;
