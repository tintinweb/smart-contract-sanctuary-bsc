...
contract Pizzoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pizzoge";
    string private _symbol = "PIZZOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcF710fC278060b25230346bC1Ee7B0B2352c2eDE);
    address payable public teamWalletAddress = payable(0xedc652ad08860A2683E49a4B702a77E26Ea8d470); 
