...
contract BITCOININU is BEP20, Auth {
    ...
    string public constant name = "Bitcoin Inu";
    string public constant symbol = "BTCINU";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + utilityFee;
    uint256 public constant feeDenominator = 100;

    uint256 sellMultiplier = 200;
    uint256 buyMultiplier = 100;
    uint256 transferMultiplier = 1400;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9085bf73E81a823C260E92Fe9b480ECB3A6b4d2E;
    ...
    function tradingStatus_launchmode(uint256 confirm) external onlyOwner {
        require(confirm == 811911000,"Accidental Press");
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _utilityFee, uint256 _teamFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        utilityFee = _utilityFee;
        teamFee = _teamFee;
        totalFee = _liquidityFee + _marketingFee + teamFee + _utilityFee;
        
        _updatefees();
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _utilityFeeReceiver) external onlyOwner {
