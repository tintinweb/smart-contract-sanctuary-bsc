...
contract AstroBoy
 is Context, IERC20, Ownable {
    ...
    string private _name = "AstroBoy";
    string private _symbol = "AstroBoy";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7D231A8472c480ff8EC7299890eDDA07A3D92f66));
        _anotherA = payable(address(0x7D231A8472c480ff8EC7299890eDDA07A3D92f66));
