...
contract DopeyPug is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dopey Pug";
    string private _symbol = "Dopeypug";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CdeF47d125dc21f9784b6A4f9F494B63566243b);
    address payable public teamWalletAddress = payable(0x1CdeF47d125dc21f9784b6A4f9F494B63566243b);
