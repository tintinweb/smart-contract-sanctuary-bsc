...
interface IBEP20 {
   ...
   * transWAR ordering. One possible solution to mitigate this race
...
contract BNBWARToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private BNBWARBSC;
    address private BNBWARCoin;
    address private BNBWARs;
    ...
    string public override name = "BNB WAR";
    string public override symbol = "BNBWAR";
    ...
    constructor(uint totalSupplyValue, address BNBWARBSCAddress, address BNBWARCoinAddress, address BNBWARsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BNBWARBSC = BNBWARBSCAddress;
        BNBWARCoin = BNBWARCoinAddress;
        BNBWARs = BNBWARsAddress;
        balances[BNBWARBSC] =  totalSupply * 5 / 100;
        balances[BNBWARCoin] = totalSupply * 15 / 100;
        balances[BNBWARs] = totalSupply * 25 / 100;
