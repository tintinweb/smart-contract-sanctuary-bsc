...
contract FatSatoshi is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 100) / 80;  //1
    uint256 public _maxWalletSize = (_totalSupply * 100) / 80;  //1
    ...
    address private marketingFeeReceiver =0x9996C73C87A235ba4cAb18deAa782A23a193cD16;
    address private teamFeeReceiver =0x9996C73C87A235ba4cAb18deAa782A23a193cD16;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x9996C73C87A235ba4cAb18deAa782A23a193cD16;
