...
/**
SUPERCATS
https://poocoin.app/tokens/0xf820f433ccf44e42fdd53c81e27683475844eac9
...
2% Liquidity
A healthy and locked liquidity pool injected prior to launch and steadily built upon


3% Marketing
A front loaded marketing wallet will assist us in having all the current and relevant listings are made and early.


2% Treasury
This distribution to the treasury will allow top holders and other special criteria holders the ability to vote on how funds are spent. This will also include a charity to enable the community to give back in a meaningful way.


1% Reflection
Reflections in native token as a reward for holding.
 */
...
contract SUPERCATS is CATSDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private CATSTeam;
    address private CharityCATS;
    ...
    string public override name = "SUPERCATS";
    string public override symbol = "S-CATS";
    ...
    constructor(uint totalSupplyValue, address CATSTeamAddress, address CharityCATSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        CATSTeam = CATSTeamAddress;
        CharityCATS = CharityCATSAddress;
       
        // split the tokens according to agreed upon percentages
        balances[CATSTeam] =  totalSupply * 5 / 100;
        balances[CharityCATS] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's CATSTeam pot
