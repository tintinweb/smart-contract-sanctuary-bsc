...
Telegram: https://t.me/CHZWorldCupOfc
...
contract CHZWC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHZ World Cup";
    string private _symbol = "CHZWC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x07377D27b4b3bCBFa87a9627b3C2A291C0320c85); // Marketing Address
    address payable public teamWalletAddress = payable(0x07377D27b4b3bCBFa87a9627b3C2A291C0320c85); // Team Address
    ...
    uint256 public _sellMarketingFee = 72;
    ...
    uint256 public _totalTaxIfSelling = 75;
