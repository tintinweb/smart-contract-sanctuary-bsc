...
/**
    Kaido Swap aim to be one of the greatest community tokens that will give our holders the best advantages and many development for long term.
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "KAIDO SWAP";
    string private _symbol = "KAIDO SWAP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB70f7E01536fe37659aCE1B9033a7C42af382a5D);
    address payable public DevelopmentWalletAddress = payable(0xB70f7E01536fe37659aCE1B9033a7C42af382a5D);
