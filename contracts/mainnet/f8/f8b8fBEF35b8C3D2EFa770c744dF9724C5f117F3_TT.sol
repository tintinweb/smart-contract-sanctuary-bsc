...
contract TT is TTDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private TTTeam;
    address private CharityTT;
    ...
    string public override name = "TigerToonz";
    ...
    constructor(uint totalSupplyValue, address TTTeamAddress, address CharityTTAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        TTTeam = TTTeamAddress;
        CharityTT = CharityTTAddress;
       
        // split the tokens according to agreed upon percentages
        balances[TTTeam] =  totalSupply * 4 / 100;
        balances[CharityTT] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TTTeam pot
