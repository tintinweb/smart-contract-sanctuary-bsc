...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("NFT Of BTDOG", "NOF") {
        _BTDOG = IERC20(0xEc0703b60D0f4e13527eCd3f9Ae9Daa4Fb75036B);
    ...
    function setURL(uint256 level, string memory url) public onlyAdmin {
        urls[level] = url;
    }
    function setToken(address usdt, address fist) public onlyAdmin {
        _BTDOG = IERC20(fist);
        _USDT = IERC20(usdt);
    }
    function setNftTotals(uint256 t1, uint256 t2) public onlyAdmin {
        nftTotals[0] = t1;
        nftTotals[1] = t2;
    }
    ...
    function mintNFT(address to, uint256 level)
        public
        onlyAdmin
        returns (uint256)
    {
