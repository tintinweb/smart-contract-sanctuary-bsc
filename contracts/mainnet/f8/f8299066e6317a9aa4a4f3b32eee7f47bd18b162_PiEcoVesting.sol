...
contract PiEcoVesting is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        // 101250000
        amountTotal = 101250000 ether;
        // 11250000
        tgeAmount = 11250000 ether;
    ...
    returns (uint256)
    {
        if (currentTime < start) {
            ...
            uint256 startTime = currentTime.sub(start);

            if (startTime >= cliff) {
                uint256 timeFromCliff = startTime.sub(cliff);
