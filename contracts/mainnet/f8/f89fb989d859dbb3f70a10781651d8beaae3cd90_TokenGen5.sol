...
import {ERC20_Swap2_Own_AutoBB_OneWal} from './ERC20_Swap2_Own_AutoBB_OneWal.sol';
import './libraries/Ownable.sol';
import './interfaces/ITokenFactory.sol';

contract TokenGen5 is Ownable {
    ...
    function createToken(
        ...
        ERC20_Swap2_Own_AutoBB_OneWal newtok = new ERC20_Swap2_Own_AutoBB_OneWal(name, symbol, decimals, totalSupply, owner, raddr, w1addr, w1bfee, w1sfee, bbbfee, bbsfee);
...
// Swap 2.0, Ownable, 1 Wallet, autobuyback

contract ERC20_Swap2_Own_AutoBB_OneWal is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _wallet1Fee, uint256 _buybackFee) external onlyOwner {
    ...
    function setSellFees(uint256 _wallet1Fee, uint256 _buybackFee) external onlyOwner {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.wallet1).sub(values.buyBack);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.wallet1Fee.add(_defaultFees.buybackFee);
        }
    }
