...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95FFc0289BedA39C5C7B9A79C0089b5E1166A282; // owner address
...
contract RTyrant is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RabbitTyrant";
    string private _symbol = "RTyrant";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95FFc0289BedA39C5C7B9A79C0089b5E1166A282); // Marketing Address
    address payable public teamWalletAddress = payable(0x95FFc0289BedA39C5C7B9A79C0089b5E1166A282); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 13;  // original 7
    uint256 public _totalTaxIfSelling = 14;  // original 7
