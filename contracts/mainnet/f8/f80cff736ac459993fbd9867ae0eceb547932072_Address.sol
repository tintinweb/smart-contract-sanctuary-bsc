...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0CeC9072E7617c90A646A69c13C525407Ad6050;
...
contract LunaAid is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf065B80c3E2bB19E284e6F74341595e4125551B1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Luna Aid";
    string private _symbol = "LA";
