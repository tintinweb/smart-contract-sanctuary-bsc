...
/*
ChineseCow
launch on Binance January 24, 2023

https://t.me/ChineseCow
...
contract ChineseCow is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CHineseCOw";
    string private _symbol = "CCOW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x614c7D143F4b7E1da854E0cE449982f4f67879Dc);
    address payable public liqWalletAddress = payable(0x614c7D143F4b7E1da854E0cE449982f4f67879Dc);
    ...
    uint256 private _totalSupply =  236666* 10**_decimals;
    uint256 public _maxTxAmount =    9466* 10**_decimals;
    uint256 public _walletMax =     11833* 10**_decimals;
