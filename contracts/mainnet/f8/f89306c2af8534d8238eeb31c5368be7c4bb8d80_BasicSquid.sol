...
contract BasicSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic Squid";
    string private constant _symbol = "BasicSquid";
