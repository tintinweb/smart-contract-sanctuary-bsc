...
/**
   ...
   #Kylian Mbappé Super Star IN WORLD CUP
*/
...
contract KylianMbappe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kylian Mbappe";
    string private _symbol = "Mbappe";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x25da9d7fcdf50E30a44EDAF1B8cA60dd1aA7f472); 
    address payable public BurnedWalletAddress = payable(0x25da9d7fcdf50E30a44EDAF1B8cA60dd1aA7f472); 
