...
/**
EmemToken is a BSC token which targeting meme as it sale value. 
By creating sets of meme as the NFT of EmemToken, we will gather & bring crypto meme community together & grow EmemToken. 
We will ensure that EmemToken is safe & transparent to everyone, with the fairest launch.

TOKENOMICS
1) Supply : 100 Billion
2) Buy & Sell Tax : 9%
...
contract EmemToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "EmemToken"; // 
    string private constant _symbol = "EmemToken"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x4477E1AfC4529C41872EB4dD44Ba082BD44692b2;
