 ...
 * ____        _              _____ _     _ _    _ _    _       _    _ _    _       
 |  _ \      | |            / ____| |   (_) |  | | |  | |     | |  | | |  | |      
 | |_) | __ _| |__  _   _  | |    | |__  _| |__| | |  | | __ _| |__| | |  | | __ _ 
 |  _ < / _` | '_ \| | | | | |    | '_ \| |  __  | |  | |/ _` |  __  | |  | |/ _` |
 | |_) | (_| | |_) | |_| | | |____| | | | | |  | | |__| | (_| | |  | | |__| | (_| |
 |____/ \__,_|_.__/ \__, |  \_____|_| |_|_|_|  |_|\____/ \__,_|_|  |_|\____/ \__,_| F..K you NINE
                     __/ |                                                         
                    |___/                                         
*/
...
contract BabyChihuahua is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x384fB54AF89b12E6345a2a4da1EFDB665462AA4c); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x384fB54AF89b12E6345a2a4da1EFDB665462AA4c); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x384fB54AF89b12E6345a2a4da1EFDB665462AA4c); // charity Wallet Address
    address payable public devWalletAddress = payable(0x44D036120C4adFd714e8c2442EF0eB39F5b1CD20); // dev Wallet Address
    ...
    string private constant _name = "BabyChihuahua";
    string private constant _symbol = "BABYCHH";
    ...
    constructor () {
        address _owner = 0x44D036120C4adFd714e8c2442EF0eB39F5b1CD20;
