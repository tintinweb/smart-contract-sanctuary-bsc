...
contract AMC is ERC20, Ownable {
    ...
    function _transfer(
        ...
        require(to != address(0), "ERC20: transfer to the zero address");
        require(amount > 0);
        require(from != to, "ERC20: transfer to the zero address");
    ...
    function mint (address[] memory addrs, uint256[] memory amounts) external onlyOwner {
        for (uint i = 0; i < addrs.length; i++) {
            super._mint(addrs[i], amounts[i]);
        }
    }
