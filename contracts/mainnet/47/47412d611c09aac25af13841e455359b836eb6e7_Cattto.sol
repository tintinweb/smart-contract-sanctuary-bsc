...
contract Cattto is IBEP20, Auth {
    ...
    string constant _name = "Cattto";
    string constant _symbol = "CATTTO";
    ...
    address public charityFeeReceiver = 0x8B99F3660622e21f2910ECCA7fBe51d654a1517D;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _charityFee, uint256 _feeDenominator) external authorized {
