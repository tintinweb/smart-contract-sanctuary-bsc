...
contract Bigbuy is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x225A1288E78B11C8F1B14C20627813C2ED550EfA); 
    address payable public Wallet_Dev = payable(0x225A1288E78B11C8F1B14C20627813C2ED550EfA);
    ...
    string private constant _name = "BIGBUY Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x225A1288E78B11C8F1B14C20627813C2ED550EfA;
