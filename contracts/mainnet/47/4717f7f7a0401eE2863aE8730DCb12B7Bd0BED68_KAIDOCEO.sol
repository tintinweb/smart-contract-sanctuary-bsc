...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xba373B266e73b189DE0513d0A5f0C6132a9cB7f1; // owner address
...
contract KAIDOCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAIDO CEO";
    string private _symbol = "$KAIDOCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xba373B266e73b189DE0513d0A5f0C6132a9cB7f1); // Marketing Address
    address payable public teamWalletAddress = payable(0xba373B266e73b189DE0513d0A5f0C6132a9cB7f1); // Team Address
