...
contract Token {
 // All subsequent code will be inside this block    string public name; // Holds the name of the token
    string public name;
    ...
    constructor() {
        name = "AGROGLORYTIME"; // Sets the name of the token, i.e Ether
        symbol = "AGTI"; // Sets the symbol of the token, i.e ETH
