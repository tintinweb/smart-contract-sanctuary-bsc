...
contract U20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "U20";
    string private _symbol = "U20";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3dCf2aB3eDe368b1b59172Eb6f0397995BACFe39));
        marketingWalletAddress = payable(address(0x9feBafBa61d45F3860674c3Fda7a39a6CDA1B3F6));
