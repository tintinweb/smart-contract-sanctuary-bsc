...
contract BossyCatDollars is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BossyCatDollars";
    string private _symbol = "BCD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0aC07802Ab16628baDBE419db9B47bb99A9bB762); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0aC07802Ab16628baDBE419db9B47bb99A9bB762); // BuyBack Address
