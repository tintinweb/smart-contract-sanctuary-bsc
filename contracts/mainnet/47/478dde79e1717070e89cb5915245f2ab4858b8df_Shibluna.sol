...
contract Shibluna is IBEP20, Auth {
    ...
    string constant _name = "Shibluna";
    string constant _symbol = "SHIBLU";
    ...
    address public marketingFeeReceiver = 0x000000000000000000000000000000000000dEaD;
