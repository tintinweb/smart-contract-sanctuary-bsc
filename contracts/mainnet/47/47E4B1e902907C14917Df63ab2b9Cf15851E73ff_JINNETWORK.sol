...
contract JINNETWORK is ERC20, Ownable {
    ...
    address private wallet11;
    address private wallet21;
        ...
        ERC20("JIN NETWORK", "JIN")
    {
        ...
        wallet11 = address(_wallet11);
        wallet21 = address(_wallet21);
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        sendBNB(payable(wallet01), amount1);
        sendBNB(payable(wallet11), amount2);
        sendBNB(payable(wallet21), amount3);
    }
