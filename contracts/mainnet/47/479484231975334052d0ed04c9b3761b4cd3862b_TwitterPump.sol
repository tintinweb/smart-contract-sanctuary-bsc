...
/**
 *Submitted for verification at BscScan.com on 2022-2-12
*/
...
contract TwitterPump is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Twitter Pump";
    string constant _symbol = "TwitterPump";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0b0bCe6a76BAb25C66E48A2263648AF53EcCD6DB; //marketingwallet
        anothermarketingWallet = 0x0b0bCe6a76BAb25C66E48A2263648AF53EcCD6DB; //devwallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(6).div(6);
