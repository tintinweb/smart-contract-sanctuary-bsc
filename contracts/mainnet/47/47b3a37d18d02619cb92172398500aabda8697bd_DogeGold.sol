...
/*
🥇DOGE GOLD 🥇(READY FOR LAUNCHH

DogeGold is a token that grows on the BSC network with great utilities that it has, the project runs perfectly and is fully controlled by a smart and careful community.

🥇Low taxes %6
🥇Community Run
🥇 Swap + Staking
🥇Great Utilities and Logo
🥇Auto LP mechanism & Reflections!

*/

//Telegram : https://t.me/DogeGold_BSC
...
contract DogeGold is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8D395427160e7374cA4038E28E52B6A74B64FdF2); 
    address payable public Wallet_Team = payable(0x13E143b04bBEE9744db9E2F167CA8821E8B1ed07);
    ...
    string private constant _symbol = unicode"DOGE GOLD"; 
    ...
    constructor () {
        ...
        _owner = 0x13E143b04bBEE9744db9E2F167CA8821E8B1ed07;
