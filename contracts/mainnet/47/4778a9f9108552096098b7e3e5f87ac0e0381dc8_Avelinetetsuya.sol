...
contract Avelinetetsuya is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x89917A5A125979A4F67355FE90D4B0EB597c08Ca); 
    address payable public Wallet_Dev = payable(0xC797D949CC103cd91f5b71B39aAa889B65634d2d);
    ...
    string private constant _name = "Aveline Tetsuya"; 
    string private constant _symbol = unicode"$Tetsyu"; 
    ...
    constructor () {
        ...
        _owner = 0xC797D949CC103cd91f5b71B39aAa889B65634d2d;
