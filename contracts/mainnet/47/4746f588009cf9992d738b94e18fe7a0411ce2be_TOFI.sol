...
*/
/**
Welcome to TOFI INU BSC. The hottest new meme token sponsored by Together Crypto.

✅ Safe
✅ Bullish name
✅ Good LP Contribution
✅ Fair Tax
✅ Buyback and burn facility.
...
contract TOFI is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 13_500 * 10**9;
    uint256 public maxWalletLimit = 30_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x0a4D4C92c6d01257e8712BAF189D207d81A951b1;
    address public devWallet = 0x1246b313f61207596D9fe29E64c049bC23099C98;
    address public treasuryWallet = 0x1246b313f61207596D9fe29E64c049bC23099C98;

    string private constant _name = "Tofi Inu";
    ...
    Taxes public taxes = Taxes(0, 2, 4, 3, 0);
    Taxes public sellTaxes = Taxes(0, 2, 4, 3, 0);
