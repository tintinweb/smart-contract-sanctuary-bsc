...
/**
 ...
 Telegram: https://t.me/babytrias
 Twitter: https://twitter.com/babytrias
 Website: https://babytrias.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  TRIAS = IBEP20(0xa4838122c683f732289805FC3C207Febd55BabDD);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TRIAS.balanceOf(address(this));
        ...
        uint256 amount = TRIAS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TRIAS.transfer(shareholder, amount);
...
/* Token contract */
contract BTRIAS is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC = 0xf909CB45e8a19ec976A03941C9F36B87f0357A45; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5c0De9E505566FE0fdB0026Ef73C4f147D1238C0;
    ...
    // Name and symbol
    string constant _name = "Baby TRIAS";
    string constant _symbol = "BTRIAS";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 500000 * (10 ** _decimals); // 100k
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x0d2d93E19fe19D5d422FA81fdd64F2a41fA20b72;
