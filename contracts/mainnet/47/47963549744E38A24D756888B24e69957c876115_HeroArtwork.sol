...
contract HeroArtwork is ERC721, ERC721Enumerable, Pausable, AccessControl {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string baseURI = "https://meta.heroesempires.com/artwork/";
    mapping(uint256 => string) public name;
    function getName(uint256 _tokenId) external view returns(string memory) {
        return name[_tokenId];
    }
    constructor() ERC721("Hero Artwork", "HAW") {
    ...
    function safeMint(address to, uint256 tokenId, string memory _name) external onlyRole(MINTER_ROLE) {
        _safeMint(to, tokenId);
        name[tokenId] = _name;
    }
