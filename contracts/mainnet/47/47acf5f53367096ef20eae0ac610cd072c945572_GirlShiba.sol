...
contract GirlShiba is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "GIRL SHIBA";
    string private _symbol = "GIRLS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xEd7f7474f5eF34b539e4A75DF00A5a4a891FD6b3);
    address payable public liqWalletAddress = payable(0xEd7f7474f5eF34b539e4A75DF00A5a4a891FD6b3);
