...
/*
    ...
    🎮⚽️Cybloc⚽️🎮
    #CyBloc is a football-themed, NFT-based game with a Play-to-Earn model that allows you to test your might against players from around the world.
    Be quick to rise to the top of the ranks by building and training your dream team of CyBlocs now!
    ⚽️Cybloc Ecosystem
    🌆🖼Marketplace
    Native NFT Marketplace for CyBloc’s assets
    ⭐️CyLoans
    Proprietary CyBlocs loaning system for automated scholar-ships
    💰CyDex
    Trade CyBloc’s tokens right from our native interface
    What builds a CyBloc?
    ⚽️Traits
    Inherent abilities that will affect a CyBloc’s performance or potential earnings in-game
    ⚽️⚽️Class
    CyBlocs come in different tiers of rarity: Bronze, Silver, Gold, Platinum and Legendary
    ⚽️⚽️⚽️Skill
    All CyBlocs have 6 footballing skills: Tackling, Passing, Dribbling, Crossing, Shooting and Physical
    ---Game Features
    🎮⚽️Cybloc Game Summary ; 
    Exhibition ; Practice and compete in a more casual setting while earning rewards and experience
    Mentoring ; Create new CyBlocs (NFTs) using your existing CyBlocs as mentors
    Training ; Levelup Cyblocs in Battle Stadium (Manuel PVE) or Hire-a-Coach(automatic)
    Tactic Cards ; Strategize gameplay with tactic cards to boost your chance of winning
    League ; Register your line-up and rise to the top of the seasonal ladders.
    Tournament ; Exclusive tournaments for the best of the best teams
    💰💸Cybloc #Reflections
    Earn $CYBLOC by just holding #Cybloc in your wallet. 4% of every buy and sell transaction is distributed to #Cybloc holders.

    🌍Web               :https://Cybloc.io
    💗Buy on PinkSale   :https://www.pinksale.finance/#/launchpad/
    🔎Telegram          :https://t.me/CyblocOfficial
    🕊Twitter            :https://www.twitter.com/Cyblocio
    🖼️ Instagram        :https://instagram.com/Cyblocofficial
    🎮 Discord          :https://discord.gg/8bKsu2A9rF
    🎦Youtube           :https://www.youtube.com/channel/UCr0aszAEHW1g4kpkHaqyJ3w/about
...
contract CyBloc is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "CyBloc";
    string private constant _symbol   = "CYBLOC";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1000000000000000 * 10**9;
...
subtractedValue) public virtual returns (bool) {
        ...
        function unallowClaim(address account) external onlyOwner {
            _isAllowed[account] = false;
    }

    function allowClaim(address[] calldata addresses) external onlyOwner {
