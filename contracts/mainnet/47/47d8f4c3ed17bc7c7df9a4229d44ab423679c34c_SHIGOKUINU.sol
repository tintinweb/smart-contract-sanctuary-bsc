...
// Telegram - https://t.me/SHIGOKUINU_Portal

// Hard-coded tax limit - taxes cannot be set over 20%
// Anti-rug feature - max tx and max wallet cannot be set below 0.3%
...
contract SHIGOKUINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2836e4Eb0cA87b29DFcD42D8176D191E388B6C7d);
    address payable public TeamWalletAddress = payable(0xA91312834020688b1C9498A4B8F52fDd60F3bBeB);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (3 * 10**5 * 10**9));
