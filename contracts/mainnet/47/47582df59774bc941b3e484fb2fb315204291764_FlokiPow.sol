...
// 
//
// 📱 Telegram:https::https://t.me/FlokiPowVerify
...
contract FlokiPow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Floki Pow", "FlokiPow") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiPow";
    string private _symbol = "FlokiPow";
