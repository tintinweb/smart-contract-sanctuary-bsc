...
contract Sonarium109 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x94F45369f1C0672703e5F27A04fF2A18BEb545e5); 
    address payable public Wallet_Dev = payable(0xb3c2a75CF7e8CD620790592A23F0dd4d0Acf4deB);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 20**8 * 10**_decimals;
    string private constant _name = "Sonarium"; 
    ...
    constructor () {
        ...
        _owner =0xb3c2a75CF7e8CD620790592A23F0dd4d0Acf4deB ;
