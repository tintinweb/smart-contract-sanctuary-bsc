...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 public _vipLimit = 100 * 10**18;
    uint256 public _swapLimit = 2000 * 10**18;
    uint256 public _lotteryAmount = 400 * 10**18;
    ...
    address public ownerAddress =
        address(0x0E0e184a745521be51c4130e7a6025C9F5ff0E31);
    address public liquidityAddress =
        address(0xdDB9343079B325944917916E5ba7C805BF84d94e);
    ...
    function calculateBurnFee(uint256 _amount) private view returns (uint256) {
        if (_balances[burnAddress] >= 9899010000 * 10 ** 18) {
            return 0;
        }
