...
contract RYU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x23F454629F147FE2B4d1D4d2E339a6b3f9F81e9B);
    address payable public BuyBackWalletAddress = payable(0x23F454629F147FE2B4d1D4d2E339a6b3f9F81e9B);
    ...
    function addBlackList(address[] calldata accounts) public onlyOwner {
