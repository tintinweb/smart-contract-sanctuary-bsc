...
contract USDXImplementation {
    ...
    string public constant name = "Binance USDX"; // solium-disable-line
    string public constant symbol = "USDX"; // solium-disable-line uppercase
