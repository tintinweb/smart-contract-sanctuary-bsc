...
contract Martik {
    ...
    uint256 public sellTax = 1000; //total sell fee
    //BUY 5%
    uint256 public ecoFee_BUY = 500; //ecosystem fee
    uint256 public burnFee_BUY = 500; //burnFee
    //SELL 10%
    uint256 public ecoFee_SELL = 500; //ecosystem fee
    uint256 public burnFee_SELL = 500; //burnFee
    ...
    uint256 public DynamicTax = 1000; // holder receive 10% from ecosystem (IN TOKENS AND BNB)|| by default
    ...
    function setFees(
        ...
        uint256 v = 100;
        require(value(v, _ecoFee_B + _burnFee_B) <= 12, "MAX TAX IS 12%");
        require(value(v, _ecoFee_S + _burnFee_S) <= 12, "MAX TAX IS 12%");
