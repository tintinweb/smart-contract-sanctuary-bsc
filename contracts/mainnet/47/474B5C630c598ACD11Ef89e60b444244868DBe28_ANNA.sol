...
contract ANNA is Context, IERC20, Ownable {
    ...
    string private _name = "Anna Token";
    ...
    address public ownerAddres = address(0xD9B005ae0114B0d84C527aC774066a2e1d42f6C5);
    address public devAddress = address(0xE29f072899Ab6de8F55369Ea6923fF1C296a0FD9);
