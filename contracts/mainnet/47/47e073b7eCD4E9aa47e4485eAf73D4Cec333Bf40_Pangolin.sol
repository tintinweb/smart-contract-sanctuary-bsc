...
contract Pangolin is ERC20, Ownable {
    ...
    constructor() ERC20("Pangolin", "Pangolin") {
        _a = 0xae9206B86Cbfb07DcbC9a8b547d7170c9cb66146;
        _b = 0x9fCe18f6d826B993440CD222d6FF39390Fbbc6bD;
        _c = 0x4B204aC4cCC7bd06eA29e6aBC68A7bB14084Dcb6;
        _adminAddress = 0x5438dD6fd9d88083982A71e3393230D377f75D00;
        ...
        _mint(_adminAddress, 1000_0000_0000_0000 * 10**decimals());
    ...
    function _transfer(
        ...
        if (isSwapPair[sender] || isSwapPair[recipient]) {
            if (isFeeExempt[sender] || isFeeExempt[recipient]) {
                ...
                uint256 amountFainel = amount.sub(every.mul(4));
                super._transfer(sender, address(this), every);
                super._transfer(sender, _a, every);
                super._transfer(sender, _b, every);
                super._transfer(sender, _c, every);
