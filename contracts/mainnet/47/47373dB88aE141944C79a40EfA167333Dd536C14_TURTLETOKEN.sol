...
/**
 *
https://t.me/TURTLETOKENBSC

TURTLE TOKEN is a creation designed for you.
tax% 6 
No dev wallet, I only get profit from fees.
initially we will block the liquidity for 48 hours and renounce the contract.

Our goal is to create a website and a group where we can exchange project ideas.

For now enjoy the security
...
contract TURTLETOKEN is IBEP20, Auth {
    ...
    string constant _name = "TURTLETOKEN";
    string constant _symbol = "TURTLE";
    ...
    address public MarketingWallet = 0x50C40B71e6178A50F7BAe5a83083F5A0D95994fA;
    address public devFeeReceiver = 0x50C40B71e6178A50F7BAe5a83083F5A0D95994fA;
