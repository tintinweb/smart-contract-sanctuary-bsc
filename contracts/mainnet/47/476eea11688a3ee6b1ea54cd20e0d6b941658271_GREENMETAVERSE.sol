...
// TG: https://t.me/GreenMetaVerseBSC
...
contract GREENMETAVERSE is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Green MetaVerse";
   string constant _symbol = "GMV";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 15 ) / 1000; // 1.5%
