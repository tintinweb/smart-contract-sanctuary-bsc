...
// DogeSwap just down 2-3 hours ago with milllions doge value This could happen again any moment.
// We made $NCDW Dogeswap victims.

//NCDW ready to make the trend, the deployer and dev's previous project hit 17k$, and the project
//backed by a big amount of reputable callers,
//devs and trusted people of the BSC space

//Telegram : https://t.me/NewCommunityDogeSwap
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x928ef3fc5B15f2180bAaB0aaA53E8fA84db2AA21;
...
contract NewCommunityDogeSwap is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x928ef3fc5B15f2180bAaB0aaA53E8fA84db2AA21);
    ...
    */
    ...
    string private _name = "NEWCOMMUNITY DOGESWAP"; 
    string private _symbol = " $NCDW";  
