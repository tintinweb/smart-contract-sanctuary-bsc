...
contract ELTOROINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "EL TORO INU"; 
    string private constant _symbol = "ETI"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x0db60Fd01166B81279DaDB32bC90F916A912947F;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _Owned[address(this)] += promoFee + liquidityFee;
