...
TG: https://t.me/UPNetworkOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc47494be4559A587ff2437E270B6589cDf75aDF9; // owner address
...
contract UPNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"UP Network";
    string private _symbol = unicode"UPNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc47494be4559A587ff2437E270B6589cDf75aDF9); // Marketing Address
    address payable public teamWalletAddress = payable(0xc47494be4559A587ff2437E270B6589cDf75aDF9); // Team Address
