...
contract KAGOME is Context, IERC20, Ownable {
    ...
    string private _name = "Kagome";
    string private _symbol = "$KGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6509B5C4CF3A7F2B57cEf27E5084740429ddEdAD); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6509B5C4CF3A7F2B57cEf27E5084740429ddEdAD); // Team Address
