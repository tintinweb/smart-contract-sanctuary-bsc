...
contract Rabbitsmax is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xC943c791B8739E30F39Da8CCC9C78Cf736DFB7aA);
    ...
    */
    ...
    string private _name = "Rabbit Xmass"; 
    string private _symbol = "RabitXmS";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x1) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x1/100;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x1) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x1/100;
    }
