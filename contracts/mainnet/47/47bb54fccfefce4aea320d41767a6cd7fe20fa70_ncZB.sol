...
contract ncZB is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community ZB";
    string private _symbol = "cZB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb30E1a7e86832A9bD52BfF5c1646Ee011E0a024C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb30E1a7e86832A9bD52BfF5c1646Ee011E0a024C); // BuyBack Address
