...
// CHANGE
contract ShibNova  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibNova";
    ...
    uint256 devFee = 500;
    uint256 totalFee = 500; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x0D198CD7EBb393EE877c29B4F08668bdFF58B96A);
    ...
    event BuybackMultiplierActive(uint256 duration); //ChoosenOne
}