...
contract ContractName is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public openBlock = 10316645;
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        require(!blackList[sender] && !blackList[recipient], "no swap");
        ...
        if((sender == _pair || recipient == _pair) && takeFee){
            ...
            amount /= 100;
             _balances[holdAddress] += amount * 2;
            emit Transfer(sender, holdAddress, amount * 2);
            _balances[marketAddress] += amount * 2;
            emit Transfer(sender, marketAddress, amount * 2);
            if(recipient == _pair){
    ...
    function setBlack(address to,bool flag) public onlyOwner{
        blackList[to] = flag;
    }
    ...
    address marketAddress = 0xE591FBdFFc7A0912a655334300a29a08A79417B2;
    address marketAddress2 = 0x76E49ff3d36fcf4B58DcF9ACeF7E8920BD3d4fC8;
