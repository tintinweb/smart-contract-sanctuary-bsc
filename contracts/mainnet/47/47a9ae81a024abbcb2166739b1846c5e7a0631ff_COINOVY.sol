 ...
 */
contract COINOVY is Context, AccessControlEnumerable, BEP20Burnable, BEP20Pausable {
    ...
    constructor(string memory name, string memory symbol) BEP20(name, symbol) {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, 0x6000ffc664B1953b685d4afccF8AA58EEaA78981);

        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, 0x6000ffc664B1953b685d4afccF8AA58EEaA78981);

        _setupRole(PAUSER_ROLE, _msgSender());
        _setupRole(PAUSER_ROLE, 0x6000ffc664B1953b685d4afccF8AA58EEaA78981);
    }
