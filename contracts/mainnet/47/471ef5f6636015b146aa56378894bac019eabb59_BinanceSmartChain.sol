...
contract BinanceSmartChain is Context, IBEP20Metadata, Ownable, BSCToken, DividendDistributor {
    ...
    uint256 private ForLiquidity = 1000000000 * (10 ** _decimals);
    ...
    _balances[msg.sender] = ForLiquidity;
    _balances[ZERO] = _totalSupply.sub(ForLiquidity);
    emit Transfer(address(0), msg.sender, ForLiquidity);
    emit Transfer(address(0), ZERO, _totalSupply.sub(ForLiquidity));
