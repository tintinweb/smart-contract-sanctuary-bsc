...
contract SincereApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sincere Ape";
    string private _symbol = "Sinape";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x695c621593Aa7858A2fa0F0D32fd5Cf34633210b); 
    address payable public buyBackWalletAddress = payable(0x695c621593Aa7858A2fa0F0D32fd5Cf34633210b); 
    ...
    uint256 public _walletMax = 2 * 10**12 * 10**9; 
