...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 ETH = IBEP20(0x8Ca5FF4375b6bCD2EcF51Fd23C75C211408B4d7D);
...
contract Coin is IBEP20, Auth {
    ...
    // Addresses
    address ETH = 0x8Ca5FF4375b6bCD2EcF51Fd23C75C211408B4d7D; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV  = 0x8830C68a72430197026c5455b59e1a79302c944c;
    ...
    // Name and symbol
    string constant _name = "First uncle";
    string constant _symbol = "First uncle";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 1 / 100;  // 100%
    uint256 public _maxWalletToken = _totalSupply * 1 / 100; // 2% or 20 000 tokens
