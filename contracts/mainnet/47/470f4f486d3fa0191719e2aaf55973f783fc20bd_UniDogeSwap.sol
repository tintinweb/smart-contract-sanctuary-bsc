...
/**
🦄🦄 UNI DOGE 🦄🦄🦄
SWAP - USDC BRIDGE - EARN - DEX - MORE
Unidoge is born as a decentralized platform based on dogechain with a multitude of applications available. BSC bridge with low fixed FEES.

🗓 Native Token Launch 09/14/22
Contract: 0x470f4F486d3fA0191719e2aaF55973f783FC20BD

✅ USDC BSC BRIDGE ✅
🟢 BSC TO DOGECHAIN, ETHEREUM, POLYGON AND ARBITRUM.🟢

https://t.me/UniDogeSwap
https://unidoge.org/bsc
*/
...
contract UniDogeSwap is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2656929820709843A0eF2DD4Aa4c8c37f693bB1E); 
    address payable public Wallet_Dev = payable(0x2656929820709843A0eF2DD4Aa4c8c37f693bB1E);
    ...
    string private constant _name = "UniDogeSwap"; 
    ...
    constructor () {
        ...
        _owner = 0x2656929820709843A0eF2DD4Aa4c8c37f693bB1E;
