...
Telegram: @brainsoupverify
Twitter: @brainsoup_BRAIN
Instagram: @brainsoup_brain
GitHub: github.com/brain-Soup
Website: brainsoup.xyz
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); //Tether
...
contract BrainSoup is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Brain Soup";
    string constant _symbol = "BRAIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xeB86B7e6A80C1F170e85e9D6A56b6B4BD7145346;  // marketingwallet
    ...
    function changeTxLimit(uint256 newLimit) external authorized {
        ...
        require(newLimit >= 100000 * 10 ** _decimals); // Max Tx amount should be bigger or equal to 0.01% of Total Supply
    }
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        ...
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee;
        require(totalFee < 10); // Total fee should be lower or equal to 10%
    }
    ...
    function rescueTokens(IBEP20 token, address recipient, uint256 amount) external onlyOwner {
