...
contract SoccerDoge  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9f45eE93C3DB5C77F4611b6d9C857e37aD35e516); 
    address payable public Wallet_Dev = payable(0x9f45eE93C3DB5C77F4611b6d9C857e37aD35e516);
    ...
    string private constant _symbol = unicode"SODE"; 
