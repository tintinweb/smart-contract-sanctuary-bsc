...
contract HalfWBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Wrapped BNB";
    string private _symbol = "WBNB 0.5";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xFfC1Fe3e7d7ddc8D019E87e580639c827F11567A); 
    address payable public BurnedWalletAddress = payable(0xFfC1Fe3e7d7ddc8D019E87e580639c827F11567A); 
