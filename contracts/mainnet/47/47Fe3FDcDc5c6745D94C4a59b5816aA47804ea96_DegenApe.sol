...
contract DegenApe is DegenApeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DegenApeTeam;
    address private CharityDegenApe;
    ...
    string public override name = "DegenApe";
    string public override symbol = "DegenApe";
    ...
    constructor(uint totalSupplyValue, address DegenApeTeamAddress, address CharityDegenApeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DegenApeTeam = DegenApeTeamAddress;
        CharityDegenApe = CharityDegenApeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DegenApeTeam] =  totalSupply * 4 / 100;
        balances[CharityDegenApe] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's DegenApeTeam pot
