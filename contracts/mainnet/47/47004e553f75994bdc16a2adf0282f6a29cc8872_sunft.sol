...
// SPDX-License-Identifier: Unlicensed
 ...
 /*
NOTE: Trading with Bots on The Contract is not allowed/prohibited. Wallets Address trading with Bots will be Blacklisted.
...
The Contract is a, Web 3, Play-to-Earn, NFT project that will allow existing games to access and create last man standing games on the blockchain 
directly through their API and reward system, strategically prioritizing price stability conducive for investors and financial system.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5593EF6F1A09a31382F5351B2328d4B0bE7C3e5e;
...
contract sunft is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5593EF6F1A09a31382F5351B2328d4B0bE7C3e5e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "sun soft";
    string private _symbol = "SunT";
