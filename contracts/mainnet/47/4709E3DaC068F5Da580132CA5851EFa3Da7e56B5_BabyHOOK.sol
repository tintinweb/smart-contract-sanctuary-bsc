...
contract BabyHOOK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyHOOK";
    string private _symbol = "BabyHOOK";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xcD984b923C072b5C5c33674aEaE380842d7aa4fC); 
    address payable private teamWalletAddress = payable(0xcdCAC48B354e556ab5E1E1c41a890DEC7D7A9638); 
