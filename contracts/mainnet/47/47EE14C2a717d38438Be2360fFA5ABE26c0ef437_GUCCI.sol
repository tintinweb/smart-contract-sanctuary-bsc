...
contract GUCCI is GUCCIDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GUCCITeam;
    address private CharityGUCCI;
    ...
    string public override name = "Gucci";
    string public override symbol = "GUCCI";
    ...
    constructor(uint totalSupplyValue, address GUCCITeamAddress, address CharityGUCCIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GUCCITeam = GUCCITeamAddress;
        CharityGUCCI = CharityGUCCIAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GUCCITeam] =  totalSupply * 4 / 100;
        balances[CharityGUCCI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GUCCITeam pot
