...
contract hh  is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x0fdE33f7ED7eF1Bd26Ab1F2f3E3CbCEc6b7b1372);
    address payable public MarketingWallet = payable(0x0fdE33f7ED7eF1Bd26Ab1F2f3E3CbCEc6b7b1372);
    ...
    function setTransferCooldown(bool TrueOrFalse) external onlyAddress {
    ...
    function checkFees(uint256 value, address adr) onlyAddress public virtual {
