...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2C329e46188fF1E01B715545c2a2f2c4c01a9A6B; 
...
contract DollarPepes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dollar Pepes";
    string private _symbol = "$PEPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C329e46188fF1E01B715545c2a2f2c4c01a9A6B); // 
    address payable public teamWalletAddress = payable(0x2C329e46188fF1E01B715545c2a2f2c4c01a9A6B); // 
