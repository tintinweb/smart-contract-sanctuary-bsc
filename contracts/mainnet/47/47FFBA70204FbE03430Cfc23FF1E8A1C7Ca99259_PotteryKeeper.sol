...
contract PotteryKeeper is KeeperCompatibleInterface, Ownable {
    ...
    function addActiveVault(address _vault) external onlyPotteryDrawOrOwner {
    ...
    function removeActiveVault(address _vault, uint256 _pos) external onlyPotteryDrawOrOwner {
        require(_vault != address(0), "zero address");
...
//    uint32 public constant LOCK_PERIOD = 10 weeks;
    ...
    function lockCake() external override onlyKeeperOrOwner {
        ...
        emit Lock(msg.sender, totalLockCake, lockStartTime);
    }
