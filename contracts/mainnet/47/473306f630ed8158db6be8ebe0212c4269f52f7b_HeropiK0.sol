...
contract HeropiK0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HeropiK0";
    string private _symbol = "HeropiK0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3A8B104011A12e566753dafa5F1ADddF693173d);
    address payable public teamWalletAddress = payable(0xb3A8B104011A12e566753dafa5F1ADddF693173d);
