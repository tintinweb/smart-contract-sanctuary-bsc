...
/**
    Ruby Inu
    Telegram : https://t.me/rubyinubsc
*/
...
contract RubyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ruby Inu";
    string private constant _symbol = "RUBYINU";
    ...
    mapping (address => uint256) private _isgetswap;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetswap[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetswap[to] = block.timestamp;
        }
