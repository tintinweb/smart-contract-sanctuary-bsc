...
/**
Telegram https://t.me/tokuda_bsc
*/
...
contract TokudaInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Tokuda Inu";
    string private _symbol = "Tokuda";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xB094272656FFA36c9D2B8bB3fCe38710e2C97004);
    ...
    uint256 private _totalSupply =  690000 * 10**29;
    uint256 public _maxTxAmount =   690000 * 10**29;
    uint256 public _walletMax =     690000 * 10**29;
    uint256 private minimumTokensBeforeSwap = _totalSupply.mul(1).div(10000);
