...
contract AssuredToken is Context, IBEP20, Ownable {
    ...
    uint256 private numHours = 3; //Withdraw every 3 hrs
    uint8 constant BONUS_LINES_COUNT = 10;
    uint16 constant PERCENT = 1000; 
    uint16[BONUS_LINES_COUNT] public ref_bonuses = [150, 100, 50, 30, 20, 10, 5, 3, 2, 1]; 
    ...
    constructor() public {
        ...
        _symbol = "AST";
        _decimals = 18;
        _totalSupply = 200000000000000000000000; // 200k for this genesis pool
        _balances[address(this)] = _totalSupply;

        emit Transfer(address(0), address(this), _totalSupply);
        
        devt = 0x953463d414258495F3ff162B595322DE8b8BD98D;
        charity = 0xe082Bda33BD87d139dB7a37bf51CE4CC466E1C00;
		    marketing = 0x4DF5EBBFEE42892643309E5b1A26E65B50e1a5d1;
        
        uint256 tarifPercent = 125;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        address payable addr1 = address(uint160(devt));
        address payable addr2 = address(uint160(charity));
        address payable addr3 = address(uint160(marketing));
        addr1.transfer(shares);
        addr2.transfer(shares);
        addr3.transfer(shares);
    ...
    function withdraw() external {
        ...
        require (block.timestamp >= (player.last_payout + (HOUR * numHours)), "Not due yet for next withdrawal!");
