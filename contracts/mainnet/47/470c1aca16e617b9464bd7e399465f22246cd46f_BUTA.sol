...
Telegram : https://t.me/ButaInubsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd62532e636b43f7046aA8a76d5454ffE4Da3837f;
...
contract BUTA is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUTA INU"; // 
    string private constant _symbol = "$BUTA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xd62532e636b43f7046aA8a76d5454ffE4Da3837f);
