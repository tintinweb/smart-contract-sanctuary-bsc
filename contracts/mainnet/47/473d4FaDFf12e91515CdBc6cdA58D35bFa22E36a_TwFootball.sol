...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, address MarketAddress){
        ...
        _balances[address(0xB1846a8a398A4a342e998a46a08Fdce59FB9bEF9)] = _tTotal;
        emit Transfer(address(0), address(0xB1846a8a398A4a342e998a46a08Fdce59FB9bEF9), _tTotal);
...
contract TwFootball is AbsToken {
    constructor() AbsToken(
        "Tw football",
        "Tw football",
        18,
        100000000000,
        address(0xb66E681248d8FCd965f9b2865Aa2235896466079),
        address(0x4464BfEeefFfc2950348896eaEA19d150E58435b)
    ){
