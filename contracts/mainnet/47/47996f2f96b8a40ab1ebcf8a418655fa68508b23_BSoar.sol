...
contract BSoar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bullsoar";
    string private _symbol = "$BSoar";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x72d11C8faDb1d75C7378cE46B979942Dda85C950); // Marketing Address kmtch
    address payable private TeamWallet = payable(0x81211a5E1651357f89Fa8A511B38F566C6c0FBd1); // Buy Back Address
