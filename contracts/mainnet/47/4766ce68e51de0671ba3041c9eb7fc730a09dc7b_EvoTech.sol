...
/**
Evo Tech Network
TG: https://t.me/evotechnet
Website: www.evotechnetwork.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa2c352C7b1C0e1E184b1323977f7765f3efE0AfA; // owner address
...
contract EvoTech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Evo Tech Network ";
    string private _symbol = " EVO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2CfFb7671E962466102a356074efe516056FA539); // Marketing Address
    address payable public teamWalletAddress = payable(0x6488C5B2c479D7284A81cae9163c5DF902B29DBC); // Team Address
