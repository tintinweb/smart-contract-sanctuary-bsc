...
contract TaurenToken is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        TRN = TaurenNFT(0xDE2d40e53a242F0d5A12c0fC1F3Fbe04E04f9688);
    ...
    function rescueBullNFT(uint256 _bullPeriodIndex) public {
        ...
        uint256 price = (105 ** (length - 1)).mul(10000).div(100 ** (length - 1)).mul(hammerBasePrice).div(10000);
    ...
    function getBullNFTDetail(uint256 _bullPeriodIndex) public view returns(uint256 tokenId, address currentOwner, uint256 price, uint256 sealTimes) {
        ...
        if(hammerOwner[_bullPeriodIndex].length > 0){
            ...
            price = (105 ** (length - 1)).mul(10000).div(100 ** (length - 1)).mul(hammerBasePrice).div(10000);
        }
    ...
    function getBullNFTPrice(uint256 _bullPeriodIndex) public view returns(address user) {
