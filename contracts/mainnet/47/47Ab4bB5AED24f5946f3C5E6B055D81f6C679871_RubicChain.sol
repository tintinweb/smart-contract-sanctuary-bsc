...
/**
/*
👥 Telegram : https://t.me/RubicChain
...
contract RubicChain is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xa732aEFAE32773a4F0574eE83CF8CAeDc2e9166c));
    address payable private devWallet =
        payable(address(0xa732aEFAE32773a4F0574eE83CF8CAeDc2e9166c));
    address private liquidityReceiver =
        0xa732aEFAE32773a4F0574eE83CF8CAeDc2e9166c;
    ...
    uint256 private _maxWalletSize = 50000000000 * 10**9;
