...
https://t.me/NinjitsuInu

The best way to beat the jeets is to join the Ninjitsu Army!
...
contract NinjitsuInu is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Ninjitsu Inu';
    string private constant _symbol = 'NINJINU';
    ...
    uint256 public swapThreshold = ( _tTotal * 500 ) / 100000; // .50% of total supply
