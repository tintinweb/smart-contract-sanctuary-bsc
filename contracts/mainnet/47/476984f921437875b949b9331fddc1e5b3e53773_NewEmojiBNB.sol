...
contract NewEmojiBNB is IBEP20, Ownable {
    ...
    string constant _name = "New Emoji BNB";
    string constant _symbol = unicode"Emoji";
    ...
    address private marketingWallet = 0x85BE68dCDAA3e21BAB42319f9193826f20110480;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(3, 2, 3, 0);
    Fees public sellFees    = Fees(3, 2, 3, 0);
    ...
    function Multisell() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
