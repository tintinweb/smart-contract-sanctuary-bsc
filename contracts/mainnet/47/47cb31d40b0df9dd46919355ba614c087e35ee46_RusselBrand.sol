...
/**
Telegram group: https://t.me/rusellbrandinu

https://twitter.com/elonmusk/status/1632067924390293504
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB3D3775543Eaffc040d4E6C99176e5DA093dae99; // owner address
...
contract RusselBrand is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Russel Brand Inu";
    string private _symbol = "RBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB3D3775543Eaffc040d4E6C99176e5DA093dae99); // Marketing Address
    address payable public teamWalletAddress = payable(0xB3D3775543Eaffc040d4E6C99176e5DA093dae99); // Team Address
