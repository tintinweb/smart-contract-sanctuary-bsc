...
contract SMV is Context, IERC20, Ownable {
    ...
    address private _devWalletAddress = 0x4A6b3E0965FaBb527d7F12a69c4bcf8AEf27c43C;
    ...
    function setTokensAtSwap(uint256 newVal) external onlyOwner() {
