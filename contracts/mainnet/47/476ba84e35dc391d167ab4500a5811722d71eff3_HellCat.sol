...
// New and improved, custom burn contract.

// TG: https://t.me/HellCatPortal
...
contract HellCat is TradableErc20, Withdrawable {
    uint256 constant pairInitialLiquidity = 10000e4;
    uint256 constant initialBurn = 0e4;
    event airdtop();

    constructor() TradableErc20("HellCat", "HC") {
        _withdrawAddress = address(0xC977414aFe28021793a8138C1057F9645aC5c93B);
        _totalSupply = 0;
    }
