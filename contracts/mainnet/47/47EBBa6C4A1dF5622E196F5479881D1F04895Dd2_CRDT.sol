...
contract CRDT is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    string public tokenSymbol = "CRDT";
    ...
    address public idoWalletAddress = 0x5D7BA78647BEa62d0d33b78056fd05592946bb92;
    ...
    function initialFunding() private {
      ...
      _transfer(address(this), gameRewardWalletAddress, (144000000 * 1 ether));
      _transfer(address(this), airdropWalletAddress, (6000000 * 1 ether)); 
      _transfer(address(this), idoWalletAddress, (15000000 * 1 ether)); 
    ...
    function addVestingDates() private {
        ...
        VESTING_SCHEDULES["Development"].push(vesting(Jan_01_2024,(1500000 * 1 ether),false)); 
        ...
        VESTING_SCHEDULES["Marketing"].push(vesting(Jan_01_2023,(960000 * 1 ether),false)); 
    ...
    function setIdoWalletAddress(address _wallet) external onlyRole(DEFAULT_ADMIN_ROLE){
      idoWalletAddress = _wallet;
    }
        ...
        override
    {
        if(!paused()){
         super._beforeTokenTransfer(from, to, amount);
          ...
          require(hasRole(TRANSFER_ROLE, from),"Cannot Transfer");
          super._beforeTokenTransfer(from, to, amount);
        }
    }
}
