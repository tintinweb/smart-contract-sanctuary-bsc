...
*TELEGRAM: https://t.me/mooniggrow
*/
...
contract MooningGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mooning Grow"; 
    string private _symbol = "$GG"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93FfBd0baf589d1Df8EeDA63797040835147B17D); 
    address payable public teamWalletAddress = payable(0xd62bA4d1A182cddD20E6a5F575aC0E9779016696); 
