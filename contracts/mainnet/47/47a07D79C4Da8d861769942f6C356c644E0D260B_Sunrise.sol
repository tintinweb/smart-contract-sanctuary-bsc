...
// Sunrise Finance COPYRIGHT (C) 2022 
...
contract Sunrise is ERC20Detailed, Ownable {
    ...
    string public _name = "Sunrise";
    string public _symbol = "SRISE";
    ...
    constructor() ERC20Detailed("Sunrise", "SRISE", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x7d5F14fAA1644b518945171b3200D13136956217; 
        safuuInsuranceFundReceiver = 0xD8914826fB95Dc765A3827B65866b285942B21Fc;
        firePit = 0x214d6c9b27EA27c23CB482196fb45a49CBD7554f;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Sunrise token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
