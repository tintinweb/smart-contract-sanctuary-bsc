...
/*
    ...
    Popular anime, One Piece!!
    Has become one of the most loved anime series of all time and is probably the most famous pirate’s anime out there,
    Bringing in all kinds of fans.

    If you fans of one piece, dont miss Kawamatsu Boy!

    Telegram : https://t.me/KawamatsuBoy
    Website : https://kawamatsu.io/
*/
interface IERC20 {
...
contract KawamatsuBoy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kawamatsu Boy"; //
    string private constant _symbol = "KB"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x409E1D6176F312fC5b7112102EAaBB4C2647A015;
