...
contract BabyCatcherCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Catcher Coin";
    string private _symbol = "Baby Catcher";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xbC077e8c0883E88563B4fa4aCFF724f7dE4890E2);
