...
contract GreenChannabisFrog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Green Channabis Frog";
    string constant _symbol = "GCF";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 3000000000  * (10 ** _decimals);
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 1000 && multiplier * totalFee <= 490000, "Multiplier too high");
    ...
    function setFees(uint256 _liquidityFee, uint256 _prizepoolFee, uint256 _reflectionfee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        prizepoolFee = _prizepoolFee;
        reflectionfee = _reflectionfee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_prizepoolFee).add(_reflectionfee).add(_marketingFee);
