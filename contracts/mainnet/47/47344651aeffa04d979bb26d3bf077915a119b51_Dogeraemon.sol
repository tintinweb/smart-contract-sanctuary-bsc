...
/**
A futures meme coin. DOGERAEMON stealth launch On binance Smart Chain. An experienced, safe and well connected  team.  Are you ready to go parabolic?
...
CHANNEL : https://t.me/Dogeraemon  

TWITTER : https://twitter.com/dogeraemon/
*/
...
contract Dogeraemon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogeraemon";
    string private _symbol = "Dogeraemon";
    ...
    // Liquify when 2 trillion tokens are stored
