...
contract DateDogeCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Date Doge Coin";
    string private _symbol = "DateDoge";
    ...
    uint256 private _maxRestrictionAmount = 1 * 10**15 * 10**9;  // maximum trade amount allowed in the first 10 minutes
