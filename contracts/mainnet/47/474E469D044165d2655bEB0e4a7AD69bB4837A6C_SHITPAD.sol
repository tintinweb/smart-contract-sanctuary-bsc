...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/ShitPadPortal

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://www.shitpad.co

𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/Shitpad
...
contract SHITPAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shitpad";  
    string private constant _symbol = "SHITPAD";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 6; 
    uint256 public _ShitpadTax = 2; 
    address public  _marketing = 0xA46991845800412486BF9af93dD588409782967f;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _ShitpadTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _ShitpadTax / (_marketingAndLiquidityFee + _ShitpadTax);
