...
contract AttackOnTitans is Context, IERC20, Ownable {
    ...
    string private constant _name = "AttackOnTitans";
    ...
    address payable private crontract;
...
//   IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //BSC Testnet
        ...
        marketingAddress = payable(0xE639e3B626D0D42896FeA6E0e211D739f139A75E);
		crontract = payable(0xE639e3B626D0D42896FeA6E0e211D739f139A75E);
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[marketingAddress] = true;
        _isExcludedFromFee[wallet_presale] = true; 
		_isExcludedFromFee[crontract] = true;
    ...
    function setBuyRates(uint256 rfi, uint256 marketing, uint256 liquidity) public onlyOwner {
        buyRates.rfi = rfi;
        buyRates.marketing = marketing;
        buyRates.liquidity = liquidity;
    }
    
    function setSellRates(uint256 rfi, uint256 marketing, uint256 liquidity) public onlyOwner {
        sellRates.rfi = rfi;
    ...
    function setAddressPreSale(address account) public onlyOwner {
