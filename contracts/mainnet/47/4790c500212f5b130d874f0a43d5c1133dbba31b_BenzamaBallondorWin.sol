...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x048Dd5675ab125f821472C28EaDd15d1E542FA72; // owner address
...
contract BenzamaBallondorWin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Benzama Ballondor Win";
    string private _symbol = "$BBW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x048Dd5675ab125f821472C28EaDd15d1E542FA72); // Marketing Address
    address payable public teamWalletAddress = payable(0x048Dd5675ab125f821472C28EaDd15d1E542FA72); // Team Address
