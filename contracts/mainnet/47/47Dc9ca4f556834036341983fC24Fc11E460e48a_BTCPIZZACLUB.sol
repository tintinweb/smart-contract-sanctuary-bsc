...
/**
 * May 22nd was the day when for the first time A pizza was bought for 10,000 Bitcoins and here we are Where Now you can open a Whole pizza place with only 1 bitcoin.
   This historic rise is surely commendable and We are here to celebrate that!
   Join BITCOIN PIZZA CLUB to celebrate the humankind’s greatest wealth generation asset.
*/
...
contract BTCPIZZACLUB is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "BTC PIZZA CLUB";
    string constant _symbol = "BTCPIZZA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x297B76F984F9cd9aA053C043A4F2E8c151E4b354;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    function swapBack() internal lockTheSwap {
        ...
        // only to supress warning message
        tmpSuccess = false;
        tmpSuccess1 = false;
