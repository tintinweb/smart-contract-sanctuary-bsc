...
/**
/*  
Telegram : https://t.me/lamborghiniinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfE4439cDFFD729D6724C71736CA9Ed5559296446; 
...
contract LAMBORGHINIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LAMBORGHINI INU";
    string private _symbol = "LAMBORGHINI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD7Cb6dc8A1dc36F60810cE6c1a7Ae68AB9800365); // 
    address payable public teamWalletAddress = payable(0xfE4439cDFFD729D6724C71736CA9Ed5559296446); // 
