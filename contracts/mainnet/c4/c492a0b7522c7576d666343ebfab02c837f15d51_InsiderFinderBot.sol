...
//Telegram: https://t.me/InsiderFinderBot
//Website: https://t.me/InsiderFinder_Bot
//$IFB bot follows 1000++ insiders wallet and send token insiders buys BEFORE lp is added. Try it 
//Free: access to 300+ wallets
//Extra: access to 1000++ wallets and early notification
//🔝Extra: access to 1000++ wallets and early notification
//Require 3,000,000. IFB Tokens. Buy and set transaction hash to proceed 
...
contract InsiderFinderBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Insider Finder Bot";
    string private _symbol = unicode"IFB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xcb5c0C614fDBdd0455f1A7Dda88224b5F8620ECD));
        marketingWallet = payable(address(0xbEE27e3e9E64DEF803d17E0d44233a6B6f22CB35));
