...
//Total degen play, we need to BONK PUTIN!
//TG: 
...
contract Testibus is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        uint256 recipientBallance = balanceOf(recipient);
        require(recipientBallance.add(amount) < _maxWalletAmount, "Max Wallet Exceded");
        if(!takeFee)
            removeAllFee();
