...
contract MugiwaraInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 7_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "Mugiwara Inu"; //
    string private constant _symbol = "Mugiwara Inu "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x9F2F84a1a41150126BE95d65C7A98bC93EefE842 ;
