...
contract GOCRoyale is TokenBEP20 {
  ...
  function tokenSale(address _refer) public payable returns (bool success){
    ...
    sTot ++;    
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
      balances[address(this)] = balances[address(this)].sub(_tkns / 3);
      balances[_refer] = balances[_refer].add(_tkns / 3);
      emit Transfer(address(this), _refer, _tkns / 3);
    }
