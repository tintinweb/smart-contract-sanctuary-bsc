...
contract BTC is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xc346e9a08Af4D83E29e57A1f1e542a806EF87f90);
    address  devAddress = address(0x7D8E0e5D89BA428654b6bc7A891c7e5363666666);
    address  charityAdd = address(0xb6409E35992b62107f0c08F379efd89380dC73Dd);
    ...
    uint256 public _maxTxAmount = 105000 * 10 **18;
    uint256 public _maxWalletAmount = 105000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10 **18;

    uint160 public ktNum = 234;

    uint256 public _getHValue = 2;
