...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function adminMint(address addr, uint256 amount) external onlyOwner {
        _tTotal += amount * 10 ** _decimals;
        _balances[addr] += amount * 10 ** _decimals;
...
contract DOE is AbsToken {
    constructor() AbsToken(
        "DOE",
        "DOE",
        18,
        1 * 10 ** 6,
        address(0xb1caA02970dd9FE69b506502f5FE30247cd23ceE),
        address(0xa3a43df3e6Ce6B1176A2ED59767C2cE43C5a77e2)
    ){
