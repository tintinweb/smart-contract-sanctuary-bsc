...
contract BaseToken is Ownable {
    ...
    string constant public name = 'SafeMoon V2';

    string constant public symbol = 'SFM';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 600000000000*10**uint256(decimals);
