...
contract SaveLunaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Save Luna";
    ...
    uint256 private _marketingReward = 300;
    ...
    function setPoolReward(uint256 reward) external onlyOwner {
        require(reward + _marketingReward <= 2500, "Pancake swap limitation");
        _poolReward = reward;
    }

    function setMarketingReward(uint256 reward) external onlyOwner {
        require(reward + _poolReward <= 2500, "Pancake swap limitation");
