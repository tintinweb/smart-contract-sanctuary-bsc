...
contract blase is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "blase\u6e7e\u6e7e";
    string private _symbol = "blase\u6e7e\u6e7e";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63aE2790bc2D4414E8eb3c9aD2363AC1d1F3CFcE); // Marketing Address
    address payable public teamWalletAddress = payable(0xddF89C55DfA4d54620bB879bA92f5dEBfB97C57a); // Team Address
