...
contract Launchpad is Ownable {
    ...
    address public admin = 0x4BB0CFB32F3584A97317be72BB3283Aa73d3E610;
    ...
    function approveToken(address _token, bool _flag) external {
        require (msg.sender == owner() || msg.sender == admin, "!permission");
        whitelist[_token] = _flag;
    }

    function updateAdmin(address _wallet) external onlyOwner {
        admin = _wallet;
    }
...
contract PresalePool is Ownable, ReentrancyGuard {
    ...
    function cancelSale() external beforeStarted onlyTokenOwner {
    ...
    function _invest() internal nonReentrant {
        require (!canceled, "canceled sale");
    ...
    function started() external view returns (bool) {
        return  !canceled && block.timestamp >= startTime;
    }

    function ended() public view returns (bool) {
        return canceled || block.timestamp >= endTime || raised >= hardcap * 99999 / 100000;
    }
