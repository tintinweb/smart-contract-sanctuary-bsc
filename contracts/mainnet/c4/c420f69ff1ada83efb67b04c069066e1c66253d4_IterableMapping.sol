...
contract BPAY is ERC20, Ownable {
    ...
    constructor() ERC20("BUSD PAY", "BPAY") {
        ...
        totalBuyFee          = rewardFeeOnBuy + marketingFeeOnBuy + liquidityFeeOnBuy + burnTaxFeeOnBuy;
        totalSellFee         = rewardFeeOnSell + marketingFeeOnSell + liquidityFeeOnSell + burnTaxFeeOnSell;
