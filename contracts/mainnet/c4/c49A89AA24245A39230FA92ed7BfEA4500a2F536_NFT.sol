...
contract NFT is ERC721Enumerable, Ownable {
    ...
    IERC20 private _HHZ;
    constructor() ERC721("NFT Of HHZ", "NOH") {
        _USDT = IERC20(0x55d398326f99059fF775485246999027B3197955);
        _market = 0xbe9AAe54827A4A8c86ddB87630b433889759de43;
        nftMax = 2000;
    }
    ...
    function withdraw() public {
        ...
        if (user.balance > 0) {
            _HHZ.transfer(msg.sender, user.balance);
            _lastBalanceToken = _HHZ.balanceOf(address(this));
            user.balance = 0;
        }
        ...
        returns (uint256, uint256)
    {
        ...
        if (_HHZ.balanceOf(address(this)) > _lastBalanceToken) {
            uint256 balance = _HHZ.balanceOf(address(this)) - _lastBalanceToken;
