...
contract SailormoonDoge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7C966356f8AF937622D2081E72660b8e06AFb5f5); 
    address payable public Wallet_Dev = payable(0x8C5df363A59103b2B0b4fc3B22fb9BaB31901Af2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
     uint256 private _tTotal = 100000000 * 10**3 * 10**_decimals;
    string private constant _name = "Sailormoon Doge"; 
    ...
    constructor () {
        ...
        _owner = 0x8C5df363A59103b2B0b4fc3B22fb9BaB31901Af2;
