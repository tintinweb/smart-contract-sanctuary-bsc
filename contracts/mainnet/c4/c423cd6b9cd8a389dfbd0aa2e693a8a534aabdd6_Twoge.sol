...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1575742822733a35B65649ae53fD90dC54724Cf2; // owner address
...
contract Twoge is Context, IERC20, Ownable {
    ...
    string private _name = "Twoge 2023";
    string private _symbol = "Twoge2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3F51F4512d10785589A4AD0936916adcbd45c4f); // Marketing Address
    address payable public teamWalletAddress = payable(0xa3F51F4512d10785589A4AD0936916adcbd45c4f); // Team Address
