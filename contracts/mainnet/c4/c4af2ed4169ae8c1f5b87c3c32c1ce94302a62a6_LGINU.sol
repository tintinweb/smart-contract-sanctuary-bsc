...
TELEGRAM: https://t.me/LittleGrimaceInu
|
*/
...
contract LGINU   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Little Grimace Inu ";
    string private _symbol = "LGINU "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x82E340b047c7455Cd9e04D0E34Aef681B2F9A64B); 
    address payable public teamWalletAddress = payable(0x82E340b047c7455Cd9e04D0E34Aef681B2F9A64B); 
