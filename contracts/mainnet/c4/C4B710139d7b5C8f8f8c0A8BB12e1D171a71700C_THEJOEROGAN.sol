...
contract THEJOEROGAN is Context, IERC20, Ownable {
    ...
    string private _name = "THE JOE ROGAN";
    string private _symbol = "THEJOEROGAN";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable public marketing =
        payable(0x999088E63134600b281b8701B03E723Db4F9BbBF);
