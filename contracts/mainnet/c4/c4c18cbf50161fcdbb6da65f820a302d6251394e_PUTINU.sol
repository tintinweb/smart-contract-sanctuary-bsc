...
/**
There are no winners in war, WORLD WAR INU
https://t.me/worldwarinu3
...
contract PUTINU is Context, IERC20, Ownable {
    ...
    uint256 private _taxFeeOnSell = 97;
    
    uint256 private _redisFee;
    uint256 private _taxFee;
    
    address payable private _developmentAddress = payable(0x9bd059a50cCa31D52Cf1c6EDfc7C2F652d548D04);
    address payable private _marketingAddress = payable(0x9bd059a50cCa31D52Cf1c6EDfc7C2F652d548D04);
    
    string private constant _name = "WORLD WAR INU";
    string private constant _symbol = "WWINU";
