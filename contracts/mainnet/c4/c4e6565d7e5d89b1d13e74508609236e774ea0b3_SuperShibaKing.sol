...
contract SuperShibaKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "SuperShibaKing";
    string private _symbol = "SuperShibaKing";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0a51E8Bd5e9d48FCc122Fbcb17eeDa4CA72eA577));
        ________ = payable(address(0x0a51E8Bd5e9d48FCc122Fbcb17eeDa4CA72eA577));
