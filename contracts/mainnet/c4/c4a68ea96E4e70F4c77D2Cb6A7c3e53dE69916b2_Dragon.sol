...
contract Dragon is ERC20, Ownable {
    ...
    DragonNetworkDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Dragon Network", "DRAGON") {
        marketingWallet = payable(0x3f39AD3e4ee6A9c4130e59B91E4F54b7d0397C63);
        devWallet = payable(0x68CC05A26FAC043dF8fF943D5DE29CD91c15E8F9);
        ...
        dividendTracker = new DragonNetworkDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "DragonNetworkTRACKER",
            "DRAGONNETWORKTRACKER"
        );
...
contract DragonNetworkDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        DragonContract = Dragon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DragonNetwork_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DragonNetwork_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DragonNetwork contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DragonContract);

            uint256 prevBalance = DragonContract.balanceOf(address(this));
            ...
            {
                uint256 received = DragonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DragonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
