...
contract LunaGold is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Gold Coin"; // 
    string private constant _symbol = "LunaGold"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x9EDA0CFaE81Cb8Be5A64fc7FE4e40BF6cfEEb432;
