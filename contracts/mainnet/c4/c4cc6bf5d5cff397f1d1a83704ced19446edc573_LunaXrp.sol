...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x514D991bbede74c470740881600E8c27F8B4B550; // owner address
...
contract LunaXrp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luna Xrp";
    string private _symbol = "LUNX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x514D991bbede74c470740881600E8c27F8B4B550); // Marketing Address
    address payable public teamWalletAddress = payable(0x514D991bbede74c470740881600E8c27F8B4B550); // Team Address
