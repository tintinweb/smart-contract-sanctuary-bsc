...
// implements: BEP20 interface, fees & swaps
contract Baywatch is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	// MAIN TOKEN PROPERTIES
	string private constant NAME = "SuperSun";
	string private constant SYMBOL = "SUPERSUN";
	...
	uint8 private _highBuyFee; //This fee is apply for bot system
    ...
    address private _marketingWallet = 0x4483F5fC0BE763e25fbe590Dc1C7C64ab0953a4d;
    address private _devAddress = 0x4483F5fC0BE763e25fbe590Dc1C7C64ab0953a4d;
	...
	constructor (address routerAddress) {
		...
		// Initialize PancakeSwap V2 router and BAY <-> BNB pair.
		setPancakeSwapRouter(routerAddress);

		_maxHoldAmount = 1200000 * 10**DECIMALS;

		// 0% liquidity fee, 0% reward fee, 5% marketing fee, 0% dev fee
		setFees(0, 0, 5, 0);
	...
	function onBeforeCalculateFeeRate() internal virtual view returns(bool) { return false;}
	...
	// This function swaps a {tokenAmount} of BAY tokens for BNB and returns the total amount of BNB received
	function swapTokensForBNB(uint256 tokenAmount) internal returns(uint256) {
		uint256 initialBalance = address(this).balance;
		
		// Generate pair for BAY -> WBNB
	...
	// Returns how many more $BAY tokens are needed in the contract before triggering a swap
    ...
    // This function is used to enable all functions of the contract, after the setup of the token sale (e.g. Liquidity) is completed
//	function onActivated() internal override {super.onActivated(); updateAntiBotStatus(true); }
