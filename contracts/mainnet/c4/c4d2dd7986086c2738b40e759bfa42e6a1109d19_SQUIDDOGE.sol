...
contract SQUIDDOGE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 450_000 * 10**_decimals;
    uint256 public maxTxAmount = 2_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 2_000_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xbbEF4054F4c8c7C83a59d9bFE5E6438AbdD74517;

    string private constant _name = "Squid Doge";
    string private constant _symbol = "SQUOGE";
    ...
    Taxes public taxes = Taxes(0,70,1,0);
