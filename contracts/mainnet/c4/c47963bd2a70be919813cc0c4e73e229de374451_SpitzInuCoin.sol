...
contract SpitzInuCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpitzInu";
    string private _symbol = "$SPITZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1AAD95A70c4d1c3c39680Cb2bfA75DBfa59B5AEc); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1AAD95A70c4d1c3c39680Cb2bfA75DBfa59B5AEc); // BuyBack Address
