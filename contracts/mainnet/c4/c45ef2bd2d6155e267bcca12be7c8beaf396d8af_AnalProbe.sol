...
contract AnalProbe is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xFecc21CCb12f9fA965CdbB00f1c19417C8F7a5e7;

    string constant _name = "AnalProbe";
    string constant _symbol = "AnalProbe";
