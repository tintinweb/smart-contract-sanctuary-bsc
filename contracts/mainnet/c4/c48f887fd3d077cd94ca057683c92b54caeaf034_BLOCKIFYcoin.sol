...
contract BLOCKIFYcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blockify.Games";
    string private constant _symbol = "BLOCKIFY";

    address public _PancakeSwapV1RouterUniswap = 0x864acB0bccCf688104d1D79a7a5A9D2686660294; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x864acB0bccCf688104d1D79a7a5A9D2686660294; //can be the same
