...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC64f0147ff4eB44d18510477F86668B379C3010b; // owner address
...
contract Usagimine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Usagimine ";
    string private _symbol = "USAMINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC64f0147ff4eB44d18510477F86668B379C3010b); // 
    address payable public teamWalletAddress = payable(0xC64f0147ff4eB44d18510477F86668B379C3010b  ); // 
