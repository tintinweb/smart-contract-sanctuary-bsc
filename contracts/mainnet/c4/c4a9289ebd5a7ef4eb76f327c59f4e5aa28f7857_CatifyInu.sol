...
Catify Inu a Cryptocurrency Degen project with a small mcap, Our goal is to help the community thrive and
We want to take part in a venture that has the potential to make investors wealthy.
We are confident that we can do everything rapidly thanks to the power of our community.

Because for us, community power is everything. We will give birth on the current

Smart Chain Network by Binance. And perhaps in the future, we'll be in several networks.
...
contract CatifyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Catify Inu"; // 
    string private constant _symbol = "CATIFY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x12108ea239a3E75491d83AFBB9aDccd28E62C356;
