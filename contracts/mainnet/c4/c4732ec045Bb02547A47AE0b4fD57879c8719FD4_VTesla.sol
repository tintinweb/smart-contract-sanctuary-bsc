...
/**
 Valentine Tesla (VTesla)
 
 Valentine Tesla (VTesla) is a meme coin with a well-defined purpose.
 We have a strong vision of the future of what we want to achieve and with your help we know we can go to the moon!
 
 Website : https://www.valentinetesla.com
 Telegram : https://t.me/valentinetesla
...
contract VTesla is Context, IERC20, Ownable {
    ...
    string private constant _name = "Valentine Tesla"; // 
    string private constant _symbol = "VTesla"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x1529cb07B7d6E645472A0DE394d9Efe1F20e880d;
