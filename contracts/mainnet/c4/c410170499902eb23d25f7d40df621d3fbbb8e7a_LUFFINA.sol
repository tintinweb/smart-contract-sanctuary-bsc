...
// Telegram : https://t.me/Luffina_global
...
contract LUFFINA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUFFINA";
    string private _symbol = "$LFN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA164b97391cf38FD0a068cEd353a1EDfEede0e26); // Marketing Address
    address payable public teamWalletAddress = payable(0xBAAD8a59A5d8F8f3F7C3FBe097dAfd3F3bFCB73a); // Team Address
