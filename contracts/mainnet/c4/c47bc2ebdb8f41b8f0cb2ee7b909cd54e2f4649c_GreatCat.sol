...
/**
Total 8% Taxes:
3% $CAKE Reward to holders
1% Liquidity Fee
4% Marketing Fee

Join to moon with us:
Telegram: https://t.me/GreatCat
*/
...
contract GreatCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreatCat";
    string constant _symbol = "GREATCAT";
