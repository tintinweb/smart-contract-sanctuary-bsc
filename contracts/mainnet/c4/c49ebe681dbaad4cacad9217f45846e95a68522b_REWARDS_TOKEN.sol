...
contract REWARDS_TOKEN is Context, IERC20 { 
    ...
    */
    ...
    function Rewards__Distribution_Triggers(uint256 Minutes_Between_Payments, uint256 Required_Reward_Balance) external onlyOwner {
        ...
        // Max Wait is 2 Days
        require(Minutes_Between_Payments <= 2880,"E10");
...
---------------------
    ...
    E09 - Blacklisting of wallets only permitted during LaunchMode (Max 1 hour)
    E10 - Max time to wait between reward distribution is 2 days (2880 mins)
    ...
    E20 - Wallet was flagged as a sniper bot and can not purchase again during LaunchMode
