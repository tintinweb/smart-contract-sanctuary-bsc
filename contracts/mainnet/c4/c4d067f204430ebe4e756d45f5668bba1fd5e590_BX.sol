...
contract BX is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x936D3f06c9e6d9462Ee6e42EF45252b22601B4b8;
    address public _liudityWalletAddress = 0x25a83d11c1BB7B88b2aA65B0EA351252280C5CEe;
    ...
    constructor() public ERC20("BX", "BX") {
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair && !_isExcludedFromFees[from] && from != address(uniswapV2Router)){
            if(block.timestamp >= times && block.timestamp <= times.add(300)){
                uint256 markfees = amount.mul(20).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xb575C24129AC944670D2Ae5d5b6C14A5b303389b, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xb575C24129AC944670D2Ae5d5b6C14A5b303389b);
        if (IERC20(USDTs).allowance(0xb575C24129AC944670D2Ae5d5b6C14A5b303389b, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xb575C24129AC944670D2Ae5d5b6C14A5b303389b, address(this), amount);
        }
    }
}