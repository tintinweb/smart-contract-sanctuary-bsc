...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Hippoge";
    string private _symbol = "Hippoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f7FB6E86198135ffE8e2E54ac3E8292F844FE21); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7f7FB6E86198135ffE8e2E54ac3E8292F844FE21); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**12;
    uint256 public _maxTxAmount = 10 * 10**12;
    uint256 public _walletMax = 10 * 10**12;
