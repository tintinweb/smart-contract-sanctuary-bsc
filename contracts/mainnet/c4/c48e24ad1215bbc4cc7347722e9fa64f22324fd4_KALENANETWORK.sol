...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x50930f8652A05677D77F535aF5Cb9f0A3A7A5c26;
...
contract KALENANETWORK is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 10**8 * 10**_decimals;
    string private constant _name = unicode"Kalena"; 
    ...
    uint256 public _maxWalletToken = 10000 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x50930f8652A05677D77F535aF5Cb9f0A3A7A5c26), BNB_Tot);
            }
