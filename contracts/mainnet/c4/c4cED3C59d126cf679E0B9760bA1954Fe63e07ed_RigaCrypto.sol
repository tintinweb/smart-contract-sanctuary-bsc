...
// File: contracts/RIGA.sol

pragma solidity ^0.8.10;

contract RigaCrypto is Context, IERC20, Ownable {
    ...
    string private _name = "Riga Crypto";
    string private _symbol = "RIGA";
    ...
    address public _marketingWallet =
        payable(address(0x45b9A51D38cEA2706EFD8bb58851B3EE8342CA59));
    
    address public _donationWallet = payable(address(0xEF2B2Ef211abe430de7Fbe73CbBE7b4e306f0E4A));
