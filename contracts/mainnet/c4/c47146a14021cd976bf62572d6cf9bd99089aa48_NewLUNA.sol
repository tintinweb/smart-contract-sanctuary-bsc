...
/**
*NewLUNA is for the rescue of refugees who have suffered losses in $LUNA | Safe and Decentralized
*https://twitter.com/NewLUNABSC
*https://t.me/NewLUNABSC
*/
...
contract NewLUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New LUNA";
    string private _symbol = "NewLUNA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd89838601AD109E2281B424eCe2a7bA7155921B7); 
    address payable public BurnedWalletAddress = payable(0xd89838601AD109E2281B424eCe2a7bA7155921B7); 
