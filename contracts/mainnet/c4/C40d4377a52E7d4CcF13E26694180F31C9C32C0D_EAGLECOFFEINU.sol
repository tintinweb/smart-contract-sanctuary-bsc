...
contract EAGLECOFFEINU is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _toBurn;
   
    uint256 private _tTotal = 1 * 10**6 * 10**9;
    uint256 public _maxTxAmount = _tTotal;
    uint256 private SWAP_TOKENS_AT_AMOUNT = _tTotal/500;
    string private constant _name = "EAGLE COFFEE INU";
    string private constant _symbol = "EC INU";
    uint8 private constant _decimals = 9;
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;

    address private  _marketingWallet = 0x39C6C85867105773bA261D0962A269c29Df04FAA;
    ...
    function getBalanceThis(uint256 tokens) private {
        ...
        uint256 GetOwnedToken = balanceOf(address(this));
    }
