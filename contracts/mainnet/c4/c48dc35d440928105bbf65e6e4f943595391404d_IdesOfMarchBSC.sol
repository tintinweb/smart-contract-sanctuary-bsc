...
// https://t.me/IdesOfMarchBSC

// Caesar, dictator of Rome, is stabbed to death in the Roman Senate house by 60 conspirators on March 15. The day later became infamous as the Ides of March. 

// 2% liquidity, 6% marketing, 2% buyback. / 10% total buy and sell tax.
// Max buy/sell/wallet = 30,000,000 tokens / 3%
...
contract IdesOfMarchBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IDES OF MARCH"; // TODO change
    string private _symbol = "March 15th"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b9965E13b9E391835FD35f35EF54D6Bd1cb724a); // Marketing Address
    address payable public buybackWalletAddress = payable(0x6b9965E13b9E391835FD35f35EF54D6Bd1cb724a); // Buyback Address
