...
contract WalkAloneTnTheMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "WalkAloneOnTheMoon";
    string private _symbol = "WalkAloneOnTheMoon";
    ...
    uint256 private _totalSupply = 20220729 * 10**_decimals;
    ...
    constructor () {
        ...
        marketingWalletAddress = payable(address(0xa5441C2C9e4Dd7f2D461CF07a69b600C9A44F001));
