...
Welcome to Twitty Inu!

Twitty Inu is a project launched in the Binance Smart Chain (BSC) network.  The crux of its ecosystem is the world's first fully-functional tweet 2 earn system, an application that will rewards Twitter users each and every time they will post a tweet that contains our assigned hashtag.  The goal of the project is to become a major player in the Twitterverse as the social media platform transitions from Web 2.0 to Web 3.0 with its new owner, Elon Musk, at the helm.

The Twitty Inu app is not vaporware.  It is not a false promise.  We already have the technology and we are at the final stages of development.

Come invest on this, truly, once-in-a-generation opportunity today and be part of something that's bound to be big!

TOKENOMICS:
TOTAL SUPPLY: 1,000,000,000,000,000
BUY TAX: 9% (5% marketing, 2% LP, 2% utilities development fee)
SELL TAX: 10% (5% marketing, 2% LP, 3% utilities development fee)
MAX WALLET/TX: 2%

LINKS:
Website: https://twittyinu.com
Telegram: https://t.me/twittyinu
Twitter: https://twitter.com/twittyinu
-----------------------------------------------------------------------------------------------------------------
*/
...
contract twittyinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twitty Inu";
    string private constant _symbol = "TWITTY";
