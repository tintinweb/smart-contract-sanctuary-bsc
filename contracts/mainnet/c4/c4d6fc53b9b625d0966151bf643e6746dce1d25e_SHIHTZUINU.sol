...
//  SSS  H  H III H  H TTTTTT ZZZZZ U   U     III N   N U   U 
// S     H  H  I  H  H   TT      Z  U   U      I  NN  N U   U 
//  SSS  HHHH  I  HHHH   TT     Z   U   U      I  N N N U   U 
//     S H  H  I  H  H   TT    Z    U   U      I  N  NN U   U 
// SSSS  H  H III H  H   TT   ZZZZZ  UUU      III N   N  UUU  

/**
Portal : @Shihtzu_Inu_Portal
 */
...
contract SHIHTZUINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x3e98eeB4748bc4A496bf19276AAD79489276eA2d;
    address public ecosystemWallet = 0x77696969d16fF48add1054b8506263f0786c3292;



    string private constant _name = "SHIHTZU INU";
    string private constant _symbol = "SHIHTZUINU";
    ...
    Taxes public taxes = Taxes(0, 5, 4, 1);
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _ecosystem) public onlyOwner {
       sellTaxes = Taxes(_rfi,_marketing,_liquidity,_ecosystem);
        emit FeesChanged();
    }
