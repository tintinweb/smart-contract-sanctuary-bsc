...
contract KillDoKwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kill Do Kwon";
    string private _symbol = "Kill Do Kwon";
    ...
    uint256 public minimumTokensBeforeSwap = 100000000000000000000000000 * 10**_decimals; 
