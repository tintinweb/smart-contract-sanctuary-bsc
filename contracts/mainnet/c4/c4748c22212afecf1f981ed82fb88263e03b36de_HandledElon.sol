...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC55EF3D0dC13a6BFb2dBA43ab5Ad6A36188B9054; // owner address
...
contract HandledElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HandledElon";
    string private _symbol = "$HANDLED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC55EF3D0dC13a6BFb2dBA43ab5Ad6A36188B9054); // Marketing Address
    address payable public teamWalletAddress = payable(0xC55EF3D0dC13a6BFb2dBA43ab5Ad6A36188B9054); // Team Address
