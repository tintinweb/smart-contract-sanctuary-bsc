...
Telegram : https://t.me/DogeSpartan

join moonshot together with Doge Spartan, easy 100x GEMS 
*/
...
contract DogeSpartanBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7fB60410519288a781CC59F1eEdbaCF93940d0DB); 
    address payable public Wallet_Dev = payable(0x7fB60410519288a781CC59F1eEdbaCF93940d0DB);
    ...
    string private constant _name = "Doge Spartan"; 
    string private constant _symbol = unicode"DOGARTAN"; 
    ...
    constructor () {
        ...
        _owner = 0x7fB60410519288a781CC59F1eEdbaCF93940d0DB;
