...
contract AAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alliance Association Dao";
    string private _symbol = "AAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x394166a3e6C5e52f293424cAfDFf2E28a5a61A3E); 
