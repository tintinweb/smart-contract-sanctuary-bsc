...
/**
INDATIVE PROTOCOL SAFU IS MADE BECAUSE THE ORGINAL ONE SCAMMED INVESTOR
AND WE WANT INVESTOR TO RETURN THERE MONEY BACK  LETS DRIVE THIS TO MOOOOOON


https://t.me/INDATIVEPROTOCOLSAFU
**/
...
contract INDATIVEPROTOCOLSAFU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2087f874687EF3E82C768bacEEe4293D26f430bE;
    address public developmentWallet = 0x2087f874687EF3E82C768bacEEe4293D26f430bE;
    address public buybackWallet = 0x2087f874687EF3E82C768bacEEe4293D26f430bE;

    string private constant _name = "INDATIVE PROTOCOL SAFU";
    string private constant _symbol = "ISAFU";
    ...
    Taxes public buyTaxes = Taxes(3, 7, 2, 0, 0);
    Taxes public sellTaxes = Taxes(3, 7, 2, 0, 0);
