...
contract PidgeyCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x3Ed31507700E669d1A3f25AadB0ea83cC085af2e;
    string constant _name = "PidgeyCoin";
    string constant _symbol = "PIDGEY";
