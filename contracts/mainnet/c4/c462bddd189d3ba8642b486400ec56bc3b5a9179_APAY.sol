...
What exactly is AirBNB / $APAY?
APAY is a cryptocurrency token that is currently under research & development phase with plans to stealth launch on the binance smart chain network & later bridge over to other cryptocurrency networks. 
The application that this team is building will allow users to purchase Airbnb's, Hotel’s, Rental’s, Real-Estate etc. using $BNB & many other well known cryptocurrencies.
...
Telegram: https://t.me/APAYChannel
Twitter:  https://twitter.com/APAYToken
*/
...
contract APAY is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "APAY";
