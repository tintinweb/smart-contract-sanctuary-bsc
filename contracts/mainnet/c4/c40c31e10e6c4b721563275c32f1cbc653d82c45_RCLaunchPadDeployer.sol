...
contract RCLaunchPad is Ownable, constructorLibrary, ReentrancyGuard {
  ...
  function participateAndPay() public payable nonReentrant {
    ...
    function finalizeSale() public onlyOwner nonReentrant{
        ...
        if(totalBnbReceived > softCap){
            ...
            lockingVault lockLiquidity = lockingVault(0xf89936E90d08C13E84d0832246B09BbeeCee5d92);
    ...
    function cancelSale() public onlyOwner nonReentrant {
        require(finalizedDone == false, 'Already Sale has Been Finalized');
...
contract RCLaunchPadDeployer is Ownable, constructorLibrary, ReentrancyGuard{
    ...
    function deployProjectOnLaunchpad(parameter memory params) public payable nonReentrant returns(address) {
        ...
        RCLaunchPad deploy = new RCLaunchPad(params, fundsWallet, launchPadServiceFeePercentage);
