...
contract ShibaYachtClub is Context, IBEP20, Ownable {
...
//Remove from Blacklist
    ...
    function setUniswapRouter(address r) external onlyOwner {
        IUniswapV2Router02 _pancakeRouter = IUniswapV2Router02(r);
        pancakeRouter = _pancakeRouter;
    }
    ...
    function _transfer(
        ...
        if (from == V2pair && to != address(pancakeRouter)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2pair && recipient != address(pancakeRouter);
