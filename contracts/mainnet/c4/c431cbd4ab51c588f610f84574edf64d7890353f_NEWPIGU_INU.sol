...
contract NEWPIGU_INU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**9 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x9d0120Ab21031cA7dEcc04C3014F3b0A8898e0aD));


    string private _name = "NEWPIGINU";
    string private _symbol = "$NEWPIGINU";
