...
/*CRYPTO HEIST is an organized community of skilled individuals in degen world trading activities 
where they sychronized by positioning early in other projects and take profit to swap back to build asset in 
CRYPTO HEIST. It is a simple Robinhood spirit or Pirate type of ways yet allowed in crypto world 
to grow together. We are the CRYPTO HEIST COMMUNITY.
...
contract CRYPTOHEIST is IERC20, Ownable {
    ...
    string _name = "CRYPTO HEIST";
    string _symbol = "Heist";
