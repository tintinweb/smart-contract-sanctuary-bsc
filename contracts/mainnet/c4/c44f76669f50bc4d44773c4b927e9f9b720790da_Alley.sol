...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x403ea3fdB2890AF0Da0F2366CE730b9C0E61845a; // owner address
...
contract Alley is Context, IERC20, Ownable {
    ...
    string private _name = "ALLEY CATS";
    string private _symbol = "ALLEYCATS"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24424fdb0C9909972e0504754E310ff5fb0B2d94); // Marketing Address
    address payable public teamWalletAddress = payable(0xc35e5cB3611183253CcAcdE1B5ee852d25d8b273); // Team Address
