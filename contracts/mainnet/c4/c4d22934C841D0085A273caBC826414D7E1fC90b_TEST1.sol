                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _sellFundFee + 

_sellLPDividendFee + _sellLPFee;
...
contract TEST1 is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        1888,//Supply
        address(0xe8E9CFCcf1BAfE2Bf84D21e664e9104C3aC447eF),//FundAddress
        address(0xF3d9954E1Cf78dC28eaa07c6C491389088b2cdf0)//ReceiveAddress
    ){
