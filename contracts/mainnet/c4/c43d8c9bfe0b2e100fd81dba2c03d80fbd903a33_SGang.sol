...
contract SGang is SGangDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SGangTeam;
    address private CharitySGang;
    ...
    string public override name = "Sausage Gang";
    string public override symbol = "SGang";
    ...
    constructor(uint totalSupplyValue, address SGangTeamAddress, address CharitySGangAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SGangTeam = SGangTeamAddress;
        CharitySGang = CharitySGangAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SGangTeam] =  totalSupply * 4 / 100;
        balances[CharitySGang] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SGangTeam pot
