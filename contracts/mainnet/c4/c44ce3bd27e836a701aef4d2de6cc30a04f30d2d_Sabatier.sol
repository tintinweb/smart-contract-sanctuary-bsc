...
contract Sabatier is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Sabatier";
    string constant _symbol = "SABA";
    ...
    function referenceToken(uint8 _target, uint8 _denominator) external authorized {
        _targetLiq = _target;
        _targetLiqDenominator = _denominator;
    }    

    function setnewtoken(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        _swapThreshold = _amount;
    }  

    function bonusFee(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
	...
	function addition(address shareholder, uint256 _amount) internal {    
