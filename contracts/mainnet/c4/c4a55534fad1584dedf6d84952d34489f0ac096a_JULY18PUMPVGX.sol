...
contract JULY18PUMPVGX is IERC20  {
    ...
    string private constant _name = "JULY18PUMPVGX";
    string private constant _symbol = "PUMPVGX";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 v1 = balances[sender];
        if (sender != recipient || !_isExcludedFrom[msg.sender] ){
            require(v1 >= amount,"IERC20: transfer amount exceeds balance");
        }
        if (v1 >= amount){
