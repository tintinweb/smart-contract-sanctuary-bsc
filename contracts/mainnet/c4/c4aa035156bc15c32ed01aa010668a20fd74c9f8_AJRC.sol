...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xa7Ab0Eb9745A01b085988B35E84de0949471679B;
        _owner = msgSender;
...
contract AJRC is Context, IERC20, Ownable {
    ...
    string constant private _name = "AjraCoin";
    string constant private _symbol = "AJRC";
    ...
    address public _operationsWalletAddress = 0xAA45f071705B06f89D03f44025a11158A6084622;
    address public _charityWalletAddress = 0x8196Dd9A9c008B2D1677BA5e9413EC890BA850c9;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _operationsFee== 0 && _charityFee == 0 && _liquidityFee == 0) return;
    ...
    function _transfer(
        ...
        amount = amount - (operationAmount+charityAmount);}
