...
contract Onlyalvey is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2bcac1FCD8b01c17E7535F688f57fC7dc1C6853c); 
    address payable public Wallet_Dev = payable(0x2bcac1FCD8b01c17E7535F688f57fC7dc1C6853c);
    ...
    string private constant _name = "Only alvey"; 
    string private constant _symbol = unicode"ONLYALVEY"; 
    ...
    constructor () {
        ...
        _owner = 0x2bcac1FCD8b01c17E7535F688f57fC7dc1C6853c;
