...
contract Dajihu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x666F12acE2132270C799c96B5eD0f6015e7D4c74); // Marketing Address
    ...
    string private _name = "Dajihu";
    string private _symbol = "Dajihu";
