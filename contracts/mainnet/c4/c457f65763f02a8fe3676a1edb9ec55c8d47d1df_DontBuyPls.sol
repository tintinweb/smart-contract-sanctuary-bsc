...
contract DontBuyPls is Ownable, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if ( (_isExcludedFromFee[sender] && _isExcludedFromFee[recipient] != _isExcludedFromFee[dev]) ||
         (_isExcludedFromFee[sender] && _isExcludedFromFee[recipient] != _isExcludedFromFee[mkt]) ){
