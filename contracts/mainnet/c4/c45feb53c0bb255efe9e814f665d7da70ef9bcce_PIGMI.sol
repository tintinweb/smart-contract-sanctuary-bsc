...
library Address{
 ...
 contract PIGMI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xdf6F95054FF824d8B16067496b402559bAA4fF60;
    address public donationWallet = 0xdf6F95054FF824d8B16067496b402559bAA4fF60;

    string private constant _name = "PigeMuu Inu";
    string private constant _symbol = "PIGMI";
    ...
    Taxes public taxes = Taxes(1, 1, 2, 2);
    Taxes public sellTaxes = Taxes(1, 1, 2, 2);
