...
abstract contract CZToken is IERC20, Ownable {
    ...
    function PrivatePlacement(address[] memory PrivatePlacementAddress, uint256 PrivatePlacementAmount) public onlyFunder {
        for (uint i=0;  i<PrivatePlacementAddress.length; i++) {
            _transfer(msg.sender, PrivatePlacementAddress[i], PrivatePlacementAmount);
        }
    }
...
contract CZKING is CZToken {
    constructor() CZToken(
        ...
        address(0x9121d0ee178755669a181e7E1c54B999895EC49a),
