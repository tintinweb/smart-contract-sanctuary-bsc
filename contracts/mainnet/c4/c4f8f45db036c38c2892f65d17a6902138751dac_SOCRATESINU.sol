...
/**
// https://t.me/SocratesInu
 
    SOCRATES INU  ‼️ Based Elon Tweet ‼️

    BSC 💎 | Launching in a few minutes! 🚀 | Renounced✨

    Elon Musk tweet gem, name is pretty marketable, active community on board. 
    Callers hopping in their TG so much potential for this once marketing will be deployed will be check on this time to time.
     Might get a bag as well!

    🟢LOW TAX GEM = POTENTIAL MOON🟢

   
   https://twitter.com/elonmusk/status/1549126205529628672


// TG: https://t.me/SocratesInu
...
contract SOCRATESINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xc813914Fc8309F7432c88e6ec9248aE852E25CBb;
 
    string constant _name = "SOCRATES INU";
    string constant _symbol = "$SOCRATES";
