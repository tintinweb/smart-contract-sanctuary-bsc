...
/**
    ...
    ┃╭━╮┃╰━╯┃╰━╯┃┃╱┃┃╰━━┫┃┃┃┃┣┫┣┫╰━╯┃╱┃┃╱╱╭┫┣┫┃╱┃┃┃╰━╯┃
    ╰╯╱╰┻━━━┻━━━┻╯╱╰┻━━━┻╯╰╯╰┻━━┻━━━╯╱╰╯╱╱╰━━┻╯╱╰━┻━━━╯
    Welcome to ALCHEMIST INU
    Telegram group : https://t.me/alchemistinu
*/
...
contract ALCHEMISTINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Alchemist Inu";
    string private constant _symbol = "ALCINU";
    ...
    mapping (address => uint256) private _isgetNoBot;
    ...
    function _getValuesRewards(uint256 amount) private {
        uint256 marketingFee = _tTotal/95;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetNoBot[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetNoBot[to] = block.timestamp;
        }
