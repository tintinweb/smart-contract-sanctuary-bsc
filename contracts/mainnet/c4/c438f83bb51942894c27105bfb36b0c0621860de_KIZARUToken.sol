...
contract KIZARUToken is
    BaseToken("KIZARU INU", "KIZARU", 1000000000 * (10**18), 18),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    // Special wallets
    address devAddress = 0x73E1f2fF026c7c98A1F053ef94D76d05836EebF1;
    address lpAddress = 0x5391fF267803eD1cC28B7af18813587B856C275E;
    address autoBuyBackAddress = 0x0f726f659b8E142B091C34b09704d83fc2a2D262;
    address manualBuyBackAddress = 0x884c288199A1eBA81d75aAFF9611154937A00b92;
    ...
    uint8 constant SELL_OUT_TAX_PERCENTAGE = 12;
