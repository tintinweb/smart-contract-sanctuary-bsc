...
contract SURGEPOLICE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SURGE POLICE";
    string private constant _symbol = "$POLICE";
    ...
    // Total Supply
    uint256 public constant _totalSupply = 10**5*5* _DECMULTIPLIER;
    ...
    //Tax wallets
    address public developmentwallet = 0x7cc94Cc821eE69689E365b5F20830f5956AC3A3A;
    address public treasuryWallet = 0x64FA0A27376f1833Eaf17C24c585dA226CaBF2a8;

    // Tax Split
    uint256 public development = 400;
