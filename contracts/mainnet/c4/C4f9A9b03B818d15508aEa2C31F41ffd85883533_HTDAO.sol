...
contract HTDAO is Context, IERC20, Ownable {
    ...
    string private _name = "HTDAO Token";
    ...
    address public ownerAddres = address(0xA23F778Fd0CFBCb0e38Cac3c99E22624C42fB5Ce);
    address public devAddress = address(0xdbF87e0e53A5e2a1bC58Fc6eD50dc4DdB53eaA73);
