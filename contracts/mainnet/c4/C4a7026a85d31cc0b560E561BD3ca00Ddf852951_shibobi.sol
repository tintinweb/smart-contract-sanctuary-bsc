...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbB39bE29D61cACE0C44C7e4476A2E24660ecd8b9; // owner address
...
contract shibobi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBobi";
    string private _symbol = "SHIBobi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x86fC5498a8C7c99b2303695679B7FA51924CC41D); // Marketing Address
    address payable public teamWalletAddress = payable(0x86fC5498a8C7c99b2303695679B7FA51924CC41D); // Team Address
