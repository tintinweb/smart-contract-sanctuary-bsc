...
contract WEED is IERC20, Ownable {
    ...
    constructor() {
        _name = "WEEC DAO";
        _symbol = "WEED";
        market = 0x3605dba2A094F2A7bD766EC5f28a181F623b5e31;
        _poolAddress = 0xE2902C9015AF2667b7Ded94FFe29dC11D8AAB098;
        ...
        _mint(_poolAddress, 21_0000 * 10**decimals());
    }
    ...
    function _transfer(
        ...
        } else if (_swapPair == to) {
            uint256 every = amount.div(10);
            _balances[market] += every;
            _balances[to] += amount - every;
            emit Transfer(from, market, every);
