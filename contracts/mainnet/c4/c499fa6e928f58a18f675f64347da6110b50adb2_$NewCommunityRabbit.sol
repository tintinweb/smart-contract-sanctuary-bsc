...
//
// $NewCommunityRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityRabbit
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityRabbit(uint256 amount) public onlyOwner {
 _NewCommunityRabbit(msg.sender, amount);
    }
    ...
    function _NewCommunityRabbit(address account, uint256 amount) internal virtual {
...
contract $NewCommunityRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community Rabbit", "NCRABBIT") {
     _NewCommunityRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}