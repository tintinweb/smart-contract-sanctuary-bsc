...
contract Pangea is IBEP20 {
    string constant _name = "Pangea";
    string constant _symbol = "$Pangea";
    ...
    uint256 public totalPaidFromJackpot;
    ...
    mapping(address => uint256) public permitedTokensTotalClaims;
    mapping(address => mapping(address => uint256)) public permitedTokensUserClaims;    
    ...
    constructor() {
        ...
        tokens.push(Token({contractAddress: IBEP20(0xdD8B490001D081eD065239644dae8D1a77b8A91F), percentage: 50, active: true}));
        tokens.push(Token({contractAddress: IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c), percentage: 50, active: true}));
        permitedTokens[0xdD8B490001D081eD065239644dae8D1a77b8A91F] = true;
