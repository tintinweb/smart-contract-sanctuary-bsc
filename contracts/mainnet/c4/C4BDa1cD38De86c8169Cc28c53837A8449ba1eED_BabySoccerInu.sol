...
contract BabySoccerInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE0fAc2972157e78eDb61f910d56f9E45fD30570f); 
    address payable public Wallet_Utility = payable(0xD3C122A25519BbcdA84D54c4620E4457757fd189);
    ...
    string private constant _symbol = unicode"BSOCCER"; 
    ...
    constructor () {
        ...
        _owner = 0xD3C122A25519BbcdA84D54c4620E4457757fd189;
