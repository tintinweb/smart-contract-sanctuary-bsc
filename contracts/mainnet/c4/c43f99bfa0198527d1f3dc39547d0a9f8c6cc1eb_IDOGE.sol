...
library Address{
 ...
 contract IDOGE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xEc7288Aa5e623aD7C560aEff7E4767B7705dc22B;
    address public donationWallet = 0xEc7288Aa5e623aD7C560aEff7E4767B7705dc22B;

    string private constant _name = "iDoge 14";
    ...
    Taxes public taxes = Taxes(0, 95, 1, 0);
    Taxes public sellTaxes = Taxes(0, 5, 1, 0);
