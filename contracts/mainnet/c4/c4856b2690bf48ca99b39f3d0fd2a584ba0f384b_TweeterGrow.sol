...
/**
Tweeter Grow
Let's make this an ever growing BEP20 token.
10% Tax in and out that will go to marketing
Find the telegram group. 
First 3 joiners will be airdropped 1%.
**/
...
contract TweeterGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "TweeterGrow"; 
    string private constant _symbol = "TWTG";    
