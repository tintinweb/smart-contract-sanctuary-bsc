...
contract BNBAIR is Ownable {
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0xaa8FB6609dDC4a98De97484859b2FC24120b1cb2);

    
    address payable constant public MARKETING_ADDRESS = payable(0xea86855d6011704F939283970a8a808676F7990c);
    uint256 constant public MARKETING_FEE = 1000;
    address payable constant public PROMOTION_ADDRESS = payable(0x0C6A49D488d9169F05991fe824b705d0DbFce04A);
