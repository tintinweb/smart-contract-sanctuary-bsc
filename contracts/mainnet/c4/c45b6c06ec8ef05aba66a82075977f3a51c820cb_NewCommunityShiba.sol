...
/**
   #NCSHIBA The New Community Shiba
    
   I make this #NCSHIBA to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityshiba

   Great features: 0 Tax

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #NCSHIBA to the community and ensure it's 100% safe.

   I will add .1 BNB and 40% of the total supply to the pool
   Can you make #NCSHIBA 10000000X? 
...
contract NewCommunityShiba is Ownable {
    constructor(
        string memory _NAME,
