...
/*
Assassin Token | The Following Token Project Utility On Binance Smart Chain Network.

We name it Assassin Token 

⚔️ Contract Verified
⚔️ Renounced Owner
⚔️ Locked LP For Long Time
⚔️ Low Tax
⚔️ Safe Contract Address

🌐 Website : Soon
🌐 Telegram : https://t.me/assassin_bsc
*/
...
contract AssasinToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Assasin Token";
    string constant _symbol = "Assasin";
    ...
    uint256 private swapThreshold = _totalSupply * 100 / 8000; // 1% of supply
    bool inSwap;
