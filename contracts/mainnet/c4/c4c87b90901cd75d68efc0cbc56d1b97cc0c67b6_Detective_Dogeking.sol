...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GASC = IBEP20(0x62bC448A508499fb54479CC7a6fA79C2D8f16cDe);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GASC.balanceOf(address(this));
        ...
        uint256 amount = GASC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GASC.transfer(shareholder, amount);
...
contract Detective_Dogeking is IBEP20, Auth {
    using SafeMath for uint256;

    address GASC = 0x62bC448A508499fb54479CC7a6fA79C2D8f16cDe;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Detective Dogeking";
    string constant _symbol = "Dking";
