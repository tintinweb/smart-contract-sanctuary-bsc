...
contract $8Token is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "$8";
    string constant _symbol = "$8";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
	address marketingAddress = 0xbbEC40440C08b4cD552fb48aD5F263E5CD539445; //market wallet

    uint256 _totalSupply = 1 * 100000000000000 * (10 ** _decimals);
    uint256 private _maxTxAmount = _totalSupply / 100;
    uint256 private _walletMax = _totalSupply ;
	...
	mapping (address => bool) private exchangePairs;
    ...
    uint256 private burnPercentage = 0;

    uint256 public totalFee = 0;
    uint256 public totalFeeIfSelling = 0;

    address private autoLiquidityReceiver = marketingAddress;
