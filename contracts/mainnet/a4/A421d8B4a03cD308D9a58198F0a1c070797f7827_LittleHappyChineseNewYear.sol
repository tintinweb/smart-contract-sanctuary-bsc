...
/**
 Little Happy Chinese New Year - This token will make an unforgettable moonshot that tweet by "Elon Musk" So come and join us and be part of LHCPNY Community.

Little Happy Chinese New Year - is a decentralized finance (Defi) meme token. Auto-liquidity generating protocol. 
On each transaction 7% is locked into the liquidity pool and 7% is going to marketing wallet.

T O K E N O M I C S :

Total Supply: 5,000,000,000,000,000  
Burn Supply: 2,500,000,000,000,000 
Tax Per Transactions: 14%
-7% going to marketing wallet
-7% Automatic add liquidity


🌎Website: https://www.littlehappychinesenewyear.com
📞TG:https://t.me/Littlehappychinesenewyear
...
contract LittleHappyChineseNewYear is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5_000_000_000_000_000 * 10**9;
    uint256 public _maxTxAmount = 5_000_000_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 500_000_000_000 * 10**9; 

    string private constant _name = "Little Happy Chinese New Year"; 
    string private constant _symbol = "LHCNY"; 
