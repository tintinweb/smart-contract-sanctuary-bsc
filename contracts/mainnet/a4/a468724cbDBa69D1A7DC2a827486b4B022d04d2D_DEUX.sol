...
//
//
// Welcome to decentralized IDO IGO platform that integrates the developer and the investor,
// aims to increase the profits of the parties on the Binance Smart Chain.
...
contract DEUX is IERC20, Context, Ownable {
    ...
    function burnFrom(address account, uint256 amount) public virtual {
        ...
        require(
            currentAllowance >= amount,
            "DEUX: burn amount exceeds allowance"
        );
        unchecked {
