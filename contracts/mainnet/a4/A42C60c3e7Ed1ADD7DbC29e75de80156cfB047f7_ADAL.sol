...
contract ADAL is ADALDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ADALTeam;
    address private CharityADAL;
    ...
    string public override name = "Adalend";
    string public override symbol = "ADAL";
    ...
    constructor(uint totalSupplyValue, address ADALTeamAddress, address CharityADALAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ADALTeam = ADALTeamAddress;
        CharityADAL = CharityADALAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ADALTeam] =  totalSupply * 4 / 100;
        balances[CharityADAL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ADALTeam pot
