...
contract ArabianGold is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 500 * 10**_decimals;
    uint256 public maxSellLimit = 500 * 10**_decimals;
    uint256 public maxWalletLimit = 500 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet =0x4EC1A34F90B316bcCB2FBd5026F174e633FE0f09;
    address public devWallet =0x4EC1A34F90B316bcCB2FBd5026F174e633FE0f09; 
    address public operationWallet = 0x4EC1A34F90B316bcCB2FBd5026F174e633FE0f09;
    address public charityWallet = 0x4EC1A34F90B316bcCB2FBd5026F174e633FE0f09; 

    string private constant _name = "Arabian Gold";
    ...
    Taxes public taxes = Taxes(0, 1, 1, 1, 0, 0);
    Taxes public sellTaxes = Taxes(2, 2, 2, 0, 0, 0);
