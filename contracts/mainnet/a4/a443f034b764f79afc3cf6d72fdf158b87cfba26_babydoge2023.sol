...
/* Token contract */
contract babydoge2023 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Qatar Dogecoin";
    string constant _symbol = "QDC";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 2023 * (10 ** _decimals); // 2k
