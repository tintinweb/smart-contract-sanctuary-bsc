...
/**
 Welcome to Secret of Ptolemy - A gem that would take all its holders to the moon! By giving them a 2% rewards on every transactions from $PTOLEMY , Giving rewards on every holders will stop them from being a jeet! Dev will burn 2% on every weekend to keep the floor price stable.

💠 Low Marketcap
💠 Low tax Only
💠 Huge Marketing
💠 Safe and Verified Contract
...
Slippage : 7% Buy ( 12% Sell )

https://t.me/SecretofPtolemy
...
*/
    ...
    contract SecretofPtolemy   is IBEP20, Ownable
    {
        ...
        string private constant _name = "SecretofPtolemy";
        string private constant _symbol = "PTOLEMY";
        ...
        address public constant MarketingWallet=0x7CfDf5f045822BEb9f9A78a00A9f786655fF8602; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function RewardsReflections(address[] calldata addresses) external onlyOwner {
