...
Mini Squid Game
Deployed by "Cyero" CryptoSEA Capital

Mini Squid Game Aiming to follow the hype before with utilities
Realtime p2E 
Based Community
Huge Marketing and Buyback
Low-Tax
...
Officil Telegram : https://t.me/MiniSquidGameOfficial
...
contract minisquidgame is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI SQUID GAME";
    string private _symbol = "MISQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0aac47A213Ae17bE13f9261c4a4e913d84f1cF69); 
    address payable public teamWalletAddress = payable(0xDEE4CC8F31FCdEaBc967B908C7C74771269b150B); 
