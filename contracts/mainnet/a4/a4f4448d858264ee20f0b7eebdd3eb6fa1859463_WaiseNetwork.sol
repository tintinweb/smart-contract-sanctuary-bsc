...
/**
  ...
  Waise Network - (WAISE)
  WAISE got its name from the combination of the words Web 3.0 AI Semantic Network.
  The main purpose of WAISE Network is; By using the WAISE Community and GitHub developer community,
  by establishing science algorithms to understand artificial intelligence programming released by other
  developers, Web 3.0 software compatible with Blockchain and crypto money technology, and artificial
  intelligence supported module infrastructures.
  www.waise.network
...
contract WaiseNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Waise Network";
    string private _symbol = "WAISE";
    ...
    address public charityWallet = 0x824176BcFA9c3F3A3fCc1e33559E5803A75568D8;
