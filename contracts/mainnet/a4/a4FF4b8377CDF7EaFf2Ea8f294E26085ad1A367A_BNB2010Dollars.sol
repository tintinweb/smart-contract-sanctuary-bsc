...
/*
💵 $10 Dollars to Million #Dollard #Million

📈Safu Stealth Launch by Team Caller @tthundercalls 

🏦Initial liquidity 10$, The project is simple Go to Million Building working and Fcking Mooning, No false Hope 
Easy and big X's Incoming 
Future Utility 
...
Portal : https://t.me/tthundercalls

Website : https://www.10dollars.tech/
*/
...
contract BNB2010Dollars is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe64bF084D906347760bDEBfb55C53CCf518b826B;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "10 DOLLARS";
    string constant _symbol = "$10DOLLARS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0255Ce77fFDAD1A1D2C1e410be935CF0a01C5BA7;
