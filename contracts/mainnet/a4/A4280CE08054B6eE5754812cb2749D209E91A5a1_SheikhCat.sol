...
DONT BUY UNLESS WE GIVE SIGNAL ON TG 
JOIN US
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9578d4E06565Af9Bf548B6514915da2a90857A41; // owner address
...
contract SheikhCat is Context, IERC20, Ownable {
    ...
    string private _name = "SheikhCat";
    string private _symbol = "Sc";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9578d4E06565Af9Bf548B6514915da2a90857A41); // Marketing Address
    address payable public teamWalletAddress = payable(0x9578d4E06565Af9Bf548B6514915da2a90857A41); // Team Address
