...
contract BabyDogeBurn is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**15 * (10**15);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x90fad3a279d96135a82d168A10668a2B0cc5568E); // Team Wallet
    address public _projectWalletAddress = address(0xb5b167D93f86f89f1747886b2840Dc81B1bD0f94); //Burn Wallet
    ...
    constructor() ERC20("BabyDogeBurn", "BDB") {
        ...
        buyFee.projectFee = 80; // 8% Burn
        buyFee.teamFee = 70;  // 7% team fee
        totalBuyFee = buyFee.projectFee + buyFee.teamFee;

        sellFee.projectFee = 80; // 8% Burn
