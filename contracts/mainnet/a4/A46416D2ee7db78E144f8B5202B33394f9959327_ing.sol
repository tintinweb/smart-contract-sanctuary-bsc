...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  1800000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0B5FCa8de0F2914Ac02A9b8b2181b00BB6Ed0971), block.timestamp
                );
            }
        }
    }
...
contract ing is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000,//Supply10000
        address(0x0B5FCa8de0F2914Ac02A9b8b2181b00BB6Ed0971),//FundAddress
        address(0x0B5FCa8de0F2914Ac02A9b8b2181b00BB6Ed0971)//ReceiveAddress
    ){
    }
}