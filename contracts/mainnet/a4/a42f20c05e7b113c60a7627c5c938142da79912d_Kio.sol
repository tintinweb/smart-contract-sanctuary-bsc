...
contract Kio is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "009";
    string private _symbol = "Kio";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xFAbaAA0aa02DDaEC0CC74eb703BC9e8626538af6); 
    address payable public BurnedWalletAddress = payable(0xFAbaAA0aa02DDaEC0CC74eb703BC9e8626538af6); 
