...
/**
 ...
 Welcome CZ x CR7
   ...
   https://twitter.com/Cristiano/status/1539972040291061765
 
   Degen play CR7 Tweet. If you want to create a telegram I suggest to name it to @CZxCR7
...
contract CZxCR is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZ x CR";
    string private constant _symbol = "CC7";
