...
// a token meme that is hype in 2022 with a combination of sex and crypto

// https://t.me/BlowjobDust
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4AC0108D6eF1DE5033cCe9A236c13ea76422552f; // owner address
...
contract BlowjobDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blowjob Dust";
    string private _symbol = "$BJD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4AC0108D6eF1DE5033cCe9A236c13ea76422552f); // Marketing Address
    address payable public teamWalletAddress = payable(0x4AC0108D6eF1DE5033cCe9A236c13ea76422552f); // Team Address
