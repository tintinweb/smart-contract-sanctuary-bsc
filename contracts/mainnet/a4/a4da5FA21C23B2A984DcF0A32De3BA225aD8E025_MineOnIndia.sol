...
import "./Mineon-import.sol";

abstract contract Tokenomics {
    
    using SafeMine for uint256;
    
    // --------------------- Token Settings ------------------- //

    string internal constant NAME = "MineOnIndia";
    string internal constant SYMBOL = "MOI";
    ...
    uint256 internal constant TOTAL_SUPPLY = 299792458999 * ZEROES;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));

    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 1; // 100% of the total supply
    
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 3; // 33.33% of the total supply
    
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 2; // 50% of the total supply
    ...
    address internal charityAddress = 0x414581b18d2cc73FbFFCD19c0899C137626bf651;
    address internal marketingAddress = 0x86A5673FF1941a203802B846377f1E9cBaf6882B;
...
abstract contract MineOn is BaseRfiToken, Liquifier, Antiwhale {
...
contract MineOnIndia is MineOn{

    constructor() MineOn(Env.MainnetV2){
