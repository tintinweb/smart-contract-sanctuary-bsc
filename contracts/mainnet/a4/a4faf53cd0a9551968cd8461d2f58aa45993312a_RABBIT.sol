...
contract RABBIT is Context, IERC20, Ownable {
    ...
    address payable private MarketingWallet = payable(0xf7aD613978008925c287cFadE53a7471a0bc2DFe); // Marketing Address
    address payable private TeamWallet = payable(0xf7aD613978008925c287cFadE53a7471a0bc2DFe); // Buy Back Address
    ...
    uint256 public _maxTxAmount = _totalSupply.div(32); 
    uint256 public _walletMax = _totalSupply.div(32);
