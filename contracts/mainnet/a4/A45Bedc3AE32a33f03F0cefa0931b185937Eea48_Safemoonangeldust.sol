...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Safemoonangeldust is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SafemoonAngelDust";
    string private _symbol = "SFMAD";
    uint8 private _decimals =  18;

    address payable public marketingWalletAddress = payable(0x4bF02B166a43FCF5CB198Bd547f2c9966b74Eba1);
    address payable public devWalletAddress = payable(0x0280b0D5920D086BD4c2bEce15dd7136B7708A4A);
