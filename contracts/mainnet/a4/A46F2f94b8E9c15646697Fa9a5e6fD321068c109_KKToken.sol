            ...
            if (isRemoveLP) {
                ...
                if (!inSwap) {
                    ...
                    if (contractTokenBalance > 0) {
                        uint256 numTokensSellToFund = fundAmount * 210 / 100 + extFeeAmount;
...
contract KKToken is AbsToken {
    constructor() AbsToken(
        ...
        6,
        10000,
        address(0xD7D013EB4C17A87E76DB15c446100326fCF69eAF),
        address(0xD7D013EB4C17A87E76DB15c446100326fCF69eAF),
        address(0xD7D013EB4C17A87E76DB15c446100326fCF69eAF),
        0,
        0
