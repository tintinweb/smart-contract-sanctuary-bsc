...
contract GoldieLocksStacking is Ownable, Pausable, ReentrancyGuard {
    ...
    function deposit(uint256 amount) external nonReentrant whenNotPaused updateReward updateUserList {
        require (block.timestamp < endTime, "expired");
        require(IERC721(0xFD07E65F567DD846F655d5F175b6ED6402C70697).balanceOf(msg.sender) > 0, "You need to own NFT to stake!");
