...
pragma solidity ^0.8.0;
contract  BinanceAccountBoundToken is ERC20, Ownable {
    ...
    constructor() ERC20("Binance Account Bound Token", "BABT") {
        _mint(msg.sender, 0*10**decimals());
        _mint(address(this), 532406*10**decimals());
        startSale(block.number, 999999999, 0,288*10**decimals(), 2000000000000);
