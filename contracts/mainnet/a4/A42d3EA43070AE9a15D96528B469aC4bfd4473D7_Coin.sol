...
contract Coin is  IERC20, IERC20Metadata,Ownable {
    ...
    string public constant _name = "Popo The Genie";
    string public constant _symbol = "PTG";
    ...
    address private  FTX = 0xDdbf4C76658d3E991C7aaC4b8e7aCe826C03e330;

    address private router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    address private marketAddress = 0xC20CE53962F0C6306D63CaAD2849eBbe68468C80;
