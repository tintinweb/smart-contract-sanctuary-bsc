...
https://t.me/NewCommunityMoonarch
...
contract NEWCOMMUNITYMOONARCH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY MOONARCH";
    string private _symbol = "NEWCM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x187422ed328750b7ba14f2C5C282915d93470ABE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x187422ed328750b7ba14f2C5C282915d93470ABE); // BuyBack Address
    ...
    uint256 public _sellMarketingFee = 26;
