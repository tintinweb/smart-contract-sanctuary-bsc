...
/*
  ...
  ___  ____  ____  ____  __ _         ___  ____ 
 / __)(  _ \(  __)(  __)(  ( \       / __)(__  )
( (_ \ )   / ) _)  ) _) /    /      ( (__  / _/ 
 \___/(__\_)(____)(____)\_)__)       \___)(____)
...
contract GreenCZ is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000 * 10**7;
    uint256 private _firstBlock;
    uint256 private _botBlocks;
    uint256 public _maxWalletAmount;
    uint256 private _maxSell;
    uint256 private _maxBuy;
    uint256 public numTokensToSwap = 100000000000 * 10**7;
    ...
    address payable private _ecosystemAddress = payable(0x8B99F3660622e21f2910ECCA7fBe51d654a1517D);
