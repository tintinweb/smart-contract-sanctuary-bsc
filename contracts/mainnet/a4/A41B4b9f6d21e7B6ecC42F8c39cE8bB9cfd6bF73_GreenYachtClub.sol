 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/GreenYachtClub
 * 
 * 
 * Green Yacht Club token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract GreenYachtClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Green Yacht Club";
    string constant _symbol = "GYC";
