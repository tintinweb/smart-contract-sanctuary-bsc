...
contract Truetest1 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TrueTest1";
    string private _symbol = "TT1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57387a860043CDF02e3E53a39F53093BE90d6AE1); // Marketing Address
    address payable public DevWalletAddress = payable(0x57387a860043CDF02e3E53a39F53093BE90d6AE1); // Dev Address
    ...
    uint256 public _maxTxAmount = 30 * 10**6 * 10**9; //5 * 10**6 * 10**9;
