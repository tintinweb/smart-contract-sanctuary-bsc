...
contract DefiKing is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
  
    uint256 public _swapamount = 500000000000 * 10**2;
    ...
    address public ownerAddres = address(0xCd9d142398EBCD696687D404eE56e08D836EFEaD);
    ...
    function _transfer(
        ...
        if (TransactionType==3||TransactionType==4 ||TransactionType==5)
               takeFee = false;
