...
abstract contract AbsToken is IERC20, Ownable {
    ...
    notoken public _tokenDistributor;

    uint256 public _buyFundFee = 700;
    ...
    constructor (
        ...
        _tokenDistributor = new notoken(FISTAddress);
    }
...
contract QJZilla is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1888888,//Supply
        address(0x2d25c6f6d4B1BF77f50765821332362BbA9dd109),//FundAddress
        address(0x2d25c6f6d4B1BF77f50765821332362BbA9dd109)//ReceiveAddress
    ){
    }
}