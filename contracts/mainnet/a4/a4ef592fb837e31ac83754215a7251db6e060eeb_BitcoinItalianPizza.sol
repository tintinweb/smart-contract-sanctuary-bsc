...
contract BitcoinItalianPizza is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Bitcoin Italian Pizza";
   string constant _symbol = "ITALIANBTCPIZZA";
