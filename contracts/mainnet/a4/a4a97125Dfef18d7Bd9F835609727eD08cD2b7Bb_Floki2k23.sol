...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x003EF0CdE061833a3940d75C8368eB79130A5eA0; // owner address
...
contract Floki2k23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Floki2k23";
    string private _symbol = unicode"F2k23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x003EF0CdE061833a3940d75C8368eB79130A5eA0); // Marketing Address
    address payable public teamWalletAddress = payable(0x003EF0CdE061833a3940d75C8368eB79130A5eA0); // Team Address
