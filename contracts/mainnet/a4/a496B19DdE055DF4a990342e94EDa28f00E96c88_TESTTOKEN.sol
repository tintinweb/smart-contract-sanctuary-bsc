...
contract TESTTOKEN is IBEP20, Auth {
    ...
    function tokensForSecondTicket() external view returns (uint256) { return _tokensForSecondTicket; }
    function tokensForThirdTicket() external view returns (uint256) { return _tokensForThirdTicket; }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        else
        {
            ...
            if (recipient != address(this))
            {
                ...
                _dailyPrizeEntries[rewardDay][recipient] = _dailyPrizeEntries[rewardDay][recipient] + 1;
