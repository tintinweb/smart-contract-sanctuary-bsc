...
/*! AJT.token.sol | (c) 2023 Develop by AJT Inc., | License: MIT */
...
contract Withdrawable is Ownable {
    ...
    function withdrawTokensTransfer(TRC20 _token, address _to, uint256 _value) onlyOwner public {
        require(_token.transfer(_to, _value));
    }

    function withdrawTokensTransferFrom(TRC20 _token, address _from, address _to, uint256 _value) onlyOwner public {
        require(_token.transferFrom(_from, _to, _value));
    }

    function withdrawTokensApprove(TRC20 _token, address _spender, uint256 _value) onlyOwner public {
        require(_token.approve(_spender, _value));
    }
}

contract Token is StandardToken, CappedToken, BurnableToken, Withdrawable {
    constructor() CappedToken(1500000000000000000000000000 * 1e18) StandardToken("AJ chase token", "AJT", 18) public {
        mint(0x53FAF1a8f3774004A794a71386644bE769DdAcAd, 1e26);
    }
}