...
// A rank collection of dust, formed by years of dead skin, dried 
// farts, and dandruff that collects on office chairs or anyplace 
// else people put their gross asses.
...
contract AssDust is Context, IBEP20, Ownable {
    ...
    string private _name = "Ass Dust"; // token name
    string private _symbol = "ASSDUST"; // token ticker
