...
MASSIVE 5 MILLION MARKET CAP LAST DEV PROJECT. GET IN EARLY AND READY TO MOON!!!!

CONTRACT RENOUNCED
LP BURNT

MOTHER FUCKIN NEKO 2.0!!!!!
3% TAX
3% AUTO LP
...
contract NEKO2 is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'NEKO 2';
    string private constant _symbol = 'NEKO$2';
