...
contract WFDToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buyBuysellFee;
    uint256 public buyLiquidityFee;
    
    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellBuysellFee;
    ...
    constructor() ERC20("WORLD FOOD DEPOSIT", "WFD") {
        ...
        uint256 _buyBuysellFee = 1;
        uint256 _buyLiquidityFee = 2;

        
        uint256 _sellMarketingFee = 1;
        uint256 _sellBuysellFee = 1;
        ...
        buyBuysellFee = _buyBuysellFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBuysellFee;
        
        sellMarketingFee = _sellMarketingFee;
        sellBuysellFee = _sellBuysellFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBuysellFee;
        
    	marketingWallet = address(0x517876C896Ebb27EcD8b9F0b4E27F99F6CB53c20); // set as marketing wallet
        charityWallet = address(0x09660ac1F2D518b6E13ecd2541edb1A3C384edCe); // set as project wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForProject += fees * sellBuysellFee / sellTotalFees;
            }
            // on buy
                ...
                tokensForProject += fees * buyBuysellFee / buyTotalFees;
            }
