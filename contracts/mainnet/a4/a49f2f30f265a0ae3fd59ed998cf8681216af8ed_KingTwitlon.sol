...
contract KingTwitlon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Twitlon";
    string private _symbol = "KINGTWIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x948A246f6579752dfd82570Bc7DC19b9a70bA0EA); 
    address payable public BuyBackWalletAddress = payable(0x948A246f6579752dfd82570Bc7DC19b9a70bA0EA); 
