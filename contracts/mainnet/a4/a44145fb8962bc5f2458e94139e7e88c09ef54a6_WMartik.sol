...
//THOSE WHO BUY WMARTIK CAN EXCHANGE 1 FOR 1 FOR MARTIK AND THOSE WHO
// HAVE MARTIK CAN EXCHANGE 1 MARTIK FOR 1 WMARTIK THE EVOLUTION OF 
//THE ECO SYSTEM MARTIK IS HERE!

//ESTE TOKEN SERVE COMO ABASTECIMENTO DE LIQUIDEZ DO ECO SISTEMA MARTIK,
// QUEM COMPRAR WMARTIK PODE TROCAR 1 POR 1 POR MARTIK E QUEM TEM MARTIK 
//PODE TROCAR 1 MARTIK POR 1 WMARTIK A EVOLUÇÃO DO ECO SISTEMA MARTIK ESTA AQUI!
...
contract WMartik {
    ...
    string constant _name = "Wrapped Martik";
    string constant _symbol = "WMTK";
    ...
    function toKitram(uint256 amount) external {
        require(migrate);
