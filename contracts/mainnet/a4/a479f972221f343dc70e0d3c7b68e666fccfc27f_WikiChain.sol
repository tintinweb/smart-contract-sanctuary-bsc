...
contract WikiChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Chain";
    string private _symbol = "WICHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x947e331A749E976581056577490790f0313b3074); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x947e331A749E976581056577490790f0313b3074); // Development Address
