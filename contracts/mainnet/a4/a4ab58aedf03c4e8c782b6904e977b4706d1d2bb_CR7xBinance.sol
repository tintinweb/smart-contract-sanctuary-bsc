...
contract CR7xBinance is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x832C906F4d84a1a6A24A240C21aD0779B0718789); 
    address payable public Wallet_Dev = payable(0x832C906F4d84a1a6A24A240C21aD0779B0718789);
    ...
    string private constant _name = "CR7xBinance"; 
    string private constant _symbol = unicode"CR7BNB"; 
    ...
    constructor () {
        ...
        _owner = 0x832C906F4d84a1a6A24A240C21aD0779B0718789;
