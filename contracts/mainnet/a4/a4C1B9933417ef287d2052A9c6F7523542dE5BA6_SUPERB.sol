...
// https://t.me/SBC_GLOBAL
// https://superbcoinbsc.finance
// https://twitter.com/thesuperbcoin
...
contract SUPERB is Context, IERC20 { 
    ...
    address payable public Wallet_Development = payable(0x2a06e4338c5E7136DD157d796bd54B90D1f3b042); // Building Project 6%
    address payable public Wallet_Team = payable(0xd1d1d07f651d91D5348687fDCA1a8e34D40a0525); // Pay Team Shill - Raid 1%
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); // Burn Wallet - CEX Listing 2%
    address payable public constant Lp_Reciever = payable(0x4C487024Ac6972F9c55935034f600546dbe331ba); // Liquidity Pool - Floor Price 1%
    ...
    constructor () {
        ...
        _owner = 0xd1d1d07f651d91D5348687fDCA1a8e34D40a0525;
