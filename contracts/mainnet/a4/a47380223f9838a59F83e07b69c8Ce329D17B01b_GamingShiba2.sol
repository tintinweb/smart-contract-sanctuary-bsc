...
contract GamingShiba2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "GamingShiba2.0";

    string private _symbol = "GSHIB2.0";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xd5722C63ef44004FB42Df95Cd882BB8c88940833;
