...
contract MorkieInu is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 100_000 * 10**18;
    uint256 public maxSellLimit = 100_000 * 10**18;
    ...
    address public marketingWallet = 0xa22b84E0D01145AeC31D027604db18611b8C75aE;
    address public devWallet = 0x73FC771a4F223d8b97a5317DEfde5aF85bbB5453;
    address public opsWallet = 0xB483b3CF39B67115e45B4d0C514B20Ad035d64e5;
    address public buybackWallet = 0x4C286eFA9e8c7a1dBb1091e80773e0fBe122E133;
    ...
    constructor(address routerAdd) ERC20("Morkie Inu", "MINU") {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        ...
        require(amount >= 10_000, "Cannot set max wallet amount lower than 0.1%");
    }
