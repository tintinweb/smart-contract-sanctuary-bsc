...
contract BotBlueRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = " Bot Blue Rabbit "; // 
    string private constant _symbol = " $BOBR "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x79971105952B1203fF795A4edB909CaD1a3761f9;
