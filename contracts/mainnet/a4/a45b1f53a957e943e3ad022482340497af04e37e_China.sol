...
contract China is Context, IERC20, Ownable {
    ...
    string private _name = "China Cat";
    string private _symbol = "CC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89b4E77bD8624FeAb2C84bbb624864Ebe1F4225C); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x89b4E77bD8624FeAb2C84bbb624864Ebe1F4225C); // buyback Address
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**9; // 0.1%
    uint256 public _walletMax = 10000000000000 * 10**9; // 2%
