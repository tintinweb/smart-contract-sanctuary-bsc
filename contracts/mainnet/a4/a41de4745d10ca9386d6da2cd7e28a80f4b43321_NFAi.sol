...
contract NFAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Not Financial Advice";
    string private _symbol = "NFAi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a28239abb359030E8245ee8B9A2A0ad5fff6A34); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3a28239abb359030E8245ee8B9A2A0ad5fff6A34); // Team Address
