...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE84e7d91CAe5C53DcaaFEa88e114E666019aeA92; // owner address
...
contract BurnSpooky is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BurnSpooky";
    string private constant _symbol = unicode"BS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x294Bd2b568f45914EdCe4b255c7C59CcDf4b9F52); // Marketing Address
    address payable public teamWalletAddress = payable(0xE84e7d91CAe5C53DcaaFEa88e114E666019aeA92); // Team Address
