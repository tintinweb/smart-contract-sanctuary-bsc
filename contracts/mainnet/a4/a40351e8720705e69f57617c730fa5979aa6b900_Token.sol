...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 17800 * 10**18;

    string private _name = "BAIZE";
    string private _symbol = "BAIZE";
    ...
    address public _market = 0xF3894B0F5C0deDa86FCb31e5186c51F4215759A3;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0xF3894B0F5C0deDa86FCb31e5186c51F4215759A3),
            _msgSender(),
            _tTotal
        );
    }
