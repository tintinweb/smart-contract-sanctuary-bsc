...
//telegram: https://t.me/saudiviatoken
interface IERC20 {
...
contract SAUDIVIA is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 4_000_000 * 10**_decimals;

    address public marketingAddress = 0x9FbcD850a2d9D1D8d3d15d71D74a27aeC83AF987;
    address public devAddress = 0x9FbcD850a2d9D1D8d3d15d71D74a27aeC83AF987;

    string private constant _name = "SAUDIVIA TOKEN";
