...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0624b444848895935a0822469d2180888929bA21; // owner address
...
contract EthereumDEV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ethereum DEV";
    string private _symbol = "ETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42cB03c7B7f5da225F24dd08495Ea999CbD61739); // Marketing Address
    address payable public buybackWalletAddress = payable(0x42cB03c7B7f5da225F24dd08495Ea999CbD61739); // Buyback Address
