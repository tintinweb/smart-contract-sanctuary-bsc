...
We are at the precipice of a revolution, to bring the crypto space back to how is once was, to bask in the glory of the months of yore all over again.  What was once old is new, only... bigger... bolder... LOUDER!  

This is BITCOIN!!! 
Don't forget the "!!!"

BITCOIN!!! is a community-centric BSC project led by some of the most based names in the industry today. BTC!!! aims to bring back the glory days of BSC by reinventing what is old and bringing something new and exciting to the scene. It is 100% SAFE
and backed by big names.

TOKENOMICS:

Total Supply: 1,000,000,000
Max Wallet & TX: 2%
Taxes For Initializing Partnerships With Influencers
Rewards in BTCB

Important Links:

TG: @BitcoinExclamationPoint3x
-----------------------------------------------------------------------------------------------------------------
*/
...
contract BTCExclamation1000x is IBEP20, Auth {
    using SafeMath for uint256;
