...
contract AntiRugNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anti Rug Network"; // 
    string private constant _symbol = "ARN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3C7579B0afF9e4161DDf9ef5266D663830C129ED;
