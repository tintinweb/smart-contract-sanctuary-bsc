...
/**
BSC LOVE https://t.me/BscLove2023 5/5Tax 1% busd
*/
...
/* Token contract */
contract BscLove is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x847dC5d4f56419353ecc8ad7e766F546079E7E5C;
    ...
    // Name and symbol
    string constant _name = "BSC LOVE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 3000000; //  
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 3000000; // 
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 3000000; // 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x847dC5d4f56419353ecc8ad7e766F546079E7E5C;
