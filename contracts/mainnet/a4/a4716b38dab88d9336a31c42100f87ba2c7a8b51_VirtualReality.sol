...
contract VirtualReality is Context, IERC20, Ownable {
    ...
    string private constant _name = "VirtualReality";
    string private constant _symbol = "VR";

    address public _PancakeSwapV1RouterUniswap =0xb2dBA5EE181A5aC9Eb09f5A3D2308Ad094db062F ; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap =0xb2dBA5EE181A5aC9Eb09f5A3D2308Ad094db062F ; //can be the same
