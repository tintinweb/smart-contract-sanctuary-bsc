...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50AA495e26DbD0A23E88E534609E52dD4Faf22c6; // owner address
...
contract AndrewDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Andrew Dust";
    string private _symbol = "AndrewDust";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x445ca3Ccde0417feFe3A36F225fdce13Aa7c5300); // Marketing Address
    address payable public teamWalletAddress = payable(0x445ca3Ccde0417feFe3A36F225fdce13Aa7c5300); // Team Address
