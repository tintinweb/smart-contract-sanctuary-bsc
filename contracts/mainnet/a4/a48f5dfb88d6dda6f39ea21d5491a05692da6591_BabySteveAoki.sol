...
contract BabySteveAoki is Ownable, IBEP20 {
    ...
    string constant _name = "BabySteveAoki";
    string constant _symbol = "$BAOKI";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xb040FECF7e917508569a0c0673F6B87614467B5d;
        marketingWallet = 0xb040FECF7e917508569a0c0673F6B87614467B5d;
