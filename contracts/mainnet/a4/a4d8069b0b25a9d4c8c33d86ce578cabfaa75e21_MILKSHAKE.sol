...
contract MILKSHAKE is Context, IBEP20, Ownable {
    ...
    address public devWallet = 0xcdE55102F94b6067aE996d7D1f388DC4Af728FC6;
    address public opsWallet = 0xcdE55102F94b6067aE996d7D1f388DC4Af728FC6;

    string private constant _name = "MyMilkShake";
    ...
    Taxes public taxes = Taxes(0, 3, 1, 1, 1);
    Taxes public sellTaxes = Taxes(0, 3, 1, 1, 1);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev + _ops) <= 20, "Fees can't exceed 20%");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 100_000, "Cannot set max buy amount lower than 0.1% of tokens");
        require(maxSell >= 100_000, "Cannot set max sell amount lower than 0.1% of tokens%");
        require(maxWallet >= 1_000_000, "Cannot set max wallet amount lower than 1% of tokens");
