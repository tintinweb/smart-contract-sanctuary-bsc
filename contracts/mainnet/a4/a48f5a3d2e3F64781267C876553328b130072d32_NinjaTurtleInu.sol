...
contract NinjaTurtleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ninja Turtle Inu"; //
    string private constant _symbol = "NTI"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x9D60D2a4ECbaD6C8C5ec0fDEF3A61046246A85dD ;
