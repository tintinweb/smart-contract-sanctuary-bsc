...
contract Rabbit2023 is Context, IERC20 { 
    ...
    string private _symbol = unicode"RABBIT 23";
    ...
    address payable public DevWallet = payable(0xeE7424438676efc048d996af3A4BDB2226087908);
    address payable public MarketingWallet = payable(0xeE7424438676efc048d996af3A4BDB2226087908);
