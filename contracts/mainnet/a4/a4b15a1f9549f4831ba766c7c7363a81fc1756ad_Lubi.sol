...
contract Lubi is Context, IERC20, Ownable {
    ...
    string private _name = "Lunc Binance";
    string private _symbol = "Lubi";
    ...
    address payable public marketingWallet = payable(0x633Ec9C76cABb90612709478aD5f2D83835cB922);
