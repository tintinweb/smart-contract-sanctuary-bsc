...
// Telegram : https://t.me/RyokugyuInu
...
contract Wagmitwozero is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ryokugyu Inu";
    string private _symbol = "RYOKU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9D681648b9263F09756F76517B98481CDB584AC8); // Marketing Address
    address payable public teamWalletAddress = payable(0x690DE3fcFedF31cc3625AcE656e6Abd53BD48493); // Team Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xc16880dB0463f4710c09017159Ff58430FD10cA0); 
