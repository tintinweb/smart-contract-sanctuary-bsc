...
Exos Network A highly scalable, fast and secure blockchain platform for distributed apps,
enterprise use cases and the new internet economy.

Telegram : https://t.me/exosnetworkofficial
...
contract Exosnetowrk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Exos Network"; // 
    string private constant _symbol = "$ESN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x5891786F19B7b1437873BCa82c47C647c714Ea8C;
