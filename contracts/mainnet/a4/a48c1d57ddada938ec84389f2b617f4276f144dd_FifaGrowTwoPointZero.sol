...
contract FifaGrowTwoPointZero is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x30f102F40Da58880e5f63e10C37232FE65BF44BE;

    string constant _name = "Fifa Grow 2.0";
    string constant _symbol = "FG2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 1**6 * 10**_decimals;
