...
contract PawFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0E401e681750279a3F50a3C272412aA4d0579fF2); 
    address payable public Wallet_Dev = payable(0x96Bc4E05c45E31C4E43Cf1FD1A1A2e860e5f7568);
    address payable public W_Deployer = payable(0x96Bc4E05c45E31C4E43Cf1FD1A1A2e860e5f7568);
    ...
    string private constant _name = "Paw Floki"; 
    string private constant _symbol = unicode"PAWFLOKI"; 
    ...
    constructor () {
        ...
        _owner = 0x96Bc4E05c45E31C4E43Cf1FD1A1A2e860e5f7568;
