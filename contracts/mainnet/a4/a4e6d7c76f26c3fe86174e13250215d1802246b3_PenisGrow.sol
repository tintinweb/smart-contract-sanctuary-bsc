...
Every TX 3% is gathered for this very beautiful moment, and every milestone MC hit, we will do buybacks emptying the whole wallet! over and over and over again! 
*/
...
contract PenisGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd704256764af1eDb36Ae7d3d701C35f6A92059dD); 
    address payable public Wallet_Climax = payable(0x53Bd1eEe0FDbf85eab017e83114b9b8dDA7214b8);
    ...
    constructor () {
        ...
        _owner = 0x53Bd1eEe0FDbf85eab017e83114b9b8dDA7214b8;
