...
contract NARUTOINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8dC15B82B04206d14BAC3626b123d2F9f9Af776b); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xfe41DF542167DdD1ceD0dE0775A0d26b932BfaC0); // Development Address
    ...
    uint256 private _totalSupply = 900* 90**6 * 90**9;
    uint256 public _maxTxAmount = 900 * 90**6 * 90**9;
