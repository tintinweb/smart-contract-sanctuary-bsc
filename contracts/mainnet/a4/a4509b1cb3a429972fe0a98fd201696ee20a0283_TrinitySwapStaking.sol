...
contract TrinitySwapStaking is Ownable {
	...
	ERC20Interface TrinitySwapRewards;
    ...
    constructor(address _TrinitySwapRewards) public {
        TrinitySwapRewards = ERC20Interface(_TrinitySwapRewards);
    }

    function invest(address referrer, uint256 amount) public {
		TrinitySwapRewards.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = TrinitySwapRewards.balanceOf(address(this));
		...
		TrinitySwapRewards.transfer(msg.sender, totalAmount);
