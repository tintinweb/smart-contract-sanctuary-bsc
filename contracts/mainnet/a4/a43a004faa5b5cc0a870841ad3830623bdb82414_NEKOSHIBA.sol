...
contract NEKOSHIBA is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEKO SHIBA";
    string private constant _symbol = "NEKOSHIBA";
