...
contract Tigercnm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tigercnm";
    string private _symbol = "Tigercnm";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x38bC471e59d218bfbfAb0Be3B6d6c16c72Ec4Bb6);
    address payable public teamWalletAddress = payable(0xd0606BBa51b131ad9e73EEda8a2716dcBEA22013); 
    ...
    uint256 private minimumTokensBeforeSwap = 10 * 10**4 * 10**_decimals; 
