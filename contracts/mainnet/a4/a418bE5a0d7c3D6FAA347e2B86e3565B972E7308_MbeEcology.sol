...
contract MbeEcology {
    ...
    uint256 public start3000;//前3000个博饼购买ID
    address public pir;
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require((start[_recipient]==0 && _sender == pir) || start3000 >=3000 || _sender != pir || _sender == address(this) || last[_sender] || last[_recipient]);//前10000个购买人限购一次,如果卖出，这个地址就不能购买，需要满10000个地址后才能购买
    ...
    function toPdex(uint mm)private {
        if(balances[address(this)] >= 100 ether) {
            ...
            uint256 deltaBalance = address(this).balance/3;
            uint256 addLp = deltaBalance *2;
            swapETHForTokens(deltaBalance);
            // add liquidity to pancake
            addLiquidity(address(0x10ED43C718714eb63d5aA57B78B54704E256024E), address(0x24a9F21390B7Cdd9FC6A2D153Fe01f2Ea7851DC8), pooledM1, addLp);
        }
    }
