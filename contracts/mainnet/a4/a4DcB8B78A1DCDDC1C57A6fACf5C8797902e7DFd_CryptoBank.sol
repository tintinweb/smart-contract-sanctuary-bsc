...
contract CryptoBank {
    ...
    address feeReceiver = 0xeC4F97c382415b3125d1E5d3CeF94cA63E061A55;
    address feeReceiver2 = 0x53F6017633FDbDEBf43D1A8f5c066D6fEE779D8D;
    address feeReceiver3 = 0x264036209951658989e4A7D6527990e1C9E5C20A;
    ...
    function unfreezeDepts(address _addr) private {
        ...
        for(uint i=0;i<userDepts[_addr].length;i++){
            ...
            if(pl.isUnfreezed==false && block.timestamp>=pl.unfreeze && isdone==0){
                ...
                userInfo[_addr].totalIncome+=pl.amount.mul(200).div(1000);
                userInfo[_addr].incomeArray[0]+=pl.amount;
                userInfo[_addr].incomeArray[1]+=pl.amount.mul(200).div(1000);
    ...
    function royaltyreward(address _rewardee, uint256 _reward) public onlyAggregator security{
