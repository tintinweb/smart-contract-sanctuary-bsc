...
contract BabyFifaInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyFinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb5717bfe9B6E1eB1987110B36612b211800B8D03); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb5717bfe9B6E1eB1987110B36612b211800B8D03); // BuyBack Address
