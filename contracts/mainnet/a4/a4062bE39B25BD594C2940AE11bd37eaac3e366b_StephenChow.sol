...
contract StephenChow is Context, IERC20, Ownable {
    ...
    string private _name = "Stephen Chow Coin";
    string private _symbol = "ZhouXingChi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4507Bd0C43F18B8e2CAC549DeDB6337f6Ce9D0F1); // Marketing Address
    address payable public teamWalletAddress = payable(0x4507Bd0C43F18B8e2CAC549DeDB6337f6Ce9D0F1); // Team Address
