...
contract IceBlock is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xA724c1983E9731d5074F449F9aA10aB90b8B08A4); // Marketing Address
        
    address payable public teamAddress =
        payable(0x89F684a3d5E9fc0c9D8825D5250e2388Ac00Aa01); // Team Address
        
    address payable public liquidityAddress =
        payable(0x89F684a3d5E9fc0c9D8825D5250e2388Ac00Aa01); // Liquidity Address
    ...
    string private constant _name = "Ice Block";
