...
contract MonkeypoxGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkeypox Grow";
    string private _symbol = "MPGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe24F6Ae07681737fe97EB32f135711F60bfa14AA); // Marketing
    address payable public BuyBackWalletAddress = payable(0x9849B36Bca31111f64cAD44A0077357cfF2Be419); // BuyBack 
