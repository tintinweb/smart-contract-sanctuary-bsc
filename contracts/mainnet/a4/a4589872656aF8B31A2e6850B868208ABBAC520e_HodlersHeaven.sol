...
Hodlers Heaven IS A Based Project Developed By a Based Dev
Its heavily centered around staking and reflection features.

Check it on
Telegram
https://t.me/hodlersheavenBSC
...
/* Token contract */
contract HodlersHeaven is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xD692cf4E6198D7aE79Df0AA89D5D5C1197571E74;
    ...
    // Name and symbol
    string constant _name = "HodlersHeaven";
    string constant _symbol = "HH";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10 / 100; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 100; // 1% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 11 ) / 100; // 20% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD692cf4E6198D7aE79Df0AA89D5D5C1197571E74;
