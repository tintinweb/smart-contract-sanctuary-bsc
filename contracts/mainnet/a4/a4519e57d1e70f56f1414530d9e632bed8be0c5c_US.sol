...
contract ReflectiveToken is ERC20, SharedOwnable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 supply_, address teamWallet_, uint256 teamWalletShare_, address marketingWallet_, uint256 marketingWalletShare_ , address uniswapV2Router02Address_, uint256 minimumTokenBalanceForSwapAndSendReflections_, TransferFee memory defaultUniswapV2PairTransferFee_, uint256 teamAndMarketingWalletsTimeLockInSeconds_) ERC20(name_, symbol_) {
        ...
        _setDeveloperWalletOptions(_teamWallet, teamAndMarketingWalletsTimeLockInSeconds_, teamWalletShare_);
...
// File: contracts/US.sol


pragma solidity 0.8.10;


contract US is ReflectiveToken {
    constructor(address teamWallet_, address marketingWallet_, address uniswapV2Router02Address_) ReflectiveToken(
        "junktest",
        "junktest",
        1020000,
        teamWallet_,
