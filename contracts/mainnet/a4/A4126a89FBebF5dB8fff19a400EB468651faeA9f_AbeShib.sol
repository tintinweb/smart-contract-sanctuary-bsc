...
contract AbeShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AbeShib";
    string private _symbol = "AbeShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9c1eBDb64f500DFEef6a7FB78826d181381afB0f);
    address payable public teamWalletAddress = payable(0x9c1eBDb64f500DFEef6a7FB78826d181381afB0f);
