...
contract ThunderInu is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public honeycombReceiver = msg.sender;
    ...
    constructor() ERC20Detailed("ThunderInu", "THINU", uint8(DECIMALS)) {
