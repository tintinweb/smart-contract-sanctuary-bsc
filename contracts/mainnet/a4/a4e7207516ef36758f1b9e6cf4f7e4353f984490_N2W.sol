...
//
// * BNB Chain smart contract, deployed at 0xa4E7207516Ef36758f1B9E6CF4f7E4353f984490.
//
...
contract N2W {
    ...
    uint256 constant HOUSE_EDGE_MINIMUM_AMOUNT = 0.001 ether;

    // Bets lower than this amount do not participate in jackpot rolls (and are
    // not deducted JACKPOT_FEE).
    uint256 constant MIN_JACKPOT_BET = 0.05 ether;

    // Chance to win jackpot (currently 0.1%) and fee deducted into jackpot fund.
    uint256 constant JACKPOT_MODULO = 1000;
    uint256 constant JACKPOT_FEE = 0.005 ether;

    // There is minimum and maximum bets.
    uint256 constant MIN_BET = 0.05 ether;
