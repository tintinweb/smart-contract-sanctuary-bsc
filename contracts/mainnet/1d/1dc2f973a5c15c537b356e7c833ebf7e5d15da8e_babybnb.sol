...
contract babybnb  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5B5C70D02C11556D014A6BA0bd3a2995E2E44E13); 
    address payable public Wallet_Dev = payable(0x5B5C70D02C11556D014A6BA0bd3a2995E2E44E13);
    ...
    string private constant _symbol = " BABYBNB2.0";
