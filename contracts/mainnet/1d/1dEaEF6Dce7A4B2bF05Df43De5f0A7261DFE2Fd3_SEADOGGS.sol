...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB2865a03a208924D3dfe6a8a132abbD392af6cAE; // owner address
...
contract SEADOGGS  is Context, IERC20, Ownable {
    ...
    string private _name = "SEA DOGGS";
    string private _symbol = "SEA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB2865a03a208924D3dfe6a8a132abbD392af6cAE); // Marketing Address
    address payable public teamWalletAddress = payable(0xB2865a03a208924D3dfe6a8a132abbD392af6cAE); // Team Address
