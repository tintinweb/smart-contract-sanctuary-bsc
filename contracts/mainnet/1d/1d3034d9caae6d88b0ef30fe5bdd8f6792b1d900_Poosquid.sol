...
library Address{
 ...
 contract Poosquid is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3_000_000 * 10**4;
    uint256 public maxBuyLimit = 20_000_000 * 10**4;
    uint256 public maxSellLimit = 20_000_000 * 10**4;
    uint256 public maxWalletLimit = 20_000_000 * 10**4;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x4E6DE330a38E20D6731A8219DeA5d343fcef2f17;
    address public donationWallet = 0xd339872Dfb5D533399076a7253dd7da3ea3c78a2;

    string private constant _name = "PooSquid";
    string private constant _symbol = "POOSQUID";
    ...
    Taxes public taxes = Taxes(0, 90, 0, 9);
