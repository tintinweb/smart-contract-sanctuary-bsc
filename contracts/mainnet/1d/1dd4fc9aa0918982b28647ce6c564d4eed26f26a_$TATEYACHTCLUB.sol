...
// 
//
// 📱 Telegram:https::https://t.me/TateYachtClub
//
...
contract $TATEYACHTCLUB is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("TATEYACHT CLUB", "TATEYACHTCLUB") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TATEYACHTCLUB";
    string private _symbol = "TATEYACHTCLUB";
