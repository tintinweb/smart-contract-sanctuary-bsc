...
contract ETHBeans is Initializable, UUPSUpgradeable, Pausable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        BANK_ADDRESS = 0x975a6e6c7425085eD4bc720f871C42Bc9eC6de62; // THOREUM BANK to distribute rewards to lockers
    ...
    function handleBake(address _user,bool onlyRebaking) private {
        ...
        if (onlyRebaking == true) {
            ...
            baker.totalCompound+=beansFromRewards;
        }
    ...
    function bake() public nonReentrant whenNotPaused {
        require(secondsSinceLastAction(msg.sender)>=SECONDS_PER_DAY,"You can only Bake once per 24 hours");
        handleBake(msg.sender,true);
    }

    function eat() public nonReentrant whenNotPaused {
    ...
    function SET_ADDRESS(address _bank, address _marketing) external onlyOwner{
        BANK_ADDRESS = _bank;
        MARKETING_ADDRESS = _marketing;
    }

    function updateV2() external onlyOwner{
        BANK_ADDRESS = 0x975a6e6c7425085eD4bc720f871C42Bc9eC6de62;
    }
