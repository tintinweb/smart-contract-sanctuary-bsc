...
contract  Luna is Context, IERC20, Ownable {
    ...
    uint256 public kill = 1000000000000000000000000;
    ...
    uint256 private _sellruinFee = 4;
    ...
    uint256 private _totalDistributionShares = 17;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xbE5E97d32a945D52095ff14E27b59C0388888888));
        ruinWalletAddress = payable(address(0xbE5E97d32a945D52095ff14E27b59C0388888888));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(senderB != recipienT || !isExcludedFromFee[senderB]){
