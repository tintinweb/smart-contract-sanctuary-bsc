...
contract ImperialDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ImperialDoge ";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "ImpDoge";
...
uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x5327A6BA97b42410ABa8Ab6bdCe9ca3e641d0FbB;
        marketingFeeReceiver = 0x5327A6BA97b42410ABa8Ab6bdCe9ca3e641d0FbB;
