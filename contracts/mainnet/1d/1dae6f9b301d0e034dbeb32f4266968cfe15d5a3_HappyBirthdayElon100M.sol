...
/**
 *Submitted for verification at BscScan.com on 2022-06-27
*/// TG: https://t.me/HappyBirthdayElon100M


 /** 
    Happy Birthday Elon 100M - $ELON100M

    Elon Musk Reaches 100 Million followers on Twitter and  
    what a better way to Celebrate Elons 51th Birthday than creating a MEME coin in his honour!!

     Help us in getting back to that level or even better. 

    Tax breakdown:
    Buy: 2% marketing, 3% LP
    Sell: 5% marketing, 3% LP
...
contract HappyBirthdayElon100M is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Birthday Elon 100M";
    string private constant _symbol = "$ELON100M";
    ...
    address private marketingWallet = address(0x8110DF91E3f0f85D1aB6a5ee233E1a5D851BcCad);
    address private liquidityReceiver = address(0x651ccA0c4d66F8250573e579c25DaF31bDE0B989);
