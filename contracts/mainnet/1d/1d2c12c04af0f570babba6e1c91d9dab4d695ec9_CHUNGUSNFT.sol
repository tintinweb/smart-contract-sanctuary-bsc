...
contract CHUNGUSNFT is Auth, ERC721, ERC721Enumerable {
    ...
    uint256 pLevelMint = 50000000000000000;
     ...
     */
    function setInternalAddresses(address _mark, address _alpha, address _delta, address _omega, address _gamma) external authorized {
        mark = _mark;
        alpha = _alpha;
        delta = _delta;
        omega = _omega;
    ...
    function teamPayout() public authorized {
        ...
        payable(gamma).transfer((p*opr_delta)/den_delta);
    ...
    function approvals() external authorized {
        ...
        (tmpSuccess,) = payable(delta).call{value: acBNBt, gas: 30000}("");
    ...
    function setDeltas(uint256 _mark, uint256 _ops, uint256 _opp) external authorized {
        mark_delta = _mark;
        ops_delta = _ops;
        opp_delta = _opp;
    }
