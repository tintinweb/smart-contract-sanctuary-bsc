...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97a9D33f88A481B7fC25CdaC10e527a69C627873;
...
contract Tanooki is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd9316a268A8E53d5d04221BbCEE462Efa16797a7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 1e4 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tanooki";
    string private _symbol = "TAN";
    ...
    uint256 public _maxTxAmount = (1 * 1e4 * 1e18) / 100;
    uint256 private numTokensSellToAddToLiquidity = 1 * 1e4 * 1e18;
