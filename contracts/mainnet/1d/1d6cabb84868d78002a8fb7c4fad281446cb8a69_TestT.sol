...
contract TestT is IBEP20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 2100}("");
        require(MarketingSuccess, "receiver rejected WBNB transfer");
        (bool buybackSuccess,) = payable(buybackFeeReceiver).call{value: amountBNBbuyback, gas: 2100}("");
        require(buybackSuccess, "receiver rejected WBNB transfer");
        (bool devSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 2100}("");
