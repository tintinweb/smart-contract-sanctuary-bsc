...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 6120 * 10** Decimals;
        maxSellAmount = 1 * 10** Decimals;
        walletLimit =  6120 * 10** Decimals;
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _buyLPFee + _buyDeadFee + _sellFundFee + _sellLPDividendFee + _sellLPFee + _sellDeadFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee;
            if (isSell) {
                swapFee = _sellFundFee + _sellLPDividendFee + _sellLPFee + _sellDeadFee;
                require(tAmount <= maxSellAmount,"over max sell amount");
            } else {
                swapFee = _buyFundFee + _buyLPDividendFee + _buyLPFee + _buyDeadFee;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x696cE7c3ee21Fe0C544f51bC5dd94331407D2023;//
    ...
    function setBuyFee(uint256 dividendFee,uint256 fundFee,uint256 lpFee,uint256 DeadFee) external onlyOwner {
    ...
    function setSellFee(uint256 dividendFee,uint256 fundFee,uint256 lpFee,uint256 DeadFee) external onlyOwner {
...
contract LYE is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        6120,//Supply
        address(0x696cE7c3ee21Fe0C544f51bC5dd94331407D2023),//FundAddress
        address(0x696cE7c3ee21Fe0C544f51bC5dd94331407D2023)//ReceiveAddress
    ){
    }
}