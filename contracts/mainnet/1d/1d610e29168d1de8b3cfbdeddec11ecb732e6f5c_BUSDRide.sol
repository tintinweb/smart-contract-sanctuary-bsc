...
contract BUSDRide is ERC223Token, Ownable {
    ...
    address internal busdrideTeam_addr = 0x9d03E26e036987245B8B501c1695cA2155f342a9;
    address internal marketing_addr = 0x9d03E26e036987245B8B501c1695cA2155f342a9;
    address internal buyBack_addr = 0x9d03E26e036987245B8B501c1695cA2155f342a9;

    /* BUSD Address */
    address internal busd_address = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    IERC20 public busd_token;

    /* % from every day's lobby entry dedicated to busdride team, marketing and buy back */
    uint256 internal constant DM_busdrideTeam_percentage = 4;
    ...
    /* Gets called once a day and withdraws busdride team's share for the privious day of lobby */
    function _sendDevShare() internal nonReentrant {
        require(currentDay > 0);
        // busdrideTeamPercentage = 4% of every day's lobby entry
        uint256 busdrideTeamPercentage = (lobbyEntry[currentDay - 1] *
            DM_busdrideTeam_percentage) / 100;
        busd_token.transfer(busdrideTeam_addr, busdrideTeamPercentage);
    }
    ...
    function withdrawSoldStakeFunds() external {
        ...
        stakeLoanFee = stakeLoanFee * DM_busdrideTeam_percentage;
        stakeLoanBuybackFee = stakeLoanBuybackFee * DM_busdrideTeam_percentage;
