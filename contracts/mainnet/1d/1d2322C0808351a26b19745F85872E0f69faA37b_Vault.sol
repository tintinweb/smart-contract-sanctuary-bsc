...
contract Vault is Configurable {
    ...
    function __Vault_init(address governor) public initializer {
   ...
   function withdrawToken(address _token, address _dst) public governance {
        uint balance = IERC20(_token).balanceOf(address(this));
        IERC20(_token).safeTransfer(_dst, balance);
    }
     
    function withdraw(address payable _dst) external governance {
