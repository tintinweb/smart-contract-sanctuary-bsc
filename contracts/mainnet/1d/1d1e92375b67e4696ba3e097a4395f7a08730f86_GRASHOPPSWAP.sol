...
contract GRASHOPPSWAP is Context, IERC20, Ownable {
    ...
    string private constant _name = "GRASHOPPSWAP"; 
    string private constant _symbol = "$HOPP"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 9;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xa7D297BB40F55B9893f9E8150B9d5e7A9e094Af5;
