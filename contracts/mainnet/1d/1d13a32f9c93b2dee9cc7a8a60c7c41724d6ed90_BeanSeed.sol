...
https://t.me/BeanSeedBsc
https://twitter.com/BeanSeedBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEAaD363483Ae1b2A120612C3d3a4AB1fAead26A2;
...
contract BeanSeed is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xEAaD363483Ae1b2A120612C3d3a4AB1fAead26A2);
    ...
    */
    ...
    string private _name = "BeanSeed"; 
    string private _symbol = "$BEASE";  
