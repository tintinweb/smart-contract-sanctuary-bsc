...
Many Good Callers Have Joined Like GoodCryptoreview,CryptoFrog,Valhalla,DubaiCalls,Casaeth, and Others

Stealth launch todays 2PM-3PM UTC

Baby FTX The goal of Baby FTX is to make the crypto space more transparent and to give our users an advantage over other traders through our DApp!

🔥JOIN OUR GREAT COMMUNITY🔥
Portal:
https://t.me/BabyFTXbsc
 */
library SafeMath {
...
contract  bFTX is IBEP20, Auth {
    ...
    address DEV =  0xf46D33C75Cbbf9C8067bb90D4CC3e4c4E82f9057;
    ...
    // Name and symbol
    string constant _name = "Baby FTX";
    ...
    // Buy Fees
    uint256 private DevelopmentFeeBuy = 2; 
    ...
    // Sell fees
    uint256 private DevelopmentFeeSell = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf46D33C75Cbbf9C8067bb90D4CC3e4c4E82f9057;
