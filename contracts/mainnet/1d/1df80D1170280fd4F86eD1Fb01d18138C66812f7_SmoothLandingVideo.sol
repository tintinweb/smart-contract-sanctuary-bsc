...
contract SmoothLandingVideo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Smooth Landing Video";
    string private _symbol = "$SpaceX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73ea88541388A960f097fDD0486F75e41d2CF218);
    address payable public teamWalletAddress = payable(0x73ea88541388A960f097fDD0486F75e41d2CF218);
