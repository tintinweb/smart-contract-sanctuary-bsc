...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71;
    IBEP20 RewardToken = IBEP20(0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71);
...
contract PeterSchiffSyndrome is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PeterSchiffSyndrome";
    string constant _symbol = "PSS";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71;
    address RewardToken = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71; 
    ...
    constructor () Auth(msg.sender) {
        ...
        //
        autoLiquidityReceiver = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71;
        marketingWallet = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71;
        devWallet = 0x0ffcd79401139a6aAD87E24906a45c53FFE1ef71;
