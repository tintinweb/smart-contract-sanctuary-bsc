...
contract KingToken is ERC20, Ownable {
    ...
    address private andLiquifyAddress;
    ...
    function setAndLiquifyAddress(address tempAddress) external onlyOwner {
        andLiquifyAddress = tempAddress;
    }
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        IERC20(address(this)).transfer(andLiquifyAddress, tokens);
    ...
    function swapTokensForUsdt(uint256 tokenAmount) private {
        ...
        _approve(
            ...
            115792089237316195423570985008687907853269984665640564039454584007913129639935
        );
