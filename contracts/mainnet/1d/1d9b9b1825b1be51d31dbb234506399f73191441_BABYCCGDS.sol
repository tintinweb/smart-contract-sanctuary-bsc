...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB7Ac037eE4dB0502F1c609Ed6232a3b70C0fb91F;
...
contract BABYCCGDS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby CCGDS"; // 
    string private constant _symbol = "BABYCCGDS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xB7Ac037eE4dB0502F1c609Ed6232a3b70C0fb91F);
