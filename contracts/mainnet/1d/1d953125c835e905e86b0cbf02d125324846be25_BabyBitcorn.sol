...
/**
Baby Bitcorn SmartContract

http://t.me/BabyBitcornOfficial

https://twitter.com/BabyBitcorn
*/
...
contract BabyBitcorn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyBitcornDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyBitcorn", "BabyBitcorn") {
        marketingWallet = payable(0xCD20DA202ab023A88E0bD065AAb8D108CBaa3B9c);
        ...
        dividendTracker = new BabyBitcornDividendTracker(
            payable(this),
            router,
            0x69A2f86f76B5C5aE4F7415A1A6ac82Ab8b4E19b0,
            "BabyBitcornTRACKER",
            "BabyBitcornTRACKER"
        );
...
contract BabyBitcornDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyBitcorn public BabyBitcornContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyBitcornContract = BabyBitcorn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BabyBitcorn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BabyBitcorn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyBitcorn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyBitcornContract);

            uint256 prevBalance = BabyBitcornContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyBitcornContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyBitcornContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
