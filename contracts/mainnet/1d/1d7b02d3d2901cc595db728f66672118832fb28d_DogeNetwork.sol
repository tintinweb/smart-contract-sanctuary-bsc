...
*/
/** DogeNetwork
https://t.me/dogenetwork_Official
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x360345c7b9af21121e8d4819eb4d4cA4fF5E7362; // owner address
...
contract DogeNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeNetwork ";
    string private _symbol = "DOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x360345c7b9af21121e8d4819eb4d4cA4fF5E7362); // 
    address payable public teamWalletAddress = payable(0x360345c7b9af21121e8d4819eb4d4cA4fF5E7362); // 
