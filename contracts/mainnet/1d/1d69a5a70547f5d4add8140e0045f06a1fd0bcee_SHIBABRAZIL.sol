...
// Telegram : https://t.me/ShibaBrazil
...
Sell tax 7%
Initial Lp: 1BNB
Liq Lock: 1 Month on Pinksale
📝 Group will open after Hit Trending on Biggestbuy Bot 🤖
...
contract SHIBABRAZIL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBA BRAZIL";
    string private _symbol = "$SHIB";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x6DF912741Ee0E738d6F67f34D51932857A87f06B); // Use for Marketing Address
    address payable private TeamWallet = payable(0x85a4bb253630EA6D7bf9f6Bb117e1FDDC726C839); // Main Address
    ...
    uint256 private _totalSupply = 600 *  10**5 * 10**_decimals;
    ...
    //manage address claim
    function AddIncludeinReward(address[] calldata addresses, bool status) public onlyOwner {
