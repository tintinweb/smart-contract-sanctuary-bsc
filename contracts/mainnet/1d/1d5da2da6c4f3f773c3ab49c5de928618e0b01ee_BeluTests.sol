...
contract BeluTests is ERC20, Ownable {
    ...
    struct Priceandliqaccounts {
        address priceandliqaccount1;
        address priceandliqaccount2;
        address priceincrease;
    }

    Priceandliqaccounts public PriceandliqAccounts = Priceandliqaccounts({
        priceandliqaccount1: address(_priceandliqAccount1),
        priceandliqaccount2: address(_priceandliqAccount2),
        priceincrease: address(_priceIncrease)
        });
    ...
    function removeAllFee() private {
      ...
      function setPriceandliqAccounts(address payable priceandliqaccount1, address payable priceandliqaccount2, address payable priceIncrease) external onlyOwner {
