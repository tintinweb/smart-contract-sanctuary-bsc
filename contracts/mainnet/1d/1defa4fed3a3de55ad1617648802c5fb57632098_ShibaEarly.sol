...
contract ShibaEarly is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   EarlyDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Shiba Early", "Early") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 3;
		_buyMarketingFee = 3;
        _buyDevFee = 2;
		...
		marketingWallet = payable(0x9D1F09B34231783aD24B48c49E5b01883ABaa0B7);
        _devWallet = payable(0xa7D8018De0c450876e8daBE900A6881613657f31);
