...
contract KyotoLaunchpadV1 is Initializable {
    ...
    function addIDO(
        ...
        require(
            ...
            "KyotoLaunchpad: Project token address zero"
        );
     ...
     * @param projectID ID of the Project
     */
    function invest(string calldata projectID, bytes32[] calldata merkleProof, uint256 _amount)
        external
        payable
        onlyValidProject(projectID)
    {
     ...
     * @param projectID ID of the Project
     */
    function refundInvestment(string calldata projectID, bytes32[] calldata merkleProof)
        external
        onlyValidProject(projectID)
    {
        require(
    ...
    function claimIDOTokens(string calldata projectID, bytes32[] calldata merkleProof)
        external
        onlyValidProject(projectID)
    {
        Project memory project = _projects[projectID];
