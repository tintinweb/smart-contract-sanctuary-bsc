...
/**https://t.me/cronix_earn
/**
/**CRONIX launch is inspired to be the next 100X gem to your crypto wallet.

Play to Earn and NFT Utility/
 *
*/ 
...
contract CRONIX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CRONIX";
