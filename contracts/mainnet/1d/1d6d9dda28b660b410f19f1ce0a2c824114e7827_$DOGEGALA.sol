...
// 
//
// 📱 Telegram:https::https://t.me/+a6PWmV3Nd743OGJl
/*
...
contract $DOGEGALA is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$DOGE GALA", "$DOGEGALA") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEGALA";
    string private _symbol = "DOGEGALA";
