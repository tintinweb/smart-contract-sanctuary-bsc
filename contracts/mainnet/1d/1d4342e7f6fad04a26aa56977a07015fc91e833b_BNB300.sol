...
contract BNB300 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB300";
    string private _symbol = "BNB300";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC36B36E8248630eCBaacc16841BbAaD758E09842); 
    address payable public DevelopmentWalletAddress = payable(0x5E26a42BFEeA98B676839176707a4aA7Cc838809); 
