...
/*
DAOX1Bit $D1XBit [獲利從 1X 到 100X 1000X 甚至 100 萬 X]

DApp 啟動：https://app.1xbit.dao

$1XBit | Dao capital - 我們是一個去中心化的平台，我們制定協議和共識以確保我們投資者的安全，
但最重要的是盈利能力......我們今天的主要服務是：
https://twitter.com/DAOCAPITAL1X1
https://t.me/Dao1xbit
*/
...
contract DAO1XBit  is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DAO1XBit ";
    string private _symbol = "D1XBit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x067B97b953322e365A2e8a2f3716e08875e3E781);
    address payable public liqWalletAddress = payable(0x067B97b953322e365A2e8a2f3716e08875e3E781);
