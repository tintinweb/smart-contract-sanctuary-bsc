...
contract CheckBalance is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function setContract(address _tokenContract, address _nftContract)public onlyOwner{
