...
contract BusdyRabbit is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BusdyRabbit";
    string constant _symbol = "BusdyRabbit";
    ...
    uint256 public _maxTxAmount = 23 * (10 ** _decimals);
    uint256 public _walletMax = 23 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x242365A21B3c94da141912363bd0f96fdfb22f98;
        marketingWallet = 0x242365A21B3c94da141912363bd0f96fdfb22f98;
        devWallet = 0x242365A21B3c94da141912363bd0f96fdfb22f98;
