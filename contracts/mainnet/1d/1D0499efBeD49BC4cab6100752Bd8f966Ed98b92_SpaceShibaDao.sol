...
contract SpaceShibaDao is IBEP20, Auth { 
    ...
    string constant _name = "Space Shiba Dao";
    ...
    address public marketingFeeReceiver = 0xA81f3F246CFcCC60b82Fbfec8719151c6A7387Aa;
    ...
    constructor (address _fowner) Auth(_fowner) {
        router = IDEXRouter(routerAddress);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        isFeeExempt[_fowner] = true;
