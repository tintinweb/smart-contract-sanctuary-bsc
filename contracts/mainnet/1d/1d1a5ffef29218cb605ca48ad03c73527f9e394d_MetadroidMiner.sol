...
/**
 *Visit the Ecosystem of MTD
*/

// SPDX-License-Identifier: MIT
pragma solidity 0.8.9;

contract MetadroidMiner {
    using SafeMath for uint256;

    IERC20 public token_MTD;
	address erctoken = 0x096D25018a4900cAA2271B2FF72b752E6b64BdCc; /** mainnet MTD **/
	...
	uint256 public COMPOUND_BONUS_MAX_TIMES = 15; /** 15 times / 15 days. **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 10000000 ether; /** 10000000 MTD **/
    ...
    uint256 public MIN_INVEST = 1000000000 ether; /** 1000000000 MTD  **/
	uint256 public WITHDRAW_COOLDOWN = 12 * 60 * 60; /** 12 hours  **/
    uint256 public WITHDRAW_LIMIT = 100000000 ether; /** 100000000 MTD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000000000 ether; /** 10000000000 MTD  **/
    ...
    function sellEggs() public{
        ...
        token_MTD.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public payable{
        ...
        token_MTD.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                /** referral rewards will be in CMT **/
                ...
                token_MTD.transfer(upline, refRewards);
                /** referral rewards will be in CMT value **/
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_MTD.transfer(project, projectFee);
		token_MTD.transfer(partner1, partnerFee);
		token_MTD.transfer(partner2, partnerFee);
        token_MTD.transfer(buyback, buybackFee);
    ...
    function payFeesSell(uint256 eggValue) internal returns(uint256){
        ...
        token_MTD.transfer(project, prj);
		token_MTD.transfer(marketing, mkt);
        token_MTD.transfer(buyback, bbk);
   ...
   /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
        ...
        if(participants != 0){
            ...
            for(uint256 i = 0; i < participants; i++){
                if((random >= init_range[i]) && (random <= end_range[i])){
                    ...
                    token_MTD.transfer(buyback, back);
    ...
    function getBalance() public view returns (uint256) {
        return token_MTD.balanceOf(address(this));
	}
