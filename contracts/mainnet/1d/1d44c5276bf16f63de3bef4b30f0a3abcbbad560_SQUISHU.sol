...
/**
    TG : https://t.me/squidkishuinu
    WEB : https://squidkishuinu.com/
*/
...
contract SQUISHU is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Squid Kishu Inu";
    string constant _symbol = "SQUISHU";
    ...
    address public marketingFeeReceiver = 0xa9cD79c11d3Bcd6474C708D694FE40838E25A05c;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x9042C9B1e6FAcC019738215a3e1dd6c8cf2a8c2D] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x9042C9B1e6FAcC019738215a3e1dd6c8cf2a8c2D] = true;
