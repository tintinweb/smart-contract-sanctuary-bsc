...
contract BABYCRONOS is Context, IERC20, Ownable {
    ...
    string private _name = "BABY CRONOS";
    string private _symbol = "BABYCRONOS";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x3329392592AF9344A133Cf8dEf67f7C3e3EB4D7F);
    ...
    constructor () {
        ...
        _maxBalance = 10 * 10**9 * 10**_decimals;
