...
/* Token contract */
contract SuperWhale is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xA4b7BFa037dCfA494Afc580c521dE41eB7B5cDEE;
    ...
    // Name and symbol
    string constant _name = "Super Whale";
    string constant _symbol = "Super Whale";
