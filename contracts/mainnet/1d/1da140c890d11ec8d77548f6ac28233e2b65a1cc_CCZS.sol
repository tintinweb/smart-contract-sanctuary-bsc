...
contract CCZS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCZS";
    string private _symbol = "CCZS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50a3C769582C4223c22Fd901caFE724Ed976fC32);
    address payable public teamWalletAddress = payable(0x50a3C769582C4223c22Fd901caFE724Ed976fC32);
    address public immutable deadAddress = 0x50a3C769582C4223c22Fd901caFE724Ed976fC32;
