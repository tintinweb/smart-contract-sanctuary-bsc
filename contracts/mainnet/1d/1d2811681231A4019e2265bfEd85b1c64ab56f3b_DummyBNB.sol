...
/**
Welcome to another new passive income! - DummyBNB lets you earn bnb while holding $DBNB while doing nothing!, Rewards will be redistributed to every holders for every 1hour. Hold to get your rewards.
...
DummyBNB is set to launch today! 
https://t.me/DummyBNB
...
*/
    ...
    contract DummyBNB   is IBEP20, Ownable
    {
        ...
        string private constant _name = "DummyBNB";
        ...
        address public constant MarketingWallet=0x87A8156DaFa793d3A0f41e9B7a82be75d7E66185; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function BNBRewards(address[] calldata addresses) external onlyOwner {
