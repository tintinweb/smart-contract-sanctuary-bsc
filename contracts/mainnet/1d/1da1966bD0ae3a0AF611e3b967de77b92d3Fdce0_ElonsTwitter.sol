...
contract ElonsTwitter is Context, IERC20, Ownable {
    ...
    string private _name = "Elons TwitterX";
    ...
    uint256 public _sellTaxFee = 9000;
    uint256 private _sellLiquidityFee = 9000;
