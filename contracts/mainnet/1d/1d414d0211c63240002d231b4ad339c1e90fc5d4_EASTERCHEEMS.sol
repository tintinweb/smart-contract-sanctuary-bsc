...
contract EASTERCHEEMS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Easter Cheems";
    string private constant _symbol = "ECHEEMS";
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        uint256 marketingAmtMarketing = marketingAmt * 7 / 10;
        uint256 marketingAmtTeam = marketingAmt-marketingAmtMarketing;
        if(marketingAmt > 0){
            payable(marketingWallet).sendValue(marketingAmtMarketing);
            payable(teamWallet).sendValue(marketingAmtTeam);
    ...
    function updateWallet(address newMarketingWallet, address newTeamWallet,address newLiquidityWallet) external onlyOwner{
    ...
    function manualSwap(uint256 amount) external onlyOwner{
        uint256 toSwap = _tTotal * amount / 1000;
