...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0x3B3691d4C3EC75660f203F41adC6296a494404d0);
...
contract Token is IERC20, Ownable {
    ...
    // CHANGE
    address ADA = 0x3B3691d4C3EC75660f203F41adC6296a494404d0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Cat";
    string constant _symbol = "Baby Cat";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 0.5% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 1% MAX 300,000
    ...
    uint256 public swapThreshold = _totalSupply / 100; // 0.05%
    bool inSwap;
