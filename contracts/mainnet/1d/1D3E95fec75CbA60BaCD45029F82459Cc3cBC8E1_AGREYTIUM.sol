...
Telegram https://t.me/AgreytiumNetworkOfficial
website http://agreytium.com
*/
...
/* Token contract */
contract  AGREYTIUM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xffE8669fd6ef71d6aCE980f47cC8Bcbd2Cb058E9;
    ...
    // Name and symbol
    string constant _name = "AGREYTIUM NETWORK";
    string constant _symbol = "AR";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 200000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 200 / 1000; // 3% 
    uint256 private _maxSellTxAmount = _totalSupply * 200 / 1000; // 3% 
    uint256 private _maxWalletToken = ( _totalSupply * 200 ) / 1000; // No max wallet
    ...
    uint256 private totalFeeSell = 16;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xffE8669fd6ef71d6aCE980f47cC8Bcbd2Cb058E9;
