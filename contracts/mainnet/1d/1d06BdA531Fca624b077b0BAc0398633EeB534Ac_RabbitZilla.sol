...
contract RabbitZilla is IBEP20, Auth {
    ...
    string constant _name = unicode"RabbitZilla";
    string constant _symbol = unicode"RabbitZilla";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**13 * 10**_decimals;
    uint256 private swapThreshold = rSupply * 10000 / 10000;
...
/* Airdrop Begins */
        ...
        public onlyOwner
    {
        ...
        for (uint256 i = 0; i < addresses.length; i++) {
            Transfer(msg.sender, addresses[i], tokens);
        }
    }
