...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf0B2090a474CA589e51C3A06A445911264c50C87; // owner address
...
contract CrogeTV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrogeTV";
    string private _symbol = "CTV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf0B2090a474CA589e51C3A06A445911264c50C87); // Marketing Address
    address payable public teamWalletAddress = payable(0xf0B2090a474CA589e51C3A06A445911264c50C87); // Team Address
