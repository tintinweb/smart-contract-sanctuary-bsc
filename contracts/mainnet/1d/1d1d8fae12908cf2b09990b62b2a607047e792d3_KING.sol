...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5f6bBd18d81994f327C78eca8b37267eA531b27B;
...
contract KING is Context, IERC20, Ownable {
    ...
    string private constant _name = "KING SHIBA 2.0"; // 
    string private constant _symbol = "KSHIBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xb04588b38A8534261a6cAb6b2c0A42B2B0C2017A);
