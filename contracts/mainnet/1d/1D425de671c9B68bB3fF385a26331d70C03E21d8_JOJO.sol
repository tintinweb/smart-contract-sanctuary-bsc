...
abstract contract Token is IERC20, Ownable {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (isAddLiquidity(to)) {
                    ...
                    require(false, "just can addLiquidity!");
                }
            }
                if (_swapPairList[to]) {
                    if (!inSwap) {
    ...
    function setProcessTime(uint256 _processBlockNumber) external onlyOwner {
...
contract JOJO is Token {
    constructor()
        Token(
            ...
            18,
            999,
            address(0x361e7A595405886a95CAA53820b8f7AA29780F11), //buyfundaddress
            address(0x43aE7A735d66dF77B07E10ACCec9aF2007C5E9aB), //sellfundaddress
            address(0x118d338a1e1C843fd3ccEf724bCF4cd698f904da) //receiver
        )
    {}
}