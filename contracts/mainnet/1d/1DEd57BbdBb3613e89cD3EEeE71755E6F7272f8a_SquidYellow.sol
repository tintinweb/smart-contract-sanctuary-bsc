...
contract SquidYellow is Context, IERC20, Ownable {
    ...
    string private _name = "SquidYellow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc9c821d3F41b7f447B0C05D28DbDDF49910D2ACe));
        marketWall = payable(address(0xc9c821d3F41b7f447B0C05D28DbDDF49910D2ACe));
