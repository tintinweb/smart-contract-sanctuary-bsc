...
contract JL is ERC20 {
	...
	address payable _receive = payable(address(0xF1CB2A62bBc420E58C5FfA1A2dA2Ed9533A85B09));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("PanJinLian", "JL") {
        ...
        rewardtoken = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
        uint256 total = 10**23;
                ...
                if(buySize >10){
                    for(uint256 i=0;i<10;i++){
                        ...
                        if(balanceOf(user) >= 10**16){
                            ...
                            if(rate>0){
                                rewardtoken.transfer(user,thisAmount.mul(rate).div(10000));
                            }
                        }
