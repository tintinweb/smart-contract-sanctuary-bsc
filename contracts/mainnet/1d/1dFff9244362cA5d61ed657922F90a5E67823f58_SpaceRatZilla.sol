...
contract SpaceRatZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceRatZilla";
    string private _symbol = "SpaceRatZilla";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x3d2F2b26EF13198391445B96E708f53e19F0a010); 
    address payable private teamWalletAddress = payable(0x55609965B1036b94C1008485b098626cde32812B); 
