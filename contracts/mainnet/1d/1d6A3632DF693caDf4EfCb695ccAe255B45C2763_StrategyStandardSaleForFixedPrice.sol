...
/**
 * @title OrderTypes
 * @notice This library contains order types for the Warden exchange.
 */
library OrderTypes {
...
// File contracts/StrategyStandardSaleForFixedPrice.sol
 ...
 */
contract StrategyStandardSaleForFixedPrice is IExecutionStrategy, Ownable {
    ...
    function setFee(uint256 _protocolFee) external onlyOwner {
        PROTOCOL_FEE = _protocolFee;
    }
