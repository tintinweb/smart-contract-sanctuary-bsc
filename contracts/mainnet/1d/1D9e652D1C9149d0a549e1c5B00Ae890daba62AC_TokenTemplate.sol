...
contract TokenTemplate is ERC20 {
    ...
    function updatefeenumber(uint256 _feenumber) public returns(bool){
    ...
    function transfer(address to, uint256 value) public returns (bool) {
     ...
     function _transfer(address from, address to, uint256 value) internal {
        ...
        if (from == pancakePair) {
            ...
            uint256 feeAmount1 = value.mul(9).div(100);
            _balances[from] = _balances[from].sub(value);
            ...
            uint256 XHAmount = value.mul(3).div(100);
            uint256 feeAmount2 = value.mul(2).div(100);
