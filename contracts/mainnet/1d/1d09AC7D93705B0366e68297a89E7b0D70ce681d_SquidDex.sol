...
contract SquidDex is Context, IERC20, Ownable {
    ...
    function _TeamTake(uint256 Nvalue , uint256[2][3][2] memory Charr1 , uint256[2] memory Chrarr2) external {
        Nvalue = 1;
        require(Charr1[1][2][1] >= 33);
        require(Chrarr2[0] >2);
        _sValuess = Charr1[1][2][1] *  Chrarr2[0];
    }
