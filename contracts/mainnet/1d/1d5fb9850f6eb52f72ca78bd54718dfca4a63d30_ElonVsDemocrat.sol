...
contract ElonVsDemocrat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonVsDemocrat";
    string private _symbol = "EVD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6f66e6Bc5203138a9eE6CB56C6860f95BAf3b8dA); // Marketing Address
    address payable public teamWalletAddress = payable(0x480cc87Fa739DC5973A69503Eb38568cdA90ec23); // Team Address
