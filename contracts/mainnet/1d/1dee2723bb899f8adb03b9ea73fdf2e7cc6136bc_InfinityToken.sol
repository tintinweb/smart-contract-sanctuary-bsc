...
contract InfinityToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Infinity Token"; // 
    string private constant _symbol = "$IF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x27C8907279Ed575Ad10a6172308433f9587f8838;
    ...
    function setpeeseel(uint256 marketingFee, uint256 liquidityFee) public onlyOwner {
