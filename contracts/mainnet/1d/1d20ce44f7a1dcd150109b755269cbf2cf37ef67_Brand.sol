...
contract Brand is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x100b1c0cA439361EdDfb80473875673339923E41);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;
    address public uniswapV2Pair;
    address public receiveReward1Token = address(0x100b1c0cA439361EdDfb80473875673339923E41);
    address public fund1Address = address(0x5702a7c87Bdc470Cf3e7DD8a59DDe7fed1d1fff5);
