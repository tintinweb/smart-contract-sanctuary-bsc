...
contract PixelVerse is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Pixel Verse";
    string constant _symbol = "PIXEL";
    ...
    address public marketingFeeReceiver = 0x9cd6f67F910f9EA8ADa7f1A53a7984bDEdAf261f;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x9cd6f67F910f9EA8ADa7f1A53a7984bDEdAf261f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x9cd6f67F910f9EA8ADa7f1A53a7984bDEdAf261f] = true;
