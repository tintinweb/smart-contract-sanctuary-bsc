...
Telegram : https://t.me/superlitecoin
...
contract SuperLitecoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02db194642b4D733E0c78cB1A883c4F7E42c1378); 
    address payable public Wallet_Dev = payable(0x02db194642b4D733E0c78cB1A883c4F7E42c1378);
    ...
    string private constant _name = "Super Litecoin"; 
    string private constant _symbol = unicode"SLTC"; 

    uint256 public _LPS1 = 0;
    ...
    constructor () {
        ...
        _owner = 0x02db194642b4D733E0c78cB1A883c4F7E42c1378;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _BurnTAX1 / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _LPS1 / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_LPS1 + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_LPS1 + Percent_Marketing + Percent_Dev);
