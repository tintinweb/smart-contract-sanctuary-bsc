...
/**
PULICHAIN is a defi-based project that has real utility, being on the BSc network, PULICHAIN has a digital wallet that combines a marketplace platform with a DECENTRALIZED P2P platform based on blockchain technology.

We focus on PULICHAIN Development. With Features Speed   and also good security. With 300,000 Transactions per second & 15 seconds Block
...
contract PULICHAIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x3C7DfBEB0527Ea709616067ea85Ab0573bc8E65a); // Marketing Address

    address payable public devAddress =
        payable(0x3C7DfBEB0527Ea709616067ea85Ab0573bc8E65a); // Buyback Address

    address payable public liquidityAddress =
        payable(0x3C7DfBEB0527Ea709616067ea85Ab0573bc8E65a); // Liquidity Address
    ...
    uint256 private constant _tTotal = 200000000 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "PULI CHAIN";
