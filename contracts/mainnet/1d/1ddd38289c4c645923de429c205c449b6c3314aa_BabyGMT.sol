...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GMT = IBEP20(0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1);
...
contract BabyGMT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Baby Green Metaverse Token";
    string private _symbol = "BGMT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x1Ed05A667E51a18365c1782Ff93a8DB2CC395537; 
