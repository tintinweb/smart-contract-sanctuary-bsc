...
/*
Shiboy $SHIBO
Handsome. Loyal. Mighty
shiboy token is a community-driven gamefi project with zero tax and liquidity lock. 
It will become the first gamefi project in shib chain in the future. 
Players can earn governance tokens by playing games. NFT pricing is linked to governance tokens. 
Using NFT can Earn Governance Tokens Faster
*/
...
contract Shiboy is ContextBep20, Bep20, OwnableBep20 {
