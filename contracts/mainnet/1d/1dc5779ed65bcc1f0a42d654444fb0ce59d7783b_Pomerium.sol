...
// File contracts/extend/ERC20ex.sol
...
// File contracts/token/IGToken.sol
...
// File contracts/token/pomerium.sol
...
contract Pomerium is IGToken, ERC20ex {
    ...
    constructor(uint256 _balance) ERC20ex('Pomerium Utility Token', 'PMR', 18) {
