...
contract Romania is RomaniaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private RomaniaTeam;
    address private CharityRomania;
    ...
    string public override name = "Romania National Fan Token";
    string public override symbol = "Romania National Fan Token";
    ...
    constructor(uint totalSupplyValue, address RomaniaTeamAddress, address CharityRomaniaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        RomaniaTeam = RomaniaTeamAddress;
        CharityRomania = CharityRomaniaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[RomaniaTeam] =  totalSupply * 49 / 1000;
        balances[CharityRomania] = totalSupply * 49 / 1000;
    ...
    // Get the address of the token's RomaniaTeam pot
