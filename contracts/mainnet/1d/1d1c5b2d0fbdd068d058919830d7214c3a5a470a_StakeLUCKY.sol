...
contract StakeLUCKY is Pausable, Ownable, ReentrancyGuard {
    ...
    function claimReward() external returns (bool){
        ...
        lkyToken.transfer(_msgSender(), totalTokens);
    ...
    function stakeToken(uint256 stakeAmount) external payable whenNotPaused {
        ...
        require(lkyToken.balanceOf(_msgSender()) >= stakeAmount, "Insufficient Balance");
        
           lkyToken.transferFrom(_msgSender(), address(this), stakeAmount);
            totalStakers++;
