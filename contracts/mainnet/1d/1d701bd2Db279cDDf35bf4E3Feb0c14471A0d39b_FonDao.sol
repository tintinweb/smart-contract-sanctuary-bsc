...
contract FonDao is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("FY", "FY")  {
        ...
        IBEP20(address(0x55d398326f99059fF775485246999027B3197955)).approve(address(0x10ED43C718714eb63d5aA57B78B54704E256024E), ~uint256(0));
