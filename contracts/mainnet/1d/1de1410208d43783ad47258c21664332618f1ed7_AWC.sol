...
// Telegram : https://t.me/AWChainBSC
...
contract AWC is Context, IERC20, Ownable {
    ...
    string private _name = "ARCADE WARRIOR CHAIN";
    string private _symbol = "AWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x441CAF6C8C970E4fB58EC53f15d5B0F1abA938dD); // Marketing Address
    address payable public teamWalletAddress = payable(0x441CAF6C8C970E4fB58EC53f15d5B0F1abA938dD); // Team Address
