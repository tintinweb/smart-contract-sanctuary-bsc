...
contract BigEggs is IBEP20, Auth {
    ...
    string constant _name = "BigEggs";
    string constant _symbol = "BGGS";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //1% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 3) / 100;  //2% max wallet
