...
contract ClassicSatoshiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "ClassicSatoshiInu"; 
    string private constant _symbol = "$SatoshiInu"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 6;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xC84A89bb7E25102455a4cC0d0D36bbb3EA9895FF;
