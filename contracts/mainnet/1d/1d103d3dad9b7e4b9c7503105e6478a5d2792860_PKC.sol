...
contract PKC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PKC";
    string private _symbol = "PKC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3A9eDdA147f2B043b4B86eCab9071C9D5EF3A057); 
    address payable public teamWalletAddress = payable(0xA3f76badCB11d5B690d16C37020E3F2C140BddF8); 
