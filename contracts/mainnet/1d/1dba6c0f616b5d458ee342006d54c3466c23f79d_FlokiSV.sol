...
contract FlokiSV is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiSV";
    string private _symbol = "$FlokiSV"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB83BCDD2cB5307Cc44A812d147A2024D0d813E50); // Marketing Address
    address payable public teamWalletAddress = payable(0xB61DB45D5B9AFafF4e7E3E6B58dE42eFcBB9c0ca); // Team Address
