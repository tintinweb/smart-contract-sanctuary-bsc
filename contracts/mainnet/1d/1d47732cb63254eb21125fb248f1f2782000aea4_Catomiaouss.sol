...
//     CATOMIAOUSS       CATOMIAOUSS      CATOMIAOUSS        CATOMIAOUSS     CATOMIAOUSS      CATOMIAOUSS   

//     CATOMIAOUSS       CATOMIAOUSS      CATOMIAOUSS         CATOMIAOUSS    CATOMIAOUSS      CATOMIAOUSS   

//     https://t.me/CatomiaoussBSC    
...
contract Catomiaouss is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"CatoMiaouss";
    string private _symbol = unicode"MIAOUSS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x229Ae421c17d4bCB21d7f3Be03cabE2004fdE0bC);
    address payable public teamWalletAddress = payable(0x229Ae421c17d4bCB21d7f3Be03cabE2004fdE0bC);    
    ...
    uint256 private _totalSupply =  2080000000 * 10**_decimals;
    uint256 public _maxTxAmount =   41600000 * 10**_decimals;     
    uint256 public _walletMax =     31200000 * 10**_decimals;      
