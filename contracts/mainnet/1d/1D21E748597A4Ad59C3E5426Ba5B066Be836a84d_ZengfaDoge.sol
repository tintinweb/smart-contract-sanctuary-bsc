...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceDogezilla2.0";
    string private _symbol = "SpaceDogezilla2.0";
    ...
    constructor () {
        ...
        marketingWalletAddress = payable(address(0xA3193731E271dc19265F92a299B8bEf694fF6431));
