...
/*
A fun meme token based on Pochita the Chainsaw Devil from Chainsaw Man.

Taxes: 6/6 after launch duration

TG: https://t.me/PochinuPortal

Website: https://pochinu.monster/
...
contract POCHINU is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'PochInu';
    string private constant _symbol = '$POCH';
    //uints
    uint public constant InitialSupply= 666666666 * 10**_decimals;
    ...
    address private projectWallet=0x38dC6DA411EA519C0394014fFaf4c2f63FF99824;
    address private constant lpReceiver=0xA0802b386dB41CBa891Cba676676EF30dAE36abD;
    address private constant binanceReceiver=0xF977814e90dA44bFA03b6295A0616a897441aceC;
    ...
    constructor () {
        transferOwnership(0xA0802b386dB41CBa891Cba676676EF30dAE36abD);
        uint binanceBalance= InitialSupply*35/100;
        uint deployerBalance= InitialSupply-binanceBalance;
        _balances[binanceReceiver] = binanceBalance;
        _balances[owner()] = deployerBalance;
        emit Transfer(address(0), binanceReceiver, binanceBalance);
        ...
        excludedFromLimits[binanceReceiver] = true;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=8 minutes;
    ...
    function getCirculatingSupply() public view returns(uint){
        return InitialSupply-_balances[address(0xdead)]-_balances[binanceReceiver];
    }
