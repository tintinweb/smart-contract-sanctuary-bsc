...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcc9744630De13bA0d6A5A0515eAa83e962bcFf7d;
...
contract NeoCityPeople is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xee7FC94d2Ef1DE50061d298068cA80c730c1B890;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NeoCityPeople";
    string private _symbol = "NCP";
