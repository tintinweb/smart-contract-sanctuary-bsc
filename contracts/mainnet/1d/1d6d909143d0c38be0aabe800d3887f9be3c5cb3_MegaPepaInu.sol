...
contract MegaPepaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MegaPepaInu";
    string private _symbol = "MPI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x830e0209894039949429F061458de279B8eD0ce4); // Marketing Address
    address payable public teamWalletAddress = payable(0x830e0209894039949429F061458de279B8eD0ce4); // Team Address
    ...
    uint256 public _marketingShare = 54;
