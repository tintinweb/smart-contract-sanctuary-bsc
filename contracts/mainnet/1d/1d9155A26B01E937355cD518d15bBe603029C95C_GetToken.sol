...
contract Context {
 ...
 contract GetToken is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "GetToken";
    string private _symbol = "GT";
    address private constant _pancakeRouterAddress = 0xEEE22681411489A7Cb302C6F057981B7F4C78E91; // Pancakeswap Router V2
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 9000000000000000000;
    uint256 private fee = 99; // ADDED TO THE LP
    ...
    address private _pancakeRouterV2 = 0xEEE22681411489A7Cb302C6F057981B7F4C78E91;
