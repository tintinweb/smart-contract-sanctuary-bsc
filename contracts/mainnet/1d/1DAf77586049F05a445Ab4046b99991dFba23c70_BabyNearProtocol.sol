...
B A B Y  N E A R  P R O T O C O L

Baby Near Protocol is the hottest baby in the crypto space
that rewards you the hottest token by holding,
which is NEAR! 

Website: https://www.babynearbsc.com/
Telegram: https://t.me/babynearofficial
Twitter: https://twitter.com/babynearbsc

Together lets support NEAR's rise!
...
contract BabyNearProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "BabyNearProtocol";
    string private _symbol = "BNEAR";
