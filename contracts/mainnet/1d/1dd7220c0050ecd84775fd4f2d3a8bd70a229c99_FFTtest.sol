...
contract FFTtest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FFT Test";
    string private _symbol = "FFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x096253777A80392F992d219bf125F8830F3eDEE2); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xC4aD2F6B4d97D60930c0ede22e6396deEF0827CB); // Development Address
