...
contract EldenRing is Context, IERC20, Ownable {
    ...
    string private _name = "Elden Ring";
    string private _symbol = "FROMSF";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3B2F16b46350Fa0F5Ee5d17E70DcC89341947395));
        marketingWalletAddress = payable(address(0x4e871993B6Aa40eef3a97b9240D19F394cC9F01B));
