...
contract DOR is IBEP20, Auth {
    ...
    string constant _name = "DOR2.0";
    string constant _symbol = "DOR2.0";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1888 * 10**_decimals;

    uint256 public _maxTxAmount = 1888 * 10**_decimals;
    uint256 public _maxWalletToken = 1888 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1d1731dA67ED54E2aD614345a7595945adF115d1;
