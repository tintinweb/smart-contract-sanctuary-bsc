...
contract TwitterBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TwitterBurnDividendTracker public dividendTracker;
    ...
    constructor() ERC20("TwitterBurn", "TWIT") {
        marketingWallet = payable(0x0b0c79eC1c662764dd9250Ac9acD7BA2eb023ae7);
        devWallet = payable(0xA0d2910Bc57cf96248A665079aAEd23a27Cb6A01);
        ...
        dividendTracker = new TwitterBurnDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (69_420_101) * (10**18);
...
contract TwitterBurnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TwitterBurn public TwitterBurnContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TwitterBurnContract = TwitterBurn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TwitterBurn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TwitterBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TwitterBurn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TwitterBurnContract);

            uint256 prevBalance = TwitterBurnContract.balanceOf(address(this));
            ...
            {
                uint256 received = TwitterBurnContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TwitterBurnContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
