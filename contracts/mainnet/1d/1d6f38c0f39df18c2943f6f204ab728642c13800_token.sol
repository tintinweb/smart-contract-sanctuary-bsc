...
contract token is ERC20 {
    ...
    address _tokenOwner;
    uint256 public intervalTime = 11 minutes;
    ...
    //name,symbol
    string internal tokenName = "Ossendein";
    string internal tokenSymbol = "OSS";
    uint256 constant total  =  100 * 10**8 * 10**18;

    //mainnet
    address public swapRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    IERC20 public RewardToken = IERC20(0x55d398326f99059fF775485246999027B3197955); //replace with your token here
    address public pairToken = address(0x55d398326f99059fF775485246999027B3197955); //replace with your token here
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        transReward(address(pool),abi.encodeWithSignature("getReward()"));
    }
