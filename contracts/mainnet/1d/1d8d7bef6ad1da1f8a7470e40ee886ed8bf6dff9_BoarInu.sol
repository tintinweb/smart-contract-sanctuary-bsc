...
contract BoarInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BoarInu";
    string private _symbol = "$BOAR";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6DB0D4884f3390C40Fd65bB04c6260FB5af8D34d));
        marketingWalletAddress = payable(address(0x6DB0D4884f3390C40Fd65bB04c6260FB5af8D34d));
