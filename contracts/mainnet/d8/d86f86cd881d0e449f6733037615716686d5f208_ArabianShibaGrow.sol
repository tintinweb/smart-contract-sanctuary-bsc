...
contract ArabianShibaGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x87094f83E05811887cB2bD731d6c1E1416A94AF8); 

    address payable public Dev_Wallet = payable(0x80341c36E6304939f0427bF173baeEa31C52Ab59);
    ...
    string private constant _name = "ArabianShiba Grow"; 

    string private constant _symbol = unicode"ASGrow"; 
    ...
    constructor () {
        ...
        _owner = 0x87094f83E05811887cB2bD731d6c1E1416A94AF8; //DEV
