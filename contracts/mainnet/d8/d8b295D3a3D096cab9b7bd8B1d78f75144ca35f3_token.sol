...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "NO.1";
    string private _symbol = "NO.1";
    uint8 private  _decimals = 18;
    address private immutable _owner;
    address payable public marketingWalletAddress = payable(0xe4DCb715b15c2Af7B8E87A1F42d0CCe6199af205); 
    ...
    uint256 private minimumTokensBeforeSwap =2*10**14 ; 

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapPair;
    uint256 public _maxTxAmount = 1*10**15;
