...
contract FortuneumGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fortuneum Grow";
    string private _symbol = "FORTUNEGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbD7FABC9eE3dbc275d13479997bD61994c5D8CE5); // Marketing Address
    address payable public teamWalletAddress = payable(0xbD7FABC9eE3dbc275d13479997bD61994c5D8CE5); // Team Address
