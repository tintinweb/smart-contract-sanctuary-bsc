...
contract ShibantoryuInu is Context, IERC20, Ownable {
    ...
    uint256 private maxTxAmount = 2_000_000 * (10**_decimals);
    uint256 private maxWallet =  2_000_000 * (10**_decimals);
    uint256 private _swapThreshold = 5 * (10**_decimals); 

    string private constant _name = "Shibantoryu Inu"; 
    ...
    address public treasuryWallet = 0x14fEFCe65b8Ed03E23aD4F7e335C4C1855487E6e;
