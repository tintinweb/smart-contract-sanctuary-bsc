...
contract SASAKI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SASAKI", "SASA") {
        
        address newOwner = address(0x7adfFd64bAc041BB02E2Cde515dad55E7580E0eD);
    	...
    	marketingWallet = address(0x2E9c89378501F19d9eBc0F2C5e2d7Cc0D927Ce64); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x7adfFd64bAc041BB02E2Cde515dad55E7580E0eD),
            block.timestamp
        );
