...
contract RATCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**0;
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**0;
    uint256 private numTokensSellToAddToLiquidity = 30000000000000 * 10**0;
