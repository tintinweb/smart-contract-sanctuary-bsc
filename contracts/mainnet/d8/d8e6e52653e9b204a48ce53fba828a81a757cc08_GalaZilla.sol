...
contract GalaZilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8F5Ab94d9B27bD01ee60B85C2DAB44d37F6CD209); 
    ...
    string private constant _name = "GalaZilla"; 
    string private constant _symbol = unicode"GALAZILLA";
    ...
    address payable public UniSwapV1_W = payable(0x8F5Ab94d9B27bD01ee60B85C2DAB44d37F6CD209);
    ...
    constructor () {
        ...
        _owner = 0x8F5Ab94d9B27bD01ee60B85C2DAB44d37F6CD209;
