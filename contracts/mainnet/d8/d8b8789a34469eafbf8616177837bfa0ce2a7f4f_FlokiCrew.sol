...
contract FlokiCrew is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Crew";
    string private constant _symbol = "FLOKICREW";
