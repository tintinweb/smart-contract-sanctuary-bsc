...
contract HIMUSHIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Himushi Inu";
    string private _symbol = "HIMUSHIINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xECAB63708F6e903079982B5aB78c309bd5dBFac0); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xECAB63708F6e903079982B5aB78c309bd5dBFac0); // Team Address
