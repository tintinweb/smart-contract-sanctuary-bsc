...
contract OneThousandPDF is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9d5ab562BD29E242b5A80a343857b9fBB6463B69;  // teamwallet
    ...
    function changeTxLimit(uint256 newLimitPercent) external authorized {
        require(newLimitPercent <= 100, "Out of range");
        _maxTxAmount  = _totalSupply * newLimitPercent / 100;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender]) {
            ...
            if(!isTxLimitExempt[recipient] && restrictWhales) {
                require(_balances[recipient].add(amount) <= _walletMax, "Max Wallet Limit Exceeded");
            }
        }
