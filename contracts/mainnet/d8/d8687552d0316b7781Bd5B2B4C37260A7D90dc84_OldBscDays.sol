...
contract OldBscDays is Context, IERC20, Ownable {
    ...
    string private constant _name = "Old Bsc Days";
    ...
    uint256 public _maxWalletAmount = 20700000000000 * 10**_decimals;
