...
contract AITECHToken is AITECHBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private AITECHBSC;
    address private AITECHCoin;
    address private AITECHs;
    ...
    string public override name = "AI Utility Token";
    string public override symbol = "AITECH";
    ...
    constructor(uint totalSupplyValue, address AITECHBSCAddress, address AITECHCoinAddress, address AITECHsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        AITECHBSC = AITECHBSCAddress;
        AITECHCoin = AITECHCoinAddress;
        AITECHs = AITECHsAddress;
        balances[AITECHBSC] =  totalSupply * 4 / 100;
        balances[AITECHCoin] = totalSupply * 4 / 100;
        balances[AITECHs] = totalSupply * 4 / 100;
        // split the tokens according to agreed upon percentages        
        balances[owner] = totalSupply * 88 / 100;
    }
