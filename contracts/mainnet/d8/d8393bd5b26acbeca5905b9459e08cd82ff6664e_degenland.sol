...
contract degenland is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Degen Land";
    string private _symbol = "DEGENLAND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9926c13759AEA3eEe5f4edDB0F39281CE6B1FaA4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9926c13759AEA3eEe5f4edDB0F39281CE6B1FaA4); // BuyBack Address
