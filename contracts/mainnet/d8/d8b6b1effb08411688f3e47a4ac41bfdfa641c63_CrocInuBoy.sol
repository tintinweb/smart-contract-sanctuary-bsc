...
contract CrocInuBoy is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0xcE17f8bCC9a5dD5C9964F57a4092c8512e8e922A);
    address payable public Wallet_Dev = payable(0xcE17f8bCC9a5dD5C9964F57a4092c8512e8e922A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);
    address payable public constant Lp_Reciever = payable(0xcE17f8bCC9a5dD5C9964F57a4092c8512e8e922A);
    ...
    constructor () {
        ...
        _owner = 0xcE17f8bCC9a5dD5C9964F57a4092c8512e8e922A;
