...
Website : https://www.usagitokenbsc.com/
...
contract UsagiToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02c118D41744540Cd757d6A712aCBc6B4D7cdC0a); 
    address payable public Wallet_Dev = payable(0x02c118D41744540Cd757d6A712aCBc6B4D7cdC0a);
    ...
    string private constant _name = "USAGI TOKEN V2"; 
