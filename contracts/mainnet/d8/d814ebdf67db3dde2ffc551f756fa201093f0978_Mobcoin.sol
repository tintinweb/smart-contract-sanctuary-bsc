...
// TG : https://t.me/MOBCoinOfficial
// Website: https://mobcoin.vip/
...
contract Mobcoin is IBEP20, Ownable {
    ...
    string constant _name = "Mobcoin";
    string constant _symbol = "$MOB";
    ...
    address public marketingFeeReceiver = 0xF9a8dFF88c40d53F58e526CB3F616053Dc4bBA66;
    address public donateFeeReceiver = 0xb7EbAde7F9E8e80458A95799650Ac75D33bA776c;
    address public LiquidityFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdev = amountBNB.mul(donateFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool devSuccess, /* bytes memory data */) = payable(donateFeeReceiver).call{value: amountBNBdev, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _donateFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        donateFee = _donateFee;
        totalFee = _liquidityFee.add(_marketingFee).add(_donateFee);
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _donateFeeReceiver) external onlyOwner {
    ...
    function manualSend() external {
        ...
        payable(LiquidityFeeReceiver).transfer(contractETHBalance);
    }

    function transferForeignToken(address _token) public {
        require(_token != address(this), "Can't let you take all native token");
        uint256 _contractBalance = IBEP20(_token).balanceOf(address(this));
        payable(LiquidityFeeReceiver).transfer(_contractBalance);
    }
