...
contract ERC20Token is ERC20, Pausable, Ownable {
    ...
    constructor() ERC20("ULLA", "ULLA") {
        _mint(msg.sender, 2100000 * 10 ** decimals());
        whiteListOf[0xb79530cE8aA38164EA7DFb4f553E8a5f996373fd] = true;
        whiteListOf[0x5f2e66A1D96D8f878E31390bd06FCa1CEc7e548c] = true;
        whiteListOf[0x5636475870b19530d70Cd3693aCa18D149CAA866] = true;
    }
    ...
    function addWhiteList(address _account, bool _bool) public onlyOwner {
    ...
    function _charge(address from, address to, uint256 amount) private{
        ...
        if((!_isContract(from) && _isContract(to)) && !whiteListOf[from] && !whiteListOf[to]){
            // 5% 的手续费打入项目方地址
            super._transfer(from, address(0xb9a468967795491487B1eF2ee722b69ecB38820a), amount * 3 / 100);
            super._transfer(from, address(0x1eBD02Ec2a29cf8d33b4CbBE0ab6cc6C619bE442), amount * 1 / 100);
