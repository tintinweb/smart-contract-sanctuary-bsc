...
abstract contract daoToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 21 * 10 ** Decimals;
        maxWalletAmount = 21 * 10 ** Decimals;
        thA = msg.sender;
        _tTotal = total;
...
contract oskdao is daoToken {
    constructor() daoToken (
        ...
        18,    
        5000,    
        address(0x34b1fc100Ef88c116cFfc46C3f2F2fBc7E672F4a),
        address(0x24eAc9c65C06dC01537e0185bE482896017Cc3bb),    
        address(0x43317693da141FbfA39916e8866064e558ff4e4B)
    ){
