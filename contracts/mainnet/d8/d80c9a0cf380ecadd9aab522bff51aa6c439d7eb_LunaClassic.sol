...
contract LunaClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "LunaClassic";
    ...
    constructor () {
        _MarketingWallet = payable(0x343Fa80C39144aF4D55f8A953D286Aad1FCD9E24);
        _liquidityWallet = payable(0x343Fa80C39144aF4D55f8A953D286Aad1FCD9E24);
        _rewardWallet = payable(0x343Fa80C39144aF4D55f8A953D286Aad1FCD9E24);
        ...
        emit Transfer(address(0x343Fa80C39144aF4D55f8A953D286Aad1FCD9E24), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxSellAmount = 30000000000 * 10**9;
        _maxWalletAmount = 30000000000 * 10**9;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        ...
        require(newAmount <= 10000000000 * 10**9, "Swap amount cannot be higher than 1.0% total supply.");
