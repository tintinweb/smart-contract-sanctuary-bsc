...
// CHANGE
contract KanyeInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Mc Truck";
    string constant _symbol = "Mc Truck";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 0.5% MAX 100,000
    ...
    uint256 devFee = 4; // 
    uint256 totalFee = 5; // liquidityFee + reflectionFee + devFee
