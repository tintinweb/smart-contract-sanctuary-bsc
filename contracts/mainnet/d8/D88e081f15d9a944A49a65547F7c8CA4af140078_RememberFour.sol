...
contract RememberFour is Context, IERC20, Ownable {
    ...
    string private constant _name = "Remember 4";
    string private constant _symbol = "$R4";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 4444 * 10**_decimals;
    uint256 public _maxTxAmount = 133 * 10**_decimals;
    uint256 public _maxWalletAmount = 133 * 10**_decimals;
