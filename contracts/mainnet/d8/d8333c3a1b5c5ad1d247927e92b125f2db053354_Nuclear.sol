...
contract Nuclear is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "Nuclear";
    string private constant TOKEN_SYMBOL = "NUCLEAR";
    ...
    uint256 constant public MAX_TAX = 4000;
    ...
    address payable private _marketingWallet = payable(0x0234647220950D350F7e263A8C2E470B8c7c0850);
    
    bool private inSwapAndLiquify;
    bool public swapAndLiquifyEnabled;
    
    uint256 private buyMaxTxPercent = 2;
    uint256 private buyMaxTxDivisor = 1000;
    uint256 public _buyMaxTxAmount = (_tTotal * buyMaxTxPercent) / buyMaxTxDivisor;
    ...
    uint256 private sellMaxTxPercent = 2;
    uint256 private sellMaxTxDivisor = 1000;
    uint256 public _sellMaxTxAmount = (_tTotal * sellMaxTxPercent) / sellMaxTxDivisor;
    ...
    uint256 public swapAmount = (_tTotal * 10) / 2000;
...
//===============================================================================================================
    ...
    function setMaxTxPercents(uint256 buyPercent, uint256 buyDivisor, uint256 sellPercent, uint256 sellDivisor) external onlyOwner() {
        ...
        require(_sellMaxTxAmount >= (_tTotal / 10000) 
                ...
                "Max Transaction amts must be above 0.01% of total supply."
                );
    }

    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        uint256 check = (_tTotal * percent) / divisor;
        require(check >= (_tTotal / 10000), "Max Wallet amt must be above 0.01% of total supply.");
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if(to == lpPair) {
                ...
                require(buy_AllowedTime[to] < block.timestamp, "Anti-bots enabled: The waiting period is 30 seconds");
                buy_AllowedTime[to] = block.timestamp + (30 seconds);
            }
    ...
    function switchTrading(bool truefalse) external onlyOwner() {
    ...
    function setUniswapRouter(address otherRouterAddress) external onlyOwner {
        dexRouter = IUniswapV2Router02(otherRouterAddress);
    }
