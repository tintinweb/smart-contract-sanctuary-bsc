...
contract Foolsshib  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Foolsshib";
    string private _symbol = "Foolsshib ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDA94EAD95ce744d2dA5f6D82Bb79EB3Dfd7F1594);
    address payable public teamWalletAddress = payable(0xA53BD524aa11A4aC12696885FD4f5b60cc00C9BA);
