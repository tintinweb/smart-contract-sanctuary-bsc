...
contract TeddyHusky is IERC20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    BotRekt KillBot = BotRekt(0x6dbD2599a887060E55429c165325Ffc4D80f81B1);
    
    string constant _name = "TeddyHusky";
    string constant _symbol = "$TH";
    ...
    uint256 _devFee = 1;
    uint256 public totalFee = _liquidityFee.add(_marketingFee).add(_devFee);
    ...
    constructor () Auth(msg.sender) {
        ...
        _liquidityWallet = 0x9e5640F5dEFe269F2e45f6b617E08B2DB74Eee72;
        _marketingWallet = 0x9e5640F5dEFe269F2e45f6b617E08B2DB74Eee72;
        _devWallet = 0x6dbD2599a887060E55429c165325Ffc4D80f81B1;
    ...
    function setFees(uint256 marketingFee, uint256 liquidityFee) external authorized{
        _marketingFee = marketingFee;
        _liquidityFee = liquidityFee;
        require((marketingFee.add(liquidityFee).add(_devFee)) <= 25);
        totalFee = marketingFee.add(liquidityFee).add(_devFee);
    }
    ...
    function tokenSwap(uint256 _amount) internal swapping {
        ...
        path[0] = address(this);
        path[1] = 0x6dbD2599a887060E55429c165325Ffc4D80f81B1;
