...
contract BabySocialOfRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Social Of Rabbit";
    string private constant _symbol = "BabySocialRabbit";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 6000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 180000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 180000000 * 10**_decimals;
