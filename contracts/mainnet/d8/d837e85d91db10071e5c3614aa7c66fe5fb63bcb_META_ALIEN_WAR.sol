 ...
 */
contract META_ALIEN_WAR {
    using SafeMath for uint256;
    using RoundPool for RoundPool.RoundBalances;

    uint256 private _totalSupply = 1000000000 ether;
    string private _name = "META ALIEN WAR";
    string private _symbol = "MAWT";
    uint8 private _decimals = 18;
    address private _owner;
    uint256 private _cap = 0;
    uint256 private _BURN_FEE = 200; //2%
    ...
    uint256 private _saleMin = 0.003 ether;
    ...
    uint256 private _airdropEth =   3000000000000000;//.003
    uint256 private _airdropToken = 50000000000000000000000;//50000
