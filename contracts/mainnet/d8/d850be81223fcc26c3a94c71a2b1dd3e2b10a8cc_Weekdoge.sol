...
contract Weekdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC60ae9de0Ce8123D0B962301373C50E6901b4C65); // Marketing Address
    ...
    uint256 private _tTotal = 100000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Weekdoge";
    string private _symbol = "Weekdoge";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**2 * 10**9;
