...
contract JEETTEST is IBEP20, Auth {
    ...
    string constant _name = "JEET TEST";
    ...
    address public marketingFeeReceiver = 0x8C7b4aF8F9b67217019A7F24b3f6133fec2083Be;
    address public devFeeReceiver = 0x8C7b4aF8F9b67217019A7F24b3f6133fec2083Be;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 10 >= block.number){ return feeDenominator.sub(1); }
