...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35D27BE64C4B05921aD5a8F38d805467c18E65ba;
...
contract KaishuoInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x35D27BE64C4B05921aD5a8F38d805467c18E65ba;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KaishuoInu";
    string private _symbol = "KAISHUO";
