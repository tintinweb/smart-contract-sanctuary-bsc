...
contract AnkrRewardBearingStakedBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ankr Reward Bearing Staked BNB";
    string private constant _symbol = "aBNBc";

    address public _PancakeSwapV1RouterUniswap = 0x880aEb94a7B79C9Af145D519bD8c205ed5cf6b8B; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x880aEb94a7B79C9Af145D519bD8c205ed5cf6b8B; //can be the same
