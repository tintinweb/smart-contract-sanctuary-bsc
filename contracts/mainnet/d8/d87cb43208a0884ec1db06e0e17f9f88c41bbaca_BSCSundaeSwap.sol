...
/**
Just Hold and get your 3% Cardano reward
...
contract BSCSundaeSwap is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BSCSundaeSwap";
    string constant _symbol = "SundaeSwap";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(50).div(100); //Max tx one time is 50%
    uint256 public _maxWalletHold = 5000000000;
