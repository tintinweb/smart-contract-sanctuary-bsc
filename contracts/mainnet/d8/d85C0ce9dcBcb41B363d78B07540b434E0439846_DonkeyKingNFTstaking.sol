...
contract DonkeyKingNFTstaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN.approve(address(this), 3246154172800000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
