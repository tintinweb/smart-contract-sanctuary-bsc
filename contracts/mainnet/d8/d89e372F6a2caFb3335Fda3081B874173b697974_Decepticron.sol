...
contract Decepticron is IBEP20, Auth {
    ...
    string constant private _name = "DeceptiCron";
    string constant private _symbol = "DCRON";
    ...
    address public _sellFeeReceiver = 0x00846E4a5dA5840bf236BD1B8F362BDc5810c529;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _FeeLiquidity, uint256 _devFee, uint256 _feeDenominator) external authorized {
        FeeLiquidity = _FeeLiquidity;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _FeeLiquidity.add(__sellFee).add(_devFee);
