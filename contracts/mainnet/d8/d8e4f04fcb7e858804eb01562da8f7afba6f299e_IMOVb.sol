...
contract IMOVb is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 30_000_000 * 10**18;
    ...
    Taxes public taxes = Taxes(4,1,3);
    ...
    constructor(address _marketingWallet, address _devWallet) ERC20("IMOV Burn", "IMTb") {
    ...
    function manualSwapAndSend(uint256 amount, uint256 devPercentage, uint256 marketingPercentage) external onlyOwner{
