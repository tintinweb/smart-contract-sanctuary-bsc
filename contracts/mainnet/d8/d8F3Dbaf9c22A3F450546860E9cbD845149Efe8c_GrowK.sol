...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60373e00f1dF2C6fE83DE7Bd332711bDbE55B60f;
...
contract GrowK is Context, IERC20, Ownable {
    ...
    string private constant _name = "GrowK"; // 
    string private constant _symbol = "GrowK"; //    
