...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78bEa23ce7cfD043028dAd04020F59430265Ad94; // owner address
...
contract GreenChart is Context, IERC20, Ownable {
    ...
    string private _name = "GreenChart";
    string private _symbol = "GREENCHART";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78bEa23ce7cfD043028dAd04020F59430265Ad94); // Marketing Address
    address payable public teamWalletAddress = payable(0x78bEa23ce7cfD043028dAd04020F59430265Ad94); // Team Address
