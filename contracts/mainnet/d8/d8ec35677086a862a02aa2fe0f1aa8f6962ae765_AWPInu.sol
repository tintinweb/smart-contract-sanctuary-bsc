...
/**
   #AWP Inu The New Community of Ape Token
    
   I make this #AWP Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: AWP Inu is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract AWPInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "AWP Inu";
