...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF4F4dc82Bdbd9E80AAC414c4D623da4ba84C77Ba; // owner address
...
contract Shigarakiinu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3dC0DD3eC480d7b7028ed0a90D877411E26f57E4); // Marketing Address
    address payable public buybackWalletAddress = payable(0x3dC0DD3eC480d7b7028ed0a90D877411E26f57E4); // Buyback Address
