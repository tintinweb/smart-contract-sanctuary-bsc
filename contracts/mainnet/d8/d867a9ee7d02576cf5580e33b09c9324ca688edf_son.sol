...
// File: @openzeppelin/contracts/utils/Address.s
...
contract ERC20 is Context, Pausable,IERC20 {
...
contract son is ERC20Capped, Ownable {
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "FoneFanClub: minting is finished");
        _;
    }
