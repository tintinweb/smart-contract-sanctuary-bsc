...
contract Aphrodyte is BEP20, Ownable {
    ...
    address public OpsWallet = 0xeb6E5b1d0B8b5583EC35a8757Be972e86B389d8D;
    address public TreasuryWallet =  0x7557CDc373788Ee56274D9131b46b427c104Eee1;
    ...
    constructor() BEP20("Aphrodyte", "Aphro") {
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.treasury + sellTaxes.ops;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = buyTaxes.liquidity + buyTaxes.treasury + buyTaxes.ops;
            feesum = feeswap;
    ...
    function SetBuyTaxes(uint256 _marketing, uint256 _liquidity, uint256 _development) external onlyOwner {
        ...
        require((_marketing + _liquidity + _development) <= 12,"Must keep fees at 12% or less");
    }
