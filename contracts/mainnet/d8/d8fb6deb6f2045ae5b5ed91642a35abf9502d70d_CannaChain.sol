...
// CannaChain is the world’s first blockchain engine for cannabis, intended to solve the industry’s problems.

// Website: https://cannachain.cc
// Twitter: https://twitter.com/cannachaincc
// Telegram: https://t.me/cannachainportal
// Docs: https://docs.cannachain.cc
...
contract CannaChain is ERC20, Ownable {
    ...
    address public cannaFundAddress;
    ...
    uint256 public sellCannaFundFee;

    uint256 public tokensForMarketing;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTeam;
    uint256 public tokensForBuyBack;
    uint256 public tokensForCannaFund;
    ...
    event UpdatedCannaFundAddress(address indexed newWallet);
    ...
    constructor() ERC20(block.chainid == 56 ? "CannaChain" : "CTEST", block.chainid == 56 ? "CNC" : "CTEST") {
        ...
        sellTeamFee = 200;
        sellBuyBackFee = 200;
        sellCannaFundFee = 200;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellTeamFee + sellBuyBackFee + sellCannaFundFee;
        ...
        //@dev update these!
        marketingAddress = address(0x7c537E135A5B5E3d0E61C30118683f2F800443f3);
        teamAddress = address(0xbb85369a2a045B08E94A7210E0196762A3eFcd25);
        cannaFundAddress = address(0x9A3aA4760F036c9cacdefe89909f72FdcAb23a34);
        buyBackAddress = address(0x0FF26f4EF1C999094572EE615700a5EB60C1B39F);
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _teamFee, uint256 _buyBackFee, uint256 _cannaFundFee) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellTeamFee = _teamFee;
        sellBuyBackFee = _buyBackFee;
        sellCannaFundFee = _cannaFundFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellTeamFee + sellBuyBackFee + sellCannaFundFee;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
            ...
            tokensForCannaFund += fees * sellCannaFundFee / sellTotalFees;
        }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForTeam + tokensForMarketing + tokensForLiquidity + tokensForBuyBack + tokensForCannaFund;
        ...
        uint256 ethForCannaFund = ethBalance * tokensForCannaFund / totalTokensToSwap;

        tokensForTeam = 0;
        tokensForMarketing = 0;
        tokensForLiquidity = 0;
        tokensForBuyBack = 0;
        tokensForCannaFund = 0;
        ...
        if(ethForCannaFund > 0){
            (success, ) = cannaFundAddress.call{value: ethForCannaFund}("");
        }
    ...
    function setCannaFundAddress(address _address) external onlyOwner {
        require(_address != address(0), "address cannot be 0");
        cannaFundAddress = payable(_address);
        emit UpdatedCannaFundAddress(_address);
    }
