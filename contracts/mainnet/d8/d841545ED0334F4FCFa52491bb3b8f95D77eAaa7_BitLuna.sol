...
library Address{
 ...
 contract BitLuna is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_000_000 * 10*6;
    uint256 public maxBuyLimit = 25_000_000 * 10**6;
    uint256 public maxSellLimit = 25_000_000 * 10**6;
    uint256 public maxWalletLimit = 25_000_000 * 10**6;
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0xAa86D5344Ef2Aa80C786A10e233fD1a2A90873B0;
    address private donationWallet = 0xAa86D5344Ef2Aa80C786A10e233fD1a2A90873B0;
    address private buybackWallet = 0xAa86D5344Ef2Aa80C786A10e233fD1a2A90873B0;

    string private constant _name = "Bit-Luna 0.5";
    string private constant _symbol = "BitLuna Half";
    ...
    Taxes private taxes = Taxes(0, 5, 1, 0, 0);
    Taxes private sellTaxes = Taxes(0, 5, 1, 0, 0);
