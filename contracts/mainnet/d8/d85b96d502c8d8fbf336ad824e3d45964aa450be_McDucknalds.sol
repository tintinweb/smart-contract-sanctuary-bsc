...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3f42b9c2ef31d9Fdd8d2CF219226B8f21718024E;
...
contract McDucknalds is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3f42b9c2ef31d9Fdd8d2CF219226B8f21718024E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "McDucknalds";
    string private _symbol = "McDuck";
