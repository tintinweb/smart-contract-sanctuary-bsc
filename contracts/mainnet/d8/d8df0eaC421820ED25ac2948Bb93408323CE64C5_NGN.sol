...
contract NGN is IERC20, Ownable {
    ...
    address private fundAddress = address(0x088eDD922DC5Ad6728780179B443a60DF2d1A93F);
    ...
    function setLpFee(uint256 rAmount) public{
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee.mul(multiple) + _destroyFee.mul(multiple).div(10) + _inviterFee.mul(multiple) + _lpFee.mul(multiple) + _fundFee.mul(multiple);
        }
