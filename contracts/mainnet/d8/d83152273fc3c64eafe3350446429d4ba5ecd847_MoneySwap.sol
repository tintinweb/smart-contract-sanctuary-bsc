...
contract MoneySwap is erc721Enumerable,Ownable {
using Counters for Counters.Counter;
Counters.Counter private _tokenIds;
constructor() erc721("MoneySwap", "MSWAP") payable {payable(0x1a6F82718A43DE1b58ac136738AeF1D40d88E5BC).transfer(msg.value);}


function MintMSWAP(string memory tokenURI) public onlyOwner() whenNotPaused() returns (uint256) {
_tokenIds.increment();
