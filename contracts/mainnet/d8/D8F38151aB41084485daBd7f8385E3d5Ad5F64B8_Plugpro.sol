...
contract Plugpro is IBEP20, Auth {
    ...
    string constant private _name = "PlugPRO";
    string constant private _symbol = "PLUGPRO";
    ...
    address public _sellFeeReceiver = 0xBbA28819f66907f5417337eBBBDcD76f3CC1389D;
    address public devFeeReceiver = 0x3d06a5763FE023Fa644777EA04FF40691Ea15f42;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _liq_fee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        liq_fee = _liq_fee;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _liq_fee.add(__sellFee).add(_devFee);
