...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0701dA5D465bE4c7123431004D2Fc995892e3304; // runner
...
contract runner is Context, IERC20, Ownable {
    ...
    string private _name = "runner";
    string private _symbol = "IT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0701dA5D465bE4c7123431004D2Fc995892e3304); // runner Marketing
    address payable public earnWalletAddress = payable(0x4a6c5c39aE0e88e969Fa55192e9d1662BEDeeA73); // runner Earning Pool
