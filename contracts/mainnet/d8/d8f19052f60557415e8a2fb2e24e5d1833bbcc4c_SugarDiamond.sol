...
contract SugarDiamond is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SugarDiamond";
    string private _symbol = "SSSGR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3EE485d5c29f2675e1C5fbF976d664884b511Bdf); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3EE485d5c29f2675e1C5fbF976d664884b511Bdf); // BuyBack Address
