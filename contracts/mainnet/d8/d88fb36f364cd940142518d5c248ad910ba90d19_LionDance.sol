...
🥁 Lion Dance 🥁
是一种使用类似狮子的围裙的中国传统舞蹈
已有数千年的历史。 关于这种舞蹈的第一个音符，目的是带来好运
https://t.me/liondancecoin
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c374db2f6a8A77C28De69E3D4F467831E74EB61;
...
contract LionDance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lion Dance";
    string private _symbol = "LDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4c374db2f6a8A77C28De69E3D4F467831E74EB61);
    address payable public teamWalletAddress = payable(0x4c374db2f6a8A77C28De69E3D4F467831E74EB61);
