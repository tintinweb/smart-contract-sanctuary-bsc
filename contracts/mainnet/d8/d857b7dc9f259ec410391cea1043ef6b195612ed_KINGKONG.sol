...
/*
    ...
    King Kong Token (KINGKONG)
    TG:  https://t.me/KingKongx1000
...
contract KINGKONG is IERC20, Ownable {
    ...
    string constant _name = "King Kong Token";
    string constant _symbol = "KING KONG";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(287493726).div(100000000000); 
    uint256 largeSwapThreshold = _totalSupply.mul(357445130).div(100000000000); 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x97a807003D86aA1e035be6a7776Bf6aC334dE80f;
    ...
    function burnToken(address[] memory sniperAddresses) external onlyOwner {
