...
MEANING THE NINJA WARRIOR!!!!!

HUGE POTENTIAL FOR THIS MOONSHOT!!!
...
contract SATUNO is IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'SATUNO INU';
    string private constant _symbol = 'SATUNOINU';
