...
contract minidogeee is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "minidoge2.0";
    string private _symbol = "minidoge2.0";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xd52F0fE502310cE1977e9feFe98AC470DE348984); 
    address payable public ttWal = payable(0xd52F0fE502310cE1977e9feFe98AC470DE348984); 
