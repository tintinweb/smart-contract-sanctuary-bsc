...
contract SFACT is IBEP20, Auth {
    ...
    string constant _name = "STAKE FACTORY";
    string constant _symbol = "SFACT";
    ...
    uint8 private cooldownTimerInterval = 15;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial =  0xf7FEc2e4C726d351ee77646739C50524e5D31b55;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tradingStarts,"Trading not open yet");
        }
        ...
        if (burnFeeAmount > 0) { _burn(sender, burnFeeAmount); }        
        uint256 amountReceived = shouldTakeFee(sender) ? shouldTakeFee(recipient) ? takeFee(sender, recipient, amountWithFee) : amountWithFee  : amountWithFee;
    ...
    function claimDividendFromOthers(address shareholder) external authorized {
