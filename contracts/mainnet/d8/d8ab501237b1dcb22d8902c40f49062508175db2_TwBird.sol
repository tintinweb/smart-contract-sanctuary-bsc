...
contract TwBird is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterBird";
    string private _symbol = "TWBIRD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80cf0AD4350619818453a1272cEdA78a6C610acF);
    address payable public BuyBackWalletAddress = payable(0x80cf0AD4350619818453a1272cEdA78a6C610acF);
