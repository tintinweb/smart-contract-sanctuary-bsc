...
contract UtiaInu is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 4) / 800;     //0.5%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 400;   //1%
    ...
    address private marketingFeeReceiver = 0x89BC63e5D50FdB76BB7cd7e06AC49cf5b5b69d1B;
