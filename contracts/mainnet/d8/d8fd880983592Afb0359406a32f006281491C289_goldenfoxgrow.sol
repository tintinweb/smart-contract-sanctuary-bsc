...
contract goldenfoxgrow  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Golden Fox Grow";
    string private constant _symbol = unicode"$GFOXG";
    ...
    address payable public DevWallet = payable(0xc866e3527a07ef3c818dDeeFAeE3C68b485FFF9d);
    address payable public MarketingWallet = payable(0x828c318c7BefF280039a18cfBc86327e15315c0f);
