...
library Address{
 ...
 contract Bitcoin2 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8468E4e6A47B942bAEC358E15837F540e52fB1cc;
    address public donationWallet = 0x8468E4e6A47B942bAEC358E15837F540e52fB1cc;

    string private constant _name = "Bitcoin2.0";
    string private constant _symbol = "BTC2";
    ...
    Taxes public taxes = Taxes(0, 2, 10, 0);
    Taxes public sellTaxes = Taxes(0, 2, 10, 0);
