...
contract LeftCenterRight is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LeftCenterRight";
    string private _symbol = "LCR";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x53a993eD4368f66B6684c56c558e6915615a0409);
