...
contract SquidApeCoinTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidApeCoinTwo";
    string private constant _symbol = "SQAPC2.0";
