...
contract TimonInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5279759583857180000000 * 10**18;
    ...
    address payable public marketingWallet = payable(0xe55D0A3EBB2D686a3aC5acBC7A7aB87Cb7c59bd2);
    ...
    uint256 public numTokensSellToAddToLiquidity = 500005958385718 * 10**18;
    uint256 public _maxTxAmount = 5279759583857180000000 * 10**18;
    uint256 public maxWalletToken = 5279759583857180000000 * (10**18);
