...
contract HPoolManager is ERC1155HolderUpgradeable, HordUpgradable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    /**
         * @notice          Function sends platformFee to HordTreasury.
         * @param           amount is amount that HordTreasury wants to withdraw.
     */
    ...
    /**
        * @notice          Function to add more protocol fees in WETH
     */
    function addProtocolFeeWETH(uint256 amount)
    external
    {
        hordTreasury.depositToken(uniswapRouter.WETH(), amount);
    }
