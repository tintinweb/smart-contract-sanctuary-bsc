...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE43f30655184380E09Ae9C720967D32A94a7F4B8;
...
contract ShibaTron is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAfCDD081AC2DB5b17043cF1c6aB35a6436Ad1406;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ShibaTron";
    string private _symbol = "SHIBRON";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 930;
