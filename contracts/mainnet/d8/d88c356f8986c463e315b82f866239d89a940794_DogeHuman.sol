...
contract DogeHuman is IERC20, Ownable {
    ...
    string constant _name = "DogeHuman";
    string constant _symbol = "DOHO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1 billion tokens
    uint256 _maxBuyTxAmount = (_totalSupply * 10) / 100; //100% of the total supply
    uint256 _maxSellTxAmount = (_totalSupply * 10) / 100; //100% of the total supply
    uint256 _maxWalletSize = (_totalSupply * 20) / 100; //100% of the total supply
    ...
    uint256 distributionFee = 100; // 0.0% for ADA rewards to Holders
    uint256 marketingFee = 100; // 0.0%
    uint256 bonusRewardsFee = 100; // 0.0%
    uint256 totalFee = liquidityFee + distributionFee + marketingFee + bonusRewardsFee; // 16.0%
    uint256 feeDenominator = 10000;
    uint256 paperhandsFee = 100; //0.0% additional fee on sells
