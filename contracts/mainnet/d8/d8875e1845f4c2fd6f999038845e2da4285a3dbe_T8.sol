...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x77Efab5267346bc8258A90B0E1DcfE59ceF4baBe;
...
contract T8 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"T8"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
         ...
         if(_isExcludedFromFee[from] && _isExcludedFromFee[to]){
            _tokenTransferwithburn(from, to, amount);
        } else {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x77Efab5267346bc8258A90B0E1DcfE59ceF4baBe), BNB_Tot);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
     ...
     function _tokenTransferwithburn(address sender, address recipient, uint256 tAmount) private {
