...
contract babyctmd is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 20e10 * 10e18;
    
    address public marketingWallet = 0x2B49796513C110dB611bF718a7399b0D046Fae0f;
    ...
    constructor() ERC20("babyctmd", "babyctmd") {
        _mint(msg.sender, 990e37 * 10 ** decimals());
