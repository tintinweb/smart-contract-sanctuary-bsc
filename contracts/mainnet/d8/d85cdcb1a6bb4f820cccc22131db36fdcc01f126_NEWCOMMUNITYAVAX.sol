...
library Address{
 ...
 contract NEWCOMMUNITYAVAX is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x51a231a0eA008A34f0A6B0888f14BA9b4fA05fDc;
    address public donationWallet = 0x51a231a0eA008A34f0A6B0888f14BA9b4fA05fDc;

    string private constant _name = "New Community Avax";
    string private constant _symbol = "NAVAX";
