...
🔮SquidSock is the best meme token based on Elon Tweet. We will be the best meme token on crypto space!🔥
...
contract Squidsock is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcA916330Ec0C317814c6607c974dC9dbC6B06C42); 
    address payable public Wallet_Dev = payable(0xcA916330Ec0C317814c6607c974dC9dbC6B06C42);
    ...
    string private constant _name = "SquidSock"; 
    string private constant _symbol = unicode"SQUIDSOCK"; 
    ...
    constructor () {
        ...
        _owner = 0xF02F5CFC77F272bBE1dA381eb599463B858027f6;
