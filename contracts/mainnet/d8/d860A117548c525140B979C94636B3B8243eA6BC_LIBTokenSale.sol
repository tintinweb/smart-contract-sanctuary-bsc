...
contract LIBToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "LIB";
    string private _name= "LIB COIN";
...
contract LIBTokenSale {
    address payable admin;
    LIBToken public tokenContract;
    ...
    constructor(LIBToken _tokenContract, uint256 _tokensSold)  {
