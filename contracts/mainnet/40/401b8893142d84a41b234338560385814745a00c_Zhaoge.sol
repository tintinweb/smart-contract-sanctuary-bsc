...
--------------------------------------------------------------------------------------------------------------
WELCOME TO Zhaoge!!! is a true defi platform that brings the power back to swapping, Bridge , Staiking and more. 
...
Website: http://comingsoon.com
Telegram : https://t.me/ZhaogeExclamation
Twitter: 
-----------------------------------------------------------------------------------------------------------------
*/
...
contract Zhaoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZHAOGE!!!";
    string private constant _symbol = "ZHAOGE!!!";
