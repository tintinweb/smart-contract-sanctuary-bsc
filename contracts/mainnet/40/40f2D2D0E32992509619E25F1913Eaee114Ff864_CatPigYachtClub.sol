...
/* Token contract */
contract CatPigYachtClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x910d917196C65fD13ccBB24b89BAd1ee96AF8804;//dev wallet address
    ...
    // Name and symbol
    string constant _name = "Cat Pig Yacht Club";//token name
    string constant _symbol = "CPYC'";//symbol
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1 or 5M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x639b3D7B331fB2E6C36337741A19eF1B160e4E8e;//change this to your marketing wallet 
