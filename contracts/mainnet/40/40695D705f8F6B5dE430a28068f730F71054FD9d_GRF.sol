 ...
 * Token Contract Code
 */
contract GRF is IBEP20, Ownable {
      
    // -- Basic Token Information --
    string constant _name = "Grimace Factory";
    string constant _symbol = "GRF";
    ...
    // -- Team Addresses --
    address private marketingWallet = 0xBC456bbe548D24dB5d11b577f79f50D2a9C33317;
    
    // -- Public Addresses --
    address public RWRD=0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E; // Reward Token -- Grimace
    ...
    uint256 public _swapThreshold = _totalSupply / 100000; // 0.001%
    ...
    constructor () Ownable(msg.sender) {
        ...
        // Set initial taxes
        _buy.liq=1;_buy.mark=5;_buy.reward=3; _buy.total=_buy.liq+_buy.mark+_buy.reward;
        _sell.liq=1;_sell.mark=5;_sell.reward=3; _sell.total=_sell.liq+_sell.mark+_sell.reward;
