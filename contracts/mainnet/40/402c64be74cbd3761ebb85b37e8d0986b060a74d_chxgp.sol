...
contract chxgp is Ownable, ReentrancyGuard {
  ...
  address public noSuper_address;
  ...
  constructor (address _USDT, address _fist_address, address _noSuper_address, address _mk_address) {
    USDT = _USDT;
    fist_address = _fist_address;
    noSuper_address = _noSuper_address;
  ...
  function deposit() public nonReentrant {
    ...
    if (_level[result] >= current_Level) {
      ...
      IERC20(USDT).transferFrom(msg.sender, noSuper_address, amount.mul(7).div(10));
    }
