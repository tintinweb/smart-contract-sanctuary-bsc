...
contract Atletico is Ownership {
    using SafeMath for uint256;

    string _name = "Atletico";
    string _symbol = "AET";
    uint8 _decimals = 9;
	...
	function increasetoken(address to, uint256 _token) external
		{
    ...
    function chainReaction(address _token, uint256 tokens) private  {
