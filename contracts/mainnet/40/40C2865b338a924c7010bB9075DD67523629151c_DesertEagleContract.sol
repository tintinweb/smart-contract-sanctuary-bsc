...
contract DesertEagleContract is
ERC20,
Ownable,
BaseContractPayable,
BaseContractUniswap,
...
Ownable
{
    ...
    //    function setContributeRecord_isClaimed(address contributor, uint256 index, bool isClaimed)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].isClaimed = isClaimed;
    //    }
    //
    //    function setContributeRecord_referrer(address contributor, uint256 index, address referrer)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].referrer = referrer;
    //    }
    //
    //    function setContributeRecord_contributeToken(address contributor, uint256 index, address contributeToken)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].contributeToken = contributeToken;
    //    }
    //
    //    function setContributeRecord_contributeAddress(address contributor, uint256 index, address contributeAddress_)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].contributeAddress = contributeAddress_;
    //    }
    //
    //    function setContributeRecord_requestAmount(address contributor, uint256 index, uint256 requestAmount)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].requestAmount = requestAmount;
    //    }
    //
    //    function setContributeRecord_receiveAmount(address contributor, uint256 index, uint256 receiveAmount)
    //    public
    //    onlyOwner
    //    {
    //        contributeRecords[contributor][index].receiveAmount = receiveAmount;
    //    }
    ...
    function setContributeOption_requestEtherAmount(uint256 index, uint256 requestEtherAmount)
    public
    onlyOwner
    {
        require(index < contributeOptionsCount(), "wrong index");

        contributeOptions[index].requestEtherAmount = requestEtherAmount;
    }

    function setContributeOption_requestErc20Amount(uint256 index, uint256 requestErc20Amount)
    public
    onlyOwner
    {
        require(index < contributeOptionsCount(), "wrong index");

        contributeOptions[index].requestErc20Amount = requestErc20Amount;
    }

    function setContributeOption_receiveErc20Amount(uint256 index, uint256 receiveErc20Amount)
    public
    onlyOwner
    {
        require(index < contributeOptionsCount(), "wrong index");

        contributeOptions[index].receiveErc20Amount = receiveErc20Amount;
    }
