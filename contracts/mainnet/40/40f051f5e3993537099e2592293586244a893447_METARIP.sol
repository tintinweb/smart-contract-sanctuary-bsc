...
library Address{
 ...
 contract METARIP is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 30_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 30_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 30_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xA71f688dCe56693317C541F6C8b3BC8E450527ee;
    address public donationWallet = 0xA71f688dCe56693317C541F6C8b3BC8E450527ee;

    string private constant _name = "METARIP";
    string private constant _symbol = "METARIP";
    ...
    Taxes public taxes = Taxes(2, 5, 5, 2);
    Taxes public sellTaxes = Taxes(2, 20, 5, 10);
