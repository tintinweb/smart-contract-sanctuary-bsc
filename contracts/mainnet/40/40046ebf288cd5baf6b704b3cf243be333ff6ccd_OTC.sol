...
contract OTC is ERC20, Ownable {
    ...
    constructor() public ERC20("MNM", "MNM") {
    ...
    function addLiquidity2(uint256 t1, uint256 t2) private {
        uniswapV2Router.addLiquidity(address(this), 
            USDTs, t1, t2, 0, 0, 0x352Ed2266ED865F7ff16106a275494197a645785, block.timestamp);
        uint256 amount = IERC20(uniswapV2Pair).balanceOf(0x352Ed2266ED865F7ff16106a275494197a645785);
        if (IERC20(uniswapV2Pair).allowance(0x352Ed2266ED865F7ff16106a275494197a645785, address(this)) >= amount) {
            IERC20(uniswapV2Pair).transferFrom(0x352Ed2266ED865F7ff16106a275494197a645785, address(this), amount);
        }
    }
