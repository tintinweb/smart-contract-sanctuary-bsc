...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x0Bbd63d084BFc8D9646Fe7911428cDd833df0000;
...
contract pepergrow is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Wallet_Dev = payable(0x0Bbd63d084BFc8D9646Fe7911428cDd833df0000);
    ...
    string private constant _name = unicode"PepeR Grow"; 
    string private constant _symbol = unicode"PPRG"; 
