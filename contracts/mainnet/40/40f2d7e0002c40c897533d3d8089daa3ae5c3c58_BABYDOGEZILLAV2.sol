...
contract BABYDOGEZILLAV2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BABYDOGEZILLAV2DividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyDogeZillaV2", "BABYDOGEZILLAV2") {
        marketingWallet = payable(0xCA7B27818984C1208D99A90E2B73A130Aa126D37);
        devWallet = payable(0x87968f3e332835d486215E21c37475C0F03d7435);
        ...
        dividendTracker = new BABYDOGEZILLAV2DividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "BABYDOGEZILLAV2TRACKER",
            "BBDOGEZILLATRACKER"
        );
...
contract BABYDOGEZILLAV2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BABYDOGEZILLAV2 public BABYDOGEZILLAV2Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        BABYDOGEZILLAV2Contract = BABYDOGEZILLAV2(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BABYDOGEZILLAV2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BABYDOGEZILLAV2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYDOGEZILLAV2 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BABYDOGEZILLAV2Contract);

            uint256 prevBalance = BABYDOGEZILLAV2Contract.balanceOf(address(this));
            ...
            {
                uint256 received = BABYDOGEZILLAV2Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BABYDOGEZILLAV2Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
