...
*/
/** 
Telegram: https://t.me/poohstake_bsc
Website: https://poohstake.website
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFCD514892B3a55b1e5086055398EE4c9a88f733D; // owner address
...
contract PoohStake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PoohStake";
    string private _symbol = "$POS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFCD514892B3a55b1e5086055398EE4c9a88f733D); // 
    address payable public teamWalletAddress = payable(0xFCD514892B3a55b1e5086055398EE4c9a88f733D); // 
