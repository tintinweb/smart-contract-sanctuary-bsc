...
contract IZUKUINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "IZUKU INU"; // 
    string private constant _symbol = "IZUKU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7A1c0d2Ee66de571c3fA1CbAf6D09452908CE2d3;
