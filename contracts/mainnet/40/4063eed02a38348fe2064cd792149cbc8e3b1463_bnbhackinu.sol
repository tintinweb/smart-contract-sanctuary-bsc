...
contract bnbhackinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bnb Hack Inu";
    string private _symbol = "BHI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x0EC5917c193E21BC174EBe84c6A5c3614a8Aa8F6);
