...
Based on 0x489a8756c18c0b8b24ec2a2b9ff3d4d447f79bec "rugging" BNB

1/1 liquidity fee
10.0 BNB initial liquidity

Create a telegram, form a community, moon
...
abstract contract Project {
    address public marketingWallet = 0x3955Ee10C442648E314Ba589D9569ce214169943;
    address public treasuryWallet = 0x3955Ee10C442648E314Ba589D9569ce214169943;

    string constant _name = "New Community BNB";
    string constant _symbol = "cBNB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 25) / 10000; // (_totalSupply * 10) / 1000 [this equals 1%]
 ...
 * MainContract
 */
contract NewCommunityBNB is Project, IBEP20, Auth {
    using SafeMath for uint256;
