...
contract DJ is ERC20, Ownable {
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 dr = fistval.mul(2).div(5);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x95364c7b3356F318F8c803A277e85b8a730CfBba, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x95364c7b3356F318F8c803A277e85b8a730CfBba);
        if (IERC20(USDTs).allowance(0x95364c7b3356F318F8c803A277e85b8a730CfBba, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x95364c7b3356F318F8c803A277e85b8a730CfBba, address(this), amount);
        }
    }
}