...
contract ZoaVesting7Marketing is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting7Marketing: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting7Marketing: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting7Marketing: wrong TGE timestamp");
