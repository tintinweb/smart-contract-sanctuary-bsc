...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x1600a314B8e7D94B2650a0C2Ed8e000512587632;
        _owner = msgSender;
...
contract FIFA is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x7b1D3E68c4b8996EdA0306a6F87caf7212886515);
    address payable private _marketingAddress = payable(0x5eeCAF9290E64640d453De30d19A8C58f9315c5a);
    
    string private constant _name = "FIFA";
    ...
    constructor () {
        _rOwned[0x1600a314B8e7D94B2650a0C2Ed8e000512587632] = _rTotal;
        ...
        emit Transfer(address(0x0000000000000000000000000000000000000000), 0x1600a314B8e7D94B2650a0C2Ed8e000512587632, _tTotal);
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 3, "Redis cannot be more than 99.");
	    require(redisFeeOnSell < 3, "Redis cannot be more than 99.");
	    require(taxFeeOnBuy < 30, "Tax cannot be more than 99.");
	    require(taxFeeOnSell < 30, "Tax cannot be more than 99.");
