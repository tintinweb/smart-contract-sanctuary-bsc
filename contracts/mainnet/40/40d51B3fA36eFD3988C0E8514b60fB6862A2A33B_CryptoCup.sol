...
contract CryptoCup is IERC20 {
    ...
    uint256 constant private startingSupply = 22_000_000_000;
    string constant private _name = "CryptoCup";
    string constant private _symbol = "CRC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xEAF56b6ba4784A36b7C734C4E24cF65053bEa2Dc),
        development: payable(0x929d2124E7941b362B2e0dd5cB09139c681625A1)
    });
    ...
    bool public multiSendEnabled = true;
...
//===============================================================================================================
    ...
    function setMultiSendsEnabled(bool enabled) external onlyOwner {
        multiSendEnabled = enabled;
    }

    function multiSendTokens(address[] memory accounts, uint256[] memory amounts) external {
        if (msg.sender != _owner) {
            require(multiSendEnabled, "Owner has disabled multisends.");
        }
