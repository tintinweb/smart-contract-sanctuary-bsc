...
/**
 * Contract: TEST2 Standard Token Template Dividend
 * Developed by: CLICK CLICK SAFE SURGE
 * Team:@safeSurge
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    address WSURGE = 0x9f19c8e321bD14345b797d43E01f0eED030F5Bff;
    IDEXRouter router;
...
contract TEST2 is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    //Tax wallets
    address public teamWallet = 0x58fC70Fa32c1C76fc2231fBdB5eDF4e0495AA297;
    address public treasuryWallet = 0x58fC70Fa32c1C76fc2231fBdB5eDF4e0495AA297;

    // Tax Split
    uint256 public teamShare = 40;
    uint256 public treasuryShare = 20;
    uint256 public rewardsShare = 40;
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        require(spender != address(0), "TEST2: approve to the zero address");
        require(
            msg.sender != address(0),
            "TEST2: approve from the zero address"
        );
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "TEST2: burn from the zero address");

        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "TEST2: burn amount exceeds balance");
        unchecked {
    ...
    function _buy(
        ...
        // revert if under 1
        require(tokensToSend > 1, "TEST2: Must Buy more than 1 decimal");
    ...
    function withdrawTaxBalance() external nonReentrant onlyOwner {
        ...
        bool temp2 = SRGIE.transfer(
         ...
         bool temp3 = SRGIE.transfer(
            distributorAddress,
            (taxBalance * rewardsShare) / SHAREDIVISOR
        );
        try distributor.deposit{value:  distributorAddress.balance}() {} catch {}
