...
contract TWITBURGLAR is IBEP20, Auth {
    ...
    string constant _name = "TwitBurglar";
    string constant _symbol = "TWITBURGLAR";
    ...
    address public marketingFeeReceiver = 0x5Edd971350db5D6C207F16A69f128Ee241b2beFA;
    address public devFeeReceiver = 0x5Edd971350db5D6C207F16A69f128Ee241b2beFA;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 30; // 0.25%
    bool inSwap;
