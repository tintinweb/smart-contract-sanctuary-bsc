...
contract BSC_CATnobi is Context, IERC20 {
    ...
    string constant private _name = "CATnobi";
    string constant private _symbol = "CNI";
    ...
    address payable private _marketingWallet = payable(0x577eb32B28349B1e455d28E31E0E6e96fe39819e);
    address payable private _charityWallet = payable(0xca8C581E6873bb571d629b312f15e46e9f653c2D);
    address payable private _developmentWallet = payable(0xA734AFFf4661BE987968ECF2Ff8F854d27Dd6FA7);
