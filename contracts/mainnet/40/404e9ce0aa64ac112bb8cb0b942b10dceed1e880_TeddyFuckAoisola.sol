...
contract TeddyFuckAoisola is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeddyFuckAoisola";
    string private _symbol = "TeddyFuckAoisola";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe08D0EA1dE3563990a4F44897493C2c4E12b2c3C); // Marketing Address
    address payable public teamWalletAddress = payable(0x26Cd968f9E04D090E829828f861b2F17be8B905E); // Team Address
