...
/* Token contract */
contract JUNGLEMONK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xea8646f03C0eD0C3a45087F95a60c0aaFc3ea9a7;
    ...
    // Name and symbol
    string constant _name = "Elon Monkeys";
    string constant _symbol = "$EMONKEYS";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% or 5M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xdCc4106dcfe3E8f7aFAfd959E6EACc6552Da76ce;
