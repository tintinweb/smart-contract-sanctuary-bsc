...
/* Token contract */
contract ShibaNaldo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xE0a546A1070BF4Cb9F4621028772BB521c0f5639;
    ...
    // Name and symbol
    string constant _name = "ShibaNaldo";
    string constant _symbol = "ShibaNaldo";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 4% (200 mil)
