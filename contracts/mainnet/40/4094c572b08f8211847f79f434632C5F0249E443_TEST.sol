...
88b           d88  ad88888ba  88  
888b         d888 d8"     "8b 88  
88`8b       d8'88 Y8,         88  
88 `8b     d8' 88 `Y8aaaaa,   88  
88  `8b   d8'  88   `"""""8b, 88  
88   `8b d8'   88         `8b 88  
88    `888'    88 Y8a     a8P 88  
88     `8'     88  "Y88888P"  88  

The worlds of digital art and games have developed significantly over the past few years thanks to the introduction of blockchain technology. Subsequently, many trading platforms appeared where people can buy and sell their digital gaming or art assets based on the blockchain, called non-blockchain tokens or NFT. Unfortunately, these markets are characterized by high transaction fees that apply to platform users. To improve the mass adoption of NFT and encourage people to join the NFT movement, the team developed MetaSwap Protocol, an innovative peer-to-peer trading platform that allows people to exchange NFT without the risk of fraudulent activity and without having to pay large transaction fees.
...
contract TEST is Context, IERC20, Ownable {
    ...
    //Create additional liquidity using TEST tokens in contract
