...
contract YeagerInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Yeager Inu";
    string private _symbol = "YEAGER";
    ...
    function setFeesBuy(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _lpFeeBuy = lpFee;
    }

    function setFeesSell(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _lpFeeSell = lpFee;
    }
