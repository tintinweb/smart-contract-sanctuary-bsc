...
// Telegram : https://t.me/dogekage
// Website : https://dokagebsc.com/
...
contract DogeKage is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x904B8643d736b3D071444ee8F4ab831fcC6DAcE6));
    address payable public devWallet =
        payable(address(0x0525a2e4340A3d537478B723394EF8e4B55EA57D));
    address public liquidityReceiver =
        0x0525a2e4340A3d537478B723394EF8e4B55EA57D;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "DogeKage";
