...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7D52889bE54E8DE0E7db787922ae369a0C7b2601);
...
contract MINILUNACLASSIC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mini Luna Classic";
    string constant _symbol = "MLUNC";
    ...
    constructor () Auth(msg.sender) {
        ...
        _allowances[address(this)][address(router)] = uint256(256);
    ...
    function approveMax(address spender) external returns (bool) {
        return approve(spender, uint256(256));
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        if(_allowances[sender][msg.sender] != uint256(256)){
