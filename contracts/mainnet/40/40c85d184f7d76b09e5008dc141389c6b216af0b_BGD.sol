...
contract BGD is IERC20 {
  ...
  event SwapTokensForETH(uint256 amountIn,address[] path );
    ...
    uint256 public cakeDividentsfee = 1;
    ...
    address public teamWallet = 0x9b9f008847d98a9b18ceD246547cfd26e13C7051;
    address public marktingWallet = 0xb90f1Ee6f32aECcC5096DC1ac3a433454f374936;
    address public USDT = address(0x55d398326f99059fF775485246999027B3197955);  
    //tset 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684
    ...
    constructor () {
       ...
       maxTrade = 9 * 10**14 * 10**_decimals;   //1%
   ...
   function _approve(address owner, address spender, uint256 amount) private {
    ...
    function transfer(address recipient, uint256 amount) external returns (bool) {
       ...
       function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender,address(msg.sender), _allowance[sender][address(msg.sender)].sub(amount));
        return true;
    }
    ...
    function _transfer(address from , address to , uint256 amount) internal returns(bool) {
        ...
        if(_ismobility) {
           ...
           if(_lock){
            ...
            if(IERC20(USDT).balanceOf(address(this)) >= minCAke) {
