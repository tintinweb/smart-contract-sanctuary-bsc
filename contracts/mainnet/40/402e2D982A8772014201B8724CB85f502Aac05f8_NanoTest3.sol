...
contract NanoTest3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NanoTest3DividendTracker public dividendTracker;
    ...
    constructor() ERC20("NANOTest3", "NANOT3") {
        ...
        dividendTracker = new NanoTest3DividendTracker(
            payable(this),
...
contract NanoTest3DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    NanoTest3 public NanoTest3Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        NanoTest3Contract = NanoTest3(mainContract);
    ...
    function _transfer(
        ...
        require(false, "NanoTest3_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "NanoTest3_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NanoTest3 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(NanoTest3Contract);

            uint256 prevBalance = NanoTest3Contract.balanceOf(address(this));
            ...
            {
                uint256 received = NanoTest3Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    NanoTest3Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
