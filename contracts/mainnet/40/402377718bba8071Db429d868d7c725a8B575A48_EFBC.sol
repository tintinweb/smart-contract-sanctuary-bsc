...
contract EFBC is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xd91637B1Bbcc123506fC00A054E5F53c44550501));
    address payable private devWallet =
        payable(address(0xd91637B1Bbcc123506fC00A054E5F53c44550501));
    address private liquidityReceiver =
        0xd91637B1Bbcc123506fC00A054E5F53c44550501;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "ETH Fan Burn Chinese";
    string private _symbol = "EFBC";
