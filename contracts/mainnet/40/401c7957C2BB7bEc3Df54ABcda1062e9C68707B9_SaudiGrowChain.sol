...
// SAUDI GROW CHAIN CODE
// Telegram: https://t.me/Saudigrowchain
// Website: www.saudigrowchain.com
...
contract SaudiGrowChain is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 200000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SAUDI GROW CHAIN"; // token name
    string private _symbol = "SGC"; // token ticker
    ...
    uint256 public minTokenToSwap = 1000000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
