...
/**
Welcome To Bull Luna

$BLUNA  Support for Luna Network progress
    
   Time: 13:00 AM Thursday, September 01, 2022, UTC.
Bull Luna is a community token by providing passive income to every holder $BLUNA with prizes $Luna

   I make this $BLUNA to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/BullLuna

   Great features:
Tax 5%
   1% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders
   3% fee auto distribute to marketing wallet

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer $BLUNA to the community and ensure it's 100% safe.

   I will add 1 BNB and 99% of the total supply to the pool
   Can you make #BLUNA 10000000X? 
...
contract BullLuna is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x199c53bfe711F17fB23B4b454151F32a51B046d1); 
    address payable public Wallet_Dev = payable(0x59C833b59C328bf3b80ab9878D660f4c4C5b872D);
    ...
    string private constant _name = "Bull Luna"; 
    string private constant _symbol = unicode"BLUNA"; 
    ...
    constructor () {
        ...
        _owner = 0x59C833b59C328bf3b80ab9878D660f4c4C5b872D;
