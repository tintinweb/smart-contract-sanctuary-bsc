...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TOKEN is ERC20, LockToken {
        ...
        constructor () ERC20("Black Beard Token", "BBDT"){

            numTokensSellToAddToLiquidity = 10000000 * 10 ** decimals();
            _marketingWalletAddress = 0xA4917FE42d456b1fbeFEbC62d836e7eCb635BdD1;
            _charityWalletAddress = 0xF193e6B22619bDB3fFd668ac2F32506155565015;
        ...
        function setChairtyWalletAddress(address _addr) external onlyOwner {
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (from == uniswapV2Pair) {
                ...
                uint256 charityTokens = amount.mul(_buyCharityFee).div(100);

                amount= amount.sub(liquidityTokens.add(marketingTokens).add(charityTokens));
                super._transfer(from, address(this), liquidityTokens);
                super._transfer(from, _marketingWalletAddress,marketingTokens);
                super._transfer(from, _charityWalletAddress, charityTokens);
                super._transfer(from, to, amount);
                ...
                uint256 charityTokens = amount.mul(_sellCharityFee).div(100);
