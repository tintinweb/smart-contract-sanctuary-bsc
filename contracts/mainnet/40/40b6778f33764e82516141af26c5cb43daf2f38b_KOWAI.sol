...
//submitted for Telegram: https://t.me/KowaiOfficial
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
     ...
     contract KOWAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " KOWAI ";
    string private _symbol = " KOWAI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42F36b1dA4987c0b94d6e24eD1420FAc212bD7DA);
    address payable public teamWalletAddress = payable(0x7D852E2cAa175546eda411921693a7B8F0322719);
    ...
    uint256 public _maxTxAmount = 1 * 15000000000000 * 10**_decimals; 
    uint256 public _walletMax = 1 * 15000000000000 * 10**_decimals;
