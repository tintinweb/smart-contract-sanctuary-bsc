...
// Our Telegram: https://t.me/babybluedoge
// Our Twitter: https://twitter.com/GreenDogeTM
...
/* Token contract */
contract GreenDoge is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC = 0x09D614C98554E706AE2AE9a12E460782b559096d; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x60BB5B30C5F1e3e830BEdb4a804a1D17Ab78E1B9;
    ...
    // Name and symbol
    string constant _name = "GreenDoge";
    string constant _symbol = "GDG";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x09D614C98554E706AE2AE9a12E460782b559096d;
