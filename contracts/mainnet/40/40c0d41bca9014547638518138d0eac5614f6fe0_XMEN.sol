...
contract XMEN is ERC20 {
    ...
    address private _fundAddress = address(0x4439104ABd79B9923d6454A1A2e1417c0c2890a7);
	...
	function swapAndLiquify() public {
		...
		if(allBalance > usdtBalance){
			...
			ETH.transfer(_fundAddress,newBalance.div(7).mul(4));
			if(newBalance.mul(otherAmount) > 10**34){
				addLiquidityUsdt(newBalance.div(7), otherAmount);
			}
		}
    }
