...
contract BullishInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1f4412BA8308066f5f90E56011AFE58e68B02e6d); 
    address payable public Wallet_Dev = payable(0x96335cB802891eB7B4bBf332dA2ae4581f0e0232);
    ...
    string private constant _symbol = unicode"$BULI"; 
