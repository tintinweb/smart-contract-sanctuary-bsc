...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x660c3297067E9C786423C53360E2C9283632748E; // owner address
...
contract A is Context, IERC20, Ownable {
    ...
    string private _name = "A+";
    string private _symbol = "A+";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x660c3297067E9C786423C53360E2C9283632748E); // Marketing Address
    address payable public teamWalletAddress = payable(0x660c3297067E9C786423C53360E2C9283632748E); // Team Address
