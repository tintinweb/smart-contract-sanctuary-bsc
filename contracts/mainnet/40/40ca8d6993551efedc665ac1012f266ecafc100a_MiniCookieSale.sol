...
contract MiniCookieSale is ERC20, Ownable {
    ...
    address payable public teamWallet = payable(0xAc177a0f465a0002DBA39755965b4Cc4Ae4DBE25);
    address payable public marketingWallet = payable(0xeB9443a46f4C25dAfd277341c8Cad1Cc77Ab80b6);
    ...
    constructor() ERC20("Mini CookieSale", "Mini COOKIE") {
        // Create supply
