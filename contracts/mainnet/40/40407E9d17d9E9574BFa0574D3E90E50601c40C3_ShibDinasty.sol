...
/**
Telegram group: https://t.me/Shibdinasty
...
3. You understand if you lose money on a ShibGam play, you can try again in the future plays.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C1dA8c9D3536b18B2997049C3d48696053327C8; // owner address
...
contract ShibDinasty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shib Dinasty";
    string private _symbol = "ShibD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C1dA8c9D3536b18B2997049C3d48696053327C8); // Marketing Address
    address payable public teamWalletAddress = payable(0x0C1dA8c9D3536b18B2997049C3d48696053327C8); // Team Address
