...
contract GEISHA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6fb9b46db947E561ea096cF6e2745F2A1A1E60A7); 
    address payable public Wallet_Dev = payable(0x3f38F717Cd9D31Ab1D8c986E19D4506ad669b1b1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Geisha Assassin"; 
