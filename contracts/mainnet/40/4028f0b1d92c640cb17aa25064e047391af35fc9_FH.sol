...
contract FH is ERC20 {
    ...
    address public fundAddress = address(0x126aC94414198dFAe5948f215c52E76A05649c6E);
	address public usdtPoolAddress = address(0xA7570F35cC1e318A0369113E7D88E5B8a8E1A33d);
    ...
    constructor(address tokenOwner) ERC20("FH", "FH") {
	...
	function changeSwapWarp(FHWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx) {
			...
			}else if(to == uniswapV2Pair){warp.addTokenldx(amount);}else{
                takeFee = false;
            }
        }
	...
	function swapAndLiquify() public {
        ...
        USDT.transfer(fundAddress,usdtBalance.div(24).mul(14));
        USDT.transfer(usdtPoolAddress,usdtBalance.div(24).mul(10));
    }
	...
	function changeUsdtPool(address _usdtPoolAddress)
    public
    returns (bool success)
    {
        require(contractSender == msg.sender);
