...
contract BillRussellCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Bill Russell Coin";
    string private _symbol = "BRC";

    uint256 private _zeroTax = 3;
