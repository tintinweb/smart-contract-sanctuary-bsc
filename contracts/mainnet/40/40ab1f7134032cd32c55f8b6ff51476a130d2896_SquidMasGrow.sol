...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA865AcC540c8CC0289F2295DE90a2c3d355A1878;
...
contract SquidMasGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidMasGrow";
    string private _symbol = "$SMASG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xabc0D092F44013ef3860E6862c50b0528A506691);
    address payable public teamWalletAddress = payable(0x85C4023bbB91ab1Ad7AB1B45AB256B7fd9ba7A95);
