...
contract Genji is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Genji";
    string constant _symbol = "Genji";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x067a66E4BA9178a91771695D8659b59141735074;
