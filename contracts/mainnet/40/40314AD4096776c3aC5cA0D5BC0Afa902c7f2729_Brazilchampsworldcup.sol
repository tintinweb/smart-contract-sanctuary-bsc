...
telegram : https://t.me/brazilchampsworldcup
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x158eD0D1dfD8d7AdC52faFBE57526aA4ef66610E; // whatDOGE
...
contract Brazilchampsworldcup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brazil Champs WORLDCUP";
    string private _symbol = "BRAZIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x158eD0D1dfD8d7AdC52faFBE57526aA4ef66610E); // Marketing Address
    address payable public teamWalletAddress = payable(0x158eD0D1dfD8d7AdC52faFBE57526aA4ef66610E); // Team Address
