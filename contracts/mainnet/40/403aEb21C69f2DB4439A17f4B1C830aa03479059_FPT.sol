...
contract FPT is Ownable, IERC20Metadata {

    using SafeMath for uint256;
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant NFT = 0xBB4cE7b2951b4AE4B81cEE2e2BeBAf864A68Fed3;
    address private NFTDividendRouter = 0x87659603848FdAE5a664663bc7E945E55845D781;//Bsc self-built router address
    ...
    string private _name = "Final Protocol";
    ...
    uint8 private lpRate = 60;
    uint8 private burnRate = 20;
    uint8 private NFTrewards = 30;
    ...
    uint256 private startTime = 1673442000;

    uint256 private TOTAL_GONS;
    uint256 public _lastRebasedTime;
    uint256 private _gonsPerFragment;
    uint256 public pairBalance;
    uint256 public rebaseRate = 17500;
    ...
    constructor(uint256 _initSupply, address _usdt, address _fundAddress, address _uniswapV2RouterAddress) {
        ...
        excluded[NFTDividendRouter] = true;
        platform = owner();
    ...
    function setLiquifyEnabled(bool _enabled) public onlyOwner {
        ...
        function setNFTDividendRouter(address NFTDividend) public onlyOwner {
        NFTDividendRouter = NFTDividend;
    }
