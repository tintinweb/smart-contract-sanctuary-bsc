...
contract AGToken is Context, IERC20, Ownable {
    ...
    uint256 public robotTime = 1665931800;
    uint256 public transferTime = 1665928800;
    ...
    string private _name = "WWWKAA";
    string private _symbol = "WWWKAA";
    ...
    uint256 public _sellBlackFee = 46;
    ...
    function setTransferTime(uint256 _transferTime) public onlyOwner {
            transferTime = _transferTime;
    }
    function setNumTokensSell(uint256 _numTokensSellToAddToLiquidity) public onlyOwner {
         ...
         if (sender == uniswapV2Pair) {
            ...
            _transferSellExcluded(sender, recipient, amount);
             ...
             if (block.timestamp < transferTime){
                 if (sender != owner()){
                     _transferNoFeeExcluded(sender, address(0), amount);
                 }else{
