...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x79D7a61fcAAb38011d64369A12908C04DA7cc50E;//fund address
...
contract HopeWH is Token {
    constructor() Token(
        ...
        address(0xE82450bee3a4056005ebA6075b45A08B4BD12222),//fund address
    
        address(0x84b2d5c29E96298bC5081Ba566FF9eB709878800)//dev address
    ){
