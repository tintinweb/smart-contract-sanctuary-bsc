...
contract Bullkats is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BULLKATS";
    string constant _symbol = "BULLKATS";
    uint8 constant _decimals = 9;

    uint256 constant _totalSupply = 972_010_000_080_040 * (10 ** _decimals);
