...
contract APEFORREKTAGE is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'APE FOR REKTAGE';
    ...
    address public constant liquidity_receiver = 0xaa44f3A92042316eBb0bAa62Ee15655D6c4Ec03C; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0xaa44f3A92042316eBb0bAa62Ee15655D6c4Ec03C;
    ...
    function setStartWhitelist() external onlyOwner {
        require(!tradingAllowed);
        whitelistAllowed = true; 
    }

    function setEndWhitelist() external onlyOwner {
    ...
    function shouldSwapBack(address sender, address recipient, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && aboveMin && !isFeeExempt[sender].FeeExempt && recipient == pair && swapTimes >= uint256(2) && aboveThreshold;
    }
