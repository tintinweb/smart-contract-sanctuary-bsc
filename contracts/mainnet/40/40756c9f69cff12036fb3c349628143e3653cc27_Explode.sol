...
contract Explode is Context, IERC20 {
    ...
    uint256 private constant INITIAL_SUPPLY = 1_000;
    ...
    address payable public _marketingWallet = payable(0x1fAa001cd2D6789030CcA38C9843196EcD25B39c);
    
    bool private inSwapAndLiquify;
    bool public swapAndLiquifyEnabled;
    
    uint256 public buyMaxTxPercent = 10;
    uint256 public buyMaxTxDivisor = 1000;
    ...
    uint256 public sellMaxTxPercent = 10;
    uint256 public sellMaxTxDivisor = 1000;
    ...
    uint256 public maxWalletDivisor = 1000;
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if(to == lpPair) {
                ...
                require(buy_AllowedTime[to] < block.timestamp, "Anti-bots enabled: The waiting period is 15 seconds");
                buy_AllowedTime[to] = block.timestamp + (15 seconds);
            }
