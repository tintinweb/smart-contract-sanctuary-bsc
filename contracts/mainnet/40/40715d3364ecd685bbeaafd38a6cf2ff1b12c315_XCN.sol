...
contract XCN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "XcnBusdy";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xFC98bCfDA0c367F6e3D38F2dF5F3E9BD0F8Cee24));
        marketingWalletAddress = payable(address(0xFC98bCfDA0c367F6e3D38F2dF5F3E9BD0F8Cee24));
