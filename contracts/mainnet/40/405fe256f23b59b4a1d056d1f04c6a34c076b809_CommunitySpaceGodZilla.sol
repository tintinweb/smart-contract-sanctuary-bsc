...
/**
	Community SpaceGodZilla 

   I make this #Community SpaceGodZilla to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/CommunitySpaceGodZilla
...
contract CommunitySpaceGodZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "CommunitySpaceGodZilla";
    string private constant _symbol = "cSpaceGodZilla";    
    uint8 private constant _decimals = 9;
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x125C9490bd752C3900358F0B669c8c0A9Bc1B48d;
    ...
    function RemoveLimits() public onlyOwner{
        ...
        _maxWalletToken = _tTotal * 50 / 100;
    }
