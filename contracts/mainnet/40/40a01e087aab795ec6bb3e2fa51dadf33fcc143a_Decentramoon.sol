...
contract Decentramoon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Decentramoon";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xd611Cba0ed75D144D812910785E2A88462698FB5;  // teamwallet
        lotteryWallet = 0x0beF66bE944c0371759704Ac5C6005AB4b843bD5;  // lotterywallet
    ...
    function rescueDividends(address to) external onlyOwner{
        dividendDistributor.rescueDividends(to);
    }
