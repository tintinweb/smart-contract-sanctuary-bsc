...
contract NutgainMigration is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0xC091377110ACFB780dFB9f6c200b2EF81d8cE4aB));
        
        // Token V2
        token2 = IERC20(address(0xB149B030CFA47880aF0BDE4Cd36539E4C928b3eB)); 
        
        
        liquidityWalletForV2 = address(0xd510A6fD23f1d909c5CB9E20481ABB344b8209D7); // change to new owner before launch
    ...
    function tradeInTokens() external nonReentrant {
        ...
        token1.transferFrom(msg.sender, address(liquidityWalletForV2), token1Balance);
     ...
     //   amountToSend = amountToSend + ((amountToSend / 100) * bonustokens);
    ...
    // use in case people accidentally send tokens to the Bridge
    function emergencyToken1Withdraw() external onlyOwner {
        token1.transfer(address(liquidityWalletForV2),token1.balanceOf(address(this)));
    }
}