...
contract MollyInu is Context, IBEP20, Ownable {
    ...
    address private devWallet = 0xec1914899781f767065Bc31587F49DaD9C6E6B80;
    ...
    Taxes public taxes = Taxes(0, 65, 10, 0, 5);
    Taxes public sellTaxes = Taxes(0, 900, 10, 0, 5);
    Taxes private launchtax = Taxes(0, 999, 0, 0, 0);
    ...
    function setTaxes(
        ...
        require((_reflections + _marketing + _liquidity + _dev + _mteam) <= 200, "Fees can't exceed 20%");
        taxes = Taxes(_reflections, _marketing, _liquidity, _dev , _mteam);
        emit FeesChanged();
    }
    ...
    function setSellTaxes(
        ...
        require((_reflections + _marketing + _liquidity + _dev + _mteam) <= 200, "Fees can't exceed 20%");
        sellTaxes = Taxes(_reflections, _marketing, _liquidity, _dev, _mteam);
        emit FeesChanged();
    }
    ...
    function _getValues(
        ...
        (to_return.rDev, to_return.rmteam) = _getRValues2(
            to_return,
            takeFee,
            _getRate()
        );
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tDev + s.tmteam
            );
        }
