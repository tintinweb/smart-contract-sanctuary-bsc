...
contract DogeverseInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeverseInu";
    string private constant _symbol = "DVI";
    ...
    address private marketingWallet = address(0x88881Ace51791787Fc5c2D09A40De8f439e676D4);
    ...
    function liqChecks() public onlyOwner { 
