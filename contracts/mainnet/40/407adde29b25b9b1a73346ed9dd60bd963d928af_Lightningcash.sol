...
// *Telegram : https://t.me/lightningcash_bsc
// 

// SPDX-License-Identifier: MIT
/*
    LIGHTNING CASH Token
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38Aa9E9FD406E1A7bF0Ca0c4D46afC6E70c37fb4; // owner address
...
contract Lightningcash is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lightning Cash";
    string private _symbol = "$LIGHT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38Aa9E9FD406E1A7bF0Ca0c4D46afC6E70c37fb4); // Marketing Address
    address payable public teamWalletAddress = payable(0x38Aa9E9FD406E1A7bF0Ca0c4D46afC6E70c37fb4); // Team Address
