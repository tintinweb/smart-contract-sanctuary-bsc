...
/**
Baby Quokka dropped by the same team come gain as many rewardsa before we take off!
...
contract BabyQuokkaInu is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Baby Quokka Inu';
    string private constant _symbol = 'Baby Quok';
