...
contract Smart_Binary_F_L is Context {
    ...
    // function TestNumWin() public view returns(uint256){
    //     return ((Value_LotteryANDFee * 9)  / 10**18) / Max_Lottery_Price;
    // }

    function Lottery_Reward() private {
        uint256 Numer_Win = ((Value_LotteryANDFee * 9)  / 10**18) / Max_Lottery_Price;
