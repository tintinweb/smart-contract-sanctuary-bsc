...
contract LOWTAX is IBEP20, Renounce {
    ...
    function swapAndLiquify(uint256 swapAmount) internal lockTheSwap {
        ...
        if(amountToLiquify > 0){router.addLiquidityETH{value: amountLiquidity}( address(this), amountToLiquify, 0, 0, autoLiquidityReceiver, block.timestamp);}}
