...
contract KISHUTAMA is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _liquidityFee = 11;
  uint256 public _maxTxAmount = 315000000000000000000000;
  uint256 public _maxWalletSize = 264600000000000000000;
  uint256 public _taxFee = 1;
  uint256 public marketingFeePercent = 50;

  constructor() public {
    _totalSupply = 42 * 10**15 * 10**9;
