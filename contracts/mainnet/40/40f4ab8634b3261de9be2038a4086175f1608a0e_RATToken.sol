...
contract RATToken is IERC20, Ownable {
    ...
    address public _marketAddress= 
        address(0x0cFB330C8A8b5e96663a0A0edE6d89ECcE1c5d16);
    ...
    function lockswap(bool _state) public onlyOwner() {
            lockSwap = _state;
        }
