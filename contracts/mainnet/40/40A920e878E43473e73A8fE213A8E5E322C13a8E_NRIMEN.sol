...
contract NRIMEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "NRIME FINANCE"; // 
    string private constant _symbol = "NFN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xb2f53539bB565139e9C2e83F27169cA74076A71f;
