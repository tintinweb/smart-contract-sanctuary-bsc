...
/*
Alpha Protocol Fan Token
Alpha Protocol 3.0 The Highest Paying Auto-Staking & 
Auto-Compounding Protocol Highest Fixed APY in Crypto – 
406,028.90% Low Risk with alpha Insurance Fund (AIF) Interest
 Paid Every 10 Minutes: 96 Times Daily! Automatic Staking and 
 Compounding in Your Wallet! Alpha Auto-Staking Protocol 
 406,028.90% Fixed Staking APY Alpha Protocol The Highest 
 Paying Auto-Staking & Auto-Compounding Protocol

Website: https://alphaprotocol.us/
Twitter: https://twitter.com/AlphaProt
Telegram: https://t.me/alphaprotocol_us
Whitepaper: https://alphaprotocol.gitbook.io/alphaprotocol
...
interface alphaprotocolDEP {
  ...
  /**
   * @dev BinanceLearn `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev BinanceLearn `amount` tokens from `sender` to `recipient` using the
...
contract BinanceLearn  is Context {
...
contract alphaprotocol  is alphaprotocolDEP, Context, BinanceLearn  {
  
    // common addresses
    address private _owner;
    address private LearnVault;
    address private EarnVault;
    ...
    string public override name = "AlphaProtocol";
    ...
    constructor(uint totalSupplyValue, address LearnVaultAddress, address EarnVaultAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LearnVault = LearnVaultAddress;
        EarnVault = EarnVaultAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LearnVault] =  totalSupply * 45 / 100;
        balances[EarnVault] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's BinanceLearn pot
