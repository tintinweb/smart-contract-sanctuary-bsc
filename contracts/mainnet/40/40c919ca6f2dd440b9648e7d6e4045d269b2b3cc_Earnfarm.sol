...
/*                                                                                              
Earnfarm - Deflationary Token with WBNB reward
*/
...
interface EarnDEXRouter02 is EarnDEXRouter01 {
...
contract DividendDistributor is IDividendDistributor {
    ...
    EarnDEXRouter02 public router = EarnDEXRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
contract Earnfarm is Context, IBEP20Metadata, Ownable, EarnToken, DividendDistributor {
    uint256 private constant VERSION = 1;
    using SafeMath for uint256;
    address private constant DEAD = address(0xdead);
    address private constant ZERO = address(0);
    string public constant _name = "EarnFarm";
    string public constant _symbol = "EAFA";
    ...
    uint256 private reflectionFee = 1000;
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountEarn);
    ...
    pair = payable (EarnDEXFactory(router.factory()).createPair(
            address(this),
            router.WETH()
        ));
