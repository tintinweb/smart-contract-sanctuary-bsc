...
contract BabyBNBV2 is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address DEAD                                = 0x000000000000000000000000000000000000dEaD;
    address ZERO                                = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver         = 0xB648d02473cb69085BdE2727199AeFa2C9959bAf;

    string  _name                               = "Baby BNB V2";
    string  _symbol                             = "$BBNBV2";
