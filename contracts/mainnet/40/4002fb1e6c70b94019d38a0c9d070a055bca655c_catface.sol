...
Cat Face the cutest face in the entire world born 
into BSC to takeover the trend, 
with The cutenes of the cat face we gonna moon easily.
...
// Telegram : https://t.me/CatFaceOfficial
// Twitter  : https://twitter.com/CatFaceBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61df7979d15C68f22EA98e759b6b4CC2F4Ef2C23;
...
contract catface is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x61df7979d15C68f22EA98e759b6b4CC2F4Ef2C23);
    ...
    */
    ...
    string private _name = unicode" Cat Face"; 
    string private _symbol = unicode" (=˃ᆺ˂=) ";  
