...
contract ShirakumoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shirakumo Inu";
    string private _symbol = "SHIRAKUMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8E76bD6340bdaD4375195D2d0cae42C4FCa3dcA6); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x8E76bD6340bdaD4375195D2d0cae42C4FCa3dcA6); // Team Address
