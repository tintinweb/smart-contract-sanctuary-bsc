...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x791ee45D9ceF4d4F8Fe10Ef7cac2C77eB886C9bF; // 
...
contract Messhib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Messhib";
    string private _symbol = "Messhib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x791ee45D9ceF4d4F8Fe10Ef7cac2C77eB886C9bF); // Marketing Address
    address payable public teamWalletAddress = payable(0x791ee45D9ceF4d4F8Fe10Ef7cac2C77eB886C9bF); // Team Address
