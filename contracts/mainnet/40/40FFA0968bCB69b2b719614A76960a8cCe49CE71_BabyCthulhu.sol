...
/**
 *Baby Cthulhu has arisen from the depths to dominate the Crypto & DeFi Markets. Join with the Baby Dark Lord, Become an Acolyte Today and Reap the Profits!
 * 
 */
...
contract BabyCthulhu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Cthulhu";
