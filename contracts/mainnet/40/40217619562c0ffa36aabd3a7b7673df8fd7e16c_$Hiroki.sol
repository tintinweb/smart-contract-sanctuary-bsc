...
contract $Hiroki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x05Db5BB9B1625C54965D2E2F01949AB6C8B90d78));
    address payable public devWallet =
        payable(address(0x05Db5BB9B1625C54965D2E2F01949AB6C8B90d78));
    address public liquidityReceiver =
        0x05Db5BB9B1625C54965D2E2F01949AB6C8B90d78;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Hiroki Inu";
    string private _symbol = "$Hiroki";
    ...
    uint256 private numTokensSellToAddToLiquidity = 13000000000 * 10**9;
