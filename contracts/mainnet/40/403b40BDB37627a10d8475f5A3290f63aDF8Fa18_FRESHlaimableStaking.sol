...
contract FRESHlaimableStaking {
    ...
    function claimRewards(uint256 index) public {
        ...
        uint256 _duration = stakersRecord[msg.sender][index].unstaketime.sub(stakersRecord[msg.sender][index].staketime);
        uint256 _persecondreward = stakersRecord[msg.sender][index].reward.div(_duration);
