...
contract BTCPi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTCPi";
    string private _symbol = "BTCPi";
    ...
    address public immutable deadAddress = payable(0x344C7E2c15059c84BB2aa5f4Fb930cD44Efb6DD4);
