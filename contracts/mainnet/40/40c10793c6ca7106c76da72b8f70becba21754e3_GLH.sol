...
contract GLH is IERC20, Ownable {
    ...
    address public _fundAddress = address(0x8188a7c1Ed0A7DBFC1f25E5762F48e44CDB991F3);
    address private _inviterAddress = address(0x8188a7c1Ed0A7DBFC1f25E5762F48e44CDB991F3);
	...
	function _takeInviterFee(
        ...
        for (int256 i = 0; i < 9; i++) {
            ...
            cur = inviter[cur];
            if (cur != address(0) && balanceOf(cur) >= 10**19) {
                recieveD = cur;
            }else{
