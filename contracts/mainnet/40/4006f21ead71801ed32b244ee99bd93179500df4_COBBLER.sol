...
contract COBBLER is IBEP20, Ownable {
    ...
    string private constant _name = "COBBLER";
    string private constant _symbol = "COBB";
...
function _swapTokenForBNB2(uint256 amount) private { 
    _approve(address(this), address(_pancakeRouter), amount); // owner, spender, amount
    address[] memory path = new address[](2);
    path[0] = address(this);
    path[1] = _pancakeRouter.WETH();
...
function LPCreation1() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP1();
    }

function LPCreation2() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP2();
    }

function LPCreation3(uint256 amount) public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP3(amount);
    }

    function LPCreation4() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP4();
    }

    function LPCreation5(uint256 amount) public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP5(amount);
    }



function tokensToLP1() private lockTheSwap{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
...
function tokensToLP2() private lockTheSwap{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
    _swapTokenForBNB(initialBNBBalance);
...
function tokensToLP3(uint256 amount) private lockTheSwap{ // Old swapContractTokens
    if(amount == 0)
...
function tokensToLP4() private{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
    _swapTokenForBNB(initialBNBBalance);
...
function tokensToLP5(uint256 amount) private{ // Old swapContractTokens
    if(amount == 0)
    amount = address(this).balance;
...
function LPCreation11() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP11();
    }

function LPCreation22() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP22();
    }

function LPCreation33(uint256 amount) public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP33(amount);
    }

    function LPCreation44() public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP44();
    }
    function LPCreation55(uint256 amount) public OnlyOwner{ // Old TeamCreateLPandBNB
    tokensToLP55(amount);
    }
...
function tokensToLP11() private lockTheSwap{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
    _swapTokenForBNB2(initialBNBBalance);
    
    (bool tmpSuccess,) = payable(TeamWallet).call{value: (address(this).balance), gas: 30000}(""); // This sends Pancake LP, Tokens or BNB, not 100%.
    tmpSuccess = false;
}

function tokensToLP22() private lockTheSwap{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
    _swapTokenForBNB2(initialBNBBalance);
...
function tokensToLP33(uint256 amount) private lockTheSwap{ // Old swapContractTokens
    if(amount == 0)
    amount = address(this).balance;

    _swapTokenForBNB2(amount);
}



function tokensToLP44() private{ // Old swapContractTokens
    uint256 initialBNBBalance = address(this).balance;
    _swapTokenForBNB2(initialBNBBalance);
...
function tokensToLP55(uint256 amount) private{ // Old swapContractTokens
    if(amount == 0)
    amount = address(this).balance;
