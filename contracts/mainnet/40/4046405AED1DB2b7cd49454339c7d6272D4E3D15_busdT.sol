...
contract busdT is Context, Ownable {
    ...
    function buyBeans(address ref, uint256 _amount) payable public {
        require(initialized);
        ...
        */
        ...
        IERC20(BUSD).transferFrom(msg.sender, payable(address(this)), _amount);
