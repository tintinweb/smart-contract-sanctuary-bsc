...
contract SaitanaTwo is IBEP20, Auth {
    ...
    string constant _name = "Saitana Inu 2.0";
    string constant _symbol = "SI 2.0";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(icecreamFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _icecreamFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        teamFee = _teamFee;
        icecreamFee = _icecreamFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_teamFee).add(_icecreamFee).add(_marketingFee);
