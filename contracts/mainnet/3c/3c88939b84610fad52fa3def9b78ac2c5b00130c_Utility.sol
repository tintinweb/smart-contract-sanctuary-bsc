...
// The UTILITY Token is the first triangular token in the history, and that's its main utility.
// 8% BURN
// 2% LP
// 3% Max Wallet
...
contract Utility is IBEP20, Ownable {
    using SafeMath for uint256;
    string constant _name = "Utility";
    string constant _symbol = "UTILITY";
    ...
    uint256 public _maxHold = _totalSupply * 30 / 1000;			//3%
