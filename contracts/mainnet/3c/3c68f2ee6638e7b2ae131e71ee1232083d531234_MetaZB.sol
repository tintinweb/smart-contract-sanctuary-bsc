...
contract MetaZB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MetaZB";
    string private _symbol = "MetaZB";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress =
        payable(0x2ffBD8b2728349005a4a819873e7850336049ec6);
