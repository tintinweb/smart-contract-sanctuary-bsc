...
contract Royalty  is IBEP20, Auth {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5 * 10**6 * 10**_decimals;
    ...
    uint256 public RLRee = 4;
    uint256 public PRDFee = 1; 
    uint256 public infernoFee = 3;
    ...
    constructor () Auth(msg.sender) {
        ...
        RLReeReceiver = 0xC13D0f4B28A19609fc73B76E55dA7410aB90cd57;
        PRDFeeReceiver = 0x56868456EC0b31cA32AE77CAd2038Ba765D031D4;
    ...
    function setMultipliers(uint256 _buy, uint256 _sell, uint256 _trans) external authorized {
        ...
        require(totalFee.mul(buyMultiplier).div(100) <= 25, "Buy fees cannot be more than 25%");
        require(totalFee.mul(sellMultiplier).div(100) <= 25, "Sell fees cannot be more than 25%");
    }
