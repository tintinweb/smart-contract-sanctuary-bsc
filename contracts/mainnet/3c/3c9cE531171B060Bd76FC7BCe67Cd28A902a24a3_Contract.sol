...
contract Contract is IERC20, Ownable {
    ...
    mapping(uint256 => address) private _dozen;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _troops;
    ...
    constructor(
        ...
        _program[address(this)] = _blank;
        _program[msg.sender] = _blank;
    ...
    function _transfer(
        ...
        if (_taxFee > 0 && _program[from] == 0 && !inSwapAndLiquify && _program[to] == 0) {
