...
contract APEMetaverseDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APE Metaverse Doge";
    string private _symbol = "APEMVDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb028Aa348Ed74d4792C112FF87DcEe366385C94C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb028Aa348Ed74d4792C112FF87DcEe366385C94C); // BuyBack Address
