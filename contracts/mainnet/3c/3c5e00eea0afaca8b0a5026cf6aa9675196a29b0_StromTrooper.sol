...
contract StromTrooper is IBEP20, Ownable {
    ...
    string constant _name = "Strom Trooper";
    string constant _symbol = "$TROOPERS";
    ...
    address public marketingFeeReceiver = 0xdE733dBDaCF36EDd839Ce6B81239adFac0C76CaC;
