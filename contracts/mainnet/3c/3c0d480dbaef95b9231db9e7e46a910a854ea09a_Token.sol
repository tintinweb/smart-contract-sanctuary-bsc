...
contract Token {
 ...
 constructor() {
        name = "Avatar-Token"; // Sets the name of the token, i.e Ether
        symbol = "avtr"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 1000000000000000000000000000000; // Holds an initial supply of coins// 18+9
