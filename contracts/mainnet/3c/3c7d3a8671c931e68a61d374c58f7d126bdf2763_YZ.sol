...
contract YZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YZ";
    string private _symbol = "YZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE64a64184BD2F7E6288613bcBC8B8dE178836Cf7); 
    address payable public buyBackWalletAddress = payable(0xE64a64184BD2F7E6288613bcBC8B8dE178836Cf7); 
    ...
    uint256 private _totalSupply = 1600 * 10**9;
