...
contract TradingPost is Ownable {
    ...
    uint256 public currentSellOfferId = 0;
    uint256 feePercent;
    uint256 feeFlat;
    ...
    modifier onlyBuyableOffer(uint256 offerId) {
        require(
            saleOffers[offerId].completed == false,
            "Offer alrealdy completed"
        );
        require(saleOffers[offerId].expiry > block.number, "Offer expired");
        _;
    }
    ...
    function addSaleOffer(
        ...
        currentSellOfferId = currentSellOfferId + 1;
