...
contract AnunnakiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anunnaki Inu";
    string private _symbol = "$ANUN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf6dE947a95CBeB07B18f81643a11348694b0AE50); // Marketing Address
    address payable public teamWalletAddress = payable(0xf6dE947a95CBeB07B18f81643a11348694b0AE50); // Team Address
