...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x70Dac30227Ce8dc6F583957BA256344A387CeE63 ;
...
contract CATINUTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x5775534f00112F41dcCB09F67bA2650186D959c4 ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CATINUTOKEN";
    string private _symbol = "CATT";
