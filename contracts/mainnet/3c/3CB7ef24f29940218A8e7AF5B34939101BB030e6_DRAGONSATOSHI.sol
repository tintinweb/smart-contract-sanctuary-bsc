...
contract DRAGONSATOSHI  is Context, IERC20 { 
    ...
    string private constant _name = "DRAGON SATOSHI "; 
    string private constant _symbol = unicode"DRAGONTOSHI"; 
