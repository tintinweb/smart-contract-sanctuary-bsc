...
// 
//
// 📱 Telegram:https::https://t.me/PulseChihuahua
//
...
contract $PulseChihuahua is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("Pulse Chihuahua", "PulseChihuahua") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "PulseChihuahua";
    string private _symbol = "PulseChihuahua";
