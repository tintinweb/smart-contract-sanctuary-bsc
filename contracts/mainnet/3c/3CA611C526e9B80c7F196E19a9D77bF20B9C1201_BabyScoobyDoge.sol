...
/*
💎💎 BabyScoobyDoge - Baby Doge and Scooby Collaboration. 100x Meme Token  💎💎

Collaboration of BabyDoge and Scooby. 
100x Meme Token.
BabyDogeScooby is a moonshot for the current bearish market.

✅ BabyDoge and Scooby Community Collaboration
✅ Lowtax
✅ Experienced dev from BNBMine
✅ Safe and LP Lock

TG : https://t.me/BabyScoobyDoge
*/
...
contract BabyScoobyDoge is Context, IERC20 { 
    ...
    uint256 private _tTotal = 1 * 10**17 * 10**_decimals;
    string private constant _name = "BabyScoobyDoge"; 
    string private constant _symbol = "$SCD"; 
