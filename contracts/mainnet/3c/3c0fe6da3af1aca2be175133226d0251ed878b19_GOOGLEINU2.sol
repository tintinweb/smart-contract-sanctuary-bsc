...
contract GOOGLEINU2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoogleInutwo";
    string private _symbol = "GoogleInu2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2589abE507a1BE656215F40CDBf07f6bd9336b15); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2589abE507a1BE656215F40CDBf07f6bd9336b15); // BuyBack Address
