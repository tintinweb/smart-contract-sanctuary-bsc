...
contract PantherBusd is Context, Ownable , ReentrancyGuard {
    ...
    address public dev = 0x95C64F014697Ac64A3c210Bbce3e5b0E2cc3D9dd;
    ...
    require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,7), "You cant withdraw you have collected five times Already"); // hh new
