...
contract Destacking is ERC20, Ownable {
    using SafeMath for uint256;
    
    uint256 public _totalSupply = 100000000000000000000 * (10**18);
    ...
    constructor() ERC20("Destacking ", "Destacking") {

    	marketingWallet = 0x39F3B054B28726a4c573BeCACA85b7d7e8bE139e;
    	rewardsWallet = 0x39F3B054B28726a4c573BeCACA85b7d7e8bE139e;
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0x39F3B054B28726a4c573BeCACA85b7d7e8bE139e); // dev fee lasts for one day only
