...
contract pumaeth is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUMA.eth";
    string private _symbol = "PUMA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xAe678b459628Ed3751668c2Cb80c5cb39EB6cc90); 
