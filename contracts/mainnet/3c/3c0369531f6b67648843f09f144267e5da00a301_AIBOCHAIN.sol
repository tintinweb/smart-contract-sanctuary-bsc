...
contract AIBOCHAIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4a4C4d9136fA63503D1b63C58DD93eA7994b3720); // Marketing Address
    ...
    string private _name = "AIBO CHAIN";
