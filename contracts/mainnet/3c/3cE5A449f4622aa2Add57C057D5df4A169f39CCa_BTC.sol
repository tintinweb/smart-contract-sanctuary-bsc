        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5804e039fCDf9b354d7c0bd34C2F3C39c54775Fa), block.timestamp
                );
            }
        }
    }
...
contract BTC is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        9120,//Supply
        address(0xd400C8afc2dBFf7ed0Cc604F2BDf98776Ae93EDA),//FundAddress
        address(0xBBe42825d4ad0b67971D5052ff572E4F07e34228)//ReceiveAddress
    ){
    }
}