...
contract FakeDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FakeDOGE";
    string private _symbol = "FakeDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0c3732D6155B0a85dBFDe88630313B8D910ED2A1);
    address payable public teamWalletAddress = payable(0x0c3732D6155B0a85dBFDe88630313B8D910ED2A1);
