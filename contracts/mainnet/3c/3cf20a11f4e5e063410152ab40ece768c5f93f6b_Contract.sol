...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Legend of Exorcism"; //
    string private constant _symbol = "LE"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE2aAdA16406aED6afC8d77502f12Ba418ac9ac4e;
