...
contract NFTZP is Base{
    ...
    function playerwinning(address playeraddress,uint256 winningNum,uint256 condition) private   returns(uint256)   {
            if( winningNum ==1 ){
                if( condition ==3){
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(9),_asSingletonArray(1),"0x00");
                }
                else if( condition ==2){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(5),_asSingletonArray(1),"0x00");
                }
                else{  
            ...
            if( winningNum ==2 ){
                if( condition ==3){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(10),_asSingletonArray(1),"0x00");
                }
                else if( condition ==2){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(6),_asSingletonArray(1),"0x00");
                }
                else{  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(1),_asSingletonArray(1),"0x00");
                }
            }
            if( winningNum ==3 ){
                if( condition ==3){  
            ...
            if( winningNum ==4){
                if( condition ==3){  
                    ...
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(2),_asSingletonArray(1),"0x00");
                }
            }
            if( winningNum ==5 ){
                if( condition ==3){
