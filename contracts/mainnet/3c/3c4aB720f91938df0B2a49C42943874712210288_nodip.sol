...
/*
 ...
 Find us on TG: https://t.me/nodipbdc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x778DDEc6F52076Dc8D00712216B1A607e15Ab0a7; // owner address
...
contract nodip is Context, IERC20, Ownable {
    ...
    string private _name = "NODIP";
    string private _symbol = "NODIP"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x013dCDb05657419bE7Fc2085F48DC3618fb0e3fA); // Marketing Address
    address payable public teamWalletAddress = payable(0xBc7D4ABaBb4f011c05280F6d6CFA67C29F51f1C2); // Team Address
    ...
    uint256 public _totalDistributionShares = 24;  // original 12
