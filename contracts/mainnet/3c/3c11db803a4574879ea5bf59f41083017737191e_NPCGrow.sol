...
contract NPCGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "NPC Grow";
    string private constant _symbol = "NPCG";
    ...
    address private marketingWallet = address(0x3708743f35A27609678F3479544b5B7b3Fe620A9);
