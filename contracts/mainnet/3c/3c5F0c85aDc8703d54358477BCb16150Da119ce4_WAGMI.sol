...
contract WAGMI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2db237C7a6f6F0a467e6AaCaC84d4ef670FefAfa); // Marketing Address
    address payable public teamWalletAddress = payable(0x2db237C7a6f6F0a467e6AaCaC84d4ef670FefAfa); // Team Address
