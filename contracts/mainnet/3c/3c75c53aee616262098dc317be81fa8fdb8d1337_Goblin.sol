...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd40f176B7b2e5450e5f1Bf436523770DdD627818; // owner address
...
contract Goblin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd40f176B7b2e5450e5f1Bf436523770DdD627818); // Marketing Address
    address payable public teamWalletAddress = payable(0xd40f176B7b2e5450e5f1Bf436523770DdD627818); // Team Address
    ...
    uint256 public _liquidityShare = 1; // original 4
    uint256 public _marketingShare = 4;
    uint256 public _teamShare = 0; // original 4
