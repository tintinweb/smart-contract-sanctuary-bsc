...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90c1067FFe1C65211c22553a127539F231AA0679; // owner address
...
contract NobukoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nobuko Inu";
    string private _symbol = "NOBINU";
