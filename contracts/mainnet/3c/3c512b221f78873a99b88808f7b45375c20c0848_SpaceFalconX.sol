...
contract SpaceFalconX is ERC20, Ownable {                                                                
    ...
    function setFees(uint256 marketingfee, uint256 devfee, uint256 treasuryfee, uint256 liquidityfee, uint256 rewardsfee, uint256 sellfeeIncrease) external onlyOwner{
        require(rewardsfee <= 3, "Requested rewardsFee fee not within acceptable range.");
        require(liquidityfee <= 3 , "Requested liquidity fee not within acceptable range.");
        require(marketingfee <= 3, "Requested marketing fee not within acceptable range.");
        require(devfee <= 3, "Requested marketing fee not within acceptable range.");
        require(treasuryfee <= 3, "Requested marketing fee not within acceptable range.");
