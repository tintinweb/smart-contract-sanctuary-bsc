...
contract Monaka is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x90F8B1d29EC3aFcef6C64eD7d7A9353699045f8c); 
    address payable public Wallet_Dev = payable(0x2802fbbdFef7298F1E4AF8e276A42727f2d6f403);
    ...
    string private constant _name = "Monaka Inu"; 
    string private constant _symbol = unicode"MONAKA"; 
    ...
    constructor () {
        ...
        _owner = 0x2802fbbdFef7298F1E4AF8e276A42727f2d6f403;
