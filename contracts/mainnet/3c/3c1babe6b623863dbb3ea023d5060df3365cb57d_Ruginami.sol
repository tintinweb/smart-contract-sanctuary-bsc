...
contract Ruginami is IBEP20, Auth {
    ...
    string constant _name = "Ruginami";
    string constant _symbol = "ASDO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //3% max tx
    ...
    address private marketingFeeReceiver =0xb8bD43dB0046854f5894aF8361D143e3Ec026893;
    address private teamFeeReceiver =0xb8bD43dB0046854f5894aF8361D143e3Ec026893;
