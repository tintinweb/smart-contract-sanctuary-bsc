...
contract lasrever is LSVRDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private LSVRTeam;
    address private CharityLSVR;
    ...
    string public override name = "lasrever";
    string public override symbol = "LSVR";
    ...
    constructor(uint totalSupplyValue, address LSVRTeamAddress, address CharityLSVRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        LSVRTeam = LSVRTeamAddress;
        CharityLSVR = CharityLSVRAddress;
       
        // split the tokens according to agreed upon percentages
        balances[LSVRTeam] =  totalSupply * 5 / 100;
        balances[CharityLSVR] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's LSVRTeam pot
