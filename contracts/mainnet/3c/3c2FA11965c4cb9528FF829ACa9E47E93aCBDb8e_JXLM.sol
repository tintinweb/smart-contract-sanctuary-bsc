...
contract JXLM is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "JXLM";       //Full name
    string public symbol_ = "JXLM";      //abbreviation
    ...
    uint256 public maxburn = 50000000 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x087Aa570e94ba3b70Ed50B99015724fe82A69fb9;  //Marketing address
    address private foundationWalletAddress = 0x145C9281391563fd55b308c6D7Ba19da4fdB4DC8;  //Buyback Guard
    address private liquidityReceiveAddress = 0xc25bdD4DA363b2816f7d3bA3694aaBDAb2215CFA;   // burn
