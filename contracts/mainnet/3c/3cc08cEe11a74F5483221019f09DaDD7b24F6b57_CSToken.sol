...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xc1C43cEc62cf72f2241FBa4d2773cd59f0f41080;    
...
contract CSToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x94b0d8d7fd386B4f12E152Bf21265c9fa655e3DC),  //
    
        address(0x62f827BA6c4144D101D4f8196561ed3579b02cDe) //
    ){
