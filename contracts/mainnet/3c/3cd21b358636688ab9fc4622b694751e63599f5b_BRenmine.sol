...
contract BRenmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyRenmine";
    string private _symbol = "BRenmine";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x07AC231616C69E5b25A723C61F8dA7ACB9D92c8a); // Buy Back Address
