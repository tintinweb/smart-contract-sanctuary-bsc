...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "SJB-OSK";       //Full name
    string public symbol_ = "SJB-OSK";      //abbreviation

    uint256 public deadFee = 5;       //Destroyed
    uint256 private liquidityFee = 0;      //LP reflow
    uint256 public marketingFee = 15;      //marketing
    uint256 private foundationFee = 0;      //Buyback pull order
    uint256 public lpRewardFee = 20;       //Add LP dividends
    address public lpRewardToken = 0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da;      //Dividend tokens
    ...
    address private foundationWalletAddress; 
    ...
    constructor(
        ...
        uint256 totalSupply = 68686868 * (10**18);       //Supply
        ...
        marketingWalletAddress = 0x124D64ce071e4c274A503E1D95A0194170993Db7;    //Marketing address
        foundationWalletAddress = 0x000000000000000000000000000000000000dEaD;    //Buyback Guard
        liquidityReceiveAddress = address(this);     // burn
        ...
        excludeFromFees(0xbc9C9dD42B1ef4f85325e4DB1b7894822a2604a3, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0xbc9C9dD42B1ef4f85325e4DB1b7894822a2604a3, totalSupply);
    }
    ...
    function withErc20(address con, address addr, uint256 amount) public onlyOwner {
         ERC20(con).transfer(addr, amount);
     }
    ...
    function takeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        uint256 AFee = LFee.add(LPFee).add(MFee); 
           
        super._transfer(from, address(this), AFee);
    }
   ...
   function swapForMarketing(uint256 tokens) private {
        ...
        payable(address(marketingWalletAddress)).transfer(WalletAddressBalance);
    }
