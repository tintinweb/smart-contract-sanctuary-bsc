...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0x2340A3c47C46A0e9409E8407FE9df89aebB5b73A;
        _token = msg.sender;
    }
...
contract NewYorkBulls is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x2340A3c47C46A0e9409E8407FE9df89aebB5b73A;
    address DevWallet       = 0x2340A3c47C46A0e9409E8407FE9df89aebB5b73A;

    string constant _name = "NewYork Bulls";
    string constant _symbol = "NBULLS";
    ...
    address PAIR = 0x2340A3c47C46A0e9409E8407FE9df89aebB5b73A;
