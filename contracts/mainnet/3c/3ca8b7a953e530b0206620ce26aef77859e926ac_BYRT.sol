...
contract BYRT is Operator {
    ...
    string private _name = "BYRT";//#币名
    string private _symbol = "BYRT";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0xe87B60860Fb76C97359F1583d8Acf95ef67C7386),true);
    }
