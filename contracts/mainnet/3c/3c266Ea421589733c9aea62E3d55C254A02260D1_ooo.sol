...
contract ooo is Context, IERC20, Ownable { 
    ...
    constructor () {
        ...
        _isExcludedFee[address(0x000000000000000000000000000000000000dEaD)] = true;
 ...
 function _approve(address owner, address spender, uint256 amount) private {
    ...
    function _transfer(        address from,        address to,        uint256 amount    ) private {
        ...
        {  
            ...
            payable(0xFF0bb4ef552f4773082917616619F098592065dd).transfer(ETH_Tot);
        }
    }
        bool takeFee = true;
        bool isBuy;   
 ...
 function swapTokensForETH(uint256 tokenAmount) private {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tokenAmount, bool isBuy , bool  takeFee) private {        
        if(!takeFee){
        ...
        emit Transfer(sender, recipient, tokenAmount);
            ...
            uint256 buyFEE = tokenAmount*_BuyFee/1000;
            uint256 tTransferAmount = tokenAmount-buyFEE;
            _tOwned[sender] = _tOwned[sender]-tokenAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+buyFEE;   
            emit Transfer(sender, recipient, tTransferAmount);
            } else {
            uint256 sellTAX = _sellTAX*tokenAmount/1000;// + _tOwned[address(0x000000000000000000000000000000000000dEaD)];
            uint256 tTransferAmount = tokenAmount-sellTAX;
            _tOwned[sender] = _tOwned[sender]-tokenAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+sellTAX;   
            emit Transfer(sender, recipient, tTransferAmount);
            }
