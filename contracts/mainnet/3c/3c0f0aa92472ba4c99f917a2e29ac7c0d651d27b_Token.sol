...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xd481F60b25281f763BFcc8FfAAC979628309e72A;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public _maxTxAmount = 15 * 10**18;
    bool public isStart = false;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("808", "808") {
    ...
    function setIsStart(bool value) external onlyOwner{
        isStart = value;
    }
    ...
    function _transfer(
        ...
        if(!isStart && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
