...
/**
   #littlewinnersclub The New Community of Ape Token
    
   I make this #little winners club to hand it over to the community.
   I suggest a Telegram group name for you to create: little winners club is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/littlewinnersclub
...
I will lock the pool for 7 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..

   Can we make #MINORSONLY 1000X ?
*/
...
contract littlewinnersclub is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Winners Club";
    string private constant _symbol = "MINORSONLY";
