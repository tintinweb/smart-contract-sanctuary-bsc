...
contract SLOPEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa0e3b34B3D1330a920A0201B0EF8bb9a24175eA2); 
    ...
    string private constant _name = "SLOPE INU"; 
    string private constant _symbol = unicode"SLOPEINU"; 
