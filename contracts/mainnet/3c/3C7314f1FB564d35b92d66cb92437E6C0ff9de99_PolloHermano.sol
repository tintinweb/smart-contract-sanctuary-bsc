...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEDbfceCb57eDEe9F07f5D79e019bbBec763C0246;
...
contract PolloHermano is Context, IERC20, Ownable {
    ...
    address public _ZgegWalletAddress = 0xb9f1E5bf005d5EB4009793f778085616Cf2b4c72;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PolloHermano";
    string private _symbol = "PHO";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 40;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _Zgegfee = 20;
    uint256 private _previousDevelopmentFee = _Zgegfee;
    ...
    function setZguegFeePercent(uint256 developmentFee) external onlyOwner() {
        _Zgegfee = developmentFee;
    }
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_ZgegWalletAddress] = _rOwned[_ZgegWalletAddress].add(rDevelopment);
        if(_isExcluded[_ZgegWalletAddress])
            _tOwned[_ZgegWalletAddress] = _tOwned[_ZgegWalletAddress].add(tDevelopment);
    }
    ...
    function calculateDevelopmentFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_Zgegfee).div(
            10**3
        );
    }
    ...
    function removeAllFee() private {
        ...
        _previousDevelopmentFee = _Zgegfee;
    ...
    function restoreAllFee() private {
        ...
        _Zgegfee = _previousDevelopmentFee;
