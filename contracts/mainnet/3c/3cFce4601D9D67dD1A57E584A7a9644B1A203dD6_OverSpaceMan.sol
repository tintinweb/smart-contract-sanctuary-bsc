...
contract OverSpaceMan is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0xdbE10Bb0a7F80843f279191bc434a69804cC7327;
    address private devWallet = 0xB0C6242c8111408c804183f2Af27e6B62ecFD3f1;
    address public buyBurnAddLiQ = 0x7F6d2d9a8fd661877A041ebAE9c62320eB1692dc;

    string private constant _name = "OverSpaceMan";
    string private constant _symbol = "OverSpaceMan";
    ...
    Taxes public taxes = Taxes(2, 5, 3, 0, 0);
    Taxes public sellTaxes = Taxes(2, 5, 3, 0, 0);
