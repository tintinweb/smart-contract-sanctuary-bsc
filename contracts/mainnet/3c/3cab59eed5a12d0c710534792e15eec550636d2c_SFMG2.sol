...
contract SFMG2 is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafemoonGrow 2.0";
    string private _symbol = "SFMGrow 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x682A857644FaA981E0B7F9f475A0e3A048a6Ef53); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x682A857644FaA981E0B7F9f475A0e3A048a6Ef53); // BuyBack Address
