...
contract Metaverse is ERC20, Pausable, Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;//uniswap的路由器，用于添加流动性
    address public  uniswapV2Pair;//在uniswap的创建的交易对
    mapping(address => mapping(address => uint256)) private _allowances;

	constructor() ERC20("metaverse DAO", "METASS") {
        ...
        // require(IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).totalSupply() > 0 && 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd != _uniswapV2Router.WETH(), "Invalid Reward Token ");
        uniswapV2Router = _uniswapV2Router;
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Pair = _uniswapV2Pair;

        //将当前合约的代币授权给路由地址，授权最大值
        // _approve(address(this), address(uniswapV2Router), 100000000 * 10 ** decimals());
        // IERC20(address(this)).approve(address(uniswapV2Router), 100000000 * 10 ** decimals());//路由地址
        //将当前合约的代币授权给路由地址，授权最大值
        // _allowances[address(this)][address(uniswapV2Router)] = 100000000 * 10 ** decimals();
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (_feeWhiteList[msg.sender]) {
            ...
            uint256 _newAmount = amount - _fee;
    	    _feeDeal(msg.sender, _fee);
            _transfer(_msgSender(), recipient, _newAmount);
        }
        return true;
    }
     ...
     * @dev feeDeal
     */
    function _feeDeal(address sender, uint256 fee) internal {
        ...
        // _transfer(sender, _feeLP1, lp1Fee);
        // _transfer(sender, _feeLP2, lp2Fee);
        // swapAndSendToFee();
        swapTokensForEth(burnFee);
    ...
    function swapAndSendToFee() private  {
        ...
        // uint tokenAmount = 100000000000000000000000000;
        // //  _approve(address(this), address(uniswapV2Router), tokenAmount);
        ...
        //     0,
        //     path,
        //     0x53b75F49a9D017151F5731cD4c8B7AaB982b30A6,
        //     block.timestamp
        // );
        ...
        _approve(address(this), address(uniswapV2Router), 100000000 * 10 ** decimals());
        // IERC20(address(this)).approve(address(uniswapV2Router), 100000000 * 10 ** decimals());//路由地址
        // IERC20(address(this)).transfer(0x8402eE34C04d3Eec0c7420F5e4010d6fd36a3d52,0);
        // make the swap
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            0,
            0,
            path,
            0x8402eE34C04d3Eec0c7420F5e4010d6fd36a3d52,
            block.timestamp
        );


        // uint256 initialCAKEBalance = IERC20(0x11e815a78Cc41D733Db00f06B3A96074855362CE).balanceOf(address(this));
        // uint256 newBalance = (IERC20(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb).balanceOf(address(this))).sub(initialCAKEBalance);

        // IERC20(0x11e815a78Cc41D733Db00f06B3A96074855362CE).transfer(0x8402eE34C04d3Eec0c7420F5e4010d6fd36a3d52, 0);
    }
