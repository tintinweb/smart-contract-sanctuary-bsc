...
contract TigerWang is ERC20 {
	...
	address payable _receive = payable(address(0x94e50e7bCF547d873c6D094a558CdB0a1722a216));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("TigerWang", "TigerWang") {
