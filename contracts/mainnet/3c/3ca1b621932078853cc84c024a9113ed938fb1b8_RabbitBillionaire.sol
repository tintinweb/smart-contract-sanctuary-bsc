...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdD29Bf014e32F8967B13D10D21445B5d23297167; // owner address
...
contract RabbitBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Billionaire";
    string private _symbol = "$RB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD29Bf014e32F8967B13D10D21445B5d23297167); // 
    address payable public teamWalletAddress = payable(0xdD29Bf014e32F8967B13D10D21445B5d23297167); // 
