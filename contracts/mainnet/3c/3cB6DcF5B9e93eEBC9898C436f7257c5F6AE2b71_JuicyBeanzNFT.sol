    ...
    PaymentSplitter 
{
    ...
    string public baseURI = "ipfs://QmQ8MTPfUZzXJBWLgWHMGhdUEiaLRgj2KAsK2pA6dc22Ft";
    ...
    uint256 _price = 500000000000000; // 0.05 BNB

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [40, 30, 30]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0x5Bd5076FB7E774d78245B6bC11994543Da261875,
        0xa6E9F53529E389A6596cD5c776F3e8c8CBEc8617, // Admin Account gets 25% of the total revenue
        0x76682a14DC43643d2CA30EB6a6ABbF8a6DB5b920 // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("JuicyBeanzNFT", "$BNZ")
    ...
    /**
     * Override isApprovedForAll to whitelist user's OpenSea proxy accounts to enable -less listings.
     */
