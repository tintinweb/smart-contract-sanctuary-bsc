 ...
 */
contract ArabianPUNK is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Arabian Punk";
    ...
    uint256 _sellTotalFee = _sellMarketingFee+_sellDevFee+_sellRewardsFee + _sellLiquidityFee;
        // Buy Fees
    uint256 _buyMarketingFee = 3;
    uint256 _buyDevFee = 2;
    uint256 _buyRewardsFee = 0;
    uint256 _buyLiquidityFee = 3;
    uint256 _buyTotalFee = _buyMarketingFee+_buyDevFee+_buyRewardsFee+_buyLiquidityFee;

    // Team Wallet & Dead address
    address private developmentWallet = 0x52A71345f23cFb191152F742aDD8cbdC26Ebf94b;
    address private marketingFeeReceiver = 0x52A71345f23cFb191152F742aDD8cbdC26Ebf94b;
