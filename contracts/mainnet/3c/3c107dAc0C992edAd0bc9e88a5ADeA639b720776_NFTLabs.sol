...
contract NFTLabs is Ownable, ERC721, ERC721Enumerable {
    ...
    constructor(string memory name, string memory symbol, address _paymentToken, uint256 price, uint256 _resalesFee, uint256 _startDate) ERC721(name, symbol) {
    ...
    function _rewardWeight(uint256 tokenId, uint256 at) view public returns (uint256) {
        TokenLockInfo memory tokenLockInfo = mapTokenLockInfo[tokenId];
    ...
    function _totalRewardWeight(uint256 at) public returns (uint256) {
