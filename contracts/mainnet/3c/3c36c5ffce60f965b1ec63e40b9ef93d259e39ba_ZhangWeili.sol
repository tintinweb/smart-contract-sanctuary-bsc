...
contract ZhangWeili is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZWL";
    string private _symbol = "ZWL";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x100c8ce1DFcC39427F117064686A61B128b66326); 
    address payable public BurnedWalletAddress = payable(0x100c8ce1DFcC39427F117064686A61B128b66326); 
