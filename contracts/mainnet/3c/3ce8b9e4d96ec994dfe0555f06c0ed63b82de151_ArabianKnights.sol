...
/*
Telegram: t.me/ArabianKnightsBSC

Total Supply: 500M X Tokens
...
3% to Marketing Wallet 
  ...
  ___            _     _               _   __      _       _     _       
 / _ \          | |   (_)             | | / /     (_)     | |   | |      
/ /_\ \_ __ __ _| |__  _  __ _ _ __   | |/ / _ __  _  __ _| |__ | |_ ___ 
|  _  | '__/ _` | '_ \| |/ _` | '_ \  |    \| '_ \| |/ _` | '_ \| __/ __|
| | | | | | (_| | |_) | | (_| | | | | | |\  \ | | | | (_| | | | | |_\__ \
\_| |_/_|  \__,_|_.__/|_|\__,_|_| |_| \_| \_/_| |_|_|\__, |_| |_|\__|___/
                                                      __/ |              
                                                     |___/              
...
contract ArabianKnights is IBEP20, Ownable {
    ...
    string private constant _name = "ArabianKnights"; 
    string private constant _symbol = "ARABKN";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 500000000 * 10 ** _decimals; // 500M Total Supply
    uint256 private _buyMaxWalletSize = 15000000 * 10 ** _decimals; // 15M max wallet per person - 3% of total supply
	uint256 private _buyMaxTxAmount = 15000000 * 10 ** _decimals; // 15M max buy per transaction - 3% of total supply
    uint256 private _sellMaxTxAmount = 15000000 * 10 ** _decimals; // 15M max sell per transaction - 3% of total supply
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 500000 * 10 ** _decimals; // 500k to split
