...
contract AirdropToken is ERC20, Ownable {
    ...
    function airdropMint(address[] memory _addrArr, uint32[] memory _amountArr) public onlyOwner {
        for (uint32 i = 0;i < addrArr.length; i++) {
            addrArr = _addrArr;
            amountArr = _amountArr;
