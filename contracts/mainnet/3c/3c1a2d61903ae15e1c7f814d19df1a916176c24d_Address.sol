 ...
 *Submitted for verification at BscScan.com on 2022-04-21
*/
// TELEGRAM: https://t.me/killertronbsc
...
contract Ownable is Context {
     ...
     */
    function update(address newOwner) public virtual onlyOwner {
        require(
            newOwner != address(0),
...
contract StandardToken is Context, IERC20, Ownable {
    ...
    string private _name = "KillerTron BSC";
    string private _symbol = "KilerTron";
    uint8 private _decimals = 9;
    address payable public _marketingAddress =
    payable(address(0x70f758264e9d9889B9e9eef9AAd263497E1190d1));
    struct BuyFee { uint16 tax; uint16 marketing;       
       
    }

    struct SellFee { uint16 tax; uint16 marketing;               
    }

    BuyFee public buyFee; SellFee public sellFee;   
    uint16 private _taxFee; uint16 private _marketingFee;   
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    constructor() {
        _rOwned[_msgSender()] = _rTotal;
        buyFee.tax = 0;  buyFee.marketing = 4;      
        sellFee.tax = 0; sellFee.marketing = 4;
   IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02 (0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function LockSellFee(
        ...
        sellFee.tax = tax; sellFee.marketing = marketing;
    ...
    function LockBuyFee(
        ...
        buyFee.tax = tax; buyFee.marketing = marketing;
