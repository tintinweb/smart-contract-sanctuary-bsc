...
contract AriesX is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
        wallet1 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
        wallet2 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
        wallet3 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
        wallet4 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
        wallet5 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
        wallet6 = 0xb09c21062923dEcEc3B50364512e219e053Cf8F9;
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "AriesX: minting has not started yet");
    require(_mintAmount > 0, "AriesX: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "AriesX: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "AriesX: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "AriesX: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "AriesX: zero address");
    require(_amount > 0, "AriesX: you have to mint at least one");
    require(lastSupply != 0,  "AriesX: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"AriesX: URI query for nonexistent token");
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 wallet1Share = _amount.mul(10).div(100);
