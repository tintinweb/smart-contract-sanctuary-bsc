...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0xF458C4C77a02883ECd1d1868f6B5D3d86E82C797;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0x4cac2163474d67d52a4240CAF022a910d3D3AC8f;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0xE1397eA52c094Bd5a59901edDf8a9194eA8171D7;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "COBAINDONG";
  string private _symbol = "CBAJA";
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "LAH: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "LAH: transfer from the zero address");
    require(recipient != address(0), "LAH: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "ELAHRC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "LAH: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "LAH: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "LAH: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "LAH: approve from the zero address");
    require(spender != address(0), "LAH: approve to the zero address");
