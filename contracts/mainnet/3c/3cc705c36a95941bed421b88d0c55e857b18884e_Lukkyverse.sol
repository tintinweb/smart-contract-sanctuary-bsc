...
contract Lukkyverse is Context, IERC20, Ownable {
    ...
    address payable public _marketingWallet = payable(address(0x0DB2C14431A6287A286737bD66AdAb168aD1d425));
    address payable private _buybackWallet = payable(address(0x0A7B5575cF5E0DD05816AF7085C33EFD582DEF5c));
