...
/**
A NAVIGATION APP THAT WILL PAY YOU TO USE OUR MAPS TO DRIVE! WILL BE INTEGRATED WITH WAZE!
*/
...
contract WAZE2EARN is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'WAZE2EARN';
