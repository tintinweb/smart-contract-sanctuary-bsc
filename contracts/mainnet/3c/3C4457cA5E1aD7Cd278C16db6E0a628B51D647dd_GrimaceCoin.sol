...
//TG: https://t.me/GrimaceCoinGrimaceCoinGrimaceCoi
...
contract GrimaceCoin is Context, IERC20 {
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x23b8585eAf243c4F4C60854409c6b4fa03Ff8205);
        ...
        emit Transfer(address(0), address(0xa6941b3e98bF846196B0A1250aCfDf079b4263B5), _tTotal);
    }
    ...
    function updateMarketingWallet(address newWallet)external onlyOwner{tradingStatus(false);}
