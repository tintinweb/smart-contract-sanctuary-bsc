...
/**
🎖 BUSDGOLD 🥇READY FOR LAUNCH 🥇 HODL & EARN 🎖 LFG!

BUSDGOLD is a community-driven token on Binance Smart Chain with low tax, hold $BUSDGOLD in your wallet and watch your tokens amount grow. Each transaction will deduct a fee to be distributed to holders as %4 BUSD reflections, %2 LP,Rewards and marketing.

🥇Buy and Sell Tax %6
🥇%4 BUSD Reflections
🥇%2 Auto Add LP
🥇Swap + Staking SOON!
🥇Website & Twitter After launch Available!

TG: https://t.me/BUSDgoldbsc
*/
...
contract BUSDGOLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x22159A9fEE9fe20822762CC51e94b7B6CBD48797); 
    address payable public Wallet_Dev = payable(0xD2EA9b4b8Ffdc3b718A15300518D1A714a11Ca47);
    ...
    string private constant _name = "BUSD Gold"; 
    string private constant _symbol = unicode"BUSDGOLD"; 
    ...
    constructor () {
        ...
        _owner = 0xD2EA9b4b8Ffdc3b718A15300518D1A714a11Ca47;
