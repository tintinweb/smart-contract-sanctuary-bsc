...
contract VALENTINESM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VALENTINE SAFEMOON";
    string private _symbol = "VALENTINESM";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xDf470e498f3916CE850081085F7449F6fF92c2d0); // Marketing Address
    address payable public BuyBackWallet = payable(0xDf470e498f3916CE850081085F7449F6fF92c2d0); // Team Address
