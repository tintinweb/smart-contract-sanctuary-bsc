...
contract BabyFPSBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby FPS Burn";
    string private constant _symbol = "bFPSBURN";
