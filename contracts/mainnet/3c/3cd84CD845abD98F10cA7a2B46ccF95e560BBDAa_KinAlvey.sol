...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7F1d71f90a3639e88DfF314B86f3b793278Ecb1B; // owner address
...
contract KinAlvey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kin Alvey";
    string private _symbol = "Kin Alvey";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7F1d71f90a3639e88DfF314B86f3b793278Ecb1B); // Marketing Address
    address payable public teamWalletAddress = payable(0x7F1d71f90a3639e88DfF314B86f3b793278Ecb1B); // Team Address
