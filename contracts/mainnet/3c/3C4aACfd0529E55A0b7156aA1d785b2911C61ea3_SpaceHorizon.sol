...
contract SpaceHorizon is ERC20, Ownable {
    ...
    constructor() ERC20("Space Horizon Coin", "SHC") {
    ...
    function changeFees(uint16 _feeliq_buy, uint16 _feeliq_sell) external onlyOwner{
        require(_feeliq_buy <= 7, "buy tax to high");
        feeliq_buy = _feeliq_buy;
        require(_feeliq_sell <= 7, "sell tax to high");
