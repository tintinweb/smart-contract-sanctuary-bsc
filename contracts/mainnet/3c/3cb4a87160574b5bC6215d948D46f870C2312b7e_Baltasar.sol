...
contract Baltasar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baltasar Graci\u00e1n";
    string private _symbol = "Baltasar Graci\u00e1n";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00bb7a8De73959213b2E9A42578074A17612EaC9); // Marketing Address
    address payable public teamWalletAddress = payable(0x1bC7b748642572De13a5516A474c84E768f0B09a); // Team Address
