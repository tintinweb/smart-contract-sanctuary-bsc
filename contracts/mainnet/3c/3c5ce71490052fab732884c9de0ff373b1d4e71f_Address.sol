...
library Address{
 ...
 contract ElonsEight is Context, IERC20, Ownable { 
    ...
    address public marketingWallet = 0x237c9C64Edb6E6e2eC9aFdc1E2D46007f66126c5;
    address public developer = 0xE9bC69D2c66B332ffB34CE9ce3869f0539c5cAB2;

    string private constant _name = "Elons Eight";
    string private constant _symbol = "Elons8";
    ...
    Taxes public taxes = Taxes(0, 5, 5, 10);
    Taxes public sellTaxes = Taxes(0, 5, 5, 10);
