...
/**
FNX Token Miner
 Hire Farmers, Gather Crops, Harvest Crops and Sell for FNX tokens. 
  8% daily daily Rate
  8% Referral Bonus, will go directly to referrer wallet.
  2% stacking compound bonus every 12 hrs, max of 5 days. (Max. 20%)
  48 hours cut off time.
  1,000,000 FNX minimum investment.
  1,000,000,000 FNX max deposits per wallet.
...
contract FNXMiner {
    ...
    address erctoken = 0x3F6d17676a2896D80F4a33c412eC04025679a48F; /** FNX Mainnet **/
    ...
    uint256 public MIN_INVEST_LIMIT = 1000000 * 1e9; /** 10 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 1000000000 * 1e9; /** 10000 BUSD  **/
