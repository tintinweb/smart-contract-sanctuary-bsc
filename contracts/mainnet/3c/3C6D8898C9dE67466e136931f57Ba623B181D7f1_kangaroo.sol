...
contract kangaroo is Context, IERC20, Ownable {
    ...
    function increasepercentage(uint256 maxTXPercentage) external onlyOwner {
    ...
    function changeMax(uint256 amount) external onlyOwner {
     ...
     function totalsupply(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
