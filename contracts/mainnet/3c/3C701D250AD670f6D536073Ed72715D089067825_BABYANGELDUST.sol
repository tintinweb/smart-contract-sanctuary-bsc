...
contract BABYANGELDUST  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY ANGEL DUST";
    string private constant _symbol = "BAD";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 43000* 10**_decimals;
    uint256 public _maxTxAmount = 43000* 10**_decimals;
    uint256 public swapTokenAtAmount = 43000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x959Ed916aC025C9c8C799bc56be5757B79762181);
    address private liquidityReceiver = address(0x959Ed916aC025C9c8C799bc56be5757B79762181);
