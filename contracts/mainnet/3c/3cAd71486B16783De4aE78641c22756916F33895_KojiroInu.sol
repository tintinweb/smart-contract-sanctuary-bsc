...
/*
KojiroInu - The Next Gem Token in BSC
A samurai dog that wield two swords, KojiroInu is ready to cut down all the way in BSC. By having a bullish name & an experienced Dev, KojiroInu is one of the tokens that has huge potential.

1) 8% of buy & sell tax
2) Previous project, DHBNB -> ATH 100K
3) Bullish name
4) Based Dev that is experienced in BSC

TG : https://t.me/KojiroInu
*/
...
contract KojiroInu is Context, IERC20 { 
    ...
    string private constant _name = "KojiroInu"; 
    string private constant _symbol = "KojiroInu"; 
