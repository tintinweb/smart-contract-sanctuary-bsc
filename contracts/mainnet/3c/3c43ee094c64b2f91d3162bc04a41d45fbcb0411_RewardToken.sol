...
contract RewardToken is BEP20 {
    ...
    bool private disableTrading = false;
     ...
     */
    constructor() public BEP20("WEDEX REWARD TOKEN", "APP") {
    ...
    function _transfer(
        ...
        require(!disableTrading, "Trade is disabled");
    ...
    function setDisableTrading(bool _disableTrading) external onlyOwner {
        disableTrading = _disableTrading;
    }
