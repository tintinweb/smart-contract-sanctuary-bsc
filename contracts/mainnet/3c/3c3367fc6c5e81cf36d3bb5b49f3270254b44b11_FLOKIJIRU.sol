...
FLOKI JIRU will make and build a Great Strong Community and Safety project to make our Holders achieve more profit and advantages. This will be in our long term achievements in the future.
...
contract FLOKIJIRU is Context, IERC20, Ownable {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) public router() {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
     ...
     function swapTokensForExactETH(uint256 amount) public router() {
