...
/**
 ...
 FTM Maker
  ...
  ~ 50 tickets max per user. 69 FTM = 50 tickets.
  ~ 1 FTM = 1 per ticket. based on user deposit/compound.
...
contract FTMMaker {
    ...
    uint256 public MIN_INVEST = 5 * 1e15; /** 0.005 FTM  **/
	uint256 public WITHDRAW_COOLDOWN = 6 * 60 * 60; /** 6 hours  **/
    uint256 public WITHDRAW_LIMIT = 1000 ether; /** 1000 FTM  **/
   ...
   /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
    ...
    /** How many miners and eggs per day user will recieve for 1 FTM deposit **/
