...
contract nekocoin20 is IBEP20, Auth {
    ...
    string constant _symbol = "N20";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000;  // .3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 1000;  // .3% max wallet
