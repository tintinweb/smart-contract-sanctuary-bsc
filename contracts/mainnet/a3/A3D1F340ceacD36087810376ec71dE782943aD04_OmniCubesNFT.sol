...
// File: contracts/OmniCubesNFT.sol
...
contract OmniCubesNFT is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT = 4444;

    bool public isMintActive = false;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("OmniCubesNFT", "CUBE") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(msg.value > 530000000000000);
