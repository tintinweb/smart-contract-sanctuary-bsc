...
address public charityAddress =  0xe5756A95F265Eacd0CbE0bA9AABb4CFC3426b2A0;
     ...
     * Can only be called by the current operator.
     */
    // function changeLotteryAmount(uint256 newAmount) public virtual onlyOperator {
     ...
     * Can only be called by the current owner.
     */
    function changeLotteryAmount(uint256 _newMin) public virtual onlyOwner {
    ...
    /** @dev Change amount new charity tax (`_newCharityAmount`).
     * Can only be called by the current owner.
     */
    function changeCharityAmount(uint16 _newCharityAmount) public virtual onlyOwner {
        _taxToCharity = _newCharityAmount;
    }
