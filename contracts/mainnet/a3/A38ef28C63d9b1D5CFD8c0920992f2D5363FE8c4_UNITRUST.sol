...
/**
    ...
    Tax: 
    0% buy 
    25% sell at launch, After 15 mins we will reduce the tax be 10%

    https://t.me/unitrustbsc_portal
   */
...
contract UNITRUST is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "UNITRUST";
