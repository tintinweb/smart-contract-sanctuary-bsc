...
contract PriceAndRate is Configurable {
    ...
    mapping(address => address) public priceFeeds; //token => Aggregrator
    ...
    function getPriceAndRate(address token,bytes32 currency) public view returns (int price, uint rate){
