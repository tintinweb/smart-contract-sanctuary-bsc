...
//Join Our TG! https://t.me/ReinshibaInuPortal
//Owner Of @dylandirtycalls
...
contract REIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rein Shiba Inu";
    string private _symbol ="$REINSHIB";
