...
/*
https://t.me/happybirthdayelonmuskportal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6EEc76f4f5543a600ECdF89dF95aab84C3f95068; // owner address
...
contract HBDElonMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Happy Birthday Elon Musk";
    string private _symbol = "HBDELONMUSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5893BF88Cb5298CDd193C8a1E95904db17Bc670D); // Marketing Address
    address payable public teamWalletAddress = payable(0x5893BF88Cb5298CDd193C8a1E95904db17Bc670D); // Team Address
