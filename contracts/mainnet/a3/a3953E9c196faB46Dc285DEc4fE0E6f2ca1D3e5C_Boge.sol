...
/*
The BOGECOIN MANIFESTO:

BOGE (BINANCE DOGE) IS THE FIRST COMMUNITY OWNED AND OPERATED DOGE COIN ON THE BINANCE NETWORK.
BOGE BRINGS BACK THE ESSENCE OF COMMUNITY IN BSC TO MAKE IT GREAT AGAIN! THE COMMUNITY IS WHAT WILL MAKE BOGE THE 
BEST PERFORMING MEMECOIN IN BSC HISTORY. 

THE GOAL OF THIS TOKEN IS TO REACH OUR DAD'S MARKETCAP AND TO BE A DEFLATIONARY IMPROVEMENT IN DOGE COIN'S TOKENOMICS, WHILE OFFERING A 
LOW TAX ALTERNATIVE TO ALL THE COINS PLAGUING THE BINANCE ECOSYSTEM TODAY!

THE TAX IS ONLY 3%

1% OF EVERY TRANSACTION IS BURNT FOREVER, THUS MAKING THE SUPPLY EVER REDUCING!

COMMUNITY SLOGAN:
BOGE MAKES BSC GREAT AGAIN
*/
...
contract Boge is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 10000000 * 10**9; //1%
