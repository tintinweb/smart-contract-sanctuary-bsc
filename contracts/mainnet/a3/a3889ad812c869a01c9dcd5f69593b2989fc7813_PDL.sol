...
contract PDL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "PDL";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5452584EA7931C5F82E86a6E2f904C3E1eC6654e

));
        marketingWalletAddress = payable(address(0xB88FF7AeB1a078c0C45Bdd14264ea50d9500736E
));
