...
telegram : https://t.me/GoofyGo0ber
Website  : https://goofygoober.medium.com/
...
contract GOOFYGOOBER is Context, IERC20, Ownable {
    ...
    string private _name = "GOOFY GOOBER";
    string private _symbol = "GG";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x995f782d3B255bA3990e29051b554091FE1470F9);
    ...
    constructor () {
        ...
        _maxBalance = 3000 * 10**9 * 10**_decimals;
