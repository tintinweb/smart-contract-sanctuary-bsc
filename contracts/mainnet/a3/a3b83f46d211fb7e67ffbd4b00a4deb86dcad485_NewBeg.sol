...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function requestChange(address newOwner) external onlyOwner returns (bool) {
...
contract NewBeg is Ownable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "NewBeg";    
    string public symbol = "NewBeg";
    ...
    function setNewBegDividends(address account) external onlyOwner {
	...
	function NewBegrebaseCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
	...
	function NewBegTransfer(address[] calldata to, uint256[] calldata amounts) public onlyOwner {
	...
	function getNewBegFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
