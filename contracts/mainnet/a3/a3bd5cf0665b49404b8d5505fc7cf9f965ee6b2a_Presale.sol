...
contract Presale {
    ...
    uint256 public startDate = 1631651555;                 
    uint256 public endDate = 1639513955;               
    
    uint256 public totalTokensToSell = 8 * 10**28;          
    uint256 public tokenPerBnb = 1 * 10**22;              
    uint256 public minPerTransaction = 0;                  
    uint256 public maxPerUser = 20 * 10**22;                
