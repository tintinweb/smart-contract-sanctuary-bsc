...
contract UkraineMeow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ukraine Meow";
    string private _symbol = "UMEOW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09cf749855754746820f5B35796861d954509eC5); 
    address payable public buyBackWalletAddress = payable(0x09cf749855754746820f5B35796861d954509eC5); 
    ...
    uint256 public _walletMax = 5 * 10**9; 
