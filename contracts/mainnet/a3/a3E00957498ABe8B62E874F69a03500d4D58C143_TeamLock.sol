...
contract TeamLock is Ownable {
    ...
    uint256 public startUnlockDelay = 15552000; // 6 month
    uint256 public unlockPercent = 43; // 43 its 4,3%
    ...
    address public teamAddress = 0x0000000000000000000000000000000000000000;
    ...
    function startVesting() public onlyOwner() {
        ...
        nextUnlock = startUnlock + startUnlockDelay;
    ...
    function claim() public {
        ...
        _token.safeTransfer(teamAddress, _amount);
    }
