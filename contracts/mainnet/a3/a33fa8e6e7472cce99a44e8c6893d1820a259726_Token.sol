...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c559F3D6F18FA8DB09b9527C21AE03AA76716fb;
...
contract Token is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x92647BE0C25aB387B5AB527eCa8800ae242903DD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TravisScott FanToken";
    string private _symbol = "FanTS";
