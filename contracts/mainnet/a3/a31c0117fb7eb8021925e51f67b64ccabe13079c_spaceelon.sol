...
contract spaceelon is Context, IERC20, Ownable {
    ...
    string private _name = "Space Elon";
    string private _symbol = "spl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1d1959040caDbBD7640dbd17448DCF36528c8428);
    address payable public teamWalletAddress = payable(0x2D31d88Ac395435796a0b29d4B5d2570EdA60701);
