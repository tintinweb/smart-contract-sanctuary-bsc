...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4734bf61A1211A7DE57bD6CCdB8f8deD3F336502; // owner address
...
contract ShirokiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIROKI INU";
    string private _symbol = "SHROKI";
