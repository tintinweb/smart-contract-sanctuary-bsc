...
/**
Earn $CAKE token by holding $ShibaXCat 🤑
It couldn’t be much more easier 🥞

💫Hold $ShibaXCat and earn 7% CAKE reflection!
...
contract ShibaXCat is Context, IERC20, Ownable {
    ...
    string private _name = 'Shiba X Cat';

    string private _symbol = 'ShibaXCat';
