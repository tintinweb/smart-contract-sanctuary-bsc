...
contract DAO is ERC20Capped, Orchestrated {
    ...
    constructor() ERC20Capped(700000 * (10 ** 18)) ERC20("BSC DAO", "DAO") {
        white[address(this)] = true;
        white[_msgSender()] = true;
        ERC20._mint(msg.sender, 700000 * (10 ** 18));
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!senderLimit || !isContract(from) || senderWhite[from] || white[from] || white[to] || address(0) == from, "DAO Token: senderLimit");
        require(!recipientLimit || !isContract(to) || recipientWhite[to] || white[from] || white[to], "DAO Token: recipientLimit");
    }
