...
contract InfinityShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Infinity Shiba";
    ...
    address payable private _marketingWallet = payable(0x950D858e6481bbC85dC4E186119238B984D5D2f1);
    address payable private _devWallet = payable(0x2D530F68cC3e4287C6E7BCDAEf43237D6bA3E6a4);
