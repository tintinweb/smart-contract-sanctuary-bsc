...
library Address{
 ...
 contract CalebCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "CalebCoin";
    ...
    Taxes public taxes = Taxes(0, 0, 2, 1);
    Taxes public sellTaxes = Taxes(0, 0, 2, 1);
