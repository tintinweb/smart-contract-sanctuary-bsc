...
contract DaughterOfSatan is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xa73F92cF895B3F7b57181D33362e0629F884eb82);
    ...
    string private constant _symbol = unicode"$DOF";
    ...
    constructor() {
        _owner = 0xa73F92cF895B3F7b57181D33362e0629F884eb82;
