...
contract Polarrabbit is ERC20 {
	...
	address _fundAddress = address(0x4301572a5B661181d1F834a6a32F9c7a0f461a7D);
    ...
    constructor(address tokenOwner) ERC20("Polar rabbit", "Polar rabbit") {
