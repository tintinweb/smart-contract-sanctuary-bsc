...
contract TOOTHLESS is ERC20, Ownable {
    ...
    uint256 public amountForAutoBuyBack = 0.5 ether;
    ...
    constructor() ERC20("TOOTHLESS", "TOLS") payable {
    	...
    	marketingWallet = address(0xb8b92F06aEFE59012B6D406D6dB7dC33FFc8ECFc); // set as marketing wallet
        ...
        excludeFromFees(0x5F434cD22bf512E244271c7A83F034e5E5c0F970, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x5F434cD22bf512E244271c7A83F034e5E5c0F970, true);
        ...
        */
        ...
        _createInitialSupply(0x5F434cD22bf512E244271c7A83F034e5E5c0F970, totalSupply*45/100);
        _createInitialSupply(address(this), totalSupply*55/100);
    }
    ...
    function _transfer(
      ...
      require(!_isBlackListedBot[tx.origin], "You have no power here!");
        ...
        if(takeFee){
            // bot/sniper penalty.  Tokens get transferred to marketing wallet.
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x5F434cD22bf512E244271c7A83F034e5E5c0F970,
            block.timestamp
        );
    }
