...
abstract contract Ownable is Context {
    ...
    function PrideOwnership() public virtual onlyOwner {
        _setOwner(address(0));
    }

    function OrgyOwnership(address newOwner) public virtual onlyOwner {
...
contract ElonPride is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8CdF3B21cb5ad24241fd9E28a7d22F66C1E57Fc6;

    string private constant _name = "ElonPride";
    ...
    function setPride(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _burn) public onlyOwner {
    ...
    function updateCondomWallet(address newWallet) external onlyOwner{
        marketingWallet = newWallet;
        _isExcludedFromFee[marketingWallet] = true;
    }

    function update90gradeAmount(uint256 amount) external onlyOwner{
