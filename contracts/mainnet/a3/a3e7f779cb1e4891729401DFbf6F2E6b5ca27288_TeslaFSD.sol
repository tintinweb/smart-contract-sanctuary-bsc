...
contract TeslaFSD is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 106931 * 1e9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Tesla FSD  10.69.3.1"; // token name
    string public _symbol = "TESLAFSD"; // token ticker
    ...
    uint256 public minTokenToSwap = 106 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 106931 * 1e9;
    uint256 public minBuyLimit = 106931 * 1e9;
