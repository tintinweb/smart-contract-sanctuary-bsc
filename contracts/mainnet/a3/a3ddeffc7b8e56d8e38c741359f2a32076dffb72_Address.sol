...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d569645aA60715B09Bc759E54Acdde18d3B8381;
...
contract VoxDeiInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2F9DCC8577Fc1a8006bB743Cc3e1C15A91266D49;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VoxDeiInu";
    string private _symbol = "VDI";
