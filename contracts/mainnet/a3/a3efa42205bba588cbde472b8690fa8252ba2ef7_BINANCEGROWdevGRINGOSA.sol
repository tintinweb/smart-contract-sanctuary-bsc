...
/* Token contract */
contract BINANCEGROWdevGRINGOSA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BINANCE GROW";
    string constant _symbol = "BNG";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 150) / 10000; // 1.5% on launch or 15k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 100) / 10000; // 1% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 150) / 10000; // 1.5% or 15k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x20627C055166d3baaf991ae1DCF8d71fa4Fa5E01;
        devFeeReceiver = 0xd8c4C9EbfB1b6F8dfe1A096f1c3590cBFdFb8bbd;
