...
contract LoveBank is ReentrancyGuard, AccessControlEnumerable {
    ...
    function restart(uint256 depositIndex) external {
        ...
        require(block.timestamp > deposits[msg.sender][depositIndex].createTimestamp + restartWaitingTime * INTERVAL, "LoveBank: this deposit not satisfy to restart.");
