...
contract Shiba2023 is IBEP20, Auth {
    ...
    address DEV = 0x35124c2F0A6e884E74235B06a4B60309b3CC6dcd;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Shiba 2K23";
    string constant _symbol = "SHIBA2K23";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2023000000000 * (10 ** _decimals); 
