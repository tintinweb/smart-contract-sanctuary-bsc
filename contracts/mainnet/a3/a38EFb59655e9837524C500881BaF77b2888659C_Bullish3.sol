...
contract Bullish3 is ERC20, Ownable {
    ...
    constructor() ERC20("Bullish3", "BULLISH") {
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 100, "transfer fee cannot exceed 100%");
    ...
    function updateFees(
        ...
        require(totalSellFees <= 20 && totalBuyFees <= 99, "total sell fees cannot exceed 20%");
