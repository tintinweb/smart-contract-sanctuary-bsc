...
contract filiarToken is IERC20, Ownable {
    ...
    address public bep20fil = 0x0D8Ce2A99Bb6e3B7Db580eD848240e4a0F9aE153;
    address public marketingAddress = 0xcf2B5E097bDDC9B5dd1e8b7613646D1Fbb39bd85;
    address public reflowAddress = 0xd639d7773dB4083A83c2e92C84F5E00b2d55B2f0;

    uint256 private _tFeeTotal;

    string private _name = "FILIAR";
    string private _symbol = "FILIAR";
    ...
    uint256 public _reflowFee = 200;
    uint256 private _previousReflowFee;

    uint256 currentIndex;
    uint256 private _tTotal = 121000000 * 10**_decimals;
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), bep20fil);
        ...
        _isExcludedFromFee[reflowAddress] = true;
    ...
    function setReflowFee(uint256 fee) public onlyOwner {
        _reflowFee = fee;
    }

    function setReflowAddress(address _address) public onlyOwner {
        reflowAddress = _address;
    }

    function resetLPFeefenhong() public onlyOwner {
        LPFeefenhong = 0;
    }
    ...
    function _takeburnFee(address sender, uint256 tAmount) private {
        ...
        if (_tFeeTotal >= 100000000 * 10**_decimals) _burnFee = 0;
    ...
    function _takeReflowFee(address sender, uint256 tAmount) private {
        if (_reflowFee == 0) return;
        _tOwned[reflowAddress] = _tOwned[reflowAddress].add(tAmount);
        emit Transfer(sender, reflowAddress, tAmount);
    }
    ...
    function _transferStandard(
        ...
        _takeReflowFee(sender, tAmount.div(10000).mul(_reflowFee));
