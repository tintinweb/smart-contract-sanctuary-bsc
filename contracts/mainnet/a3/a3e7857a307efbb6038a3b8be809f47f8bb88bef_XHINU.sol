...
contract XHINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x85e19CB5A740D688a159E87192884eCa56fb4356);
    address payable public Wallet_Dev = payable(0x2BfF01Ce9A4c6532B028d7F7290926b7bB488e0c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "xHamster Inu"; 
    string private constant _symbol = unicode"XHINU";
