...
contract ETHW is Operator {
    ...
    string private _name = "ETHW";//#币名
    string private _symbol = "ETHW";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x108A5BAA718084fa6E7c03DadE3D1a996130238c),true);
    }
