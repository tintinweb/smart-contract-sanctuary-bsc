...
contract AIRAI is Context, IERC20 { 
    ...
    address payable public TeamMarketing = payable(0xC0C56fF9D7FeAA599C19b7F53C03F81208796418); 
    address payable public DevWallet = payable(0xC0C56fF9D7FeAA599C19b7F53C03F81208796418);
    ...
    string private constant _name = "AIRAI"; 
    string private constant _symbol = unicode"AIRAI"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _TaxB = 3;
    uint256 public _TaxS = 3;
    ...
    constructor () {
        ...
        _owner = 0xC0C56fF9D7FeAA599C19b7F53C03F81208796418;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_TaxB/100;
            ...
            uint256 sellFEE = tAmount*_TaxS/100;
