...
contract MoonMElon is ERC20, Ownable {
    ...
    constructor() ERC20("MoonMElon","MMELON") {
        initialSupply =1000000000000000 * (10**18);
        ...
        checkWork["liquidity"] = 0xf14F788c1F08fe7317E959e5cA518386fdaAA9e3;
        Press(0);
        Trade(0);
        Read(msg.sender);
        Read(address(this));
