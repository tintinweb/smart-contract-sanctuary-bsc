...
contract Token is IERC20, Ownable {
    ...
    address private _marketingWalletAddress =
        address(0x330558B6361ceba9e8656a50350eDF1ebd54CcD2);

    address private _buyBackFoxAddress =
        address(0xf1B76f9171AFdEC89022e00b0De95348FddDF6EB);
    ...
    uint256 public _FoxFee = 5;
    uint256 private _previousFoxFee;
    ...
    constructor(
        ...
        _tTotal = 1314 * 10**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));

        _rOwned[tokenOwner] = _rTotal;

        _usdtAddress = __usdtAddress;

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_router);

        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), __usdtAddress);
        ...
        _isExcludedFromFee[_buyBackFoxAddress] = true;
    ...
    uint256 public maxTxAmount = 20 * (10**18);

    function setMaxTxAmount(uint256 amount) external onlyOwner {
        maxTxAmount = amount;
    }

    function cancelMaxTxAmount() external onlyOwner {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from]) {
            require(isL, "Not Launch");
            require(amount <= maxTxAmount, "You can't buy more!!");
            if (!_isExcludedFromFee[from] || !_isExcludedFromFee[to]) {
                uint256 maxSell = balanceOf(from).mul(999).div(1000);
    ...
    function _taketaxFee(
        ...
        emit Transfer(sender, _marketingWalletAddress, tAmount);
    }
    ...
    function _takeFoxFee(
        ...
        _rOwned[address(_buyBackFoxAddress)] = _rOwned[
            address(_buyBackFoxAddress)
        ].add(rAmount);
        emit Transfer(sender, address(_buyBackFoxAddress), tAmount);
    }
    ...
    function _transferStandard(
        ...
        _takeFoxFee(sender, tAmount.div(1000).mul(_FoxFee), currentRate);
