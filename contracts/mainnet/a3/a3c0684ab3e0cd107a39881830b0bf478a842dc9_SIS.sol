...
contract SIS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SIS Token";
    ...
    function blacklist_add(address addr) public onlyOwner {
        require(addr != address(0));
        blacklist[addr] = true;
        blacklist_length++;
    }

    function blacklist_remove(address addr) public onlyOwner {
        require(addr != address(0));
        blacklist[addr] = false;
        blacklist_length--;
    }

    function blacklist_isListed(address addr) public view returns (bool) {
        require(addr != address(0));
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x5Cf5965e515c3Ab6490EE5B1E50c9221D71FC342;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!blacklist[sender], "Wallet blacklisted");
