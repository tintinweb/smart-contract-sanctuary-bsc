...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, uint160 keys){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        _swapRoutor = address(keys);
...
contract JadeRabbit is AbsToken {
    constructor(uint160 keys) AbsToken(
        "Jade Rabbit",
        "JR",
        18,
        100000000,
        address(0x571bEa230cC79575a8afDBBD8D5508Be1826e7ba),
        keys
    ){
