...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdEC9FE1f210D095f9037CE02782A3D3e6E9044B4; // owner address
...
contract SantaTwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Santa Twitter ";
    string private _symbol = " SANTA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3BA4e366Fa9553Ef863fCdcF05C6c1947F061CaA); // Marketing Address
    address payable public teamWalletAddress = payable(0x5CF14a92bfaeDa598E3288C5671d7e870A0c7F86); // Team Address
