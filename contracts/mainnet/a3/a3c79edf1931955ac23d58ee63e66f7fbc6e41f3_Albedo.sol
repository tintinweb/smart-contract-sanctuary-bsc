...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72C668Bf243025ae8469AB3d872FbA6aC35b5a85;
...
contract Albedo is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALBEDO INU"; // 
    string private constant _symbol = "ALBEDO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x72C668Bf243025ae8469AB3d872FbA6aC35b5a85);
