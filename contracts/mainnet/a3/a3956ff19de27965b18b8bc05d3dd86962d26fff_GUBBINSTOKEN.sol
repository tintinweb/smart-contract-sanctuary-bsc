...
/** Telegram: https://t.me/Gubbinstoken
*/
...
contract GUBBINSTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gubbins Token";
    string private _symbol = "GBT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02e511Db9B7bE95D0c2A0d1513C4A979A3475022); // Marketing Address
    address payable public teamWalletAddress = payable(0x2041aD898e0ee7aB5B28994B62Ae58C41ea05147); // Team Address
