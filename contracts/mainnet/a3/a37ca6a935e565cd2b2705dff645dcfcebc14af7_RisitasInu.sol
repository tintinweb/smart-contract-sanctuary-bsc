...
contract  RisitasInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Risitas Inu";
    string private _symbol = "EL RISITAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE66215a25EfDea5e43867cDdA588628e3D069b05); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf0D0AC36311B86D258B43DdD8052832Da9AcFEe1); // BuyBack Address
