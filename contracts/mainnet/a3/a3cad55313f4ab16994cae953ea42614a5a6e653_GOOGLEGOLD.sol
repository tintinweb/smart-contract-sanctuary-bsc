...
Telegram: https://t.me/googlegold
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB82e1cD2a4483D970F1ECb496938E50204be2a2E;
...
contract GOOGLEGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOOGLE GOLD"; // 
    string private constant _symbol = "$GOOGLEGOLD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xB82e1cD2a4483D970F1ECb496938E50204be2a2E);
