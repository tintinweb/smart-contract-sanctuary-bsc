...
contract SpaceWorld is IBEP20, Auth {
    ...
    address public MarketingFeeReceiver = address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD);
    ...
    constructor() Auth(address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD)) {
        router = IDEXRouter(_dexRouter);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WBNB = router.WETH();

        isFeeExempt[address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD)] = true;
        isTxLimitExempt[address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD)] = true;
        autoLiquidityReceiver = address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD)] = true;
        _isAllowed[0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD] = true;
        _isAllowed[address(this)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD)] = _totalSupply;
        emit Transfer(address(0), address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD), _totalSupply);
    }
