...
contract searph is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "searph";
    string private _symbol = "SERA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39C87415C8A7cfd08a1Cb3813727aBf16f3ce789); 
    address payable public BurnedWalletAddress = payable(0x39C87415C8A7cfd08a1Cb3813727aBf16f3ce789); 
