...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFA9d62c885574797Fc0Fb1cD2C727e1932AeCEF2;
...
contract SaudiSquid is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xFA9d62c885574797Fc0Fb1cD2C727e1932AeCEF2);
    ...
    */
    ...
    string private _name = "SaudiSquid"; 
    string private _symbol = "SaudiSquid";  
    ...
    */
    ...
    // Toggle on and off to auto process tokens to MOVR wallet 
    ...
    // This function is required so that the contract can receive MOVR from router
    ...
    */
    ...
    Fees are added to the contract as tokens, these functions exchange the tokens for MOVR and send to the wallet.
    One wallet is used for ALL fees. This includes liquidity, marketing, development costs etc.

    */


    // Send MOVR to external wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForMOVR(contractTokenBalance);
        uint256 contractMOVR = address(this).balance;
        sendToWallet(Wallet_Dev,contractMOVR);
    }
    ...
    // Swapping tokens for MOVR using Router 
    function swapTokensForMOVR(uint256 tokenAmount) private {
