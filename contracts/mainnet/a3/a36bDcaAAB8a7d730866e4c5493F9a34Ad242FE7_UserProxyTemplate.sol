...
contract UserProxyTemplate is UserProxyStorageLayout, CascadingFallbackProxy {
    ...
    function initialize(
        ...
        require(unkwnLensAddress == address(0), "Already initialized");
        ownerAddress = _ownerAddress;
        unkwnLensAddress = _unkwnLensAddress;
        unkwnLens = IUnkwnLens(_unkwnLensAddress);
        unConeAddress = unkwnLens.unConeAddress();
        unConeRewardsPoolAddress = unkwnLens.unConeRewardsPoolAddress();
        userProxyInterfaceAddress = _userProxyInterfaceAddress;
        vlUnkwnAddress = unkwnLens.vlUnkwnAddress();
