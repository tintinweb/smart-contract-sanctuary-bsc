...
contract K1Token is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "K1";
    string constant _symbol = "K1";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
	address marketingAddress = 0x6E7D45cD6F54BB03E18c94ef6bdb886B35081164; //market wallet

    uint256 _totalSupply = 1 * 100000000000000000 * (10 ** _decimals);
