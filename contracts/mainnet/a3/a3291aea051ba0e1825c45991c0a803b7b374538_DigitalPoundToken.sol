...
contract DigitalPoundToken is DigitalPoundTokenDeployer, Context, Ownable {
    ...
    string public override name = "Digital Pound Token";
    string public override symbol = "Digital Pound Token";
