...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5be3174eEd785d2A6FE5431DcD9Bc49F0A77AE3; // owner address
...
contract Hashirasinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hashiras INU";
    string private _symbol = "HASHIRAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFbB9b80535A1fb37E26e86b568ca32642C7305Ce); // Marketing Address
    address payable public buybackWalletAddress = payable(0xFbB9b80535A1fb37E26e86b568ca32642C7305Ce); // Buyback Address
