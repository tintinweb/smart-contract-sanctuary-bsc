...
contract CYBORGSTAKING__bnb {
    using SafeMath for uint256;
    uint256 public constant INVEST_MIN_AMOUNT = 0.05 ether;//0.05 BNB minimum deposit 
    uint256[] public REFERRAL_PERCENTS = [80];//8% referal reward
    ...
    address payable public Address;
    ...
    constructor(address payable wallet)  {
        Address = wallet;
        plans.push(Plan(40, 45));
        plans.push(Plan(60, 40));
        plans.push(Plan(90, 35));
        plans.push(Plan(1000, 25));
  }
