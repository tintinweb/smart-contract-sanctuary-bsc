...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6f6B8383827f79169ab656156F3fC84d906970A0; // owner address
...
contract Akira is Context, IERC20, Ownable {
    ...
    string private _symbol = "Akra";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64a33024D3CA621cd398A08ca518Fa039ec63cAC); // Marketing Address
    address payable public teamWalletAddress = payable(0x86d4E559f3d5c3C72a31d8C80cc1E8a1b6b4D16f); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 20000000000000 * 10**_decimals; 
