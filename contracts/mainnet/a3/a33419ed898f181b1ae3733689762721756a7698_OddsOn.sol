...
contract OddsOn is IBEP20, Ownable {
    ...
    string constant _name = "OddsOn";
    string constant _symbol = unicode"#BET";
    ...
    address private marketingWallet = payable(0xAc6a9870c923DB04a10b8C840C5d4b8B774720d7);
