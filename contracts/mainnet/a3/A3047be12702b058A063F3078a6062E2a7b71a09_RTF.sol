...
/**
Telegram https://t.me/RewardTokenFactory
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1000 * (10**9); // user must hold 1000,000 token to receive ADA
...
contract LockToken is Ownable {
    ...
    function include(address[] calldata _users) external onlyOwner {
...
contract RTF is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "RTF USDC";
    string constant _symbol = "RTFUSDC";
