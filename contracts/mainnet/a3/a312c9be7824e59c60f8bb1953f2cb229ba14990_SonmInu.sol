...
contract SonmInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SonmInu";
    string private _symbol = "SNMINU";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xFba08f3E69626FF958C42923379c110a417419B1); 
    address payable public BurnedWalletAddress = payable(0xFba08f3E69626FF958C42923379c110a417419B1); 
    ...
    uint256 private _totalSupply = 55500000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 5550 * 10**_decimals; 
