...
Portal:https://t.me/CryptoAwards2022
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x846730b0a621DAa9246f12eFBCF1A4026Ec99AF6; // owner address
...
contract cryptoawards is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crypto Awards 2022";
    string private _symbol = "$CA2k22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x846730b0a621DAa9246f12eFBCF1A4026Ec99AF6); // Marketing Address
    address payable public teamWalletAddress = payable(0x846730b0a621DAa9246f12eFBCF1A4026Ec99AF6); // Team Address
