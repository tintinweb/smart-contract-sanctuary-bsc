...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
   ...
   address public treasury;
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            uint256 beforestakedtokentotalsupply = stakedToken.balanceOf(address(this)).sub(totalRewardAmount);
            if(depositFeeBP > 0) {
            ...
            uint256 depositedamount = stakedToken.balanceOf(address(this)).sub(beforestakedtokentotalsupply).sub(totalRewardAmount);
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            uint256 withdrawamount = beforestakedtokentotalsupply.sub(stakedToken.balanceOf(address(this)).sub(totalRewardAmount));
