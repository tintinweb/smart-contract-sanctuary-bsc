...
contract MiloKing is Context, IBEP20, Ownable {
    ...
    string private _name = "MiloKing";
    string private _symbol = "MiloKing";

    uint256 private buyMarketFee = 5;
    uint256 private sellMarketFee = 5;
    uint256 private transferFee = 0;
    uint256 public AmountMarketFee = 0;
    ...
    uint256 public numTokensSellToMarket = 1000000 * 10**_decimals;

    address public _market = 0x17B8F4dB972adD3e53f15e00Feb27dA6C00AE3bb;
    ...
    {
        return (buyMarketFee, sellMarketFee, transferFee);
    }

    function resetAmounts() public onlyOwner {
        AmountMarketFee = 0;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (AmountMarketFee > 0) {
                swapTokensForUsdt(AmountMarketFee);
                AmountMarketFee = 0;
            }
        ...
        if (takeFee) {
            ...
            if (!swapPairList[from] && !swapPairList[to] && takeFee) {
            ...
            amount = amount - MFee;
            if (MFee > 0) _tokenTransfer(from, address(this), MFee);
        }
