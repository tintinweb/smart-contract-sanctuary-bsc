...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC110A0c8D7eBAC53d7C8F9c6eFdEE50DE133a107;
...
contract PandaKikiINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x74Ebab7ee0a73ebE82B77891836d5f8bc00CBC90;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Panda Kiki INU";
    string private _symbol = "PKI";
