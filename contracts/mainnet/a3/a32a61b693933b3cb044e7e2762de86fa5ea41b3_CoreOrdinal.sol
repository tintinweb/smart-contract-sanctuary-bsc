...
/**
 * Website https://coreordinal.finance/
 * Telegram https://t.me/coreordinalfinance
*/
...
contract CoreOrdinal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CORE Ordinal";
    string private _symbol = "COREORDINAL";
