...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFbf6cDB9D13285838f230E500bEf60A7e7C3fc79; // owner address
...
contract SAFECORN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SAFECORN";
    string private _symbol = unicode"SFCRN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFbf6cDB9D13285838f230E500bEf60A7e7C3fc79); // Marketing Address
    address payable public teamWalletAddress = payable(0xFbf6cDB9D13285838f230E500bEf60A7e7C3fc79); // Team Address
