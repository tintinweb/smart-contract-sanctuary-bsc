...
//Welcome to the first Bet to earn protocol on BSC !
// By holding WCP, you earn USDC token by reflection + participate in a prediction turnament on the soccer World Cup with Cash prize.
// More information on telegram

//Telegram : https://t.me/WorldCupPrinter
//Twitter : https://twitter.com/WWCPrinter2022

//Fees : 4% reflection on USDC
//       2% for Cash Prize of World cup Prediction
//       2% on marketing wallet
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); // reward address USDC
...
contract WorldCupPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; // reward USDC
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "World Cup Printer";
    ...
    uint256 marketingFee = 400; // 2% cash prize, 2% marketing
    uint256 totalFee = 800;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x40E9A7910a1f7469E7ae7be6293f5dd3bFeCDd0F; //liq address
    address public marketingFeeReceiver=0x40E9A7910a1f7469E7ae7be6293f5dd3bFeCDd0F; // marketing address
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[0x40E9A7910a1f7469E7ae7be6293f5dd3bFeCDd0F] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        buyBacker[msg.sender] = true;
        isMaxWalletExempt[0x40E9A7910a1f7469E7ae7be6293f5dd3bFeCDd0F] = true;
