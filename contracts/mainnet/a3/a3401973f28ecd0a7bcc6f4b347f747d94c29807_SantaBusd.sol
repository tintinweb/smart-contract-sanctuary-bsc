...
2% LP
 ...
 TG: https://t.me/SantaBusd_Official
 Web: http://santabusd.com/



 website under development, not live yet
...
contract SantaBusd is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public cooldowntimer = 10; //default cooldown 0s
    ...
    constructor() ERC20("SantaBusd", "SBUSD") {
        marketingWallet = payable(0x28f4aAE9Eef1783A79658df1a47992e998d55114);
        devWallet = payable(0xE25651bD3A68813f410a74D0c9943C45810a90f0);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    SantaBusd public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = SantaBusd(mainContract);
