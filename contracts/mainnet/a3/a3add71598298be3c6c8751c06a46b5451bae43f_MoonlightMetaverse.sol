...
// Moonlight Metaverse is a fight-to-earn multiplayer RPG.

// Website  http://moonlightmetaverse.online/

// Telegram  https://t.me/themoonlightbsc

// Twitter https://twitter.com/themoonlightbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MOONLIGHT = IBEP20(0xB1CeD2e320E3f4C8e3511B1DC59203303493F382);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MOONLIGHT.balanceOf(address(this));
    
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MOONLIGHT);
        ...
        uint256 amount = MOONLIGHT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MOONLIGHT.transfer(shareholder, amount);
...
contract MoonlightMetaverse is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Moonlight Metaverse";
    ...
    address public marketingFeeReceiver = 0x27Bb15B6da8483Cc88f3503b17c459BCfC05954f;
