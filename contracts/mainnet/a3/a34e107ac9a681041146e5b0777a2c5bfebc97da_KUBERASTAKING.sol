...
// Inheritance
contract KUBERASTAKING is Owned, Pausable {
    using SafeMath for uint256;
    ...
    function withdrawReward1() public{
        ...
        //require(rewards > 0, "Account does not have reward balance");
        if(rewards > 0) {
            ////////////////////////////////////////////
            ...
            //revert("Account does not have reward balance");
        }
    }
