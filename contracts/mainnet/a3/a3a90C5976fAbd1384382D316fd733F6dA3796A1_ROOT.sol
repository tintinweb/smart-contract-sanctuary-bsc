...
contract ROOT is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 65,000 ROOTs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ROOT Token", "ROOT") {
        _mint(msg.sender, 1 ether); // mint 1 SEED Root for initial pools deployment
