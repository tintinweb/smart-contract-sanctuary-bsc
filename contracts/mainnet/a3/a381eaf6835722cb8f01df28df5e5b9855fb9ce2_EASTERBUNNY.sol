...
contract EASTERBUNNY is Context, IERC20, Ownable {
    ...
    string private _name = "EasterBunny";
    string private _symbol = "EBUNNY";
    uint8 private _decimals = 18;
    address public rewardAddress = 0x102D14C370693bD9e605DeAb1BD0d582454fB023;
    ...
    function updatePancakeV2Router(address newAddress) public onlyOwner {
		require(newAddress != address(pancakeV2Router), "Error: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
		require(pair != pancakeV2Pair, "Error: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
