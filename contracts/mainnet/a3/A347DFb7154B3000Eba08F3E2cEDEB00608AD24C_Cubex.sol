...
contract Cubex is Context, IERC20, Ownable {
    ...
    address public deployerAddress = 0x83F3E9fb978F52ce8D07fE71F7033F19F992debc;
    address public yfih2 = 0xDcb624C870d73CDD0B3345762977CB14dE598cd0;
    address public migratorContractAddress = 0x1dd61Aee044794bF662d6a0EdeD29B80Ea200276;
    
    // Migration from Yfih2 to Cubex 
    bool public migrationEnabled = false;
    uint256 public totalTokenAvailableForMigration;
    uint256 public totalYfih2TokenMigrated;
    uint256 public totalWalletsMigrated;
    uint256 public ratioYfih2Cubex = 1_000_000;
...
////////////////////////////////////////////////////////////////////// Migration from Yfih2
    function _migrationPreview(address account) public view returns(uint256, uint256) {
        uint256 oldTokenPreview = IERC20(yfih2).balanceOf(account);
        uint256 newTokenPreview = oldTokenPreview / ratioYfih2Cubex;
        return (oldTokenPreview, newTokenPreview);
    }

    function _migrateYfih2TokenToCubex() external {
        // record balance of Yfih2 token and calculate Cubex token amount
        (oldToken[msg.sender], newToken[msg.sender])  = _migrationPreview(msg.sender);
        
        // make sure the migratorContract has enough Cubex tokens
        ...
        //collect Yfih2
        IERC20(yfih2).transferFrom(msg.sender, deployerAddress, oldToken[msg.sender]);
