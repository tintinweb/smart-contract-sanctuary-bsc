...
/**
Remember the good old days, where community moved towards million cap tokens?
Well here it is, remembering bsc in safemoon times - Old Moon Token.
No dev, no wen marketing, no bullsh*t, all apes together for one goal. Moon
Make it for old times sake. Publish on Reddit, coin sites listings, call your friends, call the normies

- Liq will be 2 BNB.
- No mint funtion on contract, no familly getting early.
- No team behind it, no airdrops, no presale

If you read this, you know you are early. LFG anon let's moon this

Dev will not create socials but will join them anon.
WAGMI

Never forget HODL. Road to 100m.
...
contract SafeEth is IBEP20, Auth {
    ...
    string constant _name = "Old Moon Token";
    ...
    address private marketingFeeReceiver = 0x1411740E847E31bFbb8B13A3Ba0A979076b530Ff;
    address private buybackFeeReceiver = 0x1411740E847E31bFbb8B13A3Ba0A979076b530Ff;
