...
/*
 *                                                  
 *   Stake Inu, coin of the # 1 online crypto casino stake.com . We are aiming to get back a tweet from them aswell as a partnership. Join us on our journey! 
 *   TG: @StakeInuBSC                                      
 *
*/
...
contract StakeInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Stake Inu";
