...
contract SpookyKittyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpookyKittyInu"; 
    string private _symbol = "$SKITTU"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd61f6e338639a8fF7b05751d5724e802e0BAAA44); 
    address payable public teamWalletAddress = payable(0xd61f6e338639a8fF7b05751d5724e802e0BAAA44); 
