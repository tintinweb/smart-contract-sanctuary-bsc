...
interface GlitteringHoshimachi {
...
contract GlitteringHoshimachiToken is GlitteringHoshimachi {
    ...
    string public override name = unicode"ぎらぎらほしまち";
    string public override symbol = unicode"ぎらぎらほしまち";
