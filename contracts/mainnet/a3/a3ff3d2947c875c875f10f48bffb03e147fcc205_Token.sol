...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "909";
    string private constant _symbol = "909";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 9090 * 10**_decimals;
    uint256 public _maxTxAmount = 1818 * 10**8;
    uint256 public _maxWalletAmount = 1818 * 10**8;
