...
- 1.5% LP
- 3% Marketing
- 9% BTC Rewards TG https://t.me/chipotleBTC
...
contract ChipotleBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ChipotleBTC";
    string constant _symbol = "$ChipotleBTC";
