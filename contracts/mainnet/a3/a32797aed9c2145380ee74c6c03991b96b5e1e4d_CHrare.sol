...
contract CHrare is Context, IERC20, Ownable {
    ...
    string private _name = "Swiss rare Token";
    string private _symbol = "CHrare";
    ...
    address payable public marketingWallet = payable(0xe7FD4fbf7fb7D2Cb7038D8f96E1f74359976da76);
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, liquidity and marketing feefee
        _tokenTransfer(from,to,amount);
    }

    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityShare = contractTokenBalance.mul(_liquidityFee).div((_marketingFee.add(_liquidityFee)));
