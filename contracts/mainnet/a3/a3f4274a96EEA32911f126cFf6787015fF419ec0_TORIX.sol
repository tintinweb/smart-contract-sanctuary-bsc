...
contract TORIX is TORIXDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TORIXTeam;
    address private CharityTORIX;
    ...
    string public override name = "TORIX";
    string public override symbol = "TORIX";
    ...
    constructor(uint totalSupplyValue, address TORIXTeamAddress, address CharityTORIXAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TORIXTeam = TORIXTeamAddress;
        CharityTORIX = CharityTORIXAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TORIXTeam] =  totalSupply * 4 / 100;
        balances[CharityTORIX] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TORIXTeam pot
