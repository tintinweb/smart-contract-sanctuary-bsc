...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86F31383c952f7Eb15480CF7aE5fEdFE73f93864; // owner address
...
contract PINU is Context, IERC20, Ownable {
    ...
    string private _name = "Puma Inu";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d3773F2c23DA5789a1271332df00218A65446F8); // Marketing Address
    address payable public teamWalletAddress = payable(0x0000000000000000000000000000000000000000); // Team Address
    ...
    uint256 public _sellTeamFee = 72;

    uint256 public _liquidityShare = 0; 
    uint256 public _marketingShare = 16;
    uint256 public _teamShare = 74; 
