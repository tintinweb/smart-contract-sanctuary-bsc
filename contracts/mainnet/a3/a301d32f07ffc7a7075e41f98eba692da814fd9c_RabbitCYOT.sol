...
contract RabbitCYOT is Context, IERC20 { 
    ...
    address payable public Cam_Wallet = payable(0x4C8367F495A14689ae8361e4ABD2c69D7026a5a5); 
    address payable public Dev_Wallet = payable(0xAdd0a5635dA5a898D9Cc920cAc45B76c6679a70A);
    ...
    string private constant _name = "Chinese Year Of The Rabbit 2023"; 
    string private constant _symbol = unicode"RabbitCYOT";
    ...
    constructor () {
        ...
        _owner = 0xAdd0a5635dA5a898D9Cc920cAc45B76c6679a70A;
    ...
    function _transfer(
        ...
        {  
            ...
            txCount = 0;
            swapAndLiqu(contractTokenBalance);
        }
    ...
    function swapAndLiqu(uint256 contractTokenBalance) private lockTheSwap {

            uint256 contractLiqBalance = balanceOf(address(this));
            uint256 tokensLiq =  contractLiqBalance - _dTotal;

            uint256 tokens_to_Dead = contractTokenBalance * Percent_Dead / 100;
            ...
            uint256 tokens_to_M = contractTokenBalance * Percent_Cam / 100;
            uint256 tokens_to_D = contractTokenBalance * Percent_Utility/ 100;
            uint256 tokens_to_LP_dalf = contractTokenBalance * Percent_Liq / 100;
