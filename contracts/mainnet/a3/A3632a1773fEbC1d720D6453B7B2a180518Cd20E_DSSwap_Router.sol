...
contract DSSwap_Router is IStoboxRouter02 {
    ...
    uint256 public defaultTreasuryFee;
    uint256 public defaultBurnFee;
    ...
    constructor(address _factory, address _WETH) public {
        ...
        defaultTreasuryFee = IStoboxFactory(_factory).defaultTreasuryFee();
        defaultBurnFee = IStoboxFactory(_factory).defaultBurnFee();
    }
