...
Join the team - lets begin our mission.
...
contract tsieHyenoM is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'tsieH yenoM';
    string private constant _symbol = 'TSIEH';
	...
	uint256 public autoBanTime = 180; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    //DevWallets
    address public Development=payable(0x9553c629F17d01dD643b5934900dc39de76B1f90);
    address public Marketing=payable(0x9553c629F17d01dD643b5934900dc39de76B1f90);
    //MainNet
