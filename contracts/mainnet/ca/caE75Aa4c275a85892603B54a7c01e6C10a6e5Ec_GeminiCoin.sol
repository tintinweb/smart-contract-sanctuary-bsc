...
// SPDX-License-Identifier: Unlicensed https://twitter.com/Gemini/status/1521143502088081409
...
contract GeminiCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gemini Coin";
    string private _symbol = "GEMINI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2e4d0D74BE8d2Dff86142b26696D07B63d4C99d4);
