...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x167Da919cbb2de93BFCCD8466e53fD42F17aa40B;
...
contract DogeZ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf52A71fef1d29e96c29979057fB411CA646222A2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DogeZ";
    string private _symbol = "DGZ";
