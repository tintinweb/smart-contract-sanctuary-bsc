...
contract Tt is Ownable, IERC20 {
    ...
    string private _name = "xue"; // name 
    string private _symbol = "xue"; // symbol
    ...
    uint256 private _sbsbsb = 300; // kill block
    uint256 private _launchedTime;

    address payable public marketingWalletAddress = payable(msg.sender);
    address payable public routerAddr = payable(0x9CcD9cd86d70AeA6d9fe773820147EDb9244d8b7);
