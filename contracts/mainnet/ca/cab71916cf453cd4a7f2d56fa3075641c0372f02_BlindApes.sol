...
contract BlindApes is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BlindApes";
    string constant _symbol = "BAPES";
    ...
    uint256 _totalSupply = 75000000 * (10 ** _decimals);
