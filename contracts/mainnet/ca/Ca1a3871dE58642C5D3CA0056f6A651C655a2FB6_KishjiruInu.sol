...
*/
// SPDX-License-Identifier: MIT Lichence
...
contract  KishjiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kishjiru Inu";
    string private _symbol = "KISHJIRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73C41E9a5264C7E02E94cCD3587164586F9Bf42d);
    address payable public teamWalletAddress = payable(0x36099EcC86457b60134fbAFe3376024F557729f9); 
