...
contract BabySKT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySKT";
    string private _symbol = "BabySKT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70Ff79DfABF5b4FeEd8F5E721919DD6442c5d9f5); // Marketing Address
    address payable public teamWalletAddress = payable(0x70Ff79DfABF5b4FeEd8F5E721919DD6442c5d9f5); // Team Address
    ...
    uint256 private _totalSupply = 10 * 10**4 * 10**2 * 10**_decimals;
    uint256 public _maxTxAmount = 10* 10**4 * 10**2 * 10**_decimals; 
    uint256 public _walletMax = 10 * 10**4 * 10**2 * 10**_decimals;
