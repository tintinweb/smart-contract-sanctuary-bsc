...
contract PEPAPIGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepa Pige";
    string private _symbol = "PEPAPIGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59E8023f23E5E54E9625CE1c2E01483B5F427752); 
    address payable public teamWalletAddress = payable(0x2D71218B8d865bB99874445E09673157404bF2bc); 
    ...
    uint256 private minimumTokensBeforeSwap = 4500000 * 10**9; 
