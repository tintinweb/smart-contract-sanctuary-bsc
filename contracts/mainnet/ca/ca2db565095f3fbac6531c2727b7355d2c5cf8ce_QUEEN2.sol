...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5E84F55B0d0C71889428c447CCA561a01237dF48;
...
contract QUEEN2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "QUEEN 2.0"; // 
    string private constant _symbol = "Queen2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x5E84F55B0d0C71889428c447CCA561a01237dF48);
