...
contract ElonCheemsYachtClub is IBEP20, Auth {
    ...
    string constant _name = "Elon Cheems Yacht Club";
    string constant _symbol = "ElonCheemsYachtClub";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 200; //10% 
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; //30%
    ...
    address private marketingFeeReceiver = 0xfF4Ff1bEd61CDc3894b61653da68c8B080eb64Eb;
    address private developmentFeeReceiver = 0x74684Cf245C4DC3956616E48B4DC2E7E1c9309ee;
