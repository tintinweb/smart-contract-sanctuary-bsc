...
Telegram : https://t.me/IndependenceShib
...
contract IndependenceShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBFe0e0EDDc92dce45C2829c0bFd75eD3F6e48eD4); 
    address payable public Wallet_Dev = payable(0xBFe0e0EDDc92dce45C2829c0bFd75eD3F6e48eD4);
    ...
    string private constant _name = "Independence Shiba"; 
    string private constant _symbol = unicode"INSHIB"; 
    ...
    constructor () {
        ...
        _owner = 0xBFe0e0EDDc92dce45C2829c0bFd75eD3F6e48eD4;
