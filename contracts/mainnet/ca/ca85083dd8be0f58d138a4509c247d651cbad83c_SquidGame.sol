...
contract SquidGame is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x36D6EFBd726eCf1D5cA4d95808DA2267A6a67dF6); 
    address payable private Wallet_Dev = payable(0xea77c2E9AFDcac260A98bb3148dBB879f9461B67);
    ...
    string private constant _symbol = unicode"SQUIDGAME 3.0"; 
    ...
    constructor () {
        ...
        _owner = 0xea77c2E9AFDcac260A98bb3148dBB879f9461B67;
