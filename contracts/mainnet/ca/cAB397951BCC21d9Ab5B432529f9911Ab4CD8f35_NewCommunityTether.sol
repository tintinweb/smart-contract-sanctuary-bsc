...
//SBF & CZ causes the crypto crash this time. Alameda Research one of the sister company of FTX is trying to short USDT. Is this the end for USDT?
//Contract will be renounced with 6% tax, LP will be locked.
//Community driven project to raise awareness to the crypto community that USDT is in the brink of death. Everyone need to take notice and stop the market maker / manipulator on what they are doing
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1ED130b094E9B650FBb9E27cFbd34507010173Ef; // owner address
...
contract NewCommunityTether is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Tether";
    string private _symbol = "cTether";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1ED130b094E9B650FBb9E27cFbd34507010173Ef); // Marketing Address
    address payable public teamWalletAddress = payable(0x1ED130b094E9B650FBb9E27cFbd34507010173Ef); // Team Address
    ...
    uint256 public _liquidityShare = 4; // original 5
