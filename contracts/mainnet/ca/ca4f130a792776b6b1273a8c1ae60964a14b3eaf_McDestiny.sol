...
contract McDestiny is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "McDestiny";
    string constant _symbol = "Destiny 2";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xF6Af575256D7903457689bC1dB2b0cc6265b9aBF;
