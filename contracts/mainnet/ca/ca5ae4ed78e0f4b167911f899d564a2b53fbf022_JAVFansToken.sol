...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6AfF270bbDc1e449F92Ee5d99C2998F88122d3cD;
...
contract JAVFansToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JAV Fans Token";
    string private _symbol = "JAV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8719D62FcDb6095a52889C039679D169d5b20216);
    address payable public teamWalletAddress = payable(0x8719D62FcDb6095a52889C039679D169d5b20216);
