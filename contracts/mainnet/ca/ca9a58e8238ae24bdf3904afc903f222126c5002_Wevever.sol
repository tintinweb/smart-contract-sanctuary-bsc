...
/**
Telegram : Https://Telegram.me/Wevever

Wevever is a warrior princess endowed with the fortitude
...
contract Wevever is ERC20, Auth {
    ...
    string constant private _name = "WebEVEForever";
    string constant private _symbol = "Wevever";
    ...
    address private autoLiquidityReceiver = 0x26213DC7C7101e7080C370FB6016eEfC151937b9;
    address private MarketingFeeReceiver = 0x26213DC7C7101e7080C370FB6016eEfC151937b9;
    ...
    function setBMWevever(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMWevever(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
