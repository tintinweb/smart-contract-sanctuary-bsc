...
contract NINJACAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1478AA9331C8747369B9bc35B59336869B557e38); 
    address payable public Wallet_Dev = payable(0x967C1c1164886f66aaC0cbba67F2Afa94cb5F510);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Ninja Cat"; 
    string private constant _symbol = unicode"NINJACAT";
