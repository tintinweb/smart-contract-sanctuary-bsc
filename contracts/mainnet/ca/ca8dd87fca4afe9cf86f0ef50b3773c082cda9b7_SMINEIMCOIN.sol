...
contract SMINEIMCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Smineim Coin";
    string private _symbol = "SMINEIM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB082a01D7aFD6413499886Ee39f6F2c1CA074DE); 
    address payable public teamWalletAddress = payable(0xf9dDE8C6441F8573890113b7302B4491cAe34a5D); 
