...
/**
 *Submitted for verification at https://bscscan.com/ on 2023-01-24
*/
...
contract Yang is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "Yang";
    ...
    // uint256 public maxWalletToken = 100000 * (10**2);
    uint256 public maxWalletToken = _tTotal;


    // uint256 public  _maxTxAmount     = 100000 * 10**2;
    uint256 public  _maxTxAmount     = _tTotal;
    uint256 private _minTokenBalance = 1 * 10**2;
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        //BSC Mainnet Pancakeswap 0x10ED43C718714eb63d5aA57B78B54704E256024E
        // uniswap
