...
contract CATONOMICS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATONOMICS";
    string private _symbol = "CTNS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x48af892FA28ff8EB04A954C1442397fDE78fEAED); // Marketing Address
    address payable public teamWalletAddress = payable(0x48af892FA28ff8EB04A954C1442397fDE78fEAED); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 20000 * 5 **_decimals; 
