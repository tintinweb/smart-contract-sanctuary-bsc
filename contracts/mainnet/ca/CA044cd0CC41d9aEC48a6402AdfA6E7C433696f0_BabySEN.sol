...
contract BabySEN
 is Context, IERC20, Ownable {
    ...
    string private _name = "BabySEN";
    string private _symbol = "BabySEN";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1504af3cb6a3A65ACbB7638020cE23Eaf9193F2b));
        _anotherA = payable(address(0x1504af3cb6a3A65ACbB7638020cE23Eaf9193F2b));
