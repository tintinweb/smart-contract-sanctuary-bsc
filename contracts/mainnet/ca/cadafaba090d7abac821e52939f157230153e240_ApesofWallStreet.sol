...
contract ApesofWallStreet  is Ownable, IBEP20 {
    ...
    string constant _name = "Apes of Wall Street";
    string constant _symbol = "AWST";
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x4259AD2d60E03b7fe70a1d7C52b8c990d374157b;
        marketingWallet =0xef50F889238fd93141579E634C09ab7700DF648D;
        Devwallet = 0x4259AD2d60E03b7fe70a1d7C52b8c990d374157b;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(DevFee.div(2));
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee) external onlyOwner {
