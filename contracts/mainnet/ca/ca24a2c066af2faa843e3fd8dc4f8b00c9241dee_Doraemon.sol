...
contract Doraemon is ERC20 {
	...
	address private _fund1Address = address(0x134ad393795203B6d761BE8332Fe9d368847FE5e);
	address private _fund2Address = address(0xa748B3Bd58d4f45a3ae3af3013fA2101d4B7A2Ae);
	address private _fund3Address = address(0x9dc9406E89F6AFC932E5A8E1Eb79232e446721a6);
	address private _fund4Address = address(0x03F26b2Ab7A83852144a13cceCD5ebBe5E21e1A3);
    address private _fund5Address = address(0x773e34f25d6E2E2973a72F4D27f5aB2778b67Faf);
    ...
    constructor(address tokenOwner) ERC20("Doraemon2.0", "Doraemon2.0") {
        ...
        swapTokensAtAmount = total.div(300000);
	...
	function changeSwapWarp(DoraemonWarp _warp) public onlyOwner {
        warp = _warp;
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			_takeInviterFeeKt(amount.div(100000000000000));
        }
        super._transfer(from, to, amount);
	...
	function swapAndLiquifyUsdt() public {
		...
		if(allAmount > 10**19){
			swapTokensForOther(allAmount.div(4).mul(3));
			uint256 allusdtAmount = USDT.balanceOf(address(this));
			if(allusdtAmount > 10**18){
				USDT.transfer(_fund1Address,allusdtAmount.div(4));
				USDT.transfer(_fund2Address,allusdtAmount.div(4));
				USDT.transfer(_fund3Address,allusdtAmount.div(4));
				USDT.transfer(_fund4Address,allusdtAmount.div(4));
			}
			swapTokensForDoge(allAmount.div(4));
		}
    }
	...
	function swapTokensForDoge(uint256 tokenAmount) internal {
