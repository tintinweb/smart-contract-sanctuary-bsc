...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCD37384b10f6Af594a4bEDf0FF5fd6895A5Bd037; // owner address
...
contract CatGirlExclamation is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xfe36f29fEa370Ae279fD2B9F08dF095338eA779b); // Marketing Address
    address payable public teamWalletAddress = payable(0xCD37384b10f6Af594a4bEDf0FF5fd6895A5Bd037); // Team Address
