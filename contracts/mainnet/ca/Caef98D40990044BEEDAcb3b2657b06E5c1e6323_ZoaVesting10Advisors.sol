...
contract ZoaVesting10Advisors is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting10Advisors: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting10Advisors: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting10Advisors: wrong TGE timestamp");
