...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = Symbol;
        _decimals = 6;
        uint256 total = 2400000000000 * 10 ** _decimals;
...
contract SpaceDogll is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        "Space Dogll",
        "Space Dogll",
        address(0x4f0a390221408Cdb22A8204Bcf6D7D7cbD551C36),
        address(0x9F4f82fe5a031EA70F2370B2BD2f4918c348fFf3)
    ){
