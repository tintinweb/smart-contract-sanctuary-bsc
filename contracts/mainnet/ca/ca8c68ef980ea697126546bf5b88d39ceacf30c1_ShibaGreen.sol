...
contract ShibaGreen is IBEP20, Auth {
    ...
    address DEV = 0xB465649e42096ACA9736dFa14fC3faB1CC74C027;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9Fe3058f2dE0CA8A2c30b8846eb9efDbff78B7Eb;  
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(sellFee).div(totalBNBFee);
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _sellFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        sellFeeBuy = _sellFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        developmentFeeBuy = _developmentFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_sellFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _sellFeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        sellFeeSell = _sellFeeSell;
        marketingFeeSell = _marketingFeeSell;
        developmentFeeSell = _developmentFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_sellFeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
