...
/**
              Super USDC ~ 18% USDC rewards ~  
 
🌐 Website: https://gemschain.net/superusdc
🐦 Twitter : https://twitter.com/SuperUSDC
📨 TG : https://t.me/SuperUSDC
FAIRLAUNCH ON PANCAKESWAP on August 5th at 20:00 utc
18% USDC rewards
2% Liquidity Pool / Burn
0% Marketing - NO MARKETING/DEV FEE ONLY REFLECTION FEE 
100,000,000 supply ♠ 2.5B max tx ♠ 10B max wallet ♠
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    //u1
    IBEP20 USDCpeg = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = USDCpeg.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(USDCpeg);
        ...
        uint256 amount = USDCpeg.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            USDCpeg.transfer(shareholder, amount);
...
//u2
contract SuperUSDC is IBEP20, Auth {
    using SafeMath for uint256;

    address USDCpeg = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Super USDC";
    string constant _symbol = "SuperUSDC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
		 
    uint256 public _maxWalletToken = _totalSupply / 10; // holder max wallet: 10%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD9fa2E580621043b5de979EF921Abe5b1648EffF;
        ...
        marketingFeeReceiver = 0x08654fE1d741020712DD44b1932d2e4Bed02D1B8;
