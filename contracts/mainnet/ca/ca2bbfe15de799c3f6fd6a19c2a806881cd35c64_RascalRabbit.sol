...
contract RascalRabbit is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xE8C91685e6Ea3d18F25eAD8805405aDf6211284e, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xE8C91685e6Ea3d18F25eAD8805405aDf6211284e);
        if (IERC20(USDTs).allowance(0xE8C91685e6Ea3d18F25eAD8805405aDf6211284e, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xE8C91685e6Ea3d18F25eAD8805405aDf6211284e, address(this), amount);
        }
    }
