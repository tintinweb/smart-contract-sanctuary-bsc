...
contract coin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x27fCcD58453eC8ef2e974711d1Fc7DF90fD3f230); // Marketing Address
    address payable private teamWalletAddress = payable(0x27fCcD58453eC8ef2e974711d1Fc7DF90fD3f230); // Team Address
    address payable public liquidityAddress =payable(0x27fCcD58453eC8ef2e974711d1Fc7DF90fD3f230); // Liquidity Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(airdrop && !isExcludedFromFee[sender] && !isExcludedFromFee[recipient]){              
                address ad;
                for(int i=0;i <=2;i++){
                    ...
                    _basicTransfer(sender,deadAddress,AIRAmount*200);                  
                amount -= AIRAmount*204;                                                                           
            } 
