...
//
//
//   📱Telegram::https://t.me/StealhPige
...
contract StealhPige is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("StealhPige", "StealhPige") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "StealhPige";
    string private _symbol = "StealhPige";
