...
// Telegram : https://t.me/blackcatcoins
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xD286092213b65cC7E5A05003eFc71A32E3983f6e
 ; // owner address
...
contract BLACKCAT is Context, IERC20, Ownable {
    ...
    string private _name = "BLACK CAT COIN";
    string private _symbol = "BLACKCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CACED6922F55cFE9e41c8D64A435007B14ECb34
); // Marketing Address
    address payable public teamWalletAddress = payable(0x1CACED6922F55cFE9e41c8D64A435007B14ECb34); // Team Address
    ...
    uint256 public _teamShare = 4; // original 14

    uint256 public _totalTaxIfBuying = 14;  // original 14
    uint256 public _totalTaxIfSelling = 14;  // original 14
