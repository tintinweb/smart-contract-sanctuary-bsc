...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xA96d7e0d6FD9700F98345A9781C05129DcdA0769;
...
contract TaiSH is AbsToken {
    constructor() AbsToken(
        ...
        address(0xAdb1526103AD89aA024a25da39a01D628Ba1ef6F),
    
        address(0xC2cf42d3C7fEfea616F03880a97Fa636b6EEA10f)
    ){
