...
/**
 Chief Floki is the new trend on binance smart chain.
Floki is a know memetoken based on Elon Musk dog, as the new adquisition of Twitter, we believe floki can be a good chief!

Portal: https://t.me/chiefflokibsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A6b195a223d695b620Bcb494E45ee3eeED46075; // owner address
...
contract chieffloki is Context, IERC20, Ownable {
    ...
    string private _name = "Chief Floki";
    ...
    uint256 private _totalSupply = 427000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 8540000000000 * 10**_decimals; 
    uint256 public _walletMax = 8540000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 854000000000 * 10**_decimals; 
