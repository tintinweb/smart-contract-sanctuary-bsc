...
/*
  ____ _                                                   
 / ___| |__   __ _ _ __   __ _ _ __  _   _ _ __ ___  _ __  
| |   | '_ \ / _` | '_ \ / _` | '_ \| | | | '_ ` _ \| '_ \ 
| |___| | | | (_| | | | | (_| | |_) | |_| | | | | | | |_) |
 \____|_| |_|\__,_|_| |_|\__, | .__/ \__,_|_| |_| |_| .__/ 
                         |___/|_|                   |_|    
 _   _      _         
| \ | | ___| | _____  
|  \| |/ _ \ |/ / _ \ 
...
contract ChangpumpNeko is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Changpump Neko";
    string constant _symbol = "CNEKO";
    ...
    address public marketingFeeReceiver = 0x91AD6eFab884777e1Cd6d46E9A4220Bd6036d8A8;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x91AD6eFab884777e1Cd6d46E9A4220Bd6036d8A8] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x91AD6eFab884777e1Cd6d46E9A4220Bd6036d8A8] = true;
