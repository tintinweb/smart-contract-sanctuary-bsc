...
contract SHIBAPOW is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA POW"; // 
    string private constant _symbol = "SPW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x1B031bED3aBE968e7E0B9f883338651cd43fd0f3;
