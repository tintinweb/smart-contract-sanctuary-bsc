...
contract liangxid is Context, IBEP20, Ownable {
    ...
    string private _name = "liangxid";
    string private _symbol = "liangxid";
    ...
    uint256 private buyTeamFee = 0;
    uint256 private sellTeamFee = 0;
    ...
    address public _market = 0xf0fceB5A254B4F9d60A3b73a3db9DB7121A00A28;
    address constant _usdt = 0x55d398326f99059fF775485246999027B3197955;
    address public _team = 0xf0fceB5A254B4F9d60A3b73a3db9DB7121A00A28;
    ...
    function setDeadFeePercent(uint256 _buyTeamFee, uint256 _sellTeamFee)
        external
        onlyOwner
    {
    ...
    function setAddress(address market, address team) public onlyOwner {
        _market = market;
        _team = team;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            amount = amount - fees;
            if (TFee > 0) _tokenTransfer(from, _team, TFee);
            if (fees - TFee > 0)
