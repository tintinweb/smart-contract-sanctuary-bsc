...
TG: https://t.me/AstronautDogeBsc
...
contract ASTRONAUTDOGE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ASTRONAUT DOGE";
    string constant _symbol = "ASTRODOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 3) / 200; // 1.5% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 3) / 200; // 1.5% of Total supply
    ...
    uint256 public swapThreshold = _totalSupply * 37 / 10000; // 0.37
    bool inSwap;
