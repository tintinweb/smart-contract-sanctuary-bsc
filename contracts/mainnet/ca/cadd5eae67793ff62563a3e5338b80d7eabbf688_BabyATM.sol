...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDAf7667c3F8590a3005C1F7A7B3Dc920d3ad0e25; // owner address
...
contract BabyATM is Context, IERC20, Ownable {
    ...
    string private _symbol = "$BATM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDAf7667c3F8590a3005C1F7A7B3Dc920d3ad0e25); // Marketing Address
    address payable public teamWalletAddress = payable(0xDAf7667c3F8590a3005C1F7A7B3Dc920d3ad0e25); // Team Address
