...
/**
Enter Your Token Briefing or First Impression
**/
...
contract TetToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x2c6ef442bEeC14Bd050897611cdB4402F98F6A3c);
    address payable public devWallet = payable(0x09F066B23f3d17d0831CD77Ba9427f215F802ac1);
    address payable public buybackWallet = payable(0xd6Af44628f5Cf121979a3eF4AFF0fd2aFDeE026D);
    ...
    uint256 public maxTransferAmount = 10000000 * 10**9;
    uint256 public maxBuyAmount = 10000000 * 10**9;
    uint256 public maxSellAmount = 5000000 * 10**9;
    uint256 public maxWalletSize = 20000000 * 10**9;
    ...
    constructor() {
        ...
        _isExcludedFromLimit[buybackWallet] = true;
    ...
    function setMaxWalletSize(uint256 newMaxWalletSize)
        external
        onlyOwner
    {
        ...
        )
    {
        ...
        uint256 tWallet = calculateMarketingFee(tAmount) +
            calculateDevFee(tAmount) + calculatebuyback(tAmount);
    ...
    function calculatebuyback(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_buyback).div(10**2);
    }
    ...
    function blacklistWallet(address Wallet, bool isBlacklisted) public onlyOwner {
        Blacklisted[Wallet] = isBlacklisted;
    }

    function blacklistMultipleWallet(address[] calldata Wallet, bool isBlacklisted) public onlyOwner {
    ...
    function _transfer(
        ...
        require(!Blacklisted[to], "Your address is Blacklisted");
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 buybackAmt = unitBalance *
            2 *
            (buyFee.buyback + sellFee.buyback);
        ...
        if (buybackAmt > 0) {
            (buybackWallet).transfer(buybackAmt);
        }
