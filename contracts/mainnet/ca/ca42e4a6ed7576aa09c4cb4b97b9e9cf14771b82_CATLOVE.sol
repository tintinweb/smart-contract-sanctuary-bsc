...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95a0981E7e703A6d88A640686395cF2eba0802E3; // owner address
...
contract CATLOVE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT LOVE";
    string private _symbol = "CATLOVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95a0981E7e703A6d88A640686395cF2eba0802E3); // Marketing Address
    address payable public teamWalletAddress = payable(0x95a0981E7e703A6d88A640686395cF2eba0802E3); // Team Address
