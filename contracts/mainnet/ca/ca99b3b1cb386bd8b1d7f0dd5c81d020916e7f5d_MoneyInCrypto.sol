...
Elon is making the choice... MONEY STAYS IN CRYPTO!
...
contract MoneyInCrypto is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xB84d8b97988D23dE904398195945E4822FF7e96E); // Marketing Address
        
    address payable public teamAddress =
        payable(0x647BE0f28f43E1aa581e4bA6249c2720ac71Fd61); // Team Address
        
    address payable public liquidityAddress =
        payable(0x647BE0f28f43E1aa581e4bA6249c2720ac71Fd61); // Liquidity Address
    ...
    string private constant _name = "Money In Crypto";
