...
contract Hodi is ERC20Detailed, Ownable {
    ...
    string public _name = "HODI";
    string public _symbol = "HOD";
    ...
    uint256 public hodInsuranceFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public firePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(hodInsuranceFundFee).add(
            firePitFee
        );
    ...
    constructor() ERC20Detailed("HODI", "HOD", uint8(DECIMALS)) Ownable() {
