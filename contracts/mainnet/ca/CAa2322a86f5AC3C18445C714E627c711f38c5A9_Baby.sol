...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "VirusKiller";
    string private _symbol = "VirusKiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7082F9DCdC52C0b36FAcb51226b1B4d459e1CD8a);
    address payable public teamWalletAddress = payable(0x7082F9DCdC52C0b36FAcb51226b1B4d459e1CD8a);
