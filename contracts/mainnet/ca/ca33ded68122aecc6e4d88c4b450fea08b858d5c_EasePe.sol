...
contract EasePe is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'EasePe';
    string  private constant _SYMBOL = 'EPE';
    ...
    uint256 private    _BURN_FEE = 25; // 1% BURNED
    uint256 private _MARKETING_FEE = 275; // 2% TO MARKETING WALLET
    ...
    function _BURNFEE(uint256 burnFee) external onlyOwner() {
        _BURN_FEE = burnFee;
    }
