...
contract SHINA is Context, IERC20, Ownable {
    ...
    string private _name = "Mrs. Shina";
    string private _symbol = "HINA";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x150F6DFfDda1FA4a64a846Ef3af8DBBE2499D92a); // Marketing Address
    address payable public BuyBackWallet = payable(0xE174C9AeaDfF3B7ae36784c3505974B062CC25Ec); // Team Address
