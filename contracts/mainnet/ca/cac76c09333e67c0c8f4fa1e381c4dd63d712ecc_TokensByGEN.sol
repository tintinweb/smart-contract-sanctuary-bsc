...
// Create your BSC token at: https://TokensByGen.com/ 
...
contract Contract is Context, IERC20 { 
    ...
    uint256 public _Fee__Buy_Contract        = 0;
    uint256 public _Fee__Buy_Liquidity       = 0;
    uint256 public _Fee__Buy_BNB             = 0;
    uint256 public _Fee__Buy_Reflection      = 0;
    uint256 public _Fee__Buy_Tokens          = 0;

    uint256 public _Fee__Sell_Burn           = 0;
    uint256 public _Fee__Sell_Contract       = 0;
    uint256 public _Fee__Sell_Liquidity      = 0;
    uint256 public _Fee__Sell_BNB            = 0;
    uint256 public _Fee__Sell_Reflection     = 0;
    ...
    function Token_Information() external view returns(string memory Token_Name,
                                                       ...
                                                       string memory Contract_Creator,
    ...
    */
    ...
    function Contract_Setup_1__Blacklist_Known_Bots(address[] calldata Wallets) external onlyOwner {
        ...
        require(LaunchBlock == 0,"Only before launch!");
    ...
    */ 
    ...
    function Contract_Setup_3__Add_PreSale_Wallet (address PreSale_Wallet_Address) external onlyOwner {

        _isLimitExempt[PreSale_Wallet_Address] = true;
        _isExcludedFromFee[PreSale_Wallet_Address] = true;
        _preLaunchAccess[PreSale_Wallet_Address] = true;
    ...
    */
    ...
    // Set Buy Fees
    function Contract_Setup_4__Fees_on_Buy(uint256 BNB_on_BUY, 
        ...
        require (BNB_on_BUY          + 
                 ...
                 Burn_on_BUY         + 
                 Tokens_on_BUY       + 
                 _Fee__Buy_Contract <= 20, "20% limit"); 
    ...
    // Set Sell Fees
    function Contract_Setup_5__Fees_on_Sell(uint256 BNB_on_SELL,
        ...
        require (BNB_on_SELL        + 
                 ...
                 Burn_on_SELL       + 
                 Tokens_on_SELL     + 
                 _Fee__Sell_Contract <= 20, "20% limit"); 
    ...
    */
    ...
    function Contract_Setup_6__Wallet_Limits(
        ...
        require(Max_Tokens_Per_Transaction > _tTotal / 1000 / 10**_decimals, "0.1% Limit");
        require(Max_Total_Tokens_Per_Wallet > _tTotal / 1000 / 10**_decimals, "0.1% Limit");
    ...
    function Contract_Setup_7__OpenTrade() external onlyOwner {
    ...
    // Enter the URL for the Liquidity Locker 
    function Contract_Setup_8__Share_Liquidity_Lock_URL(string memory Liquidity_Locker_URL) external onlyOwner{
    ...
    */
    ...
    function Contract_Update__Remove_Ongoing_Fee_For_2BNB() external onlyOwner payable {

        require(msg.value == 2*10**18, "Req 2 BNB"); 
    ...
    */
    ...
    function Owner_Transfer_Ownership(address payable newOwner) public onlyOwner {
        require(newOwner != address(0), "Can not be 0x0");
    ...
    */
    ...
    function Processing_Process_Now (uint256 Percent_of_Tokens_to_Process) external onlyOwner {
        require(!inSwapAndLiquify, "Swapping"); 
    ...
    */
    ...
    // Identifies wallet as a liquidity pair - Default false (Must also be limit exempt!)
    ...
    */
    ...
    // Update Tokens wallet - (Check Website for use) 
    function Update_Wallet_Tokens(address wallet) external onlyOwner {

        require(wallet != address(0), "0x0 address");
    ...
    // Update BNB wallet - (Check Website for use) 
