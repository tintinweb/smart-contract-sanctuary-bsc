...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAF03De9885D9B0df1b3622FFecf9f715C7163f2F;
...
contract BasicPitbullinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic Pitbull inu"; // 
    string private constant _symbol = "BPITBULLINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x731fC520e26eF05eF18775053d04798c9462d316);
