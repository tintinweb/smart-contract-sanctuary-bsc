...
TELEGRAM: https://t.me/DogeShibaFlokiBSC
...
contract DogeShibaFloki   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Shiba Floki???";
    string private _symbol = " DSF??? "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfb3aea91e9C8D1D365633c580c3148F912a8dAB2); 
    address payable public teamWalletAddress = payable(0xfb3aea91e9C8D1D365633c580c3148F912a8dAB2); 
