...
contract DAPE is Context, IERC20, Ownable {
    ...
    string private _name = "Diamond Ape Coin";
    string private _symbol = "DAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB47685F2456f83fFdf3aF5A1d5fD328a42F7E800); // Marketing Address
    address payable public teamWalletAddress = payable(0xB47685F2456f83fFdf3aF5A1d5fD328a42F7E800); // Team Address
