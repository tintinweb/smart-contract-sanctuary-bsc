...
contract stakereward {
    ...
    constructor(address new_lpToken,address new_ticketToken,address new_inviteAddr,uint256 new_DURATION,uint256 new_rewardRate,uint256 new_levelUpCount) {
        ...
        external 
    {
        ...
        IERC20(lpToken).safeTransfer(msg.sender,rewardAmt);
