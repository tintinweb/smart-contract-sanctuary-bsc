...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6c1DF12599e79E0804c34575E4a38FCc14A38F3; // owner address
...
contract MaxProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Max Protocol";
    string private _symbol = "MPL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6c1DF12599e79E0804c34575E4a38FCc14A38F3); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6c1DF12599e79E0804c34575E4a38FCc14A38F3); // Team Address
