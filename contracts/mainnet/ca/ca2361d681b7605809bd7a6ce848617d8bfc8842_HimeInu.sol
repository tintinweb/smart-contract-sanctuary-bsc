...
犬と知り合ってからは、飼い主に対してとても従順な動物です。
数年前、致命的なウイルスで亡くなった愛犬を偲んで。多くの人がこの動物を愛し、私も含まれています。
Hime inu
inu to shiriattekara wa, kainushi ni taishite totemo jūjun'na dōbutsudesu. Sūnenmae,
chimei-tekina uirusu de nakunatta aiken o shinon de. Ōku no hito ga kono dōbutsu o aishi, watashi mo fukuma rete imasu.
*/
...
contract HimeInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x14E9af06488Ab4F5117E6a2e0dc66809C55d48f7);
    address payable public liqWalletAddress = payable(0x14E9af06488Ab4F5117E6a2e0dc66809C55d48f7);
