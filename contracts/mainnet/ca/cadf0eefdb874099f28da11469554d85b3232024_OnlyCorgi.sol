...
contract OnlyCorgi is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"ONLYCORGI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = (10**9) * 10**_decimals;

    address payable private DevWallet = payable(0xc9076Ac69Ce56ACBA4858efDb296Fc18a5d5fd21);
    address payable private MarketingWallet = payable(0x081522a038F83D5386A4330329aA87eb84507EBc);
