...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x462c366aC3c2dECf022F5efB6f1a38bcc2bbf75f; // owner address
...
contract NOBUY is Context, IERC20, Ownable {
    ...
    string private _name = "TEST NO BUY2";
    string private _symbol = "TNB";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xec3C57781dD060bc765bBE81803FB8d4c2B57B51); 
    address payable public teamWalletAddress = payable(0xec3C57781dD060bc765bBE81803FB8d4c2B57B51);
