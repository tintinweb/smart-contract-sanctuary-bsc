...
contract NimbusApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nimbus Ape";
    string private _symbol = "NimbusApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43FD7C30b7087004E71A7c7E604B1Bb7D6B5192B);
    address payable public teamWalletAddress = payable(0x43FD7C30b7087004E71A7c7E604B1Bb7D6B5192B);
