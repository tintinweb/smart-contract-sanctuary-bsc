...
/**   // SPDX-License-Identifier: MIT
       ...
       Telegram Group : https://t.me/elonrockscoin
...
contract ELONROCKS is Context, IERC20, Ownable {
    ...
    string private _name = "Elon Rocks";
    string private _symbol = "ELR";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**15 * 10**_decimals;

    address payable private marketing =
        payable(0x36f7022f80397259D246a160eBDE1B4B831F3eE0);
