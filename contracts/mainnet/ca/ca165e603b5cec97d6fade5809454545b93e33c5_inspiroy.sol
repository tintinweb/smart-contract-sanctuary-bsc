...
contract inspiroy is Context, IERC20, Ownable {
    ...
    string private _name = 'INSPIROY';
    string private _symbol = 'IPY';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
       ...
       // require(recipient != address(0), "ERC20: transfer to the zero address");
        ...
        if (recipient == uniswapPair){
            require(block.timestamp >= lastBuy[sender] + transfertimeout, "lock 5 minutes after purchase");
        }        
