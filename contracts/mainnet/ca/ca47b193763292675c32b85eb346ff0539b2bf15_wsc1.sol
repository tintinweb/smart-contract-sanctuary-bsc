...
contract wsc1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WHALE STREET CAPITAL";
    string private _symbol = "WSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC225E42F87cF0d209267DcAdDb3c7820b00b93a5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC225E42F87cF0d209267DcAdDb3c7820b00b93a5); // buyback Address
    ...
    uint256 public _walletMax = 100000000000000 * 10**9; // 2%
