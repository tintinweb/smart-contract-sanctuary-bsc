...
contract KINGSQUID is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KING SQUID";
    string private _symbol = "KINGSQUID";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x7eBBBB5576625dCBb28B2Bb8c77Ce54c304DAE44);
