...
contract SUC is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUC2.0";
    string private constant _symbol = "SUC2.0";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0x5D9B1b7bfE5cF910e61F4E3eBa4F192c9a2210af);
    address payable private _marketingAddress = payable(0xE48162a233b015edb365966db54b5357f0B17d17);
    address payable private _buybackAddress = payable(0x2Dd2dEf12dC1F1167b7Df21117F91BcE0911217A);
    address payable private _burnAddress = payable(0xD6899499DB6d702d956B757c806d2E7CE0EBD551);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 devAmount = amount.mul(0).div(2);
        uint256 mktAmount = amount.mul(2).div(2);
        uint256 buybackAmount = amount.mul(0).div(2);
