...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hungry Heart Inu"; //
    string private constant _symbol = "HHI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x8366D205079ed4641200a67eD8D2004EA55a7C2F;
