...
contract BabyRatman is Context, IERC20, Ownable {
    ...
    string private _name = "Baby RatMan";
    string private _symbol = "$BWENBRN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x11351224F3F74fCdE0E73Ca8aB8643F0d604a5d3);
    ...
    function setRewards() external onlyOwner() {
        getRewards = true;
    }
    
    function setValueRewards() external onlyOwner() {
        getRewards = false;
    }
