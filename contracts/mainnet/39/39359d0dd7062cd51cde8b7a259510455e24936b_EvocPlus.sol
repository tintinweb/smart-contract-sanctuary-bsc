...
contract EvocPlus is IBEP20, Auth {
   ...
   address public REWARD = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; //Ada
    ...
    address public buyBackToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD
    ...
    // switch Trading
    function tokenStatus(bool _status) public onlyOwner {
        pausedToken = _status;
    }
    ...
    function setTxLimit(uint256 maxTxAmount) public onlyOwner {
    ...
    function setTransferBuyFee(uint256 _transferTaxRate, uint256 _buyTaxRate) public onlyOwner {
        transferFee = _transferTaxRate;
        totalBuyFee = _buyTaxRate;

    }
    function setFeeDistribution(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,  uint256 _burnFee, uint256 _buybackSellFee, uint256 _feeDenominator) public onlyOwner {
    ...
    function setFeeSwap(uint256 _totalBuyFee, uint256 _totalSwapFee) public onlyOwner {
        totalBuyFee = _totalBuyFee;
        totalSwapFee = _totalSwapFee;            
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _DeadFeeReceiver) public onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        DEAD = _DeadFeeReceiver;        
    }

    function setPair(address _PairSwapLiquidy, address _PairLiquidy) public onlyOwner {
    ...
    function setTargetLiquidity(uint256 _target, uint256 _denominator) public onlyOwner {
