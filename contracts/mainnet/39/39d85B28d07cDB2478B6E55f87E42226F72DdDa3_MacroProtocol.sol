...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xacd769CE36bDF68Ed9c7DC1AB3123fa6F66598dC;
    ...
    modifier onlyOwner() {
        require(_owner == 0xacd769CE36bDF68Ed9c7DC1AB3123fa6F66598dC, "Ownable: caller is not the owner");
        _;
    }
...
contract MacroProtocol is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Macro Protocol";
    string constant _symbol = "MPT";
    ...
    address payable public liquidityFeeReceiver = payable(0xacd769CE36bDF68Ed9c7DC1AB3123fa6F66598dC);
    address payable public marketingFeeReceiver = payable(0xacd769CE36bDF68Ed9c7DC1AB3123fa6F66598dC);
    ...
    function setMember(address _team, bool _enabled) external onlyOwner {
