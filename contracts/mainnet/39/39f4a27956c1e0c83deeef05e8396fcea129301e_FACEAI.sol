...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC01e13a42355a79f9750FB07e0d6F31D6B0665a6; // owner address
...
contract FACEAI is Context, IERC20, Ownable {
    ...
    string private _name = "FACEAI";
    string private _symbol = "FCA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC01e13a42355a79f9750FB07e0d6F31D6B0665a6); // Marketing Address
    address payable public teamWalletAddress = payable(0xC01e13a42355a79f9750FB07e0d6F31D6B0665a6); // Team Address
