...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x460449CEA1bA4FD045E8fc9411b6A64f8DDc95EB; // owner address
...
contract TeslAi is Context, IERC20, Ownable {
    ...
    string private _name = "TeslAi";
    string private _symbol = "TAI";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xF715D4F8d58A9070a99aB7549E852ab9E36906b7); 
    address payable public teamWalletAddress = payable(0xF715D4F8d58A9070a99aB7549E852ab9E36906b7);
