...
contract SpeedSui is ERC20Detailed, Ownable {
    ...
    constructor() public ERC20Detailed("Speed Sui", "Speed", 16) Ownable() {
        uint256 initialFragments = uint256(5000000000).mul(10**uint256(16));
        INITIAL_FRAGMENTS_SUPPLY = initialFragments;

        uint256 totalGons = MAX_UINT256 - (MAX_UINT256 % initialFragments);
        TOTAL_GONS = totalGons;

        MAX_SUPPLY = uint256(5000000000).mul(10**uint256(16)).mul(10**4);
        ...
        autoLiquidityReceiver = 0x6F90901E16127c705111e31f2922DE0FD7F91fA8;
        treasuryReceiver = 0x41Cc7E2019D811A7Ac08768f04c0D166e1ff80b7;
        insuranceFundReceiver = 0x6990beAcf842D3051A2eaf505285F3536F924a3f;
        ...
        cooldownExempt[0x6F90901E16127c705111e31f2922DE0FD7F91fA8] = true;
        cooldownExempt[0x41Cc7E2019D811A7Ac08768f04c0D166e1ff80b7] = true;
        cooldownExempt[0x6990beAcf842D3051A2eaf505285F3536F924a3f] = true;
        cooldownExempt[0x000000000000000000000000000000000000dEaD] = true;
        cooldownExempt[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true;
