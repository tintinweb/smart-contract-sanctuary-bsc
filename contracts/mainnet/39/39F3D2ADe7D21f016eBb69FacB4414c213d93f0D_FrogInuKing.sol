...
contract FrogInuKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FGI Inu King";
    string private _symbol = "Frog Inu King";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9D0532B7981Af3A74F64777Aa51B0cC8375a4BCA); // Marketing Address
    address payable public teamWalletAddress = payable(0x422d31B9c4acE5a6289524d3ae26AAA635BF1131); // Team Address
