...
/**
 * @title Treedefi collectibles Staking Version 2.1
 *
 * @author treedefi
 */
contract NftreeStakingSEEDv2_1 {
  ...
  /**
   * @dev Creates/deploys treedefi collectibles Staking Version 2.1
   *
  ...
  function harvest(uint256 index_) public payable {
    ...
    if(_unclaimed > 0) { 
      ...
      userStakes[msg.sender][index_].stakedOn += lockingPeriod; 
