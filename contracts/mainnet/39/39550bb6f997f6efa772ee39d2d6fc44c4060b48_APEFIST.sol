...
contract APEFIST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APEFIST";
    string private _symbol = "APEFIST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x725601e8b2887d305C19F183210311C996826Ac4); // Marketing Address
    address payable public teamWalletAddress = payable(0xe9F79Be5f5e6e9c6aCd29330D2FFD93E603561B5); // Team Address
