...
/*
Following the hype
Cutest most adorable Asian Shiba is coming to BSC
check out the tg
TG : AsianShibaOfficial
Sincerly Raiden Team
*/
...
contract AsianShiba is IBEP20, Ownable {
    ...
    string constant _name = "Asian Shiba";
    string constant _symbol = "AShiba";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //100% max tx
    ...
    address private marketingFeeReceiver = 0x2C8BF6ae354fA0D1f1D14fF13b76F78f009B509f;
