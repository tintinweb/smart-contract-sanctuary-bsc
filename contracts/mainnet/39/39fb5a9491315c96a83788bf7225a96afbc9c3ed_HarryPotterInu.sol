...
(Just lauınched & LP LOCKED & RENOUNCED)

🧙‍♂️Community-Focused
🧙‍♂️No team DEV & Team Wallet
🧙‍♂️Fat LP & Tokenomics
🧙‍♂️Max Wallet & 3 BNB Ready for Marketng

TG: https://t.me/harrypotterinu
*/
...
contract HarryPotterInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x80837537F16878DC188e157a840B4A28D0290b05); 
    address payable public Wallet_Dev = payable(0x3fEF13be180E833e987A6468ac13854B4444F7d2);
    ...
    string private constant _name = "Harry Potter Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x3fEF13be180E833e987A6468ac13854B4444F7d2;
