...
contract TRVchainStaking {
    ...
    uint256[5] public Duration = [30 days, 60 days, 90 days, 0 days, 0 days];
    uint256[5] public Bonus = [40, 80, 120, 0, 0];
    struct Stake {
        uint256 unstaketime;
        uint256 staketime;
        uint256 amount;
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        totalFee = 5;
        maxStakeableToken = 700000000000000000000000;
        percentDivider = 1000;
        minimumStakeToken = 1000000000000000000000;
        maxpoolbalance = 100000000000000000000000000;
        maxaccountbalance = 50000000000000000000000000;
    }
