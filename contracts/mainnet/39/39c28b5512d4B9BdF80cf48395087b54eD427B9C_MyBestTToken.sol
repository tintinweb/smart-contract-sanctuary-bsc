...
contract MyBestTToken is ERC20, Ownable {
 ...
 //   address public rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; 
    ...
    uint256 public amountMarketingFeeTokens = 30000 * (10**8);//30000 * (10**18);
    ...
    uint256 public AmountLPFeeDead = 30000 *(10**8);//3000 *(10**8); 
    ...
    // bool public isRaise = false;  
    // uint256 public raiseAmount = 10000000000000 * (10**18); 
   ...
   // address public serviceAddr_ = 0x9cB11C52ce373220953BcE39Dcd109c7459dDaAD;
    ...
    uint256 public tokenBalanceForReward_ = 3000 *(10*18);  //有多少分红币开始分红
