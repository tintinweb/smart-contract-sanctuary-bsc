...
contract WalletNowOblivionNft is ERC721, Ownable {
    ...
    // Timestamps of each token mint date
    mapping (uint => uint) public mintTimestamps;
    ...
    function reviveRug(address _to) public returns(uint) {
        ...
        _mint(_to, newItemId);
        mintTimestamps[_tokenIds.current()] = block.timestamp;
