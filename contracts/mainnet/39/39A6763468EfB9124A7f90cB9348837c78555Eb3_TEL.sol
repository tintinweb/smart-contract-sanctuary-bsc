...
contract TEL is Context {
    ...
    constructor(address address_) {
        ...
        ServieChargeAddress[0] = 0x0000000000000000000000000000000000000005;
        ServieChargeAddress[1] = 0x0000000000000000000000000000000000000006;
        ServieChargeAddress[2] = 0x0000000000000000000000000000000000000007;
        ServieChargeAddress[3] = 0x0000000000000000000000000000000000000008;
        ServieChargeAddress[4] = 0x0000000000000000000000000000000000000009;
    }
    ...
    function setpool(address pool__) public __Owner returns(bool){
        pool_ = pool__;
        return true;
    }
    function setpools_(address pools__) public __Owner returns(bool){
        poolnumber_ = pools__;
        return true;
    }
