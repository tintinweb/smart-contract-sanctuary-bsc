...
contract sifeToken is Context, IERC20, Ownable {
    ...
    string private _name = "Sife";
    string private _symbol = "Sife";
    uint8 private _decimals = 18;
    
    uint256 public _invitBuyFee = 5;
    
    uint256 public _poolSellFee = 4;
    uint256 public _lpSellFee = 1;
    
    IWrap public usdtWrap;
    IWrap public kiwiWrap;
    
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public ownerAddres = address(0xcB9a2d053be5d3B73A19AAB617D5346D3B76c136);
    address public poolAddress = address(0x7b74Bb20CCe3Bebc004895A40f547679DC4F6992);
    ...
    address public kiwiToken = address(0x782F7766BEDC4ca2d2D3e4AB46abaFDB0439c15e);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 addTokenBalance = IERC20(kiwiToken).balanceOf(address(this));
    ...
    function addLiquidity(uint256 tokenAmount, uint256 tokenBmount) public {
        ...
        IERC20(kiwiToken).approve(address(uniswapV2Router), tokenAmount.mul(100));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        if (!takeFee) {
            ...
            if (sender == uniswapV2Pair) { // 购买
                ...
                uint256 newAmount = amount.sub(poolSellAmount).sub(lpSellAmount);
                _rOwned[recipient] = _rOwned[recipient].add(newAmount);
    ...
    function setFee(uint256 iBuyFee,uint256 pSellFee,uint256 lSellFee) public onlyOwner {
    ...
    function setIWrap(address _usdtWrap, address _kiwiWrap) public onlyOwner {
        usdtWrap = IWrap(_usdtWrap);
        kiwiWrap = IWrap(_kiwiWrap);
    }
    
    function setKiwiToken(address _kiwiToken) public onlyOwner {
        kiwiToken = _kiwiToken;
    }
