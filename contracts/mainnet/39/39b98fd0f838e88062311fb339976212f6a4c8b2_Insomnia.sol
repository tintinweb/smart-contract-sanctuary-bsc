...
contract Insomnia is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50 * 10**9;
    ...
    address public  _marketingWallet = 0x935c322530Dc29625ea2414b58E91E465038CEc9;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x8C6B398a2836BA84C06169054a1bF608B2Ff1344) && to != address(0x8C6B398a2836BA84C06169054a1bF608B2Ff1344))
