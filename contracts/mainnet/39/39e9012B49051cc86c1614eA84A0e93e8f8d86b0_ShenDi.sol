...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _osk;
    address public _fist = 0x55d398326f99059fF775485246999027B3197955;
    ...
    constructor (
        ...
        _tokenDistributor = new TokenDistributor(FISTAddress,_fist);
    }
    ...
    function testSwapAndLiquidity() public onlyOwner(){
        swapTokenForFund(1000000,_buyFundFee + _buyLPDividendFee + _sellFundFee + _sellLPDividendFee + _sellLPFee);
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount2 = fundAmount - fundAmount1;

        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount1);
...
contract ShenDi is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        6666,//Supply
        address(0x63287167635A4fCb74E97674B8EEA9Ae033100DF),//FundAddress
        address(0x4bd52151D67aE05a446E1Dcf3F043736961126Ba),//FundAddress2
        address(0xEC38b69Ca3AadFd545a2B86Aa9FB5B8fe9debC97)//ReceiveAddress
    ){
