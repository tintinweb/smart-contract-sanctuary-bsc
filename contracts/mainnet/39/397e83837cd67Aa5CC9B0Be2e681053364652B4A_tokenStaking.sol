...
contract tokenStaking is StakingState, ReentrancyGuard {
    ...
    function invest(uint amount) external nonReentrant whenNotPaused tenBlocks hasNotStoppedProduction {
...
contract StakingState {
	...
	uint internal constant EXPRIRATION_DAYS = 10 days;
	uint stopProductionDate;
