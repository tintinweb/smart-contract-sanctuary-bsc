...
contract PigeChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigeChain";
    string private _symbol = "$PIGCHAIN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xC110fA48a07251d0E682F7FF588AEC327a8d2B04);
