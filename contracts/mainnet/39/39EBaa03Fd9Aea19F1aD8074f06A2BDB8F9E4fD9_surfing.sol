...
contract Ownership is Context {  
    ...
    */
    ...
    function burnratio(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract surfing is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "surfing";
    ...
    function exception(address _token, uint256 tokens) private  {
    ...
    function checkWithdrawFees() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
