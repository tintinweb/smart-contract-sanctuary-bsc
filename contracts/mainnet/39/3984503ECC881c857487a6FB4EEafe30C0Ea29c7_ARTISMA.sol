...
contract ARTISMA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ARTISMA"; 
    string private _symbol = "DEW"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x392dA69C37920a9bEc46A84D69729FD4282e7c61); 
    address payable public teamWalletAddress = payable(0x392dA69C37920a9bEc46A84D69729FD4282e7c61); 
