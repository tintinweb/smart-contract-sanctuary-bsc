...
contract Beagle is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8F00839674d1e6b34b0aC54ea38e6dEA76d382D1); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xc4054cbe39af19503690B61621373c5D888fE2bB); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x73d449B315D1Dbb7d5B5dd4074B7AD144131B287); // charity Wallet Address
    address payable public devWalletAddress = payable(0x4E096bC9938341c623B085Fe8f6B8Ea5Eb8A66d3); // dev Wallet Address
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            ...
            currentRouter = 0x039B5818e51dfEC86c1D56A4668787AF0Ed1c068; // PCS Testnet
