...
contract ArbitrageEngine {
    function start(
        ...
        (uint256 profit, uint256 outAmounts, uint256 outRepays) = check(token0, token1, amount, srcRouter, destRouter);
    ...
    function check(
        ...
        return (
            uint256(amountRepay - _amountTokenPay), // our profit or loss; example output: BNB
            amountOut,
