...
contract BaseToken is Ownable {
    ...
    string constant public name = 'XMOONSWAP';
    string constant public symbol = 'XMSWAP';
    uint8 constant public decimals = 18;
    uint256 public totalSupply =  1000000000000*10**uint256(decimals);
    uint256 public constant MAXSupply = 100000000000000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0x49F863eA62eddc91aAA9a276a10BcdEd15Ac0a8E;
...
contract XMOONSWAP is BaseToken {
