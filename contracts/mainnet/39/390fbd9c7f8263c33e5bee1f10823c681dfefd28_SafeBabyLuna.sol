...
contract SafeBabyLuna is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x06a31f004C776540f6fBd876B3fd18dE85B8a982); 
    address payable public Wallet_Dev = payable(0xCD60E3207daaf20314ab993c366790B082e7EdAE);
    ...
    string private constant _name = "Safe Baby Luna"; 
    string private constant _symbol = unicode"SBL"; 
    ...
    constructor () {
        ...
        _owner = 0xCD60E3207daaf20314ab993c366790B082e7EdAE;
