...
contract MEGANEINU is IBEP20, Auth { // NAME OF YOUR TOKEN
    ...
    string constant _name = "MEGANE INU"; // NAME OF YOUR TOKEN SAME AS LINE 184
    string constant _symbol = "MGI"; // SYMBOL FOR TOKEN
    ...
    address private marketingFeeReceiver =0xd123d4AF47F238d3951eEF24A71b14Df3aE37AA6; // MARKETING WALLET 
    address private teamFeeReceiver =0xd123d4AF47F238d3951eEF24A71b14Df3aE37AA6; // TEAM WALLET (USE MARKETING WALLET IF NO TEAM FEES)
    ...
    constructor () Auth(msg.sender) { // PANCAKE SWAP 
        ...
        routerGas = 0x43be48B5119A7355a55Fa01bdeDB4baf02bfD654;
