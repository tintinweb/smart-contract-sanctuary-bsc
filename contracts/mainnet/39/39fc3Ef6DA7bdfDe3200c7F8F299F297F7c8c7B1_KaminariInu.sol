...
contract KaminariInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "KAMINU";
    ...
    function setExcludedFromFee(address account) public view returns(bool) {
        return _isExcludedFromFee[account];
    }

    function setBuyTaxes(uint256 liquidityFees, uint256 marketingFees, uint256 burnFees) public onlyOwner {
        buyFee.liquidity = liquidityFees;
        buyFee.marketing = marketingFees;
        buyFee.burn = burnFees;
    }

    function setSellTaxes(uint256 liquidityFees, uint256 marketingFees, uint256 burnFees) public onlyOwner {
