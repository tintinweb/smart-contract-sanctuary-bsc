...
contract CuckooInu is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Cuckoo Inu';
    ...
    uint256 public _maxWalletToken = ( _tTotal * 1000 ) / 10000;
    uint256 public _maxTransferAmount = ( _tTotal * 1000 ) / 10000;
    ...
    uint256 public swapThreshold = ( _tTotal * 500 ) / 100000; // .30% of total supply
