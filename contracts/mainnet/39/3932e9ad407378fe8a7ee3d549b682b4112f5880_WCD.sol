...
/*
World Cup Doge 🤩 | Join the best team of experts in football betting, Low Risk, High Rewards. KYC 
✅ Audit ✅ LP Lock for a Year ✅ Elaborate Marketing plans ✅ The best Influencers onboard 🚀 All Fair Launch Buyers will get life time share of treasury betting pool. Binance AMA 
✅ CEX Listings ✅ CG & CMC Fast-Tracked ✅ Ads on Etherscan & BSCScan ✅ Doge + World Cup Fever 
🤩 | Exclusive Rewards for Fair Launch Buyers 🤩🤩
...
contract WCD is WCDDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private WCDTeam;
    address private CharityWCD;
    ...
    string public override name = "World Cup Doge";
    string public override symbol = "WCD";
    ...
    constructor(uint totalSupplyValue, address WCDTeamAddress, address CharityWCDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        WCDTeam = WCDTeamAddress;
        CharityWCD = CharityWCDAddress;
       
        // split the tokens according to agreed upon percentages
        balances[WCDTeam] =  totalSupply * 5 / 100;
        balances[CharityWCD] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's WCDTeam pot
