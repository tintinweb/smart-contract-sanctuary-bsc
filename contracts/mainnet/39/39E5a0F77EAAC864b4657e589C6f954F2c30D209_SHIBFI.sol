...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x68f9Da7e43FD07D4574C734F4c225EbEF5a90cFd;
...
contract SHIBFI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba FI"; // 
    string private constant _symbol = "SHIBFI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x68f9Da7e43FD07D4574C734F4c225EbEF5a90cFd);
