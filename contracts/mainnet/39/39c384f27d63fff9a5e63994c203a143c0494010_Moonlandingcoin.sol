...
contract Moonlandingcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Moon Landing Coin";
    ...
    uint256 public _boostedMarketingFee = 1300;
    ...
    address payable private _marketingWallet = payable(0x24cEF56f7Ce272514a846e42b86144E2c1818ba5);
    address payable private _devWallet = payable(0xe653157447b9Bc23Ce8C1882e09Ea17f84Fe5f1f);
