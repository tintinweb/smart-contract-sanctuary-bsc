...
contract TsukuyomiDragon_NFT is ERC721, Ownable, Pausable
{
    ...
    uint256 public constant MAX_WHITELIST_ACCOUNT_MINT = 2;

    //ETH: 5997, POL: 2001, BSC = 1001, AVL = 1001
    uint256 public constant MAX_TOKEN_SUPPLY = 1001;
    ...
    //Mint value
    uint256 public sWhitelistMintValue = 0.0446 ether;   // 1 USD = 0.00446 BNB, 10 x 0.00446 = 0.0446 x ether = 44600000000000000 (wei) - 1 ether = 1000000000000000000 (or 10^18) wei
    uint256 public sLimitedMintValue = 0.0892 ether;    // 89200000000000000 (wei) - 1 ether == 1000000000000000000 (or 10^18) wei

    string public sBaseURI = "https://bafybeieugeegtjb5di5hyzusni4gkq35arhrlbcotnx6vlfh6lfi54jwe4.ipfs.nftstorage.link/";
