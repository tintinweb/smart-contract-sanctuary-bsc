...
/**
SpaceHero
TG : https://t.me/SpaceHeroBSC

Recently, The Fed has lifted the interest rates for a few times, and it brings dangers to Crypto. SpaceHero senses it & step up to gather community to overcome this situation.

SpaceHero is building a decentralized application where everyone can stake most of their coins and earn higher rate to overcome this winter.

SpaceHero is taking up the role to pay the gas fees of the dApp & on every week it will also reward you with any coins that you catch eye on, depending on how much you hold the token.
*/
...
contract SpaceHero is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpaceHero"; // 
    string private constant _symbol = "SPACEHERO"; //    
