...
contract SNOTROCKET is Context, IBEP20, Ownable {
    ...
    string private _name = "Snot Rocket"; // token name
    string private _symbol = "SNOT"; // token ticker
    ...
    uint256 public minTokenToSwap = 100000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 50000000000 * 1e9;  
