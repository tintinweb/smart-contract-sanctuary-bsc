...
// Hold $FSCREAM and get rewards in $FLOKI
// TG Portal: https://t.me/FLOKISCREAM
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E);
    PCSRouter router;
...
contract FlokiScream is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "FlokiScream";
    string constant public symbol = "$FSCREAM";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF521E46720634aFbd9eD716fbbdc217a9446D941;
        devFeeReceiver = 0xF521E46720634aFbd9eD716fbbdc217a9446D941;
