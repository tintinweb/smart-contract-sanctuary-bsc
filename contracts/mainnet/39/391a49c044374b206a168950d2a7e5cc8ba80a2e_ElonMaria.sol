...
contract ElonMaria is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ElonMaria";
    string constant _symbol = "ElonMaria";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7700FF8525403F1dfBAdDe8c54572Ffd4a68E92a;
