...
contract YANGMI is Context, IERC20, Ownable {
    ...
    string private constant _name = "YANG MI"; // 
    string private constant _symbol = " $MI "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x0F317B8f95f3EF183Baa684211B07ffa4B047e02;
