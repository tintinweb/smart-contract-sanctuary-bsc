...
/**
/*  
Telegram : https://t.me/Argentiwin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f; 
...
contract Argentiwin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Argentiwin";
    string private _symbol = "AFAWIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f); // 
    address payable public teamWalletAddress = payable(0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f); // 
