...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ALVEY = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ALVEY.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ALVEY);
        ...
        uint256 amount = ALVEY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ALVEY.transfer(shareholder, amount);
...
contract BurnAlvey is IBEP20, Auth {
    using SafeMath for uint256;

    address ALVEY = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BurnAlvey";
    string constant _symbol = "BurnAlvey";
    ...
    address public Owner=0xC4f86e8BDC399bE8e5d4d7705549B97Bfa9F3c7A; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xC4f86e8BDC399bE8e5d4d7705549B97Bfa9F3c7A;
