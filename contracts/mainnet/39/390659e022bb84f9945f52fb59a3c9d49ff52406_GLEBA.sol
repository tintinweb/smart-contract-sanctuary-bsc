...
abstract contract Ownable is Context {
 ...
 contract GLEBA is ERC721Enumerable, Ownable   {
  ...
  uint256 public MinitngPricein_token=80;    // token
  uint256 public MinitngPricein_token1=20;    // token1
   uint256 public MinitngPrice_with_single=100;    // token1
   uint256 public MinitngPricein_bnb = 80;     // bnb 
   uint256 public MinitngPricein_busd = 80e18;     // busd
