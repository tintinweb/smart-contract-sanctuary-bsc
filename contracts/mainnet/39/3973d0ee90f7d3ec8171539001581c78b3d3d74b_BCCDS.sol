...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xBFd48CC239bC7e7cd5AD9F9630319F9b59e0B9e1);
...
contract BCCDS is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xF93b4D0dB82f60E88092804868A0502AFbBD0025;

    string constant _name = "Baby CCDS";
    string constant _symbol = "BCCDS";
