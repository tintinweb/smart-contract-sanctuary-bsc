...
contract BAHAGIA_GOLD is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BAHAGIA-GOLD";
    string constant _symbol = "BHG";
    ...
    function starttreding(uint256 botBlocks) external onlyOwner() {
    ...
    function Stmaxwallet(uint256 maxTxPercent) external onlyOwner() {
    ...
    function StaxnofEE(address holder, bool zerofee) external onlyOwner {
