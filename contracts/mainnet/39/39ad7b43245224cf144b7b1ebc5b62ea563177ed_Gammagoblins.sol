...
/**
Gammagoblins
$GAMMA is a cryptocurrency launched on bnb Blockchain named after a mythical creature 
"Gammagoblin" with the ability to manipulate space and time.

https://t.me/GAMMA_2023

Contract Address : 
0x39ad7B43245224Cf144B7B1eBC5b62EA563177Ed

poocoin
https://poocoin.app/tokens/0x39ad7B43245224Cf144B7B1eBC5b62EA563177Ed
*/
...
interface GammagoblinsDeployer {
...
contract Gammagoblins is GammagoblinsDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GammagoblinsTeam;
    address private CharityGammagoblins;
    ...
    string public override name = "Gammagoblins";
    string public override symbol = "GAMMA";
    ...
    constructor(uint totalSupplyValue, address GammagoblinsTeamAddress, address CharityGammagoblinsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GammagoblinsTeam = GammagoblinsTeamAddress;
        CharityGammagoblins = CharityGammagoblinsAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GammagoblinsTeam] =  totalSupply * 4 / 100;
        balances[CharityGammagoblins] = totalSupply * 4 / 100;
