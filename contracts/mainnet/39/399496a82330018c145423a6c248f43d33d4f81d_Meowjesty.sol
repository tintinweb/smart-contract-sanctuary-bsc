...
Portal: https://t.me/queenmeowjestytoken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf0c85Ac8707642F264bD2B3EdD15165BBEc85f4; // owner address
...
contract Meowjesty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Queen Meowjesty";
    string private _symbol = "Meowjesty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6901968c855157E493310e9B2c224d53A660FBe5); // Marketing Address
    address payable public teamWalletAddress = payable(0xAf0c85Ac8707642F264bD2B3EdD15165BBEc85f4); // Team Address
