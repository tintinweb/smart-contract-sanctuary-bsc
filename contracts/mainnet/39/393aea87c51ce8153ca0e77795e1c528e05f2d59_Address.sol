...
contract TokenV2 is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        fund = 0xb9258Fa87f2BBEff3DC48561244F6e5454430808;
        ...
        whitelist[0xA679949D757E013B31CeaaF9A865178f9D4e2213] = true;
        whitelist[0xAa06bf6dAa897c4B535e445e0342A1Ea13f00789] = true;
        whitelist[0x3228EB03CfD78f8421b717Ad983530A5BFEA7253] = true;
        whitelist[0x84b8D511daCeAb59C1597EBcc1087C1A1a11f73B] = true;
        whitelist[0x055c007e2C531893eB5bEf665E1cBC3d74de6b10] = true;
        whitelist[0xcef75E1241d5a25DAB397f2ae0a2b6760B216288] = true;
        whitelist[0xDCac15298F667bDE72e4C88D4D3227Eb17d77777] = true;
        whitelist[0x944cfC5F30db65BBDC8BE40FC63B481b400e0512] = true;
        whitelist[0xed045654c081e43eC8baF8eD0E30860970920b82] = true;
        whitelist[0x42004A25b08922E46ed553CcE80580a65eA4780A] = true;
    ...
    function calculateFee(
        ...
        if(start == 0 && to == liquidity){
            start == block.timestamp;
        }

        if(block.timestamp > start && block.timestamp <= start +60){
            if(from == liquidity && !whitelist[to]){
                Blacklist[to] == true;
            }
        }
