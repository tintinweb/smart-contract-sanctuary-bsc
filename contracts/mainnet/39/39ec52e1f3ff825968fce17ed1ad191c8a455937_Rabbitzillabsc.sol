...
/**
According to the Rabbit Chinese Horoscope 2023, the year of the Rabbit will be good for 
the Rabbit natives. Things will finally start to fall into place after a 2-year period of 
struggles and hardship.
Your life will take a positive turn and your efforts will make you proud of yourself
https://t.me/Rabbitzillabsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbb8b0F8F5bE05Af3f38DEF10bE3Cf0C90E3CE617; // owner address
...
contract Rabbitzillabsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RabbitZilla";
    string private _symbol = "Rabzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE45990cDc3C3944Dd6a33696A3e0a19253A33AcE); // Marketing Address
    address payable public teamWalletAddress = payable(0xE45990cDc3C3944Dd6a33696A3e0a19253A33AcE); // Team Address
