...
contract denji is ERC20, Ownable {
    ...
    constructor() ERC20("Caroline", "caroline") 
    {
        ...
        taxWallets["liquidity"] = address(0x32Cb4F0e9bC9ee76aA8cAa7C169b8fF7bB534766);
        setBuyTax(4,2); //marketing tax, liquidity tax
        setSellTax(4,2); //marketing tax, liquidity tax
        setEarlyTax(9, 1); // early sell marketing tax, early sell liquidity tax
        
        setTaxWallet(address(0x921b1ED9d2cebC313A891Cc02215cef099417Fe6)); // 
        exclude(msg.sender);
