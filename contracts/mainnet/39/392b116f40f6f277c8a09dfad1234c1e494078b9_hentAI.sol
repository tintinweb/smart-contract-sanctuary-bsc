...
// Telegram : https://t.me/hentAI_BNB
...
contract hentAI is Context, IERC20 { 
    ...
    address payable public W_MARKET = payable(0xD5CEfd2A18BDB8125EC6b07D5228222CcEA579cD); 
    address payable public W_DEV = payable(0x9f51Fc6a49aA340aA89904524648476ceDbEE24C);
    ...
    constructor (address[] memory addresses, string memory typeC) {
        ...
        _owner = 0x9f51Fc6a49aA340aA89904524648476ceDbEE24C;
