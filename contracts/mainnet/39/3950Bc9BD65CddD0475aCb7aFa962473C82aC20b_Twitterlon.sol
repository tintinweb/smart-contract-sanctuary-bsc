...
$TWITTERLON TO THE MOON
https://t.me/Twitterlon
...
contract Twitterlon is Context, IERC20 { 
    ...
    */
    ...
    Wallet_Twitterlon: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_Twitterlon = payable(0x3c443f2B70a107C80469511F18A1B24257636F28); 
    address payable public Wallet_LP = payable(0x3c443f2B70a107C80469511F18A1B24257636F28);
    address payable public Wallet_Tokens = payable(0x3c443f2B70a107C80469511F18A1B24257636F28); 
    ...
    string private constant _name = "Twitterlon"; 
    string private constant _symbol = unicode"Twitterlon"; 
    ...
    uint256 public Percent_Twitterlon = 70;
    ...
    constructor () {
        ...
        _owner = 0x3c443f2B70a107C80469511F18A1B24257636F28;
        ...
        */
        ...
        _isLimitExempt[Wallet_Twitterlon] = true; 
        ...
        _isExcludedFromFee[Wallet_Twitterlon] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 Twitterlon_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((Twitterlon_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_Twitterlon = Twitterlon_Wallet;
    ...
    */
    ...
    //Update the Twitterlon wallet
    event updatedTwitterlonWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_Twitterlon(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedTwitterlonWallet(Wallet_Twitterlon,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_Twitterlon] = false; 

        Wallet_Twitterlon = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_Twitterlon != 0){

            // Calculate how many tokens need to be swapped for BNB (Twitterlon BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_Twitterlon / 100;
            ...
            uint256 split_M = Percent_Twitterlon * 100 / (Percent_AutoLP + Percent_Twitterlon);
            ...
            // Send BNB to Twitterlon wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_Twitterlon, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_Twitterlon != 0){

            // Swap tokens for BNB and send to Twitterlon Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_Twitterlon / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_Twitterlon, BNB_M);
            ...
            // Create the Auto LP if Twitterlon is 0
