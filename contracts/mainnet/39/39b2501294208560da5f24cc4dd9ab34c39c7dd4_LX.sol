...
contract LX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xeCC2cfaB242bC5Fe80D952f708cE405CD7C88888);
    address payable public teamWalletAddress = payable(0x1f4D0ca6221DA57eceF23Adb3FD163eAF7666666);
    ...
    uint256 public _maxTxAmount =   99999999999999 * 10**_decimals;     
    uint256 public _walletMax =     99999999999999 * 10**_decimals;      
