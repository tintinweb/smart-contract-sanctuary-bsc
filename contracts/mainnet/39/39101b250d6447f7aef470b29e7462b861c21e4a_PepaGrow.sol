...
contract PepaGrow is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "PepaGrow";
string private _symbol = "PEPAGROW";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xb0F079DE410157aAE12d019677bdE6C259478e56); // Marketing Address
address payable private TeamWallet = payable(0xb0F079DE410157aAE12d019677bdE6C259478e56); // Buy Back Address
...
uint256 private _totalSupply = 100 *  10**1 * 10**_decimals;
uint256 public _maxTxAmount = _totalSupply.div(24); 
uint256 public _walletMax = _totalSupply.div(24);
