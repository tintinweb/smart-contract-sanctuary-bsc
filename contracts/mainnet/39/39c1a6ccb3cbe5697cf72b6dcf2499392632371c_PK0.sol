...
contract PK0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PK0";
    string private _symbol = "PK0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37Bc804B472f8B496aCAf758DA9A25e919c6aA98);
    address payable public teamWalletAddress = payable(0x24AFAdFB63b8112dc4c2084B176C11F8614D5b47);
