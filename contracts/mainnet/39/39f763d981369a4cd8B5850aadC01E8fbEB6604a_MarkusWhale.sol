...
contract MarkusWhale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MarkusWhale";
    string private _symbol = "MARKUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9D0d4357054A5aDDe93CA8776dCDF81140292039);
    address payable public teamWalletAddress = payable(0x9D0d4357054A5aDDe93CA8776dCDF81140292039);
