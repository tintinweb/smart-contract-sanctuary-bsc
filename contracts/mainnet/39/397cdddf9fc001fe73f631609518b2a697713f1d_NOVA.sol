...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x588AbC31AE61e405dC250b06eE8553984644a195; // owner address
...
contract NOVA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xeB0FD895Ec0cd773115360b63BB2bEc2bc37C5C1); // Marketing Address
    address payable public teamWalletAddress = payable(0x4da9b6583e06942fDD5C110102b43eE7e56b0a93); // Team Address
