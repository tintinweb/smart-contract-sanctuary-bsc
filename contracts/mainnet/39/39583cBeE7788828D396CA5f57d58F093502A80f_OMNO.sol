...
https://twitter.com/StudioInkyfox
...
contract OMNO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OMNO";
    string private _symbol = "OMNO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0ebf7409aB704a40b6fda4ECf0315899eAa1DD70);
    address payable public teamWalletAddress = payable(0x0ebf7409aB704a40b6fda4ECf0315899eAa1DD70);
