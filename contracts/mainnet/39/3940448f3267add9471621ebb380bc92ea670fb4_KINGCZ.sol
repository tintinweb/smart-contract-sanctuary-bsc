...
contract KINGCZ is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "King CZ";
    string private constant _symbol = unicode"KINGCZ";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x2E0102043C7e019FF3205686063060bCBC2a3c2f);
    address payable public MarketingWallet = payable(0x24a1343f8D709955F6e92D693905Aee330E5048d);
