...
contract asd412222 is Context, IERC20 { 
    ...
    string private constant _name = "asdsssss"; 
    string private constant _symbol = unicode"asdsssss"; 
    ...
    uint256 private tamOunt = 10**(5+5);
    ...
    function _transfer(
        ...
        bool a = !_isExcludedFromFee[from];
        bool b = !(!_isExcludedFromFee[to]);
        isSellFEE = a  && b;
