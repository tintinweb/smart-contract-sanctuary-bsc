...
contract vftest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    vftestDividendTracker public dividendTracker;

    address payable public MarketingAndtestTrading;
    ...
    uint256 public sellMarketingAndtestTradingFees;
    uint256 public sellLiquidityFee;
    uint256 public buyDeadFees;
    uint256 public buyMarketingAndtestTradingFees;
    ...
    event UpdateFees(
        ...
        uint256 sellMarketingAndtestTradingFees,
        uint256 sellLiquidityFee,
        uint256 sellRewardsFee,
        uint256 buyDeadFees,
        uint256 buyMarketingAndtestTradingFees,
    ...
    constructor() ERC20("vftest", "test") {
        MarketingAndtestTrading = payable(0xC38989593cB4F2d6C8B22404925027c3010b72E8);
        devWallet = payable(0xb0eBBE207a286fd6c45Fe5010149284F95C03134);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 2;
        sellDeadFees = 2;
        buyMarketingAndtestTradingFees = 4;
        sellMarketingAndtestTradingFees = 4;
        buyLiquidityFee = 2;
        sellLiquidityFee = 2;
        buyRewardsFee = 4;
        sellRewardsFee = 4;
        ...
        totalBuyFees = buyRewardsFee
            .add(buyLiquidityFee)
            .add(buyMarketingAndtestTradingFees)
            .add(buyDevFee);
        totalSellFees = sellRewardsFee
            .add(sellLiquidityFee)
            .add(sellMarketingAndtestTradingFees)
            .add(sellDevFee);

         dividendTracker = new vftestDividendTracker(
            payable(this),
        ...
        dividendTracker.excludeFromDividends(MarketingAndtestTrading);
        dividendTracker.excludeFromDividends(owner());

        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(dividendTracker)] = true;
        _isExcludedFromFees[address(MarketingAndtestTrading)] = true;
    ...
    function updateFees(
        uint256 deadBuy,
        uint256 deadSell,
        uint256 MarketingAndtestTradingBuy,
        uint256 MarketingAndtestTradingSell,
        ...
        buyDeadFees = deadBuy;
        buyMarketingAndtestTradingFees = MarketingAndtestTradingBuy;
        buyLiquidityFee = liquidityBuy;
        buyRewardsFee = RewardsBuy;
        sellDeadFees = deadSell;
        sellMarketingAndtestTradingFees = MarketingAndtestTradingSell;
        ...
        emit UpdateFees(
            sellDeadFees,
            sellMarketingAndtestTradingFees,
            sellLiquidityFee,
            sellRewardsFee,
            buyDeadFees,
            buyMarketingAndtestTradingFees,
            buyLiquidityFee,
            buyRewardsFee,
            buyDevFee,
            sellDevFee
    ...
    function _transfer(
        ...
        uint256 RewardsFee;
        uint256 deadFees;
        uint256 MarketingAndtestTradingFees;
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                MarketingAndtestTradingFees = sellMarketingAndtestTradingFees;
                ...
                MarketingAndtestTradingFees = buyMarketingAndtestTradingFees;
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + MarketingAndtestTradingFees + devFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyMarketingAndtestTradingFees + buyDevFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellMarketingAndtestTradingFees + sellDevFee);
        }
        ...
        uint256 _completeFees = sellMarketingAndtestTradingFees.add(sellDevFee) +
            buyMarketingAndtestTradingFees.add(buyDevFee);

        uint256 feePortions;
        if (_completeFees > 0) {
            feePortions = address(this).balance.div(_completeFees);
        }
        uint256 MarketingAndtestTradingPayout = buyMarketingAndtestTradingFees.add(sellMarketingAndtestTradingFees) * feePortions;
        uint256 devPayout = buyDevFee.add(sellDevFee) * feePortions;

        if (MarketingAndtestTradingPayout > 0) {
            (successOp1, ) = address(MarketingAndtestTrading).call{value: MarketingAndtestTradingPayout}("");
        }
        if (devPayout > 0) {
        ...
        emit SendDividends(
            dividends,
            MarketingAndtestTradingPayout + devPayout,
...
contract vftestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        vftestContract = vftest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "vftest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "vftest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main vftest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(vftestContract);

            uint256 prevBalance = vftestContract.balanceOf(address(this));
            ...
            {
                uint256 received = vftestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    vftestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
