 ...
 *  Tokenomics : 6% Marketing | 6% Madness                        
 *  Telegram : https://t.me/WorldCupMadness_BSC
 *
 *  Welcome to World Cup Madness
 *  The objective of this project is to ensure everyone gets to have fun during this World Cup. 
 *  There will be a game that is built onto telegram bot so everyone can interact with it conveniently while watching your favorite teams cruising through the World Cup.
 *  The LP will be locked for 1 month upon launching.
*/         
...
contract WorldCupMadness is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "World Cup Madness";
    string constant _symbol = "WCM";
    ...
    constructor () Auth(msg.sender) {
        ...
        //Marketing wallets are splitted to 6% Marketing and 6% Madness
        marketingWallet = 0xBC013fB5785F05aa78d3B8c5711f662fDc9fFFCa;  //Marketing wallet 1
        anothermarketingWallet = 0xBC013fB5785F05aa78d3B8c5711f662fDc9fFFCa; //Marketing wallet 2
