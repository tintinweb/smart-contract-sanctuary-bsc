...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x905894A5a9DCdcCb4542845B096E7bBA18990f38;
...
contract CutieInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cutie Inu"; // 
    string private constant _symbol = "CINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x905894A5a9DCdcCb4542845B096E7bBA18990f38);
