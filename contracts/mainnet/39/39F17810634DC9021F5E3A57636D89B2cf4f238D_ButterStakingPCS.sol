...
contract ButterStakingPCS is Ownable {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;


    // CHANGE THIS ON CHANGE OF EXCHANGE
    address MAIN_TOKEN_ADDRESS = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //Main TOKEN ADDRESS
    ...
    function deposit(uint256 _amount) public noReentrant  {
        ...
        require(_amount > 0, "0 is nothing"); // que la solicitud no sea por 0 Mains
