...
contract Farming is Pausable, Ownable, ReentrancyGuard {
    ...
    function rewardPerToken(uint256 _pid) private view returns (uint256) {
        ...
        return
            ...
            ((((endTime - pool.lastUpdateTime) * (pool.rewardPerSecond)) *
                1e18) / pool.totalAmount);
    }
    ...
    function _updateFeeRecipient(address _feeRecipient) internal {
        require(
            ...
            "Farming: _feeRecipient is zero address"
        );
    ...
    function withdraw(address _rewardAddress, uint256 _amount)
        external
        onlyOwner
    {
