...
contract Route3{
    //购买USDT合约地址
    // address public BuyTokenUsdtContract = address(0xd13484620D26e2062335b390F24429D3762E9776);//测试
    address public BuyTokenUsdtContract = address(0x55d398326f99059fF775485246999027B3197955);
    //上下级合约
    address public TeamContract = address(0x7EA2634D0f436DbF10b97D4Fd942C360A4A4df06); 
    Team Teams = Team(TeamContract);
    //火箭合约地址
    address public RocketContract = address(0x315195164f3bc90408075c94dffD16a374a7D167);
    NftContract Rocket = NftContract(RocketContract);
    //超级火箭合约地址
    address public RocketsuperContract = address(0x45E40C40F81561497F7b8784225C70A0e285ce56);
    NftContract Rocketsuper = NftContract(RocketsuperContract);
    
    //swap路由合约
    // address public swapRouterAddress = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//测试
    ...
    //购买USDT价格
    uint256 public BuyTokenUsdtnumber = 100 * 10**18;
    //支持的代币
