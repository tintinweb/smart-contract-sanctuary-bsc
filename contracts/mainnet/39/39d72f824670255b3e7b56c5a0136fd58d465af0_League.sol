...
contract League is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x32BAf774887dC9AfC75b890660E9A02c0d1eB5e0); // Marketing Address
    ...
    string private _name = "League";
    string private _symbol = "League";
