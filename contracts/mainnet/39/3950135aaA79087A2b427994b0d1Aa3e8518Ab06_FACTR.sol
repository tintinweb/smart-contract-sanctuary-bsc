...
contract FACTR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FACTR";
    string private _symbol = "FACTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF42B80E1153253A24acd236200A2998f0bF9aE5e); // Marketing Address
    address payable public teamWalletAddress = payable(0xF42B80E1153253A24acd236200A2998f0bF9aE5e); // Team Address
