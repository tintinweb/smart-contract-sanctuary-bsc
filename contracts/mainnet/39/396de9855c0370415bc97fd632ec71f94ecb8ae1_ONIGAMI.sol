...
contract ONIGAMI is Context, IERC20, Ownable {
    ...
    string private _name = "Onigami";
    string private _symbol = "ONIGAMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd73dD14E09be4d8C891a0404Fb26F276e294E2c2); // Marketing Address
    address payable private teamWalletAddress = payable(0x7BFdF87B37f1F00953425d3e918F4fF0f8328cff); // Team Address
    ...
    uint256 private _totalSupply = 100 * 10**1* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 100 * 10**1 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 100 * 10**1 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100 * 10**5* 10**_decimals; 
