...
/**
Telegram https://t.me/LowTaxWallStreetPortal
...
contract LowTaxWallStreet is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC4f86e8BDC399bE8e5d4d7705549B97Bfa9F3c7A); 
    address payable public Wallet_Dev = payable(0x0A653cAC5BA05c560B0E752F25a4133f067A1Bb3);
    ...
    string private constant _name = "LowTaxWallStreet"; 
    string private constant _symbol = unicode"LowTaxWSB"; 
    ...
    constructor () {
        ...
        _owner = 0x0A653cAC5BA05c560B0E752F25a4133f067A1Bb3;
