...
contract FLOKI is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 1000; // 10%
    uint256 public _walletMax = _totalSupply * 100 / 1000; //10% 
    ...
    string constant _name = "FlokiBurn";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xCE845c191a88675D8b588ACcF26641cF353CD99D;
        marketingWallet = 0xCE845c191a88675D8b588ACcF26641cF353CD99D;
