...
// MiniBitBurnReflect SmartContract 
...
contract MiniBitBurnReflect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MiniBitBurnReflect", "MBBR") {
        marketingWallet = payable(0x4f15F566df1000420de16100CA90b045C72Aec84);
        devWallet = payable(0x4f15F566df1000420de16100CA90b045C72Aec84);
        ...
        maxWallet = totalTokenSupply / 1; // 0.05%
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    MiniBitBurnReflect public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = MiniBitBurnReflect(mainContract);
