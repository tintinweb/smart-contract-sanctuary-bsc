...
contract BNBGrimaceCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB Grimace Coin";
    string private constant _symbol = "BNBGrimace";
