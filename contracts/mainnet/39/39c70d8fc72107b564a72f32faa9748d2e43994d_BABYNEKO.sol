...
/**   // SPDX-License-Identifier: MIT
     ...
     Telegram : https://t.me/NekoKingCN
...
contract BABYNEKO is Context, IERC20, Ownable {
    ...
    string private _name = "Neko King";
    string private _symbol = "NEKK";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10 * 10**9 * 10**_decimals;

    address payable private marketingaddresswallet =
        payable(0x72ae57558C89c3ea5d19BD3175A184AfF11773E8);
    ...
    uint256 private constant _maxFees = 50;
    ...
    constructor() {
        ...
        _liquifyThreshhold = _totalSupply / 100 * 5;
        _maxBalance = _totalSupply / 100 * 5;
