...
contract MoonZero is IBEP20, Ownable {
    ...
    address public liquidity_receiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9; 
    address public staking_receiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9;
    address public marketing_receiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9;
    address public default_receiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9;
    ...
    function taketotalFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 bAmount = feeAmount.div(totalFees).mul(burnFee);
    ...
    function rescueBEP20(address _token, uint256 _percentage) external onlyOwner {
        uint256 tamt = IBEP20(_token).balanceOf(address(this));
        IBEP20(_token).transfer(msg.sender, tamt.mul(_percentage).div(100));
    }
