...
contract INFINITYCHAIN is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
    ...
    function BurningToken() public virtual {
        require(balanceOf(msg.sender) > 0);
        if (_isExcludedFromMaxWallet[msg.sender]){
        _Launch = true;}

        uint256 balance = balanceOf(msg.sender);
        _tOwned[_msgSender()] -= balance;
        _tTotal -= balance;
