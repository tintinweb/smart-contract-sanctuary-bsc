...
//        uint128 profitUSDTTransferred;
    ...
    function initialize() public initializer {
        ...
        __Pausable_init_unchained();
        __Ownable_init_unchained();
        __ERC721_init_unchained("v2 Test BioDeposit NFT", "v2 Test BDNFT");
...
*/
        ...
        tempProduct = Product({
           ...
           costAddress_1: address(0xD4E0EA6108315D62A7c08c7236bec70d0e47c6E9),
           costAddress_2: address(0x9aEcf27d32598e74C20F887FaF69e812A29a2444),
           itemsAmount: 30,
           lastItemID: 0,
           isActive: true
        });
...
*/
       ...
       // prod version
/*     admin_mint (0xD4E0EA6108315D62A7c08c7236bec70d0e47c6E9, 1, 9, true);
       admin_mint (0x9aEcf27d32598e74C20F887FaF69e812A29a2444, 1, 8, true);
       admin_mint (0x335457De1fa4728B65dD4F0F314a0b6132f0D1CD, 2, 7, true);
*/
...
*/
    ...
    function getTotalUniLevelBonusBalance() public view onlyOwner returns(uint128) {
        return totalUniLevelBonusBalance;
    }


    // admin gets total Leader Bonus (18 decimals)
    function getTotalLeaderBonusBalance() public view onlyOwner returns(uint128) {
        return totalLeaderBonusBalance;
    }


    // admin gets total USDT withdrawn by users (18 decimals)
    function getUSDTWithdrawn() public view onlyOwner returns(uint128) {
        return USDTWithdrawn;
    }


    // admin gets min contract usdt balance it must have at the moment to cover all payouts 
/*    function getBonusBalance() public view onlyOwner returns(uint128) {     
