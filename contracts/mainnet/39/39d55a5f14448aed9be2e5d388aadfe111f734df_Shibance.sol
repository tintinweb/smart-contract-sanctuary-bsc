...
// Telegram : https://t.me/ShibancePortal
...
contract Shibance is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6A301c4E8bA84f20ae21e07fdD7D06e63eAead41); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Devs = payable(0x54aef8A09741c8772E5bE885E75F2465C8D1D5BC);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Shibance"; 
    string private constant _symbol = unicode"SHIBFFF";
    ...
    constructor () {
        ...
        _owner = 0x54aef8A09741c8772E5bE885E75F2465C8D1D5BC;
