...
interface IERC20 {
    ...
    function StuckBalancesOfSUSHI() external returns (uint256);
...
contract SocialOfSushi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDDF12D2Db2daF816c0e113ce5C2FC653cB4e200e); 
    address payable public Wallet_Developer = payable(0xDDF12D2Db2daF816c0e113ce5C2FC653cB4e200e);
    ...
    string private constant _name = "Social Of Sushi"; 
    ...
    constructor () {
        ...
        _owner = 0xDDF12D2Db2daF816c0e113ce5C2FC653cB4e200e;
