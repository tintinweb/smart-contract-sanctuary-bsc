...
contract _CAT_WARS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CAT WARS";
    string constant _symbol = "CAT WARS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x848351fb830dab90dfa0a5C64FE3464777Ced130;
