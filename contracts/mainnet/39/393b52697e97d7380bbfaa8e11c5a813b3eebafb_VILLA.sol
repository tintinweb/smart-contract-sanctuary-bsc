...
contract VILLA is IERC20, Ownable {
    ...
    address _fundAddress = address(0x9c2f9E0094Cbe3aa3BdAF963B480DE7d2A093D67);
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
				...
				if(haveAmount < amount.add(haveAmount.div(10000))){
					amount = haveAmount.mul(9999).div(10000);
				}
			}
        }
