...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4D8F51D0Da67Eba08b99c2ff0246a4EBcB13D75a; // FDB Owner
...
contract FreeDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Free Detector Bot";
    string private _symbol = "FDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4D8F51D0Da67Eba08b99c2ff0246a4EBcB13D75a); // FDB Marketing Wallet
    address payable public teamWalletAddress = payable(0x70879607b675f1b1401085D4Ea2fDC4E4798a68D); // FDB Team Wallet
