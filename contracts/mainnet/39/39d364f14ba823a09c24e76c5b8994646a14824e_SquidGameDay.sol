...
contract SquidGameDay
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGameDay";
    string private _symbol = "SquidGameDay";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87DeBd5864920D91Bf35B99B87Fd83D1AD7904DA);
    address payable public teamWalletAddress = payable(0x87DeBd5864920D91Bf35B99B87Fd83D1AD7904DA);
    address public immutable deadAddress = 0x87DeBd5864920D91Bf35B99B87Fd83D1AD7904DA;
