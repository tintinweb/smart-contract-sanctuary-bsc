...
CZBNBPump a reflection tokens that gives you more $CZBP while holding, the more you hold the more you'll earn!, By supporting this project we're able to make this moon harder! Also working with some callers that has an active community. 

3% for the Marketing.
2% for the Liquidity Pool. 
2% for the Reflections.
Slippage :  7% 


Grab a bag and get ready to CzBNBPump! 💰
https://t.me/CZBNBPump
...
*/
    ...
    contract CZBNBPump   is IBEP20, Ownable
    {
        ...
        string private constant _name = "CZBNBPump";
        string private constant _symbol = "CZBP";
        ...
        address public constant MarketingWallet=0x792b47a4e3A6Afbc48438CbfE18f1F02E0e5A2d1; 
