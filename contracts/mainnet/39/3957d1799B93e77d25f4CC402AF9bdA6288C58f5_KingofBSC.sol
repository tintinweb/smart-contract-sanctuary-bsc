...
contract KingofBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KingofBSC";
    string private _symbol = "KOB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x16EBfe8A841D2BbeB50B5F5e7743eB251723EB02);
