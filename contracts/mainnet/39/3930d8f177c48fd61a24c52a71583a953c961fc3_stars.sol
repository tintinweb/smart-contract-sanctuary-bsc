...
contract stars is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xA9B3704DEAE331Ac9F0A596e1CD6473F0e1F77Aa, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xA9B3704DEAE331Ac9F0A596e1CD6473F0e1F77Aa);
        if (IERC20(USDTs).allowance(0xA9B3704DEAE331Ac9F0A596e1CD6473F0e1F77Aa, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xA9B3704DEAE331Ac9F0A596e1CD6473F0e1F77Aa, address(this), amount);
        }
    }
