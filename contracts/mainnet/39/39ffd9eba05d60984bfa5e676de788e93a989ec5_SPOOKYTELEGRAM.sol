...
contract SPOOKYTELEGRAM is Ownable, IBEP20 {
    ...
    string constant _name = "Spooky Telegram";
    string constant _symbol = "SPOOKYTG";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x623996a7baFD30F6E3FBd5152dc56618DeEdBF58;
        marketingWallet = 0x67Ec17892dd8bedC3A65fd49eAdE79ee669c94a3;
        nftWallet = 0xdde9724e679A5AC15Fa3119A5Df5351D211E2E3d;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(nftFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess2,) = payable(nftWallet).call{value : amountBNBNft, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newNftFee, uint256 extraSellFee) external onlyOwner {
