...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf33B5dD4D1B513949937bc143E5765FB02985062;
...
contract ZillaGrow is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 750 * 10**9; //
    string private constant _name = "Zilla Grow"; // 
    string private constant _symbol = "$ZillaGrow"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xa286191Eebb0A0dEdebfA20B7e4cEd42180cE0db);
