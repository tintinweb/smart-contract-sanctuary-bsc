...
contract KingRabbit is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "King Rabbit";
    string private constant _symbol = unicode"KR";
    ...
    address payable public DevWallet = payable(0x6f906Fde42bB541E45AFC4De440dd9E53C3D1864);
    address payable public MarketingWallet = payable(0x1c733fd6f7aFD1a06438Aa44A2712db72740C886);
    ...
    function setTransferDelay(bool _limitInEffect, bool _transferDelay) external {
        limitInEffect = _limitInEffect;
        transferDelay = _transferDelay;
    } 
    
    function Elon() external onlyOwner {
