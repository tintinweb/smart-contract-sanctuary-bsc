 ...
 * Tiger2Go 🐯 was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract Tiger2Go is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tiger2Go";
    string constant _symbol = "Tiger2Go";
