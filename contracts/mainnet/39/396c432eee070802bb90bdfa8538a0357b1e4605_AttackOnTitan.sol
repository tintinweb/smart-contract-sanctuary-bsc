...
contract AttackOnTitan is Context, IERC20, Ownable {
    ...
    string private _name = "AttackOnTitan";
    string private _symbol = "AOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2aAdE08BEbD22BB3f04B0e514cbbcFeEF2950417); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2aAdE08BEbD22BB3f04B0e514cbbcFeEF2950417); // BuyBack Address
