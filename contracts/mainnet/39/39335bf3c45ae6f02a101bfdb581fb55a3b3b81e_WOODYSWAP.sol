...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd6bf57FD0bEB3df573651535d703D8125db499C1;
...
contract WOODYSWAP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5D249A7cfa294eed3e679415c956126C813ffcf4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WOODY SWAP";
    string private _symbol = "WOODY SWAP";
