...
contract Calyx is Initializable,  ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, OwnableUpgradeable {
    ...
    function takeFee() private lockTheSwap {
        ...
        if (tokensForLiquidity > 0 && baseTokenBalance > 0) {
