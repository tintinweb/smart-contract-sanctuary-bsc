...
contract WhalePoor is Context, IERC20, Ownable {
    ...
    string private constant _name = "Whale Poor"; // 
    string private constant _symbol = "WHALES"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x465065B6EAE0AcD5D8cf086ced7c5e7C3bF0d953;
