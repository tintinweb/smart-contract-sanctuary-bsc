...
/**
 Im about to launch „FuckZilla“

 https://t.me/FuckZillaPortal

Fr it’s not funny at all. 30k ppl are waiting since 3hours. Who are you? Are you satoshi? Launch that shit and lets see. I fuck your 600m V1. Fkin retards conversation like they wanna troll. 

U guys are nothing. Come back to reality faggots.

In order to do so, we need you, the hodlers, to listen close and hodl tight.
...
15 second buy/sell cooldown

Tax is split with 70% to LP and 30% to marketing.
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  SHIBA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // 2% Rewards
...
/* Token contract */
contract FuckZilla is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address SHIBA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // 2% Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xcD1240c1E438E0F11BbCa3FDa71fFAf9A4F37fCD;
    ...
    // Name and symbol
    string constant _name = "FuckZilla";
    string constant _symbol = "FuckZilla";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9a38Ec7186A8B8657b154d9D3b835B66A7c9176d;
