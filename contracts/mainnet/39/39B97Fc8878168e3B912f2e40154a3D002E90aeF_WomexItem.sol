...
// File: contracts\WomexItem.sol

pragma solidity ^0.8.16;
contract WomexItem is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    Pausable,
    ...
    ERC721Burnable
{
    constructor() ERC721("World Of Mining Item", "WomexItem") {}
    ...
    function transferFromGameToUser(address to, uint256 tokenId)
        public
        onlyOwner
    {
