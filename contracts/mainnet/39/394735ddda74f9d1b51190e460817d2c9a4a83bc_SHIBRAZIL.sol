...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA450C77D9c2bE082abf551a4c005573fFe2e5D0c; // owner address
...
contract SHIBRAZIL is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBRAZIL";
    string private _symbol = "CBF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40738d3b5013c9793Ddf6c06e89d532709c9C91F); // Marketing Address
    address payable public teamWalletAddress = payable(0xA450C77D9c2bE082abf551a4c005573fFe2e5D0c); // Team Address
