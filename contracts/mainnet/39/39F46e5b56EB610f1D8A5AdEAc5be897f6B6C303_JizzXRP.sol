...
contract JizzXRP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Jizz XRP", "JIZZXRP") {
        marketingWallet = payable(0xed0Ee338063164414779E96dcA347650fdDbe527);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    JizzXRP public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = JizzXRP(mainContract);
