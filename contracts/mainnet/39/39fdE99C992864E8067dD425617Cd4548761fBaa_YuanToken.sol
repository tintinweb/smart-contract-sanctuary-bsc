...
// ----------------------------------------------------------------------------
contract YuanToken is ERC20Interface, Owned {
    ...
    event Issued(address to, uint tokens, string memo);
    ...
    // to : EOS address
    // tokens : number of tokens in YUAN
