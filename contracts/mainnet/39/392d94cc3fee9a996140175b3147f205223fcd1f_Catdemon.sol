...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBca3DFaf363b80aE838A25E7B4672A7fbd71dCb3;
...
contract Catdemon  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x4C4c592EdE2C5657f4839D095374d63f8cceB77B;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Catdemon";
    string private _symbol = "Catdemon";
