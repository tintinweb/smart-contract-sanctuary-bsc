...
contract DevIsLMAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is LMAO";
    string private _symbol = "$LMAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3637a964D6A00791EA86471C34e6C2416AFF872c);
    address payable public BuyBackWalletAddress = payable(0x3637a964D6A00791EA86471C34e6C2416AFF872c);
