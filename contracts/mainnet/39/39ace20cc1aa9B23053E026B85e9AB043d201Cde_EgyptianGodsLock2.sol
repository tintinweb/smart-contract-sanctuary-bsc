...
contract EgyptianGodsLock2 is LockContract {
    IERC20 public token = IERC20(0x7430b4D4DEf23f2055f7df3679c6dd7bcEf11D12);

    function egyptianGodsLock() public onlyOwner {
        deposit(token, token.balanceOf(msg.sender), 7, 0x6f773df7A3f9a859ccaE58B90C3Ec0fFB8c17617);
    }
