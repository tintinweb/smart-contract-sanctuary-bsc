...
Total Supply: 100 000 000 $VL
Max Wallet: 1% - 100 000 $VL

Taxes are 9/9
3% on every transaction is for marketing.
3% on every transaction is for utility development.
3% on every transaction if for buy-back

https://t.me/VanguardListings
https://vanguardlistings.com/
 */
...
contract vanguardlistings is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Vanguard Listing";
    string private constant _symbol = "VL";
    ...
    // Total Supply
    uint256 public constant _totalSupply = 10**9 * _DECMULTIPLIER;
    ...
    //Tax wallets
    address public teamWallet = 0x9f0d5C80984fD96AAd1FB6D199471ab9B090658f;
    address public treasuryWallet = 0x9f0d5C80984fD96AAd1FB6D199471ab9B090658f;

    // Tax Split
    uint256 public teamShare = 100;
    uint256 public treasuryShare = 200;
    uint256 public rewardShare = 200;
    uint256 public burnShare = 0;
    uint256 public constant SHAREDIVISOR = 500;
