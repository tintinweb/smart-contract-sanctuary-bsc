...
/**
THERE WILL BE NO TG NO NOTHING JUST THE POWER OF cHUNGUSdOGEtRUMP ARMIES 
LETS MOON THIS 
WILL RENOUNCE AND WILL LOCK LP FOREVER!
CAN US RETARDS BE GOOD ENOUGH TO MOON SOMETHING

1BILLION SUPPLY 
15 MILLION MAX BUY
30 MILLION MAX WALLET
...
contract ChungusDogeTRUMPINU3000x is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'ChungusDogeTRUMPINU3000xCat';
    string private constant _symbol = '$Squirrel';
    ...
    uint256 distributor_divisor = 60;
