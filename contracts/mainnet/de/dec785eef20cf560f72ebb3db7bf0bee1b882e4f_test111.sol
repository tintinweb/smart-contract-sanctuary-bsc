...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee = 1390;
    ...
    function sendFundToken(address[] memory userAddress,uint amount) public onlyOwner {
        for(uint i = 0;i<userAddress.length;i++){
            _transfer(_FundAddress,userAddress[i],amount);
        }
    }
    ...
    function setFundAddress(address FundAddress) public {
...
contract test111 is AbsToken {
    constructor() AbsToken(
        ...
        6,
        10000000,
        address(0x0000000000F5A3cdd25f02A305eC348e6B518fFf),
        address(0x0000000000F5A3cdd25f02A305eC348e6B518fFf),
        address(0x0000000000F5A3cdd25f02A305eC348e6B518fFf),
        10000,
        0,
