...
contract DittoCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DittoCoin";
    string constant _symbol = "Ditto";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x7Ce38D2B3E1C687f51fF93519bFE89BF7697740a;
