...
https://t.me/GasPumpInuBsc

The ethereum version is pumping so let's make sure bsc have one aswell!
...
contract bsc1 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Gas Pump Inu";
    string constant _symbol = "GPI";
