...
contract travelcoin is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x34a5c95A38a4b73557668e015998Bf86e026aB35); //nice
    address payable public charityAddress = payable(0x34a5c95A38a4b73557668e015998Bf86e026aB35); //nice
    ...
    uint256 private _tTotal = 1100000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Travel Coin"; //CC"; //CC
    string private _symbol = "TRA";  //nice
    ...
    uint256 public _maxTxAmount = 16500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 16500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 11000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 16500;// 0.01*165 token for 0.01 bnb (set as per requirements)
