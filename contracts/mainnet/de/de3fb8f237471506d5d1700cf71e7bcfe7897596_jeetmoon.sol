...
/**
Welcome to jeetmoonbsc  Together we will celebrate the Titano Days!
Join the TG https://t.me/JeetMoonBSC
...
contract jeetmoon is Context, IERC20, Ownable {
    ...
    string private _symbol = "jeetbsc";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x5e2A2CcAb10e6c8973C8FC9971997453B4e23448); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5e2A2CcAb10e6c8973C8FC9971997453B4e23448); // BuyBack Address
