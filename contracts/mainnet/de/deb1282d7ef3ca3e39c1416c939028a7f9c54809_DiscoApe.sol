...
contract DiscoApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Disco Ape";
    string private _symbol = "DAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbaaaE0Eb239BBcb482c78dba2B50Bb3bBDC8F84f); 
    address payable public buyBackWalletAddress = payable(0xbaaaE0Eb239BBcb482c78dba2B50Bb3bBDC8F84f); 
