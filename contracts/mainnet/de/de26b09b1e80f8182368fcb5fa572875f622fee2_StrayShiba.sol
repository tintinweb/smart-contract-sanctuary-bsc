...
contract StrayShiba is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "StrayShiba";
    string constant _symbol = "SSINU"; 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (1000) * (30); // 3%
    uint256 public _maxSellTxAmount = _totalSupply / (1000) * (15); // 1,5%
    uint256 public _maxWalletToken = _totalSupply / (1000) * (30); // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xB3a68052CaaDCf240f26b8cFb1431Aa8Ee522F52 ;
        marketingFeeReceiver = 0xB3a68052CaaDCf240f26b8cFb1431Aa8Ee522F52 ;
        devFeeReceiver = 0x4599bE6DF11a1F57979900b1965a9df61894503F ;
