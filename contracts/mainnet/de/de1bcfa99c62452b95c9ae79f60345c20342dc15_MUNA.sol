...
3BNB Initial liquidity (Burned)
1% Dev tokens

Buy your max bags cheap and create a community for it
...
contract MUNA  is IBEP20, Auth {
    ...
    string constant _name = "MUNA";
    string constant _symbol = "MUN";
    ...
    address public topholdersFeeReceiver;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa69304C99Ba4A2Df10378BEFb819345c25b38b7B;
        topholdersFeeReceiver = 0xa69304C99Ba4A2Df10378BEFb819345c25b38b7B;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess2, ) = payable(topholdersFeeReceiver).call{
    ...
    function setFeeReceivers(address MarketingTax, address topholdersTax) external onlyOwner {
        marketingFeeReceiver = MarketingTax;
        topholdersFeeReceiver = topholdersTax;
    }
