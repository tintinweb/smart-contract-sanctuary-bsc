...
contract minicap is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1 * 10**2 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Minicap';
    string private _symbol = 'minicap';
