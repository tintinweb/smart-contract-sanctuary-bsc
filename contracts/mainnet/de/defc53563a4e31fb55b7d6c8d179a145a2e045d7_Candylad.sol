...
contract ZillaDogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ZillaDogeDividendTracker", "ZillaDoge_DividendTracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 500000000000 * (10**decimals()); //must hold 10000+ tokens
    }
...
contract Candylad is ERC20, Ownable {
    ...
    address public marketingWallet = 0xBBBaA8f60Bf4a603F66C8f192599e6DEA802b9a5;
    address public buybackWallet = 0xBBBaA8f60Bf4a603F66C8f192599e6DEA802b9a5;
    ...
    constructor() ERC20("BabyHare","BabyHare") {
