...
contract OSKCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "OSKCZ";
    string public _symbol = "OSKCZ";
    ...
    uint256 private _totalSupply = 59 * 10**10 * 10**16 * 10**_decimals;
    uint256 public _maxTxAmount = 59 * 10**10 * 10**16 * 10**_decimals; 
    uint256 public _walletMax = 59 * 10**10 * 10**16 * 10**_decimals;
