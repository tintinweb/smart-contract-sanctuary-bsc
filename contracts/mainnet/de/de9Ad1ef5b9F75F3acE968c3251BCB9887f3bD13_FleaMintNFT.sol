...
contract FleaMintNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    string private baseURI =
        "ipfs://bafybeiet3dhqq2ffa3bzcr7ju4xrc75g3wo37qltzmuva3ns5qlchstgn4/";
    ...
    address public withdrawFundsAddress =
        0x72167926e9ce1A6afAE79827823c0d2Fd6aD565D;
    ...
    function setNewWithdrawFundsAddress(address newAddress) external onlyOwner {
        withdrawFundsAddress = newAddress;
    }
    ...
    function userMint(uint256 qty, uint256 amount, Rarity rarity) external {
        ...
        ERC20TokenToBeAccepted.transferFrom(
            msg.sender,
