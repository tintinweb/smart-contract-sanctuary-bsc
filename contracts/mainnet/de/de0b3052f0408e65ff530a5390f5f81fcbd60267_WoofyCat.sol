...
// telegram : https://t.me/woofycat
// website  : https://woofycat.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x9bb99dF4F2E343f7c1C1A93557a983B687Cf3947; // owner address
...
contract WoofyCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Woofy Cat";
    string private _symbol = "Woofycat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCdD2D1Aa4De9b53d45678Aabb89E7e49114106F3); // Marketing Address
    address payable public teamWalletAddress = payable(0x9bb99dF4F2E343f7c1C1A93557a983B687Cf3947); // Team Address
    ...
    uint256 public _teamShare = 1; // original 7

    uint256 public _totalTaxIfBuying = 8;  // original 7
    uint256 public _totalTaxIfSelling = 8;  // original 7
