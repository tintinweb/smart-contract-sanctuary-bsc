...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6495253f4c3e9af5410f4bF9C608f69793956CC; // owner address
...
contract CNNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CN_Network";
    string private _symbol = "CNN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6495253f4c3e9af5410f4bF9C608f69793956CC); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6495253f4c3e9af5410f4bF9C608f69793956CC); // Team Address
