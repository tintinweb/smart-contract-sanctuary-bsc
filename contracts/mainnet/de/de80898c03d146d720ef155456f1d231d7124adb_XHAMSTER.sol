...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06270e86018B09f4037388f5B80c9D5C87cd9aE5; // owner address
...
contract XHAMSTER is Context, IERC20, Ownable {
    ...
    string private _name = "X-hamster.com";
    string private _symbol = "XHAMSTER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x554186Fba63746900E0D2d198E3385c3a0018404); // Marketing Address
    address payable public teamWalletAddress = payable(0x06270e86018B09f4037388f5B80c9D5C87cd9aE5); // Team Address
