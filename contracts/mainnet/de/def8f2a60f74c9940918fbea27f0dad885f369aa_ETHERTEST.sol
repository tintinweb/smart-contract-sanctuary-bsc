...
contract ETHERTEST is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ETHERTEST", "ETEST") {
        ...
        marketingBuyFee = 3;
        liquidityBuyFee = 1;
        devBuyFee = 2; //used for Staking
        burnBuyFee = 0;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee + devBuyFee + burnBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0x67DCEd03c40d09A977CBbb9aeA223C9DFa4Df984); // set as marketing wallet
    	devWallet = address(0x67DCEd03c40d09A977CBbb9aeA223C9DFa4Df984); // set as staking wallet 
        ...
        // exclude from paying fees or aving max transaction amount
