...
contract VestingWallet {
    ...
    constructor(address token_, address executor_, address beneficiary_, uint256 start_, uint256 duration_) {
        token = token_;
        executor = executor_;
    ...
    function releasable() public view returns (uint256) {
        return _vestingSchedule(vestedAmount(), block.timestamp) - released;
    }

    function release() external onlyExecutor {
