        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x094Cf93a8C1b149D4ec16A137327e1b68937C338), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000000,//Su
        address(0x094Cf93a8C1b149D4ec16A137327e1b68937C338),//
        address(0x094Cf93a8C1b149D4ec16A137327e1b68937C338)//
    ){
    }
}