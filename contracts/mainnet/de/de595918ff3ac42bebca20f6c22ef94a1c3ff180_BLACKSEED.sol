...
contract BLACKSEED is BLACKSEEDDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BLACKSEEDTeam;
    address private CharityBLACKSEED;
    ...
    string public override name = "BLACKSEED";
    string public override symbol = "BLACKSEED";
    ...
    constructor(uint totalSupplyValue, address BLACKSEEDTeamAddress, address CharityBLACKSEEDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BLACKSEEDTeam = BLACKSEEDTeamAddress;
        CharityBLACKSEED = CharityBLACKSEEDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BLACKSEEDTeam] =  totalSupply * 5 / 1000;
        balances[CharityBLACKSEED] = totalSupply * 5 / 1000;
        
        balances[_owner] = totalSupply * 990 / 1000;
    }
