...
/**
 * @title GOH BEP20 token
 * @dev  
 *      The goal of GOH is to increase in price over time.
 *      Based on the Ampleforth protocol.
 */
contract GOH is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("GoHigh", "GOH", uint8(DECIMALS))
        public
    {
     ...
     * 2% fee is taken for development purposes.
     */
