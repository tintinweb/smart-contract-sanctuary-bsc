...
contract asdasd is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaed24A2fe6469ed6410C7A4890e4FD6ACAD8e91B); 
    address payable public wDev = payable(0x3B0046C1f64De4Af66466cC4bFDF86A93A479D0d);
    ...
    string private constant _name = "asdasdasd"; 
    string private constant _symbol = unicode"asdasdasdasd"; 
    ...
    constructor () {
        ...
        _owner = 0x3B0046C1f64De4Af66466cC4bFDF86A93A479D0d;
    ...
    function isExcludedFromFee(address from, address to) private returns(bool){
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(wDev, removeRandom);
