...
contract DdaoToken is Context, IERC20, Ownable {
    ...
    //uint256 public _lqFee = 20;//lp分红
    uint256 public _mk1Fee = 10;//营销钱包
    //uint256 public _mk2Fee = 10;
    uint256 public _lpFee = 20;//回流底池
    uint256 public totalFee = 30;

    uint public lqTxAmount = 2e18;
...
//uint mta2, uint mta1, 
    function setTxAmount(uint lta,uint mta1, uint apta)external onlyOwner{
        mk1TxAmount = mta1;
