...
contract Novembull is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "nBULL";
    ...
    address public liquidityReceiver = address(0xD8163dc9cC04D9D9365E589ed6A367D12A3CdaB3);
    address public marketingWallet = address(0xfe2629f62AcCcCb3d5FCF4C6Cd40Aa115a76B273);
    address public bbWallet = address(0xfe2629f62AcCcCb3d5FCF4C6Cd40Aa115a76B273);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 180 && !prePhase) {
            buyFee.liquidity = 3;
            buyFee.marketing = 3;
            buyFee.bb = 0;
        ...
        if(launched && block.timestamp > launchEpoch + 180 && !phaseOne) {
            ...
            _maxTxAmount     = 1_500_000 * 10**_decimals;
