...
contract HashiruGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Hashiru Grow";

    string private _symbol = "HASHIRUGROW";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xfEd6A81d565923B00E7dd68ED8154493f13debcE;
