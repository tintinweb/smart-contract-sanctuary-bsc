...
/**
  SPRITEZILLA is inspired to PitStarshipVenus that fly 200x. If you've missed one of them this is your chance. Hop in!

  SPRITEZILLA - is a decentralized finance (Defi) meme token. BSSV is a auto-liquidity generating protocol and we will have a charity for the homeless family.
...
-5% Automatic add liquidity
   ...
   Twitter: https://twitter.com/SPRITEZILLA
 🌎Website:https://www.SPRITEZILLA.com
 ☎️TG: https://t.me/SPRITEZILLA
...
contract SPRITEZILLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPRITEZILLA"; 
    string private constant _symbol = "SPRITEZILLA"; 
