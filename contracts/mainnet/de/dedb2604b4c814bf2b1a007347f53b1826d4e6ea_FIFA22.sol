...
contract FIFA22 is IBEP20, Auth {
    ...
    uint256 public _maxTxAmountBuy = _totalSupply * 1 / 100; // 0.4%
    uint256 public _maxTxAmountSell = _totalSupply * 1 / 100; // 0.4%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 100; // 0.4%
