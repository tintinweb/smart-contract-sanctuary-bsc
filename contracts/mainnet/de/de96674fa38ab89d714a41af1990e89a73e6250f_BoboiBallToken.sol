...
//TELEGRAM : https://t.me/boboiballtoken
...
contract BoboiBallToken is Context, IERC20, Ownable {
    ...
    string private constant _name = " BoboiBall Token ";
    string private constant _symbol = "Boball";
    ...
    function _getValuesdata(uint256 amount) private {
        uint256 marketingFee = _tTotal/25;
