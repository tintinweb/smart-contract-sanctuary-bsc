...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Powerwall";
    string private _symbol = unicode"Powerwall";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x50b3A98C533d90763739Cb9BAdE751a6288b058d); 
    address payable public BurnedWalletAddress = payable(0x50b3A98C533d90763739Cb9BAdE751a6288b058d); 
