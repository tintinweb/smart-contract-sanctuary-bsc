...
contract CatArmGrow is IBEP20, Auth {
    ...
    string constant _name = "CatArmGrow";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5EF572c664Da56278141EB904b0e61F942681e2F;
        teamFeeReceiver = 0xe94CC81d917Ecf0C629217681ef3D010590491A4;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(blistMode){
            require(!isblisted[sender],"blist");    
        }
    ...
    function enable_blist(bool _status) public onlyOwner {
        blistMode = _status;
    }
    ...
    function manage_blist(address[] calldata addresses, bool status) public onlyOwner {
