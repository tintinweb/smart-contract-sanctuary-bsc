...
TG : https://t.me/BFlCNETWORK_PORTAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFAbB8ED3587a98C4abb4bD1a073db6a3E1bE2E16; // owner address
...
contract BFIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BFIC NETWORK";
    string private _symbol = "BFIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8E0c4cE8b869F4F417f1f03F5B2fb4E31441DAf1); // Marketing Address
    address payable public teamWalletAddress = payable(0xFAbB8ED3587a98C4abb4bD1a073db6a3E1bE2E16); // Team Address
