...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x931d8606BabCf98D639F75eDABF8C232c4022f3c; // owner address
...
contract CEOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CEO INU";
    string private _symbol = "$CENU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x931d8606BabCf98D639F75eDABF8C232c4022f3c); // Marketing Address
    address payable public teamWalletAddress = payable(0x931d8606BabCf98D639F75eDABF8C232c4022f3c); // Team Address
