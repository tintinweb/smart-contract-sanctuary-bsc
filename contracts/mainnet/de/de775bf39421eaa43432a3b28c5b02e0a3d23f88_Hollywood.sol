        ...
        if (_swapPairList[sender]) {//Buy
            ...
            if (inviteAmount > 0) {
                ...
                if (address(0) != invitor && (0 == _invitorHoldCondition || balanceOf(invitor) >= _invitorHoldCondition)) {
                    _takeTransfer(sender, invitor, inviteAmount, true);
                } else {
                    _takeTransfer(sender, fundAddress, inviteAmount, false);
                }
            }
            ...
            if (lpDividendAmount > 0) {
                ...
                _takeTransfer(sender, address(this), lpDividendAmount, false);
            }
        } else if (_swapPairList[recipient]) {//Sell
            uint256 sellLPAmount = tAmount * _sellLPFee / 10000;
            if (sellLPAmount > 0) {
                feeAmount += sellLPAmount;
                _takeTransfer(sender, address(this), sellLPAmount, false);
            }
...
contract Hollywood is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0x4589aA0fB44A0736342053c63b71DB936A07495D),
        address(0x75d756E23E0602228E842100F3b5A90223DD66fa)
    ){
