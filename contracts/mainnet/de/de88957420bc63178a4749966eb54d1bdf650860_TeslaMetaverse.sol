...
contract TeslaMetaverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Tesla Metaverse";
    ...
    uint256 public sejswbaLiquidityFee = 3;

    uint256 public sejswbaMarketingFee = 6;
    uint256 public sejswbaBuyBackFee = 1;
    ...
    constructor (address MarketingWalletAddress, address buyBackWalletAddress) {
      ...
      BuyBackWalletAddress = payable(buyBackWalletAddress);
        ...
        _totalTaxIfSelling = sejswbaLiquidityFee.add(sejswbaMarketingFee).add(sejswbaBuyBackFee);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax) external onlyOwner() {
        sejswbaLiquidityFee = newLiquidityTax;

        sejswbaMarketingFee = newMarketingTax;
        sejswbaBuyBackFee = newBuyBackTax;
        _totalTaxIfSelling = sejswbaLiquidityFee.add(sejswbaMarketingFee).add(sejswbaBuyBackFee);
    }
