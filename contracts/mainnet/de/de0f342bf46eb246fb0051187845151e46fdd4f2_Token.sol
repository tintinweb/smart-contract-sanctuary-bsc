...
contract Token is Context, IERC20, Ownable{
    ...
    constructor () public{
        _balanceOf[msg.sender] = 2200000000000000;            // Give the creator all initial tokens
        _totalSupply = 2200000000000000;                    // Update total supply
        name = 'Q22';                                 // Set the name for display purposes
        symbol = 'Q22';                                   // Set the symbol for display purposes
