...
contract BeluTests is ERC20, Ownable {
    ...
    function removeAllFee() public onlyOwner {
      ...
      function promarketingt() public onlyOwner {
          if(_promarketingT == 0 && _marketinganddevT == 2 && _priceandliqT == 2 && _charityT == 1 && _burnFee == 0) {
          _marketinganddevT = 1;
          _promarketingT = 1;
          }

          if(_promarketingT == 1 && _marketinganddevT == 1 && _priceandliqT == 2 && _charityT == 1 && _burnFee == 0) {
          _marketinganddevT = 2;
          _promarketingT = 0;
          }
      }
