...
contract NOVTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NOVTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("NOVTest", "NTest") {
        ...
        dividendTracker = new NOVTestDividendTracker(
            payable(this),
            router,
...
contract NOVTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    NOVTest public NOVTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        NOVTestContract = NOVTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "NOVTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "NOVTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NOVTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(NOVTestContract);

            uint256 prevBalance = NOVTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = NOVTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    NOVTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
