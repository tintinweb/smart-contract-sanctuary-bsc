...
contract DT96 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xD940d9370566D16fEE4C685626B8A547C01e2791); // Marketing Address
        
    address payable public teamAddress =
        payable(0x759Efd837b2aF326DD2973Ec592B7C48E8fFed0f); // Dev Address

    address payable public liquidityAddress =
        payable(0x759Efd837b2aF326DD2973Ec592B7C48E8fFed0f); // Liquidity Address
    ...
    string private constant _name = "Dejitaru Tsuka 1996";
