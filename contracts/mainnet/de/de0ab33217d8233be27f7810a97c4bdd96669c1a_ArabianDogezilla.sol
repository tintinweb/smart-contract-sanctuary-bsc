...
contract ArabianDogezilla is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100_000_000_000 * 11**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "Arabian-DogeZilla "; //
    string private constant _symbol = "$ADogeZilla"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xbE30336F77E41B3c45d0908eCBfd140C1c3264De ;
