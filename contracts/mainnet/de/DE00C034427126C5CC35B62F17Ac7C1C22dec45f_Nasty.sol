...
contract Nasty is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 10_000_0 * 10**18;
    uint256 public maxSellLimit = 10_000_0 * 10**18;
    uint256 public maxWalletLimit = 20_000_0 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 5;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xddf9065f23F4c00d331766f8e11C879d15094a1f;
    address public devWallet = 0xddf9065f23F4c00d331766f8e11C879d15094a1f;
    ...
    Taxes private taxes = Taxes(6, 2, 2);
    Taxes private sellTaxes = Taxes(4, 2, 2);
    ...
    constructor(address routerAdd) BEP20("Nasty", "NASTY") {
    ...
    function _transfer(
        ...
        if (
            sender != pair && !exemptFee[recipient] && !exemptFee[sender] && !_liquidityLock
        ) {
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private liquidityLock {
