...
// File: contracts/YardAirDrop.sol
...
/// @notice `YardAirDrop` is a contract for sending multiple ETH/ERC20 Tokens to
/// multiple addresses.
///
/// Used for the https://nftyard.io/AirDrop
///
contract YardAirDrop is
    Pausable,
    Escapable,
    MultiTransfer,
    MultiTransferEqual,
