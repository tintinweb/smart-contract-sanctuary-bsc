...
contract GASTONINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe875eaeB2107ab4ae8F32a1b4C36e80bb0224f40); 
    address payable public Wallet_Dev = payable(0x25bCc06934091A707ee94e74AEc5a1eE6B02dbc1);
    ...
    string private constant _name = "GASTON INU"; 
    string private constant _symbol = unicode"GASTON INU"; 
    ...
    constructor () {
        ...
        _owner = 0x25bCc06934091A707ee94e74AEc5a1eE6B02dbc1;
