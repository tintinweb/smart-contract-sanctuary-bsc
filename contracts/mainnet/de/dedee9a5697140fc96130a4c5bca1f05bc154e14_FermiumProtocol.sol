...
// Fermium Protocol MIUM Token
// The Fermium Protocol, created for the user experience stuck between hundreds of DApps and new
// designs that are constantly difficult to adapt, aims to develop a communication network between
// DApp applications in the BSC network. It makes all DApp applications available within the Fermium DApp,
// which learns and operates through machine learning.
// Website: fermium.network
// AutoLP: 1%
// Marketing: 3%
// Charity: 2%
...
contract FermiumProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Fermium Protocol";
    string private _symbol = "MIUM";
    ...
    address public charityWallet = 0x4c0FD04b3510fa568510cE778D9CDAcCE6A1F30C;
