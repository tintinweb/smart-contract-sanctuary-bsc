...
/**
Aggretsuko, also known by its original Japanese title Aggressive Retsuko, is a Japanese animated comedy streaming
television series based on the eponymous character created by "Yeti" for the mascot company Sanrio. 
The character first appeared in a series of animated shorts by Fanworks which aired on TBS Television between April 2016
and March 2018.
An original net animation (ONA) anime series adaptation was launched worldwide on Netflix in April 2018,
followed by a second season in June 2019, a third season in August 2020 and a fourth season in December 2021.
A comic book series adaptation by Daniel Barnes and D.J. Kirkland was launched by Oni Press.

A mobile game, Aggretsuko: The Short Timer Strikes Back, was released by Hive for Android and iOS in July 2020.
The game, which is available worldwide, includes the full 100 short episode series,
which need to be unlocked individually via normal gameplay. 
Whilst subtitled, the short episodes were not dubbed into other languages.
...
/* Token contract */
contract Aggretsuko is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x6f1B9cDCF1D3EBfBFdfD643080E4E5A69B85bAEA;
    ...
    string constant _symbol = "Aggretsuko";
