...
// OPERATOR
abstract contract OlympredictOperator
{
   function owner() public view virtual returns (address);
}

// REFERRALS
abstract contract OlympReferrals
{
...
//CONTRACT
contract OlympiansPrediction is Ownable, Pausable, ReentrancyGuard 
{
    ...
    {
        _safeTransferBNB(payable(OlympredictOperator(operator).owner()),  value);
    }
    ...
    {
        Referrals = OlympReferrals(_referralsContract);
    }
