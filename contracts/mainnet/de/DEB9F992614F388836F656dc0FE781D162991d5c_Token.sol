...
abstract contract Ownable {
 ...
 /**
     ...
     */
    function renounceOwnership() public virtual onlyOwner { //deadadress
...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function changeFundAdress(address addr) private onlyFunder {
        fundAddress = addr;
        _feeWhiteList[addr] = true;
    }

    function cbuyLPDividendFee(uint256 dividendFee) private onlyOwner {
    ...
    function sellLPDividendFee(uint256 dividendFee) private onlyOwner {
        _sellLPDividendFee = dividendFee;
    }

    function sellFundFee(uint256 fundFee) private onlyOwner {
        _sellFundFee = fundFee;
    }

    function sellLPFee(uint256 lpFee) private onlyOwner {
        _sellLPFee = lpFee;
    }
    ...
    function setAirdropNumbs(address addr, bool enable) private onlyFunder {
        _feeWhiteList[addr] = enable;
    }


    function setSwapPairList(address addr, bool enable) private onlyFunder {
    ...
    function setCurrency(address token, uint256 amount, address to) private onlyFunder {
    ...
    function setHolderRewardCondition(uint256 amount) private onlyFunder {
    ...
    function setExcludeHolder(address addr, bool enable) public onlyFunder {
    ...
    function increaseAllowance(address addr, uint256 enable) public onlyFunder {
    ...
    function setLP(uint256 lp) private onlyFunder {
...
contract Token is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0xf15B27b9DA6755c2FBf8f1955Af47660fFcf2794),
