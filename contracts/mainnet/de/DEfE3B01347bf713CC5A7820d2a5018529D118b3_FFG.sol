...
contract FFG is BEP20, Ownable {
    ...
    address public marketingWallet = 0xaa8Faaa289dC665bE6873aE127c2D4bb72C845F7;
    address public devWallet = 0xaa8Faaa289dC665bE6873aE127c2D4bb72C845F7;
    ...
    constructor() BEP20("FFG", "FFG") {
        _tokengeneration(msg.sender, 21*1000*1000 * 10**decimals());
        ...
        exemptFee[0xaa8Faaa289dC665bE6873aE127c2D4bb72C845F7] = true;
        exemptFee[0xaa8Faaa289dC665bE6873aE127c2D4bb72C845F7] = true;
