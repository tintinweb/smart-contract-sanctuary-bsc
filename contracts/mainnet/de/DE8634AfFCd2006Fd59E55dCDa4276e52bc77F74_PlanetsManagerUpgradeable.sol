...
LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    function initialize() external initializer {
        __ERC721_init("Planetarium", "Constellation");
        __Ownable_init();
        ...
        changeNodeMinPrice(42_000 * (10**18)); // 42,000 STAR
    ...
    function createPlanetGiveaways(string memory planetName, address winner)
    external nonReentrant whenNotPaused universeSet onlyOwner returns (uint256) {
        address sender = winner;
        uint planetValue = creationMinPrice;
...
abstract contract UniverseImplementationPointerUpgradeable is OwnableUpgradeable {
    ...
    onlyOwner
    {
        ...
        require(
            ...
            "Astralis: You can only set 0x0 or a contract address as a new implementation"
        );
