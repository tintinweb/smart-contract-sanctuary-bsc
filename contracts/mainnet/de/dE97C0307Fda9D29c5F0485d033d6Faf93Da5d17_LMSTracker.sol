...
contract LMSTracker is Initializable, OwnableUpgradeable {
    ...
    function initialize() initializer public{
        ...
        tokenContract = 0x580e2b3170AA36e7018eaD248298C8cc18B0f019;

        _proposedTokens.add(0x1CE0c2827e2eF14D5C4f29a091d735A204794041); // AVAX
        _proposedTokens.add(0xCC42724C6683B7E57334c4E856f4c9965ED682bD); // MATIC
        _proposedTokens.add(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); // XRP
        _proposedTokens.add(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // ETH
        _proposedTokens.add(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402); // DOT
        _proposedTokens.add(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // SHIB
        _proposedTokens.add(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD); // LINK
        _proposedTokens.add(0xBf5140A22578168FD562DCcF235E5D43A02ce9B1); // UNI
        ...
        minimumBalanceForRewards = 1e9 * (10**18);
        lastFriday = 1669410000; // Friday, November 25, 2022 9:00:00 PM UTC
    ...
    function addOperator(address _operator) external onlyOwner {
        ...
        require(_operator != address(0), "LMSTracker: Zero address cannot be an operator");
