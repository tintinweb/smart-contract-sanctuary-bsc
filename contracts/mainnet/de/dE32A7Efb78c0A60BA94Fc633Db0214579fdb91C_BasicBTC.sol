...
Telegram: https://t.me/BasicBitcoinPortal
...
contract BasicBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BasicBTC";
    string constant _symbol = "BASICBTC";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee <= feeDenominator/10, "Total Fee is Over 10%" );
