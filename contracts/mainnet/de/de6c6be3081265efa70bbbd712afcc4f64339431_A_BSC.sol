...
contract A_BSC is Context, IERC20, Ownable {
    ...
    string private _name = "SAHARA";
    string private _symbol = "SAHA";
    ...
    function setSwapTokenAt(uint256 amount) external onlyOwner() {
