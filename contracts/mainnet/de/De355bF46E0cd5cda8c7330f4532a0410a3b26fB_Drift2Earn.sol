...
contract Drift2Earn is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 2 / 100; // 
    uint256 public _maxWalletToken =  1000000000000000 * 3  / 100; // 2%
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "DRIFT to Earn"; // 
    string private constant _symbol = "DRIFT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x39C40Da80DA21BFe4eE1D379f8afe9c0157b73c9;
