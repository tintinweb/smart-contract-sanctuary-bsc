...
contract  MiauInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Miau Inu";
    string private _symbol = "MIAUINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12AF9E71Bb22b916AB9d85FFba1dbfBc1FcB1a0b);
    address payable public teamWalletAddress = payable(0xFc31ba934f92c9db1cF21DC03F45295a80f36AE2); 
