...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  OWNERDEV = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = OWNERDEV.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(OWNERDEV);
        ...
        uint256 amount = OWNERDEV.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            OWNERDEV.transfer(shareholder, amount);
...
/* Token contract */
contract Gomenasai is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address OWNERDEV = 0x3B477d1B1E12795FAc2bD064aD56480e02411DBA; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x3B477d1B1E12795FAc2bD064aD56480e02411DBA;
    ...
    // Name and symbol
    string constant _name = "Gomenasai";
    string constant _symbol = "Gomenasai";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (20 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (10 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (20 mil)
