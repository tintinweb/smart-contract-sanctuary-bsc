...
contract babyaBNBc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babyaBNBc";
    string private _symbol = "babyaBNBc";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBcb7e2Bda081702343fC4f7A551d11C01b5126d0); 
    address payable public BurnedWalletAddress = payable(0xBcb7e2Bda081702343fC4f7A551d11C01b5126d0); 
