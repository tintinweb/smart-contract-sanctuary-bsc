...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6fbD0c4Ff95F9F7d8EFC12fbed680130B74f0Da9; // owner address
...
contract CORKIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CORKIINU";
    string private _symbol = "CORKIINU";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x6fbD0c4Ff95F9F7d8EFC12fbed680130B74f0Da9); // Marketing Address
    address payable public teamWalletAddress = payable(0x6fbD0c4Ff95F9F7d8EFC12fbed680130B74f0Da9); // Team Address
