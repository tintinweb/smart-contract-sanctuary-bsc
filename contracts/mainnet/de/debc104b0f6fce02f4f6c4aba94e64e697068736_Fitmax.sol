...
contract Fitmax   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fitmax ";
    string private _symbol = "FITMDAO";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x1a99207cD8b1da9783355Ca416460A43880D782c); 
    address payable public ttWal = payable(0x1a99207cD8b1da9783355Ca416460A43880D782c); 
