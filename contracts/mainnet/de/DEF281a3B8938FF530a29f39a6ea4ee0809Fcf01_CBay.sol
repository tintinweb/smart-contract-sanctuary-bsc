...
The #1 E-Commerce Platform! Buy & Sell Marketplace with Crypto!

Website: (https://Cbaybsc.com)
*/
...
contract CBay is Ownable, IERC20 {
    ...
    string private _name = "CBay";

    string private _symbol = "CBay";
