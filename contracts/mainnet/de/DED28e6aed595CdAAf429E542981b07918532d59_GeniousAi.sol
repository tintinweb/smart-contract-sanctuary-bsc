...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE822fD1B35DD67B3bd8DbAC469CF2E5703890862; // owner address
...
contract GeniousAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"GeniousAi";
    string private _symbol = unicode"GAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE822fD1B35DD67B3bd8DbAC469CF2E5703890862); // Marketing Address
    address payable public teamWalletAddress = payable(0xE822fD1B35DD67B3bd8DbAC469CF2E5703890862); // Team Address
    ...
    uint256 public _walletMax = 14000 * 10**_decimals;
