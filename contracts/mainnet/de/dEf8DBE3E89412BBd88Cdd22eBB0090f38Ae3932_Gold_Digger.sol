...
Buy tax: 12% (7% marketing, 5% liquidity)
Sell tax: 15% (8% marketing, 7% liquidity)
...
contract Gold_Digger is Context, IBEP20, Ownable { 
    using SafeMath for uint256;

    address WBNB                         = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress                  = 0x0000000000000000000000000000000000000000;
    address burnAddress                  = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress       = 0xaA290ebC7bc8BE09E6059b2512D25F4D94c596d9;
    address public autoLiquidityReceiver = 0xaA290ebC7bc8BE09E6059b2512D25F4D94c596d9;

    string constant _name    = "Gold Digger";
    ...
    uint256 public externalFee       = 8;
    uint256 public sellExternalFee   = 10;

    uint256 public liquidityFee      = 4;
    uint256 public sellLiquidityFee  = 5;

    uint256 public totalBNBFee        = externalFee + liquidityFee;
    uint256 public totalSellFee       = sellExternalFee + sellLiquidityFee;
    ...
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 200; 
    ...
    function setFees(uint256 _externalFee, uint256 _sellExternalFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalBNBFee       = _externalFee + _liquidityFee;
        totalSellFee      = _sellExternalFee + _sellLiquidityFee;
