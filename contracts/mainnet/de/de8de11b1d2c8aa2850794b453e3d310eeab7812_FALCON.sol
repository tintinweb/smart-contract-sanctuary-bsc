...
/**
🔥Falcon Master🔥
Space is made of Falcon stars.
Trade, earn, and win crypto Become a STAR on the most popular decentralized platform in the galaxy.

Features New Dapps
- Swap
- Farms - ( Lock Reward ) - ( Auto compounding )
- Pools - ( Auto Automatic restaking )

- NFT Marketplace ( Coming soon )
- NFT staking Boost ( Coming soon )
- Prediction price BNB fork pancakeswap ( Coming soon )
*/
