...
/**
   /$$$$$$                                /$$   /$$                     /$$$$$$$$ /$$$$$$$$ /$$   /$$       /$$$$$$$  /$$$$$$$$ /$$$$$$$         /$$$$$$   /$$$$$$ 
 /$$__  $$                              |__/  | $$                    | $$_____/|__  $$__/| $$  | $$      | $$__  $$| $$_____/| $$__  $$       /$$__  $$ /$$$_  $$
| $$  \__/  /$$$$$$  /$$$$$$  /$$    /$$ /$$ /$$$$$$   /$$   /$$      | $$         | $$   | $$  | $$      | $$  \ $$| $$      | $$  \ $$      |__/  \ $$| $$$$\ $$
| $$ /$$$$ /$$__  $$|____  $$|  $$  /$$/| $$|_  $$_/  | $$  | $$      | $$$$$      | $$   | $$$$$$$$      | $$$$$$$ | $$$$$   | $$$$$$$//$$$$$$ /$$$$$$/| $$ $$ $$
| $$|_  $$| $$  \__/ /$$$$$$$ \  $$/$$/ | $$  | $$    | $$  | $$      | $$__/      | $$   | $$__  $$      | $$__  $$| $$__/   | $$____/|______//$$____/ | $$\ $$$$
| $$  \ $$| $$      /$$__  $$  \  $$$/  | $$  | $$ /$$| $$  | $$      | $$         | $$   | $$  | $$      | $$  \ $$| $$      | $$            | $$      | $$ \ $$$
|  $$$$$$/| $$     |  $$$$$$$   \  $/   | $$  |  $$$$/|  $$$$$$$      | $$$$$$$$   | $$   | $$  | $$      | $$$$$$$/| $$$$$$$$| $$            | $$$$$$$$|  $$$$$$/
 \______/ |__/      \_______/    \_/    |__/   \___/   \____  $$      |________/   |__/   |__/  |__/      |_______/ |________/|__/            |________/ \______/ 
                                                       /$$  | $$                                                                                                  
                                                      |  $$$$$$/                                                                      */
/**               
Telegram : https://t.me/GravityEthereum_Bep20
...
contract GravityETH is ERC20, Ownable {
    ...
    GravityETHDividendTracker public dividendTracker;
    ...
    constructor() ERC20("GravityETH Bep20", "GETH") {
        marketingWallet = payable(0x03E0a49bAc42bDfE9254ca7258C767D414aa3dCb);
        devWallet = payable(0x03E0a49bAc42bDfE9254ca7258C767D414aa3dCb);
        ...
        dividendTracker = new GravityETHDividendTracker(
            payable(this),
            router,
...
contract GravityETHDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    GravityETH public GravityETHContract;
    ...
    constructor(
        ...
        defaultToken = token;
        GravityETHContract = GravityETH(mainContract);
    ...
    function _transfer(
        ...
        require(false, "GravityETH_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "GravityETH_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GravityETH contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(GravityETHContract);

            uint256 prevBalance = GravityETHContract.balanceOf(address(this));
            ...
            {
                uint256 received = GravityETHContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    GravityETHContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
