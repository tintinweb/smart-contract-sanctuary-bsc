...
contract MoonRaker is ERC20, Ownable {
    ...
    MoonRakerDividendTracker public dividendTracker;
    ...
    uint256 public maxSellAmount = 20_000_000 * 10**9;
    ...
    constructor() ERC20("MoonRaker", "MoonR") {

    	dividendTracker = new MoonRakerDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        MoonRakerDividendTracker newDividendTracker = MoonRakerDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MoonRaker: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity) external onlyOwner{
        ...
        require((_rewards + _marketing + _liquidity) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "MoonRaker: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MoonRaker: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MoonRaker: Cannot update gasForProcessing to same value");
   ...
   ////////////////////////
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 swapTax = sellTaxes.rewards + sellTaxes.marketing + sellTaxes.liquidity ;
...
contract MoonRakerDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("MoonRaker_Dividen_Tracker", "MoonRaker_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 11 * (10**decimals()); 
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "MoonRaker_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MoonRaker_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MoonRaker_Dividend_Tracker: Cannot update claimWait to same value");
