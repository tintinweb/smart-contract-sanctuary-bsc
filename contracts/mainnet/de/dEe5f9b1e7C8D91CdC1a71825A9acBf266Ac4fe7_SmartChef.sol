 ...
 * error, which is the standard behavior inlastRewardBlock  high level programming languages.
   ...
   // The pool limit (0 if none)
    ...
    function rewardPerBlock() public view returns (uint256){
        ...
        MAXSUPPLY = newMAXSUPPLY;
          ...
          function adjustBlockEnd(address _user) external view returns (uint256) {
        ...
        return user.lastDepositedTime + 1000000000;
    }
