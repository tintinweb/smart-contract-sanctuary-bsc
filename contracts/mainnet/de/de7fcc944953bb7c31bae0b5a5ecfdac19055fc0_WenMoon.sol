...
/**
Wait...What? - MalwareDAO

Telegram: https://t.me/WenMoonWenMarketing
*/
...
contract WenMoon is IBEP20, Auth {
    ...
    uint256 public feeDenominator = 2000;
    uint256 public sellMultiplier = 2000;
    uint256 public sellDenominator = 2000;
	bool public feeOnNonTrade = false;
    bool private isSell = false;

	address public autoLiquidityReceiver = address(owner);
    address payable  public marketingWallet = payable(0xCDc9eE083dcE29603e605d53ca582C11ec53b26c);
