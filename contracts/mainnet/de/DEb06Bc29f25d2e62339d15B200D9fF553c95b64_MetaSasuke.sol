...
🥷  Welcome to MetaSasuke 🥷

Sasuke with his new Visual Prowess has teleported in Crypto World. 
MetaSasuke is Anime based community token, that has a goal to get good ground holders 
and make solid standing in Crypto Market. Get Ready to be part of our Shadow Hokage's 
journey in the Crypto World and unlock the secrets of Ootsuki Clan in the moon.


🥷 Website : https://metasasuke.online/

🥷 Telegram : https://t.me/MetaSasuke
...
pragma solidity ^0.6.12;
    ...
    contract MetaSasuke is Context, IERC20, Ownable {
        ...
        string private _name = 'MetaSasuke';
        string private _symbol = 'METASASUKE';
