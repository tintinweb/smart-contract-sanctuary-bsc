...
contract MatrixV1 is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x867Dd20D5aF1A7329e840c68beF6aCcc5FD80f70));

    address private liquidityReceiver =
        0x06323B30716AD8219F55905431d2799BCc4e5d13;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "Matrix V1";
    string private _symbol = "Matrix V1";
    ...
    event SwapAndLiquify(
        ...
        payable(address(0x06323B30716AD8219F55905431d2799BCc4e5d13));
