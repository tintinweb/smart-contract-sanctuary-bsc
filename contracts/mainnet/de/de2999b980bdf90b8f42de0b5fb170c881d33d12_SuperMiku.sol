...
contract SuperMiku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Miku"; // 
    string private constant _symbol = "Supermiku"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x626d785ef93f4F32C7735aCf59c1Cf120119a34B;
