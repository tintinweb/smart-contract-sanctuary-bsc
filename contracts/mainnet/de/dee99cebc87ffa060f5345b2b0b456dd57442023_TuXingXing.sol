...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        marketingAddress[0] = address(0x300a8C17E64A4E5Db2e21F3E1f92C4A8c615e3e0);
...
contract TuXingXing is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("TuXingXing", "TuXingXing") {
        ceo = _msgSender();
