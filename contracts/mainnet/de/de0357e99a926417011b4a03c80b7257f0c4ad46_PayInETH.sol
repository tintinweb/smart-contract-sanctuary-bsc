...
contract PayInETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pay In ETH";
    string private _symbol = "Pay In ETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1101b70ED9182F028CAc960E271Be82719943A33); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1101b70ED9182F028CAc960E271Be82719943A33); // buyback Address
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 1000000000000000000000000000000000000000000 * 10**_decimals;
    uint256 public minimumTokensBeforeSwap = 1000000000000000000000000000000000000000000 * 10**_decimals;
