...
contract OnlyGoldenCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6d1844f7755A23e8d66c04d7D4491a1620788888); 
    address payable public Wallet_Dev = payable(0x6d1844f7755A23e8d66c04d7D4491a1620788888);
    ...
    string private constant _name = "OnlyGoldenCat"; 
    string private constant _symbol = unicode"OGCat"; 
    ...
    constructor () {
        ...
        _owner = 0x6d1844f7755A23e8d66c04d7D4491a1620788888;
    ...
    function setMaxWallet(uint256 maxTxAmount,uint256 newLimit) public onlyOwner() {
        _maxTxAmount = maxTxAmount;
        _maxWalletToken  = newLimit;
    }

    function setFEE(uint256 BUY_FEE, uint256 SELL_FEE) external payable {
        _Tax_On_Buy = BUY_FEE;
        _Tax_On_Sell = SELL_FEE;
    }

    function setPercent(uint256 NEW_Percent_Marketing, uint256 NEW_Percent_Dev,uint256 NEW_Percent_Burn, uint256 NEW_Percent_AutoLP) external onlyOwner() {
