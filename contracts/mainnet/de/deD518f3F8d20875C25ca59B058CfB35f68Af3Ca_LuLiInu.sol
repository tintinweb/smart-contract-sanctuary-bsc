...
Instead of creating new tokens to reward trusty stakers, 
LuliInu tokens are collected on each sale of the token.
 This way the normal inflation a yield farm always tried to combat is simply not possible! Burns are executed on every sell transaction which makes the circulating supply continiously shrink, hence the name $LULI !
📱 Telegram:
https://t.me/LuliInu

🌐 Website: www.luliinu.live
...
contract LuLiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LULI INU";
    string constant _symbol = "LULI";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 150;
