...
/**
TG:https://t.me/ELONDUSTOFFICIAL
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x188CF33291e0AaA547864B81A504C5FE112E4f31; // owner address
...
contract ELONDUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON DUST";
    string private _symbol = "EDUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40889283b79a3343A403fd9e98001004863dE5b3); // Marketing Address
    address payable public teamWalletAddress = payable(0x40889283b79a3343A403fd9e98001004863dE5b3); // Team Address
