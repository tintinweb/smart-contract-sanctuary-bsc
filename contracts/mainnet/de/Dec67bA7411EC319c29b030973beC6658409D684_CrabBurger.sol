...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_ol == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract CrabBurger is Context, IERC20, Ownable {
    ...
    string private _name = "CrabBurger";
    string private _symbol = "CrabBurger";
