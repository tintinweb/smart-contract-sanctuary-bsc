...
interface worldblockchainmetaDeployer {
...
contract worldblockchainmeta is worldblockchainmetaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private worldblockchainmetaTeam;
    address private Charityworldblockchainmeta;
    ...
    string public override name = "world blockchain meta";
    string public override symbol = "wbmeta";
    ...
    constructor(uint totalSupplyValue, address worldblockchainmetaTeamAddress, address CharityworldblockchainmetaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        worldblockchainmetaTeam = worldblockchainmetaTeamAddress;
        Charityworldblockchainmeta = CharityworldblockchainmetaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[worldblockchainmetaTeam] =  totalSupply * 4 / 100;
        balances[Charityworldblockchainmeta] = totalSupply * 4 / 100;
