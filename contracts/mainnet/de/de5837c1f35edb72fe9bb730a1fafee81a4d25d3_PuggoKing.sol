...
contract PuggoKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5b0321dFbf5bD1fE1501454789b9EC47a14FE55b);
    ...
    string private constant _name = "PuggoKing";
    string private constant _symbol = "PGK";
