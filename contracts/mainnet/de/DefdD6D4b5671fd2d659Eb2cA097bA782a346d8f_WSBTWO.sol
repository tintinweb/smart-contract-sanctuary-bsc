...
contract WSBTWO is ERC20, Ownable{
    ...
    Taxes private taxes = Taxes(4,1,4);
    ...
    constructor(address _marketingWallet, address _devWallet) ERC20("WallStreetBets 2.0", "WSBTWO") {
