...
contract VenusLendingAdapter is ILendingPlatform, ILendingPlatformBSC, Uint2Str {
        ...
        returns (AssetMetadata memory assetMetadata)
    {
        ...
        assetMetadata.canSupply = !IVComptroller(platform).actionPaused(vToken, IVComptroller.Action.MINT);
        assetMetadata.canBorrow =
            !IVComptroller(platform).actionPaused(vToken, IVComptroller.Action.BORROW) &&
            !IVComptroller(platform).actionPaused(vToken, IVComptroller.Action.REPAY);
    }
