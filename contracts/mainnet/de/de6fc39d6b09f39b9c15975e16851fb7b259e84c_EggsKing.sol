...
/**
世界上最著名的加密蛋。/ 让我们做一个趋势AVE。
这款 Egg King 拥有令人难以置信的细节和精确度，将统治世界市场。
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCbA1AfA26D3489C75104A6d86490dC6978C4Ef60; // owner address
...
contract EggsKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EggsKing";
    string private _symbol = "EggsKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCbA1AfA26D3489C75104A6d86490dC6978C4Ef60); // 
    address payable public teamWalletAddress = payable(0xCbA1AfA26D3489C75104A6d86490dC6978C4Ef60); // 
