...
contract genechain is Context, IERC20, Ownable {
    ...
    string private constant _name = "GENECHAIN"; // 
    string private constant _symbol = "RNA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xe2A0758FEa011538f67464a789E4453543e7bdc3;
