...
*/
 ...
 /** HUNTER BIDEN BSC - A+ for cinematography



    https://twitter.com/elonmusk/status/1547238325907513346?s=20&t=IaU6A0U39oKjtrIzfxuMVg
...
contract HUNTERBIDENBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "HUNTER BIDEN BSC";
    string private constant _symbol = "$HBIDEN";
    ...
    address private marketingWallet = address(0x81206B25df20DB859e7Dd9f2e3D4FabEC9989522);
    address private liquidityReceiver = address(0x81206B25df20DB859e7Dd9f2e3D4FabEC9989522);
