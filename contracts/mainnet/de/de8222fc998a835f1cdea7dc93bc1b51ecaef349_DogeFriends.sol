...
contract DogeFriends is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public ncount=0;
  constructor() ERC721("Doge Friends", "DogeFriends") {}
  ...
  function mint2address(address recipient,uint256 count) public onlyOwner(){
	  for(uint256 i=0;i<count;i++){
		 ncount=ncount+1;
		 _safeMint(recipient,ncount);
	  }
  }
