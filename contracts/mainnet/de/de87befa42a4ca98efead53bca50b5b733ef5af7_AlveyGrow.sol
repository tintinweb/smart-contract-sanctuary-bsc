...
Telegram : https://t.me/alveygrowBSC
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3aBF31f6Fd257ceEaDBa2A49193c8b7706B375A7;
...
contract AlveyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Alvey Grow"; // 
    string private constant _symbol = "$wALV"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x9A56b0aa89677043f0B5Dab0F34028cc4e76BCF0 );
