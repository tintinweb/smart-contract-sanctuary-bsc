...
/**
    ...
    Cooper  is a long-term project that brings multiple crypto utilities into one app. 
    Utilities to be released in the near future are a custom crypto address / (EVM) generator and a Crypto wallet.
    
    LAST PROJECT GEISHA WAS 300X
    

    https://t.me/CooperBSC
...
contract COOPER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x00949931688e80bDe1f5121F509d881136f28FFB;
 
    string constant _name = "COOPER";
    string constant _symbol = "$COOPER";
