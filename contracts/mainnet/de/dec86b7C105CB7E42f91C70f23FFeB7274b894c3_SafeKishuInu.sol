...
Safe Kishu Inu is a Reflect BUSD + Auto Liquidity based tokenomics on Binance Smart chain which aims to be more deflationary while enabling PUMPANOMICS!!
  🖥 Website : www.safekishuinu.live

📢Telegram : https://t.me/SafeKishuInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //8% of busd in face of rewards will distributed too all holders
...
abstract contract Auth {
    ...
    /**
     * Function modifier to require caller to be contract owner true
     */
    modifier onlyOwner() {
    ...
    /**
     * Function modifier to require caller to be authorized true
     */
    modifier authorized() {
    ...
    /**
     * Authorize address. Owner only true
     */
    ...
    /**
     * Remove address' authorization. Owner only ,only owner ha ve wright to do
     */
    ...
    /**
     * Transfer ownership to new address. Caller must be owner. Leaves old owner authorized this will be used when owner renounced
     */
...
contract SafeKishuInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SafeKishuInu"; 
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  //busd to all holders 
    ...
    uint256 public swapThreshold = _totalSupply * 6 / 2000; // 0.03%
    ...
    constructor () Auth(msg.sender) {
        ...
        //isDividendExempt[msg.sender] = true; yes
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        isDividendExempt[ZERO] = true;

        // SafeKishuInu Wallet Information 
        autoLiquidityReceiver = msg.sender;
        marketingWallet = msg.sender; 
        anothermarketingWallet = 0xE2219005e0D91b62D3571396Ed746278AE7AB3c0;
