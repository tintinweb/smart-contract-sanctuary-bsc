...
contract DonkeyKongApe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DonkeyKongApe";
    string private _symbol = "KONG";
    uint8 private _decimals = 18;
    address payable public marketingAddress = payable(0xDBCb3F23bfcdAdC5F6e8e5a81996C816608A517a);
