...
contract Cryptobase is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptoBase"; // 
    string private constant _symbol = "CBASE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xFb4E80C283B93C8C099cBfa45FC3889350e9DCdd;
