...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _balances[address(0xc64C22452D9C111EA7B98aeC59847278c425A957)] = total * (4) / (1000);//LP
        _balances[address(0x889F05d4583bbeD97311E394F627f03326832F0C)] = total * (4) / (1000);//LP
        _balances[address(0xB91458A3bE48054475835A501A43c13b06CD9058)] = total * (4) / (1000);//LP
        _balances[address(0x3fb54e781871C2ce05b9348c6e0BE5b7c2E852C7)] = total * (4) / (1000);//LP
        // _balances[address(0x3fc07B909B14ED5Ff24bB0Ad69438d67f1ef40ae)] = total * (4) / (1000);//LP
        _balances[msg.sender] = total * (4) / (1000);//LP
        ...
        _balances[address(0x1f856398b29Ef714eEc91cBb523506F4B7AE4A9A)] = total * (280) / (1000);//node token
        
        emit Transfer(address(0), address(ReceiveAddress), total * (600) / (1000));
        emit Transfer(address(0), address(0xc64C22452D9C111EA7B98aeC59847278c425A957), total * (4) / (1000));
        emit Transfer(address(0), address(0x889F05d4583bbeD97311E394F627f03326832F0C), total * (4) / (1000));
        emit Transfer(address(0), address(0xB91458A3bE48054475835A501A43c13b06CD9058), total * (4) / (1000));
        emit Transfer(address(0), address(0x3fb54e781871C2ce05b9348c6e0BE5b7c2E852C7), total * (4) / (1000));
        // emit Transfer(address(0), address(0x3fc07B909B14ED5Ff24bB0Ad69438d67f1ef40ae), total * (4) / (1000));
        emit Transfer(address(0), msg.sender, total * (4) / (1000));
        ...
        emit Transfer(address(0), address(0x1f856398b29Ef714eEc91cBb523506F4B7AE4A9A), total * (280) / (1000));
    ...
    function _tokenTransfer(
        ...
        _takeTransfer(sender, recipient, tAmount - sellBurnFee);
    }
    ...
    function isLpAddress(address addr) public pure returns(bool) {
        if (addr == 0xc64C22452D9C111EA7B98aeC59847278c425A957 ||
            addr == 0x889F05d4583bbeD97311E394F627f03326832F0C ||
            addr == 0xB91458A3bE48054475835A501A43c13b06CD9058 ||
            addr == 0x3fb54e781871C2ce05b9348c6e0BE5b7c2E852C7 ||
            addr == 0x3fc07B909B14ED5Ff24bB0Ad69438d67f1ef40ae
            ){
            return true;
        }
        return false;
