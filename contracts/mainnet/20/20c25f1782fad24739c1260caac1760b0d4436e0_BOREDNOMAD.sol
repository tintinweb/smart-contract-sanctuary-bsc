...
contract BOREDNOMAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bored Nomad";
    string private _symbol = "bNomad";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81F86cc3aC3425CE7F0145b9cFf033F251a6AD8d); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x700406436e9fa60A0dD4603Fd40A868DB632F067); // Developmental Address
