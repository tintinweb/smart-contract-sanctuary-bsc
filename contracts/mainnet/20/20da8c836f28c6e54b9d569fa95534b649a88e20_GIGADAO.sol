...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbc8C503a7b458510A54Fa5366F8ac5cC29481F36; // owner address
...
contract GIGADAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GIGA DAO";
    string private _symbol = "GIGA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbc8C503a7b458510A54Fa5366F8ac5cC29481F36); // Marketing Address
    address payable public teamWalletAddress = payable(0xbc8C503a7b458510A54Fa5366F8ac5cC29481F36); // Team Address
