...
contract BEARSEASONCOIN is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BearSeasonCoin";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 1000; // 6% marketing, 2% team 2% development 
    ...
    uint256 marketingFeeSell = 1000; // 6% marketing, 2% team 2% development
