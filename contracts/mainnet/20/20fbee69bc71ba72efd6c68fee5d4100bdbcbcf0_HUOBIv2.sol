...
contract HUOBIv2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HUOBIv2";
    string private _symbol = "HUOBIv2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD114D3354e13F982f3Ef12eB270798fE9AAB9dC3); 
    address payable public BurnedWalletAddress = payable(0xD114D3354e13F982f3Ef12eB270798fE9AAB9dC3); 
