...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC65CDC608Ab57398d8377187A80f65c4A75D63f6; // owner address
...
contract BABYTKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY TKO";
    string private _symbol = "BTKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC65CDC608Ab57398d8377187A80f65c4A75D63f6); // Marketing Address
    address payable public teamWalletAddress = payable(0xC65CDC608Ab57398d8377187A80f65c4A75D63f6); // Team Address
