...
contract Unicorneum is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        _tokenTransfer(from,to,amount,takeFee,feecat);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee,uint256 feecat) private {
