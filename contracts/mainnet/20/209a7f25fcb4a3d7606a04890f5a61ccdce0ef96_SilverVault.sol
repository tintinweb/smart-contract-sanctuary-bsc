...
contract SilverVault is Context, IERC20, Ownable {
    ...
    string private constant _name = "SilverVault";
    string private constant _symbol = "SilverVault";

    address public _PancakeSwapV1RouterUniswap = 0x05251a2B8d5Ab7Af9ECcb9592979Cf8F5862Ea34; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x05251a2B8d5Ab7Af9ECcb9592979Cf8F5862Ea34; //can be the same
