...
contract xlxt is IERC20, Ownable {
    ...
    address private _communityAddress = address(0xF8824F706Ca8C9fDB735cc7a6BAc42ECE78d5fA4);
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || _destroyAmount >= _destroyMaxAmount){
            ...
            if(to != uniswapV2Pair){
                require(balanceOf(to).add(amount) <= 5 * 10**18);
            }
        }
