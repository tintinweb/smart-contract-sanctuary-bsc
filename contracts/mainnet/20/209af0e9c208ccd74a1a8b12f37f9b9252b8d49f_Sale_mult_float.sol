...
contract Sale_mult_float is Ownable {
    ...
    function buyToken(uint256 amountBUSD, address swapToken, string memory orderId) public onlyActive returns(bool) {
    ...
    function buyTokenView(uint256 amountBUSD, address swapToken) public view returns(uint256 token, uint256 securities) {
