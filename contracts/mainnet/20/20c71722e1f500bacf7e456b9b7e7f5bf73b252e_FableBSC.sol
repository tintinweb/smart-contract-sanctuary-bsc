...
contract FableBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    FableBSCDividendTracker public dividendTracker;
    ...
    constructor() ERC20("FableBSC", "FableBSC") {
        ...
        dividendTracker = new FableBSCDividendTracker(
            payable(this),
            router,
...
contract FableBSCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    FableBSC public FableBSCContract;
    ...
    constructor(
        ...
        defaultToken = token;
        FableBSCContract = FableBSC(mainContract);
    ...
    function _transfer(
        ...
        require(false, "FableBSC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "FableBSC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FableBSC contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(FableBSCContract);

            uint256 prevBalance = FableBSCContract.balanceOf(address(this));
            ...
            {
                uint256 received = FableBSCContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    FableBSCContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
