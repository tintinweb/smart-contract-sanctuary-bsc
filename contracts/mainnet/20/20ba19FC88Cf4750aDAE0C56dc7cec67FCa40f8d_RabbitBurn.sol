...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5AcD2C10a27D3337164841D8Bc33096f6D629741; // whatDOGE
...
contract RabbitBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Burn";
    string private _symbol = "RBURN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5AcD2C10a27D3337164841D8Bc33096f6D629741); // Marketing Address
    address payable public teamWalletAddress = payable(0x5AcD2C10a27D3337164841D8Bc33096f6D629741); // Team Address
