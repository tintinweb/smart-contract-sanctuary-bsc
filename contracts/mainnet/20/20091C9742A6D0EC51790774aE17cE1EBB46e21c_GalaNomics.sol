...
contract GalaNomics is IBEP20, Auth {
    ...
    string constant _symbol = "GalaNomics";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 0.5%
    ...
    uint256 public reflectionFeeBuy = 30;
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 150;
    uint256 devFeeSell = 0;
    uint256 public totalFeeSell = 200;
