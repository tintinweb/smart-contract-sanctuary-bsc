...
contract YHToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("YH", "YH") {
        address newOwner = address(0x9175Ed8A9EB05464C5d2016673940CF62A3C0781);
    
        uint256 totalSupply = 18000 * 1e18;
        
        maxTransactionAmount = 2 * 1e18; // 0.5% maxTransactionAmountTxn
    	...
    	marketingWallet = address(0x5A237877624c335Caa89dc9b1D67dC32dDEc1940); // set as marketing wallet
        buyBackWallet = address(0x5A237877624c335Caa89dc9b1D67dC32dDEc1940); // set as marketing wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * (10**18); //must hold 10,000+ tokens
    }
