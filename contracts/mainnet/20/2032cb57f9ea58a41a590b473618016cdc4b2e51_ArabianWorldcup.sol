...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN 
    IBEP20 BUSD = IBEP20(0x49f2339D323486b614c9a427ca2994E0D14FF596); 
...
/* Token contract */
contract  ArabianWorldcup is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x49f2339D323486b614c9a427ca2994E0D14FF596; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x2Ff8Fb0c6f3E6e8DE4193f732184e530aFC04f20;
    ...
    // Name and symbol
    string constant _name = "ARABIAN WORLDCUP";
    ...
    uint256 private swapThreshold = _totalSupply * 20 / 10000; // 0.2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2Ff8Fb0c6f3E6e8DE4193f732184e530aFC04f20;
