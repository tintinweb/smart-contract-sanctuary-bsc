...
contract xGEMx is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x92253d1CDd15FeAE2A5B99AaCdBCC93FFf3f3bd4); 
    address payable private _marketingAddress = payable(0x92253d1CDd15FeAE2A5B99AaCdBCC93FFf3f3bd4);
    ...
    constructor() {
        ...
        _isExcludedFromFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true;//pinklock
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.transfer(amount.mul(5).div(7));
        _developmentAddress.transfer(amount.mul(2).div(7));
    }
