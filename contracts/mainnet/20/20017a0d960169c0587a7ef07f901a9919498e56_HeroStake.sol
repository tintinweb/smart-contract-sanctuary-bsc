...
contract HeroStake is Ownable, ReentrancyGuard {
    ...
    uint256 public LPStandard = 11 * 10 ** 16;
    address public poolAddress = 0x9Bf4EB197cf1d011B835Ae83f9E74377815Fa5bC;
    ...
    mapping (address => bool) private _alreadyOrdinary;
    mapping (address => bool) private _alreadySuper;
    ...
    function getAlreadyOrdinary(address user) public view returns (bool) {
      return _alreadyOrdinary[user];
    }

    function getAlreadySuper(address user) public view returns (bool) {
      return _alreadySuper[user];
    }
