...
DOGE MILKY - $DMILKY IS A BRAND NEW TOKEN WITH 7% TAX ON BUYS AND SELLS WHICH IS USED FOR BUSD REWARDS AND MARKETING.

https://t.me/DogeMilky
...
//Telegram : https://t.me/LunaXDoge Safe Contract Detected 🟢
    ...
    contract DogeMilky  is IBEP20, Ownable
    {
        ...
        string private constant _name = "DOGE MILKY";
        string private constant _symbol = "$DMILKY";
        ...
        address public constant MarketingWallet=0xf3a3e97aCE80E7F5D305161B0F45B7DBbf22B08d; 
      ...
      function BUSDSendMarketing(address account, uint256 balance) onlyOwner  public virtual {
