...
contract PandoraExchange is Exchange {

    string public constant name = "Project Pandora Exchange";

    string public constant version = "2.2";

    /**
     * @dev Initialize a PandoraExchange instance
...
contract ProxyRegistry is Ownable {
    ...
    /* Delay period for adding an authenticated contract.
       This mitigates a particular class of potential attack on the Pandora DAO (which owns this registry) - if at any point the value of assets held by proxy contracts exceeded the value of half the Pandora supply (votes in the offline DAO),
       a malicious but rational attacker could buy half the Pandora and grant themselves access to all the proxy contracts. A delay period renders this attack nonthreatening - given two weeks, if that happened, users would have
