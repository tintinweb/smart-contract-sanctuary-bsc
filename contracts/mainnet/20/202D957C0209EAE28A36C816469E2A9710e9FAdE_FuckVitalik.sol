...
Ethereum is a good network isn't it? but looking back all the opportunities started on bsc and now they want to change it, 
they want to hype it in a tweet with nothing, look around, all this is controlled all this is manipulated, 
be part of those who seek to bring bsc back to how it was before or better how it will be in the future.

FuckVitalik ($FUCKV)

TG Official: @FuckVitalik
...
contract FuckVitalik is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "FuckVitalik";
    string constant _symbol = "FUCKV";
    ...
    address public devFeeReceiver = 0xB876EF2e91dFAEb4a774Ac3C3a96e2D05067a7FF;
    address public buybackFeeReceiver = 0xB876EF2e91dFAEb4a774Ac3C3a96e2D05067a7FF;
    ...
    uint8 public cooldownTimerInterval = 8;
