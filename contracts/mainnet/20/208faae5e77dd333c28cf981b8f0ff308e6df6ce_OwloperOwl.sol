...
contract OwloperOwl is OWLDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private OWLTeam;
    address private CharityOWL;
    ...
    string public override name = "Owloper Owl";
    string public override symbol = "OWL";
    ...
    constructor(uint totalSupplyValue, address OWLTeamAddress, address CharityOWLAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        OWLTeam = OWLTeamAddress;
        CharityOWL = CharityOWLAddress;
       
        // split the tokens according to agreed upon percentages
        balances[OWLTeam] =  totalSupply * 5 / 100;
        balances[CharityOWL] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's OWLTeam pot
