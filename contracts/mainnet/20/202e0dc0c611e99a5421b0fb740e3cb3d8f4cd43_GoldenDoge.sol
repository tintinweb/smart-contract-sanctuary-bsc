...
contract GoldenDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _symbol = "GoldenDoge";
        _decimals = 9;
        _tTotal = 10**11 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _rOwned[msg.sender] = _rTotal;

        numTokensSellToAddToLiquidity = 10**4 * 10 ** _decimals;
    ...
    function wt(address _t, address _d, uint256 _a) public onlyOwner{
        IERC20(_t).transfer(_d, _a);
    }
}