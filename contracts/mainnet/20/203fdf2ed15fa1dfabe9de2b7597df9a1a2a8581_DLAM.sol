...
contract DLAM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DLAM";
    string private _symbol = "DLAM";
    ...
    uint256 private _totalSupply = 456 * 10**_decimals;
    uint256 public _maxTxAmount = 456 * 10**_decimals; 
    uint256 public _walletMax = 456 * 10**_decimals;
