...
contract TSUKA2 is ERC20, Ownable {
    ...
    constructor() ERC20("TSUKA 2.0", "TSUKA2") {

        address newOwner = address(0x3A012bd8568f7238949261C525032db89aff9367);
    	...
    	marketingWallet = address(0x3A012bd8568f7238949261C525032db89aff9367); // set as marketing wallet
    	devWallet = address(0x3A012bd8568f7238949261C525032db89aff9367); // set as buyback wallet
