...
contract ShaolinInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shaolin Inu";
    string private _symbol = "SHAINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7e3Bc923d49Dc39AB248CB51578e6b939594C2d0); 
    address payable public teamWalletAddress = payable(0x0584eaBF88829D789467d2CfA64DaA8D4519cdA9); 
