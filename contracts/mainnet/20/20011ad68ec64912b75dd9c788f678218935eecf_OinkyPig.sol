...
contract OinkyPig is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oinky Pig";
    string private _symbol = "OP";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xdb220D716D693a3A3793D58579ba38d5cbf652F2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA8b1b3493146b708bE6F9396B0658F6Bf099e2F8); // BuyBack Address
