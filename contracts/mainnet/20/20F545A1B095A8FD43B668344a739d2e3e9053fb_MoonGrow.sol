...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/MoonGrowOfficial

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://t.me/MoonGrowOfficial

𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/iMoonGrow
...
contract MoonGrow is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 5 * 10**9 * 10**_decimals;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**_decimals;
    string private constant _name = "MoonGrow";
    string private constant _symbol = "MOONGROW";
    uint8 private constant _decimals = 9;

    uint256 public _GrowliquidityFee = 4;
    uint256 public _GrowmarketingFee = 4;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _GrowmarketingFee / 100;
        uint256 liquidityFee = amount * _GrowliquidityFee / 100;
    ...
    function swapAndLiquify() private {
        uint256 liquidityTokens = balanceOf (address(this)) * _GrowliquidityFee / (_GrowmarketingFee + _GrowliquidityFee);
