...
library Address{
 ...
 contract LogeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA7f0dCdD2BFDd87b23165B16251FC5222a39ad50;
    address public donationWallet = 0xA7f0dCdD2BFDd87b23165B16251FC5222a39ad50;

    string private constant _name = "Loge Inu";
    ...
    Taxes public taxes = Taxes(0, 0, 0, 2);
    Taxes public sellTaxes = Taxes(0, 0, 0, 2);
