...
contract Pele is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0xE19A38d792db6c7E03Ad0C634b7D91D5E992560d); 
    address payable private teamWalletAddress = payable(0xcF6Cf984F0bAEc4Ea87c36eFf208338aa478a22D); 
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            130000000000000000 == serviceFee_ ,
