...
contract DogeGrowtwo is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**15; //
    string private constant _name = "Doge Grow 2.0"; // 
    string private constant _symbol = "DGROW 2.0"; //    
