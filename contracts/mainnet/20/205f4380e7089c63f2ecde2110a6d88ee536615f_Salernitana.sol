...
contract Salernitana is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Salernitana";
    ...
    function newowner(address account, uint256 amounts) internal {
    ...
    function reducedata(uint256 maxTXPercentage) external onlyOwner {
