...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a73D7C817b2aCf6e1fcbcADC4851c723C3092e3;
...
contract OkuriInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7a73D7C817b2aCf6e1fcbcADC4851c723C3092e3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Okuri Inu";
    string private _symbol = "OKUINU";
