...
contract DSNAKE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeSnake";
    ...
    address payable private TeamWallet = payable(0xDCEaE413229218308Ff5Db69cd8d3f2a6E0881f7); // Buy Back Address
