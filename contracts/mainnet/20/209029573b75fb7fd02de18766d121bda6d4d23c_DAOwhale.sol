...
/**
    DAOWhale 是一个由社区驱动的风险投资 DAO。 与“鲨鱼坦克”类似，雄心勃勃的创始人可以提出自己的想法，希望获得投资、曝光和资源，从而将梦想变为现实。

    通过 DAO，您可以控制对战略投资风险投资的提议和投票，以塑造加密空间的未来：例如，提议对提供现实世界使用效用的 NFT 项目进行投资； 因此，投资越聪明，回报就越高，从而获得质押代币的高被动收入。
*/
...
contract DAOwhale is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc00f942CFAF35607F86BBC724b2C6cffEc243FE2);
    address payable public teamWalletAddress = payable(0x9B9b28e9D6edF743303f987722Df4035356C6411);
    ...
    string private _name = "DAOwhale";
    string private _symbol = "DAOwhale";
