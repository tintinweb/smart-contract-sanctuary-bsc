...
//
//
//   📱Telegram::https://t.me/ElonBonkBsc
//   📱Website :: https://ElonBonk.Club
/*
...
contract ELONBONK is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ELON BONK", "ELONBONK") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ELONBONK";
    string private _symbol = "ELONBONK";
