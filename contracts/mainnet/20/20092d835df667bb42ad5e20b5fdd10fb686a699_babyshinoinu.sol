...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x1701E133159a2DAe772e8EAe4E6bd24ebfDC8C32);
...
contract babyshinoinu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xd74aAd59FfDfeF5edbf5F395588EF2929BFF1035;

    string constant _name = "BABYshinoinu";
    string constant _symbol = "Bshino";
