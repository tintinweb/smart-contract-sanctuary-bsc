...
contract SoccerGrow is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x548F6e13AEfb5181a8cEAD5A5c7b137eC61BD0Bc;

    string private constant _name = "SoccerGrow";
    string private constant _symbol = "SoccerGrow";
