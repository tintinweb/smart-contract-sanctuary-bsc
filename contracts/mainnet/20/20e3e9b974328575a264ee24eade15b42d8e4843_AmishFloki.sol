...
/*
      ...
      The Amish Floki has come to the Binance Chain to share 
      his wonderful set of skills & tools!

      https://t.me/AmishFloki
...
contract AmishFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x267DC404d98Ee4Bd1A7E5c7Eb9Fe158A8133cAfb); // Marketing Address
        
    address payable public teamAddress =
        payable(0xc8D7ca1E09C6De2620D2d2A80f1b3cd95b376F9C); // Team Address
        
    address payable public liquidityAddress =
        payable(0xc8D7ca1E09C6De2620D2d2A80f1b3cd95b376F9C); // Liquidity Address
    ...
    string private constant _name = "Amish Floki";
    string private constant _symbol = "AMISH";
