...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9dEADdcfC1EED9A87Eb9cCf9BF5906e473D94B60;
...
contract UniPancakeSwap is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAeC5C46c750A0D76438Ec20e7fF509A15D8F87C7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "UniPancakeSwap";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1500000000 * 10**18;
