...
contract FuckLvp is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 6000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 6000000000000000 * 10**_decimals; 
    uint256 public _walletMax =6000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6000000000000000 * 10**3; 
