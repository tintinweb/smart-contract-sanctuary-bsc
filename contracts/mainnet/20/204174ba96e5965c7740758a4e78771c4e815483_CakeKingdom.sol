...
// WEB | https://cakekingdomcash.xyz
// TG  | https://t.me/CakeKingdomCash
// TW  | https://twitter.com/CakeKingdomCash
...
contract CakeKingdom {
    ...
    IERC20 constant CAKE_TOKEN = IERC20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function addCrystals(address ref, uint256 value) initialized external {
        ...
        CAKE_TOKEN.transferFrom(msg.sender, manager, valueToManager);
        CAKE_TOKEN.transferFrom(msg.sender, address(this), value - valueToManager);
    }
    ...
    function withdrawMoney(uint256 gold) initialized external {
        ...
        CAKE_TOKEN.transfer(user, CAKE_TOKEN.balanceOf(address(this)) < amount ? CAKE_TOKEN.balanceOf(address(this)) : amount);
    }
