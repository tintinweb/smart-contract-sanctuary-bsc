...
Masterbatedone for Elon Musk's advice.
...
contract Masterbatedone is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Masterbatedone";
    string constant _symbol = "MASTERBATEDONE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 56 * 10**9 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6C8F3f3A375ECdc3cfa5F5247a15B920A1cffEAA;
        teamFeeReceiver = 0x52df4db1155E0ddf8ED3C444c52304a384ce0643;
