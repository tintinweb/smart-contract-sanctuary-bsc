...
contract DNET is Context, IERC20, Ownable {
    ...
    string private _name = "DiamondNetwork";
    ...
    address payable public DevelopmentWalletAddress = payable(0xA5Fb5DDd6fF01588198Ac4b073e00b6Acd0e52EE); // Development Address
