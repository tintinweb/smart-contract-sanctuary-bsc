...
contract WOOF is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply =  7900000000 * 10**_decimals;
    uint256 public _maxTxAmount =   7900000000 * 10**_decimals; 
    uint256 public _walletMax =     7900000000 * 10**_decimals;
