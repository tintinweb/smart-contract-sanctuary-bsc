...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbF7d05a6F12B6fAa01251fF8060b87351442F0F6;
...
contract KingCatNetwork is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9CE9D574845e2a9773CbC4c33d9e8c050e33c46C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "King Cat Network";
    string private _symbol = "KINGCATNET";
