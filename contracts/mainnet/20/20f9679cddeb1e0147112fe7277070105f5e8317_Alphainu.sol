...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfad8c994018EA2b7ea19A8Cf3187c46390f0F252; // owner address
...
contract Alphainu is Context, IERC20, Ownable {
    ...
    string private _name = "Alpha INU";
    string private _symbol = "ALPHA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfad8c994018EA2b7ea19A8Cf3187c46390f0F252); // Marketing Address
    address payable public teamWalletAddress = payable(0xfad8c994018EA2b7ea19A8Cf3187c46390f0F252); // Team Address
