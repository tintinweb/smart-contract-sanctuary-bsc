...
contract Bullish is ReentrancyGuard, Pausable, XNFTHolder
{
	...
	function deposit_test(uint256 _pool_id, uint256 _amount_or_id) public whenNotPaused nonReentrant
	{
...
// !!!
	function deposit_nft(uint256 _pool_id, address _address_user, uint256 _xnft_id) public 
	{
	...
	function withdraw_nft(uint256 _pool_id, address _address_user, uint256 _xnft_id) internal
	{
