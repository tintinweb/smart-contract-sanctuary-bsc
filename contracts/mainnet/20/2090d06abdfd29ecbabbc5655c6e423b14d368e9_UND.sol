...
contract UND is ERC20 {
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
		...
		if(allamount > oldamount){
			...
			nftRewardAmount = nftRewardAmount.add(newAmount.div(5).mul(2));
			USDT.transfer(_fund1Address,newAmount.div(5));
			USDT.transfer(_fund2Address,newAmount.div(5));
		}
    }
    ...
    function splitOtherToken() private {
        ...
        if(thisAmount > nftRemain){
			thisAmount = thisAmount - nftRemain;
