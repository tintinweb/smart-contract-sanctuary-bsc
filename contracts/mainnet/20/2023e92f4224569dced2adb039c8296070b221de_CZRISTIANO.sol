...
/* Token contract */
contract CZRISTIANO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "CZristiano";
    string constant _symbol = "CZRISTIANO";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 5000; // 2% or 2m tokens
