...
string public name; // Holds the name of the token
    ...
    constructor() {
        name = "HYPERCHAINS"; // Sets the name of the token, i.e Ether
        symbol = "HPC"; // Sets the symbol of the token, i.e ETH
        decimals = 8; // Sets the number of decimal places
        uint256 _initialSupply = 21000000000000000; // Holds an initial supply of coins
