...
contract CBUSD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888000000000000 * 10**9;
    uint256 public _maxTxAmount = 17760000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Classic BUSD"; // 
    string private constant _symbol = "$CBUSD"; //    
