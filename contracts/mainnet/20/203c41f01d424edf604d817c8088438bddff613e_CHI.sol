...
interface IRouter {
    ...
    address private marketingWallet = 0x91fb3a3BD6bc8b76171cd84aF130a752A4829a94;
    address private devWallet = 0x170ebea0d250d2b84bAd218A9e8Bf3706c068957;
    address private opsWallet = 0xbC81689eFe200c93e1E7e5BBdC8Ba12e2e041aEc;
    ...
    Taxes private taxes = Taxes(4, 3, 2, 1);
    Taxes private sellTaxes = Taxes(4, 3, 2, 1);
    ...
    constructor(address routerAdd) ERC20("CryptoHeist Inu", "CHI") {
