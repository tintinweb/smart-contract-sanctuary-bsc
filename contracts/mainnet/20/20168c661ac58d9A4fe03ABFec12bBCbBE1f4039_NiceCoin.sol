...
contract DividendDistributor {
    ...
    modifier onlyOwnerOrToken() {
        require(_owner == msg.sender || msg.sender == dappToken, "Ownable: caller is not the owneror dapp");
        _;
    }
    ...
    function setToken(address _dappToken) external onlyOwner {
        dappToken = _dappToken;
    }

    function rescueOwnToken(address tokenAddress) public onlyOwnerOrToken {
...
contract NiceCoin is ERC20 {
    ...
    address constant uniswapV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    constructor(address tokenOwner) ERC20("NiceCoin", "NiceCoin")  {
    ...
    function _transfer(
        ...
        if (
            ...
            if (balanceOf(address(this)) >= 1 * 10 ** 16) {
                swapAndLiquify(balanceOf(address(this)) / 2);
            }
    ...
    function swapExactTokensForTokens(uint256 tokenAmount) private {
        ...
        DividendDistributor(dividendDistributor).rescueOwnToken(usdtToken);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 usdtAmount) private {
        ...
        IUniswapV2Router02(uniswapV2Router).addLiquidity(
            ...
            0,
            0,
            0xAd829Fca278c793C8c09003915FE368C7DA0C665,
            block.timestamp
        );
    }
