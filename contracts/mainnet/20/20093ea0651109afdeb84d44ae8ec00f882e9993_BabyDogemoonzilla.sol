...
contract BabyDogemoonzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDogemoonzilla";
    string private _symbol = "BabyDogemoonzilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x9725378467d9d6b0B10f2aC9Dd9D0939851d28B8); 
    address payable public ttWal = payable(0x9725378467d9d6b0B10f2aC9Dd9D0939851d28B8); 
