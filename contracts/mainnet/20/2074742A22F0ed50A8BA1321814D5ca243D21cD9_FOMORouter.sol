...
contract Pool {
    ...
    function withdrawPool(address recipient, uint value) private returns (bool successful) {
        uint256 winAmount = ((address(this).balance-value) * poolPercentage) /
            DENOMINATOR;
        if (supernova) {
