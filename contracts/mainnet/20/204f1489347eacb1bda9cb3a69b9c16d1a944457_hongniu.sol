...
contract hongniu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "hongniu";
    string private _symbol = "hongniu";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xB7B76840A48afC05CDFEc123F2e2C1Af3274C3D5);
    address payable public teamWalletAddress = payable(0xB7B76840A48afC05CDFEc123F2e2C1Af3274C3D5);
