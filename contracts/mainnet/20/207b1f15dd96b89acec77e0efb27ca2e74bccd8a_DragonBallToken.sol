...
電報なし。コミュニティが作成することを決定した場合、あなたは無料です
...
contract DragonBallToken is IBEP20, Auth {
    ...
    string constant _name = "Dragon Ball Token";
    string constant _symbol = unicode"亀";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 97) / 1000; 
    uint256 public _maxWalletSize = (_totalSupply * 97) / 1000; 
    ...
    address public marketingFeeReceiver = 0xb33aB5218B4f59376c5b6a035753d0559c13C749;
    address public devFeeReceiver = 0xb33aB5218B4f59376c5b6a035753d0559c13C749;
