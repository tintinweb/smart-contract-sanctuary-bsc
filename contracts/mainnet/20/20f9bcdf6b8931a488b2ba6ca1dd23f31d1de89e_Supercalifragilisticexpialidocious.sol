...
https://t.me/SupercalifragilisticCoin

extraordinarily good; wonderful

www.SupercalifragilisticCoin.com
...
contract Supercalifragilisticexpialidocious is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0x3B6a130f2d85C44C9bfF59B1673B8dE8B72528AB;

    string private constant _name = "Supercalifragilisticexpialidocious Coin";
    string private constant _symbol = "SCFGTCEXPLIDCS";
    ...
    Taxes public taxes = Taxes(0, 10, 1);
    Taxes public sellTaxes = Taxes(0, 10, 1);
