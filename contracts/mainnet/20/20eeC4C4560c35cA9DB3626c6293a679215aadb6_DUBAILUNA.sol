...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1269FB1e3A65295Ff564E1c44B32c1e1ed1585ca; // owner address
...
contract DUBAILUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dubai Luna";
    string private _symbol = "DUBAI LUNA  ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1269FB1e3A65295Ff564E1c44B32c1e1ed1585ca); // Marketing Address
    address payable public teamWalletAddress = payable(0x1269FB1e3A65295Ff564E1c44B32c1e1ed1585ca); // Use Same Address as Marketing Address
    ...
    uint256 public _walletMax = 1_000_000 * 10**_decimals;
