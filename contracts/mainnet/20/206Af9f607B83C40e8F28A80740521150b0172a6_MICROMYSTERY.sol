...
//telegram: https://t.me/devismicromystery 
interface IERC20 {
...
contract MICROMYSTERY is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x77b292719c1426eb37EEf442ACa2d6e71D6681fb;
    address public devAddress = 0x77b292719c1426eb37EEf442ACa2d6e71D6681fb;

    string private constant _name = "DEVISMICROMYSTERY";
    string private constant _symbol = "$MICRODEV";
    ...
    Taxes public taxes = Taxes(1,4,3,0);
    Taxes public sellTaxes = Taxes(1,4,3,0);
