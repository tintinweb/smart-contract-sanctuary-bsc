...
contract SincereHare is Context, IERC20, Ownable {
    ...
    string private _name = "Sincere Hare";
    string private _symbol = "SINHARE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5876b081dA6023211f7f440a2875eB7D952214d5); 
    address payable public buyBackWalletAddress = payable(0x2Fde32C300F14d54208B26E1d256b54f8503BcC3); 
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**12 * 10**9; 
