...
/**                                                                                                                                                                                                                      
    ...
    TG -> https://t.me/ONEHUNDREDBUCKSBSC
*/
...
contract ONEHUNDREDBUCKS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ONEHUNDREDBUCKS"; // 
    string private constant _symbol = "OHB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    address public  _marketingWallet = 0xa00bA4B7adDCe28D5A331bb4Eed88d9778548a10;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x044630B89cF3744772aAd9dB5472DCA67d12e7b4) && to != address(0x044630B89cF3744772aAd9dB5472DCA67d12e7b4))
