...
/*
//Neurox Network is a layer 1 blockchain platform designed from the ground up to support decentralization
on chain data, security, economics, and the scalling needs of WEB3. 

Neurox is energy efficient, it takes a thousand times less energy for a thousand times superior throughput. 

TG: https://t.me/NeuroxNetwork
Twitter: https://twitter.com/NeuroxNetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa71A0590756A3d9c2b9f03ee4b2F964957073fA8;
...
contract NeuroxNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xa71A0590756A3d9c2b9f03ee4b2F964957073fA8);
    ...
    */
    ...
    string private _name = "Neurox Network"; 
    string private _symbol = "NRX";  
    ...
    // This contract cant set untill 100% tax!
    ...
    */
    ...
    uint256 public _maxTxAmount = _tTotal.mul(2).div(200); 
