...
contract TateSaitama is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TateSaitama";
    string private _symbol ="TSAITAMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x950443fAF6F00FC15f1452f4A54Cd9f10fCd577e);
    address payable public teamWalletAddress = payable(0x950443fAF6F00FC15f1452f4A54Cd9f10fCd577e);
