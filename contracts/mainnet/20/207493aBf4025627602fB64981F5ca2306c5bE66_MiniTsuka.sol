...
/*
    TG: https://t.me/Minitsukaportal
    TW: https://twitter.com/minitsukabsc
*/
...
contract MiniTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniTsuka";
    string private constant _symbol = "$MiniTsuka";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x495418612E394c4eEd544C09288a982814296736);
        _feeAddrWallet2 = payable(0xF0557E7781f01CaB2BD91BE69Cd36A3c1eAD67b3);
        _liquidityWallet = payable(0xD215Dac76C067D0Aa9eBD86bC5f51FfAd6070c46);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (swapAmount >= _swapTokensAt &&
                ...
                uint256 tokensForLiquidity = swapAmount / 6;
                ...
                if(contractETHBalance > 0) {
                    sendETHToFee(contractETHBalance.mul(4).div(5));
