...
interface ISwapRouter {
    ...
    // function swapExactTokensForETHSupportingFeeOnTransferTokens(s
    //     uint amountIn,
    //     uint amountOutMin,
    //     address[] calldata path,
    //     address to,
...
contract FFFController is Ownable {
    ...
    constructor() {
        ...
        force = ERC20(0xE2D072E208D45795315730ddE617573325cA93b7);
        ...
        forcePair = address(0x5062564b01b2D8F0d3144c20cf7E1c6b1F021d84);

        _swapRouter = ISwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);

        usdt.approve(address(_swapRouter), 1000000000 * 10 ** 18);

        //teamLeader
        nodeIds[address(0xee1529FA76bF87c62DA88ab7876b5dAd13c72c7C)] = 1001;
        nodeIds[address(0xEd703D611df2fef3D0c626B1f688edFeeA8CfcF7)] = 1002;
        nodeIds[address(0x28c5945f2201FF2735d7ba4b9f012bb5d8203532)] = 1003;
        ...
        userPower[address(0xee1529FA76bF87c62DA88ab7876b5dAd13c72c7C)] = 1000;
        userPower[address(0xEd703D611df2fef3D0c626B1f688edFeeA8CfcF7)] = 1000;
        userPower[address(0x28c5945f2201FF2735d7ba4b9f012bb5d8203532)] = 1000;
    ...
    function buyNode(uint256 nodeType) public {
        ...
        // require(usdt.balanceOf(msg.sender) >= usdtAmount, "You don't have enough usdt");
    ...
    function drawNodeTokenRelease() public {
        ...
        force.transfer(msg.sender, timeRelease + priceRelease);
    ...
    function drawNodeProfit() public {//NodeTokenDividend
        ...
        force.transfer(msg.sender, dividend);
    ...
    //     force.transfer(msg.sender, release);
    ...
    function queryUserProfitProgress(address user) public view returns(uint256 progress) {
        ...
        uint256 usddtProfit = userNodeRecommendeProfits[user] + userDrawNodeLevelTokenDividendLastAmount[user];
