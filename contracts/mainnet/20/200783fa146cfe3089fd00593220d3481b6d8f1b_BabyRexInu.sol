...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8F34E5205504a293dE27B80159CCD3D08CE457B6;
...
contract BabyRexInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC1a053283A2871fa4313EC3a6e847a757BFE6753;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyRexInu";
    string private _symbol = "BREX";
