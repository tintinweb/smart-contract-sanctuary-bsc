...
contract Tiankeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"填坑";
    string private _symbol = unicode"填坑";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x61032f4c33EC91c98d2691cFf5C6499F175f2c43); 
    address payable private teamWalletAddress = payable(0x5dbf898E58254425AD4fe71A6267a3164bEB599b); 
    ...
    uint256 private _totalSupply = 2023 *  10**8 * 10**_decimals;
    uint256 public _maxTxAmount = 2023  * 10**8* 10**_decimals; 
    uint256 public _walletMax = 2023 * 10**8* 10**_decimals;
