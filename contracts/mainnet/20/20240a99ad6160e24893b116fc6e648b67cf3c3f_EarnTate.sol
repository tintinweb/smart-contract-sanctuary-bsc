...
contract EarnTate is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x369D2479829f4Ce630A17b5C350d8E75Dd0Ff24B;

    string constant _name = "EARN TATE";
    string constant _symbol = "EARNTATE";
