...
contract SOT is Context, IERC20, Ownable {
    ...
    string private _name = "Son Of Twoge"; 
    string private _symbol = "SOT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4cB4698DaCaD59Fe7af4B79b8dC512051584294); 
    address payable public teamWalletAddress = payable(0xaF61F32EAb522D5eDF086B4199a14d4E7A939F57); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 47 / 10000;
