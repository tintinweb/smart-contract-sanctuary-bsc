...
contract KamizukiNaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kamizuki Naki";
    string private _symbol = unicode"Naki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x213639f66B81c508ae29c36a9775Bce21fDA84De); 
    address payable public buyBackWalletAddress = payable(0x213639f66B81c508ae29c36a9775Bce21fDA84De); 
