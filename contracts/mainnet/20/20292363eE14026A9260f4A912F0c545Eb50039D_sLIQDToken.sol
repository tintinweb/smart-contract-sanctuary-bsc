...
contract sLIQDToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked LIQD", "sLIQD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLIQD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLIQD
