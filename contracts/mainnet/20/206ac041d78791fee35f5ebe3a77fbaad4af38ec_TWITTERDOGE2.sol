...
TG: https://t.me/TwitterDoge2Zero
...
contract TWITTERDOGE2 is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 25; // 4% of supply
    uint256 public maxTxAmountSell = _tTotal / 25; // 4% of supply
    ...
    string private constant _name = "Twitter Doge 2.0";
    string private constant _symbol = "TDOGE2.0";
