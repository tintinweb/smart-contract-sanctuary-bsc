...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x685d74D0a9b1AfE0059690CcA14C884CF7102070; // owner address
...
contract DynastyToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dynasty Token";
    string private _symbol = "DYNASTY";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x37Bf0FE5b0E5253F45ef644a83b112f603De5869); 
    address payable public teamWalletAddress = payable(0x37Bf0FE5b0E5253F45ef644a83b112f603De5869);
