...
contract Bologna is BolognaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BolognaTeam;
    address private CharityBologna;
    ...
    string public override name = "Bologna FC Fan Token";
    string public override symbol = "BFC";
    ...
    constructor(uint totalSupplyValue, address BolognaTeamAddress, address CharityBolognaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BolognaTeam = BolognaTeamAddress;
        CharityBologna = CharityBolognaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BolognaTeam] =  totalSupply * 4 / 100;
        balances[CharityBologna] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BolognaTeam pot
