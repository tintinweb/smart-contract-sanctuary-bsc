...
contract Betoc3 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "BETOC3";
    string private _symbol = "BBB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB5B0fF1427C614e85473A616D54DF7FE6C021081);
    address payable public liqWalletAddress = payable(0xB5B0fF1427C614e85473A616D54DF7FE6C021081);
    ...
    uint256 private _totalSupply =  444444* 10**_decimals;
