...
Telegram : https://t.me/FiredByELON
...
contract FIREDBYELON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x12486D32a7695e97A7B2C1582277aE43dA59C4F8); 
    address payable public Wallet_Utility = payable(0x3C8D0370Aa055C4D74fa1cE32f92b0BD91C72123);
    ...
    string private constant _name = "FIRED BY ELON"; 
    string private constant _symbol = unicode"FIRED BY ELON";
    ...
    constructor () {
        ...
        _owner = 0x3C8D0370Aa055C4D74fa1cE32f92b0BD91C72123;
