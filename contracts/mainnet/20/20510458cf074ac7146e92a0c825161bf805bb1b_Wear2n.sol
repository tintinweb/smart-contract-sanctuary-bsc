...
Wear to Earn
Wear2n is a decentralized project that combines blockchain technology, 
which allows for authenticity registration, 
with digital marketing to become a big in the clothing industry.
...
contract Wear2n is Ownable {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Wear2n";
    string constant _symbol = "$W2N";
    ...
    uint256 public buyTax = 700; //total buy fee
    uint256 public sellTax = 700; //total sell fee

    uint256 public marketingFee = 700; //marketfee fee
