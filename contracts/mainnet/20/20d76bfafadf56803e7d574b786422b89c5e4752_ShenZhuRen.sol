...
/**
  #ShenZhuRen-沈主任
   ...
   #该代币的产生灵感来自2023年央视春晚节目小品《坑》
    表演者：沈腾、马丽、艾伦、常远、宋阳、于健

    该小品聚焦官场、社会热点和百姓日常生活，让人在欢声笑语中，引发共情共鸣。

    据可靠消息，沈腾先生将在小品《坑》中饰演病假初愈的沈主任，因此该代币（沈主任）由此产生！
    本代币（沈主任）总供应量为1,000,000,000，DEV将会将所有供应量和1BNB添加到池子，并将LP进行销毁（发送到0x000000000000000000000000000000000000dead）
    本代币（沈主任）的滑点为2%：买卖金额的2%将进入营销钱包！（0x15Be01f0cDbBe33c5ac23ebf97C365d11357FAe5）

    最后让我们期待病假初愈的沈主任（沈腾饰演）又将有哪些金句？

    电报：https://t.me/ShenZhuRen
 */
...
contract ShenZhuRen is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ShenZhuRen";
    string private _symbol = "ShenZhuRen";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x15Be01f0cDbBe33c5ac23ebf97C365d11357FAe5);
    address payable public liqWalletAddress = payable(0x15Be01f0cDbBe33c5ac23ebf97C365d11357FAe5);
