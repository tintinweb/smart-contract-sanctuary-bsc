...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  1500000000000 * 10** Decimals;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"DogeDesignerking",//Name
        unicode"DogeDesignerking",//Symbol
        9,//Decimals
        100000000000,//Supply
        address(0xCD6eA29AAf137d35398c25d6402160Ea917Dde45),//FundAddress
        address(0x827E6B8AF05BE029D42c9b85465B4C94641ffd56)//ReceiveAddress
    ){
    }
}