...
contract BABYTOKEN is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x66bEB9BD87946F832C729385AB24B15DaF89D12b);
    ...
    string private constant _name = "Simsa"; 
    string private constant _symbol = unicode"SIMSA";
    ...
    uint256 public _maxWalletToken = _tTotal/20;
    ...
    function SetmaxTX (uint256 New) public onlyOwner {
