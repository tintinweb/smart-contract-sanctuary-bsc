...
contract DragonElon is Context, IERC20, Ownable {
    ...
    string private constant _name = " Dragon Elon "; // 
    string private constant _symbol = " $DRAGONELON "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x92AD8E2722BbB4C63c355F27B6595288B57e60f1;
