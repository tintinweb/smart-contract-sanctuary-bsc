...
/**
Following the number trend - MMXXIII is 2023 in Roman Numerology.

Low tax play 1% Max Tx 2% Max Wallet

Tax 5/5

USDT Pairing, Starting LP $88

https://t.me/MMXXII2023
...
contract MMXXII is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x746CAbaB51a1Cd70C5567D77Ca8A64765898CA78); 
    address payable public Dev_Wallet = payable(0xdb567e643e4ec642AA2b71c78f99dB1Daf915E9c);
    ...
    string private constant _name = unicode"2023"; 
    string private constant _symbol = unicode"MMXXII";

    bool public swapAndLiquEnabled = true;
    bool public swapEqualLiq = false;

    uint8 private txCount = 0;
    uint8 private swapDrigger = 88;
    ...
    constructor () {
        ...
        _owner = 0xdb567e643e4ec642AA2b71c78f99dB1Daf915E9c;
