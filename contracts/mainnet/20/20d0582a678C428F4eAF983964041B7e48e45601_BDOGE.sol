...
/**
BDOGE!!! BDODGE!!! (BSC Project Screaming Its Name To The Moon!!!)
-You ready to fly with BDOGE on space? BDOGE going to make it to the top! 

Portal : https://t.me/BDOGEBDOGEBDOGE
...
*/
    ...
    contract BDOGE   is IBEP20, Ownable
    {
        ...
        string private constant _name = "BDOGE!!!";
        ...
        address public constant MarketingWallet=0x6C8a4d64af89d7Cab83108aE08266e794b68f1e2; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AllowAddressTax(address[] calldata addresses) external onlyOwner {
