 ...
 * Is it a dog? 🐶
   ...
   It's the best of both, The Chow panda,
   Asia's cutest hybrid pet is here to win hearts all around the BSC.
   ...
   Check out our Website, Whitepaper and Socials for more details.

   CHOW PANDA INU 
   The Binance Smart Chain's Legendary Inu
   ...
   Telegram: https://t.me/ChowPandaInu
   Telegram China: https://t.me/ChowPandaInuChina
   Discord: https://discord.gg/EJ2RrtMU
   Website: https://chowpandainu.com/
   Twitter: https://twitter.com/ChowPandaInu
*/
...
contract ChowPandaInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Chow Panda Inu";
    string private _symbol = "CHOWP";
    ...
    uint256 public marketFeeOnBuying = 5; // 5% will be added to the market address
    uint256 public devFeeOnBuying = 1; // 1% will be added to the development address
    uint256 public liquidityFeeOnBuying = 2; // 2% will be added to the liquidity

    uint256 public marketFeeOnSelling = 5; // 5% will be added to the market address
    uint256 public devFeeOnSelling = 1; // 1% will be added to the development address
