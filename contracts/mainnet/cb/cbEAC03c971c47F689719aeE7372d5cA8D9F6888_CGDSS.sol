...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _destroyFee = 3000;

    uint256 public startTradeBlock;
    address public _mainPair;

    uint256 public _txLimitAmount;
    uint256 public _txLimitDuration = 1 days;
    ...
    constructor (
        ...
        _txLimitAmount = 500 * tokenDecimals;
    }
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            ...
            if (_swapPairList[from]) {
                ...
                if (txLimitAmount > 0) {
                    require(txLimitAmount >= amount, "txLimitAmount");
                    uint256 buyTime = _buyTimes[to];
                    uint256 blockTime = block.timestamp;
                    if (buyTime > 0) {
                        require(buyTime + _txLimitDuration <= blockTime, "txLimitDuration");
                    }
                    _buyTimes[to] = blockTime;
                }
...
contract CGDSS is AbsToken {
    ...
    //USDT
        ...
        200000000,
    //Receive
        address(0x2eE293f9A68baEAD969a827f062f4358B8342425),
    //Fund
        address(0x2eE293f9A68baEAD969a827f062f4358B8342425)
    ){
