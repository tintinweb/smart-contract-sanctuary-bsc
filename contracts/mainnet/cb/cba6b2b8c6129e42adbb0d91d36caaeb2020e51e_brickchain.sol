...
contract brickchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " brickchain";
    string private _symbol = " brickchain ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAd4476315c3505B924F309e273FF8D01769885F6);
    address payable public teamWalletAddress = payable(0xAd4476315c3505B924F309e273FF8D01769885F6);
