...
contract ToTheSmart is ERC20, Ownable {
    ...
    address public oldContract = 0x2F9315577D7f45025a50ca744F474069EbB2b1F3; ////@todo changes
    address private feewallet;
    ...
    ///////====>//////
    uint256 private _tokenFarmingTreasury = 84 * 10**10 * 10**18; // 84%
    uint256 private _tokenPreSale = 10 * 10**10 * 10**18; //10%
    uint256 private _tokenTeam = 5 * 10**10 * 10**18; //5%
    uint256 private _tokenAirDrop = 0 * 10**10 * 10**18; // 0
    ...
    constructor(
        ...
        feewallet = 0xB38A37bf7c87a72a5cFe8BccFCf201010a4F0746; //
