...
contract DogeGates is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xF617f8Bfd3b0ad5ec1Abdb72e734EF6Dd8798e1f));
    address payable public devWallet =
        payable(address(0xC8749cD333c43d7222F100aeF56373fC6986ea18));
    address public liquidityReceiver =
        0xC8749cD333c43d7222F100aeF56373fC6986ea18;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "DogeGates";
