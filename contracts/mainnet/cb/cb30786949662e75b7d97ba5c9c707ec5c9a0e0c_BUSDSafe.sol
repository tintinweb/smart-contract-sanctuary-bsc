...
/*
 * 
 *   BUSDSAFE - Decentrilized Investment Platform based on BNB Chain!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://busdsafe.me                                        │
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [INSTRUCTION]
 *
 *   1) Connect website to Metamask browser extension, or mobile wallet apps like Trustwallet and Metamask, Safepal...
 *   2) Send any BUSD amount (minimum 5 BUSD) using our website Stake button.
 *   3) Wait for your earnings.
 *   4) Withdraw earnings any time using our website "Withdraw" button.
 *
 *   [CONTRACT DETAILS]
 * 
 *   - Plan 1:  +3% every 24 hours for 200 days (+0.125% hourly)
 *   - Plan 2:  +3.5% every 24 hours for 150 days (+0.145% hourly)
 *   - Plan 3:  +4% every 24 hours for 80 days (+0.166% hourly)
 * 
 *   - Minimum investment: 5 BUSD, no maximal limit
 *   - Total income: From 320% to 600% (deposit included)
 *   - Earnings every moment, withdraw any time
 * 
 *   [AFFILIATE PROGRAM]
 *
 *   Share your referral link with your partners and get additional bonuses.
 *   - 10-level referral commission: 10%, 2%, 1%, 0.75%, 0.5%, 0.5%, 0.5%, 0.25%, 0.25%, 0.25%
 *
 *   [SEED INCOME]
 *   Seed income is referred to income generated in real time over your referral dividends.
 *   E.g. User A refers user B, User B invested 100 BUSD in Plan 3 receiving 4% daily so user A would be entitled to receive 10% of 4 BUSD i.e. 0.40 BUSD daily.
 *
 *
 */
