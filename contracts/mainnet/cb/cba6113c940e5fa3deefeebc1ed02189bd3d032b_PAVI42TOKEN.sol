...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
contract PAVI42TOKEN is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "PAVI42TOKEN";
    string private constant _symbol = "PAVI";
    ...
    address public pair;
    address public autoLiquidityReceiver = 0xE283C4Efe5db491FDBE28f6906edc121819fD7b5; // MultiSig address to receive LP tokens from liquidity add from fee
    address public marketingFeeReceiver = 0x2f382424728cC9985ab1eD6472849A0C381121b1; // address to receive marketing fee
