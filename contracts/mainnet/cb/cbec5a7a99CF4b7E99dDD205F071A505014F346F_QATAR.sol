...
Qatar Token is a community token for Qatar supporters in the 2022 World Cap, We as a Qatar community want to create a Token on the Binance Smart Chain network as a Qatar fan token. 

We will be doing a stealth launch so keep an eye on the chat. 

Tokenomics:
Name Token: Qatar Token
Symbol: QATAR
...
Safety Reminder : Any contract posted here not pinned by an Admin/Dev is a Scam. At Launch We Will Post And Pin the Contract!

Telegram: https://t.me/QatarTokenBSC
 */
...
contract QATAR is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "Qatar Token";
