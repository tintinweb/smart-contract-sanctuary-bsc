...
// contract created by DAMMYdev TG Handle: @DAMMYdev//
/**
...
/* Token contract */
contract ArabianNightBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Arabian Nights BSC";
    string constant _symbol = "$ANB";
