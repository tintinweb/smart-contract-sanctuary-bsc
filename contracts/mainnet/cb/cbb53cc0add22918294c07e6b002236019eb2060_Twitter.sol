...
contract Twitter is Context, IERC20, Ownable {
    ...
    string private _name = "TwiterCoin";
    string private _symbol = "TWITTER";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xA34e0Df74733069CfFB67Cb2B2D4C5adaBc3E09F); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA34e0Df74733069CfFB67Cb2B2D4C5adaBc3E09F); // BuyBack Address
