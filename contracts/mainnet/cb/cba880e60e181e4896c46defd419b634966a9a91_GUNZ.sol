...
contract GUNZ is Context, IERC20, Ownable {
    ...
    string private _name = "GunZilla";
    string private _symbol = "GUNZ";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x5288c8dE7A169B2963257e15C926971f5893829d); // Buy Back Address
