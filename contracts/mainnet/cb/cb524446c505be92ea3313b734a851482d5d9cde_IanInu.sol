...
/* Token contract */
contract IanInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Ian Inu";
    string constant _symbol = "Ian Inu (Hurricane)";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 75000 / 10000; // 1.5% on launch or 150000 tokens
    uint256 public _maxSellTxAmount = _totalSupply * 25000 / 10000; // 1% or 100000 tokens
    uint256 public _maxWalletToken = ( _totalSupply * 75000 ) / 10000; // 1.5% or 150000 tokens
