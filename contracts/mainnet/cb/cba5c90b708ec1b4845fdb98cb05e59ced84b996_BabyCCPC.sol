...
contract BabyCCPC is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCCPC";
    string private _symbol = "BabyCCPC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBb413A77E8cbb42C762667351Af1bA813c512186); 
    address payable public BurnedWalletAddress = payable(0xBb413A77E8cbb42C762667351Af1bA813c512186); 
