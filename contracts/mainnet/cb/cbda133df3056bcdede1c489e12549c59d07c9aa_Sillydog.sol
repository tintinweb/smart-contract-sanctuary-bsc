...
contract Sillydog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Sillydog";
    string private _symbol = "Sillydog";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 1 * 10**30 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa6b580d70A68e6C5BD235938AD5552431FE64BC8; 
