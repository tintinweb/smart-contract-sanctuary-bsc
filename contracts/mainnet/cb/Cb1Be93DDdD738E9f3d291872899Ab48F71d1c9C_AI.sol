...
Telegram : https://t.me/AIBusdyBoobs
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x417C2689Ba227bAbd75C0f458a3574fEa0277B7f;
...
contract AI is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI BUSDY BOOBS"; // 
    string private constant _symbol = "$AIbb"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x417C2689Ba227bAbd75C0f458a3574fEa0277B7f);
