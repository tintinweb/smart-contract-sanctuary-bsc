...
/**
We love milkmon, and we want to always hold them because they are graceful and supple, of all the beauties in the world, milkmom are the best.
*/

// Telegram https://t.me/milkmombsc
// Website www.milkmom.wtf
...
contract MilkMom is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf2351668D282042c6C856E731f6C9E42c7f6855a); 
    address payable public Wallet_Dev = payable(0x7d21B29143bDC1f664Dbea447E72da03e5E2eBa3);
    ...
    string private constant _name = "MilkMom"; 
    string private constant _symbol = unicode"Mmom"; 
    ...
    constructor () {
        ...
        _owner = 0x7d21B29143bDC1f664Dbea447E72da03e5E2eBa3;
