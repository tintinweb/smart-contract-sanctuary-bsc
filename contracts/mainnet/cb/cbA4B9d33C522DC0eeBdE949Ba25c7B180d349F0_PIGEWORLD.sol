...
contract PIGEWORLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1843e003314C9a434DDd0901DF7e9D0245AB8917); 
    address payable public Wallet_Dev = payable(0x1843e003314C9a434DDd0901DF7e9D0245AB8917);
    ...
    string private constant _symbol = unicode"PigeWorld"; 
    ...
    constructor () {
        ...
        _owner = 0x1843e003314C9a434DDd0901DF7e9D0245AB8917;
