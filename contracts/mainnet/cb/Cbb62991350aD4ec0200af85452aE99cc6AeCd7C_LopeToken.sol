...
library Address{
 ...
 contract LopeToken is IERC20, Context, Ownable {
    ...
    string private constant _name = "LopeToken";
    string private constant _symbol = "LopeToken";
    ...
    uint256 public maxWalletSize = 100000000000 * 10**9;
