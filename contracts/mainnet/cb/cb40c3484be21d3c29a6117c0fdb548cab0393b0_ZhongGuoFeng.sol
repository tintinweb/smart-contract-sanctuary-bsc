...
contract ZhongGuoFeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZhongGuoFeng";
    string private _symbol = "ZGF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4433e4f73B57541957bE76b6e6d0DBfF5D3368DE); // Marketing Address
    address payable public teamWalletAddress = payable(0xCEde2f19eE69921fC2931D0670A301C4A6456c2b); // Team Address
