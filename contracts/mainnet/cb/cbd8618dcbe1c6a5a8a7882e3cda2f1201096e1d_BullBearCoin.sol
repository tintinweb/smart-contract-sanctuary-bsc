...
// telegram : https://t.me/bullbear_coin
/**
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract BullBearCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x11DA25429014990c1e7fDA25276FbFA0d3c58B86); // Marketing Address

    address payable public teamAddress =
        payable(0x11DA25429014990c1e7fDA25276FbFA0d3c58B86); // Team Address

    address payable public liquidityAddress =
        payable(0x969b1096B0D075bbC520A4812d00fa9EDD60b9f8); // Liquidity Address
    ...
    string private constant _name = "BullBearCoin";
