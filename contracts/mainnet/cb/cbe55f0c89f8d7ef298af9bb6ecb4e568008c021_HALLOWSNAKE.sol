...
Telegram : https://t.me/hallowsnakebsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x071fdBAa4CFe3e1FF6e049C4913291701f934874;
...
contract HALLOWSNAKE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 31000000 * 10**9;
    uint256 public _maxTxAmount = 930000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 93000 * 10**9; //
    string private constant _name = "HALLOW SNAKE"; // 
    string private constant _symbol = "$HSNAKE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x071fdBAa4CFe3e1FF6e049C4913291701f934874);
