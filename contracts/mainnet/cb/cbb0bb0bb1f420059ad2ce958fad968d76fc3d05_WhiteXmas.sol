...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1663c8748E66A481f76778e596B03A80bfd6dD04; // owner address
...
contract WhiteXmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhiteXmas";
    string private _symbol = "WhiteXmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb036fE43BE7A8aC2cDa0325c917A12c5c5Be18D6); // Marketing Address
    address payable public teamWalletAddress = payable(0x1663c8748E66A481f76778e596B03A80bfd6dD04); // Team Address
