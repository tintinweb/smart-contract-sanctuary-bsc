...
// Telegram : https://t.me/Soccergrow
...
contract SoccerGrow is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Soccer Grow";
    string private constant _symbol = unicode"SoccerGrow";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xa5c4aB6A51208076F947CC816Dc624aB4CC13Ae5);
    address payable public MarketingWallet = payable(0x20A3184762da169338De3Ce81ce73361Ef35fFFA);
