...
contract BillionsTrade is Context, Ownable {
    ...
    function createDeposit(uint256 amountPaid, address adr) private {
        User storage user = users[adr];
        uint256 amount = payFee(amountPaid);
    ...
    function removeDays(address adr, uint256 daysLow) public _onlyOwner {
