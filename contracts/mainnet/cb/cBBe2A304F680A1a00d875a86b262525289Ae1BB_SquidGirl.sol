...
/**
   ...
   d888888o.       ,o888888o.     8 8888      88  8 8888 8 888888888o.                    ,o888888o.     8 8888 8 888888888o.   8 8888         
 .`8888:' `88.  . 8888     `88.   8 8888      88  8 8888 8 8888    `^888.                8888     `88.   8 8888 8 8888    `88.  8 8888         
 8.`8888.   Y8 ,8 8888       `8b  8 8888      88  8 8888 8 8888        `88.           ,8 8888       `8.  8 8888 8 8888     `88  8 8888         
 `8.`8888.     88 8888        `8b 8 8888      88  8 8888 8 8888         `88           88 8888            8 8888 8 8888     ,88  8 8888         
  `8.`8888.    88 8888         88 8 8888      88  8 8888 8 8888          88           88 8888            8 8888 8 8888.   ,88'  8 8888         
   `8.`8888.   88 8888     `8. 88 8 8888      88  8 8888 8 8888          88           88 8888            8 8888 8 888888888P'   8 8888         
    `8.`8888.  88 8888      `8,8P 8 8888      88  8 8888 8 8888         ,88           88 8888   8888888  8 8888 8 8888`8b       8 8888         
8b   `8.`8888. `8 8888       ;8P  ` 8888     ,8P  8 8888 8 8888        ,88'           `8 8888       .8'  8 8888 8 8888 `8b.     8 8888         
`8b.  ;8.`8888  ` 8888     ,88'8.   8888   ,d8P   8 8888 8 8888    ,o88P'                8888     ,88'   8 8888 8 8888   `8b.   8 8888         
 `Y8888P ,88P'     `8888888P'  `8.   `Y88888P'    8 8888 8 888888888P'                    `8888888P'     8 8888 8 8888     `88. 8 888888888888 
...
contract SquidGirl is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Squid Girl';
    ...
    uint16 public constant SellLimitDivider=20;
    ...
    address public Marketing=payable(0x6a14901a88A57867D2992d8925968Fc0C1aDF2D7);
    address private LiquidityRouter=payable(0x6a14901a88A57867D2992d8925968Fc0C1aDF2D7);
    address private TeamWallet=payable(0x6a14901a88A57867D2992d8925968Fc0C1aDF2D7);
    //TestNet
	...
	uint256 private MaxBuy = 500000000 * 10**_decimals; // 500,000,000 tokens
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==LiquidityRouter||addr==TeamWallet;
    }
    ...
    //Relection Share gets an extra 1% during launch. Reflections commence when buy tax is reduced to normal 12% so bad snipers taking quick exit do not get rewarded.
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;  // Floki Rewards can be enabled - the original INU
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(LiquidityRouter).transfer((amount*1)/5);
    ...
    function TeamChangeLiquidityRouter(address newLiquidityRouter) public onlyOwner{
      LiquidityRouter=payable(newLiquidityRouter);
    }
