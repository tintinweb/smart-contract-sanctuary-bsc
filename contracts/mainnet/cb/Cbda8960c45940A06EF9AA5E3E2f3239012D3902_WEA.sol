...
contract WEA is ERC20Detailed, Ownable {
    ...
    string public _name = "WEA";
    string public _symbol = "WEA";
    ...
    uint256 private constant MAX_SUPPLY = 100000000000 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("WEA", "WEA", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x7B517e6EE1Eabc42045854d8C679635947d2e8be;
        treasuryReceiver = 0xE2C57bfC740C3389b6897861c120630aff659DC4; 
        safuuInsuranceFundReceiver = 0xb2D938cec11d60FC9af9d1873E8639C2372b1a05;
        firePit = 0xf31ae2624fC631cF437802F319DCd6d167187991;
