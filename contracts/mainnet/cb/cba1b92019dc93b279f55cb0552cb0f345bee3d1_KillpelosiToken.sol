...
contract KillpelosiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Killpelosi";
    string private _symbol = "Killpelosi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC2528CaA6545f3440E136932f3b41DB20f7aAB9E); 
    address payable public BurnedWalletAddress = payable(0xC2528CaA6545f3440E136932f3b41DB20f7aAB9E); 
