...
// TELEGRAM: https://t.me/shamrock_coin_bsc
...
contract SHAMROCKCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHAMROCK COIN";
    string private _symbol = "SHAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x394aD04d0f691E21f7F2256A8618F575cC73b17D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x394aD04d0f691E21f7F2256A8618F575cC73b17D); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**3;
    uint256 public _maxTxAmount = 30 * 10**6 * 10**3;
    uint256 public _walletMax = 30 * 10**6 * 10**3;
    uint256 private minimumTokensBeforeSwap = 25000 * 10**3; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000 * 10**6 * 10**3), "Max wallet should be less or euqal to 100% totalSupply");
