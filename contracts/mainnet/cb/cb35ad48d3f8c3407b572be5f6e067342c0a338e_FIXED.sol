...
contract FIXED is IBEP20, Auth {
    ...
    string constant _name = "808";
    string constant _symbol = "808";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 80808 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1;  // 100% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1;  // 100% max wallet
    ...
    address private marketingFeeReceiver = 0x46DbDD1c164B716a133b16ffAd436Da89A2c90bE;
    address private teamFeeReceiver = 0x46DbDD1c164B716a133b16ffAd436Da89A2c90bE;
