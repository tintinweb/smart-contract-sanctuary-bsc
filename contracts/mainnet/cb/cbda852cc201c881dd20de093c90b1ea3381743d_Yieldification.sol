...
contract Yieldification is YDFDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private YDFTeam;
    address private CharityYDF;
    ...
    string public override name = "Yieldification";
    string public override symbol = "YDF";
    ...
    constructor(uint totalSupplyValue, address YDFTeamAddress, address CharityYDFAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        YDFTeam = YDFTeamAddress;
        CharityYDF = CharityYDFAddress;
       
        // split the tokens according to agreed upon percentages
        balances[YDFTeam] =  totalSupply * 5 / 100;
        balances[CharityYDF] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's YDFTeam pot
