...
/** 
    Welcome To Bill Murray Coin

    Telegram Group : https://t.me/billmurraycoin
    Website : Coming Soon
*/
...
contract BillMurrayCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Bill Murray Coin";
    string private _symbol = "$BMCN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x76C906cF2d5FE0Aff8644bF780181294DeA3924C);
