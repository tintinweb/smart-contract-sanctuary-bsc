...
//t.me/contagionBSC
//www.cryptocontagion.xyz
// twitter.com/contagionBSC
...
library Address{
 ...
 contract CONTAGION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Contagion";
    string private constant _symbol = "CONTAGION";
    ...
    Taxes private taxes = Taxes(0,4,1, 0);
    Taxes private sellTaxes = Taxes(0, 94, 5, 0);
