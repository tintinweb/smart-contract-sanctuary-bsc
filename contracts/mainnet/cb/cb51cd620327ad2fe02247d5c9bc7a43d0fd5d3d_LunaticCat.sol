...
// | $$                                      | $$    |__/                               /$$__  $$            | $$             
// | $$       /$$   /$$ /$$$$$$$   /$$$$$$  /$$$$$$   /$$  /$$$$$$$                    | $$  \__/  /$$$$$$  /$$$$$$   /$$$$$$$
// | $$      | $$  | $$| $$__  $$ |____  $$|_  $$_/  | $$ /$$_____/       /$$$$$$      | $$       |____  $$|_  $$_/  /$$_____/
// | $$      | $$  | $$| $$  \ $$  /$$$$$$$  | $$    | $$| $$            |______/      | $$        /$$$$$$$  | $$   |  $$$$$$ 
// | $$      | $$  | $$| $$  | $$ /$$__  $$  | $$ /$$| $$| $$                          | $$    $$ /$$__  $$  | $$ /$$\____  $$
// | $$$$$$$$|  $$$$$$/| $$  | $$|  $$$$$$$  |  $$$$/| $$|  $$$$$$$                    |  $$$$$$/|  $$$$$$$  |  $$$$//$$$$$$$/
// |________/ \______/ |__/  |__/ \_______/   \___/  |__/ \_______/                     \______/  \_______/   \___/ |_______/ 
//  
// Lunatic Cats:                                                                                                                          
// @lunatic_dev - Lynx 
// @Lunatic_Tortie - Tortie      
// @lunatic_green - Milow 
// @Lunatic_Red - Redcat  
// @Lunatic_Loki - Loki-Cat
// @JimmyCat20 - Jimmy Cat
// @DarthSithCat - Darth SithCat
// @Catman6969 - Catman  
// @Maikenshin - MewKenshin                                                                                     
...
contract LunaticCat is Context, IBEP20, Ownable {	
    ...
    address[] private _excluded;
   	...
   	uint256 private _lastLottoWinnerAmount;
    uint256 private _totalLottoPrize;
    uint private _lottoDrawCount = 0;
    ...
    string private _name = "Lunatic-Cats";	
    ...
    bool private lottoEnabled = false;
    ...
    uint256 public lotteryThreshold = 10 * 10**18;	
    // anti whale
    bool    public _isAntiWhaleEnabled = false;
    uint256 public _antiWhaleThreshold = 1500000000 * 10**18;
    ...
    // This is the 716th Line of the Contract <OwO>
    constructor () {
