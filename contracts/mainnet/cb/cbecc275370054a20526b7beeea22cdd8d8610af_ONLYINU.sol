...
@OnlyInuPortal This is the portal you'll find.

Only Inu is 1% tax, why? 

The Only Inu you will ever need. This contract is renounced and burn liquidity forever.

Only Inu is led by a small group of whales. We truly believe in a space where we can make wonderful projects without greedy teams profiting off of it with high taxes.
*/
...
contract ONLYINU is IBEP20, Auth {
    ...
    string constant _name = "Only Inu";
    string constant _symbol = "ONLY INU";
