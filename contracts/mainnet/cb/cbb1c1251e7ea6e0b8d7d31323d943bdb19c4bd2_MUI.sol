...
contract MUI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mafia Uzi Inu";
    string private _symbol = "MUI";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x0a285F32D2EBaee4CD9D25a0892499ef1cc3E5f2); // Marketing Address
    address payable private TeamWallet = payable(0x0a285F32D2EBaee4CD9D25a0892499ef1cc3E5f2); // Buy Back Address
