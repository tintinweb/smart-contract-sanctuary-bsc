...
library Address{
 ...
 contract DipSquidInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xcC6bd8aA69e1Cc19eC8e8f2045aF68834b9CfFdc;
    address public treasuryWallet = 0x34B03715c261c33b775C894a78038A19fD4b0dD3;

    string private constant _name = "DipSquid Inu";
    string private constant _symbol = "DIPSQUID";
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(treasuryWallet).sendValue(donationAmt);
        }
    }
