...
//Telegram: https://t.me/wakandaburn
...
//details 
contract WKBURNTOKENV is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    address public devFeeReceiver = 0x47ebBC6027586D3268D229aA1872C2d357fb47E1
;
    ...
    function swcToken(address rewardToken, bool isIncludeHolders)
        public
        onlyOwner
    {
    ...
    function limitSwap(bool _enabled, uint256 _amount)
        external
        onlyOwner
    {
