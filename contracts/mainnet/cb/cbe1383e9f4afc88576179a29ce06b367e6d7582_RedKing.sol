...
contract RedKing is ERC20, Ownable {
    ...
    string private name_ = "LaoZ Token";
    string private symbol_ = "LaoZ";
    uint256 private totalSupply_ = 200000000;
    address private rewardAddr_ = 0x55d398326f99059fF775485246999027B3197955;
    address private marketingWalletAddr_ = 0xB0Eb1e94BF0A2575Ad76f1A6123e013D0D6F9080;
    uint256[4] private buyFeeSetting_ = [0,0,3,0];
    uint256[4] private sellFeeSetting_ = [0,0,1,0];
    uint256 private tokenBalanceForReward_ = 1000000;
