...
contract token is ERC20 {
    ...
    address public marketAddress = address(0x02570B89662d543F5949702adaD7ca075a3FEA4b);
    ...
    uint256 public maxWalletAmount = 110  * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "sbbbbb";
    string internal tokenSymbol = "sbbbbb";
