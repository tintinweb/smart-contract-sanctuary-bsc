...
contract ONLYBULLDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Only Bulldoge";
    string private _symbol = "ONLYBULL";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0e2a111Da3B81B1c71b86B7492b404329D497538); // Marketing Address
    address payable public teamWalletAddress = payable(0x0e2a111Da3B81B1c71b86B7492b404329D497538); // Team Address
