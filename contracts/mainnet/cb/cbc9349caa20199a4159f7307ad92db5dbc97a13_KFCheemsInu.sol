...
*/
 ...
 /** KFCheems INU
    ...
    Based on KFC tweet. bullish af!
    https://twitter.com/KFC_ES/status/1533742919957585924    

    I create this token for community, so this will be community token. 
    If you want to make some hype, I suggest you to make tg @KFCheemsInu

    Features : 
    Tax buy/sell : 5% Low tax with Community driven will goes to LP+ Marketing+ 2% Cheems

    2% Cheems Inu Rewards
    2% Marketing
    1% LP
   
    Max wallet : (5%) 500,000,000,000,000 

    Don't miss it !!!

*/

// TG: https://t.me/KFCheemsInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71); // 2% CHEEMS INU
...
contract KFCheemsInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71; // 2% CHEEMS INU REWARDS
    ...
    address _marketingAdr = 0x32EB0bF4750de71F2CbbD58906B8c2125C1fa2f7;
 
    string constant _name = "KFCheems INU";
    string constant _symbol = "$KFCINU";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; //max wallet holding of 5%
