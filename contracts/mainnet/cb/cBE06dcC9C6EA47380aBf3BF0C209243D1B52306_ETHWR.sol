...
contract ETHWR is ERC20 {
    ...
    constructor() ERC20("ETHW rise", "ETHWR") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x950468FE7c19aBa8519824F1ef0C162636888fb5);
        fundAddress = address(0x65cC9031d9bC10dDD4436c00eA9D3D0dCB88bc64);
