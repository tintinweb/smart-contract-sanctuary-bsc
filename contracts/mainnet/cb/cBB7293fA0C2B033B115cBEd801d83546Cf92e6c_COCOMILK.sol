...
contract COCOMILK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COCOMILK";
    string private _symbol = "COCO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17Df176324a5EE7DA08B058543f2aABbef3065FE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x17Df176324a5EE7DA08B058543f2aABbef3065FE); // BuyBack Address
