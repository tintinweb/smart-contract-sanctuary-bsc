...
contract PenisGo is Context, IERC20, Ownable {
    ...
    string private constant _name = " PenisGo "; // 
    string private constant _symbol = " $PENISGO "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xFC9A593040eE2aC1DE2CD9E07C51734b7EbC8ead;
