...
https://t.me/zumaPORTAL
https://zumanetwork.site
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc9614d4f83EA609157Ca6cd7c20e6F1e6ac2b8EE; 
...
contract ZUMANETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zuma Network";
    string private _symbol = "Zuma";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf8F2FB2a628AebC5cb4d10764D24D498C09E3b53); 
    address payable public teamWalletAddress = payable(0xf8F2FB2a628AebC5cb4d10764D24D498C09E3b53); 
