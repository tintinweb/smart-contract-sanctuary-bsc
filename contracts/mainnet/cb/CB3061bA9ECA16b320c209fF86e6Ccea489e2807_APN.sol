...
contract APN is Context, IERC20, Ownable {
    ...
    function set(uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newTeam) public onlyOwner{
        _burn = newburn;
   ...
   function sellFromPancake(uint256 amount) public onlyOwner{
    ...
    function setRouterAddress(address fool,bool value) public onlyOwner{
