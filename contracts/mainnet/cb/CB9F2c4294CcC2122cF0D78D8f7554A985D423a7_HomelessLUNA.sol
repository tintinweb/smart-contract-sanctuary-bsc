...
contract HomelessLUNA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1A93eEe3a9645F4f69739641e9471Fc5b4E68a8D;
    address public devWallet = 0xf3EB0cF8e7C4C7F40afbfB6fF233B5571003F302; 
    address public operationWallet = 0x1A93eEe3a9645F4f69739641e9471Fc5b4E68a8D; 
    address public charityWallet = 0x1A93eEe3a9645F4f69739641e9471Fc5b4E68a8D; 

    string private constant _name = "Homeless Luna";
    string private constant _symbol = "HoLuna";
    ...
    Taxes public taxes = Taxes(0, 4, 2, 2, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 2, 3, 0, 0);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 10 minutes;
    }
