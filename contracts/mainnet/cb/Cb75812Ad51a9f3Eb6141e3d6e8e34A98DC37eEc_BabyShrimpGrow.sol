...
contract BabyShrimpGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby ShrimpGrow";
    string private _symbol = "BABYSGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFD6358Cd3353C6D1B9E9e40f8E5eF83723b54687); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFD6358Cd3353C6D1B9E9e40f8E5eF83723b54687); // BuyBack Address
