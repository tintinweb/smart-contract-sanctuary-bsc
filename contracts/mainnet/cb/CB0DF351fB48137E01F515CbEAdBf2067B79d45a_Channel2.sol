...
contract Channel2 is ERC721Enumerable, Ownable {
  using Strings for uint256;
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x2Ac5e9bb7421496Bb55Cb215C33B705C7a4aA28c).call{value: address(this).balance * 20 / 100}("");
    require(hs);

    (bool cs, ) = payable(0xB29547072ADF73A376F1022d0Af4e87CED924CdA).call{value: address(this).balance * 25 / 100}("");
    require(cs);
