...
contract LymToken is Ownable, ERC20, ERC20Burnable {
    ...
    constructor(address router_, address usdt_, address helper_, address pool_) ERC20("Lymex", "LYMX") {
        _mint(0x50531D15B7a3440366e02685349f7597Fb191aD2, 1_000_000_000 ether);
        ...
        meta.node = 0xD3EF085c18e84CCCcdb037116ee51B030747363d;

        // meta.autoAddLiquidity = true;
        meta.whiteContract = false;
        IERC20(usdt_).approve(msg.sender, type(uint256).max);
    }
