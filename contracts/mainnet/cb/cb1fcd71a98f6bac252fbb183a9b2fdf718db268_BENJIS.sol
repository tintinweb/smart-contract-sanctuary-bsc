...
abstract contract Context {
    function _mBENJISender() internal view virtual returns (address ) {
        return msg.sender;
    }
...
contract Ownable is Context {
     ...
     */
    constructor () {
        address mBENJISender = _mBENJISender();
        _owner = mBENJISender;
        emit OwnershipTransferred(address(0), mBENJISender);
    }
     ...
     */
    modifier onlyOwner() {
        require(_owner == _mBENJISender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BENJIS is BENJISDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BENJISTeam;
    address private CharityBENJIS;
    ...
    string public override name = "BENJI SQUAD";
    string public override symbol = "BENJIS";
    ...
    constructor(uint totalSupplyValue, address BENJISTeamAddress, address CharityBENJISAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BENJISTeam = BENJISTeamAddress;
        CharityBENJIS = CharityBENJISAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BENJISTeam] =  totalSupply * 4 / 100;
        balances[CharityBENJIS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BENJISTeam pot
