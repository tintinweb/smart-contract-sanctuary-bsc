...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x56d2Afefc7EDBd1d2e52711B1a06b87c6c57d540;
...
contract CSS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA2128Da8234D3a0d857e120245731F75C33Be491;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 12000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CLOUD SOFT";
    string private _symbol = "CSS";
