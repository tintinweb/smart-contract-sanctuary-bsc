...
contract BabyWikiCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyWikiCat";
    string private _symbol = "BabyWikiCat";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xaE0EBC1eBec26275B81B57eE6912E9c041Ec5BaF);
