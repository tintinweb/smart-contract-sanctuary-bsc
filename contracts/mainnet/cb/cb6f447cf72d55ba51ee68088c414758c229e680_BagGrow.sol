...
/* Token contract */
contract BagGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x17e66D3F6E23D63b64E521a1B4dF9901a78B3FF9;
    ...
    // Name and symbol
    string constant _name = "BagGrow";
    string constant _symbol = "BagGrow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 2% on launch or 2M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 2% or 2M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x17e66D3F6E23D63b64E521a1B4dF9901a78B3FF9;
