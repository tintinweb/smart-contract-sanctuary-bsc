...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4d6dbde32ACd59dd0CeE2f680212641b7156C02B; // owner address
...
contract ShibaCEO is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaCEO";
    string private _symbol = "$SCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4d6dbde32ACd59dd0CeE2f680212641b7156C02B); 
    address payable public teamWalletAddress = payable(0x4d6dbde32ACd59dd0CeE2f680212641b7156C02B); 
