...
Telegram: https://t.me/prayforRich
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC42948697471F10AA6abaf46f0bd7c9D3F7FaB43; // owner address
...
contract PrayForRich is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pray For Rich";
    string private _symbol = "PFR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC42948697471F10AA6abaf46f0bd7c9D3F7FaB43); // Marketing Address
    address payable public teamWalletAddress = payable(0xC42948697471F10AA6abaf46f0bd7c9D3F7FaB43); // Team Address
