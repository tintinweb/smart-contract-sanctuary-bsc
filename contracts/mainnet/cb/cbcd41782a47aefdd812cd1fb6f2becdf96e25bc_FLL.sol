...
contract FLL is IERC20, Ownable {
    ...
    address public inviterAddress = address(0xd6861a7Ef6Be10d8D287592cbd189e35D4b75b7F);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public fund1Address = address(0xb5315652f49AE5248062Db7DE157F9447f325f1E);
