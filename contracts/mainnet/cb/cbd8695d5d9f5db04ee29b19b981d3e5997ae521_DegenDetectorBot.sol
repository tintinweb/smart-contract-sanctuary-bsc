...
contract DegenDetectorBot is Context, IERC20, Ownable {
    ...
    string private _name = "Degen Detector Bot";
    string private _symbol = "D2B";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE36264672Be004644eC3e91b3dAE11e7333968Dd);
    address payable public BuyBackWalletAddress = payable(0xE36264672Be004644eC3e91b3dAE11e7333968Dd); 
