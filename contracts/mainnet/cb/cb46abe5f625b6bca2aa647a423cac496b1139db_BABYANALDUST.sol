...
contract BABYANALDUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Anal Dust";
    string private _symbol = "BABYANALDUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4068381a007cE30bDe22c9F471620E66F083d0C); // Marketing Address
    address payable private teamWalletAddress = payable(0x358e763744B996ED8dE681F29ff5B2d8EB63187E); // Team Address
    ...
    uint256 private _totalSupply = 1 * 10**6* 10**5 * 10**_decimals;
    uint256 public _maxTxAmount = 5 * 10**3 * 10**5* 10**_decimals; 
    uint256 public _walletMax = 4 * 10**4 * 10**5* 10**_decimals;
