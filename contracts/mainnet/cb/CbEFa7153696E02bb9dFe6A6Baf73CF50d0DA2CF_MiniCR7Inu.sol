...
Mini CR7 Inu - Next big moonshot on the BSC! 

Taxes: 8/8

Telegram: https://t.me/MiniCR7Inu
...
contract MiniCR7Inu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd7B48160A0F4C93d98Ee426395E3DFB078B45fd2); 
    address payable public Wallet_Dev = payable(0xd7B48160A0F4C93d98Ee426395E3DFB078B45fd2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private FeeAddress = 0x383F004652C5e52AD682D40e2e8E67b88B0F3876;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**10 * 10**_decimals;
    string private constant _name = "Mini CR7 Inu"; 
    ...
    constructor () {
        ...
        _owner = 0xd7B48160A0F4C93d98Ee426395E3DFB078B45fd2;
    ...
    function tradingStatus(bool newStatus) public onlyDev {
