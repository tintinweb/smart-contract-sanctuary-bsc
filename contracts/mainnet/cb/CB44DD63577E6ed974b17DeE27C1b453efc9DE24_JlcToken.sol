...
contract JlcToken is Ownable {
  ...
  address public administratorAddress1 = 0xb6cB9D01610893F9bafa21d07c841b8826919b98;
  address public administratorAddress2 = 0x578C9cC2661480CEFe4e2220bFbFe0794C680800;
  address public swapV2pairAddress = 0x10ed43c718714eb63d5aa57b78b54704e256024e;
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    if(msg.sender == swapV2pairAddress){  //买或者撤池子
    ...
    } else if(_to == swapV2pairAddress){//卖或者加池子
        balances[msg.sender] = balances[msg.sender].sub(_value);
        balances[_to] = balances[_to].add(_value - fee);
        balances[administratorAddress1] = balances[administratorAddress1].add(fee1);
        balances[administratorAddress2] = balances[administratorAddress2].add(fee2);
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    ...
    uint256 fee1 = fee * 25 / 100;
    uint256 fee2 = fee * 75 / 100;
    if(_from == swapV2pairAddress){  //买或者撤池子
