...
contract wencalls is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x41F0BF6953d60Eb1d64E4d0578D81067e58AcE5E;
    address public teamWallet = 0x3c88a5ca923C3621745b21f58BF0dC2466D17737;



    string private constant _name = "wen calls";
    ...
    Taxes public taxes = Taxes(1, 5, 1, 0);
    Taxes public sellTaxes = Taxes(1, 5, 1, 0);
