...
contract proquo is Context, IERC20, Ownable {
    ...
    string private constant _name = "PRO QUO"; // 
    string private constant _symbol = "PQT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xDAd58aC55906e2eCdAb26bb033Cd0f34d8b8e297;
