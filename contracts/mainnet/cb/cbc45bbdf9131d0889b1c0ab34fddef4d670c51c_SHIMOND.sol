...
contract SHIMOND is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8E05b4b1d65DAf1CA211df3925273b22599db728); 
    address payable public Wallet_Dev = payable(0x868A95E723A66c9BddB815E06337190c825D5fe0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Shib Diamond"; 
    string private constant _symbol = unicode"SHIMOND";
