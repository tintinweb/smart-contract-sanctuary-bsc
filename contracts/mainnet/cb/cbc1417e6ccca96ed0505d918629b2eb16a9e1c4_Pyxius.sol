...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC83b98d064aaF6B4508070011bB9738D3363252d; // owner address
...
contract Pyxius is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pyxius";
    string private _symbol = "PYX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC83b98d064aaF6B4508070011bB9738D3363252d); // Marketing Address
    address payable public teamWalletAddress = payable(0xC83b98d064aaF6B4508070011bB9738D3363252d); // Team Address
