...
/**
Welcome to 🐺 WOLF INU 🐕, the first super-Meme on Mainnet bridging together the Defi, Staking, NFT and DApp communities. Join us on our journey of creating one of the most powerful organizations on BSC, the possibilities are limitless. 

Fair Launch 16:00UTC 23th August 2022 On Pancakeswap

Initial LP: 5BNB


Naruto Inu Tokenomics: 
🎁 Supply: 100.000.000.000 

🛒 Tax: 8% - (2% Marketing | 2 Liquidity  | 4% Buy back )

🔐Liquidity Locked in Pinksale  1 Month  🔐
...
contract WINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x46514BEA7928b868812d91Df1403aBeb370963a2); 
    address payable public Wallet_Dev = payable(0xD745040CC111C45893876816a2Afe071279dE5ED);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Wolf Inu"; 
