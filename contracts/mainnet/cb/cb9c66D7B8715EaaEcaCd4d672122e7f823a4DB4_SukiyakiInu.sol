...
/**
Sukiyaki Official
A powerful token with experienced Dev team, Sukiyaki is ready to launch in BSC. Sukiyaki is build with a strong tokenomics that has buy back function & from each of the sell transaction, the contract will also add in part of the tax fees back to the LP, which will make the chart become more and more powerful.

Sukiyaki Official TG : https://t.me/SukiyakiInu

Sukiyaki Tokenomics:
1) 10 Trillion of Supply
2) 10% of Tax Fees, allocated to:
~ 3% for Marketing
~ 3% for Buy Back
~ 3% to LP
~ 1% for Dev Team
3) Starting with 1 BNB
*/
...
contract SukiyakiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SukiyakiInu"; // 
    string private constant _symbol = "SUKIYAKI"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xbc4dBE0f2942600B1944182861CbBC98d5ae14FD;
