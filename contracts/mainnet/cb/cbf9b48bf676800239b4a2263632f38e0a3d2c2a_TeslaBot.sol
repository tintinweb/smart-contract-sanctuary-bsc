...
contract TeslaBot is Ownable, IERC20 {
    ...
    string constant private _name = "TeslaBot";
    string constant private _symbol = "TBOT";
    ...
    constructor() {
        ...
        marketingWallet = 0x53Ab558B78a3dD41BFA04D62024673777e2219a5;
        devWallet = 0x11408041fBf4F737e22a6A206b89dDe87A7917E8;
        giveWallet = 0x0784dE6Fb93b9CA1116E17963A96F39E10edC255;
        nativeWallet = 0xB4EFd32C0ec0be2175a2d023b4eBfDD8f528C975;

        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(giveFee).add(nativeFee).add(devFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBGive = amountBNB.mul(giveFee).div(totalBNBFee);
        uint256 amountBNBDev = amountBNB.mul(devFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (tmpSuccess1,) = payable(giveWallet).call{value : amountBNBGive, gas : 30000}("");
        tmpSuccess1 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newTeslaFee, uint256 newNativeFee, uint256 extraSellFee) external onlyOwner {
        ...
        totalFee = liquidityFee.add(marketingFee).add(devFee).add(giveFee).add(nativeFee);
    ...
    function setFeeReceivers(address newMktWallet, address newGiveWallet, address newDevWallet, address newLpWallet, address newNativeWallet) public onlyOwner{
        autoLiquidityReceiver = newLpWallet;
        marketingWallet = newMktWallet;
        devWallet = newDevWallet;
        giveWallet = newGiveWallet;
