...
//FOR A SIMPLE USE WITH ERC20 TOKEN
    ...
    IERC721 private CatCoinNft1; // 0x21540c9647535262b344ddc8b9bd676e18810804 rinkeby
    IERC721 private CatCoinNft2; // 0x21540c9647535262b344ddc8b9bd676e18810804 rinkeby
...
// CONSTRUCTOR HERE! 
    ...
    constructor(address _Catcoin, address _CatCoinNft1, address _CatCoinNft2) {
        Catcoin = IERC20(_Catcoin);
        CatCoinNft1 = IERC721(_CatCoinNft1);
        CatCoinNft2 = IERC721(_CatCoinNft2);
...
*/
    ...
    function vote(uint proposalId, bool _positiveVote) public Status3 {
        ...
        if (CatCoinNft1.balanceOf(msg.sender) > 0) {
            cantVote += 2;
        }

        if (CatCoinNft2.balanceOf(msg.sender) > 0) {
            cantVote += 2;
        }
