...
contract ChristmasSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChristmasSHIBA INU";
    string private _symbol = "ChristmasSHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xaDAF6982F6C60293eA4Ddf2aA6dF51f2E9ED35f2); 
    address payable private teamWalletAddress = payable(0xd1387a2C062C06B8b2F45f164e26264DcDD034a6); 
