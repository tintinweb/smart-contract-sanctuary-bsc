...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "Virus Killer";
    string private _symbol = "Virus Killer";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x05B9AdDA0A73abb47BD52E81569EcD251423D54E));
        marketingWalletAddress = payable(address(0x668c66e5A00c0A8F0C3E6C1848cCeefbEF119c67));
