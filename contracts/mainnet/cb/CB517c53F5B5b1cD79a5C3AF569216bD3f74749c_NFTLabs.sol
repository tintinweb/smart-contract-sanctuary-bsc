...
contract NFTLabs is Ownable, ERC721, ERC721Enumerable {
    ...
    function _migrate(address nftOwner, uint256 tokenId, uint256 lockedAt, uint256 _lastPurchaseAt, uint256 lockId, uint256 cumulatedReward, uint256 price) external onlyOwner {
