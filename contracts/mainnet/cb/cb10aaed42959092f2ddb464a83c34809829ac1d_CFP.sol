...
// File: crypto4palestine_flat.sol


// File: contracts/crypto4palestine.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        // mainnet : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract CFP is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // mainnet
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // mainnet
    ...
    uint256 public _maxTxAmount = _totalSupply; // 0.1% is recommended
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // mainnet IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
