...
contract BabyPi is Context, IERC20, Ownable {
    ...
    string private _name = "BabyPi";

    string private _symbol = "BabyPi";
    ...
    address payable public marketAddress = 0x8AA482140cf43fD76F5bc11392381c59895019d1 ; //Marketing
