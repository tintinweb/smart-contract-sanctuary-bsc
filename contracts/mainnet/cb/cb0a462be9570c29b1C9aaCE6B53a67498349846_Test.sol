...
//address
    ...
    address public marketingAddress = 0xd0f06B0010b6f5Df89Dc829aFFDdDa004E93331F;
    address public devAddress = 0xd0f06B0010b6f5Df89Dc829aFFDdDa004E93331F;
    address public teamAddress = 0xd0f06B0010b6f5Df89Dc829aFFDdDa004E93331F;
    address public liquidityAddress = 0xd0f06B0010b6f5Df89Dc829aFFDdDa004E93331F;
//uint
...
//set functions
    ...
    function setMaxSellTxAmount(uint _value) external onlyOwner {
        ...
        require(maxSellTxAmount >= totalSupply() / 200,"maxSellTxAmount should be at least 0.5% of total supply.");
        emit MaxSellChanged(_value);
    }
    function setMaxBuyTxAmount(uint _value) external onlyOwner {
        maxBuyTxAmount = _value*10**decimals();
        require(maxBuyTxAmount >= totalSupply() / 200,"maxBuyTxAmount should be at least 0.5% of total supply.");
