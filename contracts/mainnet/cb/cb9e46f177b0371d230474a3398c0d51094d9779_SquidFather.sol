...
contract SquidFather is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Squid Father";
    string constant _symbol = "SQF";
    ...
    address public marketingFeeReceiver = 0x30a7B68B761512382159f6A2b9F6251767E59c99;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x30a7B68B761512382159f6A2b9F6251767E59c99] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x30a7B68B761512382159f6A2b9F6251767E59c99] = true;
