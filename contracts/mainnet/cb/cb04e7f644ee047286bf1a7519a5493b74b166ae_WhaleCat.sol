...
contract WhaleCat is IBEP20, Auth {
    ...
    string constant _name = "WhaleCat";
    string constant _symbol = "WCAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 10000;  //0.5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 200) / 10000;  //2% max wallet
    ...
    address private marketingFeeReceiver =0x36805Fdb1f0bD5c654dF743687d713a7B0a932b4;
    address private teamFeeReceiver =0x36805Fdb1f0bD5c654dF743687d713a7B0a932b4;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x36805Fdb1f0bD5c654dF743687d713a7B0a932b4;
