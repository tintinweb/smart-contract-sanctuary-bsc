...
// @YoungHeeInu - based on the doll in the show Squid Game that's currently hyped in BSC.
...
contract YoungHeeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Young Hee Inu";
    string private constant _symbol = "YHI";
