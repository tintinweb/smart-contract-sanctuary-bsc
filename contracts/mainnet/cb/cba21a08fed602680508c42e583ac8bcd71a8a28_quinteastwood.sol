...
contract quinteastwood is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Quint Eastwood";
    string private _symbol = "QUINT EASTWOOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5CF8A8c4C10F0D727f9fAEb1648a4D6E11547478); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x5CF8A8c4C10F0D727f9fAEb1648a4D6E11547478); // buyback Address
    ...
    uint256 public _maxTxAmount = 20000000000000 * 10**9; // 0.1%
