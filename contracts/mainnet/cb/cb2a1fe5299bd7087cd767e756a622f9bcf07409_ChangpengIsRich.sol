...
contract ChangpengIsRich is Context, IERC20, Ownable {
    ...
    string private constant _name = "Changpeng Is Rich"; // 
    string private constant _symbol = "$CZillionare"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x8837b1F0f9eB259C1eeA49E5FFa7F20B55DA1a79;
