...
/**
 ...
 tg will be created elon tweet stealth launch 
...
contract $OnlyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only Grow";
    string private constant _symbol = "$OnlyG";
    ...
    address private marketingWallet = address(0xa64cCD63F0219B8c6C6f40a5900F7fC4d6538A6a);
