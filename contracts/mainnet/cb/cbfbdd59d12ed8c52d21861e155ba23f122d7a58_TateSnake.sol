...
contract TateSnake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _devAddress = 0x92454aB2C1eeC12D65E5564754E0dA3B18f18954;
    
    string constant _name = "TATE SNAKE";
    string constant _symbol = "TateSnake";
