...
// WEN BINANCE WEN MARKETING WEN WEN
...
contract WIZARDS is Context, IERC20, Ownable {
    ...
    string private _name = "Wizards";
    string private _symbol = "$WIZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dfE6C85E06aCAAb10f7FDa20AD64f6c1067Fa8d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA2507B7a4349FDD42D5c344Ed3C0A57F533D0daa); // BuyBack Address
