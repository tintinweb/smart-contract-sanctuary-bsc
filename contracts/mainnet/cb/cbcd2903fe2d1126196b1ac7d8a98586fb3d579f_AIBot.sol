...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x218b31e8fe8347e283e9156C8C7c0D1b3C2921ca; // owner address
...
contract AIBot is Context, IERC20, Ownable {
    ...
    string private _name = "AIBOT";
    string private _symbol = "$AIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x218b31e8fe8347e283e9156C8C7c0D1b3C2921ca); // Marketing Address
    address payable public teamWalletAddress = payable(0x218b31e8fe8347e283e9156C8C7c0D1b3C2921ca); // Team Address
