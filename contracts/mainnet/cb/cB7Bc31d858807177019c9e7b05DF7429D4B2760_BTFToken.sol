...
contract BTFToken is IERC20, Ownable {
    ...
    function _transferFrom(
        ...
        //indicates if fee should be deducted from transfer
        bool takeFee = false;
        //transfer amount, it will take tax, burn, liquidity fee， 免税
        if (from == marketAddress && msg.sender == marketAddress) {
            takeFee = true;
        }
        //transfer amount, it will take tax, burn, liquidity fee
        _transfers(from, to, amount, takeFee);
    }
    ...
    function _transfers(
        ...
        if (!takeFee) {
            ...
            _takeTransfers(sender, recipient, tAmount, fundsFee);
        }
    }
    ...
    function _transferStandard(
        ...
        _takeTransfer(sender, fundAddress, tAmount, fundFee);
    ...
    function setFundFee(uint256 _fundFee) public onlyOwner {
        fundFee = _fundFee;
    }
