...
contract DomsInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb437e35F60ed4cc2d0061bbB075708c7685D556b); 
    address payable public Wallet_Dev = payable(0xfa51a9012417Beb48bd50E190FDc2C2D6B0A1060);
    ...
    string private constant _name = "DomsInu"; 
    string private constant _symbol = unicode"DOMS"; 
