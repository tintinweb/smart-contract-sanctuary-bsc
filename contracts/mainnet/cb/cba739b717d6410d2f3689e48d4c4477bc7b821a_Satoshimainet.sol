...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdEA034d6fdBb8d1b6870ebB570f7236e3fDeaF6c;
...
contract Satoshimainet is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3764092D2B772C29a88EDb659Ab18D26db51BA8A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Satoshi mainet";
    string private _symbol = "SMAINET";
