...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaD6AB96b0fF4822e9839A6697f405c439B066395; // owner address
...
contract GoldenPepe is Context, IERC20, Ownable {
    ...
    string private _symbol = "$GOLDP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaD6AB96b0fF4822e9839A6697f405c439B066395); // 
    address payable public teamWalletAddress = payable(0xaD6AB96b0fF4822e9839A6697f405c439B066395); // 
