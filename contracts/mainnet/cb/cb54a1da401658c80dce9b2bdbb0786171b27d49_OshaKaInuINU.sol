...
contract OshaKaInuINU is IBEP20, Ownable {
    ...
    string constant _name = "OshaKa Inu";
    string constant _symbol = unicode"OSHAKA";
    ...
    address private marketingWallet = 0x3F1f8b5329E4D552c1aDd66A40376D8aB614E104;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(4, 5, 1, 0);
    Fees public sellFees    = Fees(4, 5, 1, 0);
    ...
    function setMaxPercent(uint256 newMaxTxPercent, uint256 newMaxWalletPercent) external onlyOwner {
        ...
        _maxTxAmount = _totalSupply.mul(newMaxTxPercent) / 1000;

        require(newMaxWalletPercent >= 1, "Max wallet must be at least 1%");
        _maxWalletAmount = _totalSupply.mul(newMaxWalletPercent) / 1000;
    }
