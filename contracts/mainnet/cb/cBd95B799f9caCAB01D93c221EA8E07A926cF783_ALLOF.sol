...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf9Ae7E91b28a04D4a37e6C3b7C48B87B5B00Dc8C; // owner address
...
contract ALLOF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AL FOR $8";
    string private _symbol = "$8";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf9Ae7E91b28a04D4a37e6C3b7C48B87B5B00Dc8C); // Marketing Address
    address payable public teamWalletAddress = payable(0xf9Ae7E91b28a04D4a37e6C3b7C48B87B5B00Dc8C); // Team Address
