...
contract MisDao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _devAddress = 0x1FcA4b790C8Afb9A8b7988A2b52A1E333a74Bc8F;
   ...
   mapping(address => bool) public _isBlacklisted;
    ...
    uint256 public _inviteTxAmount = 20000 * 10**18;
    ...
    constructor() payable ERC20("MisDao", "MisDao") {
        uint256 totalSupply = 1000000 * (10**18);
        swapTokensAtAmount =20 * 10**18; //20;
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function updateDistributorGas(uint256 newValue) public onlyOwner {
        require(newValue >= 80000 && newValue <= 400000, "distributorGas must be between 200,000 and 500,000");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 fee1s = swapTokensAtAmount.mul(3).div(10);
