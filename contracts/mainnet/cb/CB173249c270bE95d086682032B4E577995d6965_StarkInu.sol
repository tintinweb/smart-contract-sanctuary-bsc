...
contract StarkInu is ERC20, Ownable {
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;

    address public operationsWallet = 0x80fE0094Ff6Bec7E1C12b64e9C5672b3E3e509d8;
    ...
    bool public autoOperationsEnabled = false;
    ...
    constructor() ERC20("Stark Inu", "Stark Inu") {

        BuyTotalFees = BuyLiquidityFee.add(BuyOperationsFee);
        SellTotalFees = SellLiquidityFee.add(SellOperationsFee);
    ...
    function updateBuyFees(uint256 newBuyLiqFee, uint256 newBuyOperationsFee) public onlyOwner {
        BuyLiquidityFee = newBuyLiqFee;
        BuyOperationsFee = newBuyOperationsFee;
        BuyTotalFees =BuyLiquidityFee.add(BuyOperationsFee);
    }

    function updateSellFees(uint256 newSellLiqFee, uint256 newSellOperationsFee) public onlyOwner {
    ...
    function changeAutoOperationsSettings(bool newStatus) external onlyOwner {
        autoOperationsEnabled = newStatus;
    }
    ...
    function _transfer(address from, address to, uint256 amount ) internal override {
        ...
        if(autoOperationsEnabled && contractTokenBalance >= swapTokensAtAmount && !swapping && from != uniswapV2Pair) {
            swapBack(contractTokenBalance);
        }
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        uint256 bnbForOperations = bnbBalance.sub(bnbForLiquidity);
