...
// Website: https://whitepaper.rabbitcupid.com/
...
contract RABBITCUPID is Context, IERC20 { 
    ...
    uint256 private _tTotal = 14022023 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xE92d5b8770Ea83B8E505746C30EDF7ED5b378561);
    address payable public MarketingWallet = payable(0xE92d5b8770Ea83B8E505746C30EDF7ED5b378561);
