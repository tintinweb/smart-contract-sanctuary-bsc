...
contract RubyMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ruby Moon";
    string private _symbol = "RubyMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0b2c0de5821115dCcCaf49E66F5B04f5E6B6F1B);
    address payable public teamWalletAddress = payable(0xb0b2c0de5821115dCcCaf49E66F5B04f5E6B6F1B);
