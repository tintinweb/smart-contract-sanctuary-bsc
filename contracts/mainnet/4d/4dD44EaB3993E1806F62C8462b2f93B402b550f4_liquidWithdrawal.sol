...
contract liquidWithdrawal is Ownable, ReentrancyGuard {
    ...
    mapping(address => uint8) private _liquidOwners;
    address[] private _ownersAddresses;

    constructor() {

        _liquidOwners[0xf5cE22eC351683466ddA09c1863A10490fc27346] = 100;
    ...
    function sendRevenue(uint8 percent) public thirtyDaysPassed avrInstanceInited  onlyOwner nonReentrant returns(bool){
        ...
        for (uint i; i < _ownersAddresses.length;) {
            ...
            _avrToken.transfer(addressReceiver, allowedAmount * _liquidOwners[addressReceiver] / 100);
            unchecked {
                i++; 
                }
        }
