...
Twitter : https://twitter.com/WhalesClubs
Website : https://whalesclubs.com
Telegram : https://t.me/WhalesClubs
...
contract WhalesClubs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WhalesClubsDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WhalesClubs", "WhalesClubs") {
        marketingWallet = payable(0x2292cC016c18d76C4a938D220a84D2c5EC740dB2);
        devWallet = payable(0xeb3448A1f942e6125E1Cd0eb00BeC0d0EC2a7CDD);
        ...
        dividendTracker = new WhalesClubsDividendTracker(
            payable(this),
            router,
...
contract WhalesClubsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WhalesClubs public WhalesClubsContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WhalesClubsContract = WhalesClubs(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WhalesClubs_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WhalesClubs_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WhalesClubs contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WhalesClubsContract);

            uint256 prevBalance = WhalesClubsContract.balanceOf(address(this));
            ...
            {
                uint256 received = WhalesClubsContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WhalesClubsContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
