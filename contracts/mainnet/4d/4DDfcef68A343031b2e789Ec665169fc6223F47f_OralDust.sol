...
contract OralDust is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    OralDustDividendTracker public dividendTracker;
    ...
    constructor() ERC20("OralDust", "ORAL") {
        marketingWallet = payable(0x678EEC1404918d7BDC85Dd7c426909Ba13b466dD);
        devWallet = payable(0xbd7B14BfE04590e808933E4e068Ff8dE0E4De577);
        ...
        dividendTracker = new OralDustDividendTracker(
            payable(this),
            router,
...
contract OralDustDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    OralDust public OralDustContract;
    ...
    constructor(
        ...
        defaultToken = token;
        OralDustContract = OralDust(mainContract);
    ...
    function _transfer(
        ...
        require(false, "OralDust_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "OralDust_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main OralDust contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(OralDustContract);

            uint256 prevBalance = OralDustContract.balanceOf(address(this));
            ...
            {
                uint256 received = OralDustContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    OralDustContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
