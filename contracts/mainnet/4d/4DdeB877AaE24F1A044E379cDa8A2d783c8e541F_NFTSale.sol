...
contract NFTSale is ReentrancyGuard, Ownable {
        ...
        roundAvailable(_roundId) preventContractCalls
    {
        ...
        if(useAzw){
            ...
            azw.transferFrom(msg.sender, address(this), amountOfAzwToPay * burnPercent / 100);

            // 70% of AZW received goes to devAddress

            azw.transferFrom(msg.sender, devAddress, amountOfAzwToPay - (amountOfAzwToPay * burnPercent));
        }
        else{
            require(msg.value >= purchaseRound.priceInBnb * _mintAmount, "Not enough BNB");
