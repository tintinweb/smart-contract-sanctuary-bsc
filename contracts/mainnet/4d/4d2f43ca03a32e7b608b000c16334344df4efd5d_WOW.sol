...
contract WOW
 is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa09600a358FD7c454174703A2ba9c03dCAD5e11c));
        _anotherA = payable(address(0xa09600a358FD7c454174703A2ba9c03dCAD5e11c));
