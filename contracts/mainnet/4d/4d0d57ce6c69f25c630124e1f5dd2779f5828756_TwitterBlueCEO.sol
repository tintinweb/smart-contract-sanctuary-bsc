...
contract TwitterBlueCEO is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xfb22709100cE29D6211BA007C7212D001A597890);
    address payable private _twdmkt = payable(0xfb22709100cE29D6211BA007C7212D001A597890);
    
    string private constant _name = "Twitter Blue CEO";
    string private constant _symbol = "BLUECEO";
