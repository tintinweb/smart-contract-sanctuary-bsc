...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xA54226aAf40d735908806a8473348941De77F649; // owner address
...
contract RATBOY2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RATBOY 2023";
    string private _symbol = "RATB2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24EF020A2C0313e1A137DBac1eb8Dc86845b3415); // Marketing Address
    address payable public teamWalletAddress = payable(0xA54226aAf40d735908806a8473348941De77F649); // Team Address
