...
contract SECcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SEC COIN";
    string private _symbol = "SEC";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x04E2aEB72aA48a162A41D0fa1e23Bd7b760891f4); 
    address payable public teamWalletAddress = payable(0x04E2aEB72aA48a162A41D0fa1e23Bd7b760891f4); 
