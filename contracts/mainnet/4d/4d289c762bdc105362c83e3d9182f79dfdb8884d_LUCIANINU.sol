...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2420Cba519f0300BAfD45660523E213903ee3639; // owner address
...
contract LUCIANINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUCIANINU";
    string private _symbol = "LUCIANINU";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x2420Cba519f0300BAfD45660523E213903ee3639); // Marketing Address
    address payable public teamWalletAddress = payable(0x2420Cba519f0300BAfD45660523E213903ee3639); // Team Address
