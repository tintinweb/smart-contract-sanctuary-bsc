...
contract TheLine is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TLINE";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1e11 * 10**_decimals;

    uint256 public _maxWalletAmount = 3_000_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 1_000_000_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1_000_000_000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x508312f9f85907791b2b55edD4FeF337BeF3029e);
