...
contract Token is ERC20 {
	...
	address public _fund1Address = address(0x9243cff0f29b22fEb1cBAdB2cB807FF0d1a978d8);
    ...
    constructor(address tokenOwner) ERC20("YFI-GAME", "YFI-G") {
    ...
    function _transfer(
		...
		bool isInviter = from != uniswapV2Pair && balanceOf(to) == 0 && inviter[to] == address(0) && amount >= 10**8;
        ...
        if (sender == uniswapV2Pair) {
         ...
         for (int256 i = 0; i < 3; i++) {
            ...
            if (cur != address(0)) {
				...
				_receiveD = _fund1Address;
			}
            super._transfer(sender, _receiveD, amount.div(1000));
        }
    }
}