...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferFee = 9000;   //转账扣税
    ...
    constructor (
        ...
        //达到1000分红币，开始分红
        holderRewardCondition = 500 * 10 ** IERC20(DividendToken).decimals();
        //持有1个本币才能参与分红
        holderCondition = 888888 * tokenDecimals;
...
contract BNB is AbsToken {
    ...
    //总量
        100000000,
    //Receive，接收地址
        address(0xfdf4D3Fa08042DF053Ca324CFB7d341c28C85D93),
    //Fund，营销
