...
/**
 ...
 God Of Dogchain
 Telegram : https://t.me/godofdogchain
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x082b7d1F194EF85ceda6BB7A19db8226e89CF2dA; // owner address
...
contract GodofDogechain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "God Of Dogechain";
    string private _symbol = "$GOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaDEe2a22f00DEA37cc46860c0513ad8A89015c6b); // Marketing Address
    address payable public buybackWalletAddress = payable(0xaDEe2a22f00DEA37cc46860c0513ad8A89015c6b); // Buyback Address
