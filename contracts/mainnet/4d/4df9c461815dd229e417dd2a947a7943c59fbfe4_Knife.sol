...
library Address{
 ...
 contract Knife is Context, BEP20, Ownable {
    ...
    Taxes public sellTaxes = Taxes(2, 7, 2, 8);
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        require(maxBuy >= 1000000, "Can't set lower than 1% of the totol supply.");
        require(maxSell >= 1000000, "Can't set lower than 1% of the totol supply.");
