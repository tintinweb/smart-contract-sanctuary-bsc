...
contract PausableToken is StandardToken, Pausable {
  ...
  function transfer(address _to, uint256 _value) public whenNotPaused returns (bool) {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public whenNotPaused returns (bool) { 
      ...
      require(_from == msg.sender || _to == msg.sender, "BEP20: Sender not owner allowance token");
...
**/  function transferFrom(address sender, address recipient, uint256 amount) public whenNotPaused virtual returns (bool) {
...
contract Sakura_BSC_SEBC is PausableToken, MintableToken {
    string public name = "SAKURA-TEST";
