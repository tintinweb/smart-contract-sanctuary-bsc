...
contract HalloHalloween is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hallo Halloween";
    ...
    address private  _marketingWallet = 0xDcb900285af679Ad1FFCBBf1cd0740b8bDDfcC39;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee * 2 / 100; 
    ...
    // Check for maxTX
    function checkTxLimit(address from, uint256 amount, address to) private view {
