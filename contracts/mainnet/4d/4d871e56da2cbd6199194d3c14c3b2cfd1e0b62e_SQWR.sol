...
contract SQWR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid War BSC";
    string private _symbol = "SQR";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x95d7466b19eFDCeF7FEbbA1c2d7249160891d24E); // Marketing Address
    address payable public BuyBackWallet = payable(0x95d7466b19eFDCeF7FEbbA1c2d7249160891d24E); // Team Address
