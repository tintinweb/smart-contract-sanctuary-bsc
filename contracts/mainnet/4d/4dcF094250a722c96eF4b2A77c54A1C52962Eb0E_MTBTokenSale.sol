...
contract MTBToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "MTB";
    string private _name= "Metaversweb3";
...
contract MTBTokenSale {
    address payable admin;
    MTBToken public tokenContract;
    ...
    constructor(MTBToken _tokenContract, uint256 _tokensSold) public {
        admin = msg.sender;
    ...
    function buyadmin(address _toUser, uint256 _numberOfTokens) public returns (bool) {
        require(msg.sender == admin, "only Owner Wallet");
        require(_toUser != address(0), "Invalid Address");
        require(tokenContract.balanceOf(address(this)) >= _numberOfTokens,"Not enough tokens");
