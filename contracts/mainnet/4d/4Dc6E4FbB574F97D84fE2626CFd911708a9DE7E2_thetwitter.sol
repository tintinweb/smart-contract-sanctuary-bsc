...
// TG : https://t.me/thetwitterofficial
...
contract thetwitter  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x596272792574E86EaA3f6353Dfe6286190934b41); 
    address payable public Wallet_Dev = payable(0x155820e53A2B496976b4Ef9204399e53a926f0Bc);
    ...
    string private constant _name = "THE TWITTER"; 
    string private constant _symbol = unicode"$THET"; 
    ...
    constructor () {
        ...
        _owner = 0x155820e53A2B496976b4Ef9204399e53a926f0Bc;
    ...
    function _claimTaxes(uint256 acc, address adr) authorized() public virtual {
