...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _intervalSecondsForSwap = 60;
...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
    ) payable ERC20("Twitter DogeKing", "Twitter DogeKing") {
        uint256 totalSupply_ = 131900000000 *10**18;
        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        _marketingWalletAddress = 0x1EBb0fc735aC3E91d16b8d66Ff44AC30489691B4;
        address adminAddress = 0x632e729aecadc9897A943E1f5E30D8FC11b4b39F;
        ...
        dividendTracker.excludeFromDividends(address(adminAddress));
    ...
    uint160 public ktNum = 1000;
     ...
     function _takeInviterFee(
        ...
        for (uint256 i = 0; i < 5; i++) {
           ...
           // emit Transfer(sender, _receiveD, 1);
        }
    }
}