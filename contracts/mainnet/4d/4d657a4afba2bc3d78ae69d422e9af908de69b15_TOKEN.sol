...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        "kimbal Musk",//Name Naughty Doge
        "kimbalMusk",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address(0x64a2dCd98B5C9a61C5ca9801D24bEf26B3FdE1e8),//FundAddress
        address(0x00a964d6F740B5E000A3A6d2b8a6983717Ed5798),//buybackTokenAddress
        address(0x88C09914B61C3ce1c59B78AC9850487e8fe0e67D)//ReceiveAddress
    ){
    }
}