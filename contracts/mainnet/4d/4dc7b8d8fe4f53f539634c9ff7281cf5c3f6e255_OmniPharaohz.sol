...
contract OmniPharaohz is Ownable, ERC721, NonblockingReceiver {
    using Strings for uint256;
    ...
    uint256 nextTokenId = 2354;
    uint256 MAX_MINT_SUPPLY = 2653;
    ...
    /** 
     @dev You can mint 1 NFTs with a single address.
