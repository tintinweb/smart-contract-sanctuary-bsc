...
contract PiggyBankBUSD is Ownable {
    ...
    // --- Constants ---
    uint256 public constant MINIMUM_DEPOSIT_AMOUNT = 0.001 ether; 
    ...
    uint256 public constant BASE_DAILY_ROI_PERCENTAGE = 70; // 7%
    ...
    uint256[] public        REFERRAL_BONUS_PERCENTAGES = [50, 40, 30, 20, 10, 10, 10, 10, 10, 10]; // 5%, 4%, 3%, 2%, 1%, 1%, 1%, 1%, 1%, 1%

    uint256 public constant CONTRACT_BALANCE_BONUS_STEP = 1000 ether; // Each 1000 BUSD in contract balance will increase the daily ROI by 0.1%
    ...
    function startcontract(uint256 amount) public onlyOwner returns (bool success) {
