...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC59C51976797aAe8Edf4C62c16246EAd9d5e03bD; // owner address
...
contract BrittneyGriner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brittney Griner Inu";
    string private _symbol = "BAD TRADE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28608990D638D5258B6273Da68B6883d13570Ee2); // Marketing Address
    address payable public teamWalletAddress = payable(0x28608990D638D5258B6273Da68B6883d13570Ee2); // Team Address
