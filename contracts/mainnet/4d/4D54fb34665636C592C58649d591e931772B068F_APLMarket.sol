...
contract AplMarketEasy is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControlEnumerable, ERC721Burnable {
...
contract APLMarket is AplMarketEasy, ReentrancyGuard {
    ...
    constructor(
        ...
        AplMarketEasy(_owner, name, symbol, _anyoneCanMint) 
    {
        admin = _admin;
