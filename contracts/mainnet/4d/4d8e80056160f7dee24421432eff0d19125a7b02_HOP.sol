...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Hop Exchange';

    string constant public symbol = 'HOP';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 700000000000*10**uint256(decimals);
