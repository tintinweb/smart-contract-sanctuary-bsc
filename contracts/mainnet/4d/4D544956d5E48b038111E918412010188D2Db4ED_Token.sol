...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "DOUYINDAO";
    string private _symbol = "DOUYINDAO";
    ...
    address public mainAddres = address(0x714DF3BC3cFe958ae9d8d077cB372708Ac7fF73B);
    address public marketAddress = address(0xfdB9cbBCFB53961c42438f2F783B5Ce447111642);
    address public fundAddress = address(0xc28D9D47EeD7eF0CCdA1DD85eb698FD0088809F3);
    address public liquidAddress = address(0x202EAd43661362941E1601cA0224731829094699);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _takeBurn(sender, tElseFee / 12);      // 2%
        _takeMarket(sender, tElseFee / 12);   // 1%
        _takeFund(sender, tElseFee / 6);     // 1%
