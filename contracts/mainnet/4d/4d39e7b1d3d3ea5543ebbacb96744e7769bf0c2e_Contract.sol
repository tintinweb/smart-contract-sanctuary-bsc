...
/*
    Nobura is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable in the world.
    We are keeping this truly classic.
    ~4% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $NOBURA a household name.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0c27849a4eb9eBc6A08B161617C9F82C8200fa82;
...
contract Contract is Context, IERC20, Ownable {
    ...
    */
    address payable private Wallet_Dev = payable(0x0c27849a4eb9eBc6A08B161617C9F82C8200fa82);
