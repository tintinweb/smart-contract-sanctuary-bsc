...
contract FKTS is Context, IERC20, Ownable {
    ...
    string private _name = "Fuck The System";
    string private _symbol = "FKTS";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 60; // 0.60% 
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 480; // 4.80% 
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 480; // 4.80% 
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _treasuryFee = 180; // 1.80% 
    ...
    uint256 public minNumTokensSellToAddToLiquidity = 500 * 10**18;
