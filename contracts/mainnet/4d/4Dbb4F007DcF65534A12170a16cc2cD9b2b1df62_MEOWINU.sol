...
contract MEOWINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MEOWINU";
    string constant _symbol = "MI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0351cD103635a278B2FB06aE0481eBa1A2BaC5C7;  
        anothermarketingWallet = 0x0351cD103635a278B2FB06aE0481eBa1A2BaC5C7;
