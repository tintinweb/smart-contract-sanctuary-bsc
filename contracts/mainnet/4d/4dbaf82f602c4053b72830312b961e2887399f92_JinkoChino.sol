...
contract JinkoChino is JinkoChinoDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private JinkoChinoTeam;
    address private CharityJinkoChino;
    ...
    string public override name = "Jinko Chino AI";
    string public override symbol = "Jinko Chino";
    ...
    constructor(uint totalSupplyValue, address JinkoChinoTeamAddress, address CharityJinkoChinoAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        JinkoChinoTeam = JinkoChinoTeamAddress;
        CharityJinkoChino = CharityJinkoChinoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[JinkoChinoTeam] =  totalSupply * 4 / 100;
        balances[CharityJinkoChino] = totalSupply * 4 / 100;
