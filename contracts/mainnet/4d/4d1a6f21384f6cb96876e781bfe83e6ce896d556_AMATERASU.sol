...
contract AMATERASU is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Amaterasu";
    string private _symbol = "AMATERASU";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x9d47E1Ee52239B3D044111be8e34D3ceB03Bd454); // Marketing Address A9
    address payable private TeamWallet = payable(0x0d1e0C9977A4390c0bC39B412f0819DC394148ec); // Team Address
