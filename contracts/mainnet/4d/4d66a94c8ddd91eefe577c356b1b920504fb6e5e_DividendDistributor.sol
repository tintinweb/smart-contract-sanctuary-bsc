...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x5bc3ED94919af03279c8613cB807ab667cE5De99;
...
contract UtilityBnb is IBEP20, Auth {
    /*
          __  _____  _  _____ 
         / / / / _ )/ |/ / _ )
        / /_/ / _  /    / _  |
        \____/____/_/|_/____/ 
        UtilityBnb {2022}
        TG: https://t.me/UtilityBnb
    */
    using SafeMath for uint256;

    string constant _name = "UtilityBnb";
    string constant _symbol = "UBNB";
    ...
    uint256 public _walletMax = 5 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x23149FA8458cd87397733d00B8be6220876a9835;
        marketingWallet = 0x5336Eed721EfEbe50f9bD1f69113293B2627E3FD;
        devWallet = 0x48D9bfcf392306fE95EDf1Cc1dc541Df4440B197;
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee.add(extraFeeOnSell);

        transferOwnership(0x48D9bfcf392306fE95EDf1Cc1dc541Df4440B197);
    ...
    function changeBlacklistedStatus(address holder, bool status) external authorized {
        require(holder != address(this) && holder != pair && holder != address(router));
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        ...
        require(totalFeeIfSelling <= 30, "Fees cannot be set above 30%");
    }
