...
contract Germany is GermanyDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GermanyTeam;
    address private CharityGermany;
    ...
    string public override name = "Germany Fan Token";
    string public override symbol = "Germany Fan Token";
    ...
    constructor(uint totalSupplyValue, address GermanyTeamAddress, address CharityGermanyAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GermanyTeam = GermanyTeamAddress;
        CharityGermany = CharityGermanyAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GermanyTeam] =  totalSupply * 5 / 100;
        balances[CharityGermany] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's GermanyTeam pot
