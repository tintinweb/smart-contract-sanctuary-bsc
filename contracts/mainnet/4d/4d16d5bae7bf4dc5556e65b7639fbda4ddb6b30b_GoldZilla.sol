...
contract GoldZilla is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc67786aAbB840266cd8bcc0e96c4a1BD6C394824);
    address payable public Wallet_Dev = payable(0xb5Fe6cc44daA2eC93D0c5f32B5FC3B861070d2c6);
    ...
    string private constant _name = "GoldZilla";
    string private constant _symbol = unicode"GZ";
