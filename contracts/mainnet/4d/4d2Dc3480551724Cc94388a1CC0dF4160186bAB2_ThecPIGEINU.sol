...
/**
Contract is forked from cLuna, with Pige Inu newest partnership announcement
I will burn the liquidity and renounce the ownership
3% tax, 2% to liquidity pool, 1% auto reflections to all holders
1% token for dev
 */
...
contract ThecPIGEINU is Ownable {
    constructor(
        string memory _NAME,
