...
The Wild Leopard token is led by the development community, managed by volunteers.

Telegram:
https://t.me/LEOPARDNFTs
Website:
https://wildleopards.wixsite.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1000 * (10 ** 12);
...
contract WildLeopardNFTs is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    //address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Test 

    string constant _name = "WILD LEOPARDS";
    string constant _symbol = "LEOPARD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 2 / 100; // 2%
    uint256 public _maxTxAmountSell = _totalSupply * 2 / 100; // 2%
