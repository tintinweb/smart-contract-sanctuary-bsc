...
/**
THE BSC HAS FUCKED ENOUGH PEOPLE I MADE THIS COIN SO ANYONE CAN FEEL SAFE CONTRACT RENOUNCED AND LP BURNT IF YOU
WANT YOU GUYS CAN MAKE A TG. BUT THIS IS FULLY COMMUNITY NO MARKETING TAX NO NOTHING JUST LP BEING FED 2% LP TAX JUST TO MAKE IT HEALTHIER OVERTIME
...
contract NEWCOMMUNITYCHUNGUSCOIN  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'NEW COMMUNITY CHUNGUS COIN';
    string private constant _symbol = 'NCCC';
    ...
    //HUCHUGUS DUNGUS IN YOUR BUNGUS
}