...
contract TestToken is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x72dc55a370f6eE1756e4fdcC71AfB65B3c2D8b26;
    address public receiveSellFeeWallet = 0xa30A1EA02b20D72616dd79d643aD6C1566bF73FB;
    IWrap public wrap = IWrap(0xa7a03D208c9Cef8faFc5ea15d86d3fA6F7A6e8FD);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Test Token", "TestToken", 18, 310000000 * 10 ** 18){
        address msgSender = _msgSender();
