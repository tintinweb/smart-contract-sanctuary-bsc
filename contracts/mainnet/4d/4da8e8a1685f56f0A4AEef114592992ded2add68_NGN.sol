...
contract NGN is IERC20, Ownable {
    ...
    address private fundAddress = address(0xeD96d5217C4D8Cc055A1978B771f6764f098893E);
    ...
    function setTradeStatus(bool canBuy) public onlyOwner returns (bool){
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            rate = _taxFee.mul(multiple) + _inviterFee.mul(multiple) + _lpFee.mul(multiple) + _fundFee.mul(multiple);
        }
