...
contract BASICDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB2A1B5A3A7d372D6e6DFaFf7cC8EfE51FB1024B8); 
    address payable public Wallet_Dev = payable(0xB2A1B5A3A7d372D6e6DFaFf7cC8EfE51FB1024B8);
    ...
    string private constant _name = "Basic Doge"; 
    ...
    constructor () {
        ...
        _owner = 0xB2A1B5A3A7d372D6e6DFaFf7cC8EfE51FB1024B8;
