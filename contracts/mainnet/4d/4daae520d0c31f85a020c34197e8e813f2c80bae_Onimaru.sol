...
/* Token contract */
contract Onimaru is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3Ac003B29eE1B7B9cE6b23B8Bb0559F96eC53Ec2;
    ...
    // Name and symbol
    string constant _name = "Onimaru";
    string constant _symbol = "Onimaru";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD1bb941244EaF993c73EF215710B1f391f90B82b;  
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(buybackFee).div(totalBNBFee);
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _donationFeeBuy, uint256 _buybackFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        donationFeeBuy = _donationFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        developmentFeeBuy = _developmentFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_donationFeeBuy).add(_buybackFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _donationFeeSell, uint256 _buybackFeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        donationFeeSell = _donationFeeSell;
        buybackFeeSell = _buybackFeeSell;
        marketingFeeSell = _marketingFeeSell;
        developmentFeeSell = _developmentFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_donationFeeSell).add(_buybackFeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
