...
6% Buy/Sell Taxes in Total 

Maximum Buy/Sell Taxes Capped at 30%

MYCOIN SOCIALS
Telegram: https://t.me/MyCoinOfficialTG
Website: http://www.mycoinfinance.com
Twitter: https://twitter.com/mycointoken
...
contract MYCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 250 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x0865ED134F8A65D36f07A829F3D182899B7424b0);
    ...
    constructor () {
        ...
        _maxBalance = 250 * 10**9 * 10**_decimals;
