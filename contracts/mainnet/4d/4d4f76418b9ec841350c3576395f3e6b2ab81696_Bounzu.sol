...
Bounzu is the first privacy protocol developed on traditional services to enable greater anonymity  
privacy when transacting via the binance Blockchain.

Telegram: https://t.me/Bounzu
*/
...
contract Bounzu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bounzu";
    string private _symbol = "BZU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x4087C9FD62731F18f041D425CC41792a087A31f7);
