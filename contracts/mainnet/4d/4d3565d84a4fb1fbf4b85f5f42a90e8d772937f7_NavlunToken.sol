...
contract NavlunToken {
  ...
  constructor() {
        name = "NAVLUN"; // Sets the name of the token, i.e Ether
        symbol = "NVLN"; // Sets the symbol of the token, i.e ETH
        decimals = 10; // Sets the number of decimal places
        uint256 _initialSupply = 10000000000000000000; // Holds an initial supply of coins
