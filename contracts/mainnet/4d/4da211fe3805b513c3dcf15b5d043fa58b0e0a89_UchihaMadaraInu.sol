...
/** Telegram: https://t.me/UchihaMadaraInuBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe09a8C7B4C9E8D5a6A77E41251c7995CAce03d72; // owner address
...
contract UchihaMadaraInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Uchiha Madara Inu";
    string private _symbol = "$INU$"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe09a8C7B4C9E8D5a6A77E41251c7995CAce03d72); // Marketing Address
    address payable public teamWalletAddress = payable(0xe09a8C7B4C9E8D5a6A77E41251c7995CAce03d72); // Team Address
