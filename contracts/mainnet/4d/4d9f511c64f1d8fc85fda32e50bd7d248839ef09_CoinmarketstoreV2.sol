...
contract CoinmarketstoreV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xB0179625F60cD5e4339E69f7963344625932Fe06); // Marketing Address
    ...
    string private constant _name = "CoinmarketstoreV2";
    string private constant _symbol = "CMSV2";
    ...
    constructor() {
        address newOwner = address(0x3B415AEA091BFD444d469584eD9B3af2F8f9F3Af);
