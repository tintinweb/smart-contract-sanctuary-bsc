...
contract GoldenDogeDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldenDogeDao";
    string private _symbol = "GoldenDogeDao";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe074E5703ba151C9A3401Bd0A1e94A2D84f0B69b); 
    address payable private teamWalletAddress = payable(0xe074E5703ba151C9A3401Bd0A1e94A2D84f0B69b); 
