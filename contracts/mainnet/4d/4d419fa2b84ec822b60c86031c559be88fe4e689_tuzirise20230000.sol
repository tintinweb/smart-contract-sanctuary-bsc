...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55c81A195116d20E093f0eb7288b20fF8CE09f7C; // owner address
...
contract tuzirise20230000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "tuzi rise 2023 0000";
    string private _symbol = "$tr2300";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x55c81A195116d20E093f0eb7288b20fF8CE09f7C); 
    address payable public teamWalletAddress = payable(0x55c81A195116d20E093f0eb7288b20fF8CE09f7C);
