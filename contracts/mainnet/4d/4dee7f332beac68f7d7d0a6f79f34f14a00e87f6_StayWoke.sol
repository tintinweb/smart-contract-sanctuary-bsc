...
contract StayWoke  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StayWoke";
    string private _symbol = "StayWoke";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xed92aa72e90443b6D34DeA18D0D00003C4d91c8B); 
    address payable public BurnedWalletAddress = payable(0xed92aa72e90443b6D34DeA18D0D00003C4d91c8B); 
