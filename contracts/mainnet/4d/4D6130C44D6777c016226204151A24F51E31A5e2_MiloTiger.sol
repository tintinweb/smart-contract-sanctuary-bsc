...
contract MiloTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiloTiger";
    string private _symbol = "MiloTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD7e46588A44BE7a849a8A2bB5a8A71f5F1994F6); // Marketing Address
    address payable public teamWalletAddress = payable(0x9D973dD1418F90dd19EF3F344a41c07d3B470a9D); // Team Address
