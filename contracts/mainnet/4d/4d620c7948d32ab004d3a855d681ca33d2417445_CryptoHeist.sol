...
contract CryptoHeist is IBEP20, Auth {
    ...
    string constant private _name = "Crypto Heist INU";
    string constant private _symbol = "HEIST";
   ...
   function setmaxWallPercent(uint256 amount) external onlyOwner() {
    ...
    function setmaxTXPercentage(uint256 amountBuy) external authorized {
