...
contract NewShibaGrow is ERC20 {

    uint tokenTotalSupply = 2000000000; // 2 Billion Token Supply

    constructor() public ERC20("NewShibaGrow", "NewShibaGrow") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "NewShibaGrow";
    string private _symbol = "$NSG";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D, 'We can not exclude Uniswap router.');
