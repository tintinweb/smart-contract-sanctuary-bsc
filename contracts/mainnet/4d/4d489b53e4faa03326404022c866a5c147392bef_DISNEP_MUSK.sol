...
contract DISNEP_MUSK is Context, IERC20, Ownable {
    ...
    _marketingAddress =
        payable
        (address
        (0x3B0A924FCc361C9c21A0Ffad6E5b751c9d655084));


    string private _name = "DisnepMusk";
    string private _symbol = "DisnepMusk";
