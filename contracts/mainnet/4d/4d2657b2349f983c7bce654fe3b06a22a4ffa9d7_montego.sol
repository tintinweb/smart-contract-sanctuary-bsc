...
contract montego is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x743016abC916A201a7700acFBBA97Fe06dB8D95A); 
    ...
    string private constant _name = "montego"; 
    string private constant _symbol = unicode"montego"; 
