...
contract WhaleSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Whale Squid"; // 
    string private constant _symbol = "Squid Whale"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x97567892b4F5a3bA5aB9a23ff82676fCB7E9D773;
