...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 850 * 10**18;
    string private _name = "Mcake";
    string private _symbol = "Mcake";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x905A31F32b1262A1f46242A305892A4eF8705623);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 850 * 10**18;
