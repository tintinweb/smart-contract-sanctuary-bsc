...
contract BscMaster is Ownable{
    ...
    uint256 public monthlyFee = 1000000000000000000   ; // 1 USDC | Test 0.001 BUSD | 50000000000000000000 | Testnet -> 1000000000000000
    ...
    constructor() {
        ...
        BUSDContract = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Testnet - 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee
    } 
...
contract BscVault is AutomationCompatibleInterface {
    ...
    // TODO: Change for BSC
    address public constant registrar = 0xDb8e8e2ccb5C033938736aa89Fe4fa1eDfD15a1d; // Testnet -  0xDb8e8e2ccb5C033938736aa89Fe4fa1eDfD15a1d
