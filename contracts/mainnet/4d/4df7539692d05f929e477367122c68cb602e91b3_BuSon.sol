...
contract BuSon is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    BuSonDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    uint256 public _totalSupply = 290000000 * 10 ** 18;
    uint256 public swapTokensAtAmount = 290000000 * 10 ** 18;
    ...
    address payable public _marketingWalletAddress = payable(0x7315E407eea12FFd1F57dFe7Cc9d050E75c978f1);
    address payable public _buybackWalletAddress = payable(0x667197727a1aD67a9ffFfD4bae85424A2d62D226);
    ...
    constructor() BEP20("BuSon", "BS") 
    {
        dividendTracker = new BuSonDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "BuSon: The dividend tracker already has that address");
        BuSonDividendTracker newDividendTracker = BuSonDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "BuSon: The new dividend tracker must be owned by the BuSon token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BuSon: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BuSon: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BuSon: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BuSon: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BuSon: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BuSon: Cannot update gasForProcessing to same value");
...
contract BuSonDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BuSon_Dividend_Tracker", "BuSon_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "BuSon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BuSon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BuSon contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BuSon_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BuSon_Dividend_Tracker: Cannot update claimWait to same value");
