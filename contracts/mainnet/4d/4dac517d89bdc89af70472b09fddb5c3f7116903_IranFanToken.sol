...
/* Token contract */
contract IranFanToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xA03E45E2a2CF49CdF6d7C5AD09ad414155B88b47;
    ...
    // Name and symbol
    string constant _name = "Iran Fan Token";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 10000 / 10000;  // 1% max or 1M
    uint256 public _maxWalletToken = _totalSupply * 10000 / 10000; // 2% or 2M tokens
