...
contract DecentraBNB is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0xf9b42dC679C5196d90695BB9D359262e35F932Af; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xf9b42dC679C5196d90695BB9D359262e35F932Af; //can be the same

    uint256 private _tTotal = 1000000000 * 10**_decimals;     // Supply do Token = 280 millions
