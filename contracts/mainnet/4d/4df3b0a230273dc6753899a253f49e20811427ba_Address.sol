...
/* Linux Token Is A Deflationary Token Powered By The Binance Smart Chain Platform
...
contract PimexToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8a915DfeA3729c3756De75A553C35D332d8Ef045); // Marketing Address
    address payable public charityAddress = payable(0x8a915DfeA3729c3756De75A553C35D332d8Ef045); // Charity/Dev Address
    ...
    uint256 private _tTotal = 50000000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PimexToken";
    string private _symbol = "PIMEX";
    ...
    uint256 public _maxTxAmount = 50000000000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
