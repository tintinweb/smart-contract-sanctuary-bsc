...
contract PeakyDoge is Context, IBEP20, Ownable {
    ...
    string private _name = "Peaky Doge"; // token name
    string private _symbol = "PEAKYDOGE"; // token ticker
    ...
    uint256 public minTokenToSwap = 10 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 50 * 1e9;
    uint256 public minBuyLimit = 25 * 1e9;
    ...
    uint256 public marketWalletFeeOnSelling = 350;
