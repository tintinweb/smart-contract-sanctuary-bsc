...
/**
   ...
   #BabyLUNA will list on #BSC 

   I make this #BabyLUNA to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/babyluna_tg
   ...
   Can you make #BabyLUNA 10000000X? 
...
contract BabyLUNA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BabyLUNA"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 1;
    address private _promoWallet = 0x2D4CDfAccFdB5b10d3256906135c46b1e5080c5c;
