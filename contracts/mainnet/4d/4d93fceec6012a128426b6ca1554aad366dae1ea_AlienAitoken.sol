...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04c9BD7c85F3707ed9E50Ef8A04C3aE455066993; 
...
contract AlienAitoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALIEN AI TOKEN";
    string private _symbol = "ALIEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3650C8b54465DA0901C88345E574AD71e79Ca93); // 
    address payable public teamWalletAddress = payable(0x04c9BD7c85F3707ed9E50Ef8A04C3aE455066993); // 
