...
contract SoccerWorldToken is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x1878094E9f58944aF65CE6F7176c36c3357ce725);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 10000 * 10**18;
    ...
    constructor () BEP20Detailed("Soccer World", "SCW", 18) {
        _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000 * 10**18 && _numTokensSellToFee <= 1000000 * 10**18, "Threshold must be set within 1,000 to 1,000,000 tokens");
