...
contract SphynxVault is Ownable, Pausable {
    ...
    IERC20 public immutable token; // LuxeToken
    IERC20 public immutable receiptToken; // LuxeToken
    ...
    function getUserInfo(address _user) public view returns (uint256, uint256, uint256) {
        UserInfo storage user = userInfo[_user];
        return (user.shares, user.lastDepositedTime, user.sphynxAtLastUserAction);
    }
