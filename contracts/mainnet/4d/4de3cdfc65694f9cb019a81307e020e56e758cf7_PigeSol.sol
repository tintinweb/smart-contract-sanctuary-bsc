...
contract PigeSol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xce69c2467999aAeA0d133c218706C9C591535933); 
    address payable public Dev_Wallet = payable(0x5d33a8D421eB7beB67Ec32eD1dFDeaa181eC4d89);
    ...
    string private constant _name = "Pige Sol"; 
    string private constant _symbol = unicode"$PigeSol"; 
    ...
    constructor () {
        ...
        _owner = 0x5d33a8D421eB7beB67Ec32eD1dFDeaa181eC4d89;
