...
contract piggish is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x2aD7A5CCdD702B5E0F77cc1Bf45a17fC7b4186D6));
    address payable public devWallet =
        payable(address(0x2a165E1Ecb1676f6197d058c92842d943FD8bB9c));
    address public liquidityReceiver =
        0x2a165E1Ecb1676f6197d058c92842d943FD8bB9c;
    ...
    uint256 private numTokensSellToAddToLiquidity = 7000000000 * 10**9;
