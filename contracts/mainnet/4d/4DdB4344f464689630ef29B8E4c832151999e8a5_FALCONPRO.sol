...
contract FALCONPRO is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x0cDf8C0d0bd7E37De25AdaF509E88060955F3bCA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 15e9 * (10 ** _decimals);
    string private constant _name = "Falcon Protocol"; 
    string private constant _symbol = unicode"FALC"; 
    ...
    uint256 public _maxWalletToken = 15e8 * (10 ** _decimals);
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = 15e8 * (10 ** _decimals); 
