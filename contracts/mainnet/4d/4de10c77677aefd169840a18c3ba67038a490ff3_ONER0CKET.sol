...
contract ONER0CKET  is Ownable, IBEP20 {
    ...
    string constant _symbol = "1R0CKET";
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x24471629487823462c9c7Bbb8C9c069069CC399B;
        marketingWallet =0x31b053EADb970A0f4D9F470518cAA24de9eb8127;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(BurnFee.div(2));

        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBMarketing = amountBNB.mul(BurnFee).div(totalBNBFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBurnFee) external onlyOwner {
