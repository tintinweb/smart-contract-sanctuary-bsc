...
contract LIBERAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chronicles Of Dragon";
    string private _symbol = "LIBERAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Fba96c8629a0f365C8D728ecd639f9dDFfC1bF9); // Marketing Address
    address payable public teamWalletAddress = payable(0x2Fba96c8629a0f365C8D728ecd639f9dDFfC1bF9); // Team Address
