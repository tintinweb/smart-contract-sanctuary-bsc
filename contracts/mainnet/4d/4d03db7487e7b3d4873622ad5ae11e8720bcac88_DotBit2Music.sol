...
contract DotBit2Music is ERC721Enumerable, Ownable, AccessControl {
    ...
    event LogVerificationRequestSubmitted(address indexed ownerWalletAddress, string bitDomain);
    event LogVerificationRequestCompleted(address indexed ownerWalletAddress, string bitDomain);
    ...
    function verifyDidOwnership(string memory domainName) external {
        ...
        emit LogVerificationRequestSubmitted(msg.sender, domainName);
    }
    ...
    function setDomainVerifyStatus(address[] memory ownerWalletAddressMap, string[] memory domainNameMap) public onlyMember {
        ...
        for (uint i=0; i<domainNameMap.length; i++) {
            ...
            emit LogVerificationRequestCompleted(walletAddress, domainName);
        }
    }
