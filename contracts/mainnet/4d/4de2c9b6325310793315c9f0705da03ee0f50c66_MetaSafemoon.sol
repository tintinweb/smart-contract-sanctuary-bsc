...
/**
TELEGRAM:  https://t.me/MetaSafemoonCommunity
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2678C88D9A27a9A20B2A93ED01c28BA48DFCfF11; //
...
contract MetaSafemoon is Context, IERC20, Ownable {   //
    ...
    string private constant _symbol = "MSafemoon"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x2678C88D9A27a9A20B2A93ED01c28BA48DFCfF11); //
