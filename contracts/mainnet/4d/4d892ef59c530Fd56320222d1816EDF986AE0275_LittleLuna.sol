...
contract LittleLuna is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Little Luna Classic";
    string constant _symbol = "LLUNC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC8576a4Cfe533474962C1a301C6f63a1bD0a8C61;//mkt
        buybackFeeReceiver = 0xC8576a4Cfe533474962C1a301C6f63a1bD0a8C61;//11
        teamFeeReceiver = 0xC8576a4Cfe533474962C1a301C6f63a1bD0a8C61;//11
