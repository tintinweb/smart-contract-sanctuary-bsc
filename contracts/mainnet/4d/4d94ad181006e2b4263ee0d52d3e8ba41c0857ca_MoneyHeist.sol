...
contract MoneyHeist is Context, IERC20, Ownable {
    ...
    string private _name = "MoneyHeistInu 2.0";
    string private _symbol = "MoneyHeistTwo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaaD9C7b265d28fB6307aa728c0FFa679e7e4Bf86); 
    address payable public teamWalletAddress = payable(0xaaD9C7b265d28fB6307aa728c0FFa679e7e4Bf86); 
    ...
    uint256 private _totalSupply = 41000000000 * 10**9;
    uint256 public _maxTxAmount = 41000000000 * 10**9; 
    uint256 public _walletMax =  1230000000 * 10**9; 
