...
contract token is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        IERC20(_usdt).approve(address(_uniswapV2Router), MAX);
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(address(this), _usdt);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountReceived = IERC20(_usdt).balanceOf(address(this));
