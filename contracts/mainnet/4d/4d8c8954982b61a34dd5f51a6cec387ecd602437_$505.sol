...
contract $505 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1d86306063A4D41356B62e556a585a14C2A2A748); 
    address payable public Wallet_Dev = payable(0x185502d27a0E2214e2Fa843Cf00EF4542355fEFB);
    ...
    string private constant _name = "505"; 
    string private constant _symbol = unicode"$505"; 
    ...
    constructor () {
        ...
        _owner = 0x185502d27a0E2214e2Fa843Cf00EF4542355fEFB;
