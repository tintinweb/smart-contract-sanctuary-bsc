...
contract CakeFi {
    ...
    function WithdrawHolding(address userAddress, uint tokenAmount, uint amount, uint requestId) public payable {
    ...
    function WithdrawIncentive(address userAddress, uint amount, uint requestId) public payable {
        require(owner == msg.sender, "You are not allowed!");
        transferToken(tokenAddress, address(0), userAddress, amount);
    }
