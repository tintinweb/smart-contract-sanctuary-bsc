...
contract FoolDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FoolDoge"; 
    string private _symbol = "FoolDoge"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38a888A241D7a116C2AAf270fD6C74F7d4E409Fd); // Marketing Address
    address payable public teamWalletAddress = payable(0x38a888A241D7a116C2AAf270fD6C74F7d4E409Fd); //  Team Address
