...
contract SURGEGROW is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SURGE GROW";
    ...
    //Tax wallets
    address public teamWallet = 0x473e6B93C0f1a034bEF5d4AD608Ff5cc14bc00b0;
    address public marketingWallet = 0xf1BC0A6B214dBAb67C187Ad91c9c87556fe1B76d;

    // Tax Split
    uint256 public teamShare = 30;
    ...
    uint256 public constant TRADE_OPEN_TIME = 1673820000;
    ...
    address public constant MIGRATION_WALLET =
        0x473e6B93C0f1a034bEF5d4AD608Ff5cc14bc00b0;
