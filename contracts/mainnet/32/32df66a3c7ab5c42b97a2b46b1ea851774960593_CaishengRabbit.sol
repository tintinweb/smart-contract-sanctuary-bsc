...
contract CaishengRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Caisheng Rabbit";
    string private constant _symbol = " CaishengRabbit";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x598d62D0F7F5058A3a2899e041e18c575ba13124);
    address payable private _marketingAddress = payable(0x598d62D0F7F5058A3a2899e041e18c575ba13124);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 93, "Redis cannot be more than 93.");
	    require(taxFeeOnBuy < 6, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 93, "Tax cannot be more than 93.");
