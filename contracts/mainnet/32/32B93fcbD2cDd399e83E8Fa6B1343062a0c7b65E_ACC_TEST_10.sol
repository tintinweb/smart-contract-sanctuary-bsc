...
contract ACC_TEST_10 is Context, IERC20, Ownable {
    ...
    string private _symbol = "ACC_TEST_10";
    ...
    function setWhiteAddresses(address[] memory accounts) public onlyOwner{
        uint len = accounts.length;
        for( uint i = 0; i < len; i++ ){
            whiteContract[accounts[i]] = true;
        }
    }
