...
contract SINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1E5481A7c1427240585a01646D3Dd217ecA379D1); 
    address payable public Wallet_Dev = payable(0x534A9CD9E5Edb298bc63208D852e02063aB9470D);
    address payable private constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5*10**11 * 10**_decimals;
    string private constant _name = "Susanoo Inu"; 
