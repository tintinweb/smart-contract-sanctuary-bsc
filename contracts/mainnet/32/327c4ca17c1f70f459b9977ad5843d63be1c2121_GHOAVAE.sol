...
contract GHOAVAE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GHOAVAE";
    string constant _symbol = "GHOAVAE ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply.mul(4)).div(100); // 0.4%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xF1E6Bb9bAD7fe1e1428C8E5C8e396BB0BAF9207e;
        ...
        marketingFeeReceiver = 0xF1E6Bb9bAD7fe1e1428C8E5C8e396BB0BAF9207e;
