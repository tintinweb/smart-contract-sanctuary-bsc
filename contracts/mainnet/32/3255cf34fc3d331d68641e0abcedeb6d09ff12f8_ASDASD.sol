...
contract ASDASD is Context, IERC20 { 
    ...
    address payable public Wallet_Developer = payable(0x3B0046C1f64De4Af66466cC4bFDF86A93A479D0d);
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Developer] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != address(this) && from != uniswap())
