...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6);
...
/* Token contract */
contract BABYPROBETS is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTC = 0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC2c7E9FF8e8FECFcd470e1383D48e30F7A1C6307;
    ...
    // Name and symbol
    string constant _name = "BABY PROBETS";
    string constant _symbol = "bBETS";
    ...
    uint256 public totalFeeSell = 39;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x1F257b02FC3c793cC17d0EF12Cd76F85240873Ae;
        marketingFeeReceiver = 0xCf48b4986f54405430d12b1fFE6DfB5C0987401C;
