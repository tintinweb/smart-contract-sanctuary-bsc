...
contract bxbToken is Context, IERC20, Ownable {    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "gfh";   
    string private _symbol = "fgh"; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x19046247246a061B7725433c9683b0607c663098));   
