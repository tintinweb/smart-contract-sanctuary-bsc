...
Telegram: https://t.me/ZiggoeChain
Twitter: http://ziggoechain.site/
...
contract  ZGO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ziggoe Chain"; // 
    string private constant _symbol = unicode"$ZGO"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x181c2833A1b5335296382F43Be3432a5B2E1AE4C;
