...
contract  GamblingSociety is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "GamblingSociety";
    string constant _symbol = "GamblingSociety";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xd1f0Be0A1F6a0a613D13B3F5a432849217F393dC;
