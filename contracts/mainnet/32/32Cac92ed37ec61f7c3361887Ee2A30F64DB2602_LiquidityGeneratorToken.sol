...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x13B0e0226a4b5Bd0E64A28c5FD98C45c0F1276a5; // owner address
...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    string private _name = "CEO PIG";
    string private _symbol = "CPIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x789A7785ead60b05aB8E712aAc638DBCF41a370b); // Marketing Address
    address payable public teamWalletAddress = payable(0x789A7785ead60b05aB8E712aAc638DBCF41a370b); // Team Address
