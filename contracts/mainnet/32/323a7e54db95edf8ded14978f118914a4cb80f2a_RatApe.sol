...
// * RatApe    * Rewards in RatBoy    * TG :https://t.me/RatApe
...
contract RatApe is IBEP20, Auth {
    ...
    address DEV = 0x35Ce853465556591029090ceEf388bf59d98D6D1;
// * Name
    string constant _name = "RatApe";
    string constant _symbol = "BRAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**5 * 10**_decimals;

    uint256 public _maxTxAmount = 2000 * 10**3 * 10**_decimals;
    uint256 public _maxWalletToken = 2000 * 10**3 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x05A9225Bf6E9276D791e5e9d5DC6a3B96C5E0e35;
        marketingFeeReceiver = 0xa96398c3010ed5D4dD7F2AECbaE6DEBfec77fF1a;
