...
contract SIXTEENZEROSGROW is IBEP20, Ownable {
    ...
    string private _name = "SIXTEEN ZEROS GROW";
    string private _symbol = "SIXTEENZEROSGROW";
    uint256 private constant INITIAL_SUPPLY = 10_000_000_000_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //Zero can never set tax higher than this value
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 6,
        rewards: 0
        //@Zero. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        Zero: 0x3DD4beA82b1A31FeD49d7cc05CF88B6C35100312,
        team: 0x3DD4beA82b1A31FeD49d7cc05CF88B6C35100312,
        marketing: 0xeB6142a46709Ed3B0a8b1ba8C7482B28440A8180
    });
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdateZeroWallet(address newZeroWallet);
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on Zero's chosen ratios
    ...
    //allows Zero to change token name and symbol. 
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external onlyOwner {
        ...
        //Zero can never set sells below 0.1% of circulating/initial supply
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newZero + newLiquidity + newteam + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newZero, newLiquidity, newteam, newMarketing, newRewards);
    }
    ...
    function withdrawZero() external authorized {
        ...
        uint256 amount = lostBalance ? ZeroBalance + remaining : ZeroBalance;
        ZeroBalance = 0;
        _sendBnb(_taxWallet.Zero, amount);
    } 
    ...
    function setZeroWallet(address payable addr) external authorized {
        address prevZero = _taxWallet.Zero;
        _excluded.remove(prevZero);
        _taxWallet.Zero = addr;
        _excluded.add(_taxWallet.Zero);
        emit UpdateZeroWallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Zero, uint256 team, uint256 marketing) {
        return (buybackBalance, ZeroBalance, teamBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 ZeroSplit = (bnbAmount*_taxRatios.Zero) / distributeRatio;
