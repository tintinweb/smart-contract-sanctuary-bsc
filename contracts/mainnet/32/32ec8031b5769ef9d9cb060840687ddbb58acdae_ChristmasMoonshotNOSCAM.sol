...
/**
THIS IS NOT A SCAM OR HONEYPOT OR WHATEVER 
JOIN THE TG FOR MORE INFOS!!

TG: https://t.me/ChristmasMoonshotBSC
...
contract ChristmasMoonshotNOSCAM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChristmasMoonshotNOSCAM";
    string private _symbol = "CMSToken";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x2bD18a59443D71382FDb32AD434979F1911c24E6);
    address payable public teamWalletAddress = payable(0x6c500dffd7427729E6BC463d813FEE4E42B4218C);
