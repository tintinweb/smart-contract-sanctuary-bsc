 ...
 *	 	 0.5% Daily ROI 						       	                     
 *	                                                                       
 *     Fully Verified and Secured Contract     							 
 *                                                                    		 
 *   
 *
 *   [USAGE INSTRUCTION]
...
contract StakeBNB {
    ...
    uint constant public ADMIN_FEE = 2500;
	uint constant public NETWORK = 2500;
    ...
    function withdraw() public {
        ...
        if(user.referrer!=address(0)){
            ...
            address(uint160(user.referrer)).transfer(withdrawBonus);
