...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa44d4C4C5d629D7d344df15dAe16b9acF90058C0; // owner address
...
contract BEASTECOSYSTEM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BEAST ECOSYSTEM";
    string private _symbol = "BECO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa44d4C4C5d629D7d344df15dAe16b9acF90058C0); // Marketing Address
    address payable public teamWalletAddress = payable(0xa44d4C4C5d629D7d344df15dAe16b9acF90058C0); // Team Address
