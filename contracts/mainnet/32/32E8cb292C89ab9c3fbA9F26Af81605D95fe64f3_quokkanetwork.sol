...
contract quokkanetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quokka Network"; // 
    string private constant _symbol = "QKA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2348E875De0BF4A4fa6e4bd83795B5C65516e903;
