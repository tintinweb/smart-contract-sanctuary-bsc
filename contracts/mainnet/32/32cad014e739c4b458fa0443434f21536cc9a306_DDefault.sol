...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "TwinKats";
    string private _symbol = "$TK";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x24317Da561e7Ad5Ea93188f0f8Bc8b21Db18FD36); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x24317Da561e7Ad5Ea93188f0f8Bc8b21Db18FD36); // BuyBack Address
