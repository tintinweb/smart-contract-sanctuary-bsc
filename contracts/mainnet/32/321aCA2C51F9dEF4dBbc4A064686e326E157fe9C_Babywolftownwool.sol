...
contract Babywolftownwool is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "baby wolf town wool";
    string private _symbol = "BWTWOOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9c8E155Ad4E0BB223058F9d5a237267d0c69f009); 
    address payable public buyBackWalletAddress = payable(0x3FEcFF0eEB3447A1b3F6Ff1F1F327AA593948292); 
