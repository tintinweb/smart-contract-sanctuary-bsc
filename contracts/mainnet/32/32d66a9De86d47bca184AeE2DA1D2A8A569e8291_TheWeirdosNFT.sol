...
// File: contracts/TheWeirdosNFT.sol



/*

https://t.me/TheWeirdosNFT
...
\__$$  __|$$ |                $$ | $\  $$ |          \__|                $$ |                    
   ...
   $$ |   $$ |  $$ |$$   ____|$$$  / \$$$ |$$   ____|$$ |$$ |      $$ |  $$ |$$ |  $$ | \____$$\ 
   $$ |   $$ |  $$ |\$$$$$$$\ $$  /   \$$ |\$$$$$$$\ $$ |$$ |      \$$$$$$$ |\$$$$$$  |$$$$$$$  |
   \__|   \__|  \__| \_______|\__/     \__| \_______|\__|\__|       \_______| \______/ \_______/ 
...
contract TheWeirdosNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 500;
    uint256 public normalPrice = 0.1 ether;
    uint256 public presalePrice = 0.05 ether;
  
    uint256 public totalMint = 0;
    string private baseUrl;

    uint256 public presaleDuration = 10 minutes;
    ...
    constructor(string memory _baseURI) ERC721("TheWeirdosNFT", "TheWeirdos NFT") {
        baseUrl = _baseURI;
    }
    ...
    function mint(address player, uint256 amount) public payable {
        require(saleIsActive);
        require(totalMint + amount <= maxMint);
        require(normalPrice*amount <= msg.value);
        _mintTokens(player, amount);
    }
    ...
    function _presaleIsActive() internal view returns (bool) {
        return block.timestamp < presaleEnd;
    }
    ...
    function reserve(address player, uint256 amount)
        public
        payable
        onlyOwner
    {
