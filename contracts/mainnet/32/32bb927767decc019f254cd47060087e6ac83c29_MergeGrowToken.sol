...
/*
    Telegram    : https://t.me/mergegrow
    Twitter     : https://twitter.com/mergegrow
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x749a1e5a65c550d9B2183C1af4e739bFaA040cbb; // owner address
...
contract MergeGrowToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Merge Grow";
    string private _symbol = "$MG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x749a1e5a65c550d9B2183C1af4e739bFaA040cbb); // Marketing Address
    address payable public teamWalletAddress = payable(0x749a1e5a65c550d9B2183C1af4e739bFaA040cbb); // Team Address
