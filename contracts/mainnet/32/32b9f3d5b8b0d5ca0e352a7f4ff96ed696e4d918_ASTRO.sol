...
contract ASTRO is Context, IERC20, Ownable {
    ...
    string private _symbol = "ASTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48f13f136C526718716C5574D708C51c3DC57376); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x48f13f136C526718716C5574D708C51c3DC57376); // BuyBack Address
