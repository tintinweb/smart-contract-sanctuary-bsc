...
//Introducing Pancake Inu, a new decentralized protocol for yield farming and automated liquidity provided by the combined backing of both Binance Smart Chain (BSC) and Ethereum. Pancake Inu provides various rewards including staking rewards, trading fees, and flash loans. The system is powered by an incentivized liquidation structure that promotes safety and prevents market manipulation. Pancake Inu is built to bring together all investors and traders in the crypto space so they can maximize their yield potential while supporting a safe & reliable platform.


//https://t.me/PancakeInu_Bsc
...
contract PancakeInu is IBEP20, Ownable {
    ...
    string constant _name = "Pancake Inu";
    ...
    address public marketingFeeReceiver = 0x1A0db8c2385Aee0b25275c1F32dEFa92d47faD22;
