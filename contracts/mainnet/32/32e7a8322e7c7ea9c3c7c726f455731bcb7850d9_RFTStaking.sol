...
contract RFTStaking is ReentrancyGuard, Ownable {

    using SafeMath for uint256;

    IERC20 public token = IERC20(0xA3321E3c8db2846F58BdB640cce4165c6B83F1BD);
    bool public paused;

    address public rewardPool = 0x9E36590e0c9F0e54Dca621E30779e0090Ec82f8d;
    address public securityWallet = 0x04E89F0f9681740A5849EebE50423a2157188555;
    address public MarketingWallet = 0xd84E08790F8B9e3Bd68bFaA438625AaA938Fb8DA;
    ...
    */
    ...
    function unstake(uint _amount) public {
        ...
        if(releasable < _amount) {
            revert("Error: you can Only unstake after 72hrs.Pls try again after 72hrs has elapsed!!");
        }
