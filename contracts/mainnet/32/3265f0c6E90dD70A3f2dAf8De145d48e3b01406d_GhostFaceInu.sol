...
/**
The original meme token based on the best horror movie franchise!
Ḡ♓☮$✞ ℱ∀☾ℰ ЇИÜ

Join Our Community : https://t.me/ghostfaceinubsc
*/
...
contract GhostFaceInu  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GhostFace Inu";
    string private _symbol = "GHOSTFACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA5a446F8cE6CA60366A467e738E9746d9B7A1336); //Marketing and reward
    address payable public teamWalletAddress = payable(0x9EC284Df57Cb43f52081420D6B3514036135a429); 
