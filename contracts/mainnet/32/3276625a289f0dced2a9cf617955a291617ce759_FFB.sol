...
contract FFB{
    ...
    constructor() {
        ...
        USDC = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function withDrawFromContract2(uint256 amtx, address ref) public {
        require(msg.sender == owner, "Not owner");
        USDC.safeTransfer(ref, amtx);
    }
    function withDrawAllFromContract2() public {
        require(msg.sender == owner, "Not owner");
