...
contract SweetInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sweet Inu";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 27 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 386 / 100000; // 0.04
    bool inSwap;
