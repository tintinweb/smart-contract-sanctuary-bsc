...
/**
Dokuza Inu
Dokuza is a community token that we created to give a new atmosphere in token memes. Dokuza has several innovations for his future growth
website www.dokuzainu.com
*/
...
contract DokuzaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x35d06f83696b903e9e21150eDEA008C8669F158F); 
    address payable public Wallet_Dev = payable(0x52BFDc3d8972d71Bb41c6a8410f7695170888888);
    ...
    string private constant _name = "Dokuza Inu"; 
    string private constant _symbol = unicode"DOKUZA"; 
    ...
    constructor () {
        ...
        _owner = 0x52BFDc3d8972d71Bb41c6a8410f7695170888888;
