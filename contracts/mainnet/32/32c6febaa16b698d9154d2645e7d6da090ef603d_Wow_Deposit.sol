...
contract Wow_Deposit{
    ...
    bool public blockToken=false;
    bool public blockBNB=true;
    ...
    function depositBalance(string memory idPlayer, uint amountToken) public{
        require(blockToken==false, "You cannot deposit at this moment");
    ...
    function depositBalanceBNB(string memory idPlayer) public payable{
        require(blockBNB==false, "You cannot deposit at this moment");
    ...
    function changeBlockCurrencies(bool tokenStatus, bool bnbStatus) public checkOwner{
        blockToken = tokenStatus;
        blockBNB = bnbStatus;
    } 
