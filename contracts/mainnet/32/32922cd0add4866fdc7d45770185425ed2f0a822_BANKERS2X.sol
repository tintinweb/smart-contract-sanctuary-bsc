...
/*   BANKERS2x - Yield Farming Smart Contract built on BANKERS Smart Chain.
 *   The only official platform of original BANKERS2x team! All other platforms with the same contract code are FAKE!
 *
 *   [OFFICIAL LINKS]
 *
 *
 ...
 *
 *      - Deposit - Transfer BANKERS you want to double to contract address, use msg.data to provide referrer address
 *      - Withdraw earnings - Transfer 0 BANKERS to contract address
 *      - Reinvest earnings - Withdraw and Deposit manually
 *
 *   2) Using website UI
 *
 *      - Connect web3 wallet
 *      - Deposit - Enter BANKERS amount you want to double, click "Double Your BANKERS" button and confirm transaction
...
contract BANKERS2X {
    uint256 constant INVEST_MIN_AMOUNT = 2e5; // 2 BANKERS
