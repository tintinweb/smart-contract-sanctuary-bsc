...
contract ElonHell is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ElonHell";
    ...
    uint256 private _taxFeeOnBuy = 1;  // fee will be reduce after launch - wagercity team 
    uint256 private _redisFeeOnSell = 0;  
    uint256 private _taxFeeOnSell = 1; // fee will be reduce after launch - wagercity team 
    ...
    address payable private _developmentAddress = payable(0xE60B1FCa03F26308b55d859d544E7f6BC7cDF28f); 
    address payable private _marketingAddress = payable(0xE60B1FCa03F26308b55d859d544E7f6BC7cDF28f);
