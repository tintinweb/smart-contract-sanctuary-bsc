...
// Telegram portal : https://t.me/Bulloge
...
contract BULLOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BULLOGE";
    string constant _symbol = "BULLOGE";
    ...
    // Anti-Bot v2
    uint256 public maxFuelPrice = 1000000000;
    ...
    uint256 public swapThreshold = rSupply;
    uint256 public rate;
    uint256 public _totalSupply;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant MAX_SUPPLY = ~uint128(0);
    uint256 private constant rSupply = MAX_UINT256 - (MAX_UINT256 % INITIAL_FRAGMENTS_SUPPLY);
    uint256 public _maxTxAmount = rSupply.div(1);
    uint256 public _maxWalletToken = rSupply.div(1);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x920574F71BCE5FCe91dEA8B34d79DcB0d8D6F31B;
        devFeeReceiver = 0x920574F71BCE5FCe91dEA8B34d79DcB0d8D6F31B;
