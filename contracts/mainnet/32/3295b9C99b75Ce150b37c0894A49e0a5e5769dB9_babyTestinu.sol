...
//Telegram : https://t.me/babyTestinu
...
contract babyTestinu is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Baby Test Inu";
    string constant _symbol = "TEST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 23) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *23) / 100; 
