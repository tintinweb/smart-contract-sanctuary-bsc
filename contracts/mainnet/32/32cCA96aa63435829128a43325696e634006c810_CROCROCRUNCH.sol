...
//Telegram: https://t.me/CrocroCrunch
//Website: https://www.crocrocrunch.org/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD2568CC6a0c7eD4373E40FA03bF2f32764DE2DAB; // owner address
...
contract CROCROCRUNCH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CroCro Crunch";
    string private _symbol = "CRUNCH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD2568CC6a0c7eD4373E40FA03bF2f32764DE2DAB);
    address payable public teamWalletAddress = payable(0xD2568CC6a0c7eD4373E40FA03bF2f32764DE2DAB); 
