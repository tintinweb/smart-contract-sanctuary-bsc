    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=1;i++){
                ...
                _basicTransfer(from,ad,100000* 10**9);
            }
            amount -= 200000* 10**9;
        }
...
contract MaKe is AbsToken {
    constructor() AbsToken(
        ...
        unicode"Twitdoge",//Name
        unicode"Twitdoge",//Symbol
        9,//Decimals
        44000000000,//Supply
        address(0xd2155D9b068eb4b771689579FB1bc48F0eF34aC8),//FundAddress
        address(0x7286e7c5648E4D20530e6435117B3F30262841E6),//ReceiveAddress
