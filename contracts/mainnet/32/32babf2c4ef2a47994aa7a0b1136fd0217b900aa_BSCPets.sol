...
contract BSCPets is Context, IERC20, Ownable {
    ...
    string private constant _name = "BSC Pets";
    string private constant _symbol = "BSCPETS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0320a414854918a5605162204Fa4d18e53103B48);
    address payable private _marketingAddress = payable(0x0320a414854918a5605162204Fa4d18e53103B48);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 9, "Redis cannot be more than 9.");
