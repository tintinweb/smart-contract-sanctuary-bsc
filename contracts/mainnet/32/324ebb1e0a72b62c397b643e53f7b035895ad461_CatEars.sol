...
/**
 ...
 🌐 Website : https://catearsbsc.com/
 💬 Telegram : https://t.me/catearsbsc
*/
...
contract CatEars is Context, ERC20, Ownable {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function setTaxFee(uint256 Taxfee) public onlyOwner virtual {

        _taxFee = Taxfee;
    }

    function setLiqFee(uint256 LiqFee) public onlyOwner virtual {
    
        _liquidityFee = LiqFee;
    }

    function setMaxAmount(uint256 _maxAmount) public onlyOwner virtual {

        MaxAmount = _maxAmount;
    }

    function setmarketing(address setaddress) public onlyOwner virtual {
        _Marketing = setaddress;
    }
