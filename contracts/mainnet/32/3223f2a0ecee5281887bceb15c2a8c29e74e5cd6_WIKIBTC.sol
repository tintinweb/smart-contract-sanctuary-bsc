...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf11edC15fFC41d6502C2dD304c8AB27E2a150660;
...
contract WIKIBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WIKI BTC";
    string private _symbol = "wBTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf11edC15fFC41d6502C2dD304c8AB27E2a150660);
    address payable public teamWalletAddress = payable(0xf11edC15fFC41d6502C2dD304c8AB27E2a150660);
