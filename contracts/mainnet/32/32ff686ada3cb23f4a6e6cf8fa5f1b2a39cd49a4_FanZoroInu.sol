...
/**
        FanZoroInu IS THE FIRST DECENTRALIZED LIQUIDITY INJECTION (DLI) PROTCOL OF THE BINANCE SMART CHAIN
*/
...
contract FanZoroInu is Context, IERC20, Ownable {
    ...
    string private _name = 'FanZoroInu';
    string private _symbol = 'FZoroInu';
