...
TELEGRAM: https://t.me/+ehfC8YcI1100MzRl
|
*/
...
contract HIGOLD   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Hold Is Gold ";
    string private _symbol = " HIGOLD "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48a9b3990Db492CC501f4e805A19eB4f34F20Ab6); 
    address payable public teamWalletAddress = payable(0x48a9b3990Db492CC501f4e805A19eB4f34F20Ab6); 
