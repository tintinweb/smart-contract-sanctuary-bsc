...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFe327160ED260fcfe01cA7406C054e40C67A60B3; // owner address
...
contract AXFINITY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AXFINITY";
    string private _symbol = "AXFINITY"; 
