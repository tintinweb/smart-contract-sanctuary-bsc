...
Telegram: https://t.me/prayforlambo
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xda326C7C90854e4e8333C3be397f6350F78feaF5;
...
contract PRAYFORLAMBO is Context, IERC20, Ownable {
    ...
    string private constant _name = "PRAY FOR LAMBO"; // 
    string private constant _symbol = "$PFL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xda326C7C90854e4e8333C3be397f6350F78feaF5);
