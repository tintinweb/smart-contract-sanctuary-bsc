...
https://t.me/AnalMusk - The DEGEN Experience.
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // MAINNET: 0x10ED43C718714eb63d5aA57B78B54704E256024E // TESTMAIN: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        _token = msg.sender;
    }
...
contract AnalMusk is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x42E530EE869796b6D7eBF277aeA051C15B8A1113;

    string constant _name = "Anal Musk";
    string constant _symbol = "AMUSK";
