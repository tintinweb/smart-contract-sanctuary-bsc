...
contract cxking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "cxking";
    string private _symbol = "cxking";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd0157191c75C574571FaB9dF15162ea125B9F564); // Marketing Address
    address payable public teamWalletAddress = payable(0xd0157191c75C574571FaB9dF15162ea125B9F564); // Team Address
