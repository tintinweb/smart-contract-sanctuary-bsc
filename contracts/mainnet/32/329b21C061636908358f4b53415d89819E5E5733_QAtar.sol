...
contract QAtar is Context, IERC20, Ownable {
    ...
    string private _name = "QAtarV2";
    string private _symbol = "QAtarV2";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xF12806c96FeDB76C6e65A38FBb8a82d7DcacdB58); 
    address payable private teamWalletAddress = payable(0x1bCE6e7097B72Fc2870440A5aEE7990ec39c212b); 
