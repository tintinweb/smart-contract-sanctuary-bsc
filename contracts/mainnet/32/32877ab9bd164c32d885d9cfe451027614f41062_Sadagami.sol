...
/**
The story of Sadako is based on the true story of a girl named Sadako Yamamura who lived in the 1990s. Sadako is a quiet, melancholic girl and has a depressing demeanor.
Since childhood he was always alone, confined himself and never played with children his age.
https://t.me/sadagami
*/
...
contract Sadagami is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5CDA3a863B40a9f63180dfCceE5df994605C83cA); 
    address payable public Wallet_Dev = payable(0x3C43a4f3E14eFeE9Cf418135AEd2b83F04fC209A);
    ...
    string private constant _name = "Sadagami"; 
    string private constant _symbol = unicode"Sadagami"; 
    ...
    constructor () {
        ...
        _owner = 0x3C43a4f3E14eFeE9Cf418135AEd2b83F04fC209A;
