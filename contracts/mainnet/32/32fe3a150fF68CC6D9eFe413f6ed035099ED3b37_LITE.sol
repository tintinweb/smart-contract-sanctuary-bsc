...
Lite 🚀
This is going to be the next moonshot in the bsc space, you dont want to miss out
/TG: https://t.me/Litebscportal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  Litecoin = IBEP20(0x4338665CBB7B2485A8855A139b75D5e34AB0DB94);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Litecoin .balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Litecoin);
        ...
        uint256 amount = Litecoin.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Litecoin.transfer(shareholder, amount);
...
contract LITE is IBEP20, Auth {
    ...
    address DEV =  0xb4C11D7e5a81794ecB304f1178bF9d897ACDa2B3;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "LITE";
    string constant _symbol = "LITE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xb4C11D7e5a81794ecB304f1178bF9d897ACDa2B3;
