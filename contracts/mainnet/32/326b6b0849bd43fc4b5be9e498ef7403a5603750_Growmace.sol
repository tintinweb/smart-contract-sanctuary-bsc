...
contract Growmace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Growmace";
    string private _symbol = "Growmace";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x7cE23C8eBBaFA4491015CA737F55c75960A76686); // Buy Back Address
