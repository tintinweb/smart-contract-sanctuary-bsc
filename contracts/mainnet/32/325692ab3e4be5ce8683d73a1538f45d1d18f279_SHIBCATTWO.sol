...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31e445df9d5A5A9D7e2712301e2Ff39a4d2658FA; //
...
contract SHIBCATTWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBCAT2.0"; // 
    string private constant _symbol = "SHIBCAT2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 89; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x31e445df9d5A5A9D7e2712301e2Ff39a4d2658FA); //
