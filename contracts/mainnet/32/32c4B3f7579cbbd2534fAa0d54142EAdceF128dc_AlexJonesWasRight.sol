...
contract AlexJonesWasRight is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Alex Jones Was Right";
    ...
    uint256 private totalFee        = marketingFee + reflectionFee + liquidityFee + donationfee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1aEB68712a52bB49Cb77F377A39f33db97e95D09;
        donationfeeReceiver = 0xD36bB4b87735D9000ee20FD594E28ac6AC73Bd23;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != donationfeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(donationfee).div(totalBNBFee);
 
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(donationfeeReceiver).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemfeeReceiver, address _burnFeeReceiver ) external authorized {
        ...
        donationfeeReceiver = _ecosystemfeeReceiver;
