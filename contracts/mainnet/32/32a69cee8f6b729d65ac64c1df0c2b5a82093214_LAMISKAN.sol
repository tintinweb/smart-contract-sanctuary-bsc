...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract LAMISKAN is Context , IERC20, Ownable {
    ...
    string private _name = "LAMIS KAN";
    string private _symbol = "لميس كان";
    ...
    address public devWallet = 0xB634Ce93C3B32eBc5Be1579b95548903C8E6b963; 
    ...
    uint256 public _maxTxAmount = 20000 * 10**9 * 10**9; //2% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2800 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 40000 * 10**9 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        else if(recipient == uniswapV2Pair){ require(amount <= _maxTxAmount, ""); }
        else{
            require(amount <= _maxTxAmount, "");
            uint256 contractBalanceRecepient = balanceOf(recipient);
            require(contractBalanceRecepient + amount <= _maxWalletToken, "");
        }
