...
contract LunaBubble is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Bubble";
    string private constant _symbol = "LunaBubble";
