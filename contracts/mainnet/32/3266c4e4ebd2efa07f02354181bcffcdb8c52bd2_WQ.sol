...
contract WQ is Context, IERC20, Ownable {
    ...
    string private _name = " WQcoin";
    string private _symbol = "WQcoin ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2e885eba3ef773F15B7BC3B785003df19517037);
    address payable public teamWalletAddress = payable(0xF2e885eba3ef773F15B7BC3B785003df19517037);
