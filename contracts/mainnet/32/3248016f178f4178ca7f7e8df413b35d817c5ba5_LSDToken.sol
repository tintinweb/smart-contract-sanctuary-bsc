...
contract LSDToken is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 200000000 * (10**9);
    uint256 public maxBuyTransactionAmount = 200000000 * (10**9);
    uint256 public swapTokensAtAmount = 20000000 * (10**9);
    uint256 public maxWalletToken = 200000000 * (10**9);

    uint256 public liquidityFee = 1;
    uint256 public pricePoolFee = 2;
    uint256 private devFee = 2;

    uint256 private totalFees = liquidityFee.add(pricePoolFee).add(devFee);

    address payable public pricePoolWallet = payable(0x7bfaD1a6358872de51298f4752bAea427d12dCc9);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LSDToken: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LSDToken: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LSDToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LSDToken: Automated market maker pair is already set to that value");
