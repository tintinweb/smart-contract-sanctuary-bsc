...
contract ChatGPT is Context, IERC20, Ownable {
    ...
    constructor (address payable _feeWallet)  {
        uint256 amountOfTokenWei = 32000000000000000000000000000;         
        ...
        numTokensSellToAddToLiquidity = 320000000000000000000000;        
    ...
    function _burn(address account, uint96 amount) internal {
        require(account != address(0), "CHATToken: burn from the zero address");
        require(_rOwned[account] >= amount, "CHATToken: amount exceeds");
    ...
    function burn(uint256 rawAmount) public nonReentrant(){
        uint96 amount = safe96(rawAmount, "CHATToken::approve: amount exceeds 96 bits");
    ...
    function setistrading(bool _istrading) public onlyOwner{
    ...
    function _transfer(
        ...
        if(from == pcsV2Pair || to == pcsV2Pair){
            require(istrading == true, "Trading not start");
            takeFee = true;
        }
