...
contract Fomobfc is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "Fomobfc";       //Full name
    string public symbol_ = "Fomobfc";      //abbreviation
    ...
    uint256 public lpRewardFee = 60;       //Add LP dividends
    address public lpRewardToken = 0xcA06f928aD1A64A5a55F210184399822544d8cC2;      //Dividend tokens
    ...
    address public marketingWalletAddress = 0xD240b5eF643F27772D6c41C0810cC30901FCa63E;  //Marketing address
