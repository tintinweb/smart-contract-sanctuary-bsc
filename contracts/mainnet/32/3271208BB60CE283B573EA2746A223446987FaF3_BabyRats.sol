...
contract BabyRats is Context, IBEP20, Ownable {
    ...
    string public _name = "Baby Rats"; // token name
    string public _symbol = "BRATS"; // token ticker
    uint8 public _decimals = 18; // token decimals
    ...
    uint256 private minTokenToSwap = 10000000 * 1e18; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 1000000000 * 1e18;
    uint256 private minBuyLimit = 1000000000 * 1e18;
