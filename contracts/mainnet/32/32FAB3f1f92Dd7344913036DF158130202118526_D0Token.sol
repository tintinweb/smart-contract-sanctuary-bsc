...
contract D0Token is IERC20, Ownable {
    ...
    address private projectAddress = 0x78fB7bB83fA9431196DafA6889503a2a149A41E8;
    address private Marketing = 0x01cEA628c5f2c9F0Ba72145F8A87e867CdE286CC;

    
    string private _name = "D0(DOGE)";
    string private _symbol = "D0(DOGE)";
    ...
    uint256 private _tTotal = 1 * 10**24 * 10**9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(
        ...
        if (_tTotal.sub(_tOwned[address(0)]) <= _tTotal.div(10000)) _burnFee == 0;
