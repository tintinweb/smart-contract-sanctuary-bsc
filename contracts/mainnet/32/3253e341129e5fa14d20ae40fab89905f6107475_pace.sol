...
contract pace is Context, IERC20, Ownable {
    ...
    string private constant _name = 'PACE';
    string private constant _symbol = '$PCE';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x615fA450507c663CE447583996D949A7871a88A9, 'We can not exclude router.');
