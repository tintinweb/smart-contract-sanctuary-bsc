...
contract HOUBI is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOUBI Inu"; //
    string private constant _symbol = "HTINU"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 6;
    address private _marketingWallet = 0xc836187772f50f99AECE40Df1FE27d887Ecea3f6 ;
