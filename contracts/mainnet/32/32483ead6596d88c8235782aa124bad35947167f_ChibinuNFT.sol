...
Chibinu will brandish the arrival of the female Chibinu character and demonstrate
her compentence and intelligence as she traverses through treachery and
corruption. Bringing art to life, Chibinu will display the character traits of the
diminutive Chibinu character, and bring her into the future through a series of
NFT's with the potential to evolve, and the release of an NFT Graphic Novel (zine)
with evolution and NFT owner interaction shaping the future of the story.
Chibinu will maintain a non-discrimination policy and will actively be involved in a
variety of community platforms to facilitate the growth and exposure of the
Chinbinu culture, growth and its evolution.
...
Website: http://www.chibinu.co
Email: [email protected]
Link Tree: www.linktr.ee/Chibinu
Telegram @chibinunft
Twitter: www.twitter.com/Chibinu
@chibinu_
Discord: https://discord.gg/8E9n4YMg
...
contract ChibinuNFT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x840D2d930BDe55D16B55D473ec9c7f4C16b6C4B5;
    address public devWallet = 0x475F08d931e89c0fE83FB909d95E90085ADcF1f7;
    address public buybackWallet = 0x3b0c64E83dADd346a3CdD68B535253B4f11B8fab;

    string private constant _name = "Chibinu NFT";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 0, 1);
    Taxes public sellTaxes = Taxes(1, 2, 3, 0, 1);
