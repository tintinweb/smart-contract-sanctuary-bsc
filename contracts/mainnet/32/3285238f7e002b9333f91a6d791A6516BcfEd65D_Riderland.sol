...
Riderland - Health and Fitness dapp with inbuilt Game-Fi and Social-Fi.

| 7% GMT Earning Forever  |

Website: www.RiderLand.co
Telegram: https://t.me/RiderlandBSC
Rewards Dashboard: https://Riderland.co/dashboard
Twitter: https://twitter.com/Riderland_
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1);
...
contract Riderland is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant BASKET = type(uint128).max;
    address BUSD = 0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RiderLand";
    string constant _symbol = "RIDER";
    ...
    constructor (
        ...
        marketingFeeReceiver = 0xf1d720C3e576dB29570Cc739A594aD9EC9225eCA;
    ...
    function Furnace(uint256 amount) external authorized {
