...
contract Token is Context, ITRC20, Ownable {
    ...
    constructor (address fundAddress) public {
        ...
        _balances[0xfec97296aB2e934A9417DE5bae1154f2bfD38039] = _totalSupply;

        emit Transfer(address(0), 0xfec97296aB2e934A9417DE5bae1154f2bfD38039, _totalSupply);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(!_isExcludedFromFee[recipient] && recipient != uniswapV2Pair){
            require(balanceOf(recipient) + amount <= 10000000000000 * 10**18);
        }
