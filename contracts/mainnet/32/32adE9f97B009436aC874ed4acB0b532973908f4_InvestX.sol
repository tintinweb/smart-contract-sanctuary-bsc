...
//SPDX-License-Identifier: MIT
        ...
        */
        ...
        contract Ownable is Context {
            ...
            constructor() {
                _owner = 0x6b47a4ac83e6B7D4d0bdB534E65634E057649EA4;
        ...
        contract InvestX is IERC20, Context, Ownable, ReentrancyGuard {
            event Bought(
            ...
            // token data
            string private constant _name = "InvestX";
            string private constant _symbol = "Inx";
            ...
            uint256 public sellMul = 85;
            uint256 public buyMul = 85;
            uint256 public constant DIVISOR = 100;

            //Max bag requirements
            mapping(address => bool) public isTxLimitExempt;
            uint256 public maxBag = _totalSupply * 200/100 / 100;
            uint256 public maxTX = _totalSupply * 200/100 / 100;
            
            //Tax collection
            uint256 public taxBalance = 0;

            //Tax wallets
            address public teamWallet = 0x08Cb80D5C6dA7DCc4FCF4431288c4F97C9021173;
            address public treasuryWallet = 0x2650250993D14b538a0227E7076BC0B44245422D;

            // Tax Split
            uint256 public teamShare = 33;
            uint256 public treasuryShare = 66;
            ...
            //trading parameters
            uint256 public liquidity = 2 * 10**_srgDecimals;
