...
contract inuReadCommunity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "INU READ COMMUNITY";
    string private _symbol = "INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2dca7837e1d1751b559E36127A731224e1A9e973);
    address payable public teamWalletAddress = payable(0x2dca7837e1d1751b559E36127A731224e1A9e973);
