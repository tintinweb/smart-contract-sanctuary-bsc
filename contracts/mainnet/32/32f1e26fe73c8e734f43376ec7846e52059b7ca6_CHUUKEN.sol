...
contract CHUUKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBBF41435B06abF33e0a330B9f1cCBd83578C2B7F;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "CHUUKEN";
    string constant _symbol = "$CHUUKEN";
