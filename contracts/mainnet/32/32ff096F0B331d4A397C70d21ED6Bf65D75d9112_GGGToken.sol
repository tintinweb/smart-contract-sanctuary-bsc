...
contract  GGGToken is IERC20, Ownable {
    ...
    constructor(){  
            ...
            _burnFee = 200;
            _marketingFee = 300;
            marketAddr = 0x33981E6CCc054f00e60f0455De9908fC3eA00b3a;
            _intervalSecondsForSwap = 3;
            burnEndNumber =1e18;
             address router;
            if( block.chainid == 56){
                router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
                _token = 0x55d398326f99059fF775485246999027B3197955;
                adminAddress =0x0312e71e8169E6a104A86CD7B341fE46B3fBe187;
                minPeriod = 180;
            }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount;
         ...
         if(canSwap &&from != address(this) &&from != uniswapV2Pair  &&from != owner() && to != owner() ){
                ...
                IERC20(_token).transfer(marketAddr, tokenBal);
        }
