...
A place where crypto security is made easy through 
A fully decentralized token which will used to build the infrastructure of a 
Wallet dApp and a fully functional Telegram Bot.

https://t.me/PixelShield
...
contract PixelShield is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4a5BAc2959DB132514808C7f4f228F4c4Aa80503); // Marketing Address
        
    address payable public teamAddress =
        payable(0xAb4beB888214931E0c34b00911542798585F23D4); // Team Address
        
    address payable public liquidityAddress =
        payable(0xAb4beB888214931E0c34b00911542798585F23D4); // Liquidity Address
    ...
    string private constant _name = "PixelShield";
    string private constant _symbol = "PXS";
