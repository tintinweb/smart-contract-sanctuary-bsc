...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x830e0Fda3AAeBaEa535CaE42c974F05f5BAB8a29;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x830e0Fda3AAeBaEa535CaE42c974F05f5BAB8a29),//fund 

        address(0x830e0Fda3AAeBaEa535CaE42c974F05f5BAB8a29)//dev 
    ){
