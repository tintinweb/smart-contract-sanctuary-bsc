...
contract GoingAPE is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GoingAPE"; // 
    string constant _symbol = "GAPE"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (6); // 6%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (2); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (6); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0x39B8850D89D2c7e3324FC086Db4de9e016B56FD3; //LP receiver
    address private marketingFeeReceiver = 0x39B8850D89D2c7e3324FC086Db4de9e016B56FD3; //mkt
    address private devFeeReceiver = 0x39B8850D89D2c7e3324FC086Db4de9e016B56FD3; //31 BuyBack
    address private teamFeeReceiver = 0x39B8850D89D2c7e3324FC086Db4de9e016B56FD3; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x0Fd7088f278E6798B2845689AABe6d710923343c;
