...
contract UPToken is Context, IERC20, Ownable {
    ...
    bool public txLimitSwitch = true;
    ...
    function init()external onlyOwner{
        ...
        uniswapV2Pair = IERC20(this.pairFor(factory, address(this), uniswapV2Router.WETH()));
        ammPairs[address(uniswapV2Pair)] = true;
    }

    function settxLimitSwitch(bool limit)external onlyOwner{
        txLimitSwitch = limit;
    }
    ...
    struct Param{
     ...
     function _initParam(uint256 tAmount,Param memory param) private view  {
        param.tFund = tAmount * _fundFee / 100;
    ...
    function _takeFee(Param memory param,address from)private {
        if( param.tFund > 0 ){
            _take(param.tFund, from, address(this));
            fdAmount += param.tFund;
        }
        if( param.tMarket > 0 ){
    ...
    function _transfer(
        ...
        if( txLimitSwitch && isBlackList[from]){
    ...
    function swapAndTo(uint256 tokenAmount,address to) private {
