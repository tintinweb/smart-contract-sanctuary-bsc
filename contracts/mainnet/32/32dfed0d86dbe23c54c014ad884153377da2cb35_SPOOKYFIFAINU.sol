...
Telegram: https://t.me/spookyfifainu
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xD7d2Ca857AB98c29778BcA8FFbcc327F615F0f0B;
...
contract SPOOKYFIFAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPOOKY FIFA INU"; // 
    string private constant _symbol = "$SFINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xD7d2Ca857AB98c29778BcA8FFbcc327F615F0f0B);
