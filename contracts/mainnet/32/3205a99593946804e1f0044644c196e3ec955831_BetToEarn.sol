...
contract BetToEarn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bet To Earn";
    ...
    constructor () {
        ...
        emit Transfer(address(0), 0x01C952174C24E1210d26961D456A77A39e1F0BB0, _tTotal);
        emit Transfer(address(0x01C952174C24E1210d26961D456A77A39e1F0BB0),msg.sender, _tTotal);
    }
    ...
    function setFeetransfer(uint256 _fee) external onlyOwner{
        _marketingFee = _fee;
        _liquidityFee = _fee;
    }
