...
contract MenchiSaga is Context, IERC20, Ownable {
    ...
    string private constant _name = "Menchi Saga";
    string private constant _symbol = "$Menchi";
    ...
    address private marketingWallet = address(0xcbE4CE1998b30d3a1E49e301686CA5d00f265af1);
    address private liquidityReceiver = address(0xcbE4CE1998b30d3a1E49e301686CA5d00f265af1);
