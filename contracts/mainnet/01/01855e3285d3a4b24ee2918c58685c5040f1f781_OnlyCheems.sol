...
contract OnlyCheems is IBEP20, Ownable {
    ...
    string constant _name = "Only Cheems";
    string constant _symbol = unicode"OCHEEMS";
    ...
    address private marketingWallet = 0xdbb16EBaF157dbebA53fEcC444cB3Ba6D86093fb;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 0, 1, 0);
    Fees public sellFees    = Fees(1, 0, 1, 0);
