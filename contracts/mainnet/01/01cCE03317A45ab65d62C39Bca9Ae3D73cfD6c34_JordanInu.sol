...
/**
 ...
 Jordan inu is here to set new trend in memecoin world!
 */
...
contract JordanInu is IERC20 {
    ...
    string constant _name = "Jordan Inu"; //TODO
    string constant _symbol = "$JINU"; //TODO
    ...
    address payable private _marketingWallet = payable(0xf2Cb5f13990cF5d22613C9bad16C55319A7dBDBF); //TODO
    address payable private _buybackWallet = payable(0x55F19F1ddE1C4bB5bF40bC1C7c16AA857d740048); //TODO
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0xe975120cdc090296fA3439ba93C2072267F73609] = true;      //TODO
        _isDividendExcluded[0xe975120cdc090296fA3439ba93C2072267F73609] = true;
