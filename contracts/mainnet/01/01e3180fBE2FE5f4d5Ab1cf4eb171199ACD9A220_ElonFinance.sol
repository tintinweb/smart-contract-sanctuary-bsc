...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x42d7213F3c29DA05C02813b044B7823dC02Fcc1B;
...
contract ElonFinance is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Elon Finance"; 
    string private constant _symbol = unicode"Elon Finance"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x42d7213F3c29DA05C02813b044B7823dC02Fcc1B), BNB_Tot);
            }
