...
contract CallawayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Callaway Inu";
    string private _symbol = "Callaway";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20f69Dd807955449CcE1465062138aa94f55dE44); 
    address payable public buyBackWalletAddress = payable(0x20f69Dd807955449CcE1465062138aa94f55dE44); 
