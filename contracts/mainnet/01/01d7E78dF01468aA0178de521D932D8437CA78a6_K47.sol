...
// if you find this, remember it will moon


// Telegram: https://t.me/K47Official
// Twitter : https://twitter.com/K47INUBSC
// Website : https://KalashnikovInu.com
...
library Address{
 ...
 contract K47 is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 1947000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 5841 * 10**9;
    uint256 public maxBuyLimit = 1947000 * 10**9;
    uint256 public maxSellLimit = 1947000 * 10**9;
    uint256 public maxWalletLimit = 1947000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xA17748e9fD72938EBf21A27C8816AfBB643c5825;
    address public developmentWallet = 0xA17748e9fD72938EBf21A27C8816AfBB643c5825;

    string private constant _name = "Kalashnikov Inu";
    string private constant _symbol = "K47";
    ...
    function multitransfer(address[] memory accounts, uint256[] memory amounts) external onlyOwner{
