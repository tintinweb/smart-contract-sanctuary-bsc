...
*/
 ...
 /** SHIKIGAMI INU - Following the IKIGAMI trend, Shikigami


    With the recent trend of IKIGAMI, we brought it in the crypto world 
...
contract SHIKIGAMIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIKIGAMI INU";
    string private constant _symbol = "$HIKIGAMI";
    ...
    address private marketingWallet = address(0x34e6ef36f03141eA84717ef0Cc6cd8f57f0829ee);
    address private liquidityReceiver = address(0x34e6ef36f03141eA84717ef0Cc6cd8f57f0829ee);
