...
🔔TG @TAKI_KOI
 ...
 📱Telegram group: https://t.me/TAKI_KOI
 
🔔 CA  0x0152a836Af8F6b1e7958098c303BaBAb3DA08C29
✅TOKENOMICS ✅
👍Total Supply: 10 Q
...
abstract contract ContextBEP20TAKIKOI {
...
contract OwnableBEP20TAKIKOI is ContextBEP20TAKIKOI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20TAKIKOI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20TAKIKOI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TheWaterfallLegend is ContextBEP20TAKIKOI, BEP20TAKIKOI, OwnableBEP20TAKIKOI {
    ...
    string private _name = 'The Waterfall Legend';
    string private _symbol = 'TAKIKOI';
