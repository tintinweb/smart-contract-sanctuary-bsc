...
// Telegram: https://t.me/CatcaptainBsc
...
contract CATCAPTAIN is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Cat Captain";
    string private constant _symbol = "CATCAPTAIN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 1 * 10**5 * 10**_decimals;
