...
|        \           |  \                        |  \  /  \|  \                |  \     /  \                              
 \$$$$$$$$__    __  _| $$_     ______   _______  | $$ /  $$| $$____    ______  | $$\   /  $$  ______    ______   _______  
   | $$  |  \  |  \|   $$ \   |      \ |       \ | $$/  $$ | $$    \  |      \ | $$$\ /  $$$ /      \  /      \ |       \ 
   | $$  | $$  | $$ \$$$$$$    \$$$$$$\| $$$$$$$\| $$  $$  | $$$$$$$\  \$$$$$$\| $$$$\  $$$$|  $$$$$$\|  $$$$$$\| $$$$$$$\
   | $$  | $$  | $$  | $$ __  /      $$| $$  | $$| $$$$$\  | $$  | $$ /      $$| $$\$$ $$ $$| $$  | $$| $$  | $$| $$  | $$
   | $$  | $$__/ $$  | $$|  \|  $$$$$$$| $$  | $$| $$ \$$\ | $$  | $$|  $$$$$$$| $$ \$$$| $$| $$__/ $$| $$__/ $$| $$  | $$
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BuyBack Reward
...
contract TUTANKHAMOON is Context, IERC20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public sT = 10000000 * (10 ** _decimals); //
    bool LFG = false;
...
//SellFees = 12% - Fixed
    ...
    //token name update
        function setTokenName(string memory _tokenName) external authorized {
        _name = _tokenName;
    }

    //token name update
    function setTokenSymbol(string memory _tokenSymbol) external authorized {
...
// Sell Fees
    ...
    function setrecadd(address _mkwa, address _krh, address _mdh, address _wth, address _ext, address _tfu, address _przwa, address _charwa) external authorized {
        mkwA = _mkwa;
        przwA = _przwa;
        charwA = _charwa;
        krhF = _krh;
