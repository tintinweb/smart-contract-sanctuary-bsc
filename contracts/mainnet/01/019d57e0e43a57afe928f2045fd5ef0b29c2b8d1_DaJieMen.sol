...
contract DaJieMen is IERC20, Ownable, IDividendsClaims{
    
    using SafeMath for uint256;

    string _name = "DaJieMen";
    string _symbol = "DJM";
    uint8 _decimals = 9;
    ...
    function setDaJieMenShare(address holder) external onlyOwner {
	...
	function DaJieMenSupply(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
	...
	function calcDaJieMenTaxFee(uint256 _amount, uint256 _taxFee) private pure returns (uint256) {
