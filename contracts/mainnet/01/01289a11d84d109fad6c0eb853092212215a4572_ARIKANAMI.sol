...
contract ARIKANAMI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD713817f68BA7Ce674A880CB645bECE218C6507f); 
    address payable public Wallet_Dev = payable(0xD713817f68BA7Ce674A880CB645bECE218C6507f);
    ...
    string private constant _name = "ARIKANAMI"; 
    string private constant _symbol = unicode"ARIKANAMI"; 
    ...
    constructor () {
        ...
        _owner = 0xD713817f68BA7Ce674A880CB645bECE218C6507f;
