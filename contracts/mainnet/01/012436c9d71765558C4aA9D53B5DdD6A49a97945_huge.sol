...
contract huge is Context, IERC20, Ownable {
    ...
    string private _name = "Milo Shib lnu";
    string private _symbol = "Milo Shib lnu";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8781508e3a32E4DeAF04AbC41ba1b424162051D1));
        marketingWalletAddress = payable(address(0x8781508e3a32E4DeAF04AbC41ba1b424162051D1));
