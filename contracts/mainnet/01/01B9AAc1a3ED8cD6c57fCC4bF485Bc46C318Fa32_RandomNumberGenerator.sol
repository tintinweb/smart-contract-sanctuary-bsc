...
// File: contracts/interfaces/IBashpLottery.sol

pragma solidity ^0.8.4;

interface IBashpLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Bash Protocol lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == bashLottery, "Only BashLottery");
    ...
    /**
     * @notice Set the address for the BashLottery
     * @param _bashLottery: address of the Bash Protocol lottery
     */
    function setLotteryAddress(address _bashLottery) external onlyOwner {
        bashLottery = _bashLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBashpLottery(bashLottery).viewCurrentLotteryId();
    }
}