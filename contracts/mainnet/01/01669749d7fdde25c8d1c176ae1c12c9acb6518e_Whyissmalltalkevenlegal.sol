...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7d91F1957498c4C17C02526aD606B45b54652391;
...
contract Whyissmalltalkevenlegal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Why is small talk even legal!?";
    string private _symbol = "WISTEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7d91F1957498c4C17C02526aD606B45b54652391); 
    address payable public teamWalletAddress = payable(0x3d28661Cc0460A6D2e84c153FADAbf1A67908406); 
