...
/**
   ...
   I make this #Casperinu to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/casperinubsc

   Great features:
   2% Fee auto add to the liquidity pool 
   4% Fee Marketing
   1% Fee Utility & Development

   Can We make #Casperinu 10000000X? 
*/
...
library Address{
 ...
 contract CasperInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x770287a8E93E8192BEA60b11488b1D913598bbaD;
    address public donationWallet = 0x770287a8E93E8192BEA60b11488b1D913598bbaD;

    string private constant _name = "Casper Inu";
    string private constant _symbol = "Casper Inu";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 0);
    Taxes public sellTaxes = Taxes(1, 3, 2, 0);
