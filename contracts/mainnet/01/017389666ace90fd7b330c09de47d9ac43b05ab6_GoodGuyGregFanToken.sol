...
/* 
🙂GoodGuyGreg🙂 GGG 🙂 Fan Token (BSC) 0% Tax Buy 🙂
⌛️Ready to catch  300x ATH🚀?
...
contract GoodGuyGregFanToken is Context, Bep20, Ownable {
    ...
    string private _name = 'GoodGuyGreg Fan Token';
    string private _symbol = 'GGG BSC';
