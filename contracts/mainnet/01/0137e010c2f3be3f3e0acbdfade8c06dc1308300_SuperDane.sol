...
contract SuperDane is Context, IERC20, Ownable {
    ...
    string private _name = "SuperDane";

    string private _symbol = "SuperDane";
    ...
    address payable public marketAddress = 0x94D59a59C4B552BeCf16c081f1588FD21C3cd0b9 ; //Marketing
