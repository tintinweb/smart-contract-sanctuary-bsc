...
contract SincereKishu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereKishu";
    string private _symbol = "KISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcCaB845C7920949357190f5906e607A72058988B);
    address payable public teamWalletAddress = payable(0xcCaB845C7920949357190f5906e607A72058988B);
