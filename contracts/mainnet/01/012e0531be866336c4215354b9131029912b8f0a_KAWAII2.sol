...
contract KAWAII2 is IBEP20, Auth {
    ...
    string constant _name = "KAWAII 2.0";
    string constant _symbol = "KAWAIIv2";
    ...
    uint256 public swapThreshold = _totalSupply / 40000 * 50; // 0.25%
    bool inSwap;
