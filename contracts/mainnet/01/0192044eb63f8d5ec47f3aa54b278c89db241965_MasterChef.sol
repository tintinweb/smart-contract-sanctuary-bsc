...
contract ElonGateToken is BEP20('EGSwap Token', 'ELONGATE') {
    using SafeMath for uint256;
...
contract MasterChef is Ownable {
    ...
    function transferElonGateTokenOwnerShip(address newOwner_) public onlyOwner { 
