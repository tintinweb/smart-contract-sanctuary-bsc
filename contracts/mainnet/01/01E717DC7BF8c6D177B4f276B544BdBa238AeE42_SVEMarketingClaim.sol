...
contract SVEMarketingClaim is Ownable, ReentrancyGuard {
    ...
    function setTgeTime(uint256 _tge) public onlyOwner {
        ...
        uint256 sveUnlockAtTge = (lock * TGE_RELEASE) / 100;
        lock -= sveUnlockAtTge;
        SVE.transfer(MARKETING_ADDRESS, sveUnlockAtTge);
    }
    ...
    function updateWallet(address _MARKETING_ADDRESS) external onlyOwner {
        require(_MARKETING_ADDRESS != address(0), "Error: address(0)");
