...
contract SF is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc397D82B52EA1eEd46405Aa9d9FF1f7510eFF96d); 
    address payable public Wallet_Dev = payable(0x36dbda886107F20E1b4cBBbf2E2fBC3b3f2f960A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Static Fire"; 
