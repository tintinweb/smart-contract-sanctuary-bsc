...
contract EB_Token_Presale is Ownable {
    ...
    function joinPresale(address _ref) public payable {
        ...
        if(EstimatedToken > 0) {
            EBToken.transfer(msg.sender,EstimatedToken);
    ...
    function getBalance() public view returns (uint) {
        return EBToken.balanceOf(address(this));
    }
	...
	function rescueToken() public onlyOwner {
		EBToken.transfer(msg.sender,EBToken.balanceOf(address(this)));
	}
