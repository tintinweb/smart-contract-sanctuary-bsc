...
contract RABBITCEO  is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 156685 * 10**9; //
    string private constant _name = "Rabbit CEO"; // 
    string private constant _symbol = unicode"RCEO"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xd5FCD0D62FFFDDD9C1fF850b91E1c433d95B94D9;
...
/*
    ...
    */
    ...
    function Blacklistaddwallet(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function issetmaxWallPercent_x100(uint256 maxWallPercent_x100) external onlyOwner() {
