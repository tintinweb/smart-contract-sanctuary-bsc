...
contract PlayerBook is Governance {
        ...
        public
    {
        ...
        if(_plyr[Code].laff == address(0))
        {
            ...
            if( _hasInvite[_plyr[Code].laff].mod(3) == 0)
            {
                _plyr[_plyr[Code].laff]._nodetype = _plyr[_plyr[Code].laff]._nodetype < 6?_plyr[_plyr[Code].laff]._nodetype+1:_plyr[_plyr[Code].laff]._nodetype;
            }
        }
        ...
        external
    {
        ...
        IERC20(lpToken).safeTransfer(msg.sender,reward);
