...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1Ff3d4b59936E45f5039512aebaB6FfE1Bc2b328));
...
contract GuGuawa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GuGuawa";
    string private _symbol = "GuGuawa";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1Ff3d4b59936E45f5039512aebaB6FfE1Bc2b328);
    address payable public teamWalletAddress = payable(0x1Ff3d4b59936E45f5039512aebaB6FfE1Bc2b328);
