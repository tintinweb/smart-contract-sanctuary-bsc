...
contract DirChian is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DirChian";
    string private _symbol = "DCB";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0xb806e9b29b5FC3f293F15529d804C271015b3B63); 
    address payable public teamWalletAddress = payable(0xb806e9b29b5FC3f293F15529d804C271015b3B63); 
