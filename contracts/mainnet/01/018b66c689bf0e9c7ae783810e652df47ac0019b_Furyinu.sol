...
contract Furyinu is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x7cF3C8F7585ea3Ce07EE1ecC2d2D84a278d90Fb6;
 
    string constant _name = "Fury inu";
    string constant _symbol = "FINU";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //1% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 1) / 100;  //1% max wallet
