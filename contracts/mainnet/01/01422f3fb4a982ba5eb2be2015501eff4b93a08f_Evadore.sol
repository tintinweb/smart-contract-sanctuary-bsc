...
contract Evadore is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8a9064cb0434DcAAa726716C157Ef421723ABE6C;
    ...
    function addAirdropBalance(uint256 _amount) public onlyOwner{
    ...
    function refundAirdropBalance() public onlyOwner{
    ...
    function sendAirdropWallets(address[] memory _wallets , uint256 _balance) public onlyOwner{
