 ...
 * 
 */
contract maiToken is IERC20 {
    
    using SafeMath for uint256;
    
    //mzi token, creator will take 2% fee
    address public feeTo = 0x0000000000000000000000000000000000000000;

    string public name = "MaoZai Token";
    string public symbol = "mzi";
    uint256 public decimals = 4;
    uint256 private _totalSupply = 0;
    
    //MZI Token supply max length
   uint256 private totalLength = 12;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 mzi
