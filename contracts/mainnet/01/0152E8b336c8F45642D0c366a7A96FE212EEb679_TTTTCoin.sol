...
contract TTTTCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3 * 10**4 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TESTTTTT";
    string private _symbol = "TESTTTTT";
    ...
    uint256 public _maxTxAmount = 21 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
