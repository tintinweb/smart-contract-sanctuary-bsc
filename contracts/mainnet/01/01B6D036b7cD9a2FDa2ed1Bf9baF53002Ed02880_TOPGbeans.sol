...
contract TOPGbeans is Context, Ownable{
    ...
    constructor() {
        ...
        MIN_DEPOSIT = 100000000000000000; // 0.01 BNB
        MIN_BAKE = 100000000000000000; // 0.01 BNB
    ...
    function dailyReward(address adr) public view returns (uint256) {
        ...
        if (referralsCount < 2) return 20000;
        if (referralsCount < 5) return (25000);
        if (referralsCount < 10) return (30000);
        if (referralsCount < 20) return (35000);
        if (referralsCount < 30) return (40000);
        if (referralsCount < 50) return (50000);
        return 60000;
    }
