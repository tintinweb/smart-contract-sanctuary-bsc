 ...
 *Submitted for verification at BscScan.com on 2022-10-13
*/
// Telegram : https://t.me/elonbtc20000
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe41cFAC5ee2c7e631C7998763ef984e545F6B4f3; // owner address
...
contract elon20000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON20000!!";
    string private _symbol = "E20000!!";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x772983aedfE5AEa6adDFfBC4381ac27c1b609fAE); // Marketing Address
    address payable public teamWalletAddress = payable(0x772983aedfE5AEa6adDFfBC4381ac27c1b609fAE); // Team Address
