...
/*
Telegram : https://t.me/bondeebsc
Website : https://bondee.net/
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC46238d8AcFDF09C9BeaE172DADAE46686fBDa3d; // owner address
...
contract BONDE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BONDEE";
    string private _symbol = "BONDE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC46238d8AcFDF09C9BeaE172DADAE46686fBDa3d); // Marketing Address
    address payable public teamWalletAddress = payable(0xC46238d8AcFDF09C9BeaE172DADAE46686fBDa3d); // Team Address
