...
contract MMV1 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MMV1';
    string private constant _symbol = '$MMV1';
    ...
    //DevWallets
    address public TeamWallet=payable(0x56Dd2DB812bd3b1d3F7E2Fc8B6028Ee86920C84C);
    address public walletTwo=payable(0xd9E6acD3CC19a586becF3b13828317068737cb07);
    //Testnet
