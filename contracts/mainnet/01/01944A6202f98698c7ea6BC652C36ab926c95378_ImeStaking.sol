...
/**
    ...
    @notice Implementation of IMe staking

    @dev Certain staking contracts should extend this contract
 */
    ...
    ImeStakingAccessControl
{
    ...
    uint256 private _incomePeriod;
    uint256 private _safeWithdrawalDuration;
    ...
    constructor(
        ...
        _safeWithdrawalDuration = withdrawnTokensLockDuration;
        ...
        onlyRole(STAKING_MANAGER_ROLE)
    {
        ...
        if (start != _startsAt) _startsAt = start;
        if (end != _endsAt) _endsAt = end;
    }
    ...
    function _tokenForDeferral() internal view override returns (IERC20) {
        return _token;
    }
    ...
    function _withdraw(
        ...
        if (mode == WithdrawalMode.Safe) {
            ...
            _token.transfer(user, amount - fee);
        }
...
/**
    ...
    @author IMe Group
    @notice Contract fragment, responsible for ERC20-token transfer deferral
 */
abstract contract TransferDeferrer is TimeContext {
    ...
    /**
        @dev Token to use
     */
    function _tokenForDeferral() internal view virtual returns (IERC20);

    /**
        @notice Schedule ERC20 token transfer
    ...
    /**
        ...
        @return amount Amount of transferred tokens
     */
        ...
        returns (uint256 amount)
    {
        ...
        _totalDeferredTokens -= amount;
        _tokenForDeferral().transfer(to, amount);
    }
