...
// Long Term NFT MoveToEarn Autostacking Game

// https://medium.com/@AmethystFinance
// https://amethystfinance.ga/
// https://twitter.com/AmethystFinanc2
// https://t.me/AmethystFinanc2
// https://www.tiktok.com/@Amethystfinance
...
contract AmethystFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "AmethystFinance";
    string public _symbol = "AM";
    ...
    uint256 public chiBankFee = 20;
    uint256 public nftJerryFee = 20;

    uint256 public sellFee = chiBankFee.add(nftJerryFee);
    ...
    address public chiBankReceiver;
    address public nftJerryReceiver;
    ...
    constructor() ERC20Detailed("AmethystFinance", "AM", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xe08B93Fe59fb9994B2A27DE943fC7aDA4Ea372bB;
        treasuryReceiver = 0xD4edD610992877237d27Db9e9931E5d7c049eb59;
        insuranceReceiver = 0xe33526D1990377f05FCaA2bCc8423CBAeD9d1757;
        chiBankReceiver = 0x252eee4a967bd3F2BBfEb5eF38be6c0073F8728a;
        nftJerryReceiver = 0x3462e3B7c185F186b343796cCD865D1cc4393500;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = chiBankFee.add(nftJerryFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(chiBankFee).add(nftJerryFee);
        ...
        (success, ) = payable(chiBankReceiver).call{
        value: currentBalance.mul(chiBankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");

        (success, ) = payable(nftJerryReceiver).call{
        value: currentBalance.mul(nftJerryFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _nftJerryReceiver,
        address _chiBankReceiver
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        insuranceReceiver = _insuranceReceiver;
        nftJerryReceiver = _nftJerryReceiver;
        chiBankReceiver = _chiBankReceiver;
