...
*/
/**
Telegram : https://t.me/spookybabyaptos
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA6fACC3eB2C53Dca9996A0D48cCd4c78dc7e554A; // owner address
...
contract SpookyBabyAptos is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpookyBabyAptos";
    string private _symbol = "$SBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6fACC3eB2C53Dca9996A0D48cCd4c78dc7e554A); // Marketing Address
    address payable public teamWalletAddress = payable(0xA6fACC3eB2C53Dca9996A0D48cCd4c78dc7e554A); // Team Address
