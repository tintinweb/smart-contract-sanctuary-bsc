...
contract TCat is Context, IERC20, Ownable {
    ...
    string private _name = "TomCat";
    string private _symbol = "TCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfd259C2b3c91b1ad04d5d864D1e769D4c7093720);
    address payable public buyBackWalletAddress = payable(0xfd259C2b3c91b1ad04d5d864D1e769D4c7093720);
