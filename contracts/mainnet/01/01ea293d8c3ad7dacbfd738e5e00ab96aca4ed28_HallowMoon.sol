...
Welcome to HallowMoon, land of the Monster Mooners! Our mission is simple, MOONING!

The most exciting part of this Halloween Token is the fact that it is no trick, 
ALL TREATS!!!!!!!! A full 2 percent of taxes have been dedicated to a treat wallet,
which is used to reward our holders with drawings, give aways and all kinds of awsome
treats direct to your wallet!


https://t.me/Hallow_Moon
...
contract HallowMoon is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'HallowMoon';
    ...
    //DevWallets
    address public Development=payable(0xB5Aa75c9ad9fe2E6B18B53b35457cBf09d5e8dd8);
    address public Development2=payable(0x647d64BE015c70356c87BAB07C45CB8526ee1222);
    address public Marketing=payable(0x07e022afa77d3A9B53ceE5d70C22B67dF403fA55);
    //MainNet
   ...
   //tracks auto generated ETH, useful for ticker etc
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(Development2).transfer((amount*25) / 100);
