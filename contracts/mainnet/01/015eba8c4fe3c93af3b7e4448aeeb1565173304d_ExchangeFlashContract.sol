...
contract ExchangeFlashContract is Ownable {
	...
	/* the balances (in INERY) of all exchange members */
	mapping(address => uint256) public balanceOfINERY;

	/* the whitelist of the Exchange Flash Contract */
    ...
    function deposit(address addr) external afterClosed {
