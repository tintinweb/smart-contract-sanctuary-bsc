     ...
     //   uint realPrice;
        ...
        if(dataTmp.priceType!=0){
            ...
            if (dataTmp.priceType ==1)
                dataTmp.realPrice = dataTmp.price.mul(dataTmp.rate).div(uint(dataTmp.decimals)).add(makeExs[makeID].floatVal);//1170e18 *6.71e18
            else if(dataTmp.priceType ==2)
                dataTmp.realPrice = dataTmp.price.mul(dataTmp.rate).div(uint(dataTmp.decimals)).mul(1e18+makeExs[makeID].floatVal).div(1e18);//
