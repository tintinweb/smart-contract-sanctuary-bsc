...
/*
Welcome to NUCLEUS!
    The Official Token for the Nucleus Token!

    Website: https://nucleus-token.com/
    Telegram Group: https://t.me/NucleusOfficial
    Twitter: https://twitter.com/NucleusToken
    
    What is Nucleus Project?
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18252af3865C5819aF163D07e7ee3ab63C1f6A37;
...
contract NucleusToken is Context, IERC20, Ownable {
    ...
    //_isCommunity = Can Buy at Launch
    //_isBlacklisted = Can not buy or sell
    mapping (address => bool) public _isCommunity;
    mapping (address => bool) public _isBlacklisted;
    
    //private launch - Only approved people can buy! 
    //need to add uniswapV2Pair address to community list in order to add liquidity 
    bool public onlyCommunity = true;
    
    address[] private _excluded;
    address payable private _promotionsWalletAddress = payable(0x18252af3865C5819aF163D07e7ee3ab63C1f6A37);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Nucleus";
    ...
    uint256 private _liqToPromoFraction = 0;
    ...
    //adding people to the Community approved list
    ...
    function _transfer(
        ...
        //limits the amount of tokens that each person can buy
