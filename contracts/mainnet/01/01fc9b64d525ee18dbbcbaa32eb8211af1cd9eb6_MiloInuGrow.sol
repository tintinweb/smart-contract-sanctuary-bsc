...
contract MiloInuGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiloInuGrow";
    string private constant _symbol = "MiloInuGrow";
    ...
    Taxes public taxes = Taxes(2,0,4,2);
    Taxes public sellTaxes = Taxes(2,0,4,2);
