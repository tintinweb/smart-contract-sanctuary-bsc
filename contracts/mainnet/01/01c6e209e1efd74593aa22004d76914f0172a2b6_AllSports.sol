...
/*
 https://discord.com/invite/F2nURHke9Q
All Sports X is blockchain dedicated to sports marketing, sports IP NFT asset trading, sports middle-tier infrastructure 
implementation and game application development.
At present, the development of a decentralized community has been completed and currently we 
are working on our sports blockchain. All Sports X will support all future Defi and NFT 
sports projects and will build towards a community Dao.
*/
...
contract AllSports is SOCDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SOCTeam;
    address private CharitySOC;
    ...
    string public override name = "All Sports";
    string public override symbol = "SOC";
    ...
    constructor(uint totalSupplyValue, address SOCTeamAddress, address CharitySOCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SOCTeam = SOCTeamAddress;
        CharitySOC = CharitySOCAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SOCTeam] =  totalSupply * 4 / 100;
        balances[CharitySOC] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SOCTeam pot
