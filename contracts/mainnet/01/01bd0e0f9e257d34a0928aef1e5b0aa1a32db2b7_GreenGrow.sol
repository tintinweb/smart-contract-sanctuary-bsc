...
contract GreenGrow is Context, IERC20, Ownable {
    ...
    string private _name = "GreenGrow";
    ...
    address payable public marketingWalletAddress = payable(0xb4B9ecbBDc1E6d6e120887DF56a694d0AE7a7EAb);
    address payable public teamWalletAddress = payable(0xF8E3dE68492DA31f83E13b4b9671986789bA35Af);
