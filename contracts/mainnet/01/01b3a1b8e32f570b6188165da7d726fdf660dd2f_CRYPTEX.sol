...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa64c4Bb77a5F5Fb4e8783cD9186F69b2A192FFde; // owner address
...
contract CRYPTEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CRYPTEX";
    string private _symbol = "CRYPTEX"; 
