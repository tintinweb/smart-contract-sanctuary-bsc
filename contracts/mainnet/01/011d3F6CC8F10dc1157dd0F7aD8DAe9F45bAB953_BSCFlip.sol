...
contract DividendDistributor {
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external onlyToken {
        ...
        emit DistributionCriteriaChanged(_minPeriod, _minDistribution);
    }
...
abstract contract Tradable is IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        if(
            ...
            !_isExcludedFromMaxBalance[to]  // is not excludedFromMaxBalance
        ) {
...
abstract contract Taxable is Ownable, Tradable {
    ...
    function setReceiverAddresses(address payable newMarketingAddress, address payable newDevAddress, address payable newTeamAddress) external onlyOwner() {
        require(newMarketingAddress != address(0x0));
        require(newDevAddress != address(0x0));
        require(newTeamAddress != address(0x0));
...
contract BSCFlip is Context, Ownable, Taxable {
    ...
    address payable _BdevAddress = payable(address(0x9AF4295d939482Cb293D5A4Fa395bAbC39C5E839));
    address payable _BmarketingAddress = payable(address(0x74dC4C095a3fb35298924b707B9d3CF77Ff7A4Bf));
    address payable _BteamAddress = payable(address(0x215e12Ac391E9D734f3C64cE96FE54e176AD9061));
