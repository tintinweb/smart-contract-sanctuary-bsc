...
contract USDTSeeds is Ownable {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1e18; // 5 USDT
	uint256[] public REFERRAL_PERCENTS 	= [1000, 200, 100, 75, 50, 50, 50, 25, 25, 25];
	uint256[] public SEED_PERCENTS 		= [500, 1000, 1500, 500, 300, 200, 100, 100, 100, 100];
	...
	function withdrawTokens(address tokenAddr) external onlyOwner returns(bool) {
		uint tokens_balance = IERC20(tokenAddr).balanceOf(tokenAddr);
