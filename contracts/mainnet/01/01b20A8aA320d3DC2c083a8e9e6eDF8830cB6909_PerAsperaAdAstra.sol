...
contract PerAsperaAdAstra is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Per aspera ad astra!";
    string private _symbol = "PAAA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7b335a0b419F47Fe6ddC8C05f975406e0E946042);
