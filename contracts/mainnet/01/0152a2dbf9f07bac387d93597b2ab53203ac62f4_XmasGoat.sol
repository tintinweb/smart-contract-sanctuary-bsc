...
contract XmasGoat is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 100000 * 10**_decimals; // 1% of sp
    uint256 public maxTxAmountSell = 100000 * 10**_decimals; // 1% of sp
    uint256 public maxWalletAmount = 200000 * 10**_decimals; // 2% of sp
    ...
    address payable public giftsAddress;
    address payable public wAddress;
    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "XmasGoat";
    ...
    constructor() {
        ...
        giftsAddress = payable(msg.sender);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 giftsFee = (remainingBalance * appliedRates.gifts) /
            (denominator - appliedRates.gifts);    
        devAddress.sendValue(devFee);
        treasuryAddress.sendValue(treasuryFee);
        charityAddress.sendValue(charityFee);
        giftsAddress.sendValue(giftsFee);
    }
    ...
    function setGiftsAddress(address payable _giftsAddress) external onlyOwner {
        giftsAddress = _giftsAddress;
    }
    ...
    function setBuyFees(
        ...
        buyRates.gifts = _gifts;
        buyRates.lp = _lp;
        buyRates.toSwap = _treasury + _dev + _charity + _gifts + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.gifts = _gifts;
        sellRates.lp = _lp;
        sellRates.toSwap = _treasury + _dev + _charity + _gifts + _lp;
    }
