...
contract InfernoSYToken is Context, InfernoSYECO, Ownable {
    ...
    string private _name = 'InfernoSeesYOU';
    string private _symbol = 'InfernoSY';
