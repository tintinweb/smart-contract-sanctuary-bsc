...
contract SuperSafuu is ERC20Detailed, Ownable {
    ...
    string public _name = "SuperSafuu";
    string public _symbol = "SSAFUU";
    ...
    constructor() ERC20Detailed("SuperSafuu", "SSAFUU", uint8(DECIMALS)) Ownable() {
