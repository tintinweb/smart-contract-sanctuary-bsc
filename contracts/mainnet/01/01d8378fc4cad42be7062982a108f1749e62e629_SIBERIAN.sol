...
/**
https://t.me/siberiansquid
https://siberiansquid.com
*/
...
pragma solidity ^0.6.12;
    ...
    contract SIBERIAN is Context, IERC20, Ownable {
        ...
        string private _name = 'Siberian Squid';
        string private _symbol = 'SIBSQUID';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x37bfe51125B6b69450E2713d3092ffF2F7F9c675, 'We can not exclude Uniswap router.');
        ...
        function _setMarketingFee(uint256 MarketingFee) external onlyOwner() {
            require(MarketingFee >= 7 && MarketingFee <= 50, 'MarketingFee should be in 7 - 50');
