...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd591B878575Fb1d80a62A31978585c3C89Eed3B0;
...
contract DefiRabbit is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x144B38eA1f9CAcC885CA14aad2c939791c67759B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DefiRabbit";
    string private _symbol = "Derab";
