 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/ElderRingBSC
 * 
 * 
 * Elder Ring token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract ElderRing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Elder Ring";
    string constant _symbol = "ELRING";
