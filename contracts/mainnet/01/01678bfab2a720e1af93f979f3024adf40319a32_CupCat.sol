...
contract CupCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe984dF2f14cd10C81269637f99e4fAD2d4Df3C71); // Marketing Address
        
    address payable public teamAddress =
        payable(0xf856C6e533987d686c80aA1b74c3A7e07EA0ce4e); // Team Address
        
    address payable public liquidityAddress =
        payable(0xf856C6e533987d686c80aA1b74c3A7e07EA0ce4e); // Liquidity Address
    ...
    string private constant _name = "CupCat";
    string private constant _symbol = "CupCat";
