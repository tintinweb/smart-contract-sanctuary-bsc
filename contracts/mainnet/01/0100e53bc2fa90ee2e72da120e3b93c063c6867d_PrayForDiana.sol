...
contract PrayForDiana is Context, IERC20, Ownable {
    ...
    string private constant _name = "PrayForDiana";
    string private constant _symbol = "PFDIANA";
