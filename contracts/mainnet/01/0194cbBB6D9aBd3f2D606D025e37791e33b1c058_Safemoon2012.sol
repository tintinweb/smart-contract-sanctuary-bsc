...
contract Safemoon2012 is Context, IERC20, Ownable {
    ...
    string private _name = "Safemoon 2012";
    string private _symbol = "S2k12";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x7741372CC1895605040BefA7c8983d01832b54F8);
    ...
    uint256 private constant _maxFees = 80;
    ...
    constructor() {
        ...
        _liquifyThreshhold = 2000 * 10**_decimals;
        _maxBalance = 80000 * 10**_decimals;
