...
Dory Inu did reach 10K Marketcap , as a dev I will never abandon a bullish name we are relaunching ( BABY DORY INU ) with 3BNB marketing budget , 
$BDORY will let you earn $BUSD while holding. Baby Dory Inu is different this is going to be huge not just a pump  and dump unlike others.
 Team has a experience and well organized. Marketing is already lined up. 

-3% Marketing
-2% Liquidity
-2% BUSD

Get ready to swim , just keep swimming!  https://t.me/BabyDoryInu
...
*/
    ...
    contract BabyDoryInu   is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyDoryInu";
        string private constant _symbol = "BDORY";
        ...
        address public constant MarketingWallet=0x51212C9e3137F9aD7Cab6AF7d03710D02d092B43; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AllowBUSDRewards(address[] calldata addresses) external onlyOwner {
