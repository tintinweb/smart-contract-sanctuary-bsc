...
contract JhonyDeepElonShibaDogeEatMcDonalds is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "JhonyDeepElonShibaDogeEatMcDonalds";
    string constant _symbol = "JDESDEMD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 6) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 12) / 100; 
    ...
    address public devFeeReceiver = 0x24C4dd351d97452f704F0B96a96176f7e6206CFF;
    address public buybackFeeReceiver = 0x24C4dd351d97452f704F0B96a96176f7e6206CFF;
