...
🐱CateCoin 2.0 is a decentralized cryptocurrency token built on Binance Smart Chain network. It was created with the community and investor in mind with the goal of literally landing on the moon. 🚀

🐱CateCoin will overpass the catcoin 2.0, This is a multi million project cap. Big marketing plan already in book. Let's hit the moon together.🌝
...
🟢 Based Dev
🟢 Moonshot x100
🟢 More influencers are lined up
🟢 Funds are SAFU!

𝖲𝗂𝗍 𝖻𝖺𝖼𝗄 𝖺𝗇𝖽 𝖾𝗇𝗃𝗈𝗒 𝟣𝟢𝗑 , 𝟣𝟢𝟢𝗑 
𝗉𝗋𝗈𝖿𝗂𝗍𝗌.. 𝖶𝖾'𝗅𝗅 𝖲𝗍𝖺𝗋𝗍 𝗌𝗈𝗈𝗇...☎️ 𝖲𝗍𝖺𝗒 𝖳𝗎𝗇𝖾𝖽! 🚀 𝖩𝖮𝖨𝖭 𝖴𝖲!!!

📱Socials ⬇️: 
💌 Telegram Chat:
https://t.me/catecointwopointzero
**/
...
contract catecoin2 is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 20; // 5% of supply
    ...
    string private constant _name = "CateCoin2.0";
    string private constant _symbol = "CATE2.0";
