...
// File: contracts/WildGamesWildFive.sol
...
contract WildGamesWildFive is Ownable {
    ...
    constructor()   {
        ...
        paymentToken = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd);

        wildGamesVault = 0xddF056C6C9907a29C3145B8C6e6924F9759103E4;
        amountGamesUntilExtraGame = 100;

        createGame(1000000000000000000); //$100
        ...
        createGame(500000000000000000000000); //$500000
        }
    ...
    function getTokenBalanceContract() external view returns(uint) {
     ...
     function createGame(uint256 _betValue) public onlyOwner {
        ...
        AllGames.push(Game( playersArr, 0, 0 ,0, emptyArr,_betValue, playersNotesArr ));
    ...
    function pushPlayerIn(address _player, uint _index, uint256 _playerNote) internal {
        ...
        currentGame.playerNotes[i] = _playerNote ;
                ...
                break;
                    ...
                    // revert("dynamic value, sorry array full of players");
    }
 ...
 ////////////////////////////////////////////
    ...
    function extraGameDraw(uint _indexGame) internal   {
        ...
        AllWinners.push(WinnerLog( currentGame.losers[winnerIndex], currentGame.betValue, currentGame.extraGameFundBalance  ));
