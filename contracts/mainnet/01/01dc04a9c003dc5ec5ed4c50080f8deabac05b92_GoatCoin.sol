...
Let's say that's gonna be the GOAT token, fresh out the swimming pool! 🐐

Telegram: https://t.me/GoatCoinBSCPortal

Webiste: https://goatcoinbsc.com/
...
contract GoatCoin is Ownable, IBEP20 {
    ...
    string constant _name = "GoatCoin";
    ...
    uint256 public marketingFee = 99;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xAab5a5b8b6fff074dA9A6f387BE98D7306415FC6;
        marketingWallet = 0xAab5a5b8b6fff074dA9A6f387BE98D7306415FC6;

        totalFee = 10;
        totalFeeIfSelling = 20;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 15);
        require (newTotalSell < 20);
