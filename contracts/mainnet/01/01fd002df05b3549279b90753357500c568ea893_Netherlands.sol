...
Who’s will win? Netherlands!

Join us and become supporters of Netherlands

Netherlands 🇳🇱 dedicated for Netherlands 🇳🇱 Football Team on World Cup!

#Netherlands

https://t.me/Netherlandsportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1dFA1534065F1ABc397306DaBd585DAd420DfaED; // owner address
...
contract Netherlands is Context, IERC20, Ownable {
    ...
    string private _symbol = " NED ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1dFA1534065F1ABc397306DaBd585DAd420DfaED); // Marketing Address
    address payable public teamWalletAddress = payable(0x1dFA1534065F1ABc397306DaBd585DAd420DfaED); // Team Address
