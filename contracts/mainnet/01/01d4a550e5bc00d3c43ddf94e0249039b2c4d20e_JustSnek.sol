...
contract JustSnek is Context, IERC20, Ownable {
   ...
   string private _name = "Just Snek";
   string private _symbol = "JustSnek";
   uint8 private _decimals = 9;
 
   address payable public marketingWalletAddress = payable(0x37800C02C78b8459652500CdD8a4375dB9DA0407); // Marketing Address
   address payable public DevelopmentWalletAddress = payable(0x37800C02C78b8459652500CdD8a4375dB9DA0407); // Development Address
