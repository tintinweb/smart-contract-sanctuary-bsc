    ...
    UUPSUpgradeable
{
    struct Fees {
        ...
        uint256 chestFeesPerTenThousand;
        uint256 ksosFeesPerTenThousand;
    }
    ...
    mapping(address => bool) private _isExcludedFromBuyFees;
    ...
    address private _chestWallet;
    address private _ksosWallet;
    ...
    uint256 private _maxSellTransaction;

    mapping(address => bool) private _allowTokenTransferDespiteTradingDisabled;
    ...
    event ChestWalletUpdated(
        address indexed previousWallet,
        address indexed newWallet
    );
    event KsosWalletUpdated(
        address indexed previousWallet,
        address indexed newWallet
    );
    ...
    event ChestBuyFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event KsosBuyFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event BuyFeesUpdated(
        ...
        uint256 previousChestFeesPerTenThousand,
        uint256 newChestFeesPerTenThousand,
        uint256 previousKsosFeesPerTenThousand,
        uint256 newKsosFeesPerTenThousand
    );
    ...
    event ChestSellFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event KsosSellFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    ...
    event ExcludedFromBuyFees(address indexed account, bool isExcluded);
    event ExcludedFromSwap(address indexed account, bool isExcluded);
    event AllowedTokenTransferDespiteTradingDisabled(
    ...
    function initialize(
        ...
        address chestWallet_,
        address ksosWallet_
    ) public initializer {
        __ERC20_init("PPToken", "PPTK");
        __Ownable_init();
        ...
        _chestWallet = chestWallet_;
        _ksosWallet = ksosWallet_;
        ...
        _swapThreshold = 100_000 * 10**decimals(); // 100K $PPTK ( 0.1% )

        // Buy fees
        _buyFees.liquidityFeesPerTenThousand = 200; // 2.00%
        _buyFees.teamFeesPerTenThousand = 200; // 2.00%
        _buyFees.marketingFeesPerTenThousand = 200; // 2.00%
        _buyFees.chestFeesPerTenThousand = 300; // 3.00%
        _buyFees.ksosFeesPerTenThousand = 100; // 1.00%

        // Sell fees
        _sellFees.liquidityFeesPerTenThousand = 200; // 2.00%
        _sellFees.teamFeesPerTenThousand = 200; // 2.00%
        _sellFees.marketingFeesPerTenThousand = 200; // 2.00%
        _sellFees.chestFeesPerTenThousand = 300; // 3.00%
        _sellFees.ksosFeesPerTenThousand = 100; // 1.00%

        _mint(owner(), 100_000_000 * 10**decimals()); // 100M $PPTK
    }
    ...
    function maxSellTransaction() external view returns (uint256) {
        return _maxSellTransaction;
    }
    ...
    function isExcludedFromBuyFees(address account)
        external
        view
        returns (bool)
    {
        return _isExcludedFromBuyFees[account];
    }
        ...
        )
    {
        return (
            ...
            _buyFees.chestFeesPerTenThousand,
            _buyFees.ksosFeesPerTenThousand,
            _totalBuyFees()
        );
    }
        ...
        )
    {
        return (
            ...
            _sellFees.chestFeesPerTenThousand,
            _sellFees.ksosFeesPerTenThousand,
            _totalSellFees()
        );
    }
    ...
    function chestWallet() external view returns (address) {
        return _chestWallet;
    }

    function ksosWallet() external view returns (address) {
        return _ksosWallet;
    }
    ...
    function enableTrading(bool isEnabled) external onlyOwner {
        require(
            ...
            "PPToken: Trading enabled is already the value of 'isEnabled'"
        );
    ...
    function enableTakeFees(bool isEnabled) external onlyOwner {
        require(
            ...
            "PPToken: Take fees enabled is already the value of 'isEnabled'"
        );
    ...
    function enableSwap(bool isEnabled) external onlyOwner {
        require(
            ...
            "PPToken: Swap enabled is already the value of 'isEnabled'"
        );
    ...
    function updateUniswapV2Router(address router_) external onlyOwner {
        require(
            router_ != _router,
            "PPToken: The router already has that address"
        );

        address previousRouter = _router;
        IUniswapV2Router02 routerObject = IUniswapV2Router02(router_);
        ...
        emit UniswapV2RouterUpdated(previousRouter, router_);
    }

    function updateTeamWallet(address payable newWallet) external onlyOwner {
        require(
            newWallet != _teamWallet,
            "PPToken: The team wallet already has that address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: The marketing wallet already has that address"
        );
    ...
    function updateChestWallet(address payable newWallet) external onlyOwner {
        require(
            newWallet != _chestWallet,
            "PPToken: The chest wallet already has that address"
        );

        address previousWallet = _chestWallet;
        _chestWallet = newWallet;

        emit ChestWalletUpdated(previousWallet, newWallet);
    }

    function updateKsosWallet(address payable newWallet) external onlyOwner {
        require(
            newWallet != _ksosWallet,
            "PPToken: The ksos wallet already has that address"
        );

        address previousWallet = _ksosWallet;
        _ksosWallet = newWallet;

        emit KsosWalletUpdated(previousWallet, newWallet);
    }
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: Account is already the value of 'excluded'"
        );
    ...
    function excludeFromBuyFees(address account, bool excluded)
        external
        onlyOwner
    {
        require(
            _isExcludedFromBuyFees[account] != excluded,
            "PPToken: Account is already the value of 'excluded'"
        );

        _isExcludedFromBuyFees[account] = excluded;

        emit ExcludedFromBuyFees(account, excluded);
    }

    function excludeFromSwap(address account, bool excluded)
        external
        onlyOwner
    {
        require(
    ...
    function updateBuyFees(
        ...
        require(
            liquidityFeesPerTenThousand !=
                ...
                _buyFees.marketingFeesPerTenThousand ||
                chestFeesPerTenThousand != _buyFees.chestFeesPerTenThousand ||
                ksosFeesPerTenThousand != _buyFees.ksosFeesPerTenThousand,
            "PPToken: Buy fees has already the same values"
        );
        ...
        uint256 previousChestFeesPerTenThousand = _buyFees
            .chestFeesPerTenThousand;
        _buyFees.chestFeesPerTenThousand = chestFeesPerTenThousand;

        uint256 previousKsosFeesPerTenThousand = _buyFees
            .ksosFeesPerTenThousand;
        _buyFees.ksosFeesPerTenThousand = ksosFeesPerTenThousand;
        ...
        emit BuyFeesUpdated(
            ...
            marketingFeesPerTenThousand,
            previousChestFeesPerTenThousand,
            chestFeesPerTenThousand,
            previousKsosFeesPerTenThousand,
            ksosFeesPerTenThousand
        );
    }
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: Liquidity buy fees has already the same value"
        );
    ...
    function updateTeamBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "PPToken: Team buy fees has already the same value"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: Marketing buy fees has already the same value"
        );
    ...
    function updateChestBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            feesPerTenThousand != _buyFees.chestFeesPerTenThousand,
            "PPToken: Chest buy fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _buyFees.chestFeesPerTenThousand;
        _buyFees.chestFeesPerTenThousand = feesPerTenThousand;

        emit ChestBuyFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }

    function updateKsosBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            feesPerTenThousand != _buyFees.ksosFeesPerTenThousand,
            "PPToken: ksos buy fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _buyFees.ksosFeesPerTenThousand;
        _buyFees.ksosFeesPerTenThousand = feesPerTenThousand;

        emit KsosBuyFeesUpdated(previousfeesPerTenThousand, feesPerTenThousand);
    }
    ...
    function updateSellFees(
        ...
        require(
            liquidityFeesPerTenThousand !=
                ...
                marketingFeesPerTenThousand !=
                _sellFees.marketingFeesPerTenThousand ||
                chestFeesPerTenThousand != _sellFees.chestFeesPerTenThousand ||
                ksosFeesPerTenThousand != _sellFees.ksosFeesPerTenThousand,
            "PPToken: Sell fees has already the same values"
        );
        ...
        uint256 previousChestFeesPerTenThousand = _sellFees
            .chestFeesPerTenThousand;
        _sellFees.chestFeesPerTenThousand = chestFeesPerTenThousand;

        uint256 previousKsosFeesPerTenThousand = _sellFees
            .ksosFeesPerTenThousand;
        _sellFees.ksosFeesPerTenThousand = ksosFeesPerTenThousand;
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: Liquidity sell fees has already the same value"
        );
    ...
    function updateTeamSellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "PPToken: Team sell fees has already the same value"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "PPToken: Marketing sell fees has already the same value"
        );
    ...
    function updateChestSellFees(uint256 feesPerTenThousand)
        external
        onlyOwner
    {
        require(
            feesPerTenThousand != _sellFees.chestFeesPerTenThousand,
            "PPToken: Chest sell fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _sellFees.chestFeesPerTenThousand;
        _sellFees.chestFeesPerTenThousand = feesPerTenThousand;

        emit ChestSellFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }

    function updateKsosSellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            feesPerTenThousand != _sellFees.ksosFeesPerTenThousand,
            "PPToken: Ksos sell fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _sellFees.ksosFeesPerTenThousand;
        _sellFees.ksosFeesPerTenThousand = feesPerTenThousand;

        emit KsosSellFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }

    function updateAllowTokenTransferDespiteTradingDisabled(
        address account,
        bool allowed
    ) external onlyOwner {
        require(
            _allowTokenTransferDespiteTradingDisabled[account] != allowed,
            "PPToken: Account is already the value of 'allowed'"
        );

        _allowTokenTransferDespiteTradingDisabled[account] = allowed;

        emit AllowedTokenTransferDespiteTradingDisabled(account, allowed);
    }
    ...
    function manualSwapSendFeesAndLiquify(
        ...
        uint256 chestFeesPerTenThousand,
        uint256 ksosFeesPerTenThousand
    ) external onlyOwner swapping {
        uint256 totalFeesPerTenThousand = liquidityFeesPerTenThousand +
            teamFeesPerTenThousand +
            marketingFeesPerTenThousand +
            chestFeesPerTenThousand +
            ksosFeesPerTenThousand;
        ...
        uint256 chestEthAmount = (ethAmount * chestFeesPerTenThousand) /
            totalFeesPerTenThousand;
        _sendFeesToWallet(_chestWallet, chestEthAmount);

        uint256 ksosEthBalance = (ethAmount * ksosFeesPerTenThousand) /
            totalFeesPerTenThousand;
        _sendFeesToWallet(_ksosWallet, ksosEthBalance);
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "PPToken: Automated market maker pair is already set to that value"
        );
        _isAutomatedMarketMakerPairs[newPair] = value;
    ...
    function _transfer(
        ...
        require(
            sender == owner() ||
                _allowTokenTransferDespiteTradingDisabled[sender] ||
                _tradingEnabled,
            "PPToken: Trading is not enabled"
        );
        require(
            sender != address(0),
            "PPToken: Transfer from the zero address"
        );
        require(
            recipient != address(0),
            "PPToken: Transfer to the zero address"
        );
        require(amount > 0, "PPToken: Transfer zero token");
        require(
            !_isBlacklisted[sender] && !_isBlacklisted[recipient],
            "PPToken: Blacklisted address"
        );

        _isBuying = _isAutomatedMarketMakerPairs[sender];
        _isSelling = _isAutomatedMarketMakerPairs[recipient];
    ...
    function _customTransfer(
        ...
        require(
            !(_isSelling && amount > _maxSellTransaction),
            "PPToken: Can't sell more than max sell transaction"
        );
        ...
        returns (bool)
    {
        return
            ...
            sender == _chestWallet ||
            recipient == _chestWallet ||
            sender == _ksosWallet ||
            recipient == _ksosWallet;
    }
        ...
        returns (bool)
    {
        return
            ...
            (!_isBuying || !_isExcludedFromBuyFees[recipient]);
    }

    function _shouldSwap(address sender, address recipient)
        private
        view
        returns (bool)
    {
        return
            ...
            !_isExcludedFromSwap[sender] &&
            !_isExcludedFromSwap[recipient];
    }
