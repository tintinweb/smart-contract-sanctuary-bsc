...
The main Goal of NPCBack is to support and earn NPC Coin.




TG: https://t.me/NPCBack
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x86D6faDB5F7A0c069fB50F998e120835CaE15A54);
...
contract NPCBack is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NPCBack";
    string constant _symbol = "NPCB";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x86D6faDB5F7A0c069fB50F998e120835CaE15A54;
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0x80ff1862bEb57983569b325318c232717d7B1070;
        marketingWallet = 0x2788A0FbD5b22A64dC8e889599DbB2B7b514E5b3;
        devWallet = 0x80ff1862bEb57983569b325318c232717d7B1070;
