...
/*
  Social2Earn (STOE Token)
  #STOE, the next generation social media platform connected to
  the blockchain, decentralized and developed by the community
  Website: social2earn.org
  DApp: stoe.social2earn.org
*/
...
contract Social2Earn is Context, IERC20, Ownable {
    ...
    string private _name = "Social2Earn";
    string private _symbol = "STOE";
    ...
    address public charityWallet = 0x22F49A8c826054f1f29027dD51CA3B1A38833c2e;
    ...
    uint256 public numTokensSellToAddToLiquidity = 7770000 * 10**9;
    uint256 public _maxTxAmount = 777000000 * 10**9;
