...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private _maxSupply=750000000*10**18;
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(_totalSupply<=_maxSupply,"Amount exceed Maximum Supply");
...
contract RewardToken is BEP20('BERRIES Reward Token', 'BRT') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterBuilder).
    function mint(address _to, uint256 _amount) public onlyOwner {
