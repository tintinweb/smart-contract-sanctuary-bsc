...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xA8B3ec291B7f54a8b5A914167378bd3DC7524279;//fund address
...
contract TwitterComplaintHotlineOperator is Token {
    constructor() Token(
        ...
        10000000000000000000000,//num
    
        address(0xA8B3ec291B7f54a8b5A914167378bd3DC7524279),//fund address
    
        address(0xA8B3ec291B7f54a8b5A914167378bd3DC7524279)//dev address
    ){
