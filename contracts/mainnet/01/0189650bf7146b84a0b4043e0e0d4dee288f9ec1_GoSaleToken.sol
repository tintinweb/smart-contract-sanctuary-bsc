...
contract GoSaleToken is BEPDetailed, BEP20 {
  ...
  constructor() BEPDetailed("Go Sale", "GOSA", 18) {
    ...
    marketingWallet = 0x4cB0081951299e6C42c1DD21d19aebD6B398D1A8;
  ...
  function setTaxes(uint8 _buyTax, uint8 _sellTax) external onlyOwner {
    ...
    require(_sellTax <= 3);
     buyTax = _buyTax;
    sellTax = _sellTax;
    emit changeTax(_buyTax,_sellTax);
  }

  function getTaxes() external view returns (uint8 _buyTax, uint8 _sellTax) {
