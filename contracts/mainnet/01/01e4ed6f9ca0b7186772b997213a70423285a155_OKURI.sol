...
contract OKURI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = unicode"Okuri Inu 送 り 犬";
    string private constant _symbol = unicode"OKURI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0x8C6135625df0AF06E5DE02d27E459124F196Af56);
    address payable private MarketingWallet = payable(0x173FAce7529dE5A03E58b7f43b9E35Eff30C8C80);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (limitInEffect ) {require(tx.gasprice <= gas);}
