...
contract  DogeKwonInu is Context, IERC20, Ownable {
    ...
    string private _name = "DogeKwon Inu";
    string private _symbol = "DK INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6334aa23BaF4dBac28eaAC81d3a5a62Dc5C7D341); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6334aa23BaF4dBac28eaAC81d3a5a62Dc5C7D341); // BuyBack Address
