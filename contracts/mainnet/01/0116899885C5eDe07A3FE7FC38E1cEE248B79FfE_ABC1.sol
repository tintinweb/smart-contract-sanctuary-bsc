...
contract ABC1 is Context, IERC20, Ownable {
    ...
    string private _name = "ABC1";
    string private _symbol = "A1";
    ...
    uint256 private _burnFee = _buyBurnFee;
    uint256 private _previousBurn= _burnFee;
 
    address public  advertisementWallet = 0xC097916139205303E282fA1416B4DB96108969D7;
    ...
    uint256 public _maxTxAmount = _tTotal.mul(10).div(10**3); // max transaction amount is 1% supply
    ...
    function setTaxFeePercent(uint256 buyTaxFee, uint256 sellTaxFee) external onlyOwner() {
     ...
     function setBurnFee(uint256 buyBurnFee, uint256 sellBurnFee) external onlyOwner() {
