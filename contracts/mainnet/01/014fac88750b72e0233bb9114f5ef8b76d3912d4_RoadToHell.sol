...
// File: contracts/Road2Hell.sol
/*
By Set for Daywalker

*/

pragma solidity ^0.8.4;

contract RoadToHell is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC2981, ClampedRandomizer {
    constructor() 
        ERC721("Road To Hell", "RTH") ClampedRandomizer(maxSupply) {
    ...
    uint maxSupply = 100;
    uint maxPerTx = 10;
    uint maxPerWallet = 100;
    uint price = 0;
    address public royaltyAddress=0x1c8dF4Ec28B6b7aa82feE2A7acCc53458f83CB48;
    uint96 public royalty=1000;
    string public baseURI = "ipfs://bafybeiglyw23hdrgsp7qomq4o5dol6a33gx5gkvslerxjfafiksz5oc3fe/";
    string public unrevealedURI = "ipfs://bafybeidkzrkwa5nw2ugapvrje5b6jk43oo7ugl4xoap33th7nejynd6ggi/hidden.json";
    mapping(address => uint) public publicCount;
    mapping(uint => bool) private _isRevealed;
    mapping(uint => bool) private _isMinted;

     function mint (address mintAddress, uint256 amount) public payable  onlyOwner {
      uint supply = totalSupply();
        require(supply + amount <= maxSupply, "No more album jackets");
        ...
        publicCount[mintAddress] +=amount;
      }
