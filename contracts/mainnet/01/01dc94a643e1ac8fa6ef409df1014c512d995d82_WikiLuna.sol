...
contract WikiLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Luna";
    string private _symbol = "WKL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x692C21F33Fe5E647Ffc4A5775Db44E3b86673703); 
    address payable public DevelopmentWalletAddress = payable(0xc809010dECf82d7f997542028a20a5E9ed4b6515); 
