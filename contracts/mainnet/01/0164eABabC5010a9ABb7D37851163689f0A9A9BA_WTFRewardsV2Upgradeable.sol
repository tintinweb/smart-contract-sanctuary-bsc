    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    ...
    function claimReward() external returns (uint256) {
        ...
        // V1 user amount as registered here in V2
        User storage userV1 = usersV1[msg.sender];

        /*
          The amount based on which we pay to V1 users is fixed after registration. This is to protect against the following
        ...
        */
        ...
        uint256 totalReward = rewardV1 + rewardV2;
