...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd15DcD0D1a9Cf835Ef72B750880D131106A1B8e2; // owner address
...
contract GoDBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoDBunny";
    string private _symbol = "GoDBunny";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd15DcD0D1a9Cf835Ef72B750880D131106A1B8e2); // Marketing Address
    address payable public teamWalletAddress = payable(0xd15DcD0D1a9Cf835Ef72B750880D131106A1B8e2); // Team Address
