...
//Website: https://www.infinitasx.com/
//Telegram: https://t.me/infinitasx
//Twitter: https://twitter.com/X_Infinitas
...
contract InfinitasX is ERC20, Ownable {
    ...
    address public ecosystemWalletAddress = 0x3D7f870F8d2693fa3BbDCA05895D95e4Ec0b1e0b;
    ...
    constructor(address operator) ERC20("InfinitasX" , "IFX") Ownable(operator) {
    ...
    function antiBotAddress(address account, bool value) external onlyOwner{
        antiBot[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!antiBot[from] && !antiBot[to], 'antiBot address');
        ...
        if( swapEnabled &&
            ...
            swapAndSendToAll(contractTokenBalance);
