...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x708844286B785D6Ddd06dBaC873C13F2eb384052; // owner address
...
contract Shibro is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBRO";
    string private _symbol = "$SHIBRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x708844286B785D6Ddd06dBaC873C13F2eb384052); // Marketing Address
    address payable public teamWalletAddress = payable(0x708844286B785D6Ddd06dBaC873C13F2eb384052); // Team Address
