...
/**  
TG: https://t.me/ak47inuexclamation
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6b6b3CCA0b9abDed4072E65E1093e2e2635eBB82; // owner address
...
contract AK47INU is Context, IERC20, Ownable {
    ...
    string private _name = "AK47INU!!!";
    string private _symbol = "AK47INU!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b6b3CCA0b9abDed4072E65E1093e2e2635eBB82); // Marketing Address
    address payable public teamWalletAddress = payable(0x6b6b3CCA0b9abDed4072E65E1093e2e2635eBB82); // Team Address
