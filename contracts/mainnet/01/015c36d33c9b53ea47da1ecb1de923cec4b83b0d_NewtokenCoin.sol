...
contract NewtokenCoin is Context, IERC20, Ownable {
    ...
    string private _name = "KuiYinCoin";
    ...
    function KuiYinCoinTxSetting(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function KuiYinCoinAmountSetting(uint256 maxWallPercent) external onlyOwner {
    ...
    function getKuiYinCoinFees() public view returns (uint256) {
	...
	function AutoKuiYinCoinCount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
