...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Fable NFT';
    ...
    function DeployTheArt(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function ArtTransactionStatus(address account) public view returns (bool) {
...
contract NFTFabelContract is BaseToken {
