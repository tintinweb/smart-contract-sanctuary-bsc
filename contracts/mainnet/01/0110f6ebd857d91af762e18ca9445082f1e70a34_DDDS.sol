...
contract DDDS is ERC20, Ownable {
    ...
    function setaddLiquManege(address _addr) public onlyOwner {
        lpManager = _addr;
 ...
 function _getTradeType(address _sender, address _recipient)
    ...
    function swapLPRewardToken(uint256 _amount) private {
       super._transfer(address(this), address(dividendTracker),_amount);  
    }
