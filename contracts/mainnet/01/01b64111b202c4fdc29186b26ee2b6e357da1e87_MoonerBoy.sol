...
contract MoonerBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monerboy";
    string private _symbol = "Moonerboy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7aFA2e680CDE1DFBC855d0D04e4Caf862c894d0); 
    address payable public buyBackWalletAddress = payable(0xB7aFA2e680CDE1DFBC855d0D04e4Caf862c894d0); 
    ...
    uint256 public _walletMax = 2 * 10**13 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 2 * 10**10 * 10**9; 
    ...
    function sniperAddress(address account, bool newValue) public onlyOwner {
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax, uint256 feeDenomintor) external onlyOwner() {
        _liquidityFee = newLiquidityTax;
        _marketingFee = newMarketingTax;
        _buyBackFee = newBuyBackTax;
        _extraFeeOnSell = feeDenomintor;
