...
contract MINIDOGEKILLER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniDogeKiller";
    string private _symbol = "MiniDogeKiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01b830223F7f12c946E06A464FfaE8239bE1a792); 
    address payable public buyBackWalletAddress = payable(0x44eF10685c4faC6b07a5FD81ACeDF955b64B41e1); 
    ...
    uint256 private minimumTokensBeforeSwap = 4000000000000 * 10**9; 
