...
interface StarshipDogeDeployer {
...
contract StarshipDoge is StarshipDogeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private StarshipDogeTeam;
    address private CharityStarshipDoge;
    ...
    string public override name = "StarshipDoge";
    string public override symbol = "StarshipDoge";
    ...
    constructor(uint totalSupplyValue, address StarshipDogeTeamAddress, address CharityStarshipDogeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        StarshipDogeTeam = StarshipDogeTeamAddress;
        CharityStarshipDoge = CharityStarshipDogeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[StarshipDogeTeam] =  totalSupply * 4 / 100;
        balances[CharityStarshipDoge] = totalSupply * 4 / 100;
