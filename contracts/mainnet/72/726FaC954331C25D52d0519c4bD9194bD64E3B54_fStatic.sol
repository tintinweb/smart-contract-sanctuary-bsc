...
contract fStatic is ERC20Burnable, AccessControlEnumerable, IMintableToken {
	bytes32 public constant minterRole = keccak256('minterrole');

	/**
	 * @notice Constructs the fStatic ERC-20 contract.
	 */
	constructor() ERC20('fStatic', 'fStatic') {
