...
contract XinJiFei is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x627a2196b244857E40c4e5d1D73BB48d511Bf2B6;
    ...
    constructor(address receiveAddress) public ERC20("XinJiFei", "XinJiFei") {
        ...
        */
        _mint(address(receiveAddress), 10000000000000 * (10**18));
    }
