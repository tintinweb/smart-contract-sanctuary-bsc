...
contract YeetInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x01d21E2F68B78c7E63646937ba9bFa7a09e591fE); 
    address payable public Wallet_Dev = payable(0x1bAfBC811b9eD610faC2Ad01c8272fa655637aB1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x47aD873868FD5e0fd548C08E0Ae1eE43f4A1902A); 
    ...
    string private constant _name = "Yeet Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x47aD873868FD5e0fd548C08E0Ae1eE43f4A1902A;
...
function blackList(address _user) public onlyOwner
  {
   ...
   function removeFromBlacklist(address _user) public onlyOwner{
    ...
    function _transfer(
     ...
     require(isBlacklisted[to], "Your Wallet is blacklisted"); 
