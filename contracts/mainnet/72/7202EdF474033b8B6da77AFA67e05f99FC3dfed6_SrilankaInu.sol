...
/**
*Srilanka Inu - $Rupee
 💱 5% BUSD rewards to each holders and for poor people 💸

 ✅NO DEV WALLET
 ✅LP GOT LOCKED
 ✅Ongoing Initial Audit by TechRate
 ✅Mem token with Utilities : LankanSwap
 ✅Poor marketing & Promos
 💹Trading friendly 5% Tax for BUSD rewards
 💰5% BUSD rewards
 *Telegram: https://t.me/srilankainu
 *Website: http://srilankainu.space
 *Twitter:  https://twitter.com/srilankainu
*/
...
contract SrilankaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Srilanka Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Rupee";
