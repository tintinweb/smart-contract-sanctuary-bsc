    ...
    OwnableUpgradeable
{
    ...
    modifier allowedAddressAddPairOnly() {
        require(allowedAddressAddPair[msg.sender], "!Allowed");
        _;
    }
    ...
    function addPairManagerManual(
        ...
        address _baseAsset,
        address _quoteAsset
    ) external allowedAddressAddPairOnly {
        require(
            _quoteAsset != address(0) && _baseAsset != address(0),
            Errors.VL_EMPTY_ADDRESS
        );
    ...
    function addAllowedAddress(address _address, bool allow) external onlyOwner {
