...
/** A first time interaction between tokens & NFTs. 20M possibilities & a future of multichain domination.
    SocialCredit.AI
    t.me/SocialCreditAI
    twitter.com/SocialCreditAI
*/
...
contract SatoshiAI is IBEP20, Ownable {

    address private WETH;

    string private constant _name = "SatoshiAI";
    string private constant _symbol = "SatoshiAI";
    ...
    address public marketingWallet = payable(0xA7d9B3d4E389c78B5BcbE9B2cb8d454b5451116B);
    address public lottoWallet = payable(0x286031efD412262A8E2aB885411Fb9a2CcaBdD76);
