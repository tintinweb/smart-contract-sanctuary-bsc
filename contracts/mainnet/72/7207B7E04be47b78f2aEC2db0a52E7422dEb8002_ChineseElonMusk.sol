...
contract ChineseElonMusk is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'ChineseElonMusk';
    string private constant _symbol = '$ChineseElon';
    ...
    //DevWallets
    address public TeamWallet=payable(0xA579825d71999Fcd90d62871a642b0e9D3C4ec6d);
    address public walletTwo=payable(0xA579825d71999Fcd90d62871a642b0e9D3C4ec6d);
    //TestNet
	...
	uint256 private antiWhale = 250 * 10**_decimals;
