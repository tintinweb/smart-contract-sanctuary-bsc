...
contract NYD is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0x74a6c77B0E8C487353b1B8b490107d3D2a50A966);

    address private _devsAddress =
        address(0x33fD0A3F065e7C4246046A6be257aE34A0C6b89B);
    ...
    constructor(address tokenOwner) {
        _name = "NEW YEAR DEGEN";
        _symbol = "NYD";
        _decimals = 18;

        _wy = 10000 * 10**_decimals;
