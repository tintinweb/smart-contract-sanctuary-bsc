...
contract METAYFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METAYFI";
    string private _symbol = "METAYFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30c70B9AE433dE9672Cc1A8EC9DfB47bCcCD2f0c);
    address payable public teamWalletAddress = payable(0x30c70B9AE433dE9672Cc1A8EC9DfB47bCcCD2f0c);
    address public immutable deadAddress = 0x30c70B9AE433dE9672Cc1A8EC9DfB47bCcCD2f0c;
