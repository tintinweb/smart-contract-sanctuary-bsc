...
Telegram : https://t.me/squidbusd_community
*/
...
contract squidbusd is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SQUID BUSD", "$SQB") {
        marketingWallet = payable(0x6546A3e35852410e3bF82Ef483DE5ed4aEcEAaBA);
        devWallet = payable(0x6546A3e35852410e3bF82Ef483DE5ed4aEcEAaBA);
        ...
        uint256 totalTokenSupply = (1000_000_000) * (10**18);
...
contract XmasXRPDividendTracker is DividendPayingToken, Ownable {
    ...
    squidbusd public squidbusdContract;
    ...
    constructor(
        ...
        defaultToken = token;
        squidbusdContract = squidbusd(mainContract);
