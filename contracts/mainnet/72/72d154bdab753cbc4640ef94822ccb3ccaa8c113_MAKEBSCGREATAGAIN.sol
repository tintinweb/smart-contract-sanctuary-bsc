...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10E1ebcD6BeA5eA2bb0c9055C8e53012ffFdF548; // owner address
...
contract MAKEBSCGREATAGAIN is Context, IERC20, Ownable {
    ...
    string private _name = "MAKEBSCGREATAGAIN";
    ...
    address payable public teamWalletAddress = payable(0x468DefF339cB522Ba8CA74FA997CCF8D316DF45A); // Team Address
