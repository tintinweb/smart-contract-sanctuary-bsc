...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01255A5B98900f26A6952F765EBe57d6c2cdE072; 
...
contract Holineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HoliNeko";
    string private _symbol = "HONEKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01255A5B98900f26A6952F765EBe57d6c2cdE072); // 
    address payable public teamWalletAddress = payable(0x01255A5B98900f26A6952F765EBe57d6c2cdE072); // 
