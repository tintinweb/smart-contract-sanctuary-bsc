...
contract Asprx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Asprx";
    string private _symbol = "Asprx";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x8909A6C69A3ad98F559EF7fe09Bbfe78421ee763); 
    address payable public marketingAddress2 = payable(0x8AC94Ed7864466802B2f3178740c65EFC76bCf25); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xC09eb06E6A3380c864C17c0C56D197D1d1C02a21);
