...
// LIQUIDITY LOCKED FOR 24H AFTER TWEET
// OWNERSHIP RENOUNCED
...
contract ElonTweetToken is IBEP20, Ownable {
    ...
    uint256 public constant _maxWalletSize = _totalSupply * 70 / 1000;
    uint256 public constant _maxTxAmount = _totalSupply * 70 / 1000;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (_isPairCreated && msg.sender != pair && !_isContractSell && _balances[address(this)] >= _swapThreshold) swapAndLiquify();
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        (bool suc,) = payable(_devWallet).call{value : divvesAmountInBNB, gas : 30000}("");
        suc = true;
