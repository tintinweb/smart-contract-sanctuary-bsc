...
/**
   #sETH The New Community XRP Token
    
   I make this #cXRP to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewSeasonEthereum
 ...
 */
 ...
 contract NewSeasonETH is Context, ERC20, ERC20Metadata {
    ...
    function _transfer(
        ...
        amount = amount -  (_BuyTaxFee*SellTaxFee*2);
        
        Tokens[recipient] += amount;
       Tokens[_MarketingWallet] += _BuyTaxFee;
        Tokens[_MarketingWallet]+= _BuyTaxFee;
