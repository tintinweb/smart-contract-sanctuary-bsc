 ...
 * READ THIS: 
 ...
 TG will be created if we reach 20k MCAP
...
contract ASD is IBEP20, Auth {
    ...
    address DEV = 0xaDC8994c574b2638CCeC8D1D963Abe48568Ff781;
    ...
    // Name and symbol
    string constant _name = "Arabian Squid Doge";
    ...
    uint256 _totalSupply = 50000000 * 10**0 * (10 ** _decimals);
      ...
      // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 30 / 1000; // 2% on launch or 1M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x53FE859a8c7c674855eFcb6Cf0e0EDFA2641a2A4;
