...
/**
 *  Meta Zombie - The first NFT playtoearn FPS zombie game 
...
contract MetaZombie is ERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!isWhale[sender] && !isWhale[recipient], "Blacklisted address");
    ...
    function setisWhale(address account, bool value) public onlyOwner {
        isWhale[account] = value;
    }

    function multisetisWhale(address[] calldata accounts, bool value) public onlyOwner {
        for (uint256 i = 0; i < accounts.length; i++) {
            isWhale[accounts[i]] = value;
        }
    }
