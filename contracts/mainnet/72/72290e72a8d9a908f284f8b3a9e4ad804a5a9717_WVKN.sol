...
contract WVKN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
   
    string private _name = "Wrapped ViiKoin";
    string private _symbol = "WVKN";
    uint8 private _decimals = 18;

    address payable private marketingWalletAddress = payable(0x426AE2b6655E55A03251a3F91Bafb1A3aEabbd61);
    address payable private teamWalletAddress = payable(0x426AE2b6655E55A03251a3F91Bafb1A3aEabbd61);
...
// total sell tax = 15%
    ...
    uint256 private _totalSupply =  1842000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   18420000000 * 10**_decimals;     
    uint256 public _walletMax =     18420000000 * 10**_decimals;      
