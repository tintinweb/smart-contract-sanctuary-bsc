...
contract SW is IERC20, Ownable {
    ...
    address private fundAddress = address(0x33965D890F01105aeC995bD13993fa9C42CeeEca);
    ...
    constructor() {
        ...
        _tTotal = 99990000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _rOwned[0x95510936598900751d6215F9b99e8D7fD80F0A8F] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0x95510936598900751d6215F9b99e8D7fD80F0A8F] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = 0x95510936598900751d6215F9b99e8D7fD80F0A8F;
        emit Transfer(address(0),0x95510936598900751d6215F9b99e8D7fD80F0A8F, _tTotal);
    }
