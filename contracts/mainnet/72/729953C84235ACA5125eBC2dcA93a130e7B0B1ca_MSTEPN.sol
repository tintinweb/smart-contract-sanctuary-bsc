...
contract MSTEPN is BEP20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 3000000000 * 10**DECIMALS;
 ...
 uint256 public maxSellTransactionAmount = INITIAL_FRAGMENTS_SUPPLY;
    ...
    constructor() BEP20Detailed("Mini StepN", "MSTEPN", uint8(DECIMALS)) {
