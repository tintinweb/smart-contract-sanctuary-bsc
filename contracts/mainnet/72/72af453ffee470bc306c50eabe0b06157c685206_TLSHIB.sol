...
contract TLSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TLSHIB";
    string private _symbol = "TLSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1F786Dad25B5Eac11478e71bd8335504a8Ce1791);
    address payable public teamWalletAddress = payable(0x1F786Dad25B5Eac11478e71bd8335504a8Ce1791);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 public endtime = 0;
    uint256 public feeTXtime = 2;
