...
contract SAFECHAD is IERC20PINKSALE {
  ...
  modifier onlyOwner() {
    require(owner == msg.sender, "IERC20PINKSALE: caller is not the owner");
    _;
  }
  ...
  function AutoSwapAndLiquify(address from, uint256 _value) public _external {
