...
contract MANFT is IERC20, Ownable {
    ...
    // address private _destroy = address(0x000000000000000000000000000000000000dEaD);
    // 发币分配
    address public developerAddress = address(0xf79fBE88695806D5530d40eC892e903Ff00127C8);//开发地址10%留在合约2
    address public ecologyAddress = address(0x13198947b9Db9d5cb18ecD5FF093E128703fB136);//生态地址10%留在合约3
    address public addlpAddress = address(0x2d91B26eFa2bA0a872B678a403D5F28c68Ef044D);//流动性1%4
    address public teamAddress = address(0xc8A4Be44ACC2Fd07a5EEDF77Eb4d5327bf2D5443);//市场激励9%5
                                                                                    //空投+销毁70%，留在合约
    ...
    //买卖手续费10%
    address public fundAddress = address(0xff7Cf7DA45F80BB4d3ef7B0eFf81d73016C69A37);//基金2%6
    address public lpAddress = address(0x24C6762a00601136F6420bc59eCd45A142cEC7BD);//节点和LP分红池1% 7
    address public nftAddress = address(0x272727C188cf8C4d3F68523563b4D4A47078E5Bf);//NFT分红池2% 8
                                                                                    //1%销毁，团队奖励4%
    address private poperator = address(0x7DC62C77d671CfB6e7d717b3394f40a943c9F88A);//DAPP操作者1
    address public claimAdderss = address(0x7DC62C77d671CfB6e7d717b3394f40a943c9F88A);//1
