...
contract XYZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "XYZilla";

    string private _symbol = "XYZilla";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xCde038C78dD8589A22fF3DcB632F45b96bAd1BC7;
