...
TG : https://t.me/SocialOfShibarium
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74879ba83Ea918c5014BE646D1E994cb8d31E7B3; // owner address
...
contract SocialOfShibarium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Social Of Shibarium";
    string private _symbol = "$SOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x74879ba83Ea918c5014BE646D1E994cb8d31E7B3); // Marketing Address
    address payable public teamWalletAddress = payable(0x74879ba83Ea918c5014BE646D1E994cb8d31E7B3); // Team Address
