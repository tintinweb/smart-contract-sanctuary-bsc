...
contract BigPapaBSC is IBEP20, Ownable {
    ...
    TierTaxes public _buyTaxes = TierTaxes({first: 8, second: 8, third: 8});

    TierTaxes public _sellTaxes = TierTaxes({first: 8, second: 8, third: 8});
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0x77825Bb16d1CD0c8bf72F0354041dc025BD98d4b,
            events: 0x77825Bb16d1CD0c8bf72F0354041dc025BD98d4b,
            marketing: 0xf7bA74649A79e7F82B2DF60b8B8FEAd476B7A383
        });
