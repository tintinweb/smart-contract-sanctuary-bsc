...
contract MOONWALK is BEP20, Auth {
    ...
    string public constant name = "Moonwalk";
    string public constant symbol = "Mwalk";
    ...
    uint256 public moonshotFee = 10;
    uint256 public devFee = 10;
    uint256 public utilityFee = 20;
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + devFee + utilityFee + moonshotFee;
    ...
    address public moonshotFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x82c29c7aa60699CB310aA123727bE2bce0b9484E;
        moonshotFeeReceiver = 0x67961E72996f62741791B964043c7479fd818dA9;
        teamFeeReceiver = 0xAB021b70d3a437fD2888a626c0FfB031cf90a31E;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMoonshot = (amountBNB * moonshotFee) / totalETHFee;
        uint256 amountBNBDev = (amountBNB * devFee) / totalETHFee;

        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(teamFeeReceiver).transfer(amountBNBteam);
        payable(moonshotFeeReceiver).transfer(amountBNBMoonshot);
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _teamFee, uint256 _moonshotFee, uint256 _utilityFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        moonshotFee = _moonshotFee;
        utilityFee = _utilityFee;
        totalFee = _liquidityFee + _marketingFee + _teamFee + devFee + _utilityFee + _moonshotFee;
        
        update_fees();
    }

    function setFeeReceivers(address _marketingFeeReceiver, address _teamFeeReceiver, address _moonshotFeeReceiver, address _utilityFeeReceiver) external onlyOwner {
        ...
        require(_moonshotFeeReceiver != address(0),"Team fee address cannot be zero address");
        require(_utilityFeeReceiver != address(0),"Utility fee address cannot be zero address");

        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        moonshotFeeReceiver = _moonshotFeeReceiver;
        utilityFeeReceiver = _utilityFeeReceiver;

        emit Set_Wallets(marketingFeeReceiver, teamFeeReceiver, moonshotFeeReceiver, utilityFeeReceiver);
    }
...
event Set_Wallets(address MarketingWallet, address TeamWallet, address MoonshotWallet, address UtilityWallet);
