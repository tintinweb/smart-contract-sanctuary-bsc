...
contract FGI2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FGI2.0";
    string private _symbol = "FGI2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41e1A4e3Dadd7bdEE5A5E7272C9fE1A571102FD5);
    address payable public teamWalletAddress = payable(0x41e1A4e3Dadd7bdEE5A5E7272C9fE1A571102FD5);
