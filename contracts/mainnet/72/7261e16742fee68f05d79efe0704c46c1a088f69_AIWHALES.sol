...
contract AIWHALES is ERC20 {

    uint tokenTotalSupply = 1000000; // 100 Million Token Supply

    constructor() public ERC20("AIWHALES", "AIWHALES") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "AIWHALES";
    string private _symbol = "AIWHALES";
