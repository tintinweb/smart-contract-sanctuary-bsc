...
/**
     ...
     Twitter - https://twitter.com/DCUApe

     Webiste - https://dcu.rocks
...
contract DecentralizedUnited is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Decentralized United";
    string constant _symbol = "DCU";
