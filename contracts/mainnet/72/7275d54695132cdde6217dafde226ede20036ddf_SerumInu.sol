...
contract SerumInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Serum Inu";
    string private _symbol = "SER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8eE7379D6E2A1d5948d0C546FfF97fA3cb2C66B7); 
    address payable public teamWalletAddress = payable(0xBA63EB4fB1ADf62Cd9465c10C06CCDbB38eb0aa6); 
