...
contract BIGONE is Context, IERC20, Ownable {
    ...
    string private _name = "BIGONE";
    string private _symbol = "BIGONE";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0xdadcdDee05b81d94072475bd60964e753Eb35C72));
    address _tokenOwner;
