...
contract SUNEKU is Context, IBEP20, Ownable {
    ...
    string private _name = "JIN KAZAMA"; // token name
    string private _symbol = "JINKAZAMA"; // token ticker
    ...
    uint256 public burnFeeOnBuying = 30;
    ...
    uint256 public burnFeeOnSelling = 30;
