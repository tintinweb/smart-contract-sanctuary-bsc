...
/**
Telegram : Https://Telegram.me/Gaporpy

Gaporpy is a warrior princess endowed with the fortitude
...
contract Gaporpy is ERC20, Auth {
    ...
    string constant private _name = "GangPornHappy";
    string constant private _symbol = "Gaporpy";
    ...
    address private autoLiquidityReceiver = 0xd379C1095091E7842848E667002582711519A862;
    address private MarketingFeeReceiver = 0xd379C1095091E7842848E667002582711519A862;
    ...
    function setBMGaporpy(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMGaporpy(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
