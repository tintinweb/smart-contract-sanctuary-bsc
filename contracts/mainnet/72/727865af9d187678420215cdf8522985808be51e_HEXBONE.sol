...
⚡️HEXBONE is Fan meme Token Features The HEX And DONE Tokens To be Combined As One Token 
And became the HEXBONE CHAIN
...
contract HEXBONE is Context, HEXBONEECO, Ownable {
    ...
    string private _name = 'HEXBONE';
    string private _symbol = 'HEXBONE';
