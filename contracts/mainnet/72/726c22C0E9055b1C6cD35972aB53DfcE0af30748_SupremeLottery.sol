...
// File contracts/SupremeLottery.sol

pragma solidity ^0.8.4;
contract SupremeLottery is VRFConsumerBaseV2, Ownable, Pausable {
    VRFCoordinatorV2Interface COORDINATOR;
    uint64 s_subscriptionId = 71;
    ...
    address public tokenAddress = 0x983B9Ab65CCDccFdAEA3F7A973De6Fed4E0546B3;
    IERC20 token;

    address public marketingAddress =0xE28A3c2Feb553DC3C29f2982D15f92309041f5F9;
    address public devAddress =0x03861288cc5c2714e8c00Fc63ee6b0A0b306F3e9;
    address public blackHoleAddress =0x000000000000000000000000000000000000dEaD;

    uint256 public maxTicketsPerPlayer = 10**8;
    mapping(uint256 => mapping(address => uint256)) public numTicketsBought;

    uint256 public winnerShare = 600;
    uint256 public marketingShare = 200;
    uint256 public devShare = 100;
    uint256 public blackHoleShare = 100;
    ...
    function setShares(uint256 _winner, uint256 _market, uint256 _dev, uint256 _burn) external onlyOwner {
        winnerShare = _winner;
        marketingShare = _market;
        devShare = _dev;
        blackHoleShare = _burn;
    }

    function setMaxTicketPerPlayer(uint256 _ticket) external onlyOwner{
        maxTicketsPerPlayer = _ticket;
    }
    ...
    function payoutLottery() external onlyOwner{
        ...
        if (players.length > 0) {
            ...
            uint256 marketingAmount = (totalAmount * marketingShare) /
                shareDenominator;
            uint256 devAmount = (totalAmount * devShare) /
                shareDenominator;
