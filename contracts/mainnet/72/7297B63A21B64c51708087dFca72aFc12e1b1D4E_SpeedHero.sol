...
contract SpeedHero is BEP20Detailed, BEP20 {
  ...
  function setLockBuy(bool _lockBuy) external onlyOwner {
      lockBuy = _lockBuy;
  }

  function setLockSell(bool _lockSell) external onlyOwner {
      lockSell = _lockSell;
  }
