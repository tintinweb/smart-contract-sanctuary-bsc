...
contract MrBeast is BEP20, Auth {
    ...
    string public constant name = "MrBeast Fan Token";
    string public constant symbol = "MRBEAST";
    ...
    function addBot(address[] calldata addresses, bool status) external authorized {
        require(addresses.length < 501,"GAS Error: max limit is 500 addresses");
        for (uint256 i=0; i < addresses.length; ++i) {
