...
/**
 LIONSUN Inu is developed with safe contract and fair tax that aims to give the community a high margin of earnings in this bear market.  🚀🚀🚀🚀 
...
MARKETING PLAN
OBITO AND LOW TAX 15K MC
VENOM AND CAESER 50K
AMA IN TRAVLADD 100K UP


TOTAL SUPPLY:  10,000,000,000
TAX : 9% Buy / Sell

TELEGRAM: https://t.me/LionSunInu
...
contract LIONSUN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lion Sun Inu"; // 
    string private constant _symbol = "LIONSUN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x9e3287825ab58E70BCBf81D5d198C757fA10a432;
