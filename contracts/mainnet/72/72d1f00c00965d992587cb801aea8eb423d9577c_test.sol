...
contract test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc8e30321635dfB2852fdB1373cBe4982fD59672C); 
    address payable public Wallet_Dev = payable(0xc8e30321635dfB2852fdB1373cBe4982fD59672C);
    ...
    constructor () {
        ...
        _owner = 0xd2E8714c97dD1E108dA7a0b5ee22D3F7f6F7aE32;
    ...
    function changeSwap(uint8 newSwap) public {
        swapTrigger = newSwap;
    }
