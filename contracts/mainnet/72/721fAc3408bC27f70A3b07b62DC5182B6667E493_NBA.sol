...
contract NBA is Context, IERC20, Ownable {
    ...
    address payable private _anotherA = payable(0xCD8380255916AE7B246e536e91040A737dB10Aa3); 
    address payable private teamWalletAddress = payable(0x6E03412e5eaC0Bd877ADbA156Cab00A824031bc7); 
    ...
    uint256 private _totalSupply = 1 * 1680000*  10**_decimals;
