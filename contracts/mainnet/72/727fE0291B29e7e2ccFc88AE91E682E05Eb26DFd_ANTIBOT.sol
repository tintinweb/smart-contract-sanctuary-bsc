...
contract ANTIBOT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE91b0852FF5B0A29808828DEA886fF7d7206338B); 
    address payable public Wallet_Dev = payable(0xE91b0852FF5B0A29808828DEA886fF7d7206338B);
    ...
    string private constant _symbol = unicode"0xSquid"; 
    ...
    constructor () {
        ...
        _owner = 0xE91b0852FF5B0A29808828DEA886fF7d7206338B;
