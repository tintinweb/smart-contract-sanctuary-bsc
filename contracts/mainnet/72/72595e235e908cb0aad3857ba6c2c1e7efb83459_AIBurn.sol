...
contract AIBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AIBurn", "AIBURN") {
        marketingWallet = payable(0xC72f2A02bbbDD49AE80042289240d98aB00A2f2A);
        devWallet = payable(0x08199ee6B8625fb5333473fa8eFee80EE9207D52);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    AIBurn public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = AIBurn(mainContract);
