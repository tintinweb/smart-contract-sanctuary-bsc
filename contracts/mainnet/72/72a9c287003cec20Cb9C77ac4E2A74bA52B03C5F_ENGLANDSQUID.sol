...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4353F3cA72Ce3798a5065072debE7914Cf92E3DA; // owner address
...
contract ENGLANDSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ENGLAND SQUID";
    string private _symbol = "ENGLANDSQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4353F3cA72Ce3798a5065072debE7914Cf92E3DA); // Marketing Address
    address payable public teamWalletAddress = payable(0x4353F3cA72Ce3798a5065072debE7914Cf92E3DA); // Team Address
