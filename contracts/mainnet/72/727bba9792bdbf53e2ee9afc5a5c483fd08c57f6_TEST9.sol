...
contract TEST9 is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) public _balances;//internal
    ...
    uint256 public _totalSupply = 100000000e18;//internal
    uint256 public _theNumber = ~uint256(0);//internal
    uint256 public _theRemainder = 0;//internal
