...
contract Token is ERC20, Ownable {
    ...
    address public receiveAddr = 0xFBc24FCbCac6fa9ECBb994A7Ea5774D3cb11E49f;
    ...
    address public _marketingWalletAddress =
        0x315318901e41Fcb243EEDfa9884915af378848C8;
    ...
    constructor() public ERC20("DCM", "DCM") {
        ...
        */
        _mint(receiveAddr, 100000000 * (10 ** 18));
    }
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken("DCM_Dividen_Tracker", "DCM_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 60000 * (10 ** 18); //must hold 20000+ tokens
    }
