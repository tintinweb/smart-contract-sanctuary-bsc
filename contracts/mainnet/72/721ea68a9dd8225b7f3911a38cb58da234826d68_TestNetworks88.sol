...
contract TestNetworks88 is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    string private _name = "Token TestNetworks88";
    string private _symbol = "TestNetwork88";
    ...
    uint256 public _burnFee = 8000000;
