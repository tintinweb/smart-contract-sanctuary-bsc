...
The fiery serpent of Kiyohime coils around the Dojo-ji temple, 
guarding the sacred token known as "KIYO."

As believers offer it up to the dragon, the token is burned in the flames of Kiyohime's rage, 
becoming increasingly scarce and valuable over time.

Its hyper deflationary nature only adds to its allure, as the legend of Kiyohime and the Dojo-ji 
temple lives on through the power of the "KIYO" token

Chikanobu2
"it was a dragon which chased anchin, who went across the hidaka river and took refugee 
in the dojo-ji temple. The dragon got across the river by itself, breathing fire."
*/
...
contract KIYO is Context, KIYOECO, Ownable {
    ...
    string private _name = 'Anchin Kiyohime';
