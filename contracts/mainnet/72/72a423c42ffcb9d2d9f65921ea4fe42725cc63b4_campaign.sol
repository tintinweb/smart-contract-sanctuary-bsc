...
abstract contract owned {
    ...
    constructor ()  {
        ...
        treasory = 0x368a91b501B11c3930A50e7C38EEb722C87af4A8;
        oracle = 0xa85680ddb9b6D2DBB118De7623840d313EB3b246;
...
contract campaign is oracleClient {
    ...
    function applyCampaign(bytes32 idCampaign,uint8 typeSN, string memory idPost, string memory idUser,uint64 abosNumber) public returns (bytes32 idProm) {
    ...
    function getGains(bytes32 idProm) public {
        ...
        require(block.timestamp -proms[idProm].lastHarvest > 86400, "less than 24h to harvest again");
    ...
    function getRemainingFunds(bytes32 idCampaign) public {
        ...
        require(block.timestamp - campaigns[idCampaign].endDate > 1296000 ,"Withdraw not allowed under 15 days");
