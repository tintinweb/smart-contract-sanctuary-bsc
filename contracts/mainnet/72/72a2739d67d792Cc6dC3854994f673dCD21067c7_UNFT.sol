...
contract TokenDetails is IERC20 {
...
contract UNFT is TokenDetails {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "United NFT";
  string constant tokenSymbol = "UNFT";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 1000000000 * 10 ** 18; // 1,000,000,000

  address _owner;

  constructor() public payable TokenDetails (tokenName, tokenSymbol, tokenDecimals) {
    _owner = msg.sender;
