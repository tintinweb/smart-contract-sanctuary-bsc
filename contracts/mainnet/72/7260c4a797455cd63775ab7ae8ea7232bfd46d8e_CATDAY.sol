...
contract CATDAY is Context, IERC20, Ownable {
    ...
    string private _name = "CAT DAY";
    string private _symbol = "CAT DAY";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xf559CAf83335C789f7bDd8ca02718f8658240717));
        marketingWalletAddress = payable(address(0xf559CAf83335C789f7bDd8ca02718f8658240717));
