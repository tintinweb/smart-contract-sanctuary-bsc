...
contract mainStakingFactory is Ownable{
    ...
    function  createBnbForToken(structBnbForToken memory _values) public onlyOwner {
    ...
    function  createTokenForBnb(structTokenForBnb memory _values) public onlyOwner {
    ...
    function  createTokenForToken(structTokenForToken memory _values) public onlyOwner{
