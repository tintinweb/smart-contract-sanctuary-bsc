...
contract HokbMinterV2 is Context, Ownable {
  ...
  function MintNew(address to,uint256 refid) external returns (bool) {
    ...
    updateRefReward(to,buyprice*120/1000,true);
