...
/**
Bring back the old BSC. 

MAX TX     - 2% (200 mil of tokens)
Max Wallet - 2% (200 mil of tokens)

First few minutes after launch SELL TAX will be 99% to rect the bots
ALL MULTIWALLET BOTS WILL BE BLACKLISTED!

ANTIBOT
Blacklist 


// https://t.me/FatherCake2
*/
...
/* Token contract */
contract FatherCake2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xFbA98090e8Ba437EF7Fb4c6354B95bc52A167D03;
    ...
    // Name and symbol
    string constant _name = "Father Cake 2";
    string constant _symbol = "FATHERCAKE2";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (100 mil)
