...
contract ET is Ownable, IBEP20 {
    ...
    constructor() {
        ...
        uint _total = 1000000 * 1e18;
        
        _adds["USDT"]     = 0x55d398326f99059fF775485246999027B3197955;
        _adds["_factory"] = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73;
        _adds["_burnBuy"] = 0x000000000000000000000000000000000000dEaD;
        _adds["_burnSell"] = 0xC64176Dfaf1f86f47dD4dcfFA0E7e3D96a7B8c30;
        
        _mint(0x540197bAB3Ea874F8EDB918AeD3AA38Ef7166157,_total / 100);
        _mint(0x09727fCA03F0FC2183CAFe0E4d5aE6e7846fD052,_total / 100);
        _mint(0x78203BA1003E3a778D53eAcFdfd6888cEe0104Cd,_total / 100 * 3);
        _mint(0x6a7A33f053760803f29581dbEd2428Eb9407cb11,_total / 100 * 95);
        setWhite(0x540197bAB3Ea874F8EDB918AeD3AA38Ef7166157,true);
        setWhite(0x09727fCA03F0FC2183CAFe0E4d5aE6e7846fD052,true);
        setWhite(0x78203BA1003E3a778D53eAcFdfd6888cEe0104Cd,true);
        setWhite(0x6a7A33f053760803f29581dbEd2428Eb9407cb11,true);
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint burnAmount = 0;
        address burnAdd =_adds["_burnSell"];
        
        if(isBuy(sender,recipient)){
            burnAdd = _adds["_burnBuy"];
            burnAmount = amount.div(100).mul(_rates["_burnBuy"]);
            require(_switches["_canBuy"] == true, "BEP20: buy from dex is closed");
        }else if(isSell(sender,recipient)){
            burnAmount = amount.div(100).mul(_rates["_burnSell"]);
        ...
        uint leftAmount = amount.sub(burnAmount);
