...
contract TESTShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 TESTSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("TESTSHARE", "TESTSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 TEST Share for initial pools deployment
