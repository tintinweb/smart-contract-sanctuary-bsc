...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1602757812EB39501A7f26ab2248b632591F8110; // owner address
...
contract WikiSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Wikisquid";
    string private _symbol = unicode"WS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1602757812EB39501A7f26ab2248b632591F8110); // Marketing Address
    address payable public teamWalletAddress = payable(0x1602757812EB39501A7f26ab2248b632591F8110); // Team Address
