...
// Telegram : https://t.me/Australiainu
...
contract AustraliaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4f175Bf6820B2462EA75f192F00A83D1A3bFcF0F); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Devs = payable(0xdDE1396C1C75a72c9AC1395d0274510D45Da1515);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Australia Inu"; 
    string private constant _symbol = unicode"Aussie";
    ...
    constructor () {
        ...
        _owner = 0xdDE1396C1C75a72c9AC1395d0274510D45Da1515;
