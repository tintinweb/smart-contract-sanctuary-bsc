...
contract GoldDogeGrow
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "GoldDogeGrow";
    string private _symbol = "GoldDogeGrow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xfE1570fA70528b3176Ae564Abc830Ae5e3ec5905));
        _anotherA = payable(address(0xfE1570fA70528b3176Ae564Abc830Ae5e3ec5905));
