...
contract Web3finance is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("Web3 Finance", "WEB") payable
    {
    ...
    function _transfer(
        ...
        require(!paused(), "Web3 Finance: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Web3 Finance: sender blacklisted");
        require(!isBlacklisted(recipient), "Web3 Finance: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Web3 Finance: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Web3 Finance: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Web3 Finance: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Web3 Finance: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Web3 Finance: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Web3 Finance: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Web3 Finance: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "Web3 Finance: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "Web3 Finance: Tax is already disabled");
        taxStatus = false;
    }
