...
contract HowlingDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Howling Doge";
    string private _symbol = "Howling Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xab5f49B6e371e7d32A5ca9d1471d53300046C06B); 
