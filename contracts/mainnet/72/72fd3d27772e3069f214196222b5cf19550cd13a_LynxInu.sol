...
contract LynxInu is IBEP20, Auth {
   ...
   string constant _name = "LynxInu";
   string constant _symbol = "Lynx";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 500) / 1000; // 
    uint256 public _maxSellTxAmount = ( _totalSupply * 500) / 1000; // 
   ...
   // Buy Fees
    ...
    uint256 marketingFeeSell = 8500;
    uint256 totalFeeSell = 8500;
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0xe75cE4dd29eAB425B714edffaB40Bea363d766E4;
       marketingFeeReceiver = 0xe75cE4dd29eAB425B714edffaB40Bea363d766E4;
