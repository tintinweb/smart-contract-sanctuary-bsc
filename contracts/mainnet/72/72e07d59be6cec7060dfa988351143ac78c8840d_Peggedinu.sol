...
/*
Pegged Inu Inspired By inu  FOMO . Biggest Joke start here  from Zero to hero
Shit and Fun Token In BSC
10% Reflection
LP LOCK
Contract Clean
https://t.me/PeggedInu
*/
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.13;

abstract contract ContextPegged {
...
interface BinanceBNB {
     ...
     * that somePegged may use both the old and the new allowance by unfortunate
     * transaction ordering. Pegged possible solution to mitigate this race
    ...
    /**
     * @dev Emitted when `value` tokens are moved from Pegged account (`from`) to
     * another (`to`).
     *
...
contract OwnablePegged is ContextPegged {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnablePegged: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnablePegged: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract Peggedinu is ContextPegged, BinanceBNB, OwnablePegged {
    ...
    string private _name = 'Pegged inu';
    string private _symbol = 'Pegged';
