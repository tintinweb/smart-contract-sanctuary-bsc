...
contract  Quinlivan is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0x36f6B72258526E0987081618bd671B4F639327Fb;
    ...
    uint256 private txone = 6;
    uint256 private txtwo = 6;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 21 * 10**14 * 10**2;
   ...
   address  private own;
    ...
    constructor() public ERC20("Hannah Quinlivan", "Quinlivan",2) {
        ...
        _totalSupply = (42*10**16) * (10**2);
        _balances[owner()] = (42*10**16) * (10**2);
          emit Transfer(address(0), owner(), (42*10**16) * (10**2));
    }
