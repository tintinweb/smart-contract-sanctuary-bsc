...
interface IAlfaProfitSharing {
    ...
    function redeem(address _user, uint256[] memory _indexes) external returns (uint256 payout_);
...
contract AlfaProfitSharing is IAlfaProfitSharing, Ownable {
    ...
    function toEarnsUper() public _onlyOwner {
    ...
    function redeem(address _user, uint256[] memory _indexes) public returns (uint256 payout_) {
        ...
        afa.transfer(_user, payout_); // send payout as AFA
    }
