...
NOMAd safemoon is the best token out there. More community utilities and support big buys .
Metaverse, web3 app, Staking, minigames,and swap is some of the utility.


Telegram: https://t.me/nomadsafemoonbsc
...
contract NOMADSAFEMOON is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "NomadSFM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x968059725AB0105a979E66290718688e3fFE5bB4;
