...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE65b8b7644CD3295311B97295c459e2AE32E2036; 
...
contract Bemyvalentineinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Be my valentine inu";
    string private _symbol = "LOVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4d5F61BFd2D9d746033a3F9DDCFFa42e69Ffcda2); // 
    address payable public teamWalletAddress = payable(0x9B73243d54F53828266e888d9D5c1671BE8CE9A5); // 
