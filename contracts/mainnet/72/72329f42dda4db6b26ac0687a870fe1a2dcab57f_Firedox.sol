...
contract Firedox is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Firedox";
    string private _symbol = "$FIREDOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56703657058048f8CfA88fb80d77C1ED56b604E3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x56703657058048f8CfA88fb80d77C1ED56b604E3); // BuyBack Address
