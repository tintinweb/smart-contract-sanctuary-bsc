...
contract Cossacks is ERC721, ERC721Burnable, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Cossacks", "CSK") {}
    ...
    function mint(address to) public payable checkValue checkSupply {
        _tokenIdCounter.increment();
        _safeMint(to, _tokenIdCounter.current());

        payable(0x165CD37b4C644C2921454429E7F9358d18A45e14).transfer(msg.value);
    }
