...
contract RICHEYSHIBU is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x49f1AEb162A593b9e9922F3Ee5cF2C68556E232D;

    string private constant _name = "RICHEY Shibu";
    string private constant _symbol = "RICHEY";
    ...
    Taxes public buyTaxes = Taxes(0, 70, 20);
    Taxes public sellTaxes = Taxes(0, 70, 20);
