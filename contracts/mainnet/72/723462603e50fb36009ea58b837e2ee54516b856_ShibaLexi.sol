...
contract ShibaLexi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**_decimals; // Edit Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = _tTotal * 7 / 1000; // Edit Auto-Sell: 10 = 1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 3 / 100; // Edit Max Wallet: 1 = 1%

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x6418E4772055F5dDb214B0c247585F82e2B1F153; // Marketing Wallet

    string private constant _name = "SHIBA LEXI"; // Edit name
    string private constant _symbol = "SHIBA LEXI"; // Edit Symbol
    ...
    Taxes public taxes = Taxes(1,5,2,0); // Taxes {Reflection,Marketing,LP,Auto-Burn}
