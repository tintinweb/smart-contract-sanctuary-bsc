...
contract BabyStarBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Baby Star Boy ";
    string private _symbol = " $BSB "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37d2E91f782415edd3e08660a341BCB40a95Fd63);
    address payable public teamWalletAddress = payable(0x37d2E91f782415edd3e08660a341BCB40a95Fd63);
