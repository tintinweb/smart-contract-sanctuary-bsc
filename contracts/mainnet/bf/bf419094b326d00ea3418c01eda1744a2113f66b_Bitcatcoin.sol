...
// Bitcatcoin, a revolutionary cryptocurrency made for Influencers. 
// Join this website www.bitcatcoin.net or join this telegram https://t.me/Bitcatcoin
...
contract Bitcatcoin is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    string private _name = "Bitcatcoin";
    string private _symbol = "Bitcat";
    uint8 private _decimals = 18;

    BitcatDividendTracker public dividendTracker;
    ...
    event BitcatcoinRoarChange(bool indexed newValue, bool indexed oldValue);
    ...
    constructor() public ERC20("Bitcatcoin", "Bitcat") {
        liquidityWallet = address(0x80398d9d6034D041c004d6C0e578f85ce7428076);
    	marketingWallet = address(0xCD90AD83B73AFDc117E45A60a6CD7e15Af586d5A);
    	salaryWallet = address(0xf00F5ADd3c29a88751783b3Df388ec2688c14f55);
    	buyBackWallet = address(0x7BC1265A8cc61e1242d9dC4fDbf43b81521e81E5);
    	
    	dividendTracker = new BitcatDividendTracker();
    ...
    function cancelLaunch() public onlyOwner {
        require(this.isInLaunch(), "Bitcat: Launch is not set");
    ...
    function setBitcatcoinRoar() public onlyOwner {
        require(!this.isInRoar(), "Bitcat: Roar is already set");
        require(isTradingEnabled, "Bitcat: Trading must be enabled first");
        require(!this.isInLaunch(), "Bitcat: Must not be in launch period");
        emit BitcatcoinRoarChange(true, false);
        _roarStartTimestamp = _getNow();
    }
    function cancelBitcatcoinRoar() public onlyOwner {
        require(this.isInRoar(), "Bitcat: Roar is not set");
        emit BitcatcoinRoarChange(false, true);
        _roarStartTimestamp = 0;
    }
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Bitcat: The dividend tracker already has that address");
        BitcatDividendTracker newDividendTracker = BitcatDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "Bitcat: The new dividend tracker must be owned by the Bitcat token contract");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Bitcat: Automated market maker pair is already set to that value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFee[account] != excluded, "Bitcat: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTransactionLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTransactionLimit[account] != excluded, "Bitcat: Account is already the value of 'excluded'");
        _isExcludedFromMaxTransactionLimit[account] = excluded;
        emit ExcludeFromMaxTransferChange(account, excluded);
    }
    function excludeFromMaxWalletLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxWalletLimit[account] != excluded, "Bitcat: Account is already the value of 'excluded'");
        _isExcludedFromMaxWalletLimit[account] = excluded;
        emit ExcludeFromMaxWalletChange(account, excluded);
    }
    function blacklistAccount(address account) public onlyOwner {
        uint256 currentTimestamp = _getNow();
        require(!_isBlacklisted[account], "Bitcat: Account is already blacklisted");
        if (_isLanched) {
            require(currentTimestamp.sub(_launchStartTimestamp) < _blacklistTimeLimit, "Bitcat: Time to blacklist accounts has expired");
        }
        _isBlacklisted[account] = true;
        emit BlacklistChange(account, true);
    }
    function unBlacklistAccount(address account) public onlyOwner {
        require(_isBlacklisted[account], "Bitcat: Account is not blacklisted");
        _isBlacklisted[account] = false;
        emit BlacklistChange(account, false);
    }
    function setLiquidityWallet(address newAddress) public onlyOwner {
        require(liquidityWallet != newAddress, "Bitcat: The liquidityWallet is already that address");
    ...
    function setMarketingWallet(address newAddress) public onlyOwner {
        require(marketingWallet != newAddress, "Bitcat: The marketingWallet is already that address");
        emit MarketingWalletChange(newAddress, marketingWallet);
        marketingWallet = newAddress;
    }
    function setBuyBackWallet(address newAddress) public onlyOwner {
        require(buyBackWallet != newAddress, "Bitcat: The buyBackWallet is already that address");
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "Bitcat: The salaryWallet is already that address");
    ...
    function setLiquidityFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnBuy != newvalue, "Bitcat: The liquidityFeeOnBuy is already that value");
    ...
    function setMarketingFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnBuy != newvalue, "Bitcat: The marketingFeeOnBuy is already that value");
    ...
    function setHolderFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnBuy != newvalue, "Bitcat: The holdersFeeOnBuy is already that value");
    ...
    function setBuyBackFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnBuy != newvalue, "Bitcat: The buyBackFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "Bitcat: The salaryFeeOnBuy is already that value");
    ...
    function setLiquidityFeeOnSell(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnSell != newvalue, "Bitcat: The liquidityFeeOnSell is already that value");
    ...
    function setMarketingFeeOnSell(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnSell != newvalue, "Bitcat: The marketingFeeOnSell is already that value");
    ...
    function setHolderFeeOnSell(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnSell != newvalue, "Bitcat: The holdersFeeOnSell is already that value");
    ...
    function setBuyBackFeeOnSell(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnSell != newvalue, "Bitcat: The buyBackFeeOnSell is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "Bitcat: The salaryFeeOnSell is already that value");
    ...
    function setUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Bitcat: The router already has that address");
        emit UniswapV2RouterChange(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }
    function setGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Bitcat: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Bitcat: Cannot update gasForProcessing to same value");
        emit GasForProcessingChange(newValue, gasForProcessing);
        gasForProcessing = newValue;
    }
    function setMaxTxAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxTxAmount, "Bitcat: Cannot update maxTxAmount to same value");
        emit MaxTransactionAmountChange(newValue, maxTxAmount);
        maxTxAmount = newValue;
    }
    function setMaxWalletAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxWalletAmount, "Bitcat: Cannot update maxWalletAmount to same value");
        emit MaxWalletAmountChange(newValue, maxWalletAmount);
        maxWalletAmount = newValue;
    }
    function setMinimumTokensBeforeSwap(uint256 newValue) public onlyOwner {
        require(newValue != minimumTokensBeforeSwap, "Bitcat: Cannot update minimumTokensBeforeSwap to same value");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            require(isTradingEnabled, "Bitcat: Trading is currently disabled.");
            require(!_isBlacklisted[to], "Bitcat: Account is blacklisted");
            require(!_isBlacklisted[from], "Bitcat: Account is blacklisted");
            if (_isInLaunch && currentTimestamp.sub(_launchStartTimestamp) <= 300 && isBuyFromLp) {
                require(currentTimestamp.sub(_buyTimesInLaunch[to]) > 60, "Bitcat: Cannot buy more than once per min in first 5min of launch");
            }
            if (!_isExcludedFromMaxTransactionLimit[to] && !_isExcludedFromMaxTransactionLimit[from]) {
                require(amount <= maxTxAmount, "Bitcat: Buy amount exceeds the maxTxBuyAmount.");
            }
            if (!_isExcludedFromMaxWalletLimit[to]) {
                require(balanceOf(to).add(amount) <= maxWalletAmount, "Bitcat: Expected wallet amount exceeds the maxWalletAmount.");
            }
        }
    ...
    function _swapAndLiquify() private {
        ...
        uint256 tokensInBitcatcoinForLiquidity = _liquidityTokensToSwap.div(2);
        uint256 amountToSwapForBNB = contractBalance.sub(tokensInBitcatcoinForLiquidity);
        
        // initial BNB balance
        uint256 initialBNBBalance = address(this).balance;
        // Swap the Bitcatcoin for BNB
        ...
        _addLiquidity(tokensInBitcatcoinForLiquidity, bnbForLiquidity);
        emit SwapAndLiquify(amountToSwapForBNB, bnbForLiquidity, tokensInBitcatcoinForLiquidity);
...
contract BitcatDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Bitcat_Dividend_Tracker", "Bitcat_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); 
    }
    function _transfer(address, address, uint256) internal override {
        require(false, "Bitcat_Dividend_Tracker: No transfers allowed");
    }
    function withdrawDividend() public override {
        require(false, "Bitcat_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Bitcat contract.");
    }
    ...
    function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
        require(minimumTokenBalanceForDividends != newValue, "Bitcat_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
        minimumTokenBalanceForDividends = newValue;
    } 
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Bitcat_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Bitcat_Dividend_Tracker: Cannot update claimWait to same value");
