...
contract BSCFreeMasons is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = ( _totalSupply * 15 ) / 100; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD981f993f044826C39A7CDcE230c705A9A7fd850;
