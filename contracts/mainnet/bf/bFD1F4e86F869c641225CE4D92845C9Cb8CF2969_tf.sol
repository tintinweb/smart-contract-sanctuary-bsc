...
contract tf is Context, IERC20, Ownable {
    ...
    string private _name = "TF";
    string private _symbol = "TF";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xa4A8202F35A912D987dAFb166de755780f745739); 
    address payable public marketingAddress2 = payable(0x0B68997Af4b8AFF44f40B50B555B1a79D92AFdE4); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x84abc94Dee4FB03CD492C2C97752f1A8bB1f6441);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A
    address ethAddress = address(0x46CA105545163f9Caf276B24c97E280847661452);
