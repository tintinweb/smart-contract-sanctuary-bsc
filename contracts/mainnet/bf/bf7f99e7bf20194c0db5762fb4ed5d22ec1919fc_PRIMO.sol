...
contract PRIMO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PRIMO";
    string private _symbol = "PRIMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd88858F76062ED5A2Ad72Edc6152060a823EBe38); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa0A804b596526dBd09697E6B7819450eb50DCe13); // buyback Address
    ...
    uint256 public _walletMax = 1000000000000000 * 10**9; // 2%
