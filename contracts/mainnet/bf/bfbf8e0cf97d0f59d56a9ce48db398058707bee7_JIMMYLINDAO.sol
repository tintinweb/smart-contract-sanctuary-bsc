...
contract JIMMYLINDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JIMMYLINDAO";
    string private _symbol = "JIMMYLINDAO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xd322C3BD9270d4a6f47df95f0CFDee32F92026Ff); // Marketing Address
    address payable public teamWalletAddress = payable(0xd322C3BD9270d4a6f47df95f0CFDee32F92026Ff); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xd322C3BD9270d4a6f47df95f0CFDee32F92026Ff),
            block.timestamp
        );
    }
