...
contract EsiumNFT is ERC721Enumerable, Ownable {
    ...
    address public creatorAddress = 0xb3205FFCd38b02Fe943accD96C3F559a49ea4723;
    ...
    constructor() ERC721("EsiumNFT", "ESI") {}
    ...
    function mintNFT(
        ...
        usdt.transferFrom(msg.sender, address(this), price * 10**18);
    ...
    function buyNFT(uint256 tokenId, uint256 price) public {
        ...
        require(
            usdt.balanceOf(msg.sender) > price * 10**18,
            "Insuficient funds!"
        );
        ...
        usdt.transferFrom(msg.sender, _owner, ((price * 97) / 100) * 10**18);
    }
