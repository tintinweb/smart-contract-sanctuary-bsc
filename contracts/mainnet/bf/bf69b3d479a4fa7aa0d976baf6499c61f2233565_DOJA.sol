...
contract DOJA is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Doja Cat Woman";
    string private constant _symbol = "DOJA";
    ...
    address payable  _marketingAddress = payable(0x1e58294724EC9df514EF308c3D9e8A23FE9c4403);
    address payable constant  _projectMaintainence = payable(0x1e58294724EC9df514EF308c3D9e8A23FE9c4403);
