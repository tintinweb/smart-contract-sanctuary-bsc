...
Telegram: https://t.me/spookyfifabsc
...
contract SPOOKYFIFA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPOOKY FIFA"; // 
    string private constant _symbol = "$SFIFA"; //    
