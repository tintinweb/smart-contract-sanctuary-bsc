...
contract SquidGrow2 is IBEP20, Auth {
    ...
    string constant _symbol = "SG 2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 16000 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x3cefb006548cb28ADCd6982A07091B0231ca8257;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 150; // 1.50%
    bool inSwap;
