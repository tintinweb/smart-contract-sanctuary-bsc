...
contract PLUSONE is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "+1"; // To Do
    string constant _symbol = "+1"; // To Do
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (3); // 5%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (3); // 5%
    uint256 public _maxWalletToken = _totalSupply / (100) * (100); // 100%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0xB03254579E757Cf4A0d15b9595D902cD4dCE5A2D;
    address public devFeeReceiver = 0xB03254579E757Cf4A0d15b9595D902cD4dCE5A2D;
    address public buybackFeeReceiver = 0xB03254579E757Cf4A0d15b9595D902cD4dCE5A2D;
