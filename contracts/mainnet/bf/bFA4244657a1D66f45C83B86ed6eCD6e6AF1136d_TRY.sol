...
contract TRY is ERC20, Ownable {
    ...
    TRYDividendTracker public dividendTracker;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    address public marketingWallet = 0xAEc83FfE6679C52e567EbDa991738d2631fD30E3;
    address public devWallet = 0x79B5a43CeB5b69eF42B80e860C54981F1dF3CACD;
    ...
    uint256 public extraBuyThreshold = 5e5 * 10**9;
    uint256 public extraSellThreshold = 5e5 * 10**9;
    ...
    constructor() ERC20("TRY", "TRY") {
    	...
    	dividendTracker = new TRYDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        TRYDividendTracker newDividendTracker = TRYDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TRY: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "TRY: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TRY: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TRY: Cannot update gasForProcessing to same value");
...
contract TRYDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("TRY_Dividen_Tracker", "TRY_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 100_000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "TRY_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TRY_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TRY_Dividend_Tracker: Cannot update claimWait to same value");
