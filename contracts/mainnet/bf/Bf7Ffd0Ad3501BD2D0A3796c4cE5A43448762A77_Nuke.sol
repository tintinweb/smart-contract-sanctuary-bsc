...
contract Nuke is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        V2pair = IUniswapV2Factory(_pancakeswapRouter.factory())
    ...
    function _transfer(
        ...
        if (from == V2pair && to != address(pancakeswapRouter)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == V2pair && recipient != address(pancakeswapRouter);
