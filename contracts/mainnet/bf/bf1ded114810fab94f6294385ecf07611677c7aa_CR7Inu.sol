...
contract CR7Inu is Context, IERC20, Ownable {
    ...
    string private _name = "CR7 Inu";
    string private _symbol = "CR7";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x932fFF2DE4C235be992C7623509C0da31E9B6e08); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2cc63f655712F5964C54F66774e57448A3ce4D04); // BuyBack Address
