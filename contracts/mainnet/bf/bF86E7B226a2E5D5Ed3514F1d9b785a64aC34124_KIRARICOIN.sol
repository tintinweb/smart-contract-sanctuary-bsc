...
contract KIRARICOIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KIRARICOIN";
    string constant _symbol = "$KIRARI";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x373118BD3349cD2a96cabEF312d8c711dA317007 ;
