...
contract XKAKI  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XKAKI ";
    string private _symbol = "XKAKI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA063563a105575e62f7c662e2b87Bc55E8552112);
    address payable public teamWalletAddress = payable(0xA063563a105575e62f7c662e2b87Bc55E8552112);
    address public immutable deadAddress = 0xA063563a105575e62f7c662e2b87Bc55E8552112;
