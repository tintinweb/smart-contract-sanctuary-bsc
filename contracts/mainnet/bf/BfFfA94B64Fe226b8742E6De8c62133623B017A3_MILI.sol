...
contract MILI is Context, IBEP20, Ownable {
    ...
    string private _name = "MILI";
    string private _symbol = "MILI";
    ...
    address public _nfc = 0x19e016190a07Ad2ECDfb9041912fE5bC13DE35E6;
    address public _market = 0x736637Ee259c47C6294a92Ff52e45F7B58348240;
    address public _usdt = 0x55d398326f99059fF775485246999027B3197955;
    address private _creator;

    uint256 public numTokensSellToMarket = 10000 * 10**_decimals;
    ...
    function setNFCAddress(address _addr) public onlyOwner {
        _nfc = _addr;
    }

    function setMarketAddress(address _addr) public onlyOwner {
        _market = _addr;
    }
    ...
    function setMarketEnabled(bool _enabled) public onlyOwner {
    ...
    function _transfer(
        ...
        if (
            ...
            if (marketEnabled) {
                ...
                swapTokensForNFC(contractTokenBalance);
            }
    ...
    function swapTokensForNFC(uint256 tokenAmount) private {
        address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = _nfc;
