...
// File: contracts/SportbetPlusReferPatchedModelY.sol
...
contract SportbetPlusReferPatchedModelY is Ownable {
    ...
    address constant nullAddress = 0x56B4B488C489Abd92cDaf851736160DCfB525Caf; //<<UPDATE TO PERSONAL ADDRESS TO COLLECT FEES <<0x000000000000000000000000000000000000dEaD;
    ...
    function createBet(uint _leagueId, uint _gamblingId, uint _target, uint _stake, address _referParent) external onlyNotFinished(_leagueId, _gamblingId) { // _referParent DEFAULT VALUE SHOULD BE undef IN JAVASCRIPT IF NO REFERER
        ...
        require(_stake >= 5*1e9, "createBet: Minimum Bet $5!");////////////NEED A BETTER WAY TO MULTIPLY THE UINT8 DECIMALS////////////////
