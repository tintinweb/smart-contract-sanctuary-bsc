...
Telegram https://t.me/TwitterOfQatarPortal
channel https://t.me/TOQChannel
*/
...
contract TOQ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Of QATAR";
    string private _symbol = "$TOQ";
    ...
    uint256 public _walletMax = 300 * 10**7 * 10**9;
