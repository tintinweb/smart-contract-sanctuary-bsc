...
contract Staking is Owned{
    ...
    address public AGTNative = 0x9d5758D86998D74F002C218C9967980a238BEb55;
    ...
    function PendingReward(address _caller) public view returns(uint256 _pendingRewardWeis){
        ...
        uint256 reward = ((users[_caller].activeDeposit).mul(_totalStakingTime.mul(_reward_token_second))).div(10 ** 14); // remove extra 10^12 // 10^2 are for 100 (%)
