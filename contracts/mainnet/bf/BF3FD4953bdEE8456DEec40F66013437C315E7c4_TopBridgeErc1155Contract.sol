...
interface IERC1155 is IERC165 {
    ...
    function getErc1155Creators(uint256 id) external view returns (address theId);
    function getErc1155Amounts(uint256 id) external view returns (uint256 theAmount);
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    //      nft_id     creator_address
    mapping(uint256 => address) public erc1155Creators;

    //      nft_id     amount 
    mapping(uint256 => uint256) public erc1155Amounts;
    ...
    function getErc1155Creators(uint256 id) public view virtual override returns (address theId) {
        return erc1155Creators[id];
    }

    function getErc1155Amounts(uint256 id) public view virtual override returns (uint256 theAmount) {
        return erc1155Amounts[id];
    }
}
