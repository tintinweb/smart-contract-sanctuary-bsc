...
contract JeetsAreFucked is IBEP20 {
    string constant _name = "JeetsAreFucked4";
    string constant _symbol = "JAF4";
        ...
        if(letTheJeetsOutEvent) {
            response = string(
                abi.encodePacked(
                    ...
                    " buys left until the party is crashed and the jeets get rekt. \n Current sell tax is ",
                    uintToString(tax * sellMultiplier  + (jeetTax - sells)),
                    "% and will go down by 1% with every sell. \n Only ",
