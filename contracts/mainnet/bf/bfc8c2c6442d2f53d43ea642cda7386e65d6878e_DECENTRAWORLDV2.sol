...
contract DECENTRAWORLDV2 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xA227531Ea4B78a61643B05d963A9767f805D51B1;

    string constant _name = "DECENTRAWORLDV2";
    string constant _symbol = "DEWOV2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000;

    uint256 public _maxTxAmount = 30000;
    uint256 public _maxWalletToken = 30000;
