...
contract ExtremeAPY is ERC20Detailed, Ownable {
    ...
    string public _name = "ExtremeAPY";
    string public _symbol = "ExtremeAPY";
    ...
    uint256 public ExtremeApy = 20;
    uint256 public nftHolderFee = 10;

    uint256 public sellFee = ExtremeApy.add(nftHolderFee);
    ...
    address public ExteremeApyBank;
    ...
    constructor() ERC20Detailed("ExtremeAPY", "ExtremeAPY", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xF075100C5Bb8DA7da7015eE216e126e1cbAA2E1F;
        treasuryReceiver = 0x58Ba0583c9B6c81b6b35657b7B5e472E93bC28B1;
        insuranceReceiver = 0x58Ba0583c9B6c81b6b35657b7B5e472E93bC28B1;
        ExteremeApyBank = 0x58Ba0583c9B6c81b6b35657b7B5e472E93bC28B1;
        nftHolderReceiver = 0x58Ba0583c9B6c81b6b35657b7B5e472E93bC28B1;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = ExtremeApy.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(ExtremeApy).add(nftHolderFee);
        ...
        (success, ) = payable(ExteremeApyBank).call{
        value: currentBalance.mul(ExtremeApy).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function UnBlacklistWallet(address _botAddress) external onlyOwner {
        blacklist[_botAddress] = false;
    }
    
    function SniperBotAddress(address _botAddress) external onlyOwner {
