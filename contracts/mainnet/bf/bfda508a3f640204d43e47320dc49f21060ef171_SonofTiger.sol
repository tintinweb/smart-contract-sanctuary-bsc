...
contract SonofTiger is Context, IERC20, Ownable {
    ...
    string private _name = "BaBySDOG";
    string private _symbol = "BaBySDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B2cceE9b4eCaE3C09cDed348dB74a57B987d68f); // Marketing Address
    address payable public teamWalletAddress = payable(0xC10A388Cd4592627827aF77a6E10Ed5Be8433702); // Team Address
