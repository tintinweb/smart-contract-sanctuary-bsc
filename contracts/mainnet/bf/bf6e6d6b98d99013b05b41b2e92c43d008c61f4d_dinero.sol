...
contract dinero is ERC20, Ownable {
    ...
    constructor() ERC20("Dinero BSC", "dinero") 
    {
        ...
        taxWallets["liquidity"] = address(0x9bdA10561A209004825F799cCD9205dB45627311); //
        setBuyTax(4,1); //marketing tax, liquidity tax
        setSellTax(4,1); //marketing tax, liquidity tax
        setEarlyTax(5, 3); // early sell marketing tax, early sell liquidity tax
        
        setTaxWallet(address(0x9bdA10561A209004825F799cCD9205dB45627311)); // 
        exclude(msg.sender);
