...
contract DreamFounDerSwapToken is Context, IERC20, Ownable {
    ...
    string private _name = "Dream Fouder Token";
    ...
    address public mainAddres = address(0x75094520841440545EDCf152c492e13E08DBfC0B);
    address public marketAddress = address(0x622Bad942337d37a6d94AC40dddC6497129433de);
    address public fundAddress = address(0xD590E37B9337EB24E84A0a47612C470D7a140783);
    address public liquidAddress = address(0x5E4919a10C0593b6Ca889FDCB438d9ca52d2c5a3);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 6000 * 10 ** 18 
        ...
        _takeLiquidity(sender, tElseFee / 3); // 3%
        _takeBurn(sender, tElseFee / 2);      // 2%
        _takeMarket(sender, tElseFee / 3);   // 3%
        _takeFund(sender, tElseFee / 5);     // 5%
