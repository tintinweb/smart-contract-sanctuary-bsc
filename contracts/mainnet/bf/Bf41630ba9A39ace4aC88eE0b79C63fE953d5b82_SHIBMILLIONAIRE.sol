...
// Telegram: https://t.me/SHIBMILLIONAIREBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA59b664e0c52D226c3461Fae6F302E7cbc7a1e59; // owner address
...
contract SHIBMILLIONAIRE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIB MILLIONAIRE";
    string private _symbol = "SHIB";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xA59b664e0c52D226c3461Fae6F302E7cbc7a1e59); 
    address payable public teamWalletAddress = payable(0xA59b664e0c52D226c3461Fae6F302E7cbc7a1e59);
