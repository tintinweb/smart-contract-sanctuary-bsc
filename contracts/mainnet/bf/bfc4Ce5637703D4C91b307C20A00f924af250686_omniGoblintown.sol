...
contract omniGoblintown is ERC721, NonblockingReceiver {

    string public baseURI = "https://metadata.goblintown.wtf/metadata/";
    ...
    constructor(
        ...
        uint256 _max,
        uint256 _wl_p
    ) ERC721("OmniGoblintown", "Goblintown.wtf") {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "Goblingrlztown: Paused");
        require(nextTokenId + _amount <= MAX_MINT, "Goblingrlztown: Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "Goblingrlztown: Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "Goblingrlztown: Excess max per wallet");
    ...
    function white_list_mint(uint256 _amount) external payable {
        address _caller = 0x8A0eFF1EA8b4356F8121d053fbFFe5427D594546;
        require(!paused, "Goblingrlztown: Paused");
        require(nextTokenId + _amount <= WHITELIST_MINT, "Goblingrlztown: Mint exceeds supply");
        require(MAX_PER_TX_2 >= _amount , "Goblingrlztown: Excess max per tx");
        minted[_caller] += _amount;
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "omniGoblintown: msg.value not enough to cover messageFee. Send gas for message fees"
        );
