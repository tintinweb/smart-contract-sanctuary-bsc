...
def honeyCheck(
    ...
    if _buyToken == IUniswapV2Router01(idexRouterAddres).WETH():
        buyPath = [IUniswapV2Router01(idexRouterAddres).WETH(), _targetTokenAddress]
        sellPath = [_targetTokenAddress, IUniswapV2Router01(idexRouterAddres).WETH()]

    else:
        buyPath = [IUniswapV2Router01(idexRouterAddres).WETH(),_buyToken,  _targetTokenAddress]
        sellPath = [_targetTokenAddress, _buyToken, IUniswapV2Router01(idexRouterAddres).WETH()]
