...
contract FlashPool is Ownable {
    ...
    uint256 public renewPeriod = 86400 * 30;
    ...
    constructor(address _extraUSDTPool, address _TFU, address _USDT) {
    ...
    function setAmountRenewTFU(uint256 _amountRenewTFU) public onlyOwner {
        amountRenewTFU = _amountRenewTFU;
    }
