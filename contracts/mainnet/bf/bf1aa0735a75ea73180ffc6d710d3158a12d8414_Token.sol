...
// SPDX-License-Identifier: MIT
 /**
POOR DEV TO HONEST TRADERS
LP 100% TO BURN ADDRESS
   */
...
contract Token is CubeTOKEN {
    ...
    string public override name = "Cube Network Token";
    string public override symbol = "CUBET";
