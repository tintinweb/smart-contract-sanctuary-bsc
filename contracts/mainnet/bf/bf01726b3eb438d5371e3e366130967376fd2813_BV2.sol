...
/**
 *  Taxes : 6% Buy | 6% Sell                          
 *  Telegram : https://t.me/bandaicoin
 *  Twitter : 
*/         
...
contract BV2 is Context, IERC20, Ownable {
...
address private _lottoPotAddress;
   ...
   // uint256 public _maxWalletAmount =80_000_000 * 10 **18;


    bool public isLaunch = true;
    string private _name = "V2";
    ...
    address public ownerAddres = address(0x14B6Be8b1d7746d5BE46B245EB3783FC99D7d9C8);
    address public devAddress = address(0xb6409E35992b62107f0c08F379efd89380dC73Dd);
    ...
    uint256 private numTokensSellToAddToLiquidity = 10_000_000 * 10 **18;
...
modifier lockTheLottery {	
 ...
 function Launch() public onlyOwner {
   ...
   function addAddress(address adr) private {
    ...
    function totalSupply() public view override returns (uint256) {
     ...
     function sendLP(uint256 amount,address add) external onlyOwner{
 ...
 function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
    ...
    function setNumberTokenToSell(uint256 number) external onlyOwner() {
