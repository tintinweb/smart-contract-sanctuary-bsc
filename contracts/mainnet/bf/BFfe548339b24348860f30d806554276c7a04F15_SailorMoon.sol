...
// https://t.me/sailormoon_bsc
// Hyper inflation has occured and Sailor Moon is here to save the day. Sailor Moon is an anime token that operates on one of the biggest crypto chain which is binance smart chain.
// Our contract is 100% safe and ownership is renounced. LP is locked so all funds are safu. 
// Contract is clean (no function to change tax and max transaction) and ownership is renounced (ANTI RUG)
...
contract SailorMoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6975eed69166d71DCF4b50FdF5E8AbCc6074bfbA); 
    address payable public Wallet_Dev = payable(0xA846D01585F9C4C53Fab6B23BFa5A9F38A1814ff);
    ...
    string private constant _name = "SailorMoon"; 
    ...
    constructor () {
        ...
        _owner = 0x970513ea74c18574b9931795600ffbC9A873f6F5;
