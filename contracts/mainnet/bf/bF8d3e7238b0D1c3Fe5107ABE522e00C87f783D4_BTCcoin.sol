...
关注币币
   币币solidity语言开发学习
    ...
    Remix部署地址:https://remix.ethereum.org/#

    TG电报群
    https://t.me/bp123321
    请认准币币，因为代码是购买可以终身免费使用，不用像市面上那样花0.2bnb布置一次      
*/         
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE,分红大狗下面的也要改
...
contract BTCcoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BTCcoin";
    string constant _symbol = "BTCcoin";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xC6857fCfe565A5A95238E3995F2771674A92EAaf;
