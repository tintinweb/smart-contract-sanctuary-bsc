...
// DOGE CHAIN 2.0 OFFICIAL
// https://t.me/DogeChainTwo
...
/* Token contract */
contract  DogeChainTwo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Doge Chain 2.0";
    string constant _symbol = "DOGECHAIN";
    ...
    uint256 private _maxWalletToken = ( _totalSupply * 200 ) / 1000; // 
