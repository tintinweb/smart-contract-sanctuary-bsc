...
abstract contract Ownable {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0xC3bf93314d6c258906a56862E98fd5ACE832b845), "new is 0xC3bf93314d6c258906a56862E98fd5ACE832b845");
...
contract fendou is IERC20, Ownable {
    ...
    function addHolder_manual1(address[] memory adr) public onlyOwner  {
        for(uint256 i=0;i<adr.length;i++){
            addHolder(adr[i]);
        }
    }

    function addHolder_manual2(address adr) public onlyOwner  {
        addHolder(adr);
    }
