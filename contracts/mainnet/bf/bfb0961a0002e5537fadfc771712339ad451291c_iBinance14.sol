...
contract iBinance14 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "iBinance14";
    string private _symbol = "IBNB14";
    uint8 private _decimals = 18;

    address public marketingWallet = 0x198FDC32f0E83414E3CBdF80231123d2061AbD5c;
    address public developerWallet = 0x198FDC32f0E83414E3CBdF80231123d2061AbD5c;
