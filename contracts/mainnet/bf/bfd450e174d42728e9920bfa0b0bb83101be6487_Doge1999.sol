...
/**
Telegram : https://t.me/Doge1999official
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5E029A19363D31FB71E1855f6Daf7CB725729E0b; // owner address
...
contract Doge1999 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge 1999";
    string private _symbol = "DOGE99";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5E029A19363D31FB71E1855f6Daf7CB725729E0b); // Marketing Address
    address payable public teamWalletAddress = payable(0x5E029A19363D31FB71E1855f6Daf7CB725729E0b); // Team Address
    ...
    uint256 public _walletMax = 1980000000 * 10**_decimals;
