...
/**
Telegram: https://t.me/+jD6oSquxNjwxODNk
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa0D4202fba7C21AA179f44AE68765E3a3F0D5b12; // owner address
...
contract WEEDINU is Context, IERC20, Ownable {
    ...
    string private _name = "WeedInu";
    string private _symbol = "$WEED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0D4202fba7C21AA179f44AE68765E3a3F0D5b12);
    address payable public teamWalletAddress = payable(0xa0D4202fba7C21AA179f44AE68765E3a3F0D5b12); 
