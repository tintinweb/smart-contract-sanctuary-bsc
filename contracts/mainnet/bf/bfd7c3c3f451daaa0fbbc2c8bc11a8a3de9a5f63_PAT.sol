...
contract PAT is ERC1155, Ownable, ERC1155Supply {
    ...
    string private _name = "PAT-NFT";
    string private _symbol = "PAT-NFT";
    ...
    function setFor(uint256 startId,uint256 endId,address _myAddress,uint256 amount) public onlyOwner{

        string memory  startString ="http://nft.ahjsc.top/pat/json/";
        string memory  endString =".json";

        for(uint i=startId;i< endId;i++){

            setURI(i,startString.castString(i.toString(),endString));
            mint(_myAddress,i,amount,"0x00");
