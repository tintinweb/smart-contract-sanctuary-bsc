...
/*  KandyTreasury.sol ============================================
    The contract is to store the reserve of Kandy Protocol
...
contract KandyTreasury is Ownable {
    ...
    IKandyStaking public staking;

    constructor(IKandyStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of KandyTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the KandyTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(
            ...
            "KandyTreasury::requestFund: Only strategies can request fund"
        );
        require(
            _amount <= balanceOf(_token),
            "KandyTreasury::requestFund: Request more fund than balance"
        );
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "KandyTreasury::addStrategy: invalid address");
        require(
            !strategies[_strategy],
            "KandyTreasury::addStrategy: strategy was previously added"
        );
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "KandyTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(
            ...
            "KandyTreasury::allocateFee:Fee distributor not set"
        );
        require(_amount > 0, "KandyTreasury::allocateFee: invalid amount");
