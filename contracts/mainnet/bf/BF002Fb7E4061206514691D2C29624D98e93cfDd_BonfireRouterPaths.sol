...
contract BonfireRouterPaths is IBonfireRouterPaths, Ownable {
    ...
    address public constant override tokenFactory =
        address(0xBF00b7215a747A9775b6771773877e0E60F00084);
    ...
    constructor(address admin) Ownable() {
        ...
        ] = address(0xbfbc05802580EaD13D7528dE26229Cb24eeF577c);
    }
    ...
    function isWrapper(address pool) internal view returns (bool) {
        return pool == wrapper;
    }
