...
/*
    ...
    ⭐️With #MetaSimpsons you really can take the reality of living and dreaming into a virtual world. 
    ...
    where you choose your path of success within the MetaSimpsons world.

    🎮⭐️MetaSimpsons Game Summary ; 
    🗣️MetaSimpsons #Characters ; Each player will create their own #identity with specific characteristics, 
    #skills and attributes. These chosen skills will allow you to browse the MetaSimpsons in-game world to 
    complete different daily tasks for fun!

    💎🚙🏘MetaSimpsons #Assets ; Like any real world, once you earn your #MetaSimpsons you can exchange them 
    ...
    🌇MetaSimpsons #City ;In the game our first city will be designed for in game player interaction, with #tasks, 
    #skills and #games. The more successfull you are at completeing such interactions the more you are rewarded.

    🌆🖼MetaSimpsons #Marketplace ; Game items could both be traded through the in-game #marketplace and also the 
    NFT marketplaces on other blockchains. It creates #liquidity for the assets created through the game and also 
    encourages more players to participate in building the the MetaSimpsons world.

    💰💸MetaSimpsons #Reflections
    Earn $METAS by just holding #MetaSimpsons in your wallet. 2% of every buy and sell transaction is distributed to 
    #MetaSimpsons holders.

    🌍Web       : https://MetaSimpsons.io
    🔎Telegram  : https://t.me/MetaSimpsonsio
    🕊Twitter    : https://www.twitter.com/MetaSimpsonsio
    🖼️Instagram : https://instagram.com/MetaSimpsons
    🎮Discord   : https://discord.gg/Y99HVSHQzW
    🎄 Linktree : https://linktr.ee/MetaSimpsons

    TOKENOMICS
    1,000,000,000,000,000,000 METAS
    🔥%60 Supply burnt
    💦%40 Supply Add to LP
    ⭐️Tax Fee %6 ; 👥%2 to Holders ,💰%2 to Marketing ,🎁%2 to
...
contract MetaSimpsons is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Meta Simpsons";
    string private constant _symbol   = "METAS";
