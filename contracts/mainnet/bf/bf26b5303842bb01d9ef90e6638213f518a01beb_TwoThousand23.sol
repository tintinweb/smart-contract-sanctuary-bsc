...
contract AbsToken is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        minimumTokensBeforeSwap = _supply * 4 ** _decimals;
...
contract TwoThousand23 is AbsToken{
    constructor() AbsToken (
        address(0xb1eD443907613e3ebd9D661C4B6d09a84F0ecC0D),    //The address receive the token
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),    //Router
        "2023",                                                 //The name of the token
        "2023",                                                 //The symbol of the token
        20230000                                                //Total supply of the token
    ) {}
}