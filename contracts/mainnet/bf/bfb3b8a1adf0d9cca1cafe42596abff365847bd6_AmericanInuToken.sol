...
contract AmericanInuToken is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "American Inu Token";
    string constant _symbol = "AIT";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 1_000_000_000 * (10 ** _decimals);


    uint256 public _maxTxAmount = (_totalSupply * 1) / 8000; //~1.25%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 4000; //~2.5%
    ...
    uint256 antiDumpPeriod = 10 minutes;
    ...
    uint256 public swapThreshold = _totalSupply / 4000; //2.5%
