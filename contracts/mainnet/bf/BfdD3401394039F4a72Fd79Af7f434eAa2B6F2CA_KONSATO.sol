...
contract KONSATO is KONSATODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private KONSATOTeam;
    address private CharityKONSATO;
    ...
    string public override name = "Konsato";
    string public override symbol = "KONSATO";
    ...
    constructor(uint totalSupplyValue, address KONSATOTeamAddress, address CharityKONSATOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        KONSATOTeam = KONSATOTeamAddress;
        CharityKONSATO = CharityKONSATOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[KONSATOTeam] =  totalSupply * 4 / 100;
        balances[CharityKONSATO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KONSATOTeam pot
