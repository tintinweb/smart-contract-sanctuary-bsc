...
contract CrazyPanda is BEP20, Ownable {
    ...
    address public BNBVaultWallet = 0x042763708422ac1D38b2c76090369E11aB312BE1;
    ...
    Taxes public sellTaxes = Taxes(3, 1);
    ...
    constructor() BEP20("CrazyPanda", "BAMBOO") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 BNBVaultAmt = unitBalance * 2 * swapTaxes.BNBVault;
            if (BNBVaultAmt > 0) {
                payable(BNBVaultWallet).sendValue(BNBVaultAmt);
            }
    ...
    function SetBuyTaxes(
        ...
        require((_BNBVault + _liquidity) <= 10, "Must keep fees at 10% or less");
        taxes = Taxes(_BNBVault, _liquidity);
    }
    ...
    function SetSellTaxes(
        ...
        require((_BNBVault + _liquidity ) <= 10, "Must keep fees at 10% or less");
        sellTaxes = Taxes(_BNBVault, _liquidity);
    }
    ...
    function updateBNBVaultWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0),"Fee Address cannot be zero address");
        BNBVaultWallet = newWallet;
    }
