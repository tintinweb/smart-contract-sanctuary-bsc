...
contract TokenStakingPool is Ownable {
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken,bool _enableBonus, address _bonusToken, address _swapPairAddress, uint256 _lockSeconds , bool _withUpdate) public onlyAdmin {
