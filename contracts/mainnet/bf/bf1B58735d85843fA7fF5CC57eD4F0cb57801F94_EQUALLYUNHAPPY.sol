...
contract EQUALLYUNHAPPY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EQUALLY UNHAPPY";
    string private _symbol = "EQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92d172E8f3fF11BA2286f276a503222987b7Bb4A);
    address payable public teamWalletAddress = payable(0xaDd824761Fa4822cDFFC642E77d644cEfE863E9c);
