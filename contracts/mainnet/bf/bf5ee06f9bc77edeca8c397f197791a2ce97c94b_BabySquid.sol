...
//telegram: https://t.me/BabySquidGameTwo
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SQUI = IERC20(0xBB5A9067A1419b994EC917878B3275be77BEF016);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SQUI.balanceOf(address(this));
        ...
        uint256 amount = SQUI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SQUI.transfer(shareholder, amount);
...
contract BabySquid is IERC20, Ownable {
    ...
    address SQUI = 0xBB5A9067A1419b994EC917878B3275be77BEF016;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Squid Game 2.0";
    string constant _symbol = "BABYSQUID2.0";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xB322591F245fF6f32AfA6d4789Ee16B93Be9a464);
        marketingFeeReceiver = address(0xB322591F245fF6f32AfA6d4789Ee16B93Be9a464);
