...
contract KILLAZCOKEZERO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x388eCfAaB34A9D53168Ca6914f9C8Edc0518c9eb); // Marketing Address
    ...
    string private _name = "killazero";
    string private _symbol = "Killz0";
    ...
    uint256 private buyBackUpperLimit = 20000000000 * 10**18;
