...
contract SquidSaudi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Saudi";
    string private constant _symbol = "SquidSaudi";
