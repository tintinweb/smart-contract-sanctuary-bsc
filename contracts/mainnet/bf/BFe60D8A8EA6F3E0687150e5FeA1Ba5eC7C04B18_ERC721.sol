...
// File: contract/wkong/token/ERC721/IERC721Metadata.sol
...
// File: contract/wkong/token/ERC721/IERC721Enumerable.sol
...
// File: contract/wkong/token/ERC721/IERC721Receiver.sol
...
// File: contract/wkong/introspection/ERC165.sol
...
// File: contract/wkong/math/SafeMath.sol
...
// File: contract/wkong/utils/Address.sol
...
// File: contract/wkong/utils/EnumerableSet.sol
...
// File: contract/wkong/utils/EnumerableMap.sol
...
// File: contract/wkong/utils/Counters.sol
...
// File: contract/wkong/token/ERC721/WkongERC721.sol
...
contract ERC721 is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Mapping from token ID to  nft level
    ...
    function mintNft(address receiver, string memory tokenURI, uint256 level) public virtual override onlyWhiteListAccount returns (uint256) {
        _tokenIds.increment();
        ...
        emit MintNft(receiver, tokenId, level);
        return tokenId;
    }
    
    function setTokenURI(uint256 tokenId, string memory tokenURI, uint256 level) public virtual override onlyWhiteListAccount {
        _nftLevel[tokenId] = level;
        _setTokenURI(tokenId,tokenURI);
    }

    function getCurrentTokenId() public view virtual override returns (uint256) {
        return _tokenIds.current();
    }

    function getNftLevel(uint256 tokenId) public view virtual override returns (uint256) {
    ...
    */
     ...
     * Emits a {Transfer} event.
     */
    function _transfer(address from, address to, uint256 tokenId) internal onlyNotPause onlyWhiteList virtual {
