...
contract SaudiArabiaGOAT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2f1aC911A8f88c3eb9D606A2E7cdBE43751eFe38); // Marketing Address
    ...
    string private _name = "Saudi Arabia GOAT";
    string private _symbol = "SAGOAT";
