...
contract ElonTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Trust";
    string private _symbol = "ELONTRUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64C10cDe9ab3e813D1021819F79c776FfDBd2f42); // Marketing Address
    address payable public teamWalletAddress = payable(0x64C10cDe9ab3e813D1021819F79c776FfDBd2f42); // Team Address
