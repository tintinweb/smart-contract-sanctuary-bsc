...
contract DRAGONV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DRAGONV2";
    string private _symbol = "DRAGONV2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xcfc91336aD7192f311669cEAAC71cbCda55f3C1b);
