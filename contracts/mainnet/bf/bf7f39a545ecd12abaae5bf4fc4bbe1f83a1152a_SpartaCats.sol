...
/*
   ...
   _____                  _         _____      _       
  / ____|                | |       / ____|    | |      
 | (___  _ __   __ _ _ __| |_ __ _| |     __ _| |_ ___ 
  \___ \| '_ \ / _` | '__| __/ _` | |    / _` | __/ __|
  ____) | |_) | (_| | |  | || (_| | |___| (_| | |_\__ \
 |_____/| .__/ \__,_|_|   \__\__,_|\_____\__,_|\__|___/
        | |                                            
        |_|                                            

https://spartacats.com

*/


contract SpartaCats is Context, ERC721Burnable {

    using SafeMath for uint256;
    using Strings for uint256;


    string public constant BASE_URL = "https://spartacats.com/daonft/";
    int public constant MAX_NFTS = 300;
    int public currentNftCount = 0;
    ...
    constructor() public ERC721("SpartaCats DAO NFT", "PurrDAO") {
        _owner = _msgSender();
    }
    

    function mint(address to, uint256 tokenId) _ownerOnly public{

        currentNftCount++;

        require(currentNftCount <= MAX_NFTS, "Nft limit exceed" );
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(BASE_URL, tokenId.toString(), "_metadata.json"));
    }
