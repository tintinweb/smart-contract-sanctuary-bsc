...
Telegram : https://t.me/TeleMetaverseBSC
Tele Metaverse is a token based on the BSC network, 
which will grow with a solid and strong community.
✅ SAFU    
✅ Solid Community    
✅ LP Lock    
✅ Renounced 
...
contract TeleMetaverse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tele Metaverse";
    string private _symbol = "TMV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC2860ad84650cdcd13B490C4cd9A080C12A039C7); 
    address payable public teamWalletAddress = payable(0xC2860ad84650cdcd13B490C4cd9A080C12A039C7); 
    ...
    uint256 public _walletMax =  2500000000000 * 10**9; 
