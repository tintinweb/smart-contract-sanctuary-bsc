...
contract XCNv2 is IBEP20, Auth {
    ...
    string constant _name = "Chain V2";
    string constant _symbol = "XCNv2";
    ...
    uint256 public swapThreshold = _totalSupply * 100834766 / 10000000000; // 0.15% of supply
    bool inSwap;
