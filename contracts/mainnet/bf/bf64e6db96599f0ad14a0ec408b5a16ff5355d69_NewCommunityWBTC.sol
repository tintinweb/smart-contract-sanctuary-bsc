...
/* Token contract */
contract NewCommunityWBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x9Fc93fbaD0961ED9715a13fC3c84E25C064cC80A;
    ...
    // Name and symbol
    string constant _name = "New Community WBTC";
    string constant _symbol = "cWBTC";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 550000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9Fc93fbaD0961ED9715a13fC3c84E25C064cC80A;
