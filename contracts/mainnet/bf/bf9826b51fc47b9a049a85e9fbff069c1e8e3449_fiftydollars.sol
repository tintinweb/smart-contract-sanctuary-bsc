 ...
 * $50 A cryptocurrency movie
 * Real-time Movie Script of a cryptocurrency
 * “Delon started with only fifty dollars!”
 * Follow the scenario stages and Director +CAST+ Producer interviews on our website! 
*/
...
// https://t.me/fiftydollarsmovie
// https://fiftydollarsmovie.com/
// https://twitter.com/FiftydollarsM
...
/* Token contract */
contract fiftydollars is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x597ac5b124ddae908aC836bf5AFCAAfF00738Aa5; // Wallet Developer Think
    ...
    // Name and symbol
    string constant _name = "fiftydollars";
    string constant _symbol = "50";
    ...
    uint256 public marketingFeeBuy = 2; //  Scriptwriting and awareness costs
    uint256 public devFeeBuy = 0; // Continue Development and Charity
    uint256 public totalFeeBuy = 4; //  Not more that 4% Total Tax
    ...
    uint256 public marketingFeeSell = 6; // Scriptwriting and awareness costs
    uint256 public devFeeSell = 0; // Continue Developers and Charity
    uint256 public totalFeeSell = 8; //  Not more that 8% Total Tax
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x597ac5b124ddae908aC836bf5AFCAAfF00738Aa5; // Wallet Marketing Work
