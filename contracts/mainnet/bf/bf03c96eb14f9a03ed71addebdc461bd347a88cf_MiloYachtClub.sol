...
// TOKEN: Milo Yacht Club
// TG:    https://t.me/MiloYachtClub
// WEB:   https://MiloYachtClub.com
// FARM:  https://MYC.Farm or via the main website
...
contract MiloYachtClub is ERC20, Ownable {
    ...
    constructor() ERC20("MiloYachtClub", "MYC", 18) {
    	...
    	marketingWallet = address(0xF1705F1e3b3B074257B4F5960Abb2bB31Ec3bC2f); // set as marketing wallet
    	liquidityWallet = address(0x31520840765d2032141ABC7621bd1e71920B2b54); // set as liquidity wallet
        stakingAddress = address(0x1a5cd378F149D23F948259A0180437Cf4CBD4e63); // set as staking wallet / contract
        jumpStartWallet = address(0x1a5cd378F149D23F948259A0180437Cf4CBD4e63); // set as Jump Start wallet
        utilityWallet = address(0x702B7E3B3F2bBa621Fd74693E08f8428f78B51a5); // set as utility wallet
