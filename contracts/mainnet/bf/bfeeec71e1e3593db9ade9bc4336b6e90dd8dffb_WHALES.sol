...
Telegram : https://t.me/whalescoinbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37A02363B53B51a55d0c4835594609491cFe357b;
...
contract WHALES is Context, IERC20, Ownable {
    ...
    string private constant _name = "WHALES COIN"; // 
    string private constant _symbol = "$WHALES"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xD45f03b56db710863E468CC3EC406ae0a147A331);
