...
contract ninetyone is ERC20 {

    uint tokenTotalSupply = 91; // 404 token supply

    constructor() public ERC20("123", "123") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 123 * 10**6 * 10**9;
    ...
    uint256 public _maxTxAmount = 123 * 10**6 * 10**9;
