...
contract binance is Context, IERC20, Ownable {
    ...
    string private _name = "binance never die";
    string private _symbol = "BND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14C2939fFC9620774Ad80B8AC84Ae820131c5AF8);
    address payable public BuyBackWalletAddress = payable(0xb8d124D5aC508E083C9D7d4F96f9efc8b81b1C3D); 
    ...
    uint256 public _walletMax = 25000000 * 10**9;
