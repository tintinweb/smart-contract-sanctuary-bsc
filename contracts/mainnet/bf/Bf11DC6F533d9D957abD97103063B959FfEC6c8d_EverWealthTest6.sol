...
contract EverWealthTest6 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    EverWealthTest6DividendTracker public dividendTracker;
    ...
    constructor() ERC20("EverWealthTest6", "WEALTHTest6") {
        ...
        dividendTracker = new EverWealthTest6DividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "EverWealthTest6TRACKER",
            "WealthTest6TRACKER"
        );
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            require(balanceOf(from).sub(amount) >= tokensLocked[from], "Tokens are locked for double rewards");
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 _marketDeadTotal = sellMarketingFees.add(sellDeadFees) + buyMarketingFees.add(buyDeadFees);
        ...
        if (deadPayout > 0) {
            ...
            _totalSupply = _totalSupply - (buyDeadFees + sellDeadFees);
        }
...
contract EverWealthTest6DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EverWealthTest6 public EverWealthTest6Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        EverWealthTest6Contract = EverWealthTest6(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EverWealthTest6_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EverWealthTest6_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EverWealthTest6 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EverWealthTest6Contract);

            uint256 prevBalance = EverWealthTest6Contract.balanceOf(address(this));
            ...
            {
                uint256 received = EverWealthTest6Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EverWealthTest6Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
