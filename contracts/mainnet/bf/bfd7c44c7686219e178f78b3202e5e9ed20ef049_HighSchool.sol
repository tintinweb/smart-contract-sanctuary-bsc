...
contract HighSchool is Context, IERC20, Ownable {
    ...
    string private constant _name = "High School"; // 
    string private constant _symbol = "DXD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xFcC185bFd682cBBF0859faD6bA703Ee1Bdb7C2cd;
