...
contract SkimmingCall is IBonfireStrategicCalls, Ownable {
    address public constant paths =
        address(0xBFff8640ba65E2Ca61a144Ad5aB89FC5b68444AF);
        ...
        external
    {
        bool included = false;
        require(
            IBonfireRouterPaths(paths).uniswapFactoryEnabled(uniswapFactory),
            "SkimmingCall: factory not allowed"
        );
    ...
    function removePool(address pool) external {
        ...
        require(i < pools.length, "SkimmingCall: pool not found");
