...
contract BabyRenmine is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner; 
    
    string private constant _name = " Baby Renmine";
    string private constant _symbol = unicode" BRenmine ";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0x6bA57F86E0D6F18EF6c76cddDDDf85606cA7Cf31);
    address payable public MarketingWallet = payable(0x6bA57F86E0D6F18EF6c76cddDDDf85606cA7Cf31);
