...
=========== ALICE IN BORDERLAND ===========
TELEGRAM: https://t.me/aliceinborderlnd
TWITTER: https://twitter.com/Alice_Bordrland
WEBSITE: OUTSIDE THE BORDER (UNDER MAINTENANCE)
...
contract AIB_LAND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALICE IN BORDERLAND";
