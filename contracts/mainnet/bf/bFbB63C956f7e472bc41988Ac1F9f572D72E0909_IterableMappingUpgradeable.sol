...
contract OREO is Initializable, ERC20Upgradeable, OwnableUpgradeable {
...
//=======FeeManagement=======//
    ...
    function setSpecialFees(address[] memory accounts, uint256 fee) external onlyOwner{
        require(fee <99, "Fee is too high");
    ...
    function changeBuybackToken(address _buybackToken) external onlyOwner {
        ...
        require(isContract(_buybackToken), "Buyback token cannot be a contract");
