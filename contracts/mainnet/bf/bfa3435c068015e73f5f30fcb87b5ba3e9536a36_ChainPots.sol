...
contract ChainPots {
    ...
    uint256 public silverBattleEntryPrice = 0.05 ether;
    uint256 public silverBattlePotMaxAmount = 0.1 ether;
    uint256 public silverBattleMaxEntries = 2;
    bool public silverBattleIsLive = true;

    address payable[] public playersGoldBattle;
    uint256 public goldBattleEntryPrice = 0.1 ether;
    uint256 public goldBattlePotMaxAmount = 0.2 ether;
    uint256 public goldBattleMaxEntries = 2;
    bool public goldBattleIsLive = false;

    address payable[] public playersDiamondBattle;
    uint256 public diamondBattleEntryPrice = 0.5 ether;
    uint256 public diamondBattlePotMaxAmount = 1 ether;
