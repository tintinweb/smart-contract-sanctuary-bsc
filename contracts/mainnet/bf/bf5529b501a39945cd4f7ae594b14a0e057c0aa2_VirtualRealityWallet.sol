...
contract VirtualRealityWallet is  Context, IERC20, Ownable {
    ...
    string private _name = "Virtual Reality Wallet";
    string private _symbol = "VRG";
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**8 * 10**18;
