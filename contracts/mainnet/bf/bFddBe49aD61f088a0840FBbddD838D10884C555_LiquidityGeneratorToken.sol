...
/**
 * Telegram https://t.me/lambodoge2
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x741cC5c7D500933f21fE44683DBdFe69320449a9; // owner address
...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x741cC5c7D500933f21fE44683DBdFe69320449a9); // Marketing Address
    address payable public teamWalletAddress = payable(0x741cC5c7D500933f21fE44683DBdFe69320449a9); // Team Address
