...
contract Plus380 is IBEP20, Auth {
    ...
    string constant _name = "+380";
    string constant _symbol = "+380";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 380 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0x4b611b876E91378763199cEe19694908461d06bd;
    address private teamFeeReceiver =0x3E3Bd281430DE2851F90A3D7C743E55e50576c98;
    ...
    uint256 public swapThreshold = _totalSupply / 10 * 3; // 0.3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0xd6B2dE38B6A5851Ee2B0B08362a02c97C00F7E7a;
