...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x4bdbB1F2B93FF9A2be377A4EcbEed3fDCCD77240;
...
contract QatarApesBurn is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Qatar Apes Burn"; 
    string private constant _symbol = unicode"QAB"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x4bdbB1F2B93FF9A2be377A4EcbEed3fDCCD77240), BNB_Tot);
            }
