...
/**
 * @dev Interface of the CCG ERC20 standard as defined in the EIP.
 */
interface IERC20 {
    /**
     * @dev Returns the total supply amount of CCG in existence.
     */
    function totalSupply() external view returns (uint256);

    /**
     * @dev Returns the amount of CCG owned by a special `account`.
     */
    function balanceOf(address account) external view returns (uint256);

    /**
     * @dev Moves `amount` of CCG from the caller's account to another address of the caller’s choice.
     *
    ...
    /**
     * @dev Returns the remaining number of CCG that a user will be
     * allowed to spend on behalf of `owner` through {transferFrom}. This is
     * zero by default.
     *
     * This value changes when approved {approve} or transferred {transferFrom} are          called.
     */
    function allowance(address owner, address spender) external view returns (uint256);

    /**
     * @dev Sets `amount` as the allowance of `spender` over the caller's CCG.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
    ...
    /**
     * @dev Moves `amount` CCG from `from` to `to` using the
    ...
    /**
     * @dev Emitted when `value` CCG are moved from one account (`from`) to
     * another (`to`).
     *
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        unchecked {
            // Gas optimization for CCG: this is cheaper than requiring 'a' not being zero, but the
...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Initializes the contract setting the CCG team deployer as the initial owner.
     */
    constructor() {
...
contract CryptotestGems is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x270d445bcc2d1549589D2dE7412268c21b13bF36));
    address payable public _devwallet =
        payable(address(0x6315Eb369e51DDF9dD03395998e803ED95602569));
    address private _donationAddress =
        0x5e1A90b871BFFb7842Aa8b7A45e022430C36E526;

    string private _name = "Crypto test Gems";
    string private _symbol = "CCtestG9";
    ...
    function _transfer(
        ...
        // is the CCG balance of this contract address over the min number of
        // CCGs that we need to initiate a swap + liquidity lock?
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate the uniswap pair path of CCG -> weth
