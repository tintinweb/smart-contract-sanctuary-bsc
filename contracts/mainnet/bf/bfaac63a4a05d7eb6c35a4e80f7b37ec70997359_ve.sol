...
contract ve is IERC721, IERC721Metadata, Ownable {
    ...
    string public constant name = "veBCXS";
    string public constant symbol = "veBCXS";
    ...
    /// @param token_addr `ERC20_BCXS` token address
