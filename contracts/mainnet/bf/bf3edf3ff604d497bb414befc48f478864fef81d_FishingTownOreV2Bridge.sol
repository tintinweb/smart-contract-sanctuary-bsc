...
// File: contracts/FishingTownOreBridge.sol


pragma solidity 0.8.10;


contract FishingTownOreV2Bridge is BridgeBase {
    constructor(address _token) BridgeBase(_token) EIP712("FishingTownOreBridge","1") {}
}