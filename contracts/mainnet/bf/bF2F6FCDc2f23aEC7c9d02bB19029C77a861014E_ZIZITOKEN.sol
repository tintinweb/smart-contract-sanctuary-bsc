...
contract ZIZITOKEN is IBEP20, Auth {
    ...
    string constant _name = "ZIZI";
    string constant _symbol = "ziz";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 100 / 1000; // 0.5%
    uint256 public _maxTxAmountSell = _totalSupply * 100 / 1000; // 0.5%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 25 ) / 1000; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x99884Ce6d11DD3eAC33514CD7a6695Ae9Ac162B1;
        marketingFeeReceiver = 0x99884Ce6d11DD3eAC33514CD7a6695Ae9Ac162B1;
        devFeeReceiver = 0x1024173EA04a43456d5EBbdDe80eeBf598E584Dd;
