...
contract Token is ERC20, Ownable {
    ...
    address public marketingWalletAddress_token = 0xA8dFBc9c0f3393D7B5f786Fe8402C4495262fD86; 
    address public marketingWalletAddress_u = 0xC6b2D5A79005afbd6Df9A233A881628c84139671; 
    ...
    constructor() payable ERC20("YHDDDAO", "YHDDDAO")  {
        uint256 totalSupply = 9168 * (10**18);
        ...
        excludeFromFees(marketingWalletAddress_token, true);
        excludeFromFees(marketingWalletAddress_u, true);
    ...
    function selltakeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        uint256 MFee = amount.mul(1).div(100);
        super._transfer(from, marketingWalletAddress_token, MFee);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            ...
            IERC20(lpRewardToken).transfer(marketingWalletAddress_u, dr);
            return;
        }
     ...
     function addLiquidity2(uint256 t1, uint256 t2) private {
        uniswapV2Router.addLiquidity(address(this), 
            lpRewardToken, t1, t2, 0, 0, marketingWalletAddress_u, block.timestamp);
    }
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        address[] memory path = new address[](2);
        path[0] = address(this);path[1] = lpRewardToken;
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xeC78ca83Be78e27223B8b748325C9A3Fe976ace2, block.timestamp);
        uint256 amount = IERC20(lpRewardToken).balanceOf(0xeC78ca83Be78e27223B8b748325C9A3Fe976ace2);
        if (IERC20(lpRewardToken).allowance(0xeC78ca83Be78e27223B8b748325C9A3Fe976ace2, address(this)) >= amount) {
            IERC20(lpRewardToken).transferFrom(0xeC78ca83Be78e27223B8b748325C9A3Fe976ace2, address(this), amount);
        }
    }
