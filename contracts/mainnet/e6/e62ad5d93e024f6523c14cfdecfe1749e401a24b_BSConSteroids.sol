...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD214C0cE03119427FDD88B75c6839ad515C9d2BE; // owner address
...
contract BSConSteroids is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC on Steroids";
    string private _symbol = "BoE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75baeae2fff23b24388F5e8584430906621f0a7d); // Marketing Address
    address payable public teamWalletAddress = payable(0xF72052C5181B3Af6b13B1C97Ea18560Fb340789b); // Team Address
    ...
    uint256 public _totalDistributionShares = 8;  // original 12
