...
/**
KryptoKong
KONGCLUB (SAFU COMMUNITY SOCIAL EXPERIMENT)

Telegram - https://t.me/kongclub
*/
...
contract KryptoKong is IBEP20, Auth {
    ...
    string constant _name = "KryptoKong";
    string constant _symbol = "KONGS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //5% max tx
    uint256 public _maxWalletSize = (_totalSupply *5) / 100;  //7% max wallet
    ...
    address private marketingFeeReceiver =0xBDecEdB6B299d6E9Bf2708A532Aeb99965a63ba9;
    address private teamFeeReceiver =0xBDecEdB6B299d6E9Bf2708A532Aeb99965a63ba9;
