...
// EuroShock Coin $EUS
// As the name suggests this token is for EuroShock
// $EUS aspires to become the currency of the masses, 
// A currency for the community, not the dev or the owner. 🚀🚀🚀

// Total supply: 10 Million
// - 30% Burn
// - 70% Initial Liquidity
// - 0% Dev Wallet (Its Boring)
// - 0% Bullshit (Its Boring)

// RIP HATTERS. RIP GREEDY DEVS

// ⚡️10% fee per transaction
// 2% to holders as rewards & 8% Operations⚡️

// 🔒LP WILL BE LOCKED FOR >30 Days

// ✅ Hard Coded Taxes
// ✅ EUS NFTs
// ✅ BUY LIMIT OF 3% (first 3 mins)
// telegram group link : 
Every 14 days after launch, taxes will be lowered by 1%, to eventually make EuroShock Token a 1% tax token, as development and marketing will mostly be funded by transactions done with our wallet.

- No Team Wallet
- Liquidity Locked
- Contract will be renounced if tax reaches 0%, or if the community decides to want it earlier.

*/

contract EuroShock is ERC20, Ownable {
    ...
    constructor() ERC20("EuroShock Currency", "EUS") {
        ...
        uint256 totalSupply = 1e6 * 1e18; //1e11 * 1e18;
