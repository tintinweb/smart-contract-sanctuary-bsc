...
contract LuckyGodZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyGodZilla";
    string private _symbol = "LuckyGodZilla";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x6E71650392722cac05dFA0D7eEb57cd65ba2497E); 
    address payable private teamWalletAddress = payable(0x0B3222F66753a3439dbf752200929B56F5012Af8); 
