...
contract HinataHyuga is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 75 * 10**_decimals;
    uint256 public maxBuyLimit = 200 * 10**_decimals;
    uint256 public maxSellLimit = 200 * 10**_decimals;
    uint256 public maxWalletLimit = 200 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0x264180a2E5b48E85Fc504ACBb82F4b7014C6694a;
    address public devWallet = 0x264180a2E5b48E85Fc504ACBb82F4b7014C6694a; 
    address public operationWallet = 0x264180a2E5b48E85Fc504ACBb82F4b7014C6694a;
    address public charityWallet = 0x264180a2E5b48E85Fc504ACBb82F4b7014C6694a; 
    ...
    Taxes public taxes = Taxes(1, 6, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(1, 6, 1, 0, 0, 0);
