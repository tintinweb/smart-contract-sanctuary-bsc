...
// Pig Classic Token Is Community Based Token. Low Tax Safu Renounce at 10k
...
contract babyteddydoge is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address RouterV2 = 0xA0943175B66A6CC84B8A99EC474EC77F7A56E61a;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string  _name = "Baby Teddy Doge";
    string  _symbol = "BTD";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xfE8966ff9a775D463452850dfcFbDC66F3819690;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0xBb2022D60c815CEA349bD446742B50553e881FD4;
