...
/*
Telegram: https://t.me/AsukaPortal
Safe Dev
Last Project 230k MC
*/
...
contract Asuka is Context, IERC20, Ownable {
    ...
    string private _name = "AsukaCoin";
    string private _symbol = "ASUKA";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x7Ec2DA7d384386c45473C29a49A978c3c96B84B1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7Ec2DA7d384386c45473C29a49A978c3c96B84B1); // BuyBack Address
