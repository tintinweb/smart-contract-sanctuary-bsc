...
//TELEGRAM : https://t.me/saudimanbsc
...
contract SaudiMan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9Dc3AF249d2B0e9080C12D752dd32dCf2B1C33B0); 
    address payable public Wallet_Dev = payable(0x9Dc3AF249d2B0e9080C12D752dd32dCf2B1C33B0);
    ...
    string private constant _name = "SaudiMan"; 
    string private constant _symbol = unicode"SAUDIMAN"; 
    ...
    constructor () {
        ...
        _owner = 0x9Dc3AF249d2B0e9080C12D752dd32dCf2B1C33B0;
