...
//
//
//   📱Telegram::https://t.me/GetAI
//   📱Website ::https://GetAI.io/
/*
...
contract GetAI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("GetAI", "GetAI") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "GetAI";
    string private _symbol = "GetAI";
