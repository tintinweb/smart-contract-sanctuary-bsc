...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe8251be2ca68A5861d4DBA1a41eA128774eF1a5a; // owner address
...
contract NProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "N Protocol";
    string private _symbol = "N";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8251be2ca68A5861d4DBA1a41eA128774eF1a5a); // Marketing Address
    address payable public teamWalletAddress = payable(0xe8251be2ca68A5861d4DBA1a41eA128774eF1a5a); // Team Address
