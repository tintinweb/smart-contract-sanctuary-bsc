...
contract NFTBuyIn {
 ...
 function getOwner() public view returns (address) {
        ...
        function contribute () payable external {
            require (id <= totalAvailable, "We've hit the limit!");
            require (msg.value >= 1000000000000000000, "Cost price is 1BNB" );
            require (privateOpen == true, "Sale not open yet");
            require (!_contributed[msg.sender] == true, "Wallet already contributed");
            ...
            emit contributed(msg.sender, id.sub(1));
 ...
 function getAllAddresses ()  public view returns (address[] memory){
  ...
  function updateOpenStatus(bool open) external{
      require(msg.sender == owner, "Operation unauthorised");
      privateOpen = open;
  }
  function updateTotalAvailable(uint256 _totalAvailable) external{
      require(msg.sender == owner, "Operation unauthorised");
