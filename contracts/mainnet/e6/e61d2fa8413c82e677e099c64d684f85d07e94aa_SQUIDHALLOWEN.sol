...
// 
//
// 📱 Telegram:https::https://t.me/Hallowensquid
...
contract SQUIDHALLOWEN is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SQUIDHALLOWEN", "SQUIDHALLOWEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SQUIDHALLOWEN";
    string private _symbol = "SQUIDHALLOWEN";
