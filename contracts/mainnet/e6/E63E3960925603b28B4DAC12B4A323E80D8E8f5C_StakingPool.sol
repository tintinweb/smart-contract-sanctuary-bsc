...
contract USDTWrapper {
    ...
    address public hsAddr=address(0x9339d523F58A0c41d0f326B0011DA0189AB9641f);
    address public hbAddr=address(0x036856195b8fD7C4d0d08b8Cf11913E51fCCd0d9);
    address public pairAddr=address(0xe17cf3D900d3c98125C1e65F2724408e68819884);
    ...
    address[] public _fundAddress=[address(0x748299A5DdE7ed8A5Dc14Af8670ECcD16cfB231b),address(0x3e4dB0D177dA6509EdA6649c986Da17A0f5C2278),address(0x3e4dB0D177dA6509EdA6649c986Da17A0f5C2278)];
    uint256[] public _rate=[70,20,10,20,80,30,70];
    uint256 public perDayReward=180;
    address public _collectAddress=address(0x748299A5DdE7ed8A5Dc14Af8670ECcD16cfB231b);
