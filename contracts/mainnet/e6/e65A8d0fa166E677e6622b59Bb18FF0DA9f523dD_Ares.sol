...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferLPFee = 0;
    ...
    uint256 public _invitorActiveCondition = 5;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        _swapRouter.addLiquidityETH{value : balance}(
            address(this),
            lpAmount,
            0,
            0,
    ...
    uint256 public _airdropDividendFee = 500;
...
contract Ares is AbsToken {
    ...
    //SwapRouter
        ...
        100000000,
    //Fund
        address(0x7E50D74B4dFF26dCa3601575bbaaD65563f2cE3F),
    //Receive
        address(0x7990741F10FdcD9e326119a3f4CcbA049b94d8E9),
        21000
    ){
