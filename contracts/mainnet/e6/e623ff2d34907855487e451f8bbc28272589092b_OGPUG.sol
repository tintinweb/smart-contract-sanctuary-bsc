...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0A4e23DEEf81f5c3a4Cb9bf5a3e57004f626520;
...
contract OGPUG is Context, IERC20, Ownable {
    ...
    string private constant _name = "O.G PUG"; // 
    string private constant _symbol = "O.G PUG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xc0A4e23DEEf81f5c3a4Cb9bf5a3e57004f626520);
