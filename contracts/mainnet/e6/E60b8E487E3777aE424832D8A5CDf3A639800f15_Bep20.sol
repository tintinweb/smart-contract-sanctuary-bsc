...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 500000 * 10 ** Decimals;
        walletLimit = 500000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x7981FcFf4e55B9acBFCb17092E4599eF7461E67A;
...
contract Bep20 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x7981FcFf4e55B9acBFCb17092E4599eF7461E67A),
