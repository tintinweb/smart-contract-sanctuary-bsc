...
/*! maticfinance.sol | (c) 2022 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | SPDX-License-Identifier: MIT License */
...
contract Maticfinance is Ownable, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    uint8[] public ref_bonuses;                     // 1 => .5%

    uint8[] public pool_bonuses;                    // 1 => .5%
