...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x465fb49c029D8bA8e5895FE40a18acd84Cd7dbE1; // owner address
...
contract ElonsQuack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonsQuack";
    string private _symbol = "EQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbF273fE72FE2Dc3F946990E8387Bb847E133b253); // Marketing Address
    address payable public teamWalletAddress = payable(0x4907828F2e9EbD886BC8a5BD26051E33953C1c6c); // Team Address
