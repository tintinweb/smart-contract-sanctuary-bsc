...
*Trend is set, Mecha is taking over. Ride the hype with the meme king.
...
contract ContractMechaPepeGen is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 210000000 * 10**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0x0eD4122f07Fd6f190f36DD479F539580D58bCBE6;
    address private devWallet = 0x0eD4122f07Fd6f190f36DD479F539580D58bCBE6;
    ...
    Taxes public taxes = Taxes(6, 3, 0);
    Taxes public sellTaxes = Taxes(22, 3, 0);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("MechaPepe", "$MEPE") payable {
        _tokengeneration(msg.sender, 7000000000 * 10**decimals());
