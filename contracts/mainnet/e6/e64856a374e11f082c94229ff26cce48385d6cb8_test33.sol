...
/**
 *Submitted for verification at BscScan.com on 11-05-2022
 Test Token
 Do Not Buy!!
*/
...
contract test33 is IERC20 {
    ...
    string constant private _name = "test 33";
    string constant private _symbol = "test33";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xc36a02721D9f60cE9F28c7099834fd91aa26175B),
        buyback: payable(0xc36a02721D9f60cE9F28c7099834fd91aa26175B)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 marketing, uint16 buyback) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.marketing = marketing;
        _ratios.buyback = buyback;
        _ratios.total = rewards + marketing + buyback;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + buybackBalance);
