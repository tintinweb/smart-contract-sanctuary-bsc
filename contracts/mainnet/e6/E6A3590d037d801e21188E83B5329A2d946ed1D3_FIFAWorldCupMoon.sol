...
contract FIFAWorldCupMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFAWorldCupMoon";
    string private _symbol = "FIFAWorldCupMoon";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x17e0f00dEd3Ff448488851f3e08175cBC85ec5f6); 
    address payable private teamWalletAddress = payable(0xFdd39E92fe233E1C12edD95bb1dd6279Fb2CF0eC); 
