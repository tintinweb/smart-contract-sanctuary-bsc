...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RewardToken = BEP20(0x55d398326f99059fF775485246999027B3197955); // Rewards Token
...
contract BabyTest2 is BEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Baby Test 2";
    string constant _symbol = "BT2";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // BSC Router
    address RewardToken = 0x55d398326f99059fF775485246999027B3197955; // Reward Token
    ...
    function getPaidDividend(
        address shareholder) public view
    returns (uint256)
    {
        return dividendDistributor.getPaidEarnings(shareholder);
    }


    function getUnpaidDividend(
        address shareholder) external view
    returns (uint256)
    {
    ...
    function getTotalDistributedDividend() external view
    returns (uint256)
    {
