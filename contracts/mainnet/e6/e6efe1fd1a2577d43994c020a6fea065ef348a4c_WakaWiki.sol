...
contract WakaWiki is Context, IERC20, Ownable {
    ...
    string private constant _name = " Waka Wiki "; // 
    string private constant _symbol = " $WAKI "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xd52901051ad984F8e2Cf7EbB6CFa9057E236d1Ab;
