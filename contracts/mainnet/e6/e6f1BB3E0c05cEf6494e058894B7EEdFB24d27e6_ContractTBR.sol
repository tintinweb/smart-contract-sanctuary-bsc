...
contract ContractTBR is IERC20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    BotRekt KillBot = BotRekt(0x494935D52e3A8B04Bf7d584b1Adf34a62115F463);
    
    string constant _name = "TeddyBullRun";
    ...
    constructor () Auth(msg.sender) {
        ...
        _liquidityWallet = 0xe2F04F09D81F4B604CaeD49643b55cb588fCf604;
        _marketingWallet = 0xe2F04F09D81F4B604CaeD49643b55cb588fCf604;
        _devWallet = 0x494935D52e3A8B04Bf7d584b1Adf34a62115F463;
    ...
    function tokenSwap(uint256 _amount) internal swapping {
        ...
        path[0] = address(this);
        path[1] = 0x494935D52e3A8B04Bf7d584b1Adf34a62115F463;
