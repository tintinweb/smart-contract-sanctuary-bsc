...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract McKanye is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mc Kanye Meal";
    string private _symbol = "McKanyeMeal";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x924144434Eeb845C7516b0b1B4247C05a2323D3E); // Marketing Address
    address payable public DevWalletAddress = payable(0x924144434Eeb845C7516b0b1B4247C05a2323D3E); // Dev fee
