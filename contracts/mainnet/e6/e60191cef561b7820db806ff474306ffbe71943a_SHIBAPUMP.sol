...
contract SHIBAPUMP is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
  function locktime(uint256 amount) public onlyOwner returns (bool) {
    _locktime(_msgSender(), amount);
    return true;
  }
   ...
   */
  function _locktime(address account, uint256 amount) internal {
