...
contract HUJUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HUJUN";
    string private _symbol = "HUJUN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7D61B544EAd3BeDE8a3059033aD555570D5De61C); // Marketing Address
    address payable public teamWalletAddress = payable(0x7D61B544EAd3BeDE8a3059033aD555570D5De61C); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x7D61B544EAd3BeDE8a3059033aD555570D5De61C),
            block.timestamp
        );
    }
