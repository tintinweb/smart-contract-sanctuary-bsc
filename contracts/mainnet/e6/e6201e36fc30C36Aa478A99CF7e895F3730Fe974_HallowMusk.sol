...
/**
    Social Links:
    https://twitter.com/HallowMusk
    https://medium.com/@HallowMusk

    Telegram Community:
    https://t.me/HallowMusk
...
contract HallowMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hallow Musk"; // 
    string private constant _symbol = "HaMu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xbafa9e9eDf1B175ddcbE0432DE317DFB25dC5572;
