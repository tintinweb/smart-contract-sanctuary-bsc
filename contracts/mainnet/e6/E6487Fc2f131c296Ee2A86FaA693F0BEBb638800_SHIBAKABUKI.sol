...
contract DividendDistributor is IDividendDistributor, Auth {
    ...
    IBEP20 RWDS = IBEP20(0x8a36c68D0BF070E065C0d02D67A1d06d140348bb);
    address REWARDS;
    IRouter router;
...
contract SHIBAKABUKI is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'SHIBAKABUKI';
    string private constant _symbol = '$SHIBABUKI';
