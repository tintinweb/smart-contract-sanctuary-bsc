...
contract YAYAFinanceToken is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply,address _routerAddr, address _adminAddress ,uint256[8] memory _value) ERC20(_tokenName, _tokenSymbol) 
    {
        initialSupply =_supply * (10**18);
        uniswapV2Router02 = IUniswapV2Router02(_routerAddr);
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
        uniswapV2Pair = IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));
        taxWallets["liquidity"] = _adminAddress;
        setBuyTax(_value[0], _value[1], _value[2] ,_value[3]);
        setSellTax(_value[4], _value[5],  _value[6] ,_value[7]);
        setTaxWallets(_adminAddress,_adminAddress, _adminAddress , _adminAddress);
        exclude(msg.sender);
