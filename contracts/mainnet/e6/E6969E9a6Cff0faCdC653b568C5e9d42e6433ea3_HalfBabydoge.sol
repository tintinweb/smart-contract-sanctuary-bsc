...
Telegram : https://t.me/Halfbabydoge
...
contract HalfBabydoge is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Doge 0.5";
    string private _symbol = "Babydoge 0.5";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**6 * 10**_decimals;

    address payable private marketing =
        payable(0x2Ea5454cD1141B4f761ff4F1FEF3827bD4AbE1A5);
