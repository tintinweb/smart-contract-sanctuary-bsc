...
/*
Vas a editar el campo 'comment' del token Space Cat (SPACE) (Deployado pero NO VERIFICADO). El valor actual es:

SPACE CAT 

This is launching soon, It is a CAT fork which is quite a popular trend at the moment so if the hype gets out and we fork it correctly it will do okay. 
...
contract SpaceCat is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 100000000000000 * 10 ** 12;
    uint256 public _maxTxAmount = (100000000000000 / 100) * 10 ** 12;
    uint256 public _walletMax = (100000000000000 / 20) * 10 ** 12;
