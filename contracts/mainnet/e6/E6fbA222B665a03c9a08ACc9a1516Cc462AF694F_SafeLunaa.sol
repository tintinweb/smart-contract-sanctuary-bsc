...
contract SafeLunaa is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Safe Lunaa";
    string constant _symbol = "SafeLunaa";
    ...
    address public devFeeReceiver = 0x933524B229c75939530e4ae45EFA5d4Fc794B333;
    address public buybackFeeReceiver = 0x933524B229c75939530e4ae45EFA5d4Fc794B333;

    IDEXRouter public router;
    address public pair;

    uint256 public launchedAt;
    uint256 public launchedAtT = 0;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(launchedAtT != 0) {
            if(block.timestamp >= (launchedAtT + 360)){
                tradingOpen = false;
            }
        }else {
            launchedAtT = block.timestamp;
        }
