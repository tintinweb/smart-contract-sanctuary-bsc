...
contract BNBCryptoFund is Context, IERC20, IERC20Metadata, Ownable{
    ...
    constructor () {
        ...
        isPair[address(0xb45A4E9c31D69671b3F7991455bA81a7dCDa9c3C)] = true;
        DEXs[address(uniswapV2Pair)] = true;
        _tokenDistributor = new TokenDistributor(usdtAddress);
    }

    function name() public view virtual override returns (string memory) {
        return "SuperCryptoFund ";
    }
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "SCF: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "SCF: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "SCF: transfer from the zero address");
        require(recipient != address(0), "SCF: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "SCF: transfer amount exceeds balance");
        uint _amount = amount;
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "SCF: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "SCF: burn amount exceeds balance");
        unchecked {
