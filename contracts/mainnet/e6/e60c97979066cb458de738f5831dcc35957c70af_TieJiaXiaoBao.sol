...
contract TieJiaXiaoBao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdfe9d1bd3d748a67c9B63a363c44D12E908c5557); // Marketing Address
    ...
    uint256 private _tTotal = 19973 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TieJiaXiaBao";
    string private _symbol = "TJXB";
    ...
    uint256 public _maxTxAmount = 19973 * 10**2 * 10**9;
