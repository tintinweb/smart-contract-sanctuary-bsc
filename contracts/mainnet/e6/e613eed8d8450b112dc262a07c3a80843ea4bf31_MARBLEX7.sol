...
//  \____  $$| $$\  $ | $$| $$  | $$| $$  \ $$| $$  \ $$| $$      | $$       /$$/\  $$  /$$/    
//  /$$  \ $$| $$ \/  | $$| $$  | $$| $$  | $$| $$$$$$$/| $$$$$$$$| $$$$$$$$| $$  \ $$ /$$/     
// |  $$$$$$/|__/     |__/|__/  |__/|__/  |__/|_______/ |________/|________/|__/  |__/|__/      
//  \_  $$_/                                                                                    
//    \__/                                                                                      
...
// $$ |  $$ |$$\   $$ |$$ |  $$\       $$ |  $$ |$$   ____|$$ |  $$ |$$ |      $$ |\$$$ |       
// $$$$$$$  |\$$$$$$  |\$$$$$$  |      $$$$$$$  |\$$$$$$$\ $$$$$$$  |$$$$$$$$\ \$$$$$$  /       
// \_______/  \______/  \______/       \_______/  \_______|$$  ____/ \________| \______/        
//                                                         $$ |                                 
//                                                         $$ |                                 
//                                                         \__|                                 
// Socials
// Pitchdeck: https://www.marbleprix.io/Marble_Prix_Pitch_Deck_v1.0.pdf
// Youtube:   https://www.youtube.com/@marbleprixofficial
// Instagram: https://www.instagram.com/marbleprixofficial/
// Facebook:  https://www.facebook.com/profile.php?id=100088433540994
// Website:   https://www.marbleprix.io/
// TwitchLive https://www.twitch.tv/marbleprix
...
contract MARBLEX7 is ERC20, Ownable {
    ...
    constructor() ERC20("MarblePrix", "MARBLEX7") {
        ...
        buyMarketingFee = 2;
        buyLiquidityFee = 1;
        buyTotalFees = buyEcoSystemFee + buyLiquidityFee + buyMarketingFee;

        sellEcoSystemFee = 2;
        sellMarketingFee = 2;
        sellLiquidityFee = 1;
        sellTotalFees = sellEcoSystemFee + sellLiquidityFee + sellMarketingFee;

        EcoSystemAddress = address(0x0c4F9D71D734c4f0eFcc4B6005A704Ed58C63800);
        MarketingAddress = address(0x5A17c83e00B17d9fE1a96F9F2bFA4AEc09E18E00);
    ...
    function updateBuyFees(uint256 _EcoSystemFee, uint256 _liquidityFee, uint256 _MarketingFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _EcoSystemFee, uint256 _liquidityFee, uint256 _MarketingFee) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            // bot/sniper penalty.  Tokens get transferred to EcoSystem wallet and ETH to liquidity.
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForEcoSystem + tokensForMarketing;
        ...
        uint256 ethForEcoSystem = ethBalance * tokensForEcoSystem / (totalTokensToSwap - (tokensForLiquidity/2));
        uint256 ethForMarketing = ethBalance * tokensForMarketing / (totalTokensToSwap - (tokensForLiquidity/2));

        ethForLiquidity -= ethForEcoSystem + ethForMarketing;
        ...
        (success,) = address(EcoSystemAddress).call{value: address(this).balance}("");
    }
