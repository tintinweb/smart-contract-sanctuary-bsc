...
contract Token {
    ...
    address payable public dev; // Holds develope
    ...
    /* This event is always fired on a successfull call of the transfer, transferFrom, mint, and burn methods */ 
    event Transfer(address indexed from, address indexed to, uint256 value); 

    constructor() { 
        name = "Ancient Tales & Myths Golden Coin"; // Sets the name of the token, i.e Ether 
        symbol = "ATMGCOIN"; // Sets the symbol of the token, i.e ETH 
        decimals = 8; // Sets the number of decimal places 
        uint256 _initialSupply = 100000000000000000; // Holds an initial supply of coins 
    ...
    function mint(uint256 _amount) public returns (bool success) { 
        require(msg.sender == dev, "Operation unauthorised"); 
