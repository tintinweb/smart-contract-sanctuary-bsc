...
contract MARSDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF8DD382C8C0cA631C98920D01BbC82FD8FdBEbE9); // Marketing Address
    address payable public teamWalletAddress = payable(0xF8DD382C8C0cA631C98920D01BbC82FD8FdBEbE9); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xF8DD382C8C0cA631C98920D01BbC82FD8FdBEbE9),
            block.timestamp
        );
    }
