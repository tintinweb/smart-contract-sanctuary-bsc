...
contract CC is ERC20, Ownable{
    ...
    address public marketingWallet = 0xB4Dca8a24Aca0E8e82190384F88b49a09a407369;
    address public devWallet = 0x728398B666d3b6604Aa47336e6Af2633463e4112;
    address public communityrewardsWallet = 0x1EC8eDA9A4FCB065bD74c5fB6870FD4173470A79;
    ...
    constructor()  ERC20("C-Charge", "CC") {
        ...
        excludeFromFees(communityrewardsWallet, true);
    ...
    function updateRouter(address newAddress) public onlyOwner {
        require(newAddress != address(router), "C-Charge: The router already has that address");
        emit Updaterouter(newAddress, address(router));
        router = IRouter(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "C-Charge: Account is already the value of 'excluded'");
    ...
    function setTaxes(uint256 lp, uint256 marketing, uint256 communityrewards) external onlyOwner{
        totalTax = lp + marketing + communityrewards + 1 ;
        taxes = Taxes(lp,marketing,communityrewards, 1);
    ...
    function setcommunityrewardsWallet(address newWallet) external onlyOwner{
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        // Send BNB to communityrewards
        uint256 communityrewardsAmt = (unitBalance * 2 * taxes.communityrewards);
        if(communityrewardsAmt > 0){
            payable(communityrewardsWallet).sendValue(communityrewardsAmt);
        }
