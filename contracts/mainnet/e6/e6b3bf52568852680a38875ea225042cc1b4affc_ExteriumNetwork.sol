...
contract  ExteriumNetwork  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Exterium Network"; // 
    string private constant _symbol = unicode"$EXN"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xC89Dec4d87f230bdDdb2e3b6Ab20907f6B3Eaa63;
