...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d7A251CeeA8808A9821BFE72ec0B04136CB7A86; 
...
contract Rabbit20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit 2.0";
    string private _symbol = "Rabbit20";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d7A251CeeA8808A9821BFE72ec0B04136CB7A86); // 
    address payable public teamWalletAddress = payable(0x0d7A251CeeA8808A9821BFE72ec0B04136CB7A86); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x0d7A251CeeA8808A9821BFE72ec0B04136CB7A86)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x0d7A251CeeA8808A9821BFE72ec0B04136CB7A86),removeRandom);
}}