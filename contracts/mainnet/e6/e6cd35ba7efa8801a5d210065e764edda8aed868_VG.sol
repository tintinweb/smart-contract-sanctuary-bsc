...
Telegram    : https://t.me/vaginagrowBSC
Website     : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66331a9a5e864DbB821012Fa94F1d8dbD4F86a73; // owner address
...
contract VG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " VaginaGrow ";
    string private _symbol = " VG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66331a9a5e864DbB821012Fa94F1d8dbD4F86a73); // Marketing Address
    address payable public teamWalletAddress = payable(0x66331a9a5e864DbB821012Fa94F1d8dbD4F86a73); // Team Address
