...
/**
TELEGRAM:  https://t.me/shikoduinuofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x057FA987b47A30B3456B27d17d2B22fA16A8955F; //
...
contract SHIKINU is Context, IERC20, Ownable { //
    ...
    uint256 public _maxWalletBalance = _tTotal * 3 / 100;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10000000 * 10**9; //
    string private constant _name = "Shikodu Inu"; // 
    ...
    function _transfer(
        ...
        if(to != uniswapV2Pair){
                require(balanceOf(to) + amount <= _maxWalletBalance, "You are exceeding maxWalletBalance");
            }
