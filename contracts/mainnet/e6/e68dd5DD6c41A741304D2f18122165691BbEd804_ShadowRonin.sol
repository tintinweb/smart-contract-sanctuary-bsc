...
//TG : https://t.me/shadowroninportal
...
contract ShadowRonin  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xffcBC7ebE5Df04122a8d907cCa45Fc0930e287C8); 
    address payable public Wallet_Dev = payable(0x3Eb495eA2072E453ACfAaC461e5BA8c4564d8A93);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private _authorized = 0x89F8Fb3D638B32a0C121C9075F01D7cc78cc2345;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**7 * 10**_decimals;
    string private constant _name = "ShadowRonin"; 
    ...
    constructor () {
        ...
        _owner = 0x89F8Fb3D638B32a0C121C9075F01D7cc78cc2345;
