...
contract RocketRaccoonTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RocketRaccoon 2.0";
    string private _symbol = "ROC 2.0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7a1Eb88Ab8F48441fFDE5564A9e9f1b630613903); // Marketing Address
    address payable public teamWalletAddress = payable(0x7a1Eb88Ab8F48441fFDE5564A9e9f1b630613903); // Team Address
