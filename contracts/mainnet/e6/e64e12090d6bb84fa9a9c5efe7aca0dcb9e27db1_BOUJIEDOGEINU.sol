...
THE HIGH CLASS, UPSCALE, AND BOUJIE DOGE INU!!!

HUGE DOGE REWARDS AND RELFECTIONS!!!

STEALTH LAUNCH, CHADS WELCOME, NON STOP MOONSHOT!!!

PREMARKETING ALREADY LINED UP!!

CALLS WILL START WHEN WE HAVE OUR FLOOR!!

GET IN BEFORE THE PUMPS SERRSSSSSSSS!!!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PRWDS = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    address REWARDS;
    IRouter router;
...
contract BOUJIEDOGEINU is Context, IBEP20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'BOUJIE DOGE INU';
    string private constant _symbol = 'BOUJIE';
    ...
    uint256 public swapThreshold = ( _tTotal * 800 ) / 100000;
