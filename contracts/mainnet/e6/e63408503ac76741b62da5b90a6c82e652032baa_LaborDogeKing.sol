...
contract LaborDogeKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "LaborDogeKing";
    string private _symbol = "LaborDogeKing";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD4b3FD407926FFb4Dd81dC1B8B77384f148FAa6c
));
        marketingWalletAddress = payable(address(0x057626a4CB5c2552414435d5949613bFb08c4A7e
