...
contract CORE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x469E0f718514696Cf8C5EA89606FaE6Fedb00889); // Marketing Address
    address payable public teamWalletAddress = payable(0x46a49b3619dA7598A78b73EfC5f838eFD564B4dF); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xedd6a32aD712589852D3f52c62e9Ee220e6DD90d),
            block.timestamp
        );
    }
