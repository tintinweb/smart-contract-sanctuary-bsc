    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public _rewardTokenAddress = address(0x55d398326f99059fF775485246999027B3197955); //Binance pegged RewardToken:0x55d398326f99059fF775485246999027B3197955
...
contract DividendTracker1 is DividendPayingToken {
    ...
    constructor() DividendPayingToken("DividendTracker1", "Tina_DividendTracker1") {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(false, "DividendTracker1: withdrawDividend disabled. Use the 'claim' function on the main Tina contract.");
    }
...
///  to token holders as dividends and allows token holders to withdraw their dividends.
///  Reference: the source code of PoWH3D: https://etherscan.io/address/0xB3775fB83F7D12A36E0475aBdD1FCA35c091efBe#code
contract DividendPayingTokenBNB is
    ERC20,
    Ownable,
    DividendPayingTokenInterface,
    DividendPayingTokenOptionalInterface
...
contract DividendTrackerBNB is DividendPayingTokenBNB {
    ...
    constructor() DividendPayingTokenBNB("DividendTracker2", "Tina_DividendTracker2") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "DividendTrackerBNB: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DividendTrackerBNB: withdrawDividend disabled. Use the 'claim' function on the main Tina contract.");
    }
...
contract TINA is Context, ERC20, ERC20Burnable , Ownable {
    ...
    mapping (address => bool) public _isExcludedFromMaxBal;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromMaxTx[from]) { require(amount <= maxTxAmount,"TINA: transfer more than allowed amount"); }
        ...
        if(!_isExcludedFromMaxBal[to]) { require(balanceOf(to) <= maxBalance,"TINA: Balance exceed max balance"); }
    ...
    function updateDividendTrackerBNB(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "Tina: The new dividend tracker must be owned by the Tina token contract");
   ...
   //Setter functions
    ...
    function excludeFromMaxBalance(address account) public onlyOwner {
        _isExcludedFromMaxBal[account] = true;
    } 
