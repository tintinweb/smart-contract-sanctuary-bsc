...
contract CGT_LV_SINGLE is ERC721A, Ownable {
    uint256 public PRE_MINT_SUPPLY;
    uint256 public PRE_MINT_MAX_SPPLY = 2501;
    ...
    string _baseTokenURI =
        "https://api.cryptoverse.vip/binance/voucher/metadata/single/1";
    ...
    constructor(address launchpad) ERC721A("CGT_LV_SINGLE", "CGT_LV_SINGLE") {
        LAUNCHPAD = launchpad;
    }
