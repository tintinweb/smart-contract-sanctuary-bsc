...
contract LUNA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb16d6FA0EAF9487c214f566BAaDa5385bB7BCe60);
    address payable public teamWalletAddress = payable(0xb16d6FA0EAF9487c214f566BAaDa5385bB7BCe60);
    ...
    uint256 private _totalSupply =  270709303487 * 10**_decimals;
    uint256 public _maxTxAmount =   270709303487 * 10**_decimals;     
    uint256 public _walletMax =     270709303487 * 10**_decimals;      
