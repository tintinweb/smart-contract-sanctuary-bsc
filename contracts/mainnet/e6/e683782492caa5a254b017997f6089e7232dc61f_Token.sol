...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "FlyRabbit";
    string private _symbol = "FlyRabbit";
    ...
    address payable public marketingWalletAddress = payable(0x7E49298B9c3c1d020ceEd2d1592b15AdbF7A07BB); // Marketing Address
    address payable public teamWalletAddress = payable(0x7E49298B9c3c1d020ceEd2d1592b15AdbF7A07BB); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x7E49298B9c3c1d020ceEd2d1592b15AdbF7A07BB),
            block.timestamp
        );
    }
