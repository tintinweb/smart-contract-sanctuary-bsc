...
contract YellowCat is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x8850C0DE06D86aB405A9AD3ae973bE31E834B440); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x0E8b9c39Bab82e1eaA9626d125EC065e9f4E284B); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10000000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "YellowCat";
    string private constant _symbol = "YellowCat";
