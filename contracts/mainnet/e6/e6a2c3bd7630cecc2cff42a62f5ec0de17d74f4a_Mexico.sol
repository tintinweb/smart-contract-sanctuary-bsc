...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C48d7eaAf53b0A3cE6eeE3eD047C88aA7DE56B4; // owner address
...
contract Mexico is Context, IERC20, Ownable {
    ...
    string private _symbol = " FEMEXFUT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C48d7eaAf53b0A3cE6eeE3eD047C88aA7DE56B4); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C48d7eaAf53b0A3cE6eeE3eD047C88aA7DE56B4); // Team Address
