...
/*
* TELEGRAM:https://t.me/TournamentalCrypto_BSC
*/
...
contract TournamentalCrypto is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "Tournamental Crypto";
    string private  _symbol = "TCAPP";
