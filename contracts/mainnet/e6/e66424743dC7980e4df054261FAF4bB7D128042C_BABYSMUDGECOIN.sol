...
contract BABYSMUDGECOIN is Ownable, IERC20 {
    ...
    string public _name = "Baby Smudge Coin";
    string public _symbol = "Baby Smudge Coin";
    ...
    uint256 public _maxWallet =   3000000000000 * 10 ** _decimals;
