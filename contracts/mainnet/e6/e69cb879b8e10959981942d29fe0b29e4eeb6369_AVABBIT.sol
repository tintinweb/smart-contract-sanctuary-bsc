...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7303a4b56d1208A7052185973Db21848a282C13B; // owner address
...
contract AVABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AVABBIT";
    string private _symbol = "AVABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7303a4b56d1208A7052185973Db21848a282C13B); // 
    address payable public teamWalletAddress = payable(0x7303a4b56d1208A7052185973Db21848a282C13B); // 
