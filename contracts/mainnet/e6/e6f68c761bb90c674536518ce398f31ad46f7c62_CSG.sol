...
contract CSG is ERC20 {
	...
	address _delldxAddress = address(0x5e232Ec84e4552aab59Ba320BAC2E97A0224992B);
    ...
    constructor(address tokenOwner) ERC20("CSG", "1CSG") {
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
			...
			if(isDelLdx){
				if(startTime.add(360) > block.timestamp){
					delldxRate = 45;
				}
			}else{
			}
