...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4Cee26e4e4e417FE7bfb6e3A24231E077AA7d961; // owner address
...
contract BinanceCZInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binance CZ Inu";
    string private _symbol = "BCZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x294f18fD08bD9e6DeF2c88597c4623afc204f9FE); // Marketing Address
    address payable public teamWalletAddress = payable(0x5A2EA0A7C05b0DCF392673a86f03E903A98511A0); // Team Address
