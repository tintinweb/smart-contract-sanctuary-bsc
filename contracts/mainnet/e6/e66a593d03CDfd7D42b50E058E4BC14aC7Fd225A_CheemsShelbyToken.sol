...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public CINU =
        IERC20Extended(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
    ...
    uint256 public minDistribution = 1 * (10**CINU.decimals());
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CINU.balanceOf(address(this));
        ...
        uint256 amount = CINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            CINU.transfer(shareholder, amount);
...
// main contract
contract CheemsShelbyToken is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Cheems Shelby";
    string private constant _symbol = "$CS";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * 10**_decimals;

    address public CINU = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
    ...
    uint256 _liquidityFee = 300;
    uint256 _reflectionFee = 200;
    uint256 _marketingFee = 700;
    uint256 _devFee = 300;
    uint256 _swapDenominator = 1500;
    ...
    constructor(
        ...
        isFeeExempt[devFeeReceiver_] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBNBFee = _swapDenominator.sub(dynamic_LiquidityFee.div(2));
    ...
    function setFees(
        ...
        _devFee = __devFee;
        _swapDenominator = __liquidityFee.add(__reflectionFee).add(__marketingFee).add(__devFee);
