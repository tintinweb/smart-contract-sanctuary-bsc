...
contract CCDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCDS2.0";
    string private _symbol = "CCDS2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92cB8d8a86267B3d18C430F85f6fa3ce3128A015); 
    address payable public teamWalletAddress = payable(0x888178331777b64D8629eE9015f5663C71FE1ffd); 
