...
contract BSCTEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xaFCE13732BFe73836A0aE7d2bADE21B0E0f6055C); // Marketing Address

    address payable public teamAddress =
        payable(0x8C19cc30019F155B405100a14ce962f92de6fd2F); // Team Address

    address payable public liquidityAddress =
        payable(0x57B180d21f27870f4719A226F8F24acB0F39D0d5); // Liquidity Address
    ...
    string private constant _name = "RUSSIAN SHIBA";
    string private constant _symbol = "RUSSIAN SHIBA";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 100 / 1000; // 1.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 100 / 1000; // 1.5% maxWalletToken
