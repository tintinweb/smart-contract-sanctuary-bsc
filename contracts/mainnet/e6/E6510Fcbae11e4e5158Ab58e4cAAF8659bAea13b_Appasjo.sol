...
contract Appasjo is Context, IBEP20, Ownable {	
    ...
    function excludeFromReward(address account) public onlyOwner() {	
        // require(account != 0x0f650250A72A8f5BF76d25c0D0B3bC62B59f8a77, 'We can not exclude Uniswap router.');	
    ...
    function _transfer(	
        ...
        /*
            anti whale: when buying, check if sender balance will be greater than 80% of total supply
