...
contract SafeMoon is IERC20, Ownable {
    ...
    uint256 _totalSupply = 100_000_000_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 8) / 100;   // 8%
    uint256 public _maxTxAmount = (_totalSupply * 8) / 100;     // 8%
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(413945130).div(100_000_000_000_000_000_000_000);
    uint256 largeSwapThreshold = _totalSupply.mul(669493726).div(100_000_000_000_000_000_000_000);
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x60e72eAe4A88CC2255416f66cb89683202830807;
        marketingFeeReceiver = 0x73AB75B876e7718801Ed80495BCf1e3fD998AEC3;
        devFeeReceiver = 0x60e72eAe4A88CC2255416f66cb89683202830807;
