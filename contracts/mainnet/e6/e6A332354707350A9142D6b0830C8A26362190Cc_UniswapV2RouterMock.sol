...
contract UniswapV2RouterMock is IUniswapV2Router, AccessControl {
    ...
    function setExchangeRate(address from, address to, uint256 rate)
    ...
    // 1 frl = 0.045 usdt
    // 45000000000000000000 = 1000000000000000000
