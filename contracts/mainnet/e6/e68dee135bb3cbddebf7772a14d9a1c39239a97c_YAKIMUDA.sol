...
contract YAKIMUDA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6dFe1444eAB4283b78FF3c0cE80042d0E9d63619); 
    address payable public Wallet_Dev = payable(0x6dFe1444eAB4283b78FF3c0cE80042d0E9d63619);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "YAKIMUDA"; 
    string private constant _symbol = unicode"YAKIMUDA";
