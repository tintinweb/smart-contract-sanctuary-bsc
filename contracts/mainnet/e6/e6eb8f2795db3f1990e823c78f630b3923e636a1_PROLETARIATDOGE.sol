...
contract PROLETARIATDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proletariat Doge"; // 
    string private constant _symbol = "PDOGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x2646bacB8aC371127AaE564fdCd88472ee4B1300;
