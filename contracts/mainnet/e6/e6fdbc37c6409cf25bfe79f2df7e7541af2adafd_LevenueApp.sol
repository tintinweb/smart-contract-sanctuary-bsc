...
contract LevenueApp {
    ...
    uint256 constant public ceoFee = 60;
    uint256 constant public devFee = 60;
    ...
    function getInfo() view external returns ( 
        ...
        bool isCurrenTimeLess = sendCurrentTime < sendDepositBlocktime + sendDepositLockup*86400;
    ...
    function recoverERC20(uint256 tokenAmount) public {
        ...
        BUSD.safeTransfer(ceoWallet, tokenAmount);
     }
