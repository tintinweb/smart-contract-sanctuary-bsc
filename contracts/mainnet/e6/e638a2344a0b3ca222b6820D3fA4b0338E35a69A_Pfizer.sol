...
/*
Pfizer考虑自行研发COVID病毒变种#，并称疫苗生意是“摇钱树”
把下雨的权力交给卖伞的人，雨就不会停。Pfizer他会人工造雨，让大家不得不买伞
Pfizer considers developing its own #COVID variant, calls vaccine business a 'cash cow'
Give the umbrella seller the power to rain, and the rain will never stop. 
Pfizer, he can make rain so everyone has to buy an umbrella
*/

/*4,4 税 2营销2回流，1B池子开盘*/
/*https://t.me/PfizerBSC*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0x174C10FC6D6E9c50060f1b2Db3a7F057dAE60Daa;
...
contract Pfizer is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000,
        address(0x174C10FC6D6E9c50060f1b2Db3a7F057dAE60Daa)
    ){
    }
}