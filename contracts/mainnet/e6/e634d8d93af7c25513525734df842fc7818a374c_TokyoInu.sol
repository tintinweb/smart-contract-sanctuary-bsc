...
contract TokyoInu is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"TOKYO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa940AB39C4dBa3f4D2853F5f5A04E2957A19950F); 
    address payable public buyBackWalletAddress = payable(0xa940AB39C4dBa3f4D2853F5f5A04E2957A19950F); 
    ...
    uint256 private _totalSupply = 1e12 * 10**9;
    uint256 public _maxTxAmount = 1e12 * 10**9; 
    uint256 public _walletMax = 1e12 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1e12 * 10**9; 
