...
contract Aristocrats is AristocratsDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private AristocratsTeam;
    address private CharityAristocrats;
    ...
    string public override symbol = "Aristocrats";
    ...
    constructor(uint totalSupplyValue, address AristocratsTeamAddress, address CharityAristocratsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        AristocratsTeam = AristocratsTeamAddress;
        CharityAristocrats = CharityAristocratsAddress;
       
        // split the tokens according to agreed upon percentages
        balances[AristocratsTeam] =  totalSupply * 4 / 100;
        balances[CharityAristocrats] = totalSupply * 4 / 100;
