...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42175c066FF956955B5306d5e1fa3F36217a3301; // SHIBBAT
...
contract SHIBBAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBBAT";
    string private _symbol = "SHIBBAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42175c066FF956955B5306d5e1fa3F36217a3301); // SHIBBAT
    address payable public teamWalletAddress = payable(0x42175c066FF956955B5306d5e1fa3F36217a3301); // SHIBBAT
