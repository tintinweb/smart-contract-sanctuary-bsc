...
contract FlokiBucksCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiBucksCoin";
    string private _symbol = "FBC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7312c994533ea548b5a261c7E862B7cFBAe6f2eA);
