...
// https://t.me/AdrianaChechikCrypto
...
contract AdrianaChechik is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7d6b42cB0CEFC2984b8b90252c4931364a44cfA5); 
    address payable public Wallet_Dev = payable(0x67A86E61831f440131c09e0D97c4e9088834E9D3);
    ...
    string private constant _name = "Adriana Chechik"; 
    string private constant _symbol = unicode"ADRIANACHECHIK"; 
    ...
    constructor () {
        ...
        _owner = 0x67A86E61831f440131c09e0D97c4e9088834E9D3;
