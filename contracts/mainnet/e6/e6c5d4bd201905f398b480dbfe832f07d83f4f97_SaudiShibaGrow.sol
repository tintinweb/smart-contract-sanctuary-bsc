...
contract SaudiShibaGrow is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x233422323E9b8C2b1037DB9954AF0dcFFC9a4d0b;

    string constant _name = "Saudi Shiba Grow";
