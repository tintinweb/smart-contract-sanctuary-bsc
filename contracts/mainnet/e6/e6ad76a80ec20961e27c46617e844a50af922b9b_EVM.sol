...
/*
 ...
 |______|   \/   |_|  |_|
    ...
    Marketing & Development fee for future project developments: 5%
...
contract EVM is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 5 * 10**5 * 10**9; // 5% of the supply
    uint256 public maxSellAmount = 5 * 10**5 * 10**9; // 5% of the supply
    uint256 public maxWalletAmount = 5 * 10**5 * 10**9; // 5% of the supply
    ...
    address public _devWallet = payable(address(0xCFf1B7D5Af1F6d8e2f01CB424eeD2f19Efc5e717)); // developer/owner wallet
    address public _marketingWallet = payable(address(0xF586E8de4AFE8A1769D6a3Fc75fcf872d18C6F4C)); // marketingWallet
    ...
    constructor() ERC20("EVM", "EVM") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E // Pancakeswap Router 0x10ED43C718714eb63d5aA57B78B54704E256024E // Testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        );
