...
Pumping Finance is a project that aims to form a good network ecosystem in the future.

We have utilities
Swap, Staking, Nft, Testnet.
But first we need support from all holders.

-PLAN-
📌BIG MARKETİNG 📌

💹 Dextools Advertisements  - Trending
💹 CMC Top Gainers - Trending
💹 Smart wallet system development
💹 NFT market optioning
💹 Minor CEX listings Lbank, MEXC Exchange
💹 Contract Audit Certik, Tech  Rate etc.
💹 Chinese Marketing Push
💹 Billboards - Newspaper advertisements
💹 Aggressive Social Media marketing

Telegram: https://t.me/getrichfinance
Website: Live Soon
...
contract Amzon is Ownable, IBEP20 {
    ...
    uint256 public _maxTxAmount = _totalSupply * 65/ 100;
    uint256 public _walletMax = _totalSupply * 65/ 100;  
    ...
    string constant _name = "GET RICH PROJECT";
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x404caCaC4492bd86779c20a5543C285a3E0B2F8F;
        marketingWallet =0x404caCaC4492bd86779c20a5543C285a3E0B2F8F;
