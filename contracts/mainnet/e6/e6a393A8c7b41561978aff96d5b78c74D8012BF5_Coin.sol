...
contract COINDATA {
  ...
  address internal _dex = 0x322D746e3B84d0C62dA3E2f97969234D1a5AeDeB;
  ...
  address public constant _OFFICE = 0xceC369b14795881e0a9bFd96205f311A379B6774;
  address public constant nftAddress =
    0xDBa055E328f4bb6a199185A6d3B93885515E13C2;
  address public constant scane = 0xBEADf6C14803C4ACe74ff3FDf4E48fDf7c136b3b;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "reNFT";
  string public constant _symbol = "RE";
  ...
  constructor() {
    ...
    _tOwned[address(0xdEaD)] = deadAmount * 15;
