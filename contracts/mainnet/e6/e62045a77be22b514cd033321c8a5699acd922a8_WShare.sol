...
contract WShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 55,001 BSHAREs
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 1 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("WSHARE", "WSHARE") {
        _mint(msg.sender, 10 ether); // mint 1 TOKEN for initial pools deployment
