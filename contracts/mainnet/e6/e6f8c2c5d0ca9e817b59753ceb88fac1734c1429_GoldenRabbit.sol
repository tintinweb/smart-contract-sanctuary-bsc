...
contract GoldenRabbit is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"GRabbit"; 
    ...
    function set_Max_Tx_Wallet (uint256 maxTxAmount, uint256 maxWalletToken) external onlyOwner() {
