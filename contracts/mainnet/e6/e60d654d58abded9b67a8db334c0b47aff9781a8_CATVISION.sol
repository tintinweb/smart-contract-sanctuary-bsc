...
Cat Vision a cryptocurrency project with a small mcap, Our goal is to help the community thrive and
...
Telegram: https://t.me/catvisionofficial
...
contract CATVISION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Vision"; // 
    string private constant _symbol = "VC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x284906a350cAaa8219BbeB09D1A329eBaef9286e;
