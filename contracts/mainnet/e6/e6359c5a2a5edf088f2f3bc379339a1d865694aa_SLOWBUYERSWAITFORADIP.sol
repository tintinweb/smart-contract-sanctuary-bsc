...
//
//Welcome to SLOW BUYERS WAIT FOR A DIP , fun degen play based on the famous quote we all love and eagerly waiting for.https://t.me/slowbuyerswaitforadip
...
contract SLOWBUYERSWAITFORADIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SLOWBUYERSWAITFORADIP";
    string private _symbol = "SBWFAD";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xF76C256F231783e76b53CD7F36175AFB851B9038); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7eF316CEEdB0A1D5d0a6F25cE06e10944f9CEba6); // BuyBack Address
