...
contract ShiPlay is ShiPlayDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ShiPlayTeam;
    address private CharityShiPlay;
    ...
    string public override symbol = "ShiPlay";
    ...
    constructor(uint totalSupplyValue, address ShiPlayTeamAddress, address CharityShiPlayAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ShiPlayTeam = ShiPlayTeamAddress;
        CharityShiPlay = CharityShiPlayAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ShiPlayTeam] =  totalSupply * 4 / 100;
        balances[CharityShiPlay] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShiPlayTeam pot
