...
contract ZMSS is ZMSSDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ZMSSTeam;
    address private CharityZMSS;
    ...
    string public override name = "Zombie Mob Secret Society";
    string public override symbol = "ZMSS";
    ...
    constructor(uint totalSupplyValue, address ZMSSTeamAddress, address CharityZMSSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ZMSSTeam = ZMSSTeamAddress;
        CharityZMSS = CharityZMSSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ZMSSTeam] =  totalSupply * 4 / 100;
        balances[CharityZMSS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ZMSSTeam pot
