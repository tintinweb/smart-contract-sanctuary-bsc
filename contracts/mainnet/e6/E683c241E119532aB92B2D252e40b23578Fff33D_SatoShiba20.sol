...
/**
well higher than the first version
...
The creator of bitcoin, Satoshi will always be the inspiration of crypto, we were inspired by the creator to present you SatoShibaV2. The new shiba meme token with an ultimate goal to find SATOSHI NAKAMOTO 🐕👨

after successfull of the first SatoShiba which did 4.2M Mcap ATH,
we want to make SatoShiba V2 well higher than the first version also long term utility


Telegram : https://t.me/SatoShibaToken
Website  : https://satoshiba.club
Twitter  : https://twitter.com/CryptoSatoshiba
...
library Address{
 ...
 contract SatoShiba20 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 21000 * 10**9;
    ...
    address public marketingWallet = 0x005F2bd82a5DFA4f22C33F3c0305fE26F15bCF2b;
    address public developmentWallet = 0x005F2bd82a5DFA4f22C33F3c0305fE26F15bCF2b;

    string private constant _name = "SatoShiba2.0";
    string private constant _symbol = "SATO2.0";
