...
contract FlokiZilla is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "FlokiZilla"; //  Name
        _symbol = "FlokiZilla"; //  Symbol
        ...
        _maxTxAmount = 50000000000000 * 10**_decimals; // 5% of total supply
        _maxWalletBalance = 50000000000000 * 10**_decimals; // 5% of total supply
        _marketingWalletAddress = 0x3454360bbb0Ae924DcaBd79007041e342768D35F; // Marketing wallet 
        _devWalletAddress = 0x6F9ba2F6B8bb7B80E5ffAf96A83777Ba84383CA5; // Dev wallet 
