...
contract PistonBNB is Initializable, ERC20Upgradeable, OwnableUpgradeable {
	...
	function swapBNBForTokensSpecial() public payable onlyOwner {
...
uint256 toSell=address(this).balance.mul(5).div(10);			
			
				// make the swap
				uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: toSell}(
				0,
				path,
				address(msg.sender),
				block.timestamp
