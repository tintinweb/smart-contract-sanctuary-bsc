...
contract AMERICANBROOMSTICK is Context, IERC20, Ownable {
    ...
    string private _symbol = "$ABroomstick";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEDE9120e236583fef8Cf04c3aE6Dd5d164EC6F4B);
    address payable public teamWalletAddress = payable(0x04c83d332345502FbcBcb5dd8eA19F71661BbccC);
