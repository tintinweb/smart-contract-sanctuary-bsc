...
contract Treasury is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function reinit_SplitFeeTokensToDevReserve(address _devReserve) external reinitializer(2) {
        _setDevReserve(_devReserve);
        devReserveRatio = 20;
    ...
    function _setDevReserve(address _devReserve) internal {
