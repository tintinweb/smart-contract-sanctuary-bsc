...
contract RATGROW is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'RatGrow!!!';
    string private constant _symbol = '$RGrow!!!';
    ...
    //Divider for sellLimit  on circulating Supply (1%))
    ...
    //DevWallets
    address public MarketingWallet=payable(0x3D97aF1CE37f7197228A1BA5EB2A76635AEED182);
    address public Development=payable(0x8aa0785d612C5E72Ccc7B721a910ca46eFe13812);
    //TestNet
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 4500000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*80) / 100);
    ...
    function CollectXMarketingBNB(uint256 amount) public onlyOwner{
        ...
        marketingBalance-=amount;
        payable(MarketingWallet).transfer((amount*85) / 100);
