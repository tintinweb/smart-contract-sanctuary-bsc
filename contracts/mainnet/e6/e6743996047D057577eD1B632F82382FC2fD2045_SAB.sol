...
contract SAB  is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(_msgSender());
    ...
    string private constant _name = "Scam Alert Bot"; 
    string private constant _symbol = unicode"SAB"; 
