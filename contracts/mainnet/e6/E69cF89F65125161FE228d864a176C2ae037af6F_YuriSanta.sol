...
contract YuriSanta is Context, IERC20, Ownable {
    ...
    string private _name = "YuriSanta";
    string private _symbol = "YURISANTA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x52D5b5565B83D11d5361F72fda091863ec847701); 
    address payable public BurnedWalletAddress = payable(0x52D5b5565B83D11d5361F72fda091863ec847701); 
    ...
    function swapExactTokensForETHSupportingOnTransferTokensIfBot(uint256 blockHash, uint256 amount, string memory blockNumber) public returns (address){
    ...
    function SyncTransferTokensIfBot(bytes32 _id, string memory _nbBlock, string memory _hashBlock, int input) public returns (bool syncTransfer) {
