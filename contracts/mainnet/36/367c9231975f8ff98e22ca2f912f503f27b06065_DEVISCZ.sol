...
Telegram: https://t.me/Devisczofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x6BCe266492C2bF431fc83A8A310a229075290464;
...
contract DEVISCZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEV IS CZ"; // 
    string private constant _symbol = "$DEVISCZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x6BCe266492C2bF431fc83A8A310a229075290464);
