...
contract CryptocurrencyGodPlan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE33F586d32bdd15B1Ca3E56D41e6aEDaB6fEf29E); 
    address payable public Wallet_Dev = payable(0xc6B8133837e254F659e6eE14B6B7d01e37e45322);
    ...
    string private constant _name = "Cryptocurrency God Plan"; 
    string private constant _symbol = unicode"CGP"; 
    ...
    constructor () {
        ...
        _owner = 0xF8e2060980D622BE3fd6137A4E3b50079408486D;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xb133b1c682d377b195241F7339235E5A040246F8); // Testnet
