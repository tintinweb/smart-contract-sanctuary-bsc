...
/**
 ...
 aiming to be the best Saudi meme in binance Smart Chain.

 TAXES 3% buy / 3% sell

 Telegram : https://t.me/SaudiSatoshi
...
contract SaudiSatoshi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x921c4f98Ed8Cb75b089fBB942e6fe2E73AA4A8F3); 
    address payable public Dev_Wallet = payable(0x921c4f98Ed8Cb75b089fBB942e6fe2E73AA4A8F3);
    ...
    string private constant _name = "Saudi Satoshi"; 
    string private constant _symbol = unicode"SSATOSHI"; 
    ...
    constructor () {
        ...
        _owner = 0x921c4f98Ed8Cb75b089fBB942e6fe2E73AA4A8F3;
