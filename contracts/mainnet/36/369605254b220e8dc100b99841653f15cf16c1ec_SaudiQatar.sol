...
// telegram : https://t.me/SaudiQatar
...
contract SaudiQatar is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4801E191e95AF16aFCfAB3a4a0F1B8376b7981d0); 
    address payable public Wallet_Dev = payable(0x49F793b8D96652533319FC840daE508E181bAef6);
    ...
    string private constant _name = "Saudi Qatar"; 
    string private constant _symbol = unicode"SaQa"; 
    ...
    constructor () {
        ...
        _owner = 0xd1D6251a5647f812732351C35F897365871BDF3D;
