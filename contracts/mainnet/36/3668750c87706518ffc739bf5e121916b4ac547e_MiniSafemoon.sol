...
/**
 Every mini was like ATH after ATH, LETS JOIN US FOR EASY SAFEMOON START

 https://t.me/MiniSafemoonOfficial
*/
...
contract MiniSafemoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniSafemoon";
    string constant _symbol = "MiniSFM";
