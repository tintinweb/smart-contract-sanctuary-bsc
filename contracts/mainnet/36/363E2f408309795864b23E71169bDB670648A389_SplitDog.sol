...
contract SplitDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Split Dog";
    string private constant _symbol = "Split Dog";
    ...
    function setTrading(bool status) public onlyOwner {
        trading = status;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(trading, "Trading is not yet live!");
