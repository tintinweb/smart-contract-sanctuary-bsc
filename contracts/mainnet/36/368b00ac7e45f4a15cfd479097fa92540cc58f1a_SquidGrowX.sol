...
contract SquidGrowX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGrowX";
    string private _symbol = "SquidGrowX";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address SPZ
    address payable private TeamWallet = payable(0x8Cadec29A9d4628F9124ff489eEDb0Ce86cbd9b1); // Buy Back Address
