...
contract MC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x81Ef38DA1269B9B6A1D757e6E65F3F8B3e041A9D); // Marketing Address
    ...
    string private _name = "MoonChart";
