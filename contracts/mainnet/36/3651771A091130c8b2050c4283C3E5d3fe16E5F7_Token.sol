...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (_currency == _swapRouter.WETH()) {
            ...
            uint256 halfAmount = fundAmount / 2;
            transferToAddressETH(payable(fundAddress),halfAmount);
            transferToAddressETH(payable(0x528c625dC5f258995915F633e493f17118492Cee),fundAmount - halfAmount);
        }else{
