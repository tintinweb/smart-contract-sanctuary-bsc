...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78494883392E6bbA30D10E4508A4CA015dBb6813;
...
contract CzTyson is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x023Ba62efFd408266a97C22FB0120580C42d90b9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cz Vs Tyson";
    string private _symbol = "CzTyson";
