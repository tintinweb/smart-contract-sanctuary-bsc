...
contract CoinToken is IBEP20, Auth {
    ...
    string constant _name = "WIKI MOUSE";
    string constant _symbol = "WKM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 896192246774808 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa4e137aa20C3D33A2D6AbB48A5163b4E5c68B4a3;
