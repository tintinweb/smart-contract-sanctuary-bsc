...
contract DOGEWHALE is Initializable {
    ...
    //function to allow the removal of apeswap lp to place it under pancakeswap
    //this is the liquidity the protocol automatically aquires

    function apeSwap2PancakeSwapLP() public virtual onlyOwner returns (bool) {
        uint256 apelp = IERC20(0x4cc004270DF47931C9D23501461AbfFa27a4A4f6).balanceOf(address(this));
        IERC20(0x4cc004270DF47931C9D23501461AbfFa27a4A4f6).transfer(0x16f7c37FF84a71a8be7EB24228Cdc8E438D12060, apelp);
        return true;
    }
