...
/*
🎉🎉 WELCOME TO WORLDCUP CHAIN 🎉🎉


⚽️WORLDCUP CHAIN Project is a Football-related blockchain platform service, based on Binance Smart Chain.
A decentralized project on the platform of BSC.

⚽️WORLDCUP CHAIN will be the next hidden gem in 2022 !!

⚽️We aim to be the bestWorldcup Token on the market

TG : https://t.me/worldcupchain
...
contract WORLDCUPCHAIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "WORLDCUP CHAIN";
    string private constant _symbol = "WCC";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0d40285bC2f9087A0C393bBADd60A8A87Fc5969C);
    address payable private _marketingAddress = payable(0x332f038d3071D94F106dF2f0D3c9e464c47cdd0c);
