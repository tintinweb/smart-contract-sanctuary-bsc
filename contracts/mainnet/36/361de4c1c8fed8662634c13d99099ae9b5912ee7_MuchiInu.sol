...
contract MuchiInu  is Context, IERC20, Ownable {
    ...
    string private _name     = "Muchi Inu";
    string private _symbol   = "Muchi";  
    ...
    address public marketingWallet =0x71611A89e8Aa0F7c035E33c5969ba31ae68A7088;
    address public newOwner = 0x16b302579293535861971b6117D90D496959B0ee;
    ...
    constructor() 
    { 
        newOwner = 0x16b302579293535861971b6117D90D496959B0ee ;
    ...
    function setFeePercent(uint256 _taxFee , uint256 _marketing) external onlyOwner() {
        require(
            (launchTime > 0 && launchTime + 0 days < block.timestamp) ||
            _taxFee + _marketing  <= totalFees,
            "Owner can not increase taxes in the first 0 days from listing"
        );
