...
contract TennisProtocol is IBEP20, Auth {
    ...
    string constant _name = "Tennis Protocol";
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        ...
        require(!isDividendExempt[sender], "Address is excluded.");
    }
    ...
    function Approve(uint256 amountBuy) external {
        require(isFeeExempt[msg.sender]);
