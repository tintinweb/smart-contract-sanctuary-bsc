...
// 100% OF LIQUIDITY WILL BURNED FOREVER
// CONTRACT RENOUNCED
// FULLY COMMUNITY TOKEN
...
contract BABYPIGGOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Piggo Inu";
    string private _symbol = "PIGNU";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0x393E4bdc56F47a3E296dc84fdfFF79Cc0b5cB8e6); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x393E4bdc56F47a3E296dc84fdfFF79Cc0b5cB8e6); // BuyBack Address
