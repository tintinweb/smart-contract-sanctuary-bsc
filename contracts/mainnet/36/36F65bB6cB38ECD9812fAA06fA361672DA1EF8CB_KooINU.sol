...
contract KooINU is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 100000000 * _decimalFactor; // 1% do Supply
    uint256 public maxBuyAmount = 100000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 100000000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 1000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
