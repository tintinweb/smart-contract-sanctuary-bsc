...
contract CVSA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xDD84583be83C7518bF186C28E3d7aeBe0E406749;

    string private constant _name = "Cats vs Apes";
    string private constant _symbol = "CVSA";
