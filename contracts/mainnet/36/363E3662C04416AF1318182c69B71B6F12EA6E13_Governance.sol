...
contract Governance {
    ...
    event SetFee(address indexed product, uint256 feePercent);
    ...
    /** @notice Change product fee */
    function setFeePercent(address _product, uint256 _feePercent)
        public
        onlyVoter
    {
        IProduct(_product).setFeePercent(_feePercent);
        emit SetFee(_product, _feePercent);
    }
}
