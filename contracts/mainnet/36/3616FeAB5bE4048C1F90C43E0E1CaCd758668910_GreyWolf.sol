...
contract GreyWolf is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "GreyWolf";    
    string public symbol = "GREYWOLF";
    uint8 public decimals = 9;   

    uint8 public expensive;
  
    uint8 public takeandsee;   
    ...
    function percent(uint256 iSupply) private pure returns(uint256, uint256) {
    ...
    function newarrival(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
    ...
    function decreasegas(uint256 newCoolWait) external onlyOwner {
        require(
