...
/**
    Project Anti-Jeet
    http://projectantijeet.club/
    https://t.me/AntiJeetProject
**/
...
contract ProjectAntiJeet is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    bool private swapping;
     ...
     AntiJeetDividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0x98DAdc2b691Aa9ADcE26eFB1bF3d4758A37aFcD2);
    address payable public _buybackWalletAddress = payable(0x98DAdc2b691Aa9ADcE26eFB1bF3d4758A37aFcD2);
    ...
    constructor() BEP20("Project Anti-Jeet", "ANTIJEET") 
    {
        dividendTracker = new AntiJeetDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), " AntiJeet: The dividend tracker already has that address");
         AntiJeetDividendTracker newDividendTracker =  AntiJeetDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), " AntiJeet: The new dividend tracker must be owned by the  AntiJeet token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), " AntiJeet: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, " AntiJeet: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, " AntiJeet: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, " AntiJeet: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, " AntiJeet: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, " AntiJeet: Cannot update gasForProcessing to same value");
...
contract  AntiJeetDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken(" AntiJeet_Dividend_Tracker", " AntiJeet_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, " AntiJeet_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, " AntiJeet_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main  AntiJeet contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, " AntiJeet_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, " AntiJeet_Dividend_Tracker: Cannot update claimWait to same value");
