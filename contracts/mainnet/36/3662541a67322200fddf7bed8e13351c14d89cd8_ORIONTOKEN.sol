...
• 3% max buy for the first 5 minutes
• 21% tax on buys and sale for the first 5 minutes
• All block 0 purchases will be blacklisted

After 5 minutes the max buy limits will be removed. 

GET INVOLVED WITH TRANSPARENT
...
contract ORIONTOKEN is Context, IERC20, Ownable, specialEvent {
    ...
    string private _name = "OrionToken";
    string private _symbol = "ORIONTOKEN";
