...
// Telegram : https://t.me/CHEEMSGALA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFe2A3e4a80dEF744feE9bc97a9f3CB90E1C5b659; // owner address
...
contract CHEEMSGALA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHEEMS GALA";
    string private _symbol = "CHEEMSGALA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xFe2A3e4a80dEF744feE9bc97a9f3CB90E1C5b659); // Marketing Address
    address payable public teamWalletAddress = payable(0xFe2A3e4a80dEF744feE9bc97a9f3CB90E1C5b659); // Team Address
