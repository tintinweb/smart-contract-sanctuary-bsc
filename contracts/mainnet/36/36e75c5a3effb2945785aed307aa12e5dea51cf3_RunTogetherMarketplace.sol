...
contract RunTogetherMarketplace is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public minPrice; // minium price for sale
    ...
    function sellItem(
        ...
        require(_price > minPrice, "Price must be greater than limit");
        // Send NFT to market
    ...
    function buyItem(uint256 _saleIndex) external nonReentrant validOpenMarket {
        ...
        emit EventBuyCompleted(_saleIndex, nftId, boxType, sellerAddress, msg.sender, pricing);
    }
