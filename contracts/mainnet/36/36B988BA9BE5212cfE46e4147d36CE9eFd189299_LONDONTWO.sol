...
contract LONDONTWO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "London 2.0";
    string constant _symbol = "LondonTwo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 9_000_000 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0x408b9BF1Bf5E5461F4104b27C093173fa3daed83;
    ...
    bool public sellersPenalties = true;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(selling && sellersPenalties) { return totalSellFee; }
        return totalBuyFee;
    }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setSellersPenalties(bool active) external authorized {
        sellersPenalties = active;
    }
    ...
    function setSellFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee) external authorized {
