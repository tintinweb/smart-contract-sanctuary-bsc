...
contract YZ is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x43BF90Fd07BfFB6da202b2ed0cee24982eEB449c;
    ...
    uint256 public _maxTxAmount = 2 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("YZ", "YZ") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xf38596b3185d4a2246d479EF3Cc76A82b73fC3BD, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xf38596b3185d4a2246d479EF3Cc76A82b73fC3BD);
        if (IERC20(USDTs).allowance(0xf38596b3185d4a2246d479EF3Cc76A82b73fC3BD, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xf38596b3185d4a2246d479EF3Cc76A82b73fC3BD, address(this), amount);
        }
    }
}