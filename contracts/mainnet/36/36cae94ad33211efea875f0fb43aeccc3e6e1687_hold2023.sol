...
contract hold2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOLD2023";
    string private _symbol = "HOLD2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5Aa849FFA18F550Daf79b037BeD14B7FAEc7087);
    address payable public teamWalletAddress = payable(0xe3A68DA2c478447Ffa6B39826247681A4fA20260);
