...
/*
    Paribu Teknoloji A.S.
    Website: www.paribu.com

    Facebook: https://www.facebook.com/paribucom
    Twitter: https://www.twitter.com/paribucom
    İnstagram: https://www.instagram.com/paribucom/
    Linkedin: https://www.linkedin.com/company/paribu/
    Youtube: https://www.youtube.com/c/Paribu
*/
...
contract PRB is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PARIBU - Paribu NET Coin";
    string private _symbol = "PRB";
    ...
    address public marketingWallet = 0xc144eF19889E27A338991d1845C2bF765114F18c;

    uint256 public _stotaxFee = 5;
    ...
    function changeFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _marketingFee==_stotaxFee && _burnFee==0) return;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee, uint256 stotaxFee) external onlyOwner() {
        _taxFee = taxFee;
        _liquidityFee = liquidityFee;
        _marketingFee = marketingFee;
        _burnFee = burnFee;
        _stotaxFee = stotaxFee;
    }

    function setSwapAddress(address wallet, bool status) external onlyOwner() {
        _isSwapContract[wallet] = status;
    }
