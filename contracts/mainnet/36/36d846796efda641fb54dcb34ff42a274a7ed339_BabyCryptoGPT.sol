...
contract BabyCryptoGPT is IBEP20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "BABY CrpytoGPT";
    string private constant _symbol = "BABYCGPT";
    ...
    uint256 _reflectionBuyFee = 60;
    uint256 _marketingBuyFee = 29;

    uint256 _liquiditySellFee = 1;
    uint256 _reflectionSellFee = 60;
    uint256 _marketingSellFee = 29;
