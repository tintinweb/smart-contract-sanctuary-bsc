...
/**
Telegram : https://t.me/santamagicbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb6e100CB9A2FCcC5f68B7CB03628A3aC382fc6a5; // owner address
...
contract SantaMagic is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Magic";
    string private _symbol = "HiHiHi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3425A3BDAf63be65c897B44304514211bEf14911); // Marketing Address
    address payable public teamWalletAddress = payable(0xb6e100CB9A2FCcC5f68B7CB03628A3aC382fc6a5); // Team Address
