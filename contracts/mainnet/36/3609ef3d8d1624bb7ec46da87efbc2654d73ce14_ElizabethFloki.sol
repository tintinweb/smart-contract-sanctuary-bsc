...
/** 
    Elizabeth Floki
    Telegram : https://t.me/elizabethfloki_bsc
*/
...
contract ElizabethFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Elizabeth Floki";
    string private _symbol = "ELIZABETHFLOKI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x47b6D74EAD58226339620a97ADd905D51797A3Ca);
