...
contract GoogleAiBsc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Google Ai";
    string private _symbol = "GOOGLEAI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xe9AD388148fB4E998DCf36e393A6638F602C699f);
