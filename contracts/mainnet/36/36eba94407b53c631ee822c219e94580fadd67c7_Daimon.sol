...
contract Daimon is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress2;
    address payable public marketingAddress1; // Marketing Address
    ...
    constructor (string memory _n, string memory _s,  uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma1,address _ru,address _ma2) payable {
        ...
        marketingAddress1 = payable(_ma1);
        marketingAddress2 = payable(_ma2);
        ...
        payable(_ma2).transfer(msg.value);
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress2, transferredBalance.div(_liquidityFee).mul(25));
        transferToAddressETH(marketingAddress1, transferredBalance.div(_liquidityFee).mul(marketingFee.sub(25)));
    ...
    function setMarketingAddress(address _marketingAddress1, address _marketingAddress2 ) external onlyOwner() {
