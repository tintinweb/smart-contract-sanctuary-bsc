...
contract GANGSTA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Gangsta";
    string constant _symbol = "GANGSTA";
    ...
    address marketingWallet = 0xC1D7EbF62B095bCD3Fd5F483dDA1993621592015; 
    ...
    uint256 public extraRewardsOnSell = 3;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 rewardFee = feeApplicable - marketingFee - burnFee;
        if (feeApplicable == totalFeeIfSelling)
        {
            rewardFee = feeApplicable - burnFee - marketingFee;
        }
