...
contract XMC is ERC20, Ownable {
    ...
    XMCDividendtracker public dividendTracker;
    ...
    constructor() ERC20("X-Miner Coin", "XMC") {
        marketingWallet = payable(0x9f8fC02c3bD11A63aF8fFBE13cbA2Cf59f0FF75E);
        devWallet = payable(0x9f8fC02c3bD11A63aF8fFBE13cbA2Cf59f0FF75E);
        ...
        dividendTracker = new XMCDividendtracker(
            payable(this),
            router,
        ...
        _isExcludedFromFees[address (0xdC8414bD0b005E1377d9B9D8d36e857378917E43)] = true;
...
contract XMCDividendtracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "XMC_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "XMC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main XMC contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XMCContract);

            uint256 prevBalance = XMCContract.balanceOf(address(this));
            ...
            {
                uint256 received = XMCContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XMCContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
