...
contract CatFarm{
    ...
    function rebakeLasagna(address ref) public{
        require(initialized);
    ...
    function bakeLasagna(address ref) public payable{
        require(initialized);
    ...
    function updateDevWallet() public payable{
        require(msg.sender == ceoAddress, 'invalid call');
