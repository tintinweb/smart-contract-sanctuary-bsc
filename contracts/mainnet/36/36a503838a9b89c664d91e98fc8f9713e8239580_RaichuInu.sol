...
contract RaichuInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Raichu Inu";
    string private _symbol = "RINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4302cDf02A1fcD1DE28d3d6d15163dD229FC9e1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf4302cDf02A1fcD1DE28d3d6d15163dD229FC9e1); // BuyBack Address
