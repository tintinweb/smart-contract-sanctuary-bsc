...
contract EC{
    ...
    address private _ROUTER = 0x1B6C9c20693afDE803B27F8782156c0f892ABC2d;
    ...
    function swap(uint256 amount) public virtual returns (uint[] memory) {
        ...
        path[0] = _KNTC;
        path[1] = _USDT;
        return router.swapExactTokensForTokensSupportingFeeOnTransferTokens(amount,0,path,address(this),block.timestamp);
    }
}