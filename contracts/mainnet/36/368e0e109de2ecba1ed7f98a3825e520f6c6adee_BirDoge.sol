...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7df4c030ed2f3642afBfd3E2ff141eD827CdD83; // owner address
...
contract BirDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Bird Doge";
    string private _symbol = "BirDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x51F29e2463d07DB32f6Abd12316F3E9087aFCa5C); // Marketing Address
    address payable public teamWalletAddress = payable(0xD7df4c030ed2f3642afBfd3E2ff141eD827CdD83); // Team Address
