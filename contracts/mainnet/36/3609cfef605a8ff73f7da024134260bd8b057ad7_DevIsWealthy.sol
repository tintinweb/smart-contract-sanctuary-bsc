...
contract DevIsWealthy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is Wealthy";
    string private _symbol = "DIW";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x05d9F4996919342B2d155E650797648884F4b32e);
