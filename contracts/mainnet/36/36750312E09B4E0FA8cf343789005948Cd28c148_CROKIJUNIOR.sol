...
BSC LAUNCH OF THE CRO BANGER THAT WAS CROKI JUNIOR NFTS AND STAKING WILL BE AVAILABLE SHORTLY AFTER LAUNCH
STEALTH LAUNCH CAUSE CMON WHO DOESNT LOVE A STEALTH
...
contract CROKIJUNIOR is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'CROKI JUNIOR';
    string private constant _symbol = 'CROKIJR';
