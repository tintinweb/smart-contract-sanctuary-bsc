...
// *Telegram : https://t.me/SafeSquidGrow
...
contract safesquidgrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeSquidGrow"; // 
    string private constant _symbol = "$SAFESQUIDGROW"; //    
