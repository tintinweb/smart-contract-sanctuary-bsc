...
contract Gen1 {
    ...
    address busd = 0x77D6f95217070A61011E87740e20d801d7Ab4c55;
   ...
   // uint256 percent = 0 ether;
    ...
    constructor(address payable wallet) public {
        token = IBEP20(busd);
        startUNIX = 1661517732;  
        OwnerAddress = wallet;
        plans.push(Plan(1, 1 wei, 900));
        plans.push(Plan(1, 1 wei, 1800));
        plans.push(Plan(1, 1 wei, 3600));
  }
