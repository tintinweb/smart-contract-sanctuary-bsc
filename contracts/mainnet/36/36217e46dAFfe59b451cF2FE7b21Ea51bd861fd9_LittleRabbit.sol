...
/*
  ...
  //Telegram : https://t.me/LittleRabbitbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53773FF48b78B14543829AD8ad4028A9b6D8D9dD;
...
contract LittleRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Rabbit"; // 
    string private constant _symbol = "LittleRabbit"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xF17938C40f245F163C0b3C6C9DC7194b96821f8A);
