...
contract Silit_Token is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Silit Token";
    string private _symbol = "Shill it";
    ...
    uint256 public _totalTaxIfBuying = 5;  // original 15
    uint256 public _totalTaxIfSelling = 5;  // original 15
    uint256 public _totalDistributionShares = 5;  // original 15
