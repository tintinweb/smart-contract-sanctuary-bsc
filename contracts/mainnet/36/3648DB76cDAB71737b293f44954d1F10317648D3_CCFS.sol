...
contract CCFS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCFS";
    string private _symbol = "CCFS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x272173e39EF808675A835775ce7690FbB55d469a);
    address payable public teamWalletAddress = payable(0x272173e39EF808675A835775ce7690FbB55d469a);
    address public immutable deadAddress = 0x272173e39EF808675A835775ce7690FbB55d469a;
