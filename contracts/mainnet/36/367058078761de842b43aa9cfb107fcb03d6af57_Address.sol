...
contract DFH2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DFH2";
    string private _symbol = "DFH2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0c2804Bf7DE0ec736150eA524FF785Dce10b8CB5); 
    address payable public teamWalletAddress = payable(0x318121a337be30e80b031b00BA616fC9d2a53fAB); 
