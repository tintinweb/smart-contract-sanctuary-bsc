...
/**
Welcome to JOTB. Together we will celebrate!
Join the TG https://t.me/JackOffBSC
...
contract JackOff is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JackOff";
    string private _symbol = "JOTB";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x2AdC498304caB5D4302a45039836Dd91eDc1fa1f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2AdC498304caB5D4302a45039836Dd91eDc1fa1f); // BuyBack Address
