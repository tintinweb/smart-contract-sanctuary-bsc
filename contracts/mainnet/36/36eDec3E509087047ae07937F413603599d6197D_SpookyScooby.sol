...
/**
Telegram - https://t.me/SpookyScoobydoo
...
contract SpookyScooby is IBEP20, Auth {
    ...
    address DEV = 0xb6fcBDAE239d8872f0347C89F1FF254141e897A6;
    ...
    // Name and symbol
    string constant _name = "SPOOKY SCOOBY DOO";
    string constant _symbol = "SPOOKSCOOB";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% 
    ...
    uint256 public swapThreshold = _totalSupply * 300 / 10000; // 2% of supply
