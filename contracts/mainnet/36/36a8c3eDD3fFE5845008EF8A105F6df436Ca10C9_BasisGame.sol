...
contract LPTokenWrapper {
    ...
    function stake(uint256 amount) public {
        ...
        TokenSEA.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        TokenSEA.safeTransfer(msg.sender, amount);
    }
}
...
contract BasisGame  is LPTokenWrapper
{
	...
	constructor(address _TokenOSK,address _TokenBGM) LPTokenWrapper(IERC20(_TokenOSK)) public
    {
        ...
        RewardsPS = 10802469135802469;   //1400000000000000000000 / 36 / 3600
