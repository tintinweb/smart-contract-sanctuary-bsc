...
/**
BABY GOOSEREUM (BABYGOOSER)

GOOSER is trending on BSC. We created Baby Gooser for Gooser holders to get Gooser rewards.

Supply: 1,000,000,000,000,000 tokens
2% Rewards in GOOSEREUM
2% Marketing

TG: https://t.me/BABYGOOSEREUM_BSC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xC444C8d84385b8ca21866f17333C2425584F8B36);
...
contract BABYGOOSER is IERC20, Ownable {
    using SafeMath for uint256;

    
    address REWARD = 0xC444C8d84385b8ca21866f17333C2425584F8B36;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY GOOSEREUM";
    string constant _symbol = "BABYGOOSER";
    ...
    uint256 public swapThreshold = _totalSupply * 450 / 100000;
    bool inSwap;
