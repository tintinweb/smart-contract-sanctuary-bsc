...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x92f8aCD124Cfc8c1FeE78514d6AE57b8553f3A1C); //Andrew Tate Inu 
...
contract TristanTateInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TRISTAN TATE INU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2A28ACA203606b43aaCbF169B3019b383c0df618;  //marketingwallet
        anothermarketingWallet = 0x2A28ACA203606b43aaCbF169B3019b383c0df618; // this is dev wallet but there's no team fee sirs don't worry
