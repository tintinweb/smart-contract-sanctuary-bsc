...
ZapdosCoin is a 100% safe token with very low taxes
...
contract ZapdosCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ZapdosCoin";
    string constant _symbol = "ZCoin";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x102Df958009C89fA075aBe7Da1A2AB3bD528De71;
