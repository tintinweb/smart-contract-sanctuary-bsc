...
/**
Join the Cloudcat Community!
$CC is an ownership renounced community Defi Education token on the BSC based around a cat who's actual name is Cloudcat! Hold Cloudcat to generate passive income and be a part of the worlds FIRST Defi Learn to Earn Platforms! Diversify, Learn, and Grow with Cloudcat Learn and Earn. 📚💰😻
...
contract cloudcat is Context, IERC20, Ownable {
    ...
    string private constant _name = "cloudcat"; // 
    string private constant _symbol = "CC"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0xC18eac460E54d693febe8cb0AD140d26bbF57C41;
