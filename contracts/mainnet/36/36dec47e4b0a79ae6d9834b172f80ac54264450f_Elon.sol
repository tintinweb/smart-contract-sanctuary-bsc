...
/*
        ...
        Elon SUS BR
        https://twitter.com/br_elon
        https://t.me/ElonSUSBR
        Contact: [email protected]
        CMC and CG soon
        Exchange listing soon too
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant BTC = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract Elon is ERC20, Ownable {
    ...
    address private constant BTC = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);

    uint256 public swapTokensAtAmount = 8000 * (10**8);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0xf4436F0ddE943d3Bd80B8A5e6FD5Da0180853ADd)); //marketing wallet
    ...
    constructor() ERC20("Elon SUS BR", "ESBR") {
        ...
        */
        _mint(owner(), 21000000 * (10**8));

        maxTxAmount = 100000000000000;
    }
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    address public addressOwner = address(0x1c9A2FE5FF2484374b643EA9fee3670c59F8992c);
