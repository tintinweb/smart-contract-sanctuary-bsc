...
contract StonksCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StonksCat";
    string constant _symbol = "$STONKSCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xd141e4edC0D3B16609798a83b1d070136019E6A8;
