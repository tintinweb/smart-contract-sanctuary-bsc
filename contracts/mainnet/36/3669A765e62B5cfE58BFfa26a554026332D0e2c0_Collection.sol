...
contract Collection is ERC721, ERC721Enumerable, Ownable {
    ...
    // List of tokens allowed to use to mint NFT
    ...
    constructor() ERC721("Vault Finance Diamond NFT Collection", "VFD") {}
    ...
    return "ipfs://QmNekqS2JxP3ggnAfVqkTB522HnDMhsMuSABRNyTKgdvNQ/";
    ...
    function mintpid(address _to, uint256 _mintAmount, uint256 _pid) public payable {
        ...
        require(isAllowListActive, "Allow list is not active");
            ...
            if (msg.sender != owner()) {
            require(paytoken.balanceOf(msg.sender) >= cost * _mintAmount);
            }
            _allowList[msg.sender] -= _mintAmount;
            for (uint256 i = 1; i <= _mintAmount; i++) {
