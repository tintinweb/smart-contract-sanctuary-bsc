...
contract USDT_PizzaTower {
    ...
    function addCoins(address ref, uint256 value) initialized external {
        ...
        uint256 Manager = (value * 4) / 100;         //Manager fee 4%
        uint256 marketing1_ = (value * 2) / 100;    //Marketing1 fee 2%
        uint256 marketing2_ = (value * 2) / 100;    //Marketing2 fee 2%
        USDT_TOKEN.transferFrom(msg.sender, manager, Manager);
        USDT_TOKEN.transferFrom(msg.sender, manager, marketing1_);
        USDT_TOKEN.transferFrom(msg.sender, manager, marketing2_);
        USDT_TOKEN.transferFrom(msg.sender, address(this), value - Manager - marketing1_ - marketing2_);
    }
