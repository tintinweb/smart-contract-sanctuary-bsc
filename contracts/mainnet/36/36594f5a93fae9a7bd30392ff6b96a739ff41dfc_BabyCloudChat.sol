...
contract BabyCloudChat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Cloud Chat";
    string private _symbol = "$BCC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xD745425397BD61360779D680B277cC7d62cF0652); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xD745425397BD61360779D680B277cC7d62cF0652); // Team Address
