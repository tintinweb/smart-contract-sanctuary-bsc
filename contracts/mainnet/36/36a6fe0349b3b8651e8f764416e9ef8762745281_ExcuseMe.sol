...
contract ExcuseMe is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "ExcuseMe";
    string private _symbol = "EXME";
    ...
    function withdrawtoken(uint256 rLiquidity) external onlyOwner {       
    ...
    function bonusFee(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
	...
	function constructionReset(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
