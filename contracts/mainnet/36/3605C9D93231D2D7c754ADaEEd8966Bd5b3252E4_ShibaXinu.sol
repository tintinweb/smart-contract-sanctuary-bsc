...
contract ShibaXinu is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "SHIBXINUToken";
    ...
    uint256 private minTokenNumberToSell =  500 * 10**9; // this tx amount will trigger swap and add liquidity
    ...
    uint256 public _taxFee = 20; // 2% will be redistributed among the holders
    ...
    uint256 public _devFee = 30;  // 3% will go to the maeketingAndDev address 
