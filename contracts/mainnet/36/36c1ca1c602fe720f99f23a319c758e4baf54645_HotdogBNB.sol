...
contract HotdogBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hotdog BNB"; // 
    string private constant _symbol = "HDBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xF89883aBcfc7aa2e65Bc59049A1278716C4eA124;
