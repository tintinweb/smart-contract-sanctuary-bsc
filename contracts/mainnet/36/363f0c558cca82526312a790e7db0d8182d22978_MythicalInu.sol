...
Telegram Chat: https://t.me/MythicalInu
...
contract MythicalInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mythical Inu"; //
    string private constant _symbol = "MythicalInu"; //
