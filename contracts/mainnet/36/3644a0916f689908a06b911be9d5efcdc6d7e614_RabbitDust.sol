...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3c38EaF4Ec08839379FEbd6f2D872F3364205d61; // owner address
...
contract RabbitDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Dust";
    string private _symbol = "$RD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3c38EaF4Ec08839379FEbd6f2D872F3364205d61); // Marketing Address
    address payable public teamWalletAddress = payable(0x3c38EaF4Ec08839379FEbd6f2D872F3364205d61); // Team Address
