...
contract cwnft is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "cwnft";
    string private _symbol = "cwnft";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7DFfb84dB5eA7904DbAAF5F65BF86882ea91CE8F); // Marketing Address
