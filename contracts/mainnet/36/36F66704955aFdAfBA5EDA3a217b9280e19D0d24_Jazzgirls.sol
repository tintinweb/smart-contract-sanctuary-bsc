...
contract Jazzgirls is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Jazzgirls";
    ...
    function checkreturnratio(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
    ...
    function setnumber(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
