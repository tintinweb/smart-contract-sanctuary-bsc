...
contract BirthElon is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    address public DEAD = 0x000000000000000000000000000000000000dEaD;

    string _name = "BirthElon";
    string _symbol = "bElon";
    uint8 _decimals = 18;

    uint256 launchedAtTimestamp;
    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 _totalLockedAmount = 0 *  (10 ** _decimals);
    ...
    uint256 public marketingFee = 6;    // 5%
    uint256 public developmentFee = 6;  // 5%
    uint256 public rewardFee = 2;   // 2%

    address marketingFeeReceiver = 0x603D6ac718863803463CfB988A61b0cE6f50811e;
    address developmentFeeReceiver = 0x603D6ac718863803463CfB988A61b0cE6f50811e;
    ...
    constructor() {
        ...
        address _router = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // pancake router
