...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd22E3a5520DE4b106199c5937176BfAD55C7f244;
...
contract LankyBox is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5123AAC61435A0407073E66491C460A7c9828488;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LankyBox";
    string private _symbol = "LBOX";
