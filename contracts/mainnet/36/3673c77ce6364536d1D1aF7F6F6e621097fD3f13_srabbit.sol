...
contract srabbit is Context, IERC20, Ownable {
    ...
    string private _name = "srabbit";
    string private _symbol = "srabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C9b690D05b79FA354182D578006Da0aa028108A);
    address payable public teamWalletAddress = payable(0x07e7Ecc618690bb9daF13792004dD85eD11e3229);
