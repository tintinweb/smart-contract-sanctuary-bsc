...
contract ARABIANNOMAD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf0B94F1DfDfac2b36B39f6dC3b75A9BdCDdfae86); 
    address payable public Wallet_Dev = payable(0x7AcEb631Cf37d2D67C1b0A66e1EbC5c6dB5d6804);
    ...
    string private constant _name = "ARABIAN NOMAD"; 
    string private constant _symbol = unicode"ARAB NOMAD"; 
    ...
    constructor () {
        ...
        _owner = 0x7AcEb631Cf37d2D67C1b0A66e1EbC5c6dB5d6804;
