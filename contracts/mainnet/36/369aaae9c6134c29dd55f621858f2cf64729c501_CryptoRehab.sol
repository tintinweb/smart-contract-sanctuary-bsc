...
https://t.me/+NPYDyc8IBuFlYmZk

We will add 10 members first, let them invest (5min),
then we add 10 others (5min), we add 10 others ect,
we keep this until we reach 100 members then
I ll open the group to public and add everyone.
*/
...
contract CryptoRehab is IERC20, Ownable {
