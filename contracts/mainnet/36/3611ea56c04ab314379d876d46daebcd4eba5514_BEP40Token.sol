...
contract BEP40Token is Context, IBEP40, Ownable {
    ...
    constructor() {
        ...
        _mint(_msgSender(), 60 * 10**8 * 10**_decimals);
    }
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "BEP40: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "BEP40: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(
            amount,
            "BEP40: burn amount exceeds balance"
        );
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            ...
            _allowances[account][_msgSender()].sub(
                amount,
                "BEP40: burn amount exceeds allowance"
            )
        );
    }
}