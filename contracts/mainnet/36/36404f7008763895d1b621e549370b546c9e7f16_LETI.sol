...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x521609CBAd5418C438F12626dC4f20Dd031D7DC8;
...
contract LETI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf4DAf1505653720Eea46094ad4bfc33736677A2b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1800000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LETI";
    string private _symbol = "LETI";
