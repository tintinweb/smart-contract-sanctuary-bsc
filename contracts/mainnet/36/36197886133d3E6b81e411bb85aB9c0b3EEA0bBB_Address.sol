...
/*
Safe dev
Telegram:https://t.me/BNBGrowPortalOfficial
Taxes: 10/10
*/
...
contract BNBGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Bnb Grow";
    string private _symbol = "BNBGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6AD2A7838F642A9CaAe12650A557C3303470244); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3716Da6551e8c0401376DB7D0d9580B4b1e9f5Eb); // BuyBack Address
    ...
    uint256 private _maxSellTxAmount = 20 * 10**6 * 10**9;
