...
/*$Skullgirls
will launch evenly on October 3rd on Pancakeswap🔔

👾Website : 
https://skullgirls.net
👾Twitter   : 
https://twitter.com/skullgirls_bsc
👾Group     : 
t.me/Skullgirlsportal
*/
...
contract SKULLGIRLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SKULL GIRLS";
    string private _symbol = "SKG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb47503ec0944f5A0c0BDc56F9030F045CFBEC26c);
    address payable public teamWalletAddress = payable(0xb47503ec0944f5A0c0BDc56F9030F045CFBEC26c);
