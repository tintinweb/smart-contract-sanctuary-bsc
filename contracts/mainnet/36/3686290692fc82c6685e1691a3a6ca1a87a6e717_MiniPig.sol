...
contract MiniPig is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x311df4fdB042C0146aEcB3192Fa5AAfFa427344b;
    address DevWallet       = 0x96C57250B06374F41F0F4B9F5A8A789962e0D566;

    string constant _name = "Mini Pig Adventure";
    string constant _symbol = "MPA";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply / 450;
    bool inSwap;
