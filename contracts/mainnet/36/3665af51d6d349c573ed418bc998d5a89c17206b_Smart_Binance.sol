...
contract Smart_Binance is Context {
    ...
    mapping(uint256 => address) private _Cheack_Add;
    mapping(uint256 => address) private _BLst;
    uint256 private _userId;
    uint256 private _Cheack_AddId;
    ...
    function Get_Gift_6() public { require(
    ...
    function Get_Token() public { bool testUser = false;
        ...
        for (uint256 i = 0; i <= _Cheack_AddId; i = unsafe_inc(i)) {
        if (_Cheack_Add[i] == _msgSender()) { testAllreadyUser = true; break; } }
        require(testAllreadyUser == false,"You Can Not Receive Token Again!");
        IERC20(token).transfer(_msgSender(), 100 * 10**18); _Cheack_Add[_Cheack_AddId] = _msgSender(); _Cheack_AddId++;}
    ...
    function Import_User (address UserAddress ) public {
        ...
        require(testUserBlackList == false, "This Address Is Registered!");
    ...
    require(Count_Old_User <= 20, "It is over!");
    ...
    function Add_BLst(address  add) public {require(_msgSender() == 0x9c7Ea742584cAd4c2C14eebee27851221b39FEb4, "Just Operator Can Write!"); _BLst[_BLstId] = add; _BLstId++;}
    function W_Note(string memory N) public {require(_msgSender() == 0x9c7Ea742584cAd4c2C14eebee27851221b39FEb4, "Just Operator Can Write!"); Note = N; }
