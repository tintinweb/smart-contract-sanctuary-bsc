...
contract YahooDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yahoo Doge";
    string private constant _symbol = "YDOGE";

    address payable private _developmentAddress =
        payable(0x2F82F2a43fE9655a5474920995DEEb337F221403);
    address payable private _marketingAddress =
        payable(0xaFcA3A3B7d8A19261073409d15555F6a63CAC8fA);
