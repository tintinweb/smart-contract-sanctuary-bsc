...
contract BullyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1969d3650AacEcd15b7372198D0dc5A3c469D9Eb); // Marketing Address
    ...
    uint256 private _tTotal = 500000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BullyDoge";
    string private _symbol = "BullyDoge";
