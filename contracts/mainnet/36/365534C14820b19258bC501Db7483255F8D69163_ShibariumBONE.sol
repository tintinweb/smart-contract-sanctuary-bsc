...
/*
         ...
         ______   ____   ____  ____       _____         _____        _____    ____  ____   ____      ______  _______   
     ___|\     \ |    | |    ||    | ___|\     \    ___|\    \   ___|\    \  |    ||    | |    |    |      \/       \  
    |    |\     \|    | |    ||    ||    |\     \  /    /\    \ |    |\    \ |    ||    | |    |   /          /\     \ 
    |    |/____/||    |_|    ||    ||    | |     ||    |  |    ||    | |    ||    ||    | |    |  /     /\   / /\     |
 ___|    \|   | ||    .-.    ||    ||    | /_ _ / |    |__|    ||    |/____/ |    ||    | |    | /     /\ \_/ / /    /|
|    \    \___|/ |    | |    ||    ||    |\    \  |    .--.    ||    |\    \ |    ||    | |    ||     |  \|_|/ /    / |
|    |\     \    |    | |    ||    ||    | |    | |    |  |    ||    | |    ||    ||    | |    ||     |       |    |  |
|\ ___\|_____|   |____| |____||____||____|/____/| |____|  |____||____| |____||____||\___\_|____||\____\       |____|  /
| |    |     |   |    | |    ||    ||    /     || |    |  |    ||    | |    ||    || |    |    || |    |      |    | / 
 \|____|_____|   |____| |____||____||____|_____|/ |____|  |____||____| |____||____| \|____|____| \|____|      |____|/  
    \(    )/       \(     )/    \(    \(    )/      \(      )/    \(     )/    \(      \(   )/      \(          )/     
     '    '         '     '      '     '    '        '      '      '     '      '       '   '        '          '      
                                                                                                                       


                                        Telegram : https://t.me/ShibariumBoneBSC

                                        Twitter : Twitter: https://twitter.com/ShibariumBone_
...
contract ShibariumBONE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private ManagementWallet = payable(0xac4f5651c0766a91A90Afb5afC3707f033C6bd83);
    address payable public BURNDEADWALLET = payable(0x000000000000000000000000000000000000dEaD); 
    ...
    */
    ...
    string public _name = "Shibarium Bone"; 
    string public _symbol = "SBONE";  
    ...
    */
    ...
    constructor () {
        ...
        noWalletLimit[ManagementWallet] = true;
        noWalletLimit[BURNDEADWALLET] = true;
        noWalletLimit[owner()] = true;
        noWalletLimit[address(this)] = true;

        // Remove Tx Limits from wallets
        noTransactionLimit[owner()] = true;
        noTransactionLimit[BURNDEADWALLET] = true;
        noTransactionLimit[ManagementWallet] = true;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(ManagementWallet,contractBNB);
    }
