...
contract WEIBOINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WEIBO INU COIN";
    string private _symbol = "WEIBOINU";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x14c2fbA24B213d1bDe018B92F8701B1e7Ee5df44); // Marketing Address
    address payable private TeamWallet = payable(0x14c2fbA24B213d1bDe018B92F8701B1e7Ee5df44); // Buy Back Address
