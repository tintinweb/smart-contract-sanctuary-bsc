...
contract token is ERC20 {
    ...
    string internal tokenName = "MBEDAO";
    string internal tokenSymbol = "MBEDAO";
    uint256 constant total  =  120000 * 10**18;
    address public marketAddress = address(0x431e4C5F7d1Ca8a6B0eEa7b65e5950a638fBcABe);
    uint256 buyFee = 20;
    uint256 sellFee = 960;
