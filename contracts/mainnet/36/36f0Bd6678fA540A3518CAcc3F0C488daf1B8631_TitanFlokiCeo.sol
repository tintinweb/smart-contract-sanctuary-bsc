...
contract TitanFlokiCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " TitanFlokiCeo ";
    string private _symbol = " TitanFlokiCeo "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE666f13622225509F0d7bad0f8834c85f27362e3); 
    address payable public teamWalletAddress = payable(0xE666f13622225509F0d7bad0f8834c85f27362e3); 
