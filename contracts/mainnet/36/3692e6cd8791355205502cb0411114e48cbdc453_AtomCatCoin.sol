...
/*
https://t.me/AtomCatCoin

*Inovative Staking contract. Web3 Site that interacts with contract coming soon.
*Until then, just stake and claim rewards directly with the contract on BscScan.
*Hold this and we will all moon with AtomCat Coin and have nice passive rewards income.
*Do not snipe this. You will cry. 
...
//Contract
contract AtomCatCoin is IBEP20, Ownable {
    ...
    string private constant _name = 'AtomCat Coin';  
    ...
    uint16 private constant SellLimitDivider=200; //.5% = 5,000,000
    uint8 public constant MaxTax=32;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    ...
    address public MainReward=0x0Eb3a705fc54725037CC9e008bDede697f62F335;   //change this address to desired reward token
...
//constructor
    constructor () {
        ...
        MarketingWallet= 0x559CCED3Ab268455FbD19C0A42ecaa42fBe01C81;
        ...
        _excluded.add(0x5FA9cd78F3a626b825955a6a8F71969643C2f6aF);
        _excluded.add(0x6c1b6396502245ba87741eaB3E86CF5e1E74aD38);
