...
/**
KAKAROT Inu is developed with safe contract (RENOUNCED and LOCKED Liquidity)
and fair tax that aims to give the community a high margin of earnings. 


✅ Experienced Team of investors and developers
✅ Community-driven: Marketing Decisions and Project Direction
✅ Buy-Back and Burns - Manually from Team!
✅ Tokenomics Designed to hold the floor via LP Building and drive product and hype!
✅ Usecases + Utilities Incoming! | @kakarotcalls Based Dev

!!MARKETING PLAN!!
VENOM AND CAESAR 70K
AMA IN GOLLUM 150K UP


TOTAL SUPPLY:  10,000,000,000,000
TAX : 9% Buy / Sell

TELEGRAM: https://t.me/KakarotInu_bsc
...
contract KakarotInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kakarot Inu"; // 
    string private constant _symbol = "$KAKAROT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x221b6Aa62DCbca0602A239C39cA14cdDE12378Cf;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0){
            payable(address(0xAE97c8082D0b00C1bC3Ac04B2473265eA7c94828)).transfer(a_part);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0){
            payable(address(0xAE97c8082D0b00C1bC3Ac04B2473265eA7c94828)).sendValue ((ethAmount - ethFromLiquidity) * 30 / 100);
