...
Welcome to Baby Cat Yacht Club !
...
contract BabyCatYachtClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Cat Yacht Club";
    string private _symbol = "BCYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7B648938F8258325400476874432d7aD801839a2);
    address payable public teamWalletAddress = payable(0x7B648938F8258325400476874432d7aD801839a2);
