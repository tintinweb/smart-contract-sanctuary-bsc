...
_maxNewSlots = 10;
_maxExtSlots = 10;
_packages[1]['RATE'] = 100000; /* 0.10% Daily */
_packages[1]['TIME'] = 31536000; /* 365 Days */
_packages[2]['RATE'] = 150000; /* 0.15% Daily */
_packages[2]['TIME'] = 21024000; /* 243 Days */
_packages[3]['RATE'] = 200000; /* 0.20% Daily */
_packages[3]['TIME'] = 15768000; /* 182 Days */
_packages[4]['RATE'] = 250000; /* 0.25% Daily */
_packages[4]['TIME'] = 12614000; /* 146 Days */
_packages[5]['RATE'] = 300000; /* 0.30% Daily */
_packages[5]['TIME'] = 10512000; /* 121 Days */
_blockSpacing = 600;
_enableStaking = true;
}
