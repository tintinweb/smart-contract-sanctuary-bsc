...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe4375B9D8B80bD7c432F91c361a4F8e38ece62D9; // owner address
...
contract BlueSafeMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Blue SafeMoon";
    string private _symbol = " BSFM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4375B9D8B80bD7c432F91c361a4F8e38ece62D9); // Marketing Address
    address payable public teamWalletAddress = payable(0xe4375B9D8B80bD7c432F91c361a4F8e38ece62D9); // Team Address
