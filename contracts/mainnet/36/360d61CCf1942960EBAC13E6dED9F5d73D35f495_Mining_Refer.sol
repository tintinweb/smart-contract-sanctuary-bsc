...
contract Mining_Refer is OwnableUpgradeable {
    struct UserInfo {
        address invitor;
        uint refer;
        bool isInvitor;
    ...
    function setAddress(address main_) public onlyOwner {
        main = Mining(main_);
    ...
    function buyRefer() public {
        ...
        IERC20(TGG).transferFrom(msg.sender, burnAddress, need);
        userInfo[msg.sender].isInvitor = true;
    }

    function getReferPrice() public view returns (uint){
        return referPrice * 1e18 / main.getTGGPrice();
    }
