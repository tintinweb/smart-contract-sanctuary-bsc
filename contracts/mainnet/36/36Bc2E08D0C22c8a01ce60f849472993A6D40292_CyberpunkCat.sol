...
contract CyberpunkCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyberpunk Cat";
    ...
    address payable private marketingWalletAddress = payable(0x207af251aBDc41855d404a56FbC0D241Af5347eA);
    address payable private devWallet = payable(0x6b25Cb9338b4cEC5632aFd12B905C9C25a71BB4b);
    address payable private liquidityWalletAddress = payable(0x207af251aBDc41855d404a56FbC0D241Af5347eA);
    ...
    uint256 public _totalTaxIfBuying = 350;
    uint256 public _totalTaxIfSelling = 350;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 totalShare = _DevShare.add(_marketingShare);
        uint256 amountBNBDev = amountBNBLeft.mul(_DevShare).div(totalShare);
        uint256 amountBNBMarketing = amountBNBLeft.sub(amountBNBDev);

        if(amountBNBMarketing > 0)
            transferToAddressETH(marketingWalletAddress, amountBNBMarketing); 
        if(amountBNBDev > 0)
            transferToAddressETH(devWallet, amountBNBDev); 
