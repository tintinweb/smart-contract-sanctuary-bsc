...
contract FreemasonInu is IBEP20, Auth {
    ...
    string constant private _name = "Freemason-Inu";
    string constant private _symbol = "FMI";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __marketingFee, uint256 _taxLiquidity, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxLiquidity = _taxLiquidity;
        _marketingFee = __marketingFee;
        devFee = _devFee;
        totalFee = _taxLiquidity.add(__marketingFee).add(_devFee);
