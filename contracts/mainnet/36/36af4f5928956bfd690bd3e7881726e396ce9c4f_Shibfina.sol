...
/* 
🦴Shib fina🦴
🦴Degen BSC Bullish Future name 

🦴Shiba Inu Wallet
Store and manage your Shiba Inu in multi-asset  chains future Crypto Wallet on iOS, Android and the web.

🦴lock lp 
🦴renounce ownership
🦴tax 4% return to holders 4% as reflection $ShibFina
https://t.me/ShibaFina
🦴website links 

Enjoy Shiba Inu Wallets official links

https://freewallet.org/shib-wallet
Create Shiba Inu Wallet and experience all the advantages of mobile cryptocurrency wallets with our apps for iOS and Android. 

https://zengo.com/assets/shiba-inu/
Woof! ZenGo ❤️ SHIB! Shiba Inu (SHIB) is an Ethereum-based ERC-20 token with an outstanding, dynamic, and passionate community. 

https://www.exodus.com/shiba-inu-wallet
Exodus Shiba Inu Wallet
Send, Receive, and Exchange
With Exodus' Free and Secure Shiba Inu Walle

https://www.ledger.com/shiba-inu-wallet
Shiba Inu wallet
SECURE YOUR SHIB ASSETS
Secure your Shiba Inu assets with the most trusted hardware wallet. 
*/
...
contract Shibfina is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Shib fina';
    string private _symbol = 'ShibFina';
