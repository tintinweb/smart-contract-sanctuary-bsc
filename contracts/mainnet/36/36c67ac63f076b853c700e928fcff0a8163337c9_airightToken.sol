...
https://t.me/airight_io
aiRight is a complete system for AI x NFT x DeFi.
It is the world’s first all-in-one NFT creation and copyright management platform.
...
contract airightToken is BEP20Official {
    ...
    string public override name = unicode"aiRight Fan Token";
    string public override symbol = unicode"aiRight Token";
