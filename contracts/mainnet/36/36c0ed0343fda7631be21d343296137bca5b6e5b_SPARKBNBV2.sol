...
contract SPARKBNBV2 {
    ...
    uint256 constant public INVEST_MAX_AMOUNT = 1 ether;
    uint256 constant public HOUR_LIMIT = 2 ether; // only 2 BNB per Hour
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        require(msg.value <= INVEST_MIN_AMOUNT, "MAX amount is 1 BNB");
