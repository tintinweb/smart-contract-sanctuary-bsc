...
contract BabyArabianGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x70ecAaAeF052299A33a9B41D7479d256abCBF5F4); 

    address payable public Dev_Wallet = payable(0xa1709a1bCd8C61cb5d6F3aFE68EC1C92Ed0ab459);
    ...
    string private constant _name = "Baby Arabian Grow"; 

    string private constant _symbol = unicode"BAGrow"; 
    ...
    constructor () {
        ...
        _owner = 0xa1709a1bCd8C61cb5d6F3aFE68EC1C92Ed0ab459; //DEV
