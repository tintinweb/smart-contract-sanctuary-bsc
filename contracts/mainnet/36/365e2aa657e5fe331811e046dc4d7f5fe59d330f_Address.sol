...
/*
    ...
    I make this #RatChain to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ratchainbsc
...
Aautobuyback, everything allocated in dev wallet going back as buyback and burn

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #RatChain to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 50% total supply to the pool
   Can you make #Ratchain 100000X? 
...
contract RatChain is Context, IERC20, Ownable { 
    ...
    string private _name = "RatChain"; 
    string private _symbol = "RATCHAIN";  
