...
/**
Who doesn't know Lord of the Rings? With the recent tweet of Elon Musk, we brought it in the crypto world as a community driven project with verified contract and big liquidity.

📍SHARKS DEPLOYER📍 
Community cooperation is the key as proven in my previous project. Help us in getting back to that level or even better. 
...
Telegram: https://t.me/LordOfTheRingsInu
...
contract LOTRI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lord Of The Rings Inu"; // 
    string private constant _symbol = "LOTRI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x5E05F27B2D2Eb7d0c144C0Bc97031787c7ECE75D;
