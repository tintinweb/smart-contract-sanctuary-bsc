...
contract DOOM    is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOOM gnus";
    ...
    address private marketingWallet = address(0xc443c0E63be281841a00775Db12d6e1116303978);
    address private liquidityReceiver = address(0xc443c0E63be281841a00775Db12d6e1116303978);
