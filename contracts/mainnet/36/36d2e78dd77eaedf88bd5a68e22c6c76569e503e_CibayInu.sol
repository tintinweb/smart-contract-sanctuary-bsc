...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F600d5abD382D6614081e1a62C9e86cA21796B6;
...
contract CibayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Cibay Inu ";
    string private _symbol = " CIBAY ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAFf2E3D85e1EEd91778779932BC34A6FC57997Aa);
    address payable public teamWalletAddress = payable(0x6abbaEB2bCeCD935655F2B702e355e3742dbd306);
