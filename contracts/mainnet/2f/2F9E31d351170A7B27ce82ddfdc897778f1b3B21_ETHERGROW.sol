...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAC5a2DfdD352c8927F2314125f7922c53912d68b; // owner address
...
contract ETHERGROW is Context, IERC20, Ownable {
    ...
    string private _name = "Ether Grow";
    string private _symbol = "ETHER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAC5a2DfdD352c8927F2314125f7922c53912d68b);
    address payable public teamWalletAddress = payable(0xAC5a2DfdD352c8927F2314125f7922c53912d68b); 
