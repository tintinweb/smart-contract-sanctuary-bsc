...
contract Loh is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "lohi";
    string private constant tokenSymbol = "loh";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x12dAe1BD02B657fEA8f2a763e2AAed9b8Ab7e9d7);
        devAddress = payable(0x12dAe1BD02B657fEA8f2a763e2AAed9b8Ab7e9d7);
