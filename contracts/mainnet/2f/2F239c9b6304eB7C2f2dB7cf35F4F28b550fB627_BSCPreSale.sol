...
contract BSCPreSale is Ownable {
    ...
    // BSC Main Net
    IERC20 public PTOKEN = IERC20(0xAE7a4870a5156388EB584a1d3f1DCBb2E701bA13);
    IERC20 public RCTOKEN = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit(uint256 amount) public checkIfPaused {
        ...
        uint256 tokenAmount = amount.div(tokenPrice).div(10 ** (RCTOKEN_DECIMAL.sub(4)));
