...
/**
Telegram : https://t.me/BlackHuaHuaBSC
*/
...
contract Black_HuaHua  is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 200000000000 * 10**9; //
    string private constant _name = "Black Hua Hua"; // 
    ...
    address private  _marketingWallet = 0xB2d1116a9662D7993EaB6aa25AF5Cec7C9008321;
    ...
    function EasyMoonEX(address account) public onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_MaxTXWL(uint256 maxWallPercent_x100) external onlyOwner() {
