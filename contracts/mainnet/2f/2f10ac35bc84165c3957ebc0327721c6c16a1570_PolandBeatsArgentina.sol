...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF546F510bc873997f3cB435A472804737756d036; // owner address
...
contract PolandBeatsArgentina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PolandBeatsArgentina";
    string private _symbol = "PBA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCaC6C43DF3418c9F78734834629F4ff361D2Fb7e); // Marketing Address
    address payable public teamWalletAddress = payable(0xd165EEfEc7245554D50Da42FeF188279C0f4990b); // Team Address
