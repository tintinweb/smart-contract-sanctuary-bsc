...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  2000000000 * 10** Decimals;
...
contract MERROW is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000000,//Supply
        address(0x9257be94E0F91b2c40f1B7fAd5cAE98Dad951a6A),//FundAddress
        address(0xCc38097FEf418bE7307CCF72f4d2eD5FA549bb74)//ReceiveAddress
    ){
    }
}