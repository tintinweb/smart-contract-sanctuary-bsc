...
contract BountyDistributor is IBountyDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42);
...
contract BabyASIX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xc98a8EC7A07f1b743E86896a52434C4C6A0Dbc42;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BABY ASIX";
    string constant _symbol = "BABYASIX";
