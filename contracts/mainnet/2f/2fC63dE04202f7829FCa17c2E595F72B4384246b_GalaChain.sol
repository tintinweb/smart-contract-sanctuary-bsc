...
GALA CHAIN is Making blockchain games you'll actually want to play

Stealth launch Today 3PM-4PM UTC

Many Good Callers Have Joined,
(Gubbin+Caesar+SquidCall+CryptoFrog+BeastModeApeCalls+Crissy)

Now it's your turn, don't miss it 🔥

Website
https://gala-chain.com
Telegram
https://t.me/galachainofficial
Twitter 
https://twitter.com/Gala_Chain
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN 
    IBEP20 GALA = IBEP20(0x7dDEE176F665cD201F93eEDE625770E2fD911990); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GALA.balanceOf(address(this));
        ...
        uint256 amount = GALA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GALA.transfer(shareholder, amount);
...
/* Token contract */
contract  GalaChain is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address GALA = 0x7dDEE176F665cD201F93eEDE625770E2fD911990; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xd0D5d138Eb02AC60F2d8481Bb9A8116381bf4934;
    ...
    // Name and symbol
    string constant _name = "Gala Chain";
    string constant _symbol = "GALA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 1000; 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 1000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd0D5d138Eb02AC60F2d8481Bb9A8116381bf4934;
