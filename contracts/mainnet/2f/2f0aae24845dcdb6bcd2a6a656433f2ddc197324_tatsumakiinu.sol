...
https://t.me/tatsumakiinu
https://tatsumakiinu.com
...
contract tatsumakiinu is IBEP20, Ownable {
    ...
    string private constant _name = "Tatsumaki Inu";
    ...
    uint256 private _sellMaxTxAmount = 1000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 200000000, "Can not reduce below 10K");
        require(maxSell > 200000000, "Can not reduce below 10K");
