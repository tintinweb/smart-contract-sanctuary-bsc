...
contract GFDToken is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    uint256 public buyFeePercent = (3 * BASE_RATIO) / 100;
    uint256 public sellDeadFeePercent = (1 * BASE_RATIO) / 100;
    uint256 public sellLpPercent = (2 * BASE_RATIO) / 100;
    uint256 public transferDeadFeePercent = (2 * BASE_RATIO) / 100;
    ...
    constructor() ERC20("Greenford Token", "GFD") {
        _setupDecimals(18); 
        address _usdtToken = 0x55d398326f99059fF775485246999027B3197955;
        market = 0xAefdaC05655814E276E2755b2E83D17dDe24b134;
        lpReceiver = 0x3fA2dF64Dfe6bF19B627483DBa500f6307b0D77f;
