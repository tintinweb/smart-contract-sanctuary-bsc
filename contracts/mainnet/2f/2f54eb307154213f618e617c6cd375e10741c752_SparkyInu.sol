...
/**
    ...
    $SPARK is a #FaaS supercharged Inu reviving the true crypto spirit ⚡️🌕
    Low tax community driven coin 3/3
    Join us, sit back and enjoy the burns, utilities and memes 🔥

    TG: https://t.me/SparkyInu
...
contract SparkyInu is IBEP20, Auth {
    ...
    string constant _name = "Sparky Inu";
    string constant _symbol = "$SPARK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;     //2%
    ...
    address private marketingFeeReceiver = 0x4626329cB566c52669f850F28e68d06C0986171C;
    address private teamFeeReceiver = 0x4626329cB566c52669f850F28e68d06C0986171C;
