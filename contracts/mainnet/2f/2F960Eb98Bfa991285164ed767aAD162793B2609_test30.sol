...
contract test30 is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x240F3cf8bB03F6165e9Caa96f1841a9eCeB999CF); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x240F3cf8bB03F6165e9Caa96f1841a9eCeB999CF); // Marketing Wallet Address
    address payable public BurnWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Wallet Address
    address payable public devWalletAddress = payable(0x240F3cf8bB03F6165e9Caa96f1841a9eCeB999CF); // dev Wallet Address
    ...
    string private constant _name = "test30";
    string private constant _symbol = "test30";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _BurnFee + _reserveFee;
    ...
    uint256 _saleBurnFee = 5;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _saleBurnFee + _saleReserveFee;
    ...
    uint256 public BurnTokensCollected = 0;
    ...
    constructor () {
        address _owner = 0xe0dE9CC6fB7a2bCA255753E8e12e1bC80FcE9F04;
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + marketingTokensCollected + BurnTokensCollected + reserveTokensCollected;
        ...
        uint256 ethForBurn = (newBalance * BurnTokensCollected)/walletsTotal;
        ...
        transferToAddressETH(BurnWalletAddress, ethForBurn);
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _BurnFee; 
    }
    ...
    function countUpFeeShare(uint256 amount) private
    {
        ...
        BurnTokensCollected += (amount * _BurnFee)/100;
    }
    ...
    function setBurnWalletAddress(address _BurnWallet) external onlyOwner() {
        require(_BurnWallet != address(0), "setBurnWalletAddress: ZERO");
        BurnWalletAddress = payable(_BurnWallet);
        emit AuditLog("We have Updated the BurnWallet:", BurnWalletAddress);
    }
