...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xb97ccc4Bb771C804503163b8d0179233865BF5d4;
...
contract sero is AbsToken {
    constructor() AbsToken(
        ...
        address(0xb97ccc4Bb771C804503163b8d0179233865BF5d4),  //营销
        
        
        address(0xa5Ddda0C210B6b0030c072123c7129A72E6B8324 ) //代币接受钱包
    ){
