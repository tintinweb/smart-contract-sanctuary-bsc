...
// Don't let his $MANLETRAGE start World War 3!

// Official Fuck Putin Token (TICKER: $MANLETRAGE)
// 4% of each transaction is donated to the Ukranian military and charities helping those affected. 4% is redistributed to holders for $BUSD rewards.
// 3% liquidity, 1.5% marketing.
...
contract FuckPutin is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "FUCK PUTIN.";
    string constant _symbol = "MANLETRAGE";
    ...
    address public marketingFeeReceiver = 0xACc6F997322dC78150FD5ef6F5dc51f5a3Cf7449;
    address public buybackFeeReceiver = 0xcf7D3b78c2fF09c66E69A727a358cEad33d91182;
...
//		router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
    ...
    modifier onlyAdmin() {
        require(CheckAdmin(msg.sender), "You are not an admin."); _;
    }
    ...
    function setIsFeeExempt(address holder, bool exempt) public onlyAdmin() {
    ...
    function setDistributorSettings(uint256 gas) public onlyAdmin() {
        require(gas <= 1000000);
        distributorGas = gas;
    }

    function setFeesOnNormalTransfers(bool _enabled) public onlyAdmin() {
        feesOnNormalTransfers = _enabled;
    }

    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _burnFee, uint256 _feeDenominator) public onlyAdmin() {
    ...
    function setFeeReceivers(address _buybackFeeReciever, address _autoLiquidityReceiver, address _marketingFeeReceiver) public onlyAdmin() {
        buybackFeeReceiver = _buybackFeeReciever;
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
    }

    function setSwapBackSettings(bool _enabled, uint256 _amount) public onlyAdmin() {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }

    function setLiquifyEnabled(bool _enabled) public onlyAdmin() {
    ...
    function swapBackAdmin() public onlyAdmin(){
        swapBack();
    }
