...
contract TownTown is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Town Town", "TOWN") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 5 / 10, "Swap amount cannot be higher than 0.5% total supply.");
