...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf75C0f60f283357CE0f66a945A6c6c992BdFFeef; // owner address
...
contract Safekumamoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFEKUMAMOON";
    string private _symbol = "KMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf75C0f60f283357CE0f66a945A6c6c992BdFFeef); // Marketing Address
    address payable public teamWalletAddress = payable(0xf75C0f60f283357CE0f66a945A6c6c992BdFFeef); // Team Address
