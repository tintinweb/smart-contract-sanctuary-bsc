...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x618d36A95f788d4A24490aE70E57d2Fd55771937; // owner address
...
contract SquidBonkCommunity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidBonk";
    string private _symbol = "SB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCA8Dfec668b81ae54075CE35041a37c1D456fb78); // Marketing Address
    address payable public teamWalletAddress = payable(0xCA8Dfec668b81ae54075CE35041a37c1D456fb78); // Team Address
