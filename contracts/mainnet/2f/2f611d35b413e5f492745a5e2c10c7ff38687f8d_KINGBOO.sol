...
contract KINGBOO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x97ac3442b00b61a1FAD5b49FeB21FFF7Dbf2102E); 
    address payable public Wallet_Dev = payable(0x1A7c9Bc99CA0ceCA925846c3e262A5320b55a682);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "King Boo"; 
    string private constant _symbol = unicode"KINGBOO";
