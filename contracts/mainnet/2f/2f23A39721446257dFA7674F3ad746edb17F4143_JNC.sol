...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _intervalSecondsForSwap = 0 ; //杀多少秒机器人，3秒约等于一个区块
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        if(_startTimeForSwap == 0 && msg.sender == address(_swapRouter) ) {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(buyList[sender]>=(sellList[sender]+tAmount),"sell amout gt buy total");
                sellList[sender]=(sellList[sender]+tAmount);
            } else {
                swapFee = _buyFundFee + _buyLPDividendFee;
            }
            if(sender==_mainPair){
                 buyList[recipient]=buyList[recipient]+tAmount;
            }
    ...
    function setIntervalSecondsForSwap(uint256 value) external onlyOwner {
...
contract JNC is AbsToken {
    constructor() AbsToken(
        ...
        9,
        4999,
        address(0x9bC900bb9496Dd48cc1582a954210eee7EA260f1),
        address(0x9bC900bb9496Dd48cc1582a954210eee7EA260f1)
    ){
