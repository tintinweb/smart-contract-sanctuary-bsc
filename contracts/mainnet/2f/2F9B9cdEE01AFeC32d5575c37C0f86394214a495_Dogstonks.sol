...
contract Dogstonks is TradableErc20 {
    constructor()
        TradableErc20("Dogstonks", "DOGSTONKS")
    {}
...
abstract contract MaxWalletDynamic {
    ...
    function _setMaxWallet(uint256 maxWallet_) internal {
        maxWallet = maxWallet_;
    }

    function _setMaxTx(uint256 maxTx_) internal {
        maxTx = maxTx_;
    }
}
