...
contract NomadInu is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Nomad Inu"; // 
    string constant _symbol = "NOMAD"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (50) * (1); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (50) * (1); // 2%
    uint256 public _maxWalletToken = _totalSupply / (50) * (1); // 2%

    // Fees receivers
    address public autoLiquidityReceiver = 0xDda592e4160bEb8AE78Fa2AAb054138371C1dec2;
    address public marketingFeeReceiver = 0xfbe89c1615e54212A18fFf2EB234ED12044F08AC;
    address public devFeeReceiver = 0xDda592e4160bEb8AE78Fa2AAb054138371C1dec2;
    address public buybackFeeReceiver = 0xDda592e4160bEb8AE78Fa2AAb054138371C1dec2;
