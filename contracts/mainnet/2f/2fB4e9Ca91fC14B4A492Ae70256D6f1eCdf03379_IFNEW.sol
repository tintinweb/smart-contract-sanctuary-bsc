...
contract IFNEW is Context, IERC20, Ownable {
    ...
    uint256 public numTokensToSwap = 1000 * 10**_decimals; // 10k - Swap Marketing Balance 
    uint256 public numTokensToSwapLiquidity = 1000 * 10**_decimals; // 10k - Swap Liquidity Balance 
    uint256 public numTokensToSwapBuyBack = 1000 * 10**_decimals; // 10k - Swap BuyBack balance 
    ...
    constructor () {
        ...
        // wallet project
        marketingAddress = payable(0x23F645f859A9abe3cF894131D1d5e4A6fF791eF4); 
   ...
   function setTokenToSwapbuyBack(uint256 top) public onlyOwner { 
    ...
    function _takeBuyBack(uint256 rBuyBack, uint256 tBuyBack) private {
        contractBalance.buyback_balance+=tBuyBack;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (contractBalance.buyback_balance>= numTokensToSwapBuyBack && !inSwapAndLiquify && from != pancakeswapV2Pair && swapAndLiquifyEnabled) {
            // RUN BUYBACK
            BuybackBurnOne(numTokensToSwapBuyBack.div(2));
            BuybackBurnTwo(numTokensToSwapBuyBack.div(2));
        }
    ...
    function BuybackBurnOne(uint256 tokens) private {
        ...
        contractBalance.buyback_balance-=tokens;
