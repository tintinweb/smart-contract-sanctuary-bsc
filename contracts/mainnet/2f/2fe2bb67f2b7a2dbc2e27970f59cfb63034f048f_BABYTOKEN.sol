...
contract BABYTOKEN is ERC20, Ownable {
    ...
    constructor(
        ...
        address[6] memory addrs, // reward, router, marketing wallet, dividendTracker
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 balance_s =  newBalance.mul(3).div(5);
        uint256 balance_other =  newBalance.sub(balance_s);       
        IERC20(rewardToken).transfer(_marketingWalletAddress, balance_s);
        IERC20(rewardToken).transfer(_buybackWalletAddress, balance_other);
