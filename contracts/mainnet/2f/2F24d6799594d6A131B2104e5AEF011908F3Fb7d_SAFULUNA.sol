...
8% Buy/Sell:
1% Liquidity
2% Reflections in $LUNA
4% Marketing
1% BURN BABY

TG: https://t.me/SafuLuna
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
/* Token contract */
contract SAFULUNA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xEcf61Fe371a1116D0F2B23cdcA22905aBe125459;
    ...
    // Name and symbol
    string constant _name = "SAFULUNA";
    string constant _symbol = "$SAFULUNA";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // .5% or 5M tokens
