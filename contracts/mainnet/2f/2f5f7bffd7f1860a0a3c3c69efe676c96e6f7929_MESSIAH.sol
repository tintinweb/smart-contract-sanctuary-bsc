...
Telegram: https://t.me/Messiah_BSC


Buy:  10% fee
Sell: 15% fee

3% - Auto Liquidity Fee  
5%  - Marketing Fee 
5%  - Developement Fee
...
contract MESSIAH is Context, IERC20, Ownable {
    ...
    string private _name = "MESSIAH";
    string private _symbol = "1GOONRICH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x327ed708Bb1486A5b78b07D201e3caf6A1395062); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x327ed708Bb1486A5b78b07D201e3caf6A1395062); // Buyback Wallet Address
    ...
    uint256 public _walletMax = 400000 * 10**9; // 4%
