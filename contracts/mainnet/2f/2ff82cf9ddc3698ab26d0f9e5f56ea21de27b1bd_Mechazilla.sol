...
contract Mechazilla
 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE402E180A1Aa46F6C699DCD0893b6CA918b43Bf4);
    address payable public teamWalletAddress = payable(0xE402E180A1Aa46F6C699DCD0893b6CA918b43Bf4);
    address public immutable deadAddress = 0xE402E180A1Aa46F6C699DCD0893b6CA918b43Bf4;
    ...
    uint256 public _maxTxAmount =   110000000 * 10**_decimals; 
    uint256 public _walletMax =     110000000 * 10**_decimals;
