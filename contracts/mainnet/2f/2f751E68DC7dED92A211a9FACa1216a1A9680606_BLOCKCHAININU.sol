...
library Address{
 ...
 contract BLOCKCHAININU is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 2000000000000 * 10**9;
    uint256 public maxSellLimit = 2000000000000 * 10**9;
    uint256 public maxWalletLimit = 5000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x028197DA9d4572EbAEd8E57f8Ac093c1515c136d;
    address public TeamWallet = 0x028197DA9d4572EbAEd8E57f8Ac093c1515c136d; 

    string private constant _name = "BTCETHBNBSOLAVAXTRONCROFTM";
    string private constant _symbol = "BLOCKCHAIN INU";
    ...
    Taxes public sellTaxes = Taxes(0, 2, 3, 1);
