...
contract DogeKawaii is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeKawaii";
    string private _symbol = "DOGEKAWII";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xa92a069dFF875EDD74d8dF10512e9a3b6aee391d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xa92a069dFF875EDD74d8dF10512e9a3b6aee391d); // BuyBack Address
