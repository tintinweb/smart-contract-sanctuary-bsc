...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10F8978982ec129b7109Da246943EeF3392ae4E9; // owner address
...
contract WeiboCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WEIBO COIN";
    string private _symbol = unicode"$WEIBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12175BE5cFD85adaF430B46c97eeaE687E9b1E14); // Marketing Address
    address payable public teamWalletAddress = payable(0x10F8978982ec129b7109Da246943EeF3392ae4E9); // Team Address
