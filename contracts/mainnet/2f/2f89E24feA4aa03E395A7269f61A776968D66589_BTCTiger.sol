...
contract BTCTiger is Context, IERC20, Ownable {
    ...
    string private _name = "BTCTiger";
    string private _symbol = "BTCTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6192Fb0E1599F6A38F3fF772e313F4B1B3B3dB5A); // Marketing Address
    address payable public teamWalletAddress = payable(0x6192Fb0E1599F6A38F3fF772e313F4B1B3B3dB5A); // Team Address
    ...
    uint256 public _maxTxAmount = 50000000000 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 50000000000 * 10**6 * 10**6* 10**_decimals;
