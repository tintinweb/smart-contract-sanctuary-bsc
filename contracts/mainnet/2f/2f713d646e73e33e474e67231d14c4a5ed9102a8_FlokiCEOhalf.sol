...
✅ 3% max wallet, 3% max transaction, 5% tax for buys and sells, renounced contract, locked liquidity.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62D1801baF8E53883f4417ca5E853270FD4428eC; // owner address
...
contract FlokiCEOhalf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki CEO 0.5";
    string private _symbol = "FCEO05";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8C9c2f68b0e35839289d4d8B5Ce2f9c86E09d1Cf); // Marketing Address
    address payable private teamWalletAddress = payable(0x62D1801baF8E53883f4417ca5E853270FD4428eC); // Team Address
