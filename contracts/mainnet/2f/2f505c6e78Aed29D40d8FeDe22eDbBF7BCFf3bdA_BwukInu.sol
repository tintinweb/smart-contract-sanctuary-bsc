...
contract BwukInu is IBEP20, Auth {
    ...
    string constant private _name = "Bwuk INU";
    string constant private _symbol = "BWUK";
    ...
    address public _sellFeeReceiver = 0xA59FF1c30F4bc620419EE02a6Cf6fd1A78F610e1;
    address public devFeeReceiver = 0x83ce89E12a84E9ffC04Ba35e24243280ba200151;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __sellFee, uint256 _lpFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        lpFee = _lpFee;
        _sellFee = __sellFee;
        devFee = _devFee;
        totalFee = _lpFee.add(__sellFee).add(_devFee);
