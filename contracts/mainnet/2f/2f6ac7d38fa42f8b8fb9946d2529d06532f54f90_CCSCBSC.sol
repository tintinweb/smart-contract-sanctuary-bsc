...
Pi NetNetNetwork NEW TREND TOKEN
...
contract CCSCBSC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 314 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; 
    string private constant _name = "PioneerDAO"; 
    string private constant _symbol = "PioneerDAO"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 1;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x55B58da7E9900871D588fEd1b3D42A55d94Fc1BA;

    uint256 public _maxTxAmount = (_tTotal * 1) ; 
    uint256 public _walletMax = (_tTotal * 1) ;
