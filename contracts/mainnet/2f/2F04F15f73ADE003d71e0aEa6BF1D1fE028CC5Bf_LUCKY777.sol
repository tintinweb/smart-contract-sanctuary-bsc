...
contract LUCKY777 is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 0 * 10**9; //
    ...
    address payable private _developmentAddress = payable(0xad3088Fc1E0F1b7ae8306e7f8141aD8bEca728B5);
    address payable private _marketingAddress = payable(0xad3088Fc1E0F1b7ae8306e7f8141aD8bEca728B5);
