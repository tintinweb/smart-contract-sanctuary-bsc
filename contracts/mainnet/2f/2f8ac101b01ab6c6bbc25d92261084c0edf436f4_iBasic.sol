...
library Address{
 ...
 contract iBasic is Context, BEP20, Ownable {
    ...
    string private constant _name = "iBasic";
    string private constant _symbol = "iBSC";
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _funding) public onlyOwner {
        ...
        require(selltotaltaxes <= 30, "Must keep taxes at 30% or less"); 
