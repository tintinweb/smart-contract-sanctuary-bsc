...
contract FatCatKiller is IERC20 {
    ...
    uint256 constant private startingSupply = 36_000_000_000_000;
    string constant private _name = "Fat Cat Killer";
    string constant private _symbol = "kBUSD";
    ...
    IERC20 public immutable IERC20_PairedToken;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        staking: payable(0x8bE79A2ae35B4C92e46D7836F1964fe249AB3e03),
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            dexRouter = IRouter02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
            pairedToken = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;
...
//===============================================================================================================
    ...
    function lockStakingRatio() external onlyOwner {
        require(!_ratios.stakingLocked, "Already locked.");
        // This will lock buy taxes at their current value forever, do not call this unless you're sure.
        _ratios.stakingLocked = true;
    }
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 staking) external onlyOwner {
        ...
        if (_ratios.staking != staking) {
            require(!_ratios.stakingLocked, "Cannot change, value is locked.");
        }
        ...
        require(_ratios.totalSwap + _ratios.staking <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable staking, address payable liquidity) external onlyOwner {
        require(marketing != address(0) && staking != address(0) && liquidity != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 liquidityBalance = (IERC20_PairedToken.balanceOf(address(this)) * toLiquify) / swapAmt;
        ...
        IERC20_PairedToken.transfer(_taxWallets.marketing, IERC20_PairedToken.balanceOf(address(this)));
    }
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        Ratios memory ratios = _ratios;
        uint256 total = _ratios.totalSwap + _ratios.staking;
        uint256 currentFee;
        if (buy) {
        ...
        uint256 swapAmt = feeAmount - stakingAmt;
        if (swapAmt > 0) {
