...
contract PAKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Panda Killer"; // 
    string private constant _symbol = "PAKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x61fC5056C94d02f3C315177b90d2d4A9F6F2e0F8;
