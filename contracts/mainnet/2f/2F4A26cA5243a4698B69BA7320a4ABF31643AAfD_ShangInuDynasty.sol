...
contract ShangInuDynasty is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public marketingFeeReceiver = 0x4CbFB6f643943B6caC53F58D074413d2A429d6fB;
    address public autoLiquidityReceiver;

    string constant _name               = "ShangInuDynasty";
    string constant _symbol             = "DYNASTY";
    uint8 constant _decimals            = 9;

    uint256 _totalSupply                = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount         = _totalSupply.mul(5).div(10);
    uint256 public _maxWalletToken      = _totalSupply.mul(5).div(10);
