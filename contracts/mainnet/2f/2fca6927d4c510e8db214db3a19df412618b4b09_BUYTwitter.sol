...
contract BUYTwitter is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BUYTwitter";
    string private _symbol = "BUYTwitter";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x7771911120D159f40dC8c2560FA17d0f8315AFc7);
