...
contract EthTwit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHCOIN TWIT";
    string private _symbol = "EthTwit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8E28971749826c28cc24750f364de1506b074444); 
    address payable public BurnedWalletAddress = payable(0x8E28971749826c28cc24750f364de1506b074444); 
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x744ef3aab8fD9688C20a2E44E594535A4f560d68),
            block.timestamp
        );
    }
