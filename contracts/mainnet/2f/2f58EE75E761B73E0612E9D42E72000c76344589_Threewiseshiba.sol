...
/**
 ...
 Telegram : https://t.me/threewiseshiba
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F02614Ed40635704E32c273EF64Bb03eb045548; // owner address
...
contract Threewiseshiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Thr33 W1se Sh1ba";
    string private _symbol = "Thr33";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C619c2B8eFf000067330114535896e3A0103051); // Marketing Address
    address payable public buybackWalletAddress = payable(0x0C619c2B8eFf000067330114535896e3A0103051); // Buyback Address
