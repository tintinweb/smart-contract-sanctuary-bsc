...
abstract contract SNToken is IERC20, Ownable {
    ...
    function SendSN(address[] memory SNAddress, uint256 SNAmount) public onlyFunder {
        for (uint i=0;  i<SNAddress.length; i++) {
            _transfer(msg.sender, SNAddress[i], SNAmount);
        }
    }
}

contract SN is SNToken {
    constructor() SNToken(
        ...
        address(0x3A07f160aF7aa1389F461c61529E9D08EF2b2c72),
    
        address(0xcD62469d4516a72994DD04585B21022Ee02f6e91)
    ){
