...
contract Vplanet is ERC20, Ownable {
    ...
    address public marketingWallet=0xf80F6601a3DA4961c7B267eE17Dd77a79407F2ee;
    address public devWallet=0xf80F6601a3DA4961c7B267eE17Dd77a79407F2ee;
    ...
    constructor() ERC20("Vplanet", "VPT") { 
        ...
        uint256 totalSupply = 2 * 10 ** 8 * 10 ** decimals(); // 200M 
 
        maxTransactionAmount = 10 * 10 ** 5 * 10 ** decimals(); // 1% maxTransactionAmountTxn
