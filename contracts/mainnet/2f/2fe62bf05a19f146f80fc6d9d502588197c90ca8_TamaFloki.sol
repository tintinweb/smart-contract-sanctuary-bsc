...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaA267BEf18152e0E45344e779284630525754F2a; // owner address
...
contract TamaFloki is Context, IERC20, Ownable {
    ...
    string private _name = "TamaFloki";
    string private _symbol = "TaFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaA267BEf18152e0E45344e779284630525754F2a); // Marketing Address
    address payable public teamWalletAddress = payable(0xaA267BEf18152e0E45344e779284630525754F2a); // Team Address
