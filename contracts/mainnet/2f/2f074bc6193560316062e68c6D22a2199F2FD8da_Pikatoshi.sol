...
contract Pikatoshi is Context, IERC20, Ownable {
    ...
    string private _name = "Pikatoshi";
    ...
    uint256 public _boostedLiquidityFee = 300;

    uint256 public _marketingFee = 700; // All taxes are divided by 100 for more accuracy.
    ...
    address public burnAddress = 0x3D6fBCc3910709D2b0E5E0947b695D32668bBa10;
    address payable private _marketingWallet = payable(0x3D6fBCc3910709D2b0E5E0947b695D32668bBa10);
    address payable private _devWallet = payable(0x3D6fBCc3910709D2b0E5E0947b695D32668bBa10);
