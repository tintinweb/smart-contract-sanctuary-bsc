...
contract BWCI is Context, IERC20, Ownable {
    ...
    string private _name = " Baby World Cup inu BSC ";
    string private _symbol = " $BWCI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF12905541A0E69922a018C181607AD9A79de51E8); 
    address payable public teamWalletAddress = payable(0xF12905541A0E69922a018C181607AD9A79de51E8); 
