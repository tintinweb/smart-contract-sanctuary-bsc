...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0042f428Acb0A843eA809487F9Cd8a26b4383b40; // owner address
...
contract PumpkinInuBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PumpkinInuBsc";
    string private _symbol = "PIB";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x18976a41f402EF9AEa4AaC9c568f64ed508c5690); // Marketing Address
    address payable public teamWalletAddress = payable(0x18976a41f402EF9AEa4AaC9c568f64ed508c5690); // Team Address
