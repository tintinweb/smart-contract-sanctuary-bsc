...
/**
 ...
 .oooooo..o ooooo     ooo ooooooooo.   ooooooooo.   oooooooooooo ooo        ooooo oooooooooooo 
d8P'    `Y8 `888'     `8' `888   `Y88. `888   `Y88. `888'     `8 `88.       .888' `888'     `8 
Y88bo.       888       8   888   .d88'  888   .d88'  888          888b     d'888   888         
 `"Y8888o.   888       8   888ooo88P'   888ooo88P'   888oooo8     8 Y88. .P  888   888oooo8    
     `"Y88b  888       8   888          888`88b.     888    "     8  `888'   888   888    "    
oo     .d8P  `88.    .8'   888          888  `88b.   888       o  8    Y     888   888       o 
8""88888P'     `YbodP'    o888o        o888o  o888o o888ooooood8 o8o        o888o o888ooooood8                                                                                         
...
contract SUPREME is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Supreme Coin", "SUP", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x03861288cc5c2714e8c00Fc63ee6b0A0b306F3e9;
        TreasuryReceiver = 0xE28A3c2Feb553DC3C29f2982D15f92309041f5F9;
        RiskFreeValueReceiver = 0xecE4e55220aCA34617E6FEAD3d54d2b24b41f2a3;
    ...
    function setRewardYield(uint256 _rewardYield, bool _rewardDir) external onlyOwner {
        rewardYield = _rewardYield;
        rewardDir = _rewardDir;
    }
    function rebase() external onlyOwner {
        ...
        require(epoch>nextRebase,"not rebase time yet!");
        coreRebase(epoch, supplyDelta);
        nextRebase = nextRebase + rebaseFrequency;
    }

    function coreRebase(uint256 epoch, uint256 supplyDelta)
        private
        returns (uint256)
    {
        require(!inSwap, "Try again");
        ...
        returns (uint256)
    {
        ...
        if(recipient == pair) _totalFee = _totalFee.add(totalFee);
