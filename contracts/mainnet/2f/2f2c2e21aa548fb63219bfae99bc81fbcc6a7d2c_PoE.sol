...
contract PoE is IBEP20, Auth {
    ...
    string constant _name = "Power of Elon"; 
    string constant _symbol = "PoE"; 
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 44000000000 * 10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 880000000 * 10**_decimals; 
    ...
    uint256 public marketingFee    = 13; // Edit Marketing Fee
