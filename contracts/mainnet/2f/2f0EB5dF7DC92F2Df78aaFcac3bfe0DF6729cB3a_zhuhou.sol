...
contract zhuhou is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "zhuhou";
    string private _symbol = "ZHUHOU";
    ...
    function display(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
