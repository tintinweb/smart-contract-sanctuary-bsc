...
contract Doge is Context, IERC20, Ownable {
    ...
    string private _name = "Sanction Pelosi";
    string private _symbol = "condemn";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0a01fF953Bab12968d88F3867A740A40366077D2));
        marketingWalletAddress = payable(address(0x0a01fF953Bab12968d88F3867A740A40366077D2));
