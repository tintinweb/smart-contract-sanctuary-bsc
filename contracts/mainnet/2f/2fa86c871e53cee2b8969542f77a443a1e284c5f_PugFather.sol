...
https://twitter.com/GodFatherInuBSC
...
contract PugFather is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PugFather Inu";
    string private _symbol = "PUGFATHER";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x06f64E2414ab16F327D5E378069C8cd2bf1Fb547); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x06f64E2414ab16F327D5E378069C8cd2bf1Fb547); // BuyBack Address
