...
contract CATMERGE is Context, IERC20, Ownable {
    ...
    string private _symbol = "CATMERGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11059e9cA46C6d2318E223368A3405789cE925dF); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x11059e9cA46C6d2318E223368A3405789cE925dF); // BuyBack Address
    ...
    uint256 private _totalSupply = 100 * 10**2 * 10**9;
    uint256 public _maxTxAmount = 3 * 10**2 * 10**9;
    uint256 public _walletMax = 3 * 10**2 * 10**9;
