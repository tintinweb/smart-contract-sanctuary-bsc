...
/**
   #test The New Community test
    
   Time: 7.15 AM Wednesday, May 18, 2022, UTC.

   #test will list on #BSC at 7.15 AM Wednesday, May 18, 2022, UTC.

   I make this #test to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/test
   Great features: 0 Tax

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #test to the community and ensure it's 100% safe.

   I will add 9.999 BNB and 99% of the total supply to the pool
   Can you make #test 10000000X? 
