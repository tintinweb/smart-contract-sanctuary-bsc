        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x5cb2119989E62Dc7874d8811bD8df5874a05D73A), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        "BNBHARE",//Name Naughty Doge
        "BNBHARE",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address(0xb34CdC6B4d0854d0ece12EDba752C7f4C471d779),//FundAddress
        address(0xC831F80165D59e0B32CDad475c205453eBCd62a8),//buybackTokenAddress
        address(0x967ea19a6a4123E85eEda6028F0178E58e35D2df)//ReceiveAddress
    ){
    }
}