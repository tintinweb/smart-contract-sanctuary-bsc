...
contract TEACHINU is TEACHINUDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private TEACHINUTeam;
    address private CharityTEACHINU;
    ...
    string public override name = "Teacher Inu";
    string public override symbol = "TEACHINU";
    ...
    constructor(uint totalSupplyValue, address TEACHINUTeamAddress, address CharityTEACHINUAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        TEACHINUTeam = TEACHINUTeamAddress;
        CharityTEACHINU = CharityTEACHINUAddress;
       
        // split the tokens according to agreed upon percentages
        balances[TEACHINUTeam] =  totalSupply * 4 / 100;
        balances[CharityTEACHINU] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TEACHINUTeam pot
