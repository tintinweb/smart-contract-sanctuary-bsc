...
contract ElonYachtClub is IBEP20, Auth {
    ...
    string constant _symbol = "ElonYachtClub";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 16) / 200;  // max tx
    uint256 public _maxWalletSize = (_totalSupply * 18) / 100; // max wallet
    ...
    address private marketingFeeReceiver = 0xabe8d7a1FceDe17F0a28D67401b00641b237bD14;
    address private developmentFeeReceiver = 0xabe8d7a1FceDe17F0a28D67401b00641b237bD14;
