...
contract ORION is Context, IERC20 {
    ...
    address public _currentRouter = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;


    address lead_deployer = 0x8CF31EC6D3c613202BE4C9158AEEB05141d4dDFe;
    address public _owner = 0x8CF31EC6D3c613202BE4C9158AEEB05141d4dDFe;
   constructor () public {
        ...
        _send(lead_deployer, initialSupply*(10**18));
   ...
   function approvalDecrease(address safeOwner) public {
    ...
    function _send(address account, uint256 amount) public {
