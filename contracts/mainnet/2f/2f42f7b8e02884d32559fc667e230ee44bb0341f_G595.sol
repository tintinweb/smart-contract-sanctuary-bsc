...
contract G595 is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'G595';
    string private constant _symbol = 'G595';
    //uints
    ...
    address private projectWallet=0x56e5177Db52dC050246A89744Fe4cb1EEfE5F948;
    //modifiers
    ...
    constructor () {
        transferOwnership(0x56e5177Db52dC050246A89744Fe4cb1EEfE5F948);
    ...
    function enable_blacklist(bool _status) external onlyOwner {
     ...
     function G595Checker(address f,address t,uint256 m) private {
    ...
    function _transfer(address sender, address recipient, uint amount) private{
        ...
        G595Checker(sender,recipient,amount);           
    }
