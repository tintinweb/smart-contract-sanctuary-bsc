...
/**
こぼ・かなえる is an female Virtual YouTuber associated with hololive, debuting as part of the third generation VTubers. 
Come and join.
UWU!
...
/* Token contract */
contract KANAERU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa1f1eA3b2Ba892dC2cF9F4849B9Bc2B3962eafc9;
    ...
    // Name and symbol
    string constant _name = "KANAERU COIN";
    string constant _symbol = unicode" かなえる ";
