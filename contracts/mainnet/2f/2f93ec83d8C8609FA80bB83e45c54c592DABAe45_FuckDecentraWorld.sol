...
contract FuckDecentraWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fuck DecentraWorld";
    string private _symbol = "FDEWO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x60f22565A662898397fa40E70E3B9921f2d74f9D); // Marketing Address
    address payable public teamWalletAddress = payable(0x60f22565A662898397fa40E70E3B9921f2d74f9D); // Team Address
