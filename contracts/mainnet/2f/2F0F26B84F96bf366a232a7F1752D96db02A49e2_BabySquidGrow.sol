...
contract BabySquidGrow
 is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xde983Bc398Cc98b919B0A3fe91C981098ef4440E));
        _secondWallet = payable(address(0xde983Bc398Cc98b919B0A3fe91C981098ef4440E));
