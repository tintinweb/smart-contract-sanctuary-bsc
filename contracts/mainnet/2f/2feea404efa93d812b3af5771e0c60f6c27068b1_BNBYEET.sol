...
contract BNBYEET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB YEET"; 
    string private _symbol = "BYET"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4Ab617518910B79B85bdb4126d6bD2488A66462E); 
    address payable public teamWalletAddress = payable(0x4Ab617518910B79B85bdb4126d6bD2488A66462E); 
