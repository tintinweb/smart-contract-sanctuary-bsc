...
/*
    ...
    4% is sent to the marketing wallet and
    4% to the team wallet.
    
    2% of every transaction is redistributed between holders of the coin
    1% of every transacion is burned
    
    Telegram: https://t.me/azikachat
    Twitter: https://twitter.com/azikaio
    Website: https://azika.io
...
contract AZIKA is Context, IERC20, Ownable {
    ...
    uint256 public _donationFee = 8; //8% is split to 4% marketing + 4% team
    uint256 private _previousDonationFee = _donationFee;
    
    uint256 public _maxTxAmount = 10**12 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10**9 * 10**9; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingTransfer = 3*BNBTransfer;
        uint256 teamTransfer = 2*BNBTransfer;
        
        TransferBNBToWallet(marketingAddress, marketingTransfer);
        TransferBNBToWallet(teamAddress, teamTransfer);
    }
    ...
    function TransferBNBToWallet(address payable recipient, uint256 amount) private {
