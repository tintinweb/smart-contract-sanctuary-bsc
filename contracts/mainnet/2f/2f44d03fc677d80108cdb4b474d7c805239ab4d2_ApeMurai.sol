...
ApeSamurai Bullish name ready to shake BinanceSmartChainnn
...
contract ApeMurai is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x78284dda42e36f1c7FB010e98A6Eddf3ED4FF82F);
    ...
    constructor () {
        ...
        _owner = 0x78284dda42e36f1c7FB010e98A6Eddf3ED4FF82F;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x78284dda42e36f1c7FB010e98A6Eddf3ED4FF82F); // Testnet
