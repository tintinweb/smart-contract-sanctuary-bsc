...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a472 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a472;
...
contract ValentinoToken is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        // MAINNET PCS Router: 0xE8379fbFEf7dDf530E072e04DEf0d6F063374135
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xE8379fbFEf7dDf530E072e04DEf0d6F063374135);

        // TESTNET PCS Router: 0xE81D941f606DaDe764c8bf4D38aca0fD8d7D2c0f
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xE81D941f606DaDe764c8bf4D38aca0fD8d7D2c0f);
