...
contract WolfCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wolf Cat";
    string private _symbol = "WCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3292083F69c26F77DE537b458120f032057B005D); // 
    address payable public teamWalletAddress = payable(0x3292083F69c26F77DE537b458120f032057B005D); // 
    ...
    uint256 public _maxTxAmount = 10* 10**7* 10**_decimals; 
    uint256 public _walletMax = 50* 10**7* 10**_decimals;
