...
contract TroyBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "TroyBurn";  
    string private constant _symbol = "TROYBURN";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 5; 
    uint256 public _DevTax = 0; 
    address public  _marketing = 0xc7909164285cE979014C095A53ff90800c0898fA;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _DevTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _DevTax / (_marketingAndLiquidityFee + _DevTax);
