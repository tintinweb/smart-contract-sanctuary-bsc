 ...
 *
*/
// https://t.me/BoredapeYN
// Bored Ape Yatch Network
...
contract BAYN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bored Ape Yatch Network";
    string private _symbol = "BAYN";
