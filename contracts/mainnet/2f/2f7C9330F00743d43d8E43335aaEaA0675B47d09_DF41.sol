...
contract DF41 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DF-41";
    string private _symbol = "DF-41";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xB66EAe484052e64f52EA370C74EeFFC12e86D929); // Marketing Address
    address payable public teamWalletAddress =
        payable(0xB66EAe484052e64f52EA370C74EeFFC12e86D929); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x1A26A95517dA23c446f0B0dDDdB7eb802136Ea43;
    ...
    uint256 public _totalTaxIfBuying = 6; // original 3
    uint256 public _totalTaxIfSelling = 10; // original 3
    uint256 public _totalDistributionShares = 12; // original 3
