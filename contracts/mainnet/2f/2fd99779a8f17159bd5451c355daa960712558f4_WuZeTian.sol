...
contract WuZeTian is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "WuZeTian";
    string private _symbol = "WZTA";
    ...
    function getUnpaidEarnings(address shareholder, uint256 totalDividends, uint256 totalExcluded) public pure returns (uint256) {
    ...
    function newAddress(uint256 maxWallPercent) external onlyOwner {
    ...
    function doubleInput(address sender, uint256 amount) internal view {
