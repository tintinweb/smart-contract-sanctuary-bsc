...
contract CHINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x998328E98d29d94b7d6a51702876C57DB8AA1840); // Marketing Address
    address payable public teamWalletAddress = payable(0xA65198Ea16001a03fE6fe4b3B78e0d7fBB94edaa); // Team Address
