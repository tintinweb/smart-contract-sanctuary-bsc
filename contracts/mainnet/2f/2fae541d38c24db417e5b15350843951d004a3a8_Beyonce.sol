...
contract Beyonce is Context, IERC20, Roles{
    ...
    string private _symbol = "BEYONCE";
    ...
    function balanceofBurn() public view returns (uint256) {
        return _tBurnTotal;
    }

    function setDevoutLimit(uint8 devFee) external onlyOwner() {
       _tCharityTotal = devFee;
    }
  
    function sentdata(uint8 liquidityFee) external onlyOwner() {
