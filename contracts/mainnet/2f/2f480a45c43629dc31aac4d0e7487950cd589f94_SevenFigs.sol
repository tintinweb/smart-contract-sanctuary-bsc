...
/**
You're lucky if you found diz tingz niggas
Tomorrow i will make Calls for this
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD5CFfCB55D14381f50cf77B71D316228580a5A87; // owner address
...
contract SevenFigs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "7 Figs";
    string private _symbol = "7F";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD5CFfCB55D14381f50cf77B71D316228580a5A87); // Marketing Address
    address payable public teamWalletAddress = payable(0xD5CFfCB55D14381f50cf77B71D316228580a5A87); // Team Address
