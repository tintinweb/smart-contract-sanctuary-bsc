...
contract KittenMoney is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittenMoney";
    string private _symbol = "$KITTEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCBB6Bb2a58054F88935Ffb4871c1353b56095D40); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xCBB6Bb2a58054F88935Ffb4871c1353b56095D40); // BuyBack Address
