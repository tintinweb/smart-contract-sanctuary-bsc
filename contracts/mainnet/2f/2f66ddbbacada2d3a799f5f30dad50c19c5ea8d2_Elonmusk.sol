...
contract Elonmusk is IBEP20, Auth {
    ...
    string constant _name = "Elonmusk";
    ...
    address internal MarketingFeeReceiver = address(0x4d6F563CAcA45e4206872c7547e4b595cAB7E49c);
    ...
    constructor() Auth(address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50)) {
        router = IDEXRouter(_dexRouter);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WBNB = router.WETH();

        isFeeExempt[address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50)] = true;
        autoLiquidityReceiver = address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50)] = true;
        _isAllowed[0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50] = true;
        _isAllowed[address(this)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50)] = _totalSupply;
        emit Transfer(address(0), address(0x9E79bE5D1E1aCcB0d4579DaF7881Ba8F740b9E50), _totalSupply);
    }
