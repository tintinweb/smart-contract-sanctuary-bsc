...
TELEGRAM: https://t.me/medusaSnakeInu
|
*/
...
contract MedusaSnakeInu  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Medusa Snake Inu ";
    string private _symbol = " MSI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc58F4cC92074C64510932684aDc8ab8D0b297276); 
    address payable public teamWalletAddress = payable(0x360C38b058f0E8DB2c6392cbCd8f9966461F7F70); 
