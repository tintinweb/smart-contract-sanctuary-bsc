...
contract RussiaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Russia INU";
    string private _symbol = "$KRAINE";
    ...
    address payable private _marketingWallet = payable(0xa25cbDD73824C2B2C147f6030387C7aDE674E306);
