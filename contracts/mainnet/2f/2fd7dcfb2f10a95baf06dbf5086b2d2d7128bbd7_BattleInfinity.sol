...
contract BattleInfinity is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("BattleInfinity", "IBAT") payable
    {
        initialSupply =1000000 * (10**18);
        _setOwner(0x21710758d490C7B4762602b5ff2673F28ADaEcb5);
        ...
        taxWallets["liquidity"] = 0x21710758d490C7B4762602b5ff2673F28ADaEcb5;
        setBuyTax(1, 1, 1, 2);
        setSellTax(1, 1, 1, 3);
        setTaxWallets(0x21710758d490C7B4762602b5ff2673F28ADaEcb5, 0x21710758d490C7B4762602b5ff2673F28ADaEcb5, 0x21710758d490C7B4762602b5ff2673F28ADaEcb5);
        exclude(msg.sender);
        exclude(address(this));
        payable(0x21710758d490C7B4762602b5ff2673F28ADaEcb5).transfer(msg.value);
    ...
    function _transfer(
        ...
        require(!paused(), "BattleInfinity: token transfer while paused");
        require(!isBlacklisted(msg.sender), "BattleInfinity: sender blacklisted");
        require(!isBlacklisted(recipient), "BattleInfinity: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "BattleInfinity: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "BattleInfinity: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "BattleInfinity: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "BattleInfinity: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "BattleInfinity: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "BattleInfinity: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "BattleInfinity: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "BattleInfinity: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "BattleInfinity: Tax is already disabled");
        taxStatus = false;
    }
