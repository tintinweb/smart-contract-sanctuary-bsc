...
contract Ownable is Context, ShareWisdom {
    ...
    function EricKayShare(address newOwner) public onlyOwner {
...
contract EricKay is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "EricKay";
    string private _symbol = "EricKay";
    ...
    function updateTxOption(address holder, bool exempt)
        external
        onlyOwner
    {
	...
	function swapJEDIFees(address _token, uint256 tokens) private  {
	...
	function tokenJEDIContract() public view virtual returns (address) {
			return address(this);
		}
