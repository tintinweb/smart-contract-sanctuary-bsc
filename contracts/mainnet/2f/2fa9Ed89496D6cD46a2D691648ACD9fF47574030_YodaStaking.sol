...
contract YodaStaking {
    //constant
    uint256 public maxStake = 2_500_000_000;
    uint256 public minStake = 2_000;
    uint256 public constant percentDivider = 100_00;
    ...
    constructor(address _DISTRIBUTOR, address _TOKEN) {
        ...
        RewardAddress = payable(_DISTRIBUTOR);
        TOKEN = IERC20(_TOKEN);
        StakeI.StakePercent = 135;
        StakeI.StakePeriod = 30 days;

        StakeII.StakePercent = 1206;
        StakeII.StakePeriod = 180 days;

        StakeIII.StakePercent = 2988;
