...
contract LexTallionis is IBEP20, Auth {
    ...
    address DEV =  0x58f965f845BFcb277fDDF615e7267CDE38C1BaD0;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Lex Tallionis";
    string constant _symbol = "LXTLNS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 7000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x1dbCa083a42191AD79b2c5238cCF5320A8d53Fdc;
