...
contract Ekisupato is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ekisupato Inu";
    string private _symbol = "EKIS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x0612c18246959f3EE82a01f27fd2f376aD76D518);
