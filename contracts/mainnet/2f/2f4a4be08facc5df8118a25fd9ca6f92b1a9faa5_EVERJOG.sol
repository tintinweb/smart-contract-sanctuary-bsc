...
contract EVERJOG is ERC20, Ownable {
    ...
    EverjogDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x4a7D0d7DBa16116C27bA60B3400bc8F9C1F4DfD8;
    address public opsWallet = 0x1c66f278aE507389B11938c657b121d96A52C38c;
    address public devWallet = 0x41D722F60Dd0D4F1Aa108310740Ab74619DDA915;

    uint256 public swapTokensAtAmount = 2_500_000 * 10**9;
    uint256 public maxWalletBalance = 20_000_000 * 10**9;
    uint256 public maxBuyAmount = 20_000_000 * 10**9;
    uint256 public maxSellAmount = 10_000_000 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(3,3,2,1,1);
    Taxes public sellTaxes = Taxes(3,3,2,1,1);
    ...
    constructor() ERC20("Everjog", "EJ") {

    	dividendTracker = new EverjogDividendTracker();

    	IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        EverjogDividendTracker newDividendTracker = EverjogDividendTracker(payable(newAddress));
    ...
    function forceSend() external {
        ...
        payable(devWallet).sendValue(BNBbalance);
    }
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Everjog: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _ops, uint256 _liquidity, uint256 _dev) external onlyOwner{
        buyTaxes = Taxes(_rewards, _marketing, _ops, _liquidity, _dev);
        require((_rewards + _marketing + _ops +  _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
    }

    function setSellTaxes(uint256 _rewards, uint256 _marketing, uint256 _ops, uint256 _liquidity, uint256 _dev) external onlyOwner{
        sellTaxes = Taxes(_rewards, _marketing, _ops, _liquidity, _dev);
        require((_rewards + _marketing + _ops +  _liquidity + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function setMaxBuyLimits(uint256 maxBuy) external onlyOwner{
        ...
        require(maxBuy >= 1000000, "Cannot set max buy amount lower than 0.1%");
    }

    function setMaxSellLimits(uint256 maxSell) external onlyOwner{
        maxSellAmount = maxSell * 10**decimals();
        require(maxSell >= 1000000, "Cannot set max sell amount lower than 0.1%");
    }
    ...
    function setCooldownTime(uint256 timeInSeconds, uint256 balance) external onlyOwner{
        ...
        require(timeInSeconds <= 300, "cooldown timer cannot exceed 5 minutes");
    }
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "Everjog: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Everjog: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Everjog: Cannot update gasForProcessing to same value");
   ...
   ////////////////////////
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 swapTax = sellTaxes.rewards + sellTaxes.marketing + sellTaxes.ops + sellTaxes.liquidity + sellTaxes.dev;
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[to]){
                ...
                swapAmt = amount * (buyTaxes.rewards + buyTaxes.marketing + buyTaxes.ops + buyTaxes.liquidity + buyTaxes.dev) / 100;
            }
...
contract EverjogDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("Everjog_Dividen_Tracker", "Everjog_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 11 * (10**decimals()); 
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "Everjog_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Everjog_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Everjog_Dividend_Tracker: Cannot update claimWait to same value");
