...
That dastardy Do Kwon has infected the market with fear, uncertainty and weak hands and it's up to us to bring a stop to it. 
Lunapox is here! Expose yourself to 3% WLUNA reflections and immunize against the FUD. Let's get Gigapoxxed!!

 TICKER: LPOX

 3% Wrapped Luna Rewards
 2% Liquidity 
 1% Marketing

 t.me/lunapox_bsc

 May CZ Save our Sats, Degen.   
*/
...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962); //the reward token you want distributed 
...
contract LunaPox is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0x156ab3346823B651294766e23e6Cf87254d68962; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x82f90B83DE193FFC2683cC47041a30934CFFacAE;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "LUNAPOX";
 string constant _symbol = "LPOX";
