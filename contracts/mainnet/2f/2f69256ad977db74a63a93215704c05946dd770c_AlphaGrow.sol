...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa2Aaa8F2b1f7e7098A4a098999Ee90301f296bB8; // owner address
...
contract AlphaGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alpha Grow";
    string private _symbol = "AlphaG"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7dfdb6816ae8BBbcc42f22528413452D8e5B6e22); // Marketing Address
    address payable public teamWalletAddress = payable(0x7dfdb6816ae8BBbcc42f22528413452D8e5B6e22); // Team Address
