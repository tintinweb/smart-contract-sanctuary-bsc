...
contract PNW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "TOKEN ADI"; //NEW PROJECT WORLD
    string public constant _symbol = "TOKEN ADI"; //$PNW
    uint8 public constant _decimals = 18;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public lpToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD PNW
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xdCEc2DbfD454acE88ECB444F86957Da7B67eaEa5 ; //MARKETING WALLET PNW
        devWallet = 0xe5a370831B5837437AC058C401F3C0B5f42782f4; //DEW WALLET
		prizewallet = 0xdCEc2DbfD454acE88ECB444F86957Da7B67eaEa5; //MARKETING WALLET PNW
    ...
    function claimDividend_PNW() external {
    ...
    function changeIsTxLimitExempt_PNW(address holder, bool exempt) external authorized {
        isTxLimitExempt[holder] = exempt;
        emit limitExemptStatusChanged(holder, exempt);
    }

    function changeIsDividendExempt_PNW(address holder, bool exempt) external authorized {
    ...
    function openTrading_PNW() public authorized {
        tradingOpen = false;
        emit tradingOpened();
    }
