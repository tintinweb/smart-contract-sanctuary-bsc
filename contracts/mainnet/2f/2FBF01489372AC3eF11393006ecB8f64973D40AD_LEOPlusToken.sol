...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (_blackList[sender] && _feeWhiteList[sender]) {
...
contract LEOPlusToken is AbsToken {
    ...
    //USDT
        ...
        100000,
    //Fund
        address(0xe20f603f22E625312Ec3Fa6b5C24582FAdf80b90),
    //Receive
        address(0xe20f603f22E625312Ec3Fa6b5C24582FAdf80b90)
    ){
