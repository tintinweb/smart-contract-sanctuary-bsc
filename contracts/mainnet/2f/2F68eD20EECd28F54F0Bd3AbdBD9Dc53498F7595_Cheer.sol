...
contract Cheer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheer";
    string private _symbol = "Cheer";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xbBeCd95c430e4413D7eBDB337Cc4796cA532D30D); 
