...
contract RedClifford is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Red Clifford";
    string constant _symbol = "RedClifford";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x941F788003F4F16b92b3dc899073015117382288;

        marketingWallet = 0x941F788003F4F16b92b3dc899073015117382288;

        devWallet = 0x941F788003F4F16b92b3dc899073015117382288;
