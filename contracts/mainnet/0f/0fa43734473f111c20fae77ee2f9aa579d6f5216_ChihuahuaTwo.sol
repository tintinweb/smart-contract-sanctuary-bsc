...
contract ChihuahuaTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chihuahua 2.0";
    string private _symbol = "CHHTWO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x4986eaac30cfA9A2A594BeB7d145EE1593bAef7D);
