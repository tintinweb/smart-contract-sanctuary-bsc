...
contract SGD
 is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceGreat Dane";
    string private _symbol = "SpaceGreat Dane";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x638bA577Ef1778112C3C1dcE5a793e4F2407154d));
        _secondWallet = payable(address(0x638bA577Ef1778112C3C1dcE5a793e4F2407154d));
