...
contract binancegrow2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Binance Grow2"; // 
    string private constant _symbol = "$BNBgrow2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x8214574CEf87b9941e1f2C86B172615aDaE5c141;
