...
contract pigeon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf5b468cB2A8Df749e213AA1C3896af4D7B2445f0); // Marketing Address
    address payable public teamWalletAddress = payable(0xf5b468cB2A8Df749e213AA1C3896af4D7B2445f0); // Team Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bcAddr[sender] && !bcAddr[recipient], "ERC20: transfer to the zero address");
