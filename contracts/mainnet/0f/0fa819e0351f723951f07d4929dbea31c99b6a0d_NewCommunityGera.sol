...
contract NewCommunityGera is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Gera";
    string private _symbol = "CGera";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCcc1140e34Ad8bc4C886D49A714fC257a9D0C3CC); 
    ...
    uint256 private _totalSupply = 2 *  10**12 * 10**_decimals;
