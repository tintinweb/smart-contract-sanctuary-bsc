...
Stealth launch Micro Squid GROW
Micro Cap
Tax Buy 10%
Tax Sell 12%
Potential 100x Gem
...
contract Microsquidgrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICRO SQUID GROW";
    string private _symbol = "$MSG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1fbBe94c40EF4e2Db3Ba51f6b4E71FF92317C000);
    address payable public teamWalletAddress = payable(0xFCaD65b53779b8D784c5b1a485e0a71A4e29e7A4);
    ...
    uint256 public _totalDistributionShares = 22;  // original 10
