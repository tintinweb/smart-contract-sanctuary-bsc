...
library Address{
 ...
 contract MoneyPrinter is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x41F2555581bF5b0D4dDda88A4C60d06D961844eF;
    address public donationWallet = 0x41F2555581bF5b0D4dDda88A4C60d06D961844eF;

    string private constant _name = "Money Printer";
    string private constant _symbol = "MoneyPrinter";
    ...
    Taxes public taxes = Taxes(2, 3, 3, 0);
    Taxes public sellTaxes = Taxes(2, 3, 3, 0);
