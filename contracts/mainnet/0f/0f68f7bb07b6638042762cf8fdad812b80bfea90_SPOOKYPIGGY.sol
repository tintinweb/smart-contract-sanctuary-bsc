...
contract SPOOKYPIGGY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SPOOKYPIGGY";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
...
uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x33014d9Ed8F256E83a1667e29903619F2f01fEd0;
        marketingFeeReceiver = 0x33014d9Ed8F256E83a1667e29903619F2f01fEd0;
