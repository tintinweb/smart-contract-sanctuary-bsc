...
// File: contracts/METAHEAVENNFT.sol
...
contract MetaHeavenNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 777;
    uint256 public normalPrice = 0.5 ether;
    ...
    constructor(string memory _baseURI) ERC721("MetaHeavenNFT", "MHeaven NFT") {
        baseUrl = _baseURI;
    }
