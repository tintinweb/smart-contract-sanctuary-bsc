...
contract ElonInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ELN";
    uint8 private constant _decimals = 18;
    address payable private _developmentAddress = payable(0x856c034F27F84dF70C6B3d106f1E83f66aF097d2);
    address payable private _marketingAddress = payable(0x856c034F27F84dF70C6B3d106f1E83f66aF097d2);
