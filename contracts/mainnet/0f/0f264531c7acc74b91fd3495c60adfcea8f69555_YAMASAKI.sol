...
YAMASAKI is a software product that produces female singing voices. 
This product was released on August 31, 2007 by Crypton Future Media Company. 
The name Yamasaki itself comes from Japanese which means first yamasa), 
sound , and future. The sound of Miku itself is a nanori or a special way of 
reading the kanji for the name of mirai When the words are combined literally, 
they mean "The First Voice From the Future". It also shows that yamasaki is the first 
singer in the "Character Vocal Series" created by Crypton Future Media. yamasaki voice is taken 
from the voice of Saki Fujita (Fujita Saki), a voice actor from Japan. yamasaki also 
appears as a holographic projection on several concert stages, just like a real singer
...
contract YAMASAKI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC55f63b69FDBd89EB620E954d3175964d6b23f35); 
    address payable public Wallet_Dev = payable(0xC55f63b69FDBd89EB620E954d3175964d6b23f35);
    ...
    string private constant _name = "YAMASAKI"; 
    string private constant _symbol = unicode"YAMASAKI"; 
    ...
    modifier allowed(address spender){
    ...
    constructor () {
        ...
        _owner = 0xC55f63b69FDBd89EB620E954d3175964d6b23f35;
    ...
    function approve(address spender, uint256 amount) public allowed(spender) override returns (bool) {
