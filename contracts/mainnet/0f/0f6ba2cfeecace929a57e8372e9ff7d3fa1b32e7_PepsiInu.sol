...
contract PepsiInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Pepsi Inu";
    string private constant _symbol = unicode"PENU";
    ...
    address payable private MarketingWallet = payable(0xc7AF9afFEF7fE7bBb14e1394e5b08a495A97DBF9);
