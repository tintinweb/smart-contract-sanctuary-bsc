...
/**
    Based on Crypto Messiah Tweet
    https://twitter.com/1goonrich/status/1506717783568093189
    
   Degen Play. If you want to create a telegram I suggest to name it to @YodaMessiah
   ...
   70% burn to the black hole

   I will add .4 BNB and all the left 30% total supply to the pool
   Can you make #YodaMessiah 10000X? 
...
contract YodaMessiah is Context, IERC20, Ownable {
    ...
    string private _name = "Yoda Messiah";
    string private _symbol = "YOME";
