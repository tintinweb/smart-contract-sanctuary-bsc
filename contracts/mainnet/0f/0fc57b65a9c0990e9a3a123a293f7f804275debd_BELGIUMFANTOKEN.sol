...
// 
//
// 📱 Telegram:https::https://t.me/+edtvt-PZA8w2YWZl
/*
...
contract BELGIUMFANTOKEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BELGIUMFAN TOKEN", "BELGIUMFANTOKEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BELGIUMFANTOKEN";
    string private _symbol = "BELGIUMFANTOKEN";
