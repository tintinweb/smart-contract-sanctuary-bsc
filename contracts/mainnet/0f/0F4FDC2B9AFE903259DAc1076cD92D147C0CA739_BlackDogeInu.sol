...
/*
B̶L̶A̶C̶K̶ D̶O̶G̶E̶ I̶N̶U̶
-----------------------
Official PORTAL: @BLACKDOGEINU
*/
...
contract BlackDogeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BLACK DOGE INU";
    ...
    constructor () {
        ...
        uniswapPair = IUniswapV2Factory(_uniV2Router.factory())
