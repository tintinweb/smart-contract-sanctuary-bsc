...
contract Pro is IERC20, Ownable {
    ...
    address public USD = address(0x55d398326f99059fF775485246999027B3197955); // USD 代币存放地址
    address public _blackHoleAddress = address(0x000000000000000000000000000000000000dEaD); // 黑洞销毁地址

    address private _mintAddress = address(0x6AbC9dc6dbbc544bBcD6377D2c4320ff1FF60681); // 收币账户
    address public _staticAddress = address(0x03A10e26C294B6578bE72fdd4A58aD4Ed89391f1); // 静态
    address public _dynamicAddress = address(0x1F48E56739B87279302917dB2Db8f39538b65dE8); // 动态
    address public _poolAddress = address(0x949045065494D046B548b6AF08995fb92547C326); // pancake
    address public _partnerAddress = address(0x874Cc89006F1e6D88e83f5F4B907174d5769EeE9); // 股东
    address public _operateAddress = address(0x843438Ab33BD3c0EBbe4E0dAa70273AF35a811c2); // 运营
    address public _adminAddress = address(0x0d12F1f8467a1aB1761841f998cc0294bC3f4e69); // 技术

    uint256 public _buyBurnFee; // 买入燃烧费率 千分比
    uint256 public _buyOperateFee; // 买入运营费率 千分比

    uint256 public _sellBurnFee; // 卖出燃烧费率 千分比
    uint256 public _sellOperateFee; // 卖出燃烧费率 千分比

    mapping(uint256 => uint256) public _random; // 支付金额
    ...
    function changeFee(uint256 buyBurnFee, uint256 buyOperateFee, uint256 sellBurnFee, uint256 sellOperateFee) public onlyOwner {
        _buyBurnFee = buyBurnFee; // 买入燃烧费率 千分比
        _buyOperateFee = buyOperateFee; // 买入运营费率 千分比
        _sellBurnFee = sellBurnFee; // 卖出燃烧费率 千分比
        _sellOperateFee = sellOperateFee; // 卖出燃烧费率 千分比
    }
