...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x672440EEd2B2CB4c186A5B2a564b681Ef394d232; // owner address
...
contract retroeth is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Retro Ethereum";
    string private _symbol = "RETROETH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x672440EEd2B2CB4c186A5B2a564b681Ef394d232); // Marketing Address
    address payable public teamWalletAddress = payable(0x672440EEd2B2CB4c186A5B2a564b681Ef394d232); // Team Address
