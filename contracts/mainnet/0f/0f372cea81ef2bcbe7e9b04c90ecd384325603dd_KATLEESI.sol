...
contract KATLEESI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFa300a97408d757D85453e3fAeb3719DBCCA1f71); // Marketing Address
    ...
    string private _name = "Katleesi";
    string private _symbol = "KatL";
