...
Telegram : NewCommunityDogeChainRevenge
Website : TBA
...
contract NewCommunityDogeChainRevenge is Context, IERC20, Ownable {
    ...
    string private constant _name = "NcDogeChainRevenge";
    string private constant _symbol = "NcDogeChainRevenge";
    ...
    address private marketingWallet = address(0x8C96C331aa546BEF3BA2b38031982a1BA565aE41);
