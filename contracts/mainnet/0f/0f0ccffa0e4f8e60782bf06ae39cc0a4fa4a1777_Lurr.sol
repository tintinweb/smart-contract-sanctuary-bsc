...
contract Lurr is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lurr", "LLLLL") {

        address _owner = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;
    	...
    	maintenanceWallet = address(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298); // set as maintenance wallet
