...
contract Token {
    ...
    constructor() {
        name = "Over 9000"; // Sets the name of the token, i.e Ether
        symbol = "ONT"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places

        uint256 _initialSupply = 9001; // Holds an initial supply of coins
