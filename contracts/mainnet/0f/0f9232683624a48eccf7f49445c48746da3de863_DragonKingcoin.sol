...
contract DragonKingcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Dragon King coin"; 
    string private _symbol = "DKC"; 
    ...
    uint256 public fomoMin = 1 * 10**4 * 10**18; 
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    uint256[3] public feeFomo = [30, 20, 10];
    uint256[3] public feeLiquidity = [20, 10, 5];
    uint256[3] public feeFee = [10, 3, 0];
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256 tTransferAmount, uint256 tFomo, uint256 tLiquidity, uint256 tFee) {
        ...
        tFomo = tAmount.mul(feeFomo[healthLevel]).div(1000);
        tLiquidity = tAmount.mul(feeLiquidity[healthLevel]).div(1000);
        tFee = tAmount.mul(feeFee[healthLevel]).div(1000);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if (takeFee) {
            ...
            if (launchedAtTime + 0 minutes > time) {
