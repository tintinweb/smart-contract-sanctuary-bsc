...
FairLaunch Date : 10th August 2022 - 15:00 UTC
...
JOIN WITH US :
🍁Website :www.canacapt.com
🍁Telegram: https://t.me/Canacapt
🍁Twitter: https://twitter.com/CanaCaptBsc
*/
...
contract CanaCapt  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "CannaCapt";
    ...
    address public devFeeReceiver = 0x9F5A20A31bE403E7F68408214A9E093f93759BEF;
    address public buybackFeeReceiver = 0x9F5A20A31bE403E7F68408214A9E093f93759BEF;
    ...
    uint256 public swapThreshold = _totalSupply / 10 * 3; 
    bool inSwap;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function aprover(address _address, bool _value) public authorized{
