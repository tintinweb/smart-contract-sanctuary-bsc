...
contract Pootest is Ownable, IBEP20 {
    ...
    uint _marketingTax = 7000;

    uint _reflectionTax = 1500;

    uint _liquidityTax = 1500;
    ...
    uint public maxWallet=InitialSupply * 1 / 100;
    uint public maxTX=InitialSupply * 1 / 100;
    ...
    function SetTXRestrictions(uint maxWallet_, uint maxTX_) external onlyOwner{
        ...
        require(maxTX_>=InitialSupply/200);
