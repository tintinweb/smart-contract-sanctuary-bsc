...
contract Shinanomics is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x02a8a8655Dc5eCb2E62EeB659e13ef29C4a1cDB6;

    string constant _name = "Shinanomics";
    string constant _symbol = "Shinanomics";
