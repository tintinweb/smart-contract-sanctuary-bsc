...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "Squid party";
    string private _symbol = "Squid party";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 10;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xB4c2834b4043ccdC56bdbB34ec181b2Aff913EE3); // Marketing Address
    address payable private teamWalletAddress = payable(0x167D4A85BBAE234d6062d6870b9b70B21cccb307); // Team Address
