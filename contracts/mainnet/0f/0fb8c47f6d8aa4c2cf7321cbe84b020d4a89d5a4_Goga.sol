...
contract Goga is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000 * 10**6 * 10**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Goga";
    string private _symbol = "GOGA";
    ...
    // Owner cannot transfer out Goga from this smart contract
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Goga!");
