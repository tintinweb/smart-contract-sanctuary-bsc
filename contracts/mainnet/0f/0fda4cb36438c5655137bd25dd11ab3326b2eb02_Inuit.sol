...
// Launched by @BlueprintCalls we will make it big if you just hold long term. No max buy nor max tx to allow big buys to come in once we set our first Biggest buy contest (5 BNB to win). I can make this big, it only depends on community/holders.
...
contract Inuit is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"INUIT"; 
