...
contract BitcoinWebz is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000000 * 10**1 * 10**18;
    ...
    uint256 public _maxTxAmount = 2000000 * 10**1 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 2000000 * 10**1 * 10**18;
