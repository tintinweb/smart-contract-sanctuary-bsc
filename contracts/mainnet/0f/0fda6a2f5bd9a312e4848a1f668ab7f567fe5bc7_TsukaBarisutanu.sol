...
Have you ever seen a dog make coffee? definitely not, this is first time the dog has become a barista to serve coffee to you all.

https://t.me/TsukaBarisutanu
...
contract TsukaBarisutanu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka Barisutanu";
    string private constant _symbol = "Tsuka Barisutanu";
    ...
    address private marketingWallet = address(0x487b3147ef6c7C482022a90DA89F7d47d868D308);
