...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Avatar New Year"; //
    string private constant _symbol = "Avatar NY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4FB0083226D53133928c4b51193a4d33AD11aCBF;
