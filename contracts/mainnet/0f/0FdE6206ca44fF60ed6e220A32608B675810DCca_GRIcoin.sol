...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x2DADc05c88CAf3763F084111213462f581E5914e;
    }
}
...
contract GRIcoin is Context, IBEP20, Ownable {
    ...
    address public _investingWallet;
    ...
    string private _name     = "GRI Coin";
    string private _symbol   = "GRI";
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        _investingWallet = 0x961e2B79Cf8e83aaBCEFc46d80b26D4C9E85C1f4;
        ...
        _isExcludedFromFee[_investingWallet]     = true;
    ...
    function setInvestingWallet(address investingWallet) external onlyOwner {
        _investingWallet = investingWallet;
    }
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee <= 0, "Liquidity Fee cannot exceed 5%");
        _liquidityFee = liquidityFee;
    }

    function setPercentageOfLiquidityForMarketing(uint256 marketingFee) external onlyOwner {
            require(marketingFee <= 13, "Investing and Marketing fee cannot exceed 13%");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        uint256 feeOne = marketingFee / 2;
        uint256 feeTow = marketingFee - feeOne;
        uint256 bnbForLiquidity = newBalance.sub(marketingFee);
        if (marketingFee > 0) {
            payable(_marketingWallet).transfer(feeOne);
            payable(_investingWallet).transfer(feeTow);
