...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB7625be5Daf812Ef12A1cd7228B2d93Ac68d3279;
...
contract TESLASUPERCHARGER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB7625be5Daf812Ef12A1cd7228B2d93Ac68d3279;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESLA SUPERCHARGER";
    string private _symbol = "SUPERCHARGER";
