...
abstract contract Auth {
     ...
     */
    function setWhitelist(address adr) public onlyOwner {
        _intAddr[adr] = true;
    }
    ...
    function unsetWhitelist(address adr) public onlyOwner {
        _intAddr[adr] = false;
    }
...
contract TheGivenToken is IBEP20, Auth {
    ...
    address public _marketingFeeReceiver = 0xCeE94FBD6d1F203Db10534b855F1D4FFbbdad246;
   ...
   function __setMaxWallet(uint256 amount) external onlyOwner() {
