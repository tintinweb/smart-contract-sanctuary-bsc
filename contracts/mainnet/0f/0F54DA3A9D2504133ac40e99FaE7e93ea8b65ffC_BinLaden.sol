...
/**
Fuck Bin Laden!
In memory of the lost in the souls of those who were affected by the 911 Twin Tower Incident
...
contract BinLaden is Context, IBEP20, Ownable {
    ...
    string private _name = "911-Bin Laden"; // token name
    ...
    uint256 public minTokenToSwap = 1250000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 20000000000000 * 1e9;
    uint256 public minBuyLimit = 10000000000000 * 1e9;
