...
T E L E G R A M 
——————————
https://t.me/BlueShibaInuOfficial
*/
...
contract BlueShiba is IERC20 {
    ...
    uint256 constant private startingSupply = 10000000000000;
    string constant private _name = "BLUE SHIBA";
    string constant private _symbol = "BSHIB";
    ...
    address payable public marketingWallet = payable(0x05EeB9Ce3fc90Df74F7dAbAb312Dc81044a9a881);
