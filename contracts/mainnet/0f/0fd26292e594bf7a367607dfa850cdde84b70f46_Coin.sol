...
contract Coin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x3D8b3D07293439Aa490033bC8a7E2080ee4b7f3b);
    ...
    uint256 private _totalSupply = 223 * 10**1 * 10**_decimals;
    uint256 public _maxTxAmount =   223 * 10**1 * 10**_decimals;
    uint256 public _walletMax =     5 * 10**1 * 10**_decimals;
