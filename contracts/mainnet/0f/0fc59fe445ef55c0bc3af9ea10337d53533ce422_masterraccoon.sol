...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcd03B2610626279B116765F12279d44E3ACa6938; // owner address
...
contract masterraccoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Master Raccoon";
    string private constant _symbol = unicode"MRACCOON🦝";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xcd03B2610626279B116765F12279d44E3ACa6938); // Marketing Address
    address payable public teamWalletAddress = payable(0xb64947AA7D0cbb29722194bD8F0915c282951A26); // Team Address
    ...
    uint256 public _walletMax = 1000;
