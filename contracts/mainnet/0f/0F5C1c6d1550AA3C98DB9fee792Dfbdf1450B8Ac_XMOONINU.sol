...
contract XMOONINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XMOONINU";
    string private _symbol = "XMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBE383008aFc8Ffd550F72196602D335572A52D6a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBE383008aFc8Ffd550F72196602D335572A52D6a); // BuyBack Address
