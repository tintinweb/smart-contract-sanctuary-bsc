...
contract PortalProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Portal Protocol";
    string private _symbol = "Portal";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56AeB9fb494da0E3D4155a9C3E1a6DCb23bbc919); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x56AeB9fb494da0E3D4155a9C3E1a6DCb23bbc919); // Development Address
