...
contract MechaShibZilla_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "MechaShibZilla";
    string private constant _symbol = "MSZ";
