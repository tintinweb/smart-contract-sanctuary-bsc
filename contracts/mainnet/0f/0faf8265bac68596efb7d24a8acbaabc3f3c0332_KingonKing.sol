...
contract KingonKing is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string private _name = 'KingonKing';
    string private _symbol = 'KING';
    uint8 private _decimals = 9;
    uint256 public _maxTxAmount = 80000 * 10**3 * 10**9;
