...
contract YBCoin is ERC20Burnable {
    ...
    function set_isSwapIncludes(address _address) public virtual {
        require(_admin[_msgSender()] == true, "only admin can set");
    ...
    function set_special_list(address _address , bool f) public virtual {
        require(_admin[_msgSender()] == true, "only admin can set");
    ...
    function set_no_slippage_swap_t(bool f) public virtual {
        require(_admin[_msgSender()] == true, "only admin can set");
        _no_slippage_swap_t = f;
    }
    
    function set_admin(address _address ,bool f) public virtual {
        require(_admin[_msgSender()] == true, "only admin can set");
        _admin[_address] = f;
    }
