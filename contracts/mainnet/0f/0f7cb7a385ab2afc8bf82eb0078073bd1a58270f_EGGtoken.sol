...
contract OwnableBSC is ContextBSC {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBSC: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBSC: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract EGGtoken is ContextBSC, BSC, OwnableBSC {
    ...
    string private _name = unicode'Teh Golden EGG';
    string private _symbol = unicode'🥚Teh🥚Golden🥚EGG🥚';
