...
/*
FatRedBull - Red Bull Racing Fans Meme Token
Exist to fully support Red Bull Racing, with only 3% of tax fees. Ever see Red Bull race to the moon? Grab your chance now!
- Low tax fees
- Based Dev with legit token only
- NFT coming soon

Join our telegram group : https://t.me/FatRedBull
*/
...
contract FatRedBull is Context, IERC20 { 
    ...
    string private constant _name = "FatRedBull"; 
    string private constant _symbol = "$FRB"; 
