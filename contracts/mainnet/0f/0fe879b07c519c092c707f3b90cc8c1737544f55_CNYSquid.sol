...
contract CNYSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChineseNewYear Squid";
    string private _symbol = "CNYSquid";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x09932597ceA472b1b6A027977c4F0e2789652732); // Buy Back Address
