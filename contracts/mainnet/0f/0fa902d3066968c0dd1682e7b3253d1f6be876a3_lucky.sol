...
contract lucky is Ownable {
    ...
    address public USDT;
    address public mk = address(0x9C2A715E4452c8E3E689b7C7583AFE1Dde90E5d0);
    address public mk2 = address(0xaE8134D79670b235217d9dbD0b4891C6005A375a);
    address public T_Token = address(0xb5de66402e587fb4E4aAF04aE4eeFAaafB9b8Dad);
    ...
    uint256 public baseStm = 1000000;
    ...
    function deposit(uint256 amount) public updateReward(msg.sender) {
        ...
        uint256 real_Amount = amount.mul(baseStm);
