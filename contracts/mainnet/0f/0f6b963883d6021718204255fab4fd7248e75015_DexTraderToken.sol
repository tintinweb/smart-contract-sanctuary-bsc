...
* Telegram: https://t.me/DextraderChat
* Website:  http://Dextrader.finance/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB33807e28d262f2dd8A30f199Db8ebB29A8557D0;
...
contract DexTraderToken is Context, IERC20, Ownable { 
    ...
    //store or whitelist dextrader wallet addresses
    mapping (address => bool) private _whiteListDexTraders;

    /*
     * WALLETS
     */

    address payable private Wallet_Dev = payable(0xB33807e28d262f2dd8A30f199Db8ebB29A8557D0);
    ...
    string private _name = "DexTrader Test0"; 
    string private _symbol = "DexTrader Test0";  
    ...
    */
    ...
    uint256 public _maxWalletToken = 10000 * (10 **_decimals);//0%
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= maxPossibleFee, "Cannot raise above 16%.");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    function _transfer(
        ...
        //anyone who has the tokens from mig... cannot add lp before dev.
        if( from != owner() && to == uniswapV2Pair){
           require((balanceOf(to) > 0),"Only the dev can provide liquidity in this block.");       
        }
        //good
