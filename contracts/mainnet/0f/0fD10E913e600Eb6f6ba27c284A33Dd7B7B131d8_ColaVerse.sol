...
contract ColaVerse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ColaVerse";
    string private _symbol = "COLAVERSE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xE976e444cd3f79650c0B7CA09411056dD1Da37E8);
