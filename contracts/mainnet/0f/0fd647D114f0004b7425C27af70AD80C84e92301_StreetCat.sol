...
contract StreetCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x63b2960DeB33cD1018938668A77951C470532EDD); 
    address payable public Wallet_Dev = payable(0x63b2960DeB33cD1018938668A77951C470532EDD);
    ...
    string private constant _name = "StreetCat"; 
    string private constant _symbol = unicode"STREETCAT"; 
    ...
    constructor () {
        ...
        _owner = 0x63b2960DeB33cD1018938668A77951C470532EDD;
