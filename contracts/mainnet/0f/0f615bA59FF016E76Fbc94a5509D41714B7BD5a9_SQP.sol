...
abstract contract SQPToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapFeeTwo;
            if (isSell) {
                swapFeeTwo = _sellFundFeeTwo;
            } else {
                swapFeeTwo = _buyFundFeeTwo;
            }
            uint256 swapAmountTwo = tAmount * swapFeeTwo / 10000;
            if (swapAmountTwo > 0) {
                feeAmount += swapAmountTwo;
                _takeTransfer(
                    sender,
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fistBalance);
    }
    ...
    function setBuyFundFee(uint256 fundFee,uint256 fundFeeTwo) external onlyOwner {
        _buyFundFee = fundFee;
        _buyFundFeeTwo = fundFeeTwo;
    }
    ...
    function setSellFundFee(uint256 fundFee,uint256 fundFeeTwo) external onlyOwner {
        _sellFundFee = fundFee;
        _sellFundFeeTwo = fundFeeTwo;
    }
...
contract SQP is SQPToken {
    constructor() SQPToken(
        ...
        18,
        2100000000,
        address(0x54638EaDF80f09700569a5c9Af2e7E1A58a2a059),
        address(0x30F500FAfb0e5414c344C730795E6d276BA1F722)
    ){
