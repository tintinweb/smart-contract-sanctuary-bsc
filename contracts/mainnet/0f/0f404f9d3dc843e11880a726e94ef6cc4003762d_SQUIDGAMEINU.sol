...
Squid Game Inu 2.0 next moonshot x1000
...
contract SQUIDGAMEINU is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 4_000 * 10**9; //
    string private constant _name = "SquidGameInu2.0"; //
    string private constant _symbol = "Squid Game Inu 2.0"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x222CfcFE893E97b9a743ae0313112d84FfDB96DD ;
