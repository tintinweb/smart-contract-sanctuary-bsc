...
contract XMASBLACK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XMAS BLACK";
    string private _symbol = "XBLACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe74d6a338B8F7A8F9d8A3f7ceBAF528d44bf09AE); // Marketing Address
    address payable public teamWalletAddress = payable(0xe74d6a338B8F7A8F9d8A3f7ceBAF528d44bf09AE); // Team Address
