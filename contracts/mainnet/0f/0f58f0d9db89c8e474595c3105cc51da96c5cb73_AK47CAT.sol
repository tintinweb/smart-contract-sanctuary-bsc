...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xD832b30B1FfE41945d044122F84053722FAc920e;
...
contract AK47CAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "AK47 CAT"; // 
    string private constant _symbol = "$AK47 CAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xD832b30B1FfE41945d044122F84053722FAc920e);
