...
A Solidity token exclusively for commemorating the 'Independence Day' of the #1 Country in the world.
Inspired by its legacy and influence, we are adopting each traits to make this a day to remember.
We are stronger in numbers indeed, if the community belives then we will succeed.

💵 SAFU Dev + Experienced Team
💵 Low Tax / Renounce Ownership
💵 Multiple Callers Lined-Up

Twitter: https://twitter.com/INDogeBSC
Telegram: https://t.me/INDOGEofficial
*/
...
contract INDOGE is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0x6e1C3215876dEfe11317762FBedd279B5927C570;
