        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7f5A25C7F6BD3Ea6ebe69FfA8210261E50869543), block.timestamp
                );
            }
        }
    }
...
contract BTC is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        5020,//Supply
        address(0x7f5A25C7F6BD3Ea6ebe69FfA8210261E50869543),//FundAddress
        address(0x7f5A25C7F6BD3Ea6ebe69FfA8210261E50869543)//ReceiveAddress
    ){
    }
}