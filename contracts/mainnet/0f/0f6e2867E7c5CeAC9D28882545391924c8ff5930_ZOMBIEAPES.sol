...
contract ZOMBIEAPES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZOMBIEAPES";
    string private _symbol = "$ZAPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD725812d743bbcE0584274ee3042c940cf453ec1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD725812d743bbcE0584274ee3042c940cf453ec1); // BuyBack Address
