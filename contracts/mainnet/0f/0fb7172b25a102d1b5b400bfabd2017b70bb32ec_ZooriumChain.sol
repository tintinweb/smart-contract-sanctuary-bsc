...
contract ZooriumChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zoorium Chain";
    string private _symbol = "Zoorium";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7bfEA898a898ac49E2790FC148FDE0E9fa92Bff1);
