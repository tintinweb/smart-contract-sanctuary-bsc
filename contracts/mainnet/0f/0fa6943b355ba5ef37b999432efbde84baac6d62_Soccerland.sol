...
/**
Soccerland
Telegram : https://t.me/soccerland_portal
Website  : https://soccerland.live
*/
...
contract Soccerland is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0xFF197E56a261e648C9E40AF12d36DF71a39Ca7E8);
    address public bbWallet = address(0xFF197E56a261e648C9E40AF12d36DF71a39Ca7E8);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 1800 && !phaseTwo) {
            _maxWalletAmount = 5_000_000 * 10**_decimals;
            _maxTxAmount     = 5_000_000 * 10**_decimals;
