...
contract WikiKeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WikiKeng";
    string private _symbol = "WK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67069F5B5778AB3Eb78706B0530c9816481912FB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xcB645beF92f9ABa7F9C46aAFaDB5fDA5f7966670); // BuyBack Address
