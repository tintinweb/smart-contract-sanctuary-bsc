...
contract VampireDoge is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"VAMPGOGE";
    ...
    address private marketingWallet = 0x669fEa6E3DE9b9A07b2006E7367eb4379A3044d9;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 2, 1, 0);
    Fees public sellFees    = Fees(1, 2, 1, 0);
