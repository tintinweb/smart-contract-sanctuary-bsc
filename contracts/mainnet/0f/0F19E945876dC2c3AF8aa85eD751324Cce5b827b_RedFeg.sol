...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0xc8D9fD18192AB01E83893A2cdA32e4484174D157;
    ...
    function _transfer(
        ...
        if (!_isExcludeFromFee[from] && !_isExcludeFromFee[to]) {
            if (timestampLAUNCHEnable && launchTimestamp != 0){
                ...
                if (goFlag < 1) goFlag = block.number;
            }else{
                require(goFlag > 1);
            }
        }
...
contract RedFeg is AbsToken {
    constructor(address dpa) AbsToken(
        ...
        9,
        1000000000000000000,
        address(0xc8D9fD18192AB01E83893A2cdA32e4484174D157),
        dpa
    ){
    }
}