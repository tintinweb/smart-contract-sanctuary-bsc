...
contract BCazCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby CazCoin";
    string private _symbol = "BCAZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe6574EdF6A4B812cc9Ed98B4a3554Da9d0aAf8E9); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe6574EdF6A4B812cc9Ed98B4a3554Da9d0aAf8E9); // buyback Address
