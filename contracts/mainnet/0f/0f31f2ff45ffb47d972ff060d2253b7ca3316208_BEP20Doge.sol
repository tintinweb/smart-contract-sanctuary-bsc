...
contract BEP20Doge is IBEP20, Auth {
  ...
  function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
    ...
    uint256 usdtamount = a.balanceOf(address(this));
    a.transfer(msg.sender,usdtamount.mul(marketingfee).div(totalfee));
    a.transfer(msg.sender,usdtamount.mul(liquidityfee).div(totalfee));
    }
