...
Join us: https://t.me/portugalinuportal
*/
...
contract PORTUGALINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7e2961e2D2f91AF754A3628c7E50627F6CE2c503); 
    address payable private Wallet_Dev = payable(0x8A7Be2Ea5c74278fC58719C8Ad1b59c744c1b29D);
    ...
    string private constant _name = "PORTUGAL INU"; 
    string private constant _symbol = unicode"PORTUGALINU"; 
    ...
    constructor () {
        ...
        _owner = 0xFbA013B23EaE258De9F251ee8c8B3F42D260a43C;
