...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF7618D14E2fb2ceB98e96b14d961Fdeed3DaE420; // owner address
...
contract RatboyMas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Ratboy Mas ";
    string private _symbol = " RATMAS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF7618D14E2fb2ceB98e96b14d961Fdeed3DaE420); // Marketing Address
    address payable public teamWalletAddress = payable(0xF7618D14E2fb2ceB98e96b14d961Fdeed3DaE420); // Team Address
