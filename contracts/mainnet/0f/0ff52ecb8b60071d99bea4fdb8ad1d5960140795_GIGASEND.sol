...
contract GIGASEND is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xE63FE70a222BCCA6C474bCF0A3f48d75C4089EF3;
    address public buybackWallet = 0x988c569832475075f0Aab34f9263af522008DEa9;
    address private operationsWallet = 0x5a9862aEf54325655f21C794B827aFC97A3676D8;

    string private constant _name = "GIGA SEND";
    ...
    Taxes public taxes = Taxes(0, 4, 0, 7, 1);
    Taxes public sellTaxes = Taxes(0, 4, 0, 7, 1);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _buyback, uint256 _operations) public onlyOwner {
       require(_rfi+(_marketing)+(_liquidity)+(_buyback)+(_operations) <=22, "Sell Taxes cannot be higher than 22%");
       
       taxes = Taxes(_rfi,_marketing,_liquidity,_buyback,_operations);
        emit FeesChanged();
    }
