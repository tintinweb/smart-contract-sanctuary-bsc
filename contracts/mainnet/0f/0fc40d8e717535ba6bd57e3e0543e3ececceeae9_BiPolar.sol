...
contract BiPolar is ERC20, Ownable, SafeToken {
    ...
    uint256 public maxSellTransactionAmount = 400000000000 * (10**18);
    uint256 public maxBuyTransactionAmount = 800000000000 * (10**18);
    ...
    function setFee(uint256 _liquidityFee, uint256 _DevFee) public onlyOwner {
        ...
        totalFees = liquidityFee.add(DevFee); // total fee transfer and buy
    }
    ...
    constructor() ERC20("Polar2.0", "Bi Polar") {
        liquidityFee = 1;
        DevFee = 10;
        DevWallet = payable(0x6f75fDc85B3175Ae7946d1DB9e4097CE627d8311);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // worthy Dev fee
        uint256 DevAmount = deltaBalance.sub(BNBToAddLiquidityWith).div(totalFees.sub(liquidityFee)).mul(DevFee);
    ...
    function swapAndSendBNBToDev(uint256 tokenAmount) private {
