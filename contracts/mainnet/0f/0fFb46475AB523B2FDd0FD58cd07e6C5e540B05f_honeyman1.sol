...
contract honeyman1 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "honeyman1";
    ...
    function SetCharityAddress(address payable  _charityAddress) onlyOwner public {
        require(_charityAddress != address(0), "can't add the zero address");
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    function Prize_Fund(address _account) onlyOwner public {
        require(_account != address(0), "can't add the zero address");
