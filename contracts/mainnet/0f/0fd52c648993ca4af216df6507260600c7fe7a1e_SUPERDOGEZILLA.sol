...
contract SUPERDOGEZILLA is BEP20, Auth {
    ...
    string public constant name = "Super DogeZilla";
    string public constant symbol = "SDZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd9D7A31e15d52b0Fde471BA2DdC4DB56e3F8Bc3d;
        teamFeeReceiver = 0x6900FC8F2E2d5B3300fF5a08be66F9fF9F09bfBF;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(antibot && (firstbuy[sender] > 0)){
                require( firstbuy[sender] > (block.number - 8), "Bought before launch!");
            }

        }

        if(!antibot){
            require(!isSnpr[sender],"SUPERDOGEZILLA");    
        }
