...
/**
    ...
    Croodle Token created for the Meme community on BSC chain,
    which has a good heart! Croodle is Passive income token with 3% busd reward, 
    compounding and passive income generator with Hold - To - Earn and 
    Croodle Inu token reward form integrated staking platform


    Twiter : https://twitter.com/CroodleInu
...
/* Token contract */
contract CroodleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xAD00c02D6Dc43643e3A3EAE06A5CAA23d1DBfE00;
    ...
    // Name and symbol
    string constant _name = "Croodle Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xAD00c02D6Dc43643e3A3EAE06A5CAA23d1DBfE00;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, bool GREEDMode) internal returns (uint256) {
        ...
        if (GREEDMode){
            if(isSell){
                ...
                feeAmount = amount.mul(totalFee).mul(3).div(feeDenominator);
            } else {
