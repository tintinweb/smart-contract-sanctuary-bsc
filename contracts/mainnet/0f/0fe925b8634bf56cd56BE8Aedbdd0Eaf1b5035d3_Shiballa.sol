...
contract Shiballa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiballa";
    string private _symbol = "Shiballa";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x416E257d889D64197e382949d6cCB38761DAc1b0); 
    address payable public teamWalletAddress = payable(0x29bad80Df010fcd73261d1c13d5B4aff05875513); 
