...
contract OkaNoKamihimeTensorGate is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xF3Bf1d178C7eBC0A35123870670483Fe9178a8A3);
    address payable public Wallet_Marketing = payable(0x938A0dE551F28d92dA53198119922036754f2450); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 3000000000 * 10**_decimals;
    string private constant _name = "OkaNoKamihimeTensorGate"; 
    string private constant _symbol = unicode"ONKTG"; 
    ...
    constructor () {
        ...
        _owner = 0x7885A99c6Ee441B79D24C9852b96b65A09416895;
