...
Telegram : https://t.me/RatBoySoldierPortal
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD6fe22AD7EbdDbcBbe441345951f29d55922f1c2;
...
contract Rat is Context, IERC20, Ownable {
    ...
    string private constant _name = "RatBoy Soldier"; // 
    string private constant _symbol = "$RatBoy"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xD6fe22AD7EbdDbcBbe441345951f29d55922f1c2);
