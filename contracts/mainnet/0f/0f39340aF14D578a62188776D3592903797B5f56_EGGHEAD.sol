...
contract EGGHEAD is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xe9a94C3bE2AdE404f9C0e661866188d93B700fb4);
    ...
    string private constant _name = "EggHead"; 
    string private constant _symbol = unicode"EGGH"; 
