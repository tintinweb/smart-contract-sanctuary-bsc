...
contract PresaleLockForwarder is Ownable {
    ...
    IUniswapV2Locker public DIGICHAIN_LOCKER;
    IUniswapV2Factory public UNI_FACTORY;
    
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0x87908152b759b0b2fDB4E977Ae24e207feA8b0b1);
        DIGICHAIN_LOCKER = IUniswapV2Locker(0x7AcbdF20FCf12b7f24420Ca0284d51c112C7a4A7);
    ...
    */
    ...
    function lockLiquidity (IERC20 _baseToken, IERC20 _saleToken, uint256 _baseAmount, uint256 _saleAmount, uint256 _unlock_date, address payable _withdrawer) external {
        ...
        TransferHelper.safeApprove(pair, address(DIGICHAIN_LOCKER), totalLPTokensMinted);
        uint256 unlock_date = _unlock_date > 9999999999 ? 9999999999 : _unlock_date;
        DIGICHAIN_LOCKER.lockLPToken(pair, totalLPTokensMinted, unlock_date, address(0), true, _withdrawer);
    }
