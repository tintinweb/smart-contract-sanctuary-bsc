...
contract CokeGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coke Grow";
    string private constant _symbol = "COKEGROW";
