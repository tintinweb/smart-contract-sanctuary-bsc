...
/*
$oCAT — The ORIGINAL MEMECOIN
Tax : 5/5%
Telegram: https://t.me/OrdinalCatBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcB1480fdf8baebbF59c221C03E9a1B5B786Dc68A;
...
contract OrdinalCat is Context, IERC20, Ownable {
    ...
    string private _name = "Ordinal Cat";
    string private _symbol = "oCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcB1480fdf8baebbF59c221C03E9a1B5B786Dc68A);
    address payable public teamWalletAddress = payable(0xcB1480fdf8baebbF59c221C03E9a1B5B786Dc68A);
