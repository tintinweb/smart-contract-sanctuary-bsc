...
contract TransparentUpgradeableProxy is Context, IERC20, Ownable {
    ...
    string private _name = "Bit Pad";
    string private _symbol = "BPAD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x89Ffb2CD75FeaccA2B0BDBA330FC0A1118981f0e);
    address payable public buyBackWalletAddress = payable(0x89Ffb2CD75FeaccA2B0BDBA330FC0A1118981f0e);
