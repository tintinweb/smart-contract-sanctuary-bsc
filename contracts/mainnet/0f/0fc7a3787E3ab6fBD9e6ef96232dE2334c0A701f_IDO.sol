...
interface IInvitation {
    ...
    // function getInvitation2(address user) external view returns(address inviterFather, address[] memory invitees);
...
contract IDO is Ownable{
    ...
    address constant public _invitation = 0x1aa11Cc807B0E3cc4251D4217f6FD8A6Ce1bff56;
    address public _nft = 0xf3AC9Ee5B3b024822e2046b156cac8d02d1Ba02B;
 ...
 function invest1() external {
        ...
        (address inviterFather,) = IInvitation(_invitation).getInvitation(inviter);
        ...
        IERC20(_usdt).transferFrom(msg.sender, _fund, 85e18);
        IERC20(_usdt).transferFrom(msg.sender, inviter, 10e18);
        if(inviterFather != address(0)){
            IERC20(_usdt).transferFrom(msg.sender, inviterFather, 5e18);
        }else{
            IERC20(_usdt).transferFrom(msg.sender, _fund, 5e18);
        }
   ...
   // stake
    function invest3(uint256 _inviamount,uint256 _ceoamount) external {
        ...
        IERC20(_usdt).transferFrom(msg.sender, _fund, 70e18);
    ...
    function stakeUsdt() external {
        ...
        IERC20(_usdt).transferFrom(msg.sender, _fund, 200e18);
