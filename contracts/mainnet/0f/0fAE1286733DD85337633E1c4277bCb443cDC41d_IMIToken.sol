...
contract IMIToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x04783dC7a7Ab58d629B35C6695B9361cB82783c4); // Marketing Address
    address payable public teamWalletAddress = payable(0x04783dC7a7Ab58d629B35C6695B9361cB82783c4); // Team Address
    address payable public liquidityAddress = payable(0xCD52C7b660FbbcbAe31bFb5b00FF9f424b18a5bd); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 11000000000000 * 5 **_decimals; 
