...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfC24B3F441A1D66A4C61BBa548909D118581eFA7; // owner address
...
contract Auxireum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Auxireum";
    string private _symbol = "Auxi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfC24B3F441A1D66A4C61BBa548909D118581eFA7); // Marketing Address
    address payable public teamWalletAddress = payable(0xfC24B3F441A1D66A4C61BBa548909D118581eFA7); // Team Address
