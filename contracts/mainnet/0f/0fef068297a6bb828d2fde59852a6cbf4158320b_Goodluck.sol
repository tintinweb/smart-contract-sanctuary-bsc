...
contract Goodluck is Context, IERC20, Ownable {
    ...
    string private _name = "Goodluck";
    string private _symbol = "GODK2";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x793da0FF6F4759AE724883A1A0909E574d568043));
        marketingWalletAddress = payable(address(0x8f9E80948BbAFB9105C3b2c0d517a746145f506a));
