...
contract WorldBetToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(_decimals)) Ownable() {
        ...
        treasuryReceiver = 0x298565b5027546db94D9e3bf3695cD9cde9F29C1;
        rewardReceiver = 0x8A812Ff72E256B32f2CAa3Bb2847C65354f822c7;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHToTreasuryAndReward = address(this).balance.sub(
            balanceBefore
        );

        uint256 _currentFee = treasuryFee.add(rewardFee).add(burnFee);
