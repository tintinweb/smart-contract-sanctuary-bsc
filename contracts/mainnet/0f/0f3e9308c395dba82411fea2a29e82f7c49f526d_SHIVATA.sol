...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd03d4D275b6c187888F8b257Ba659fD0F5AE9a30; // owner address
...
contract SHIVATA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIVATA Inu";
    string private _symbol = "SHIVATA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd03d4D275b6c187888F8b257Ba659fD0F5AE9a30); // Marketing Address
    address payable public teamWalletAddress = payable(0xd03d4D275b6c187888F8b257Ba659fD0F5AE9a30); // Team Address
