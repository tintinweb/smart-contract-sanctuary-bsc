...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
 ...
 //File: TheRealmToken.sol

pragma solidity ^0.8.17;

contract TheRealmToken is BEP20, Ownable {
    constructor() BEP20("The Realm Token", "TOR") {
        _mint(msg.sender, 10000000000 * 10** decimals()); // 10 BILLION TOKEN SUPPLY
    }

    /**
    *@dev Claim Stucked BNB from the smartcontract
    */

    function claimStuckedBNB () external onlyOwner {
     ...
     /**
    *@dev Claim Stucked bep20 from the smartcontract
    */
