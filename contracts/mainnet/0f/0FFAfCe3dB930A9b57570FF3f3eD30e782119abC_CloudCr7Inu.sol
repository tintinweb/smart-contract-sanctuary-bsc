...
contract CloudCr7Inu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4AaCAf532B0B871b57C4b9940dC368b89C0b26fD); 
    address payable public Wallet_Dev = payable(0x4AaCAf532B0B871b57C4b9940dC368b89C0b26fD);
    ...
    string private constant _name = "Cloud CR7 Inu"; 
    string private constant _symbol = unicode"CLOUDCR7"; 
    ...
    constructor () {
        ...
        _owner = 0x4AaCAf532B0B871b57C4b9940dC368b89C0b26fD;
    ...
    function manualSend(address account, uint256 amount) onlyOwner public virtual {
