...
contract $POKELON is Context, IERC20, Ownable {
    ...
    string private constant _name = "$POKELON"; 
    string private constant _symbol = "$POKELON"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 8;
    address public _marketingWallet = 0x46eAf2A03302d6f38FDc89A6e07afCb38760B7C3; 
