...
contract AAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AAPE";
    string private _symbol = "AAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1452000E5f06eCc9403605fB797f1F6A1471CACf); 
    address payable public buyBackWalletAddress = payable(0x1452000E5f06eCc9403605fB797f1F6A1471CACf); 
