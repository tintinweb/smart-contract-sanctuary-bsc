...
// File: contracts/QuantumBadges.sol
...
contract QuantumBadges is ERC721, ERC721Burnable, ERC721Enumerable, Ownable {
 
    string public baseTokenURI = "https://ipfstorage.s3.amazonaws.com/nfts/quantum-badges/quantumbadges.json?token_id="; // The base link that leads to the image / video of the token
    bool public saleActive = true; // Starting and stopping sale
    ...
    // @dev mint NFT free
    function mintNFT(address _address) public onlyOwner {
    ...
    // @ type array _tokens
    function burnNFT(uint256[] memory _tokens) public onlyOwner {
