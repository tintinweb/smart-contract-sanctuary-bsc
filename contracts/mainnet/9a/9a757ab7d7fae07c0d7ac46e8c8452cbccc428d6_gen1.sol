...
contract gen1 {
    ...
    uint256[] public REFERRAL_PERCENTS = [70, 10, 1, 1, 1];
    ...
    constructor() public {
        token = IBEP20(busd);
        commissionWallet = 0x697418EB688db1B0822D21C78C022912581C0388; // CR wallet
        ceoWallet = 0x19Aeead1a0E24161c02D12Ee8DE5C152eAD2A010;
        plans.push(Plan(9, 190));
        plans.push(Plan(12, 170));
        plans.push(Plan(24, 140));
        plans.push(Plan(40, 110));
    }
