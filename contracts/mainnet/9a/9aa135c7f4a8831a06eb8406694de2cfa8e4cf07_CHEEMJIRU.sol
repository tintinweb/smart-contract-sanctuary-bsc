...
// 1% Auto - Buyback
// Tax - 5%
// TG: https://t.me/CheemJiruInu - TG / CN: https://t.me/CheemJiruInu_CN
...
contract CHEEMJIRU is IBEP20, Auth {
    ...
    string constant private _name = "CheemJiru Inu";
    string constant private _symbol = "CHEEMJIRU";
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function setMarketingFe(address _varMarketingFeeReceiver, address _devFeeReceiver) external authorized {
