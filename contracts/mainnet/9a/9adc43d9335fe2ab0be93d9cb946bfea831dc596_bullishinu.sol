...
*/
// Telegram : https://t.me/bullish_inu offcial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6931847a3E1B87891B0F8b4d2F3e33058Da2c988; // owner address
...
contract bullishinu is Context, IERC20, Ownable {
    ...
    string private _symbol = "BULLISH INU";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x6931847a3E1B87891B0F8b4d2F3e33058Da2c988); // Marketing Address
    address payable public teamWalletAddress = payable(0x6931847a3E1B87891B0F8b4d2F3e33058Da2c988); // Team Address
