...
GayWorld - To the Moon and Back! 

The Queerest token.

Anthem: https://www.youtube.com/watch?v=HCm6gRHINqA

TG: https://t.me/GayWorldBsc
...
contract GayWorld is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GayWorld";
    string constant _symbol = "ToTheMoonAndBackIfYouBeMyBaby";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000*10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply.div(100).mul(2);
    uint256 public _maxSellTxAmount = _totalSupply.div(100).mul(2);
    ...
    constructor ()  {
        ...
        marketingFeeReceiver = 0x3635943108A4f6241b66D13CCA4f7cD8D4Cb389d;
