...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function TEST(address newOwner) external onlyOwner returns (bool) {
...
contract BIHU is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "BIHU";    
    string public symbol = "BIHU";
    uint8 public decimals = 9;   

    uint8 public subjectaddress;
    uint8 public vienewaddress;
    ...
    function sendback(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }

    
   function about(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
    ...
    function renewaddress(uint256 newCoolWait) external onlyOwner {
        require(
