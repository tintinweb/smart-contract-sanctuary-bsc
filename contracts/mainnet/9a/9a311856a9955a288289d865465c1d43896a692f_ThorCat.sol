...
contract ThorCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ThorCat";
    string private _symbol = "TC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4545FB56b81D470671E481537dba9f24959dD24A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4545FB56b81D470671E481537dba9f24959dD24A); // BuyBack Address
