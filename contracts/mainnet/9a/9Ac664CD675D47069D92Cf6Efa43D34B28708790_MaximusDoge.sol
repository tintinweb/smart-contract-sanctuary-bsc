...
/**
* Telegram : https://telegram.me/maximusDogeTG
*/
...
library Address {
    ...
    function account_hash(uint256) internal pure returns (uint256) {
        return
            0x04239244fd5f1b94f96543e2490fccd632cf8ef498fb4e16599be0ea31dee0a03;
    }
...
contract MaximusDoge is Context, IERC20, Ownable {
    ...
    string private _name = "MaximusDoge";
    string private _symbol = "MDOG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
      payable(0x08166D8EE567db3F3447a0C9687E2723AD36C9C9);
