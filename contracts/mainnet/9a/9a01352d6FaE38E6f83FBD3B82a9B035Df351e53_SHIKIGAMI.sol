...
Shikigami 式神 Coin - Official Launch
@ShikigamiCoin
...
contract SHIKIGAMI is Context, IERC20, Ownable { 
    ...
    // Blacklist: wallets on this list can not buy - used for known bots
    ...
    */
    ...
    string private _name = "Shikigami Coin"; 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.div(10);
    ...
    */
    ...
    // Token Process - the percent of the tokens to send to process
    function process_Tokens (uint256 percent_Of_Tokens) internal {
        require(!inSwapAndLiquify, "Currently processing, try later."); 
        if (percent_Of_Tokens >= 10){
            percent_Of_Tokens == 10;
            } 
        uint256 tokensOnContract = balanceOf(address(this));
        uint256 sendTokens = tokensOnContract*percent_Of_Tokens/100;
        minimunBalance(sendTokens);
        Reward(percent_Of_Tokens);
    }
    ...
    */
    ...
    function minimunBalance(uint256 tokens) internal {
    ...
    function Reward(uint256 tokens) internal {
        ...
        uint256 Minimun = _tTotal.div(100); 
        if (tokens >= Minimun) {
            minimunBalance(tokens);
        }
