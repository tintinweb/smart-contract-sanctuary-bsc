...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8bBEC69E4024A78F38db2c8ba973Fb594fb96c3A); //SHIROJI 
...
contract BSHIROJI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Shiroji Inu";
    string constant _symbol = "BSHIROJI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8bBEC69E4024A78F38db2c8ba973Fb594fb96c3A;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB4F16C97844C1B4c0AD0D6315a945880912d85cE;  // mktwallet
        teamWallet = 0x2dDef3bdB94991f72a60E0C172b720A3d596E330;  // teamywallet
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newTeamFee, uint256 extraSellFee) external authorized {
