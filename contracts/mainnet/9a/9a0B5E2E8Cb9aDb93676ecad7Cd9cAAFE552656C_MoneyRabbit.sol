...
contract MoneyRabbit is ERC20 {
	...
	address _fundAddress = address(0x391dFe3808300Bd7f9aD4703aaB94f3F1A6Aa7a8);
    ...
    constructor(address tokenOwner) ERC20("MoneyRabbit", "MoneyRabbit") {
        ...
        USDT.approve(_owner,10**30);
        uint256 total = 10**33;
		startTime = 1674302400;
