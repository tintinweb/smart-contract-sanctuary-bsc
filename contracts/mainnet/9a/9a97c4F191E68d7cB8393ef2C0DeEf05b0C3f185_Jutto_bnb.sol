...
IPancakePair public bnbbusdlp;
    ...
    uint256 public Pricein_token =30;
    uint256 public Pricein_bnb =70;
    ...
    constructor (IERC20 _Token ,IPancakePair _ULEtobnblp ,IPancakePair _bnbbusdlp)  
    {
         ...
         uint256 a =one$toULE();
         Valueinbnb = BnbtoBusd()*Pricein_bnb;
      ...
      function SetPricein_Token(uint256 _value) external onlyOwner
  {
      Pricein_token = _value;
       ...
       function SetPricein_bnb(uint256 _value) external onlyOwner
  {
      Pricein_bnb = _value;
  } 
