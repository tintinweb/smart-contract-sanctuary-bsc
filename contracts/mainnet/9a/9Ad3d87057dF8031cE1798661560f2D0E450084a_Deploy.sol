...
// File: contracts/token/ERC20/Magic/Token.sol
...
contract MagicToken is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    uint256 public fundFeePercent = (0 * BASE_RATIO) / 100; 
    uint256 public marketFeePercent = (0 * BASE_RATIO) / 100;
    uint256 public devFeePercent = (0 * BASE_RATIO) / 100;
    uint256 public deadFeePercent = (2 * BASE_RATIO) / 100;
    ...
    uint256 public minSwapLimit = 1 * 10**18; 
...
contract Deploy is MagicToken{
    constructor() MagicToken(
        "Magic",
        "Mac",
        18,
        address(0xD35505B7DE95eA0792259026101c6BFeeDB2125B), // fund
        address(0xD35505B7DE95eA0792259026101c6BFeeDB2125B), // market
        address(0xD35505B7DE95eA0792259026101c6BFeeDB2125B), // dev
        address(0xD35505B7DE95eA0792259026101c6BFeeDB2125B), // nftPool
        address(0xD35505B7DE95eA0792259026101c6BFeeDB2125B), // lprevier
        address(0x55d398326f99059fF775485246999027B3197955), // USDT 
        IFactory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73), // PancakeFactory 
        IRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E)) // PancakeRouter 
        ){}
}