...
contract Boilthebear is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BTBCDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Boil The Bear", "BTBC") {
        ...
        dividendTracker = new BTBCDividendTracker(
            payable(this),
            router,
        ...
        dividendTracker.excludeFromDividends(address(0xdC8414bD0b005E1377d9B9D8d36e857378917E43));
...
contract BTBCDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Boilthebear public BoilthebearContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BoilthebearContract = Boilthebear(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Boilthebear_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Boilthebear_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Boilthebear contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BoilthebearContract);

            uint256 prevBalance = BoilthebearContract.balanceOf(address(this));
            ...
            {
                uint256 received = BoilthebearContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BoilthebearContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
