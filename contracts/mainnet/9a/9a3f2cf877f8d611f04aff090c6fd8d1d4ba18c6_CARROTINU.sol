...
contract CARROTINU is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Carrot Inu";
    string private _symbol = "CARROT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5f81784d2a8D8D163532a38580C302Cf4086ac9b);
    address payable public liqWalletAddress = payable(0x5f81784d2a8D8D163532a38580C302Cf4086ac9b);
