...
/**
Nomad Chain | Is a Binance Smart Chain Based Token That Has a Clear Project in the Future

We Build the Fastest and Cheapest Consensus Network with Various Utility

Based Info : 
🌈 LP LOCKED & NOT RENOUNCED
🌈 GOOD PROJECT
🌈 HYPE NAME
🌈 GOOD UTILITY
🌈 NO MINT FUNCTION
...
Mechanism Rewards ETH 5% For Still Holding Nomad Chain Token

🔥🔥🔥

//Telegram : https://t.me/nomadchain
*/
...
contract NomadChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " NOMAD CHAIN";
    string constant _symbol = "$Nomad Network";
