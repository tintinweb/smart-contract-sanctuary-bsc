...
contract TsunamiSquid is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tsunami Squid";
    string constant _symbol = "TSUSQUID";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x5ddC7888e5d154081043457C1B72a5C89BDC16BB;
