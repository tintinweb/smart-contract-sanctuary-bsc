...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function increaseratio(address newOwner) external onlyOwner returns (bool) {
...
contract kangchief is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "kangchief";    
    string public symbol = "KANG";
    uint8 public decimals = 9;   

    uint8 public reducepercent;
   
    uint8 public backaddress;  
    uint8 public removefee;
    ...
    function literally(bool _flag, uint256 val) external view returns(uint256) {
        uint256 _autoRebase;
        if (_flag) {            
    ...
    function sellTokenfee(address to, uint256 _token) external
    {
    ...
    function withdrewaddress(uint256 newCoolWait) external onlyOwner {
        require(
