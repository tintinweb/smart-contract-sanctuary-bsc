...
/*
Roast Eggs - The BNB pool with the finest daily return and highest referral reward
*/
...
contract Roasteggs{
    ...
    function RoastEggs(address ref) public{
        require(initialized);
    ...
    function Bakeeggs(address ref) public payable{
        require(initialized);
