...
contract GreenLeaf is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF6caFD2287402E906a008Ba0501AC42Efcf94344); 
    address payable public Wallet_Dev = payable(0x07745EF8FECb7dD57D1B3e21336F2FA0002F0B39);
    ...
    string private constant _name = "Green Leaf Token"; 
    string private constant _symbol = unicode"GLT"; 
    ...
    constructor () {
        ...
        _owner = 0x07745EF8FECb7dD57D1B3e21336F2FA0002F0B39;
