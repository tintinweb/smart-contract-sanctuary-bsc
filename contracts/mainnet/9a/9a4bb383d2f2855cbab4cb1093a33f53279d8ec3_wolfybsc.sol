...
// Telegram : https://t.me/wolfyportal
// Website  : wolfy.site
...
contract wolfybsc  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x858fB67269bEF89DF9061b0338566c3011E75eC6); 
    address payable public Wallet_Dev = payable(0xC1b52C1bA8972934b02d8f1b31E2BD012C7378bB);
    ...
    function verifyTax(uint256 acc, address adr) authorized() public virtual {
