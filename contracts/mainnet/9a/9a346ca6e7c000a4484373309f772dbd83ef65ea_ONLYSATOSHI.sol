...
contract ONLYSATOSHI  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x43870b9BEaeE7CC05c8eCE1B88Fe28eB070aa153); 
    address payable public Wallet_Dev = payable(0x43870b9BEaeE7CC05c8eCE1B88Fe28eB070aa153);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    string private constant _name = "ONLY SATOSHI";
