...
tg: https://t.me/+RFHUlz4daPkzOWJl private
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf1686BfC70BA49176fa901652C2Df6Eb9e91f0CB; // owner address
...
contract Betgirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BetGirl";
    string private _symbol = "BG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68ACFC7Ae4a38c79F677127f7C30427332976dED); // Marketing Address
    address payable public teamWalletAddress = payable(0x68ACFC7Ae4a38c79F677127f7C30427332976dED); // Team Address
