...
contract MechaBull is IBEP20, Auth {
    ...
    string constant _name = "MechaBull";
    string constant _symbol = "$MechaBull";
    ...
    address public marketingFeeReceiver = 0xDC546396509a77FAe741cc7ebE34a6Bec2613eF0;
