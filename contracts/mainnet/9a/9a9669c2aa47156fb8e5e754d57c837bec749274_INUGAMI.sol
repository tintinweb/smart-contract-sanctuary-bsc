...
contract MilkoMeta is IBEP20, Auth {
    using SafeMath for uint256;

    address WADA = 0xAE83571000aF4499798d1e3b0fA0070EB3A3E3F9;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MilkoMeta";
    string constant _symbol = "MilkoMeta";
    ...
    address private marketingFeeReceiver = 0x772430076497683a6844B9E57c52626D41BcE552;
    address private teamFeeReceiver = 0xC93B33FD17682809a54D2b96f5c895f0056759C4;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9D2E30C2FB648BeE307EDBaFDb461b09DF79516C);
    ...
    function swapBack() internal swapping {
        ...
        (bool developmentSuccess, /* bytes memory data */
        /**
...
contract INUGAMI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "INUGAMI";
    string constant _symbol = "IGM";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xa8b7e2170671233211411E45e9efFb112FA15a86;
