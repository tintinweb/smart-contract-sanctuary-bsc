...
// No TG Just locked and renounced if it does good community can make a TG. lets go habibi.
...
contract Shibibi is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUST = 0x73bc120Fa56B5419e53CaC1e91F76694955E49F8;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Habibi Shiba Inu";
   string constant _symbol = "Shibibi";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 3 ) / 100 ; //max tx base 100
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0x73bc120Fa56B5419e53CaC1e91F76694955E49F8; 
       marketingFeeReceiver = 0x73bc120Fa56B5419e53CaC1e91F76694955E49F8; 
       buybackFeeReceiver = 0x73bc120Fa56B5419e53CaC1e91F76694955E49F8; 
