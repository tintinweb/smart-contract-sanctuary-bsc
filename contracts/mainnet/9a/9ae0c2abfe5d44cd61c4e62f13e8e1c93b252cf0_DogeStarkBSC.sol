...
contract DogeStarkBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeStark";
    string private _symbol = "STARKINC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x517D43847f4D09f04e6369878CfDcaAFA98f3ae6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x517D43847f4D09f04e6369878CfDcaAFA98f3ae6); // BuyBack Address
