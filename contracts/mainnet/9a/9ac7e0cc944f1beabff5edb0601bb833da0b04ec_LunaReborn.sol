...
// LunaReborn re-launches well-known token with top 10 CoinMarketCap

// @RiskyGemsHunters https://t.me/RiskyGemsHuntersCalls
// Re-Launch Luna
...
contract LunaReborn is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 3_000_000 * 10e18;
    uint256 public maxTxAmount = 10_000_000 * 10**18;
    uint256 public maxWalletAmount = 15_000_000 * 10**18;
    ...
    constructor(address _marketingWallet, address _devWallet) ERC20("LunaReborn", "RLuna") {
