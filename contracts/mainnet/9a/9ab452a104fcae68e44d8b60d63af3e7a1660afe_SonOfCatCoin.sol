...
Welcome To Son Of Catcoin!

The parent has taken flight.  The Baby has followed suit.  Now, it’s the firstborn Son’s turn to moon!  Cat hype is real and it’s here!  This is your chance to be early!  Manage your investments, temper your greed, and everything will turn out PURRRRRRFECTLY!
...
2.5% max TRX, 2.5% max wallet

TG: http://t.me/SonOfCatcoin
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CATS = IERC20(0x3B3691d4C3EC75660f203F41adC6296a494404d0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CATS.balanceOf(address(this));
        ...
        uint256 amount = CATS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CATS.transfer(shareholder, amount);
...
contract SonOfCatCoin is IERC20, Ownable {
    using SafeMath for uint256;

    
    address CATS = 0x3B3691d4C3EC75660f203F41adC6296a494404d0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Son of CatCoin";
    string constant _symbol = "SoCATS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 400; // 2.5% of Total Supply.
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x5A8f8647F6e7e559A972792A2eB9fD16042214C3);
        marketingFeeReceiver = address(0x5A8f8647F6e7e559A972792A2eB9fD16042214C3);
