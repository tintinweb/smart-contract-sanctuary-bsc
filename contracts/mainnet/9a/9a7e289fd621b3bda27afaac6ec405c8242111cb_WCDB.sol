...
TELEGRAM : https://t.me/worldcupdetectorbot
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa7aB87Ba2450A122A711f662d1e1bCD71FaBF915; // owner address
...
contract WCDB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " World Cup Detector Bot ";
    string private _symbol = " WCDB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7aB87Ba2450A122A711f662d1e1bCD71FaBF915); // Marketing Address
    address payable public teamWalletAddress = payable(0xa7aB87Ba2450A122A711f662d1e1bCD71FaBF915); // Team Address
