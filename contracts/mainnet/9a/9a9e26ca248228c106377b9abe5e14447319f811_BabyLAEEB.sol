...
contract BabyLAEEB is Context, IERC20, Ownable {
    ...
    string private constant _name = " Baby LAEEB "; // 
    string private constant _symbol = " $BABYLAEEB "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x3BD81Ac3a8d69DFdB792b0C36B034374ebcBD11C;
