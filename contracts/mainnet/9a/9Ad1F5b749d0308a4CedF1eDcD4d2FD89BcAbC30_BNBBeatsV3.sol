...
Silvercash Farm | earn money until 4% daily | Metaversing 
...
contract BNBBeatsV3 is Ownable {
    ...
    constructor() {
        devAddress = payable(0xED81C4786E198ab374225c7F8f9aE9109cA937A3);
        ownerAddress = payable(0xcB464D0B7820Ac9906B729367D17AA3D29417A1d);
        mktAddress = payable(0xd90422fE4626Cf8ffC59bE1df36Ff828fB855a95);
    ...
    function buyWhiteList() public payable {
        require(msg.value == priceWhiteList, "The price is 0.17 BNB");
