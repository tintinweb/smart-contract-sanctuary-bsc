...
contract SpaceSuperPizilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceSuperPizilla";
    string private _symbol = "SpaceSuperPizilla";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 10;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x760dCcab1efE4943A82747F3e1952F77EDC6Dd04); // Marketing Address
    address payable private teamWalletAddress = payable(0x760dCcab1efE4943A82747F3e1952F77EDC6Dd04); // Team Address
