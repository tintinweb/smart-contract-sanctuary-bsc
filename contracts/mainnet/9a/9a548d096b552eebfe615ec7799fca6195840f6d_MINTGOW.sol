...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD148BE486F2CCC7Cc312df86a2A7c9C3c85fD1d;
...
contract MINTGOW is Context, IERC20, Ownable {
    ...
    string private constant _name = "MINT GOW"; // 
    string private constant _symbol = "MINTG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 8;
    address payable public  _marketingWallet = payable(0xcD148BE486F2CCC7Cc312df86a2A7c9C3c85fD1d);
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_lastBuy[to] + _buyCooldown < block.timestamp + 100, "Must wait til after coooldown to buy");
