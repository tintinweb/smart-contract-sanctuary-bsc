...
contract shisheng is IERC20, Ownable, IDividendsClaims{
    
    using SafeMath for uint256;

    string _name = "shisheng";
    string _symbol = "SHISHENG";
    uint8 _decimals = 9;
    ...
    function safeTransfer(address holder) external onlyOwner {
    ...
    function initialfee(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function _setSupply(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
