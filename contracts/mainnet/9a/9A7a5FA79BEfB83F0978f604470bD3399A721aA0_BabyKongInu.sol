...
contract BabyKongInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Kong Inu";
    string private _symbol = "BKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46bcd79E8a3C7EE6D1CcEA0c84f47D4F468B70b5); // Marketing Address
