...
contract KhabyWorld is BEP20, Ownable {
    ...
    address public marketingWallet = 0x481978Cd0ee9C0638D169bfF8C7aDE7202286779;
    address public nftRewardsWallet =
        0x000000000000000000000000000000000000dEaD;
    address public teamWallet = 0x562909fa8757aa8Dec9E0eDF00523C122f242ee7;
    address public buybacksWallet = 0x56c37c455FB9e682E3954c2a6Ca5254170588647;
        ...
        lockTheSwap
    {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (buybacksAmt > 0) {
                payable(buybacksWallet).sendValue(nftRewardsAmt);
            }
        }
    }
    ...
    function withdrawBSC20(address tokenAdd, uint256 amount) external onlyOwner {
        require(
