...
contract CZ is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 600_000 * 10**18;
    ...
    address public devWallet = 0xfF8F224f5213403015aab9a6e72AdC4c8C08D613;
    address public gamedevWallet = 0xfF8F224f5213403015aab9a6e72AdC4c8C08D613;
    ...
    constructor(address routerAdd) ERC20("CZ Binance", "CZ") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _gamedev + _dev) <= 99, "Must keep fees at 20% or less");
    }
