...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36CC27e3Fe4f3Bd3FFE0927882171D02812D1643;
...
contract wstep is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF363ec2D957A9F3ef93fFDE4adc1Be1E864DaFd7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "wstep";
    string private _symbol = "wstep";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 1200;
