...
contract Overrated is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Overrated";
    string private _symbol = "Overrated";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC89f93892097a8D7939eE23eE02C8E170aBd1309));
        marketingWalletAddress = payable(address(0xC89f93892097a8D7939eE23eE02C8E170aBd1309));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xC89f93892097a8D7939eE23eE02C8E170aBd1309), _msgSender(), _totalSupply);
    }
