...
contract Odin is OdinDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private OdinTeam;
    address private CharityOdin;
    ...
    string public override name = "Odin Inu";
    string public override symbol = "Odin";
    ...
    constructor(uint totalSupplyValue, address OdinTeamAddress, address CharityOdinAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        OdinTeam = OdinTeamAddress;
        CharityOdin = CharityOdinAddress;
       
        // split the tokens according to agreed upon percentages
        balances[OdinTeam] =  totalSupply * 4 / 100;
        balances[CharityOdin] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's OdinTeam pot
