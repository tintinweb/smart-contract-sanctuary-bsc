...
contract Wigglytuff is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wigglytuff Coin";
    string private _symbol = "WC";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x8FFED023371829C6C9Ac7142A82612B7Df25bf92); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xed411f4601C8E5C01aa3e7e461f7efC3c585755B); // BuyBack Address
