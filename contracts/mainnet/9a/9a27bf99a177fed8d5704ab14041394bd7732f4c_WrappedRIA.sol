...
// File: contracts/token/ERC20/WrappedRIA.sol
...
/**
 * @title WrappedRIA
 * @dev Implementation of the WrappedRIA
 */
contract WrappedRIA is ERC20Mintable, ERC20Burnable, Ownable {

    constructor (
        )

        ERC20("Wrapped aRIA", "wRIA")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
