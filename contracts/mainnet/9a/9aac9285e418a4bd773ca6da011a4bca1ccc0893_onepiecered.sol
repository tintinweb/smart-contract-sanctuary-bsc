...
contract onepiecered is Context, IERC20, Ownable {
    ...
    string private constant _name = "One Piece Red"; // 
    string private constant _symbol = "$onepiecered"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 25;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x0709ea37896BaF61075be3ef7c8EB1AF0bedcCDe;
