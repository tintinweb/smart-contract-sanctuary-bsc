...
/**
  Pollux Inu goal is to build a strong consensual community.
 We need diamond Hands to join us. The moon will be our first stop.

POLLUX is your next BSC moonshot and a rare BSC gem. POLLUX is a defi
project that focused on providing its holders with security in the present and value in the future. 
As an intergalactic POLLUX holder, you will earn Token reflection everytime have buy and sell.

 For more info, kindly check our Socials: 

 https://twitter.com/pollux_inu

 https://www.polluxinu.net/

 https://medium.com/@polluxinubsc/pollux-brother-of-castor-the-twin-demi-god-of-horsemanship-14061598f837

 https://t.me/PolluxInu
...
pragma solidity ^0.6.12;
    ...
    contract Polluxinu is Context, IERC20, Ownable {
        ...
        string private _name = 'Polluxinu';
