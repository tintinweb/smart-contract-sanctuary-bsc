...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3aD83ce7d8C5bcf8aCdb13c97d9f9103a27b774C; // owner address
...
contract lamboinu is Context, IERC20, Ownable {
    ...
    string private _name = "LAMBOINU";
    string private _symbol = "LAMBOINU";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3aD83ce7d8C5bcf8aCdb13c97d9f9103a27b774C); // Marketing Address
    address payable public teamWalletAddress = payable(0x3aD83ce7d8C5bcf8aCdb13c97d9f9103a27b774C); // Team Address
