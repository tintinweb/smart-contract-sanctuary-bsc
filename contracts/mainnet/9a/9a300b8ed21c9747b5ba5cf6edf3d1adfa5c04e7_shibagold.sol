...
contract shibagold is ERC20, Ownable {
    ...
    constructor() ERC20("shiba gold", "shibgold") {
        marketingWallet = payable(0xcB350249D2357bA5e80FC08963080b0Cc113fc73);
        devWallet = payable(0x3a279d5e43017C1A7db0443daBaC1dA274a715CE);
...
contract shibagoldDividendTracker is DividendPayingToken, Ownable {
    ...
    shibagold public shibagoldContract;
    ...
    constructor(
        ...
        defaultToken = token;
        shibagoldContract = shibagold(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "shibagold_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main shibagold contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(shibagoldContract);

            uint256 prevBalance = shibagoldContract.balanceOf(address(this));
            ...
            {
                uint256 received = shibagoldContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    shibagoldContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
