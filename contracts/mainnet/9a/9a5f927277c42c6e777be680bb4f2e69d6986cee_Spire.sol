...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa9Be448ff20119985bd07D5faFb07988F092da70;
...
contract Spire is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeE586853aB3d2F389806823011fd6DD52CDcb737;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SpireFinance";
    string private _symbol = "SpireF";
