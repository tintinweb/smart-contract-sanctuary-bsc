...
contract RacaMoonZilla is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "RacaMoonZilla";
  string private _symbol = "RacaMoonZilla";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0xD0aC10Ec4F920bE55C2351e6566Aa88aC9eB740A);
  address payable public teamWallet = payable(0xD0aC10Ec4F920bE55C2351e6566Aa88aC9eB740A);
