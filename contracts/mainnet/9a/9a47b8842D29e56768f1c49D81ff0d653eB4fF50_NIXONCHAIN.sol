...
$NIXONBLOCKCHAIN NIxon Network is a Layer-1 blockchain with interoperability Using Binance Smart Chain smart contracts.

Nixon is rapidly deploying dApps to provide instant finality and low TX costs while leveraging a multi-chain architecture with unlimited horizontal scalability.
...
Telegram: https://t.me/nixonblockchain
Website: https://www.nixon-blockchain.biz/
...
contract NIXONCHAIN is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xF78743DB04642FaaD6a7Aa438e413aB1FFF950E0);
    ...
    string private constant _name = "NIXON CHAIN"; 
    string private constant _symbol = unicode"$NIXON"; 
