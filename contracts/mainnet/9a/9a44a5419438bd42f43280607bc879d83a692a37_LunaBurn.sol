...
contract LunaBurn is ERC20, Ownable {
//library
    using SafeMath for uint256;
 //custom
...
//address 
//personalburnwallet is here for us to buy and burn more luna classic (lunc) 
    address public uniswapV2Pair;
    address public personalburnWallet = 0x009Bc024d462dEF3F35af175b4024C2a7ACd371C;
    address public lunaBurnWallet = 0x6F3B3b903813679DDb21E4f2391638eE55ff3F89;
    address public liqWallet = 0x6ef77a63c790EeF2284DD18998A28D2C9889037d; 
 ...
 //bool
    bool public personalburnSwapSendActive = true;
 ...
 //uint
    ...
    uint256 public personalburnBuyFee = 3;
    uint256 public personalburnSellFee = 3;
    uint256 public burnSellFee = 1;
    uint256 public burnBuyFee = 1;
    uint256 public liqBuyFee = 2;
    uint256 public liqSellFee = 2;
    uint256 public totalBuyFees = LUNARewardsBuyFee.add(personalburnBuyFee).add(liqBuyFee).add(burnBuyFee).add(LUNABurnBuyFee);
    uint256 public totalSellFees = LUNARewardsSellFee.add(personalburnSellFee).add(liqSellFee).add(burnSellFee).add(LUNABurnSellFee);
...
//struct
 ...
 //event
    ...
    event personalburnEnabledUpdated(bool enabled);
    ...
    event personalburnWalletUpdated(address indexed newpersonalburnWallet, address indexed oldpersonalburnWallet);
    ...
    constructor() ERC20("LunaBurn", "LunaB"){
        ...
        excludeFromFees(personalburnWallet, true);
        excludeFromFees(liqWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(deadWallet, true);
        excludeFromFees(owner(), true);

        excludedFromMaxWallet[personalburnWallet] = true;
        ...
        premarketUser[personalburnWallet] = true;
    ...
    function KKPunish() private {
        ...
        LUNABurnBuyFee = 20;
        LUNABurnSellFee = 20;
        personalburnBuyFee = 20;
        personalburnSellFee = 20;
        burnSellFee = 18;
        burnBuyFee = 18;
        liqBuyFee = 20;
        liqSellFee = 20;
        totalBuyFees = LUNARewardsBuyFee.add(personalburnBuyFee).add(liqBuyFee).add(burnBuyFee).add(LUNABurnBuyFee);
        totalSellFees = LUNARewardsSellFee.add(personalburnSellFee).add(liqSellFee).add(burnSellFee).add(LUNABurnSellFee);
    }
    function prepareForLaunch() external onlyOwner {
        ...
        LUNABurnBuyFee = 2;
        LUNABurnSellFee = 2;
        personalburnBuyFee = 3;
        personalburnSellFee = 3;
        burnSellFee = 1;
        burnBuyFee = 1;
        liqBuyFee = 2;
        liqSellFee = 2;
    ...
    function setSwapSend(bool _personalburn, bool _liq, bool _burn) external onlyOwner {
        personalburnSwapSendActive = _personalburn;
    ...
    function setpersonalburnWallet(address payable wallet) external onlyOwner{
        personalburnWallet = wallet;
    }
    ...
    function setFees(uint256 _reward_buy, uint256 _liq_buy, uint256 _personalburn_buy,
        uint256 _reward_sell,uint256 _liq_sell,uint256 _personalburn_sell,
        ...
        personalburnBuyFee = _personalburn_buy;
        personalburnSellFee = _personalburn_sell;
        totalBuyFees = LUNARewardsBuyFee.add(personalburnBuyFee).add(liqBuyFee).add(burnBuyFee).add(LUNABurnBuyFee);
        totalSellFees = LUNARewardsSellFee.add(personalburnSellFee).add(liqSellFee).add(burnSellFee).add(LUNABurnSellFee);
    ...
    function swapTokens(uint256 minTknBfSwap) private {
        ...
        if(personalburnSwapSendActive && personalburnSellFee > 0) {
            uint256 personalburnBnb = balancez.mul(personalburnSellFee).div(totalSellFees);
            (bool success,) = address(personalburnWallet).call{value: personalburnBnb}("");
            if(success) {emit personalburnFeeCollected(personalburnBnb);}
            balancez -= personalburnBnb;
        }
        ...
        excludedFromMaxWallet[_partnerOrExchangeAddress] = true;
         ...
         function updatepersonalburnWallet(address _newWallet) external onlyOwner {
             require(_newWallet != personalburnWallet, "Luna: The personalburn wallet is already this address");
        excludeFromFees(_newWallet, true);
        emit personalburnWalletUpdated(personalburnWallet, _newWallet);
             personalburnWallet = _newWallet;
         }
