...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8AfA975257cfD81Df875b1aB43137329A7464Cff;
...
contract BURNGOW is Context, IERC20, Ownable {
    ...
    string private constant _name = "BURN GOW"; // 
    string private constant _symbol = "BURN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 7;
    address payable public  _marketingWallet = payable(0x8AfA975257cfD81Df875b1aB43137329A7464Cff);
