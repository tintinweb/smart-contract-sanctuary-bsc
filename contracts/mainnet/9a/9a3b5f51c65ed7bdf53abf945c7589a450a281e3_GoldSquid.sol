...
contract GoldSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldSquid";
    string private _symbol = "GSQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDFAFf77A47c4eaF965813FDcB8B6b7cD3f22f469); 
    address payable public buyBackWalletAddress = payable(0xDFAFf77A47c4eaF965813FDcB8B6b7cD3f22f469); 
