...
contract USDT_Piggy_Bank {
    ...
    mapping (address => uint256) public hatchCount;
    ...
    function hatchEggs(address ref) public {
        ...
        // increment the hatch count
        hatchCount[msg.sender]++;
    ...
    function sellEggs() public {
        ...
        uint256 fee2=fee/2;
        if(hatchCount[msg.sender] < 6) {
        uint256 earlyFee = (eggValue * 80) / 100;
        eggValue = eggValue - earlyFee;
        marketEggs = marketEggs - earlyFee;}    
        claimedEggs[msg.sender]=0;
        lastHatch[msg.sender]=now;
