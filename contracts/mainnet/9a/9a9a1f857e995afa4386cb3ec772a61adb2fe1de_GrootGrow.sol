...
contract GrootGrow is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "GrootGrow";
   string constant _symbol = "GRTGRW";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x4Fd2E5Dd323d1e8B848f584e4d67655438608343).call{value: BNBMarketingamount, gas: 30000}("");
