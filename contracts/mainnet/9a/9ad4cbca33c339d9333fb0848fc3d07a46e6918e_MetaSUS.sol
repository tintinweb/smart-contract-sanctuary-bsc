...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5ADc54a0bFD10294267c0623c19DD517fEEB3fC;
...
contract MetaSUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaSUS"; // 
    string private constant _symbol = "MetaSUS"; //    
