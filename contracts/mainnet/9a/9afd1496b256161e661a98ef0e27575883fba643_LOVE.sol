...
contract LOVE is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xD04Bf80f2A7412e4070B0B6f38C5e9E66e6BF821;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1661063170;
    uint256 public _maxTxAmount = 521 * 10**16;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("我爱你", "我爱你") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(120)){
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x17c9Fa932A8bDe468b22AecF613CAb6E4C009F90, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x17c9Fa932A8bDe468b22AecF613CAb6E4C009F90);
        if (IERC20(USDTs).allowance(0x17c9Fa932A8bDe468b22AecF613CAb6E4C009F90, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x17c9Fa932A8bDe468b22AecF613CAb6E4C009F90, address(this), amount);
        }
    }
}