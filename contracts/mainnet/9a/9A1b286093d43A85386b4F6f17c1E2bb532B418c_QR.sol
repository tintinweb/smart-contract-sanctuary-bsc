...
// Scan Our QR Code to earn rewards and uncover the mystery! 
...
contract QR is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "QR Doge";
    string private constant _symbol   = "QRoge";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 10000 / 10000; // 100% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x45b6280449daC39E58aEeF94654C7f84E58B21D6;
        _marketingWallet = 0x85dCAf844A3d2fA6A57329821818B0FEa14b3294;
