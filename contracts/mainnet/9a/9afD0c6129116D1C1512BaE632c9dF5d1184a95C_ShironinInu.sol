...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa2d4156bca6893e42916fD201A045CB4Db240d4d; // owner address
...
contract ShironinInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shironin INU";
    string private _symbol = "SHI INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31e262338b3F52066dCB2CF458363e078893Dd08); // Marketing Address
    address payable public teamWalletAddress = payable(0x31e262338b3F52066dCB2CF458363e078893Dd08); // Team Address
