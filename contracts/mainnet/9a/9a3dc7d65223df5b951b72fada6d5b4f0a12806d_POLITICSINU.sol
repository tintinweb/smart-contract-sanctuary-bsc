...
contract POLITICSINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Politics Inu";
    string private _symbol = "Politics";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32c491C91c064f419dd7BA115217118B200564DB); 
