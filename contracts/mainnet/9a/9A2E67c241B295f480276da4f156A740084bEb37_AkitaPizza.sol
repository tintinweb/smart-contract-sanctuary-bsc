...
contract AkitaPizza is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Akita Pizza";
    string private _symbol = "AkitaPizza";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF8CfCb64De1a14A5EFDDb6d46f75735e5Ed4e4d8); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0xF8CfCb64De1a14A5EFDDb6d46f75735e5Ed4e4d8); // BuyBack Address
