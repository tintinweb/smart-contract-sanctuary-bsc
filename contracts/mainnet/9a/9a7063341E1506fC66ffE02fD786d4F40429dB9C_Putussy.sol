...
contract Putussy is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 500 * 10**6 * 10**18;
    uint256 public _maxWalletToken = 2 * 10**9 * 10**18;
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Gay Clown Putin';
    string private _symbol = 'PUTUSSY';
