...
contract BianQue is Context, IERC20, Ownable {   
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bian Que";  
    string private _symbol = "BQ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x040e2E3498b70c08943011f7a1f77c1dECc44288); 
    address payable private teamWalletAddress = payable(0x6C39c74C16863a3F1080bB08e2A1e8f0CD9Ce213); 
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 6**6* 6**_decimals; 
