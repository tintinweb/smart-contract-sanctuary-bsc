...
abstract  contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "SOA: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(
            newOwner != address(0),
            "SOA: new owner is the zero address"
        );
...
contract SOOMA is Context, IBEP20, Ownable {
    ...
    string private _name = "SOOMA";
    string private _symbol = "SOA";
    uint8 private _decimals = 18;

    uint256 public _taxFee = 3;
    address private taxFeeWallet = 0x6D2b556cA76a381d81D884C2DB2F85445751bac2;
    ...
    address private charityWallet = 0x27299Ed609F1DFcCDF4Ba493d3635165b693E031;
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "SOA: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "SOA: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function excludeFromReward(address account) public onlyOwner {
        require(
            account != 0x9C0B62E8535849857933efdAB7772e3E468357ee,
    ...
    function _approve(
        ...
        require(owner != address(0), "SOA: approve from the zero address");
        require(spender != address(0), "SOA: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "SOA: transfer from the zero address");
        require(to != address(0), "SOA: transfer to the zero address");
