...
contract YUMMYToken is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 3 * 10**1 * 10**9;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x3b7812B82230ecB7B60d91Dc26af5Ec889ddcE93, 'We can not exclude Uniswap router.');
