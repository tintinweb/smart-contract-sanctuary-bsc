...
contract TKLS  is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _NAME = "True Kings Legend ";
    string constant _SYMBOL = "TKLS";
    ...
    constructor() {
        ...
        rewardDistributor = IRewardDistributor(0x1a170A1D89D1EadBA7DEECf269576715112630d7);
        _allowances[address(this)][address(rewardDistributor)] = _MAX;
        _allowances[address(rewardDistributor)][address(pcsV2Router)] = _MAX;

        reserveWallet = 0xD514c6c3B54a1ACD3F45415e69c6B0957290F417;
