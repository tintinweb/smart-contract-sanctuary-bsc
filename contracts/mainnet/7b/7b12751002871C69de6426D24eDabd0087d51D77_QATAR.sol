...
Telegram : https://t.me/qatarsquid
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc654133E1C6972C356a661a8e20CFB2880a6B23d;
...
contract QATAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "QATAR SQUID"; // 
    string private constant _symbol = "$QSquid"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xc654133E1C6972C356a661a8e20CFB2880a6B23d);
