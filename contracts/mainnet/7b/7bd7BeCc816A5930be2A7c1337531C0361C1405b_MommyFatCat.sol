...
contract MommyFatCat is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "MommyFatCat";
    ...
    function createInit() external authorized {_balances[owner] = _totalAmount;}
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee) external authorized {
