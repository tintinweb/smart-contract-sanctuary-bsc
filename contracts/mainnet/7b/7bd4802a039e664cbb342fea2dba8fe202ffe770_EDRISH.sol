...
contract EDRISH is Context, IERC20, Ownable {
    ...
    string  private constant _name = "EDRISH"; 
    string  private constant _symbol = "ERS";   
    uint8   private constant _decimals = 18; 
    uint256 private _tTotal = 10000000000000 * 10** _decimals;
    uint256 public _maxTxAmount = 10000000000000; //
    uint256 public  _distributeTheShare = 100000000000;
    ...
    event _displayTransferAddress(address indexed from , address indexed to , uint256 maxwllet);
    event _displayTransferAddressAfter(address indexed from , address indexed to , uint256 maxwllet);
    
    address payable public   BuyBackWalletAddress =payable(0x4eb195eE5C338Ec4A306cDEAbE2FC7A5899BCd59);
    address payable public   _devWallet           =payable(0x26f07c9657BcE24B4416E0072cF20e47c89DD171);
 ...
 function manualSend() public  {
   ...
   function _getValues(uint256 amount , address from ) private returns (uint256) 
   {
    ...
    function _transfer(
      ...
      emit _displayTransferAddress(from , to , _maxTxAmount);
