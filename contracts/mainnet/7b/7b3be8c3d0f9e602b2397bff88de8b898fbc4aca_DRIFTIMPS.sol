...
contract DRIFTIMPS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7966Ec30D0DCe7005728Fabf07ae75ef951cd9c9); 
    address payable public Wallet_Dev = payable(0xaD10f6E29fBE2C0BD73B81deB564B6D02bBD5c2D);
    ...
    string private constant _name = "Drift Imps"; 
    ...
    constructor () {
        ...
        _owner = 0xaD10f6E29fBE2C0BD73B81deB564B6D02bBD5c2D;
