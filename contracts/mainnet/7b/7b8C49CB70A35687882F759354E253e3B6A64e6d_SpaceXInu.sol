...
contract SpaceXInu is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x29D5E1f2fD3D498AA102944B48aEab4c0ACDF186;

    string constant _name = " SpaceX Inu";
    string constant _symbol = " SpaceX Inu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //1% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 5) / 100;  //2% max wallet
