...
/**
 *Baby OnlyChads is giving BUSD rewards to stock up on your OnlyChads, the only token on the block to do so!! find us as babychadsbsc on telegram.
*/
...
/* Token contract */
contract BChads is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Baby Only Chads";
    string constant _symbol = "BCHADS";
