...
/**
Just launch, hype "squid play" we create Squid Arabian. 
ca renounced and lp locked, safe here.

Telegram: https://t.me/squidarabian
...
contract SquidArabian is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Arabian"; // 
    string private constant _symbol = "SQUIDAR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xEC75e8D7E54B89DA38a74604C39B8c9a7E43b010;
