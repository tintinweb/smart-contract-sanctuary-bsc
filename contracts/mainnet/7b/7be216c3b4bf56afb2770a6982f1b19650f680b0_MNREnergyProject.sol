...
contract MNREnergyProject is IERC20 {
    ...
    uint256 constant private startingSupply = 9_999_999;
    string constant private _name = "MNR Energy Project";
    string constant private _symbol = "MNR";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xE49Ed6FF990b9CFD07a9d1953eec95EEd38Ba409),
        development: payable(0x75e7E68ee22Dda719688488a97dfFEc05884EB21)
    });
