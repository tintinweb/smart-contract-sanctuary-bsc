...
contract TestNetToken is IBEP20, Auth {
 
    string private constant _name = "TestNet";
    ...
    uint256 public sellDenomDays = 1;
    ...
    address public oldDBZ = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function triggerDBZBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
