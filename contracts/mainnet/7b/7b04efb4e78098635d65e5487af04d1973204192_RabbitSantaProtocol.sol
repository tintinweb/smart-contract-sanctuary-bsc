...
https://t.me/rabbitsantaprotocol
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE2Eb005bf0E15295A5Ba34cc5e7D43Beb30c6362; // ATOM NETWORK
...
contract RabbitSantaProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Santa Protocol";
    string private _symbol = "RSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xef2cd8737afa978B5f76b63c60cB2AC1b64a5939); // Marketing Address
    address payable public teamWalletAddress = payable(0xef2cd8737afa978B5f76b63c60cB2AC1b64a5939); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 23;
