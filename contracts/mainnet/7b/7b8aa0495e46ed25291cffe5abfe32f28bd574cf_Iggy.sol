...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x654f882968f4B998d353B84eA5F3d4789E36ee57; // owner address
...
contract Iggy is Context, IERC20, Ownable {
    ...
    string private _name = "Iggy Inu";
    string private _symbol = "IGGY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4638a195FF061C681E8139EBA923899C88998300); // Marketing Address
    address payable public teamWalletAddress = payable(0x4638a195FF061C681E8139EBA923899C88998300); // Team Address
