...
contract TestCA is IBEP20, Ownable {
    ...
    string constant _symbol = "TestCA"; // 
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percentage_min_base1000, uint256 _percentage_max_base1000) external onlyOwner {
