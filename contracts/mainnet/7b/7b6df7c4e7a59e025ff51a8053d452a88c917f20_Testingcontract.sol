...
// Testing new contract, dont buy, i will pull liqudity after injected
...
contract Testingcontract is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5898E5A6c89B312B2Be5AE90dB3C204F6050E152); 
    address payable public Wallet_Dev = payable(0x5898E5A6c89B312B2Be5AE90dB3C204F6050E152);
    ...
    string private constant _name = "CONTRACTEST"; 
    string private constant _symbol = unicode"$CONTRACTEST"; 
    ...
    constructor () {
        ...
        _owner = 0xD8Bf97426C2C15033F8CF3B31E49c0e9F3a79fd3;
