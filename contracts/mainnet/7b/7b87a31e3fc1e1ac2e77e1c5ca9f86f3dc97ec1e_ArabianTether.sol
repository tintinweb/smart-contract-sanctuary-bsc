...
/* Token contract */
contract ArabianTether is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x9479c5e1E47Ab037230D8dB7a68b80c8869654a7;
    ...
    // Name and symbol
    string constant _name = "ArabianTether";
    string constant _symbol = "ArabianTether";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 1000000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 1000000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 1000000; // 3%
  ...
  // Sell fees
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 1000000; // 0.25% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA3BAE221A60DC7b7E868a452DD00056B11F26e96;
