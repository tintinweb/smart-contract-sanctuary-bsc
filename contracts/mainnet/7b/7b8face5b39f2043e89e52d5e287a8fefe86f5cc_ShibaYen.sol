...
contract ShibaYen is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x81623A99515Db3DF0959A3F3E3cC2468D927796D); // Marketing Address
    address payable public charityAddress = payable(0xE0e8d321f8eB5A54324D11937bAd536899046Dba); // Charity/Dev Address
    
    address public immutable deadAddress = 0xf6732cbF2db606474248eC1227249a59252Ec8f1;
