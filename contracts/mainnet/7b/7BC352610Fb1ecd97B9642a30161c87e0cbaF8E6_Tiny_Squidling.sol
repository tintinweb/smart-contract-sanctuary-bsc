...
/* Token contract */
contract Tiny_Squidling is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x88479186BAC914E4313389a64881F5ed0153C765; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x86188b2604e3ED5a65Ec71eEe9024B6E09dC5595;
    ...
    // Name and symbol
    string constant _name = "Tiny Squidling";
    string constant _symbol = "TSQ";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 4% or 5M tokens
