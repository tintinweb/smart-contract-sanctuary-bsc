...
interface IDEXRouter {
 ...
 contract Fiberian_Hufky is IBEP20, Auth {
    ...
    string constant _name = "Fiberian Hufky";
    string constant _symbol = "FB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 200; //1%
    ...
    address private marketingFeeReceiver = 0x482A2BE5ffCDBc2a1ee2682379774c98d1c6537f;
    address private developmentFeeReceiver = 0x482A2BE5ffCDBc2a1ee2682379774c98d1c6537f;
