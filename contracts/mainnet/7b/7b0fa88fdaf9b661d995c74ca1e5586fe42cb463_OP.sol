...
// telegram : https://t.me/monkeyDcoin
// low tax 5% 3% to marketing 2% to lp no bot
// i made two contracts which 1 was hit by a bot so i made a new one
...
contract OP is Context, IERC20, Ownable {
    ...
    string private _name = "Monkey D";
    string private _symbol = "MD COIN";
    ...
    address public marketingWallet = 0x0e9D810130799D6a3177C9a9c73d6d1bAF8d7bF6;
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; // 3% of total supply
    uint256 private numTokensSellToAddToLiquidity = 20 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 5 * 10**6 * 10**9; // 3% of total supply
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) public {
        require(maxWalletPercent > 10, "Cannot set transaction amount less than 10 percent!");
