...
/**
BABY FENIX INU IS SET TO OUTPERFORM HIS FATHER ( FENIX INU ) WHO IS CURRENTLY ON $450k MC!!

( BABY FENIX INU - NANOCAP )

SO LETS SUPPORT AND WE WILL DELIVER 🚀🚀🚀
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BabyFenixInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Fenix Inu";
    string private _symbol = "BABY FENIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3957A04f4fCD159a6d550cA17f892bcE35B1551e);
    address payable public devWalletAddress = payable(0x3957A04f4fCD159a6d550cA17f892bcE35B1551e);
