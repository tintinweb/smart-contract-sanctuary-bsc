...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20 (0xa1611E8D4070dee36EF308952CF34255c92a01c5); //$POOP rewards
    ...
    contract PooGirl is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "PooGirl";
    string constant _symbol = "POOPGIRL";
    ...
    uint256 rewardFeeBuy = 3;      //Reward might be turned on later
    uint256 marketingFeeBuy = 7;   //Marketing 
    uint256 devFeeBuy = 0;         //Dev Fee
    uint256 burnFeeBuy = 0;        //Default sends to Dead adress
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x25d98C4d346e4f878ab0260d5F68B9a4e3C1dD9e; //Marketing wallet
        devFeeReceiver = 0x25d98C4d346e4f878ab0260d5F68B9a4e3C1dD9e; //Dev fee
