...
contract SsiStaticNFT is ERC721Enumerable, Ownable {
    ...
    function mint(uint _amt) public {
        ...
        require(token.balanceOf(msg.sender) > amtToPayWithFee, "Make sure you have enough tokens" );
        require(isMintable, "Minting of new NFT is not available now");
        require(_amt <= maxMint, "Not allowed to mint more than 3 NFTs at a time");
