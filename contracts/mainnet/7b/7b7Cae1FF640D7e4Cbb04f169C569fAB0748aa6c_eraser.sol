...
contract Ownership is Context {  
    ...
    */
    ...
    function dismisslimit(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract eraser is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "eraser";
    string private _symbol = "ERASER";
