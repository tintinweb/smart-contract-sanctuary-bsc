...
contract CryptoBusan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crypto Busan";
    string private constant _symbol = "CRYPTO BUSAN";
