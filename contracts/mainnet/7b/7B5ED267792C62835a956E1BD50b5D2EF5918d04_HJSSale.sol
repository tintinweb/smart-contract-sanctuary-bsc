...
abstract contract AbsPreSale is Ownable {
    ...
    constructor(address USDTAddress, address TokenAddress, address CashAddress, address NFTAddress){
        ...
        _saleInfo.push(SaleInfo(90 * usdtDecimals, 30000 * tokenDecimals, 3000, 0));
        _saleInfo.push(SaleInfo(200 * usdtDecimals, 80000 * tokenDecimals, 500, 0));
        _saleInfo.push(SaleInfo(300 * usdtDecimals, 150000 * tokenDecimals, 200, 0));
    ...
    function buy(uint256 saleId) external {
        ...
        if (address(0) != invitor) {
            ...
            uint256 inviteUSDT = price * _inviteFee / 100;
            invitorInfo.inviteUSDT += inviteUSDT;
            _totalInviteUSDT += inviteUSDT;
            _takeToken(_usdtAddress, account, invitor, inviteUSDT);
    ...
    uint256 public _maxClaimNFTNum = 100;
...
contract HJSSale is AbsPreSale {
    constructor() AbsPreSale(
    //USDT
        address(0x55d398326f99059fF775485246999027B3197955),
    //Token
        address(0x5C481d5A806e61BEdefB15476B23661Fd1428640),
    //Cash
        address(0x009d154EB5f6B47bdb60Ca34aFb322a898b573d1),
    //NFT
        address(0xD150d9BC6e8C9C3579f8976074129728C3cd3008)
    ){
