...
contract ClassicGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Classic GROW";
    string private _symbol = "ClassicGROW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD9728791460d8d902351f9DB3861F2C9A6E1809b); // Marketing Address
    address payable public teamWalletAddress = payable(0xD9728791460d8d902351f9DB3861F2C9A6E1809b); 
