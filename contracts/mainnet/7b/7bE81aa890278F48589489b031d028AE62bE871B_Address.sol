...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6C4CCC090b787113aCf25D876141f7104267EB72; // owner address
...
contract Shibaraku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibaraku";
    string private _symbol = "RAKUINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x469036ecb2E24fd3da5ACe61Bd73f751833B2543); // Marketing Address
    address payable public teamWalletAddress = payable(0x469036ecb2E24fd3da5ACe61Bd73f751833B2543); // Team Address
