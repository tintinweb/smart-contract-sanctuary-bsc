...
contract mommybnb  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8889278528Bf89722dBEe45041129e34b8Bc6032); 
    address payable public Wallet_Dev = payable(0x8889278528Bf89722dBEe45041129e34b8Bc6032);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;
    string private constant _name = " Mommy Proof Of Degen";
    string private constant _symbol = " MOMMYBNB2.0";
