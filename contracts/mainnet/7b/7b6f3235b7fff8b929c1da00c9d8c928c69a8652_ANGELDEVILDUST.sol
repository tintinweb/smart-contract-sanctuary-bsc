...
Community telegram for Angel and Devil’s Dust ($ADD)

Portal: https://t.me/angeldevildustHQ
...
contract ANGELDEVILDUST is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'ANGEL DEVIL DUST';
    ...
    //DevWallets
    address public Development=payable(0x181769b27C132Ac6343A538B4EF4412A426B8a71);
    address public Marketing=payable(0x87FE09eb8C03d82da729BF6f91e3dAb7424fE3F4);
    //MainNet
	...
	uint256 private MaxBuy = 150000 * 10**_decimals;
