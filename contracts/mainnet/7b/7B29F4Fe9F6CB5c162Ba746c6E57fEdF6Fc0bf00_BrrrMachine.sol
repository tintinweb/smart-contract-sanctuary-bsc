...
contract BrrrMachine is Token {
    
    uint private startTime = 1644955200; // Tuesday, February 25, 2022 8:00:00 PM GMT
    ...
    uint private constant ADV_FEE           = 10;
    uint private constant ADV_FEESM         = 16;
    uint private constant LIMIT_AIRDROP     = 100000 ether;
    uint private constant MANUAL_AIRDROP    = 220000 ether;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;
        DEV_2 = 0x0933e7B4B121D6Bef36AdF1B3e5977eFD020111c;
        ADV_1 = 0xB17c0beF764Ee4De8F712575F0ee0209B31F976A;         
    ...
    function sellToken(uint tokenAmount) public {
        ...
        uint fee = BUSDAmount.mul(ADV_FEESM).div(PERCENT_DIVIDER);

        BUSDAmount = BUSDAmount - fee;
