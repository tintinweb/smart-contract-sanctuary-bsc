...
contract TTS1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public lpManager = 0xacE5bC68a2f8f1c6Acd8939434D2eb3EF21c3060;
    ...
    constructor()
        ...
        ERC20("TTS1", "TTS1")
    {
        uint256 totalSupply = 420000 * (10**18);
        ...
        _cast(0xb87ac8Dda13A4299d9775Cf1BB17993B42c79105, totalSupply);
    }
