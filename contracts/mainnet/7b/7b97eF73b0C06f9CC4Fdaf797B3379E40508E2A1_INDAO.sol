...
contract INDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "INDAO";
    string private _symbol = "IND";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0E7Ca00cd87967DBCB060921eA4483eaB39F71A7); // Marketing Address
    address payable public teamWalletAddress = payable(0x1F24302B31d530daEaEED6dba8f9Ce17944Be73D); // Team Address
    ...
    uint256 private _totalSupply = 326250 * 10**_decimals;
    uint256 public _maxTxAmount = 326250 * 10**_decimals; 
    uint256 public _walletMax = 326250 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 326250 * 10**12; 
