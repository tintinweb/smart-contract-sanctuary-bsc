...
contract OneDollarShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "1$ Shiba"; // 
    string private constant _symbol = "1$ Shiba"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 15;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xbCa7EBEE3d7F5C9B05Bb9e6756032C816Bf1bC66;
