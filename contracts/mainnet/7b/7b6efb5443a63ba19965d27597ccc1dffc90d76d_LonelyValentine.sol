...
/**
100% stealth launched ! Launched before TG was created, launched unverified, verified after launch.

Your chance for 1000x ! Push this Token as a community ! No bots, no pre pump. 
Because im lonely and i dont have friends who could pre pump my token :(

Spend Valentines with me please.

https://t.me/LonelyValentineStealth
*/
...
contract LonelyValentine is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x2b501e506573270de22390183A1f07f1B637E95D));
    address payable public devWallet =
        payable(address(0x2b501e506573270de22390183A1f07f1B637E95D));
    address public liquidityReceiver =
        0x2b501e506573270de22390183A1f07f1B637E95D;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "My Life Sucks";
    string private _symbol = "LONELY";
