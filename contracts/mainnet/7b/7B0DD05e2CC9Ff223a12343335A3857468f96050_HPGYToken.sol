...
Telegram:
https://t.me/HPGYToken

🌕HPGY TOKEN  🌕
Inspired by the recent AYA Token, Dev planned to launch a gem token with mission to enlighten BSC by becoming top trending token of the month.


Tokenomics:
📦 Total Supply : 1,000,000 (1Million)
💵 Buy Tax : 8%
💰 Sell Tax : 8%
👝 Max Wallet : 3%
...
contract HPGYToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "HPGY Token";
    string private constant _symbol = "HPGY";
    ...
    function getBalances() public virtual {
