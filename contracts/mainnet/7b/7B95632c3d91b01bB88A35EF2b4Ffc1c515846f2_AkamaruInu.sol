...
/**
Woof Akamaru just arrived on BSC and has brought with him the undying wealth of the hidden leaf. 
Many things have already been set in place for this project such as a staking pool and NFTS. 
Our team also has connections with a CEX which will be announced during the first AMA.

10% Tax
2% Max Wallet

TG: https://t.me/akamaruinu_bsc

                                                                                                                                                                                               
   _   _                                       _____             
  /_\ | | ____ _ _ __ ___   __ _ _ __ _   _    \_   \_ __  _   _ 
 //_\\| |/ / _` | '_ ` _ \ / _` | '__| | | |    / /\/ '_ \| | | |
/  _  \   < (_| | | | | | | (_| | |  | |_| | /\/ /_ | | | | |_| |
\_/ \_/_|\_\__,_|_| |_| |_|\__,_|_|   \__,_| \____/ |_| |_|\__,_|
...
contract AkamaruInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AkamaruInu";
    string constant _symbol = "AKI";
    ...
    function blacklist_off(bool _status) public onlyOwner {
        blacklistMode = _status;
    }

    function naughty_list(address[] calldata addresses, bool status) public onlyOwner {
