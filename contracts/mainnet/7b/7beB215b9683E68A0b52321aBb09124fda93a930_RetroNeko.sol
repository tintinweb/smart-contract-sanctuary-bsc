...
contract RetroNeko is ERC20, Ownable {
    struct Fees {
        ...
        uint256 projectFeesPerTenThousand;
        uint256 shortingFeesPerTenThousand;
    }

    address private _router;

    address private _projectWallet;
    address private _shortingWallet;
    ...
    event ProjectBuyFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event ShortingBuyFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event BuyFeesUpdated(
        ...
        uint256 previousProjectFeesPerTenThousand,
        uint256 newProjectFeesPerTenThousand,
        uint256 previousShortingFeesPerTenThousand,
        uint256 newShortingFeesPerTenThousand
    );
    event LiquiditySellFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event ProjectSellFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    event ShortingSellFeesUpdated(
        uint256 previousFeesPerTenThousand,
        uint256 newFeesPerTenThousand
    );
    ...
    constructor(
        ...
        address newShortingWallet
    ) ERC20("RetroNeko", "R-NEKO") {
        _router = newRouter;
        _projectWallet = newProjectWallet;
        _shortingWallet = newShortingWallet;
        ...
        _buyFees.projectFeesPerTenThousand = 500; // 5.00%
        _buyFees.shortingFeesPerTenThousand = 300; // 3.00%

        // Sell fees
        _sellFees.liquidityFeesPerTenThousand = 300; // 3.00%
        _sellFees.projectFeesPerTenThousand = 500; // 5.00%
        _sellFees.shortingFeesPerTenThousand = 300; // 3.00%
        ...
        )
    {
        return (
            ...
            _buyFees.projectFeesPerTenThousand,
            _buyFees.shortingFeesPerTenThousand,
            _totalBuyFees()
        );
    }
        ...
        )
    {
        return (
            ...
            _sellFees.projectFeesPerTenThousand,
            _sellFees.shortingFeesPerTenThousand,
            _totalSellFees()
        );
    }
    ...
    function shortingWallet() external view returns (address) {
        return _shortingWallet;
    }
    ...
    function updateProjectWallet(address payable newWallet) external onlyOwner {
        require(
            newWallet != _projectWallet,
            "RetroNeko: The project wallet already has that address"
        );

        address previousWallet = _projectWallet;
        _projectWallet = newWallet;

        emit ProjectWalletUpdated(previousWallet, newWallet);
    }

    function updateShortingWallet(address payable newWallet)
        external
        onlyOwner
    {
        require(
            newWallet != _shortingWallet,
            "RetroNeko: The shorting wallet already has that address"
        );

        address previousWallet = _shortingWallet;
        _shortingWallet = newWallet;

        emit ShortingWalletUpdated(previousWallet, newWallet);
    }
    ...
    function updateBuyFees(
        ...
        require(
            liquidityFeesPerTenThousand !=
                _buyFees.liquidityFeesPerTenThousand ||
                projectFeesPerTenThousand !=
                _buyFees.projectFeesPerTenThousand ||
                shortingFeesPerTenThousand !=
                _buyFees.shortingFeesPerTenThousand,
        ...
        uint256 previousProjectFeesPerTenThousand = _buyFees
            .projectFeesPerTenThousand;
        _buyFees.projectFeesPerTenThousand = projectFeesPerTenThousand;

        uint256 previousShortingFeesPerTenThousand = _buyFees
            .shortingFeesPerTenThousand;
        _buyFees.shortingFeesPerTenThousand = shortingFeesPerTenThousand;

        emit BuyFeesUpdated(
            previousLiquidityFeesPerTenThousand,
            liquidityFeesPerTenThousand,
            previousProjectFeesPerTenThousand,
            projectFeesPerTenThousand,
            previousShortingFeesPerTenThousand,
            shortingFeesPerTenThousand
        );
    }
    ...
    function updateProjectBuyFees(uint256 feesPerTenThousand)
        external
        onlyOwner
    {
        require(
            feesPerTenThousand != _buyFees.projectFeesPerTenThousand,
            "RetroNeko: Project buy fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _buyFees.projectFeesPerTenThousand;
        _buyFees.projectFeesPerTenThousand = feesPerTenThousand;

        emit ProjectBuyFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }

    function updateShortingBuyFees(uint256 feesPerTenThousand)
        external
        onlyOwner
    {
        require(
            feesPerTenThousand != _buyFees.shortingFeesPerTenThousand,
            "RetroNeko: Shorting buy fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _buyFees
            .shortingFeesPerTenThousand;
        _buyFees.shortingFeesPerTenThousand = feesPerTenThousand;

        emit ShortingBuyFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }
    ...
    function updateSellFees(
        ...
        uint256 previousProjectFeesPerTenThousand = _sellFees
            .projectFeesPerTenThousand;
        _sellFees.projectFeesPerTenThousand = projectFeesPerTenThousand;

        uint256 previousShortingFeesPerTenThousand = _sellFees
            .shortingFeesPerTenThousand;
        _sellFees.shortingFeesPerTenThousand = shortingFeesPerTenThousand;
    ...
    function updateProjectSellFees(uint256 feesPerTenThousand)
        external
        onlyOwner
    {
        require(
            feesPerTenThousand != _sellFees.projectFeesPerTenThousand,
            "RetroNeko: Project sell fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _sellFees
            .projectFeesPerTenThousand;
        _sellFees.projectFeesPerTenThousand = feesPerTenThousand;

        emit ProjectSellFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }

    function updateShortingSellFees(uint256 feesPerTenThousand)
        external
        onlyOwner
    {
        require(
            feesPerTenThousand != _sellFees.shortingFeesPerTenThousand,
            "RetroNeko: Shorting sell fees has already the same value"
        );

        uint256 previousfeesPerTenThousand = _sellFees
            .shortingFeesPerTenThousand;
        _sellFees.shortingFeesPerTenThousand = feesPerTenThousand;

        emit ShortingSellFeesUpdated(
            previousfeesPerTenThousand,
            feesPerTenThousand
        );
    }
        ...
        view
    {
        if (
            ...
            recipient != _projectWallet &&
            recipient != _shortingWallet &&
        ...
        returns (bool)
    {
        return
            ...
            sender == owner() ||
            recipient == owner() ||
            sender == _projectWallet ||
            recipient == _projectWallet ||
            sender == _shortingWallet ||
            recipient == _shortingWallet;
    }
    ...
    function _swapSendFeesAndLiquify() private swapping {
        ...
        uint256 projectEthAmount = (ethAmount * projectFeesPerTenThousand) /
            totalFeesPerTenThousand;
        _sendFeesToWallet(_projectWallet, projectEthAmount);

        uint256 shortingEthBalance = (ethAmount * shortingFeesPerTenThousand) /
            totalFeesPerTenThousand;
        _sendFeesToWallet(_shortingWallet, shortingEthBalance);
