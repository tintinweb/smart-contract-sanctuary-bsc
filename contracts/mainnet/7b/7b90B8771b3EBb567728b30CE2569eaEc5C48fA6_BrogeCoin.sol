...
/*
tg: https://t.me/OfficialBrogeCoin
*/
...
contract BrogeCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "Broge Coin";
    string private _symbol = "BROGE";
    ...
    function _transfer(
        ...
        if (from == pair && to != address(V2router)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == pair && recipient != address(V2router);
