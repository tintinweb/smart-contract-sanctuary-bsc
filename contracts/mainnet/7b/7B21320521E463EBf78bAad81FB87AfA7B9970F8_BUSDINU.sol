...
/**
https://t.me/busdInuBSC - Stealth Launch
*/
...
contract BUSDINU is ERC20, Ownable {
    ...
    constructor() ERC20("BUSD Inu", "BUSDINU") {
		...
		uint256 _buyTax = 300;
		uint256 _sellTax = 700;
 
        uint256 totalSupply = 1 * 1e8 * 1e17;
 
        maxWallet = 3 * 1e7 * 1e18;
        swapTokensAtAmount = 1 * 1e5 * 1e17;

        BuyTax = _buyTax;
		SellTax = _sellTax;
         
		_deployer = address(owner());
        marketingWallet = address(0x4a95E5BA0492A3Be7bC3Ff0742E59Ccf258AfEbc);
