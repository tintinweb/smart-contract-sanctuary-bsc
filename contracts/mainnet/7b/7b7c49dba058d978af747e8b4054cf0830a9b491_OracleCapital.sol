...
World's First Dual Income Rebase With Additional Referral System 
Protocol Rewarding In the native token and in BUSD (Strongest Stable Coin). 
...
Taxes 15% in and 19% out, unchangeable
...
contract OracleCapital is ERC20Detailed, Auth {
    ...
    constructor() ERC20Detailed("OracleCapital", "OC", uint8(DECIMALS)) Auth(msg.sender) {
        ...
        liquidityFund = 0x1bfc3Fb189bBE12D780C96F70d61B5F487F20C08;
        treasuryFund = 0x7305B179086d8CfE6d5D777317Ff42Ca9fe4a8C3;
        insuranceFund = 0x5c9dbd931F6ebBB05135989cce764b559d32DBb4;
        firePit = 0xE57B595F18744742d0c077215B2cB3bc78B9e6fe;
        sellFeeFund = 0x2ab55FD8ddF391db756F01C1fA04AD2104424F99;
