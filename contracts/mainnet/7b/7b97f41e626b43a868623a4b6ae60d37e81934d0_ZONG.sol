...
contract ZONG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb1BBcEc3BE2A37489Ad1e2f07B34a18c57D149C1); // Marketing Address
    ...
    string private _name = "ZONG";
    string private _symbol = "ZONG";
