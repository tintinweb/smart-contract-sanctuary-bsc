 ...
 */
contract NFTExperience is IBEP20, ReentrancyGuard, Context, Ownable {
	...
	string private constant _name         = "NFTExperience";
    string private constant _symbol       = "LordX";
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 5 * 10**8 * 10**_decimals; // 500 Million
	...
	uint256 public buyBurnFee   = 2;  // 2% Fee to Burn wallet on buy
	uint256 public sellBurnFee  = 2;  // 3% Fee to Burn wallet on sell
	uint256 public otherBurnFee = 0;  // 1% Fee to Burn wallet on other transaction

	uint256 public buyRewardsFee   = 2;  // 2% Fee to Rewards wallet on buy
	uint256 public sellRewardsFee  = 2;  // 3% Fee to Rewards wallet on sell
	uint256 public otherRewardsFee = 0;  // 1% Fee to Rewards wallet on other transaction

	uint256 public buyMarketingFee   = 2;  // 4% Fee to Marketing wallet on buy
	uint256 public sellMarketingFee  = 6;  // 3% Fee to Marketing wallet on sell
	uint256 public otherMarketingFee = 0;  // 1% Fee to Marketing wallet on other transaction
	...
	// Dev's wallets
	address payable public constant marketingWallet = payable(0x48AB780d0bC151F063f3dE616B28296fc0Bc3Fc8);
 ...
 * End contract
 * 
 * Developed by NFTExperience dev
 */