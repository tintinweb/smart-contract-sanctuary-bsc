...
contract lronman is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Lron Man";
    string private _symbol = "Lron man";
    ...
    uint256 private _totalDistributionShares = 11;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x45d6688CfEcDFA81A0a84ecDCFA4d0a476159888));
