...
contract MJC is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x1cFB90E05dFB9a3f76C3CF35705C3cf9bD97658e);
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public _devFee = 2;
    address payable public devWallet = payable(0x7B690529Afa28eC52b5e732ca4f77F6a834D751d);
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //testnet
