...
contract TooookenV2 is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function setExpansion(uint256 v) external onlyOwner {
    _mint(msg.sender, v * 10 ** decimals());
  }
