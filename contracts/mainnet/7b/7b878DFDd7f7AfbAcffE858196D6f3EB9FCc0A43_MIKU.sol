...
contract MIKU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF5E00E9108316648cca213e5F19E887d7FA85B62); 
    address payable public Wallet_Dev = payable(0x905aFe2d107919D368Ff6eBB32A21032e29A12a4);
    ...
    uint256 public _maxWalletToken = _tTotal * 250 / 100;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 150 / 100; 
    ...
    constructor () {
        ...
        _owner = 0x905aFe2d107919D368Ff6eBB32A21032e29A12a4;
