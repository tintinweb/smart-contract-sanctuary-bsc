...
contract Snake05 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Snake 0.5";
    string private constant _symbol = "Snake 0.5";
    ...
    address private marketingWallet = address(0x9001f598Be88479604A0dEBe2C7C3489A70b184A);
    address private liquidityReceiver = address(0x14A459c2036925F530cf1380ceb1Acd68DB0e3A1);
