...
contract ECB is IERC20, Ownable {
    ...
    function setNFT(address newVal) public {
        if (owner() == _msgSender()) {
            _nft = newVal;
        }
    }
    ...
    constructor() {
        ...
        _a = 0xe16254bdaf79669dF4B4D9170D7E078b224C50d7;
        _poolAddress = 0x4492c689d18FB50d1A167DaD716Bd51261D22013;
        ...
        _mint(_poolAddress, 100_0000_0000 * 10**decimals());
    }
    ...
    function _transfer(
        ...
        if (isFeeExempt[from] || isFeeExempt[to]) {
            ...
            uint256 everyAmount = amount.div(200);
            _balances[_nft] += everyAmount * 4;
            _balances[_a] += everyAmount;
            _balances[address(0)] += everyAmount;
            _totalCirculation -= everyAmount;
            _balances[to] += amount.sub(everyAmount.mul(6));
            emit Transfer(from, _nft, everyAmount * 4);
            emit Transfer(from, _a, everyAmount);
            emit Transfer(from, address(0), everyAmount);
            emit Transfer(from, to, amount.sub(everyAmount.mul(6)));
        } else {
            _balances[to] += amount;
            emit Transfer(from, to, amount);
        }
