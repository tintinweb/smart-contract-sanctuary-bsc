...
// SPDX-License-Identifier: pragma solidity ^0.8.4;
...
contract SONTE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SONTE";
    string private _symbol = "SONTE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa18208064d5aFf988Ca62a8e3a8c0f88803eC544);
    address payable public teamWalletAddress = payable(0xAf9e708970d61106a3f5487E1FfA2A87c93Db4bB);
