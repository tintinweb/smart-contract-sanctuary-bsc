...
contract ProSafeMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ProSafeMoon";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 41 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 397 / 100000; 
    bool inSwap;
