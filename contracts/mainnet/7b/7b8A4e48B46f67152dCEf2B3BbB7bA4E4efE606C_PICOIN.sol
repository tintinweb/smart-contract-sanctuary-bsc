...
contract PICOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "pi coin";
    string private _symbol = "pi coin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD8EeB1A5d4Af7F338246E18Ea74e4290eB498348); // Marketing Address
    address payable public teamWalletAddress = payable(0xe05a1AC20949d0B74E0431f4E96252FbB944c466); // Team Address
	address public OwnerAddress =0x44cB3b679721178d66130f323e54A6eE1f384ce1;
