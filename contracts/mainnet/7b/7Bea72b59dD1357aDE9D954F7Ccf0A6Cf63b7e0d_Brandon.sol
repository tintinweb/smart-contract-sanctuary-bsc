...
contract DividendDistributor {
    ...
    IERC20 ftm = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD Rewards 
...
contract Brandon is IERC20, Ownable {
    ...
    string constant _name = "Student Loan";
    string constant _symbol = "EDUCATION";

    uint256 public _liquidityFee = 9000; 
    ...
    uint256 public _liquidityFeeSell = 9000; //200
    uint256 public _reflectionFeeSell = 0; //1000
    uint256 public _marketingFeeSell = 650; //800
