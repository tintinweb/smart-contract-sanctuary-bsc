...
WELCOME TO MCKanyeWest

MCKanyeWest - is a crypto meme token, ready to take digital currency by storm. 
As an emerging leader of dog tokens and Shiba Inu coins in the blockchain market, 
MCKanyeWest is a rising star that will unite the crypto community. The mission is
...
pragma solidity ^0.6.12;
    ...
    contract MCKanyeWest is Context, IERC20, Ownable {
        ...
        string private _name = 'MCKanyeWest';
        string private _symbol = 'MCKanyeWest';
