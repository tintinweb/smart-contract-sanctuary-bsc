...
/**
 ...
 Telegram https://t.me/sheepdoginu

*/

/**
 welcome to : Sheepdog Inu
 Telegram : @sheepdoginu
 BASED : Dev
...
contract Sheepdog is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**3 * 10**9;
    string private constant _name = "Sheepdog Inu"; // 
    string private constant _symbol = "SHEEPDOG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 2;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x97E813aeC38B0498d7303a1A4cA7379651B7a73a;
