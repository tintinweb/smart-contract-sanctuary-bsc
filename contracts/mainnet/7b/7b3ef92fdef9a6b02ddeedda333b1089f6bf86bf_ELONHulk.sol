...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa50F2549d221404B9F74fD96905570C66e1aFA57; // owner address
...
contract ELONHulk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON Hulk";
    string private _symbol = "ELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa50F2549d221404B9F74fD96905570C66e1aFA57); // 
    address payable public teamWalletAddress = payable(0xa50F2549d221404B9F74fD96905570C66e1aFA57); // 
