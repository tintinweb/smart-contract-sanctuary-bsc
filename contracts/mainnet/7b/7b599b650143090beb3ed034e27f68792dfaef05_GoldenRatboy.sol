...
contract GoldenRatboy   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Golden Ratboy ";
    string private _symbol = " $GRB "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE63C020501F75cB70db595E09b60F4059F92624C); 
    address payable public teamWalletAddress = payable(0xE63C020501F75cB70db595E09b60F4059F92624C); 
