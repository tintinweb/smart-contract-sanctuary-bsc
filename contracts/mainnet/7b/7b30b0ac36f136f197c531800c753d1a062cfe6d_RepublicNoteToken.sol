...
Republic Note (Investment)
The Republic Note is a profit sharing token. 
It’s an investment in us and the success of our business and future."
...
contract RepublicNoteToken is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Republic Note';
    string private _symbol = 'Republic Note';
