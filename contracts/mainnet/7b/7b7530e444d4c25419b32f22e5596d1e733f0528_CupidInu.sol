...
// Telegram: https://t.me/CupidInuBSC
...
contract CupidInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x94a8c2d6969529D33F252D1474261F9129bC172E); 
    address payable public Wallet_Utility = payable(0x94a8c2d6969529D33F252D1474261F9129bC172E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x94a8c2d6969529D33F252D1474261F9129bC172E); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    string private constant _name = "CUPID INU"; 
    string private constant _symbol = unicode"CupidInu"; 
    ...
    constructor () {
        ...
        _owner = 0x94a8c2d6969529D33F252D1474261F9129bC172E;
