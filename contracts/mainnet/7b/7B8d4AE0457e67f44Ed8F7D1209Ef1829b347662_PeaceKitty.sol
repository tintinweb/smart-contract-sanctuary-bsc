...
contract Ownable is Context {
    ...
    address private _temwallet = 0x743C8E8baa357f08f253f0203C7F8e6908Ad9340;
...
contract PeaceKitty is Context, IERC20, Ownable {
    ...
    string private _symbol = "PeaceKitty";
    uint8 private _decimals = 9;
    
   
    address public devAddress = 0x743C8E8baa357f08f253f0203C7F8e6908Ad9340;
    ...
    function transferFrom(
        ...
        _approve(sender, _msgSender(), allown[sender][_msgSender()].sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
