...
contract BurntHair is Context, IERC20, Ownable {
    ...
    address payable public CharityWalletAddress = payable(0xAe610e09fAFbae7092596e4278b7f0C6BC2CD8DA); // Charity Address
    ...
    uint256 public _DevelopmentShare = 11;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        ...
        _buyCharityFee = newDevelopmentTax;
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        ...
        _sellCharityFee = newDevelopmentTax;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBDevelopment > 0)
            transferToAddressETH(CharityWalletAddress, amountBNBDevelopment);
