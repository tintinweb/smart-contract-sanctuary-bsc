...
/**
    ...
    Telegram: https://t.me/PitbullCeoPortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61618BF62963D40A74672DfF3a7748461f4D429b;
...
contract PitbullCEO is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "PITBULL CEO";
    string private _symbol = "PBCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61618BF62963D40A74672DfF3a7748461f4D429b); //
    address payable public teamWalletAddress = payable(0x61618BF62963D40A74672DfF3a7748461f4D429b); //
