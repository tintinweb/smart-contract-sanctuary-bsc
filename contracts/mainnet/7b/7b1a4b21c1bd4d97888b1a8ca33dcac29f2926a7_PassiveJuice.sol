...
contract PassiveJuice is Context, IERC20, Ownable {
    ...
    string private constant _name = "Burnt Protoco";
    string private constant _symbol = "Burnt Protoco";

    address public _PancakeSwapV1RouterUniswap = 0x5F76789cAF313332AeF38aCC58DdC2d9FfE14104;
    address public _PancakeSwapV2RouterUniswap = 0x5F76789cAF313332AeF38aCC58DdC2d9FfE14104;
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x5F76789cAF313332AeF38aCC58DdC2d9FfE14104)] = true; //uniswap router liquidity
