...
contract pikamcdonalds is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "pika mcdonald's";
    string constant _symbol = "pkmc";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xBD2B8C1637d6E213640554dE50542a949c739783;
