...
library Address{
 ...
 contract PrideToshi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2e8 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 6000000 * 10**9;
    uint256 public maxBuyLimit = 6000000 * 10**9;
    uint256 public maxSellLimit = 6000000 * 10**9;
    uint256 public maxWalletLimit = 6000000 * 10**9;
    
    uint256 public genesis_block;

    address public marketingWallet = 0x4B9Bce16d2B611721B9025300558EA8A0CfBdD28;
    address public donationWallet = 0x4B9Bce16d2B611721B9025300558EA8A0CfBdD28;

    string private constant _name = "PrideToshi";
    ...
    Taxes public taxes = Taxes(2, 4, 2, 1);
    Taxes public sellTaxes = Taxes(2, 4, 2, 1);
