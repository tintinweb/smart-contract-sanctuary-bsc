...
contract UTORRENTINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "uTorrent Inu";
    string private _symbol = "UTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC59d852bd9b06a9823d9ED4796f2d17363d229F2); 
    address payable public buyBackWalletAddress = payable(0x2d86253E572BE1E21b982bAD2b76b7b9d65A1406); 
    ...
    uint256 private minimumTokensBeforeSwap = 900 * 10**9; 
