...
/**
   Hey guys, i just created this token for the BSC community and show
   the power of the degens of BSC to everyone. I will burn the LP when i see a great community
gathering and shilling around all socials. Max Tx will be low and taxes at launch will be high.
I will reduce the taxes to 2/2 which will be used for LP and BUSD Rewards. I will pay for marketing from my own pocket if needed.
If you want me to reveal and show you guys who i am, show me your power. See you in the next message.
*/
...
contract PowerOfBSC is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x498E846EeCB399764bb1A09641547bD183D4e1f6;

    string constant _name = "PowerOfBSC";
