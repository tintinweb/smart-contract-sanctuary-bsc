...
contract ShitGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shit-Grow";
    string private _symbol = "SHITG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0a0d9D1cce6fc818aFf0729AadBe400f29Bca9C9); // Marketing Address
    address payable public teamWalletAddress = payable(0xa8072b788666D8cd825A61985B152186606d5019); // Team Address
