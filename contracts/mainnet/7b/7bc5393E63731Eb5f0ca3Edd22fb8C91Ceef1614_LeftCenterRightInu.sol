...
contract LeftCenterRightInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Left Center Right Inu";
    string private _symbol = "ELON";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xA2EAe6b2524611129Cb2aA62AB16EF7CA56fB280);
