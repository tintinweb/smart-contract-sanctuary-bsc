...
We introduce a project with 10x more potential and has a bullish name in 2022, join our journey now!

Liquidity Locked (60D) 
Renounced the ownership
Massive Marketing
Unique McQueen Nfts
McQueen Nft Marketplace
Verified Contract
our target is 50k tonight!




    Official twitter
    https://twitter.com/McQueen_Inu

    Telegram Mcqueen
    https://t.me/Mcqueen_Inu
...
contract McQueenInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x12DAe3BB1fcB13bCCf9a1038B8C4baa791f97979));


    string private _name = "McQueen Inu";
    string private _symbol = "McQueen";
