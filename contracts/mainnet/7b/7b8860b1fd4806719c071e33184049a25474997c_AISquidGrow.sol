...
TELEGRAM : https://t.me/aisquidgrowportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBD0F805B911Df5B12dFdC3A9e0731e26F47a685c; // owner address
...
contract AISquidGrow is Context, IERC20, Ownable {
    ...
    string private _name = " AI SquidGrow";
    string private _symbol = " AISG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBD0F805B911Df5B12dFdC3A9e0731e26F47a685c); // Marketing Address
    address payable public teamWalletAddress = payable(0xBD0F805B911Df5B12dFdC3A9e0731e26F47a685c); // Team Address
