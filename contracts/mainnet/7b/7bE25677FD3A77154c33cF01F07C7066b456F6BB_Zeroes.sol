...
contract Zeroes is Context, IERC20, Ownable {
    ...
    string private constant _name = "Zeroes";
    string private constant _symbol = "ZZ0";
    ...
    function setTransferTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity) public onlyOwner {
        require(_rfi+_marketing+_liquidity <= 35, "Max fee is 35%");
