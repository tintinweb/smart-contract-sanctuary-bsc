...
contract Fistiana is FistianaDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private FistianaTeam;
    address private CharityFistiana;
    ...
    string public override name = "Fistiana";
    string public override symbol = "FCT";
    ...
    constructor(uint totalSupplyValue, address FistianaTeamAddress, address CharityFistianaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        FistianaTeam = FistianaTeamAddress;
        CharityFistiana = CharityFistianaAddress;
       
        // split the tokens according to agreed upon percentages
        balances[FistianaTeam] =  totalSupply * 4 / 100;
        balances[CharityFistiana] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's FistianaTeam pot
