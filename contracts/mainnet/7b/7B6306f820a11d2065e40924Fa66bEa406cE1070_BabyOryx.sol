...
/**
      ...
      Telegram - https://t.me/babyoryx_portal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ORYX = IBEP20(0x10bb58010CB58e7249099eF2efdFfe342928B639);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ORYX.balanceOf(address(this));
        ...
        uint256 amount = ORYX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            ORYX.transfer(shareholder, amount);
...
contract BabyOryx is IBEP20, Auth {
    ...
    address constant ORYX = 0x10bb58010CB58e7249099eF2efdFfe342928B639;
