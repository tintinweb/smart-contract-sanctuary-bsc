...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb14b4cF1FC1beDE237D34c8c001ef17e45e9C457;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb14b4cF1FC1beDE237D34c8c001ef17e45e9C457;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyDogepunk";
    string private _symbol = "BDOGEPUNK";
