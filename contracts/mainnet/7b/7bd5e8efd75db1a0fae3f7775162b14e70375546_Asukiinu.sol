...
/*  
		...
		Asuki Inu NFT and more products we will release at launch, 
		looking for long term sustainable growth of the Asuki Inu ecosystem.
        Initial LP: 2 BNB LOW TAX:5/5 OWNERSHIP RENOUNCED
        Telegram: https://t.me/asukiinuportal
        Website : http://asukiinu.io/
        The project party reserves 5%  
        LOW TAX:5/5
        2LP 3Marketing  LOW TAX
    Telegram :https://t.me/asukiinuportal
    Website  :http://asukiinu.io/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5CEcC2A9e18bC14E62fCF9e54a92a94847A33619; 
...
contract Asukiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Asuki inu";
    string private _symbol = "AKINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5E301F12e98CDE0aDb23250FEa9461ad63071e0); // 
    address payable public teamWalletAddress = payable(0xc5E301F12e98CDE0aDb23250FEa9461ad63071e0); // 
