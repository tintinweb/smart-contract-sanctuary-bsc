...
/*
    HUGE INU - THE FIRST HULK DOGE WILL COME IN HUGE AND ANGRY! $HUGE is a token of community , make our community strong so the hulk will be anger than anything.

    TG: https://t.me/HugeInuBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5FC7Cecf265BA1D490dB3085b1bCd8a9A2361B1D; 
...
contract HugeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Huge Inu ";
    string private _symbol = " $HUGE ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5FC7Cecf265BA1D490dB3085b1bCd8a9A2361B1D); // 
    address payable public teamWalletAddress = payable(0x5FC7Cecf265BA1D490dB3085b1bCd8a9A2361B1D); // 
