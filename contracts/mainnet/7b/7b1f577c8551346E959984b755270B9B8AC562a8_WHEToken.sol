...
contract WHEToken is IBEP20, Ownable, InviteReward {
    ...
    string constant  _name = "WHE";
    string constant _symbol = "WHE";
      ...
      uint256 contractTokenBalance = _balances[address(this)];
        ...
        if(recipient == uniswapV2Pair) {      
            if(!isExcluded(sender)) {    
                ...
                {   
                     if(nft_pool != address(0x0)){
                         uint256 nft_number = onepercent.mul(20);
                            _balances[nft_pool] = _balances[nft_pool].add(nft_number);
                    ...
                    uint256 pool_number = onepercent.mul(100); 
                    if(SwapForUsdt == 1){
