...
contract SICFI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sickonolfis";
    string private _symbol = "SICFI";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x4960F988234ffe460822f7684Eddf5161249aC0a, 'We can not exclude Uniswap router.');
