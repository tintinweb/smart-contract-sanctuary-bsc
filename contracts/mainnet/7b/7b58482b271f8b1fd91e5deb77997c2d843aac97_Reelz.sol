...
contract Reelz is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 15_000_000 * 10**18;
    ...
    Taxes public sellTaxes = Taxes(6, 2);
    ...
    function bulkAddSnipers(address[] memory accounts, bool state) external onlyOwner {
        //Limit this function to first 30mins after launch
        require(block.number < genesis_block + 600, "Can't be used anymore!");
        for (uint256 i = 0; i < accounts.length; i++) {
