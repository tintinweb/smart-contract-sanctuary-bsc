...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD Reward
...
contract PUSHINPI is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private _name = 'PushinPi';
    string private _symbol = 'PushinPi';
    ...
    uint256 public sT = 300000000 * (10 ** _decimals); //
    bool LFG = false;
