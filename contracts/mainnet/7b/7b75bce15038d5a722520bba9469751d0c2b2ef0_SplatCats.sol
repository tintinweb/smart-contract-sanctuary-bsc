...
/**
 * @title Splat Cats contract.
 * @author The Eternal Klay team.
 *
 ...
 */
contract SplatCats is ERC721A, Ownable {
    using Strings for uint256;
    ...
    /// @notice The current price to mint one Splat Cat - price in WEI = 0.50 BNB
    uint256 public _currentPrice = 500000000000000000;
    ...
    constructor(
        string memory placeholderURI, address launchpad, uint256 maxSupply
    ) ERC721A("Splat Cats", "SC") {
