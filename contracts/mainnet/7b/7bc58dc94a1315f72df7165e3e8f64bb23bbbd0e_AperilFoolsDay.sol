...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    /**
        12% CARDANO reflection on internal tx back to holder
...
contract AperilFoolsDay is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 17;
  uint256 public _feeReflections = 12;
  uint256 public _feeHolders = 2;
  uint256 public _feeLiq = 3;
  uint256 public _maxTX = 25;
  

  constructor() public {
    _totalSupply = 10 * 10**8 * 10**12;
