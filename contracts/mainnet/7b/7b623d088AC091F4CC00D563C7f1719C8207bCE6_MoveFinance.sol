...
Move Finance is an innovative platform for m2e

We are very unique so we can beat the market

*Website: https://movefinancebsc.com
...
contract MoveFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoveFinance";
    string private constant _symbol = "Move";

    address payable private _developmentAddress =
        payable(0x29b20DA083B723324d9d7c19ebC18E1bD19BD378);
