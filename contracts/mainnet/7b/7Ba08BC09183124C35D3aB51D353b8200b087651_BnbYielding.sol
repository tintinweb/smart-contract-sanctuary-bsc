    ...
    import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";
        ...
        contract BnbYielding is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
            ...
            function withdraw() external NonBlackListed whenNotPaused whenNotSafeLiqEnabled nonReentrant { 
                ...
                uint256 timeEndBG = (investorvip.time_end - 1649904471) / 86400;
                if (timeEndBG >= 26 && timeEndBG <= 65) {
                    uint256 timeEndBGTarif = (investorvip.time_end - investorvip.checkpointDep) / 259200;
                    investorvip.time_end = investorvip.checkpointDep + (timeEndBGTarif * 86400);
                } else if (timeEndBG >= 66 && timeEndBG <= 172) {
                    uint256 timeEndBGTarif2 = (investorvip.time_end - investorvip.checkpointDep) / 604800;
                    investorvip.time_end = investorvip.checkpointDep + (timeEndBGTarif2 * 86400);
                }
