...
contract GreedSnake2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GreedSnake2";
    string private _symbol = "GreedSnake2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE5061FeF759ec13206d7d945645677265fD9B034);
    address payable public teamWalletAddress = payable(0xE5061FeF759ec13206d7d945645677265fD9B034);
