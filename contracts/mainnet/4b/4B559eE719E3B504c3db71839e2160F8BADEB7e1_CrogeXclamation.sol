...
_______  ______    _______  _______  _______  __   __   __  
|       ||    _ |  |       ||       ||       ||  | |  | |  | 
|       ||   | ||  |   _   ||    ___||    ___||  | |  | |  | 
|       ||   |_||_ |  | |  ||   | __ |   |___ |  | |  | |  | 
|      _||    __  ||  |_|  ||   ||  ||    ___||__| |__| |__| 
|     |_ |   |  | ||       ||   |_| ||   |___  __   __   __  
|_______||___|  |_||_______||_______||_______||__| |__| |__|                                                                                                                                                                                                      
*/
...
contract CrogeXclamation is Ownable, IBEP20 {
    using SafeMath for uint256;
