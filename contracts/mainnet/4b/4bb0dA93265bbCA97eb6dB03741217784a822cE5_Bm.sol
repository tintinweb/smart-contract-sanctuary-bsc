...
contract Bm is Context, IERC20, Ownable {
    ...
    address public devAddress = address(0xeC0ceD6bA7Cd2db18bd18759862Bb4eACdca8fb0);
    ...
    function settaxFeePercent(uint256 taxFee , uint256 liquidityFee , uint256 devFee) external onlyOwner() {
        _taxFee = taxFee;
        _liquidityFee = liquidityFee;
        _devFee = devFee;
    }
