...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    NFTTokens nftTokens = NFTTokens(0xE513ec1BB74C6BFaCb5F7bfDC217b3Dd607984DD);
    ...
    constructor(
        ...
        //黑洞地址
        holdAddress = 0x0000000000000000000000000000000000000001;
        ...
        //营销钱包费率
        nftFee = 5;
        totalFees = tokenRewardsFee.add(holdFee).add(nftFee);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                fees += amount.mul(1).div(1000);
            }
            amount = amount.sub(fees);

            try nftTokens.doGenesisProfit(fees / 10)  {} catch {}
            super._transfer(from, address(nftTokens), fees / 10); 
            super._transfer(from, holdAddress, fees * 2 / 5); 
    ...
    //设置nft地址
    function setNFTTokens(address _target) external onlyOwner{
        nftTokens = NFTTokens(_target);
    }
    //设置交易开关
