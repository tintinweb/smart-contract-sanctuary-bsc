...
contract WienerInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9A11EDB25019EB269FD2C7632D7C53ac8B659EAA); 
    address payable public Wallet_Dev = payable(0x9A11EDB25019EB269FD2C7632D7C53ac8B659EAA);
    ...
    string private constant _name = "WienerInu"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 2 / 100; // max wallet 2%
    ...
    constructor () {
        ...
        _owner = 0x9A11EDB25019EB269FD2C7632D7C53ac8B659EAA;
