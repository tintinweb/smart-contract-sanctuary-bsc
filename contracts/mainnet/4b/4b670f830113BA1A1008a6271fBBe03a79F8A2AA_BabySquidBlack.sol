...
/* Token contract */
contract BabySquidBlack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe2bA3443D862e08d202a8f5E77423E1a075F5b6c;
    ...
    string constant _symbol = "$BABYSBLACK";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 4% on launch 
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 4% 
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 4% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe2bA3443D862e08d202a8f5E77423E1a075F5b6c;
