...
Telegram: https://t.me/SagitariusProtocol
...
contract SAG is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150e6 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 1_500_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 150_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 150_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 150_000_000 * 10**_decimals;
    ...
    string private constant _name = "Sagittarius Protocol";
    string private constant _symbol = "SAG";
    ...
    // Owner cannot transfer out SAG from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SAG!");
