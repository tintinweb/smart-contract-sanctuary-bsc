...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xF33b6B3DD26EE0B7c0Ba1Ce3239A1Ce15B94934C); //Hurricane
...
contract BabyHurrican is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Hurricane";
    string constant _symbol = "Baby Hurricane";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1415F3Bd4527c6db625BDdf5B9886C91E80111b7;
