...
contract MouseInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mouse Inu";
    string constant _symbol = "MouseInu";
    ...
    uint256 public swapThreshold = _totalSupply * 34834766 / 10000000000; // 0.15% of supply
    bool inSwap;
