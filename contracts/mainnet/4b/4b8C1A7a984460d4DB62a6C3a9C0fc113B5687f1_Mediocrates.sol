...
/*
 https://twitter.com/elonmusk/status/1571337302416437252?s=20&t=pUK_ZfSjnwsZLn0eqi1xlg
*/
...
contract Mediocrates is Context, IERC20, Ownable {
    ...
    uint256 private _sellMarketingFee = 7;   // Markting Fee 5%
    ...
    constructor() {
        _name = "Mediocrates"; //  Name
        _symbol = "CRATES"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000 * 10**_decimals; // Total Supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 5000000000 * 10**_decimals;  
        _maxTxAmount = 10000000000 * 10**_decimals; // 1% Of Total Supply
        _maxWalletBalance = 10000000000 * 10**_decimals; // 1% Of Total Supply 
        _marketingWalletAddress = 0x6B981A18755C3A4d2Bc873A4f16fdD9D66F874eD; // Marketing Wallet 
        _devWalletAddress = 0x6B981A18755C3A4d2Bc873A4f16fdD9D66F874eD; // Dev Wallet 
