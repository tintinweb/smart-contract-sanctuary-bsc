...
contract luckybnb is Context, IERC20, Ownable {
    ...
    string private _name = " Lucky Proof Of Degen";
    string private _symbol = " LUCKYBNB2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3f9aBDAA6BA3698cF76F93999C71E37FD1B8A70);
    address payable public buyBackWalletAddress = payable(0xF3f9aBDAA6BA3698cF76F93999C71E37FD1B8A70);
    ...
    function setTxLimit(uint256 txLimit) public {
