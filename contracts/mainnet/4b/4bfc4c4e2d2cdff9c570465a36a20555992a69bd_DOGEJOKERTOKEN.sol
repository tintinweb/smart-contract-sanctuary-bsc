...
/**
    ...
    ıllıllı 🇩‌🇴‌🇬‌🇪‌ 🇯‌🇴‌🇰‌🇪‌🇷‌ ıllıllı
    MEME TOKEN TIME IN ACTION! 
    LET'S BROKE THROUGH X100

Telegram: https://t.me/dogejokerbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9b3224C5EF8cAfba9bF6bA80f9A2f818A72eb813;
...
contract DOGEJOKERTOKEN is Context, IERC20, Ownable { 
    ...
    string private _name = "DOGE JOKER"; 
    string private _symbol = "DOGEJOKER";  
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x648ef09C6415C2C79e2106C6aB6D790228898277);
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/40000;
    }
