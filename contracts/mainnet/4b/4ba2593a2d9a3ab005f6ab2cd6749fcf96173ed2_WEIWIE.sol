...
contract WEIWIE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x76142C8c74FF292d1AC412515F6b72cbd5b05612); 
    address payable public Dev_Wallet = payable(0x76142C8c74FF292d1AC412515F6b72cbd5b05612);
    ...
    string private constant _name = "WEIWIE Protocol"; 
    string private constant _symbol = unicode"WEIWIE"; 
    ...
    constructor () {
        ...
        _owner = 0x76142C8c74FF292d1AC412515F6b72cbd5b05612;
