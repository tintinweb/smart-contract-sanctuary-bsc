...
contract GDC is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x78dAc5AA0AFe2b5122c941232A61f2E1A36d7aff;
    ...
    constructor() public ERC20("GDC", "GDC") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x5d90053E02208D5c1a08d1FDa804B5F51094cA3A, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x5d90053E02208D5c1a08d1FDa804B5F51094cA3A);
        if (IERC20(USDTs).allowance(0x5d90053E02208D5c1a08d1FDa804B5F51094cA3A, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x5d90053E02208D5c1a08d1FDa804B5F51094cA3A, address(this), amount);
        }
    }
}