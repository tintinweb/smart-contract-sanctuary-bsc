...
*/
 ...
 /** ✳️ SAKAZUKI INU 🔥
    ...
    SUPER STEALTH LAUNCH BY UNKNOWN APE TEAM!! ✳️


    SAKAZUKI INU is a decentralized token project on the BSC network.

    Anime season has arrived and so has SAKAZUKI INU.  


    Private portal: https://t.me/+UOjL91xl7pI3ODUYSZx
...
contract SakazukiINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sakazuki Inu";
    string private constant _symbol = "$SAKAZU";
    ...
    address private marketingWallet = address(0x669368E54F24395114E4a7ED54f1DCff6Ed578d3);
    address private liquidityReceiver = address(0x669368E54F24395114E4a7ED54f1DCff6Ed578d3);
