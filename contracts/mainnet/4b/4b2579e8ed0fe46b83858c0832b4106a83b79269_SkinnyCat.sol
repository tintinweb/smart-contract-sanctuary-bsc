...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50a871BA38F060DF47D3125ef93f2a1952546c77; 
...
contract SkinnyCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Skinny Cat";
    string private _symbol = "SKCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87B63032b5c0636304Fff38a70ed0557ed12E4A8); // 
    address payable public teamWalletAddress = payable(0x7e4e76989F50e2629440D8C9f19dDf62E11659f2); // 
