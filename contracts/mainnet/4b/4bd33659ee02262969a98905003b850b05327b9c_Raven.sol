...
contract Raven is Context, IERC20, Ownable {
    ...
    string private _name = "Raven Inu";
    string private _symbol = "RAVEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x589DDddecdF597971dF328113A3deE7bD32DAeDe); 
    address payable public buyBackWalletAddress = payable(0x4EF497bBd72c2b82CeD64D44C71a5e5033e90366); 
