...
// CHANGE
contract MuunerInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "$MUUNER";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x63467D81B63AD18b2Af4C34baBD941c24F79b702);
