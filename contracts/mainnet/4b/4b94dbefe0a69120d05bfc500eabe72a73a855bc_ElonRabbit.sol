...
contract ElonRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "Elon Rabbit";
    ...
    address payable public marketingWalletAddress = payable(0x074F2c7D1c51b39c00E21099ACabf86b747eb233); // Marketing Address
    address payable public teamWalletAddress = payable(0x6180168179e29FD63b8d96234f723601f298bE77); // Team Address
