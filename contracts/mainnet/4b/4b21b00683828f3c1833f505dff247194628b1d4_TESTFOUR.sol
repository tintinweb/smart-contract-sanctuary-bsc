...
contract TESTFOUR is Context, IERC20, Ownable {
    ...
    string private _name = "TESTFOUR";
    string private _symbol = "TESTV4";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x774b09579bb981bF2F1E16785915742C65Dd7148);
