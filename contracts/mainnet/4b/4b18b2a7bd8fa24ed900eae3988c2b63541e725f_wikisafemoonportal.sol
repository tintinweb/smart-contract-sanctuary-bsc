...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf7DF2bE121d9E69e1dD0a638bBaADBdF21B04b5;
...
contract wikisafemoonportal is Context, IERC20, Ownable {
    ...
    string private constant _name = "WIKI SAFEMOON"; // 
    string private constant _symbol = "WKS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0xAf7DF2bE121d9E69e1dD0a638bBaADBdF21B04b5);
