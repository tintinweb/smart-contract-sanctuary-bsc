...
contract WienerDogs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiener Dogs";
    string private _symbol = "Wieners";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x837C651925d99Adf270E03fcd556c4Bd27A0b7b7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x837C651925d99Adf270E03fcd556c4Bd27A0b7b7); // BuyBack Address
