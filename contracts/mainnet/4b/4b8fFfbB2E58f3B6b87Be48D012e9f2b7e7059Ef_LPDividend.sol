...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, usdtBalance / 5);
        USDT.transferFrom(address(_tokenDistributor), address(this), usdtBalance * 4 / 5);
    }
    ...
    function processLP(uint256 gas) private {
        if (progressLPBlock + 20 > block.number) {
            return;
        }
...
contract LPDividend is AbsToken {
    constructor() AbsToken(
        ...
        18,
        588,
        address(0x1877C28C9222E87658323EBE47B7533bd7aE7436)
    ){
