...
contract LetsGetDollar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LetsGetDollar";
    string private _symbol = "LGD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCe07859650D690e2eD99Be16b1b0b113d12C26C2);
    address payable public DevWalletAddress = payable(0x754b1D8eA1d8cEbDf6ccA77b4dE524cb084d35bE);
