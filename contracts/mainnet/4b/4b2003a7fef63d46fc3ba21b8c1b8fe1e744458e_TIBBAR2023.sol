...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8589d4B6ad00137B1a79f32625bb3AF39c16a72f;
...
contract TIBBAR2023 is Context, IERC20, Ownable {
    ...
    string private constant _name = "TIBBAR 2023"; // 
    string private constant _symbol = "TIBBAR2023"; //    
    uint8 private constant _decimals = 9; // 
    uint256 public MaxFee = 15;
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x8589d4B6ad00137B1a79f32625bb3AF39c16a72f);
