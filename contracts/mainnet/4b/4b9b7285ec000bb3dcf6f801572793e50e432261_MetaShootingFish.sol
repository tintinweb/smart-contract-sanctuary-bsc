...
Meta Shooting Fish - Hyper Reflection Token ft Play to Earn gaming project
...
contract MetaShootingFish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDEA0B633Fd8B79d8dDc596ab9179a922Df2F420A); // Marketing Address
    ...
    string private _name = "Meta Shooting Fish";
    string private _symbol = "MSF";
    ...
    uint256 public buyBackSellLimit = 5 * 10**6;
