...
contract cpy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "\u9648\u57f9\u9065";
    string private _symbol = "\u9648\u57f9\u9065";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4CB41a11B32c02ec2D8C8C09fe3F1fA01BaE3F2e); 
    address payable public BurnedWalletAddress = payable(0x4CB41a11B32c02ec2D8C8C09fe3F1fA01BaE3F2e); 
