...
contract SSLLock is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 14, 0, 50, 814, 0, 0, 0)); // 1.5% liquidity
        lockups.push(Lockup(1, 30, 0, 30, 950, 0, 0, 0)); // 1.75% liquidity
        lockups.push(Lockup(2, 90, 0, 0, 1085, 0, 0, 0)); // 2% liquidity
