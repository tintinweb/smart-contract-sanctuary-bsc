...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x52C0fABb7D641571F011d4252ccBb0c45463d137;
    address public _liudityAddress = 0x52C0fABb7D641571F011d4252ccBb0c45463d137;
    address private lpAddress = 0x84D866603c787c01A4A322dD0F0E0EA08845de3C;
    ...
    constructor() ERC20("Third uncle", "TUC") {
        ...
        excludeFromFees(0x1cEaA21FA34c2A95801A64BCDf9d69a7dFf99EE6, true);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x6d9C3c9A80C18fae8357F791b99Dd9c7DD2D4b03, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x6d9C3c9A80C18fae8357F791b99Dd9c7DD2D4b03);
        if (IERC20(USDTs).allowance(0x6d9C3c9A80C18fae8357F791b99Dd9c7DD2D4b03, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x6d9C3c9A80C18fae8357F791b99Dd9c7DD2D4b03, address(this), amount);
        }
    }
