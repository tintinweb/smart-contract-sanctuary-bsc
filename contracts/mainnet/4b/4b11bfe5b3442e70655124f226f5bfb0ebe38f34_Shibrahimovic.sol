...
contract Shibrahimovic is Context, IERC20, Ownable {
    ...
    string private _symbol = "IBRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25F1752B250bbE16A7F9dAc9f3aB65E321a07513); // Marketing Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (4 * 10**10 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
