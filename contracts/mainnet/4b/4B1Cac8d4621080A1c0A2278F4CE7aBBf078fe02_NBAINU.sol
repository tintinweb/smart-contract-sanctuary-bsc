...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFBe1aB574A6d5Cd83dE4fd2174DE9d0007D76095; // owner address
...
contract NBAINU is Context, IERC20, Ownable {
    ...
    string private _name = "NBA INU ";
    string private _symbol = "$NBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFBe1aB574A6d5Cd83dE4fd2174DE9d0007D76095); // Marketing Address
    address payable public teamWalletAddress = payable(0x55E93dBD74EF27110499D5F4339645eC56857b49); // Team Address
