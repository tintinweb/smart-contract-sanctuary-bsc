...
// File contracts/Pirate/PirateToken.sol
...
contract PirateToken is ERC20, Ownable {
    ...
    constructor() ERC20("Pirate", "Pirate") {
        ...
        receiveAddress = address(0xD3F7C53162818Fc762d4E38592897da4F8561eC0);
        marketOneAddress = address(0xF22D985036Cc3b3F70857ad108c95bAfD010a40e);
        marketTwoAddress = address(0x1e51C25B67Fa6a48a4D53E320fd46beC8E7bD84b);
        pairAddress = IPancakeFactory(pancakeRouter.factory()).createPair(
            address(this),
            USDT
        );

        _mint(receiveAddress, 1000000000 * (10**decimals()));
