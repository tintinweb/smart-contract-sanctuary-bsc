...
contract DARUMA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2E933c52E2375fe73Ad20a6714cFae8662d3Fe16);
    address payable public liqWalletAddress = payable(0x2E933c52E2375fe73Ad20a6714cFae8662d3Fe16);
    ...
    uint256 private _totalSupply =  1850 * 10**_decimals;
    uint256 public _maxTxAmount =   37 * 10**_decimals;
