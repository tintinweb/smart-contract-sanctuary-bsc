...
contract Boxingchampion is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x92b72dE9692484F329027B1e6d1943694F0ffF0D); // Marketing Address
    ...
    string private _name = "Boxingchampion";
