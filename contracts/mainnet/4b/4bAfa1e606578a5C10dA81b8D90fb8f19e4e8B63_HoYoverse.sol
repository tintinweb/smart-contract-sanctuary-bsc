...
contract HoYoverse is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "sanjiu";
    string private _symbol = "sanjiu";
    ...
    address public charityWallet = 0xB1089cF750a89cd034d1Dc40b50f5fEFE8efb4Dc;
    ...
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**5 * 10**9;
