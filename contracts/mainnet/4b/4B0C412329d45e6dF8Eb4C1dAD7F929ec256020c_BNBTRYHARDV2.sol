...
//BNBTRYHARD V2 LAUNCH DATE - 08/04/2022 - 21:00 (UTC)

pragma solidity 0.5.8;

contract BNBTRYHARDV2 {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(21, 78)); // 7.8% per day for 21 days
        plans.push(Plan(28, 71)); // 7.1% per day for 28 days
		plans.push(Plan(14, 93)); // 9.3% per day for 14 days (at the end, compounding)
        plans.push(Plan(21, 87)); // 8.7% per day for 21 days (at the end, compounding)
        plans.push(Plan(28, 82)); // 8.2% per day for 28 days (at the end, compounding)
