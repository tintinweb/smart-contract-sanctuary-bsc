...
contract ShibAK47 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibAK47 Inu";
    string private _symbol = "ShibAK47";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34F34f1431F788A536647eDabEc4A060ADe01571); 
    address payable public BuyBackWalletAddress = payable(0x34F34f1431F788A536647eDabEc4A060ADe01571); 
