...
Still at best entry point! Let's ape in and hope for a sweet journey to the moon! 
...
✅ 3% Buy/Sell Tax – Goes to Reflections!

💚 Solid Community - LETS MOON! 

TG: https://t.me/DelmonteSustainingourFuture
*/
...
contract DELMONTE is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "DEL MONTE";
    string private _symbol = "DEL MONTE";
