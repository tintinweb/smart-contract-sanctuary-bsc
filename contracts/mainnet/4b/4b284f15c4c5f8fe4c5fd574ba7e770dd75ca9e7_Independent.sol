...
contract Independent is IBEP20, Auth {
    ...
    string constant _name = "Peaky TOKEN";
    ...
    uint256 public totalFee         = charityFee + marketingFee + liquidityFee + utilityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCd2F67838f94E184F217476ff7467D03626D3E2a;
        charityFeeReceiver = 0x1928d620557cA0b04B9a8CD73F6a0af24D54e5cD;
    ...
    function setFees(uint256 _liquidityFee, uint256 _charityFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        charityFee = _charityFee;
        marketingFee = _marketingFee;
        utilityFee = _utilityFee;
        totalFee = _liquidityFee.add(_charityFee).add(_marketingFee).add(_utilityFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _charityFeeReceiver) external authorized {
