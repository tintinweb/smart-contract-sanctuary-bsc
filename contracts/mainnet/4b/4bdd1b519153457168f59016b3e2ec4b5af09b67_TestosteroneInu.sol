...
pragma solidity ^0.6.12;
    ...
    contract TestosteroneInu is Context, IERC20, Ownable {
        ...
        string private _name = 'TestosteroneInu';
        string private _symbol = 'TESTOSTERONEINU';
        uint8 private _decimals = 9;
        
        // Marketing and fees will start at 0 so we don't have a big impact when deploying to PancakeSwap
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xA0Bd009f2bC2634aaF335EEc1EaA0f0095EA32B0, 'We can not exclude Uniswap router.');
