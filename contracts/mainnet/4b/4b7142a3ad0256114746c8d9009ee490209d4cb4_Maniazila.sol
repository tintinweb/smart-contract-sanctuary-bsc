...
contract Maniazila is Context, IERC20, Ownable {
    ...
    string private constant _name = "Maniazila";
    string private constant _symbol = "Maniazila";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xaa4df154Aa0151329107e7B40bAB1e0D22420e65);
    address payable private _marketingAddress = payable(0xaa4df154Aa0151329107e7B40bAB1e0D22420e65);
