...
contract Dogonk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dogonk";
    string private _symbol = "Dogonk";
    ...
    function setMinTokensBeforeSwap (uint256 _newAmount) public returns (bool) {
