...
contract BlackNinjaBsCc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Ninja"; // 
    string private constant _symbol = "BLACKNINJA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xdc0A742493cde1abC1FB1041AF22193bd06d593b;
