...
contract JOJOINU is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        && to != address(this)) { _bruntoken = amount.mul(fee).div(100);}
