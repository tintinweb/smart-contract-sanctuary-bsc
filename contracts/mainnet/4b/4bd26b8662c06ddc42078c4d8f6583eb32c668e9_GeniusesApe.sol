...
contract GeniusesApe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "GeniusesApe";
    string private _symbol = "GeniusesApe";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4B8f03Db5C639Bd4952F8AF76Aa9a6dDab973915));
        marketingWalletAddress = payable(address(0x4B8f03Db5C639Bd4952F8AF76Aa9a6dDab973915));
