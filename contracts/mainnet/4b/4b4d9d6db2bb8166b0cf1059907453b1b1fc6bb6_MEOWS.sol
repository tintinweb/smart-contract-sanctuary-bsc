...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7c980B264C598F018Bd06AC01dB3065fa51Aa23a; // owner address
...
contract MEOWS is Context, IERC20, Ownable {
    ...
    string private _name = "MEOWS";
    string private _symbol = "MEOWS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7c980B264C598F018Bd06AC01dB3065fa51Aa23a); // Marketing Address
    address payable public teamWalletAddress = payable(0x7c980B264C598F018Bd06AC01dB3065fa51Aa23a); // Team Address
    ...
    uint256 public _teamShare = 2; // original 8
