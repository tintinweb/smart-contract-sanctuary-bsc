...
contract ADADAOStaking {
    ...
    IERC20 public stakeToken = IERC20(0x3b76374Cc2DfE28Cc373DcA6d5024791B2586335);
    ...
    uint256[4] public Bonus = [100, 300, 800, 250];
    ...
    function stake(uint256 amount, uint256 planIndex) public {
        require(planIndex < 4, "Invalid Time Period");
    ...
    function unstake(uint256 index) public {
        ...
        require(planIndex < 3, "invalid plan");
