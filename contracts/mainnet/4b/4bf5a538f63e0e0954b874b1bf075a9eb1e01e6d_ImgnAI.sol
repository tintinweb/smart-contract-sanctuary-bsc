 ...
 * Token Contract Code
 */
contract ImgnAI is IBEP20, Ownable {
      
    // -- Basic Token Information --
    string constant _name = "ImgAI";
    string constant _symbol = "ImgnAI";
    ...
    // -- Team Addresses --
    address private marketingWallet = 0xF8afBB5F6FF27A63F64c22Ba3eF8b85dbb7d1378;  // ADD WALLET
    
    // -- Public Addresses --
    address public RWRD=0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Reward Token -- BUSD
    ...
    constructor () Ownable(msg.sender) {
        ...
        // Set initial taxes
        _buy.liq=1;_buy.mark=5;_buy.reward=2; _buy.total=_buy.liq+_buy.mark+_buy.reward;
        _sell.liq=1;_sell.mark=5;_sell.reward=2; _sell.total=_sell.liq+_sell.mark+_sell.reward;
