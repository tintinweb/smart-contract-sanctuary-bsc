...
TG: https://t.me/+ZMQLVG9uLhViYTRl
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8118Cd1E6f6B19855CF9D7B0c64c8BAA4bE3B712; // owner address
...
contract Superratboy is Context, IERC20, Ownable {
    ...
    string private _name = "Super Ratboy";
    string private _symbol = "SRATBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x462671ed3Cc565A0eAf569538AB1d4b3872be82F); // Marketing Address
    address payable public teamWalletAddress = payable(0x462671ed3Cc565A0eAf569538AB1d4b3872be82F); // Team Address
