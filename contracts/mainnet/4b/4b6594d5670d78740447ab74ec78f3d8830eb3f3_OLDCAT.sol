...
contract OLDCAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9139aB7d5A9384dD6A56315eEc8911d50922b6Aa);
    address payable public teamWalletAddress = payable(0x9139aB7d5A9384dD6A56315eEc8911d50922b6Aa);
