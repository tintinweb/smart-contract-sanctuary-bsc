...
contract StrayKevin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StrayKevin";
    string private _symbol = "Kevin";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0x3A56CFbC8C23E2A9433528d3a55e0221F7AFC503); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3A56CFbC8C23E2A9433528d3a55e0221F7AFC503); // BuyBack Address
