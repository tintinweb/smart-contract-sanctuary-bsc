...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7689F1a9a62d4f9F2aEF7443213c77C5Fe73590B; // owner address
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "FuTu DAO";
    string private _symbol = "FuTu DAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7689F1a9a62d4f9F2aEF7443213c77C5Fe73590B); // 
    address payable public teamWalletAddress = payable(0x7689F1a9a62d4f9F2aEF7443213c77C5Fe73590B); // 
