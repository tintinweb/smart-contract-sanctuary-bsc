    ...
    ReentrancyGuard
{
    ...
    constructor(string memory name_, string memory symbol_) payable ERC721WithPermit(name_, symbol_) {
        _setCreator(0xAdc1f292A3B3CD974C4501FBa55f499E3Ab182a6);
        _setupPrimarySaleRecipient(0xAdc1f292A3B3CD974C4501FBa55f499E3Ab182a6);
        _setTransferFee(0x55d398326f99059fF775485246999027B3197955, _msgSender(), 0);
        _setType(1, address(0), 10000000000000000, 2, 2);
        _setType(2, address(0), 20000000000000000, 2, 2);
        _setType(3, address(0), 30000000000000000, 2, 2);
        _setType(4, address(0), 40000000000000000, 2, 3);
        _setType(5, address(0), 50000000000000000, 2, 1);
