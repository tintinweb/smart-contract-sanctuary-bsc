...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfeb60b309B25Fa5aE2Fd6cFE595ac1a0BBC4D57c; // owner address
...
contract RabbitWhales is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Rabbit Whales";
    string private _symbol = unicode"RICH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfeb60b309B25Fa5aE2Fd6cFE595ac1a0BBC4D57c); // Marketing Address
    address payable public teamWalletAddress = payable(0xfeb60b309B25Fa5aE2Fd6cFE595ac1a0BBC4D57c); // Team Address
