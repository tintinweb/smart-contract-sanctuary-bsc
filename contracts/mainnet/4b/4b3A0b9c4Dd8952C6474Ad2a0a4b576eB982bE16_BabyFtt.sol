...
contract BabyFtt is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyFtt";
    string private constant _symbol = "BabyFtt";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xac428087f509539Fed82d0916AD9532519a66390);
    address payable public developmentWalletAddress = payable(0xac428087f509539Fed82d0916AD9532519a66390); 
    ...
    uint256 public _maxTxAmount = 300 * 10**2 * 10**9;
    uint256 public _walletMax = 300 * 10**2 * 10**9;
