...
/**
Telegram: https://t.me/GravityDogebsc
Website: https://gravitydogebsc.com
Game: https://gravitydogebsc.com/game
Twitter: https://twitter.com/gravitydogebsc
*/
...
contract GravityDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Gravity Doge";
    string constant _symbol = "GDOGE";
    ...
    uint256 public _maxWalletToken = ( _totalSupply *32 ) / 100;
    ...
    address public Owner=0x3c63D5dE563C84B49EfFfE97aDcAc5B0B1d26976; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3c63D5dE563C84B49EfFfE97aDcAc5B0B1d26976;
