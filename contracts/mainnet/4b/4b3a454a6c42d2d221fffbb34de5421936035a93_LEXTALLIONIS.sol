...
/**
    https://lextallionis.space

    Judgement shall thee to the unjust.

    Telegram: https://t.me/lextallionisBSC
*/ 
...
contract LEXTALLIONIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lex Tallionis";
    string private _symbol = "Retribution";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x531e495f9B22200b7cf4e45e1B71fFac8D65Ffb7); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2dfB8Caf5099FBecdeb5E07f5e7C9a5beb1cE19D); // buyback Address
    ...
    uint256 private _totalSupply = 7000000000 * 10**9;
    uint256 public _maxTxAmount = 140000000 * 10**9; 
    uint256 public _walletMax = 210000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 4200000 * 10**9; 
