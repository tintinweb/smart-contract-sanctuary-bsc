...
contract hippo   is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x8301EAE9F504b33877B5BE246B6BFA65FE747E27);
    address payable private _marketingAddress = payable(0x8301EAE9F504b33877B5BE246B6BFA65FE747E27);
