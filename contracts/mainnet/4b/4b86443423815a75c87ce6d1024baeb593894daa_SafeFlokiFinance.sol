...
//https://t.me/safeflokifinanceofficial
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33b049096F7e7dC4B8fEdAaE35bcF370F6F149aC;
...
contract SafeFlokiFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeFlokiFinance"; // 
    string private constant _symbol = "SFF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xDE70B8b0652B0Ff5226532bB2cE019fD4a412A8C);
