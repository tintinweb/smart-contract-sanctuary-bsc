...
contract CJNH is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "CJNH";       //Full name
    string public symbol_ = "CJNH";      //abbreviation
    ...
    uint256 public maxburn = 9999 * (10**18); //max burn
    ...
    address public marketingWalletAddress = 0x2b4307bd02eC6646d9856606Cc4DAD32b06ccCCb;  //Marketing address
