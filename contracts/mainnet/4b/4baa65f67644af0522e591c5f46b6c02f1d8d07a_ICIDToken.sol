...
contract ICIDToken is ERC20Capped, Orchestrated {
    ...
    constructor() ERC20Capped(4000000 * (10 ** 18)) ERC20("ICID", "ICID") {
        white[address(this)] = true;
        white[_msgSender()] = true;
        ERC20._mint(msg.sender, 4000000 * (10 ** 18));
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!senderLimit || !isContract(from) || senderWhite[from] || white[from] || white[to] || address(0) == from, "ICID Token: senderLimit");
        require(!recipientLimit || !isContract(to) || recipientWhite[to] || white[from] || white[to], "ICID Token: recipientLimit");
    }
