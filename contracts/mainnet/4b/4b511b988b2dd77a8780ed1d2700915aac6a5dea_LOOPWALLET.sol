...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A70dc930B671C5CB624Cd16559344bCEe6CA073; 
...
contract LOOPWALLET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Loop Wallet";
    string private _symbol = "Loop";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE002a44600d13621E255835EdA25912EaC42d30f); 
    address payable public teamWalletAddress = payable(0xE002a44600d13621E255835EdA25912EaC42d30f); 
