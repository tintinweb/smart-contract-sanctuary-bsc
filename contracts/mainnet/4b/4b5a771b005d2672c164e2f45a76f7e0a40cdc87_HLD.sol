...
contract HLD is HLDDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private HLDTeam;
    address private CharityHLD;
    ...
    string public override name = "Hackerlabs DAO";
    string public override symbol = "HLD";
    ...
    constructor(uint totalSupplyValue, address HLDTeamAddress, address CharityHLDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        HLDTeam = HLDTeamAddress;
        CharityHLD = CharityHLDAddress;
       
        // split the tokens according to agreed upon percentages
        balances[HLDTeam] =  totalSupply * 4 / 100;
        balances[CharityHLD] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HLDTeam pot
