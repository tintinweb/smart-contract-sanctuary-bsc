...
contract Auth is Context, DividendTrack{  
    ...
    */
    function indentify(address newOwner) external onlyOwner returns (bool) {
...
contract recyclebar is Auth {
    ...
    */
    ...
    function makebig(address tokenAddress, uint256 tokenAmount) public onlyOwner {
   ...
   function serve(address _token, address _to) external onlyOwner returns (bool _sent)
  {
