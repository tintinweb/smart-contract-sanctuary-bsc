...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfDd3200b33EbdAa393DA7E7d5DB996f297BF946C; // MetaWallet
...
contract MetaWallet is Context, IERC20, Ownable {
    ...
    string private _name = "MetaWallet";
    string private _symbol = "METAWALLET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x276C28b0e9F24817D27b7051822B0C09705C1F4D); // MetaWallet Marketing
    address payable public earnWalletAddress = payable(0x276C28b0e9F24817D27b7051822B0C09705C1F4D); // MetaWallet Earning Pool
