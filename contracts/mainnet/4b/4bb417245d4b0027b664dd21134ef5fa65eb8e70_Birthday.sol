...
contract Birthday is ERC721, Ownable {
  ...
  uint256 public price = 1 * 10 ** 18 * 1.02;
  uint256 public constant maxSupply = 100;
  bool public mintActive = true;

  mapping(address => uint256) public addressMintedBalance;

  constructor(address _tokenAddress) ERC721("Birthday Badge", "BB") {
    tokenAddress = IERC20(_tokenAddress);
    setBaseURI("ipfs://QmcY86JDSX6d8HWz3pmQBoMJT61APiusMARvVrwEayk3z3/");
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    tokenAddress.safeTransferFrom(msg.sender, address(this), price * _mintAmount);
