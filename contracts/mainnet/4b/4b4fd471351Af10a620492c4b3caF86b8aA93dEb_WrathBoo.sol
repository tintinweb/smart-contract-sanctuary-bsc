...
contract WrathBoo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WrathBoo";
    string constant _symbol = "WrathBoo";
    ...
    uint256 public _walletMax = _totalSupply * 2 / 100; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        projectWallet = 0x8A1914596795f08bb8D73d59745a322c80a29933; 
