...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x844B15D34A1681b9C7Fda734BAC982D6DF1d111F; // owner address
...
contract OrdinalDoge is Context, IERC20, Ownable {
    ...
    string private _name = "OrdinalDOGE";
    string private _symbol = "$oDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x844B15D34A1681b9C7Fda734BAC982D6DF1d111F); // Marketing Address
    address payable public teamWalletAddress = payable(0x844B15D34A1681b9C7Fda734BAC982D6DF1d111F); // Team Address
