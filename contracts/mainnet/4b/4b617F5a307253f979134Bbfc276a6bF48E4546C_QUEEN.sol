...
contract QUEEN is Context, IERC20, Ownable {
    ...
    string private _name = "Feminist";
    string private _symbol = "F";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8bE17935A409D6CA117A3Ad30271A2781238FaAd); // Marketing Address
    address payable public teamWalletAddress = payable(0x8bE17935A409D6CA117A3Ad30271A2781238FaAd); // Team Address
    ...
    uint256 public _liquidityShare = 0; // original 3
    uint256 public _marketingShare = 0;
    uint256 public _teamShare = 0; // original 3

    uint256 public _totalTaxIfBuying = 0;  // original 3
    uint256 public _totalTaxIfSelling = 0;  // original 3
    uint256 public _totalDistributionShares = 0;  // original 3

    uint256 private _totalSupply = 105000000000000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 105000000000000 * 10 ** _decimals;
    uint256 public _walletMax = 105000000000000* 10 ** _decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 10 ** 12;
    ...
    function setTradingEnabledTimestamp(uint256 _tradingEnabledTimestamp) public onlyOwner {
