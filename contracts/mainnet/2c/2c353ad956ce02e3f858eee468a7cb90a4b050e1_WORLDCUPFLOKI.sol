...
contract WORLDCUPFLOKI is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"WORLDCUPFLOKI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x3008D0e8f14E7804819F479f4114613321DC359b);
    address payable public MarketingWallet = payable(0xe3A0Eb9dB132c73D3598a2b1df146B678e7F673b);
