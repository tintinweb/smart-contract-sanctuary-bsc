...
contract WeTrustWallet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " We Trust Wallet ";
    string private _symbol = " WTW ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31863d1b0a0D89Cd5c4b69388C56b6E350472F82);
    address payable public teamWalletAddress = payable(0x31863d1b0a0D89Cd5c4b69388C56b6E350472F82);
    ...
    uint256 private minimumTokensBeforeSwap = 750 * 10**_decimals; 
