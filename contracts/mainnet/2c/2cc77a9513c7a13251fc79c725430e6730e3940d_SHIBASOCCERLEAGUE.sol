...
/**
The first WEB3.0 & Shoot to earn gaming platform . 
An integrated platform to provide a bridge between football lovers and crypto users that combined dapps with NFT, Gamefi , Staking, And Lottery. 
Safe & Experienced team . Low tax 5% in & out . 
Kyc & audit. 
Game goes live at launch. Join our socials to know more .
*/ 

// Website  https://shibsocaleague.org/
// Twitter  https://twitter.com/shiba_league
// Telegram  https://t.me/shibasoccerleagueofficial
...
contract SHIBASOCCERLEAGUE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaSoccerLeague";
    string private _symbol = "SSL";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0x297b5614003103024F9a6f5253232dB9B6105123);
    address payable public buyBackWalletAddress = payable(0x297b5614003103024F9a6f5253232dB9B6105123);
