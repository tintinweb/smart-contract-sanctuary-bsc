...
library Address{
  ...
  contract BearBottom is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC6Ed58517f9D3AA525FB85AbC437AFEa3c276F85;
    address public donationWallet = 0xaBA8F31e735e3f5A5F701A911bc159C657d6B77D;

    string private constant _name = "Bear Bottom";
    string private constant _symbol = "BBOTTOM";
