...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06883DFa9D1766EE17E8060e8f853a89147f24ad; 
...
contract HookUp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HookUp AI";
    string private _symbol = "HooK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe92a2ce93F03583Dd66e79795F0877C4A5F320Fa); 
    address payable public teamWalletAddress = payable(0xeb31ADfA15c3342C506dBcbD55Ed15121fe6e004); 
