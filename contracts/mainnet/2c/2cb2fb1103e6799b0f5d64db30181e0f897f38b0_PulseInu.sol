...
/**PULSE INU
Website (pending): https://www.pulseinu.xyz
Telegram: https://t.me/PulseInuBSC
Twitter: https://twitter.com/askconradzen
*/
...
contract PulseInu is IBEP20, Ownable {
    ...
    uint256 maxTx = 30000000 * (10 ** _decimals);
    uint256 maxWallet = 30000000 * (10 ** _decimals);
    ...
    address public marketingWlt = payable(0x705e969494f292F9B842E1D7e7Ca478d5284522B);
