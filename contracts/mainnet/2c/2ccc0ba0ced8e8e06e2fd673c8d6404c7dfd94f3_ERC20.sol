...
contract BabyHulk is ERC20, Ownable, Pausable {

    // CONFIG START
    
    uint256 private initialSupply = 100000000000 * (10**18);
    ...
    constructor() ERC20("BabyHulk", "BHLK") payable
    {
        _setOwner(msg.sender);
        uniswapV2Router02 = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
		lpWallet = uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH());
        uniswapV2Pair = IUniswapV2Pair(lpWallet);
        taxWallets["liquidity"] = lpWallet;
		// setBuyTax(dev, marketing, liquidity, charity);
		// setSellTax(dev, marketing, liquidity, charity);
        // setTaxWallets(dev, marketing, charity);
		setBuyTax(5, 4, 2, 3);
		setSellTax(6, 5, 3, 4);
		setTaxWallets(0x4EDBC9bc484459507c1A54AEC4083F39dF1303D5, 0x4EDBC9bc484459507c1A54AEC4083F39dF1303D5, 0x4EDBC9bc484459507c1A54AEC4083F39dF1303D5);
        exclude(msg.sender);
        exclude(address(this));
        payable(lpWallet).transfer(msg.value);
    ...
    function _transfer(
        ...
        require(!paused(), "BabyHulk: token transfer while paused");
        require(!isBlacklisted(msg.sender), "BabyHulk: sender blacklisted");
        require(!isBlacklisted(recipient), "BabyHulk: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "BabyHulk: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "BabyHulk: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "BabyHulk: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "BabyHulk: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "BabyHulk: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "BabyHulk: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "BabyHulk: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "BabyHulk: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "BabyHulk: Tax is already disabled");
        taxStatus = false;
    }
