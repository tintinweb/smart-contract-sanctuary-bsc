...
contract FLY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "777 Fly";
    ...
    address public ownerAddres = address(0x6e5620D51E6875F46408b37EaB966c20e7aa087f);
    address public devAddress = address(0x4BD55f9d4D5F335023440a046b52C50e97e96B8B);
    ...
    uint256 public _maxTxAmount = 777 * 10**18;
