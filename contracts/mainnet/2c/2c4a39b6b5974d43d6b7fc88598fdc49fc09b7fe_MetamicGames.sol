...
contract MetamicGames {

    using SafeMath for uint256;
    IERC20 public MEGContract = IERC20(0x7DBe537984c7C98DD8D25eD3C530CC38889e0a6A);
    IERC20 public BUSDTokenContract= IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);  
    uint256 public price = 4;
    uint256 public minimumBuy = 30;
    uint256 public rewardPecentage = 1;          
    address public owner = 0xD0E2E99452b456cCe0AC336Bd5Fa0C2063B5f6E6;
    ...
    function buyTokens(uint256 numberOfTokens) public {
        ...
        require(minimumBuy.mul(uint(10)**18) <= numberOfTokens,"Minimum Buy 30 Token");
