...
contract BokuNoPico is Context, IERC20, Ownable {
    ...
    bool public tradeStatus;
    bool public swapEnabled;
    bool private swapping;
    
    modifier antiBot(address account){
        require(tradeStatus || allowedTransfer[account], "Trading not enabled yet");
        _;
    }
    ...
    uint256 public maxBuyLimit = 100_000 * 10**_decimals;
    uint256 public maxSellLimit = 100_000 * 10**_decimals;
    uint256 public maxWalletLimit = 100_000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0x15e00C9C7A6445604470542aA411E900FFeB6c75;
    address public devWallet = 0x15e00C9C7A6445604470542aA411E900FFeB6c75; 
    address public operationWallet = 0x15e00C9C7A6445604470542aA411E900FFeB6c75;
    address public charityWallet = 0x15e00C9C7A6445604470542aA411E900FFeB6c75; 
    ...
    constructor (address routerAddress, uint256 antiSnipeSeconds) {
        ...
        router = _router;
        pair = _pair;
        _approve(owner(), address(_router), MAX);
...
//=========View Functions=========
    ...
    function _snipersREKT() public view returns (uint){
...
//========Owner Functions=========
    ...
    function updateWallets(address newMarketing, address newDev, address newCharity, address newOperation) external onlyOwner{
        marketingWallet = newMarketing;
        devWallet = newDev;
        charityWallet = newCharity;
        operationWallet = newOperation;
    }
    ...
    function updateSwapAndLiquify(bool _enabled) external onlyOwner{
    ...
    function updateExcludeFromFee(address account,bool isExcluded_) external onlyOwner {
        _isExcludedFromFee[account] = isExcluded_;
    }
    ...
    function update_MaxTx(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        maxBuyLimit = maxBuy * 10**decimals();
        maxSellLimit = maxSell * 10**decimals();
    }
    
    function update_MaxWallet(uint256 amount) external onlyOwner{
        maxWalletLimit = amount * 10**decimals();
    }
    
    function update_BuyTax(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev, uint256 _operation, uint256 _charity) public onlyOwner {
        taxes = Taxes(_rfi,_marketing,_liquidity,_dev,_operation,_charity);
        emit FeesChanged();
    }
    
    function update_SellTax(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev, uint256 _operation, uint256 _charity) public onlyOwner {
...
//================================
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            require(tradeStatus, "Trading not active");
        }
