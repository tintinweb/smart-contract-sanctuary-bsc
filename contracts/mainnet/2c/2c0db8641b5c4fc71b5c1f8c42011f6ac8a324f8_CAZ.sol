...
//  telegram : https://t.me/copicoofficial
...
contract CAZ is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CazCoin"; // 
    string constant _symbol = "CAZ"; // 
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (10); // 10%
    uint256 public _maxWalletToken = _totalSupply / (100) * (30); // 30%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0xd8878a9809aB5E3b50a6560b27413CA90Ec80c7a;
    address public devFeeReceiver = 0xd8878a9809aB5E3b50a6560b27413CA90Ec80c7a;
    address public buybackFeeReceiver = 0xd8878a9809aB5E3b50a6560b27413CA90Ec80c7a;

    IDEXRouter public router;
    address public pair;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 1000 * 100; // 10%
