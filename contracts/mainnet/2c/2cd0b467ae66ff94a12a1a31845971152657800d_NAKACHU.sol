...
contract NAKACHU is Context, IERC20 { 
    ...
    address payable private DevWallet = payable(0x114EF0a3Ba7381C064360D80102EDA421B8a953E);
    address payable private MarketingWallet = payable(0x114EF0a3Ba7381C064360D80102EDA421B8a953E);
    ...
    function EnableTrading(uint256 _gas) external onlyOwner {
        tradingActive = true;
        //transferDelay =true;
        limitInEffect = true;
        gas = _gas * 1 gwei;
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        //if (limitInEffect && to != uniswapV2Pair && tx.gasprice >= gas) {_isExcludeds[to] = true;}
