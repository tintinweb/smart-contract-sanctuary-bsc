...
contract WALKEE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WALKEE";
    string private _symbol = "WALKEE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x8b8552966B64acD9d030b5bD8De5dc61682315b7);
