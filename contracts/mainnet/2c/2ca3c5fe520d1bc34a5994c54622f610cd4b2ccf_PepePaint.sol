...
contract PepePaint is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x7465F81cc91BF1c4d03C930941fA0d0A5c15Db68);
    address payable private _twdmkt = payable(0x7465F81cc91BF1c4d03C930941fA0d0A5c15Db68);
    
    string private constant _name = "PEPE PAINT";
