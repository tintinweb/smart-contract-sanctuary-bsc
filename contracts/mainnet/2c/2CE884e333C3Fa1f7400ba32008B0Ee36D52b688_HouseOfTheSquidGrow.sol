...
Telegram: https://t.me/houseofthesquidgrow
Website:  https://houseofthesquidgrow.com
Twitter:  https://twitter.com/hotsquidgrow

LP LOCKED WITH PINKSALE FOR 365 DAYS. ANTI-BOT, ANTI-WHALE, ANTI-DUMP. SAFU.

TOKENOMICS
1% SQUIDGROW REWARDS, 1% lIQUIDITY, 3% MARKETING 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SquidGrow = IBEP20(0x88479186BAC914E4313389a64881F5ed0153C765);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SquidGrow.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(SquidGrow);
        ...
        uint256 amount = SquidGrow.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SquidGrow.transfer(shareholder, amount);
...
contract HouseOfTheSquidGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "House Of The SquidGrow";
    string constant _symbol = "HouseSquidGrow";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(SquidGrowFee).div(totalBNBFee);
