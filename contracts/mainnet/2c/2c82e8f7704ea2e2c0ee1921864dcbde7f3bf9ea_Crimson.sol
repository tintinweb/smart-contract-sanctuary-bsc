...
contract Crimson is Context, IERC20, Ownable {
    ...
    string private _name = "Crimson Coin";
    string private _symbol = "Crimson";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71E9566C3B8D96f44a5DF04557A925cF1dA56a6F); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x71E9566C3B8D96f44a5DF04557A925cF1dA56a6F); // Dev Address
    ...
    uint256 public _maxTxAmount = 100000 * 10**6 * 10**9; // 2% max tx
    uint256 public _walletMax = 100000 * 10**6 * 10**9; // 2% max wallet
