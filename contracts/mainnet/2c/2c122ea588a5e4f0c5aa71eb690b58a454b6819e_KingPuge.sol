...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF3e059CAD46180016DC86400e189B8A47B0c0E0f; // owner address
...
contract KingPuge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Puge";
    string private _symbol = "King Puge";
