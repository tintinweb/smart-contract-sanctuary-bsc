...
🤝Build web3 with friends 🤝
Developer DAO is a community 
of thousands of web3 builders 
creating a better internet. Join us and create the future.
CODE🤝🤝🤝🤝🤝🤝🤝
🤝 0x2C12D3C98be799F5196bB8c49C833B0cFA3c402d
...
contract CODE is CODEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CODETeam;
    address private CharityCODE;
    ...
    string public override name = "CODE";
    string public override symbol = "CODE";
    ...
    constructor(uint totalSupplyValue, address CODETeamAddress, address CharityCODEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CODETeam = CODETeamAddress;
        CharityCODE = CharityCODEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CODETeam] =  totalSupply * 5 / 100;
        balances[CharityCODE] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's CODETeam pot
