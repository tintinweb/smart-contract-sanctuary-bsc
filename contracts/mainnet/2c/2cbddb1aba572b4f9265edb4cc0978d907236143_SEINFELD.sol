...
contract SEINFELD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SEINFELD";
    string private _symbol = "SEINFELD";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xC877207818A5E74BC0B8d0F487673185aB9995FB); 
    address payable public teamWalletAddress = payable(0xC877207818A5E74BC0B8d0F487673185aB9995FB); 
