...
library Address{
 ...
 contract RugFreeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "RugFreeInu";
    string private constant _symbol = "RugFreeInu";
    ...
    Taxes public taxes = Taxes(0, 6, 1, 92);
