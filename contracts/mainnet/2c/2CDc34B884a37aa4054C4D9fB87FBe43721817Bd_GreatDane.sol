...
/**
Great Dane🐕‍ 
👉The English name of the Great Dane is translated from the French name "giant Dane". Also known as the German Mastiff in mainland Germany, it is known as the "Sun God" among dogs. The Great Dane is largest dog in the world. 👈
👊It is not only a symbol of nobility, but also has outstanding skills in hunting wild boars and wolves 👊
✊"We are strong to protect those who need to be protected"✊
💪 Great Dane will set up a unique anti-war fund, the anti-war fund association will organize to help the oppressed weak and neutral countries.💪
❤❤❤World peace is our wish❤❤❤
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
✅TAX: BUY 8% - SELL 8%
✅HC: 200BNB     MAX: 0.8BNB

🤩Presale :         08.20     12:00 (UTC)
🤩Launch  :         08.20     14:00 (UTC)
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂

🔉EN: https://t.me/GreatDaneEN
🔉CN: https://t.me/GreatDaneCN
🕊TWITTER: https://twitter.com/dane_greater
*/
...
contract GreatDane is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69e14 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1_000_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 1_000_000_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 1_000_000_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 1_000_000_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public CallWallet = 0x498d02Fd5691C20a69CB57560b7275f445334CeB;
    ...
    string private constant _name = "GreatDane";
    string private constant _symbol = "GreatDane";
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(devAmt > 0){
            payable(CEXWallet).sendValue(devAmt);
        }
