...
contract FUCKRON is Context, IERC20, Ownable {
    ...
    string private constant _name = "FUCK RONIN INU";
    string private constant _symbol = "FUCKRON";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000 * 10**_decimals;

    uint256 public _maxWalletAmount = 35* 10**_decimals;
    uint256 public _maxTxAmount = 35* 10**_decimals;
    uint256 public swapTokenAtAmount = 35* 10**_decimals;
    ...
    address private marketingWallet = address(0x63150FF3b18863AA0b7152FBd4B45657F1885845);
    address private liquidityReceiver = address(0x63150FF3b18863AA0b7152FBd4B45657F1885845);
