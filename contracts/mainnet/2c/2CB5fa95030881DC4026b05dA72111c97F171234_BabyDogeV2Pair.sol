...
import "./BabyDogeV2ERC20.sol";
import "./libraries/Math.sol";
import "./libraries/UQ112x112.sol";
import "./interfaces/IERC20.sol";
import "./interfaces/IBabyDogeV2Factory.sol";
import "./interfaces/IBabyDogeV2Callee.sol";

contract BabyDogeV2Pair is IBabyDogeV2Pair, BabyDogeV2ERC20 {
  ...
  function initialize(
    ...
    require(msg.sender == factory, "BabyDogeV2: FORBIDDEN"); // sufficient check
    token0 = _token0;
    token1 = _token1;
    router = _router;
  }
  ...
  function _mintFee(uint112 _reserve0, uint112 _reserve1)
    ...
    returns (bool feeOn)
  {
    address feeTo = IBabyDogeV2Factory(factory).feeTo();
    address feeToTreasury = IBabyDogeV2Factory(factory).feeToTreasury();
  ...
  function swap(
    ...
    uint256 balance1;
    {
      ...
      if (data.length > 0)
        IBabyDogeV2Callee(to).babyDogeV2Call(
          msg.sender,
          amount0Out,
          amount1Out,
          data
...
import "./interfaces/IBabyDogeV2ERC20.sol";
import "./libraries/SafeMath.sol";

contract BabyDogeV2ERC20 is IBabyDogeV2ERC20 {
  using SafeMath for uint256;
  ...
  function permit(
    ...
    require(deadline >= block.timestamp, "BabyDogeV2: EXPIRED");
...
interface IBabyDogeV2Callee {
  function babyDogeV2Call(
    address sender,
    uint256 amount0,
    uint256 amount1,
    bytes calldata data
