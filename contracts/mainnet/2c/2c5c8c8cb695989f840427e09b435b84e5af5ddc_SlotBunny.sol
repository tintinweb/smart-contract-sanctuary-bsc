...
The next BSC slot machine that supports BEP-20 tokens as credits!
Come play with our bunny and take your chances in our amazing slot game! 

https://t.me/SlotBunny
...
contract SlotBunny is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x909530d3d094AcECdD8ae084B1F7d3b08034c926); // Marketing Address
        
    address payable public teamAddress =
        payable(0x05630796dfE146B7552e4033f177A2747a9F8a30); // Team Address
        
    address payable public liquidityAddress =
        payable(0x05630796dfE146B7552e4033f177A2747a9F8a30); // Liquidity Address
    ...
    string private constant _name = "SlotBunny";
    string private constant _symbol = "SBUNNY";
