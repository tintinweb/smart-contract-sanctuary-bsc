...
contract TestToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB9792B5ed750a7A7A398333585C9E33706986C4f); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xB9792B5ed750a7A7A398333585C9E33706986C4f); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xB9792B5ed750a7A7A398333585C9E33706986C4f); // charity Wallet Address
    address payable public devWalletAddress = payable(0xB9792B5ed750a7A7A398333585C9E33706986C4f); // dev Wallet Address
