...
contract Gooned is ERC20, ERC20Detailed {

    uint256 private _minimumSupply = 1000 * (10 ** 1);
    address public owner ;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Gooned", "goon", 1) {
        _mint(msg.sender, 65000000000000 * (10 ** uint256(decimals())));
        owner=msg.sender;
    }
    ...
    function _calculateBurnAmount(uint256 amount) internal view returns (uint256) {
        ...
        if (totalSupply() > _minimumSupply) {
            burnAmount = amount.mul(15).div(1000);
    ...
    function _change_minimum_supply(uint256 amount) public {
