...
contract    ORN
 is Context, IERC20, Ownable {
    ...
    string private _name = " ORN";
    string private _symbol = " ORN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5959a6A7a035cDE0d8885338FCAb9386E91758b0);
    address payable public teamWalletAddress = payable(0x5959a6A7a035cDE0d8885338FCAb9386E91758b0);
    address public immutable deadAddress =0x5959a6A7a035cDE0d8885338FCAb9386E91758b0;
