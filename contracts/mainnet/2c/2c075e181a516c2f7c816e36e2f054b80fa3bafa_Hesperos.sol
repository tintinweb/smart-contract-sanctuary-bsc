...
/**
 Website  : https://Hesperos.Finance/
 Telegram : https://t.me/HesperosOfficial

A hybrid DPOS protocol, called Chaos Consensus, is used by Hesperos.

Based on DPOS consensus, this protocol offers
a random selection method for nodes, allowing more 
nodes to participate in the consensus and increasing the system's decentralization.
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25AD6bAde4312a5dd22964D3eC717862189316a4;
...
contract Hesperos is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x25AD6bAde4312a5dd22964D3eC717862189316a4);
