...
contract CZEDs is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CZEDS";
    string constant _symbol = "$CZEDS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1E24F49342db6a8ff134A9B40731E0919bcF1C55 ;
