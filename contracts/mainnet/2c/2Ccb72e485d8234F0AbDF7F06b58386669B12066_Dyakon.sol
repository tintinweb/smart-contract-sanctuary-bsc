...
contract Dyakon is Context, IERC20, Ownable,Initializable {   
    ...
    */
    ...
    function myRewards(address _wallet) public view returns(uint256 _reward){
        ...
        if(_wallet!=pancakePair &&_isExcludedFromReward[_wallet]!=true) {
    ...
    function claimReward() public {
        if(msg.sender!=pancakePair &&_isExcludedFromReward[msg.sender]!=true) {
