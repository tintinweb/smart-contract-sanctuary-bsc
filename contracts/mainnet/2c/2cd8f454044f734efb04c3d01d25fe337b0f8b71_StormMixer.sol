...
// https://t.me/StormMixer
// https://stormmixer.net
...
contract StormMixer is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping(address => uint256) private _includedInFee;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _excludedFromFee;
    string private _name = "StormMixer";
    string private _symbol = "Storm";
    ...
    uint256 public _maxWallet =   100000000000000 * 10 ** _decimals;
