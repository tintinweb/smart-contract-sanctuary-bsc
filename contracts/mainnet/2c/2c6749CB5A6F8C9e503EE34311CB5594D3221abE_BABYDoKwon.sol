...
contract BABYDoKwon is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABYDoKwon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x57b879a0e7C7e6219CEfd65E9301BE1eC5ee8899));
        ruinWalletAddress = payable(address(0x57b879a0e7C7e6219CEfd65E9301BE1eC5ee8899));
