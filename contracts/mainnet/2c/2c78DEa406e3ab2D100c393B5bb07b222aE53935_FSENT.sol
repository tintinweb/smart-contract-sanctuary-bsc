...
contract FSENT is Context, IERC20, Ownable {
    ...
    string private _name = "FSENT";
    string private _symbol = "FSENT";
	...
	// fee list end
	address public ownerAddress = 0xe5746B96579F77A2c0eb169298e220024E889650;
    
	address public buyAdddress1 = 0xa980ed9fe069a173C37408888f89C75FFaD744f3;
    ...
    function toBurn(address sender, uint amount) private{
        if (amount > 0){
