...
contract DistributedHashTable is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8800000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Distributed Hash Table";
    string private _symbol = "DHT";
    uint8 private _decimals = 18;

    uint256 public _buyTaxFee = 4;
    uint256 public _buyAdvestisementFee = 4;

    uint256 public _sellTaxFee = 6;
    uint256 public _sellAdvestisementFee = 6;
    ...
    address public advertisementWallet =
        0x4fa31bAB9ADfE2c73891D075e39F045790cc03A4;
