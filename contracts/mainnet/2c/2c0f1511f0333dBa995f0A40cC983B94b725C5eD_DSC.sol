...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract DSC is ERC20, Ownable {
        ...
        string private    _name = "Digital Safe Coin";
   ...
   address payable maintenanceWallet = payable(0x3e6Fd0A4e3b7D59f75BcFbFF1AF5591Ed656B96e);
    ...
    function updateMarketingFee (uint256 percentage) public onlyOwner{
        require(percentage<=5, "cannot set higher than 10");
        _maintenanceFee= percentage;
    }

    function updateLiquidityFee (uint256 percentage) public onlyOwner{
        require(percentage<=5,"cannot set higher than 10");
