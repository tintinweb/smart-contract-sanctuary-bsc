...
contract OGAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG APE"; 
    string private _symbol = "OGAPE"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88709F556530478Db351E13143554b66dCdc0Ab3); 
    address payable public teamWalletAddress = payable(0x88709F556530478Db351E13143554b66dCdc0Ab3); 
