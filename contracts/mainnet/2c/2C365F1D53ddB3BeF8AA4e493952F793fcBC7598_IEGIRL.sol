...
/**
After 27 years of service, Microsoft is finally pulling its plug on internet Explorer! Lots of fans are paying their respect to the fallen giant! Save IE Chan now!
TG: https://t.me/IEGirlOfficial
...
/* Token contract */
contract IEGIRL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xDE6D18D40dC73B3a7CE96d36caa9996b69414F20;
    ...
    // Name and symbol
    string constant _name = "IE Girl";
    string constant _symbol = "IE";
    ...
    uint256 public swapThreshold = _totalSupply * 70 / 10000; // 2% of supply, 0.7%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDE6D18D40dC73B3a7CE96d36caa9996b69414F20;
