...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41F548f9d56261334F68aCa1e4Aa2945b6511980; // owner address
...
contract Crowrasuno is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crowrasuno";
    string private _symbol = "Crowrasuno";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41F548f9d56261334F68aCa1e4Aa2945b6511980); // Marketing Address
    address payable public teamWalletAddress = payable(0x41F548f9d56261334F68aCa1e4Aa2945b6511980); // Team Address
