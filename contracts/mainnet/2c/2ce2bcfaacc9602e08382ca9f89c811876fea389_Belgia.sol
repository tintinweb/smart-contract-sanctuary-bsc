...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3ff0e6463706C87AeBA0269Fc52b62f7150eD09C; 
...
contract Belgia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Belgia";
    string private _symbol = "Belgia";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3ff0e6463706C87AeBA0269Fc52b62f7150eD09C); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x0d172154797CaAAB8CF5Cf525Be4a21C19d376d7); // Team Wallet
