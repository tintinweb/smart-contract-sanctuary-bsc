...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2800229E86Ab638692D540BB15E100Bd77d12374;
...
contract fattoken is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletTokens = 1000000000000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; //
    string private constant _name = "433"; // 
    string private constant _symbol = "433"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x2800229E86Ab638692D540BB15E100Bd77d12374);
