...
contract CCDS is Context, IERC20, Ownable {
    ...
    string private constant _name = "CCDS"; // 
    string private constant _symbol = "CCDS"; //    
    uint8 private constant _decimals = 9; // 
    uint256 public _marketingFee = 5;
    
    uint256 public _liquidityFee = 1;
    
    address public  _marketingWallet = 0x038c294a72a2A10c9Cf5f6194C0C13673fCF4D89;
    ...
    function setTxMara(uint256 l, uint256 m) public onlyOwner {
        _liquidityFee = l;
        _marketingFee = m;
    }
