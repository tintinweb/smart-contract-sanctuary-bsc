...
contract MTMO_ICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 30000; // Number of tokens per BNB
  uint256 public constant CAP = 1000; // Cap in BNB
  uint256 public constant START = 1654268400; //Fri June 03 2022 18:00:00  GMT+0300 
