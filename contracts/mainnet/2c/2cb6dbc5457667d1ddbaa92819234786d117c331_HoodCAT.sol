...
contract HoodCAT is Context, IERC20, Ownable {
    ...
    string private _name = "HoodCAT";
    string private _symbol = "HC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb11b8A713909C2039FD7CA3881DF5eF8C58D1EbA); // Marketing Address
    address payable public teamWalletAddress = payable(0x9A21c8B1068a3F3D36f83AAc100613Da42318208); // Team Address
    ...
    uint256 public _maxTxAmount = 3000 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 3000 * 10**6* 10**_decimals;
