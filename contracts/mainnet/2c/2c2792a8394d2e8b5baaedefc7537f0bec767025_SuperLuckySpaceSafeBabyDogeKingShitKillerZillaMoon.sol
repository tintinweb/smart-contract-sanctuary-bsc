...
contract SuperLuckySpaceSafeBabyDogeKingShitKillerZillaMoon
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperLuckySpaceSafeBabyDogeKingShitKillerZillaMoon";
    string private _symbol = "SuperLuckySpaceSafeBabyDogeKingShitKillerZillaMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72420688e4A667912F51e090062b9c2A99C27aA0);
    address payable public teamWalletAddress = payable(0x72420688e4A667912F51e090062b9c2A99C27aA0);
