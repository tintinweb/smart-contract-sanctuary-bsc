...
contract TokenRewardAllReferrer is ERC20, Ownable, BaseToken {
    ...
    string  name_ = "DORMOON";
    string  symbol_ = "DORMOON";
    ...
    constructor() payable ERC20(name_, symbol_) {
        rewardToken = 0x23766CB8a96fF2f46F664BC7D088a6306DE73618;
        ...
        excludeFromFees(0xE2B1eA73BAD3226b619826399Ab56501DBE75bbA, true);
        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _mint(0xE2B1eA73BAD3226b619826399Ab56501DBE75bbA, totalSupply_);

        emit TokenCreated(0xE2B1eA73BAD3226b619826399Ab56501DBE75bbA, address(this), TokenType.baby, VERSION);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 Mfees = amount.mul(marketingFee).div(1000);
            ...
            uint256 tmp = amount;
            amount = amount.sub(fees.add(Mfees));
            //
            if(isOpenRef) {
                address ref1;
                ...
                if(balanceOf(ref1) >= 100 *10**18 && ref1 != address(0)){
                    ...
                    if(balanceOf(ref2) >= 100 *10**18 && ref2 != address(0)){
            ...
            super._transfer(from, _marketingWalletAddress, Mfees);
        }
        if(isOpenRef){
