...
contract ChubbyRatBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChubbyRatBoy";
    string private _symbol = "CRB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE5FC6d375FC4fac371676be6cBa9b547e74C035D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE5FC6d375FC4fac371676be6cBa9b547e74C035D); // BuyBack Address
