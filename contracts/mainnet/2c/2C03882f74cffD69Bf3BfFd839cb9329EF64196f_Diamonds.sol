...
contract Diamonds is ERC20Burnable, Operator {
    ...
    uint256 public constant TEAM_FUND_ALLOCATION = 4000 ether;
    uint256 public constant TEAM_FUND_AIRDROP = 998 ether;
    ...
    uint256 public constant TREASURY_FUND_ALLOCATION = 3000 ether;
    uint256 public constant TREASURY_FUND_AIRDROP = 2000 ether;
    ...
    constructor(
        ...
        // airdrop 998 DIA for TEAM funds
        _mint(teamAddress, TEAM_FUND_AIRDROP);

        // airdrop 2000 DIA for TEAM funds
        _mint(treasuryAddress, TREASURY_FUND_AIRDROP);

        // mint 2 DIA for initial pools deployment
