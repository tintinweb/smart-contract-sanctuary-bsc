...
first offer WELCOME TO TOTO INU
$Toto Inu
Introducing Toto Inu, a revolutionary new token with innovative web3 utilities like easy swap, Shooky wallet, investment tracking and NFT marketplace.
 Named after the popular internet meme, Toto Inu is set to disrupt the crypto space.
...
contract Totoinu  is Contextbep20, bep20, Ownablebep20 {
    ...
    uint256 private constant _allTotalSupply = 10000000 * 10**6 * 10**18;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Totoinu';
    string private _symbol = 'Totoinu';
