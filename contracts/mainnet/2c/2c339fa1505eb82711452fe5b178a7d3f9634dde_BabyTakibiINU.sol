...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92f20FbD03fbd631Ee577AEdcc4d7BA986709d04; // owner address
...
contract BabyTakibiINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyTakibi INU";
    string private _symbol = "BTNU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17d682639Aef694e72D376eccA256C6a2a6f7b09); // Marketing Address
    address payable public teamWalletAddress = payable(0x1C858B4f83f3d964808856bde92F1040657E817d); // Team Address
