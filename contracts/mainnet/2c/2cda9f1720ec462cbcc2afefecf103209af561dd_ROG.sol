...
contract ROG is ERC20, Ownable, SafeToken, LockToken {
    ...
    uint256 public maxBuyTransactionAmount = 45000000 * (10**9); // 5% of total supply 
    ...
    constructor() ERC20("Ride of Gamers", "ROG") {
        ...
        marketingFee = 3;
        burnFee = 4;
        marketingWallet = payable(0x33d862d9A90FbABD95f4C3Efd5c8ea4F4fA54F94); // please confirm address
