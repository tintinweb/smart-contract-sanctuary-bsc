...
Telegram : https://t.me/betflokiofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF6Bf6B3C23B68Cbd895d939252AF8b3ccbb780CF;
...
contract BETFLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "BETFLOKI"; // 
    string private constant _symbol = "$BFLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xF6Bf6B3C23B68Cbd895d939252AF8b3ccbb780CF);
