...
contract Argentina is Context, IERC20 { 
    ...
    string private _symbol = unicode"AFT";
    ...
    uint256 public _maxBuy = _tTotal * 3 / 200;
    uint256 public _maxSell = _tTotal * 3 / 200;
    ...
    address payable public DevWallet = payable(0x6Af915d5d6324bc4D822E7eF6D2581caAad95F9C);
    address payable public MarketingWallet = payable(0x6Af915d5d6324bc4D822E7eF6D2581caAad95F9C);
