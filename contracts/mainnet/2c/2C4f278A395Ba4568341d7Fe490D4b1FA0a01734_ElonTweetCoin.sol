...
contract ElonTweetCoin is Ownable, IERC20 {
    ...
    address uniswapV2PairAddress = IUniswapV2Factory(_router.factory()).createPair(_router.WETH(), address(this));
