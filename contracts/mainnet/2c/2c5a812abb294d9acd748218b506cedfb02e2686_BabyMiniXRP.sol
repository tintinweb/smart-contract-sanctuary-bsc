...
contract BabyMiniXRP is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Mini XRP"; // TODO change
    string private _symbol = "BABYMINIXRP"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63560F860cdFd38434Fe0379634d9f5eDb0a32e0); // Marketing Address
    address payable public buybackWalletAddress = payable(0x63560F860cdFd38434Fe0379634d9f5eDb0a32e0); // Buyback Address
