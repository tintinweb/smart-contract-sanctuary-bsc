...
contract NANOMOON100 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NANO MOON 100";
    string private _symbol = "NM100";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xC0ff5A7B5b91756a9bF5cD7ae6C1046b089696fA);
    address payable public teamWalletAddress = payable(0x17E9b274796b9515546c9Ce38672B43d2eFAdC7a);
