...
//
// $SANTACAKE proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN $SANTACAKE ! With the auto-claim feature,
// simply hold$SANTACAKE and you'll receive CAKE automatically in your wallet.
// 
// Hold $SANTACAKE  and get rewarded in CAKE on every transaction!
//
//
// 📱 Telegram:https::https://t.me/+1CM0g87iPhk1NjRl
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsCake(uint256 amount) public onlyOwner {
...
contract SANTACAKE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SANTA CAKE", "SANTACAKE") {
