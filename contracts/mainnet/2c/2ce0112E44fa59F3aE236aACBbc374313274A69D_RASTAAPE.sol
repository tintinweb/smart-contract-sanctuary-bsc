...
RastaApe meme coin stealth launch that utilizes organic as a thrifty boost,
and 3% marketing to add a more powerful boost 
...
LP LOCK / RENOUNCE
Link TG: https://t.me/RastaApe
DEV TG: https://t.me/LufyDEV
...
contract RASTAAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rasta Ape";
    string private _symbol = "Raspe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x179A1A5bEc5037DE47252F7c8d5C8780BAf5e198); // 营销钱包
    address payable public teamWalletAddress = payable(0x179A1A5bEc5037DE47252F7c8d5C8780BAf5e198); // 团队钱包
