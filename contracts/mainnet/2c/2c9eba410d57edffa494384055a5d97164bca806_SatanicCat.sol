...
contract SatanicCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Satanic Cat";
    string private _symbol ="Hail Satan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA1e0979E692Da4A4f69d7367B8512f2Ca6aF89ea);
    address payable public teamWalletAddress = payable(0xA1e0979E692Da4A4f69d7367B8512f2Ca6aF89ea);
