...
contract  MISHASHI  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MMinShanShinBa Inu"; // 
    string private constant _symbol = unicode"$MISHASHI"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x27e40aa67156F20C9703151CB321852791838b0d;
