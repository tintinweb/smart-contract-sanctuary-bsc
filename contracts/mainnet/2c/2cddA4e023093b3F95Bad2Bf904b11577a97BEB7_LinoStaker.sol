...
contract LinoStaker is Ownable {
    ...
    uint256 stakezarib=1000000;
    uint256 stakemineszarib = 10000;
    ...
    function setZaribsForDots(uint256 _stakezarib,uint256 _stakemineszarib) onlyOwner public{
        stakezarib = _stakezarib;
        stakemineszarib = _stakemineszarib;
    }
    ...
    function CalcaluateAllRewardUser() internal {
        for(uint i=0; i<Stakers.length; i++){
            uint256 Rewarded = CalcaluateRewardNew(Stakers[i])/stakemineszarib;
    ...
    public {
        ...
        ///////////////////
        rewardcalc = CalcaluateRewardNew(msg.sender)/stakemineszarib;
    ...
    public {
        ...
        uint256 Rewarded = CalcaluateRewardNew(msg.sender)/stakemineszarib;
    ...
    function CalcaluateRewardNew(address _user) view public returns(uint256){
        ...
        if(block.timestamp > (StartedTimer+PeriodTimeBySecond)){
            ...
            uint256 PercentOfTime = (StakedTime*stakezarib)/PeriodTimeBySecond;
