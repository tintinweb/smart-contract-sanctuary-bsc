...
contract WORLDWARFINAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WORLD WAR FINALE";
    string private _symbol = "WWF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b34cb6F299D44d874135e5A301Bdfd89387F7AC); // Marketing Address
    address payable public devFee = payable(0xf9144F3d4809B2C04bD6f92c1c49f6D13d84dF01); // devFee
