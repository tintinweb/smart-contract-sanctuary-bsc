...
contract TEST is ERC20, Ownable {
    ...
    constructor() ERC20("The Daleks", "DLK") 
    {
        ...
        maxWallet = _maxSupply * 10 / 100; // 3% Of total supply
        ...
        setTaxWallet(address(0xF40ed121bD2fFdf8c72aF38ae964C06A7b0AEfA8)); //set your wallet here
    ...
    */
    ...
    function setSellTax(uint256 _newSellTax) public onlyOwner {
        require (_newSellTax <= 90, "Max Sell Tax Limit is 30%");
