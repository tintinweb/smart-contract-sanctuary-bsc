...
contract GRIMJABEP20 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "GRIMJA";
    string constant _symbol = "GRIMJA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xF5aa089042374D86650e9a9Ebd7613537224ae6A;
