...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCAbe62f0400947ad8aa696d9690E206D6e342075; // owner address
...
contract ARBITRUMREWARDS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ARBITRUM REWARDS";
    string private _symbol = "AR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x280e08A4324583d756e372704232417b52B8EAE4); 
    address payable public teamWalletAddress = payable(0x280e08A4324583d756e372704232417b52B8EAE4);
