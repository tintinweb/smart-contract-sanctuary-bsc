...
/** 
 *  SourceUnit: c:\Users\ASUS\Desktop\ReflectionToken\contracts\MarsStreetInu.sol
*/
...
contract MarsStreetInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mars Street Inu";
    ...
    address public _buybackWallet = payable(address(0x456));
    ...
    constructor() {
        ...
        buyFee = Fee(20, 20, 10, 10, 10);
        sellFee = Fee(20, 20, 10, 10, 10);
        ...
        numTokensSellToAddToLiquidity = totalSupply().mul(5).div(10000);
    }
        ...
        )
    {
        ...
        tTransferAmount = tTransferAmount.sub(tBuyback + tMarketing + tBurn);
        ...
        )
    {
        ...
        uint256 rBurn = calculateBurnFee(tAmount) * currentRate;
        uint256 rMarketing = tMarketing.mul(currentRate);
        uint256 rTransferAmount = rAmount.sub(
            rFee + rLiquidity + rBuyback + rMarketing + rBurn
        );
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 forLiq = contractTokenBalance
            ...
            swapAndSendFee(contractTokenBalance - forLiq);

            swapAndLiquify(forLiq);
        }
    ...
    function swapAndSendFee(uint256 amount) private lockTheSwap {
        ...
        payable(_buybackWallet).transfer(newBalance - forMarketing);
    }
