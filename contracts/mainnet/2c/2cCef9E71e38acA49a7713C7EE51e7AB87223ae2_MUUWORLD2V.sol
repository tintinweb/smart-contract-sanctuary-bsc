...
// Telegram: https://t.me/mjlaunches
// No group chat yet channel only
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06Cb1DA45d42c46371fA91FADa0bA30035EF389E; // owner address
...
contract MUUWORLD2V is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muu World 2.0";
    string private _symbol = "Muu 2.0"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06Cb1DA45d42c46371fA91FADa0bA30035EF389E);
    address payable public teamWalletAddress = payable(0x06Cb1DA45d42c46371fA91FADa0bA30035EF389E); 
