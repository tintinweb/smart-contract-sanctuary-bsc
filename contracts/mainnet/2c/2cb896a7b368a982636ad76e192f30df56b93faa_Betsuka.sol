...
contract Betsuka is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BETSUKA";
    string private _symbol = "$BETSUKA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x87eDed894A4EdAFA55cE575407448056E8c2f2aE);
