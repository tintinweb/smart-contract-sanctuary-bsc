...
contract DAO is Context, IERC20, Ownable {
    ...
    string private _name = "DaoDoge";
    string private _symbol = "DDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5508240DeD56dA80b0Af137b918eF31CDbDee51A);
    address payable public teamWalletAddress = payable(0x026AAA36DCd02B8eeee1c4174B98D4829b86bb16);
