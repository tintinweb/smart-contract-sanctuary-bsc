...
// SPDX-License-Identifier: Unlicensed https://t.me/MiningDoge_BSC
...
contract MiningDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiningDoge";
    string private _symbol = "MiningDoge";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xd16a9FC59454F39dD5B706AbFc892De31cCC9D03);
