...
// no blacklist
// isVIP wallets to get in for normal taxes, while botters get taxes 85% of their bag.. Disable_VIP to go public
...
contract TEST is ERC20, Auth {
    ...
    uint256 public sellMultiplier  = 100; // Cannot increase this
    ...
    uint256 public swapThreshold = _totalSupply * 3 / 10000; //total amount of tokens contract will sell each time
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x852b6505dCE3f61d792A4a224Aea27F40cd7BFBA;
        devFeeReceiver = 0x852b6505dCE3f61d792A4a224Aea27F40cd7BFBA;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, address receiver) internal returns (uint256) {
        ...
        if(VIPmode && !isVIP[receiver] && !isSell){
            multiplier = 850;
        }
    ...
    function disable_VIP () public onlyOwner {
        VIPmode = false;
    }
