...
contract Luna is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0xAeB9060018C69994C827fa191E2864398674E4BC; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xAeB9060018C69994C827fa191E2864398674E4BC; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xAeB9060018C69994C827fa191E2864398674E4BC)] = true; //uniswap router liquidity
