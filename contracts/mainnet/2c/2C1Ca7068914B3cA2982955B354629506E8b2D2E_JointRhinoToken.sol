...
import "./JointRhinoTokenStorage.sol";
import {List} from "./JointRhinoTokenStructs.sol";


contract JointRhinoToken is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, JointRhinoTokenStorage {
    ...
    constructor(string memory baseURI_, address payee_) ERC721("JointRhinoToken","JRT") {
        baseURI = baseURI_;
        payee = payee_;
    }
...
contract JointRhinoTokenStorage {
