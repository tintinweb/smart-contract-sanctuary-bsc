...
Website
https://www.stepninu.com/

Twitter
https://twitter.com/stepninu
*/
/**
...
/* Token contract */
contract  STEPNINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xdD563Df9c88524142c8ca92b3b1f8129D81F2e74;
    ...
    // Name and symbol
    string constant _name = "STEPN INU";
    string constant _symbol = "STEPN";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 5241617 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 1000; // 1% on launch 
