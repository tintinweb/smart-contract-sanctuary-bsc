...
contract StableBeans {
    ...
    uint256 public MARKET_EGGS_DIVISOR = 5; // 50%
    uint256 public MARKET_EGGS_DIVISOR_SELL = 2; // 100%

    uint256 public MIN_INVEST_LIMIT = 5 * 1e18; /** 5 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 250 * 1e18; /** 250 BUSD  **/
