...
contract Pinjol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pinjol";
    //change the token symbol
    string constant _symbol = "Pinjol";
    //dont change that
    uint8 constant _decimals = 9;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 10_0000000000000e8;
    ...
    address public marketingFeeReceiver = 0xBAf18A3241df1778a4EDb9FCEa80009bc3b6c2A5;
