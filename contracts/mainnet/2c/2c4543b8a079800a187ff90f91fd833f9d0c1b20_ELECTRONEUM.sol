...
//** telegram https://t.me/ElectroneumBSC
...
/* Token contract */
contract ELECTRONEUM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7960Da0D15a6F1a1b7eef9FD6a60b58B6d65181E;
    ...
    // Name and symbol
    string constant _name = "ELECTRONEUM ";
    string constant _symbol = "ELECTRO";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 20mill
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 5000; // 2% or 2B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x15Be0D5E92DfF361e44a9Dcf9b66A1D3646617e9;
