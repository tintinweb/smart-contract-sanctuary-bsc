        ...
        if (whiteList[sender] || whiteList[recipient]) {
            ...
            if (sender == address(uniswapV2Pair)) {
                ...
                if (usdtSwitch) {
                    ...
                    if (AmountMarketingFeeBuy > 0) {
                         swapTokensForToken(AmountMarketingFeeBuy, address(this), address(usdtToken), usdtManageAddress);
                ...
                if (usdtSwitch) {
                   ...
                   _tokenTransfer(sender, address(this), usdtAmount);
                    ...
                    if (AmountMarketingFeeSell > 0) {
                        swapTokensForToken(AmountMarketingFeeSell, address(this), address(usdtToken), usdtManageAddress);
...
contract YFIV is ERC20 {
    ...
    constructor() ERC20Detailed("YFIV", "YFIV", 18) {
        ...
        _reviseTimestamp = 1659974400;//block.timestamp;
