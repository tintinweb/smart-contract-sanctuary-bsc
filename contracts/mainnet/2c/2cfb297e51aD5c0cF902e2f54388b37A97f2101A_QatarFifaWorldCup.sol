...
⚽https://t.me/qatar_fifaworld
🌐https://qatarfifaworldcup.xyz/
🕊️https://twitter.com/QATARFiFAWORLD5
*/
...
contract QatarFifaWorldCup is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xaE1508e5E1C6AA0BD0b64d7790C630FA4481153a;

    string constant _name = "Qatar Fifa World Cup";
    string constant _symbol = "QFWC";
