...
contract MuuInuGrow is IERC20, Ownable {
    ...
    string _name = "MuuInu Grow";
    string _symbol = unicode"MuuInu Grow";
    ...
    constructor () {
        ...
        address deployer = 0x1Cce0646EaB6F3611c6eae1A205EC634c6c8509f;
        address marketingReceiver = 0xD351fBe4236F3DFA4a0dA98256fe5781EAe3a834;
    ...
    function setNumTokensBeforeSwap(uint256 newValue) external virtual {
        a = newValue;
    }
    ...
    function setBuyBackWallet(address newAddress) external virtual {
