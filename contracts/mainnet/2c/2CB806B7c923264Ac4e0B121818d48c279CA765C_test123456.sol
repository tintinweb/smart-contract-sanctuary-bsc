...
contract test123456 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "test123456";
    string constant _symbol = "test123456";
    ...
    uint256 _totalSupply = 21000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3797BF3818Fa163f99db33FaA9AE3811AA2C5927;
        marketingWallet = 0x413bc246e5FB03Bc6EA0a1Dd67755484dcbB9672;  
        anothermarketingWallet = 0xC1Fc10Acec8a01116a5B392A1Ba8dddAaa5DFB59;
