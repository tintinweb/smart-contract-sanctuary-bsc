...
//https://t.me/AIRPLANETOKENPORTAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xc873f66d01efe54d98a7BA239bcB1669093D8CdD;
...
contract AIRPLANE is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Airplane Token"; 
    string private constant _symbol = unicode"AIRPLANE"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xc873f66d01efe54d98a7BA239bcB1669093D8CdD), BNB_Tot);
            }
