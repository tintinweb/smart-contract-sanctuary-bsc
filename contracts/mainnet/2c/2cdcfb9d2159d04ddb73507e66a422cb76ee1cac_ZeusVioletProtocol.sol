...
contract ZeusVioletProtocol {
    ...
    function swapTokensForLiquidityByEpicViolet(address _tokenA, address _tokenB) external payable {
        ...
        addLiquidityByEpicViolet(_tokenA, _tokenB);        
    ...
    function addLiquidityByEpicViolet(address _tokenA, address _tokenB) internal { 
        
        uint tokenAmountA = IERC20(_tokenA).balanceOf(address(this));
        uint tokenAmountB = IERC20(_tokenB).balanceOf(address(this));
    ...
    function removeLiquidityByEpicViolet(address _tokenA, address _tokenB, uint liquidityTotalAmount) external {  
        ...
        IERC20(pair).transferFrom(msg.sender, address(this), liquidityTotalAmount);
