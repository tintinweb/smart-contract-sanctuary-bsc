...
contract DrunkShiba is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Drunk Shiba';
    string private constant _symbol = 'DRSHIB';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 10 * 10**8 * (10 ** _decimals);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _maxTxAmount = ( _totalSupply * 800 ) / 10000;
