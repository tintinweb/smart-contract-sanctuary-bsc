...
Structured
DeFi Products
One protocol, every product
STRATEGIES FOR ALL
Yield Aggregated Power Sets
Multi-Asset PositionSingle-Asset DepositAutocompoundingLeverageHedging

Website :
https://www.seam.money/
Telegram : 
https://t.me/Seam_Money
Documentation : 
https://docs.seam.money/
...
contract SeamMoney is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Seam Money";
    string private _symbol = "$SEAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcaBdaBc3259231eBA133A297B2873C96301F0416); // Marketing Address
    address payable public teamWalletAddress = payable(0xcaBdaBc3259231eBA133A297B2873C96301F0416); // Team Address
