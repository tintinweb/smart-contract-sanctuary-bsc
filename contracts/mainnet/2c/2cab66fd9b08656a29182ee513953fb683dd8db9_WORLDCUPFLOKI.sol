...
// Telegram: https://t.me/WORLDCUP_FLOKI

// Website: https://www.worldcupfloki.win/

// Twitter: https://twitter.com/WorldCup_Floki
...
contract WORLDCUPFLOKI is Context, IERC20 { 
    ...
    uint256 public _tax_On_Buy = 8; // 2% Liquidity 6% Marketing to same wallet
    uint256 public _tax_On_Sell = 8; // 2% Liquidity 6% Marketing to same wallet
    uint256 public _maxTxAmount = _tTotal * 5 / 1000; // 0.5% at launch
    uint256 public _maxWalletToken = _tTotal * 35 / 1000 ; // 3.5% at launch

    address payable public DevWallet = payable(0x2C1D9AC9724CFB25C1dE21E97B4EAe1FC4Fdc5D0);
    address payable public MarketingWallet = payable(0x2C1D9AC9724CFB25C1dE21E97B4EAe1FC4Fdc5D0);
