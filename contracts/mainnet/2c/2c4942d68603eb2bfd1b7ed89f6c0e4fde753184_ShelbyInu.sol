...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @ShelbyinuBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ShelbyInu to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 50% total supply to the pool
   Can you make #ShelbyInu 10000X? 
   ...
   it's the best part of the #ShelbyInu idea, increasing the liquidity pool automatically, 
...
contract ShelbyInu is Context, IERC20, Ownable {
    ...
    string private _name = "Shelby Inu";
    string private _symbol = "SHELBY";
