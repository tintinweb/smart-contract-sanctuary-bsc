    ...
    PancakePairPrice
{
    ...
    // Events
    event ProjectCreated(address project, address owner, string name, string uri);
    ...
    // Create new project (Only creators)
    function createProject(
        ...
        address project = AlturaNFTFactoryV2(payable(factoryAddress)).createCollection(_name, _uri, false);
        ...
        emit ProjectCreated(project, msg.sender, _name, _uri);
    ...
    function addCreator(address newCreator) external {
        require(hasRole(ADMIN_ROLE, msg.sender), "Only admin can add new creator");
