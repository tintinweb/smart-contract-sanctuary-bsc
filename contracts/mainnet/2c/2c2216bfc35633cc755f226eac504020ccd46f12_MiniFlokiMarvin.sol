...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  $PALS = IBEP20(0x18D0717E9B3371a9EC4089CF0FE89e6591724556);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = $PALS.balanceOf(address(this));
        ...
        uint256 amount = $PALS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            $PALS.transfer(shareholder, amount);
...
/* Token contract */
contract MiniFlokiMarvin is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address $PALS =  0xbA2aE424d960c26247Dd6c32edC70B295c744C43; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "MiniFloki Marvin";
    string constant _symbol = "$MFM";
