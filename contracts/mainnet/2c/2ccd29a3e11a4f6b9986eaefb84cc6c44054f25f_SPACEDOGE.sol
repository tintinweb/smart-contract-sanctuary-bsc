...
/**
项目来源:向埃隆·马斯克致敬,他把Doge从地球带到了太空。我们不能输给狗。因 前有Spacedoge, 后有SpacedogeGodzilla, 这个月Spacedoge必出圈!!!! 项目方专业操盘手, 项目方这次 励志超越前史!!! 让太空狗变小一万倍!!!

此,SpaceDoge诞生了! 是新生代的FoMo代币,Defi助力我们飞上月球
Telegram : https://t.me/SpaceDogeChina
*/
...
contract SPACEDOGE is Context, IERC20, Ownable {
    ...
    string private _symbol = "SPACE DOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x09eB056c0E99EbFF083725e9bdeA41E4363C6769); // Marketing Address
    address payable public teamWalletAddress = payable(0x09eB056c0E99EbFF083725e9bdeA41E4363C6769); // Team Address
