...
contract Ownable is Context {
    address private _owner = 0xf04D4b40f44E48F9AD81E584f2576CB22ce87aeF;
...
contract TaiJi is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xDEcaC5825E785b29e39CbaE963D94DcEeBbD265e); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "TaiJi"; // token name
    string private _symbol = "TaiJi"; // token symbol
    uint8 private _decimals = 9; // 1 token can be divided into 10e_decimals parts

    uint256 private _tTotal = 5000 * 10**0 * 10**_decimals;
    ...
    uint256 public _marketingBNBFee =220; // marketing BNB fee
    ...
    uint256 public _minTokensSwapToAndTransferTo = 24 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
