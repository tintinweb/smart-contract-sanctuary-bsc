...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "iphone 14 promax";
    string private _symbol = "iphone 14 promax";
    ...
    address payable public marketingWalletAddress = payable(0x86fb18DDa8fB0FEEf4A39AF5081deFF84267EF05);
    address payable public teamWalletAddress = payable(0x561C4F656D32D591a43ECd540cfDa0c383c4c1Bc);
    ...
    uint256 public _walletMax =     210000 * 10**_decimals;
    ...
    function setBlackListAddress(address[] calldata Account,bool status) external onlyOwner(){
        for(uint256 i = 0; i < Account.length; i++) {
            _isblackList[Account[i]] = status;
        }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_isblackList[sender] && !_isblackList[recipient], 'Blacklisted address');
