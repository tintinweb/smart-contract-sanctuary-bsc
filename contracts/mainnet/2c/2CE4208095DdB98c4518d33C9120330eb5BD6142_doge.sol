...
contract doge is Context, IERC20, Ownable {
    ...
    string private _name = "0.1doge";
    string private _symbol = "0.1doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdb2934166bcca0Dea34bFEC1a173E2439Ade5E18);
    address payable public teamWalletAddress = payable(0xd3ff1Fb8De2291bE01fc63781489E395569CA66d);
    ...
    uint256 private _totalSupply =  1 * 10**8;
    uint256 public _maxTxAmount =   1 * 10**8; 
    uint256 public _walletMax =     1 * 10**8;
    uint256 private minimumTokensBeforeSwap = 1 * 10**6; 
