...
SHANRAI INU
SHANRAI INU is a token on the Binance Smart Chain that never stops growing 
through TRUE deflationary techniques and further income generation for its ecosystem. 

-------------- PROJECT AND ECOSYSTEM --------------
One of the main issues cryptocurrency projects face is the lack of continuous volume. 
This problem dampens marketing and development during low-volume days/weeks or even months.
SHANRAI INU solves this by hedging a portion of the marketing wallet into Yield bearing 
assets to generate additional income that can be used to develop further, Market, and in the future
long Term vision is to dominate the metaverse ecosystem (ShanraiVerse). We plan to have Land 
in the various ecosystems on Binance Smart Chain and other blockchains, 
Develop unique experiences, and generate revenue from advertising on said lands.

Our community is growing stronger by the day. Follow us on our social media platforms 
to get the most up-to-date, and accurate Shanrai information.

Telegram : https://t.me/ShanraiInu
Website  : https://shanraiinu.com/
Twitter  : https://twitter.com/shanraiinu
Reddit   : https://www.reddit.com/user/ShanraiInu

TOKENOMICS
>> NAME COIN : SHANRAI INU
>> SYMBOL    : SHANRAIINU
>> DECIMALS  : 9
>> SUPPLY    : 999.999

TAX BUY AND SELL 10% FUNCTION FOR :
>> AUTO BURN MECHANISM 1%
>> ADD TO LIQUIDITY POOL 2%
>> ADD TO MARKETING PURPOSES 7%

ANTI WHALE SYSTEM ACTIVED
>> MAX WALLET 3% 
>> MAX TRANSACTION 2%

" DO NOT BUY SHINRAI FAKE CONTRACTS, OTHER THAN THIS CONTRACT "

// ORIGINAL SHANRAI INU CONTRACT
...
contract SHANRAIINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x588776f8B50f8023Fa3F40FE9BA470038850e2C2); 
    address payable public Wallet_Dev = payable(0xA0EC19F089C84015618acC298e5ffBF5c0F58062);
    ...
    constructor () {
        ...
        _owner = 0x4Be900Cb8fbB2A56e8a12183507D3aafd1A4a840;
