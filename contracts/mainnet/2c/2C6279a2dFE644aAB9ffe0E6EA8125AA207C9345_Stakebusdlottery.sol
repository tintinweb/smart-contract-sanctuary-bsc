...
contract Stakebusdlottery is Context, Ownable , ReentrancyGuard  {
   
   address public dev = 0x7D4D145e0E572BAA319B9f11d6178cD1ed99a391;
   address public miner = 0xD2Ef70cA89711502F28628c4d74f5cd4F8573839;
   uint256 public dev_fee = 5;
   uint256 public miner_fee = 25;
...
// lotto 1 
    ...
    function pickWinner_lotto1() public{
        ...
        require(time1Id[1].timestamp <= block.timestamp);
          ...
          uint256 stakeBusdFee = SafeMath.div(SafeMath.mul(lotto1Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,stakeBusdFee);
          uint256 userReward = SafeMath.sub(lotto1Balance,totalFee);
          BusdInterface.transfer(dev,devFee);
          BusdInterface.transfer(miner,stakeBusdFee);
    ...
    function pickWinner_lotto2() public{
        ...
        require(time1Id[2].timestamp <= block.timestamp);
          ...
          uint256 stakeBusdFee = SafeMath.div(SafeMath.mul(lotto2Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,stakeBusdFee);
  ...
  if (players3[i]==ad){
    ...
    function pickWinner_lotto3() public{
        ...
        require(time1Id[3].timestamp <= block.timestamp);
          ...
          uint256 stakeBusdFee = SafeMath.div(SafeMath.mul(lotto3Balance,miner_fee),100);
          uint256 totalFee = SafeMath.add(devFee,stakeBusdFee);
