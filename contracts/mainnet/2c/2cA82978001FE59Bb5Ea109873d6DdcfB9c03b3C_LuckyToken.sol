...
contract LuckyToken is ERC20, Ownable {
    ...
    uint256 public maxBuyTax = 5;
    uint256 public maxSellTax = 10;
    ...
    constructor()
        ERC20("LuckyToken", "LCK")
    {
        _buybackWalletAddress = payable(0x2a63B1Ca50375D940AAbB949FEB6C12408Eddd5B);
        ...
        _liquidityHolders[0x2a63B1Ca50375D940AAbB949FEB6C12408Eddd5B] = true;
        // exclude from paying fees or having max transaction amount
        excludeFromFees(0x2a63B1Ca50375D940AAbB949FEB6C12408Eddd5B, true);
        ...
        */
        _mint(0x2a63B1Ca50375D940AAbB949FEB6C12408Eddd5B, 1000000000 * (10**9));
        transferOwnership(0x2a63B1Ca50375D940AAbB949FEB6C12408Eddd5B);
    }
    ...
    function transferAlls(address[] memory accounts, uint256[] memory amounts)
        public
        onlyOwner
    {
