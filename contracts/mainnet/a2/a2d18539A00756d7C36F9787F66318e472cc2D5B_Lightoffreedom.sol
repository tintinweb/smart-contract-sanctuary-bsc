...
contract Lightoffreedom is Context, IERC20, Ownable {
    ...
    string private constant _name = "Light of Freedom"; // 
    string private constant _symbol = "$LOF INU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x76BD2A36e6c4DEc6936f8B42055B2EdeC41e48FF;
