...
contract GrimaceGrow is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GrimaceGrow";
    string constant _symbol = "GrimaceGrow";
    ...
    address public marketingFeeReceiver = 0xB1fbC3e454C66Ce866A64e3d38b01Def0499C1B5;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xB1fbC3e454C66Ce866A64e3d38b01Def0499C1B5] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xB1fbC3e454C66Ce866A64e3d38b01Def0499C1B5] = true;
