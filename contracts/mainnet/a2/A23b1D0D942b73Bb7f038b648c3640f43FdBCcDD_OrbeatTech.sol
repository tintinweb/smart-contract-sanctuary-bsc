...
// Telegram : https://t.me/OrbeatTech
// Website : https://orbeat-tech.com/
...
contract OrbeatTech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orbeat Technology";
    string private _symbol = "ORBEAT";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x064AFd9B4d8883028Bce068286f9b02d947D05ED); // Marketing Address
    address payable public teamWalletAddress = payable(0x064AFd9B4d8883028Bce068286f9b02d947D05ED); // Team Address
