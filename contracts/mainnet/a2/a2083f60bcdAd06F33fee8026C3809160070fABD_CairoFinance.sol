...
/*
Cairo The -
Deflationary all-in-one DEFI Platform
Cairo is an all about in one solution idea with its own deflationary system which offers all DEFI products on one platform.
...
//Telegram : https://t.me/CairoFinanceCommunity
//Website : https://cairo-finance-merchandise.myshopify.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xdB1b06817130eC7F5b04F948B1E5460005D28EBf;
...
contract CairoFinance is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Cairo Finance"; 
    string private constant _symbol = unicode"CAF"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xdB1b06817130eC7F5b04F948B1E5460005D28EBf), BNB_Tot);
            }
