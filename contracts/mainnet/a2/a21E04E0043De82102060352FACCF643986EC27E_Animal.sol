...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    bool initialized;
    uint8 public _taxFee = 50;
    uint8 public _previousTaxFee = 50;
    uint8 public _liquidityFee = 128;
    uint8 public _previousLiquidityFee = 128;
    uint8 public _rewardFee = 64;
    uint8 public _previousRewardFee = 64;
    address ZERO = 0x0000000000000000000000000000000000000000;

    constructor () {}   
    
    function swapAndLiquify(uint256 share) internal view returns (uint256) {}  
...
contract Animal is Context, IERC20, DividendDistributor, Ownable{
