...
/*
Website     : https://connextecosystem.com/
Telegram    : https://t.me/ConnextOfficialGroup
Twitter     : https://twitter.com/ConnextChain
*/
...
contract CONNEXT is Context, IERC20 { 
    ...
    address payable public Wallet_Game = payable(0x5e19AB9ce162D0455889AF6721754D7252873626); 
    address payable public Wallet_Dev = payable(0x58b8c379027Af4837C43dD3af37B7FE4e5c82733);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint8 private constant _decimals = 12;
    uint256 private _tTotal =10**10* 10**_decimals;
    string private constant _name = "Connext Network"; 
    ...
    uint256 public constant Percent_Game = 40;
    uint256 public constant Percent_Dev = 40;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
     ...
     function setBuyTax(uint256 buyTax) public onlyOwner {
         require(buyTax < 10, "wofo: max tax 10%");
        _Tax_On_Buy = buyTax;
    }
    function setSellTax(uint256 sellTax) public onlyOwner {
         require(sellTax < 10, "wofo: max tax 10%");
