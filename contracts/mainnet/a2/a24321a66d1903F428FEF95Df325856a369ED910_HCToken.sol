...
contract HCToken is ERC20 {
    ...
    mapping(address => bool) private vip;
    ...
    constructor(
        ...
        address pair0 = IUniswapV2Factory(router.factory()).createPair(address(this), _bth);
        address pair1 = IUniswapV2Factory(router.factory()).createPair(address(this), _usdt);
        pairs[pair0] = true;
        pairs[pair1] = true;

        vip[address(this)] = true;
        vip[address4] = true;
        vip[_pool] = true;
        vip[_recipient] = true;
        vip[0xf52d87bBF8191E3A3E5f970ff55593cf170c5FbC] = true;
    }
