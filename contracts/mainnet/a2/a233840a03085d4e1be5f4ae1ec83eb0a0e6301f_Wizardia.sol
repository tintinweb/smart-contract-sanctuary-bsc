...
/*
Wizardia
HUGE Wizardia Airdrop: $10 250 USDT, 135 winners
The futuristic fantasy realm of Wizardia lives within a shattered reality 
filled with mystical powers that have NFTs at their core.
 As players fight to survive the fog, their efforts are rewarded with in-game 
 currency that translates to real-world profits.
PRIZES
...
🔗 Official links: https://linktr.ee/wizardia
*/
...
interface WizardiaAirDrops {
  ...
  /**
   * @dev Wizardia `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev Wizardia `amount` tokens from `sender` to `recipient` using the
...
contract WizardiaToken  is Context {
...
contract Wizardia is WizardiaAirDrops, Context, WizardiaToken  {
  
    // common addresses
    address private _owner;
    address private WizardiaStaking;
    address private WizardiaFarming;
    ...
    string public override name = "Wizardia";
    string public override symbol = "Wizardia";
    ...
    constructor(uint totalSupplyValue, address WizardiaStakingAddress, address WizardiaFarmingAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WizardiaStaking = WizardiaStakingAddress;
        WizardiaFarming = WizardiaFarmingAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WizardiaStaking] =  totalSupply * 4 /100;
        balances[WizardiaFarming] = totalSupply * 4 /100;
