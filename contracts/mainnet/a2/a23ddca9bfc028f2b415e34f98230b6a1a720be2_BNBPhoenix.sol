...
contract BNBPhoenix is Ownable {
    using SafeMath for uint256;

    uint256 constant public DEPOSITS_MAX = 100;
    uint256 constant public INVEST_MIN_AMOUNT = 0.05 ether;
    uint256[] public REFERRAL_LEVELS_PERCENTS = [500, 500, 100, 100, 100, 100, 100, 100];
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0xE0AFC782565319D5DF2Af07fB4547C0b1870Dec2);

    
    address payable constant public MARKETING_ADDRESS = payable(0xAaFeC90d41CE685166f914Cb751795Ef84C64aE6);
    uint256 constant public MARKETING_FEE = 1000;
    address payable constant public PROMOTION_ADDRESS = payable(0x00757753B8Cb624155F0aE4Ed08AF5CfbFff29AE);
