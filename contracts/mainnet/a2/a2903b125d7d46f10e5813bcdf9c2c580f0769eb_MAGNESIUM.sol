...
contract MAGNESIUM is Context, IERC20, Ownable {
    ...
    string private _name = "Magnesium";
    string private _symbol = "Mg";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9167faaBf863108f6F97A6e2c6bf06579d2bc87b); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xBB51A6ec773C3f76E242f932daFD121168BE439B); // buyback Address
