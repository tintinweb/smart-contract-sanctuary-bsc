...
contract pdb is Context, IERC20, Ownable {
    ...
    string private constant _name = "Prepump Detector Bot"; // 
    string private constant _symbol = "PDB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4B775DC320debdF337C37F4C0F150076544da7d3;
