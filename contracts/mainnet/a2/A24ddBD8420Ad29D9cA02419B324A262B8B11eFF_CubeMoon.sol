...
contract CubeMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CubeMoon";
    string private _symbol = "CubeMoon";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x893516450540C69CE7757B11482d9336f5913813); 
    address payable private teamWalletAddress = payable(0x4aD075D6339e2110c693457737BcDB884eDc6C7a); 
