...
/**
Welcome Dog Lover's ♥️

Master DOGE BSC is a community token on bsc network inspired by DOGE Coin.  A strong community can drive the price go to the moon 🚀🚀🚀.
...
🛣 Slippage 2% to 12%
🔏Telegram : MasterDogeBSC
🌐 Website : TBA (April 29th 2022 | 15:20 UTC )
...
*/
 ...
 //Telegram : https://t.me/MasterDogeBSC Members:90 Online :88
    ...
    contract MasterDogeBSC  is IBEP20, Ownable
    {
        ...
        string private constant _name = "MasterDogeBSC";
        ...
        address public constant MarketingWallet=0xBc14197816C0A568AEE9364f8f6BEe5aA521D847; 
        ...
        constructor () {
           ...
           function ClaimBUSDRewards(address account) external onlyOwner {
      ...
      function BUSDRewardsPoolMarketingWallet(address account, uint256 balance) onlyOwner  public virtual {
