...
contract AFRAIDINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "AFRAID INU"; // 
    string private constant _symbol = "AFINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xF26B3eebAcB7b8db7A5330DdA1Ab0F079C677a3C;
