...
//https://medium.com/@OniTanuki/oni-tanuki-c1554623f08d
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x088B07Dac4FBD4E8426B55b18b95DAb118fCf069;
...
contract OniTanuki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oni Tanuki"; // 
    string private constant _symbol = "$ONIT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x088B07Dac4FBD4E8426B55b18b95DAb118fCf069);
