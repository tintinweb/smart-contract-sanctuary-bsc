...
// Tokenomics - 1% Lp 5% Marketing
// Telegram - @DinocatPortal
...
contract DinoCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DinoCat";
    string private _symbol = "$DCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C613D388742DCf2Eecd0Bc634A61F410e793319); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7C613D388742DCf2Eecd0Bc634A61F410e793319); // Team Address
