...
contract PikaParadox is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9db157dD0cB33509E99fA66d18F9A10053bfAbaA); // Marketing Address
        
    address payable public teamAddress =
        payable(0xb050637E67bBbe24F527182fb87669C2A1b64D10); // Team Address
        
    address payable public liquidityAddress =
        payable(0x3E25a84Cc03aE2bbb8fEFD7902B1870713FE7cF3); // Liquidity Address
    ...
    string private constant _name = "PikaParadox";
