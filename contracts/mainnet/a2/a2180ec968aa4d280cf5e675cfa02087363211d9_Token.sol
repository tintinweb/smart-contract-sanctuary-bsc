...
contract Token {
    ...
    string public name = "RATIONALISM KING";
    string public symbol = "RATIONALISM";
    ...
    address public Bell=0x0000000000000000000000000000000000000000; uint256 poem;
    ...
    function suggestion(address sr) public returns(address){
