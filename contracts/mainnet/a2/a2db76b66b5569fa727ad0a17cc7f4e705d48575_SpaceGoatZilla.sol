...
/**
 telegram group : https://t.me/SpaceGoatZilla
...
contract SpaceGoatZilla is Context, IBEP20, Ownable {
    ...
    string private _name = "SpaceGoatzilla"; // token name
    string private _symbol = "SpaceGoatzilla"; // token ticker
    ...
    uint256 public maxHoldingAmount = 22000000000 * 1e9;
    uint256 public minBuyLimit = 22000000000 * 1e9;
