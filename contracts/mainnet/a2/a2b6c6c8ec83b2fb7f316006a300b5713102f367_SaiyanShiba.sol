...
Saiyan Shiba Official Smart Contract
@saiyanshiba
*/
...
contract SaiyanShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Saiyan Shiba";
    string constant _symbol = "S-SHIBA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xeFb83BA51690359f4c1B7B330434f50C9B930b5E);
