...
/**
   ...
   #sETH The New Season ETH
    
   Time: 5 PM utc Wednesday, May 18, 2022, UTC.

   #sETH will list on #BSC at 5:00 PM Wednesday, May 18, 2022, UTC.

   I make this #sETH to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewSeasonEth
   Great features: 1 Tax

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #sETH to the community and ensure it's 100% safe.

   I will add 1 BNB and 99% of the total supply to the pool
   Can you make #sBSC 10000000X? 
...
// CHANGE
contract NewSeasonEth is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "New Season Eth";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0c79E96E94393458F3C072741C1e86A8F30D08Df);
