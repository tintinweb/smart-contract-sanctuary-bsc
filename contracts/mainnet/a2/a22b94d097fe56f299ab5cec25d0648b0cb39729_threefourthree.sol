...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2CD235c37ac3239B4C19Ae1C5Ef60603353d8403; // owner address
...
contract threefourthree is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "343";
    string private _symbol = "343";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2CD235c37ac3239B4C19Ae1C5Ef60603353d8403); // 
    address payable public teamWalletAddress = payable(0x2CD235c37ac3239B4C19Ae1C5Ef60603353d8403); // 
    ...
    uint256 private _totalSupply = 343 * 10**_decimals;
