 ...
 */
contract OurBEP20 is Context, IERC20, Auth {
  ...
  function setPair(address _pair) public onlyOwner returns (bool) {
    require(pair == address(0), "forbidden");
    pair = _pair;
    return true;
  }
  ...
  function _transfer(
    ...
    require(
      !(blacklist[sender] || blacklist[tx.origin] || blacklist[msg.sender]),
      "anti bot"
    );
