...
contract StakingToken {
	...
	uint256 constant private INITIAL_SUPPLY = 100000000e18; // 100M
	uint256 constant private STAKE_FEE = 2; // 2% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 100000e19; // 1M

	string constant public name = "Staking Token";
	string constant public symbol = "STAK";
