...
contract HWT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Honor World Token";
    string private constant _symbol = "HWT";

    address public _PancakeSwapV1RouterUniswap = 0x0055F2D75498B829bF2d278029A0d4d7b3856ce7; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x0055F2D75498B829bF2d278029A0d4d7b3856ce7; //can be the same
