...
contract Garuda is Context, IERC20, Ownable {
    ...
    string private constant _name = "Garuda Inu"; // 
    string private constant _symbol = "GI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE7C38b011cc656484b76112CA7e7438F2166b159;
