...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE8202Fe37D4Ea8512addC07eE04A6eBc7450EA68;
...
contract JemaDigital is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x98EA49e1Ca18611E564fFA6b0a93a82Cf0A7B258;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "JemaDigital";
    string private _symbol = "JEMA";
