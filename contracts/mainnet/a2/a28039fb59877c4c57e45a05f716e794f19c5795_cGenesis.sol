...
library Address{
 ...
 contract cGenesis is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 20_000_000 * 10**9; // 0.2%
    uint256 public maxBuyLimit = 200_000_000 * 10**9; // 2%
    uint256 public maxSellLimit = 200_000_000 * 10**9; // 2%
    uint256 public maxWalletLimit = 200_000_000 * 10**9; // 2%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x98968585FcC58a3dB5758259752a7954793A8dE9;
    address public donationWallet = 0x98968585FcC58a3dB5758259752a7954793A8dE9;

    string private constant _name = "New Community Genesis";
    string private constant _symbol = "cGENESIS";
