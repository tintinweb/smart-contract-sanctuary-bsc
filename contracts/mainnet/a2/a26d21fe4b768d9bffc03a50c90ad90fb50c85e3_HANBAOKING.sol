...
contract HANBAOKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HANBAOKING";
    string private _symbol = "HANBAOKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x562DbAC6aAFa5951D58D37102EF2D99c97C28031);
    address payable public teamWalletAddress = payable(0x562DbAC6aAFa5951D58D37102EF2D99c97C28031);
