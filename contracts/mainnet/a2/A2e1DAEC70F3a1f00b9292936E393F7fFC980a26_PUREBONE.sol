...
TELEGRAM: https://t.me/purebonebsc
*/
...
contract PUREBONE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PURE BONE"; // 
    string private constant _symbol = "PBONE"; //    
