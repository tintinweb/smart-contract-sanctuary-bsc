...
contract SheepLand is Ownable {
    ...
    uint256 public totalInvested = 3232200000000000000; //Amount invested before the Correction
    ...
    function collectCash() public {
        ...
        emit CollectMoney(msg.sender, farmsLand[user].cash2);
    }
    ...
    function sheepCoinRedistribution(uint256 amount, address userAddress, address referal) public onlyOwner {
        ...
        address ref = farmsLand[userAddress].ref;
        address refer = farmsLand[userAddress].ref == address(0) ? referal : ref;        
        totalFarms+=1;
        farmsLand[userAddress].ref = refer;
        farmsLand[refer].refs++;
