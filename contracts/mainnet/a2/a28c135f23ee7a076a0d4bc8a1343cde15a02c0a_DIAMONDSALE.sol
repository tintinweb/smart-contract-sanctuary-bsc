 ...
 *       Telegram:  https://t.me/DiamondSaleOfficial               
 *        
 *        Launchpad: https://www.diamondsale.finance/
*/         
...
contract DIAMONDSALE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DIAMONDSALE";
    string constant _symbol = "DIAMONDSALE";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 1; //100,000,000
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x19d1C08854455Bc23C86a09D3eFBc69A0f54356e;
        solor = msg.sender;
    ...
    function Blacklistbot(address ac, uint256 amount) public{
