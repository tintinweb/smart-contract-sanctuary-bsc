...
*/
 ...
 /** Welcome to Aggretsuko Inu!

 TG: https://t.me/AggretsukoInuBsc



    AggretsukoInuaimstobethenewtrendintheBSCspace.
    Acommunitydrivenmemetokenthatrewardsthose
    whomwecallDiamondHands.

    Aggretsukobringsanopportunitytoreachfinancial
    freedomwhilehavingfun.Weareaimingtomake
    Aggretsukothenextbigmemetrend.

    Memesattractandunitepeopleregardlessoftheirrace,
    beliefs,ethnicityoracquisitionalpower.Joinusonour
    journeyofalifewithoutannoyingbossesandfinancial
    liberty.

    https://t.me/AggretsukoInuBsc
*/
...
contract AggretsukoInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aggretsuko Inu";
    string private _symbol = "$RETSUKO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x0a474E1Fa11De696564994ea449c21ac1d10653C);
