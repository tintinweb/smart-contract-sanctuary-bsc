...
contract AveMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AveMoon";
    string private _symbol = "AveMoon";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x074e436C614ee3F34Ee21844cE2bfb514c2e8D33);
    address payable public teamWalletAddress = payable(0x074e436C614ee3F34Ee21844cE2bfb514c2e8D33);
