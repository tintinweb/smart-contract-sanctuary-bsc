...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEdB5C38B6f54767835207c54B7C1E82A2d54f8D9; // owner address
...
contract Kissaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kissaki";
    string private _symbol = "Kissaki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEdB5C38B6f54767835207c54B7C1E82A2d54f8D9); // Marketing Address
    address payable public teamWalletAddress = payable(0xEdB5C38B6f54767835207c54B7C1E82A2d54f8D9); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 36;  // original 12
