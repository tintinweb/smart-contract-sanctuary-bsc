...
Folllow Us  https://t.me/TheLastStandingSquid
@TrustBei DEV
...
contract TLSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Last Standing Squid";
    string private _symbol = "TLSS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5e63E5c3d99959F141189FDD18fDDCf5c6704d03);
    address payable public teamWalletAddress = payable(0x07253AF081394b71c2bd2f7E3abC0d4e73a34634); 
