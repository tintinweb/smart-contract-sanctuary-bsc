...
Telegram: https://t.me/Squidillionaire
...
contract Squidillionaire is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xA52e77C55B15D65D57fa345c2faeCE74726fD83d;
    address DevelopmentWallet = 0xe0a056F972bd8b35277F55b4a914B789245B9099;

    string constant _name = "Squidillionaire";
    string constant _symbol = unicode"SQUIDAIRE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 888888888888 * (10 ** _decimals);
    uint256 public _maxTxAmount = 9000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 18000000000 * (10 ** _decimals);
