...
contract MTCToken is IBEP20, Ownable {
    ...
    constructor() {
        ...
        _balances[0x523eBAEFdd605B9297393d806184Ca635a034AeB] =_totalSupply; 
         emit Transfer(address(0), 0x523eBAEFdd605B9297393d806184Ca635a034AeB, _totalSupply);
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal {
        ...
        if(recipient == _lp_address){
            // 销毁
            uint256 _cFee = amount *3 / 100;
           _balances[address(0)] = _balances[address(0)].add(_cFee);
           _totalSupply = _totalSupply.sub(_cFee);
           emit Transfer(sender, address(0), _cFee);
