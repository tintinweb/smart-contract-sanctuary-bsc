...
contract OGGRIM is Context, IERC20, Ownable {
    ...
    string private _name = "OG Grimace";
    string private _symbol = "$OGGRIM";
    ...
    uint256 public maxBuyTranscationAmount = 500000 * 10**9;
    uint256 public maxSellTransactionAmount = 100000 * 10**9;
    uint256 public _maxWalletToken = 1000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 68196 * 10**9; 
