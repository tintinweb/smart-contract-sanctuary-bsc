...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4908d41D4863Ad341224aE02041926b8921b1c8; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "babyaptos";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4908d41D4863Ad341224aE02041926b8921b1c8); // Marketing Address
    address payable public teamWalletAddress = payable(0xD4908d41D4863Ad341224aE02041926b8921b1c8); // Team Address
