...
contract CXDAO is ERC20 {
	...
	address payable _fundAddress = payable(address(0x7cbAf99DdCE19219Aab81bfAE493761265dde114));
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
	address private _marktAddress = address(0xd859a330B5bdE29104fE28d25Dab34eF35d135eA);
    ...
    constructor(address tokenOwner,address root) ERC20("CxDao", "CxDao") {
