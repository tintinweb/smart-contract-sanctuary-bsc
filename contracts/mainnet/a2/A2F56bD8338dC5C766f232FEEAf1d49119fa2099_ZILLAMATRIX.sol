...
contract ZILLAMATRIX is IBEP20, Auth {
    ...
    string constant _name = "web3";
    string constant _symbol = "web3";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**10 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xB4B20f8D9dA118ba16a051cbF5C0D6FD31a91b6f;
