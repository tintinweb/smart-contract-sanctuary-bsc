...
contract Winter_DOG is IBEP20, Auth {
    ...
    string constant _name = "Winter DOG";
    ...
    address private marketingFeeReceiver = 0x6AafbF1aF38109f11f36928D7DcAfB68611c48a6;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        require((_marketingFee + _liquidityFee ) <= 45, "Must keep fees at 10% or less");
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
        require(swapThreshold > 0, "swapThreshold should be > 0");
