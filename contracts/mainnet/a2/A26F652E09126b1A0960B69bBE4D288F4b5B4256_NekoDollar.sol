...
💵 NEXT DOLLAR SUBSTITUTE
💵 BIG MARKETING HUGE
💵 LOW MC
💵 LOW TAXES
💵 VERIFIED, LOCKED, RENOUNCED AND PUMPING

@NekoDollar NEXT LAUNCH TODAY
...
contract NekoDollar is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x488eb0Ac704C7859B4d3935CF853D2cf095e99D3); 
    address payable public Wallet_Dev = payable(0x48b56d90562A5C940DB8e113D32ffDAE5A7B5450);
    ...
    string private constant _symbol = unicode"Neko Dollar"; 
    ...
    constructor () {
        ...
        _owner = 0x48b56d90562A5C940DB8e113D32ffDAE5A7B5450;
