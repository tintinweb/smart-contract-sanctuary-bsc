...
$SHEEP fairlaunch on 21/03/2022 @17:30 UTC

Feel Free to enjoy the group and make some friendSHEEPS!!!!

https://t.me/SHEEP_TOKEN

Buy your $SHEEP to enter our SPACESHEEP, Destination MOON!!!
...
Buy Tax 9%
Sell Tax (BAAAAHHHHH) 12%

BUSD Rewards AND $SHEEP Reflections all in one reasonably taxed community token! 

https://t.me/SHEEP_TOKEN

Join the FLOCK all the way to the MOON!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PRWDS = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //PancakeSwap Token (CAKE)
    address REWARDS;
    IRouter router;
...
contract SHEEPTOKEN is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'SHEEP TOKEN';
    ...
    uint256 public swapThreshold = ( _tTotal * 400 ) / 100000; // .40% of total supply
