...
contract CasinovegasCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Casino vegas Coin";
    string private constant _symbol = "CVC";
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
        uint256 liquidity;
    ...
    // Buy 1% reflection, 50% mkt, 40% dev, 1 loterry
    Taxes public buyTaxes = Taxes(1, 50, 0, 40, 1);
