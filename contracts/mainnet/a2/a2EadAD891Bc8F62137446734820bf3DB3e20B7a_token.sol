...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0xE574Cf0D6360118ff2Ecc9C65384Ec8e26eDDB91);
    address private _MarketAddress2 = address(0xE574Cf0D6360118ff2Ecc9C65384Ec8e26eDDB91);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("TTH", "TTH") {
        ...
        uint256 total = 1400**1 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x69B17b7B9Bd98A96f4220d4699920F5A065AF110, "");
        _;
    }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress2, amount.div(100).mul(1));
        super._transfer(from, uniswapV2Pair, amount.div(100).mul(4));
