...
Telegram    : https://t.me/analclassic
Website     : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x193A25f856223744b527622e49c2F02a406541D7; // owner address
...
contract AC is Context, IERC20, Ownable {
    ...
    string private _name = " AnalClassic ";
    string private _symbol = " AC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x193A25f856223744b527622e49c2F02a406541D7); // Marketing Address
    address payable public teamWalletAddress = payable(0x193A25f856223744b527622e49c2F02a406541D7); // Team Address
