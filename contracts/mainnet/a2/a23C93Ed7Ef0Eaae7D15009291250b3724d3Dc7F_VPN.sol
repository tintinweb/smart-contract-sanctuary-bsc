...
contract VPN is Context, IERC20, Ownable {
    ...
    string private _name = "VPN";
    string private _symbol = "VPN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC6681274Ef52bb7005adF8638CB2f8A897651529); // Marketing Address
    address payable public teamWalletAddress = payable(0x987044d59B4cc3ae7f125034db3cb7A24d5DC230); // Team Address
