...
contract TsundereGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsundere Girl"; // 
    string private constant _symbol = "TSUNDERE"; //    
