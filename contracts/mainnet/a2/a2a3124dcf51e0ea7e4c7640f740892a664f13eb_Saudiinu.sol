...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6AB0Ef7dF863Cf1fF97E42f43Bd021CDeaA510c3;
...
contract Saudiinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe9F4e5461A170c31E0390e83FFd7ABe51Abd051A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Saudi inu";
    string private _symbol = "Saudiinu";
