...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA2E4D65Ccfd273e25be27Af22B116f6497668A97; // owner address
...
contract GoldDogeGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldDoge GROW";
    string private _symbol = "$GDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2E4D65Ccfd273e25be27Af22B116f6497668A97); // Marketing Address
    address payable public teamWalletAddress = payable(0xA2E4D65Ccfd273e25be27Af22B116f6497668A97); // Team Address
