...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7faE7BE6F5F8c36CE90d20c47B53f48B4c333f36; // owner address
...
contract Charidoge is Context, IERC20, Ownable {
    ...
    string private _name = "ChariDoge";
    string private _symbol = "CD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7faE7BE6F5F8c36CE90d20c47B53f48B4c333f36); // Marketing Address
    address payable public teamWalletAddress = payable(0x7faE7BE6F5F8c36CE90d20c47B53f48B4c333f36); // Team Address
