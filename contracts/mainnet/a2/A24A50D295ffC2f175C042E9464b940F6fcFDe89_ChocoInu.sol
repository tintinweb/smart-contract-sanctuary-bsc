...
contract ChocoInu is ChocoInuDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ChocoInuTeam;
    address private CharityChocoInu;
    ...
    string public override name = "Choco Inu";
    string public override symbol = "Choco Inu";
    ...
    constructor(uint totalSupplyValue, address ChocoInuTeamAddress, address CharityChocoInuAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ChocoInuTeam = ChocoInuTeamAddress;
        CharityChocoInu = CharityChocoInuAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ChocoInuTeam] =  totalSupply * 4 / 100;
        balances[CharityChocoInu] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ChocoInuTeam pot
