...
✅ Safe contract 
✅ Safe Dev
✅ Well-connected Marketers
✅ Strong P2E Utility

⚠️ The project is currently under development. It will be 100% a Portal of the famous Nayan Cat game, structured in such a way as to give the player an economic return.


TELEGRAM : https://t.me/SpaceCatP2E

WEBSITE : https://www.spacecatp2e.com
...
contract SpaceCat is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 5; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 5; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 5; // 2% of supply
    ...
    string private constant _name = "SpaceCat P2E";
    string private constant _symbol = "SCP2E";
