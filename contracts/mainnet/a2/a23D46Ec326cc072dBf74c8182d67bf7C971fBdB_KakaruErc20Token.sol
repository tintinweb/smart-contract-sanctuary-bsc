...
// File: lab/kira_erc20_basic_token.sol
...
contract KakaruErc20Token is ERC20 {
    constructor(string memory name_, string memory symbol_, dAllocation[] memory allocations) ERC20(name_, symbol_) {
            for (uint256 i = 0; i < allocations.length; i++) {
                dAllocation memory alloc=allocations[i];
               _mint(alloc.wallet, alloc.allocation);
            }
    }
}