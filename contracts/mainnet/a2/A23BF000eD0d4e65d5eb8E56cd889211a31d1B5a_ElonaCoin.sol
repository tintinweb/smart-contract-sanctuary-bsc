...
contract ElonaCoin is Ownable, IERC20 {
   ...
   uint256 public _decimals = 6;
    ...
    string private _name = unicode"Baby ELONA COIN";
    string private _symbol = unicode"Baby ELONA COIN";
    uint public _liquidityFee = 3;
    uint public _marketingFee = 5;
    uint public _liquiditySellFee = 8;
