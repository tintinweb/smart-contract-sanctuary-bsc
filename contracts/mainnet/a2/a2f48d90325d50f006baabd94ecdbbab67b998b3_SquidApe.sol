...
contract SquidApe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x1C5B3DC93D6C65944Ad3B9002a8C2C76aA417a1A); // Marketing Address

    address payable public devAddress =
        payable(0x1C5B3DC93D6C65944Ad3B9002a8C2C76aA417a1A); // Buyback Address

    address payable public liquidityAddress =
        payable(0x1C5B3DC93D6C65944Ad3B9002a8C2C76aA417a1A); // Liquidity Address
    ...
    string private constant _name = "SQUID APE";
    string private constant _symbol = "SQPE";
