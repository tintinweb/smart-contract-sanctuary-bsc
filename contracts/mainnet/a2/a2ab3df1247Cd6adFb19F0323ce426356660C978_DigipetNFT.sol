...
contract DigipetNFT is Ownable, ERC721 {
  ...
  constructor(string memory name_, string memory symbol_, string memory uri_, uint left_, uint totalLeft_, uint reserved_, uint price_, address beneficiary_, address currency_) ERC721(name_, symbol_) {
    currentLeft = left_;
  ...
  function mint(address account) external {
    require(!pause, "pause");
    SafeERC20.safeTransferFrom(currency, _msgSender(), address(this), price);
    _mint(account);
  }

  function bulkMint(address account, uint count) external {
    require(!pause, "pause");
    SafeERC20.safeTransferFrom(currency, _msgSender(), address(this), price * count);
  ...
  function transferValue() external {
    ...
    emit TransferValue(balance);
    SafeERC20.safeTransfer(currency, _beneficiary, balance);
  }
