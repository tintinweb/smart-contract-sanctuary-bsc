...
contract KashimaInu is IERC20 {
    ...
    string constant private _name = "Kashima Inu";
    string constant private _symbol = "SHIMA";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x97430d52011242C40c4D74B95d336B56eADC4B16),
        charity: payable(0x5C318d1c8ACACD46C46119d492505907FBBc7789)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 charity) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.totalSwap = liquidity + marketing + charity;
