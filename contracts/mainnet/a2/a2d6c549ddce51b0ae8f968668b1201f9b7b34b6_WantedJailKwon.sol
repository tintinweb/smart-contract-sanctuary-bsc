...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15D51f65E9a8222fFd409502869C9Ca4C7aa8659; // owner address
...
contract WantedJailKwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WantedJailKwon";
    string private _symbol = "$WJAK"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0A42FFc8039e49Bde4d35dDc0407b40BFBEECB4b); // Marketing Address
    address payable public teamWalletAddress = payable(0x6a46092c35C4D0022686a6793d538E55E5441340); // Team Address
