...
contract InsiToken is Context, IERC20, Ownable {
    ...
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner {
        require(marketingFee <= 5, "Marketing fee cannot be more than 5%");
    ...
    function setSellBurnFeePercent(uint256 sellBurnFee) external onlyOwner {
        require(sellBurnFee <= 5, "Sell burn fee cannot be more than 5%");
        ...
        onlyOwner
    {
        ...
        require(
            maxBuyPercentPerTime <= 150,
            "Max holding percents cannot be more than 1.5%"
        );
