...
contract MARUTARONFT is ERC721, ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, ERC721Pausable {
	...
	uint256 public PRICE = 1000 * 10**14;
    ...
    event CreateMARUTARONFT(uint256 indexed id);
	
    constructor() ERC721("MarutaroNFTs", "Maru") {
        pause(true);
    }
