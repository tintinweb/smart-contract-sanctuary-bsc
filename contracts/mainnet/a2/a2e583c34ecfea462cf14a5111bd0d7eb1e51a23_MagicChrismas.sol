...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x754ee83FAEddEF38D088A869cA6B56E5D7998e48; // owner address
...
contract MagicChrismas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Magic Chrismas";
    string private _symbol = "Magic Chrismas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x754ee83FAEddEF38D088A869cA6B56E5D7998e48); // Marketing Address
    address payable public teamWalletAddress = payable(0x754ee83FAEddEF38D088A869cA6B56E5D7998e48); // Team Address
