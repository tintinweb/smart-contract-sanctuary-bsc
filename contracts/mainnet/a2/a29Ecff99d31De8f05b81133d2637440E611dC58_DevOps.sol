                ...
                if (_swapopenlist[to]) {
                    ...
                    if (!CTlockSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            ...
                            uint256 numTokensSellFORFund = amount * swapFee / 5000;
...
contract DevOps is CTToken {
    constructor() CTToken(
        ...
        "DevOps",//Symbol
        9,//Decimals
        10000000000000000,//Supply
        address(0xB94398Ccdf502a5AE8B8ECdFAdFf7afC7422A3BE),//FundAddress
        address(0xb4c52b4079489edF5565bED8315dFE45bd631a34))//SSAddress
    {
    }
}