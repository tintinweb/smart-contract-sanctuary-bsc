...
contract CoeusProtocol is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    string public _name = "Coeusprotocol.com";
    string public _symbol = "COEUS";
    ...
    uint256 public coeusBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = coeusBankFee.add(nftHolderFee);
    ...
    address public coeusBankReceiver;
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x31D29CFc7189ABF0eE4391B89a3304879215CB2b;
        treasuryReceiver = 0x23eEB7a98b20861238C193d5827924147a95C12E;
        insuranceReceiver = 0x41a51499ff0C709a8C4A33A22c3E2DB977fc5A03;
        coeusBankReceiver = 0x7B1ac682D4c978cC489fdCA093EB818fabAf0BAb;
        nftHolderReceiver = 0xFB8ce73B75f6B8Eb9dF45e4c4c0A558f44B8BA4D;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = coeusBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(coeusBankReceiver).call{
            value: currentBalance.mul(coeusBankFee).div(_currentFee),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _coeusBankReceiver
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        insuranceReceiver = _insuranceReceiver;
        nftHolderReceiver = _nftHolderReceiver;
        coeusBankReceiver = _coeusBankReceiver;
        lpReceiver = _lpReceiver;
    }

    function setAutoLiquidity(
        address from,
        ...
        require(this.balanceOf(from) >= token);
