...
// Elon Tweet Battle World 
// Buy sell Tax 6% Slippage 6/7
...
contract Token is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 2000 * 10 ** _decimals;

    uint256 public _maxTxAmount = 100 * 10 ** _decimals;

    uint256 public _fee = 7;

    string private _name = "Battle World";

    string private _symbol = "Battle World";
