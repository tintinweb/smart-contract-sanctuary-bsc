...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59957224B194910E938fBfd9e379AaA1D72BFe6f; // owner address
...
contract Proofofmoonshot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof Of Moonshot";
    string private _symbol = "$POM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3c520952e833fAe83e0BD29B2f11Bc7440666b9e); // Marketing Address
    address payable public teamWalletAddress = payable(0x3c520952e833fAe83e0BD29B2f11Bc7440666b9e); // Team Address
