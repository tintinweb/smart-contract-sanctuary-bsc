...
contract WorldCupNFT is SafeOwnable, NFTCoreV3, Mintable, Burnable, IMintableBurnableERC721V2 {

    constructor(
        string memory _name, 
        string memory _symbol, 
        string memory _uri
    ) NFTCoreV3(_name, _symbol, _uri, 3840) Mintable(new address[](0), false) Burnable(new address[](0), false) {
    }
