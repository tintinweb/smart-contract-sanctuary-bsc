...
contract EGM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EGM";
    string private _symbol = "EGM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5F3AC4C81980a262b458c0757fB681F2AC0f1543); // Marketing Address
    address payable public teamWalletAddress = payable(0xae9206B86Cbfb07DcbC9a8b547d7170c9cb66146); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2100000 * 10**13; 
