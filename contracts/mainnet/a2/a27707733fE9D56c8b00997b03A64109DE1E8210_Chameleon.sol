...
CHAMELEON SOCIALS:
    Telegram:  https://t.me/ChameleonBNB
    Website: http://chameleonbnb.com
    TWitter:  https://twitter.com/ChameleonBNB
...
Token fees are converted to BNB and paid as BNB dividends to holders. Dividends vest continuously over 3 days. If you sell early, you will miss out on some rewards. Hold and behold.
...
contract Chameleon is ERC20, Ownable {
    ...
    constructor() ERC20("ChameleonBNB", "CBNB") {
        _storage.router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _storage.pair = IUniswapV2Pair(IUniswapV2Factory(_storage.router.factory()).createPair(address(this), _storage.router.WETH()));
        ...
        _storage.marketingWallet1 = 0xd0CEaB4169725C872F102DD67CA5B794c43b1AE4;
        _storage.marketingWallet2 = 0x892C80AE9ab2E9A00cFF61868f8a75ac055521be;
    ...
    function getData(address account) external view returns (uint256[] memory dividendInfo, uint256 referralCode, int256 buyFee, uint256 sellFee, address biggestBuyerCurrentHour, uint256 biggestBuyerAmountCurrentHour, uint256 biggestBuyerRewardCurrentHour, address biggestBuyerPreviousHour, uint256 biggestBuyerAmountPreviousHour, uint256 biggestBuyerRewardPreviousHour, uint256 blockTimestamp) {
        ...
        (buyFee,sellFee) = _storage.fees.getCurrentFees();
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (takeFee) {
            ...
            (uint256 fees,uint256 buyerMint,uint256 referrerMint) = _storage.transfers.handleTransferWithFees(_storage, from, to, amount, referrer);
