...
contract BasisGame is TokenBGMWrapper {
    ...
    event Takebacked(address indexed user, uint256 amount);

	constructor(address _TokenBGM, address _TokenBGS) TokenBGMWrapper(IERC20(_TokenBGM)) public{
	    TokenBGS = IERC20(_TokenBGS);

        InitRewards = 1 * 10 ** 16;   //0.01BGS
        Interval = 3888000;   //45 days，3888000 seconds
        StartTime = 1656255600; /*2022-06-26 23:00:00*/
