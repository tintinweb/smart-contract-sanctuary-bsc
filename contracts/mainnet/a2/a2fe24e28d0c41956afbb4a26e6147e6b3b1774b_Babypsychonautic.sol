...
Welcome to Baby Psychonautic

we give Psychonautic rewards

TG: https://t.me/BabyPsychonauticBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x76efbf78A7f190B2Ee6Fd4E34ef97c338Be39749);
...
contract Babypsychonautic is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyPsychonautic";
    string constant _symbol = "BbPsycho";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x76efbf78A7f190B2Ee6Fd4E34ef97c338Be39749;

    uint256 _totalSupply = 10* 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = 4 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 4 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0x8F3fDfeAcE695881EcD5C79922D17F12Eb93cF0A;
        marketingWallet = 0x8F3fDfeAcE695881EcD5C79922D17F12Eb93cF0A;
        devWallet = 0x8F3fDfeAcE695881EcD5C79922D17F12Eb93cF0A;
