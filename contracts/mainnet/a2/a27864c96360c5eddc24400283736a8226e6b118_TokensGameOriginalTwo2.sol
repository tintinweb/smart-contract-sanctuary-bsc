...
struct User {
    ...
    function buyMinersRef(address ref, uint256 amount) public { // first purchase with referral link only
    ...
    function buyMiners2(uint256 amount) public { //other purchases
        require(amount >= 50000000000000000000);
        require(initialized);
