...
contract Dungeon is IBEP20, Auth {
    ...
    address GameDev          = 0xA15c49CBf7C51DC59Be279a6690DE3D74Bd3b305;
    address ContractDev      = 0x5cB76aDCdF05857D1301B78e57adB70c44F38c6E;

    string constant _name = "Dungeon";
    string constant _symbol = "DGN";
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _devFee2) external authorized {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        devFee = _devFee;
        devFee2 = _devFee2;
        totalFee = _liquidityFee.add(_marketingFee).add(_devFee).add(_devFee2);
        require(totalFee < 20);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _devFee2Receiver) external authorized {
