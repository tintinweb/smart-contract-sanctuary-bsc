...
contract SOCCERZILLA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Soccer Zilla";
    string private constant _symbol = unicode"SCZILLA";
    ...
    address payable public DevWallet = payable(0xb420c44Fe201d7408cb416196688A2C2B58Ea2F2);
    address payable public MarketingWallet = payable(0xB05CF2DE3f38Cd8cA8082f8F6aF09b9b7726412F);
    address payable private TeamWallet01 = payable(0xAD98170Ea1f82a12e29e2E4DD7337b35fcd28B3d);
    address payable private TeamWallet02 = payable(0x37A5bb0493Db89AC8b1cB7Fe8adD4D71deDB7EE8);
    address payable private TeamWallet03 = payable(0x827a57e29242Bd0a029eFDe491AC7B0f7926c368);
