...
contract eldonbsc is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ELDON";
    string private constant _symbol = unicode"$ELDON";
    ...
    address payable public DevWallet = payable(0xB338C85e9d1217F890732e140E96849d7336eaf3);
    address payable public MarketingWallet = payable(0x2d7331e5755ef246030a2eA06158b4743433DEBC);
