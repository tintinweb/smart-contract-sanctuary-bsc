...
contract PirateCoinzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PirateCoinzilla";
    string private _symbol = "PirateCoinzilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xFBfEAfAb6B704Eba3105A56eC9d3A2A5F035E95b); 
    address payable public ttWal = payable(0xFBfEAfAb6B704Eba3105A56eC9d3A2A5F035E95b); 
