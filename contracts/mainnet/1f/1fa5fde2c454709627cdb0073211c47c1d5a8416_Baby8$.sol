...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1502207218Cb733B82B2Bd7851716Fc9582cbCbe; // owner address
...
contract Baby8$  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby 8$";
    string private _symbol = "B$8";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17990eB4835013FdADDd073E1c4868F279A0ba70); 
    address payable public lotteryWalletAddress = payable(0x17990eB4835013FdADDd073E1c4868F279A0ba70); 
