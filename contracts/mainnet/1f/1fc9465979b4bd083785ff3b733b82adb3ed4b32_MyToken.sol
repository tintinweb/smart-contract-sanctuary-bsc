...
//This is just a practice token for futher deployments
// The delevoper is CT-5555 or @CT5555a in Telegram.
...
abstract contract Ownable is Context {
    ...
    constructor() {
         _owner = 0x428A672E848eabbFe3E69E7C5506186848479f4A;
...
contract MyToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xEFa1A213C5C4B63362cE408F4CAa4Ad4661943be);
    address payable public devWalletAddress = payable(0x428A672E848eabbFe3E69E7C5506186848479f4A);
    ...
    uint256 _liquidityShare = 40;
    uint256 _marketingShare = 40;
