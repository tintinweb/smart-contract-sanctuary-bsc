...
contract SHIBUSHI_Token is Context, IERC20, Ownable, SafeMaths {
    ...
    uint256 public _HoldLimit = 30_000_000 * 10**18;
    ...
    function setHoldersLimitEnabled(bool enabled) external {
        require(
            msg.sender == owner() || msg.sender == antiManager,
            'Only admin or anti manager allowed'
        );
