...
Website : https://babycryptogpt.ai
Telegram: https://t.me/BabyCyptoGPT
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8243f4b65d5c289cEA675CA6624Bbd09657C69c7; // owner address
...
contract BabyCryptoGPT is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCryptoGPT";
    string private _symbol = "BCGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8243f4b65d5c289cEA675CA6624Bbd09657C69c7); // Marketing Address
    address payable public teamWalletAddress = payable(0x8243f4b65d5c289cEA675CA6624Bbd09657C69c7); // Team Address
