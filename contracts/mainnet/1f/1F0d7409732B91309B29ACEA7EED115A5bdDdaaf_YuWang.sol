...
contract YuWang is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 50_000_000_000_000 * 10**18;
    uint256 public maxBuyLimit = 1_000_000_000_000_000 * 10**18;
    uint256 public maxSellLimit = 500_000_000_000_000 * 10**18;
    uint256 public maxWalletLimit = 2_000_000_000_000_000 * 10**18;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x19e84C5AeE19ecB5eDA79554B74C5A06f6b7f81e;
    address public devWallet = 0x49bA846148E81c7790ff5926c369271513b261E0;

    string private constant _name = "YuWang";
    ...
    Taxes public taxes = Taxes(3, 8, 2, 1);
    Taxes public sellTaxes = Taxes(3, 8, 2, 1);
