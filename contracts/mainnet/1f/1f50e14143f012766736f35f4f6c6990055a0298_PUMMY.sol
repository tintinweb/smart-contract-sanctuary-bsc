...
contract PUMMY is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PUMMY TOKEN";
    string private constant _symbol = unicode"PUMMY";
    ...
    address payable private DevAddress = payable(0x376153AeF38157EB3F4a146903C65aFBB9eF9973);
    address payable private MarketingAddress = payable(0x612d0b4CA7D893CFC7afDd62836a0BA68203110D);
