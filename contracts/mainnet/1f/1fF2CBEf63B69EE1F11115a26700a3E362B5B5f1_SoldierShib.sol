...
contract SoldierShib is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sholdier Shib";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;  //marketingwallet soldierShib
        anothermarketingWallet = 0x08bd2E0685C6d7aAab4a2713aC61D83bEc09934D;
