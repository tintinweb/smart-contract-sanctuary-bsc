...
INDODAX2.0
LP BURNED, OWNERSHIP RENOUNCED AND LOW TAX
https://t.me/indodax_Bsc20
...
contract Indodax20 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xED6d63B9a6a4045b5Cc137A45eB1aBD17c41ee0F); 
    address payable public Wallet_Dev = payable(0xD7372b10425A6B16FfCA402317E39396acCD868C);
    ...
    string private constant _name = "Indodax2.0"; 
    string private constant _symbol = unicode"IDX2.0"; 
    ...
    constructor () {
        ...
        _owner = 0xE52ED510CD50DAE6EBcF46F3d2b721dA7fb24f47 ;
