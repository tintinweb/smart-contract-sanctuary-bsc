...
contract Kengv2 is IBEP20, Auth {
    ...
    string constant _name = "Kengv2";
    string constant _symbol = "Keng2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10000000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4496A7228818a55063380E22b97275b3A258a491;
