...
contract Freedom
 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAebb6B7f3baa4e8463e8B48afA0840AAD64E47fD);
    address payable public teamWalletAddress = payable(0xAebb6B7f3baa4e8463e8B48afA0840AAD64E47fD);
    address public immutable deadAddress =0xAebb6B7f3baa4e8463e8B48afA0840AAD64E47fD;
    ...
    uint256 public _walletMax =     8000000000 * 10**_decimals;
