...
contract SPORTSMANIA is IERC20 {
    ...
    string constant private _name = "SPORTSMANIA";
    string constant private _symbol = "SPM";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xe63748497E200da68F2936B421E0f141903003F5),
        lottery: payable(0x56B5C206343d83aF6C04c4692C11bF524eb81Da5)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 lottery) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.lottery = lottery;
        _ratios.totalSwap = liquidity + marketing + lottery;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable lottery) external onlyOwner {
        require(marketing != address(0) && lottery != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - lotteryBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: marketingBalance, gas: 35000}("");
        }
        if (ratios.lottery > 0) {
            (success,) = _taxWallets.lottery.call{value: lotteryBalance, gas: 35000}("");
        }
    }
