...
/**
DogeMiftah is a meme token inspired by Deployer's ex co-founder Miftah.
Miftah launched SPAYv2 using another deployer wallet and runs with dev's money. Let's moon this meme token and get all Miftah's victim here (Previous Project SPAY. ATH 3 Millions Marketcap)

TG : https://t.me/DogeMiftah
*/
...
contract DogeMiftah is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeMiftah"; // 
    string private constant _symbol = "DOMIF"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xd5dcA34F341aD029dF6Cd9dd6bf0A84AC8B8FB82;
