...
contract PsyDuck is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x27aa37A3A6639CA567C06794B9fa28fa0b98c6ac);
    address payable public teamWalletAddress = payable(0x963E7365Caaf4B586c5235F5c10404A9ec800a9A);
	address public OwnerAddress = 0xfb62C76b76fabFF3dfEA46Ff2726Af8aa00c7d56;
    ...
    uint256 private _totalSupply = 10 * 10**4* 10**6 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 15 * 10**7* 10**_decimals; 
