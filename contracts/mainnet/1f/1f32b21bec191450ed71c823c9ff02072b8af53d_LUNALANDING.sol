...
$LUNA LANDING is a BSC smart chain contract with stable BUSD rewards designed to reward holders during this difficult time.

LUNA LANDING TOKENOMICS & TAXES
Total supply: 1,000,000,000 or 1 billion $LUNA tokens
Decimals: 18
Liquidty: 2% 
Marketing: 2%
BUSD reflections: 2% 
...
LUNA LANDING SOCIALS
Web: https://www.lunalanding.info
TG: https://t.me/lunalandingbsc
Twitter: https://twitter.com/lunalandingbsc
...
contract LUNALANDING is IERC20 {
    ...
    string constant private _name = "LUNALANDING";
    string constant private _symbol = "$LUNA";
    ...
    // BINANCE BUSD MAINNET TOKEN CONTRACT
    ...
    address payable private _marketingWallet = payable(0xe6E0095782Af734ED33B3D39e8cDC7755AD06F41);
    address payable private _buybackWallet = payable(0xe6E0095782Af734ED33B3D39e8cDC7755AD06F41);
