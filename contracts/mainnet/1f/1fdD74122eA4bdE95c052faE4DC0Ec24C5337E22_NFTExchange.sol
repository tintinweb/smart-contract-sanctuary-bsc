...
contract ExchangeCore is ReentrancyGuarded, Ownable {
        ...
        returns (bool)
    {
        ...
        /* fallback 鈥?attempt EIP-1271 isValidSignature check. */
...
contract Exchange is ExchangeCore {
    ...
    /**
     * @dev Call cancelOrder, supplying a specific nonce 鈥?enables cancelling orders
