...
6% BUSD rewards for our holders.
1% Liquidity.
1% Team.
5% Marketing.
...
contract BUSDemon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSDemon";
    string constant _symbol = "$BUSDemon";
