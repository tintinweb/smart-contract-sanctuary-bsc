...
contract SPF is Context, IERC20, Ownable {
    ...
    address public developerAddress = address(0x5C8aabB60e457F574c099355eDf3ae92A14A832F);
    ...
    constructor() public {
        ...
        _isExcludedFromFee[address(0xF291377b31b00c6276a6B201624fF38ce712E6df)] = true;
        _isExcludedFromFee[address(0xDB60a256C85dA2686f6494cA86DbFaB412d9B8C3)] = true;
        _isExcludedFromFee[address(0x9D22F0F7660A413FAC157677da2b2F6c31a5BBb0)] = true;
        _isExcludedFromFee[address(0x31d46Ce2f5f6392B04E6Be4C25CC339D70935569)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 1000000 * 10**18;
        _balances[address(0xF291377b31b00c6276a6B201624fF38ce712E6df)] = 500000 * 10**18;
        _balances[address(0xDB60a256C85dA2686f6494cA86DbFaB412d9B8C3)] = 480000 * 10**18;
        _balances[address(0x9D22F0F7660A413FAC157677da2b2F6c31a5BBb0)] =  10000 * 10**18;
        _balances[address(0x31d46Ce2f5f6392B04E6Be4C25CC339D70935569)] =  10000 * 10**18;

        emit Transfer(address(0), address(0xF291377b31b00c6276a6B201624fF38ce712E6df), 500000 * 10**18);
        emit Transfer(address(0), address(0xDB60a256C85dA2686f6494cA86DbFaB412d9B8C3), 480000 * 10**18);
        emit Transfer(address(0), address(0x9D22F0F7660A413FAC157677da2b2F6c31a5BBb0),  10000 * 10**18);
        emit Transfer(address(0), address(0x31d46Ce2f5f6392B04E6Be4C25CC339D70935569),  10000 * 10**18);

        doAddKol(address(0xaA24cd3db703572cC033F1fCAd6DB199F5475e21));
    }
