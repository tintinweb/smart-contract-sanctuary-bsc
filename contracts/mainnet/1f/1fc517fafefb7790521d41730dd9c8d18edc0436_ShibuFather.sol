...
/**
 ...
 JOIN HERE
 https://t.me/ShibuFather_portal

SHIBU FATHER is the leading intellectual property specialist 
who guides brands as they join the NFT and metaverse space 
to become part of the web3 revolution. As well as being 
true innovators in the space, SHIBU FATHER are bringing an entire 
DeFi product ecosystem to the market which includes: 
the FomoVERSE, The Avenue Marketplace, FomoLAUNCH pad, FomoSTAKE 
dApp and a revolutionary mobile social application for 
NFT collector; which are all powered with $FOMO token.Fomo Lab 
are ensuring NFTs are accessible to the masses and ensuring 
...
contract ShibuFather is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Shibu Father";
    string constant _symbol = "SHIBUDAD";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf7820c106C4EACACb8851fA429a4642a9e9f76c0;
