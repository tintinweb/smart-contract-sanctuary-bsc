...
contract SaleraPrivateSale is Ownable {
    ...
    uint256 public realeaseTime=1681540200;
    ...
    function updateCommisionWallet(address payable _wallet) public onlyOwner returns (bool) {
        commissionWallet=_wallet;
        return true;
    }

    function updateWithdrawTokenWallet(address payable _tokenWallet) public onlyOwner returns (bool) {
        tokenWallet=_tokenWallet;
        return true;
    }
