...
$FBURN is the newest, truest, and fastest hyper-deflationary, hyper-burning token on the BNB smart chain.
...
contract ForeverBurn is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Forever Burn';
    string private constant _symbol = '$FBURN';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x7D618257cb85F508784aEAB450dB77C7330Dd3FC);
    address public Development=payable(0x7D618257cb85F508784aEAB450dB77C7330Dd3FC);
    //TestNet
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3000 * 10**_decimals;
