...
contract BABYTWIZZLER is IBEP20, Ownable {
    ...
    string private _symbol = "BTWIZZLER";
    uint256 private constant INITIAL_SUPPLY = 1_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //elon can never set tax higher than this value
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 7,
        rewards: 0
        //@elon. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        elon: 0x30d910fc9EeAdCE8a17f6cA381eb3325949C17D4,
        team: 0x30d910fc9EeAdCE8a17f6cA381eb3325949C17D4,
        marketing: 0xDe8D1DB7652b06c62007f58369a5a1b940BeB2C0
    });
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdateelonWallet(address newelonWallet);
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on elon's chosen ratios
    ...
    //allows elon to change token name and symbol. 
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external onlyOwner {
        ...
        //elon can never set sells below 0.1% of circulating/initial supply
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newelon + newLiquidity + newteam + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newelon, newLiquidity, newteam, newMarketing, newRewards);
    }
    ...
    function withdrawelon() external authorized {
        ...
        uint256 amount = lostBalance ? elonBalance + remaining : elonBalance;
        elonBalance = 0;
        _sendBnb(_taxWallet.elon, amount);
    } 
    ...
    function setelonWallet(address payable addr) external authorized {
        address prevelon = _taxWallet.elon;
        _excluded.remove(prevelon);
        _taxWallet.elon = addr;
        _excluded.add(_taxWallet.elon);
        emit UpdateelonWallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 elon, uint256 team, uint256 marketing) {
        return (buybackBalance, elonBalance, teamBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 elonSplit = (bnbAmount*_taxRatios.elon) / distributeRatio;
