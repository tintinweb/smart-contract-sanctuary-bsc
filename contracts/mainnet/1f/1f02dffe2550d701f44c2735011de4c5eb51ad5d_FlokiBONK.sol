...
/* 
🐶Floki  💢BONK 🐶
https://t.me/Floki_BONK

✅ 100% Fair Launch 💨

Hello to all new members and welcome to Akita BONK!, the new hottest  💎  token on BSC , load up your BNB and get ready for takeoff !! 🚀
...
abstract contract ContextBinanceBNB {
...
contract OwnableBinanceBNB is ContextBinanceBNB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceBNB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceBNB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract FlokiBONK is ContextBinanceBNB, BinanceBNB, OwnableBinanceBNB {
