...
#StoneFi is a Future cryptocurrency solution that aims to enhance the $STONE ecosystem, lightning fast, low cost, which includes such useful utilities 
💎Stone Wallet 
💎Stone Swap 
💎Staking $STONE

Website: https://stonefi.org/
Twitter: https://twitter.com/stonefi_
Telegram: https://t.me/StonefiPortal
Medium: https://medium.com/@stonefibep20
*/
...
contract Stonefi is IBEP20, Auth {
    ...
    address constant DEV = 0x96fd7b0bDF1445eD09DfAD6B781A4A916e1E78cE;


    string constant _name = "StoneFi";
    string constant _symbol = "$STONE";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 200000000 * (10 ** _decimals);
