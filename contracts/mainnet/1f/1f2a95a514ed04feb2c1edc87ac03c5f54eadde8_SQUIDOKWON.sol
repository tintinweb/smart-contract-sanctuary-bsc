...
contract SQUIDOKWON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidDoKwon";
    string private _symbol = "SQUIDOKWON";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x3B780A5D240B06214F6964E590bEDa286ad8DcE9);
    address payable public teamWalletAddress = payable(0x5D108571b4372610EaCb946BC1D30f982538A227);
