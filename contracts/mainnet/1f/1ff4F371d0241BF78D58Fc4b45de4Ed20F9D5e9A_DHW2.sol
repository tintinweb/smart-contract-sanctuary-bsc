...
contract DHW2 is ERC20 {
    ...
    address private _fundAddress = address(0x0cE0c720B3E62911f3691366fb96A2b0cAf6eb69);
    address private _lpAddress = address(0x87A532da65b7707392181FB4f7CeFdE6aDB2f3bD);
    ...
    function _transfer(
        ...
        if(perparInviter[from] == to && inviter[from] == address(0) && amount == 1 * 10**14){ //0.0001
          inviter[from] = to;
        }
        bool isInviter = from != uniswapV2Pair && balanceOf(to) == 0 && perparInviter[to] == address(0) && amount >= 1 * 10**15; //0.001
        if(isInviter){
    ...
    function _takeInviterFee(
          ...
          for (int256 i = 0; i < 2; i++) {
              ...
              super._transfer(address(this), cur, amount.div(100).mul(rate));
              //}
          }
      }    
}