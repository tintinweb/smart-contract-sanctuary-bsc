...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  FPS = IBEP20(0x213503534d927424A5cdf6d580E9Fd408be9337a);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FPS.balanceOf(address(this));
        ...
        uint256 amount = FPS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FPS.transfer(shareholder, amount);
...
/* Token contract */
contract MINIfps is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address FPS = 0x213503534d927424A5cdf6d580E9Fd408be9337a; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Mini FPS";
    string constant _symbol = "MFPS";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 150 / 10000; // 2% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 2% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 10000; // 2% (100 mil)
