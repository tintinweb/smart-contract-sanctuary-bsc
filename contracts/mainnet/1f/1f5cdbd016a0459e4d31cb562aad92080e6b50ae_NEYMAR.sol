...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _destroyFee = 500;
    ...
    constructor (
        ...
        _limitAmount = 100000000000 * 10 ** Decimals;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (destroyAmount > 0) {
                ...
                _takeTransfer(sender, address(0x1c6BfcAE76f3eC77482FfEB08767A4Ae11F28f7c), destroyAmount);
            }
...
contract NEYMAR is AbsToken {
    constructor() AbsToken( 
        ...
        18,
        100000000000,
        address(0x1c6BfcAE76f3eC77482FfEB08767A4Ae11F28f7c),
        address(0x9Df380d230D36D4BaB3385Fe4f7607a6Da36913F)
    ){
