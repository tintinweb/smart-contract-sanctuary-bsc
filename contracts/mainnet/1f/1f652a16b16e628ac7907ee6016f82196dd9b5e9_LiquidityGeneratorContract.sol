...
contract LiquidityGeneratorContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "180 Token"; //
    string private constant _symbol = unicode"180"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x750197Ca2Ffc35705e8068d2BBA99b41f4490DeA;
    uint256 public ff = 1;
