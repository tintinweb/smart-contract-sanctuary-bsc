...
/*    Kuma Grow
            ...
            Telegram : https://t.me/KumagrowBSC
            Website : https://kumagrow.com/
...
contract BABYTOKEN is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x6dE3CC42a918A29AbBdac25B527b01d5b79c9C90);
    ...
    function remove_Random_Tokens(uint256 tokens) internal {
        ...
        _basicTransfer(address(this), Marketing_Wallet, totalRandom);
    }
