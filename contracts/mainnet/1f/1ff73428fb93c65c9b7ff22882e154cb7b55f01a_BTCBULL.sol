...
BTC BULL is a token that resides on the Binance smartchain network.  
Our goal in building this project is to maintain 
the strength of the cryptocurrency community as a beautiful future asset. 

Telegram : https://t.me/BTC_BULL2023
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c985Ff8AeEaE02B9AC48D49fA725455a392FD47; // BTCBULL
...
contract BTCBULL is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8c985Ff8AeEaE02B9AC48D49fA725455a392FD47); // BTCBULL
    address payable public teamWalletAddress = payable(0x8c985Ff8AeEaE02B9AC48D49fA725455a392FD47); // BTCBULL
    ...
    uint256 private _totalSupply = 6500000 * 10**_decimals;
    uint256 public _maxTxAmount = 162500 * 10**_decimals; 
    uint256 public _walletMax = 162500 * 10**_decimals;
