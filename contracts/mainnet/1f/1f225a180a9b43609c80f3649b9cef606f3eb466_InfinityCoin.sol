...
contract InfinityCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Infinity Coin";
    string private _symbol = "Infi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeC8A7De2e4b424281F5546070CF4B8b9eD81c4d0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xeC8A7De2e4b424281F5546070CF4B8b9eD81c4d0); // BuyBack Address
