...
// Father of neko 
// https://t.me/daddyneko
// https://twitter.com/DaddyNekoBsc
...
library Address{
 ...
 contract DaddyNeko is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xdFC77aFf5B8cAf9081A7F9900509Eb6DF587bFc1;
    address public donationWallet = 0xdFC77aFf5B8cAf9081A7F9900509Eb6DF587bFc1;

    string private constant _name = "DaddyNeko";
    string private constant _symbol = "DADDYNEKO";
    ...
    Taxes public taxes = Taxes(1, 2, 0, 0);
    Taxes public sellTaxes = Taxes(1, 2, 0, 0);
