...
https://t.me/Metacatcity
http://metacatcity.com/

METACAT CITY is the latest community-based token launched in the crypto world. We have created NFT MINTING/MARKETPLACE, STAKING POOLS and much more to follow. The team behind this project has extensive experience and is ready to ensure we significantly increase the value of our tokens for investors.
...
contract Metact is Ownable, IERC20 {
    ...
    uint public _liquidityFee = 40;
    uint public _marketingFee = 75;
    uint public _devFee = 5;
    uint256 public _totalFee = _liquidityFee + _marketingFee;
    uint public _liquiditySellFee = 40;
    uint public _marketingSellFee = 95;
    uint public _devSellFee = 5;
    uint256 public _sellFee = _liquiditySellFee + _marketingSellFee + _devSellFee;
