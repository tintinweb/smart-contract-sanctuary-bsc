...
contract ReignToken is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable  {
    ...
    function buyPresale(uint256 amount, bytes32[] calldata merkleProof) external {
        ...
        require(amount >= 43_478 ether, "You can't buy less than 43478 REIGN");
        require(tokenBuyPerPerson[msg.sender] < 869_565 ether, "You can't buy more than 2k");
    ...
    function clearStuckBusd(address _receiver) external onlyOwner {
        IERC20(busdToken).transfer(_receiver, IERC20(busdToken).balanceOf(address(this)));
    }
