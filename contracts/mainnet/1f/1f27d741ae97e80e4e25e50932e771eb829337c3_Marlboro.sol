...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB18C9285D640709596585E20FCEf1f415DaD52A3; // owner address
...
contract Marlboro is Context, IERC20, Ownable {
    ...
    string private _symbol = "MBORO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9D658c949500d93f9473372B137D7c134922765E);
    address payable public buybackWalletAddress = payable(0xAEF142337f77EFCE32B0b95cEd2952E270d5e744); 
