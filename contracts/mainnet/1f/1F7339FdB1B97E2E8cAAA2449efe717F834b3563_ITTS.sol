...
contract ITTS is ERC20 {
    ...
    address public nftDistributor = 0xcC8Ae4557b1c66D2ef240ab56D0AB95525a4C61a;
    ...
    function setDividendDistributor(address _dividendDistributor) public onlyOwner {
        nftDistributor = _dividendDistributor;
    }
        ...
        if (takeFee) {
            ...
            if (recipient == uniswapV2Pair) {
                ...
                if (inviterAddress != address(0)) {
                    ...
                    super._transfer(sender, address(inviterAddress), fee);
                    totalFee += fee;
                }
            } else {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        uint256 preAmount = IERC20(divAddress).balanceOf(nftDistributor);
        swapExactTokensForTokens(contractTokenBalance);
        uint256 curAmount = IERC20(divAddress).balanceOf(nftDistributor);
        INftDistributor(nftDistributor).deposit(curAmount - preAmount);
