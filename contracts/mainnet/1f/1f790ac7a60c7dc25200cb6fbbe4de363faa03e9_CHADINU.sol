...
library Address{
 ...
 contract  CHADINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2B3605f32Fb331aC00a5B1560797A563f764C27B;
    address public donationWallet =0x2B3605f32Fb331aC00a5B1560797A563f764C27B ;
    string private constant _name = "CHAD INU ";
    string private constant _symbol = "CIU";
