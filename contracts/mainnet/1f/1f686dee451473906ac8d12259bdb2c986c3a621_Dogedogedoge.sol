...
contract Dogedogedoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogedogedoge";
    string private _symbol = "Dogedogedoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF26F4C3bb40AfB63DE526981aB6192a1C27e944c); 
    address payable public BurnedWalletAddress = payable(0xF26F4C3bb40AfB63DE526981aB6192a1C27e944c); 
