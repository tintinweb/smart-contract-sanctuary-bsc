...
contract TWITTER96 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWITTER 1996";
    string private _symbol = "TWITTER96";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x02d9d26AA6de288499FbD6a305F47b5E2502f0a9); // Buy Back Address
