...
contract CAKEZILLAKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cake Zilla King";
    string private _symbol = "CZillaKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF69bB35019cA5DbdA21F33AB4dc25a1fca64fa08); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF69bB35019cA5DbdA21F33AB4dc25a1fca64fa08); // BuyBack Address
