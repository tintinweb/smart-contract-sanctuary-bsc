...
Portal: https://t.me/changvitalikzhao
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd1890808d44b2da0d641A09cE0961f6cd019e64B; // owner address
...
contract chang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Changvitalik Zhao";
    string private _symbol = "CZalik";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x008b99f32D329719d47fE09f8eeB7F7Ac867d28f); // Marketing Address
    address payable public teamWalletAddress = payable(0x008b99f32D329719d47fE09f8eeB7F7Ac867d28f); // Team Address
