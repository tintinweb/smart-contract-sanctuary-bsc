...
contract POF is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF4BD14D61a1e7A8Bc0f58287acf6211df10E5752); 
    address payable public Wallet_Team = payable(0xc83d8103A7139726E08c3Da6920c7d879A4db59b);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0xE97Fb61c8AB74DFBF08A856745E1286628A27B14); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;
    string private constant _name = "Proof Of Football"; 
    ...
    constructor () {
        ...
        _owner = 0xE97Fb61c8AB74DFBF08A856745E1286628A27B14;
