...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
...
contract BabyHiphopDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Hiphop Doge";
    string constant _symbol = "$BHD";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B;
    ...
    uint256 public swapThreshold = 3 * 10**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // wallets
        autoLiquidityReceiver = 0x566e55460419Ea9F8e256668C4B00A7d502D3934;
        marketingWallet = 0x566e55460419Ea9F8e256668C4B00A7d502D3934;
        devWallet = 0x566e55460419Ea9F8e256668C4B00A7d502D3934;
