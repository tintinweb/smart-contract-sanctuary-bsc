...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFa9c176cE1ab15A06083cA4Cf6909fa2729778bD;
...
contract CatTail is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc06e606b53e5d2d8712eF32FdEfc272b72EAc332;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cat Tail";
    string private _symbol = "CTAIL";
