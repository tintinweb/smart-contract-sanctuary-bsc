...
contract SaudiLaeeb is Ownable {
    using SafeMath for uint256;

    string constant public name = 'SaudiLaeeb';

    string constant public symbol = 'SaudiLaeeb';
    ...
    uint256 public _taxcfi = 5;
    uint256 private _previousTaxcfi = _taxcfi;

    uint256 public _burncfi = 4;
