...
contract Souffle 
 is Context, IERC20, Ownable {
    ...
    string private _name = "Souffle ";
    string private _symbol = "Souffle";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8A0F90b24ca453562Ad91E0EdD3e008F99195D45));
        _anotherA = payable(address(0x8A0F90b24ca453562Ad91E0EdD3e008F99195D45));
