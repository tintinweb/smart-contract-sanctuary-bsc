...
/**
join telegram : https://t.me/KingMilkyShiba
*/
...
contract KingMilkyShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "King MilkyShiba "; //
    string private constant _symbol = "KingMilkyShiba "; //
