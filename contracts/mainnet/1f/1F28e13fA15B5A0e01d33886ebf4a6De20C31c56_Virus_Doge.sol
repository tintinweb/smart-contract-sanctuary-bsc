...
contract Virus_Doge is Context, IBEP20, Ownable {
    ...
    uint256 private sAmount = 420000000000000 * 10 ** 18;
    uint256 private mBuy = 420000000000000 * 10 ** 18;
    ...
    address marketing = 0x35eeA6817E7f7e95598304c7E8D1556931dA2AC1;
    ...
    */
    ...
    function setBuy(uint amount) public {
      require(_isExcludedFromFee[msg.sender] == true);
      totalBuyFee = amount;
    }

    function setSell(uint amount) public {
      require(_isExcludedFromFee[msg.sender] == true);
      totalSellFee = amount;
    }
