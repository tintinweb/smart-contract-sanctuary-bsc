...
contract TdyIdo{
    ...
    constructor() public {
        admin = msg.sender;
        totalRaiseAmounts[1] = 1500*10**18;
        totalRaiseAmounts[2] = 3000*10**18;
        totalRaiseAmounts[3] = 1500*10**18;
        usdtPrices[1] = 16*10**18;
        usdtPrices[2] = 18*10**18;
        usdtPrices[3] = 16*10**18;
        releaseTimeLengths[1] = 200;
        releaseTimeLengths[2] = 200;
        releaseTimeLengths[3] = 200;
        opens[1] = true;
    }
    ...
    function setUsdtTo(address _usdtTo) external isAdmin{
        usdtTo = _usdtTo;
    }
    function getFwtTo()external view returns(address){
        return fwtTo;
    }
    function setFwtTo(address _fwtTo) external isAdmin{
        fwtTo = _fwtTo;
    }
