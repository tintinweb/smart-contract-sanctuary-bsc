...
contract SPF is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isExcludedFromLPRewardTrigger;
    ...
    address public developerAddress = address(0x9389058FC3B6dbb8fD67c7978687c876B3ba737C);
    ...
    constructor() public {
        ...
        _isExcludedFromFee[address(0x8633a1f5dfD869DeA39e51663bC19d711B8c4cD5)] = true;
        _isExcludedFromFee[address(0x5b41D3F67f6ACd17077fC099B70f5AECf44eF0B0)] = true;
        _isExcludedFromFee[address(0x108Ec1049A5dc9E6b6Cfea2992C076fD96842A67)] = true;
        _isExcludedFromFee[address(0x9389058FC3B6dbb8fD67c7978687c876B3ba737C)] = true;

        //exclude owner and this contract from lp reward trigger
        _isExcludedFromLPRewardTrigger[ownerAddress] = true;
        _isExcludedFromLPRewardTrigger[address(this)] = true;
        _isExcludedFromLPRewardTrigger[address(0x8633a1f5dfD869DeA39e51663bC19d711B8c4cD5)] = true;
        _isExcludedFromLPRewardTrigger[address(0x5b41D3F67f6ACd17077fC099B70f5AECf44eF0B0)] = true;
        _isExcludedFromLPRewardTrigger[address(0x108Ec1049A5dc9E6b6Cfea2992C076fD96842A67)] = true;
        _isExcludedFromLPRewardTrigger[address(0x9389058FC3B6dbb8fD67c7978687c876B3ba737C)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 3500000 * 10**18;
        _balances[address(0x8633a1f5dfD869DeA39e51663bC19d711B8c4cD5)] = 2495000 * 10**18;
        _balances[address(0x5b41D3F67f6ACd17077fC099B70f5AECf44eF0B0)] =    5000 * 10**18;
        _balances[address(0x108Ec1049A5dc9E6b6Cfea2992C076fD96842A67)] = 1000000 * 10**18;

        emit Transfer(address(0), address(0x8633a1f5dfD869DeA39e51663bC19d711B8c4cD5), 2495000 * 10**18);
        emit Transfer(address(0), address(0x5b41D3F67f6ACd17077fC099B70f5AECf44eF0B0),    5000 * 10**18);
        emit Transfer(address(0), address(0x108Ec1049A5dc9E6b6Cfea2992C076fD96842A67), 1000000 * 10**18);

        doAddKol(address(0xdF34b4A3695dcCCB730fb77a3F7f2366F70596Af));
    }
    ...
    function setExcludedFromLPRewardTrigger(address account, bool state) public onlyOwner {
        _isExcludedFromLPRewardTrigger[account] = state;
    }

    function isExcludedFromLPRewardTrigger(address account) public view returns (bool) {
        return _isExcludedFromLPRewardTrigger[account];
    }
    ...
    function _transfer(
        ...
        if (!_isExcludedFromLPRewardTrigger[from] &&
            turnOffLPReward && lpReward > takeLPRewardAmount && !isSwapPair(from) && !isSwapPair(to) && burnAddress != to) {
            massSendLPReward();
        }
