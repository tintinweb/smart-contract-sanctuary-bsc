...
contract BWROToken {
    ...
    constructor() {
        name = "Bawer Online"; // Sets the name of the token, 
        symbol = "BWRO"; // Sets the symbol of the token,
        decimals = 9; // Sets the number of decimal places
        uint256 _initialSupply = 1000000000 * (10**uint256(decimals)); // Holds an initial supply of coins

        /* Sets the owner of the token*/
        owner = payable(0x5b6DF8765D9429c5898EFd09F3110baa1d4B5d87);
