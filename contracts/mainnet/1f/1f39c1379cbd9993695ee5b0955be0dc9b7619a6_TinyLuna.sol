...
contract TinyLuna is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5aADF76296eCa824fbe60764f9C1B6A259cfC5dF); 
    address payable public Wallet_Dev = payable(0x5aADF76296eCa824fbe60764f9C1B6A259cfC5dF);
    ...
    string private constant _name = "Tiny Luna"; 
    string private constant _symbol = unicode"TLUNA"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 100 / 4000;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 100 / 8000; 
    ...
    constructor () {
        ...
        _owner = 0x5aADF76296eCa824fbe60764f9C1B6A259cfC5dF;
