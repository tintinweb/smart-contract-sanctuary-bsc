...
contract Dot is Context, IERC20 { 
    ...
    address payable public marketingAddress = payable(0x3ED7078B2e3b7a3FA99821B6b55415a4aD0B9BB7); 
    address payable public eventAddress = payable(0x6A021b81a48dfb29C469c1204be97090fd6C7faE); 
    address payable public devAddress = payable(0x42b647E0B1300ba90b9Cc3A6309B9579fef4e7F1);
    ...
    constructor () {
        ...
        _owner = 0x42b647E0B1300ba90b9Cc3A6309B9579fef4e7F1;
