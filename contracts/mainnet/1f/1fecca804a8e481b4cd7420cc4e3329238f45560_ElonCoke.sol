...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b4Dddd1fF9F94eD0fE1A7dAEf6380A3E37F9f21;
...
contract ElonCoke is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5f291AfF60e2a107c87640EdFd416775831Bf46E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ElonCoke";
    string private _symbol = "ELNCO";
