...
DO You Love Ripple and Bitcoin?
Ever wished You can earn Both For Free?

Well Now You Can, Just by Holding XRPBTC.
 ...
 #     # ######  ######              ######  #######  #####  
  ...
  #   #  #    #  #            #      #     #    #    #     # 
 #     # #     # #                   ######     #     #####  
Telegram: https://t.me/RippleCoinTG
*/
...
contract RippleCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RippleCoinDividendTracker public dividendTracker;
    ...
    constructor() ERC20("RippleCoin", "RIPCOIN") {
        marketingWallet = payable(0xAf2256bD35DD0B509f9001f5014045e8DDa43a4a);
        devWallet = payable(0xAf2256bD35DD0B509f9001f5014045e8DDa43a4a);
        ...
        dividendTracker = new RippleCoinDividendTracker(
            payable(this),
            router,
            0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE,
            "RippleCoinTRACKER",
            "RippleCoinLASSICTRACKER"
        );
...
contract RippleCoinDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    RippleCoin public RippleCoinContract;
    ...
    constructor(
        ...
        defaultToken = token;
        RippleCoinContract = RippleCoin(mainContract);
    ...
    function _transfer(
        ...
        require(false, "RippleCoin_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "RippleCoin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RippleCoin contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(RippleCoinContract);

            uint256 prevBalance = RippleCoinContract.balanceOf(address(this));
            ...
            {
                uint256 received = RippleCoinContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RippleCoinContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
