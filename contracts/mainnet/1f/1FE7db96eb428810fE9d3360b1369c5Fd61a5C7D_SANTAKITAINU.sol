...
contract SANTAKITAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SANTAKITA INU"; 
    string private constant _symbol = "SAKITA";    
