...
contract MILOKINGINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiloKingInu";
    string private _symbol = "MILOKINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFDC43479cfCbc95DCcE4E57550FCFACfeb449534); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x4Cd5636eD851e4aBC588170986196DEf29541633); // buyback Address
    ...
    uint256 private _totalSupply = 690000000000000 * 10**9;
    uint256 public _maxTxAmount = 69000000000000 * 10**9; 
    uint256 public _walletMax = 69000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 690000000000 * 10**9; 
