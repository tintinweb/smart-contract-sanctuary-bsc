...
contract RoverInu is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xff5b99dE479Bd48084829525b6dafA4AE229178F;
    address public devAddress = 0x1C0d03487EE8cc671a542923bD1E97F4df533D62;

    string private constant _name = "Rover Inu";
    string private constant _symbol = "RoverInu";
    ...
    Taxes public taxes = Taxes(1,2,5,2);
    ...
    // Owner cannot transfer out Rover Inu from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Rover Inu!");
