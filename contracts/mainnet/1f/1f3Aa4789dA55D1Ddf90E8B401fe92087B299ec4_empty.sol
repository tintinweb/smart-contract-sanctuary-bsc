...
contract empty is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "0";
    ...
    address internal constant development_receiver = 0xA66c708F5cF10AC7729147251Bb76FB037706E4A; 
    address internal constant marketing_receiver = 0xA66c708F5cF10AC7729147251Bb76FB037706E4A;
    address internal constant liquidity_receiver = 0xA66c708F5cF10AC7729147251Bb76FB037706E4A;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 transfertorec = 100000000000000;
        _balances[sender] = _balances[sender].sub(amount);
        //if (sender!=recipient || shouldTakeFee(sender, recipient))
        transfertorec = shouldTakeFee(sender, recipient) ? takeFee(sender, recipient, amount) : amount;
