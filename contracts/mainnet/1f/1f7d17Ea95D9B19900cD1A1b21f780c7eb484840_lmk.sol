...
//https://t.me/LeMonKeyToken
//https://www.lemonkey.xyz
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xBFF263aF1ABBaa4E135c2CCb5DD54B608698d710;
...
contract lmk is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"LeMonKey"; 
    string private constant _symbol = unicode"LMK"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xBFF263aF1ABBaa4E135c2CCb5DD54B608698d710), BNB_Tot);
