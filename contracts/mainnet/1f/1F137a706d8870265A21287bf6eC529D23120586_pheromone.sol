...
contract pheromone is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x73dF51602222A151d4f234060b1200dC15be900B); 
    address payable private teamWalletAddress = payable(0x51629AdED02C7eFc13b85B21a2f12a63Ccea454c); 
