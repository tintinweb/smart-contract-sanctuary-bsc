...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0xB104a776fdA9836Cd25a22B0a9B74A14354b9473);
...
/* Token contract */
contract ZombieBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xcD012B05e9577e5e8247F50604e17146B7d6e238;
    ...
    // Name and symbol
    string constant _name = "ZombieBsc";
    string constant _symbol = "$Zombie ";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 100T

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% on launch or 5T tokens
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 2.5% or 2.5T tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% or 5T tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xcD012B05e9577e5e8247F50604e17146B7d6e238;
