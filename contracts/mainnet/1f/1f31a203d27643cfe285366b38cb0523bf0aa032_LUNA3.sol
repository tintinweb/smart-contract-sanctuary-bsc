...
contract LUNA3 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "LUNA 3.0";
    string private _symbol = "LUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53cFbCdc6607c9Ef143f3A7d0ED27004907f2F38);
    address payable public DevelopmentWalletAddress = payable(0x53cFbCdc6607c9Ef143f3A7d0ED27004907f2F38);
    ...
    uint256 private _totalSupply = 3300300 * 10**9;
    uint256 public _maxTxAmount = 99009 * 10**9;
    uint256 public _walletMax = 3300300 * 10**9;
    uint256 private minimumTokensBeforeSwap = 3300300 * 10**9;
