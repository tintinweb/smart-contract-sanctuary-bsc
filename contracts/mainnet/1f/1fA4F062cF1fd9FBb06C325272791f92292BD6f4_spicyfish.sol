...
contract spicyfish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "spicyfish";
    string private _symbol = "SPICYFISH";
    uint8 private _decimals = 9;

    uint8 public newsupplydata;
    ...
    function checkin(address holder, bool exempt)
        external
        onlyOwner
    {
   ...
   function getnewsupply(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
