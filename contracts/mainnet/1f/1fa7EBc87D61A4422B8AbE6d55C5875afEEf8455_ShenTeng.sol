...
contract  ShenTeng is IBEP20 , Auth { 
    using SafeMath for uint256;
    string internal _name;
    string internal _symbol;
    uint8   internal _decimals;
    uint256 internal _totalSupply;
    string public tokenType="ShenTeng";
    ...
    constructor(  
        ...
        _name ="\xe6\xb2\x88\xe8\x85\xbe";
        _symbol = "\xe6\xb2\x88\xe8\x85\xbe";
        _decimals=18; 
        _totalSupply =  10**7 * 1 ether;
        ...
        fA=new allotDAO(ceo);
        marketingAddress = [address(fA),0xcA364B68C0d4DbFEC8B62037e741A353472d3bc9,0x3B90a75b9Ee3c4c2F338EF10381598390E901670,0x77b4a67E816EeD8d44A7AE196716940f513e4870];
        marketingShare=[15,20,5,5];  

        fees=Fee(500,500,500,10000);
        allot=Allot(9,1,0,10); 
