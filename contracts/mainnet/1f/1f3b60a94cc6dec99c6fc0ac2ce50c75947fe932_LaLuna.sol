...
contract LaLuna is ERC20, Ownable {                 //Contract name
   using SafeMath for uint256;
    ...
    address public marketingWalletAddress = 0x5292ACC7be139d4f78090ADfe489A38680dBA152;  //Marketing address
    address private foundationWalletAddress = 0x0000000000000000000000000000000000000000;  //Buyback Guard
