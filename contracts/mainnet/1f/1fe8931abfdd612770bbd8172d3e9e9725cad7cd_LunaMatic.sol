...
contract LunaMatic is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x22DEbD4A9694b951749d9EeD668e3fD8774Ba6E7);
    address payable public devWallet = payable(0xB0b7fe1e3Ff75c974c7D23E123EF0eD368B64a83);
    ...
    constructor(address router) ERC20("Luna Matic", "LUNAMATIC") {
