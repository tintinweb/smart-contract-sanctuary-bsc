...
//*************************************************************************************************//
// tg: @hotbirdinu  Elon musk favourite satelite at space x
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("HotBirdInu_Track", "Hbird", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract HotBirdInu is Main {
    ...
    constructor() Main (
        ...
        0xd228473d13733c8C984DdE7294BB8a0fd02eD44C,     // Marketing address
        0xd228473d13733c8C984DdE7294BB8a0fd02eD44C,     // Team address AND DEV
        0xd228473d13733c8C984DdE7294BB8a0fd02eD44C,     // Multi Use address (CHARITY)
