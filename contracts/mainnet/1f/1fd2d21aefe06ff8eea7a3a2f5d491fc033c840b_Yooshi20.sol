...
Telegram: https://t.me/yooshi2bsc
...
contract Yooshi20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "Yooshi 2.0";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x9a126392Bcb133b93d39CF2E3b500d7b11AEc36A);
    address payable public teamWalletAddress = payable(0x7320f46CfC1FAe8e3F0a5C9C6A46CC4b7A6D7022);
