...
contract SevenEleven is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 711_711_711 * 10**9;
    uint256 public _maxTxAmount = 17_117_117 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Seven Eleven"; // 
    string private constant _symbol = "7/11"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xb398a67c4F0F2f63654b3E23916aF9272194681f;
