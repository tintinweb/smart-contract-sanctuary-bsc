...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEB0B7ba4Eba31d8209795E5434151387cf6763e0; // owner address
...
contract Swiss is Context, IERC20, Ownable {
    ...
    string private _name = "Swiss";
    string private _symbol = "Swiss";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEB0B7ba4Eba31d8209795E5434151387cf6763e0); // Marketing Address
    address payable public teamWalletAddress = payable(0xEB0B7ba4Eba31d8209795E5434151387cf6763e0); // Team Address
