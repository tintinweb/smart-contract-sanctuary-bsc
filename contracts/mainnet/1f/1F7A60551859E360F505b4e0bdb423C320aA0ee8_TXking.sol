...
contract TXking is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "TXking";
    string private _symbol = "TXking";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x553821BC81Ae6e3D0B4c9EA78b1054811848AC04));
        marketingWalletAddress = payable(address(0x553821BC81Ae6e3D0B4c9EA78b1054811848AC04));
