...
Join Us in Our Community : https://t.me/BabyDogeBUSD
*/
...
contract BabyDogeBUSD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDogeBUSD";
    string private _symbol = "BDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb43bD31e4be0b7BdBb7F4bc1F9C595fEe9239a94);//REWARD ADDRESS
    address payable public teamWalletAddress = payable(0x2FFb732c45bE3E1c4d25Fdf7db575356A94dEd64); //MARKETING AND TEAM ADDRESS
