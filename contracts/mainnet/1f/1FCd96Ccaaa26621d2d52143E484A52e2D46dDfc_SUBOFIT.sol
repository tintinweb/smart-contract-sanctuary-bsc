...
contract SUBOFIT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SuboFIT";
    string private _symbol = "SUBO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xea9196C37c6B03008aCc4c0DE9791c95Ad2e55fE);
    address payable public liqWalletAddress = payable(0xea9196C37c6B03008aCc4c0DE9791c95Ad2e55fE);
    ...
    uint256 private _totalSupply =  100e6 * 10**_decimals;
    uint256 public _maxTxAmount =   5e6 * 10**_decimals;
    uint256 public _walletMax =     5e6 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1e5 * 10**_decimals;
