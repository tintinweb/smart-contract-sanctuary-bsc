...
contract BitCoinRun is Context, IERC20, Ownable {
    ...
    string private constant _name = " BitCoin Run "; // 
    string private constant _symbol = " $BTCRUN "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x6DcB5893c9e5d7A437C546eB034d0edB9774602a;
