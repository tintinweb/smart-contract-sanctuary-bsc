...
contract SkypeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8B530DB27B7294084841AfF0f485608E57c8875c); 
    address payable public Wallet_Dev = payable(0x4417aEB1cbf174Eb9A9b9b3778ad096266fe2faf);
    ...
    string private constant _name = "Skype Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x4417aEB1cbf174Eb9A9b9b3778ad096266fe2faf;
