...
//Telegram:https://t.me/OrcaWhaleBSC

//Orca whale, the most intelligent sea creature. The APEX predator of the sea, most dominant species of whale. Will now take over BSC animal trend, just like i takes over the whole sea!Implementing its famous nickname onto the space where anyone can be whale friendly.
...
contract OrcaWhale is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public  deadAddress = address(0x5EB500d435c730c6419b7706d120505a3AfD7D09);
    ...
    constructor() ERC20("Orca Whale", "$Orca") {
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0x5EB500d435c730c6419b7706d120505a3AfD7D09)
            ) { 
            _blacklist[to] = true;
            emit BoughtEarly(to);
        }
