...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb8faBcB1136B24478b4312bad213a92B9140b1b5;
...
contract DBNK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6747Ebb874A5Ac2480ED4d9A540beFFBB2Cf7608;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 325000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Debunk";
    string private _symbol = "DBNK";
    ...
    uint256 public _maxTxAmount = 325000000 * 10**18;
