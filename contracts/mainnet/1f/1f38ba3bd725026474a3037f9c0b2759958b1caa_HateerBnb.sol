...
contract HateerBnb is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HATEERBNB";
    string constant _symbol = "HTBNB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(7).div(100);
    uint256 public _maxWalletToken = _totalSupply.mul(7).div(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2B4B7480968579B7FCF8D768a2af7376cBaDE238;
        ecosystemfeeReceiver = 0x2B4B7480968579B7FCF8D768a2af7376cBaDE238;
