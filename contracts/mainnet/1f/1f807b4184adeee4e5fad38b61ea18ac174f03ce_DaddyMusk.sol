...
//This is a test run, if you are a real human do not buy this.
...
contract DaddyMusk is IBEP20, Auth {
    ...
    string constant _name = "DaddyMusk";
    string constant _symbol = "DaddyMusk";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 16) / 200; //3% 
    uint256 public _maxWalletSize = (_totalSupply * 8) / 100; //4%
    ...
    address private developmentFeeReceiver = 0xcDCD076cE6Fb6fF604d4D33E86870D641D5427D8;
