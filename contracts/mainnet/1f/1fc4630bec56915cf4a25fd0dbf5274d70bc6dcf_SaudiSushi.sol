...
contract SaudiSushi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Sushi";
    string private _symbol = "Saushi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5A183Ac62f3BDB589F52Af83D13b8DF4213309E);
    address payable public BuyBackWalletAddress = payable(0xa5A183Ac62f3BDB589F52Af83D13b8DF4213309E);
