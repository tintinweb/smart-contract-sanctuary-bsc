...
contract $MIGOS is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000000000 * 10**7; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100000000000 * 10**7; //
    string private constant _name = "Rest And Piece MIGOS"; // 
    string private constant _symbol = "MIGOS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 5;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x7BF6ef0e49A2a17Ad5F4c5a45bbdFD76dFCcCC16;
