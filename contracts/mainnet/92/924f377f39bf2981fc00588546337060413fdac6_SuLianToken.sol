...
contract SuLianToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SuLian";
    ...
    uint256 _totalSupply = 1 * 22000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 2000;
    ...
    uint256 public silentBlockNumber = 100;
