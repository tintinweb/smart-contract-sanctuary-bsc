...
/**
Welcome XLUNA Casino

Please join Our Socials:
Website: https://xluna.net/
Telegram: https://t.me/XLUNACasinoClub
Twiter : https://twitter.com/XLUNACasinoClub
...
contract xlunacasino is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XLUNA Casino";
    string private _symbol = "XLUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6Bae87cDC90CBb76292E50048F1d6B63CB6a0F44);
    address payable public teamWalletAddress = payable(0x6Bae87cDC90CBb76292E50048F1d6B63CB6a0F44);
