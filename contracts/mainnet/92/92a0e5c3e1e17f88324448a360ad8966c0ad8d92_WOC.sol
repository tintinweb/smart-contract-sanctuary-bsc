...
contract WOC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Whales Of Cash";
    string constant _symbol = "WoC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x168345AeC1B30276fCf01f6be7f7262307bdd203;  //marketingwallet
        anothermarketingWallet = 0x168345AeC1B30276fCf01f6be7f7262307bdd203;
