...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "BabySafeApe";
    string private _symbol = "BABYSAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc9F8AFc98d312B9FF4a06be8Cf2a8aF0B954F679); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc217f2EfBf55dD5D8f8BA21F9b533EE09DB9367F); // BuyBack Address
    ...
    uint256 public _walletMax = 20000 * 10**6 * 10**9;
