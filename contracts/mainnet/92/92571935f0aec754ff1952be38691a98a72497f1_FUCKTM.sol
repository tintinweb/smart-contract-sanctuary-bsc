...
contract FUCKTM is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "Fuck The Merge";
    string constant _symbol = "FUCKTM";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(devFee).div(totalBNBFee);
