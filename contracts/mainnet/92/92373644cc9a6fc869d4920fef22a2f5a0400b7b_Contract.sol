...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Les Bleus World Cup"; //
    string private constant _symbol = "LBWC"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xEA2E7013bcc5E7b04976ef9eE4eA5B4D784Dc59A;
