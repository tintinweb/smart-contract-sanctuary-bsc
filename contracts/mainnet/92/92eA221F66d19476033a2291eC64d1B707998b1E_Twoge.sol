...
contract Twoge is Context, IERC20, Ownable {
    ...
    string private _name = "Twoge2.0";
    string private _symbol = "Twoge2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8b8cf61E70f7A3E3f10519A68d1d4E1Dcc446A8d); 
    address payable private teamWalletAddress = payable(0x32B487302B64d95709a0964073AC801E116B9A93); 
