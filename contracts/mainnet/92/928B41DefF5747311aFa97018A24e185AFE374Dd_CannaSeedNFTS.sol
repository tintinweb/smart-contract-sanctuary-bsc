...
contract CannaSeedNFTS is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 420;
    uint256 public normalPrice = 0.42 ether;
    uint256 public presalePrice = 0.4 ether;
    ...
    constructor(string memory _baseURI) ERC721("CannaSeedNFTS", "CannaSeed Finance NFT") {
        baseUrl = _baseURI;
    }
