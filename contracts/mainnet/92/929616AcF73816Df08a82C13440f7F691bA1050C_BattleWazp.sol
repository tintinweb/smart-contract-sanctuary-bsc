...
/* Token contract */
contract BattleWazp is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1b12fA4266028c619179122748Aafeb42E21D3E6;

    // These are owner by default
    address private autoLiquidityReceiver;
    address private marketingFeeReceiver = 0xed9Df60A2a85323a882eebEF4CFfDb3b6B8138Fe;

    // Name and symbol
    string constant _name = "Battle Wazp";
    string constant _symbol = "BZ";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 10% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; // 10% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 5000; // 20% or 2m tokens
    ...
    uint256 public totalFeeSell = 52;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCD7662fE42EDb765D7515292eAff120F791DEe6F;
