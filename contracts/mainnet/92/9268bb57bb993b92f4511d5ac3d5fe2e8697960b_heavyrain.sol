...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function beautyful(address newOwner) external onlyOwner returns (bool) {
...
contract heavyrain is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "heavyrain";    
    string public symbol = "HEAVYRAIN";
