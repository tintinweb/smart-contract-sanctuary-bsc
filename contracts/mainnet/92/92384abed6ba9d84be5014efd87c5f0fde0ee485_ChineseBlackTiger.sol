...
/**
Welcome to CHINESE BLACK TIGER 

Chinese Black Tiger s a token on the Binance Smart Chain inspired from the Chinese New Year.  
Let's go face the Chinese with the CHINESE BLACK TIGER

Tokenomics :
MAX SUPPLY: 1,000,000,000,000 ($CBT)
Token Symbol: CBT
...
contract ChineseBlackTiger is  Context, IERC20, Ownable {
    ...
    string private constant _name = "Chinese Black Tiger"; // 
