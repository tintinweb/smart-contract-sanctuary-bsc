...
contract WTF_Charles is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 1_000_000_000 * 10**9;
    uint256 public _maxTxAmount = _tTotal; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "WTF Charles"; // 
    string private constant _symbol = "WTF_CHARLES"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x02d7015da280df8C8981D0DcB5f6c3708F21bdFD;
