...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyHoldTokenDividendFee = 200;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                ...
                uint256 fundAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyHoldTokenDividendFee) / 10000;
                if (fundAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + fundFee2 + lpDividendFee + holdTokenDividendFee;
        ...
        USDT.transferFrom(tokenDistributor, address(this), lpUsdt + fundUsdt + fundUsdt2);
    ...
    function setBuyFee(uint256 buyDestroyFee, uint256 buyFundFee, uint256 buyFundFee2, uint256 buyHoldTokenDividendFee) external onlyOwner {
    ...
    function setSellFee(uint256 sellDestroyFee, uint256 sellFundFee, uint256 sellFundFee2, uint256 sellLPDividendFee) external onlyOwner {
...
contract BEX is AbsToken {
    ...
    //SwapRouter
        ...
        address(0x16Ac73bFd55613e1A1F8934B64a3B41500C2fA5D),
        0,
        0,
        address(0xE1fbee1D22Eb702f0fAc134F1dd2bB50179E535a)
    ){
