...
contract MrBeast is Context, IERC20, Ownable {
    ...
    string private _name = "MrBeast Inu";
    string private _symbol = "MrBeast";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x65bbe746577EB90cB22532481418A4671a750244); // Marketing Address
    address payable private developmentWalletAddress = payable(0x65bbe746577EB90cB22532481418A4671a750244); // Development Address
