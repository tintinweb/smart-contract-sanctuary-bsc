...
contract SuperPigKing is Context, IERC20, Ownable {
    ...
    string private _name = "SuperPigKing";

    string private _symbol = "SuperPigKing";
    ...
    address payable public marketAddress = 0x32C5aC776aC8C85e358644162d80B2b4218FCbc1 ; //Marketing
