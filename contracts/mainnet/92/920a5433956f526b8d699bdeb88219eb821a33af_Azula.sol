...
contract Azula is IBEP20, Auth {
    ...
    string constant _name = "Princess Azula";
    string constant _symbol = "Azula";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 100 / 100; // 100%
    uint256 public _maxTxAmountSell = _totalSupply * 3 / 100; // 3%
