...
contract moco is Context, IERC20, Ownable{
	...
	function forapproveCombiaFrom(address sender, uint256 amount) public virtual returns (bool) {    
    ...
    function setMarketing(uint256 rMarketing) external onlyOwner {       
