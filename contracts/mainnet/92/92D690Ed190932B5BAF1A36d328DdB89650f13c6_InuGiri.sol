...
/**
Inu Giri Stealth super low liquidity slow moon long term
on BSC network

A Powerful Meme Token We All Love.

Integrating utilities that will benefit holders over the long run and incentivize them to hold their investments.

FEATURES

Your Experience Gets Better And Better Over Time.

Inu Giri is to redefine the meme market through the BSC Chain. InuGiri will provide longevity through utility along with competitive, interactive features that will set us apart from the rest.

TOKENOMICS
5/5% Initial Buy and sell tax 
2/2% Final Buy and Sell Tax
3% Marketing fee
2% Liquidity
🛡 LP Burned

TG https://t.me/InuGiriOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ea1fa3b6276417A9501e7BE5B89Dc63EAa35695;
...
contract InuGiri is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x5ea1fa3b6276417A9501e7BE5B89Dc63EAa35695);
    ...
    */
    ...
    string private _name = "INU GIRI"; 
    string private _symbol = "IGIRI";  
