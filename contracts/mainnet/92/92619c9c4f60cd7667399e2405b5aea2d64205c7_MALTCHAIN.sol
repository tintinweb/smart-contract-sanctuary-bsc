...
contract MALTCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MALTCHAIN";
    ...
    address payable public BuyBackWalletAddress = payable(0x27F06eB71393ecB5D49A6573E78631dEB1981558); // BuyBack Address
