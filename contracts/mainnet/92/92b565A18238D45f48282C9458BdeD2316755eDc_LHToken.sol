...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyFundFee + _sellFundFee) * 20 / swapFee;
        uint firstfundamount = fundAmount / 20;
        uint secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0x4223cB8747B19266Ac16282c7913B9B233358145;
...
contract LHToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x2dd4912B9A92de34b03Adb936010FDaa107Bf269),
    
        address(0xf9cEB180CE54D5B89e0fa4697AC7f63805483819)
    ){
