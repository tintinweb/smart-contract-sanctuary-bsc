...
contract CakeDorayaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xF000718b1e5508bb9eE43F1C5167b402f5658898); // Marketing Address
    address payable public devWalletAddress = payable(0xF000718b1e5508bb9eE43F1C5167b402f5658898); // Dev Address
    ...
    string private _name = "CakeDorayaki";
    string private _symbol = "$DORAYAKI";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x0690bC5a2dFC0FFd8f8C34711347d0caE6F61B51, 'We can not exclude Uniswap router.');
