...
contract Token is ERC20 {
	...
	address payable _fundAddress = payable(address(0x533Fa8291C8B3a51d9C72E219A3e77e93CA93645));
    address payable _fund1Address = payable(address(0x68d630f1b1064B09665c22129f05dE15c551E0C7));
    ...
    constructor(address tokenOwner) ERC20("Football dog", "Football dog") {
    ...
    function swapAndLiquify(uint256 canSwapAmount) private  {
		if(balanceOf(address(this)) >= canSwapAmount){
            ...
            _fundAddress.transfer(newBalance.div(5).mul(3));
