...
contract MoonVerseXRPDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonVerse XRP DAO";
    string private _symbol = "MXD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x423e601d464d1efB2db27B04b027e721FaC655C7);
