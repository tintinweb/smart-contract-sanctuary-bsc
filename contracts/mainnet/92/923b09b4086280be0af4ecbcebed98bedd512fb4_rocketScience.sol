...
contract rocketScience is ERC20, Ownable {
    ...
    constructor() ERC20("TEST TEST", "TEST") {
        ...
        maxTransactionAmount = 2_123_000 * 1e18; // 2% from total supply
        maxWallet = 2_133_000 * 1e18; // 2% from total supply maxWallet
        ...
        devWallet = address(0x6A54ee0354014cF5955bAdA79a67ec51a9811E78); // set as dev wallet
