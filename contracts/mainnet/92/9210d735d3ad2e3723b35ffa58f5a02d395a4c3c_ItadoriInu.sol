...
contract ItadoriInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x472f480DB266C7069a88cBAE73aAe4144bdd8b0D;
    string constant _name = "Itadori Inu";
    string constant _symbol = "ITADORI";
