...
contract SquidSonicInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidSonicInu";
    string private constant _symbol = "SQSINU";
    uint8 private constant _decimals = 9;

    uint256 private _tTotal = 100000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 2000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 2500000000 * 10**_decimals;
    ...
    function unauthorize() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
