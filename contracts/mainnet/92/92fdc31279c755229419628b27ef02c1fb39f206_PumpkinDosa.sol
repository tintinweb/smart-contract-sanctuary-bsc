...
contract PumpkinDosa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pumpkin Dosa";
    string private _symbol = "PMD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf14CA1264d7A2e23C68af4ba1466E3d12E4c8fe3);
    address payable public teamWalletAddress = payable(0xf14CA1264d7A2e23C68af4ba1466E3d12E4c8fe3);
