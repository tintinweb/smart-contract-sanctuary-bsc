...
/**
    ...
    Saitage Inu 2.0 is a low tax play for degen hunters
    Bullish name, easy mooning

    tg      : https://t.me/SaitageInu2
*/
...
contract SaitageInuTwo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8429061C471aa1E1698082D40f721AfFC51868C9);
    address payable public teamWalletAddress = payable(0x8429061C471aa1E1698082D40f721AfFC51868C9);
    ...
    string private _name = "Saitage Inu 2.0";
    string private _symbol = "SAITAGETWO";
