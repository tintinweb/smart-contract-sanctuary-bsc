...
library Address{
 ...
 contract M416 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD7C14B07118D5e796b6bd40B78CD918E88161F13;
    address public donationWallet = 0xD7C14B07118D5e796b6bd40B78CD918E88161F13;

    string private constant _name = "M416 Inu";
    string private constant _symbol = "M416";
    ...
    Taxes public taxes = Taxes(1, 2, 0, 2);
    Taxes public sellTaxes = Taxes(1, 2, 0, 2);
