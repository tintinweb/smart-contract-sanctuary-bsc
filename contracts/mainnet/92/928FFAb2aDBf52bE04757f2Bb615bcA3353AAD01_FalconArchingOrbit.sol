...
contract FalconArchingOrbit is Context, IBEP20, Ownable {
    ...
    string private _name = "Falcon Arching Orbit"; // token name
    string private _symbol = "$FAO"; // token ticker
