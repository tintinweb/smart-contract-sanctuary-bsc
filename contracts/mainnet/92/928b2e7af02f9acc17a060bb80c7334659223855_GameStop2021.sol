...
contract GameStop2021 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GameStop 2021";
    string private _symbol = "GME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd58F3bd569CC49de1Fe9A925D5caD8d784eb6773); 
    address payable public DevWalletAddress = payable(0x4907129a9E80bd66e00afbD2dBD1d46f6e301Cc6); 
