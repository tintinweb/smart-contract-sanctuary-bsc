...
contract DGNShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Dragon Share", "DSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 DGN Share for initial pools deployment
