...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeMint(
        address to, uint256 tokenId, bytes memory _data
    ) internal virtual {
        _mint(to, tokenId);
        require(
...
contract NFT is Context, ERC721Enumerable {
    ...
    uint256 public maxtid;
    string  private _baseTokenURI;

    constructor() ERC721("AMAX", "AMAX") {
    ...
    function setAdmin(address addr, bool val) public onlyOwner {
        admins[addr] = val;
    }
    ...
    function burn2(uint256 tokenId) public onlyOwner {
        _burn(tokenId);
    }
