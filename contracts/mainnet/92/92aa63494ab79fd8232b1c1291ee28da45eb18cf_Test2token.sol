...
contract Test2token is Context, IERC20, Ownable {
    ...
    string private _name     = "Test2token";
    ...
    uint256 public devTeamFee = 0;
    uint256 private _previousDevTeamFee = devTeamFee;

    uint256 public totalFees = taxFee + operationsFee + marketingFee + devTeamFee + charityFundrasingFee;

    address public marketingWallet = 0x000000000000000000000000000000000000dEaD;
    address public devTeamWallet = 0x000000000000000000000000000000000000dEaD;
    address public operationsWallet = 0x2307c99cFec5cace4689fb0890F6a330CC6e0F64;
    address public charityFundrasingWallet = 0x000000000000000000000000000000000000dEaD;    
    ...
    constructor() 
    { 
        address newOwner = 0x2307c99cFec5cace4689fb0890F6a330CC6e0F64;
    ...
    function removeAllFee() private {
        if(taxFee == 0 && operationsFee == 0 && charityFundrasingFee == 0 && marketingFee == 0 && devTeamFee == 0) return;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxForSwap = devTeamFee + marketingFee + operationsFee + charityFundrasingFee;
            if(taxForSwap > 0) {
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee + operationsFee + devTeamFee + charityFundrasingFee;
