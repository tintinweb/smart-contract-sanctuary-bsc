...
contract FIFA is IERC20, Ownable {
    ...
    address private marketAddress = 0x4c3Be2038765aBEafe0cCFB474a8cCF671c36968;

    uint256 private _tFeeTotal;

    string private _name = "Football World";
    ...
    uint256 public swapTokensAtAmount = _tTotal.mul(2).div(10**6); // 0.002%;
    uint256 public minDividendAmount = 10000;
    uint256 public maxBurnAmount = 20999000 * 10**18;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;
         if(_tOwned[address(this)] >= swapTokensAtAmount && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _tokenTransfer(
        ...
        if(isSell){
          _selTransferStandard(sender,recipient,amount);
        }else{
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= maxBurnAmount)_burnFee = 0;
    ...
    function _selTransferStandard(
        ...
        // market
        _takeMarketFee(sender, tAmount.div(10000).mul(_marketingFee));
        // LP
