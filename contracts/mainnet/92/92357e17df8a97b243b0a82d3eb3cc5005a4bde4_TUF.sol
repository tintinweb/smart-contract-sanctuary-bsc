...
/*
Telegram : https://t.me/TUFTokenBSC
...
contract TUF is Context, IERC20, Ownable {
    ...
    string private _name = "TUF Token";
    string private _symbol = "TUF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdF63f8eD779043FcE7c39948f858Ba601623CE88); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xdF63f8eD779043FcE7c39948f858Ba601623CE88); // buyback Address
    ...
    uint256 public _maxTxAmount = 8200000 * 10**9; 
    uint256 public _walletMax = 8200000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 3000  * 10**9; 
