...
contract SatoshiAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Satoshi AI";
    ...
    constructor (address liquidityAddress, address marketingAddress) {
        marketingWallet = marketingAddress;
        balances[address(liquidityAddress)] = _tTotal;
        ...
        emit Transfer(address(0), address(liquidityAddress), _tTotal);
    }
    ...
    function setSwapAtAmount(uint256 swapAtAmount) public onlyOwner {
        require(swapAtAmount <= 5000000, "SwapTokenAtAmount cannot be set higher than 0.5%.");
