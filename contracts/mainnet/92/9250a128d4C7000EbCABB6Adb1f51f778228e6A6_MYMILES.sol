...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79c893791b71628C4342c4b64e5Deea809E77cE6;
...
contract MYMILES is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x34D2CC699E2019b541401Ed80D278048142EBe48;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MYMILES";
    string private _symbol = "MYMILES";
