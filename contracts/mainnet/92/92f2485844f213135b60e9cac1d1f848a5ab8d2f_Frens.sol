...
contract Frens is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x947652c9AecEa5f568A6F4D68b76f30151aF20F1;
    address public devWallet = 0x947652c9AecEa5f568A6F4D68b76f30151aF20F1;
    address public buybackWallet = 0x947652c9AecEa5f568A6F4D68b76f30151aF20F1;

    string private constant _name = "FRENS";
    string private constant _symbol = "Frns";
    ...
    Taxes public taxes = Taxes(0, 5, 5, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 5, 0, 0);
