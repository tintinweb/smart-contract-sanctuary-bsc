...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 RWRD = IBEP20(0x7A155D5f79b72c03F3CE8BA70FD0457cDa9A2f35);
...
contract Perfuel is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 string constant _name = "Perfuel";
 string constant _symbol = "PRF";
 uint8 constant _decimals = 3;
 
 uint256 _totalSupply = 2100 * 10**3 * 10**_decimals;
 
 uint256 public _maxTxAmount = _totalSupply.mul(1000).div(100);
 uint256 public _maxWalletToken = _totalSupply.mul(1000).div(100);
 ...
 marketingFeeReceiver = 0xE4E83392bAcE87A48dbEcB4F71698B724410D9fd;
 teamfeeReceiver = 0xE4E83392bAcE87A48dbEcB4F71698B724410D9fd
;
