...
contract TWAPOracle is BridgeAppBase {
    ...
    event ReceivedPrice(address _pool, int24 price, uint256 blockNumber, uint256 blockTimeStamp);
    ...
    function sendV3TWAP(
        ...
        int24 price = int24(
            (tickCumulatives[1] - tickCumulatives[0]) / int56(uint56(_twapDuration))
        );
    ...
    ) external virtual onlyControllingAddress whenNotPaused {
        emit ReceivedPrice(_pool, _price, _blockNumber, _blockTimeStamp);
    }
}
