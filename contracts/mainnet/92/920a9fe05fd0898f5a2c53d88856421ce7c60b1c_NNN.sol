...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address secFundAddress = 0x07e95BC0Dd4201AD209ebfF7E23Ad63f48Ad8276;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 0 / 10000;
            if (burnAmount > 0) {
...
contract NNN is AbsToken {
    constructor() AbsToken( 
        ...
        6,   
        50000000,   
        address(0x07e95BC0Dd4201AD209ebfF7E23Ad63f48Ad8276),   
        address(0x07e95BC0Dd4201AD209ebfF7E23Ad63f48Ad8276)
    ){
