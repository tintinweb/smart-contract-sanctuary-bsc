...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF962598696ea19039a5d6363A59Eb99025C19B37;
...
contract CARBONZEROTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc05b900c4B6B8EB4e7C7fa3e4a539fA7F39bDFe3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CARBON ZERO TOKEN";
    string private _symbol = "CZT";
