...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _standardTransfer(address sender,address recipient,uint256 amount) internal{
        if(whitelist[sender] == true || whitelist[recipient] == true){
            ...
            emit Transfer(sender, marketing, amount.mul(3).div(100));
    ...
    function _addLiquidityControl() internal{

        if(IERC20(uniswapV2Pair).totalSupply() > 0 && _balances[address(this)] >= 1e18){
            uint256 balances = _balances[address(this)];
            _sellAndAddLiquidity(balances);
        }

    }

    function _sellAndAddLiquidity(uint256 amount) private{
    ...
    function _sellTokenToBNB(uint256 amount) private{
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private {
        ...
        IUniswapV2Router02(uniswapV2Router).addLiquidityETH{value: bnbAmount}(
            address(this),
            tokenAmount,
            0, 
            0, 
...
contract Aee is ERC20{

    constructor()ERC20("AEE","AEE"){
        manager = msg.sender;
        _mint(msg.sender, 100000e18);
        uniswapV2Router = 0xa5B1020DE06D21dd9F1209aC462e3c5C86375438;
        ...
        marketing = 0x71F1e9E46e4003cB0174530c2a2E7677a0781135;
