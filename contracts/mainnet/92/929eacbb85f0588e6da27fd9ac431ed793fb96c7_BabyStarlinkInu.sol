...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xc95765C92F75b55d567653C4F58312e0AB9fbC60);
...
contract BabyStarlinkInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyStarlink Inu";
    string constant _symbol = "BSTARLNK";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xc95765C92F75b55d567653C4F58312e0AB9fbC60;
    ...
    uint256 public swapThreshold = 3 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x8fa84Bfcc3Fa11954242CfB72C584AB52AE24B44;
        marketingWallet = 0x51b74cacF2C5B0940a636BdDFFaD1F575328319d;
        devWallet = 0x8fa84Bfcc3Fa11954242CfB72C584AB52AE24B44;
