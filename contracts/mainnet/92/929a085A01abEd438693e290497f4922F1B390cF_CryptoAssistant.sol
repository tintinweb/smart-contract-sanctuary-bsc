...
contract CryptoAssistant is ERC20, Ownable {
    ...
    address private marketingWallet = 0x75F45307f720df190269b569A024A12752ece262;
    address private devWallet = 0x97c9795201E4979417d63a88EBeFfeBe329d423E;
    ...
    Taxes public sellTaxes = Taxes(5, 3, 0);
    ...
    constructor(address routerAdd) ERC20("CryptoAssistant", "CAS") {
    ...
    function UpdateBuyTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 8, "Buy taxes up to 8% only");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 16, "Sell taxes up to 16% only");
    }
