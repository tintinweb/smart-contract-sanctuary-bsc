...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D494fb31C65450659D5A596140FC029Ae254eED;
...
contract ListenbourgMoney is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe66bc11FDFca333bbd2F7E10b2Dd58136b867F68;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Listenbourg Money";
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**2;
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**2;
