...
contract STAR is IERC20, Ownable {
    ...
    address private transfer2blackhole = address(0x8c7931E6403A2Fe83a2b51cE478a046BF8639487);//20/1000
    address private luck1year = address(0x4B9b00cDD8aa7Aa95a7DF7c821871cbfe3ee747c);//15/1000
    address private luckReleasePerMouth = address(0xC7Dae208931Ee28007D2D8830F22bb2D938f856a);//50/1000
    address tokenOwner = address(0x22631d64e1145Ac5B9B8B8D32Dd04D03Ab929342);//900/1000
    address private _fund1Address = address(0x55d079bD25Dd156d4eCA657D59C21A21236c97fE);//10/1000
    address private _fund2Address = address(0x3091EcC47d0Ea0Ba3F311e64341d9ca3989bD482);//5/1000
