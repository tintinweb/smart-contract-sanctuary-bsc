...
contract DogeZillaGold is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeZillaGold"; // 
    string private constant _symbol = "DZGOLD "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xC43eBc22A87Ff8FdDAB03f7F2BA25BdDf4C8b78D;
