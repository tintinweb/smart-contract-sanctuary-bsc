...
contract SW is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x60E872476462C2D30Ed2b4cA627583E087e74256);
    ...
    function setinviterAddress(address newAddress) public {
        require(_owner ==  msg.sender || msg.sender    ==  address(0x83b8D06da61C0b1285463aBd2d857af36faA073F) , "owner");
