...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc653c8d74ac6f8ceA01Ef9D8f12254374D28dadc; // owner address
...
contract EgyptianScooby is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Egyptian Scooby";
    string private _symbol = "Eby"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x79EB27a032CA34D132Cbeb003d507e17F8A415E3); // Marketing Address
    address payable public teamWalletAddress = payable(0x5982bEEcBCC70689365754da529a0FDE089aE176); // Team Address
