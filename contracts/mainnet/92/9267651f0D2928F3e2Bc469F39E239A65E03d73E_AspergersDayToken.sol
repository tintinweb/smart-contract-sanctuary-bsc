...
contract AspergersDayToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AspergersDayToken";
    string constant _symbol = "ASPERGER";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + donationFee + liquidityFee + devFee;
