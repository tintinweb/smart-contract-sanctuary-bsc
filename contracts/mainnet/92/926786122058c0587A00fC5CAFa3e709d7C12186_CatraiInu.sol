...
/*
    Join the community: https://t.me/CatraiInuofficial
    Twitter: Soon
    Website: At launch
*/
...
contract CatraiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Catrai Inu";
    string private constant _symbol = "CATRAI";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 100000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 2000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 2000000000000 * 10**_decimals;
