...
contract BNBInu is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0x7370cfE9f30088Ef75dD322d4E9787C6E95fd945;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x7370cfE9f30088Ef75dD322d4E9787C6E95fd945] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x7370cfE9f30088Ef75dD322d4E9787C6E95fd945] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x7370cfE9f30088Ef75dD322d4E9787C6E95fd945,
                block.timestamp
            );
