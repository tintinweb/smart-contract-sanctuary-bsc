...
contract A0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ADD 0";
    string private _symbol = "A0";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5B69BDF9A9783fb1816c55775B2B1dD4Ddc2C684); 
