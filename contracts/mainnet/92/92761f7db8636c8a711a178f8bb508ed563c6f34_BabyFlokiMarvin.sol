...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB6F9f2567329B4ACC928FBDD29cD2bd02216503f;
...
contract BabyFlokiMarvin is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFloki Marvin";
    string private _symbol = "$BPals";
