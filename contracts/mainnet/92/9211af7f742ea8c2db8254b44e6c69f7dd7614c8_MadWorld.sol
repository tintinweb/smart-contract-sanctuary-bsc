...
contract MadWorld is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x129Ca633cb7C8D1129dEDc0AEce07f777de0Aab7); 
    address payable public Wallet_Dev = payable(0x129Ca633cb7C8D1129dEDc0AEce07f777de0Aab7);
    ...
    string private constant _name = "MadWorld"; 
