...
contract  JZ is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x228D1313550d94eC2C92e4DD4d35CE790eB65BEB);
    address payable public teamWalletAddress = payable(0x9a8D1A6Ac930d9d2E27A9dc086204eB9bE59D1b8);
    ...
    uint256 private _totalSupply =  288 * 10**_decimals;
