...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  SHIBA = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract CREATO is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xaD64762817f47a089B370a8B5E65093E0Ef41625;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "CREATO";
    string constant _symbol = "CREATO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply ; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xaD64762817f47a089B370a8B5E65093E0Ef41625;
