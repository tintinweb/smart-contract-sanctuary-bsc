...
Telegram: https://t.me/spectrumnetworkofficial
...
contract SpectrumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spectrum Network";
    string private _symbol = "SNET";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xdB5B2D3972da0DA73108864BF4A096d3F4eC3bDd); // Marketing Address
    address payable public teamWalletAddress = payable(0xD8B389Fa52ef05034Fb1F3892D47383fF1B25c51); // Team Address
