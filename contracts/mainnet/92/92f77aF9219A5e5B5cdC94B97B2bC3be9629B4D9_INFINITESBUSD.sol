...
contract INFINITESToken is IBEP20 {
...
contract INFINITESBUSD {
    address payable admin;
    INFINITESToken public tokenContract;
    ...
    constructor(INFINITESToken _tokenContract, uint256 _tokensSold)  {
