...
contract HKBY is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * (10**16) * (10**9);
    ...
    string private constant _name = "Huckleberry inu";
    string private constant _symbol = " HKBY V2";
