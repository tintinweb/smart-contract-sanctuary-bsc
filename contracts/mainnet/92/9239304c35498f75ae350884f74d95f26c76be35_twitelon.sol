...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA3B1D05605dfAD9E806b91703CA64449a56E1568; // owner address
...
contract twitelon is Context, IERC20, Ownable {
    ...
    string private _name = "TwitElon";
    string private _symbol = "TWITELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02d7015da280df8C8981D0DcB5f6c3708F21bdFD); // Marketing Address
    address payable public teamWalletAddress = payable(0x02d7015da280df8C8981D0DcB5f6c3708F21bdFD); // Team Address
