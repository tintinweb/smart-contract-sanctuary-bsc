...
contract LAPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Aptos"; // 
    string private constant _symbol = "$LAPT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x388dbc027Fb6903F2257b19B6BbcB6cFd66FDfCA;
