...
contract SantaXRP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Santa XRP ";
    string private _symbol = " $SantaXRP "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF5c246f0527a9810959aF5E70c4e73d2aB3C100E); 
