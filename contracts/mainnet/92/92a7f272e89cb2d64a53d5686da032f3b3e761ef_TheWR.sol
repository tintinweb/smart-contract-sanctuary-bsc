...
/*
    ...
    t.me/+MGBU2eZbwvI2ZTI0
    www.thewhiterabbit.io/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFD6a1dE945DEE1dF26FD033812075fcD96605841;
...
contract TheWR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x89F519BA3D480699652f71214478Ff7284997A05;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "The White Rabbit";
    string private _symbol = "TheWR";
