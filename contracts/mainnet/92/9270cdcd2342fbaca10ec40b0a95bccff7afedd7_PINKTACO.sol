...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C8875D3c70266AaA81Bd97F61eb8345b6DA2146;
...
contract PINKTACO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4ef34333A7aAE07836023A7a2b90d7298C0D140e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Delta V Mug";
    string private _symbol = "DVM";
