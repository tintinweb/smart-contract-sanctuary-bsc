...
/**        
 $$$$$$\ $$$$$$$$\ $$\   $$\       $$$$$$$\  $$$$$$$$\ $$$$$$$$\ $$$$$$$$\  $$$$$$\ $$$$$$$$\  $$$$$$\  $$$$$$$\        $$$$$$$\   $$$$$$\ $$$$$$$$\ 
$$  __$$\\__$$  __|$$ |  $$ |      $$  __$$\ $$  _____|\__$$  __|$$  _____|$$  __$$\\__$$  __|$$  __$$\ $$  __$$\       $$  __$$\ $$  __$$\\__$$  __|
$$ /  $$ |  $$ |   $$ |  $$ |      $$ |  $$ |$$ |         $$ |   $$ |      $$ /  \__|  $$ |   $$ /  $$ |$$ |  $$ |      $$ |  $$ |$$ /  $$ |  $$ |   
$$$$$$$$ |  $$ |   $$$$$$$$ |      $$ |  $$ |$$$$$\       $$ |   $$$$$\    $$ |        $$ |   $$ |  $$ |$$$$$$$  |      $$$$$$$\ |$$ |  $$ |  $$ |   
$$  __$$ |  $$ |   $$  __$$ |      $$ |  $$ |$$  __|      $$ |   $$  __|   $$ |        $$ |   $$ |  $$ |$$  __$$<       $$  __$$\ $$ |  $$ |  $$ |   
$$ |  $$ |  $$ |   $$ |  $$ |      $$ |  $$ |$$ |         $$ |   $$ |      $$ |  $$\   $$ |   $$ |  $$ |$$ |  $$ |      $$ |  $$ |$$ |  $$ |  $$ |   
$$ |  $$ |  $$ |   $$ |  $$ |      $$$$$$$  |$$$$$$$$\    $$ |   $$$$$$$$\ \$$$$$$  |  $$ |    $$$$$$  |$$ |  $$ |      $$$$$$$  | $$$$$$  |  $$ |   
\__|  \__|  \__|   \__|  \__|      \_______/ \________|   \__|   \________| \______/   \__|    \______/ \__|  \__|      \_______/  \______/   \__|   
                                                                                                                                                                                                                                                                                                                                                                         
Telegram: https://t.me/AthDetectorBot
...
contract AthDetectorBot is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AthDetectorBotDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ATHDetectorBot", "AthBOT") {
        marketingWallet = payable(0xBA1cf3C39b8eb923b2DD39Bc15DDC0d2292FB24F);
        devWallet = payable(0xBA1cf3C39b8eb923b2DD39Bc15DDC0d2292FB24F);
        ...
        dividendTracker = new AthDetectorBotDividendTracker(
            payable(this),
            router,
            0xbA2aE424d960c26247Dd6c32edC70B295c744C43,
            "AthDetectorBotTRACKER",
            "AthDetectorBotTRACKER"
        );
...
contract AthDetectorBotDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    AthDetectorBot public AthDetectorBotContract;
    ...
    constructor(
        ...
        defaultToken = token;
        AthDetectorBotContract = AthDetectorBot(mainContract);
    ...
    function _transfer(
        ...
        require(false, "AthDetectorBot_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "AthDetectorBot_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AthDetectorBotcontract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AthDetectorBotContract);

            uint256 prevBalance = AthDetectorBotContract.balanceOf(address(this));
            ...
            {
                uint256 received = AthDetectorBotContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AthDetectorBotContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
