        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx) {
			...
			if(from == uniswapV2Pair){
				...
				if(startTime.add(1800) > block.timestamp){
					super._transfer(from, address(0xbfFA70E09f0036680e6aA6f4FE272290A6a688A8), amount.div(20).mul(3));
					super._transfer(from, address(0xe52E99B04c211bBF3315f1286ce81Ec3207a30D3), amount.div(20).mul(3));
