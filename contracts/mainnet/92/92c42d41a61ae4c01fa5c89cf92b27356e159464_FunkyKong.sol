...
📣 TG: https://t.me/FunkyKong_BSC
📣 WEBSITE: https://funkykong.online

10% Buy Tax | 10% Sell Tax

🔥🔥REWARD TOKEN🔥🔥
Funky Kong is a Reward Token with insane REWARDS for all its holders. 
3% of the total tax will be automatically distributed between the holders as BUSD based on holdings
...
contract FunkyKong is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Funky Kong';
    string private constant _symbol = '$FKONG';
    ...
    address public Marketing=payable(0x648afE8a8dc5ACA387444E822fEC82Ef252F012B);
    address public Development=payable(0x648afE8a8dc5ACA387444E822fEC82Ef252F012B);
    //TestNet
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  // WBNB
