...
/**
/*
Welcome to ArabDoge on binance smart chain.

Fair launch 21 UTC

Telegram : https://t.me/officialarabdoge
...
contract ArabDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArabDoge";
    string private _symbol = "$ARABDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAa8D5044Ca74D1A2F7C1dfC199751a254d0E0424); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xAa8D5044Ca74D1A2F7C1dfC199751a254d0E0424); // BuyBack Address
