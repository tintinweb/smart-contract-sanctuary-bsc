...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb0eB8Db5Ed828BA1D55812E38b5c6cEc813eF19;
...
contract BasicPumpinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic Pump inu"; // 
    string private constant _symbol = "BPUMPinu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xD49709689b45Bd4A740493C89cE15698f3EF89d8);
