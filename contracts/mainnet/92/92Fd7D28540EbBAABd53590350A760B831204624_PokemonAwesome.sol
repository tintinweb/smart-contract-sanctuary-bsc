...
Join our Telegram for the latest updates!

https://t.me/pokemonawesome
...
/* Token contract */
contract PokemonAwesome is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xEb2D124b97b1b29b2B5eaAC63a9e73c7e0F0D609;
    ...
    // Name and symbol
    string constant _name = "PokemonAwesome";
    string constant _symbol = "POKEAWESOME";
