...
contract DividendDistributor is Owned, DividendPayingToken {
    ...
    uint256 public minimumTokenBalanceForDividends = 5e6 * 1e18;
...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    function setFee(uint256 _lpFee, uint256 _marketingFee,uint256 _distributefee) external onlyOwner {
        lpFee = _lpFee;
...
contract coin1984 is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 1e8 * 1e18;
    uint256 public constant burnFee = 0;
    ...
    constructor() ERC20("1985", "1985", 18) DividendFee() {
