...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd); //REWARDS
...
contract SCNTEST is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SCNTEST";
    string constant _symbol = "SCNTEST";
    ...
    uint256 public extraFeeOnSell = 91;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xaa099A43ddE92244e9DB6ba0bA49b1c4F7f92FA3;  // marketingWallet
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newmarketingFee, uint256 newExtraSellFee) external authorized {
        require(liquidityFee.add(rewardsFee).add(marketingFee).add(extraFeeOnSell) <=20, "Sell Taxes cannot be higher than 20%");
