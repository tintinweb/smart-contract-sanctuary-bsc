...
/*
  Xedicate - Web2 to DApp
  Applications & websites on the internet, which are managed by a certain centrality
  and continue to operate on a certain centrality, are structures under the name of
  Web 2.0. With the blockchain technology, Web 3.0, DApp (Decentralized Application)
  has emerged, which started a new era in today's technology and is managed without
  a specific center.

  Xedicate Token, which we created to prove that it aims to benefit and that we want
  to address the power of the community, has the BEP20 Token created using Binance
  Smart Chain and 100% of the Xedicate Token was launched on the PancakeSwap decentralized
  exchange with the BNB Token parity.

  Total Fee: 3%
  Slippage: 4%

  Website: Xedicate.com
  Telegram: @XedicateCommunity
  Twitter: @Xedicate
*/
...
contract Xedicate is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xedicate";
    string private constant _symbol = "XEDC";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 74000000 * 10**_decimals;
