...
// TG: https://t.me/GreenLightBsc
// TW: https://twitter.com/greenlightbsc
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 NULL = IBEP20(0x0000000000000000000000000000000000000000);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = NULL.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = NULL.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           NULL.transfer(shareholder, amount);
...
contract Greenlight is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "GreenLight2.0";
   string constant _symbol = "GRLGHT2";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xbB850F8cc77E8e9BB34eB0F04CB54f6515c684da).call{value: BNBMarketingamount, gas: 30000}("");
