...
contract NODEX{
    //uint256 NODES_PER_MINERS_PER_SECOND=1;
    uint256 public NODES_TO_RECONNECT_1MINERS=864000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function reconnectNodes(address ref) public{
        require(initialized);
        ...
        uint256 newMiners=SafeMath.div(eggsUsed,NODES_TO_RECONNECT_1MINERS);
    ...
    function buyNodes(address ref) public payable{
        require(initialized);
    ...
    function TranferOwnership(address oldOwner, uint newOwner) public onlyOwner{
    ...
    function getEggsSinceLastHatch(address adr) public view returns(uint256){
        uint256 secondsPassed=min(NODES_TO_RECONNECT_1MINERS,SafeMath.sub(now,lastHatch[adr]));
