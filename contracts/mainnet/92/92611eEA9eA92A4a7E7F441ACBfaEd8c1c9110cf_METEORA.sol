...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5D31EFFe30c57468931aEf13bad5c73d0C43639;
...
contract METEORA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD15c210df3C377eb46C103FB214485Bbae1b92dA ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "METEORA";
    string private _symbol = "$METEORA";
