...
contract ShibKwon is Ownable, IBEP20 {
    ...
    string constant _name = "ShibKwon";
    string constant _symbol = "ShibKwon";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x47272617508Fb0e2D2FefF3d7f3b9C4d95010b6e;
        marketingWallet = 0x47272617508Fb0e2D2FefF3d7f3b9C4d95010b6e;
        devWallet = 0x47272617508Fb0e2D2FefF3d7f3b9C4d95010b6e;
        gameWallet = 0x47272617508Fb0e2D2FefF3d7f3b9C4d95010b6e;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        // cant go to busd directly from token, need to go bia ETH
        ...
        (bool tmpSuccess2,) = payable(gameWallet).call{value: amountETHGame, gas: 30000}("");
        (bool tmpSuccess3,) = payable(devWallet).call{value: amountETHDev, gas: 30000}("");
