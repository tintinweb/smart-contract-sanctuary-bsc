...
contract OVERHYPE2POINT0 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFD9096dCa6D655d2667CB6173C3bD0e7CF1E6d25);
    address payable public Wallet_Dev = payable(0xAc34aE9Fb94466FD13b809EE041a15fC48541047);
    ...
    string private constant _name = "OVERHYPE 2.0";
    string private constant _symbol = unicode"OVERHYPE2.0";
