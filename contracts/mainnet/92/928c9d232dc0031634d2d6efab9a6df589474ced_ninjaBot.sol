...
contract ninjaBot{
    ...
    event Approval(address indexed owner, address indexed spender, uint256 value);
    event nuevoDeposito(address sender, uint256 amount, uint256 balance); // cuando deposita veo la address / monto / total invertido.
    event Withdraw(uint amount, uint balance);    //no necesita address porque retira el owner.
