...
contract TokenB is ERC20Upgradeable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    
    uint public transferPercent; // threshold
    ...
    function setManager(address manager, bool flag) public onlyOwner {
     ...
     function getManager(address manager) public onlyManager view returns (bool) {
