...
// CHANGE
contract WorldWithoutWar is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "World Without War";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x043aa34fa6727cE00D440CFB72E670987618E4c3);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _charityfee, uint256 _marketingFee, uint256 newExtraSellFee, uint256 _feeDenominator) external onlyOwner {
