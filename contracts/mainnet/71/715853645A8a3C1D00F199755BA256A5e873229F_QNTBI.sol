...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint _burnAmount = tAmount * 100 / 10000;
            feeAmount += _burnAmount;
            _takeTransfer(sender,address(0x000000000000000000000000000000000000dEaD),_burnAmount);
        }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = fistBalance * (_buyLPDividendFee + _sellFundFee) / swapFee;
        FIST.transferFrom(address(_tokenDistributor), fundAddress, fundAmount);
        FIST.transferFrom(address(_tokenDistributor), address(_mainPair), fistBalance - fundAmount);
...
contract QNTBI is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        210000000,//Supply
        address(0xc20bB2E8e0088cDDEb27375184e866A51e450f1d),//FAddress
        address(0xeE8C37eF1b6ECc03C96B0D01AB4972078C4cbE4e)//ReceiveAddress
    ){
