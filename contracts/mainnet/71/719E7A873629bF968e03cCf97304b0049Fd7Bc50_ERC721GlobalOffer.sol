    ...
    ReentrancyGuard
{
    ...
    function createOffer(
        ...
        require(
            _isAllowedPaymentToken(erc721Address, paymentToken),
        ...
        require(
            IERC20(_paymentToken).balanceOf(bidder) >= totalValue,
            "insufficient balance"
        );
        require(
            IERC20(_paymentToken).allowance(bidder, address(this)) >=
                totalValue,
     ...
     */
    function removeExpiredOffers(RemoveExpiredOfferInput[] calldata offers)
        external
    {
    ...
    {
        address paymentToken = _getPaymentTokenAddress(offer.paymentToken);
     ...
     */
    function _getOfferStatus(address erc721Address, Offer memory offer)
        private
        view
        returns (Status, uint256)
    {
        ...
        if (!_isAllowedPaymentToken(erc721Address, offer.paymentToken)) {
...
interface IERC721GlobalOffer {
     ...
     * @param paymentToken erc20 token for payment. Address 0 is wrapped ether
