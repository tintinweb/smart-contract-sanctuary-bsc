...
contract RoyalYieldFarm {
	...
	uint256 public WALLET_LIMIT = 90 ether;  
    ...
    uint public startTime = 1662411600; 
	...
	constructor(address payable _dev1, address payable _dev2, address payable _dev3) {
        ...
        plans.push(Plan(20,  60,  1 * 1e17, 35 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  50,  2 * 1e17, 30 ether, 0, 0, 0, 0, true));
        plans.push(Plan(100,  40,  3 * 1e17, 25 ether, 0, 0, 0, 0, true));
	}
