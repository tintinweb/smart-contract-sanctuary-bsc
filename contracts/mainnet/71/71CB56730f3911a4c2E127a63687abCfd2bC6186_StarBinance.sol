...
contract StarBinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarBinance";
    string constant _symbol = "SB";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10 * 10**13 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 100 / 100;

    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 33 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 392 / 100000; 
    bool inSwap;
