...
Welcome to Pige DoKwon, a community-based token (TEAM LEAD) inspired to the infamous DoKwon trend. 

⚡What to expect??
- BIGGEST BUY COMPETITION
- SHILL COMPETITION
- BIG TG CALLERS LINED UP!  
- STARTING WITH LOW MC = MOON
- HYPE NAME & HIGH GRAPHIC LOGO

🎯Utilities will be added onto the project based on each milestone marketcap to avoid misleading advertisement and false promises! WE ARE IN THIS TOGETHER!

📌 Buy n Sell Tax - 8%
✅ Slippage 12++

📲 TG  - https://t.me/pigedokwon
🐽 TWITTER - https://twitter.com/PigeDokwon
*/
...
contract PIGEDOKWON is Context, IERC20 { 
    ...
    string private constant _name = "Pige DoKwon"; 
    string private constant _symbol = unicode"PigeDoKwon"; 
