...
contract EleDrill is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "EleDrill";
    string private _symbol = "DRILL";
    ...
    function lastprocess(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
