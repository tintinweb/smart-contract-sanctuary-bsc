...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x5ceBBb5304DbFbCe4E1AbA1e461Ed69e840059b0 ;
...
contract HALLOWEENRATS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x9b37d05A03880E384FaeD9715849cd32946bBfBF ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HALLOWEEN RATS";
    string private _symbol = "HLWT";
