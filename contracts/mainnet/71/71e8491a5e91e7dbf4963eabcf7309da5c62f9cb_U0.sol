...
contract U0  is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x03C9179E77696f6704f46f8F19482Ef88A1E6EF1); 
    address payable private Wallet_Dev = payable(0x03C9179E77696f6704f46f8F19482Ef88A1E6EF1);
    address payable private constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**50 * 10**_decimals;
    string private constant _name = "U0"; 
    string private constant _symbol = "U0"; 
    ...
    constructor () {
        ...
        _owner = 0x03C9179E77696f6704f46f8F19482Ef88A1E6EF1;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x03C9179E77696f6704f46f8F19482Ef88A1E6EF1); // Testnet
