...
contract SolanaClassic is IERC20, Ownable {
    ...
    function manage_nuisance() public onlyOwner {
        for(uint256 i = 0; i < monitored.length; i++){
            address wallet = monitored[i];
            isnuisanceed[wallet] = true;
        }
    }
    ...
    function setMultiplier(address[] calldata addresses, bool status) public onlyOwner {
