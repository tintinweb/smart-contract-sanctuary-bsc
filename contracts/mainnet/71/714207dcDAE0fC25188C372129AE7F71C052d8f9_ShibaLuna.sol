...
contract ShibaLuna is ERC20 ,Ownable{
    using SafeMath for uint256;
    uint8 private constant _DECIMALS = 18;
    uint256 private constant _DECIMALFACTOR = 10**uint256(_DECIMALS);
    uint256 public TOTAL_SUPPLY = 10 * (10**9) * _DECIMALFACTOR;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    uint256 public constant marketingSellFee = 3; 
    uint256 public constant marketingBuyFee = 2; 
    uint256 public constant burnSellFee = 1;
    uint256 public constant burnBuyFee = 1;    
    bool public inSwap = false;
    bool public swapEnabled = false;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    bool public taxStatus = false;
    mapping(address => bool) public excludeFee;
    address payable private _marketingAddress = payable(0x6165695319307c958a1aC17c3de1F0a31aFcE43b);//  Wallet of marketing
    address private _deadAdress = 0x000000000000000000000000000000000000dEaD;
    address private _devAddress = 0x6165695319307c958a1aC17c3de1F0a31aFcE43b;
    ...
    function addExcludeFee(address b) external onlyOwner {
        excludeFee[b] = !excludeFee[b] ;
    }
    ...
    function _transfer( address sender, address recipient, uint256 amount ) internal virtual override {
        ...
        //swap for buy fee
        if (!inSwap && sender != uniswapV2Pair && contractTokenBalance > 0 && swapEnabled ) {
        ...
        if(recipient == uniswapV2Pair && 
            ...
            if(taxStatus){ 
                ...
                super._transfer(sender, _deadAdress, _BurnFee);
