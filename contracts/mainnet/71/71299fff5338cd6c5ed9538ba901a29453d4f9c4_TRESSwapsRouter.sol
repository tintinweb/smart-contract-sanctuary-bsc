...
/*
    ...
    Contract Name: TresLeches LP Router 
...
contract SwapsHelper {
        ...
        )
    {
        require(
            _tokenA != _tokenB,
            "TresSwapsHelper: IDENTICAL_ADDRESSES"
        );
        ...
        returns (uint256 amountB)
    {
        require(
            _amountA > 0,
            "TresSwapsHelper: INSUFFICIENT_AMOUNT"
        );

        require(
            _reserveA > 0 && _reserveB > 0,
            "TresSwapsHelper: INSUFFICIENT_LIQUIDITY"
        );
        ...
        returns (uint256 amountOut)
    {
        require(
            _amountIn > 0,
            "TresSwapsHelper: INSUFFICIENT_INPUT_AMOUNT"
        );
        ...
        returns (uint256 amountIn)
    {
        require(
            _amountOut > 0,
            "TresSwapsHelper: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        ...
        internal
    {
        ...
        require(
            ...
            "TresSwapsHelper: TRANSFER_FAILED"
        );
    }
        ...
        internal
    {
        ...
        require(
            ...
            "TresSwapsHelper: TRANSFER_FROM_FAILED"
        );
    }
        ...
        internal
    {
        ...
        require(
            success,
            "TresSwapsHelper: ETH_TRANSFER_FAILED"
        );
    }
...
contract TRESSwapsRouter is SwapsHelper {
    ...
    modifier ensure(
        ...
        require(
            ...
            "TresSwapsRouter: DEADLINE_EXPIRED"
        );
        _;
    }
        ...
        payable
    {
        require(
            msg.sender == WETH,
            "TresSwapsRouter: INVALID_SENDER"
        );
    }
        ...
        returns (uint256, uint256)
    {
        ...
        if (amountBOptimal <= _amountBDesired) {
            ...
            require(
                ...
                "TresSwapsRouter: INSUFFICIENT_B_AMOUNT"
            );
        ...
        require(
            ...
            "TresSwapsRouter: INVALID_DESIRED_AMOUNT"
        );

        require(
            amountAOptimal >= _amountAMin,
            "TresSwapsRouter: INSUFFICIENT_A_AMOUNT"
        );
        ...
        returns (uint256[] memory amounts)
    {
        ...
        require(
            ...
            "TresSwapsRouter: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        ...
        returns (uint256[] memory amounts)
    {
        ...
        require(
            ...
            "TresSwapsRouter: EXCESSIVE_INPUT_AMOUNT"
        );
...
contract RouterCodeCheck {
    ...
    {
        return keccak256(
            type(TRESSwapsRouter).creationCode
        );
    }
}