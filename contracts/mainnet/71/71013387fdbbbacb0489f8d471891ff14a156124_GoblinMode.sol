...
contract GoblinMode is Context, IERC20, ERC20Ownable {
    ...
    string private constant _symbol = "Goblin Mode";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x31AF7eb1c6892b47d5B137e9749F3EEbdCdca4af);
        CharityWallet = payable(0x612A21023d955E88A50dDf12769816e7469D8d79);
        DevWallet = payable(0xCe6DD5f8e0069A396c8f752Bea697b358c98e53f);
