...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x0c2bfA54d6d4231b6213803dF616a504767020eA);
...
/* Token contract */
contract BabySquidGrow is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address SquidGrow = 0x88479186BAC914E4313389a64881F5ed0153C765; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xcD8f065333a4fed39D7d05A8A7cA7D6a4f6b60b8;
    ...
    // Name and symbol
    string constant _name = "Baby Squid Grow";
    string constant _symbol = "BabySquidGrow";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xcD8f065333a4fed39D7d05A8A7cA7D6a4f6b60b8;
