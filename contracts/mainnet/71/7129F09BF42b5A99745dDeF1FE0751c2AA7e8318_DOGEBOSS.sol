...
contract DOGEBOSS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x771E690ad76D5Ca87013ba1727488314ED09C2aD); 
    address payable public Wallet_Dev = payable(0x771E690ad76D5Ca87013ba1727488314ED09C2aD);
    address payable public constant Wallet_Burn = payable(0x771E690ad76D5Ca87013ba1727488314ED09C2aD); 
    ...
    string private constant _symbol = unicode"DOGEBOSS"; 
    ...
    constructor () {
        ...
        _owner = 0x771E690ad76D5Ca87013ba1727488314ED09C2aD;
