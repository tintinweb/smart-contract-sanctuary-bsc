...
Trade liquid assets quickly, seamlessly, and cost-effectively with cross-chain composability.
Website: www.xmasofc.network
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x68C0BA843029dBac88B7C58642E35efdef3A2AE4; // owner address
...
contract XMASNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " XMAS Network ";
    string private _symbol = " XMAS ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5895D0dc6086588c8907C100b3D8250fe8c70a12);
    address payable public teamWalletAddress = payable(0x3BbC0B0d1F23845f4C8D5706CE5840Cf8ea446fF);
