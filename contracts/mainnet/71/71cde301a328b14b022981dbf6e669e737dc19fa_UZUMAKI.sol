...
contract UZUMAKI is Ownable, IBEP20 {
    ...
    string constant _name = "Uzumaki Inu";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x41Db6591e425b622Fe21097D9CE58341eC4b3E45;
        marketingWallet = 0xf80e62559776c39e69e89ba4295426eBD3459373;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 11);
        require (newTotalSell < 16);
