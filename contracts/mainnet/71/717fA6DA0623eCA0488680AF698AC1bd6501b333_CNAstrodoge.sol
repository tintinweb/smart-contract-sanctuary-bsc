...
contract CNAstrodoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CN ASTRO DOGE";
    string constant _symbol = "CNAD";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xe535628A09c0320Eb7Aa83f6DD3B9bD9979e6f35;
