...
contract KUMAMONTWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "KUMAMON 2.0";
    string private constant _symbol = "KUMAMON2.0";
    ...
    function updateHasFees(address[] calldata addresses) external onlyOwner { 
    ...
    function updateMaxTransaction(uint256 newMaxTransaction, uint256 newMaxWallet) external onlyOwner {
