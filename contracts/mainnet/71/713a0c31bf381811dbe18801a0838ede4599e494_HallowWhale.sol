...
Supply: 999 999 999 999

Buy/Sell Tax 9% 

Taxes accumulated in treasury wallet will be exclusively used to buy & burn Hallow Whale .
...
TELEGRAM: https://t.me/HallowWhale
...
contract HallowWhale is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999999999999 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = _tTotal / 50; // 2% 
    uint256 public maxTxAmountSell = _tTotal / 50; // 2% 
    uint256 public maxWalletAmount = _tTotal / 50; // 2% 
    ...
    string private constant _name = "Hallow Whale";
    string private constant _symbol = "HALLOWHALE";
    ...
    event markedAsBot(address botAddress, bool indexed value);
    ...
    function _transfer(
        ...
        require(!isBot[from], "ERC20: address is a buttb0t");
    ...
    function markBot(address botAddress, bool isban) external onlyOwner {      
