...
contract BUC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Beau Cat";
    string private constant _symbol = "BUC";

    address public _PancakeSwapV1RouterUniswap = 0xeCCA58E777E7Fd98159586A5185EE3214284085c; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xeCCA58E777E7Fd98159586A5185EE3214284085c; //can be the same
