...
contract StakingProxy is Ownable {
    ...
    constructor(
        address _HXL, // HXL Token contract address
        address _sHXL, // sHXL Token contract address
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        require(_amount != 0); // why would anyone need to stake 0 HXL?
        ...
        claims[_recipient] = Claim({
            ...
            gons: claimInfo.gons.add(IsHXL(sHXL).gonsForBalance(_amount)),
    ...
    function claim(address _recipient) public {
        ...
        IERC20(sHXL).transfer(_recipient, IsHXL(sHXL).balanceForGons(claimInfo.gons));
    }
