...
contract LvrgdToken is ERC20("LvrgdToken", "LVRGD"), Ownable {
  ...
  constructor(uint256 _startReleaseBlock, uint256 _endReleaseBlock) public {
    ...
    // maunalMint 10m for seeding liquidity
...
contract FairLaunch is IFairLaunch, Ownable {
  ...
  */
  ...
  function setLvrgdPerBlock(uint256 _lvrgdPerBlock) public onlyOwner {
    lvrgdPerBlock = _lvrgdPerBlock;
  }
  ...
  */
  ...
  function updatePool(uint256 _pid) public override {
    ...
    if (block.number <= bonusEndBlock) {
      lvrgd.lock(devaddr, lvrgdReward.div(10).mul(bonusLockUpBps).div(10000));
    ...
    if(block.number > bonusEndBlock && pool.lastRewardBlock < bonusEndBlock) {
      ...
      lvrgd.lock(devaddr, lvrgdBonusPortion.div(10).mul(bonusLockUpBps).div(10000));
