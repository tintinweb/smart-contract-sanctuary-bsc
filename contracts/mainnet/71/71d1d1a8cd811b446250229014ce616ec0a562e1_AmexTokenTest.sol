...
contract AmexTokenTest is ERC20, AccessControl, ERC20Permit {
    ...
    IWrap public wrap = IWrap(0x5eb6B459Dd60CDd6239c830cFaa7E30bf98E06B6);                     // 注意  请先部署完wrap合约再部署本合约
    IERC20 public usdt = IERC20(0x6C51eDb2d8F5eA142d45969aDe54eBEbAF50F1CA);
    ...
    constructor()
        ERC20("Amex Token Test", "ATT")
        ERC20Permit("Amex Token Test")
    {
