...
contract MRWCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xB1c61dbf6a066812B6B4Dd71eADBb4c8c1DC9487); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x99dB048A9Dd3167a948A84e3c4B83b81DC53CA63); // Liquidity Address
    ...
    string private constant _name = "MRW";
    string private constant _symbol = "MRW";
    ...
    constructor() {
        address newOwner = address(0x99dB048A9Dd3167a948A84e3c4B83b81DC53CA63);
