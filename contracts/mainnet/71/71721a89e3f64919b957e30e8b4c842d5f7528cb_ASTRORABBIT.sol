...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a5fA8dD711b740Bd7e9AEe15878451d2bA5caCb; // owner address
...
contract ASTRORABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASTRO RABBIT";
    string private _symbol = "ATR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x6Bcb1DA003E5a19ec67cA680527ef2ad4Df45037); 
    address payable public teamWalletAddress = payable(0x6Bcb1DA003E5a19ec67cA680527ef2ad4Df45037);
