...
//
//
//   📱Telegram::https://t.me/SquidPawPortal
//   📱Website ::https://squidpaw.club/
/*
...
contract SQUIDPAW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SQUIDPAW", "SQUIDPAW") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SQUIDPAW";
    string private _symbol = "SQUIDPAW";
