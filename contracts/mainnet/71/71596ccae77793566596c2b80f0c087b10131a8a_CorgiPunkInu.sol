...
contract CorgiPunkInu is Context, IERC20, Ownable {
    ...
    string private _name = "Corgi Punk INu";
    string private _symbol = "CPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4260f0166FE69F3710789ca21C7F902652B7fa0e);
    address payable public teamWalletAddress = payable(0x4260f0166FE69F3710789ca21C7F902652B7fa0e);
