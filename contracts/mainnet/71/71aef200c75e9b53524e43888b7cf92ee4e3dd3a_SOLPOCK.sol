...
contract SOLPOCK is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "SOLPOCK";
    string private constant _symbol = "SOL POCK";
    ...
    address payable private _developmentAddress = payable(0x399eC4eE47d3999A27b6413fAE6da1e4b4b0d32A);
    address payable private _marketingAddress = payable(0xbE96BeBBCCA9cF92e6dDD4e19861D7186bA5dEdB);
