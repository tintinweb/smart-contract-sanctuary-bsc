...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "StarBaseInu";
    string private _symbol = "StarBase";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD7E5ae9f415c3B75b8edCDE66a618A5C3B1BB4D9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x93dFa0AD2033693CB6Da7eF6f0f3Ee922B1Cd7Ba); // BuyBack Address
