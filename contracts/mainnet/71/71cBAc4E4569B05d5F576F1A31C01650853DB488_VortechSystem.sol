...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7e369df908206079aF1bBD6d139B6C1E2df477E; // owner address
...
contract VortechSystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Vortech System";
    string private _symbol = unicode"Vsys";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7e369df908206079aF1bBD6d139B6C1E2df477E); // Marketing Address
    address payable public teamWalletAddress = payable(0xb7e369df908206079aF1bBD6d139B6C1E2df477E); // Team Address
