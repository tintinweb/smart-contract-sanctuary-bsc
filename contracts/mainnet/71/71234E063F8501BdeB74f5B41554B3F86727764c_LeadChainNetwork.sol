...
contract LeadChainNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "LeadChain Network";
    string private _symbol = "LEADC";
    ...
    address payable public marketingWallet = payable(0x4bFADf74D2c2F4dc61c0e20026A52Ff3480b57da);
    address payable public devWallet = payable(0x4bFADf74D2c2F4dc61c0e20026A52Ff3480b57da);
    ...
    uint256 public swapTokensAtAmount = _tTotal.mul(3).div(100); 
    uint256 public _maxTxAmount = _tTotal.mul(3).div(100); 
    uint256 public maxWalletToken = _tTotal.mul(3).div(100);
