...
contract Nextbtccoin_staking is ERC20 {
    ...
    function addDownlineRef(address senderAddress, address refUserAddress, uint8 refLevel,uint8 _plan, uint256 _amount,uint256 timestamp) internal {
        ...
        user.seedDeposit.push(SeedDeposit(senderAddress,refUserAddress,refLevel,_plan, _amount, timestamp,0));

        }
    }

	 function distributeRef(address _referredBy,address _sender, bool _newReferral,uint8 _plan, uint256 _amount,uint256 timestamp) internal {
       
          address _customerAddress        = _sender;
        // Level 1
        referralLevel1Address[_customerAddress]                     = _referredBy;
        if(_newReferral == true) {
            addDownlineRef(_referredBy, _customerAddress, 1,_plan,_amount,timestamp);
        }
        ...
        if(chkLv2 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel1Address[_referredBy], _customerAddress, 2,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv3 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel2Address[_referredBy], _customerAddress, 3,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv4 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel3Address[_referredBy], _customerAddress, 4,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv5 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel4Address[_referredBy], _customerAddress, 5,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv6 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel5Address[_referredBy], _customerAddress, 6,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv7 != 0x0000000000000000000000000000000000000000) {
           ...
           if(_newReferral == true) {
                addDownlineRef(referralLevel6Address[_referredBy], _customerAddress, 7,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv8 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel7Address[_referredBy], _customerAddress, 8,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv9 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel8Address[_referredBy], _customerAddress, 9,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv10 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel9Address[_referredBy], _customerAddress, 10,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv11 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel10Address[_referredBy], _customerAddress, 11,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv12 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel11Address[_referredBy], _customerAddress, 12,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv13 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel12Address[_referredBy], _customerAddress, 13,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv14 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel13Address[_referredBy], _customerAddress, 14,_plan,_amount,timestamp);
            }
        }
        ...
        if(chkLv15 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {
                addDownlineRef(referralLevel14Address[_referredBy], _customerAddress, 15,_plan,_amount,timestamp);
            }
        }
	...
	function invest(address referrer, uint8 plan,uint256 _amount) public payable {
      ...
      _approve(address(msg.sender),address(this), _amount);
       ...
       if(status){ 
		...
		distributeRef(referrer, msg.sender, _newReferral,plan, _amount, block.timestamp);
    ...
    function reinvest(uint8 plan,uint256 _amount) public payable {
	  ...
	  require(_amount >= INVEST_MIN_AMOUNT);
       ...
       if(status){
		...
		distributeRef(user.referrer, msg.sender, _newReferral,plan, _amount, block.timestamp);
		   	...
		   	for (uint256 i = 0; i < user.seedDeposit.length; i++) {
				uint256 finish = user.seedDeposit[i].start.add(plans[user.seedDeposit[i].plan].time.mul(1 days));
                    ...
                    if (user.seedDeposit[i].start < finish) {
                        uint256 share = user.seedDeposit[i].amount;
