...
contract AquarionAndPolaris is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AquarionAndPolaris";
    string constant _symbol = "$AQRNPLRS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xab498681B3F94dD0EbAc4Eef831eA470B181fF45;
