...
contract RewardsCoin is ERC20, Ownable {
    ...
    constructor() ERC20("REWARDS COIN", "1RC") {
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from], "ERC20: blacklisted wallets cannot trade");
    ...
    function swapBack() private {
        ...
        (bool success,) = address(dividendTracker).call{value: ethBalance}("");
                
        if (success) {
            dividendTracker.distributeTokenDividends(ethBalance);
            emit SendDividends(contractBalance, ethBalance);
        }
