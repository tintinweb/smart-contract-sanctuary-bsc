...
contract USB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "USB";
    string private _symbol = "USB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb132de7385B04Ccba217e845D2822170d5B65685); // Marketing Address
    address payable public teamWalletAddress = payable(0x6F05aDD5984CB2c15724fdecca49dF5A27c2B6b1); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000 * 10**12; 
