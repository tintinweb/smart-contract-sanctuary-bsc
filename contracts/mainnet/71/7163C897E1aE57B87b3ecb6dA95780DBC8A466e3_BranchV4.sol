...
contract BranchV4 is ReentrancyGuard, AccessControlEnumerable {
    ...
    uint32 dayInterval = 60 * 60;
    address usdt = 0x9948a363C8CD2442156824Fe7600290183588c29;
    address fuel = 0xADC660e078F274844025c2159A5b9f6cA143B2B5;
    address daos = 0x87b903535c983Bd9f1f1fD5d64c55e02A5c4b18e;
    address fuelRescue = 0x62784a7D7EA75A8E67ADDf3Ee2C4d6B59431651c;
    address branchRandom = 0x82Df23Cde0031Baa9B975F18c2Df7eA99066DC11;
    // 管理员配置
    ...
    function userPreDeposit(uint256 amount, bool useCommentReward) external nonReentrant {
        ...
        deposit.endFinalPayTimestamp = uint32(block.timestamp + (days_ + 2) * dayInterval); // todo:正式需将10改为2
        deposit.status = 10;
    ...
    function lossCompensationWithdraw(uint32 _versionTimestamp) external nonReentrant {
        ...
        lossCompensations[msg.sender][_versionTimestamp].withdrawedAmount += drawable;
