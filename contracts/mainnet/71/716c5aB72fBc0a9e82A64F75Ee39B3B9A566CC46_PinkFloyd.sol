...
contract PinkFloyd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Pink Floyd";
    string private _symbol ="Pink Floyd";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD7fC0a59232724F27a85fb79C2d95e302EAE376F);
    address payable public teamWalletAddress = payable(0xaA67797C2d66c6f5A88aD6a46C20208A9a76a356);
