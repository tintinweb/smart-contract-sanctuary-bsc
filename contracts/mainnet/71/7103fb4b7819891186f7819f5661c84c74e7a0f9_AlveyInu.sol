...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96E3687a90A46E6D3ac9Ced06096e477EA1990Fc; // owner address
...
contract AlveyInu is Context, IERC20, Ownable {
    ...
    string private _name = "Alvey Inu";
    string private _symbol = "AlveyInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96E3687a90A46E6D3ac9Ced06096e477EA1990Fc); // Marketing Address
    address payable public teamWalletAddress = payable(0x96E3687a90A46E6D3ac9Ced06096e477EA1990Fc); // Team Address
