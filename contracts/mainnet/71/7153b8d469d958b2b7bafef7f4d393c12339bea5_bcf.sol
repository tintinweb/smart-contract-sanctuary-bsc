...
contract bcf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "bcf";
    string private _symbol = "bcf";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08E8968B865245FC495e363474A2D459226D050A); // Marketing Address
    address payable public teamWalletAddress = payable(0xB90c250eE8D88A8249190A2d210E0A182D8B8A0B); // Team Address
