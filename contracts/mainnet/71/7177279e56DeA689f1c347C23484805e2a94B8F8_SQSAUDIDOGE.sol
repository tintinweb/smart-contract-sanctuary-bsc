...
contract SQSAUDIDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidSaudiDoge"; // 
    string private constant _symbol = "$SQSAUDIDOGE "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xEd045c444AD2744A2ec2E40A437CDd1343638803;
