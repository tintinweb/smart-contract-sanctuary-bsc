...
contract BabyBillMurrayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Baby Bill Murray Inu ";
    string private _symbol = " $BBMI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA365496449aD12dAf7DfBC6ea4Bc35e34e40C577);
    address payable public teamWalletAddress = payable(0xA365496449aD12dAf7DfBC6ea4Bc35e34e40C577);
