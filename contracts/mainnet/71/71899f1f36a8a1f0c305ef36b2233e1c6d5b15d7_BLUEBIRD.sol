...
contract BLUEBIRD is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x5365C8658765CCd118c845b8A6400c16110a6a8D);
    address payable public MarketingWallet = payable(0xC3078BF9A53999157B295b31e5B65908a8b5c2Df);
