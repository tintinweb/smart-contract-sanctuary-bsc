...
contract TANJIROBUSD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE1C7389E82E6354E127980C94303008b6C7482a4); 
    address payable public Wallet_Dev = payable(0xc3FFdA961a6cBF2eEc532BC3F3701050026f77BC);
    ...
    string private constant _name = "TANJIROBUSD"; 
    string private constant _symbol = unicode"TBUSD"; 
    ...
    constructor () {
        ...
        _owner = 0xc3FFdA961a6cBF2eEc532BC3F3701050026f77BC;
