...
contract OrdinalMatrix is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal Matrix";
    string private constant _symbol = "$oMATRIX";
