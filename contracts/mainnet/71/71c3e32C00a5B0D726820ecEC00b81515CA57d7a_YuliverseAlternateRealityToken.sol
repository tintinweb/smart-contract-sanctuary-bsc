...
Yuliverse is an alternative reality metaverse which is parallel to the real world and brings you a new lifestyle, meanwhile, it is also a game-based social application. Yuliverse currently has thousands of fantastic and exciting story lines. Under role-playing, players can obtain $ARG and $ART by accomplishing these quests. Yuliverse's economy is an economy owned by all players, and players can actually own, buy, sell, and trade items they earned in-game by playing and contributing to the economy.
At the same time, the establishment of Yuliverse is inseparable from interaction among players. In Yuliverse, all behaviors that help to establish a good ecology will be rewarded. We hope that players can play, benefit and make friends in Yuliverse, and get real happiness, real benefits and real friends from Yuliverse as well.
...
contract YuliverseAlternateRealityToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Yuliverse Alternate Reality Token";
