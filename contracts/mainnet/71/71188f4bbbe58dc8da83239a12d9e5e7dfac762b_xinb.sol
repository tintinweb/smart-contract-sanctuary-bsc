        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdD50A341e46f9017E0c718FfB026fd20e2482B12), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        3000000,//Su
        address(0xdD50A341e46f9017E0c718FfB026fd20e2482B12),//
        address(0xdD50A341e46f9017E0c718FfB026fd20e2482B12)//
    ){
    }
}