...
Ooooow shit dawg i longed BTC x50 at 40k yesterday i'm still shitting blood today bro
I took a short x100 today and my TP is at 15k so that shit better go down

✅ Ownership renounced right after launch
✅ Liquidity locked for 3 weeks on Mudra right after launch

✅ 1% tax on each transaction for my burger
...
✅ No function to do sketchy ass shits
...
contract BTC15K is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Bitcoin 15k";
    string constant _symbol = "$BTC15";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address feeReceiver = 0x3A3Ea3173Edb4F986E1d5182DA704a276CAe3ad8;
