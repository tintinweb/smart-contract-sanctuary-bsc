...
contract token is ERC20 {
	...
	address public _fundAddress = address(0xEd6d4Eaa2fBC7F403903d9db81A861aE6EbB6aeE);
    ...
    constructor(address tokenOwner) ERC20("3399", "3399") {
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
		    ...
		    USDT.transfer(_fundAddress,newAmount.div(2).mul(1));	
		}
    }
