...
// CHANGE
contract GenosInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Genos Inu";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x61cFca9F8cDf09c364c34f994C82a3927011a64e);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
