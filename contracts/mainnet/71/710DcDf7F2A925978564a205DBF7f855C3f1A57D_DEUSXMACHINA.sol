...
contract DEUSXMACHINA is Context, IERC20, Ownable {
    ...
    string private _name = "Deus X Machina";
    string private _symbol = "DEUS X MACHINA";
    ...
    constructor () public {
        ...
        maxTxAmountSell = totalSupply() * 100 / 1000; // 5% maxTx for sell
        _maxWalletSize = totalSupply() * 100 / 1000; // 5% maxWallet
