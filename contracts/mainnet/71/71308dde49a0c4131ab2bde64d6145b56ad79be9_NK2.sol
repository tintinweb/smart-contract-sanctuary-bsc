...
contract NK2 is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x4dF241deF7796AE31A6960180B38B9CEcD5B79Cd);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NUKE2";
    string private _symbol = "NK2";
    ...
    uint256 public _maxWalletToken = 200000000 * 10**18;
    ...
    uint256 public _numTokensSellToAddToLiquidity = 50000000 * 10**18;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x18252af3865C5819aF163D07e7ee3ab63C1f6A37)] = true;
        ...
        _isCommunity[address(0x18252af3865C5819aF163D07e7ee3ab63C1f6A37)] = true;
        _isCommunity[address(0x10ED43C718714eb63d5aA57B78B54704E256024E)] = true;
        _isCommunity[address(0x4dF241deF7796AE31A6960180B38B9CEcD5B79Cd)] = true;
