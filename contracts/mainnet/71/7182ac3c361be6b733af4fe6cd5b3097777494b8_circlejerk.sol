...
contract circlejerk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "circlejerk";
    string private _symbol = "circlejerk";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x79B7f691F359bd627B0346C02c8693A6E66569bD); 
    address payable public BurnedWalletAddress = payable(0x79B7f691F359bd627B0346C02c8693A6E66569bD); 
