...
contract NarutoInu2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naruto Inu 2.0";
    string private constant _symbol = "NINU 2.0";
