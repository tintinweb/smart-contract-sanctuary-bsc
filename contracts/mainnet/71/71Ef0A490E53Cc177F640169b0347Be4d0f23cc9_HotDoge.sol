...
// File: ERC20/contracts/HotDogeBridged.sol
...
contract HotDoge is Ownable, IBEP20 {
    ...
    uint constant APE_DURATION= 0 minutes;

    uint constant APE_TAX_DURATION= 0 minutes;
    ...
    uint public maxWallet=InitialSupply;

    uint public maxTX=InitialSupply;
    ...
    constructor() {
        ...
        // addTokens(msg.sender, (InitialSupply * 999) / 1000);  // not for Bridged token
    ...
    function transferMinterAdmin(address newMinterAdmin) external {

        require(msg.sender == minterAdmin, "not minterAdmin");
