...
CR7 token is a potential token to reach X1000 as a target. 
CR7 is built on the binance smart chain network which is supported by CR7 FAN. 
THIS IS COMMUNITY TOKEN AND DEV TOKEN WE ARE MOONING.

https://t.me/CR7FANSTOKENN
...
contract CR7Fans is IBEP20, Auth {
    ...
    string constant _name = "CR7 Fans Token";
    string constant _symbol = "CR7BNB";
    ...
    address private marketingFeeReceiver =0xe724c0d03E06a53Ed1e0DFd11A5E71afedd6633f;
    address private teamFeeReceiver =0xe724c0d03E06a53Ed1e0DFd11A5E71afedd6633f;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xe724c0d03E06a53Ed1e0DFd11A5E71afedd6633f;
