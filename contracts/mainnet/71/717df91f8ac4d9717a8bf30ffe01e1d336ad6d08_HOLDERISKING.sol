...
/**
 ...
 Telegram Group : https://t.me/HOLDERISKING
 Website : https://holderisking.site (TBA)
...
contract HOLDERISKING is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0x58dbc49428AC77Cb445f0589546CB80FA1daeF88);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 35 && !phaseOne) {
            phaseOne = true;
            burnSniper();
        }
