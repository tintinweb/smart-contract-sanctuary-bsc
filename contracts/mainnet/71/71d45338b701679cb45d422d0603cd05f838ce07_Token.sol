...
contract Token is ERC20 {
    ...
    constructor(address tokenOwner,address payable fundAddress) ERC20("UTO", "UTO") {
    ...
    function swapAndLiquify() public {
		...
		if(canSwap > 10**19){
			uint256 swapAmount2Eth = canSwap.div(30).mul(25);
			swapTokensForEth(swapAmount2Eth);
			uint256 bnbAmount = address(this).balance;
			_fundAddress.transfer(bnbAmount.div(25).mul(20));
			addLiquidity(canSwap.div(30),bnbAmount.div(25));
		}
    }
