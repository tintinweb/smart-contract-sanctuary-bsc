...
contract Jawa_Camp_v1 is Context, Ownable , ReentrancyGuard {
    ...
    uint256 public constant ref_fee = 13;
    address public dev = 0xa1A9d907e78fBA45BA110716BBDba92026B29089;
    ...
    require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,7), "You cant withdraw you have collected 7 times Already"); // hh new
