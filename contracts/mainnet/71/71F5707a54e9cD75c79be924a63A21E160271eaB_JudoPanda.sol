...
/*
JudoPanda
TG : https://t.me/JudoPandaBSC

A new born panda that wish to become a Judo master, JudoPanda is a P2E game that allow holder to mint a baby panda as a NFT & raise it to become a Judo master!

By raising your panda up into a certain level, it will give you more and more reflection of JudoPanda token. It is a fun & simple game with reward, only in BSC.

Tokenomics:
~ 100 Billion of Supply
~ 8% of Tax Fee
~ Starting with 1 BNB ($300 MC)

Come and join JudoPanda!
*/
...
contract JudoPanda is Context, IERC20 { 
    ...
    string private constant _name = "JudoPanda"; 
    string private constant _symbol = "JPANDA"; 
