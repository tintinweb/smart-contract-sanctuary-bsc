...
/**     THOSE 👈
    ...
    These type of memes running hard $this $wen $the $that so here are $THOSE 👈
...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 contract THOSE is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x4D2b1201F9955a5dAA1B61e6F620a04F2134Bdc7;
    address public charityAddress = 0x51b6470632441Cf545a514eAc6B053F452a25Ddc;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 3;
    uint public sellMarketingFee = 13;
    ...
    uint public maxWalletAmount;// 5% max wallet (constructor)
...
// constructor
    constructor() ERC20("THOSE", "$THOSE") {
        ...
        maxWalletAmount = ( total_supply / 100 ) * 5;
        //spawn pair
