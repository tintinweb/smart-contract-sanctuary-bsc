...
// CHANGE
contract StrayGrimaceCat is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Stray Grimace Cat";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0497c1Df43f82deCc12660FE6B4c7c3FE65fD847);
