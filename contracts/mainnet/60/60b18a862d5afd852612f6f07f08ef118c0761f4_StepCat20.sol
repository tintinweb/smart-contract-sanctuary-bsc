...
contract StepCat20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Step Cat 2.0"; // 
    string private constant _symbol = "STEPC2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xA287DCC7A56D097C4596884a4374470dbF4bfDab;
