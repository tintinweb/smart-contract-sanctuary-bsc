...
/**
 * @title Trippy Trunkz Prize Ticketz NFT Contract
 */
contract TrippyTrunkzPrizeTicketz is ERC721Base, ReentrancyGuard {
    ...
    function mint(address _to, uint256 _amount) external nonReentrant payable {
    ...
    function airdrop(address[] calldata _tos, uint256[] calldata _amounts) external onlyOwner {
