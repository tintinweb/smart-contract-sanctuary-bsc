...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyLPDividendFee = 350;   //买进LP分红 不要就写0
    uint256 public _buyLPFee = 0;  //LP回流    /   
    uint256 public _buyBlackFee = 100;  //销毁
    ...
    uint256 public numTokensSellToFund = 500000000;   //回流阈值，一般发行量初一10000的数量
    ...
    constructor (
        ...
        maxTXAmount = 5888 * 10 ** Decimals;   //单笔限购
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0xe53ec4582f700E7e59008A36d8f859A0c2146053), //营销地址
    
        address(0xD8A22A43c32CA08d739666BD38287D587CF00048)  //
    ){
