...
/**
SnakeMoney
🐍SNAM Meme Token 🐍Celebration 
https://t.me/SNAMToken
⚡️Giveaway Announcement ⚡️
🥁On the occasion of the SnakeMoney IDO on the GAGARIN
✔️LP LOCK
✔️Renounce
✔️Degen BSC Play
🥁SnakeMoney.io Play-To-Earn in minutes!
🥁https://snakemoney.io/
...
contract SnakeMoney is SnakeMoneyDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SnakeMoneyTeam;
    address private CharitySnakeMoney;
    ...
    string public override name = "SnakeMoney";
    string public override symbol = "$SNAM";
    ...
    constructor(uint totalSupplyValue, address SnakeMoneyTeamAddress, address CharitySnakeMoneyAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SnakeMoneyTeam = SnakeMoneyTeamAddress;
        CharitySnakeMoney = CharitySnakeMoneyAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SnakeMoneyTeam] =  totalSupply * 4 / 100;
        balances[CharitySnakeMoney] = totalSupply * 4 / 100;
