...
/**
 *
  Telegram : https://t.me/officialdogequeen
  Website : https://dogequeen.finance
*/
...
contract contractdogequeen is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Queen";
    string private _symbol = "dogequeen";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x1A1e6eF90dB0fD233F372bfBBD5B476199D06545);
    ...
    constructor () {
        ...
        _maxBalance = 100 * 10**9 * 10**_decimals;
