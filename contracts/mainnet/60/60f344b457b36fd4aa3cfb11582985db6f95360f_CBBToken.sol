...
/**
* Telegram: https://t.me/CBBPortal
* Website:  http://CompetitionBuyBot.io/
* twitter:  https://twitter.com/CBBTrending
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C13141CEb9813179c23a4Af3c578190b18B8F12;
...
contract CBBToken is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x3C13141CEb9813179c23a4Af3c578190b18B8F12);
    ...
    string private _name = "CompetitionBuyBot"; 
    ...
    uint256 public maxPossibleFee = 18; 
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= maxPossibleFee, "Cannot increase above 18%.");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
