...
contract TaromaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Taromaru Inu";
    string private _symbol = "Taromaru";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf9cAdE2E1C8ed9Ee4128785BC975F65dCE71Dd47);
    address payable public BuyBackWalletAddress = payable(0xf9cAdE2E1C8ed9Ee4128785BC975F65dCE71Dd47);
