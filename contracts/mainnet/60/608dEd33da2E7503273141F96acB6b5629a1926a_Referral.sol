...
contract Referral is AccessControl {
    ...
    function addReferrer(address _user, address _referrer) external onlyRole(OPERATOR_ROLE) {
    ...
    function addRewards(address _user, bytes32 _type, uint256 _total) external onlyRole(OPERATOR_ROLE) {
        require(_user != address(0), "user_zero");
