...
contract LibertarianBeerUS is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor()
        ERC20("Libertarian Beer US", "LBUS")
        ERC20Permit("Libertarian Beer US")
    {
