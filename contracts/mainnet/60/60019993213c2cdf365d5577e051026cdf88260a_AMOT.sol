...
contract AMOT is Operator {
    ...
    string private _name = "AMOT";//#币名
    string private _symbol = "AMOT";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 1000000 * 1e9;//#总币量
    ...
    constructor () public {
        ...
        setWhiteList(address(0xcB690f8f881CD4E8322848fc223632C610bd1c30),true);
    }
