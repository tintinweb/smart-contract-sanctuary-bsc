...
contract ZhuBi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZhuBi";
    string private _symbol = "ZB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9C49c34AFE95Cf95B6eCab9CB21ED3647A6117f5); 
    address payable public BurnedWalletAddress = payable(0x9C49c34AFE95Cf95B6eCab9CB21ED3647A6117f5); 
