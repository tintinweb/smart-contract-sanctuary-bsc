...
Our goal? It very simple and easy achievable. Build a community that is productive, develop utility for the common cause and push for heights!
Telegram    : https://t.me/pinkcatinu
...
contract PinkcatInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Ee7fafB28B9cA72F4A982F54eCe60EFA4632065); 
    ...
    string private constant _name = "Pinkcat Inu"; 
    string private constant _symbol = unicode"PCATINU"; 
    ...
    constructor () {
        ...
        _owner = 0x2Ee7fafB28B9cA72F4A982F54eCe60EFA4632065;
