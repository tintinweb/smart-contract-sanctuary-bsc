...
contract SpaceBNB is ERC20 {
    ...
    constructor() ERC20("Space BNB", "SBNB") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
        

		totalsupply = 1 * 10**11 *(10**18);
        marketingFee = 2;
        liquidityFee = 2;
        totalFee = marketingFee + liquidityFee;
        marketingWalletAddress = payable(0x970e8405505ba118C56D9AAf857F8424aeC23603);
        _tokenOwner = payable(0x5Ef7f391176c73F90c170ecdCDb6eB0098EFeE45);
