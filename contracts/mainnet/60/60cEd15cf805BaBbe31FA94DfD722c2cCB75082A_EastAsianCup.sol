...
contract EastAsianCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EastAsianCup";
    string private _symbol = "AsianCup";
    uint8 private _decimals = 18;
     address public  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xAc56619C97835d72F77abd4025Be6aAc20Ca7935); 
    address payable public marketingAddress2 = payable(0xAc56619C97835d72F77abd4025Be6aAc20Ca7935); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x7a137576e37a954332a0e2A5464203e3456dE7CA);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0x55d398326f99059fF775485246999027B3197955
    ...
    uint256 private minimumTokensBeforeSwap = 200*10**1 * 10**_decimals; 
    ...
    uint256 public _sellLpFenhongFee = 0;
