...
contract BABYPI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2cF130ce22f9572B52aCeF48eB47EA7892f48Fb0); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10000000 * 10**2 * 10**9;
