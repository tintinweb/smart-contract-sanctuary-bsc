...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb6709af756893fd586c14BDb391C2C68e5d343c7; // owner address
...
contract PawBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Paw Burn";
    string private _symbol = unicode"$PB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb6709af756893fd586c14BDb391C2C68e5d343c7); // Marketing Address
    address payable public teamWalletAddress = payable(0xb6709af756893fd586c14BDb391C2C68e5d343c7); // Team Address
