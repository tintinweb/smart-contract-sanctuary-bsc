...
Elon Tweet Low MC need Reached to Millions MC

Token Supply : 77.777.777
Token Name : ElevenDoge
Symbol : ELDOGE

    10% Liquidity Pancake
    90% Token Burned
    No Team Token
...
/* Token contract */
contract ElevenDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xcBbC79B403ca32c1d841a89A0c953c18DD38776B;
    ...
    // Name and symbol
    string constant _name = "Eleven Doge";
    string constant _symbol = "ELDOGE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 77777777 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 100 / 10000; // 4% on launch 
    uint256 private _maxSellTxAmount = _totalSupply * 100 / 10000; // 4% 
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 4% 
    ...
    uint256 private totalFeeSell = 6;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x07c84674ed36DECc6A0628aBC278119511Fd1964;
