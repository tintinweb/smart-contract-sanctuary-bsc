...
/**
    ...
    Official Valentine Inu

        Telegram: https://t.me/ValentinesInuTBA
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract ValentineInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x377EFbF35dE0017556F02ADe9b8921Ddc22F3808); // Marketing Address

    address payable public teamAddress =
        payable(0x377EFbF35dE0017556F02ADe9b8921Ddc22F3808); // Team Address

    address payable public liquidityAddress =
        payable(0x985A96d11accd9c40A9e888d609Be3F881607083); // Liquidity Address
    ...
    string private constant _name = "ValentineInu";
    string private constant _symbol = "$ValentineInu";
