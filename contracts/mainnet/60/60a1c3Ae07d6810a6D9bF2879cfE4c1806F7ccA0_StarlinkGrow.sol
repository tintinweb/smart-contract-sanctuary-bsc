...
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: https://t.me/StarlinkGrow
...
/**
 FOR REAL MF YOU ARE READING THIS GIMME A CHANCE AND APE ON THIS IN 20HOURS AROUND. THIS A SAFE NICE PLAY @OurCryptoHood
*/
...
contract StarlinkGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4c63067EF1faaBe2d5D335A06719f7a841f2FeAb); 
    address payable public Wallet_Team = payable(0x4c63067EF1faaBe2d5D335A06719f7a841f2FeAb);
    ...
    string private constant _name = "IfYouReadingThisJoinThatTGLinkThisIsAMoonshotEveryoneLovesXS"; 
    string private constant _symbol = unicode"IYRTJTTLTIAMELXS"; 
