...
contract SUCMETA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUCMETA";
    string private _symbol = "SUCMETA";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xe60153cB5eA4830A05B2b3BE08b8beFB35049484); 
    address payable public ttWal = payable(0xe60153cB5eA4830A05B2b3BE08b8beFB35049484); 
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000000 *  10**_decimals;
