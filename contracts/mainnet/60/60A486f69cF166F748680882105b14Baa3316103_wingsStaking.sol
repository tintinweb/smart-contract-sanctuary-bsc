...
contract wingsStaking is Ownable {
    ...
    uint256 public _7daysApr = 18;
    uint256 public _14DaysApr = 37;
    uint256 public _30DaysApr = 64;
    uint256 public _60daysApr = 103;
    uint256 public _unlimitedDaysApr = 8;
    ...
    constructor() {
        _token = msg.sender;
        REWARD = IERC20(0xc0fe33B654d13AF5a72C47Dc5a370674ba85b3E6);
        STAKING = IERC20(0xc0fe33B654d13AF5a72C47Dc5a370674ba85b3E6);
    }
    ...
    function changeApr(
        ...
        _30DaysApr = _30days;
        _60daysApr = _60days;
        _unlimitedDaysApr = unlimitedDays;
        useApy = _useApy;
    }
    ...
    function calculatRewardByAPY(
        ...
        uint256 const36500 = 36500;
        for (uint256 i = 0; i < timeDays; i++) {
            //apr/(365*100) gives the daily return. (36500+apr)/36500 = (1+apr/(365*100))
            reward = reward.mul(const36500.add(apr)).div(36500);
        }
        if (improveAccuracy) {
            //increase accuracy
