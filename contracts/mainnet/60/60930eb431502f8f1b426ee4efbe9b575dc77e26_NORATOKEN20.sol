...
contract NORATOKEN20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nora Token";
    string private constant _symbol = "Nora2.0";
    ...
    uint256 public swapTokenAtAmount = 100000000000000 * 10**_decimals;

    address public liquidityReceiver; 
    address private marketingWallet = address(0x92863231d5DBF6B83864b194774a3BfC424d26Fe);
