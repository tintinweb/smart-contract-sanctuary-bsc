...
contract XRPCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XRP CEO"; 
    string private _symbol = "$XrpCeo"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xddE4397cd78b2C450DB1eBAaB088e78E6E2feb97); 
    address payable public teamWalletAddress = payable(0xddE4397cd78b2C450DB1eBAaB088e78E6E2feb97); 
