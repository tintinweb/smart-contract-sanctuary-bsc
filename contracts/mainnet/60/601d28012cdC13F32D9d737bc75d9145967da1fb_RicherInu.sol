...
contract RicherInu is IERC20 {
    ...
    string constant private _name = "Richer Inu";
    string constant private _symbol = "RCR";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        treasury: payable(0xF7FF8d3e81Ad55Aae469D3068F4187586decC195)
    });
...
//===============================================================================================================
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if (ratios.treasury > 0) {
            (success,) = _taxWallets.treasury.call{value: treasuryBalance, gas: 35000}("");
        }
    }
