...
contract BaseToken is Ownable {
    ...
    string constant public name = "DOGE0.5";

    string constant public symbol = "DOGE0.5";
    ...
    address public projectAddress = 0x68886cAccC3bd9E2EaCE735738A0E58e1CDA11D1;
...
contract DOGE05 is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0x68886cAccC3bd9E2EaCE735738A0E58e1CDA11D1;
