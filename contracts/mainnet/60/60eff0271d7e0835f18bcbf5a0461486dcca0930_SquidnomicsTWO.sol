...
Buy:  4% marketing, 2% LP
Sell: 4% marketing, 2% LP
...
/* Token contract */
contract SquidnomicsTWO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x466b748b557265f9F2f19a59C8d29cbe54bBa9a3;
    ...
    // Name and symbol
    string constant _name = "Squidnomics 2.0";
    string constant _symbol = "SQUID 2.0";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 30000; // 1%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 30000; // 1%
  ...
  // Sell fees
    ...
    uint256 public totalFeeSell = 80;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb72998bc30e956c30cE437f4D8987FA5e5a7A4a9;
