...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); 
...
contract ETHEREUM2 is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xf91Ab5463100E2deB32E79AB420A2302f75D090a;
    address DevWallet       = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;

    string constant _name = "Ethereum 0.5";
    string constant _symbol = "EthreumHalf";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 2000 * (10 ** _decimals);
