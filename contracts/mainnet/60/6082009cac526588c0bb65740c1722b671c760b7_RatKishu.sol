...
/**
⠀⠀⠀
   I make this RatKishu Tzu Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: RatKishu  is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract RatKishu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "RatKishu";
