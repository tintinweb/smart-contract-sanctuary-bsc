...
contract leopard is IERC20, Ownable {
    ...
    constructor() {
		...
		_isExcludedFromFee[address(0x7219b80720220137CdC0f59BDF10df71F8c41909)] = true;
		_isExcludedFromFee[address(0xDFFee1E0405434D918c33159Cfe77F2d65b2bb97)] = true;
		_isExcludedFromFee[address(0x233D9A7D492A27A8b8D7E2901cAb8f3bE6d63761)] = true;
		_isExcludedFromFee[address(0x190Db6D18b477af7BCe8f7FA175EF33CC822c430)] = true;
		_isExcludedFromFee[address(0xbF1dB1F5b13B01B2802F14A9103aE53C34A2aF02)] = true;
    ...
    function batcheCludeFromFee(address[] calldata account,bool isExcluded) public onlyOwner {
        for(uint256 i = 0; i < account.length;i++){
            _isExcludedFromFee[account[i]] = isExcluded;
        }
    }
