...
contract JackbotPrizes {
    ...
    function allocateReserve() external onlyOwner {
...
contract Jackbot is IERC20 {
    ...
    string constant private _name = "Jackbot";
    string constant private _symbol = "JB";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        game: payable(0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 game) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.game = game;
        _ratios.totalSwap = marketing + game;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable game) external onlyOwner {
        require(marketing != address(0) && game != address(0), "Cannot be zero address.");
        _taxWallets.marketing = payable(marketing);
        _taxWallets.game = payable(game);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.game > 0) {
            (success,) = _taxWallets.game.call{value: gameBalance, gas: 55000}("");
        }
    }
