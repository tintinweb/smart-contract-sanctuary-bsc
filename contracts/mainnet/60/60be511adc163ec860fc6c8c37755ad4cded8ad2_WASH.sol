...
contract WASH is BEP20, BEP20Burnable, Pausable {
    constructor() BEP20("WASH", "CLEANS") {
     ...
     function claimStuckedTokensAndBNB(address _token) external onlyOwner {
        ...
        if (_token == address(0x0)) {
            ...
            return;
             ...
             require(balanceOf(address(this))> 0, "WASH: Contract balance should be greator than zero");
