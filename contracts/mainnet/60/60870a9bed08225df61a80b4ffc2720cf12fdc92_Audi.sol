...
contract Audi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB8060122121527221D3645c31a50fc1cA6bEc293);
    address payable public teamWalletAddress = payable(0x6f15a38fb971Ccd9CFAA028E47db88E8109Cf01b);
    ...
    constructor () {
        ...
        isWalletLimitExempt[address(this)] = false;
