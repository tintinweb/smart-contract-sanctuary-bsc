...
contract FGDCHAINTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FGDCHAINTOKEN";
    string private _symbol = "FDG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x452AFCFcf36B82C3EfE2de8fab941c810A7C0Ac5); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x1A45b094b9eEAE43826C618a5E00a9B38100897a); // Development Address
