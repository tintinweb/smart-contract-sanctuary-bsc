...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8Fb36CAba48EEB171F5025d019a0c8Cf2e517f40;
...
contract HIBATOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x39F8996d9014C89AE78Ab152581E6b88598307c1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HIBATOKEN";
    string private _symbol = "HICO";
