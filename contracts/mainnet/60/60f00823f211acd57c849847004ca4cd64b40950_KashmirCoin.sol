...
* Coin Website:               https://www.kashmircoin.co.uk

* Business Websites:          https://www.kashmircommunity.com & https://www.kashmirtv.co.uk

* Crypto Exchange Website:    https://www.trueinternetmoney.com

Kashmir Coin features:

        6% fee auto add to the liquidity pool to locked for liquidity providers
        2% fee auto distribute to all holders
        3% fee auto distribute to marketing and giveaway wallet
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7d0cb25Ea02E06EF5f0678870Bf7a211159278EC;
...
contract KashmirCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc2FE05F558034Aca37f32E80e9F9D8cd064369c6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kashmir Coin";
    string private _symbol = "KASHMIR";
