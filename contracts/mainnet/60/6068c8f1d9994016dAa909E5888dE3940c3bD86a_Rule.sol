...
contract Rule is Context, Ownable {
    ...
    uint256[] public _rate=[10,10,10,20,10,20,10];

    address public _tokenAddr=address(0x34E3dfFfDE1a657Fb34d1E98d0044C2bA1d97A8E);
  ...
  function buy( address u, uint256 a) private returns(uint256 sy) {
    ...
    function sell( address u, uint256 a) private returns(uint256 sy) {
        ...
        if(_rate[4]>0){ sy-=addBalanceWithLog(u,_fundAddress,a*_rate[4]/1000);}
