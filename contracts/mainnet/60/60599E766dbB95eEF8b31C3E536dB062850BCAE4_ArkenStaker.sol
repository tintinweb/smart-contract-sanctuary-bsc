...
contract ArkenStaker is ArkenSmithyPool {
    ...
    function handleArkenPerBlockChange(uint256, uint256) public {
        massUpdatePools();
    }
    ...
    IArkenSmithyPool
{
    ...
    function handleArkenPerBlockChange() public virtual {}
}
...
contract ArkenSmithy is Ownable, ReentrancyGuard {
    ...
    function set(
        ...
        IArkenSmithyPool(poolAdmins[_pid]).handleArkenPerBlockChange(
    ...
    function setPoolAdmin(uint256 _pid, address _newAdmin) external {
        ...
        IArkenSmithyPool(_newAdmin).handleArkenPerBlockChange(
            0,
            poolInfos[_pid].arkenPerBlock
        );
