...
contract FuckCardano is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuckCardano";
    string private _symbol = "FC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDe02279401Ebe44EAFCBace949176f7Da70aE2cd); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xDe02279401Ebe44EAFCBace949176f7Da70aE2cd); // BuyBack Address
