...
contract florkdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd11aeb72B8a37Ef83048E41A027C8a6171BCd044); // Marketing Address
        
    address payable public teamAddress =
        payable(0xF748ccb59Bf7Ba5CEb3589Bee7A36B9779BEC677); // Team Address
        
    address payable public liquidityAddress =
        payable(0xF748ccb59Bf7Ba5CEb3589Bee7A36B9779BEC677); // Liquidity Address
    ...
    string private constant _name = "flork doge";
    string private constant _symbol = "florkdoge";
