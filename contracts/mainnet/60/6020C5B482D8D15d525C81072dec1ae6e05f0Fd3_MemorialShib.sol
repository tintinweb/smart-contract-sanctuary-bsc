...
The memecoin scene is full of scams and millions of investors in crypto lost their trust and hope in memecoins.. will you APE into another honeypot/rugpull/taxrugg or join and create a safe memecoin community to finally make gains again?
I make #MSHIB to hand it over to the community. I will still be working in the background, add LP (if needed), get marketing deals, create a Twitter and make relevant updates on the Website.
I will create a TG, and choose some people to be Admins. Are you ready to create the best community on  BSC?

You will find the TG on the Website.


Memorial Shib
Honor our fallen bulls.
Flags, insignia, and flowers will be placed on the graves of all memes, fallen in the bearmarket.


I will burn liquidity LPs to burn addresses to lock the pool forever.
After I blacklisted all bots, I will renounce the ownership to burn addresses to transfer #MSHIB to the community and ensure it's 100% safe.

I will add 3.333 BNB and 95% of the total supply to the pool.

- Total Supply: 300000000 
- Buy and Sell Fee: 5%

Can you make #MSHIB 10000000X? 


Website: https://memorialshib.com/



In remembrance of those who fell to preserve the light of freedom - Elon Musk
https://twitter.com/elonmusk/status/1531279278624612352?s=20&t=aKkVwkpXG47QJvyjAAP04w
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4Fa6DBcC78f33401221865d82FbaBb9f0A3889D1;
...
contract MemorialShib is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x4Fa6DBcC78f33401221865d82FbaBb9f0A3889D1);
    ...
    */
    ...
    string private _name = "Memorial Shib"; 
