...
contract ShitcoinHour is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7ecE17230B6e1a241725869B18c998bA33A114A0); 
    address payable public Wallet_Dev = payable(0x9F4e6D0954D19fbCe097B4dDF22FC583487EF0a2);
    ...
    string private constant _name = "ShitcoinHour"; 
    ...
    constructor () {
        ...
        _owner = 0x2F0E73254E142AD79706866CDfc43B7A6D8d1514;
