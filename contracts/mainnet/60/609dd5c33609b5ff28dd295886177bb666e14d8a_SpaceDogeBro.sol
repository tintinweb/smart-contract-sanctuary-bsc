...
contract SpaceDogeBro is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceDogeBro";

    string private _symbol = "SpaceDogeBro";
    ...
    address payable public marketAddress = 0x174EF3079400f928A8Fa59481B09FAf026663C4a ; //Marketing
