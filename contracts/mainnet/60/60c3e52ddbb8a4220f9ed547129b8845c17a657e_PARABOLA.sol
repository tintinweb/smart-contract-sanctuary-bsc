...
🏁Contract Address🏁 : 
0x60C3E52dDBb8A4220f9eD547129B8845c17a657E

💰poocoin💰
https://poocoin.app/tokens/0x60C3E52dDBb8A4220f9eD547129B8845c17a657E

WELCOME TO PARABOLA
Parabola is a cryptocurrency token built on the BNB blockchain. 
Parabola is designed to be a fast and low-cost token for use in a variety of applications, 
including decentralized finance (DeFi) and online gaming. It uses the ERC-20 standard, which allows 
it to be easily integrated with a wide range of BNB-based platforms and services.
...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/BNB/solidity/issues/2691
        return msg.data;
    }
}

interface PARABOLAECO {
    /**
...
contract PARABOLA is Context, PARABOLAECO, Ownable {
    ...
    string private _name = 'PARABOLA';
    string private _symbol = '$PARABOLA';
