...
contract T1 is Context, IERC20, Ownable {
    ...
    string private _name = "StarCloud-M";
    string private _symbol = "StarCloud-M";
    ...
    address payable public marketingWalletAddress = payable(0x5e767D5c5b300AFD7F4838CfbD38dFc9e49614A2);
    address payable public liquidityWalletAddress = payable(0x9904232931c95c0b7cD4F6D56085eD81639b7557);
