...
contract BeanFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0x8a75d2F601913dA221d20fD1727D608EA2CEB95A);
    uint8 public _houseFeePercentage = 30; // In 0.1% increments

    address public _devFeeReceiver = address(0x8a75d2F601913dA221d20fD1727D608EA2CEB95A);
    uint8 public _devFeePercentage = 40; // In 0.1% increments

    uint8 public _referrerFeePercentage = 60; // In 0.1% increments
    ...
    uint256 public _blockWaitTime = 1; // How many blocks we want to wait before finalizing a game
