...
contract AgroConnect is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 10000000 * _decimalFactor; // 1% do Supply
    uint256 public maxBuyAmount = 10000000 * _decimalFactor; // 1% do Supply
    ...
    /*=== Strings ===*/
    string private _name = "Agro Connect";
