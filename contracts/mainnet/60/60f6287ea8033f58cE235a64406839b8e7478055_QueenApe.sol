...
contract QueenApe is Context, IERC20, Ownable {
    ...
    string private _symbol = "QueenApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa96174a9f0a2E488b97e3dA5544A4E9b61494698); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xbC0aa88BD089255B4D0A40f5AD3B3A4b869407C9); // Buyback Address
