...
contract GrowHige is Context, IERC20, Ownable {
    ...
    string private constant _name = "GrowHige";
    string private constant _symbol = "$GROWHIGE";
    ...
    constructor () {
        _MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6);
        _liquidityWallet = payable(0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928);
        _devWallet = payable(0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928);
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        ...
        require(newAmount <= 10000000001 * 10**9, "Swap amount cannot be higher than 1.0% total supply.");
