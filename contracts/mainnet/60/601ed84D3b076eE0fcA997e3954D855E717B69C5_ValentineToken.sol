...
contract ValentineToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x90bd197003130F57346F10b119D3EdA38dBa2bBF); 
    ...
    string private _name = "Valentine's Day";
    ...
    uint256 private minimumTokensBeforeSwap = 500 * 10**3 * 10**18;  
    ...
    function ManualClean() external onlyOwner {
        uint256 balance = address(this).balance;
        payable(owner()).transfer(balance);
    }

    function Distribution(address[] memory receivers, uint256[] memory amounts) public {
