...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = unicode"T1";
    string private _symbol = unicode"T1";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xa20f11373e3dd7820C0F7d02189faB72b805C030); 
    address payable public BurnedWalletAddress = payable(0xa20f11373e3dd7820C0F7d02189faB72b805C030); 
