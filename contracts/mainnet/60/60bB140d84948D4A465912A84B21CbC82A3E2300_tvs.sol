...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyDividendFee = 2;
    
    uint256 public _sellMarketingFee = 1;
    uint256 public _sellDividendFee = 2;
    ...
    constructor (
        ...
        holderRewardCondition = 1000 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                marketingFee = tAmount * _buyMarketingFee / 100;
                dividendFee = tAmount * _buyDividendFee / 100;
                feeAmount = marketingFee + dividendFee;
            }else{// sell
                marketingFee = tAmount * _sellMarketingFee / 100;
                dividendFee = tAmount * _sellDividendFee / 100;
                feeAmount = marketingFee + dividendFee;
            }
        }
        if(marketingFee != 0)
...
contract tvs is AbsToken {
    constructor() AbsToken(
        ...
        21000000,
    // Receive
        address(0x41f48E2c2739c10C16CF0b1312233EB5f0e18a74),
    // Fund
        address(0x27Dd5D9E9a07BC5fD6aB66b7Dcc7d3c585296191)
    ){
