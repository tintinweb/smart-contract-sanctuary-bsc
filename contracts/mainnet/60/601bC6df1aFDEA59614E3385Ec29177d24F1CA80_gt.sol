...
contract gt is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address from, address to, uint256 amount,bool takeFee,uint256 indic) private {
       ...
       // toamount =toamount- taxpart;
       // }

        // if (feecat==1){  fromamount=fromamount - toamount;    }
        
        _tOwned[to] = _tOwned[to]+toamount;
        _tOwned[from] = _tOwned[from]-fromamount;
