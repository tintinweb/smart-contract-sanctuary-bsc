...
contract ApeVerse is ApeVerseDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ApeVerseTeam;
    address private CharityApeVerse;
    ...
    string public override name = "ApeVerse";
    string public override symbol = "ApeVerse";
    ...
    constructor(uint totalSupplyValue, address ApeVerseTeamAddress, address CharityApeVerseAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ApeVerseTeam = ApeVerseTeamAddress;
        CharityApeVerse = CharityApeVerseAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ApeVerseTeam] =  totalSupply * 4 / 100;
        balances[CharityApeVerse] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ApeVerseTeam pot
