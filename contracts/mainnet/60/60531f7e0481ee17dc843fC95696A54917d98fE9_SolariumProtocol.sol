...
contract SolariumProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Solarium Protocol";
    string private _symbol = "$SOLPRO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA0D5Bca20Ef304793Ef274B7bE70D44318308fAF));
        marketingWalletAddress = payable(address(0x4CAC1CB03cb43bb2Aadd47B3548D74fd73000113));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xccb0a10FDfD6b9f388D314e07614307aA176CC6d), _msgSender(), _totalSupply);
    }
