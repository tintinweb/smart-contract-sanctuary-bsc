...
contract VSHACOM is Context, IERC20, Ownable {
    ...
    address payable public _taxPool =
        payable(address(0x0796488ffc49D0d217bdC199af6259002B5999D4));

    string private _name = "VSHACOM";
    string private _symbol = "VSHA";
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**8; // 0.5% of total supply
    uint256 public _maxWalletSize = 2 * 10**7 * 10**8; // 2% of total supply
