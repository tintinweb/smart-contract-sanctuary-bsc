...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb089df7f50b51808985cB0385dFe8C3cFe4054b6; // owner address
...
contract ShikokuCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIKOKU CEO";
    string private _symbol = "SC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF9afBcCD5A7b9579d5f64639be3bD105FaD0FFAa); // Marketing Address
    address payable private teamWalletAddress = payable(0xF9afBcCD5A7b9579d5f64639be3bD105FaD0FFAa); // Team Address
