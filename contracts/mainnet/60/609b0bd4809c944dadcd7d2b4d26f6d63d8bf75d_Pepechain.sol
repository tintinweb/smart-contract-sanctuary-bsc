...
contract Pepechain is Context, IERC20, Ownable {
    ...
    string private _symbol = "PCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x463A0Fbb5150eF35a2b3Ba147A6eac724C97beFc); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x463A0Fbb5150eF35a2b3Ba147A6eac724C97beFc); // Team Address
