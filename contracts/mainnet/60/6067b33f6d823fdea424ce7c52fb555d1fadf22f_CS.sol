...
contract CS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE186daE40e966777868E204B6A0e6F014c461961); 
    address payable public marketingAddress2 = payable(0xE186daE40e966777868E204B6A0e6F014c461961); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xE186daE40e966777868E204B6A0e6F014c461961);
    ...
    uint256 public coolBlock = 10;    //区块链机器人杀10秒
    ...
    uint256 public _buyDestoryFee = 1;   //销毁
    uint256 public _buyBackLpFee = 1;    //回流
    uint256 public _buyLpFenhongFee = 1;  //分红
