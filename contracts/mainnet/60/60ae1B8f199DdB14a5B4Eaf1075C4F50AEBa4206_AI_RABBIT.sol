...
contract AI_RABBIT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AI Rabbit";
    string constant _symbol = "AI Rabbit ";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTC
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x9529A3238edE1504D942e5DF93f0E15C963bCEFE;
        marketingWallet = 0x9529A3238edE1504D942e5DF93f0E15C963bCEFE;
        devWallet = 0x9529A3238edE1504D942e5DF93f0E15C963bCEFE;
    ...
    function changeTxLimit(uint256 newLimit) private authorized {
        _maxTxAmount = newLimit;
    }

    function changeWalletLimit(uint256 newLimit) private authorized {
        _walletMax  = newLimit;
    }
    ...
    function setFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
    ...
    function setFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newDevWallet) external authorized {
