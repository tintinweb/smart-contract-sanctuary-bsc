...
// $NGN fiat channel is live on #Binance. This is huge for crypto #Nigerians 🇳🇬🚀

// TG: https://t.me/BinanceNGNOfficial

// CZ Tweet: https://twitter.com/TwiterLTC/status/1589709224740884485?s=20&t=Ex1NH0NKjDvYnLyNnvv-UA
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  DOGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // DOGE Rewards
...
/* Token contract */
contract Binance$NGN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address DOGE = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // DOGE Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x75455A135bcD8c31b5694047C72c50AeB96bfA06;
    ...
    // Name and symbol
    string constant _name = "Binance $NGN ";
    string constant _symbol = "$NGN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9f1B0e015A3D6987a2E245fee78DD6dcFfaF89B6;
