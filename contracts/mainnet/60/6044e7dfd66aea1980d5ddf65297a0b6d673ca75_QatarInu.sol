...
contract QatarInu is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"QINU"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 10000 / 100;
