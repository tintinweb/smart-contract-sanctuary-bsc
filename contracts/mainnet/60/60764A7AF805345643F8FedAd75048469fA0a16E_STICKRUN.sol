...
/*
TELEGRAM: https://t.me/StickRunPortal
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB24925b3a4C57440FfF47F5a63aDC7b5dCaF02C3; // owner address
...
contract STICKRUN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StickRun";
    string private _symbol = "RUN  ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB24925b3a4C57440FfF47F5a63aDC7b5dCaF02C3); // Marketing Address
    address payable public teamWalletAddress = payable(0xB24925b3a4C57440FfF47F5a63aDC7b5dCaF02C3); // Use Same Address as Marketing Address
