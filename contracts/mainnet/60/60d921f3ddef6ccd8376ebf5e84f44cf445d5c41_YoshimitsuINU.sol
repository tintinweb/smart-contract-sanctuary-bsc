...
contract YoshimitsuINU is Context, IBEP20, Ownable {
    ...
    uint256 public _liquiditySellFee = 2;                           // Liquidity Fee to sell
    uint256 public _liquidityBuyFee = 2;                            // Liquidity Fee to buy

    uint256 public _rewardSellFee = 1;                              // Reflected reward Fee to sell
    uint256 public _rewardBuyFee = 1;                               // Reflected reward Fee to buy

    uint256 public _marketingSellFee = 0;                           // Marketing Fee percent to sell
    uint256 public _marketingBuyFee = 0;                            // Marketing Fee percent to buy

    uint256 public _charitySellFee = 0;                             // Charity Fee percent to sell
    uint256 public _charityBuyFee = 0;                              // Charity Fee percent to buy

    uint256 public _burnSellFee = 0;                                // Burn Fee percent to sell
    uint256 public _burnBuyFee = 0;                                 // Burn Fee percent to buy
    ...
    address public marketingAddress = 0x7253bAaD44685d8Dc950FeF9Cc4eb884E5e7254B;
    address public charityAddress = 0x7253bAaD44685d8Dc950FeF9Cc4eb884E5e7254B;
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x7253bAaD44685d8Dc950FeF9Cc4eb884E5e7254B] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0x7253bAaD44685d8Dc950FeF9Cc4eb884E5e7254B, _tTotal);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != pancakeswapV2Pair, "YINU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "YINU: Automated market maker pair is already set to that value");
