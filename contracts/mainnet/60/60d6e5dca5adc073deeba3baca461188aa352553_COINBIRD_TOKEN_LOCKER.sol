...
contract COINBIRD_TOKEN_LOCKER {
    ...
    function lockableTokensInAccessedContract() public view returns (uint) {
        return connectedTo[msg.sender].balanceOf(msg.sender);
    }
    ...
    function totalSupplyOfAccessedContract() public view returns (uint) {
        return connectedTo[msg.sender].totalSupply();
    }

    function decimalsOfAccessedContract() public view returns (uint) {
        return connectedTo[msg.sender].decimals();
    }
