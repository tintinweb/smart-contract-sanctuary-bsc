...
contract FIFAGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFAGROW";
    string private _symbol = "FIFAGROW";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7b730352573D032444942027C66272C8491456Dc); // Marketing Address
    address payable private developmentWalletAddress = payable(0x50D245B3F28Bd8482762D72ffF2321031E75eC9C); // Development Address
