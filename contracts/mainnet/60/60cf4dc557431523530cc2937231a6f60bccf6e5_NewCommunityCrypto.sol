...
New Community Crypto  -- NCC --

Created from the ashes of the liquidated people in the recent bloodbath

A token that will lay in the foundation of the NEW CRYPTO MARKET. Obviously this one sucks balls and only causes fear and desparation.

Q1 2023 - buying FTX from the free banana market <-- Our goal
...
contract NewCommunityCrypto is Ownable {
    constructor(
        string memory _NAME,
