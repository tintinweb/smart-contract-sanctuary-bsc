...
contract SokudoINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sokudo INU";
    string private _symbol = "SINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x466AeC285A9E3cd05745769f6abc18A897780F55);
