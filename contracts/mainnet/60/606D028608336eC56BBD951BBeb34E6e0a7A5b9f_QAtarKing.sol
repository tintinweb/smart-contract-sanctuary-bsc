...
contract QAtarKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QAtarKing";
    string private _symbol = "QAtarKing";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xE1A84F431859BC45cDE68779665d81eC46F59CD3); 
    address payable private teamWalletAddress = payable(0x435bC0e6B350b8273dDD242f61c97F2685e2D304); 
