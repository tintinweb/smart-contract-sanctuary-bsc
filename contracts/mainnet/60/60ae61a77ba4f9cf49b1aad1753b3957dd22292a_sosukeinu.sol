...
Tg: https://t.me/SosukeInu

Website: https://www.sosukeinu.xyz/
...
contract sosukeinu is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Sosuke Inu";
   string constant _symbol = "SOSUKEINU";
