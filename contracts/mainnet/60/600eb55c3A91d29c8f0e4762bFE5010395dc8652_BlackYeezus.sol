...
contract BlackYeezus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Yeezus";
    string private _symbol = "bYE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xea1a1a38DaA2fA44f9b3c54d87fe163be4eB27bD);
    address payable public LotteryFee = payable(0x8CA9761f1f795758bb61338D6fE4741126897e05);
    ...
    function setLotteryFeeAddress(address newAddress) external onlyOwner() {
        LotteryFee = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBuyBack = amountReceived.mul(_LotteryShare).div(totalBNBFee);
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(LotteryFee, amountBNBBuyBack);
