...
contract Token is ERC20, Ownable {
    ...
    address public _liudityWalletAddress = 0x8b35d10986C97d13648494322e9168D5107C3838;//回流钱包（改）
    address public _mindAddress = 0x8b35d10986C97d13648494322e9168D5107C3838;//中转钱包 授权U给当前合约地址（改）
