...
contract OGShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "OGShiba"; // 
    string private constant _symbol = " $OGSHIBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xdE105d15CfCa1Cb7FBd148E8962E2BA231650f0B;
