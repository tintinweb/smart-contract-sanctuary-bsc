...
/*
    ...
    telegram      : https://t.me/DogBoyGrow
    Website       : https://Dogboygrow.live/
*/
interface IERC20 {
     ...
     *
     * Returns a boolean value indiDoging whether the operation succeeded.
     *
...
library SafeMath {
    ...
    /**
     * @dev Returns the multipliDogion of two unsigned integers, reverting on
     * overflow.
     *
     * Counterpart to Solidity's `*` operator.
     *
     * Requirements:
     *
     * - MultipliDogion cannot overflow.
     */
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multipliDogion overflow");
...
contract DogBoyGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dog Boy Grow"; //
    string private constant _symbol = "DBG"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xA67aC4bAB2a991A188aad9a6a30Ee352607374e4;
