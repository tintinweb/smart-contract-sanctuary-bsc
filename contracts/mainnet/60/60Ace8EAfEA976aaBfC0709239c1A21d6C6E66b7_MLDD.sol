...
contract MLDD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MLDD";
    string private _symbol = "MLDD";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x29A0B4665B6eCA46d20B3bC0Da598f1EA4c3D78c); 
    address payable public BurnedWalletAddress = payable(0xf985D7340E66711eD7e69b4aBf425C2F43b0e486); 
