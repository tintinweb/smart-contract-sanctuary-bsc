...
contract MPCToken is IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient,uint256 tAmount) private {
        ...
        if (sender == address(uniswapV2Pair) || recipient == address(uniswapV2Pair) || sender == address(uniswapV2Router)) {
