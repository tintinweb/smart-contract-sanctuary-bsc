...
/**
Are you ready for GrimaceBurn boy?
*/

// Telegram : https://t.me/GrimaceBurn 
...
contract GrimaceBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrimaceBurn";
    string private _symbol = "$GBURN";
