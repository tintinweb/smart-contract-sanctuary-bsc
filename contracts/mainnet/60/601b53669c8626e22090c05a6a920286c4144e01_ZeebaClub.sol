...
contract ZeebaClub is ERC721Enumerable, Ownable {
  using Strings for uint256;

  uint256 public maximumWalletHoldings = 5;
  address ethHolderWallet = address(0x74821046595CA344105F6A9F7E6620a7c14a5789);
  string baseURI;
  string public baseExtension = "";
  uint256 public cost = 0.25 ether;
  uint256 public maxSupply = 1000;
  uint256 public maxMintAmount = 20;
  uint256 public whitelistMintAmount = 20;
  ...
  constructor() ERC721("Zeeba Club", "ZEECLUB"){
    setBaseURI("");
    setNotRevealedURI("");
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    // 60% for developer/team
    uint256 balance = address(this).balance;
    (bool os, ) = payable(address(0xbd4f2Cfa3Eb88a38A0F73BD5Ad14dB4C965Ece96)).call{value: balance * 20 / 100}("");      
    (os, ) = payable(address(0x94dD5516e274dDD33F5ab4e5468d29fCCD44Ad72)).call{value: balance * 20 / 100}("");
    (os, ) = payable(address(0x49a5eA7bC721fB3a126de83E585C7a19Ea379309)).call{value: balance * 20 / 100}("");
