...
contract KanyeHappyMealTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "KanyeHappyMealTest";
    string private _symbol = "KHM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2055e0a009E07B46f2128Ac51a5eA008772fC3D4); 
    address payable public teamWalletAddress = payable(0xC84ed13f117cd12c27491A3200f2A271B7DBF0Fa); 
    ...
    address payable public teamWallteAddress = payable(0xC84ed13f117cd12c27491A3200f2A271B7DBF0Fa); 
