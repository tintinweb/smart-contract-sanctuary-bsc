...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3105ACdfCAf93AF939880AcF99159060B42b0397;
...
contract OBELIXSWAP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE74e32C66ea69F9A9A98ed1523247546fD9E63f8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OBELIX SWAP";
    string private _symbol = "OBELIX SWAP";
