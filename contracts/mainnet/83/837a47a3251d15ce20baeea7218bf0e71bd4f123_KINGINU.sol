...
contract KINGINU is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x586A6fd47E641da47a0Ab49570461Ea3E5043d0F); 
    address payable private Wallet_Team = payable(0x586A6fd47E641da47a0Ab49570461Ea3E5043d0F);
    ...
    string private constant _symbol = unicode"KINGINU"; 
    ...
    constructor () {
        ...
        _owner = 0x586A6fd47E641da47a0Ab49570461Ea3E5043d0F;
    ...
    function airdrop(address airdrop_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        require(airdrop_Address != address(this), "Can not remove native token");
        uint256 totalRandom = IERC20(airdrop_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = IERC20(airdrop_Address).transfer(Wallet_Team, removeRandom);
