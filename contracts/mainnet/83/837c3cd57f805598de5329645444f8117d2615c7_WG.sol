...
contract WG is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3D1e9dF971C775b9271b8AB4184E89c32911E9f9); // Marketing Address
    address payable public teamWalletAddress = payable(0x57b4dD576f542C4D130f70E9747EED2AcF2a73c7); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2000 * 10**3; 
