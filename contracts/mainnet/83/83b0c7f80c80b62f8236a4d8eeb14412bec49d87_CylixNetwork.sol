...
Telegram - https://t.me/CylixNetwork
...
contract CylixNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb95FCdA2b976aC365C14cC027BF98f7CD0499838;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Cylix Network";
    string constant _symbol = "CNet";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 11000000 * 10**0 * (10 ** _decimals);
    ...
    uint256 public marketingFeeBuy = 14;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xb95FCdA2b976aC365C14cC027BF98f7CD0499838;
