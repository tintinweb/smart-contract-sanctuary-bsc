...
contract GovernanceToken is IERC20, Ownable {
    ...
    string private _name = "Governance";
    ...
    address public _teamAddress = 0x9645D3bbFbcACe544Ce0b035cCf588CDE0De0E6d;
    ...
    constructor() {
        ...
        numTokensSellToAddToLiquidity = _totalSupply.mul(5).div(10**4); // 0.05%
    ...
    function setTaxFeePercent(uint256 taxFeeBps) external onlyOwner {
        _taxFee = taxFeeBps;
        require(
            _taxFee + _liquidityFee + _teamFee <= 10**4 / 4,
