...
contract IKIGAMITWOZERO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IKIGAMI 2.0";
    string private _symbol = "IKIGAMI";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x9649F9f3383A715B6248b50173dF1e35b5e4eB68); // Marketing Address
    address payable public teamWalletAddress = payable(0xBB2c480c283606f7cFd43b0F9F0175D4F843CbCb); // Team Address
