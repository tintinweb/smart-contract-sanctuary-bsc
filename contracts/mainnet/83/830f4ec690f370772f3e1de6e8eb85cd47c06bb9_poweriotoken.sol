...
contract poweriotoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbd07a831DC354AFD0E3655872860212054ec3238); //nice
    address payable public charityAddress = payable(0xbd07a831DC354AFD0E3655872860212054ec3238); //nice
    ...
    uint256 private _tTotal = 1300000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Powerio Token"; //CC
    string private _symbol = "POW";  //nice
    ...
    uint256 public _maxTxAmount = 19500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 19500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 13000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 19500;// 0.01*195 token for 0.01 bnb (set as per requirements)
