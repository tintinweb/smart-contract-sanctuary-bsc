...
contract BABYPIGT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYPIGT";
    string private _symbol = "BABYPIGT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa1D727754D2fA309890179bABb350EC574952879); 
    address payable private teamWalletAddress = payable(0x4b5a1fe6006D1EF38A50041eC4A9eb2Fd655FD77); 
    ...
    uint256 private _totalSupply = 1 * 10**18* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**18 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**18 * 10**6* 10**_decimals;
