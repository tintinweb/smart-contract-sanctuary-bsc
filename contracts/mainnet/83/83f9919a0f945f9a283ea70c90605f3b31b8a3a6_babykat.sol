...
contract babykat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babykat";
    string private _symbol = "kat";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97404cdF9F261fa4f272cfbD30ac40e98F13f699); 
