...
/* Token contract */
contract SaxonSquid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xea5871d448eCe3a1954cACD391391392d516730d;
    ...
    // Name and symbol
    string constant _name = "Saxon Squid";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 30000 / 10000;
    uint256 public _maxSellTxAmount = _totalSupply * 30000 / 10000;
    uint256 public _maxWalletToken = ( _totalSupply * 30000 ) / 10000;
