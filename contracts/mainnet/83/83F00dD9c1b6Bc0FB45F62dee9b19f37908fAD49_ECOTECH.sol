...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x4B68b67b09452DB696A0C6cD381Eaffd682964Fb ;
...
contract ECOTECH is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x008178F525A0DCE2E3486dC0c05D419C1D269e0e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 150000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ECO TECH";
    string private _symbol = "ECOT";
