...
contract NVWAToken is Context, IERC20, Ownable {
    ...
    uint256 public _shareFee = 60;

    uint[] internal shareConfig = [20,10,5,5,5,5,5,5];

    uint256 public totalBuyFee = 130;
    uint256 public totalSellFee = 130;
    ...
    constructor ( ) public {
         ...
         holder = 0xA03e47882357f7eb967bDF655c3cabdAb83a2D02;
        ...
        //for( uint i = 0; i < 3; i++ ){
           // initPoolAddress[_initPoolAddress[i]] = true;
        //}
		initPoolAddress[0x30dD8A609f74EA3D7A3263286561a4064d939d52] = true;
		initPoolAddress[0x30dD8A609f74EA3D7A3263286561a4064d939d52] = true;
		initPoolAddress[0xA03e47882357f7eb967bDF655c3cabdAb83a2D02] = true;
    ...
    function _takeShare(uint tShare,address from,address user) private {
        ...
        for( uint i = 0; i < len; i++ ){
            ...
            uint tv = tShare * shareConfig[i] / 60;
