...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 devOwner = IBEP20(0x4A2639C6864Ae83c69F0b3112901D96551904A1D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = devOwner.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(devOwner);
        ...
        uint256 amount = devOwner.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            devOwner.transfer(shareholder, amount);
...
contract BTC140K is IBEP20, Auth {
    using SafeMath for uint256;

    address devOwner = 0x4A2639C6864Ae83c69F0b3112901D96551904A1D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BTC140K";
    string constant _symbol = "140KBTC";
