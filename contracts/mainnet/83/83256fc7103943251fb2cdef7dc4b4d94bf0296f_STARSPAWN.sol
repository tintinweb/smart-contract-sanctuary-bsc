...
contract BaseToken is Ownable {
    ...
    string constant public name = 'STARSPAWN';

    string constant public symbol = 'STARSPAWN';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 6000000000*10**uint256(decimals);
...
contract STARSPAWN is BaseToken {
