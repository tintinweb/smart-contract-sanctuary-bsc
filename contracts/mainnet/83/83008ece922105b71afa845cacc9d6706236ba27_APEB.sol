...
/**
 welcome to :APE BILLIONAIRE
 Telegram : https://t.me/apebillionaire
...
contract APEB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ape Billionaire"; // 
    string private constant _symbol = "APEB"; //    
