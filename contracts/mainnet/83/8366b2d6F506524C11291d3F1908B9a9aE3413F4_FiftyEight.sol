...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCE290523B9E8CBf4EcCEd15EE45140c5e4F87856; // owner address
...
contract FiftyEight is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "58$";
    string private _symbol = "5$8";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCE290523B9E8CBf4EcCEd15EE45140c5e4F87856); // Marketing Address
    address payable public teamWalletAddress = payable(0xCE290523B9E8CBf4EcCEd15EE45140c5e4F87856); // Team Address
