...
/**
Telegram: https://t.me/OrdinalCheemsBsc
Twitter: https://twitter.com/ordinalcheems
*/
...
library Address{
 ...
 contract OrdinalCheems is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x829C57294f55Db0C1024713F5120515048735048;
    address public devWallet = 0x6ed8f0E79827FF15f834506cC842D91F1e8f1FBE;

    string private constant _name = "Ordinal Cheems";
    string private constant _symbol = "$oCHEE";
    ...
    Taxes public taxes = Taxes(2, 6, 1, 0);
    Taxes public sellTaxes = Taxes(2, 6, 1, 0);
