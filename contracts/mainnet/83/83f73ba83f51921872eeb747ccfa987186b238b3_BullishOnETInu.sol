...
/**
"Away from the Trick-or-Treaters, Elliot and E.T. got on Elliot's bike and headed into the woods.

When the ride got too bumpy, E.T. took over.

Together they rose off the ground and soared through the sky gathering ETH rewards!"
*/
...
/* Token contract */
contract BullishOnETInu is IBEP20, Auth {
    using SafeMath for uint256;
