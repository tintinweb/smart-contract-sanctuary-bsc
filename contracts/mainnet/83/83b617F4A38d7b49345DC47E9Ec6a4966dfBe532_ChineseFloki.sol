...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4D5CD0bC431F8108dA0bC980a5F81Bd07FcA2c5; // owner address
...
contract ChineseFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Chinese Floki";
    string private _symbol = "CFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4D5CD0bC431F8108dA0bC980a5F81Bd07FcA2c5); // Marketing Address
    address payable public teamWalletAddress = payable(0xD4D5CD0bC431F8108dA0bC980a5F81Bd07FcA2c5); // Team Address
