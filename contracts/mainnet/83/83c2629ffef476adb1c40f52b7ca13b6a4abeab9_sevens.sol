...
// Telegram : https://t.me/sevens_hallowen
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x402AA922970230b1551f18c5Ab623dBE77eB5E56; // owner address
...
contract sevens is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "7s Halloween";
    string private _symbol = "7sHallowen";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x402AA922970230b1551f18c5Ab623dBE77eB5E56); // Marketing Address
    address payable public teamWalletAddress = payable(0x402AA922970230b1551f18c5Ab623dBE77eB5E56); // Team Address
