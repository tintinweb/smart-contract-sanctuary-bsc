...
contract MinionsTHISISTHERISEOFGRU is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 6_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public MarketingWallet = 0x6A799E984ddeeED4ee23d1A359653FEE7CE42C9B;
    address public DevelopmentWallet = 0x6Ec4C471dBd24EB785101994fF2ae94DC36f5Dc5;
    address public BurnWallet = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Test Token";
    string private constant _symbol = "TTKN";
    ...
    Taxes public taxes = Taxes(20, 40, 10, 8, 0);
    Taxes public sellTaxes = Taxes(20, 40, 12, 12, 0);
    ...
    function setTaxes(uint256 _Reflections, uint256 _Marketing, uint256 _Liquidity, uint256 _Development, uint256 _Burn) public onlyOwner {
       taxes = Taxes(_Reflections,_Marketing,_Liquidity,_Development,_Burn);
        emit FeesChanged();
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tReflections = tAmount*temp.Reflections/10000;
        s.tMarketing = tAmount*temp.Marketing/10000;
        s.tLiquidity = tAmount*temp.Liquidity/10000;
        s.tDevelopment = tAmount*temp.Development/10000;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 10) {
            require(to != pair, "No sells allowed for the first 10 blocks");
        }
