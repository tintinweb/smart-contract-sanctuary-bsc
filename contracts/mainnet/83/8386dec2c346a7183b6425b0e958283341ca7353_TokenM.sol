...
contract TokenM is IERC20, Ownable {
	...
	string private constant _name =  "TokenM"; //MetaMerce Token";
	string private constant _symbol = "TokenM"; //MMTKN";
	...
	function setBaseFeesOnBuy(uint8 _liquidityFeeOnBuy, uint8 _marketingFeeOnBuy, uint8 _buyBackFeeOnBuy, uint8 _holdersFeeOnBuy) external onlyOwner {
		require(_launchStartTimestamp > 0 && (block.timestamp - _launchStartTimestamp) > 300, "MetaMerce: Cannot change taxes within the first 14days of launch");
