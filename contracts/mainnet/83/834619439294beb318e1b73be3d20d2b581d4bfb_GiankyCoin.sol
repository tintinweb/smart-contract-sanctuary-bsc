...
contract GiankyCoin is ERC20, Ownable {
    // -- Mappings --
    ...
    string constant _name = "Gianky Coin";
    string constant _symbol = "GKY";
    ...
    address public developmentReceiver = 0x1Fad82e1bA7ABFFebBBbf02ee5a7a35eF79b7BFa;
    address public marketingReceiver = 0x1Fad82e1bA7ABFFebBBbf02ee5a7a35eF79b7BFa;
    ...
    function _ownerBlacklistBot(address botAddress) external onlyOwner {
        require(!_blacklisted[botAddress]);
        _blacklisted[botAddress]=true;
        sniperList.push(address(botAddress));
    }
