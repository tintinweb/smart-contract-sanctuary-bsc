...
contract FairLaunchProtocol is IERC20 {
    ...
    string constant private _name = "Fair Launch Protocol";
    string constant private _symbol = "FLP";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xe0d10854bef02cEC1571457B482447e02329b8f4),
        team: payable(0xCcA8e2361F069ddee29388E2227d84F45F521AAA)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 buyback, uint16 burnFee) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.buyback = buyback;
        _ratios.burn = burnFee;
        _ratios.total = marketing + buyback + _ratios.team + _ratios.rewards;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + buybackBalance + teamBalance);
    ...
    function takeTaxes(address from, uint256 amount, bool buy, bool sell, bool other) internal returns (uint256) {
        Ratios memory ratios = _ratios;
        uint256 total = ratios.total + ratios.burn;
        uint256 currentFee;
        if (buy) {
    ...
    function _burn(address sender, uint256 amountTokens) internal {
