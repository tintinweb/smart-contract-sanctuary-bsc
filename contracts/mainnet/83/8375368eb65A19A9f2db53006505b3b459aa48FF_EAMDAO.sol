...
//
// EAMDAO PROTCOL COPYRIGHT (C) 2022 
...
contract EAMDAO is ERC20Detailed, Ownable {
    ...
    string public _name = "EAMDAO";
    string public _symbol = "EAM";
    ...
    constructor() ERC20Detailed("EAMDAO", "EAM", uint8(DECIMALS)) Ownable() {

        router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // tnet:0xD99D1c33F9fC3444f8101754aBC46c52416550D1 MNET:0x10ED43C718714eb63d5aA57B78B54704E256024E
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );
      
        autoLiquidityReceiver = 0xe125863b1aD35e463dAE5Fbb65D6953c90c35d37;
        treasuryReceiver = 0xbBa7Cf0C4d23cE010d328978d3FB7EDae66d1E21; 
        safuuInsuranceFundReceiver = 0x6B84809FE621f847b8384ABB086b607B9eA9F451;
        firePit = 0xE3A8464041F3635f1A9F9002De5A3F1a0E864E92;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no EAM token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
