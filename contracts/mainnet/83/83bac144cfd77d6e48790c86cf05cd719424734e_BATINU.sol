...
// Telegram : https://t.me/BabyTelegramInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x4Aa22532e3E8B051eae48e60C58426c8553D5df5); // TELEGRAMINU
...
contract BATINU is IBEP20, Auth {
    ...
    string constant _symbol = "$BATINU";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x4Aa22532e3E8B051eae48e60C58426c8553D5df5; // TELEGRAMINU
    ...
    constructor () Auth(msg.sender) {
		...
		marketingWallet = 0xB65ECd966a57E4A790AA1774BF392131953cCaba;
        anothermarketingWallet = 0x383ce0980f491573753B4635d4d4775b036d642c;
