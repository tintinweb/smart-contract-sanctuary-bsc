...
/**
50% supply airdrop to pepa inu top 100 holder
sent from pepa inu deployer
*/
...
contract PEPACEO is IBEP20, Auth {
    ...
    string constant _name = "PEPA CEO";
    string constant _symbol = "PEPACEO";
