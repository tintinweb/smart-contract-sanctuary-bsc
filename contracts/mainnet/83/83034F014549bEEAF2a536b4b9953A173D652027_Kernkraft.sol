...
/*
KERNKRAFT translates into Nuclera Power

The goal is to have our own energy drink branded and we will use this to promote our project in the mainstream media.

With every purchase of KERNKRAFT you automatically recieve 2% reflections from our native token.

Simultaneously our burn mechanism automatically sends 2% of every transaction to a dead wallet as nuclear waste. Thereby shrinking the already low supply and increasing price.
...
https://www.kernkraft.site/
https://t.me/KERNKRAFT_PORTAL
*/
...
contract Kernkraft is IBEP20, Auth {
    ...
    string constant private _name = "KernKraft";
    string constant private _symbol = "KRAFT";
    ...
    address public marketingFeeReceiver = 0x9ADBD9AAb881d97D17b9472F11d7146b16170B97;
    address public devFeeReceiver = 0xf5D40182B6D5bA7E33ba73303A5e2ca32Bfa875C;
