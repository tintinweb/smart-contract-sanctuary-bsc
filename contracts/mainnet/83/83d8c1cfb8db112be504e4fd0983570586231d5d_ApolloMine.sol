...
contract ApolloMine {
    ...
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    uint256 BONUS_20_BUSD = 20000000000000000000; // bonus
    uint256 private mDep = 100000000000000000000;  // min dep
...
struct User {
    ...
    function getFreeMiners_20BUSD() public {    
        require (initialized); 
        require (OneGetFree[msg.sender] == false);
        lastHatch[msg.sender] = now; 
        usersMiner[msg.sender] = SafeMath.add(SafeMath.div(calculateTokensBuySimple(BONUS_20_BUSD),SECONDS_WORK_MINER),usersMiner[msg.sender]);
    ...
    function devFee2(uint256 amount) public pure returns (uint256) { //team and partners
