...
Telegram : https://t.me/Squidgolden

Join new trend on BSC network, squid not only black, red etc, but there is SQUID GOLDEN, support us to be moonshot and defeat other squid.
...
contract SquidGoldenToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xec4477d8e0Fc9B88938163da7cdb92ef34EF256f); 
    address payable public Wallet_Dev = payable(0xec4477d8e0Fc9B88938163da7cdb92ef34EF256f);
    ...
    string private constant _name = "Squid Golden"; 
    string private constant _symbol = unicode"$SQUIDG"; 
    ...
    constructor () {
        ...
        _owner = 0xec4477d8e0Fc9B88938163da7cdb92ef34EF256f;
