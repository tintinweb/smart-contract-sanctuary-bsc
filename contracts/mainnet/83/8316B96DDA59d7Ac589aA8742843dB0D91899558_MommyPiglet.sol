...
contract MommyPiglet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mommy Piglet";
    string private _symbol = "MOMMY";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xB61D0a56055E719Aa8F946078bbBbadDde9761C9);
