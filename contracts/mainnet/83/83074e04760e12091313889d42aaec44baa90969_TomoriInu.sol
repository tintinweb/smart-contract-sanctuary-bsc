...
contract TomoriInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tomori Inu"; // 
    string private constant _symbol = "$RINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3227AeEbaE352a55806CC9c9930ef3e5a7B7C803;
