...
contract SmartVault {
    ...
    function initialize(IERC20 _usdtToken, IERC20 _xstmd) external {
        require(address(usdtToken) == address(0), "has been initialized");
        usdtToken = _usdtToken;
        xstmd = _xstmd;

        usdtToken.approve(address(xstmd), uint256(-1));
    }
...
contract XSTMD is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    uint256 public minSwapAndLiquifyLimit = 1;
    uint256 public minSwapLimit = 1;
...
contract ts is XSTMD{
    constructor() XSTMD(
        "test123",
        "test123",
        2,
        0x18b2338e678d9fD75E071754eD7E5dDC4125D74E,//营销1
        0xAAAc6193e3Bf8BF90381842735D87b82988ADafE,//营销2
        0xC8960Dfc24e64f5DA66eB09e718326e1b15e9400,//LP接收者
        0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c,//组成交易对的代币合约
        IFactory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73),//工厂
        IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E)//路由
    ){
    }
}