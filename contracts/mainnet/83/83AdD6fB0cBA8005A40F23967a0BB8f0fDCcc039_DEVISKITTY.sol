...
//telegram: https://t.me/DEVISKITTY 
interface IERC20 {
...
contract DEVISKITTY is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 3_500_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3_500_000 * 10**_decimals;

    address public marketingAddress = 0x7f1160da47598786C50101187A92EC3c23444b4e;
    address public devAddress = 0x7f1160da47598786C50101187A92EC3c23444b4e;

    string private constant _name = "DEV IS KITTY";
    string private constant _symbol = "$KITTYDEV";
