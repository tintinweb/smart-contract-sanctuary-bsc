...
contract BattlefieldOfRenegades is ERC20, ERC1363, ERC2612, ERC20Burnable, ERC20TokenRecover, IBattlefieldOfRenegades {
    ...
    address public override gameVaultWallet;
    address public override safetyVaultWallet;
    ...
    constructor(
        ...
        address _rba,
        address _gameVaultWallet,
        address _safetyVaultWallet,
        address _liquidityWallet
    ) ERC2612("BattlefieldOfRenegades", "BOR") {
        IDEXRouter _dexRouter = IDEXRouter(_routerAddress);
        RBA = _rba;
        gameVaultWallet = _gameVaultWallet;
        liquidityWallet = _liquidityWallet;
        safetyVaultWallet = _safetyVaultWallet;
    ...
    function initializeDividendTracker(IBattlefieldOfRenegadesDividendTracker _dividendTracker) external override onlyOwner {
        ...
        setWhitelistAddress(gameVaultWallet, true);
    }
    ...
    function updateGameVaultWallet(address newGameVaultWallet) external override onlyOwner {
        require(newGameVaultWallet != gameVaultWallet, "BattlefieldOfRenegades: The gameVault wallet is already this address");
        setWhitelistAddress(newGameVaultWallet, true);
        emit gameVaultWalletUpdated(newGameVaultWallet, gameVaultWallet);
        gameVaultWallet = newGameVaultWallet;
    }

    function updateSafetyVaultWallet(address newSafetyVaultWallet) external override onlyOwner {
        require(newSafetyVaultWallet != safetyVaultWallet, "BattlefieldOfRenegades: The safetyVault wallet is already this address");
        setWhitelistAddress(newSafetyVaultWallet, true);
        emit safetyVaultWalletUpdated(newSafetyVaultWallet, safetyVaultWallet);
        safetyVaultWallet = newSafetyVaultWallet;
    }
    ...
    function swapAndSendToFeeGameVault(uint256 tokens) private {
        ...
        payable(gameVaultWallet).transfer(newBNBBalance);
    }
    ...
    function swapAndSendToFeeSafetyVault(uint256 tokens) private {
        ...
        swapTokensForEth(tokens);
        uint256 newBNBBalance = address(this).balance - initialBNBBalance;
        payable(safetyVaultWallet).transfer(newBNBBalance);
    }
...
interface IBattlefieldOfRenegades is IBEP20, IERC1363, IERC2612, IERC20Burnable, IERC20TokenRecover {
    ...
    function gameVaultWallet() external view returns (address);

    function safetyVaultWallet() external view returns (address);
    ...
    event safetyVaultWalletUpdated(address indexed newSafetyVaultWallet, address indexed safetyVaultWallet);

    event gameVaultWalletUpdated(address indexed newGameVaultWallet, address indexed gameVaultWallet);
    ...
    function updateGameVaultWallet(address newGameVaultWallet) external;

    function updateSafetyVaultWallet(address newGameVaultWallet) external;
