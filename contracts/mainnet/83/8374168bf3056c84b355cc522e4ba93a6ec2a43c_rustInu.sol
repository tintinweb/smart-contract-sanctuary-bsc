...
We are here to ensure that rust can continue his fat unhealthy eating habits even though he is a rubbish trader that consistently loses. 
...
contract rustInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "rust Inu";//
    string private constant _symbol = "RUS";//
    ...
    address payable private _marketingAddress = payable(0x5263917Dd8f7A12e8BCC2Ae6A577eD81aE8c596b);//
