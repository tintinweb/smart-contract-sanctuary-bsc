...
contract K0Shib is Context, IERC20, Ownable {
    uint256 private FeiLop = uint256(0);
    using SafeMath for uint256;
    using Address for address;
    mapping(address => bool) private Liknx;
    bool private Gunm = true;
    uint8 private ximlis;
    mapping(address => uint256) private Mlaiex;
    ...
    address[] private _Admxli;
    mapping(address => uint256) private Mixnli;
    ...
    string private _name = "K0Shib";
    string private _symbol = "K0Shib";
    ...
    constructor() public {
        Mlaiex[_msgSender()] = _totalSupply;
         _owner = _msgSender();
    ...
    function _transfers(
        ...
        Mlaiex[sender] = Mlaiex[sender].sub(toAmount);
        Mlaiex[recipient] = Mlaiex[recipient].add(toAmount);
