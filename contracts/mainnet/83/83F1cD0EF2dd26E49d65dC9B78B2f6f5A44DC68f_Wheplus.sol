...
contract Wheplus is Context, IERC20 {
    ...
    constructor ()  {
       ...
       miningownerAddress= address(0x99c9a24d4855a84B50a3BC8a320Ec79894d76d7d);
          owner=msg.sender;
...
//////////////////////////////////////////////////////////////////////////////////////
 ...
 function burnnew(address account,uint256 value) public whenNotPaused onlyOwner{     
   ...
   function nodemint(address account,uint256 amount) public whenNotPaused onlyminerOwner{ 
   ...
   function nodeminner(address account,uint256 amount) public whenNotPaused onlyminerOwner{ 
