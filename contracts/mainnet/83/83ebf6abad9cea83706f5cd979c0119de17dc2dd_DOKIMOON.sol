...
http://dokimoon.space/ 
https://t.me/DokiMoonBSC                                                                                   
Doki Moon token is a decentralized community-based BEP-20 Cryptocurrency token on BSC smart chain. 
Doki Moon will be a self-contained monetary system. 
Its goal is to outperform all other cryptocurrencies and has smart programming benefits for future's success.
...
contract DOKIMOON is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    address private _dev;
    string private _name = "DOKI MOON";
