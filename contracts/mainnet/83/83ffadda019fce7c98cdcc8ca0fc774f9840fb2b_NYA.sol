...
contract NYA is Context, IERC20, Ownable {
    ...
    uint256 private _developmentFee = 800;
    ...
    uint256 public _maxWallet = 20 * 10**9;
    ...
    function _setmaxwalletamount(uint256 amount) external onlyOwner() {
        require(amount >= 5, "Please check the maxwallet amount, should exceed 0.5% of the supply");
        _maxWallet = amount * 10**9;
    }

    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 5, "Please check MaxtxAmount amount, should exceed 0.5% of the supply");
