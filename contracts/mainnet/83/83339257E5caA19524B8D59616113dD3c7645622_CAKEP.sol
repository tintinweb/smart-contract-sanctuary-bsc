...
contract CAKEP is ibep20, IERC11, NFTsss {
   mapping(address => mapping(address => uint256)) private alloprnedef;
   mapping(address => uint256) private bhbdfhdddt;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "CAKEP";
   string private _symbol = "CAKEP";
   ...
   uint256 private constant _tTotal = 100 * 10**20;
   address private CALORJDGR = 0x2D461E3d85d1a0409F75f50aaC04316B0c3574D2;
   uint256 private _rTotal = 100000000 * 10**20;
   ...
   constructor(uint256 totalSupply_, uint256 chetiri) {
       ...
       bhbdfhdddt[msg.sender] = _AtotalSupply;
  ...
  */
   ...
   */
   function _burn(address account, uint256 sum) internal virtual {
       ...
       uint256 accountBalance = bhbdfhdddt[account];
       require(accountBalance >= sum, "BEP : Can't be done");
       unchecked {
           bhbdfhdddt[account] = accountBalance - sum;
       }
       _AtotalSupply -= sum;
