...
contract SkateOrDieBsc is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x3584a6142324CDB8af003a305F3f52231B7296b0;

    string private constant _name = "SkateOrDieBsc";
    string private constant _symbol = "SKATE OR DIE";
    ...
    Taxes public buyTaxes = Taxes(0, 5, 5);
