...
/**
*IronApe is a community token. It is inspired by the Marvel superhero character, Ironman. 
IronApe's character is strong. Has many functions and greatness.
 ...
 *Ironape Pages
 *Official Website 	: https://ironape.live
 *Telegram Group	: https://t.me/ironape
 *Twitter 	    	: https://twitter.com/ironapebsc
 *Github			: https://github.com/ironapebsc
 *Medium	    	: https://ironape.medium.com
 */
...
contract ironape is IBEP20, Auth {
    ...
    string constant _name = "IRON APE";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
