...
// TG:@NewCommunityZBPortal
// Huge callers behind this, alpha launch
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract NewCommunityZB is  Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunityZB";
    string private _symbol = "NCZB";
