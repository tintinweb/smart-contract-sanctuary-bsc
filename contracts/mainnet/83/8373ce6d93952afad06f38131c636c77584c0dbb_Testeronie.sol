...
contract Testeronie is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Testeronie";
    string private _symbol = "TesterO2";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xA29608e1e5e511d5307dFA1A35f8146B54fA0c1d);
    address payable public teamWalletAddress = payable(0x967Ba040cf9F7bdcE3fBB869A5f0Da51ff90ad2C);
    ...
    uint256 private minimumTokensBeforeSwap = 100000000000000 * 10**_decimals; 
