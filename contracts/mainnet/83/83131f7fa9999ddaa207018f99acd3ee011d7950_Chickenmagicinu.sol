...
contract Chickenmagicinu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3cD659b49B212734860CADA7FD6dC2EB9efAFee1); 
    address payable public Wallet_Dev = payable(0x2856b4dAce13208ce57Cb4229Ee4B458C9edbecF);
    ...
    string private constant _name = "CHICKEN MAGIC INU"; 
    string private constant _symbol = unicode"$CHIC"; 
    ...
    constructor () {
        ...
        _owner = 0x2856b4dAce13208ce57Cb4229Ee4B458C9edbecF;
