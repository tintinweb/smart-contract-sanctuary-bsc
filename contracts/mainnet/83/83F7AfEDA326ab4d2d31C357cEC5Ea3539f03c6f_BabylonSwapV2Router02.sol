...
import './libraries/BabylonSwapV2Library.sol';
import './libraries/SafeMath.sol';
import './libraries/TransferHelper.sol';
import './interfaces/IBabylonSwapV2Router02.sol';
...
import '../interfaces/IBabylonSwapV2Pair.sol';
...
library BabylonSwapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'29449c6e6f9ed230b56a32f1ce334733861e77f3d2fc635bb193299e2a19fd3b' // init code hash
...
import './IBabylonSwapV2Router01.sol';
