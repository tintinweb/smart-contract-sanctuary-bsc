...
Shina
@ShinaToken
Hi! My name is Shina and I have a crush on Shiba! No tax, Shib clone, burned liquidity pool, 
29% supply burned and incredible community! 💕 Join the movement!
ApeCoin
@apecoin
...
contract SHIAPE is Context, SHIAPEBNB, Ownable {
    ...
    string private _name = 'SHI APE';
    string private _symbol = 'SHIAPE';
