...
/*
ShibaShow is a meme token following SHIBA 

https://t.me/ShibaShow
Initial Burn: 50%
Ownership: Renounced
...
contract Ownable is Context {
 ...
 contract  ShibaShow is Context, BEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10000000000000 * 10**6 * 10**10;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'ShibaShow';
    string private _symbol = 'ShibaShow';
