...
contract BlackSheep is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BlackSheep';
    string private constant _symbol = 'SHEEPLE';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply= 1 * 1000000000000000 * 10**_decimals;
...
///////////////////////////////YeaaaahBrooooooo//////////addd
    ...
    function SetTaxes(uint buy, uint sell, uint transfer_, uint burn, uint marketing,uint liquidity) public onlyTeam{
        uint maxTax=2*(TAX_DENOMINATOR/MAXTAXDENOMINATOR);
