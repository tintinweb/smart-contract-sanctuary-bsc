...
contract FrogT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FrogT";
    string private _symbol = "FrogT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB3acB4b532a2fC81F4bc63c4ab230E43f8eF7b67);
    address payable public teamWalletAddress = payable(0x9bEDC25CF30b4fC11D9A9AdE258E66E34d2eBdcD);
