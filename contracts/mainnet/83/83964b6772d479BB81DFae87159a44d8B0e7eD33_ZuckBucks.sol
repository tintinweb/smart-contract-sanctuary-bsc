...
contract ZuckBucks is ZuckBucksDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ZuckBucksTeam;
    address private CharityZuckBucks;
    ...
    string public override name = "Zuck Bucks";
    string public override symbol = "ZBUCKS";
    ...
    constructor(uint totalSupplyValue, address ZuckBucksTeamAddress, address CharityZuckBucksAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ZuckBucksTeam = ZuckBucksTeamAddress;
        CharityZuckBucks = CharityZuckBucksAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ZuckBucksTeam] =  totalSupply * 45 / 100;
        balances[CharityZuckBucks] = totalSupply * 45 / 100;
