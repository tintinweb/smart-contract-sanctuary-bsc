...
/** ------ EPICALLS TEAM ----- HEIN NEKO GROW
 *Submitted for verification at BscScan.com on 2022-08-05
*//*https://t.me/HeinNekoGrow
...
contract HEINNEKOGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "HEIN NEKO GROW";
    string private constant _symbol = "$HEINNEKOGROW";
    ...
    address private marketingWallet = address(0xAE9fB1C81Fd3f4C90599aA5fd6Ca532322FADc2B);
    address private liquidityReceiver = address(0xAE9fB1C81Fd3f4C90599aA5fd6Ca532322FADc2B);
