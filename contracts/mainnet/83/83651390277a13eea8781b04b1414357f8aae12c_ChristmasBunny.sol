...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd0D23B062fCbe6589ccCCf9A8ae513c44694E2B6; // owner address
...
contract ChristmasBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Bunny";
    string private _symbol = "CBUNNY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd0D23B062fCbe6589ccCCf9A8ae513c44694E2B6); // Marketing Address
    address payable public teamWalletAddress = payable(0xd0D23B062fCbe6589ccCCf9A8ae513c44694E2B6); // Team Address
