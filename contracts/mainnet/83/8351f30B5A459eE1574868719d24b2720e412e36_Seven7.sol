...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF3b0DdB63D49C1784b3e2E049F6aB8b85CAd9a62; // owner address
...
contract Seven7 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF3b0DdB63D49C1784b3e2E049F6aB8b85CAd9a62); // Marketing Address
    address payable public teamWalletAddress = payable(0xF3b0DdB63D49C1784b3e2E049F6aB8b85CAd9a62); // Team Address
    ...
    uint256 private _totalSupply = 77000000000 * 10**_decimals;
