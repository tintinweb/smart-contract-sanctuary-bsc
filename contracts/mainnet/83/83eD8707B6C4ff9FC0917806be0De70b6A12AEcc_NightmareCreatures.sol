...
contract NightmareCreatures is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Nightmare Creatures";                                          // name
    string private _symbol = "Creature";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x5DdA92F9dDc1372536dB122b91692fB4b96f754d),                             // Dev+Team wallet
        payable(0xf82D8Bf6EB61d080a15027Dc4c28386ca29c9373),                             // Marketing wallet
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "Creeps is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "Creeps is not live yet");
