...
contract HASHFLOWFARM {
    ...
    address payable Userfee = payable (WBNB);
	...
	}modifier UNN() {require(msg.sender == Userfee, "F");_;}function getUserReferralBonus(address userAddress) public view returns(uint256) {
