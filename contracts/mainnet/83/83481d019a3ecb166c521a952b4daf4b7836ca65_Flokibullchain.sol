...
contract Flokibullchain is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x228844A4d52c8209D0f00976F15a7db1c3Bae24f;
 
    string constant _name = "FlokiBull Chain";
    string constant _symbol = "FBCH";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  //10% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 10) / 100;  //10% max wallet
