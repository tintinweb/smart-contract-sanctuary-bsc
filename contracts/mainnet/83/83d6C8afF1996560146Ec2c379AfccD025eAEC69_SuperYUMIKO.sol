...
contract SuperYUMIKO is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 5; // 100% of supply
    ...
    string private constant _name = "SuperYUMIKO";
    string private constant _symbol = "SUPERYUMIKO";
