...
contract hulahula is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "hulahula";
    string private _symbol = "HULA";
    ...
    function changelimit(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function totalsupply(uint256 _amount) private view returns (uint256) {
    ...
    function dividetoken(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
