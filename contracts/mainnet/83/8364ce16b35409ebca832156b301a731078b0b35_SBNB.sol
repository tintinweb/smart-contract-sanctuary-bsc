...
/*
Telegram: https://t.me/SafuuBNB
Website: https://www.safuubnb.com/
Twitter: https://twitter.com/SafuuBNB_bsc
...
contract SBNB is IERC20 {
    ...
    uint256 constant private startingSupply = 325_000;

    string constant private _name = "SafuuBNB";
    string constant private _symbol = "SBNB";
    ...
    // WBNB MAINNET TOKEN CONTRACT ADDRESS
    ...
    struct TaxWallets {
        ...
        address payable rewardback;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x665A6Dc9aD5494C2cb9Df999fCceCAA1993568FE),
        rewardback: payable(0x20F9A51524482efB04AECA478Ce76c61a196316B)
        });
    ...
    constructor () payable {
        ...
        _isExcludedFromFees[_taxWallets.rewardback] = true;
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 rewardback) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.rewardback = rewardback;
        _ratios.total = rewards + liquidity + marketing + rewardback;
    }

    function setWallets(address payable marketing, address payable rewardback) external onlyOwner {
        _taxWallets.rewardback = payable(rewardback);
    ...
    function contractSwap(uint256 contractTokenBalance) internal swapping {
        ...
        uint256 rewardbackBalance = (amtBalance * ratios.rewardback) / ratios.total;
        uint256 marketingBalance = amtBalance - (rewardsBalance + rewardbackBalance);

        try reflector.load{value: rewardsBalance}() {} catch {}

        if(ratios.rewardback > 0){
            _taxWallets.rewardback.transfer(rewardbackBalance);
        }
