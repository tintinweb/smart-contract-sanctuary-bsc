...
contract Presale is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0xAc47727c9b6e978e95909dc55eFb70C06AB0f8e1);
...
contract PresaleGenerator is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0xdAc5fE9B51cD59B27742aE1427E47bEF44103084);
        PRESALE_SETTINGS = IPresaleSettings(0xda46a08F8EB2b595fB6Bc34667f33d7B1460A98c);
    }
