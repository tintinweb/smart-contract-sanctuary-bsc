...
contract BooBSC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BooBSC";
    ...
    address payable public DevWallet = payable(0x0fbD886C9d2522050b5b59307429A8Ab909F3080);
    address payable public MarketingWallet = payable(0x137d07833f6Ff4c6DF97B14cb18f1F6d8E91Eb96);
