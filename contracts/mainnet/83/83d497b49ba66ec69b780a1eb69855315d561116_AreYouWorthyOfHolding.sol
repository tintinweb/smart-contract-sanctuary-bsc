...
contract AreYouWorthyOfHolding is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF0C6B6FfB142aBf1564870E02330603488257669;
    address public devWallet = 0x3d157DE07D65228495a983222dAF13771E3B362D;
    address public Mjolnir = 0x61390E78FDe8401806a9F56d5E00fCE81F7D9Cb7;

    string private constant _name = "AreYouWorthyOfHolding";
    ...
    Taxes public sellTaxes = Taxes(0, 7, 3, 0, 5);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Mjolnir] = true;
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev, uint256 _Mjolnir) public onlyOwner {
       taxes = Taxes(_rfi,_marketing,_liquidity,_dev,_Mjolnir);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev, uint256 _Mjolnir) public onlyOwner {
       sellTaxes = Taxes(_rfi,_marketing,_liquidity,_dev,_Mjolnir);
        emit FeesChanged();
    }
    ...
    function _takeMjolnir(uint256 rMjolnir, uint256 tMjolnir) private {
        totFeesPaid.Mjolnir +=tMjolnir;

        if(_isExcluded[address(this)])
        {
            _tOwned[address(this)]+=tMjolnir;
        }
        _rOwned[address(this)] +=rMjolnir;
    }
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rDev, to_return.rMjolnir) = _getRValues2(to_return, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tMjolnir = tAmount*temp.Mjolnir/100;
        s.tTransferAmount = tAmount-s.tRfi-s.tMarketing-s.tLiquidity-s.tDev-s.tMjolnir;
        return s;
    }
    ...
    function _getRValues1(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi,uint256 rMarketing, uint256 rLiquidity){
        ...
        uint256 rMjolnir = s.tMjolnir*currentRate;
        rTransferAmount =  rAmount-rRfi-rMarketing-rLiquidity-rDev-rMjolnir;
        return (rAmount, rTransferAmount, rRfi,rMarketing,rLiquidity);
    }
    
    function _getRValues2(valuesFromGetValues memory s, bool takeFee, uint256 currentRate) private pure returns (uint256 rDev,uint256 rMjolnir) {
        ...
        rMjolnir = s.tMjolnir*currentRate;
        return (rDev,rMjolnir);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(sender, address(this), s.tLiquidity + s.tMarketing + s.tDev+ s.tMjolnir);
        }
        if(s.rMarketing > 0 || s.tMarketing > 0) _takeMarketing(s.rMarketing, s.tMarketing);
        if(s.rMjolnir > 0 || s.tMjolnir > 0) _takeMjolnir(s.rMjolnir, s.tMjolnir);
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.dev + temp.Mjolnir) * 2;
        ...
        uint256 buybackAmt = unitBalance * 2 * temp.Mjolnir;
        if(buybackAmt > 0){
            payable(Mjolnir).sendValue(buybackAmt);
        }
    ...
    function updateMjolnir(address newWallet) external onlyOwner{
        Mjolnir = newWallet;
    }
