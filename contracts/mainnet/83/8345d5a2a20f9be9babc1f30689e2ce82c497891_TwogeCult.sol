...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD31494703EF5efC2146007E0CFb6FBeC58FFa49e; // owner address
...
contract TwogeCult is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Twoge Cult ";
    string private _symbol = "TWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD31494703EF5efC2146007E0CFb6FBeC58FFa49e); // Marketing Address
    address payable public teamWalletAddress = payable(0xD31494703EF5efC2146007E0CFb6FBeC58FFa49e); // Team Address
