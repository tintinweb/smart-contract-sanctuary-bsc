...
/**
🚀 Welcome to CandyKittencoin 🚀

$CandyKittencoinn  is a community driven crypto currency, with real world use. we seek to maximize the benefits for coin holders 

✅Super early MC
🅿️ 100% Community Project
🏢 Ownership Renounce (optional)
💼 Liquidity Locked
🚀Reflections
❤️ Experienced Dev
...
contract CandyKittencoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CandyKittencoin"; 
    string private _symbol = "CKC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB5A0312B438b9d8373b5088f022206fFBac3BB6D);
    address payable public teamWalletAddress = payable(0xB5A0312B438b9d8373b5088f022206fFBac3BB6D);
