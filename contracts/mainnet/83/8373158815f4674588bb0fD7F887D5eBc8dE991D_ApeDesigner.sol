...
contract ApeDesigner is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdB8E916A24bF5aDf7087FB4193224e66F8ff46F3); 
    address payable public Wallet_Dev = payable(0xdB8E916A24bF5aDf7087FB4193224e66F8ff46F3);
    ...
    string private constant _name = "Ape Designer"; 
    string private constant _symbol = unicode"ADESIGN"; 
    ...
    uint256 public Tax_on_adesignliq = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Tax_on_adesignbrn = 0;             
    ...
    constructor () {
        ...
        _owner = 0xdB8E916A24bF5aDf7087FB4193224e66F8ff46F3;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Tax_on_adesignbrn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Tax_on_adesignliq / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Tax_on_adesignliq + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Tax_on_adesignliq + Percent_Marketing + Percent_Dev);
