...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "wusheng";
    string private _symbol = "wusheng";
    ...
    uint256 private _totalSupply = 1680 * 10**_decimals;
    uint256 public _maxTxAmount = 16800 * 10**_decimals; 
    uint256 public _walletMax = 16800* 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x57b9275226C17249d9D1bD0572Af4253c77b567E));
        __wal = payable(address(0x3F0F1D628d31b81ab7841567d3Cd9e7e95d072c9));
    ...
    function setlsExcIudeFromFee(address[] calldata account, bool newValue) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++) {
            isExcludedFromFee[account[i]] = newValue;
        }
    }
