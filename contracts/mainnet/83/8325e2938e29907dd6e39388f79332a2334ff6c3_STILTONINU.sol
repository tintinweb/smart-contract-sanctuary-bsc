...
contract STILTONINU is Context, IERC20, Ownable {
    ...
    string private _name = "STILTON INU";
    string private _symbol = "STILTON INU";
    ...
    address public burnAddress = 0x46A30d270dDB561F21fDAC8552B5dc3F2CbcD04d;
    address payable private _marketingWallet = payable(0x33a15FecAe8E4ab891Fa55Ff89BFFF135530Db89);
    address payable private _devWallet = payable(0x46A30d270dDB561F21fDAC8552B5dc3F2CbcD04d);
    ...
    uint256 public percentToSell = 250;
