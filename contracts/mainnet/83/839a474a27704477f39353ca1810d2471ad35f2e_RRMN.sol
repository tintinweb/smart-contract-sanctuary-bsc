...
contract RRMN is Context, IERC20, Ownable {
    ...
    string private constant _name = "RICH RICH Moon"; //
    string private constant _symbol = "RRMN"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x7b2DEA8f74825078fAd17BE92c1aE99e15198a98;
    ...
    function setFBRRMN(address addr,bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }
