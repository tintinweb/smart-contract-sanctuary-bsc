...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "$4M";
    string private _symbol = "$4M";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBbaE4C5742aa729C944CE27d1Dfc3Ea9D555a021); 
    address payable public BurnedWalletAddress = payable(0xBbaE4C5742aa729C944CE27d1Dfc3Ea9D555a021); 
