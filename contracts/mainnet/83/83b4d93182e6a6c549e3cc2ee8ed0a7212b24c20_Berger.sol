...
🏆 https://bergerdoge.com/
 
 🛡️🔗✅KYC✅🌐 
https://github.com/bergerdoge/
 🔗🌐🛡️

Official Fan Token of  🚀  BergerDoge

BergerDoge Coin ($BergerDoge) is a decentralized, community-focused cryptocurrency with daily 
super value rewards. You can increase your profits by simply holding $BergerDoge,
 4% of each transaction divided among loyal holders. In addition, who buy $BergerDoge 
 there will be a chance to receive extremely large rewards, the rewards will be distributed 
 every 2 days (1% each transaction for rewards pool). We are a developer with a big vision, 
 and BergerDoge Coin is a long-term project. Be a smart investor!!!
...
contract Berger is BergerDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BergerTeam;
    address private CharityBerger;
    ...
    string public override name = "Berger Doge";
    string public override symbol = "Berger Doge";
    ...
    constructor(uint totalSupplyValue, address BergerTeamAddress, address CharityBergerAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BergerTeam = BergerTeamAddress;
        CharityBerger = CharityBergerAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BergerTeam] =  totalSupply * 2 / 100;
        balances[CharityBerger] = totalSupply * 2 / 100;
    ...
    // Get the address of the token's BergerTeam pot
