...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf479c02e9C95Ee735fC323a1257E05E9Ed7cE6A9;
...
contract KINGBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Bnb"; // 
    string private constant _symbol = "$KINGBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xf479c02e9C95Ee735fC323a1257E05E9Ed7cE6A9);
