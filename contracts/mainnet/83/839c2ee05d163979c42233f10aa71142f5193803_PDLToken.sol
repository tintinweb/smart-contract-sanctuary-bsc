...
contract ERC20 is Context, IERC20 {
    ...
    address  private  _fundAddress = 0xDFE3Fa35d2CD1D3362AC47398bAafE84592832a0;
    ...
    function bindInviter(address current, address inviter) public {
    ...
    function setLpPoolAddress(address lp) public {
        require(msg.sender == _owner, "ERC20: setLpPoolAddress to the owner");
        _lpPoolAddress = lp;
    }
