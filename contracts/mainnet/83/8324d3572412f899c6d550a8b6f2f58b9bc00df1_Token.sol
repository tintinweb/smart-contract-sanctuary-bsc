...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "TIFIDAO";
    string private _symbol = "TIFIDAO";
    ...
    address public burnAddress = address(0x7Ac5c44B27859aFDdb56E8eb394d1522E4f70598);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount, rFee, tTransferAmount, data.tFee, data.tBurn);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, TData memory) {
        ...
        return (tTransferAmount, TData(0,tFee, tBurn));
    }
