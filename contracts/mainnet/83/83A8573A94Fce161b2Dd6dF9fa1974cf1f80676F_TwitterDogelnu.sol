...
/**
Telegram : https://t.me/TwitterDogelnu
*/
...
contract TwitterDogelnu is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Twitter Doge lnu";
    string constant _symbol = "TWD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 39) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 39) / 100; 
