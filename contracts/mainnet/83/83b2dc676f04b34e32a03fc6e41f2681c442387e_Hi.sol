...
contract Hi is IERC20 {
    ...
    string constant private _name = "Hi";
    string constant private _symbol = "Hi";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x80bE9ad4aeBf88e973115BbeAF0c02a0B2ED41af)
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 treasury) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.treasury = treasury;
        _ratios.totalSwap = liquidity + marketing + treasury;
