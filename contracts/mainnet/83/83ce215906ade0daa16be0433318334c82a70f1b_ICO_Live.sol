...
contract ICO_Live is Ownable {
    ...
    */
    ...
    function buy() external payable returns (bool) {
        require ((startTime < block.timestamp) && (block.timestamp >= startTime),'ICO is not started yet');
        ...
        uint amount = (msg.value * dexListingRate)/baseRate;
