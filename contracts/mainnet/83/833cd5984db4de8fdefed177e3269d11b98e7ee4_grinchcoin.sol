...
contract grinchcoin is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x17f9E4c8BEd6Bc0009DA6825e793b346Da4700d0;
    address public devAddress = 0x619B2c309808f07C0a06543f8e76D8866234F0eA;
    address public liquidityAddress = 0x152926BdE170E4f8A43F3b4b7A98c6a692240DD1;
//uint
    ...
    uint public maxWallet; // 2% tot supply (constructor)
...
// constructor
    constructor() ERC20("GrinchCoin", "GCC") {
        ...
        maxWallet = total_supply / 50; // 2% supply
        //spawn pair
