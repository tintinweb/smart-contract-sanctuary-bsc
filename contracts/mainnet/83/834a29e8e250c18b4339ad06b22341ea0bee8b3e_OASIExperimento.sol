...
contract OASIExperimento is Ownable, IERC20Metadata {

    using SafeMath for uint256;
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public constant MAX_UINT256 = type(uint256).max;
    uint256 private constant MAX_SUPPLY = 27 * 1e19 * 1e18;
    ...
    string private _name = "OASI Experimento";
    string private _symbol = "OASI";
    ...
    uint256 private maxHoldAddrExcludeFee = 5000000;
