...
contract PriceInBUSD{
    ...
    function getWalletBalanceInBUSD(address wallet) public view returns(uint[] memory, uint[] memory, uint, uint){
    ...
    function getExampleBalanceInBUSD(uint256[] memory _walletamount, uint256 _busd_amount) public view returns(uint[] memory,uint){
