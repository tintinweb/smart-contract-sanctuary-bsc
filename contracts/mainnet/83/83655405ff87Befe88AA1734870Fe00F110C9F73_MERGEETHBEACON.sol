...
library Address{
 ...
 contract MERGEETHBEACON is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xCadAE2a679e12CE223924B91ABB78A43E179E716;
    address public teamWallet = 0x50E0298c6ed3A84a1E9Fb3Fd6B5FB2C05AB071d7; 

    string private constant _name = "MERGE ETH BEACON";
    string private constant _symbol = "MEB";
    ...
    Taxes public sellTaxes = Taxes(3, 7, 2, 1);
