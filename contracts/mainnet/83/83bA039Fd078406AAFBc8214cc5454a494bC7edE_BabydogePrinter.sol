...
/\  _`\           /\ \              /\  _`\                              /\  _`\          __          /\ \__                 
\ \ \L\ \     __  \ \ \____   __  __\ \ \/\ \    ___      __       __    \ \ \L\ \ _ __  /\_\     ___ \ \ ,_\     __   _ __  
 \ \  _ <'  /'__`\ \ \ '__`\ /\ \/\ \\ \ \ \ \  / __`\  /'_ `\   /'__`\   \ \ ,__//\`'__\\/\ \  /' _ `\\ \ \/   /'__`\/\`'__\
  \ \ \L\ \/\ \L\.\_\ \ \L\ \\ \ \_\ \\ \ \_\ \/\ \L\ \/\ \L\ \ /\  __/    \ \ \/ \ \ \/  \ \ \ /\ \/\ \\ \ \_ /\  __/\ \ \/ 
   \ \____/\ \__/.\_\\ \_,__/ \/`____ \\ \____/\ \____/\ \____ \\ \____\    \ \_\  \ \_\   \ \_\\ \_\ \_\\ \__\\ \____\\ \_\ 
    \/___/  \/__/\/_/ \/___/   `/___/> \\/___/  \/___/  \/___L\ \\/____/     \/_/   \/_/    \/_/ \/_/\/_/ \/__/ \/____/ \/_/ 
                                  /\___/                  /\____/                                                            
                                  \/__/                   \_/__/                                                             
Telegram: https://t.me/babydogeprinter
BabyDoge Printer SmartContract 
*/
...
contract BabydogePrinter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BDPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Babydoge Printer", "BDP") {
        marketingWallet = payable(0xb7a9f3657197b8Fa1b3D919149926633589B70F4);
        devWallet = payable(0x95a0f6db7b95F8D2fCAbe4686C75DAc3B0fbD25B);
        ...
        dividendTracker = new BDPDividendTracker(
            payable(this),
            router,
...
contract BDPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabydogePrinter public BabydogePrinterContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabydogePrinterContract = BabydogePrinter(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BDP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BDP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabydogePrinterContract);

            uint256 prevBalance = BabydogePrinterContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabydogePrinterContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabydogePrinterContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
