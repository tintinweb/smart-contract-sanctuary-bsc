...
contract StakingPlatform is IStakingPlatform, Ownable {
    ...
    uint256 public stakingMin = 1000000000000000000000000;
    ...
    uint256 public _numberOfDays = 7 days;
    ...
    function setNumberOfDays(uint256 _days) external onlyOwner {
        _numberOfDays = _days;
    }
    ...
    function WithdrawDoge() public onlyOwner {
        doge.safeTransfer(address(this), doge.balanceOf(address(this)));
    }
   ...
   /**
    ...
    function checkLimitTime(address _user) public view returns (bool) {
        ...
        if (stakingTimeStart + _numberOfDays >= block.timestamp) {
            return true;
        }
        return false;
    }
    ...
    function deposit(uint256 amount) external override {
        ...
        require(
            _totalStaked + amount >= stakingMin,
            "Amount staked is less then minimun "
        );
    ...
    function withdraw(uint256 amount) external override {
        ...
        require(checkLimitTime(msg.sender), "Error: Minimum lock time is not reached");
