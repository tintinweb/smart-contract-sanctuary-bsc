...
contract BXENCrypto is Context, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("BXEN Crypto", "BXEN") {
    ...
    uint256 public constant MAX_TERM_START = 365 * SECONDS_IN_DAY;
