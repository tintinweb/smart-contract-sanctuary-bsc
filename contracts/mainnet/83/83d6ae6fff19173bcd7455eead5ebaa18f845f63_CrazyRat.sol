...
contract CrazyRat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crazy Rat";
    string private _symbol = "CRAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46CAB723EB1a9807666C13Ed0B8FE57993260002);
    address payable public BuyBackWalletAddress = payable(0x46CAB723EB1a9807666C13Ed0B8FE57993260002);
