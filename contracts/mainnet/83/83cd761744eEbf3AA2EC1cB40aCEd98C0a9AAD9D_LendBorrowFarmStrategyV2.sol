...
contract LendBorrowFarmStrategyV2 is LogicUpgradeable {
    ...
    event BorrowAmount(
        address[] arrBorrowToken,
        uint256[] arrBorrowAmount,
        uint256[] arrToken0Amount,
        uint256[] arrToken1Amount,
        uint256 pos
    );
     ...
     */
    function build(uint256 usdAmount, uint8 flag) external onlyOwnerAndAdmin {
