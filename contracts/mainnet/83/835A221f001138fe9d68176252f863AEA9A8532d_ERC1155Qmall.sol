...
abstract contract ERC1155Lazy is OwnableUpgradeable, IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function mintAndTransfer(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public payable override virtual {
        require(msg.sender == owner() || block.timestamp >= 1668528000, "Mint is not public!");
        require(msg.value >= 0.5 ether, "Not enough BNB sent!");
...
abstract contract ERC1155Base is ERC1155DefaultApproval, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {
    ...
    function setRoyalties(uint256 _id, LibPart.Part[] memory _fees) public onlyOwner {
        _saveFees(_id, _fees);
