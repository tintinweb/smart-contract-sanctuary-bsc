...
contract RojoTokenNFT is Ownable, ERC721 {
    using Strings for uint256;
    uint256 public constant MAX_MINT_COUNT = 15;
    uint256 public constant MAX_SUPPLY = 100000000;
    
    string private _nftURI = "https://rojotoken.mypinata.cloud/ipfs/QmVEST6T5kZUFpq4NpPWV1hQStLw4cJe1PdvK4jUbrJHcZ/";
    uint256 private _counter = 0;
    

    constructor() ERC721("Rojo Token NFT", "RTNFT"){
        // Mint for the team
