...
contract SSCY is Context, IERC20, Ownable {
    ...
    string private constant _name = "shanshangcheye";
    string private constant _symbol = "SSCY";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xA65D720C0A40F89D725B5a463fA0F4Dff5f1a499);
    address payable private _marketingAddress = payable(0x90632c5c4dEDcA2F3adF9e0BC7a33360AF1e5d92);
