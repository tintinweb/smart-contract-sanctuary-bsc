...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5f84248874f859DB4e83d089E28Eb4C979A043C8; // owner address
...
contract SambaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Samba Chain";
    string private _symbol = "SAMBA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBee80e91f82C3E2dA102Dc28417cD3f5DADCf996); // Marketing Address
    address payable public teamWalletAddress = payable(0x5f84248874f859DB4e83d089E28Eb4C979A043C8); // Team Address
    ...
    uint256 public _walletMax = 3_000_000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 250_000 * 10**3; 
