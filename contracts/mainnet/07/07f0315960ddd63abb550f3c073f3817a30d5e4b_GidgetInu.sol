...
contract GidgetInu is IBEP20, Auth {
    ...
    string constant _name = "Gidget Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "GIDGETINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3B7814e4DDf3d2813192932Ee15B89f7b40AE10e;
        marketingFeeReceiver = 0x9F1037e1fc871CC7447416FB7Be256f7cdCD0091;
