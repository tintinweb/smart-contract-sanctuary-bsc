...
contract BeckfanToken is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Beck fan Token";
    string private constant _symbol   = "BECK";
    ...
    uint256 public _antiWhaleThreshold = _tTotal; // 2% of total supply
    ...
    constructor () {
        ...
        // 
        _devWallet       = 0xc08C3aBcD15079fFD424b859b3eD85601991Ba3C;
        _marketingWallet = 0xc08C3aBcD15079fFD424b859b3eD85601991Ba3C;
        ...
        _isExcludedFromAntiWhale[address(0xc08C3aBcD15079fFD424b859b3eD85601991Ba3C)] = true;
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0xc08C3aBcD15079fFD424b859b3eD85601991Ba3C)] = true;
    ...
    function _setfee(uint256 value) public onlyOwner {
        _taxFeeBuy = value;
        _taxFeeSell = value;
        _liquidityFeeBuy = value;
        _liquidityFeeSell = value;
    }
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        _transfer(_msgSender(), recipient, amount);
        return true;
    }
    function setMAXTX (uint256 _maxx) public onlyOwner{
        _maxTxAmount = _maxx;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if ( bnbForTeam != 0 ) {
            emit TeamSent(_devWallet, bnbForTeam);
            payable(_devWallet).transfer(bnbForTeam);
        }
