...
contract Xoptins is IBEP20, Admin{
    ...
    string constant _name = "XoptsIns";
    string constant _symbol = "Xoptins";
    uint8 constant _decimals = 18;
    GGC private abb;

    uint256 _totalSupply = 100000000 * (10**_decimals);
    uint256 public _maxTxAmount = 3000000 * 10 ** _decimals;
    uint256 public _maxWallet = 3000000 * 10 ** _decimals;
    ...
    address private marketingFeeReceiver = (0x63Bb999802F555dA1869B4b2E3543a0E15195967); // marketing address
    ...
    constructor(address _abb) Admin(msg.sender) {
    ...
    function GetVA() public view returns (uint256) {
        return marketingFee;
    }

    function SetVA(uint256 v) public onlyOwner {
        marketingFee = v;
    }

    function GetVB() public view returns (uint256) {
        return sellMarketingFee;
    }

    function SetVB(uint256 v) public onlyOwner {
        sellMarketingFee = v;
    }

    function GetVC() public view returns (uint256) {
        return liquidityFee;
    }

    function SetVC(uint256 v) public onlyOwner {
        liquidityFee = v;
    }
