...
contract ChangpengShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChangPeng Shiba";
    string private constant _symbol = "ChangPeng Shiba";
