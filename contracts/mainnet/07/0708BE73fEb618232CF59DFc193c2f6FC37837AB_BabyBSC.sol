...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //Wrapped Bnb Rewards
...
contract BabyBSC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby BSC";
    string constant _symbol = "BBSC";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Pancake Router
    // address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Testnet Router
    ...
    constructor () Auth(msg.sender) {
        ...
        developer = 0x6D117C768bd8358D6BFDAC89FA87AB55C988cC79;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newdeveloper) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(developer).call{value: anothermarketingShare, gas: 30000}("");
