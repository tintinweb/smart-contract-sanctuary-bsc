...
contract SSCY is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 5000000 * 10**6 * 10**_decimals; //0.5% of tTotal
    uint256 public numTokensSellToAddToLiquidity = 5000000 * 10**6 * 10**_decimals; //0.05% of tTotal
    ...
    constructor () {
        ...
        // marketing wallet
        _marketingWalletAddress = 0x38C369781251FDc6765C7968c6188316954e7324;
