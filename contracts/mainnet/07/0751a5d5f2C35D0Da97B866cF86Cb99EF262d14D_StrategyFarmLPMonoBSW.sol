...
contract StrategyFarmLPMonoBSW is StrategyFarmLPMono {
    ...
    function pendingReward() public view override virtual returns (uint256 amount) {
        amount = IMasterChefBSW(masterchef).pendingBSW(poolId, address(this));
        return amount;
    }
}

interface IMasterChefBSW is IMasterChef {
...
// INTERNAL FUNCTIONS
    ...
    function _poolWithdraw(uint256 amount) internal override {
