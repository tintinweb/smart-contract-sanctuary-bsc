...
contract AllStarsFarm is Ownable {
    ...
    uint256 public constant MIN_STAKE_AMOUNT = 500 ether; // TODO: change by function to calculate minStakeAmount
     ...
     */
    // TODO: to make amounts for groups adjustable
    function stake(
        address token_,
        uint256 amount_,
        bool isLowRisk_
        ...
        require(amountInBUSD >= MIN_STAKE_AMOUNT, "AllStarsFarm: Insufficient amount!");
        uint8 groupNumber;
        if (amountInBUSD < 1000 ether) {
            groupNumber = 1;
        } else if (amountInBUSD < 5000 ether) {
            groupNumber = 2;
        } else if (amountInBUSD < 10000 ether) {
            groupNumber = 3;
        } else {
            groupNumber = 4;
        }
