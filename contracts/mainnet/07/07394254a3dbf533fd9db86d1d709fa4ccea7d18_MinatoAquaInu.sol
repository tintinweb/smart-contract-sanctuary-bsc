...
contract MinatoAquaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MinatoAquaInu";
    string private _symbol = "$MAQUA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x979aeC9E6712c74a2Ccf9388619e5EAA79A2ce46); 
    address payable public buyBackWalletAddress = payable(0x979aeC9E6712c74a2Ccf9388619e5EAA79A2ce46); 
