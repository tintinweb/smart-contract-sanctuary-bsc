...
contract TokenB is Ownable, ERC20 {
    ...
    string private constant _name = "TokenB"; //Balloon Protocol";
    string private constant _symbol = "TokenB"; //AIR";
    ...
    // Base fees
    function setBaseFeesOnBuy(uint8 _liquidityFeeOnBuy,uint8 _operationsFeeOnBuy,uint8 _targetAFeeOnBuy, uint8 _targetBFeeOnBuy, uint8 _targetCFeeOnBuy) external onlyOwner {
    ...
    function setBaseFeesOnSell(uint8 _liquidityFeeOnSell,uint8 _operationsFeeOnSell,uint8 _targetAFeeOnSell, uint8 _targetBFeeOnSell, uint8 _targetCFeeOnSell) external onlyOwner {
    ...
    function _setCustomSellTaxPeriod(CustomTaxPeriod storage map,uint8 _liquidityFeeOnSell,uint8 _operationsFeeOnSell,uint8 _targetAFeeOnSell, uint8 _targetBFeeOnSell, uint8 _targetCFeeOnSell ) private {
    ...
    function _setCustomBuyTaxPeriod(CustomTaxPeriod storage map,uint8 _liquidityFeeOnBuy,uint8 _operationsFeeOnBuy,uint8 _targetAFeeOnBuy, uint8 _targetBFeeOnBuy, uint8 _targetCFeeOnBuy) private {
