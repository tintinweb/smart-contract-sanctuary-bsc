...
contract Gate {
    ...
    function allSpecialIds() external view returns (uint256[] memory) {
        uint256[] memory spcialIds = SPECIAL_IDS;
        return spcialIds;
    }
    ...
    function setAddGasSwitch(bool useGasSwitch) public onlyAuth {
        USE_GAS_SWITCH = useGasSwitch;
    }
