...
contract INU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x40a2faD6aD3b31531e26baD632a835520FC462e3); 
    address payable public Wallet_Dev = payable(0x40a2faD6aD3b31531e26baD632a835520FC462e3);
    ...
    uint256 public Tax_on_inuLiq = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Tax_on_inuBrn = 0;             
    ...
    constructor () {
        ...
        _owner = 0x40a2faD6aD3b31531e26baD632a835520FC462e3;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Tax_on_inuBrn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Tax_on_inuLiq / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Tax_on_inuLiq + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Tax_on_inuLiq + Percent_Marketing + Percent_Dev);
