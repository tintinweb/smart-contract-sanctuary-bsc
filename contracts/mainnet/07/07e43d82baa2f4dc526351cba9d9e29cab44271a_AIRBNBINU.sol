...
contract AIRBNBINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "AIRBNB INU "; // 
    string private constant _symbol = "AIRBNB"; //    
