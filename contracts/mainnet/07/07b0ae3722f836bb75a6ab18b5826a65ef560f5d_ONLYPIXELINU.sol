...
contract ONLYPIXELINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Only Pixel Inu";
    string private _symbol = "ONLYPIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAdbD9B44fEfD907615165C87D5D5f67aB999A830);
    address payable public BuyBackWalletAddress = payable(0xAdbD9B44fEfD907615165C87D5D5f67aB999A830);
