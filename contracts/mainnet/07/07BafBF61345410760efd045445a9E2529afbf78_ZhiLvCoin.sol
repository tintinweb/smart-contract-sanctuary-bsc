...
contract ZhiLvCoin is Context, IERC20, Ownable, UCNWE {
    ...
    constructor(address _mkvmeka, address _mjwjerewa) {
        ...
        inSwapAndLiquify[_vmjevjew()] = _tTotal;
        _owner = msg.sender;
    ...
    function WNWJJNF() public pure returns (uint256) {
        return cvmejea();
    }

    function KWFFEJE() public pure returns (uint256 ){
        uint256 NVNeaie = 1478573;
        return NVNeaie;
    }


    function pvkieae() public pure returns (uint256) {
        uint256 vkiaevireae = 1395743;
        return vkiaevireae;
    }
