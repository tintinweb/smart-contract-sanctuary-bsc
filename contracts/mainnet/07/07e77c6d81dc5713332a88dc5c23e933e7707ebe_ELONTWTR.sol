...
contract ELONTWTR is Context, IERC20, Ownable {
    ...
    string private _symbol = "ELONTWTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa01A2bC9F6eEFa2265B8547f64DE91F545c5ba2f); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa01A2bC9F6eEFa2265B8547f64DE91F545c5ba2f); // buyback Address
