...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7E6537827AA777Ae11f51279eE24b907a59dB31; // owner address
...
contract SunsetSnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sunset Snake";
    string private _symbol = "SSAKE"; 
