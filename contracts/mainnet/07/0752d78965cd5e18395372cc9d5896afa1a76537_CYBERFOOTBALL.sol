...
contract CYBERFOOTBALL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyber Football";
    string private _symbol = "COFO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9167faaBf863108f6F97A6e2c6bf06579d2bc87b); 
    address payable public buyBackWalletAddress = payable(0x734F63b8783ea3cB39ff98Ecf7a74B78Ff90A619); 
