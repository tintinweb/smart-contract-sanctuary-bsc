...
contract tSAFUv3 is ERC20Detailed, Ownable {
    ...
    address public es2DividendReceiver;
    ...
    constructor() ERC20Detailed("tSAFUv3t", "tES3t", uint8(DECIMALS)) Ownable() {
        ...
        //contract addreses
        autoLiquidityReceiver = 0x2c1C750b0E11bE5ef390C0Afa91e5C07372C2C66;
        treasuryReceiver = 0x1aaE66E0e40cd1c4b4bBFca06Eda7032f94d42FC;   
        ...
        es2DividendReceiver = address(distributor);
