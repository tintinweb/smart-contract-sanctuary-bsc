...
contract SLBtoken is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 6e7 * 3e17;
    
    address public marketingWallet = 0xB2A1ceF0C399ff0E36DC2142e1f952aB6793Fc9a;
    ...
    constructor() ERC20("SpaceLaEeb", "SpaceLaEeb") {
        _mint(msg.sender, 100e13 * 10 ** decimals());
