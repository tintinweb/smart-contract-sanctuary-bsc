...
A story of millions, by the real Squid Game 2.0 team!

Telegram: https://t.me/SquidDay
Website: https://twitter.com/SquidDay_BSC
...
contract SquidDay is Ownable, IBEP20 {
    ...
    string constant _name = "Squid Day";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x4BC360F6aa99e756b12D3D70387aB0e14725fd0e;
        marketingWallet = 0x4BC360F6aa99e756b12D3D70387aB0e14725fd0e;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 8);
        require (newTotalSell < 8);
