...
contract PureBloodToken is Context, IERC20, Ownable {
    ...
    uint256 public buybackLimit = 1 ether; //1 BNB

    uint256 private lastBlock;
    uint8 public constant BLOCKCOUNT = 100; //AntiSnipe 100 blocks
  ...
  tradingStartBlock = block.number;
    ...
    function setBuyFee(
       ...
       uint256 totalbuyFee = liq + market + buyback + tax + charity + treasury;
       require (totalbuyFee < 20, "buyFee should be less than 20%");
    }
    ...
    function setSellFee(
        ...
        uint256 totalsellFee = liq + market + buyback + tax + charity + treasury;
       require (totalsellFee < 20, "sellFee should be less than 20%");
    }
   ...
   require (value >= 1000000, "Max wallet value should be greator than 1 million tokens");
  ...
  require (value>= 100000 , "No Rug Pulls");
    ...
    function setBuyBackLimit(uint256 amount) external onlyOwner {
        require(amount >=  1000000000000000, "buybackValue should be greator than 0.01 bnb!");
        buybackLimit = amount;
    }
    ...
    function _transfer(
     ...
     if (!inSwapAndLiquify && from !=uniswapV2Pair ) {
        ...
        if (
            ...
            uint256 walletFees = contractTokenBalance - forLiquidity ;    
           ...
           swapAndSendToWallets(walletFees
            ); // sending BNB for Buyback, marketing and Treasury Wallet
        ...
        lockTheSwap
    {
        ...
        uint256 forMarketing = newBalance
            ...
            .div(buyFee.treasuryFee + sellFee.treasuryFee + buyFee.marketingFee + sellFee.marketingFee + buyFee.buybackFee + sellFee.buybackFee);
       
        uint256 forTreasury = newBalance
                   .mul(buyFee.treasuryFee + sellFee.treasuryFee)
                   .div(buyFee.treasuryFee + sellFee.treasuryFee + buyFee.marketingFee + sellFee.marketingFee + buyFee.buybackFee + sellFee.buybackFee);
