...
Website: http://lowtoken.live/
Telegram: https://t.me/lowtoken
...
contract LowToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOW TOKEN";
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**9; // max tx
    uint256 public _walletMax = 30 * 10**6 * 10**9; // max wallet
