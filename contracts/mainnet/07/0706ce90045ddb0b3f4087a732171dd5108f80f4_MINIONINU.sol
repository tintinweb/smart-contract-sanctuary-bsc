...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89602d512354999005747021a321eb6665dAF27f;
...
contract MINIONINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x89602d512354999005747021a321eb6665dAF27f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MINION INU";
    string private _symbol = "MINION";
