...
contract bnbbull2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBBULL2.0";
    string private _symbol = "BBULL2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa74f97634fabe5158119c56B750Da85365665db6); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa74f97634fabe5158119c56B750Da85365665db6); // buyback Address
    ...
    uint256 private minimumTokensBeforeSwap = 99000 * 10**9; 
