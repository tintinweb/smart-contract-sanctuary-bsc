...
contract FLEEP is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLEEP GRU"; // 
    string private constant _symbol = "FLEEP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC5999B08D059384C5F5e7EE55e698357173B6E8D;
