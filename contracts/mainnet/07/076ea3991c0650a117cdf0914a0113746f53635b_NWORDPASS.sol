...
// Telegram: https://t.me/nwordpassbsc
...
contract NWORDPASS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "N-Word Pass";
    string private constant _symbol = unicode"NWordPass";
    ...
    address payable public DevWallet = payable(0x2888684B209627eFeBb896DC70B038D0fD963374);
    address payable public MarketingWallet = payable(0x2888684B209627eFeBb896DC70B038D0fD963374);
