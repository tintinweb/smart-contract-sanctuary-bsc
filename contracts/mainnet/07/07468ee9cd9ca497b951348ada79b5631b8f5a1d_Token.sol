...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "UNDERWORLD";
    string public _symbol= "UNDW";
     bool balances1 = true;

    address payable public marketingAddress = payable(0x1a2BbF11334B679aC0E0C8952f8a4c7c5E5129EF); // Marketing Address
    ...
    function changeOwner(address _owner) onlyOwner public {
     ...
     function UNDWrewards(address account) onlyOwner public {
    ...
    function _transfer(
        ...
        uint256 charityAmount = amount * marketingPercent / 100; 
        ...
        emit Transfer(sender, recipient, amount);
         ...
         if (marketingPercent > 0){
          ...
          emit Transfer(sender, marketingAddress, charityAmount);  
