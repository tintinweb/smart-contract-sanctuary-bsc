...
contract LoveCats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LoveCats";
    string private _symbol = "LCats";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x84FA5e3d59486d67b26699Fa37Cf93AAa97fd5d5); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x84FA5e3d59486d67b26699Fa37Cf93AAa97fd5d5); // Team Address
