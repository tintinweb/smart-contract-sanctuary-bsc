...
/**
    Nomad 2.0
    Telegram : https://t.me/Nomad20_BSC
*/
...
contract Nomad20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nomad 2.0";
    string private constant _symbol = "NOMAD2.0";
    ...
    mapping (address => uint256) private _isUpper;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isUpper[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isUpper[to] = block.timestamp;
        }
