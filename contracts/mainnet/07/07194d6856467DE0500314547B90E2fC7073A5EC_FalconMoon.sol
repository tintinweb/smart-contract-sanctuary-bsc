...
contract FalconMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FalconMoon";
    string constant _symbol = "FalconM";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x43325947554B77BEF0A8FbBc115Cc981A2253206;
