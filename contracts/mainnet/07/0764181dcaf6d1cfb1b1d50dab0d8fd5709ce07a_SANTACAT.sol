...
/**
SANTACAT
Telegram : https://t.me/santacatbnb
*/
...
contract SANTACAT is Context, IERC20, Ownable {
    ...
    address public liquidityReceiver = address(0x01489D7A380cB4F0972A5FE31fc5B7AE4D8cC084);
    address public marketingWallet = address(0x92C9d67ECfFC4F231AcC5aa16823D7FDA0413587);
    address public bbWallet = address(0x92C9d67ECfFC4F231AcC5aa16823D7FDA0413587);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 120 && !phaseOne) {
            _maxWalletAmount =  30_000_000_000 * 10**_decimals;
            _maxTxAmount     = 30_000_000_000 * 10**_decimals;
