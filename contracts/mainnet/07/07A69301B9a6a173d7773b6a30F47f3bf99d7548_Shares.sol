...
contract Shares is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("Shares", "Shares") { 
        ...
        uint256 totalSupply = 100 * 10 ** 9 * 10 ** decimals(); // 500 Billion
 
        maxTransactionAmount = 1 * 10 ** 3 * 10 ** decimals(); // 1000 maxTransaction
        maxWalletAmount = 1 * 10 ** 3 * 10 ** decimals(); // 1000 maxWallet
