...
contract JeeraSwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jeera Swap"; //
    string private constant _symbol = "Jeera"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x28ec75be48d0a34fB2a2d26c5373a5cBC0cCE33e ;
