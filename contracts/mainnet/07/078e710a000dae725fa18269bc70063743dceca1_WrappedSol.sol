...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF8bBd18ad7827bE44255D30F8c1a959dea880589; // owner address
...
contract WrappedSol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wrapped Solana";
    string private _symbol = "WSOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29aB035f1Fe1F11Ff8964ED0c089173232B1fC52); // Marketing Address
    address payable public teamWalletAddress = payable(0x29aB035f1Fe1F11Ff8964ED0c089173232B1fC52); // Team Address
