...
contract LinkDaoRecurring_P24 is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address public LINKDAO_TOKEN_ADDRESS;
    uint256 public MAX_STAKE = 300000 ether;
    uint256 public MAX_STAKE_PER_USER = 50000 ether;
    ...
    function investAmountForOwner(address investorAddress,uint256 _amount) external onlyOwner{
        ...
        require(totalInvestments.add(_amount)<=MAX_STAKE,"Cannot stake more than 350,000 LKD");
        require(investors[investorAddress].totalInvestment.add(_amount)<=MAX_STAKE_PER_USER,"Cannot stake more than 350,000 LKD");
    ...
    function investAmount(uint256 _amount) external{
        ...
        require(totalInvestments.add(_amount)<=MAX_STAKE,"Cannot stake more than 350,000 LKD");
        require(investors[msg.sender].totalInvestment.add(_amount)<=MAX_STAKE_PER_USER,"Cannot stake more than 350,000 LKD");
