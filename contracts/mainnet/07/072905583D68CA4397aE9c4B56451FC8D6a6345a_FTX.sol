...
contract FTX is Context, IERC20, Ownable {
    ...
    string private _name = "Freetax Token";
    ...
    address payable  public devWallet = payable(0x8B1935856467b0874EBfEa0Ef2F57173352D44fb);
    ...
    function setTaxFeePercent(uint256 taxFee,uint256 liquidityFee,uint256 MarketingFee,uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
        _pretaxfee = _taxFee;
    ...
    function setsellTaxFeePercent(uint256 taxsellFee,uint256 liquiditysellFee,uint256 MarketingsellFee,uint256 burnsellFee) external onlyOwner() {
