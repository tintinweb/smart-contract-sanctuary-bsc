...
contract RaccoonNetworkToken is IERC20, Ownable {
    ...
    address private fundAddress = address(0x6768377EC805D5277439e9DDa1E99410C54CE2b2);
    ...
    constructor() {
        ...
        _tTotal = 5541920267402470 * 10 ** _decimals;
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            require(balanceOf(from).mul(80).div(100)>amount,"selle max 80%");
            takeFee = true;
        }else{
