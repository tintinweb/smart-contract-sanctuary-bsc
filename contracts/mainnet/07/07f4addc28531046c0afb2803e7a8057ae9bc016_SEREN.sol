...
/**
The Serenity project is a “defi talent agency” that is partnering with talented independent artists, producing custom art through our LLC business, and selling that art as NFTs or through custom crypto-centric events. Profits are shared with the artist, and the token holding community also receives a 30% buyback/burn on all NFT sales and 3% token reflections.
*/
...
contract SEREN is Context, IERC20, Ownable {
