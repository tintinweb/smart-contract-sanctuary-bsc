...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd83f956DB49480FfB64895Ca387372664A8DE1ca; // owner address
...
contract THEMEMECONOMY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "THE MEMECONOMY";
    string private _symbol = "MEMECONOMY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd83f956DB49480FfB64895Ca387372664A8DE1ca);
    address payable public teamWalletAddress = payable(0xd83f956DB49480FfB64895Ca387372664A8DE1ca); 
