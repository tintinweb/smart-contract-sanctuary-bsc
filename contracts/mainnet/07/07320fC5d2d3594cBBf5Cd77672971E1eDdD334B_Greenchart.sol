...
/**
GREEN CHART 2.0! $GC20 💹

The market is GREEN and we want to keep hodler's pockets that way too! 🟢

💡Green Chart version 1 did massive numbers & with a more competent team behind 2.0, you can expect the roof to be blown off! $GC20 aims to enable investors to become self-sufficient through high quality content and accessible investment platforms and services. 

💡The goal of $GC20 is to create a universal asset that anyone can buy with no crypto experience. Our primary utilities out the gate will be our own wallet application with a fiat buy button, a staking dapp, & a token bridge to attract more investors across chain. 

Come join us on this ride to a green chart and become a better investor today! 
...
TG: @Greenchart20
Twitter: https://twitter.com/GreenChart20
...
contract Greenchart is Context, IERC20, Ownable {
    ...
    string private constant _name = "Greenchart 2.0"; 
    string private constant _symbol = "$GC20"; 
