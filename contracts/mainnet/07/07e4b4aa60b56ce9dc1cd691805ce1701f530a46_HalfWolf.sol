...
contract HalfWolf is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "HALF WOLF";
    string private constant _symbol = unicode"$HWOLF";
    ...
    address payable public DevWallet = payable(0xd9eA4D7B23d8EBd597a1256C7FD09527f7EFb78B);
    address payable public MarketingWallet = payable(0x8DaEFA653F20cfE23148B74e133Cf5bC3aA1e143);
