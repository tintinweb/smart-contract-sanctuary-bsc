...
contract FuckPelosi is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "FuckPelosi";
    string private _symbol = "FuckPelosi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6028036Ab491aa0A4fB3985a33FB70Ea5380fAAB);
    ...
    uint256 private _totalSupply =  44444444444444 * 10**_decimals;
    uint256 public _maxTxAmount =   44444444444444 * 10**_decimals;
    uint256 public _walletMax =     44444444444444 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 444444444 * 10**_decimals;
