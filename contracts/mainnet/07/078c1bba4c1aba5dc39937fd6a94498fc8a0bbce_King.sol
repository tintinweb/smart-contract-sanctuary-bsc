...
Telegram: https://t.me/KingCharlesIII
...
contract King is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1f64AECA96Fe64B1fd4C5774068B5b516D29a5Fb;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0x1f64AECA96Fe64B1fd4C5774068B5b516D29a5Fb;
    ...
    function set_sell_multiplier(uint256 _multiplier) external onlyOwner{
        require(totalFee.mul(sellMultiplier).div(100) < 99, "Sell Tax cannot be more than 50%");
