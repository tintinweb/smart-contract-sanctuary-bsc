...
contract SKITTYCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xfbe35847997b7F4CD30af8ce0c51022A7950a815); 
    address payable public buyBackWalletAddress = payable(0x164ffBFa0dcd813115641e2E1d7CB7Ed9E2882cf); 
    ...
    uint256 private minimumTokensBeforeSwap = 900000 * 10**9; 
