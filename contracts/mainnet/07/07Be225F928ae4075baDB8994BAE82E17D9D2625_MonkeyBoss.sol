...
contract MonkeyBoss is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Bd396F813d8e1bE3DaD748c39bFdC744437274a); 
    address payable public Wallet_Dev = payable(0x2Bd396F813d8e1bE3DaD748c39bFdC744437274a);
    address payable public constant Wallet_Burn = payable(0x2Bd396F813d8e1bE3DaD748c39bFdC744437274a); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Monkey Boss"; 
    string private constant _symbol = unicode"MonkeyBOSS"; 
    ...
    constructor () {
        ...
        _owner = 0x2Bd396F813d8e1bE3DaD748c39bFdC744437274a;
