...
contract TEST is Context, IERC20 { 
    ...
    */
    ...
    Wallet_TEST: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_TEST = payable(0xec7D683353DAe73FE7ec79f9d71324A35c3286F9); 
    address payable  Wallet_LP = payable(0x9F9cE3a784D1b327296Cd2A351aB7C6DE5A68bd2);
    ...
    uint256 public Percent_TEST = 70;
    ...
    constructor () {
        ...
        */
        ...
        _isLimitExempt[Wallet_TEST] = true; 
        ...
        _isExcludedFromFee[Wallet_TEST] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 TEST_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((TEST_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_TEST = TEST_Wallet;
    ...
    */
    ...
    //Update the TEST wallet
    event updatedTESTWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_TEST(address payable wallet) external onlyOwner() {
        ...
        emit updatedTESTWallet(Wallet_TEST,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_TEST] = false; 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_TEST != 0){

            // Calculate how many tokens need to be swapped for BNB (TEST BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_TEST / 100;
            ...
            uint256 split_M = Percent_TEST * 100 / (Percent_AutoLP + Percent_TEST);
            ...
            // Send BNB to TEST wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_TEST, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_TEST != 0){

            // Swap tokens for BNB and send to TEST Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_TEST / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_TEST, BNB_M);
            ...
            // Create the Auto LP if TEST is 0
