...
contract bings is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"Bingschain";
    string private _symbol = unicode"BINGS";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x86b549767372dA4a4F192Ae01BaA722d8EFD23aC); 
