...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _afterTokenTransfer(account, address(0x000000000000000000000000000000000000dEaD), amount);
    }
...
contract CryptoARCToken is ERC20, Ownable, Pausable {

    uint256 private premint = 300000000e18;
    uint256 private _cap = 700000000e18;

     constructor() ERC20("CryptoARC", "ARC") {
