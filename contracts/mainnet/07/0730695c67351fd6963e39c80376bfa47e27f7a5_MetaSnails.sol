...
contract MetaSnails is ERC20Detailed, Ownable {
    ...
    string public _name = "MetaSnails";
    string public _symbol = "MS";
    ...
    uint256 public MSInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(MSInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public MSInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("MS", "MS", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x799ED71AF53022c43955D6BDa505A8789aCcB6A2;
        treasuryReceiver = 0xB0333D5cC08B6fE16D7EF4859856a6C4B499Cdb4; 
        MSInsuranceFundReceiver = 0x3660c54e16B284DFc04121CC3273e456903099AB;
        firePit = 0x220bCc484e663Be378347D84d4B572a4596dB28E;
    ...
    function takeFee(
        ...
        uint256 _MSInsuranceFundFee = MSInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _MSInsuranceFundFee = MSInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(MSInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(MSInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(MSInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(MSInsuranceFundFee).div(
                treasuryFee.add(MSInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no MS token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function shouldAddLiquidity() internal view returns (bool) {
        return
            ...
            !inSwap && 
            msg.sender != pair &&
            block.timestamp >= (_lastAddLiquidityTime + 5 minutes);
    }
    ...
    function setFeeReceivers(
        ...
        address _MSInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        MSInsuranceFundReceiver = _MSInsuranceFundReceiver;
        firePit = _firePit;
    }
