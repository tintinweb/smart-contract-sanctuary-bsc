...
contract TIMELINE is IERC20, Context, Ownable {
    ...
    string private constant _name = "Timeline Coin";

    uint256 public Timeline_max_BuyLimit = 5000000 * 10**9;
    uint256 public Timeline_max_SellLimit = 5000000 * 10**9;

    address private Timeline_Marketing_Wallet = 0x93B2f9595D21a17a00FAA89e0B0c8b0dE7166666;
    address private Timeline_Team_Wallet = 0x93B2f9595D21a17a00FAA89e0B0c8b0dE7166666;

    uint256 public Timeline_max_WalletLimit = 10000000  * 10**9;
    uint256 public swapTokensAtAmount = 1500000 * 10**9;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Timeline_Marketing_Wallet] = true;
        _isExcludedFromFee[Timeline_Team_Wallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Timeline_Marketing_Wallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Timeline_Marketing_Wallet).sendValue(marketingAmt);
        }
    ...
    function Timeline_Update_MarketingWallet(address newWallet) external onlyOwner{
        Timeline_Marketing_Wallet = newWallet;
    }
