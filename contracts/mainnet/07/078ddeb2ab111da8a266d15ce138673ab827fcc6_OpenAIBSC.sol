...
/**
    ...
    🎮⭐️OpenAIBSC⭐️🎮
    #OpenAIBSC, the fun virtual reality game allowing you to #earn and #live online.
    ⭐️With #OpenAIBSC you really can take the reality of living and dreaming into a virtual world. 
    ...
    where you choose your path of success within the OpenAIBSC world.

    🎮⭐️OpenAIBSC Game Summary; 
    🗣️OpenAIBSC #Characters; Each player will create their own #identity with specific characteristics, 
    #skills and attributes. These chosen skills will allow you to browse the OpenAIBSC in-game world to 
    complete different daily tasks for fun!

    💎🚙OpenAIBSC #Assets; Like any real world, once you earn your #OpenAIBSC you can exchange them 
    ...
    🌇OpenAIBSC #City; In the game our first city will be designed for in game player interaction, with #tasks, 
    #skills and #games. The more successfull you are at completeing such interactions the more you are rewarded.

    🌆OpenAIBSC #Marketplace; Game items could both be traded through the in-game #marketplace and also the 
    NFT marketplaces on other blockchains. It creates #liquidity for the assets created through the game and also 
    encourages more players to participate in building the the OpenAIBSC world.

    🚀FairLaunch on Pancakeswap: Feb 12th, 10:00 UTC 📆

    🌍Web       : https://www.OpenAIBSC.online
    🔎Telegram  : https://t.me/OpenAIBSCChannel
    🕊Twitter    : https://twitter.com/ortiz234

    OpenAIBSC
    1,000,000,000 OpenAIBSC
...
contract OpenAIBSC is ERC20, Ownable {
  ...
  constructor() ERC20("OpenAIBSC", "OpenAIBSC") {
    address _routerAddr;
    if (block.chainid == 56) {
