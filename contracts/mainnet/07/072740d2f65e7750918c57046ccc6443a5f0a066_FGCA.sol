...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49E2097fEE9ff730f69C842CEBd70E1249AF1Dcb;
...
contract FGCA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x404eB097e5b04Cf4a4aAc62DE17F6d9e6F6523BD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FGCA";
    string private _symbol = "FGCA";
