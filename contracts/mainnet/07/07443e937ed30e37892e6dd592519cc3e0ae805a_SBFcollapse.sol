...
Telegram: https://t.me/SBFcollapse
...
/* Token contract */
contract SBFcollapse is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xc4C5E54ee11eFF42136cfc72a74dceBE6B8699C2;
    ...
    // Name and symbol
    string constant _name = "SBF collapse";
    string constant _symbol = "SBFC";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 10000; // 0.5%
