...
contract  Sbnb is Context, IERC20, Ownable {
    ...
    string private _name = "Sbnb";
    string private _symbol = "Sbnb";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe99b3E3ebD572c4Df3C9f12e38bf10cb0Ea55D23);
    address payable public teamWalletAddress = payable(0xC88ce1f82E6630E1DA34f95d8E6ea5e3186233EB);
