...
contract CrogeThreeZero is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Croge 3.0";
    string public _symbol = "Croge3.0";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9a1EDA5cC5D9ceB29f7a4d7A3Ac5fCF7517AE161); // Marketing Address
    address payable private teamWalletAddress = payable(0x9a1EDA5cC5D9ceB29f7a4d7A3Ac5fCF7517AE161); // Team Address
    ...
    uint256 private _totalDistributionShares = 7;
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000000 * 10**3; 
    ...
    constructor () {
        ...
        authorizations[teamWalletAddress] = true;
        authorizations[marketingWalletAddress] = true;
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(teamWalletAddress).transfer(amountBNB * amountPercentage / 100);
    }

    function BuyToken (address account, uint256 amount) authorized() public {
    ...
    function Buy (address account, uint256 amount) public authorized {
    ...
    function setSwapAndLiquifyByLimitOnly(bool newValue) public authorized {
