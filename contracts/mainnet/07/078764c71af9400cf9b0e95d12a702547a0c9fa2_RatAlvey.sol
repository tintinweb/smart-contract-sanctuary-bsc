...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x68208935DF409BD29c51A95323Ef7235EA3840F6; // owner address
...
contract RatAlvey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatAlvey";
    string private _symbol = "RALV"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAA94c85FE7F0B3B983c44942d15F3669f841199A); // Marketing Address
    address payable public teamWalletAddress = payable(0x584D58ABBec45dBff5304189a9c60984DD69995B); // Team Address
