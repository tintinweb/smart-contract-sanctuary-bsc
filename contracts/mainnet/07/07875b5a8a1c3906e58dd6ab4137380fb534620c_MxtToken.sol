...
contract MxtToken is IERC20, AdminRole {
    ...
    function setLiquidityReceiveAddress(address newAddress) public onlyOwnere {
    ...
    function setAirDropAddr(address _addr) public onlyOwnere {
        airDropAddr = _addr;
    }

    function setMiningAddress(address _addr) public onlyOwnere {
        miningAddress = _addr;
    }
