...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92eE215Cb76A21052A97E1062eCF1758c2440fF0;
...
contract ATMINU20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ATM INU 2.0"; // 
    string private constant _symbol = "ATM inu 2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x92eE215Cb76A21052A97E1062eCF1758c2440fF0);
