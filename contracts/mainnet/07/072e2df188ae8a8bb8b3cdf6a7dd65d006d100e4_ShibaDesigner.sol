...
contract ShibaDesigner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaDesigner Coin";
    string private _symbol = "ShibaDesigner";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA7881E40047c6143032558C2bd5f6156f3DD5EC0); 
    address payable public teamWalletAddress = payable(0xA7881E40047c6143032558C2bd5f6156f3DD5EC0); 
