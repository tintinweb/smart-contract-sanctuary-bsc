...
contract WuKeLan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function doubleInput(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function newowner(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
