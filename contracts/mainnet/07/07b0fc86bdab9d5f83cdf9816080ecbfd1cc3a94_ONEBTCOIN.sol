...
contract ONEBTCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1 BTCOIN";
    string private _symbol = "1BTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83d0B7126f6C6550d15a6963B3c3c4B9fB4A83a3);
    address payable public teamWalletAddress = payable(0x83d0B7126f6C6550d15a6963B3c3c4B9fB4A83a3);
