...
contract GALATIC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "GALATIC";
    string private constant _symbol = unicode"GLC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0xf638976950131Fa1bB41fdeF33323883e6a86E43);
    address payable public MarketingWallet = payable(0x27a78Ad933C386ad5ECf52CfE641b7d5230E85d9);
