...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4241394f340d992CE164388c21B1EB66eB20b97d; // owner address
...
contract TwicatInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twicat Inu";
    string private _symbol = "$TWICAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4241394f340d992CE164388c21B1EB66eB20b97d); // Marketing Address
    address payable public teamWalletAddress = payable(0x4241394f340d992CE164388c21B1EB66eB20b97d); // Team Address
