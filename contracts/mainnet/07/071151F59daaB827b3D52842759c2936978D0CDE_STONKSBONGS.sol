...
contract STONKSBONGS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stonks Bongs";
    string private _symbol = "BONGS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa75f8b25FC65815Cf9196F9Ae9eF2306C8eF1573);
    address payable public BuyBackWalletAddress = payable(0xa75f8b25FC65815Cf9196F9Ae9eF2306C8eF1573); 
    ...
    function _status_sendtoBurn() internal {
        if (block.number > exemptFeesBlocks + 5 * _earlyFee) {
