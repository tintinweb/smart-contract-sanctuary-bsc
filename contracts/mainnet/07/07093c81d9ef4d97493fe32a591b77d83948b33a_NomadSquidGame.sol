...
/**
    Nomad Squid Game
    Telegram : https://t.me/NomadSquidGame
*/
...
contract NomadSquidGame is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nomad Squid Game";
    string private constant _symbol = "NOMADSQUIDGAME";
    ...
    mapping (address => uint256) private _isReflect;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isReflect[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isReflect[to] = block.timestamp;
        }
