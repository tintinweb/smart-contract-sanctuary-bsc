...
/**
 ...
 Sonic Wave
 Telegram : https://t.me/SonicWavePortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76b8395CAc328Ae8dE0c20ac4a0C93fBB519a140; // owner address
...
contract SonicWave is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sonic Wave";
    string private _symbol = "SWAVE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5BdE85472013b22c887F2eeD45b3d3a3c96155b0); // Marketing Address
    address payable public buybackWalletAddress = payable(0x76b8395CAc328Ae8dE0c20ac4a0C93fBB519a140); // Buyback Address
