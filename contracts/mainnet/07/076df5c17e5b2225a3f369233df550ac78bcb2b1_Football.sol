...
contract Football is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Football";
    string constant _symbol = "Football";
	...
	function getFootballHold(uint256 _maxHold) public view returns(uint256) {
