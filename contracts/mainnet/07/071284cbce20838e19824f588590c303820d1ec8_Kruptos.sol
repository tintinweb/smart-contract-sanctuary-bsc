...
//https://t.me/kruptoswalletchannel
...
contract Kruptos is ERC20, Ownable {
    ...
    constructor() ERC20("Kruptos Wallet", "KRPT") {
        ...
        maxWallet = totalSupply * 1 / 100; // 3% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 100) / 1000; // 1% swap wallet
        ...
        devWallet = address(0x3623AC3551fd78FF1b4960f49604B91C98b20649); // set as dev wallet
