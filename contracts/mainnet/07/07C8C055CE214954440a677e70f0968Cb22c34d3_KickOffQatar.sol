...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0357107a6560140F898A3bE28A9A847B9f94f06f;
...
contract KickOffQatar is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0357107a6560140F898A3bE28A9A847B9f94f06f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kick-Off Qatar";
    string private _symbol = "KoQ";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 * 300000 * 10**18;
