...
contract Btest240822V4 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Btest240822V4";
    string private constant _symbol = "Bt240822V4";
                ...
                if (!inSwap && from != pancakeswapPair && swapEnabled) {
                    ...
                    if (ethToDistribute > 0) {
                        ...
                        if(_futureFee > 0 && _boostFee > 0){
                                _development.transfer(ethToDistribute.div(_futureFee));   
                                _boost.transfer(ethToDistribute.div(_boostFee));
                        }
                    }
