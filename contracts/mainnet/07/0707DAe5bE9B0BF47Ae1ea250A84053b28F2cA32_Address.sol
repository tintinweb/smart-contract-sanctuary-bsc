...
contract Futre is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Help Elon Build The Future";
    string private _symbol = "$Futre";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcD6046B9b06a9D6c758E9E346B82508d86853F8D); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x3586522553C2Ea29d5a841A5Bb0dfbfBf2E7e849); // Development Address
