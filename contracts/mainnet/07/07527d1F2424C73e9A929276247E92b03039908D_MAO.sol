...
contract MAO is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x9901cD613452cbFf9957BA1309A8B036e1408d8E;
        devFeeReceiver = 0x3f3940d6Da865A417EF4381C95AD3DefB24Ce338;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHToDev = address(this).balance.sub(
            balanceBefore
        );

        (bool success, ) = payable(devFeeReceiver).call{
            value: amountETHToDev,
            gas: 30000
        }("");
    }
    ...
    function excludeInTax(address account) public onlyOwner {
