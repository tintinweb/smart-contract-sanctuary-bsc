...
Dedicated to developing an advanced blockchain
(cryptocurrency, non-fungible tokens) build 
and growth service provider, Derra Network
primary services, utilization and integrations
are bound for availability cross-chains: 
Ethereum, Binance smart chain and Polygon 
with extensive options

TG : https://t.me/DerraChain
Beta Testnet: https://testnet-derra.live/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x690B3B1A93D7e3AdA4a8DbFD684Aab86cA2764F1;
...
contract DERRACHAIN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x690B3B1A93D7e3AdA4a8DbFD684Aab86cA2764F1);
    ...
    */
    ...
    string private _name = "DERRACHAIN"; 
    string private _symbol = "DERRACHAIN";  
