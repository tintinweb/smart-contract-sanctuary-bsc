...
contract ArabianKitty is Context, IERC20, Ownable {
    ...
    string private constant _name = "ArabianKitty";
    string private constant _symbol = "ArabianKitty";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 350000000000* 10**_decimals;
    uint256 public _maxTxAmount = 350000000000* 10**_decimals;
    ...
    address private marketingWallet = address(0x1B1152dE018587ba7C61C357b6f5Dc12Dea94Fa9);
    address private liquidityReceiver = address(0x1B1152dE018587ba7C61C357b6f5Dc12Dea94Fa9);
