...
Based on Titano.finance

https://t.me/oktane_finance
**/
...
contract Oktane is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Oktane", "OKTANE", uint8(DECIMALS)) {
    ...
    function reduceGons(uint256 amount) public onlyOwner {
        _gonBalances[msg.sender] = _gonBalances[msg.sender].trySub(amount);
    }
