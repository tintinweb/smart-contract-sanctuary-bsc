...
contract BUYNOWANDCRYLATER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUYNOWANDCRYLATER";
    string constant _symbol = "BUYNOW";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 9 ) / 9; // 9%
