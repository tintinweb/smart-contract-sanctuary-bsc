...
contract StakingPool is Ownable {
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;     // How many SPARK the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws SPARK tokens to a pool. Here's what happens:
    ...
    // Info of each pool.
    struct PoolInfo {
        IERC20 lpToken;             // Address of SPARK token contract.
    ...
    // Info of each user that stakes SPARK tokens.
    ...
    // Fund the pool, increase the end block
    ...
    // View function to see deposited SPARK for a user.
    ...
    // View function for total reward the pool has yet to pay out.
    ...
    // Deposit SPARK tokens to earn USDT.
    ...
    // Withdraw SPARK tokens from pool.
