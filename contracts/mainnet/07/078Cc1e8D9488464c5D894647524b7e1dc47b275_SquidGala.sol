...
Telegram :     https://t.me/SquidGalaBSC
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFf8e1fc3d4e0953Ae5833354C5e14a5bbc5A4A3D;
...
contract SquidGala is Context, IERC20, Ownable {
    ...
    string private constant _name = "SQUID GALA"; // 
    string private constant _symbol = "sGALA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xFf8e1fc3d4e0953Ae5833354C5e14a5bbc5A4A3D);
