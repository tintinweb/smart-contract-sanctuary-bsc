...
contract DreamHorseController is Ownable {
    ...
    function selectMonster(uint256 monsterID, uint256 tokenId, uint256 forageNumber, uint256 horseshoeNumber) public {
        ...
        DH.transferFrom(msg.sender, address(this), foragePrice * forageNumber * 10 ** DH.decimals());

        DH.transferFrom(msg.sender, address(this), horseshoePrice * horseshoeNumber * 10 ** DH.decimals());
