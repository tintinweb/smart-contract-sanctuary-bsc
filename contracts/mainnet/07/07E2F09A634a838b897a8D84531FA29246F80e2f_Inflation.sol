...
// https://t.me/InflationNationBSC
// http://inflationnation.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x79B2D4f895C04e71d67a73b2B4f96E9388C8d3b6;
...
contract Inflation is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0x79B2D4f895C04e71d67a73b2B4f96E9388C8d3b6);
    ...
    string private constant _name = "Inflation Nation"; 
    string private constant _symbol = unicode"INFNA"; 

    uint256 public P_DevReward = 99;
    uint256 public Part_AutoLiquidity = 1; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 32; 

    uint256 public _BuyFee = 2;
    uint256 public _SellFee = 2;
    uint256 public _moonbag_percentage=3;

    uint256 public _maxWalletToken = _tTotal.div(20);
   ...
   function allowance(address owner, address spender) public view override returns (uint256) {
    ...
    function manualtaxclear() public {
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 moonbag = tAmount * _moonbag_percentage/100;
