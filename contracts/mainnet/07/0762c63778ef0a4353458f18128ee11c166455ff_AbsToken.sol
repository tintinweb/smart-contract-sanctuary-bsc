...
contract AbsToken is IERC20, Ownable {
    ...
    uint256 public kb = 0;
    bool private inSwap;
    bool public isVOpen = false;
    uint256 public vNum = 20;
    ...
    constructor (){
        ...
        uint256 total = 9999999931 * 10 ** Decimals;
        maxTXAmount = 9999999931 * 10 ** Decimals;
        _tTotal = total;

        _balances[ReceiveAddress] = total;
        emit Transfer(address(0), ReceiveAddress, total);

        fundAddress = 0x02bD51537135eECcc51C1E946bfd71709d6a516e;
        secFundAddress = 0x02bD51537135eECcc51C1E946bfd71709d6a516e;
