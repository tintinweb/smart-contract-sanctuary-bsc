...
contract Burnacoin is Context, IERC20, Ownable {
    ...
    string private _name = "Burnacoin";
    ...
    address public teamWallet = 0x0C8f8e03CaB51CbAcb5F0F156650A98757f61A28;
    uint256 private _previousteamFee = _teamFee;
    uint256 public _annualburnFee = 10;
    address public annualburnWallet = 0x82f8253f86D20ad7c4ece21e5869aFe2CA319263;
    uint256 private _previousannualburnFee = _annualburnFee;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _burnFee==0 && _teamFee==0 && _annualburnFee==0) return;
        _previousTaxFee = _taxFee;
        _previousDevelopmentFee = _developmentFee;
        _previousLiquidityFee = _liquidityFee;
        _previousBurnFee = _burnFee;
        _previousteamFee = _teamFee;
        _previousannualburnFee = _annualburnFee;
        _taxFee = 0;
        _developmentFee = 0;
        _liquidityFee = 0;
        _burnFee = 0;
    ...
    function restoreAllFee() private {
        ...
        _annualburnFee = _previousannualburnFee;
    }
    ...
    function setannualburnWallet(address newWallet) external onlyOwner() {
        annualburnWallet = newWallet;
    }
    function setteamFeePercent(uint256 teamFee) external onlyOwner() {
        _teamFee = teamFee;
    }
     function setbpaFeePercent(uint256 bpaFee) external onlyOwner() {
        _annualburnFee = bpaFee;
    }   
}