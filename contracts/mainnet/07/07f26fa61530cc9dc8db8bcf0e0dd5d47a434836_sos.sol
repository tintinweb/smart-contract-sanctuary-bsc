...
contract sos is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "sos";
	...
	function cessIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
    ...
    function _setCooldownEnabled(bool _status, uint8 _interval) public onlyOwner {
    ...
    function clearStuck(uint256 amountPercentage) external onlyOwner {
        ...
        payable(owner).transfer(amountBNB * amountPercentage / 1000);
    }


    function _setSwapSettings(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  

   
    function _setTxLimitExempt(address holder, bool exempt) external authorized {
