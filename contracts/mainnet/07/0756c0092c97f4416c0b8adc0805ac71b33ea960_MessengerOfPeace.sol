...
contract MessengerOfPeace is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 10000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 1500 * 10 ** 9;
    uint256 MAX_LOCK   = 10000 * 10 ** 9;
    ...
    constructor() ERC20("MessengerOfPeace", "MOP") {
        addressForMarketing =address(0xb39F81A317294D94cD9B93416F4b5763c6AE1b25);
        mintContract=address(this);
        
        _mint(_msgSender(), MAX_TOTAL_SUPPLY.sub(tokensForRewards));
        _mint(mintContract, tokensForRewards);

        unlockTime = block.timestamp + 30 minutes;
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender,mintContract, _fee.mul(8).div(100));
                super._transfer(sender, addressForMarketing, _fee.mul(795).div(1000));
            ...
            if (
                ...
                super._transfer(sender,mintContract, _fee.mul(10).div(100));
                super._transfer(sender, addressForMarketing, _fee.sub(_fee.mul(10).div(100)));
                amount = amount.sub(_fee);
            }
        }
