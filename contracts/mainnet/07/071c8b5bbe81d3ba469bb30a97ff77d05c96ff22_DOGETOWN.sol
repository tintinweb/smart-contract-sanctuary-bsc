...
contract DOGETOWN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xb7Aaeceb1ec73587313E65F69467cdC3Cbe70a8C;
    address public devWallet = 0x67eF049952801F2ec4F514f9AEa1D66Fe8A215D2;

    string private constant _name = "DogeTown";
    string private constant _symbol = "DTN";
    ...
    Taxes public taxes = Taxes(1, 8, 2, 1);
    Taxes public sellTaxes = Taxes(1, 8, 2, 1);
