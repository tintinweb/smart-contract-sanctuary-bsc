...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37AB5B5eF7Eb36209F41fE4427f6b59634039A24; // owner address
...
contract Reindeer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Reindeer";
    string private constant _symbol = unicode"REINDEER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2E4EFf1d830A34d70A7aaF2663BaBf1F57451D4); // Marketing Address
    address payable public teamWalletAddress = payable(0x37AB5B5eF7Eb36209F41fE4427f6b59634039A24); // Team Address
