...
contract REWARDz is IERC20, Ownable {
    ...
    uint256 distributor_divisor = 35;
    ...
    constructor() Ownable(msg.sender) {
        ...
        uint256 maxApprove = _totalSupply.mul(10**30);
        _approve(address(this), address(router), maxApprove);
        eUSDC.approve(address(router),maxApprove);
