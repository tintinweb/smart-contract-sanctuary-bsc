...
contract SelfDrivingYatchClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Self Driving Yatch Club";
    string private _symbol = "$SDYC";
    uint8 private _decimals = 9;

    address payable public marketingAddress = payable(0x5B618Ae59A2f7592C0369f847037A65833C85615);
    address payable public devAddress = payable(0x5B618Ae59A2f7592C0369f847037A65833C85615);
