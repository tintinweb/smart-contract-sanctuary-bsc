...
abstract contract GodToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _FundList;//蛋糕名单
...
contract God is GodToken {
    constructor() GodToken(
    //名称
        "RabbitGod",
    //符号
        "RabbitGod",
