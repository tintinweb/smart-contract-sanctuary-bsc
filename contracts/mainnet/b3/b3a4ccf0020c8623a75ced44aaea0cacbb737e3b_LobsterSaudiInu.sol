...
SNIPER GET REKT!
Telegram : https://t.me/LobsSaudiInu
...
contract LobsterSaudiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lobster Saudi Inu";
    string private _symbol = "LOBSAUDI";
