...
contract BillgateToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20FlashMint {
    constructor() ERC20("Billgate", "BGT") {
        _mint(msg.sender, 547580 * 10 ** decimals());
    }
