...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3cb8d734e4a4c6EC07e648aB8c2EC50caA14e301;
...
contract SFM4 is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletTokens = 10000000000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; //
    string private constant _name = "400 SAFEMOON"; // 
    string private constant _symbol = "400 SAFEMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x1228EF853afaD7C040A60d2f2813BaC0b4aFCD55);
