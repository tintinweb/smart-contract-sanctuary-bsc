...
contract BiggestBuyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Biggest Buy Inu";
    string private constant _symbol = "BigBuyInu";
