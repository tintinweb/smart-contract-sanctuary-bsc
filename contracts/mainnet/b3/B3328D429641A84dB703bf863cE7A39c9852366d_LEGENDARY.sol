...
TEAM LAST PROJECT 250K MC

💎LEGENDARY BULL COIN INU💎

💎LBCI is a fully decentralized and community driven meme token on the bsc network that provides great rewards for its holders
...
20K START MARKETING STRONG GROUND NO JEET

Telegram Chat: https://t.me/legendarybullcoin_inu - TEAM LAST PROJECT 250K MC
...
contract LEGENDARY is Context, IERC20, Ownable {
    ...
    string private constant _name = "LEGENDARY BULL COIN INU"; //
    string private constant _symbol = "LBCI"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xF19Bd7b9228c8f8A2D9C0703cB2FcCE23B04c5AB ;
