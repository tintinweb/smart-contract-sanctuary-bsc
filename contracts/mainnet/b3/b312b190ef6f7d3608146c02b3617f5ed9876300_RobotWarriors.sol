...
contract RobotWarriors is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9221bb87EA209c82fcE204d124a6cB2156816c00); // Marketing Address
    ...
    string private _name = "Robot Warriors";
    string private _symbol = "METABOT-V2";
