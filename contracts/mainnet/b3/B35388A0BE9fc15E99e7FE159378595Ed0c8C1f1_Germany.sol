...
contract Germany is ERC20 {
	...
	address _fundAddress = address(0xD875d7E5727205bB448E762654501AD21904e81D);
    ...
    constructor(address tokenOwner) ERC20("Germany 2.0", "Germany 2.0") {
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			super._transfer(from, address(this), amount.div(1000).mul(15));
