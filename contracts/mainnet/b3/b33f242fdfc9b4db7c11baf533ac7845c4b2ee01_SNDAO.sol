...
contract SNDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SN DAO";
    string private _symbol = "SN-DAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xBacAF21a3B5c723F8366E1a56c82b4A29B822c38); 
    address payable private teamWalletAddress = payable(0xAb0D3320C0CDa2a97fd56Cc0E119DD43884606db); 
