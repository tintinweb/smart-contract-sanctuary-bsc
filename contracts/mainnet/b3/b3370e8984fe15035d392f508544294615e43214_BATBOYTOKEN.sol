...
contract BATBOYTOKEN is IBEP20, Auth {
    ...
    uint256 public _maxTxAmountBuy = _totalSupply * 2 / 1000; // 0.2%
    uint256 public _maxTxAmountSell = _totalSupply * 2 / 1000; // 0.2%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 1000; // 0.2%
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xf308DAF0cF22e9dDcd5F0FE6459AEDe124E201c2;
        marketingFeeReceiver = 0xC9c649D0098d3480E7AA44102131e53fA6bec84c;
        devFeeReceiver = 0x2563d2382Fc12153fC7afd09BE436D955b007068;
