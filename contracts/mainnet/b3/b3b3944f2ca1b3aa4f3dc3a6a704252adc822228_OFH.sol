...
contract OFH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OFH COIN";
    string private _symbol = "OFH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d1176beA2cb22f0A3811B251c3d254Cc7cB30Ed);
    address payable public teamWalletAddress = payable(0x5d1176beA2cb22f0A3811B251c3d254Cc7cB30Ed);
