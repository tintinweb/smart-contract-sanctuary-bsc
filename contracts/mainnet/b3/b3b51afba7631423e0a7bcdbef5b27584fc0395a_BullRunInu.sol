...
contract BullRunInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BullRunInu";
    ...
    constructor () {
        _MarketingWallet = payable(0x7B60A4De15E34660CB71ED4230189D8E63868095);
        _liquidityWallet = payable(0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5);
        _DevWallet = payable(0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5);
        ...
        emit Transfer(address(0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5), _msgSender(), _tTotal);
    }
    ...
    function _takeFees(address sender, uint256 amount, bool isSell) private returns (uint256) {
        ...
        tokensForMarketing += fees * MarketingFee.div(2) / _totalFees;
