...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 //file: test.sol
contract TheDaleks is ERC20, Ownable {
    ...
    constructor() ERC20("The Daleks", "DLK") 
    {
        ...
        setSellTax(8); // set initial tax value here
        setTaxWallet(address(0x8424Ded6D78b5e34C8FbE030bEca34AE0dd93483)); //set your wallet here
    ...
    */
    ...
    function setSellTax(uint256 _newSellTax) public onlyOwner {
        require (_newSellTax <= 8, "Max Sell Tax Limit is 8%");
