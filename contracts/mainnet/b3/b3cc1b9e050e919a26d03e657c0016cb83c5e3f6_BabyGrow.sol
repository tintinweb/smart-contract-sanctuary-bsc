...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF097abe838F72182Bf6812aC8c4697686ACFd318; // owner address
...
contract BabyGrow is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x930aEBEDa8911ac561264c939a577015765215e0); // Marketing Address
    address payable public teamWalletAddress = payable(0x930aEBEDa8911ac561264c939a577015765215e0); // Team Address
