...
contract THORINUTOKEN is Context, IERC20, Ownable, IERC20Metadata {
    ...
    address payable private _devAddress =
        payable(0x66a4b9a21B402B395254EA5C1c7d640644788888);
    address payable private _marketingAddress =
        payable(0x66a4b9a21B402B395254EA5C1c7d640644788888);
    address payable private _charityWallet =
        payable(0xe1cAB24E2C56Cd8fE25b276E53b7E7C910Cf523A);
    ...
    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer(amount.mul(80).div(100));
        _charityWallet.transfer(amount.mul(20).div(100));
        _marketingAddress.transfer(amount.mul(0).div(100));
    }
    ...
    function setFee(
        ...
        require(redisFeeOnBuy < 16, "Redis cannot be more than 15");
        require(redisFeeOnSell < 16, "Redis cannot be more than 15");
        require(taxFeeOnBuy < 16, "Tax cannot be more than 15");
        require(taxFeeOnSell < 16, "Tax cannot be more than 15");
