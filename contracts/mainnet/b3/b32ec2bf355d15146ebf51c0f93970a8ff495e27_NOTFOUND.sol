...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = " SCARY MUDRA ";
    string private _symbol = " 404NOTFOUND ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0448C210274dbf56016691d634be90a217fc5B99);
    address payable public teamWalletAddress = payable(0x0448C210274dbf56016691d634be90a217fc5B99);
    ...
    uint256 public _maxTxAmount = 1 *  20000 * 10**_decimals; 
    uint256 public _walletMax = 1 * 20000 * 10**_decimals;
