...
abstract contract Ownable {
    ...
    contract BlueBird is Ownable, IBEP20{
    ...
    function symbol() external pure override returns (string memory){return "BlueBird";}
    function name() external pure override returns (string memory){return "BlueBird";}
    ...
    constructor(){
       ...
       addTokens(msg.sender,InitialSupply*9999/10000);
       addTokens(address(0xdead),InitialSupply/10000);
        emit Transfer(address(0),address(0xdead),InitialSupply/10000);      
       emit Transfer(address(0),msg.sender,InitialSupply*9999/10000);
