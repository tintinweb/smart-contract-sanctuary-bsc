...
contract Sfm2ndBday is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public currentMaxSupply = 3232;
  uint256 public finalMaxSupply = 3232; 
  ...
  constructor(
  ) ERC721A("Happy 2nd Birthday Safemoon", "BDAY") {
