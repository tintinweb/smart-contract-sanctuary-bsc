...
/**
 * @dev contract of the Ghostrunner including 5% fund autotransfer to USDT
 */

contract Ghostrunner is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4999 * 10**6;
    string private _name = "Ghostrunner";
    ...
    address public devAddress = address(0xd98C72d6c2bCD23f4BD929DdD0d6B02f89FB23b2);
