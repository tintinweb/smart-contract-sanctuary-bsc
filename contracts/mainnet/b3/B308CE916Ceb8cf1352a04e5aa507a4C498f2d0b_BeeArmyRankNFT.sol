...
contract BeeArmyRankNFT is ERC721Enumerable {
    ...
    constructor() ERC721("Bee Army Rank NFT", "BeeArmyRankNFT") {
        admin = 0x379DC00C911960F7F4223115dCCC46D8dA29D9B6;
    }
    ...
    function firstMint() external {
        require(balanceOf(msg.sender) == 0,"already has nft");
        _mint(msg.sender,tokenId);
        tokenId++;
        emit mintNew(msg.sender, tokenId);
    }
    function _baseURI() override internal view virtual returns (string memory) {
        return "https://beesale.finance/nft/beearmyranknft/";
    }
