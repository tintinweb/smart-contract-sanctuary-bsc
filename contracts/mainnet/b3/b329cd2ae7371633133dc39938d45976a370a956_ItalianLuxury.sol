...
contract ItalianLuxury is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;

    string private _name = "Italian Luxury";
    string private _symbol = "ITA";
    ...
    uint256 public lotteryPoolFee = 100;
    uint256 public nftRoyalPoolFee = 0;
    uint256 public burnFee = 100;
    uint256 public taxFeeTotal =500;

    uint256 public feeTotal;
    address public teamWallet;
    //@dev can be configured. 
    address public distributionWallet= 0xDB997F6E8a364Ed05b7844C2dC69bAE28c863EAf;
    address public nftRoyalPoolWallet=0x8BcCB59c444fEd9b303e43fc4DfD6b34FC401f3b;
    address public lotteryPoolWallet=0x8BcCB59c444fEd9b303e43fc4DfD6b34FC401f3b;
    ...
    uint256 public maxTxAmountPercentage = 150000;
    uint256 public maxTxAmount =
        _tokenTotal.mul(maxTxAmountPercentage).div(10000); // 15%
