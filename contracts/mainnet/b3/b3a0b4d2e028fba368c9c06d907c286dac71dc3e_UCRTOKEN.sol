...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9c0C8c2acCbE46F85C02dB1fe2356690aAc52983; // WHALES
...
contract UCRTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Uncle Rabbit Token";
    string private _symbol = "UCR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9c0C8c2acCbE46F85C02dB1fe2356690aAc52983); // whales
    address payable public teamWalletAddress = payable(0x9c0C8c2acCbE46F85C02dB1fe2356690aAc52983); // whales
