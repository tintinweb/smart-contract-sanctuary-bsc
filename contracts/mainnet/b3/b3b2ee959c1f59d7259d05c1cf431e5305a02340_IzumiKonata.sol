...
/**
Izumi Konata(泉こなた) 
The main character of the Lucky Star series. An eccentric but friendly person, the next gem on Binance Smart Chain.
Telegram: https://t.me/izumikonatabsc
*/
...
contract IzumiKonata is Context, IERC20, Ownable {
    ...
    string private constant _name = "Izumi Konata";
    string private constant _symbol = "Izumi";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x97424C13c016d2D1AB4Ce024D295415343316771;
