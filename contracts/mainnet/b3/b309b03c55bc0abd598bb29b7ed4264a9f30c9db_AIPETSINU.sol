...
contract AIPETSINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI PETS INU"; // 
    string private constant _symbol = "AIPETSINU"; //    
