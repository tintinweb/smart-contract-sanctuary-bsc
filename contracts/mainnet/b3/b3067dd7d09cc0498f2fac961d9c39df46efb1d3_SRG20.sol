...
/**
    Surge Protcol was was built by a team of gigabrains that will change the future of crypto.
    As a result, Heisen Inu was developed to pay tribute to @Heisenman, one of the Surge Protocol creators.
    
    Heisen Inu is a 5% tax token that rewards holders with 3% $SRG Rewards.
    Funds are SAFU due to SRG20 technology which stores the liquidity directly in the contract.

    This token is not tradable via PancakeSwap or PooCoin.

    <<< Please buy tokens ONLY via https://swap.surgeprotocol.io/ or directly on BSCscan >>>

    Twittter: https://twitter.com/HeisenSurge
 */
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "Heisen Inu";
    ...
    //Tax wallets
    address public teamWallet = 0x9721eA17fB547C3a69b05c8686D95d3347f5e585;
    address public treasuryWallet = 0x9721eA17fB547C3a69b05c8686D95d3347f5e585;

    // Tax Split
    uint256 public teamShare = 40;
    uint256 public treasuryShare = 0;
    uint256 public rewardShare = 60;
    ...
    //trading parameters
    uint256 public liquidity = 7 * 10**5 * 10**_srgDecimals;
