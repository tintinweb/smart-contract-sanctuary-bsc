...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = "Decentralized Freedom Token";
    ...
    address public MarketingWallet = 0x04c37C11412bd7eAb0102511a1e071B5128952e1; //2% for marketing 
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _charityFee = 4;
    address public CharityWallet = 0x62E305078792E2De67cc45726Be4fB6BEDA31983; 
    ...
    uint256 public _maxTxAmount = 75000000  * 10**9; //1% of total supply   //ANTIDUMP
    uint256 private numTokensSellToAddToLiquidity = 2430  * 10**9;
    uint256 public _maxWalletToken = 75000000  * 10**9;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     //to recieve BUSD from uniswapV2Router when swaping
