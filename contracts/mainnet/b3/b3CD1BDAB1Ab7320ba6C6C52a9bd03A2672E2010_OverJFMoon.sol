...
contract OverJFMoon is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x5fAc926Bf1e638944BB16fb5B787B5bA4BC85b0A); //Reward ETH
    ...
    uint256 public _maxWalletAmount = 10000000000000000 * (10**18);
    bool public isL;
    uint256 public killNum = 0;
    uint256 public lunachB;

    address public _marketingWalletAddress = 0xD1334140D03d867418eFa3500C07c0931747e824;
    ...
    constructor() public ERC20("OverJFMoon", "OverJFMoon") {
