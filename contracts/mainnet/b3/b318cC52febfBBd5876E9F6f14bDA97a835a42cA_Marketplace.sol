...
contract Marketplace is Ownable, AccessControl {
    ...
    constructor() {
        _grantRole(DEFAULT_ADMIN_ROLE, 0xb6e1cAB7a9E3032A397278C7767916E15C46488a);
        _grantRole(ADMIN_ROLE, 0xb6e1cAB7a9E3032A397278C7767916E15C46488a);
        _transferOwnership(0xb6e1cAB7a9E3032A397278C7767916E15C46488a);
    ...
    function enablePublicMint() external onlyOwner {
        require(whitelistPresale, "Marketplace: enable WL mint first");
