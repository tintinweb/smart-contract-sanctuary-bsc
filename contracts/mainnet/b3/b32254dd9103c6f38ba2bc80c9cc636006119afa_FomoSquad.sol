...
contract FomoSquad is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fomo Squad"; // 
    string private constant _symbol = "FOMO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x776551d9eD431c06ADe26b0a1C5586740513c348;
