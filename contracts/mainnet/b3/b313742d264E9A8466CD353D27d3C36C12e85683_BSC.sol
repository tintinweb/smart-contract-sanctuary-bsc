...
contract BSC is Context, IERC20, Ownable {
    ...
    string private _name = "\u674e\u6613\u5cf0\u505a\u7231";
    string private _symbol = "\u674e\u6613\u5cf0\u505a\u7231";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xFA0F2B213f0582Cf0fCd6E057bF1cc94D75EFa6C);
    address public marketingWalletToken = 0xFA0F2B213f0582Cf0fCd6E057bF1cc94D75EFa6C;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 30 * 10**9 * 10**_decimals;
