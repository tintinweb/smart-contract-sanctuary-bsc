...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x05723E70ac5aEDF7f615d14A9a003893C24c6EEb; // owner address
...
contract ManyZeros is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Many Zeros";
    string private _symbol = "MZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3E56552046325eEb7bDf1f90C63Bd243Ec7d4862); // Marketing Address
    address payable public teamWalletAddress = payable(0x4242E87811569a8D2322DC3819De2D870Ad47306); // Team Address
