...
contract Saudoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudoge";
    string private _symbol = "$Saudoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x845e91210eEe19256EE134670018D98E841dbeb7); // Marketing Address
