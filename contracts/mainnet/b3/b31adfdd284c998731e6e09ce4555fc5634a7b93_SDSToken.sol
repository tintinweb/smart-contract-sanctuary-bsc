...
contract SDSToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceDogeShark";
    string private _symbol = "SpaceDogeShark";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xbc015B718bc4BB3D5003FCb7aCD81d744D0a1f64); 
    ...
    uint256 private _totalSupply = 10 *  10**20 * 10**_decimals;
