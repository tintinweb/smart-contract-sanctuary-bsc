...
contract TeenSpiritCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC4863C66E8F0045a2A826197f93315D199304607); 
    address payable public Wallet_Dev = payable(0x33fc21a32036Bbb02F5AD7c4B32b87E5a127F1aF);
    ...
    string private constant _name = "Teen Spirit Coin"; 
    string private constant _symbol = unicode"$TESPCO"; 
    ...
    uint256 public Percent_1xbet = 70;
    ...
    constructor () {
        ...
        _owner = 0x33fc21a32036Bbb02F5AD7c4B32b87E5a127F1aF;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_M = contractTokenBalance * Percent_1xbet / 100;
            ...
            uint256 split_M = Percent_1xbet * 100 / (Percent_AutoLP + Percent_1xbet + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Percent_AutoLP + Percent_1xbet + Percent_Dev);
