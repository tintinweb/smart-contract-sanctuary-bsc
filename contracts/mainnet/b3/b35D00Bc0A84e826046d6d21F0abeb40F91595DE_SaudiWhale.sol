...
contract SaudiWhale is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd47d96E7a6526f659eBcFce8FCC9911F03868D06); 

    address payable public Dev_Wallet = payable(0x2f278Fb8358EB7Ff54eEAaC306797e091ACDD099);
    ...
    string private constant _name = "Saudi Whale"; 

    string private constant _symbol = unicode"Saudi Whale"; 
    ...
    constructor () {
        ...
        _owner = 0x2f278Fb8358EB7Ff54eEAaC306797e091ACDD099; //DEV WALLET
