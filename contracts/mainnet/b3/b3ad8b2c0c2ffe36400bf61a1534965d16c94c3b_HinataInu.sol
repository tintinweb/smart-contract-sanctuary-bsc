...
ANTIBOT
BLACKLIST
 Telegram - https://t.me/HinataInuPortal
...
/* Token contract */
contract HinataInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xeD5D5f65620c4c7d05956Ff0970d2F6c6f981Bf6;
    ...
    // Name and symbol
    string constant _name = "HinataInu";
    string constant _symbol = "HinataInu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // .5% or 50M tokens on launch
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // .5% or 50M tokens on launch
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 10000; // .5% or 50M tokens on launch
