...
contract BaseToken is Ownable {
    ...
    string constant public name = 'ESHARE';

    string constant public symbol = 'ESHARE';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 25549*10**uint256(decimals);
