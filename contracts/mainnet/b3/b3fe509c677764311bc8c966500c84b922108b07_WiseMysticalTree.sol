...
https://t.me/wisemysticaltreeportal
Tax 10/10
2 liq
8 marketing
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB4203E837757265e26d6c42afd2Da509104D25d8; // owner address
...
contract WiseMysticalTree is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wise Mystical Tree";
    string private _symbol = "$WMT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf79a32A01fcd0cb6D93aA1db751093ABA1634d54); // Marketing Address
    address payable public teamWalletAddress = payable(0xf79a32A01fcd0cb6D93aA1db751093ABA1634d54); // Team Address
