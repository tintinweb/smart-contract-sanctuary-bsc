...
*/
 ...
 /** https://t.me/BokugrowBSC
 
    Bokugrow is a self-created anime token. For all anime fans we have big surprises. 
    You can expect new characters as NFTs, a limited manga as an ebook and a secret utility

    Miku (ミク) Deployer
    Community cooperation is the key as proven in my previous project. 
...
contract BOKUGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "BOKUGROW";
    ...
    address private marketingWallet = address(0x9ae23319fE1Cb893aFCD81df7E78c7E0C2F3e827);
    address private liquidityReceiver = address(0x9ae23319fE1Cb893aFCD81df7E78c7E0C2F3e827);
