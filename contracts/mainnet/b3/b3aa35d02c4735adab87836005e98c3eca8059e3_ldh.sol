...
contract ldh is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"刘德华";
    string private _symbol = unicode"刘德华";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F77854630100EE2051446F0A72cAa399d507b55);
    address payable public teamWalletAddress = payable(0x8F77854630100EE2051446F0A72cAa399d507b55);
