...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0B6634FcbaD10cD034a278db48984CC445D34094;
...
contract XMAS is Context, IERC20, Ownable {
    ...
    string private _name = "413XMAS";
    string private _symbol = "413XMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B6634FcbaD10cD034a278db48984CC445D34094);
    address payable public teamWalletAddress = payable(0x0B6634FcbaD10cD034a278db48984CC445D34094);
