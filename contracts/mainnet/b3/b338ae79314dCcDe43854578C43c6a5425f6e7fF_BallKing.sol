...
contract BallKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address[2] memory addrs, // router, shell
        address _owner
    ...
    function _transfer(
        ...
        // LP Process
        if(IERC20(address(this)).balanceOf(address(this)) >= minEthVal && !swapping && from != address(this)) {
