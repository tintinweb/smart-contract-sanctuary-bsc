...
contract McGrow is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**6 * 10**6;
    uint256 public _maxWalletAmount = _tTotal;
    uint256 public _maxTxAmount = _tTotal;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9 * 10**9;
    string private constant _name = "McGrow 2.0";
    string private constant _symbol = "McG2.0";
