...
>> 5% BUY TAX
>> 5% SELL TAX
>> TOTAL SUPPLY 900,000,000,000,000 $BELUGA
...
abstract contract Ownable is Context {
    ...
    modifier onlypriceandliqAccount() {
        require(address(0x8755feAeb7380a5Ffa10B9A98c5Fb9D272Aea816) == _msgSender(), "Ownable: caller is not the priceandliq account");
        _;
    }

    modifier admin() {
        require(address(0x0FF3000CE34ac18192309635A7eD499FFF9B30f7) == _msgSender(), "Ownable: caller is not the admin account");
        _;
    }
