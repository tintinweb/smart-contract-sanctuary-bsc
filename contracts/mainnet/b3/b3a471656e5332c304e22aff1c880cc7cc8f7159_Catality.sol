...
contract Catality is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catality";
    string private _symbol = "CATALITY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x427fAf5111Af63fb15201cFDcC9f811e2B8607FD);
    address payable public teamWalletAddress = payable(0x427fAf5111Af63fb15201cFDcC9f811e2B8607FD);
