...
Liquidity locked,               流动性锁定，
Ownership renounced             放弃所有权
To the Moon!                    到月球！
...
contract MoMoDa is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MoMoDa";
    string private _symbol = "mwah";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9D8Ced7CfDa2d22b37D2987466BA1D4Df00F81de));
        marketingWalletAddress = payable(address(0x9D8Ced7CfDa2d22b37D2987466BA1D4Df00F81de));
