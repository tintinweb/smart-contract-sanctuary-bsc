...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2D4D417357AeD9F1049997bbed94d6140707C59a;
...
contract Ernota is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 99999 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ernota";
    string private _symbol = "ERTA";
    ...
    uint256 public _maxTxAmount = 99999 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 99999 * 10**8;
