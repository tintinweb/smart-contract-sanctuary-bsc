...
// File: NodeFather/interfaces/IPancakePair.sol
...
// File: NodeFather/interfaces/IUniswapV2Factory.sol
...
// File: NodeFather/interfaces/IUniswapV2Router02.sol
...
contract BUCKS is  ERC20, AccessControl, ReentrancyGuard, Pausable {
  /** CONSTANTS **/
  ...
  uint256 public sellingFeeNonClaimed = 900; // (/1000)
  ...
  constructor(address _pancakeRouter, address payable _feeSafe) ERC20("Pure", "PURE") { // TODO
