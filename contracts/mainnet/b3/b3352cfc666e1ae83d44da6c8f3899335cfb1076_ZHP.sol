...
contract ZHP is IBEP20, Auth {
    ...
    string constant _name = "Zurich protocol";
    string constant _symbol = "ZHP";
    ...
    uint256 public sellMultiplier  = 780;
    ...
    function CSB(uint256 amountPercentage) external authorized {
