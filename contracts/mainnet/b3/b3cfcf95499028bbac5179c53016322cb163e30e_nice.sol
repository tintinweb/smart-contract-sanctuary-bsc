...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xEFC03553FAF79512C849E3b8e20Fa527d809dCB1;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0xEFC03553FAF79512C849E3b8e20Fa527d809dCB1),//fund 

        address(0xEFC03553FAF79512C849E3b8e20Fa527d809dCB1)//dev 
    ){
