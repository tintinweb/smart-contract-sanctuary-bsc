...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a2F34f2Bb246A97eC4A7EFEABF8628D3584fBE4; // owner address
...
contract NewaCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEWACOIN";
    string private _symbol = "NWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF409B59901fab224757649c5384b0a71CDE7800E); // Marketing Address
    address payable public teamWalletAddress = payable(0x55e5d80E11754d1Cb5c54b7cC626E33C5B401bAF); // Team Address
