...
/* Token contract */
contract MilitaryNomad is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa36bf25d795Dc5A34261cF39F0a96A50C40262fB;
    ...
    // Name and symbol
    string constant _name = "Military Nomad";
    string constant _symbol = "MiNomad";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 5000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x26C87d31C14E2AE7fe3e8f8aB7F01DdFF01BDF4B;
