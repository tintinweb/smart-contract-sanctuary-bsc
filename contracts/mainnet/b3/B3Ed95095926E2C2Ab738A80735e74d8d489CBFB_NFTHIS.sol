...
contract NFTHIS is NFTHISDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NFTHISTeam;
    address private CharityNFTHIS;
    ...
    string public override name = "NFTHIS";
    string public override symbol = "NFTHIS";
    ...
    constructor(uint totalSupplyValue, address NFTHISTeamAddress, address CharityNFTHISAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NFTHISTeam = NFTHISTeamAddress;
        CharityNFTHIS = CharityNFTHISAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NFTHISTeam] =  totalSupply * 4 / 100;
        balances[CharityNFTHIS] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's NFTHISTeam pot
