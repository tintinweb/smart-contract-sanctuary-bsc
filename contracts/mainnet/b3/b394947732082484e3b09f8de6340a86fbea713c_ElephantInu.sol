...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb153442939742573980695c9Fe8ce97338B99D6E;
...
contract ElephantInu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x8f8efB511c74E5a1C1BC4CE1ACEDCE9Bc6eb7d1e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Elephant Inu";
    string private _symbol = "Elephant Inu";
