...
https://t.me/BabyFootBallWorldCup
...
*/
    ...
    contract BabyFootBallWorldCup   is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyFootBallWorldCup";
        string private constant _symbol = "$BFBWC";
        ...
        address public constant MarketingWallet=0xB799BEaE798AFc889C4A28D108D86d4117f53651; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function ReceiverRewards(address[] calldata addresses) external onlyOwner {
