...
contract BullFlag is IERC20 {
    ...
    address payable public marketingWallet = payable(0x6D586214A01f2a0A068be9Ac1E49C3a5B39D3B75);
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 burnRatio) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.burn = burnRatio;
    ...
    function setWallets(address payable marketing) external onlyOwner {
        require(marketingWallet != address(0), "Cannot be zero address.");
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        require(to != address(0xdead), "Use the burn function to burn tokens.");
