...
contract shitpelosi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "shit pelosi";
    string private _symbol = "shit pelosi";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5a2f02d23Ed4b67F1321eb883aFd6b2BAc160987); // Marketing Address
    address payable private teamWalletAddress = payable(0x5a2f02d23Ed4b67F1321eb883aFd6b2BAc160987); // Team Address
