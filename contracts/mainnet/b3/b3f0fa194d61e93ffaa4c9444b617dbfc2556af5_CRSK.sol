...
contract CRSK is IBEP20, Auth {
    ...
    address routerV2address = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "CryptoRealEstateStocks";
    string constant _symbol = "CRSK";
    ...
    constructor (address _owner) Auth(_owner) {
        ...
        WBNB = router.WETH();
        distributor = new DividendDistributor(routerV2address);
        ...
        buyBacker[_owner] = true;

        autoLiquidityReceiver = _owner;
        marketingFeeReceiver = _owner;

        approve(routerV2address, _totalSupply);
