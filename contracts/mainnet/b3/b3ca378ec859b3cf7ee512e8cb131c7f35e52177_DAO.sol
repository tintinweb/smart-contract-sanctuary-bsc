...
contract DAO is Context, IERC20, Ownable {
    ...
    string private _name = "BSC-MOON";
    string private _symbol = "BSC-MOON";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xca285976a9346F63D54673E79710f7D5dB1EBB93); 
    address payable private teamWalletAddress = payable(0x3272dA6F366FDeA50B15113628149180DC8343BE); 
