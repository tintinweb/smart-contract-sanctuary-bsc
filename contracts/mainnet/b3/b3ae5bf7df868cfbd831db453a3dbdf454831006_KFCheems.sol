...
First Dog + food meme coin 

We are a meme + charity + utility project aimed at providing food for the poor…

With KFC already tweeting our name, we aim to create an awareness among kfc lovers and to inspire our investors into feeding the poor
...
contract KFCheems is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'KFCheems';
    ...
    //DevWallets
    address public MarketingWallet=payable(0xd2547C20815897ED723Bf617787cd8C7e5EAbe1d);
    address public Development=payable(0x8c68d70a36EAFE8296eD7B228Cd1F71499E47fCe);
    //TestNet
