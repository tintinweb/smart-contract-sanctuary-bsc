...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc39bED3B41879bdff505D3F870b1f7fB544ddB91; // owner address
...
contract SHIMAINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc39bED3B41879bdff505D3F870b1f7fB544ddB91); // Marketing Address
    address payable public teamWalletAddress = payable(0xc39bED3B41879bdff505D3F870b1f7fB544ddB91); // Team Address
