...
contract SHIBSNAKESPACE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIB SNAKE SPACE"; // 
    string private constant _symbol = "SSS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xe9f2948ecfbefab8dbe9A7a1080caaAFAAb4797B;
