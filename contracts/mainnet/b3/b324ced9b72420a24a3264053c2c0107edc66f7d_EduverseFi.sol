...
TELEGRAM : https://t.me/eduversefi
WEBSITE  : https://eduversefi.com/
...
contract EduverseFi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EduverseFi";
    string private _symbol = "EVF";
