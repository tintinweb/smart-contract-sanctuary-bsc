...
/**
 ----------------------------------------------------------------------------------------------------------------
Welcome 
is a degen token with a bullish drive led by community.
...
Max Wallet & TX: 1%
Buy/Sell Tax: 9/9 at launch. Funds will be used for buybacks and calls.
Breakdown: (6% marketing, 2% liquidity , 1% Development)
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49257694F8A53aE1D7892e8c72A65D679Aca3b46; 
...
contract Bambaa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "bambaa";
    string private constant _symbol = unicode"bamba1";
    uint8 private _decimals = 9;

    mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x49257694F8A53aE1D7892e8c72A65D679Aca3b46); // Marketing Address
    address payable public teamWalletAddress = payable(0x49257694F8A53aE1D7892e8c72A65D679Aca3b46); // Team Address
