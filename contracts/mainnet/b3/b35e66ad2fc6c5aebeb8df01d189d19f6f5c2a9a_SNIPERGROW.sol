...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  MUU = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MUU.balanceOf(address(this));
        ...
        uint256 amount = MUU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MUU.transfer(shareholder, amount);
...
/* Token contract */
contract SNIPERGROW is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address MUU = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x74873C7F42D3Fcf5402C0E0Fcd0a2640803Ba6F9;
    ...
    // Name and symbol
    string constant _name = "SniperGrow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // .1% 
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // .1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x74873C7F42D3Fcf5402C0E0Fcd0a2640803Ba6F9;
