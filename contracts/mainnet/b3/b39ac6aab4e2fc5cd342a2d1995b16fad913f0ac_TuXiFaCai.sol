...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59627EbC15b33240f9151628d0C00fed6817D826; // WHALES
...
contract TuXiFaCai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tu Xi Fa Cai";
    string private _symbol = "TXFC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59627EbC15b33240f9151628d0C00fed6817D826); // whales
    address payable public teamWalletAddress = payable(0x59627EbC15b33240f9151628d0C00fed6817D826); // whales
