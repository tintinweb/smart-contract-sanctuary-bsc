...
/**
  ...
  More information :
🌐 https://justpumpit.io/
🗳️ https://t.me/JustPumpItBsc
🕊️ https://twitter.com/justpumpitcoin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9aC4b415209956767a87BbE05F4138F9E17aA443; 
...
contract JustPumpIt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Just Pump It.";
    string private _symbol = "JPI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9aC4b415209956767a87BbE05F4138F9E17aA443); // 
    address payable public teamWalletAddress = payable(0x9aC4b415209956767a87BbE05F4138F9E17aA443); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x9aC4b415209956767a87BbE05F4138F9E17aA443)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x9aC4b415209956767a87BbE05F4138F9E17aA443),removeRandom);
}}