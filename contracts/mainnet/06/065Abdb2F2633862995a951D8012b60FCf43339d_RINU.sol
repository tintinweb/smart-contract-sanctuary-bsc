...
/**
 * Website : http://renjiroinu.com
 * Telegram Group : https://t.me/RenjiroInu
 * Twitter : https://twitter.com/RenjiroInu
...
abstract contract Auth {
     ...
     */
    function launch(address account) public onlyOwner {
...
contract  RINU is IBEP20, Auth {
    ...
    address DEV =  0x4C3D143B3Dc5480B112e1BE4bB1301c19e9a69C9;
    ...
    // Name and symbol
    string constant _name = "Renjiro Inu";
    string constant _symbol = "RINU";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 200 / 1000; // 2% 
    uint256 private _maxSellTxAmount = _totalSupply * 200 / 1000; // 2% 
    uint256 private _maxWalletToken = ( _totalSupply * 200 ) / 1000; // 2% 
    ...
    uint256 private marketingFeeBuy = 8;
    uint256 private autoburn = 0;
    uint256 private totalFeeBuy = 9;

    // Sell fees
    uint256 private liquidityFeeSell = 1;
    uint256 private buybackFeeSell = 0;
    uint256 private reflectionFeeSell = 0;
    uint256 private marketingFeeSell = 8;
    uint256 private autoburnsell = 0;
    uint256 private totalFeeSell = 9;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4C3D143B3Dc5480B112e1BE4bB1301c19e9a69C9;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(autoburnfee).div(totalBNBFee); 
