...
contract gluontoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x38Df408A9dBFd71ddD720F658B58D062dF3b3C81); //nice
    address payable public charityAddress = payable(0x38Df408A9dBFd71ddD720F658B58D062dF3b3C81); //nice
    ...
    uint256 private _tTotal = 700000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gluon Token"; //CC"; //CC
    string private _symbol = "GLU";  //nice
    ...
    uint256 public _maxTxAmount = 10500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 10500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 7000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 10500;// 0.01*105 token for 0.01 bnb (set as per requirements)
