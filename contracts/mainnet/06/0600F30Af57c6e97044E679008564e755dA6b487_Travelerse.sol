...
contract Travelerse is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public rewardYield = 4375690;
    ...
    address public liquidityReceiver        = 0x56a3A45afB3c3e4F6bf911cE8289FE55c7AaDDc1;
    address public treasuryReceiver         = 0xa620E9619847830CFb99FB81dB9a1F6f10D1DD59;
    address public riskFreeValueReceiver    = 0xBd5c07f9Fc9B23cD3cadEf62B31Fe7A16a5ABe70;
    address public busdToken                = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public charityReceiver          = 0x5d63Ab0658bd6E112481483d64f6de2c28a082e4;
    ...
    uint256 public liquidityFee = 2; // 0.5% will go into holders 0.5% to case 0.5% to charity and 0.5% to liquidity
    ...
    constructor() ERC20Detailed("$TRAVELERSE", "$TRAVELERSE", uint8(DECIMALS)) {
