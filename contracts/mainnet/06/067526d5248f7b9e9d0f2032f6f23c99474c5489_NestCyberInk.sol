...
// File contracts/libs/SimpleERC721.sol
 ...
 * {ERC721Enumerable}.
 */
abstract contract SimpleERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = SimpleERC721.ownerOf(tokenId);
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        owner = SimpleERC721.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(SimpleERC721.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(SimpleERC721.ownerOf(tokenId), to, tokenId);
    }
...
// File contracts/NestCyberInk.sol
