...
contract Flashloan {
  ...
  IPancakeRouter02 public pancakeRouter;
    ...
    IERC20 private WBNB = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    IERC20 private JST = IERC20(0xEE6cacDDd3A9370d87dB581EE6728226883578e5);
    IERC20 private JET = IERC20(0xBc58b718B886Cf62bf7000980fCE96b2603e0950);
  ...
  function pancakeCall(
    ...
    address[] memory pathCalc = new address[](2);
    ...
    // require(_amount0 == 1 || _amount1 == 0, string(abi.encodePacked(token0, token1, _amount0, _amount1)));
    ...
    // require(false, string(abi.encodePacked(amountRequired)));
    // require(token.approve(address(pancakeRouter), amountToken), 'token not approved');
    ...
    function withdraw() external {
        ...
        balance = JST.balanceOf(address(this));
        JST.transfer(owner, balance);
        balance = JET.balanceOf(address(this));
        JET.transfer(owner, balance);
