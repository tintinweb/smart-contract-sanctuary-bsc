...
pragma solidity ^0.6.12;
    ...
    contract DragonDeezNutsAcrossYourFaceInu is Context, IERC20, Ownable {
        ...
        string private _name = 'DragonDeezNutsAcrossYourFaceInu';
        string private _symbol = 'DragonDeezNutsAcrossYourFaceInu';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x4D6b5A75d373274522fFC20ea0d2144ea638da00, 'We can not exclude Uniswap router.');
