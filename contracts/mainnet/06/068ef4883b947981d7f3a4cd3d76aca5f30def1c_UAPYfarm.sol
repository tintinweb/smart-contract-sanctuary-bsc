...
contract UAPYfarm {
    ...
    uint256 public MIN_INVEST_LIMIT = 1000 * 1e5; /** 1000 UAPY  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 1000000 * 1e5; /** 1000000 UAPY  **/
    ...
    function sellEggs() public{
        ...
        token_UAPY.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_UAPY.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_UAPY.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_UAPY.transfer(dev1, tax);
        token_UAPY.transfer(dev2, tax);
        token_UAPY.transfer(dev3, tax);
        token_UAPY.transfer(dev4, tax);
        token_UAPY.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_UAPY.balanceOf(address(this));
	}
