...
contract BookShib is ERC721r, Ownable {

    mapping(address => uint) private mintedAmountPerWallet;

    constructor() ERC721r("BookShib", "BOOKSHIB", 100) { }

    function mint() public payable {
        require(mintedAmountPerWallet[msg.sender] < 3, "Unable to mint: wallet mint limit reached");
        require(msg.value >= 0.5 ether, "Unable to mint: insufficient value sent");
        mintedAmountPerWallet[msg.sender]++;
    ...
    function getMintPrice() public pure returns (uint) {
        return 0.5 ether;
    }

    function getMintedAmountPerWallet(address wallet) public view returns (uint) {
        return mintedAmountPerWallet[wallet];
    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeifo3w5fobnl6m67p5tburrshhzxasgndskmfpx5pa7qje7qapi2ne/";
    }
