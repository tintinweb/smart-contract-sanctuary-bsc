...
contract GoateInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoateInu";
    string private _symbol = "GoateInu";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x8316bC127a1976e73531f49c9197B9cF3Dc638A1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x16356D71Ab68804c19e8eB3bf73Bb4D93E618710); // BuyBack Address
