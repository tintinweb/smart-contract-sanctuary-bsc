...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x55d398326f99059fF775485246999027B3197955); //USDT
    //dont change that (:
...
contract KinderInu is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x55d398326f99059fF775485246999027B3197955; //USDT
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Kinder Inu";
    //change the token symbol
    string constant _symbol = "KinderINU";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x6abb5B382c26999B709ec6d1a789Cba31Dc4D07C;
