...
/**
    ...
    Telegram: https://t.me/cupidcatinubsc

    Twitter: https://twitter.com/cupidcatinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25c7182bDc765bFa816120081A9619cD7AE304e3; // owner address
...
contract CupidCatInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cupid Cat Inu";
    string private _symbol = "CCINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25c7182bDc765bFa816120081A9619cD7AE304e3); // Marketing Address
    address payable public teamWalletAddress = payable(0x25c7182bDc765bFa816120081A9619cD7AE304e3); // Team Address
