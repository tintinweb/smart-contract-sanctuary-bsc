...
contract SpaceMoonMan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceMoonMan";
    string private _symbol = "SpaceMoonMan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87346C412Cb0DEA528d3805B2e179b78F9B67EA3);
    address payable public teamWalletAddress = payable(0xf14bc84BE677E70aCA142A3b43BD53de25B14210);
