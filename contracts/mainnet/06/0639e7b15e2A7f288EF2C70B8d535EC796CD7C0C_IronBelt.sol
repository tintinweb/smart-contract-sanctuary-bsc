...
contract IronBelt is Context, IERC20 { 
    ...
    address payable public Wallet_Deployer = payable(0x2e18175Ba11A4a23Df8DBF837d28D2055056dF86); // DEV
    address payable public Wallet_Marketing = payable(0x362bDF1f0DbA56EB30698f0e177859cAFbd95206);  // MARKETING
    ...
    string private constant _name = "IRON BELT"; 
    ...
    constructor () {
        ...
        _owner = 0x362bDF1f0DbA56EB30698f0e177859cAFbd95206;
