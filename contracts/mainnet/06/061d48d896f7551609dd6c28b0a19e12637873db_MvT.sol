...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCC84c7d3632e201A7423A099C8105C9F2F8c5f1e; // owner address
...
contract MvT is Context, IERC20, Ownable {
    ...
    string private _name = "MaestroVSTokerr";
    string private _symbol = "MvT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCC84c7d3632e201A7423A099C8105C9F2F8c5f1e); // Marketing Address
    address payable public teamWalletAddress = payable(0xCC84c7d3632e201A7423A099C8105C9F2F8c5f1e); // Team Address
