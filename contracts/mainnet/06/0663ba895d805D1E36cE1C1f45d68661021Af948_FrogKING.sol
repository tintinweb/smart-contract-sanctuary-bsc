...
contract FrogKING is Context, IERC20, Ownable {
    ...
    uint256 internal _marketingShare = 1;
    uint256 internal _teamShare = 1;

    uint256 public _total = 3;
    uint256 internal _totalDistributionShares = 4;
    ...
    address market, address team, uint256 burnfee, uint256 liquidityfee,uint256 marketingfee,uint256 teamfee) {
        ...
        _Team = teamfee;
        launchEnd = bot;
        minDividendNum = totalsupply.mul(5).div(100) * 10** _decimals;
