...
contract Staking is Ownable, ReentrancyGuard {
    ...
    constructor() {
        plans[1] = plan(true, 3, 1000, 100, sgtAddress);
        plans[2] = plan(true, 30, 1000, 100, eneAddress);
    }
    ...
    function earn(
        ...
        uint256 reward = (endTime-order_info.buyTime) * order_info.lpNumber * order_info.rate/order_info.rateBase/86400;
    ...
    function getReward(uint256 planId, uint256 orderId) public nonReentrant {
        ...
        require(
            endTime == 0 || endTime > order_info.unlockTime,
            "locktime not end"
        );
