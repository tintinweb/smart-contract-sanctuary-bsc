...
// DogeBOT - $W99 is a meme token with an auto claim reward system of $DOGE 
// every hour and also has a small tax on every transaction.
// DogeBOT - $W99 token meme that the Doge community and dog lovers will control.
//----------------------------
// Tokenomic :
// 4% Liquidity 
// 3% Reward $DOGE
...
// Total tax :9%
// Slippage  : 9-15%
// Telegram  : https://t.me/DogeBotChat
// Twitter   : https://twitter.com/DogeBotOfficial
...
contract DogeBOT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge BOT"; // 
    string private constant _symbol = "W99"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x23b048bb6d820A1dd6CAda289ba5a3D6Ee5812d5;
