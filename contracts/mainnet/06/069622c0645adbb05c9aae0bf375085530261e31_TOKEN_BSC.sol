...
contract TOKEN_BSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Enchantress";
    string private constant _symbol = "ENCHANT";
    ...
    constructor () {
        _feeAddress = payable(0xD36D9dd30a527fbdda9EcACE730f095481b261da);
        _buyTax = 10;
        _sellTax = 10;
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        removeMaxTx = true;
        _maxTxAmount = 1_000_000_000_00000 * 10**9;
        tradingOpen = true;
