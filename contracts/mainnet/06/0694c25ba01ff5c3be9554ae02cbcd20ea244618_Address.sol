...
contract OAS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa3B22E5332AA88d095b0aAF6dC4eD43C577497a2); 
    address payable public developmentAddress = payable(0xa3B22E5332AA88d095b0aAF6dC4eD43C577497a2); 
    address payable public charityAddress = payable(0xa3B22E5332AA88d095b0aAF6dC4eD43C577497a2); 
    address payable public vaultRewardAddress = payable(0xa3B22E5332AA88d095b0aAF6dC4eD43C577497a2); 
    ...
    string private constant _symbol = "OAS";
    ...
    uint256 public _sellVaultFee = 50;
    ...
    //Create additional liquidity using Deca tokens in contract
