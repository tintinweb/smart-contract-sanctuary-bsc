...
MAX TX     - 4% (400 mil of tokens)
Max Wallet - 4% (400 mil of tokens)
...
contract INUGROW is IBEP20, Auth {
    ...
    address DEV = 0x492ff06c77366EFbd26a9566020e1Ea4Fdc5B415;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 2% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 2% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 2% (100 mil)
    ...
    uint256 public swapThreshold = _totalSupply * 31 / 10000; // .5% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xbF46F8024b8385FE246Db5f548F21d3a231E47FD;
        marketingFeeReceiver = 0x9410911f03604e5DD9050ff849731403F21D987A;
