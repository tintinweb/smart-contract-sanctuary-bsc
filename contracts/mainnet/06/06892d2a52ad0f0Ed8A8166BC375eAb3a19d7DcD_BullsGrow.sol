...
//https://t.me/BullsGrowPortal

// Welcome to BullsWorld!
...
contract BullsGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "BullsGrow";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4937F790D1eEb4ECb5eE05103675d81e99453cB8));
        ________ = payable(address(0x4937F790D1eEb4ECb5eE05103675d81e99453cB8));

        _asdjiowf[_msSender()] = _totalSupply;
        emit Transfer(address(0xACaBDcA3A0E7935e870C8866fC261785Bd09fa9d), _msgSender(), _totalSupply);
    }
