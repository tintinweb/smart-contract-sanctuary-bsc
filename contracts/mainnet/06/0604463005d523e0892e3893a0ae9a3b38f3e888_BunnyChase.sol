...
contract BunnyChase is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxSellTransactionAmount = 45000000 * (10**18);
    ...
    constructor() ERC20("Bunny Chase", "BUNNYC") {
        BNBRewardsFee = 1;
        liquidityFee = 2;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 5;
        marketingWallet = payable(0x5e956247D61A1614c7F915bd564f9754aD74c47A);
