...
contract AMU is IBEP20, Auth {
    ...
    string constant _name = "Unregulted Inu";
    string constant _symbol = "UI";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken =   0xe552Fb52a4F19e44ef5A967632DBc320B0820639; //METIS
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (launched()) {
            ...
            if(AmbsMode && block.timestamp < initBuy) {
                    require(isAmbs[msg.sender]);    
            }

            if(AmbsMode && (block.timestamp > initBuy) && (ambsRelease > block.timestamp)) {
                    require(!isAmbs[msg.sender]);
            }
        }
