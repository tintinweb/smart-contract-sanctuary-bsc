...
contract Vecna is IBEP20, Auth {
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 5000; // 3%
    ...
    uint256 public marketingFeeBuy = 35;
    uint256 public devFeeBuy = 0;
    uint256 public totalFeeBuy = 70;

    // Sell fees
    uint256 public liquidityFeeSell = 35;
