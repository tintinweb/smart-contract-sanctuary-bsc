...
contract EverStaking is Ownable {
    ...
    constructor() {
        _token = msg.sender;
        REWARD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        STAKING = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        TOKEN = IERC20(0x47d42E0e864ceFf8C4270F7b6E1f6F91Da45882C);
