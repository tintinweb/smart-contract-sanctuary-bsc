...
abstract contract MZ is IERC20, Ownable {
    ...
    constructor (
        ...
        uint256 total = Supply * 9 ** Decimals;
        _tTotal = total;

        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  8888 * 9** Decimals;
...
contract TOKEN is MZ {
    constructor() MZ(
        ...
        9,//Decimals
        8888,//Supply
        address(0xf9984942B5EBE07BE2882840fd8D761d823E41bB),//FundAddress
        address(0xd9E07d1b50179511061B9E2f9f675354764f1221)//ReceiveAddress
    ){
    }
}