...
MEME token By following the Name hype in the current round 

EASY PUMP WITH STRONGER
💧 SAFE DEV
💧 LOCK LIQUIDITY
💧 RENOUNCED
💧 MARKETING PLAN
...
contract XNXXGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1fcfddb0CADB19810ee7C3be50250c9A5Fc8DE43); 
    address payable public Dev_Wallet = payable(0xF78743DB04642FaaD6a7Aa438e413aB1FFF950E0);
    ...
    string private constant _name = "XNXX GROW"; 
    string private constant _symbol = unicode"XNXX GROW💦"; 
    ...
    constructor () {
        ...
        _owner = 0xF78743DB04642FaaD6a7Aa438e413aB1FFF950E0;
