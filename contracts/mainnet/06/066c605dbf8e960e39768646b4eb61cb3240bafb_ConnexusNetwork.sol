...
/**
   Connexus Network - CONN Token
   Its main purpose is to provide maximum useful, easy and efficient DApp & Smart Contract development components for developers and project owners.
   Connexus is a community-driven development and analysis project designed for developers and produced as a solution to multiple network software problems.
   Using Connexus Network, developers can develop software and DApp projects using a single infrastructure for Ethereum, Binance Smart Chain, Solana and Avalanche networks.
   At the same time, developers can redesign their Smart Contract production not for single networks, but as multi-chain with Connexus Network smart contracts.

   Total Fee: 3%
   Auto-LP: 1% Fee (Liquidity Pool)
   Marketing: 2% Fee (Charity & Marketing)
   connexus.network
...
contract ConnexusNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Connexus Network";
    string private _symbol = "CONN";
    ...
    address public charityWallet = 0x46D344f575B2B4e3df99E23B2D06777843749479;
