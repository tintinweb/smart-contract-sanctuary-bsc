...
/**
    The Newest Decentralized Meme Token

Omega Inu is very giving and is designed to reward long term holders. 
Community is first and foremost. Omega is proud to run with his father and 
provide transparency and fairness to the community.

Telegram : https://t.me/OmegaInu
Website : https://omegainu.space/
Twitter : https://twitter.com/RealOmegaInu
...
contract OMEGAINU is Context, IERC20, Ownable {
    ...
    string private _name = "OMEGA INU";
    string private _symbol = "$OMEGA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x040610f715B7bae035891274740Ff04e9EC86eEF); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x040610f715B7bae035891274740Ff04e9EC86eEF); // Team Address
