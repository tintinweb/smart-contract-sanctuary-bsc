...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //pcs
    IBEP20 RewardToken = IBEP20(0x893535ED1b5C6969E62a10bABfED4F5fF8373278); //cakemoon
...
contract GoldenTicket is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Golden Ticket";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xdb51b7dC70872e8FCB830a735defe19F43F28e63;  // goldenticketmarketingwallet
        anothermarketingWallet = 0x04feE00Ed167dDCc353429FA44c05d65Ae038C77; // jackpotwallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(4).div(5);
