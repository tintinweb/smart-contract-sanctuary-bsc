...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = address(0x0ec7D86581ab13Aeb185c7767190085dEBe9FaE8);
        _owner = msgSender;
...
contract NowBanq is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;

    address public marketingWalletAddress = 0xDa63986C0ef3BAF4c6B4DA05aCaaEa099D3BB371; // Marketing wallet Address.
    ...
    string private _name = "NowBanq";
    string private _symbol = "NWB";
