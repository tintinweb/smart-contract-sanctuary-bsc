...
contract SAUDIGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Grow";
    string private _symbol = "SAUDIGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6254F9CcAbD6BffBCD80b92D326cB2be2ca3830a);
    address payable public DevelopmentalWalletAddress = payable(0x3a903F17d81ec0C036d0f9b6B729c9001E83D221);
