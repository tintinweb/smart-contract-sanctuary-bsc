...
contract MartianDoge is ERC20 {
	...
	address _fundAddress = address(0xb29cAB73b7081f65f6125Dc071F529faA41E37C1);
    ...
    constructor(address tokenOwner) ERC20("Martian Doge", "Martian Doge") {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                if(startTime.add(120) > block.timestamp){
                    ...
                    swapAndLiquifyV3(haveAmount.div(6));
                    swapAndLiquifyV4(haveAmount.div(6).mul(5));
                }
                swapping = false;
            }
        }
        ...
        if (takeFee) {
            ...
            super._transfer(from, address(this), amount.div(100).mul(fee));
            _takeInviterFeeKt(amount.div(10000));
			amount = amount.div(100).mul(100 -fee);
        }
        super._transfer(from, to, amount);
    }
