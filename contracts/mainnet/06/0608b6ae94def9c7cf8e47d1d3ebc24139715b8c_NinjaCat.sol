...
contract NinjaCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1481b9d4Deb56aa14B28c76D5f863Aa34F57Bd77); 
    address payable public Wallet_Dev = payable(0x1481b9d4Deb56aa14B28c76D5f863Aa34F57Bd77);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Ninja Cat"; 
    string private constant _symbol = unicode"NinCat";
