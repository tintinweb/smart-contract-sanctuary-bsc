...
contract DYORTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 50000000000000000000000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 400000000000000000000000 * 10**9; //
    string private constant _name = "DYOR TOKEN"; // 
    string private constant _symbol = "Mysteryfifteencat"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0xB345C7AB54b6B0A0678a83263832D5B3820a4811;
