 ...
 *    :r;..rGGh,  :SAG;;[email protected]:.,,,,,,,,,.r83:      hHH1sXMBHHHM3..,,,,.ir.    
 *   ,si,.1GS,   sBMAAX&MBMB5,,,,,,:,,.:&8       [email protected]#X,.,,,,,,rr    
 *   ;1:,,SH:   [email protected]&&B#&8H#BS,,,,,,,,,.,5XS,     [email protected]&59M#As..,,,,:,is,   
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5e0334611202bFFD634D945f3fcE5C1de2d3722;
...
contract Kremlin is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xF5e0334611202bFFD634D945f3fcE5C1de2d3722);
    address payable private Wallet_Burn = payable(0xF5e0334611202bFFD634D945f3fcE5C1de2d3722); 
    address payable private Wallet_zero = payable(0xF5e0334611202bFFD634D945f3fcE5C1de2d3722); 
    ...
    */
    ...
    string private _name = "Kremlin"; 
    string private _symbol = "Kremlin";  
