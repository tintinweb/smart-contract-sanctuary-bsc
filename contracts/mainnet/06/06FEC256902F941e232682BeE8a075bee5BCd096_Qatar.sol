...
abstract contract AbsToken is IERC20, Ownable {
    ...
    bool public killBatchMode = true;
    bool private inSwap;
    ...
    function updateKillBatch(bool TF) external onlyOwner {
        killBatchMode = TF;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (!_swapPairList[recipient])
                require(tAmount + _balances[recipient] <= maxWalletAmount);
            uint256 swapFee;
            if (isSell) {
    ...
    function setSwapAndLiquifyEnabled(bool TF) external onlyOwner {
...
contract Qatar is AbsToken {
    constructor()
        AbsToken(
            ...
            9,
            1000000000,
            address(0x359cFa0DBF9dbfD5Ac285eE3546beda1eC2D129E),
            address(0xda2F3C49bd83e362A9f3e32d4aB30EEf984849D4)
        )
    {}
}