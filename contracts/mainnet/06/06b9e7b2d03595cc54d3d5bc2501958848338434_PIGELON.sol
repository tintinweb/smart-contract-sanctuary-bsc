...
contract PIGELON is Context, IERC20, Ownable {
    ...
    string private constant _name = "PigElon";
    string private constant _symbol = "PGE";
    ...
    address private marketingWallet = address(0x0961D71FD0B2b2173A246d3ddBa8427f5DB0F0A3);
