...
// File: contracts/interfaces/ISerenityLottery.sol

pragma solidity ^0.8.4;

interface ISerenityLottery {
    /**
...
// File: contracts/SerenityLottery.sol

pragma solidity ^0.8.4;
pragma abicoder v2;

/** @title Serenity Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract SerenityLottery is ReentrancyGuard, ISerenityLottery, Ownable {
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            cakePerBracket: [uint256(0), uint256(0), uint256(0), uint256(0)],
