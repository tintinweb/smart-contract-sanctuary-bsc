...
contract GemFist is Context, IERC20, Ownable {
    ...
    string private _name = "GemFist";

    string private _symbol = "GemFist";
    ...
    address payable public marketAddress = 0x64099812368011063aaB8717A8551aFAfF6b20be ; //Marketing
