...
library Address{
 ...
 contract DOGEHACK is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 567_567_765_765 * 10**9;
    ...
    address public marketingWallet = 0x610fD84c4BE079503A5816073307b98054c39454;
    address public donationWallet = 0x610fD84c4BE079503A5816073307b98054c39454;

    string private constant _name = "Doge Hack";
    ...
    Taxes public taxes = Taxes(1, 6, 2, 1);
    Taxes public sellTaxes = Taxes(1, 6, 2, 1);
