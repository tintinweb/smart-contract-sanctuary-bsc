...
contract Advisor2Lock is Ownable {
    ...
    uint256 public unlockPercent = 40; // 40 its 4%
    ...
    address public advisorAddress = 0x5E93614edB0Ac0D528d0e5f7bdc8169881Cce892;
    ...
    function claim() public {
        ...
        _token.safeTransfer(advisorAddress, _amount);
    }

    function changeAdvisorAddress(address newAdvisor) public onlyOwner() {
        advisorAddress = newAdvisor;
    }
