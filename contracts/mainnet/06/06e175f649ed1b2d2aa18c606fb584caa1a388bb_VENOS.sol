...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60b1daaAf6806315cc3C566ED887AAF2C48fF6fa;
...
contract VENOS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x60b1daaAf6806315cc3C566ED887AAF2C48fF6fa;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Venos Coin";
    string private _symbol = "VON";
