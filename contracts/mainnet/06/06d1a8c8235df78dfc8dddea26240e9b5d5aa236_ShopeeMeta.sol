...
contract ShopeeMeta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShopeeMeta";
    string constant _symbol = "ShopeeMeta";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 15000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 650;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1203Fe8e3beC2f90835c97cBefaF034a9Fff84BD;
        ecosystemfeeReceiver = 0x1203Fe8e3beC2f90835c97cBefaF034a9Fff84BD;
