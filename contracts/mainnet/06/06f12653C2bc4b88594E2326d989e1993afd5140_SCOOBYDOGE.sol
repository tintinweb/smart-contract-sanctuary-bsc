...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4429924a8B8e03217a8f3048aCEbfADd077E78E5; // owner address
...
contract SCOOBYDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCOOBY DOGE";
    string private _symbol = "SCOOBY";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x385A8a08D033Edb27fcf03d38DbE2BF6435A6956); // Marketing Address
    address payable public teamWalletAddress = payable(0x385A8a08D033Edb27fcf03d38DbE2BF6435A6956); // Team Address
    ...
    uint256 public _liquidityShare = 8; // original 5
    ...
    uint256 public _totalDistributionShares = 10;  // original 12
