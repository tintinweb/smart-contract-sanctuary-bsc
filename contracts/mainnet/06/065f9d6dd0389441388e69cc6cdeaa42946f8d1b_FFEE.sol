...
contract FFEE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUTURE";
    string private _symbol = "FFEE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDCA1204c986741f21a7e62A7C2B76e6de53658f1); 
    address payable public BurnedWalletAddress = payable(0xD3CB4855D16254D714544B96d7613053A97Af460); 
    ...
    uint256 private _totalSupply = 6688 * 10**_decimals;
