...
library Address{
 ...
 contract BaboonINU is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public isGone;
    ...
    uint256 public swapTokensAtAmount = 400_000 * 10**6; // 0.40%
    uint256 public maxBuyLimit = _tTotal; // 1%
    uint256 public maxSellLimit = _tTotal; // 1%
    uint256 public maxWalletLimit = _tTotal; // 1%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x61fa6A9c37C9eD321A45c4aE8208df1b7e484Fd1;
    address public developmentWallet = 0x61fa6A9c37C9eD321A45c4aE8208df1b7e484Fd1;

    string private constant _name = "Baboon INU";
    ...
    Taxes public taxes = Taxes(0, 1, 0, 5);
    Taxes public sellTaxes = Taxes(0, 1, 0, 5);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override antiBot(sender) returns (bool) {
        ...
        require(!isGone[recipient] && !isGone[sender], 'Address is Rewarded');
