...
contract QATARDOGEGROW is IERC20 {
    ...
    string constant private _name = "QATAR DOGE GROW";
    string constant private _symbol = "QDG";
    ...
    address public marketingWallet = payable(0xa8308220c4d8C8829361f938AdAa9CaC833612A0);
...
//===============================================================================================================
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        (success,) = marketingWallet.call{value: address(this).balance, gas: 50000}("");
    }
