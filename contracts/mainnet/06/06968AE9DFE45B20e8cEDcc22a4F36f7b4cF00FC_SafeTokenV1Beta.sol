/**
 * author of Safetoken: 0f0crypto <[email protected]>
 * discord of Safetoken: https://discord.gg/zn86MDCQcM
 *
 * Rio Token v2.0 based on Safetoken.
 *
 ...
 */
  ...
  * Redistribution   0.1%
  * Burn             0.8%
  * Tip to the Dev   0.1% For Safetoken who made this contract.
  */
 ...
 abstract contract Tokenomics {
     ...
     string internal constant NAME = "Rio Token";
     string internal constant SYMBOL = "RIT";
     
     uint16 internal constant FEES_DIVISOR = 10**3;
     uint8 internal constant DECIMALS = 9;
     uint256 internal constant ZEROES = 9**DECIMALS;
     
     uint256 private constant MAX = ~uint256(0);
     uint256 public constant TOTAL_SUPPLY = 1000000000 * 1e9; // 1 bil for 9 Decimals
     /*uint256 internal constant TOTAL_SUPPLY = 1 * ZEROES;*/
      ...
      */
     address internal burnAddress = 0x0000000000000000000000000000000369369369;
     ...
     function _addFees() private {
          ...
          */ 
         _addFee(FeeType.Rfi, 1, address(this) ); 
         _addFee(FeeType.Burn, 8, burnAddress );
