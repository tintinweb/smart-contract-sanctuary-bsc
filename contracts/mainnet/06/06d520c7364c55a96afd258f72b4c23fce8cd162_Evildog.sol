...
contract Evildog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAFC2C0A516a8E0C0d55E1f8e4f442C69d830A833); // Marketing Address
    ...
    uint256 private _tTotal = 10000000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Evildog";
    string private _symbol = "Evildog";
