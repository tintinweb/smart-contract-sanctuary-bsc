...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _gow  = 0x9e1c3fce8112a8259158f9a0b81FfC4fbed878D9;
        _main = 0x16b3529a8Df098250A3dF31af968AaCAdDC4F437;
        _mark = 0x16b3529a8Df098250A3dF31af968AaCAdDC4F437;
        _pool = 0x16b3529a8Df098250A3dF31af968AaCAdDC4F437;
        ...
        _maxusdt = 100 * 10 ** 18;
        _mint(_main, 5500000 * 10 ** decimals());
    }
    ...
    function _transfer(
        ...
        if (usdts >= _maxusdt && !_swapping && sender != _pair) {
            _swapping = true;
            // pool 2%
            IERC20(_usdt).transfer(_mark, usdts * 3 / 11);
            // fund 2%
            IERC20(_usdt).transfer(_pool, usdts * 3 / 11);
            // usdt to fbox 1%
            _swapUsdtForToken(_gow, usdts * 5 / 11);
            _swapping = false;
            isbonus = true;
        }
        ...
        // else 5%
        _balances[address(this)] += (amount * 11 / 100);
        emit Transfer(sender, address(this), (amount * 11 / 100));

        // to user 92%
        amount = amount * 87 / 100;
        _balances[recipient] += amount;
        emit Transfer(sender, recipient, amount);
    }
