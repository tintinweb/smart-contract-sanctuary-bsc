...
contract USDT is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 10000000000000000; // default 0.01 USDT
    ...
    uint256 minDeposit = 1000000000000000000; // default 1 USDT
    ...
    function withdrawBank() external nonReentrant {
    	// Requires now to be UTC Monday 8:00 ~ 11:59 PM
    	timeNowWithdraw = block.timestamp % 604800;
        require (417600 < timeNowWithdraw && timeNowWithdraw < 432000, "Withdrawal Opens at UTC Mon 20:00 ~ 23:59");
        address _sender = msg.sender;
   ...
   function refund(uint256 _betId) external nonReentrant {
    ...
    function bet(uint256 _betAmount, uint256 _odd) external payable nonReentrant {
    	// Requires now to NOT be UTC Monday 20:00 ~ 23:59
		timeNowBet = block.timestamp % 604800;
        require(timeNowBet < 417500 || timeNowBet > 432100, "Betting Closes at UTC Mon 20:00 ~ 23:59" );
