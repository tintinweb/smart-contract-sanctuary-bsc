...
https://t.me/wingerPORTAL
https://wingerchain.pro
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x148b6f4867e944bbC1f84611a5d676970291F6EB; 
...
contract WINGERCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Winger Chain";
    string private _symbol = "winger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb342660876b79561862839B103D492501712aC0B); 
    address payable public teamWalletAddress = payable(0xb342660876b79561862839B103D492501712aC0B); 
