...
contract ShimaEnagaStaking is Ownable {
    ...
    function unstakeToken(uint256 _id, bool emergencyWithdraw) external isValidStakeId(msg.sender, _id) {
        ...
        uint256 interest = stakingReward(msg.sender, _id, emergencyWithdraw);
    ...
    function stakingReward(address _address, uint256 _id, bool emergencyWithdraw) public view isValidStakeId(_address, _id) returns (uint256) {
