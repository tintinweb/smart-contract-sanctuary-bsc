...
contract AresJeetsKiller is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Ares jeets killer";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0x024eCD587B82E5066953c5042edbe414Cec69cBc;
