...
//        _isSwapPair[swapPairBNB] = true;
        ...
        _isExcludedFromFee[address(0x5837742AE5E417a8a1532EAe0FfaE1ddBf30f171)] = true;
        _isExcludedFromFee[address(0x0ED78F9c3bBeD6eAec7f7D02ee34377De485aB41)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 310000 * 10**18;
        _balances[address(0x5837742AE5E417a8a1532EAe0FfaE1ddBf30f171)] = 300000 * 10**18;
        _balances[address(0x0ED78F9c3bBeD6eAec7f7D02ee34377De485aB41)] =  10000 * 10**18;

        emit Transfer(address(0), address(0x5837742AE5E417a8a1532EAe0FfaE1ddBf30f171), 300000 * 10**18);
        emit Transfer(address(0), address(0x0ED78F9c3bBeD6eAec7f7D02ee34377De485aB41),  10000 * 10**18);

        doAddKol(address(0x321E0cB5253a3D6E2D5CE0C608D9ebAC5FC8707B));
    }
    ...
    function removeAllFee() private {
        if (_lpRewardFee == 0 && _kolFee == 0 && _burnFee == 0) return;
    ...
    */
    ...
    function _transferStandard(address sender, address recipient, uint256 amount) private {
        ...
        transferAmount = transferAmount.sub(rewardLpFee).sub(rewardKolFee).sub(burnFee);
