...
contract SincereDAO is Context, IERC20, Ownable {
    ...
    string private _name = "SincereDAO";
    string private _symbol = "SincereDAO";
    uint8 private _decimals = 3;

    address payable private marketingWalletAddress = payable(0x8dB9cf1cD4b9E376C25Bd166D8bc1B75D37B5Af4); 
    address payable private teamWalletAddress = payable(0x8dB9cf1cD4b9E376C25Bd166D8bc1B75D37B5Af4); 
