...
contract BullRun is ERC20DividendToken {
    ...
    constructor (address _marketingAddress, address _devAddress) ERC20DividendToken("BullRun", "BRN", _tokenSupply, _routerAddress, _marketingAddress, _devAddress) {
