...
contract FtxToken is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    FtxTokenDividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0x953e43Ae7391b3269b389C86cb8ecc905Fe12EBA);
    address payable public _buybackWalletAddress = payable(0x3fbec737501264aFAD1aA718AE7F1612b0012cd9);
    ...
    constructor() BEP20("FtxToken", "FTX") 
    {
        dividendTracker = new FtxTokenDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "FtxToken: The dividend tracker already has that address");
        FtxTokenDividendTracker newDividendTracker = FtxTokenDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "FtxToken: The new dividend tracker must be owned by the FtxToken token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "FtxToken: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FtxToken: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FtxToken: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "FtxToken: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "FtxToken: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "FtxToken: Cannot update gasForProcessing to same value");
...
contract FtxTokenDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("FtxToken_Dividend_Tracker", "FtxToken_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "FtxToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "FtxToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FtxToken contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FtxToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "FtxToken_Dividend_Tracker: Cannot update claimWait to same value");
