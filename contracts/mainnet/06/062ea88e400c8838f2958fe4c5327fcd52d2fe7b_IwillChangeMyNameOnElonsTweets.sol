...
contract IwillChangeMyNameOnElonsTweets is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IwillChangeMyNameOnElonsTweets";
    string private _symbol = "IWCMNOET";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x5ac8Df798eA1a85F0D8b65CD4999D137cFaA8c5a);
    address payable public teamWalletAddress = payable(0x1B42f6f581fd179ec633518d4550589BfB16F844);
