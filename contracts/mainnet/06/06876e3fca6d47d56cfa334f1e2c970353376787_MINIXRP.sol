...
5% XRP-BEP20 rewards with masisve buybacks

TG: https://t.me/MiniRipple
...
contract MINIXRP is ERC20, Ownable {
    ...
    MINIXRPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MiniRipple", "MINIXRP") {
        marketingWallet = payable(0x2d344094eD70e8c9CB8FdCA5EE10a226AB5d72C0);
        devWallet = payable(0xABc72b1eC9845C63CA7d6F61B5E630707e8B861D);
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new MINIXRPDividendTracker(
            payable(this),
            router,
...
contract MINIXRPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MINIXRP public MINIXRPContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MINIXRPContract = MINIXRP(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MINIXRP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MINIXRP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MINIXRP contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MINIXRPContract);

            uint256 prevBalance = MINIXRPContract.balanceOf(address(this));
            ...
            {
                uint256 received = MINIXRPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MINIXRPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
