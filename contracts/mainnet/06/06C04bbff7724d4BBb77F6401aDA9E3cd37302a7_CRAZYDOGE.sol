...
contract CRAZYDOGE is ERC20, Ownable {
    ...
    CRAZYDOGEDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Crazy Dogecoin", "CRAZYDOGE") {
        marketingWallet = payable(0x099fC8c2a9793fF6e277F78566E2b10395cbe9Af);
        devWallet = payable(0xC44a4dFe250dbEBd9102814e76F64e3FeC135EC7);
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new CRAZYDOGEDividendTracker(
            payable(this),
            router,
    ...
    function setGasPriceLimit(uint256 GWEI) external onlyOwner {
        require(GWEI >= 8, "can never be set below 5");
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**6);
        require(value >= _totalSupply / 2000000, "max wallet cannot be set to less than 0.05%");
        maxWallet = value;
    }
    ...
    function airdropToWallets(
        ...
        for (uint256 i = 0; i < airdropWallets.length; i++) {
            ...
            uint256 airdropAmount = amount[i] * (10**6);
...
contract CRAZYDOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CRAZYDOGE public CRAZYDOGEContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CRAZYDOGEContract = CRAZYDOGE(mainContract);
        minimumTokenBalanceForAutoDividends = 1 * 1e26 * 1e6; // 1 * 1e26 tokens
    ...
    function _transfer(
        ...
        require(false, "CRAZYDOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CRAZYDOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CRAZYDOGE contract."
        );
    }
    ...
    function setMinimumTokenBalanceForAutoDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForAutoDividends = value * (10**6);
    }
    ...
    function setMinimumTokenBalanceForDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForDividends = value * (10**6);
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CRAZYDOGEContract);

            uint256 prevBalance = CRAZYDOGEContract.balanceOf(address(this));
            ...
            {
                uint256 received = CRAZYDOGEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CRAZYDOGEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
