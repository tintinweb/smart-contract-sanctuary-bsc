...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x689570404677f9c56F0C679D0a4bBDdF1519e9A5;
        // owner address
...
contract Bgold is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "BlackGoGoWorld";
    string private _symbol = "Bgold";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x689570404677f9c56F0C679D0a4bBDdF1519e9A5); // Marketing Address
    address payable public teamWalletAddress = payable(0x689570404677f9c56F0C679D0a4bBDdF1519e9A5); // Team Address
    ...
    function setDLBgold(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEBgold(uint256 fe) external onlyOwner {
