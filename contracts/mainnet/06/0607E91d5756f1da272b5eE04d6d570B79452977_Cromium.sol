...
contract Cromium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cromium";
    string private _symbol = "CROMIUM";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xbC1ddE93C570FB4a56e3c322CD37ae5c92dF66E0);
