...
contract StandardToken is IERC20, Ownable, BaseToken {
    ...
    function setFee(uint256 _marketFee,uint256 _lpFee) public onlyOwner{
        marketFee = _marketFee;
        lpFee = _lpFee;
    }
    function setAddress(address _marketAddress,address _lpAddress) public onlyOwner{
    ...
    function setBlackList(address add,bool flag) public onlyOwner{
        blackList[add] = flag;
    }
}