...
contract SmartChefInitializable is AccessControl, ReentrancyGuard {
    ...
    /*
     * @notice Transfers specific amount of reward tokens to the caller
     ...
     */
    function stopReward() external onlyRole(GOVERNANCE_ROLE) {
