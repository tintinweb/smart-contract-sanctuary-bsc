...
/**
BONEDINO
telegram https://t.me/BONEDINO
🟡 Total Supply: 100,000,000,000,000
✅ LP Locked 1 Year 🔒
⚡️ Renounced
🟡 Tax: 8/8% Buy/Sell
📄Contract Address : 0x068CCd037DCA8Ba6CC3dFf2E7b7A2147abf74891

https://poocoin.app/tokens/0x068CCd037DCA8Ba6CC3dFf2E7b7A2147abf74891
*/
...
contract BONEDINO is BONEDINODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BONEDINOTeam;
    address private CharityBONEDINO;
    ...
    string public override name = "BONEDINO";
    string public override symbol = "BONEDINO";
    ...
    constructor(uint totalSupplyValue, address BONEDINOTeamAddress, address CharityBONEDINOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BONEDINOTeam = BONEDINOTeamAddress;
        CharityBONEDINO = CharityBONEDINOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BONEDINOTeam] =  totalSupply * 4 / 100;
        balances[CharityBONEDINO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BONEDINOTeam pot
