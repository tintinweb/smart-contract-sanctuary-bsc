...
contract HappyHalloween is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7a6C227b4A6b8b2842A96DAE98959B6055F1e48b;
    address public teamWallet = 0x7a6C227b4A6b8b2842A96DAE98959B6055F1e48b;
    ...
    Taxes public taxes = Taxes(1, 8, 2, 2);
    Taxes public sellTaxes = Taxes(1, 8, 2, 2);
