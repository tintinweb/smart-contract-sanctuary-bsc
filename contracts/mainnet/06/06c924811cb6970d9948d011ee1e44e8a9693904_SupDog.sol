...
/**
Detail of SuperDoge Visit SOCIAL To Be Announced
TELEGRAM: https://t.me/superdogeport
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x6258c967337D3faF0C2ba3ADAe5656bA95419d5f;
    IBEP20 RewardToken = IBEP20(0x7B4328c127B85369D9f82ca0503B000D09CF9180);
...
contract SupDog is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Super Doge";
    string constant _symbol = "SupDog";
    ...
    uint256 private _maxTxAmount = 30 * 10**9 * (10 ** _decimals);
    uint256 public _walletMax = 50 * 10**9 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x13C1B20eDcc2c38D97a7Bb390594c1B3e337B920;
        marketingWallet = 0xdbb41B40a08ff872EA44ffA23cd6B751eA8975e2;
        devWallet = 0x13C1B20eDcc2c38D97a7Bb390594c1B3e337B920;
