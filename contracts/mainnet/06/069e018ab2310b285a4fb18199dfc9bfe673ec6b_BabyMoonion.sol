...
library Address{
 ...
 contract BabyMoonion is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_500_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xCD8cd8B2Dc6A79f4ffe33De38788d5F47E28441f;
    address public donationWallet = 0xCD8cd8B2Dc6A79f4ffe33De38788d5F47E28441f;

    string private constant _name = "BabyMoonion";
    string private constant _symbol = "bMOONION";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 6, 0);
