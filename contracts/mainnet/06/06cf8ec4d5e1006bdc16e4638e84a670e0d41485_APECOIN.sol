...
contract APECOIN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x13e749E8E2C796fF1b7806d8DE11276CA3323cde;
    address public newOwner = 0xF04FDa229C768a1845051cC0E4B5c9d6D39284E1;
    ...
    constructor() 
    { 
        newOwner = 0xF04FDa229C768a1845051cC0E4B5c9d6D39284E1;
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        require(
            launchTime != 0 && 
            launchTime + 1 days < block.timestamp, 
            "You cannot change fees before 1 days passes after launch"
        );
        taxFee = _taxFee;
