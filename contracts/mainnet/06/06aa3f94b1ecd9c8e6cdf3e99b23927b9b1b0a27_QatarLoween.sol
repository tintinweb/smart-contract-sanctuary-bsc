...
contract QatarLoween is Context, IERC20, Ownable {
    ...
    string private constant _name = "QatarLoween"; // 
    string private constant _symbol = " $QATARLOWEEN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x97a1a5181633C198CBe3CcAd3816A8e925A42260;
