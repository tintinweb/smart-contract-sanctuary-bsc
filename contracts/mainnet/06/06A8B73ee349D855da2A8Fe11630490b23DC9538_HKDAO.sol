...
/**
       Official TG Group:https://t.me/HKDAO_CN
       Official QQ Group:646561179                                           
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xF9a860F0dB10099a1412d1EbB8143B092b175FD4;//
...
contract HKDAO is AbsToken {
    constructor() AbsToken(
        ...
        unicode"HKDAO",//Name
        unicode"HKDAO",//Symbol
        9,//Decimals
        97000000,//Supply
        address(0xF9a860F0dB10099a1412d1EbB8143B092b175FD4),//FundAddress
        address(0xb2D7d3DE2d05B350780938756333275E2dc94660)//ReceiveAddress
    ){
    }
}