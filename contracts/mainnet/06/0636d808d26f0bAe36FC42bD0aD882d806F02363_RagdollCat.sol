...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8E9270df43d9DEa7C023d7EF6f6DAa26781CB99B;
...
contract RagdollCat is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"RAGDOLLCAT🐱"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x8E9270df43d9DEa7C023d7EF6f6DAa26781CB99B);
