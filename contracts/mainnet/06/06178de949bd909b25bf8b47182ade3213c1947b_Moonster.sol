...
/* 
Telegram: https://t.me/Moonsterofficial
 */
...
//address
    ...
    address public marketingAddress = 0xBC27014aFF9C89Bdd9cb81f69e86aE59f53506d2;
    address public devAddress = 0x70FD91171D293bcf4Df7Eb3e0b5F8b86D6a2070C;
    address public teamAddress = 0x70FD91171D293bcf4Df7Eb3e0b5F8b86D6a2070C;
    address public liquidityAddress = 0xA20b51A3D53735d9a5489bB738B398E1c85d6055;
//uint
    uint public buyMarketingFee = 70;
    uint public sellMarketingFee = 90;
    uint public buyLiquidityFee = 10;
    uint public sellLiquidityFee = 20;
    uint public buyDevFee = 10;
    uint public sellDevFee = 20;
    uint public buyTeamFee = 10;
    uint public sellTeamFee = 20;
...
// constructor
    constructor() ERC20("Moonster", "MOON") {
        ...
        maxSellTxAmount = total_supply / 200; // 2% supply
        maxBuyTxAmount = total_supply / 200; // 2% supply
        //spawn pair
...
//set functions
    ...
    uint Buydev, uint Buyteam,uint Selldev, uint Sellteam) external onlyOwner {
        ...
        //checks
        require(totalBuyFee + totalSellFee <= 300,"Total fees cannot be over 30%");
