...
// File: contracts/GTXToken/GTX.sol
...
contract GTXToken is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xe9Cd54746a5Ea24910BCA620383aa64420932a0a));
    address payable public _devwallet =
        payable(address(0xe9Cd54746a5Ea24910BCA620383aa64420932a0a));
    address private _donationAddress =
        0xe9Cd54746a5Ea24910BCA620383aa64420932a0a;

    string private _name = "GTX Token";
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal / 2;
    uint256 public _maxWalletSize = _tTotal / 1000000000000000;
    ...
    constructor() {
        buyFee.liquidity = 100;
        buyFee.marketing = 100;
        buyFee.dev = 100;
        buyFee.donation = 1000;

        sellFee.liquidity = 100;
