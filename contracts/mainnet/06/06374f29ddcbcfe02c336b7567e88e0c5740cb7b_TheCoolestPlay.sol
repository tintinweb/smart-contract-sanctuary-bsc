...
The Coolest Play - $COOLEST

Telegram: https://t.me/TheCoolestPlay
Twitter: https://twitter.com/TheCoolestPlay
...
contract TheCoolestPlay is IBEP20, Ownable {
    ...
    string private constant _name               = 'The Coolest Play';  
    string private constant _symbol             = 'COOLEST';    
    ...
    uint8 public constant MaxSellTax            = 20; // Max buytax = 18%

    //tax distribution
    //total normal tax = 12%
    uint8 private _devTax                       = 0;
    uint8 private _burnTax                      = 0;
    uint8 private _marketingTax                 = 40; // 5%
    uint8 private _liquidityTax                 = 18; // 2%
    uint8 private _stakingTax                   = 42; // 5%
    uint8 private _buyBackTax                   = 0; 

    //buy, sell and transfer tax
    uint8 public _buyTax                        = 12;
    ...
    address public MainReward = 0x66B881AD5738319b33E608943Ca0544E842D02e7;   // $vCOOL
...
//OnlyOwner has control of LP functions
    ...
    function UpdateTaxes(uint8 burnTaxes, uint8 buybackTaxes, uint8 devTaxes, uint8 marketingTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public authorized{
        ...
        require(buyTax<=18,"Buytax is higher than the 18%.");
