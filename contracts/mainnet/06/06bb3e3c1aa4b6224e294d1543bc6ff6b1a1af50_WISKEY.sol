...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75E1BE232c317A071810EEeB8F1cB53afA8a00EB;
...
contract WISKEY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x75E1BE232c317A071810EEeB8F1cB53afA8a00EB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WISKEY";
    string private _symbol = "WISKEY";
