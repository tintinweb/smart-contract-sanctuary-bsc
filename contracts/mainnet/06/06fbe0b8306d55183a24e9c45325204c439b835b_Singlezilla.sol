...
/**
  ...
  TG : https://t.me/singlezillabsc

  WEBSITE : https://singlezillabsc.xyz
  
  DEV LAST PROJECT 2M MC. HOLD AND EARN PASSIVE INCOME
...
contract Singlezilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Single Zilla";
    string private _symbol = "SINGLEZILLA";
