...
contract Germany is Context, IERC20, Ownable {
    ...
    string private _name = "Germany Champion";
    ...
    address public ownerAddres = address(0x76b11911Bb7eC45b7e6bACb4D53f146EBEff4cD2);
    address public devAddress = address(0x9Df7c652C5Cd52A853515f9C10edf8059149e1c4);
    address public devLpAddress = address(0x900d99587698D13f37FfE8b24Ab098941973Ac99);
