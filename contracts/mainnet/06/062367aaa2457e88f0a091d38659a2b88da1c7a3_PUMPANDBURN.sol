...
/**
  Website : https://pumpandburn.io
  Telegram : https://t.me/PUMPANDBURN
*/
...
contract PUMPANDBURN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PUMPANDBURN", "PUMB") {
        marketingWallet = payable(0x32a43B64eeAfb44AaC31b39270853a71637636F1);
        devWallet = payable(0x61bAcF3aa73B784EC02024b441f54d9033972Ed3);
        ...
        swapTokensAtAmount = totalTokenSupply / 100; // 1.0%;
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    IUniswapV2Router02 public uniswapV2Router;
     ...
     PUMPANDBURN public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = PUMPANDBURN(mainContract);
