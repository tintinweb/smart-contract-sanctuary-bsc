...
contract WEMIX is ERC20, Ownable {
    ...
    address public _devAddress = 0x3e17B45992DED8f1100db6512ACb3b325B600237;
	
	address public _devAddress2 = 0x90B47676F49E596858F8617D9e73e40cb112081B;
   ...
   mapping(address => bool) public _isBlacklisted;
    ...
    uint256 public minPeriod = 43200;
    
    uint256 distributorGas = 100000;

    uint256 public _maxTxAmount = 100000000 * 10**18;
	
    uint256 public _sellMaxTxAmount = 100000000 * 10**18;

    uint256 public _inviteTxAmount = 1000 * 10**18;
    ...
    constructor() payable ERC20("WEMIX DAO", "WEMIX") {
