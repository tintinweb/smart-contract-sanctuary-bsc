 ...
 *SHIBA PUNK
  ...
  Let's build a community newer and stronger..💪

  The community which will stronger than ever and has the potential to explode in this crypto market. 

  🔗 JOIN US NOW AND THANKS US LATER. 🔗
  🔗 SHOW YOUR SUPPORT. 🔗 
  ...
  🎁 REWARDS 🎁
  7% $ BUSD for the holder's 

  ⚗️ LIQUIDITY ⚗️
  4% for Rising Price Floor

  🛒 MARKETING 🛒
  2% Funds for Continuous Growth

  🧙‍♀️TOTAL SUPPLY 🧙‍♀️
  1 Trillion of which half will be burned during launch

  🔐 LIQUIDITY LOCKED 🔐
  Initially it will be lock for 7 day if things go in our favor we will extend it for a month.
...
contract SHIBAPUNK is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA PUNK";
