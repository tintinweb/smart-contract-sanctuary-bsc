...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0DB989F1Fd32030Dfa16BcA1B6089183E79bfC52; // owner address
...
contract GoogleProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Google Protocol";
    string private _symbol = "$GPR";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x0DB989F1Fd32030Dfa16BcA1B6089183E79bfC52); 
    address payable public teamWalletAddress = payable(0x0DB989F1Fd32030Dfa16BcA1B6089183E79bfC52);
