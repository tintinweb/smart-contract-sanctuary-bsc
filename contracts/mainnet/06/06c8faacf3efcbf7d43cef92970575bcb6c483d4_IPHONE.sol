...
contract IPHONE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc8167230f95DA5E672F422F74A02A013D8e82D3D); // Marketing Address
    address payable public teamWalletAddress = payable(0xc8167230f95DA5E672F422F74A02A013D8e82D3D); // Team Address
    ...
    uint256 private _totalSupply = 308 * 10**_decimals;
    uint256 public _maxTxAmount = 308 * 10**_decimals; 
    uint256 public _walletMax = 308 * 10**_decimals;
