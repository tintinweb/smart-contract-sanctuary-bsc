...
contract Queen is ERC20 {
    ...
    uint256 public oneDividendNum = 120;
    uint256 public _walletMax = 66 *10**18;
    ...
    constructor() ERC20("Queen", "Queen") {
        ...
        _tokenOwner = address(0x5692D1EE6E2474CEa1F9F0fA21713708929b7bA3);
        marketAddress = address(0xE70662FBF9007E89ae35b694D96dF9345b86AaA7);
        teamAddress= address(0x7e579437A5208E60C23F0Fa8C4Ea86800B48E96e);
        ...
        _mint(_tokenOwner, 6666 * 10**18);
        divLpHolderAmount = 1 * 10**16;
        lpTokenDivThres = 200 * 10**18;
    }
