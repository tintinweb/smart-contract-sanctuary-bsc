...
/**
 * Welcome to  $NIBIRU BNB RWRDS - BabyVigimon Ecosystem - $GNFTxLabs -  https://t.me/BabyVigimonportal
*/ 
...
contract NIBIRU is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x9c888088572656918B1eFCbE741359b913a087e5;

    string constant _name = "NIBIRU";
    string constant _symbol = "$Nibiru";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 9**5 * 10**_decimals;
