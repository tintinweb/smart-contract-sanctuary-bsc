...
/////////////////// ADMIN FUNCTIONS ///////////////////////////////////////////////////////////////////////
    ...
    function supplyRandomness(uint256 _nonce, uint256[] memory randomNumbers) external onlyVRF {
        if(nonceProcessed[_nonce]) {
            ...
            winnersOfCurrent[0] = allBuysSinceLastJackpot[(randomNumbers[0] % allBuysSinceLastJackpot.length)];
            winnersOfCurrent[1] = allBuyers[(randomNumbers[1] % allBuyers.length)];
        }
