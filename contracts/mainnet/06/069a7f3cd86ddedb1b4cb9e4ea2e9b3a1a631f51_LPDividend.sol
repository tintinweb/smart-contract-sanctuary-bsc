...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, address MarketAddress, address NFTAddress){
        ...
        fod = Ifod(0x2Bd64fdD25d87893DF2a5762a6F098Da39fB1F75);
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), marketAddress, usdtBalance * 15/ 100); //3d
        USDT.transferFrom(address(_tokenDistributor), address(this), usdtBalance * 25 / 100);
    }
...
contract LPDividend is AbsToken {
    constructor() AbsToken(
        ...
        address(0x98a6C2CeD4E49215a4E5c5D3D3Ce3fA5E3Fa1803),
   
        address(0x2Bd64fdD25d87893DF2a5762a6F098Da39fB1F75),
  
        address(0x05a0672393ACA39F6112A1a5EfD2349E7d8bec75)
    ){
