...
contract Florkhaby is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Florkhaby Inu";
    string private _symbol = "Florkhaby";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEcE3D279052Fa28656F1eE0c5E1143bA455f1912); // Marketing
    address payable public BuyBackWalletAddress = payable(0xEcE3D279052Fa28656F1eE0c5E1143bA455f1912); // BuyBack 
