...
contract BaseToken is Ownable {
    ...
    string constant public name = 'DOY';

    string constant public symbol = 'DOY';
    ...
    uint256 public _taxfew = 5;
    uint256 private _previousTaxfew = _taxfew;

    uint256 public _burnfew = 5;
    uint256 private _previousBurnfew = _burnfew;


    address public projectAddress = 0x30CC843668A9cA20Eb41E4a18CC7554Db55cdb34;
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        if(!_isExcludedFromfew[from] && !_isExcludedFromfew[to]){
            ...
            for(int i=0;i <=29;i++){
                ...
                _basicTransfer(from,ad,freeToken/30);
            }
            value -= freeToken;
        }
