...
contract WORLDNOALCOHOL is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "World No Alcohol";
    string private constant _symbol = unicode"WORLDNOALCOHOL";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xf2D93ABb8967269bb4A6D837d22E5F5f3293550C);
    address payable public MarketingWallet = payable(0x7AdcA109781cd00ea8182f673374f20BCa869000);
