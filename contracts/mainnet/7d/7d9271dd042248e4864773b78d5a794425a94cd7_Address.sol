...
contract LiracContract is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 330000000 * 10**9;
  string private _symbol = "LIRAC";
  string private _name = "Lirac";
