...
contract Bonk413 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4130 * 10**9;
    uint256 public _maxTxAmount = 1239 * 10**8; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Bonk 413"; // 
    string private constant _symbol = "B413"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x705cC292c67a4625A9b9576BfB85589392b34ECd;
