...
contract TrustTestSAFU is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("TrustTestSAFU", "TrustTestSAFU", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x230265aBEBf3987792BD4A1cA194081621F95A03;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TrustTestSAFU token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
