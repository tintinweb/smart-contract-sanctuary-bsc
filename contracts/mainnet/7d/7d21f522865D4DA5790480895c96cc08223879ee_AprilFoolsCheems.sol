...
contract AprilFoolsCheems is IBEP20, Auth {
    ...
    string constant _name = "April Fools Cheems";
    string constant _symbol = "AFC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100; //5%
