...
contract FuckPanGu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuckPanGu";
    string private _symbol = "FuckPanGu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9c48AdEC47dcc980c6a36211Df22eAB667C2B74);
    address payable public teamWalletAddress = payable(0xA9c48AdEC47dcc980c6a36211Df22eAB667C2B74);
