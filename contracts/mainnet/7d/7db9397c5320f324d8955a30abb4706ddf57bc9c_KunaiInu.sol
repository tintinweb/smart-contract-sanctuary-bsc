...
contract KunaiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC3018D0bdDC0Af8545de797eEdC1EE80cf952e3B); 
    address payable public Wallet_Dev = payable(0xC3018D0bdDC0Af8545de797eEdC1EE80cf952e3B);
    ...
    string private constant _symbol = unicode"KUNAI"; 
    ...
    constructor () {
        ...
        _owner = 0xC3018D0bdDC0Af8545de797eEdC1EE80cf952e3B;
