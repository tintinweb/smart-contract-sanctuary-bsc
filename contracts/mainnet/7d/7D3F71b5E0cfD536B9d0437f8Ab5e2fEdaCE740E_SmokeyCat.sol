...
contract SmokeyCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Smokey Cat";
    string constant _symbol = "SCAT";
    ...
    uint256 public extraFeeOnSell = 65;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x35ca0f5C65761F995174A6DEEC21FE6B94788Ec7;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) public authorized {
