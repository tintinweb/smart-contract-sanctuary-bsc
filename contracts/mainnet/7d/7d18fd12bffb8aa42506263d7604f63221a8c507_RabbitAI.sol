...
library Address{
 ...
 contract RabbitAI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xdb8ADd6d53e7470996C0b86d5707791A8Af95a27;
    address public donationWallet = 0xdb8ADd6d53e7470996C0b86d5707791A8Af95a27;

    string private constant _name = "RABBIT AI";
    ...
    Taxes public sellTaxes = Taxes(1, 1, 1, 1);
