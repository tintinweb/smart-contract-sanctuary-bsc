...
contract BabyWhalesClubs is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Whales Clubs";
    string private constant _symbol = "$BWC";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 960362459077809 * 10**_decimals;
    uint256 public _maxTxAmount = 28810873772334 * 10**_decimals;
    uint256 public _maxWalletAmount = 28810873772334 * 10**_decimals;
