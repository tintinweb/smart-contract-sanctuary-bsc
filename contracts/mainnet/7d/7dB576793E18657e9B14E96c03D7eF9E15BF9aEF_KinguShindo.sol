...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x132CdBAC32A789529B6Eb6940cB837737263EE76; // owner address
...
contract KinguShindo is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Kingu Shindo";
    string private _symbol = "KinguShindo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x132CdBAC32A789529B6Eb6940cB837737263EE76); // Marketing Address
    address payable public teamWalletAddress = payable(0x132CdBAC32A789529B6Eb6940cB837737263EE76); // Team Address
