...
contract Amazingsafuu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Amazing safuu";
    string private _symbol = "Asafuu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A4d55b0F9796bc6eC6b8928e00968755283DAA2);
    address payable public teamWalletAddress = payable(0x5A4d55b0F9796bc6eC6b8928e00968755283DAA2);
