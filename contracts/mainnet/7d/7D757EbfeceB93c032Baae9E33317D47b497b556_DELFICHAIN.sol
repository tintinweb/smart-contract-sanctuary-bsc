...
contract DELFICHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Delfi Chain";
    string private _symbol = "DELFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x589705dB4Ca8bcBa8F1790271b9f00C30F4e0F12); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x589705dB4Ca8bcBa8F1790271b9f00C30F4e0F12); // Development Address
