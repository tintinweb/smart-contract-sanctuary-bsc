...
CloudHelper has been set up to provide additional marketing support
to CloudChat.  WE ARE NOT ASSOCIATED WITH CLOUDCHAT.
Marketing wallet assigned is the CloudChat Deployer.
We simply believe in their product and want to support
while giving investors an alternate exposure to CloudChat.
3% Max Wallet / Transaction
3% Marketing Tax sent to CloudChat
2% Dev Fee
...
contract CloudHelper is IBEP20, Auth {
    ...
    string constant _name = "CloudHelper";
    string constant _symbol = "CChelper";
    ...
    address private marketingFeeReceiver =0xc994a598fDf2ef984a65b3dDB42A83f9B332e563;
    address private teamFeeReceiver =0xadBA61DfeD42a2564b4Bc13b386B0603ABF08A65;
