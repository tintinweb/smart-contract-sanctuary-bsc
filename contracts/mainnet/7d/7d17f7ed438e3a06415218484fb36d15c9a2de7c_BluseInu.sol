...
contract BluseInu  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Bluse Inu";
    string private _symbol = "BLUSE";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x255e35DB0221E48BF36D5C16700CAa950B6C1F0E));
        marketingWalletAddress = payable(address(0x255e35DB0221E48BF36D5C16700CAa950B6C1F0E));
