...
contract T1 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby BLST";
    string private _symbol = "Bbay BLST";
    ...
    address payable public marketingWalletAddress = payable(0x6b3352F233736dDB79C036b22E797f2b525cd62F);
    address payable public liquidityWalletAddress = payable(0xAAe74297d512Ad2170AEDef69De1560fA228AD1e);
