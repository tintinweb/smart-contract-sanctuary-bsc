...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(RewardTokenSET); //usdt
...
contract BTCDAO is IBEP20 , Auth, BaseToken {
	...
	uint256 public marketingWalletPercent = 80;										
    ...
    constructor(
        ...
        anothermarketingWallet = 0x128CBa0d3c9bBBBc19eA58b467B87f0666666998;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(marketingWalletPercent).div(100);
