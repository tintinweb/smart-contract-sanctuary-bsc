...
contract GoDrive is Ownable {
    ...
    uint256 public lastPrice = 220000000000000000;
    ...
    constructor(IPesla _rewardToken,address _pancakeRouter,IBEP20 _usdtToken,IBEP20 _bnbToken) public {
        ...
        carPackage.priceUSDT = 1 * (10**18);
        carPackage.serviceUSDT = 1 * (10**18);
        carPackage.refuelUSDT = 1 * (10**18);
        carPackage.roadtaxUSDT = 1 * (10**18);
        
        Package storage motorPackage = packages[13];
        motorPackage.priceUSDT = 1 * (10**17);
        motorPackage.serviceUSDT = 1 * (10**17);
        motorPackage.refuelUSDT = 1 * (10**17);
        motorPackage.roadtaxUSDT = 1 * (10**17);
    }
    ...
    function buy(uint256 userId,uint256 _packageId) public{
        ...
        require(currentPrice<lastPrice*5,"price is to high");
