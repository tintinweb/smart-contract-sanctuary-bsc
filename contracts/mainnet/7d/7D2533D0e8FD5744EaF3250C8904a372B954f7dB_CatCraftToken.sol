...
contract CatCraftToken is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('CatCraftToken', 'CCT') {
        require(
            feeAccount != address(0),
            'CatCraftToken: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'CatCraftToken: incorrect fee percent');
        require(owner != address(0), 'CatCraftToken: incorrect owner address');
        require(mintToAddr != address(0), 'CatCraftToken: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'CatCraftToken: transfer from the zero address');
        require(recipient != address(0), 'CatCraftToken: transfer to the zero address');
