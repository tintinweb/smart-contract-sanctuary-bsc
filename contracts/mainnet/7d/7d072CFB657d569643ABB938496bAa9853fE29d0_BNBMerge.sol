...
The next 1000x moonshot.
After ETH Merge, BNBMerge will be trending in Twitter soon and we are early!

Based dev and deployer, intense marketing and BULLISH NAME!

TG : https://t.me/BNBMerge
*/
...
contract BNBMerge is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7B50d2928329A00b277c75C1C124D084629c761b); 
    address payable public Wallet_Dev = payable(0x7B50d2928329A00b277c75C1C124D084629c761b);
    ...
    string private constant _name = "BNBMerge"; 
    string private constant _symbol = "BNBMerge"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 1000 / 1000;
