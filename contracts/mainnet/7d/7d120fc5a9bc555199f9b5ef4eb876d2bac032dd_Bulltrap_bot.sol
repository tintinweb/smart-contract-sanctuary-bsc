...
contract Bulltrap_bot is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Bulltrap_bot";
    string private constant _symbol = "BULLTRAP";
