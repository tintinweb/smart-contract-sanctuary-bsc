...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`newDEVwantsMOONOwner`).
...
contract DEVwantsMOON_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEVwantsMOON";
    string private constant _symbol = "$DEVMOON";
