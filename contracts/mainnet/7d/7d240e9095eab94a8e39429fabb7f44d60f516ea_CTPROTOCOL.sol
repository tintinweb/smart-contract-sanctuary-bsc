...
TELEGRAM: https://t.me/CurrentThingProtocolofficial
*/
...
contract CTPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Current Thing Protocol ";
    string private _symbol = " $CTPROTOCOL "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEE4FF0eF109ddA888d896abDD5e72268f701E7e2); 
    address payable public teamWalletAddress = payable(0xEE4FF0eF109ddA888d896abDD5e72268f701E7e2); 
