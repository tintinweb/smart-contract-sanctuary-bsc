...
contract ShigarakiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shigaraki Inu"; // 
    string private constant _symbol = "$SINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2373Ad259Bb1Bcc434362740DC264C2fC851bE9f;
