        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xb6Bd839Ffe500e3d9617A5A40693d522bA8F860b), block.timestamp
                );
            }
        }
    }
...
contract Supersoon is AbsToken {
    constructor() AbsToken(
        ...
        address(0xCcd646D553c5CC6519ea281D6673a4b178D4294d),//FundAddress
        address(0x9b8f7DaE92256bE23f7871EeeBD23130cae3F74A)//ReceiveAddress
    ){
    }
}