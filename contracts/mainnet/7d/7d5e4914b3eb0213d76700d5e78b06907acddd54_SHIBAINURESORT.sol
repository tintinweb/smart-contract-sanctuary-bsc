...
//  SHIBA INU RESORT!  - Did u miss Doge Resort, so, don't missed for the SHIBA INU RESORT!


    we just had to make this super quick from TRENDY RESORT TOKENS . 

    This is a real community driven token with 6% tax and SUPER HYPE!!, website in development.

    Features LIQUIDTY LOCKED, RENOUNCED OWNERSHIP, and no dev wallet.

    TOTAL SUPPLY      : 100 Billion Tokens
    MAX WALLET / TX   : 3% / 3000000000 / 3 Billion Tokens
   

//  TG: https://t.me/ShibaInuResortPortal
...
contract SHIBAINURESORT is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBA INU RESORT";
    string private constant _symbol = "$RESORT";
    ...
    address private marketingWallet = address(0xB0ca5344a37d3Eb126342994b3A80Da42b3D1bb7);
    address private liquidityReceiver = address(0xc2A14475298F4DC11BCC33947841dBE3a449DE7b);
