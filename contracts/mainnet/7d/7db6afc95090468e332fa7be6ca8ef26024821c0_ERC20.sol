...
//BCK积分合约
contract ERC20 {
    string public name = "JIFEN";
    string public symbol = "JF";
    ...
    bool public isCheckWhite = true; // 是否开启白名单
    ...
    function setOwner(address new_addr) public onlyOwner {
        owner = new_addr;
    }
    ...
    function setCheckWhite(bool new_isCheckWhite) public onlyOwner {
        isCheckWhite = new_isCheckWhite;
    }
