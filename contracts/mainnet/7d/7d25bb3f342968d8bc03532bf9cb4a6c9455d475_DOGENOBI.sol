...
contract DOGENOBI is Context, IERC20, Ownable {
    ...
    address public DogeNobi_MarketingWallet = 0x8777C88E536B5678cdE14367A568b6880476Cf5E;
    address public DogeNobi_RoyalWallet = 0x8777C88E536B5678cdE14367A568b6880476Cf5E;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[DogeNobi_MarketingWallet] = true;
        _isExcludedFromFee[DogeNobi_RoyalWallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[DogeNobi_MarketingWallet] = true;
        allowedTransfer[DogeNobi_RoyalWallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(DogeNobi_MarketingWallet).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(DogeNobi_RoyalWallet).sendValue(teamAmt);
        }
    }
    ...
    function DogeNobi_UpdateMarketingWallet(address newWallet) external onlyOwner{
        DogeNobi_MarketingWallet = newWallet;
    }
    
    function DogeNobi_UpdateRoyalWallet(address newWallet) external onlyOwner{
        DogeNobi_RoyalWallet = newWallet;
    }
