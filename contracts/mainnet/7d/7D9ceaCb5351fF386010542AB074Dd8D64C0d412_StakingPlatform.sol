...
contract StakingPlatform is Ownable {
    ...
    function Init() internal {
        ...
        _rewardRate = 50; // per day
        _unstakingFeeRate = 1500;
        _rewardFeeRate = 10;
        _eventPeriod = 7;
        _lockupPeriod = 90;
        _minStakeAmount_m = 3* 10**24;
        _minStakeAmount_c = 10**24;
        _minStakeAmount_s = 3 * 10**24;
        _minStakeAmount_g = 7 * 10**24;
    }
    ...
    function getStakerInfo(address staker) public view returns (Staker memory) {
        require(_staker[staker].staked == 55);
