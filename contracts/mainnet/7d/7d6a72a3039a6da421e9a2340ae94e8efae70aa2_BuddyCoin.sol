...
contract BuddyCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Buddy Coin";
    ...
    address public charityWallet = 0x50698C9Cb66D42c936B59977dDc9561Aba7d6BE2;
    ...
    function setBuddyCharityWallet(address newWallet) external onlyOwner() {
