...
/**
* She Goes By The Name Twitter Girl, But Her Real, Name is Twirl :)
* Safe Launch, with many More To come
* Send Twirl To the Moon, Before She Gets Tired Of Earth.
 -N.M.L.M.
Telegram: https://t.me/TwitterGirlsBSC
*/
...
contract TwitterGirl is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x209F0FFf2F476EC09CCb5090B3396f026164693e); 
    address payable public Wallet_Dev = payable(0x209F0FFf2F476EC09CCb5090B3396f026164693e);
    ...
    string private constant _symbol = unicode"TWIRL"; 
    ...
    constructor () {
        ...
        _owner = 0x209F0FFf2F476EC09CCb5090B3396f026164693e;
