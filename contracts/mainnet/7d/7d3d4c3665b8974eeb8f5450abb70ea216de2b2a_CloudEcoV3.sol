    ...
    function addUser(address _user, address _referrer,uint256 _amount) public onlyOwner{
     ...
     function importUser(uint256 index,uint length) public onlyOwner{
        ...
        for(uint256 i=start;i<end;i++){
            ...
            user.pendingReward=pendingReward(0,usersimport[i]);
            ...
            pool.totalStakedUSD = pool.totalStakedUSD.add(userimport.amountUSD12);
            pool.totalStakedXOS = pool.totalStakedXOS + userimport.amount12;
        }
    }
