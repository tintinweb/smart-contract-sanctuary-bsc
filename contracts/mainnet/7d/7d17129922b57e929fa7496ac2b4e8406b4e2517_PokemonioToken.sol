...
Pokemonio is an innovative DeFi and NFT Marketplace hybrid project based on the Binance
Smart Chain. It will contain many products that will allow users to earn passive
income and trade NFTs. Pokemonio offers a wide range of facilities
for its users. It combines all the knacks that a crypto user is looking for.
Check our products: - PokeDex - PokeStaking - PokeNFT Marketplace
- PokeLending - PokeLaunchpad - PokeGames - PokeApp - All Pokemonio
...
interface PokemonioTokenDeployer {
...
contract PokemonioToken is PokemonioTokenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PokemonioTokenTeam;
    address private CharityPokemonioToken;
    ...
    string public override name = "Pokemonio Token";
    string public override symbol = "POK";
    ...
    constructor(uint totalSupplyValue, address PokemonioTokenTeamAddress, address CharityPokemonioTokenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PokemonioTokenTeam = PokemonioTokenTeamAddress;
        CharityPokemonioToken = CharityPokemonioTokenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PokemonioTokenTeam] =  totalSupply * 4 / 100;
        balances[CharityPokemonioToken] = totalSupply * 4 / 100;
