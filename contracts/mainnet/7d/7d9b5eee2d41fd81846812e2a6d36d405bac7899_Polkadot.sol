...
contract Polkadot is Context, IERC20, Ownable {
    ...
    string private constant _name = "PolkadotEarn"; // 
    string private constant _symbol = "DOTE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x87a7A5e3072A2494d4B2208B95d46dA48D66481d;
