...
contract Rising is ERC20, Ownable {
    ...
    constructor() ERC20("RISING BIRD", "RISING") {
        buyFee = 0;
        sellFee = 0;

        address owner_ = address(0x62e0781346E69e4b1c2227e44913635E814a4158);

        // exclude from paying fees
        excludeFromFees(address(this), true);
        excludeFromFees(owner_, true);

        buyLimit = 500000000000000000000000000;
        sellLimit = 5000000000000000000000000000;

        // minting
        uint256 initialSupply = 100_000_000_000_000 * (10 ** 18);
