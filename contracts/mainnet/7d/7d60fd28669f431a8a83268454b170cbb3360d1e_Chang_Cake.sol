...
// CHANGE
contract Chang_Cake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Chang Cake";
    string constant _symbol = "CC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 100
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000; // 1.5% MAX 15
    uint256 public _maxWalletSize = (_totalSupply * 15) / 1000; // 1.5% MAX 15
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x25CE5d5d5351fEDa761aa4Db2E7Ba8c9a5292b76);
