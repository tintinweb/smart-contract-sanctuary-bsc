...
contract MOT is Context, IERC20, Ownable {
    ...
    string private _name = "Manufacturing Output Token";
    ...
    uint256 public _liquidityFee = 125; // 1.25% fee
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketingFee = 50; // .50% fee
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**8;
    uint256 public numTokensSellToAddToLiquidity = 5000000 * 10**8;
    uint256 public minNumTokensSellToAddToLiquidity = 5000 * 10**8;
