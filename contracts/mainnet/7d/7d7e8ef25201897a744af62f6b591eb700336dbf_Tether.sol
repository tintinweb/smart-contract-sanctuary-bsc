...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11a3924c889F45ADdb2E705999a9Ed4e01D41aD7;
...
contract Tether is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x06bf6711B40A1D951412b3A3Db25E3540D9F59BC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tetherium";
    string private _symbol = "Tetherium";
