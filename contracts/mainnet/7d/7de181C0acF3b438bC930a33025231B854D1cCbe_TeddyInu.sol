...
contract TeddyInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB                        = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD                        = 0x000000000000000000000000000000000000dEaD;
    address ZERO                        = 0x0000000000000000000000000000000000000000;
    address devFeeReceiver              = 0x41BC965DF4B8c4e30c0dd5F8C88bd6d9e5b424E0; 
    address public marketingFeeReceiver = 0x1409D055e4EE39B05cE723A1B22eE35aeC8F6AE2;
    address public autoLiquidityReceiver;

    string constant _name               = "Teddy Inu";
    string constant _symbol             = "Teddy Inu";
    uint8 constant _decimals            = 9;

    uint256 _totalSupply                = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount         = _totalSupply.mul(2).div(10);
    uint256 public _maxWalletToken      = _totalSupply.mul(3).div(10);
