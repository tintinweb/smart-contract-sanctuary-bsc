...
address constant FEE_DISTRIBUTOR = 0xe56CDDA1AC1Eb38cf7BBbdb2Ae7d78bADF4e8358;

/// @notice withdraw unclaimed fee to distribution contract
/// as approved in LIP#11
/// see https://app.level.finance/dao/proposals/0x734cc8f4fa85a2563112067c766acc3a648726d1b113aeec464a0b8e83318caf
contract PoolWithdrawUnclaimedFee is Pool {
    function init_withrawFee() external reinitializer(6) {
        _doTransferOut(btc, FEE_DISTRIBUTOR, 3079346095216820503);
        _doTransferOut(eth, FEE_DISTRIBUTOR, 36123472742669774733);
        _doTransferOut(bnb, FEE_DISTRIBUTOR, 576323216590695249254);
        _doTransferOut(cake, FEE_DISTRIBUTOR, 80964218825131812676);
        _doTransferOut(usdt, FEE_DISTRIBUTOR, 130054170624871956796413);
        _doTransferOut(busd, FEE_DISTRIBUTOR, 278794516122378857236578);
    }
}