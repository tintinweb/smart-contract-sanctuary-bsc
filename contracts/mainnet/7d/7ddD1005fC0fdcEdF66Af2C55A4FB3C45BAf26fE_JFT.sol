...
contract JFT is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 40_000_000 * 10**18;
    ...
    address public marketingWallet = 0x51A595A20f1522c94C2EF3bDBaACBe15D64770dE;
    address public devWallet = 0x51A595A20f1522c94C2EF3bDBaACBe15D64770dE;
    address public operationsWallet = 0x51A595A20f1522c94C2EF3bDBaACBe15D64770dE;
    address public charityWallet = 0x51A595A20f1522c94C2EF3bDBaACBe15D64770dE;
    ...
    Taxes public taxes = Taxes(5, 3, 2, 0, 0, 0);
    Taxes public sellTaxes = Taxes(5, 3, 2, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Just For Test", "JFT") {
