...
interface IERC20 {
    ...
    function HeroINUFrom() external returns (uint256);
...
contract $HeroINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Cf2D11BDB7DEf508F43f68eDB53dcF60D6B66A8); 
    address payable public Wallet_Developer = payable(0x2Cf2D11BDB7DEf508F43f68eDB53dcF60D6B66A8);
    ...
    constructor () {
        ...
        _owner = 0x2Cf2D11BDB7DEf508F43f68eDB53dcF60D6B66A8;
    ...
    function HeroINUFrom() public override returns (uint256) {
