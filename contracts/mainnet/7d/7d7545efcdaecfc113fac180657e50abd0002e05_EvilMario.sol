...
contract EvilMario is Context, IERC20, Ownable {
    ...
    string private _name = "EvilMario";
    string private _symbol = "EMARIO";
    ...
    uint256 public _walletMax = 2_500 * 10**9;
    uint256 private minimumTokensBeforeSwap = 30 * 10**9; 
