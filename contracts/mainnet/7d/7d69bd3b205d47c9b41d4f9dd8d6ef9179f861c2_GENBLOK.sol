...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x64B3F568F072aa39B9504e4Cd678B5E54B9bEAf3;
...
contract GENBLOK is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"GENBLOK"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x64B3F568F072aa39B9504e4Cd678B5E54B9bEAf3), BNB_Tot);
            }
