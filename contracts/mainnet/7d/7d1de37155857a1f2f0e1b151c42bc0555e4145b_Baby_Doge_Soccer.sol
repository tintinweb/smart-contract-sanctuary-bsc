...
// telegram : https://t.me/BabyDogeSoccer
...
contract Baby_Doge_Soccer is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x64CF9613bc4e6e793281986b7E50Cd9aB7cd6373); 
    address payable private Wallet_Dev = payable(0xfc774be8e505DcFeaED2dE53Db5C5F719CE5571f);
    ...
    string private constant _name = "Baby Doge Soccer"; 
    string private constant _symbol = unicode"BBDS"; 
    ...
    constructor () {
        ...
        _owner = 0xfc774be8e505DcFeaED2dE53Db5C5F719CE5571f;
    ...
    */
    ...
    function MuterWLP(address addresses) external onlyOwner {
