...
// 
//
// 📱 Telegram:https::https://t.me/TrustWhales
...
contract TrustWhales is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Trust Whales", "TrustWhales") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TrustWhales";
    string private _symbol = "TrustWhales";
