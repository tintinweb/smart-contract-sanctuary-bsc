...
contract McYeezy is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "McYeezy";
    string constant _symbol = "MCY";
    ...
    uint256 public _sellMultiplierNumerator = 400;
