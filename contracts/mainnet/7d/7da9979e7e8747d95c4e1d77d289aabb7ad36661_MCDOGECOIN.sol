...
// MCDO will reveal at superbowl they will accept dogecoin payments from now
...
contract MCDOGECOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MCDOGECOIN";
    string private _symbol = "MCDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x356923d7b354f5bde606dC2e1df8ff1473107d59); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x356923d7b354f5bde606dC2e1df8ff1473107d59); // BuyBack Address
