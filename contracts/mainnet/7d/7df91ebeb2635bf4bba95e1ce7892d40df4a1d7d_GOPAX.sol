...
contract GOPAX is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOPAX";
    string private constant _symbol = "GOPAX";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c);
    address payable private _marketingAddress = payable(0xb38a597bF2e64bD1a071b65906deCB77d6e70C9c);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 79, "Redis cannot be more than 79.");
	    require(redisFeeOnSell < 79, "Redis cannot be more than 79.");
	    require(taxFeeOnBuy < 79, "Tax cannot be more than 79.");
	    require(taxFeeOnSell < 79, "Tax cannot be more than 79.");
