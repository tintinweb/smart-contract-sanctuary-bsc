...
// Unlicensed does not mean Open Source 
...
Contract created by GEN https://gentokens.com
...
contract GEN is Context, IERC20 { 
    ...
    */             
    ...
    uint256 public Swap_BNB     = 2 * 10**17;       // BNB swap target (in Wei) 0.2 BNB - Set to 0 stop auto updates
...
Do not fork - not open source - Custom contract created by GEN
If you want me to create your token, fill out the form on my website
