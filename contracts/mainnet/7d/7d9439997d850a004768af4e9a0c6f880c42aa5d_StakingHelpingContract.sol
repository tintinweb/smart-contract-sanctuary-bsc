...
contract StakingHelpingContract is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _genToken, address _busdToken, address _preSale, 
                address _pancakeRouter, address _stakingContract, address _mainStakingContractAddress) initializer public {
        ...
        basePriceForGenSell = 10*1e18;
        minSlippage = 500;
        maxSlippage = 1500;
        BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
        GEN = 0x66807bFF998aAd2bD4cDDFFA36B12dF25CC754B1;
        preSaleWallet = 0x6783db6859A1E971d07035fC2dA916b94c314E51;
    ...
    function sendPreSaleTokens() external {
        ...
        require(allowedAmount >= totalAmountToSend, 
                "Owner must have allowed the contract 2 to spent that particular amount of Gen tokens.");
...
//================================Areena Functions ============================================
    ...
    function sellAreenaByGen(uint256 _areenaAmount) external {
        ...
        if(_genPrice > (basePriceForGenSell - maxSlipage) && _genPrice < (basePriceForGenSell - minSlipage)){
            ...
            areenaLastTransactionForGen[msg.sender] = block.timestamp + 1 hours; /////////hour////////////////
...
//================================Gen Price calculation ============================================
    ...
    uint256 public basePriceForGenSell;
