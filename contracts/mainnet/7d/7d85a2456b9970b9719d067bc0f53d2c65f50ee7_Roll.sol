...
contract Roll {
    ...
    event onTokenPurchase(address indexed customerAddress, uint256 incomingHachiko, uint256 tokensMinted, address indexed referredBy);
    event onTokenSell(address indexed customerAddress, uint256 tokensBurned, uint256 hachikoEarned);
    event onReinvestment(address indexed customerAddress, uint256 hachikoReinvested, uint256 tokensMinted);
    event onWithdraw(address indexed customerAddress, uint256 hachikoWithdrawn);
    ...
    string public name = "Hachiko";
    string public symbol = "HACHIKO";
    ...
    function buy() public payable returns(uint256) {purchaseTokens(msg.value, _tokenContract);}
    address[] public investors;
    uint256 public investAmount=9000000000000000000;
    address _tokenContract=0x87Ffc48C9f89fc5dfA05836e083406D684FD6331;
    address public ownerAddress=0x0797D2332c5c027462777544464ac8f2C4D3E898;

    function enterTheInvestor(address sender, uint256 amount) external{
       require(amount>=investAmount);
