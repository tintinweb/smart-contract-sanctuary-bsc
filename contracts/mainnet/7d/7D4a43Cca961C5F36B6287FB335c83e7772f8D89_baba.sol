...
//  iquidityFee + marketFee + developmentFee

contract baba is ERC20, Ownable  {
    mapping (address => bool) private _isExcludedFromFee;

    address public constant marketAddress = 0xb7F3453dd6DEc6f16f88E9e9137D7a398Bf43b33;
    address public constant devAddress = 0xb7F3453dd6DEc6f16f88E9e9137D7a398Bf43b33;

    uint256 private constant total =  1 * 1e8 * 1e18;

    uint256 public _liquidityFee = 0; //iquidityFee
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _marketFee = 5; //marketFee
    uint256 private _previousMarketFeeFee = _marketFee;

    uint256 public _devFee = 0; //developmentFee
    ...
    function setFees(uint256 marketFee, uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee + marketFee <= 20, "ERC20: fees more than 20%");
