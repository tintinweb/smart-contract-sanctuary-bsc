...
/**
FOREMOON
JOIN US ON TELEGRAM: https://t.me/foremoonbsc
/**
   */
...
contract FOREMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FOREMOON";
    string private _symbol = "$FOREMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14A2aeb5e133Eb7BB618A735dFe407CF14050A49); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x14A2aeb5e133Eb7BB618A735dFe407CF14050A49); // BuyBack Address
    ...
    uint256 public _walletMax = 3000 * 10**3 * 10**9;
