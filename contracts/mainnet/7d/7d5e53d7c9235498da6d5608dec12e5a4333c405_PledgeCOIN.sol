...
/**
Pledge Utility Coin’s mission is to be a force for the greater good. Specifically, 
our efforts bridge the gap between global donors and nonprofits in local communities. 
In simpler terms, as Uber is to the Taxi industry, the PUC project is to the Nonprofit industry. 
We list a couple of them on our website here: www.trypledge.org.
https://twitter.com/thepledgecoin
https://www.instagram.com/thepledgecoin/
https://www.facebook.com/thepledgecoin
*/
...
contract PledgeCOIN is Context, BEP20, Ownable {
    ...
    string private _name = 'Pledge';
    string private _symbol = 'Pledge';
