...
contract SpaceHDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceHDOGE";
    string private _symbol = "SpaceHDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xb5aFd2B983470B9FCa41D333B4421A6957b84892); // Marketing Address
    address payable private teamWalletAddress = payable(0xb5aFd2B983470B9FCa41D333B4421A6957b84892); // Team Address
