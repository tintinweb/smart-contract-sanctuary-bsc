...
/*
HoneyBee is a new BSC token with a powerful concept that give holders reward of another sub-token. By holding HoneyBee, you will receive $HONEY as a reward that can give you reflection of HoneyBee token & for buying NFT from HoneyBee marketplace.
1) Powerful concept that protect the chart
2) Starting with low market cap, easy pump
3) 6% of tax fees:
~ 2% back to LP
~ 2% for reward & reflection
~ 2% for development & marketing
4) NFT marketplace (on development)

Follow & join HoneyBee on TG : https://t.me/HoneyBeeOfficial
*/
...
contract HoneyBee is Context, IERC20 { 
    ...
    string private constant _name = "HoneyBee"; 
    string private constant _symbol = "HBEE"; 
