...
// tg: https://t.me/Goat2023bsc
// tg: https://t.me/LucasECAcalls
// tax 9/9 
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 RWRD = IBEP20(0xa338292fc14f7940fB24606eB8f9DF2873b31A00);
...
contract Goat2023 is IBEP20, Auth {
   using SafeMath for uint256;
 
   address RWRD = 0xa338292fc14f7940fB24606eB8f9DF2873b31A00;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Goat2023";
   string constant _symbol = "GOAT23";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x75fdfCd0372C7b6e04811cdE346984d4Fb19f183).call{value: BNBMarketingamount, gas: 30000}("");
