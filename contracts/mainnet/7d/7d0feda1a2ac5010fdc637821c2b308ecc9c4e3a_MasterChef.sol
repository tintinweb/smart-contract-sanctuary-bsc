...
contract CakeToken is ERC20("CAKE", "Cake"), Ownable {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of Cakees
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. Cakees to distribute per block.
        uint256 lastRewardBlock;  // Last block number that Cakees distribution occurs.
        uint256 accCakePerShare;   // Accumulated Cakees per share, times 1e18. See below.
    ...
    uint256 public CakePerBlock = 1 ether;
    ...
    // View function to see pending Cakees on frontend.
    ...
    // Safe Cake transfer function, just in case if rounding error causes pool to not have enough FOXs.
