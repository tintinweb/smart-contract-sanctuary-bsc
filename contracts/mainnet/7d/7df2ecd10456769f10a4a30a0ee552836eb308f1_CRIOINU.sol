...
contract CRIOINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAd5c2fc833aF85C020061B90930133B3428A48cc); 
    address payable public Wallet_Dev = payable(0xAd5c2fc833aF85C020061B90930133B3428A48cc);
    ...
    string private constant _name = "CRIOINU"; 
    string private constant _symbol = "$CRIOINU"; 
    ...
    uint256 public totalFee = _Tax_On_Buy + _Tax_On_Sell;
    uint256 public PcMKT = 55;
    uint256 public PcDEV = 35;
    ...
    constructor () {
        ...
        _owner = 0xAd5c2fc833aF85C020061B90930133B3428A48cc;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_M = contractTokenBalance * PcMKT / 100;
            uint256 tokens_to_D = contractTokenBalance * PcDEV / 100;
            ...
            uint256 split_M = PcMKT * 100 / (Percent_AutoLP + PcMKT + PcDEV);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = PcDEV * 100 / (Percent_AutoLP + PcMKT + PcDEV);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount.mul(totalFee.div(2))/100;
            ...
            uint256 sellFEE =tAmount.mul(totalFee.div(2))/100;
