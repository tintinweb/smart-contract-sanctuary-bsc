...
contract Ownership is Context {  
    ...
    */
    ...
    function principle(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract luomu is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "luomu";
    string private _symbol = "LUOMU";
    ...
    function notify(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
