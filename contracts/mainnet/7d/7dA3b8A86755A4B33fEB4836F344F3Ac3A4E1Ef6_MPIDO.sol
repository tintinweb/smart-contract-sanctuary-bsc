...
contract MPIDO {
    ...
    constructor (address usdt) {
        ...
        Coll = 0x8773218104212D6955BdA78EF4f8412E9c13ca97;
        referrerAddress[msg.sender] = 0xD97821fcA9e6AF9f83E4e4c582550C91F7ab7809;
    }

    function buy(uint _num) public {
        require(_num == 20e18 || _num == 30e18 || _num == 50e18 || _num == 100e18, "num error");
    ...
    function partner() public {
        ...
        usdtContract.transferFrom(msg.sender, Coll, 1000e18);
