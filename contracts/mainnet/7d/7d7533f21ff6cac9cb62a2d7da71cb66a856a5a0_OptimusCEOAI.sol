...
/**
 ...
 Tg : https://t.me/OptimusCEOAI

 Nano Cap. forked contract from YEET with Auto-burn and Auto-LP.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb729b6f0b0417ADeE256246856fedA9600756b20; // owner address
...
contract OptimusCEOAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OptimusCEOAI";
    string private _symbol = "oCEOAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb729b6f0b0417ADeE256246856fedA9600756b20); // Marketing Address
    address payable private teamWalletAddress = payable(0xb729b6f0b0417ADeE256246856fedA9600756b20); // Team Address
