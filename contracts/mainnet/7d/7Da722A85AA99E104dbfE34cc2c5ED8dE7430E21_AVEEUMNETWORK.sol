...
Telegram https://t.me/Aveeumnetwork
Website https://aveeum.network
*/
...
contract AVEEUMNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AVEEUM NETWORK";
    string private _symbol = "AVEE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x505235Bd3aa69E76785Ed978760c88e363ce830a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2CcDD427b3218b1ee7b94e0dFF23eA6924B32aBd); // BuyBack Address
    ...
    uint256 private minimumTokensBeforeSwap = 10 * 10**1 * 10**9; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (6 * 10**6 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
