...
contract BacardiToken is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x7609F5B2b4028E17095Bc6D1484dd1c1ed97c79C;//other than ownership adress
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 18000000000 * 10**18;// total supply 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BacardiToken"; //name of the token 
    string private _symbol = "BACO"; //symbol
        uint8 private _decimals = 18; // e.g 1.000000000000000000 if you want to change then also change from above 
    
    uint256 private _taxFee = 0; // % from each transaction and goes to all token holder as per thier holiding sort of rewards
    ...
    uint256 public _maxTxAmount = 100000 * 10**18; //it will restric transaction according to amount
    ...
    constructor () {
        ...
        // PankcakeSwap testnet RouterAddress
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        //PancakeSwap Mainnet RoutingAddress
