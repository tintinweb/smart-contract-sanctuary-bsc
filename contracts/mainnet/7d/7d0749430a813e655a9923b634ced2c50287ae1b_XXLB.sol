...
contract XXLB is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "XXLB";
    string private _symbol = "XXLB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xcC8Bd26F8C8b0443C8FC217890230fD991230202);
    address payable public liqWalletAddress = payable(0xcC8Bd26F8C8b0443C8FC217890230fD991230202);
