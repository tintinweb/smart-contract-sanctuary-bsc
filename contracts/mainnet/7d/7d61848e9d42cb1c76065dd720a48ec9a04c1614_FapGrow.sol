...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfa65B93849dC79cDb5Bb6700B1eCb8504CDa9607; // owner address
...
contract FapGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fap Grow";
    string private _symbol = "Fap";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfa65B93849dC79cDb5Bb6700B1eCb8504CDa9607); // Marketing Address
    address payable public teamWalletAddress = payable(0xfa65B93849dC79cDb5Bb6700B1eCb8504CDa9607); // Team Address
