...
contract STAK is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Stakita";
    string private _symbol = "STAK";
    ...
    address public MarketingWallet = 0x62ee71BE7B5dA1F85BA2c5f52dc488fA4434e798;
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**18; // 10% Max transaction from total supply
