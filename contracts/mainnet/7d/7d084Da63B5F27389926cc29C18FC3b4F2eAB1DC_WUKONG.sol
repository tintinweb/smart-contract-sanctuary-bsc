...
contract WUKONG is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2FFa656213e5AfAfB0Ce69C7C4454D1cc2Fb9750); // Marketing Address
    address payable public teamWalletAddress = payable(0x4340A01F339804e3cB7246adBb3FDDB71AC20bC4); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 500000 * 5 **_decimals; 
