...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc79cCd86a4e265f63B3B7E1ef422b698A60E1C70; // owner address
...
contract HOPPINGRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOPPING RABBIT";
    string private _symbol = "HOPBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc79cCd86a4e265f63B3B7E1ef422b698A60E1C70); // Marketing Address
    address payable public teamWalletAddress = payable(0xc79cCd86a4e265f63B3B7E1ef422b698A60E1C70); // Team Address
