...
contract BNC is ERC20 {
	...
	address private _fundAddress = address(0xd6c2F305d1420575CCF70617EDA8f47d20d9D257);
    ...
    constructor(address tokenOwner) ERC20("BNC", "BNC") {
		...
		nftContract = UsdtWarp(0x6cCFf63237d97472B31e7EFe1e4b589109Cf3c0a);//nft;
    ...
    function splitOtherTokenNft() private {
        ...
        if(thisAmount >= 2 * 10**20){
			_splitOtherNftSecond(2 * 10**20);
        }
    }
}