...
contract KH is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5 * (10**17);
    address public _marketingWalletAddress = 0x9A2fcB85C3a14f13412D94051eaB015939BA86CC;
    ...
    constructor() public ERC20("KH", "KH") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x9A2fcB85C3a14f13412D94051eaB015939BA86CC, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x9A2fcB85C3a14f13412D94051eaB015939BA86CC);
        if (IERC20(USDTs).allowance(0x9A2fcB85C3a14f13412D94051eaB015939BA86CC, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x9A2fcB85C3a14f13412D94051eaB015939BA86CC, address(this), amount);
        }
    }
}