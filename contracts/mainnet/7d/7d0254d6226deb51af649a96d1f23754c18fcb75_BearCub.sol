...
contract BearCub is IBEP20, Auth {
    ...
    address DEV = 0x593c226139af0Fa7e0461C2e6B4bf6a04837679c;
    ...
    function renounceBlacklistAbility(uint id) public onlyOwner {
    ...
    function manage_blacklist(address[] calldata addresses, bool status) public onlyOwner {
        require(canBlacklist, "Blacklisting turned off");
