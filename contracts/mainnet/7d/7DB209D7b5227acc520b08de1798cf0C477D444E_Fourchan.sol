...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Pancakeswap Router
...
contract Fourchan is IBEP20, Auth {
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Pancakeswap Router
    address RewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB Optional Change
    ...
    uint256 public liquidityFee = 0; //Fees to Liquidity 
    uint256 public marketingFee = 0; // Fees to marketing wallet
    uint256 public rewardsFee = 0; // Fees for Reward Tokens
    uint256 public extraFeeOnSell = 0; //Extra fees

    uint256 public totalFee = 0; //Total fee (changes based on liq + marketing + reward fees)
    uint256 public totalFeeIfSelling = 0; //Total selling fee.
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x03d581Ff7D6EEbC23eC5842983fDFd978db5B200; //Change
