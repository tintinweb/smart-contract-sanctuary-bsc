...
contract HallowZhaoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hallow Zhaoge "; // 
    string private constant _symbol = " $HWZHAO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xe5231B378BD091680DBC4218fE46b498F699c1ac;
