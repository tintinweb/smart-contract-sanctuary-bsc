...
contract TestCA is IBEP20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 3000}("");
        require(MarketingSuccess, "receiver rejected WBNB transfer");
        (bool buybackSuccess,) = payable(buybackFeeReceiver).call{value: amountBNBbuyback, gas: 3000}("");
        require(buybackSuccess, "receiver rejected WBNB transfer");
        (bool devSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 3000}("");
