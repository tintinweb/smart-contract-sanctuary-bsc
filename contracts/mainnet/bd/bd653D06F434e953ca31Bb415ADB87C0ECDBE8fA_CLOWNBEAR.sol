...
contract CLOWNBEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Clown Bear";
    string private _symbol = "CLOWNBEAR";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1E5A4ECe9Ad6a2b334e8AAef14AA467ff0b2cC97); // Marketing Address
    address payable public teamWalletAddress = payable(0x5F1f046ce27f5F5b787256fb5C9205D54757037a); // Team Address
