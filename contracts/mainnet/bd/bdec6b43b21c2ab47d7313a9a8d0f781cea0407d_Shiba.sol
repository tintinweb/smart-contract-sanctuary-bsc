...
library Address{
 ...
 contract Shiba is Context, IERC20, Ownable {
    ...
    modifier antiBot(address account){
        require(allowedTransfer[account], "Trading not enabled yet");
        _;
    }
    ...
    address public marketingWallet = 0x46dFdd48C85baF6ECE97d2EFBdb1d2eA953120E3;
    address public donationWallet = 0x46dFdd48C85baF6ECE97d2EFBdb1d2eA953120E3;
