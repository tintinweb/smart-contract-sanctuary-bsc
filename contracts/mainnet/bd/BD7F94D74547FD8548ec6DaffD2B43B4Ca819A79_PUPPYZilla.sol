...
contract PUPPYZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUPPYZilla";
    string private _symbol = "PUPPYZilla";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x31Aee6ffbb75f55eDBcB386684F22b50c2FadeDf); 
    address payable private teamWalletAddress = payable(0x51C105CABC9ad6c0ABDa2cfEA4fEDaaDA6740170); 
