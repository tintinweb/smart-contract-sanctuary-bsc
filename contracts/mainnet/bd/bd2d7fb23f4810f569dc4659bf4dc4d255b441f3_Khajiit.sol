...
//  ((_/`(____,-'
//
// Khajiit is an Absorber token on BSC.
// Holders recieve passive income and 
// sell transactions add money to Khajiits pockets increasing the price floor
...
contract Khajiit is IERC20, Ownable, ReentrancyGuard {

    using SafeMath for uint256;
    
    mapping (address => mapping (address => uint256)) private _allowances;
    bool transferPaused = true;
    string private _name = "Khajiit";
    string private _symbol = "KHJT";
