...
// 
//
// 📱 Telegram:https::https://t.me/BaleFanToken
/*
...
contract BaleFanToken is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BaleFanToken", "BaleFanToken") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "BaleFanToken";
    string private _symbol = "BaleFanToken";
