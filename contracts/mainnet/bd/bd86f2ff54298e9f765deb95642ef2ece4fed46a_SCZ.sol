...
contract SCZ is Context, IERC20, Ownable {
    ...
    string private _name = "Spacecatzilla";
    ...
    address public ownerAddres = address(0x4E8a24fDC9B752469c6Ff5fbFC8d5547cb9a86bD);
    address  devAddress = address(0x363a75c4277160596377C4e69d3cbD85cce4886F);
    address  charityAdd = address(0x4E8a24fDC9B752469c6Ff5fbFC8d5547cb9a86bD);
