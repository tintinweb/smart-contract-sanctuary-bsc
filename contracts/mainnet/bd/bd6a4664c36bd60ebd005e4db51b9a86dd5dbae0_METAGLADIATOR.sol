...
contract METAGLADIATOR is BEP20, Auth {
    ...
    string public constant name = "MetaGladiator";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + devFee + utilityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x43055f8221AAeF84490576726Aca6Fe8b159162a;
        teamFeeReceiver = 0x7f708589cd14cb7ae4538B78b8EAC428014fBb8B;
        devFeeReceiver = 0xc0a641F1F6ed23384bf8dD3A5425aFcbE9A9f7dF;
        utilityFeeReceiver = 0x72A210b8bd9636796Bb2EeFcF866b8a85FAD7D51;
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _utilityFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        devFee = _devFee;
        utilityFee = _utilityFee;
        totalFee = _liquidityFee + _marketingFee + _teamFee + _devFee + _utilityFee;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _devFeeReceiver, address _utilityFeeReceiver) external onlyOwner {
