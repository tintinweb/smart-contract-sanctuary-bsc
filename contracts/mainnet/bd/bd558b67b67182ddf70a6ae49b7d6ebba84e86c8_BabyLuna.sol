...
// Pure Degen. Ape At Your Own Risk. NFA
...
contract BabyLuna is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Baby Luna";
    ...
    constructor () {
        ...
        // 
        _BuyBackWallet       = 0xb74d39b066fEDaF1602e22C6412F712EA515F99b;
        _marketingWallet = 0xd6D8A189bb85603C4851a5cb0A9e91e2Dc0ce9Af;
        ...
        _isExcludedFromAntiWhale[address(0x42b548803c08fEfd8dF7B9e95432cBa2800c80c1)]            = true; // Deployer
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x42b548803c08fEfd8dF7B9e95432cBa2800c80c1)] = true; // Deployer
...
//Remove from Blacklist 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if ( bnbForTeam != 0 ) {
            emit TeamSent(_BuyBackWallet, bnbForTeam);
            payable(_BuyBackWallet).transfer(bnbForTeam);
        }
