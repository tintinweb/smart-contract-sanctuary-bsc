...
contract BEATS is IBEP20, Auth{
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xbEacE12648f7465c4f45e43998136Babf4eA5aBD;

    string constant _name = "Beat Token";
    ...
    uint256 public reflection   = 2;
    uint256 public marketingFee    = 3;
    uint256 public devFee          = 2;
    uint256 public totalFee        = marketingFee + reflection + liquidityFee + devFee;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(reflection).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflection, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflection = _reflection;
        marketingFee = _marketingFee;
        devFee = 3;
        totalFee = _liquidityFee.add(_reflection).add(_marketingFee).add(devFee);
