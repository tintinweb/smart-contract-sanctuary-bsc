...
contract SpaceSnake is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xE81637db51c0819527C5B0eDb3445eBe8a201DdA); // Marketing Address
        
    address payable public teamAddress =
        payable(0xb7c0f5c0e30835618864e97fe73fd11c50184BAf); // Team Address
        
    address payable public liquidityAddress =
        payable(0xE81637db51c0819527C5B0eDb3445eBe8a201DdA); // Liquidity Address
