...
contract HappyChristmas is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Happy Christmas";
    string constant _symbol = "Happy Christmas";
    ...
    uint256 private donationFee    = 2;
    uint256 private devFee         = 0;
    uint256 public burnFee         = 0;
    uint256 public totalFee        = marketingFee + rewardFee + liquidityFee + donationFee + burnFee + devFee;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x9f05B58880ac15F4E93852F091E32E30Ea1cf0A2;
        donationFeeReceiver = 0x9f05B58880ac15F4E93852F091E32E30Ea1cf0A2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= CH1 && recipient != pair) {
    ...
    function updateCH1 (uint256 _CH1) public onlyOwner {
               CH1 = _CH1 * 1 gwei; 
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _donationFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _rewardFee + _marketingFee + _donationFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _donationFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
