...
interface OldStaking {
    ...
    function userInfo(address account) external view returns (OldUserInfo memory);
...
// TODO: make it fully compatible with new staking, so it can replace old staking pools
