...
contract ARABIANCACTI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x8Ffb3a45793be1EA4f5b0e0F11124b9EA3494398));
    address payable public devWallet =
        payable(address(0x8Ffb3a45793be1EA4f5b0e0F11124b9EA3494398)); 
    address public liquidityReceiver =
        0x8Ffb3a45793be1EA4f5b0e0F11124b9EA3494398;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Arabian Cacti";
    string private _symbol = "ACACTI";
    ...
    uint256 public _maxTxAmount = 4000000000000 * 10**9;
