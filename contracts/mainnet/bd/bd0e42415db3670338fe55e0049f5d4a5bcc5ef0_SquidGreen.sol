...
contract SquidGreen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Green";
    string private _symbol = "SquidGreen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x100BFe3823A66C56a2CEa848318bD2dAeb893d38);
    address payable public BuyBackWalletAddress = payable(0x100BFe3823A66C56a2CEa848318bD2dAeb893d38);
