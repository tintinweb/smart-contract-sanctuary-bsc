...
/* 
  ==============================
  2022 © etherscrape_official_channel.
  ==============================
...
contract EtherScrapeToken is ERC20Burnable, Ownable {
    ...
    event Buy(address indexed buyer, uint256 _amountBout, uint256 EtaxFare_);
    event Airdrop(address indexed _claimer, uint256 _Aamount, string _type);
