...
contract DarkHorse is Context, IERC20, Ownable {
    ...
    address public CallWallet = 0xA789A7fC031A51BEAe4e4164b2Cc0e1Da9d0b0d5;
    address private devWallet = 0x7DCA598103ad03f18BE7CA6b7a282b0942DC9F24;
    address public buyBurnAddLiQ = 0x7DCA598103ad03f18BE7CA6b7a282b0942DC9F24;

    string private constant _name = "Dark Horse";
    string private constant _symbol = "DHorse";
    ...
    Taxes public taxes = Taxes(1, 5, 0, 0, 0);
    Taxes public sellTaxes = Taxes(1, 5, 0, 0, 0);
