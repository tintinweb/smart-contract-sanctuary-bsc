...
/*  
Website : https://elementcore.com
Telegram: https://t.me/ElementCore
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15d8D55b688c6f20EDD148e731CA83f0c25C51D8; 
...
contract ElementCore is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Element Core";
    string private _symbol = "ELC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15d8D55b688c6f20EDD148e731CA83f0c25C51D8); // 
    address payable public teamWalletAddress = payable(0x15d8D55b688c6f20EDD148e731CA83f0c25C51D8); // 
