...
contract NPCGrowToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NPC Grow Token";
    string private _symbol = "NPC Grow";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xd55bF6A1b5F8d730eaD5274ffCAaCfADD8C5ece8); // Marketing Address
    address payable public teamWalletAddress = payable(0xC7B80BE89cc089e9cBE25CC93c22fCAe301C8Cc2); // Team Address
