...
/**
    ...
    Telegram : https://t.me/Mrbeetweet
...
contract MrBeeTweet is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x73CDa24dDD4F26BEe2A897C4dAa7327aBC28cb1f); 
    address payable public Dev_Wallet = payable(0x73CDa24dDD4F26BEe2A897C4dAa7327aBC28cb1f);
    ...
    string private constant _name = "Mr Bee Tweet"; 
    string private constant _symbol = unicode"MrBeeTweet"; 
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0x73CDa24dDD4F26BEe2A897C4dAa7327aBC28cb1f;
