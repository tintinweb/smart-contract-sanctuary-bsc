...
// TG:@BABYGGSCN  8BNB+LP  14:30 UTC launch  GO buy to the moon
...
contract BABYGGS is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public holderMax =  8000 * 1e18;
    ...
    constructor() {
        ...
        _totalSupply = 8000 * (10 ** uint256(_decimals));
