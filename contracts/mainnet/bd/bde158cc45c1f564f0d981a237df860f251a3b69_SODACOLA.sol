...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61883eF10e95252A9493bDfEf98718261C04C7e8; // owner address
...
contract SODACOLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SODA COLA";
    string private _symbol = "SODACOLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe65bA5132fE0C0925232374F90da970f6f88ad7); // Marketing Address
    address payable public teamWalletAddress = payable(0xEe65bA5132fE0C0925232374F90da970f6f88ad7); // Team Address
    ...
    uint256 public _totalDistributionShares = 0;  // original 0
