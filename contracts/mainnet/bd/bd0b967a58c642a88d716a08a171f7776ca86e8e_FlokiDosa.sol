...
// 
//
// 📱 Telegram:https::https://t.me/FlokiDosa
/*
...
contract FlokiDosa is ERC20 {

    uint tokenTotalSupply = 800000; // 100 Million Token Supply

    constructor() public ERC20("Floki Dosa", "FlokiDosa") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiDosa";
    string private _symbol = "FlokiDosa";
