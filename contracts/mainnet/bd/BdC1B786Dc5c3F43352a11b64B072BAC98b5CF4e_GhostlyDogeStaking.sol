...
/**
GHOSTLY DOGE STAKING FOR DOGE <3 

No Commitment Needed, Only early Exit Penalty

Telegram: https://t.me/GhostlyDoge
DAPP: https://ghostlydoge.com/farm/
*/
...
contract GhostlyDogeStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x9E2D9D6B2BA0c6dA59A384aacF38b74a5c42CD3E);
    ...
    function updatelockdurationinseconds(uint256 newlockDuration) external onlyOwner {
