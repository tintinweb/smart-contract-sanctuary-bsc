...
/**
🏆 https://t.me/GoalcryptoNews10

⚽GOAL CRYPTO an ecosystem for fans of soccer and cryptocurrencies, 
Experience this World Cup in a different way by earning GCP tokens⚽🏆 
💰Fully developed staking tools, Global Voting Pool, Match Voting Pool and many more opportunities
 (NFT Market, NFT Staking, Goal Crypto Virtual, Gaming Zone)💰 
 🛡️Secure and stable ecosystem you can validate our GCP token locks in DX, in our white paper
 
 🛡️🔗✅KYC✅🌐 
 https://www.gooalcrypto.com/
 🔗🌐🛡️

Official Fan Token of  Goal Crypto 🚀 GCP
Token Name	Goal Crypto
Token Symbol	GCP
Token Decimals	18

https://twitter.com/GoalCrypto10
...
contract GCP is GCPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GCPTeam;
    address private CharityGCP;
    ...
    string public override name = "Goal Crypto";
    string public override symbol = "Goal Crypto";
    ...
    constructor(uint totalSupplyValue, address GCPTeamAddress, address CharityGCPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GCPTeam = GCPTeamAddress;
        CharityGCP = CharityGCPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GCPTeam] =  totalSupply * 4 / 100;
        balances[CharityGCP] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GCPTeam pot
