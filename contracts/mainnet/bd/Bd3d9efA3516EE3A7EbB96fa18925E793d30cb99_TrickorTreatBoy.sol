...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8e95B2846828Ff7F40b78530F94a645C36CDa9f2; // owner address
...
contract TrickorTreatBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trick Or Treat boy";
    string private _symbol = "Trickboy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e95B2846828Ff7F40b78530F94a645C36CDa9f2); // Marketing Address
    address payable public teamWalletAddress = payable(0x8e95B2846828Ff7F40b78530F94a645C36CDa9f2); // Team Address
