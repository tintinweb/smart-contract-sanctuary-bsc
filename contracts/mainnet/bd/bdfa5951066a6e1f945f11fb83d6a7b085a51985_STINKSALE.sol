...
/**
TELEGRAM:  https://t.me/stinksaleofficial
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63d77EE18B6F2460Aacca2821194822e92FF87b5; //
...
contract STINKSALE is Context, IERC20, Ownable {   //
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5000000 * 10**9; //
    string private constant _name = "Stinksale"; // 
    string private constant _symbol = "STINKSALE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x63d77EE18B6F2460Aacca2821194822e92FF87b5); //
