...
contract PutinMyAssOfficial is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x579E8c18cc4f334af52a4A3a36E9255e2a03e5A6);
    ...
    string private constant _name = "PutinMyAss";
    string private constant _symbol = "OFFICIAL";
...
maxTransactionAmount = _tTotal * 15 / 1000; // 0.5% maxTransactionAmountTxn
