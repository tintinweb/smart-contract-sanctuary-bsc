...
// Telegram : https://t.me/Tesla420BNB
...
contract Tesla420 is Context, IERC20 { 
    ...
    address payable public W_MARKET = payable(0x6e36C2b2674e7493f86029fd2A8DF2F2733973aA); 
    address payable public W_DEV = payable(0xf7F1558910d92a6f9293676e72fDad6DFCc2c1f2);
    ...
    uint256 private _tTotal = 2* 10**6 * 10**_decimals;
    string private constant _name = "Tesla 420"; 
    string private constant _symbol = unicode"T420"; 
    ...
    constructor (address[] memory addresses, string memory typeC) {
        ...
        _owner = 0xf7F1558910d92a6f9293676e72fDad6DFCc2c1f2;
