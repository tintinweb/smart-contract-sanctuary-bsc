...
contract MoviaToken is ERC20, Ownable {
    uint256 public  liquidityFeeOnBuy   = 1;
    uint256 public  liquidityFeeOnSell  = 1;

    uint256 public  projectFeeOnBuy      = 1;
    uint256 public  projectFeeOnSell     = 1;
    ...
    event UpdateBuyFees(uint256 liquidityFeeOnBuy, uint256 marketingFeeOnBuy, uint256 projectFeeOnBuy);
    event UpdateSellFees(uint256 liquidityFeeOnSell, uint256 marketingFeeOnSell, uint256 projectFeeOnSell);
    event SendMarketing(uint256 bnbSend);
    event SendProject(uint256 bnbSend);

    constructor (address newOwner)ERC20("Movia Token",  "MVA"){  

        _mint(newOwner, 30_000_000 * (10 ** 18));

        operator = msg.sender;
        marketingWallet = 0x60d3a099B0D5920c54E4782C3F00b68d15Bda083;//Mainnet
        projectWallet   = 0x60d3a099B0D5920c54E4782C3F00b68d15Bda083;//Mainnet
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _projectFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _projectFeeOnBuy <= 25,
            "Fees must be less than 25%"
        );
        liquidityFeeOnBuy = _liquidityFeeOnBuy;
        projectFeeOnBuy    = _projectFeeOnBuy;
        marketingFeeOnBuy = _marketingFeeOnBuy;
        _totalFeesOnBuy   = liquidityFeeOnBuy + marketingFeeOnBuy + projectFeeOnBuy;
        emit UpdateBuyFees(_liquidityFeeOnBuy, _marketingFeeOnBuy, _projectFeeOnBuy);
    }

    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _projectFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _projectFeeOnSell <= 25,
            "Fees must be less than 25%"
        );
        liquidityFeeOnSell = _liquidityFeeOnSell;
        projectFeeOnSell    = _projectFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + projectFeeOnSell;
        emit UpdateSellFees(_liquidityFeeOnSell, _marketingFeeOnSell, _projectFeeOnSell);
    }
    ...
    function changeProjectWallet(address _projectWallet) external onlyOwner {
        require(_projectWallet != projectWallet, "Marketing wallet is already that address");
        require(!isContract(_projectWallet), "Marketing wallet cannot be a contract");
