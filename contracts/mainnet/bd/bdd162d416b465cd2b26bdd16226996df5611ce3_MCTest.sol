...
contract MCTest is Context, IERC20, Ownable {
    ...
    address payable public devAddress =
        payable(0x65104341e0991929C9CD8A3FC4E9Ed2eeeB0C82F);
    address payable public liquidityAddress =
        payable(0xFC34ae0ABAeaeE44CEDEc4ea4A8D5c03dae7278B);
    ...
    string private constant _name = "MCTest1";
    string private constant _symbol = "MCTest1";
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && automatedMarketMakerPairs[to]) {
     ...
     function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingBalance = transferredBalance.div(2);
