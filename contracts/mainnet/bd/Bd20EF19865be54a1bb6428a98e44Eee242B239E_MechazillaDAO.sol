...
contract MechazillaDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MechazillaDAO";
    string private _symbol = "MechazillaDAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xE672B836Bc9246B7c55F14900aD45307cc13Cc21); 
    address payable private teamWalletAddress = payable(0xbB77f335C9298775399e3CA729af57da4Ce4672B); 
