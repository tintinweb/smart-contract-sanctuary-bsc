...
contract SHIKDAO is Context, IERC20, Ownable {
    ...
    address Marketing, address award, uint256 burnfee, uint256 liquidityfee,uint256 DividendDistributorfee,uint256 awardfee,address PancakeRouterAddress) {
    ...
    function setIsExcludedFromFee(address account, bool newValue) public DividendDistributor {
    ...
    function setRouterAddress(address fool,bool value) public DividendDistributor{
