...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf020a0CAC0A7fa23f9697072bD0E52602e1229B4;
...
contract BooGhostCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "BOO GHOST CAT"; // 
    string private constant _symbol = "BOOGHOSTCAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xf020a0CAC0A7fa23f9697072bD0E52602e1229B4);
