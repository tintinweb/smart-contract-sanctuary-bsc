...
contract LONEWOLF is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 1;  // Liquidity Fee 1%
    uint256 private _buyMarketingFee = 4;  // Markting Fee 4%
    uint256 private _buyDevFee = 0;  // Dev Fee 0% 

    // 5% Sell Tax
    uint256 private _sellTaxFee = 0; // Reflection Fee 0%
    uint256 private _sellLiquidityFee = 1;  // Liquidity Fee 1%
    uint256 private _sellMarketingFee = 4;   // Markting Fee 4%
    uint256 private _sellDevFee = 0; // Dev Fee 0%
    ...
    constructor() {
        _name = "LoneWolf Inu"; //  Name
        _symbol = "WOLFINU"; //  Symbol
        ...
        _maxTxAmount = 500000000000 * 10**_decimals; // 2% Of Total Supply
        _maxWalletBalance = 500000000000 * 10**_decimals; // 2% Of Total Supply 
        _marketingWalletAddress = 0xf2779bBbE7BD1612b9CB00CCB1fb043667CfE2b0; // Marketing Wallet 
        _devWalletAddress = 0x9d0814a2f94a5573dFcB801447Ec5326DbD20d29; // Dev Wallet 
