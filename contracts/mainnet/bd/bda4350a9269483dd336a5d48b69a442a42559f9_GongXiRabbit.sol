...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8077aAc0b14F20523432f903D60d8a64e0a266E3;
...
contract GongXiRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "GongXi Rabbit";
    string private _symbol = "GXRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3945bE2D8904F90BA32c7F51DCD6a3317719434D);
    address payable public teamWalletAddress = payable(0x3945bE2D8904F90BA32c7F51DCD6a3317719434D);
