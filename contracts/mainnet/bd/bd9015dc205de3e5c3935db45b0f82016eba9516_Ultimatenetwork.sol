...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9cc9B553b4D17d0Da55c7B4B0F0EFF18354D400F; // owner address
...
contract Ultimatenetwork is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"ULTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9cc9B553b4D17d0Da55c7B4B0F0EFF18354D400F); // Marketing Address
    address payable public teamWalletAddress = payable(0x9cc9B553b4D17d0Da55c7B4B0F0EFF18354D400F); // Team Address
