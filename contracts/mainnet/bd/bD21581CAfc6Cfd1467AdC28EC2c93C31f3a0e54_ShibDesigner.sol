...
contract ShibDesigner is ERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 500000000 * (10**18);
    bool public isL;
    uint256 public killNum = 3;
    uint256 public lunachB;

    address public _marketingWalletAddress = 0xC5828533Db02c7f71bAd964A3192A6734CEbB3c7;
    ...
    constructor(address Receive) public ERC20("ShibDesigner Coin", "ShibDesigner") {
        ...
        dividendTracker.excludeFromDividends(address(Receive));

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(_marketingWalletAddress, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(Receive), true);

        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _mint(address(Receive), 100000000000 * (10**18));
    }
