...
contract RAKS is Operator {
    ...
    string private _name = "RAKS";//#币名
    string private _symbol = "RAKS";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x01F4C5caaE621684B4033F91fb36c7eebC9eC61e),true);
    }
