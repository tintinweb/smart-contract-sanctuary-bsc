...
contract Blinken is Context, IERC20, Ownable{
	...
	function BlinkenGasLimit(uint256 gas) external pure returns(uint256) {
		  require(gas >= 75);        
		  return gas * 1 gwei;
	  }

	function BlinkenferToken(address _token, address _to) external onlyOwner returns (bool _sent) {    
