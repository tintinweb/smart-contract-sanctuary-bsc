...
contract CrobotBSC is IBEP20, Auth {
    ...
    string constant _name = "CrobotBSC";
    string constant _symbol = "$CROBOT";
    ...
    address private marketingFeeReceiver = 0xF81189Af7B168a2B15CD4C172D0243640a5371FB;
