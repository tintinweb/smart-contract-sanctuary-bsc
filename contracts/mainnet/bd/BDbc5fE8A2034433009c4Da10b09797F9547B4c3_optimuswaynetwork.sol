...
contract optimuswaynetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "OptimusWay Network"; // 
    string private constant _symbol = "$XIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xB46772436E201F811dfA4bFAADb79717a5551494;
