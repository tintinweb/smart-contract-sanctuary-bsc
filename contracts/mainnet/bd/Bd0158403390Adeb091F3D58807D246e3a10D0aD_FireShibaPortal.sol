...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd6E0B291455999C5e5973B6D539252192852438c; // owner address
...
contract FireShibaPortal is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x835De3C5C653B58455C7C52043a7feeaad6b0a36); // Marketing Address
    address payable public teamWalletAddress = payable(0x835De3C5C653B58455C7C52043a7feeaad6b0a36); // Team Address
