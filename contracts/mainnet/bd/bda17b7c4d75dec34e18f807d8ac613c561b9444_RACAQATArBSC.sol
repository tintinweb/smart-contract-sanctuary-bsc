...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD793223F8B81Bb6C12caE66EF62B4c6eb4d1cdb4;
...
contract RACAQATArBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "RACAQATAR BSC"; // 
    string private constant _symbol = "RQB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xD793223F8B81Bb6C12caE66EF62B4c6eb4d1cdb4);
