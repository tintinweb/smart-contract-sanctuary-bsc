...
contract SFMSOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon SOL";
    string private _symbol = "SFMSOL";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xa3B5C7695542b2ee16397885d1924ff3aFeF2306); // Buy Back Address
