    ...
    Ownable
{
    ...
    uint256 public requiredValueMaxLimit = 10000 * 10 ** 18;
    ...
    function setRequiredValueMaxLimit(uint256 _maxLimit) external onlyOwner {
        ...
        updateReward(msg.sender)
    {
        ...
        super.stake(amount);
        uint256 currnValue = calculateValue(msg.sender).div(1e18);
        require(currnValue <= requiredValueMaxLimit, "Max value limit");
        userActValue[msg.sender] = currnValue;
