...
contract NomadArmy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nomad Army"; // 

    string private constant _symbol = "$NOAR"; // 
    ...
    address public  _marketingWallet = 0x4ca6C0Bc658cC19eBe69186998CdCc5ebE7B67a9;
