...
contract NewYearsDOGEv2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Years Doge V2";
    string private constant _symbol = "NYD";
