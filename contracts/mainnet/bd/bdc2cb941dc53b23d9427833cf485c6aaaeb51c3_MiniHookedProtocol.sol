...
contract MiniHookedProtocol is IBEP20, Ownable {
    ...
    string constant _name = "Mini Hooked Protocol";
    string constant _symbol = "mHOOK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2500 * (10 ** _decimals);
