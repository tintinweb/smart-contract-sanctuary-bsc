...
contract Proofofdognom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proofofdognom"; 
    string private _symbol = "PNOM"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdeeE8eA83FD57E9Ec7a38659d9d7Ad301f0080E4); 
    address payable public teamWalletAddress = payable(0x06E5265098Cdda4ace3C0519278D84dFa5dC67cc); 
