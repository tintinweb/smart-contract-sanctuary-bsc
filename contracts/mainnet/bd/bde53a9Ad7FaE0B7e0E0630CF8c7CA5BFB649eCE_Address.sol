...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAF13F59c91b3967BEaf970Fb8236AAf993D9fdc7;
...
contract KYRA11 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kyra1.1"; // 
    string private constant _symbol = "$KYR1"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0xAF13F59c91b3967BEaf970Fb8236AAf993D9fdc7);
