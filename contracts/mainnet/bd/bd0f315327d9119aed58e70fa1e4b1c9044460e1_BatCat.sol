...
RisingMummy is built upon the fundamentals of Buyback and increasing the investor's value
...
contract BatCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x76C3Fd94953de22bE91Dcdba04205654A33D51bA); // Marketing Address
