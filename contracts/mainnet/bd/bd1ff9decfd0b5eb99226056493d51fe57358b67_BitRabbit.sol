...
contract BitRabbit  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x422A6B69E7de5c52c724C3bB404C15039121b36A); // Marketing Address
    ...
    string private _name = "BitRabbit";
    string private _symbol = "BitRabbit";
