...
contract BBITCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BASIC BITCOIN ";
    string private _symbol = " BBITCOIN "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8b2ead3C460fdb6fF04F3a6BF7991B7af62E4Af1); 
    address payable public teamWalletAddress = payable(0x8b2ead3C460fdb6fF04F3a6BF7991B7af62E4Af1);
    ...
    uint256 private _totalSupply = 112501  * 10**_decimals;
    uint256 public _maxTxAmount = 112501 * 10**_decimals;
    uint256 public _walletMax = 112501 * 10**_decimals;
