...
str2 = sfr.add(1);
    ...
    function getUsercheckpointRefBonusMinutes22(address userAddress)
        public
        view
        returns (uint256)
    {
...
for (uint256 i = 0; i < user.deposits.length; i++) {
      ...
      uint256 str3 =  users[userAddress].checkpointRefBonus+(user.deposits[i].finish);
}
        return str3;
    }
