...
contract SAXONINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saxon Inu";
    string private _symbol = "SAXONINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC314c4f16AA64D718C22185e7D04B85D29A585f1); 
    address payable public teamWalletAddress = payable(0x23AA56F5317F4f3e0E17d23004bF66703Db6abcc); 
