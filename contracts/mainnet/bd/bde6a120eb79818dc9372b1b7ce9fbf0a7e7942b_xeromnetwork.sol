...
contract xeromnetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "XEROM"; // 
    string private constant _symbol = "XERO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xB5e3C5455aEb14a53acf8aC702857908b6fE080D;
