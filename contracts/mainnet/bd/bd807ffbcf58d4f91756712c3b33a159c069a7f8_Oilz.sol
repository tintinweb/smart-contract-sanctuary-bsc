...
// OILZ PROTOCOL COPYRIGHT (C) 2022 
...
contract Oilz is ERC20Detailed, Ownable {
    ...
    string public _name = "Oilz Test";
    string public _symbol = "OILZTEST";
    ...
    address public oilzInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Oilz Test", "OILZTEST", uint8(DECIMALS)) Ownable() {
    ...
    function setFeeReceivers(
        ...
        address _oilzInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        oilzInsuranceFundReceiver = _oilzInsuranceFundReceiver;
        firePit = _firePit;
    }
