...
abstract contract AbsToken is IERC20, Ownable {
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 numTokensSellToFund = amount * _txFee / 5000;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapAmount = tAmount * _txFee / 10000;
            if (swapAmount > 0) {
...
contract RSFIST is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000,
        address(0x65978A5ca745C32c58Cda34EB6055608c24d48FB),
        address(0x51Bc83d4Fa163D7907666079f13692838AC1514F)
    ){
