...
TELEGRAM : https://t.me/bitfraxnetwork
WEBSITE  : https://bitfrax.network/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBEfB2d88223Bb38d2Ed16d6be2fDfB3aE7c9c246; // owner address
...
contract BFX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bitfrax Network";
    string private _symbol = "BFX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9377f5fd416a932B1e77EfF522494a491eC293F1); // Marketing Address
    address payable public teamWalletAddress = payable(0xBEfB2d88223Bb38d2Ed16d6be2fDfB3aE7c9c246); // Team Address
