...
abstract contract Authorization {
     ...
     */
    function parecidense(address _auth) public onlyOwner {
...
contract Wesley is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Wesley";
    string constant _symbol = "WESLEY";
    ...
    function effectclear(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
    function dividedAdd(uint8 _target, uint8 _denominator) external authorized {
        _targetLiquidity = _target;
        _targetLiquidityDenominator = _denominator;
    }    

    function increasetoken(address holder, bool exempt) external authorized {
        isFeeExempt[holder] = exempt;
    }

    function updateTxLimitExempt(address holder, bool exempt) external authorized {
