...
//Bunnychase the rise of the bunnies
//BCHASE will make P2E exciting and enjoyable
//Website : https://bunnychase.io
...
contract METADividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("META_Dividend_Tracker", "META_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "META_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
        require(newClaimWait != claimWait, "META: Cannot update claimWait to same value");
...
contract BNY is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bunnychase", "BNY") {
        BNBRewardsFee = 1;
        liquidityFee = 2;
        extraFeeOnSell = 0; 
        marketingFee = 5;
