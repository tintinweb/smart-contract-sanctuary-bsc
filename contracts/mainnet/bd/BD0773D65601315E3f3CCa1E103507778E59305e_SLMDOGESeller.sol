...
contract SLMDOGESeller is Context, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    function buySLMDOGEwithBNB() public payable nonReentrant {
    ...
    function buySLMDOGEwithBUSD(uint256 amount) public nonReentrant {
        address beneficiary = _msgSender();
        require(amount != 0, "Amount is 0");
        ...
        uint256 tokenAmount = _getTokenAmount(amount.mul(BNBPrice).div(10**18));
        _preValidatePurchase(beneficiary, tokenAmount);
    ...
    function forwardSLMDOGE() public {
