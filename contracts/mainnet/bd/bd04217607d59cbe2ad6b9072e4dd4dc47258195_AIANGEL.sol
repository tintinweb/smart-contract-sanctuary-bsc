...
Telegram: https://t.me/aiangelofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xb613F4E8D3a12b1F5f5D3766950d8C124BE1025E;
...
contract AIANGEL is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI Angel"; // 
    string private constant _symbol = "$AIA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xb613F4E8D3a12b1F5f5D3766950d8C124BE1025E);
