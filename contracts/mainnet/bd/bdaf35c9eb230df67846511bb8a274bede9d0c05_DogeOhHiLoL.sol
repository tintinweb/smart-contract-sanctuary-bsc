...
contract DogeOhHiLoL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Doge Oh Hi Lol";

    string private _symbol = "Doge Oh Hi Lol";

    uint8 private _decimals = 10;

    address public LPFEE = 0x0073F6B6D1846369F8c389cC3cc48F7E314C8882;
