...
contract SHIBAROCKETGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Rocket Grow";
    string private _symbol = "SRG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9157aFcDC9bF2fa8FAb7ff25B6D57EEBc3EBb617); 
    address payable public teamWalletAddress = payable(0xc3ed0a30DBd5fA3f44970188512288cc47CeE1Bf); 
