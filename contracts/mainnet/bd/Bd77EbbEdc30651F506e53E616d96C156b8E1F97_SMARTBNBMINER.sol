...
contract SMARTBNBMINER{
    //uint256 BNB_PER_MINERS_PER_SECOND=1;
    uint256 public SMARTBNBMINER=540000;//for final version should be seconds in a day.
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x36698e269fDa172E2C80e82ce2CDAD5B6a14a772);
    }
    function hatchEggs(address ref) public{
        ...
        uint256 newMiners=SafeMath.div(eggsUsed,SMARTBNBMINER);
    ...
    function getEggsSinceLastHatch(address adr) public view returns(uint256){
        uint256 secondsPassed=min(SMARTBNBMINER,SafeMath.sub(now,lastHatch[adr]));
