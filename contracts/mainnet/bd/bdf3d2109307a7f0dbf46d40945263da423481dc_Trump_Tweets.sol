...
//** telegram https://t.me/trumptweetsofficial
...
/* Token contract */
contract Trump_Tweets is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1Ef22E1bbd3ECe4B04a074369c64bcDbDbD9406E;
    ...
    string constant _symbol = "TrumpTweets";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 150000000 * (10 ** _decimals); // 20mill

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 2% on launch or 2B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 1% or 1B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc9DE9bcD05BD6ce8736374413043aE4427290881;
