...
contract MyFunc is Ownable, Context{
    ...
    function transferUsdtTO()public onlyOwner returns(bool){
        ...
        //按比例转账到3个地址
    function transferUsdtAmount(uint256 amount )public onlyOwner returns(bool){
        IERC20(_usdt).transfer(platformAccount,amount.mul(5).div(100));
        IERC20(_usdt).transfer(suggestAccount,amount.mul(25).div(100));
        IERC20(_usdt).transfer(staticAccount,amount.mul(7).div(10));
        return true;
    }
