...
/**
 telegram : https://t.me/SonOfGreatDane
...
contract SonOfGreatDane is Context, IERC20, Ownable {
    ...
    constructor (address deployer) 
    {
        ...
        _name   = "Son Of Great Dane";
        _symbol = "Son Of Great Dane";
        _decimals = 9;
        _totalSupply = 6900000000000000 * 10**_decimals;
        ...
        marketWallet = payable(0x76C9286aD90D578f888353ECeA41b6D1720a7B95);
        developmentWallet = payable(0xFF67e0F75060cE3A75c9706ecd89432fb666d455);
    ...
    function setdevelopmentWallet(address newAddress) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(developmentWallet, amountBNBTeam);
