...
/**
https://t.me/StarnoldSchwarzvester


— Nano Cap 100$ MC.
— 1.5% max buy & sell 
— 3% max wallet 
— 9% buy tax & 9% sell tax.
— Biggest project @Bull_Doge_BSC (140x)
— Giveaways, contests, competitions etc!
— Aiming for a mid-term project.

👉 Stealth Launch!
👉 Contract in @MikesGambles!

Giveaway of 0.1 bnb for 2 active telegram members.
*/
...
contract StarnoldSchwarzvester is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x7EB5aFd54673619b0d95EBC073812091e2Ec5987);
    address payable public Wallet_Dev =
        payable(0x5A18E7af256c174dDc246bDbbD4387446db90181);
    ...
    string private constant _name = "StarnoldSchwarzvester";
    string private constant _symbol = unicode"$STARNOLD";
    ...
    constructor() {
        _owner = 0x5A18E7af256c174dDc246bDbbD4387446db90181;
