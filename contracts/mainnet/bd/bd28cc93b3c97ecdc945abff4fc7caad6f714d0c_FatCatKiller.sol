...
contract FatCatKiller is Context, IERC20, Ownable {
    ...
    string private _name = "Fat Cat Killer";
    string private _symbol = "killer";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe98394358CbF4F5B66522d0f6a6A9c35dD8C5e07);
    address payable public teamWalletAddress = payable(0xADe05aB9F6B4634F0FB674f84F8C1403146dbd56); 
