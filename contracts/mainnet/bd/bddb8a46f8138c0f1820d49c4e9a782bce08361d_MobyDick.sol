...
25,000 tokens, for example, is about 7 hours. 
120 tokens would be 2 minutes.
That's it. No other restrictions or special limitations.
Buying or selling resets your counter. 
It's always the amount of tokens in seconds from last transcation.
Small buyers may exit early or hold longer. 
Whales must hold on to their bags for far longer.
*/
...
contract MobyDick is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {      
        ...
        marketingWallet = 0x8b47BA9c22599DB8A23b2bC2867ec95BAaB08318;  //Marketing wallet, change to your own
	...
	function checkTxLimit(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender != owner
            ...
            require(!isSniper[sender]);  // snipers cant sell
    ...
    function tagSnipers(address sender) internal {
        if (block.number - launchedAt <= antiSniperBlocks || gasLimitActive && tx.gasprice >= antiSniperGasLimit || tagAllBuys) {
