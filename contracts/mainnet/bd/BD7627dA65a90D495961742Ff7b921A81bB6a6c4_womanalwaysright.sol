...
contract womanalwaysright is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "WomanAlwaysRight";
    string private constant _symbol = unicode"$WOAR";
    ...
    address payable public DevWallet = payable(0x7Ab41d009156fAFaBCAfab233A73857cC22CdF9B);
    address payable public MarketingWallet = payable(0x1dC9e8731c8A0e5aB22969e3F3C7D4b1F42b37Bd);
