...
/**
 🔥 Orochimaru Coin - $OI  🚀
    ...
    Orochimaru is known to be a strong character in the Naruto anime series.
    One of the three legendary Sannin. 👌

 telegram : https://t.me/OrochimaruCoin
 twitter  : https://twitter.com/OrochimaruCoin
 website  : http://www.Orochimaru.co/
*/
...
contract OrochimaruCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orochimaru Coin";
    string private _symbol = "$OI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2823f55aF2a4352372249F55aA8d642A18Fe00D8);
