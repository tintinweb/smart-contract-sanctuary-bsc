...
// File: contracts/onlychadsPoolInitializable.sol

pragma solidity 0.6.12;

contract onlychadsPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public onlychads_POOL_FACTORY;
    ...
    constructor() public {
        onlychads_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == onlychads_POOL_FACTORY, "Not factory");
