...
contract Moda is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 20220226* 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 20220226 * 10 ** 9;
    ...
    constructor() ERC20("Moda", "Moda") {
        addressForMarketing =address(0x08ceeE226db41F5E2ce299BB7C54Dbc895930b85);
    ...
    function _transfer(
        ...
        if(recipient == uniswapV2Pair){
            if (
                ...
                super._transfer(sender,mintContract, _fee.mul(20).div(100));
                super._transfer(sender, addressForMarketing, _fee.mul(500).div(1000));
                super._transfer(sender, BurnAddr, _fee.mul(100).div(1000));
