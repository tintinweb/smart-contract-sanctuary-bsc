...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4425CBEB41727b3b54BBB43b39c640cA6a15ca48;
...
contract doges  is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x4425CBEB41727b3b54BBB43b39c640cA6a15ca48);
    address payable private Wallet_Burn = payable(0x4425CBEB41727b3b54BBB43b39c640cA6a15ca48); 
    address payable private Wallet_zero = payable(0x4425CBEB41727b3b54BBB43b39c640cA6a15ca48); 
    ...
    */
    ...
    string private _name = "2834"; 
    string private _symbol = "2834";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 2834 * 10**18;
    ...
    uint256 private maxPossibleFee = 4; 
