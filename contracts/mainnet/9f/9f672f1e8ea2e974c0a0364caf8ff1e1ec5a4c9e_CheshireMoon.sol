...
contract CheshireMoon is IBEP20, Auth {
    using SafeMath for uint256;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cheshire Moon";
    string constant _symbol = "CSM";
    ...
    address private tax4;
    address private tax5;
    ...
    function transferTax() internal {
        ...
        uint256 tax = amount.div(5);
        _basicTransfer(address(this), tax1, tax);
        _basicTransfer(address(this), tax2, tax);
        _basicTransfer(address(this), tax3, tax);
        _basicTransfer(address(this), tax4, tax);
        _basicTransfer(address(this), tax5, amount.sub(tax).sub(tax).sub(tax).sub(tax));
    }
    ...
    function setTaxReceivers(address _tax1, address _tax2, address _tax3, address _tax4, address _tax5) external authorized {
        excludeTax[tax1] = false;
        excludeTax[tax2] = false;
        excludeTax[tax3] = false;
        excludeTax[tax4] = false;
        excludeTax[tax5] = false;
        tax1 = _tax1;
        tax2 = _tax2;
        tax3 = _tax3;
        tax4 = _tax4;
        ...
        excludeTax[tax4] = true;
        excludeTax[tax5] = true;
    }
    ...
    function setTaxThreshold(uint256 _amount) external authorized {
        require(_amount > _totalSupply / 100000, "taxThreshold must be greater than 0.001% of total supply");
