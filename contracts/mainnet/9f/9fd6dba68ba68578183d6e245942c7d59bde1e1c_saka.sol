...
/**
 welcome to : Sacramental Cannabis
 Telegram : https://t.me/sacramentalcannabis
...
contract saka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sacramental Cannabis"; // 
    string private constant _symbol = "$SACA"; //    
