...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDA0a29BA0a24cF50Ed1449aD407052CaBCe54e9e; // owner address
...
contract SB is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x90017d8eA0f171baDc662AF5D6740717A921710C); // Marketing Address
    address payable public teamWalletAddress = payable(0x90017d8eA0f171baDc662AF5D6740717A921710C); // Team Address
