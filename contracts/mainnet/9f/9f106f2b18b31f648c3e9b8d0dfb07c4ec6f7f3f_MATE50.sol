...
contract MATE50 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MATE50";
    string private _symbol = "MATE50";
    ...
    address payable public teamWalletAddress = payable(0x63438e25b943D696579966cA33E7d5C5C7cDb580); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x33c91646F261F8D1BaDB204c8e62a91594ddf5cf),
            block.timestamp
        );
    }
