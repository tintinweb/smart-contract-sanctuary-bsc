...
Don't buy if you can't hold for days. 
*/
...
contract SQUID is Context, IERC20, Ownable {
    ...
    string private _name = "MetaSquidBonk"; 
    string private _symbol = "SBONK"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb21D63dBEB63f649Bb6Ae4A3635c233B7818Fa8D); 
    address payable private teamWalletAddress = payable(0xb21D63dBEB63f649Bb6Ae4A3635c233B7818Fa8D); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 22 / 1000;
