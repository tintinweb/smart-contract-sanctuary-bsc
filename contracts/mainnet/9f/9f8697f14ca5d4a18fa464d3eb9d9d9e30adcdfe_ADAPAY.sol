...
/*
    ...
    Website: https://ada-pay.com
    Telegram: https://t.me/adapay
    Twitter: https://twitter.com/cordano_adapay
...
contract ADAPAY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ADAPAY - Direct & Secure Payment Method";
    string private _symbol = "ADAPAY";
    ...
    address public marketingWallet = 0x6CD2aB019C4f9B9CD1B50C2D866DB651723AebbF;

    uint256 public _stotaxFee = 40;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000 * 10**5;
    uint256 public _maxTxAmount = 1000000000000 * 10**5;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmt * (10**5);
    }
