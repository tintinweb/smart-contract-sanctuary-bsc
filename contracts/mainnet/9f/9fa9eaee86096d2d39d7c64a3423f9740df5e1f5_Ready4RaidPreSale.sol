...
/**
  Ready4Raid Pre-Sale Smart Contract BSC
  It is a carefully crafted smart contract by Ready 4 Raid for
  the R4R Token pre-sale. You can participate in the pre-sale on our website.
...
contract Ready4RaidPreSale is OwnerWithdrawable {
    using SafeMath for uint256;
