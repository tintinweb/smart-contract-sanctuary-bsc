...
contract Flask_Power is Base, Math, AccessControl, With_DAORole, ERC20, With_FundContract, I_Flask_Power{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    modifier withGuard() {
        require(!guarded, "Flask_Power: guard token already false");
        guarded = true;
        _;
        guarded = false;
    }
    
    constructor() ERC20("Flask_Power", "PWR") {
