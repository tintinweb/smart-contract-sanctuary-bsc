...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41106574cc439DbE5A7fef4E56b2A8c683D76B4f; // owner address
...
contract SafariMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafariMoon";
    string private _symbol = "SFM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40D07fFdC706E53ce063ef9102CB4f730d4e047F); // Marketing Address
    address payable public teamWalletAddress = payable(0x40D07fFdC706E53ce063ef9102CB4f730d4e047F); // Team Address
