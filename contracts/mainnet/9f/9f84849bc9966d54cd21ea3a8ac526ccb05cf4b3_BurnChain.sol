...
contract BurnChain is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 21000 * 10**18;
    uint256 public maxBuyLimit = 21000000 * 10**18;
    uint256 public maxSellLimit = 21000000 * 10**18;
    uint256 public maxWalletLimit = 21000000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x7a4C99619F2B82B3A4aAA231817d2089BD74CbC8;
    ...
    constructor() BEP20("BurnChain", "Burn") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 210000, "Swap threshold amount should be lower or equal to 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 21000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 21000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 210000, "Cannot set max wallet amount lower than 1%");
