...
contract MaLanXing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaLanXing";
    string private _symbol = "MaLanXing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Ce046A569E7e87315533874F9F803d005261b64); // Marketing Address
    address payable public teamWalletAddress = payable(0xA9d7afeBc7dCd9c2e19C96FB2F169F77beDc30F9); // Team Address
