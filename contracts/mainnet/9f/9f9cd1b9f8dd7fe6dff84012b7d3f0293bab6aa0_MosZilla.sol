...
contract MosZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MosZilla";
    string private _symbol = "MosZilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xf862C5fE723d7D4126a5d2E7d5524B1c0227AE6B); 
    address payable public ttWal = payable(0xf862C5fE723d7D4126a5d2E7d5524B1c0227AE6B); 
