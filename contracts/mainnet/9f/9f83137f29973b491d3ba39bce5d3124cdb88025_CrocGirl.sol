...
contract CrocGirl is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x475b5E2cd732Ea39916BcE95a6296C384525Ed2C);
    address payable public teamWalletAddress = payable(0x475b5E2cd732Ea39916BcE95a6296C384525Ed2C);
    ...
    string private _name = "CROC GIRL";
    string private _symbol = "CROCGIRL";
