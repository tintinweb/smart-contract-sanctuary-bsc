...
contract CakeCrewDividendTracker is IDividendDistributor {
    ...
    IBEP20 Cake = IBEP20(0x3B694DC9e493F3d202edD87bfCe9c82009a6DC8C);
...
contract SatoshiCatCoin is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    address private marketing = address(0x062dc92276dE7F2c806f22dd2b1399E609653A95);
    address private liquidity = address(0xbCc3cf9E7E50CE01371cA007c3a076088A3fAc46);
