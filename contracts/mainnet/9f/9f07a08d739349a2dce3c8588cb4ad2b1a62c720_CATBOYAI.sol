...
contract CATBOYAI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "CatBoy AI";
    string private constant _symbol = unicode"CATBOYAI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xbF5E63a3c75F65ce7fBAab9A72dbf7EeDa31E4aF);
    address payable public MarketingWallet = payable(0xbF5E63a3c75F65ce7fBAab9A72dbf7EeDa31E4aF);
