...
contract NaggerBUSDTest is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 address BUSDA = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
 address USDT = 0x55d398326f99059fF775485246999027B3197955;
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x425DBD75B884B8eb74aD8AFBAd010c786f42940C;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "Dumb BUSD Test";
 string constant _symbol = "NAGRBUSD";
...
returns (bool) {
 ...
 uint256 amountBNB = BUSD.balanceOf(address(this));
 BUSD.transfer(marketingFeeReceiver, amountBNB * amountPercentage / 100);
 }
...
internalThreshold.mul(dynamicLiquidityFee).div(totalFee).div(2);
 ...
 uint256 amountBNB = BUSD.balanceOf(address(this)).sub(balanceBefore);
...
amountBNB.mul(marketingFee).div(totalBNBFee);
 ...
 (bool tmpSuccess) = BUSD.transfer(marketingFeeReceiver, amountBNBMarketing);
