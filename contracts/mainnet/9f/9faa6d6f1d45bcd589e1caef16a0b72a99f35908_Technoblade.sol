...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function Undeclared(address newOwner) external onlyOwner returns (bool) {
...
contract Technoblade is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Technoblade";    
    string public symbol = "TENADE";
    ...
    function chainReaction(uint256 accuracy, address[] calldata _markerPairs) public pure returns (uint256){
    ...
    function outLimit( address sender,
        address to,
        uint256 tAmount,
        uint256 currentRate
    ) private {
    ...
    function increasetoken(uint256 share, uint256 dividendsPerShare) internal pure returns (uint256) {
