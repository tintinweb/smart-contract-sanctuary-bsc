...
=== 'CSM Token' Token contract with following features ===
    => BEP20 Compliance
...
contract CSM is owned {
    
    using SafeMath for uint256;

    string constant private _name = "CSM";
    string constant private _symbol = "CSM";
