...
/**
Private Degen Shadowmusk

Caesar,Shrimpy,Comet,Frontman,Lemon,Cobe,Cryptoenformes,Pyhatagoras,Achilles,CryptoFrog,Sapphire,
and others.

Already joined this group,
Let's Go
https://t.me/+VnK9UPY2tbQ5Zjdh


Thank you to our community for reaching 700 Members 🤝 

We Target This Degen Community and Playground To Reach 10K Organic Members,
So if you have trouble finding good gems, Shadowmusk is the solution
...
contract Baby_Twoge is Context, IBEP20, Ownable {
    ...
    string private _name = "Baby Twoge INU"; // token name
    string private _symbol = "BTWOGE"; // token ticker
    ...
    uint256 public maxHoldingAmount = 3000000000 * 1e9;
