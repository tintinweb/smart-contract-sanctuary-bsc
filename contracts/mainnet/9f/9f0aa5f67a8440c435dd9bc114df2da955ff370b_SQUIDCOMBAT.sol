...
Twitter  : https://twitter.com/Squidcombatbsc

Telegram : https://t.me/squidcombatofficial

Website  : https://www.squidcombat.com/
*/
...
contract  SQUIDCOMBAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUID COMBAT";
    string private _symbol = "SCOMBAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78986F2CfC6b87d52B735cb7FB4Edb1c9A865095); 
    address payable public teamWalletAddress = payable(0x15465508893b88D1ea4dcA8EDDe9a5B02cc81ca1); 
