...
https://twitter.com/elonmusk/status/1590597988136939520

4/4 low tax community token based on Elon's tweet
LP will be burned and CA renounced so its safu
Shill and share this moonshot bsc community!
...
contract  Teslaconomics  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Teslaconomics"; // 
    string private constant _symbol = unicode"Teslaconomics"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x76DE22c16eE0C390350E65E1e29C23A764609ADC;
