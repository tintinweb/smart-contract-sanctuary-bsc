...
/*
TELEGRAM GROUP: @MotherApesCoins
@PharaXHun7er 
...
contract Motherapecoins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MotherApeCoins";
    ...
    uint256 public _maxTxAmount = (100000000 / 100) * 10 ** 12;
    uint256 public _walletMax = (100000000 / 20) * 10 ** 12;
    ...
    constructor () {
        ...
        uniswapPair = IUniswapV2Factory(_pancakeV2Router.factory())
            .createPair(address(this), _pancakeV2Router.WETH());

        pancakeV2Router = _pancakeV2Router;
        _allowances[address(this)][address(pancakeV2Router)] = _totalSupply;
