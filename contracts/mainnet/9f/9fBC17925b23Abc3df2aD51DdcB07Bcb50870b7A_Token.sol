...
contract Token is ERC20, Ownable {
    ...
    address public marketingWalletAddress = 0xbDb1d8FB497863142C2b1B2FAEC22e52A227493d; 
    address public lpRewardToken = 0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da; 
    ...
    uint256 public times = 1660465943;
    
    uint256 distributorGas = 500000;
    
    constructor() payable ERC20("JS", "JS")  {
        uint256 totalSupply = 2800 * (10**18);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            ...
            IERC20(lpRewardToken).transfer(marketingWalletAddress, mr);
            return;
        }
