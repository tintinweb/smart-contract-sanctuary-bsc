...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor() payable ERC20("Jaychou", "JAY") {
        rewardToken = 0x6b88c7975AA1Af8787629F6A09B4CE693bD897D2;
        _marketingWalletAddress = 0xCDB8dC5426e8d25d78D610D74B55f1a5044AFCf9;
        require(
        ...
        excludeFromFees(address(0x6fDDCF9A0ba55e47Cd2aAD6Bcda319a95e4F450c), true);
