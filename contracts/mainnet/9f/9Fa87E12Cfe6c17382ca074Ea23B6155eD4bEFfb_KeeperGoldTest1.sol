...
contract KeeperGoldTest1 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KGOT1";
    string constant _symbol = "KGOT1";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x7F842A842cC4FC5CaAE63473de505cc1AC994884;  // teamwallet
    ...
    function changeHellBurnRate(uint256 newBurnRate) external authorized {
        hellBurn = newBurnRate;
    }

    function changeFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newRewardFee) external authorized {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 burnAmount = amount.mul(hellBurn).div(10000);
        uint256 feeAmount = amount.mul(feeApplicable).div(100).sub(burnAmount);
