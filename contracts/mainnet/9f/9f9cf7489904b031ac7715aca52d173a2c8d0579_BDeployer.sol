...
contract PoolToken is IPoolToken, Lif3ERC20 {
    ...
    uint256 public mintFee = 0.005e18; //0.5

    function changeMintFee(uint256 newFee) public {
        ...
        returns (uint256 mintTokens)
    {
        ...
        uint256 mintFeeDAO = mintTokens.mul(mintFee).div(1e18);
        mintTokens = mintTokens.sub(mintFeeDAO);
        ...
        _mint(IFactory(factory).reservesManager(), mintFeeDAO);
