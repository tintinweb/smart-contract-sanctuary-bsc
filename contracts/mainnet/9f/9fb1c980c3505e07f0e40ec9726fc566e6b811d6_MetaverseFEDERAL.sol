...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xd47b08E6319fAC11469D1432Cb4bFbdD3f18a29B;
        _owner = msgSender;
...
contract MetaverseFEDERAL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address public marketingAddress = 0xd47b08E6319fAC11469D1432Cb4bFbdD3f18a29B; // Marketing wallet Address.
    ...
    string private _name = "Metaverse FEDERAL";
    string private _symbol = "MetaFED";
    ...
    uint256 public _maxTxAmount = 1_00_000_000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 1000_000 * 10**18; 
    ...
    constructor () {
        ...
        //to exclude some addresses from whale limit. 
    ...
    {
        _amount = _amount.div(100-_marketingFee).mul(100);
    ...
    {    
        ...
        _maxTxAmount = 1_00_000_000 * 10**18;
    }
...
//excludeWalletsFromWhales()
//checkForWhale(address from, address to, uint256 amount)
