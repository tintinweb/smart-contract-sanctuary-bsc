...
contract BabydogeUNAWARE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Babydoge UNAWARE";
    string constant _symbol = "BDOGEA";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xa8B33Df83f54B6bE1Af9F0e5ab3656C92Cc9DB46; // DEV WALLET
        marketingWallet = 0x7eB3dB40853727eB5dAF1B64fe2a658c2909627E;  // MARKETING WALLET
