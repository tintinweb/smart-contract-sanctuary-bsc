...
contract ZeroZeroSeven is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "007 JAMES BOND";
    string private _symbol = "007";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x641b48C27B317AbAC54d8f2A57d0aD97C85bc22B);
    address payable public teamWalletAddress = payable(0x641b48C27B317AbAC54d8f2A57d0aD97C85bc22B);
