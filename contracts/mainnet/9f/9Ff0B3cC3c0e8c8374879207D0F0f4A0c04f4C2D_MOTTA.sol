...
contract MOTTA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Motta Inu";
    string constant _symbol = "MOTTA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB0825Aef44347D129d9D36F765140854bB9a910f;  // teamwallet
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newASSFee) external authorized {
        liquidityFee = newLiqFee;
        rewardsFee = newRewardFee;
        marketingFee = newASSFee;
