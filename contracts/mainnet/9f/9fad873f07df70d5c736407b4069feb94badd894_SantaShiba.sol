...
/**
Telegram @@SANTA_SHIBA

Stealth launch today! 
From a based and experienced dev. 
No degen, 100k soon very easy!
*/
...
contract SantaShiba is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "SantaShiba";
