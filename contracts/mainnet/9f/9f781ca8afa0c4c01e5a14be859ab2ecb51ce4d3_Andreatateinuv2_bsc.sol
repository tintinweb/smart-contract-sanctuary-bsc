...
contract Andreatateinuv2_bsc is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AndreaTate Inu V2.0";
    string constant _symbol = "$HU20";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x979d4ac06ecF3bCE90DE267B0233211cD16657ad;
        buybackWallet = 0x00C99D08Bb17f2782f52Ac15F8dd37C3A9322c2f;
