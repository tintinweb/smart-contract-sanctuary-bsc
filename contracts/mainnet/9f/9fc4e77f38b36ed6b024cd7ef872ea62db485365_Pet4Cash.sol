...
pragma solidity ^0.6.12;
    ...
    contract Pet4Cash is Context, IERC20, Ownable {
        ...
        string private _name = 'Pet4Cash';
        string private _symbol = 'P4C';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xfFe9a3e3C214F0A49575C67bFb848206EECfcf94, 'We can not exclude Uniswap router.');
