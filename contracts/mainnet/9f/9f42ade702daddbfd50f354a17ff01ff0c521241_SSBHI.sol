...
contract  SSBHI is ERC20 {
   ...
   bool private swapping;
    ...
    address public market = 0x00587F6621C2Cac8C846B84C0fDD135929802fED;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 2 * 10**22 * 10**2;
    ...
    constructor() public ERC20("SSBHI", "SSBHI",2) {
        ...
        _totalSupply = (1*10**25) * (10**2);
        _balances[owner()] = (1*10**25) * (10**2);
          emit Transfer(address(0), owner(), (1*10**25) * (10**2));
    }
