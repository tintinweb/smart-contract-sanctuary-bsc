...
contract METANEWYEAR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "META NEWYEAR";
    string private _symbol = "META NEWYEAR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xdc79e3cD3945e2e140FFDd40494db8B83a74b747);
