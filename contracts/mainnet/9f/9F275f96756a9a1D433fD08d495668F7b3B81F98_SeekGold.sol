...
contract SeekGold is IERC20, Ownable {
    ...
    address private fundAddress = address(0x13552fca67C466275c68b6213Ede71445709c794);
    ...
    constructor() {
        ...
        _tTotal = 9786655345765176 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _rOwned[0x6768377EC805D5277439e9DDa1E99410C54CE2b2] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0x6768377EC805D5277439e9DDa1E99410C54CE2b2] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = msg.sender;
        emit Transfer(address(0),0x6768377EC805D5277439e9DDa1E99410C54CE2b2, _tTotal);
    }
    ...
    function setLimitTime(uint256 time) public onlyOwner {
        _limitTime = time;
    }

    function setIsTrade() public onlyOwner {
        _isTrade = !_isTrade;
    }
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            require(balanceOf(from).mul(30).div(100)>amount,"selle max 30%");
            takeFee = true;
        }else{
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] ) {
            ...
            require(!_isStop[from] && !_isStop[to] ,"limit address ");
        }
