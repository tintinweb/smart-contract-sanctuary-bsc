...
contract MuscCraft is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuscCraft";
    string private _symbol = "MuscCraft";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xaF8121DC61Ac7A87aBa4Ea8B1A0Da4Bc93c6d1F4); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xaF8121DC61Ac7A87aBa4Ea8B1A0Da4Bc93c6d1F4); // buyback Address
    ...
    uint256 public _maxTxAmount = 100000000 * 10**9; // 5%
    uint256 public _walletMax = 100000000 * 10**9; // 5%
