...
contract vodprom is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7AF58e6BC83e574225957338add9914CBCa6AABE); //nice
    address payable public charityAddress = payable(0x7AF58e6BC83e574225957338add9914CBCa6AABE); //nice
    ...
    string private _name = "Vod Prom"; //CC"; //CC
    string private _symbol = "VOD";  //nice
