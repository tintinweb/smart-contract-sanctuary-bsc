...
contract StakeTRACE {
    ...
    uint256[4] public Bonus = [100, 12, 20, 45];
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 TRACEVAL = getPriceinUSD();
        uint256 rewardtokenPrice = (amount.mul(TRACEVAL)).div(1e18);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TRACE_WBNB = 0xFf00E422b604c3ee5161AaD64e51e9cabB6fD5aC; // TRACE_WBNB pancake pool address
        IERC20 TRACETOKEN = IERC20(0xf4395E5faB0745eF81c648cDED74Ec4C48fd10AE); // TRACE Token address 

        uint256 WBNBSUPPLYINTRACE_WBNB =(WBNBTOKEN.balanceOf(TRACE_WBNB));
        uint256 TRACESUPPLYINTRACE_WBNB = (TRACETOKEN.balanceOf(TRACE_WBNB));

        uint256 TRACEUSDVAL = (((WBNBSUPPLYINTRACE_WBNB.mul(1e18)).div((TRACESUPPLYINTRACE_WBNB))).mul(BNBPRICE)).div(1e18);
        return TRACEUSDVAL;
    }
