...
contract SaudiPigeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Pige Inu";
    string private constant _symbol = "SaudiPigeInu";
