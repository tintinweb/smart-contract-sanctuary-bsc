...
contract APTEST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PTEST";
    string private _symbol = "PTEST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x185D358E7e2DE28D24ce7b3269d213A5C64ce138); // Marketing Address
    address payable public teamWalletAddress = payable(0x0f804b50f8D495677C85dc3076B1b5F60Df9ea01); // Team Address
	...
	uint256 public tradingEnabledTimestamp = 1653366600000;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
		...
		if(block.timestamp <= tradingEnabledTimestamp) {  //当前块的时间戳小于等于 可交易时间戳
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
	 ...
	 function setTradingEnabledTimestamp(uint256 datetime) external onlyOwner() {
        tradingEnabledTimestamp = datetime;
     }
	 //设置黑名单地址
