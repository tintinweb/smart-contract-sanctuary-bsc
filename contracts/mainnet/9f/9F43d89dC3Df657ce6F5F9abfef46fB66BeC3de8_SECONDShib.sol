...
contract SECONDShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SECOND Shib";
    string private _symbol = "SECOND Shib";
    uint8 private _decimals = 0;

    address payable private marketingWalletAddress = payable(0xCF06Fb332A2bfdfA466bAc4a25caE39248D09B71); // Marketing Address
    address payable private teamWalletAddress = payable(0xCF06Fb332A2bfdfA466bAc4a25caE39248D09B71); // Team Address
    ...
    uint256 private _totalSupply = 59 * 10**28;
    uint256 public _maxTxAmount = 59 * 10**28; 
    uint256 public _walletMax = 59 * 10**28;
    uint256 private minimumTokensBeforeSwap = 59 * 10**28;
    ...
    constructor () {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xE1F3311C05dbC0595c9A219Fc4422912A157e007); 
