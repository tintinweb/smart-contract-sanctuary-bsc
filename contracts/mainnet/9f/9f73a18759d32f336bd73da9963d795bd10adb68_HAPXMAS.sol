...
contract HAPXMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HAPPY XMAS";
    string private _symbol = "HAPXMAS";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x72F12912378644D79B137420e99125D7141808F6); // Marketing Address
    address payable public BuyBackWallet = payable(0x72F12912378644D79B137420e99125D7141808F6); // Team Address
