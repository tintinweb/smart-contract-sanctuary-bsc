...
contract WikiBTCRun is Context, IERC20, Ownable {
    ...
    string private constant _name = " Wiki BTC Run "; // 
    string private constant _symbol = " $WBTCR "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x27Ac2b71DB80564DB406308fF819Ee60F6158082;
