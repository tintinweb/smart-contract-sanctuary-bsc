...
contract FGD2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "fGDTOKEN2.0";
    string private _symbol = "FGD2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF3Df030e666dBA51A1d4BF4B53737AEE520B7481); 
    address payable public BurnedWalletAddress = payable(0xF3Df030e666dBA51A1d4BF4B53737AEE520B7481); 
