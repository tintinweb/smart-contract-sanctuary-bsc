...
contract MoonyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MoonyInu";
    string private _symbol = "$MOONY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA869dc708B3f1F20Bb1103E50CAF827cF5D8C24B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA869dc708B3f1F20Bb1103E50CAF827cF5D8C24B); // BuyBack Address
