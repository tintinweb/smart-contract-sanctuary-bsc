...
contract BallsGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Balls Grow";
    string private constant _symbol = "BallsGrow";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 140000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 150000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x5565faFC758A7644Db75A076bd9F72E5a404C9B8);
