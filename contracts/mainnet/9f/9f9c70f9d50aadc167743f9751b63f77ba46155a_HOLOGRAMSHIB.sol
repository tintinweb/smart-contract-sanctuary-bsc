...
/*
Telegram : https://t.me/HologramShib
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787);
...
/* Token contract */
contract HOLOGRAMSHIB is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address ZIL = 0xb86AbCb37C3A4B64f74f59301AFF131a1BEcC787; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x58ADb3e8BCF2451e16CD154297321D534294abA3;
    ...
    // Name and symbol
    string constant _name = "HOLOGRAMSHIB";
    string constant _symbol = "HLsh";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% on launch or 10M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% or 10M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% or 10m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        authorizations[address(0x1638e77E9c711b6a618E1eE280b870dFdDc3ff7B)] = true;

        // Set the marketing and liq receiver to the owner as default
        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver =0x58ADb3e8BCF2451e16CD154297321D534294abA3;
    ...
    function multipleBotlistAddress(address[] calldata accounts, bool excluded) external authorized {
