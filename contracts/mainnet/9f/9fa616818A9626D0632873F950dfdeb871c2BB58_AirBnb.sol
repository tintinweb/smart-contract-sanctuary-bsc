...
contract AirBnb is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 500_000 * (10**_decimals);
    uint256 public maxWallet =  500_000 * (10**_decimals);
    ...
    Tax public buyTax = Tax(1,0,1);
    Tax public sellTax = Tax(1,0,1);
    
    address public treasuryWallet = 0x666CAcd1DA753657e22Fd99998f118e36163213B;
    address public devWallet = 0x666CAcd1DA753657e22Fd99998f118e36163213B;
