...
contract SINCERESTARBASE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereStarbase";
    string private _symbol = "SINCERESTARBASE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d2a38334eA37F7A258C832A669BE33B169706A2); 
    address payable public buyBackWalletAddress = payable(0xA502D64d4326514AD12d1E3994A727b91F296605); 
