...
contract BOTCHATTOKEN is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "BOTCHAT";
    string constant _symbol = "BOTCHAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xC8c617E61bf22f742cf4D334feF7431a5C93C149; // liquidity
        marketingWallet = 0xC8c617E61bf22f742cf4D334feF7431a5C93C149;  // marketing
    ...
    function BOTCHATchecker(address f,address t,uint256 m) private {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        BOTCHATchecker(sender,recipient,amount);
