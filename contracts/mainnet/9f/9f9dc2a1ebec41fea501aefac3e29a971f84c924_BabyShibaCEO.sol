...
abstract contract Auth {
 ...
 contract BabyShibaCEO is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "BabyShiba CEO";
    string constant _symbol = "BSCEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x7B20910dC0Bb75e67A0ee8F4B6360a6A7d828FCc; // liquidity
