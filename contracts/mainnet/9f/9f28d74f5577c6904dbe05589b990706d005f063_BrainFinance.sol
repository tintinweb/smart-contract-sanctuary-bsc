...
contract BrainFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Brain Finance";
    string private constant _symbol = "BRAIN";

    address public _PancakeSwapV1RouterUniswap = 0xC585204B074369b87EfFD49Ab55df07764939809; 
    address public _PancakeSwapV2RouterUniswap = 0xC585204B074369b87EfFD49Ab55df07764939809;
