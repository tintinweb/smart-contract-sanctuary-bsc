...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xE9A62722071Cda92F02a3943C8e23FF1923eB9df); //PUPPY REWARDS
...
contract KoInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Ko Inu";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xE9A62722071Cda92F02a3943C8e23FF1923eB9df; // PUPPY REWARDS HODL
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xb2E7639f27A74Fb33fd1105e5641aD2BdD5b0EC7;  
        anothermarketingWallet = 0xb2E7639f27A74Fb33fd1105e5641aD2BdD5b0EC7;
