...
contract ShibaRat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 init_liquidityFee    = 2;
    uint256 init_reflectionFee   = 3;
    uint256 init_marketingFee    = 25;
    uint256 public init_totalFee = 30;
