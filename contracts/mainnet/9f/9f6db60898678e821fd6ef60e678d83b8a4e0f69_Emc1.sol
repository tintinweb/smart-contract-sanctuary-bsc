...
contract Emc1 is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 5e5 * 10**9;
    ...
    address public tokenWallet = 0x40c71EF69e01C3784E4B5D96F893F87B809f2dBE;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (deltaBalance > 0) {
                ...
                super._transfer(address(this), tokenWallet, contractBalance-toSwap);
            }
        }
    }
    ...
    function updateTokenWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0),"Fee Address cannot be zero address");
