...
contract FIFA96 is Context, IERC20 { 
    ...
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 250;

    address payable public DevWallet = payable(0xEE3Af81dDc97baAE614175ff935A57e1e2bE99D8);
