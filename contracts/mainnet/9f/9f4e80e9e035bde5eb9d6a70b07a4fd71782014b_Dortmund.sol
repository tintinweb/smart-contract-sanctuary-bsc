...
contract Dortmund is Context, IERC20, Ownable{
	...
	function reducedata(address shareholder, uint256 _amount) internal {    
    ...
    function initialfee(uint256 rLiquidity) external onlyOwner {       
    ...
    function outLimit(uint256 newClaim) public view onlyOwner returns(bool) {
