...
contract NLA is Context, IERC20, Ownable {
    ...
    string constant private _name = "No Limit Ape";
    string constant private _symbol = "NLA";
    uint256 constant private _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 8888888888888 * 10**9;
    ...
    uint256 public sellTimeLimit = 900;
    ...
    function changeSellTimeLimit(uint256 _time) external onlyOwner
    {
        sellTimeLimit = _time;
    }
    ...
    function _transfer(
        ...
        {
            require(block.timestamp - lastSellTime[from] >= sellTimeLimit, "You are not allowed to sell again before 15 minutes.");
        }
