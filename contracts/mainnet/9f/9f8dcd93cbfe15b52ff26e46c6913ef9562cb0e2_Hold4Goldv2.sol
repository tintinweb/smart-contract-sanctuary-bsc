...
THIS IS YOU CHANCE TO RIDE UP THE HYPE 
Hold4Goldv2 will be having a stealth launch for those who missed our v1

enjoy the highest BUSD rewards in the BSC network
Reieve BUSD reflection every hour
...
Telegram link :https://t.me/H4G_Official_Chat
Website : https://www.Hodl4Gold.com
*/
...
contract Hold4Goldv2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOLD 4 GOLD";
    string private _symbol = "H4GV2";
