...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 9999 * 10** Decimals;
        walletLimit =  9999 * 10** Decimals;
...
contract Boss is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        9999,//Supply
        address(0x05C7F935C1F89d000667Ad81f5b6e5620408DEAD),//FundAddress
        address(0x05C7F935C1F89d000667Ad81f5b6e5620408DEAD)//ReceiveAddress
    ){
