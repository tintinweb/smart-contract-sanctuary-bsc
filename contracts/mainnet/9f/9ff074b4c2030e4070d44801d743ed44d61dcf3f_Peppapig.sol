...
contract Peppapig is Context, IERC20, Ownable {
    ...
    string private _name = "Peppa Pig";
    string private _symbol = "PP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x905A1EB85E5Ff07D028aC1aC950C31F730B891E9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x905A1EB85E5Ff07D028aC1aC950C31F730B891E9); // BuyBack Address
