...
contract DummyBoyToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DummyBoy";
    string private _symbol = "DUMBOY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x97224b5576198A8ad40C17AB289d65AeFb7c5c9A); // Marketing Address
    address payable public teamWalletAddress = payable(0xf217aDFC0cd693e888c975B9a94F56D69A2C2281); // Team Address
