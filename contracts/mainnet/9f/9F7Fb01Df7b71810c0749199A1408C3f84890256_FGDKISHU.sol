...
contract FGDKISHU is Context, IERC20, Ownable {
    ...
    string private constant _name = "FGD KISHU";
    string private constant _symbol = "FKI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x49719198DA44cBaF4388040660a2e18C8ed60b78);
    address payable public _marketingAddress = payable(0x49719198DA44cBaF4388040660a2e18C8ed60b78);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnSell < 101, "Tax cannot be more than 15.");
