...
contract RiddleInu  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1c1aDd13a76cb5ccd1E70f3B6a9A6B2cCf529c8C); //IE 
    address payable public Wallet_Dev = payable(0x1300Df1aCd144b1D00956b7c01506dbD7860F3e8); //FF
    ...
    string private constant _symbol = "RIDDLES"; 
    ...
    constructor () {
        ...
        _owner = 0x4dA484B3A3375544757677F0D9dbeBaE5FD8bF64;
