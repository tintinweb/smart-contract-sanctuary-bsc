...
contract WorkN is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
    require(tradingEnabled || whitelist[msg.sender], "Trading not yet enabled");
    ...
    } else if(whitelist[sender] || whitelist[receiver] || sender == marketingPool || receiver == marketingPool) {
      taxAmount = 0;
    } else {
