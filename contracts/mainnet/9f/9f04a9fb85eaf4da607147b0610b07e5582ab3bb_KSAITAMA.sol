...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract KSAITAMA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " KingSaitama ";
    string private _symbol = " KSAITAMA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25E9A34a6551433295710c21C4596BC42bC864fd);
    address payable public teamWalletAddress = payable(0x5339EA87319c2b4b5C8413F03701dc0e27eeF378);
