...
contract FWCI is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Final World Cup Inu WHO?";
    string constant _symbol = "FWCI";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x8C02Ac80618a9Bdf0E4E3b0F4ADC4E85006Cf8C7; // liquidity
        marketingWallet = 0x59EEe00A270a7ffc0FD9b4Cc9Fe7A50437CB1fcb;  // marketing
