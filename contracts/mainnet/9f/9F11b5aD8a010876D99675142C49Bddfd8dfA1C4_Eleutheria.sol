...
//
// Bringing freedom back to defi
// Whitepaper, Website, Staking, NFT collection and Utilities
// coming soon (10k holders+)
//
// Happy trading folks!
//
//
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x44A39F0c5D2E75c4abC5CEc45187D6172aB9b3fe;
...
contract Eleutheria is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x41b1C51eC390EAc399566510fB78869b0E1671c5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ELEUTHERIA";
    string private _symbol = "THERIA";
