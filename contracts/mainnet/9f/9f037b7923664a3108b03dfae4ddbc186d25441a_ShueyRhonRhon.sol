    ...
    Ownable
{
    ...
    uint256 public liquiditySubFee;
    uint256 public marketingSubFee;
    ...
    function excludeFromReward(address account) public onlyRole(ADMIN_ROLE) {
    ...
    function includeInReward(address account) external onlyRole(ADMIN_ROLE) {
        ...
        )
    {
        ...
        _feeInfoTmp.tMarket = tAmount.mul(marketingSubFee).div(1000);
        _feeInfoTmp.tLiquidity = tAmount.mul(liquiditySubFee).div(1000);
    ...
    function updateRouterAndPair(address router, address pair)
        public
        onlyRole(ADMIN_ROLE)
    {
