...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Ownerisasi = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Ownerisasi.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Ownerisasi);
        ...
        uint256 amount = Ownerisasi.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Ownerisasi.transfer(shareholder, amount);
...
contract ShankutsuInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shankutsu Inu";
    string constant _symbol = "SHANKUTSU";
    ...
    // switch 
    function isBots(bool _status) public onlyOwner {
        easily = _status;
    }
    ...
    function limitTransaction(uint256 amount) external authorized {
        _maxTxAmount = amount;
    }
