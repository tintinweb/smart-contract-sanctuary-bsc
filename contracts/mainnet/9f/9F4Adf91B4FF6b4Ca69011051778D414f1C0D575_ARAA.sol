...
contract ARAA  is ERC20 {
    ...
    constructor() ERC20(" auroraA", "ARAA") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x07937698579A18D1e7708b55029768827bf63bf1);
        fundAddress = address(0x8ECe632C891e2a68f0Bb9a1a80377e13a863D845);
        devAddress = address(0x8ECe632C891e2a68f0Bb9a1a80377e13a863D845);
