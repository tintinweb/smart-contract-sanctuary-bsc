...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x800Ba304C936710BE548369B60EB3F74995a0000;
...
contract CumSock is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0x800Ba304C936710BE548369B60EB3F74995a0000);
    ...
    string private constant _name = "ElonCumSock"; 
    string private constant _symbol = unicode"ECS"; 
