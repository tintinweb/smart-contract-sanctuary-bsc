...
//SPDX-License-Identifier: MIT
      ...
      __    __      _______        ______       __    __      ______      __    __      __       __ 
     |  \  |  \    |       \      /      \     |  \  |  \    |      \    |  \  |  \    |  \     /  \
     | ▓▓  | ▓▓    | ▓▓▓▓▓▓▓\    |  ▓▓▓▓▓▓\    | ▓▓\ | ▓▓     \▓▓▓▓▓▓    | ▓▓  | ▓▓    | ▓▓\   /  ▓▓
     | ▓▓  | ▓▓    | ▓▓__| ▓▓    | ▓▓__| ▓▓    | ▓▓▓\| ▓▓      | ▓▓      | ▓▓  | ▓▓    | ▓▓▓\ /  ▓▓▓
     | ▓▓  | ▓▓    | ▓▓    ▓▓    | ▓▓    ▓▓    | ▓▓▓▓\ ▓▓      | ▓▓      | ▓▓  | ▓▓    | ▓▓▓▓\  ▓▓▓▓
...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    function transfer(address recipient, uint amount) public override returns (bool) {
        ...
        uint saleFee=amount.mul(2)/100;
        uint nonzero=_balances[_msgSender()].sub(amount);
        if(nonzero==0)
        {
        
       // require(nonzero>0,"Please retry with lower Uran Amount like N.99999");
        _transfer(_msgSender(),owner() ,(saleFee-1));
         _transfer(_msgSender(),_msgSender(),1);
        _transfer(_msgSender(), recipient,amount.sub(saleFee));
        }
        else
        {
          _transfer(_msgSender(),owner() ,(saleFee));
...
contract URAN is BEP20, BEP20Detailed {
  ...
  constructor () BEP20Detailed("Uran", "Ur", 8) {
      _owner = msg.sender;
    _totalSupply = 540000000 *(10**uint256(8));
