...
We Spark
Ideas to Life.
Europe’s leading and most-comprehensive blockchain solutions provider.
Services
Get access to STORM Partners multidisciplinary team of blockchain professionals, where each department is 100% on tangible results & your project’s success.
Marketing & Growth
Legal & Compliance
Finance & Fundraising
Education & Events
...
abstract contract Contextbep20STORMAI {
...
contract Ownablebep20STORMAI is Contextbep20STORMAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20STORMAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20STORMAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract STORMAIToken  is Contextbep20STORMAI, bep20STORMAI, Ownablebep20STORMAI {
    ...
    string private _name = 'STORM AI';
    string private _symbol = 'STORM AI';
