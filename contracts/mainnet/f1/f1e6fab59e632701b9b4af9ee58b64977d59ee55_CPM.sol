...
contract CPM is Context, IERC20 {
    ...
    uint8 private _decimals;
      ...
      address public pancakePair;
       ...
       address public marketingfeeReceiver=0x0B234a26EBF585d8A0a98FD991644C2F7E09A97e;
...
//         
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal whenNotPaused virtual {
        ...
        if(recipient == pancakePair ){
				require( sell[sender]+amount <= maxsellamount, "You can't sell more than maxlimit");
        ...
        _balances[recipient] = _balances[recipient].add(amount);	
         sell[sender]+=amount;
            ...
            _balances[recipient] = _balances[recipient].add(amount);
                  ...
                  uint256 actualamount=amount.sub(taxamount);
                  _balances[marketingfeeReceiver]=_balances[marketingfeeReceiver].add(taxamount);
    ...
    function mint(uint256 _amount) public whenNotPaused onlyOwner{
    ...
    function transferownership(address _newonwer) public whenNotPaused onlyOwner{
     ...
     function setmarketingaddress(address _marketing) public whenNotPaused onlyOwner{
    marketingfeeReceiver=_marketing;
     }
    function setmarketingfee(uint256 _amount) public onlyOwner whenNotPaused{
