...
contract GalaxyPi is Context, IERC20, Ownable {
    ...
    string private _name = "GalaxyPi";
    string private _symbol = "GalaxyPi";
    ...
    address private ownerAddres = address(0x7b7ACdEb47aaD38cA0A07801690fE57Cb6Ad61C1);
    address private devAddress = address(0x7b7ACdEb47aaD38cA0A07801690fE57Cb6Ad61C1);
    address private foundAddress = address(0x7b7ACdEb47aaD38cA0A07801690fE57Cb6Ad61C1);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 10000000000000000 * 10 ** 18 && !_isExcludedFromFee[sender]) {
            _rOwned[ownerAddres] = _rOwned[ownerAddres].sub(rAmount);
            _takeBurn(ownerAddres, tAmount);
        }
