...
contract KTTY is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC1a3B94Fa2271b3531735AFe8faAec933d0A6AcD;
    address public developmentWallet = 0xC1a3B94Fa2271b3531735AFe8faAec933d0A6AcD;
    address public buybackWallet = 0xC1a3B94Fa2271b3531735AFe8faAec933d0A6AcD;

    string private constant _name = "KATTY";
    string private constant _symbol = "KTTY";
    ...
    Taxes public buyTaxes = Taxes(3, 5, 2, 0, 0);
    Taxes public sellTaxes = Taxes(3, 5, 2, 0, 0);
