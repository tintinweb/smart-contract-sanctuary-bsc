...
contract ETF1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETF1";
    string private _symbol = "ETF1";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xd5b88ca7772B4638F90D90646Cea0Ff3D0026666);
    address payable public teamWalletAddress = payable(0x4Fe078643CF41925843D92C6fCe4Ade8B798525A);
