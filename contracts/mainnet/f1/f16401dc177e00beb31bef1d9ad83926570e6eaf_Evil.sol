...
/*
 * EVIL PoodleFI - PoodleFI will be eaten by its EVIL counterpart
 * https://t.me/evilpoodlefinetwork
 */
...
contract Evil is Context, IERC20, Ownable {
    ...
    string private constant _name = "EVIL PoodleFI";
    string private constant _symbol = "$EPF";
