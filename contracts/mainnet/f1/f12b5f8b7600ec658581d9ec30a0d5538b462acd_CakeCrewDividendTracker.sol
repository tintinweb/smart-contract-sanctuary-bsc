...
contract LittleBabyWhale is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "LittleBabyWhale";
    string _symbol = "BabyWhale";
    ...
    address private marketing = address(0x160Cf80312030a4541F80Bb4EA275af2f85eC7f5);
    address private liquidity = address(0x7269778904c65c2991171957df34aC1e98d57c1C);
