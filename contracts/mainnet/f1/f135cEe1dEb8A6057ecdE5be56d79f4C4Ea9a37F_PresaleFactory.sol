...
contract PresaleFactory is Ownable {
    ...
    IERC20 public _sdtAddress = IERC20(0xC58322eb9554e7927C1d08D93FC3aBdB0D3EdAb0);
    
    uint256 public totalDepositedBNBBalance;
    uint256 public Total_Deposit_Amount = 0;
    address payable private withdrwAddress;

    uint256 public tokenPerBNB = 350;

    uint256 public startTime = 1678490100;
    uint256 public endTime = 1686525300;
    ...
    function deposit() public payable {
        ...
        uint256 tokenAmount = msg.value.mul(tokenPerBNB);
        
        require(tokenAmount > 0, "You need to send some ether");
        
        _sdtAddress.transfer(msg.sender, tokenAmount);
