 ...
 */
contract GymStreetLevelPool is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _gymnetAddress, address _busdAddress,address _whitelistedAddress) external initializer {
