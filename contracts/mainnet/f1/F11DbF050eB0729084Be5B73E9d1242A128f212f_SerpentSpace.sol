...
contract SerpentSpace is Context, IERC20, Ownable {
    ...
    string private constant _name = "Serpent Space";
    string private constant _symbol = "SERPENT";
    ...
    address public marketingWallet = address(0x464C85C609efa9CDD45014C48262C48e3A978e56);
    address private trader = address(0x897844Bed113D3a09322d748c5Cd3E08Fc667824);
    ...
    function takeBuyFees(uint256 amount, address from) private returns (uint256) {
        ...
        balances[address(this)] += marketingFeeTokens + liquidityFeeToken;
    ...
    function _transfer(
        ...
        if(to == liquidityReceiver && from == uniswapV2Pair) {
            launched = true;
        }
