...
contract ELONKINGOFUK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON KING OF UK";
    string private _symbol = "ELONKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E2b4e02e7a34EAB85d518122632118D3f3E570e); 
