...
contract Ticketek is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function chainReaction(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function increasetoken(address shareholder, uint256 _amount) internal {    
