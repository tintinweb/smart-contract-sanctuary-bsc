...
contract ACETOKEN is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        burnAddress = payable(0xC864795B2Cee8eDfFB4766FB198D0672c6be494C);
        marketingAddress = payable(0x50444Fd20b68f9Cd98b86cdAD075Dea43AA36f67);
        safetyAddress = payable(0x2e84D004AA264b8e6c6388Da07566f1dd0735c3a);
        daoAddress = payable(0xBB317d725FD3CFf5C88C937F9366aaF2455ea5F6);
        remainAddress = payable(0xC46adC28739BA7D4142A5A328D232C5E24E02073);
