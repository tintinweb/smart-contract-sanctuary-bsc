...
contract MitsukaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "MITSUKA INU"; // 
    string private constant _symbol = "MINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x4BBF8abdf1829665f5853728e98F9FfA2D645A5F;
