...
/**
 * Story: Are you ready to open the door ? Unlock rewards
 * Developed by: Mysterious Surge team
 * TG: t.me/MysteriousSurge
 */
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "Mysterious Surge";
    ...
    uint256 public sellMul = 94;
    uint256 public buyMul = 94;
    ...
    //Tax wallets
    address public teamWallet = 0x27b732f274A6907eC66383f9568067bfD92e5F81;
    address public treasuryWallet = 0xE418C77b0bB1779ABDE6ea1B1a3bCF6c843a7c8D;
