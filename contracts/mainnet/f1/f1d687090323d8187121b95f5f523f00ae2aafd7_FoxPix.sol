...
contract FoxPix is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FOXPIX";
    string private constant _symbol = unicode"$FPIX";
    ...
    address payable public DevWallet = payable(0xd1135285c96f76717B1BF78dC457Ae9d20DFf51f);
    address payable public MarketingWallet = payable(0x5b9ceB1182Be0ad029B41ffB52dBdf210B093F0B);
