...
/**
 *Submitted for verification at BscScan.com on 2022 3-18
*/
...
contract ApeMetaVerse is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ApeMetaVerse";
    string constant _symbol = "APEMV";
