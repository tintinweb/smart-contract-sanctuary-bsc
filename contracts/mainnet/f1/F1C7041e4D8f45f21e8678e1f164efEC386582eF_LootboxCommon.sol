...
// File: contracts/lootBox/LootboxCommon.sol
...
contract LootboxCommon is Ownable {
  ...
  constructor(IMintToken _nftAddress, address _router, uint _secondaryParamsCount) public {
    ...
    uint[] memory badges = new uint[](12);
    for(uint i = 0; i < 8; i++) {
      badges[i] = 1;
    }
    badges[8] = 4;
    ...
    uint[] memory jackets = new uint[](18);
    jackets[0] = 1;
    jackets[1] = 1;
    jackets[2] = 1;
    jackets[3] = 1;
    ...
    uint[] memory gradients = new uint[](13);
    gradients[0] = 2;
    gradients[1] = 1;
    gradients[2] = 1;
    gradients[3] = 1;
    ...
    uint[] memory accessories = new uint[](14);
    accessories[0] = 1;
    accessories[1] = 2;
    accessories[2] = 2;
    accessories[3] = 2;
