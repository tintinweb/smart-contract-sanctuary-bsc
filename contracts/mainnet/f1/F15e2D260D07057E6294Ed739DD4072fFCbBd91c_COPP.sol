...
contract COPP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "COPP";
    string private _symbol = "COPP";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress =
        payable(0x8441AbFe2075BC3820E3325c6f9695b570E2127c); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x8441AbFe2075BC3820E3325c6f9695b570E2127c); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x99431e669eb78B64f2140cf4022464548057e996;
