...
Telegram : https://t.me/OnlyShibaInuBSC
...
contract OnlyShibaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4c3A3970925f0f842B45ee8238Cd774D57Ae592e); 
    address payable public Wallet_Utility = payable(0x752E131fB958D2A5FF0ACbBeAca77e4fd812c7Cd);
    ...
    string private constant _name = "Only Shiba Inu"; 
    string private constant _symbol = unicode"ONLY SHIBA INU"; 
    ...
    constructor () {
        ...
        _owner = 0x752E131fB958D2A5FF0ACbBeAca77e4fd812c7Cd;
