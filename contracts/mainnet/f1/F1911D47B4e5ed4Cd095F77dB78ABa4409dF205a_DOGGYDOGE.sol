...
contract DOGGYDOGE is Ownable, IBEP20 {
    ...
    string  _name = "Doggy Doge";
    string  _symbol = "$DOGGY";
    ...
    uint256 public totalFee        = marketingFee + liquidityFee + burnFee + devFee;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x9dC1754971A2515EFD27bEA460aC850954AAc728;
        devFeeReceiver = 0x9dC1754971A2515EFD27bEA460aC850954AAc728;
    ...
    function set_Max_Wallet_Holding_Percent(uint256 _amount) external onlyOwner {
  	    _maxWalletToken = _amount.mul(10**_decimals);
  	}

    function set_Max_Transaction_Percent(uint256 _amount) external onlyOwner() {
        _maxTxAmount = _amount.mul(10**_decimals);
    }
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit is Exceeded");
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;        
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _marketingFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
