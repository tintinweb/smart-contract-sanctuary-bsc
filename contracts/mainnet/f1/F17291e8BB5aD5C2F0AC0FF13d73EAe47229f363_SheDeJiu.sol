...
contract SheDeJiu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SheDeJiu";
    string private _symbol = "SheDeJiu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4fFC31e9Ab8D1cdbA526dC96B1B6d3838dE0eB2e); 
