...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 3061 * 10 ** Decimals;
        maxWalletAmount = 3061 * 10 ** Decimals;
        thA = msg.sender;
        _tTotal = total;
...
contract XBToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0xBa0edEe69041a153b731796ebF45fE61Ac95FC7A),
        address(0xBF54C3A4C43Ba2F3dEeb4c352aFDff019845897A),
    
        address(0x518E0fB163A558b3F1Dd680B9269D2e824B89FB5)
    ){
