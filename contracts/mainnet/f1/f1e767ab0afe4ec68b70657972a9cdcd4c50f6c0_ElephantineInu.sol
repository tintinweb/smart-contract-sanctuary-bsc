...
Tokenomics :
🐘 Token Name : Elephantine Inu [$ELIN]
🐘 Total Supply : 100.000.000
🐘 Max Wallet : 4% (4M Tokens)
🐘 Tax : 7/7%
...
contract ElephantineInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "ELEPHANTINEINU";
    string private constant _symbol = unicode"$ELIN";
    ...
    address payable public DevWallet = payable(0x8c5533e27546F20040dc2d4C2520fF7fCD3a2EA8);
    address payable public MarketingWallet = payable(0xbF4d0eee2C3367bcD0a680501328a3A21d6B7dC0);
