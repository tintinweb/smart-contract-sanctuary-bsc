...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72C682963A5328fF24e50E6CE8a2496022a6Bc87; // owner address
...
contract ShibaGenesis is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaGenesis";
    string private _symbol = "ShiGen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72C682963A5328fF24e50E6CE8a2496022a6Bc87); // 
    address payable public teamWalletAddress = payable(0x72C682963A5328fF24e50E6CE8a2496022a6Bc87); // 
