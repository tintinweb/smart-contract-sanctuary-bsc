...
contract pigexclamation is ERC20, Ownable {
	...
	constructor (
		...
		uint256 _supply = 1000000000 * (10 ** 9);
    ...
    function setMaxTransactionRates_Denominator1000(uint256 _maxTransactionRateBuy, uint256 _maxTransactionRateSell) external onlyOwner _maxTransactionAvailable {
        require(_maxTransactionRateSell >= 10 && _maxTransactionRateBuy >= 10, "Max Transaction limit cannot be lower than 0.1% of total supply"); 
