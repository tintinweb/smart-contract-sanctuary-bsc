...
// NEW EMOJI TWEET BY CZ BINANCE NEW HYPE
// LIQ WILL BURN 
// LOW TAX
// LOW MAX WALLET FOR ANTI WHALE
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCb66022ceAD701BD6f0a37BeF059cCC82fd140EE; // Owner
...
contract NewEmoji is Context, IERC20, Ownable {
    ...
    string private _name = "NEW EMOJI";
    string private _symbol = "EMOJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCb66022ceAD701BD6f0a37BeF059cCC82fd140EE); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x008Ec527D13a95787d2E90feE2aaeF86B9612b9e); // Team Wallet
