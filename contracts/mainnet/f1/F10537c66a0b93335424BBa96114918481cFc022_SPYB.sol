...
contract SPYB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 130 * 10**3 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x8D8Bea71C1f491Fa8416FE4d2b0381f3a59E4B7E)); //marketing wallet
    ...
    constructor() ERC20("SPY INU BUSD", "SPYB") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("SPYB_Dividend_Tracker", "SPYB_Dividend_Tracker")
    {
        claimWait = 3600;
