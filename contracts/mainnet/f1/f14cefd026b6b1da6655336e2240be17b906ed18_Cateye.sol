...
contract Cateye is IBEP20, Auth {
    ...
    string constant _name = "Cat Eye";
    string constant _symbol = "Cat Eye";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 1 / 100; // 2%
    uint256 public _maxTxAmountSell = _totalSupply * 1 / 100; // 2%
