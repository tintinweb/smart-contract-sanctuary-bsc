...
/**
Babybossy Don’t miss out Launching in 15 minutes 
Low MCap 1000 X Potential Based Dev and Team Mudra LP Lock Contract Ownership Renounced Use Case Already Provided
...
contract babybossy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYBOSSY";
    string private _symbol = "BOSSY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b9fef12B8B9577536d5fDc249F8cB00C016Dd35); 
    address payable public buyBackWalletAddress = payable(0x6b9fef12B8B9577536d5fDc249F8cB00C016Dd35); 
