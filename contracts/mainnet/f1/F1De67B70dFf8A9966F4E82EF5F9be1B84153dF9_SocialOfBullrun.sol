...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x907A3da92cA3539793E6fE5115111DfDE96B2fC4; // owner address
...
contract SocialOfBullrun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SocialOfBullrun";
    string private _symbol = "SocialBullrun";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x907A3da92cA3539793E6fE5115111DfDE96B2fC4); // 
    address payable public teamWalletAddress = payable(0x907A3da92cA3539793E6fE5115111DfDE96B2fC4); // 
