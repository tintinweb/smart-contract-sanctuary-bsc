...
contract TITTERSHIBA is ERC20 {
    using SafeMath for uint256;
    using Address for address;
    uint256 public constant maxSupply = 10**11 * 10**18;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    uint256 public constant marketingSellFee = 4; 
    uint256 public constant marketingBuyFee = 3; 
    uint256 public constant liquiditySellFee = 1;
    uint256 public constant liquidityBuyFee = 1;
    uint256 public constant burnSellFee = 1;
    uint256 public constant burnBuyFee = 1;    
    address public constant marketingAddress = 0xCc1006CD06EAcee1048842B6C26C56A14662DeAC; // Marketing Wallet
