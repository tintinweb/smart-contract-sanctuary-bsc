...
contract LAOSTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LAOSTOKEN contract."
        );
    }
...
contract LAOSTOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LAOSTOKENDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = LAOSTOKENDividendTracker(
