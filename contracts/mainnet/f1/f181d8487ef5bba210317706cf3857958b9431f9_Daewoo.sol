...
contract Daewoo is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Daewoo";
    string private constant _symbol = "Daewoo";
    uint8 private constant _decimals = 9;
    uint private _totalSupply = 1800000000 * 10 ** _decimals;
    ...
    constructor () {
        ...
        emit Transfer(address(0), Admin, _totalSupply);
              ...
              uint burnamount = _totalSupply.mul(29).div(100);
