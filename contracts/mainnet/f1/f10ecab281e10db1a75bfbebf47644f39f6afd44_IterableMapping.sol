...
contract Dogehuman is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DogeHuman", "DoHu") {
        BNBRewardsFee = 0;
        liquidityFee = 1;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 0;
        marketingWallet = payable(0xB285000B93e847aD351bd0849b67C7a4E6dEBe49);
