...
contract WonkaInuToken is IBEP20, Auth {
    ...
    string constant _name = "Wonka inu";
    string constant _symbol = "$Wonka";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 2 / 1000; // 0.2% max transaction amount buy
    uint256 public _maxTxAmountSell = _totalSupply * 2 / 1000; // 0.2% max sell

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 1000; // 0.2% nax wallet
