  ...
  , IERC20Metadata
{
  ...
  string private _name = "Wayspad";
  string private _symbol = "WAYS";
  uint8 private _decimals = 18;
  uint256 private _totalSupply;
  uint256 _taxBuy = 0;
  uint256 _taxSell = 0;    
  uint256 _taxDivider = 100;
  uint256 _taxSellTokenLimit = 100000000000000000000000;
  uint256 _maxTaxPercentage = 0;
  ...
  address _treasuryWallet = 0x66fE6a88E6145F158C7FD1b61423819EB18fC9Cf;
  address _teamWallet = 0x66fE6a88E6145F158C7FD1b61423819EB18fC9Cf;
  ...
  mapping(address => bool) _excludedBuyFee;
  mapping(address => bool) _excludedSellFee;
  ...
  function distributeFee () private swapping {
    ...
    if (_balances[address(this)] > 0) {
      ...
      try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        (bool sent_1, ) = payable(_treasuryWallet).call{value: (amountBNB * 50 / 100), gas: 30000}(""); require(sent_1, "Transfer wallet_1 error."); 
        (bool sent_2, ) = payable(_teamWallet).call{value: (amountBNB * 50 / 100), gas: 30000}(""); require(sent_2, "Transfer wallet_2 error.");
