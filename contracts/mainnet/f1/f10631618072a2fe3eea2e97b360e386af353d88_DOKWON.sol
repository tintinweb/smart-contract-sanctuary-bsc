...
// Telegram : https://t.me/dokwoninuuu
...
contract DOKWON is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"DKWON";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x7fD517a65E52A29a45022227dd7D58BFA4c26876);
    address payable public MarketingWallet = payable(0xCdEA35C8F87218f5237b34F27Eb41C9e28a7A7fe);
