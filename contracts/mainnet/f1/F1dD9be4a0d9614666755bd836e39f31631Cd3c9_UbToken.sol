...
abstract contract UToken is IERC20, Ownable {
    ...
    function setFee(uint256 fundFee, uint256 lpDividendFee) external onlyOwner {
        ...
        require(fundFee + lpDividendFee  <= 2500, "max 25%");
    }
    ...
    function getTokenInfo() external view returns (
        ...
        bool canAirdrop, uint256 endTime, uint256 blockTime
    ){
...
contract UbToken is UToken {
    ...
    //USDT
        ...
        1000000,
    //Fund
        address(0xD3a7816124895107f7E4a0d72bF804F476238686),
    //Receive
        address(0xD3a7816124895107f7E4a0d72bF804F476238686)
    ){
