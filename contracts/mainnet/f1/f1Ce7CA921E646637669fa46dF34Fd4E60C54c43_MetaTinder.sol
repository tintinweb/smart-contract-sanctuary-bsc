...
MetaTinderApp.com
Made Match Group Blockchain
https://mtch.com/
https://t.me/MetaTinder_App
https://metatinderapp.com/
https://twitter.com/MetaTinder_app
https://www.reddit.com/user/MetaTinder

PHASE 1 
Creation Brand, Website and DATE Contract;
 Marketing and Promotions;
 Liquidity Blocked, Burning, Verify and CertiK;
 Launch without pre-sale, on PancakeSwap;
 Listing on Coinmarket and Coingecko;

PHASE 2
 Integration with the Tinder application – Swipe Right®;
 Profile Creation in Metatinder – Swipe Right Metaverse®;
 Customization of Metatinder with DATE; [10,000 DATE]

PHASE 3
 Launch of Social Spaces in Metaverse;
 Use of Private Spaces in Metaverse with DATE; [25,000 DATE]
 New Customizable Clothing and Accessories;
 Gifts and Interactions;

PHASE 4
 Interactions in a private environment;
 Listing on Binance;
...
contract          MetaTinder                                                              is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("MetaTinder", "DATE") {
