...
// Telegram: t.me/NekoGirlCoin
// Website: NekoGirlCoin.com
...
library Address{
 ...
 contract NGIRL is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _canTransferBeforeTradingIsEnabled;
    ...
    uint256 public swapTokensAtAmount = 3_000_000 * 10*11;
    uint256 public maxBuyLimit = 10_000_000 * 10**11;
    uint256 public maxSellLimit = 5_000_000 * 10**11;
    uint256 public maxWalletLimit = 10_000_000 * 10**11;
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0x301d954039181C17e050ADe5d1Fff646BcDe6B33;
    address private burnWallet = 0x301d954039181C17e050ADe5d1Fff646BcDe6B33;
    address private buybackWallet = 0x301d954039181C17e050ADe5d1Fff646BcDe6B33;

    string private constant _name = "Neko Girl";
    ...
    Taxes private taxes = Taxes(0, 2, 2, 2, 0);
    Taxes private sellTaxes = Taxes(0, 2, 2, 2, 0);
    ...
    function allowPreTrading(address account, bool allowed) public onlyOwner {
        require(_canTransferBeforeTradingIsEnabled[account] != allowed, "Pre trading is already the value of 'excluded'");
        _canTransferBeforeTradingIsEnabled[account] = allowed;
    }
    ...
    function AutoSwapOn(bool state) external onlyOwner{
        swapEnabled = state;
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _burn, uint256 _buyback) public onlyOwner {
       taxes = Taxes(_rfi,_marketing,_liquidity,_burn,_buyback);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _burn, uint256 _buyback) public onlyOwner {
       sellTaxes = Taxes(_rfi,_marketing,_liquidity,_burn,_buyback);
        emit FeesChanged();
    }
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rBurn) = _getRValues2(to_return, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.tRfi-s.tMarketing-s.tLiquidity-s.tBurn-s.tBuyback;
        return s;
    }
    ...
    function _getRValues2(valuesFromGetValues memory s, bool takeFee, uint256 currentRate) private pure returns (uint256 rBurn) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(sender, address(this), s.tLiquidity + s.tMarketing + s.tBurn + s.tBuyback);
        }
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.burn + temp.buyback) * 2;
    ...
    function updateMarketingWalletStuckBalance(uint256 weiAmount, address _to) external onlyOwner{
