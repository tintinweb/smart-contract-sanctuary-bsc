...
contract SquidPetTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Pet 2.0";
    string private _symbol = "SP2";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1648bf2fA04FC8426D6Ef26FB80d8E879bc8E22E); // Marketing Address
    address payable public teamWalletAddress = payable(0x499A9f4ea12EbA9783Ded3473f782f09773B3A76); // Team Address
