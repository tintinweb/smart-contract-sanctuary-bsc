...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Football DogeKing";
    string private _symbol = "FDK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA17A977Eb4B409bB29bcD9E7FF463e6D6b90d3Af); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x535266D16cb5f5C23354Ae6Ba5C96eC1C848CAc4); // BuyBack Address
