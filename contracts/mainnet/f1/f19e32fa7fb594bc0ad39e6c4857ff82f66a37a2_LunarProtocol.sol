...
contract LunarProtocol is ERC20Detailed, Ownable {
    ...
    uint256 public lunarDividendFee = 70;
    uint256 public sellFee = 20;
    uint256 public blackholeFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(lunarDividendFee).add(
            blackholeFee
        );
    ...
    address public lunarDividendReceiver;
    ...
    constructor() ERC20Detailed("LunarProtocol", "LPRO", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x34bBC9d5Da10A9095e5a5A543b3fAEfF903c36f6;
        treasuryReceiver = 0x744cdFb5d6E77361Bf33BD82cD2dae04357079f7;   
        ...
        lunarDividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(lunarDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(lunarDividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(lunarDividendFee).div(treasuryFee.add(lunarDividendFee))
        } () {} catch {}        
    }
