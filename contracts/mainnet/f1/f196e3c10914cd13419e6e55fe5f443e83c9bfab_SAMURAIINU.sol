...
//Telegram : https://t.me/Samuraiinuportal
//AMA SESSION with USA Crypto Group
// We will reach out strong influencer first, Venom, Gubbin, Brotherhood, Obito, Valhalla, Sardine, Doxxed, Japan Calling are on our list!
...
contract SAMURAIINU is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xDE6387BE2Ea9Cb84f4235e6156EdFAB97D3A1775);
    ...
    string private constant _name = "SAMURAIINU"; 
    string private constant _symbol = unicode"$SAMI"; 
    ...
    constructor () {
        ...
        _owner = 0xDE6387BE2Ea9Cb84f4235e6156EdFAB97D3A1775;
