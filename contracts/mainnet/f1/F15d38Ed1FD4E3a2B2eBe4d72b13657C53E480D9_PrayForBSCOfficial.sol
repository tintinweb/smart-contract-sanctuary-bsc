...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90F2C777eB17D8fACB05515aF6A8979e53B2428d; // owner address
...
contract PrayForBSCOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pray For Bsc";
    string private _symbol = "PFB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e1Eb3e9C41c1d0Ac8fCEe18E7BD05C6EDEa5c54); // Marketing Address
    address payable public teamWalletAddress = payable(0x3e1Eb3e9C41c1d0Ac8fCEe18E7BD05C6EDEa5c54); // Team Address
