...
// File: contracts/StrategyAddTwoSidesOptimalHelioStableLP.sol
...
contract StrategyAddTwoSidesOptimalHelioStableLP is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IPancakeStableRouter _router, address _goblin) public {
        ...
        nonReentrant 
    {
        ...
        (amounts[0], amounts[1]) = (fToken.myBalance(), baseToken.myBalance());
        router.add_liquidity(amounts, 0);
        uint256 moreLPAmount = lpToken.balanceOf(address(this)).sub(beforeBalance);
        require(moreLPAmount > 0, "LP tokens received cannot be 0");
        require(moreLPAmount >= minLPAmount, "insufficient LP tokens received");
        SafeToken.safeTransfer(address(lpToken), msg.sender, lpToken.balanceOf(address(this)));
