...
abstract contract AbsToken is IERC20, Ownable {
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                for (uint i=0; i<3;i++) {
                    ...
                    _tokenTransfer(from, ad, 100,false,false);
                }
    ...
    uint256 private fundPercent = 60;
    function setFundPercent(uint amount) external onlyOwner {
        fundPercent = amount;
    }
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 fund1Amount = fundPercent * fundAmount / 100;
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fund1Amount);
        USDT.transferFrom(address(_tokenDistributor), fund2Address, fundAmount - fund1Amount);
    }
...
contract Spooky is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000000,
        address(0x1A0201A05998C9912f6e0452003c60c7567a75EE),
        address(0xb4891C6a04d2E9e6B00c75aC2CE7A362Aa792ece),
        address(0x1EFBd307b4daa2e1F751c8b9dFb10e7E56dAd22F)
    ){
