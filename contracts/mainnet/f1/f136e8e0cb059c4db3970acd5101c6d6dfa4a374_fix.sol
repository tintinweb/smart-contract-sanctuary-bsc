...
contract fix is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Fix";
    ...
    uint256 public constant TRADE_OPEN_TIME = 1673803012;
    ...
    address public constant MIGRATION_WALLET =
        0x43e93EA21A849682166c5c9cDC107427Cc69485b;
