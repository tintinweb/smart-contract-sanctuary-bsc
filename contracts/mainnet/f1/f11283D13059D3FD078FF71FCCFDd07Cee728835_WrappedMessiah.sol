...
contract WrappedMessiah is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "WrappedMessiah";

    string private _symbol = "$WMESS";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0xac556C493EB81550Eb3753ef8E7286843711Db58;
