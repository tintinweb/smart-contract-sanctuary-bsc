...
contract MCMoneySac is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MCMoneySac";
    string constant _symbol = "MCM$";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x255df36AA3A50c2a3405b047899688234472f460; //Where the 5% marketing fee will be sent
