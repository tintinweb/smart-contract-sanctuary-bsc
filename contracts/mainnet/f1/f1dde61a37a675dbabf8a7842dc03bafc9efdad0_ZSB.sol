...
contract ZSB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZSB";
    string private _symbol = "ZSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x938231F040e1230298F02eb6612E98bE817541f2);
    address payable public teamWalletAddress = payable(0xA0e6eB785DE5291225becFD3d14615bc7E4F5E79);
