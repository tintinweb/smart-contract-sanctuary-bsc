...
// Telegram: https://t.me/BabyAntcoinOfficial

// Twitter: https://twitter.com/BabyAntcoinBsc
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 rANT = IBEP20(0xa52f0c0A5D0217cEE99faBAE71DbaE98ccFc106E);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = rANT.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = rANT.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           rANT.transfer(shareholder, amount);
...
contract BABYANTCOIN is IBEP20, Auth {
   using SafeMath for uint256;
 
   address rANT = 0xa52f0c0A5D0217cEE99faBAE71DbaE98ccFc106E;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby Antcoin";
   string constant _symbol = "babyAnts";
