 ...
 * specific functions at vested time expiration and certain block.
 *
...
contract Ownable is Context{
   ...
   */
  constructor () internal {
    address msgSender = 0x08bC9CcdecDD47254c364EDD19348a0147998789;//_msgSender();
    _owner = msgSender;
...
contract LILMPTokenPresale is Ownable{
    uint256 public investment = 0;
    uint256 public price = 16500;
    Token c ;
    ...
    function withdrawRemainingTokensAfterPRESALE() public{
         require(msg.sender==owner(),"Only owner can update contract!");
    ...
    function forwardFunds() internal {
        address payable PRESALEadmin = address(uint160(owner()));
        PRESALEadmin.transfer(address(this).balance);
    }
