...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25FE0eBd568a8BCCDd0BfD46FAFF71Bd4d76aEBb;
...
contract casinochristmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Casino Christmas";
    string private _symbol = "C-MAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa633889d010046dc6D99F2bD0FA84Cd5f72BC3bf);
    address payable public teamWalletAddress = payable(0xfe73acBcde31A464a33e2c95167e5dBB68c47b39);
