...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x27f41932AC089e89bd2175aec33d6dd51B036a11; // owner address
...
contract MuunShot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MuunShot";
    string private _symbol = "MuunS"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2C69BFc593a6E9899179167E0D8509319067CFE); // Marketing Address
    address payable public teamWalletAddress = payable(0xca0B45Afd5C81398682ff639043F5Ffd73D9a8b7); // Team Address
