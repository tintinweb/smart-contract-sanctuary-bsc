...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x631db4a597f07A44b692719Abd5F3C1e5F9DCA75;
...
contract kstonks is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Wallet_Dev = payable(0x631db4a597f07A44b692719Abd5F3C1e5F9DCA75);
    ...
    string private constant _name = unicode"(=^ ◡ ^=)KittyStonks(=^ ◡ ^=)"; 
    string private constant _symbol = unicode"KSTONKS"; 
