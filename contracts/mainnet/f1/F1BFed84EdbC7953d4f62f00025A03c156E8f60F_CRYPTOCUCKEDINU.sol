...
/**
TELEGRAM: https://t.me/cryptocuckedinu
   */                                                                       
...
contract CRYPTOCUCKEDINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Crypto Cucked INU";
    string constant _symbol = "CCI";
    ...
    uint256 _maxTxAmount = 2 * 10**9 * (10 ** _decimals);
    uint256 _walletMax = 2 * 10**9 * (10 ** _decimals);
    
    uint256 public maxTxAmount = _maxTxAmount.div(10 ** _decimals);
    uint256 public walletMax = _walletMax.div(10 ** _decimals);
    ...
    uint256 swapThreshold = 1 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2698026f13C1016711d899E557f385B7c49d402B;
        devWallet = 0xF1A2cd23FF4164d6374F456625821ba7e6d90C9f;
    ...
    function changeFeeReceivers(address newMarketingWallet, address newDevWallet) external authorized {
