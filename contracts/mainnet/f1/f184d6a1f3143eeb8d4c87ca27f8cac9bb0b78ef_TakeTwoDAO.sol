...
contract TakeTwoDAO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Take 2 DAO";
    string private _symbol = "T2DAO";
    ...
    uint256 private _maxTxAmount = 100000000000000 * 10**_decimals; 
    uint256 private _walletMax = 100000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xED545cFd9C5CE3A63FcbE8C7Ab6cFD4c1f046F65));
        marketingWalletAddress = payable(address(0xED545cFd9C5CE3A63FcbE8C7Ab6cFD4c1f046F65));
