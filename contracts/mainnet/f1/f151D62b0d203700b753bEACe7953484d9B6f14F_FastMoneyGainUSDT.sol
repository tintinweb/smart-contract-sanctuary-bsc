...
// _____ _    ____ _____   __  __  ___  _   _ _______   __   ____    _    ___ _   _ 
//|  ___/ \  / ___|_   _| |  \/  |/ _ \| \ | | ____\ \ / /  / ___|  / \  |_ _| \ | |
//| |_ / _ \ \___ \ | |   | |\/| | | | |  \| |  _|  \ V /  | |  _  / _ \  | ||  \| |
//|  _/ ___ \ ___) || |   | |  | | |_| | |\  | |___  | |   | |_| |/ ___ \ | || |\  |
//|_|/_/   \_\____/ |_|   |_|  |_|\___/|_| \_|_____| |_|    \____/_/   \_\___|_| \_|

//https://fastmoneygain.xyz/
...
contract FastMoneyGainUSDT {
    using SafeMath for uint256;

    IToken public token_BUSD;
	address erctoken = 0x55d398326f99059fF775485246999027B3197955; /** USDT **/
    ...
    uint256 public COMPOUND_FOR_NO_TAX_WITHDRAWAL = 2; // Reinvest days, for no tax withdrawal.
	...
	uint256 public WITHDRAW_COOLDOWN = 48 * 60 * 60; /** 4 hours  **/
    ...
    constructor(address _dev1, address _dev2, address _dev3, address _dev4) {
		require(!isContract(_dev1) && !isContract(_dev2) && !isContract(_dev3) && !isContract(_dev4));
        owner = msg.sender;
        dev1 = _dev1;
        dev2 = _dev2;
        dev3 = _dev3;
    ...
    function CHANGE_DEV4(address value) external {
        require(msg.sender == dev4, "Admin use only.");
        dev4 = value;
    }
