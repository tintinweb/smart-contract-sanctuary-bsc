...
contract FIFABET is BEP20, Ownable {
    ...
    address public marketingWallet = 0xfF3A276e63b46b11e75674afE6fc31CeeED87F3E;
    address public devWallet = 0x3fb60C4449DcE705D0B8bDe716ec0a79Dd132603;
    ...
    constructor() BEP20("FIFABET2022", "FB22") {
        ...
        exemptFee[0xfF3A276e63b46b11e75674afE6fc31CeeED87F3E] = true;
        exemptFee[0x3fb60C4449DcE705D0B8bDe716ec0a79Dd132603] = true;
    ...
    function _transfer(
        ...
        bool useLaunchFee = !exemptFee[sender] &&
            !exemptFee[recipient] &&
            block.number < genesis_block + deadblock;
    ...
    function updatedeadblock(uint256 _deadblock) external onlyOwner {
