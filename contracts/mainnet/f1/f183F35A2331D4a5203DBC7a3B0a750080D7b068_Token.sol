...
// TopGunDoge - We are ready to fly.
...
contract Token is Context, IERC20, Ownable {
   ...
   address public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //main
   // address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // testnet
    ...
    constructor (string memory tokenName,
        ...
        uint16 setMxTxPer, uint16 setMxWalletPer,
        FeeWallet memory wallet, address _rewardToken,
        uint256 _minimumTokenBalanceForDividends, Fee memory fee, address payable _feeReceiver
        ) payable {
            
        require(msg.value >= 0.03 ether, "BNM");
        transferEth(_feeReceiver, 0.03 ether);
        if(msg.value > 0.03 ether) { // transfer excess back
