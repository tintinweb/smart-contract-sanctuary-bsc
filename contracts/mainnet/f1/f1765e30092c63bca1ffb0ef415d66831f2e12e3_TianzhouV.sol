...
contract TianzhouV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tianzhou V";
   
    string private _symbol = "Tianzhou V";

    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xd4ed1e84413F7Cfa371E9F97a1b525Eb6F59f763); 
    address payable public ttWal = payable(0xd4ed1e84413F7Cfa371E9F97a1b525Eb6F59f763); 
