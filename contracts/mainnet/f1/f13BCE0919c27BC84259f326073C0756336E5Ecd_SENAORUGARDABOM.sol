...
contract SENAORUGARDABOM is Context, IERC20, Ownable {
    ...
    uint256 public _maxRxAmount = 100 * 10**_decimals;
    uint256 public numTokensToSwap = 500 * 10**_decimals;
    ...
    string private constant _name = "Se Nao Rugar Da Bom";
