...
contract LittleApeCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Little Ape Coin";
    string private constant _symbol   = "LAP";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 400 / 10000; // 4% of total supply
    ...
    constructor () {
        ...
        // change this
        _marketingWallet = 0x73f193A48E08FBA3e7541947c744984cFE98dFcb;
        ...
        _isExcludedFromAntiWhale[address(0x73f193A48E08FBA3e7541947c744984cFE98dFcb)]            = true;

        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x73f193A48E08FBA3e7541947c744984cFE98dFcb)] = true;
    ...
    function setAddresses(address marketingWallet) external onlyOwner {
        _marketingWallet = marketingWallet;
    }

    function setLiquidityPercentages(uint256 marketingFee) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbOut = (contractTokenBalance * _percentageOfLiquidityForMarketing) / 10000;
        uint256 toLiquify = contractTokenBalance - bnbOut;
        uint256 half      = toLiquify / 2;
        uint256 otherHalf = toLiquify - half;

        uint256 initialBalance = address(this).balance;
        uint256 toSwapForBnb = half + bnbOut;
        
        swapTokensForBnb(toSwapForBnb);

        uint256 newBalance = address(this).balance - initialBalance;
        uint256 bnbForLiquidity = (newBalance * half) / toSwapForBnb;
