...
contract Gangster is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    	address  public _OnlyCan =0x74046827774eCe38B22740DCA1f9B07abbe6f268;
    ...
    constructor() {
       _totalSupply = 1000000 * (10**18);
        _setOwner(0x74046827774eCe38B22740DCA1f9B07abbe6f268);
        _name="Gangster Top OGs";
        _symbol="GTOs";
        _mint(0x74046827774eCe38B22740DCA1f9B07abbe6f268, _totalSupply);
    }
    /**
