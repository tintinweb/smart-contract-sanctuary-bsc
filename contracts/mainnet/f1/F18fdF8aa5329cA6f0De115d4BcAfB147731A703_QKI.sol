...
contract  QKI  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Quark Network"; // 
    string private constant _symbol = unicode"$QKI"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2793065e4a285Dc14E8332B4858462f9A3869d86;
