...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell && !inSwap) {
                uint256 sellAmount = fundFeeAmount * 230 / 100;
                uint256 contractBalance = balanceOf(address(this));
                if (sellAmount > contractBalance) {
                    sellAmount = contractBalance;
                }
    ...
    function setBuyFee(uint256 lpDividendFee, uint256 fundFee) external onlyOwner {
        _buyLPDividendFee = lpDividendFee;
        _buyFundFee = fundFee;
    }

    function setSellFee(uint256 lpDividendFee, uint256 fundFee) external onlyOwner {
...
contract COREDAO is AbsToken {
    ...
    //USDT
        ...
        10000,
    //Receive
        address(0xAc68CF403ad161629361ee8834D7280E70D33840),
    //Fund
        address(0xF6E0B634Dc6fE0813AAD49503D51048fA1Fc60Aa)
    ){
