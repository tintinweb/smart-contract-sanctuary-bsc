...
contract GoldRushPool is Context, Ownable {
    ...
    function claim() external {        
        uint256 amount = goldRushGame.balanceToClaim(msg.sender);        
        ...
        uint256 balance = goldRushGame.balanceOf(msg.sender);
        ...
        goldRushGame.claimedRewards(msg.sender);        
...
interface IGoldRushGame {
    ...
    function claimedRewards(address account) external;
