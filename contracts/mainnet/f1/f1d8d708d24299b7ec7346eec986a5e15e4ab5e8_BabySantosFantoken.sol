...
/**
Welcome Sers I bring you a Safe Community Degen named BabySantosFantoken!
  ...
  Good Luck Degens its FANTOKEN SEASON 
   ...
   I will renounce the ownership to burn addresses to transfer #BabySantosFantoken to the community, make sure it's 100% safe.
*/
...
contract BabySantosFantoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabySantosFantoken";
    string private constant _symbol = "BabySantos";
