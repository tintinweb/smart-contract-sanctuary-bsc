...
contract SQUINANCE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SQUINANCE";
    string private constant _symbol = "$SQ";
    ...
    constructor () {
        _MarketingWallet = payable(0xAc92021a3E3DF57807BC0c218188aD42B72EaaCD);
        _liquidityWallet = payable(0xAc92021a3E3DF57807BC0c218188aD42B72EaaCD);
        _rewardWallet = payable(0xAc92021a3E3DF57807BC0c218188aD42B72EaaCD);
        ...
        emit Transfer(address(0xAc92021a3E3DF57807BC0c218188aD42B72EaaCD), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxSellAmount = 100000000000 * 10**9;
        _maxWalletAmount = 100000000000 * 10**9;
