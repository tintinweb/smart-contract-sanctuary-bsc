...
*/
contract STOCKBIT is Ownable, Stakeable{
  ...
  */
  function _mint(address account, uint256 amount) internal {
    ...
    require(account != address(0), "STOCKBIT: cannot mint to zero address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "STOCKBIT: cannot burn from zero address");
    require(_balances[account] >= amount, "STOCKBIT: Cannot burn more than the account owns");
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "STOCKBIT: transfer from zero address");
    require(recipient != address(0), "STOCKBIT: transfer to zero address");
    require(_balances[sender] >= amount, "STOCKBIT: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "STOCKBIT: approve cannot be done from zero address");
      require(spender != address(0), "STOCKBIT: approve cannot be to zero address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, "STOCKBIT: You cannot spend that much on this account");
      // Transfer first
   ...
   */
    ...
    *
    ...
    function stake(uint256 _amount) public {
      ...
      require(_amount < _balances[msg.sender], "STOCKBIT: Cannot stake more than you own");
