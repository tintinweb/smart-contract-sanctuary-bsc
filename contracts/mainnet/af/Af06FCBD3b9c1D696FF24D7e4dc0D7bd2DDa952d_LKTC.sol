...
contract LKTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LKTC";
    string private _symbol = "LKTC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF6d84210D49fb6161e9F407B32E56a66150B0A3E); // Marketing Address
    address payable public teamWalletAddress = payable(0x70972a4F7e8d2ECF5c75B510539D3a2a2e0Cc93a); // Team Address
