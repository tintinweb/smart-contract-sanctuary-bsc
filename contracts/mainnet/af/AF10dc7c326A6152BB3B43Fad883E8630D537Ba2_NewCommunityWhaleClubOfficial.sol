...
New Community Whale Club🐋🐳


A community driven marketing centric token which utilizes the new community hype
which is mooning despite the bearish market. Adding the whale club hype to the new 
community is going to be the perfect combination. 
...
taxes will be lowered by 1% every single day that passes.
...
contract NewCommunityWhaleClubOfficial is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "New Community Whale Club";
    string constant _symbol = "$NCWC";
