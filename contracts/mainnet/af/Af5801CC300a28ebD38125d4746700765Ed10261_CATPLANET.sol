...
contract CATPLANET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT PLANET"; // TODO change
    string private _symbol = "CP"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0xbb6032C7addBE750Fa884BB1eB10305720747372); // Buyback Address
