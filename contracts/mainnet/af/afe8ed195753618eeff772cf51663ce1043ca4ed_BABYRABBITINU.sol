...
abstract contract Project {
    address public marketingWallet = 0x5C01b69890D0724c13Ac339CDC9785e07d16c42A;
    address public treasuryWallet = 0xab6ac47Bdd7F89295625c0dE85E376bF60045187;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 31) / 1000; // (_totalSupply * 10) / 1000 [this equals 3%]
...
contract BABYRABBITINU is Project, IBEP20, Auth {
    using SafeMath for uint256;
