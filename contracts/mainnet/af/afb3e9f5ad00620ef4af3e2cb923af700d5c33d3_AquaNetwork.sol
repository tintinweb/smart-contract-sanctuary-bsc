...
contract AquaNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aqua Network";
    string private _symbol = "AQUA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x93a1e7129E57D9f2b8E6057bB56C246b557bbf7b);
