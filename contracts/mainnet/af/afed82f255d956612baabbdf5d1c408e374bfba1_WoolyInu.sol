...
/**
/*  
兔子有几种类型，其中一种是 $Wooly。这种类型很常见。我们在 BSC CHAIN 上推出了它，以创建一个新的加密货币社区。
我们有 0/0 税，供应量为 6,666。
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeBBa6baE3AEaf02610104Cb286AD5a5B7C0c59B9; 
...
contract WoolyInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wooly Inu";
    string private _symbol = "Wooly";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeBBa6baE3AEaf02610104Cb286AD5a5B7C0c59B9); // 
    address payable public teamWalletAddress = payable(0xeBBa6baE3AEaf02610104Cb286AD5a5B7C0c59B9); // 
