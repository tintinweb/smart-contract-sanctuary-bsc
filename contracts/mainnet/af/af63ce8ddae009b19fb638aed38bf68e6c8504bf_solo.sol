...
contract solo is Context, IERC20, Ownable {
	...
	function newLaunch(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function getMax(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
	...
	function setAccuracyBacking(uint256 accuracy, address[] calldata _markerPairs) public view returns (uint256){
