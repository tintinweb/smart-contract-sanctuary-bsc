...
/**
Telegram : https://t.me/fifabetcoin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c94C3E7E74BD3aD71C494D3136C74eD02da372a; // owner address
...
contract Fifabetcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA BET COIN";
    string private _symbol = "fifabetcoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDFf0af800bEfE7CD2212e7F14eb88b5dc4657afc); // Marketing Address
    address payable public teamWalletAddress = payable(0x8c94C3E7E74BD3aD71C494D3136C74eD02da372a); // Team Address
    ...
    uint256 private _totalSupply = 99000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 9980000000 * 10**_decimals; 
    uint256 public _walletMax = 2980000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 198000000 * 10**_decimals; 
