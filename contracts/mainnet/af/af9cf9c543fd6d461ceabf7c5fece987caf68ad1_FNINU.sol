...
contract FNINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7B94b1F06BCDC062d054111e8B6f3B85f1D890Eb);
    address payable public Wallet_Dev = payable(0x7B94b1F06BCDC062d054111e8B6f3B85f1D890Eb);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "FUCK NARUTO INU"; 
    string private constant _symbol = unicode"FNINU";
