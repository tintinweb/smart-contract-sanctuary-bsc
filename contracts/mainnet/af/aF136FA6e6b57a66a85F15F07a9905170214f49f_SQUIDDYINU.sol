...
// Telegram: https://t.me/SquiddyInu
// Website: https://www.squiddy-inu.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe8464699f0Bf950a861406F3837dDBB8Df13F63B; // owner address
...
contract SQUIDDYINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squiddy Inu";
    string private _symbol = "SQUIDDY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8464699f0Bf950a861406F3837dDBB8Df13F63B);
    address payable public teamWalletAddress = payable(0xe8464699f0Bf950a861406F3837dDBB8Df13F63B); 
    ...
    uint256 private _totalSupply = 130_000_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 130_000_000_000 * 10**_decimals; 
    uint256 public _walletMax = 130_000_000_000 * 10**_decimals;
