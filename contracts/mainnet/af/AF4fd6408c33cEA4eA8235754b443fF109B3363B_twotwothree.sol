...
contract twotwothree is Context, IERC20, Ownable {
    ...
    string private constant _name = "223";
    string private constant _symbol = "223";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 2023 * 10**_decimals;
    uint256 public _maxTxAmount = 6069 * 10**7;
    uint256 public _maxWalletAmount = 6069 * 10**7;
