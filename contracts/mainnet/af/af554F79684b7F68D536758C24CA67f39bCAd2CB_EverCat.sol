...
/*
EVERCAT
Telegram: https://t.me/EverCatBSC
Website: https://evercatbsc.com
...
contract EverCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ever Cat";
    string private _symbol = "EVERCAT";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x856B727d9f2f85075925Bd628a409dF2cB21782e);
    address payable public teamWalletAddress = payable(0xDDC128600D7Ab7b9Bdb08075a4fa468C0BAcbe46);
