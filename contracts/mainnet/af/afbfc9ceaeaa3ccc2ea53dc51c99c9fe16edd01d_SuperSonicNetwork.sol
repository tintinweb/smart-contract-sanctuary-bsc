...
// SPDX-License-Identifier: Super Sonic Network
...
contract SuperSonicNetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Game = payable(0x17607EB1Ec351445Ce77Fe4C318268Eb172af294); 
    address payable public Wallet_Dev = payable(0x0AbF551e82cEcdd9E75db4133C3Efd2298fF99Fe);
    address payable public constant Wallet_Burn = payable(0x7b12ef2137DCA9c380a5Cb94Fc4B20890F00caE5); 

    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10**9* 10**_decimals;
    string private constant _name = "Super Sonic Network"; 
    string private constant _symbol = unicode"SCN"; 
    ...
    uint256 public constant Percent_Dev = 20;
    uint256 public constant Percent_Burn = 10;
