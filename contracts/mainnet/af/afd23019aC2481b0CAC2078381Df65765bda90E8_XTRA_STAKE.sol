...
contract XTRA_STAKE is ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    ...
    // Added to support recovering LP Rewards from reward that not staked or other systems such as BAL to be distributed to holders
