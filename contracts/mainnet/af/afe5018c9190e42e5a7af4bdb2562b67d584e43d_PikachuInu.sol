...
/**
/*  
https://t.me/pikachuinuportal
https: Under Development
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0418b272C8E4391B5636A302b83dF6246b22565b; 
...
contract PikachuInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "PIMU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0418b272C8E4391B5636A302b83dF6246b22565b); // 
    address payable public teamWalletAddress = payable(0x0418b272C8E4391B5636A302b83dF6246b22565b); // 
