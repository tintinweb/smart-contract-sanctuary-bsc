...
contract sMSMToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 8000000 * 10**9;
    ...
    constructor() ERC20("Staked MSM", "sMSM", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMSM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMSM
