...
contract ZGHB is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("ZGHB", "ZGHB") {
        ...
        lpAddress = payable(0xf878479374A2f7eF314a56D5B311754539537952);
        marketAddress = payable(0x6b636cB6aD799E7d0BD46D871cbF22b7297aCC84);
        teamAddress = payable(0x6b636cB6aD799E7d0BD46D871cbF22b7297aCC84);
        _mint(
            0x4b26189308f987707fa09Ff6451895DE1d292347,
            400 * 10**decimals()
        );
        _mint(
            0xC99f7417e9B434dC8704c11D70aFbC227804525D,
            400 * 10**decimals()
        );
        _mint(
            0x29bAB7C2dD4a8a290948cf78476a2F2E5C0c90ab,
            199 * 10**decimals()
        );
    }
