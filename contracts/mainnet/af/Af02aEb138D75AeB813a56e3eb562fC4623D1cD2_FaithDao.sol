...
contract FaithDao is IERC20, Ownable {
    ...
    address private fundAddress = address(0xF2d25Ba959e39B72b5CfEE24c5cb3FAe30fDcf90);
    address private fundAddress2 = address(0xD2ef9bCc65Fa330F839a5B32e7A7CcCCF1a42E15);
    address private fundAddress3 = address(0x1001d79367C2E9dff8af998CAe26f9821bE59Cf8);
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            require(balanceOf(from).mul(95).div(100)>amount,"selle max 95%");
            takeFee = true;
        }else{
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || balanceOf(_destroyAddress) >= 10000000 * 10 ** _decimals) {
            takeFee = false;
        }
    ...
    function getPrice() public view returns(uint256){
        ...
        path[1] = address(this);
        uint256[] memory amounts = uniswapV2Router.getAmountsOut(1*10**18,path);
        return amounts[1];
    }
