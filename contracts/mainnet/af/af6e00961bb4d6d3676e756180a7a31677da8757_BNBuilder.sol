...
Check for details: https://bnbuilder.app/pages/12/token-relaunch
...
library Address{
 ...
 contract BNBuilder is Context, IERC20, Ownable {
    ...
    address public donationWallet = 0x31cf4DeFaDbBe1cd1270a82EFdeBFFB86951A781;

    string private constant _name = "BNBuilder";
