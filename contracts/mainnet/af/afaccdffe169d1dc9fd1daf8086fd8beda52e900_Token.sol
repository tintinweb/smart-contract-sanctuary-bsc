...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x18b6a1B62edA872D750DaEAa3652CB2CB71BAF30);
    ...
    constructor () public {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), USDTs);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, TData memory) {
        ...
        return (tTransferAmount, TData(0,tFee, tLiquidity));
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            contractTokenBalance, 0, path, ownerAddres, block.timestamp);
    }
