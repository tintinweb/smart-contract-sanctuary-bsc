...
contract Ak47Designer
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "AK 47!!! DESIGNER";
    string private _symbol = "AK 47!!! DESIGNER";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x029de4c6ED5C877E042eaCb308fF0bCe6502A15A));
        _anotherA = payable(address(0x029de4c6ED5C877E042eaCb308fF0bCe6502A15A));
