...
contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        address PoolAddress, // must 0x10ED43C718714eb63d5aA57B78B54704E256024E
        string memory Name,
        string memory Symbol,
        uint8 Decimals,
        uint256 Supply,
        uint256 StarBlock, // must Now BlockNum, not timestamp
        address FundAddress, //
        address ReceiveAddress // must 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd
    ) {
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
