...
contract LINKDAO_Token is BEP20('LinkDao', 'LKD') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "LKD::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "LKD::delegateBySig: invalid nonce");
        require(now <= expiry, "LKD::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "LKD::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "LKD::_writeCheckpoint: block number exceeds 32 bits");
