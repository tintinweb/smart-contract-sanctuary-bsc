...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x854cC90117661Af5d05DC011918F8232B34F6129; 
...
contract YAMAKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YAMAKA";
    string private _symbol = "YAMAKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x854cC90117661Af5d05DC011918F8232B34F6129); 
    address payable public teamWalletAddress = payable(0x854cC90117661Af5d05DC011918F8232B34F6129); 
    ...
    uint256 private _totalSupply = 161616 * 10**_decimals;
