...
-We are gem token has potential 1000X.
...
contract LuncElizabeth is IBEP20, Auth {
    ...
    string constant _name = "Lunc Elizabeth";
    string constant _symbol = "LUNCE";
    ...
    uint256 public totalFee        = developmentFee + marketingFee + liquidityFee + buybackFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0xfe0446C7374320008a3B70dE29E6EeEE2191b4EC; 
        ...
        marketingFeeReceiver = 0xfe0446C7374320008a3B70dE29E6EeEE2191b4EC;
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
        marketingFee = _marketingFee;
        buybackFee = _buybackFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_developmentFee).add(_marketingFee).add(_buybackFee).add(_burnFee);
