...
contract PLAYER is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x88479186BAC914E4313389a64881F5ed0153C765; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0xAD5F354EE8Ab9d9092271eB184F9f741920E815e;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "PLAYER456";
    string constant _symbol = "PLAYER";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 5000; // will start swapping once 0.05% of supply is in the swap wallet
    bool inSwap;
