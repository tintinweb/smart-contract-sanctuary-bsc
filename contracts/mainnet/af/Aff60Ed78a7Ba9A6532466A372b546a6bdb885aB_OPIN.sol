...
contract OPIN is IERC20 {
    ...
    string constant private _name = "OPIN";
    string constant private _symbol = "OPIN";
    ...
    address payable public operationsWallet = payable(0x1dc7Eacb61837C980bBd87B0b8EB4e93f8A574b8);
    ...
    uint256 private _maxTxBuyAmount = (_tTotal * 10) / 100;
    uint256 private _maxTxSellAmount = (_tTotal * 6) / 1000;
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 operations) external onlyOwner {
    ...
    function setWallets(address payable operations) external onlyOwner {
        ...
        operationsWallet = payable(operations);
    }
    ...
    function getMaxTXs() external view returns (uint256 maxBuy, uint256 maxSell) {
        return (_maxTxBuyAmount / (10**_decimals), _maxTxSellAmount / (10**_decimals));
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.operations > 0) {
            (success,) = operationsWallet.call{value: address(this).balance, gas: 35000}("");
        }
    }
