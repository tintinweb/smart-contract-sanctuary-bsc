...
import './interfaces/IAssetForChef.sol';
    ...
    IMasterPlatypusV2
{
    ...
    using SafeERC20 for IAssetForChef;
    ...
    // Info of each pool.
    struct PoolInfo {
        IAssetForChef lpToken; // Address of LP token contract.
    ...
    event Add(uint256 indexed pid, uint256 baseAllocPoint, IAssetForChef indexed lpToken, IRewarder indexed rewarder);
    ...
    function _assetAdjustFactor(IAssetForChef asset) internal view returns (uint256) {
...
interface IAssetForChef is IERC20 {
