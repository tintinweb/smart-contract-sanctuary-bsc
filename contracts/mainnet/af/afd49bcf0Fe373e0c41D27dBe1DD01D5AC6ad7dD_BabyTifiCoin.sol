...
/**
 *Submitted for verification at BscScan.com on 2022-07-08
🛡️ BabyTifi Coin is a community-driven meme token with insane Tifi rewards for all holders.
Main goal is to make most realiable and sustainable coin is BSC space by buiding some utilities like staking, Dapp,  etc. 
We team believe that BabyTifi Coin will create a name in BSC that one of most popular coin ever made.
...
// Telegram: https://t.me/BabyTificoin
...
contract BabyTifiCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyTifi Coin";
