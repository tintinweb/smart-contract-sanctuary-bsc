...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xF84e9e7627dd17F23FFe0109864800ED6210b891;
        _token = msg.sender;
    }
...
contract One_Million_DAO is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x70C68b8345a334Aaf04ba50161D13f62A9Eb27Da;
    address MarketingWalletTwo = 0x18462b4bF2854F8b0C6639c16Fda700c27E24934;

    string constant _name = "One_Million_DAO";
    string constant _symbol = "OMD";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 100000 * (10 ** _decimals);
    ...
    address IDEXPair = 0x62756c7B27115A0dCa062fB28533c2E08dE20a26;
