...
HologramDoge
A true Degen Stealth Launch

Close to Real this is HoloGram Doge

telegram: https://t.me/HologramDoge
web: https://hologramdoge.com/
...
contract HOLOGRAMDOGE is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HOLOGRAMDOGE"; // 
    string constant _symbol = "HLDG"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (3); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (3); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (3); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0x9c2A3F32c8F67d25C75Cf3045da7875481930cd0; //LP receiver
    address private marketingFeeReceiver = 0x39B8850D89D2c7e3324FC086Db4de9e016B56FD3; //mkt
    address private devFeeReceiver = 0x80A784EB75CE74b3934a61412e6001879458A5D5; //31 BuyBack
    address private teamFeeReceiver = 0x3AC5A2C8e64716bcdB88B17e8525f26d513d95c5; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xb2AAa9c9e989c92a6e3e5D0DE3318e41465F6851;
