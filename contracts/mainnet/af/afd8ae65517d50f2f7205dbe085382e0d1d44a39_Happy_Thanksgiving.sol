...
//** telegram https://t.me/happythanksgivingbsc
...
/* Token contract */
contract Happy_Thanksgiving is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC98C5464dfC3003c65DaDD34888EF77e4eC7915D;
    ...
    // Name and symbol
    string constant _name = "Happy Thanksgiving";
    string constant _symbol = "Thanksgiving";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 240000 * (10 ** _decimals); // 20mill
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x180B520508232951ec32B7eFCB7D8500eB6cC0C5;
