...
Osamu おさむ ⛩️🇯🇵
@WeAreOsamu
Osamu will bring wealth & glory to those who are disciplined. 
Rising is the only way forward, a new order is sanctioned
*/
...
contract OsamuFLOXI is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Osamu FLOXI';
    string private _symbol = 'Osamu FLOXI';
