...
/**
Telegram: https://t.me/happywomenday_bsc
...
contract WOMENDAY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF8eE2ce7F0675EAf104b6F34667D1C747CA21208); // Marketing Address
    ...
    uint256 private _tTotal = 38000000 * 10**9 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "HAPPY WOMEN'S DAY";
    string private _symbol = "HWD";
    ...
    uint256 public _taxFee = 1; //TO HODLER
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyTaxFee = 1; //TO HOLDER
    uint256 public _buyLiquidityFee = 3; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 1; //TO HOLDER
    uint256 public _sellLiquidityFee = 3; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 public _maxTxAmount = 38000000 * 10**9 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 38000000 * 10**9 * 10**9 * 10**9; 
    uint256 public buyBackSellLimit = 1000000000 * 10**9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 38000000 * 10**9 * 10**9 * 10**9;
    }
