...
contract AutofarmVenusDistributor {
  ...
  function claim(address claimant, uint96[] memory amounts, bytes32[] calldata proof) public {
    ...
    console2.log(claimant);
    console2.log(amounts[0]);
    console2.log(amounts[1]);
    console2.log(amounts[2]);
    console2.log(amounts[3]);
    console2.log(amounts[4]);
    console2.log(amounts[5]);
    console2.log(amounts[6]);
    console2.log(amounts[7]);
    console2.log(amounts[8]);
    console2.log(amounts[9]);
    console2.log(amounts.length);
