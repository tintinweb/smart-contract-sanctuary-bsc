...
// https://t.me/WhiteHouseInu

// Dont forget to subscribe our channel at Telegram! @ElonTweetsLaunch
interface IERC20 {
...
contract WhiteHouse is Context, IERC20, Ownable {
    ...
    string private constant _name = "White House Inu";
    string private constant _symbol = "WHI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xFcbe6aBae286d8d992D4Ce983f86F4cf735E1d8A);
    address payable private _marketingAddress = payable(0xFcbe6aBae286d8d992D4Ce983f86F4cf735E1d8A);
