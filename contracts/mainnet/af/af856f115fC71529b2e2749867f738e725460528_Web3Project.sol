...
contract Web3Project is Web3ProjectDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private Web3ProjectTeam;
    address private CharityWeb3Project;
    ...
    string public override name = "Web3Project";
    string public override symbol = "Web3Project";
    ...
    constructor(uint totalSupplyValue, address Web3ProjectTeamAddress, address CharityWeb3ProjectAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        Web3ProjectTeam = Web3ProjectTeamAddress;
        CharityWeb3Project = CharityWeb3ProjectAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Web3ProjectTeam] =  totalSupply * 4 / 100;
        balances[CharityWeb3Project] = totalSupply * 4 / 100;
