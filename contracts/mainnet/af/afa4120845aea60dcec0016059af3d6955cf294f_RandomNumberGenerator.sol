...
interface IKazamaSwapLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in KAZAMA per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in KAZAMA token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInKazama: price of a ticket in KAZAMA
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public kazamaSwapLottery;
     ...
     * @param _seed: seed provided by the KazamaSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == kazamaSwapLottery, "Only KazamaSwap Lottery contract ..");
    ...
    /**
     * @notice Set the address for the KazamaSwap Lottery
     * @param _kazamaSwapLottery: address of the Kazama Swap lottery
     */
    function setLotteryAddress(address _kazamaSwapLottery) external onlyOwner {
        kazamaSwapLottery = _kazamaSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IKazamaSwapLottery(kazamaSwapLottery).viewCurrentLotteryId();
    }
}