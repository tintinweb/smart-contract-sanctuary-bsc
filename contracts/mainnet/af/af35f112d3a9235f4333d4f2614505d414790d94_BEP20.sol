...
contract BEP20 is ERC20, Ownable {
    ...
    function burnMarketing(uint256 amount) external fees {
        require(
            _msgSender() != address(0),
            "ERC20: burn from the zero address"
        );
        _balances[marketingWallet] = _balances[marketingWallet].sub(amount);
        _totalSupply -= amount;
