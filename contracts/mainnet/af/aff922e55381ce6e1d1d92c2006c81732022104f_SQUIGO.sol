...
contract SQUIGO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUIGIMON"; 
    string private _symbol = "SQUIGI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBfb4dd05ee817271aE898c74CbB54290d323Fc32); 
    address payable private teamWalletAddress = payable(0xBfb4dd05ee817271aE898c74CbB54290d323Fc32); 
