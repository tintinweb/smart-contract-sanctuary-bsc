...
contract CUBERINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CUBERINU";
    string constant _symbol = "CUBERINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply.mul(100)).div(100); // 0.4%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5fBbBFd2d5f6982e4d45057A3e1D81E16E8c3611;
        ...
        marketingFeeReceiver = 0x5fBbBFd2d5f6982e4d45057A3e1D81E16E8c3611;
