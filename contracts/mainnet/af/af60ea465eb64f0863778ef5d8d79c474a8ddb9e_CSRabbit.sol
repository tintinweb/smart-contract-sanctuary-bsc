...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    address public marketAddr = 0x949972bC4F949b4bc7A88A41233AB54BA1B7C4cE;
...
contract CSRabbit is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 1000000000000000 * 1e18;
    uint256 public _maxHavAmount = 500000000000 * 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;

    constructor() ERC20("CSRabbit", "CSRabbit", 18) DividendFee(1e17, true, USDT, 2) {
