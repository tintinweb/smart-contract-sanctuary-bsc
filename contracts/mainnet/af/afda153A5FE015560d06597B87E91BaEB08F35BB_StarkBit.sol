...
contract StarkBit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarkBit";
    string private _symbol = "SRK";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x47a57Ad86Ec979e6Ab49984b30Ce3a576D6c4658); // Marketing Address
    address payable public teamWalletAddress = payable(0x77DC30f32DB058A72BDcFdC0faB694449CF79B37); // Team Address
