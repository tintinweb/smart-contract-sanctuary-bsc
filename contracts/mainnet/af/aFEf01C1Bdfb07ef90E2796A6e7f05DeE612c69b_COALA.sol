...
//
// $Coala Coin proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN COALA ! With the auto-claim feature,
// simply hold$ Coala Coin and you'll receive Coala Coin automatically in your wallet.
// 
// Hold Coala Coin and get rewarded in Coala Coin on every transaction!
//
//
// Telegram:https://t.me/coin_coala
// 
//
...
contract COALA is ERC20 {
    ...
    uint tokenTotalSupply = 20000000000; // 100 Million Token Supply

    constructor() public ERC20("Litesun", "LITE") {
