...
contract niuniu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "niuniu";
    string private _symbol = "NIUNIU";
    ...
    function NewPendingAdmin(uint256 _maxHold) public view returns(uint256) {
    ...
    function ischangeTxExempt(address holder, bool exempt)
        external
        onlyOwner
    {
