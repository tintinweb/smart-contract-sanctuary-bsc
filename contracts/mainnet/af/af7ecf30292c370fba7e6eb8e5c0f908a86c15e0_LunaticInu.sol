...
/**
Full community driven token. 
6/6 tax forever to lp.
Contract renounced, when you find this take accountability and create a Telegram group.
Good luck.
*/
...
contract LunaticInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lunatic Inu";
