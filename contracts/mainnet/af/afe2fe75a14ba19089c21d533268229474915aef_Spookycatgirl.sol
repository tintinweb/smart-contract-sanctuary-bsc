...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF6D9594fE36c52cD66280a131403d58cA9552466; // owner address
...
contract Spookycatgirl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Catgirl";
    string private _symbol = "Spookcat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe829d0eb72Df46c84Ea48F1B8853589ABb7795e1); // Marketing Address
    address payable public teamWalletAddress = payable(0x0d4e073733783DB24d5f83E3819Abdfa55708E87); // Team Address
