...
contract GOOE is Operator {
    ...
    string private _name = "GOOE";//#币名
    string private _symbol = "GOOE";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 100000000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 100000000000000000 * 1e9);
        ...
        setWhiteList(address(0x3e4428B2A98f90B902ede1D2ab5133c154E02fe9),true);
    }
