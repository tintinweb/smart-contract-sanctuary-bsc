...
/**
 *  Hey BSC a new trending has started... Muu!!!!!!! Muu Inu just skyrocketed and we will be the first MuuDoge on BSC! Muu + Doge = MuuDoge!
 *
 * Telegram: https://t.me/MuuDoge
 *
*/
...
contract MuuDoge is IBEP20, Auth {
    ...
    string constant _symbol = "MuuDoge";
