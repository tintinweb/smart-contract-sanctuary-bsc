...
// TELEGRAM : https://t.me/khonsutoken
// TWITTER  : https://twitter.com/khonsutoken
// WEBSITE  : https://khonsutoken.com/ 
...
contract KHONSU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KHONSU";
    string private _symbol = "$KHONSU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48548C8398f50f0037d2C7f65f21aD0DB2E4E0Fe); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x48548C8398f50f0037d2C7f65f21aD0DB2E4E0Fe); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (15000* 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
