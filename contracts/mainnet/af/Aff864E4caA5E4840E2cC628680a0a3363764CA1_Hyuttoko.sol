...
/**
 ...
 TELEGRAM: https://t.me/hyottokoinubsc
 WEBSITE: https://hyottokoinu.net (not live yet)
...
contract Hyuttoko is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x71CF653A32D66D6b1935bCA9c163A675d0aF0414;
    address public devAddress = 0x075aBBE54ACbF52751ED28f9D129112A098340e6;

    string private constant _name = "Hyottoko Inu";
    ...
    Taxes public sellTaxes = Taxes(0,2,8,2);
