...
contract TryToken is Context, IERC20, Ownable
{
    // Token info
    string private constant Name = "TryToken";
    string private constant Symbol = "TRY"; 
    ...
    // Important addresses
    address payable private DevAddress = payable(0x6E40528b59DE5e2f7280CdE0b23B1324E7E56C3D); 
    address payable private MarketingAddress = payable(0x6C8F3f3A375ECdc3cfa5F5247a15B920A1cffEAA);
