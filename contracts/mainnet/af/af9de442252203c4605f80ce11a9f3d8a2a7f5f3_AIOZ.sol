...
contract BaseToken is Ownable {
    ...
    string constant public name = 'AIOZ Network';

    string constant public symbol = 'AIOZ';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 4253333412*10**uint256(decimals);
