...
contract MetaVesting3 is Ownable {
    ...
    function claimAtTge(uint256 _strategyId) internal {
        ...
        require(claimingPart > 0, "MetaVesting3: Waiting for the next!");
    ...
    function claim(uint256 _strategyId) public {
        ...
        VestingInfo storage userInfo = userToVesting[msg.sender][_strategyId];
        VestingStrategy storage vestingInfo = vestingStrategy[_strategyId];
        require(userInfo.amount > 0, "MetaVesting3: You do not have allocation for this type!");
        require(userInfo.claimed < userInfo.amount, "MetaVesting3: You already received fully your allocation!");
        ...
        require(claiming > 0, "MetaVesting3: We already vested all tokens!");
        mtsERC20.safeTransfer(msg.sender, claiming);
    }
