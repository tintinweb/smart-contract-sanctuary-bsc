...
contract CatShark is Context, IERC20, Ownable {
    ...
    string private _name = "CatShark";
    string private _symbol = "CatShark";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCb8E7322c6F721CA7ba503e9F8aFD59962719523); 
    address payable private teamWalletAddress = payable(0xB795d3a7F65aE203667aE3a2F160F4295de0e574); 
