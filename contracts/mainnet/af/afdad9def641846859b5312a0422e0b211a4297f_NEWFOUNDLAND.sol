...
pragma solidity ^0.6.12;
    ...
    contract NEWFOUNDLAND is Context, IERC20, Ownable {
        ...
        string private _name = 'New Foundland Inu';
        string private _symbol = 'NFINU';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x9267145E715eeFF25E2f33A829c9d4FBC3eE326F, 'We can not exclude Uniswap router.');
