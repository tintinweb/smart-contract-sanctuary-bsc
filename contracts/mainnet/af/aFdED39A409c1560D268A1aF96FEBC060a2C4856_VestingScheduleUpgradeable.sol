...
interface IVestingScheduleUpgradeable {
    struct Schedule {
        uint96 total;
        uint96 released;
    }
    ...
    function initialize(
        IERC20Upgradeable vestingToken_,
        ITreasury treasury_,
...
import "./interfaces/IVestingScheduleUpgradeable.sol";
import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";

import "./libraries/FixedPointMathLib.sol";

contract VestingScheduleUpgradeable is
    BaseUpgradeable,
    ProxyCheckerUpgradeable,
    FundForwarderUpgradeable,
    ReentrancyGuardUpgradeable,
    IVestingScheduleUpgradeable
{
