...
//This contract was written by MiniDOG's DEV team.
...
contract MiniDOGContract is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniDOG";
    string private _symbol = "MiniDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C9698435cC759da408127A03ea1A008763d4730);
    address payable public teamWalletAddress = payable(0x7C9698435cC759da408127A03ea1A008763d4730);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 public endtime = 0;
    uint256 public feeTXtime = 4;
