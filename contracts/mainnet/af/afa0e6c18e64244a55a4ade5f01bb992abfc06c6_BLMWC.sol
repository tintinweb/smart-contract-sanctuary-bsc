...
contract BLMWC is Token {
    constructor() Token(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E), //路由
    
        address(0x55d398326f99059fF775485246999027B3197955),  //u
        "Baby Lemon World Cup Token",
        "BLMWC",
        18,  //不要改
    
        1000000000,//num
    
        address(0x4E853a7fd7C0c92E1bD77299BF0179C0920a01E0),//fund address
    
        address(0x4E853a7fd7C0c92E1bD77299BF0179C0920a01E0)//dev address
    ){
