...
contract FaceDAO is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x4FeFd79f701530c7bEC37c7C1bCA39ff37d53bfE;
    address public devAddress = 0x4FeFd79f701530c7bEC37c7C1bCA39ff37d53bfE;

    string private constant _name = "FaceDAO";
    string private constant _symbol = "FaceDAO";
    ...
    Taxes public taxes = Taxes(0,0,1,8);
    Taxes public sellTaxes = Taxes(0,0,1,8);
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out NoToWar!");
