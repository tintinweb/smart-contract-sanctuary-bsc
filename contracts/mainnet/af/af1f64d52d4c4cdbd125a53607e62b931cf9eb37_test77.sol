...
contract test77 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0Fec7c76bb2cf8CA1156d9156efaE03c798E53Ad); 
    address payable public Wallet_Dev = payable(0x075aedD264C4eedB4F8abf42aeF1BAcB58908B1C);
    ...
    string private constant _name = "test77"; //token name
    string private constant _symbol = unicode"test77"; //symbol
    ...
    constructor () {
        ...
        _owner = 0x075aedD264C4eedB4F8abf42aeF1BAcB58908B1C;
