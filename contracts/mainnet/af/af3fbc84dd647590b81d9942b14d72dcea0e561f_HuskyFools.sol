...
//100% liquidity burn 
//Tokenomics 1% Auto Add liquidity 4% Marketing
//Max wallet 3% = 30 Billion HUSKY-F of supply from 1 wallet
//Tottal Supply 1,000,000,000,000

pragma solidity ^0.8.5;
// SPDX-License-Identifier: MIT

//TG Community - https://t.me/HuskyFoolsBsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x075d1Fd0EeC788C4cd8bc830C86Fc0B7c7ef70B3;
...
contract HuskyFools is Context, IERC20, Ownable {
    ...
    string private constant _name = "Husky Fools"; // 
    string private constant _symbol = "$HUSKY-F"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x075d1Fd0EeC788C4cd8bc830C86Fc0B7c7ef70B3);
