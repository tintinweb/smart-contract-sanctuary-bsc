...
contract MEMEDAO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x5BAb582Bf8E77567e417709FEA5F3f43f248B1c2);
    address payable private _marketingAddress = payable(0xD17a367893A033A59B746801a941BA226022Ede2);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 61, "Tax cannot be more than 61.");
	    require(taxFeeOnSell < 61, "Tax cannot be more than 61.");
