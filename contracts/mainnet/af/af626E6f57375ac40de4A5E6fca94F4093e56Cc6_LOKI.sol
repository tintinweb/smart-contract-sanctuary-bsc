...
contract LOKI is IBEP20, Auth {
    ...
    address DEV = 0x0B212Ef4DCfD1dB68Fd5C0c79D1fd3c0EE9CEE23;
    ...
    // Name and symbol
    string constant _name = "LOKI INU";
    string constant _symbol = "LOKI INU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% (200 mil)
    ...
    uint256 public marketingFeeSell = 96;
