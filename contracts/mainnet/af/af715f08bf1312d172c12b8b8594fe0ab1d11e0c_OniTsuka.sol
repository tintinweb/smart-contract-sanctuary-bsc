...
contract OniTsuka is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x17EC8039503eE054C183C22ADd9Ed76ea0d143b1); 
    address payable public Wallet_Dev = payable(0x1627522a173228423fec910736372dAb1241693d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Oni Tsuka"; 
    string private constant _symbol = unicode"OTSUKA";
