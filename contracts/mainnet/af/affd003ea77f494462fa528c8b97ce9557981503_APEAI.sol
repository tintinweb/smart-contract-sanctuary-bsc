...
contract APEAI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Ape AI";
    string private constant _symbol = unicode"APEAI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0x423EC69130094884C6e6BeD4c9bd84285A264a35);
    address payable public MarketingWallet = payable(0x423EC69130094884C6e6BeD4c9bd84285A264a35);
