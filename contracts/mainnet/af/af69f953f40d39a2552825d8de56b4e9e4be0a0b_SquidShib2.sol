...
contract SquidShib2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidShib 2.0";
    string private constant _symbol = "SQUIDSHIB2.0";
