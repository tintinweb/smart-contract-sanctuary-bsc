...
contract BobbybuybotGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bobbybuybot Grow";
    string private _symbol = unicode"BG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23Cbf9291710Fc337B48A479f60488616b9E9D31); 
    address payable public buyBackWalletAddress = payable(0x23Cbf9291710Fc337B48A479f60488616b9E9D31); 
    ...
    uint256 private _totalSupply = 1e9 * 10**9;
    uint256 public _maxTxAmount = 1e9 * 10**9; 
    uint256 public _walletMax = 1e9 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1e9 * 10**9; 
