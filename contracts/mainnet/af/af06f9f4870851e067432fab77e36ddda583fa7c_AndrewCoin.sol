...
TG: https://t.me/DarkNetworkBSC

DARK NETWORK

COIN BASED ON OVERALL HYPE ON NETWORKs and DARKWEB - Accessing the dark web can only be done using specific browsers, such as TOR Browser. you can find all forbiden thing in this network! 
 BASED TEAM WITH GOOD EXPERIENCE
 X1000 POTENTIAL
 LOW TAX
...
contract AndrewCoin is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0xa2dff3Ee207eFc0827253733037B536de222c57d; // Marketing wallet 
        _devWalletAddress = 0xB9D811F5eF7F03Ef7db203B8284C3b274FC77417; // Dev wallet 
