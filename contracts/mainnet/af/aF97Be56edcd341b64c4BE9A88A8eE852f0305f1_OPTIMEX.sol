...
Telegram: https://t.me/OptimexAPP
Website: https://optimex.app
Twitter: https://twitter.com/OptimexAPP

Fees Explained

The OPTIMEX Protocol’s transaction fees ensure the stability of the price, the maintenance of liquidity, and the security of the community.

Buy Fees:

4% – Liquidity Pool
5% – $OPEX Trust Fund (OTF)
3% – The $OPEX Treasury (OPT)
...
4% – Liquidity Pool
5% – $OPEX Trust Fund (OTF)
3% (+2%) – The $OPEX Treasury (OPT)
2% – The Black Hole (TBH)
+ Variable Impact Tax (OADA)
...
contract OPTIMEX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3716643 * 10**9;
    ...
    string private _name = "OPTIMEX Protocol";
    string private _symbol = "OPEX";
