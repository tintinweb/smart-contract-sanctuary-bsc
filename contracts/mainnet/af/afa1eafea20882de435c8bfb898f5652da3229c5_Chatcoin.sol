...
abstract contract Jackpot_OverflowableMixin is Ownable, Jackpot_TaxesAndWalletsMixin, Jackpot_LiquidityTokenBaseMixin, Jackpot_SettingsMixin, Jackpot_WinningPoolMixin {
  ...
  contract Chatcoin is Context, IERC20, Ownable, Jackpot_TaxesAndWalletsMixin, Jackpot_LiquidityTokenBaseMixin, Jackpot_SettingsMixin, Jackpot_OverflowableMixin, Jackpot_AwardableMixin {
  using Address for address;
  ...
  string private tokenName = "Chatcoin";
  string private tokenSymbol = "CHAT";
  ...
  Jackpot_LiquidityTokenBaseMixin(_uniswapV2RouterAddress)
  {
    ...
    // 0x9384C60F5C585fC7209a17D3561152eB55f18C32 // dev
    // 0x87E52c24131D9b8a497AC93aaFf2BEAef617D282 // marketing
    // 0x4d1D2F7486Def530DaA738E59C606DBb2a6Cc5E1 // buyback
