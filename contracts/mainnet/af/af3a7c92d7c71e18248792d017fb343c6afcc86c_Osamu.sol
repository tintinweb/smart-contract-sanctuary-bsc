...
/*
Osamu おさむ ⛩️🇯🇵
Osamu will bring wealth & glory to those who are disciplined. Rising is the only way forward, a new order is sanctioned
*/
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextOsamuBNB {
...
contract OwnableOsamuBNB is ContextOsamuBNB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableOsamuBNB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableOsamuBNB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract Osamu  is ContextOsamuBNB, OsamuBNB, OwnableOsamuBNB {
