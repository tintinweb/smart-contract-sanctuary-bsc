...
contract Roulette is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(
            _gamble != address(0) && _house != address(0) && _random != address(0) && _fee != address(0) && _ustFund != address(0),
            "Roulette::constructor: Gamble, house, random, fee and the UST victims fund addresses cannot be the zero address"
        );
        gambleToken = _gamble;
        houseAddress = _house;
        feeAddress = _fee;
        ...
        tokenWinAmount[0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c] = 38130388349603454684; // migration from old Roulette contract
