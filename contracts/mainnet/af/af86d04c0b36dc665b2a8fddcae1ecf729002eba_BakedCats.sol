...
// ____    ____  __  _    ___  ___           __   ____  ______  _____
//|    \  /    ||  |/ ]  /  _]|   \         /  ] /    ||      |/ ___/
//|  o  )|  o  ||  ' /  /  [_ |    \       /  / |  o  ||      (   \_ 
//|     ||     ||    \ |    _]|  D  |     /  /  |     ||_|  |_|\__  |
//|  O  ||  _  ||     \|   [_ |     |    /   \_ |  _  |  |  |  /  \ |
//|     ||  |  ||  .  ||     ||     |    \     ||  |  |  |  |  \    |
//|_____||__|__||__|\_||_____||_____|     \____||__|__|  |__|   \___|
//        www.bakedcats.com - Most advanced miner out of BSC
...
contract BakedCats {
    ...
    uint256 public TAX = 33; //3.3% x 3 WALLETS = 9.99 TAX
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 2000 * 1e18; /** 2000 BUSD AT START THEN 10000 BUSD  **/

	uint256 public COMPOUND_BONUS = 25; /** 2.5% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 12; /** 12 times / 6 days. **/
    ...
    constructor(address _treasury, address _dev, address _marketing) {
		require(!isContract(_treasury) && !isContract(_dev) && !isContract(_marketing));
        owner = msg.sender;
        treasury = _treasury;
        dev = _dev;
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_BUSD.transfer(treasury, tax);
