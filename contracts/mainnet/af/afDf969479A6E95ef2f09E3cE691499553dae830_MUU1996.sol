...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88D4a383564ceb5593Ae93c9A262A20E774e91e2; // owner address
...
contract MUU1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muu 1996";
    string private _symbol = "MUU96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88D4a383564ceb5593Ae93c9A262A20E774e91e2); // Marketing Address
    address payable public teamWalletAddress = payable(0x88D4a383564ceb5593Ae93c9A262A20E774e91e2); // Team Address
