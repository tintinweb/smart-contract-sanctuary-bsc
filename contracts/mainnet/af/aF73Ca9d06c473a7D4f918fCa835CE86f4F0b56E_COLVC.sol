...
contract COLVC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "COLVC";
    string constant _symbol = "COLVC";
    ...
    uint256 _totalSupply = 8848 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 2005 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x16156b091A18035Bc3b869A28d44AcC3dc1ee941;
