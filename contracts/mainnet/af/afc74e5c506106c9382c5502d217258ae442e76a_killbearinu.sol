...
library Address{
 ...
 contract  killbearinu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x07d91f59a805c7492726198C7f4876511DbBAc5b;
    address public donationWallet = 0x107453a7ADb08287D12Bc509c77BD02491Efa1f5;

    string private constant _name = "killbearinnu";
    string private constant _symbol = "kbu";
