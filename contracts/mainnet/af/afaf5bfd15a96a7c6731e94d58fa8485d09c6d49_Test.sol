...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDe6bC55B2A179687Eee50DBb64e6E8CF9A39a8bF); 
    address payable public Wallet_Dev = payable(0xDe6bC55B2A179687Eee50DBb64e6E8CF9A39a8bF);
    ...
    constructor () {
        ...
        _owner = 0xDe6bC55B2A179687Eee50DBb64e6E8CF9A39a8bF;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _burrn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _liq / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_liq + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_liq + Percent_Marketing + Percent_Dev);
