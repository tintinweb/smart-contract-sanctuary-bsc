...
Telegram : https://t.me/Echonetwork
...
contract EchoNetwork is ERC20, Ownable {
    ...
    EchoNetworkDividendTracker public dividendTracker;
    ...
    constructor() ERC20("EchoNetwork", "EchoNetwork") {
        marketingWallet = payable(0xE444b8103E84f62Cf2f077c67cCBA93Cd264C424);
        buybackWallet = payable(0x7DB6B5943a98b0Ed129e49A1af6b9C0c570a1388);
        ...
        dividendTracker = new EchoNetworkDividendTracker(
            payable(this),
            router,
...
contract EchoNetworkDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EchoNetwork public EchoNetworkContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EchoNetworkContract = EchoNetwork(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EchoNetwork_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EchoNetwork_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EchoNetwork contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EchoNetworkContract);

            uint256 prevBalance = EchoNetworkContract.balanceOf(address(this));
            ...
            {
                uint256 received = EchoNetworkContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EchoNetworkContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
