...
contract BNBBILLIONAIRE is Context, IERC20, Ownable {
    ...
    string private constant _name = "bnb billionaire"; // 
    string private constant _symbol = "BBB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x4B681Fb2d7FE050742EeFeA4f1f17b38Be95F05f;
