...
contract ChadInuToken is Context, IBEP20, Ownable {
    ...
    bool public taxAutomated = true;
    
    uint256 public _maxTxAmount =  10**10 * 10**18;
    uint256 private numTokensToSwap =  10**5 * 10**18;
    ...
    uint256 public nlcDeadline = 86400 * 14;
    ...
    constructor () {
        ...
        lockCexTime = block.timestamp + 86400 * 183;
        lockDevTime = block.timestamp + 86400 * 91;
    ...
    function sweepTokens() external onlyOwner {
        _tokenTransfer(address(this), msg.sender, balanceOf(address(this)));
    }
    ...
    function setTaxAutomated(bool _value) external onlyOwner {
        taxAutomated = _value;
    }
    ...
    function releaseLockedDevTokens(address account) external onlyOwner {
        ...
        lockDevTime = lockDevTime.add(86400 * 91);
