...
contract SUERC20 {
    IERC20 public tokens = IERC20(0x86De7dcc59A221e36008bD9DDBD9355aA7eDfdDD);
...
contract PAIRERC20 {
    IERC20 public pair = IERC20(0xb185d4d9De5792C0488e5d6a8A50f6b88Ec366D5);
...
contract PancakePair {
    IPancakePair public pairs =IPancakePair(0xb185d4d9De5792C0488e5d6a8A50f6b88Ec366D5);
...
contract BFBPledge is USDTERC20, SUERC20,PAIRERC20, PancakePair, Ownable {
    ...
    address public hunter =0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;

    address public tokenA = 0x2b70152ad721D4921991D2F4E7A6CD1954B87aaf; //su
