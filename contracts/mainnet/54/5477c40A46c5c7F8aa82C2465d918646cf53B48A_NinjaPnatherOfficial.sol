...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x55d398326f99059fF775485246999027B3197955); // BUSD
...
contract NinjaPnatherOfficial is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x55d398326f99059fF775485246999027B3197955; // BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Ninja Panther";
    string constant _symbol = "$NPANTHER";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 10000; // 0.05% of supply
    bool inSwap;
