...
/**
 * #LuckyDragon Token
   - 5% of every transaction is redistributed to all holders
   ...
   - 3% of every transaction is converted to BNB and sent to the charity wallet
   ...
   100,000,000 tokens limitation for sell, which is 1% of the total supply.
   Maximum tokens per wallet is only 2% from total supply
*/
...
contract LuckyDragonToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x7B4ead49FdB2890ad7F1a812f2173a2CD41C3C57;
    address private _devWalletAddress = 0x901ae7488B2dfaf86B83f75f56888025dc20D3DA;
    ...
    string private _name = "Lucky Dragon Token";
