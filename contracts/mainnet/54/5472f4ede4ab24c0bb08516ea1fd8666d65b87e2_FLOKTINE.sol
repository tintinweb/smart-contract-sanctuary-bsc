...
contract FLOKTINE is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = " FLOKTINE ";
    string private _symbol = " FT ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbDfd549c19700A2E83DD11e001365506EdbbA3e8);
    address payable public liqWalletAddress = payable(0xbDfd549c19700A2E83DD11e001365506EdbbA3e8);
    ...
    uint256 private _totalSupply =  1400000 * 10**_decimals;
    uint256 public _maxTxAmount =   1400000 * 10**_decimals;
    uint256 public _walletMax =     1400000 * 10**_decimals;
