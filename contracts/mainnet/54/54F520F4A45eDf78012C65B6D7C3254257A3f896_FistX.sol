...
contract FistX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FistX";
    string private _symbol = "FistX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE66f64E3CdBdcaF8782A273266769567E92d1cCc); // Marketing Address
    address payable public teamWalletAddress = payable(0xE66f64E3CdBdcaF8782A273266769567E92d1cCc); // Team Address
