...
contract IceCreamAssassin is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x70b41e009C01f08208facA72fC5Eb0384f0342a4;
    ...
    constructor() public ERC20("IceCreamAssassin", "ICA") {
    ...
    function timeSinceBuy(address _address) public view returns(uint256){
        uint256 timeInterval = (block.number).sub(firstBuyTime[_address]);
        return timeInterval;
    }
    ...
    function rescueToken(address TokenAddress, uint _amount) external{
        require(msg.sender == emergency,"You are not allowed.");
