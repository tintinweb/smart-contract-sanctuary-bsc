...
contract LuxeAventador is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("LuxeNFT Avent", "LUXEAVENT") {
    sender = msg.sender;
  }
    ...
    returns (bool)
{
  ...
  function _baseURI() internal pure override returns (string memory) {
    return
      "https://gateway.pinata.cloud/ipfs/QmeoUzd9vti1UQLgqcfG2iU2TwMuVtknNEcuV1Fu7Xa9GC/";
  }
