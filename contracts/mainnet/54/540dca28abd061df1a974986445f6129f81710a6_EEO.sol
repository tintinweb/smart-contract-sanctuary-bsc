...
contract EEO
 is Context, IERC20, Ownable {
    ...
    string private _name = "EEO";
    string private _symbol = "EEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9BC3B747D2665e827494Bfe1E03d3e802B84752e);
    address payable public teamWalletAddress = payable(0x9BC3B747D2665e827494Bfe1E03d3e802B84752e);
    address public immutable deadAddress = 0x9BC3B747D2665e827494Bfe1E03d3e802B84752e;
    ...
    uint256 public _maxTxAmount =   28 * 10**_decimals; 
    uint256 public _walletMax =     28 * 10**_decimals;
