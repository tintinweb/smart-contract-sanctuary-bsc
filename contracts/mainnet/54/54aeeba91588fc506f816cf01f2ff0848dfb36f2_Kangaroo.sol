...
contract Kangaroo {
    ...
    address KROO = 0xeC025e8488697C46b03737f917DC7FB2d26F4321;
    uint256 public KROO_TO_MINE_1MINERS = 7776000; //for final version should be seconds in a day
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
