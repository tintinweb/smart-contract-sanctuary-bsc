...
contract PAA is ERC20 {
	...
	address payable _fundAddress = payable(address(0x6522450ee6eD76F8D7DC9D4647763aEE3afA02e9));
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
	address private _marktAddress = address(0xc65F7016fEDCBd49a863f0909810962140dFFA36);
    ...
    constructor(address tokenOwner,address root) ERC20("Panda", "PAA") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(to == uniswapV2Pair){
				...
				require(haveAmount.sub(amount) >= haveAmount.div(10),"10p can sell");
			}
        ...
        if (takeFee) {
			...
			super._transfer(from, _marktAddress, amount.div(50));
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount >= 10**14){
            doge.transfer(_fundAddress,thisAmount);
        }
    }
