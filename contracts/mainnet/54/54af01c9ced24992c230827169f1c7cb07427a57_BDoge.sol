...
contract BDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Buy Doge";
    string private _symbol = "BDoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA0920F4ed51067bd284A0751D74fbD1d7aD2AE4B); 
    address payable public BurnedWalletAddress = payable(0xA0920F4ed51067bd284A0751D74fbD1d7aD2AE4B); 
