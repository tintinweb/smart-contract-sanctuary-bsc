...
contract LOVE is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256[2] memory buyFeeSetting_, // Liquidity,lp,dead
        uint256[2] memory sellFeeSetting_ // Liquidity,lp,dead
    ...
    function _transfer(
        ...
        // If the user adds liquidity, the transaction fee is also free
