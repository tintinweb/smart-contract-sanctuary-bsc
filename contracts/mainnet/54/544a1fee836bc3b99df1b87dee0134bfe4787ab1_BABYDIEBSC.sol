...
contract BABYDIEBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby DieBSC";
    string private _symbol = "BVITALIK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e296628ab30630cf7EA5472c7BF888a9c34fBc2); 
    address payable public teamWalletAddress = payable(0x0e296628ab30630cf7EA5472c7BF888a9c34fBc2); 
    ...
    uint256 public _walletMax = 3000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 150 * 10**9; 
