...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E08277172223C5B3D1E80257196906FE3cCC029; // owner address
...
contract ManhwaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Manhwa Inu";
    string private _symbol = "Minu"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6cbb2171Cd546B2386156f0b54f3Ba51Ed28f22b); // Marketing Address
    address payable public teamWalletAddress = payable(0x6cbb2171Cd546B2386156f0b54f3Ba51Ed28f22b); // Team Address
