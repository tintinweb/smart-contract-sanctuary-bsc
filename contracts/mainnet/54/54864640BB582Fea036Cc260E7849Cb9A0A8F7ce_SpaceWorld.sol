...
contract SpaceWorld is IBEP20, Auth {
    ...
    string constant _symbol = "$SWORLD";
    ...
    address internal MarketingFeeReceiver = address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD);
    ...
    constructor() Auth(address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13)) {
        router = IDEXRouter(_dexRouter);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WBNB = router.WETH();

        isFeeExempt[address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13)] = true;
        autoLiquidityReceiver = address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13)] = true;
        _isAllowed[0xd6ecE8cCd36119B687010E9BD70470bdE842dD13] = true;
        _isAllowed[address(this)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13)] = _totalSupply;
        emit Transfer(address(0), address(0xd6ecE8cCd36119B687010E9BD70470bdE842dD13), _totalSupply);
    }
