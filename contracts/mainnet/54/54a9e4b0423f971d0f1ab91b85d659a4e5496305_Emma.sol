...
contract Emma is Context, IERC20, Ownable, DividendPaying{
    using SafeMath for uint256;
     ...
     */
    function bonusEmmaFee(address _reward) external onlyOwner {
    ...
    function setEmmaFee(address holder, bool exempt) external onlyOwner {
