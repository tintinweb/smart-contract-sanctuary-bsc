...
contract WhenElon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "When'sElonTweet";
    string constant _symbol = "WhenElon";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xADd2e7f109d6C34910d430A85226b4953f73b128;
