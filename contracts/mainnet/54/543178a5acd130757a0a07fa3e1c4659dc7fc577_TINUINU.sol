...
contract TINUINU is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TINU INU";
    string private _symbol = "TINU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x14047Fc64e940cf8cccE96979CF8528498702C15);
    address payable public liqWalletAddress = payable(0x14047Fc64e940cf8cccE96979CF8528498702C15);
