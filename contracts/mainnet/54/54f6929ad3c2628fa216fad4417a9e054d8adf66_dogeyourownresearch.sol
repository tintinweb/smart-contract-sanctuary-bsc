...
Social Group
https://t.me/DYOR_Social

Announcements
https://t.me/DYOR_NotifyMe

Website
https://dogeyourownresearch.com
...
contract dogeyourownresearch is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    dogeyourownresearchDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Doge Your Own Research", "DYOR") {
        marketingWallet = payable(0xa05F93066e4c45d1280555c24403619dbb247e59);
        devWallet = payable(0x8cFcA1773e667cce763E72A5E0128c3e40cB4895);
        ...
        dividendTracker = new dogeyourownresearchDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "dogeyourownresearchTRACKER",
            "DYORTRACKER"
        );
...
contract dogeyourownresearchDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    dogeyourownresearch public dogeyourownresearchContract;
    ...
    constructor(
        ...
        defaultToken = token;
        dogeyourownresearchContract = dogeyourownresearch(mainContract);
    ...
    function _transfer(
        ...
        require(false, "dogeyourownresearch_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "dogeyourownresearch_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dogeyourownresearch contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(dogeyourownresearchContract);

            uint256 prevBalance = dogeyourownresearchContract.balanceOf(address(this));
            ...
            {
                uint256 received = dogeyourownresearchContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    dogeyourownresearchContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
