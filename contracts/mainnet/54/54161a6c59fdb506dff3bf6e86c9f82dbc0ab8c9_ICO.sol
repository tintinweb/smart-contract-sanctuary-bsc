...
contract ICO is IBEP20, Auth {
    ...
    string constant _name = "ICO";
    string constant _symbol = "ICO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10000000 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(100).div(10000000);
    uint256 public _maxWalletToken = _totalSupply.mul(10).div(10000000);
    ...
    constructor () Auth(msg.sender) {
        ...
        ecosystemfeeReceiver = 0xC9b2F7fb12221FC9E2150B33C5B33297A7837684;
