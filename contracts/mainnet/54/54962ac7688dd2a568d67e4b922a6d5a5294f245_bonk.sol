...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1bf03a5048301613b7e2e54DF0A1F31cBE012AbF; // owner address
...
contract bonk is Context, IERC20, Ownable {
    ...
    string private _name = "Bonk Inu 2023";
    string private _symbol = "BONK2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1bf03a5048301613b7e2e54DF0A1F31cBE012AbF); // Marketing Address
    address payable public teamWalletAddress = payable(0x1bf03a5048301613b7e2e54DF0A1F31cBE012AbF); // Team Address
