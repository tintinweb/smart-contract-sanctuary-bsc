...
contract WaterBoyCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Water Boy Coin"; // 
    string private constant _symbol = "WBC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xE41B5325c4a385Ea74Ae52acba8ecF55d56D8cBb);
