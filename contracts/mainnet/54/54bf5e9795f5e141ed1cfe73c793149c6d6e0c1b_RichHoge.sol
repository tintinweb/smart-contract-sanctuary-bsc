...
/*
-----Rich Hoge Features-----
* 2 % Tax Fee (Income to Holders)
* 2 % Liquidity Fee
* 1 % Auto Burn
* 5 % Marketing & Development
* 2,5% Max Transaction(2,5 Trillion)
------------------------------
Website: RichHoge.Site
Telegram: @RichHogeToken
Twitter: @RichHogeToken
*/
...
contract RichHoge is Context, IERC20, Ownable {
    ...
    string private _name = "RichHoge";
    string private _symbol = "RHOGE";
    ...
    address public marketingWallet = 0xb5c6AeB73ea5516F359CDAa810C7Ba3ae68dE794;
