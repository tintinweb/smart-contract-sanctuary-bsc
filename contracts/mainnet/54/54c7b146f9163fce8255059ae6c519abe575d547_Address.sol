...
// BEST GEMS, STEALTH LAUNCH NOW! L
// Tg : https://t.me/segaprotocols
...
contract SEGAPROTOCOL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe6b73a1db4f4d5647a7DA8f779A96eDF0d9C415c); 
    address payable public Wallet_Dev = payable(0xe6b73a1db4f4d5647a7DA8f779A96eDF0d9C415c);
    ...
    string private constant _name = "Sega Protocol"; 
    ...
    constructor () {
        ...
        _owner = 0xe6b73a1db4f4d5647a7DA8f779A96eDF0d9C415c;
