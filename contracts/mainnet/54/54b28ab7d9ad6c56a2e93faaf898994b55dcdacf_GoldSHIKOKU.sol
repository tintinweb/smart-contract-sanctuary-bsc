...
/*
   ...
   Telegram: https://t.me/GoldSHIKOKU
   Gold SHIKOKU come to tlbe the next trend on Binance Smart Chain,
   Combine it with one of the biggest meme ever make it 
   become a powerfull meme token also, 
   Community will be the most important key to make Gold SHIKOKU 
   Simply hold Gold SHIKOKU and see you on to
...
contract GoldSHIKOKU is ERC20, Ownable {
    ...
    constructor() ERC20(" Gold SHIKOKU  ", " GSHIKOKU ") {
        ...
        devWallet = address(0x05615c15B1201b1312eBae8337747Ef46ce9cb75); 
