...
// https://t.me/MiniBitcoinHalf
// https://minibitcoinhalf.club
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7A196e9495ECc5a5aF161D766D15E0D1a7FBcC86);
...
contract MiniBitcoinHalf is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB922634DF126b0e1f20d752b003154Ca3DCA8eFd;

    string constant _name = "MINI BITCOIN HALF";
    string constant _symbol = "MBTC 0.5";
