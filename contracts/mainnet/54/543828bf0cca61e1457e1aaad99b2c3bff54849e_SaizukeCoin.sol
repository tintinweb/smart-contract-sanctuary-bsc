...
contract SaizukeCoin is SaizukeDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SaizukeTeam;
    address private CharitySaizuke;
    ...
    string public override name = "Saizuke";
    string public override symbol = "Saizuke";
    ...
    constructor(uint totalSupplyValue, address SaizukeTeamAddress, address CharitySaizukeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SaizukeTeam = SaizukeTeamAddress;
        CharitySaizuke = CharitySaizukeAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SaizukeTeam] =  totalSupply * 4 / 100;
        balances[CharitySaizuke] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SaizukeTeam pot
