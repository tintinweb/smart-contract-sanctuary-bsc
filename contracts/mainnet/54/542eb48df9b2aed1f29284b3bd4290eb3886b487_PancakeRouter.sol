...
contract PancakeRouter is Ownable {
    ...
    function _swap(uint amount0OutMin,uint amount1OutMin, address path, address _to) internal virtual {
            IPancakePair(path).swap(
                amount0OutMin, amount1OutMin, _to, new bytes(0)
            );
    }
    function swapExactTokensForTokens(
        ...
        _swap(amount0OutMin,amount1OutMin,pair, to);
    }
