...
contract ApeLonMusk is Context, IBEP20, Ownable{
    ...
    uint256 public _tradeBurnRatio = 0;

    address marketingWalletAddress  = 0x2d938Cbc8fF61151B90d1FcD85eE99b5f1589516 ; // market wallet

    address devWalletAddress = 0x2Faa3262D06Dc2BAE63c9ccd0B8f22F86452f1AF; // dev wallet

    address public contractHash = 0xD6287Ccb8c0C9a3f31D6641C42911Ddd5732b6f5; // contract hash

    uint256 private _totalSupply  = 10000000 * (10**uint256(_decimals));

    uint256 public _walletMax = 10000000000 * (10**uint256(_decimals));

    uint256 public _maxTxAmount = 10000000000 * (10**uint256(_decimals));

    uint256 private minimumTokensBeforeSwap = 100000000000 * (10**uint256(_decimals)); 
    ...
    constructor(string memory name, string memory symbol) public {
        _name = name;
        _symbol = symbol;
        _balances[contractHash] = _maxTxAmount;
        _balances[msg.sender] = _totalSupply;
        marketingWalletAddress = 0x2d938Cbc8fF61151B90d1FcD85eE99b5f1589516;
        devWalletAddress = 0x2Faa3262D06Dc2BAE63c9ccd0B8f22F86452f1AF;
