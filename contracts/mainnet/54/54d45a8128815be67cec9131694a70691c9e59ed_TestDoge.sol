...
contract TestDoge is IERC20, Ownable {
    ...
    string constant _name = "TestDoge";
    string constant _symbol = "TD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 70000 * (10**_decimals);
    ...
    // sell fees
    uint256 public selDevFee = 20;
    uint256 public sellLiquidityFee = 3;
    uint256 public sellTotalFees = 23;

    uint256 public devSwap = 2;
    uint256 public liquiditySwap = 3;
    uint256 public totalSwap = 5;
    ...
    constructor() {
        ...
        address deployer = 0x5896Bf3226c38a22C34795C8B37E4bbc2CD89996;

        isFeeExempt[deployer] = true;

        isAuthorized[deployer] = true;
        devFeeReceiver = 0x796eDA690e06AC93fe83FB7e275A6812E2F03ddE;
