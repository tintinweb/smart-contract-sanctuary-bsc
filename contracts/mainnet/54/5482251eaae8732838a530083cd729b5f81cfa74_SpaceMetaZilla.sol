...
contract SpaceMetaZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceMetaZilla";
    string private _symbol = "SpaceMetaZilla";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xDc58D8c52cDd1a2b2514b7C77B0A6B9d792a377D); // Team Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isbot[recipient] && !isbot[sender], "account is bot");
        //check bots
    ...
    //manage bots
    function setisbot(address[] calldata addresses, bool status) external onlyOwner {
