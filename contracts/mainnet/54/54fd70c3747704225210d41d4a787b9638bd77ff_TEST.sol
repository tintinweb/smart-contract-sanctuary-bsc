...
contract TEST is ERC20, Ownable {
    ...
    constructor() ERC20("TEST", "TST") 
    {
        ...
        maxWallet = _maxSupply * 2 / 100; // 2% Of total supply
        ...
        setSellTax(10); // set initial tax value here
        setTaxWallet(address(0xAd1f38649C288f6B912dA52BE63073349486dD71)); //set your wallet here
    ...
    */
    ...
    function setMaxWallet (uint256 amount) public onlyOwner {
        require (amount >= totalSupply() * 2 / 100, "NO rug pull");
        maxWallet = amount;
    }
    ...
    */
    ...
    function setSellTax(uint256 _newSellTax) public onlyOwner {
        require (_newSellTax <= 30, "Max Sell Tax Limit is 30%");
