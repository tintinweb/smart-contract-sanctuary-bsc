...
contract BabyHallowFLoki is IBEP20, Auth {
    ...
    string constant _name = "Baby Hallow FLoki";
    string constant _symbol = "BHL";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100 * (10 ** _decimals);
    uint256 public _maxWalletToken = 100 * (10 ** _decimals);
