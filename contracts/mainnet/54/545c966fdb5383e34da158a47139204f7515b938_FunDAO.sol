...
████████████████████████████████████████████████████████████████████████████████████████
FunDAO IS A PROJECT BASED ON THE BSC BLOCKCHAIN NETWORK
HAVE A UTILITIES SUCH AS STAKING
LIQUIDITY FARMING,P2E GAMES
WALLET,AND OTHERS DEFI PROJECT...!!!

<DEVELOP BY CONTRACT CHECKER>
...
2% MAX WALLET AND 2% MAX TX
for the first 1 hour : max wallet 2% and max transaction only 1%
*/
...
contract FunDAO is IBEP20, Auth {
    ...
    string constant _name = "FunDAO";
    string constant _symbol = "FDAO";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply = 50 * 10**6 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0x6201486817c9668271e505BCf870bee263F35BDB;
    address private buybackFeeReceiver = 0x6201486817c9668271e505BCf870bee263F35BDB;
