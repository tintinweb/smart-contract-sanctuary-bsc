...
contract Sliki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sliki";
    string private _symbol = "SLK";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD59779529051296Cb73f04ed71Ddb53F81Ee85c7); 
