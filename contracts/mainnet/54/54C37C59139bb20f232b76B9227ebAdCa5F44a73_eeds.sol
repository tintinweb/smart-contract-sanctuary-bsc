...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xB1f2204A41Eb020F8d5Ddbe1e2A589eCAf311D84;//fund address
...
contract eeds is Token {
    constructor() Token(
        ...
        1000000000000000000000000000,//num
    
        address(0xB1f2204A41Eb020F8d5Ddbe1e2A589eCAf311D84),//fund address
    
        address(0xB1f2204A41Eb020F8d5Ddbe1e2A589eCAf311D84)//dev address
    ){
