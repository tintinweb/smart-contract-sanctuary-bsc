...
contract OpenGateNFTMaster is Ownable, IERC721Receiver {
    ...
    uint256 public feeRate = 0;  // 5% = (feeRate/FEE_BASE)

    address payable public feeTo = 0x1f8E9EFBacE5543199126a31685Db70C1225EBCC;
    ...
    uint256 public maximumDuration = 2 seconds;
    ...
    function claimNFT(uint256 collectionId_, uint256 index_) public {
        ...
        claimRevenue(collectionId_, index_);
    }

    function claimRevenue(uint256 collectionId_, uint256 index_) public {
        Collection storage collection = allCollections[collectionId_];
