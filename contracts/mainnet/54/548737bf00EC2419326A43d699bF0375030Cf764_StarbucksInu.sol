...
contract StarbucksInu is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "Starbucks Inu"; //  Name
        _symbol = "Starinu"; //  Symbol
        ...
        _maxTxAmount = 90000000000 * 10**_decimals; // 9% of total supply
        _maxWalletBalance = 90000000000 * 10**_decimals; // 9% of total supply
        _marketingWalletAddress = 0x54fda9B0B5C68edAfe5393eC61Af9Ac3f612520E; // Marketing wallet 
        _devWalletAddress = 0x714737F590460698c2e91D9A565f0C4487973C41; // Dev wallet 
