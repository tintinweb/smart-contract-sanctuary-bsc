...
contract DataWorldToken is Context, IERC20, Ownable {
    ...
    uint256 public _buyLpFenhongFee = 4;
    ...
    uint256 public _sellLpFenhongFee = 7;
    ...
    address public usdtUniswapPair;
    ...
    constructor () {
        ...
        usdtUniswapPair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(ethAddress));    

        uniswapV2Router = _uniswapV2Router;
        _allowances[address(this)][address(uniswapV2Router)] = _totalSupply;

        isDividendExempt[address(uniswapPair)] = true;
        isDividendExempt[address(usdtUniswapPair)] = true;
        ...
        isWalletLimitExempt[address(usdtUniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;

        isMarketPair[address(uniswapPair)] = true;
        isMarketPair[address(usdtUniswapPair)] = true;
    ...
    function setIsDividendExempt(address account, bool newValue) public onlyOwner {
        isDividendExempt[account] = newValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(_limitAddressMap[recipient] != 1, "ERC20: transfer is limit");
    ...
    function process(uint256 gas) private {
        ...
        IERC20 pair = IERC20(usdtUniswapPair);
        ...
        uint256 lpCount = IERC20(usdtUniswapPair).balanceOf(shareholders[currentIndex]);
         if(lpCount == 0) {
             currentIndex++;
             iterations++;
             return;
