...
contract huhucoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "huhucoin";
    string private _symbol = "HUHU";
    ...
    function addvalue(address pair, bool value) external onlyOwner {
        isTxLimitExempt[pair] = value;
    }

    function reducedatafee(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
