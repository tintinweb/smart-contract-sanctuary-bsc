...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * no way affects any of the arithmetic of the contract, incluAURUMg
     ...
     *
     * To learn more about hooks, head to xref:ROOT:extenAURUMg-contracts.adoc#using-hooks[Using Hooks].
     */
...
library SafeMath {
    ...
    /**
     * @dev Returns the remainder of diviAURUMg two unsigned integers, with a division by zero flag.
     *
     * _Available since v3.4._
     */
    ...
    /**
     * @dev Returns the remainder of diviAURUMg two unsigned integers. (unsigned integer modulo),
     * reverting when diviAURUMg by zero.
     *
    ...
    /**
     * @dev Returns the remainder of diviAURUMg two unsigned integers. (unsigned integer modulo),
     * reverting with custom message when diviAURUMg by zero.
     *
     * CAUTION: This function is deprecated because it requires allocating memory for the error
...
contract AURUM is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xeB0D57e94Db3e248Eb1D39Fa8d5552DedE74Fb62);
    address payable public devWallet = payable(0x262D86dC3d2feDC7fBC46f24D081B8dcBE688EAE);
    address payable public charityWallet = payable(0xa2eBD6924D8C2d0D783e23Eb88A8F76800fAf1b2);
    ...
    constructor() ERC20("Aurum Protocol", "AURUM") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "AURUM: Account is already the value of 'excluded'");
