...
contract ZENCO is BEP20, BEP20Burnable, Pausable {
    constructor() BEP20("ZENCO", "ZENCO") {
     ...
     function claimStuckedTokensAndBNB(address _token) external onlyOwner {
        ...
        if (_token == address(0x0)) {
            ...
            return;
             ...
             require(balanceOf(address(this))> 0, "ZENCO: Contract balance should be greator than zero");
