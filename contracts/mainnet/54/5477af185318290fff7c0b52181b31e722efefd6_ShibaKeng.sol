...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81005575027D1d60BC2670e0a05A22eFdB20ceEA;
...
contract ShibaKeng is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 50000000 * 10**9; //
    string private constant _name = "Shiba Keng"; // 
    string private constant _symbol = "SHBKNG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x81005575027D1d60BC2670e0a05A22eFdB20ceEA);
