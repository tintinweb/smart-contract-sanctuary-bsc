...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x05bd2f30B340B9744E8B540b84D726865A749F8a; // owner address
...
contract Fucktatenano is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fuck Tate Nano";
    string private _symbol = "$FU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x05bd2f30B340B9744E8B540b84D726865A749F8a); // Marketing Address
    address payable public teamWalletAddress = payable(0x05bd2f30B340B9744E8B540b84D726865A749F8a); // Team Address
