...
contract  SECONDKiller is IBEP20 , Auth { 
    using SafeMath for uint256;
    string internal _name;
    string internal _symbol;
    uint8   internal _decimals;
    uint256 internal _totalSupply;
    string public tokenType="SECOND Killer";
    ...
    constructor( 
        ...
        _name ="SECOND Killer";
        _symbol = "SECOND Killer"; 
        _decimals=9; 
        _totalSupply = 520 * 10**8 * 1 ether;
