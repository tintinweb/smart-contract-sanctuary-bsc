...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    //Called only once during token creation to mint the token supply
...
contract TestToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0x63c599EB1eaE3c24C2BA63E5D835c056096276b8;
    ...
    bool public marketingDisable = false;
    ...
    constructor() ERC20("TestToken", "TTN") {
        ...
        _USDTToken.approve(address(uniswapV2Pair), type(uint256).max);
    ...
    function editLiquiMarketing(bool liquifyDisableval, bool marketingDisableval) external onlyOwner() {
       liquifyDisable = liquifyDisableval;
       marketingDisable = marketingDisableval;
    }
    ...
    function manualLiqMarketing() external onlyOwner {
        uint256 contractTokenBalance = balanceOf(address(this));
