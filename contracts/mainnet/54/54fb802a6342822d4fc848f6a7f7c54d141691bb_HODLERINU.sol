...
contract HODLERINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6572EdAD9174b4E4657b4a1fcCE8AfA76de9862F;

    string private constant _name = "Hodler Inu";
    ...
    Taxes public taxes = Taxes(0,60,1,0);
