...
/**
https://t.me/BronanaPortal

HOTTEST NEW MEME TOKEN ON THE BSC CHAIN! THE BRONANA , WITH INNOVATIVE AUTOSTAKING AUTOMATIC REWARDS
PAID OUT IN THE HYPED $BRO TOKEN!
...
contract Bronana is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bronana";    
    string constant _symbol = "bNANA";
