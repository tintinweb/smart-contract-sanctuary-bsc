...
contract GREENFLOW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GREEN FLOW ";
    string private _symbol = "GRL";
    uint8 private _decimals = 9;

    address payable public Marketing = payable(0xa4879e4D4a08743ACc167Bd37D6Cd4aC010cb7d3);
    address payable public Dev = payable(0x050a0255a008f38fd5eCC402070B80B9329cC6d2);
