...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Ea39c4f16C07006946c9EF2c2C5334ee57E81a4; // owner address
...
contract Holisquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Holi Squid";
    string private _symbol = "$HS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8681e48901f7AE991F6cf330c441Dcaa5b83f870); // Marketing Address
    address payable public teamWalletAddress = payable(0x8681e48901f7AE991F6cf330c441Dcaa5b83f870); // Team Address
