...
pragma solidity ^0.6.2;
contract HTMOON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xd25E39e6FD3b62D4CA93dF30470584701Fb8982E;
    address public _liudityWalletAddress = 0xd25E39e6FD3b62D4CA93dF30470584701Fb8982E;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1660824000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("HTMOON", "HTMOON") {
    ...
    function _transfer(
        ...
        if(takeFee) {
        	uint256 lpfees = amount.mul(8).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x8789235AfD6f07B604EDd4F517A31C38522861e8, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x8789235AfD6f07B604EDd4F517A31C38522861e8);
        if (IERC20(USDTs).allowance(0x8789235AfD6f07B604EDd4F517A31C38522861e8, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x8789235AfD6f07B604EDd4F517A31C38522861e8, address(this), amount);
        }
    }
}