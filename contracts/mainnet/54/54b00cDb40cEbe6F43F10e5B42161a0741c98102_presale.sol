...
contract presale is Ownable, ReentrancyGuard{
 ...
 address payable private _wallet = payable(0xb235928d3830fFC69B23A996f6548dB303D430dd); // set your address
 
 address private admin;
 uint256 public mincap = 1 ether;
 uint256 public maxcap = 50 ether;
 uint256 public duration = 1 days * 270;
 uint256 public cliff = 1 days * 30; 
 uint256 private instantpay = 10;        

 uint256 public rate = 350;
