...
WikipediainU - WikiinU

Wikipedia Dog is an online encyclopedia that provides in-depth information about dogs of all breeds and sizes, from their histories and health to types of training and playing with them. It also has related topics such as grooming, nutrition, responsible ownership and behaviour issues.

10% Tax > reduced after 20 mins to 7% and will be renounce after

https://t.me/WikipediainUofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc80441791303f44CE65B7D63Ed846D333180d4E0; // owner address
...
contract WikipediainU is Context, IERC20, Ownable {
    ...
    string private _name = "WikipediainU";
    string private _symbol = "WikiinU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc80441791303f44CE65B7D63Ed846D333180d4E0); // 
    address payable public teamWalletAddress = payable(0xc80441791303f44CE65B7D63Ed846D333180d4E0); // 
