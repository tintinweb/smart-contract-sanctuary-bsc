...
contract EVO is ERC20, Ownable{
    ...
    Taxes public taxes = Taxes(2,3,4,1);
    uint256 public totalTax = 10;

    address public marketingWallet = 0x09f958acf5ba406fa8a0dD6169c26E2a814E8987;
    address public devWallet = 0xa83522d57D827a56cd53244C7dfB27dCE924B5fa;
    address public teamWallet = 0x47B5da287c63E9401fC098f35cf003AfDBA858fF;
    ...
    function seyTaxes(uint256 lp, uint256 marketing, uint256 team, uint256 dev) external onlyOwner{
        totalTax = lp + marketing + team + dev;
        taxes = Taxes(lp,marketing,team,dev);
    }
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        // Send BNB to team
        uint256 teamAmt = (unitBalance * 2 * taxes.team);
        if(teamAmt > 0){
