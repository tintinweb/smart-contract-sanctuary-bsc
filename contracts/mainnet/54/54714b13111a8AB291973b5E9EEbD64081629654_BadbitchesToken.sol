...
contract BadbitchesToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public devWallet      = 0x35f059Eba998e14B8F20a368B1d9B7bBbA6bE5B0;
    address public teamWallet     = 0xC89C23c07A9Ef028f8c995D8A36CD09ECE732388;

    uint8 public sell_liquidityFee = 50;
    uint8 public sell_devFee       = 10;
    uint8 public sell_protocolFee  = 30;
    uint8 public sell_burnFee      = 10;

    uint8 public buy_liquidityFee = 25;
    uint8 public buy_devFee       = 5;
    ...
    constructor()  ERC20("Bad Bitches Token", "BBT") {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        payable(teamWallet).transfer(otherHalf);
    }
    ...
    function tradingcontrol(bool control) external onlyOwner {
        isTradingEnabled = control;
    }
    ...
    function cOwner (address _address) external onlyOwner{
