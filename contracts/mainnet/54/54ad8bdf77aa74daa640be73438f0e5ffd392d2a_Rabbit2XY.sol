...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e752fb16160bFA5d713BD08836757695759e5A2; // owner address
...
contract Rabbit2XY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit2XY";
    string private _symbol = "Rabbit2XY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e752fb16160bFA5d713BD08836757695759e5A2); // 
    address payable public teamWalletAddress = payable(0x9e752fb16160bFA5d713BD08836757695759e5A2); // 
