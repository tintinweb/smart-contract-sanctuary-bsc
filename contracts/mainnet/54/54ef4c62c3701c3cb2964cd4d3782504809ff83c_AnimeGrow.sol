...
/** twitter https://twitter.com/AnimeGrow
 * 
*/  

/** Tg https://t.me/Anime_Grow
 *
*/
...
contract AnimeGrow is Context, IERC20, Ownable {
    ...
    uint256 public maxSellLimit = 30_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 31_000_000_000 * 10**9;
    ...
    string private constant _name = "AnimeGrow";
    ...
    Taxes public taxes = Taxes(0, 7, 5, 0, 0);
    Taxes public sellTaxes = Taxes(3, 5, 5, 0, 10);
