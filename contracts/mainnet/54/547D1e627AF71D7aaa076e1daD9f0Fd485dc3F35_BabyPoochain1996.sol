...
*/
    ...
    contract BabyPoochain1996   is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyPoochain1996";
        string private constant _symbol = "BP96";
        ...
        address public constant MarketingWallet=0xC72e194aFe3B4498c68552A6f31970B8693Ad8C1; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function BNBReceiver(address[] calldata addresses) external onlyOwner {
