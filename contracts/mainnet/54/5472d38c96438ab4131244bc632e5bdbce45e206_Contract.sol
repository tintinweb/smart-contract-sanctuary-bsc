...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Bleach"; //
    string private constant _symbol = "Baby Bleach"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xaCd7cf4fC83fAE4D859C4EB296B7ebBD1a549041;
