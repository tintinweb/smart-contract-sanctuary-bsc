...
contract FrontmanHi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Frontman, HI.";
    string constant _symbol = "MARIA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x76F5A730acA2c170d6F5e0397BD2C186065E04e1;
