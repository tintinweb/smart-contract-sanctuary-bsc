...
// MMMMMMMM               MMMMMMMMTTTTTTTTTTTTTTTTTTTTTTTDDDDDDDDDDDDD        
// M:::::::M             M:::::::MT:::::::::::::::::::::TD::::::::::::DDD     
// M::::::::M           M::::::::MT:::::::::::::::::::::TD:::::::::::::::DD   
// M:::::::::M         M:::::::::MT:::::TT:::::::TT:::::TDDD:::::DDDDD:::::D  
// M::::::::::M       M::::::::::MTTTTTT  T:::::T  TTTTTT  D:::::D    D:::::D 
// M:::::::::::M     M:::::::::::M        T:::::T          D:::::D     D:::::D
// M:::::::M::::M   M::::M:::::::M        T:::::T          D:::::D     D:::::D
// M::::::M M::::M M::::M M::::::M        T:::::T          D:::::D     D:::::D
// M::::::M  M::::M::::M  M::::::M        T:::::T          D:::::D     D:::::D
// M::::::M   M:::::::M   M::::::M        T:::::T          D:::::D     D:::::D
// M::::::M    M:::::M    M::::::M        T:::::T          D:::::D     D:::::D
// M::::::M     MMMMM     M::::::M        T:::::T          D:::::D    D:::::D 
// M::::::M               M::::::M      TT:::::::TT      DDD:::::DDDDD:::::D  
// M::::::M               M::::::M      T:::::::::T      D:::::::::::::::DD   
// M::::::M               M::::::M      T:::::::::T      D::::::::::::DDD     
// MMMMMMMM  
...
interface olIDOO {
    ...
    function getUserInfo(address _addr) external  view returns(uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal);
...
contract IDO is Ownable,Pausable, ReentrancyGuard{
    ...
    constructor(
        ...
        tarifs.push(Tarif(1, 1000000000000000000000));
        tarifs.push(Tarif(101,500000000000000000000));
        tarifs.push(Tarif(497, 300000000000000000000));
        tarifs.push(Tarif(1179, 100000000000000000000));
        tarifs.push(Tarif(9999926,30000000000000000000));
    }
    ...
    function setRegister(uint256 _register) public onlyOwner {
        register = _register;
    }
    ...
    function setUserInfo(address _addr, uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal) public  onlyOwner {
        users[_addr].ID = _ID;
    ...
    function setrefRate(uint256 _refOne,uint256 _refTwo,uint256 _refThree) public onlyOwner {
        refOne = _refOne;
        refTwo = _refTwo;
        refThree = _refThree;
    }
    ...
    function syncDatabaseOne(address  _UserAddress) public  onlyOwner {
        ...
        (uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal) = oldIDO.getUserInfo(_UserAddress);
    ...
    function syncDatabaseAll(address[] memory  _UserAddress) public  onlyOwner {
        ...
        (uint8 _ID,bool _reflow,uint256 _reflowUSDT,uint256 _InvestmentUSDTotal,uint256 _PromotionUSDTAmount,uint256 _BuyMTDTotal) = oldIDO.getUserInfo(_UserAddress[i]);
