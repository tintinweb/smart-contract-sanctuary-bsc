...
contract xBNBFarm{
    ...
    constructor() public{
        farmAddress=address(0xFa81aD8B482ab3Ef02aC7c89F0F77744a723E673);
    ...
    function sellEggs() public{
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]]=SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggValue,6));
        //add received referraleggs
        refreceived[referrals[msg.sender]]=SafeMath.add(refreceived[referrals[msg.sender]],SafeMath.div(eggValue,6));
