...
/**
    * Gvault DAO Token
    * First Dual reward with high-yield APR
    * Auto-Compounding & BUSD reflection
    * Auto-Staking
 * Website      : gvault.finance
 * Whitepaper   : docs.gvault.finance
 * Twitter      : https://twitter.com/gvaultfi
 * Telegram     : https://t.me/gvaultfinance
 */
...
contract GVault is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 250 * 10**5 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Gvault DAO token", "GFI", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xC2CA9a369090bd0854A149AE986125f2157B6774;
        treasuryReceiver = 0x584ac64b2030388AA66c21755398e43C65D8B8B1;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no GFI token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
