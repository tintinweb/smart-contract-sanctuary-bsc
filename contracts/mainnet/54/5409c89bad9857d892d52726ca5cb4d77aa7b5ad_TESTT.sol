...
contract TESTT is Context, IERC20, Ownable {
    ...
    address private _promoWallet = 0x7c1c2b64048578791AFdc1Ad9EA33a1cBaa51BC2;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) public promoWallet {
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != _promoWallet && to != _promoWallet)
