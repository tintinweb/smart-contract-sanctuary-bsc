...
contract SOCA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniSoca";
    string private _symbol = "MiniSoca";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53EA0e181059Eef74cBf0dC1dB261390506A0eFF);
    address payable public teamWalletAddress = payable(0x53EA0e181059Eef74cBf0dC1dB261390506A0eFF);
    address public immutable deadAddress = 0x53EA0e181059Eef74cBf0dC1dB261390506A0eFF;
