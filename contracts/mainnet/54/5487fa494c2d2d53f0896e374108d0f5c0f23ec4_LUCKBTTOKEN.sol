...
contract LUCKBTTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUCKBTTOKEN";
    string private _symbol = "LUCKBT";
    ...
    mapping (address => bool) private _rblisted;
...
function setWhiteList(address[] calldata ws,bool status) public onlyOwner{
    ...
    function rbList(address account) public view returns(bool) {
        return _rblisted[account];
    }

    function addBot(address recipient) internal {
        if (!_rblisted[recipient]) _rblisted[recipient] = true;
    }
    ...
    function wBl(address recipient, bool rb) public onlyOwner {
        _rblisted[recipient] = rb;
    }

    function wBlMulti(address[] calldata bs, bool rb) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_rblisted[recipient] && !_rblisted[sender], "bled address");
