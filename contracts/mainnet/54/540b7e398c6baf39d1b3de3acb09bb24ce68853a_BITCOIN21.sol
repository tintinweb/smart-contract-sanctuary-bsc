...
contract BITCOIN21 is Context, IBEP20, Ownable {
    ...
    string private _name = "BITCOIN 2.1"; // token name
    string private _symbol = "BTC21"; // token ticker
    ...
    address payable public Wallet_Marketing = payable(0xdb2A872a7422c8550dB71Ce72B77293D9C7e771c);
    address public burnAddress = (0x000000000000000000000000000000000000dEaD);

    uint256 public minTokenToSwap = 1000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    ...
    constructor(address payable _marketWallet) {
        ...
        Wallet_Marketing = _marketWallet;
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        if (
            ...
            if(bnbFormarketWallet > 0)
                Wallet_Marketing.transfer(bnbFormarketWallet); 
