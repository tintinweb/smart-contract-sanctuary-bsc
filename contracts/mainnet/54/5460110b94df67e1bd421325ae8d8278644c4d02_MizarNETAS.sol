...
contract MizarNETAS is MizarNETASDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MizarNETASTeam;
    address private CharityMizarNETAS;
    ...
    string public override name = "Mizar NETAS";
    string public override symbol = "MIZARNETAS";
    ...
    constructor(uint totalSupplyValue, address MizarNETASTeamAddress, address CharityMizarNETASAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MizarNETASTeam = MizarNETASTeamAddress;
        CharityMizarNETAS = CharityMizarNETASAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MizarNETASTeam] =  totalSupply * 5 / 100;
        balances[CharityMizarNETAS] = totalSupply * 15 / 100;
