...
contract ArgentinaFanToken is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x0E101F35d6209EB7a5b36ebB107F8ea9470Ff12E);
    address payable public MarketingWallet = payable(0xda24aCCDAd8BA5C58195789b2864dB9f2eCFd04a);
    ...
    function tradingStatus(bool newtradingActive) public onlyOwner {
        tradingActive = newtradingActive;
    }
