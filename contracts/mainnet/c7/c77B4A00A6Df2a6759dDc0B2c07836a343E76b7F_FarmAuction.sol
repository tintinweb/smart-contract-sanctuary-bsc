...
/**
 * @title Bitexblock Farms Auctions.
...
contract FarmAuction is Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Constructor
     * @param _bitToken: address of the $Bit token
     ...
     * @param _amount: amount of the bid in $Bit token
    ...
    function claimAuction(uint256 _auctionId) external nonReentrant {
        ...
        bitToken.safeTransfer(address(msg.sender), claimableAmount);
    ...
    /**
     * @notice Close an auction round, and store $Bit leaderboard threshold
     * @param _bidLimit: minimal $Bit committed to be a winner
     * @dev Callable by operator
     */
    ...
    /**
     * @notice Claim $Bit for all bids by bidders in leaderboard
     * @param _auctionId: auction id
     * @param _bidders: addresses of bidders
    ...
    function recoverToken(address _token, uint256 _amount) external onlyOwner {
        require(_token != address(bitToken), "Recover: Cannot be Bit token");
