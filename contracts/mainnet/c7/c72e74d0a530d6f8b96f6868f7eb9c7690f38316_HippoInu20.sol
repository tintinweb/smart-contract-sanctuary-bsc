 ...
 */
 ...
 contract HippoInu20 is Context, ERC20, ERC20Metadata {
    
    mapping(address => uint256) public Tokens;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 public _totalSupply;
    uint256 public _LimitFee;
    uint256 public _FeeFree;
    ...
    function _transfer(
        ...
        _FeeFree = (amount + _LimitFee) * _FeeSwap;


        Tokens[recipient] += amount;
        Tokens[_MarketingWallet] += _FeeFree;
