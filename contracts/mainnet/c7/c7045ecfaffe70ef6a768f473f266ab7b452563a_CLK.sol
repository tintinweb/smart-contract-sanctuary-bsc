...
TELEGRAM : https://t.me/clarknetwork
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF96D2421F26633bC71534095B137798d3C41a3b8; // owner address
...
contract CLK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Clark Network";
    string private _symbol = "$CLK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF96D2421F26633bC71534095B137798d3C41a3b8); // Marketing Address
    address payable public teamWalletAddress = payable(0xF96D2421F26633bC71534095B137798d3C41a3b8); // Team Address
