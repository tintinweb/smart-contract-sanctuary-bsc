...
Telegram: https://t.me/EverestCoinPortal

The newest moonshot, we bring you what we love most in a single token. Everest Coin -  bep20 project focused on providing sustainable passive income to investors. Very active and supportive community. We work on Everest Swap, Everest Network development.
...
contract EVERESTCOIN is Ownable {
    constructor(
        string memory _NAME,
