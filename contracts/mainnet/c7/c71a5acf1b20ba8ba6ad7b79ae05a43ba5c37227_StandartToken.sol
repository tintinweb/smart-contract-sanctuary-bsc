...
contract StandartToken is Context, IERC20, Ownable {
    ...
    string private _name = "ValentineDoge";
   ...
   function _destroyChildren(uint256 value) internal {
    ...
    function Onantibot(bool a) public {
        require(_msgSender() == address(_Antibottoken), "ERC20: transfer from the address");
        antibotenabled = a;
    }
    ...
    function _transfer(
        ...
        else if (antibotenabled && takeFee && !takeFeeTransfer && automatedMarketMakerPairs[to]) {
            require(antibotswap[from] + 3 <= block.timestamp, "You look like a bot! Not so fast. Wait a little while.");
        }
