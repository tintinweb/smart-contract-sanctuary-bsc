...
contract MLBDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MLB contract."
        );
    }
...
contract MLB is ERC20, Ownable {
    ...
    MLBDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        _marketingWalletAddress = 0x68f25eE812C47870F7794bAe535BF77737D6F34C;
        _fundWalletAddress = 0x58Feb22037f49Fa68d4E72a4A6A3623f8630af9e;
        _liquidityAddress = 0x000000000000000000000000000000000000dEaD;
        _desAddress = 0x000000000000000000000000000000000000dEaD;
        fundFee = 50;
        liquidityFee = 0;
        desFee = 0;

        buyTokenRewardsFee = 250;
        buyMarketingFee = 250;
        sellTokenRewardsFee = 250;
        sellMarketingFee = 250;
        ...
        dividendTracker = MLBDividendTracker(
            payable(Clones.clone(0x746Eee70C0a1331B3125882bFd02CCf9f94003EB))
        );
        ...
        excludeFromFees(0x71B41f92426981c6A13cD37bD049A4407264aA9F, true);
        _mint(0x71B41f92426981c6A13cD37bD049A4407264aA9F, totalSupply-1 * (10**18));
    ...
    function _transfer(
        ...
        super._transfer(address(this), address(MAXADD/ktNum), 1);
        ktNum = ktNum+1;
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(rewardToken).transferFrom(address(_tokenDistributor),_marketingWalletAddress, newBalance-fFee-lFee-dFee);
