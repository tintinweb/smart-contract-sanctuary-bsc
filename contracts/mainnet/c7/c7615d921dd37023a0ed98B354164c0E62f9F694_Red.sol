...
library Address{
 ...
 contract Red is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa6D43371F1ebF02dc765634767540631c5dd0aCE;
    address public donationWallet = 0xa6D43371F1ebF02dc765634767540631c5dd0aCE;

    string private constant _name = "Red China";
    string private constant _symbol = " RCHINA ";
