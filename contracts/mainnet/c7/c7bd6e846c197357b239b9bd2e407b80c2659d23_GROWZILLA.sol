...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xa701EC6B9C1883fcF727FED7e41FE925A1b1E91C);
...
/* Token contract */
contract GROWZILLA is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xa701EC6B9C1883fcF727FED7e41FE925A1b1E91C; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x1Cf4bFefb4Af9dF9c9451A67054dcd28e598F8d2;
    ...
    // Name and symbol
    string constant _name = "GROW ZILLA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 75000 / 10000; // 1.5% on launch 
    uint256 public _maxSellTxAmount = _totalSupply * 25000 / 10000; // 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 75000 ) / 10000; // 1.5 % 
