...
contract Ruby is ReentrancyGuard, AccessControl {
    ...
    uint256 public tokenAmountPerUSD = 1330000000;
        ...
        returns (uint256 finalAmount)
    {
        ...
        finalAmount = amount * tokenAmount / (10**paymentDetails[paymentType].decimal);
    }
