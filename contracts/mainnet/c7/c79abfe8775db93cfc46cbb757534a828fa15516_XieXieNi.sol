...
contract XieXieNi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function chainReaction(address sender, uint256 amount) internal view {
        require(
    ...
    function generating(uint256 rate, uint256 amount) private pure returns (uint256) {     
