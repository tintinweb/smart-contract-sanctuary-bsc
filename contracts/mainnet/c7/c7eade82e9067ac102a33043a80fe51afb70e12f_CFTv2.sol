...
contract CFTv2 is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public maxWalletBalance = 400000000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 40000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 40000000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 400000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    bool private inSwapAndLiquify; 
    bool private coolDownUser;
    bool private swapping;
    bool private activeDividends = false;
    bool public buyCooldownEnabled = false;
    bool public sellCooldownEnabled = false;
    bool private isSendToken = true;
    bool private swapAndLiquifyEnabled = true;
    /*=== Strings ===*/
    string private _name = "CAPITAL FUND TOKEN V2";
    string private _symbol =  "CFTv2";
    /*=== Modifiers ===*/
    ...
    function _setRouterAddress(address router) private {
        ...
        address pairCreated = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH()); // Gera o Par CFTv2/BNB
        uniswapV2Router = _uniswapV2Router; // Armazena Rota
        uniswapV2Pair = pairCreated; // Armazena Par
