...
/*
Pub Coin - A unique reflections token with rewards to all holders that are in the Pub Club! Learn more here at our telegram or read up online at Pub-Coin.com
*/
...
contract PubCoin is Context, IERC20 {
    ...
    address payable public DevWallet = payable(0x8Ba268AcE56dda200Ecb7A65fe4333dAE45216b1);
    address payable public MarketingWallet = payable(0x5C907eDb34c527E99a0455437b5DCe74095e9062);
    address payable private TeamWallet01 = payable(0x1441358fe2d82661C88F3262bb0677B062Bc26A0);
    address payable private TeamWallet02 = payable(0x5fF442A186d0E13e59af71081Fad4dfE2CA42eB7);
    address payable private TeamWallet03 = payable(0x8459f2ae9a109c188fE0033C79599673aEc3F8Ad);
