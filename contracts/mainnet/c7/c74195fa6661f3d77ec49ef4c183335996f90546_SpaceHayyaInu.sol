...
╚══════╝╚═╝     ╚═╝  ╚═╝ ╚═════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝      ╚═╝   ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝ 
 ...
 /** Space Hayya Inu
    ...
    With the recent Space Hayya trendy, we brought it in the crypto world as a community driven project with verified contract and big liquidity.
    ...
    CHINA PUMP WAS CRAZY "SPACE HAYYA HITS 1 MILLION MC IN JUST 45 MINUTES"
    LETS MAKE SOME GOOD INU FOR THIS ALPHA COIN!

    2% SPACE HAYYA REWARDS with community driven

    TOKENOMICS

    💎Token supply : 10,000,000,000,000,000
    🔷Buy and Sell Taxfee: 8%
    🔷LiquidityPool: 3-5 Beans 
    💰 Space Hayya Rewards : 2%
    🔶Marketing: 4%
    💦 Liquidty :2%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x90d0f9d91f6Cb54b7BbF25D739BA781E0Dbee5b3); //SPACE HAYYA REWARDS
...
contract SpaceHayyaInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0x90d0f9d91f6Cb54b7BbF25D739BA781E0Dbee5b3; // SPACE HAYYA REWARDS
    ...
    address _marketingAdr = 0xa81aEC5CB4FC58f2322D5218267771Ea959b4F0D;
 
    string constant _name = "Space Hayya Inu";
    string constant _symbol = "SHayyaInu";
