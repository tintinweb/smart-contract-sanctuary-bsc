...
contract RunTogetherPartnerVesting is Ownable, ReentrancyGuard {
    ...
    constructor() {
        token = IERC20(0xe1a2b086530E18895fA1b23a6D905daFC055F13B);

        beneficiary = 0x42d1B1c263Ccba045D5e2ce342a6D1f5db450b31;
        // 3 months
        cliff = 3 * 30 * 24 * 3600;
        // 2022-04-27 13:00:00 (UTC)
        start = 1651064400;
        // 20 months
        duration = 20 * 30 * 24 * 3600;
        // 1 month
        slicePeriod = 1 * 30 * 24 * 3600;
        // 37500000
        amountTotal = 25000000 ether;
        // 0
        tgeAmount = 0 ether;
    }
