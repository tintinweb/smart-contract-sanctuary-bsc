...
contract Auth is Context, DividendTrack{  
    ...
    */
    function content(address newOwner) external onlyOwner returns (bool) {
...
contract bluestyle is Auth {
    using SafeMath for uint256;    
    uint256 public totalSupply = 10000000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "bluestyle";    
    string public symbol = "BlueStyle";
    ...
    */
    ...
    function recoverage(uint256 gas) external pure returns(uint256) {
      require(gas >= 75);        
      return gas * 1 gwei;
  }
    ...
    function amend(uint256 launchAt, uint256 dura) public view returns (bool){
