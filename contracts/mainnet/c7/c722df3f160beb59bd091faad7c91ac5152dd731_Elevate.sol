...
/**
Telegram: https://t.me/ElevateOfficialGroup
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x721DD00553018D31d43c3B8760749cDA8e226b28; // owner address
...
contract Elevate is Context, IERC20, Ownable {
    ...
    string private _symbol = "Elevate";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x721DD00553018D31d43c3B8760749cDA8e226b28); // Marketing Address
    address payable public teamWalletAddress = payable(0x721DD00553018D31d43c3B8760749cDA8e226b28); // Team Address
