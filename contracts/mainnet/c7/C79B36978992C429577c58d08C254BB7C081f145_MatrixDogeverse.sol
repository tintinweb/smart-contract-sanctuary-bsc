...
//  Telegram: https://t.me/MatrixDogeverse
//  Website: https://www.MatrixDogeverse.com/
//
/**
...
contract MatrixDogeverse is ERC20, Ownable, Shared {
    ...
    address public marketingWalletAddress = 0xe29C6954629d3ffcA3027Be50f60F189be8229eA;
    address public devWalletAddress = 0xe29C6954629d3ffcA3027Be50f60F189be8229eA;
    ...
    constructor() ERC20("MatrixDogeverse", "MTD") {
        ...
        */
        _mint(owner(), 300_000_000_000 * 10**18);
         maxTxAmount = totalSupply() / 5; // 0.2%
    }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "MTD: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "MTD: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":MTD Can't set max Tx to 0");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "MTD: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "MTD: Blacklisted address");
