        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x8020122891F60A7b9A11Bde373d5AFFDbBb14588), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        300000,//Su
        address(0x8020122891F60A7b9A11Bde373d5AFFDbBb14588),//
        address(0x8020122891F60A7b9A11Bde373d5AFFDbBb14588)//
    ){
    }
}