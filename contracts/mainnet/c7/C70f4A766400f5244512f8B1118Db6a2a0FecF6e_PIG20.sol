...
contract PIG20 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb8ee4A063CC55Af5dE7f68A8208D6592cA314445);
    address payable public teamWalletAddress = payable(0xb8ee4A063CC55Af5dE7f68A8208D6592cA314445);
    ...
    uint256 private _totalSupply =  66666666666666 * 10**_decimals;
    uint256 public _maxTxAmount =   6666666666666* 10**_decimals;     
    uint256 public _walletMax =     6666666666666 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 666666 * 10**_decimals; 
