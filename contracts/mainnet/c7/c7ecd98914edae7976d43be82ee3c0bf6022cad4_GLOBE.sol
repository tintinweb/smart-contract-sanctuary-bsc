...
contract GLOBE is ERC20, Ownable {
    ...
    constructor () ERC20("GLOBECHAIN TOKEN", "GLOBE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x8377197EC9470444FeA27F37b26625d1bF1760dE;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= 5, "Total Fees cannot be more than 5%");
