...
/** Soros vs Elon 
 ...
 Interesting. I wonder if those funding these organizations are fully aware of 
 what the organizations are doing.- Elon Tweet

 Launching very soon. it can be moonshot! 
*/

// telegram : https://t.me/SOROSvsELON
...
contract SOROSvsELON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xaacc9f323664138f4a74C5a036a899408A0E690A;
 
    string constant _name = "SOROS VS ELON";
    string constant _symbol = "$SVE";
