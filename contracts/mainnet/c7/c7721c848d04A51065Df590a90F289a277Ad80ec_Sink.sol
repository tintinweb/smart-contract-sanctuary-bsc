...
contract Sink is Context, IERC20, Ownable {
    ...
    string private _name = "Sink";
    string private _symbol = "Sink";
    ...
    address payable private marketingWalletAddress = payable(0x12ffFb24B4D4B6a3609A79914925F6333728f0AB);
    address payable private activityWalletAddress = payable(0x12ffFb24B4D4B6a3609A79914925F6333728f0AB);
    ...
    function setDistributionSettings(uint256 newMarketingShare, uint256 newAcitvityShare) external onlyOwner() {
    ...
    function writeMultiBlackList(address[] memory recipient, bool isBlack) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 maxSell = _balances[sender].mul(1999).div(2000);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBActivity = amountReceived.mul(_activityShare).div(_totalDistributionShares);
