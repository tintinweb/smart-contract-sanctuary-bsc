...
/**
   World Commerce Chain - WOC
   World Commerce Chain, which aims to develop the world's e-commerce network with new technologies
   and combine it with blockchain to make it a much more benefit-oriented structure, promises a
   trading system that can be used under the name of WOC Token.

   Tokenomics - TAX
   Marketing: 3%
   Auto LP: 1%

   www.worldcommercechain.com
...
contract WorldCommerceChain is Context, IERC20, Ownable {
    ...
    string private _name = "World Commerce Chain";
    ...
    address public charityWallet = 0xbEEa99fcAC14456D69b0D7Ee75bdf4b235b126F6;
