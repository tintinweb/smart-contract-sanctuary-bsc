...
contract TokenWithTax is ERC20, Ownable {  
    ...
    constructor() ERC20("Kurusetra Battle", "KRSTC") { 
         _mint(msg.sender, 10000000 * 10 ** decimals());  
         taxPercentage = 0;  
         maxTransfer = 10000000 * 10 ** decimals();  
    }  
    ...
    function setTax(uint256 percent) external onlyOwner {  
        ...
        emit taxSelected(percent); 
    }  
     
    function setMaxTransfer(uint256 amount) external onlyOwner {  
        require( amount * 10 ** decimals() >= 100000 * 10 ** decimals(), "You cannot place less than 100,000 tokens." );  
        maxTransfer = amount * 10 ** decimals();  
        emit maxTransferSelected(amount); 
    }  
    ...
    function setWalletsWithoutFee(address wallet) external onlyOwner {  
        ...
        emit walletsWithoutFeeIncluded(wallet); 
    }  
