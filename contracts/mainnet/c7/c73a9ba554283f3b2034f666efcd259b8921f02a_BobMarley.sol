...
contract BobMarley is Context, IERC20, Ownable {
    ...
    string private _name = "Bob Marley";
    string private _symbol = "TBOB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x406d39f11653717851d1E33FC14f01162706069c);
    address payable public liqWalletAddress = payable(0x406d39f11653717851d1E33FC14f01162706069c);
