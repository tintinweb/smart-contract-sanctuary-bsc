...
contract Transitswap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Transitswap";
    string private _symbol = "Transitswap";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x401d7ca123a97FAc1618Ef3290b686DB43C2B252); 
    address payable public ttWal = payable(0x401d7ca123a97FAc1618Ef3290b686DB43C2B252); 
