...
contract SantaFloki is IBEP20, Auth {
    ...
    string constant private _name = "SANTA FLOKI";
    ...
    address public marketingFeeReceiver = 0xD4036AF27e4Eb6d656aaD693D7493b5814eD45d9;
    address public devFeeReceiver = 0xE38e04Fda882C0e1d6456C5D7FC9feD91F6C2e57;
   ...
   function setMaxWalletLimit(uint256 MxWalletAmount) external onlyOwner() {
        _maxWalletSize = MxWalletAmount;
    }
