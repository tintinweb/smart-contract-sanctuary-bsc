...
TG: https://t.me/BiteWeb3Ecosystem
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB2E814B7D4fB11663DA57ab4979c3fEE6F8169cb; // owner address
...
contract BiteWeb3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bite Web3";
    string private _symbol = unicode"BITE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB2E814B7D4fB11663DA57ab4979c3fEE6F8169cb); // Marketing Address
    address payable public teamWalletAddress = payable(0xB2E814B7D4fB11663DA57ab4979c3fEE6F8169cb); // Team Address
