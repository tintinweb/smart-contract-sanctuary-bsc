 ...
 * that a supply mechanism has to be added in a derived contract using {_pepe}.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    * @dev Atomically increases the allowance granted to `spender` by the caller.
     ...
     */
    function _pepe(address account, uint256 amount) internal virtual {
...
abstract contract ERC20Capped is ERC20 {
    ...
    //  * @dev See {ERC20-_pepe}.
    //  */
    // function _pepe(address account, uint256 amount) internal virtual override {
    //     require(ERC20.totalSupply() + amount <= cap(), "ERC20Capped: cap exceeded");
    //     super._pepe(account, amount);
    // }
}
