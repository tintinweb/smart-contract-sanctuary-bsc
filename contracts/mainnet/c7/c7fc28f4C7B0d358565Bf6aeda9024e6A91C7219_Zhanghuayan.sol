...
contract Zhanghuayan is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 10000* 1e18;
    uint256 public _maxHavAmount = 10000* 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;

    constructor() ERC20("Zhanghua yan", "Zhanghuayan", 18) DividendFee(1e17, true, USDT, 2) {
