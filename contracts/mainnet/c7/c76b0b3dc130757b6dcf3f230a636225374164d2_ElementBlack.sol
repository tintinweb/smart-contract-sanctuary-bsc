...
contract OwnableELT is ContextELT {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableELT: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableELT: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ElementBlack is ContextELT, BinanceBNB, OwnableELT {
    ...
    string private _name = 'Element Black';
