...
contract SafeLuna is IERC20, Auth {
    ...
    string private constant  _name = "SafeLuna";
    string private constant _symbol = "SALUNA";
    ...
    address payable public marketingWallet = payable(0x242750F9E1287dd6f18Cc368759a0311c083dD64);
    ...
    //max buy of 1%
    uint256 private maxBuyTransaction = ( _totalSupply * 1 ) / 1000;
