...
contract LaunchpadNFT is ReentrancyGuard, Ownable, Pausable {
    ...
    event LaunchpadExecuted(address indexed user, uint launchIndex, uint monkeyboost);
     ...
     */
    constructor(IAnpanswapNFT _anpanswapNFT, IERC20 _dealToken, address _treasuryAddress) {
    ...
    */
    function addNewLaunch(uint32 _totalCount, uint _price, uint32 _level, uint _monkeyBoost, uint32 _maxToUser) public onlyOwner {
    ...
    function buyNFT(uint _launchIndex)public nonReentrant whenNotPaused {
        ...
        emit LaunchpadExecuted(msg.sender, _launchIndex, _launch.monkeyBoost);
    }
