...
contract TransparentUpgradeableProxy is IBEP20, Auth {
    ...
    string constant _name = "KatanaInu NFT";
    string constant _symbol = "KATA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 50000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x21E7ADe79EE6Ef6Dbce420D2782677Da792A7c9d;
