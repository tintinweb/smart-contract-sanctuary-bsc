...
contract BABYSHIBAPREDATOR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Shiba Predator";
    string private _symbol = "BQOM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C5c6e869423f77AfC7f005195371Dbc0dc52eB3); 
    address payable public buyBackWalletAddress = payable(0xdD7305Ffb4a7F64bf147618f27F70d8F90A3ba3C); 
