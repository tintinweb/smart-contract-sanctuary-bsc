...
contract APEN is IBEP20, Auth {
    ...
    string constant private _name = "APEN Earn";
    string constant private _symbol = "APEN";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function blacklist(address _address, bool _value) public authorized{
