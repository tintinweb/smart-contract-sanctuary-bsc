...
contract TmntToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 3888 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 30 * 10**_decimals;

        fundAddress = 0x5A33451Db304576414fcC48Aa4B6CC38D7b36dff;
        devAddress = 0x5A33451Db304576414fcC48Aa4B6CC38D7b36dff;
