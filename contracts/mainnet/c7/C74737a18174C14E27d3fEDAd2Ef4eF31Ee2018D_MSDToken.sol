...
contract MSDToken is IERC20, Ownable {
    ...
    uint256 public _lplockFee = 3;
    
    address public _lplockAddress= 
        address(0x7919B5A391be44313a0Cb33A5bFfeCA4CeEe780b);
    ...
    function _tokenBuyTransferFee(
		...
		if(fee){
		    ...
		    _rOwned[recipient] = _rOwned[recipient].add(rAmount.div(100).mul(96));
    ...
    function _tokenSellTransferFee(
		...
		if(fee){
			...
			uint256 destroyfee = tAmount.div(1000).mul(_destroyFee.add(40).sub(ratesum));
		    ...
		    _takeTransfer(
    			sender,
    			_lplockAddress,
    			tAmount.div(100).mul(_lplockFee),
    			currentRate
    			);
		    
		    _rOwned[recipient] = _rOwned[recipient].add(rAmount.div(100).mul(91));
