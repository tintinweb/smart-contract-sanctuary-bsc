...
/**    
🔥🔥🔥 XRP Burn Reflect 🔥🔥🔥                                                                             
Telegram :🔥🔥🔥 XRP Burn Reflect 🔥🔥🔥
Website : 🔥🔥🔥 XRP Burn Reflect 🔥🔥🔥
*/
...
contract XrpBurnReflect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    XrpBurnReflectDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Xrp Burn Reflect", "XBR") {
        marketingWallet = payable(0x096eece29201d85D99a93b2B609302d7c9bE7138);
        devWallet = payable(0x096eece29201d85D99a93b2B609302d7c9bE7138);
        ...
        dividendTracker = new XrpBurnReflectDividendTracker(
            payable(this),
            router,
            0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE,
            "XrpBurnReflectTRACKER",
            "XRPBURNREFLECTLASSICTRACKER"
        );
...
contract XrpBurnReflectDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    XrpBurnReflect public XrpBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        XrpBurnReflectContract = XrpBurnReflect(mainContract);
    ...
    function _transfer(
        ...
        require(false, "XrpBurnReflect_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "XrpBurnReflect_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main XrpBurnReflect contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(XrpBurnReflectContract);

            uint256 prevBalance = XrpBurnReflectContract.balanceOf(address(this));
            ...
            {
                uint256 received = XrpBurnReflectContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    XrpBurnReflectContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
