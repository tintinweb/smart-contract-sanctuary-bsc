...
contract FreeHareToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FreeHare";
    string private _symbol = "FreeHare";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x083dF661a730A1948a9E7912D0aD4E4e3DF230B9); 
    address payable public BurnedWalletAddress = payable(0x083dF661a730A1948a9E7912D0aD4E4e3DF230B9); 
