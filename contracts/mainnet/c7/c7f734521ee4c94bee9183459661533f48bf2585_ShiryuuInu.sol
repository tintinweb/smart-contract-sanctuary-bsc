...
contract ShiryuuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiryuu Inu"; // 
    string private constant _symbol = "SHIRYUU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3D86ae50CfEeaB8eDB441cbBEe00AfeB1f8B9284;
