...
contract GOLDSHIBAINU is Context, IERC20, Ownable {
    ...
    string private _name = "GOLD SHIBA INU";
    string private _symbol = "GOLDSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4CF11727e65D0A8bCf801BaD9AC5feA3b6F2d76D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x4CF11727e65D0A8bCf801BaD9AC5feA3b6F2d76D); // buyback Address
