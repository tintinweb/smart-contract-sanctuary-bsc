...
contract DeMoon is IBEP20, Auth {
    ...
    address DEV = 0xad22Bd7384372bda78bd0665824C198C0858FBf9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != buybackFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver){
