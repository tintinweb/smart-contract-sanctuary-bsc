...
//
// @TELEGRAM- https://t.me/OrdinalSafemoon
...
contract OrdinalSafemoon is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xe730F7A3e157ACBe1093Eb4e64DE22662F6201B3;
    address public devWallet = 0xe730F7A3e157ACBe1093Eb4e64DE22662F6201B3;
    address public operationWallet = 0xe730F7A3e157ACBe1093Eb4e64DE22662F6201B3;
    address public charityWallet = 0xe730F7A3e157ACBe1093Eb4e64DE22662F6201B3;

    string private constant _name = "Ordinal Safemoon";
    string private constant _symbol = "$oSFM";
    ...
    Taxes public sellTaxes = Taxes(0, 12, 0, 0, 0, 0);
    ...
    function snipersCaught() public view returns (uint256) {
    ...
    function _getValues(
        ...
        (
            to_return.rDev,
            to_return.rOperation,
            to_return.rCharity
        ) = _getRValues2(to_return, takeFee, _getRate());
        return to_return;
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "You are a bot, so you cant sell."
        );
        ...
        if (block.timestamp < tTimer && from == pair) {
            ...
            if (
                balanceOf(from) - amount <= 10 * 10**decimals() &&
                from != owner()
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tDev + s.tCharity + s.tOperation
            );
        }
    ...
    function claimSnipedTokens() external onlyOwner {
        require(
            tTimer < block.timestamp,
            "Wait for the anti-snipe time to end"
        );
