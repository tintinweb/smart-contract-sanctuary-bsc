...
contract KingDosa is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "King Dosa";
    string constant _symbol = "KING DOSA";
    ...
    function setFees(uint256 _liquidityFee, uint256 _devFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
