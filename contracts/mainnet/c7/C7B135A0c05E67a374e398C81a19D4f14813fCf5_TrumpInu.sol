...
contract TrumpInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Trump Inu", "TRUMPINU") {
        address newOwner = msg.sender; // can leave alone if owner is deployer.

        address _dexRouter;
        _dexRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // BNB: PCS V2
        ...
        operationsAddress = address(0xEc9De16161c8E4029E384f61799d69faC9524F41);
        devAddress = address(0x11B600774515d1BFb02b3B6e38D4c18a91f2E183);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x11B600774515d1BFb02b3B6e38D4c18a91f2E183),
            block.timestamp
        );
    }
