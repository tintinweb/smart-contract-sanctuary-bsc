...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public CEEK = IBEP20(0xe0F94Ac5462997D2BC57287Ac3a3aE4C31345D66);
    ...
    uint256 public minDistribution = 1 * (10 ** 16); // 1 CEEK minimum auto send
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CEEK.balanceOf(address(this));
        ...
        uint256 amount = CEEK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CEEK.transfer(shareholder, amount);
...
contract BabyCeek is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby CEEK";
    string constant _symbol = "bCEEK";
    ...
    uint256 public _maxWallet = 4 * (10**10) * (10 ** _decimals);
