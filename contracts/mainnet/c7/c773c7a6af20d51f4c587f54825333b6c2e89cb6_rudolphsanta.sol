...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x318d434c50876c6949098Bf0D408E0648d749a71; // owner address
...
contract rudolphsanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rudolph Santa";
    string private _symbol = "RUSAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7fb6E1d4F959FDA5c8723AC9540bd3643EfeC8cd); // Marketing Address
    address payable public teamWalletAddress = payable(0x2552Bb93DED948e2121b5045443d7ee4C4f7Fe33); // Team Address
