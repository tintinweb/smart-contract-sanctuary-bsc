...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    //这里填入你的营销地址
    address public marketAddr = 0xC71379758a7F814be1f600335Bc2cD50fe5dC703 ;
...
contract Martiandoge  is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 3000000000000 * 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;
    uint256 public BurnRate = 2;

    constructor() ERC20("Martiandoge ", "MAD" , 18) DividendFee(1e17, true, USDT, 2) {
