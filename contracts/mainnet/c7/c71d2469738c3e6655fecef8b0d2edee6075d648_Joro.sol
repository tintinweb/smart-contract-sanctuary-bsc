...
// Find out more about JORO Token at http://joro.dj
...
contract Joro is Context, IERC20, Ownable,AccessControl {
    ...
    uint256 private blocksToBlacklist = 120;
    ...
    string private constant _name = "JORO";
    ...
    constructor (address mktg, address lp, address development) {
    ...
    function setBuyFee(uint256 buyMarketingFee, uint256 buyLiquidityFee, uint256 buyDevelopmentFee) external onlyOwner {
        require(buyMarketingFee + buyLiquidityFee + buyDevelopmentFee <= 30, "Must keep buy taxes below 30%");
        _buyMarketingFee = buyMarketingFee;
        _buyLiquidityFee = buyLiquidityFee;
        _buyDevelopmentFee = buyDevelopmentFee;
    }

    function setSellFee(uint256 sellMarketingFee, uint256 sellLiquidityFee, uint256 sellDevelopmentFee) external onlyOwner {
        require(sellMarketingFee + sellLiquidityFee + sellDevelopmentFee <= 30, "Must keep sell taxes below 30%");
    ...
    function removeAllFee() private {
        if(_buyMarketingFee == 0 && _buyLiquidityFee == 0 && _buyDevelopmentFee == 0  && _sellMarketingFee == 0 && _sellLiquidityFee == 0 && _sellDevelopmentFee == 0) return;
    ...
    function _takeFees(address sender, uint256 amount, bool isSell) private returns (uint256) {
        ...
        if(tradingActiveBlock + blocksToBlacklist >= block.number){
            ...
            if (isSell) {
                ...
                developmentFee = _sellDevelopmentFee;
            } else {
                mktgFee = _buyMarketingFee;
                liqFee = _buyLiquidityFee;
                developmentFee = _buyDevelopmentFee;
            }
        }
        ...
        tokensForDevelopment += fees * developmentFee / _totalFees;
    ...
    function _getTotalFees(bool isSell) private view returns(uint256) {
        if (isSell) {
            return _sellMarketingFee + _sellLiquidityFee + _sellDevelopmentFee;
        }
        return _buyMarketingFee + _buyLiquidityFee + _buyDevelopmentFee;
    }
