...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF68a692A1aeF4cc27a42951330C46aF0d6a4bC09; // owner address
...
contract PSYOP is Context, IERC20, Ownable {
    ...
    string private _name = "PSYOP INU";
    string private _symbol = "PSYOP";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xF68a692A1aeF4cc27a42951330C46aF0d6a4bC09); // Marketing Address
    address payable public teamWalletAddress = payable(0xF68a692A1aeF4cc27a42951330C46aF0d6a4bC09); // Team Address
