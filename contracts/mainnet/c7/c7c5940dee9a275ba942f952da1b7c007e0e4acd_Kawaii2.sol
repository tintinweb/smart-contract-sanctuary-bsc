...
contract Kawaii2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kawaii 2.0";
    string private _symbol = "Kawaii2";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xfeCDd91CcFdDD4846D1b21cA86ADad34d378293d); // Marketing Address A9
    address payable public TeamWallet = payable(0x9d47E1Ee52239B3D044111be8e34D3ceB03Bd454); // Team Address
