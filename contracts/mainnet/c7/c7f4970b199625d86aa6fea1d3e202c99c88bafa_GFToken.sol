...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x355bd3388E90A010b6E35de5048E29A587bdd5ed;
...
contract GFToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0xdaC7cE86e7844F7d0d8B6F72bb53BFa99ef88888),
    
        address(0x58D51492C8e5C5603a0d64284c6490DA608B8888)
    ){
