...
contract VisionScanAi is BEP20, Ownable {
    ...
    address public marketingWallet = 0xeDE6F5600681cD9349865A2011e5Ddc4319909A1;
    ...
    constructor() BEP20("VisionScanAi", "VSAI") {
        _tokengeneration(msg.sender, 100e7 * 10**decimals());
