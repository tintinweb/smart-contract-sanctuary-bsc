...
contract JieFengDOGE is IBEP20, Auth {//记得改你的币的名字，部署合约也是部署这个名字的文件
    
    using SafeMath for uint256;

    string constant _name = "JieFengDOGE";
    string constant _symbol = "JieFengDOGE";
    ...
    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);//数量
    ...
    uint256 public liquidityFee = 0;//流动费，买卖都是4，建议这三个费用最初改为0，后面上链改
    uint256 public marketingFee = 0;//营销地址费用
    uint256 public rewardsFee = 0;//分红的费用
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;  //营销钱包地址
        anothermarketingWallet = 0x2a00d63Ee02b3a7Cf0b4ec921a30B68676B87a1e;//修改你自己的
