...
contract CryptoPump is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Crypto Pump";
    string private constant _symbol   = "Crypto Pump";
    ...
    uint256 public  _maxTxAmount     = _tTotal * 700 / 10000;
    uint256 public  _minTokenBalance = _tTotal / 700;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 700 / 10000; // 7% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x65ec2ceC606365ab4f26e429a67612840c6E6e99;
        _marketingWallet = 0x65ec2ceC606365ab4f26e429a67612840c6E6e99;
