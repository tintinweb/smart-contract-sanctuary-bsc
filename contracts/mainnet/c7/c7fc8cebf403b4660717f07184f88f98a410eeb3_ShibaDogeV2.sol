...
contract ShibaDogeV2 is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 584_457 * 10**9;
    uint256 public maxBuyLimit = 200_000_000 * 10**9;
    uint256 public maxSellLimit = 200_000_000 * 10**9;
    uint256 public maxWalletLimit = 200_000_000 * 10**9;

    uint256 public genesis_block;

    address public marketingWallet = 0x8b4c0362e203b726E597a458bC2EB186b64eAdCE;
    address public devWallet = 0x8b4c0362e203b726E597a458bC2EB186b64eAdCE;
    address public teamWallet = 0x8b4c0362e203b726E597a458bC2EB186b64eAdCE;

    string private constant _name = "Shiba Doge V2";
    string private constant _symbol = "$SDV";
    ...
    Taxes public sellTaxes = Taxes(0, 95, 0, 0, 0);
    Taxes public highTaxes = Taxes(0, 20, 5, 0, 0);
