...
contract KFC   is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 8888 * 10**9;
    ...
    string private constant _name = "KFC ";
    string private constant _symbol = "KFC";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xE185C87704dC318c3a8F920bFd797fe36ce8AFDa);
    address payable private _marketingAddress = payable(0xE185C87704dC318c3a8F920bFd797fe36ce8AFDa);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 99, "Redis cannot be more than 97.");
