...
contract StakePool is StakedTokenWrapper, RewardDistributionRecipient {
    ...
    constructor(address token, address rewardsDistributor)
        StakedTokenWrapper(token)
    {
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            IERC20(stakedToken).safeTransfer(msg.sender, reward);
    ...
    {
        IERC20(stakedToken).safeTransferFrom(msg.sender, address(this), reward);
