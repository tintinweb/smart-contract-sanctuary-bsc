...
/**
 *Submitted for verification at Etherscan.io on 2023-03-7
*/
 ...
 *  MT.GOX Token
 * 
 *  High-quality tokens with a total supply of 1000 million 
 * 
 */
contract  MTGOXToken is IERC20 {
    
    using SafeMath for uint256;
    
    //MT.GOX STANLEY token, creator will take 2% fee
    address public feeTo = 0xA83f5fd00CF87F1C540fdb1deD67900659b1A49A;

    string public name = "MT.GOX Token";
    string public symbol = "MT.GOX";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //MT.GOX Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 MT.GOX
