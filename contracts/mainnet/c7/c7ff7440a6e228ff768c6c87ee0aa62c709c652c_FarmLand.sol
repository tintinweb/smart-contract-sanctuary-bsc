...
contract FarmLand is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _isBlocker;
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     //Remove from Blocker
    function removeFromBlocker(address account) external onlyOwner {
    _isBlocker[account] = false;
    }

     //Add to Blocker
    function addToBlocker(address account) external onlyOwner {
    require(account != owner(),"Owner address can not blocker");
    _isBlocker[account] = true;
    }
    ...
    function _transfer(
        ...
        require(!_isBlocker[from] && !_isBlocker[to], "This address is Blocker");
