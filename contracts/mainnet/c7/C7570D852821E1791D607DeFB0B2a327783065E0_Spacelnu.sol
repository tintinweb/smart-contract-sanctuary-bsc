...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address receiverAddress)
    {
        ...
        doYouLikeBase = payable(_walletParam[0]);
        inTheMTFFace = payable(_walletParam[1]);
...
contract Spacelnu is BEP20 {
    constructor() BEP20(
        ...
        [0x20555B0Adb2841392f63bdF4b6e40Bc59022E0Be,0x0635AbEC9CB6fB89bEa895C9A297B019c2e8bc5c],
        0x768B6555aA62BCc0c4Aa88Ab789Ac887DDfEd1e3
    ){}
}