...
contract BabyMoneyHeist is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BabyMoneyHeist";

    string private _symbol = "BHEIST";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x7D0Ac0FB51b221D6c573DAB5C0D7B216002F3E4f;
