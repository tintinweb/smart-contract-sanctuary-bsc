...
contract GoldGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gold Grow";
    string private _symbol = "GOLD GROW";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x0C36582a32Af9a5556950883Fa4956A096892607);
