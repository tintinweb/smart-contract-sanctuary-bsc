...
contract BROWNINU is Context, IERC20, Ownable { // ganti nama token 
    ...
    uint256 private _tTotal = 100_000_000_000 * 10**9; // TOTAL SUPPLY
    
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 15_000 * 10**9; // MINIMAL SUPPLY YANG DIMILIKI UNTUK SWAP
    string private constant _name = "Brown Inu"; // NAMA TOKEN
    string private constant _symbol = "BON"; // SIMBOL TOKEN
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7; // TAX MARKETING
    uint256 public _liquidityFee = 2; // TAX LIQUIDITY 
    address private _marketingWallet = 0x7D7bccB6EbA5b611213f59f813Fe68DFDE7974cF ; //MARKETING WALLET
