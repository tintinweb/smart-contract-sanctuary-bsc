...
contract BYDToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BYD";
    string private _symbol = "BYD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x606ee8A7198BA309c3609B3856dab8185d187843); 
