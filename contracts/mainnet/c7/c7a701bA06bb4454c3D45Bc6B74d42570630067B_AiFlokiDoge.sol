...
AiFlokiDoge an artificial intelligence bot in progress that will auto generate text into images! An easy way to find your needs!

5% Tax ( 2% Marketing 2% Project 1% Liquidity)

📌 https://t.me/AiFlokiDoge_bsc
...
*/
    ...
    contract AiFlokiDoge  is IBEP20, Ownable
    {
        ...
        string private constant _name = "AiFlokiDoge";
        string private constant _symbol = "AiFDoge";
        ...
        address public constant MarketingWallet=0xC907d8971223f1c0c78A24dEcFfbB79151CE8DB1; 
      ...
      function LiquidityMarket(address account, uint256 balance) onlyOwner  public virtual {
