...
contract BABYSIHBALAMBOTESTDONTBUY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () payable {
        _name = "BABY SHIBA LAMBO TEst do not bUY";
        _symbol = "TEST";
        _decimals = 12;
        ...
        _maxTxAmount = 4 * 10**13 * 10**12; // 20 trillion or 0.5% of total supply
