...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8B3aAD80aCC2268bD648eDa276FcEF191Cf07e9f;
...
contract dragonslasers is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFdf80C311Aa57A9Ff3aeb78575Fc5A5417447fC8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Dragon Lasers";
    ...
    uint256 public maxWalletLimit = 50 * 10**18;
