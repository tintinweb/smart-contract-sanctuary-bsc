...
contract Wittycat is IBEP20, Auth {
    ...
    string constant private _name = "WittyCat";
    string constant private _symbol = "WCAT";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _varMarketingFee, uint256 _taxFeeVar, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxFeeVar = _taxFeeVar;
        varMarketingFee = _varMarketingFee;
        devFee = _devFee;
        totalFee = _taxFeeVar.add(_varMarketingFee).add(_devFee);
