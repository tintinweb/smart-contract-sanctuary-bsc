...
contract SquidSir is Context, IERC20, Ownable {
    ...
    string private _name = "SquidSir";
    string private _symbol = "SquidSir";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc88f05b8d2bb402471ad3793Cedc3eF07433aD25));
        __wal = payable(address(0xc88f05b8d2bb402471ad3793Cedc3eF07433aD25));
