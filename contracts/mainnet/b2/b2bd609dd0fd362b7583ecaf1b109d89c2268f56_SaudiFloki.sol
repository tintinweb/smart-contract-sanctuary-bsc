...
library Address{
 ...
 contract SaudiFloki is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xCF4C4A716991c33653037d5aaaD1D132e6558A33;
    address public donationWallet = 0xCF4C4A716991c33653037d5aaaD1D132e6558A33;

    string private constant _name = "SaudiFloki";
    string private constant _symbol = "SaudiFloki";
    ...
    Taxes public taxes = Taxes(1, 5, 2, 1);
    Taxes public sellTaxes = Taxes(1, 5, 2, 1);
