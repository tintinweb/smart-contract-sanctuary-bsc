 ...
 *   2) Choose one of the tariff plans button
 ...
 *   - Minimal deposit: 0.05, no maximal limit
...
contract BNBHOLD {
	...
	constructor(address payable marketing, address payable dev, address payable project, uint256 startDate)  {
		...
		startUNIX = startDate; // 1648238400 // Date and time (GMT): Friday, 25 March 2022 20:00:00
