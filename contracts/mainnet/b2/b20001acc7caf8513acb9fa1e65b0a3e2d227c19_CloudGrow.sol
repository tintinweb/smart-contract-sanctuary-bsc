...
https://t.me/CloudGrow

Grow your Cloudchat holdings with CloudGrow! 4% Cloudchat Rewards, 4% Marketing and 2% LP! 10% Tax both ways.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x0c2bfA54d6d4231b6213803dF616a504767020eA); //CURRENT REWARD
    IBEP20 PRWDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //PREVIOUS REWARD
    address REWARDS;
    IRouter router;
...
contract CloudGrow is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'CloudGrow';
    ...
    uint256 public swapThreshold = ( _tTotal * 800 ) / 100000; // .80% of total supply
