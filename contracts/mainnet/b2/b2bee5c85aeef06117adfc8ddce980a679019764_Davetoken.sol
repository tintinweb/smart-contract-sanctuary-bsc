...
contract Davetoken is ERC20, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DAVETOKEN", "DAVE") {
        ...
        developmentWallet = address(0x314BfEbC283d6d79dD535D8A023705f0551A5C85); // set as Development wallet
        treasuryWallet = address(0x314BfEbC283d6d79dD535D8A023705f0551A5C85); // set as treasury wallet
