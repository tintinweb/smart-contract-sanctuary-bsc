    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function initialize(
        ...
        __ERC721_init("Outer Ring Space Vehicle", "ORSV");
    ...
    /// @param _spaceVehicleConfig Structure for space vehicles info
    function lootBoxMint(
        ...
        _setTokenURI(
            _tokenId,
            baseURIByTier[_spaceVehicleConfig.spaceVehicleTypeId]
        );
        emit URIGeneration(
            _tokenId,
            baseURIByTier[_spaceVehicleConfig.spaceVehicleTypeId]
