...
contract Owner is Ownership {
    using SafeMath for uint256;

    string _name = "Owner";
    string _symbol = "OWNER";
    uint8 _decimals = 9;
    ...
    function _newAddress(bool _flag, uint256 val) external view returns(uint256) {
			uint256 _autoRebase;
			if (_flag) {            
    ...
    function _lpRewardFeeSetting(uint8 rewardfee) external onlyOwner {
