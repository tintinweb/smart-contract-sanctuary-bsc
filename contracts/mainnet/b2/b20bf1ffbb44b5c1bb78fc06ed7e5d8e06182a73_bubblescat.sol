...
contract bubblescat is Context, IERC20, Ownable {
    ...
    string private constant _name = "https://t.me/bubblescatoffical"; // 
    string private constant _symbol = "BSCAT"; //    
