...
/*
Bullish Name Bullish Community
join our telegram : https://t.me/BooShiba
...
contract BooShiba is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BooShiba";
    string private constant _symbol = unicode"BOOSHIB";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = (10**9) * 10**_decimals;

    address payable private DevWallet = payable(0x2fB149A4C176eAD3abfCe7a70615Aa79dFE2E39D);
    address payable private MarketingWallet = payable(0x2fB149A4C176eAD3abfCe7a70615Aa79dFE2E39D);
