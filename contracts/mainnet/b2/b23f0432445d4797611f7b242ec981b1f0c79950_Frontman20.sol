...
/**
Telegram : https://t.me/frontman2bsc
*/
...
contract Frontman20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Frontman 2.0";
    string private constant _symbol = "Frontman2.0";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 3000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0xF365D707F45BAdf778Ae218C6d2A225Ef35f0f16);
