...
contract Shibnoobi is IERC20, Ownable {
    ...
    constructor () {
        ...
        _tTotal = 20e21 * 10 ** _decimals;
        _rTotal = MAX - (MAX % _tTotal);

        _rOwned[_msgSender()] = _rTotal / 1725 * 100;
        _taxFeeBuy = 20;
        _marketingFeeBuy = 25;
        _liquidityFeeBuy = 30;
        _burnFeeBuy = 10;
        ...
        _taxFeeSell = 30;
        _marketingFeeSell = 90;
        _liquidityFeeSell = 50;
        _burnFeeSell = 20;

        _taxFeeTransfer = 10;
        _marketingFeeTransfer = 25;
        _liquidityFeeTransfer = 30;
        _burnFeeTransfer = 10;

        _feeDenominator = 1000;
        
        minETHValueBeforeSwapping = 1 * 10 ** 18;

        marketingWallet = 0xF70Ff5422d2311920922100D779918b0DBE8f090;
        // 0xF70Ff5422d2311920922100D779918b0DBE8f090
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF70Ff5422d2311920922100D779918b0DBE8f090); //Mainnet BSC
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xF70Ff5422d2311920922100D779918b0DBE8f090); //Testnet BSC
        address router = 0xF70Ff5422d2311920922100D779918b0DBE8f090;
        ...
        _allowances[0x941f397b24fAcE10a39ffE97259F9Cd9C4EB12c1][router] = MAX;
        excludeFromReward(0x000000000000000000000000000000000000dEaD);
        excludeFromReward(address(0));
        bridgeAddress = 0x5a86c68329e3eABaAC320335339f268DD25d5a16;
        _limits[bridgeAddress].isExcluded = true;
        _isExcludedFromFee[bridgeAddress] = true;
        _rOwned[bridgeAddress] = _rTotal - _rOwned[_msgSender()];
        excludeFromReward(bridgeAddress);
        emit Transfer(address(0), _msgSender(), _tTotal / 1725 * 100);
    }
    ...
    function includeInReward(address account) external onlyOwner() {
        require(account != burnWallet && account != bridgeAddress, "Don't include it, it's not a good idea");
    ...
    function setFeeDenominator(uint256 newValue) external onlyOwner {
        ...
        uint256 buyTotal = _marketingFeeBuy + _taxFeeBuy + _liquidityFeeBuy + _burnFeeBuy;
        uint256 sellTotal = _marketingFeeSell + _taxFeeSell + _liquidityFeeSell + _burnFeeSell;
        uint256 transferTotal =
        _marketingFeeTransfer + _taxFeeTransfer + _liquidityFeeTransfer + _burnFeeTransfer;
