...
contract oinkinu is Context, IERC20, Ownable {
    ...
    string private _name = "OINK INU";
    string private _symbol = "OINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF27d8D0700cedFd8bBa30D6C4CfCa59f46FAfdD2); 
    address payable public teamWalletAddress = payable(0xeB60a407b29666f88422aEF56333Ce9D1B030f37); 
