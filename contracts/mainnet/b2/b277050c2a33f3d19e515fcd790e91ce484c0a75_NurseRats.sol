...
contract NurseRats is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nurse Rats"; // 
    string private constant _symbol = "NRATS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x3BEC2dC107aD4042594992f17F2218f98f4593f1;
