...
/**
INCINERATOR SmartContract
Visit our Telegram and become part of the INCINERATOR family! We are here to BURN THIS SUPPLY!
*/
...
contract INCINERATOR is ERC20, Ownable {
    ...
    INCINERATORDividendTracker public dividendTracker;
    ...
    constructor() ERC20("INCINERATOR", "BURNT") {
        ...
        dividendTracker = new INCINERATORDividendTracker(
            payable(this),
            router,
...
contract INCINERATORDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    INCINERATOR public INCINERATORContract;
    ...
    constructor(
        ...
        defaultToken = token;
        INCINERATORContract = INCINERATOR(mainContract);
    ...
    function _transfer(
        ...
        require(false, "INCINERATOR_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "INCINERATOR_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main INCINERATOR contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(INCINERATORContract);

            uint256 prevBalance = INCINERATORContract.balanceOf(address(this));
            ...
            {
                uint256 received = INCINERATORContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    INCINERATORContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
