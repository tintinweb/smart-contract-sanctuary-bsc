...
contract Presale_Trueverse is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public  RATE = 29410; // Number of tokens per 1 BNB : price = 0.01 usd per token
  uint256 public  CAP = 40000; // Cap in BNB
  uint256 public  START = 1662877800; // Sun Sep 11 2022 12:00:00 GMT+0530 (India Standard Time)
  uint256 public  DAYS = 60; // 60 0Days 
  // The minimum amount of Wei you must pay to participate in the preslae
  uint256 public  MinPurchase = 1 * 1e15; /** 0.001 BNB  **/

  
  uint256 public constant initialTokens =  120000000 * 10**18; // 20% of total tokens available
