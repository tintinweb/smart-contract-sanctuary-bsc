...
contract  YES is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF9B342046B7AF6F610aEaa7ae1026c59FeDFa5c6);
    address payable public teamWalletAddress = payable(0x2963d8a055b75E1ef2Dcb49e5FbA0353C6A9Ff0a);
    ...
    uint256 private _totalSupply =  960000000 * 10**_decimals;
    uint256 public _maxTxAmount =   900000000 * 10**_decimals; 
    uint256 public _walletMax =     900000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 900000000 * 10**_decimals; 
