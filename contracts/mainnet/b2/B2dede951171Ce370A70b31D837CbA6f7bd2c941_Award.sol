...
contract HMC is IERC20, Ownable {
    ...
    uint256 public _fundFee1 = 2;
    uint256 public _fundFee2 = 1;
    uint256 public _fundFee3 = 1;
    uint256 public _fundFee4 = 1;
    uint256 public _fundFee5 = 3;
    uint256 public _fundFee6 = 4;
    uint256 public _fundFee7 = 8;

    
    address private fundAddress = address(0xD4749644C56FbA3996B8d7ffC55717fEf4B00e30);
    address private fundAddress1 = address(0x091cc9cdD1FD4C139873bba5E66281583f53983c);
    address private fundAddress2 = address(0xEAE29c3cf40d6FD5E8a5e1Cc1445D056491dDc86);
    address private fundAddress3 = address(0xe3e04B10988A89D10cF6D35dB7B4CD8e7a8bFFDd);
    address private fundAddress4 = address(0xb24c28ec86E8F232dB92d34b1777bB57ea0eBAc1);
    address private fundAddress5 = address(0xECaab9Be7fcD683FCC970aE3C4629c48c263F809);
    address private fundAddress6 = address(0x5310C4c7F025F83E437c22816343E244C0e87Aa8);
    address private fundAddress7 = address(0x2D71ebBa6F8464c8e09aF953CdF9A3BcDd614f9B);
    ...
    constructor() {
        ...
        address tokenReceiver = address(0x6BC0B6404a0D078F2B753222293157a15812ef07);
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                rate = (_fundFee + _fundFee1 + _fundFee2 + _fundFee3 + _fundFee4).mul(multiple);
                ...
                rate = (_fundFee + _fundFee1 + _fundFee2 + _fundFee3 + _fundFee4 + _fundFee5 + _fundFee6).mul(multiple);
            }else{
                _takeTransfer(
                    sender,
                    fundAddress7,
