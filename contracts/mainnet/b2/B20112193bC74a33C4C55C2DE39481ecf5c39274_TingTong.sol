...
contract TingTong is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "TingTong";
    string private constant _symbol = "TingTong";
    ...
    uint256 public liqdittax = 0;
    uint256 public maxtax = 1;
    uint256 public devertax = 0;
    ...
    constructor() {
        ...
        DevelopmentWallet = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;
        MarketingWallet = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298;
        ...
        NetFee = liqdittax.add(maxtax).add(devertax);
        totalfees = NetFee;
    ...
    function ReductionOfCharge(
        ...
        liqdittax = newLPfee;
        maxtax = newmarketFee;
        devertax = newDevelopmentFee;

        NetFee = liqdittax.add(maxtax).add(devertax);
        totalfees = NetFee + extras;
    }
    ...
    function swapBackAndPair() internal lockTheSwap {
        ...
        uint256 totalETHFee = NetFee.sub(liqdittax.div(2));

        uint256 amountETHLiquidity = amountETH
            .mul(liqdittax)
            .div(totalETHFee)
            .div(2);
        uint256 amountETHMarketing = amountETH.mul(maxtax).div(
            totalETHFee
        );
        uint256 amountETHDev = amountETH.mul(devertax).div(totalETHFee);
