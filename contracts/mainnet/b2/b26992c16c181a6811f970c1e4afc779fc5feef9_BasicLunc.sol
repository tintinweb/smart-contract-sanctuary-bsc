...
contract BasicLunc is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xc52a8640939539Fb97859760B73121CEab013C26;

    string constant _name = "BasicLunc";
    string constant _symbol = "BasicLunc";
