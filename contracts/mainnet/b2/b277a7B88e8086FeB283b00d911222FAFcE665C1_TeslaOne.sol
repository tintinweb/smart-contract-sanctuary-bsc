...
contract TeslaOne is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeslaOne";
    string private _symbol = "TeslaOne";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8615a018AD546ae65B37852Cc9A4d61f05eafBDF); 
    ...
    uint256 private _totalSupply = 100 *  10**16 * 10**_decimals;
