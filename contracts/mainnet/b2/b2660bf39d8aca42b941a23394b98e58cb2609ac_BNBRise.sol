...
contract BNBRise is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNBRise";
    string private constant _symbol = "BNBR";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  888888888  * 10**_decimals;

    uint256 public _maxWalletAmount = 88888888 * 10**_decimals;
    uint256 public _maxTxAmount = 8888888 * 10**_decimals;
    uint256 public swapTokenAtAmount = 88888888 * 10**_decimals;
