...
contract CIRCLE is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_DAO_WALLET_DISTRIBUTION = 500 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the CIRCLE ERC-20 contract.
     */
    constructor() public ERC20("Circle Finance", "CIRCLE") {
        // Mints 400 CIRCLE to contract creator for initial pool setup
        _mint(msg.sender, 400 ether);
    }

    /**
     * @notice Operator mints CIRCLE to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of CIRCLE to mint to
    ...
    function distributeReward(
        ...
        for(uint256 i = 0; i < _genesisPools.length; i++) {
            ...
            if (i == _genesisPools.length - 1) {
                ...
                stake = INITIAL_GENESIS_POOL_DISTRIBUTION.mul(_poolsStakes[i]).div(10000);
            }
