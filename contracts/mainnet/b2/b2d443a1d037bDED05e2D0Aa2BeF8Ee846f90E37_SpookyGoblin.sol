...
contract SpookyGoblin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Goblin";
    string private constant _symbol = "SPKYGBLN";
