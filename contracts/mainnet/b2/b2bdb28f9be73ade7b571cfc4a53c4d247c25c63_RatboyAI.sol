...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x442ab72617D4B3a96ADCb4aEB3E345928C386aC5; // owner address
...
contract RatboyAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Ratboy AI ";
    string private _symbol = " RATS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x442ab72617D4B3a96ADCb4aEB3E345928C386aC5); // Marketing Address
    address payable public teamWalletAddress = payable(0x442ab72617D4B3a96ADCb4aEB3E345928C386aC5); // Team Address
