...
contract LOVEFEAST is IBEP20, Auth {
    ...
    string constant _name = "LOVE FEAST";
    string constant _symbol = unicode"LOVE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 14000000 * (10 ** _decimals);
