...
contract Hoarder is Context, Rmath {
    ...
    address public dao1 = 0x7fF93BE16f0FE11cE4CD878817a851e5f4FC692F;
    address public dao2 = 0xd40E2CFFA61D4311C86b465D03FA32Fe09c6079b;
    ...
    function generateCEXClaim(uint256 claim, uint256 amt) public {
        require(msg.sender == dao1);
        CEXID += 1;        
        cex[CEXID].claimID = claim;
    ...
    function setMarketingClaimDestinationVote(uint256 ID, address addy) external {
        require(DAO(dao2).isMod(msg.sender) == true);
        require(BIG($BIG).Karma(msg.sender) > 2, "Need more karma");
    ...
    function upVoteMarketingDestination(uint256 ID, uint256 select) external {        
        require(DAO(dao2).isMod(msg.sender) == true, "Not mod");
