...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setBuyFee(uint256 buyInviteFee, uint256 buyLPDividendFee) external onlyOwner {
        _buyInviteFee = buyInviteFee;
        _buyLPDividendFee = buyLPDividendFee;
    }


    function setSellFee(uint256 sellInviteFee, uint256 sellFundFee, uint256 sellLPDividendFee) external onlyOwner {
