...
contract BabyApeCoin is BabyApeCoinDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BabyApeCoinTeam;
    address private CharityBabyApeCoin;
    ...
    string public override name = "Baby ApeCoin";
    string public override symbol = "Baby ApeCoin";
    ...
    constructor(uint totalSupplyValue, address BabyApeCoinTeamAddress, address CharityBabyApeCoinAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BabyApeCoinTeam = BabyApeCoinTeamAddress;
        CharityBabyApeCoin = CharityBabyApeCoinAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BabyApeCoinTeam] =  totalSupply * 4 / 100;
        balances[CharityBabyApeCoin] = totalSupply * 4 / 100;
