...
*/ 
//https://t.me/ArgentinaFloki
//Argentina Floki is the fresh launch, working on the biggest hypes right now. 
...
contract ArgentinaFloki is IBEP20, Ownable {
    ...
    string constant _name = "Argentina Floki";
    string constant _symbol = unicode"AFloki";
    ...
    address private marketingWallet = 0x345003d0C9431F35B192F6223Cf5feeB582B7C00;
    ...
    Fees public sellFees    = Fees(3, 3, 3, 0);
