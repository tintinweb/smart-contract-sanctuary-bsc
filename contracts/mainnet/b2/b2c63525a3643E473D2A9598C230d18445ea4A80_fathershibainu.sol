...
contract fathershibainu is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 500; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 500; // 2% of supply
    ...
    string private constant _name = "Father Shiba Inu";
    string private constant _symbol = "FShiba";
