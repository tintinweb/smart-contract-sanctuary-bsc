...
contract NewYearRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "NewYear Rabbit";
    string private _symbol = "Rabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC2DaCD2167378Ab3d29605AABb8E1b7A62543395); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC2DaCD2167378Ab3d29605AABb8E1b7A62543395); // buyback Address
