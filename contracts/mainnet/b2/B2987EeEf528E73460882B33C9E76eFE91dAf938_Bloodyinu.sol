...
// BLOODY INU (BSC) 
// Telegram:https://t.me/Bloodyinuofficial
...
contract Bloodyinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bloody inu";
    string private _symbol = "$BINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3056488323C10Cc3990E30A326A42D1DFb5fdd7); // Marketing Address
    address payable private BuyBackWalletAddress = payable(0x91B79A4aDc3509A5c9d24F9F5E7fF9e2894ed716); // BuyBack Address
