...
// 
//
// 📱 Telegram:https::https://t.me/+f_5hgcxkBhg0Mzhl
/*
...
contract CheemsYears is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cheems Years", "CheemsYears") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CheemsYears";
    string private _symbol = "CheemsYears";
