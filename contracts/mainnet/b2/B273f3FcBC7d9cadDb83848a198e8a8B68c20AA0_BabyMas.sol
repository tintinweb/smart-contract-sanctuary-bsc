...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEe7340B156dBb5eDcaAF765Cc76daCdFC075BfB7; // owner address
...
contract BabyMas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyMas";
    string private _symbol = "BABYMAS";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xEe7340B156dBb5eDcaAF765Cc76daCdFC075BfB7); // Marketing Address
    address payable public teamWalletAddress = payable(0xEe7340B156dBb5eDcaAF765Cc76daCdFC075BfB7); // Team Address
