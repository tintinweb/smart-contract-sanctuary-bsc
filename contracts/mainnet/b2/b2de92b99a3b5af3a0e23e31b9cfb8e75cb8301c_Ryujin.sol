...
/**
                   ...
                   https://t.me/RyujinPortal    The Dragon of $RYUJIN 
...
contract Ryujin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Dragon of $RYUJIN";
    string constant _symbol = "$RYUJIN";
    ...
    uint256 public totalFee = marketingFee + buybackFee + liquidityFee + devFee;
