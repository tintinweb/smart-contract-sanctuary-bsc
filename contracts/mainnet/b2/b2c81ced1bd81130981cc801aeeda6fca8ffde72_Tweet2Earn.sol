...
contract Tweet2Earn is Context, IERC20, Ownable {
    ...
    address payable public farmAddress = 0x0000000000000000000000000000000000000000; 
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
            ...
            if (recipient != burningAddress && recipient != uniswapV2Pair && recipient != marketingAddress && recipient != devAddress  && recipient != address(uniswapV2Router) && recipient != farmAddress){
    ...
    function setFarm(address payable wallet) public onlyOwner {
        farmAddress = wallet;
    }
