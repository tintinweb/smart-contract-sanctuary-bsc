...
contract KumaGold is BEP20, Auth {
    ...
    string public constant name = "Kuma Gold";
    string public constant symbol = "KGOLD";
    ...
    uint256 public swapThreshold = totalSupply / 2700;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x27c06843B58E9387f897408d64934EA247BFEb5a;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x27c06843B58E9387f897408d64934EA247BFEb5a;
        devFeeReceiver = 0x27c06843B58E9387f897408d64934EA247BFEb5a;
