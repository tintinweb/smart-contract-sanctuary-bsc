...
// telegram: https://t.me/warcrimebsc
...
contract WarCrime is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "War Crime";
    string private constant TOKEN_SYMBOL = "WAR";
    ...
    address public rewardPool = 0x1BC55F0A1E86Dee64E3c31E62a4ba8D9DE7034bd;
    ...
    uint256 private swapThreshold = (_tTotal * 20) / 10000;
    uint256 private swapAmount = (_tTotal * 20) / 1000;
