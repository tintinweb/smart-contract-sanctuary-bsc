...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyInviteRewardRate = 700;
    ...
    constructor (
        ...
        _feeWhiteList[address(0x1bFB27a950855e8Ed619351FA7e2871C884Edc40)] = true;
        ...
        _remainRewardAmount = 5000 * tokenDecimals;
    }
                ...
                if (_swapPairList[sender]) {//Buy
                    ...
                    if (remainRewardAmount > 0) {
                        ...
                        for (uint256 i; i < 5;) {
                            ...
                            if (0 == i) {
                                invitorAmount = inviteFeeAmount * 3 / 7;
                            } else if (1 == i) {
                                invitorAmount = inviteFeeAmount * 1 / 7;
                            } else if (2 == i) {
                                invitorAmount = inviteFeeAmount * 1 / 7;
                            } else if (3 == i) {
                                invitorAmount = inviteFeeAmount * 1 / 7;
