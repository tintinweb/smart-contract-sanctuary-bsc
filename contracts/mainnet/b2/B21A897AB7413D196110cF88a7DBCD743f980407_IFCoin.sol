...
contract IFCoin is IBEP20, Auth {
    ...
    address MKT  = 0x23F645f859A9abe3cF894131D1d5e4A6fF791eF4;

    string constant _name = "XXXPAYXX";
    string constant _symbol = "XXXPAYXX";
    ...
    uint256 public swapThreshold = 1500000000000000000000; // 1500 TK
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        if (totalFee > 0) {
            ...
            amountBNB = address(this).balance.sub(balanceBefore);
            (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNB}("");
            tmpSuccess = false;         
        }
    }
