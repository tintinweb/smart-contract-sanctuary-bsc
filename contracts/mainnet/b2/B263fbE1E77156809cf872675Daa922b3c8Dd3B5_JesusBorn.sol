...
contract JesusBorn is Context, IERC20, Ownable {
    ...
    string private constant _name = "JesusBorn";
    string private constant _symbol = "GOD";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 25000 * 10**_decimals;
