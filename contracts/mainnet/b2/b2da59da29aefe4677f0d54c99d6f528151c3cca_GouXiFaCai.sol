...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16Cc29060DAD76d630D61E66cb9CF3E997983Eaa; 
...
contract GouXiFaCai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gou Xi Fa Cai";
    string private _symbol = "GXFC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16Cc29060DAD76d630D61E66cb9CF3E997983Eaa); // 
    address payable public teamWalletAddress = payable(0x16Cc29060DAD76d630D61E66cb9CF3E997983Eaa); // 
    ...
    uint256 private _totalSupply = 2574000 * 10**_decimals;
    uint256 public _maxTxAmount = 51480 * 10**_decimals; 
    uint256 public _walletMax = 51480 * 10**_decimals;
