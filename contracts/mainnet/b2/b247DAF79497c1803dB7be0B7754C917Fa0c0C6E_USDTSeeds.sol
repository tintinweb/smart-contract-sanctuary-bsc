...
contract USDTSeeds is Ownable {
	...
	uint256[] public SEED_PERCENTS 		= [2000, 1000, 800, 500, 300, 200, 100, 100, 100, 100,0,0,0,0,0];
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(1, 500));
		plans.push(Plan(3, 500));
		plans.push(Plan(5, 1000));
        plans.push(Plan(7, 300));
        plans.push(Plan(12, 450));
		plans.push(Plan(30, 550));
		plans.push(Plan(60, 600));
        plans.push(Plan(90, 800));
		plans.push(Plan(150, 1000));
		plans.push(Plan(1, 5000));
        plans.push(Plan(1, 6000));
		plans.push(Plan(1, 8000));
		plans.push(Plan(2, 3000));
        plans.push(Plan(2, 3500));
		plans.push(Plan(2, 4000));
		plans.push(Plan(3, 2000));
        plans.push(Plan(3, 3000));
		plans.push(Plan(3, 4000));
		plans.push(Plan(5, 1500));
        plans.push(Plan(5, 2000));
		plans.push(Plan(5, 3000));
		plans.push(Plan(7, 2000));
        plans.push(Plan(7, 3000));
		plans.push(Plan(7, 5000));
		plans.push(Plan(10, 2000));
        plans.push(Plan(10, 3000));
		plans.push(Plan(10, 5000));
        plans.push(Plan(1, 1000000));
	...
	function getUserDividends(address userAddress) public view returns (uint256) {
		...
		for (uint256 i = 0; i < user.deposits.length; i++) {
		    ...
		    if ( finish <= block.timestamp) {
				...
				uint256 share = user.deposits[i].amount.mul(plans[user.deposits[i].plan].percent).mul(plans[user.deposits[i].plan].time).div(PLANPER_DIVIDER);
				//if (from < to) {
					//totalAmount += user.deposits[i].amount+totalAmount.add(share.mul(to.sub(from)).div(TIME_STEP));
					totalAmount = user.deposits[i].amount+totalAmount.add(share);
				//}
              
			}
		}
        totalAmount=totalAmount-getUserTotalWithdrawn(userAddress)+getUserTotalSeedWithdrawn(userAddress);
		return totalAmount;
	}
		...
		for	(uint256 y=1; y<= count; y++)
		{
			...
			for (uint256 i = 0; i < downline.deposits.length; i++) {
				...
				if (finish <= block.timestamp) {
					...
					//uint256 to = finish < block.timestamp ? finish : block.timestamp;
					//seed income
					uint256 share = downline.deposits[i].amount.mul(plans[downline.deposits[i].plan].percent).mul							//totalSeedAmount =totalSeedAmount.add(seedshare.mul(to.sub(from)).div(TIME_STEP));	
(plans[downline.deposits[i].plan].time).div(PLANPER_DIVIDER);
					...
					//if (from < to) {
                            ...
                            totalSeedAmount =totalSeedAmount.add(seedshare);	
