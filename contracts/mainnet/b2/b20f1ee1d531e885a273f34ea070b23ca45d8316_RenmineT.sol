...
contract RenmineT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "RenmineT";
    string private _symbol = "RenmineT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBB5B48Abe7ea4389fc73B7D2e962C585363Ff7C5);
    address payable public liqWalletAddress = payable(0xBB5B48Abe7ea4389fc73B7D2e962C585363Ff7C5);
    ...
    uint256 public _maxTxAmount =   192672191 * 10**_decimals;
