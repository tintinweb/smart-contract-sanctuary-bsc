...
contract Spain is Context, IERC20, Ownable {
    ...
    string private _name = "Spain";
    string private _symbol = "Spain";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xa8ea731Cda0e4F4b6FD4bC7eB546c754983b507f); 
    address payable private teamWalletAddress = payable(0x46D04425aEdEF3E7435797aCb98e6d346Fce8e8c); 
