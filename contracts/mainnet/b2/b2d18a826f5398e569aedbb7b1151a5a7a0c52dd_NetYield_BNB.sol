...
/*   Netyield BNB - Yield Farming Smart Contract built on BNB Smart Chain.
 *   The only official platform of original NetYiled team! All other platforms with the same contract code are FAKE!
 *
 *   [OFFICIAL LINKS]
 * 
 *   ┌────────────────────────────────────────────────────────────┐
 *   │   Website: https://netyieldbnb.com                           │
 *   │                                                            │
 *   │   Twitter: https://twitter.com/netyieldbnb        │
 *   │   Telegram: https://t.me/netyieldbnb                         │
 *   │                                                            │
 ...
 *   - 13% Advertising and promotion expenses, Support work, Development, Administration fee
 *
...
contract NetYield_BNB {
	uint256 constant INVEST_MIN_AMOUNT = 2e16; // 0.02 bnb
	uint256 constant REFERRAL_PERCENT = 13;
	uint256 constant PROJECT_FEE = 10;
	uint256 constant ROI = 225;
