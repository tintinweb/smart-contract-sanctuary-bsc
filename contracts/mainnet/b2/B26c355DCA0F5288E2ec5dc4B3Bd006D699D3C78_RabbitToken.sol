...
contract  RabbitToken is IERC20, Ownable {
    ...
    uint256 public minLPDividendToken =  50000000e18;
    ...
    constructor(){  
             address adminAddress = 0xD2312e736fFaeAd9Ba4Ae0C512B13A9972a6d783;
            _name = "Rabbit";
            _symbol = "Rabbit";
            _decimals= 18;
            ...
            _marketingFee =100;
            _LPFee = 100;
            marketAddr =0x0de6576a68410A610736583384A11E3f8AA4c9a9;
            _liquidityFee = 200;
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount;
         ...
         if(canSwap &&from != address(this) &&from != uniswapV2Pair  &&from != owner() && to != owner() ){
                uint256  addLiquidityTokenNum = (contractTokenBalance*_liquidityFee)/400;
                swapTokensForTokens(contractTokenBalance-addLiquidityTokenNum);
                uint256 tokenBal = IERC20(_token).balanceOf(address(this));
                       //先添加流动性
                addLiquidity(addLiquidityTokenNum ,  tokenBal*_liquidityFee /400);
                IERC20(_token).transfer(marketAddr,  tokenBal.mul(_marketingFee).div(400));
   ...
   function _takeburnFee(
    ...
    function _transferStandard(
        ...
        _takeTransfer(sender,address(this), tAmount,_marketingFee+_liquidityFee+_LPFee);
