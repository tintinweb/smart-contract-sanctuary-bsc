...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_oMap[_msgSender()], "Ownable: caller is not the owner");
        _;
    }
...
contract MiracleStar is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _total = 300000 * (10**18);
    
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    
    address public RewardCoin=address(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A); //RewardCoin
    
    uint256 public maxSellTransactionAmount = _total;
    uint256 public swapTokensAtAmount =100 * (10**18);
    
    uint256 public maxSwapTokensAtAmount = 5000 * 10**8 * (10**18);
    
    bool public swapAndLiquifyEnabled = true;
    
    mapping(address => bool) public _isBlacklisted;

    uint256 public TokenRewardsFee = 40;
    ...
    uint256 public genFee = 40;
    uint256[3] public genFeeList = [50, 25, 25];

    mapping(address => address) public _referrerByAddr;

    address public _marketingWalletAddress=address(0xC803200242f652106fa7fD121d3Efb7bf9870A25);
    ...
    constructor() ERC20("Miracle star", "MS") public{
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        /// TestNet
        // _uniswapV2Router = IUniswapV2Router02(0xCc7aDc94F3D80127849D2b41b6439b7CF1eB4Ae0);
    ...
    function activeDividend(address newAddress) public onlyOwner {
        address _rewardCoin = 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A;//FIST
        /// TestNet
        // _rewardCoin = 0x58B3DE4bAeE683eC93b56424d68E4dd4519A1d82;//RUSDT
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Miracle star: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "Miracle star: The new dividend tracker must be owned by the Miracle star token contract"
        );
    ...
    function updateRewardCoin(address newRewardCoin) public onlyOwner {
        ...
        require(RewardCoin != newRewardCoin, "Miracle star: The RewardCoin already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Miracle star: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Miracle star: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Miracle star: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Miracle star: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Miracle star: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Miracle star: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 burnFees = amount.mul(burnFee).div(1000);
            uint256 genFees = amount.mul(genFee).div(1000);
            ...
            if (genFees > 0) {
                ...
                for (uint256 i = 0; i < genFeeList.length; i++) {
                    ...
                    uint256 oGenFees = genFees.mul(oGenFee).div(100);
                    super._transfer(from, address(taxer), oGenFees);

                    amount = amount.sub(oGenFees);
                }
            }
    ...
    function setGenFeeList(uint256[3] calldata _gene) public onlyOwner{
        genFeeList=_gene;
    }
    ...
    function _swap() private {
        uint256 swapFees = marketingFee;
        uint256 contractTokenBalance = balanceOf(address(this));
            
        uint256 swapTokens = contractTokenBalance.mul(swapFees).div(totalFees);
    ...
    function swapAndSendToMarketing(uint256 tokens) private {
        ...
        uint256 marketBalance = newBalance;
        
        payable(address(_marketingWalletAddress)).transfer(marketBalance);
    }
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        uint256 initialCAKEBalance = IERC20(RewardCoin).balanceOf(address(this));

        swapTokensForRewardCoin(tokens);
        uint256 newBalance = (IERC20(RewardCoin).balanceOf(address(this))).sub(
            initialCAKEBalance
        );
        IERC20(RewardCoin).transfer(_marketingWalletAddress, newBalance);
    }
    ...
    function swapTokensForRewardCoin(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        swapTokensForRewardCoin(tokens);
        uint256 dividends = IERC20(RewardCoin).balanceOf(address(this));
