...
contract PEEPSOFSURGE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SRGPEEPS";
    string private constant _symbol = "$PEEPS";
    ...
    address public treasuryWallet = 0x1E43881d582B5f9a7FDDc38Ed842FC653e3b054c;
    ...
    uint256 public constant SHAREDIVISOR = 300;
    ...
    function withdrawTaxBalance() external {
        if(teamShare>0){
