...
contract DHXY is Context, IERC20, Ownable{
    ...
    // address private potwalletAddr = 0xfE5f91a7c373076367FB9313d548D729C6958c89;
    address private potwalletAddr = 0xe82fb2dD9062C7e105a445b35F3fA29dcBB3302B;
    ...
    //stake
    function initStake(address account,uint256 amount,uint256 mul,uint256 time) public onlyOwner{
require(_balances[address(this)]>waitIncome,"mint over");
        require(amount>0,"Amount is not enough!");
        uint256 lp_amount = IPancakePair(_pairAddress).balanceOf(msg.sender);
        require(lp_amount>=amount,"lp is not enough!"); 
        ...
        userMap[account].stakeUsdt += total0;
        userMap[account].staketoken += total1;
        userMap[account].totalStakeUsdt += total0;
        userMap[account].totalStakeToken += total1;
    ...
    function setStake(address account,uint256 index,uint256 time,uint256 muls)public onlyOwner{
