...
contract APC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APE CORN";
    string private _symbol = "APC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x64C76a927ff8Eda511fe35fAc54092876db0d9e0); // Marketing Address
    address payable public BuyBackWallet = payable(0x64C76a927ff8Eda511fe35fAc54092876db0d9e0); // Team Address
