...
contract ScarFaceLion is IERC20 {
    ...
    string constant private _name = "ScarFace Lion";
    string constant private _symbol = "SFL";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x2527ee89183ee3a911d36be0F8ECF0a4bF407823),
        development: payable(0x0667D8B89955f5bCF11b483281d4E12550fE9F40),
        charity: payable(0x5c306080E865355D91eAef25D81E7f4C330d0E71)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 development, uint16 charity) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.charity = charity;
        _ratios.totalSwap = liquidity + marketing + development + charity;
