...
// NEKO TOM TOKEN V.1
/**
     * Website: http://www.nekotom.tk/
     * Telegram Channel: t.me/nekotomofficiachannel
     * Telegram Group: t.me/nekotomofficialgroup
     * Twitter: https://twitter.com/NekotomC
    */
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEFFd495e1D321dCD974398ce33e1F820f97dCA8e;
...
contract NekoTomToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD763fE3629c13D2663CACaa4b125C5aBb44FF427;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Neko Tom Token";
    string private _symbol = "NekoTomT";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 30; 
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 30;// 2% Devs + 1% Charity
