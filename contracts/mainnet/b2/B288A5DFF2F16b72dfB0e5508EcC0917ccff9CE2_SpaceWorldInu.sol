...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE5Be4a54f28a0e66800d5Ddc7D688b527884eAB6;
...
contract SpaceWorldInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPACEWORLD INU"; // 
    string private constant _symbol = "SWI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xE5Be4a54f28a0e66800d5Ddc7D688b527884eAB6);
