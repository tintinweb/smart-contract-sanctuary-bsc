...
contract DONTBUY is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x130e5e1f8f0830f7b48447Add939CE6210E724fE);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**2 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x130e5e1f8f0830f7b48447Add939CE6210E724fE;
