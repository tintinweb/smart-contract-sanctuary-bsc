...
contract YeZilla is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor() payable ERC20("YeZilla", "YeZilla") {
        uint256 totalSupply = 100000000 * (10**18);
        swapTokensAtAmount = totalSupply.mul(5).div(10**5); // 0.005;
        ...
        liquidityReceiveAddress = 0xa075fbbbeef7d4D7C1c6Dc5e6ee389F2cD0dF274;
