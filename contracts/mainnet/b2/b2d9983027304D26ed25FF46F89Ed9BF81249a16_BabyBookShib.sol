...
contract DividendDistributor is IDividendDistributor, Auth {
    ...
    IBEP20 RWDS = IBEP20(0x4693983B0d0C1d5Ef6692F799A5DD4f6CfA3fEe4);
    address REWARDS;
    IRouter router;
...
contract BabyBookShib is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Baby BookShib';
