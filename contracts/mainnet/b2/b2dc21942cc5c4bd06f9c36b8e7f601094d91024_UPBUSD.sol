...
contract UPBUSD is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "UP BUSD";
    string constant _symbol = "UP BUSD";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 10000; // 0.5%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 0.5%
    uint256 public _maxWalletToken = ( _totalSupply * 600 ) / 10000; // 0.5%
