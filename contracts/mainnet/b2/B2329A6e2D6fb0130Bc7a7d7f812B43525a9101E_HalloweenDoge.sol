...
contract HalloweenDoge is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xfD98Fbb5998A30eC1aa00323aD8b8DFc0c6C6C9D);
    ...
    uint256 private batchBlock = 20;
    mapping (address=>uint256) user2blocks;
    uint256 public bots;

    function setKillParameter (
        uint _killBlock,
        uint _batchBlock
    ) external onlyOwner {
        killBlock = _killBlock;
        batchBlock = _batchBlock;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 maxSell = _balances[sender].mul(499).div(500);
