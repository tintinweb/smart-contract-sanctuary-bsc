...
contract Falconcoin is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Falcon Coin";
    string private _symbol = "$FALCON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFea82f6e38D4D014C8c316b222DF7d7Dfc289147); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFea82f6e38D4D014C8c316b222DF7d7Dfc289147); // BuyBack Address
