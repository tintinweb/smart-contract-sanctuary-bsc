...
abstract contract ContextBTC {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/RYOSHIereum/solidity/issues/2691
        return msg.data;
    }
}
...
interface RYOSHI {
     ...
     *
     * Returns a boolean value indicating whRYOSHIer the operation succeeded.
     *
     ...
     * Returns a boolean value indicating whRYOSHIer the operation succeeded.
     *
     * IMPORTANT: Beware that changing an allowance with this mRYOSHIod brings the risk
     * that someone may use both the old and the new allowance by unfortunate
     * transaction ordering. One possible solution to mitigate this race
     * condition is to first reduce the spender's allowance to 0 and set the
     * desired value afterwards:
     * https://github.com/RYOSHIereum/EIPs/issues/20#issuecomment-263524729
     *
...
contract Ownable is ContextBTC {
...
contract TheHuntersLegend is ContextBTC, RYOSHI, Ownable {
    ...
    string private _name = 'The Hunters Legend';
