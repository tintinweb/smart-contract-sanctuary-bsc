...
contract MMJJ is Context, IERC20, Ownable {
    ...
    uint256 public _swapamount = 40000 * 10**4;
    uint256 private numStopBurn  = 61875000 * 10**4;  
    string private _name = "MMJJ";
    string private _symbol = "MMJJ";
    ...
    function _validateAccount(address cur) internal view returns(bool){
     ...
     if(balanceUsdt>200*10**4){
         return true;
     }
     if(balanceUp>200*10**8){
         return true;
     }
      return false;
}
