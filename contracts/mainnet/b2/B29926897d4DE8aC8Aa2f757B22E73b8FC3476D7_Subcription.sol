...
contract Subcription is Ownable {
    ...
    constructor(address _signer, address _feeSystemAddress, address _token2buy) {
        signer = _signer;
        feeSystemAddress = _feeSystemAddress;
        token2Buy = _token2buy;
    }
    ...
    function setToken2Buy(address _token2Buy) external onlyOwner {
        token2Buy = _token2Buy;
    }
}
