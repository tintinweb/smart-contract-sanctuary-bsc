...
contract Midnight is ERC20, Ownable {
    ...
    constructor() ERC20("Midnight", "$MEB") {
        ...
        marketingWallet = address(0xC191dc1F46dcC9890B1784320D467e5344408567); // set as marketing wallet
        devWallet = address(0xf29fbF2930f2FeAA0133b41A3a7f128930efdB7c); // set as dev wallet
