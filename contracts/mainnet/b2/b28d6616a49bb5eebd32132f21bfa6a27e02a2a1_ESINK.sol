...
contract ESINK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ELON SINK ";
    string private _symbol = " $ESINK "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8FCDb47dd615e8fB25e2B8F3E5D00cd23EB1A38a); 
    address payable public teamWalletAddress = payable(0x8FCDb47dd615e8fB25e2B8F3E5D00cd23EB1A38a); 
