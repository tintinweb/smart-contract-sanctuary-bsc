...
contract NatsunoNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Natsuno Neko";
    string private _symbol = "Natsuneko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F830B13EF7F5D1651F64A58bF9A781bd7240f35); 
    address payable public buyBackWalletAddress = payable(0x8F830B13EF7F5D1651F64A58bF9A781bd7240f35); 
