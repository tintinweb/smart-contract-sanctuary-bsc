...
library Address{
 ...
 contract BEEBO is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x653A99B1282Fd049B8a40a5be938cd9b3d1b5c98;
    address public developmentWallet = 0x653A99B1282Fd049B8a40a5be938cd9b3d1b5c98;

    string private constant _name = "Beebo Inu";
