...
contract SafePi is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SafePi";
    string private _symbol = "SafePi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6a514A0e55954B4aCEc41C996d487df92D79A841);
