...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDDcF7105739A69f729560264cbD86C73809a1F35); // Marketing Address
    address payable public charityAddress = payable(0xDDcF7105739A69f729560264cbD86C73809a1F35); // Charity/Dev Address
    ...
    uint256 private _tTotal = 300000000000000 * 10**18; // 1 Qud
