...
contract ProfitAI is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xBda99AC3936Ab8326e0CF57C809115910fFe767C);
    address payable public Wallet_Dev =
        payable(0x25473802e129d438aB46e8a30cEF350DD39b056b);
    ...
    uint256 public _Tax_On_Buy = 90;
    uint256 public _Tax_On_Sell = 90;
    uint256 public _Tax_Max = 10;
    ...
    constructor() {
        _owner = 0xddDE69605249abE2963AF8f770E1dF438dad1105;
    ...
    function setTax(
        ...
        require(buy <= _Tax_Max, "Buy tax cannot exceed the maximum");
        require(sell <= _Tax_Max, "Sell tax cannot exceed the maximum");
    ...
    function setWallets(
        ...
        Wallet_Marketing = payable(marketing);
        Wallet_Dev = payable(dev);
