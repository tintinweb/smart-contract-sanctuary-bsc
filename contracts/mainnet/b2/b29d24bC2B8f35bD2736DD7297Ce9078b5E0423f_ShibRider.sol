...
contract ShibRider is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDed08B0ade846764620C6BD3230D3f17099B9Eaf); // Marketing Address
    ...
    string private _name = "ShibRider";
    string private _symbol = "ShibRider";
