...
/*
What is Belon DAO Exchange?

Belon.io will be the first centralised DAO exchange on BSC, encompassing a host of utilities including: 
trading, staking, governance and many more to come. 
The project aims to bring together serious utility and accessible 
branding in order to reach the widest target market possible. Belon will attempt to carve 
it's own space, bringing together the best of both world's by utilising the strengths of both CEX and DEX.

✅ KYC / DOXXED and SAFU team
💵 Low market cap
...
contract BelonDao is IERC20, Ownable {
