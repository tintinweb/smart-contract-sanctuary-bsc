...
*/
// SPDX-License-Identifier: Lichence
...
contract  BabyBulls is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Bull's World";
    string private _symbol = "BBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2545b46ED67144E0dA5789B5DC64d07eE88AeC56);
    address payable public teamWalletAddress = payable(0x7F80760965c420d4721cb3055D399BF88c49b655); 
