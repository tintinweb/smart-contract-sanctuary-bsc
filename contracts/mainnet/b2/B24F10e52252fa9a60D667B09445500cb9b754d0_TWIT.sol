...
contract TWIT is IERC20, Ownable {
    ...
    address private fundAddress = address(0xd1820Dc11C28E4929a5694a905Be6F863Fb8b6C1);
    address private lpAddress = address(0x3b5357cF2b4B86599DACcB0c21058Cff7a78A12B);
    ...
    function _transfer(
        ...
        if(_starttime==0 && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            if(from==uniswapV2Pair || to==uniswapV2Pair){
                _starttime=block.timestamp + 5 minutes;
            }
        }
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                if(_destroyFee==0){
                    ...
                    _funTotal=_funTotal.add(tAmount.div(100).mul(_lpFee));
                }else{
