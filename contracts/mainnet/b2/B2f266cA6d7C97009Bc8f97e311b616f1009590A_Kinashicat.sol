...
A a new breed of meme coin on a big mission to bring crypto adoption to the 
main stream through its out of the box marketing, staking, merchandise, NFTS, 
decentralized exchanges and also through huge partnerships with charities and brands around the world.

🔐LIQ LOCKED(UNRUGGABLE)
🔥Stealth Launch (No presale scams)
🔰Friendly Community
👌Verified Contract
...
contract Kinashicat is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KINASHI CAT";
    string constant _symbol = "KINACAT"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 1 * 10**15 * 10**_decimals;
    ...
    uint256 public _maxTxAmount = _tTotal * 300 / 1000; //Initial 1%
    uint256 public _maxWalletSize = _tTotal * 500 / 1000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0xB56Ba666CDbF93e1794888839a0322BbcaE6cbB4;
    address public marketingFeeReceiver = 0xBd4ae80C59b652aD6E97d3f3caf0aF33210BC77E;
    address public liquidityFeeReceiver = 0xB56Ba666CDbF93e1794888839a0322BbcaE6cbB4;
