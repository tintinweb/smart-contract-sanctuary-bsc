...
/*
    ...
    🐾😻🐾😻DigiKitty ( KITTY ) -🐾😻🐾😻 NextGeneration CAT on BSC
    By holding $KITTY, you are automatically entered in a draw to have an oppourtunity to win a DigiKitty NFT!
    DigiKitty token is a community-driven project that has potential to be millionaire like as DOGE, SHIB.

    🌍Web           : https://DigiKitty.io
    🔎Telegram      : https://t.me/DigiKittyBSC
    🕊Twitter        : https://www.twitter.com/DigiKittyBSC
    🖼️ Instagram    : https://instagram.com/DigiKittyBSC
    🎮 Discord      : https://discord.gg/Y33HVSHQzW

    TOKENOMICS
    1,000,000,000,000,000,000 KITTY
    🔥%60 Supply burnt
    💦%40 Supply Add to LP
    ⭐️Tax Fee %6 ; 👥%3 to Holders ,🎁%3 to LiquidityPool
...
contract DigiKitty is Context, IBEP20, Ownable {
    ...
    uint256 public _liquidityFee = 550;
