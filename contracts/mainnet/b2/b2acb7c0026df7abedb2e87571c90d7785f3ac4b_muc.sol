...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2caAB559FD956F96D891B5C146182De4430279B9; // owner address
...
contract muc is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2caAB559FD956F96D891B5C146182De4430279B9); // Marketing Address
    address payable public teamWalletAddress = payable(0x2caAB559FD956F96D891B5C146182De4430279B9); // Team Address
