...
/**
Telegram : https://t.me/BLACKCODEXGLOBAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80870D0662a558414352e3fD8c501c5b6982fA46; // owner address
...
contract CODEX is Context, IERC20, Ownable {
    ...
    string private _name = "Black Code-X";
    string private _symbol = "CODEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80870D0662a558414352e3fD8c501c5b6982fA46); // 
    address payable public teamWalletAddress = payable(0x80870D0662a558414352e3fD8c501c5b6982fA46); // 
