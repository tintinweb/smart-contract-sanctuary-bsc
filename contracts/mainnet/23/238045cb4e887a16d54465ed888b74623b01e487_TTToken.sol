...
contract TTToken is ERC20, Ownable {
    ...
    constructor() ERC20("TTToken", "NNT") {
        ...
        _createSupply(address(this), 2 * (10**16));
    ...
    function getmarketingShare() public view returns (uint256) {
        uint256 marketingShare = marketingFeeOnBuy + marketingFeeOnSell;
        return marketingShare;
    }

    function getliquidityShare() public view returns (uint256) {
        uint256 liquidityShare = liquidityFeeOnBuy + liquidityFeeOnSell;
        return liquidityShare;
    }

    function getmarketingTokens() external returns (uint256) {
        uint256 totalFee = _totalFeesOnBuy + _totalFeesOnSell;
        uint256 contractTokenBalance = balanceOf(address(this));
        uint256 marketingShare = marketingFeeOnBuy + marketingFeeOnSell;
            uint256 marketingTokens = (contractTokenBalance *
    ...
    function getliquidityTokens() external returns (uint256) {
        uint256 totalFee = _totalFeesOnBuy + _totalFeesOnSell;
        uint256 contractTokenBalance = balanceOf(address(this));
        uint256 liquidityShare = liquidityFeeOnBuy + liquidityFeeOnSell;
            uint256 liquidityTokens = (contractTokenBalance *
