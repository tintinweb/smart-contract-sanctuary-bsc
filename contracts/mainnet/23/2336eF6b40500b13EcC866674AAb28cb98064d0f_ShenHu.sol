...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 2 / 100;
            if (burnAmount > 0) {
...
contract ShenHu is AbsToken {
    constructor() AbsToken(
    
        address(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d),
    
        address(0x59ca1F07db16ec596216aA0f435382582A814507),
        "SH",
        "SH",
        18,
        ...
        address(0xFc715e8983cd2Adc8867D29fc704dcDa3cDe5531)
    ){
