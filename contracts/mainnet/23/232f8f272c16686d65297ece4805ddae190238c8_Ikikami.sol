...
contract Ikikami is Context, IERC20 { 
    ...
    address payable private DevWallet = payable(0xE6d2917710cD7B65dba2b4f8c8b2b5F7d3ee48d8);
    address payable private MarketingWallet = payable(0x10b092E69C08E245dB872Aa52A18c342d79A53eD);
