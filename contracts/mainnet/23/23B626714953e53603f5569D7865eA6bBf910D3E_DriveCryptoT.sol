...
contract DriveCryptoT is GasHelper, ERC20 {
  ...
  string constant private _nameToken = "Drive CryptoT";
  string constant private _symbolToken = "DRIVECRYPTOT";
  ...
  function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20) {
        require (isBlacklisted[from] == false || isBlacklisted[to] == false, "Token transfer refused. Receiver is on blacklist");
