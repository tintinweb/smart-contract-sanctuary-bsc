...
contract KishuTwo is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 3; // 100% of supply
    ...
    string private constant _symbol = "KISHUTWO";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 1, // 0 RFI rate, in %
            team: 2, // team fee in %
            marketing: 6, // team fee in %
            lp: 2, // lp rate in %
            toSwap: 11 // marketing + team + lp
        });
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 teamFee = (remainingBalance * appliedRates.team) /
            (denominator - appliedRates.team);
