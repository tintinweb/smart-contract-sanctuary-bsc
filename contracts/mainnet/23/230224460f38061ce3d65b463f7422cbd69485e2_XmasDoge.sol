...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x278Cd501951543c9B0b9728D26BBfbd6A1EBd687;
...
contract XmasDoge is Context, IERC20, Ownable { 
    ...
    mapping (address => uint256) private _OOOwned;
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x278Cd501951543c9B0b9728D26BBfbd6A1EBd687);
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _OOOwned[sender] = _OOOwned[sender].sub(tAmount);
        _OOOwned[recipient] = _OOOwned[recipient].add(tTransferAmount);
        _OOOwned[address(this)] = _OOOwned[address(this)].add(tDev);   
