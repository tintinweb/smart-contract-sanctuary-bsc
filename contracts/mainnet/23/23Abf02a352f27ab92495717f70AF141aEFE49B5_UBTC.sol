...
contract UBTC is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "UBTC";       //Full name
    string public symbol_ = "UBTC";      //abbreviation
    ...
    address public marketingWalletAddress = 0xD24F7233e7570460ba58E8cbAEfD38972b8e4DfC;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 100 * (10**18);       //Supply
