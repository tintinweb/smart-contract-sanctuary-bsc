...
contract TIGRDAO is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**2 * (10**9); // % of the supply

    uint256 public maxBuyAmount = 1 * 10**8 * 10**9; // % of the supply
    ...
    function setSellFee (
       ...
       uint16  burn
        ...
        sellFee.assetFee = asset;

        
        sellFee.burnFee = burn;
        
        totalSellFee = asset + burn;
    }
   ...
   function setTransferFee (
       ...
       uint16  burn
        ...
        transferFee.assetFee = asset;
        
        transferFee.burnFee = burn;
        
        totalTransferFee = asset + burn;
    }
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function swapAndSendWallets(uint256 tokens) private lockTheSwap {
        ...
        uint256 forAsset = newBalance.mul(totalBuyFee + sellFee.assetFee)
                               .div(totalBuyFee + sellFee.assetFee);
