...
contract FireHelp {
    ...
    ISwapRouter private JetSwapRouter;
    ...
    constructor() {
        ...
        JetSwapRouter = ISwapRouter(JetSwapROUTER);
    }
        ...
        returns (uint256 amountBought)
    {
        ...
        // SELL
        JetSwapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(amountBought, 0, sellPath, self, block.timestamp);
    ...
    function ApproveToken(address tokenAddress) external onlyOwner {
        ...
        IBEP20(tokenAddress).approve(JetSwapROUTER, MAX_UINT);
    }
