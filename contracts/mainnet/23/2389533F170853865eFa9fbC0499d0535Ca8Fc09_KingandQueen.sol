...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11ABCA16a1FBCf4fd038f065F46cDDb0F9268691; // owner address
...
contract KingandQueen is Context, IERC20, Ownable {
    ...
    string private _name = "King and Queen";
    string private _symbol = unicode"KNQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11ABCA16a1FBCf4fd038f065F46cDDb0F9268691); // Marketing Address
    address payable public teamWalletAddress = payable(0x11ABCA16a1FBCf4fd038f065F46cDDb0F9268691); // Team Address
