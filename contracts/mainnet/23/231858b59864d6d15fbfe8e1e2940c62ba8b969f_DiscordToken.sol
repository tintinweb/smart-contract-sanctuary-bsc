...
//  DiscordToken - Deflationary token powered by the Binance Smart Chain platform.
...
contract DiscordToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4310313Ae0A451979ED1f8c802F0f059c0eB7137); // Marketing Address
    address payable public charityAddress = payable(0x4310313Ae0A451979ED1f8c802F0f059c0eB7137); // Charity/Dev Address
    ...
    string private _name = "DISCORD TOKEN";
    string private _symbol = "CORD";
