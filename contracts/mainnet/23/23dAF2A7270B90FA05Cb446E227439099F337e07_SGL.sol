...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3e0B0040E2b314A3E0E157C8e9A929047a27Bd9;
...
contract SGL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x96f25a932F1B752aF1425444137f1965037e3F1C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SIGIL";
    string private _symbol = "SGL";
