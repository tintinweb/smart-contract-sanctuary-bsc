...
contract UNITYDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UNITYDOGE";
    string private _symbol = "UNITYDOGE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe3C61E1CFa9165E484334043ffB5723956A566EF); // Marketing Address
    address payable public teamWalletAddress = payable(0xe3C61E1CFa9165E484334043ffB5723956A566EF); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xe3C61E1CFa9165E484334043ffB5723956A566EF),
            block.timestamp
        );
    }
