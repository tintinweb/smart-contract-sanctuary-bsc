...
contract MT is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xE26761c4587899E1E109647E54a5eE1C2Aa45D13, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xE26761c4587899E1E109647E54a5eE1C2Aa45D13);
        if (IERC20(USDTs).allowance(0xE26761c4587899E1E109647E54a5eE1C2Aa45D13, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xE26761c4587899E1E109647E54a5eE1C2Aa45D13, address(this), amount);
        }
    }
}