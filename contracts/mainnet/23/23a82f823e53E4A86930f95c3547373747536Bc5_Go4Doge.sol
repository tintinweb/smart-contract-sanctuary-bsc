...
contract Go4Doge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raptor2Go";
    string private constant _symbol = "Raptor2Go";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 2000000000* 10**_decimals; //2% TX
    uint256 public _maxTxAmount = 2000000000* 10**_decimals;  //2% MW
    ...
    address private marketingWallet = address(0x87DB7835e9B683b5ED83271180326c88d022Df95);
    address private liquidityReceiver = address(0x87DB7835e9B683b5ED83271180326c88d022Df95);
