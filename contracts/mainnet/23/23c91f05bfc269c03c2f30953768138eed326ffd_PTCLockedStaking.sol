...
contract PTCLockedStaking is Ownable{
    using SafeMath for uint256;

    IBEP20 public ptcToken;
    ...
    constructor() {
        ptcToken = IBEP20(0x06E68f942dc309842Cf36Dbb889dDf33849e035f);
        marketingAddress = payable(owner);
        plans.push(Plan(365, 12));
    }
    
    function feePayout(uint256 amt) internal{
        ptcToken.transfer(marketingAddress, amt);
    ...
    function invest(address referrer, uint256 depAmount) public {
        ...
        ptcToken.transferFrom(msg.sender, address(this), depAmount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = ptcToken.balanceOf(address(this));
        ...
        ptcToken.transfer(payable(msg.sender), withdrawAmount);
    ...
    function getContractBalance() public view returns (uint256) {
        return ptcToken.balanceOf(address(this));
    }
    ...
    function emergencyWithdraw() public onlyOwner {
        ptcToken.transfer(msg.sender, ptcToken.balanceOf(address(this)));
    }
}
