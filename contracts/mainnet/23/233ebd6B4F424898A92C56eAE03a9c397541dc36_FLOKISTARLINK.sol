...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1FB21A54B6f837d94E687079B452f7d267fDcce7;
...
contract FLOKISTARLINK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x84E17185AA67934AdDaa72Cae8D7cb36925a7Ca6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FLOKISTARLINK";
    string private _symbol = "$FLINK";
