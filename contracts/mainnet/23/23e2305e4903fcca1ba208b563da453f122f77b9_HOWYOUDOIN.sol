...
contract HOWYOUDOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOW ARE YOU DOING TODAY??";
    string private _symbol = "HOWDY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD96fd11E311ba962CbD0b756186B09765516EED0); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD96fd11E311ba962CbD0b756186B09765516EED0); // buyback Address
