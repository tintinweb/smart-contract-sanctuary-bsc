...
contract ClashCard is ERC20, Ownable, BaseToken {
    ...
    {   
        require(_arg.buyFee_ + _arg.sellFee_ <= 5, "Total buy and sell fees cannot be more than 5%");
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee + _sellFee <= 5, "Total buy and sell fees cannot be more than 5%");
        buyFee = _buyFee;
        sellFee = _sellFee;
