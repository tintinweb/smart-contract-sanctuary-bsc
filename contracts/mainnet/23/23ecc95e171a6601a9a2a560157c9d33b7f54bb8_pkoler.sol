...
//https://t.me/PepeKoler

//https://www.PepeKoler.me
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x9A897E0613fF9934cA1B47c8469E3f04f719E777;
...
contract pkoler is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"PepeKoler.me"; 
    string private constant _symbol = unicode"KOLER"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x9A897E0613fF9934cA1B47c8469E3f04f719E777), BNB_Tot);
