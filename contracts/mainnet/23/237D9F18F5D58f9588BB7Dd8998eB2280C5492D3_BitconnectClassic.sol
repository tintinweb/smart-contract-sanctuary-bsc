...
contract BitconnectClassic is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BitconnectClassic";
    string constant _symbol = "Bitconn";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xe3B5298Fd43C1B4F3A574170CCf63f66b842A376; //Where the 5% marketing fee will be sent
