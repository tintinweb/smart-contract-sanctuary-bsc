...
// File contracts/WebCake.sol

pragma solidity 0.6.12;

// WebCake
contract WebCake is ERC20("WebCake", "WebCake") {
    uint256 private constant MAX_SUPPLY = 200000000000000000e18;
    ...
    constructor(address _treasuryAddr) public {
        ...
        // Mints 160,000,000 WebCake (8%) for Airdrop, IDO and Seed Funders.
        _mint(treasuryAddr, 10000000e18);
        _totalMinted = _totalMinted.add(10000000e18);
        emit Mint(msg.sender, treasuryAddr, 10000000e18);
    }
