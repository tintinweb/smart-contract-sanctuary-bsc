...
contract CAKECEO is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "CAKE CEO";
    string constant _symbol = "$CAKECEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x6cC6a4b863659359eBA4F645a53852721f4831dC; // liquidity
