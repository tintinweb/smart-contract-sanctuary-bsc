...
contract TaxCollect is Ownable {
  bool inSwap;
  modifier swapping() { inSwap = true; _; inSwap = false; }
  uint256 public balance;
  uint256 public maxPercent = 10000;

  uint256 public stakingrewardPercentage = 3000; address public stakingrewardWallet = 0xBd2aAEf4cf359d3c1bB4C3e02011E5a2C4fF12d3;
  ...
  uint256 public marketingPercentage = 3000; address public marketingWallet = 0x5FE03B7557170C13FaFA22C3Aa897b0934939BD3;
  ...
  uint256 public buybackandburnPercentage = 3000; address public buybackandburnWallet = 0x2F491d46FC463Fe1d28759BE1F31E35552E3598A;
  ...
  uint256 public partnershipPercentage = 1000; address public partnershipWallet = 0xc9b928B7d24319A975173B4de79A1790d8F41024;
  ...
  function distribute() public onlyOwner swapping {
    require(stakingrewardPercentage + marketingPercentage + buybackandburnPercentage + partnershipPercentage == maxPercent, "The sum of percentage isn't 100.");
    require(
    ...
    (bool sent_4, ) = payable(partnershipWallet).call{value: (amount * partnershipPercentage / maxPercent), gas: 30000}(""); require(sent_4, "Transfer wallet_4 error."); balance = address(this).balance;
  }

  function kill() public onlyOwner { selfdestruct(payable(owner())); }
}

interface InterfaceTaxCollect {
  ...
  , IERC20Metadata
{
  ...
  string private _name = "EXALT";
  string private _symbol = "EXALT";
  uint8 private _decimals = 9;
  uint256 private _totalSupply;
  uint256 public _tax = 10;
  uint256 public _taxDivider = 100;
  address public _taxCollect;
  ...
  function setTaxCollect(address input_) public onlyOwner { 
    require(input_ != address(0), "Zero Address."); 
    _taxCollect = input_; 
    iTaxCollect = InterfaceTaxCollect(input_);
  }
  ...
  InterfaceTaxCollect private iTaxCollect;
  ...
  function taxBalance() public view onlyOwner returns(uint256) { return iTaxCollect.getBalance(); }
  function distributeTax() public onlyOwner { iTaxCollect.distribute(); }
  function setStakingrewardTax(uint256 percent_, address wallet_) public onlyOwner { iTaxCollect.setStakingreward(percent_, wallet_); }
  function setMarketingTax(uint256 percent_, address wallet_) public onlyOwner { iTaxCollect.setMarketing(percent_, wallet_); }
  function setBuyandburnTax(uint256 percent_, address wallet_) public onlyOwner { iTaxCollect.setBuyandburn(percent_, wallet_); }
  function setPartnershipTax(uint256 percent_, address wallet_) public onlyOwner { iTaxCollect.setPartnership(percent_, wallet_); }
  function setTaxTransferOwner(address newOwner_) public onlyOwner { iTaxCollect.transferOwnership(newOwner_); }
  ...
  function distributeFee () private swapping {
    ...
    if (_balances[address(this)] > 0) {
      ...
      try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        (bool sent, ) = payable(_taxCollect).call{value: amountBNB, gas: 30000}(""); require(sent, "Transfer error.");
