...
contract AustralianDollar is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AustralianDollar";
    string private _symbol = "eAUD";
