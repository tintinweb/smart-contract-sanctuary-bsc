...
contract ButterStakingBABY is Ownable {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;


    // CHANGE THIS ON CHANGE OF EXCHANGE
    address MAIN_TOKEN_ADDRESS = address(0x53E562b9B7E5E94b81f10e96Ee70Ad06df3D2657); //Main TOKEN ADDRESS
    ...
    function swapTokensForMain(IBEP20 rewardToken, uint256 tokenAmount) private {
        ...
        path[1] = address(0x55d398326f99059fF775485246999027B3197955); //USDT
