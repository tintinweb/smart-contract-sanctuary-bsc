 ...
 * Contract Code
 */
contract CrownedMeta is Context, IBEP20, Ownable {
    ...
    string private _name = "CrownedMeta";
    string private _symbol = "CMA";
    uint8 private _decimals = 18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1_000_000_000_000_000*(10**_decimals); // 1 QUAD, 18 decimals
    ...
    uint256 public _secondaryTax=7;
    ...
    constructor () {
        ...
        _taxes.liquidityTax=20;
        _taxes.marketingTax=40;
        _taxes.developmentTax=40;
...
// Swap and distribution
    function swapAndLiquify(uint8 _swapThreshold,bool ignoreLimits) private lockTheSwap {
        ...
        // 1% of 1 QUAD
        uint256 maxSwapSize=(1_000_000_000_000_000*(10**_decimals))/100;
