...
contract FWHY is Context, IERC20, Ownable {
    ...
    string private constant _name = "FIFA WORLD HAPPY"; //
    string private constant _symbol = "FWHY"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x550ED11979E4610D4A41a5a8c6d6245D1519D1f2;
    ...
    function setFBFWHY(address addr, bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }
