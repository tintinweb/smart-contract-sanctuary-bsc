...
contract YAKUZAJIRU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "YAKUZA JIRU";
    string private constant _symbol = "YAJI";
    ...
    address payable private _developmentAddress = payable(0xB9Ed4A1f622bf16f6E79919C5B6e1bc6C7a031AF); 
    address payable private _marketingAddress = payable(0xF37bDee2eC2DeAE7cbf9f5102e06DD692AA4f200); 
