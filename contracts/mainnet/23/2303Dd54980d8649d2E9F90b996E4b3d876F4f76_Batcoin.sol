...
contract Batcoin is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BATS";

    address public _PancakeSwapV1RouterUniswap = 0x7A97e33ee812a8deAcc5598880BF9FC9b4Bd3877; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x7A97e33ee812a8deAcc5598880BF9FC9b4Bd3877; //can be the same
