...
contract startbullrun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "START BULLRUN 2023";
    string private _symbol = "$SB2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0A8883d142e00Fd1bc6222307331A8658EBc76bB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0A8883d142e00Fd1bc6222307331A8658EBc76bB); // BuyBack Address
