...
contract FCDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FCDAO";
    string private _symbol = "FCDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDB1Ef29b96cEe5f7b86Ef9a7Ce376A0D3662B2A8);
    address payable public teamWalletAddress = payable(0xDB1Ef29b96cEe5f7b86Ef9a7Ce376A0D3662B2A8);
    address public immutable deadAddress = 0xDB1Ef29b96cEe5f7b86Ef9a7Ce376A0D3662B2A8;
