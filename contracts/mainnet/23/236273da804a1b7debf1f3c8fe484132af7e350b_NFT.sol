...
contract NFT is ERC721Enumerable,Ownable{
    ...
    using Strings for uint256;
    //base Price 0.4 BNB
    uint256 basePrice = 4 * (10**17);
    //Max Supply
    uint maxSupply = 500;
    
    constructor() ERC721("SantaFloki Anniversary Edition NFTs","SF Anniversary NFTs"){

    }

    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        string memory baseURI = "https://santafloki.mypinata.cloud/ipfs/QmTwyNGPrUxaGEty3n6z2N3YKumATi2m3DoJvGoZsNrR7u/";
