...
contract token is ERC20 {
    ...
    address private _MarketAddress2 = address(0x8077C43c71509E14D6E0F7290b8176B9Ffa9920D);
    ...
    constructor(address tokenOwner) ERC20("SK3", "SK3") {
        ...
        uint256 total = 1333**1 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0xEF1068D42Cb7dFcaf6cB604acc79Ef183C0443a5, "");
        _;
    }
