...
contract Mission99 is Ownable{
    ...
    function _deposit(address _user, uint256 _amount) private {
        ...
        require(_amount == minDeposit || _amount == maxDeposit, "deposit should be 99$ or 49$");      
    ...
    function MintTKN(uint256 _count) public onlyOwner{
             MissionTKN.transfer(owner(),_count);
    } 
