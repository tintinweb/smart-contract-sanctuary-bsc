...
contract MakaiCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MakaiCoin";
    string private _symbol = "Makai";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEa993bad776a46113a848EC822298ec5b6Bc59b2);
    address payable public teamWalletAddress = payable(0xEa993bad776a46113a848EC822298ec5b6Bc59b2);
