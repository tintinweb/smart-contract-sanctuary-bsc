...
/**
 * https://medium.com/@kaibyaku
 * https://twitter.com/kaibyakutoken
 * We do it for the ppl.
*/
...
contract kaibyaku is IBEP20, Auth {
    ...
    string constant _name = "Kaibyaku";
    string constant _symbol = "KB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 108910891069 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x4f0706B5610D87B2a19042D873ced95f3D249Ee0;
    address public devFeeReceiver = 0x8cAFAFeefac05fDeA9eD4Fbe3268A1A24cfcF6e2;
