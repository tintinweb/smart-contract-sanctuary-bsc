...
Jeju Inu (JEJU) is going to be the top dog of the crypto world, 
ready to claim its throne as the leader of all new dog tokens on the BEP-20 network. 
An experimental meme token community with spontaneous support and motivation for growth and foundation.

Join our socials to learn more about $JEJU and its future.
...
contract JejuInu  is IERC20, Ownable {
