...
contract babyapeking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babyapeking";
    string private _symbol = "babyapeking";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD4C64c5783C89719ee9965265351041Ca14C16df); 
    address payable public BurnedWalletAddress = payable(0xD4C64c5783C89719ee9965265351041Ca14C16df); 
    ...
    uint256 public _buyBurnedFee = 5;
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 5;
    uint256 public _sellBurnedFee = 5;
