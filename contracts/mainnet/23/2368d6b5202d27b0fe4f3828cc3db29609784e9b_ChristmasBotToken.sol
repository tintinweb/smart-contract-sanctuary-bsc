...
contract ChristmasBotToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChristmasBotToken";
    string private _symbol = "CBT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39622F0B974D1efcEfa07d9779988101EFfA8A57);
    address payable public teamWalletAddress = payable(0x39622F0B974D1efcEfa07d9779988101EFfA8A57);
