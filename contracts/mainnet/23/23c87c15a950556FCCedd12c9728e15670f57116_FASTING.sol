...
library Address{
 ...
 contract FASTING is Context, IERC20, Ownable {
    ...
    string private constant _name = "FASTING";
    string private constant _symbol = "FASTING";
    ...
    Taxes public taxes = Taxes(0, 4, 1, 3);
    Taxes public sellTaxes = Taxes(0, 4, 1, 3);
