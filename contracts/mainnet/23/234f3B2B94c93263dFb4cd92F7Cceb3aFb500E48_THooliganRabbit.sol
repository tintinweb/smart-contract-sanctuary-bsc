...
contract THooliganRabbit is IERC20, Ownable {
    ...
    address private fundAddress = address(0x753Df1abD917f5d30b5020885752D3A8EF3E3b0F);
    address private fundAddress2 = address(0xf371a9C7d7F4bAd50cD951D4833e72136239979d);
    address private fundAddress3 = address(0x81547EA145F5D7998C463E72F37ddD67B44dF9E2);
    address private fundAddress4 = address(0x102deEBD3d5A0BF2cAE4FE9EC033802BeBC14Fcf);
    address private fundAddress5 = address(0xa15f2793f4CBFE9A3A48665c8D06e1487F741822);
    ...
    uint256 public limit_min=10 minutes;
    mapping(address => bool) public isStop;

    constructor() {
        _name = "Hooligan Rabbit";
        _symbol = "Hooligan Rabbit";
        _decimals = 18;
        ...
        _tTotal = 330000000 * 10 ** _decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                if((starttime+limit_min)>block.timestamp){
                    _takeTransfer(
                        sender,
                        _destroyAddress,
                        tAmount.div(100).mul(31),
                        currentRate
                    );
                }else{
                    _takeTransfer(
                        sender,
                        fundAddress,
                        tAmount.div(100).mul(_fundFee.div(5)),
                        currentRate
                    );
