...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (lpAmount > 0) {
            uint256 lpFist = wbnbBalance * lpFee / swapFee;
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _wbnb, lpAmount, lpFist, 0, 0, fundAddress, block.timestamp
                );
            }
        }
    }
...
contract DIE is AbsToken {
    constructor() AbsToken(
        ...
        "DIE",//Symbol
        18,//Decimals
        5000000000000,//Supply
        address(0x2942df05d7790d5462368487C9aFfca040D366cB),//FundAddress
        address(0x7Dc949255aAcEa525d0DaEFB81Bd82Bc04868Bb1),//ReceiveAddress
        address(0x7Dc949255aAcEa525d0DaEFB81Bd82Bc04868Bb1)
    ){
