...
contract GreenCandle is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "GreenCandle";
    string _symbol = "GC";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxWallet = _totalSupply.mul(20).div(200); 
    uint256 public _maxTxAmount = _totalSupply.mul(10).div(200);
    ...
    address private marketing = address(0x893D0c55F28b74F221315b1380805c13bc1dDD32);
    address private liquidity = address(0x7f1a19D90a9DEb1b1CDc1b164D60B38B12070332);
