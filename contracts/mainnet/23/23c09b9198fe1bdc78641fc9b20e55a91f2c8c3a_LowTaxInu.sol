...
/**
    ...
    Telegram: https://t.me/BiogeOfficial
...
contract LowTaxInu is IBEP20, Auth {
    ...
    string constant _name = "Low Tax Inu";
    string constant _symbol = "LTI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 300;     //2%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 200;   //4%
    ...
    address private marketingFeeReceiver = 0xEe2c5ea18D28F76DfADbFDc76cb3c65861Ef9306;
    address private teamFeeReceiver = 0xEe2c5ea18D28F76DfADbFDc76cb3c65861Ef9306;
