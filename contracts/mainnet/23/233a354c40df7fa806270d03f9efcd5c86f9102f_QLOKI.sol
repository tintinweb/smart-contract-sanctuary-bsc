...
💹Tax 2%  Buy/Sell  1% Rewards 1% LP Burn
💹Max 2% TXS /Wallet
...
contract QLOKI is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100000000000 * 10**3 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'QLOKI';
    string private _symbol = 'QLOKI';
