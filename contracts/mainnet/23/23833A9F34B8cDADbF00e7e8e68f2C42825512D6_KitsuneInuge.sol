...
/**
  Cometbomb project hit 300K Market Cap

  🔥Welcome to the next trend on bsc $KitsuneInuge

KitsuneInuge is a deflationary reflective farming protocol. KitsuneInuge or Ninetails is a large, powerful nine-tailed kitsune who rules Oni Island and To adopt it in BSC we created this MEME token to prove that his power is especially strong. 

For each transaction, there is a 9% fee. This allows holders of $KitsuneInuge to get more by just holding, this is similar to the idea of auto-compound farming. 

📈TOKENOMICS

🟢TOTAL SUPPLY: 1,000,000,000,000

Marketing going to Twitter Influencer and Calls and All initial liquidity provided has been Locked for 7 Days. 

Social Media Links:

📱TG: https://t.me/KitsuneInuge
...
pragma solidity ^0.6.12;
    ...
    contract KitsuneInuge is Context, IERC20, Ownable {
        ...
        string private _name = 'KitsuneInuge';
        string private _symbol = 'KITSUNEIGE';
