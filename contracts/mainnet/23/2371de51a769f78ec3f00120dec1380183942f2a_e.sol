...
contract e is IERC20 {
    ...
    string constant private _name = "E";
    string constant private _symbol = "E";
    uint8 constant private _decimals = 18;
    uint256 constant private _tTotal = startingSupply * 10**_decimals;
    address private DEV = 0x6b72bd58F9b20e94C6d9839FfDB4ea8EC8A805A8;
    struct Fees {
        uint16 buyFee;
        uint16 sellFee;
        uint16 transferFee;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6b72bd58F9b20e94C6d9839FfDB4ea8EC8A805A8),
        team: payable(0x6b72bd58F9b20e94C6d9839FfDB4ea8EC8A805A8),
        staking: payable(0x6b72bd58F9b20e94C6d9839FfDB4ea8EC8A805A8)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 team, uint16 staking) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.staking = staking;
        _ratios.totalSwap = staking + marketing + staking;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable team, address payable staking) external onlyOwner {
        require(marketing != address(0) && team != address(0) && staking != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (stakingBalance + teamBalance);
