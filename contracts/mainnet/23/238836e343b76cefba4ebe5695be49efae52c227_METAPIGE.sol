...
contract METAPIGE is Context, IERC20, Ownable {
    ...
    string private _name = "METAPIGE";
    string private _symbol = "$METAPIGE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10 * 10**12 * 10**_decimals;

    address payable public marketing =
        payable(0x2D26B3c25301FF5bFCD37eb193C8a1FfaF5f570F);
