...
contract STARSCREAM is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb1092B1EBa8fd5704D8e5f0C36fE40B6a9625153); // 
    address payable public teamWalletAddress = payable(0xb1092B1EBa8fd5704D8e5f0C36fE40B6a9625153); // 
