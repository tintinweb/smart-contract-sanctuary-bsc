...
/*
 ...
 #cInu New Community INU
    
   I make this #ciNu to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunity
...
contract NewCommunity is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community"; 
    string private constant _symbol = "cNEW"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 5;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x3C0e9c1B88EFDdEF137688F1a2b0DD107B7aA847;
