...
contract DeathNoteInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "DEATH NOTE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59DfF43A6Ab0043C782e5fcbc682B651eC2E62F0); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x59DfF43A6Ab0043C782e5fcbc682B651eC2E62F0); // Development Address
    ...
    uint256 private _totalSupply = 500 * 10**24 * 10**9;
    uint256 public _maxTxAmount = 25 * 10**24 * 10**9;
    uint256 public _walletMax = 50 * 10**24 * 10**9;
