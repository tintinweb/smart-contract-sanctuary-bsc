...
contract SaudiCheemsInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SaudiCheemsInu";
    string private constant _symbol = "SaudiCheemsInu";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 100, "Buy fee can't go higher than 20");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 100, "Sell fee can't go higher than 20");
