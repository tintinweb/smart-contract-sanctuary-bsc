...
Telegram https://t.me/goosebonkcoin
...
contract GooseBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GooseBonk";
    string private _symbol = "GOBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8B70c384F21215EBB0Dbc9448E11c8c30633a8f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbA815Ab4808645C4c21070A0F51B917890c0C63a); // BuyBack Address
    ...
    uint256 private _totalSupply = 1 * 10**18 * 10**9;
    uint256 public _maxTxAmount = 1 * 10**18 * 10**9;
    uint256 public _walletMax = 1 * 10**18 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**18 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
