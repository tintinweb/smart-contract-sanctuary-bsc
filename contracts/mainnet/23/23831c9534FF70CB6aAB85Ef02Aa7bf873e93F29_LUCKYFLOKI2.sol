...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x442e786A4839b66cF96449E5a6C7322896Ce2005; // owner address
...
contract LUCKYFLOKI2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lucky Floki 2.0";
    string private _symbol = "LUCKY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x442e786A4839b66cF96449E5a6C7322896Ce2005);
    address payable public teamWalletAddress = payable(0x442e786A4839b66cF96449E5a6C7322896Ce2005); 
