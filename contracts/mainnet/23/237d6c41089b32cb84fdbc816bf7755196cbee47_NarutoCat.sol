...
/* Token contract */
contract NarutoCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address Charity = 0x8EAEca3b0eB607a262897C38355e898073aBC6F7;
    ...
    // Name and symbol
    string constant _name = "Naruto Cat";
    string constant _symbol = "9TailsCat";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1%
