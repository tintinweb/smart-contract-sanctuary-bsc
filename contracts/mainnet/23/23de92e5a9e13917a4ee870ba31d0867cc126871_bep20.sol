...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x156C9ff57Bd7E9d5feBF1423DB940F998f6F6628; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Cat Coin 2.0";
    string private _symbol = "catcoin2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x156C9ff57Bd7E9d5feBF1423DB940F998f6F6628); // Marketing Address
    address payable public teamWalletAddress = payable(0x156C9ff57Bd7E9d5feBF1423DB940F998f6F6628); // Team Address
