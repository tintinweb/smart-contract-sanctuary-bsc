...
contract BRODIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "BRODI INU"; // 
    string private constant _symbol = " BRODI "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xd9d0acf34f45B8D001C2C99A26EFf2eE0e556e89;
