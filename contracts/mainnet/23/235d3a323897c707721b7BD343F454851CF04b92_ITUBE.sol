...
contract ITUBE is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x677dA135285aea820Cb2A137e8fb3229B4e8ca7c;

    string private constant _name = "InuTube";
    string private constant _symbol = "ITUBE";
