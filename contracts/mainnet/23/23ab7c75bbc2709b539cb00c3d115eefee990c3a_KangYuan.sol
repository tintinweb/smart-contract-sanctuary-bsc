...
contract  KangYuan  is Ownable, IERC20 {
    ...
    string private  _name = unicode'抗原';
    string private  _symbol = unicode'抗原';
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( block.timestamp  > burntime  )    {   burnfee = amount.mul(bf).div(100); }     }  }
