...
contract SPEED is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public totalBuyFee =
        DividendFee.add(marketingFee).add(burnFee).add(liquidityFee);
    ...
    constructor() ERC20Detailed("Speed", "SPEED", uint8(DECIMALS)) Ownable() {
        ...
        marketingReceiver = 0x31669C1Dd94f712824c35Aa512038dFEA7F064A0;
        admin = 0xa8Fc8be78bb8eC23ac9d9b72e113785c3D182E31;
        autoLiquidityReceiver = 0x07153c7BB23b908dd5DFfb995068df30Bb32DcF1;
    ...
    function takeFee(
        ...
        _balances[autoLiquidityReceiver] = _balances[autoLiquidityReceiver].add(
            amount.div(feeDenominator).mul(_liquidityFee)
        );

        _balances[address(this)] = _balances[address(this)].add(
            amount.div(feeDenominator).mul(_marketingFee.add(_DividendFee))
        );

        _balances[burnReceiver] = _balances[burnReceiver].add(
            amount.div(feeDenominator).mul(_burnFee)
        );
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return (Total_Supply.sub(_balances[DEAD]).sub(_balances[ZERO]));
    }
    ...
    function setFee(
        ...
        require(_liquidityFee < 100, "liquidityFee cannot be more than 6%");
        require(_marketingFee < 100, "marketingFee cannot be more than 6%");
        require(_DividendFee < 100, "DividendFeeBuy cannot be more than 6%");
    }
