...
contract CUPIDINU is Context, IERC20 { 
    ...
    // Contract Wallets
    address private _owner = payable(0x81A0BAe21C62DFbc829a41DD3e5c2bc6B4Ce0bB2);
    ...
    // Token Info
    string private  _name = "Cupid Inu";
    ...
    address payable public constant feeCollector = payable(0x81A0BAe21C62DFbc829a41DD3e5c2bc6B4Ce0bB2);
