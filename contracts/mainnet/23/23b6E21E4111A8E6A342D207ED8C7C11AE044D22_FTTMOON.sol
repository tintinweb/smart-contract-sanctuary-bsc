...
contract FTTMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTTMOON";
    string private _symbol = "FTTMOON";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x9574c101D4be9e11E7e6C17508e47d4787a87e15); 
    address payable private teamWalletAddress = payable(0xD46FC9d36F86266d8Ee4F161F0B7C51409046941); 
