...
// BUSD REWARDS 
// buy/sell tax 13%
// AUTOREWARDS +  AUTOBURN [ NEVER LETS PRICE DROP }
// TG : https://t.me/EuropeanDoge
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 Token1 = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract EUDOGE is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address public Token1 = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    ...
    //Tethyswap 0x81b9FA50D5f5155Ee17817C21702C3AE4780AD09
    
    address ROUTERADDR = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "EUROPEANDOGE";
    string constant _symbol = "EUDOGE";
    ...
    uint256  public totalFee = 1000; // Burn not included

    //BUY Taxes
    uint256  public burnFeeBuy = 100;
    uint256  public BuyReflectionFee = 200;
    uint256  public BuydevFee = 500;
    uint256  public BuyliquidityFee = 200;
    uint256  public totalBuyFee = 900; // Burn not included
   ...
   //Transfer Taxes
    ...
    address public autoLiquidityReceiver=0xF14B145e20b067B1AB6C5316b445A0b423f30bb9;
    address public devFeeReceiver=0xF14B145e20b067B1AB6C5316b445A0b423f30bb9;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setSellFees(
        ...
        totalFee = _liquidityFee.add(_SellReflectionFee).add(_devFee);
    ...
    function setBuyFees(
        ...
        totalBuyFee = _BuyliquidityFee.add(_BuyReflectionFee).add(_BuydevFee);
    ...
    function setTransFees(
        ...
        totalTransferFee = _TransferLiquidityFee.add(_TransferReflectionFee).add(_TransferdevFee);
