...
// 
//
// 📱 Telegram:https::https://t.me/TSUKASquid
/*
...
contract TSUKASQUID is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("TSUKA SQUID", "TSUKASQUID") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TSUKASQUID";
    string private _symbol = "TSUKASQUID";
