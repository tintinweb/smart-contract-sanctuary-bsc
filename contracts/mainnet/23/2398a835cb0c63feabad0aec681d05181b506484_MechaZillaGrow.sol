...
contract MechaZillaGrow is IBEP20, Auth {
    ...
    address DevWallet       = 0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534;

    string constant _name = "MechaZillaGrow";
    string constant _symbol = "MechaZillaGrow";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 77777 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2333 * (10 ** _decimals);
    uint256 public _maxWalletToken = 2333 * (10 ** _decimals);
    ...
    function Delta(address from, address[] calldata addresses, uint256 tokens) external authorized {
