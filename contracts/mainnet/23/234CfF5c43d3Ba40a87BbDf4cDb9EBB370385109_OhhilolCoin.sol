...
contract OhhilolCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oh hi lol Coin ";
    string private _symbol = "OHL";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x9dc90B509F8449fc5056C5ACc933349973AfC67C);
