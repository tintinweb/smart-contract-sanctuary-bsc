...
contract FICKY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FICKY INU", "FICKY") {
    	...
    	marketingWallet = address(0x775967eB2aDd5Ac1e9c200ce4100ca88843cd07B); // set as marketing wallet
    	devWallet = address(0xA5797c361420A073b05Dd46a18B129FF8c53585E); // set as dev wallet
