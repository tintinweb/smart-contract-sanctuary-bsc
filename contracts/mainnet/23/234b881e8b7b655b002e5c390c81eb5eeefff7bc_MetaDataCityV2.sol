...
abstract contract Ownable is Context {
    address private _owner = 0x741744a990E8421A13e646D4de65aE9c1D522447;
    address private _previousOwner;
    uint256 private _lockTime;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0x741744a990E8421A13e646D4de65aE9c1D522447;
...
contract MetaDataCityV2 is Context, IBEP20, Ownable {
    ...
    event Locked(address indexed _of, bytes32 indexed _reason, uint256 _amount, uint256 _time);
   ...
   function _getCurrentSupply() private view returns(uint256, uint256) {
    ...
    function _lock(address _of, bytes32 _reason, uint256 _amount, uint256 _time)
    ...
    function extendLock(address _of, bytes32 _reason, uint256 _time, uint256 _amount)
        public virtual onlyOwner
        returns (bool) {
