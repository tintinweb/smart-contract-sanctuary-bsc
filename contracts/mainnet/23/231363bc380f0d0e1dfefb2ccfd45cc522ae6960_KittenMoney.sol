...
//address
    ...
    address public marketingAddress = 0x0aCE654a493671bF75b0021db890Fd25619aa0f4;
    address public charityAddress = 0xef5AC502CC13F7Dcbb853eD36008a6e4b247C3b7;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 5;
    uint public sellMarketingFee = 3;
    uint public buyCharityFee = 5;
    ...
    uint public minimumTokensBeforeSwap = 6000000 * 10 ** decimals();
    uint public tokensToSwap = 6000000 * 10 ** decimals();
...
// constructor
    constructor() ERC20("Winnie BSC", "WinnieBSC") {
