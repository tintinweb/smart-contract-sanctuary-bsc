...
contract JINGAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JINGAN";
    string private _symbol = "JINGAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C624294C159f243a6EaE53321C3221da372BE73);
    address payable public teamWalletAddress = payable(0x33A2DeACa8e425B625A70E4E21b0dDB55df1eE51);
