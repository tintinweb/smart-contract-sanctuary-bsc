...
contract EWRLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EGOD WORLD";
    string private _symbol = "EWRLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe3891161CD3A2aD46341C0EFd878d8994E41D836); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe3891161CD3A2aD46341C0EFd878d8994E41D836); // Team Address
