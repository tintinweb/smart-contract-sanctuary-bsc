...
NFT COLLECTION
We will release a NFT Collection shortly after launch.

TAX WILL BE 10% FOR EVERY BUY/SELL TRANSACTION

TOKENOMICS
-8% Will be used for marketing plan and several contests.
-2% Will be used to fille the liquidity pool

MAX WALLET WILL BE THE 3% OF THE TOTAL SUPPLY
*/
...
contract DogeGabbana is IBEP20, Auth {
    ...
    string constant private _name = "Doge & Gabbana";
    string constant private _symbol = "D&G";
    ...
    uint256 liqForFee = 14;
    uint256 devFee = 1;
    uint256 _marketingFee = 14;
    uint256 totalFee = 6;
    ...
    address public _marketingFeeReceiver = 0x166e8469734f18cd307bce88fDC9eCE359e4FF4a;
    address public devFeeReceiver = 0xD03f61f5798bC10d7f4D1277523c160a955513d6;
