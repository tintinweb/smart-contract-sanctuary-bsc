...
/*
MadaraCoin - 100x Gem NFT Low Tax Degen Coin
MadaraCoin is a Meme Degen coin inspired by one of the most popular Naruto character, Madara. With low taxes & based dev, MadaraCoin will be trending in BSC.
- Based Dev
- Previous project ATH : $80,000
- Low tax : 2% for buy & sell

TG : https://t.me/MadaraCoin
*/
...
contract MadaraCoin is Context, IERC20 { 
    ...
    string private constant _name = "MadaraCoin"; 
    string private constant _symbol = "$MadaraCoin"; 
