...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MINU = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MINU.balanceOf(address(this));
        ...
        uint256 amount = MINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MINU.transfer(shareholder, amount);
...
contract BabyMuuInu is IBEP20, Auth {
    ...
    address MINU = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyMuuInu";
    string constant _symbol = "BabyMINU";
