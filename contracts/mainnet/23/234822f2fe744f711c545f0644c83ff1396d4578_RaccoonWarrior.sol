...
contract RaccoonWarrior is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RaccoonWarrior";
    string private _symbol = "RaccWar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23792fc9fB19D4580e686bc158a18dAaD34521C5); // Marketing Address
    address payable public teamWalletAddress = payable(0x2DF1ccC68788271B7911Ea0163F8d5DfDb1B67bA); // Team Address
