...
contract FlopiInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 45000000000000 * 10**14;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Flopi Inu";
    string private _symbol = "FLOPI";
    ...
    address public marketingWallet = 0xDb499F156f3671377Ff05e6DeDB97Accb9978130;
    address public devWallet = 0xBA22135e6187e55A11F6C9FB4f986C1373c3eaA1;
    ...
    uint256 public numTokensSellToAddToLiquidity = 45000000000000 * 10**14;
    uint256 public _maxTxAmount = 45000000000000 * 10 **14;
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    ...
    function prepareFoePresale() external onlyOwner() {
       ...
       _maxTxAmount = 1000000000000 * 10**14;
