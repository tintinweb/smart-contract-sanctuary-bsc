...
/**
    I make this #CHICKEN to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/chickentoken
   ...
   I will renounce the ownership to burn addresses to transfer #CHICKEN to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #CHICKEN 10000000X? 
...
contract ChickenToken is Context, IERC20, Ownable {
