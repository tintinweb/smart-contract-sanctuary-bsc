...
contract PridePooches is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 500;
    uint256 public GENERAL_PRICE = 0.2 ether;
    ...
    constructor() ERC721A("Pride Pooches", "PROOCH"){
    ...
    function Mint(uint256 _quantity) external payable callerIsUser{
        ...
        require(ownerMintedCount + _quantity <= MaxMint, "max NFT per address exceeded");
