...
/*
👩🏽‍💻Solkasu👩🏽‍💻
☎️Telegram : https://t.me/SolkasuBSC
*/
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextSolkasuBNB {
...
contract OwnableSolkasuBNB is ContextSolkasuBNB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableSolkasuBNB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSolkasuBNB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract Solkasu  is ContextSolkasuBNB, SolkasuBNB, OwnableSolkasuBNB {
    ...
    string private _name = 'Solkasu';
    string private _symbol = 'Skasu';
