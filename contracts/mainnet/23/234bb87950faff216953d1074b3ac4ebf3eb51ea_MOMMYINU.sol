...
contract MOMMYINU is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOMMY INU";
    string private _symbol = "MOMMYINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe94bE877B3939d14b853296731eaF005ebAc1C12); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x68c90ea647cFA48afe6f85Eef950Dd9F49d6E768); // BuyBack Address
