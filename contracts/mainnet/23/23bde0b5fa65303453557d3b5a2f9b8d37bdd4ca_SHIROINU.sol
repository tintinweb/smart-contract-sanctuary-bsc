...
contract SHIROINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIRO INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6CfE0bfc8fB1C7dF943c82c084de086c31d1955C); // Marketing Address
    address payable public teamWalletAddress = payable(0x6dbBBe803B6f912447a69275F41b5E9e4Bd4A07C); // Team Address
    ...
    uint256 public _maxTxAmount = 20 * 10**9 * 10**9; //10 * 10**6 * 10**9 1% max tnx
    uint256 public _walletMax = 20 * 10**9 * 10**9; // 2% max wallet
