...
contract TaroFoxt is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public  marketingWallet = payable(0xb3FEb9249f1de996f2a2cfCb72E169dc86e654C7);
    ...
    constructor() ERC20("Taro", "FOXT")  {
        ...
        _createTSupply(owner(), 100000*10**18);
    }
