...
contract  SpookyUP  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666 * 10**9;
    uint256 public _maxTxAmount = 12 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 66000 * 10**9; //
    string private constant _name = "Spooky UP"; // 
    string private constant _symbol = unicode"SKP"; //    
    uint8 private constant _decimals = 4; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x0E96056F7C400948C93f80b37b6cF19Fc7c394c8;
