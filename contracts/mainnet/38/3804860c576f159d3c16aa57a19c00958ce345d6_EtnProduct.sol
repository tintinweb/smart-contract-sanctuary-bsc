...
contract EtnProduct is  ProdNft {
    ...
    function buyProduct(address erc20Addr, uint count) public returns (bool){
        ...
        SaleRecord memory record = SaleRecord(address(msg.sender),price, count, block.timestamp);
    ...
    function isOwner(address to, address erc20Addr) public view returns (bool){
        uint tokenId = tokenNftIdMap[erc20Addr];
        return ownerOf(tokenId) == erc20Addr;
    }
