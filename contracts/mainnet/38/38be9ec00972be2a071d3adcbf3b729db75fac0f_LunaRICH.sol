...
//Telegram : https://t.me/lunarich_bsc
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x652d4F25F2c1b44Fe5291d195a0F9670977eaD01;
...
/* Token contract */
contract LunaRICH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x652d4F25F2c1b44Fe5291d195a0F9670977eaD01;
    ...
    // Name and symbol
    string constant _name = "LunaRich";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% on launch or 3B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 3% or 3B tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% or 3B tokens
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000; // 3% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x652d4F25F2c1b44Fe5291d195a0F9670977eaD01;
