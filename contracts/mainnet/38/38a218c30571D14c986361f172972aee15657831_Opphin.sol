...
contract Opphin is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 2300;
  ...
  function mint(uint256 mintAmount) public payable {
    ...
    require(supply + mintAmount <= 2300);
  ...
  function mintForOwner(uint256 mintAmount) public onlyOwner {
    uint256 supply = totalSupply();
    require(!paused);
    require(mintAmount > 0);
    require(mintAmount <= maxMintAmount);
