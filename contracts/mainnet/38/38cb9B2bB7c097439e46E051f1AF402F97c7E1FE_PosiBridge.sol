    ...
    OwnableUpgradeable
{
    ...
    CrosschainFunctionCallInterface public crosschainControl;

    uint256 public posiChainId;

    uint256 minimumTransferAmount;
    address public posiChainTokenHubContract;
    address public posiCrosschainControlAddress;
    ...
    function updatePosiTokenAddress(address _newTokenAddress) external onlyOwner {
        POSI_TOKEN_ADDRESS = _newTokenAddress;
    }
