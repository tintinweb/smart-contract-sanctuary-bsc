...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x73FE5DD50B13F6DcD80df0F79c0Eb9164Da18262;//
...
contract GQQ is AbsToken {
    constructor() AbsToken(
        ...
        unicode"Gao Qi Qiang",//Name
        unicode"GQQ",//Symbol
        9,//Decimals
        21000000,//Supply
        address(0x8E617FC0B222b82AA03E7D39840Cb7A72823257B),//FundAddress
        address(0xA8DD719995CCd178B34fF1E798Fd2d1E2c1Cc8eF)//ReceiveAddress
    ){
    }
}