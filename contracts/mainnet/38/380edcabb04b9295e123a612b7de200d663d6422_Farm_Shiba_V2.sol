...
contract Farm_Shiba_V2 {
    ...
    uint256 public  INVEST_MIN_AMOUNT;// tokens minimum deposit 
    uint256 public  INVEST_MIN_AMOUNT_2;// tokens minimum deposit 
    ...
    constructor(address payable wallet, address payable bnbpayable, address tokenStaking)  {
