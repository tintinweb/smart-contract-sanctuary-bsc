...
contract MoonZILLAToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MoonZILLA Token";
    string private _symbol = "MOONZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8118390dc2790EFe52fa94F7df965c35B0E2ABA4);
    ...
    uint256 private _totalSupply =  20220714 * 10**_decimals;
    uint256 public _maxTxAmount =   20220714 * 10**_decimals;
    uint256 public _walletMax =     20220714 * 10**_decimals;
