...
contract Porppy is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0xDA36867A6642F132bA63b16a42F0C3ef1519E966);
    address payable private Wallet_Dev = payable(0xDA36867A6642F132bA63b16a42F0C3ef1519E966);
    ...
    string private constant _name = "PornHappy";
    string private constant _symbol = "Porppy";
    ...
    constructor () {
        ...
        _owner = 0xDA36867A6642F132bA63b16a42F0C3ef1519E966;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if (!takeFee) {
            ...
            uint256 sellFEE = tAmount * tf / 100;
    ...
    function getPercent_Marketing() public view returns (uint256) {
        return Percent_Marketing;
    }

    function getPercent_Dev() public view returns (uint256) {
        return Percent_Dev;
    }

    function getPercent_Burn() public view returns (uint256) {
        return Percent_Burn;
    }

    function getPercent_AutoLP() public view returns (uint256) {
        return Percent_AutoLP;
    }
