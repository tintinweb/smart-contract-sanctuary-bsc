...
contract Crownx{
    ...
    using SafeMath for uint256;
     ...
     address payable public owner;
      address payable public  admin;
       ...
       constructor(address payable ownerAddress,address payable adminAddress) public {
        owner = ownerAddress;  
		    admin = adminAddress; 
    }
  ...
  function NewRegistration(string memory member_name, string memory sponcer_id) public payable
    ...
    uint256 adminAmt=msg.value.mul(10).div(100);
    uint256 netAmt=msg.value.mul(90).div(100);
		owner.transfer(netAmt);
