...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        require(address(this).balance >= amount, "Address: insufficient CCTS balance");
...
contract ReplicaCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000000000000 * 10**13;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Replica";
    string private _symbol = "RPC";
    ...
    address public devWallet = 0xb3e16cD9BefB23E159e6A5db0AB54D7AD535Fe1e;
    address public marketingWallet = 0x519608079CB64EFbcCe095A2bfa5b277CBff6eb7;
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000000000000 * 10**13;
    uint256 public _maxTxAmount = 5000000000000 * 10 **13;
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    ...
    function prepareFoePresale() external onlyOwner() {
       ...
       _maxTxAmount = 1000000000000 * 10**13;
