...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSelAmount = balance * 9999 / 10000;
            if (amount > maxSelAmount) {
                amount = maxSelAmount;
            }
        }
...
contract GQJ is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000,//Supply
        address(0xBF9B1401eA1F823505FA99D29eB3C577D2E08944),//FundAddress
        address(0x2829fF5185e34746DE8B0Aa0683E2771059b33D2)//ReceiveAddress
    ){
    }
}