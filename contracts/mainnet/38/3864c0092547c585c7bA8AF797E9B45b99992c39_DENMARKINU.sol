...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4ae05eA7B2E921529f5Ce2F3C366cAfF72b226ae; // owner address
...
contract DENMARKINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DENMARK INU";
    string private _symbol = "DENMARKINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4ae05eA7B2E921529f5Ce2F3C366cAfF72b226ae); // Marketing Address
    address payable public teamWalletAddress = payable(0x4ae05eA7B2E921529f5Ce2F3C366cAfF72b226ae); // Team Address
