...
//
//
//   📱Telegram::https://t.me/FatWhalePortal
//   📱Website ::https://fatwhale.space/
/*
...
contract FatWhale is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("FatWhale", "FatWhale") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FatWhale";
    string private _symbol = "FatWhale";
