...
contract ShangHaiFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShangHai Floki"; // Edit Name
    string constant _symbol = "S'FLOKI"; // Edit Symbol
    ...
    uint256 public reflectionFee   = 4; // Edit BUSD Reward Fee
