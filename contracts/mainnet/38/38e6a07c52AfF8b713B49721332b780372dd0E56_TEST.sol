...
contract TEST is IERC20, Ownable {
    ...
    address public DEVAddress = 0xCa6956d5D42633A170f9Ded065FEF46b4622Ae48;

    IPancakeRouter02 internal uniswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IERC20 private c_busd = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    
    constructor() public {
        address _pair = pairFor(uniswapV2Router.factory(), address(this), address(c_busd));
        pair = _pair;
