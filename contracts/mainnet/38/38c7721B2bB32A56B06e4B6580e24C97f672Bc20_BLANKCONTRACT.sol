...
/**
TELEGRAM: https://t.me/MonaLisaInu
   */                                                                       
...
contract BLANKCONTRACT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MONALISAINU";
    ...
    uint256 public _maxTxAmount = 100 * 10**5 * (10 ** _decimals);
    uint256 public _walletMax = 200 * 10**5 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        devWallet = 0xf8b586B5d1c16626c42Cad28C1D29950e283fC36;
	...
	require(newLiqFee <= 10);
        liquidityFee = newLiqFee;
	require(newRewardFee <= 10);
        rewardsFee = newRewardFee;
	require(newMarketingFee <= 10);
        marketingFee = newMarketingFee;
	require(newExtraSellFee <= 20);
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare}("");
        (bool tmpSuccess1,) = payable(devWallet).call{value: devShare}("");
