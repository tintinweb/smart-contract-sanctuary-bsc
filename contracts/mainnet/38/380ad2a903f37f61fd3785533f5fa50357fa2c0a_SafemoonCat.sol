...
contract SafemoonCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafemoonCat";
    string private constant _symbol = "SAFEMOONCAT";
