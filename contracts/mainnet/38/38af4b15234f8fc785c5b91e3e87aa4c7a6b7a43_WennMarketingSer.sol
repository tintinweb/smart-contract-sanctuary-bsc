...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6168f99AE5498974fe554FA5080115106209B40d;
...
contract WennMarketingSer is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x14F5580807B12Ed72B30649848b12b854e435CB7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WennMarketingSer";
    string private _symbol = "WMS";
