...
contract FEGSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "FEGSquidGrow";

    string private _symbol = "FSG";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xEc473865C88D66786D49511792ae6CF5DBE18e7b;
