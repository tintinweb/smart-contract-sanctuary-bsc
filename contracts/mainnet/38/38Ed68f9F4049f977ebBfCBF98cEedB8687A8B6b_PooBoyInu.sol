...
contract PooBoyInu is IBEP20, Auth {
    ...
    string constant _name = "PooBoyInu";
    string constant _symbol = "POOBOY";
    ...
    address public MarketingFeeReceiver =
        0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8;
    ...
    constructor() Auth(address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8)) {
        ...
        isFeeExempt[address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8)] = true;
        isTxLimitExempt[address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8)] = _totalSupply;
        emit Transfer(address(0), address(0xBa42D59f3e6fAd6aad1F3d2EdEd8FD95379c6Af8), _totalSupply);
    }
