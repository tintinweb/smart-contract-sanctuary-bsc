...
library Address{
 ...
 contract BabyOvermoon is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB3C73a528121DA49E967fF22A2E4f451561D72e3;
    address public donationWallet = 0xB3C73a528121DA49E967fF22A2E4f451561D72e3;

    string private constant _name = "BabyOvermoon";
    string private constant _symbol = "BOVM";
    ...
    Taxes public sellTaxes = Taxes(1, 14, 1, 0);
