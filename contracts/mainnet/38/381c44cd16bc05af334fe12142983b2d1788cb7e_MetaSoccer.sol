...
contract MetaSoccer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta Soccer";
    string private _symbol = "MSR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB8c2F322bd5046109CBed0FF437Ac19840039045);
    address payable public teamWalletAddress = payable(0xB8c2F322bd5046109CBed0FF437Ac19840039045);
