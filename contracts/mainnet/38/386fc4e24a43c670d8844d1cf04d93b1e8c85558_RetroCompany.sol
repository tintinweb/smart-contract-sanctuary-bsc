...
/*
🌿Retro Company On Pancakeswap Today, 100% community owned
🌿Let's make the candles green like the branches that grow with Retro company

🔶Project name: Retro Company
🔶 Token symbol: $RETRO
🌟 Fair launch project

🔶CA : Not launched yet

🔸 Liquidity 1,000,000,000,000 RETRO
🔸KYC Verified
🔸The contract has been audited
🔸SAFU contract
🔸Doxxed Team
🔸Main Partner
  chat : https://t.me/RetrocompanyToken
...
contract RetroCompany is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Retro Company";
    string private _symbol = "Retro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x854c7fA6B9aBAf29e69b4e22290aB3cad40a15DD);
    address payable public teamWalletAddress = payable(0x854c7fA6B9aBAf29e69b4e22290aB3cad40a15DD);
