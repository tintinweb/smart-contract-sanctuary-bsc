...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64698759dA7FcCca6AD0236c7e52a8120682F28c;
...
contract DeFiAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD83c875e0e9c95A7C45e7AE5A0499e1487b98b80;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DeFi AI";
    string private _symbol = "DFAI";
