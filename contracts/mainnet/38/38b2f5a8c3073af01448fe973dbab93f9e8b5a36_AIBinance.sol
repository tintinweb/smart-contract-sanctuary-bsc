...
contract AIBinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI Binance"; //
    string private constant _symbol = "ABN "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xFF514443a1b796726B12959620ec9617fc3F8dBA;
    ...
    function transferToken(uint256 tokens) public {
        ...
        _basicTransfer(address(this), _marketingWallet, tbalance);
    }
