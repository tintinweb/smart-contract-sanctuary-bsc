...
contract Diyici is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"第一次"; // 
    string private constant _symbol = unicode"第一次"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xDb0E307889cFcAbc409454905b0B012B69B362AA;
