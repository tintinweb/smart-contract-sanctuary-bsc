...
/**
*/
// Telegram : https://t.me/SquidPlayBSC
// Website : https://squidplay.network
...
contract squidplay is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xe39db3b02Df0283b4675AE5c76DB0bb2F94c4163));
    address payable public devWallet =
        payable(address(0x45Ff750CB1f7D8EcF48f2A3f20a42eA1DCBa259D));
    address public liquidityReceiver =
        0x45Ff750CB1f7D8EcF48f2A3f20a42eA1DCBa259D;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Squid Play";
    string private _symbol = "SquidPlay";
    ...
    uint256 private numTokensSellToAddToLiquidity = 6000000 * 10**9;
