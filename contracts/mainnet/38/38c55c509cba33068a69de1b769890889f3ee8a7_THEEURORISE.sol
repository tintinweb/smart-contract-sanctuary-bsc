...
Telegram : https://t.me/eurorisecommunity
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB770bfb9099CBbE56Ad8358f2bA14cEb6efC02F2;
...
contract THEEURORISE is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 150000000 * 10**9; //
    string private constant _name = "THE EURO RISE"; // 
    string private constant _symbol = "$EURORISE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xB770bfb9099CBbE56Ad8358f2bA14cEb6efC02F2);
