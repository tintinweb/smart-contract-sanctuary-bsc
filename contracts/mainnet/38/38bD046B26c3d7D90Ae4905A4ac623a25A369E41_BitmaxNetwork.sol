...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF99d2c74a9629901DE588Bd00f08aD24257DFcC0; // owner address
...
contract BitmaxNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bitmax Network";
    string private _symbol = unicode"BMXNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF99d2c74a9629901DE588Bd00f08aD24257DFcC0); // Marketing Address
    address payable public teamWalletAddress = payable(0xF99d2c74a9629901DE588Bd00f08aD24257DFcC0); // Team Address
