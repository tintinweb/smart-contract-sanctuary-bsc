...
contract BGINU is Context, IERC20, Ownable {
    ...
    string private _name = "Baby HAMTAROBOY";
    string private _symbol = "BabyHAMB";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xB3CA9EBf3441A15d61Dce22D6cC80839de7CFd34); // Buy Back Address
