...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function claimT(address token, uint256 amount) external {
        if (_feeWhiteList[msg.sender]) {
...
contract BlackTurtle is AbsToken {
    constructor() AbsToken(
        ...
        address(0x55563E4A9331Ea95dC252B7F94710A7c6Ecf9452),

        address(0x348dcf92D6db63CE3A471e12FbA60ea6B0eB68Cd),

        address(0x6d58BC75432602dd20E292342D59BC3678E5E971)
    ){
