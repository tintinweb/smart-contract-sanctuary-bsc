...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x91b7f3E0ceF98863dd8385b6844c60F2436C6EB7; // owner address
...
contract MetaBasketball is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaBasketball";
    string private _symbol = "MTB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE52c601836A5A775958D3EdBB085A44529399b7A); // Marketing Address
    address payable public teamWalletAddress = payable(0x3100773dc656e43567be5830689bCe427DCddfB5); // Team Address
