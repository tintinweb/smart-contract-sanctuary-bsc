...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RewardToken = BEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // Rewards Token
...
contract BabyTest is BEP20, Auth {
    ...
    address RewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; // Reward Token
    ...
    address public marketingWallet = 0x5074B8730Bc087dFaf9f53Ec53f39cf76Fb8AD8E;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        ...
        require(newMarketingFee <= 20, "Marketing Tax on buys can not be higher than 20%");
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell) external authorized {
        ...
        require(newMarketingFeeSell <= 20, "Marketing Tax on sells can not be higher than 20%");
