...
contract SpaceCatcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Space Cat Coin";

    string private _symbol = "Space Cat Coin";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xeE29D9D215dD649DD6B4b780390b93020500aD1f;
