...
contract YourContract is Context, IERC20, Ownable {
    ...
    string private _name = "ABE74";
    string private _symbol = "ABE74";
    ...
    address payable public marketingWalletAddress = payable(0x896C12015A9923d30b454aB2400F7a9142805eE4);
    address payable public liquidityWalletAddress = payable(0x2330e1B882FbaC24B37d4B9De92C039c20F43527);
    ...
    uint256 private minimumTokensBeforeSwap = 21000 * 5 **_decimals; 
    ...
    constructor () {
       //  okx 0x069A306A638ac9d3a68a6BD8BE898774C073DCb3
