...
contract Woofiinu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Woofi Inu";
    string private _symbol = "WOOFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00D6e89F5262eE4106442b44B2737Bd4509f1AEe);
    address payable public liqWalletAddress = payable(0x00D6e89F5262eE4106442b44B2737Bd4509f1AEe);
    ...
    uint256 public _maxTxAmount =  630000000* 10**_decimals;
    uint256 public _walletMax =     630000000* 10**_decimals;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1011CFdeC046DfDE0Ea555BbCBE8F6f6F9E9D88e);
