...
/** @title MetaFlokiAvatarsSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract MetaFlokiAvatarsLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    IERC20 public MetaFlokiAvatars;
     ...
     * @param _MetaFlokiAvatars: address of the MetaFlokiAvatars token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _MetaFlokiAvatars, address _randomGeneratorAddress) {
        MetaFlokiAvatars = IERC20(_MetaFlokiAvatars);
        ...
        nonReentrant
    {
        ...
        // Calculate number of MetaFlokiAvatars to this contract
        ...
        // Transfer MetaFlokiAvatars tokens to this contract
        MetaFlokiAvatars.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function claimTickets(
        ...
        MetaFlokiAvatars.safeTransfer(msg.sender, rewardInCakeToTransfer);
    ...
    /**
     * @notice Draw the final number, calculate reward in MetaFlokiAvatars per group, and make lottery claimable
     * @param _lotteryId: lottery id
     * @param _autoInjection: reinjects funds into next lottery (vs. withdrawing all)
     * @dev Callable by operator
     */
        ...
        nonReentrant
    {
        ...
        // Calculate prizes in MetaFlokiAvatars for each bracket by starting from the highest one
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                // A. No MetaFlokiAvatars to distribute, they are added to the amount to withdraw to treasury address
            } else {
        ...
        // Transfer MetaFlokiAvatars to treasury address
        MetaFlokiAvatars.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in MetaFlokiAvatars token
     * @dev Callable by owner or injector address
     */
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        require(_lotteries[_lotteryId].status == Status.Open, "Lottery not open");

        MetaFlokiAvatars.safeTransferFrom(address(msg.sender), address(this), _amount);
     ...
     * @dev Callable by operator
     * @param _endTime: endTime of the lottery
     * @param _priceTicketInCake: price of a ticket in MetaFlokiAvatars
     * @param _discountDivisor: the divisor to calculate the discount magnitude for bulks
     * @param _rewardsBreakdown: breakdown of rewards per bracket (must sum to 10,000)
     * @param _treasuryFee: treasury fee (10,000 = 100%, 100 = 1%)
     */
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(MetaFlokiAvatars), "Cannot be MetaFlokiAvatars token");
    ...
    /**
     * @notice Set MetaFlokiAvatars price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInCake: minimum price of a ticket in MetaFlokiAvatars
     * @param _maxPriceTicketInCake: maximum price of a ticket in MetaFlokiAvatars
     */
     ...
     * @param _priceTicket price of a ticket (in MetaFlokiAvatars)
