...
abstract contract Kingdom_Vault is Ownable, ReentrancyGuard, Pausable {
    // Maximises yields in Belt, fork of StratX2 by Autofarm, modified by @fbslo
    ...
    bool public isAutoComp; // this vault is purely for staking
    ...
    address public mainFarmAddress;
    address public CUBAddress;
    ...
    address[] public earnedToCUBPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(mainFarmAddress, _wantAmt);
...
contract Cub_Kingdom_Vault_Belt_2 is Kingdom_Vault {
    ...
    constructor(
        ...
        bool _isAutoComp,
        address[] memory _earnedToCUBPath,
        ...
        mainFarmAddress = _addresses[2];
        CUBAddress = _addresses[3];
        ...
        earnedToCUBPath = _earnedToCUBPath;
        ...
        belt4PoolAddress = _addresses[12];

        transferOwnership(mainFarmAddress);
    }
