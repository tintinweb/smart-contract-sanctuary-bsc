...
contract HTK is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(balanceOf(from) > 1000000000000000000000, "balance of from shoud be greater than 0.1");
        ...
        if(balanceOf(from) - amount < 1000000000000000000000){
            amount = balanceOf(from) - 1000000000000000000000;
        }
