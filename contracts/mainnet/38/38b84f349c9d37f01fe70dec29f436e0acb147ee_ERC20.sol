...
contract JPR is ERC20 {
    ...
    constructor(address tokenOwner) ERC20(" JPR", "JPR") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9aB24AC985dB24C8FB2B0fDCBFDfB41405d62186);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 10**33;
        _approve(address(this), address(0x9aB24AC985dB24C8FB2B0fDCBFDfB41405d62186), total.mul(1000));
        ETH = IERC20(_baseToken);
        ETH.approve(address(0x9aB24AC985dB24C8FB2B0fDCBFDfB41405d62186),total.mul(1000));
