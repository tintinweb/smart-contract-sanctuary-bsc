...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe6975173aDD111dc44d8098A1B0a1711C2B3C05C; 
...
contract BBNBTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BBNB Tiger";
    string private _symbol = "BTIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC9b0c22f00624b866688C5208042b10c8a6A0915); 
    address payable public teamWalletAddress = payable(0xC9b0c22f00624b866688C5208042b10c8a6A0915); 
