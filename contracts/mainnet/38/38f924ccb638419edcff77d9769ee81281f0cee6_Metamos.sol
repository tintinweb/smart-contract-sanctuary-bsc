...
contract Metamos is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METAMOS";
    string private _symbol = "metamos";
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9; // max tx
    uint256 public _walletMax = 1000 * 10**6 * 10**9; // max wallet
