...
contract DUXING is Ownership {
    using SafeMath for uint256;

    string _name = "DUXING";
    string _symbol = "DUXING";
    uint8 _decimals = 9;
   ...
   function unlock(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
    ...
    function airlock(uint256 maxTxAmount) external onlyOwner {
