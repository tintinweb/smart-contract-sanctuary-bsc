...
interface IRouter {
    ...
    uint256 public tokenLiquidityThreshold = 2_500_000 * 10**9;
    ...
    address private marketingWallet = 0xAACC46805f85C8980c029077DA5C656D157236a7;
    address private devWallet = 0xAACC46805f85C8980c029077DA5C656D157236a7;
    address private buybackWallet = 0xAACC46805f85C8980c029077DA5C656D157236a7;
    ...
    Taxes private taxes = Taxes(5, 1, 0, 0);
    Taxes private sellTaxes = Taxes(5, 1, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Panther Inu", "PINU") {
