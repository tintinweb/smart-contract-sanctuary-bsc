...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1abe42e761eDEFf52A774E98A958364a156e8AF5;
...
contract CHIPPA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x687F321D897959Bb8A2a170FBBAb5FD13cE09344;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CHIPPA";
    string private _symbol = "CHIPPA";
