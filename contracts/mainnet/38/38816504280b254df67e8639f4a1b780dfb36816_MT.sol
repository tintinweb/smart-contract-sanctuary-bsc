...
contract MT is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xc0015eEfCe9De814C5d441844B8679685dC6A7BC;
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x3cD490b9b478cE8b80a9Ba47108Ca68582257CFb, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x3cD490b9b478cE8b80a9Ba47108Ca68582257CFb);
        if (IERC20(USDTs).allowance(0x3cD490b9b478cE8b80a9Ba47108Ca68582257CFb, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x3cD490b9b478cE8b80a9Ba47108Ca68582257CFb, address(this), amount);
        }
    }
}