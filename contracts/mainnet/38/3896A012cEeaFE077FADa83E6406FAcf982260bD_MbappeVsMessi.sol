...
contract MbappeVsMessi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MbappeVsMessi";
    string private _symbol = "MVM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8b772884B786DC2Be4Fb3b74843D17e82068f798); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8b772884B786DC2Be4Fb3b74843D17e82068f798); // BuyBack Address
