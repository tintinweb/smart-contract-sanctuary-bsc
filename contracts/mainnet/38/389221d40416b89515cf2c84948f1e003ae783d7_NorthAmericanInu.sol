...
*/
 /** NORTH AMERICAN INU - Elon Tweet Coin

    North American Inu! - $NAI

    We aim to be the new Meme token from BSC to reach the millions ! 

    Ascension to the top of the BSC is the mission.  $NAI is a BEP-20 token inspired by Elon's  bullish tweet. 

    Total Supply: 10,000,000,000,000,000
    Max Wallet: 4% (400,000,000,000,000 Tokens)
    Max Transaction: 2% (200,000,000,000,000 Tokens)
    Buy / Sell Tax: 3%

// TG:https://t.me/NorthAmericanInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Mainnet
...
contract NorthAmericanInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x880b4C1199c05e9091a3a0b2aea36698e14EF23d;
 
    string constant _name = "NORTH AMERICAN INU";
