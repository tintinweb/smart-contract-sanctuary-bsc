...
contract TTT is IBEP20, Auth {
    ...
    string constant _name = "4x^2-4x+1=4088484";
    string constant _symbol = "x=2023";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 202300 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2023 * (10 ** _decimals);  // .1% max tx
    uint256 public _maxWalletSize = 2023 * (10 ** _decimals);  // .1% max wallet
    ...
    address private marketingFeeReceiver = 0x696C1F3848EaFDA7dfc12351ce964d80A8853680;
    address private teamFeeReceiver = 0x696C1F3848EaFDA7dfc12351ce964d80A8853680;
    ...
    uint256 public swapThreshold = 2023 * (10 ** _decimals); // 0.3%
    bool inSwap;
