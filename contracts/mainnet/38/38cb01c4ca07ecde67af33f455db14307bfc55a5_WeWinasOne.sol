...
contract WeWinasOne is Context, IERC20, Ownable {
    ...
    string private constant _name = "We Win as One"; // 
    string private constant _symbol = "ONE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xEa9C1ddc7C1723fb02e6d7da461cc6Cc3e6C9561;
