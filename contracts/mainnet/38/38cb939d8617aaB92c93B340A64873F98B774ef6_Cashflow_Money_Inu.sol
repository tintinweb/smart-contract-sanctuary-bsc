...
contract Cashflow_Money_Inu is IBEP20, Ownable {
    ...
    uint256 private constant _totalSupply = 4_200_000 * 10**_decimals;   //Token Decimals
    ...
    uint256 public totalBuyFee = 14;    //Total Buy Fee
    uint256 public totalSellFee = 14;   //Total Sell Fee
