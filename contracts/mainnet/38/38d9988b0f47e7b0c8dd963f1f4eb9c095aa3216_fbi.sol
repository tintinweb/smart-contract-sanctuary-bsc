...
contract fbi is Context, IERC20, Ownable{
	...
	function isrecoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
			// do not allow recovering self token
			require(tokenAddress != address(this), "Self withdraw");
			IERC20(tokenAddress).transfer(owner(), tokenAmount);
		}

    function realpreLaunch(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function discludeFromReward(address account) external onlyOwner() {
