...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x530dDADf957e9D408304a116D64839DC515C76f8; // owner address
...
contract NEWCOMMUNITYBNB is Context, IERC20, Ownable {
    ...
    string private _symbol = "NEWBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x530dDADf957e9D408304a116D64839DC515C76f8); // Marketing Address
    address payable public teamWalletAddress = payable(0x530dDADf957e9D408304a116D64839DC515C76f8); // Team Address
