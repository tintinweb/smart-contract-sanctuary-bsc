...
contract POTOFGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pot of Gold";
    ...
    mapping (address => uint256) private _getReflection;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_getReflection[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _getReflection[to] = block.timestamp;
        }
