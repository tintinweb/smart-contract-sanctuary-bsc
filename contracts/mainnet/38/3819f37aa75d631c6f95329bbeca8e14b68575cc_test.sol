...
contract test is BEP20, Auth {
    ...
    string public constant name = "Ape at your own Risk";
    string public constant symbol = "TEST";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 10 * 10**5 * 10**decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x80f5c272A3D009eA56410E554B0685b0a69541e6;
        marketerFeeReceiver = 0x80f5c272A3D009eA56410E554B0685b0a69541e6;
        teamFeeReceiver = 0x80f5c272A3D009eA56410E554B0685b0a69541e6;
        devFeeReceiver = 0x80f5c272A3D009eA56410E554B0685b0a69541e6;
    ...
    function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier).div(100) <= 200, "Sell tax cannot be more than 35%");
