...
contract VOLTA is Context, IERC20, Ownable {
    ...
    address payable public projectAddress = payable(0x18D955CE5608d974C7396A924ce508b4b9c4000B); 
    address payable public developmentAddress = payable(0xa4B78e4130e3523f3ABEF4522E92a56CA2560eb3); 
    address payable public IT = payable(0x1f46671B95a85De317fFA20D114BE920e7213953); 
    address payable public vaultRewardAddress = payable(0x124741AAFc4f0aE86D1429056214dDcA2B4D8ef4); 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 20000000 * 10**9;
        _sMaxTxAmount = 20000000 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 1;
        _liquidityFee = 10;
        _bMaxTxAmount = 600000 * 10**9;
        _sMaxTxAmount = 300000 * 10**9;
        setTradingOpen(true);
    }
