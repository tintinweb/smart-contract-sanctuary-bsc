...
contract CGBS is ERC20, Ownable {
    ...
    uint256 public constant LP_SUPPLY =     45000000 * 10**18; 
    uint256 public constant VAULT_SUPPLY = 105000000 * 10**18; 

    uint256 public _maxTxAmount = 3000000 * 10**18; 
    uint256 public _walletMax = 3000000 * 10**18;
    ...
    constructor(
        ...
        isWalletLimitExempt[vaultWallet] = true;
        isWalletLimitExempt[lpRewardsWallet] = true;
        isWalletLimitExempt[rewardsWallet] = true;
        isWalletLimitExempt[marketingWallet] = true;
        isWalletLimitExempt[creatorWallet] = true;
        isWalletLimitExempt[technologyWallet] = true;
        isWalletLimitExempt[supportRewardWallet] = true;
    ...
    function swapTokenAndFees(
        ...
        if(duration < ONE_DAY){
            ...
            if(zeroVaultPeriod) {
                ...
                uint256 fees = amount.mul(2).div(1000);
