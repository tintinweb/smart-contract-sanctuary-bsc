...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6F900651FF30a712c12ec45E6bb2fFa7b903aDb2; // owner address
...
contract TribalNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tribal Network";
    string private _symbol = "TRIBAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F900651FF30a712c12ec45E6bb2fFa7b903aDb2); // Marketing Address
    address payable public teamWalletAddress = payable(0x6F900651FF30a712c12ec45E6bb2fFa7b903aDb2); // Team Address
