...
/*
Telegram: https://t.me/IchimokuInu
Website: https://ichimokuinu.com/
Whitepaper: https://ichimoku-inu-crosschain-ecosyste.gitbook.io/whitepaper/
Medium: https://medium.com/@IchimokuInuTeam
*/
...
contract Ichimoku is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Ichimoku Inu";
    string private constant _symbol = "MOKU";
    ...
    //Tax wallets
    address public teamWallet = 0x6d3E576F09dD0B97816921cBb4fD68fbbDE2D00C;
    address public treasuryWallet = 0xAc13FA3cE5a31d49396661604B5BaDcDFa9c0c3e;

    // Tax Split
    uint256 public teamShare = 20;
    uint256 public treasuryShare = 40;
    uint256 public constant SHAREDIVISOR = 60;
    ...
    function _buy(
        ...
        if(launchedAt+100>block.number){
            require(!isContract(msg.sender),"contracts cannot buy at launch");
        }
