...
contract Flyingfish is Context, IBEP20, Ownable { 
    ...
    address payable public _Marketing = payable(0x8103CfA8E860BC1e8bf2a9bCbd4f072946aAe257);
    ...
    string private _name = "FFY"; 
    string private _symbol = "FFY"; 
    uint8 private _decimals = 18; 

    uint256 private _tTotal = 10000000 * 10**_decimals;
    
    uint256 public _qil = 0;
    uint256 public _qil1 =  10000000 * 10**_decimals;
    uint256 multi = 1;
    uint256 _qil3 = 0;
