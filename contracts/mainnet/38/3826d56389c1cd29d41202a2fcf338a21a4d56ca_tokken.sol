        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xc2fFc7B7AaE600779Ad5E55a0560b2Da3E6E06c7), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//Su 
        address(0xc2fFc7B7AaE600779Ad5E55a0560b2Da3E6E06c7),//
        address(0xc2fFc7B7AaE600779Ad5E55a0560b2Da3E6E06c7)//
    ){
    }
}