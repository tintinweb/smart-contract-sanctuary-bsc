...
contract CawTori is Context, IERC20, Ownable {
    ...
    string private _name = "A Hunting Dream";
    ...
    RouterTwo public immutable ToriRouter;
    address public immutable toriPair;
    ...
    constructor() public {
        ...
        RouterTwo _ToriRouter = RouterTwo(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
        toriPair = ToriFactory(_ToriRouter.factory()).createPair(
            address(this),
            _ToriRouter.WETH()
        );
        ToriRouter = _ToriRouter;
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = ToriRouter.WETH();
        _approve(address(this), address(ToriRouter), tokenAmount);
        ToriRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
            address(this),
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        _approve(address(this), address(ToriRouter), tokenAmount);
        ToriRouter.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0,
            0,
