...
Telegram : https://t.me/ILLUMINATICAT_TG
*/
...
contract IlluminatiCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Illuminati Cat"; 
    string private _symbol = "IlluminatiCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x627804E77315686C6a6660091E5bB62a4110C99A);
    address payable public teamWalletAddress = payable(0x627804E77315686C6a6660091E5bB62a4110C99A);
