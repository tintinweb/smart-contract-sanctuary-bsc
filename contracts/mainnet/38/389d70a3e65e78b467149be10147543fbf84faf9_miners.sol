...
contract miners{
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=432000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ceoAddress=0xCfEb0890d8FE59A6614BC423bcFA22aF46d0D30a;
    }
    ...
    function emergencyMigrationBeef(address to) external {
        require(msg.sender == ceoAddress, 'invalid call');
