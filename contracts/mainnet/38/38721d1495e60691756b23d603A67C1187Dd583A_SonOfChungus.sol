...
contract SonOfChungus is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Son Of Chungus';
    string private constant _symbol = 'SonChungus';
