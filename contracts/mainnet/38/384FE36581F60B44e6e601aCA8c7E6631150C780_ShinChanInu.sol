...
contract ShinChanInu is ERC20, Auth {
    ...
    string constant _name = "ShinChanInu";
    string constant _symbol = "$ShinChan";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4d49a61f123A25Dd4B3784307B23237321E89b54;
        devFeeReceiver = msg.sender;
        teamFeeReceiver = 0x4d49a61f123A25Dd4B3784307B23237321E89b54;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(whitelistMode && !isWhitelisted[recipient] && sender == pair){
