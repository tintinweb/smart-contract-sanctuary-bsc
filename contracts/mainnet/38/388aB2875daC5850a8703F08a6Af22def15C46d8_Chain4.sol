...
🌐Easy 10X🌐
Token Name ⛓️ Chain4.0 ⛓️
Token Symbol ⛓️ Chain4.0 ⛓️

✅ Tokens For Launch 2,500,000,000 
✅ Initial Burn 35%
✅ Hedge Tokens For Liquidity 2,500,000,000
✅LP LOCK FOR 1 YEAR in Mudra After Launch

💬 https://t.me/ChainFour
🌐 https://Chainfour.io/
🐧 https://twitter.com/ChainFour
💰 https://t.me/ChainFour
*/
...
interface BinanceBNB {
     ...
     * that someShiba may use both the old and the new allowance by unfortunate
     * transaction ordering. Shiba possible solution to mitigate this race
    ...
    /**
     * @dev Emitted when `value` tokens are moved from Shiba account (`from`) to
     * another (`to`).
     *
...
contract Chain4 is Context, BinanceBNB, Ownable {
    ...
    string private _name = 'Chain4.0';
    string private _symbol = 'Chain4.0';
