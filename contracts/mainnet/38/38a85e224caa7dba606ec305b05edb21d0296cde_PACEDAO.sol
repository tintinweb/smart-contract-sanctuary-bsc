...
contract PACEDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "PACEDAO";
    string public _symbol = "PACEDAO";
    uint8  public _decimals = 8;

    address payable public marketingWalletAddress = payable(0x882aDA4a5ac673B21fFF8C026d064406eA3B8188); 
    ...
    constructor () {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x882aDA4a5ac673B21fFF8C026d064406eA3B8188); 
