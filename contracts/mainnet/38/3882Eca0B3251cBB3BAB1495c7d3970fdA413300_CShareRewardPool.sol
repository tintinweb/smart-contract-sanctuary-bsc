...
contract CShareRewardPool {
    ...
    uint256 public constant withdrawFee = 600;
    ...
    uint256 public cSHAREPerSecond = 0.00176 ether; // 59500 cshare / (370 days * 24h * 60min * 60s)
    uint256 public runningTime = 365 days; // 365 days
    uint256 public constant TOTAL_REWARDS = 55500 ether;
