...
contract XrpGrow is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    address private _owner;

    string private constant _name = "XRP Grow";
    ...
    address payable public DevWallet = payable(0xb392FD6DAcea7bfb4363b662B2125B2ADfA38Fd6);
    address payable public MarketingWallet = payable(0x6912C56BF6172Ca595c6e4091A84484C2905478c);
    address payable private TeamWallet01 = payable(0x76F6456FB97F454bA0f28490D65078240E4cdC86);
    address payable private TeamWallet02 = payable(0x2A5A3417e522875D5E898461d22d67e49cA2A5ff);
    address payable private TeamWallet03 = payable(0xa93D214d65510E292b89e630c8A707F1B894D5e8);
