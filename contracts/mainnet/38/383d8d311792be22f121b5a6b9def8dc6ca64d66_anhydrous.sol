...
contract anhydrous is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100 * 10**_decimals; //
 
    string private constant _name = "anhydrous"; // 
    string private constant _symbol = unicode"ANH"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(_marketingWallet).transfer(ethToSend); //marketing wallet
    }
