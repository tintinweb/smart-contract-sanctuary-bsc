...
contract BuddhaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA9B8A8a82F9f54f7633f70B27f33a96E5144Ec8c); 
    address payable public Wallet_Dev = payable(0xA9B8A8a82F9f54f7633f70B27f33a96E5144Ec8c);
    ...
    string private constant _name = "BuddhaInu"; 
    ...
    constructor () {
        ...
        _owner = 0xA9B8A8a82F9f54f7633f70B27f33a96E5144Ec8c;
