...
/*
stealth launch, no private sale, marketing launch on 13/05, be the first.
*/
...
contract Moveyourass is IBEP20, Ownable
{
    ...
    string private constant _name = 'MoveYourAss';
    string private constant _symbol = '$MYA';
    ...
    address public TeamWallet=payable(0xD028164Ce8494594a253901eeE1012F8F33a38d0);
    address public walletTwo=payable(0xD028164Ce8494594a253901eeE1012F8F33a38d0);
