 ...
 */
contract cryptovoexls{
    using SafeMath for uint256;

    uint256 private _totalSupply = 70*10**6 * 10**18;
    string private _name = "cryptovoexls";
    string private _symbol = "CORL";
    ...
    uint256 private salePrice = 150000; // 1 BNB
    ...
    constructor() public {
        _devAddress = 0x1aF655695d6d6620fc3f026C5392d94A479AC17b; // LA
        _presaleAddress = 0x61405f7FbeeFBd79062609F155f039e5b64D884e; // TO
        address _BurnAddress = 0xD8A4235e62D71f81001117729a93944d74dC4ac4; // MA
        _owner = msg.sender;

        
        _mint(_presaleAddress, 15000000*10**18);

    
        _mint(_devAddress, 30000000*10**18);

    
        _mint(_BurnAddress,2500000*10**18);
    }
   ...
   function endPresale() public onlyOwner {
    ...
    function buyPresale(address _refer) payable public returns(bool){
        ...
        uint referToken = _token.mul(_referToken).div(150000);
