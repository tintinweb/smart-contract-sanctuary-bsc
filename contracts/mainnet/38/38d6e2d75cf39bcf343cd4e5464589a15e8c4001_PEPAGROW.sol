...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04C65dc72f9e42e7f9E194144Cc5239790F4dE8D; // owner address
...
contract PEPAGROW is Context, IERC20, Ownable {
    ...
    string private _name = "PEPA GROW";
    string private _symbol = "PEPAGROW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x04C65dc72f9e42e7f9E194144Cc5239790F4dE8D); // Marketing Address
    address payable private teamWalletAddress = payable(0x04C65dc72f9e42e7f9E194144Cc5239790F4dE8D); // Team Address
