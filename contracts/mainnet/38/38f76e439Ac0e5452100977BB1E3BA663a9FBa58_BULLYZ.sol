...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb92f28358C8D944A2046A3d5BC1b5567F03029C8; //
...
contract BULLYZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bullyz Inu"; // 
    string private constant _symbol = "Bullyz Inu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xC3cB627354621C14cede9d2E3eb351Dde5451Eb1); //
