...
/**
 *                          
 *      Join our Telegram group at:   https://t.me/Charles_Inu
*/         
...
contract CHARLES is ERC20, Ownable {
    ...
    constructor() ERC20("Charles Inu", "$EARS") {
        
        address newOwner = address(0xf6E05fA79fA9862807A0fC0405C9c14429b4999E);
    	...
    	marketingWallet = address(0xf6E05fA79fA9862807A0fC0405C9c14429b4999E); // Marketing and Brewery taxes are coming here. 40% to brewery, 60% stay in marketing
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xf6E05fA79fA9862807A0fC0405C9c14429b4999E),
            block.timestamp
        );
