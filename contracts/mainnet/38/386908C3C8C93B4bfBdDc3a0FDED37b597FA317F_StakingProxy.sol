...
contract StakingProxy is Ownable {
    ...
    constructor(
        address _cadt, // CADT Token contract address
        address _scadt, // sCADT Token contract address
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        require(_amount != 0); // why would anyone need to stake 0 CADT?
        ...
        claims[_recipient] = Claim({
            ...
            gons: claimInfo.gons.add(IsCADT(sCADT).gonsForBalance(_amount)),
    ...
    function claim(address _recipient) public {
        ...
        IERC20(sCADT).transfer(_recipient, IsCADT(sCADT).balanceForGons(claimInfo.gons));
    }
