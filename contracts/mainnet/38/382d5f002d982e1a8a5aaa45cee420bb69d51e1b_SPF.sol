...
contract SPF is Context, IERC20, Ownable {
    ...
    uint256 public takeLPRewardAmount = 1 * 10**18;
    ...
    address public developerAddress = address(0x77aebAabb657B9016aeeAF46aB92A6e49B4A0bb2);
    ...
    constructor() public {
        ...
        _isExcludedFromFee[address(0x4b1a8734644382Ea3392d6C28B1993522E69d001)] = true;
        _isExcludedFromFee[address(0x3f8785F8332A46691959c152ba77B4778AAD4e90)] = true;
        _isExcludedFromFee[address(0x366692db7640127873FD338650C8010Dde700c26)] = true;
        _isExcludedFromFee[address(0x77aebAabb657B9016aeeAF46aB92A6e49B4A0bb2)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 500000 * 10**18;
        _balances[address(0x4b1a8734644382Ea3392d6C28B1993522E69d001)] = 480000 * 10**18;
        _balances[address(0x3f8785F8332A46691959c152ba77B4778AAD4e90)] =  10000 * 10**18;
        _balances[address(0x366692db7640127873FD338650C8010Dde700c26)] =  10000 * 10**18;

        emit Transfer(address(0), address(0x4b1a8734644382Ea3392d6C28B1993522E69d001), 480000 * 10**18);
        emit Transfer(address(0), address(0x3f8785F8332A46691959c152ba77B4778AAD4e90),  10000 * 10**18);
        emit Transfer(address(0), address(0x366692db7640127873FD338650C8010Dde700c26),  10000 * 10**18);

        doAddKol(address(0x473f448513cFED1e0Bb347fEcCb9835A1C2FcDFe));
    }
