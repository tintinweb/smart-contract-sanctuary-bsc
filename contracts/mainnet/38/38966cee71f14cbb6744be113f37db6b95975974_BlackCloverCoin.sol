...
// TELEGRAM : https://t.me/BlackCloverCoin
// WEBSITE : https://black-clover.io
...
contract BlackCloverCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackCloverCoin";
    string private _symbol = "$DRAKEN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9672BcEa232C1855bc77B37920779A53541ab639); // Marketing Address
    address payable public teamWalletAddress = payable(0x9672BcEa232C1855bc77B37920779A53541ab639); // Team Address
