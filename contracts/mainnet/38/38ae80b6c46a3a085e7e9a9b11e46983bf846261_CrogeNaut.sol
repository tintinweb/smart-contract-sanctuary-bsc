...
Telegram : https://t.me/CrogeNaut_Portal
*/
...
contract CrogeNaut is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrogeNaut";
    string private _symbol = "$CNaut";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x29a4C7848E0188cc65787174c5250e679C2A4294); // Marketing Address
    address payable public teamWalletAddress = payable(0xe1F39E360a3c2AC72bE63744873bB94AB3CD2E26); // Team Address
