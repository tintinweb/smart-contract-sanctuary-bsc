...
// https://t.me/MUDRAKILLER
// https://twitter.com/mudrakiller
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x8d331bc13c60d723f2e517cD890AEFa70D6ce163;
...
contract MudraKiller is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Mudra Killer"; 
    string private constant _symbol = unicode"Mudrakill"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x8d331bc13c60d723f2e517cD890AEFa70D6ce163), BNB_Tot);
            }
