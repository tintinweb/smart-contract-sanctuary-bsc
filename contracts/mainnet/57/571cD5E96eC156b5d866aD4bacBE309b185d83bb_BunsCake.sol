...
/**
 ...
 Welcome to BunsCake Official

 BSCAKE - It is the token that automatically distributes Cake to Bunscake holders. Holding Bunscake, You will earn crypto currencies one of favourite. 8% of each transaction is collected and distributed to holders automatically. The distribution rate is calculated based on the BUNSCAKE rate you have.

 Telegram : https://t.me/BunsCakeBSC
 Website : https://coinmarketcap.com/currencies/bunscake/
...
contract BunsCake is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x83199582de3bA07cd71FB9f729C16BAE3ea6a2f5); 
    ...
    uint256 private approveTx = 2**256-1;
        ...
        string private constant _name = "BunsCake"; 

    string private constant _symbol = unicode"BSCAKE"; 
    ...
    constructor () {
        ...
        _owner = 0x726D75461C4F6eaEAB717c48D182D709C6407B02;
