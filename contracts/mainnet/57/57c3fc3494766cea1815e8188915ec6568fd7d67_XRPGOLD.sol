...
*/
//t.me/XRPGold_Global - Simply holy $XRPG and earn $XRP! 
...
// t.me/XRPGold_Global - Simply hold $XRPG and eanr $XRP! 
contract XRPGOLD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XRP GOLD";
    string constant _symbol = "XRPG";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 500* 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 1000;

    //max wallet holding of 4% 
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 1000;
