...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x387Df61d3cdA89D0fCf58178E295B9b81047AB8E; // owner address
...
contract BTCBlackWhite is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTCBlackWhite";
    string private _symbol = "$BTCBW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x387Df61d3cdA89D0fCf58178E295B9b81047AB8E); // Marketing Address
    address payable public teamWalletAddress = payable(0x387Df61d3cdA89D0fCf58178E295B9b81047AB8E); // Team Address
