...
contract ApeBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeBonk";
    string constant _symbol = "APEBONK";
    ...
    uint256 public totalfee        = marketingfee + reflectionfee + liquidityfee + teamfee+ devfee + burnfee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingfeeReceiver = 0x8E0813DD004c94887272746D6eed0dE110fc4860;
        teamfeeReceiver = 0xe350cb2E1BBAB516855e163F6250B89f587179bC;
        devfeeReceiver = 0xA2940a469143Cbc95E6B3477817385524bF933Ee;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingfeeReceiver && recipient != devfeeReceiver && recipient != teamfeeReceiver && recipient != autoLiquidityReceiver && recipient != burnfeeReceiver){
    ...
    function TokenSOS(address tokenAddress, uint256 tokens) public onlyOwner returns (bool) {
     if(tokens == 0){
    ...
    function BNBSOS(uint256 amountPercentage) external authorized {
    ...
    function setfees(uint256 _liquidityfee, uint256 _reflectionfee, uint256 _marketingfee, uint256 _teamfee, uint256 _devfee, uint256 _burnfee, uint256 _feeDenominator) external onlyOwner {
        ...
        teamfee = _teamfee;
        burnfee = _burnfee;
        totalfee = marketingfee + reflectionfee + liquidityfee + teamfee + devfee + burnfee;
