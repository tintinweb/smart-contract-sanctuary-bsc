...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29B7FFfBa006D9067001368215FF3Ae2d4cd0C7a;
...
contract ALLUNITE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x29B7FFfBa006D9067001368215FF3Ae2d4cd0C7a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ALL UNIT";
    string private _symbol = "AUNT";
