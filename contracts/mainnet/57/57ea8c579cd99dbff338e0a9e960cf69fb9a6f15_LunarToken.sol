...
// of a most famous crypto $Luna and the greatest public chain named Terra.
// We present to your attention the new Lunar token and a new DAO to Rescue $Luna.
...
// 🌶 90% Distribution of all The supply
// 🌶 10% Marketing

// Welcome to Lunar, a simple DAO token based on the Binance Smart Chain. All holders are passively rewarded in $Luna for holding.
// 🌶 Low Cap Gem
// 🌶 Locked liquidity
// 🌶 New website live
...
contract LunarTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LunarToken contract."
        );
    }
...
contract LunarToken is ERC20, Ownable {
    ...
    LunarTokenDividendTracker public dividendTracker;
    ...
    address public LUNA_PAIR = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // LUNA PAIR
    ...
    constructor(
        ...
        address dividendTrackerAddress, // reward, router, marketing wallet, dividendTracker
        ...
        rewardToken = address(0x156ab3346823B651294766e23e6Cf87254d68962);
        _marketingWalletAddress = address(0x41C4A1d2a764adD71B0dFe16133D51D9E8A590cd);
        ...
        require(buyTokenRewardsFee.add(buyLiquidityFee).add(buyMarketingFee).add(buyDeadFee) <= 5, "Total buy fee is over 5%");
        require(sellTokenRewardsFee.add(sellLiquidityFee).add(sellMarketingFee).add(sellDeadFee) <= 5, "Total sell fee is over 5%");
        ...
        dividendTracker = LunarTokenDividendTracker(
