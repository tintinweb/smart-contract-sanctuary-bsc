...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x55d398326f99059fF775485246999027B3197955); //usdt,分红usdt下面的也要改
...
contract bestpeople is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "bestpeople";
    ...
    address RewardToken = 0x55d398326f99059fF775485246999027B3197955;//分红usdt

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);//数量
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3F9e0C5ceA50B14ABa733BfEAaE121b094A25616;
