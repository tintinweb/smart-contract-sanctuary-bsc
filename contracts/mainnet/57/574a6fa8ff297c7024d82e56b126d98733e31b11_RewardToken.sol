...
contract RewardToken is Ownable, IBEP20, SafeToken, LockToken {
    ...
    uint256 public _maxWallet = 5000000000 * (10**_decimals);
    ...
    uint256 public totalFee = burnFee.add(reflectionFee).add(marketingFee).add(charityFee);
    uint256 public feeDenominator = 10000;

    string constant _name = "RewardTestII";
    ...
    constructor() {
       ...
       // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Tesnet
        ...
        //marketing = owner_;
        marketing = 0x5F1d21F8c1Ce33D23ceb0C2927A6326C6B0DD619;
        charity = 0x98DEE588E7f3Ca6a450F733769E20967ea9223ee;
