...
contract USDTSeeds is Ownable {
	...
	uint256[] public SEED_PERCENTS 		= [2000, 1200, 900, 500, 300, 200, 100, 100, 100, 100,100,0,0,0,0];
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(1, 400));
		plans.push(Plan(3, 400));
		plans.push(Plan(7, 200));
        plans.push(Plan(10, 420));
        plans.push(Plan(30, 470)); 
		plans.push(Plan(60, 500));
        plans.push(Plan(90, 600)); 
        ...
        plans.push(Plan(15, 600));
        plans.push(Plan(15, 700));
		plans.push(Plan(15, 800));
		plans.push(Plan(15, 1500));
		plans.push(Plan(1, 10000));
