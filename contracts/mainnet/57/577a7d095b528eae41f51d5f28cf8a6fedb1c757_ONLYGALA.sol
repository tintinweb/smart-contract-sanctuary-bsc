...
Only Gala is 1% tax, why? 

The Only Gala is Only Inu Clone with same contract you will ever need. This contract is renounced and burn liquidity forever.

Only Gala is led by a small group of whales. We truly believe in a space where we can make wonderful projects without greedy teams profiting off of it with high taxes.
*/
...
contract ONLYGALA is IBEP20, Auth {
    ...
    string constant _symbol = "ONLY GALA";
    ...
    address private marketingFeeReceiver = 0x0c9cb7CB1fc75Aa6dc0B3BF4eC2E9Cc612700bA2;
    address private teamFeeReceiver = 0x0c9cb7CB1fc75Aa6dc0B3BF4eC2E9Cc612700bA2;
