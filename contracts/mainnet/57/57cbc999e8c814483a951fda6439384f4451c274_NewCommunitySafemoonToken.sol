...
Telegram: https://t.me/NewCommunitySafemoonToken
...
contract NewCommunitySafemoonToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Safemoon 2.0"; // 
    string private constant _symbol = "cSafemoon 2.0"; //    
    uint8 private constant _decimals = 9; // 
    bool private trading = true;
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xF23f798312ca5d4af9Fe5B28429335Fd8113d75b;
    ...
    constructor () {
        ...
        isWhitelisted[_uniswapV2Pair] = true;
    ...
    function removeFromWhitelist(address _user) public onlyOwner {
        require(isWhitelisted[_user], "user already not Whitelisted");
    ...
    function disableTrade() public onlyOwner {
        require(trading, 'Trading already disabled');
        trading = false;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[from], "Blacklisted Account");
        require(isWhitelisted[from] || trading, "Trading Disabled");
