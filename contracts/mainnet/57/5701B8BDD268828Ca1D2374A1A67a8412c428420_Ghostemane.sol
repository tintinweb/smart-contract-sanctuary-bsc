...
contract Ghostemane is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ghostemane";
    string private _symbol = "GHOST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96eBb4BEE796d67863ea2181f8c9aCB115Dd5d29); // Marketing Address
    address payable public teamWalletAddress = payable(0x96eBb4BEE796d67863ea2181f8c9aCB115Dd5d29); // Team Address
