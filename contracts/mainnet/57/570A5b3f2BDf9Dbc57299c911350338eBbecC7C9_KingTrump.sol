...
contract KingTrump is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Trump Inu"; // 
    string private constant _symbol = "$KingTrump"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x26Ff8878A3D52978f51301b4D0b75667221dd6B4;
