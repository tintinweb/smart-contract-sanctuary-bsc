...
contract LeprechaunBNB {
    ...
    function CompoundRewards(bool isCompound) public {
        ...
        if (msg.sender == dev1){buyPotOfGoldhiminers();}
    ...
    function BuyPotOfGold(address ref) public payable{
        require(contractStarted, "Contract not yet Started.");
        User storage user = users[msg.sender];
    ...
    /* How many PotOfGold per day user will receive based on BNB deposit */
    ...
    function buyPotOfGoldhiminers() private{
