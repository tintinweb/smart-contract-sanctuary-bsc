...
contract FFD is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0x7a0D72A3b3edcAeA8D0EF0ECCA98536712762Eb4);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0x5A29593169f4B0c61f08AB1d926C538AA94E76f0);
    ...
    address public ownerAddr = 0x74a1f9e88fe664493FE14Ebdd1d729366667f728;
    ...
    constructor() {
        ...
        _owner = 0x74a1f9e88fe664493FE14Ebdd1d729366667f728;
