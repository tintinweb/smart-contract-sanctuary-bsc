...
contract DOKEMOON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DokeMoon", "DOKEMOON", msg.sender) {
        ...
        buybackWallet = address(0x19635875d764606ed002F76a50c88aC6C459769E);
    ...
    function _transfer(
        ...
        if(takeFee){
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                require(balanceOf(liquidityWallet) == 0);
    ...
    function swapBack() private {
        ...
        (success,) = address(liquidityWallet).call{value: ethForTeam}("");
