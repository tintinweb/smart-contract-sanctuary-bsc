...
contract DogeAvengers is Context, IERC20, Ownable {
    ...
    string private _symbol = "DOGAVGR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC2b3C1E66cfbE4b816652352712C1EB5300145ae); // Marketing Address
    address payable private teamWalletAddress = payable(0xC2b3C1E66cfbE4b816652352712C1EB5300145ae); // Team Address
    ...
    uint256 public _maxTxAmount = 3 * 10**3* 10**6* 10**_decimals; 
