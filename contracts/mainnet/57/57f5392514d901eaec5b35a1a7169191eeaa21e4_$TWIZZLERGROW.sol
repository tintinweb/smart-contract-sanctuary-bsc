...
//
// $TWIZZLERGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TwizzlerGrowchat
//
...
contract $TWIZZLERGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("TWIZZLER GROW", "TWIZZLERGROW") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "TWIZZLERGROW";
    string private _symbol = "TWIZZLERGROW";
