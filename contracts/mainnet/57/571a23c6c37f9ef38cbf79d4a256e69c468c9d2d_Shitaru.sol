...
/**
    Shitaru 旨在成為幣安智能鏈上最大、最安全的實用模因幣。我們將繼續發展，直到我們在營銷、實用程序等方面達到頂峰。
    巨大的營銷將獲得聯繫，營銷的可能性是無窮無盡的。我們將在發佈時推出 Twitter 空間。
    Shitaru 將成為模因硬幣世界中最大的靈感之一。市場營銷、網站和 Dextools 都在一條線上。
...
contract Shitaru is ERC20, Ownable {
    ...
    constructor() ERC20("Shitaru", "SHITARU") {
        ...
        devWallet = address(0x866514D6C91Ee6ef92d91Aa3e359ef0f9cCc82A2); 
