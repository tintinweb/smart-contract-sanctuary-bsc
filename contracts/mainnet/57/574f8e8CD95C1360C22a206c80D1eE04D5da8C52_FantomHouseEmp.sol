...
contract FantomHouseEmp is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    uint256 minBet = 100000000000000000000; // default 100 EMP (When EMP was $0.30)
    ...
    uint256 minHouseDeposit = 50000000000000000000000; // default 50000 EMP (Which was around $15000)
