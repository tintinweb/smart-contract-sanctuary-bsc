...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x465cB1c1453344774d7A358e22223800291c42D5; // owner address
...
contract SOTAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SOTA INU";
    string private _symbol = "SOTA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1Cd377731f988dcB85244c8627329081F6503eB5); // Marketing Address
    address payable public teamWalletAddress = payable(0x465cB1c1453344774d7A358e22223800291c42D5); // Team Address
    ...
    uint256 public _buyMarketingFee = 36;
    uint256 public _buyTeamFee = 2;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 36;
