...
contract ApeElon is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeElon";
    string private constant _symbol = "APON";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0Cdc27382f23C5fC0461c976Ee68DEB33cFAAA0a);
    address payable private _marketingAddress = payable(0x5BeDb3f4B3147995895C92f3631E0AFAcc4B4752);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
        ...
        require(taxFeeOnSell < 28, "Tax cannot be more than 25.");
