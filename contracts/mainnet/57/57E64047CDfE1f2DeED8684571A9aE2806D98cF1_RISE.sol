...
/**
There was silence before the storm... this is trial by flames. 
The growth is up to the community.

I will watch over the chat and our holders will be able to 
...
contract RISE is IBEP20, Auth {
    ...
    address DEV = 0x47E5e8da8A98B5fa98A1DA523C4638C0c937EF92;
    ...
    // Name and symbol
    string constant _name = "RISE";
    string constant _symbol = "RISE";
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // 2% of supply, 0.7%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x47E5e8da8A98B5fa98A1DA523C4638C0c937EF92;
