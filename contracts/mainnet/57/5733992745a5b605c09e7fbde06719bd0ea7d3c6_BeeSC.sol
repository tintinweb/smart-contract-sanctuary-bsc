...
contract BeeSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BeeSC";
    string private _symbol = "BeeSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Afc3797220cb218eBEE68613968D4A1843880EA); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5Afc3797220cb218eBEE68613968D4A1843880EA); // BuyBack Address
