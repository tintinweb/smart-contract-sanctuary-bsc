...
contract MetaDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6755B49C2A735FCF53850Cf266252371bd407350);
    address payable public liqWalletAddress = payable(0x6755B49C2A735FCF53850Cf266252371bd407350);
    ...
    constructor () {
        ...
        emit Transfer(address(0x515C65E26BBF5dA731B5Ce6679b9f7fA0230B352), _msgSender(), _totalSupply);
    }
