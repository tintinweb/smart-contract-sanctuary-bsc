...
contract Token is Context, IERC20, Ownable {
    ...
    bool public _allowLiquidity = false;
    ...
    function setAllowLiquidity(bool allow) external onlyOwner {
        _allowLiquidity = allow;
    }
...
contract SBS is Token {
    constructor() Token(
        ...
        address(0xf8920E216280D6A79107d543Bc1d28B8669270C6),//owner
        address(0x1304fd6CF44A0bE31761Fee926daD047d4068164),//marketingAddress
        address(0xE5fC6470168250E364D0596c288E78F614f0e50a),//teamAddress
        address(0x55d398326f99059fF775485246999027B3197955)//usd
    ){
