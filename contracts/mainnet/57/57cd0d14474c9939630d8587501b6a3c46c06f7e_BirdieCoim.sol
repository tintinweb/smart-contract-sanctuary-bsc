...
/**
Telegram : https://t.me/birdiecoin
Website  : 

Birdie Coin is MCD favorite clown. And we created a Birdie Coin community token on the BSC network. Which will definitely have a good impact on the future. Don't miss it
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9CdEC09184Be9d3DA0B10CddA0555590198CB0cc; // owner address
...
contract BirdieCoim is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Birdie Coin";
    string private _symbol = "BIRDIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9CdEC09184Be9d3DA0B10CddA0555590198CB0cc); // Marketing Address
    address payable public teamWalletAddress = payable(0x46E1B9Bda422029cEc4F07364D2c5Cb66D2d59Ea); // Team Address
