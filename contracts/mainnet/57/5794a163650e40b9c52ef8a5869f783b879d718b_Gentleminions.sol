...
/*
  ______                        __      __                          __            __                               
 /      \                      |  \    |  \                        |  \          |  \                              
|  $$$$$$\  ______   _______  _| $$_   | $$  ______   ______ ____   \$$ _______   \$$  ______   _______    _______ 
| $$ __\$$ /      \ |       \|   $$ \  | $$ /      \ |      \    \ |  \|       \ |  \ /      \ |       \  /       \
| $$|    \|  $$$$$$\| $$$$$$$\\$$$$$$  | $$|  $$$$$$\| $$$$$$\$$$$\| $$| $$$$$$$\| $$|  $$$$$$\| $$$$$$$\|  $$$$$$$
| $$ \$$$$| $$    $$| $$  | $$ | $$ __ | $$| $$    $$| $$ | $$ | $$| $$| $$  | $$| $$| $$  | $$| $$  | $$ \$$    \ 
| $$__| $$| $$$$$$$$| $$  | $$ | $$|  \| $$| $$$$$$$$| $$ | $$ | $$| $$| $$  | $$| $$| $$__/ $$| $$  | $$ _\$$$$$$\
...
Telegram - https://t.me/GentleminionsBSC

50% Of Supply Burned At Laumch 
*/
...
contract Gentleminions is Context, IERC20, Ownable {
    ...
    uint256 private _sellLiquidityFee = 5;  // Liquidity fee 5%
    uint256 private _sellMarketingFee = 9;   // Markting fee 9%
    uint256 private _sellDevFee = 1; // Dev fee 1%
    ...
    constructor() {
        _name = "Gentleminions"; //  Name
        _symbol = "GENTM"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 10000000000 * 10**_decimals; // Total Supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 25000000 * 10**_decimals;  // 0.5% of Total Supply
        _maxTxAmount = 100000000 * 10**_decimals; // 1% of Total Supply
        _maxWalletBalance = 100000000 * 10**_decimals; // 1% of Total Supply
        _marketingWalletAddress = 0x24a2E9f6Bd92c8C62FF87A6B0784d6AF22cDcf5E; // Marketing Wallet 
        _devWalletAddress = 0xB266694bdef3aee395d8312F9a9E3bc46CEdc91e; // Dev Wallet 
