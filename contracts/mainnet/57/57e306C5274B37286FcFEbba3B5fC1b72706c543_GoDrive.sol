...
contract GoDrive is Ownable {
    ...
    function service() public{
        ...
        usdtToken.transferFrom(msg.sender,address(this),serviceUSDT);
        usdtToken.transferFrom(address(this),admin,serviceUSDT);
        UserInfo storage user = userInfo[msg.sender];
    ...
    function refuel() public{
        ...
        usdtToken.transferFrom(msg.sender,address(this),refuelUSDT);
        usdtToken.transferFrom(address(this),admin,refuelUSDT);
        UserInfo storage user = userInfo[msg.sender];
    ...
    function roadtax() public{
        ...
        usdtToken.transferFrom(msg.sender,address(this),roadtaxUSDT);
        usdtToken.transferFrom(address(this),admin,roadtaxUSDT);
        UserInfo storage user = userInfo[msg.sender];
