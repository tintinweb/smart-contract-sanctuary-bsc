...
TELEGRAM: https://t.me/CzVsVitalik
*/
...
contract CzVsVitalik is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cz VS Vitalik"; // 
    string private constant _symbol = "CVSV"; //    
