...
contract VirtualMonsters is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Virtual Monsters';
    string private constant _symbol = 'VIGIMON';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply=  1000000000000* 10**_decimals;

    uint private constant DefaultLiquidityLockTime=15 days;
