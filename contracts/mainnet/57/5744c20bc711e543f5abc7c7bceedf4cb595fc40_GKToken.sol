...
contract GKToken is IERC20, Ownable {
    ...
    address private marketAddress = 0x0c70342D9DAE610521af7F119Ef8111B99E7782C;
    address private bep20usdt = 0x55d398326f99059fF775485246999027B3197955;
   

    uint256 private _tFeeTotal;

    string private _name = "GK";
    ...
    uint256 private _tTotal = 16888 * 10**9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 10 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
