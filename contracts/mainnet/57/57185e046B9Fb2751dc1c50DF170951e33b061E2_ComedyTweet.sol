...
//Telegram:https://t.me/ComedyTweet
...
contract ComedyTweet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Comedy Tweet"; // 
    string private constant _symbol = "$CTweet"; //    
