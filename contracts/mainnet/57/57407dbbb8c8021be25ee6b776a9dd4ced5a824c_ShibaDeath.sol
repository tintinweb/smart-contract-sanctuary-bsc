...
contract ShibaDeath is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaDeath";
    string private _symbol = "SHIBDEATH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x187C47c0d6a5a8Dbe676006126416c28EA42eD80); // Marketing Address
    address payable public teamWalletAddress = payable(0x7e5ABf9D6C239eB821b57BfE9e1e187A5355EcED); // Team Address
    ...
    uint256 public _walletMax = 50000000 * 10 ** 18;
