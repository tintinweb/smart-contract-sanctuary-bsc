...
// Telegram:https://t.me/+K_mMJl9mXq4xN2Zl
...
contract DragonGodInnu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 10 / 1000; // Edit Auto-Sell: 10 = 1%
    ...
    string private constant _name = "Dragon God Innu"; // Edit name
    string private constant _symbol = "Dragon God"; // Edit Symbol
    ...
    Taxes public taxes = Taxes(2,5,3,0); // Taxes {Reflection,Marketing,LP,Auto-Burn}
