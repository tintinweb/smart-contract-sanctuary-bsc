...
/**
 * Official Russian Warship Go F#@k Yourself ($RWGFY)
*/ 
...
contract RussianWarshipGFY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Russian Warship GFY";
    string private constant _symbol = "RWGFY";
