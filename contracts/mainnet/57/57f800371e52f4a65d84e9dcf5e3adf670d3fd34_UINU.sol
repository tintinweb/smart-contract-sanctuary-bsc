...
contract UINU is BEP20, Auth {
    ...
    string public constant name = "Utility Inu";
    string public constant symbol = "UINU";
    uint8 public constant decimals = 9;

    uint256 public constant totalSupply = 100 * 10**7 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 500;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF5CD464F3c6F0aA7367036AcfC3545F1D80fA3e9;
    ...
    function tradingStatus_launchmode(uint256 confirm) external onlyOwner {
        require(confirm == 911911911,"Accidental Press"); // Love to me is so unreal
    ...
    function _updatefees() internal {
        require(totalFee.mul(buyMultiplier).div(100) < 6, "Buy tax cannot be more than 5%");
        require(totalFee.mul(sellMultiplier).div(100) < 6, "Sell tax cannot be more than 5%");
        require(totalFee.mul(transferMultiplier).div(100) < 1, "Transfer Tax will always be 0%");
