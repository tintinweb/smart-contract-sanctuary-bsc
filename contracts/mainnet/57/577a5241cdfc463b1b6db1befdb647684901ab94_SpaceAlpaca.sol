...
// Space Alpaca Private Sale is live ! Max Buy 3.0 BNB
...
contract SpaceAlpaca is Context, IERC20, Ownable {
    ...
    string private _name = "Space Alpaca Private Sale";
    string private _symbol = "Space Alpaca";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x25e2C730CA78AC22B5DcF678895B859D8Bdf694E); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x25e2C730CA78AC22B5DcF678895B859D8Bdf694E); // buyback Address
