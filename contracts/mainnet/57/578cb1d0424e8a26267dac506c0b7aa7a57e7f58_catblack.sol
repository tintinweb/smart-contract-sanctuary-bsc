...
/**
Telegram : https://t.me/cattblackbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x920b1413985B9BabdFBdc54e83debf6E00E4Ffae; // owner address
...
contract catblack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Black";
    string private _symbol = "CATBLACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x920b1413985B9BabdFBdc54e83debf6E00E4Ffae); // Marketing Address
    address payable public teamWalletAddress = payable(0x920b1413985B9BabdFBdc54e83debf6E00E4Ffae); // Team Address
