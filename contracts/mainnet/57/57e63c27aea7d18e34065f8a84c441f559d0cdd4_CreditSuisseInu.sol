...
"No, no, no, Credit Suisse is fine. Credit Suisse
is not in trouble. Don't move your money from
Credit Suisse, that's just being silly" - Jim Cramer

Telegram : https://t.me/CreditSuisseInu_Bsc
...
contract CreditSuisseInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Credit Suisse Inu";
    string private constant _symbol = "CSI";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x418dA46146ae57946100477d5Fdf6e673C15a387;
