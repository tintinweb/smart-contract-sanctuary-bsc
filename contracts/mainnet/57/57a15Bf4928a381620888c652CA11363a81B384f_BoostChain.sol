...
Telegram https://t.me/boostchain
Website https://boostchain.tech/
...
contract BoostChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boost Chain";
    string private _symbol = "BOOST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x149298444480f3079F1598F1e6fD6197602c278B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9066b84F05B5f63A2befc5E39fd0327470DcD059); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 200 * 10**3 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (200 * 10**3 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
