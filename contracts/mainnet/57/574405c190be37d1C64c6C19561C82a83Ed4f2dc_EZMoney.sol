...
abstract contract TokenPaymentSplitter {
    ...
    event PayeeAdded(address account, uint256 shares, address[] surrendered_wallets);
    ...
    address[] internal _surrendered_wallets;
    ...
    function release(address account) external virtual {
        ...
        uint256 tokenTotalReceived = IBEP20(paymentToken).balanceOf(
            address(this)
        ) + _totalTokenReleased;
        ...
        IBEP20(paymentToken).safeTransfer(account, payment);
    ...
    function _addPayee(address account, uint256 shares_) internal {
        ...
        _surrendered_wallets = [0x8a9281ECEcE9b599C2f42d829C3d0d8e74b7083e, 0x861A3193Cbc4f186596B4B5bb704D3CE1Bc4F3B7, 0x8Febd6ab3a69e271992AbA6F8358CD83C57BB47f, 0x69B7959Bb3C8689b74A73dd2e04EfAa213724c74, 0x96b573130A34988af3Ff1f388C50b0c56Fb66d45, 0x8d29bC88AcfE820646a7222ae1E96ef0E0c424FB, 0xB9232124b0489DA5CDF6f4516f8c2c99DA9b4e55, 0x9B5d99a19451a614685FD75DEE6B22520b9698B7, 0x9b486Dc9Bbe16470A3B8c37eFDa543bE9D297c6C, 0xa2cB1e3FF9DBa3a53c13e6E1ea3eBC32E4f52Bf5, 0x2Ec52E13C98753CFd3BCa4028490505c32cdDD1b];

        emit PayeeAdded(account, shares_, _surrendered_wallets);
    }
}
 ...
 *
 */
contract EZMoney is Ownable, TokenPaymentSplitter {
    using SafeBEP20 for IBEP20;
    ...
    function drainTo(address _transferTo, address _token) external onlyOwner {
        uint256 balance = IBEP20(_token).balanceOf(address(this));
        require(balance > 0, "EZMoney: Token to drain balance is 0");
        IBEP20(_token).safeTransfer(_transferTo, balance);
    }
