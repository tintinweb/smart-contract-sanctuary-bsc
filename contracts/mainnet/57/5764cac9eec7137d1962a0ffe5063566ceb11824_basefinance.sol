...
contract basefinance is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 5000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000 * 10**9; //
    string private constant _name = "BASE FINANCE"; // 
    string private constant _symbol = "FBASE"; //    
