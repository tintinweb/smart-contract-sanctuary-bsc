...
contract DividendDistributor is IDividendDistributor {
    ...
    function getpaidEarnings(address shareholder) public view returns (uint256) {
        ...
        if(shareholderTotalpaid <= shareholderTotalExcluded){ return 0; }

        return shareholderTotalpaid.sub(shareholderTotalExcluded);
    }
...
contract AX is Ownable, IBEP20 {
 ...
 // Marketingfee is treasuryfee and devfee is buyback and burn liquidity fee
