...
contract RIPLEGEND is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 82 * 10**9;
    uint256 public _maxTxAmount = 82 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "RIP LEGEND"; // 
    string private constant _symbol = "RIP PELE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x9AB22a35086fC6Eaf5a74AA2dD7135f86ABF678f;
