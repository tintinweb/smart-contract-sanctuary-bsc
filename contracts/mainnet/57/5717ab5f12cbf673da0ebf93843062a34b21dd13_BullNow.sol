...
contract BullNow is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x5993c3aA512D463F51DAF842E8289CcEC3541794));
    address payable public _devwallet =
        payable(address(0x8e3A7E97679A25E486AD8Dc2c4dbd54ba44DFc42));
    address public _exchangewallet =
        payable(address(0xeF3c7208Cd25787CA60a88C9c2bB5A5b12Cc7A87));
    address private _donationAddress =
        payable(address(0x41a2e07b3fF9845541409A5e464d142C9a731F70));

    string private _name = "Bull Now";
    string private _symbol = "BNOW";
