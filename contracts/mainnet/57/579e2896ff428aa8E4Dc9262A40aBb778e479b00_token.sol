...
contract token
 is Context, IERC20, Ownable {
    ...
    string private _name = "Super98K";
    string private _symbol = "Super98k";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f));
        _ketmatwallet = payable(address(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f));
