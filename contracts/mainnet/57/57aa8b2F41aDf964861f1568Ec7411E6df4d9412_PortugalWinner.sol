...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDE31d93F851a9a70130A54cF0dCf39f8e974289F; // owner address
...
contract PortugalWinner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Portugal Winner";
    string private _symbol = "PW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDE31d93F851a9a70130A54cF0dCf39f8e974289F); // Marketing Address
    address payable public teamWalletAddress = payable(0xDE31d93F851a9a70130A54cF0dCf39f8e974289F); // Team Address
