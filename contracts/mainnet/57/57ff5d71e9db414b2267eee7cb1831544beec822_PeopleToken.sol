...
library Address{
 ...
 contract PeopleToken is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 100_000 * 10**6; // 0.1%
    ...
    address public developmentWallet = 0x73d885e07F0e177Ee4c9392a27892406e0542Ff4;
    address public marketingWallet = 0x713b9EC6Bda5faaD4B92B0b2F199A4670AC8309d;
    ...
    Taxes public taxes = Taxes(0, 1, 2, 7);
    Taxes public sellTaxes = Taxes(0, 1, 2, 7);
