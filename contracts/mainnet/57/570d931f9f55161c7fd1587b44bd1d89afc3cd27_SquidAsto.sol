...
contract SquidAsto is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEf80A1FDC396dd8DF0D0F7A64C983A0133bCaA5f); 
    address payable public Wallet_Dev = payable(0x9eBF7F14E3d9E9C35DB3640f5e9df2b103D1878D);
    ...
    string private constant _name = "Squid Asto"; 
    string private constant _symbol = unicode"SITO"; 
    ...
    constructor () {
        ...
        _owner = 0x9eBF7F14E3d9E9C35DB3640f5e9df2b103D1878D;
