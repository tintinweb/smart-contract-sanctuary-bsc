...
// https://www.bitagi.net/?bscscan
// https://twitter.com/bitAGI0x
// https://www.reddit.com/r/bitAGI/
// https://t.me/bitAGI0x
// https://medium.com/@bitagi0x
// https://github.com/btagiDev

// We are developing a multichain project powered by artificial general intelligence technology. bitAGI is a cryptocurrency that supports different blockchain networks.
// You can buy and use bitAGI from different blockchain networks such as Ethereum (ETH), Binance Smart Chain (BNB), and Polygon (MATIC). 
// Join our telegram group now to try our artificial intelligence products and have the chance to try it with BOT.
...
contract bitAGI is Context, IBEP20, Ownable {
