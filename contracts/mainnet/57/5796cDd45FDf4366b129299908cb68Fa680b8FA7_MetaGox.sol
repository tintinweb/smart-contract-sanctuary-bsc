...
contract MetaGox is Context, IERC20, Ownable {
    ...
    address payable public IT = payable(0xb9c3c0FA7cCF16DC6D80618Be6155E2ec635D86f); 
    ...
    uint256 public _liquidityFee = 3; // liquidity + all team fees
    ...
    uint256 public RDDivisor = 2;
    uint256 public _bMaxTxAmount = 300000000  * 10**9;
    uint256 public _sMaxTxAmount = 200000000  * 10**9;
    uint256 private _trigger = 200000  * 10**9;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to IT address
        transferToAddressETH(IT, convertedBalance.div(_liquidityFee).mul(RDDivisor));
    ...
    function setRDDivisor(uint256 divisor) external onlyOwner {
        RDDivisor = divisor;
    }
    ...
    function setIT(address _IT) external onlyOwner {
        IT = payable(_IT);
        _isExcludedFromFee[IT] = true;
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 200000000 * 10**9;
        _sMaxTxAmount = 200000000 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 1;
        _liquidityFee = 4;
        _bMaxTxAmount = 600000000 * 10**9;
        _sMaxTxAmount = 300000000 * 10**9;
        setTradingOpen(true);
    }
    ...
    function withdrawLeftoverBNBToit(address payable recipient, uint256 amount) public onlyManager{
