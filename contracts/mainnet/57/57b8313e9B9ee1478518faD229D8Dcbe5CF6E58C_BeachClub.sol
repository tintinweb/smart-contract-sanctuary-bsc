 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BeachClubBSC
 * 
 * 
 * Beach Club token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BeachClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Beach Club";
    string constant _symbol = "BCLUB";
