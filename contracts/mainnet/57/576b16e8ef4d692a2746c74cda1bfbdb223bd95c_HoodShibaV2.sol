...
contract HoodShibaV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hood Shiba V2";
    string private _symbol = "HOODSHIBA";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xBa62864659c7E08c20Ea2F3C9BF81CeC361FBEae); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBa62864659c7E08c20Ea2F3C9BF81CeC361FBEae); // BuyBack Address
