...
contract ASCCToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "ASCC";
    string private _name= "ASCC EXCHANGE";
...
contract ASCCTokenSale {
    address payable admin;
    ASCCToken public tokenContract;
    ...
    constructor(ASCCToken _tokenContract, uint256 _tokensSold)  {
