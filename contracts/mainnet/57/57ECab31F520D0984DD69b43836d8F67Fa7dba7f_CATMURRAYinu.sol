...
/**
 ...
 Telegram Group : https://t.me/CatQuestionMark3x
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC56Bbf5Ac5d6C9a7C0fD792f897B54116d0d0b58; // owner address
...
contract CATMURRAYinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATMURRAYinu???";
    string private _symbol = "CATMI++";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfA707e07d0CE4eD40544b71427DA6A1d8dCcD44D); // Marketing Address
    address payable public developmentWalletAddress = payable(0xfA707e07d0CE4eD40544b71427DA6A1d8dCcD44D); // Development Address
