...
contract PlayerBook is Governance {
    ...
    constructor(address new_lpToken,address new_teamAddr) public {
        ...
        external
    {
        ...
        IERC20(usdt).safeTransfer(msg.sender,reward.mul(98).div(100));
        IERC20(usdt).safeTransfer(teamAddr,reward.mul(2).div(100));
