...
//0x77458878e7baEA046C003f453e1DfD2312B9e958
...
contract Token is ERC20, Ownable {
	...
	address public marketingAddress = 0xE145cCE85103b3f2AB4987a03bD5151465a9a4F6;
    address public receiveAddress = 0x8d8aab92Cb54c1D6233078aB1D56612D653331B2;
    ...
    uint256 public daysToDevidend = 48 hours;
	...
	constructor() ERC20("Soccertest", "Soccertest") {
		...
		_mint(receiveAddress, 10000000 * (10**decimals()));
	...
	function setChargeFees(uint256 _dividendFee, uint256 _marketingFee, uint256 _burnFee)  external onlyOwner {
        dividendFeeForCharge = _dividendFee;  
        marketingFeeForCharge = _marketingFee;    
        burnFeeForCharge = _burnFee; 
	}
    function setSellFees(uint256 _dividendFee, uint256 _marketingFee, uint256 _burnFee)  external onlyOwner {
        dividendFeeForSell = _dividendFee;  
        marketingFeeForSell = _marketingFee;    
        burnFeeForSell = _burnFee; 
	}
    function setTransFees(uint256 _dividendFee, uint256 _marketingFee, uint256 _burnFee)  external onlyOwner {
    ...
    function setDaysToDevidend(uint256 h) public onlyOwner {
        daysToDevidend = h * 1 hours;
    }
	function _transfer(
		address from,
		address to,
    ...
    uint256 userLp = IERC20(pancakePair).balanceOf(lastTransferUser);
		...
		if(dividendTm.add(daysToDevidend) < block.timestamp){
            ...
            dividendTm = dividendTm.add(daysToDevidend);
	}
	}
