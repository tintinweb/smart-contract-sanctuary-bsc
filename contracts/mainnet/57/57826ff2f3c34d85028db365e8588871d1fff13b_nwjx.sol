...
contract nwjx is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"难忘今宵";
    string private _symbol = unicode"难忘今宵";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xCeB2ADfA7c6dfd78C5435d8d1509971A9d9f8915);
