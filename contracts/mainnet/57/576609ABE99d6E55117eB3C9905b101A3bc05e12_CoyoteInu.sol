...
library Address{
  ...
  contract CoyoteInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA21A5531349f7F4c04EcDc28cc5087797d4eBcA8;
    address public donationWallet = 0xA21A5531349f7F4c04EcDc28cc5087797d4eBcA8;

    string private constant _name = "Coyote Inu";
    string private constant _symbol = "COYOTE";
    ...
    Taxes public taxes = Taxes(1, 2, 2, 0);
    Taxes public sellTaxes = Taxes(1, 2, 2, 0);
