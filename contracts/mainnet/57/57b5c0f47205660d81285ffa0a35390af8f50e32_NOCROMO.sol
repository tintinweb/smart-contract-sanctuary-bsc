...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x22158621EAC04D422c9947CAB8B8A8cF433A94c7;
...
contract NOCROMO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7c20F3466c53cAc6065BDcDcC1C9C0Bb961D6afe;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NO CROMO";
    string private _symbol = "NCRO";
