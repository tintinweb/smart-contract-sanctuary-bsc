...
/**
 Telegram : https://t.me/ArchRealm
 Website : https://archrealm.finance/

 Slippage %7 * %8
Archrealm is the first ever multi utility project with sophisticated Combat NFT Play to Earn 3D Game built on Binance Smart Chain.
 Renounce Ownership
 Liq Locked !
 Based Team
...
contract Archrealm is Ownable, IERC20 {
    ...
    string private _name = "Archrealm";
