...
contract SQUID is Context, IERC20, Ownable {
    ...
    string private _name = "Squid 2K23";
    string private _symbol = "SQUID2K23";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xe439d4dD9b8020392d4e46309DEFfFdCDA7c5F49); // Buy Back Address
    ...
    uint256 private _totalSupply = 2023 *  1**1 * 10**_decimals;
