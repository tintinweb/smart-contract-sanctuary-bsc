...
contract Dittos is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dittos"; //
    string private constant _symbol = "DITTO"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x0353af6A2b6eF1b4D63045F577efB636DDbC009a ;
