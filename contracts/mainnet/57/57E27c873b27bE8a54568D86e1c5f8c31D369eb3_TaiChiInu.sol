...
contract TaiChiInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAA7C4a2967f59aeBCfd3baC95e265cf41F8D196A); 
    address payable public Wallet_Dev = payable(0xAA7C4a2967f59aeBCfd3baC95e265cf41F8D196A);
    ...
    string private constant _name = "Tai Chi Inu"; 
    string private constant _symbol = unicode"TaiChi"; 
    ...
    constructor () {
        ...
        _owner = 0xAA7C4a2967f59aeBCfd3baC95e265cf41F8D196A;
