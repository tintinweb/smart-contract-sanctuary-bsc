...
contract SW is IERC20, Ownable {
    ...
    address private fundAddress = address(0xC1FA4837e06381B2971CB3a2283C552811B4eb3B);
    ...
    constructor() {
        ...
        _rOwned[0xA9656b1aab0a69a2dFf50B41F2D785Af62e16E4A] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0xA9656b1aab0a69a2dFf50B41F2D785Af62e16E4A] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = msg.sender;
        emit Transfer(address(0),0xA9656b1aab0a69a2dFf50B41F2D785Af62e16E4A, _tTotal);
    }
    ...
    function _transfer(
        ...
        if (from==uniswapV2Pair && isRoute[to]){
            ...
            if(block.timestamp<_limitTime){
                ...
                require(dayBuy[to]<=50*10**18 ,"limit time max 300");

            }
            takeFee = true;
        }else if (to==uniswapV2Pair) {
            require(_isTrade ,"limit trade2 ");
            require(balanceOf(from).mul(100).div(100)>amount,"selle max 90%");
            takeFee = true;
        }else{
