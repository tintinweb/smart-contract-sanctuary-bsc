...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x268b505BB61F0089894640F9cd6f1D7aA27964a7;
...
contract MONDAYKing is Context, IERC20, Ownable {
    ...
    string private constant _name = "MONDAYKing"; // 
    string private constant _symbol = "MONDAYKing"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x268b505BB61F0089894640F9cd6f1D7aA27964a7);
