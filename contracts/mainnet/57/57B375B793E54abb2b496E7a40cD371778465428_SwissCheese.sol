...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3994e55ff8B3cd5FC0e09AbE023690c0033aE536; // owner address
...
contract SwissCheese is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SwissCheese";
    string private _symbol = "SWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3994e55ff8B3cd5FC0e09AbE023690c0033aE536); // Marketing Address
    address payable public teamWalletAddress = payable(0x3994e55ff8B3cd5FC0e09AbE023690c0033aE536); // Team Address
