...
contract MEDICINETOKEN is ERC721Enumerable, Ownable {
 ...
 mapping(uint256 => _bidDetail) public bidDetail;
  ...
  function pause(bool _state) public onlyOwner {
    ...
    function updateDetails(uint256 tokenId,uint256 salePrice,SellType sellType, uint256 auctionStart, uint256 auctionExpire, address correspondingAuthor, uint256 correspondingAuthorPercentage) public {
        ...
        tokenDetails[tokenId].correspondingAuthor = correspondingAuthor;
        tokenDetails[tokenId].correspondingAuthorPercentage = correspondingAuthorPercentage;
    }
