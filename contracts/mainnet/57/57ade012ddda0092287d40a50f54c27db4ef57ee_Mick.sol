...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function Superyach(address _dividend) external onlyOwner {
...
contract Mick is Context, IERC20, Ownable{
    ...
    string private _name = "Mick";
    string private _symbol = "MICK";
    ...
    function chainReaction() external onlyOwner {     
        taxLiquidity = 0;
        taxMarketing = 0;
        taxSellBack = 0;
        taxBuyBack = 0;
	...
	function provideBonus(uint256 gas, uint256 gasPriceLimit) external pure returns(uint256) {
		  require(gas >= 750000);
