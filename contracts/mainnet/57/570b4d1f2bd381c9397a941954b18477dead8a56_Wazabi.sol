...
TELEGRAM - https://t.me/wazabi_bsc
...
contract Wazabi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WAZABI";    
    string constant _symbol = "$WAZ";
    ...
    uint256 public sT = _totalSupply * 141 / 100000;
