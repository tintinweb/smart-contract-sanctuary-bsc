...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02dc0a370858a4e38aCf31F3ba3f4E1F12DD4Ef0; // owner address
...
contract DwogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dwoge Inu";
    string private _symbol = "$DWOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB60a407b29666f88422aEF56333Ce9D1B030f37); // Marketing Address
    address payable public teamWalletAddress = payable(0x02dc0a370858a4e38aCf31F3ba3f4E1F12DD4Ef0); // Team Address
