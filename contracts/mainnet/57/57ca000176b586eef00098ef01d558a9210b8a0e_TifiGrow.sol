...
// Main Contract
contract TifiGrow is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Tifi Grow';
   ...
   address payable public taxWallet = payable(0xC85efc4CAeB01ee1934d10dBe3aA1B84534515A1);
   address payable public liqWallet = payable(0xC85efc4CAeB01ee1934d10dBe3aA1B84534515A1);
   ...
   // Swap
   uint256 public taxSwapAt  = 100000000000000000;
   uint256 public liqSwapAt  = 100000000000000000;
