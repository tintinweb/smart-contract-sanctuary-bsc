...
contract SAFECA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFE CA DETECTOR";
    string private _symbol = "SCAD";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x808B2Fd9f30757Db67c4e63072F19Da1011B5967); 
    ...
    uint256 public _buyDevelopmentFee = 12;
