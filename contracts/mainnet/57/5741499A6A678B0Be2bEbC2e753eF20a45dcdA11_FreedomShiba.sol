...
/*
Telegram: https://T.me/FreedomShiba
Website:www.freedomShiba.live
               Launching on Pancakeswap V2
FREEDOM SHIBA Hodlers will gain major incentives and benefits as we continue to add more features to the FREEDOM SHIBA platform!  
*/
...
contract FreedomShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FREEDOM SHIBA";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + stakingFee + devFee;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        ...
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _stakingFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver ) external authorized {
