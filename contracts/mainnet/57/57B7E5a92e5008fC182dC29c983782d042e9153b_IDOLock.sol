...
contract IDOLock is Ownable {
    ...
    address public buybackAddress = 0xd65C72BfbE1F1fEf0ac572024463ACB2133333Cb;
    ...
    function claim() public {
        ...
        if (block.timestamp > nextUnlock) {
            level += 1;
            if (level == 1) unlockPercent = 80;
            if (level == 2) unlockPercent = 90;
            if (level == 3) unlockPercent = 85;
            avalableToClaimGlobal += unlockPercent;
