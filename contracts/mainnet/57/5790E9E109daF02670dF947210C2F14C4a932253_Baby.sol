...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BUSD = IBEP20(0xF2A00f00Ed05822b95e746F1d81F363664F4Bdec); //reward ca can be changed any
...
contract Baby is IBEP20, Auth {
   ...
   address BUSD = 0xF2A00f00Ed05822b95e746F1d81F363664F4Bdec; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby SafeMoon 1996";
   string constant _symbol = "$BSM1996";
...
uint256 reflectionFee = 2;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xeeD340fBd8cC0cF5B249fA391BA1cC5F444d31b0; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xeeD340fBd8cC0cF5B249fA391BA1cC5F444d31b0; //Can be change to any wallet you want
       marketingFeeReceiver = 0xeeD340fBd8cC0cF5B249fA391BA1cC5F444d31b0; //Can be change to any wallet you want
