...
/**
 * Telagram : ▀ https://t.me/CyberDogeCoinBSC
...
contract CDOGE  is IBEP20, Auth { using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // 
    string constant _name = "CyberDoge Coin";
    string constant _symbol = "CDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 207700000000 * (10 ** _decimals);
    ...
    address public devFeeReceiver = 0x6eB1cB6a25AD079D717623FCeDF706E92c1763ce ;
    address public buybackFeeReceiver = 0x6eB1cB6a25AD079D717623FCeDF706E92c1763ce;
