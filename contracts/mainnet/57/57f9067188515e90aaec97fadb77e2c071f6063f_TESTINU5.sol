...
contract TESTINU5 is Ownable, IBEP20 {
    ...
    string constant _name = "TESTINU5";
    string constant _symbol = "TINU5";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x96a47445940eab1a5bBf0Ba66E977E36dDBdc103;
        marketingWallet = 0x96a47445940eab1a5bBf0Ba66E977E36dDBdc103;
    ...
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 6, "Max gas should be higher than 7 gwei");
        gas = newGas * 1 gwei;
    }
