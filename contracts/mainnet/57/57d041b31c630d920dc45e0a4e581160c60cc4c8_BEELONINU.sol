...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xBc15765AA0E4639E8bAae42568079b6492a7364b;
...
contract BEELONINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "BeElon INU"; // 
    string private constant _symbol = "BeElon INU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xBc15765AA0E4639E8bAae42568079b6492a7364b);
