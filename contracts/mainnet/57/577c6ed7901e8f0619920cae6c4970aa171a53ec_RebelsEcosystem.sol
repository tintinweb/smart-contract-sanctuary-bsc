...
contract RebelsEcosystem is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x4f2D0B48f27CFFcd46a2dce69D81972615d76864);
    address payable public Wallet_Dev =
        payable(0x0bf9827908Bb6B37d6B499cA3ACFA1B153513Ca9);
    address payable public constant Wallet_Burn =
        payable(0x2FF05878A8B68e29805FCE626117b87fB25C13fB);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**8 * 10**_decimals;
    string private constant _name = "Rebels Ecosystem";
    string private constant _symbol = unicode"RBLS";
    ...
    constructor() {
        _owner = 0x37217803Fd78DCAeFFD69Ebcc99B3D50DCF29181;
