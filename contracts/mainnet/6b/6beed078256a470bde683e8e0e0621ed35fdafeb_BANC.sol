...
// Telegram : https://t.me/BoredApeNotClub -- Stealth launch

// B.A.N.C is a meme coin based to Elon's profil pic on twitter, it's like B.A.Y.C, only it's NOT and this a parody but will be bigger with strong community
...
contract BANC is Context, IERC20, Ownable {
    ...
    string private constant _name = "BoredApeNotClub"; // 
    string private constant _symbol = "BANC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x36EEA7E9606D829e9D6259d82Ef394573D8C81e9;
