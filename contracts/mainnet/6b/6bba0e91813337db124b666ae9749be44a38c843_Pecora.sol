...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x388B43496aA056F03A44df40Fa312898951042fd;
...
contract Pecora is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x388B43496aA056F03A44df40Fa312898951042fd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pecora Net";
    string private _symbol = "Pecora";
