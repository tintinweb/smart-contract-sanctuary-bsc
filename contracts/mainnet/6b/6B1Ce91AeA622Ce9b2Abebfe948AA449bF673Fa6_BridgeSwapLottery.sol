...
interface IBridgeSwapLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in BRIS per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in BRIS token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInBris: price of a ticket in BRIS
...
contract BridgeSwapLottery is ReentrancyGuard, IBridgeSwapLottery, Ownable {
     ...
     * @param _brisTokenAddress: address of the BRIS token
        ...
        nonReentrant
    {
        ...
        // Calculate number of BRIS to this contract
        ...
        nonReentrant
    {
        ...
        // Calculate prizes in BRIS for each bracket by starting from the highest one
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                // A. No BRIS to distribute, they are added to the amount to withdraw to treasury address
            } else {
        ...
        // Transfer BRIS to treasury address
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(brisToken), "Cannot be BRIS token");
    ...
    /**
     * @notice Set BRIS price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInBris: minimum price of a ticket in BRIS
     * @param _maxPriceTicketInBris: maximum price of a ticket in BRIS
     */
     ...
     * @param _priceTicket price of a ticket (in BRIS)
