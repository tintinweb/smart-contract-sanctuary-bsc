...
pokoknya FOMO aja terus sampe jamet go internasional!
yok bisa yok,
yang indo kita kompak bikin floor dinding ba dinding
liquidity dikunci seminggu,
kalau good di extend sama jamet jadi sebulan
kalo bagus di extend lagi setahun
klo masih idup extend lagi 5 tahun
_________________________________________
JAMETBSC

Marketing fee 9%
100% of tax transaction will be rotated for FOMO to boost JAMETBSC!

    Tokenomics
    totalSupply 1,000,000,000,000
    Max buy/sell 4 %
    
https://t.me/jawametalbsc
...
contract JAWAMETALBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "JAWAMETALBSC";
    string constant _symbol = "JAMETBSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x2e60E4A98dF3fb8B32734c379A1640f5Fc10F35c;
