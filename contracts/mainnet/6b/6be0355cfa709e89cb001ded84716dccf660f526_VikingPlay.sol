...
/**
VikingPlay Token is a unique decentralized token built on binance smart chain network, with Past planetary Gamification experience, equipped with NFT, NFT STORE and MOBILE to ensure maximum optimization for all Game lovers.
*/

// TELEGRAM : https://t.me/VikingPlayOfficiall
// WEBSITE  : https://vikingplaytoearn.com/
// Twitter  : https://twitter.com/VikingPlayOFC
// Medium   : https://medium.com/@vikingplaytoearn/
...
interface IDEXRouter {
    ...
    contract VikingPlay is IBEP20, Auth {
    ...
    string constant _name = "VikingPlay";
    string constant _symbol = "VIKING";
    ...
    address public marketingFeeReceiver = 0xD60Ef010fa5EF2eE119461667A0C1D97ED538C1F;
    address public devFeeReceiver = 0xa90909b73FCC9c8b672A8e8aB88e0a0615777777;
    ...
    uint256 public swapThreshold = _totalSupply / 5000 * 50; // 1%
    bool inSwap;
