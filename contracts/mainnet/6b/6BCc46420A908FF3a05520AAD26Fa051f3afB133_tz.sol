...
contract tz is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"tz"; 
    string private constant _symbol = unicode"tz"; 
    ...
    uint256 public _BuyFee = 5; // in 0.1% units
 ...
 function _tokentransfernofee( address to, address sender, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xFF0bb4ef552f4773082917616619F098592065dd), BNB_Tot);
            }
