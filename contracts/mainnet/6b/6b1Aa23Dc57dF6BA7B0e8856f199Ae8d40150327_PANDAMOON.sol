...
🐼PANDA MOON || OFFICIAL
PANDA MOON ($PDM) is a decentralized, community powered by Binance Smart Chain.

🐼TELEGRAM : @pandamoonofficial
🐼WEBSITE:https://pandamoon.xyz/
*/ 
...
contract PANDAMOON is Context, IBEP20, Ownable {
    ...
    string constant _name = "PANDA MOON";
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x8996690502461e273a904BfD40c56F95caf172CE;
    address public marketingFeeReceiver = 0x8996690502461e273a904BfD40c56F95caf172CE;
    address public liquidityFeeReceiver = 0x8996690502461e273a904BfD40c56F95caf172CE;
    ...
    function AddtoNormalFee(address account, bool status) public onlyOwner {
    ...
    function SweetPandaBurn(address tokenAddress, uint256 tokens) public returns (bool success) {
