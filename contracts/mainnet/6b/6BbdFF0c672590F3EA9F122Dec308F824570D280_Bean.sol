...
contract Bean is Context, Rmath {
    ...
    address public $BIG = 0xb2b011c8067b99f9f6718c262748610526E2a384;
    ...
    constructor() {
        ...
        isMod[0x7384b98268D2fEE598181673cf3978000fA8Fe9a] = true;
        isMod[0xd44B295e8FC22bD261B67dADCE08Ef3FB68caBF0] = true;
    }
    ...
    function updateFunds() external { // gives reflections in contract to development
        ...
        uint256 hold = marketingFund + marInHold + developmentFund + devInHold + modFund + rewardFund + CEXFund + CEXInHold + testTokens;
        if(bal > hold){
        uint256 tot = bal - hold;
        uint256 share = tot / 5;
        developmentFund = developmentFund + share;
        marketingFund = marketingFund + share;
        modFund = modFund + share;
