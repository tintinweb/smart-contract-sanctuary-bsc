...
contract CATZ is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public _floorMarketingFee = 6;
    ...
    uint256 public _slideMarketingFee = 6;
    ...
    address payable  _marketingAddress = payable(0xf3F5cd1e174EBcEb56d3523ff33Ec948fB9D4Adc);
    address payable  _buybackAddress = payable(0xf3F5cd1e174EBcEb56d3523ff33Ec948fB9D4Adc);
    address payable constant  _projectMaintainence = payable(0xf3F5cd1e174EBcEb56d3523ff33Ec948fB9D4Adc);
    address payable  _developmentAddress = payable(0xf3F5cd1e174EBcEb56d3523ff33Ec948fB9D4Adc);
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal.div(66); // 1,5%
        _maxWalletAmount = _tTotal.div(66); // 1,5%
