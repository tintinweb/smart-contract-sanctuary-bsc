...
contract kangarooWC is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0xA99502B803E521d268B7fBE89fbec0Fd862546c7); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xc183137FEb3b8DDeD6A3562D592E1225303B2199); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xA99502B803E521d268B7fBE89fbec0Fd862546c7); // charity Wallet Address
    address payable public devWalletAddress = payable(0xc183137FEb3b8DDeD6A3562D592E1225303B2199); // dev Wallet Address
    ...
    string private constant _name = "kangarooWC";
    string private constant _symbol = "KANGWC";
    ...
    constructor () {
        address _owner = 0x75A49C54434e9de724EDBaDd9e75AA4466ED4bc7;
