...
contract BNBProtocol is IERC20Extended, Auth {
    ...
    string private constant _symbol = "BNBP";
    ...
    address public pair;
    address public autoLiquidityReceiver = 0x452EFDfde3097586630D61227D9Be66b0b9aa311; // address to receive LP tokens from liquidity add from fee
    address public marketingFeeReceiver = 0xDebCc039C3317b464C12f4D35d94a3e0065F67e9; // address to receive marketing fee
    address public stakingFeeReceiver = 0x8934b313A0dCe86edf32AF83805EC0D9f0240337; // address to receive staking fee
    ...
    authorized
    {
        require(_multiplier <= 4, "Sell Multiplier Cannot be more than 4x");
