...
// File contracts/Ocadi_LaunchpadNFT.sol
...
contract LaunchpadGalleryNFT is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
  // ROLES
  ...
  uint256 public freezingTimeAtSecond = 3600 * 24 * 365;
  address public usdt = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
  bool public paused = false;
  uint32 public maxToUser = 10000;
  ...
  struct Launchpad {
    ...
    uint32 sendCount;
    uint32 level;
    address payable loyaltyAddress;
    uint32 loyaltyFees;
  }
  ...
  function initialize(
    ...
    launches.push(
      Launchpad({
        ...
        level: 1,
        robiBoost: 0,
        loyaltyAddress: payable(_loyaltyAddress),
        loyaltyFees: 50
      })
    );
    // 2
  ...
  function updateLaunch(
    ...
    launches[_index].loyaltyAddress = payable(_loyaltyAddress);
  ...
  function buyMultipleNFT(
    ...
    uint256 treasuryAmount = (_launch.priceInUSD * amount) - loyaltyAmount;
