...
contract PYESwapRouter is SupportingSwap {
    ...
    constructor(address _factory) {
        require(_factory != address(0), "PYESwap: INVALID_ADDRESS");
        factory = _factory;
        WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
        initialize(_factory, 30, 0xbEBA48d57474210AEbAF81C9f05fC50366e5b20B, 0x911a62409c786454D8d4faEF7E0f170B828659A4);
    }
...
abstract contract SupportingSwap is FeeStore, IPYESwapRouter {
    ...
    function _swap(address _feeCheck, uint[] memory amounts, address[] memory path, address _to, bool exactOut) internal virtual {
    ...
    function swapExactTokensForTokens(
        ...
        _swap(to, amounts, path, to, false);
    }
    ...
    returns (uint[] memory amounts)
    {
        ...
        IToken(feeTaker).handleFee(0, WETH);
        
        TransferHelper.safeTransferFrom(
            path[0], msg.sender, pair, amounts[0] - 1
        );
        
        _swap(to, amounts, path, address(this), false);
...
library PYESwapLibrary {
    ...
    address constant factory = 0x7be39F5729790112B16b0c1886591E25950024fC;
    ...
    function pairFor(address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                hex'9662a1bfee3ce023a5c6b02ea32eb082efe0106d8a6309f2f5523bb36429c9f8' // init code hash
            )))));
    }
