...
contract DDDS is ERC20, Ownable {
    ...
    address public lpRewardToken = address(this); //分红的代币

    address public addLiquManege =
        address(0xA18b9B64c68b93DC54487F1C1ff772dd69859864);
    ...
    //加底池lp分红
    uint256 public buylpRewardFee = 300;

    uint256 public buyFee = buyDeadFee + buylpRewardFee; //buy total 4%
    uint256 public saleFee = buyDeadFee + buylpRewardFee; //sale total 4%

    mapping(address => bool) private _isExcludedFromFees; //白名单设置
    ...
    function _takeBuyFee(address _sender, uint256 _amount) private {
        ...
        super._transfer(_sender,  address(dividendTracker), buylpRewardFeeAmount);
    }
