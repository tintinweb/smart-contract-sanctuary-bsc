...
contract CHEEMSINUCLASSIC is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 70000000 * 10**9; //
    string private constant _name = "CHEEMS INU CLASSIC"; // 
    string private constant _symbol = "$CHEEMS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xcb785E1463c5e20FBD122947DE5bB520ffCa5D59);
