...
Telegram : https://t.me/shinagoldbsc
Website  : TBA
...
contract SHINAGOLD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x226bb1733C2Ca003a055dB661f8B7fEB8d7B8b3a); 
    address payable public Wallet_Dev = payable(0x14FecC04F4f5A10F9a4c442B31b7D088bb75CC7b);
    ...
    string private constant _name = "SHINA GOLD"; 
    string private constant _symbol = unicode"SHINAGOLD"; 
    ...
    constructor () {
        ...
        _owner = 0x14FecC04F4f5A10F9a4c442B31b7D088bb75CC7b;
