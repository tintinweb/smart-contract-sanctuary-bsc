...
contract FarmageddonLottoKeeper is KeeperCompatibleInterface, Ownable {
    ...
    PegSwap pegswap = PegSwap(0x1FCc3B22955e76Ca48bF025f1A6993685975Bb9e);
    ChainLink oracle = ChainLink(0x7b3EC232b08BD7b4b3305BE0C044D907B2DF960B);
    ...
    function ASetKeeperId(uint256 id) external onlyOwner {
        keeper = id;
    }
    ...
    function extendLottery(address lottery, uint256 _numberOfDrawsToAdd) external payable {
        ...
        address[] memory path1 = new address[](2);
            path1[0] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
            path1[1] = 0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD;
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: (bnbToCL*_numberOfDrawsToAdd)}(0,path1,address(this),block.timestamp);
            uint256 peggedAmount = token(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD).balanceOf(address(this));
        checkAllowance(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD, peggedAmount, 0x1FCc3B22955e76Ca48bF025f1A6993685975Bb9e);
        pegswap.swap(peggedAmount,0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD,0x404460C6A5EdE2D891e8297795264fDe62ADBB75);
            uint96 link = uint96(token(0x404460C6A5EdE2D891e8297795264fDe62ADBB75).balanceOf(address(this)));
        checkAllowance(0x404460C6A5EdE2D891e8297795264fDe62ADBB75, peggedAmount, 0x7b3EC232b08BD7b4b3305BE0C044D907B2DF960B);
