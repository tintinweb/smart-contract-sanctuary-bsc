...
contract Lottery {
    ...
    uint256 public duration = 10 minutes; // The duration set for the lottery
    ...
    function updateTicketPrice(uint256 _amount) external isOperator {
        ticketPrice = _amount;
    }

    function updateMaxTickets(uint256 _amount) external isOperator {
        maxTickets = _amount;
    }

    function updateTicketCommission(uint256 _amount) external isOperator {
        ticketCommission = _amount;
    }

    function updateDuration(uint256 _amount) external isOperator {
        duration = _amount;
    }
