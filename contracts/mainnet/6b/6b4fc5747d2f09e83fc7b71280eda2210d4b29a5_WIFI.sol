...
contract WIFI is IERC20, Ownable {
    ...
    address private projectAddress = 0xCd544744eEB41fEF910A08fF29dfb73D6d8Fe68b;
    ...
    uint256 private _tTotal = 20 * 10**4 * 10**9;
    ...
    uint256 public numTokensForLPfenhong = 1 * 10**9;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if (to != address(0) && from != address(fundAddress) && to != uniswapV2Pair){
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount."); 
        }
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 5 * 10**4 * 10**9)_burnFee = 0;
    ...
    function setSwapFee(uint256 _swapFee1) public onlyOwner{
        _swapFee = _swapFee1;
    }
    ...
    function _transferStandard(
        ...
        _takeSwapFee(sender, recipient,tAmount.div(10000).mul(_swapFee));
