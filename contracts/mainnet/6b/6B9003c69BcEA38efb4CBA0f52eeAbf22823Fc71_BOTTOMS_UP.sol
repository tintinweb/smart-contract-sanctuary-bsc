...
/**https://t.me/BottomsUpBSC
/**
/**Hi_

Bottoms Up is a BSC project built to survive the bear market by paying holders in juicy gains. 
...
contract BOTTOMS_UP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOTTOMS_UP";
    string private _symbol = "$BUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9390531f93Eb69E356291F4Ad83D1f8f461488c8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1049B7B32636710Ba63A0a73269495B77eFC95aF); // BuyBack Address
