...
Telegram: https://t.me/JinbeiInuNetwork
Website: https://exchange.jinbei-inu.live/#/swap

Jinbei Inu Network is an Anime fan based community, decentralized Exchange Platform with Auto-Compounding & Staking Protocol Providing Investors with profitable income.
...
contract JINBEIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jinbei Inu Network"; //
    string private constant _symbol = "$JIN"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xE3078f036aCa7711669995F941b0E098c16fC66E ;
