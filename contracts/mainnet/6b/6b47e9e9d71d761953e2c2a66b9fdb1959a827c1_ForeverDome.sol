...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOME = IBEP20(0x475bFaa1848591ae0E6aB69600f48d828f61a80E); // Mainnet
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DOME.balanceOf(address(this));
        ...
        uint256 amount = DOME.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DOME.transfer(shareholder, amount);
...
contract ForeverDome is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "ForeverDome";
    string constant _symbol = "ForeverDome";
    ...
    address public marketingFeeReceiver = 0xc91f46AA2B07821907B8A998340c0D66cdb0ff72;
    address public buybackFeeReceiver = 0x53eeA0eb3Ab6092308522A2CaD6719a83B1dB115;

    address DOME = 0x475bFaa1848591ae0E6aB69600f48d828f61a80E; // Mainnet
	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet
