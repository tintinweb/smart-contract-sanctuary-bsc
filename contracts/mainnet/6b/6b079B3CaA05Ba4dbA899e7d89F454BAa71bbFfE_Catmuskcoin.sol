...
Catmusk Coin is your next BSC moonshot and a rare BSC gem. Catmusk Coin is a defi project that focused on providing its holders with security in the present and value in the future. As an intergalactic Catmusk Coin  holder, you will earn Tokenreflection everytime have buy and sell.
...
Telegram: https://t.me/catmuskcoin
...
contract Catmuskcoin is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Catmusk coin";
    string constant _symbol = "Catmuskcoin"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 1000 / 1000; //Initial 1%
    uint256 public _maxWalletSize = _tTotal * 1000 / 1000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0x0e9BCAcca3386481267AAD1F3a62ff0d8C53c60B;
    address public marketingFeeReceiver = 0x0e9BCAcca3386481267AAD1F3a62ff0d8C53c60B;
    address public liquidityFeeReceiver = 0x0e9BCAcca3386481267AAD1F3a62ff0d8C53c60B;
