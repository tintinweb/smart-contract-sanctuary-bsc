...
// TRACKERS DM ME ON TELEGRAM @ACQUIREE
// TRACKERS DM ME ON TELEGRAM @ACQUIREE
// TRACKERS DM ME ON TELEGRAM @ACQUIREE
// TRACKERS DM ME ON TELEGRAM @ACQUIREE
// TRACKERS DM ME ON TELEGRAM @ACQUIREE
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7F7cD1D5b789Dd91c2286925a501d0F686399BEF;
...
contract TRACKERDMTG55 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7F7cD1D5b789Dd91c2286925a501d0F686399BEF);
    ...
    */
    ...
    string private _name = " TrackersDMTG5"; 
    string private _symbol = "$DM5";  
