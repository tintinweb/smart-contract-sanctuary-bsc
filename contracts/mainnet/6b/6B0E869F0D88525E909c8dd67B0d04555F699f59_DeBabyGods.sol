...
contract DeBabyGods is Context, IERC20, Ownable {
    ...
    string private constant _name = "DeBabyGods"; //
    string private constant _symbol = "DBGODS"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x560cD5643Ad3cD3a38110b4ac9726271f624d109 ;
