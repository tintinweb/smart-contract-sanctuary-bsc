...
contract Moo is Context, IERC20, Ownable {
    ...
    string private _name = "Moo";
    string private _symbol = "$MOO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C246DfF6980002f6819E66414f204899E2e419c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4C246DfF6980002f6819E66414f204899E2e419c); // BuyBack Address
