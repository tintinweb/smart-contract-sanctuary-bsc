...
contract SamuraiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Samurai Grow";
    string private constant _symbol = "SamuraiGrow";
