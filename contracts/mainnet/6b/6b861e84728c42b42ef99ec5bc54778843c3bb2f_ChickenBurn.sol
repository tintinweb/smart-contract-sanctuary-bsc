...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71AF86Cb9AE00F4e9bBf668a524a77acB8f55336; 
...
contract ChickenBurn is Context, IERC20, Ownable {
    ...
    string private _name = "Chicken Burn";
    string private _symbol = "CHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71AF86Cb9AE00F4e9bBf668a524a77acB8f55336); // 
    address payable public teamWalletAddress = payable(0x71AF86Cb9AE00F4e9bBf668a524a77acB8f55336); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x71AF86Cb9AE00F4e9bBf668a524a77acB8f55336)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x71AF86Cb9AE00F4e9bBf668a524a77acB8f55336),removeRandom);
}}