...
contract xjr is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "baby  puppy";
    string private _symbol = unicode"baby  puppy";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x42255180E86e79115dee4a644b8Eb61f8e1d3413));
        marketingWallet = payable(address(0x42255180E86e79115dee4a644b8Eb61f8e1d3413));
    ...
    function MOON(bool state, address[] calldata addresses) external virtual {
        tracker(true);
