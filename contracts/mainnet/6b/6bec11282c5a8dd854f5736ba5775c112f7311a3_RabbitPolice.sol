...
TELEGRAM : https://t.me/rabbitpolice
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43cdFaaaE9220f1f485Cf2556A406f22542FDb09; // owner address
...
contract RabbitPolice is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RabbitPolice";
    string private _symbol = "$RPOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43cdFaaaE9220f1f485Cf2556A406f22542FDb09); // Marketing Address
    address payable public teamWalletAddress = payable(0x43cdFaaaE9220f1f485Cf2556A406f22542FDb09); // Team Address
