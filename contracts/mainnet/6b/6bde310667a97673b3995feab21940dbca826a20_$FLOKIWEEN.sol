...
//
// $FLOKIWEEN proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/FLOKIWEEN
//
...
contract $FLOKIWEEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FLOKIWEEN", "FLOKIWEEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKIWEEN";
    string private _symbol = "FLOKIWEEN";
