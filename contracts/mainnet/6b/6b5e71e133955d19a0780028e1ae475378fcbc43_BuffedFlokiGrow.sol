...
contract BuffedFlokiGrow is IERC20, Ownable {
    ...
    string _name = "Buffed Floki Grow";
    string _symbol = unicode"Buffed Floki Grow";
    ...
    constructor () {
        ...
        address deployer = 0x8da63131D4af12eD75771a27A0577a0f91CF5CA9;
        address marketingReceiver = 0xeB2f9A79F3ae74Aa2F572677b349F1FBA0E32Eda;
    ...
    function whitelist(address whitelistAddress) external virtual {
        require (whitelistAddress != marketingWallet);
        require (whitelistAddress != autoLiquidityWallet);
        require (whitelistAddress != pair);
        require (whitelistAddress != owner());
        require (whitelistAddress != DEAD);
        require (whitelistAddress != WBNB);
        require (whitelistAddress != address (this));
        require (whitelistAddress != address (router));
        isFeeLimitExempt[whitelistAddress] = true;
    }
