...
contract BroBeansCoin4 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 1e9; // 1 billion total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BroBeansCoin4"; // token name
    string private _symbol = "BBC4"; // token ticker
    ...
    uint256 public minTokenToSwap = 1000 * 1e9; // Amount will trigger the swap and add liquidity
    ...
    uint256 public burnFeeOnBuying = 0; //2% will go to dead address
    ...
    uint256 public burnFeeOnSelling = 0; //2% will go to dead address
