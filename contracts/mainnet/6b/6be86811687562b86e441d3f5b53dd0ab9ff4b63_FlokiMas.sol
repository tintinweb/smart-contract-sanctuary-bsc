...
contract FlokiMas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " FlokiMas ";
    string private _symbol = " $FMAS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2feB93913c4d7208f7856Af5Ef3bFbD8A40CD6dF); 
    address payable public teamWalletAddress = payable(0x666Dc8E522d9934f0D90E5bf36f0040Cc88d5575);
