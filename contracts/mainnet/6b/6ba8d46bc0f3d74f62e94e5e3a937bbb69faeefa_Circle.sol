...
// The faster, safer, and more efficient way to send, spend and exchange money around the globe.
...
contract Circle is ERC20, Ownable {
    ...
    constructor() ERC20("Circle", "CIRCLE") {
        ...
        devWallet = address(0x942202758a53Eb726BF10a01a8D65C005625199f); // set as dev wallet
