...
contract BabyApe2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BAPE 2.0";
    string private _symbol = "BAPE2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf1d2320952355bcC0AF88C6aDF003eAe11dc0901);
    address payable public BuyBackWalletAddress = payable(0xf1d2320952355bcC0AF88C6aDF003eAe11dc0901);
