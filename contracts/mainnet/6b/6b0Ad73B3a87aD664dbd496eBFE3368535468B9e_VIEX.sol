...
contract VIEX is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 473016609;
    ...
    uint256 public constant MAX_FEE_BUY_RATE = 150;
    uint256 public constant MAX_FEE_SELL_RATE = 200;
    uint256 private constant MAX_REBASE_FREQUENCY = 1800;
    uint256 private constant DECIMALS = 18;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5_000_000_000 * 10**DECIMALS;
    ...
    address public liquidityReceiver = 0xAb0F86fe4A048Cd619f58959458d9167e6Fd599D;
    address public treasuryReceiver = 0x56443eccf60869b76065f477F51Fd972bE143a70;
    address public riskFreeValueReceiver = 0x8eb4Bb68eC86b49E687Fd5CD7d91F1AF1d7B56f6;
    ...
    uint256 public sellFeeRFVAdded = 50;
    ...
    constructor(address _owner) ERC20Detailed("viex", "VIEX", uint8(DECIMALS)) {
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount) internal returns (uint256){
        ...
        uint256 feeAmount = gonAmount.mul(_realFee).div(1000);
        uint256 burnAmount = gonAmount.mul(burnFee).div(1000);

        _gonBalances[DEAD] = _gonBalances[DEAD].add(burnAmount);
        emit Transfer(sender, DEAD, burnAmount.div(_gonsPerFragment));

        _gonBalances[address(this)] = _gonBalances[address(this)].add(feeAmount.sub(burnAmount));
        emit Transfer(sender, address(this), feeAmount.sub(burnAmount).div(_gonsPerFragment));
    ...
    function setFees(uint256 _liquidityFee, uint256 _riskFreeValue, uint256 _treasuryFee, uint256 _sellFeeTreasuryAdded, uint256 _sellFeeRFVAdded) external onlyOwner {
        ...
        require(totalBuyFee <= MAX_FEE_BUY_RATE);
        require(totalSellFee <= MAX_FEE_SELL_RATE);
    }
