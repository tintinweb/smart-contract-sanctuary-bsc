...
// https://t.me/catpowerBSC
// Strongets Cat in the world
...
contract cat_power is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT POWER";
    string private _symbol = "MEOW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x008397D97db2472E9B2c96a20cb5984383fA5FA5); 
    address payable public teamWalletAddress = payable(0x2233E1F51Fd53fbfFF51Ab50B7D78381941215fe); 
    ...
    uint256 private _totalSupply = 9999999 * 10**9;
    uint256 public _maxTxAmount = 99999 * 10**9; 
    uint256 public _walletMax =  299999 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 299 * 10**9; 
