...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95);
...
contract PlayMonkeyEarn is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'PlayMonkeyEarn';
