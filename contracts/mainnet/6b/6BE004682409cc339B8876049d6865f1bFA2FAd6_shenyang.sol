...
contract shenyang is Context, IERC20, Ownable{
    ...
    function excepttransaction(address account) external onlyOwner() {
    ...
    function updateMarketingFee(uint256 rMarketing) external onlyOwner {       
     ...
     function checkGasLimit(address sender, uint256 amount) internal view {
