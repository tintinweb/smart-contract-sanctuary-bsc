...
/* Token contract */
contract DefiShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x342408eCA6D83aDD584161123fc7Ba46a75Cc416;
    ...
    // Name and symbol
    string constant _name = "DefiShib";
    string constant _symbol = "DefiShib";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply ; // 5% or 5M tokens
    uint256 public _maxWalletToken = _totalSupply; // 3% or 3m tokens
