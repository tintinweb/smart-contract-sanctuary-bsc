...
contract SW is IERC20, Ownable {
    ...
    constructor() {
        ...
        _rOwned[0x71Fb2E778F9503f374fFe6A8d58c8e3bBCc0FefA] = _rTotal;
        _tokenOwner = msg.sender;

        _isExcludedFromFee[0x71Fb2E778F9503f374fFe6A8d58c8e3bBCc0FefA] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;

        _owner = msg.sender;
        emit Transfer(address(0),0x71Fb2E778F9503f374fFe6A8d58c8e3bBCc0FefA, _tTotal);
    }
