...
contract RisingSun is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 1e15 * (10**9);
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        ...
        require(totalFees <=25, "fees can't be set more then 25%");
    }
    ...
    constructor() ERC20("Rising Sun", "SUN") {
        ...
        marketingFee = 5;
        marketingWallet = payable(0x56886698844feE080A1564043982a7e7e4e79636);  
