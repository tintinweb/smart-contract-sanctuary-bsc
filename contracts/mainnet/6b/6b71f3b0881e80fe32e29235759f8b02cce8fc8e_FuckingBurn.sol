...
/** 
    ...
    https://t.me/fuckingburn

    @fuckingburn
    
    http://fuckingburn.rf.gd/ 
...
contract FuckingBurn is Context, IERC20 { 
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FB Ownable: caller is not the owner");
        _;
    }
    ...
    address payable public Wallet_Marketing = payable(0xeB7cF813159DA49E49700a4B48C5cEbcbA2afE59); 
    address payable public Wallet_Dev = payable(0xeB7cF813159DA49E49700a4B48C5cEbcbA2afE59);
    ...
    string private constant _name = "Fucking Burn"; 
    string private constant _symbol = unicode"Burnies"; 
    ...
    constructor () {
        ...
        _owner = 0xeB7cF813159DA49E49700a4B48C5cEbcbA2afE59;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "FB ERC20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "FB ERC20: decreased allowance below zero"));
        return true;
    }
    ...
    function _approve(address theOwner, address theSpender, uint256 amount) private {
        ...
        require(theOwner != address(0) && theSpender != address(0), "FB ERR: dead address");
    ...
    function remove_Random_Supply(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
