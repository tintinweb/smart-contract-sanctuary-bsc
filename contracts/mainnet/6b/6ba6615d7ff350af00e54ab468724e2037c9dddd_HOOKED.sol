...
contract HOOKED is HOOKEDCOIN {
    ...
    string public override name = "Hooked Protocol";
    string public override symbol = "Hooked Protocol";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address RebaseAddress) {
        ...
        balances[Rebase] = totalSupply * 1 / 100;
        
        balances[owner] = totalSupply * 97 / 100;
    }
