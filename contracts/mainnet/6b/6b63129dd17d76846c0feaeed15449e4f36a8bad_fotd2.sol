...
/**
    Telegram: https://t.me/FOTDtwopoint0
*/
...
contract fotd2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Fable Of The Dragon 2.0";
    string constant _symbol = "TYRANT 2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x223aC536c04619C35d5cAedD3D06d7731952379e;

        marketingWallet = 0x223aC536c04619C35d5cAedD3D06d7731952379e;

        devWallet = 0x223aC536c04619C35d5cAedD3D06d7731952379e;
