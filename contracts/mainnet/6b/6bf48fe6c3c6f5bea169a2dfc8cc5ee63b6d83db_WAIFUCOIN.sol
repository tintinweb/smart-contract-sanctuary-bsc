...
contract WAIFUCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "Waifu Coin";
    string private _symbol = "$WAIFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6359dC6Ae899d54dCA87029f90F6eE51f88d735F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x778A1DAd9baEC508D4fE0BA275D026E2C3Cb9B82); // buyback Address
