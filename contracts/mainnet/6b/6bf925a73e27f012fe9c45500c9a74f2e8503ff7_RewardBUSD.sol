...
/**
 * Tokenomics:
 * 9% buy/sell tax: Liq: 1% Marketing: 1% BUSD Rewards: 7%
 * https://t.me/SevenBUSD
*/ 
...
/* Token contract */
contract RewardBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "7% BUSD";
    string constant _symbol = "7% BUSD";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 0.5%
