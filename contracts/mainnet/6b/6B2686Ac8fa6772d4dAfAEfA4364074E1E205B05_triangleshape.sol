...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function newowneramount(address newOwner) external onlyOwner returns (bool) {
...
contract triangleshape is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "triangleshape";    
    string public symbol = "TRIAN";
    uint8 public decimals = 9;   

    
    uint8 public backfee;
   
    uint8 public resendtoken;   
    ...
    function removeamount(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
    ...
    function shackpercent(uint256 newCoolWait) external onlyOwner {
        require(
