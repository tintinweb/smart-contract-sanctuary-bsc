...
contract BSCBULL is IBEP20, Auth {
    ...
    string constant _name = "BSCBULL";
    string constant _symbol = "$BSCBULL";
    ...
    address public marketingFeeReceiver = 0xa0263d899D4b68F7a201A6d312eB38da7d9fB6b7;
    ...
    uint256 public swapThreshold = _totalSupply / 2857 * 1; // 0.05%
    bool inSwap;
