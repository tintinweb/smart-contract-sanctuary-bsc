...
/**
Wizard Inu token meme that will be launched with a plan that has been prepared,
and already has a road map that will be provided on the website that we will launch, 
WizardInu will make Wizards get their potions to make WizardInu get the moon.
...
LOCK LP & RENOUNCE OWNERSHIP
Contract Verifed

NO PRIVATE SALE
*/
/**
Portal   : https://t.me/WizardInuPortal
Telegram : https://t.me/WizardInu
Twitter  : https://twitter.com/InuWizard
Website  : https://WizardInu.io 
*/
...
contract WizardInu is IBEP20, Auth {
    ...
    string constant _name = "WizardInu";
    string constant _symbol = "WDINU";
    ...
    mapping (address => bool) public DuckyKill;
    ...
    address public marketingFeeReceiver = 0x3E0AfF62C638dA13Af8eb2B2df53f0A1CcF5C6d1;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000 * 30; // 0.30%
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!DuckyKill[recipient] && !DuckyKill[sender], 'Address is excluded.');
