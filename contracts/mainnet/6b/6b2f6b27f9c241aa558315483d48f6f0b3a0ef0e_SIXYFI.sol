...
contract SIXYFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sixYFI";
    string private _symbol = "sixYFI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7E6Cfa56852b50c7cB17C8956f79082C65628C29); // Marketing Address
    address payable public teamWalletAddress = payable(0x7E6Cfa56852b50c7cB17C8956f79082C65628C29); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 666 * 5 **_decimals; 
