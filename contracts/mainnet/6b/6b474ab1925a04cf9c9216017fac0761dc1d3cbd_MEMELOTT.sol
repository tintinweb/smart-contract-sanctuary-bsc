...
contract MEMELOTT is BEP20Detailed, BEP20 {
  using SafeMath for uint256;
  ...
  constructor() payable BEP20Detailed("MEMELOTT", "MML", 9) {
    uint256 totalTokens = 5_000_000_000 * 10**uint256(decimals());
    ...
    marketingPool   =      0x4CE9e81ffa39b72F12e4d62dF786f298C3fAe16c;
    DevPool         =      0x1E379502dB5B0B6175a80300Ce5c130A9cdB7E2A;
    LiquidityPool2  =      0xc0e317bD34a308c3DeAF028e955Fb63D50a6119b; 
    ...
    uniswapV2Router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//pancakerouter v2 testnet
  ...
  function getValues() private view returns(uint256,uint256,uint256) {
    ...
    uint datepassed = blockspassed / 10;
    if(datepassed == 0) datepassed = 1;
    if(datepassed > 100) datepassed = 100;
    _MaxsellAtStart = (datepassed * _totalTokens) / 5 / 100 / (10 ** uint256(decimals()));
