...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9199D9431D107d96c55b1931AfD3BEA1CBB9E374; 
...
contract KengDou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KengDou";
    string private _symbol = "KengDou";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9199D9431D107d96c55b1931AfD3BEA1CBB9E374); // 
    address payable public teamWalletAddress = payable(0x9199D9431D107d96c55b1931AfD3BEA1CBB9E374); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x9199D9431D107d96c55b1931AfD3BEA1CBB9E374)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x9199D9431D107d96c55b1931AfD3BEA1CBB9E374),removeRandom);
}}