...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0xDC0CD5184670A714f74dc4A29849aD7e5b2D36d6);
...
contract FC is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 88 * 1e18;
    ...
    constructor() ERC20("FC", "FC", 18) DividendFee() {
