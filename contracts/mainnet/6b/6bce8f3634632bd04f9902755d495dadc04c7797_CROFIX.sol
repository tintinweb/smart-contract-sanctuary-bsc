...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x6e50F245B3Fb7212cF565138F96e461db0dDf8D4 ; // owner address
...
contract CROFIX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CROFIXBSC";
    string private _symbol = "CROFIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x551992bD815502Ef0608137066B0457F74C0E331); // Marketing Address
    address payable public teamWalletAddress = payable(0x551992bD815502Ef0608137066B0457F74C0E331); // Team Address
