...
// Telegram : https://t.me/bakenekoInu
...
/* Token contract */
contract BakenekoInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address private operationFeeReceiver;

    // Name and symbol
    string constant _name = "Bakeneko Inu";
    ...
    uint256 public operationFeeBuy = 1;
    ...
    uint256 public operationFeeSell = 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        operationFeeReceiver =0x55e025E4D0F4c8Fb0EDEf90D3B22E42a5d566cFb;
        ...
        isFeeExempt[operationFeeReceiver] = true;


        isTxLimitExempt[_presaler] = true;
        isTxLimitExempt[burnFeeReceiver] = true;
        isTxLimitExempt[marketingFeeReceiver] = true;
        isTxLimitExempt[operationFeeReceiver] = true;
        ...
        isDividendExempt[operationFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        (bool successOperation, /* bytes memory data */) = payable(operationFeeReceiver).call{value: amountBNBOperation, gas: 30000}(""); 
        ...
        require(successOperation, "operations receiver rejected ETH transfer");
    ...
    // Set all max in % 
    function setWalletMax(uint256 maxPercent) external authorized {
        _maxSellTxAmount = _totalSupply.mul(maxPercent).div(10000);
        _maxBuyTxAmount = _totalSupply.mul(maxPercent).div(10000);
        _maxWalletToken = _totalSupply.mul(maxPercent).div(10000);
    }
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _operationFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _burnFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        devFeeBuy = _devFeeBuy;
        burnFeeBuy = _burnFeeBuy;
        operationFeeBuy = _operationFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_operationFeeBuy).add(_marketingFeeBuy).add(_devFeeBuy).add(_burnFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _operationFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _burnFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        marketingFeeSell = _marketingFeeSell;
        devFeeSell = _devFeeSell;
        burnFeeSell = _burnFeeSell;
        operationFeeSell = _operationFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_operationFeeSell).add(_marketingFeeSell).add(_devFeeSell).add(_burnFeeSell);
        feeDenominator = _feeDenominator;
    }

    // Fee snipers
    function setSniperFee(bool _launchNormal) external authorized {
