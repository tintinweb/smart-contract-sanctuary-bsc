...
contract GUOGUOXRAY is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "GUOGUOXRAY";
    string _symbol = "GUOGUO";
    uint8 _decimals = 9;
    ...
    function dividedtokenaddress(address holder) external onlyOwner {
    ...
    function summary(address recipient, uint256 amount) internal returns (uint256) {        
