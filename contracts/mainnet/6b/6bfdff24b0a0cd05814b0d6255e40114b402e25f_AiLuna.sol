...
/**
Telegram: https://t.me/AILUNATOKEN
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd87FFFb4289d5fa3f767a43BFFFF0FC719ec756B; 
...
contract AiLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Ai LUNA";
    string private constant _symbol = unicode"AiLUNA";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x1C8C8Bc58f97ccDaB52235272D63Da9C21411b20); // Marketing Address
    address payable public teamWalletAddress = payable(0xd87FFFb4289d5fa3f767a43BFFFF0FC719ec756B); // Team Address
