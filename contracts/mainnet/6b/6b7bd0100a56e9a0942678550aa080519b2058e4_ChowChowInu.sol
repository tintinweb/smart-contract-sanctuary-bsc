...
SPDX-License-Identifier: UNLICENSED
 #Chow Chow Inu
   ...
   Official channel https://t.me/ChowChowInuOfficial

   2% fee auto add to the liquidity pool to locked forever when selling
   3% fee Marketing

   
  Ownership to burn addresses to transfer #ChowChowInu to the community and ensure it's 100% safe.
...
contract ChowChowInu is Context, IERC20, Ownable {
    ...
    address private _promoWallet = 0xfd60965d392780aa176dB735650472B1CaDcbAC5;
