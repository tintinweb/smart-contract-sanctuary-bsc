...
contract Crystalrabbit is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Crystal Rabbit";
    string private _symbol = "Crystal Rabbit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x37B25702aCa10cC4F24acc49fc87B4c66B8FA3e7);
