...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WETH = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
contract McDogeBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McDogeBTC";
    string constant _symbol = "$MCBTC";
   ...
   //early sell fee
    ...
    uint256 public SelltotalFee = 14;
    ...
    address public Owner=(msg.sender); // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = (msg.sender); // marketing address
    ...
    function setEarlySell(bool value) external onlyOwner {
        ...
        earlySellTime = block.timestamp + 24 hours;
    }
