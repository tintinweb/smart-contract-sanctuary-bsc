        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x13317cBe38EE5d3A26e1c2BdD787478Ea8ADf97B), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        "BNBTURTLE",//Name Naughty Doge
        "BNBTURTLE",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address(0x65f76Eb314D80D8FDF15ABb8C428B9c5d5a188e2),//FundAddress
        address(0xC831F80165D59e0B32CDad475c205453eBCd62a8),//buybackTokenAddress
        address(0x65B0B6C48eEc0f139aDfa54845529Cdf5dB613b5)//ReceiveAddress
    ){
    }
}