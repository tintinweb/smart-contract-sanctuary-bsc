...
contract FEG is Ownable, IBEP20 {
    ...
    address public lpToken = 0x55d398326f99059fF775485246999027B3197955;
    ...
    string constant _name = "FEG GRWO";
    string constant _symbol = "FEG";
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x4c99a6ab6158B0771aD9e24C3F97DE2dC7654a4c ;
        marketingWallet = 0x4c99a6ab6158B0771aD9e24C3F97DE2dC7654a4c;
        devWallet = 0x4c99a6ab6158B0771aD9e24C3F97DE2dC7654a4c;
        gameWallet =0x4c99a6ab6158B0771aD9e24C3F97DE2dC7654a4c ;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(devFee).add(gameFee);
    ...
    function setFeeReceivers(address newMktWallet, address newDevWallet, address newLpWallet, address newGameWallet) public onlyOwner{
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess2,) = payable(gameWallet).call{value: amountBNBGame, gas: 30000}("");
        (bool tmpSuccess3,) = payable(devWallet).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newGameFee, uint256 extraSellFee) external onlyOwner {
