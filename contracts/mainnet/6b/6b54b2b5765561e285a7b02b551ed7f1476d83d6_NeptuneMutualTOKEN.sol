...
🔔TG @NeptuneMutualcz
 ...
 📱Telegram group: https://t.me/NeptuneMutual
...
abstract contract ContextBEP20NeptuneMutual {
...
contract OwnableBEP20NeptuneMutual is ContextBEP20NeptuneMutual {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20NeptuneMutual: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20NeptuneMutual: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract NeptuneMutualTOKEN is ContextBEP20NeptuneMutual, BEP20NeptuneMutual, OwnableBEP20NeptuneMutual {
    ...
    string private _name = 'Neptune Mutual';
    string private _symbol = 'Neptune Mutual';
