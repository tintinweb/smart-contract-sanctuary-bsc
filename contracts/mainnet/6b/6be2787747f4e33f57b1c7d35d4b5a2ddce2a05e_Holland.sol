...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function autokenRebase(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract Holland is ContextHelper, IERC20, OwnershipHelper{
    ...
    function setHollandFees(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
