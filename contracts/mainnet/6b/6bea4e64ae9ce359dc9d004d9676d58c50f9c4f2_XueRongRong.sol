...
contract XueRongRong is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "XueRongRong";
    string private _symbol = "XueRongRong";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x6D8a00cB127fc4D5F503699e14B7D579B930A6f5);
    ...
    uint256 public _maxTxAmount = 1 * 10**8 * 10**8 * 10**9;
    uint256 public _walletMax = 1 * 10**8 * 10**8 * 10**9;
