...
contract QuogeInu is IBEP20, Auth {
    ...
    string constant _symbol = "QGI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100;  //20% max tx
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100;  //20% max wallet
    ...
    address private marketingFeeReceiver =0x4260CaC371152ae9c1dFa6E2859D428e09C3D6cA;
    address private teamFeeReceiver =0x4260CaC371152ae9c1dFa6E2859D428e09C3D6cA;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x4260CaC371152ae9c1dFa6E2859D428e09C3D6cA;
