...
contract Crowdsale is Context, ReentrancyGuard {
	...
	function buyTokens(address beneficiary) public payable nonReentrant {
		require(msg.value >= 0.1 * (10 ** 18), "Min amount is 0.1");
	...
	function buyTokens(address beneficiary, address refAddress) public payable nonReentrant {
		...
		require(msg.sender != refAddress, "Same ref address and wallet address");
		require(msg.value >= 0.1 * (10 ** 18), "Min amount is 0.1");
		...
		(bool success, ) = refAddress.call{value: weiAmount / 10}("");
