...
contract HollowFloki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Hollow Floki ";
    string constant _symbol = "H_Floki";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWalletB = 0xAeC96054EF5291C011CBe7F40a0A616D82fa4Fda;
