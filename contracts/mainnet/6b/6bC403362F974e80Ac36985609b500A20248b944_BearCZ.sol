...
/**
BEAR CZ 
STEALTHLAUNCH TODAY'S AT 12-13PM UTC
️

WE HAVE DECIDED TO
DO A STEALTH LAUNCH WITH A MISSION TO MAKE THE CRYPTO MARKET BULLISH BACK, AND WE WILL CREATE BEAR CZ WITH A MISSION OF TREND GREEN CANDLE FOR OUR COMMUNITY

NO PRESALE
NO PRIVATE SALE
STEALTH LAUNCH ONLY

LOCKED LIQUIDITY FOR LONG
VERIFICATE CONTRACT
...
Telegram : https://t.me/BearCz

Don't Miss This Potential Easy to x1000
...
/* Token contract */
contract  BearCZ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xE63Bf736876fFEDd547dfC46F3E198A28927E42D;
    ...
    // Name and symbol
    string constant _name = "Bear CZ";
    string constant _symbol = "BEARCZ";
    ...
    // Buy Fees
    uint256 private DevelopmentFeeBuy = 1; 
    uint256 private buybackFeeBuy = 0;
    uint256 private reflectionFeeBuy = 1;
    uint256 private marketingFeeBuy = 4;
    uint256 private CharityFeeBuy = 0;
    uint256 public totalFeeBuy = 6;

    // Sell fees
    uint256 private DevelopmentFeeSell = 1;
    uint256 private buybackFeeSell = 0;
    uint256 private reflectionFeeSell = 1;
    uint256 private marketingFeeSell = 4;
    uint256 private CharityFeeSell = 0;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE63Bf736876fFEDd547dfC46F3E198A28927E42D;
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        DevelopmentFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        reflectionFeeBuy = _reflectionFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        CharityFeeBuy = _devFeeBuy;
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
        DevelopmentFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        reflectionFeeSell = _reflectionFeeSell;
        marketingFeeSell = _marketingFeeSell;
        CharityFeeSell = _devFeeSell;
