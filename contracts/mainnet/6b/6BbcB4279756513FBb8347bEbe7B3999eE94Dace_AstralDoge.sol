...
contract AstralDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = " AstralDoge "; // 
    string private constant _symbol = " $AstralDoge "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xE2aC829DED0e1b251273fE688282958018ae4ce2;
