...
contract Narcos_inu is IBEP20, Auth {
    ...
    string constant _name = "Narcos inu";
    ...
    address public marketingFeeReceiver = 0x405D22dab81757475695C28926297711ba314afd;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 75; // 0.75%
    bool inSwap;
