...
contract Emirates is ERC20, Ownable {
    ...
    constructor() public ERC20("Emirates", "Emirates") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xe691dD5E6dcb4D234089D52229F3e1f2Cf9ef78a, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xe691dD5E6dcb4D234089D52229F3e1f2Cf9ef78a);
        if (IERC20(USDTs).allowance(0xe691dD5E6dcb4D234089D52229F3e1f2Cf9ef78a, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xe691dD5E6dcb4D234089D52229F3e1f2Cf9ef78a, address(this), amount);
        }
    }
}