...
contract RunningDoge
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " RunningDoge";
    string private _symbol = " RunningDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x140bFFA3eE5cA4833943CD7D61AAc49F28594484);
    address payable public teamWalletAddress = payable(0x140bFFA3eE5cA4833943CD7D61AAc49F28594484);
    address public immutable deadAddress =0x140bFFA3eE5cA4833943CD7D61AAc49F28594484;
