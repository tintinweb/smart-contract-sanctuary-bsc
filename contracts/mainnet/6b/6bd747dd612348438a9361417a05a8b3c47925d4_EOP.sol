...
contract EOP is Operator {
    ...
    string private _name = "EOP";//#币名
    string private _symbol = "EOP";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 10000000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 10000000000000000 * 1e9);
        ...
        setWhiteList(address(0x62b7571821E4bB9003F6B1f905dc3cE614d9eDEd),true);
    }
