...
/* I created this token because the love of my life has changed my life,
   ...
   This token will have a 1% fee on buys / sells
    ...
    Only a 100 tokens in supply that will be burn off the max supply.

    Telegram link: https://t.me/EmiliaToken
...
contract EMA is Context, IERC20, Ownable {
    ...
    string private _name = "Emilia Token";
    string private _symbol = "EMA";
