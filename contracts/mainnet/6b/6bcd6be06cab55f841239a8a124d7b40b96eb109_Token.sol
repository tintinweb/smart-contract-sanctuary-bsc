...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1314 * 10**9;

    string private _name = "Toledo Coin";
    ...
    uint256 public _maxTxAmount = 52 * 10**9;
    uint256 public _maxHavAmount = 52 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 150 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market = 0xDBdf6Fce98E9c21987A9d849bcE668a17a3EE695;
    ...
    constructor() {
        ...
        _isExcludedFromFee[_market] = false;
        _isExcludedFromFee[_liquify] = false;

        emit Transfer(
            address(0x359E6B0a65091380fE1a60DBE9b50e5d81C10520),
            _msgSender(),
            _tTotal
        );
    }
