...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FLKI = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FLKI.balanceOf(address(this));
        ...
        uint256 amount = FLKI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FLKI.transfer(shareholder, amount);
...
contract TestDonotbuy is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGE = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address public Owner=0xaeCb8c1715876667d2320cE20C164B28EEE8c043; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xaeCb8c1715876667d2320cE20C164B28EEE8c043;
