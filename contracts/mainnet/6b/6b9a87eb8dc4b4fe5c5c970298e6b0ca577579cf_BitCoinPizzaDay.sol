...
https://t.me/BitCoinPizzaDay_BSC
...
// CHANGE
contract BitCoinPizzaDay is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BitCoin Pizza Day";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x3EFf91205f09dc96e914964ed38d89145e5Cf8b2);
    ...
    function setFees(uint256 _liquidityFee, uint256 _BuybackFee, uint256 _TeamFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
