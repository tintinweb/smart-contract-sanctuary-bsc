...
contract MuskZilla is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xeC023f32FAa2EeCb44F5CF4Ea3375c449d9B4b60;

    string constant _name = "MuskZilla";
    string constant _symbol = "MuskZilla";
