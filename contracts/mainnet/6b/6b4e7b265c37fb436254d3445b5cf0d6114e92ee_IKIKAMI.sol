...
contract IKIKAMI is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"域 神";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable private DevWallet = payable(0x4968f6D621628B5B05855ce1EF20a0DffC6B7bB2);
    address payable private MarketingWallet = payable(0x54f5Fb3735b22aac06B241f365Ad00c81d96e3d6);
