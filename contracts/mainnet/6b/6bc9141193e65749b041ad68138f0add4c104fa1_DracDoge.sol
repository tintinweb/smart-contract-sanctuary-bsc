...
contract DracDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Drac Doge";
    string private _symbol = "DRACDOGE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xC5c2DD2BBF5f5a66181771505cb1F512F9F3cA3C);
