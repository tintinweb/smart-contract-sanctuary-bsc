...
/**
 ...
 Telegram : https://t.me/zhaogecoin
...
contract Zhaoge is IBEP20, Auth {
    ...
    string constant _name = "Zhaogecoin";
    string constant _symbol = "Zhaogecoin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**24 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0xaB74d09d4B1bAA118c8A3Ac1868404EBB136f488;
    address private buybackFeeReceiver = 0xaB74d09d4B1bAA118c8A3Ac1868404EBB136f488;
    ...
    uint256 public swapThreshold = 20 * 10**9 * (10 ** _decimals); // 0.3%
    bool inSwap;
