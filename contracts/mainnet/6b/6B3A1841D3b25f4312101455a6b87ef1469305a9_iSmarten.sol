...
contract iSmarten is ERC20, Ownable {
    ...
    constructor() ERC20("iSmarten", "iSmart") {
        ...
        uint256 totalSupply = 750000000000 * 1e18;

        maxTransactionAmount = 350000000 * 1e18; // 350M maxTransactionAmountTxn
        maxWallet = 350000000 * 1e18; // 350M maxWallet
        ...
        marketingWallet = address(0x32B8693155480341aF5844f04170c792315aC046); // set as marketing wallet
        CharityWallet = address(0x32B8693155480341aF5844f04170c792315aC046); // set as dev wallet
