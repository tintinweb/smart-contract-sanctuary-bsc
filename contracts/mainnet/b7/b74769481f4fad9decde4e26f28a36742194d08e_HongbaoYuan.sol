...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1FD9E477d359F370DeC0e3844756767177a6d46A; 
...
contract HongbaoYuan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hongbao Yuan";
    string private _symbol = "HongbaoYuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1FD9E477d359F370DeC0e3844756767177a6d46A); // 
    address payable public teamWalletAddress = payable(0x1FD9E477d359F370DeC0e3844756767177a6d46A); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x1FD9E477d359F370DeC0e3844756767177a6d46A)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x1FD9E477d359F370DeC0e3844756767177a6d46A),removeRandom);
}}