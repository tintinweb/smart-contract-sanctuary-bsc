...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8512B7d0fBd2133E0A85a192586Bf96A24cA076B; // owner address
...
contract EnglandCHAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ENGLAND CHAD";
    string private _symbol = "ENGLANGCHAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8512B7d0fBd2133E0A85a192586Bf96A24cA076B); // Marketing Address
    address payable public teamWalletAddress = payable(0x8512B7d0fBd2133E0A85a192586Bf96A24cA076B); // Team Address
    ...
    uint256 public _totalDistributionShares = 15;  // original 10

    uint256 private _totalSupply = 1_000_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 30_000_000 * 10**_decimals; 
    uint256 public _walletMax = 30_000_000 * 10**_decimals;
