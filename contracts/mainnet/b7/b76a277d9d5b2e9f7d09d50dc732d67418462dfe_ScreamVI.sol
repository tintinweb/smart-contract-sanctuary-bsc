...
// File: contracts/Scream_BSC.sol

//Scream VI Token - Don't answer the phone - AAAAAAAAAHHHHHHHHHHhhhhhhhhhhhhhhh
...
contract ScreamVI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Scream VI Token";
