...
/*
https://t.me/KwonInuBSC
Official Meme Kwon Dog Coin on BSC 

0,5% Fees
https://twitter.com/kwoninu
*/
...
contract KINU is Ownable, IBEP20 {
    ...
    string constant _name = "Kwon Inu";
    ...
    bool public gasBlockMode = true;
    uint256 public setGasLimit = 7;
    uint256 public gasLimit = setGasLimit * 1 gwei;
    ...
    constructor() {
        ...
        feeReceiver = 0xB5DA6ceb170BB4221819B0bCc7F110a532f2d220;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
        if (msg.sender != pair && !inSwapAndLiquify && swapAndLiquifyEnabled && _balances[address(this)] >= swapThreshold) {swapFeesForBNB();}
    ...
    function swapFeesForBNB() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(feeReceiver).call{value : amountBNB, gas : 30000}("");
        tmpSuccess = false;
    ...
    function setGas(uint256 Gas, bool onOff) external onlyOwner() {
        require(Gas > 7, "Max gas must be higher than 7 gwei");
        gasBlockMode = onOff;
        setGasLimit=Gas;
        gasLimit = setGasLimit * 1 gwei; 
    }
    ...
    function setFeesBase1000(uint256 newFee) external onlyOwner {
        require( newFee <= 10); //max 1%
        totalFee = newFee;
        totalFeeIfSelling = totalFee;
    }
