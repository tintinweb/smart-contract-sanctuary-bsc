...
contract BNBDAO is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "BNBDAO";       //Full name
    string public symbol_ = "BNBDAO";      //abbreviation

    uint256 public deadFee = 5;       //Destroyed
    uint256 public liquidityFee = 5;      //LP reflow
    uint256 public marketingFee = 30;      //marketing
    ...
    address public marketingWalletAddress = 0x8a2c463641c2A88a4dd90f3bE3c18F575b7d8F86;  //Marketing address
