...
___   |/  /___________ ________      __  ___/__  /____(_)__  /_ 
__  /|_/ /_  _ \_  __ `__ \  _ \     _____ \__  __ \_  /__  __ \
_  /  / / /  __/  / / / / /  __/     ____/ /_  / / /  / _  /_/ /
/_/  /_/  \___//_/ /_/ /_/\___/      /____/ /_/ /_//_/  /_.___/ 
                                                          
Meme Shib - 3% Shiba Inu Reward Token

Taxes 8/8 
Telegram: https://t.me/memeshibportal
Twitter: https://twitter.com/memeshiib
Website: https://www.memeshib.org
...
contract Memeshib is ERC20, Ownable {
    ...
    MSDIVIDENDTracker public dividendTracker;
    ...
    constructor() ERC20("Meme Shib", "memeshib") {
        marketingWallet = payable(0x8d8C6D6047569bb57afc142A6DB8aD0214745F9c);
        devWallet = payable(0x27B30e45102cCF1f126c8a0cED52B3373Ee7ec2E);
        ...
        dividendTracker = new MSDIVIDENDTracker(
            payable(this),
            router,
        ...
        _isExcludedFromFees[address(0x735a75425f4A7066AA1a73E018322e295072c828)] = true;
...
contract MSDIVIDENDTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    address public defaultToken; // Shiba Inu
    ...
    Memeshib public MemeshibContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MemeshibContract = Memeshib(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MS_DIVIDEND_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MS_DIVIDEND_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MemeshibContract);

            uint256 prevBalance = MemeshibContract.balanceOf(address(this));
            ...
            {
                uint256 received = MemeshibContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MemeshibContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
