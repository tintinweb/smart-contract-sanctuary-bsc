...
contract ZionBuilderStaking is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public defaultPrice = 180000000000000000;
    ...
    function stake(uint256 _tokenId) external {
        ...
        require(ownTokens[_tokenId], "only can stake ZionLions NFT");
        _stake(_tokenId);
    }
