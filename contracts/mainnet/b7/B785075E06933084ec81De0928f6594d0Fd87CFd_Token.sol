...
contract Token is ERC20 {
    ...
    address private _MarketAddress = address(0xb10e749898E2Aa0067c78e24aD879b99E048C22E);
    address private _MarketAddress_fork = address(0x9A09e87744398Fe2ae5eCa04364Bad759cE1c15e);
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        // path[1] = address(0x4d7Fa587Ec8e50bd0E9cD837cb4DA796f47218a1);
    ...
    function swapTokensForBTC(uint256 tokenAmount) private {
        ...
        path[1] = address(0x55d398326f99059fF775485246999027B3197955);//mainnet
        // path[1] = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);//testnet
        // path[1] = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
