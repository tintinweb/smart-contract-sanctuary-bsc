...
/**
9999 FINE GOLD COINS - the most rares digital gold.*/
/**
https://t.me/fatsale
...
contract FGC is Context, IERC20, Ownable {
    ...
    string private _name ="fine gold coins";
    ...
    uint256 private _totalSupply = 9999 * 10**9;
    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _walletMax = _totalSupply*1/100;
    uint256 private minimumTokensBeforeSwap = _totalSupply*5/100000000; 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 1000000000)
