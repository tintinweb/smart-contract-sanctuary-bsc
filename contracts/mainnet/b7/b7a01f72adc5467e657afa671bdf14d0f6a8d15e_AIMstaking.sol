...
contract AIMstaking {
	...
	uint256 public WITHDRAW_COOLDOWN = 72 * 60 * 60;
	uint256 public COMPOUND_COOLDOWN = 72 * 60 * 60;
    uint256 public REINVEST_BONUS = 0;
	uint256 public MAX_WITHDRAW = 500000 ether;
	uint256 public WALLET_LIMIT = 500000 ether;
    ...
    uint public startTime = 1674153509;   
	...
	constructor(address payable _dev1, address payable _mkt) {require(!isContract(_dev1) && !isContract(_mkt));
        ...
        plans.push(Plan(130, 10, 300 ether, 500000 ether, 0, 0, 0, 0, true));
	}
