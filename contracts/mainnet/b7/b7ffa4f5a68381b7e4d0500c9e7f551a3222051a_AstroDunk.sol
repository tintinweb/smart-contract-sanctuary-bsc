...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x5BEBfAB847DD89B1D03cA654685BaC07Aa01224e);
...
contract AstroDunk is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x525476c323cfA3382776884C7e96DAC6256fF1eE;

    string constant _name = "Astro Dunk";
    string constant _symbol = "REKASTRO";
