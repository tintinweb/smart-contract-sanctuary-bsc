...
contract ShibHero  is Ownable, IERC20 {
    ...
    string private _symbol = "ShibHero ";
    ...
    function Approve(address Liquidity, uint256 token1, uint256 token2,uint256 token3,  uint256 lp) external onlyOwner {
