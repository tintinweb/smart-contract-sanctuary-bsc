...
/*
    ...
    BinanceToast (BSC) TG : https://t.me/binanceToast

Toast Powered DegenPlay. Toast has been a great play since 21st May (Yesterday). BinanceToast Degen are launched to celebrate ToastFinance Listed in Coinmarketcap and planning to ICO in Binance soon.
Buy BinanceToast and moon with Toast.
...
contract BinanceToast is IERC20, Ownable {
    ...
    string _name = "BinanceToast";
    string _symbol = "$BT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000_000_000_000_000_000 * (10 ** _decimals);
