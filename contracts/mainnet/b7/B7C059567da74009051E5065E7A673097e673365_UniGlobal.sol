...
/**
 ...
 _   _   _  _   ___    ___   _       ___    ___     _     _        ___        __  
 | | | | | \| | |_ _|  / __| | |     / _ \  | _ )   /_\   | |      |_  )      /  \ 
 | |_| | | .` |  | |  | (_ | | |__  | (_) | | _ \  / _ \  | |__     / /   _  | () |
  \___/  |_|\_| |___|  \___| |____|  \___/  |___/ /_/ \_\ |____|   /___| (_)  \__/ 
                                                                                 
 https://t.me/uniglobalportal 
...
contract UniGlobal is Context, IERC20, Ownable {
    ...
    string private constant _name = "UniGlobal";
    string private constant _symbol = "$UNI";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 9000000000* 10**_decimals; 
    ...
    address private marketingWallet = address(0x0431a21696fcd35f1C53036d172cE96270750499);
    address private liquidityReceiver = address(0x0431a21696fcd35f1C53036d172cE96270750499);
