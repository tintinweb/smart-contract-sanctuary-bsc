...
contract XENNCrypto is Context,Ownable, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("XENN Crypto", "XENN") {
    ...
    function claimRank(uint256 term) external payable claimCompliance{
		
		require(msg.value == 0.01 ether,"Need 0.01 BNB");
