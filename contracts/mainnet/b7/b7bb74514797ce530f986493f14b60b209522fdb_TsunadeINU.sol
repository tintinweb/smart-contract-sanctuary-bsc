...
contract TsunadeINU is IBEP20, Auth {
    ...
    string constant _name = "Tsunade Inu";
    string constant _symbol = "$Tsinu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 200 ) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 400) / 100; 
    ...
    address public marketingFeeReceiver = 0x15d23d4cDc8C097F968D105D82896671ECFB289D;
    address public devFeeReceiver = 0x15d23d4cDc8C097F968D105D82896671ECFB289D;
