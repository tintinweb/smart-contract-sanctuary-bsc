...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAb048E49d0FFCd64fCB5F7cA03859C2863Ddd6c;
...
contract ChuyCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x06E796C26b6F07a03F915a72AF571010Fd82B533;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ChuyCoin";
    string private _symbol = "CHUY";
