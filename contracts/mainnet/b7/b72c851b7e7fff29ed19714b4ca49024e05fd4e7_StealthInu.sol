...
// $SINU | Stealth Inu
// Telegram: https://t.me/StealthInuV3

// Fair Launch, no Dev Tokens. 100% LP and Aidrop from v1 and v2 holders.
// Snipers will be nuked.

// LP Lock immediately on launch.
// Ownership will be renounced 30 minutes after launch.
// Stealth Inu v1 & v2 holders will receive 10% extra airdropped STLTH tokens on their first purchase!

// Slippage Recommended: 10%
// No supply limit: 30s cooldown between transfers.
// Audit & Fair Launch handled by https://t.me/FairLaunchCalls
// Community-owned token, Stealth Launched.
...
contract StealthInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xE1AdccCdb0971d88Bc1FBc8A4D6f5ab7232E57EB;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Stealth Inu V3 | t.me/StealthInuV3";
    string constant _symbol = "STLTH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xE1AdccCdb0971d88Bc1FBc8A4D6f5ab7232E57EB;
