...
contract MobiusNeuron is Modifier, Util {
    ...
    constructor() {
        joinLimit = 600000000000000000000;
        ...
        mobiusSlippage = MobiusSlippage(0x1298737377201C49DA62248320Ec08cc09999FEC);
        pancakePair = 0x535e62ECDE1B8C23C3d9b8dA120863BDab620266;
        testFlag = true;
    }
    ...
    function setTestFlag(bool _flag) public onlyOwner {
        testFlag = _flag;
    }
