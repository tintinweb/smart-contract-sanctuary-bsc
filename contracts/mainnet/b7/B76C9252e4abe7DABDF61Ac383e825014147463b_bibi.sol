...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;//路由地址
    IBEP20 RewardToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE,分红大狗下面的也要改,分红什么改什么
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 38;
...
contract bibi is IBEP20, Auth {//记得改你的币的名字，部署合约也是部署这个名字的文件
    
    using SafeMath for uint256;

    string constant _name = "KK";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;//路由地址
    address RewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;//分红大狗

    uint256 _totalSupply = 1*10**38;//数量
    ...
    uint256 public liquidityFee = 4;//流动费，买卖都是4，建议这三个费用最初改为0，后面上链改
    uint256 public marketingFee = 4;//营销地址费用
    uint256 public rewardsFee = 2;//分红的费用
    uint256 public extraFeeOnSell = 2;//这个不要改

    uint256 public totalFee = 0;//统计总费用
    uint256 public totalFeeIfSelling = 0;//统计销售总费用
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;//0x834cAb7d24b4f860D28E220764daC1eF9B67CC07
        anothermarketingWallet = 0xE522E14C1C3314E5E725773a45FFF5a5CB128c52;//修改你自己的
