...
contract KaidoChanInu is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x21516d3AfeC9C9fD073D5d2E6d3eEf32CbE1a59d);
    ...
    string private constant _name = "KaidoChan Inu"; 
    string private constant _symbol = unicode"KCI"; 
    ...
    constructor () {
        ...
        _owner = 0x21516d3AfeC9C9fD073D5d2E6d3eEf32CbE1a59d;
