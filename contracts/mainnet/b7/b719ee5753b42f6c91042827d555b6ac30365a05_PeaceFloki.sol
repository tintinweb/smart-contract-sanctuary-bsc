...
/**
 ...
 With all the rumors of wars happening in the world, let's join together and unite with peace by supporting this project.
 SAFU DEV and has connections with many influencers!
 ...
 15,000 (1.5%) max tx || 30,000 (3%) max wallet
...
contract PeaceFloki is IBEP20, Auth {
   ...
   string constant _name = "Peace Floki";
   string constant _symbol = "Peacefloki";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 15 ) / 1000; // 
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0xB94Ba19Bc39d9f4Acc4b8D80440FB3985f60a714;
       marketingFeeReceiver = 0xB94Ba19Bc39d9f4Acc4b8D80440FB3985f60a714;
