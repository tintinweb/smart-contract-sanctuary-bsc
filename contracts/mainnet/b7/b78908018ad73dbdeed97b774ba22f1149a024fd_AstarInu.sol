...
/**
   ...
   Degen play, If you want to create a telegram I suggest to name it to @AstarInuBSC
   Important: The early you create a group that shares the token, the more gain you'll get.

   I will renounce the ownership to burn addresses to transfer #ASTR to the community, make sure it's 100% safe.
...
contract AstarInu is Context, IERC20, Ownable {
    ...
    string private _name = "Astar Inu";
