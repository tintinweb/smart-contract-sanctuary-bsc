...
contract ASTROSHB is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x9fE0176932277d535f3Be8020A109Bb7b08A1901;
    address DevWallet       = 0x9fE0176932277d535f3Be8020A109Bb7b08A1901;

    string constant _name = "Astro Shiba";
    string constant _symbol = "ASTROSHB";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 100000000 * (10 ** _decimals);
