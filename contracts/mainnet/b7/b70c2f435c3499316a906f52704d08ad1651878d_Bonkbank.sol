...
contract Bonkbank is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BONKBANK";
    string private constant _symbol = unicode"$BOANK";
    ...
    address payable public DevWallet = payable(0xEb969AC4A3734b6382c4510667A6caA8DA1475aA);
    address payable public MarketingWallet = payable(0xBC06149Af1a1D32AFC238b889E71029f87393e3B);
