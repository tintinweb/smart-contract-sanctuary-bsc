...
// File: @openzeppelin/contracts/custom/ICakePool.sol
...
contract CakeStaker is Ownable, ReentrancyGuard {
    ...
    constructor(address _cakePool, address _cakeToken, uint256 _lockDuration){
        cakePoolAddress = _cakePool;
        cakePool = ICakePool(cakePoolAddress);
        cakeToken = IERC20(_cakeToken);
        lockDuration = _lockDuration;
    }

    function unlock() public onlyOwner{
        cakePool.unlock(address(this));
    }
    ...
    function withdrawByAmount(uint256 _amount) public onlyOwner {
