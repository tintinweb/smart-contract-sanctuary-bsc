...
contract HyugaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hyuga Inu";
    string private _symbol = "HYNU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDB95E474De082181AebEde37599f30D6236F212A);
    address payable public BuyBackWalletAddress = payable(0xDB95E474De082181AebEde37599f30D6236F212A);
