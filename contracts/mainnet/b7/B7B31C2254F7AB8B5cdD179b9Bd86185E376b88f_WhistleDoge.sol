...
contract WhistleDoge
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "WhistleDoge";
    string private _symbol = "WhistleDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x190a9AEE47540114d8464F298Fc2FfD48448DE60));
        _anotherA = payable(address(0x190a9AEE47540114d8464F298Fc2FfD48448DE60));
