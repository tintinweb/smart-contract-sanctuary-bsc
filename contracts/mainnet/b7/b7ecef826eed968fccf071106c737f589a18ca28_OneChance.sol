...
contract OneChance is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("One Chance", "OCT") {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyProjectFee;
        
        sellMarketingFee = _sellMarketingFee;
        sellMarketingFee = _sellProjectFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellProjectFee;
        
    	marketingWallet = address(0xdD32599E59fF0C6105E637422F8c5c491De5229d); // set as marketing wallet
        projectWallet = address(0xd2c870830937612f4b5C7A504113a68cC51c7aa0); // set as project wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _projectFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellProjectFee;
        require(sellTotalFees <= 25, "Must keep fees at 30% or less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if(tokensForProject > 0){
                super._transfer(from, projectWallet, tokensForProject);
            }
