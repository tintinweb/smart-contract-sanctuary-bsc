...
/**
Son OF Busdy Boobs. Extreme BUSD Rewards. https://t.me/SonOFbusdyBoobs
*/
...
contract SonOFBusdyBoobs is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Son OF Busdy Boobs";
    string constant _symbol = "BUSDYSON";
