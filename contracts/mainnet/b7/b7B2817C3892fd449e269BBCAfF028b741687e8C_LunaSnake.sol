...
Telegram: https://t.me/LunaSnakeOfficial
...
contract LunaSnake is ERC20, Ownable {
    ...
    LunaSnakeDividendTracker public dividendTracker;

    address public immutable LUNA = address(0x156ab3346823B651294766e23e6Cf87254d68962); //LUNA

    address public marketingWallet = 0x1c53626bAde107e512FC68297a780cb57b563e2c;
    address public devWallet = 0xAC2a4Fe857f6372b317d027EEf2038ccAcDE62C5;

    uint256 public swapTokensAtAmount = 2_350_000_000_000 * 10**9;
    uint256 public maxWalletAmount = 1e15 * 10**9;
    uint256 public maxBuyAmount = 1e15 * 10**9;
    uint256 public maxSellAmount = 5e12 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(2,5,0,0);
    Taxes public sellTaxes = Taxes(7,5,0,0);
    ...
    constructor() ERC20("Luna Snake", "LUNS") {

    	dividendTracker = new LunaSnakeDividendTracker();

    	IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         // Create a LUNAswap pair for this new token
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        LunaSnakeDividendTracker newDividendTracker = LunaSnakeDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LunaSnake: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "LunaSnake: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LunaSnake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LunaSnake: Cannot update gasForProcessing to same value");
   ...
   ////////////////////////
    ...
    function swapTokensForLUNA() private {
...
contract LunaSnakeDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("LunaSnake_Dividen_Tracker", "LunaSnake_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "LunaSnake_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "LunaSnake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LunaSnake_Dividend_Tracker: Cannot update claimWait to same value");
