...
/*
WELCOME TO TATEVERSE...WHAT COLOR IS YOUR BUGATTI
...
contract   TATEVERSE is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("TATEVERSE", "TATEVRS") { // 
        marketingWallet = payable(0x5e39797EaDd58645Cc5fDaA24718B9D0c0065F87); //
        devWallet = payable(0xc061899a5E3e4fBb4797F6aE0734139B4c583acE); // 
