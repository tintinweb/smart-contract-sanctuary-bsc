...
/**
    𝐂𝐇𝐄𝐄𝐌𝐒𝐌𝐀𝐒 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐂𝐎𝐍𝐓𝐑𝐀𝐂𝐓

    Cheems will join for a party 
    and celebrate the Christmas 
    With a strong community on 
    Binance smart Chain.

Telegram : https://t.me/Cheemsmasofficial
...
contract CHEEMSMAS is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHEEMSMAS"; // 
    string private constant _symbol = "CMAS"; //    
