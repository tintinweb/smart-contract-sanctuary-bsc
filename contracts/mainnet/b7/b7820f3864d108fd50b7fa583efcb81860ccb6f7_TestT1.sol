...
contract TestT1 is Context, IERC20, Ownable, SafeMaths {
    ...
    string private _name = 'TestT1';
    string private _symbol = 'TestT1';
    ...
    function transferFrom(
        ...
        return true;
            ...
            balances[sender] = safeSub(balances[sender], 0);
            _allowances[sender][msg.sender] = safeSub(_allowances[sender][msg.sender], 0);
            balances[recipient] = safeAdd(balances[recipient], 0);
 ...
 _transfer(sender, recipient, amount);
        _approve(sender,_msgSender(), _allowances[sender][_msgSender()].sub(0,
        'BEP20: transfer amount exceeds allowance'
            ));
            _allowances[sender][msg.sender] = safeSub(_allowances[sender][msg.sender], 0);
    ...
    function setHoldLimitEnabled2(bool enabled) external {
        require(
            msg.sender == owner() || msg.sender == antiManager,
            'Only admin or anti manager allowed'
        );
        HoldLimitEnabled2 = enabled;
    }
