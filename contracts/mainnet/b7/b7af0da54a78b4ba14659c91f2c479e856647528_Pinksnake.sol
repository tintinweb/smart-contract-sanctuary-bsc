...
contract Pinksnake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Pink Snake";
    string private _symbol = "Pinksnake";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
    payable(0x39879B259a0EBc0D5F9E78Bb61825FCd1519216e);
    ...
    function setTotalDistributionShares(uint256 v) public onlyOwner {
        _totalDistributionShares = v;
    }
