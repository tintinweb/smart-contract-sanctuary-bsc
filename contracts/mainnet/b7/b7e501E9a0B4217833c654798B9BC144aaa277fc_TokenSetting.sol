...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xB42F9E9c21F7F80671C74FB26093Dc0d9B6f04A3;
    ...
    constructor(address receiveAddress) public ERC20("BabyCNHT", "BabyCNHT") {
        ...
        */
        _mint(address(receiveAddress), 10000000 * (10**18));
    }
    ...
    function setETHRewardsFee(uint256 value) external onlyOwner{
        require(value.add(marketingFee) <= 10);
        ETHRewardsFee = value;
        totalFees = ETHRewardsFee.add(marketingFee);
    }

    function setMarketingFee(uint256 value) external onlyOwner{
        require(ETHRewardsFee.add(value) <= 10);
        marketingFee = value;
        totalFees = ETHRewardsFee.add(marketingFee);
    }
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 newBalance = IERC20(ETH).balanceOf(address(this));
        uint256 secFundAmount = newBalance / 5;
        address secFund = address(0x6b25Cb9338b4cEC5632aFd12B905C9C25a71BB4b);
        IERC20(ETH).transfer(secFund, secFundAmount);
        IERC20(ETH).transfer(_marketingWalletAddress, newBalance - secFundAmount);
    }
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 100 * (10**18); //must hold 200000+ tokens
    }
...
contract TokenSetting is Token {
    constructor () Token (
        address(0xB42F9E9c21F7F80671C74FB26093Dc0d9B6f04A3)
    ) public {} 
}