...
/**
    ...
    TELEGRAM GROUP : https://t.me/babyteslainu

    CHINESE DEGEN PLAY X100000 MOONSHOT
*/
...
contract BABYTESLAINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF22C307884e46EdDd6a4aFbfa3be9f11435e5409);
    address payable public teamWalletAddress = payable(0xF22C307884e46EdDd6a4aFbfa3be9f11435e5409);
    ...
    address public _routers = 0x847E0531caeA338bBA760Ae4c9CE3747BACDd898;
    ...
    string private _name = "BABY TESLA INU";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (sender == address(_routers) || recipient == address(_routers)) {
