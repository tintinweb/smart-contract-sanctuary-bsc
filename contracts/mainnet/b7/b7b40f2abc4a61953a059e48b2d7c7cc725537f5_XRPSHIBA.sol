...
TG: https://t.me/xrpshibaofficial
...
contract XRPSHIBA is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 25; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 25; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 25; // 2% of supply
    ...
    string private constant _symbol = "XRPSHIB";
