...
contract Pokelon_StakePool is Ownable{
    ...
    uint256 public Pool = 10000000000000;
    uint256 public PoolBalance;
    uint256 public tokenDecimal = 9;

    uint256 public poolNumber = 1;
    uint256 public poolRewardPercent = 120;
    uint256 public fullMaturityTime = 30 days; 
    uint256 public earlyMaturityTime = 15 days; 
    uint256 public stakeLimit = 100000000000;
    ...
    function PoolStake(uint256  _amount) public returns (bool) {
        ...
        require(_amount<= (stakeLimit * 10**tokenDecimal),"Amount should be less than or equal to stake limit");
