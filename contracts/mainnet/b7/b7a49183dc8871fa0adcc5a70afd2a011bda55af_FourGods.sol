...
contract FourGods{
    ...
    string private _name = "FourGods";
    string private _symbol = "FOG";
    ...
    uint256 private salePrice = 30000; // 1 BNB
    ...
    constructor() public {
        _devAddress = 0x183D2EcFa4cC7caA788715288dBF91d79Eee9b1F; // LA
        _presaleAddress = 0x4280c158EB324d9dbE6798e538C0990131828064; // TO
        address _BurnAddress = 0xC70667cA4A14C55Ed9F0753e28BF1E403282717A; // MA
        _owner = msg.sender;

        
        _mint(_presaleAddress, 9000000*10**18);

    
        _mint(_devAddress, 40700000*10**18);

    
        _mint(_BurnAddress,300000*10**18);
    }
   ...
   function endPresale() public onlyOwner {
    ...
    function buyPresale(address _refer) payable public returns(bool){
        ...
        uint referToken = _token.mul(_referToken).div(30000);
