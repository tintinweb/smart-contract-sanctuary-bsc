...
contract BlackPanther is Context, IERC20, Ownable {
    ...
    string private _name = "BlackPanther";
    string private _symbol = "BlackPanther";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xC7665B6Dab6Ac047Ed39910b2BBA506D3A1EE310); 
    address payable private teamWalletAddress = payable(0x13660F40E701D568c3A620d00867F6d677b79b98); 
