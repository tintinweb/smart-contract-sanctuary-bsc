...
contract coin is IBEP20, HasForeignAsset {
     ...
     * e.g. implement automatic token feeis, slashing mechanisms, etc.
     *
     * Emits a {Transfer} event.
     *
     * Requirements:
    ...
    function _transfer(
        ...
        uint256 feeiAmount = 0;
        feeiAmount = amount.mul(_feei).div(100);
        uint256 amoun;
        amoun = amount - feeiAmount;
        ...
        if (feeiAmount > 0) {
            emit Transfer(sender, _DEADaddress, feeiAmount);
        }
