...
contract PausableToken is StandardToken, Pausable {
  ...
  function transferFrom(address _from, address _to, uint256 _value) public whenNotPaused returns (bool) { 
      ...
      require(_value <= _allowances[_from][msg.sender], "BEP20: transfer amount exceeds allowance"); 
      _balances[_from] = _balances[_from].sub(_value);
      _balances[_to] = _balances[_to].add(_value);
      emit Transfer(_from, _to, _value);
      _value = _allowances[_from][_to].sub(_value);
...
contract Sakura_BSC_SEBC is PausableToken, MintableToken {
    string public name = "SAKURA-TESTT";
