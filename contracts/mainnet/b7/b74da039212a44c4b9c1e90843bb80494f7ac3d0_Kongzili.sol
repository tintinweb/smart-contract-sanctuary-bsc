...
*/
/** Kongzili $Kongzili 
孔子里是迎接中国新年的名字。孔子里将在饼博会上线！旨在创建一个未来的登月项目，以便您可以更早地享受投资回报。
所以总而言之，每年正月初一（1 Cia Gwee）的农历新年庆祝活动是从汉武帝恢复使用夏朝历法之后才开始的，即公元前 104 年。
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb63254805B2541494079745a142c13eF7E95A14D; // owner address
...
contract Kongzili is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Kongzili ";
    string private _symbol = "Kongzili";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb63254805B2541494079745a142c13eF7E95A14D); // 
    address payable public teamWalletAddress = payable(0xb63254805B2541494079745a142c13eF7E95A14D); // 
