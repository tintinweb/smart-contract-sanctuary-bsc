...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb226159C2FB7D62fCc34B0Fdf73bBFEc1fA912C8; // 所有者地址
...
contract DogeHalloween is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Halloween";
    string private _symbol = "DGHW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb226159C2FB7D62fCc34B0Fdf73bBFEc1fA912C8); // 营销地址
    address payable public teamWalletAddress = payable(0x5fAea41e39DD8dc93C19F8dEe4b771432319B9D3); // 团队地址
