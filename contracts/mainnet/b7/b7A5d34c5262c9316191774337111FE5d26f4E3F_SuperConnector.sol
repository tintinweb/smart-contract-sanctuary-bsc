...
/**
 New Launchpad in BSC!
 Telegram to be announced in private Group soon!
...
contract SuperConnector is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Connector"; 
    string private constant _symbol = "SUPER"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0xE3E0B013cFaB9Bb891C11de048A1bf3F5EFa68a1; 
