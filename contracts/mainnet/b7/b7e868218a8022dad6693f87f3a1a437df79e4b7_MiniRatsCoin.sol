...
contract MiniRatsCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniRatsCoin";
    string private _symbol = "MRC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8de44325869f80D95e2ee0e1E45503b12A5A4821); 
    address payable public buyBackWalletAddress = payable(0x8de44325869f80D95e2ee0e1E45503b12A5A4821); 
