...
contract ElvnPrivateDealsARtonar is Ownable {
    using SafeERC20 for IERC20;

    //General Informations
    string public constant NAME = "11Minutes Private Deals ARtonar - Private Round"; //name of the contract
    ...
    constructor(
        ...
        maxAllocationPerUserPerTier[1] = 50 ether;
        maxAllocationPerUserPerTier[2] = 100 ether;
        maxAllocationPerUserPerTier[3] = 200 ether;
        maxAllocationPerUserPerTier[4] = 350 ether;
        maxAllocationPerUserPerTier[5] = 500 ether;
        maxAllocationPerUserPerTier[6] = 750 ether;
        maxAllocationPerUserPerTier[7] = 1000 ether;
        maxAllocationPerUserPerTier[8] = 2000 ether;
