...
contract SquidRed is Context, IERC20, Ownable {
    ...
    string private _name = "Squid Red";
    string private _symbol = "SQUIDRED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7De75DAC53BE4f84000fB26ba6B33Ec8c756ff8A); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x2a029B3A59870a7a222462FF6D8c2E73CA9F7600); // Development Address
