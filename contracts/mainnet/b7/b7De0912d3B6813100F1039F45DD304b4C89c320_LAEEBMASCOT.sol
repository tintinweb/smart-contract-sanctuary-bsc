...
/* Token contract */
contract LAEEBMASCOT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x302C4e675e663e746449e852408ea5eBC5AcE1d2;
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 1% or 5M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 70 / 10000; // 2% of supply, 0.3%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x302C4e675e663e746449e852408ea5eBC5AcE1d2;
