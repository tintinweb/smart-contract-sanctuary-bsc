...
contract BurntHair is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x259cacfC016d82445f473198C4751b7518432a39);
    address payable public teamWalletAddress = payable(0x259cacfC016d82445f473198C4751b7518432a39);
