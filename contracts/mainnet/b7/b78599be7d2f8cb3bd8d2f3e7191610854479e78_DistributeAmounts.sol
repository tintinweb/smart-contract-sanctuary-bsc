...
contract DistributeAmounts is OwnableUpgradeable, ReentrancyGuardUpgradeable, IAmountsDistributor {
    ...
    function _buyAndBurnGYMNET(uint256 _buyAndBurnAmountGYM) private {
        IERC20Upgradeable(busdAddress).safeTransfer(buyAndBurnAddress, (5 * _buyAndBurnAmountGYM) / 11);
        IERC20Upgradeable(busdAddress).safeTransfer(gymLiquidityWallet, (6 * _buyAndBurnAmountGYM) / 11);
    }
