...
contract ChonkInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xE886E69629e1B5D7689229D53692ccc70D80167F));
    address payable public devWallet =
        payable(address(0xc2e274CE6BBB3Ebf503248e456B977e0BfD08bf7));
    address public liquidityReceiver =
        0xE886E69629e1B5D7689229D53692ccc70D80167F;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "ChonkInu";
