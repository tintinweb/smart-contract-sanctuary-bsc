...
// File contracts/Tatesupreme.sol
...
contract TateSupreme is ERC20DividendToken {
    ...
    constructor (address _marketingAddress) ERC20DividendToken("Tate Supreme", "Tate", _tokenSupply, _routerAddress, _marketingAddress) {
