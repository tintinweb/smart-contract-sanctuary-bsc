 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/DoggerRocket
 * 
 * 
 * Dogger Rocket Coin token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract Doggerrocketcoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dogger Rocket Coin";
    string constant _symbol = "DoggerRocket";
