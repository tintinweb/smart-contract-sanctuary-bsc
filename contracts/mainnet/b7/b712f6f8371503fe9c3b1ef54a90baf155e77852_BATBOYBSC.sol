...
contract BATBOYBSC is IBEP20, Auth {
    ...
    string constant _name = "BATBOY";
    string constant _symbol = "BATBOY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 3 / 1000; // 0.2%
    uint256 public _maxTxAmountSell = _totalSupply * 3 / 1000; // 0.2%

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 1000; // 0.2%
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xa281bfE10FcD2B8a5107E8Ad1aC3fAE301f77e5d;
        marketingFeeReceiver = 0xa281bfE10FcD2B8a5107E8Ad1aC3fAE301f77e5d;
        devFeeReceiver = 0x627650EB60c5B05917FDd72A52b646a65a1019Ed;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && !_intAddr[sender]) {
