...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3f21e9f75c7c2235e614f8d0B0A7Acdb0bfC35b; // owner address
...
contract SoloTurk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solo Turk";
    string private _symbol = "$ST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3f21e9f75c7c2235e614f8d0B0A7Acdb0bfC35b); // Marketing Address
    address payable public teamWalletAddress = payable(0xb3f21e9f75c7c2235e614f8d0B0A7Acdb0bfC35b); // Team Address
