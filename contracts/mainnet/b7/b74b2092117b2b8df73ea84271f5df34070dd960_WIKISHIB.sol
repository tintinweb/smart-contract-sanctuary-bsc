...
interface IUniswapV2Router02 {
 ...
 contract WIKISHIB is Context, IERC20, Ownable {
    ...
    string private constant _name = "WIKI SHIB";
    string private constant _symbol = "WIKISHIB";
