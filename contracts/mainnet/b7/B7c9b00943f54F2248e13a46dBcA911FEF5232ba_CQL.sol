...
contract CQL  is IERC20, Ownable {
    ...
    NFT     public NFTCQ     = NFT(0x25a5CecF792106198389D1Abd342C2835302B9Ca);
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            // .createPair(address(this),address(0x55d398326f99059fF775485246999027B3197955));
                        .createPair(address(this),address(0x1733865E77F044420480c18B03A42BfAEf63AF78));
...
function includeInFee(address account) public onlyOwner {
    ...
    function _transferStandard(
       ...
       function get_aount() public view returns(uint256) {
        ...
        uint256 usdtBalance = IERC20(0x1733865E77F044420480c18B03A42BfAEf63AF78).balanceOf(address(uniswapV2Pair));
