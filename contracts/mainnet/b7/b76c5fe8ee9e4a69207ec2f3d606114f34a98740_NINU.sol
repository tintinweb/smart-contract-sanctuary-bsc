...
contract NINU is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"NAGATO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevAddress = payable(0x3586D5E2C86Bc4eCbc7FFD6E282EcE9c276338A6);
    address payable private MarketingAddress = payable(0x265a7b99448620c1335ce2C36785a3764b45cf26);
