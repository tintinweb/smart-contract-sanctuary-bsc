...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x392Beb0038020DcEA53BE0ED3835574dCf7bA530; 
...
contract DinjaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dinja Inu";
    string private _symbol = "$DINJA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x392Beb0038020DcEA53BE0ED3835574dCf7bA530); // 
    address payable public teamWalletAddress = payable(0x392Beb0038020DcEA53BE0ED3835574dCf7bA530); // 
