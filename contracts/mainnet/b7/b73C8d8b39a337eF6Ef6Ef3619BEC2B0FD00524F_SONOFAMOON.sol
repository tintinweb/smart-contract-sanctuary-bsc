...
`.                    .'.'   .        .               .            .    .
`.`.________________.'.'  .       .        .              .          .
  `.________________.'Son Of A Moon
.     .          .          .         .        .          .      .
  .       .           .          .        .        .         .
       .      "      .      "                .         .
               .                .       "         .               . .    " .
...
LP will be initially locked 24hrs 
Extended at 10k for 1 week
Extended at 50k for 2 weeks
Extended at 100k for 1 month
Extended at 1M for 3 months
...
35% ANTI JEET TAX
first 30 mins after launch

back to normal 15% sell after 60mins

Max Wallet = 6%
Max buy and sell = 2%

4,5% Team Tokens [Split over 9 members]
95.5% PCS Listing 
...
contract SONOFAMOON is IBEP20, Ownable {
    ...
    uint256 public SelldevFee          = 8;//buyback
    ...
    // Fees receivers
    address private autoLiquidityReceiver = 0x6dA62dEaab37a69BCd4c0bCb55Cc69e0Cac48C08; //LP receiver
    address private marketingFeeReceiver = 0x8A967addF6DAA639bf2E60f835D431bDC3730877; //mkt
    address private devFeeReceiver = 0x512DDb71C4448f1C679790d154688EeCFb259aCe; //31 BuyBack
    address private teamFeeReceiver = 0xeb1c9De2BcB3550A4625cbF0b9dC124233d4CE7D; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0xBd26d7CFCefa4eE29F63c4Eb0732B3cE8492016e;
