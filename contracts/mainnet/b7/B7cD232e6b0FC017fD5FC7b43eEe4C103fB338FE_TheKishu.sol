...
abstract contract Auth {
    ...
    /**
     * Remove address' authorization. Owner only by owner
     */
    ...
    /**
     * Check if address is owner{owner=thekishu}
     */
    ...
    /**
     * Return address' authorization status {unconverted}
     */
    ...
    /**
     * Transfer ownership to new address. Caller must be owner. Leaves old owner authorized main
     */
...
contract TheKishu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "The Kishu";
    string constant _symbol = "$KISHU";
    ...
    uint256 public _walletMax = _totalSupply * 19 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;  //The Kishu
        anothermarketingWallet = 0x81358e0527429330Aab9714CFBD8D8EA0C4eE963;
