...
contract SafuuParty is ERC20Detailed, Ownable {
    ...
    string public _name = "SafuuParty";
    string public _symbol = "SAFUUPARTY";
    ...
    constructor() ERC20Detailed("SafuuParty", "SAFUUPARTY", uint8(DECIMALS)) Ownable() {
