...
contract lzCore is Ownable, ERC721Enumerable, NonblockingReceiver {
    ...
    AggregatorInterface internal bnbUSDAPI;
    ...
    /*
        ...
        Harmony ,
     */
    string public chainName = "Binance Smart Chain";
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("Layer Zero Name Service", "LZNM") { 
        ...
        baseURI = baseURI_;
        bnbUSDAPI = AggregatorInterface(0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE);
    }
    ...
    function bnbUSD() public view returns (int256) {
        return bnbUSDAPI.latestAnswer()*10**10;
    }
    ...
    function domainPrice(string memory domainName) public view returns(uint256){
        ...
        if (lenCount <= 3){
            return (threeLetter / bnbUSD()).toUint256();
        }
        else if(lenCount == 4){
            return (fourLetter / bnbUSD()).toUint256();
        }
        else if(lenCount >= 5){
            return (fiveLetter / bnbUSD()).toUint256();
        }
    }
