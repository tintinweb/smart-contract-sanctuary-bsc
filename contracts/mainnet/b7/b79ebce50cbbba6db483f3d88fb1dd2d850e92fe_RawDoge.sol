...
contract RawDoge is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SecondDividendTracker public dividendTrackerSecond;
    ...
    constructor() ERC20 ("Raw Doge", "ROGE") {
		...
		marketingWallet = payable(0xA57D3a84c53616Ca71b3e0B490D736E1A1e00488);
        _devWallet1 = payable(0xa4Ab12184900C1ADf0f9d3F11505151A77e89A94);
        _devWallet2 = payable(0x8EEe15139637182C147cdF732f8c36107C02ED48);
        ...
        */
        _mint(owner(), 696969696969696969 * (10**18));
    ...
    function updateDividendTrackerFirst(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerFirst), "Raw Doge The dividend tracker already has that address");

        FirstDividendTracker newDividendTrackerFirst = FirstDividendTracker(payable(newAddress));

        require(newDividendTrackerFirst.owner() == address(this), "Raw Doge: The new dividend tracker must be owned by the Raw Doge token contract");
    ...
    function updateDividendTrackerSecond(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerSecond), "Raw Doge The dividend tracker already has that address");

        SecondDividendTracker newDividendTrackerSecond = SecondDividendTracker(payable(newAddress));

        require(newDividendTrackerSecond.owner() == address(this), "Raw Doge: The new dividend tracker must be owned by the Raw Doge token contract");
    ...
    function updateFirstDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenFirst), "Raw Doge: The router already has that address");
    ...
    function updateSecondDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenSecond), "Raw Doge: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Raw Doge: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Raw Doge: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Raw Doge: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Raw Doge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Raw Doge: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Raw Doge: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Raw Doge: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Raw Doge: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Raw Doge: Cannot update gasForProcessing to same value");
