...
/*
𝘛𝘦𝘭𝘦𝘨𝘳𝘢𝘮 : 𝘩𝘵𝘵𝘱𝘴://𝘵.𝘮𝘦/𝘤𝘩𝘢𝘥𝘴𝘤𝘭𝘶𝘣𝘴
𝘛𝘸𝘪𝘵𝘵𝘦𝘳 : 𝘩𝘵𝘵𝘱𝘴://𝘵𝘸𝘪𝘵𝘵𝘦𝘳.𝘤𝘰𝘮/𝘤𝘩𝘢𝘥𝘴𝘤𝘭𝘶𝘣𝘴
𝘞𝘦𝘣𝘴𝘪𝘵𝘦 : 𝘩𝘵𝘵𝘱𝘴://𝘤𝘩𝘢𝘥𝘴𝘤𝘭𝘶𝘣𝘴.𝘹𝘺𝘻
*/
...
contract ChadsClubs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHADSCLUBS";
    ...
    address payable public marketingWalletAddress = payable(0x3e9960e8F7Ffb6E3C2F2D140e7180fD623B18F9E);
    address payable public teamWalletAddress = payable(0x3e9960e8F7Ffb6E3C2F2D140e7180fD623B18F9E);
    ...
    uint256 private minimumTokensBeforeSwap = 900000 * 10**_decimals; 
    ...
    function BuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function SellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
