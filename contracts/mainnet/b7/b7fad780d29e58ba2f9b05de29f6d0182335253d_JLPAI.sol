...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x7c7ee242EE7Fe7f208bC7648873A5c0400317482;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
...
contract JLPAI is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0x7c7ee242EE7Fe7f208bC7648873A5c0400317482;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Jin Li Token";
    string constant _symbol = "JLPAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * 10*9 * (10 * _decimals);
    ...
    uint256 giveawayFeeSell     = 7;
    uint256 public totalFeeSell = 24; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7c7ee242EE7Fe7f208bC7648873A5c0400317482;
        teamFeeReceiver = msg.sender;
        giveawayFeeReceiver = 0x7c7ee242EE7Fe7f208bC7648873A5c0400317482;
