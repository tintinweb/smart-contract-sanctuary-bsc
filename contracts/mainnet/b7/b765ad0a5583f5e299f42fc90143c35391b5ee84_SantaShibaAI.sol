...
contract SantaShibaAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santa Shiba AI";
    string private constant _symbol = "SSAI";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000 * 10**9 * 10**9;
    uint256 private constant _swaptokenatamount = 1000 * 10**9 * 10**9;
