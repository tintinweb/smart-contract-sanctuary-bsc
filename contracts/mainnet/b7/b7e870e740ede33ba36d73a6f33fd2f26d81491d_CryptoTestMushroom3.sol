...
// File: contracts/CryptoChampion/CCG.sol
...
contract CryptoTestMushroom3 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x368Dd687dcdb67a8D81bBe40d56E07438b0Ee35d));
    address payable public _devwallet =
        payable(address(0x684FFf74D8d9dAcE452e79b15738261095c60094));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Crypto Test Mushroom 3";
    string private _symbol = "CtestM3";
