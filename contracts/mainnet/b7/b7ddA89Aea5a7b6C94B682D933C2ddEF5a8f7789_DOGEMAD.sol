...
//telegram: https://t.me/dogemadofficial
interface IERC20 {
...
contract DOGEMAD is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_222_222 * 10**_decimals;
    
    uint256 public maxSellAmount = 1_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 1_500_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3_000_000 * 10**_decimals;

    address public marketingAddress = 0x23DF6708Ef6452B290eF18198137E43397276B08;
    address public devAddress = 0x23DF6708Ef6452B290eF18198137E43397276B08;

    string private constant _name = "DOGE MAD";
    string private constant _symbol = "$DOMAD";
    ...
    Taxes public sellTaxes = Taxes(1,7,5,1);
