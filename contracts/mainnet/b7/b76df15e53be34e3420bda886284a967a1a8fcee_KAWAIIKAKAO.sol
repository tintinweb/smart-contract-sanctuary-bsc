...
contract KAWAIIKAKAO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Kawaii Kakao";
    string constant _symbol = "$KawaKa";
    ...
    address public marketingFeeReceiver = 0x100a20A05b0485DFB9B88fB148499f69d9B9F17c;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x100a20A05b0485DFB9B88fB148499f69d9B9F17c] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x100a20A05b0485DFB9B88fB148499f69d9B9F17c] = true;
