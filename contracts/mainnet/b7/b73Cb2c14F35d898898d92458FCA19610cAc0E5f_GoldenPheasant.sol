...
library Address{
 ...
 contract GoldenPheasant is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x98EcE3Fa8bAC0F9A86f9166006DACbf9479825d1;
    address public donationWallet = 0x98EcE3Fa8bAC0F9A86f9166006DACbf9479825d1;

    string private constant _name = "Golden Pheasant";
    string private constant _symbol = "GOLDENPHEASANT";
    ...
    Taxes public taxes = Taxes(1, 4, 1, 4);
    Taxes public sellTaxes = Taxes(1, 4, 2, 4);
