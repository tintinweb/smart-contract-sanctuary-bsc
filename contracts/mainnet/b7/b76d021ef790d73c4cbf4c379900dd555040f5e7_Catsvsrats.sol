...
contract Catsvsrats is Context, IERC20, Ownable {
    ...
    string private constant _name = "CATS VS RATS";
    string private constant _symbol = "C?!R?!";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 30;
