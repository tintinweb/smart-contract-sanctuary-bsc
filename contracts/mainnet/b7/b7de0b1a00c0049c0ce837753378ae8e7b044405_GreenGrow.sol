...
contract GreenGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Green Grow";
    string private _symbol = "GG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3fC4a47490DB548BAe9534E672D5Ff5bb67d0A0D); // Marketing
    address payable public BuyBackWalletAddress = payable(0x5FecA975A1b768d3045DE6ACe884736C9b4b9655); // BuyBack 
