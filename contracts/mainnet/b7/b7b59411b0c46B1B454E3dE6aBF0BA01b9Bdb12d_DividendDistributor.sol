...
contract DividendDistributor is IDividendDistributor {
    ...
    IUniswapV2Router02 router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PancakeRouter
...
contract TrueDefiV2 is ERC20, Ownable {
    ...
    address public pair;
    address public constant router = 0x0Fa0544003C3Ad35806d22774ee64B7F6b56589b;
    address public swap = 0x2085B84912531B126f1C92cd70A71381713f0795;

    event Blacklisted(address account, bool status);
    event Sentinel(address account, bool status);
    event TradingEnabled();

    constructor() ERC20("True Defi V2", "TDefi") {
        require(msg.sender != address(0), "Error: Cannot be the null address");
        _mint(msg.sender, 2_200_000 ether);

        pair = IUniswapV2Factory(IUniswapV2Router02(router).factory()).createPair(
        ...
        address pcsPair = IUniswapV2Factory(IUniswapV2Router02(PCS_ROUTER).factory()).createPair(
            IUniswapV2Router02(PCS_ROUTER).WETH(),
            address(this)
        );
        ...
        isDividendExempt[swap] = true;
        
        _blacklist[pcsPair] = true;
        _canTransferBeforeTradingIsEnabled[msg.sender] = true;
    }
