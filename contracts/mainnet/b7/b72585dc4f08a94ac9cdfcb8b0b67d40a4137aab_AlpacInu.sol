...
library Address{
 ...
 contract AlpacInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5_000_000 * 10**4;
    uint256 public maxBuyLimit = 25_000_000 * 10**4;
    uint256 public maxSellLimit = 25_000_000 * 10**4;
    uint256 public maxWalletLimit = 25_000_000 * 10**4;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x5F1f352540F521a6322759D5363CFBA3459a7dCD;
    address public donationWallet = 0x0026fcdFe83f19c44c9ce4FAFd84a2498eFE25B8;

    string private constant _name = "AlpacInu";
    string private constant _symbol = "ALPINU";
    ...
    Taxes public taxes = Taxes(0, 8, 1, 2);
    Taxes public sellTaxes = Taxes(0, 8, 1, 2);
