...
/**
Telegram : https://t.me/fifa2k22bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFd161ED4b9B310113Ac8c474FcEbb1a8300EE8B8; // owner address
...
contract FIFA2K22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA2K22";
    string private _symbol = "FIFA2K22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd161ED4b9B310113Ac8c474FcEbb1a8300EE8B8); // Marketing Address
    address payable public teamWalletAddress = payable(0xFd161ED4b9B310113Ac8c474FcEbb1a8300EE8B8); // Team Address
