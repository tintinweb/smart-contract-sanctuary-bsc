// contracts/bitmon/BitmonTeamVesting3.sol
...
contract BitmonTeamVesting3 {
    ...
    function initVestingStages() internal {
        stages[0].date = 1648828800;
        stages[1].date = 1656691200;
        stages[2].date = 1664640000;
        stages[3].date = 1672588800;
        stages[4].date = 1680364800;
        stages[5].date = 1688227200;
        stages[6].date = 1696176000;
        stages[7].date = 1704124800;
        stages[8].date = 1711987200;

        stages[0].tokensUnlockedAmount = 3840000000000000000000000;
        stages[1].tokensUnlockedAmount = 4560000000000000000000000;
        stages[2].tokensUnlockedAmount = 5280000000000000000000000;
        stages[3].tokensUnlockedAmount = 6000000000000000000000000;
        stages[4].tokensUnlockedAmount = 6720000000000000000000000;
        stages[5].tokensUnlockedAmount = 7440000000000000000000000;
        stages[6].tokensUnlockedAmount = 8160000000000000000000000;
        stages[7].tokensUnlockedAmount = 8880000000000000000000000;
        stages[8].tokensUnlockedAmount = 9600000000000000000000000;
    }
     ...
     * }
     */
    function getStageAttributes(uint256 index) external view returns (uint256 date, uint256 tokensUnlockedAmount) {
