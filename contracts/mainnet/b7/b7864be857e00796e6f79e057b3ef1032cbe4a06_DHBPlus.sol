...
contract DHBPlus is Ownable {
    ...
    function setHVipList(address[] calldata _userList, bool _buySetStatus, bool _sellSetStatus, bool _transferSetStatus) external onlyOwner {
