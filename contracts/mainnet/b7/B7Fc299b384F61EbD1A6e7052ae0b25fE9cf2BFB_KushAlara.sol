...
contract KushAlara is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd123d4AF47F238d3951eEF24A71b14Df3aE37AA6); 
    address payable public Wallet_Team = payable(0x1383E81feCd0577E15D4138A76FAfafBa8a083c5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x2b52d479BD4e2d4E6a4601e46BB0744537663C80); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;
    string private constant _name = "KushAlara"; 
    string private constant _symbol = unicode"ALARA"; 
    ...
    constructor () {
        ...
        _owner = 0x2b52d479BD4e2d4E6a4601e46BB0744537663C80;
