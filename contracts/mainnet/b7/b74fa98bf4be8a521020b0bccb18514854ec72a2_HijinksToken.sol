...
contract HijinksToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hijinks";
    string private _symbol = "Hijinks";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5fC00d0BFc3f0De948bF977DF63128EAe98Fe85A); 
    address payable private teamWalletAddress = payable(0x94142b17C906DA15A1337760F80c44c8EF9778Ec); 
