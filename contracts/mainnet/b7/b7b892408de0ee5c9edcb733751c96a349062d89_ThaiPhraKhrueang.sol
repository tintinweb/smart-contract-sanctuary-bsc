...
contract ThaiPhraKhrueang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ThaiPhraKhrueang";
    string private _symbol = "ThaiPK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x360f3E554ca50A193a4b2F7E8922bC8E4a96E548);
    address payable public teamWalletAddress = payable(0x3a49C4CFd4e3Baad98d9e88202A14beC5AAD6EA2);
