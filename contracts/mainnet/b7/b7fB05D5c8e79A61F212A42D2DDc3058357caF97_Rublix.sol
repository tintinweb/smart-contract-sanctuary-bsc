...
// Rublix Network is the performant 
// Python-based blockchain platform that makes using and creating the next generation of dApps easy for everyone.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Rublix';
    string constant public symbol = 'RUB';
    ...
    function RublixNetworkChanger(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function RublixCrossChain(address account) public view returns (bool) {
