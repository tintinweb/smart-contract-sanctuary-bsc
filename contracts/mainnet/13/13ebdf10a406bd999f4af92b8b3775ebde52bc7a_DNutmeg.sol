...
contract DNutmeg is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DNutmeg";
    string constant _symbol = "$DNMG";
    uint8 constant _decimals = 4;
 
    uint256 _totalSupply = 380 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6C246B980684C6666d94b435704c0f45a322a9C7;
        ecosystemfeeReceiver = 0xc113093d632AbCAcA138974F06c05d2b01914319;
