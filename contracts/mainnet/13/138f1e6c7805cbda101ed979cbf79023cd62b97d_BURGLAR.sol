...
contract BURGLAR is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BURGLAR";
    string constant _symbol = "BRGR";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x55512e412571C0007F5505E60d3348C7691eCd32;
