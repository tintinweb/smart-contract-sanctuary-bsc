...
contract USDT_PizzaTower {
    ...
    function addCoins(address ref, uint256 value) initialized external {
        ...
        uint256 marketing1_ = (value * 2) / 100;
        uint256 marketing2_ = (value * 2) / 100;
        USDT_TOKEN.transferFrom(msg.sender, manager, valueToManager);
        USDT_TOKEN.transferFrom(msg.sender, manager, marketing1_);
        USDT_TOKEN.transferFrom(msg.sender, manager, marketing2_);
        USDT_TOKEN.transferFrom(msg.sender, address(this), value - valueToManager - marketing1_ - marketing2_);
    }
