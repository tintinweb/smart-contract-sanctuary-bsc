...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function addManyWL(address[] memory addresses) public onlyOwner {
    ...
    function isWhiteListOnly() public view returns (bool) {
        ...
        return block.timestamp <= whitelist_ends;
    }
     ...
     */
    constructor (uint256 rate, address payable wallet, IERC20 token, uint256 whiteListEndTime) public {
        ...
        _wallet = wallet;
        _token = token;
        whitelist_ends = whiteListEndTime;
    }
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        require((!isWhiteListOnly() || whitelist[beneficiary]), "You are not on the white list which is required at this time");
    ...
    PostDeliveryCrowdsale
{
    ...
    constructor(
        ...
        public
        CappedCrowdsale(cap)
        Crowdsale(rate, wallet, token, whiteListEndTime)
