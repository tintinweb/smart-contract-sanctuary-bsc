...
contract MrApeZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEDbfDE688f7e45B75cC536A4445D7797b91d87F7); // Marketing Address
    address payable public liquidityAddress = payable(0xFcB033c91cC6b4ce7d05117899ebE46Ea95b9b2C); // Liquidity Address
    ...
    string private _name = "Mr ApeZilla";
    string private _symbol = "MrApeZilla";
    ...
    uint256 private minimumTokensBeforeSwap = 150000000 * 10**9; 
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        uint256 liquidityBnb =  transferredBalance.div(_liquidityFee).mul(liquidityDivisor);
    ...
    function setliquidityAddress(address _newaddress) external onlyOwner() {
        liquidityAddress = payable(_newaddress);
    }
