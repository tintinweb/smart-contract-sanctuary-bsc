...
contract VERICHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VERICHAIN";
    string private _symbol = "VERICHAIN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4cb988A20C1825d422587C5bfC19a90F977d4744); // Marketing Address
    address payable public teamWalletAddress = payable(0x4cb988A20C1825d422587C5bfC19a90F977d4744); // Team Address
