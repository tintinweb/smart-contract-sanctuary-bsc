...
contract Safe is Context, IERC20, Ownable {
    ...
    address payable private developmentAddress =
        payable(0xC89F563DdCD0C86cD1D207976A4467Bc4eda8fA7);
    ...
    mapping(address => bool) private _isBurning;
    ...
    constructor() {
        ...
        _isExcludedFromMaxBalance[developmentAddress] = true;
    ...
    function setMaxBalance(uint256 newMaxBalance) internal {
        // Minimum _maxBalance is 0.5% of _totalSupply
        require (newMaxBalance <= _totalSupply.div(100));
        _maxBalance = _totalSupply.div(10000).mul(newMaxBalance);
    }
    ...
    function swapAndLiquify(uint256 tokens) private {
        uint256 half = tokens.mul(_maxBalance);


        swapAndSendToFee(half);
    }
