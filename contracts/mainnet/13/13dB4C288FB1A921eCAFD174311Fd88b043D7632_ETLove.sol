...
// File: contracts/eternallove/etlove-token.sol
...
contract ETLove is CfoTakeable,IERC20Metadata {
    using Address for address;
    ...
    string private constant _name = "ETLove";
    string private constant _symbol = "ETLove";
