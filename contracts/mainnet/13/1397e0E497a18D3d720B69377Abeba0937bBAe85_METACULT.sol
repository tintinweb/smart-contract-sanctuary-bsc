...
/**
🌌WELCOME TO METACULT || BSC💥

Missed Cult Dao on ERC? 
Well, don't miss out on #MetaCultBSC, the first token with the goal of literally, landing on the moon. 🚀
$MCult will make an explosive entry into the BSC market and become the next Hype Train! This is your chance to remake the history of metaverse token ecosystem with $MCult.
...
DO NOT MISS OUT ON THIS RIDE TO THE MOON!💎🌝🔥
**/
...
contract METACULT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METACULT";
    string private _symbol = "$MCult";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55a857A910B38F167db7C2B2aD5773DB01339A36);
    address payable public teamWalletAddress = payable(0x55a857A910B38F167db7C2B2aD5773DB01339A36);
