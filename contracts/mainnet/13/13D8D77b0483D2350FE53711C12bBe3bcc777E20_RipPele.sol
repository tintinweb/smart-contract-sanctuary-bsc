...
//TG https://t.me/rippelebsc
//community driven token from pele fans 3/3 tax
...
contract RipPele is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "rip Pele";
    string constant _symbol = "PELE";
