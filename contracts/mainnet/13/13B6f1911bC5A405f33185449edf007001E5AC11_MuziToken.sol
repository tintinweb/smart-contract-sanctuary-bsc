...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router,address _RewardTokenSET) {
        ...
        RewardTokenSET = address(_RewardTokenSET);
...
contract MuziToken is IBEP20 , Auth, BaseToken {
    
    using SafeMath for uint256;

    string public _name = "AK47 NH";
    string public _symbol = "AK47 NH";
    ...
    address public marketingWallet =0x1006E39EA4D5B493d7649473EFa03D311af5ccdc ;
