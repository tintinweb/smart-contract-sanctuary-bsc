...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ebf83025c8a3f7C9567040cB6c8cCD8526f4e7c;
...
contract BabyHippo is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5ebf83025c8a3f7C9567040cB6c8cCD8526f4e7c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Hippo Inu";
    string private _symbol = "BABYHIPPINU";
