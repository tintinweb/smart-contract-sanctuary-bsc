...
contract STAKE is Owner {
	...
	address public parent_addr =0xB5c580DdB4fb3efC624bC2935126798D8442B8B1;
	...
	function set_grade(uint256 value) public lock returns(bool) {
		 
		require(is_admin[msg.sender]==true, 'NO ADMIN');
		
		grade_lists[msg.sender]=value;
	
	}
	function buy_nft(uint256 value) public payable lock returns(bool) {
		...
		IERC20(nft_addr).transfer(msg.sender, value);
	...
	function buy_nft_1(uint256 value) public payable lock returns(bool) {
	...
	function buy_nft_2(uint256 value) public payable lock returns(bool) {
	...
	function buy_nft_3(uint256 value) public payable lock returns(bool) {
	...
	function get_fee(address addr,uint256 val) public lock returns(bool) {
