...
//LOW TAX 5/5 , LP LOCKED AND RENOUNCED SAFE PLAY
...
contract  BBONKS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Black Bonk Society"; // 
    string private constant _symbol = unicode"BBONKS"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2299f13d01260C22aa125c09a50B52A139028429;
