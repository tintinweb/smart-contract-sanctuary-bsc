...
contract QUEENHACHIKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUEENHACHIKO";
    string private _symbol = "QHACHIKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B48B0ed7dDA3c2AAf549840ec17eec780796991); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x4B48B0ed7dDA3c2AAf549840ec17eec780796991); // buyback Address
