...
// TG: https://t.me/grabchain

// Website : https://grabchain.online/
...
contract grabchain is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Grab chain";
   string constant _symbol = "G-chain";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x373304CC5a8157ADd0F3F120421b50ac5A1001bC).call{value: BNBMarketingamount, gas: 30000}("");
