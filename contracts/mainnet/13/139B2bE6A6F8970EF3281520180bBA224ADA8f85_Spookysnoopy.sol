...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCedf6D567287fd0e468de19F018F4b47BCcFf6BB; // owner address
...
contract Spookysnoopy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Snoopy";
    string private _symbol = "Spooky";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCedf6D567287fd0e468de19F018F4b47BCcFf6BB); // Marketing Address
    address payable public teamWalletAddress = payable(0xCedf6D567287fd0e468de19F018F4b47BCcFf6BB); // Team Address
