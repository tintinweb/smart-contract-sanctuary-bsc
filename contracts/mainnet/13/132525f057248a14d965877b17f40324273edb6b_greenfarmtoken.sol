...
contract greenfarmtoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1C914188c53B69E6b5791beeB72a014D50a1A3C2); // Marketing Address
    ...
    string private _name = "greenfarm token";
    ...
    uint256 private minimumTokensBeforeSwap = 31245780 * 10**6 * 10**9; 
