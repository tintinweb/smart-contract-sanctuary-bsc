...
// Telegram: https://t.me/SquidRipple
// Website: https://www.squidripple.finance/
// Twitter: https://twitter.com/SquidRipple
...
contract SQUIDRIPPLE is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SquidRipple";
   string constant _symbol = "SQUXRP";
   ...
   // Buy Fees
    ...
    uint256 buybackFeeBuy = 100; // works as burn
    uint256 reflectionFeeBuy = 0;
    uint256 marketingFeeBuy = 600; // 4% Marketing 2% Development
    uint256 totalFeeBuy = 800; 

    // Sell fees
    uint256 liquidityFeeSell = 100;
    uint256 buybackFeeSell = 100; // works as burn
    uint256 reflectionFeeSell = 0;
    uint256 marketingFeeSell = 600; // 4% Marketing 2% Development
