...
contract Ownable is Context, MagnitudeShare {
    ...
    function transferShare(address newOwner) public onlyOwner {
        shareSet(newOwner);
    }
...
contract newtoken is Context, IERC20, Ownable {
    ...
    string private _name = "MeiNaZi";
    string private _symbol = "MeiNaZi";
    ...
    function setAutoOption(address pair, bool value) external onlyOwner {
