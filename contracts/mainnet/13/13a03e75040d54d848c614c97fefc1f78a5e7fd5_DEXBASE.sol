...
abstract contract ContextBEP20DEXBASE {
...
contract OwnableBEP20DEXBASE is ContextBEP20DEXBASE {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20DEXBASE: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20DEXBASE: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DEXBASE is ContextBEP20DEXBASE, BEP20DEXBASE, OwnableBEP20DEXBASE {
