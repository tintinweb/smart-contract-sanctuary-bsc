...
contract AsuraCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Asura Coin";
    string private _symbol = "$ACOIN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x1a397b487F90ABFB4A4126EF39246a49de79eEce); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xaA356cDa8462acadD9E4364cf3F12ABD11b669Ab); // Team Address
