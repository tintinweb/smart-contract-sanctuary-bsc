...
// https://t.me/apebankofficial
// https://apebank.space/
// https://twitter.com/Apebank
// Taxes : Buy 12% Sell 14%
...
contract ApeBank is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ApeBank";
    string private _symbol = "Apebank";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f3a2078451aB066FD104926f9E5D3D5B963080d); // Marketing Address
    address payable public DevWalletAddress = payable(0x6BA81b5BfAF9435B1669d2e4FF4B36E9961889E0); // Dev Address
