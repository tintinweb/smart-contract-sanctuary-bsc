...
library Address{
 ...
 contract KOIGONEMO is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 4_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 4_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 4_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x1b029948634da7D65363483F4D988604FFC7B44c;
    address public donationWallet = 0x1b029948634da7D65363483F4D988604FFC7B44c;

    string private constant _name = "Koigonemo";
    string private constant _symbol = "KOIGONEMO";
    ...
    Taxes public taxes = Taxes(1, 5, 1, 5);
    Taxes public sellTaxes = Taxes(1, 5, 1, 5);
