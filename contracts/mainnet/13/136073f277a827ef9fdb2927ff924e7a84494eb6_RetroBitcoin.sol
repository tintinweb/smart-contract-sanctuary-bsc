...
Telegram : https://t.me/RetroBitcoin
...
contract RetroBitcoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RetroBitcoinDividendTracker public dividendTracker;
    ...
    constructor() ERC20("RetroBitcoin", "RetroBitcoin") {
        marketingWallet = payable(0x38b70e9E755f984be9e3D38036bAed0f3f923882);
        devWallet = payable(0x1bBEc15025381518DbEb7885495683409089f324);
        ...
        dividendTracker = new RetroBitcoinDividendTracker(
            payable(this),
            router,
        ...
        _isExcludedFromFees[address(devWallet)] = false;
...
contract RetroBitcoinDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    address public defaultToken; // BTCB
    ...
    RetroBitcoin public RetroBitcoinContract;
    ...
    constructor(
        ...
        defaultToken = token;
        RetroBitcoinContract = RetroBitcoin(mainContract);
    ...
    function _transfer(
        ...
        require(false, "RetroBitcoin_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "RetroBitcoin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RetroBitcoin contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(RetroBitcoinContract);

            uint256 prevBalance = RetroBitcoinContract.balanceOf(address(this));
            ...
            {
                uint256 received = RetroBitcoinContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RetroBitcoinContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
