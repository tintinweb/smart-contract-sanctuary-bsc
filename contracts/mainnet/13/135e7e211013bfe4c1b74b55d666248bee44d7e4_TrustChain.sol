...
Trust Chain
Tax 6/6
Telegram : https://t.me/Trustchainofficial
*/
...
contract TrustChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trustchain";
    string private constant _symbol = "Tchain";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100_000_000* 10**_decimals;

    uint256 public _maxWalletAmount = 3_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 3_000_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 350_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver = address(0x4E13C69198A9CB0e9380c5715455d6B915399A62);
    address public marketingWallet = address(0x9Bd589F39b6472D86f4bEB4f12d2f28D22Ba411d);
    address public bbWallet = address(0x9Bd589F39b6472D86f4bEB4f12d2f28D22Ba411d);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 120 && !prePhase) {
            buyFee.liquidity = 3;
            buyFee.marketing = 3;
            buyFee.bb = 0;
        ...
        if(launched && block.timestamp > launchEpoch + 122 && !phaseOne) {
