...
/**
 MetaShina Stealth Launch🐉

MetaShina - is your next BSC moonshot and a rare BSC gem. MetaShina is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. 
Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.

Do y'all know Pit Jupiter that reached millions?

We are the team behind it, and this new project named Dragon Satoshi could go millions too! Mark Our Words

Safeeth 2.0 have beautiful chart and PitJupiter break 1 Million Market Cap


📲Telegram: https://t.me/MetaShina
🌐Website: http://MetaShina.com  (not live yet)
...
pragma solidity ^0.6.12;
    ...
    contract MetaShina is Context, IERC20, Ownable {
        ...
        string private _name = 'MetaShina';
        string private _symbol = 'MetaShina';
