...
contract CATCAP is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD92dacda8634928b1A7620c8Ea7ec5D8f27D3e26); 
    address payable public Wallet_Dev = payable(0xD92dacda8634928b1A7620c8Ea7ec5D8f27D3e26);
    ...
    string private constant _symbol = unicode"CATCAP";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(block.timestamp <= launchedAt.add(1 minutes)){
            _dSellFee = 30; _dBuyFee = 15;
        } else if(block.timestamp > launchedAt.add(1 minutes) && block.timestamp <= launchedAt.add(3 minutes)){
            _dSellFee = 15; _dBuyFee = 10;
        } else if(block.timestamp > launchedAt.add(5 minutes) && block.timestamp <= launchedAt.add(5 minutes)){
            _dSellFee = 15; _dBuyFee = 8;
        } else if(block.timestamp > launchedAt.add(10 minutes) && block.timestamp <= launchedAt.add(10 minutes)){
            _dSellFee = 10; _dBuyFee = 6;
        }  else { _dSellFee = _Tax_On_Sell; _dBuyFee = _Tax_On_Buy;
        }
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_dBuyFee/100;
            ...
            uint256 sellFEE = tAmount*_dSellFee/100;
