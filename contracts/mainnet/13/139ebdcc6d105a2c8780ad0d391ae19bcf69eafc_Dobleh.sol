...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16C87582e57F40A1b71fb6C6A0a7b00b8e4933e3;
...
contract Dobleh is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x083B0fA7A5d3E7d86d3f6e2930c2aDF3001BcAed;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GembelElite";
    string private _symbol = "GLITE";
