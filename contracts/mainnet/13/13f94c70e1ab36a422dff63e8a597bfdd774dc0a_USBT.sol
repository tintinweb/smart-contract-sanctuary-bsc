...
contract USBT is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "USBitland";
    string private constant _symbol = "USBT";
    uint8 private constant _decimals = 9;
    uint private _totalSupply = 21398562 * 10 ** _decimals;
