...
/**
 Kangroo #KROO is community token with the aim of giving its users financial freedom,
 themain questionis whatis the need of clapping hands for crypto while others die hard
 with nothing in their wallet and only few people enjoy the fruits? now join the world 
 number one community Platform #KROO which give opportunity to its believer to earn from
 huge profitable mining pool and staking pool, #KROO is 100% community power, we love Kangaroo

 start mining now via:  https://mine.kangaroocommunity.com/
 Visit Our main website: https://kangaroocommunity.com/
 Please lets support and show love to #KANGAROO 
*/
...
contract Kangaroo is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress = 0x10c216F96A91F12DBeaBC618aD889F1Fe447E877;     // TODO - team wallet here
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private  _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kangaroo";
    string private _symbol = "KROO" ;
