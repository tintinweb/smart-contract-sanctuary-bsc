...
contract  VeneraMarketStore is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "VeneraMarketStore", "VeneraStoreMultiple");
        __Ownable_init();
        _tid = 1;
        serviceValue = 2500000000000000000;
        sellervalue = 2500000000000000000;
        deci = 18;
        mintFee = 1500000000000000;
    }
    ...
    function mint(uint256 value, uint256 royal, uint256 nooftoken, string memory ipfsmetadata) public payable{
    ...
    function editMintFee(uint256 _price) public onlyOwner{
        mintFee = _price;
    }
}