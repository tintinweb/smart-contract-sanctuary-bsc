...
contract MoonPetwars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonPetwars";
    string private _symbol = "$MPW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0141fa068318878ba32FCBA841436CcFd166dFFE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0141fa068318878ba32FCBA841436CcFd166dFFE); // BuyBack Address
