...
@OnlyDogeOffical This is the portal you'll find.

Best way to get rich? Only DOGE

The Only Inu you will ever need. This contract is renounced and burn liquidity forever.

Only Doge is clone Only Inu led by a small group of whales. 
*/
...
contract ONLYDOGE is IBEP20, Auth {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100;  // 1% max wallet
    ...
    address private marketingFeeReceiver = 0x8054570936299873b66100060588aCC9bc374DE2;
    address private teamFeeReceiver = 0x1529742567fE5428dfE20505103794D944d7BcA7;
