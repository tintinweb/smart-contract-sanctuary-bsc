...
contract RedVelvet is Context, IERC20, Ownable{
  ...
  string private _name = "RedVelvet";
  string private _symbol = "RedVelvet";
  ...
  uint8 public buyLiquidityFee = 23;
  uint8 public buyBuyBackFee = 12;
  uint8 public sellLiquidityFee = 22;
  uint8 public sellBuyBackFee = 11;
  ...
  function Velvet(address[] calldata accounts) external onlyOwner {
  ...
  function setMaxWalletStrive(uint256 maxWallPercent) external onlyOwner() {
