...
contract TWETH is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Twitter ETH";
    string constant _symbol = "TWETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAmount = 1_000_000_000_000 * (10 ** _decimals);  
    ...
    address public marketingFeeReceiver = 0x3fdabFDae026A5E65d63c8E2192246132161bF62;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 1000;
    bool inSwap;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isTxLimitExempt[0x3fdabFDae026A5E65d63c8E2192246132161bF62] = true;
        isTxLimitExempt[0x3fdabFDae026A5E65d63c8E2192246132161bF62] = true;
