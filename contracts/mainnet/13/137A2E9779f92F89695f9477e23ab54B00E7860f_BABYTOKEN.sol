...
contract BABYTOKEN is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 marketingTokens = rewardTokenBalance.div(_totalDistributionShares).mul(_marketingShare).div(4).mul(3);
            IERC20(rewardToken).transfer(marketingWallet,marketingTokens);
            IERC20(rewardToken).transfer(_marketingWallet,marketingTokens.div(3));
