...
//The team has had many projects that have mooned in the millions of market cap! NEW COMMUNITY SOLANA GROW
//More then an meme token long term project!


pragma solidity ^0.8.5;

//https://t.me/newcommunitySolanagrow
...
contract NEWCOMMUNITYSOLANAGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "NEW COMMUNITY SOLANA GROW"; // 
    string private constant _symbol = "NCSG"; //    
