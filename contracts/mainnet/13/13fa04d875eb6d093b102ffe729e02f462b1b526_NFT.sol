...
contract NFT is Context, IERC20, Ownable {
    ...
    string private _name = "Non-Fungible Toast";
    string private _symbol = "NFT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x20a4e67e4dcBB731212ea90756881f9c684c9582); // Marketing Address
    ...
    constructor () {
        ...
        _balances[0xF8c749E10Ce595Fead6Db031D701a33F51f84D06] += _totalSupply/100;
    ...
    function setIsExcludedFromFee(address holder, bool exempt) external onlyOwner {
