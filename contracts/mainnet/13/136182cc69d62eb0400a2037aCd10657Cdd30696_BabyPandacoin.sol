...
-Baby Pandacoin a meme token created for community. Get a chance to get a x100 or x1000 profit. Community must give effort in shilling this token in able to get higher profit.
TOKENOMICS:
...
Join their TG 📲 https://t.me/BabyPandacoiin
...
contract BabyPandacoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pandacoin"; 
    string private _symbol = "BPanda";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbfB86a80a94a8eCB459179643b1Af7b56E979061);
    address payable public teamWalletAddress = payable(0xbfB86a80a94a8eCB459179643b1Af7b56E979061);
