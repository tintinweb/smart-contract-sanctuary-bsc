...
/*
Pinterest Inu | The Following Token Project Utility On Binance Smart Chain Network (BEP20)

We Are Building Several Projects In The Near Future. Like Swap and Also Utility Bridge.
...
🌐 Website : At $10K Mcap
🌐 Telegram : https://t.me/pinterest_inu
*/
...
contract PinterestInu is Context, IERC20 { 
    ...
    address payable public Wallet_Team = payable(0x3fAd45Aff5725E6CdEA1BdaE0ed5A01F2854f0de);
    ...
    string private constant _name = "Pinterest Inu"; 
    string private constant _symbol = unicode"🅿️i Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x3fAd45Aff5725E6CdEA1BdaE0ed5A01F2854f0de;
