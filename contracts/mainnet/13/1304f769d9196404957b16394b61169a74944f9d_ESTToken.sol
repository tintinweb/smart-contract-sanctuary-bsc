...
contract ESTToken is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Earn Satoshi Token";
    ...
    address public pair;
    address public autoLiquidityReceiver = 0x7557CDc373788Ee56274D9131b46b427c104Eee1; // MultiSig address to receive LP tokens from liquidity add from fee
    address public marketingFeeReceiver = 0x65d1B693756d98f9a056041F8c91F597Dec18b48; // address to receive marketing fee
