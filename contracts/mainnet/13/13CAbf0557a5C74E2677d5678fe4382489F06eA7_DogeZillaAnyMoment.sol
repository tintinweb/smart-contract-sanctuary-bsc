...
contract DogeZillaAnyMoment is Context, IERC20 {
    ...
    mapping (address => bool) public Bucks;
    ...
    string private _name = "DogeZillaAnyMoment";
    string private _symbol = "DZAnyMoment";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x6dD0C4D4AD163845e8F5395b6364098DF908ae4E);
    ...
    function InBucks() public onlyOwner {
