...
-----------------------------------------------------------
ONLY HALLOWEEN  Launched ON BSC ! 
💲USDC  Reward
REWARDS ADDRESS - 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d
------------------------------------------------------------
Telegram: https://t.me/OnlyHalloweenBSC
------------------------------------------------------------
*/
...
contract OnlyHalloween is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OnlyHalloween";
    string constant _symbol = "ONLYHALLOW";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x92cc922bf471C6361354a47696CEF31F8B94317c;
