...
/*
* TELEGRAM:https://t.me/MetaFlokiAvatars_BSC
*/
...
contract MetaFlokiAvatars is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "MetaFlokiAvatars";
    string private  _symbol = "AVATARS";
