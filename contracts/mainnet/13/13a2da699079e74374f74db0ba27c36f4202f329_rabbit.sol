...
contract rabbit is ERC20 {
	...
	address public _tczsToken;
    IERC20 public USDT;
    IERC20 public pair;
    bool private swapping;
    uint256 public swapTokensAtAmount;
	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
	address private _fundAddress = address(0xb857F2a364E7f9F683957BCA2f601458b6297525);
	...
	function changeTczsToken(address tczsToken) public onlyOwner {
        _tczsToken = tczsToken;
    }
	...
	function swapAndLiquify() public {
		...
		if(allAmount > 10**17){
			swapTokensForOther(allAmount.div(7).mul(2));
			swapTokensForDead(allAmount.div(7).mul(5));
		}else{
			return;
		}
    }
