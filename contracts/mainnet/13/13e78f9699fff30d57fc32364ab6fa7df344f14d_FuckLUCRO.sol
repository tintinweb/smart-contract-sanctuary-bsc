...
contract FuckLUCRO is BEP20, Auth {
    ...
    string public constant name = "FuckLUCRO";
    string public constant symbol = "$Flucro";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketerFeeReceiver = 0x287694c5B25B8d190B6558087013166Ad8DA947E;
        teamFeeReceiver = 0x287694c5B25B8d190B6558087013166Ad8DA947E;
        devFeeReceiver = 0x287694c5B25B8d190B6558087013166Ad8DA947E;
    ...
    function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier).div(100) <= 350, "Sell tax cannot be more than 24%");
