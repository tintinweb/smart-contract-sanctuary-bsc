...
contract WILD is Context, IERC20, Ownable {
    ...
    string private constant _name = "WILD";
    string private constant _symbol = "WILD";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0C59ebC55714F7b7795ce5F905E5B2F489108379);
    address payable private _marketingAddress = payable(0x0C59ebC55714F7b7795ce5F905E5B2F489108379);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 99, "Redis cannot be more than 15.");
	    require(redisFeeOnSell < 99, "Redis cannot be more than 15.");
	    require(taxFeeOnBuy < 99, "Tax cannot be more than 15.");
	    require(taxFeeOnSell < 99, "Tax cannot be more than 15.");
