...
/**
Telegram: https://t.me/NirvanaInu

Twitter:https://twitter.com/Nirvana_Inu
 */
...
contract NirvanaInu is ERC20, Ownable {
//custom
...
//bool
    ...
    bool public switchBlackListActive = false;
...
//address
    ...
    address public marketingAddress = 0x6891C9969Dc37Ba6Cff8DBb047C0646821b849C9;
    address public charityAddress = 0x8D6059a6Fa53cb484C696B48D108EffDeA00aDcC;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 5;
    uint public sellMarketingFee = 6;
    uint public buyCharityFee = 0;
    ...
    uint public tokensToSwap = 5000000 * 10 ** decimals();
...
// constructor
    constructor() ERC20("Nirvana Inu", "NIRVANAINU") {
