...
contract GoldenYes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldenYes";
    string private _symbol = "GoldenYes";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xD84AC2894592F1F7fA6DD3C42C5B3608E319C4E8); 
    address payable public ttWal = payable(0xD84AC2894592F1F7fA6DD3C42C5B3608E319C4E8); 
