...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x28aE524DfF39B3bEfd4515988Be5CbfA5B5Cc00f;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x28aE524DfF39B3bEfd4515988Be5CbfA5B5Cc00f),//fund address
    
        address(0x28aE524DfF39B3bEfd4515988Be5CbfA5B5Cc00f)//dev address
    ){
