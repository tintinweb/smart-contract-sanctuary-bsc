...
contract CBG is CBGPool {
    ...
    address public _technologyAddr= address(0x69143a6d36bE2410c19313F129c904E4b5138CF8);

    uint public _daoFundRate = 5;
    address public _daoFundAddr= address(0x340522C5375e762cdc29272e1d0e134dD5fF2883);

    uint public _daoRate = 20;
    address public _daoAddr= address(0x378023dE39E777e238dFDD51C4a4FEC0879E90B4);
