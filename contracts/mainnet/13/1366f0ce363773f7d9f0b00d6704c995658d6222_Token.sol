...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Half BNB";
    string internal constant SYMBOL = "Half BNB";
    ...
    uint256 internal constant TOTAL_SUPPLY = 100 * ZEROES;
    ...
    address internal marketingAddress = 0x68f2cb5E8627dbCeA09DE28Bede931199b47eb2c;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 90, marketingAddress );
    }
...
abstract contract TestToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract Token is TestToken {
    ...
    constructor() TestToken(Env.MainnetV2){
