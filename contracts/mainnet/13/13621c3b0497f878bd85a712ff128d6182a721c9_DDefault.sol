...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "CAT BEANS";
    string private _symbol = "CT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa7B7ea904bc73EbF5B061b28999EE733F99C0091); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC304102156a6144F47f76428346F8975685b86AA); // BuyBack Address
