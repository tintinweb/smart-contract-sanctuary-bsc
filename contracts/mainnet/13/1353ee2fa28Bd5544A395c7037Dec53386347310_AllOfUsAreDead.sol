...
/**
        $AllOfUsAreDead a community driven crypto currency,
    get ready with an upcoming play to earn survival game.
    Goal to be number one on the crypto market not only on
    the Netflix itself.

    TELEGRAM: https://AllOfUsAreDeadToken
    WEBISTE: https://allofusaredead.site/
    TWITTER: https://All_of_us_dead
*/
