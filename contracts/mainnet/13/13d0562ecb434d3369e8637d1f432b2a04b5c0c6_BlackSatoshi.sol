...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1fBdF2c46f67d06402F91d3BCaAd924bA774eCFB; // owner address
...
contract BlackSatoshi is Context, IERC20, Ownable {
    ...
    string private _name = "BlackSatoshi";
    string private _symbol = "$BSATOSHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1fBdF2c46f67d06402F91d3BCaAd924bA774eCFB); // Marketing Address
    address payable public teamWalletAddress = payable(0x1fBdF2c46f67d06402F91d3BCaAd924bA774eCFB); // Team Address
