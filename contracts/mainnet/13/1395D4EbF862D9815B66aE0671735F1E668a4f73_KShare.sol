...
contract KShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 KSHARES
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("KSHARE", "KSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 KDOLLAR Share for initial pools deployment
