...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf13C9e032C894AFb5f2C1a16C1F3ACd946C3cb37; //
...
contract BULLS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bullrun Protocol"; // 
    string private constant _symbol = "$BULLS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x22B586fE463711c69eD8E11b22Ee2Eae7b1B1D98); //
