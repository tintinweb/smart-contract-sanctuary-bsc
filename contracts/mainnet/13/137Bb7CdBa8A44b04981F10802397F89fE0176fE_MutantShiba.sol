...
🐶 %3 LP %3 BNB Reflections
😷 CA Renounce & Locked!
*/

//Telegram : https://t.me/MutantShibaBSC
...
contract MutantShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6D3e8b980fb3FD7407EcC71BF1b5f7C59105a7cf); 
    address payable public Wallet_Team = payable(0x6516C565e4Ad8b5cb98E9C9757c1Ded23b34Fe92);
    ...
    string private constant _name = "Mutant Shiba Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x6516C565e4Ad8b5cb98E9C9757c1Ded23b34Fe92;
