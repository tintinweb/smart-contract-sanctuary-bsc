...
// Begin sauce.
contract Apenomics is Context, IERC20, Ownable {
    ...
    string private  _name               = "Apenomics";
    string private  _symbol             = "Apenomics";
    ...
    // marketing
    uint256 public _fee_marketing = 2800;
    uint256 private _fee_marketing_old = _fee_marketing;
    address payable public _wallet_marketing = payable(0xaef3276f59535DbCA89006E8aaF58762F012a69e);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0xF667a4E375C496354B07615780CaC14Ca4983541);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0xCc7446AfA10B9c332202c8fFa78478c389f50805);
