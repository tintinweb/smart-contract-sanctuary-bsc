...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _dividendPoolFee = 0;
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress, address DividendPoolAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (!inSwap && _swapPairList[to]) {
                    ...
                    if (contractTokenBalance > 0) {
                        uint256 swapFee = _lpFee + _dividendPoolFee + _fundFee;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 dividendPoolAmount = usdtBalance * _dividendPoolFee * 2 / swapFee;
        USDT.transferFrom(address(_tokenDistributor), _dividendPoolAddress, dividendPoolAmount);
        IDividendPool(_dividendPoolAddress).addTokenReward(dividendPoolAmount);

        uint256 lpUsdt = usdtBalance - fundAmount - dividendPoolAmount;
    ...
    function setDividendPoolFee(uint256 dividendPoolFee) external onlyOwner {
        _dividendPoolFee = dividendPoolFee;
    }
    ...
    function setDividendPoolAddress(address dividendPoolAddress) external onlyFunder {
        _dividendPoolAddress = dividendPoolAddress;
    }
...
contract BTToken is AbsToken {
    ...
    //总量
        21000,
    //营销钱包
        address(0x9404baa10ef488940B5BcC7b31D3e93b5dF0DdD4),
    //代币接收地址
        address(0x9404baa10ef488940B5BcC7b31D3e93b5dF0DdD4),
    //分红矿池合约地址
        address(0xE632A6EfC2fcEA8ED9968f1c4f9E2Db7Fc3c38ed)
    ){
