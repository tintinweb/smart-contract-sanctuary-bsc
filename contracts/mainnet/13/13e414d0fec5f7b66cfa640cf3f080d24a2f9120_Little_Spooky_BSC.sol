...
contract Little_Spooky_BSC is IBEP20, Auth {
    ...
    string constant _name = "Little Spooky BSC";
    string constant _symbol = "LSBSC";
    ...
    address public marketingFeeReceiver = 0x393c0449f8b6139b0a8B7F55d5E32DAc2bcF67Aa;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 100; // 1.00%
    bool inSwap;
