...
contract CaiShen is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("CaiShen", "CaiShen") {
        ...
        address _initMarketAddress = 0x869fF7e3baD2096A3665FaDd420aD47C2D548F23;
        ...
        address _initHolder = 0x869fF7e3baD2096A3665FaDd420aD47C2D548F23;
        uint256 total = 88888888;
        _mint(_initHolder, total*1 ether);

        fees = Fees(1000, 4000, 0, 10000);
