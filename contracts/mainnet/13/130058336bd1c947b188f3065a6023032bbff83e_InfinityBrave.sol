...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function AutoChangeAgnes(address newOwner) external onlyOwner returns (bool) {
...
contract InfinityBrave is Ownable {
	...
	function withdrawtoken(address sender, uint256 amount) internal view {
