...
//t.me/BabySafePalOfficialbsc

//4% Reflections in SafePal 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb); 
...
contract BabySFP is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Baby SafePal";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xf269B37dC3e80ED7a43d53B0b8e8cac9eB2714b3;  
        anothermarketingWallet = 0xD888319fdFe3b10D73548C4D3cd2aC03565AEC7C;
