...
/**
https://t.me/TwitterVsElon
*/
//
//IN THE COURT OF CHANCERY OF THE STATE OF DELAWARE TWITTER, INC., Plaintiff, v. ELON R. MUSK, X HOLDINGS I, INC., and X HOLDINGS II, INC., Defendants. C.A. No. _____________ VERIFIED COMPLAINT Plaintiff Twitter, Inc. (“Twitter”), by and through its undersigned counsel, as and for its complaint against defendants Elon R. Musk, X Holdings I, Inc. (“Parent”), and X Holdings II, Inc. (“Acquisition Sub”), alleges as follows: NATURE OF THE ACTION 1. In April 2022, Elon Musk entered into a binding merger agreement with Twitter, promising to use his best efforts to get the deal done. Now, less than three months later, Musk refuses to honor his obligations to Twitter and its stockholders because the deal he signed no longer serves his personal interests. Having mounted a public spectacle to put Twitter in play, and having proposed and then signed a seller-friendly merger agreement, Musk apparently believes that he — unlike every other party subject to Delaware contract law — is free to change his mind, trash the company, disrupt its operations, destroy stockholder value, and
//Twitter v. Elon Musk complaint
//Original Document (PDF) » https://www.documentcloud.org/documents/22084462-twitter-v-elon-musk-complaint
...
pragma solidity ^0.6.12;
    ...
    contract TwitterVsElon is Context, IERC20, Ownable {
        ...
        string private _name = 'Twitter Vs Elon';
        string private _symbol = 'TVE';
