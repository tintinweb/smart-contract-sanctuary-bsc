...
contract StratX_PancakeLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant earnedAddress =
        0xDB20F6A8665432CE895D724b417f77EcAC956550; //eshare
    ...
    address public constant unirouterplanet =
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Pancake SWAP
    ...
    address public constant receiveFee =
        address(0x236dD901D609c296b3187b6296c985638472bf2b); //
