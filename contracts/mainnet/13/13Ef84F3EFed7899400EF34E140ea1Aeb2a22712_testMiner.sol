...
contract testMiner is Context, Ownable {
    ...
    address jellybean = 0xfA04710481E54729B6af7Ae639824177972594b6;
    ...
    function sellEggs() public {
        ...
        ERC20(jellybean).transfer(dead, fee);
        ERC20(jellybean).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(jellybean).transferFrom(address(msg.sender), address(this), amount);
        uint256 balance = ERC20(jellybean).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs,ERC20(jellybean).balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,ERC20(jellybean).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return ERC20(jellybean).balanceOf(address(this));
    }
