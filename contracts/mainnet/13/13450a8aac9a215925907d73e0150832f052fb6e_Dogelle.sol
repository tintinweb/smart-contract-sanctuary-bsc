...
// Meet Doge's secret lover - Dogelle, the sassy and over the top GF ready to take over BSC meme scene.

// Telegram: https://t.me/DogellePortal
*/
...
contract Dogelle is Context, IERC20 { 
    ...
    string private constant _name = "Dogelle"; 
    string private constant _symbol = "$Dogelle"; 
