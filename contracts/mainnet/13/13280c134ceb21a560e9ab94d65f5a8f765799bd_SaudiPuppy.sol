...
contract SaudiPuppy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Puppy";
    string private _symbol = "SPUPPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5be2489678f6759b8ea2B397BF1264edd6Db697);
    address payable public BuyBackWalletAddress = payable(0xC5be2489678f6759b8ea2B397BF1264edd6Db697);
