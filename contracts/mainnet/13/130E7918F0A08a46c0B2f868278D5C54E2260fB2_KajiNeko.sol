...
contract KajiNeko is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kaji Neko";
    string private constant _symbol = "kNEKO";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100_000_000_000_000* 10**_decimals;
    uint256 public swapTokenAtAmount = 100_000_000_000 * 10**_decimals;

    address public liquidityReceiver;
    address public marketingWallet = address(0x01FBfeE0F8e8552e65f302657Fed9ff2DDF11958);
    ...
    function takeBuyFees(uint256 amount, address from) private returns (uint256) {
        ...
        balances[address(0x000)] += burnFeeTokens;
