...
contract sickkk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "sickkk";
    string private _symbol = "sickkk";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x89470587a615F8fc71b9b7C64643550Cd528FcF5); 
    address payable private teamWalletAddress = payable(0x71F979AFEF4933EaB6DaBBEEe49D6e6cb4874baB); 
