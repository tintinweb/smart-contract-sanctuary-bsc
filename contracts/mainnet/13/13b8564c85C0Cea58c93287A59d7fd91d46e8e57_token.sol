...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "Vajra kangaroo";
    string private _symbol = "Vakg";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8785f931E55Be67700d5bB053849C0278C014734); // Marketing Address
