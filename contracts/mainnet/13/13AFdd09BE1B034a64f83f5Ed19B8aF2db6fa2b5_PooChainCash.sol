...
contract PooChainCash  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'PooChainCash';
    string private constant _symbol = 'POOPCASH';
    ...
    //PooChain is destined to be the ONLY Meme Token Blockchain!
}