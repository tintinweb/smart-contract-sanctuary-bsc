...
Telegram : https://t.me/CUMATESTAJA
Twitter  : https://twitter.com/CUMATESTAJA
Website  : https://CUMATESTAJA.com

$CUMATESTAJA is a Meme coin on the Binance Smart Chain Network, $CUMATESTAJA is designed to build easy, secure and affordable transactions for decentralized crypto exchanges. It uses rollup technology to group transaction batches to save on gas costs.

$CUMATESTAJA will be developed with the latest strategies, such as the Dex Swap and Bridge and we will also develop the NFT Market in the future.
...
contract CUMATESTAJA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xdde3437dec644c56b99065d543dfe2a271bD3F0B); 
    address payable public Wallet_Dev = payable(0x9DB2cb18107817721652cF1B5e72f952cbd91D95);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 38888888885 * 10**_decimals;
    string private constant _name = "CUMA TEST AJA"; 
    string private constant _symbol = unicode"CUMATESTAJA"; 
    ...
    constructor () {
        ...
        _owner = 0xc369CB542287772F9E5F7de0bc6b2C834C0b0d54;
