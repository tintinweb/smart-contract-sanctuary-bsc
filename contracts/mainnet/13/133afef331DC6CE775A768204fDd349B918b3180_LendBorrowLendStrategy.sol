...
contract LendBorrowLendStrategy is LogicUpgradeable {
    ...
    event DestroyCircle(address token, uint256 amountMultiLogicBalance, uint256 balanceToken);
        ...
        isUsedToken(token)
    {
        ...
        uint256 amountStrategy = IMultiLogicProxy(multiLogicProxy).getTokenBalance(token, _logic);
