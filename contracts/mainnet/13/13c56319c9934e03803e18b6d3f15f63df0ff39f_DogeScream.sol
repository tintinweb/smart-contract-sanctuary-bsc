...
contract DogeScream is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Scream";
    string private _symbol = "DOGES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBb27023832660d03eC5cc54e6D3eA86EEbAA0c04); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBb27023832660d03eC5cc54e6D3eA86EEbAA0c04); // BuyBack Address
    ...
    uint256 public _walletMax = 20000000000000000000 * 10**9;
