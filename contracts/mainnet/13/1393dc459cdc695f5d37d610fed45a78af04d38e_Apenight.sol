...
contract Apenight is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0xaDFbA51890443e4af40E0090515b80cc53EF2dfC;

    string constant _name = "Ape Night";    
    string constant _symbol = "APENIGHT";
