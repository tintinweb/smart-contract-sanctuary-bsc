...
If u missed Shiba!!! Floki!!! Don’t miss MARVIN!!! They all faded Marvin. We are the first Marvin!!! Lets send this!!!

Let’s bring back the good old days with MARVIN!!!
Remember that time when all coins mooned? 
Marvin! Marvin! Marvin!!! 

This is Marvin!!! 
Don't forget the "!!!"

MARVIN!!! is a community-centric BSC project led by some of the most based names in the industry today.  MARVIN!!! aims to bring back the glory days of BSC by reinventing what is old and bringing something new and exciting to the scene.  It is 100% SAFE.

TOKENOMICS:

Total Supply: 1,000,000,000
Max Wallet & TX: 2%
Buy/Sell Tax: 7/9 at launch
Breakdown: (5% marketing & development, 2% liquidity)

Important Links:

TG: https://t.me/MarvinmarvinmarvinPortal
https://t.me/marvinexclamationpointx
...
contract Marvinexclamation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MARVIN ! ! !";
    string private _symbol = "MARVIN ! ! !";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x38A007E656a90bC5a5Cb1b70d8D235081028A3F5); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x48cbDa6230ac38D65CAe03E39f1658A99252e353); // Buyback Wallet Address
    ...
    uint256 public _walletMax = 4000000 * 10**9; // 4%
