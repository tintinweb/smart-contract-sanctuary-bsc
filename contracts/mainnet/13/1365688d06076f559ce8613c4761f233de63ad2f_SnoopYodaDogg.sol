...
/**
* Snoop Yoda Dogg protocol is comming.
* $YodaDogg - community driven token backed by experienced team.
*
* Community - https://t.me/snoopyodadogg
*/
...
contract SnoopYodaDogg is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Snoop Yoda Dogg";
    string private constant _symbol = "YodaDogg";
    ...
    function setTaxFee(uint256 tax) external onlyOwner() {
        require(tax <= 10, "tax must be less than 10");
        _taxFee = tax;
    }
