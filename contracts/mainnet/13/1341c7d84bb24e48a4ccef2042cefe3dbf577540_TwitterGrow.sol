...
contract TwitterGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "TWITTER GROW"; // 
    string private constant _symbol = "$TGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xc722A8dB898F4e235B04065f2C7005fafE68255b;
