...
contract ReindeerStakingBUSD {
    using SafeMath for uint256;
    uint256 constant launch = 1667938330;  
    ...
    constructor() {
            owner = address(0x8D43CF392ceDF863e9416905d466568c633fFAB8);
            dev = address(0x8D43CF392ceDF863e9416905d466568c633fFAB8);
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        BUSD.safeTransfer(dev, stakeFee * 4/10);
    }
    ...
    function withdrawDivs() external returns (uint256 withdrawAmount) {
        ...
        BUSD.safeTransfer(dev, withdrawFee * 4/10);
