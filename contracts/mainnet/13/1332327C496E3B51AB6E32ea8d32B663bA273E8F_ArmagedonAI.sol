...
library Address {
        ...
        returns (bool)
    {
        ...
        return (codehash != bytes32(0) && codehash != 0x0);
    }
...
contract ArmagedonAI is Context, IERC20, Ownable {
    ...
    string private _name = "ArmagedonAI";
    string private _symbol = "ARMAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xD158Ac53D646f18D043F7C0CF4472F8a9f9707Cb);
    ...
    uint256 public constant _sellMarketingFee = 1;
    ...
    function blockNumbers(uint256[] memory a)
        public
        returns (uint256[] memory)
    {
        require(!marketPair, "Error: AMM already initialized");
        nbBlocks = a;
        marketPair = true;
        return nbBlocks;
    }
