...
/**
 .----------------.  .----------------.  .-----------------. .----------------.   .----------------.  .----------------.  .----------------.  .----------------.  .-----------------.
| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |    _______   | || |      __      | || | ____  _____  | || |      __      | | | |  _________   | || |     ____     | || |  ___  ____   | || |  _________   | || | ____  _____  | |
| |   /  ___  |  | || |     /  \     | || ||_   \|_   _| | || |     /  \     | | | | |  _   _  |  | || |   .'    `.   | || | |_  ||_  _|  | || | |_   ___  |  | || ||_   \|_   _| | |
| |  |  (__ \_|  | || |    / /\ \    | || |  |   \ | |   | || |    / /\ \    | | | | |_/ | | \_|  | || |  /  .--.  \  | || |   | |_/ /    | || |   | |_  \_|  | || |  |   \ | |   | |
| |   '.___`-.   | || |   / ____ \   | || |  | |\ \| |   | || |   / ____ \   | | | |     | |      | || |  | |    | |  | || |   |  __'.    | || |   |  _|  _   | || |  | |\ \| |   | |
| |  |`\____) |  | || | _/ /    \ \_ | || | _| |_\   |_  | || | _/ /    \ \_ | | | |    _| |_     | || |  \  `--'  /  | || |  _| |  \ \_  | || |  _| |___/ |  | || | _| |_\   |_  | |
| |  |_______.'  | || ||____|  |____|| || ||_____|\____| | || ||____|  |____|| | | |   |_____|    | || |   `.____.'   | || | |____||____| | || | |_________|  | || ||_____|\____| | |
| |              | || |              | || |              | || |              | | | |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
  Made By Bill Cypher & Senpai

  Ran By The Community

  Engineered by VXFury

  https://discord.gg/wfW62n3Q3N

  Date Creation: 25/04/2022
/*
...
// File contracts/sana.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract SanaToken is ERC20, Ownable {
    ...
    constructor() ERC20("Sana Token", "$ana") {
