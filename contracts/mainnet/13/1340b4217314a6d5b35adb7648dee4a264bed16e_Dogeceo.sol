...
contract Dogeceo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x187dB0B8f14Df4c1f0DcD4a37e32691964232A37); // Marketing Address
    address payable public teamWalletAddress = payable(0xa988E182b0CB9fa476613a335EAa04ea403c1eF8); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x091537138CF95805a29E9C8CFE8ec8520a360624),
            block.timestamp
        );
    }
