...
//
// Stonks is the purposeful misspelling of the word “stocks,” often used as slang to describe the 
// stock market or a particular stock in a humorous way. The term became popular in 2017 when an 
// internet meme was created, and gained momentum in early 2021 when GameStop’s stock surged in 
// price thanks to retail investors and social media platform Reddit.
//
...
contract Stonks20 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public swapThreshold = _totalSupply * 27 / 10000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x208794B03f64961250fA10F72ADB80bD92369540;
        ecosystemfeeReceiver = 0xbdE0Eec9d3975C3FFeAf565Af850b22A1404D30d;
