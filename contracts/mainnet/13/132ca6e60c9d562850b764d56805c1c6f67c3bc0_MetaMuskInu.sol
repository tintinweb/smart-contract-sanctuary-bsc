...
*/
 ...
 /** MetaMusk Inu
    ...
    Based on MetaMask, it will be the next moonshot brought to you by the team of @Trestilo and @zorcall

    Nice name. Elon will get a lot of hype! Nearly 100m followers So today launch! I ape the first dip! 
    ...
    Total Supply: 100,000,000,000
    Max Wallet :    5% (5,000,000,000)
    Max Trn   :     5% (5,000,000,000)
...
contract MetaMuskInu is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0x775Cc3Fff9207CEF9DfBf60b297Df75398484d0d);
    address private liquidityReceiver = address(0x775Cc3Fff9207CEF9DfBf60b297Df75398484d0d);
