...
contract BaseToken is Ownable {
    ...
    string constant public name = "Echochain";

    string constant public symbol = "Echochain";
    ...
    address public projectAddress = 0x1380118669B51E19F137Eb2AD0F0ea80f0A1afb3;
...
contract Echochain is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0x5D7E3Fd1A40587064246CdFF51e08f5E25928788;
