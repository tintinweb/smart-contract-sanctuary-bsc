...
contract huqiguan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hu Qi Guan";
    string private _symbol = "HuQiGuan";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a06aCc893edf6Abab4A1eDd2ce43E7cc0126d5D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x08FbA0Fe0c5A67F445DfB8d6D3dd16c9410Eb249); // buyback Address
    ...
    uint256 public _marketingFee      = 48;
    uint256 public _buyBackFee        = 48;
    uint256 public _extraFeeOnSell    = 0; 
    uint256 public _totalTaxIfBuying  = 0;
    uint256 public _totalTaxIfSelling = 0;

    uint256 private _totalSupply            = 10000000 * 10**8 * 10**9;
    uint256 public _maxTxAmount             = 10000000 * 10**8 * 10**9;
    uint256 public _walletMax               = 10000000 * 10**8 * 10**9;
