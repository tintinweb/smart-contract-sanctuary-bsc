...
contract ETEC is ERC20 {
	...
	address payable _fundAddress = payable(address(0x0DD13A6910Fc3e8371010d15A5724b91862C2026));
    ...
    constructor(address tokenOwner) ERC20("Eternal coin", "ETEC") {
