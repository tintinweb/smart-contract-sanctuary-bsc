...
contract Pucovski is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function getadditionCurrentRate(uint256 iSupply) private pure returns(uint256, uint256) {
