...
/**
/*  
https://t.me/bonkchainbsc
https://twitter.com/BCecosystem
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x894cb6C4B01ad8d35eaA1f47630eb3D94Ac0aE91; 
...
contract Bonkchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonkchain";
    string private _symbol = "BC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb169e4f44540Eb72A7D3CFfAFd94fB028a1ACA49); // 
    address payable public teamWalletAddress = payable(0xb169e4f44540Eb72A7D3CFfAFd94fB028a1ACA49); // 
