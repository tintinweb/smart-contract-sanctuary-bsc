...
contract Aptos is IERC20, Ownable {
    ...
    // 合约拥有者
    address tokenOwner = address(0x766E8e67012bfdFdB7B6E468718781EC8d7fc213);

    // 预留5%地址
    address tokenReserved = address(0x1a4B41fB0030e46a62BAE5535B45AC0EF493EA4e);

    // 10%社区节点
    address tokenNode = address(0x90831F8e0430F63F9cb6E0ef3B0D6245819b59b2);

    // 技术5%锁仓
    address tokenTechnologyLuck = address(0xEF3db7B0828A275Bb91CAa5aca5d5F690ACb5442);

    // 资方5%锁仓
    address tokenOwnerLuck = address(0xc5A6CB995C53b39C63065A787f9295C9A203fA4D);

    // 社区激励10%地址
    address tokenFoundingTeam = address(0x1dD71eEA7a14028C84c9142C18e2853F0f741d51);

    // Defi产出14%地址
    address tokenDefi = address(0x5e20BB50Ebbd0E376E2F23EE7061ad81D2fE519b);

    // 社区空投1%地址
    address tokenDrop = address(0xd95197482397Bb7943F4Da99Db9907Ba0589E679);

    // 私募地址 50%
    address tokenPrivate = address(0xC053520F20c00D8ed810d4d266fd4F9567EeA836);
