...
contract DauInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dau Inu";
    string private _symbol = "DAUI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAaCB338eC0f282064c77CBc0A84d5623ED08c2C7);
    address payable public teamWalletAddress = payable(0xAaCB338eC0f282064c77CBc0A84d5623ED08c2C7);
    address public immutable deadAddress = 0xAaCB338eC0f282064c77CBc0A84d5623ED08c2C7;
