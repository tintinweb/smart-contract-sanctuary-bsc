...
contract WoodsWolf is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe43c57E015214Cf66E0a7D8C95614995087F4a18); // Marketing Address
    ...
    string private _name = "WoodsWolf";
    string private _symbol = "WoodsWolf";
