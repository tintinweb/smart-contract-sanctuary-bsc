...
Telegram : https://t.me/CheemsTrust
Website : www.CheemsTrust.co
...
contract CheemsTrust is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cheems Trust";
    string constant _symbol = "$CTRUST";
