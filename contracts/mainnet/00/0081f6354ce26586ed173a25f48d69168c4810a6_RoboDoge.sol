...
interface IRouter {
    ...
    address public marketingWallet = 0xE7219B6c405039B33740BC9EA8c56198D3B859ba;
    address private ecosystemWallet = 0xDc415829F78eA3560d73Bfbf464F39EaEF85DB61;
    address public developmentWallet = 0xB6f9B5685779200ffb9814AA0628096D9179cC8e;
    ...
    constructor(address routerAdd) ERC20("RoboDoge", "Rdoge") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        taxes = Taxes(_marketing, _development, _liquidity, _ecosystem);
        require((_marketing +_development + _liquidity + _ecosystem) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _development,_liquidity, _ecosystem);
        require((_marketing + _development + _liquidity + _ecosystem) <= 20, "Must keep fees at 20% or less");
    }
