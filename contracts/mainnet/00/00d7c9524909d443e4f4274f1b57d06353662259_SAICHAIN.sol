...
contract SAICHAIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Saitama Chain";
    string constant _symbol = "SAICHAIN";
    ...
    uint256 public busdRewardFee = 5;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x34CD3f7F921EF2393271Ef9E9C5c388484385D7d;
        buybackWallet = 0x34CD3f7F921EF2393271Ef9E9C5c388484385D7d;
        
        totalFee = liquidityFee.add(marketingFee).add(busdRewardFee);
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBReflection = amountBNB.mul(busdRewardFee).div(totalBNBFee);
