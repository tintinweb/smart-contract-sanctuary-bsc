...
/**
 * XRPro Abstract contract. A Team Bomba build. t.me InfinityrCryptoGems
 */
abstract contract Project {
    ...
    string constant _name = "XRPro";
    string constant _symbol = "XRPRO";
...
contract XRPro is Project, IBEP20, Auth {
    using SafeMath for uint256;
