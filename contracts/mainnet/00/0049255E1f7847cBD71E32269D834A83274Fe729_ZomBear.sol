...
contract ZomBear is IERC20Metadata, Ownable {
   ...
   address payable public treasuryWallet = payable(0xb46d0D866F5277b4F3230f6bE9A99C63cf40274a);
   address payable public liqWallet = payable(0x0a9a4DB5a8Db41cb2b1579E4e4649703c622627b);
   address payable public marketingWallet = payable(0xa6bF73C902853A8Ce4fC39F494765c194b7F54e3);
   ...
   uint256 public treasuryTaxB  = 800; //starting sell tax for bot protocol
   uint256 public liqTaxS = 200;
   uint256 public liqTaxB = 200;
   uint256 public marketingTaxS  = 7000;
   ...
   uint256 public marketingSwapAt = 2666000000000;
