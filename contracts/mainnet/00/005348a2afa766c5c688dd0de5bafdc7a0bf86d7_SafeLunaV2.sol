...
https://t.me/SafeLuna2_0

https://twitter.com/SafeLunaV2
...
contract SafeLunaV2 is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Luna 2.0";
    string private _symbol = "SLV2";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x1e9acB310bE06719DF7f1ac4B68026ab5FDB8c36);
