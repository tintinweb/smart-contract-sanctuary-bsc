...
contract cat_pump_zhao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatPump Zhao";
    string private _symbol = "CPZHAO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3EF140e363E9EB46B51bCf17F528E8b9e40bdAE8); // Marketing Address
