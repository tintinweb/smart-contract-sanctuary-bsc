...
contract RATCHEEMS is Context, IBEP20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd678868ff475da5823db5d6E42073F6276C126c3); 
    address payable private Wallet_Dev = payable(0xd678868ff475da5823db5d6E42073F6276C126c3);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "RATCHEEMS"; 
    string private constant _symbol = unicode"RCHEEMS"; 
    ...
    constructor () {
        ...
        _owner = 0xd678868ff475da5823db5d6E42073F6276C126c3;
