...
contract BABYTOKEN is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256[3] memory buyFeeSetting_, // lp,market,dead
        uint256[3] memory sellFeeSetting_ // lp,market,dead
        ...
        require(buyLiquidityFee.add(buyMarketingFee).add(buyDeadFee) <= 25, "Total buy fee is over 25%");
        require(sellLiquidityFee.add(sellMarketingFee).add(sellDeadFee) <= 25, "Total sell fee is over 25%");
    ...
    function setBuyTaxes(uint256 liquidity, uint256 marketingFee, uint256 deadFee) external onlyOwner {
        require(liquidity.add(marketingFee).add(deadFee) <= 25, "Total buy fee is over 25%");
    ...
    function setSelTaxes(uint256 liquidity, uint256 marketingFee, uint256 deadFee) external onlyOwner {
        require(liquidity.add(marketingFee).add(deadFee) <= 25, "Total sel fee is over 25%");
