...
contract RATQUEEN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Marketing_Wallet = payable(0x099B7a0845D98E23C44cF24Ab5C2a84Bed7d1816);
    ...
    */
    ...
    string private _name = "RAT QUEEN"; 
    string private _symbol = "$RTQ";  
