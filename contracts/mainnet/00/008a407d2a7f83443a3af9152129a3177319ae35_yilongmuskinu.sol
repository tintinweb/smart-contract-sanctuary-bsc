...
contract yilongmuskinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yilong Musk Inu";
    string private constant _symbol = "YLMUSK";
