...
contract GDLToken is ERC20, Ownable {
    ...
    address public marketAddress = 0xF6958b6D8874A7F87503cD3D11efdeB017833709;
    address public _shareaddress = 0x881316854B0a2103f2Aa92aFFA4f5f0890Bde354;
    uint public lpFee = 400; 
    uint public marketingFee = 100; 
    uint public commFee = 50;   
    uint8[2] public commFeeList = [30,20];
    ...
    uint256 public tokenBalanceForReward_ = 100000 *(10**18);
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair || from == uniswapV2Pair){
            ...
            super._transfer(from,to,amount.sub(marketAmount).sub(ucomm).sub(lpamount).sub(buysellAir)); 
        }
        else{
            super._transfer(from, to, amount);
        } 
