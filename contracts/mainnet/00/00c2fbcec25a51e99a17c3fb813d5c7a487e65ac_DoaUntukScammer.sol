...
contract DoaUntukScammer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doa untuk Para Scammer perbuatan anda sangat tercela dan bencana akan datang";
    string private _symbol = "DUS-20";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x7e2A9fDd849d70739D6735C7734eDE2a4792034f); 
