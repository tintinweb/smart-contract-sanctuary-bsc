...
contract shiba9 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shiba 9"; // 
    string private constant _symbol = unicode"SHIBA 9"; //    
