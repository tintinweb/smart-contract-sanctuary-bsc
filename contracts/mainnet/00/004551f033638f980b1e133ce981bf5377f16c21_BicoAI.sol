...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d434499D7cD6416f1986aFCf769f63D6B5FA830;
...
contract BicoAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xaF51a2b265d3529C0F6b792522539d7f92dBA1E3;
    uint256 private constant MAX = ~uint256(0);
    uint8 private _decimals = 12;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bico AI";
    string private _symbol = "BICOAI";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**12;
