...
/* Token contract */
contract CattyCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x6605e69858990B343757cb902ca834eb460EDBb6;
    ...
    // Name and symbol
    string constant _name = "CATTY COIN";
    string constant _symbol = "CATTY COIN";
