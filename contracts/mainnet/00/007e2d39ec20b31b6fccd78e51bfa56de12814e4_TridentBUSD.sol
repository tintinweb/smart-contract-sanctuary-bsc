...
contract TridentBUSD  is Ownable, ReentrancyGuard{
    ...
    constructor(address _devWallet, address _investWallet, address _multiSig, address _busdContract) {
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC20(BUSDContract).safeTransfer(investWallet, investFund);
    ...
    function setBUSDContractAddress(address _busdContract) public onlyMultiSig{
