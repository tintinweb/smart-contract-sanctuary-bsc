...
/*
Kommunity - $KOM, A community driven project

What is the secret of the successful project of Shiba, Floki and our previous project 100x Project Switchly (Marketcap $200,000?
The answer is Community  , with the power of community and HODL 100x is pretty to achieve. Kommunity ($KOM) being a community driven project will be a moonshot in a bearish market today 🚀

TG : https://t.me/KommunityBSC
*/
...
contract Kommunity is Context, IERC20 { 
    ...
    string private constant _name = "Kommunity"; 
