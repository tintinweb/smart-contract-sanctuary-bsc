...
contract GoldenLootboxNFT is Ownable, ERC721Min, ReentrancyGuard {
    ...
    uint256 public PRICE = 0.1344 ether; // BNB
    uint256 public PRICE_FOR_THREE = 0.4032 ether; // 3 * PRICE, precomputed for gas
    string private _contractURI;
    string private _tokenBaseURI = "https://defimagic.mypinata.cloud/ipfs/QmVUapNZ1FMKQb81DAEKANnq4ZgLym5ifo1k8G56E5z9Zs";
    ...
    constructor() ERC721Min("JPIC Golden Loot Box", "JPICGL") {}
