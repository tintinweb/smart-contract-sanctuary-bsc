...
/*
 * DRONA
 * Bring Back meme hype token 
 * Simply love and grow by the community!!
█▄─▄▄▀█▄─▄▄▀█─▄▄─█▄─▀█▄─▄██▀▄─██
██─██─██─▄─▄█─██─██─█▄▀─███─▀─██
▀▄▄▄▄▀▀▄▄▀▄▄▀▄▄▄▄▀▄▄▄▀▀▄▄▀▄▄▀▄▄▀
...
contract  Drona is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DRONA";
    string private _symbol = "DRN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47B34e58794f1854bE3722e2eEc59fa41Df48EcB); 
    address payable public teamWalletAddress = payable(0xddB5D614675755284Ff5E6B39f107Cbac600d1e3); 
