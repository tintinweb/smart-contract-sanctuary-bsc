...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("TT", "TT") {
        if (block.chainid == 56) {
            ...
            address _rewardToken = 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A;
            ...
            // tokenB = uniswapV2Router.WETH();
            address _rewardToken = 0x58B3DE4bAeE683eC93b56424d68E4dd4519A1d82;
    ...
    function updateRewardCoin(address newRewardCoin) public onlyOwner {
        ...
        require(
            ...
            "TT: The RewardCoin already has that address"
        );
        RewardCoin = newRewardCoin;
    }
