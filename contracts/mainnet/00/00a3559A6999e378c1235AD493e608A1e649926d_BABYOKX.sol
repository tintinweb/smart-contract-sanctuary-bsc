...
contract BABYOKX is Ownable, IERC20 {
    using SafeMath for uint256;

    string private _name = "Mini BABYOKX";
    string private _symbol = "mBABYOKX";
   ...
   uint256 public _decimals = 3;
    ...
    uint256 public _maxWallet = 1000000000000000 * 10 ** _decimals;
