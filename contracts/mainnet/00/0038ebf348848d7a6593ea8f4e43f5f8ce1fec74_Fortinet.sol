...
contract Fortinet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fortinet"; // 
    string private constant _symbol = unicode"Fortinet"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xd3f5041De805ba022eBcDCA42722a9605c2FF954;
