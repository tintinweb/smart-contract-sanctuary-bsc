...
/**
Telegram https://t.me/Bitcoinbullrun_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF3f171631B2A101186D4eEAaeb61bF469DfC788B; // owner address
...
contract BitcoinBullrun is Context, IERC20, Ownable {
    ...
    string private _name = "Bitcoin Bullrun";
    string private _symbol = "BB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3f171631B2A101186D4eEAaeb61bF469DfC788B); // Marketing Address
    address payable public teamWalletAddress = payable(0xF3f171631B2A101186D4eEAaeb61bF469DfC788B); // Team Address
