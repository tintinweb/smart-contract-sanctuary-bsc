...
contract YiKuaiQi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "YiKuaiQi";
    string private _symbol = "YKQ";
	...
	function getYiKuaiQiDividend(uint256 share, uint256 dividendsPerShare) internal pure returns (uint256) {
