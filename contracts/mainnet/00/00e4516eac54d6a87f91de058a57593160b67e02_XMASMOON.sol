...
contract XMASMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XMASMOON";
    string private _symbol = "XMASMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5533ef166bdfaE2D14E52A57f62434229a112275); // Marketing Address
    address payable public teamWalletAddress = payable(0x5D94FC7aa1959Bfa74725bb24d5f9ACC31a7582F); // Team Address
