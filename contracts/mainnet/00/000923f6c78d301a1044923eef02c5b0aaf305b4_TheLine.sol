...
contract TheLine is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Line";
    string constant _symbol = "TLINE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC7F3A13BE6DD99E141A053548C362317A6D00737;
        devFeeReceiver = 0xAe665600D19956484050BfB233906E599Bb80c78;

        distributor = new DividendDistributor(address(router));

        isFeeExempt[msg.sender] = true;
        isFeeExempt[address(devFeeReceiver)] = true;
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[address(devFeeReceiver)] = true;

        isTimelockExempt[msg.sender] = true;
        isTimelockExempt[address(devFeeReceiver)] = true;
        ...
        isDividendExempt[address(devFeeReceiver)] = false;
    ...
    function approveMax(address spender) external returns (bool) {
        return approve(spender, uint256(int(-1)));
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        if(_allowances[sender][msg.sender] != uint256(int(-1))){
