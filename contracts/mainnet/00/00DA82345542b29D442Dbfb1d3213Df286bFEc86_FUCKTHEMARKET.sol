...
// TG : https://t.me/FUCKTHEMARKETBSC
// At 10K MC i will open up the group with a BuyBot in it.
// At 25K MC i will extend the Liquidity.
// At 50K MC i will open up the Chat Group.
// At 100k MC i will doxx myself.
// At 150K MC i will extend the Liqudity.
// At 200K MC Website goes live.
// At 300K MC The miner goes live.
// At 500K MC Staking goes live. 
// At 1 Million MC the Chain goes live.
// Taxes will be 10/30 at Launch to prevent from killing the chart at launch. I will lower the sell tax every 15 Minutes by 5%.
...
contract FUCKTHEMARKET is IBEP20, Auth {
    ...
    string constant _name = "FUCKTHEMARKET";
    ...
    address public marketingFeeReceiver = 0x0bD0EEBC692A9a157779339094DCb34A27D22d60;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 1 >= block.number){ return feeDenominator.sub(0); }
