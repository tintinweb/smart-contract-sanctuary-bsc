...
/**
Welcome to Baby ORYX
ORYX REWARDS
Telegram: t.me/babyoryx
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x10bb58010CB58e7249099eF2efdFfe342928B639); // () Rewards
...
contract BabyORYX is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x10bb58010CB58e7249099eF2efdFfe342928B639; // () REWARDS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby ORYX";
    string constant _symbol = "bORYX";
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x21D12ea91C5f6FDE403a51533b13A8ccaCb94c1c;
        ...
        marketingFeeReceiver = 0x21D12ea91C5f6FDE403a51533b13A8ccaCb94c1c;
        teamFeeReceiver = 0x21D12ea91C5f6FDE403a51533b13A8ccaCb94c1c;
        giveawayFeeReceiver = 0x21D12ea91C5f6FDE403a51533b13A8ccaCb94c1c;
