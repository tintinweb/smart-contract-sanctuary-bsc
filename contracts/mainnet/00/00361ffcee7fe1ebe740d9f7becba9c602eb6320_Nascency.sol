...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2aa69E8D25C045B659787BC1f03ce47a388DB6E8);
...
contract Nascency is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x106B36ad74e1608f66cCF64cD97dBAf66DEc1720;

    string constant _name = "Mission Nascency";
    string constant _symbol = "BIRTH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 88 * 10**6 * 10**_decimals;
