...
// 
//
// 📱 Telegram:https::https://t.me/+ekqvWYamgkFhOWFl
/*
...
contract RabbitXmas is ERC20 {

    uint tokenTotalSupply = 1000000; // 100 Million Token Supply

    constructor() public ERC20("Rabbit Xmas", "RabbitXmas") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RabbitXmas";
    string private _symbol = "RabbitXmas";
