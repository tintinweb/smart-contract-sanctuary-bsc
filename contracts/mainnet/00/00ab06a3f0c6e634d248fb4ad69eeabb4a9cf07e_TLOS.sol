 ...
 *
 * THE LAST OF SHIBA
 * https://twitter.com/lastofshiba
 * https://thelastofshiba.online
 * https://t.me/+ilfgkJlZhs9jYWM0
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RewardToken = ERC20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //SHIBA
...
contract TLOS is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "THE LAST OF SHIBA";
    string constant _symbol = unicode"TLOS";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xB0534c55D800a1B0FcA7AD2d57eA3a5E9a9508fc;
        marketingWallet = 0x6c96b5e812B2fa8552cfb92dDd4ce996E5FaDa5C;
        devWallet = 0xB0534c55D800a1B0FcA7AD2d57eA3a5E9a9508fc;
