...
contract LUCKY777SLOTS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUCKY 777 SLOTS"; // TODO change
    string private _symbol = "LUCKY777"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0x27983226dCE5f8aED36f06FfE0791884D58ccB5D); // Buyback Address
