...
contract LOLABUNNYINU is Context, IERC20, Ownable {
    ...
    string private _name = "Lola Bunny Inu";
    string private _symbol = "Lola Bunny Inu";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCb01ec3780a5C9356E0B5f87aaE47cE088E6Dd53));
        marketingWalletAddress = payable(address(0xCb01ec3780a5C9356E0B5f87aaE47cE088E6Dd53));
