...
contract TweelonMusk is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4CA5A554b7A265057337943694aBc236db0eFd8F;

    string private constant _name = "TweelonMusk";
    string private constant _symbol = "TweelonMusk";
    ...
    Taxes public taxes = Taxes(0,48,0,0);
