...
contract MEWTWOBSC is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'MEWTWO BSC';
    ...
    uint256 public swapThreshold = ( _tTotal * 300 ) / 100000; // .30% of total supply
