...
// NEXT MOONSHOT
// Forever Green is a hyper-deflationary, community-driven token on the Binance Smart Chain. 
// t.me/forevergreenprtl

// DO NOT SNIPE. ALL BUYS BEFORE CONTRACT PINNED IN THE TELEGRAM GROUP WILL BE BLACKLISTED.
...
contract ForeverGreen is IERC20, Ownable {
    ...
    string _name = "ForeverGreen";
    string _symbol = "FG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 3) / 1000;   // 3%
    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000;     // 3%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xf6eF4C7A459F8483EAd3032715e030c95C762ee9;
        marketingFeeReceiver = 0xf6eF4C7A459F8483EAd3032715e030c95C762ee9;
        devFeeReceiver = 0xf6eF4C7A459F8483EAd3032715e030c95C762ee9;
