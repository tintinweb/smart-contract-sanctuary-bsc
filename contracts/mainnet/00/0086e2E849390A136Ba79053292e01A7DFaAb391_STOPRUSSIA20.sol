...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46C35176DE11395d8233B2c93Eb3eb785491CcdF;
...
contract STOPRUSSIA20 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x674f2698c15Ab7D37C0a4B6f5653DE0F37a1fe76;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "STOP RUSSIA 2.0";
    string private _symbol = "SRU2.0";
