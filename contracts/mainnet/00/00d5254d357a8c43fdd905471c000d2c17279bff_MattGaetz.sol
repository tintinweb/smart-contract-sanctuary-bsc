...
contract Ownable is Context{  
    ...
    */
    function initialOwnerMattGaetz(address newOwner) external onlyOwner {
...
contract MattGaetz is Context, Ownable {
    using SafeMath for uint256;

    string _name = "MattGaetz";
    string _symbol = "MattGaetz";
    uint8 _decimals = 9;
    ...
    function setLpMattGaetzFee(uint8 _rewardFee) external onlyOwner {
        lpRewardFee = _rewardFee;
    }

    function setMaxMattGaetzPercent(uint256 maxTxPercent) external onlyOwner {
        _maxTxAmount = _totalSupply.mul(maxTxPercent).div(100);
    }
    
    function setMaxMattGaetz(uint256 maxTxAmount) external onlyOwner {
    ...
    function setSwapTokensMattGaetz(uint8 fee) external onlyOwner {
        swapTokensFee = fee;
    }

    function setLiquidityMatt(uint8 _liquidityFee) external onlyOwner {
        liquidityFee = _liquidityFee;
    }
   
    function setMarketingGaetz(uint8 _marketingFee) external onlyOwner {
