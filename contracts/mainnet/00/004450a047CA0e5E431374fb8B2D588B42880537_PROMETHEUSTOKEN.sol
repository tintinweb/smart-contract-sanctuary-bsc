...
/*
   ___  ___  ____  __  _______________ ________  ______
  / _ \/ _ \/ __ \/  |/  / __/_  __/ // / __/ / / / __/
 / ___/ , _/ /_/ / /|_/ / _/  / / / _  / _// /_/ /\ \  
/_/  /_/|_|\____/_/  /_/___/ /_/ /_//_/___/\____/___/  
...
contract PROMETHEUSTOKEN is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x3164328aeed9929661f8B101DD7564c1E443E789;
    ...
    constructor() BEP20("PROMETHEUS", "PROMETHEUS", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "PROMETHEUS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "PROMETHEUS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
