...
contract New_Community_Ronin_Inu_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Ronin Inu";
    string private constant _symbol = "cRON";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 3, // Marketing fee in %
            treasury: 90, // Team / Dev fee in %
            lp: 3, // lp rate in %
