...
/* Token contract */
contract BULLRISE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe5782D1EA9DB2c307Df0DDB53aE00e6a846DBC96;
    ...
    // Name and symbol
    string constant _name = "BullRise";
    string constant _symbol = "BULLRISE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1 / 100; // 1% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 100; // 1% or 1M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD1C3492f535faAF9c4b52f9852A9F9dC80F8acE0;
