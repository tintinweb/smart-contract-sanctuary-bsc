...
contract SuperGoldRatToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperGoldRat";
    string private _symbol = "SuperGoldRat";
    uint8 private _decimals = 18;
     address public  deadAddress = 0xaAddAdAcBCA2F89fb931Ec32426ba4F5d2546462;
    address payable public marketingWalletAddress = payable(0xaAddAdAcBCA2F89fb931Ec32426ba4F5d2546462); 
    address payable public marketingAddress2 = payable(0xaAddAdAcBCA2F89fb931Ec32426ba4F5d2546462); 
    ...
    uint256 private minimumTokensBeforeSwap = 2*10**1 * 10**_decimals; 
