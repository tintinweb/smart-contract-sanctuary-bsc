...
contract TEWA_SIDECHAIN is ERC20, Ownable {
    ...
    constructor () ERC20("TEWA SIDECHAIN", "TEWA$") 
    {   
        ...
        treasuryWallet = 0xBf2547770498E66E5c725C0FeC91CA2AC76BE82f;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _treasuryFeeOnBuy) external onlyOwner {
        require(_treasuryFeeOnBuy <= 10, "TreasuryFeeOnBuy should be less than or equal to 10");
    ...
    function updateSellFees(uint256 _treasuryFeeOnSell) external onlyOwner {
        require(_treasuryFeeOnSell <= 10, "TreasuryFeeOnSell should be less than or equal to 10");
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]|| swapping) {
            ...
            _totalFees = treasuryFeeOnBuy;
        } else if (to == uniswapV2Pair) {
            _totalFees = treasuryFeeOnSell;
        } else {
