 ...
 */
contract MarketingAmetaTokenLock {
    using SafeERC20 for IERC20;

    string public name = "Marketing Ameta Token Lock";
    ...
    // total lock 200M token
    uint256 public totalAllocation = uint256(200_000_000 * 10**18);
