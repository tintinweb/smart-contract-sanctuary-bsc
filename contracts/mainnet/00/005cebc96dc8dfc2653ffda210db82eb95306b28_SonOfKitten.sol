...
contract SonOfKitten is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son Of Kitten"; // 
    string private constant _symbol = "$SOK"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet = 0x38Fa3a0153E984ec2e0f8C30A6178053Db19C660;
