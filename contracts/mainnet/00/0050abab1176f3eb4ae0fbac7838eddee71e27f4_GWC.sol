...
contract GWC is Context, IERC20, Ownable {
    ...
    uint256 private _taxFeeOnSell = 96;
    
    uint256 private _redisFee;
    uint256 private _taxFee;
    
    address payable private _developmentAddress = payable(0x3072EB6f6Fa0d5Dd33C44fe73b9E15aEE25bdaB1);
    address payable private _marketingAddress = payable(0x3072EB6f6Fa0d5Dd33C44fe73b9E15aEE25bdaB1);
    
    string private constant _name = "Green Wall of China";
