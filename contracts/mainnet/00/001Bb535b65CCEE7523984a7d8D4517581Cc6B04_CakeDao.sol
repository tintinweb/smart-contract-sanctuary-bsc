...
contract CakeDao {
   ...
   // mapping (address => address) public referrals;
    ...
    uint[] public rate = [120,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10];
  
    IERC20 public Cake  ;
    address markBuy = 0x3AC375704ba6950630fd95E0C09F1cFaEa905143;
    address markSell = 0xFa36bF9d5fFf54384A65FFE23a74FeFdb6e60Dcc;
    


    constructor( address market,address cake_) public
    {
        ceoAddress = market;
        Cake = IERC20(cake_);
    }
