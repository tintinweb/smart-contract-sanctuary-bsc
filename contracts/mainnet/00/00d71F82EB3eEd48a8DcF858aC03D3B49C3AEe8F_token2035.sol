...
contract token2035 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x562B6E2E14735f27acDf7d883861CA80950002ea); 
    ...
    uint256 private _totalSupply = 10 *  10**4 * 10**_decimals;
