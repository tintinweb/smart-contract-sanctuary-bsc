...
contract ShibaFarm
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "SHIBAFARM";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x29604215693C6952F8228e1A310BD75e58C50104));
        _anotherA = payable(address(0x29604215693C6952F8228e1A310BD75e58C50104));
