...
contract GOF is IERC20 {
    ...
    string private tokenName = "GUANGZHU";
    uint8 private decimalUnits = 6;
    string private tokenSymbol = "QGZ";

    //usdt address
    Token token = Token(0x55d398326f99059fF775485246999027B3197955);

    address public dividendAddress = address(0x3bEe15135b3E383F9cfeccf63444cf9615AF4491);
    address public lpDividendAddress = address(0x3bEe15135b3E383F9cfeccf63444cf9615AF4491);
    address public marketingAddress = address(0x3bEe15135b3E383F9cfeccf63444cf9615AF4491);
