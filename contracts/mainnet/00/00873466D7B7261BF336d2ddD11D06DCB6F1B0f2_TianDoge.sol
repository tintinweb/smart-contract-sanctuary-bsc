...
contract TianDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TianDoge";
    string private _symbol = "TianDoge";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb3C6eb09f690233CAc9513779AAcB1311dB988E7); 
    address payable private teamWalletAddress = payable(0xb3C6eb09f690233CAc9513779AAcB1311dB988E7); 
