...
/* mahadao.net launch Pad- BNB Reward Token

website: https://mahadao.net
Listing 1 MHD = 1 USD
...
contract MHD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF34F6CE93B58325d88d2761116E9E95822787513); // Marketing Address
    address payable public charityAddress = payable(0xF34F6CE93B58325d88d2761116E9E95822787513); // Charity/Dev Address
    ...
    string private _name = "Maha Dao";
    string private _symbol = "MHD";
