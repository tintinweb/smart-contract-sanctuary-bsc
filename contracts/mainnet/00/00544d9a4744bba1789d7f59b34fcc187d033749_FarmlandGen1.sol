...
contract FarmlandGen1 is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public bnbCost = 0 * 10**18;
  address public bep20ContractAddress=payable(0xF8D4ccd333F893FC1Ad75B626a2C82B4BC7Ccbdd);
  uint256 public bep20Cost = 1000000000;
