...
contract DOUGRAMSEY is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 80_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "DOUG RAMSEY"; // 
    string private constant _symbol = "NOSE EATER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 11;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xcBD34A59D46adc88A511dcDF21c9b9EFCa890D7A;
