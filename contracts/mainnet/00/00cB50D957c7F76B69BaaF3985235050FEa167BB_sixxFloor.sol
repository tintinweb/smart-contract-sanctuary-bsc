...
contract sixxFloor is ERC721Enumerable, Ownable {
    
    using Strings for uint256;
   
    string public baseURI = "ipfs://QmVz9yPzV3P9YqvMmkfk89EsfTHGDFowBhXa4S51KZqLpN/";
    string public baseExtension = ".json";
    
    uint256 public cost = 1690000000000000000;
    uint256 public maxSupply = 100;
    uint256 public maxMintAmount = 5;
    
    bool public paused = false;

    constructor() ERC721("69thFloor NFT", "STH") {
    }
    ...
    function mint(address _to, uint256 _mintAmount) external payable {
        ...
        require(_mintAmount > 0, "Mint amount needs to be greater than 1!");
        require(_mintAmount <= maxMintAmount, "You cannot mint more than maximum amount!");
