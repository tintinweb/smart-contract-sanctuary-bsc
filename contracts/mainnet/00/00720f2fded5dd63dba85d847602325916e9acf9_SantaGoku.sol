...
/**
SantaGoku SmartContract

https://t.me/SantaGoku
...
contract SantaGoku is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SantaGokuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SantaGoku", "SantaGoku") {
        marketingWallet = payable(0x45339428B700A12600385c120aE0a38A8cDEBD24);
        devWallet = payable(0x74fd37DD8D88edB34072b3b27791F1c06761b705);
        ...
        dividendTracker = new SantaGokuDividendTracker(
            payable(this),
            router,
...
contract SantaGokuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SantaGoku public SantaGokuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SantaGokuContract = SantaGoku(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SantaGoku_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SantaGoku_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SantaGoku contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SantaGokuContract);

            uint256 prevBalance = SantaGokuContract.balanceOf(address(this));
            ...
            {
                uint256 received = SantaGokuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SantaGokuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
