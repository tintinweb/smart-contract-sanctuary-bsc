...
contract TateApe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x10a706389B47134B26cF336f55c7d66B92c06b5d); 
    address payable public Wallet_Dev = payable(0x10a706389B47134B26cF336f55c7d66B92c06b5d);
    ...
    string private constant _name = "Tate Ape"; 
    ...
    constructor () {
        ...
        _owner = 0x10a706389B47134B26cF336f55c7d66B92c06b5d;
