...
contract EzDoge2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Ez Doge 2023 ";
    string private _symbol = " $EZDOGE2023 "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xffa356a4369C18aA1879b3eA21FE6EAF40b0e87a); 
    address payable public teamWalletAddress = payable(0xB703ec03E0411a580461D0a3327df9DB22c41095);
