...
contract PancakeSwapSmartRouter is Ownable, ReentrancyGuard {
    ...
    event SwapMulti(address indexed sender, address srcTokenAddr, address dstTokenAddr, uint256 srcAmount);
    event Swap(address indexed sender, address srcTokenAddr, address dstTokenAddr, uint256 srcAmount);
