...
contract WleomceCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "WleomceCoin";
    string private _symbol = "McoDandls";
    uint8 private _decimals = 18;
    address payable public marketingAddress = payable(0x412b5d38EA6221a248C80cfAC5Bd26d205fD6f51);
