...
Website : https://growupv1.website/

Telegram :  https://t.me/GrowUPV1Token
*/
...
contract GrowUPV1Token is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrowUP V1 Token";
    string private _symbol = "GROWUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x940942C0c5B71131E44223670361Bf65f95af961); 
    address payable public buyBackWalletAddress = payable(0x940942C0c5B71131E44223670361Bf65f95af961); 
