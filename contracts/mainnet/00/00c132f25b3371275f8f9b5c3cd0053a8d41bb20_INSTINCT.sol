...
contract INSTINCT is ERC20, Ownable {
    ...
    // inviterFee
    uint256 public buyInviterFee = 1100;

    uint256 public sellInviterFee = 900;


    address public _marketingWalletAddress = 0x32035d872B39c34C458c6F2f52d94f9cC9257e82;

    address public deadWallet = 0xC3aadD82E25EA4E759394A0D89e4f2D6f63FfA78;
    ...
    function setSelTaxes(uint256 marketingFee,uint256 inviterFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                // inviterFee
                InviterFee = amount.mul(sellInviterFee).div(10000);
                fees = MFee.add(InviterFee);
                // sell inviter
            ...
            if(automatedMarketMakerPairs[from]) {
                ...
                // inviterFee
                InviterFee = amount.mul(buyInviterFee).div(10000);
                fees = MFee.add(InviterFee);
                // buy inviter
            ...
            if(fees > 0){
                super._transfer(from, _marketingWalletAddress, fees.sub(InviterFee));
            }
        }
