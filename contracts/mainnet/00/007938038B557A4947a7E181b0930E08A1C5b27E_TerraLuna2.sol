...
contract TerraLuna2 is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'TERRA LUNA 2 (Wormhole)';
    string private constant _symbol = 'LUNA 2';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 163 * 10**9 * (10 ** _decimals);
