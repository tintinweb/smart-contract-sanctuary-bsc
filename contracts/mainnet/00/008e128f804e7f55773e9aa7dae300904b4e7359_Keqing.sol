 ...
 *  Telegram : https://t.me/KeqingBSC
 *
 *  Welcome to Keqing 
 *  Keqing chooses her own path with her own power and ability, instead of letting the gods determine her fate.
 *  刻晴坚信与人类命运相关的事，应当由人类去做，而且人类一定可以做
 *  
*/         
...
contract Keqing is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Keqing";
    string constant _symbol = "KEQING";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8aF20759E57e6C9B927A37EB052761be54b6A5d0;  //marketingwallet 1
        anothermarketingWallet = 0x8aF20759E57e6C9B927A37EB052761be54b6A5d0; //marketing wallet 2
