...
/*
                    COWGE INU || Stealth Launch 
                     (3:30 p.m - 4:00 p.m UTC)

            CowGe Inu is a combination token from cow and doge. 
    Cowge token has been inspiring by Muutoken and it's a community driven token.

    Telegram Dev Channel    :https://t.me/Jordygems
    Telegram Group          :https://t.me/CowGeInuPortal
    Twitter                 :https://twitter.com/CowGeOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeaC8555557234d0943b8f6f96F0b9A2072173F67;
...
contract CowGeInu is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xeaC8555557234d0943b8f6f96F0b9A2072173F67);
    ...
    string private _name = "CowGe Inu"; 
    string private _symbol = "$CowGe";  
