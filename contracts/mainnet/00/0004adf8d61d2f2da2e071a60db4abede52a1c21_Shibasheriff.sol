...
contract Shibasheriff is ERC20, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Sheriff", "SHSF") {
        ...
        uint256 _buyTreasury = 5;
        
        uint256 _sellDevFee = 0;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellTreasury = 5;
        
        uint256 totalSupply = 1000000 * (10**9); // 1,000,000 * 10^9 (1e9) = 1,000,000,000,000
        ...
        developmentWallet = address(0x60cdCEB49c74FfB0765bc9ff6D35B3e32b34F022); // set as Development wallet
        treasuryWallet = address(0x60cdCEB49c74FfB0765bc9ff6D35B3e32b34F022); // set as treasury wallet
    ...
    //adding multiple addresses to the blacklist - Used to manually block liquidity bots and scammers (use on launch only)
