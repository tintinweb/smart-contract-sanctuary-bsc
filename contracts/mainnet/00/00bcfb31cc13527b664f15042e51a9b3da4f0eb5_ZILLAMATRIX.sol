...
contract ZILLAMATRIX is IBEP20, Auth {
    ...
    string constant _name = "BNBChain";//名字
    string constant _symbol = "BNBChain";//名字
    ...
    uint256 public reflectionFee   = 7;//分红税
    ...
    address public autoLiquidityReceiver =0x09dBa5375EA57A1a1500af4C10c04bc18D175f38 ; //LP要送给谁 下边默认给DEAD地址 意思是组成LP打入黑洞
    address public marketingFeeReceiver = 0x919FD9faA4A38DA4a9e3A37C81c458b0E7a7733D;//营销费给谁 默认初始发币地址
    address public devFeeReceiver = 0x919FD9faA4A38DA4a9e3A37C81c458b0E7a7733D ;//dev费用给谁 默认初始发币地址
