...
contract  DIE  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"DIEINU"; //    
    ...
    address public  _marketingWallet = 0x82dD235602BFC0C877439788ce04C0Ad7e181F5F;
    ...
    function increaseAllowance_die(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function excludeFromFee_die(address account) public onlyOwner {
    ...
    function isExcludedFromFee_die(address account) public view returns(bool) {
