...
/*
SHIBAWEEZ is a meme token following SHIBA 

https://t.me/SHIBAWEEZ
Initial Burn: 50%
Ownership: Renounced
...
✅ Contract Verified
🔐 Lp Locked
✅5% reflection on Shiba inu and dogecoin 
...
contract Ownable is Context {
 ...
 contract  ShibaWeez is Context, BEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10000000 * 10**6 * 10**10;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'ShibaWeez';
    string private _symbol = 'ShibaWeez';
