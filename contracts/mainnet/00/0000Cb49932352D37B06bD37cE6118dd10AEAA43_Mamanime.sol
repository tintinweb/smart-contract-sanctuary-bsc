...
/**
 * @title Mamanime NFT Contract
 */
contract Mamanime is ERC721Base, ERC721Reservable, ERC721Whitelist, ReentrancyGuard {
    ...
    uint256 public priceForWhitelist = 0.1183 ether;
    bool public mintActive = false;
    bool public whitelistDiscounted = true;
    ...
    /**
     * @notice Change price for minting with beeing whitelisted and discounted to `_price` in WEI.
     */
    ...
    /**
     * @notice Set whitelistDiscounted to `_whitelistDiscounted`. Only callable by owner.
     */
    function setWhitelistDiscounted(bool _whitelistDiscounted) external onlyOwner {
        whitelistDiscounted = _whitelistDiscounted;
    }
    ...
    function _mintTo(address _to, uint256 _amount) internal override nonReentrant {
    ...
    function priceFor(address _user) public view returns (uint256) {
        return (whitelistDiscounted && whitelistSpotsOf[_user] > 0) ? priceForWhitelist : price;
    }
}
