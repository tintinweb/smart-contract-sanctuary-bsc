...
library Address{
 ...
 contract PussyDust is Context, IERC20, Ownable { 
    ...
    uint256 private initialsupply = 69_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 100_000 * 10**9;
    uint256 public maxBuyLimit = 690_000 * 10**9;
    uint256 public maxSellLimit = 345_000 * 10**9;
    uint256 public maxWalletLimit = 1_450_000 * 10**9;

    uint256 public genesis_block;
    
    address public marketingWallet = 0xB935d9914843bC30EB8befe876Dcee7D17cB5922;
    address public charity = 0xB935d9914843bC30EB8befe876Dcee7D17cB5922;

    string private constant _name = "Pussy Dust";
    string private constant _symbol = "PussyDust";
