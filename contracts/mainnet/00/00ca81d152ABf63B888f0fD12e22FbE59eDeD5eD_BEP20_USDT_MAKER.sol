...
contract BEP20_USDT_MAKER {
    ...
    function sellEggs() public {
        ...
        uint256 fee10=fee/10;
        claimedEggs[msg.sender]=0;
        lastHatch[msg.sender]=now;
        marketEggs=SafeMath.add(marketEggs,hasEggs);
        ERC20(usdt).transfer(ceoAddress, fee10);
        ERC20(usdt).transfer(ceoAddress2, fee-fee10);
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        uint256 fee5=fee/5;
        ERC20(usdt).transfer(ceoAddress, fee5);
        ERC20(usdt).transfer(ceoAddress2, fee-fee5);
