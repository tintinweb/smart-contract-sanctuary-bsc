...
contract Mario is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x705DD5b7E2a3071bf3EF102Bfe28675AaeE0B5Ff));
        marketingWalletAddress = payable(address(0x705DD5b7E2a3071bf3EF102Bfe28675AaeE0B5Ff));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xcc10a44236dA9dE2a1E386562CA6D6EbEEc627C8), _msgSender(), _totalSupply);
    }
