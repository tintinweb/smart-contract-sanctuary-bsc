...
contract AsunaGirl is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Asuna Girl";
    string private _symbol = "ASUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x688415177EeA8aBe0983Bf27Cf08118c9c9c612b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5433Bcedd283129Da21B63d6Eb89deBFcefba251); // BuyBack Address
