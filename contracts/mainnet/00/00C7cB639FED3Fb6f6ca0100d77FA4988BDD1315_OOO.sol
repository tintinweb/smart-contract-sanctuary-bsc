...
contract OOO is ERC20, Ownable {
    ...
    uint256 public ETHRewardsFee = 150;
    ...
    address public _marketingWalletAddress = 0x32C1881a64B8C6ec8f017409eDA89f8fd6c283Eb;
    ...
    constructor(address receiveAddress) public ERC20("OOO", "OOO") {
        ...
        */
        _mint(address(receiveAddress), 100000000000 * (10**18));
    }
