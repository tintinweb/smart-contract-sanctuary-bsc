...
contract TTOEKN is Context, IERC20, Ownable {
    ...
    constructor (address deployer) 
    {
        ...
        _name   = "Raccoon Network Token";
        _symbol = "RAC";
        _decimals = 18;
        _totalSupply = 574000000000000 * 10**_decimals;
        ...
        marketWallet = payable(0x463AA7edd801e9f59F342705683f10783837f5bD);
        marketWallet2 = payable(0x463AA7edd801e9f59F342705683f10783837f5bD);
