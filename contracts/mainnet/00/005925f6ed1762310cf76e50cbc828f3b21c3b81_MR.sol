...
contract MR is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("MR", "MR")  {
        uniswapV2Router = address(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d);

        uniswapV2Pair = IUniswapV2Factory(IUniswapV2Router02(uniswapV2Router).factory())
        .createPair(address(this), address(0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da));

        _approve(address(this), uniswapV2Router, ~uint256(0));
        IBEP20(address(0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da)).approve(uniswapV2Router, ~uint256(0));
        excludeFromFees(tokenOwner, true);
        excludeFromFees(address(this), true);
        uint256 total = 1888 * 10 ** decimals();
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            if (sender == uniswapV2Pair) {
                require(startTime + 5 * 60 * 60 < block.timestamp);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public {
        address divAddress = 0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da;
    ...
    function swapExactTokensForTokens(uint256 tokenAmount) public {
        ...
        path[0] = address(this);
        path[1] = address(0x04fA9Eb295266d9d4650EDCB879da204887Dc3Da);
