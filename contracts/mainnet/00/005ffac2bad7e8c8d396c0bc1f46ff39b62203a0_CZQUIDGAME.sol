...
/**
        Telegram: https://t.me/CZquidGame
*/ 
...
contract CZQUIDGAME is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZquid Game";
    string private _symbol = "CZQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x164ffBFa0dcd813115641e2E1d7CB7Ed9E2882cf);
    address payable public rewardsWalletAddress = payable(0x49a33C08f136A8741a8A3d057060B4aFd659DF5f); 
