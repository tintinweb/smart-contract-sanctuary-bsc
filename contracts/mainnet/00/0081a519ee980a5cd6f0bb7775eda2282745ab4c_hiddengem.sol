...
contract hiddengem is IBEP20, Auth {
    ...
    uint256 _walletMaxCap = _totalSupply * 10 / 1000; //1%
    ...
    constructor () Auth(msg.sender) {      
        ...
        devWallet = msg.sender; //dev receiver
	...
	function checkTxLimit(address sender, address recipient, uint256 amount) internal view {
		if (sender != owner
            ...
            if (restrictWhales || isTxLimitExempt[recipient]){
    ...
    function setFees(uint256 newLiqFee, uint256 newdevFee) external authorized {
