...
contract cats is IBEP20, Auth {
    ...
    string private constant _name = "cats";
    ...
    uint256 private constant _burntSupply = (_totalSupply * 0) /100;
    ...
    address private marketingFeeReceiver = 0x2A782f5c9bA56b0162AE98652ad0e28836689B54;
    ...
    function AntiDumpMultiplier() private view returns (uint256) {
        ...
        uint256 hour = 0;
        if (time_since_start > 0 * hour) { return (0);}
        else { return (0);}
    }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setBuyFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _feeDenominator) external authorized {
    ...
    function setSellFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _feeDenominator) external authorized {
