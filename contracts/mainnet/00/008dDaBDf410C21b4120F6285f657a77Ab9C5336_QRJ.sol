...
contract QRJ is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1314 * 10**9; // 
    uint256 public _maxWalletAmount = 1314 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"QRJ"; // 
    string private constant _symbol = unicode"QRJ"; //    
    ...
    address public  _marketingWallet = 0xA2341Dbb37110e31309539aba6C16b9d88a8Daa2;
