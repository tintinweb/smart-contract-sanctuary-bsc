...
contract LiquidityGeneratorToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        address owner_ = 0xb2a0C5199Fd10477b8970C5B0C1D214495c90756;
        string memory name_ = "TESTE";
        string memory symbol_ = "TST";
        uint256 totalSupply_ = 1000000 * 10 ** _decimals;
        address router_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address charityAddress_ = 0xb2a0C5199Fd10477b8970C5B0C1D214495c90756;
        uint16 taxFeeBps_ = 500; 
        uint16 liquidityFeeBps_ = 500;
        uint16 charityFeeBps_ = 500;
        uint16 maxTxBps_ = 500;
