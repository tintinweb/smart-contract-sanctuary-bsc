...
contract NFT is ERC721,Access {

    address public miner = 0x526FcD747B7521C80A1700C9c825bDD9DC170980;
    uint256 public latestTokenId;
    uint256 public totalSupply;
    
    uint256 public nftNum = 20;//限量1314张
    using EnumerableSet for EnumerableSet.UintSet;
    mapping(address => EnumerableSet.UintSet) private ownerTokens;

    constructor() ERC721("XKSNFT", "XKSNFT") {
        setPendingOwner(address(0x7C417589caF11810Bb4D6268D255403324cF1E80));
    }

    function mint(address recipient_) external returns(uint256) {
        require(_msgSender() == miner, "get out");
        require(totalSupply <= nftNum, "get out");
    ...
    function setNftNum(uint256 numbers) external onlyOwner {
        nftNum = numbers;
    }
