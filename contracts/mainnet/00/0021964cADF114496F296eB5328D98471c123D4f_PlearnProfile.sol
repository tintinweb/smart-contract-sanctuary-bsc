...
contract PlearnProfile is AccessControl, ERC721Holder {
    ...
    event UserNew(address indexed userAddress, address nftAddress, uint256 tokenId);
    ...
    event UserReactivate(address indexed userAddress, address nftAddress, uint256 tokenId);
    ...
    function createProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        plnToken.safeTransferFrom(_msgSender(), address(this), numberPLNToRegister);
        ...
        users[_msgSender()] = User({userId: newUserId, nftAddress: _nftAddress, tokenId: _tokenId, isActive: true});
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        plnToken.safeTransferFrom(_msgSender(), address(this), numberPLNToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        plnToken.safeTransferFrom(_msgSender(), address(this), numberPLNToReactivate);
