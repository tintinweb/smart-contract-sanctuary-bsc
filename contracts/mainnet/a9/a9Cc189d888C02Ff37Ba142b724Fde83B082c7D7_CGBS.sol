...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x449748B90B1a8fec2B87A7f35C47495eA1799999; // owner address
...
contract CGBS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CGBS";
    string private _symbol = "CGBS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x145e72b478cc3ad68b5A72EAF89a3Bf60c6f21Dd); // Marketing Address
    address payable public teamWalletAddress = payable(0xa26D1b82bA89C4B169868Db4243c63b0FE6c5C10); // Team Address
