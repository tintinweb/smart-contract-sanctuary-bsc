...
library Address{
 ...
 contract MarvinGrow is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = initialsupply * 18 ** _decimals; 
    ...
    address public marketingWallet = 0x29f025DBAA5bBd368403176A40B20fE5f45bB570;
    address public donationWallet = 0x804C30ce9b6E40B128Cf26144F76391Cf2fE3e81;

    string private constant _name = "REDMAGIC";
    string private constant _symbol = "REDMAGIC";
