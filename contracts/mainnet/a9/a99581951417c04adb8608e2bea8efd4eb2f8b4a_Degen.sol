...
contract Degen is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 10000 * 10**_decimals; // 1% of sp
    uint256 public maxTxAmountSell = 10000 * 10**_decimals; // 1% of sp
    uint256 public maxWalletAmount = 20000 * 10**_decimals; // 2% of sp
