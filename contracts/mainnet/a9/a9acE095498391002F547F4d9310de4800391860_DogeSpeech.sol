...
//https://t.me/DogeSpeechBSC
//https://twitter.com/DogeSpeechBSC
...
contract DogeSpeech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeSpeech";
    string private _symbol = "Speech";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb9A248C3fb1f8aB41F5E55Fb1a1A693Be6211b53); // Marketing Address
    address payable private teamWalletAddress = payable(0x4De0006C58dacD131571220c2a0Ac8D974C2D2bD); // Team Address
