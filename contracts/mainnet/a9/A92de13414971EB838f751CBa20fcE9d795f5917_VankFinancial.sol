...
contract VankFinancial is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    VankFinancialDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Vank Financial", "VANK") {
        marketingWallet = payable(0x585aB9De9715e0e502649c1970E94f098FA93517);
        devWallet = payable(0xdAB6b46c748eac1e7aF19054e659a72f6f79ac54);
        ...
        dividendTracker = new VankFinancialDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "VANKFINANCIALTRACKER",
            "VANKTRACKER"
        );
...
contract VankFinancialDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    VankFinancial public VankFinancialContract;
    ...
    constructor(
        ...
        defaultToken = token;
        VankFinancialContract = VankFinancial(mainContract);
    ...
    function _transfer(
        ...
        require(false, "VankFinancial_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "VankFinancial_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main VankFinancial contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(VankFinancialContract);

            uint256 prevBalance = VankFinancialContract.balanceOf(address(this));
            ...
            {
                uint256 received = VankFinancialContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    VankFinancialContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
