...
contract SPACEKANGAROO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x07bCB5B390Bc011Ba655225BD0Cf8F1C59Cc94e7); // Marketing Address
    address payable public teamWalletAddress = payable(0x51D50B56b66610Bec48E2F3F5347006839E52499); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x99f269d69d6DfB2AdB74b7Cd3fBb357EE3663c35),
            block.timestamp
        );
    }
