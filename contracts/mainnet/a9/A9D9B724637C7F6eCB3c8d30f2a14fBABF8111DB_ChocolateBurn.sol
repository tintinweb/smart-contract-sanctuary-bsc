...
contract ChocolateBurn is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chocolate Burn";
    string private constant _symbol = "CHOCOBURN";
