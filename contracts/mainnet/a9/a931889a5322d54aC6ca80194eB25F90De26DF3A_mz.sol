...
contract mz is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1999 * 10**_decimals;
    uint256 public _maxTxAmount = 1999 * 10**_decimals; 
    uint256 public _walletMax = 1999 * 10**_decimals;
    ...
    constructor () {
        ...
        marketingWalletAddress = payable(address(0x757C7033AFD0a4BdFb484D01038578adB6E3CB4f));
