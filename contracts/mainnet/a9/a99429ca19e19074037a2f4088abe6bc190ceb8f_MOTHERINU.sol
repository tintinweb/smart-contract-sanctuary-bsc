...
contract MOTHERINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOTHER INU";
    string private _symbol = "MINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2378C3Ec8A960589dF8aA320545D4C545605E2b2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2378C3Ec8A960589dF8aA320545D4C545605E2b2); // BuyBack Address
