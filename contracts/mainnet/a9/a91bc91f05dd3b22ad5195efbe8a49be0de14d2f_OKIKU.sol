...
contract OKIKU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77d1Fe9a942671ECaB64FA6A851f4A0D71737FF1); 
    address payable public Wallet_Dev = payable(0x77d1Fe9a942671ECaB64FA6A851f4A0D71737FF1);
    ...
    constructor () {
        ...
        _owner = 0x77d1Fe9a942671ECaB64FA6A851f4A0D71737FF1;
