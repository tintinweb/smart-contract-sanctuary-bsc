...
contract BTUD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTUD";
    string private _symbol = "BTUD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10e73Bd8Ed20C8e80426D2cc0CCb593CbaF8912C);
    address payable public teamWalletAddress = payable(0x10e73Bd8Ed20C8e80426D2cc0CCb593CbaF8912C);
    address public immutable deadAddress = 0x10e73Bd8Ed20C8e80426D2cc0CCb593CbaF8912C;
