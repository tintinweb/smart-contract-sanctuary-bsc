...
TG: https://t.me/GnomesInu
Website: https://medium.com/@GnomesInu
...
contract GnomesInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"GNOMES INU";
    string private _symbol = unicode"$GNOMES";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xA4F76F5332382A868BE32C42ff6A49928F62B580);
    address payable private taxWallet2 = payable(0xA4F76F5332382A868BE32C42ff6A49928F62B580);
