...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x549E969F9B46E9da2Ce944E292760B46c935aD43; // owner address
...
contract RabbitBlackPink is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Rabbit Black Pink ";
    string private _symbol = " $RBPK ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x549E969F9B46E9da2Ce944E292760B46c935aD43); // Marketing Address
    address payable public teamWalletAddress = payable(0x549E969F9B46E9da2Ce944E292760B46c935aD43); // Team Address
