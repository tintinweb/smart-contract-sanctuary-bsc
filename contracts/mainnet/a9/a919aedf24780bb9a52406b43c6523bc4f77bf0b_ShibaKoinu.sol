...
contract ShibaKoinu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10**9;   // Total Supply 
    ...
    uint256 private _developmentFee = 1400; // marketing/development/team tax | this gets collected in the marketing wallet
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; // max transaction is total supply by default, can be changed after launch
    uint256 public _maxWallet = 200000000 * 10**9;    // max wallet is 2% by default, can be changed after launch
    ...
    constructor () {
        _rOwned[_msgSender()] = _rTotal;                                                // ETH mainet DegenSwap router 0x4bf3E2287D4CeD7796bFaB364C0401DFcE4a4f7F
        
        degenSwapRouter = IDEGENSwapRouter(0x843b1bAc1b916E5F41a33A63865Fa065a73e81f9); // BSC DegenSwap Router: 0x843b1bAc1b916E5F41a33A63865Fa065a73e81f9
        ...
        IDEGENSwapPair(degenSwapPair).updateTotalFee(1400);
