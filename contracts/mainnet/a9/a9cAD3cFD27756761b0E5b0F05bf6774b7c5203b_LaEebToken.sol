...
contract LaEebToken is ERC20, Ownable {

    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    address payable public  _marketingWalletAddress = payable(0xaC7da03F0bE4459dced76a359309fDBc6771fb7d);//payable(0xaC7da03F0bE4459dced76a359309fDBc6771fb7d); 
    address public rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; //0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
 //   address public rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; 
    ...
    uint256 public amountMarketingFeeTokens = 30000 * (10**18);//30000 * (10**18);
    ...
    uint256 public AmountLPFeeDead = 30000 *(10**18);//30000 *(10**8); 

    uint256 public AmountDeadFee;  
    uint256 public AmountDeadBNB = 4 * (10**18);//(4 * (10 ** 18));  
    ...
    //address public serviceAddr_ = 0xf907515B6CeA51Bd5B3A0d0775cDF0124dCBdbCD;  //测试 rinkeby=0x2B6C73B308D503349e7cD9B6c3528B8131a10805
   // address public serviceAddr_ = 0x9cB11C52ce373220953BcE39Dcd109c7459dDaAD;

    TokenDividendTracker public dividendTracker;
    uint256 public tokenBalanceForReward_ = 3000 *(10**8);  //  3000 *(10*8)  有多少分红币开始分红
    ...
    constructor(
        ...
        // ropsten、rinkeby Rounter02=  0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D   pancakeswap:0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function updateUniswapV2Router(address newAddress) private executeDo {
    ...
    function excludeFromFees(address account, bool excluded) private executeDo {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) private executeDo {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) private executeDo {
        require(pair != uniswapV2Pair, "The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function blacklistAddress(address account, bool value) private executeDo{
    ...
    function updateGasForProcessing(uint256 newValue) private executeDo {
