...
contract Multistake_BTC {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; // BTC
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 0.0002 ether; // 0.0002 BTC
