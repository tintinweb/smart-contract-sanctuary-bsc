...
Don't buy unless you are a shrimp.
...
contract shrimpcake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    shrimpcakeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Shrimp Cake", "Sake") {
        ...
        dividendTracker = new shrimpcakeDividendTracker(
            payable(this),
            router,
...
contract shrimpcakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    address public defaultToken; // Cakemoon 
    ...
    shrimpcake public shrimpcakeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        shrimpcakeContract = shrimpcake(mainContract);
    ...
    function _transfer(
        ...
        require(false, "shrimpcake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "shrimpcake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main babyaptos contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(shrimpcakeContract);

            uint256 prevBalance = shrimpcakeContract.balanceOf(address(this));
            ...
            {
                uint256 received = shrimpcakeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    shrimpcakeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
