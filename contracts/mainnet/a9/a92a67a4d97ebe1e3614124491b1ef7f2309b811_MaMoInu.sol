...
contract MaMoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaMo Inu";
    string private _symbol = "MaMo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08f3799f94AE055535fe8Be0b124299134c03E3d);
    address payable public BuyBackWalletAddress = payable(0x08f3799f94AE055535fe8Be0b124299134c03E3d);
