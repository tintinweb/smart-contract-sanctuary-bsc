...
Jeet Nugget Meta Fart Bunga Bunga

Starting the new trend on YouTube and Reddit!
...
contract JeetNuggetMetaFartBungaBunga  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Jeet Nugget Meta Fart Bunga Bunga';
    string private constant _symbol = 'BungaBunga';
