...
contract RupeSHib is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Rupe SHib";
    string private _symbol = "Rshib";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc200cCDebCf77Bf15Fe6e8e168016bb87a299518);
    address payable public liqWalletAddress = payable(0xc200cCDebCf77Bf15Fe6e8e168016bb87a299518);
