...
contract BaseToken is Ownable {
    ...
    string constant public name = "SHIBDAO2.0";

    string constant public symbol = "SHIBDAO2.0";
    ...
    address public projectAddress = 0xc5e270a1e48CA5f326D3A54A9e2CD1fE02d66998;
...
contract SHIBDAO2 is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0xc5e270a1e48CA5f326D3A54A9e2CD1fE02d66998;
