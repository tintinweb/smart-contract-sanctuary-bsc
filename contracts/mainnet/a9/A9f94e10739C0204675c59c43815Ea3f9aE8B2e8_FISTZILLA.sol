...
contract FISTZILLA is IBEP20, Auth {
    ...
    string constant _name = "FistZilla";
    string constant _symbol = "FistZilla";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 69000000000000000000000 * 10**_decimals;
