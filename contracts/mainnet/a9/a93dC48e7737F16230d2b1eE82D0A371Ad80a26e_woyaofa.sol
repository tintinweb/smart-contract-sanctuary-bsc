...
//            }
    ...
    function processReward(uint256 gas) private {
        ...
        uint256 ba0 = holdToken.balanceOf(address(0)) + holdToken.balanceOf(address(0xdead));
...
contract woyaofa is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        518,//Supply
        address(0x9F742F5Dc12EcA774876D72f580672E328852518),//FundAddress
        address(0xf9605Df70e9C1d1Cb5D8BD708bdEBfa4fe915518)//ReceiveAddress
    ){
