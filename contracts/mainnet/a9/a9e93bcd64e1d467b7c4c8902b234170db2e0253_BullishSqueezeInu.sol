...
contract BullishSqueezeInu is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 1000; // 2% (200 thousand)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000; // 1% (100 thousand)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 1000; // 2% (200 thousand)
