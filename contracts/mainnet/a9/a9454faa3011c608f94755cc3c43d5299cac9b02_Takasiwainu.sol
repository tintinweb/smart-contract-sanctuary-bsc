...
contract Takasiwainu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3118C0670ea77cB5aB62AB0A79242a9B20214ffA);
    address payable public W_Deployer = payable(0x94Be5BDa200415bf76780C19cD339E52E2c8C79C); 
    address payable public Wallet_Dev = payable(0x94Be5BDa200415bf76780C19cD339E52E2c8C79C);
    ...
    string private constant _name = "Takasiwa inu"; 
    string private constant _symbol = unicode"TAKASIWA"; 
    ...
    constructor () {
        ...
        _owner = 0x94Be5BDa200415bf76780C19cD339E52E2c8C79C;
        ...
        uniswapV2Router = _uniswapV2Router;_whiteList[W_Deployer] = false;
