...
contract ElonGoat is Context, IERC20, Ownable {
    ...
    constructor (address service) payable {
        ...
        _symbol = "EGT";
        _decimals = 9;
        _tTotal = 9_000_000_000 * 10 ** _decimals;
        ...
        _devWalletAddress = 0x04642EB445d4EeE06e58127390C39fb99C4d19Ad;
        
        _rOwned[msg.sender] = _rTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // pancakeswap v2 mainnet
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // pancakeswap v2 testnet
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee + _devFee + _liquidityFee <= 20, "Total tax should be below 20%");
        _taxFee = taxFee;
    }

    function setDevFeePercent(uint256 devFee) external onlyOwner() {
        require(_taxFee + devFee + _liquidityFee <= 20, "Total tax should be below 20%");
        _devFee = devFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(_taxFee + _devFee + liquidityFee <= 20, "Total tax should be below 20%");
        _liquidityFee = liquidityFee;
    }
   
    function setMaxTxPercent(uint256 maxTxPercent) public onlyOwner {
        require((_tTotal * maxTxPercent / 1000) > 1, "Max Transaction amt must be above 0.1% of total supply.");
    ...
    function transferOtherToken(address _token, address _to)
        external
        onlyOwner
        returns (bool _sent)
    {
