...
abstract contract Project {
    ...
    string constant PROJECT_NAME = "Winners";
    string constant SYMBOL = "Winners";
 ...
 * MainContract
 */
contract Winners is Project, IBEP20, Ownable {
    using SafeMath for uint256;
...
// ***
     ...
     */
        ...
        if(payableFeesInfo.marketing > 0) {
            (tmpSuccess,) = payable(wallets.marketing).call{value: payableFeesInfo.marketing, gas: 30000}("");
        }
