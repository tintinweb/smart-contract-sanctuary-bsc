...
contract Token {
    ...
    uint256 constant totalSupply = 1000000000 * 10 ** 9;
    string constant name = "Indra Token";
    string constant symbol = "Indra";
    ...
    function balanceOf(address own4) public view returns(uint256) {
        return balances[own4];
    }
