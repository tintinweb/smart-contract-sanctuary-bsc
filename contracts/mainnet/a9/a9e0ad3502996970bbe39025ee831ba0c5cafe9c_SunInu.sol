...
// Sun INU - 
 ...
 Sun Inu | Powering the Next Generation of Emissions with $BTC
 
 by DoxedBoy Dev!

 LP locked for 6 months!

 During times of constannt rugs…
 a bear market…
 and overall sentiment being down… 

 SunInu brings unique features and utilities to the crypto world

// telegram : https://t.me/SunInuBSC
*/
...
contract SunInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUN INU";
    string private constant _symbol = "$RENEW";
    ...
    address private marketingWallet = address(0x8847b326AC7106E88C56f9894cFdafd1007fF51A);
    address private liquidityReceiver = address(0x8847b326AC7106E88C56f9894cFdafd1007fF51A);
