...
contract PrivateTwitter is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Private Twitter";
    string private _symbol = "Private Twitter";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x1aBA86ddC4604BbC46c3696eA9db63AAC71BdE52);
