...
contract DCB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb9055B2188DF721Bcd3C44f00c5F3902D392005c); 
    address payable public developmentAddress = payable(0x7f4052f92B37be87285A527173503F9b9365D9dB); 
    address payable public charityAddress = payable(0x076667aB2014947A2D0E9193d2FD083818eB026f); 
    address payable public vaultRewardAddress = payable(0x851DcBB9640E3Df77A1e7816BDf1b919a3877359); 
    ...
    string private constant _name = "BICITOKEN";
