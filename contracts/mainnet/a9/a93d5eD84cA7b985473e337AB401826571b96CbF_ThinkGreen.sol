...
// https://t.me/thinkgreencommunity
// https://thinkgreen.community/
// https://twitter.com/thinkgreencomm
...
/* Token contract */
contract ThinkGreen is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWRD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Reward Token - No for Think
    ...
    address DEV = 0xB6dD36326CD0fc5448F6D0f211065d98DF9444Ce; // Wallet Developer Think
    ...
    // Name and symbol
    string constant _name = "Think Green";
    string constant _symbol = "THINK";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals);  // 100 Millions Supply

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // No Limits for Think
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // No Limits for Think
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2 Millions
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 2; // Send Back to Liquidity & Charity
    uint256 public buybackFeeBuy = 0; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeBuy = 0; // Reward Holders with BUSD
    uint256 public marketingFeeBuy = 3; // Calls Marketing & Growing Project
    uint256 public devFeeBuy = 0; // Continue Development and Charity
    uint256 public totalFeeBuy = 5; //  Not more that 5% Total Tax

    // Sell fees
    uint256 public liquidityFeeSell = 2; // Send Back to Liquidity & Charity
    uint256 public buybackFeeSell = 0; // Decrease Supply - Increase Price Fomo
    uint256 public reflectionFeeSell = 0; // Reward Holders with BUSD
    uint256 public marketingFeeSell = 2; // Calls Marketing Telegram Future
    uint256 public devFeeSell = 1; // Continue Developers and Charity
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5F0309d23b974b5Db1924C656ABb37f40bb0cf08; // Wallet Marketing Work
