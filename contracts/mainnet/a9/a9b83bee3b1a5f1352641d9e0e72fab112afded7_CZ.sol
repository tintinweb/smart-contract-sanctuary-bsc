...
contract CZ is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1747B844a5A5dEFFA52Aa8b204797337ce752964);
    address payable public teamWalletAddress = payable(0x8A5A90Cf7a7f4Fe5f5cD6486594402441B56479D);
    ...
    uint256 private minimumTokensBeforeSwap = 8 * 10**_decimals; 
