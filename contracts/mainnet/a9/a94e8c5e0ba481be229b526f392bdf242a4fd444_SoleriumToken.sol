...
contract SoleriumToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0x641fe1759bae6206fC563312dB3F0E84F306A507;
    ...
    function updateFees(
        ...
        require(
            liquidityFee.add(burnFee).add(teamFee) <= 1500,
            "You can't set fee more than 15%"
        );
