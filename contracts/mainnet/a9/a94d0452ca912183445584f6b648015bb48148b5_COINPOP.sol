...
contract COINPOP is Context, ERC20, Ownable {
    ...
    constructor (address payable mktgWallet, address payable devWallet, address payable liqWallet) ERC20("COINPOP", "POP") {
