...
/**
   #SharkRaceMini The New Community of Ape Token
    
   I make this #SharkRaceMini to hand it over to the community.
   I suggest a Telegram group name for you to create: SharkRaceMini is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/SharkRaceMini
...
I will lock the pool for 60 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..
   ...
   Can we make #SharkRaceMini 1000000X ?
*/
...
contract SharkRaceMini is Context, IERC20, Ownable {
    ...
    string private constant _name = "SharkRace Mini";
    string private constant _symbol = "SHRKmini";
