...
contract YASUO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6e36F88082cA2f42242D286D454606652921153b); 
    address payable public Wallet_Dev = payable(0x78Ce8e25b55b5e0D4f6A3022C91fb6c9e1a77778);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    string private constant _name = "Yasuo"; 
    string private constant _symbol = unicode"YASUO";
