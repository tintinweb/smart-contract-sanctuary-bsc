...
contract PIGEBANK is Context, IERC20, Ownable {
 
   using SafeMath for uint256;
   using Address for address;
 
   string private _name = "PIGE BANK";
   string private _symbol = "PIGEBANK";
   uint8 private _decimals = 9;
 
   address payable public marketingWalletAddress = payable(0x8370F9542EeA189A60E8c24b45B5d963CDe7b6C2); // Marketing Address
   address payable public DevelopmentWalletAddress = payable(0x8370F9542EeA189A60E8c24b45B5d963CDe7b6C2); // Development Address
