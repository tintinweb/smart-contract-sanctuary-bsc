...
contract DividendDistributor is IDividendDistributor {
 ...
 // PANCAKE SWAP ROUTER ADDRESS MAINNET 
...
contract TLUXURYCATTOKENTEST is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = " TLUXURY CAT TOKEN TESTS";
    string constant _symbol = "TLCTTS";
