...
contract Dexbuilder is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0E7222d18d1E789606F0C1d8Dc121272313f9CCB;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "DexBuilder";
    string constant _symbol = "$SWAP";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd996887ac9183c593502cFFbDCd6B53e3432Cb4D;
