...
Join us on TG : https://t.me/ShibaHasui
*/
...
contract ShibaHasui is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaHasui";
    string private _symbol = unicode"ハスイ犬";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xC2126e62d0dC0be058A535a24b804e73469A121d);
    address payable public developmentWalletAddress = payable(0x617a3729C550615eC8A7B9494DE431efCf7d6B28);
