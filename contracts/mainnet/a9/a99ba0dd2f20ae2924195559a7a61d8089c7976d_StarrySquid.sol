...
contract StarrySquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starry Squid";
    string private _symbol = "StarrySQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d2f56790bD1B4d95543fbc72D5387295A9b6889);
    address payable public BuyBackWalletAddress = payable(0x0d2f56790bD1B4d95543fbc72D5387295A9b6889);
