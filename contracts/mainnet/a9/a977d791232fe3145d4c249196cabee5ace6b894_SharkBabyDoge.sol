...
contract SharkBabyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SharkBabyDoge";
    string private _symbol = "SharkBabyDoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x62D4F642243A84031D4818F64f89bFCb338143c1); // Marketing Address
    address payable private teamWalletAddress = payable(0x62D4F642243A84031D4818F64f89bFCb338143c1); // Team Address
