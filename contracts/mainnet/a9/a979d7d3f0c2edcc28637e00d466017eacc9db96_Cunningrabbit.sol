...
contract Cunningrabbit is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cunning rabbit";
    string private _symbol = "Cunning rabbit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x55CF1415ceA67beFF4B12dda45494fA8e4799B91);
