...
/*
    ...
    🌍Web : https://ChillChat.me
    🔎Telegram : https://t.me/ChillChatBSC
    🕊Twitter : https://www.twitter.com/ChillChatME
    🖼️ Instagram : https://www.instagram.com/chillchatme/
    🎮 Discord : https://discord.gg/Y935wSHQzW

    ⭐️💬🗨ChillChat💬🗨⭐️ChillChat LIVE on the BSC network.
    Recreate yourself, one pixel at a time.
    Chillchat is a pixel art NFT metaverse, a vast collection of virtual worlds, made entirely by its players, 
    where you can jump into adventure with a new identity created by you or another player, pixel by pixel.
    There is no limit to who you can be or what you can create. If you can imagine it, you can be it. Our 
    Pixel Editor, World System, and the Solana blockchain power it all. Create and mint Worlds, Characters, 
    Stories, and take them to life with other players.
...
contract ChillChat is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "ChillChat";
