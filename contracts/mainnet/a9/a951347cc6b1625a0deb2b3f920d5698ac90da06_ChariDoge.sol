...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37CBB5986A8796c28Afa4E26EEEd058B2017739b ; //
...
contract ChariDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chari DOGE"; // 
    string private constant _symbol = "ChariDoge"; //    
