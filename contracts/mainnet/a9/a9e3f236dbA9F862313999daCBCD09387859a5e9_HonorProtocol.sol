...
contract HonorProtocol is ERC20, Ownable {
  ...
  uint public governanceMaxAmount = 1250000 * 10 ** 18; // 1.25m token max governance mint
 ...
 // Voting ON/OFF
  ...
  function setMiningContract(address _miningDao) external onlyOwner {
    if (miningDao == address(0)) {
      ...
      require(Governances[address(this)].totalvotes >= 0, "Not Enough 25% Votes"); // 2500 NFTs out of 10,000
      miningDao = _miningDao;
