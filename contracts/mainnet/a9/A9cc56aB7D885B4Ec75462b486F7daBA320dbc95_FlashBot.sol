...
contract FlashBot is Ownable {
    ...
    function flashArbitrage(address pool0, address pool1) external {
        ...
        // avoid stack too deep error
        {
            ...
            if (baseTokenOutAmount > debtAmount){
                ...
                emit FlashArbitrage(orderedReserves.a1, orderedReserves.a2, borrowAmount);
            }
        }
    ...
    function getProfit(address pool0, address pool1) external view returns (uint256 profit, address baseToken, uint256 a1, uint256 b1, uint256 a2, uint256 b2, uint256 borrow, uint256 debt) {
        ...
        a1 = orderedReserves.a1;
        b1 = orderedReserves.b1;
        a2 = orderedReserves.a2;
        b2 = orderedReserves.b2;
        borrow = borrowAmount;
        debt = debtAmount;
