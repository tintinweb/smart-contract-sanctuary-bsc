...
contract BOBCATINU is IBEP20, Auth {
    ...
    string constant _symbol = "BOBCATINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 15) / 1000;  // 1.5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 15) / 1000;  // 1.5% max wallet
    ...
    address private marketingFeeReceiver = 0xb17367EbEE013f22635D16eBa903F87a18b95d8D;
    address private teamFeeReceiver = 0xb17367EbEE013f22635D16eBa903F87a18b95d8D;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 45; // 3%
    bool inSwap;
