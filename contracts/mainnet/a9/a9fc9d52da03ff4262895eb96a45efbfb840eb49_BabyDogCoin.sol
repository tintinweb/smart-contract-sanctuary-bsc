...
contract BabyDogCoin is Context, IERC20, Ownable {
    ...
    string private _name = "BabyDogCoin";
    string private _symbol = "BDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb151637b472549b5C8bd2F8e9Fc9F62695ca2907); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb151637b472549b5C8bd2F8e9Fc9F62695ca2907); // BuyBack Address
