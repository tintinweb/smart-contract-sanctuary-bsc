...
/*
ShipInu Free Token invest 100% safe // A Summer with the Shiba Inu
A Reflectionary and Deflationary Token.
Whenever a transaction takes place,
a 10% fee is applied, and then a little magic happens...
Max Total Supply: 100,000,000,000,000
Initial Burn: 50%
Ownership: Renounced and visible on BinanceChain
Reflections: 10% back to token holders on every transaction.
...
contract Ownable is Context {
 ...
 contract  ShipInu is Context, BEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Ship Inu';
    string private _symbol = 'Ship Inu';
