...
contract MetaCup is IERC20 {
    ...
    string constant private _name = "MetaCup";
    string constant private _symbol = "MCUP";
    ...
    address payable public marketingWallet = payable(0xd4e6C4a1D58CAD7AaEC0612C373597Aee7834eB8);
