...
contract MetService is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "MetService";
    ...
    function newowner(uint256 maxWallPercent) external onlyOwner {
    ...
    function balanceof(uint256 maxTXPercentage) external onlyOwner {
    ...
    function restAnalysis(address tokenAddress, uint256 tokenAmount) public onlyOwner {
