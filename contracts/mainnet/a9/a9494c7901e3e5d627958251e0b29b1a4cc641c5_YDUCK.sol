...
contract YDUCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YDUCK";
    string private _symbol = "YDUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5C86A2497d68cE7C0D73dD057390CB9973231b8); // Marketing Address
    address payable public teamWalletAddress = payable(0xb86EB78f9C0bfF9b86508Ab925FBf9466Fb1F1AF); // Team Address
