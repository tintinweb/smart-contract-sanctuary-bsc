...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C25417b73aA15F542d9cD6E474033EdAf23a523; // owner address
...
contract BankaiKurasaki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bankai Kurasaki";
    string private _symbol = "BankaiKura";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8241e715102fE2A1d9CBa1551C07e138EDB4f956); // Marketing Address
    address payable public teamWalletAddress = payable(0x8241e715102fE2A1d9CBa1551C07e138EDB4f956); // Team Address
