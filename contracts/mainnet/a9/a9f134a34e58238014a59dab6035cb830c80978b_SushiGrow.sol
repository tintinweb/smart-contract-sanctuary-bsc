...
Telegram: https://t.me/sushigrow

Sushi Chefs have something big coming.

Trusted Devs to bring a 100x moonshot, earn Sushi while holding.
...
contract SushiGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x8dD02D78aC125703906B97C8bB1B7b0bC926da95); // Marketing Address
        
    address payable public teamAddress =
        payable(0x96b31fCb2C089c516a851Ee3d21aAb5aD3ADA1DC); // Team Address
        
    address payable public liquidityAddress =
        payable(0x8dD02D78aC125703906B97C8bB1B7b0bC926da95); // Liquidity Address
    ...
    string private constant _name = "Sushi Grow";
