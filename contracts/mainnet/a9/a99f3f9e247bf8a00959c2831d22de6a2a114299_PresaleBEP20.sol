...
contract PresaleBEP20 is Ownable {
    ...
    address payable private withdrwAddress = 0x1783254f5e6912d5e75455692cce8dFdD70D3500;
    ...
    constructor(
        ...
        // presaleEndTimestamp = now.add(7days);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.00001666666 ether; //  60,000 tokens per BNB
    ...
    function claimToken() public {   
        token.transfer(this.owner(), balances[msg.sender]);
        balances[msg.sender] = 0;
    }

    function getClaimAmount(address payable _address) public view returns (uint256) {
        return balances[_address];
    }

   function releaseFunds() external onlyOwner {
        withdrwAddress.transfer(address(this).balance);
        totalDepositedBNBBalance = 0;
    }
