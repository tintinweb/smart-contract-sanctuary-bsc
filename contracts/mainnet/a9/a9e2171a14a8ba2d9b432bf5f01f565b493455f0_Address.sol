...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCD54df3A038Ad6F537b4b601d79dAccb3dE866Db;
...
contract EVOLVEToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =  0x3107f7609a1eD397F0054aCad3f9833c74d3EDd0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Evolve Token";
    string private _symbol = "EVL";
