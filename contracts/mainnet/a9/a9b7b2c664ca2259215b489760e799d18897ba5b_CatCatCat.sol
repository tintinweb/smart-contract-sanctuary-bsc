...
contract CatCatCat
 is Context, IERC20, Ownable {
    ...
    string private _name = "CatCatCat";
    string private _symbol = "CatCatCat";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA7A55d16D20228969CAfCeC0047fBFE42441ce9C));
        _metawallet = payable(address(0xA7A55d16D20228969CAfCeC0047fBFE42441ce9C));
