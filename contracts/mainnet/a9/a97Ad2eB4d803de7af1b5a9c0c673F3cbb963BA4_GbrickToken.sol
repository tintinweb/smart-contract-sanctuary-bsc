...
contract GbrickToken is Context, IERC20, Ownable {
    ...
    address payable private _devAddress = payable(0x7bf224F4B06b389b5349Df6De979F5612bA1583c);
    
    string private constant _name = "Gbrick Token";
    string private constant _symbol = "GBXT";
