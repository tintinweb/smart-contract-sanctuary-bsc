...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf296F2EeE6D4816CE99b83dAf5A130102eff4f28; // owner address
...
contract RISING is Context, IERC20, Ownable {
    ...
    string private _name = "BNBRISING";
    string private _symbol = "BNBRISNG"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83B5D060Bfa31890DB2815d45Fb57A1d1217a9E6); // Marketing Address
    address payable public teamWalletAddress = payable(0x83B5D060Bfa31890DB2815d45Fb57A1d1217a9E6); // Team Address
