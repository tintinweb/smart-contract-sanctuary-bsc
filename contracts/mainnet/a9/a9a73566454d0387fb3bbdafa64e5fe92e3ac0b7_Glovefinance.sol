...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa664Bdfc1aEB0176Bf9A4dA2efF40246c596B280;
...
contract Glovefinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCa427A414749141310288aBC76b1D2F9d49e56B8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**17;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Glove Finance";
    string private _symbol = "GLV";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**17;
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**17;
