...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x461bbEB4D099cbA3584659ffA5C3A3b20Bdaa51C; // owner address
...
contract ELONSQUACK is Context, IERC20, Ownable {
    ...
    string private _name = "ELONs QUACK";
    string private _symbol = "EQUACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4907828F2e9EbD886BC8a5BD26051E33953C1c6c); // Marketing Address
    address payable public teamWalletAddress = payable(0x463CAF1fD9346A6C721f66Eb241486304B45Ca06); // Team Address
