...
contract P77 is Context, Ownable {
    ...
    uint256 private constant X5 = 77 * (10** X4);
    string private constant _name = "P77";
    string private constant _symbol = "P77";
