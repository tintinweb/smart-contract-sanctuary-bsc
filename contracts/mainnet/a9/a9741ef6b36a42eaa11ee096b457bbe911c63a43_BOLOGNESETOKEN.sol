...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xce6833D5dB054ba3a1C33AF11aCfA44cFbF3B8Ec;
...
contract BOLOGNESETOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeE4483BA89Ce19b16436dD7151901023936DE131;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BOLOGNESE TOKEN";
    string private _symbol = "BOLO";
