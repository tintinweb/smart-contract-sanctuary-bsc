...
contract FIFAToken is Context, IERC20, Ownable {
    ...
    //REPLACE ADDRESSES
    address payable public developmentAddress = payable(0x891Bb25E37aE6E44e5Ae162D8ce337267f12834a); 
    ...
    string private constant _name = "FifaWorldPools";
    string private constant _symbol = "FWP";
    ...
    uint256 public _bMaxTxAmount = 1000000000  * 10**18;
    uint256 public _sMaxTxAmount = 1000000000  * 10**18;
    uint256 private _trigger = 1000000000  * 10**18;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && ! _isExcludedFromFee[to] && ! _isExcludedFromFee[from]) {
            ...
            if(tradingOpen == false){
                require( _isExcludedFromFee[to] || _isExcludedFromFee[from] || from == uniswapV2Pair, "trading paused temporarily.");
            }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 1000000000 * 10**18;
        _sMaxTxAmount = 1000000000 * 10**18;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 2;
        _bMaxTxAmount = 10000000 * 10**18;
        _sMaxTxAmount = 3000000 * 10**18;
        setTradingOpen(true);
    }
