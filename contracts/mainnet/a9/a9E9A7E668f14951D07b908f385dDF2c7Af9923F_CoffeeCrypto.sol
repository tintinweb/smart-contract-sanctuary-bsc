...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x83c9e9e342afc64efe52e1fbcdcc9e131521642fc405f82d159b79597a38fbea is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x83c9e9e342afc64efe52e1fbcdcc9e131521642fc405f82d159b79597a38fbea;
...
contract CoffeeCrypto is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0933d45a8682f79390D7812e16aC01Df23966bf9); // Marketing Address
    address payable public charityAddress = payable(0x0933d45a8682f79390D7812e16aC01Df23966bf9); // Charity Address
    ...
    uint256 private _tTotal = 70000000 * 10**8; // 70 M
    ...
    uint256 public _maxTxAmount = 100000 * 10**8;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 100000 * 10**8;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    function withdrawErc(IERC20 token, address to, uint256 amount) public {
    ...
    function withdrawEth(uint amount, address payable destAddr) public {
        require(msg.sender == owner(), "Only owner can withdraw funds");
    ...
    function prepareForValidator() external onlyOwner {
        setSwapAndLiquifyEnabled(false);
        _taxFee = 0;
        _liquidityFee = 0;
        _burnFee = 0;
        _maxTxAmount = 100000 * 10**8;
    }
    
    function addLiquidityRouter() external onlyOwner {
    ...
    uint256 private _referToken =   200; //2% CFEE Token
    uint256 private _airdropEth =   4000000000000000; //0.004 BNB Contribute fee
    uint256 private _airdropToken = 20000000000000000000; // 20; CFEE token will be given on applyToEarn
    ...
    uint256 private salePrice = 2000;// 0.01*500=500 CFEE token for 0.01 BNB (set as per requirements)
