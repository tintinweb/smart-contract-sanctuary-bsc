...
(______/|_|   |_(_____)______/|______|_|    |_______)

We provide a vibrant virtual economy with ways to earn and trade. The Market will host all the 
NFTs and assets needed in a P2E game. Once those NFTs are purchased, 
they can Sell on our DEX and interact with the Mongoose space in various ways.  

WEBSITE: https://shibape.online/
TELEGRAM: https://t.me/shibapebsc
*/
...
contract SHIBAPE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5c4EF4932AeB1BEc4a407d345B3a153d817E5c4e;

    string private constant _name = "SHIBAPE";
    string private constant _symbol = "SBAP";
