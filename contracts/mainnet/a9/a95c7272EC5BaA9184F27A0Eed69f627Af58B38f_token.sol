...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x13c0569bb8e466bd78E4dDa06961d6ba49713089);
    address private _MarketAddress2 = address(0x13c0569bb8e466bd78E4dDa06961d6ba49713089);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("ABJS", "ABJS") {
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x13c0569bb8e466bd78E4dDa06961d6ba49713089, "");
        _;
    }
