...
contract ERC20 is IERC20 {
    ...
    uint256 public _rebaseLastTime;
    ...
    uint256 public _rTotalBouns;
    uint256 public _tTotalBouns;
...
contract OLOGY is ERC20, Ownable {
    ...
    constructor() ERC20("OLOGY", "OLOGY") {
        ...
        isAdmin[0xF8D58D5b687a019fC358bD131c1fA1cA197503bC] = true;
    ...
    function _transfer(
        ...
        if (isSwapPair[sender]) {
            ...
            require(amount <= (balanceOf(sender) * 99) / 100, "Not All Swap");
