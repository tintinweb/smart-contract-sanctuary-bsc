...
/* Token contract */
contract DogeElonCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xFd4e3E5dbA9698F9A1CC9521C3e41457E6Ab4cf6;
    ...
    // Name and symbol
    string constant _name = "DogeElon Cat";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 100000; // 0.1% of supply
