...
/**
Eight Dollar Twitter Smart Contract 


    _______       __    __     ____        ____              ______         _ __  __           
   / ____(_)___ _/ /_  / /_   / __ \____  / / /___ ______   /_  __/      __(_) /_/ /____  _____
  / __/ / / __ `/ __ \/ __/  / / / / __ \/ / / __ `/ ___/    / / | | /| / / / __/ __/ _ \/ ___/
 / /___/ / /_/ / / / / /_   / /_/ / /_/ / / / /_/ / /       / /  | |/ |/ / / /_/ /_/  __/ /    
/_____/_/\__, /_/ /_/\__/  /_____/\____/_/_/\__,_/_/       /_/   |__/|__/_/\__/\__/\___/_/     
        /____/                                                                                 


https://t.me/eightdollartwitter
*/
...
contract EightDollarTwitter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    EightDollarTwitterDividendTracker public dividendTracker;
    ...
    constructor() ERC20("EightDollarTwitter", "EDT") {
        marketingWallet = payable(0x5E8d3cce8ca4cF9e61052B26014a93c403c30674);
        devWallet = payable(0x302C9C273DBaEC0F0ba15e9452A7e17729EF61f0);
        ...
        dividendTracker = new EightDollarTwitterDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "EightDollarTwitterTRACKER",
            "EDTTRACKER"
        );
...
contract EightDollarTwitterDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    EightDollarTwitter public EightDollarTwitterContract;
    ...
    constructor(
        ...
        defaultToken = token;
        EightDollarTwitterContract = EightDollarTwitter(mainContract);
    ...
    function _transfer(
        ...
        require(false, "EightDollarTwitter_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EightDollarTwitter_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EightDollarTwitter contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(EightDollarTwitterContract);

            uint256 prevBalance = EightDollarTwitterContract.balanceOf(address(this));
            ...
            {
                uint256 received = EightDollarTwitterContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    EightDollarTwitterContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
