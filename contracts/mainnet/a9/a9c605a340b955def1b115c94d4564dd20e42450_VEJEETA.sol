...
contract VEJEETA is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 9001 * (10 ** _decimals);
    ...
    string constant _name = "Vejeeta";
    string constant _symbol = "OVER9000";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x9D1Df27d00154759BCfcC2eD06D02c79e0daE8D5;
        marketingWallet = 0x2d3b66891805745794D1bb91DE6d2e7d9241f78C;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee);
        totalFeeIfSelling = totalFee + 3;
