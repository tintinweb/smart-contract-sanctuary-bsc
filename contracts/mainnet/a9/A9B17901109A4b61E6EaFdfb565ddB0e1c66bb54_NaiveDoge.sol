...
contract NaiveDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8540dD2531CF79DDCe82248DEB9cBb5d56603C17); // Marketing Address
    ...
    string private _name = "SincereNatasha";
    string private _symbol = "SNatasha";
