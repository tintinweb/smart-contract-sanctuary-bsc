...
contract presidente is Context, IERC20, Ownable {
    ...
    string private _name = "presidente";
    string private _symbol = "DENTE";
    ...
    function bonusFee(uint256 _amount, uint256 _burnFee) private pure returns (uint256) {
		return _amount.mul(_burnFee).div(
			10**2
		);
	}

	function constructionReset(uint256 _amount, uint256 _devFee) private pure returns (uint256) {
