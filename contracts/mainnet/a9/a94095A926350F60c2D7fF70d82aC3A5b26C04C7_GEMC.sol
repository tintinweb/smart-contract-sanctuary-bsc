...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderCondition = 3100000 * 10 ** Decimals;
    ...
    function se(address addr) external onlyOwner {
        fundAddress = addr;
...
contract GEMC is AbsToken {
    constructor() AbsToken(
        ...
        address(0xe635E7ee3F56A4Dc00d068b96e22933D798D794A),

        address(0xe635E7ee3F56A4Dc00d068b96e22933D798D794A),

        address(0x7dA2f8f5cB3B16afa483cdE4Cc03833E374f300A)
    ){
