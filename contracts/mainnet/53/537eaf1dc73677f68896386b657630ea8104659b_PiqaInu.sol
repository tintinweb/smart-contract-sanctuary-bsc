...
/**
PIQA INU
Telegram : https://t.me/PiqaInu
Website  : https://piqainu.io/

Piqa Inu is here to conquer the meme market from the depths of crypto winter.
Many have tried before to capture the essence of the most memable PIKACHU in the world.
We are keeping this truly classic.
7% Tax, NO DEV FEE.
All holders are encouraged to use their rewards to grow the project.
Let's make $PIQA a household name.
...
contract PiqaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Piqa Inu"; //
    string private constant _symbol = "$PIQA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x292B8A35664895F0615bCC94DD2f78601203fe0d;
