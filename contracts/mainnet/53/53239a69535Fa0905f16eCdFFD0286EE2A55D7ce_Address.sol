...
contract Test748 is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 10;  //liquidity + dev 
    ...
    function _setCharityWallet(address payable charityWalletAddress) external onlyOwner() {
        _devWallet = charityWalletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liqPart = contractTokenBalance.div(_liquidityFee).mul(4);
        uint256 devPart = contractTokenBalance.sub(liqPart);
