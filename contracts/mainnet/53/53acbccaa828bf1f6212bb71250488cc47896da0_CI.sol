...
contract CI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Captain Inu";
    string constant _symbol = "CAPTAININU";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf8f03770B6A1c704F37AB5D48d6b34aFE29187Fd;
