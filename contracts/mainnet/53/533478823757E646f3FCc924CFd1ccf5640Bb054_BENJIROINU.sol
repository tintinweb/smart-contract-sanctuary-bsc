...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEC8C4657582e7DA1c188b23A061Af5b034F7dAfD;
...
contract BENJIROINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 90000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BENJIRO INU";
    ...
    uint256 public _maxTxAmount = 47000000000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 47000000000000 * 10**18;
