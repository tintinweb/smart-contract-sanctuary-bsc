...
contract SupportAssistV5 is Ownable {
    ...
    uint256 public tokenAPrice = 3 * 1e18;
    ...
    function deposit(uint256 _ftype, uint256 amount0) external {
        ...
        uint256 amountU = (tokenAPrice * amount0) / 1e18; // getUSDT(amount0);
        uint256 amount1 = getTokenB(amountU);
