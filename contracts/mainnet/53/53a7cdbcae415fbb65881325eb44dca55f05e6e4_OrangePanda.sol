...
// ENGLISH TG PORTAL: @orange_panda_portal
// CHINESE TG: https://t.me/OrangePandaChinese
//WEBSITE: https://orangepanda.live/
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("OrangePanda_Track", "OGPG", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
    ...
    function Launch(uint256 Blocks) external onlySharedOwners {
        ...
        require(Blocks <= 60, "Not more than 3mn");
        tradingEnabled = true;
...
contract OrangePanda is Main {
    ...
    constructor() Main (
        ...
        0xBf50F6dFdc066780DB6a18Ba594e7bDE5DBF1A64,     // Marketing address
        0x3D58F0bf5e525d42d93Cf2314949de23Fd3F76ee,     // Team address AND DEV
        0x41491A8d0fDC65B309f01406C008beba26F278f3,     // Multi Use address (CHARITY)
        100_000_000,      // Initial Supply
        60_000_000,       // Dispatch Supply
        98     // Max Tax
        ) {} 
}
