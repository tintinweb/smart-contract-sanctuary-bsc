...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            //: IDEXRouter(0x078c034c929D239E0D8Be0d2D845838CbB1eBc14); // TESTNET ONLY
...
contract SXS is IBEP20, Auth {
    ...
    address MKT  = 0xdd0deDf0d95A88F6864B4b03537Cd7F7914479b3;
    address CATTLE = 0x406979f31AA6c4453FF7cA9E9B9679cDe1342acb;

    string constant _name = "Spoc X Swap";
    string constant _symbol = "SXS";
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x078c034c929D239E0D8Be0d2D845838CbB1eBc14); // TESTNET ONLY
