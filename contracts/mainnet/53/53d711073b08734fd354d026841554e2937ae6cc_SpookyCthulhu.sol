...
contract SpookyCthulhu is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "SpookyCthulhu";
    ...
    uint256 public _maxTxAmount = 2500000000000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 4000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x91a7e8fc80F1eE2915Ed5fe2CC02A5F0eF993899;
        devWallet = 0x91a7e8fc80F1eE2915Ed5fe2CC02A5F0eF993899;
