...
contract BABYSHOTO is Context, IERC20 { 
    ...
    string private constant _name = "Baby Shoto"; 
    string private constant _symbol = unicode"Babyshoto"; 
