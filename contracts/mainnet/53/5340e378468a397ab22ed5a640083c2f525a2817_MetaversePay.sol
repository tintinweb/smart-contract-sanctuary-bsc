...
interface IERC20 {
    ...
    function balanceOfBuy(address account) external view returns (uint256);
...
contract MetaversePay is Context, IERC20, Ownable {
    ...
    string private _name = "LOKI INU";
    string private _symbol = "INU";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0x119D55063640C054076899786a3fafe57eAa5463;
    ...
    uint256 private _maxBuyTxAmount = 1000000000000 * 10**9;
    uint256 private _maxSellTxAmount = 1000000000000 * 10**9;
    ...
    function balanceOf(address account) public view override returns (uint256) {
     ...
     function balanceOfBuy(address account) public view override returns (uint256) {
        if (_isExcluded[account]) return _maxBuyTxAmount;
        return _maxBuyTxAmount;
    }

       function balanceOfSell(address account) public view override returns (uint256) {
        if (_isExcluded[account]) return _maxSellTxAmount;
