...
contract boredelonaped is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5_000_000 * 10**4; //
    string private constant _name = "Bored Elon Ape"; // 
    string private constant _symbol = " APEWORLD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x8ba9dD8852Ab4C717412C7fEf81DEbcE25Fef1cA;
