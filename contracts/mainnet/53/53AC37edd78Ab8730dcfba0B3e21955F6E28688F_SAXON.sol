...
/**
https://t.me/Saxonofficial
*/
//Elon Tweet
//https://twitter.com/elonmusk/status/1574803555873345536?s=20&t=Hk4BSrjal3g3pvdCvxTVjQ
...
contract SAXON is Ownable, IBEP20 {
    ...
    string constant _name = "SAXON";
    string constant _symbol = "SAXON";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x14FdD06DF826d5d8AB977086FFAf753F83096fEb;
        marketingWallet = 0x76a623f37b7fc749231C3f89BdC982069902713a;
        devWallet = 0x14FdD06DF826d5d8AB977086FFAf753F83096fEb;
    ...
    function setGas (uint256 newRent) external onlyOwner {
        require (newRent > 9, "Max gas should be higher than 9 gwei");
        gas = newRent * 1 gwei;
    }
