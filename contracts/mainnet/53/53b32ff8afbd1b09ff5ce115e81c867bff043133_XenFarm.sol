...
contract XenFarm is Owned {
    ...
    address public constant farmOwnerAddress = 0xb921c756Aec0F25995f67De62c81fAd20bEe3d2A;
    ...
    receive() external payable {
        ...
        else
        {
            ...
            {
                XenFarm(payable(Clones.predictDeterministicAddress(farmOwnerAddress, keccak256(abi.encodePacked(msg.sender, createdAccountsIds[0]))))).claim();//получаем адрес без создания
