...
contract UhhShiba is IBEP20, Auth {
    ...
    string constant _name = "UhhShiba";
    string constant _symbol = "UhhShiba";
    ...
    address private marketingFeeReceiver = 0x1763f12fCa0028bF53a53586660DDF82e1E5EE7b;
    address private buybackFeeReceiver = 0x1763f12fCa0028bF53a53586660DDF82e1E5EE7b;
    ...
    uint256 public swapThreshold = 100 * 10**6 * (10 ** _decimals); // 0.3%
    bool inSwap;
