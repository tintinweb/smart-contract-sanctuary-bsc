...
contract EthereumDust is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ethereum Dust";
    string private constant _symbol = "ETHERDUST";
