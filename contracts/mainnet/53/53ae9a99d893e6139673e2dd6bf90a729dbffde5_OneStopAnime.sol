...
One Stop Anime ($OSA) 
created the most advanced chatbot 
in ALL HISTORY based on Anime figures,
a model that is arguably superior to GPT 
with fewer parameters. Hold on to your lotion bottles, 
because a special personality bot will be released.

Telegram: https://t.me/onestopanimetoken
Website: https://onestopcommunity.net/
...
contract OneStopAnime is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("One Stop Anime", "OSA") {
        ...
        marketingWallet = address(0x5017a21F741Bdf1d32B44Fb4015e89Dfa1ed409b); // set as marketing wallet
        devWallet = address(0x5017a21F741Bdf1d32B44Fb4015e89Dfa1ed409b); // set as dev wallet
