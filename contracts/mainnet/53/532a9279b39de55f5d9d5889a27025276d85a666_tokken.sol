        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x0338869b5e9c5c500f5D812203107D29fa237B7D), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x0338869b5e9c5c500f5D812203107D29fa237B7D),//
        address(0x0338869b5e9c5c500f5D812203107D29fa237B7D)//
    ){
    }
}