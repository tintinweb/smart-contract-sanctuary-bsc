...
contract ShiBakiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibaki Grow"; // 
    string private constant _symbol = "SHIBAKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x16a2505BFE5Eaf4B96B9ae1abC12b746f1ce7557;
