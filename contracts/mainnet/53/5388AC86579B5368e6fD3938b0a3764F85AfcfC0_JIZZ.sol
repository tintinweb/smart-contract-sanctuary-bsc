...
/**
 BSC fork of JizzRocket on ETH. All tokenomics are exactly the same, this is for everyone that missed the run in ETH.
 Web - https://jizzrocket.io/
 Telegram - t.me/JizzRocketPortal
 Twitter - https://twitter.com/jizzrocketcoin
 BSC Telegram and Twitter will follow if this takes off.
*/
