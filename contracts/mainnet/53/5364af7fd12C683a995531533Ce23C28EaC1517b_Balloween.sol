...
contract Balloween is IBEP20, Ownable {
    ...
    string constant _name = "Balloween"; 
    string constant _symbol = "BAUY"; 
    ...
    address public marketingFeeReceiver = 0x9c9287fA58aa59a196E794B66b0a75b1B5df9672;
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
        require(BuyliquidityFee.add(BuymarketingFee) <= 10, "Buy fees can't be higher than 10%");
    ...
    function setSellFees(uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
        require(SellliquidityFee.add(SellmarketingFee) <= 10, "Sell fees can't be higher than 10%");
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percentage_min_base10000, uint256 _percentage_max_base10000) external onlyOwner {
        require(_percentage_min_base10000 >= 1);
        require(_percentage_max_base10000 >= 10);
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner {
        require(maxWallPercent_base1000 >= 10, "Max Wallet amount must be at least 1%");
    ...
    function setMaxBuyTxPercent_base1000(uint256 maxBuyTXPercentage_base1000) external onlyOwner {
        require(maxBuyTXPercentage_base1000 >= 10,"Max Buy amount must be at least 1%");
    ...
    function setMaxSellTxPercent_base1000(uint256 maxSellTXPercentage_base1000) external onlyOwner {
        require(maxSellTXPercentage_base1000 >= 10, "Max Sell amount must be at least 1%");
