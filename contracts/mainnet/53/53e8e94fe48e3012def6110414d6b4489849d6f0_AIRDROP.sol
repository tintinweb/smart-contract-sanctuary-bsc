...
contract AIRDROP is Ownable{
   ...
   ///// mapping (address => mapping (address => uint256)) private TokenAllowance;
    ...
    function AirdropA_Jump(address Token_CA, address[] calldata Wallets, uint256 Token_Total ) external {

                BEP20(Token_CA).transferFrom(msg.sender, address(this), Token_Total);
    ...
    function AirdropA_From_CONTRACT(address Token_CA, address[] calldata Wallets) external {
