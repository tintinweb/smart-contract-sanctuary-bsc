...
contract DecaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Deca Network";
    string private _symbol = "$DECA";
    uint8 private _decimals = 9;
    
    address payable public marketingWallet = payable(0xA08c544069F2ef01275B402e2c53b8A99fA6E487); // Marketing Address
    address payable public buyBackWallet = payable(0xa652db5d56cEf1725A3bF9643Ab49064B09694e0); // BuyBack Address
