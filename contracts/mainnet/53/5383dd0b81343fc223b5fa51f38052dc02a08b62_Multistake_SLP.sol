...
contract Multistake_SLP {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address private tokenAddr = 0x070a08BeEF8d36734dD67A491202fF35a6A16d97; // SLP
    IERC20 public token;

    uint256 public constant INVEST_MIN_AMOUNT = 1000 ether; // 1000 SLP
