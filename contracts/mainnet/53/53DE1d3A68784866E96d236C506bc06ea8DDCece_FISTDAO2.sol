...
contract FISTDAO2 is Context, IERC20, Ownable {
    ...
    address payable private _anotherA = payable(0xB238603b36d4612271B8562052352196be05f963); 
    address payable private teamWalletAddress = payable(0x9ab4c5008C1652B16C01d212b59863CF7117044F); 
    ...
    uint256 private _totalSupply = 1 * 666*  10**_decimals;
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            152000000000000000 == serviceFee_ ,
