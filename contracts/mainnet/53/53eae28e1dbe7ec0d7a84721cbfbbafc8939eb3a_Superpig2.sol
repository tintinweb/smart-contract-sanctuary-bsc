...
contract Superpig2 is Context, IERC20, Ownable {
    ...
    string private _name = "SuperPig 2.0";

    string private _symbol = "SuperPig 2.0";
    ...
    address payable public marketAddress = 0x49a500Fdb545a2cEEe04c53FD6070D8305b01089 ; //Marketing
