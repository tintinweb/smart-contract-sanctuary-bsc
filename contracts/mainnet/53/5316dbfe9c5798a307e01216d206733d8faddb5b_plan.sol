...
contract plan is Ownable{
    ...
    uint[11] public levelIncome = [500,10,10,10,10,10,10,10,10,10,10];
    uint[11] public retopupIncome = [250,25,25,25,25,25,25,25,25,25,25];
    ...
    IBEP20 private  BUSD = IBEP20(0xa22293f17deF56e2d49Df9cE623f9348929bfCC1);
