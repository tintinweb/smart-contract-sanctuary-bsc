...
contract BasicGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic Grow";
    string private constant _symbol = "BASICGROW";
