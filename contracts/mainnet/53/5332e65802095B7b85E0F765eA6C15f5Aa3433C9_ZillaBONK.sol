...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6491ed51276651b7FCA911eF2B0144eF284C1C8F; // owner address
...
contract ZillaBONK is Context, IERC20, Ownable {
    ...
    string private _symbol = "ZILLABONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6491ed51276651b7FCA911eF2B0144eF284C1C8F); // Marketing Address
    address payable public teamWalletAddress = payable(0x6491ed51276651b7FCA911eF2B0144eF284C1C8F); // Team Address
