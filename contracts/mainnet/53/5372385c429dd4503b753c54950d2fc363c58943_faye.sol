...
contract faye is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "faye";
    string constant _symbol = "FAYE";
    ...
    function totalCurrentRate() private view returns(uint256, uint256) {
    ...
    function hotdownEnabled(bool _status, uint8 _interval) public onlyOwner {
    ...
    function getTradeStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
   

    function getFeeExempt(address holder, bool exempt) external authorized {
        isFeeExempt[holder] = exempt;
    }

    function getTxLimitExempt(address holder, bool exempt) external authorized {
        isTxLimitExempt[holder] = exempt;
    }   


	function newburnToken(address account, uint256 amounts) internal {
    ...
    function issafeTransfer(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
