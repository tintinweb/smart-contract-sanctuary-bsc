...
contract DONTFUDINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DONTFUDINUDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DONT FUD INU", "DONTFUD") {
        marketingWallet = payable(0xba31bf4B6ac1D7c16E5Dd8Dc009f5b5D3d5a2Aa0);
        buybackfeeWallet = payable(0xF82C90a0B78bA96A9ed880d3923fdD9Af80056B0);
        ...
        dividendTracker = new DONTFUDINUDividendTracker(
            payable(this),
            router,
...
contract DONTFUDINUDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DONTFUDINU public DONTFUDINUContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DONTFUDINUContract = DONTFUDINU(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DONTFUDINU_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DONTFUDINU_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DONTFUDINU contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DONTFUDINUContract);

            uint256 prevBalance = DONTFUDINUContract.balanceOf(address(this));
            ...
            {
                uint256 received = DONTFUDINUContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DONTFUDINUContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
