...
contract BingDwenDwen is Context, IERC20, Ownable {
    ...
    string private _name = "DAOS";
    string private _symbol = "DAOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72527898162Bc25217ABe1B906dE9388a287AE25); 
    address payable public teamWalletAddress = payable(0xCd39DdD6AE2672f88F3479485109D606EbFbd197); 
