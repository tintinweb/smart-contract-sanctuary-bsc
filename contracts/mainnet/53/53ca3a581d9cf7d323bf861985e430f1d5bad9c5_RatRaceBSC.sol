...
contract RatRaceBSC is Context, IERC20, Ownable {
    ...
    address private developmentWallet = 0x2A951a97caD41D8D87bad6f4d8baEE11D1d50d22;
    address private mteamWallet = 0xD449e2C36Efb49981ECD317871Ed6be846252Bc6;

    string private constant _name = "RatRaceBSC";
    ...
    Taxes public sellTaxes = Taxes(0, 50, 45, 1, 1);
    ...
    function setBuyTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _mteam) public onlyOwner {
        require((_rfi + _marketing + _liquidity + _development + _mteam) <= 20, "Fees can't exceed 20%");
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell, bool useLaunchTax) private view returns (valuesFromGetValues memory s) {
        ...
        s.tmteam = tAmount*temp.mteam/100;
