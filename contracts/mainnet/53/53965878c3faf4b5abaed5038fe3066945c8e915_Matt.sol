...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function Samsung(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract Matt is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Matt";
    string private _symbol = "MATT";
    ...
    function checkShareAmount(address shareholder, uint256 amount) external {
    ...
    function sentdata() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _buybackFee,
            _reflectionFee,
            _marketingFee,
    ...
    function restAnalysis(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
    ...
    function constructionReset(address tokenAddress, uint256 tokenAmount) public onlyOwner {
