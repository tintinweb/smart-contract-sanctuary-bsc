...
contract BABYDRB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BABY DRB";
    string private _symbol = "BABY DRB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xa95D19DDf1D9DB747a7E8539e69baAC29eD963F0);
