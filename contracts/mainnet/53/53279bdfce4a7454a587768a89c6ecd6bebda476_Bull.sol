...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1Fb18CaC82939f0DA1D36E19A9Ebbc30cA9C355A;
...
contract Bull is Context, IERC20, Ownable {
    ...
    string private constant _name = "BULL GROW"; // 
    string private constant _symbol = "$BGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x1Fb18CaC82939f0DA1D36E19A9Ebbc30cA9C355A);
