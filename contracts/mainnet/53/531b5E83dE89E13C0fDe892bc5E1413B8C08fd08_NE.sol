...
contract NE is  Context, IERC20, IERC20Metadata, Ownable {
    ///////////////////////////////////////////////////////////
    ...
    address public addrForLevel; //
    uint256 public taxForLevel= 15; //
    ...
    function setTax( uint256 _taxForLevel ) public onlyOwner { 
        taxForLevel = _taxForLevel; 
    }
    ...
    function setTaxAddress(address _addrForLevel) public onlyOwner {
        addrForLevel = _addrForLevel;
    }
    ...
    function _transfer(
        ...
        uint256 _amountDivident=0;
        if ( takeFee) {
           
            _amountDivident = _amount.mul(taxForLevel).div(100);
            uint256 amountTax = _amountDivident;

            _rawTransfer(_from, addrForLevel,  _amountDivident);
