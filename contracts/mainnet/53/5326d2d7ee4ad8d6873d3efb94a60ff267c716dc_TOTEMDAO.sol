...
abstract contract Contextbscscan {
...
contract Ownablebscscan is Contextbscscan {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebscscan: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebscscan: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TOTEMDAO is Contextbscscan, BinanceBTC, Ownablebscscan {
    ...
    string private _name = 'TOTEM DAO';
    string private _symbol = 'TOTEM DAO';
