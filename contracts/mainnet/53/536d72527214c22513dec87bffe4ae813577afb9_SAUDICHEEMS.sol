...
contract SAUDICHEEMS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SAUDI CHEEMS INU";
    string constant _symbol = "SAUDICHEEMS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x32C8Cf05AAdac84c2522cd0d6cf3c92316C05052; 
        burnWallet = 0x42EBb683D3216E20F40A8De4F5AbDEa09190B105; 
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(burnFee));
        totalFeeIfSelling = totalFee + 81;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newBurnFee, uint256 extraSellFee) external authorized {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newBurnWallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(burnWallet).call{value: amountBNBBurn, gas: 30000}("");
