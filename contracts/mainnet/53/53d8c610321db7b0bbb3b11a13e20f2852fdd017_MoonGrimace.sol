...
contract MoonGrimace is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "MoonGrimace";
   string constant _symbol = "MOONGRIM";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeSell = 3000;
    uint256 totalFeeSell = 4500;
