...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87BA9b1712EC847419DF2997304058eC7e2fb59D; // owner address
...
contract BluChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BluChain";
    string private _symbol = "$Blu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87BA9b1712EC847419DF2997304058eC7e2fb59D); // Marketing Address
    address payable public teamWalletAddress = payable(0x87BA9b1712EC847419DF2997304058eC7e2fb59D); // Team Address
