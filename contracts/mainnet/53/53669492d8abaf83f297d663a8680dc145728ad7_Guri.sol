...
contract Guri is IBEP20, Auth {
    ...
    string constant _name = "WTF";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "BahGuri";
    ...
    uint256 public liquidityFee    = 4; //fees.
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x237e06fD754Bd764d422994DDd7AaD00B357C69a;
        marketingFeeReceiver = 0x237e06fD754Bd764d422994DDd7AaD00B357C69a;
