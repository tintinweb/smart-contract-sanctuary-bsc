...
abstract contract AbsToken is IERC20, Ownable {
        ...
        lockTheSwap
    {
        ...
        uint256 marketingAmount = USDTBalance * (_buyFundFee + _sellFundFee) / swapFee;

        if (marketingAmount > USDTBalance)
            marketingAmount = USDTBalance;
...
contract denglong is AbsToken {
    constructor()
        AbsToken(
            ...
            address(0x55d398326f99059fF775485246999027B3197955),//fenhonng
            "AQIU",
            "AQIU",
            6,
            10000,
