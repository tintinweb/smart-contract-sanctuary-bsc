...
contract GoGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF22AF649f5f05f268EAd3208d38351056eCbE523); 
    address payable public Wallet_Dev = payable(0x34Bd9EBb96e23Cc796315661b4B20cC945656c56);
    ...
    string private constant _name = "Go Grow"; 
    string private constant _symbol = unicode"GO"; 
    ...
    uint256 public Percent_Reward = 10;
    ...
    constructor () {
        ...
        _owner = 0x34Bd9EBb96e23Cc796315661b4B20cC945656c56;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Reward / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Reward);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Reward * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Reward);
