...
contract SHIB is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 20 *10**15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e14 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x1B1a316659384d3e56d57602a816dF4729609467;
    ...
    function _getTValues(
        ...
        s.tRfi = (tAmount * taxes.rfi) / 40;
        s.tMarketing = (tAmount * taxes.marketing) / 40;
        s.tTransferAmount =
            tAmount -
            s.tRfi -
            s.tMarketing;
