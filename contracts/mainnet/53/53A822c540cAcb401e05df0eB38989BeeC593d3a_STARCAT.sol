...
contract STARCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Starry Cat "; // 
    string private constant _symbol = " $STARCAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xfE593Cb9166Fcbb7f28506D7B7F98104c600515C;
