...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd76B31B471858C9d3EC140955dc5f5d3421B9a61; // owner address
...
contract USHIONI is Context, IERC20, Ownable {
    ...
    string private _name = "USHI ONI";
    string private _symbol = "$ONI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1CDE928A8b4BfF0cAb2e7A595422db064BE8f9e6); // Marketing Address
    address payable public teamWalletAddress = payable(0xd76B31B471858C9d3EC140955dc5f5d3421B9a61); // Team Address
