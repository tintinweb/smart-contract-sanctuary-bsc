...
contract GetriumBurn is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Getrium Burn"; 
    string private constant _symbol = unicode"GRMBURN"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x01CA0D5E229eddDF6B2dfE6591419030F8Cdb7C6), BNB_Tot);
            }
