...
contract Dogeceo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6084C4B3af7F9553A5c1f9Dd7620809449887037); // Marketing Address
    address payable public teamWalletAddress = payable(0x7eb3b456D2ecf42df7C200Fe315023797154fd97); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x6084C4B3af7F9553A5c1f9Dd7620809449887037),
            block.timestamp
        );
    }
