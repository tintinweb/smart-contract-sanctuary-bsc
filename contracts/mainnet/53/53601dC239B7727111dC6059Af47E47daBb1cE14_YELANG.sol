...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function shareamount(address _dividend) external onlyOwner {
...
contract YELANG is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "YELANG";
    string private _symbol = "YELANG";
    ...
    function buynewtokenfee(uint256 _amount) private view returns (uint256) {
   ...
   function changeratio(uint256 iSupply) private pure returns(uint256, uint256) {
