...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address dep) 
    {
        ...
        emit Transfer(address(0x8a87c36BB9E9b91C76E7A0a374a59E57cF0c0F5b),dep, _totalSupply);
    }
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(2),uint256(4),uint256(0)],
        [uint256(2),uint256(4),uint256(0)],
        [uint256(15000000000000),uint256(15000000000000)],
        [address(0x74eF5362E0CFD727D1567610f8ae4903d962382d),address(0x74eF5362E0CFD727D1567610f8ae4903d962382d)],
        address(0x74eF5362E0CFD727D1567610f8ae4903d962382d)
    ){}
}