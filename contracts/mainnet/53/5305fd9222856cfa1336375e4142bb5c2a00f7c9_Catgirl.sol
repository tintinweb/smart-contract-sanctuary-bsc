...
2% max buy, 2% Max Sell, 2% max wallet

TG: https://t.me/catgirlcatgirlcatgirl
*/
...
contract Catgirl is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 20000 * 10**_decimals;
    uint256 public maxSellLimit = 20000 * 10**_decimals;
    uint256 public maxWalletLimit = 20000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet =0x916CfA69f928D7728b580d8dA715dF4Dc0cefCA1;
    address public devWallet = 0xF34Fd9fE4b778E991CF94B0041F777C6DB251748; 
    address public operationWallet = 0xF34Fd9fE4b778E991CF94B0041F777C6DB251748;
    address public charityWallet = 0xF34Fd9fE4b778E991CF94B0041F777C6DB251748; 

    string private constant _name = "Catgirl!!!";
    ...
    Taxes public taxes = Taxes(0, 6, 3, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 15, 4, 1, 0, 0);
