...
contract chocolate is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "chocolate";

    address public _PancakeSwapV1RouterUniswap = 0x57eb765845E20Ed9fE477Dedb5017130d16E33B8; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x57eb765845E20Ed9fE477Dedb5017130d16E33B8; //can be the same

    uint256 private _tTotal = 1032297 * 10**_decimals;
