...
//
// $KAIDOGROW proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/KAIDOGROW
//
...
contract $KAIDOGROW is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("KAIDO GROW", "KAIDOGROW") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "KAIDOGROW";
