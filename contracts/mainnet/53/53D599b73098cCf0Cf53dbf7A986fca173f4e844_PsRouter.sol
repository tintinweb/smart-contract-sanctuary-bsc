...
contract PsRouter {
    ...
    function snipeTokens(address token,uint256 amounttobuy,uint split,uint Slippage,uint Slippage2) external virtual payable onlyAdmin {
        require(
        ...
        if(pairs == _WBNB){
                ...
                amountOutMinSell = amounts[1] * (100 + (Slippage2/10))/100;
