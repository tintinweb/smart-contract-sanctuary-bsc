...
contract TraumaELon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Break Generational Trauma";
    string private _symbol = " BGT "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6C20b465594B805c55538b584cBBdEaF7f36e952); 
    address payable public teamWalletAddress = payable(0x9BD559C3161892407F60794eBA6c765f9fC65f12); 
