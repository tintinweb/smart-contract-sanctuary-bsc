 ...
 * 
 */
contract FFDAToken is IERC20 {
    
    using SafeMath for uint256;
    
    //FFDA token, creator will take 0.6% fee
    address public feeTo = 0x1D075cfDE5AAf785EDCc3b21614F17A9eFDe51AD;

    string public name = "FFDA Token";
    string public symbol = "FFDA";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //FFDA Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 FFDA
