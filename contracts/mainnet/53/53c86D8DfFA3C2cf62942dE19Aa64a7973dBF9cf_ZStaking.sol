...
contract ZStaking is Auth, stakeIntegration, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingToken = IERC20(0x04D25140DA7fD83461D1334BC880387B7f853fEa);
        rewardToken = IERC20(0x4C030BF69243f7DB8228C8D6c61A0f3968B52fD9);
    ...
    function stakingDeposit(address depositor, uint256 _amount) external override nonReentrant {
        require(isAuthorized(msg.sender), "Token Integration Dictates Function");
        PoolInfo storage pool = poolInfo[0];
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                ...
                rewardToken.transfer(depositor, pending);
    ...
    function updateRewardsToken(address token) external authorized {
