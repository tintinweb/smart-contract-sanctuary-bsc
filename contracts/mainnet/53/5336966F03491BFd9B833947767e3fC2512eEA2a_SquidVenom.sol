...
contract SquidVenom is IERC20, Ownable {
    ...
    string _name = "Squid Venom";
    string _symbol = "SQUIDVENOM";
    ...
    uint256 marketingFeeVariable = 9;
    ...
    function changeMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 1000000000000000000 * 10 ** _decimals * maxTx / 1000;
    }
