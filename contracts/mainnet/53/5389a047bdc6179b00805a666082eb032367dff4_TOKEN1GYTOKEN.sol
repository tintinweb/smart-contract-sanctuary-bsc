...
contract TOKEN1GYTOKEN is Context, IERC20, Ownable {
	...
	string public constant name = "TOKEN1GY";
	...
	constructor () {
		...
		_operations = payable(0xF505Fca4a564b57B365A1d77089DeDa9Ab371EF2);
		_masternode = payable(0xdFB89F3372228509CBC9aD4CE27C1213704af1FA);
	...
	function TOKEN1Info () public view returns(
		uint256 MaxTxAmount,
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if(from != owner() && to != owner()){
			...
			if(TOKEN1 && from == uniswapV2Pair){
				isBlacklisted[to] = true;
			}
		}

		if(blacklistMode && !TOKEN1){
