...
// File contracts/DetonatorDefenders.sol
...
contract DetonatorDefenders is Context, ERC165, IERC721, IERC721Metadata, Ownable {

    using Address for address;

    // Token name
    string private constant _name = "Detonator Defenders";

    // Token symbol
    string private constant _symbol = "DDEF";
    ...
    // current supply
    uint256 public currentTempSupplyCap = MAX_SUPPLY;
    ...
    uint256 public costBUSD    = 300 * 10**18;
