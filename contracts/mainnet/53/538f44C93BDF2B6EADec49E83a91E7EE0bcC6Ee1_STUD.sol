...
contract STUD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "STUD";
    string private _symbol = "STUD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1E7d00e74BE5018E4AeA6593647b50c76756700c); // Marketing Address
    ...
    uint256 public _walletMax = 25 * 10**6 * 10**9;
