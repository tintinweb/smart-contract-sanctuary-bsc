...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BLST = IBEP20(0x2D685b00E649510C75918506F4a3618A14cdB48f);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BLST.balanceOf(address(this));
        ...
        uint256 amount = BLST.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BLST.transfer(shareholder, amount);
...
/* Token contract */
contract tokenzxc is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BLST = 0x2D685b00E649510C75918506F4a3618A14cdB48f; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC993b56de76A25Fa1E0e7b13D90631e0b95E6051;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x76F8C662EB2E07C942326D14DB926F9433344460;
