...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5999B08D059384C5F5e7EE55e698357173B6E8D;
...
contract NUTCRACKER is Context, IERC20, Ownable {
    ...
    string private constant _name = "NutCracker"; // 
    string private constant _symbol = "NutCracker"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x5c1Cc24b945168D54f13eA7F136f8050917f2aB7);
