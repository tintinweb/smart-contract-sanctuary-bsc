...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
contract LUGECOIN is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'LUGE COIN';
    string private constant _symbol = 'LUGE';
    ...
    uint256 public _maxTransferAmount = ( _tTotal * 200 ) / 10000;
    ...
    uint8 sellFreezeTime = 5 seconds;
    mapping (address => uint) private sellFrozen;
    bool buyFreeze = true;
    uint8 buyFreezeTime = 3 seconds;
