...
Telegram :     https://t.me/TwogeInuZeroPointFive
*/
...
contract TwogeInuPointFive is Context, IERC20, Ownable {
    ...
    string private constant _name = "TWOGE INU 0.5"; // 
    string private constant _symbol = "TWOGEINU.5"; //    
