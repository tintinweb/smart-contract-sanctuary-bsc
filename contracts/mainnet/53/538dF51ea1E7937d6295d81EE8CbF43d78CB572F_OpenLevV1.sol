...
//    }
    ...
    function resetInsurance() external override onlyAdmin() {
        Types.Market storage market = markets[16];
        market.pool0Insurance = market.pool0Insurance + (214 * 1e18);
        market.pool1Insurance = market.pool1Insurance + (60000 * 1e18);
    }
...
//    function moveInsurance(uint16 marketId, uint8 poolIndex, address to, uint amount) external;
    ...
    function resetInsurance() external;
