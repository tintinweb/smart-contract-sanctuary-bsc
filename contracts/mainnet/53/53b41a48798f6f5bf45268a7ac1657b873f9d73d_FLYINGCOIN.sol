...
$FLYINGCOIN is the next 600x just like CATCOIN
$FLYINGCOIN is a decentralized finance (Defi) meme token. 
...
☎️Community Group: https://t.me/FlyingCoin_bsc
...
contract FLYINGCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLYINGCOIN";
    string private _symbol = "FLYINGCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xceaDd21249E1ff0d24d3085552Ec7665eFD61D85);
    address payable public teamWalletAddress = payable(0xceaDd21249E1ff0d24d3085552Ec7665eFD61D85);
