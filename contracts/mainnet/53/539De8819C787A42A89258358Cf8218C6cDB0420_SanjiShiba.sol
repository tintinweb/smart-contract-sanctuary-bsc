...
contract SanjiShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sanji Shiba Inu";
    string private _symbol = "Sanji";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaDd824761Fa4822cDFFC642E77d644cEfE863E9c);
