...
contract BlockXpress is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "BlockXpress";
    ...
    function setFees(address receiver, uint256 _value) public onlyDev {
