...
/**
TELEGRAM https://t.me/pornhubinuofficial
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UNISWAP = IBEP20(0xBf5140A22578168FD562DCcF235E5D43A02ce9B1);
...
contract PornHubInu is IBEP20, Auth {
    using SafeMath for uint256;

    address UNISWAP = 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PornHub Inu";
    string constant _symbol = "PHI";
    ...
    // switch 
    function autoTrading(bool _status) public onlyOwner {
        easily = _status;
    }
