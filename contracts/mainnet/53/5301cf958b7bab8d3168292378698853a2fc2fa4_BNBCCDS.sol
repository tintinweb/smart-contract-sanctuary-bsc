...
contract BNBCCDS  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBCCDS ";
    string private _symbol = "BNBCCDS ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE741f1b124AB637AFDe05EB659Aa06454674c0B7);
    address payable public teamWalletAddress = payable(0xE741f1b124AB637AFDe05EB659Aa06454674c0B7);
    address public immutable deadAddress = 0xE741f1b124AB637AFDe05EB659Aa06454674c0B7;
