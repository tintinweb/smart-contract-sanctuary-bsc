...
// ----------------------------------------------------------------------------
/// @title Website : https://elrold.com/
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
/// @title Elrold : ERC Token.
// ----------------------------------------------------------------------------
contract Elrold is  ERC20Interface, Context, Ownable, Whitelisted, Pausable {
    // Define public constant variables.
    ...
    returns (bool success) 
    {
        ...
        if(totalSupply+_amount>100000000){
