...
contract SuperSurge is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SuperSurge";
    ...
    //Tax wallets
    address public marketingWallet = 0xD1C027d860f27361FCa04aD3077Be3362C790743;

    // Tax Split Buy
    uint256 public marketingShare = 600;
    uint256 public rewardShare = 400;
    

    //tax Split Sell
    uint256 public sellMarketingShare = 600;
    uint256 public sellRewardShare = 400;
    ...
    //trading parameters
    uint256 public liquidity = 5**5 * 10**_srgDecimals;
