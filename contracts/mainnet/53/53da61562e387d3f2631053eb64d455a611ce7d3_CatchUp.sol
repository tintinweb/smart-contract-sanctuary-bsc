...
contract CatchUp is ERC20, Ownable {
    ...
    address public teamVestingWallet=0xFfc44911a5a9C30C8d2B1F079DF85a4470B7D976; //Team Vesting
    ...
    constructor (address newOwner) ERC20("Catch Up", "CU"){
        ...
        _mint(owner(), 40_000_000_000 * (10 ** 18));

        swapTokensAtAmount = 40_000_000_000 * (10 ** 18) / 5000;
    }
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _teamFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy  + _teamFeeOnBuy <= 20,
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _teamFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _teamFeeOnSell <= 20,
            "Fees must be less than 20%"
        );
