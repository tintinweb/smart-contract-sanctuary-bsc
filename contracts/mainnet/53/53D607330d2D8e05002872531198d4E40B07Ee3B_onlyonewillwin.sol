...
contract onlyonewillwin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Not Gonna Rug Inu";
    string private _symbol = "$NGRI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x979AC2831368AAaE41eD52E025d860823b259469); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x979AC2831368AAaE41eD52E025d860823b259469); // Team Address
