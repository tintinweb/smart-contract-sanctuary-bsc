...
contract WUT2DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("WUT22_Dividend_Tracker", "WUT22_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "WUT22_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "WUT22_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WUT22 contract.");
    }
