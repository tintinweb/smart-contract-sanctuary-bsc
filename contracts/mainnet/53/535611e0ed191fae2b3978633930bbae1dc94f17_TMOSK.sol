...
contract TMOSK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TMOSK";
    string private _symbol = "TMOSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb9E4e82840b5b1EC46C53A01dAe278985422DCEa);
    address payable public teamWalletAddress = payable(0xb9E4e82840b5b1EC46C53A01dAe278985422DCEa);
    address public immutable deadAddress = 0xb9E4e82840b5b1EC46C53A01dAe278985422DCEa;
