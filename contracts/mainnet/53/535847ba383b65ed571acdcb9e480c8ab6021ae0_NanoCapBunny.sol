...
contract NanoCapBunny is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"🐰NanoCapBunny"; // 
    string private constant _symbol = unicode"🐰NCBunny";  //    
