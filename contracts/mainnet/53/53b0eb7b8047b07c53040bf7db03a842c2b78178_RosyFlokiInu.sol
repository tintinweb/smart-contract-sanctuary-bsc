...
/**
 ...
 Telegram Group: https://t.me/RosyFlokiPortal
 Website: https://rosyfloki.com/
 Total Fees: 15%
 6% Marketing fee                   
 5% Liquidity fee
 2% Reflection fee
...
pragma solidity ^0.6.12;
    ...
    */
    ...
    contract RosyFlokiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Rosy Floki Inu";
    string private _symbol = "ROSYFLOKI";
    ...
    uint256 public _maxWallet = 15000000 * 10**9; //1.5% of TS
    uint256 public _maxTxAmount = 2500000 * 10**9; //0.25% of TS
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _developerAddress = 0xd727508A5F6bB5EEFfe98642e303D6d27Ae1F60d;
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Rosy Floki Inu: cannot burn from zero address");
    require(_balances[account] >= amount, "Rosy Floki Inu: Cannot burn more than the account owns");
