...
/*
    ...
    Contract Name: TresLechesLPStaking
...
contract TresLechesCakeLPStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() {
        token = IBEP20(0x97B846DB4E521A07185d3da4408a12897316b618); //3LechesCake Contract
        lpToken = IBEP20(0x03587BbfAcb5d68b2c6A1E5049587E59CE900E84); //3LechesCake Liquidity Pool
