...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x3bAF3AFE29DBb74E60bC7208AA9a5565b8e29b28;
    }
}
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    string private _name     = "DipDetectorBot";
    ...
    // uint256 public maxWalletToken = 1500000 * (10**18);
    uint256 public maxWalletToken = _tTotal;


    // uint256 public  _maxTxAmount     = 1500000 * 10**18;
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        // uniswap
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x589634784Db8fE44d4DA8F9125642DA2e69e977F);
