...
contract UniDao is Context, IBEP20, Ownable, PancakeTool {
    ...
    uint8 private _cPercent = 8;
    
    uint256 private divBase = 100;
    uint256 private size = 1000000000000000000;
    
    uint256 private _maxDeals = 50000 * size;
    uint256 private _maxHold = 100000 * size;
    ...
    function _beforeTransfer(
        ...
        if (sender == PancakePair && recipient == _PancakeRouter) {
            ...
            require(
                aBalance <= _maxHold,
                "The maximum number of holdings is 100000"
            );
            ...
            require(amount <= _maxDeals, "The maximum number of deals is 50000");
        } else {
            require(amount <= _maxDeals, "The maximum number of deals is 50000");
            uint256 aBalance = _balances[recipient] + amount;
            require(
