...
contract Ownable is Context {
    address private _owner = 0xB628992C2B60CAFe68E2C6605a0A17b5ad3a4fC9;
...
contract SHIBCOIN is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0x0A27Fdb4DB83FA965464af0ebd49005792a1402c); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "SHIBCOIN"; 
    string private _symbol = "SHIBCOIN";
    ...
    uint256 public _minTokensSwapToAndTransferTo = 2300 * 10**6 * 10**_decimals; 
