...
contract SUPERME is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x2F7F38D60B1FeffA1b16778E61f7c4C69C53c776); // Marketing Address

    address payable public teamAddress =
        payable(0x6fCF723CA68Ca6cA1921dceeb700Da17C950d084); // Team Address

    address payable public liquidityAddress =
        payable(0xB4285b8aC9F4308204C9Be9D9186cd9AA44c1CAA); // Liquidity Address
    ...
    string private constant _name = "SUPERME";
    string private constant _symbol = "SUPERME";
