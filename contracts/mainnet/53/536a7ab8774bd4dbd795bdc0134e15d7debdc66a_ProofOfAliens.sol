...
/**
STEALTH LAUNCH BY @LamaİnvestorClub 
TG: https://t.me/ProofOfAliens
TAX: 
BUY : 6%
SELL: 12%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc1a9Bde5d49bb38a4135E6B4296278f334a5a18c; // owner address
...
contract ProofOfAliens is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PROOF OF ALIENS";
    string private _symbol = "POA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc1a9Bde5d49bb38a4135E6B4296278f334a5a18c); // Marketing Address
    address payable public teamWalletAddress = payable(0xc1a9Bde5d49bb38a4135E6B4296278f334a5a18c); // Team Address
