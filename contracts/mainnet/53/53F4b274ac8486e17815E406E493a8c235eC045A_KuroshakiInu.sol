...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Ed2429fAa4dF22F98e5FB9d4ED4bB899CA65946; // owner address
...
contract KuroshakiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Kuroshaki Inu";
    string private _symbol = unicode"KURO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Ed2429fAa4dF22F98e5FB9d4ED4bB899CA65946); // Marketing Address
    address payable public teamWalletAddress = payable(0x0Ed2429fAa4dF22F98e5FB9d4ED4bB899CA65946); // Team Address
