...
contract APEPfarm {
    ...
    IToken public token_APEP;

    address erctoken = 0x594931E152c3094b087E4E1404271576FB93c53F;
    ...
    uint256 public MIN_INVEST_LIMIT = 1000 * 1e5; /** 1000 APEP  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 1000000 * 1e5; /** 1000000 APEP  **/
    ...
    function sellEggs() public{
        ...
        token_APEP.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_APEP.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_APEP.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_APEP.transfer(dev1, tax);
        token_APEP.transfer(dev2, tax);
        token_APEP.transfer(dev3, tax);
        token_APEP.transfer(dev4, tax);
        token_APEP.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_APEP.balanceOf(address(this));
	}
    ...
    function SET_WALLET_DEPOSIT_LIMIT(uint256 value) external {
        require(msg.sender == owner, "Admin use only");
        require(value >= 20);
        WALLET_DEPOSIT_LIMIT = value * 1e5;
    }
}