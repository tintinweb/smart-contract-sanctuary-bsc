...
TG: https://t.me/ShibaEternityOfficial
TAX: 
BUY : 10%  BUY TAX WILL BE 99% AT FIRST DONT BUY IT 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd8a8982dD8e710693cF648b70A4FFC478C0bf875; // owner address
...
contract ShibaEternityOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Eternity";
    string private _symbol = "Shiba Et";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x557B15D99467f4a88dF30A7ea42E0D41Ee3Bc6be); // Marketing Address
    address payable public teamWalletAddress = payable(0x557B15D99467f4a88dF30A7ea42E0D41Ee3Bc6be); // Team Address
