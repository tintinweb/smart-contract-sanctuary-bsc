...
// File: contracts/DogeDLuffy.sol

/**         
 *                          King of the Pirates and Doge enthusiast, meet Doge D. Luffy now.                
 *                          Join our journey at: https://t.me/DogeDLuffy
 *         
 * 
 *
                                                    ╭━━━╮╱╱╱╱╱╱╱╱╱╭━━━╮╱╭╮╱╱╱╱╱╱╭━╮╭━╮
...
contract DogeDLuffy is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500_000 * 10**_decimals;     // 0.05% of total supply
    uint256 public maxTxAmount = 5_000_000 * 10**_decimals;          // 0.5% of total supply
    uint256 public maxWalletAmount = 15_000_000 * 10**_decimals;     // 1.5% of total supply

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x05bDB9e6510A2233c7b9b6AAF155A84290753d34;

    string private constant _name = "Doge D. Luffy";
    string private constant _symbol = "DogeLuffy";
    ...
    Taxes public taxes = Taxes(2,8,1,1);
    ...
    address private teamWallet = 0x03f2Aa5479F84f80780f93044DE795dB95b4f21a;
    ...
    // Owner cannot transfer out DogeLuffy from this smart contract
    function rescueAnyCRC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
