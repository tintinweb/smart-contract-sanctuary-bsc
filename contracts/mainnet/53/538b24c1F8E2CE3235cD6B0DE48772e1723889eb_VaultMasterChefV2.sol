...
// File: contracts_BSC/main/VaultMasterChefV2.sol
...
contract VaultMasterChefV2 is Ownable {
    address public safeHouse;
    IMasterChefV2 public masterChefV2;
    Admin public admin;
    constructor (address _admin, address _safeHouse, address _masterChefV2)  {
    ...
    function stake(
        ...
        masterChefV2.deposit(_pid, amount);
    }
