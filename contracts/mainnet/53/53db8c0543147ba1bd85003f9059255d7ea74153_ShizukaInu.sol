...
Welcome to ShizukaInu 🙌

ShizukaInu is Meme Fan token, Strong community with Hype name and huge marketing, Next gems on BSC
...
contract ShizukaInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x555DfFe841B043A8260Fa6C696eF6DDF52a7683B);
    ...
    */
    ...
    string private _name = "ShizukaInu"; 
    string private _symbol = " $ShizukaInu";  
