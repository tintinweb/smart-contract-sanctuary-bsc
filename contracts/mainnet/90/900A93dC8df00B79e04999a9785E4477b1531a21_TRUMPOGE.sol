...
/**
   ...
   The early you enter the group, the more you will gain.
   
   As a community token, every holder should promote it! 
   If you want to pump your investment, you need to do some effort!
   
   Telegram: https://t.me/trumpoge
...
contract TRUMPOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x18B0C35bcd8C852f289e15B698C0c99A2bEEF9e7); // Marketing Address
