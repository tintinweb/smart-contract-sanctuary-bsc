...
contract DAWAE is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    uint256 constant reflectionFee = 30;  
    ...
    constructor () {
        ...
        _maxWalletSize = _totalSupply / 200; // 0.5%

        smallSwapThreshold  = _totalSupply.mul(373593726).div(100000000000);
    ...
    function changeMaxWallet(uint256 percent, uint256 denominator) external {
