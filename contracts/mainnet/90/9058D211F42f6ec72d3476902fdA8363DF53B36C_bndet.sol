...
contract bndet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "bndet token";
    string private _symbol = "bndet";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7800E18b97dA19F8926d0AE2D93ec8F9Bb290d16));
        marketingWalletAddress = payable(address(0x0d74c0CdfaAEb1768fC5E60978141315B832E34B));
