...
contract MyCheemsDogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MyCheemsDoge Inu";
    string private _symbol = "MCDINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26423816087A2Ef4e0583334d9Cb6BA3259BBF40); 
    address payable public buyBackWalletAddress = payable(0x26423816087A2Ef4e0583334d9Cb6BA3259BBF40); 
