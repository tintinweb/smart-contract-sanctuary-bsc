...
*/
 /** 🏳️‍🌈🐕 Pridoge 🐕🏳️‍🌈
    ...
    🏳️‍🌈🐕 Pride Month+ DOGE 🐕🏳️‍🌈

    It’s 2022 EVERYBODY must be accepted. There is already enough crime and hate in this world. 
    We need to make it a better place where everybody can feel accepted. 
    That is why Pride Month + DOGE was created, a place you can feel accepted and not judged. 

    Verified Contract✔️
    Liquidity Locked✔️

    https://t.me/PridogePortal
------------------------------------------------------
    💠Tokenomics💠

    Total Supply: 10,000,000,000,000 $PRIDOGE
    50% will be burnt
    Max wallet : %4 
    Slippage: 5%
    1% to Liquidity pool
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD REWARDS 
...
contract PRIDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x45A78AcBE3c031872d2f2BF3F33c23cC18adc4c0;
 
    string constant _name = "PRIDOGE";
    string constant _symbol = "$PRIDOGE";
