...
contract USDT_PiggyBank_v1 {
    ...
    constructor() public{
	  deployer = msg.sender;
        ...
        mktngWallet=address(0xAB25d21f6dC243205C3Cc443cEE2633d92eA6b18);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(usdt).transfer(devWallet, fee2);
        ERC20(usdt).transfer(mktngWallet, fee-fee2);
