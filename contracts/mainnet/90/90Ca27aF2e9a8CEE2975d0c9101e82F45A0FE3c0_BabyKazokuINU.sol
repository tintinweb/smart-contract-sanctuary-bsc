...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x619824E5251363EB8AB46b3A2AFe262ABC8A1217; // owner address
...
contract BabyKazokuINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyKazokuINU";
    string private _symbol = "BBKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb73C8e7b0c8a7f91fC69315F3585BB10fc95b191); // Marketing Address
    address payable public teamWalletAddress = payable(0xb73C8e7b0c8a7f91fC69315F3585BB10fc95b191); // Team Address
