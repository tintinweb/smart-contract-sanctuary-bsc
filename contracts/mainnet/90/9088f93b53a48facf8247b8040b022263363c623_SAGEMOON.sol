...
contract SAGEMOON is Context, IERC20, Ownable {
    ...
    string private _name = "SageMoon";
    string private _symbol = "SAGEMOON";
    ...
    address payable public marketingWallet = payable(0xB549a5237cba2488fdf6F359069A0D3102e7C15e);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 15, "tax too high");
        _taxFee = taxFee;
