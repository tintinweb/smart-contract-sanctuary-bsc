...
contract GRIMACEKAYNEWEST is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Grimace for Kayne West";
    string constant _symbol = "GRIMACEKAYNEWEST";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x476EE462Ee0BeeD9950F66DB1C3Cb1a710341f4f;
