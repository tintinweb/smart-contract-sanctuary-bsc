...
contract CandyToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public virtual initializer {
        ...
        //
		__Ownable_init();
        __ERC20_init("CANDYTOKEN", "CANDY");
        _ecosystemWalletAddress = address(0x524BA6f7189B384304ac6A7a8793A0A0AA87919a);
        _devWalletAddress = address(0x524BA6f7189B384304ac6A7a8793A0A0AA87919a);
        ...
        //feeTargetTokenAddress = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD test
        //liquidityTokenAddress = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD test
    ...
    function swapAndLiquify(uint256 tokens) private {
       // split the contract balance into halves
        ...
        uint256 initialBalance = IERC20Upgradeable(liquidityTokenAddress).balanceOf(address(this));
        ...
        uint256 newBalance = IERC20Upgradeable(liquidityTokenAddress).balanceOf(address(this)).sub(initialBalance);
