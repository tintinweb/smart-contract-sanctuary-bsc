...
*TELEGRAM: https://t.me/SeraphoftheEndBSC
*/
...
contract VampireReign is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Seraph Of The End ";
    string private _symbol = " Vampire Reign "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x942f18A28F0c0e8145421aaDD730EA282D60d099);
    address payable public teamWalletAddress = payable(0x53DEA0241e95A4eFB2AbF8Fe3b3d1E9D667cbC43); 
    ...
    uint256 private minimumTokensBeforeSwap = 231 * 10**_decimals;
