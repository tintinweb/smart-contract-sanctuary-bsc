...
//** Hello the Great Pomeranian Community! We are a great community and reached out to 20 million market caps before.
//* Sadly, dev and the admins werent so efficient and they left the project. But as we are a huge community, we said
//** we cant let it end like this. Couple of experts in their area came together to launch this token in order to rebuild
//** the Great Pomeranian Community! This will be the most stealth launch ever on BSC. No TG, no Twitter, no Calls
//** only the smart people who follow the MoonArch and see the revive of this amazing community will benefit as early
//** holders. Lets get the show going. After certain points regarding the marketcap everything will come in line.
//** Contract and the team safu and will be delivering you, your dreams. Anti bot and anti whale contract.
//** Max tx and max wallet will be set to prevent whales damaging our rebirth. SEE YOU AT THE MOON!!!
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner =0x9b2ABf6256B26d44634E251Fb6c75e5A0d6a6177 ;
...
contract PomeranianVerse is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x9b2ABf6256B26d44634E251Fb6c75e5A0d6a6177;
    ...
    string private _name = "PomeranianVerse";
