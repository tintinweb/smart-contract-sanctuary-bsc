...
library Address{
 ...
 contract GAYAPE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 666_666 * 10**9;
    ...
    address public marketingWallet = 0xf83e47b6a52a90E1FD49D3D06EfB6370E6a7d4fe;
    address public donationWallet = 0xf83e47b6a52a90E1FD49D3D06EfB6370E6a7d4fe;

    string private constant _name = "Gay Ape";
    string private constant _symbol = "GAYAPE";
    ...
    Taxes public taxes = Taxes(1, 2, 1, 0);
    Taxes public sellTaxes = Taxes(1, 2, 5, 0);
