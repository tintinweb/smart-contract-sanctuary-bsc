...
/** 
 *  SourceUnit: d:\Direct Projects\Atompad\Backend\atompad-V2\presale\contracts\PresaleInternal.sol
*/
...
contract PresaleBase is PresaleStorage, Ownable, Pausable, ReentrancyGuard {
        ...
        )
    {
        ...
        uint256 _released = (claims[_user].reserved * _free) / (100 * (10**18));
...
////import {PresaleBase} from "./PresaleBase.sol";
