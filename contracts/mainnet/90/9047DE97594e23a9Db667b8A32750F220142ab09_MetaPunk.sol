...
contract MetaPunk is Ownable, ERC721Enumerable {
    ...
    constructor(address _marketingWallet) ERC721("Meta Punk", "MPNFT") {
    ...
    function mint(uint256 count) public payable isMintable(count) {
        require(msg.value >= MINT_PRICE.mul(count), "Ether value sent is lower than expected");
        for (uint256 index = 0; index < count; index++) {
