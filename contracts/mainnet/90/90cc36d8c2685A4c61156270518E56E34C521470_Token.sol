...
contract  Token is IERC20, Ownable {
    ...
    uint256 public startPublicTradeBlock;
    ...
    function _transfer(
        ...
        if(startPublicTradeBlock == 0 && _swapPairList[from]){
    ...
    function startTrade() external onlyOwner {
        require(0 == startPublicTradeBlock, "trading");
        startPublicTradeBlock = block.number;
    }


    function closeTrade() external onlyOwner {
        startPublicTradeBlock = 0;
    }
