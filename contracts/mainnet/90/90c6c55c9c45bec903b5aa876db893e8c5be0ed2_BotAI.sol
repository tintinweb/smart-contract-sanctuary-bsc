...
contract BotAI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x80d1EC5Ba00b80Df75B1a224092AF5daAc1e5940); 
    address payable private Wallet_Dev = payable(0x637b6C5Cd3aF115F6a8D4e8abEe393d258660238);
    ...
    constructor () {
        ...
        _owner = 0x637b6C5Cd3aF115F6a8D4e8abEe393d258660238;
