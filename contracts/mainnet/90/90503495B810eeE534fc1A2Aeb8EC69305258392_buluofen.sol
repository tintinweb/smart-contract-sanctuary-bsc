...
contract buluofen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"布洛芬";
    string private _symbol = unicode"布洛芬";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd3ff1Fb8De2291bE01fc63781489E395569CA66d);
    address payable public teamWalletAddress = payable(0xdb2934166bcca0Dea34bFEC1a173E2439Ade5E18);
    ...
    uint256 private _totalSupply =  600 * 10**_decimals;
