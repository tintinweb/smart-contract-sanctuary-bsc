...
Later reduced to 5% Tax

TG: https://t.me/AngelDogePortal
*/
...
contract AngelDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Angel Doge";
    ...
    uint256 public swapThreshold = _totalSupply * 35 / 10000; // 0.35
    bool inSwap;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x966ABbdce78Cd82d26eA80504b9e480B581976c4;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require (totalFee <= 2000 && feeDenominator <= 10000);
    }
