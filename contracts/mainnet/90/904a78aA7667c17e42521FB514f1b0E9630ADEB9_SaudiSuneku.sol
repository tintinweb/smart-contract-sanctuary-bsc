...
contract SaudiSuneku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Saudi Suneku BSC";
    string private constant _symbol = "SaudiSuneku";
