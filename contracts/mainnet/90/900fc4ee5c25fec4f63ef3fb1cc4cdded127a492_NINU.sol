...
pragma solidity ^0.6.12;
    ...
    contract NINU is Context, IERC20, Ownable {
        ...
        address payable public TrustFloki_Marketing_Wallet;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x464b494DCeBb50Fe83abb3198F3EeE8d16E27f69, 'We can not exclude Uniswap router.');
