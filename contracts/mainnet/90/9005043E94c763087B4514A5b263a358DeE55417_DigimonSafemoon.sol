...
//Telegram : https://t.me/DigimonSafemoon
...
contract DigimonSafemoon is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Digimon Safemoon";
    string constant _symbol = "DGS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 13) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *13) / 100; 
