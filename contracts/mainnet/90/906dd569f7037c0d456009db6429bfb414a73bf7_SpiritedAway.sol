...
contract SpiritedAway is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'SpiritedAway';
  string private constant _symbol = 'SpiritedAway';
