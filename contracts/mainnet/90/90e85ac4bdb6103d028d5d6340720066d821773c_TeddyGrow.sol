...
contract TeddyGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeddyGrow";
    string private _symbol = "TDG";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x785AF2f9B4f2AE02DBA597965403449910506087); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x785AF2f9B4f2AE02DBA597965403449910506087); // BuyBack Address
