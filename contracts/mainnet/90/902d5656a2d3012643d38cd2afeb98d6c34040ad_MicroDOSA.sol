...
contract MicroDOSA is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "Micro DOSA";
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
