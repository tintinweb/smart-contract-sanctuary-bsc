...
contract SosharuNetworks is IERC20 {
    ...
    uint256 constant private startingSupply = 300_000_000_000;
    string constant private _name = "Sosharu Networks";
    string constant private _symbol = "SNS";
    ...
    address public treasuryWallet = payable(0xAe66D754f42bc5b283FEeFd5a397D572E2AfdCDC);
...
//===============================================================================================================
    ...
    function setTaxes(uint16 sellFee, uint16 transferFee) external onlyOwner {
        ...
        require(sellFee <= maxSellTaxes, "Cannot exceed roundtrip maximum.");
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 treasury, uint16 burn, uint16 buyback) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.treasury = treasury;
        _ratios.burn = burn;
        _ratios.buyback = buyback;
        _ratios.totalSwap = liquidity + treasury + buyback;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.treasury > 0) {
            (success,) = treasuryWallet.call{value: marketingBalance, gas: 35000}("");
        }
    }
