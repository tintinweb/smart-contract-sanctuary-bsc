...
Shiba is pumping and we want to support that by giving out SHIBA INU rewards!
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
/* Token contract */
contract LunaGirl is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x156ab3346823B651294766e23e6Cf87254d68962; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x053Ca6805CB155a60457d21B38fe193a970019A4;
    ...
    // Name and symbol
    string constant _name = "LunaGirl";
    string constant _symbol = "LunaGirl";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 2% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 2% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x17aC77deB3Dd8Da98375a82c8B615D2fec6717F0;
