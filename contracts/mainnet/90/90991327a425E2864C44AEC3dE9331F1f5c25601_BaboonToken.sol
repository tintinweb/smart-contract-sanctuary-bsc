...
//
//     ___         ___      .-.        .-.   \\\  ///(o)__(o)  .-.           _ wWw \\\  /// 
//    (___)__ /)  (___)__ c(O_O)c    c(O_O)c ((O)(O))(__  __)c(O_O)c  (OO) .' )(O)_((O)(O)) 
//    (O)(O)(o)(O)(O)(O) ,'.---.`,  ,'.---.`, | \ ||   (  ) ,'.---.`,  ||_/ .' / __)| \ ||  
//    /  _\  //\\ /  _\ / /|_|_|\ \/ /|_|_|\ \||\\||    )( / /|_|_|\ \ |   /  / (   ||\\||  
//    | |_))|(__)|| |_))| \_____/ || \_____/ ||| \ |   (  )| \_____/ | ||\ \ (  _)  || \ |  
//    | |_))/,-. || |_))'. `---' .`'. `---' .`||  ||    )/ '. `---' .`(/\)\ `.\ \_  ||  ||  
//    (.'-'-'   ''(.'-'   `-...-'    `-...-' (_/  \_)  (  )  `-...-'       `._)\__)(_/  \_) 
//
//
//                       Telegram Group: https://t.me/BaboonToken
...
contract BaboonToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BaboonToken";
    string constant _symbol = "Baboon";
    ...
    uint256 public swapThreshold = _totalSupply * 55 / 10000; // 0.15% of supply
    bool inSwap;
    ...
    function ManualBuyback(address holder) external authorized{
