...
contract GoldenMoonSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldenMoonSquid"; 
    string private constant _symbol = "$GOMU"; 
