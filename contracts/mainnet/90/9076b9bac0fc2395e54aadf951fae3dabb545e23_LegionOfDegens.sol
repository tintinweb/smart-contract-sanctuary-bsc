 ...
 * Main Token Contract
 */
contract LegionOfDegens is IERC20Metadata, Ownable {
    ...
    string constant _name = "Legion of Degens v2";
    ...
    address public nftRcvr;
    address public lotteryRcvr;
    ...
    function swapBack() internal swapping {
        ...
        try pcsRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            payable(address(nftRcvr)).transfer(amountBNBNFT);
            payable(address(lotteryRcvr)).transfer(amountBNBLottery);
    ...
    function setNFTReceiver(address nftRcvr_) external onlyOwner {
        nftRcvr = nftRcvr_;
    }

    function setLotteryReceiver(address lotteryRcvr_) external onlyOwner {
        lotteryRcvr = lotteryRcvr_;
    }
