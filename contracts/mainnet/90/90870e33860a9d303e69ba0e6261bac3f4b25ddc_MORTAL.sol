...
contract MORTAL is Context, IERC20 { 
    ...
    address payable private DevAddress = payable(0xA9a10CDA1430fee575936298B271E0C2c2DBEEd6);
    address payable private MarketingAddress = payable(0x10f478d119980C18018dc680753f251320f2Fa52);
    address payable private constant Wallet_Buyback = payable(0xbF8f73B758a321f8Df7829ceC2D471A5637988A0); 
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        if (to != owner() && to != MarketingAddress && to != DevAddress && to != address(this) && to != uniswapV2Pair && to != Wallet_Buyback && from != owner()){
