...
contract WAPO is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x256680047626224523A4e30737995f4b5eA802d6;
    address public devAddress = 0x89c0893c06CEf4243956Ea951D2DF7708024A808;

    string private constant _name = "WAPO";
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out WAPO!");
