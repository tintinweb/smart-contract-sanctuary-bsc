...
contract AIBUSD is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI BUSD";
    string private constant _symbol = "$AIB";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xaba31E30EF0162233f81EE14Db03F9fA38326a8A);
    address payable private _marketingAddress = payable(0xaba31E30EF0162233f81EE14Db03F9fA38326a8A);
