...
contract GrowChart is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrowChart";
    string private _symbol = "GC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa18Fc084dF6919fB7161b3D24EBEe839f0F337a6); // Marketing Address
