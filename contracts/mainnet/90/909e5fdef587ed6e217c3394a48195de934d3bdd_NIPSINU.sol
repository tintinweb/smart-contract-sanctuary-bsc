...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xdA4dC369003CCcC4cA25F3331ae45c7429ed6b88;
...
contract NIPSINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "NIPS INU"; // 
    string private constant _symbol = "$Nips Inu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xdA4dC369003CCcC4cA25F3331ae45c7429ed6b88);
