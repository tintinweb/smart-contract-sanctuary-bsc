...
contract BasisGame is LPTokenWrapper {
	...
	constructor(address _lpBGMCBNB, address _TokenBGS) LPTokenWrapper(IERC20(_lpBGMCBNB)) public{
	    TokenBGS = IERC20(_TokenBGS);

        InitRewards = 12 * 10 ** 15;   //0.012BGS
        Interval = 3888000;   //45 days，3888000 seconds

        StartTime = 1656244920; /*2022-06-26 20:02:00*/
        StartWithdrawBGSTime = 1656255600; /*2022-06-26 23:00:00*/
