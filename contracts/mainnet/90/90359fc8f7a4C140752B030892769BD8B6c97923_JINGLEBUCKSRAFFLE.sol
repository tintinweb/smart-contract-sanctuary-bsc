...
contract JINGLEBUCKSRAFFLE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jingle Bucks Raffle";
    string private _symbol = "JBR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5de29516ec7D1C6571001EBf2860B381de4Bc87d); // Marketing Address
    address payable public devFee = payable(0x8CA9761f1f795758bb61338D6fE4741126897e05); // devFee
