...
The Wasser series are powerful and like flowing water can obliterate anything standing in their way.
Breeds
...
abstract contract Ownable is Context {
 ...
 contract WASSER is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public Token;
  IBEP20 public BUSD;
  ...
  uint256 public MinitngPricein_token=400;    // token
  uint256 public MinitngPricein_token1=100;    // token1
   uint256 public MinitngPrice_with_single=500;    // token1
   uint256 public MinitngPricein_bnb = 400;     // bnb 
   uint256 public MinitngPricein_busd = 400e18;     // busd
