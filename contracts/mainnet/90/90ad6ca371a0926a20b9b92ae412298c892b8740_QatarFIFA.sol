...
contract QatarFIFA is Context, IERC20, Ownable {
    ...
    string private _name = "QatarFIFA";
    string private _symbol = "QatarFIFA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x7D739705170beAC7cf0B4CD204D277c33dc17162
); // Marketing Address
    address payable public teamWalletAddress = payable(0x7D739705170beAC7cf0B4CD204D277c33dc17162
); // Team Address
