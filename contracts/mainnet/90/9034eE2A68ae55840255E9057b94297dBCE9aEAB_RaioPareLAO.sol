...
interface DAO {
    ...
    /**
     * @dev DAOs `amount` as the allowance of `spender` over the caller's tokens.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
     ...
     * condition is to first reduce the spender's allowance to 0 and DAO the
    ...
    /**
     * @dev Emitted when the allowance of a `spender` for an `owner` is DAO by
...
contract OwnableNFT is ContextNFT {
    ...
    /**
     * @dev Initializes the contract DAOting the deployer as the initial owner.
     */
    constructor () {
...
contract RaioPareLAO is ContextNFT, DAO, OwnableNFT {
    ...
    string private _name = 'Raio Pare LAO';
    string private _symbol = 'RPLAO';
