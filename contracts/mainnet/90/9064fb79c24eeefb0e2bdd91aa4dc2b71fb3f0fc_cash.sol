...
interface IUniswapV2Pair {
    ...
    function PERMIT_TYPECASH() external pure returns (bytes32);
...
contract cash is ERC20 {
	...
	address payable _fundAddress = payable(address(0x6D880Da169e9B9CF1C0528a8c81D437bc3Fea24A));
    ...
    constructor(address tokenOwner) ERC20("cash", "cash") {
