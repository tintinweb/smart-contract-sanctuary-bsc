...
contract KAGE is KAGEDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private KAGETeam;
    address private CharityKAGE;
    ...
    string public override name = "KAGE";
    string public override symbol = "KAGE";
    ...
    constructor(uint totalSupplyValue, address KAGETeamAddress, address CharityKAGEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        KAGETeam = KAGETeamAddress;
        CharityKAGE = CharityKAGEAddress;
       
        // split the tokens according to agreed upon percentages
        balances[KAGETeam] =  totalSupply * 4 / 100;
        balances[CharityKAGE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's KAGETeam pot
