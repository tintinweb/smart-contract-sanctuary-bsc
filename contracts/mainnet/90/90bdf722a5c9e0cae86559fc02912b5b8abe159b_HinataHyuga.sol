...
// Hinata Hyuga (日向 ヒナタ, Hyūga Hinata) is a fictional character in the anime and manga Naruto.
// Low tax 5/5
// t.me/HinataHyugaBSC
...
contract HinataHyuga is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hinata Hyuga";
    string constant _symbol = "HINATA";
