...
contract test  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x083F124409aBc5E5aca26b05516d3CDE6F119829); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x083F124409aBc5E5aca26b05516d3CDE6F119829); // Dev Address
    ...
    uint256 private _totalSupply = 1000000000000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 1000000000000 * 10**6 * 10**9; // 2% max tx
    uint256 public _walletMax = 1000000000000 * 10**6 * 10**9; // 2% max wallet
