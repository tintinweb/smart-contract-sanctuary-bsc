...
contract Kenoshiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kenoshiba";
    string private _symbol = "Kenoshiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3db86a088A0d82EEF8A1d85B5a182ccb15d7298D);
    address payable public BuyBackWalletAddress = payable(0x3db86a088A0d82EEF8A1d85B5a182ccb15d7298D);
