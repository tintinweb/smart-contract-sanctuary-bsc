...
/**
    Lucky Block Inu will you test your luck?
    telegram: @Luckyblockinu
*/
...
contract Luckyblockinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lucky Block Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "LBI";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x45aFE10AD09bf8d90D57474769e7B23d85b991B9;
        marketingFeeReceiver = 0xD36119B6d14ca2d4216B43ee2158f10d650E795d;
