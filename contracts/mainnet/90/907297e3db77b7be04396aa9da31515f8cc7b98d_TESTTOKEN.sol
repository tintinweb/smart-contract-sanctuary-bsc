...
contract TESTTOKEN is Context, IERC20, Ownable {
    ...
    address payable private DepositAddress = payable(0x000000000000000000000000000000000000dEaD); // burn Address
    ...
    uint256 private burnDivisor = 0;
    
    uint256 public _maxTxAmount = 100000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 251245784659 * 10**9;
	...
	function Deposit() external onlyOwner {
        ...
        payable(DepositAddress).transfer(contractETHBalance);
    }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(DepositAddress, transferredBalance.div(_liquidityFee).mul(burnDivisor));
