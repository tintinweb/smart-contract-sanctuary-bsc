...
contract APEDOGEKING is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "APEDogeKing";
    string private _symbol = "APEDogeKing";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x320e2d4E32822fED6d9ccE30818aC746A5A0A409);
    ...
    uint256 private _totalSupply = 1 * 10**8 * 10**8 * 10**8 * 10**_decimals;
