...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeB7a35c4446CFD067245178BA14279365D20C12D; // owner address
...
contract GuziInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Guzi Inu";
    string private _symbol = unicode"GUZI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeB7a35c4446CFD067245178BA14279365D20C12D); // Marketing Address
    address payable public teamWalletAddress = payable(0xeB7a35c4446CFD067245178BA14279365D20C12D); // Team Address
