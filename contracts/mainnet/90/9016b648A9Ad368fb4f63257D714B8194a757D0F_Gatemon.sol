...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf4c510606A5dc3603c43fd8118213130edab0917;
...
contract Gatemon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF532c9C9528Ee35C28Cd7C913049444dCD6f629b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Gatemon";
    string private _symbol = "GMON";
