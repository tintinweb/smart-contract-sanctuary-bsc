...
Santa is coming to Qatar !

A memecoin on BSC network.

We're planning stacking utility by the end of the week.

https://t.me/QatarXmas
https://twitter.com/QatarXmas
...
Fees:
10% buy - 2% liqudity, 8% marketing.
10% sell - 2% liqudity, 7% marketing, 1% team.

Previous project: Shibanaldo, most of people had good profits, but now we're aiming for a higher MC this time.
...
contract QatarXmas is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x4236b2f8d68D37a246D31501322D9acDbb396694);
    ...
    string private constant _name = "QatarXmas";
    string private constant _symbol = unicode"QatarXmas";
    ...
    constructor() {
        _owner = 0x4236b2f8d68D37a246D31501322D9acDbb396694;
