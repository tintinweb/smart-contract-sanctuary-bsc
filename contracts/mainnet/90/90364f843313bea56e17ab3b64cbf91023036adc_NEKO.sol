...
Join our TG -> https://t.me/NekoKillerOfficial
*/
...
contract NEKO is Context, IBEP20, Ownable {
    ...
    function setFees_L(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _lpFeeBuy = lpFee;
    }

    function setFees_M(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _lpFeeSell = lpFee;
    }
