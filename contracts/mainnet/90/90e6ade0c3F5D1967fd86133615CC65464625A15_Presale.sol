...
contract Presale is ReentrancyGuard, BotProtector {
  ...
  constructor(address _presaleGenerator) {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0xEe7A06b16805c95d0c1ceA20Ad13133fD6A6f47e);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x1877FC4f3d50AcdB72a62c09E5B6008E77AC72F8);
