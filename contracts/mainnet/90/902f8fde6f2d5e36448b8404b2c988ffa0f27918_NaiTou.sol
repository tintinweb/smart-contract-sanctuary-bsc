...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256[5] public sellFundFeeLevel = [1000, 900, 800, 500];
    ...
    constructor (
        ...
        swapPair = swapFactory.createPair(address(this), WBNBAddress);
        _mainPair = swapPair;
        ...
        address ReceiveAddress = 0xc593092b81a346ef0858e420A0e6B0F8C37dacaC;
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        uint256 bal = IERC20(WBNBAddress).balanceOf(swapPair);
        if (bal <= 10 * 10**18) {
            return 0;
        } else if (bal <= 20 * 10**18) {
            return 1;
        } else if (bal <= 35 * 10**18) {
            return 2;
        }
        return 3;
    }
    ...
    function _transfer(
        ...
        if(!_isExcludeFromFee[from] && !_isExcludeFromFee[to] && airdropEnable){
            ...
            _sellFundFee = sellFundFeeLevel[healthLevel];
...
contract NaiTou is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000000,
        address(0xc593092b81a346ef0858e420A0e6B0F8C37dacaC)
    ){
    }
}