...
pragma solidity ^0.8.4;
contract JEETSISLAND is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'JEETS ISLAND';
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            require(_balances[recipient]
            +amount<=InitialSupply/100);
