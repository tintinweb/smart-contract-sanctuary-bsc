...
contract BURNTEST2 is IERC20 {
    ...
    string constant private _name = "BURNTEST2";
    string constant private _symbol = "BURNTEST2";
    ...
    address payable public marketingWallet = payable(0xeDc0FB033B53eDc76fb5B0bFA7910B4C9f281Edd);
    ...
    constructor () payable {
        ...
        BUSDPair = IFactoryV2(dexRouter.factory()).createPair(BUSD, address(this));
        lpPairs[lpPair] = true;
