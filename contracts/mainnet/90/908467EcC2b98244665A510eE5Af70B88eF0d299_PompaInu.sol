...
// ETH PLAY ALL THE WAY : https://t.me/PompaInu
...
contract PompaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5926340991F802a9442f7E168c37e5810764b2E5); 
    address payable public Wallet_Buyback = payable(0x5926340991F802a9442f7E168c37e5810764b2E5);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x5926340991F802a9442f7E168c37e5810764b2E5); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;
    string private constant _name = "Pompa Inu ETH"; 
    ...
    constructor () {
        ...
        _owner = 0x5926340991F802a9442f7E168c37e5810764b2E5;
