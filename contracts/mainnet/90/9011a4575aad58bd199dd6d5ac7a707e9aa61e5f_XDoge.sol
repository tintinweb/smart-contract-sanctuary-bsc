...
contract XDoge is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    uint256 public totalFee        = marketingFee + rewardFee + liquidityFee + utilityFee + burnFee + devFee;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xdd069Aa0a73015C4C72a6a00f8f19cbBF883a103;
    ...
    function updateAB7 (uint256 _AB7) public onlyOwner {
               AB7 = _AB7 * 1 gwei; 
    ...
    function setIsTxLimitExempt(address[] calldata addresses, bool status) public onlyOwner {
        ...
        function preparePresale(address holder, bool exempt) external onlyOwner {
        isFeeExempt[holder] = exempt;
        isTxLimitExempt[holder] = exempt;
    }

    function setCooldownExempt(address holder, bool exempt) public onlyOwner {
        isTimelockExempt[holder] = exempt;
    }

    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _utilityFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _rewardFee + _marketingFee + _utilityFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/3, "Fees cannot be more than 33%");
    }

    function setTaxReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _utilityFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
    ...
    function setSwapThreshold(bool _enabled, uint256 _amount) public onlyOwner {
    ...
    function setDistributionPeriod(uint256 _minPeriod, uint256 _minDistribution) public onlyOwner {
