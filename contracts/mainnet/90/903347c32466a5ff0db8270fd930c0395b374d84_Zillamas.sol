...
contract Zillamas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Zillamas  ";
    string private _symbol = " ZMAS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7312ee06adD88c763CC5a7b6C2AB8D81C5933EcD); 
    address payable public teamWalletAddress = payable(0x7312ee06adD88c763CC5a7b6C2AB8D81C5933EcD); 
