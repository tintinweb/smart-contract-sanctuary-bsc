...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
...
/* Token contract */
contract GOLDRONININU is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x27fa84161a3022915991c20B4eccAF329558b535;
    ...
    // Name and symbol
    string constant _name = "GOLD RONIN INU";
    string constant _symbol = "GOLDRONININU";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x033B6832e03434f108eA24b47Bf81547F56B729A;
