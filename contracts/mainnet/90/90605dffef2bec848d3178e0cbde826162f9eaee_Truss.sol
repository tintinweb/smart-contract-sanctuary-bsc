...
contract Truss is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Elizabeth Truss";
    string private _symbol = "Truss";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb99f4Af923826Eae1c0964D5ddBFc8d5F3f2d7cf);
    address payable public liqWalletAddress = payable(0xb99f4Af923826Eae1c0964D5ddBFc8d5F3f2d7cf);
