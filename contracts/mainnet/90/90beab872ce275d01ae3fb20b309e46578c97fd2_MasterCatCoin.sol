...
contract MasterCatCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Master Cat Coin";
    string private _symbol = "$MasterCat";
    ...
    address payable public marketingWalletAddress = payable(0x4eb0Dd84be2687Ca1BBB4976366571aa2E051B25); 
