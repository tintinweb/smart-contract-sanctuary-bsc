...
// Telegram: https://t.me/ClassicBullDoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x87c19460d12F86eaB00aF421C311bDB5de03B0E1; // owner address
...
contract CLASSICBULLDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Classic BullDoge";
    string private _symbol = "BDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87c19460d12F86eaB00aF421C311bDB5de03B0E1);
    address payable public teamWalletAddress = payable(0x87c19460d12F86eaB00aF421C311bDB5de03B0E1); 
