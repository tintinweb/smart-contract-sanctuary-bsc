...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c114B9246522772e06341D47e9d177e4ef2EFC8; // owner address
...
contract UkiyaTuzi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ukiyo Tuzi";
    string private _symbol = "UkiyoT";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x62600A2fcE7FcCEA69a2ee6D76F4bf684888C938); 
    address payable public teamWalletAddress = payable(0x62600A2fcE7FcCEA69a2ee6D76F4bf684888C938);
