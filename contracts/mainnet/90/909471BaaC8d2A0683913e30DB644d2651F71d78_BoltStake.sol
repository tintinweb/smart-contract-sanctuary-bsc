...
contract BoltStake is Context, Ownable, IERC20 {
    ...
    address private partner1 = 0x03280C44E6e3DbBDa12Ea9FDe00A8f55b5C45009;
    address private partner2 = 0x62Cc607855B4689862c754F8653AF31D76A8fB84;

	uint private startTime = 1666281600; // Tuesday, November 15
    ...
    function Invest(address _upline, uint256 amount) external {
        ...
        require(amount >= 50 ether, "Minimum Buy is 50 USDT!");
