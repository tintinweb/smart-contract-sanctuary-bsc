...
pragma solidity ^0.6.12;
    ...
    contract PAOLOBITTA is Context, IERC20, Ownable {
        ...
        string private _name = 'Paolo Bitta';
        string private _symbol = 'ポール';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x1B58646139016CbF103773Dc4099b75D818586D4, 'We can not exclude Uniswap router.');
