...
contract RabbitGrandFather is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QANX2.0";
    string private _symbol = "QANX2.0";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xA60DcE53224cEc1c3f89EA3F6c9C5be985c7D419); 
    address payable public BurnedWalletAddress = payable(0xA60DcE53224cEc1c3f89EA3F6c9C5be985c7D419); 
