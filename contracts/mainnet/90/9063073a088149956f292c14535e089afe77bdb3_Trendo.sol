...
contract Trendo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrendoID";
    string private _symbol = "TID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A1A085B809ea80299B8439a3249A67eb6DeC1a4);
    address payable public teamWalletAddress = payable(0x4A1A085B809ea80299B8439a3249A67eb6DeC1a4);
