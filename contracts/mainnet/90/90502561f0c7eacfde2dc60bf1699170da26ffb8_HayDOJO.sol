...
Make DOJO INU and Hay work as One.
✅ Low Marketcap Gem
❇️ NFA DYOR
...
🗺 Clear Roadmap
💯 SAFU
📄Contract Address : 0x90502561f0c7EAcFDe2dC60bF1699170Da26fFb8

charts: https://poocoin.app/tokens/0x90502561f0c7eacfde2dc60bf1699170da26ffb8

dex: https://www.dextools.io/app/en/bnb/pair-explorer/0x90502561f0c7eacfde2dc60bf1699170da26ffb8
...
contract HayDOJO is HayDOJODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HayDOJOTeam;
    address private CharityHayDOJO;
    ...
    string public override name = "HayDOJO";
    string public override symbol = "HAYDOJO";
    ...
    constructor(uint totalSupplyValue, address HayDOJOTeamAddress, address CharityHayDOJOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HayDOJOTeam = HayDOJOTeamAddress;
        CharityHayDOJO = CharityHayDOJOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HayDOJOTeam] =  totalSupply * 4 / 100;
        balances[CharityHayDOJO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HayDOJOTeam pot
