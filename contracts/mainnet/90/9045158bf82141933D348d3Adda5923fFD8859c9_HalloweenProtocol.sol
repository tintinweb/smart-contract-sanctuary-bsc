...
/**
Official Telegram : https://t.me/HalloweenProtocol

a solid community token in the binance smartchain network. we will make sure that the $HPRO will be the best token in the meme category.

Https://T.me/HalloweenProtocol  
...
contract HalloweenProtocol is ERC20, Auth {
    ...
    string constant private _name = "HALLOWEEN PROTOCOL";
    string constant private _symbol = "$HPRO";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1000_000* 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply * 100 / 100;
    uint256 public _maxWalletAmount = _totalSupply * 50 / 100;
    ...
    address private autoLiquidityReceiver = 0xB4C352Eb5d21c7345a8f51C15F96992E2f42033c ;
    address private MarketingFeeReceiver = 0xB4C352Eb5d21c7345a8f51C15F96992E2f42033c;
