...
contract Smart_Binary is Context {
    ...
    function Upload_Old_Users(
        ...
        require(Count_Last_Users <= 244, "The number of old users is over!");
    ...
    function Old_Users_Counter() public view returns (uint256) {
