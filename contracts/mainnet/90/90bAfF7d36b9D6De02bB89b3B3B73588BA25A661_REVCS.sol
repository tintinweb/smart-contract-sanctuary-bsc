...
contract REVCS is Context, IBEP20, Ownable {
  ...
  constructor() public {
    _name = "RENEWABLE ENERGY VEHICLE CHARGING STATION";
    _symbol = "REVCS";
    _decimals = 18;
    _totalSupply = 30000000000000000000000000000; // 30 billion.
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_isExcludedFromFee[sender] || _taxFee == 0){
      fee = 0;
      taxedValue = amount;
    } else {
  ...
  function setTaxFee(uint256 taxFee) external onlyOwner() {
      require(taxFee >= 0 && taxFee <= 9000, 'taxFee should be in 0 - 9000');
      _taxFee = taxFee;
  }
