...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc82de587B1bad63fAD8900F571ACD085303B5d71; // owner address
...
contract BotEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Bot Ecosystem";
    string private _symbol = unicode"BOTECO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc82de587B1bad63fAD8900F571ACD085303B5d71); // Marketing Address
    address payable public teamWalletAddress = payable(0xc82de587B1bad63fAD8900F571ACD085303B5d71); // Team Address
