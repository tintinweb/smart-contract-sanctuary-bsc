...
contract  Laeeb is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xb71AeB862a9Ed5aC25580d52dd496952BaC971d2;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 5 * 10**13 * 10**2;
   ...
   address  private own;
    ...
    constructor() public ERC20("Laeeb", "Laeeb",2) {
        ...
        _totalSupply = (1*10**16) * (10**2);
        _balances[owner()] = (1*10**16) * (10**2);
          emit Transfer(address(0), owner(), (1*10**16) * (10**2));
    }
