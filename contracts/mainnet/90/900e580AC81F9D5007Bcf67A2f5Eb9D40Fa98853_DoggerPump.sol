 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/DoggerPump
 * 
 * 
 * Dogger Pump token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract DoggerPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dogger Pump";
    string constant _symbol = "DOGGERPUMP";
