  ...
  UUPSUpgradeable
{
  ...
  mapping(address => mapping(string => uint256))
    public totalNFTsUserPurchasedPreSale;
  ...
  function initialize(
    ...
    __ERC721_init("HEADPHONE BOX", "THB");
  ...
  function setMaximumPreSaleLimit(uint256 _maximumPreSaleLimit)
    external
    onlyOwner
  {
  ...
  function resetTotalNFTsUserPurchasedPreSaleData(
    address _user,
    string calldata _preSaleId
  ) external onlyOwner {
  ...
  function batchTransfer(
    ...
    string calldata preSaleId
  ) public {
    require(
      totalNFTsUserPurchasedPreSale[to][preSaleId] + tokenIds.length <=
        MAXIMUM_PRESALE_LIMIT,
      "NFTs purchased excceed limit!"
    );
