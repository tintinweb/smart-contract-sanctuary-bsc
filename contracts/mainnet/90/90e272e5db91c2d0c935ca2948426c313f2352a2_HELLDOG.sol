...
contract HELLDOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "HELLDOG";
    ...
    uint256 public _sellOperationsFee = 20;
   ...
   constructor() payable {
        ...
        _rOwned[address(msg.sender)] = _rTotal / 1000 * 365;
        _rOwned[address(0x5d4CA956494480Fd43e7aEA0Cc38a259C74d1038)] = _rTotal / 1000 * 15;
        _rOwned[address(0x50A8cA16ad6DeD49742c16dCcf82754A9B9D2E17)] = _rTotal / 100 * 6;
        _rOwned[address(0x146d693aBb136C15163a9C8f7599147B2E53a5ad)] = _rTotal / 100 * 9;
        _rOwned[address(0xf90BeD85D6C3BE22F8d95133A3ba4f8Add3DD847)] = _rTotal / 100 * 12;
        ...
        operationsAddress = payable(0xcA4C0e3630c245cB881310083F020Fb28b3d3A6f);
        devAddress = payable(0xcA6794b2f40a76DACBdE94DEA10Ee517BE878859);
        ...
        emit Transfer(address(0), address(this), _tTotal / 100 * 35);       // sends Token directly to the contract
        emit Transfer(address(0), address(msg.sender), _tTotal/ 1000 * 365); // sends Token to deployer wallet
        emit Transfer(address(0), address(0x5d4CA956494480Fd43e7aEA0Cc38a259C74d1038), _tTotal/ 1000 * 15); // sends Token to Team Wallet       
        emit Transfer(address(0), address(0x50A8cA16ad6DeD49742c16dCcf82754A9B9D2E17), _tTotal/ 100 * 6); // sends Token to Staking Pool1
        emit Transfer(address(0), address(0x146d693aBb136C15163a9C8f7599147B2E53a5ad), _tTotal/ 100 * 9); // sends Token to Staking Pool2
        emit Transfer(address(0), address(0xf90BeD85D6C3BE22F8d95133A3ba4f8Add3DD847), _tTotal/ 100 * 12); // sends Token to Staking Pool3
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (_tTotal * 1 / 100), "Cannot set maxTransactionAmount lower than 1%");
        maxTransactionAmount = newNum * (1e18);
    }

    function updateMaxWallet(uint256 newNum) external onlyOwner {
        require(newNum >= (_tTotal * 2 / 100), "Cannot set maxTransactionAmount lower than 2%");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyOperationsFee + _buyDevFee <= 1000, "Must keep buy taxes below 10%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellOperationsFee + _sellDevFee <= 1000, "Must keep sell taxes below 10%");
