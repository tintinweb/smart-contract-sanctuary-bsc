...
contract DogeLaFi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeLaFi";
    string private _symbol = "DogeLaFi";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x496F1E344a4357f20b21c463dDaa6BaAb4233333); 
    address payable private teamWalletAddress = payable(0x496F1E344a4357f20b21c463dDaa6BaAb4233333); 
