...
/**
 *Telegram: @saintnickbsc
 *Twitter: @saintnickbsc
*/
...
library Address{
 ...
 contract SaintNick is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0x1d2Dd34BcAe18cc184788DD5bBA9044c49CFa0F1;
    address private donationWallet = 0x4b6519dc5c71c7Be4Ebb61EA54BD3F3339517e3b;
    address private buybackWallet = 0x1d2Dd34BcAe18cc184788DD5bBA9044c49CFa0F1;

    string private constant _name = "Saint Nick";
    ...
    Taxes private taxes = Taxes(0, 99, 0, 0, 0);
    Taxes private sellTaxes = Taxes(0, 99, 0, 0, 0);
