...
/*
📙Elon Twitter Web4.0📙 
💎Meme Token For Elon Musk Takeover Twitter 💎

🔸 Launch in BINANCE
 👨‍💻 Owner:     ***RENOUNCED***
 💧 Liquid:      35% in Pancakeswap 
 🔥Burn :        30% 
 
 💲 MCap:       $ 500  (WBNB: $404.38)
 💰 Liquidity: 0.25 WBNB
 🔒 LP Lock:    99.50% locked for 36 days  on Mudra
 🔖 Fee:            Buy: 4.96%  |  Sell: 3.91%
fees
✅12 % fees 
💎10% Rewards To Holders
✅Slippage 10

 🆔 Telegram: https://t.me/ElonTwitterWeb4 
...
contract Ownableweb is Contextweb {
    address private _owner;

    event OwnerwebpTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    constructor () {
        ...
        _owner = msgSender;
        emit OwnerwebpTransferred(address(0), msgSender);
    }
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownableweb: caller is not the owner");
        _;
    }

 
    function renounceOwnerwebp() public virtual onlyOwner {
        emit OwnerwebpTransferred(_owner, address(0));
        _owner = address(0);
    }

    /**
     * @dev Transfers ownerwebp of the contract to a new account (`newOwner`).
     * Can only be called by the current owner.
     */
    function transferOwnerwebp(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownableweb: new owner is the zero address");
        emit OwnerwebpTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract ElonTwitterweb is Contextweb, BinanceBNB, Ownableweb {
    ...
    string private _name = 'Elon Twitter web';
    string private _symbol = 'ETWEB4.0';
