...
contract LionInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC7b8ab0699bBe963ec8C39736288FE6ae85f55dA); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xC7b8ab0699bBe963ec8C39736288FE6ae85f55dA); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x45110EC5467107Aa445122679104096d9a6FE5D4); // charity Wallet Address
    address payable public devWalletAddress = payable(0x35AbA95dbd8C4ea21419D047459238761Fd7079c); // dev Wallet Address
    ...
    constructor () {
        address _owner = 0x35AbA95dbd8C4ea21419D047459238761Fd7079c;
