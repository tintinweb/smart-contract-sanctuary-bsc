...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x510DA434D9D36B470094178b8619B7CcDC876c93; // owner address
...
contract FOXIBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FOXI BSC";
    string private _symbol = "FOXB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x207c5f3A8a659983aCf2e1967658F1C9E2Cca702); // Marketing Address
    address payable public teamWalletAddress = payable(0x20f5111D19227cFBfb64D938116fa82BDB30027A); // Team Address
