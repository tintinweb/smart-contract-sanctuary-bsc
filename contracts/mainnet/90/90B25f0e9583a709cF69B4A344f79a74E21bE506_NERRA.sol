...
// ORIGINAL CODE NERRA CHAIN
// Telegram : https://t.me/NerraChain
// Web      : https://nerrachain.com
...
contract NERRA is Context, IBEP20, Ownable {
    ...
    string public _name = "Nerra Chain"; // token name
    string public _symbol = "NERRA"; // token ticker
    ...
    uint256 private minTokenToSwap = 10000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 100000000 * 1e9;
    uint256 private minBuyLimit = 100000000 * 1e9;
    ...
    uint256 public liquidityFeeOnSelling = 40;
    uint256 public marketWalletFeeOnSelling = 140;
