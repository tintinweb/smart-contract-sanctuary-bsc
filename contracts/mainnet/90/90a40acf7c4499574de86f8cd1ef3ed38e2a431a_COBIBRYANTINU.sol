...
contract COBIBRYANTINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "COBI BRYANT INU"; // Edit Name
    string constant _symbol = "COBI INU"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 2000000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public marketingFee    = 3; // Edit Marketing Fee
