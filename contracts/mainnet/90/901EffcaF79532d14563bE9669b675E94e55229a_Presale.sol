...
contract Presale is Initializable {
    ...
    mapping(address => bool) public boughtAndPaid;
    mapping(address => uint256) public contribution;
    uint256 public limitperwallet = 3e20;
    event WhitelistedAddressAdded(address addr);
    event WhitelistedAddressRemoved(address addr);

    function initialize(address busd_addr) public initializer {
        busd = IToken(busd_addr);
  ...
  function unpause() onlyowner public {
    ...
    function Buy(uint256 amount) public
    {
       ...
       busd.transferFrom(msg.sender,address(this), amount);
        ...
        uint256 contributionNow = contribution[msg.sender];
        contribution[msg.sender] = contributionNow + amount;
        boughtAndPaid[msg.sender] = true;
