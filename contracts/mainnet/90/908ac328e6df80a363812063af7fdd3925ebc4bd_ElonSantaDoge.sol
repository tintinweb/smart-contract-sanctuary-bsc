...
contract ElonSantaDoge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "Elon Santa Doge";
    string private constant _symbol = unicode"ESD";
    ...
    address payable public DevWallet = payable(0x2A63A116A596cD3268f4C12D4789068ac989eF96);
