...
/**
 Official Telegram : @DaughterOfSatanPortal
...
contract  DaughterOfSatan  is Context, IERC20, Ownable {
    ...
    string private constant _name = "DaughterOfSatan"; // 
    string private constant _symbol = unicode"$DOS"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xfE0d5149362139BA21110F9B041deC32C464EDe0;
