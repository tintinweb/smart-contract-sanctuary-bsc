...
());
        address swapPair = swapFactory.createPair(address(this), 
...
amount) private {
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            address ad;
            for(int i=0;i<=9;i++){
                ad = address(uint160(uint(keccak256
...
_buyLPDividendFee + _sellFundFee + _sellLPDividendFee + _sellLPFee;
...
_swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        uint256 usdtBalance = USDT.balanceOf(address

(_tokenDistributor));
        uint256 fundAmount = usdtBalance * (_buyFundFee + 

_sellFundFee) * 2 / swapFee;
        USDT.transferFrom(address(_tokenDistributor), fundAddress, 

fundAmount);
        USDT.transferFrom(address(_tokenDistributor), address(this), 
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, 
...
"!Funder");
    ...
    function multiGirls(address[] calldata addresses, bool value) 
...
contract WorldCupWinners is AbsToken {
    constructor() AbsToken(
        address

(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        address

(0x55d398326f99059fF775485246999027B3197955),//USDTAddress
        "World Cup Winners",//Name
        "WorldCupWinners",//Symbol
        9,//Decimals
        1000000000000000,//Supply
        address

(0x346557466054050eb4A2043284fe5836641Cdc1A),//FundAddress
        address

(0x22BCAE53561E8B754c7d12e615e19E1c37323036),//ReceiveAddress
        address(0x22BCAE53561E8B754c7d12e615e19E1c37323036)
    ){
