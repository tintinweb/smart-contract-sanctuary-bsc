...
contract KINASHIDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KINASHIDOGE"; 
    string private _symbol = "KASHIDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1FA092951aFBdeD97Ca4c8d6EcC3e1Dc32b0C537);
    address payable public teamWalletAddress = payable(0x1FA092951aFBdeD97Ca4c8d6EcC3e1Dc32b0C537);
