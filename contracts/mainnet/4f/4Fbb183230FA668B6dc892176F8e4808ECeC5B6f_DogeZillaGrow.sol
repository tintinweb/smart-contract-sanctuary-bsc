...
contract DogeZillaGrow is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DogeZilla Grow";
    string constant _symbol = "DOGEZILLAGROW";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; //DOGE REWARD
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3B406D28f0BA1EE184154C6bAad3C36f5dFc426e; 
