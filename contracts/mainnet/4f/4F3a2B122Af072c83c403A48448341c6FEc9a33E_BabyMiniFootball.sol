...
Telegram: https://t.me/BabyMiniFootballCrypto

Website: https://www.babymini.football
...
contract BabyMiniFootball is ERC20, Ownable {
    ...
    constructor() ERC20("BabyMiniFootball", "BabyMiniFootball") {
        MarketingWallet = payable(0xFfc61Dcb1B86144EBe1eb6adCf332F3080570Ab1);
        TeamWallet = payable(0x58AE304cbB21e85470FD9B294919dcbf0048488E);
...
contract BabyMiniFootballDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyMiniFootball public BabyMiniFootballContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyMiniFootballContract = BabyMiniFootball(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "BabyMiniFootball_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyMiniFootball contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyMiniFootballContract);

            uint256 prevBalance = BabyMiniFootballContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyMiniFootballContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyMiniFootballContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
