...
SHIBA TSUKA
THE SHIBA TSŪKA DRAGON IS COVETED BY THE KNOWING AND REVERED BY THE LESSER. 
IT INSTILLS FEAR AND TERROR IN THE HEARTS AND MINDS OF THOSE WHO QUESTION. 
SEAL YOUR FATE AND FORTUNE BY HARNESSING THE UNRIVALED POWER OF THE SHIBA TSŪKA DRAGON.

Telegram:   https://t.me/ShibaTsukaBSC
Website:    https://www.shibatsuka.com/

Stealth Launch: August 8, 2022 at 1:00am UTC
...
contract ShibaTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaTsuka"; //
    string private constant _symbol = "TSUKA"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 7;
    address private _marketingWallet = 0x531dFfD31C3C031Cc966a43451bdcD4948c60679;
