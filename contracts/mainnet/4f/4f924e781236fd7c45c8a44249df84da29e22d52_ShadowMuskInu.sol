...
contract ShadowMuskInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shadow Musk Inu";
    string private _symbol = "SMUSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01b43A6Ae3688471Af45BE9ee2380aE37199C060); 
    address payable public teamWalletAddress = payable(0x14Aea222B6c755d78576887a0fA1c3dCa6d9e6AE); 
    ...
    uint256 public _walletMax =  4000000000000 * 10**9; 
