...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0xAaf60cFC8E73f913874498B03e48ECBDEd34e467); // BEAR-BUSD LP
    uint256[] public tierAllocPoints = [1 ether, 0 ether, 0 ether];
    uint256[] public tierAmounts = [1 ether, 1 ether, 1 ether];
    struct User {
