...
/** MāoMine 猫
猫 BSC 网络上的社区代币，我们肯定会推动它，为这里的所有投资者带来快乐。希望您对我们以后的努力感到满意
https://t.me/MaoMineBNB
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f932d794Ec92d68DbAF444E6AD65aA5ffE6c588; // owner address
...
contract MaoMine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaoMine ";
    string private _symbol = "MAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f932d794Ec92d68DbAF444E6AD65aA5ffE6c588); // 
    address payable public teamWalletAddress = payable(0x2f932d794Ec92d68DbAF444E6AD65aA5ffE6c588); // 
