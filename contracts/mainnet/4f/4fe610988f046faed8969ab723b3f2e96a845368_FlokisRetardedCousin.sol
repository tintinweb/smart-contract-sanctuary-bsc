...
contract FlokisRetardedCousin is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "Flokis Retarded Cousin";
    string constant _symbol = "FLOKIsCOUSIN";
    ...
    uint256 public _maxSellTxAmount = (_totalSupply * 50) / 10000; // 1%
    ...
    uint256 private gasMaxLimit = 1800000; // gasLeft limit
