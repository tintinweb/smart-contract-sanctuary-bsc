...
contract Token is IERC20  {
    ...
    string  internal _name = "y3king";
    string  internal _symbol = "y3king";
    uint8   internal _decimals = 9;
    uint256 internal  _totalSupply = 100 * 10**6 * 10**_decimals;
    ...
    address public  marktingAddress = 0xB4D1E43BB2891EaC827218be1780e28182fe88B3;
    IUniswapV2Router02 public router;

    uint256 public launchBlock;
    uint256 public launchTimes;
    uint256 public numberOfSnipe;
    uint256 internal KBnum = 3;

    uint256 public minswapnum = 10000;
    uint256 public maxTXamount = 2 * 10**6 * 10**_decimals;
    uint256 public Fees = 8;
