...
library Address{
 ...
 contract Lunarabbit is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 50_000_000 * 10**9; // 0.2%
    ...
    address public marketingWallet = 0xD2Ff7F5f0b7014aDa5A7561d7CD05C053c2E8c06;
    address public donationWallet = 0xD2Ff7F5f0b7014aDa5A7561d7CD05C053c2E8c06;

    string private constant _name = "Lunarabbit";
