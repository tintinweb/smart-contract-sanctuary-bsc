...
contract moonpige is Context, IERC20, Ownable {
    ...
    string private constant _name = "Moon Pige"; // 
    string private constant _symbol = "Moon Pige"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xb0adBDA599a7D9c3e7d7433Aa1EA52EE7B9E7Cdc;
