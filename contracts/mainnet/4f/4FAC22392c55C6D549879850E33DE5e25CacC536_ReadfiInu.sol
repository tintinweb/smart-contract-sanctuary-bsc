...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb2e253aa8eCD30cCaCe4aC9775a868B63fBA9110;
...
contract ReadfiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Readfi Inu"; // 
    string private constant _symbol = "iRDF"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xb2e253aa8eCD30cCaCe4aC9775a868B63fBA9110);
