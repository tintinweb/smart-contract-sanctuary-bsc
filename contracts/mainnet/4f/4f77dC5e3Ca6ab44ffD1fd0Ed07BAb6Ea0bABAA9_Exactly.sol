...
contract Exactly is Context, IERC20, Ownable {
    ...
    string private _name = "Exactly";
    string private _symbol = "Exactly";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2D5d7fCAc4845fB669cbEB0f76De2F954F60fE8c);
    address payable public teamWalletAddress = payable(0x50A32138D90De624F1db2ae2960503006A11F524);
