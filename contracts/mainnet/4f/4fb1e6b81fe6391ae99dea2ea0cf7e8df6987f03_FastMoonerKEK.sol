...
contract FastMoonerKEK is IBEP20, Auth {
    ...
    string constant _name = "FastMoonerKEK";
    string constant _symbol = "FMK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 99) / 100;  //99% max tx
    uint256 public _maxWalletSize = (_totalSupply * 99) / 100;  //99% max wallet
    ...
    address private marketingFeeReceiver =0x7968b2118164d7575a2f244CE8F4d1853a22d589;
    address private teamFeeReceiver =0x7968b2118164d7575a2f244CE8F4d1853a22d589;
