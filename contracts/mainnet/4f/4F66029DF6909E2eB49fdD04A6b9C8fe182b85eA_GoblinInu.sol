...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x011BC11B116aacC73122c3B460ed9F24E4E7F2F7; // owner address
...
contract GoblinInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "GOBLINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x011BC11B116aacC73122c3B460ed9F24E4E7F2F7); // Marketing Address
    address payable public teamWalletAddress = payable(0x011BC11B116aacC73122c3B460ed9F24E4E7F2F7); // Team Address
