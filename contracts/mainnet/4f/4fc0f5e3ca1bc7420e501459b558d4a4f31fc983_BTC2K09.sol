...
contract BTC2K09 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BTC2K09DividendTracker public dividendTracker;
    ...
    constructor() ERC20("BTC2K09", "BTC29") {
        marketingWallet = payable(0x0535e8f04823CbE247dA94dCCdb54153B8aBD137); 
        ...
        dividendTracker = new BTC2K09DividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(totalBuyFees <= 15 && totalSellFees <= 15, "total fees cant exceed 15%");
...
contract BTC2K09DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BTC2K09 public BTC2K09Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        BTC2K09Contract = BTC2K09(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BTC2K09_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BTC2K09_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BTC2K09 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BTC2K09Contract);

            uint256 prevBalance = BTC2K09Contract.balanceOf(address(this));
            ...
            {
                uint256 received = BTC2K09Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BTC2K09Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
