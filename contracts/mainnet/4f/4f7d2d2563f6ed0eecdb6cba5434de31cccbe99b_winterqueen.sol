...
// Telegram : https://t.me/Winterqueenbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5fE3996B9E3edb14C90E60eb630BAdB9fe28796; // owner address
...
contract winterqueen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "winter queen";
    string private _symbol = "WQ";
