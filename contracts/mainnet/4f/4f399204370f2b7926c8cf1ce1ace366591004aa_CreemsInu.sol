...
contract CreemsInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Creems Inu";
    string private _symbol = "CI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD350ae19FFaE0440822a05909d688a52882D8ceF); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD350ae19FFaE0440822a05909d688a52882D8ceF); // BuyBack Address
