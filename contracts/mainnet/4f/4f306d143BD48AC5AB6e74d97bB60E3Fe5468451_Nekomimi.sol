...
/**
                ...
                猫耳トークンは、猫耳の特徴を備えた下品なキャラクター、
    黒岡（ハイスクールD×D）にインスパイアされたコミュニティベースのトークンです。
    経験豊富な開発者が提供する猫耳トークンを誇大広告のアニメトークンにしましょう
    
    TELEGRAM:   https://t.me/Nekomimi_BSC
    TWITTER:    https://twitter.com/NekomimiBSC
...
contract Nekomimi is Context, IERC20, Ownable {
    ...
    string private constant _name = " Nekomimi"; // 
    string private constant _symbol = "NEKO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xBd1D1Eb2939d53192A728FBDa2A330aB2974EF79;
