...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xd4669132eED0481C52Ff8617CD2672D98D936862); //$SQUIDMAS rewards Ho Ho Ho
...
contract Grinchmas is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Grinchmas";
    string constant _symbol = "GMAS";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xd4669132eED0481C52Ff8617CD2672D98D936862; //$SQUIDMAS reward Ho Ho Ho

    uint256 _totalSupply = 10000001* (10 ** _decimals); 
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xB9c4a9FfbDF69b99e9fD97D36ccD84Fb20A7F8ce;  
        anothermarketingWallet = 0xB9c4a9FfbDF69b99e9fD97D36ccD84Fb20A7F8ce;
