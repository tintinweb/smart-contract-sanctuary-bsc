...
contract OPG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x71D2CF923F30Bb0003471042ffBA3B26119aa1Cb); // Marketing Address
    ...
    string private _name = "OPGG";
    string private _symbol = "OOD";
