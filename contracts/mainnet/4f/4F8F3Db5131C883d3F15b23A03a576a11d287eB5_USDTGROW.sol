...
/*      USDT GROW
            Telegram : https://t.me/usdtgrow_cn
            Website : https://usdtgrow.com/
*/
...
contract USDTGROW is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0xeDe5A38d61ca9739bC545f2Bd66398B95F5721c2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5 * 10**9 * 10**_decimals;
    string private constant _name = "USDTGROW"; 
    string private constant _symbol = unicode"USDTGROW";
