...
contract McShamrockOreo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McShamrockOreo";
    string private _symbol = "MCSHAMROCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0986e3865c1816F3D8598a3308dc9638c13891b2);
    address payable public teamWalletAddress = payable(0x0986e3865c1816F3D8598a3308dc9638c13891b2);
