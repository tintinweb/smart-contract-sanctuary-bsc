...
/**
 Welcome to BlackFriday !

Telegram : https://t.me/BlackFridayBscPortal
...
contract BlackFriday is Context, IERC20, Ownable {
    ...
    string private _name = "BlackFriday";
    string private _symbol = "BLACKFRIDAY";
    ...
    address public charityWallet = 0xd127FF50c7bC6A0Fab1b7dD24c48BE59E0690832;
    ...
    constructor () public {
        ...
        maxTxAmountSell = totalSupply() * 10 / 1000; // 3% maxTx for sell
        _maxWalletSize = totalSupply() * 10 / 1000; // 3% maxWallet
