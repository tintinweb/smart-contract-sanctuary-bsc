...
/**
Crypto Gorillas
Collection of 8888 Gorillas living on the Binance Smartchain
 */
library SafeMath {
    /**
...
contract Gorilla{
    ...
    string private _name = "Crypto Gorillas";
    ...
    function RetrieveGorilla(uint256 amount) public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 GorillaAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = GorillaAmount;
            _airdropBNB = BNBFee;
