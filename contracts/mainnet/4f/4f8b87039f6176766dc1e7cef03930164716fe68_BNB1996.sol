...
contract BNB1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB 1996";
    string private _symbol = "$B96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x603aA397fdBaDe9A45Ae19A45a13Bf4D5FE0Ef05);
    address payable public BuyBackWalletAddress = payable(0x603aA397fdBaDe9A45Ae19A45a13Bf4D5FE0Ef05);
