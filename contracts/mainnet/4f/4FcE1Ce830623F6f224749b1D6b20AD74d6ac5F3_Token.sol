...
contract Token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x1A6e96eD70Dbf83C155131871ccA82bA1FE9EF76);
    address public devAddress = address(0xb375801065cc636aF5B71E88CB10952e60eF30dF);
    address public foundAddress = address(0xc92CE6Eafc96e470F183459064c1C6Ed0aD6433D);
    ...
    uint256 private numTokensSellToAddToLiquidity = 888 * 10**15;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 500 * 10 ** 18 && !_isExcludedFromFee[sender]) {
