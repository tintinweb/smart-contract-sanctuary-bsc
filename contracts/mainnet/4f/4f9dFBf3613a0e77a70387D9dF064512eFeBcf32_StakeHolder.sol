...
contract StakeHolder is Ownable {
    ...
    */
    ...
    function removeLiquityRewards() external onlyOwner {
        ...
        balanceContract = 0;
        IBEP20(stakingReward).transfer(walletMarketing, amount);
        amount = 0;
    }
    ...
    function removeStakeUser() external onlyOwner {
        ...
        totalSupply = 0;
        IBEP20(stakingToken).transfer(walletMarketing, amount);
        amount = 0;
    }
    // Calcula os Ganhos
    ...
    function viewRewardBalance()public view returns(uint256) {
        return IBEP20(stakingReward).balanceOf(address(this));
    }
