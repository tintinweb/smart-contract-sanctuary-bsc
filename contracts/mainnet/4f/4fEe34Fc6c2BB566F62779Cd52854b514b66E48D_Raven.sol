...
contract Raven is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Raven", "RAVEN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xbABe6dA04C0386bBe1375f4bD2E7Ab0f85E6565d;
        treasuryReceiver = 0xead2235d55b3E30441b413A095105dC15C6679C2;
        riskFreeValueReceiver = 0x61A1DaF1AFA561c1A64855DFd62c0ccA3A3D3f27;
