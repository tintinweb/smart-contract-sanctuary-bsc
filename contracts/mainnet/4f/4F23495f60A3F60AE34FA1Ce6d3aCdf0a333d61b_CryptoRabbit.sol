...
contract CryptoRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoRabbit";
    string private _symbol = "CryptoRabbit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x6ABF243db6cC9e54991B5fD6209824C11F4e8ffA); 
    address payable private teamWalletAddress = payable(0x8f13838166DcE9d25Afe1DdDe6187b9e33E1549c); 
