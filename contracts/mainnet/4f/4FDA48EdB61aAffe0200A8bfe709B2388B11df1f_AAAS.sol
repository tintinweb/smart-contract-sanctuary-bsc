...
contract AAAS is IFlashBorrower, IXFlashBorrower{
    ...
    /** MDB+ */
    address constant MDBPlus = 0x6b8a384DDe6FC779342Fbb2E4a8EcF73eD18D151;
    ...
    function handleSwaps(
        ...
        if (approvedStables[_token0] && _token1 == MDBPlus) {
            // Mint MDB+
            _mintMDBPlus(amount);
        } else if(_token0 == MDBPlus && approvedStables[_token1]) {
            // Sell MDB+
            _sellMDBPlus(amount);
