...
/**
Telegram : https://t.me/FootballerDoge
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97a9a77C2E09EC9a88c91cA90b182386Bbf9C592; // owner address
...
contract Footballerdoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Footballer Doge";
    string private _symbol = "FootballerDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x172f7b867cf853835e26ecbDAEBa753d25C2Ad30); // Marketing Address
    address payable public teamWalletAddress = payable(0x172f7b867cf853835e26ecbDAEBa753d25C2Ad30); // Team Address
