...
contract USDTOSK is Ownable, IBEP20 {
    ...
    uint256 public minAmountToSwapForWallet = 5;
    uint256 public minAmountToLpDifidend = 100; 
    uint256 public minAmountToHolders = 1000; 
    uint256 public minAmountToHoldersDifidend = 100;  
    uint256 public minAmountToPool = 100;

    bool private isLiquidityAdded;
    address private pancakeRouterAddr = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address private usdt = 0x55d398326f99059fF775485246999027B3197955;   
    address public wallet1 = 0x2c6f949be5146A1E72EbB08B3d501fD65C20BC0d; 
    address public wallet2 = 0x29d2837e0140d11Cac0CCa20586cc689d4386317; 
    address public marketing = 0x2c6f949be5146A1E72EbB08B3d501fD65C20BC0d; 
    ...
    constructor() {
        _name = "USDTOSK";  //修改币子信息
        _symbol = "USDTOSK";   //修改币子信息
        _decimals = 18;
        _totalSupply = 1400 * (1e18); 
