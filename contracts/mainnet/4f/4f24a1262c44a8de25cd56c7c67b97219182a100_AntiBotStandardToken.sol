...
contract AntiBotStandardToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vitual to Pay";
    string private _symbol = "VIP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA2562a72d0459A50C9DA559f124F10c8F07eC80f);
    address payable public buyBackWalletAddress = payable(0xA2562a72d0459A50C9DA559f124F10c8F07eC80f);
    ...
    uint256 private _totalSupply = 2000 * 10**4 * 10**_decimals;
