...
//https://t.me/XiJingpingInu  tax:3/3 ,  CA will be Renounced . 
...
contract  XiJingpingInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XiJingping Inu";
    string private _symbol = "XIJINGPING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8B756f90b2751FFb53D166949a05B58a22fd5b7C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8B756f90b2751FFb53D166949a05B58a22fd5b7C); // BuyBack Address
