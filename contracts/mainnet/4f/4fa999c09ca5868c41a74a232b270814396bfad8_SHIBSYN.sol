...
abstract contract ContextSHIBSYNBSC {
...
contract OwnableSHIBSYNBSC is ContextSHIBSYNBSC {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableSHIBSYNBSC: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSHIBSYNBSC: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SHIBSYN  is ContextSHIBSYNBSC, SHIBSYNBSC, OwnableSHIBSYNBSC {
    ...
    string private _name = 'SHIB SYN';
    string private _symbol = '$SHIB SYN';
