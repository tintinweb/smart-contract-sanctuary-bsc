...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Bf7e9Cfa2f004915737D8f107058C6A9FFB8FF3;
...
contract Genji is Context, IERC20, Ownable {
    ...
    string private constant _name = "GENJI INU"; // 
    string private constant _symbol = "$GENJI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x7Bf7e9Cfa2f004915737D8f107058C6A9FFB8FF3);
