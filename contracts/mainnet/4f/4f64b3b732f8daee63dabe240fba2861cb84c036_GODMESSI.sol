...
contract GODMESSI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GodMessi";
    string private _symbol = "GMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11D55A735bb2C472fBF4e15DD046d92ac74A15A7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbdb82df5E8D789A50F6F5c81a2EFE785cD7Acd04); // Dev Address
