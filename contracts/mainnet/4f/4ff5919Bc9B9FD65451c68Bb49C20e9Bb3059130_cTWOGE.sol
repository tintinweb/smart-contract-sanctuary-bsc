...
contract  cTWOGE  is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Twoge"; // 
    string private constant _symbol = unicode"cTwoge"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xDe8C7abB2B8B79d7e1dd143A7340a2f5F1778D7E;
