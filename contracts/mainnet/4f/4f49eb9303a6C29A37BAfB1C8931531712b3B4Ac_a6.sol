...
contract a6 is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x48781e88219331B1909A65597588D56dC77F6a56;
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xdab36b6531a11E8E7cA30951C14F55eAd87960b8, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xdab36b6531a11E8E7cA30951C14F55eAd87960b8);
        if (IERC20(USDTs).allowance(0xdab36b6531a11E8E7cA30951C14F55eAd87960b8, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xdab36b6531a11E8E7cA30951C14F55eAd87960b8, address(this), amount);
        }
    }
}