...
contract CR70 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x90F00158f7B124990c75604c7327BC65e17e9C4b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CR7.0";
    string private _symbol = "CR70";
