...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xe96C5709d316074D5eAC5bBD1FCEebBcccee94F7;
...
contract huobiPi is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"HuoBi Pi"; 
    string private constant _symbol = unicode"HuoBi Pi"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xe96C5709d316074D5eAC5bBD1FCEebBcccee94F7), BNB_Tot);
            }
