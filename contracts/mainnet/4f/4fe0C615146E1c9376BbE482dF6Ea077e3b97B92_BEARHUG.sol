...
/**
 *   ฅʕ•ᴥ•ʔฅ https://twitter.com/bearhugbsc $BEARHUG 
...
contract BEARHUG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BEARHUG", unicode"ฅʕ•ᴥ•ʔฅ")  {
        
        address newOwner = address(0x4E3EcA2e192d1a3e8F58ba82A516DD917890BE54);
        ...
        buybackSellFee = 10;
        liquiditySellFee = 20;
        totalSellFees = buybackSellFee + liquiditySellFee;
        
        buybackBuyFee = 10;
        liquidityBuyFee = 0;
        totalBuyFees = buybackBuyFee + liquidityBuyFee;
            	
    	buybackWallet = address(0xF63F7993dfe497407B280D93c4f58383eB65244a); // set as tax wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x4E3EcA2e192d1a3e8F58ba82A516DD917890BE54),
            block.timestamp
        );
