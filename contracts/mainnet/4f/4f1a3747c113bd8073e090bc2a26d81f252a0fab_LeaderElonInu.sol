...
interface IDEXRouter {
    ...
    contract LeaderElonInu is IBEP20, Auth {
    ...
    string constant _name = "LeaderElonInu";
    ...
    address private marketingFeeReceiver = 0x49E4Dcf9e07474C822C3090f34698F5A9e8Bd200;
