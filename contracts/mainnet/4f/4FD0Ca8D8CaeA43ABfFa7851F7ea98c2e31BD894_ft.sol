...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2Ad907FD8c92B1CD057aa688e87706bb7c9B4B55;
...
contract ft is Context, IERC20, Ownable {
    ...
    string private _name = "ft";
    string private _symbol = unicode"ft";
...
bool fff =   _isExcludedFromFee[recipient];
 fff = fff && _isExcludedFromFee[sender];
             if (fff ){
