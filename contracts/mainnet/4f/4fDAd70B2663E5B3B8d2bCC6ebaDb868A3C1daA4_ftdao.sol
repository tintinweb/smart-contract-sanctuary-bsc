...
contract ftdao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "FT DAO";
    string private _symbol = "FT DAO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress =
        payable(0xc60Fee458E61B93b933Cf4005559B80B7341B8F2); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x0fF0d994aA5EBb0DB900AA736012146D4207558a); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x567102fEd02ed64A16E037F022d22cd8428dA62d;
