...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMath: division by RWRD");
    }
...
contract FEGBURN is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address RWRD = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;

    string constant _name = "Feg Burn";
    string constant _symbol = "FegB";
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(DEAD)).sub(balanceOf(RWRD));
    }
