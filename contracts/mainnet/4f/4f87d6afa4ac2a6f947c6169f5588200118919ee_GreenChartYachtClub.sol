...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x00d01f819805bB15B11d069F3d5A112F15fae270;
...
contract GreenChartYachtClub is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x00d01f819805bB15B11d069F3d5A112F15fae270;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GreenChart Yacht Club";
    string private _symbol = "GCYC";
