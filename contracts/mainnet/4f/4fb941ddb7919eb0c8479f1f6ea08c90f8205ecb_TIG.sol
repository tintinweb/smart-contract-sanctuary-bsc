...
contract TIG is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tige inu Grow";
    string constant _symbol = "TIG";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3db00E96515bE82116f3DafC89cDf42447C14ffC;  // teamwallet
        lotteryWallet = 0x45eC99Fceed14501EAE8De5038DB33A866d2f8cB;  // lotterywallet
