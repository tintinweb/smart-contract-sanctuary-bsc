...
🐶Doge+++ a meme token that was taken from the name hype . This token is community based and an experienced team in the crypto field . 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x702C310c28A6C9c779f7E9486582507ED0a972F9;
...
contract DOGE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x702C310c28A6C9c779f7E9486582507ED0a972F9);
    ...
    */
    ...
    // Default is true
    function Claim_Reward(bool true_or_false, uint256 _uint) external onlyOwner {
