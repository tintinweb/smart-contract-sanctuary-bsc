...
contract Dogezilla is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Zilla V2", "DZV2") {
     ...
     uint256 totalSupply = 69 * 10 ** 12 * 10 ** decimals();
 
        maxTransactionAmount = 69 * 10 ** 10 * 10 ** decimals(); 
        maxWallet = 69 * 10 ** 10 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x20565dF85E1337030BF19624860960D1cf595Bf4); // set as Marketing wallet
        DevWallet = address(0x20565dF85E1337030BF19624860960D1cf595Bf4); // set as dev wallet
