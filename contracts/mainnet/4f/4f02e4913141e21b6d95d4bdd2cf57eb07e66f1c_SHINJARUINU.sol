...
contract SHINJARUINU is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SHINJARU INU';
    string private constant _symbol = 'SHINJARU';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x246393191971bF1Ef83ccF701e8CCebdc301B565);
    address public Development=payable(0x246393191971bF1Ef83ccF701e8CCebdc301B565);
    //TestNet
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*100) / 100);
        payable(Development).transfer((amount*0) / 100);
    } 
