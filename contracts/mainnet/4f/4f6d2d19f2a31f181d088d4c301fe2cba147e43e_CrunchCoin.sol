...
/* Token contract */
contract CrunchCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x26592647e11285EDffdf082Ef8A7E0AAB445321b;
    ...
    // Name and symbol
    string constant _name = "Crunch Coin";
    string constant _symbol = "$CRUNCH";
