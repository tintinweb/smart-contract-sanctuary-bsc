...
contract MultiSaleDBdoge is BEP20, Ownable{
    ...
    function getBnbReservAddress() public view returns (address) {
        return bnb_reserv;
    }
    ...
    function transferSwapUser(uint256 amount) public isPausable() {
        ...
        if(!inTransfer){
            inTransfer = true;
                pendingBalance[sender].sub(amount);
                pendingBalance[address(this)].add(amount);
    ...
    /*
    * @dev System of Receive/create/update
