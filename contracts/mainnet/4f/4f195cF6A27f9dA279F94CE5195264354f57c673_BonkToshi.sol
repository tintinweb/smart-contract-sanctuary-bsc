...
contract BonkToshi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BONK TOSHI";
    string private _symbol = "$BTOSHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5EDf8b4FC6c9Dd9ae425f2d56B5242cC1c0cA50e); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xA98406bC17E008f8cA3b6C87B12E032C53db956B); // Team Address
