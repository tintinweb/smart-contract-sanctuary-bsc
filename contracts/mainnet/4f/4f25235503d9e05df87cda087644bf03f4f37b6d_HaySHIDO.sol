...
Make SHIDO INU and Hay work as One.
✅ Low Marketcap Gem
❇️ NFA DYOR
...
contract HaySHIDO is HaySHIDODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HaySHIDOTeam;
    address private CharityHaySHIDO;
    ...
    string public override name = "HaySHIDO";
    string public override symbol = "HAYSHIDO";
    ...
    constructor(uint totalSupplyValue, address HaySHIDOTeamAddress, address CharityHaySHIDOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HaySHIDOTeam = HaySHIDOTeamAddress;
        CharityHaySHIDO = CharityHaySHIDOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HaySHIDOTeam] =  totalSupply * 4 / 100;
        balances[CharityHaySHIDO] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HaySHIDOTeam pot
