...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x65816D1784f4352A3c3490E314700D2583CC5C89; // owner address
...
contract KYLIANMBAPPEINU is Context, IERC20, Ownable {
    ...
    string private _name = "Kylian Mbappe Inu";
    string private _symbol = "KMP"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb04aE2b4FC3F2fa14451EFcE8668209D9a56fa37); // Marketing Address
    address payable public teamWalletAddress = payable(0xC39A38C2721DC74F5734B86FEda1928C118267FC); // Team Address
