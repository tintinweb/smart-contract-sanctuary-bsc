...
Telegram: https://t.me/WeedFortune
  ...
  ~ 4% stacking compound bonus every 12 hours, max of 7 days.
  ~ 30 hours cut off time.
  ~ 12 hours withdraw cooldown.
  ~ 200 Space Buds minimum investment.
  ~ 30,000 Space Buds max deposits per wallet.
...
contract SpaceBuds {
    ...
    IERC20 public token_SB;
	//address erctoken = 0xb7771b87fd6b59fb6731e2e6d2c3e85caa2dce94; /** 9 decimal test token address **/
    address erctoken = 0xb7771B87Fd6B59FB6731E2e6D2C3E85CAA2dCe94; /** 9 decimal main token address **/
    ...
    uint256 public MIN_INVEST_LIMIT = 200 * 1e9; /** 200 Space Buds  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 30000 * 1e9; /** 30,000 Space Buds  **/
    ...
    function sellEggs() public{
        ...
        token_SB.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public payable{
        ...
        token_SB.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_SB.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_SB.transfer(owner, development);
        token_SB.transfer(dev1, development);
        token_SB.transfer(dev2, development);
        token_SB.transfer(mkt, marketing);
    ...
    function getBalance() public view returns (uint256) {
        return token_SB.balanceOf(address(this));
	}
