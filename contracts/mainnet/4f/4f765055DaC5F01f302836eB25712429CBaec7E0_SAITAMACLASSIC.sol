...
//I know many of you have missed Saitama so I'm sure you don't want to miss another chance, especially when you have the opportunity to become a whale at such a low price.
//Don't miss this Big project SAITAMA CLASSIC Everyone is looking for that 100x gem that is still under the radar.

pragma solidity ^0.8.5;

//TELEGRAM:https://t.me/SaitamaClassicOfficial

//TWITTER:https://twitter.com/SAITAMACX100
...
contract SAITAMACLASSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAITAMA-CLASSIC"; // 
    string private constant _symbol = "$SAITAMAC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x848952b02eee77ec24763a527A585035377C9015;
