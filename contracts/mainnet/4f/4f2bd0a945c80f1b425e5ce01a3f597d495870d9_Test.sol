...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFA4a62BA2625EFA7ADb8a711b51CE60146b3817f); 
    address payable public Wallet_Dev = payable(0xFA4a62BA2625EFA7ADb8a711b51CE60146b3817f);
