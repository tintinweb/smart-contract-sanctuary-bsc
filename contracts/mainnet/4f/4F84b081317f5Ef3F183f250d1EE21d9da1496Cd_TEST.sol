...
WEBSITE: www.Bullishkingbsc.com (not Live yet)

Telegram : https://t.me/Bullishkingbsc
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        _owner = 0x6b53Aaa0740a3388f272B35ef08Bf4DaE8193986;
        owner = _owner;
...
contract TEST is IBEP20, Auth {
    ...
    address private marketingFeeReceiver = payable (0x859785bE3b73b8f21E3D3D75313eD3097131F89a);
    address private buybackFeeReceiver = payable (0x329fA71E04e286034Ad0754949642E00eE4F1aE1);
    ...
    uint256 public swapThreshold = _totalSupply / 2000000 * 1; // 0.2%
    bool inSwap;
