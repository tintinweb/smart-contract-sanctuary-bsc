...
//** 7/8 Tax
//**  Utility live → https://t.me/LibertumProject_BSC 
...
interface IDEXRouter {
 ...
 contract LibertumProject is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "LibertumProject";
    string constant _symbol = "Libertum";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 60) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 60) / 100; 
    ...
    address public devFeeReceiver = 0xDfefcA08e43cC7df35F3FC98793CE3CB03139027;
    address public buybackFeeReceiver = 0xDfefcA08e43cC7df35F3FC98793CE3CB03139027;
