...
interface IStrategy {
    ...
    /// @param amountMax The requested amount the caller wants to withdraw.
    /// @return actualAmount The real amount that is withdrawn.
    function withdraw(uint256 amount, bool amountMax) external returns (uint256 actualAmount);
