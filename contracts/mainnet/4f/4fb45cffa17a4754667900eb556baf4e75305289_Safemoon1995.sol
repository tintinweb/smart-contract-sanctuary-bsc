...
contract Safemoon1995 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safemoon 1995";
    string private _symbol = "SFM95";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x020fE10553Ca55fCac2086549f37fa00Cd794a23); // Marketing Address
    address payable private teamWalletAddress = payable(0xB7659DdDd0f17154C6029c720444ED9Ed74aA603); // Team Address
    ...
    uint256 public _walletMax = 3 * 10**3 * 10**3* 10**_decimals;
