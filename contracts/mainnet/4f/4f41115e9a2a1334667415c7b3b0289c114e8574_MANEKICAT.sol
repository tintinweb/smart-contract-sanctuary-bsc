...
/**
        ...
        Meeeooow~ everyone!
        Maneki Cat Coin is here with big dreams to be the biggest untility token on BSC!
        - Low tax
        - Safe dev
        - Big marketing plan
        - Unique feature

        https://t.me/ManekiCatCoin
...
contract MANEKICAT is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Maneki Cat Coin";
    string constant _symbol = "$MCC";
    ...
    address public marketingFeeReceiver = 0x9538AB67cC03318CA5f7B68869073fE6CE9eff49;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x9538AB67cC03318CA5f7B68869073fE6CE9eff49] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x9538AB67cC03318CA5f7B68869073fE6CE9eff49] = true;
