...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xEF312B5C0968e146F732CAa76aA340A3731ADc05;
...
contract degenplay is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0xEF312B5C0968e146F732CAa76aA340A3731ADc05);
    ...
    string private constant _name = "Just a degen play but we act like its the new Bitcoin 2.0"; 
    string private constant _symbol = unicode"JADPBWALITNB2"; 
