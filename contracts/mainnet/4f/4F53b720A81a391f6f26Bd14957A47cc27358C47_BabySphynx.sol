...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x6e281f90c6D1b5E5A01FB6f14C428afF69c04C3F); // Sphynx Labs Rewards Token
...
contract BabySphynx is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabySphynx", "BabySphynx") {
    	...
    	marketingWallet = address(0xFae059eF1fB4f9cFE9EeE2c54B31BBa45d564F41); // set as marketing wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on sell
            if (!useLaunchFee && automatedMarketMakerPairs[to] && totalSellFees > 0){
            ...
            // on buy
            else if(!useLaunchFee && automatedMarketMakerPairs[from] && totalBuyFees > 0) {
                ...
                fees = amount.mul(launchFee).div(100);
