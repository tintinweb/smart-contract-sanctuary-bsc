...
contract StakeMineCoin is GasHelper, ERC20 {
  address constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address constant ZERO = 0x0000000000000000000000000000000000000000;
  address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // BSC WBNB
  address constant PANCAKE_ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

  string constant _name = "STAKEMINE";
  string constant _symbol = "STMI";

  string public constant url = "www.stakemine.tech";

  uint constant maxSupply = 780_000_000e18;
  ...
  uint public feeAdministrationWallet = 600;
  uint public feeMarketingWallet = 200;

  uint constant maxTotalFee = 1200;
  ...
  function setFees(
    ...
    require(getFeeTotal() <= maxTotalFee, "All fee together must be lower than 12%");
  }
  ...
  function setSpecialWalletFee(
    ...
    require(total <= maxTotalFee, "All rates and fee together must be lower than 12%");
