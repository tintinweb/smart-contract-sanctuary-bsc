...
contract DancingLion is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DancingLion";
    string private _symbol = "DancingLion";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf076fc286743DB8ee283E51CCA3711820b6D8f34);
    address payable public teamWalletAddress = payable(0x37b648815EC356FFBb09B25e3Fa46839989d6176);
