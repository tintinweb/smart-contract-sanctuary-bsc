...
contract MurrayQueen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MurrayQueen";
    string constant _symbol = "MQ";
    ...
    address public developmentFeeReceiver = 0x473Ffe302f36125Cd6190fF2345900c8641B8a3a;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDevelopment = amountBNB.mul(developementFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBDevelopment}() {} catch {}
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _developementFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        developementFee = _developementFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_developementFee).add(_marketingFee);
