...
contract HQNSToken is IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 30;//add lp
    uint256 public _LPFee = 30;//lp rewards
    uint256 public _inviterFee = 70;//referral lv5

    uint256 public _marketFee = 50;//nft holding rewards
    ...
    address public _marketAddress= 
        address(0xB82b9581eE80dED76A4283BA12534BD87eAbec5C);
...
constructor(address _route) {
    ...
    function _tokenBuyTransferFee(
		...
		if(fee){
			...
			uint256 destroyfee = tAmount.div(percent).mul(_inviterFee.sub(ratesum));
