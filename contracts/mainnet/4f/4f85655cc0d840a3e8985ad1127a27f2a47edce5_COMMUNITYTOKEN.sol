...
contract COMMUNITYTOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2869647743347995e48d5A138b89b0B37915807F); 
    address payable public Wallet_Dev = payable(0x86Bf8354225125298F5aa29d096F986A3159023F);
    ...
    constructor () {
        ...
        _owner = 0x86Bf8354225125298F5aa29d096F986A3159023F;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2869647743347995e48d5A138b89b0B37915807F); // Testnet
