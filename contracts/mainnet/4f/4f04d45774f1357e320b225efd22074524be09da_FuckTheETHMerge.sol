...
/**
    After The Merge, you will have to pay more to participate in the work, 
    that money will be used to keep the price of ETH TOKEN from falling too sharply when the whales take profits.

    You can increase your number of tokens by 2-4% per year, but their prices will be halved, 
    your machines will work tirelessly to earn back the money you lost, and your monthly electricity bills will make your wife scream:

    ''FUCK THE ETH MERGE'

    FUCKTEM Token represents the strength of the community, 
    true crypto lovers are so disgusted with the dirty conspiracies of the tycoons.
    Now we join forces, let these bastards know they can't fool us again.

//  The current estimated time for the Ethereum Merge is 2022-09-15!

//  https://t.me/FucktheETHMerge
*/
...
contract FuckTheETHMerge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x320774FD2bACe9C3015948d252Bb25BA26e293db;
 
    string constant _name = "Fuck the ETH Merge";
    string constant _symbol = "FUCKTEM";
