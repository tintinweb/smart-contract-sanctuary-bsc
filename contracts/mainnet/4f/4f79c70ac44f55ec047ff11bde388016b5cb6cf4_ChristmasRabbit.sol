...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd841deD4DeceF2eABa4BEcd702eC10cBda3B22b8; // owner address
...
contract ChristmasRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Rabbit";
    string private _symbol = "XmasRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBFDc22D45726A55B9fD2eCE3D21b7A44E302667F); // Marketing Address
    address payable public teamWalletAddress = payable(0xBFDc22D45726A55B9fD2eCE3D21b7A44E302667F); // Team Address
