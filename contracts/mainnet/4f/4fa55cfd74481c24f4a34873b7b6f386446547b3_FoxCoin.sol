...
/*
        🦊🦊 FOXCOIN 🦊🦊
    The fox is around the town. Catch him if you can!
    TG: https://t.me/FoxCoin
*/
...
// Buy tax: 2/2/2 (LP/Marketing/Buyback)
// Sell tax: 2/3/2 (LP/Marketing/Buyback)
...
contract FoxCoin is Context, IERC20, Ownable {
    using Address for address;  
    using SafeMath for uint256;

    string private _symbol = "FOX";   
    string private _name = " Foxcoin";
