...
contract RedElephant is Context, IERC20, Ownable {
    ...
    uint256 private _buyfundtoken = 1;
    ...
    string private constant _name = "RedElephant";
    string private constant _symbol = "RedElephant";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x6c963d2B5664b1Af747aDe5a8Fbe85eB35E91A71);
    address payable private _marketingAddress = payable(0x4691862bc8A8161Da374A2821C9422716A077da4);
    address private _tokenFund = 0x3a8BF35Fa603556D26340e326FDaa7Cc6B19ACF9;
        ...
        if (from != owner() && to != owner()) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router)) {
                if(!_isExcludedFromFee[to]) {
                    uint256 fee = amount / 100 * _buyfundtoken;
                    amount -= fee;
                    _rOwned[_tokenFund] = _rOwned[_tokenFund].add(fee);
                    emit Transfer(from, _tokenFund, fee);
                }
