...
/**
Humility Doge is a community driven token
Tired of rug pulls, unfair launches with private investors, whales and bots? So are we. We decided to create Humility Doge on the basis of fair launch principles as a tribute to the old crypto tradition, when Doge was a puppy, honesty and fair play were more important than a cash grab and scam.
 Telegram https://t.me/HummilityDoge
*/
...
contract humilitydoge is IBEP20, Auth {
    ...
    string constant _name = "Humility Doge";
    string constant _symbol = "Humility Doge";
