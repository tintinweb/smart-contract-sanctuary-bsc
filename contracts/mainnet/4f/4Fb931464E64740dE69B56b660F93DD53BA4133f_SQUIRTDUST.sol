...
/**
Telegram: https://t.me/squirtdustbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2889C41ebc42c9d1D77662F8acFD4139FB15F135; // owner address
...
contract SQUIRTDUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squirt Dust";
    string private _symbol = "SQDUST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2889C41ebc42c9d1D77662F8acFD4139FB15F135); // Marketing Address
    address payable public teamWalletAddress = payable(0x2889C41ebc42c9d1D77662F8acFD4139FB15F135); // Team Address
