...
interface IUkraineDaoDividendTrackerInterface is IERC20 {
...
contract UkraineDao is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    IUkraineDaoDividendTrackerInterface public dividendTracker;
    ...
    constructor(
        ...
        address[3] memory addrs, // rewardToken, marketing wallet, tracker
        uint256[3] memory fees, // reward, liquidity, marketing
        ...
        swapTokensAtAmount = totalSupply_.mul(3).div(10**6); // 0.002%
        gasForProcessing = 300000;

        dividendTracker = IUkraineDaoDividendTrackerInterface(addrs[2]);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "UkraineDao: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "UkraineDao: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "UkraineDao: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "UkraineDao: gasForProcessing must be between 200,000 and 500,000"
        );
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeDividend(dividends);
