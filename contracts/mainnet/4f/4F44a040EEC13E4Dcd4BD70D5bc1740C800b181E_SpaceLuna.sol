...
/**
Did you miss the wave when Bill Murray 120x  was on its way to the top? 
Do you wish you would’ve bought Kazoku at 4k  back when it launched and held on for the ride?
 Is the 100X explosion of the RatBoy something you wish you would’ve been able to be a part of? 

Even if you missed all of that, here’s your chance to get in on the ground floor!
...
contract SpaceLuna is Context, IBEP20, Ownable {
    ...
    string private _name = "Space Luna"; // token name
    string private _symbol = "$SLUNA"; // token ticker
    ...
    address public BuyBackAddress = (0xd89c3834058f99708b5410d7a427E17619142472);
    ...
    uint256 public BuyBackFeeOnBuying = 0;
    ...
    constructor(address payable _marketWallet) {
       ...
       // exclude addresses from max holding limit
        ...
        _isExcludedFromMaxHoldLimit[BuyBackAddress] = true;
        ...
        uint256 percentage = tAmount
            .mul(
                _currentReflectionFee.add(_currentLiquidityFee).add(
                    _currentmarketWalletFee.add(_currentBuyBackFee)
                )
            )
            .div(1e3);
        return percentage;
    ...
    function setBuyFee() private {
        ...
        _currentBuyBackFee = BuyBackFeeOnBuying; 
    }
    ...
    function setSellFee() private {
        ...
        _currentBuyBackFee = BuyBackFeeOnSelling;
    }
    ...
    function _transferStandard(
        ...
        _takeBuyBackFee(sender,tAmount, currentRate);
        _reflectFee(tAmount);
   ...
   function _takeBuyBackFee(address sender,uint256 tAmount, uint256 currentRate) internal {
        uint256 BuyBackFee = tAmount.mul(_currentBuyBackFee).div(1e3);
        uint256 rBuyBackFee = BuyBackFee.mul(currentRate);
        _rOwned[BuyBackAddress] = _rOwned[BuyBackAddress].add(rBuyBackFee);
