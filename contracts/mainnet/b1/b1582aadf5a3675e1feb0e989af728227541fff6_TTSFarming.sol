...
contract TTSFarming {
    address tts;
    address tts2;
    uint256 public SECONDS_WORK_MINER = 400;
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    ...
    function sellTokens() public {
        ...
        ERC20(tts).transfer(0x0000000000000000000000000000000000000000, BurnFee(amountSell));
    ...
    function swapAirdropTokens(uint256 _amount) external{
        ERC20(tts2).burnFrom(msg.sender, _amount);
        ERC20(tts).transfer(msg.sender, _amount);
    }
