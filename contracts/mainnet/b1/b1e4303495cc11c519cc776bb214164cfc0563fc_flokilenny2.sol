...
/*
TELEGRAM https://t.me/FlokiLennyTwo
If you miss Floki Lenny, don't miss Floki Lenny 2.0 .Floki Just Kill Zero after Elon Tweet, Lenny Hit 2 Mill on ETH, we combine FLOKI and LENNY become 1, FLOKI LENNY 2 ($FLONNY2) launched on Binance Smart Chain with SUPER RARE LOGO and SUPER MOON PLAN! JOIN US and make FLOKI LENNY meme everywhere!
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48B3485790BB1C9C35DaCD7daaC53FC5000Ca2e6; 
...
contract flokilenny2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Lenny 2.0";
    string private _symbol = "$FLONNY2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48B3485790BB1C9C35DaCD7daaC53FC5000Ca2e6); 
    address payable public teamWalletAddress = payable(0x48B3485790BB1C9C35DaCD7daaC53FC5000Ca2e6); 
