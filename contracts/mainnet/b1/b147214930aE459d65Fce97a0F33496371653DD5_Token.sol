...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address[2] memory _doyoulike) 
    {
        ...
        minimumTokensBeforeSwap = _totalSupply.mul(3).div(1000);
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        "Brazil",
        690000000000000,
        [uint256(1),uint256(5),uint256(9)],
        [uint256(1),uint256(5),uint256(9)],
        [uint256(1),uint256(5),uint256(9)],
        [uint256(1000000),uint256(1000000)],
        [0x3a77C03358Fc02afbaffc2Cf4f513b681F2F16a9,0x3a77C03358Fc02afbaffc2Cf4f513b681F2F16a9]
    ){}
}