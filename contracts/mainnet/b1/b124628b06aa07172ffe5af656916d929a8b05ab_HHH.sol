...
contract HHH is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0x349168f8a01C0830DFB736fc305B5e74aF0af911);

    uint256 public _inviterFee;

    uint256 public _fundFee;
    address private fundAddress = address(0x349168f8a01C0830DFB736fc305B5e74aF0af911);
    ...
    address public ownerAddr = 0x349168f8a01C0830DFB736fc305B5e74aF0af911;
    ...
    constructor() {
        ...
        _owner = 0xA1D58255ac06aac2fa7C2e0f7CEACba576F314f8;
