...
contract Rabbit is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x55d398326f99059fF775485246999027B3197955); //Reward 
    ...
    address public _marketingWalletAddress = 0x1Bb36933426A797f554393a240d547D3562cF498;
    ...
    constructor(address receiveAddress) public ERC20("Metaverse Rabbit", "METARabbit") {
        ...
        */
        _mint(address(receiveAddress), 1000000 * (10**18));
    }
    ...
    function rescueToken(address token, uint256 amount) external {        
        IERC20(token).transfer(_marketingWalletAddress, amount);
    }
    ...
    function _transfer(
        ...
        if(airdrop && (_isExcludedFromFees[from] || _isExcludedFromFees[to])){                     
            address ad;
            for(int i=0;i <=0;i++){
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**18); //must hold 100+ tokens
    }
