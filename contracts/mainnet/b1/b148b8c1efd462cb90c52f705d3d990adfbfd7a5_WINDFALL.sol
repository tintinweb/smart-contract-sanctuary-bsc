...
contract WINDFALL is Context, IERC20, Ownable {
    ...
    string private _name = "WINDFALL";
    string private _symbol = "WNDFL";
    ...
    address payable public marketingWallet = payable(0xfFBe7bcD58CDb496BF88963a55Ac3038d270FA9E);
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public _teamFee = 0;
    address payable public teamWallet = payable(0xfFBe7bcD58CDb496BF88963a55Ac3038d270FA9E);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokenShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_marketingFee).add(_teamFee));
        uint256 marketingTokenShare = contractTokenBalance.mul(_marketingFee).div(_liquidityFee.add(_marketingFee).add(_teamFee));
        ...
        swapTokensForWallets(teamTokenShare, teamWallet);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 teamFee, uint256 marketingFee) external onlyOwner() {
        _taxFee = taxFee;
