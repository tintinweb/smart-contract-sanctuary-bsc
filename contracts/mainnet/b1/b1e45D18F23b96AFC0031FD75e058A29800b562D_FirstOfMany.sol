...
contract FirstOfMany is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FirstOfMany";
    string constant _symbol = "FOM";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x651C6bb1eB7f6BfdBCd13Dd934644269A8271CE6; // dev wallet .5 percent ser
