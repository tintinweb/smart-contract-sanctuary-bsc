...
contract huluwa is IERC20, Ownable {
    ...
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD); // burn
    uint256 public _marketingFee = 1;
    address private _marketingAddress = address(0x55d97B1B12c86662CCF4E66522B7F1c422401d4D);//marketing
    uint256 public _technologyFee = 1;
    address private _technologyAddress = address(0xB6830BcDA87Bf52eB9825ba90744C36F10f2692f);//technology
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeTransfer(
                sender,
                _technologyAddress,
                tAmount.div(100).mul(_technologyFee),
                currentRate
            );
            _takeTransfer(
                sender,
            ...
            rate =_technologyFee + _inviterFee + _marketingFee;
        }
