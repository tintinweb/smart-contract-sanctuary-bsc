...
*
*
* Docs           https://docs.bnbpaycheck.org/
* Website        http://www.bnbpaycheck.com
* Telegram       https://t.me/BNBPaycheckOfficial
*/
...
contract BNBPAYCHECK is Context, Ownable {
    address private feeAddress = owner();
    ...
    function getRewardsSinceLastDeposit(address addr) public view returns(uint256) {
        ...
        return secondsPassed * users[addr].deposit / 4320000; // 14% a week / 2% a day
    }
