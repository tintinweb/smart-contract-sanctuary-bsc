...
contract X_Doge is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 95 * 10**16;
    ...
    function _transferStandard(
        ...
        uint256 tLiquidityFee = tAmount.mul(currentFee).mul(6).div(1200);
