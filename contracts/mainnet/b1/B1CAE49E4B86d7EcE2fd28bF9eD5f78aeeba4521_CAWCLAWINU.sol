...
contract CAWCLAWINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Caw Claw Inu";
    string private _symbol = "CLAWINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FA9713A88F1E5DD24857607eC673532986824C0); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xEDA9eeAdB02D5913595D9E7bf9cbbf13504Bb9D4); // Team Address
