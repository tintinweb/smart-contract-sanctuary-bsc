...
contract MendigoFinance is IBEP20, Auth {
    using SafeMath for uint256;

    address public REWARD = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MKT  = 0xE3A9c3441fa767F563c32d07F6545Add88f5cFde;
    address BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    string constant _name = "Mendigo Finance";
    string constant _symbol = "MFI";
    uint8  public constant _decimals = 18;

    uint256 _totalSupply = 21000000 * (10**_decimals); //1 b
    ...
    uint256 public transferTaxRate        = 5;
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        require(!_isDevlisted[recipient], "Blacklisted address");
        return _transferFrom(msg.sender, recipient, amount);
    }

    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
         require(!_isDevlisted[sender] && !_isDevlisted[recipient], "Blacklisted!");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _DeadFeeReceiver) external onlyOwner {
