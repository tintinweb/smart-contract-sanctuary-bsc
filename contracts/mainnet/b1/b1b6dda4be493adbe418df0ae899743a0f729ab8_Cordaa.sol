...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8C3d4955846F88F7A3eFfda121acbc3cA522608C;
...
contract Cordaa is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfa01B401E8908643Ef436beE582A07737BDB0C2e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cordaa";
    string private _symbol = "CORDAA";
