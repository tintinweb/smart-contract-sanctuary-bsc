...
/**
    ...
    Telegram: https://t.me/risebscwtf
    Website: https://risebsc.wtf/
    Twitter: twitter.com/risebscwtf
    Medium: medium.com/@risebscwtf
*/
...
contract RISE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2eB2eaE3F005bDE847CE639a29121d4D64bdEbc6); // Marketing Address
    ...
    uint256 private _buyMaxTxAmount = 5000000 * 10**_decimals;
    uint256 private _sellMaxTxAmount = 1000000000 * 10**_decimals; 
