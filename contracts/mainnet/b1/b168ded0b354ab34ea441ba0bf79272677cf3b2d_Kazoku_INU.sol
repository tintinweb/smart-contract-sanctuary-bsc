...
contract Kazoku_INU is IBEP20, Auth {
    ...
    string constant _name = "Kazoku INU";
    string constant _symbol = "KAZOKU";
    ...
    address private marketingFeeReceiver = 0xD6858f54E1eBeF66448eDD34020AF214A6976D4A;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 1 >= block.number){ return feeDenominator; }
