...
/*
 ...
 ^^ TELEGRAM : https://t.me/Liftoffdegenplay
...
contract LIFTOFBSC is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address burnAdd = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x7550c7CC2f169E8daB842B63171a51330Aa70Fb6;
    ...
    constructor() BEP20("LIFTOFF", "LIFTOFF", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "LIFTOFF: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LIFTOFF: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "LIFTOFF: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LIFTOFF: Automated market maker pair is already set to that value");
