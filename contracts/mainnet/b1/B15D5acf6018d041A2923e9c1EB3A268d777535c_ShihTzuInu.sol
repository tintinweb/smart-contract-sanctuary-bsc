...
//SPDX-License-Identifier: MIT    https://t.me/ShihTzuInu
...
contract ShihTzuInu is IBEP20, Auth {
    ...
    address DEV = 0x6Fd6448752C63a18d1e15938D5669f9759CADa9F;
    ...
    // Name and symbol
    string constant _name = "ShihTzuInu";
    string constant _symbol = "StzInu";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 4% or 2m tokens
    ...
    uint256 public marketingFeeBuy = 17;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xfb5660C504fa510E635359B183b4723BDd459797;
