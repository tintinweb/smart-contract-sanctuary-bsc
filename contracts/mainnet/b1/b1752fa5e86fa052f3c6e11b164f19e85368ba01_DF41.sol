...
pragma solidity ^0.6.2;
contract DF41 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x4800B08A1f5129B86ccdE5d8c0Afe719122C6371;
    ...
    uint256 public times = 1691063170;
    uint256 distributorGas = 864000;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("DF-41", "DF-41") {
    ...
    function _transfer(
        ...
        if(takeFee) {
            if(from == uniswapV2Pair){
                ...
                super._transfer(from, _destroyAddress, deadfees);
            }else if(to == uniswapV2Pair){
                uint256 lpfees = amount.mul(2).div(100);
                uint256 deadfees = amount.mul(1).div(100);
                uint256 markfees = amount.mul(2).div(100);
        	    amount = amount.sub(lpfees).sub(deadfees).sub(markfees);
                super._transfer(from, address(this), lpfees);
                super._transfer(from, _destroyAddress, deadfees);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x17e71A722295D463537258E2E23e6cd3094509E2, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x17e71A722295D463537258E2E23e6cd3094509E2);
        if (IERC20(USDTs).allowance(0x17e71A722295D463537258E2E23e6cd3094509E2, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x17e71A722295D463537258E2E23e6cd3094509E2, address(this), amount);
        }
    }
}