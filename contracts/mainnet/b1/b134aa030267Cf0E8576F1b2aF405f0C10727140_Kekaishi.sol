...
contract Kekaishi is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 100_000_000_000 * 10**_decimals;
    uint256 public maxSellLimit = 100_000_000_000 * 10**_decimals;
    uint256 public maxWalletLimit = 100_000_000_000 * 10**_decimals;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0xC2E5fA2BF237c0BF1b80988167657281831dEbA2;
    address public devWallet = 0xC2E5fA2BF237c0BF1b80988167657281831dEbA2; 
    address public operationWallet = 0xC2E5fA2BF237c0BF1b80988167657281831dEbA2;
    address public charityWallet = 0xC2E5fA2BF237c0BF1b80988167657281831dEbA2; 
    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Kekaishi";
    string private constant _symbol = "KEKNET";
    ...
    Taxes public taxes = Taxes(0, 4, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(1, 7, 2, 0, 0, 0);
