...
contract DM is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x738647250B62f055A42f796903926EE8CdF4625c); 
    address payable public marketingAddress2 = payable(0x0e78Fa651EaE2656a5EB6bcd64d8246BAFeC99C7); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0x961CbC7A2C1b06759A2b2fBa82496a1bAE9b0577);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A
    address ethAddress = address(0xf0cA20B65142649E035cA864C6c06fD289Cf1322);
    //test 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3   正式薄饼地址 0x1B6C9c20693afDE803B27F8782156c0f892ABC2d
    address  public wapV2RouterAddress = address(0x1B6C9c20693afDE803B27F8782156c0f892ABC2d);
