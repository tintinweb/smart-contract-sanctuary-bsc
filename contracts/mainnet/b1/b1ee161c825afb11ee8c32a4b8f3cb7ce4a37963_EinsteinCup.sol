...
// Telegram : https://t.me/einsteincup
// Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa4956847c319e8c20812e72Be6814FCCCB6e4723; // owner address
...
contract EinsteinCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EINSTEIN CUP";
    string private _symbol = "EinsteinCup";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa4956847c319e8c20812e72Be6814FCCCB6e4723); // Marketing Address
    address payable public teamWalletAddress = payable(0xa4956847c319e8c20812e72Be6814FCCCB6e4723); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 80000000 * 10**_decimals; 
