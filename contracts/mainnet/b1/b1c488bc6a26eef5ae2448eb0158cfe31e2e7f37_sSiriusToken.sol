...
contract sSiriusToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Sirius", "sSRS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSirius supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSirius
