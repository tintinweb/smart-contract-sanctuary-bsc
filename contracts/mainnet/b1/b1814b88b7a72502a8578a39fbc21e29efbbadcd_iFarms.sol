...
contract iFarms is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable, IAccessControlUpgradeable {
    ...
    */
    ...
    /**
     * @dev Creates `amount` tokens for the caller.
     *
     * See {BEP20-_burn}.
     */
    function mint(uint256 amount) external virtual onlyOwner whenNotPaused returns (bool) {
    ...
    /**
     * @dev This function can be called once by owner
     */
    function initializeAccessControl(address iFarmsManager) external whenNotPaused onlyOwner {
        require(!initializedAccessControl, "Already initialized");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(STATE_UPDATER, iFarmsManager);
        initializedAccessControl = true;
    }

    /**
     * @dev Only iFarmsManager will call this function
     *
     * See {BEP20-_mint}.
     */
    function deposit(address user, uint amount) external whenNotPaused onlyRole(STATE_UPDATER) {
        _mint(user, amount);
    }
     ...
     * See {BEP20-_burn}.
     */
    function withdraw(uint256 amount) external whenNotPaused onlyRole(STATE_UPDATER) {
        _burn(_msgSender(), amount);
    }
