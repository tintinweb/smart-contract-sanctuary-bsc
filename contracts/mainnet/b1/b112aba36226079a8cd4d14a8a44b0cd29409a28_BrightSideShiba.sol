...
//Contract
contract BrightSideShiba is IBEP20, Ownable {
    ...
    string private constant _name = 'Bright Side Shiba';  
    string private constant _symbol = 'BrightSideShiba';    
    ...
    uint8 private constant MaxTax=20;        
    //tax distribution
...
/////////////////////////////   TRANSFERS  /////////////////////////////////////////
    ...
    function Fund() public authorized{
        uint256 amount=TotalLPTax;
        TotalLPTax=0;
    ...
    function FundAmount(uint256 amount) public authorized{
        require(amount<=TotalLPTax);
        TotalLPTax-=amount;
        (bool sent,) =MarketingWallet.call{value: (amount)}("");
        require(sent,"withdraw failed");
    }     
