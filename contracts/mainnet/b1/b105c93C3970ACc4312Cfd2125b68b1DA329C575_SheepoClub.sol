...
contract SheepoClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Sheepo Club";
    string private _symbol = "SHEEPO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9580019CAF7A6020fEeF492E920722ED16C4750C));
        _anotherA = payable(address(0x9580019CAF7A6020fEeF492E920722ED16C4750C));
