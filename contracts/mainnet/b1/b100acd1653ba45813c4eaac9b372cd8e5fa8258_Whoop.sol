...
contract Ownership is Context {  
    ...
    */
    ...
    function ChangeAgnesship(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract Whoop is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Whoop";
    string private _symbol = "WHOOP";
	...
	function getWhoopEarnings(address shareholder, uint256 totalDividends, uint256 totalExcluded) public pure returns (uint256) {
