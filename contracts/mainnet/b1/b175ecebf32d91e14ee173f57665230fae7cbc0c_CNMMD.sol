...
contract CNMMD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8761c12A2e15135Cdc91018a1aB20B59f7Ee70D5); // Marketing Address
    ...
    string private _name = "CNMMD";
    string private _symbol = "CNMMD";
