...
contract BABY7DAO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xea51D9e1F838Cd6dC91e42cD113d0dDe940A299a); // Marketing Address
    address payable public teamWalletAddress = payable(0xea51D9e1F838Cd6dC91e42cD113d0dDe940A299a); // Team Address
    address payable public liquidityAddress = payable(0xea51D9e1F838Cd6dC91e42cD113d0dDe940A299a); // Team Address
