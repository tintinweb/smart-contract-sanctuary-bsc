...
//Reddit:           https://www.reddit.com/user/DalmataCoinTeam
//Instagram:        https://www.instagram.com/dalmatacoin/
//YouTube:          https://www.youtube.com/channel/UCrvQhJsbJXaFS7J_g91cjOg

// The first multi-stakes ecosystem,
// place Dalmata Coin and earn multiple consolidated coins
// Purchase fee: 10% = 9% of fees are for ecosystem supply
// and 1% for burning. sales fees: 12% = 9% of fees are for supplying the ecosystem,
// 1% for burning and 2% for purchasing competition where the winner
// will receive 2% of each transaction during the given period.
//Fee for transfers and payments 0%

//Project developer information, CEO                                  
//Linkedin  CEO: https://www.linkedin.com/in/fabiano-martins-b0415a209/
//Instagram CEO: https://www.instagram.com/fabiano_018/
//FaceBook  CEO: https://www.facebook.com/FabianoMartinsSiqueira/
//Twitter   CEO: https://twitter.com/fabiano_meg
//Telegram  CEO: @fabiano_018
//WhatsApp  CEO: wa.me/5518997833951
...
contract DalmataCoin is Ownable {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Dalmata Coin Ecosystem";
    ...
    uint256 public sellTax = 1200; //total sell fee

    uint256 public ecoFee = 900; //ecosystem fee
    uint256 public burnFee = 100; //burnFee 
    uint256 public extraFeeOnSell = 200; //buycompetition Fee
   ...
   function excludeFromFee(address account) public onlyOwner {
    ...
    function setFees(
        ...
        require(
            ...
            "MAX TAX IS 24%"
        ); //max tax is 24% include extra just in trades
        ecoFee = _ecoFee;
        burnFee = _burnFee;
