...
// telegram group : https://t.me/BoredDoge
...
contract BoredDoge is IBEP20, Auth {
    ...
    string constant _name = "Bored Doge";
    string constant _symbol = "Bored Doge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 200; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 200; //2%
    ...
    address private marketingFeeReceiver = 0xeB1487fF558316a8da9837c55a169074BCbE9b7E;
    address private developmentFeeReceiver = 0x12A2778E1C6B3Ac69360d07a4c94087987b344c0;
