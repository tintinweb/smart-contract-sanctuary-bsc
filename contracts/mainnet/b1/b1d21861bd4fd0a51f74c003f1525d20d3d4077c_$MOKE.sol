...
/**
Moonshot launch with Lowgun Paul
...
contract $MOKE is IBEP20, Auth {
    ...
    string constant _name = "The Smoking Area";
    string constant _symbol = "$MOKE";
