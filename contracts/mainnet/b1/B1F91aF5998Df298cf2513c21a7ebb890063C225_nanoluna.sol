...
// TELEGRAM : https://t.me/nanolunabsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
    ...
    uint256 public minDistribution = 1 * (10 ** 16); // 1  minimum auto send
...
contract nanoluna is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "NanoLuna";
    string constant _symbol = "NANOLUNA";
    ...
    uint256 public _maxWallet = 8 * (10**10) * (10 ** _decimals);
