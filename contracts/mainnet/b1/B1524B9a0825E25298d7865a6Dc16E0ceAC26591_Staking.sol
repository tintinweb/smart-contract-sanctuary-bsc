...
contract Staking is Ownable {
    ...
    address public constant trustedStakeTokenAddress = 0x0C0760562e2930E9F06E425A6dB5221aF5940905;
    // trusted reward token contract address
    address public constant trustedRewardTokenAddress = 0x0C0760562e2930E9F06E425A6dB5221aF5940905;
    
    // reward rate per year
    uint public rewardRatePercentX100 = 36000000000000;

    // lockup period
    uint public constant cliffTime = 8760 hours;
    ...
    function unstake(uint amountToWithdraw) public {
        ...
        require(now.sub(stakingTime[msg.sender]) > cliffTime, "You recently staked, your tokens has been locked for 1 year");
