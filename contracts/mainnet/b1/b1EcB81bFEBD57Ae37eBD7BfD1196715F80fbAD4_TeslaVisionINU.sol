...
contract TeslaVisionINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeslaVisionINU";
    string private _symbol = "ARI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xa1A0d212eC5A4d87C9Ca7Fc655dB47d85E1d8eA4);
