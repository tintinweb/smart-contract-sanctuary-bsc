...
contract CAT is Context, IERC20, Ownable {
    ...
    string private _name = "51CAT";
    string private _symbol = "51CAT";
    ...
    uint256 private _totalSupply = 19710628 * 10**_decimals;
    uint256 public _maxTxAmount = 19710628 * 10**_decimals; 
    uint256 public _walletMax = 19710628 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 19 * 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x63915CD765bBe01bAD90E9154f62869f2bB71853));
        ruinWalletAddress = payable(address(0x63915CD765bBe01bAD90E9154f62869f2bB71853));
