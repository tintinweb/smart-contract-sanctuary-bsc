...
contract MCHAMBURGLARINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public HouseAddress = payable(0x790bA3AAa098C697613Ce9843932D149F9e0CA17); // House Wallet Address
    ...
    string private _name = "McHamburglar Inu";
