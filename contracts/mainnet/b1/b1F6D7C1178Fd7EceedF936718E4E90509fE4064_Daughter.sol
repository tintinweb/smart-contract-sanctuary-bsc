...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x641EC142E67ab213539815f67e4276975c2f8D50);
...
contract Daughter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "green monkey";        //1.名字
    string constant _symbol = "GR Monkey";                    //2.缩写
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 4 * 10**20 * 10**_decimals; //3. 总供应量 4 * 10**20 个
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(100);      //4.限购
    uint256 public _maxWalletToken = rSupply.div(100).mul(100);   //5.限制持仓
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = address(0x59cB24D84911F5EA9CB428e571D6f659d1eA5c65);  //6. 营销钱包1
        devFeeReceiver = address(0x2F107584E442a57557a9528F48EC3838B8ca2505);        //7. 营销钱包2
