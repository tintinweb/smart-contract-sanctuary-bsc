...
//telegram : https://t.me/pumpkinflokiportal
interface IERC20 {
...
contract Pumpkinfloki is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5_000_000_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 1_000_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 30_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 1_000_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x4513E79f11fe53BEF30957442D8636BB02a35588;
    address public devAddress = 0x4513E79f11fe53BEF30957442D8636BB02a35588;

    string private constant _name = "PUMPKINFLOKI";
    string private constant _symbol = "PUMPFLOKI";
    ...
    Taxes public taxes = Taxes(0,3,0,1);
    Taxes public sellTaxes = Taxes(2,5,0,1);
    ...
    // Owner cannot transfer out WOOFI from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out WOOFI!");
