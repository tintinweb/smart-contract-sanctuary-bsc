...
/*
CatGirlRedemption ($CGR)

Fusion of trending CatGirl and Redemption token.
SAFU Dev with based team, we aim to reward everyone not just by buying, selling, and holding $CGR.

Telegram: https://t.me/catGirlRedemption
*/
...
contract CGR is Context, IERC20 { 
    ...
    string private constant _name = "CatGirlRedemption"; 
    string private constant _symbol = "$CGR"; 
