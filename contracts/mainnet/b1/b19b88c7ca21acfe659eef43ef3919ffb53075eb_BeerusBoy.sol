...
contract BeerusBoy is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Beerus Boy";
    string private constant _symbol = unicode"BeerusBoy";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x18Bc55Dc43dcad5ca379DD318acDfe44151E6B46);
    address payable public MarketingWallet = payable(0x3cCa1F5Cd08577D25d45463fB18Dd447165d0E4E);
