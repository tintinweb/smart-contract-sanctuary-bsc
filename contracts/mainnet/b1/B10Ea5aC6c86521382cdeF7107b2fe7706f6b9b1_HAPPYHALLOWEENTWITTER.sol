...
TELEGRAM: https://t.me/Happyhalloweentwitter
*/
...
contract HAPPYHALLOWEENTWITTER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HAPPYHALLOWEENTWITTER";
    string private _symbol = " $TITTER "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f4dc6d4d3017f5cA57945819aC64A68d11b2BAE); 
    address payable public teamWalletAddress = payable(0x7f4dc6d4d3017f5cA57945819aC64A68d11b2BAE); 
