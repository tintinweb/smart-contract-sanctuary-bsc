...
contract Koala is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "Koala";
    string constant public symbol = "Koala";
    ...
    function blacklist(address[] calldata addresses, bool isBlacklist) external {
        require(hasBlacklistPermission[msg.sender], "MetaPlay: insufficient permission");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "MetaPlay: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "MetaPlay: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "MetaPlay: transfer called from blacklisted address");
