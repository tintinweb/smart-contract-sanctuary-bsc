...
contract JASMOON is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SecondDividendTracker public dividendTrackerSecond;
    ...
    constructor() ERC20 ("JASMOON", "JASMOON") {
        _buyRewardsFeeFirst = 0;
        _buyRewardsFeeSecond =0;
        _buyLiquidityFee = 0;
		_buyMarketingFee = 0;
        _buyDevFee = 0;

        _sellRewardsFeeFirst = 5;
        _sellRewardsFeeSecond = 5;
        _sellLiquidityFee = 4;
		_sellMarketingFee = 4;
        _sellDevFee = 1;
        ...
        _maxWallet = 100000000000001 * (10**18);
        _maxBuy = 1000000000001 * (10**18);
        _maxSell = 100000000001 * (10**18);
		...
		marketingWallet = payable(0x145F6B9c847294c353247725D8ECE7967a52bc65);
        _devWallet1 = payable(0xc2a2D35eCee4895E830c63cA33dfc9Ffa7Fc17AE);
        _devWallet2 = payable(0x37d0A42e466700Ff333867Ee6d53dD57B30ae278);
        ...
        */
        _mint(owner(), 10000000000000000000000 * (10**18));
    ...
    function updateDividendTrackerFirst(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerFirst), "JASMOON The dividend tracker already has that address");

        FirstDividendTracker newDividendTrackerFirst = FirstDividendTracker(payable(newAddress));

        require(newDividendTrackerFirst.owner() == address(this), "JASMOON: The new dividend tracker must be owned by the JASMOON token contract");
    ...
    function updateDividendTrackerSecond(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTrackerSecond), "JASMOON The dividend tracker already has that address");

        SecondDividendTracker newDividendTrackerSecond = SecondDividendTracker(payable(newAddress));

        require(newDividendTrackerSecond.owner() == address(this), "JASMOON: The new dividend tracker must be owned by the JASMOON token contract");
    ...
    function updateFirstDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenFirst), "JASMOON: The router already has that address");
    ...
    function updateSecondDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsTokenSecond), "JASMOON: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "JASMOON: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "JASMOON: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "JASMOON: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "JASMOON: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "JASMOON: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "JASMOON: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "JASMOON: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "JASMOON: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "JASMOON: Cannot update gasForProcessing to same value");
