...
contract Zamio is ZamioDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ZamioTeam;
    address private CharityZamio;
    ...
    string public override name = "Zamio Meta";
    string public override symbol = "Zamio";
    ...
    constructor(uint totalSupplyValue, address ZamioTeamAddress, address CharityZamioAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ZamioTeam = ZamioTeamAddress;
        CharityZamio = CharityZamioAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ZamioTeam] =  totalSupply * 5 / 100;
        balances[CharityZamio] = totalSupply * 5 / 100;
    ...
    // Get the address of the token's ZamioTeam pot
