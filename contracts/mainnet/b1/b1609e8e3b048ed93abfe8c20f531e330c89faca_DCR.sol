...
contract DCR  is ERC20, Ownable{
    ...
    address public marketingWallet = 0xA20e44C0cf9B164836DAE3C5C17f446e2a6d6b8a;
    ...
    constructor() ERC20("dcrTOKEN", "DCR ") {
        _mint(msg.sender, 100000000 * 10 ** decimals()); // 100000000
