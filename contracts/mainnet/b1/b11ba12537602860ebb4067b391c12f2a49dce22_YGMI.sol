...
Once again this note isn't to sound important I just want to be clear about my intentions/
I used to love the bsc...now I hate it......

Anyone who was here this time last year should know what I mean/
So I made "wagmi" ... sadly  it didn't do as I had intended which is fine.....
so now I'm making YGMI it's more about you this time hopeful this helps it's trajectory...

I don't have any huge ambitions for YGMI as I know where I'm deploying it/
However I've designed Ygmi as a rare gem and community based stronghold in the sea of
capitalist refuse which currently swarms the chain/ I have got a friend to make a telegram 
group for the token t.me/Y_G_M_I

I will join if YGMI reaches 1billion market cap and say "YGMI"/
lol_ thats pretty much it_ ill renounce ca and lock liq forever  due to the  turbulence of 
the year thus far/ 
YGMI is a 100% comunity token with no dev tax_ all tax will go to liq/ and with 1 billion supply
my dream is to see 1 YGMI = 1$ or more.

Large parts of this ive already said as my mind and emotions have hardly shifted.
I hope yours have and we take this to where it should be.
