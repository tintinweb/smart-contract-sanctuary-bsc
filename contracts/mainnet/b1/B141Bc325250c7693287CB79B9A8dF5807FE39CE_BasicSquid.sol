...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C2abE25fFE5eac4196E4f93Bde6a089964655E9; // owner address
...
contract BasicSquid is Context, IERC20, Ownable {
    ...
    string private _name = "Basic Squid";
    string private _symbol = "BSQUID";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B64c36E024708586476803E7eE63DCf92857a41); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C2abE25fFE5eac4196E4f93Bde6a089964655E9); // Team Address
