...
contract TTTNFT is ERC721Enumerable, Ownable {
    ...
    //mint limit
    uint256 public maxMintNftAmount = 100;

    constructor() ERC721("TTT NFT", "TTTNFT") {}
   ...
   /**
    ...
    function mint(
        ...
        _tokenIds.increment();
        require(tokenId < maxMintNftAmount,"out of limit");
