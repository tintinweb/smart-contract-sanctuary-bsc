...
contract SocabetPatched is Ownable {
    ...
    address constant nullAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function createGambling(uint _leagueId, uint _aTeam, uint _bTeam, uint _startTime) external onlyOwner {
