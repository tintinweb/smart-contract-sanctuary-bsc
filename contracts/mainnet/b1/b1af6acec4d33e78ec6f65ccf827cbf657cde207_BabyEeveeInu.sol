...
contract BabyEeveeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Eevee Inu"; // 
    string private constant _symbol = "BABY EEVEE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xC8779C1b97f43a3C5142F763eb90aaF8b1dC20d9;
