...
/**
Missed fucoins?  We are baby fucoin, we will follow daddy
Tokenomics
...
/**
Telegram https://t.me/babyfucoin
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53Ede5f6BEAb7BDACb6DA9832F3485723409A908; // owner address
...
contract BABYFUCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY FUCOIN";
    string private _symbol = "BFCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53Ede5f6BEAb7BDACb6DA9832F3485723409A908); // Marketing Address
    address payable public teamWalletAddress = payable(0x53Ede5f6BEAb7BDACb6DA9832F3485723409A908); // Team Address
