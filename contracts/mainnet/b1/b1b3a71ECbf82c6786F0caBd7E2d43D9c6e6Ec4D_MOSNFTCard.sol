...
contract MOSNFTCard is ERC721, Ownable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    ...
    function buy() external {
        ...
        remained++;
        exchangeToken.safeTransferFrom(msg.sender, address(this), mintFee);

        exchangeToken.approve(address(_router), mintFee);
        _router.swapAndLiquifyUsdt(mintFee);
