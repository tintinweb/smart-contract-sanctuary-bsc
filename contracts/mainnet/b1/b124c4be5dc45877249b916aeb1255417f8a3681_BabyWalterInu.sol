...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x42C1613dD2236CFd60B5cbEc846b5EAD71be99Df); // BUSD
...
contract BabyWalterInu is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x42C1613dD2236CFd60B5cbEc846b5EAD71be99Df; // BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyWalterInu";
    string constant _symbol = "BabyWalterInu";
