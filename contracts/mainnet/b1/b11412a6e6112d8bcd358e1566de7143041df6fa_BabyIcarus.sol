...
// Team with 16K Mc previous project sending this to moonshots level !
...
contract BabyIcarus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Icarus";
    string constant _symbol = "BICARUS";
    ...
    address public Owner=0x7087C35cf299bEBbDF267ba907EDc4846b105aa9; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x7087C35cf299bEBbDF267ba907EDc4846b105aa9;
