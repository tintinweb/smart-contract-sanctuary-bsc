...
/**
                MyChat || Stealth Launch

        MyChat is a product-based search for friends, 
    even lovers near you in a short time according to your wishes.  

            ^Start, Choose, Approve dating.^
 "SPECIAL PERFORMANCE FROM OUR TALENT !! WILL LIVE IN OUR TELEGRAM GROUP"

Telegram    : https://t.me/MyChat_official
Twitter     : TBA
Website     : TBA
...
contract MyChat is Context, IERC20, Ownable {
    ...
    string private constant _name = "MyChat"; // 
    string private constant _symbol = "MICHAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xe49e7D51AE31A212B5997742c55DCEa47FA63Fb6;
