...
contract METAFLOKIR is METAFLOKIRDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private METAFLOKIRTeam;
    address private CharityMETAFLOKIR;
    ...
    string public override name = "METAFLOKIR";
    string public override symbol = "METAFLOKIR";
    ...
    constructor(uint totalSupplyValue, address METAFLOKIRTeamAddress, address CharityMETAFLOKIRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        METAFLOKIRTeam = METAFLOKIRTeamAddress;
        CharityMETAFLOKIR = CharityMETAFLOKIRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[METAFLOKIRTeam] =  totalSupply * 4 / 100;
        balances[CharityMETAFLOKIR] = totalSupply * 4 / 100;
