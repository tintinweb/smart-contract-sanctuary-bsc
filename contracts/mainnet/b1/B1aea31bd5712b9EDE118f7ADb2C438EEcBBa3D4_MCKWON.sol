...
/**
Mc Kwon
The cryptocurrency clown memecoin launch on binance smart chain.

Tax 9/9
Renounced
Lp lock 3days extend at 5K mc
https://t.me/McKwon
*/
...
contract MCKWON is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mc Kwon";
    string private constant _symbol = "MCKWON";
    uint8 private constant _decimals = 6;
    uint256 private _tTotal =  1_000_000_000 * 10**_decimals;

    uint256 public _maxWalletAmount = 5_000_000 * 10**_decimals;
    uint256 public _maxSellAmount = 10_000_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1_000_000 * 10**_decimals;
