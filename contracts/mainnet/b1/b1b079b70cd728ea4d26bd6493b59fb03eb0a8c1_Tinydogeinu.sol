...
contract Tinydogeinu is IBEP20, Ownable {

    using SafeMath for uint256;

    string constant _name = "TinyDogeInu";
    string constant _symbol = "TDInu";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0xEB518da47c6F20360d6524Cf3e93A174d272Fb65;
    ...
    constructor () Ownable(msg.sender) {
        ...
        totalFee = taxFeeVar.add(varMarketingFee).add(rewardsFee);
    ...
    function setMaxTxPercent(uint256 newLimit) external onlyOwner {
        _maxTxAmount = newLimit;
    }

    function setMaxWalletPercent(uint256 newLimit) external onlyOwner {
        _walletMax  = newLimit;
    }
    ...
    function SetAllFeePercent(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external onlyOwner {
        taxFeeVar = newLiqFee;
        rewardsFee = newRewardFee;
        varMarketingFee = newMarketingFee;
    ...
    function SetFeeWallet(address newLiquidityReceiver, address newMarketingWallet, address newanothermarketingWallet) external onlyOwner {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeApplicable = pair == recipient ? varMarketingFee : taxFeeVar;
