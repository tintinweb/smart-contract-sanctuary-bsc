...
contract PowerGrow is ERC20, Ownable {
    uint256 public buyFee = 3;
    uint256 public sellFee = 3;

    address public marketingWallet = 0xF29C95179A5a5C89dc07061Ae24C825e07248bCD;
    ...
    constructor () ERC20("PowerGrow", "PG") 
    {       
        safuOperator = _msgSender();
        transferOwnership(0xF29C95179A5a5C89dc07061Ae24C825e07248bCD);
