...
contract TeslaPaid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tesla Paid";
    string private _symbol = "TSLP";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x34c0EC81a5A480c8C525A14eC7979B2A78635D1C);
