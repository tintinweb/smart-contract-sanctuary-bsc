...
contract SDogeV2 is ERC20 {
	...
	address payable _receive = payable(address(0xA1EC28fbc3F12C246c5F958c7bD60a82c7b3e4F2));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("SDogeV2", "SDogeV2") {
