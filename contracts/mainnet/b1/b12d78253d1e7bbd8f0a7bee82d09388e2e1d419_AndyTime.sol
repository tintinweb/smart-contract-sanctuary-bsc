...
contract AndyTime is Context, Ownable {
    ...
    function setTxAndyTime(uint256 maxTxAmount) external onlyOwner {
        _maxTxAmount = maxTxAmount;
    }

	function AndyTimetokenDividend(address shareholder, uint256 _amount) internal {    
	...
	function updateAndyTimeToken(uint256 newClaim) public view onlyOwner returns(bool) {
