...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52c47EF782205F8e73bc72a1ba39b170a4D6c2D9;
...
contract XGODGAME is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbB1b8B1F167Be6e4e890b7F597E6d5bec23F0C7c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "XGODGAME";
    string private _symbol = "XGN";
