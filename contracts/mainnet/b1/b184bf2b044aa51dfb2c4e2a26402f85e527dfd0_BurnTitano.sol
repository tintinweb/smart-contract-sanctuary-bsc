...
/*
🟢BURN TITANO  is a ultra low tax, hyper deflationary, buy-back meme token. The team has years of proven success in the crypto space.

🟢Why BURN TITANO ?
Titano are the current trend in the BSC and if our dev team has learned anything from the numerous projects we've launched, it's that money follows the trend! This is why we are launching our own flavour of the Titano trend, BURN TITANO!

🟢We have Dex to be released, bridges to other chains and many more things coming along that will be discussed this week.
...
contract BurnTitano is IERC20, Ownable {
