        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0xF78E5b20653854E418b20Bd979387Be0219617bA), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x11E6558533127B9E2E9924693796ce516d174d32),//FundAddress
        address(0x031B03885D2329e9bCA94f1D03dab6A16b42826E)//ReceiveAddress
    ){
    }
}