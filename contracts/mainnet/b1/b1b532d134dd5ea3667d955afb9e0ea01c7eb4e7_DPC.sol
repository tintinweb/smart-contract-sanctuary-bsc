...
contract DPC is IERC20, Ownable {
    ...
    address public meshAddress = address(0xD90f76525B29A8105D84a17e893c50Bff9da1CD8); 
    address public metaverseAddress = address(0x3A4E737a2Afd8c365cf6036Fd20F8688Db228326);
    address public airdropAddress = address(0x1539d6197731808957DEFBac71296403538cAC41);
    address public lpminingAddress = address(0x72c5341c09bEB78DF818d265BB84158752dA8976);
    address public institutionAddress = address(0x1f85bFC0DD6837e30E62a82467d4c4aA1AE3c1D8);
    address public defiAddress = address(0x7DCb82fCAa17722D712D691f0B6037551E277384);
    address public poolAddress = address(0xda2fCEC0Fe983DE57d314c1ff032CFCd6Aa33E75);

    address public lpbonusAddress = address(0xccE2BCd9843bf6f05686EC46A0A1bCE69d9055bF);
    ...
    address public fundAddress = address(0xb3C253f1979CDDBcB5248160A750d26828A8EDD9);
    address public lpAddress = address(0xFEea100eFB424608F56d9ceB1fAE1427e324554b);
