...
contract ECV is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Ecentiv";
    string private constant _symbol = "ECV";
    uint8 private constant _decimals = 4;
    uint private _totalSupply = 8000000000 * 10 ** _decimals;
