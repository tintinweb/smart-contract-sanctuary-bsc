...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7bda55085765296365640734678dFB157f801d22; // owner address
...
contract NewCommunityBRA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community BRA";
    string private _symbol = "NewBRA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7bda55085765296365640734678dFB157f801d22); // 
    address payable public teamWalletAddress = payable(0x7bda55085765296365640734678dFB157f801d22); // 
