...
TG: https://t.me/CheemsGrowOfficial
low tax coin community driven
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2352750F105Fe0Fa6Ff766676a0e2b7e1396279b; // owner address
...
contract CheemsGrowOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheemsGrow Official";
    string private _symbol = "CGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72404B4437787dC6DD92492D1FD98C83De61f581); // Marketing Address
    address payable public teamWalletAddress = payable(0x72404B4437787dC6DD92492D1FD98C83De61f581); // Team Address
