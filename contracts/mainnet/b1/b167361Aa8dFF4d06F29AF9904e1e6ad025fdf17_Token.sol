...
/**
INTRODUCE：
This is a "Rabbit God of Wealth" Meme coin from Hong Kong. 
We will carry out a social experiment, from a very small pool
market value, through people's expectations for the arrival 
of the Year of the Rabbit in 2023 to full wealth. Go on, rich
people. I will eventually become rich through my own efforts 
in 2023 by holding the "rabbit God of wealth".
介绍：
这是一个来自香港的“兔财神”Meme币，我们将进行一场社会性的实验，由极小
的池子市值，通过人们对于2023年兔年的来到报满发财的期望，推向顶峰。去
吧，那些富人。我也终将通过自己的努力在2023通过持有“兔财神”成为富人。
-----------------------------------------


 To contact us please add community ；
 Telegram:https://t.me/+OLMDvqNm5JY0NWQx
 discord:https://discord.gg/9qVzyyeGsX
 ----------------------------------------
We issued a total of 100 million tokens, and taxed 10 percent 
of the marketing fee in the first phase, so that our team could
grow quickly. After the second phase will be changed to 3 percent
marketing and 3 percent added liquidity, the third phase tax will
be adjusted to 1 percent marketing, 5 percent burn, deflation burn
to 1 million. The tax rate will be changed to zero and the listing
will be carried out.
...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "\xE5\x85\x94\xE8\xB4\xA2\xE7\xA5\x9E";
    string private _symbol = "\xE5\x85\x94\xE8\xB4\xA2\xE7\xA5\x9E";
    ...
    uint256 public _maxHavAmount = 10000000 * 10**18;
    ...
    address public _market =0xFE5c6d1EDfe904a76a83Ce75274139509Bf07a00;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x059e161Abc91645E34D849186b0A529626aBCDbA),
            _msgSender(),
            _tTotal
        );
    }
