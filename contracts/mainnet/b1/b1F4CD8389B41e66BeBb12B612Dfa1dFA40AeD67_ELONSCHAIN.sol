...
Telegram: https://t.me/ElonsChain
...
contract Context {
 ...
 contract ELONSCHAIN is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ELONCHAIN";
    string private _symbol = "ELONCHAIN";
    ...
    address private _pancakeRouterV2 = 0x6da7C4338829815B07E720DF4270fc9D8fBe669D;
