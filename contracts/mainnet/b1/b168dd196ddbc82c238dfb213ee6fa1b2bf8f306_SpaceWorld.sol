...
library Address{
  ...
  contract SpaceWorld is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4B70E32F4fb752e8f6f4B9F9bebaeFc963eB34D9;
    address public devwallet = 0x553d715fdf63d48A53679323437f44F96777029c;

    string private constant _name = "SpaceWorld";
    string private constant _symbol = "SPACEWORLD";
    ...
    Taxes public taxes = Taxes(0, 5, 3, 7);
    Taxes public sellTaxes = Taxes(0, 5, 3, 7);
