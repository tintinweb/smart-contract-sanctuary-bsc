...
contract ElonDogeInu is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "ElonDogeInu";
  string constant _symbol = "EDInu";
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0xC53E637Fd437570899b70087bF2A4258b85c991C;
    devFeeReceiver = 0xf521C5fFE21b895953B8Ffd2Da2e8230821229C1;
