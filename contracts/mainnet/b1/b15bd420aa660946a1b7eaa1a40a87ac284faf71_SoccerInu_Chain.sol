...
We are happy to see you all here. We will tell you more about the project , wait patiently as we are all waiting for the WORLD CUP 🏆 and enjoy this ride 🔥

Many Good Callers Have Joined Like GubbinsCalls-Ceasar-Cryptofrog-Beastmode-Batmanscalls and Others

Stealth launch todays 4.30PM - 5 PM UTC

Telegram 

https://t.me/Soccerinuchain
*/
...
contract SoccerInu_Chain is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "SOCCER INU CHAIN";
