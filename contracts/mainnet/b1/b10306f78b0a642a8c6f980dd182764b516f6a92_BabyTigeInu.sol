...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xff426f53679B09e3cA2d908F0086b55e031b2EAe);
...
contract BabyTigeInu is IBEP20, Auth {
    ...
    string constant _symbol = "BABYTIGEINU";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xff426f53679B09e3cA2d908F0086b55e031b2EAe;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x91A32fA618fA135193aC0f23c0F02bc149A3F2bf;
        marketingWallet = 0x006D709EC1c5eD92EDf416FC8c5F4b5F9CB2e1cf;  // marketingwallet
        teamWallet = 0x006D709EC1c5eD92EDf416FC8c5F4b5F9CB2e1cf;  // team
