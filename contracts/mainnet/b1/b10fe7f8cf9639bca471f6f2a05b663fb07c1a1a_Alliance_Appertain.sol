...
Telegram https://t.me/AlltainGlobal
Website https://allianceappertain.org/
*/
...
contract Alliance_Appertain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALLIANCE APPERTAIN";
    string private _symbol = "ALLTAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5301738AC995d0775cBA1337B821E262f79fbf61); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2675DF2e2D8eC812faD5d30AE084CC7B30fA259d); // BuyBack Address
