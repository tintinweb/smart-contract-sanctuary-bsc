...
contract ChickenAi  is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Chicken Ai";
    string private _symbol = unicode"CAI";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xA2f8d781eafDe70C0568f358E6474B3C4EB8C213); 
    address payable public BurnedWalletAddress = payable(0xA2f8d781eafDe70C0568f358E6474B3C4EB8C213); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 7 / 100;  
