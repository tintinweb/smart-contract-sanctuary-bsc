...
/**
https://t.me/ChristmasDogeOFFICIAL OFFICIAL TG DONT FALL FOR FAKE
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0D4cA1920A5f9A4C2BFe9E46c5Aa7952088EFa4; // owner address
...
contract Christmasdoge is Context, IERC20, Ownable {
    ...
    string private _symbol = "Chrisdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42f56B4e190F2aC97F03f6D55A06dDF5CC36797e); // Marketing Address
    address payable public teamWalletAddress = payable(0x42f56B4e190F2aC97F03f6D55A06dDF5CC36797e); // Team Address
