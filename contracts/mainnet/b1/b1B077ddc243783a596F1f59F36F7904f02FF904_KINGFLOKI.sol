...
contract KINGFLOKI is IBEP20, Auth {
    ...
    address marketingFeeReceiver = 0xD183344f87252A23697deb4C1Fe6dA507c6a9e89;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!blacklist[recipient] && !blacklist[sender]);
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        totalFee = _liquidityFee.add(_marketingFee); //liquidity?
    ...
    function setStatus(bool trade) external authorized{
        swapEnabled = trade;
    }

    function setBlacklist(address wallet) external authorized{
