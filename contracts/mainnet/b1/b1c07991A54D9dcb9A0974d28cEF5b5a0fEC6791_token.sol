...
contract token is ERC20 {
    ...
    address public marketAddress = address(0xa6D18D3Be2AB40401e3Ca846fd11D75896A8C586);

    bool tradePause = false;
    bool killBlock = false;
    bool lpLimit = false;

    uint256 public buyLpFee = 60;
    uint256 public buyMarketFee = 40;
    uint256 public sellLpFee = 60;
    uint256 public sellMarketFee = 40;

    uint256 public maxWalletAmount = 10 * 1000 * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "KJST";
    string internal tokenSymbol = "KJST";
    uint256 constant total  = 2100 * 10000 * 10**18;
