...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA18CD04648214ABEBB8cf25749ea63131BeE5cB1; // owner address
...
contract BINANCECHRISTMAS is Context, IERC20, Ownable {
    ...
    string private _symbol = "Binance Christmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x657324Cac0268a61DB7F76e15e3e0b538Ba1569c); // Marketing Address
    address payable public teamWalletAddress = payable(0x4608E7d7FCDe9Ea994edb1EED89E67eDDf7837F9); // BuyBack Address
    ...
    uint256 public _buyTeamFee = 2; // Buyback Fee
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 6;
    uint256 public _sellTeamFee = 2; // Buyback Fee
