...
abstract contract ContextBEP20SAITAMA {
...
contract OwnableBEP20SAITAMA is ContextBEP20SAITAMA {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20SAITAMA: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20SAITAMA: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SAITAMA is ContextBEP20SAITAMA, BEP20SAITAMA, OwnableBEP20SAITAMA {
    ...
    string private _name = 'SAITAMA 2023';
