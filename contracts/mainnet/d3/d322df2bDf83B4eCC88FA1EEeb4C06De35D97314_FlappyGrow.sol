...
/**
Telegram: https://T.me/FlappyGrow
supply : 1 Biilion 
Preburn : 50%
Marketing wallet : 2%
Liquidity: 48%
...
contract FlappyGrow is BEP20, Auth {
    ...
    string public constant name = "FLAPPY GROW";
    ...
    uint256 public swapThreshold = totalSupply / 3600;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2E560fcda7e9b5fddB1436d69baF73Db65ad82C1;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x2E560fcda7e9b5fddB1436d69baF73Db65ad82C1;
        devFeeReceiver = 0x2E560fcda7e9b5fddB1436d69baF73Db65ad82C1;
