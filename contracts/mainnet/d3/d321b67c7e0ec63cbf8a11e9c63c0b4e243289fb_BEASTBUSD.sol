...
contract BEASTBUSD {
    ...
    uint256 constant launch = 1674820800;  // 27th Jan 2023 UTC: 12 PM UTC
    ...
    constructor() {
            owner = address(0x03189ca3eFe2b68EcB10569597D763fc6c056a80);
            dev = address(0x03189ca3eFe2b68EcB10569597D763fc6c056a80);
            PercsKey[10] = DivPercs(864000, 60);
            PercsKey[20] = DivPercs(1728000, 70);
            PercsKey[30] = DivPercs(2592000, 80);
