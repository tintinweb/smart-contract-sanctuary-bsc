...
contract JeetTrackerBot is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jeet Tracker Bot"; //
    string private constant _symbol = "JTB"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0x36147C90514996a92a5f0dDf5E7905D1E4a7a6AA ;
