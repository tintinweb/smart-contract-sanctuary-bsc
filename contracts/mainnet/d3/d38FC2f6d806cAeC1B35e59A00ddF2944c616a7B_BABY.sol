...
Telegram : https://t.me/babymechazilla
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4EeC2fb77Cb9ae41b93D9B52Cf1B5aa65472205B;
...
contract BABY is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY MECHAZILLA"; // 
    string private constant _symbol = "$BABY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x4EeC2fb77Cb9ae41b93D9B52Cf1B5aa65472205B);
