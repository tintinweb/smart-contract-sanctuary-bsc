...
GG Inu is a BSC project where you have the chance to win big, regardless of how the project will go.

Central to the concept is a jackpot pool where 5% of each transaction will be transmitted.  Upon reaching 1,000 holder OR upon dropping to less than $1,000 MC after two days, whichever comes first, a raffle will be held where one winner - and only one winner - will win EVERYTHING inside that jackpot pool!

Hence, whether the project will moon or dust, a loyal holder will have the opportunity to win a significant amount once the conditions are triggered.

IT WILL ALWAYS BE A GOOD GAME (GG) WHETHER OR NOT THE PROJECT THRIVES OR DIES!

Come partake of this revolutionary idea today and give yourself the chance to win huge!
...
contract gginu is Context, IERC20, Ownable {
    ...
    string private constant _name = "GG INU";
    string private constant _symbol = "GG INU";
