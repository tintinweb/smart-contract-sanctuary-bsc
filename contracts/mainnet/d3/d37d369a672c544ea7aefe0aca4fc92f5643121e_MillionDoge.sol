...
contract MillionDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MillionDoge";
    ...
    address payable public marketingWalletAddress = payable(0x794186B033807C4D5a2B72FAd6eaF4f54fD47f61);
    address payable public BuyBackWalletAddress = payable(0xDE26C7739895a614414cb0b0D71ff61005Ab20E6);
    ...
    event BuyBackGetBnb(uint256 amount);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        emit BuyBackGetBnb(amountBNBBuyBack);
