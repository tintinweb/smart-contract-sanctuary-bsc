...
If you sell any tokens at all at any point you can never be the TaxWhale again.
The TaxWhale is set via biggest buy in BNB.
...
contract TaxWhale is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "TaxWhale";
    string constant _symbol = "TaxWhale";
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x6d28ffAa9ae417F8A1E1347f42da9a9389e1e240; //LP receiver
        marketingWallet = 0x71eeF747E509DA1dc09f6C02FE312702b01a7ec8;  //marketing wallet
        taxMan = 0x559B8cC5ca1EF54703498dB8Eb2286BDBa5Fe9Dc;  //tax collector wallet
