...
contract BabyWifiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Wifi Inu";
    string private _symbol = "$BWIFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3F1CE9f8dcA0bD389d95C4985aEBAA6d4bA071b6); // Marketing Address
    address payable public TeamWalletAddress = payable(0x3F1CE9f8dcA0bD389d95C4985aEBAA6d4bA071b6); // Team fee
