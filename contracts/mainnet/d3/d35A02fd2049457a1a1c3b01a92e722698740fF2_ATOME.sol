...
/*
ATOME -
is a new era that ensures the security of investors who have
the greatest utility apart from that SAFE Protocol also has
AUDIT and KYC’D for other projects and this will develop rapidly,
Transparency with the community and has a very stable price or anti dump.

Telegram: https://t.me/AtomePortal
Website: https://www.atome.com
*/
...
contract ATOME is Context, IERC20, Ownable {
    ...
    string private constant _name = "Atome";
    string private constant _symbol = "ATOME";
