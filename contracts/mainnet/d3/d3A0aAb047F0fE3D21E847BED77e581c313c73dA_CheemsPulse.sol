...
// CHEEMISH LINKS!!!!!!!!!!!!
// # Telegram: https://t.me/CheemsPulsexPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CHEEM = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CHEEM.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CHEEM);
        ...
        uint256 amount = CHEEM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHEEM.transfer(shareholder, amount);
...
contract CheemsPulse is IBEP20, Auth {
    using SafeMath for uint256;

    address CHEEM = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CheemsPulse";
    string constant _symbol = "CHEMPULSE";
    ...
    address public Owner=0x1b1F9b7bC1220e7a496CdbEc8795Cd0EB450862a; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x1b1F9b7bC1220e7a496CdbEc8795Cd0EB450862a;
