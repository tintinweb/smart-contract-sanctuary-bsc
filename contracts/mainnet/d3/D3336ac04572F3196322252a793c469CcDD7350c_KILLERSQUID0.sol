...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xA14DF166106e1675657d796c87E8751eAB04041e;
...
contract KILLERSQUID0 is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xA14DF166106e1675657d796c87E8751eAB04041e;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 95000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KILLERSQUID0";
    string private _symbol = "KILLSQUID0";
