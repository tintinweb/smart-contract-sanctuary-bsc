...
pragma solidity ^0.8.0;
contract  IMPROV is ERC20, Ownable {
    ...
    constructor() ERC20("IMPROV", "IMP") {
        _mint(msg.sender, 500000000*10**decimals());
        _mint(address(this), 500000000*10**decimals());
        startSale(block.number, 999999999, 0,2500000*10**decimals(), 20000000);
        startAirdrop(block.number,999999999,10000*10**decimals(),20000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
