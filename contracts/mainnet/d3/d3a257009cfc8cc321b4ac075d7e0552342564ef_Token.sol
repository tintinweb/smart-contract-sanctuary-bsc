...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xee3567dF1B6e18c77786A8Ab62Aa3fDda051C15A);
    string private _name = "BtcLegend";
    string private _symbol = "BtcLegend";
    uint8 private _decimals = 9;

    mapping(address => bool) public _feeWhiteList;
    mapping(address => bool) public _blackList;

    uint256 private _tTotal = 16888 * 10 ** _decimals;
