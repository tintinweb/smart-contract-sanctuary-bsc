...
contract NEKOS  is IBEP20, Auth {
    ...
    string constant _name = "NEKO LUCKY";
    string constant _symbol = "NEKOS";
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: balanceBNB, gas: 30000}("");
