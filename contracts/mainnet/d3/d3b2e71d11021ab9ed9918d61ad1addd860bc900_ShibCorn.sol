...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49E2e7d4C656D1B09681E312cD88b3C4b42A420a; // owner address
...
contract ShibCorn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibCorn";
    string private _symbol = "SHIBCORN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49E2e7d4C656D1B09681E312cD88b3C4b42A420a); // Marketing Address
    address payable public teamWalletAddress = payable(0x49E2e7d4C656D1B09681E312cD88b3C4b42A420a); // Team Address
