...
//https://t.me/BabyBullsWorldOfficial
//tax : 10/12
//10% rewards $BullsWorld
//reward ca: 0x4bd1027c5c83dac320b096868cd1abed8b4e9bc7
//Good luck
...
contract BabyBullsWorl is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyBullsWorl";
    string private _symbol = "BBW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1B662C44c06cA0AE4a10c723a56a96ab90E7851);
    address payable public TeamWalletAddress = payable(0xC1B662C44c06cA0AE4a10c723a56a96ab90E7851);
    ...
    uint256 public _walletMax = 50 * 10**5 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (5 * 10**5 * 10**9), "Max wallet should be more than or euqal to 0.5% totalSupply");
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= (5 * 10**5 * 10**9), "Max wallet should be more than or euqal to 0.5% totalSupply");
        _walletMax  = newLimit;
    }
