...
/*   BNB YIELD - Yield Farming Smart Contract built on BNB Smart Chain.
 *   The only official platform of original BNB YIELD team! All other platforms with the same contract code are FAKE!
 *
 *   [OFFICIAL LINKS]
 * 
 *   ┌────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbyield.net                            │
 *   │                                                            │
 *   │   Twitter: https://twitter.com/bnbyield_tw                 │
 *   │   Telegram: https://t.me/bnbyield_tw                       │
 *   │                                                            │
