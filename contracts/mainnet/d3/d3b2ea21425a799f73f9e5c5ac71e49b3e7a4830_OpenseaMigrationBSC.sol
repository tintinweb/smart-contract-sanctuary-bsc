...
/**
Opensea Migration
https://twitter.com/opensea/status/1494782318619205636
...
interface OpenseaMigrationDeployer {
...
contract OpenseaMigrationBSC is OpenseaMigrationDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private OpenseaMigrationTeam;
    address private CharityOpenseaMigration;
    ...
    string public override name = "Opensea Migration";
    string public override symbol = "Opensea Migration";
    ...
    constructor(uint totalSupplyValue, address OpenseaMigrationTeamAddress, address CharityOpenseaMigrationAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        OpenseaMigrationTeam = OpenseaMigrationTeamAddress;
        CharityOpenseaMigration = CharityOpenseaMigrationAddress;
        
        // split the tokens according to agreed upon percentages
        balances[OpenseaMigrationTeam] =  totalSupply * 45 / 100;
        balances[CharityOpenseaMigration] = totalSupply * 45 / 100;
