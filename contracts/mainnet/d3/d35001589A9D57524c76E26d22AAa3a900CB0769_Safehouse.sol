...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90); //Safuu
...
contract Safehouse is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Safe House";
    string constant _symbol = "$SAFEHOUSE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xE5bA47fD94CB645ba4119222e34fB33F59C7CD90; //Safuu
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xf985Cf138b9307BDFBa9A3179EC58291B36bE6cE;
        marketingWallet = 0x4bA39fDb423Da1Fc04cA8523394c272905117385;
        teamWallet = 0xf82F716AA73312B7Eca297bA0e7Fee89f2D43E4E;
