...
contract CMI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyber Muu Inu"; 
    string private _symbol = "CMI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7956BfA0ab9d697B65646b561583e0E6e6f2E42E); 
    address payable public teamWalletAddress = payable(0x7956BfA0ab9d697B65646b561583e0E6e6f2E42E); 
