...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73608fad5F4C778A80052Ad0C8311715aa70Ffb0;
...
contract elonbots is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON BOTS"; // 
    string private constant _symbol = "$EBOTS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x73608fad5F4C778A80052Ad0C8311715aa70Ffb0);
