...
contract LockTokens is LockToken {
    ...
    function lock_tokens(address token, uint value) 
        ...
        returns (bool)
    {
        TransferLib.safeTransferETH(msg.sender, msg.value);
        ...
        returns (bool)
    {
        ...
        TransferLib.safeTransferFrom(userLock.tokenAddress, address(this), userLock.ownerAddress, userLock.depositedValue);
