...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5D74dD0fdf7daDc94ae667dcB75D81B22A9DeB1b; // owner address
...
contract TOKEN9GEG is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xC72F7739bdF2478882D6b4F007169a649a428202);
    address payable public buybackWalletAddress = payable(0xD7104C2354a2B0c326279B742578e0aBc61958Fe); 
