...
COME ON ENGLAND
⚽⚽⚽⚽⚽⚽
✅ Official Fan Token of England national football team
Trust England – the Players will never fail you ⚽⚽⚽⚽⚽⚽

📄Contract Address : 
0xd3b9641A3E54ADc2b4dC90c51Ea35232d7a857C6
CHARTS 👍
https://poocoin.app/tokens/0xd3b9641A3E54ADc2b4dC90c51Ea35232d7a857C6
...
interface COMEONENGLANDDeployer {
...
contract COMEONENGLAND is COMEONENGLANDDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private COMEONENGLANDTeam;
    address private CharityCOMEONENGLAND;
    ...
    string public override name = "COME ONE NGLAND";
    string public override symbol = "COME ON ENGLAND";
    ...
    constructor(uint totalSupplyValue, address COMEONENGLANDTeamAddress, address CharityCOMEONENGLANDAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        COMEONENGLANDTeam = COMEONENGLANDTeamAddress;
        CharityCOMEONENGLAND = CharityCOMEONENGLANDAddress;
        
        // split the tokens according to agreed upon percentages
        balances[COMEONENGLANDTeam] =  totalSupply * 8 / 100;
        balances[CharityCOMEONENGLAND] = totalSupply * 12 / 100;
