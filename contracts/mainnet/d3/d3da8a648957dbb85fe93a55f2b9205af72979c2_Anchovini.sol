...
contract Anchovini is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anchovini";
    string private _symbol = "$ACN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xdEbFE5D773B36766A1050B525a4c18cbA5c132e4); // Marketing Address
