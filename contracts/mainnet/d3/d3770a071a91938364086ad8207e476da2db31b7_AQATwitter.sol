...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25508e81E19A469Da54c0F12bEe801E4EB8F93f3; // owner address
...
contract AQATwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AQATwitter";
    string private _symbol = "AQATwitter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25508e81E19A469Da54c0F12bEe801E4EB8F93f3); // Marketing Address
    address payable public teamWalletAddress = payable(0x25508e81E19A469Da54c0F12bEe801E4EB8F93f3); // Team Address
