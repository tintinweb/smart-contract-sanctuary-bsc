...
contract WORLD is ERC20, Ownable {
    ...
    constructor() ERC20("WORLD", "WORLD") {
        ...
        usdtw1 = address(0x8E5994427437f5F7D5398d0785817A487258a9f8);
        usdtw2 = address(0x3A2F0613902997AfFFD16e40EB6172e2A7913297);
    ...
    function _tokenTransfer(
        ...
        if (
            ...
            uint256 rewardPoolBalance = IERC20(tokenB).balanceOf(
            ...
            if (_rate > markRate) {
                ...
                for (uint256 i = 0; i < diffRate; i++) {
                    ...
                    if (rewardb > 0) {
                        rewardWallet.withdraw(tokenB, rewardb);
        ...
        if (sender == uniswapV2Pair && takeFee) {
            ...
            if (rewardFee > 0) {
                ...
                _balances[address(rewardas1)] += rRewardTokens;
                emit Transfer(sender, address(rewardas1), rewardTokens);
            }
    ...
    function _swap() private lockSwap {
        ...
        rewardas1.withdraw(address(this));
        swapTokensForTokenB(balanceOf(address(this)), address(rewardWallet));
