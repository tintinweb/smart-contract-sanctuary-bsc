...
contract MissSixty is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "MissSixty";
    string private _symbol = "MissSixty";
        ...
        onlyOwner
    {
     ...
     function newsupplydata(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
    ...
    function foudationaddress(uint256 maxTXPercentage) external onlyOwner {
