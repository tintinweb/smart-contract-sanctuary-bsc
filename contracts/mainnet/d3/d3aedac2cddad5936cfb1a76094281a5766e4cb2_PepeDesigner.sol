...
contract PepeDesigner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Designer";
    string private _symbol = "PeDesigner";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfa2838E9767edFFE485AfF7788cC5d6dE0ab1899);
    address payable public BuyBackWalletAddress = payable(0xfa2838E9767edFFE485AfF7788cC5d6dE0ab1899);
