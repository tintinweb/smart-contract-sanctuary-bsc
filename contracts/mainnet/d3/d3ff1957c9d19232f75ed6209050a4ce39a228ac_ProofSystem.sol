...
✅ProofSystem✅
ProofSystem is corporations to audit their smart contracts at an affordable cost. Want to speed up your audit process? Then you’ve come to the right place 

Proof System is an ecosystem that was born from the Binance smart chain
...
// Telegram : https://t.me/ProofSystem
// Website : https://proofsystem.org
// Twitter : http://twitter.com/ProofSystemBsc/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe193Cc6FF27fae363E2D449efe420d32B85E24C9;
...
contract ProofSystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ProofSystem ";
    string private _symbol = " Proof ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBE2FC80f74E70fA85fD5F71eD5FEcD22385A7885);
    address payable public teamWalletAddress = payable(0xBE2FC80f74E70fA85fD5F71eD5FEcD22385A7885);
