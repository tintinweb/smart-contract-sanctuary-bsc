...
/*
Telegram: t.me/ToothLessTiger
we've tammed the tiger. He won't bite, so ape freely 😍
More ups than downs 🐯 he leaps..
...
/* Token contract */
contract ToothLessTiger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2C987F6079167757D2b144b35216473cda3ce05E;
    ...
    // Name and symbol
    string constant _name = "ToothLessTiger";
    string constant _symbol = "TLT";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1_000_000 * 10 ** _decimals; // 1mil

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% (30 k)
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1.5% (15 k)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% (30 k)
