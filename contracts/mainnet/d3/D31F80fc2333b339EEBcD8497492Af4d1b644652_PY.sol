...
contract  PY is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply =  52000000 * 10**_decimals;
    uint256 public _maxTxAmount =   52000000 * 10**_decimals; 
    uint256 public _walletMax =    52000000  * 10**_decimals;
