...
🔥Website: http://viasyli.com/
🔥Twitter: https://twitter.com/viasylil
🔥Telegram: https://t.me/viasylil
🔥Viasyl is an Automated Market Maker (AMM), and the Exchange is at the heart of Viasyl. Viasyl is the leading AMM on the BNB Smart Chain, and as statistics tell, the most innovator Decentralized Exchange (DEX) ever! 

🔥The Viasyl Exchange offers several features that support decentralized trading: 
🔹 Swapping/Trading
Viasyl lets users trade without the need to go through a Centralized Exchange. 
🔹 Liquidity Pools
You can only swap tokens on Viasyl if there is enough liquidity for those tokens. 
🔹 Yield Farming
Yield farming lets users that are providing liquidity earn PYKA rewards by locking their LP tokens into a smart contract. 
🔹 LaunchPad and MetaGame Launchpad
An LaunchPad and MetaGame Launchpad is an event that lets users buy into a limited-time offer to purchase new tokens. 
*/
...
contract Viasyl is ERC20DividendToken {
