...
/**
Welcome to FIFA Floki, mascot of the 2022 World Cup!
Join our telegram at: @FIFAFlokiOfficial
*/
...
contract FIFAFloki is IBEP20, Ownable {
    ...
    string constant _name = "FIFAFloki"; // To Do
    string constant _symbol = "FFloki"; // To Do
    ...
    address public marketingFeeReceiver = 0x96deB4437Fd3d9B5F51E46513715aD5CFEfe777C;
    address public devFeeReceiver = 0x96deB4437Fd3d9B5F51E46513715aD5CFEfe777C;
    address public buybackFeeReceiver = 0x96deB4437Fd3d9B5F51E46513715aD5CFEfe777C;
