...
/*
    telegram : https://t.me/squidmineportal
*/
...
contract Squidmine is IBEP20, Auth {
    ...
    string constant _name = "Squid Mine";
    string constant _symbol = "Squidmine";
    ...
    address public marketingFeeReceiver = 0x295938794bd9ef22DD6fDbBC58B26340fb39FcD1;
    address public devFeeReceiver = 0x295938794bd9ef22DD6fDbBC58B26340fb39FcD1;
    ...
    bool private opCE = true;
    uint8 private cTi = 5;
    mapping (address => uint) private cT;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair &&
            ...
            require(cT[recipient] < block.timestamp,"Please wait for 1min between two operations");
            cT[recipient] = block.timestamp + cTi;
        }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function CE(bool _status, uint8 _int) public authorized {
        opCE = _status;
        cTi = _int;
    }
