...
/**
  $EPIGGY is a non-fungible token (NFTs) composed of thousands of unique visual features and character bases. 
  Each EPIGGY is unique and exclusive based on hundreds of rare traits. 
  The final goal is to build an exclusive and chill community.

 Website: https://epiggy.io/

 https://t.me/epiggyofficial
...
pragma solidity ^0.6.12;
    ...
    contract EPIGGY is Context, IERC20, Ownable {
        ...
        string private _name = 'EPIGGY';
        string private _symbol = 'EPIGGY';
