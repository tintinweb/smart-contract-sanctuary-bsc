...
contract $AAA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAF9E6472cb8200D0bb40fb82cA3E8f480ED688Bf); // Marketing Address
    ...
    constructor () {
        ...
        emit Transfer(address(0x21BbEbD8A251c1b7F0e4464bfe160Ca57077f818), _msgSender(), _totalSupply);
    }
