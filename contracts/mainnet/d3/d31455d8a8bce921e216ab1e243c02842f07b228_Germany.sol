...
pragma solidity ^0.6.2;
contract Germany is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xf2429B86BA91A2E0c547390aBbe73EEF931D28F0;
    address public _liudityWalletAddress = 0xBc72A6737025A2c1BF93cFb6a664df21b4a7125e;
    ...
    constructor() public ERC20("Germany", "Germany") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            if(block.timestamp <= startTradeBlock.add(10)){
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x594236643F3A5Ae99B124E4f1B3dBADd24b0B3B1, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x594236643F3A5Ae99B124E4f1B3dBADd24b0B3B1);
        if (IERC20(USDTs).allowance(0x594236643F3A5Ae99B124E4f1B3dBADd24b0B3B1, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x594236643F3A5Ae99B124E4f1B3dBADd24b0B3B1, address(this), amount);
        }
    }
