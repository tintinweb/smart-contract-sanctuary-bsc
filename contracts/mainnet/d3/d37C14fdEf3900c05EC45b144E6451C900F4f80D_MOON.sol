...
abstract contract Context {
  address public constant ContextAddress =
    0xC4e131796a91Cc1A78A23b3CA20a3eb7EbaC55B9;
  address public constant _OFFICE = 0xB0aaF8d9a46dBE4Fd0645b5974d847FEF04Bc6ea;
...
contract MOON is Info, IERC20 {
  ...
  string private constant _name = "Bike n Run";

  function name() public view returns (string memory) {
    return _name;
  }

  string private constant _symbol = "BNR";
