...
contract MRMUU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MR. MUU";
    string private constant _symbol = unicode"MRMUU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xc3cF983506699ba37A5f55960F230eF1Fb3b91B9);
    address payable public MarketingWallet = payable(0xc3cF983506699ba37A5f55960F230eF1Fb3b91B9);
