...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x44a743A0fa7c0e37518f642aa5aBe51026b93cD7; // owner address
...
contract BabyCR7inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby CR7 INU";
    string private _symbol = "BCR7";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x44a743A0fa7c0e37518f642aa5aBe51026b93cD7); // Marketing Address
    address payable public teamWalletAddress = payable(0x44a743A0fa7c0e37518f642aa5aBe51026b93cD7); // Team Address
