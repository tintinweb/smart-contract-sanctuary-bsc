...
contract KandyPool is Ownable, ReentrancyGuard {
    ...
    uint256 public priceTarget = 1e16; // = 1; 1 XToken pegged to the value of 0.01 BNB
    uint256 public priceBand = 5e13; // = 0.00005; CR will be adjusted if XToken > 0.01005 BNB or XToken < 0.00995 BNB
    uint256 public minCollateralRatio = 1e6;
    uint8 public constant pegratio = 100;
