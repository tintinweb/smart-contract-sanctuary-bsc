...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract SuperDoge is IBEP20, Auth {
    ...
    string constant _name = "SuperDoge Inu";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && !isUtilityContract[recipient] && !isUtilityContract[sender] && recipient != address(this) && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
    ...
    event AutoLiquify(uint256 amountNATIVE, uint256 amountSD);
}