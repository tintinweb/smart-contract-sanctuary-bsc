...
contract NewCommunitySLP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community SLP";
    string private _symbol = "$cSLP";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x16658D44a772ecD8447739BFC3e0Ca61D761547A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x47F0e63b08138Da606cC39F5E0680F35E875Ae8c); // BuyBack Address
