...
/**
Welcone  To Cake ShibaINU
CakeShibaINU - $CAKEINU is a meme token with an auto claim reward system of $CAKE every hour 
and also has a small tax on every transaction.
CakeShibaINU - $CAKEINU A token meme that the shiba inu community and dog lovers will control.

Join our Telegram : https://t.me/CakeShibaINU
...
contract CakeShibaINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cake Shiba INU"; //
    string private constant _symbol = "CAKEINU "; //
