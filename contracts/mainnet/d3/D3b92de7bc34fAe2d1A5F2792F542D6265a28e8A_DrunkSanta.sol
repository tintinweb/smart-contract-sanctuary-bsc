...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9be823A6E89B00BbB50B06c534C51B5aC9edc975; // owner address
...
contract DrunkSanta is Context, IERC20, Ownable {
    ...
    string private _name = "DrunkSanta";
    string private _symbol = "DRUNKSANTA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9be823A6E89B00BbB50B06c534C51B5aC9edc975); // Marketing Address
    address payable public teamWalletAddress = payable(0x9be823A6E89B00BbB50B06c534C51B5aC9edc975); // Team Address
