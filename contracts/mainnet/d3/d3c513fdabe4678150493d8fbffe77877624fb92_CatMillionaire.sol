 ...
 * NEXT BSC MOONSHOT TOKEN : Cat Millionaire
 * Join our official tg : https://t.me/CatMillionaire
 */
...
contract CatMillionaire is IBEP20, Ownable {
 
    // Basic Contract Info
    string private constant _name = "CatMillionaire";
    string private constant _symbol = "CATMI";
    ...
    uint256 _maxTxAmount = _totalSupply/1000*15; // 1,5%
    ...
    address private marketingWallet=0x7Cd11B67BF632451A4C1bB8FC9D891DeEff943b7;
    address private teamWallet=0x7Cd11B67BF632451A4C1bB8FC9D891DeEff943b7;
