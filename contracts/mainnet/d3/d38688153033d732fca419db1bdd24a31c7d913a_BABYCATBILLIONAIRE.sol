...
contract BABYCATBILLIONAIRE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA75eecb74E2bE24dF9F1ea7E7138518aA5dF6216); // Marketing Address
    address payable public DevWalletAddress = payable(0xFad64C296475cd83C916b9c001525606516cB853); // Dev fee
