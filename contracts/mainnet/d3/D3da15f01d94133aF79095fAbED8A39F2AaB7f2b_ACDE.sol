...
contract ACDE is Context,IERC20Metadata {
    ...
    string private constant _name = "ACDE";
    string private constant _symbol = "ACDE";
    uint256 private constant _totalSupply = 3330000 * 1e18;
    ...
    uint public constant transferBurnRate = 50;
    uint public constant transferLpShareRate = 50;

    uint public constant swapLiquidityRate = 50;
    uint public constant swapBurnRate = 50;
    uint public constant swapLpShareRate = 100;


    address public constant lpShareFeeTo = address(0xcE5BF59De981cdD91D67B648806654F7728863c5);
    address public constant liquidityFeeTo = address(0x93fE5D7820e6e31e397Fa2fec3E2E525F78161F1);
    ...
    constructor(
        ...
        address holder = _initSupplyHolder == address(0) ? msg.sender : _initSupplyHolder;
    ...
    function _transfer(
        ...
        if(recipient != address(0)){
            bool isSwap = isSwapPair(sender) || isSwapPair(recipient);
            
            uint liquidityAmount = isSwap ? amount.mul(swapLiquidityRate)/10000 : 0;
            recipientAmount -= liquidityAmount;
            _takeFee(sender, liquidityFeeTo, liquidityAmount);
            
            uint lpShareAmount = isSwap ? amount.mul(swapLpShareRate)/10000 : amount.mul(transferLpShareRate)/10000;
            recipientAmount -= lpShareAmount;
            _takeFee(sender, lpShareFeeTo, lpShareAmount);

            uint burnAmount = isSwap ? amount.mul(swapBurnRate)/10000 : amount.mul(transferBurnRate)/10000;
