...
Launching in few minutes by a Based Well connected DEV.
⚽Low Mc Degen Play 
⚽ Tax ( 5% In / 5% Out )
⚽ Renounce ownership.
————————————————————————————
⚽ Hyped strong name
⚽ LP locked 100% ( 10 Days ) 
⚽ Good marketing plan 
⚽ Bullish community 

👀Big Names will be Pushing this up 👀.

TG : https://t.me/CzShaolinsoccer
*/
...
contract CZShaolinSoccer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZ SHAOLIN SOCCER";
    string private _symbol = "$CZSOCCER";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x2ABad0CC68969c1aBB64225fBE5e8705dD2e6Ad7;
    address public developerWallet = 0x2ABad0CC68969c1aBB64225fBE5e8705dD2e6Ad7;
