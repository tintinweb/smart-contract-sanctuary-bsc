...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43103c81Bbf3A746236594a373f0183D42272aF7; // owner address
...
contract PIGMAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIG MAN";
    string private _symbol = "PIGMAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B0017a82Dd153a5c522FE020573956BC5D4EF50); // Marketing Address
    address payable public teamWalletAddress = payable(0x4B0017a82Dd153a5c522FE020573956BC5D4EF50); // Team Address
    ...
    uint256 public _walletMax = 4_000_000_000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 500_000_000 * 10**_decimals; 
