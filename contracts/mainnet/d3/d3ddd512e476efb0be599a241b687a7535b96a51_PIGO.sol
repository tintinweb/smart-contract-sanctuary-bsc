...
library Address{
 ...
 contract PIGO is IERC20, Context, Ownable {
    ...
    uint256 public PIGO_max_BuyLimit = 20000000000 * 10**9;
    uint256 public PIGO_max_SellLimit = 20000000000 * 10**9;
    ...
    function PIGO_Update_MarketingWallet(address newWallet) external onlyOwner{
        PIGO_Wallet = newWallet;
    }
    
    function PIGO_Update_TeamWallet(address newWallet) external onlyOwner{
        PIGO_Wallet = newWallet;
    }
    ...
    function PIGO_Max_Walletlimit(uint256 amount) external onlyOwner{
