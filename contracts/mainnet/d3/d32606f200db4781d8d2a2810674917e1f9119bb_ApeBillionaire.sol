...
contract ApeBillionaire is ERC20, Ownable, SafeToken {
    ...
    constructor() ERC20("ApeBillionaire", "APE BIO") {
        liquidityFee = 1;
        DevFee = 10;
        DevWallet = payable(0x96A2F86e43D2a778bb64d8Fe1103e2124d1211EC);
