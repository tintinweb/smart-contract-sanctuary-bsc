...
contract DogeZilla is Ownable, IBEP20 {
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x67e632393EB7aabD9740560A5C005982D7F57b17;
        marketingWallet =0xFA0DfAC2a808f09010c898C00c8D2A28b8821DeF; // DogeZilla Marketing Wallet
    ...
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 7, "Max gas should be higher than 1 gwei");
        gas = newGas * 7 gwei;
    }
