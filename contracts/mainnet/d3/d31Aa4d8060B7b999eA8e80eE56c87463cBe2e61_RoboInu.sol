...
contract  RoboInu is IBEP20, Auth {
    ...
    address DEV =  0x0dF10B74D63FcD521Cf49dA6c8E9096338424CF1;
    ...
    // Max wallet and TX
    uint256 private  _maxBuyTxAmount = _totalSupply * 100 / 1000; 
    uint256 private _maxSellTxAmount = _totalSupply * 100 / 1000; 
    uint256 private _maxWalletToken = ( _totalSupply * 100 ) / 1000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0dF10B74D63FcD521Cf49dA6c8E9096338424CF1;
