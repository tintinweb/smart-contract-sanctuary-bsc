...
*/
 ...
 /** THEBABYBOYSTOKEN 
    ...
    Based on the Boys  Series by Amazon Prime Video ! 

    Riding the hype around the Amazon Prime Video Tv Series “ The Boys “ we are building a strong community by gathering fans around the globe. 
    Newbies (offline fans of “The Boys”) and OGs in the crypto space are showing love to the project.
...
// TG: https://t.me/TheBabyBoysToken
...
contract THEBABYBOYSTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "The BabyBoys Token";
    string private constant _symbol = "$bBOYS";
    ...
    address private marketingWallet = address(0x414F9275e946e12a75cC271136338b558e422155);
    address private liquidityReceiver = address(0x42Fc0cC0AdfC8a66327A20D77CD4aa415ac2874a);
