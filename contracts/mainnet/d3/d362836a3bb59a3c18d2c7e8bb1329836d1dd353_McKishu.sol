...
Welcome McKishu
   ...
   Degen play, I make this cause Elon Musk tweeted it. If you want to create a telegram I suggest to name it to @McKishu_Coin
...
contract McKishu is Context, IERC20, Ownable {
    ...
    string private _name = "McKishu";
    string private _symbol = "McKishu";
