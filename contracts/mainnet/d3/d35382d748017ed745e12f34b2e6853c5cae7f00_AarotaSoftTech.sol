...
contract AarotaSoftTech is Context, IERC20, Ownable {
    ...
    string private _name = "Aarota Soft Tech";
    ...
    address payable public marketingWallet = payable(0xd0D0B60E3fA63d7ec09A83Db2D1324a7343044b9);
    ...
    function setTaxFeePercent(uint256 liquidityfee,uint256 Marketingfee) external onlyOwner() {
