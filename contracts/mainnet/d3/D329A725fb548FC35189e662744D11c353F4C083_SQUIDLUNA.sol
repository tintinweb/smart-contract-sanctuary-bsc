...
//TELEGRAM : https://t.me/SquidLunaToken
...
contract SQUIDLUNA is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    uint256 public _maxWalletSize = (_totalSupply * 100) / 10;  // 100% 
    ...
    uint256 constant marketingFee = 30; 
    uint256 constant giveawayFee = 10;  
    uint256 constant liquidityFee = 10; 
    uint256 constant charityFee = 0; 
    uint256 constant devFee = 0;     
    uint256 constant totalFee = 50;  
    ...
    constructor (string memory _nameParam, string memory _symbolParam, uint256 _duration) payable {
        ...
        smallSwapThreshold  = _totalSupply.mul(6745937).div(10000000);
        largeSwapThreshold = _totalSupply.mul(7164451).div(10000000);
