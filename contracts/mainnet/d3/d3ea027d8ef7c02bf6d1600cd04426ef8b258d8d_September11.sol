...
contract September11 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "11 September";
    string constant _symbol = "911";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 11092001 * (10 ** _decimals);
    ...
    address public charityFeeReceiver = 0xaD63c909B5197fEa7A92Dbd44F6FA0072cB43937;
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBCharity}() {} catch {}
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _charityFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        charityFee = _charityFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_charityFee).add(_marketingFee);
