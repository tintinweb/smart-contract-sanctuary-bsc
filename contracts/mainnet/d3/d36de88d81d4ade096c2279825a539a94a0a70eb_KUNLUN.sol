...
contract KUNLUN is ERC20 {
    ...
    uint256 private lpIntervalTime = 60 * 60;
    ...
    address public marketAddress = 0x822e6dF75d412B626443805f67456f7A6c0F8dC4;
    address public liquidAddress = 0xf656f32e03ED77c4983003D050Ea4879F8F866C4;
    ...
    string internal tokenName = "KUNLUN";
    string internal tokenSymbol = "KUNLUN";
    uint256 constant total  =  21000 * 10**18;
    ...
    constructor(address tokenOwner) ERC20(tokenName, tokenSymbol) { 
        ...
        swapTokensAtAmount = total / 1000000;
    ...
    function transReward(bytes memory data) internal {
    ...
    function _transfer(
        ...
        if (takeFee) {
            require(!tradePause || isAddLdx, "trade Pause");

            if(to == uniswapV2Pair || from == uniswapV2Pair ){

                uint256 allFee = amount.div(1000).mul(lpFee + liquidFee + marketFee);
                uint256 cmarketCount = amount.div(1000).mul(marketFee);
                ...
                amount = amount.div(1000).mul(1000 - (lpFee + liquidFee + marketFee));
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        ILiquidity(pool).addLiquidity(otherHalf,newBalance);
    }

    function swapAndTransfer(uint256 contractTokenBalance) internal {
