...
contract MONRISE is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MONRISE";
    string private _symbol = "MONRISE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x802862120F1D98F65f043d7428D4d9e1ebbAF0cd);
    address payable public liqWalletAddress = payable(0x802862120F1D98F65f043d7428D4d9e1ebbAF0cd);
    ...
    uint256 private minimumTokensBeforeSwap = 500e5 * 10**_decimals;
