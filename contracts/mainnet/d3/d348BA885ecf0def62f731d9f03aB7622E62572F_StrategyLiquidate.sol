...
// File: contracts/StrategyLiquidateWombat.sol
...
contract StrategyLiquidate is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IUniswapV2Router02 _router, IWombatRouter _wombatRouter) public {
        router = _router;
        weth = _router.WETH();
        ...
        nonReentrant
    {
        ...
        lpToken.safeApprove(address(wombatRouter), uint256(-1));
        wombatRouter.withdraw(fToken, lpToken.balanceOf(address(this)), 0, address(this), now);
