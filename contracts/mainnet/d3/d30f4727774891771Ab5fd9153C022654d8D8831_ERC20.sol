...
contract ERC20 is Context, IERC20, Ownable {
    ...
    string private _name = 'CryptoPlant Token';
    string private _symbol = 'CPC';
    uint8 private _decimals = 18;
    uint256 public _maxBlack = 100_000 * 10**18;
    ...
    constructor () public {
        ...
        address pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c));
