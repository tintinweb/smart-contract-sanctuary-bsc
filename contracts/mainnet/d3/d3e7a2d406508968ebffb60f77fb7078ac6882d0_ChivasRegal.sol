...
contract  ChivasRegal is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chivas Regal ";
    string private _symbol = "CHIVAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFA563b15c8f75eA3B69320c22Fd1cA6bcADA971f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFA563b15c8f75eA3B69320c22Fd1cA6bcADA971f); // BuyBack Address
