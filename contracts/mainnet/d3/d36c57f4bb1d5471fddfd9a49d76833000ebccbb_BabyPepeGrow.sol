...
t.me/babypepegrowofficial

$BPG Baby Pepe Grow is a reward token of $PG Pepe Grow. A passive earning of $PG just by holding no need to stake.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x580f8781857Bc3bEb7C7c193D56fDa05274030d0); //the reward token you want distributed 
...
contract BabyPepeGrow is IBEP20, Auth {
    ...
    address REWARDS = 0x580f8781857Bc3bEb7C7c193D56fDa05274030d0; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0xd9282Ebf6b14e90A58E66E9CA108Bf5fe865B2a1;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 3000; // will start swapping once 0.05% of supply is in the swap wallet
    bool inSwap;
