...
contract RabbitGirl is Ownable, IBEP20 {
    ...
    string constant _name = "Rabbit Girl";
    string constant _symbol = "RGIRL";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xEEf3EA6F6f1e6229943EC3b553fEE9187ac1d1CB;
        marketingWallet = 0x800d0dE11B15EeC54F5D9add1c3322Cbd214874A;
        devWallet = 0xEEf3EA6F6f1e6229943EC3b553fEE9187ac1d1CB;
    ...
    function setGas (uint256 newRent) external onlyOwner {
        require (newRent > 8, "Max gas should be higher than 8 gwei");
        gas = newRent * 1 gwei;
    }
