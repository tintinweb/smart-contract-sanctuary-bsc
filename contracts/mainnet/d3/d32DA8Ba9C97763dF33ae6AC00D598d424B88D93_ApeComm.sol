...
// Telegram: https://t.me/MegaApeCommunity
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57298A8C699275BaD1587be6a7ff9B091469C5e1; // owner address
...
contract ApeComm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mega Ape Community";
    string private _symbol = "Mega";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xdE01331DB3a8B107DDcC06C95c332B916215b2A3); 
    address payable public teamWalletAddress = payable(0xdE01331DB3a8B107DDcC06C95c332B916215b2A3);
