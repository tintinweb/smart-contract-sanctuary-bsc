...
contract NFTmint is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    uint256 public MAX_NFT = 80;
    uint256 public MAX_BY_MINT = 1;
	uint256 public PRICE = 80000 * 10**18;
    ...
    event CreateMoonster(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Moonsters", "MOONSTER") {
        Token = IBEP20(0x4198F3234d600eC736E5b1d3E1646A5b49105311);
        setBaseURI(baseURI);
        pause(true);
    }
    ...
    function mint(uint256 _count) public saleIsOpen {
        ...
        require(_amount >= price(_count), "Value below price");
    ...
    function setToken(IBEP20 _newtoken) public onlyOwner {
