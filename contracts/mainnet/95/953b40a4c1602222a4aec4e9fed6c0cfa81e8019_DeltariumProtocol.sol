...
deltarium is a decentralized project that is on the BSC network, deltarium will also build an ecosystem for the benefit of the project and the community

   https://t.me/DeltariumProtocol
...
contract DeltariumProtocol is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x14e7F9d4bdD22727d04165A56AF547807Fd00006));


    string private _name = "Deltarium Protocol";
    string private _symbol = "DLRM";
