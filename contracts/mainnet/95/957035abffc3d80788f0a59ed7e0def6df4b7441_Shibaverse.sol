...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("Shibaverse", "SHIBV", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract Shibaverse is Main {

    constructor() Main (
        "Shibaverse",       // Name
        "SHIBV",        // Symbol
        9,                  // Decimal
        0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,     // Reward 1
        0x742d581bF33dc415D35894FFD080d63A65C55971,     // Marketing address
        0x742d581bF33dc415D35894FFD080d63A65C55971,     // Team address
        0x742d581bF33dc415D35894FFD080d63A65C55971,     // Multi Use address
