    ...
    PaymentSplitter 
{
    ...
    string public baseURI = "ipfs://QmYagQUa1RL4AcmRsyGyRiGjzzxYmn5rYp16MRhgD1fHQL";
    ...
    uint256 _price = 1000000000000000; // 0.01 ETH

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [80, 20]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0xa6E9F53529E389A6596cD5c776F3e8c8CBEc8617, // Admin Account gets 25% of the total revenue
        0x05B6e0f209D3CF88550329dA0e858F485b78a16b // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("SmartChainApes", "APE")
