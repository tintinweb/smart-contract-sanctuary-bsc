...
contract Chips is Context, IERC20, Ownable {
    ...
    string private _name = "CHIPS";
    string private _symbol = "Chipotle";
    ...
    uint256 public _liquidityFee = 500; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _boostedLiquidityFee = 700;
    ...
    address public burnAddress = 0x89bfDa44beDd596Beb398517D69eFE7686C65f23;
    address payable private _marketingWallet = payable(0xa25f0dC95291bDa10D6F775A71EfCb65d92ACF4D);
    address payable private _devWallet = payable(0x89bfDa44beDd596Beb398517D69eFE7686C65f23);
    ...
    uint256 private maxTxDivisor = 800;
    ...
    uint256 private maxWalletDivisor = 400;
