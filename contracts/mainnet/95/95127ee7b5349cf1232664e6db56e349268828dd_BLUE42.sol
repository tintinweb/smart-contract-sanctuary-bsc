...
contract BLUE42 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x896118d76dA9c80d58099c65367eC7Fa91c25685;
    ...
    // Name and symbol
    string constant _name = "BLUE 42";
    string constant _symbol = "BLUE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 424242 * (10 ** _decimals); // 424,242 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 15 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 15 / 10000; 
    ...
    // Blue Rabbit
    uint256 BLUETriggeredAt;
    uint256 BLUEDuration = 3600;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x896118d76dA9c80d58099c65367eC7Fa91c25685;
        marketingFeeReceiver = 0x896118d76dA9c80d58099c65367eC7Fa91c25685;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Check if we are in BLUETime
        bool BLUEMode = inBLUETime();
        ...
        uint256 amountReceived = shouldTakeFee(sender) ? takeFee(sender, amount, isSell, BLUEMode) : amount;
    ...
    // Check if we are in BLUE time
    function inBLUETime() public view returns (bool){
        if(BLUETriggeredAt.add(BLUEDuration) > block.timestamp){
            return true;
        } else {
            return false;
        }
    ...
    // Enable BLUE
    function enableBLUE(uint256 _seconds) public authorized {
        BLUETriggeredAt = block.timestamp;
        BLUEDuration = _seconds;
    }

    // Disable the BLUE mode
    function disableBLUE() external authorized {
        BLUETriggeredAt = 0;
    }
