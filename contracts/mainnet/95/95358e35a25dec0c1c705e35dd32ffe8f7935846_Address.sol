...
library Address{
 ...
 contract WARCAT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4f5757a847A93e20a5A1C45D44f53b89A39232aA;
    address public donationWallet = 0x4f5757a847A93e20a5A1C45D44f53b89A39232aA;

    string private constant _name = "War Cat";
    ...
    Taxes public taxes = Taxes(1, 8, 3, 3);
    Taxes public sellTaxes = Taxes(1, 12, 3, 3);
