...
Telegram : https://t.me/SafeMoonsVision
*/
...
contract SafeMoonsVision is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SafeMoonsVisionsDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SafeMoonVision", "SafeVision") {
        marketingWallet = payable(0xE666Ea44559Ab8B40b9176C7e6F1C85e40817d1e);
        devWallet = payable(0x66563420aE8E7F18ee3DB73A4754c9b6A802a831);
        ...
        dividendTracker = new SafeMoonsVisionsDividendTracker(
            payable(this),
            router,
            0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5,
            "SafeMoonsVisionsTRACKER",
            "SAFEMOONVISIONSSTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 3000000; // 2%
...
contract SafeMoonsVisionsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SafeMoonsVision public SafeMoonsVisionsContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SafeMoonsVisionsContract = SafeMoonsVision(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SafeMoonsVisions_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SafeMoonsVisions_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SafeMoonsVision contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SafeMoonsVisionsContract);

            uint256 prevBalance = SafeMoonsVisionsContract.balanceOf(address(this));
            ...
            {
                uint256 received = SafeMoonsVisionsContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SafeMoonsVisionsContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
