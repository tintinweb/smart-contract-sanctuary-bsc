...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd);
...
contract TestRat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TestRat";
    string constant _symbol = "TRAT";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd;

    uint256 _totalSupply = 10* 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 5 * 10**10 * (10 ** _decimals);
    ...
    uint256 public liquidityFeeBuy = 6;
    uint256 public marketingFeeBuy = 8;
    uint256 public rewardsFeeBuy = 6;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3D9AB38F1F15555cAe65547E97F83CCB00beF962;
        marketingWallet = 0x209c36EEF1BdCa643Fcf61efB8fa67cA2577385b;
        devWallet = 0x38a497fA0Cc7f3eb61965E58124e957373D63639;
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeBuy = liquidityFeeBuy.add(marketingFeeBuy).add(rewardsFeeBuy);
    ...
    function changeFeesBuy(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external authorized {
        liquidityFeeBuy = newLiqFee;
        rewardsFeeBuy = newRewardFee;
