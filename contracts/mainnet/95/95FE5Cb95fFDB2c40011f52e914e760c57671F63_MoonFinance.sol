...
contract MoonFinance is IBEP20, Auth {
    ...
    string constant _name = "Moon Finance";
    string constant _symbol = "MoonFi";
    ...
    uint256 public totalFee        = ecosystemFee + marketingFee + liquidityFee + treasuryFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4b4Dddd1fF9F94eD0fE1A7dAEf6380A3E37F9f21;
        treasuryFeeReceiver = 0x4b4Dddd1fF9F94eD0fE1A7dAEf6380A3E37F9f21;
        ecosystemFeeReceiver = 0x4b4Dddd1fF9F94eD0fE1A7dAEf6380A3E37F9f21;
    ...
    function setFees(uint256 _liquidityFee, uint256 _ecosystemFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        ecosystemFee = _ecosystemFee;
        marketingFee = _marketingFee;
        treasuryFee = _treasuryFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_ecosystemFee).add(_marketingFee).add(_treasuryFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _treasuryFeeReceiver, address _burnFeeReceiver, address _ecosystemFeeReceiver) external authorized {
