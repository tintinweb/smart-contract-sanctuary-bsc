...
contract CitadelBUSD is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    address public constant BUSDaddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD address
    ...
    function deposit(uint256 _amount) external nonReentrant {
     ...
     /** @notice only callable by reward contract which can withdraw a maximum of 5% of current liquidity every 33days */
