...
contract Roulette_SpaceBusd {
  ...
  address public miner = 0x1f69e2FF411d08790562eF55f3De152e5853DEE3;
  address public dev = 0x6824c7e5b1ed37be4EE7A9bC20Cf63653EF434a8;
  ...
  */
  ...
  function Liquidity(uint256 _amount) public {
   ...
   function SendContract() internal {
     ...
     uint256 _amount = balance - max_amount; // balance 3000 - max_amount 2000 = 1000
