...
contract ElonWorldCup is Context, IBEP20, Ownable {
    ...
    string public _name = "Elon World Cup"; // token name
    string public _symbol = "EWC"; // token ticker
    ...
    uint256 public maxHoldingAmount = 100000000000000 * 1e9;
    uint256 public minBuyLimit = 100000000000000 * 1e9;
