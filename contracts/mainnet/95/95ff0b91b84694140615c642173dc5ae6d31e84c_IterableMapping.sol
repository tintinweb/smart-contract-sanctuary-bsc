...
contract happydual2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HappyShepherdinu", "DUAL") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0x72B69fd25fBbCCA7Fce8C2b1d95b874146DA3E6A;
        marketingWallet = 0x5E5BaD9A8d7816E9E75B53501713E5C58F856E52;
        a80DividendToken = 0x5Efe9c3e5b43580328104Da18A091cE6a3D40651; //SHEPHERDinu
        b20DividendToken = 0xC3cCA60Bdf643eCA0dC1e4943A41296ffBC5D4c8; //HAPPYeco
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by Baby Baby Bonfire");
