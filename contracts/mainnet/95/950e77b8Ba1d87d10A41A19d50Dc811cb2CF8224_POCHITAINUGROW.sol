...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaEeada5eBEEB923210263B4D4D29cdEBDbf6ce13;
...
contract POCHITAINUGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POCHITA INU GROW";
    string private _symbol = "$POCHIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaEeada5eBEEB923210263B4D4D29cdEBDbf6ce13);
    address payable public teamWalletAddress = payable(0xaEeada5eBEEB923210263B4D4D29cdEBDbf6ce13);
