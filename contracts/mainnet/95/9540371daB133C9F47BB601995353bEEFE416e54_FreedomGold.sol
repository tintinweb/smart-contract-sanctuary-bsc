...
//SPDX-License-Identifier: MIT
        ...
        /**
            TG: https://twitter.com/freedomgoldfrg
            Website: https://t.me/FRGTOKEN
            Twitter: https://twitter.com/freedomgoldfrg
        */
...
contract Ownable is Context {
    ...
    constructor() {
        _owner = 0xC3184a15e5027fC5e34ed68F9b2d53b948DFD58A;
...
contract FreedomGold is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Freedom Gold";
    ...
    uint256 public maxBag = _totalSupply * 5000/100 / 100;
    uint256 public maxTX = _totalSupply * 5000/100 / 100;
    ...
    //Tax wallets
    address public teamWallet = 0x1Dd13187503Bd0aDE1262EBbFcf0F4C8b7398CC9;
    address public treasuryWallet = 0xC3184a15e5027fC5e34ed68F9b2d53b948DFD58A;

    // Tax Split
    uint256 public teamShare = 272;
    uint256 public treasuryShare = 363;
    uint256 public rewardShare = 363;
