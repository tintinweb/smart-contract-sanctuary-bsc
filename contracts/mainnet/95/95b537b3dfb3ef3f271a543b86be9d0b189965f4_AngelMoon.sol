...
Telegram: https://t.me/angelmoonofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5026E10d46A60eAA85eC129Cc39B9e8Eb442D995; // owner address
...
contract AngelMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Angel Moon ";
    string private _symbol = " AM ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5026E10d46A60eAA85eC129Cc39B9e8Eb442D995); // Marketing Address
    address payable public teamWalletAddress = payable(0x5026E10d46A60eAA85eC129Cc39B9e8Eb442D995); // Team Address
    ...
    uint256 public _totalDistributionShares = 43;  
