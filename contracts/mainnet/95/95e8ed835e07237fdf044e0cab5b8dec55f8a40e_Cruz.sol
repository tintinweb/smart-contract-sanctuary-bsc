...
contract Cruz is IERC20, Ownable, IShareDividends{
    ...
    function AutoDividend(address holder) external onlyOwner {
    ...
    function changeCruzAllFees(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
    ...
    function changCruzeLimit(uint256 newLimit) external onlyOwner {
        maxTx = newLimit;
    }    
    ...
    function changeCruzStatus(bool newStatus) public onlyOwner {
