...
contract newcommunitysincere is IBEP20, Auth {
    ...
    string constant _name = "new Community Sincere";
    string constant _symbol = "ncS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;  //2% max tx
    ...
    address private marketingFeeReceiver =0x37835D0d000B4b8fbC25b266D844A0d6E9dCaDD9;
    address private teamFeeReceiver =0x37835D0d000B4b8fbC25b266D844A0d6E9dCaDD9;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x37835D0d000B4b8fbC25b266D844A0d6E9dCaDD9;
