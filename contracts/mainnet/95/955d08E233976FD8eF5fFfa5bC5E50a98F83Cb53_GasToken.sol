...
contract GasToken is ReentrancyGuard, AccessControlEnumerable, ERC20Burnable {
    ...
    address public lp = 0x061fEe324A9C5b1eC7dB1585fE23b422744c28aA;
    address public token = 0xEc3c3feE95eFCa2ba4838D0C2398C84a5F5Fcb5e;
    ...
    function baseInit(address _lp, address _token, address _lpStake) external onlyRole(OPERATOR_ROLE) {
        lp = _lp;
        token = _token;
        lpStake = _lpStake;
    }
    ...
    function wrapByBank(address bank, uint256 amount) internal nonReentrant {
    ...
    function calcGasAmount(uint256 amount, uint256 rate) public view returns (uint256) {
