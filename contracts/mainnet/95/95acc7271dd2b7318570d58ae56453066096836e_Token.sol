...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x2e7bBC55E6cA7767941Db126f442b5E1f9dfa375;
    mapping (address => bool) private _isExcludedFromFees;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("888", "888") {
        ...
        excludeFromFees(0x5529536dc93BAc1c3Cbe24cD606ea3e0c9F9FC01, true);
        _mint(0x5529536dc93BAc1c3Cbe24cD606ea3e0c9F9FC01, 888 * (10**18));
    }
