...
contract Jzm is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1000000000000000000000000000000000000000000 * 10**_decimals;
    uint256 private _maxTxAmount = 10000000000000000000000000000000000000000000000000000* 10**_decimals;
    uint256 private _maxWalletSize = 10000000000000000000000000000000000000000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x2c04f3268b8a75aF0A4453fc273317dAe61b81d6));
        marketingWallet = payable(address(0x2c04f3268b8a75aF0A4453fc273317dAe61b81d6));
