...
contract  SHIBMUU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBA iMUU";
    string private _symbol = "SHIBMUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83A9e3ffBEa33eaDdC02DAD19515e046C8f583EC); 
    address payable public teamWalletAddress = payable(0x94DD353D05467a14785F7d1D5Cb185E78E935d5a); 
