...
/**
    No telegram, no channel. This is community driven token
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64319a9912BBCd6Db739D7Ed5edb6cFFF4Ea8042; // owner address
...
contract MoneyShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoneyShib";
    string private _symbol = "MoneyShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64319a9912BBCd6Db739D7Ed5edb6cFFF4Ea8042); // Marketing Address
    address payable public teamWalletAddress = payable(0x64319a9912BBCd6Db739D7Ed5edb6cFFF4Ea8042); // Team Address
