...
----------------------------------------------------------------------------------------------------------------
Welcome to Shiba Sheikh (SHIBSHK), crypto's wealthiest dog!

Shiba Sheikh is a BSC project launched by an experienced and devoted team.  It has a specially designed tokenomics system that ensures sustainability and chart stability, empowering the token to become the magic lamp you've long been searching for that will lead to untold riches.

Shiba Sheikh is focused on community building as we recognize the integral role of members who share our vision in taking the project to where it wants to be.  Utilities are planned to solidify the longevity of the project.

Come invest on us today and be part of the next big dog coin in BSC!

Total Supply: 100,000,000,000
Max Wallet and Transaction: 2%
Buy/Sell Tax: 10% (5% marketing, 3% buyback, 2% LP)

Important Links:

TG: @shibasheikh_bsc
Twitter: https://twitter.com/shibasheikh_bsc
Website: https://shibasheikhtoken.com
-----------------------------------------------------------------------------------------------------------------
*/
...
contract shibasheikh is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Sheikh";
    string private constant _symbol = "SHIBSHK";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            BuyBack: 3, // BuyBack fee in %
            lp: 2, // lp rate in %
            toSwap: 10 // BuyBack + dev + lp
        });
    ...
    event BuyBackAndDevFeesAdded(uint256 devFee, uint256 BuyBackFee);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // we give the remaining tax to dev & BuyBack wallets
    ...
    function setBuyFees(
        ...
        buyRates.dev = _dev;
        buyRates.lp = _lp;
        buyRates.toSwap = _BuyBack + _dev + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.dev = _dev;
        sellRates.lp = _lp;
        sellRates.toSwap = _BuyBack + _dev + _lp;
    }
    ...
    function rescueBNB(uint256 weiAmount) external onlyOwner{
        ...
        BuyBackAddress.sendValue(weiAmount);
    }
