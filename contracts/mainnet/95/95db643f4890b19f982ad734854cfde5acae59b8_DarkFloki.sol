...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x173734f9b2580A6db5196b208046514AC041045C;
...
contract DarkFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dark Floki"; // 
    string private constant _symbol = "DRKFLKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x173734f9b2580A6db5196b208046514AC041045C);
