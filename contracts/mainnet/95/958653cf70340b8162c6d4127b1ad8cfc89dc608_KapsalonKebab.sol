...
contract KapsalonKebab is Context, IBEP20, Ownable{ 
    using SafeMath for uint256;
    ...
    address marketingReceiver                   = 0xdA3f9bC9AE28C3eb7B6F98c6167287518d7036bE;
    address devReceiver                         = 0x91A09348C91a9B6065CCFA14B9fB92c891DCcB0A;

    string constant _name                       = "Kapsalon Kebab";
    string constant _symbol                     = "$KEBAB";
    ...
    uint256 public _maxTxLimit                  = _totalSupply / 100; // 1%
    ...
    constructor () {
        ...
        isFeeExempt[devReceiver]                    = true;

        isTxLimitExempt[msg.sender]                 = true;
        isTxLimitExempt[address(this)]              = true;
        isTxLimitExempt[marketingReceiver]          = true;
        isTxLimitExempt[devReceiver]                = true;
        ...
        isBuyCooldownExempt[devReceiver]            = true;
        ...
        isMaxWalletExempt[devReceiver]              = true;
    ...
    function setFees(uint256 _rewardFee, uint256 _marketingFee, uint256 _devFee, uint256 _liquidityFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFees < feeDenominator, "Fees cant be greater than 99%");
    }
