...
/**
TELEGRAM:  https://t.me/optimusflokibsc
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF10FF0981De87086f16950328b5B6681fa0ff12c; //
...
contract OPTIMUS is Context, IERC20, Ownable {   //
    ...
    string private constant _name = "Optimus Floki"; // 
    string private constant _symbol = "OFLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xF10FF0981De87086f16950328b5B6681fa0ff12c); //
