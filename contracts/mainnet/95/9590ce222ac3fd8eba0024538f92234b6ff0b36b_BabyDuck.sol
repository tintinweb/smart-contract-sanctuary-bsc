...
contract BabyDuck is Context, ERC20, Ownable {
    ...
    uint256 public _taxFee = 1; //reflect
    ...
    address public devWallet = 0x2141D61cC9A5a28e30D2351e63d0DD2b5c1AbC60;
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000 * 10 ** decimals();
   ...
   constructor() ERC20("Baby Duck","$BBD") {
    ...
    function isExcludeFromReward(address account) public view returns (bool) {
    ...
    function setChartityFeePercent(uint256 devFee) external onlyOwner() {
        _devFee = devFee;
    }
