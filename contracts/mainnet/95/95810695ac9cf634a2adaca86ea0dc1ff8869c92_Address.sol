...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71a5BC52Aeb8579E8E8a2A80BcDC9D45580e025f;
...
contract TokenOfOrganicWorld is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x79efe88D1F9421eda4726071363bdA54520aa68f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Token Of Organic World";
    string private _symbol = "TOW";
