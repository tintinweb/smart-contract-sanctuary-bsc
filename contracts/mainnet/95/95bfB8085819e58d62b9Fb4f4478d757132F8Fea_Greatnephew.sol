...
易烊千玺是沈腾的三舅，原来正版沈腾是大外甥？！大甥三舅齐飞！

 TG：https://t.me/Greatnephew
*/
...
contract Greatnephew is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Greatnephew";
    string private _symbol = "Greatnephew";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x8cC4B450bCAe763b1bEA39DfAAD8ab34D9626587);
