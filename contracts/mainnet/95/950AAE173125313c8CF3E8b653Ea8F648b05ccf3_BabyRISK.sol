...
contract BabyRISK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyRISK";
    string private _symbol = "BabyRISK";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xd37fF3237005ee0a04f1d7bBfc935b1803cee54c); 
    address payable private teamWalletAddress = payable(0x9286EE8DF9Cf61f301c83dBb96c7c192c2170B41); 
