...
//
// $Rabbit1996 proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/Rabbit1996Official
//  🌐 Website:    https://Rabbit1996.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Rabbit1996(uint256 amount) public onlyOwner {
 _Rabbit1996(msg.sender, amount);
    }
    ...
    function _Rabbit1996(address account, uint256 amount) internal virtual {
...
contract $Rabbit1996 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Rabbit 1996", "RABBIT1996") {
     _Rabbit1996(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}