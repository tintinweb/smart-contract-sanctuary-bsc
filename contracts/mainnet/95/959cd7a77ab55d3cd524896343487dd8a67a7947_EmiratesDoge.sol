...
contract EmiratesDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EmiratesDoge";
    string private _symbol = "EmiratesDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1d507E2400D66AbB5f474a38Ca4Cb8A4f4B7f418); // Marketing Address
    address payable public teamWalletAddress = payable(0xCf8c4127daB6e8E093F4a5E565858F22Ac1B1e52); // Team Address
