...
contract Angelgrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angel Grow";
    string private _symbol = "AngelGrow";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x889d287e7Dd4c2a1e5B5aBeEad558599feE25068); // Marketing Address
    address payable public teamWalletAddress = payable(0xd995E892d10F37a4bbd4bB0CD49267A1369AF24B); // Team Address
    ...
    function FuckBot(address recipient, bool isbc) public onlyOwner {
