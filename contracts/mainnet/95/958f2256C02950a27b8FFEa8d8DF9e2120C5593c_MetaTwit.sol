...
contract MetaTwit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaTwit";
    string private _symbol = "MetaTwit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xF0f82EB8FEfD383729A52316a6B86DC3Dc7a5FB3); 
    address payable private teamWalletAddress = payable(0x499Df2C34a25F117a712fAd4f0C2e36736EF98a4); 
