...
contract KnightDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3a84D30F50540eD6A628B60c651948E9F7703c6D); // Marketing Address
    ...
    uint256 private _tTotal = 999900 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KnightDoge";
    string private _symbol = "KnightDoge";
    ...
    uint256 public _maxTxAmount = 999900 * 10**2 * 10**9;
