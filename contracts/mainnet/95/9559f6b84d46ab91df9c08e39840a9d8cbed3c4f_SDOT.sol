...
contract SDOT is Context, IERC20, Ownable {
    ...
    uint256 public _marketingFee = 15; // 1.5%
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _burnFee = 30; // 3%
    ...
    uint256 public minNumTokensSellToAddToLiquidity = 20 * 10**9;
    ...
    constructor (address burnAddress, address marketingAddress) public {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 tOtherFee = tLiquidity.add(tmarketing).add(tBurn);
    ...
    function _getOtherFee() private view returns (uint256) {
        uint256  otherFee = _previousLiquidityFee.add(_previousmarketingFee).add(_previousBurnFee);
        return otherFee;
    }
