...
contract ChihuahuaGrow is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x637AE61006362b4Bb0Ef6F40e2059C59C169A8f4); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x9aA53eda730d67a0CEf3f606DDDE9E4322686e9A); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xDb3A4f3B282FA12D5B839BC8a53Cd004Dc3535E3); // charity Wallet Address
    address payable public devWalletAddress = payable(0x7ef8D3643f70A2Fb5f6C0134b014D385c9D52B9a); // dev Wallet Address
    ...
    string private constant _name = "ChihuahuaGrow";
    string private constant _symbol = "CHHGROW";
    ...
    constructor () {
        address _owner = 0xbe1F9751a99B0753747B7E95e9B36C559eA1376A;
