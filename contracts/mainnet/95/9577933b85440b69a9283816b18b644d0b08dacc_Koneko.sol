...
contract Koneko is ERC20, Ownable {
    ...
    constructor() ERC20("Koneko", "KEKO") {
        
        address newOwner = 0x854cb79A84f483CF3ed86633A7D9A246758c2262; // can leave alone if owner is deployer.
        ...
        maxWalletAmount = totalSupply * 35 / 10000;
        ...
        operationsAddress = address(0x5894F6f6906137FD3Cd87D0156cC25aBC4262bBF);
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e9, "Cannot set max buy amount lower than 0.1%");
        maxBuyAmount = newNum * (10**9);
        emit UpdatedMaxBuyAmount(maxBuyAmount);
    }
    
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e9, "Cannot set max sell amount lower than 0.1%");
        maxSellAmount = newNum * (10**9);
        emit UpdatedMaxSellAmount(maxSellAmount);
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 35 / 10000)/1e9, "Cannot set max wallet amount lower than 0.35%");
