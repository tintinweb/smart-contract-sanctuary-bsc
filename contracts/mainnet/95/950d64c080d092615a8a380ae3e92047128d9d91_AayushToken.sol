...
contract AayushToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Degen";
    string constant _symbol = "1million";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xBEF0A84229537a72cb236355Ad042fE2a2175e6A;
