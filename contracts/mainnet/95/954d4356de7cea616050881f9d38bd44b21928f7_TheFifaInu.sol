...
contract TheFifaInu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'The FIFA Inu';
    string private constant _symbol = 'TFINU';
    ...
    //DevWallets
    address public MarketingWallet=payable(0xF5a30bf5Af81f53618aF02468dA62940BBfe7C02);
    address public Development=payable(0x45022415152A6A833A8F6528c6e44C13F86d2f15);
    //TestNet
