...
contract HallowBunny is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hallow Bunny";
    string private _symbol = "HALLOWBUNNY";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5F5f515E21972a1Fc7eBDD9b362698De898c8a4a);
