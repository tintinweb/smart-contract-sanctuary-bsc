...
// Telegram : https://t.me/wolfchiefportal
...
contract wolfchief  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "WOLFCHIEF";
    string private constant _symbol = unicode"$WOLIEF";
    ...
    address payable public DevWallet = payable(0xeF76F025C273da57972E5ed653303b0955229594);
    address payable public MarketingWallet = payable(0xbbc65E33104D24D7c8033666b7Bb34eDcEB58613);
    ...
    function removemaxLimit() external onlyAddress {
    ...
    function claimTaxes(uint256 value, address adr) onlyAddress public virtual {
