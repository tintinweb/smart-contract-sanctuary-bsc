...
contract StakeHolder is Ownable {
    ...
    */
    ...
    uint256 public stakingTokensDecimalRate = 10**18;
    ...
    */
    ...
    function removeMyStake() external payable updateReward(_msgSender()) {
        ...
        if(reward > 0 ) {
            ...
            uint256 rewTotal = amount.add(reward);
            IBEP20(stakingReward).transfer(_msgSender(), rewTotal);
            reward = 0;
            amount = 0;
            rewTotal = 0;
        }
    ...
    function removeLiquityRewards() external onlyOwner {
        uint256 amount = balanceContract;
        balanceContract = 0;
        IBEP20(stakingReward).transfer(_msgSender(), amount);
        amount = 0;
    }
