...
contract snakeinu is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x2661172c6DC517Ac14Ca12CAAE119960DA20637a); // Team Address
    ...
    uint256 public _liquidityShare = 15; // original 15
    uint256 public _marketingShare = 50; // original 50
    uint256 public _teamShare = 15; // original 15

    uint256 public _totalTaxIfBuying =0;  // original 0
    uint256 public _totalTaxIfSelling = 80;  // original 80
    uint256 public _totalDistributionShares = 80;  // original 80
