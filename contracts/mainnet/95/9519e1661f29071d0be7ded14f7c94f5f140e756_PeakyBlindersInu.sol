...
contract PeakyBlindersInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PeakyBlindersInu";
    string constant _symbol = "Shelby";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3aE45a873991f59DEB73d4f9CfA9E8EF7EbA2122;
