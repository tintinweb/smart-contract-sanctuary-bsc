...
contract aoligei is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "aoligei";
    string private _symbol = "AOLIGEI";
    ...
    function novdistributeReward(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
    ...
    function _getTxPercentage(uint256 maxTXPercentage) external onlyOwner {
