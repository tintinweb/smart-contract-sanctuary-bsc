...
contract SquidRunCoin is ERC20, Ownable {
    ...
    constructor () ERC20("Pulse.Rent", "PR") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x481Ef7599656b7333bA36e3D7CBF08814195e03e;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        _isExcludedFromFees[0x481Ef7599656b7333bA36e3D7CBF08814195e03e] = true; //buyback

        _mint(owner(), 1e9 * (10 ** decimals()));
        swapTokensAtAmount = totalSupply() / 1_000_000_000;
