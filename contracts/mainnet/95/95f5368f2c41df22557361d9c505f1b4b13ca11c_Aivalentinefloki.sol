...
contract Aivalentinefloki is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x13481104C74515C9fDb3eF6071b345614d8B98bd;
    address public gamedevWallet = 0x13481104C74515C9fDb3eF6071b345614d8B98bd;

    string private constant _name = "Ai-ValentineFloki";
    string private constant _symbol = "AI-FLOKI";
    ...
    Taxes public taxes = Taxes(2, 0, 2, 0);
