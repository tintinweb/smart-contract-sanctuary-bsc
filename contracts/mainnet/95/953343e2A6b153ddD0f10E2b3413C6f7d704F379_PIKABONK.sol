...
contract PIKABONK is Context, IERC20, Ownable {
    ...
    string private constant _name = "PIKA BONK!!"; // 
    string private constant _symbol = "PIKA BONK!!"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC28b4D03477D9ea0ccf4BCE081a5c1EF1dfC4194;
