...
// TOKENOMICS: 
// Buy Fee | 10% MARKETING
// Sell Fee | 20% Marketing 
// Maximum Buy 1% | Maximum Sell 1% | Maximum Wallet 1%
...
pragma solidity ^0.8.10;
contract AugmentedUniverse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWallet = payable(address(0x1ECA8F29aa28389A8a420466b8B63f75F1Fa07f5)); //marketingWallet
    ...
    constructor() ERC20("Augmented Universe", "AU") {
        // Buy fee
        buyFee.rewardFee = 0;
        ...
        */
        _mint(owner(), 1 * 10**15 * (10**9)); // 1 Quadrillion Tokens
    }
   ...
   function setMarketingWallet (address wallet) external onlyOwner {
    ...
    function setBuyFee(
        ...
        totalBuyFee = rewardfee + liquidity + marketing;
    }
    ...
    function setSellFee(
        ...
        totalSellFee = rewardfee + liquidity + marketing;
    }
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function swapAndSendToWallets(uint256 tokens) private lockTheSwap {
        ...
        uint256 newBalance = IERC20(BUSD).balanceOf(address(this)).sub(
            initialBalance);
        uint256 marketingShare = newBalance.mul(buyFee.marketingFee + sellFee.marketingFee).div(buyFee.marketingFee + sellFee.marketingFee);
