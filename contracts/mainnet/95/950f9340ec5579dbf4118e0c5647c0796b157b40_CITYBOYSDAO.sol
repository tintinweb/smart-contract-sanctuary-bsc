...
contract CITYBOYSDAO is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000 * 10**9; // 1% to prevent whales and snipers from destroying the contract
    uint256 public _walletMax = 3000000 * 10**9; // 3% to prevent huge dumps
