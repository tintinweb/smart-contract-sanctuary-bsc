...
contract AdvancedTokerrContract  is Ownable, IBEP20 {
    ...
    uint256 public liquidityFee     = 2; // for buyback and giveaway
    uint256 public marketingFee     = 4; // Marketing & Development
    uint256 public MoetaTeamFee     = 1; // MoetaTeam
    ...
    address public MoetaTeamwallet;
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0xC00449C5ee006f7a077586eCE7529c9eD4E2AE80;
        marketingWallet =0x94eF0D6d2eB08094E8979De602773aa014C04f91;
        MoetaTeamwallet = 0x10a7fB56391CF8c5F013Fb0c3154fE3DA1376C2a;
        
        totalFee = liquidityFee.add(marketingFee).add(MoetaTeamFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(MoetaTeamFee.div(2));

        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBMarketing = amountBNB.mul(MoetaTeamFee).div(totalBNBFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newMoetaTeamFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        MoetaTeamFee = newMoetaTeamFee;
