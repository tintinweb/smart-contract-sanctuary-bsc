...
contract Drage2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Drage 2.0";
    ...
    address private marketingWallet = address(0x5B4dDad69C4bB9c5b777494FDdCb1be81Eb4395A);
    ...
    function Rektsniper() public onlyOwner {
    ...
    function setWallet(uint256 newMaxTxPercent) public onlyOwner {
        require(newMaxTxPercent >= 1, "MaxTx atleast 1% or Higher");
        _maxTxAmount = _tTotal.mul(newMaxTxPercent).div(10**2);
    }

    function setWalletMax(uint256 newMaxWalletPercent) public onlyOwner {
