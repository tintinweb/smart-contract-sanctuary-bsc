...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x328E191876FB7a3dD64dD6EE1e3a8030c078aCE9; // owner address
...
contract Santama is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santama ";
    string private _symbol = "STAMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0CF22755bA4DA1179EEA27341b3FEe36a4B1F65c); 
    address payable public DevAddress = payable(0x0CF22755bA4DA1179EEA27341b3FEe36a4B1F65c); 
    ...
    uint256 public _DevShare = 3; // original 12
