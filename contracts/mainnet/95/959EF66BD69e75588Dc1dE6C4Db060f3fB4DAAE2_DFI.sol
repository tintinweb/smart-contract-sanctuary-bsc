...
contract DFI is IERC20, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    mapping (address => mapping (address => uint256)) private _allowances;

    string private _name = "DFI";
    ...
    //bsc
     ...
     address public team = 0xf26CEd1eCF210671BCcF9130d749489933FC8dD1;
     address public liquidityWallet = 0xfe460DE3EE8AF4D5fE16ce3890Fd60722a159163;
    ...
    uint256 public buyPct = 5;
    uint256 public sellPct = 10;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(pairList[sender] || pairList[recipient]) {
            uint256 lpPct = sellPct;
            if(pairList[sender]) lpPct = buyPct;
