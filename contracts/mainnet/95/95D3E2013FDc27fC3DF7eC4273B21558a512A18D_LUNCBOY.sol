...
contract LUNCBOY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunc Boy"; // 
    string private constant _symbol = "LUNC BOY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x9bEe91a85B32d066213C708e76c437bBE57C5B9A;
