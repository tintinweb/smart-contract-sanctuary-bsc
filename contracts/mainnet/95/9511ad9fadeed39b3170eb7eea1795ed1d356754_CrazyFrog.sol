...
/*
 ...
 RIBBIT!! Back with an even better contract! Auto mining, no need to stake or connect to a dapp. Hold and Earn!  
 
   Lets keep it crazy up in this B!tch!
...
contract CrazyFrog is ERC20Detailed, Ownable {
    ...
    uint256 public constant MAX_FEE_RATE = 7;
    ...
    constructor() ERC20Detailed(block.chainid==1 ? "Crazy Frog" : "Crazy Frog", block.chainid==1 ? "Kermit" : "Kermit", 18) {
        address dexAddress;
        ...
        marketingAddress = address(0xA00F62f3a29e86635E52Ffff76cB6818463cE38D);
        treasuryAddress = address(0x68E79213c52C4556a6FAc4080CdEC4C116265716);
