...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _MT;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x173E774d28038d38935cbF855EfF16B13195aAF6;
    ...
    function setMT(address addr, bool enable) external onlyOwner {
        _MT[addr] = enable;
    }
...
contract LZDAO is AbsToken {
    ...
    40000,
        ...
        address(0x36cAb455a5DE7dCA7A836DA4EE52174B2C8F1Be8),
    
        address(0x2a264E837B172bd464E48e35FE45E0046F30fBf2)
    ){
