...
BINGOGE - an auto lottery SMART CHAIN token.
Prizes paid HOURLY!

Tokenomics
- 9% buy + sell
- 5% to the hourly jackpot
- 3% marketing
- 1% liquidity 

https://t.me/BingogeBSC
...
contract BINGOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BINGOGE";

    string private _symbol = "BINGOGE";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x0fb25e7440C84f0B4E5c768fB19db367cB1bf3f0;
