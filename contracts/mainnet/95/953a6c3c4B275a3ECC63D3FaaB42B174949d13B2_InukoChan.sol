...
/**
THE SWEETEST INUKO WITH A LOT OF BUSD
REWARDS FOR HER BELOVED ONES.

All locked for 6 month:
Marketing Wallet: 0x8b651B7687E219986B69075DeF33Ec9876ce77f6
NFT Reward Wallet: 0x9914c886B71d556d4E9D231508dbDA545aE24e47
Team Wallet: 0x7B93C542AB30Ca469c5dcb509F3B22A82414c1da
...
/* Token contract */
contract InukoChan is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x452Df6a2B8041c463ce089d8484A95DcC60D24A5;
    ...
    // Name and symbol
    string constant _name = " INUKO CHAN";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (200 k)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 k)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (200 k)
