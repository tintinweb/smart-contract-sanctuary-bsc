...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract StrongBox is Context, Ownable {
        using SafeMath for uint256;

        uint256 private EGGS_TO_HATCH_1MINERS = 864000;
        ...
        function hatchEggs(address ref) public {
            ...
            //send referral eggs
            claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed.mul(20),100));
            ...
            if(referrals[msg.sender]!=address(0)){
                ...
                refferalsAmountData[referrals[msg.sender]] = refferalsAmountData[referrals[msg.sender]].add(claimedEggs[referrals[msg.sender]]);
                referralsData[currentIndex] = ReferralData({
                refAddress:referrals[msg.sender],
                amount:referralsData[currentIndex].amount.add(SafeMath.div(eggsUsed.mul(20),100)),
    ...
    /**
    BNB StrongBox
     Find Rumors of strongbox, Gather Keys, Harvest Strongbox and Sell for BNB.
      10% daily daily Rate
      20% Referral Bonus, will go directly to referrer wallet.
    */