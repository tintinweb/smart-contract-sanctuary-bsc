...
📱 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/UClothesPortal

🌐 𝗪𝗘𝗕𝗦𝗜𝗧𝗘: http://UCLOTHES.CO

🐦 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/TheUClothes

𝙍𝙀𝘾𝙀𝙄𝙑𝙀 𝘾𝙇𝙊𝙏𝙃𝙀𝙎 𝘽𝙔 𝙃𝙊𝙇𝘿𝙄𝙉𝙂 💰
...
contract UCLOTHES is Context, IERC20, Ownable {
    ...
    string private constant _name = "UClothes";  
    string private constant _symbol = "UCLOTHES";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _UClothesMarketingTax = 3; 
    uint256 public _UClothesLiquidityTax = 5; 
    address public  _marketing = 0xc3E595AF12A2827b1Ddf621867ad4af32eF2cb3E;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        uint256 marketingFee = amount * _UClothesMarketingTax / 100; 
        uint256 liquidityFee = amount * _UClothesLiquidityTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _UClothesLiquidityTax / (_UClothesMarketingTax + _UClothesMarketingTax);
