...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 POOCHAIN = IBEP20(0xa1611E8D4070dee36EF308952CF34255c92a01c5); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = POOCHAIN.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(POOCHAIN);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = POOCHAIN.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           POOCHAIN.transfer(shareholder, amount);
...
contract POOGE is IBEP20, Auth {
   using SafeMath for uint256;
 
   address POOCHAIN = 0xa1611E8D4070dee36EF308952CF34255c92a01c5; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "POOGE";
   string constant _symbol = "$PGE";
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xDF97Bb4D083b8E39eBCbC2F77d3060773c1cf820; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xDF97Bb4D083b8E39eBCbC2F77d3060773c1cf820; //Can be change to any wallet you want
       marketingFeeReceiver = 0xDF97Bb4D083b8E39eBCbC2F77d3060773c1cf820; //Can be change to any wallet you want
