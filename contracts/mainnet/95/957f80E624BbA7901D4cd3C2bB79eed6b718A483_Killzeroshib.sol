...
contract Killzeroshib  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000*10E29*10**9;
    ...
    string private constant _name = "Killzeroshib";
    string private constant _symbol = "K0-ShiB";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress = payable(0x4f6dc338AC2897F42526853aF6cfB1B9EA7Da5A8);
    address payable private _marketingAddress = payable(0x091C67a7e7265e53FAEBb54093327252F280CF94);
