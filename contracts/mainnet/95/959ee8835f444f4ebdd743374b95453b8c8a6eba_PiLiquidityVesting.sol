...
contract PiLiquidityVesting is Ownable, ReentrancyGuard {
    ...
    uint256[] public stageVestingPercent;
    ...
    constructor() {
        ...
        // 12500000
        amountTotal = 12500000 ether;
        // 5000000
        tgeAmount = 5000000 ether;
        
        released = 0;

        stageVestingPercent = [30,20,10];
    }
    ...
    returns (uint256)
    {
        if (currentTime < start) {
            ...
            if (timeFromStart >= cliff) {
                ...
                for(uint256 index = 0; index < vestedSlicePeriods; index++){
                    vestedAmount += amountTotal.mul(stageVestingPercent[index]).div(100);
                }
            }
