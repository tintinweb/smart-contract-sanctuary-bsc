...
// The first token dedicated to watching porn with our community and enjoying beautiful respectable women, join the telegram hub https://t.me/OfficialPornHubCoin

// Max wallet is 69 tokens & tax is 6/9

// We will have live porn in voice chat at certain marketcap goals and group member goals & will also be giving out Pornhub Premium to top holders.
...
contract PornHub is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "www.pornhub.com";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 690 / 10000; // 6.9% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xA59cE3DBd7b720178478f8d3BF06994b33AEd1be;
        _marketingWallet = 0x7922cc2d820C1aC3634e8A44c865Ff9FCA1ad1ca;
