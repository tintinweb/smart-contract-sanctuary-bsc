...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "Dogepedia";
    string private _symbol = "Dogepedia";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x02FC66d5F8B0D4e0994626e5726A3e58FA6132f4); // Marketing Address
    address payable private teamWalletAddress = payable(0x2253F1C998abE85D7C8C6ccA146a4A9B1946E1F3); // Team Address
