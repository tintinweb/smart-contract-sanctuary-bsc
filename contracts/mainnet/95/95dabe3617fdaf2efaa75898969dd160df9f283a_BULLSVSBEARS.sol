...
interface BULLSVSBEARSDeployer {
...
contract BULLSVSBEARS is BULLSVSBEARSDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BULLSVSBEARSTeam;
    address private CharityBULLSVSBEARS;
    ...
    string public override name = "BULLSVSBEARS";
    string public override symbol = "BULLSVSBEARS";
    ...
    constructor(uint totalSupplyValue, address BULLSVSBEARSTeamAddress, address CharityBULLSVSBEARSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BULLSVSBEARSTeam = BULLSVSBEARSTeamAddress;
        CharityBULLSVSBEARS = CharityBULLSVSBEARSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BULLSVSBEARSTeam] =  totalSupply * 4 / 100;
        balances[CharityBULLSVSBEARS] = totalSupply * 4 / 100;
