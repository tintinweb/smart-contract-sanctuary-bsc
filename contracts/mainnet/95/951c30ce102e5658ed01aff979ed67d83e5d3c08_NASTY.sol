...
interface IRouter {
    ...
    contract NASTY is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 3_000 * 10**18;
    uint256 public maxSellLimit = 10_000 * 10**18;
    uint256 public maxWalletLimit = 3_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 5;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xdFe1c6d8ee8A96cF34Ec59d5264cA035F06c39fA;
    address private ecosystemWallet = 0x3ba0c0d0B56326c17cbF2Bbe5924a1D1220960e2;
    ...
    constructor(address routerAdd) ERC20("Nasty", "NASTY") {
        ...
        exemptFee[0xdFe1c6d8ee8A96cF34Ec59d5264cA035F06c39fA] = true;
        exemptFee[0x3ba0c0d0B56326c17cbF2Bbe5924a1D1220960e2] = true;
        ...
        allowedTransfer[0xdFe1c6d8ee8A96cF34Ec59d5264cA035F06c39fA] = true;
        allowedTransfer[0x3ba0c0d0B56326c17cbF2Bbe5924a1D1220960e2] = true;
