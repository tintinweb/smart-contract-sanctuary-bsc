...
contract datafund is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8DA6e95D6Ffff3802C84C0aD7959eB000BCd9C1D); //nice
    address payable public charityAddress = payable(0x8DA6e95D6Ffff3802C84C0aD7959eB000BCd9C1D); //nice
    ...
    uint256 private _tTotal = 1400000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Data Fund"; //CC"; //CC
    string private _symbol = "DAT";  //nice
    ...
    uint256 public _maxTxAmount = 21000 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 21000 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 14000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 21000;// 0.01*210 token for 0.01 bnb (set as per requirements)
