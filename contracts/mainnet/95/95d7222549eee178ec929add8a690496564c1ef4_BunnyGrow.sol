...
/**
    Telegram: t.me/BunnyGrowOfficial
*/
...
contract BunnyGrow is Context, IERC20 { 
    ...
    */
    ...
    Wallet_BunnyGrow: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_BunnyGrow = payable(0xacdF95Ee2f22e1b75C9d2D4937aa4E09091AD25A); 
    address payable public Wallet_LP = payable(0xacdF95Ee2f22e1b75C9d2D4937aa4E09091AD25A);
    address payable public Wallet_Tokens = payable(0xacdF95Ee2f22e1b75C9d2D4937aa4E09091AD25A); 
    ...
    string private constant _name = "BunnyGrow"; 
    string private constant _symbol = unicode"BunnyGrow"; 
    ...
    uint256 public Percent_BunnyGrow = 90;
    ...
    uint256 public constant _Tax_On_Sell_MAX = 35;
    ...
    constructor () {
        ...
        _owner = 0xacdF95Ee2f22e1b75C9d2D4937aa4E09091AD25A;
        ...
        */
        ...
        _isLimitExempt[Wallet_BunnyGrow] = true; 
        ...
        _isExcludedFromFee[Wallet_BunnyGrow] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 BunnyGrow_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((BunnyGrow_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_BunnyGrow = BunnyGrow_Wallet;
    ...
    */
    ...
    //Update the BunnyGrow wallet
    event updatedBunnyGrowWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_BunnyGrow(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedBunnyGrowWallet(Wallet_BunnyGrow,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_BunnyGrow] = false; 

        Wallet_BunnyGrow = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_BunnyGrow != 0){

            // Calculate how many tokens need to be swapped for BNB (BunnyGrow BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_BunnyGrow / 100;
            ...
            uint256 split_M = Percent_BunnyGrow * 100 / (Percent_AutoLP + Percent_BunnyGrow);
            ...
            // Send BNB to BunnyGrow wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_BunnyGrow, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_BunnyGrow != 0){

            // Swap tokens for BNB and send to BunnyGrow Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_BunnyGrow / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_BunnyGrow, BNB_M);
            ...
            // Create the Auto LP if BunnyGrow is 0
