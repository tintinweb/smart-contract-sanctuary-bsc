...
import "./IHappyNewYearManager.sol";

contract HappyNewYearBox is ERC721Enumerable, Ownable, ReentrancyGuard {
    constructor(address _happyNewYearBoxManagerAddress)
        ERC721("Happy New Year Box", "DINOHNYBOX")
    {
        happyNewYearBoxManagerAddress = _happyNewYearBoxManagerAddress;
    ...
    address public happyNewYearBoxManagerAddress;
    ...
    function setBoxManagerAddress(address _happyNewYearBoxManagerAddress)
        external
        onlyOwner
    {
        happyNewYearBoxManagerAddress = _happyNewYearBoxManagerAddress;
    ...
    function mintMultipleBoxes(
        ...
        require(
            ...
            "HappyNewYearBox: Receivers and amounts must have the same length"
        );
    ...
    function openBox(uint256 _boxId) external noContract {
        ...
        (
            ...
            uint256 dinoGenes4,
            uint256 dinoGenes5
        ) = IHappyNewYearManager(happyNewYearBoxManagerAddress)
...
interface IHappyNewYearManager {
