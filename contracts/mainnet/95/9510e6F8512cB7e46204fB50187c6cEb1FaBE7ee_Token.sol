...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x82e0Ad632a86E89c9eC0b21BDA8f24D660c888E7);
    address payable public lpWallet = payable(0x82e0Ad632a86E89c9eC0b21BDA8f24D660c888E7);
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyMarketingFee + _buyLpFee;
        _totalTaxIfSelling = _sellMarketingFee + _sellLpFee;
    ...
    function setLpWallet(address payable account) external onlyOwner{
        lpWallet = account;
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        swapTokensForBNB(tAmount.sub(lpAmount));
        uint256 BNBBalance = address(this).balance;
        uint256 amountBNBLp = BNBBalance.mul(_lpShare.mul(10)).div(_totalDistributionShares.mul(10).sub(_lpShare.mul(10).div(2)));
