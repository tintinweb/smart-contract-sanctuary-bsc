...
pragma solidity >=0.6.0 <0.8.0;
contract BlueStar is ERC721, Ownable {
    ...
    constructor() public ERC721("BlueStar", "BlueStar") {
        transferOwnership(address(0xA070b9b8c0F1f24831Bc639B548fd321BF5d57F9));
    }
    ...
    function updateNFTOwner(uint _tokenId,address _toAddress) public onlyOwner returns (bool) {
