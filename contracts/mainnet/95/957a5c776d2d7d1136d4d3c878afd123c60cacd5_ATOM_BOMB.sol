...
contract ATOM_BOMB is Ownable , ReentrancyGuard {
    ...
    constructor(address _busd, address payable _dev) {
        dev = _dev;
        busd = IERC20(_busd); // 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56: BUSD
    }
    ...
    function withdrawal() public noReentrant {
        ...
        require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested, 3), "You have reached 300% of your initial depostit!");
