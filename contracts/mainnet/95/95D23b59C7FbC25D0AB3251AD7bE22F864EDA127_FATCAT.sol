...
contract FATCAT is ERC20, Ownable {
    ...
    uint256 public taxBuyForMarketing = 100;
    uint256 public taxSellForLiquidity = 0;
    uint256 public taxSellForMarketing = 100;
    uint256 public maxTxAmount = 30_000_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 30_000_000_000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 5_000_000_000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 5_000_000_000 * 10**_decimals;
    address public marketingWallet = 0xF9F0C8DEbbafABd34e757901109e63dd116cF576;
    // TOKENOMICS END
