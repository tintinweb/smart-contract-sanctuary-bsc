...
//telegram: https://t.me/kingsnakegrow
interface IERC20 {
...
contract KINGSNAKEGROW is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100e4 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 5_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 30_000 * 10**_decimals;
    uint256 public maxBuyAmount = 30_000 * 10**_decimals;
    uint256 public maxWalletBalance = 30_000 * 10**_decimals;

    address public marketingAddress = 0x2E370B477133Ca4Be0AeE9feb95243f41e3D3C8a;
    address public devAddress = 0x2E370B477133Ca4Be0AeE9feb95243f41e3D3C8a;

    string private constant _name = "KINGSNAKEGROW";
