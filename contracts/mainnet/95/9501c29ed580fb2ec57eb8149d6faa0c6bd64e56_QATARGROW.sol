...
contract QATARGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "QATAR GROW"; // 
    string private constant _symbol = "$QATARGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xd8F0b82005BdEc4D09dB5dFF9a781193731eA771;
