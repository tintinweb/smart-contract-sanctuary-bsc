...
contract RCBuyBackRewardToken is IERC20Extended, Auth, BaseToken {
    using SafeMath for uint256;
...
contract RCBuyBackRewardTokenFactory is Ownable{
    ...
    function deploy(
        ...
        RCBuyBackRewardToken token = new RCBuyBackRewardToken(
            name_,
            symbol_,
            totalSupply_,
            rewardToken_,
        ...
        token.transferOwnership(payable(msg.sender));
