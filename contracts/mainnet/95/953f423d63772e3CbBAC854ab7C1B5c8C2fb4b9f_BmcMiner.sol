...
contract BmcMiner {
	...
	uint[] public					REFERRAL_PERCENTS				= [50, 40, 30, 20, 10];		// 5% 4% 3% 2% 1%
	...
	constructor(address payable _walletProject, address payable _walletDev) {
        ...
        PLANS.push( TPlan(7,250) );
		PLANS.push( TPlan(8,227) );
		PLANS.push( TPlan(9,210) );
		PLANS.push( TPlan(10,196) );
		PLANS.push( TPlan(11,184) );
		PLANS.push( TPlan(12,175) );
		PLANS.push( TPlan(13,166) );
		PLANS.push( TPlan(14,160) );
		PLANS.push( TPlan(15,153) );
		PLANS.push( TPlan(16,148) );
		PLANS.push( TPlan(17,144) );
		PLANS.push( TPlan(18,139) );
		PLANS.push( TPlan(19,136) );
		PLANS.push( TPlan(20,132) );
		PLANS.push( TPlan(21,129) );
		PLANS.push( TPlan(22,127) );
		PLANS.push( TPlan(23,124) );
		PLANS.push( TPlan(24,122) );
		PLANS.push( TPlan(25,120) );
		PLANS.push( TPlan(26,118) );
		PLANS.push( TPlan(27,116) );
		PLANS.push( TPlan(28,114) );
		PLANS.push( TPlan(29,113) );
		PLANS.push( TPlan(30,111) );
