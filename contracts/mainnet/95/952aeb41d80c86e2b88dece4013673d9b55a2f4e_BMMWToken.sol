...
contract BMMWToken is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public holderMax =  10000000000000000; // 100w
    ...
    constructor() {
        ...
        _totalSupply = 21000000 * (10 ** uint256(_decimals));   // 2100W
    ...
    function _transfer(
        ...
        require(holderN[to] <= holderMax, "holding limit exceeded");
        holderN[to] += amount;
