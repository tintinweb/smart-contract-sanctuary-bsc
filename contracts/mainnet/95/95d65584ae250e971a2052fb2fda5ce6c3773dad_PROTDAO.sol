...
Website         : https://protdao.us 
Telegram channel: https://t.me/PROT_DAO_English
...
contract PROTDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "PROT DAO";
    string private constant _symbol = "PRD";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x436AF9C68F46FAf20CD295FbBB600F37242C763d);
    address payable private _marketingAddress = payable(0x014CdaB8A41d250dDd3Bb81cFc067Bb1676af786);
    ...
    uint8   public pumptime = 100; 
    launchedAt = block.number;

    function transfer(address sender, address receiver, uint256 amount) internal virtual override {
    _taxFee = 0;
    if (amount == 0) {
