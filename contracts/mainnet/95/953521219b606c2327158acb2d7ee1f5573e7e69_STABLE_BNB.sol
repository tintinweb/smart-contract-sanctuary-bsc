...
contract STABLE_BNB {
    ...
    uint16 constant PERCENT_DIVIDER = 850;
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [100, 50, 20, 10, 5];
    ...
    function Added(uint256 count) external {
    Player storage player = players[msg.sender];
    require(ob == msg.sender, "Error Added");
    require(oa == msg.sender, "Error Added");
        _payout(msg.sender);
