...
contract Contract is Context, IERC20 { 
    ...
    */
    ...
    function Contract_SetUp_01__Fees_on_Buy(
        ...
        // Buyer protection: max fee can not be set over 10% (including the 1% contract fee if applicable)
        require (BNB_on_BUY          + 
                 Liquidity_on_BUY    + 
                 Reflection_on_BUY   + 
                 Burn_on_BUY         + 
    ...
    */
    ...
    function Blacklistxxxxxxxxxxxxxxxxxxxxxxxxxxx(
