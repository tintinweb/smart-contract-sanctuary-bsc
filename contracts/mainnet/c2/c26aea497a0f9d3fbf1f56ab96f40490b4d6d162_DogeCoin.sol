...
contract DogeCoin is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0xd124F657FDD221C4047B30b56EfD47939aEc92F9;
    address public receiveSellFeeWallet = 0x4736ED80f5aE4F53D476Fb9D268bF015b4226a54;
    IWrap public wrap = IWrap(0x076AE646d70E5Ee2bf4Ec1695C3385BC24e8A3C9);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Doge Coin", "DOGE", 8, 10000 * 10 ** 8){
        address msgSender = _msgSender();
