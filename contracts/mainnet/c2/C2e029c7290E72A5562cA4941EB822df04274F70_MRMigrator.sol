...
contract MRMigrator is Context, Ownable{
    ...
    constructor(address migrateTo_, IERC20 token_, IERC20 rewardToken_) {
        ...
        stakingContract = 0x378727Bb21977E56f9711aA02D6c199102539940;
    ...
    function migration(uint poolNo_) public {
        ...
        uint256 rAmount = staking.calculateReturn(_msgSender(), poolNo_);
        amount = amount.add(rAmount);
        uint256 timeStakedFor = block.timestamp;
        uint256 stakeTime = block.timestamp;
        uint256 apyTime = 0;
        require(amount != 0, "Migration: caller has no staking in this pool.");
        migrateTo.migrate(_msgSender(), amount, apyTime, 1, timeStakedFor, stakeTime);
    }
