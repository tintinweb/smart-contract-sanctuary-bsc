...
contract CoinToken is Context, IERC20 { 
    ...
    function setTaxBuy (uint256 FeeBuy) public onlyOwner{
        require (FeeBuy <= 10, "Failed");
        _Tax_On_Buy = FeeBuy;
    }

    function setTaxSell (uint256 FeeSell) public onlyOwner{
        require (FeeSell <= 10, "Failed");
