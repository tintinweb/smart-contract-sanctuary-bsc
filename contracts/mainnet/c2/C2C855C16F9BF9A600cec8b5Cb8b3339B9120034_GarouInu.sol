...
/*
GarouInu is a new BSC token that was inspired by one of the One-Punch Man anime character, Garou. Garou, which is the only character that is in-par with Saitama was recently in the hot topics. GarouInu will build a complete set of all the OPM characters. 
- Inspired by the current hot topic with bullish name
- Token with a clear target & utility
- 4% of low tax fees
- Pre-launch marketing plans arranged

Join us on TG : https://t.me/GarouInuOfficial
*/
...
contract GarouInu is Context, IERC20 { 
    ...
    string private constant _symbol = "GAROU"; 
