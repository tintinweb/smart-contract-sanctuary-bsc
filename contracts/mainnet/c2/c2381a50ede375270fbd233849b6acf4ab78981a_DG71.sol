...
The Year Elon Musk Was Born

TG: https://t.me/Doge1971
...
library Address{
 ...
 contract DG71 is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGE1971";
    string private constant _symbol = "DG71";
    ...
    Taxes private taxes = Taxes(0,8,2, 0);
    Taxes private sellTaxes = Taxes(0, 13, 2, 0);
