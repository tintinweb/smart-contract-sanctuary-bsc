...
/**
    Telegram: https://t.me/GalaCatPortal
*/

/**

    A hacker attack probably caused the GALA price to collapse. 

    This is just the beginning of a trend that will bring GALA to all newspapers in a matter of days.

    Gala Cat is here to print Rewards for all holders with a bag bigger than 1% of the Total Supply. 
...
contract GALACat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "GALA Cat";
    string constant _symbol = "GALACAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x6f78d5031ab4870FC2e96fb85b838002b172dF2d;
