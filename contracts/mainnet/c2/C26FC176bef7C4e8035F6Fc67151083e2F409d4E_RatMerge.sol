...
/**
🐀🐀 RatMerge 🐀🐀
Telegram Group : https://t.me/RatMerge

BSC Token with staking & lucky draw DApp, RatMerge will soon launch in BSC. 
By staking your RatMerge, you will be granted a high reflection of RatMerge, and if you reach the minimum staking amount, you will also receive a lucky draw ticket to get other blue chips crypto.
RatMerge will fair launch at 6th of September, contract will be shared on launch.

TOKENOMICS
1) 1 Trillion of Supply
2) 10% of Buy & Sell Tax
3) Initial LP of 1 BNB
4) Initial Burn of 10% RatMerge
*/
...
contract RatMerge is Context, IERC20, Ownable {
    ...
    string private constant _name = "RATMERGE"; // 
    string private constant _symbol = "RATMERGE"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xf92d05ED1B2C6Bc329456232Bc59484cF74db632;
