...
//Ha Nacido Un Albert Einstein en República Dominicana
//Ha Nacido el mejor diseño de inversión del planeta tierra 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2aE9Db7F121930C0CD5CA7348D06C77670218ED0;
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract MantequillaFinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAD2F7694c968A86B7647d5064a584001d586e80f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mantequilla Finance";
    string private _symbol = "MFT";
    uint8 private _decimals = 18; 
    uint256 public _taxFee = 20; //2%
