...
contract TWIDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD15412dd13793bdEC5101712f998Ed2eF5631C43); 
    address payable private Wallet_Dev = payable(0xD15412dd13793bdEC5101712f998Ed2eF5631C43);
    ...
    string private constant _name = "TWIDOGE"; 
    string private constant _symbol = unicode"TWIDOGE"; 
    ...
    constructor () {
        ...
        _owner = 0xD15412dd13793bdEC5101712f998Ed2eF5631C43;
