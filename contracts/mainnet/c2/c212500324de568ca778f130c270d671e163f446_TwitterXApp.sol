...
library Address{
 ...
 contract TwitterXApp is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8f112Aa9A81567a3AC42b16975139C0a4E3335bF;
    address public donationWallet = 0x8f112Aa9A81567a3AC42b16975139C0a4E3335bF;

    string private constant _name = "TwitterX App";
    string private constant _symbol = "$TXAPP";
