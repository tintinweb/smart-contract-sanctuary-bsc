...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x8545b223f10a64282a3540cF571dF585e20AD89A); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x8545b223f10a64282a3540cF571dF585e20AD89A); // Liquidity Address
    ...
    constructor() {
        address newOwner = address(0x8545b223f10a64282a3540cF571dF585e20AD89A);
        ...
        maxTransactionAmount = _tTotal * 1 / 100; // 10000% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = _tTotal * 5 / 100; // 100% max wallet
