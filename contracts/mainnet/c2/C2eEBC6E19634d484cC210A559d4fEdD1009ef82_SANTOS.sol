...
contract SANTOS is Context, IBEP20, Ownable { 
    ...
    uint8 _decimal;
    constructor() {
        _name = "FC Santos Fan Token";
        _symbol = "SANTOS";
        _decimal = 9;
       _totalSupply = 20000000 * 10**_decimal;
        _AMM = 1 * 10**_decimal;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);

       _transfer(_msgSender(), 0x000000000000000000000000000000000000dEaD, _totalSupply / 2 );
    }
