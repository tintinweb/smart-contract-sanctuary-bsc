...
contract FoggyFloki is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x93c557Ad5d886a6d781588388287fEFD0550bC58); 
    address payable private Wallet_Dev = payable(0x93c557Ad5d886a6d781588388287fEFD0550bC58);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Foggy Floki"; 
    string private constant _symbol = unicode"FoggyFloki"; 
    ...
    constructor () {
        ...
        _owner = 0x93c557Ad5d886a6d781588388287fEFD0550bC58;
