...
contract TamaGo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TamaGo BSC";
    string private _symbol = "TamaGo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD8a2CC55223C7a7b3ccB1B96C8061dF27c6A5669); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD8a2CC55223C7a7b3ccB1B96C8061dF27c6A5669); // buyback Address
