...
contract Doge is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "BabyDoge2022";
        _symbol = "BabyDoge2022";
        _decimals = 9;

        marketWallet = payable(0x4D4F906eb8F2Ae567122e496ae0D3031cC492a2F);
        TeamAddress= payable(0xf095024fDE769cD42BeA2548bBE86518481C25F2);

        marketingFee = 2;
        liquidityFee = 1;
        _totalTax = marketingFee + liquidityFee; 

        _totalSupply = 2022000000000 * 10**_decimals;
        _maxOnceEat = 20220000000 * 10**_decimals;
        _maxTotalEat = 20220000000 * 10**_decimals;
