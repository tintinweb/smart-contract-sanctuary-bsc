...
contract GALACLASSIC is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**7; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000000 * 10**7; //
    string private constant _name = "GALA CLASSIC"; // 
    string private constant _symbol = "GALAC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address public  _marketingWallet = 0xb495AB0e0476605083C5394940C1fa313709aeCf;
