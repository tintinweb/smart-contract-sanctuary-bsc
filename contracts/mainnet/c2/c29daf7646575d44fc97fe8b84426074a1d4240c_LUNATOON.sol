...
contract LUNATOON is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 210_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5_000 * 10**9; //
    string private constant _name = "LunaToon"; // 
    string private constant _symbol = "$LUNATOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xeD349E75030fA77068305052cdDaE5f6c604a852;
