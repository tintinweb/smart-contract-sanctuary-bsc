...
contract CASPERFLOKI is Context, IERC20 { 
    ...
    string private constant _name = "CASPER FLOKI"; 
    string private constant _symbol = unicode"CASPERFLOKI"; 
