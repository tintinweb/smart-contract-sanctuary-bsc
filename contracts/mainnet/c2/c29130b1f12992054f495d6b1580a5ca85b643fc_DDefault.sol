...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "BooCoin";
    string private _symbol = "BOOCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd9B8AeE76DE482C7847D7be8912f197FDD620457); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc289C24e951321f1d88621F898B4F31B5d5B2f49); // BuyBack Address
