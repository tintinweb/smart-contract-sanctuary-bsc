...
contract ARABIANYACHTCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "ARABIAN YACHT CLUB";
    string private constant _symbol = "$ARABIANYACHTCLUB";
