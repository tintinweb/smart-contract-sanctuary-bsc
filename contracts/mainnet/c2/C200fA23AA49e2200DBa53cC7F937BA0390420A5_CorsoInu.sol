...
contract CorsoInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Corso Inu";
    string constant _symbol = unicode"🐶CINU";
    ...
    address public MarketingFeeReceiver =
        0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657;
    ...
    constructor() Auth(address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657)) {
        ...
        isFeeExempt[address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657)] = true;
        isTxLimitExempt[address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657)] = _totalSupply;
        emit Transfer(address(0), address(0xb0dDB0a3c4716f48Da4C5CfA0Cb5E56c52235657), _totalSupply);
    }
