...
Telegram https://t.me/Adzuki_Inu_Community
Website https://adzukiinu.site
*/
...
contract ADZUKI is Context, IERC20, Ownable {
    ...
    string private _name = "ADZUKI INU";
    string private _symbol = "ADZUKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x939aea68f9eEc0215587711C49b2D2aF95E48384); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x939aea68f9eEc0215587711C49b2D2aF95E48384); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 200 * 10**7 * 10**9;
    uint256 public _walletMax = 200 * 10**7 * 10**9;
