...
/*
  ArtiX AI uses advanced algorithms to analyze market data and provide users with real-time trading signals and automated trading strategies.
  It is an artificial intelligence supported platform for cryptocurrency trading.

  ArtiX AI will collect and analyze large amounts of data from various sources such as social media, news articles and financial data to identify patterns,
...
contract artixai is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 475000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Artix AI";
    string private _symbol = "ARTIX";
    ...
    address public charityWallet = 0x7D1c6Feedab029B18daE0cb4DB3C5d8F7747c48d;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 4750000 * 10**9;
    uint256 public _maxTxAmount = 475000000 * 10**9;
