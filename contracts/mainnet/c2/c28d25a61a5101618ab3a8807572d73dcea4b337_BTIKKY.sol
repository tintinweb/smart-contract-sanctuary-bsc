...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  TIKKY = IBEP20(0xAC378638ace29fe9288FE2215Fa947DbF5ad59D2);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TIKKY.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(TIKKY);
        ...
        uint256 amount = TIKKY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TIKKY.transfer(shareholder, amount);
...
/* Token contract */
contract BTIKKY is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address TIKKY = 0xAC378638ace29fe9288FE2215Fa947DbF5ad59D2; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb1dc5661ceF1BE111dbf5EBB3A5e59fe1fEeD04B;
    ...
    // Name and symbol
    string constant _name = "Baby Tikky";
    string constant _symbol = "BTIKKY";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xFF7A55dda798F730D5Be7042A55aD4DE6aE1Eb86;
