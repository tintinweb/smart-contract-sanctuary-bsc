...
contract BabyDogeZilla is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69_000_000_000_000_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WierdToken";
    ...
    uint256 public _maxTxAmount = 1_380_000_000_000_000_000_000 * 10**9; // 2%

    uint256 public constant _maxTxAmountLimit = 1_380_000_000_000_000_000_000 * 10**9; // 2%
    uint256 public constant _minTxAmountLimit = 34_500_000_000_000_000_000 * 10**9; // 0.5%

    uint256 public _minTriggerAmount = 69_000_000_000_000_000_000 * 10**9; // 0.1%

    uint256 public constant _maxTriggerAmountLimit = 690_000_000_000_000_000_000 * 10**9; // 1%
    uint256 public constant _minTriggerAmountLimit = 69_000_000_000_000_000_000 * 10**9; // 0.1%
    ...
    function withdrawOtherTokens(IERC20 tokenAddress, address account) external onlyOwner() {
