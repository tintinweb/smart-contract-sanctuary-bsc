...
contract KitsugeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kitsuge Inu";
    string private _symbol = unicode"キツゲ・イヌ";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xce27Ac55E91553f6923dA60bfA9de14CE0f56ee1);
    address payable public developmentWalletAddress = payable(0x91f9AAc60D2447f83219CC2104090722d885AfFE);
