...
contract StarbucksDollar is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StarbucksDollar";
    string constant _symbol = "$StarbucksDollar";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x94358Ed7ADbE09FD4FD9A05c30c51c3b58f8AaEa;
