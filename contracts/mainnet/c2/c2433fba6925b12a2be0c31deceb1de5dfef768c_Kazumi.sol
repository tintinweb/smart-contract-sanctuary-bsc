...
contract Kazumi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kazumi Inu";
    string private _symbol = "Kazumi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5B5E1BaF68A1e003fC3e78711E1A21eb25CA04e2);
    address payable public BuyBackWalletAddress = payable(0x5B5E1BaF68A1e003fC3e78711E1A21eb25CA04e2);
