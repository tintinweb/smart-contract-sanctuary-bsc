...
/*
在汉字文化圈中，龙，又称中国龙，是中国神话、中国民俗中的传说生物。龙有许多类似动物的形态，有如龟形和鱼形，常被描述的是有四足的蛇形。有学者们对中国龙的起源确定了四种可靠的理论：蛇、中华短吻鳄、闪电和自然崇拜[1]。传统上，龙象征着强大和吉祥的力量，特别是对水、降雨、台风和洪水的控制。在中国文化中，优秀和杰出的人被比作龙，而没有能力、没有成就的人则被比作其他不受欢迎的生物。许多中国谚语和成语都提到了龙和其他不受欢迎的生物，例如“望子成龙”和“胆小如鼠”。
...
contract ZhongGuoLong is Context, IERC20, Ownable {
    ...
    string private _name = "中國龍";
    string private _symbol = "中國龍";
    ...
    address public ownerAddres = address(0x2a9cbF4FF9FeBa7eF4E8167E9F937500e20Df12e);
    address public devAddress = address(0x2a9cbF4FF9FeBa7eF4E8167E9F937500e20Df12e);
