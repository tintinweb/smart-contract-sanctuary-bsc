...
contract Vyper_contract{
    uint256 public EGGS_TO_HATCH_1MINERS=575424; //15%daily
    uint256 PSN=10000;
    uint256 PSNH=5000;
    uint public startTime = 1676408938; // Live Feb 15 2023
    ...
    uint256 public marketEggs = 57542400000; //15% daily
    constructor() public{
        ceoAddress=msg.sender;
        devAddress=address(0x1437f924a04133ec872BBb5A301f746942AAF1F0);
        fundAddress=address(0xe9b14300d3E2538C33396f2A333e9A46b73a68c5); //5% 
        mrkoneAddress=address(0xe9b14300d3E2538C33396f2A333e9A46b73a68c5);
        mrktwoAddress=address(0xe9b14300d3E2538C33396f2A333e9A46b73a68c5);
    }
