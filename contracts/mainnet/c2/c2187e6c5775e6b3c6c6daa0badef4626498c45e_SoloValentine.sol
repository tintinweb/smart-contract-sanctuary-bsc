 ...
 *  Telegram : https://t.me/solovalentine
 *
 *  Welcome to Solo Valentine's
 *  Are you alone on Valentine's Day? Are you feeling lonely? No worries.        
 *  Let's join the SOLOs worldwide community and go to Coruscant together!
*/         
...
contract SoloValentine is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Solo Valentine's";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xC3Ad4Ffd4c9a3006AfbCE7559f7Cc8Ad3284824b;
