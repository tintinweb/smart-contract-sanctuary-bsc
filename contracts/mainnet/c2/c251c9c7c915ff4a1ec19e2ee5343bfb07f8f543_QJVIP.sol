...
contract QJVIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJVIP";
    string private _symbol = "QJVIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33593ffA4C643768795967623c15CEb2F4766587);
    address payable public teamWalletAddress = payable(0x33593ffA4C643768795967623c15CEb2F4766587);
    address public immutable deadAddress = 0x33593ffA4C643768795967623c15CEb2F4766587;
