...
/**
SaudiPancake stealth launch

SaudiPancake is your next BSC moonshot and a rare BSC gem. SaudiPancake is a Decentralized finance (DeFi) meme token that focused on providing benefits while holding. Giving all holders with security in the present and value in the future. We have auto adding liquidity protocol.
...
🟢Liquidity lock
🟢Experience Dev
🟢Verified Contractat means next to zero risk for our users and community from potential bad actors.

Telegram : https://t.me/saudipancake
Twitter : https://twitter.com/saudipancake
*/
...
contract Saudipancake is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x478869349f2992215c17170fA6059Db60c9eBEcD); 
    address payable public Wallet_Dev = payable(0x0Bf4c2098B05821C48cACCfa15312f019A82260a);
    ...
    string private constant _name = "Saudipancake"; 
    string private constant _symbol = unicode"Saudipancake"; 
    ...
    constructor () {
        ...
        _owner = 0x0Bf4c2098B05821C48cACCfa15312f019A82260a;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x478869349f2992215c17170fA6059Db60c9eBEcD); // Testnet
        uniSwapV2Pair = payable(0x0Bf4c2098B05821C48cACCfa15312f019A82260a);
