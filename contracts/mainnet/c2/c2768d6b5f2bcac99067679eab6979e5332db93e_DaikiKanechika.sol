...
contract DaikiKanechika is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Daiki Kanechika";
    string private _symbol ="Daiki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDabABDF39cB63B88f96380D1001Da82acBe08eC2);
    address payable public teamWalletAddress = payable(0xDabABDF39cB63B88f96380D1001Da82acBe08eC2);
