...
// Telegram : https://t.me/SamuelBankmanFried_Ftx
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x03aef98c05D34B14f44574d206738db62C20101d; // owner address
...
contract SamuelBankmanFried is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SamuelBankmanFried";
    string private _symbol = "SAM";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x03aef98c05D34B14f44574d206738db62C20101d); // Marketing Address
    address payable public teamWalletAddress = payable(0x03aef98c05D34B14f44574d206738db62C20101d); // Team Address
