...
contract FMA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FMA";
    string private _symbol = "FMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1D9d7A9A7d04732d08E9b18B2f8981b7A4D47cD0);
    address payable public teamWalletAddress = payable(0x1D9d7A9A7d04732d08E9b18B2f8981b7A4D47cD0);
