...
// Dependency file: contracts/vrf/CryptoDropLotoV4.sol
...
/// @notice CryptoDrop V4 V4
contract CryptoDropLotoV4 is VRFElementIdBytes16 {
    using SafeERC20 for IERC20;
    using Address for address;
...
// Root file: contracts/test/TestDropLotoV4.sol


pragma solidity ^0.8.0;

// import "contracts/vrf/CryptoDropLotoV4.sol";

contract TestDropLotoV4 is CryptoDropLotoV4 {
    constructor(address _vrfCoordinator, address _linkToken) CryptoDropLotoV4(_vrfCoordinator, _linkToken) {}
}