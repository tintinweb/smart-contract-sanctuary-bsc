...
—> Degen play most likely so take profits! 
—> Launching any minute...


THIS ONE IS FOR THE REAL APERS
                🐈QUEEN CAT🐈
...
Website: TBA
Telegram - https://t.me/QueenCatPortal
*/
...
contract QUEENCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUEENCAT";
    string private _symbol = "QUEENCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53003433151638C3E65870905a36e8B43Fbff907);
    address payable public teamWalletAddress = payable(0x53003433151638C3E65870905a36e8B43Fbff907);
