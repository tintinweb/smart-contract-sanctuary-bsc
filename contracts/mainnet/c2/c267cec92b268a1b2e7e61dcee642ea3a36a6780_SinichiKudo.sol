...
contract SinichiKudo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x68A6dBeD640FAC493741BAAd4FBFF102a95BE64E); 
    address payable public Wallet_Dev = payable(0x68A6dBeD640FAC493741BAAd4FBFF102a95BE64E);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x68A6dBeD640FAC493741BAAd4FBFF102a95BE64E); 
    ...
    string private constant _name = "Sinichi Kudo"; 
    string private constant _symbol = unicode"KUDO"; 
    ...
    uint256 public Percent_AutoLP = 80; 
    ...
    constructor () {
        ...
        _owner = 0x68A6dBeD640FAC493741BAAd4FBFF102a95BE64E;
