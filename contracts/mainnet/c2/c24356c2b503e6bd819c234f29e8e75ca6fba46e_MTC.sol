...
contract MTC is IERC20, Ownable {
    ...
    address _marktAddress = address(0x7c7733ED8E751BEE200900f52BAeC04C0F5A8A5C);
    address _fundAddress = address(0xAbca21c361907a2aa076Fe9176e302C1Ba4B619f);
    
    address _superNodeAddress = address(0xd590E84996bF56170049b3eb7448D18F0Caef811);
    ...
    function getSellAmount(address user) public view returns(uint256){
        if(sellTime[user] < getNowSellTime()){
            return rewardDayAmount[user] + (balanceOf(user).div(100));
        }
        return 0;
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeInviterFee(sender, recipient, tAmount, currentRate);//8
            rate = 10;
        }
    ...
    function _takeInviterFee(
        ...
        for (uint256 i = 0; i < 16; i++) {
            ...
            uint256 curTAmount = tAmount.div(200);
