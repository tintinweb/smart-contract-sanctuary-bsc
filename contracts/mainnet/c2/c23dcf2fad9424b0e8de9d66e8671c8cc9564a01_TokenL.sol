...
contract TokenL is IERC20, Ownable {
	...
	string private constant _name =  "TokenL"; //LUCKY ROO";
	string private constant _symbol = "TokenL"; //ROO";
	...
	function _swapAndLiquify() private {
        ...
        payable(airdropWallet).transfer(amountEthAirdrop);
