...
//
//Eth Merge Complete, enjoy Binance pegged Eth as Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BETH = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //Weth
...
contract EthMergeComplete is IERC20 {
    ...
    string constant private _name = "Merge";
    string constant private _symbol = "Complete";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8C2685c9601A34dB8CC25b964cc9618b0338fdfd),
        tokensTax: 0x8C2685c9601A34dB8CC25b964cc9618b0338fdfd
    });
...
//===============================================================================================================
    ...
    function setSwapSettings(uint256 _swapAmount) external onlyOwner {
