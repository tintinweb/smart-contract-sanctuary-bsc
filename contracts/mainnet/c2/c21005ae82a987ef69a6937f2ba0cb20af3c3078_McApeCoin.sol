...
contract McApeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McApe Coin";
    string private _symbol = "McApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46713b45147eADA71d0d2daec33e18e7bBA7F356); 
    address payable public buyBackWalletAddress = payable(0x46713b45147eADA71d0d2daec33e18e7bBA7F356); 
