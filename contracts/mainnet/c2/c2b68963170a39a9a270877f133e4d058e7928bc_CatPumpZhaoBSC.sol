...
// Telegram : https://t.me/catpumpzhaobsc
...
/* Token contract */
contract CatPumpZhaoBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3EF140e363E9EB46B51bCf17F528E8b9e40bdAE8;
    ...
    // Name and symbol
    string constant _name = "Cat Pump Zhao BSC";
    string constant _symbol = "$CPZBSC";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 100%
