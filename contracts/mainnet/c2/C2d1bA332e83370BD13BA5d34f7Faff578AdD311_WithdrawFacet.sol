...
contract WithdrawFacet {
    ...
    function withdrawTokens(address _token, address _to, uint56 _amount) external {
        LibDiamond.enforceIsContractOwner();
        
        uint256 assetBalance = IERC20(_token).balanceOf(address(this));
        require(_amount <= assetBalance, "Not enough tokens to withdraw.");
        SafeERC20.safeTransfer(IERC20(_token), _to, _amount);
    }

    function withdrawNative(address _to, uint56 _amount) external {
        LibDiamond.enforceIsContractOwner();
