...
contract ShibaTate is IBEP20, Ownable
{
    ...
    string private constant _symbol = 'SHIBATATE';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply= 10**15 * 10**_decimals;//equals 1.000.000.000.000.000 Token
