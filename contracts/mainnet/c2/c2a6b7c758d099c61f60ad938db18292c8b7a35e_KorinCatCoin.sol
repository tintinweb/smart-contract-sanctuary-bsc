...
//Korin is a wise cat who is over 800 years old, martial arts expert, lives alone in the Kori Tower and was one of Goku's martial arts masters - Dragon Ball Z
//taxes : Buy 5% Sell 5%
...
contract KorinCatCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KorinCatCoin";
    string private _symbol = "$KCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbf793B3da92031B13913F56045c368ec85034A58); // Marketing Address
    address payable public devWalletAddress = payable(0xF84602E75F69E21069ABE8DAbC003A38FbbAB9Ab); // dev and team Address
    ...
    uint256 private minimumTokensBeforeSwap = 75000 * 10**9; 
