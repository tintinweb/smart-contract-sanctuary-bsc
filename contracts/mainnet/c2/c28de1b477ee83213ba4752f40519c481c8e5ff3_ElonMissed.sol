...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d83909876910dFb7b1C4055fa8Dc1653F2e3FC4; // owner address
...
contract ElonMissed is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonMissedLordOfTheRings Inu";
    string private _symbol = "EMLOTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9673c35e88251CBd2eE63Dfce56dA8A56D5F0D64); // Marketing Address
    address payable public teamWalletAddress = payable(0x8d83909876910dFb7b1C4055fa8Dc1653F2e3FC4); // Team Address
