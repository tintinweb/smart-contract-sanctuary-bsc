...
contract NewYearInu is IBEP20, Ownable {
    ...
    string constant _name = "New Year Inu"; // To Do
    string constant _symbol = "NYI"; // To Do
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (20); // 2%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (20); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (20); // 2%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0x441083817209c1763d45FC61328C11BF4f5352fE;
    address public devFeeReceiver = 0x441083817209c1763d45FC61328C11BF4f5352fE;
    address public buybackFeeReceiver = 0x441083817209c1763d45FC61328C11BF4f5352fE;
