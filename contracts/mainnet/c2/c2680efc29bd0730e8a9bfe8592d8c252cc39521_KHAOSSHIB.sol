...
contract KHAOSSHIB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "KHAOSSHIB COIN";
    string private _symbol = "KHAOSSHIB";
...
mapping (address => bool) public isMarketPair;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE1D53BaCfD0B71b1D1Ff1a79045b9aa6F804D651));
        marketingWalletAddress = payable(address(0xE1D53BaCfD0B71b1D1Ff1a79045b9aa6F804D651));
