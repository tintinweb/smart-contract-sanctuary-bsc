...
contract Suijin is Context, IERC20, Ownable {
    ...
    string private _name = "Suijin Girl";
    string private _symbol = "SUIJIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x589DDddecdF597971dF328113A3deE7bD32DAeDe); 
    address payable public buyBackWalletAddress = payable(0x624CdD05F8DdFd1BfFA6B087a79bb487548CffAC); 
