...
contract LaeebWorldCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Laeeb WorldCup";
    string private _symbol = "LaeebWC";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x9800136f3dA1d9a94f08963087DaD81C7E8Bf2Ff); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9800136f3dA1d9a94f08963087DaD81C7E8Bf2Ff); // BuyBack Address
