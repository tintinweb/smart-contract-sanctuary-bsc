...
contract DeerVampire is IBEP20, Auth {
    ...
    string constant _name = "Deer Vampire";
    string constant _symbol = "DVAMPIRE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 400;
    uint256 public _maxWalletToken = _totalSupply / 400;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaB0c8bf5E35be8A4E955b1fd77726Acd8de33407;
        treasuryFeeReceiver = 0xaB0c8bf5E35be8A4E955b1fd77726Acd8de33407;
        devFeeReceiver = 0xaB0c8bf5E35be8A4E955b1fd77726Acd8de33407;
