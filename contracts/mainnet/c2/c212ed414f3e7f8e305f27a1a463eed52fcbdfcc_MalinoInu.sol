...
contract MalinoInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Malino Inu";
    string constant _symbol = "MAIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x954f77625E609B921db7fEdE8A09107aCa1fd62a;
        devfeeReceiver = DEAD;
