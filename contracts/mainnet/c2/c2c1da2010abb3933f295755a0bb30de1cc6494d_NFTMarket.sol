...
//   address public nftContractAddress;
  ...
  function claimBidItem(uint256 itemId,address nftContractAddress) public nonReentrant {
    require(idToMarketItem[itemId].isOnAuction,"Item is not on auction");
  ...
  function withdraw() public onlyOwner{
    ...
    function withdrawnft(address _nftContractAddress , uint256 tokenId) public onlyOwner
    {

    IERC721(_nftContractAddress).transferFrom(address(this), msg.sender, tokenId);
  }
