...
contract Gym is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x56b77A42f6b5b0195BFc6387d47e7908e7e9BD43); // Marketing Address
    ...
    uint256 public _maxTxAmount = 90 * 10**6 * 10**18;
