...
contract NomadBerylBit is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nomad BerylBit";
    string private _symbol = "NOMADBRB";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xB1405fEf7240E0aAB0D81F06cDA79a70fa97480D);
