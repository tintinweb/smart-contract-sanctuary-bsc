...
import "../interface/IBinancePool_R3.sol";

contract BinancePool_R8 is
    PausableUpgradeable,
...
interface IBinancePool_R3 {
    ...
    // function stakeAndClaimBondsWithCode(address staker) external payable;

    function stakeAndClaimCerts() external payable;

    // function stakeAndClaimCertFor() external payable;
