...
/**
        Tetsuya Inu
        Telegram: https://t.me/TetsuyaInuPortal
*/
...
contract TETSU is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Tetsuya Inu";
    string constant _symbol = "TETSU";
    ...
    address public marketingFeeReceiver = 0x735e646BFe20f7898Bbc03A987254F74D394cF3D;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 285;
    bool inSwap;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x735e646BFe20f7898Bbc03A987254F74D394cF3D] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x735e646BFe20f7898Bbc03A987254F74D394cF3D] = true;
