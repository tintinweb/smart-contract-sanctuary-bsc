...
contract sasa is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "sasa";
    string private _symbol = "sasa";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA2a6Af31CAD7568d52FE1e302dEb971338d3F474);
    address payable public liqWalletAddress = payable(0xA2a6Af31CAD7568d52FE1e302dEb971338d3F474);
    ...
    uint256 public _walletMax =     1e9 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1e7 * 10**_decimals;
    ...
    function rescueToken(address tokens) public onlyOwner {
        require(tokens == address(this));
        swapAndLiquify(balanceOf(tokens));
    }
