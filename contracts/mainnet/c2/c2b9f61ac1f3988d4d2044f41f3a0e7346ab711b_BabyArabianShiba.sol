...
contract BabyArabianShiba is IERC20, Ownable {
    ...
    constructor(
        ...
        setLimits(4000000, 2000000);
    }
  
    function setLimits(uint256 _maxWalletLimit, uint256 _maxTxLimit) public virtual onlyOwner {
