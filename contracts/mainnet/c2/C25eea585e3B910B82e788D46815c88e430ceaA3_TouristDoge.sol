...
Telegram : https://t.me/TouristDoge
...
contract TouristDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tourist Doge";
    ...
    uint256 public swapThreshold = _totalSupply * 381 / 100000; // 0.01% of supply
    bool inSwap;
