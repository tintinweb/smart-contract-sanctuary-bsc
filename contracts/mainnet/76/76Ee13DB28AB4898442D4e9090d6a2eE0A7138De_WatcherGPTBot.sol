...
contract WatcherGPTBot is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WatcherGPT ";
    string private _symbol = "WatcherGPT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x8AD575bAaA88EE3D3FF02A1a2a47F05Eeca14492);
