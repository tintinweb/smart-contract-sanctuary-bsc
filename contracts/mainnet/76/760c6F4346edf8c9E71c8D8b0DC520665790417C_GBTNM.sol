...
contract GBTNM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Grudge Breal To New Mutiny";

    string private _symbol = "GBTNM";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x163Ab332fB464f2bDA4F4155CF043fab5E9281B4;
