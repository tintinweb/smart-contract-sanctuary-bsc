...
contract UltraApeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ultra Ape Coin";
    string private _symbol = "UAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA500132F959567968ea494b2fD38d2C7f229bA32); 
    address payable public buyBackWalletAddress = payable(0xA500132F959567968ea494b2fD38d2C7f229bA32); 
