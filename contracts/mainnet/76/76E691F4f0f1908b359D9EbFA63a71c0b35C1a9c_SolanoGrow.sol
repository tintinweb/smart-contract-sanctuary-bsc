...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20 (0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //rewards address here
    ...
    contract SolanoGrow is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1 / 400; //2%
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 400; // 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 400; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3827381c3888c1d7D7311ecb686A2415d9421aF3; //Marketing wallet
        devFeeReceiver = 0x110F782670408E6A1b65EcC6Ded5B63d4FeB3589; //Dev fee
