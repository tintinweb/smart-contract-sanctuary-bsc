...
//Telegram: https://t.me/+vtJDvtrnsQxlZTgx
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBf3c0Af8f1ffd2971A2961Dc46868f31A95b997F; // owner address
...
contract GOLDENGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Golden Grow";
    string private _symbol = "GROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBf3c0Af8f1ffd2971A2961Dc46868f31A95b997F);
    address payable public teamWalletAddress = payable(0xBf3c0Af8f1ffd2971A2961Dc46868f31A95b997F); 
    ...
    uint256 private minimumTokensBeforeSwap = 1_00 * 10**_decimals; 
