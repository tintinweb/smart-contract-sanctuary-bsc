...
contract  zxz is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "zxz";
    string private _symbol = "zxz";
    ...
    constructor () {
        ...
        DXtw = payable(address(0xCD03673F28f8A7F4D7EB93ea0227c38Ec0b0Aa90));
