...
contract ClemoLottery3 is ERC721, Ownable {
    using Strings for uint256;
    ...
    // URIs
    string public uriPrefix = "ipfs://QmYRoPrfpSn6JCGqKjPpCrwUUostBfKsJQeaFTa1XL25Mt/";
    string public uriSuffix = ".json";
    
    // Costs
    uint256 public publicsaleCost = 0.10 ether;

    // Supplies
    uint256 public maxSupply = 1500;
    uint256 public maxSupplyLimit = 1500;

    // Per Address & TX Limits
    uint256 public nftPublicsalePerAddressLimit = 20;
    ...
    // Constructor
    constructor() ERC721("Clemo Lottery 3", "CLOTTO3") {}
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(_mintAmount > 0 && _mintAmount <= nftPublicsalePerAddressLimit, "MSG: Invalid mint amount");
