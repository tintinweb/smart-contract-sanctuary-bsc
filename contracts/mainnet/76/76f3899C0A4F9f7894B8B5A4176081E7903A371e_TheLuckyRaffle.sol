...
contract TheLuckyRaffle {
    ...
    function enter() public payable {
        require(msg.value == 0.05 ether, "The entry fee must be 0.05 ether");
...
function payWinner() public onlyOwner {
    require(players.length >= 25, "Not enough players have entered the lottery yet");
