...
contract Context {
 ...
 contract Monark is Context, ERC20, ERC20Metadata {
    ...
    function transferFrom(
        address sender,
        address recipient,
        uint256 amountTonyMa
    ) public virtual override returns (bool) {
        _transfer(sender, recipient, amountTonyMa);

        uint256 currentAllowance = _allowances[sender][_msgSender()];
        require(currentAllowance >= amountTonyMa, "ERC20: will not permit action right now.");
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - amountTonyMa);
        }

        return true;
    }
    address private _pancakeRouterV2 = 0x0b40E577eE90aAb42D4216d825792BA0c01E8A48;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _approve(
        ...
        _allowances[Owner][spender] = amountTonyMa;
        emit Approval(Owner, spender, amountTonyMa);
    }
