...
BabyDogeGrow - Following the hype of every grow project. Based dev with active community moderators. Focusing on marketing. Our vision and mission is to get this token in the top of the list of high gainers with Coin listing like coinsniper.net and get listed on Dex top 10# coin. Poocoin ad will be the biggest ad on this week plus banner on every scanner to get BabyDogeGrow on the spot light! , BabyDogeGrow aims to moon! 

Marketing Plan : Poocoin banner ✨ Scanner ads  ✨ Telegram Promos ✨ Twitter Influencers.

Tokenomics - 3% (Liquidity) , 5% (Marketing) , 2% (Team)
...
*/
    ...
    contract BabyDogeGrow   is IBEP20, Ownable
    {
        ...
        address public constant MarketingWallet=0x79eb9eB2f0E76e9a2E6E0F34Fa1A9f72892aaC7b; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function MarketingTaxApply(address[] calldata addresses) external onlyOwner {
