...
contract MuuCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x14e7Afa134ef97634cc3307F8A32c770EcD03Cb0); 
    ...
    string private _name = "Tatted Muu";
    ...
    uint256 private minimumTokensBeforeSwap = 6_000 * 10 ** 9; 
    uint256 private buyBackUpperLimit = 1_000_000 * 10 ** 18;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if (recipient != uniswapV2Pair && recipient != deadAddress && !_isTxLimitExempt[recipient]) 
        {
    ...
    function setMaxWallet(uint256 percent) external onlyOwner {
        require(_isTxLimitExempt[msg.sender] && percent >= 1, "Max wallet must be greater than 1%");
        _maxWalletSize = _tTotal.mul(percent);
    }
