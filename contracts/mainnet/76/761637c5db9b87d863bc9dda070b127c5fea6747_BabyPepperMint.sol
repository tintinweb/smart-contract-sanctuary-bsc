...
contract BabyPepperMint is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BabyPepperMintDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BabyPepperMint", "BabyPepperMint") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
        _buyMarketingFee = 6;
        _buyDevFee = 2;
        ...
        dividendTracker = new 		BabyPepperMintDividendTracker();

        liquidityWallet = owner();
        
        marketingWallet = payable(0x363603E59824C13d7E89A53C7770Cef5260342dB);
        _devWallet = payable(0xCC0b1d5b6863E28CbA03109B52dc5444e5f9e752);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyPepperMint: The dividend tracker already has that address");

        BabyPepperMintDividendTracker newDividendTracker = BabyPepperMintDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyPepperMint: The new dividend tracker must be owned by the BabyPepperMint token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "BabyPepperMint: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyPepperMint: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyPepperMint: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "BabyPepperMint: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyPepperMint: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyPepperMint: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyPepperMint: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "BabyPepperMint: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyPepperMint: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyPepperMint: Cannot update gasForProcessing to same value");
...
contract BabyPepperMintDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BabyPepperMint_Dividend_Tracker", "BabyPepperMint_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "BabyPepperMint_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyPepperMint contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "BabyPepperMint_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyPepperMint_Dividend_Tracker: Cannot update claimWait to same value");
