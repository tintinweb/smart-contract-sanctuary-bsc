...
contract LONELYMONTH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LONELYMONTH";
    string private _symbol = "LONELYMONTH";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x24C906eBA4157d45F461d5Bc6Cbf8890dB13B641); // Marketing Address
    address payable public teamWalletAddress = payable(0x24C906eBA4157d45F461d5Bc6Cbf8890dB13B641); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x24C906eBA4157d45F461d5Bc6Cbf8890dB13B641),
            block.timestamp
        );
    }
