...
/**
Telegram : https://t.me/pitbullXmas
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6FF614Ed36671cebcec7998eFcFcD8e9b9C3cAFf; // owner address
...
contract PitbullXmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PitbullXmas";
    string private _symbol = "$PXMAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FF614Ed36671cebcec7998eFcFcD8e9b9C3cAFf); // Marketing Address
    address payable public teamWalletAddress = payable(0x6FF614Ed36671cebcec7998eFcFcD8e9b9C3cAFf); // Team Address
