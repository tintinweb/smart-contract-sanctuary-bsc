...
DogeFujitsu -  Fujitsu Inu is a japanese based token name , with organic members with some chinese on it , created to benefit all holders by redistributing all rewards pool. with the max wallet of 2% for each holders earn up to  3% of  BUSD direct to your wallet no need to claim.Liquidity is locked for 1 month to make sure all holders is safe. 2% goes to Liquidity and 2% for Marketing.
...
*/
    ...
    contract DogeFujitsu  is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeFujitsu";
        ...
        address public constant MarketingWallet=0x0a7Eccd100016bE2B9821A06782df997B75e6751; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function AddressReceivedBUSD(address[] calldata addresses) external onlyOwner {
