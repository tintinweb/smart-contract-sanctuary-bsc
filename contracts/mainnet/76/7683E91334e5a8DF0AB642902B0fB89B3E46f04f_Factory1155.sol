...
import "./NFTSeaUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NFTSeaMultipleUserToken{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NFTSeaMultipleUserToken token = NFTSeaMultipleUserToken(address(addr));
...
contract NFTSeaMultipleUserToken is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
