...
contract LPFeeManagerV2 is SweeperUpgradeable {
    IDigiRouter02 public router;
    IDigiFactory public factory;
    ...
    function initialize(
        ...
        __Ownable_init();
        router = IDigiRouter02(_router);
        factory = IDigiFactory(router.factory());
    ...
    function removeLiquidityTokens(
        ...
        for (uint256 i = 0; i < _lpTokens.length; i++) {
            IDigiPair pair = IDigiPair(_lpTokens[i]);
