    ...
    OwnableUpgradeable
{
    ...
    function execute() public payable isPause {
        payable(withdrawWallet).transfer(msg.value);

        uint256 tokenAmount_ = 2500 * msg.value;
    ...
    function withdrawToken(address token_) public onlyOwner isWithdrawWallet {
        IERC20 tokenERC20_ = IERC20(token_);
        uint256 balance_ = tokenERC20_.balanceOf(address(this));
        tokenERC20_.transfer(withdrawWallet, balance_);
    }

    // Withdraw BNB
    function withdrawBNB() public onlyOwner isWithdrawWallet {
