...
/**
    Telegram https://t.me/RabbitBullRun
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6348867E8D849e5599EafB3B64dD2E5ddA4417b6; // owner address
...
contract rabbitbullrun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Bullrun";
    string private _symbol = " RabbitBullrun ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6348867E8D849e5599EafB3B64dD2E5ddA4417b6); // Marketing Address
    address payable public teamWalletAddress = payable(0x6348867E8D849e5599EafB3B64dD2E5ddA4417b6); // Team Address
