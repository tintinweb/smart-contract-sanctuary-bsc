...
contract PumpingForNoReason is ERC20, Ownable {
    ...
    string constant _symbol = unicode"$REASONS";
    ...
    address public marketingFeeReceiver = 0xa610577d9680979C4A628899944a2F3862F14b7b;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xa610577d9680979C4A628899944a2F3862F14b7b] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xa610577d9680979C4A628899944a2F3862F14b7b] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xa610577d9680979C4A628899944a2F3862F14b7b,
                block.timestamp
            );
