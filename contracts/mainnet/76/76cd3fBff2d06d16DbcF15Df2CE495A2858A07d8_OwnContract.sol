...
contract OwnContract is  Ownable {
    ...
    function withdrawOfUSDT(uint256 amount, address receiver) public onlyOwner {
        amount = amount * 10**18;
        require(IERC20(addressOfUSDT).balanceOf(address(this)) >= amount, "Contract balance is not enough.");
    ...
    function withdrawOfBUSD(uint256 amount, address receiver) public onlyOwner {
        amount = amount * 10**18;
        require(IERC20(addressOfBUSD).balanceOf(address(this)) >= amount, "Contract balance is not enough.");
