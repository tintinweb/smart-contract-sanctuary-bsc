...
contract HALLOWRISE is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 25; // 1% of supply
    uint256 public maxTxAmountSell = _tTotal / 25; // 1% of supply
    ...
    string private constant _name = "HALLOWRISE";
    string private constant _symbol = "HRS";
