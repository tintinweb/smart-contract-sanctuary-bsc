...
contract  STN is Context, IERC20 {
    ...
    constructor ()  {
        _name = 'Secure Trade Network';
        _symbol = 'STN';
        _totalSupply = 5100000e18;
        _decimals = 18;
...
// ////////////////////////////////////////////////////////////////////
        ...
        if(_isExcluded[sender]==false ){
            uint256 tax=(amount.mul(marketselltax)).div(100);
            uint256 remaining=amount.sub(tax);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(_isExcluded[recipient]==false ){
            uint256 tax=(amount.mul(marketbuytax)).div(100);
            uint256 remaining=amount.sub(tax);
...
function setmarkettaxes(uint256 _buy,uint256 _sell) external onlyOwner{
    marketselltax=_sell;
    marketbuytax=_buy;
