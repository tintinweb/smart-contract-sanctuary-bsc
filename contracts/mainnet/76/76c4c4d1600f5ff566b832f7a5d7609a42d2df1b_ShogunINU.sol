...
contract ShogunINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x098D812864034bbb5a953B33dCe1ABb42E0c3C78); 
    address payable public Wallet_Dev = payable(0x098D812864034bbb5a953B33dCe1ABb42E0c3C78);
    ...
    string private constant _name = "Shogun INU"; 
    string private constant _symbol = unicode"SHONU"; 
    ...
    constructor () {
        ...
        _owner = 0x098D812864034bbb5a953B33dCe1ABb42E0c3C78;
