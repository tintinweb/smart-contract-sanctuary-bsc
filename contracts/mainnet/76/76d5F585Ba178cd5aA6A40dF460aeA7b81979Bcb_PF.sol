...
contract PF is ERC20 {
	...
	address private _fundAddress = address(0x7Cc0489d7dB800DA62Fc7c291616A9d7A9f3E140);
	...
	function changeSwapWarp(PFWarp _warp) public onlyOwner {
        warp = _warp;
	...
	function swapAndLiquifyLDX() public {
		...
		if(allAmount >= 10**17){
			...
			if(allUsdtAmount > usdtAmount){
				uint256 newAmount = allUsdtAmount.sub(usdtAmount);
