...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF31d81B2f45Ac5eFD8130F68ce736a7cAc73Ce8E; // owner address
...
contract Alygon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alygon";
    string private _symbol = "ALYGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF31d81B2f45Ac5eFD8130F68ce736a7cAc73Ce8E); // Marketing Address
    address payable public teamWalletAddress = payable(0xF31d81B2f45Ac5eFD8130F68ce736a7cAc73Ce8E); // Team Address
