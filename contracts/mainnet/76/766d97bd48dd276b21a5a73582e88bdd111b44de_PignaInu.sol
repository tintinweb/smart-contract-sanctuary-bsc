...
contract PignaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pigna Inu";
    string private _symbol = "PignaInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd995E892d10F37a4bbd4bB0CD49267A1369AF24B); // Marketing Address
