 ...
 * https://t.me/CZgoat
 ...
 This just stealth launched! Based on Elon Goat and Vitalik Goat Trends, 

 it will be the next moonshot brought to you by the safu team..
*/
...
contract CZgoat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CZ Goat";
    string constant _symbol = "$CZ-GOAT";
