...
contract Cyndi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CyndiGOD";
    string private _symbol = "CyndiGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52F90Fa7a47363dFb957F05cAf0BA4bFe8b10d9C);
    address payable public teamWalletAddress = payable(0x52F90Fa7a47363dFb957F05cAf0BA4bFe8b10d9C);
