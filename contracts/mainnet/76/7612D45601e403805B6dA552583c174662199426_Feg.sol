...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc4717e2E5fA64B8faC7Ac9690F021a3bA84c0aC0;
...
contract Feg is Context, IERC20, Ownable {
    ...
    string private constant _name = "Feg Dust"; // 
    string private constant _symbol = "$FDust"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xc4717e2E5fA64B8faC7Ac9690F021a3bA84c0aC0);
