...
/**
Welcome to Luffy Inu 2.0, the first super-Meme on Mainnet bridging together the Defi, NFT and DApp communities. 
Join us on our journey of creating one of the most powerful organizations on BSC, the possibilities are limitless. 

Join our community and stay active !!!

https://t.me/Luffy_Inu2
http://www.luffyinu2.space/
https://twitter.com/LuffyInu2
...
*/
 ...
 contract LuffyInu is IBEP20, Auth {
     ...
     string constant _name = "LuffyInu"; // LuffyInu NAME
     string constant _symbol = "Luffy Inu"; // LuffyInu SYMBOL
     ...
     uint256 _totalSupply = 100000000000000 * 10**5 * (10 ** _decimals);  // SUPPLY
     ...
     uint256 public rewardsFee = 5; // REWARDS
     ...
     constructor () Auth(msg.sender) {
         ...
         // NICE!
         autoLiquidityReceiver = 0xDA8EBC006090C317f3C5376BFCEf5bCCa660822F; // DEV ADDRESS
         marketingWallet = 0xd8419Fe83ee4b663aFcAfFb86e00DBE3Cae891D6; 
         developmentwallet = 0xd8419Fe83ee4b663aFcAfFb86e00DBE3Cae891D6;
     ...
     function swapBack() internal lockTheSwap {
         ...
         (bool tmpSuccess1,) = payable(developmentwallet).call{value: anothermarketingShare, gas: 30000}("");
