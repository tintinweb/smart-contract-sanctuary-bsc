...
contract FROGEGROW is Context, IERC20, Ownable {
    ...
    string public constant _name = "FROGE GROW"; // 
    string private constant _symbol = "FROGEGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 private _liquidityFee = 4;

    address private  _marketingWallet = 0xbdD88Ee976ca7372590AE11965777CcED9ed4f1D;
