...
/**
TELEGRAM: https://t.me/club300_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64853b57C5f0df06854ea254b4FB7cDfe3a3c6ae; // owner address
...
contract Club300 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "300 Club";
    string private _symbol = "300";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64853b57C5f0df06854ea254b4FB7cDfe3a3c6ae); // Marketing Address
    address payable public teamWalletAddress = payable(0x64853b57C5f0df06854ea254b4FB7cDfe3a3c6ae); // Team Address
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**_decimals; // 100%
    uint256 public _walletMax = 1000000000 * 10**_decimals; // 100%
