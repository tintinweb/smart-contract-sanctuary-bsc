...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x55d398326f99059fF775485246999027B3197955); // USDT
...
contract BABYINUKO is ERC20, Ownable {
    ...
    constructor() ERC20("BabyInuko", "BIF") {
        ...
        maxWallet = totalSupply * 2 / 1000; // 0.2% Max wallet at beginning
        ...
        marketingBuyFee = 2;
        liquidityBuyFee = 1;
        devBuyFee = 4; //used for Inuko and BabyInuko Buyback
        burnBuyFee = 1;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee + devBuyFee + burnBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0xbfAE1B3051E95485d2A016Ef8f9F1814fe3eeD7c); // set as marketing wallet
    	devWallet = address(0x635Cd94682dC493f52D1A30C836b1f6d3Af65A00); // set as Buyback Wallet
