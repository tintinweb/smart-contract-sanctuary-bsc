...
Turn your worthless tokens into assets. 
ChickGrow is introducing the next generation of NFT utility, with GameFi, E-Commerce and metaverse features.
Real CA on Website.
Tekonomics
🐣 Total supply: 100 Million $CHICKG
🐣 Max buy: 0.25% at launch (2% max)
🐣 Max sell: 0.25% at launch (2% max
🪙 10 Tax Fee Buy And Sell
    5% Marketing
    3% Liquidity
    2% Buyback
...
Website = https://chickgrow.simdif.com/
*/
...
/* Token contract */
contract CHICKGROWBEP20 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x11831cc2094cE4660D990DA254a3Ed1918810eFe;
    ...
    // Name and symbol
    string constant _name = "CHICKGROW";
    string constant _symbol = "CHICKG";
    ...
    uint256 public buybackFeeBuy = 3;
