...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0cf09f5071dBDDa949e1910704904691C9163e9e; // owner address
...
contract MOMOGEBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MomogeBSC";
    string private _symbol = "MOMOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0cf09f5071dBDDa949e1910704904691C9163e9e); // Marketing Address
    address payable public teamWalletAddress = payable(0x0cf09f5071dBDDa949e1910704904691C9163e9e); // Use Same Address as Marketing Address
