...
contract GrizzlyHoneyTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Grizzly Honey 2.0";

    string private _symbol = "GrizzlyHoney2";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46Fd850b06fdA761C444F780183c74d1E16C688e);//Market

    address payable public teamWalletAddress = payable(0x46Fd850b06fdA761C444F780183c74d1E16C688e);    
    ...
    uint256 public _supplyDec = 100000000000000000000; //
