...
contract SBFINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SBF INU";
    string private constant _symbol = unicode"SBI";
    ...
    address payable public DevWallet = payable(0x651167739BDf7956893fa1BE89d308fB9B20AfD0);
    address payable public MarketingWallet = payable(0x651167739BDf7956893fa1BE89d308fB9B20AfD0);
    address payable private TeamWallet01 = payable(0x7019e6F93790B306e6141758F89c663445Ad2486);
    address payable private TeamWallet02 = payable(0x7019e6F93790B306e6141758F89c663445Ad2486);
    address payable private TeamWallet03 = payable(0x7019e6F93790B306e6141758F89c663445Ad2486);
