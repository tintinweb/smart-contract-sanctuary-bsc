...
library Address{
 ...
 contract AnotherPige is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 55_555_555_555 * 10**9;
    ...
    address public marketingWallet = 0xf2E6dFba926c6Be2FA8A032d9497Dc644c59D0a9;
    address public donationWallet = 0xf2E6dFba926c6Be2FA8A032d9497Dc644c59D0a9;

    string private constant _name = "Another Pige";
    string private constant _symbol = "APIGE";
    ...
    Taxes public taxes = Taxes(1, 4, 3, 1);
    Taxes public sellTaxes = Taxes(1, 4, 3, 1);
