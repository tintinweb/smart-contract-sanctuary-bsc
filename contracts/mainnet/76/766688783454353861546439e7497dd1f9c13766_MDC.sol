...
contract MDC is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**5 * (10**18);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0xf12cF9c2C97369596f738c0e9A7968cD618296Cb); // Team Wallet
    address public _projectWalletAddress = address(0xf12cF9c2C97369596f738c0e9A7968cD618296Cb); //Project Wallet
    ...
    constructor() ERC20("Magic Dragon Coin", "MDC") {
