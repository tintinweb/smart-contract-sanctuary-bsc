...
contract LOONGStake is Ownable, ReentrancyGuard {
    ...
    uint256 public lines_1 = 2000;
    uint256 public lines_2 = 20000;
    ...
    function setlines(uint256 _lines_1, uint256 _lines_2) public onlyOwner {
      lines_1 = _lines_1;
      lines_2 = _lines_2;
    }
    ...
    function deposit(uint256 _glod) public nonReentrant {
      ...
      if (_glod == 1) {
        require(lines_1 > 0, 'IDO: Has ended');
        lines_1 = lines_1.sub(1);
        ...
        require(lines_2 > 0, 'IDO: Has ended');
        lines_2 = lines_2.sub(1);
