...
Telegram: https://t.me/TateShibaGrow_Bsc
*/
...
contract TateShibaGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Cc28979B725a1031375f34c9d92c98E10355046); 
    address payable public Wallet_Dev = payable(0xd03f2D1b1A8f6A0430A02f64e9faD2262EBbFfD8);
    ...
    string constant _name = "Tate Shiba Grow";
    string constant _symbol = unicode"TShibaG";
    ...
    constructor () {
        ...
        _owner = 0xd03f2D1b1A8f6A0430A02f64e9faD2262EBbFfD8;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB03feE89C82F8E5a8f1cf99331cB17ef74F55d5b); // Testnet
        uniSwapV2Pair = payable(0xd03f2D1b1A8f6A0430A02f64e9faD2262EBbFfD8);
