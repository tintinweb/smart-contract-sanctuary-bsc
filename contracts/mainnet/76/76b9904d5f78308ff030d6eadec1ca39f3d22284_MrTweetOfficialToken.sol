...
contract MrTweetOfficialToken is Context, MrTweetECO, Ownable {
    ...
    string private _name = 'MrTweet Official Token';
    string private _symbol = unicode'MrTweet 🐦';
