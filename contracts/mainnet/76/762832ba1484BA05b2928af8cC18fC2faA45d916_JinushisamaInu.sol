...
TAX: 6%
- The 3% of transaction will automatically go to liquidity 
- The 3% of transaction will go to marketing wallet
...
contract JinushisamaInu is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "Jinushisama Inu";
        _symbol = "JINUSHINU";
        _decimals = 9;

        marketWallet = payable(0x97d63c37Ac23abE83bcf6d288E65FDb924E391d2);
        teamWallet= payable(0x752a125F4225d3854DCCb43413F1fFB5A674ffeD);
        ...
        _maxTxAmount = 40000000000 * 10**_decimals;
        _maxWalletSize = 40000000000 * 10**_decimals;
