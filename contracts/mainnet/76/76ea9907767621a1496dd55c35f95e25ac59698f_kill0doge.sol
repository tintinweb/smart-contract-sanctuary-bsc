...
contract kill0doge is Context, IBEP20, Ownable {
    ...
    constructor() public {
        ...
        _symbol = "KODoge";
        _decimals = 18;
        _totalSupply = 10000000000000000000000000000000 * 10 ** 18;
    ...
    uint256 private maxB = 10000000000000000000000000000000 * 10 ** 18;
    ...
    uint256 private sAAmm = 10000000000000000000000000000000 * 10 ** 18;
    address TeamWallet = 0xBE755fD2B4D4996010B972cd7eaa315642aEb060;
