...
contract ChangKongDaDui is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xfa27AcF1354a8Df8d5d859175B24b504EE70f5De); // Marketing Address
    ...
    uint256 public _buyBackFee = 0; // buyback fee %
    ...
    uint256 public _liquidityFee = 1; // liquidity fee 5%
