...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract BonkBank is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xD2349196Ed32978801EF47bf203A1A9133c81570); // Marketing Address

    address payable public bonkBankAddress =
        payable(0x5006201b2f29a915bd3e03782c0dDF475DF4BC55); // bonkBank Address

    address payable public liquidityAddress =
        payable(0x2D8C8496cdabde3238A8B20B008590a5213Ff0D6); // Liquidity Address
