...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x56549fA8136BA768834eBFC4633758044E8AE1F6;
...
contract ClockTower is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x14a8181e0D84015Bfa23517e28223Bceb79B50c4;
    address private _marketingWalletAddress = 0xc2f09383C6496e678EF0b9ECb18f9a948cCAd62C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Clock Tower";
