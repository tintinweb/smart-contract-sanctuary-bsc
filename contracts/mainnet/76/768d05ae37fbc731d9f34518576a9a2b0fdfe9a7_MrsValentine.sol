...
library Address{
 ...
 contract MrsValentine is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x3f7e9a7B60Aa4D09d8e97DEbC7a7846aa6E447b5;
    address public donationWallet = 0x3f7e9a7B60Aa4D09d8e97DEbC7a7846aa6E447b5;

    string private constant _name = "Mrs Valentine";
    string private constant _symbol = "MRSV";
    ...
    Taxes public taxes = Taxes(1, 5, 3, 5);
    Taxes public sellTaxes = Taxes(1, 5, 3, 5);
