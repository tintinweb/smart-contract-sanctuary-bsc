...
contract Token is Ownable, IBEP20 {
    ...
    string constant _name = "Safe Moon 10.0";
    string constant _symbol = "$SM10";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xF97E9C8b4078255b9FbF0ed426CEA13e17d8A5e3;
        marketingWallet = 0xF97E9C8b4078255b9FbF0ed426CEA13e17d8A5e3;
        buybackWallet = 0xF97E9C8b4078255b9FbF0ed426CEA13e17d8A5e3;
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess2,) = payable(buybackWallet).call{value : amountBNBbuyback, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newbuybackFee, uint256 extraSellFee) external onlyOwner {
