...
/**
 * @dev Extension of {ERC20} that allows admin to mint tokens
...
contract sPokelon is ERC20,Ownable,ERC20Burnable,ERC20Mintable {

    constructor()
        ERC20("S-Pokelon", "S-POKELON", 9) {
            _mint(msg.sender, 100 * (10 ** uint256(12)) * (10 ** uint256(18)));
        }
}