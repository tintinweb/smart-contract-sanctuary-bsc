...
contract TESTCB4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "TESTCB4";
    string private constant _symbol = "TCB4";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 25) {
