...
contract Baby_ShibaCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby ShibaCat";
    string constant _symbol = "BSHIBCAT";
    ...
    uint256 public _maxTxAmount = _totalSupply * 50 / 100; // 20% 
    uint256 public _walletMax = _totalSupply * 80 / 100; // 30%
