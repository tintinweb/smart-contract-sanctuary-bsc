...
Tazuni  Stealth Launch Todays at 9:30 - 10:00 AM UTC 🚀🚀

What is Tazuni?

Tazuni  is a revolutionary new BSC token that combines all their best features to create something entirely new. All holders of Tazuni  will earn more $TAZUNI that is automatically sent to your wallet by simply holding Tazuni  coins in your wallet.

Tazuni is a penguin based on the Eudyptula minor species which is endemic to New Zealand, with the closely related Eudyptula novaehollandiae species found in Australia and New Zealand
...
PROJECT:
Tazuni  is not just meme token, it is something fun but with utility.
*/
pragma solidity 0.8.10;
pragma experimental ABIEncoderV2;
// SPDX-License-Identifier: MIT
// Offician-Contract-Tazuni
// Telegram: https://t.me/TazuniBSC 
...
contract TAZUNI is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 23000000 * 1e9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Tazuni"; // token name
    string public _symbol = "TAZUNI"; // token ticker
    ...
    uint256 private minTokenToSwap = 23000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 23000000 * 1e9;
    uint256 private minBuyLimit = 23000000 * 1e9;
