...
contract TwitterGala is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Twitter GALA";
    string constant _symbol = "TWITTERGALA";
    ...
    uint256 public sellMultiplier  = 2300;
