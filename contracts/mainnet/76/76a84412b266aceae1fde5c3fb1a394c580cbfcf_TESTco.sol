...
contract TESTco is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("TESTco", "$TESTco", uint8(DECIMALS)) {
        ...
        buyBackFeeReceiver = 0x23C217d17381af4406Ee4C3A9aa4D699d011EEB5;
