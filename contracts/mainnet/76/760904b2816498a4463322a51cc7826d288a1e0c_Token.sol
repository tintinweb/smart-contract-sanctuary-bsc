...
contract Token is IERC20, Ownable {
    ...
    string private constant _name = "2525";
    string private constant _symbol = "2525";
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 25250 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 2525; // 10000;
    uint256 private _maxTransferPercent = 2525;
    uint256 private _maxWalletPercent = 2525;
    ...
    address internal constant development_receiver = 0xEc05Ba9dC0a3eb0457CDBA7Db74E2EF3658e2701; 
    address internal constant marketing_receiver = 0xEc05Ba9dC0a3eb0457CDBA7Db74E2EF3658e2701;
    address internal constant liquidity_receiver = 0xEc05Ba9dC0a3eb0457CDBA7Db74E2EF3658e2701;
