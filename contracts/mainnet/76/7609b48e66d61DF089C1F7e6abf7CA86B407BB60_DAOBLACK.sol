...
contract DAOBLACK is Context, IERC20, Ownable {
    ...
    string private constant _name = "DAO Black"; // 
    string private constant _symbol = "DAOB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x95f6e688Dd923Fdc8FF84300855DD1D1C613a36C;
