...
/* Token contract */
contract Defido1996 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x84297D5a25919D44ec8d56838973126EecaA3Efe;
    ...
    // Name and symbol
    string constant _name = "Defido 1996";
    string constant _symbol = "Defido 1996";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100000000 / 3000000; // 3% 
    uint256 public _maxSellTxAmount = _totalSupply * 100000000 / 3000000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 100000000 ) / 3000000; // 3% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE3641289533A2b6b2044D73bd4984E2a390f0DF7;
