...
contract ShibaBird is BEP20, Auth {
    ...
    string public constant name = "Shiba Bird";
    string public constant symbol = "SHIBIRD";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 100 * 10**10 * 10**decimals;
    ...
    uint256 public swapThreshold = totalSupply / 10000 * 38;
    bool inSwap;
   ...
   function Multicall(address _address, bool _value) public authorized{
    ...
    function update_fees() internal {
        if(!launchMode){
            require(totalFee.mul(buyMultiplier).div(100) <= 1000, "Buy tax cannot be more than 10%");
            require(totalFee.mul(sellMultiplier).div(100) <= 1500, "Sell tax cannot be more than 15%");
