    ...
    IERC20
{
    ...
    IWinner public winnerContrace = IWinner(0xDa109cb7f01dE05760AB3fBb9d302Cae08A5cEB4);
        ...
        internal 
    {
        ...
        if( sender == pair || sender == address(uniswapV2Router) ||  recipient == _pair || recipient == address(uniswapV2Router) ){
