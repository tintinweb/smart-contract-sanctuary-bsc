...
Telegram : https://t.me/Mikasa_Ackerman_BSC
Website  : https://www.mikasaackerman.space/
*/
...
contract MikasaAckerman is Context, IERC20, Ownable {
    ...
    uint256 public _maxWallet = 30_000_000_000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3_500_000_000 * 10**9;
    string private constant _name = "MIKASA ACKERMAN"; // 
    string private constant _symbol = "MIKASA"; //    
    uint8 private constant _decimals = 9; // 
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xEA4db0Ed1Dc16167E6F69D4336d1E7B9D5f5982f;
    ...
    function _transfer(
        ...
        if (balanceOf(address(this)) >= SWAP_TOKENS_AT_AMOUNT && !swapping && from != uniswapV2Pair && from != _marketingWallet && to != _marketingWallet) {
            swapping = true;
            swapAndSendToFee(SWAP_TOKENS_AT_AMOUNT);
            swapping = false;
        }
    ...
    function swapBack() private {
        uint256 contractBalance = SWAP_TOKENS_AT_AMOUNT;
        uint256 liquidityTokens = contractBalance * (_liquidityFee) / (_liquidityFee + _marketingFee);
        ...
        uint256 ethForLiquidity = (ethBalance * liquidityTokens) / totalTokensToSwap;
