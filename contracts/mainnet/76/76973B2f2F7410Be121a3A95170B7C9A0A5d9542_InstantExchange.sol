...
contract InstantExchange {
    ...
    */
    ...
    constructor(address _usdtAddress,address _alnAddress){
        ...
        exchangeRate = 20*(10**18);
        modify_partners (msg.sender, 1000);
    }
    function updateTokens (address _usdtAddress,address _alnAddress) public onlyOwner{
        usdt = IERC20(_usdtAddress);
        aln = IERC20(_alnAddress);
    }
    ...
    * handle exchange
    */
    uint public exchangeRate = 20*(10**18) ;// devision by 10**18 required. 1234 means 0.00000000000001234
    ...
    function exchange(uint _amountUsdt) public{
        ...
        //send aln
        uint transferAmount = _amountUsdt * exchangeRate/(10**18);
