...
contract Grow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grow Moon";
    string private constant _symbol = "Grow Moon";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000 * 10**_decimals;

    uint256 public _maxWalletAmount = 500* 10**_decimals;
    uint256 public _maxTxAmount = 500* 10**_decimals;
    uint256 public swapTokenAtAmount = 500 * 10**_decimals;
    ...
    address private marketingWallet = address(0xAa9dCa6D21D279E2693D7Ab43FC90989181CA955);
    address private liquidityReceiver = address(0xAa9dCa6D21D279E2693D7Ab43FC90989181CA955);
