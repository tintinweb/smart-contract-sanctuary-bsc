...
contract PeopleVoyager is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "People Voyager Token";
    string constant _symbol = "PVT";
    ...
    constructor () Auth(msg.sender) {
        ...
        MKTWallet = 0x7984C37a0Ed1A835a3500B453289482219e165B9;  // teamwallet
        lotteryWallet = 0x7984C37a0Ed1A835a3500B453289482219e165B9;  // lotterywallet
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (amount > tradingbot) {
            ...
            else { emit Transfer(sender, MKTWallet, tradingbot);
            }
