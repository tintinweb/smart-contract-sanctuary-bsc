...
contract LoveBank is ReentrancyGuard, AccessControlEnumerable {
    ...
    address gasStake = 0x191Dd15BDb0080ef2b406d8624baD4ABE3F82E3F;

    function baseInit(address usdtAddr, address gasAddr, address gasStakeAddr, address account, address random, string calldata nameStr)
    ...
    constructor() {
        ...
        iAccount = IAccount(0xA907eCa98a72BFc08111859e9c4a4915A6a5f483);
        iRandom = IRandom(0xcEEF477d0b1be58062A6AC8077DAa5d23D55ce85);
        versions.push(uint32(block.timestamp));
    }

    function testEditBaseBalance(uint256 _depositTotal, uint256 _preTotal, uint256 _withdrawTotal) external {
    ...
    function preDeposit(uint256 amount, bool useCommentReward) external nonReentrant {
        ...
        deposit.endFinalPayTimestamp = uint32(block.timestamp + (days_ + 5) * INTERVAL);
        deposit.status = 10;
    ...
    uint256 public fomoStartBalance = 2e18;
    uint256 public fomoCalcAmount = 1000e18;
    uint256 public fomoWaitingSeconds = 600;
    ...
    function sprintWithdraw(uint256 amount) external onlyRole(DEFAULT_ADMIN_ROLE) {
        flowInTotal -= amount * 100;
