...
contract sfm is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6A0133095365c3FE303cd880cA02888Bdd8F1ba0); 
    address payable public Wallet_Utility = payable(0x6A0133095365c3FE303cd880cA02888Bdd8F1ba0);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x6A0133095365c3FE303cd880cA02888Bdd8F1ba0); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;
    string private constant _name = "sfm"; 
    string private constant _symbol = unicode"sfmm"; 
    ...
    uint256 public Percent_Utility = 30;
    ...
    constructor () {
        ...
        _owner = 0x6A0133095365c3FE303cd880cA02888Bdd8F1ba0;
