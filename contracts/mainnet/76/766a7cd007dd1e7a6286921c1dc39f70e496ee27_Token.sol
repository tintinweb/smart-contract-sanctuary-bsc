...
pragma solidity >=0.8.15;
 ...
 contract Token {
    ...
    constructor() {
        name = "WorldCoin"; // Sets the name of the token, i.e Ether
        symbol = "WRLD"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 8000000000000000000000000000; // Holds an initial supply of coins
