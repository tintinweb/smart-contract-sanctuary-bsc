...
contract MUSKPHONE   is Context, IERC20, Ownable {
    ...
    string private constant _name = "Musk Phone";
    string private constant _symbol = "MUSK PHONE";
    ...
    address private marketingWallet = address(0xf744459d1672bF0E1Ab1ba8F5521a619A52608d1);
    address private liquidityReceiver = address(0xf744459d1672bF0E1Ab1ba8F5521a619A52608d1);
