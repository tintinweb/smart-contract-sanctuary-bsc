...
contract BabyMetaRabbit is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "BabyMetaRabbit";
  string private _symbol = "BabyMetaRabbit";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0xe8860D7Aad7E79C99894152F3C04b7Fd5b4c4582);
  address payable public teamWallet = payable(0xe8860D7Aad7E79C99894152F3C04b7Fd5b4c4582);
