...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc6A999453506A97e601B0C08c74fCA77605bb5BB; // owner address
...
contract Muunions is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muunions";
    string private _symbol = "MUUNIONS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x798a7f48b7C383C556dB83313a8Af3fdd8EbE2b2); // Marketing Address
    address payable public teamWalletAddress = payable(0x798a7f48b7C383C556dB83313a8Af3fdd8EbE2b2); // Team Address
