...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C3EbdBCb887B2B3864Cd48CE6A8871eFb45902F; // owner address
...
contract Web3AI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Web3 AI ";
    string private _symbol = " W3 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C3EbdBCb887B2B3864Cd48CE6A8871eFb45902F); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C3EbdBCb887B2B3864Cd48CE6A8871eFb45902F); // Team Address
