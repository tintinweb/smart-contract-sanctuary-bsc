...
contract Banana is ERC20("ApeParadise Banana", "BANANA"), Ownable {
    uint256 public constant ONE_BANANA = 1e18;
    uint256 public constant NUM_PROMOTIONAL_BANANA = 500_000;
    uint256 public constant NUM_BANANA_TREE_LP = 20_000_000;

    uint256 public NUM_BANANA_BNB_LP;
    ...
    function setNumBananaBnbLp(uint256 _numBananaBnbLp) external onlyOwner {
        NUM_BANANA_BNB_LP = _numBananaBnbLp;
    }
