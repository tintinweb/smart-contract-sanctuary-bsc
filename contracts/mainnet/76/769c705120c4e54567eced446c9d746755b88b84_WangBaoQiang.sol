...
contract WangBaoQiang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WangBaoQiang";
    string private _symbol = "WangBaoQiang";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE17b6FEdb643C2BF8Bc1712ad9499a51cC9D4bb6); 
    address payable public BurnedWalletAddress = payable(0xE17b6FEdb643C2BF8Bc1712ad9499a51cC9D4bb6); 
