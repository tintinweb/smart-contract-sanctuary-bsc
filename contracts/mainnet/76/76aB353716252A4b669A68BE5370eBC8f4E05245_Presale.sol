...
contract Presale is Ownable {
  ...
  event SetOpenPresale(bool indexed open);
  event SetOpenClaim(bool indexed open);
  event SetFinishPresale(bool indexed finish);
  event SetOpenPublic(bool indexed open);
