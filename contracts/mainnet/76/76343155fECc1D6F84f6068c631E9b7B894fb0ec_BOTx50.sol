...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc335c0372F4BD482041dD3Dc4eC85Bd600cEe0AA; // owner address
...
contract BOTx50 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BOTx50";
    string private _symbol = unicode"BOTx50";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc335c0372F4BD482041dD3Dc4eC85Bd600cEe0AA); // Marketing Address
    address payable public teamWalletAddress = payable(0xc335c0372F4BD482041dD3Dc4eC85Bd600cEe0AA); // Team Address
