...
TG: https://t.me/OrdinalPawOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b33cE2dfD2C308f8aB6C9aE7E319250268E713a; // owner address
...
contract OrdinalPaw is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Ordinal Paw";
    string private _symbol = unicode"oPaw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4b33cE2dfD2C308f8aB6C9aE7E319250268E713a); // Marketing Address
    address payable public teamWalletAddress = payable(0x4b33cE2dfD2C308f8aB6C9aE7E319250268E713a); // Team Address
