...
contract SpaceSnake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpaceSnake", "SSNAKE") {
        marketingWallet = payable(0xa615fE7213903CC06e3fBFa18DdE54D6cb5fFC2D);
        devWallet = payable(0xa615fE7213903CC06e3fBFa18DdE54D6cb5fFC2D);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    SpaceSnake public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = SpaceSnake(mainContract);
