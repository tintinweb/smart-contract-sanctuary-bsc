...
contract LAZYLAMBOV2 is Context, IERC20, Ownable {
   ...
   //=======General=======//
    ...
    string private _name="LazylamboV2";
    string private _symbol="LazylamboV2";
    ...
    address public marketingWallet=0x1e5d2f235FC1CE7750be28a7e67199033b7592c0;
    ...
    uint256 private maxTransactionRateSell=10;//deminator 1000
    ...
    function claimStuckToken(address token) external onlyOwner {
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxForSwap = liquidityFeeOnSell + marketingFeeOnSell;
            if(taxForSwap > 0) {
                if(liquidityFeeOnSell > 0) {
                    uint256 liquidityTokens = contractTokenBalance * liquidityFeeOnSell / taxForSwap;
                    swapAndLiquify(liquidityTokens);
                }
                
                if(marketingFeeOnSell > 0) {
                    uint256 marketingTokens = contractTokenBalance * marketingFeeOnSell / taxForSwap;
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner {
        ...
        require(!_marketingWallet.isContract(), "Marketing wallet can not be a contract");
    ...
    function setTaxFeePercentOnBuy(uint256 _taxFee) external onlyOwner() {
        ...
        require(totalFeesOnBuy <= 21, "Total fees must be less than 21%");
    }
    ...
    function setTaxFeePercentOnSell(uint256 _taxFee) external onlyOwner() {
        ...
        require(totalFeesOnSell <= 21, "Total fees must be less than 21%");
    }
