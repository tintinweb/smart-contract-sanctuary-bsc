...
contract WaifuDeathMatch {
    ...
    function listAllOpenDeathMatches() public view returns (uint256[] memory) {
        ...
        uint256[] memory listOfAllOpenDeathMatches = new uint256[](totalOpenDeathMatches);
        totalOpenDeathMatches = 0;
    ...
    function listTheIdsOfAllWaifusOnDeathRow() public view returns (uint256[] memory) {
        ...
        uint256[] memory listOfWaifusOnDeathRow = new uint256[](totalWaifusOnDeathRow);
        totalWaifusOnDeathRow = 0;
