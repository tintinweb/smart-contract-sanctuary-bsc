...
contract evereth is everethETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamteverethETR;
    address private CharityeverethETR;
    ...
    string public override name = "evereth";
    string public override symbol = "evereth";
    ...
    constructor(uint totalSupplyValue, address TeamteverethETRAddress, address CharityeverethETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamteverethETR = TeamteverethETRAddress;
        CharityeverethETR = CharityeverethETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamteverethETR] = totalSupply * 4 / 100;
        balances[CharityeverethETR] = totalSupply * 4 / 100;
