...
contract DexsagonPresaleContract is Ownable {

    using SafeMath for uint256;

    IERC20 public DXS = IERC20(0x95F52eeA245B470c1234b37eF8C38bb1Fc033960);
    address public Recipient = 0x0CA074D45f3F3FcfDcB4D6B37CDbAC1371C61652;

    uint256 public tokenRatePerEth = 2000; // 2000 * (10 ** decimals) DXS per eth
    ...
    function deposit() public payable checkIfPaused {
        ...
        require(DXS.transfer(msg.sender, tokenAmount), "Insufficient balance of presale contract!");
    ...
    function getTokensPerEth(uint256 amount) internal view returns(uint256) {
        return amount.mul(tokenRatePerEth).div(10**(uint256(18).sub(DXS.decimals())));
    }
}