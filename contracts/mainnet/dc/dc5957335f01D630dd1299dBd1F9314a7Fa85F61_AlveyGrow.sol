...
Well, It's Alvey Grow for you! 

Alvey Grow This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best inu

Why Alvey Grow?

It is a Community Powered - Alvey Grow fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - Alvey Grow smart contract has been verified and its Liquidity Pool is locked. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8f477452A17756B0e8615d9E434fC4d590773C8; // owner address
...
contract   AlveyGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlveyGrow";
    string private _symbol = "AlveyGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc4eEc4159d298d4968166713473935C9BeaEb008); // Marketing Address
    address payable public buybackWalletAddress = payable(0xc4eEc4159d298d4968166713473935C9BeaEb008); // Buyback Address
