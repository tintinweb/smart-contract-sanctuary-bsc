...
contract    Aomen
 is Context, IERC20, Ownable {
    ...
    string private _name = " Aomen";
    string private _symbol = " Aomen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14766ede8A636d75B36F92eCA5bd5E7C66d3F757);
    address payable public teamWalletAddress = payable(0x14766ede8A636d75B36F92eCA5bd5E7C66d3F757);
    address public immutable deadAddress =0x14766ede8A636d75B36F92eCA5bd5E7C66d3F757;
