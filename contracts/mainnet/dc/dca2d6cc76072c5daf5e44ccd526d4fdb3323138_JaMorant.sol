...
contract JaMorant is Context, IERC20, Ownable, DividendPayingToken{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000000 *  10**9;        
    
    string private _name = "JaMorant";
    string private _symbol = "JaMorant";
     ...
     */
    function initDividend(address _reward) external onlyOwner {
	...
	function whileprocessIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
	...
	function waytimeClaim(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
