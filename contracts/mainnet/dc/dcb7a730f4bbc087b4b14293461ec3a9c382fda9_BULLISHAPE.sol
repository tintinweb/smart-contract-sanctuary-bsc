...
/**
   ...
   twitter : https://twitter.com/bullishapebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC099A0D5882558eA70425AFbc99Ac09Da254E449; // owner address
...
contract BULLISHAPE is Context, IERC20, Ownable {
    ...
    string private _name = "BULLAPE";
    string private _symbol = "$BA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC099A0D5882558eA70425AFbc99Ac09Da254E449); // Marketing Address
    address payable public teamWalletAddress = payable(0xF534feae3460d4f21fFD5b78A3272C1034217AE8); // Team Address
