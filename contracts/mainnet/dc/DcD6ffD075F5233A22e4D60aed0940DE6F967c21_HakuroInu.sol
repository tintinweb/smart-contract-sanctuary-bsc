...
contract HakuroInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hakuro Inu";
    string private constant _symbol = "HakuroInu";
