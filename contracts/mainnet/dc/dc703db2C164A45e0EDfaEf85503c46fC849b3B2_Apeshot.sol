...
contract Apeshot is IERC20 {
    ...
    string constant private _name = "Apeshot";
    string constant private _symbol = "APESHOT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xEf4e934F6F0eDceAc2B759dcfd7283fc5e8C744d),
        prize: payable(0x67f7e9b1234930c945b15382827900Cf3F2072CC)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 prize, uint16 marketing) external onlyOwner {
        _ratios.prize = prize;
        _ratios.marketing = marketing;
        _ratios.totalSwap = prize + marketing;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable prize) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - prizeBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.prize.call{value: prizeBalance, gas: 35000}("");
        }
        if (ratios.marketing > 0) {
