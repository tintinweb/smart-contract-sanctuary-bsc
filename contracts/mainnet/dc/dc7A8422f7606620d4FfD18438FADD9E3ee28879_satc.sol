...
contract satc is Context, IERC20, Ownable {
    ...
    string private _name = "satc";
    string private _symbol = "satc";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x725084B1dc6Cdec7bF3E81d5A118C311aF0A2B48); // Marketing Address
    address payable public teamWalletAddress = payable(0x90bDf74E9d3679045Ef3edF495ddd1C5E3e90B37); // Team Address
    ...
    uint256 private _totalSupply = 1 * 10**3* 10**3 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**3 * 10**3* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**3 * 10**3* 10**_decimals;
