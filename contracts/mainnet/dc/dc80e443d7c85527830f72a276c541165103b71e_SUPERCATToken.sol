...
contract SUPERCATToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    address usd = 0x8C8E3b2Ad34A9BffD0592f68DBBD0CAdf74134ac;

    string private _name= "SUPERCAT COIN";
    string private _symbol= "SUPERCAT";
    uint8 private _decimals=9;
    uint256 supply=2000000;
    address payable public marketingWalletAddress = payable(0x25A93a69beD74AD7F2B8E4191ab73F5C675FeE1A);
