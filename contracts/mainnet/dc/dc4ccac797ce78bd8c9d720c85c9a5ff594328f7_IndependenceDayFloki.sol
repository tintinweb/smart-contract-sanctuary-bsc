...
/**
🇺🇸 Independence Day recognizes the birth of America’s Freedom and fight for democracy worldwide! It is also one of the biggest holiday weekends in the U.S. 🇺🇸

Independence Day Floki $IDF is a charity token designed to help dogs in war torn countries find new homes. 

💎 Elon also loves dressing up his Floki for major holidays 👀

- Additionally, any refugee from any country will be whitelisted and tax exempt from trading fees 
...
TG - https://t.me/IndependenceDayFloki
...
contract IndependenceDayFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Independence Day Floki";
    string constant _symbol = "$IDF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1776 * 10**0 * 10**_decimals;
    ...
    uint256 public sellMultiplier  = 4900;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x763AF08FcE6195C1dE1b5f7740a9A8cbB2c6e11f;
        ecosystemfeeReceiver = 0x763AF08FcE6195C1dE1b5f7740a9A8cbB2c6e11f;
