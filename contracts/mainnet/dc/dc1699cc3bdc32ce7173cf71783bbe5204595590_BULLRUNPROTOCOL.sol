...
library Address{
  ...
  contract BULLRUNPROTOCOL is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8E6E768ff8cf8cb6f08c01B4e85cEFfDF616f8e0;
    address public devwallet = 0xf382803F5A5d3b601246fe889f2EDcd80803F2D0;

    string private constant _name = "BULLRUNPROTOCOL";
    ...
    Taxes public sellTaxes = Taxes(0, 8, 12, 0);
