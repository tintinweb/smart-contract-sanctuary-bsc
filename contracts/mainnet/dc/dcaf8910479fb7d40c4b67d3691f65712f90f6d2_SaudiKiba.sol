...
contract SaudiKiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Kiba";
    string private _symbol = "SKIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA1DE6d45CD4e06Bbdb33da43d21Da133c3EED891);
    address payable public BuyBackWalletAddress = payable(0xA1DE6d45CD4e06Bbdb33da43d21Da133c3EED891);
