...
/**
    Golden Coke
    Telegram : https://t.me/goldencokee
*/
...
contract GoldenCoke is Context, IERC20, Ownable {
    ...
    string private constant _name = "Golden Coke";
    string private constant _symbol = "GOLDENCOKE";
    ...
    mapping (address => uint256) private _isgetvaluesdata;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetvaluesdata[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetvaluesdata[to] = block.timestamp;
        }
