...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x580DdBD2bd4c025a86E09AE60E7B95EEb06d61ec;
...
contract BasicPumpinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "GRIMACEBOY"; // 
    string private constant _symbol = "GRIMB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xF51a544F7F41DE485561104EAa91edbB63e0F1e0);
