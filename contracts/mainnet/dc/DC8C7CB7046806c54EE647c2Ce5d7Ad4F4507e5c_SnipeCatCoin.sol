...
/**
TG: @SnipeCatCoin
Hold 1% to get access to our snipe tool, for both pre-launches and pre-sales [dxsale / pinksale].
*/
...
contract SnipeCatCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SnipeCatCoin";
    string constant _symbol = "SnipeCat";
