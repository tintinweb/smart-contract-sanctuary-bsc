...
// Telegram: @GiantSquidGrow
// Twitter: https://twitter.com/GiantSquidGrow

// THE MOST HYPED LAUNCH FOLLOWING GROW HYPE!!!
...
contract GSG is IBEP20, Auth {
    ...
    string constant _name = "Giant Squid Grow";
    string constant _symbol = "GiantSquidGrow";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //2% MAX tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100;  //2% max wallet
    ...
    address private marketingFeeReceiver = 0xe6553b60383404E677C7765CBE5b3488D21c2801;
    address private teamFeeReceiver = 0xC60D575C906eD6934aCC1491670D16c24b69Db19;
