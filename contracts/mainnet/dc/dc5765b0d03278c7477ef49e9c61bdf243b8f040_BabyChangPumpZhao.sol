...
/*
TG OF COIN: https://t.me/BabyChangPumpZhao
*/
...
contract BabyChangPumpZhao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyChangPumpZhao";
    string private _symbol = "$BabyChangPumpZhao";
