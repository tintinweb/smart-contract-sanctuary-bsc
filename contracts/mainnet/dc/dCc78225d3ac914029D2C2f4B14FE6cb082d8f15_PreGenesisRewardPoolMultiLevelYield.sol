...
//        uint256 _amount
//    ) internal {
//        PoolInfo storage pool = poolInfo[_poodID];
//        require(pool.rewardsBalance >= _amount, "Insufficient rewards balance");
//        uint256 _e_CoinBal = IERC20(pool.rewardToken).balanceOf(address(this));
//
//        if (_e_CoinBal > 0) {
//            if (_amount > _e_CoinBal) {
//                pool.rewardsBalance -= _e_CoinBal;
//                IERC20(pool.rewardToken).safeTransfer(_to, _e_CoinBal);
//            } else {
//                pool.rewardsBalance -= _amount;
