...
contract DogeTime is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeTime";
    string constant _symbol = "DogeTime";
    ...
    uint256 public swapThreshold = rSupply * 50 / 10000;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x77b26e1252F1f6C140de1b0c41b63d07cA924a72;
        marketingFeeReceiver = 0x77b26e1252F1f6C140de1b0c41b63d07cA924a72;
        devFeeReceiver = 0x77b26e1252F1f6C140de1b0c41b63d07cA924a72;
