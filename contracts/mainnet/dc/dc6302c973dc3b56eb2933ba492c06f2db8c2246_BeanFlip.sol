...
contract BeanFlip is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BeanFlip", "$BEAN") {
        marketingWallet = payable(0x32634D7a09AFb82550dB39644172aB138aAE0e8A);
        devWallet = payable(0xC7006F3Ab6B34746F6A795868be747C56D629848);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    BeanFlip public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BeanFlip(mainContract);
