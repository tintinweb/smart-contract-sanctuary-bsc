...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd1e9892373E18Bbac29dE99542f233655758e655; //
...
contract TEST1001 is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 300000000 * 10**9; //
    string private constant _name = "TEST1001"; // 
    string private constant _symbol = "TEST1001"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0xd1e9892373E18Bbac29dE99542f233655758e655); //
