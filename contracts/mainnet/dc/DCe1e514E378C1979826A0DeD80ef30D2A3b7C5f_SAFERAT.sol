...
contract SAFERAT is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'SAFERAT';
    string private constant _symbol = 'SAFERAT';
    ...
    uint256 public _maxTransferAmount = ( _tTotal * 150 ) / 10000;
