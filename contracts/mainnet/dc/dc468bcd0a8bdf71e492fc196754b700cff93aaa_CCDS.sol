...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x67018E470c36eaa4d3AC3d243dfde786f8C95b87;//   营销
...
contract CCDS is Token {
    constructor() Token(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E), //路由
    
        address(0x55d398326f99059fF775485246999027B3197955),  //u
        "Christmas Coin Doge Shiba",
        "CCDS",
        18,  //不要改
    
        1000000000,//num
    
        address(0x67018E470c36eaa4d3AC3d243dfde786f8C95b87),//fund address
    
        address(0x67018E470c36eaa4d3AC3d243dfde786f8C95b87)//dev address
    ){
