...
Stealth-launching like Bitcoin did some years ago. We are the Apes, which come out of the Dark and get known everywhere! 

Telegram: https://t.me/houseofapes

Website: Will be announced in Telegram.

Based Dev - last project did x20 and this project will honestly MOON! 

Milestones if Marketcap is reached:
*    3K - Huge shilling starts
*    8K - New Team Members are hired
*   10K - Big marketing starts
*   25K - Website is published
*   45K - Beta Version of Game is published
*   65K - CMC and Coingecko listing
*   75K - After day 3 liquidity is locked again
*   90K - Dextool logo and Social update
*  100K - Pro Version of P2E-Game is published. 
*  150K - Listing on 2 new DEX
*  250K - NFT Collection is published
*  300K - New Milestones are published

*Goal is to be published on BINANCE within 3 Months! 


My promise to you, the investor:

Contract is safe and liquidity will be locked. 
Ownership will be transferred to Dead Wallet. 
90% of Tokens will be burned at Launch. 
50% of tax in marketing wallet will be used for buyback and burn to increase price of tokens. 
...
We want organic growth - share this message! 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C1266463a95099Cd2869a1bbF7A8B997b088EbE;
...
contract HouseOfApes is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x23B6d7af6fB27593E2C4C9aCbc3B0c44c0D6B6a6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HouseOfApes";
