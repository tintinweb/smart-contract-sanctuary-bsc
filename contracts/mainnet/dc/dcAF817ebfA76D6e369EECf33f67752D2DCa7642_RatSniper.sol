...
contract RatSniper is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RatSniper";
    string constant _symbol = "RatSniper";
    ...
    uint256 public sellMultiplier  = 340;
