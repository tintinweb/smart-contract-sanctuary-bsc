...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x511F2b933299F6510b2033A0158242FdC449819d;
...
/* Token contract */
contract BusdHeist is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x511F2b933299F6510b2033A0158242FdC449819d;
    ...
    // Name and symbol
    string constant _name = "BUSD HEIST";
    string constant _symbol = "BH";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 5% on launch or 50k tokens
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 5% or 50k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 5% or 50k tokens
