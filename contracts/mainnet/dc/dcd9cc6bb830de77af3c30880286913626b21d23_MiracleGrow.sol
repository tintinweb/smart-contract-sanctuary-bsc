...
Welcome to fastest growing project and community in Crypto. We plan to help the
Crypto space grow a little more extraordinary.

Total Supply: 1,000,000,000 Miracle Grow
Max Wallet: 2%,  20,000,000 Miracle Grow
Max Transaction: 1%,  10,000,000
Buy / Sell Tax: 8% 

https://t.me/EnterMiracleGrow
...
contract MiracleGrow is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Miracle Grow';
    string private constant _symbol = 'MGROW';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//total
    ...
    //DevWallets
    address public MarketingWallet=payable(0x97847a07D1F11ad924b746d9E75a7c33bB467558);
    address public Development=payable(0x5F2BB9ACCbC226F0D68051d5eb344c7b68B7E0E0);
    //TestNet
	...
	uint256 private MaxBuy = 20000000 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3000000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*65) / 100);
    ...
    function TeamlockLiquidityInSeconds(uint256 secondsUntilUnlock) public onlyOwner{
