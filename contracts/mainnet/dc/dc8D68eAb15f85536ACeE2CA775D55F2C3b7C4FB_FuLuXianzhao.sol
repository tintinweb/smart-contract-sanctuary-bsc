...
contract FuLuXianzhao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuLuXianzhao";
    string private _symbol = "FULUXIANZHAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x283B836B18122e40188C2503ad3fB3029984DCb6); // 营销钱包
    address payable public teamWalletAddress = payable(0x283B836B18122e40188C2503ad3fB3029984DCb6); // 团队钱包
