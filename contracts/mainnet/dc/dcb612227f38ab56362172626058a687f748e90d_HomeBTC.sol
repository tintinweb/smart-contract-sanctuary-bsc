...
contract HomeBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HomeBTC";
    string private _symbol = "HBTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95880918D3adbfd7E2aeB0c658A118EEF88015eb);
    address payable public teamWalletAddress = payable(0x7009E46CbdDC7A63be0754d04Fc47A6C00fA7799);
