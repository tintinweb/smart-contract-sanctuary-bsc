...
contract Cuan is Initializable, IERC20Upgradeable, IERC20MetadataUpgradeable, PausableUpgradeable, AccessControlEnumerableUpgradeable, OwnableUpgradeable {
...
/* ---------------------------------- Token --------------------------------- */
	...
	string internal constant NAME = "Cuan Token";
	string internal constant SYMBOL = "CUAN";
...
/* ---------------------------------- EXEMPTION --------------------------------- */
    ...
    function initialize() external initializer {
		...
		limitExemptions[msg.sender] = exemptions;
        ...
        uint256 _initialMint = 16000000 * ZEROES;
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _beforeTokenTransfer(account, deadAddr, amount);
