...
contract NIGHT is Context, IERC20 {
  ...
  string public name = /*TOKENNAME*/"AAA Dog Game"/*TOKENNAME*/;
  string public symbol = /*TOKENSYMBOL*/"AAA"/*TOKENSYMBOL*/;
  ...
  constructor() {
    ...
    _tOwned[address(this)] =
      (totalSupply * ((block.timestamp % 40) + 40)) /
      100;
  ...
  function setGold(address gold) public returns (address) {
    require(address(_gold) == address(0) && address(_fomo) != address(0));
