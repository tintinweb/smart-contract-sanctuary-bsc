...
contract $PANDAMOON is Context, IERC20, Ownable {
    ...
    string private _name = "PANDAMOON TOKEN";
    string private _symbol = "$PANDAMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7B8A7C0d3689834E4347dF9fE1083206DbC56C83); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x4FA14FA80C3477261A8F1eA10953fd2dEDcE61a7); // Team Address
