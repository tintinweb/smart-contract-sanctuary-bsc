...
contract XDOGE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "X DOGE";
    ...
    address private marketingWallet = address(0x64b8C2dE858c59A4eDB75928A2C656963291D101);
    address private liquidityReceiver = address(0x64b8C2dE858c59A4eDB75928A2C656963291D101);
