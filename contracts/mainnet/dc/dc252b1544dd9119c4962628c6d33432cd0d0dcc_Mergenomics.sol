...
contract Mergenomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAddress = 0x33c49bda46070Afa03Ab0C806F0f0481242be8D8;
    
    string constant _name = "Mergenomics";
    string constant _symbol = "Mergenomics";
