...
‼️Recommended Buy and Sell Slippage at launch should be 13%+ should work.‼️/*/
...
contract METAFIRSTAIR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METAFIRSTAIR";
