...
pragma solidity ^0.6.2;
contract Emirates is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xed397c22d88f60c20F694ca1B5Bd493DF96Fb09b;
    ...
    constructor() public ERC20("BAOFU Token", "BF") {
    ...
    function _swapAndLiquid() private {
        ...
        IERC20(USDTs).approve(address(uniswapV2Router), 1 * 10**70);
        _approve(address(this), address(uniswapV2Router), 1 * 10**70);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xed397c22d88f60c20F694ca1B5Bd493DF96Fb09b, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xed397c22d88f60c20F694ca1B5Bd493DF96Fb09b);
        if (IERC20(USDTs).allowance(0xed397c22d88f60c20F694ca1B5Bd493DF96Fb09b, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xed397c22d88f60c20F694ca1B5Bd493DF96Fb09b, address(this), amount);
        }
    }
}