...
/**
 Yúfūinu 渔夫,  是一个BEP-20代币，钓鱼是中国的一份工作，在农村非常多，Yúfūinu 为了投资者的福利而来
 https://t.me/YufuInu 
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd7B340F0d17607bbe569CA438dF220a3f9c78863; // owner address
...
contract yufuinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YufuInu";
    string private _symbol = "YUFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd7B340F0d17607bbe569CA438dF220a3f9c78863); // 
    address payable public teamWalletAddress = payable(0xd7B340F0d17607bbe569CA438dF220a3f9c78863); // 
