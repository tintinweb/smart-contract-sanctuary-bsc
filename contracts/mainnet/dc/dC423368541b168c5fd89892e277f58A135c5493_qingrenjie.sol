...
contract qingrenjie is ERC20 {
    ...
    uint256 public _walletMax = 500000000 *10**18;
    ...
    uint256 private A = 5 ;
    uint256 private maxGasOfBot = 600000;
    UsdtWrap RECV;
    ...
    constructor() ERC20("qingrenjie", "qingrenjie") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x7D5f18e7f216f809d237ABbf20dC3A492Fe215FA);
        marketAddress = address(0xE8f7103b475AAE0FB64D81916CFDB2bAf844Fcb6);
        // teamAddress= address(0xE8f7103b475AAE0FB64D81916CFDB2bAf844Fcb6);
        ...
        _mint(_tokenOwner, 5200000000 * 10**18);
