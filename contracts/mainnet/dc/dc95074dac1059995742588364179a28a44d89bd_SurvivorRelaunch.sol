    ...
    IERC20MetadataUpgradeable
{
    ...
    function _isTimeToRebase() internal view returns (bool) {
        ...
        console.log("rebase??", autoRebaseEnabled, inSwap, msg.sender);
        console.log(block.timestamp, lastRebasedTime);
    ...
    function _isTimeToSwapTreasury() internal view returns (bool) {
        console.log("istimetoswaptreasury", inSwap, msg.sender, pair);
        console.log(_pendingTreasury, _nextToSwap);
        return
            !inSwap &&
            msg.sender != pair &&
            _pendingTreasury > 0 &&
    ...
    function _transferFrom(
        ...
        console.log("IN _transferFrom - nextToSwap = ", _nextToSwap);
