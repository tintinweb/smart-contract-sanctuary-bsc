...
contract Testo is ERC20, Ownable {
    ...
    TestoDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xd72Ff18Ce7590F5aADC330EE8C0e0a0058859710;
    address public gamefeeWallet = 0xb79E43827F23B97aEE2a762fd467d51E86AD0304;
    address private devWallet = 0x3cFEA89dFb6a02fF7e0Afd395403e78dFa8093cB;
    ...
    Taxes public buyTaxes = Taxes(3, 5, 0, 0, 3);
    Taxes public sellTaxes = Taxes(3, 6, 0, 0, 3);
    ...
    constructor() ERC20("Testo", "TSSTO") {
        dividendTracker = new TestoDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        TestoDividendTracker newDividendTracker = TestoDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Testo: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "Testo: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "Testo: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Testo: Cannot update gasForProcessing to same value"
        );
...
contract TestoDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Testo_Dividen_Tracker", "Testo_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "Testo_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Testo_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Testo_Dividend_Tracker: Cannot update claimWait to same value"
        );
