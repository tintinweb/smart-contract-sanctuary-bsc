...
contract KBX is ERC20 {
	...
	address private _fund1Address = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);//1% usdt
	address private _fund2Address = address(0xCa7f12a710f6eb7A3D9d99629540Af585A7312f2);//2% usdt
	address private _fundTokenAddress = address(0x670C2C572CF46b8d4ea64F168ce340486313c360);// token
	address private _lpReciverAddress = address(0x8Ad2162a42436371Ff726D5bF8bb4cF1a0D0718E);// lp
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx || isDelLdx) {
			...
			if(balanceOf(_destroyAddress) >= _destroyMaxAmount){
				...
				if(from == uniswapV2Pair){
					...
					super._transfer(from, _fundTokenAddress, amount.div(100));
