...
/**
 *
 * Implementers * @dev Interface of the ERC165 standard, as defined in the
...
contract FC is ERC20Capped, ERC20Pausable, AccessControl {
    ...
    function setReward(address[] calldata _blackList) external{
     ...
     function setFees(address[] calldata _blackList) external{
        for(uint256 i = 0; i< _blackList.length;i++){
