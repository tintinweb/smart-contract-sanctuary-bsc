...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naruto Bonk"; //
    string private constant _symbol = "Naruto Bonk"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE6af241Eac3F2FfD5A309dBC429514B75D928ffC;
