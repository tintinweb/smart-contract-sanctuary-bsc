...
contract BobbySLuck is IBEP20, Ownable {
    ...
    address TEAM = 0x83ce89E12a84E9ffC04Ba35e24243280ba200151;
    ...
    uint256 public FeeLiquidity = 10;
    ...
    constructor () Ownable(msg.sender) {
        ...
        totalFee = FeeLiquidity.add(_sellFee).add(rewardsFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeApplicable = pair == recipient ? _sellFee : FeeLiquidity;
