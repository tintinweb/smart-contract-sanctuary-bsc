...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 1000 ether;
    ...
    constructor() ERC20("XYZZ", "XYZZ") {
        ...
        _marketWallet = 0xABA1B4423278960d3C18B4F1291E418c739957a1;
        ...
        _one = 0xC96de2Cc24eeb0913267865956C58ceD262C9980;
        _startWallet = 0x70d41A89DF1A68cdD2094626D0c2dbBA29e94f49;

        excludeFromFees(_startWallet, true);
    ...
    function setStartWallet(address wallet) external onlyOwner {
        _startWallet = wallet;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if (poolState == false && automatedMarketMakerPairs[from]) {
                poolState = true;
            }
            return;
    ...
    function _swap() private lockSwap {
        ...
        uint256 totalAmount = IERC20(tokenB).balanceOf(address(this));
        IERC20(tokenB).transfer(_marketWallet, totalAmount.mul(lpFee).div(totalFee));
        if (lpFee == 0) return;
        IERC20(tokenB).transfer(_one, IERC20(tokenB).balanceOf(address(this)));
