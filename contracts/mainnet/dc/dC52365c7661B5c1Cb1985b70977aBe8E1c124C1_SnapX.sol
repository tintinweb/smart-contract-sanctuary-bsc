...
/**
Telegram : https://t.me/SnapXearn
Twitter  : https://twitter.com/SnapXearn
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50dbd54798473644c20ae00B8e2DA1c1c9955EE0; // owner address
...
contract SnapX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snap X";
    string private _symbol = "SNAPX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16Ad54C8e275D3E44Df3fd0062f6AFb03F7f80eA); // Marketing Address
    address payable public snapprizeAddress = payable(0x16Ad54C8e275D3E44Df3fd0062f6AFb03F7f80eA); // Team Address
    ...
    uint256 public _buysnapprize = 1;
    
    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 8;
    uint256 public _sellsnapprize = 1;
    ...
    constructor () {
        ...
        isExcludedFromFee[snapprizeAddress] = true;
        isExcludedFromFee[address(this)] = true;
        
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buysnapprize);
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellsnapprize);
        ...
        isWalletLimitExempt[snapprizeAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[marketingWalletAddress] = true;
        isTxLimitExempt[snapprizeAddress] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(snapprizeAddress, amountBNBTeam);
