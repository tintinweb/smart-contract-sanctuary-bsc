...
contract $BABYPIGGO is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON BINANCE"; // 
    string private constant _symbol = "$ElonBinance"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x55d278aA86362f001521F25fCb5256aff245128b;
