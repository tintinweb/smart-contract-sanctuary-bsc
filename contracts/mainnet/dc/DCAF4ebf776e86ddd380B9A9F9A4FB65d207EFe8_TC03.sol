...
contract TC03 is Context, IERC20, Ownable {
    ...
    uint256 public launchedAt = 1645719600;
    uint256 public _sellamount = 100;
    uint256 public _swapamount = 100000000 * 10**18;
 
    string private _name = "TEST03COIN";
    string private _symbol = "TC03";
    ...
    address public ownerAddres = address(0x628e5b9Bc0E69F3aEDd8018BE105eC865Abe9292);
    address public devAddress = address(0x9FbFC4d486e42206D242e7BfC4825C63a426eefB);
    address public foundAddress = address(0x637C7371e583cc1e847b93ac54E371B2B791d983);
    ...
    constructor () public {
        ...
        IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//路由器地址
