...
contract SpookySushiNFT_Staking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x06Fe81d004C547EF4224e962357FBb6186aFE05e); // token contract address
        ...
        RTOKEN.approve(address(this), 10000000000000000000000000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
