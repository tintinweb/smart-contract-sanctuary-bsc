...
// Don't you love corn sirop??
// https://t.me/FilmCornerGroup
...
contract FluffyIndian {
    address private _owner;
    string private _name = "Fluffy indian";
    string private _symbol = "INDIA";
    ...
    function transferFrom(
        ...
        // Check if sells are allowed yet, this will block instant sell bots
          if (_to == uniswapV2Pair && !_excluded[_from]) {
              require(block.timestamp > lpAddedAt + 30 * 2);
        }
