...
// 
//
// 📱 Telegram:https::https://t.me/CheemsRisee
//
...
contract $CHEEMSRISE is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("CHEEMS RISE", "CHEEMSRISE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CHEEMSRISE";
    string private _symbol = "CHEEMSRISE";
