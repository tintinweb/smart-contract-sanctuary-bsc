...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Test_Busd_Dividend_Tracker", "Test_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 3000 * (10**18); //must hold 3,000+ tokens
    }
...
contract Test is ERC20, Ownable {
    ...
    uint256 public _marketingFeeBuy = 9;
    uint256 public _LpFeeBuy = 2;

    uint256 public _busdDividendRewardsFeeSell=17;
    ...
    constructor() ERC20("BZZ", "BZZ") {
    	...
    	marketingWallet = 0x2360A570ee5273E520e58aD6eeD1DA3B32624cE2; 
