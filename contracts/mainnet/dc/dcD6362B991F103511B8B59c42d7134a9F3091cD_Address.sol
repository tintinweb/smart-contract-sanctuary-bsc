...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6b116B7ad0a04579fBB6250e5ed441661E071CEA; // owner address
...
contract SanjiInu is Context, IERC20, Ownable {
    ...
    string public _name = "Twitter Elon";
    string public _symbol = "TEL";
    uint8 public _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6b116B7ad0a04579fBB6250e5ed441661E071CEA); // Marketing Address
    address payable public teamWalletAddress = payable(0x6b116B7ad0a04579fBB6250e5ed441661E071CEA); // Team Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6b116B7ad0a04579fBB6250e5ed441661E071CEA); 
