...
The fire god is revered as a purificatory agent as much as out of fear for his destructiveness.
During the hi-matsuri (“fire festivals”) at the beginning of the new year, 
worshippers carry back to their home hearths torches lit from the new fire started by the temple priest. 
The traditional method of lighting a fire for religious purposes is with a fire drill. 
One of the most popular shrines dedicated to the Fire God.
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract Kagutsuchi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kagutsuchi";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe59532C48E2462C538a07c60795D076A353350ef;
        ecosystemfeeReceiver = 0xe59532C48E2462C538a07c60795D076A353350ef;
