...
contract LoncherOfficial is Context, IERC20, Ownable {
    ...
    string private constant _name = "Loncher";
    string private constant _symbol = "LONCHER";
