...
contract SEOS  is IERC20 {
    ...
    string private _name = "SEOSsssss";
    string private _symbol = "SEOSssss";
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 21000000 * 10**18)_burnFee = 0;
