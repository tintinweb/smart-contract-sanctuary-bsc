...
contract HeroMilo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HeroMilo";
    string private _symbol = "HeroMilo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDD4fb39c905a2354dFc8fD498deFE985d275b992);
    address payable public teamWalletAddress = payable(0xDD4fb39c905a2354dFc8fD498deFE985d275b992);
