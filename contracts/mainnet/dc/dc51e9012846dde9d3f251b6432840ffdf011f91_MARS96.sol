...
Name: MARS TOKEN 1996 
Symbol: - MARS96
* Telegram : https://t.me/MarsToken1996
*/
...
contract MARS96 is Context, IERC20, Ownable {
    ...
    string private constant _name = "MarsToken 1996";
    string private constant _symbol = "MARS96";
    ...
    function tradeEnable(bool _enable) public onlyOwner {
        Trading = _enable;
    }
