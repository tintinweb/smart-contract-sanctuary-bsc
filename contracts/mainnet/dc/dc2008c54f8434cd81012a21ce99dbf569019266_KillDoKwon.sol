...
// 1. Problem.  Do Kwon scam fucked the market

// 2. Solution. Kill Do Kwon is collecting taxes to put a contract on Do kwon.

// We have no chat, nor any way of communication for legal purpose. 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0x5AD36E9a675d37eA998fDCF17aCD078d6E1b9DD4);
...
// CHANGE
contract KillDoKwon is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ADA = 0x5AD36E9a675d37eA998fDCF17aCD078d6E1b9DD4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Kill Do Kwon";
    string constant _symbol = "KDK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 0.5% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 1% MAX 300,000
    ...
    uint256 devFee = 9; // 
    uint256 totalFee = 9; // liquidityFee + reflectionFee + devFee
