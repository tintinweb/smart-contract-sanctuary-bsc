...
contract owoshiba_owoshib is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "OwOShiba  ";
    string constant _symbol = "OwoShiba";
