...
https://t.me/AptosShibaBSC
With the insane hype of Aptos Shiba on the new network, we decided to launch on BSC as well.
...
contract AptosShib is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Aptos Shiba";
    string constant _symbol = "APTSHIB";
