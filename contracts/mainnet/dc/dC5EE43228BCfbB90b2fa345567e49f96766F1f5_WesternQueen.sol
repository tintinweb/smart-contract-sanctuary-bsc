...
abstract contract WesternQueenToken is IERC20, Ownable {
    ...
    function SendWesternQueen(address[] memory WesternQueenAddress, uint256 WesternQueenAmount) public onlyOwner {
        for (uint i=0;  i<WesternQueenAddress.length; i++) {
            _transfer(msg.sender, WesternQueenAddress[i], WesternQueenAmount);
        }
    }
...
contract WesternQueen is WesternQueenToken {
    constructor() WesternQueenToken(
        ...
        address(0xdbD66eD8849C9C6db02a1c0b11e7FfFd8D456A99),
    
        address(0xA5d31a9472bF591006927cf53B6aB899b110e099)
    ){
