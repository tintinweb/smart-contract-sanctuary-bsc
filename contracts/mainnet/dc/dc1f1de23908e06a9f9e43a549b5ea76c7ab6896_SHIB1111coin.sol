...
contract SHIB1111coin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIB1111";
    string private _symbol = "SHIB1111";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14A4a6680d5269378c81987BA22DA9b1BfF913F0); 
    address payable public BurnedWalletAddress = payable(0xf61F9a6b5Ed0762bA600670968aad556001acb30); 
    ...
    uint256 private _totalSupply = 1111111111111111 * 10**_decimals;
