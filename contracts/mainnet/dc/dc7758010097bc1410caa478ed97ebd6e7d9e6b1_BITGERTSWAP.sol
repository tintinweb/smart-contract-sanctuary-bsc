...
Telegram community https://t.me/bitgertswapp
website : https://bitgertswap.finance
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 bitrise = IBEP20(0x8FFf93E810a2eDaaFc326eDEE51071DA9d398E83);
    ...
    uint256 public minimumTokenBalanceForDividends = 500000000 * (10**9); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = bitrise.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(bitrise);
        ...
        uint256 amount = bitrise.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            bitrise.transfer(shareholder, amount);
...
contract BITGERTSWAP is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BITGERTSWAP";
    string constant _symbol = "BITGERTSWAP";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 50000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(5).div(100); 
    uint256 public _maxWalletHold = 2500000000;
