...
pragma solidity ^ 0.6.2;
 ...
 contract JSI12 is Ownable {
  ...
  address pool = 0x97ac065eF47F81269D64003453FeEdE83b9426DC;
  ...
  struct UserData {
    ...
    function register(uint256 userid,uint256 upline) public {
        ...
        if(user.userid==0){
			...
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline1,amount.div(110).mul(50));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline2,amount.div(110).mul(20));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline3,amount.div(110).mul(5));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline4,amount.div(110).mul(5));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline5,amount.div(110).mul(20));
			IERC20(BUSD).transferFrom(address(msg.sender),pool,amount.div(110).mul(10));
