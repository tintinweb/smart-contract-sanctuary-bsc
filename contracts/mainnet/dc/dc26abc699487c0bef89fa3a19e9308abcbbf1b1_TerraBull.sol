...
// CHANGE
contract TerraBull is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TerraBull";
    string constant _symbol = "$TBULL";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x513161470C877694d678E3a7F2D7150a7A395033);
