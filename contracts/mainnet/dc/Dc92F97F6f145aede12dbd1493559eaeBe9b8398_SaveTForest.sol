...
Save Totoro's Forest is a charity-oriented project based on Studio Ghibli's animated movie “My Neighbor Totoro”
...
Website: https://savetotoros.games
Telegram: https://t.me/SaveTotorosForest
Twitter: https://twitter.com/SaveTForest
...
contract SaveTForest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Save T Forest";
    string private _symbol = "STF";
    uint8 private _decimals = 9;

    address payable public Marketing = payable(0x30448BFD11A081ba66D2EF5ACF0b39bc709D1C37);
    address payable public Charity = payable(0x7f24Ba156EBE2b7339eC8123E87Be6E125E61301);
    ...
    uint256 public _walletMax = 60 * 10**5 * 10**9;
