...
contract TwitterX is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterX App";
    string private _symbol = "XAPP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6061ee9F46B91a8eFeE547Bc5e4D02FF82ada7d6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6061ee9F46B91a8eFeE547Bc5e4D02FF82ada7d6); // BuyBack Address
