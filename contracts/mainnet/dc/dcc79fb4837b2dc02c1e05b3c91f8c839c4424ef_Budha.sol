...
contract Budha is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0x0000000000000000000000000000000000000777);
    address public mainAddres = address(0x6ce465037203f6CC4F67690A0C7Fe1D47aB49f66);
    address public marketAddress = address(0x1a1104260f6cb5Dc9Ccd797cfeD850641d20F53E);
    address public fundAddress = address(0x229eDF14F249dFB1302C2c30ee32171F68914648);
    address public liquidAddress = address(0xc09B689bdc969d1200fE8Af3875133151B7b8A73);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 1890000000 * 10 ** 18 
