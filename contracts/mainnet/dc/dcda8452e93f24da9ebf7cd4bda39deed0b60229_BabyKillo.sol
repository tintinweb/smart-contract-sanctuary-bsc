...
contract BabyKillo is Ownable, IERC20 {
    ...
    string private _name = "Baby Killo";
    string private _symbol = "Baby Killo";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000 * 10 ** _decimals;
    uint256 private _mTokenss = 1000000 * 10 ** _decimals;
    uint256 private _burnfee = 0;
    address private _baddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (_burnfee > 0) {
        emit Transfer(sender, _baddress, feeAmount);
        }
    }
