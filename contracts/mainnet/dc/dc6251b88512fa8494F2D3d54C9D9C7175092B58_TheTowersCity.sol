...
contract TheTowersCity is Ownable, Pausable, Initializable {
    ...
    function getInvestmentReward(address _user, uint8 _square) public view returns(uint256) {
        return funding[_user][_square] * (submittedWorksCount[_square] - claimedRewardsCount[_user][_square]) * investmentRewardsRatio / investmentRewardsRatioDenom;
    }
    ...
    function fundTower(uint8 _square, uint256 _amount) public whenNotPaused {
        ...
        require(claimedRewardsCount[msg.sender][_square] == 0 || claimedRewardsCount[msg.sender][_square] == submittedWorksCount[_square], "TowersCity: claim rewards before funding tower");
