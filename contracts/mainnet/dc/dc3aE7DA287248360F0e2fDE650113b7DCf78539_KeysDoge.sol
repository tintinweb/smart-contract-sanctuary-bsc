...
contract KeysDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Keys Doge";
    string private _symbol = "Keys Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x290591c3913fdC8982B66dF6e5741a2Fa1769f31); // Marketing Address
    address payable public teamWalletAddress = payable(0x8Bab1AE90E094F07b6715f6bffF0F8374b24e379); // Team Address
