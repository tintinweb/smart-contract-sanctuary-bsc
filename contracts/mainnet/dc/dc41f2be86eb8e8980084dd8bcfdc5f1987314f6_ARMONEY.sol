...
contract ARMONEY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ARMONEY";
    string constant _symbol = "RMT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x70B38C28B356802f28386846216974808a6fa474;
        devfeeReceiver = DEAD;
