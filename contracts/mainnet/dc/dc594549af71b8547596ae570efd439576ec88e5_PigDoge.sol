...
contract PigDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pig Doge";
    string private _symbol = "PigDoge";
    uint8 private _decimals = 9;

    address payable public fundWalletAddress = payable(0x7C39C555f0B62FEFEBB54C2AdB102b42F3573084);
    address payable public teamWalletAddress = payable(0x7C39C555f0B62FEFEBB54C2AdB102b42F3573084);
