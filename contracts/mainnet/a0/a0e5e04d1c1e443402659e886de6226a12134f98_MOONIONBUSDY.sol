...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  BUSDY = IBEP20(0x5BEBfAB847DD89B1D03cA654685BaC07Aa01224e);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BUSDY .balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BUSDY);
        ...
        uint256 amount = BUSDY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BUSDY.transfer(shareholder, amount);
...
contract MOONIONBUSDY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MOONION BUSDY";
    string constant _symbol = "MOONBUS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x6B73251E883B038cdc6574e4967CD0C870026DD9;
