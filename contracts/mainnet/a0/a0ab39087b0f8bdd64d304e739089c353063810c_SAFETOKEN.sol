...
contract SAFETOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x51FC6e2B418578e0BB80C0c7B3025FA8F29CED06); // Marketing Address
    ...
    string private _name = "SAFE Token";
    ...
    uint256 private minimumTokensBeforeSwap = 35780 * 10**6 * 10**9; 
