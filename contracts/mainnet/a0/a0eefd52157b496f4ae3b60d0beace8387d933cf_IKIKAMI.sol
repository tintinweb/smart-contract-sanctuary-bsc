...
contract IKIKAMI is IBEP20, Auth {
    ...
    string constant private _name = "IKIKAMI";
    string constant private _symbol = unicode"域神";
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function changeFeeReceivers(address _marketingFeeReceiver, address _devFeeReceiver) external authorized {
    ...
    function manageBlacklist(address _address, bool _value) public authorized {
