...
contract ShibKillerMinidoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibKillerMinidoge";
    string private _symbol = "ShibKillerMinidoge";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xFC4fA424829c4858bd601DBB7e00C128331C9B6b); 
    address payable public ttWal = payable(0xFC4fA424829c4858bd601DBB7e00C128331C9B6b); 
