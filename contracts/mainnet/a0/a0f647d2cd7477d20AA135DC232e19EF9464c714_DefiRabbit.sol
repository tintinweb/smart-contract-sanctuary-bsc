...
contract DefiRabbit is IBEP20, Auth {
    ...
    string constant _name = "Defi Rabbit";
    string constant _symbol = "DRB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 833551639787659 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7d0eD8734E059B9651cCc2581f37de03c03ba571;
