...
contract BullGameToKens is ERC20, Ownable {
    ...
    uint256 public totalFeesOnBuy       = 10;
    uint256 public totalFeesOnSell      = 10;

    address public marketingWallet = 0x961C1A1266C0f20240bd70281E74B1d2fa3D56BB;
    ...
    event BuyFeesUpdated(uint256 marketingFeeOnBuy, uint256 liquidityFeeOnBuy, uint256 burnFeeOnBuy, uint256 buyBackFeeOnBuy, uint256 rewardFeeOnBuy, uint256 totalFeesOnBuy);
    event SellFeesUpdated(uint256 marketingFeeOnSell, uint256 liquidityFeeOnSell, uint256 burnFeeOnSell, uint256 buyBackFeeOnSell, uint256 rewardFeeOnSell, uint256 totalFeesOnSell);
    ...
    constructor(address newOwner) ERC20("Bull Game ToKens", "BGT") 
    {
        _transferOwnership(newOwner);
    ...
    function enableTraiding() external onlyOwner {
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy, uint256 _liquidityFeeOnBuy, uint256 _buyBackFeeOnBuy, uint256 _burnFeeOnBuy,uint256 _rewardFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy + _liquidityFeeOnBuy + _buyBackFeeOnBuy + _burnFeeOnBuy + _rewardFeeOnBuy <= 10, "Fees cannot be more than 10%");
        ...
        totalFeesOnBuy = _marketingFeeOnBuy + _liquidityFeeOnBuy + _buyBackFeeOnBuy + _burnFeeOnBuy + _rewardFeeOnBuy;
        emit BuyFeesUpdated(_marketingFeeOnBuy, _liquidityFeeOnBuy, _buyBackFeeOnBuy, _burnFeeOnBuy, _rewardFeeOnBuy,totalFeesOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell, uint256 _liquidityFeeOnSell, uint256 _buyBackFeeOnSell, uint256 _burnFeeOnSell, uint256 _rewardFeeOnSell) external onlyOwner {
        require(_marketingFeeOnSell + _liquidityFeeOnSell + _buyBackFeeOnSell + _burnFeeOnSell + _rewardFeeOnSell <= 10, "Fees cannot be more than 10%");
        ...
        totalFeesOnSell = _marketingFeeOnSell + _liquidityFeeOnSell + _buyBackFeeOnSell + _burnFeeOnSell + _rewardFeeOnSell;
        emit SellFeesUpdated(_marketingFeeOnSell, _liquidityFeeOnSell, _buyBackFeeOnSell, _burnFeeOnSell, _rewardFeeOnSell,totalFeesOnSell);
    }

    function updateWTWFee(uint256 _WTWFee) external onlyOwner {
        require(_WTWFee <= 10, "Fees cannot be more than 10%");
    ...
    function updateBuyBackThreshold(uint256 _buyBackThreshold) external onlyOwner {
        require(_buyBackThreshold >= 0.1 ether, "Buyback threshold cannot be less than 0.1 ether");
    ...
    function _transfer(
        ...
        require(tradingEnabled || isExcludedFromFees(from) || isExcludedFromFees(to), "Trading is not enabled yet");
        ...
        if( canSwap &&
            ...
            uint256 totalFees = liquidityShare + marketingShare + buyBackShare + rewardShare;
            ...
            uint256 bnbShare = marketingShare + buyBackShare + rewardShare;
                ...
                if(buyBackShare > 0) {
                    ...
                    if (accumulatedBuyBackBNB >= buyBackThreshold) {
                        address(this).balance >= accumulatedBuyBackBNB ?
                            buyBackTokens(accumulatedBuyBackBNB) : buyBackTokens(address(this).balance);
