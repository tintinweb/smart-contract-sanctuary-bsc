...
contract DontWasteMy is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x1a53311DF03f80A0CE98A39f348ACabC9DB20CF3),
        development: payable(0x1a53311DF03f80A0CE98A39f348ACabC9DB20CF3)
    });
...
//===============================================================================================================
    ...
    function renounceOriginalDeployer() external {
        require(msg.sender == _owner, "Can only be called by original deployer.");
        _owner = address(0);
    }
...
//===============================================================================================================
    ...
    function redisfee(uint16 buyFee, uint16 sellFee, uint16 transferFee) public authorized {
