...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 ROBINU = IBEP20(0x191F42c6A6cccf99D675a96363EeEe6f6651CA01);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ROBINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ROBINU);
        ...
        uint256 amount = ROBINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ROBINU.transfer(shareholder, amount);
...
/* Token contract */
contract BabyRobinhoodInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address ROBINU = 0x191F42c6A6cccf99D675a96363EeEe6f6651CA01; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0b471202243707Cb7ae6E950725ACB968D0fC5b2;
    ...
    // Name and symbol
    string constant _name = "Baby Robinhood Inu";
    string constant _symbol = "BabyRobinu";
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell =1300;
    uint256 devFeeSell = 0;
    uint256 public totalFeeSell = 2300;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb32b71088564c692c5a251E0E4837FF7e9A55453;
