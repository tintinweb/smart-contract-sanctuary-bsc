...
contract DOGESHUND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogeshund";
    string private _symbol = "DOGES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x734F63b8783ea3cB39ff98Ecf7a74B78Ff90A619); 
