...
🔸TAKASHI INU 🔸!!!! 
HYPE NAME IN THIS YEAR,
COME ON LETS BUILD A STRONG 
COMMUNITY AND GO TO THE MOON TOGETHER

    Telegram  https://t.me/TakashiInuBsc
...
contract TAKASHIINU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x6AbE68C4bFB9D7b730CFABf607cd5e785Dd48769));


    string private _name = "TAKASHI INU";
    string private _symbol = "TAKAINU";
