...
// Little Witch Nobeta  リトルウィッチノベタ is an anime action game built on the Binance Smart Chain where players can play to earn. Limited edition NFT area also available soon.

// Telegram: https://t.me/LittleWitchNobeta
// Website: https://www.nobetap2e.online/
// Twitter: https://twitter.com/NobetaCoin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24468863A9A393260ed6C0B2696408f8F4EC0d75;
...
contract NobetaCoin is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x24468863A9A393260ed6C0B2696408f8F4EC0d75);
    ...
    */
    ...
    string private _symbol = unicode"魔女のベータ";  
