...
contract MarketplaceV4Upgradeable is
    OwnableUpgradeable,
    EIP712Upgradeable,
    ReentrancyGuardUpgradeable
{
    ...
    function newDatasetAllowedToken(
        string memory id,
        address token,
        bool isAllowed
    ) external {
    ...
    function getAllowedToken1(address token) public view returns (bool) {
        return allowedToken[token];
    }

    function getAllowedToken2(address token) public view returns (bool) {
        return allowedToken[token];
    }

    function getAllowedToken3(address token) public view returns (bool) {
        return allowedToken[token];
    }

    function getAllowedToken4(address token) public view returns (bool) {
        return allowedToken[token];
    }

    function getAllowedToken6(address token) public view returns (bool) {
        return allowedToken[token];
    }
}
