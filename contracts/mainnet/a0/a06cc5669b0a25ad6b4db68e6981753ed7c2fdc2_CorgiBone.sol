...
We introduce $CorgiBone

Launched by an experienced team, backed by many good names, and many holding diamonds tightly.

Corgi Bone
easily build a diversified portfolio for h while protecting against inexperience in the decentralized market space.
Corgi Bone tracks token performance in the BSC and Crypto space to find high yield investment opportunities early. As a result, Crypto investors can buy a variety of different cryptocurrencies for just a minute

Join Us Now!

♻️ Chat : https://t.me/CorgiBone
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6A3d52b70BdA9DfFA022CDCf25895307dEaA60ad;
...
contract CorgiBone is Context, IERC20, Ownable {
    ...
    string private constant _name = "CorgiBone"; // 
    string private constant _symbol = "CorgiBone"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x6A3d52b70BdA9DfFA022CDCf25895307dEaA60ad);
