...
SantaRabbit2023 lp will be burnt, there will be many surprises on this long journey.. 
Because, It aims to be one of the largest communtiy-driven initiatives in the BSC. 
The team ensure to be transparent for every transaction that will happen in the near future.

Telegram Channel : https://t.me/santarabbit2023
*/
...
contract SantaRabbit2023 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SantaRabbit2023DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Santa Rabbit 2023", "$SRBT") {
        marketingWallet = payable(0xe04b580DD398AD856C75Dc2BbEa65CA43F70142b);
        devWallet = payable(0xB4Bfab73cE31dBa462850340d5d2566A5ae1fA7E);
        ...
        dividendTracker = new SantaRabbit2023DividendTracker(
            payable(this),
            router,
            0x3d6545b08693daE087E957cb1180ee38B9e3c25E,
            "SantaRabbit2023TRACKER",
            "$SRBTTRACKER"
        );
...
contract SantaRabbit2023DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SantaRabbit2023 public SantaRabbit2023Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        SantaRabbit2023Contract = SantaRabbit2023(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SantaRabbit2023_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SantaRabbit2023_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SantaRabbit2023 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SantaRabbit2023Contract);

            uint256 prevBalance = SantaRabbit2023Contract.balanceOf(address(this));
            ...
            {
                uint256 received = SantaRabbit2023Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SantaRabbit2023Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
