...
/**
https://t.me/safeblockstackable

SAFEBLOCK SCALING AN SHARDING AS A LAYER 1 CROSSCHAIN SOLUTION
...
contract SAFEBLOCKSTACKABLE is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SAFE BLOCK STACKABLE';
    string private constant _symbol = 'SAFESTACK';
    ...
    //DevWallets
    address public Development=payable(0xBDAF93A4056ebAd358c1Ff86639606990e814Bfb);
    address public Marketing=payable(0x4021c5915e3B4B63E143e38eBFC440675d24aEb2);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x6aB6d61428fde76768D7b45D8BFeec19c6eF91A8; //BUSD Rewards
