...
contract TokenD is ERC20, Ownable {
	...
	string private constant _name = "TokenD"; 
	string private constant _symbol = "TokenD"; 
	...
	// Base taxes
	CustomTaxPeriod private _base = CustomTaxPeriod('default',0,0,2,2,2,2,2,2,2,2);
	...
	function setWallets(address newLiquidityWallet, address newMarketingWallet) external onlyOwner {
		if(liquidityWallet != newLiquidityWallet) {
			require(newLiquidityWallet != address(0), "DUT: The liquidityWallet cannot be 0");
	...
	function _swapAndLiquify() private {
		...
		uint256 amountETHHolders = ETHBalanceAfterSwap - (amountETHLiquidity + amountETHMarketing);
