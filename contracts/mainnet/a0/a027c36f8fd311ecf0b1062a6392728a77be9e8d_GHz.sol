...
https://twitter.com/elonmusk/status/1539375908800368641


12GHz:lock LP renounce CA before launch


Join us 12GHz:https://t.me/elon12GHz
...
contract GHz is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"12GHz broadband,"; ////
    string public constant symbol = unicode"12GHz Inu "; ////
    ...
    function startTrading() external onlyOwner() {
        ...
        _maxTxnAmount = 6000000 * 10**9; // 6%
        _maxWalletAmt = 12000000 * 10**9; // 12%
    }
