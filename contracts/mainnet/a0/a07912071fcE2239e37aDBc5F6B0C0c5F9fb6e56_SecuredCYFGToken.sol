...
// SPDX-License-Identifier: Unlicensed
    ...
    */
    ...
    contract SecuredCYFGToken is Context, IERC20, Ownable, ReentrancyGuard {
        ...
        address public cyfMinter_;
        address public bscyf_;
        uint256 public leftOverBalanceAfterSwap; // sent to Farm Reward
    
        string private constant _name = "SECURED CYFG TOKEN";
        string private constant _symbol = "CYFG";
        ...
        uint256 public _growthFee = 2; // Swapped & sent to bscyf
        ...
        address private immutable _usdToken = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); 
        ...
        uint256 public constant numTokensSellToAddToLiquidity = 75 * 10 ** (_decimals + 6); // 75m 
        ...
        constructor (address _cyfMinter, address _bscyf) {
            cyfMinter_ = _cyfMinter; 
            bscyf_ = _bscyf; 
            _rOwned[_cyfMinter] = _rTotal;
            ...
            _isExcludedFromFee[_cyfMinter] = true;
            _isExcludedFromMaxTxLimit[_cyfMinter] = true;

            // approve contract to Enable automatic 
            // Liquidity adding from cyfMinter Defi 
            _approve(_cyfMinter, address(uniswapV2Router), 2 ** 256 - 1);
            _approve(address(this), address(uniswapV2Router), 2 ** 256 - 1);
                
            emit Transfer(address(0), _cyfMinter, _tTotal);
        }
