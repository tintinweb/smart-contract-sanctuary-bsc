...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function percentage(address newOwner) external onlyOwner returns (bool) {
...
contract FUPO is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "FUPO";    
    string public symbol = "FUPO";
    uint8 public decimals = 9;   

    uint8 public initialfee;
   ...
   function takeright(address _token, uint256 tokens) private  {
    ...
    function removefee(uint256 newCoolWait) external onlyOwner {
        require(
   ...
   function changeright(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
