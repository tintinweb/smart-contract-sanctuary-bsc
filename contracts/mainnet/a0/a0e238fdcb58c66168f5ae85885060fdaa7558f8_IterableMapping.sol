...
contract BUSDKitty is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BKTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BUSD Kitty", "BK") {
        dividendTracker = new BKTokenDividendTracker();

        stakingWallet = 0xcCF67EB26384f27326f3Bd78702A971259e1d1eb;
        marketingWallet = 0xEBE35C10380b6bCFDB34be43AD7e1c0716766EEE;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BK: The dividend tracker already has that address"
        );

        BKTokenDividendTracker newDividendTracker = BKTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "BK: The new dividend tracker must be owned by the BK token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BK: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BK: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BK: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BK: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
...
contract BKTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("BK_Dividend_Tracker", "BK_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "BK_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BK_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BK contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "BK_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "BK_Dividend_Tracker: Cannot update claimWait to same value"
        );
