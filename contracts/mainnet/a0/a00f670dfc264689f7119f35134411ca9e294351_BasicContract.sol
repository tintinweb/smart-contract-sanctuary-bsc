...
// Telegram: https://t.me/CupidFlokiInu
...
contract BasicContract is IERC20 {
    ...
    uint256 private constant startingSupply = 14_200_000;
    string private constant _name = "CUPID FLOKI";
    ...
    Fees public _taxRates = Fees({buyFee: 200, sellFee: 300, transferFee: 500});
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x7E72fcafEdebcF5A8f235E8A02dE7e9FBb95fb52),
            development: payable(0xf5dCd540e2f8446351efaA1D9f9d8be36b7aBA4F)
        });    
    bool inSwap;
