...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb45F78432435ca793a233dddEFe3bb8c323c683D; // owner address
...
contract THEMASK is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x194468e7d984C8D8C5ddDC691109Fa899cC8a522); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2000000000000000 * 10**_decimals; 
