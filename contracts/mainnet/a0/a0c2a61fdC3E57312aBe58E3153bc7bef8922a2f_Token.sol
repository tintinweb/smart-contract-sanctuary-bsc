...
contract Token is IERC20, Ownable {
    ...
    address private projectAddress = 0x9B97f0D7c2c89c3a5B3F520668E9895183fcC7a2;
    address public  marketAddr = 0x8AA7bAa36Eb33D1716dee67b1a9827B42B27aD24;
    address public  agentAddr =  0x15942cBc1405CFA887e7bA919485FfE388BE7E4c;

    uint256 private _tFeeTotal;

    string private _name = "HXT";
    ...
    uint256 private _tTotal =52000 * 10**18;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if( !_isExcludedFromFee[from] &&!_isExcludedFromFee[to]){
            require(amount <= (1*10**18), "Transfer max 1");
