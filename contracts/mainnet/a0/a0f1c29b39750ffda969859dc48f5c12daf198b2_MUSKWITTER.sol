...
/**
  MUSKWITTER - MUSKWITTER TOKEN
  It is a token created to boycott the Twitter fucker Elon Musk.
  To show your reaction, it is enough to buy 1 dollar.
  All funds raised will be used to advertise against Elon Musk.
  Respect to Elon Musk, who screwed Bitcoin, the stock markets, the market.

  We don't have the money to lock in liquidity.
  You can help us lock for 10 years after purchase or donate to the owner.

  Telegram Community: @muskwitter
  Donate BSC (Owner): 0x7DAD3267d080dF3B665030a6961aAcadDd7a02f4
...
contract MUSKWITTER is Context, IERC20, Ownable {
    ...
    string private _name = "MUSKWITTER";
    string private _symbol = "MUSKWITTER";
