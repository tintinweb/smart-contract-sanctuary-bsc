...
contract BeerusShiba  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA96458281a5E019A319fDF922BB17dbc105DCD3a); 
    address payable public Wallet_Dev = payable(0xb026D777E9c7068c8636Ea9902FFB24F8eEcc994);
    ...
    string private constant _name = "BeerusShiba"; 
    ...
    constructor () {
        ...
        _owner = 0xA96458281a5E019A319fDF922BB17dbc105DCD3a;
