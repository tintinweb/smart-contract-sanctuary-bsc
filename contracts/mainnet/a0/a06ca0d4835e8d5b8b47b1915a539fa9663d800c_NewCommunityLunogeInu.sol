...
contract NewCommunityLunogeInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Lunoge INU";
    string private _symbol = "NCLI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67780bA5B8085945eA0c2b21aa959fcF2dd38E6B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x67780bA5B8085945eA0c2b21aa959fcF2dd38E6B); // BuyBack Address
