...
contract ZGH is ERC20, Ownable, Refer {
    ...
    constructor() ERC20("ZGH", "ZGH") {
        ...
        lpAddress = payable(0xbcaCf3357e985e846c4Af75cEDB2B2d30dcc7eAA);
        marketAddress = payable(0xcbDa1c68BAC8201101d53326BaDC5B50906896D9);
        teamAddress = payable(0xcbDa1c68BAC8201101d53326BaDC5B50906896D9);
        _mint(
            0x624b4BDD4daB2F2cd98FEd993f8cD8ccf3Fa43Fe,
            400 * 10**decimals()
        );
        _mint(
            0x24B593A98c8b70EF2A42f0dc7A0cC9D1fbD41A75,
            400 * 10**decimals()
        );
        _mint(
            0x9176Eb6c5d15a73Bff74Eb032ac68eC3B7F010Ca,
            199 * 10**decimals()
        );
    }
