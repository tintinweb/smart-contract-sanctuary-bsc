...
contract SevenProtocol is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "7 Protocol";
    string constant _symbol ="$7";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0xFaf167467e8dC0D2bAA3C8b86428CFEA313799bd ;
