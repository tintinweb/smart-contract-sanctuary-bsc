...
// ========================================================
// SHEIKH DOGE!
// Telegram – https://t.me/SheikhDogePortal
// Website – https://SheikhDoge.com
// Twitter – https://twitter.com/SheikhDogeCoin
// ========================================================
...
contract RewardsDistributor is IDividendDistributor {
...
contract SheikhDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sheikh Doge";
    ...
    constructor (address _BuyBackReceiver) Auth(msg.sender) {
        ...
        distributor = new RewardsDistributor(address(router));
