...
// Shibes token is a 1 hour Degen token. This is a test contract
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41BA98104dab4406dA12bcaf9383F96f1a6700Ce;
...
contract Shibes is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB195EcD7C0ED186cdd2909ABb988f361BF996F45;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shibes";
    string private _symbol = "SHIBES";
