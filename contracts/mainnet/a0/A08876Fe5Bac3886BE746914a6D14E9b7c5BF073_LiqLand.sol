...
contract LiqLand is Context, IERC20, Ownable {
    ...
    string private _name = "LiqLand";
    string private _symbol = "LIQL";
    ...
    address public _marketingWallet = payable(address(0xae1cE2B3ea3d5D3F191f374f29BaAEfFc75CBBcD));
    address public _rewardWallet = payable(address(0xCDC4E5629c00867b77B54cCb0c0a4Af214596b61));
