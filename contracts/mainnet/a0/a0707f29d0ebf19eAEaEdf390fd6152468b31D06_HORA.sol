...
contract HORA is HORADeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HORATeam;
    address private CharityHORA;
    ...
    string public override name = "HORA";
    string public override symbol = "HORA";
    ...
    constructor(uint totalSupplyValue, address HORATeamAddress, address CharityHORAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HORATeam = HORATeamAddress;
        CharityHORA = CharityHORAAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HORATeam] =  totalSupply * 4 / 100;
        balances[CharityHORA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HORATeam pot
