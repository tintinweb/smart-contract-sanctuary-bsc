...
/**
 *Submitted for verification at BscScan.com on 2022-20-12
*/

/**
The Rabbit Hole Coin
// 100% Supply to Liquidity
TAX: 0% BUY - 0% SELL
THE MYSTERIOUS RABBIT HAS ARRIVED... 
Telegram https://t.me/therabbitholecoin
THE FIRST MEME RABBIT TOKEN DRIVEN BY THE BSC COMMUNITY / #PROBABLYNOTHING by @CryptoMessiahOhOk DYOR
*/
...
contract THERABBITHOLE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC3b3DeAB537D7B9dC412Edabb2D68B6942bd2cF8); 
    address payable public Wallet_Dev = payable(0xC3b3DeAB537D7B9dC412Edabb2D68B6942bd2cF8);
    ...
    string private constant _name = "THE RABBIT HOLE"; 
    string private constant _symbol = unicode"RHOLE"; 
    ...
    constructor () {
        ...
        _owner = 0x6d2A21BC2709694D2513E15370edA9e0b7c3ed45;
