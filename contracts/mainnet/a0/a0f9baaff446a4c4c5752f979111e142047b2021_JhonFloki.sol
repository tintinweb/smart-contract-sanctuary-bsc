...
contract JhonFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("JhonFloki", "JhonFloki") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "JhonFloki";
    string private _symbol = "JhonFloki";
