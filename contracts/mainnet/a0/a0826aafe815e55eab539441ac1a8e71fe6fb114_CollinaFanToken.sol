...
contract CollinaFanToken is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Collina Fan Token";
    string private constant _symbol = unicode"COLLINA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 5000000 * 10**_decimals;

    address payable private DevWallet = payable(0x4d02b63eDbF2Fe4d01d654b382A143f45216f288);
    address payable private MarketingWallet = payable(0xD4131C1E970e8feaCe8E1ef40E90d654B5Dbb0Fd);
