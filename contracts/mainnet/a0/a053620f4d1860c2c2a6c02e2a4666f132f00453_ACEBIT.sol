...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7cde78F763298A1844c316A068AC6032047488f8; 
...
contract ACEBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPACE RABBIT";
    string private _symbol = "ACEBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cde78F763298A1844c316A068AC6032047488f8); 
    address payable public teamWalletAddress = payable(0xA20adF86D4Ca57b813E7D9DEaFA05cD9b9BD68ed); 
