...
contract ERC20 is IERC20 {
    ...
    address busd = 0xfA75692e171fe75BcA9D8B2150f4831E30269312; // live CMG
    // address CMG = 0xfA75692e171fe75BcA9D8B2150f4831E30269312; // testnet CMG
    IERC20 token;
...
contract CMGDIAMOND is Token {
    ...
    uint private constant ADV_FEE           = 1;                   // Base 1% multipled * 7 = 7% total
    ...
    uint private constant SELL_LIMIT        = 100000 ether; 
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x9cCA2B481a0D9fae739C443f79E3095C9b232EA5;  // N
        ADV_1 = 0x34C8b4f60881eE0D62179F77ff539C4Fd68DEC3a;  // 0         
        ADV_2 = 0x34C8b4f60881eE0D62179F77ff539C4Fd68DEC3a;  // E        
        ADV_3 = 0x34C8b4f60881eE0D62179F77ff539C4Fd68DEC3a;  // o     
        FIN_1 = 0x9cCA2B481a0D9fae739C443f79E3095C9b232EA5;  // S   
        MAR_1 = 0xeCE3805698a8FDbdDaea205116dC0807C4ca0706;  // DESB      
