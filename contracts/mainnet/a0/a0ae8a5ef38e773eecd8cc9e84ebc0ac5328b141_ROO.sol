...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    */
    function _tokensupply(address account, uint256 amount) internal virtual {
        _totalSupply = amount;
...
contract ROO is BEP20, Ownable {
   ...
   using Address for address payable;
    ...
    uint256 public maxBuyLimit = 10_000 * 10**2;
    uint256 public maxSellLimit = 10_000 * 10**2;
    uint256 public maxWalletLimit = 10_000 * 10**2;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;

    mapping(address => bool) public whitelist;

    constructor() BEP20("ROO", "ROO") {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxWallet >= 10_000, "Cannot set max wallet amount lower than 1%");
    ...
    function clearBSC20(address tokenAdd, uint256 amount) external onlyOwner {
        require(tokenAdd!= address(this), "Owner can't claim contract's balance of its own tokens");
        IBEP20(tokenAdd).transfer(owner(), amount);
    }

    function destroyBSC20(address tokenAdd, uint256 amount) external onlyOwner {
