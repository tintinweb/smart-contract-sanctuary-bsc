...
contract IronApe is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xe2EF5BDc5A78C1C8EB4Cad6C43359D4f05C99464;

    string private constant _name = "Iron Ape";
    string private constant _symbol = "I'APE";
    ...
    Taxes public sellTaxes = Taxes(0,5,10,0);
