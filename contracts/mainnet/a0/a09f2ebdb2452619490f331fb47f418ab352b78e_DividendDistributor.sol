...
contract fix is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    uint256 public rewardsShare = 30;// seperated from Ca tax for divs 
    //Known Wallets
    ...
    function _buy(
        ...
        uint256 BrewardsAmount = (taxAmount * rewardsShare) / SHAREDIVISOR;
        taxBalance = taxBalance + taxAmount - BrewardsAmount  ;
        liquidity = liquidity + srgAmount;

        try distributor.deposit{value: BrewardsAmount}() {} catch {}
    ...
    function _sell(
        ...
        uint256 SrewardsAmount = (amountTax * rewardsShare) / SHAREDIVISOR;
        uint256 SRGtoSend = amountSRG - amountTax;

         try distributor.deposit{value: SrewardsAmount}() {} catch {}
        //slippage revert
        ...
        taxBalance = isFeeExempt[msg.sender]
            ? taxBalance
            : taxBalance + amountTax - SrewardsAmount;
    ...
    function changeTaxDistribution(
        ...
        require(
            newteamShare + newtreasuryShare + newrewardsShare == SHAREDIVISOR,
