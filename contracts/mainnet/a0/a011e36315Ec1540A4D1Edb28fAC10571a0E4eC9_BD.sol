...
contract BD is ERC20 {
    ...
    address payable _backAddress = payable(address(0xC550E16480788C8619aaa68F9017B8F590F1b2a5));
    ...
    constructor(address tokenOwner) ERC20("brick hand", "bd") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if(from == uniswapV2Pair){
                ...
                require(outTime[from].add(240) < block.timestamp);
