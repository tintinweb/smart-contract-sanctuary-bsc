...
contract inutsuki2 is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2000 * 10**8; //
    string private constant _name = "INUTSUKI 2.0"; // 
    string private constant _symbol = "INUTSUKI2.0"; //    
    uint8 private constant _decimals = 8; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x5A2aeb41ec1A6D872148e49475989B094fdA9330;
