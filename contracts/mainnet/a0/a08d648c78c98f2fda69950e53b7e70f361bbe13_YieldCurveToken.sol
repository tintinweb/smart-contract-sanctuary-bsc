...
contract YieldCurveToken is Context, YieldCurveECO, Ownable {
    ...
    string private _name = 'Yield Curve Frax-F';
    string private _symbol = 'Yield Curve Frax-F';
