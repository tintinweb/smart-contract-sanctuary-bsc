...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x167C7F441ca3211C59f667B4c504Bb499B1448b5;
...
contract Peasants is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa32529aF91742937bAd59D37194B20d7e642208F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string public _name = "PeasantDust";
    string public _symbol = "PD";
