...
// Telegram : https://t.me/ukeleleinu
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract UKELELE  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " UKELELE INU ";
    string private _symbol = " UKINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1f5F8630CF77990b8A78cC1D0f511A25b23E615);
    address payable public teamWalletAddress = payable(0xd1f5F8630CF77990b8A78cC1D0f511A25b23E615);
    ...
    uint256 public _maxTxAmount = 1 * 3000 * 10**_decimals; 
    uint256 public _walletMax = 1 * 3000 * 10**_decimals;
