...
contract CAESAR is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CAESAR";
    string constant _symbol = "CAESAR";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xcCd64bCb908Dc57a1D0B4bC4038A32AD8D4eD87E;
