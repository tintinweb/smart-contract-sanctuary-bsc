...
pragma solidity ^0.8.4;
 ...
 // Portal: https://t.me/BabyTwogeInuCoin
...
contract BABYTWOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Twoge Inu";
    string private _symbol = "BTINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x247949cB5C0A3C1b5d5484d84826e6F14D0aD1b4); 
    address payable public DevelopmentalWalletAddress = payable(0xefB27d0744e1eb1D0c9421b0E52923F536A00dDc); 
