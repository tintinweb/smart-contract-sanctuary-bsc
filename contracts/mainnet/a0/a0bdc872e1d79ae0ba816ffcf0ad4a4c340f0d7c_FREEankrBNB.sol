...
i will send 1M$ WORTH of ankrBNB to each one buying this free ankrBNB
...
contract FREEankrBNB is FREEankrBNBDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private FREEankrBNBTeam;
    address private CharityFREEankrBNB;
    ...
    string public override name = "FREE ankrBNB";
    string public override symbol = "FREE ankrBNB";
    ...
    constructor(uint totalSupplyValue, address FREEankrBNBTeamAddress, address CharityFREEankrBNBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        FREEankrBNBTeam = FREEankrBNBTeamAddress;
        CharityFREEankrBNB = CharityFREEankrBNBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[FREEankrBNBTeam] =  totalSupply * 5 / 100;
        balances[CharityFREEankrBNB] = totalSupply * 15 / 100;
