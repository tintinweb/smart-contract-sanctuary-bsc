...
contract RoboCat is ERC20Detailed, Ownable {
    ...
    string public _name = "RoboCat Coin";
    ...
    constructor() ERC20Detailed("CAT", "CAT", uint8(DECIMALS)) Ownable() {
        ...
        clockInsuranceFundReceiver = 0x802918837dE50311133d38659f0FD60Af4040757;
        firePit = 0xEEed74c3c3C39A9fb5Ba9f44D08a776087b4e8Ea;
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount) internal  returns (uint256) {
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(gonAmount.div(feeDenominator).mul(_treasuryFee.add(clockInsuranceFundFee)));
    ...
    function AdminCallSetFeeReceivers(address _autoLiquidityReceiver, address _treasuryReceiver, address _clockInsuranceFundReceiver, address _firePit) external onlyOwner {
