...
contract DN is Context, IERC20, Ownable {
	...
	// fee list end
	address public ownerAddress = 0x230aCD991d45b8451420c2A3e8C2e4eF061a7955;
    
	address public dragonAddress1 = 0x1F3F39148a58e3Da530611f2BCfbA526fa12dfFB;

    address public dragonAddress2 = 0x251bb74F59d538e43cEBc258e5026d8cAE6bBf14;
	
	address public dragonAddress3 = 0xAD5244D994c7CE63e3ff838eA9247a514a8d2F53;

    address public lpAddress = 0x62b600C7E803B01fca1fB1080291e31B8DF0E51B;

    address public SdragonAddress1 = 0x511A1F30346c9dCAc3D98Ff145e9D693B47AC094;

    address public SdragonAddress2 = 0xA98C3943ec5FB8eBE43B612FF86f50690aE8a02F;
	
	address public SdragonAddress3 = 0xBC8251BD27c0aa38Dbc6879B8943e4d495E5882C;

    address public otherAddress = 0x230aCD991d45b8451420c2A3e8C2e4eF061a7955;

    address public SlpAddress = 0x42513D1511FD59e505D29d6b5323a24d621995d0;
    ...
    uint public minNum = 0; // black last
    ...
    function _toOther(address sender, uint amount) private{
        if (amount > 0){
			_rOwned[otherAddress] = _rOwned[otherAddress].add(amount);
			emit Transfer(sender, otherAddress, amount);
		}
	}
    ...
    function setOtherAddress(address adr) public onlyOwner {
        otherAddress = adr;
    }
