...
interface IERC20 {
     ...
     * transaction ordering. One possible solution to mitigate this LOGIC
...
contract LogicAI is IERC20, Ownable {
    bool public tradingEnabled;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string public constant name = "LogicAI";
    string public constant symbol = "LOGIC";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "LogicAI: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "LogicAI: transaction fee percentage equals 0");
