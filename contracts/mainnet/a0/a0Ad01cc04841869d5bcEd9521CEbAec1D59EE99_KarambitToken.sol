...
contract KarambitToken is Ownable, Governance {
    using SafeMath for uint256;
    using Address for address;

    uint8 private constant _decimals = 18;

    uint256 private constant _initialSupply = 10 * 10**9 * 10**_decimals;
    ...
    constructor() ERC20("Karambit Token", "KRB") {
        _mint(0x6cd817a6DAC917e177B77cb7bD6544eAb91320CC, _initialSupply);
    }
