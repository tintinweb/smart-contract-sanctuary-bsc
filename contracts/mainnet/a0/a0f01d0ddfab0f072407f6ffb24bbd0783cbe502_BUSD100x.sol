...
contract BUSD100x {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 10 ether;				// 10 BUSD
	uint[] public					REFERRAL_PERCENTS				= [10, 5, 2, 1, 1];	    // 1% 0.50% 0.20% 0.10% 0.10%
	uint constant public			PROJECT_FEE						= 40;					// project fee 4% of deposit
	...
	uint constant public			INSURANCE_PERCENT				= 50;					// insurance fee 5% of claim
	uint constant public			INSURANCE_LOWBALANCE_PERCENT	= 250;					// protection kicks in at 25% or lower
	uint constant public			REINVEST_PERCENT				= 20;					// auto reinvest 2% of claim
	...
	constructor(address payable _walletProject, address payable _walletDev) {
		...
		PLANS.push( TPlan(12,100) );
		PLANS.push( TPlan(13,100) );
		PLANS.push( TPlan(14,100) );
		PLANS.push( TPlan(15,100) );
		PLANS.push( TPlan(16,100) );
		PLANS.push( TPlan(17,100) );
		PLANS.push( TPlan(18,100) );
		PLANS.push( TPlan(19,100) );
		PLANS.push( TPlan(20,100) );
