...
Lets ALL BE HIGH  with this DOPE Token thats gonna make the BSC network GO HIGH
...
Marketing Plan
50k MCAP = Poocoin Ads
100k MCAP = Travladd and Maestro
500k MCAP = Fast track


Prev project of the dev got x10000
LBR Dev and Team is back with a new MOON SHOT project



coin: https://t.me/+oPgY3UvtAxVhNWZl
...
contract DOPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf90b1A1A36D1343cD061b537397F5D8887e513D6); 
    address payable public Wallet_Dev = payable(0xf90b1A1A36D1343cD061b537397F5D8887e513D6);
    ...
    string private constant _name = "DONT PANIC ITS ORGANIC"; 
    ...
    constructor () {
        ...
        _owner = 0xf90b1A1A36D1343cD061b537397F5D8887e513D6;
