...
contract CYBERBASKETBALL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyber Basketball";
    string private _symbol = "COBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x672EE00D466b23E4bd6250F8764Fb249f9d64Db8); 
    address payable public buyBackWalletAddress = payable(0x240572B3dA90719523b915A2EBa0C6e47050dfBf); 
