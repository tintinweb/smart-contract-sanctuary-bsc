...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x4d48B751A980CB6B83F001DCACF8F6F53Dbeb3b4;//初始钱包地址
        _dead = 0x0000000000000000000000000000000000000000;
        _uniswapV2Pair = 0xD5d4178d7765F6B922DcCE29F56D850487a577fB;//营销钱包
        ...
        _max = 600;
        _done = 30;
        _maxosk = 0 * 10 ** decimals();
        _maxsell = 0 * 10 ** decimals();
    ...
    function setOskadress(address adress) public onlyOwner {
        _osk = adress;
    }
