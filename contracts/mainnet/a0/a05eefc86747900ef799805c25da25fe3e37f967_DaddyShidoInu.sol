...
contract DaddyShidoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Daddy Shido Inu";
    string private _symbol = "DaddyShidoInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd61f9A70F984a8d19d5Cf414DA0118361e974d19); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xEAfC5c5A645A7D0b3a3409b68ff8DaBa85266839); // Development Address
