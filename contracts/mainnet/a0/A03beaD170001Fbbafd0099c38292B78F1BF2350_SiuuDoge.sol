...
Telegram > https://t.me/SiuuDoge

Webiste > https://siuudoge.com

Twitter > https://twitter.com/SiuuDoge
...
contract SiuuDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "SiuuDoge";  
    string private constant _symbol = "SIUUDOGE";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _SiuuFee = 3; 
    uint256 public _MarketingFee = 4; 
    address public  _marketing = 0x9C91450Dc2d66e1AA6D6E1578E402e7a01Fe6aD9;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        uint256 marketingFee = amount * _SiuuFee / 100; 
        uint256 liquidityFee = amount * _MarketingFee / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _MarketingFee / (_SiuuFee + _MarketingFee);
