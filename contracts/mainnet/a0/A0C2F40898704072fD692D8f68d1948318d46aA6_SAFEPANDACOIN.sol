...
//🌐🐼Introducing SafePanda:
//🌐safepanda, a defi utility  token with a strong  focus on community
//🌐🐼The goal of safepanda is to bring Pandalovers from all over the world together to the moon. Together you achieve financial freedom - all through 🐼

//🌐telegram:https://t.me/SafePanda_BSC
...
contract SAFEPANDACOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safe Panda coin"; // 
    string private constant _symbol = "SAFEPANDA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x50c63a86442e3dD38a08f58a19ca890063103e28;
