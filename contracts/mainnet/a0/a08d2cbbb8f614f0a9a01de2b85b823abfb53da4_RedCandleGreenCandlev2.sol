...
/**
RedCandleGreenCandlev2 SmartContract 
*/
...
contract RedCandleGreenCandlev2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RedCandleGreenCandlev2DividendTracker public dividendTracker;
    ...
    constructor() ERC20("RedCandleGreenCandlev2", "RCGCv2") {
        ...
        dividendTracker = new RedCandleGreenCandlev2DividendTracker(payable(this), router, 0x17Bd2E09fA4585c15749F40bb32a6e3dB58522bA,
                                                   "RedCandleGreenCandlev2TRACKER", "RCGCv2TRACKER");
...
contract RedCandleGreenCandlev2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    RedCandleGreenCandlev2 public RedCandleGreenCandlev2Contract;
    ...
    constructor(address payable mainContract, address router, address token, string memory _name,
        ...
        defaultToken = token;
        RedCandleGreenCandlev2Contract = RedCandleGreenCandlev2(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(false, "withdrawDividend disabled. Use the 'claim' function on the main RedCandleGreenCandlev2 contract.");
    }
    ...
    function _reinvestDividendOfUser(address account) private returns (uint256) {
        ...
        if (_withdrawableDividend > 0) {
            ...
            address[] memory path = new address[](2);
            path[0] = uniswapV2Router.WETH();
            path[1] = address(RedCandleGreenCandlev2Contract);

            uint256 prevBalance = RedCandleGreenCandlev2Contract.balanceOf(address(this));
            ...
            {
                uint256 received = RedCandleGreenCandlev2Contract.balanceOf(address(this)).sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RedCandleGreenCandlev2Contract.transfer(account, received);
                } 
                else {
                    success = false;
                }
