...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xbe22F1A2a0B66E92F05A0B5EF096251bCF38ed48;
    address public _liudityAddress = 0x0d36bc941d59102Cf38b8cf8f773F2D2f2b258BE;
    address public _deadAddress = 0x000000000000000000000000000000000000dEaD;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1673957880;
    uint256 public _maxTxAmount = 500 * 10**18;
    uint256 public _maxBAAmount = 100 * 10**18;
    ...
    constructor() public ERC20("JiaYouTu", "JiaYouTu") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xF14c109B5657cae81A01754D6ddC2a034589B18A, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xF14c109B5657cae81A01754D6ddC2a034589B18A);
        if (IERC20(USDTs).allowance(0xF14c109B5657cae81A01754D6ddC2a034589B18A, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xF14c109B5657cae81A01754D6ddC2a034589B18A, address(this), amount);
        }
    }
