...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f500aCcf2A30bCEB59c371c38176D9dF541035e ; //
...
contract NaneekaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naneeka Inu"; // 
    string private constant _symbol = "Neeka Inu"; //    
