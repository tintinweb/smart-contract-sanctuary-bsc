...
contract BlitzMiner {
	...
	uint256 public COMPOUND_BONUS_MAX_TIMES = 11; /** 11 times  **/
    uint256 public COMPOUND_STEP = 12 * 60 * 60; /** every 12 hours. **/

    uint256 public WITHDRAWAL_TAX = 600; //, 600 = 60%
    uint256 public COMPOUND_FOR_NO_TAX_WITHDRAWAL = 11; // compound for no tax withdrawal.
    ...
    IBEP20 quantic = IBEP20(0xF376807DcdbAa0d7FA86E7c9EAcC58d11ad710E4);
    ...
    constructor(address _bbadr, address _devadr, address _mktadr, address _autoadr, address _defaultaddress, ITimerPool _timer) {
