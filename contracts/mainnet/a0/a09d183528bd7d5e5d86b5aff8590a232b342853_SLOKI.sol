...
contract SLOKI is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    address public marketingWallet = 0xae727566C74692906ed68D543A6EaE16E04d89ff;
    ...
    function changeIsWhitelisted(address holder, bool whitelist)
        external
        onlyOwner
    {
        isWhitelisted[holder] = whitelist;
    }
    ...
    function _buy(
        ...
        require(tradeOpen || isWhitelisted[buyer], "Trading is not Open");
    ...
    function changeTaxDistribution(
        ...
        require(
            newteamShare + newmarketingShare  + newRewardShare ==
                SHAREDIVISOR,
