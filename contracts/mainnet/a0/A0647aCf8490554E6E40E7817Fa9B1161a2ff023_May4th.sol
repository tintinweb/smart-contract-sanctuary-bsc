...
/**
TELEGRAM : https://t.me/MAY4THTOKEN
...
May 4th Token is a self sustaining token that has auto-burn and auto liquidity feature.
Overtime the value of the token will increase due to its functions.

It will be stealth launched 50% of the total supplies will be burned prior to launch.
...
contract May4th is Context, IERC20, Ownable {
    ...
    string private _name = "May4th Token";
    string private _symbol = "MAY4TH";
