...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5b7380B33F47E8378eC00a2844fCB44b48636C1;
...
contract TIPEtoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiger Pepe";
    string private _symbol = "TIPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf5b7380B33F47E8378eC00a2844fCB44b48636C1);
    address payable public teamWalletAddress = payable(0xf5b7380B33F47E8378eC00a2844fCB44b48636C1);
