...
contract HD is Context, IERC20, Ownable {
    ...
    string private _name = "HD";
    string private _symbol = "HD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x154CdDEe26e7b2378c169e235fC8d4a5B5063265); // Marketing Address
    address payable public teamWalletAddress = payable(0x154CdDEe26e7b2378c169e235fC8d4a5B5063265); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2100 * 10**3; 
