...
/*
CLEER CHAIN
Cleer is designed to offer complete
interoperability between both the cleer.
Interoperability is not limited to digital 
assets as it also includes cross-chain 
interoperability for data sets. Data 
can be shared across different types of blockchains,
 including private, permissioned and public chains.

https://cleer-chain.live/
https://t.me/cleerchain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80A3579A1398DE24bc06fCD2AbC3742642648c72;
...
contract CleerChain is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x80A3579A1398DE24bc06fCD2AbC3742642648c72);
    ...
    */
    ...
    string private _name = "CleerChain"; 
    string private _symbol = "CleerChain";  
