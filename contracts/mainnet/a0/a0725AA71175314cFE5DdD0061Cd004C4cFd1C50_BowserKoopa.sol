...
* Bowser Koopa (BOWSER)
*
* 8% tax: 4% LP 4% marketing and buyback
* 10000 supply
*   350 max tx
*
* https://t.me/bowserkoopabsc
*/
...
contract BowserKoopa is IBEP20, Auth {
    using SafeMath for uint256;

    string _name = "Bowser Koopa";
    string _symbol = "BOWSER";
    ...
    uint256 public _maxTxAmount = 350 * 10**_decimals;
    uint256 public _maxWallet = 350 * 10**_decimals;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        {
            require(_balances[recipient].add(amount) <= _maxWallet);
        }
