...
*/
 /** 
    Daddy BitBurnReflect

    Missed BitBurnReflections?? Daddy BitBurn is here to make sure you don't miss anything! 
    Like every great daddy, he's giving it away! 
    Earn BitBurnReflect passively while he PUMP's UP the VOLUME!!

// TG: https://t.me/DaddyBitBurnReflect
...
contract DaddyBitBurnReflect is ERC20 {

    uint tokenTotalSupply = 2000000000; // 2 Billion Token Supply

    constructor() public ERC20("DaddyBitBurnReflect", "DaddyBitBurnReflect") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "DaddyBitBurnReflect";
    string private _symbol = "$DBBR";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x8B6bF63e2b1C221dC0Fb01AE85868b83dDee1B54, 'We can not exclude Uniswap router.');
