...
contract supermoonzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "supermoonzilla";
    string private _symbol = "supermoonzilla";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 10;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4E79aA42bE9f0E3CbDd64EC2D516947180ea1b5d); // Marketing Address
    address payable private teamWalletAddress = payable(0x3Fe78CdA285Bcc1eD137Bc2ae0056FC0DfF42861); // Team Address
