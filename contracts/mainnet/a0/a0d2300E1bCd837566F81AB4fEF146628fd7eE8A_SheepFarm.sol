...
contract SheepFarm is Ownable {
    ...
    uint256 public totalSheeps = 6620;
    uint256 public totalFarms = 5034;
    uint256 public totalInvested = 184482200000000000000; //Amount invested before the Correction
    uint256 private _truckPrice1 = 2500;
    uint256 private _truckPrice2 = 5000;
    uint256 public referSheepPercent = 1;
    uint256 public referCashPercent = 20;
    ...
    function setReferCashPercent(uint256 _referCashPercent,uint256 _referSheepPercent) public  onlyOwner {
        referCashPercent = _referCashPercent;
        referSheepPercent = _referSheepPercent;
    }
