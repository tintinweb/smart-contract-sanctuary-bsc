...
TG: https://t.me/UltimatenetworkOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x279f13B686Ae2a4d562a078b46099Da94A103735; // owner address
...
contract Ultimatenetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Ultimate Network";
    string private _symbol = unicode"ULTIMATE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x279f13B686Ae2a4d562a078b46099Da94A103735); // Marketing Address
    address payable public teamWalletAddress = payable(0x279f13B686Ae2a4d562a078b46099Da94A103735); // Team Address
