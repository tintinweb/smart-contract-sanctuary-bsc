...
contract CommunityXmas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0280ec5652c0245E877Fad9DBEf340483038d3C0); // Marketing Address
    ...
    string private _name = "CXMAS";
    string private _symbol = "CXMAS";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x0280ec5652c0245E877Fad9DBEf340483038d3C0);
    }
