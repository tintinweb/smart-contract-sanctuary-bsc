...
contract PepaFools is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepa Fools";
    string private _symbol = "PEPAFOOLS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x2f98CFE12Ce4856e73B1876f9b179de1150E6671); // Marketing Address
    address payable public teamWalletAddress = payable(0x2f98CFE12Ce4856e73B1876f9b179de1150E6671); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x0bD5345D955d37DCF9dDe1178DCf23864ED20625),
            block.timestamp
        );
    }
