...
/* 
🎱DEXBASE🎱
https://t.me/DEXBASEBSC
✅Contract Address : 0xa05AD97465eEFDbF3cAF44e2087C4F6f47CEb823
💰https://poocoin.app/tokens/0xa05ad97465eefdbf3caf44e2087c4f6f47ceb823
🎱LP LOCK
🎱Safe 
🎱Tax 3%
🎱Rewards 3 % $DEXBASE
...
abstract contract ContextBep99 {
...
contract OwnableBep99 is ContextBep99 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBep99: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBep99: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DEXBASEtoken is ContextBep99, Bep99, OwnableBep99 {
    ...
    string private _name = 'DEXBASE';
    string private _symbol = 'DEXBASE';
