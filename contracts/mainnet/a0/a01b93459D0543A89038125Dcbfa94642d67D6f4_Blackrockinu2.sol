...
//OWNERSHIP RENOUNCED
//LP LOCKED
//JOIN TG https://t.me/Blackrockinu2 WILL BE OPENED AT 100 MEMBERS
...
contract Blackrockinu2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB3513d559D9FD4Dbc3f9B6e5903853D73000E012); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x47826d2985b295587EC608c0bECa5743A182A8F5);
    ...
    string private constant _name = "Blackrock inu 2.0"; 
    string private constant _symbol = unicode"BRINU2";
    ...
    constructor () {
        ...
        _owner = 0x47826d2985b295587EC608c0bECa5743A182A8F5;
