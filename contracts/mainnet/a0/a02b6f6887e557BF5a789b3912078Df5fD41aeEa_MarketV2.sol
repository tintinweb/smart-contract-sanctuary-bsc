 ...
 *    when users sell Chaos, part of it will be used to repay the debt for the treasury
    ...
    IMarketV2
{
        ...
        isStarted
    {
        ...
        IERC20(token).transferFrom(_msgSender(), address(this), worth);
    ...
    {
        require(worth1e18 > 0, "Market: worth1e18 is zero");
        worth = Math.convertDecimalsCeil(
            worth1e18,
            18,
            stablecoinsDecimals[token]
        );
        require(worth > 0, "Market: worth is zero");
        IERC20(token).transferFrom(user, address(this), worth);
        decreaseDebt(worth1e18);
        ...
        )
    {
        ...
        if (newPrice > _c) {
            ...
            worth1e18 =
                ...
                (2 * _k * 1e18);
            // Chaos purchased through bonds will be deducted part of the cost
        ...
        )
    {
        ...
        IERC20(token).safeTransferFrom(user, address(this), worth);
        pool.massUpdatePools();
        Chaos.mint(_msgSender(), amount - fee);
        Chaos.mint(dev, fee);
