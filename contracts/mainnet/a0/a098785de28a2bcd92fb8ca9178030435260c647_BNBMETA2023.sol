...
contract BNBMETA2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB META 2023"; // 
    string private _symbol = "BNBMETA2023"; // 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33aF2dCB006eeB4bAbECb718AdD16740DeaCfaFd); // 
    address payable public teamWalletAddress = payable(0x33aF2dCB006eeB4bAbECb718AdD16740DeaCfaFd); // 
