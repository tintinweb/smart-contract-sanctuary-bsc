...
/* RolexToken -  The Best meme of the year on BSC.
   website: https://rolextoken.info/ 
...
contract RolexToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA6f78AE0Dec72167b5E5c6d9956f9ad8BC7128eA); // Marketing Address
    address payable public charityAddress = payable(0xA6f78AE0Dec72167b5E5c6d9956f9ad8BC7128eA); // Charity/Dev Address
    ...
    string private _name = "RolexToken";
    string private _symbol = "ROLEX";
