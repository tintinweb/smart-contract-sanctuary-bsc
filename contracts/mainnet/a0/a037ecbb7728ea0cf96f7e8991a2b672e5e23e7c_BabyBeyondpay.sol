...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BPAY = IBEP20(0x516314b6061D484cEf8ACbCe802ae0e5a2000db3);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BPAY.balanceOf(address(this));
        ...
        uint256 amount = BPAY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BPAY.transfer(shareholder, amount);
...
/* Token contract */
contract BabyBeyondpay is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BPAY =  0x516314b6061D484cEf8ACbCe802ae0e5a2000db3; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "BabyBeyondpay";
    string constant _symbol = "Baby Beyondpay";
