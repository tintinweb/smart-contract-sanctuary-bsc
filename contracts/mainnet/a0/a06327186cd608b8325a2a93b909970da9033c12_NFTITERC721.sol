...
import "./NFTITAccessControl.sol";
import "./ERC2981PerTokenRoyalties.sol";

contract NFTITERC721 is
    Initializable,
    NFTITAccessControl,
    ...
    ERC2981PerTokenRoyalties
{
    ...
    function initialize(
        ...
        __NFTITAccessControl_init(_whitelistAddresses);
...
contract NFTITAccessControl is Initializable, ContextUpgradeable {
    ...
    function __NFTITAccessControl_init(address[] memory _whitelist)
        internal
        initializer
    {
        __Context_init_unchained();
