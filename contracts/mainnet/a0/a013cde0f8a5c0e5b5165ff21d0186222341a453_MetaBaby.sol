...
contract DividendDistributor is IDividendDistributor {
        ...
        returns (bool)
    {
        return
            ...
            mbabyToken.balanceOf(shareholder) > minBalanceToGetReward;
    }
...
contract MetaBaby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address DEAD = 0x000000000000000000000000000000000000dEaD;

    address payable public marketingAddress = payable(0xb4740ef503A154eB4eF867f493f1F6E9b84aE249); // Marketing Address
    address payable public burnAddress = payable(0xF11Cd2de0e13b8a9f0F8a4975b4eC0a3E0A2233c); // Reward Address. zero address so will burn.
    address payable public liquidityAddress = payable(0x000000000000000000000000000000000000dEaD); // Liquidity Address
    address payable public devAddress = payable(0xbea2a092bB34F76cd92d6f1Ca1DBa80f8d4d3991); // dev address
    ...
    string private constant _name = "Meta Baby";
    string private constant _symbol = "MBABY";
