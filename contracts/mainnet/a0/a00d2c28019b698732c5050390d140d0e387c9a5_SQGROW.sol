...
/**
TOKEN NAME: Squid Queen Grow
TICKER: SQGROW

What is Squid Queen Grow? 
Squid Queen Grow is based off the "grow" & "Squid" meta currently going around the cryptocurrency space.
Safe project on the binance smart chain network launched by an expierenceed team with massive connections in the cryptocurrency space.
Invest.  Hold.  Wait for the time to come.  Then reap the rewards of an amazing adventure!
Grab a bag, chill and have fun growing your portfolio and hanging with our community! 
Hold and wait for the time to come. Then reap the rewards of an amazing experience + adventure!
Don't get too greedy, always take profits responsibly along the way and NEVER invest more then you can afford to lose.
New tokens with low liquidity have "high risk high reward", but that doesn't mean tbat it can't go anywhere... at the end of the day, as long as the community is doing their part, this developer will go above and beyond to smash a higher market cap.
If you ask when "marketing" your portfolio will be cursed for 15 years.
Developer is a young american cryptocurrency influencer with past experience of running tokens from one thousand market cap to over three hundred million market cap.
...
Telegram: https://t.me/SquidQueenGrow
Twitter:  https://twitter.com/SquidQueenGrow
*/
...
contract SQGROW is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 1; // 1.5% of supply
    uint256 public maxTxAmountSell = _tTotal / 1; // 1.5% of supply
    uint256 public maxWalletAmount = _tTotal / 1; // 1.5% of supply
    ...
    string private constant _name = "Squid Queen Grow";
