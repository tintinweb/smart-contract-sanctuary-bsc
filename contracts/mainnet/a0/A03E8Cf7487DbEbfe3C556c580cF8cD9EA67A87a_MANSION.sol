...
/* Token contract */
contract MANSION is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3C880011a3DAE3e6d340991253a81754871c77D8; // Wallet Developer
    ...
    // Name and symbol
    string constant _name = "SPOOKY MANSION";
    string constant _symbol = "MANSION";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2 Millions
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1 Millions
    ...
    uint256 public marketingFeeBuy = 2; // Calls Marketing Telegram Future
    ...
    uint256 public reflectionFeeSell = 6; // Rewards Holders
    uint256 public marketingFeeSell = 7; // Calls Marketing Telegram Future
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3C880011a3DAE3e6d340991253a81754871c77D8; // Wallet Marketing Work
