...
contract VENUS is ERC20 {
	...
	address private _poolAddress = address(0xd828ca6510f1590957EA1D4228C13314DE443998);
    address private _jsAddress = address(0xBBEf52ca929308B484413C43e5b3479Af699024e);
    address private _marketAddress = address(0x8da077e9c304dD9a01c63b1ce483e2e4fBCcF099);
    address private _nodeAddress = address(0x723c8De34244f0E67d3A869c7414D65b4609ff58);
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			if(from == uniswapV2Pair){
				...
				super._transfer(from, _poolAddress, amount.div(100));
	...
	function swapAndLiquify() public {
		...
		uint256 usdtAmount = ETH.balanceOf(address(this));
		...
		if(allAmount > usdtAmount){
			...
			ETH.transfer(_marketAddress,newAmount.div(30).mul(12));
            ETH.transfer(_jsAddress,newAmount.div(30).mul(3));
            ETH.transfer(_nodeAddress,newAmount.div(30).mul(7));
		}
    }
