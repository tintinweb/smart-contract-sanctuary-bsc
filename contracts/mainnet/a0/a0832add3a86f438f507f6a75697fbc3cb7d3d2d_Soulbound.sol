...
contract Soulbound is Context, IERC20, Ownable {
    ...
    string private _name = "Soulbound2.0";
    string private _symbol = "Soulbound2.0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x970E58840fa0b7211499461F50a61842CE763eAB); // Marketing Address
    address payable public teamWalletAddress = payable(0x764CDDFcAb11251989F65Ed97175D8E3d4e4dCA6); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x9799222a3D17d5F2fa8Aa71Fb269f0357f023eFD),
            block.timestamp
        );
    }
