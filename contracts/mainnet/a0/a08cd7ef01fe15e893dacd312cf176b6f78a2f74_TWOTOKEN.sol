...
contract TWOTOKEN is IBEP20, Auth {
    ...
    string constant _name = "TWOTOKEN";
    string constant _symbol = "2T";
    ...
    address public marketingFeeReceiver = 0x65e97fFaFc80d3e851bfEE28fD823C142e364f5e;
    address public devFeeReceiver = 0x65e97fFaFc80d3e851bfEE28fD823C142e364f5e;
    ...
    uint256 public swapThreshold = 1 * (10 ** _decimals); // 0.25%
    bool inSwap;
