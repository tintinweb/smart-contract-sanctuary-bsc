...
contract BABYAPEGROW is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Ape Grow";
    string constant _symbol = "$BAG";
    ...
    address public marketingFeeReceiver = 0x0CC8D615eaFdBB8F5E90C602aeD01dCEBcafcFF0;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x0CC8D615eaFdBB8F5E90C602aeD01dCEBcafcFF0] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x0CC8D615eaFdBB8F5E90C602aeD01dCEBcafcFF0] = true;
