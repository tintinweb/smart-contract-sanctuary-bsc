...
/**
TELEGRAM https://t.me/FateInuPortal
TWITTER https://twitter.com/FateInuBSC
*/
/**
🌆 Fate Inu
inspired by the MANGA entitled Fate stay night. 

Fate inu is a token meme with a unique utility,
and with the name of the hype MANGA,FATE INU will be big with a strong community and strong hold,
join this wonderful journey together!
...
contract FATEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fate Inu";
    string private constant _symbol = "FATEINU";
    ...
    address private marketingWallet = address(0x2f940e8eac6BdA81Ee60BE5295802758b614A4fA);
    address private liquidityReceiver = address(0x2f940e8eac6BdA81Ee60BE5295802758b614A4fA);
