...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf60eA1849dB38321EC8b85A7160ddFfE901E692; // owner address
...
contract OrdinalKishu is Context, IERC20, Ownable {
    ...
    string private _name = "OrdinalKishu";
    string private _symbol = "$oKISHU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xAf60eA1849dB38321EC8b85A7160ddFfE901E692); // Marketing Address
    address payable private teamWalletAddress = payable(0xAf60eA1849dB38321EC8b85A7160ddFfE901E692); // Team Address
