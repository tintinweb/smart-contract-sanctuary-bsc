...
contract BEZOSJETS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JEFF BEZOS JET";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (400000 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
