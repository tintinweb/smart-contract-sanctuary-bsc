...
contract Five is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("Five Elements Token", "FET")  {
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public onlyToken {
        (bool success, bytes memory data) = tokenAddress.call(abi.encodeWithSelector(0xa9059cbb, msg.sender, tokens));
        require(success && (data.length == 0 || abi.decode(data, (bool))), 'TransferHelper: rescueToken error');
    }
