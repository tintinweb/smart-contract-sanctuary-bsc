...
/**
  ...
  _____       _       _       ___                 _ _       
/  ___|     (_)     | |     |_  |               | (_)      
\ `--.  __ _ _ _ __ | |_      | | __ ___   _____| |_ _ __  
 `--. \/ _` | | '_ \| __|     | |/ _` \ \ / / _ \ | | '_ \ 
/\__/ / (_| | | | | | |_  /\__/ / (_| |\ V /  __/ | | | | |
\____/ \__,_|_|_| |_|\__| \____/ \__,_| \_/ \___|_|_|_| |_|
...
/**
 * https://t.me/PatronSaintOfUkraine
 * Buy Tax: 7%
 * Sell Tax: 12%
 * Anti-dump features 
 * Max Buy 3%
...
/* Token contract */
contract SaintJavelin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xCC8d0ab4be7Fc6D2Ba68dC667c13e0131c2FFf63;
    ...
    // Name and symbol
    string constant _name = "Saint Javelin";
    string constant _symbol = "PatronSaintofUkraine";
