...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "reborndoge";
    string private _symbol = "reborndoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4f5Ff6A679d052ad568E666b15B9476e1dffA9d3); // Marketing Address
