...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaC200daB5Fe38A4A00ef47f63C92442bA74E5665; // owner address
...
contract MikuGrow is Context, IERC20, Ownable {
    ...
    string private _name = "MIKUGROW";
    string private _symbol = "MG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC671dC9b48ffc08B030Fad246a46A53E90390973); // Marketing Address
    address payable public teamWalletAddress = payable(0xC671dC9b48ffc08B030Fad246a46A53E90390973); // Team Address
