...
contract ELONMINATI is Context, IERC20, Ownable {
    ...
    string private _name = "ELONMINATI";
    string private _symbol = "ELMNTI";
    ...
    uint256 public _totalTaxBuy = 2;

    uint256 public _marketingFeeSell = 2;
    uint256 public _burnFeeSell = 0;
    uint256 public _totalTaxSell = 2;

    uint256 private _totalSupply = 10000 * 10**18;
    uint256 public _maxTxAmount = 10000 * 10**18;
    uint256 public _walletMax = 10000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 60 * 10**18; 
    ...
    constructor() {
        ...
        marketingWallet = 0xFF6F839C31a69CB4e2dc36Df8794a1d9E0B174dc;
    ...
    function setTax(uint256 burnBuy, uint256 marketingBuy, uint256 burnSell, uint256 marketingSell) external onlyOwner {
        require(burnBuy + marketingBuy <= 99 && burnSell + marketingSell <= 99);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            {
                if (contractTokenBalance > minimumTokensBeforeSwap.mul(3))
                {
                    contractTokenBalance = minimumTokensBeforeSwap.mul(3);
                }
