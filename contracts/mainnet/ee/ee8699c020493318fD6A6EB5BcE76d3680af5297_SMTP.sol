...
contract SMTP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0xeB38f1e3182b733F225C82f35D96AD1a6F6686C7); 
    address payable public developmentAddress = payable(0xeB38f1e3182b733F225C82f35D96AD1a6F6686C7); 
    address payable public charityAddress = payable(0xeB38f1e3182b733F225C82f35D96AD1a6F6686C7); 
    address payable public vaultRewardAddress = payable(0xeB38f1e3182b733F225C82f35D96AD1a6F6686C7); 
    address payable public liquidityWallet = payable(0xeB38f1e3182b733F225C82f35D96AD1a6F6686C7); 
    ...
    string private constant _name = "SourceMainTech";
    string private constant _symbol = "SMTP";
