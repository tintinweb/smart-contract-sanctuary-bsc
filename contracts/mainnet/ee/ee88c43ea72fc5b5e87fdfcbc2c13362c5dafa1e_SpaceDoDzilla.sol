...
contract SpaceDoDzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceDoDzilla";
    string private _symbol = "SpaceDoDzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x40F93D851eEf8A3BB706399Ff0fc0A7ff8cB94C4);
    address payable public teamWalletAddress = payable(0x40F93D851eEf8A3BB706399Ff0fc0A7ff8cB94C4);
