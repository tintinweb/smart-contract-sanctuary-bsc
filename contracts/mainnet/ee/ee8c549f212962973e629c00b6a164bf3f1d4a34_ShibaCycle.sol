...
contract ShibaCycle is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Cycle";
    string private _symbol = "SHCYC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xDc0BDC21765Fb72FCeF4b0056C3adb9392bB5430);
