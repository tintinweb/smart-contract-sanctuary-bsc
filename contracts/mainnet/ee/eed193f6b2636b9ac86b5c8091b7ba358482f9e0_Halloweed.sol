...
contract Halloweed is Context, IERC20, Ownable {
    ...
    string private constant _name = "Halloweed1000x"; // 
    string private constant _symbol = "HWD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x8Dd78C91C35791001F3F6a503A8Ddd85Fc4B67f6;
