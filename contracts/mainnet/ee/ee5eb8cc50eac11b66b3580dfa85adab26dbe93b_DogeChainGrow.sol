...
contract DogeChainGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Chain Grow";
    string private _symbol = "DCG";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xA2c2853B61521C3635c3A92ee81b61481B67a0eC);
