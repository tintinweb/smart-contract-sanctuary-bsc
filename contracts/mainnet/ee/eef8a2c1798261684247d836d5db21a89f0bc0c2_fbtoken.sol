...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x0A80534D81fB5a98D4dc384d4DB7aea206AB7266;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x0A80534D81fB5a98D4dc384d4DB7aea206AB7266),//fund address
    
        address(0x0A80534D81fB5a98D4dc384d4DB7aea206AB7266)//dev address
    ){
