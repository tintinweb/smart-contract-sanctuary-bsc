...
contract PUSSYONU is ERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x367Fe48fD4ce05A886d966990DdE014038f1fBa9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Checks max & min transaction limit
    ...
    function checkTxLimit(address sender, uint256 amount,  address recipient) internal view {
        ...
        if(recipient == pair){
            require(amount >= _minTxAmount, "minimum transaction limit not net");    
        }
    }
