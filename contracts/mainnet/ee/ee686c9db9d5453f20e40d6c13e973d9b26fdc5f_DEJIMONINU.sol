...
contract DEJIMONINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE6EB1bd81Aaaf7a91C1e2Ae09fA759aa6f9263F2); // Marketing Address
    address payable public teamWalletAddress = payable(0x0a7A7cDBfaB48177f9b43307eEeD90D5aB955ed2); // Team Address
    ...
    uint256 public _maxTxAmount = 1997 * 10**_decimals;
    uint256 public _walletMax = 1997 * 10**_decimals;
