...
/**
 *Submitted for verification at BscScan.com on 2022-10-28 Singapore [email protected]
*/

/**
   #PIG
   
   #Twitter+#ETH+#ETHW+#BNB, combine together to #TwitEthw  

    I make this #TwitEthw to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: http://t.me/ethwdaily
   ...
   It could burn liquidity LPs to burn addresses to lock the pool forever.
   It could renounce the ownership to burn addresses to transfer #PIG to the community, make sure it's 100% safe.

   I will add many BNB and all the left 49.5% total supply to the pool
   Let us make #TwitEthw 10000000X!
...
contract TwitEthw is Context, IERC20, Ownable {
    ...
    string private _name = "TwitEthw";
    string private _symbol = "TwitEthw";
