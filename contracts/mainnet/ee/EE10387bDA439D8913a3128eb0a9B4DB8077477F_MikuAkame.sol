...
/**
Welcome to Miku Akame Coin , BSC is now on Anime Season and now here's the opportunity for us to grab it to moon!
Miku Akame gives 3% reflections to every holders while the remaining tax will be use for marketing. 

Miku Akame Tokenomics
3% Marketing
3% Reflections
1% Liquidity

Portal Link : https://t.me/MikuAkame
http://mikuakame.net/
...
*/
    ...
    contract MikuAkame  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Miku Akame";
        string private constant _symbol = "MIKAME";
        ...
        address public constant MarketingWallet=0xd127359EFd9697cb2C554beBA3e84eE9A65CCBbf; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function Reflections(address[] calldata addresses) external onlyOwner {
