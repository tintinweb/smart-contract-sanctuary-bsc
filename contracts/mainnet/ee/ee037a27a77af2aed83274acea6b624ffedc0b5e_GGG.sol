...
contract GGG is Owner {
	...
	function GetListGameIdTTT1(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint) {
		uint[] memory lists;
		uint k=0;
		uint ii=0;
		if(id>(DataId-1)){
	...
	function GetListGameIdTTT12(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint) {
		uint[] memory lists;
		uint k=0;
		uint ii=0;
		if(id>(DataId-1)){
	...
	function GetListGameIdTTT13(uint256 id,uint256 mim_id,uint256 amount,uint256 _GameId) external view returns(uint) {
		uint[] memory lists;
		uint k=0;
		uint ii=0;
		if(id>(DataId-1)){
