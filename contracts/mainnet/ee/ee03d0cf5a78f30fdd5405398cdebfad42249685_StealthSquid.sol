...
Welcome to StealthSquid



TG: https://t.me/StealthSquid
...
contract StealthSquid is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StealthSquid";
    string constant _symbol = "StealthSquid";
    ...
    uint256 public _maxTxAmount = 0.4 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 0.3 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0EaCE02FFf3A4339C1FAc62039AE3Df3e63c342F;
        devWallet = 0xc2F84523FB31283cD8bFd8fc7f627fb53f6c1aE0;
