...
interface IRewarder {
    function onSnowReward(address user, uint256 newLpAmount) external returns (uint256);
...
/**
 * @dev Interface of the MasterSnowflake
 */
interface IMasterSnowflake {
    ...
    function updateFactor(address _user, uint256 _newVeSnowBalance) external;
}