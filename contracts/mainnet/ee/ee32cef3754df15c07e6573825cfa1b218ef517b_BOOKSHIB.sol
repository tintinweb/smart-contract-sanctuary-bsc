...
contract BaseToken is Ownable {
    ...
    string constant public name = 'BookShib';

    string constant public symbol = 'BOOKSHIB';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 8500000000*10**uint256(decimals);
...
contract BOOKSHIB is BaseToken {
