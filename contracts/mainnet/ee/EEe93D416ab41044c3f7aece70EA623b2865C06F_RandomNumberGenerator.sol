...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == GemuniLottery, "Only GemuniLottery");
    ...
    /**
     * @notice Set the address for the GemuniLottery
     * @param _GemuniLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _GemuniLottery) external onlyOwner {
        GemuniLottery = _GemuniLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IGemuniLottery(GemuniLottery).viewCurrentLotteryId();
    }
}
