...
Telegram : https://t.me/DeepLiveCoin
Website : http://deeplive.art
Twitter : https://twitter.com/DeepLIVECoin
*/
...
contract DeepLiveCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Deep Live";
    string private _symbol = "DEEP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x711cc2C02943812031B659C86EfACc1044D98457); 
    address payable public buyBackWalletAddress = payable(0x711cc2C02943812031B659C86EfACc1044D98457); 
    ...
    uint256 public _maxTxAmount = 710000000000000000000; 
