...
contract APEGOLD is Context, IERC20, Ownable {
    ...
    string private _name = "ApeGold Coin";
    ...
    address payable private TeamWallet = payable(0x1A8AD7fdb2e848FdAaA6786f29343FD5772a101F); // Buy Back Address
