...
tg: t.me/flokienewbsc

 Second Generation | It's ENew not Inu! Join the correction today! 
...
contract FlokiENew is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki ENew"; 
    string constant _symbol = "FENew"; 
