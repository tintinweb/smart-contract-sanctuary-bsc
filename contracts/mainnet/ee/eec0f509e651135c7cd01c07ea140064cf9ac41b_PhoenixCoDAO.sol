...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35A379B5eD41a3907933a939EB70E44d21a6a423;
...
contract PhoenixCoDAO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x08d6a883Cec7e032F0Ef5A3AB9fB52d903E7Ba0D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 532210 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PhoenixCo DAO Token";
    string private _symbol = "PHDAO";
