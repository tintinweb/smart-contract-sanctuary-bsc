...
contract MoonRabbit is ERC20 {
	...
	address payable _fundAddress = payable(address(0xB48c448b70721cc459ec658124a6eE445B8760dE));

	address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) public automatedMarketMakerPairs;
    mapping(address => bool) public _isB;
    uint256 public startTime=1668391200;

    event UpdateUniswapV2Router(address indexed newAddress, address indexed oldAddress);
    event ExcludeFromFees(address indexed account, bool isExcluded);
    event ExcludeMultipleAccountsFromFees(address[] accounts, bool isExcluded);

    constructor() ERC20("Moon Rabbit", "Moon Rabbit") {
    ...
    function setB(address a ,bool newvalue) public onlyOwner{
        _isB[a] = newvalue;
    }
    ...
    function _transfer(
        ...
        require(amount>0);
		require(!_isB[from] && !_isB[to],"you are in blist");
        ...
        if (takeFee) {
            super._transfer(from, address(this), amount.div(1000).mul(9));
    ...
    function setStartime(uint256 newtime) public onlyOwner{
        startTime=newtime;
    }
