...
contract SiuuuuDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Siuuuu Doge";
    string private _symbol = "SIUOGE";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x381fb881B5B5966e125F740e18C7318ffDb5212A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1405e48AD926a8A482EC9C8532b593db0f9C72C6); // BuyBack Address
