...
contract Test is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 1 * 10**10 * 10**9;
    uint256 public maxSellAmount = 1 * 10**10 * 10**9;
    uint256 public maxWalletAmount = 1 * 10**10 * 10**9;
    uint256 public buybackLimit = 1 ether;

    address public marketingWallet = address(0x680785aBeb2F4C7894ec71E5D2b75a1eB1cEBC24); //marketing wallet
    address public developmentWallet = address(0x680785aBeb2F4C7894ec71E5D2b75a1eB1cEBC24); //development wallet

    uint16 public transferRewardsFee = 100;
    uint16 public transferLiquidityFee = 0;
    uint16 public transferMarketingFee = 0;
    uint16 public transferDevelopmentFee = 100;
    uint16 public transferBuybackFee = 10;
    uint16 private totalTransferFee = 200; // 2% Transfer fee

    uint16 public rewardsFee = 200; // 8% fee
    uint16 public liquidityFee = 0; // 3% fee
    uint16 public marketingFee = 700; // 1% fee
    uint16 public developmentFee = 0; // 1% fee
    uint16 public buybackFee = 0; // 2% fee
