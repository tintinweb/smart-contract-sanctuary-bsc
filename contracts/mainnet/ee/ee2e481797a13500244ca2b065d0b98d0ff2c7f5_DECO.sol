...
contract DECO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DECODE DAO";
    string private _symbol = "DECO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe0E329eFC3A2a10eA6Ee80500051c25d19BB4875); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe0E329eFC3A2a10eA6Ee80500051c25d19BB4875); // Team Address
