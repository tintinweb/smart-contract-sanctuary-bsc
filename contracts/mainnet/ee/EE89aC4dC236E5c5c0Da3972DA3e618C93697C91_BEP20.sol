...
contract BEP20 is Context, IERC20, Ownable {
    ...
    address public LaFa = address(0xe9C10868BFf4b3Caff67beE86E7ca651203B1a95);
    ...
    address[2] memory _WALLET) 
    {
        ...
        isOnceEatExempt[LaFa] = true;
        isOnceEatExempt[address(this)] = true;

        isMarketPair[address(uniswapPair)] = true;

        _balances[LaFa] = _totalSupply;
        emit Transfer(address(0), LaFa, _totalSupply);
    }
