...
contract ROBOCHIKU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ROBO CHIKU COIN";
    string private _symbol = "ROBOCHIKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70C77bf7a53f40742153324Db37EFE56CEE8157A); 
    address payable public teamWalletAddress = payable(0x70C77bf7a53f40742153324Db37EFE56CEE8157A); 
    ...
    uint256 private _totalSupply = 100000000 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 100000000000000000 * 10**9; 
    uint256 public _walletMax =  100000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 8000000000 * 10**9; 
