...
contract V2Floki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "V2Floki";
    string constant _symbol = "V2F";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3Bbb19180fAC2707971DCb94427C1559E43Cc161;
