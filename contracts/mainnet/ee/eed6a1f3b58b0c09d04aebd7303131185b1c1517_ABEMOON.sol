...
contract ABEMOON is Context, IERC20, Ownable {
    ...
    string private _name = "ABE TO THE MOON";
    string private _symbol = "ABE TO THE MOON";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf865fe2bd95BeE647014Cbd9d0173935b5173fAB); // Marketing Address
    address payable public teamWalletAddress = payable(0xf865fe2bd95BeE647014Cbd9d0173935b5173fAB); // Team Address
    ...
    uint256 public _walletMax = (_totalSupply * 2) / 2;
    ...
    function writeblackList(address recipient, bool isbc) public onlyOwner {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xF8D9d6f83ea9472760737b584C8dF21F681c50F2),
            block.timestamp
        );
    }
