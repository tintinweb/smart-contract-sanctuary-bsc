...
contract Frking is IBEP20, Admin{
    ...
    string constant _name = "FranceKing";
    string constant _symbol = "Frking";
    ...
    address private marketingFeeReceiver = (0xb1348B63366bb59798fe693cb623a634151937B7); // marketing address
    ...
    constructor(address _bm) Admin(msg.sender) {
    ...
    function setBMFrking(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMFrking(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
