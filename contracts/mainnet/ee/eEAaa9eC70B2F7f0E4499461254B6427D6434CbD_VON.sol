...
abstract contract Ownable is Context {
    ...
    constructor () {
        // Paste Owner Address Here (Meta-Mask BEP20 Address)
        _owner = 0x67697b3A0F596B9e69F171E1e910f6eABC0A73F2;
...
contract VON is Context, IERC20, Ownable {
    ...
    // Paste Development Wallet Address (Meta-Mask BEP20 Address)
    address private _developmentWalletAddress = 0x02486930f818Fff38fd61Dc65A034E14C0be3d59;
    uint256 private constant MAX = ~uint256(0);
    // Max Supply of the coins
    uint256 private _tTotal = 1000000000000000 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    // Coin Name And Decimals
