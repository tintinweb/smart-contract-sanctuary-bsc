...
contract TEDDYDogeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TEDDYDogeKing";
    string private _symbol = "TEDDYDogeKing";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x03ec0c38E7769a43d4Eccc9002B06BFCcc70C493); 
    address payable public ttWal = payable(0x03ec0c38E7769a43d4Eccc9002B06BFCcc70C493); 
