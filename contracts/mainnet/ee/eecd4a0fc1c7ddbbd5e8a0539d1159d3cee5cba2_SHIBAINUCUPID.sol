...
contract SHIBAINUCUPID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBA INU CUPID";
    string private _symbol = "SIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35d7621Fa36c4aA2AbBc86f99CE8d46EdcB909c1);
    address payable public teamWalletAddress = payable(0x35d7621Fa36c4aA2AbBc86f99CE8d46EdcB909c1);
