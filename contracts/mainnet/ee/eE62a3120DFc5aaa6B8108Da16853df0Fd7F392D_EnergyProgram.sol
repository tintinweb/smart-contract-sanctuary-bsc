...
contract EnergyProgram is IERC20 {
    ...
    string constant private _name = "Energy Program";
    string constant private _symbol = "EPM";
    ...
    uint256 constant public maxRoundtripTax = 900;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xE3424D247730C7A2D47Cc36597E6F4e6BDCfD091),
        charity: payable(0x4fe8aee7Ef694252ce526832f3540A19dEa5A73E)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 charity, uint16 marketing) external onlyOwner {
