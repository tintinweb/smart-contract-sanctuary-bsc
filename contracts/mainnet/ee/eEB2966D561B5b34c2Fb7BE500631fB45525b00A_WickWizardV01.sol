...
contract WickWizardV01 is Ownable, Pausable, ReentrancyGuard, ExtraModifiers, EtherTransfer {
    ...
    uint256 public rewardRate = 970;                 // Percents
    ...
    constructor(address newOperatorAddress, address newDevAddress, string memory newPriceSource) {
    ...
    {
        _safeTransferBNB(devAddress,  value);
    }

        function FeedOperator(uint256 value) external onlyOwner 
    {
        _safeTransferBNB(operatorAddress,  value);
    }
