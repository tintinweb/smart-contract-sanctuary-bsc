...
/**
    ...
    //SQUIDGROWYATCHCLUB
        ...
        The hottest hyper-deflationary  coin on the market.  
        A community of diamond handed crypto enthusiasts who are tired of getting burnt by jeets.
...
library Address{
 ...
 contract SQUIDGROWYATCHCLUB is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8EAb3bAF19634584f086812eB77207022e938C06;
    address public TeamWallet = 0x939Bf39aABe4024Aa4E0f44454021EA4316b4554; 

    string private constant _name = "Squidgrowyatchclub";
    string private constant _symbol = "SGYC";
    ...
    Taxes public taxes = Taxes(2, 2, 2, 1);
    Taxes public sellTaxes = Taxes(2, 2, 2, 1);
