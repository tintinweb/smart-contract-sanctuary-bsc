...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbaC5ecd34B71B6c0cc72e79063182080B04b222A; // owner address
...
contract MasterbateDust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Masterbate Dust";
    string private _symbol = "MD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8e80Df8139095F2C2b1B6FDF647D939B35742FD); // Marketing Address
    address payable public teamWalletAddress = payable(0xE8e80Df8139095F2C2b1B6FDF647D939B35742FD); // Team Address
