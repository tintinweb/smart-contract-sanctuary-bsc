...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_, address initMarketAddress_) {
        ...
        allot = Allot(1000, 0, 500, 1000, 2500);
...
contract ShibKing is ERC20, ERC20Burnable, IDividendDistributor, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShibKing", "ShibKing") {
        ceo = _msgSender();
        _baseToken = 0x55d398326f99059fF775485246999027B3197955;
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        address _initMarketAddress = 0xA061C5Fec69b357F15562b104fF8b0f3b2F8C233;
        setPair(_baseToken);
        ...
        address _initHolder = 0x5DE6905Fe3fA96d63365082610F6EDa811874208;
