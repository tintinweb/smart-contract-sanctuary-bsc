...
contract GlooMWaY is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "GlooMWaY";
    string private _symbol = "WaY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0516d9c679B75ccFcDAf5401B218790b85b493c7);
