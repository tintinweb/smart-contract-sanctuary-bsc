...
contract Reverse is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 25_000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10_000_000 * 10**9; //
    string private constant _name = "Reverse Inu"; // 
    string private constant _symbol = "REVERSE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _development = 0x1001C1A76EbE5A50e4a4D98ba379fF6D4b7a1e09;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(_development).transfer(ethToSend);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(_development).sendValue (ethAmount - ethFromLiquidity);
    }
}