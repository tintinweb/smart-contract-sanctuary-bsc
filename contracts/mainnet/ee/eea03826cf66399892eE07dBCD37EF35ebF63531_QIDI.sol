...
contract QIDI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "QIDI";
    string private _symbol = "QIDI";
    ...
    function samegas(uint256 share, uint256 dividendsPerShare) internal pure returns (uint256) {
   ...
   function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
    ...
    function maxamount(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
