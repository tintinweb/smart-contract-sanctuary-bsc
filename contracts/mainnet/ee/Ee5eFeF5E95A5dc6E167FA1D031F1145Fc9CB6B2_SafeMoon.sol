...
contract SafeMoon is IERC20, Ownable {
    ...
    string _name = "Locate";
    string _symbol = "Locate";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000_000_000_000_000 * (10 ** _decimals);
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(413945130).div(100_000_000_000_000_000_000);
    uint256 largeSwapThreshold = _totalSupply.mul(669493726).div(100_000_000_000_000_000_000);
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xe3b62e87c92c6Db4DFf309b180405a547F64D666;
        marketingFeeReceiver = 0xe3b62e87c92c6Db4DFf309b180405a547F64D666;
        devFeeReceiver = 0xe3b62e87c92c6Db4DFf309b180405a547F64D666;
