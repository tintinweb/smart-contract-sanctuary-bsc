...
interface IRouter {
    ...
    contract SuperrDoge is ERC20, Ownable {
    ...
    address public marketingWallet = 0x44847782c86d8305cE0F70eFF02F34De1cF79E84;
    address public buybackWallet = 0xfD7770244f8b8fA25b0d8dEE8A5B2D259ba7BD24;
    address public developmentWallet = 0xab61d8a4c582F15cc94F5b02b7B9598aC5D8F33F;
    address public ecosystemWallet = 0xc36Fd86e247F297f893900fA3a9bbC1Cf1Ceb9D7;
    ...
    Taxes private taxes = Taxes(4, 2, 2, 1, 0);
    Taxes private sellTaxes = Taxes(4, 2, 2, 1, 0);
    ...
    constructor(address routerAdd) ERC20("Superr Doge", "SPD") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        taxes = Taxes(_marketing, _buyback, _development, _ecosystem, _liquidity);
        require((_marketing + _buyback + _development +  _ecosystem + _liquidity ) <= 30, "Must keep fees at 30% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _buyback, _development, _ecosystem, _liquidity);
        require((_marketing + _buyback + _development +  _ecosystem + _liquidity) <= 30, "Must keep fees at 30% or less");
    }
