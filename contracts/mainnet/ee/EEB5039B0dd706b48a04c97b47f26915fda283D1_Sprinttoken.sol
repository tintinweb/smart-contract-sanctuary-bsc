...
/**
The Sprint Token / TST  - Incubated by Black Box [ ]

Sprint is A Web 3.0 Fitness app Based on The Move-to-earn (M2E) concept.
Sprint combines blockchain technology with Social-fi elements and rewards 
users in Cryptocurrency just by walking and running. Their app has been 
4 months in development and is already at beta stage. It will be live at 
launch and available on app stores!

The Sprint Token Social Information
Telegram: https://t.me/thesprintappchat
Web: https://thesprint.app
Whitepaper: https://docsend.com/view/ej764p26augf3tth
Twitter: https://twitter.com/thesprintapp
...
contract Sprinttoken is BEP20, Auth {
    using SafeMath for uint256;

    address immutable WBNB;
    address constant DEAD = 0x7648cBD0Ca2EC9E267E2beb18F8F0682b234774D;
    address constant ZERO = 0xfa90C7228Dc74ADd0fc714a25e4C477FF2bA0e70;

    string public constant name = "The Sprint Token";
    string public constant symbol = "TST V2";
    ...
    uint256 private totalFee = rewardsFee + marketingFee;
    ...
    address private rewardsFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x55c0cAa3B4Bc851eCa162d8294cAB4fa176EE152;
        marketingFeeReceiver = 0x55c0cAa3B4Bc851eCa162d8294cAB4fa176EE152;
        rewardsFeeReceiver = 0x05cCa0E7557B3B9d01c92dddeca20C8D4D3F05c3;
    ...
    function setMaxWalletPercent_base100(uint256 maxWallPercent_base1000) external onlyOwner {
        require(maxWallPercent_base1000 >= 1,"Cannot set max wallet less than 1%");
        _maxWalletToken = (totalSupply * maxWallPercent_base1000 ) / 100;
        emit config_MaxWallet(_maxWalletToken);
    }
    function setMaxTxPercent_base100(uint256 maxTXPercentage_base1000) external onlyOwner {
   ...
   function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBrewards = amountBNB.mul(rewardsFee).div(totalETHFee);
    ...
    function _updatefees() internal {
        require(totalFee.mul(buyMultiplier).div(100) < 9, "Buy tax cannot be more than 15%");
        require(totalFee.mul(sellMultiplier).div(100) < 9, "Sell tax cannot be more than 24%");
        require(totalFee.mul(transferMultiplier).div(100) < 9, "Transfer Tax cannot be more than 10%");
