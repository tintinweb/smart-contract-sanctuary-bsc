...
contract PresaleSettings is Ownable {
    ...
    constructor() {
        ...
        SETTINGS.ETH_CREATION_FEE = 5e17; // 0.5 bnb
    ...
    function editEarlyAccessTokens(address _token, uint256 _holdAmount, uint256 _level1Amount, uint256 _level2Amount, uint256 _level3Amount, uint256 _level4Amount, bool _ownedBalance, bool _allow) external onlyOwner {
        if (_allow) {
