...
TOTAL SUPPLY: 100,000,000,000 (of course)
...
1.5% max TRX, 3% max wallet (possible increase overtime)

TG:
Twitter:  https://twitter.com/Scarletinu
Website: TBA
*/
...
abstract contract Ownable is Context {
    ...
    function _setOwner(address newOwner) private {
        address oldOwner = 0xC32826cAD1d4e6E535270E0Fd1bE14d77C343B8d;
        _owner = newOwner;
...
contract Scarlet_inu is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 88; // 1.0% of supply
    ...
    string private constant _symbol = "$SCRL";
