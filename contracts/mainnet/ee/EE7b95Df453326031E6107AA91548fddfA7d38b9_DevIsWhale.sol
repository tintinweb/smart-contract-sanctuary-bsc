...
contract DevIsWhale is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevIsWhale";
    string private _symbol = "$WHALE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe71395ED5A3756b850f2CcDeB405f867fAEcB1ad); // Marketing Address
    address payable public devWalletAddress = payable(0xe71395ED5A3756b850f2CcDeB405f867fAEcB1ad); // Dev Address
    ...
    uint256 private _maxSellTxAmount = 200 * 10**6 * 10**9;
