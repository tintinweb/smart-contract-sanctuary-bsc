...
//简介： 追梦月是由200位追梦核心领袖联手打造的追梦分叉币，同时73家线下工作室线下助力，数量不断增加。
//10B底池发射总量79993月9号晚上7点 电报：@ZMMOONCN
...
contract ZMMOON is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public holderMax =  7999 * 1e18;
    ...
    constructor() {
        ...
        _totalSupply = 7999 * (10 ** uint256(_decimals));
