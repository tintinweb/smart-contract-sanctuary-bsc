...
// Telegram: https://t.me/BabyMarvinPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x70A03D34cB60d718c2D0116EE41aA9812c3C1506);
...
contract BabyMarvin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyMarvin";
    string constant _symbol = "BabyMarvin";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x70A03D34cB60d718c2D0116EE41aA9812c3C1506;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0528b0A710A5beD1C150bb0a95d532523eA516ED; 
        devWallet = 0xE821bcfa3494B9e62589A143cE01a3D5DBA04edA; 
