    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function getWeaponConfig(uint8 _tier) external view returns(SharedStructs.WeaponTierConfig memory) {
        return weaponTierConfigMap[_tier];   
    }

    function getArmorConfig() external view returns(SharedStructs.ArmorTierConfig memory) {
