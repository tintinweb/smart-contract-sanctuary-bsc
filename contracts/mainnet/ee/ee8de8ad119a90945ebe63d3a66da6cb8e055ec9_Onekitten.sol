...
// Hello, my name is Kitten, i have only 1 supply, with 1% max tx and wallet.
...
contract Onekitten is IBEP20, Auth {
    ...
    string constant _name = "OneKitten";
    string constant _symbol = "1KITTEN";
    ...
    address public marketingFeeReceiver = 0x97388255b4109351C69C1FcC9709c50FF441c190;
    address public devFeeReceiver = 0x97388255b4109351C69C1FcC9709c50FF441c190;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 30 >= block.number){ return feeDenominator.sub(1); }
