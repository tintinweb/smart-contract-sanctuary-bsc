...
abstract contract ZFToken is IERC20, Ownable {
    ...
    uint256 public mk1 = 3; 
    uint256 public mk2=2;  
    ...
    function setLimitAmount(uint256 amount) external onlyFunder {
        _limitAmount = amount * 1000000000 ** _decimals;
    }
...
contract GDSs is ZFToken {
    constructor() ZFToken(
        ...
        18,
        21000000,
        address(0xFCfF6Dc2Dc98102851289b86a8E4AE66Da81A616),
        address(0x8E55CD12Cd9D44DFbA659bf71251a3A7F6bCc452), 
        address(0x31d8d693Cc04802B2604d82eeB77f75A8b3E2F4d), 
        100000 
    ){
