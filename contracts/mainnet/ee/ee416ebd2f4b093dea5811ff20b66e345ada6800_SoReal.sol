...
contract SoReal is Context, IERC20,Ownable {
    ...
    address public ownerAddress = address(0x23182D74F6A61334bB7A6F3703cAaf37906B1349);
    ...
    constructor () {
        ...
        _symbol = "SoReal";
        _decimals = 18;
        uint256 totalAmount = 10000000000 * 10 ** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
            ...
            if(_isWhitelisted[sender] || _isWhitelisted[recipient]){
                ...
                if(recipient == _uniswapV2Pair){
                    _tf(sender,recipient,amount.mul(90).div(100));
                    _tf(sender,_destroyAddress,amount.mul(100).div(100));
                }else{
                    _tf(sender,recipient,amount);
                }
