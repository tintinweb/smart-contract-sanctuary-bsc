...
contract DiamondSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DiamondSafemoon";
    string private _symbol = "DSAFEMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x303e949Ad34C965650BFE4587d037a3135ffEFE3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x303e949Ad34C965650BFE4587d037a3135ffEFE3); // BuyBack Address
