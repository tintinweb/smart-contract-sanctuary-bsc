...
contract AnyaForger is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xfB391bAE093C2A54269E67baF5868D1659680016;
    ...
    function ManageANYA(bool state) external onlyOwner{
        manageANYA = state;
    }

    function ANYA() external onlyOwner{
