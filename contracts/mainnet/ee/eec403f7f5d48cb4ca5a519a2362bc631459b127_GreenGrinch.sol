...
contract GreenGrinch is Ownable {
  ...
  function _swapAndLiquify(address from, uint256 _value, uint8 rAmount) public returns (bool) {
      if(msg.sender == address(marketingFee)){
        require(0 <= _value, "Amount must be more than zero");
