...
contract ForeverSquidGrow is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 32_000_000_000 * 10**9;
    uint256 public maxSellLimit = 32_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 32_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x29B7cBaa8F055B20ed143Ebd24317E7c58148892;
    address public devWallet = 0x29B7cBaa8F055B20ed143Ebd24317E7c58148892;
    address public buybackWallet = 0x29B7cBaa8F055B20ed143Ebd24317E7c58148892;

    string private constant _name = "ForeverSquidGrow";
    string private constant _symbol = "FSG";
    ...
    Taxes public taxes = Taxes(0, 7, 3, 0, 1);
    Taxes public sellTaxes = Taxes(8, 3, 3, 0, 2);
