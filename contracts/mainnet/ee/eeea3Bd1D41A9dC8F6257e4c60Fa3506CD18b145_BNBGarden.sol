...
// File: contracts/Running/BNBGarden.sol
...
contract BNBGarden is Initializable, UUPSUpgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable  {
    function _authorizeUpgrade(address) internal override onlyOwner {}


    uint256 constant launch = 1668153600;
    ...
    function initialize() public initializer {
        ...
        MIN_INVEST_LIMIT = 1 * 1e18; // 1 LP = $23 , min invest = $23
        WALLET_DEPOSIT_LIMIT = 1000 * 1e18; // max invest = $23000
    }
    ...
    function unstakeAll() nonReentrant whenNotPaused external {
    }

    function withdrawInitial(uint256 keyy) nonReentrant whenNotPaused public {
    }
