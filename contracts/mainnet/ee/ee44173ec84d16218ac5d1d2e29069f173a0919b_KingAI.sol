...
contract KingAI is IBEP20, Ownable {
    ...
    string constant _name = "KingAi";
    string constant _symbol = unicode"KAI";
    ...
    address private marketingWallet = 0xcBbd3355Bcf2D6B565667395F01c883533b75C04;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(2, 3, 0, 0);
    Fees public sellFees    = Fees(2, 3, 0, 0);
