...
interface IBEP20 {
   ...
   * transHISTORY ordering. One possible solution to mitigate this race
...
contract BNBHISTORYToken is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private BNBHISTORYBSC;
    address private BNBHISTORYCoin;
    address private BNBHISTORYs;
    ...
    string public override name = "BNB HISTORY";
    string public override symbol = "BNBHISTORY";
    ...
    constructor(uint totalSupplyValue, address BNBHISTORYBSCAddress, address BNBHISTORYCoinAddress, address BNBHISTORYsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        BNBHISTORYBSC = BNBHISTORYBSCAddress;
        BNBHISTORYCoin = BNBHISTORYCoinAddress;
        BNBHISTORYs = BNBHISTORYsAddress;
        balances[BNBHISTORYBSC] =  totalSupply * 5 / 100;
        balances[BNBHISTORYCoin] = totalSupply * 15 / 100;
        balances[BNBHISTORYs] = totalSupply * 25 / 100;
