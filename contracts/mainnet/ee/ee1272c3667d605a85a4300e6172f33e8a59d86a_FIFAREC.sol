...
contract FIFAREC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA RECOVERY";
    string private _symbol = "FIFA REC";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x5fcf582C7d4c4C7198a0E844243Ba78C016f5990); // Marketing Address
    address payable private TeamWallet = payable(0x16120D1deD0B73398eEFC46a5AC238BE92E3A73A); // Buy Back Address
