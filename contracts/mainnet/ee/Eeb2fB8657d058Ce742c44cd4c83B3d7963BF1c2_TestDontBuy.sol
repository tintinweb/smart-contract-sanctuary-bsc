...
Telegram : https://t.me/TestDontBuy
...
contract TestDontBuy is ERC20, Ownable {
    ...
    TestDontBuyDividendTracker public dividendTracker;
    ...
    constructor() ERC20("TestDontBuy", "TestDontBuy") {
        marketingWallet = payable(0x21456436870ea9637C279488a764cE2d20a7CF53);
        devWallet = payable(0x16579f368c7A012BDbBa80dBA9D70C60661e4262);
        ...
        dividendTracker = new TestDontBuyDividendTracker(
            payable(this),
            router,
...
contract TestDontBuyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TestDontBuy public TestDontBuyContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TestDontBuyContract = TestDontBuy(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TestDontBuy_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TestDontBuy_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TestDontBuy contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TestDontBuyContract);

            uint256 prevBalance = TestDontBuyContract.balanceOf(address(this));
            ...
            {
                uint256 received = TestDontBuyContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TestDontBuyContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
