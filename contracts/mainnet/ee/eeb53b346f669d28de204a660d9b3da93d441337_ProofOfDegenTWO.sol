...
contract ProofOfDegenTWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Degen 2.0"; // 
    string private constant _symbol = "$BNB2.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xE8F0e6a548a3f9Bd9e36e3D25C38Bd9c3c2B8477;
