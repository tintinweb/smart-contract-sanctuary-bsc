...
contract ZombieRush is Context, IERC20 {
    ...
    string constant private _name = "Zombie Rush";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x43b880dC064987a1b8656BcB9A6726120278334F),
        team: payable(0xa4B69199c75AC6678e8E8f9Cbb11850E62Fe8EC4),
        gameTreasury: payable(0x862ADa03a5B7cB89b2dE442eA8FdaBe5CCdab661)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 team, uint16 game) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.game = game;
        _ratios.total = liquidity + marketing + game + team;
    }
    ...
    function setWallets(address payable marketing, address payable team, address payable game) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.team = payable(team);
        _taxWallets.gameTreasury = payable(game);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0 && _ratios.total - _ratios.liquidity > 0) {
            ...
            _taxWallets.team.transfer((amountBNB * _ratios.team) / (_ratios.total - _ratios.liquidity));
            _taxWallets.gameTreasury.transfer((amountBNB * _ratios.game) / (_ratios.total - _ratios.liquidity));
