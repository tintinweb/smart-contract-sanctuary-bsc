...
/**
 ...
 Telegram https://t.me/JotaroKujoCoin
...
contract Jojo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x341cb59C9D1E15A2a2A728C646bA429E88188C9D); // Marketing Address

    address payable public StakeAddress =
        payable(0x341cb59C9D1E15A2a2A728C646bA429E88188C9D); //  Development Address

    address payable public liquidityAddress =
        payable(0xA5A3F47f933E9aA0162deabC32446EE34Acd23Aa); // Liquidity Address
    ...
    uint256 private _buyStakeFee = 0;
    ...
    uint256 private _sellStakeFee = 0;
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 2 / 10000; // 0.05%
