...
/**
🔥STEALTH LAUNCH TODAY'S

PREVIOS PROJECT 100X 

LP LOCK 3 MONTH AND OWNERSHIP RENOUNCE

BUY & SELL 5%

💥Join Our Community Now 💥
Portal :
https://t.me/TrustTsuka
 */
...
contract TTSUKA is Context, IBEP20, Ownable {
    ...
    string public _name = "Trust Tsuka"; // token name
    string public _symbol = "TTSUKA"; // token ticker
    ...
    uint256 private minTokenToSwap = 100000 * 1e9; // 100k amount will trigger the swap and add liquidity
