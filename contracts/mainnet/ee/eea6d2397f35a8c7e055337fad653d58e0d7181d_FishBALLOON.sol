...
/*
Fish Balloon
Fish Balloon Animal Step by Step One Balloon Fish Tutorial
*/
...
interface Bep20 {
     ...
     *
     * Returns a boolean value indiFishing whether the operation succeeded.
     *
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multipliFishion overflow");
...
contract FishBALLOON is ContextBep20, Bep20, OwnableBep20 {
    ...
    string private _name = 'Fish Balloon';
    string private _symbol = 'FBALLOON';
