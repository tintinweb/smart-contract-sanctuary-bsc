...
/**
STEALTH LAUNCH https://t.me/saudiarabiangrowportal
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5aE05514188E7c8a327bfDa11D3c92e55aBdeBcc; // owner address
...
contract saudiarabiangrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Arabia Grow";
    string private _symbol = "SAG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x632D1a77BB69D7768eeECd89d9875cB2bD0A681a); // Marketing Address
    address payable public teamWalletAddress = payable(0x632D1a77BB69D7768eeECd89d9875cB2bD0A681a); // Team Address
