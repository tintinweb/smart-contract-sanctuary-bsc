...
/**
Welcome to SaudiShiba Token

Our mission is to send this token to space and directly to the moon. Together with the help of the whole team, we will create a solid community of diamond hands and continue to gain buyers.
...
https://t.me/SaudiShibaBSCOfficial
*/ 
...
contract SAUDISHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SaudiShiba";
    string private _symbol = "SAUDISHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6254F9CcAbD6BffBCD80b92D326cB2be2ca3830a); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9Cc02Af04839AF2aae13a976F994F407b532ED9a); // buyback Address
