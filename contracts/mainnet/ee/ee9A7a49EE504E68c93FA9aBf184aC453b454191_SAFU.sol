...
contract  SAFU is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xac423e22Cb52aF631158a27162Cd58c019a06325); 
    address payable private teamWalletAddress = payable(0xac423e22Cb52aF631158a27162Cd58c019a06325); 
    ...
    uint256 private _totalSupply = 88 * 10**15;
    uint256 public _maxTxAmount = 88 * 10**15; 
    uint256 public _walletMax = 88 * 10**15;
    uint256 private minimumTokensBeforeSwap = 88 * 10**15;
    ...
    constructor () {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xc09Cc8B60A0b05EDB48a19F5cdF86AABADa78Ce5); 
