...
contract MetaPoints is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb4b8E3c2a95C328c2fd25BfF2c18664ccaCb79f4); // Marketing Address
    ...
    string private _name = "Meta E-Points";
    string private _symbol = "MEP";
