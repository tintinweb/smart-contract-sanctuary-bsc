...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4770cF1e1FCB771b644C342061E53dE2b38Dc462;
...
contract TwitB is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x4770cF1e1FCB771b644C342061E53dE2b38Dc462);
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external authorized() {
     ...
     function set_Max_Wallet_Percent(uint256 maxTxPercent_x100) external authorized() {
        _maxWalletToken = maxTxPercent_x100;
    }
