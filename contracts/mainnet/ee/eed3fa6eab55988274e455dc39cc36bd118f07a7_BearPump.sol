...
contract BearPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bear Pump";
    ...
    function setStonesMaxWallet(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }
    function setStonesMaxTx(uint256 maxTXPercentage_base1000) external onlyOwner() {
