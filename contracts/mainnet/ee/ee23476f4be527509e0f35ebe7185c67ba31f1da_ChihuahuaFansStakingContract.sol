...
// File: contracts/ChihuahuaFansPoolInitializable.sol

pragma solidity 0.6.12;

contract ChihuahuaFansStakingContract is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public ChihuahuaFans_POOL_FACTORY;
    ...
    constructor() public {
        ChihuahuaFans_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == ChihuahuaFans_POOL_FACTORY, "Not factory");
