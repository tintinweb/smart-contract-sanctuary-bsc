...
/**
 * TG: https://t.me/yuanxiaoshiba
    
    Yuan Xiao Shiba

Named from the Chinese festival also known as the "lantern festival" and like a lantern Yuan Xiao Shiba  looks to light up the blockchain with the most incredible Chinese marketing on BSC.

Feriocious Chinese marketing, no private sale, no team tokens paired with a strong English community = MOON
...
contract YuanXiaoShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yuan Xiao Shiba"; 
    string private constant _symbol = "YuanXiao"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0xe5bFF52E99F75DF226625e3E775df086Ac43C146; 
