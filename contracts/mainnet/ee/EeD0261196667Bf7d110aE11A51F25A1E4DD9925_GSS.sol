...
contract GSS is ERC20Basics, Ownable {
    ...
    constructor(address _old, address _USDTToken, address _Pledge, address _Constellation, address _Pope, address _GSSHoldToken, address _marketing, address _community, address _lp, address _uniswapV2RouterAddress)
    ...
    function swap() public returns (bool) {
        ...
        uint256 amount = ERC20Basics(old).balanceOf(from);

        ERC20Basics(old).transferFrom(from, _destroyAddress, amount);
