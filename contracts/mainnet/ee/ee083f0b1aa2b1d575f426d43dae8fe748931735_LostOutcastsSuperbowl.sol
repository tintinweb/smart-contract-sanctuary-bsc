...
// File: LostOutcastsSuperbowl.sol
pragma solidity >=0.8.9 <0.9.0;

contract LostOutcastsSuperbowl is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
  ) ERC721A("LOST Outcasts Superbowl", "LOST") {
      setHiddenUri("QmWc4JJJAoxHqwizHuMQ68bYEV5UWPuaWmtmJdUXPsLbkv/Superbowl.json");
