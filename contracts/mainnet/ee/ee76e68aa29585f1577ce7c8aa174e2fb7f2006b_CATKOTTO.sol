...
contract CATKOTTO is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5f15a9733bdb96C94Ebb86f563372450EB6e4760;

    string private constant _name = "CATKOTTO";
    string private constant _symbol = "CKOTTO";
