...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x112B84dF5E61062183cE171100F5A98D2Baf53aD; // owner address
...
contract HathInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hath Inu";
    string private _symbol = "HI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x112B84dF5E61062183cE171100F5A98D2Baf53aD); // Marketing Address
    address payable public teamWalletAddress = payable(0x112B84dF5E61062183cE171100F5A98D2Baf53aD); // Team Address
