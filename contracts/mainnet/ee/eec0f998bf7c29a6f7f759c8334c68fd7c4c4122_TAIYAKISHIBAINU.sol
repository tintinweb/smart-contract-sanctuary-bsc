...
// Telegram : https://t.me/taiyakiinu
...
contract TAIYAKISHIBAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TAIYAKI INU";
    string private _symbol = "$TAIYAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBDd56d26299A04fDf55e97044c37d1d306C44704); 
    address payable public teamWalletAddress = payable(0xB5ba3234B029e43d54d9DB59032440bfd63EC49D); 
    ...
    uint256 public _maxTxAmount = 100 * 10**6 * 10**_decimals; //(5%)
    uint256 public _walletMax = 5 * 10**6 * 10**_decimals; //(6%)
