...
contract Token is ERC20,Ownable,WhiteList {
    ...
    constructor(address addr,address specialAddress_,address marketingAddress_,address daoGovernAddress_,address superNodeAddress_,address destroyAddress_,address routerAddress_) ERC20("KTW","KTW"){
