...
contract KKRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"KKRabbit";
    string private _symbol = unicode"KK";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xE70a6c29A32402cDFF03b06F796EA5172600Ea4c); 
    address payable public BurnedWalletAddress = payable(0x34DEd263BdE4dC0dbFd31a136Ccf4D2c98b6D4E9); 
