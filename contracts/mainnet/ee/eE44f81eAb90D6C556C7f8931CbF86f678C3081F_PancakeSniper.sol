...
contract PancakeSniper is Ownable {
    ...
    IUniswapV2Router01 public uniswapRouter = IUniswapV2Router01(UNISWAP_ROUTER_ADDRESS);
    ...
    function buyToken(address targetContract) public onlyOwner {
        ...
        tokenAmount[1] = tokenAmount[1] / 10;
    ...
    function sellToken(address targetContract) public onlyOwner {
        ...
        uniswapRouter.swapExactTokensForETH(tokenAmount, bnbAmount[0], path, address(this), deadline);
        emit TokensSoldForBNBAmount(bnbAmount[0]);
    }
