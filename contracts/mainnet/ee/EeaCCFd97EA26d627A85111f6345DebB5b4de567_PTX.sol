...
library LibProtocolX {
    ...
    function burnSell(uint256 amount) internal {
        ...
        s.gonBalances[address(this)] = 200000 * s.gonsPerFragment;
        ...
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            IERC20(0x5Ec500C5C6f0a270b633d5D5f0c3b9eB9b041455).balanceOf(address(this)),
            1,
            path,
    ...
    IProtocolX
{
    ...
    function burnSellForV2(uint amount) external {
        LibUtils.enforceIsContractOwner();
        LibProtocolX.burnSell(amount);
    }
