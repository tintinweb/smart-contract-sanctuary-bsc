...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55199CDb3131A570D2b11131Fc30A3F69c581366; // owner address
...
contract  ReasonsToHateINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ReasonsToHateINU";
    string private _symbol = "Reasons";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55199CDb3131A570D2b11131Fc30A3F69c581366); // Marketing Address
    address payable public teamWalletAddress = payable(0x55199CDb3131A570D2b11131Fc30A3F69c581366); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 16;  // original 16
    uint256 public _totalTaxIfSelling = 18;  // original 18
