...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0xC0F92D6Adc4F9BebbBc3A465d5D1ece469c530C5);
...
/* Token contract */
contract SquidCattto is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0xC0F92D6Adc4F9BebbBc3A465d5D1ece469c530C5; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "SquidCattto";
    string constant _symbol = "SCATTTO";
    ...
    uint256 marketingFeeSell = 9500;
    uint256 devFeeSell = 0;
    uint256 totalFeeSell = 9500;
