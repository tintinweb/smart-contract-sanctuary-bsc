...
*/
//Naughtius Maximus Merge
//Prepare yourself to a New Generation of Meme Token.It is set to be the one of the largest Meme Coin on Dogechain , The grow will not stop and we will reach the top!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86418eBdaD6A7C3fc98AC1A7a833364C32b14B9A;
...
contract NaughtiusMaximusMerge is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x86418eBdaD6A7C3fc98AC1A7a833364C32b14B9A);
    ...
    */
    ...
    string private _name = "NaughtiusMaximusMerge"; 
    string private _symbol = unicode"NMAXMERGE";  
