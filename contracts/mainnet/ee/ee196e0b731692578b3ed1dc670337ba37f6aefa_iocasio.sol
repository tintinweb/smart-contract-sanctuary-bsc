...
contract iocasio  is Context, IERC20, Ownable {
    ...
    string private constant _name = "iOCASIO"; // 
    string private constant _symbol = unicode"58$"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 8;
    address public  _marketingWallet = 0x1a6FFE09eF1d734f2d2d00B5de0D7EBe5Ebc9783;
