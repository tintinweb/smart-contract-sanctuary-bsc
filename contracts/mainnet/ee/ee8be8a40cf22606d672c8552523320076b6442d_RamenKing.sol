...
Ramen up with 4 % BUSD rewards and strategic buybacks!
...
contract RamenKing is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "RamenKing";
    string constant _symbol = "RamenKing";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 40; //  2500000 tokens per trx ;
    uint256 public _walletMax = _totalSupply * 1 / 40;    // 2500000 mx wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x0D4932B8E3498C75aFa0Fb53e22550090d147844; // liquidity
        marketingWallet = 0xA5a9DcA290720d0324cb8D5A2DDBF0d5A643E0F4;  // marketing
