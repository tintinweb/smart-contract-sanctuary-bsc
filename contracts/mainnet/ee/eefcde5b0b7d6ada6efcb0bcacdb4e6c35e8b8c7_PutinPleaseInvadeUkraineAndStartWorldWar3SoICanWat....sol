...
It's safu as fuck though, liq locked and ownership renounced
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract PutinPleaseInvadeUkraineAndStartWorldWar3SoICanWatchTheWorldBurn
 is Context , IERC20, Ownable {
    ...
    string private _name = "PutinPleaseInvadeUkraineAndStartWorldWar3SoICanWatchTheWorldBurn";
    string private _symbol = "BasedPutin";
    ...
    address public devWallet = 0x69eA21172Ad7E0ba62d85C0877d60dF2D09815d6;
    ...
    uint256 public _maxTxAmount = 15000 * 10**9 * 10**9; //1.5% of total supply
