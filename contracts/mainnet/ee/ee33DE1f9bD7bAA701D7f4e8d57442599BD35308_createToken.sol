...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _symbol = Symbol;
        _decimals = 6;
        uint256 total = 1200 * 10 ** _decimals;
        ...
        numTokensSellToAddToLiquidity= 5*10**6;
    ...
    function _transfer(
        ...
        if (from != address(this)) {
            ...
            try this.processReward(500000){}catch{}
        }
    }
 ...
 function setSwapAndLiquifyEnabled(bool _enabled) public {
    ...
    function setLimitEnable(bool status) public onlyOwner {
     ...
     function setNumTokensSellToAddToLiquidity(uint256 valur) public onlyOwner() {
...
contract createToken is AbsToken {
    constructor() AbsToken(
        ...
        "ck",
        "ck",
        address(0x8D70fEad5B8C1FAEBaA4b83590d344A21e2B6605),
        address(0xD2dc20d42dE6aEE81349773bd971901702Bc9100)
    ){
