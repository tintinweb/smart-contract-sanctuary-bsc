...
contract Red_LUNA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Red LUNA";
    string private _symbol = "rLUNA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb8639aE9A64965209e1A51286E527c6Bd2557D67);
