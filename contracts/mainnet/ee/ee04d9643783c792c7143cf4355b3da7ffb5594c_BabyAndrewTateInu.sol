...
contract BabyAndrewTateInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby AndrewTate Inu"; // 
    string private constant _symbol = "BATI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x9f87D50C2eEf57bD9A1A73B2B4459E4d298BC5AA;
