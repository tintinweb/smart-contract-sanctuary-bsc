...
contract GreenMilo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Green Milo";
    string private _symbol = "GLO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7c5a419C3164F4917035dD356C2997a866ecEBf2); 
    address payable public buyBackWalletAddress = payable(0x9F04e7E9096EEA9ECa0388daf320431Ec61766C3); 
