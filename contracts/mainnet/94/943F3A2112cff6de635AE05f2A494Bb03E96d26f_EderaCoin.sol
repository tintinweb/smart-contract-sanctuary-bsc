...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xb95b8f2caf459c58c0772506da7B533F5292Ee4b ;
...
contract EderaCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0xE9eCEb7a0Ce8b22E418560ADa78845360C1D15eD ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EderaCoin";
    string private _symbol = "EDR";
