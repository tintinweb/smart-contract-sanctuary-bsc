...
contract GOKUNOMAD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC943c791B8739E30F39Da8CCC9C78Cf736DFB7aA); 
    address payable public Wallet_Dev = payable(0xC943c791B8739E30F39Da8CCC9C78Cf736DFB7aA);
    ...
    string private constant _name = "GOKU NOMAD"; 
    string private constant _symbol = unicode"gNOMAD"; 
    ...
    constructor () {
        ...
        _owner = 0xC943c791B8739E30F39Da8CCC9C78Cf736DFB7aA;
