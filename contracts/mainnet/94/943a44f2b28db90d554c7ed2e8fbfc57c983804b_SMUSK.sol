...
contract  SMUSK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SQUID MUSK"; // 
    string private constant _symbol = unicode"SMUS"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x2e1Bd8F1ffE3aD272496B0064470F7b622f58269;
