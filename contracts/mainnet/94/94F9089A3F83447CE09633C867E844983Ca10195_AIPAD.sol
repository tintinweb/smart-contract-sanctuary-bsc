...
contract AIPAD is IBEP20, Auth {
    ...
    string constant _name = "AiPad";
    string constant _symbol = "AIPAD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 400000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3d5Bbe76e6584a3b2378fdf7de5260984F71dFd1;
