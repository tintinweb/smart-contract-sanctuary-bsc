...
/**
https://t.me/BinanceSmartEarn
https://twitter.com/binancesetoken
 **/
...
/* Token contract */
contract BinanceSmartEarn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x99DE0Df5a6a64Ee924a52348bc1417EDbfc93D06;
    ...
    // Name and symbol
    string constant _name = "Binance Smart Earn";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 30% on launch or 30B tokens
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 1% or 15B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6457f46296DdA1Fdf0E510F505F4408114c75104;
