...
contract MarketUtility is Ownable {
    ...
    // in case of governance change
    function upgradeWOLFYBridge(address _wolfyBridge) external onlyOwner {
        WOLFYBridge = _wolfyBridge;
    }
    // in case of governance change
    ...
    function getBasicMarketData() 
        ...
        returns (
            ...
            uint256 prdQualifier, 
            uint256 minRewThreshold, 
            address wpackRewContract, 
            address wpackStakingContract, 
            address marketLiquidityAddr, 
            address wolfyBridgeAddr
        ) 
    {
        return (
            settlementPeriod, 
