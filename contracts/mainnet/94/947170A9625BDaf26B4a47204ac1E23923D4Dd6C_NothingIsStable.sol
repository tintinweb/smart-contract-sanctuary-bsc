...
TG      : https://t.me/nothingisstablebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdE38FBd5D73091976e25502C690be99078b3F4df; // owner address
...
contract NothingIsStable is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"NothingIsStable";
    string private _symbol = unicode"NIS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdE38FBd5D73091976e25502C690be99078b3F4df); // Marketing Address
    address payable public teamWalletAddress = payable(0xdE38FBd5D73091976e25502C690be99078b3F4df); // Team Address
