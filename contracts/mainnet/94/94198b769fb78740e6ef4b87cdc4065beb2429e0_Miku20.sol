...
/*
    ...
    We aim to build a Strong and Great Community that will change the entire ecosystem of crypto
    With a based team and a based community this will be a good moonshot with enought help from everyone
    Get in early for easy x100
...
contract Miku20 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Miku 2.0"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0650978Fe30AC3AE7B72aF78096625e6eb158cA1;
