...
contract OGE is Context, IBEP20, Ownable {
    ...
    string private _name = "oge"; // token name
    string private _symbol = "OGE"; // token ticker
    ...
    uint256 public minTokenToSwap = 5000000000000 * 1e9; // 1000k amount will trigger the swap and add liquidity
