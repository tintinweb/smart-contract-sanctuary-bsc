...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbcbb99681ADfcC98F0B459870587180880D923C1;
...
contract AEDFinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x524469De47d5Ed0F41AE37884dd8876eE8faE49E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AED Finance";
    ...
    uint256 public _maxTxAmount =  5000 * 10**8;
