...
contract ODC is IERC20, Ownable {
    ...
    uint256 public _maxHavAmount = 15 * 10**18;
    ...
    function setuinswap(address account) public onlyOwner() {
        ...
        onlyOwner
    {
     ...
     function setMaxHavAmount(uint256 havNumber)
        public
        onlyOwner
    {
        _maxHavAmount = havNumber * 10**_decimals;
    }
    ...
    function _takeliuFee(
        ...
        _rOwned[uniswapV2Pair] = _rOwned[uniswapV2Pair].add(rAmount);
    ...
    function _transferStandard(
        ...
        {
             _takeliuFee(sender, tAmount.div(100).mul(_liquidityFee), currentRate);
