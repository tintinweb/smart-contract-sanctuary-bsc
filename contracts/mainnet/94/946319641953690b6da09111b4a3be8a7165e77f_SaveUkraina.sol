...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0x0812C7045D69cd3A881BecAB80E23C222cfbE032);
...
// CHANGE
contract SaveUkraina is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ADA = 0x0812C7045D69cd3A881BecAB80E23C222cfbE032;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Save Ukraine";
    string constant _symbol = "SAVEUA";
    ...
    uint256 devFee = 8; // 
    uint256 totalFee = 8; // liquidityFee + reflectionFee + devFee
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 0.05%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x3d9B8810E5F0c870bB3b6E1Bfc901A569473C2e5);
