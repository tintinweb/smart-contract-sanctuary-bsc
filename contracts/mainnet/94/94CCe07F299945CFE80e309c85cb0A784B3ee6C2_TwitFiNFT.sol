...
contract TwitFiNFT is DefaultOperatorFilterer, ERC721Enumerable, Ownable, AccessControl {
	...
	function mint(address _receiver, string memory _type, uint256 _twitfi_id) external onlyMinter {
        _mintToken(_receiver, _type, _twitfi_id);
    }

	function bulkMint(address[] memory _tos, string[] memory _types, uint256[] memory _twitfi_ids) external onlyMinter {
