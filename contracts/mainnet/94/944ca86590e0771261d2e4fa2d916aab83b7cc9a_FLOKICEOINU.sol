...
contract FLOKICEOINU is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x9852F21829686b9B3102A86d216B78f39eE0db98;

    string private constant _name = "FLOKI CEO INU";
    string private constant _symbol = "FLOKIAI";
