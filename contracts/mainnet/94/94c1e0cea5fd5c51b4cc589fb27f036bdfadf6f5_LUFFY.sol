...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7EfD2cBBB3D57a03288f6dc0dd534dF44D8f5008; 
...
contract LUFFY is Context, IERC20, Ownable {
    ...
    string private _name = "Luffy Burning";
    string private _symbol = "LUFFY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7EfD2cBBB3D57a03288f6dc0dd534dF44D8f5008); 
    address payable public teamWalletAddress = payable(0x7EfD2cBBB3D57a03288f6dc0dd534dF44D8f5008); 
    ...
    uint256 public _marketingShare = 144;
