...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f60Ad8c8218a18F49B22d7439360dB7ce684CF1; // owner address
...
contract AndroMetaToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Andro Meta Token";
    string private _symbol = "ANDROMETA  ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f60Ad8c8218a18F49B22d7439360dB7ce684CF1); // Marketing Address
    address payable public teamWalletAddress = payable(0x2f60Ad8c8218a18F49B22d7439360dB7ce684CF1); // Use Same Address as Marketing Address
    ...
    uint256 private _totalSupply = 6_500_000_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 6_500_000_000_000 * 10**_decimals; 
    uint256 public _walletMax = 6_500_000_000_000 * 10**_decimals;
