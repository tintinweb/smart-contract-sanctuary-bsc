...
//⠀⠀⠀⠀    ⠀⠀⠀⠀⣀⣀⣤⣶⣶⣤⣀⣀ My Twitter is @TacoBSC
//⠀⠀    ⠀⢠⣶⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣶⡄⠀⠀⠀   hi im a taco, i have no tax and want to live on the moon!
//⠀    ⠀⣠⣿⣿⣿⡿⠛⠛⠉⠁⠀⠀⠈⠉⠛⠛⢿⣿⣿⣿⣆⠀⠀      /
//    ⣠⣾⣿⣿⠟⠁⠀⠀⣀⡀⠀⠀⠀⠀⢀⣀⠀⠀⠈⠻⣿⣿⣷⣄     /
//   ⣿⣿⡿⠁⠀⠀⠀⠀(⠛⠃)⠀⠀⠀⠀(⠘⠛)⠀⠀⠀⠀⠈⢿⣿⣿  /
//    ⢸⡿⠀⠀⠸⠂⠐⠗⠀⠐⣶⣄⣠⣶⠂⠀⠺⠂⠐⠇⠀⠀⢿⡇   / 
...
contract Taco is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "SHELL";
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x8fFe7f79780415C7a8F5d0c93912bDB7eE1C3573;
        _marketingWallet = 0x120Db54F64B181338Ed0D48736E0aa562d3d0D7f;
