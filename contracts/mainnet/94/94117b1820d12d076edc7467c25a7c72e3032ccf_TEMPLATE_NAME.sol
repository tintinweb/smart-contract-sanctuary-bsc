...
contract TEMPLATE_NAME is Auth {
    ...
    string public name = "ZETOPINHOS";
    string public symbol = "ZETOP";
    uint8 constant public decimals = 4;


    uint256 public totalSupply = 100_000_000 * (10 ** decimals);
    uint256 public max_tx = totalSupply * 100 / 1000;     // 10% of Total Supply initially
    uint256 public max_wallet = totalSupply * 200 / 1000; // 20% of Total Supply initially
