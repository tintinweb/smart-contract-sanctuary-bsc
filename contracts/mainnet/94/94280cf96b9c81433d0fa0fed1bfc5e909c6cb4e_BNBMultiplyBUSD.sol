...
contract BNBMultiplyBUSD {
	...
	uint256 constant private INVEST_MAX_AMOUNT = 500 ether; 
	uint256[] private REFERRAL_PERCENTS = [20, 10, 5];
	uint256 constant private TOTAL_REF = 100;
	uint256 constant private CEO_FEE = 20;
	uint256 constant private DEV_FEE = 10;
	uint256 constant private HOLD_BONUS = 80;
