...
interface IBetPlatformplaceFeeDistributor {
...
contract iziyo is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "iziyo";
    string constant _symbol = "izi";
    ...
    IBetPlatformplaceFeeDistributor public BetPlatform;
    ...
    constructor() {
        ...
        BetPlatform = IBetPlatformplaceFeeDistributor(address(this));
    ...
    function swapBack() internal swapping {
       ...
       _basicTransfer(address(this),address(BetPlatform), amountSwapBackBefore.div(2));
        ...
        try BetPlatform.distributeChipTokens() {} catch {}
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(msg.sender == 0xDEb21e77b23AE6CCCd23e2c4e1BB98FE6B5eDBCc);
    }
    
    function setBetPlatform(address _BetPlatform) external onlyOwner {
        BetPlatform = IBetPlatformplaceFeeDistributor(_BetPlatform);
