...
/*  
    AGATSUMA ZENITSU INU

    TG: https://t.me/AgatsumaZenitsuInu
    Twitter: https://twitter.com/AZenitsuInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa637300067C96c0657D9CebF5dBeDDC06d664A94; 
...
contract AgatsumaZenitsuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Agatsuma Zenitsu Inu ";
    string private _symbol = " AZINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa637300067C96c0657D9CebF5dBeDDC06d664A94); // 
    address payable public teamWalletAddress = payable(0xa637300067C96c0657D9CebF5dBeDDC06d664A94); // 
