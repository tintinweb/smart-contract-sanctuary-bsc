...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD6A1A02ceD7CADDeA29da5B1D333e494ee2730a7; // owner address
...
contract JustBurnIt is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Just Burn It";
    string private _symbol = "$JBI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xFA137A8fA4C51e27CAe9538F31318Dd361F88248); // MW JBI
    address payable private teamWalletAddress = payable(0xD6A1A02ceD7CADDeA29da5B1D333e494ee2730a7); // DEV JBI
