...
contract ElonTwitterINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonTwitterINU";
    string private _symbol = "ELONTWITTER";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xADc9F85A6cF0B6ef2d4Ab8d73a13D6a2380Fe5F3);
