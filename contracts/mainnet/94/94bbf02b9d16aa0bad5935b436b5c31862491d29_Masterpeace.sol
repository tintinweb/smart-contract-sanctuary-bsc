...
contract Masterpeace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Masterpeace";
    string private _symbol = "MP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89B78D046A39F5244b24d0c6d74358B77E0f243F);
    address payable public teamWalletAddress = payable(0x89B78D046A39F5244b24d0c6d74358B77E0f243F);
