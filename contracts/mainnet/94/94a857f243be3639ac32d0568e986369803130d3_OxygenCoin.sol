...
contract OxygenCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oxygen Coin"; // 
    string private constant _symbol = "$OXCOIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xaB9459B9feD7E99b511D8501212A7E3b587C8216;
