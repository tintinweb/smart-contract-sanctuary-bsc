...
contract GSD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOSTEP TOKEN";
    string private _symbol = "GSD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a73d75716Ef8b5D8e7008F2E2f1B7d42769C875);
    address payable public teamWalletAddress = payable(0x4a73d75716Ef8b5D8e7008F2E2f1B7d42769C875);
