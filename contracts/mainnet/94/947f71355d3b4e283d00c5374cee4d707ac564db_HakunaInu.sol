...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0339254748835DEe5cF6cf74eCE57d8977d97EA2;
...
contract HakunaInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x80852e716055070FB811BEc45687372Aa4745635;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hakuna Inu";
    string private _symbol = "HakInu";
