...
contract FRANCE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x90F28bA2EbbE835Fb0E76ba0996852640c93d978); 
    address payable public Wallet_Dev = payable(0x90F28bA2EbbE835Fb0E76ba0996852640c93d978);
    ...
    string private constant _symbol = unicode"LesBleus"; 
    ...
    constructor () {
        ...
        _owner = 0x90F28bA2EbbE835Fb0E76ba0996852640c93d978;
