...
/// Warning: The code is copyrighted by the sumeriyen ecosystem. All rights reserved.
...
contract sumeriyen is BEP20, Ownable, BaseToken {
  ...
  // onTotalSupply
  uint256 public onTotalSupply = 10**10 * 24400000;
  ...
  address public walletOne = 0x47cab505240f141e9B8918de8431D71Bd7F012f9;
  address public walletTwo = 0x5aCA1D6F7F2DDa5fD054bFD93990B5254330eAb5;
  address public walletThree = 0x726059EFE4e8C2E1A50242727A9894c82E8005c1;
  address public walletFour = 0xaA25Dba1b6b5D16d7EDd478fE7959167f1B85617;
  address public walletFive = 0xd2b25AB54D7342Fa2fC0Fd252C66f85142307D22;
  ...
  constructor(address _cloneadd) BEP20("sumeriyen", "sumer") {
    uint256 totalSupply_ = 100000000000000;
    rewardToken = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; // Rewards distribution in $USD
    liquiditytoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

    swapTokensAtAmount = 10000000000000000; // Minimum balance required in sumeriyen Reward Tracker for reward distribution
