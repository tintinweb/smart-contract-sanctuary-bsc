...
contract Safemars20 is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "SafeMars2.0";
    string constant _symbol = "SAFEMARS2";
    ...
    uint256 _totalSupply = 1000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x7393AcFEdE4210898352f167e3Da20aC8A3d1CdF; // liquidity
