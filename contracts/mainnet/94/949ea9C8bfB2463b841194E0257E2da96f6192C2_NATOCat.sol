...
contract NATOCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NATO Cat";
    string constant _symbol = "NCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3bFccf40EAf9Dad39B635c5749bf26a6480f2a35;
