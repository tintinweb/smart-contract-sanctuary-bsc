...
contract THERIGTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Rig Protocol ";
    string private _symbol = "RIG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD884778740b514E4E5a4860F18b7C52E62217e22); 
    address payable public BurnedWalletAddress = payable(0xD884778740b514E4E5a4860F18b7C52E62217e22); 
