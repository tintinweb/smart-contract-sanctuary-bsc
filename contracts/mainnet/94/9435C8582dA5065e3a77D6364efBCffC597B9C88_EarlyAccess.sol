...
contract EarlyAccess is Initializable,AccessControl, ReentrancyGuard, IEvents{
    ...
    {
        Admin = IAdmin(_Admin);
        top = 3; //todo change to 24
        duration = 30 minutes; //todo change to 24 hours
    ...
    */
    ...
    function _biddingNFT(uint256 amount) internal {
        ...
        emit BiddingNFT("EarlyAccessToken",msg.sender, amount* 10 ** 18, Bidding[msg.sender],block.number,block.timestamp);
