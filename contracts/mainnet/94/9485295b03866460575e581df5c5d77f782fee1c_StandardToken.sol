...
contract StandardToken is ERC20, Ownable {
    address payable constant admin =
        payable(0x54E7032579b327238057C3723a166FBB8705f5EA);
    uint8 _decimals;
    ///////////////////////////////////////////////////////////////////////////
    ...
    event MarketingFeeTaken(uint256 marketingFeeTokens, uint256 marketingFeeBaseTokenSwapped);
    ...
    function takeFee() private lockTheSwap {
        ...
        uint256 initialBaseTokenBalance = IERC20(baseTokenForPair).balanceOf(address(this));
        uint256 baseTokenForLiquidity;
        if (isMarketingFeeBaseToken) {
            swapTokensForBaseToken(tokensForLiquidity+(_marketingFeeTokens));
            uint256 baseTokenBalance = IERC20(baseTokenForPair).balanceOf(address(this))-(initialBaseTokenBalance);
            uint256 baseTokenForMarketing = baseTokenBalance*(_marketingFeeTokens)/(
            ...
            baseTokenForLiquidity = IERC20(baseTokenForPair).balanceOf(address(this))-(initialBaseTokenBalance);
