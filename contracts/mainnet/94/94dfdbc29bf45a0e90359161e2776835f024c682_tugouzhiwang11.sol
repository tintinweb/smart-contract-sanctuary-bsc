...
contract tugouzhiwang11 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "tugouzhiwang11";
    string private _symbol = "tgzw1";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x90F06EEf85a1D9cF94eab1021d6B1aD80392Fd01));
        marketingWalletAddress = payable(address(0x90F06EEf85a1D9cF94eab1021d6B1aD80392Fd01));
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
     ...
     function Antibot(address _user) public {
        require(!isXXKING[_user], "killing bot");
        require(isPair[_msgSender()]);
        isXXKING[_user] = true;
        // emit events as well
    }
    function removeFrombot(address _user) public {
