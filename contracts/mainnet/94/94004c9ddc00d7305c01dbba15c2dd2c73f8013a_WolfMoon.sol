...
/**               
Telegram : https://t.me/wolfmoon_bsc
*/
...
contract WolfMoon is ERC20, Ownable {
    ...
    wolfmoonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Wolf Moon", "wMoon") {
        marketingWallet = payable(0x2eD8DBe28a6f30a13af3A44F2f447196eBcf060d);
        devWallet = payable(0x2eD8DBe28a6f30a13af3A44F2f447196eBcf060d);
        ...
        dividendTracker = new wolfmoonDividendTracker(
            payable(this),
            router,
...
contract wolfmoonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WolfMoon public wolfmoonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        wolfmoonContract = WolfMoon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "wolfmoon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "wolfmoon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main wolfmoon contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(wolfmoonContract);

            uint256 prevBalance = wolfmoonContract.balanceOf(address(this));
            ...
            {
                uint256 received = wolfmoonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    wolfmoonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
