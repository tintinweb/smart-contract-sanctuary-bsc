...
contract ADOGEDAO is ADOGEDAODeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ADOGEDAOTeam;
    address private CharityADOGEDAO;
    ...
    string public override name = "ADOGE DAO";
    string public override symbol = "ADOGE DAO";
    ...
    constructor(uint totalSupplyValue, address ADOGEDAOTeamAddress, address CharityADOGEDAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ADOGEDAOTeam = ADOGEDAOTeamAddress;
        CharityADOGEDAO = CharityADOGEDAOAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ADOGEDAOTeam] =  totalSupply * 45 / 100;
        balances[CharityADOGEDAO] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's ADOGEDAOTeam pot
