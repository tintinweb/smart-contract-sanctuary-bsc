...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC35B644D5F4585A47ce210DBAe8790E622657832; // owner address
...
contract Kokushibo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kokushibo inu";
    string private _symbol = "KOKUSHIBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7e052762e2ED943E8cAB0B5632A62e56ee9cA971); // Marketing Address
    address payable public buybackWalletAddress = payable(0x7e052762e2ED943E8cAB0B5632A62e56ee9cA971); // Buyback Address
