...
contract SharkBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SharkBTC";
    string private constant _symbol = unicode"SBTC";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x6C4EfFa826e052951B23Fa0b065ad079B753750F); // Marketing Address
    address payable public teamWalletAddress = payable(0x6C4EfFa826e052951B23Fa0b065ad079B753750F); // Team Address
