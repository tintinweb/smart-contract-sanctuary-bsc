...
contract CheemsSoccer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheems Soccer";
    string private _symbol = "CHS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc2eC52A7784eE50E7dAc485E334cBfB7C54c5a98); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc2eC52A7784eE50E7dAc485E334cBfB7C54c5a98); // BuyBack Address
