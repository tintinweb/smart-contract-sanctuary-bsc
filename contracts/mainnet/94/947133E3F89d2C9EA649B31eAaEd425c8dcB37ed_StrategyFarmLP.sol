...
contract StrategyFarmLP is StratManager {
    ...
    function addLiquidity() internal {
        ...
        IERC20 tokenLp0 = IERC20(lpToken0);
        uint256 lp0Bal = tokenLp0.balanceOf(address(this));
        ...
        IERC20 tokenLp1 = IERC20(lpToken1);
        uint256 lp1Bal = tokenLp1.balanceOf(address(this));
