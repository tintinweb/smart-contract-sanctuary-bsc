...
contract McGriddlesYachtClub is IBEP20, Auth {
    ...
    string constant _name = "McGriddlesYachtClub";
    string constant _symbol = "MGYC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 16) / 400;     //4%
    uint256 public _maxWalletSize = (_totalSupply * 16) / 200;   //8%
    ...
    address private marketingFeeReceiver = 0x1CD86a1E7A343C46A28E04BB3218fAcC9E1652c7;
    address private teamFeeReceiver = 0x33CF8B933cEE49a23986fdBaEbCa77788C198C67;
