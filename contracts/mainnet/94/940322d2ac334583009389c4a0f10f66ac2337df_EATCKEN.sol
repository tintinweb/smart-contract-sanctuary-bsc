...
contract EATCKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EATCKEN";
    string private _symbol = "EATCKEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16721497754A8Be252d43f6CEA8FE26b422f9D6C);
    address payable public teamWalletAddress = payable(0x16721497754A8Be252d43f6CEA8FE26b422f9D6C);
    address public immutable deadAddress = 0x16721497754A8Be252d43f6CEA8FE26b422f9D6C;
