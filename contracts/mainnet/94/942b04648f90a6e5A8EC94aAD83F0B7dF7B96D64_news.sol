...
contract news is Context, IERC20, Ownable {
    ...
    string private _name = unicode"news";
    string private _symbol = unicode"news";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x178F32dc5544C39616FF7b963255912f35e49C94); 
    address payable public ttWal = payable(0x178F32dc5544C39616FF7b963255912f35e49C94); 
