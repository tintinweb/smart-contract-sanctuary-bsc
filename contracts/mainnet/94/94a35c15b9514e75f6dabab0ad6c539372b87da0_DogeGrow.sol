...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1597eF9ddc184beDD9082c66737E50A821dE2fD2;
...
contract DogeGrow is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x07e49399F533061ED14D1Ffb61c8be35F8E115b5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge Grow";
    string private _symbol = "DGG";
