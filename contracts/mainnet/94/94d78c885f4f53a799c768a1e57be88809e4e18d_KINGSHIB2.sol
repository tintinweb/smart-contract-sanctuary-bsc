...
contract KINGSHIB2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x07AfB4dA9B4fC723779c6554d52db647F0a8d8c7); 
    address payable public Wallet_Dev = payable(0x07AfB4dA9B4fC723779c6554d52db647F0a8d8c7);
    ...
    string private constant _name = "KingShibaTwo"; 
    string private constant _symbol = unicode"KINGSHIB2.0"; 
