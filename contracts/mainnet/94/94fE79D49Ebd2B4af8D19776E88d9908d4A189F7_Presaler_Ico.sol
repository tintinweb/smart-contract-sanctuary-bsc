...
contract Presaler_Ico is Ownable {
    ...
    address public devWallet = 0x169319e0185495a3a91424fD7152301C6438208B; //dev wallet
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorHardCap = 2000000000000000000; // 2 bnb max bnb Hardcap
