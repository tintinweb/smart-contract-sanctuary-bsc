...
abstract contract DexBaseUSDT {
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(USDT, 3600, 100 * 1e8);
    }
}
...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    constructor(
        ...
        distributor.excludeFromDividends(address(0));
...
contract AiKing is ExcludedFromFeeList, DividendFee, LiquidityFeeUSDT, BurnFee {
    uint256 private constant _totalSupply = 1000_0000_0000 * 1e8;

    constructor()
        ERC20("AiKing", "AiKing", 8)
        DividendFee(10_0000 * 1e8, true, address(USDT), 2)
        LiquidityFeeUSDT(10_0000 * 1e8, true)
        BurnFee()
    {
