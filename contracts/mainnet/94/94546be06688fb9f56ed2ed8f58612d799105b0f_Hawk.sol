...
contract HawkDividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Hawk contract."
        );
    }
...
contract Hawk is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    HawkDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = HawkDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Hawk: The dividend tracker already has that address"
        );

        HawkDividendTracker newDividendTracker = HawkDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "Hawk: The new dividend tracker must be owned by the Hawk token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Hawk: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Hawk: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Hawk: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Hawk: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Hawk: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Hawk: Cannot update gasForProcessing to same value"
        );
