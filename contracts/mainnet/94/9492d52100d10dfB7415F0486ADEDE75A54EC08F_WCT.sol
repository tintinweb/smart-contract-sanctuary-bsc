...
/**
Contract Name: WifeChangingToken
https://t.me/+W_imxWIftcc5YmQ0
*/
...
contract WCT is IBEP20, Auth { // NAME OF YOUR TOKEN
    ...
    string constant _name = "Wife Changing Token"; // NAME OF YOUR TOKEN SAME AS LINE 184
    string constant _symbol = "WC"; // SYMBOL FOR TOKEN
    uint8 constant _decimals = 8; // DECIMALS (1 TO 9)

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  // 3% MAX TX ALLOWED
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100;  // 3% MAX WALLET ALLOWED
    ...
    uint256 liquidityFee = 2; // LP FEE 
    uint256 teamFee = 0; // TEAM/DEV FEE (DEFAULT - 0%)
    uint256 marketingFee = 3; // MARKETING FREE 
    uint256 totalFee = 5; // TOTAL OF FEES 
    uint256 feeDenominator = 100; // DEFAULT - NO NEED TO CHANGE
    
    address private marketingFeeReceiver =0x2A9c25F6a29c51d93DDEd447a33cE042F4965A10; // MARKETING WALLET 
    address private teamFeeReceiver =0x2A9c25F6a29c51d93DDEd447a33cE042F4965A10; // TEAM WALLET (USE MARKETING WALLET IF NO TEAM FEES)
    ...
    constructor () Auth(msg.sender) { // PANCAKE SWAP 
