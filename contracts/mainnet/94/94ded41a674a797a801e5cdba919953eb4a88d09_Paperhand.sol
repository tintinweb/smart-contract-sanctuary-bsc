...
contract Paperhand is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PAPERHAND";
    string private constant _symbol = unicode"$PHAND";
    ...
    address payable public DevWallet = payable(0xe6D04D43f496E111e994102631eE1390b2C6B2f7);
    address payable public MarketingWallet = payable(0x88646C67Ee8992018319aDF0F94576eB20C332e6);
