...
contract SnakeBoy is Context, IERC20, Ownable {
    ...
    string private _name = "SnakeBoy BSC";
    string private _symbol = "$SnakeBoy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x231cf8E8959344b6F1a863Bfe84AF1c402EFa701); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x231cf8E8959344b6F1a863Bfe84AF1c402EFa701); // Team Address
