...
// JulDMaker is MasterChef's left hand and kinda a wizard. He can cook up Sushi from pretty much anything!
// This contract handles "serving up" rewards for xSushi holders by trading tokens collected from fees for Sushi.

// T1 - T4: OK
contract JulDMaker is Ownable {
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "JulDMaker: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "JulDMaker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "JulDMaker: Cannot convert");
