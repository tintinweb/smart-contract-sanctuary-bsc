...
contract BillionaireDev is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Billionaire Dev";
    string private _symbol = "BillionDev";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf429cA79677be564efeAD1a2531463BC277f3267); 
    address payable public BuyBackWalletAddress = payable(0xf429cA79677be564efeAD1a2531463BC277f3267); 
