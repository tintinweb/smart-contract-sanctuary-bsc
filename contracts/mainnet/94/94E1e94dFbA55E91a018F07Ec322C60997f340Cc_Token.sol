...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyHoldDividendFee = 400;   
    uint256 public _buyLPFee = 0;    
    uint256 public _buyFundFee = 400;   

    uint256 public _sellHoldDividendFee = 400;
    uint256 public _sellLPFee = 0;
    uint256 public _sellFundFee = 400;

    uint256 public _transferFee = 900;   //转账扣税
    ...
    constructor (
        ...
        holderCondition = 1100000 * tokenDecimals;

        addLpProvider(ReceiveAddress);
        
        _limitAmount = 5 * tokenDecimals;
       
        _numToSell = 30000000 * tokenDecimals;
    }
