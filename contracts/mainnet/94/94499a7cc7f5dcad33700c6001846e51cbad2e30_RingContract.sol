...
contract RingContract is ERC20Detailed, Ownable {
    ...
    string public _name = "wRing";
    string public _symbol = "wRING";
    ...
    uint256 public ringRiskFreeFundFee = 0;
    ...
    constructor() ERC20Detailed("wRing", "wRING", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x3F61Bf75B89e9b41E5C6d2A5524C5e27D8755C28;
        treasuryFund = 0x04e17991B077d97B0bB26b3ace42d47A42b793dF;
        ringRiskFreeFund = 0x4063e5367cEc0976E6e5540aa65Fac95B7DB4F04;
        supplyControl = 0x25e1dD88661a398967be0f1090495257234FDba4;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no wRING token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
