...
/**
qq群：740913923
tg:https://t.me/+wQNVcEfWGs1iZjgx
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFunFee = 500;
    uint256 public _buyBuybackFee = 50;

    uint256 public _sellFunFee = 300;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transfer(fundAddress,fundAmount_market);
        //
        ...
        IERC20 buyBackToken = IERC20(_buyBackToken);
        uint256 buyBackTokenBalance = buyBackToken.balanceOf(address(this));
        uint256 buyBackToBurn = buyBackTokenBalance / 2;

        buyBackToken.transfer(address(0xdead), buyBackToBurn);
        buyBackToken.transfer(fundAddress, buyBackTokenBalance - buyBackToBurn);
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                try _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0x994Ed6108dbcdCd30355d7ba5939a4fF47e63330), block.timestamp
                ) {} catch { emit Failed_1(); }
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        100000000,//Supply
        address(0xABaD05033dC9ac3D925881b6FdfCd75d38AC61CB),//FundAddress
        address(0x811e81FB9AD70Da7B64319feb6c13B143DDd00Cb),//buybackTokenAddress
        address(0xE82BA7d25f25b12e90074Db1B89076BaF41AD4B5)//ReceiveAddress
    ){
    }
}