...
contract ShiBRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShiBRabbit";
    string private _symbol = "ShiBRabbit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xAc608b9E34949b50D059C48221315923264DbE79); 
    address payable private teamWalletAddress = payable(0xCD48386A6f9f807f79374830ae516a368499e1Db); 
