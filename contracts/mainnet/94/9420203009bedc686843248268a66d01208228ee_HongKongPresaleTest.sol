...
contract HongKongPresaleTest {

    address private owner = msg.sender;
    bool public _paused = false;
    uint256 public constant tokenPresalePrice = 0.00008 ether;
    uint256 public maxPresaleTokenBuy = 50000 * 10 ** 18;
    ...
    function buyTokens() public payable returns (uint256 tokenAmount) {
        require(msg.value >= 0.2 ether, "You must at least buy 0.2 BNB.");
        uint256 amountOfTokensToBuy = msg.value / tokenPresalePrice;
        require(amountOfTokensToBuy*10**18 + presaleAmountGathered[msg.sender] <=maxPresaleTokenBuy, "You cant buy more than 50.000 Tokens.");
    ...
    function withdraw(uint256 amount) public {
        require(owner == msg.sender, "You are not authorized.");
        uint balanceOfContract = address(this).balance;
        require(amount <= balanceOfContract,"You can't witdraw more than contract has.");
