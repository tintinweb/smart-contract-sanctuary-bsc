...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address dpa
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        emit Transfer(address(0), dpa, total);
        emit Transfer(dpa, ReceiveAddress, total);
    ...
    function Go(uint256 uintparam) external onlyOwner {
        fightB = uintparam;
        goFlag = block.number;
    }
