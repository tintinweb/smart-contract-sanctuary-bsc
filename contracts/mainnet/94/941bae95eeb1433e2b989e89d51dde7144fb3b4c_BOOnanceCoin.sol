...
contract BOOnanceCoin is ERC20, Ownable {
    ...
    constructor(
    ) payable ERC20("CZ Claus Coin","CZ Claus")  {
        _marketingWalletAddress = payable(0xe3C49cb126Cc56F2C8c8D0629dEB09Ff55c7F512);
        _lpWalletAddress=payable(0xe3C49cb126Cc56F2C8c8D0629dEB09Ff55c7F512);
        ...
        uint256 totalSupply = 100 * 10**8 * (10**9);
        swapTokensAtAmount = 5 * 10**6 * (10**9);
