...
contract REKKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " King Dunk Tank  ";
    string private _symbol = " $REKKING "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x413c3fdf687C91a7A8F69c6F1A53CbDa4F7bED44); 
    address payable public teamWalletAddress = payable(0x413c3fdf687C91a7A8F69c6F1A53CbDa4F7bED44);
