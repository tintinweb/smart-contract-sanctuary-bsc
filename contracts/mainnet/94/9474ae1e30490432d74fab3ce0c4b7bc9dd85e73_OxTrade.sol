...
contract OxTrade is Context, IERC20, Ownable {
    ...
    string private _name = "0x Trade";
    string private _symbol = "0XT";
    uint8 private _decimals = 18;
    address payable private marketingWalletAddress = payable(0x520b8311d0952Bfd722C27b5942bC39185A2f226); // Marketing Address
    address payable public teamWalletAddress = payable(0x520b8311d0952Bfd722C27b5942bC39185A2f226); // Team Address
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        ISwapRouter _swapRouter = ISwapRouter(newRouterAddress); 

        newPairAddress = ISwapFactory(_swapRouter.factory()).getPair(address(this), _swapRouter.WETH());

        if(newPairAddress == address(0)) //Create If Doesnt exist
        {
            newPairAddress = ISwapFactory(_swapRouter.factory())
                .createPair(address(this), _swapRouter.WETH());
        }
