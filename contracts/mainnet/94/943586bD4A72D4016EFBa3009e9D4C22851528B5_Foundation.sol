...
contract Foundation is Ownable, ReentrancyGuard {
    ...
    function approveToken(
        ...
        token.approve(_spender, _value); //Approval of spacific amount or more, this will be an idependent approval

        emit LogTokenApproval(_tokenAddress, _spender, _value);
    }
}