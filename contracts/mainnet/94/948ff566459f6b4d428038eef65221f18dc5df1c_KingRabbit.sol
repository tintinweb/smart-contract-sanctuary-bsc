...
contract KingRabbit is Context, IERC20 { 
    ...
    string private constant _name = "The King Rabbit";
    string private constant _symbol = unicode"KingRabbit";
    ...
    address payable public DevWallet = payable(0x720C238280714D404444529FFb19BB98F00532a4);
    address payable public MarketingWallet = payable(0x720C238280714D404444529FFb19BB98F00532a4);
