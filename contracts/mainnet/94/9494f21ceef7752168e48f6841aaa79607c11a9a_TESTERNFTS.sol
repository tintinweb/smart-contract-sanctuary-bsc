...
contract TESTERNFTS is Auth, ERC721, ERC721Enumerable {
    ...
    uint256 tLevelOne = 10 * (10 ** _decimals);
    uint256 tLevelTwo = 20 * (10 ** _decimals);
    uint256 tLevelThree = 30 * (10 ** _decimals);
    uint256 tLevelFour = 40 * (10 ** _decimals);
    uint256 tLevelFive = 50 * (10 ** _decimals);
