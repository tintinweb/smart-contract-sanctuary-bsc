...
contract LOVE is ERC20 {
    ...
    uint256 private lpIntervalTime = 10 * 60;
    uint256 private liquidIntervalTime = 60 * 60; 
    ...
    uint256 public liquidFee = 10;

    address public liquidAddress = 0x8072610991D59BeFa8D53bddcf4e6bcA6687eaFF;
    ...
    string internal tokenName = "LOVE";
    string internal tokenSymbol = "LOVE";
    uint256 constant total  =  520131400000 * 10**18;
    ...
    constructor(address tokenOwner) ERC20(tokenName, tokenSymbol) { 
        ...
        swapTokensAtAmount = total / 10000;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair || from == uniswapV2Pair ){
                ...
                uint256 allFee = amount.div(1000).mul(lpFee + liquidFee);
                ...
                LPCount = LPCount.add(allFee.sub(cliquidCount));
                amount = amount.div(1000).mul(1000 - (lpFee + liquidFee));
