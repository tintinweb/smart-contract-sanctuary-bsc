...
contract FomoKey is ERC20 {
    ...
    string public constant name = "KEY#04";
    string public constant symbol = "KEY#04";
    uint8 public constant decimals = 18;
    
    address constant CAKE_FARM = address(0x041a8F3b81e40ca958aa78e3746591cb7744f2d8);
    
    uint256 totalKeys = 300 * (10 ** 18);
