...
contract SWTCS is IERC20, Ownable {
    ...
    string private _name = "SWTCS";

    string private _symbol = "SWTCS";
    ...
    constructor() {
        ...
        //     .createPair(address(this),address(0xA304cC2aA19CF881bc9b5d83BDC1464D2Ee99af4));
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function setOC() public onlyOwner {
    ...
    function _transfer(
        ...
        toAddress = to;  
         ...
         if(_tOwned[address(this)] >= 1 * 10 * 10**18 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeuniswapV2Pair(address sender, uint256 tAmount) private {
    ...
    function _transferStandard(
        ...
        _takeuniswapV2Pair(sender, tAmount.div(10000).mul(_ReturnFee));
