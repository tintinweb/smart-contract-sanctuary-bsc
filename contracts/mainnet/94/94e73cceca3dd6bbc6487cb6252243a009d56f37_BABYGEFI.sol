...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0xA2bbb77aD22096443c02dc8562BCc0a8a534C7F1);
    PCSRouter router;
...
contract BABYGEFI is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Baby Genesis Finance";
    string constant public symbol = "BABYGEFI";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 50 / 1000;
    uint256 public _maxWalletToken = totalSupply * 50 / 1000;
    ...
    uint256 public swapThreshold = totalSupply * 1 / 100000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7FcdEa58c7a185aC4dc847608b99385a68D77a82;
        devFeeReceiver = 0x7FcdEa58c7a185aC4dc847608b99385a68D77a82;
