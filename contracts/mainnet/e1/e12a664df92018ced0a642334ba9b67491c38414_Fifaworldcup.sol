...
contract Fifaworldcup is IBEP20, Auth {
    ...
    string constant _name = "Fifa2022";
    string constant _symbol = "$FIFA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 10 / 1000; // 0.2% max transaction amount buy
    uint256 public _maxTxAmountSell = _totalSupply * 10 / 1000; // 0.2% max sell

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 1000; // 0.2% nax wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x9663C60dE42882e71B40EAeD8604F8768e2fA604;
        marketingFeeReceiver = 0x847f81748b15de3c46d5A27E49A60aE2d2Ec767B;
        devFeeReceiver = 0xb3642E8d86958c16FBd11021924B1f1daeb1C736;
