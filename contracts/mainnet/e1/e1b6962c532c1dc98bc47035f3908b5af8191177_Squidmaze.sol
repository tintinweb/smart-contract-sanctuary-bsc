...
/**
 Squidmaze
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat Squidmaze designed.
    
    I make this #Squidmaze to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/Squidmaze
   ...
   I will renounce the ownership to burn addresses to transfer #Squidmaze to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 50% total supply to the pool
   Can you make #Squidmaze 100000X? 
   ...
   it's the best part of the #Squidmaze idea, increasing the liquidity pool automatically, 
...
pragma solidity ^0.6.12;
    ...
    contract Squidmaze is Context, IERC20, Ownable {
        ...
        string private _name = 'Squidmaze';
        string private _symbol = 'Squidmaze';
