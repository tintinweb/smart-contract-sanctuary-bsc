...
interface IJoeRouter02 is IPancakeSwapRouter01 {}
...
*/
contract KandyZapPancakeSwap is Ownable, ReentrancyGuard {
    ...
    address public constant wbnbAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WETH
    ...
    function swap(
        ...
        address _token0 = IPancakePair(_lp).token0();
        (uint256 _res0, uint256 _res1, ) = IPancakePair(_lp).getReserves();
