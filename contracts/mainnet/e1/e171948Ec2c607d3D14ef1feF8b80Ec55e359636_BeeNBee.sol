...
contract BeeNBee {
    ...
    function withdrawETH(uint amount) external {
        require(msg.sender == owner, "Administrator permissions");
        require(amount > 0);
        require(address(this).balance >= amount, "Contract bnb funds are insufficient to pay");
