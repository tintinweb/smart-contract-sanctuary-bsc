...
// https://t.me/MoonScapeBSC
// Moon ScAPE - an ape based p2e game!
...
contract MoonScAPE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MoonScAPE";
    string constant _symbol = "MoonScAPE";
    ...
    uint256 _totalSupply = 2147000000 * (10 ** _decimals);
