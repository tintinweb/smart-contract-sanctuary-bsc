...
contract crashtest is Context, IERC20, Ownable {
    ...
    string private constant _name = "crashtest"; // 
    string private constant _symbol = unicode"crashtest"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x649468691af371BbC210b693dce6122776E87272).transfer(ethToSend); //marketing wallet
    }
