...
contract MCLT_FACTORY is ERC721, Ownable {
    using SafeMath for uint256;
    uint public MAX_MINT = 500;
    bool public hasSaleStarted = false;
    
    address payableAddress = 0x768021F929e2f098F8956b5E50075EE057C0a781;

    constructor(string memory baseURI) ERC721("MCLITTLETIGER NFT", "MCLT") {
        setBaseURI(baseURI);
    }
