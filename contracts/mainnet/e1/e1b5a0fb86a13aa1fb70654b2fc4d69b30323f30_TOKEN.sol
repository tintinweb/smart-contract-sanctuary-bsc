...
contract Ownable {
    ...
    constructor(address _addr) {
        _owner = 0x4D5f030bA8C513698bC74eda46D3A9BF59E1e5Dd;
...
Ownable {
    ...
    address public fund_addr = 0x4D5f030bA8C513698bC74eda46D3A9BF59E1e5Dd;
    ...
    constructor() Ownable(msg.sender) {
        ...
        _mint(0x4D5f030bA8C513698bC74eda46D3A9BF59E1e5Dd, 200000000 * 10 **18);

        isFree[0x4D5f030bA8C513698bC74eda46D3A9BF59E1e5Dd] = true;
    ...
    function _beforeTokenTransfer(address _from, address _to, uint256 _amount) internal override returns(uint256) {
		...
		if (isLpAddr[_from]){
			...
			if(buy_game_time_lists[_to]!=day){
				buy_game_time_lists[_to]=day;
