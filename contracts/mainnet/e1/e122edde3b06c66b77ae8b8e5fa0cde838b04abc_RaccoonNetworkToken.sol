...
contract RaccoonNetworkToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Raccoon Network Token";
    string private _symbol = "RAC"; //SuperSQUID
    ...
    address payable public marketingWalletAddress = payable(0x8201560B825be53C6718Cb4f5d629f783880177d);
