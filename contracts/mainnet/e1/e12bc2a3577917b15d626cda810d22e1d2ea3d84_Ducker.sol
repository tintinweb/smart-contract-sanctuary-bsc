...
contract Ducker is IERC20, Ownable {
    ...
    address private constant development_receiver = 0x1eF5F48B43780ABc741839f97F9DCEA557ff4242; 
    address private constant marketing_receiver = 0x2336B539F72Ef251D287bEAf6dFA578d791BE0E0;
    address private constant liquidity_receiver = 0x376C111bC2a9858f0Cd2bdf016a6A2360D31CD1c;
    ...
    function setParameters(uint256 _purchasePercent, uint256 _transferPercent, uint256 _walletPercent) external onlyOwner {
        uint256 newTx = (totalSupply() * _purchasePercent) / 10000;
        uint256 newTransfer = (totalSupply() * _transferPercent) / 10000;
        uint256 newWallet = (totalSupply() * _walletPercent) / 10000;
        _maxTxAmountPercent = _purchasePercent;
        _maxTransferPercent = _transferPercent;
        _maxWalletPercent = _walletPercent;
