...
contract LawShiba is IBEP20, Auth {
    ...
    string constant _name = "Law Shiba";
    string constant _symbol = "LSHIBA";
    ...
    uint256 public swapThreshold = _totalSupply / 3000 * 100; // 0,3.00%
    bool inSwap;
