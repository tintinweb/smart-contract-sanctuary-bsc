...
library Address{
 ...
 contract NewMoon is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA9abaa528594dCD0e8aA3B116eA81c5d21aF087c;
    address public donationWallet = 0xA9abaa528594dCD0e8aA3B116eA81c5d21aF087c;
    ...
    Taxes public taxes = Taxes(0, 10, 2, 10);
    Taxes public sellTaxes = Taxes(0, 10, 5, 10);
