...
contract NFTWeb3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "NFT Web3"; // 
    string private constant _symbol = "$NFT Web3"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x100Ed5b23EB18E07E07b882cdAF9AAF0A49b31A2;
