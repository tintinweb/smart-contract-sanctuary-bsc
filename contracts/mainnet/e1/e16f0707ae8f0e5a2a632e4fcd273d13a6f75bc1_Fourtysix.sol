...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80E2294CdAFb459f3152CCD6d6D4859a3C51314E; 
...
contract Fourtysix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "46";
    string private _symbol = "46";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF546e884f9eD2951EdF37DE2A3347afbEf4e093e); // 
    address payable public teamWalletAddress = payable(0x80E2294CdAFb459f3152CCD6d6D4859a3C51314E); // 
    ...
    uint256 private _totalSupply = 4600 * 10**_decimals;
    uint256 public _maxTxAmount = 92 * 10**_decimals; 
    uint256 public _walletMax = 92 * 10**_decimals;
