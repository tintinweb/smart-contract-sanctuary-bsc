...
contract T2GNL is IERC20 {
    ...
    string constant private _name = "T2GNL";
    string constant private _symbol = "T2GNL";
...
//===============================================================================================================
    ...
    function setRatios(uint16 lp, uint16 tokens, uint16 swap) external onlyOwner {
        _ratios.lp = lp;
        _ratios.tokens = tokens;
        _ratios.swap = swap;
        _ratios.total = lp + tokens + swap;
    }
    ...
    function contractSwap() internal lockTheSwap {
        ...
        uint256 contractTokenBalance = balanceOf(address(this));
        uint256 amountToLiquify = contractTokenBalance * (_ratios.lp) / (_ratios.total) / (2);
