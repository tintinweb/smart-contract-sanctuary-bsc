...
contract FourTwentyGate is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x45f2230e981DEbCf8bC93Ec524a3d519c142d1ba;
    ...
    string private _name = "FourTwenty Gate";
    string private _symbol = "FOURTWENTY";
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
        {
            ...
            require(!botList[from], "address is botList");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        emit SwapAndLiquify(half, newBalance, otherHalf);
          ...
          function setBlacklistBot(address bot, bool blacklist) public onlyOwner{
        botList[bot] = blacklist;
    }
