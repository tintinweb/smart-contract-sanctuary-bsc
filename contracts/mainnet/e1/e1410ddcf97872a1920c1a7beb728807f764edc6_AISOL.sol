...
contract AISOL is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "AI Solona";
    string constant _symbol = "AISOL";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x1f0D1b30CD79585b855965d9be7B53f8eF438b9A; // liquidity
