...
TELEGRAM: https://t.me/VivaMagentaRabbit
*/
...
contract VivaMagentaRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Viva Magenta Rabbit ";
    string private _symbol = " VMR "; 
