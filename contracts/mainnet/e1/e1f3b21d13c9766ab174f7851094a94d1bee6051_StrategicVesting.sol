...
contract StrategicVesting is Ownable {
	...
	/* the whitelist of the Strategic vesting */
	...
	function _vestedAmount(address addr) private view returns (uint256) {
		...
		// linear part during 1 month cliff + 18 months
		} else {
			uint256 initialAmount = balanceOfINERY[addr].mul(7).div(100); // 7% after cliff time
