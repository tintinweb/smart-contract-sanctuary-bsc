...
contract BeeChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bee Chain";
    string private _symbol = "BEE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x497CB367933942e1C14bc7FfB0D2CaF9b8d39E89); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x04DE778627c0D1654ABA2ab66c7EE24705474C03); // Development Address
    ...
    uint256 public _walletMax = 10 * 10**6 * 10**18;
