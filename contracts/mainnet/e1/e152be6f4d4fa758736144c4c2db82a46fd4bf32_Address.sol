...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc7DE0c3F57AC4C56738A980AE19dA9B97d526Bf2ca82273b7bfad8045d85a470 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0xc7DE0c3F57AC4C56738A980AE19dA9B97d526Bf2ca82273b7bfad8045d85a470;
