...
/* 
Tiki Rabbit 是 BSC 上的一种模因加密货币。
 但它有可能在未来发挥作用。 
 TIki 在 2022 年非常有名，结合 Rabbit 炒作，我们创建了 Tiki Rabbit，
 目标是在 2023 年成为最好的 meme 加密货币。我们提供低税收，
 因此您可以以低费用进行交易，并放心放弃所有权。


https://t.me/tikirabbitportal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73b7c09c5846194d639a603C2D80326897dd5089; 
...
contract TikiRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiki Rabbit";
    string private _symbol = "TIRAB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73b7c09c5846194d639a603C2D80326897dd5089); 
    address payable public teamWalletAddress = payable(0x73b7c09c5846194d639a603C2D80326897dd5089); 
