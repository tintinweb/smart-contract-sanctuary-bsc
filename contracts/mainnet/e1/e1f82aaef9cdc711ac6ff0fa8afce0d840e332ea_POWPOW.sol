...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    function GetExclusions() public view returns(bool MaxTx, bool Fees, bool Blacklist, bool Whitelist){return (_isExcludedFromMaxTx[msg.sender], _isExcludedFromFees[msg.sender], _isBlacklisted[msg.sender], _isWhitelisted[msg.sender]);}
