...
contract NekoZilla is IBEP20, Ownable {
    ...
    string private _name = "Neko Zilla";
    ...
    uint8 private constant BLACKLIST_BLOCKS = 60; //number of blocks that will be included in auto blacklist
