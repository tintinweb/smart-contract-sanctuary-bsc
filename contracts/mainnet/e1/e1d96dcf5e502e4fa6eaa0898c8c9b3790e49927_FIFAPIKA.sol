...
contract FIFAPIKA is Context, IERC20 { 
    ...
    string private constant _name = "FIFA PIKA"; 
    string private constant _symbol = unicode"FifaPika"; 
