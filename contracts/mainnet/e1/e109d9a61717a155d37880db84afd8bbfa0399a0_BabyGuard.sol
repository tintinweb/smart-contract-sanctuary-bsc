...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 GUARD = IERC20(0xF606bd19b1E61574ED625d9ea96C841D4E247A32);
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x05E61E0cDcD2170a76F9568a110CEe3AFdD6c46f);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GUARD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WETH;
        path[1] = address(GUARD);
        ...
        uint256 amount = GUARD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GUARD.transfer(shareholder, amount);
...
contract BabyGuard is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address GUARD = 0xF606bd19b1E61574ED625d9ea96C841D4E247A32;
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Guard";
    string constant _symbol = "BGUARD";
    ...
    mapping (address => bool) prelauncher; //only for owner and LP
    ...
    address public marketingFeeReceiver=0xAF2eE3C937B11D3C5e0d55ceCe77C76dDE3D0ED7;
    ...
    constructor (
        ...
        prelauncher[msg.sender] = true;
        prelauncher[pair] = true;
        prelauncher[_dexRouter] = true;
        prelauncher[address(this)] = true;
        _isFree[address(this)] = true;
        _isFree[msg.sender] = true;
        _isFree[pair] = true;
        _isFree[_dexRouter] = true;
        _isFree[distributorAddress] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		// Max  tx check
		address routerAddress = 0x05E61E0cDcD2170a76F9568a110CEe3AFdD6c46f;
        ...
        if (!prelauncher[sender] && !prelauncher[recipient]) {
            require(GOGOGO == true);
        }
...
//        emit Transfer(sender, recipient, amount);
    ...
    function RescueTokens(address tknAddress) public authorized {
    ...
    function blacklistThatMadafacka(address holder) public authorized {
        blacklisted[holder] = true;
    }

    function heWasntNaughty(address holder) public authorized {
        require(blacklisted[holder] == true, "was never naughy, uh");
        blacklisted[holder] = false;
    }

    function checkBlacklist(address holder) public view authorized returns(bool) {
        return blacklisted[holder];
    }
    ...
    function burnBabyBurn(uint256 amount) public {
