...
interface IBEP20DieProtocol is IBEP20 {
    /**
...
contract BEP20 is Context, IBEP20, IBEP20DieProtocol {
...
contract DieProtocol  is BEP20, Ownable {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 100e13, "Swap threshold amount should be lower or equal to 1% of tokens");
