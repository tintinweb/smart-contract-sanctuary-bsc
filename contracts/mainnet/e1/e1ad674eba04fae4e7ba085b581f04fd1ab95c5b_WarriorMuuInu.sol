...
TELEGRAM: https://t.me/WARRIORMUUINU
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd0499f4793992DbAb22aDbb42460924A8f4dA155;
...
contract WarriorMuuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "WARRIOR MUU INU"; // 
    string private constant _symbol = "$WMI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x3EC749F9AbE090DE9C0f4579F3Ca7bE66fd4eaD9);
