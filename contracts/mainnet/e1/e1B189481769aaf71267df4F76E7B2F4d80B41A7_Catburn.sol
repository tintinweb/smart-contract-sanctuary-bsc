...
contract Catburn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Catburn";
    string constant _symbol = "CATB";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 250; // 200
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x7c8C5722C25Dc73F79a4c7D361084aD8831Df5A1; 
