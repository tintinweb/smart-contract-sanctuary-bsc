...
/**
https://t.me/AngelsDusted

The very first auto staking protocol to pay out Anal Dust REWARDS! While celebrating the fall of Angel Dust!
...
contract AngelsDusted is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Angels Dusted';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x647a3E7Bf64240c8E0219cE7fE913D526C311953);
    address public Development=payable(0x81035AAAbdbfc7A82eE0FfeFFA89E1b30CD0FFbD);
    //TestNet
    ...
    function claim(address addr) public{
        ...
        path[1] = 0x313bf7fCd96b8B9A924633284D4bF92546a63869;  //Binance-Peg BUSD Token
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(MarketingWallet).transfer((amount*70) / 100);
