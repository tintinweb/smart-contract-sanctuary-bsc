...
contract MiracleDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiracleDoge";
    string private _symbol = "MD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA21c35Cc60d5CD6ece6779EcF430767f121C104a);
    address payable public teamWalletAddress = payable(0xA21c35Cc60d5CD6ece6779EcF430767f121C104a);
