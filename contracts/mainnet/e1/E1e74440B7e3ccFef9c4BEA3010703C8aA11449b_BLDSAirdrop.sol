...
contract BLDSAirdrop is Ownable {
  ...
  function airdropTokens(address _recipient) public {
    uint256 airdropped;
        require(!wasPaid[_recipient], "You have already claimed your airdrop."); 
         require(token.balanceOf(address(this)) >= airdropAnount * decimalFactor, "Insufficient balance in contract.");
          wasPaid[_recipient] = true;
        token.transfer(_recipient, airdropAnount * decimalFactor);
