...
contract BabyCryptoCreepers is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Crypto Creepers";
    string private _symbol = "BABYCRYPTO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xB0DA2491c9026665Fb402AD739bEe30B640C504D);
