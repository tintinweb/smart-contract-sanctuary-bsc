...
contract ChipRaceContract is IERC721Receiver, Ownable {
    ...
    constructor(ERC721Enumerable g_firstAddress,ERC721Enumerable _secondAddress, IERC20 _tokenAddress) {
    ...
    function claimRewards(uint256 _tokenId) external {
        ...
        TokenInfo storage info = g_tokenInfo[_tokenId];
        uint256 amount = g_minableAmount[carType][info.level] * g_lockTime;
