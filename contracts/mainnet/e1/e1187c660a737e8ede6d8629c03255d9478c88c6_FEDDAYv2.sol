...
contract FEDDAYv2 is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FEDDAYv2";
    string private _symbol = "FEDDAYv2";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x46b93a7C9C3667e0c950CC6e275897672a2Fc392); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x46b93a7C9C3667e0c950CC6e275897672a2Fc392); // BuyBack Address
