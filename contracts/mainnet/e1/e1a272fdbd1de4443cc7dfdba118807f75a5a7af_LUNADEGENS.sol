...
contract LUNADEGENS is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Luna Degens";
    ...
    uint256 public _maxTxAmount = 15 * 10**6 * 10**18;
    uint256 public _maxWalletHoldingLimit = 15 * 10**6 * 10**18;
