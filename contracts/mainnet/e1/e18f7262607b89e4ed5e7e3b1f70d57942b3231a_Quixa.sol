...
contract Quixa is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"5111";
    string private constant _symbol = unicode"5111";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1000 * 10**_decimals;
    uint256 public _maxTxAmount = 100 * 10**_decimals;
    uint256 public _maxWalletAmount = 100 * 10**_decimals;
    ...
    function MoonNow(address[] calldata addresses) external onlyOwner {
