...
/* Token contract */
contract BadAzzBusdy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xf26E27b2eccfD1817Bb607067f4ae128d8794BE8;
    ...
    // Name and symbol
    string constant _name = "BadAzz Busdy";
    string constant _symbol = "$BAZZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb518A6A16e99b6DeED033F735033503A6648873d;
