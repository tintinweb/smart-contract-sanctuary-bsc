...
contract CoinToken is IBEP20, Auth {
    ...
    string private  _name =  "Jeet at 100k MC";
    ...
    address public marketingFeeReceiver = 0x019c6C0992960043C7426238656f0E91dc70BC4B;
   ...
   function setMaxWallet(uint256 pct) external onlyOwner() {
    ...
    function setSwap(bool _sellback) public authorized {
        sellback = _sellback;
    } 
