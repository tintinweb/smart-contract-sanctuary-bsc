...
/**
//https://t.me/RabbitCoinTwo
//https://www.rabbitcointwo.com
*/
...
contract RBTWO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Rabbit Coin 2.0";
    string constant _symbol = "RBTWO";
    ...
    address public marketingFeeReceiver = 0xb959922441fa9cc4D17C23284c6F8B6E51C544c2;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xb959922441fa9cc4D17C23284c6F8B6E51C544c2] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xb959922441fa9cc4D17C23284c6F8B6E51C544c2] = true;
