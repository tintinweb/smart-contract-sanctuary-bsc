...
contract CGT_LV_SMALL is ERC721A, Ownable {
    uint256 public PRE_MINT_SUPPLY;
    uint256 public PRE_MINT_MAX_SPPLY = 81;
    ...
    string _baseTokenURI =
        "https://api.cryptoverse.vip/binance/voucher/metadata/small/1";
    ...
    constructor(address launchpad) ERC721A("CGT_LV_SMALL", "CGT_LV_SMALL") {
        LAUNCHPAD = launchpad;
    }
