...
contract QAtarWorldCup is Context, IERC20, Ownable {
    ...
    string private _name = "QAtarWorldCup";
    string private _symbol = "QAtarWorldCup";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xEd001813c0398f6BFeA91Bb50Dc66DD748Ce0650); 
    address payable private teamWalletAddress = payable(0x65FeAAbd68065B890B8428063b77C82F61Fe64fd); 
