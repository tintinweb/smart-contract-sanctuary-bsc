...
Tokenomics
Liquidity 5% | Charity 1% | Development 3% | Burn 2%
*/
...
contract COINED is IBEP20, Auth {
    ...
    string constant _name = "COINED";
    string constant _symbol = "COINED";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2 * 10**15 * 10**_decimals; // 2 Quadrillion Tokens
    ...
    uint256 public totalFee        = developmentFee + charityFee + liquidityFee + burnFee;
    ...
    uint256 private burnTokensAmount;
    ...
    constructor () Auth(msg.sender) {
        ...
        charityFeeReceiver = 0x2b98260FE4b9b4E2F8e19F10d430e636525dDfCd;
        developmentFeeReceiver = 0x2b98260FE4b9b4E2F8e19F10d430e636525dDfCd;
    ...
    function TokensBurn(uint256 _amount) public onlyOwner {
        burnTokensAmount = _amount;
    }
    ...
    function checkWalletLimit(address sender, uint256 amount) internal view {
        require(amount <= _maxWalletToken || isWalletLimitExempt[sender], "Wallet Limit Exceeded");
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _charityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
        charityFee = _charityFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_developmentFee).add(_charityFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _charityFeeReceiver, address _burnFeeReceiver, address _developmentFeeReceiver) external authorized {
