...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E); // TECH TREES COIN CA
...
contract DogeTV is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DogeTv";
    string constant _symbol = "DTV";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E;
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet = 0xd063A73437f6DcCdC4f1bf7bAA42106F9B204d3e;  // team
