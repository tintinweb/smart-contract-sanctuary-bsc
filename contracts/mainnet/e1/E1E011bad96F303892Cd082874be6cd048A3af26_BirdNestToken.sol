...
contract BirdNestToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bird Nest";
    string private _symbol = "BirdNest";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8FC4Add5a50ba045DFC062aB6e26A32974958B49); 
    address payable public buyBackWalletAddress = payable(0xF4238715807FbEde7dC22955f29E805CFe30Bf94); 
    ...
    uint256 private _totalSupply            = 91000 * 10**9;
    uint256 public _maxTxAmount             = 2730 * 10**9;
    uint256 public _walletMax               = 2730 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2730 * 10**3; 
