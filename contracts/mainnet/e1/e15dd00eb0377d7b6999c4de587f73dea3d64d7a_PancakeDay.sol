...
contract PancakeDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PancakeDay";
    string private _symbol = "$CAKEDAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFB6A843836098Bc5157B588cbF86AfD4A0d0Dd5f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xFB6A843836098Bc5157B588cbF86AfD4A0d0Dd5f); // BuyBack Address
