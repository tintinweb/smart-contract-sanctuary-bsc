...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x77441Cc0de1C086e1FF67585fd29adD1Fd2F7c16;
...
contract OnlyBabyInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Only Baby Inu"; 
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x77441Cc0de1C086e1FF67585fd29adD1Fd2F7c16), BNB_Tot);
            }
