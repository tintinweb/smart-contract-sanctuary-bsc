...
contract SUPERZHAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUPER ZHAO"; // 
    string private constant _symbol = "SUPER ZHAO"; //    
