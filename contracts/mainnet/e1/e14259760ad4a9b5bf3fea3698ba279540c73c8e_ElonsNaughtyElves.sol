...
contract ElonsNaughtyElves is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Elons Naughty Elves";
    string  _symbol = "ENE";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 42 * 10**7 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x4ac451fC123C4e954171EB3D6E038c38027d6af5;
        teamFeeReceiver = 0x4ac451fC123C4e954171EB3D6E038c38027d6af5;
        devFeeReceiver = 0x02aDDA653574d203c9D6A8e1cd912D0462847F6e;
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        require(totalFee < feeDenominator/2, "Fees cannot be more than 30%");
    }
