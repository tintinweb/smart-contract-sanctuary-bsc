...
abstract contract Auth {
     ...
     */
    function initauthorizeVouchCoin(address _auth) public onlyOwner {
...
contract VouchCoin is IBEP20, Auth {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "VouchCoin";
    string constant _symbol = "VouchCoin";
    ...
    function changeVouchCoinFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
