...
/**
Telegram : https://t.me/bubbleteasafemoon
*/
...
contract BUBSAFE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bubble Tea Safemoon";
    string private _symbol = "BUBSAFE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x74E9A20bD1cCBC9494cbb2441acc5FD2758D6949); // Marketing Address
    address payable public teamWalletAddress = payable(0x74E9A20bD1cCBC9494cbb2441acc5FD2758D6949); // Team Address
