...
contract TOKEN is ERC20, Ownable {
    ...
    string public name_ = "ALG";    
    string public symbol_ = "ALG";   



    uint256 public deadFee = 0;   //销毁
    uint256 public liquidityFee = 0;    //回流
    uint256 public marketingFee = 2;    //营销bnb
    uint256 public foundationFee = 0;    //营销本币
    uint256 public lpRewardFee = 4;     //LP分红比例
    address public lpRewardToken = 0x55d398326f99059fF775485246999027B3197955; 

    uint256 public maxsell = 200000000 * (10**18); 
    uint256 public maxbuy = 200000000 * (10**18); 
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply.mul(1).div(10000); // 0.002%;
        ...
        marketingWalletAddress = 0x84091Ec2B183B18EeD814d47Ba88854258d5FEC3;   //营销钱包地址 bnb
        foundationWalletAddress = 0x84091Ec2B183B18EeD814d47Ba88854258d5FEC3;   //营销本币
