...
contract FalconPool is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public totalDistributed; // Total FLN distributed to holders.
     ...
     */
    function _harvest(address _wallet) internal virtual {
        ...
        if (amount > 0) {
            ...
            FLN.safeTransfer(_wallet, amount);
     ...
     */
    function _compound(address _wallet) private {
        _processRewards(_wallet);
        uint256 amount = stakeHolders[_wallet].pendingTokenbal;
        if (amount > 0) {
            stakeHolders[_wallet].pendingTokenbal = 0;
            ...
            emit AddedPoints(_wallet, amount);
        }
    }
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        FLN.safeTransferFrom(_msgSender(), address(this), _amount);
    ...
    /**
     * @notice Check amount of FLN per block for APY calculation.
     * @return uint256 amount of FLN per block.
     */
