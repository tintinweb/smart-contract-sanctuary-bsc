...
contract LunaPEPE is BEP20, Auth {
    ...
    string public constant name = "LunaPEPE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketerFeeReceiver = 0x0137Dd039A17d92F3e98461569FeFE42A7a5EbE0;
        teamFeeReceiver = 0x0137Dd039A17d92F3e98461569FeFE42A7a5EbE0;
        devFeeReceiver = 0x0137Dd039A17d92F3e98461569FeFE42A7a5EbE0;
    ...
    function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier).div(100) <= 340, "Sell tax cannot be more than 34%");
