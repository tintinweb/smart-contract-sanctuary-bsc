...
Welcome to APEROCKET
   ...
   I will renounce the ownership to burn addresses to transfer #APEROCKET to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 50% total supply to the pool
   Can you make #APEROCKET 10000X? 
   ...
   it's the best part of the #APEROCKET idea, increasing the liquidity pool automatically, 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B0292823dc2d0473b3b819e845C58aDE5043BEA;
...
contract APEROCKET is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x4B0292823dc2d0473b3b819e845C58aDE5043BEA);
    ...
    */
    ...
    string private _name = "APEROCKET"; 
    string private _symbol = "APEROCK";  
