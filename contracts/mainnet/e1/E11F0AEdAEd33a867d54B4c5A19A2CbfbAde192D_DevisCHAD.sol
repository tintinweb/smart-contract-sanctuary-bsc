...
contract DevisCHAD is Context, IERC20, Ownable {
    ...
    string private _name = "Dev Is CHAD"; 
    string private _symbol = "$CHAD"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x147bd242056427692f7615C56AE131aeA9F592F5); 
    address payable public teamWalletAddress = payable(0xb2bb9BCCAe131B4D7C4Ff1dBED274c3fa0fE427f); 
