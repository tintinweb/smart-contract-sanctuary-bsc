...
interface IDEXRouter {
    ...
    contract WTF1314BONK23 is IBEP20, Auth {
    ...
    string constant _name = "1314BONK23";
    string constant _symbol = "1314BONK23";
    uint8 constant _decimals = 6;

    uint256 _totalSupply =131423 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xb00b595F92e3412Ccee6e698a7B5249203ef5fdd;
    address public devFeeReceiver = 0x5010Ada3DdE5563F8802dF5103db2fe1B22d929C;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD) {
            require(isTxLimitExempt[recipient] || _balances[recipient] + amount <= _maxWalletSize, "Transfer amount exceeds the maxWallet Amount.");
        }
        if (sender == pair &&
            opCooldownEnabled &&
            !isTimelockExempt[recipient]) {
            require(cooldownTimer[recipient] < block.timestamp,"Cooldown is enabled. Please wait 1 Minute for the next Transaction");
