...
contract IMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Imperial Obelisk";
    string private constant _symbol = "IMP";

    address public _PancakeSwapV1RouterUniswap = 0xdE039CDb56AE2927F51B5719592Bc0c8658A4495; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xdE039CDb56AE2927F51B5719592Bc0c8658A4495; //can be the same
