...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa1c6294647E23b81E33DCD923618C0132CF56CA7;
...
contract Dumpling is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8750FA754A96B2b410322CD9450a68FE6F270753;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Dumpling";
    string private _symbol = "DUMP";
