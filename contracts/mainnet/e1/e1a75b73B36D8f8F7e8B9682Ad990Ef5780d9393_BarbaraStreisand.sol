...
contract BarbaraStreisand is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x673fAf5c09808B5a11C4EBb0C7A9551B75689534); 
    address payable public Wallet_Dev = payable(0x2e277d6DDc9e5d5B74a5Deb5d06B4AB2249d43F3);
    ...
    string private constant _symbol = unicode"BARBARA";
    ...
    constructor () {
        ...
        _owner = 0x2e277d6DDc9e5d5B74a5Deb5d06B4AB2249d43F3;
