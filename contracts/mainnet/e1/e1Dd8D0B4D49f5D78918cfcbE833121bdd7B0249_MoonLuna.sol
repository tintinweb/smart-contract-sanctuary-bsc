...
/**
   https://t.me/MoonLunaBSC

   "Luna", translated from spanish to english means "Moon"
    
   Luna (TERRA), token that seemed dead, made it back to Moon with a pump of over 2.000X

   MoonLuna is planned to be a community token & will launch during Saturday 14th May. Locked & Renounced to prove the safety.

   3% taxes 

   3BNB initial LP, 50% tokens burned, 50% added to liquidity

   1,000,000,000,000 total supply
   Max trade is limited to 1% supply at launch, increased to 2% before renouncing.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAcF897abE6996837Cf2f3F3b3D2D205B35650BC7;
...
contract MoonLuna is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xAcF897abE6996837Cf2f3F3b3D2D205B35650BC7);
