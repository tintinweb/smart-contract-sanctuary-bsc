...
contract SmilingandStaring is Context, IERC20, Ownable { 
    ...
    string private _name = "Smiling and Staring"; 
    string private _symbol = "Live Webcam";  
