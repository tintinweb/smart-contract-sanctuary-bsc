 ...
 */
contract KingdomOfDwarvesmetaverse{
    using SafeMath for uint256;

    uint256 private _totalSupply = 1*10**6 * 10**18;
    string private _name = "KingdomOfDwarvesMetaverse";
    string private _symbol = "KODMetaverse";
    ...
    uint256 private salePrice = 5000; // 1 BNB
    ...
    constructor() public {
        _devAddress = 0x09B811255D125FE2e63FD8fB265C33Dd784B58CE; // LA
        _presaleAddress = 0x4DdCA33F80591db1b0a0f3b9E3F520F7f58867c6; // TO
        address _BurnAddress = 0xe7F7F8AC924a1054398914b4DB395fFfB6A309F3; // MA
        _owner = msg.sender;

        
        _mint(_presaleAddress, 500000*10**18);

    
        _mint(_devAddress, 400000*10**18);

    
        _mint(_BurnAddress,100000*10**18);
    }
   ...
   function endPresale() public onlyOwner {
    ...
    function buyPresale(address _refer) payable public returns(bool){
        ...
        uint referToken = _token.mul(_referToken).div(5000);
