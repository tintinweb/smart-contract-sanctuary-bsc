...
abstract contract Ownable{
    ...
    constructor(address deployer) {
        ...
        emit OwnershipTransferred(deployer);
    }
...
abstract contract baseContract is  IBEP20 , Ownable {
    ...
    constructor(address _routerAddress,address deployer,string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply) payable Ownable(deployer) {
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        marketingAddress = [msg.sender,0xd0250353fc8Ac86CB417FB9444be2d617E48dA6f];
        marketingShare=[150,50];
        router = IDEXRouter(_routerAddress);

        limit=Limit(1000,1000,false,1000);
        autoSwap=AutoSwap(true,true,5,50,10000);
        allot=Allot(6,2,0,2,10);
...
contract Token is baseContract { 
    constructor() baseContract(address(0x10ED43C718714eb63d5aA57B78B54704E256024E),address(0x39Ee5F5B81a25dc48CA078cC3Bc0b8e4556309d8),"FreeGrow","FreeGrow",18,1000 * 10 ** 12){
    } 
}