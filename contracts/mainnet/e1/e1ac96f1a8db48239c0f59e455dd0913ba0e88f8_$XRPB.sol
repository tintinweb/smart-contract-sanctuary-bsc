...
contract $XRPB is Context, IERC20, Ownable {
    ...
    string private constant _name = "XRP Black";
    string private constant _symbol = "$XRPB";
    ...
    address public marketingWallet = address(0x50e62A8f6Ccca9a0afc7F7613Ea7Ae489D3Ed72B);
    ...
    function Blacklist() public onlyOwner { 
