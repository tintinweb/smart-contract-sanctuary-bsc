...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeC7E4F87c3baD4f3e9fA09c8d567FBFeD83Fd3a9; // owner address
...
contract JackMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JackMoon";
    string private _symbol = "JACKMOON";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x40956C29E4a61AA08ef1eE254467EF6A605E3ea1); 
    address payable public teamWalletAddress = payable(0x40956C29E4a61AA08ef1eE254467EF6A605E3ea1);
