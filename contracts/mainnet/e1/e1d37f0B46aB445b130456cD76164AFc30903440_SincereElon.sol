...
contract SincereElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereElon";
    string private _symbol = "SELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb4c0e5b26557D353F87a03fC1962CE8945428E2C);
    address payable public teamWalletAddress = payable(0xb4c0e5b26557D353F87a03fC1962CE8945428E2C);
