...
contract SirenHead is IBEP20, Ownable {
    ...
    string private _name = "Siren Head";
    string private _symbol = "$SHEAD";
    uint256 private constant INITIAL_SUPPLY = 10000000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 private constant INITIAL_MAX_WALLET = 4; //2%
    uint8 private constant INITIAL_MAX_SELL = 2; //1%
