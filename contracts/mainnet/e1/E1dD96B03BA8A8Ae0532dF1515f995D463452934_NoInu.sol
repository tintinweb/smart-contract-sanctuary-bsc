...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9E31cFd9E5F73b662Ce3f252f64C7BE135BBfec8; // owner address
...
contract NoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "No Inu";
    string private _symbol = "NO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9E31cFd9E5F73b662Ce3f252f64C7BE135BBfec8); // Marketing Address
    address payable public teamWalletAddress = payable(0x9E31cFd9E5F73b662Ce3f252f64C7BE135BBfec8); // Team Address
    ...
    uint256 public _walletMax = 30000000 * 10**_decimals; // 3%
