...
contract LeekDao is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    string public name_ = "LeekDao"; 
    string public symbol_ = "LeekDao"; 
    ...
    address public deadWallet = 0xab18A24c44Cb74f05366347765Fe3f2352ab901B;
    ...
    constructor(
        ...
        uint256 totalSupply = 1 * (10**8);
        swapTokensAtAmount = 1 * (10**2);
        ...
        marketingWalletAddress = 0x448Bae356aEA7CE26d1cBc1788Aa546d8A84A94e; 
        foundationWalletAddress = 0x3B378257887F4356Ac8FF35a805b272e9e1d96b1;
        liquidityReceiveAddress = 0xab18A24c44Cb74f05366347765Fe3f2352ab901B; 
