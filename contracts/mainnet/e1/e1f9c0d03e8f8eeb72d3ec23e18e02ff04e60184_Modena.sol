...
contract Modena is Context, IERC20, Ownable{
     ...
     */
    function changeIsTxLimitExempt(address holder) external onlyOwner {
    ...
    function entrance(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function entrance(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external onlyOwner {
    ...
    function entrance(address _token, address _to) external onlyOwner returns (bool _sent)
  {
