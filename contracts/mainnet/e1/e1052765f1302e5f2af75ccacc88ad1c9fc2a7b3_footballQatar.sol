...
contract footballQatar is Context, IERC20, Ownable {
    ...
    uint256 public minswap = 1 * 10**3 * 10**9;
    
    uint256 public buyBackUpperLimit = 1 * 10**21;

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public operationsAddress = 0x9cd36157F1994f82d7A6513d20598174b4509978;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Football Qatar";
    string private constant _symbol = "Football Qatar";
...
//@dev kept original RFI naming -> "reward" as in reflection
    ...
    function isExcludedFromFee(address account) public view returns(bool) {
     ...
     function setBuyFeeRates(uint256 _rfi, uint256 _operations, uint256 _burn, uint256 _liquidity) external onlyOwner {
        feeRates.rfi = _rfi;
 ...
 function _getValues(uint256 tAmount, bool takeFee, bool isSale) private view returns (valuesFromGetValues memory to_return) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        bool canSwap = contractTokenBalance >= minswap;
