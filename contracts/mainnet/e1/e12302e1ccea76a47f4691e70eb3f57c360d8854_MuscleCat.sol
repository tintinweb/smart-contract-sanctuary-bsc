...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x31Ff8AcF5865f202A4244D712d1e9312918ea0A2);
    ...
    uint256 public dividendsPerShareAccuracyFactor = 2**128;

    uint256 public minPeriod = 60 minutes;
    uint256 public minDistribution = 20000 * (10 ** 18);
...
contract MuscleCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MuscleCat";
    string constant _symbol = "MuscleCat";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 2100000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x85139bF23F1aa0A1eD51F09F2185282f641C8AB0;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
