...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76a8f26549D27bFb85928CeBa519eFe9d308dc68;
...
contract LastOfUsFanToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x191A42bEB75A8016DDFBD507DFF578eA9f4056B6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LastOfUs Fan Token";
    string private _symbol = "LOSFT";
