...
*/
//ARABIAN LOVELY OFFICIAL
//SPDX-License-Identifier: MIT
pragma solidity ^0.8.7;
/*
https://t.me/Arabianlovely
*/
/**
...
/* Token contract */
contract ArabianLovely is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x30b5ff41A0573645f5906a8cadAb456d85c837A9;
    ...
    // Name and symbol
    string constant _name = "ARABIAN LOVELY";
    string constant _symbol = "ALOVELY";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // KILL ZERO ARABIAN LOVELY

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 1000; // KILL ZERO ARABIAN LOVELY
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 1000; // KILL ZERO ARABIAN LOVELY
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 1000; // KILL ZERO ARABIAN LOVELY
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x30b5ff41A0573645f5906a8cadAb456d85c837A9;
