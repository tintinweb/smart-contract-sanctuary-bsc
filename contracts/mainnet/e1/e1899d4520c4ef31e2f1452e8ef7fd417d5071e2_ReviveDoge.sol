...
contract ReviveDoge is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x582127DCF0A29A54bb8BBd966D49424cA139eDF9;
    address public devWallet = 0x7B1E7546587cD62AB937C8421472Db37AfF1D3d5;

    string private constant _name = "ReviveDoge";
    string private constant _symbol = "ReviveDoge";
    ...
    Taxes public taxes = Taxes(0, 2, 0, 1);
    Taxes public sellTaxes = Taxes(0, 2, 0, 1);
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0x582127DCF0A29A54bb8BBd966D49424cA139eDF9] = true;
        _isExcludedFromFee[0xE2919E1cafeE7258FFb618bD32a3072F3e31ece6] = true;
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _dev ) <= 10, "Must keep fees at 10% or less");
