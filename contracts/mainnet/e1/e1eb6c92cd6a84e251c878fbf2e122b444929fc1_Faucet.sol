...
mapping(address => uint256) public lastAccessTime;
    ...
    event Withdrawal(address indexed to, uint256 indexed tokenAmount);
    event Deposit(address indexed from, uint256 indexed tokenAmount);
...
function depositTokens() public payable {
    require(msg.sender == owner, "Address of the token must match the one specified at contract deployment");
