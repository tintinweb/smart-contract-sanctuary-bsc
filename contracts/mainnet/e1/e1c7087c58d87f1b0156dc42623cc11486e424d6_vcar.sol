...
contract vcar is Context, IERC20, Ownable {
    ...
    string private _name = "Vitalik Car";
    string private _symbol = "VCAR";
    ...
    address public marketingAddress = 0x13fa87bDeF0735c5794d5aCaF2e13F9589227C89;
    
    uint256 public _buybackFee = 6;
    uint256 private _previousBuybackFee;
    
    uint256 public _sellBuyback = 6;
