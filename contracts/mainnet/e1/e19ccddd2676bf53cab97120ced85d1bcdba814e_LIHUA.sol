...
contract LIHUA is LIHUADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private LIHUATeam;
    address private CharityLIHUA;
    ...
    string public override name = "Dragon-Li";
    string public override symbol = "LIHUA";
    ...
    constructor(uint totalSupplyValue, address LIHUATeamAddress, address CharityLIHUAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        LIHUATeam = LIHUATeamAddress;
        CharityLIHUA = CharityLIHUAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[LIHUATeam] =  totalSupply * 4 / 100;
        balances[CharityLIHUA] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LIHUATeam pot
