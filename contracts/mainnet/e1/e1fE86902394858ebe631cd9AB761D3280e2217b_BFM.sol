...
https://t.me/BSCFreemasons

Website:
https://www.bscfreemasons.com/
...
contract BFM is IBEP20, Auth {
    ...
    string constant _name = "BSCFreemasons";
    string constant _symbol = "BFM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 15 ) / 100; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 100; // 4%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x967F8D8B2C16496a9AE592035B70B28e0dc51874;
