...
contract BOMBAY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xfD605DaA42418EBd1A34F56fFBdB63E6e63e8159); // Marketing Address

    address payable public devAddress =
        payable(0xfD605DaA42418EBd1A34F56fFBdB63E6e63e8159); // Buyback Address

    address payable public liquidityAddress =
        payable(0xfD605DaA42418EBd1A34F56fFBdB63E6e63e8159); // Liquidity Address
    ...
    uint256 private constant _tTotal = 400000000 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "Bombay Coin";
    string private constant _symbol = "BOMBAY";
     ...
     if(limitsInEffect){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (automatedMarketMakerPairs[from]) {
                removeAllFee();
                _taxFee = _buyTaxFee;
                _liquidityFee = _buyLiquidityFee + _buyMarketingFee + _buyTDFee;
                buyOrSellSwitch = BUY;
            }
            // Sell
                ...
                removeAllFee();
                _taxFee = _sellTaxFee;
                _liquidityFee = _sellLiquidityFee + _sellMarketingFee + _sellTDFee;
