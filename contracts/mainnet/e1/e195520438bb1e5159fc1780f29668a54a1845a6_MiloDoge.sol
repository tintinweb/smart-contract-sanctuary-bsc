...
contract MiloDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xfEdA84461E41254c75c81C66DE02125fA4f0F46d); 
    ...
    uint256 private _totalSupply = 2 *  10**15 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply.div(2); 
    uint256 public _walletMax = _totalSupply.div(2);
    uint256 private minimumTokensBeforeSwap = _totalSupply.div(20000); 
