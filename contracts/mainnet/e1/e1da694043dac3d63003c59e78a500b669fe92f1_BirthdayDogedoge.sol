...
contract BirthdayDogedoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "BirthdayDoge";
    string private constant _symbol = "BDoge";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xcD6B923402c4992Ea7B72EC625aB5F272c7155b6);
    address payable private _marketingAddress = payable(0x186C854DE54526F2Ee67ed4ABc2bdBDB8589092E);
    ...
    function sendETHToFee(uint256 amount) private {
        _developmentAddress.transfer(amount.div(8).mul(3));
        _marketingAddress.transfer(amount.div(8).mul(5));
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 10, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 10, "Tax cannot be more than 6.");
