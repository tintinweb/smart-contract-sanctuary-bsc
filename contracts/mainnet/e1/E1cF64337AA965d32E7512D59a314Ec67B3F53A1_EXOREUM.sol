...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39e529D743B59aBE833f0677dD693943a4Ad10a8; // owner address
...
contract EXOREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"EXOREUM";
    string private _symbol = unicode"EXO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39e529D743B59aBE833f0677dD693943a4Ad10a8); // Marketing Address
    address payable public teamWalletAddress = payable(0x39e529D743B59aBE833f0677dD693943a4Ad10a8); // Team Address
