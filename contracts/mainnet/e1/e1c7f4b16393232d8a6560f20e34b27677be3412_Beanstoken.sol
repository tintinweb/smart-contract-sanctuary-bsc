...
contract Beanstoken  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA6A645335902F3a8a2c953aee259e04aE92c15cB); 
    address payable public Wallet_Dev = payable(0x532eDF4d4AF50f807C3Db5f8f52786d391122E3b);
    ...
    string private constant _name = "Beanstoken"; 
    string private constant _symbol = unicode"Beanstoken"; 
    ...
    constructor () {
        ...
        _owner = 0x532eDF4d4AF50f807C3Db5f8f52786d391122E3b;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testne
