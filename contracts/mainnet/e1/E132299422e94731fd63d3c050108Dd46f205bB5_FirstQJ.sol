...
contract FirstQJ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "First QJ";
    string private _symbol = "First QJ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x2Ce81a4C83c103aA77143C922CB4D8CFa533fb9e);
