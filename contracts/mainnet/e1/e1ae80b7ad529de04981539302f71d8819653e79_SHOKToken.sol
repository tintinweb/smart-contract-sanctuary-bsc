...
contract SHOKToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public deadFee = 200; 
    uint256 public marketingFee = 200; 
    uint256 public lpRewardFee = 200;

    uint256 public AmountMarketingFee;
    uint256 public AmountLpRewardFee;

    address public marketingWallet = 0x6eB10Ac79e511f8F48f2ce54179C20E7803157dA; 
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(AmountMarketingFee > 0){
                swapTokensForToken(AmountMarketingFee, marketingWallet);
    ...
    function takeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        AmountMarketingFee = AmountMarketingFee.add(MFee);
    ...
    function process(uint256 gas) private {
        ...
        uint256 nowbanance = AmountLpRewardFee;
        ...
        while(gasUsed < gas && iterations < shareholderCount) {
            ...
            AmountLpRewardFee = AmountLpRewardFee.sub(amount);
