...
// Reflections in $413, CA : 0xd0959D536E3dC746C1F0e3981A2de41D585B67BF
// Liquidity will burn.
// Max tx will increase.
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 FourHundredThirteen = IBEP20(0xd0959D536E3dC746C1F0e3981A2de41D585B67BF);
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = FourHundredThirteen.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = BUSD;
       path[1] = address(FourHundredThirteen);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = FourHundredThirteen.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           FourHundredThirteen.transfer(shareholder, amount);
...
contract Token is IBEP20, Auth {
   ...
   address FourHundredThirteen = 0xd0959D536E3dC746C1F0e3981A2de41D585B67BF;
   address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby413";
   string constant _symbol = "Baby413";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountbusdMarketing, gas: 30000}("");
