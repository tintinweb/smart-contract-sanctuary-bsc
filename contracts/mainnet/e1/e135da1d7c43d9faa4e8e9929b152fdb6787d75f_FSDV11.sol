...
https://twitter.com/elonmusk/status/1591336830389067778?t=hVEDI0efu8X0GUbunWmWmw&s=19
...
contract FSDV11 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x75a47EF1fB5FBdF8147e1A93421851fc9fB576c4;

    string constant _name = "FSD V11";
    string constant _symbol = "$FSDV11";
