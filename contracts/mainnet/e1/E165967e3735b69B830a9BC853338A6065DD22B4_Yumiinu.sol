...
/**
yumi inu  is borned by hype of Inu and anime tokens. With our great marketing plan and this hype together we are pushing this to moon.
...
contract Yumiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yumi inu";
    string private _symbol = "Yumi inu";
