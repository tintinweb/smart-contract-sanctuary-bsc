...
contract GS2 is ERC20 {
	...
	address public _fundAddress = address(0x0Cf38d3643597Ab9d3ed55dC75cf9530EdE63a0F);
	address public _luckAddress = address(0x4C628121FC7e1d7a43F0A13a065F6F37D3F2C6a2);
    ...
    constructor(address tokenOwner) ERC20("Golden September2", "GS2") {
        ...
        _mint(tokenOwner, total.div(10).mul(5));
		_mint(_luckAddress, total.div(10).mul(5));
	...
	uint256 public oneTimeAmount = 1 * 10**23;
	uint256 public maxAmount = 1 * 10**23;
