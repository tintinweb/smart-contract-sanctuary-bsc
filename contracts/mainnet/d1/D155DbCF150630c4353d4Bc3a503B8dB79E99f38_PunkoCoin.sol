...
contract PunkoCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Punko Coin"; //
    string private constant _symbol = "PUNKO"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xa8C4134285Ea396447626dcEB93F8033CA1ce82C;
