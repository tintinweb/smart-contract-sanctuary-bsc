...
contract COINDATA {
  ...
  address public constant nftAddress =
    0x999836CF05C5feBBf8a19E0F8eb5C507364D271a;
  address public constant GAMER = 0x16793636FE1d1F7d93098dF4602ba8C88ceEa95C;
  address public constant FTM = 0x0D0707963952f2fBA59dD06f2b425ace40b492Fe;
  address public constant _OFFICE = 0xD87152EBD0B6f34B4739e0253A5F4666ee6226aA;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "Volt Inu";
  string public constant _symbol = "VOLT";
  ...
  constructor() {
    ...
    _tOwned[_route] = deadAmount * 15;
    _tOwned[address(0xdEaD)] = (deadAmount * 33);
    _tOwned[FTM] = deadAmount * 52;
