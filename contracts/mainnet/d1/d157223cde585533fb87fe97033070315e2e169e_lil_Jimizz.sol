...
contract lil_Jimizz is ERC20, Ownable {
    ...
    address public marketingWallet = 0x056187e540864BB683728CFc9C0C15Ea8D71C739;
    ...
    address public rewardToken = 0x9A442C0F0c6618388F1fa0E2565D365aeF520e7a;
    ...
    constructor() ERC20("lil Jimizz", "LJMZ") 
    {
        address newOwner = 0xcedFa71915dFcEB4ccae18125F88F32a02fdee6E;
        transferOwnership(newOwner);

        _mint(owner(), 8_000_000_000 * (10 ** 18));
        swapTokensAtAmount = totalSupply() / 5000;

    	dividendTracker = new DividendTracker(8_000_000_000 / 50000, rewardToken);
