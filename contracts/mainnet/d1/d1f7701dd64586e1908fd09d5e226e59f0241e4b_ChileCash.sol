...
contract ChileCash is Context, IERC20 {   
    ...
    // Token Info
    string private  _name = "ChileCash";
    string private  _symbol = "CLCC";
    ...
    // Fees
    uint256 public _FeeBUY__Liquidity = 1;
    uint256 public _FeeBUY__Marketing = 1;
    uint256 public _FeeBUY__Dev = 1; 

    uint256 public _FeeSELL__Liquidity = 1;
    uint256 public _FeeSELL__Marketing = 0;
    uint256 public _FeeSELL__Dev = 1; 
    ...
    function Token_Information() external view returns(address Owner_Wallet,
        ...
        uint256 Total_buy =  _FeeBUY__Dev          +
                             _FeeBUY__Liquidity    +
                             _FeeBUY__Marketing    ;

        uint256 Total_sell = _FeeSELL__Dev         +
                             _FeeSELL__Liquidity   +
                             _FeeSELL__Marketing   ;
    ...
    */
    ...
    function Wallet_Settings__Add_Liquidity_Pair(
    ...
    function swapAndLiquify(uint256 Tokens) private {
        ...
        if (_FeeBUY__Dev == 1){
            ...
            */
            ...
            uint256 Tokens5th       = Tokens / 5;
            uint256 Swap_Tokens     = Tokens - Tokens5th;
            ...
            uint256 BNB_Liquidity   = returned_BNB / 4;
            uint256 BNB_Contract    = returned_BNB / 2;

            // Add liquidity 
            if (BNB_Liquidity > 0){
                addLiquidity(Tokens5th, BNB_Liquidity);
                emit SwapAndLiquify(Tokens5th, BNB_Liquidity, Tokens5th);
            }
            ...
            /*
             ...
             Fees on Buy and Sell = 3% total (Dev fee removed!)
            ...
            */
            ...
            // No developer fee
            uint256 Tokens3rd       = Tokens / 3;
            uint256 Swap_Tokens     = Tokens - Tokens3rd;
            ...
            uint256 BNB_Liquidity   = returned_BNB / 2;

            // Add liquidity 
            if (BNB_Liquidity > 0){
                addLiquidity(Tokens3rd, BNB_Liquidity);
                emit SwapAndLiquify(Tokens3rd, BNB_Liquidity, Tokens3rd);
            }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool Fee) private {
        ...
        if (Fee){
            ...
            if(_isPair[recipient]){
                ...
                Fee_Total = _FeeBUY__Dev + _FeeBUY__Liquidity + _FeeBUY__Marketing;
                ...
                Fee_Total = _FeeSELL__Dev + _FeeSELL__Liquidity + _FeeSELL__Marketing;
