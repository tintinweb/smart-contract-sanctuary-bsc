...
contract DEGENSAFUU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DEGENSAFUU";
    string constant _symbol = "DEGENDSAFUU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xEef1e3BA2218ade59Db6aCcFAACd77C5DD1867Ed;
        buybackWallet = 0xEef1e3BA2218ade59Db6aCcFAACd77C5DD1867Ed;
