...
// TG: https://t.me/dotadaotoken

/* Token name: DOTA
Symbol: DOTA
Decimals: 9
Total Supply: 21 Million DOTA

Tax 7% on buy 8% on sell
...
0.05 BNB for contribution for DAO owners and contribution will start tomorrow

1.2% MAXbuy for DAO owners
0.5% for general buyers
...
contract Dotadao is IBEP20, Auth {
    ...
    string constant _name = "DOTA DAO";
    ...
    uint256 DotadaoFee = 2; 
    uint256 marketingFee = 4;
    uint256 totalFee = 7;
    uint256 feeDenominator = 100;
    uint256 public _sellMultiplier = 1;
    
    address public marketingFeeReceiver = 0x28bbd53e68FDE3Ae288e35F977b1E55a14b202eE;
    address public DotadaoFeeReceiver = 0x7d183c80d40A1787A1c2475267B889E11b9Ff5a6;
    ...
    uint256 public swapThreshold = _totalSupply / 200000 * 100; // 0.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        isTxLimitExempt[DotadaoFeeReceiver] = true;
        ...
        isTimelockExempt[DotadaoFeeReceiver] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != DotadaoFeeReceiver && !isTxLimitExempt[recipient]){
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDotadao = amountBNB.mul(DotadaoFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool DotadaoSuccess, /* bytes memory data */) = payable(DotadaoFeeReceiver).call{value: amountBNBDotadao, gas: 30000}("");
        require(DotadaoSuccess, "receiver rejected ETH transfer");
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _DotadaoFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        DotadaoFee = _DotadaoFee;
        totalFee = _liquidityFee.add(_marketingFee).add(_DotadaoFee);
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _DotadaoFeeReceiver) external onlyOwner {
        marketingFeeReceiver = _marketingFeeReceiver;
        DotadaoFeeReceiver = _DotadaoFeeReceiver;
    }
