...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 dividendUsdt = usdtBalance * lpDividendFee * 2 / totalFee;
        if (dividendUsdt > 0) {
            path[0] = usdt;
...
contract HPG is AbsToken {
    ...
    //SwapRouter
        ...
        18,
        10000,
        address(0x265b0Cc8eb4e48313141940937f3A167DD34EE77),
        address(0x265b0Cc8eb4e48313141940937f3A167DD34EE77),
        address(0x3Ef9cc968DA02Bc0aa86054491F162eD1d8BC24f),
        0,
        0,
        100
    ){
