...
contract DG is IERC20, Ownable {
    ...
    address private fundAddress = address(0xd92A1a10737FD2D5a1893Ad581e8914546620C9d);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (from==uniswapV2Pair){
                require(amount<=300*10**18,"buy gt 1");
                require((balanceOf(to)+amount)<=1000*10**18,"hold gt 3");

            }else if (to==uniswapV2Pair) {
                require(amount<=300*10**18,"sell gt 1");
