...
contract PeaceUlla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PeaceUlla"; 
    string private _symbol = "PeaceUlla"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x651d5b58A701d0d71A9866Db8200c4284C13BB7f); // Marketing Address
    address payable public teamWalletAddress = payable(0x651d5b58A701d0d71A9866Db8200c4284C13BB7f); //  Team Address
