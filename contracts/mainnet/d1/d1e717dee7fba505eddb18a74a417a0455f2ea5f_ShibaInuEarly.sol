...
/**
Https://t.me/shibaearly
Https://www.twitter.com/shibaearly
*/
...
contract ShibaInuEarly is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   EarlyDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Shiba Inu Early", "Early") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 3;
		_buyMarketingFee = 3;
        _buyDevFee = 2;
		...
		marketingWallet = payable(0x054A1b5777Af12908F35F0914C2f7F728457bf2C);
        _devWallet = payable(0xDf166e3CCbEc5E07351b7b16e7A32E22aA78E468);
