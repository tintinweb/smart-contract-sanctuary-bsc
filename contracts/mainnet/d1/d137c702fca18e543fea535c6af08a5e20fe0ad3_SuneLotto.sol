...
contract SuneLotto is ReentrancyGuard{
    ...
    address private usdtminer = 0x90399eCe26dA8d33004935A975a651AD1f96C312; //USDTminer addres
    address private dev = 0xc4922692A3c60C330963DA18aaa902C02C1793DE;
...
uint256 private maxParticipantNumbers1;
    ...
    constructor()  {  
        owner =  msg.sender;
        maxParticipantNumbers = 1000;
        ticketPrice = 1 ether ;

         maxParticipantNumbers1 =1000;
        ticketPrice1 = 10 ether;

         maxParticipantNumbers2 = 10000;
        ticketPrice2 = 50 ether;

        tokenAdress = 0x596076DD84377471A84Dc0347F64c4B571eFe6e0; 
