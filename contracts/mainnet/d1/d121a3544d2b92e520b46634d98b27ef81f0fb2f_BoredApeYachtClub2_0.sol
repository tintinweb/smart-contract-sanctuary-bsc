...
contract BoredApeYachtClub2_0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bored Ape Yacht Club 2.0";
    string private _symbol = "BAYC2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf613A618FF60F8151549940B068fd27Fb9daA816


);
    address payable public teamWalletAddress = payable(0xf613A618FF60F8151549940B068fd27Fb9daA816
