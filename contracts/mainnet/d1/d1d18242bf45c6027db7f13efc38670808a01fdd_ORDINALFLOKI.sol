...
contract ORDINALFLOKI is ERC20, Ownable {
    uint256 private constant initialSupply = 100_000_000_000_000 * 10**18;
    ...
    constructor(address _router) ERC20("Ordinal Floki NO NO NO", "ORDINALFLOKI") payable
    {
        ...
        // Buy Taxes
        buyTaxes["marketing"] = 200;
        buyTaxes["dev"] = 0;
        buyTaxes["liquidity"] = 0;

        // Sell Taxes
        sellTaxes["marketing"] = 200;
        sellTaxes["dev"] = 0;
        sellTaxes["liquidity"] = 0;

        // External wallets 
        taxWallets["marketing"] = 0xdcCBa1A321844f2565c88807110f8445E0779462;
        taxWallets["dev"] = 0x611cBEb2aE3e19e271E71392874Acdb1f08a5be3;

        maxTxAmount = initialSupply * 200 / 10000;
