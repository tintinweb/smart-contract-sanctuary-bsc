...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCF88B7796C5D371728ab57Ea8e9008994A89BaB7; // owner address
...
contract elonzhao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ELON ZHAO";
    string private _symbol = "EZ";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xCF88B7796C5D371728ab57Ea8e9008994A89BaB7); // Marketing Address
    address payable public teamWalletAddress = payable(0xCF88B7796C5D371728ab57Ea8e9008994A89BaB7); // Team Address
