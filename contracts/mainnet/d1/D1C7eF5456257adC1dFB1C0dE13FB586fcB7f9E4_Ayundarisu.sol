...
TG: https://t.me/+JKqdQ-L6ICdlN2U1
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9D480aa25710451789FAF647043303B66F330591; // owner address
...
contract Ayundarisu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ayunda Risu";
    string private _symbol = "AR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd3C9d8a63292e1c900e267e2511f5179Ef2acFC8); // Marketing Address
    address payable public teamWalletAddress = payable(0xd3C9d8a63292e1c900e267e2511f5179Ef2acFC8); // Team Address
