...
/* Token contract */
contract RichRat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5F58CB4B20f4AF748AC35d89eEf201f8DB2008cb;
    ...
    // Name and symbol
    string constant _name = "Rich Rat";
    string constant _symbol = "RICHR";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (200 tokens)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 tokens)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (200 tokens)
