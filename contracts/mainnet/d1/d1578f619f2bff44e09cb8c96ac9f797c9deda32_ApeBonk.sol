...
/**
APE BONK https://t.me/ApebonkPortal
BUY : 9% 
SELL: 9%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1E204B01093b8ee68eB9B03B2f22E4604dd13A65; // owner address
...
contract ApeBonk is Context, IERC20, Ownable {
    ...
    string private _name = "Ape Bonk";
    string private _symbol = "AB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1E204B01093b8ee68eB9B03B2f22E4604dd13A65); // Marketing Address
    address payable public teamWalletAddress = payable(0x1E204B01093b8ee68eB9B03B2f22E4604dd13A65); // Team Address
