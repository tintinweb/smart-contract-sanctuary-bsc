...
contract VenomCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VENOM CAT";
    string private _symbol = "VENOM CAT";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xd71049359D2c4a54c7B0FF85E85E26F721411C02); // Marketing Address
    address payable public teamWalletAddress = payable(0xd71049359D2c4a54c7B0FF85E85E26F721411C02); // Team Address
