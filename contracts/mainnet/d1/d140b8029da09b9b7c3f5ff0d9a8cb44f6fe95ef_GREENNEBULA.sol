...
contract GREENNEBULA is IBEP20, Auth {
    ...
    string constant _name = " Green Nebula  ";
    string constant _symbol = "  Green Nebulas ";
    uint8 constant _decimals = 18;


    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 7) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 14) / 100; 
