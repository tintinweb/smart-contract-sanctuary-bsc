...
contract FisheraIDO is Ownable {

    using SafeMath for uint256;

    IERC20 public FSHR = IERC20(0x237939F39061031150330bc7BAcC05ca5879ddE1);
    address public Recipient = 0xF0Be33032563F316CDf33441F7997E8Cf61a750d;

    uint256 public tokenRatePerEth = 4280;
    ...
    function deposit() public payable checkIfPaused {
        ...
        require(FSHR.transfer(msg.sender, tokenAmount), "Insufficient balance of presale contract!");
    ...
    function getTokensPerEth(uint256 amount) internal view returns(uint256) {
        return amount.mul(tokenRatePerEth).div(10**(uint256(18).sub(FSHR.decimals())));
    }
}