...
contract DogeQueenBSC is DogeQueenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DogeQueenTeam;
    address private CharityDogeQueen;
    ...
    string public override name = "Doge Queen";
    string public override symbol = "Doge Queen";
    ...
    constructor(uint totalSupplyValue, address DogeQueenTeamAddress, address CharityDogeQueenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DogeQueenTeam = DogeQueenTeamAddress;
        CharityDogeQueen = CharityDogeQueenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DogeQueenTeam] =  totalSupply * 2 / 100;
        balances[CharityDogeQueen] = totalSupply * 2 / 100;
