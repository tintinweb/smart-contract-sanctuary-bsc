 ...
 * Telegram: https://crybitenetwork
 * Website : https://twitter.com/crypbitenetwork

Unique meme utility token with various unique features on the bsc
borgi inu look to create a fun and social meme utility to bring the community together whilst providing enticing features
borgi inu will be the next bigest meme token.
...
contract CRYPBITENETWORK is Context, IERC20, Ownable {
    ...
    string private _name =  "CRYPBITE NETWORK";
    string private _symbol = "CRYPBITE";
