...
contract BEP20 is Context, IBEP20, IBEP20Metadata, Ownable {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        ...
        uint256 burnFees = amount * _burnFee/100;
        _transfer(owner,_deadAddress, burnFees);
        amount = amount - burnFees;
        }
    ...
    function transferFrom(
        ...
        uint256 burnFees = amount * _burnFee/100;
        _transfer(from,_deadAddress, burnFees);
        amount = amount - burnFees;
        }
     ...
     /**
     * @dev set burn fees pBEPent, 10 pBEPent is max limit.
     */
    ...
    /**
     * @dev add a user to whitelist to avoid burn fees.
     */
    ...
    /**
     * @dev remove a user from whitelist.
     */
...
// File: contracts/CKM.sol


pragma solidity ^0.8.17;

contract CKM is BEP20 {
    uint256 burnFee = 2;
