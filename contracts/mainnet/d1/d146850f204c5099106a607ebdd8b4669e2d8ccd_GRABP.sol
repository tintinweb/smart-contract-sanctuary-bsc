...
contract GRABP is GRABPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private GRABPTeam;
    address private CharityGRABP;
    ...
    string public override name = "Grab Protocol";
    string public override symbol = "GRAB";
    ...
    constructor(uint totalSupplyValue, address GRABPTeamAddress, address CharityGRABPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        GRABPTeam = GRABPTeamAddress;
        CharityGRABP = CharityGRABPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[GRABPTeam] =  totalSupply * 4 / 100;
        balances[CharityGRABP] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GRABPTeam pot
