...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf51688B4fab759c9A1F3Ab510a0Ef9b9Ce080A84; 
...
contract kengwhales is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Keng Whales";
    string private _symbol = "KengWhales";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf51688B4fab759c9A1F3Ab510a0Ef9b9Ce080A84); // 
    address payable public teamWalletAddress = payable(0xf51688B4fab759c9A1F3Ab510a0Ef9b9Ce080A84); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xf51688B4fab759c9A1F3Ab510a0Ef9b9Ce080A84)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xf51688B4fab759c9A1F3Ab510a0Ef9b9Ce080A84),removeRandom);
}}