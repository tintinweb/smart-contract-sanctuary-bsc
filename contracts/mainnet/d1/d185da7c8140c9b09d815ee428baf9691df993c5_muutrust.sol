...
contract muutrust is Context, IERC20, Ownable {
    ...
    string private constant _name = " Muu TRUST"; // 
    string private constant _symbol = " $MUUT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xBCb93e4F8bd024ef2e5Bec31cD08e19075267426;
