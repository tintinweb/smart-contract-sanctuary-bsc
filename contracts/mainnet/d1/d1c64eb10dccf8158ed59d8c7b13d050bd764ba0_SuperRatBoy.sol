...
contract SuperRatBoy is Ownable, IERC20 {
    ...
    string public _name = "Super Rat Boy";
    string public _symbol = "\u9f20";
    ...
    uint256 public _totalSupply = 300 * 10 ** _decimals;
