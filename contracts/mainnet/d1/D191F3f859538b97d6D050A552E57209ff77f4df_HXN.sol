...
TG : https://t.me/hexanetworkoffciaI
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA28eA6C1B65237B4F04541249aF8C2433DbD2B75; // owner address
...
contract HXN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hexa Network";
    string private _symbol = "HXN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDa37ce82616ae67C4C1E5b20CF33BA36497777D4); // Marketing Address
    address payable public teamWalletAddress = payable(0xA28eA6C1B65237B4F04541249aF8C2433DbD2B75); // Team Address
