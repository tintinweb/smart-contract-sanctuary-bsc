...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 SURGE = IERC20(0x9f19c8e321bD14345b797d43E01f0eED030F5Bff);
    address SSURGE = 0x9f19c8e321bD14345b797d43E01f0eED030F5Bff;
    IDEXRouter router;
...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    constructor ()  {
      router = IDEXRouter(DEX); 
        //pair = IDEXFactory(router.factory()).createPair(SRG, address(this));
        _balances[address(this)] = _totalSupply;
        distributor = new DividendDistributor(DEX);
    ...
    function withdrawTaxBalance() external nonReentrant onlyOwner {
        ...
        uint256 temp3 = (taxBalance *rewardsShare) / SHAREDIVISOR
        ;
        try distributor.deposit{value: temp3 }() {} catch {}
        assert(temp1 && temp2);
        taxBalance = 0;
    }
   ...
   function setIsDividendExempt(address holder, bool exempt) external onlyOwner {
        require(holder != address(this) && holder != SRG);
