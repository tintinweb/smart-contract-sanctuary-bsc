...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA0bb1b722c98C6467a16f77edCfa3c6DF0ce1342;
...
contract CPRE is Context, IERC20, Ownable {
    ...
    string private constant _name = "CORE BITCOIN"; // 
    string private constant _symbol = "CBTC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xA0bb1b722c98C6467a16f77edCfa3c6DF0ce1342);
