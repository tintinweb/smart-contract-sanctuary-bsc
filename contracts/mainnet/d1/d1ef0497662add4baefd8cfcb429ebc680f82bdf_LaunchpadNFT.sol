...
/**
 * @title Snail NFT Launchpad
 * @notice Pre-market sell Snail NFT tokens.
 */
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(ISnailNFT _snailNFT) public initializer {
        __AccessControl_init_unchained();
        __ReentrancyGuard_init();
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        snailDAONFT = _snailNFT;
    ...
    /**
     * @notice Buy Snail NFT token from launch
        ...
        returns (uint256)
    {
        ...
        uint256 nftId = snailDAONFT.launchpadMint(
            msg.sender,
            _launch.level,
            _launch.robiBoost,
            false
