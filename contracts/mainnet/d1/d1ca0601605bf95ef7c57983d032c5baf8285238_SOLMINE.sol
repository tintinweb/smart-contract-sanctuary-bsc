...
contract SOLMINE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x25C6650e9e1735a1E4B2B5d3db3945Df741Af038); 
    address payable public Wallet_Dev = payable(0x25C6650e9e1735a1E4B2B5d3db3945Df741Af038);
    ...
    string private constant _name = "SOLANA MINE"; 
    string private constant _symbol = unicode"SOLMINE"; 
    ...
    constructor () {
        ...
        _owner = 0x25C6650e9e1735a1E4B2B5d3db3945Df741Af038;
