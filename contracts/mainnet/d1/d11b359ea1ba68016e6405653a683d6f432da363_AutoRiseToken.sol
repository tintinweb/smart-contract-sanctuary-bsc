...
library Address{
 ...
 contract AutoRiseToken is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9319f6f3401C4bf82dED10894fC12808B99e1bf4;
    address public donationWallet = 0x9319f6f3401C4bf82dED10894fC12808B99e1bf4;

    string private constant _name = "Auto Rise Token";
    string private constant _symbol = "ATK";
    ...
    Taxes public taxes = Taxes(1, 1, 3, 0);
    Taxes public sellTaxes = Taxes(2, 2, 5, 0);
