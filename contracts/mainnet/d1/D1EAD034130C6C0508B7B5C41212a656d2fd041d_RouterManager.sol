...
contract RouterManager is Ownable {
    ...
    IUniswapV2Router02 public backupRouter;
    IWChainMaster public wchainMaster;
    address public dexAgent;
    address public immutable WETH;
    uint256 public exchangeProfitShare = 40; // 40%

    constructor(
        IUniswapV2Router02 _dexRouter,
        IUniswapV2Router02 _backupRouter,
        address _dexAgent,
    ...
    function setBackupRouter(IUniswapV2Router02 _backupRouter)
        external
        onlyOwner
    {
        backupRouter = _backupRouter;
        emit EventMessage("New Backup Router Was Set");
    }
    ...
    function swapExactTokensForTokens(
        ...
        bool useBackupRouter
    ) internal coverUp(masterInput) returns (uint256[] memory amounts) {
        ...
        IUniswapV2Router02 router = useBackupRouter ? backupRouter : dexRouter;
    ...
    // External functions for main router.
    function swapExactTokensForTokens(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
    ...
    // External functions for backup router.
    function swapExactTokensForTokensBackup(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapTokensForExactTokensBackup(
        uint256 amountOut,
        uint256 amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensBackup(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline,
    ...
    function swapTokensForExactETHBackup(
        uint256 amountOut,
        uint256 amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactTokensForETHBackup(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapETHForExactTokensBackup(
        uint256 amountOut,
        address[] calldata path,
        address to,
        uint256 deadline,
