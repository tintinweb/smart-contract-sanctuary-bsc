...
contract dear is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "dear";
    string private _symbol = "DEAR";
	...
	function cludeFromDividends(address account) external onlyOwner {
    ...
    function getchangeTxSetting(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function ischangePercentSetting(uint256 maxTXPercentage) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxTXPercentage) / 1000;
    }


    function ischangeAutomatedSetting(address pair, bool value) external onlyOwner {
