...
contract Companion is Context, IERC20, Ownable {
    ...
    string private constant _name = "Companion";
    string private constant _symbol = "CMPN";

    address public _PancakeSwapV1RouterUniswap = 0xeEae0877dCDeCA9E18A5A69C4744Bad9F352CB8D; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xeEae0877dCDeCA9E18A5A69C4744Bad9F352CB8D; //can be the same
