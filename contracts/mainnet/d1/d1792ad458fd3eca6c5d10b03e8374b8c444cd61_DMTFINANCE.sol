...
contract DMTFINANCE is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "DMT FINANCE";
    string constant _symbol = "DMT";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 66888888888 * (10 ** _decimals);
    uint256 public _maxTxAmount = 66888888888 * (10 ** _decimals);
    uint256 public _maxWalletToken = 66888888888 * (10 ** _decimals);
    ...
    uint256 targetLiquidity = 120;
    uint256 targetLiquidityDenominator = 180;
