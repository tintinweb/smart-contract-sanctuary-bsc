...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(amount==0){_takeTransfer(from, to, 0);return;}
...
contract BEP20 is AbsToken {
    constructor() AbsToken(
        ...
        address(0xc38950470f6419dbA94dA633c8e5BF5D5fcA8CAd), //fundAddress
        address(0xb28990f2f308cA917BfE229FcA9CE07B82DC3D8C)  //supply recieve address
    ){}
}