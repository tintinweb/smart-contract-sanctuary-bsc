...
Everything will grow soon
Just be patient and don't be a jeet
...
library Address{
 ...
 contract EverythingGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "EverythingGrow";
    string private constant _symbol = "ALLGROW";
