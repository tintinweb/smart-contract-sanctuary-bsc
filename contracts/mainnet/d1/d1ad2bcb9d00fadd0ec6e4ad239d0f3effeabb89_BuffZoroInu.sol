...
/*
* BUFF ZORO INU
* Telegram: https://t.me/BuffZoroinu
* Twitter: https://twitter.com/BuffZoroInu
*/
...
contract BuffZoroInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    mapping(address => uint256) private _rOwned;
    mapping(address => uint256) private _tOwned;
    mapping(address => bool) public _BannedBot;
    ...
    address payable private marketingAddress =
        payable(address(0x335b2B85126603C18f6aF9a971A44C89F156c723));
    address payable private devWallet =
        payable(address(0x335b2B85126603C18f6aF9a971A44C89F156c723));
    address private liquidityReceiver =
        0x335b2B85126603C18f6aF9a971A44C89F156c723;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "BUFF ZORO INU";
    string private _symbol = "BUFFZORO";
    ...
    bool public TradingIsOn = true;
    mapping(address => bool) public AcceptedOnTrading;

    uint256 private _maxTxAmount = 5000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 300 * 10**9;
    uint256 private _maxWalletSize = 5000 * 10**9;
