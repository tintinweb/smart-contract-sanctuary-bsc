...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75dff4e414e7CE8864D146c94f66e40415D56380;
...
contract NewVerseToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1480A38edBA8ca5Fb3295D14f64256Fa71a26b09;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "New Verse Token";
    string private _symbol = "NVER";
