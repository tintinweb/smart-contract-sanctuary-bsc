...
/*   ____.  _____ _____________________ _________
    |    | /  _  \\______   \_   _____//   _____/
    |    |/  /_\  \|     ___/|    __)_ \_____  \ 
/\__|    /    |    \    |    |        \/        \
\________\____|__  /____|   /_______  /_______  /
                 \/                 \/        \/ 
...
library Address{
 ...
 contract Japes is Context, IERC20, Ownable {
    ...
    //Tokenomics
    uint256 private _tTotal = 1e7 * 10**_decimals; //10_million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 30_000 * 10**9;
    uint256 public maxBuyLimit = 200_000 * 10**9; //2%
    uint256 public maxSellLimit = 100_000 * 10**9; //1%
    uint256 public maxWalletLimit = 200_000 * 10**9; //2%
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0xA5b91dBF4bd4E7D2f7ef071e1384F3d1aA63e30A;
    address private devWallet = 0x1b350E8f95064a5CB41ffd205ECDae5c68cba644;

    string private constant _name = "JUNGLEAPES";
    string private constant _symbol = "JAPES";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 3, 1);
    ...
    function airdropTokens(address[] memory accounts, uint256[] memory amounts) private onlyOwner{
