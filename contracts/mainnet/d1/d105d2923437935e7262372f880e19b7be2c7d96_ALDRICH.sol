...
contract ALDRICH is Context, IERC20, Ownable {
    ...
    string  private constant _name = "ALDRICH"; 
    string  private constant _symbol = "ALDR";   
    uint8   private constant _decimals = 9; 
    uint256 private _tTotal = 200000000000 * 10 ** _decimals;
    uint256 public  _distributeTheShare = 2000000;
    ...
    address payable public   _devWallet =payable(0x3e12152B88ea7F4f8031bE0EBaA156C8E81c431a);
    uint256 private _dvTx=3;
    uint256 private _dvBuyTx=3;
    uint256 private _dvSelTx=8;
 ...
 function _BuyTax(uint256 setBuyTax) external onlyOwner() 
    {
        _dvBuyTx=setBuyTax;
     
    }
  function _SellTax(uint256 setSellTax) external onlyOwner() 
     {
      _dvSelTx=setSellTax;
    }
  ...
  function setShare(uint256 amount) external onlyOwner
  {
      _distributeTheShare=amount;
  }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
     ...
     function getCirculatingSupply() public view returns (uint256){
        ...
        function changeDevWallet (address payable devwallet) external onlyOwner
        {
