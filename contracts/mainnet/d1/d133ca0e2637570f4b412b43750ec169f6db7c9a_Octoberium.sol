...
/*
    Octoberium is a community-driven token and decentralized coin in Binance Smart Chain
    Destined for a millions market cap
    Team has a lot of plans for this project
    Get in early for an easy 1000X


    https://t.me/Octoberium
    https://octoberium.io/
...
contract Octoberium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Octoberium"; //
    string private constant _symbol = "Octoberium"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xD14fBf6eE3D55A8D6b286b81Fdcde9614Ff0d47B;
