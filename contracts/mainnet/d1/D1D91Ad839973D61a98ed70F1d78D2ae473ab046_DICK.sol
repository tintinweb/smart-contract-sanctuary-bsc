...
contract DICK is ERC20, Ownable {
    ...
    string constant _name = "DICK";
    string constant _symbol = unicode"$DICK";
    ...
    address public marketingFeeReceiver = 0xa6429dA0aB4cb473f8E7981842a84B8FbD841F2e;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xa6429dA0aB4cb473f8E7981842a84B8FbD841F2e] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xa6429dA0aB4cb473f8E7981842a84B8FbD841F2e] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xa6429dA0aB4cb473f8E7981842a84B8FbD841F2e,
                block.timestamp
            );
