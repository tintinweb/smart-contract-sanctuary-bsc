...
contract GreenWhaleSV2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3272217669F7f50AC4f577cD733feC0dff3dC702;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GreenWhaleSV2";
    string private _symbol = "$GWSV2";
