...
contract BUSDFury {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 40 ether;				// 40 BUSD min invest
	...
	uint constant public			MAX_WITHDRAW_AMOUNT				= 2500 ether;			// claim 2500 BUSD max
	...
	function invest(address _referrer, uint8 _planIdx, uint256 amount) public {
		...
		uint mfee = amount * MARKETING_FEE / PERCENTS_DIVIDER;
