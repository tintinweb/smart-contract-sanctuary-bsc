...
contract LoopBlack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Loop Black";
    string private _symbol = "LOOPB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x361b9f68cdCc99a20eeF82a6c637debe756f66B2); // Marketing Address
    address payable public teamWalletAddress = payable(0x67507de2167935F30d87FF32382427a7121e99C4); // Team Address
