...
contract BonkMine is Context, IERC20, Ownable {
    ...
    string private constant _name = "BONK MINE"; // 
    string private constant _symbol = "BONKMINE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x220b41f0BFe6fCc1Ae1C8f01011CB69046AC2732;
