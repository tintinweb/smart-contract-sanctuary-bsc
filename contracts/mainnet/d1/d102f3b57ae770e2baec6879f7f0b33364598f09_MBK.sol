...
contract MBK is ERC20Detailed, Ownable {
    ...
    uint256 public inviterMinHoldAmount = 0;
    uint256 public MinAirdropAmount = 0;
    uint256 public AddLiquidityAmount = 10 * 10**DECIMALS;
    ...
    uint256 public constant MIN_SUPPLY = 10**8 * 10**DECIMALS; 
    ...
    uint256 public period = 15 minutes;
    uint256 public rebaseRate = 38850;
    uint256 public _lastRebasedTime;
    uint256 public _lastAddLiquidityTime;
    uint256 public startTradingTime;
    uint256 public _initRebaseStartTime;
    uint256 public deltaTimeFromInit;
    uint256 public autoOpertationInterval = 15 minutes;
    ...
    function setInviter(
        ...
        if (deltaTimeFromInit < (60 days)) {
            ...
            MinAirdropAmount = 10**6 * 10**DECIMALS;
            inviterMinHoldAmount = 10**14 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (60 days) && deltaTimeFromInit < (120 days)) {

            MinAirdropAmount = 10**5 * 10**DECIMALS;
            inviterMinHoldAmount = 10**13 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (120 days) && deltaTimeFromInit < (180 days)) {

            MinAirdropAmount = 10**4 * 10**DECIMALS;
            inviterMinHoldAmount = 10**12 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (180 days) && deltaTimeFromInit < (240 days)) {

            MinAirdropAmount = 10**3 * 10**DECIMALS;
            inviterMinHoldAmount = 10**11 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (240 days) && deltaTimeFromInit < (300 days)) {

            MinAirdropAmount = 10**2 * 10**DECIMALS;
            inviterMinHoldAmount = 10**10 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (300 days) && deltaTimeFromInit < (360 days)) {

            MinAirdropAmount = 10* 10**DECIMALS;
            inviterMinHoldAmount = 10**9 * 10**DECIMALS;

        } else if (deltaTimeFromInit >= (360 days) && deltaTimeFromInit < (480 days)) {

            MinAirdropAmount = 10**8;
            inviterMinHoldAmount = 10**7 * 10**DECIMALS;
     
        } else if (deltaTimeFromInit >= (480 days) && deltaTimeFromInit < (600 days)) {
            MinAirdropAmount = 10**7;
            inviterMinHoldAmount = 10**4 * 10**DECIMALS;
     
        } else if (deltaTimeFromInit >= (600 days)) {
            MinAirdropAmount = 10**6;
            inviterMinHoldAmount = 10**2 * 10**DECIMALS;
