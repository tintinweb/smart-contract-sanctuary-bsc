...
contract FlokiMerge is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1DD331bc5A5D583938c4aC91af6C5681c0E9407D;
    address DevWallet       = 0x97A0c8faFb252214170Dde52Ab9CffAE8f3E8a25;

    string constant _name = "FlokiMerge";
    string constant _symbol = "$FLOKIMERGE";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 35000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 35000000 * (10 ** _decimals);
