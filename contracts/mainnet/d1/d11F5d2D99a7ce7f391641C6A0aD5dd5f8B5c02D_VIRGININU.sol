...
/* Token contract */
contract VIRGININU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x1497c26E46e5ECB303bb6210DD95b9CBd466EEf1;
    ...
    // Name and symbol
    string constant _name = "VIRGIN INU";
    string constant _symbol = "VGI";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10_000_000_000 * 10 ** _decimals; // 1m 
