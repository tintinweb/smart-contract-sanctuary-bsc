...
contract TTC is ExtendedReflections {
    ...
    uint256 private _maxTxAmount = 50_000_000_000_000 * (10 ** _decimals);
    uint256 private _maxWalletAmount = 50_000_000_000_000 * (10 ** _decimals);
    ...
    constructor (address _marketingAddress) ExtendedReflections("BabyNekomata", "BabyNekomata", _decimals, _tokenSupply) {
