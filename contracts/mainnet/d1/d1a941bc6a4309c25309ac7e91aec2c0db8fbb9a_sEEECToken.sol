...
contract sEEECToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked EEEC", "sEEEC", 9) ERC20Permit() {
    ...
    /**
        @notice increases sEEEC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sEEEC
