...
/*
    💠Telegram : https://t.me/Medic_Cat , @Medic_Cat
*/
...
contract Medic_Cat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Medic Cat";
    string private _symbol = "$MedCat";
    ...
    uint256 private _totalSupply = 6 * 10**9 * 10**9;
    ...
    address payable public marketingWalletAddress = payable(0xFCfD32Ea1430FeF85244Dc0cCA0D426a6a1377E3); 
    address payable public rewardsWalletAddress = payable(0x5dEEba1C4a6ef5e698d5c54e4B30597c69dd9c79); 
