...
contract UNMS is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7a7D9769816D2E9E5e3780828418f6300eA54b8D));
        marketingWalletAddress = payable(address(0x7a7D9769816D2E9E5e3780828418f6300eA54b8D));
