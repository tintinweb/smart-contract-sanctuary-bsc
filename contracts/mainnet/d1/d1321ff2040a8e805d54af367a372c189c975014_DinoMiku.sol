...
/**
DINO MIKU is a project that stands on the BSC network Dino miku is a pure token that is fully controlled by the community, dino miku is a token that follows viral trends and will become a big token with strong community support
initial lock 15 day
website www.dinomiku.site
telegram community https://t.me/dinomiku

Project
Dinomiku Swap - ready
Dinomiku Ticket - soon
Dinomiku NFT - soon
*/
...
contract DinoMiku is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8cf18EF6f7A03205c9C26753E1E1F5874B474A95); 
    address payable public Wallet_Dev = payable(0x1D7ED3fE038BC65f4979CE32EC1DC8955943bd8D);
    ...
    string private constant _name = "Dino Miku"; 
    string private constant _symbol = unicode"DINOMIKU"; 
    ...
    constructor () {
        ...
        _owner = 0x1D7ED3fE038BC65f4979CE32EC1DC8955943bd8D;
