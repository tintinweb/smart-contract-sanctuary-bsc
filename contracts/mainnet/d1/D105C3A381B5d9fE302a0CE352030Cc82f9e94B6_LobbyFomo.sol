...
contract LobbyFomo is Ownable, ReentrancyGuard {
    ...
    uint256 public lobbyStartTime = 1660068000;
    ...
    // Admin updates where DAI goes to
    function updateGameReceiver(address _m) external onlyOwner {
        require(_m != address(0), "Invalid address");
        gameReceiver = _m;
    }
