...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1840056a10A019A0B45C50e1190e3A444883D546; // owner address
...
contract FLOKITACEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKITA CEO";
    string private _symbol = "FCEO";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x1840056a10A019A0B45C50e1190e3A444883D546); 
    address payable public teamWalletAddress = payable(0x1840056a10A019A0B45C50e1190e3A444883D546);
