...
NEED TO DEPLOY CONTRACT  https://t.me/THOMASS_DEV
...
contract Elonschrodinger is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50_00_00_000 * 10**_decimals;
    ...
    string private constant _name = "ELON SCHRODINGER";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 1, // 0 RFI rate, in %
            dev: 17, // dev team fee in %
            treasury: 0, // treasury fee in %
            lp: 2, // lp rate in %
            toSwap: 19 // treasury + dev + lp
        });
