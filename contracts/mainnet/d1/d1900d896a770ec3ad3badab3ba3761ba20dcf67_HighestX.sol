...
contract HighestX is ERC20Detailed, Ownable {
    ...
    string public _name = "HIGHEST X ";
    string public _symbol = "HX";
    ...
    uint256 public PlatinumFee = 20;

    uint256 public sellFee = afFee.add(PlatinumFee);
    uint256 public burnFee = 10;
    uint256 public totalFee = liquidityFee.add(reserveFee).add(cafFee).add(burnFee);
    ...
    constructor() ERC20Detailed("HIGHEST X", "HX", uint8(DECIMALS)) Ownable() {
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = afFee.add(PlatinumFee);
        totalFee = liquidityFee.add(reserveFee).add(cafFee).add(burnFee);
