...
contract BNBFARMING is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD02FcA62aF8596001CEe8991D2Dc9e1B14B24f98); 
    address payable public Wallet_Dev = payable(0xD02FcA62aF8596001CEe8991D2Dc9e1B14B24f98);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 5;
    uint256 private _tTotal = 2000 * 5**_decimals;
    string private constant _name = "BNBFARMING"; 
    string private constant _symbol = unicode"BNBFARMING"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 24; 
    ...
    uint256 public _maxTxAmount = _tTotal * 40/ 100; 
    ...
    constructor () {
        ...
        _owner = 0x17eB560264025a02B7B0eb3DEF2A015AE640a4F2;
