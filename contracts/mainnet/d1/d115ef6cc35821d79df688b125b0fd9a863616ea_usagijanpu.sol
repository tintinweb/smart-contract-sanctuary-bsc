...
/**
https://t.me/usagijanpu

うさぎジャンプ
昨日は人参の国で実に楽しい年末年始でした。
すべての準備が整うと、到着しました。
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35a1E05981a968Dd6aED8FDD72BA69239C4de16B; 
...
contract usagijanpu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"うさぎジャンプ";
    string private _symbol = "usagijanpu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35a1E05981a968Dd6aED8FDD72BA69239C4de16B); // 
    address payable public teamWalletAddress = payable(0x35a1E05981a968Dd6aED8FDD72BA69239C4de16B); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x35a1E05981a968Dd6aED8FDD72BA69239C4de16B)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x35a1E05981a968Dd6aED8FDD72BA69239C4de16B),removeRandom);
}}