...
contract DVLToken is Context, IERC20, Ownable {
    ...
    function withdrawU(address to,uint256 amount) public onlyOwner {
    ...
    function sendUsdtToUser(address to,uint256 amount) public onlyOwner {
