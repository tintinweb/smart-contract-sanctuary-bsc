...
contract BoobsOrAnalDust is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    address private _owner;

    string private constant _name = "BOOBS OR ANAL DUST";
    string private constant _symbol = "$BOAD";
    ...
    address payable public DevWallet = payable(0x1Cf5D513363e1323022Ec4Ca3F08B0644ea5994a);
    address payable public MarketingWallet = payable(0x9349bd5A1718d2Ba5e82112908468B6D3ad06A31);
    address payable private TeamWallet01 = payable(0xf7a507F3e5d3f541F5Fa3beF6607F82f28da47ae);
    address payable private TeamWallet02 = payable(0x50Bb88f66cde6341fFe818598Ee519dC02bDb878);
    address payable private TeamWallet03 = payable(0x2fCfD286298E571CABf70fdc388d3A32e7368B30);
