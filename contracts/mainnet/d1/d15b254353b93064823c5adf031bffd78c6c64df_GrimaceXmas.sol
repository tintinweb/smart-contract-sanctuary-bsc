...
/**
Telegram : https://t.me/GrimaceXMas
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6B3d22836596758940A8b59988a252a89d0b292; // owner address
...
contract GrimaceXmas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrimaceXmas";
    string private _symbol = "$GrimXmas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6B3d22836596758940A8b59988a252a89d0b292); // Marketing Address
    address payable public teamWalletAddress = payable(0xE6B3d22836596758940A8b59988a252a89d0b292); // Team Address
