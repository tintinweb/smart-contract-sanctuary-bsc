...
🚀Website:  https://coo.foundation
🚀Twitter:  https://twitter.com/CooCoinBSC
🚀Telegram: https://t.me/cooplatform
🚀Medium: https://cooplatform.medium.com/
...
contract Coocoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public projectWalletAddress = payable(0xB8c229c362438fE286ed71026984F4E140B45c1a);
    ...
    uint256 public projectFee = 7;
    uint256 public liquidityFee = 1;
    uint256 public burnFee = 1;    

    uint256 public reflectionFee_OnTransfer = 1;    
    uint256 public projectFee_OnTransfer = 50;
    ...
    uint256 public priceImpactLimit = 4000;   //   40%    
    ...
    function _blacklistBot(address account) external onlyOwner() {
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We cannot blacklist Uniswap');
