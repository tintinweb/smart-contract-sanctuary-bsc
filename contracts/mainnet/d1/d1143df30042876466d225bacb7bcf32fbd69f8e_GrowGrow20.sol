...
contract GrowGrow20 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x0d828c7E86Ffb3B1a611b5a51A95dA9390323545));


    string private _name = "Grow Grow 2.0";
