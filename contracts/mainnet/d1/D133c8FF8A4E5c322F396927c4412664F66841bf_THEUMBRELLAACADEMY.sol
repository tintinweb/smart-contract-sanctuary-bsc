...
/**
//☂️ 𝓣𝓱𝓮 𝓤𝓶𝓫𝓻𝓮𝓵𝓵𝓪 𝓐𝓬𝓪𝓭𝓮𝓶𝔂 𝓣𝓸𝓴𝓮𝓷
//Website : https:///tuatoken.com
//Telegram : https://t.me/tuatoken
// Twitter : https://twitter.com/tuatoken
...
contract THEUMBRELLAACADEMY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc9A74468b0CaB66b9a7774a3346D8Fb52Ba6f0f3); 
    address payable public Wallet_Academy = payable(0xBf1AE4a7276533FCbA5f76f9ad9A38d6CAa7715F);
    ...
    string private constant _name = "The Umbrella Academy"; 
    string private constant _symbol = unicode"TUA"; 
    ...
    uint256 public Percent_Academy = 30;
    ...
    constructor () {
        ...
        _owner = 0xc9A74468b0CaB66b9a7774a3346D8Fb52Ba6f0f3;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Academy / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Academy);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Academy * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Academy);
            ...
            sendToWallet(Wallet_Academy, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Academy, removeRandom);
