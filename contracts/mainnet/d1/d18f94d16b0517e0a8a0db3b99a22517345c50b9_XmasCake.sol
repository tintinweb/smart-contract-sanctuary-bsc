...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f; // owner address
...
contract XmasCake is Context, IERC20, Ownable {
    ...
    string private _name = "XmasCake";
    string private _symbol = "$XMC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f); // Marketing Address
    address payable public teamWalletAddress = payable(0x0e682C10490c72A8A1AE0A04cDae0e36FFBf7e1f); // Team Address
