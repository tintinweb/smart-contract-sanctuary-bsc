...
contract HToken is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _symbol = "HBTT";
        _decimals = 18;
        _tTotal = 99900000000000000000000 * 10 ** _decimals;
        ...
        _previousLiquidityFee = 4;
        _maxTxAmount = (_tTotal * 5 / 1000) * 10 ** _decimals;
        numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** _decimals;
        
        address feeaddress=0x99B4ded84034F775Ff682891D9195e85793C89A5;

        _devWalletAddress = feeaddress;
        
        address tokenOwner=0x4Ca9362318E7bB21181FBB78d47b0d68faB5693C;
