...
contract AVATARToken is BEP20 {
  ...
  address private constant marketingPool = payable(0xcF93c8935F1c40b7851697b36AB92B6Be0aFd24F);
  IUniswapV2Router02 private constant uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
  address private immutable uniswapPair;

  constructor(address owner_) BEP20(owner_, "AVATAR", "AVATAR", 18) {
  ...
  function setTaxSwitchStatus(bool _status) external onlyOwner {
    taxSwitch = _status;
  }
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
    ...
    // AddLiquidity time
    if(receiver == uniswapPair && balanceOf(receiver) == 0){
        liquidityTime = block.timestamp;
    }

    // excludeTx time limit buy
    if(liquidityPool[sender] && block.timestamp <=  (liquidityTime + excludeTxTime)) {
        excludeTx[receiver] = true;
    }

    if(taxSwitch == false || excludeFee[sender] || excludeFee[receiver]) {
