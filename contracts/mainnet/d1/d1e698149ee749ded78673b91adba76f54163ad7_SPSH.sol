...
contract SPSH is Context, IERC20, Ownable {
    ...
    string private _name = "SPSH";
    string private _symbol = "SPSH";
    ...
    address public developerAddress = address(0x720e2ac1779BDF1230373B7dCf15E0DaF7C95fC7);
    ...
    constructor() public {
        ...
        _isExcludedFromFee[address(0x4D044Da1b6d1A31174a570452564b6FfeeEd9Fd5)] = true;
        _isExcludedFromFee[address(0x640b59c30D0994B320BC40B9D025fD57aeC75207)] = true;
        _isExcludedFromFee[address(0x75BC4BB9fbAa2b8bbd1e7Aa5CB5e69fdbd04F7DC)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 1000000000 * 10**18;
        _balances[address(0x4D044Da1b6d1A31174a570452564b6FfeeEd9Fd5)] = 994900000 * 10**18;
        _balances[address(0x640b59c30D0994B320BC40B9D025fD57aeC75207)] =   5000000 * 10**18;
        _balances[address(0x75BC4BB9fbAa2b8bbd1e7Aa5CB5e69fdbd04F7DC)] =    100000 * 10**18;

        emit Transfer(address(0), address(0x4D044Da1b6d1A31174a570452564b6FfeeEd9Fd5), 994900000 * 10**18);
        emit Transfer(address(0), address(0x640b59c30D0994B320BC40B9D025fD57aeC75207),   5000000 * 10**18);
        emit Transfer(address(0), address(0x75BC4BB9fbAa2b8bbd1e7Aa5CB5e69fdbd04F7DC),    100000 * 10**18);

        doAddKol(address(0xb38521Adb18E2B87cf9479bbcCdE28dB8cD63C62));
    }
