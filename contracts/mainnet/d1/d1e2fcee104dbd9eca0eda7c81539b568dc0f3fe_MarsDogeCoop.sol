...
contract MarsDogeCoop is Context, IBEP20, Ownable, PancakeTool {
    ...
    address public marketingAddress = 0x6c4C51d93552AC44647E4355E346859D491714c2;
    event RewardLogs(address indexed account, uint256 amount);

    constructor() public {
        _name = "Mars Doge Coop";
        _symbol = "MDCOOP";
        _decimals = 18;
