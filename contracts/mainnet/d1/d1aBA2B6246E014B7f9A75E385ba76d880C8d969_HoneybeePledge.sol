...
contract HoneybeePledge is Initializable, OwnableUpgradeable, DivestorUpgradeable {
    ...
    function initialize() initializer public {
        ...
        addrInfo.u = IERC20Upgradeable(0x785180fCEa0b94542D06a35acD1e547C60Accb47);
        addrInfo.BEE = IERC20Upgradeable(0x76428562DE7c607075Da4263de4adA7dB3005f58);
        addrInfo.HBEE = IERC20Upgradeable(0xFCE29c07b4D26C46c9245786A010205c36084714);
        addrInfo.pairOfHBEE = 0x84d9504B99309984f2FbaC46cFF33989e5163F21;
        addrInfo.market = 0xA6126935164e35fc62a8716b403A6c8b4bb28ee3;
        addrInfo.technology = 0xA6126935164e35fc62a8716b403A6c8b4bb28ee3;
    ...
    function _changeBurnRate() public  {
        for (uint i = 0; i < 5; i++) {
    ...
    function viewValidValue(address account_) public view returns (uint) {
        ...
        uint amount = userInfo[account_].stakeValue * 3;
        if (amount < userInfo[account_].claimedValue) {
            return 0;
        }
        return amount - userInfo[account_].claimedValue;
    }
    ...
    function stake(uint slot_, uint value_, bool isHBEE_, address inviter_) public {
        ...
        if (debt.startTime == 0 && debt.totalValue + value_ >= burnPower[0]) {
