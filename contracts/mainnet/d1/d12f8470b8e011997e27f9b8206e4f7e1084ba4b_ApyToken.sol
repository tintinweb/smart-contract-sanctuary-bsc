...
contract ApyToken is ERC20Detailed, Ownable, BaseToken {
    ...
    {   
        ...
        require(_arg.burnShare_ + _arg.marketingShare_ + _arg.liquidityShare_  == 100, "Total fee shares must be equal to 100");
        ...
        emit TokenCreated(owner(), address(this), TokenClass.apyToken, 2);
    }
