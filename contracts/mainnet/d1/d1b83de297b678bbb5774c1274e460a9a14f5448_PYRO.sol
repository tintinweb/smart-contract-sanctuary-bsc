...
/*
PYRO will fully live up to the name by creating a hyper deflationary token that gains value with every buy AND sell. 
...
We have a higher launch sell tax set in place to help kickstart the burning process while volume is high, and to help keep pesty bots out of the project.

6% TRUE BURN AND 4% MARKETING
...
contract PYRO is ERC20, Ownable {
    ...
    constructor() ERC20("PyroMatic", "PYRO") {
        ...
        swapTokensAtAmount = supply * 30 / 10000; // 0.05% swap wallet;
        ...
        devWallet = 0x29EAF5e0e15552229fE2eE88eaDF7Aa05f373bD4;
