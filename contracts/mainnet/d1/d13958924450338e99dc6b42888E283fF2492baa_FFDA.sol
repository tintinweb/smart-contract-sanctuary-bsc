...
// WEBSITE: 
// Twitter: https://twitter.com/elonmusk/status/1632524437227716608
...
contract FFDA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCF41fbC7B38da4b75CAaB7Ca6C3F70Ef26de0661); 
    address payable public Wallet_Dev = payable(0xCF41fbC7B38da4b75CAaB7Ca6C3F70Ef26de0661);
    ...
    string private constant _name = "FFDA"; 
    string private constant _symbol = unicode"FFDA"; 
    ...
    constructor () {
        ...
        _owner = 0xCF41fbC7B38da4b75CAaB7Ca6C3F70Ef26de0661;
