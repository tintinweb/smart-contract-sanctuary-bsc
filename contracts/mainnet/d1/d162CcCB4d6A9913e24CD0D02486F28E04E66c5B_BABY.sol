 ...
 *TG: https://t.me/BabyDomsInu 
 Baby Doms Inu is longing to be with his dad, Doms Inu. The only way that we could help
 this pup to fulfill his will is to hold and wait for it to moon.
*/
...
contract BABY is IBEP20, Auth {
    ...
    string constant _name = "BABY DOMSINU";
    string constant _symbol = "BABYDOMS";
