...
contract BabyGemsPad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby GemsPad";
    string private _symbol = "BGP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5285014109B9e9816D0557a6Df16f051e71A3C6); 
    address payable public buyBackWalletAddress = payable(0xc5285014109B9e9816D0557a6Df16f051e71A3C6); 
