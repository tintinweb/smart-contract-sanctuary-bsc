...
contract PantherCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PantherCoin";
    string private _symbol = "PANTHER";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x6670b10374f38c777AAEeC0D4e1F8C5B42DDF581); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6670b10374f38c777AAEeC0D4e1F8C5B42DDF581); // BuyBack Address
