...
Telegram: https://t.me/PatrickStarToken
...
contract PatrickStarToken is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x9b95cEE864EaaF83e0E6D20DbC0b67cea5447997;

    string private constant _name = "PatrickStarToken";
    ...
    function setBuyTaxes(uint256 _Reflections, uint256 _Marketing, uint256 _Liquidity) public onlyOwner {
       require(_Reflections+(_Marketing)+(_Liquidity) <=2000, "Buy Taxes cannot be higher than 20%");
    ...
    require(_Reflections+(_Marketing)+(_Liquidity) <=2000, "Sell Taxes cannot be higher than 20%");
