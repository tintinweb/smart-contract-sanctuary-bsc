...
contract BlueTears is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BlueTearsToken";
    string private _symbol = "BlueTears";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x52c453bBC55855e6816E9cca90c35794f6435098));
