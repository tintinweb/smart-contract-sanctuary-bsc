...
/**
   #cAPE The New Community of Ape Token
    
   I make this #cAPE to hand it over to the community.
   I suggest a Telegram group name for you to create: https://t.me/NewCommunityApeToken
   ...
   I will renounce the ownership to burn addresses to transfer #cAPE to the community and ensure it's 100% safe.

   Can we make #cAPE 10000000X ?
*/
...
contract CommunityApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community Ape";
    ...
    address private marketingWallet = address(0x356287Bcb824f5eD5623b5B663348D82F4920a6f);
