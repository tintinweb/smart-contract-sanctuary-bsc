...
*/
// BABYKATZ (BABYKATZ)
// The Baby coin of the first $KATZ on the Binance Smart Chain.

// Telegram: https://t.me/BabyKatz
...
contract BabyKatz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyKatz";
    string private _symbol = "Baby Katz";
