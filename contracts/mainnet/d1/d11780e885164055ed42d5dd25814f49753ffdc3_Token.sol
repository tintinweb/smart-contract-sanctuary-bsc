...
abstract contract baseContract is  IBEP20 , Ownable {
    ...
    constructor(address _router,string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply) payable Ownable() {
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        marketingAddress = [0xdb2934166bcca0Dea34bFEC1a173E2439Ade5E18,0xd3ff1Fb8De2291bE01fc63781489E395569CA66d];
        marketingShare=[100,100];
        router = IDEXRouter(_router);
        baseToken=0x55d398326f99059fF775485246999027B3197955;

        limit=Limit(3,369,true,369);
        autoSwap=AutoSwap(true,true,1,1000,10000);  
        fees=Fee(2,30,2,100);
...
contract Token is baseContract { 
    constructor() baseContract(0x10ED43C718714eb63d5aA57B78B54704E256024E,"369","369",18,369){
    } 
}