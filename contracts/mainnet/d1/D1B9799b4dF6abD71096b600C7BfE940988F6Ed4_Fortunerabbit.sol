...
pragma solidity ^0.6.2;
contract Fortunerabbit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0x92a5EeeEaF2b424c117bF04c8633A6acD1dE5c44;//营销钱包地址
    address public _liudityWalletAddress = 0x96b21B278Bc11de21859fC0D1484a1eD869c90Ba;//回流钱包地址
    address public _mindWalletAddress = 0x8b35d10986C97d13648494322e9168D5107C3838;//中转钱包 需要授权U给当前合约地址
    address public _deadWalletAddress = 0x000000000000000000000000000000000000dEaD;//销毁钱包
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public _maxTxAmount = 2 * 10**18;
    uint256 public _maxHavAmount = 6 * 10**18;

    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("fobt", "fobt") {
