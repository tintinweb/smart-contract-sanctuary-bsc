...
contract Morocco is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x448FBE3c5eE36290cc6443Cf8a37212103CEDfEA;
        marketingWallet = 0x448FBE3c5eE36290cc6443Cf8a37212103CEDfEA;
        devWallet = 0x448FBE3c5eE36290cc6443Cf8a37212103CEDfEA;
    ...
    function xLimit(uint256 newLimit) private authorized {
        _maxTxAmount = newLimit;
    }

    function WalletLimit(uint256 newLimit) private authorized {
        _walletMax  = newLimit;
    }

    function estrictWhales(bool newValue) private authorized {
    ...
    function setFee(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
    ...
    function setFeeWallet(address newLiquidityReceiver, address newMarketingWallet, address newDevWallet) external authorized {
