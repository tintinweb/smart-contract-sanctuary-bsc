...
contract ShinjuGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shinju Gold";
    string private _symbol = "ShinGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6DCDE9419d1E494E57D871e5a9660c2A54D90503);
    address payable public BuyBackWalletAddress = payable(0x6DCDE9419d1E494E57D871e5a9660c2A54D90503);
