...
contract KISHUGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "KISHU GOLD";
    string private constant _symbol = "KISHUGOLD";
