...
TG: https://t.me/SpaceSnakeTwo

Twitter: https://twitter.com/SpaceSnake2BSC
...
contract SPACESNAKETWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceSnake 2.0";
    string private _symbol = "SSNAKE 2.0";
