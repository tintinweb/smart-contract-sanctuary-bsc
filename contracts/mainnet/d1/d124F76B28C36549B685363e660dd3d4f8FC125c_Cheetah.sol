...
/*             /$$                   /$$                         /$$      
              | $$                  | $$                        | $$      
      /$$$$$$$| $$$$$$$   /$$$$$$  /$$$$$$    /$$$$$$   /$$$$$$ | $$$$$$$ 
     /$$_____/| $$__  $$ /$$__  $$|_  $$_/   |____  $$ |____  $$| $$__  $$
    | $$      | $$  \ $$| $$$$$$$$  | $$      /$$$$$$$  /$$$$$$$| $$  \ $$
    | $$      | $$  | $$| $$_____/  | $$ /$$ /$$__  $$ /$$__  $$| $$  | $$
    |  $$$$$$$| $$  | $$|  $$$$$$$  |  $$$$/|  $$$$$$$|  $$$$$$$| $$  | $$
    \_______/|__/  |__/ \_______/   \___/   \_______/ \_______/|__/  |__/                                          
    a big thanks to Katowice ( @Katerina_978 ) for writing the contract!*/
...
contract Cheetah is ERC20Detailed, Ownable {
    ...
    uint256 rebaseRate = 6148; // = 0.06148% every `rebaseTime`
    ...
    function set_SwapBackSettings(uint amToswap, uint timeBetween) public onlyOwner{
    ...
    function balanceOf(address who) public view override returns (uint256) {
        if(nftBalance(nftAddress).balanceOf(who)==0){
            ...
            uint asd = calcRewardNft(who, _gonBalances[who]);
            return asd.div(_gonsPerFragment);
        }
    }
