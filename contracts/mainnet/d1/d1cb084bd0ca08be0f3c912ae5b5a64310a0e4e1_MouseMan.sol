...
contract MouseMan is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mouse Man';
    string private constant _symbol = ' $CHEESE';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000 * 10**_decimals;//equals 100 000 000 tokens
    ...
    uint256 private gasLimit = 7200000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0xA0a2990d5ec4c9FFAa4f717AFEA86783f32735EA);
    address public Marketing=payable(0x97847a07D1F11ad924b746d9E75a7c33bB467558);
    //MainNet
	...
	uint256 private MaxBuy = 50000 * 10**_decimals;
    ...
    uint256 currentAmountToSwap = 38000 * 10**_decimals;
    ...
    function TeamCollectXMarketingBNB(uint256 amount) public onlyOwner{
        ...
        marketingBalance-=amount;
        payable(Development).transfer((amount*28) / 100);
        payable(Marketing).transfer((amount*72) / 100);
    } 
