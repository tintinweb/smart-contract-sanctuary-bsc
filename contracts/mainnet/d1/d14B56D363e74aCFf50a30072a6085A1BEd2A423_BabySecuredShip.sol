...
contract BabySecuredShip is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Secured ship";
    string private _symbol = "BSHIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B162827f80b4e36e25E1C605267edCc74FEB02C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x97d356a94B3413d1f030EAbcE8D89DC4A19F1e5c); // BuyBack Address
