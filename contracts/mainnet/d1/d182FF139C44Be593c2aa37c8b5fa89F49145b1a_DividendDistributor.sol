...
contract ElephantV2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ElephantTokenV2";
    string constant _symbol = "ElephantToken";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0d2C7eBA14D1daAD358150481c26d7E3C7908AdD;
