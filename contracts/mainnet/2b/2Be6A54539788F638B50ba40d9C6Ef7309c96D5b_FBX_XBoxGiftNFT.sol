...
contract FBX_XBoxGiftNFT is ERC721Enumerable,ReentrancyGuard  {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;
    string private _baseURIextended="https://www.forthbox.io/";
    string[3] private _imageAdress = ["","",""];
    string[3] private _degreeName = ["Tesla","MacBook","PS5"];
    uint256[3] public maxTokenNum =[5,10,20];
    uint256[3] public mintTokenNum =[0,0,0];
    uint256 public maxTotalSupply = 35;
    ...
    constructor () ERC721("FBX_XBoxGiftNFT", "XBoxGift NFT") {
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721) returns (string memory){
        ...
        string memory json = string(abi.encodePacked(
                '{"name":"ForthBox XBox Gift NFT",',
                '"description":"XBox Gift NFT",',
                '"image":"',imageAdress, '",',
                '"base":"',base, '",',
    ...
    function mintNFTsTo(uint256 num,uint256 degree,address to) public onlyOwner {
        ...
        require(degree<=3, "ForthBoxNFT: degree exceed 3!");
