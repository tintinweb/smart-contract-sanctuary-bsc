...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eCc9aAe61c54eA0E46c8Aa769b2548741AaE8c4; // owner address
...
contract FireBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fire BSC";
    string private _symbol = "FB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48423F63242cb24515A0fCd4AF1B213cB49117Aa); // Marketing Address
    address payable public teamWalletAddress = payable(0x59E521454c27e39fF29B8E60a2cec5eAa5671550); // Team Address
