...
contract MILEDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MILE contract."
        );
    }
...
contract MILE is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    MILEDividendTracker public dividendTracker;

    address public rewardToken;
    uint256 public totalSupply_;
    uint256 public minimumTokenBalanceForDividends_;
    ...
    constructor(
        ...
        address dividendTracker_addr

    ) payable ERC20("MILE", "ML") {
        totalSupply_ = 210_000_000*10**18;
        rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        _marketingWalletAddress = 0x05aFAcc258bcdF8A0Fee221C54E46819633eBa80;
        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        minimumTokenBalanceForDividends_ = 50000;
        require(
        ...
        developmentFee = 2;
        marketingFee = 3;
        totalFees = tokenRewardsFee.add(developmentFee).add(marketingFee);
        ...
        dividendTracker = MILEDividendTracker(
            payable(Clones.clone(dividendTracker_addr))
        );
        ...
        */
        ...
        payable(0x05aFAcc258bcdF8A0Fee221C54E46819633eBa80).transfer(msg.value);
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MILE: The dividend tracker already has that address"
        );

        MILEDividendTracker newDividendTracker = MILEDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "MILE: The new dividend tracker must be owned by the MILE token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "MILE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "MILE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MILE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MILE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "MILE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MILE: Cannot update gasForProcessing to same value"
        );
