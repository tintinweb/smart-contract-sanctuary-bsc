...
// Welcome, Peppa Pig (PPig) is launchi on BSC to bring a new meme trend.

// Telegram: https://t.me/PeppaPig_BSC

// Twitter: https://twitter.com/PeppaPigBSC
...
contract PeppaPig is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x7E6e70CEDfD80Ea0b7B2424e45A257864BbB42e9);
    address payable private _twdmkt = payable(0x7E6e70CEDfD80Ea0b7B2424e45A257864BbB42e9);
    
    string private constant _name = "Peppa Pig";
    string private constant _symbol = "PPig";
