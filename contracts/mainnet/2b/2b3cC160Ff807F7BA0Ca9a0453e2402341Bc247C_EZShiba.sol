...
/**
Welcome To EZ SHIBA Fam 🤍

EZ Shiba BSC - Low MC - 5% SHIBA REWARDS!

✅ No Team Tokens
✅ No Private Sale or Presale
✅ Only Stealth Launch
...
Telegram: https://t.me/ezshibatoken
...
contract EZShiba is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 50000000 * 1e9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "EZ Shiba"; // token name
    string public _symbol = "EZSHIBA"; // token ticker
    ...
    uint256 public minTokenToSwap = 5000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 50000000 * 1e9;
    uint256 public minBuyLimit = 50000000 * 1e9;
