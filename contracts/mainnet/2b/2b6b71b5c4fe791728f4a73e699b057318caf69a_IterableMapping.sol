...
contract CzenToken is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Czen Token", "CGG") {
        BNBRewardsFee = 0;
        liquidityFee = 0;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 1;
        marketingWallet = payable(0x60b6703DAfE241B7f0475a9221C993aF98Eb040c);
