...
/*
   ...
   Thanks to Web3 technologies, which have just adapted to the developing technology world, many more platforms such as 
   Metaverse, NFT, Play2Earn are taking their place in human life. Thanks to the Web3AI project, we are bringing artificial intelligence to Web3 systems.
   A brain that can encode its own Metaverse world, perform cross-block transactions and tracking, and examine NFTs is coming.

   Thanks to Web3 chains, Web3AI scans the blocks and tries to understand the operations performed in them by interpreting them. 
   If you think that it is still in a baby stage, it will have learned to produce its own token in an estimated 36 days, 
   to make its own Web3-ETH software within an estimated 47 days, and to build its own blockchain in an estimated 91 days.

   Telegram : https://t.me/web3aiprotocol
...
contract Web3AI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 239000000 * 10**9;
    ...
    address public charityWallet = 0x75Ec308244142B7E8dFbA56Ee30A7580bc2835CB;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 2390000 * 10**9;
    uint256 public _maxTxAmount = 239000000 * 10**9;
