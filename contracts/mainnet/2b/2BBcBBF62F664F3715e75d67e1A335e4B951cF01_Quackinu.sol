...
contract Quackinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quack Inu"; //
    string private constant _symbol = "$QUACKINU"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x18fcCff4B3eCAc03dDEF6e4fed504ddFB6ca4468;
