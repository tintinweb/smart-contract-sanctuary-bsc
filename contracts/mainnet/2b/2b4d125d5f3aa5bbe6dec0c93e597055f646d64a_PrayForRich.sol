...
/**
 ...
 LET'S PRAY TO BE RICH
 LOW TAX FOR RICH
 
 WEB = LIVE IN 4 OR 5 HOURS
 TG = https://t.me/PrayForRich
...
contract PrayForRich is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE46e10ef7E2190F4Ff29d7f6435352C879c3B9fe);
    address payable public teamWalletAddress = payable(0xE46e10ef7E2190F4Ff29d7f6435352C879c3B9fe);
    ...
    string private _name = "PrayForRich";
