...
contract MGP is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 1000000000 * 10**9;
    uint256 public maxSellAmount = 1000000000 * 10**9; 
    uint256 public maxWalletAmount = 1000000000 * 10**9;
    ...
    address public  _marketingWallet = payable(address(0xB0b223500D78A59d0a52c8BfFDf80AD0508Da021)); //change youyr marketing wallet
    address public _buybackWallet = payable(address(0xB0b223500D78A59d0a52c8BfFDf80AD0508Da021)); //change your buyback
    ...
    constructor() ERC20("Meta Games Plus", "MGP") {
        buyFee.rewardFee = 60;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MGP: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "MGP: The new dividend tracker must be owned by the MGP token contract"
        );
    ...
    require(newAddress != address(uniswapV2Router), "MGP: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "MGP: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MGP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MGP: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "MGP: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MGP: Cannot update gasForProcessing to same value"
        );
    ...
    function setBuyFee(
        ...
        require (totalBuyFee <= 300, "Total Buy Fees Can't exceed 30%");
    }
    ...
    function setSellFee(
        ...
        require (totalSellFee <= 250, "Total Sell Fees Can't exceed 30%");
    }
    ...
    function _transfer(
        ...
        require(from != address(0), "MGP: transfer from the zero address");
        require(to != address(0), "MGP: transfer to the zero address");
        require(
    ...
    function swapAndSendToMarketing(uint256 tokens) private lockTheSwap {
      swapTokensForTokens(tokens, WBNB, address(this));
        uint256 marketingTokens = IERC20(WBNB).balanceOf(address(this));
    ...
    function swapAndSendDividends(uint256 tokens) private lockTheSwap {
        ...
        bool success = IERC20(WBNB).transfer(
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("MGP_Dividend_Tracker", "MGP_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "MGP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MGP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MGP contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "MGP_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "MGP_Dividend_Tracker: Cannot update claimWait to same value"
        );
