...
contract babyRacaMoon is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "babyRacaMoon";
  string private _symbol = "babyRacaMoon";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x1c5EbE10F84F27A492aFCD35F0AD2142C3e47026);
  address payable public teamWallet = payable(0x1c5EbE10F84F27A492aFCD35F0AD2142C3e47026);
