...
/*
SunChinese Looking back at the past we can see our Sungokong which generated tremendous 
Power for development and now it's our turn to deepen knowledge of blockchain for the universe

https://t.me/SunChinese
...
contract SUnCHinese is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SUnCHinese";
    string private _symbol = "SSCH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x84FD91e05FC8d6fe8662eCEfF1722197b4e7d6e9);
    address payable public liqWalletAddress = payable(0x84FD91e05FC8d6fe8662eCEfF1722197b4e7d6e9);
    ...
    uint256 private _totalSupply =  854695* 10**_decimals;
    uint256 public _maxTxAmount =    34187* 10**_decimals;
    uint256 public _walletMax =     42734* 10**_decimals;
