...
contract KingCharlesInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Prince of Wales Inu";
    string private _symbol = "PRINCE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7feab7D62E82Ec18496f597AD9e41e950Fe710be); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2bb8351c16d3898C42d52aD99FEEdF7580F7fD55); // BuyBack Address
