...
contract CopycatsINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COPYCATS INU";
    string private _symbol = "COPYCATS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xf7C7BdfF06D364177De6bE49ff3dE084ba26FEd5);
