...
contract Monarchbutterfly is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xaf25110c0FcD776a1a7F9e89c13765aE9623C73b); // Marketing Address
    ...
    string private _name = "Monarchbutterfly";
