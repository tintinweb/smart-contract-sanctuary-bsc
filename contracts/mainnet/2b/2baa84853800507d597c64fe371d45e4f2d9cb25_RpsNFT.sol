...
contract RpsNFT is Initializable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event TokenMint(address indexed to, uint indexed tokenId);

    function initialize(
        string memory baseURI
    ) public initializer {
        __ERC721_init("RPS NFT", "RpsNFT");
