...
contract BeluTests is ERC20, Ownable {
    ...
    struct Priceandliqaccounts {
        address _priceandliqAccount1;
        address _priceandliqAccount2;
        address _priceIncrease;
    }

    Priceandliqaccounts public PriceandliqAccounts = Priceandliqaccounts({
        _priceandliqAccount1: address(_priceandliqAccount1),
        _priceandliqAccount2: address(_priceandliqAccount2),
        _priceIncrease: address(_priceIncrease)
        });
