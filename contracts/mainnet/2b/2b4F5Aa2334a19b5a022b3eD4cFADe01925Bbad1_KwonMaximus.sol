...
contract KwonMaximus is IBEP20, Auth {
   
    using SafeMath for uint256;

    string constant _name = "KwonMaximus";
    string constant _symbol = "KW";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xF6d1357aC1C7058Cd43c17C08B7a7BE4A147CcD7;
