...
contract JizzReflect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("JizzReflect", "JIZZR") {
        marketingWallet = payable(0xed0Ee338063164414779E96dcA347650fdDbe527);
        devWallet = payable(0xed0Ee338063164414779E96dcA347650fdDbe527);
        ...
        uint256 totalTokenSupply = (69_000_000) * (10**18);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    JizzReflect public JizzReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        JizzReflectContract = JizzReflect(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "BitBurnReflect_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main JizzReflect contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(JizzReflectContract);

            uint256 prevBalance = JizzReflectContract.balanceOf(address(this));
            ...
            {
                uint256 received = JizzReflectContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    JizzReflectContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
