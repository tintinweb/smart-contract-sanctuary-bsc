...
contract DividendDistributor is IDividendDistributor {
    ...
    //Mainnet
    IERC20 Fable = IERC20(0xDC50e2dbb96Fd8683f7b9328Ef160bC75d608aB0); 
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Fable.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(Fable);
        ...
        uint256 amount = Fable.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Fable.transfer(shareholder, amount);
...
contract BabyFable is ERC20Detailed, Ownable {
    ...
    uint256 public buyRewardsFee = 40;
    ...
    address public _marketingWalletAddress = 0xEd777ad8D6ac4bad5380eB46Ad8e316B6BfF13da;
    address public _developerWalletAddress = 0x6A6ff9549e2790088EFF15b4Db518ac352D855d6;
    ...
    address public BabyFableDividendReceiver;
    ...
    constructor() ERC20Detailed("Baby Fable of the Dragon", "BabyTYRANT", uint8(DECIMALS)) Ownable() {
        ...
        BabyFableDividendReceiver = address(distributor);
