	...
	ReentrancyGuardUpgradeable
{
	...
	function initialize(address _erc20, address _erc721) public initializer {
		__Ownable_init();
		__Pausable_init();
	...
	function setSystemFee(uint256 percent) public onlyOwner {
	...
	function setTreasury(address addr) public onlyOwner {
	...
	function cancelSalePrice(uint256 tokenId) public whenNotPaused nonReentrant {
		address msgSender = _msgSender();
