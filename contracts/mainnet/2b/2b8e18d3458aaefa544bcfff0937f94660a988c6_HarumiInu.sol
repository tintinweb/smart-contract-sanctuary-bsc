...
//Max Tx and Wallet: 5% (5,000,000,000)

// SPDX-License-Identifier: MIT

//Telegram:https://t.me/HarumiInu
//Website:https://harumi-inu.website/
//Twitter:https://twitter.com/HarumiInu
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6583b61bfC60f335195B17803A68B47091C4b2C5;
...
contract HarumiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "HARUMI INU"; // 
    string private constant _symbol = unicode"🐶Harumi"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x6583b61bfC60f335195B17803A68B47091C4b2C5);
