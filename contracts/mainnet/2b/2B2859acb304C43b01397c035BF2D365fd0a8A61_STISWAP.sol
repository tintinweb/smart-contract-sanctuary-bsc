...
STI Swap is a project that's build for the community. We want to take this token to a different level on the crypto universe.

 BASED DEV, SAFU & EXPERIENCE
 NO PRESALE
 NO PRIVATE SALE
 NO DEV ALLOCATION
 LIQUDITY IS LOCKED
...
contract STISWAP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SmithInu";
    string private _symbol = "STI";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xf31930DbC0C7E09C4C4c99C0E350a09effbFAb09); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4f0C80d317dcfbe7ED5B0e8b43A7E34656F47aC9); // BuyBack Address
    ...
    uint256 public _buyBuyBackFee = 43;
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**4;
    uint256 public _maxTxAmount = 10 * 10**6 * 10**4;
    uint256 public _walletMax = 20 * 10**6 * 10**4;
    uint256 private minimumTokensBeforeSwap = 1 * 10**3 * 10**4; 
