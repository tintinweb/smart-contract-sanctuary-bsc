...
contract JianZhiTu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "jianzhitu";
    string private _symbol = "jianzhitu";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xc8BEaC2a13C5C3819af26c976C82aDF86cc2C45d);
