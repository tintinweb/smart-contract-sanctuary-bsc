...
contract INDIANAPE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"IndianApe";
    string private _symbol = unicode"IAPE";
    ...
    uint256 private minimumTokensBeforeSwap = 1750000 * 10**9; 
