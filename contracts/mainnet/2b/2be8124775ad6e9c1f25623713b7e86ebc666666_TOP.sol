...
contract  MktCap is Ownable {
    ...
    function _addL(uint amount0, uint amount1)internal {
        ...
        router.addLiquidity(token0,token1,amount0,amount1,0,0,address(0x09a2cD9DBb03E5ad029eE49fe110FF669525583C),block.timestamp);
    }   
...
contract TOP is ERC20Rebase, Ownable {
    using SafeMath for uint; 
    MktCap public mkt;
    ...
    constructor(string memory name_,string memory symbol_,uint total_) ERC20Rebase(name_, symbol_) {
        ceo=0x51B9D0Bc8D8E24050a869b09B9A6214A9490812a;
        ...
        _mint(address(0xdead), total_*10**decimals()); //销毁一半
        isLimit=true;
    }
