...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4A9896f57Aa4fA0502dCeEe40644C745a7A7a352; // owner address
...
contract ONISHIBAINU is Context, IERC20, Ownable {
    ...
    string private _name = "Oni Shiba Inu";
    string private _symbol = "ONISHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A9896f57Aa4fA0502dCeEe40644C745a7A7a352);
    address payable public teamWalletAddress = payable(0x4A9896f57Aa4fA0502dCeEe40644C745a7A7a352); 
