...
contract EAI is IBEP20, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "NEBIBASSE";
    string private _symbol = "NBS";
    uint8 private _decimals = 18;

    uint256 private _totalSupply;
    uint256 private _maxSupply = 6000000 * 10**_decimals;
    uint256 private _initialSupply = 6000000 * 10**_decimals;
