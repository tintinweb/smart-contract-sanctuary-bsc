...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x6e5620D51E6875F46408b37EaB966c20e7aa087f;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"777 Fly",//Name
        unicode"777",//Symbol
        9,//Decimals
        777,//Supply
        address(0x6e5620D51E6875F46408b37EaB966c20e7aa087f),//FundAddress
        address(0x6e5620D51E6875F46408b37EaB966c20e7aa087f)//ReceiveAddress
    ){
    }
}