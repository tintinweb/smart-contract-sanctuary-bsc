...
contract METOSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetoShib";
    string private _symbol = "METOSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9912A544D12CC2e402E6B01AFF9b47C70AAceA42); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9912A544D12CC2e402E6B01AFF9b47C70AAceA42); // buyback Address
