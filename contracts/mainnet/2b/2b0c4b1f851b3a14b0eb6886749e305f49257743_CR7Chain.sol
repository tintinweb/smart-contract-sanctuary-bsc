...
contract CR7Chain is IBEP20, Auth {
    ...
    string constant _name = "CR7Chain";
    string constant _symbol = "CR7";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 99) / 100;  // max tx
    uint256 public _maxWalletSize = (_totalSupply * 99) / 100;  // max wallet
    ...
    address private marketingFeeReceiver =0x9910Ff3686321acdb64166Bf3E38119Bbc8671F3;
    address private teamFeeReceiver =0x9910Ff3686321acdb64166Bf3E38119Bbc8671F3;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x9910Ff3686321acdb64166Bf3E38119Bbc8671F3;
