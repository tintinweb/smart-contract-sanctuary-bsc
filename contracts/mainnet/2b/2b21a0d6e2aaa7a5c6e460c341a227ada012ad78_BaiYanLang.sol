...
contract Token is ERC20, Ownable {
    ...
    mapping (address => bool) public bklst; 
    ...
    function addBkList(address user) external onlyOwner{
        bklst[user] = true;
    }

    function removeBkList(address user) external onlyOwner{
        bklst[user] = false;
    }
    ...
    function _transfer(
        ...
        require(!bklst[from],"you are in black list");
        require(!bklst[to],"to is in black");
...
contract BaiYanLang is Token{
    ...
    constructor() Token(
        ...
        "baiyanlang",
        100000000000,
        [address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43),address(0x10ED43C718714eb63d5aA57B78B54704E256024E),address(0x5d7B87d17f5D984Ee45fD6d89DE72CC66cce85aA),address(0xC43a677A3E74f893f7aECC0109dc6aDb689f013a)],
        [uint256(2),uint256(2),uint256(1),uint256(0)],
        [uint256(2),uint256(2),uint256(1),uint256(0)],
        1000000*10**18
    ){
