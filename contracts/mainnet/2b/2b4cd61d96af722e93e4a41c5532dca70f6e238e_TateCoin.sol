...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02309fA692D8Ed236b1Bdce0f919656FFcE9cF61;
...
contract TateCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0ada46baff7de87454121CE69fFCbC9D32725620;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TateCoin";
    string private _symbol = "TateCoin";
 ...
 function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        ...
        require(taxFee <= 10, "taxFee is over 10%");
    ...
    function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
         ...
         require(developmentFee <= 30, "developmentFee is over 30%");
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
         ...
         require(liquidityFee <= 10, "liquidityFee is over 10%");
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        ...
        require(maxTxPercent >= 1 && maxTxPercent <= 100, "maxTxPercent is not in range");
