...
https://t.me/officialShibaKing
Welcome at the first automatic tax lowering system!

Taxes will be lowered automatically by the contract while max wallet and max transaction amount will be raised.
No voodoo magic, everything is handled by the contract!

At launch: 30% buy tax, 70% sell tax - 1% max wallet and 1% max tx
After 10 minutes: 5% buy tax 50% sell tax - 2% max wallet and 2% max tx
After 60 minutes: 5% buy tax 20% sell tax - 3% max wallet and 3% max tx
After 120 minutes: 5% buy tax 5% sell tax - max wallet and max tx raised to maximum
*/
...
contract SHIBKING is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0xA6580E610631Bff50b3f3CdCFE6529DeEBe86f80; 
    address public constant marketing_receiver = 0xA6580E610631Bff50b3f3CdCFE6529DeEBe86f80;
    address public constant liquidity_receiver = 0xA6580E610631Bff50b3f3CdCFE6529DeEBe86f80;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(10 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(5000);}
