...
contract Mops  is Context, IERC20, Ownable {
    ...
    string private _name = "Mops ";
    string private _symbol = "Mops ";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xC310aaA62f71DBeB99C6Bc150c5c8918d905e79B); 
    address payable public teamWalletAddress = payable(0xC310aaA62f71DBeB99C6Bc150c5c8918d905e79B); 
