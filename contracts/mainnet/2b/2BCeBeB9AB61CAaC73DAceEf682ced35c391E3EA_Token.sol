...
contract  Token is IERC20, Ownable {
    ...
    address public  marketAddr3 ;
    address public  marketAddr5 ;
    ...
    uint256 public _marketingFee3 ;
    uint256 private _previousMarketingFee3;

    uint256 public _marketingFee4 ;
    uint256 private _previousMarketingFee4;

    uint256 public _marketingFee5 ;
    uint256 private _previousMarketingFee5;
    ...
    constructor(
        ...
        address adminAddress = 0xBd739CA151ba0E05a1Cf8142e9046D6B14bdeefB;
        _name = "JQKA";
        _symbol =  "JQKA";
        _decimals= 18;
        ...
        marketAddr2 = 0xE03dB3DDB7C948cC1C848Cf4ae2BECcb23DD97B8;
        marketAddr3 = 0x4D7093BF6bbC4cDe4193e55B6B9eC4472F603F17;
        marketAddr5 = 0x0000000000000000000000000000000000000000;
        ...
        _isExcludedFromFee[marketAddr2] = true;
        _isExcludedFromFee[marketAddr3] = true;
        _isExcludedFromFee[marketAddr5] = true;

        swapTokensAtAmount = 100000000* (10**uint256(_decimals));
    ...
    function _transfer(
        ...
        if (0 == startTradeBlock) {
            require(_isExcludedFromFee[from] || _isExcludedFromFee[to], "!Trading");
        }
        ...
        if(canSwap &&from != address(this) &&from != uniswapV2Pair  &&from != owner() && to != owner() ){
            ...
            uint256  addLiquidityTokenNum = (contractTokenBalance*_marketingFee4)/denominator;

            swapTokensForTokens( contractTokenBalance-addLiquidityTokenNum);
            uint tokenBal =  IERC20(_token).balanceOf(address(this));
            addLiquidity(addLiquidityTokenNum ,  tokenBal*_marketingFee4/(denominator));

            if(_marketingFee2 > 0){
                distributeDividend(marketAddr2,tokenBal*_marketingFee2/(denominator));
            }
            if(_marketingFee3 > 0){
                distributeDividend(marketAddr3,tokenBal*_marketingFee3/(denominator));
            }
            if(_marketingFee5 > 0){
                distributeDividend(marketAddr5,tokenBal*_marketingFee5/(denominator));
            }
        }
    ...
    function claimToken(address token, address addr, uint256 amount) onlyOwner  public {
        token.call(abi.encodeWithSignature("transfer(address,uint256)", addr, amount));
    }
    ...
    function setStartTradeBlock(uint256 value) external onlyOwner {
        startTradeBlock = value;
    }
    function setAddr(address value2,address value3,address value5) external onlyOwner {
        marketAddr2 = value2;
        marketAddr3 = value3;
        marketAddr5 = value5;
    }

    function setFee(uint256 num,uint256 num1,uint256 num2,uint256 num3,uint256 num4,uint256 num5) external onlyOwner {
        _liquidityFee = num;
        _marketingFee = num1;
        _marketingFee2 = num2;
        _marketingFee3 = num3;
