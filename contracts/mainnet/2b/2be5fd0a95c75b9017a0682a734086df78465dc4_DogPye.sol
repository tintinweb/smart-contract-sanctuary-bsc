...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0836Ca3E19f0e5F0dd4cf7C75474569A795eA3C;
...
contract DogPye is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF0836Ca3E19f0e5F0dd4cf7C75474569A795eA3C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**11;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DogPye";
    string private _symbol = "DOGPYE";
