...
contract CKNG is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHICKENNUGGET";
    string private constant _symbol = "CKNG";

    address public _PancakeSwapV1RouterUniswap = 0x19a9567019d75b4079372Db2C5611F7305B86693; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x19a9567019d75b4079372Db2C5611F7305B86693; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x19a9567019d75b4079372Db2C5611F7305B86693)] = true; //uniswap router liquidity
