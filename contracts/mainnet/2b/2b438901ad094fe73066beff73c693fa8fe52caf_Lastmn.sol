...
contract Lastmn is IBEP20, Admin{
    ...
    string constant _name = "Last Moon";
    string constant _symbol = "Lastmn";
    ...
    address private marketingFeeReceiver = (0xe1cb0CFe8C456852f756364c5FB6D49415192a0f); // marketing address
    ...
    function setBMLastmn(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMLastmn(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
