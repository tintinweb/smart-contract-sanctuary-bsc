...
contract TETH is Operator {
    ...
    string private _name = "TETH";//#币名
    string private _symbol = "TETH";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x53537e75BBefC00897B78c4AAd27cCC1797a15Fe),true);
    }
