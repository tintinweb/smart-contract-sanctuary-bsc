        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5696a40117c51AbFd4CBa0Da3BFffddF1683bCe1), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000000,//Su
        address(0x5696a40117c51AbFd4CBa0Da3BFffddF1683bCe1),//
        address(0x5696a40117c51AbFd4CBa0Da3BFffddF1683bCe1)//
    ){
    }
}