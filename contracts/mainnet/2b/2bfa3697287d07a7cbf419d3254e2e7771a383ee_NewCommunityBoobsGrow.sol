...
/**
NEW COMMUNITY BOOBS GROW
Tax 8/8
Telegram : https://t.me/NCBGrow
*/
...
contract NewCommunityBoobsGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY BOOBS GROW";
    string private _symbol = "NCBGrow";
