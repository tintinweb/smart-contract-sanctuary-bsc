...
contract SquidGrow is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**11 * 10**11;
    uint256 public _maxWalletAmount = _tTotal;
    uint256 public _maxTxAmount = _tTotal;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**11 * 10**11;
    string private constant _name = "SquidGrowBNB";
    string private constant _symbol = "SGBNB";
