...
//  Telegram : https://t.me/bibotokenofficial
//  Website  : https://bibotoken.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x869019E2293893F12A6b71386569571634890ca6;
...
// Contract BIBO Token BEP20
//
contract BiboToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94c1786057D4dA3Cb23Cec0BE0e28b3b496b8e15;
	address private _marketingWalletAddress = 0x3d8bDE3b5a72504A7F816c117d910e7daDc9C9B8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bibo Token";
    string private _symbol = "$BIBO";
	...
	//initiate Marketing Fee
	uint256 public _defaultMarketingFee = 3;
	uint256 public _marketingFee = 3;
    uint256 private _previousMarketingFee = _marketingFee;
	
	//initiate Liq Fee
	uint256 public _defaultLiquidityFee = 2;
    ...
    function setDefaultTax() external onlyOwner() {
     	_taxFee = 7;
		_marketingFee = 3;
		_liquidityFee = 2;
		_developmentFee = 2;
	...
	function setNewPercentTax(uint256 taxFee) external onlyOwner() {
        _developmentFee = taxFee.mul(30).div(10**2);
		_marketingFee = taxFee.mul(40).div(10**2);
		_liquidityFee = taxFee.mul(30).div(10**2);
		_taxFee = taxFee;
    }
	
    function setNewTax(uint256 developmentFee, uint256 marketingFee, uint256 liquidityFee) external onlyOwner() {
        _developmentFee = developmentFee;
		_marketingFee = marketingFee;
		_liquidityFee = liquidityFee;
		_taxFee = _marketingFee + _liquidityFee + _developmentFee;
    }
