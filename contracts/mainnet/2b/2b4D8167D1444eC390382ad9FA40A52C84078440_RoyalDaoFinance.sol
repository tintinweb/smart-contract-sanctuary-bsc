...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaCb7467D289CA878085f437F767fd57991328C61;
...
contract RoyalDaoFinance is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8352ca8b7C0e293967fA24279e3162b865c5Ae86;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 730000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Royal Dao Finance";
    string private _symbol = "RoyFi";
    ...
    uint256 public _maxTxAmount = 219000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 73000000 * 10**18;
