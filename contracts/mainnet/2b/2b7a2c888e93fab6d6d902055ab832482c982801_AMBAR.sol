...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x623C3a2507D36A6b4B58f5E9885031B53BF88b15;
...
contract AMBAR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1720D05BbDF14B81b2A184b758184Fa363B29DE8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 33300000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AMBAR TOKEN";
    ...
    uint256 public _maxTxAmount = 33300000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 33300000000 * 10**18;
