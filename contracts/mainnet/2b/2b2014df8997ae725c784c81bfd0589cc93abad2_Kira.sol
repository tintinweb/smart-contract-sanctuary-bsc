...
/* 
	...
	* Max Buy: 500,000 (~1.0% of Total Supply)
	* Max Hold: 500,000 (~1.0% of Total Supply)
	*/
	...
	contract Kira is Context, IBEP20, Ownable {
	    ...
	    uint256 private constant _tTotal = 5 * 10**3 * 10**9; // 60 Billion
	    ...
	    uint256 public _maxTxAmount = 5 * 10**3 * 10**9; // Max Transaction: 600 Million (1%)
	    uint256 public _numTokensSellToAddToLiquidity = 3 * 10**3 * 10**9;
	    uint256 public _maxWalletToken = 5 * 10**3 * 10**9; // Max Wallet: 600 Million (1%)
	    
	    IPancakeRouter02 public immutable pcsV2Router;
	    address public immutable pcsV2Pair;
	
	    string private _name = 'Kira';
