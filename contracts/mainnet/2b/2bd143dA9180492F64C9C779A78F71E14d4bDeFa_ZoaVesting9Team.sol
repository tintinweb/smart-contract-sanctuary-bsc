...
contract ZoaVesting9Team is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting9Team: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting9Team: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting9Team: wrong TGE timestamp");
        ...
        // rounds settings
        // (200000 + 66700 * 12) / 1e6 = 1.0004 => 1.0
