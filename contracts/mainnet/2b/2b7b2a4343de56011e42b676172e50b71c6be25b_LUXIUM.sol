...
/**
Luxium Is A Chain or Network Based Project Where we have a project that is unique and different from the others.

We focus on Luxium Blockchain Development. With Features Speed   and also good security. With 200,000 Transactions per second & 10 seconds Block
...
contract LUXIUM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xF24fD80D6E7c0aFa3578C84689252175Ba90e4FA); // Marketing Address

    address payable public devAddress =
        payable(0xF24fD80D6E7c0aFa3578C84689252175Ba90e4FA); // Buyback Address

    address payable public liquidityAddress =
        payable(0xF24fD80D6E7c0aFa3578C84689252175Ba90e4FA); // Liquidity Address
    ...
    string private constant _name = "LUXIUM CHAIN";
