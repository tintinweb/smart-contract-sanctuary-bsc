...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8BFa263f5a1A0A44Af829F929d806A0Cb4e90544; // owner address
...
contract DieTalk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DieTalk";
    string private _symbol = "DieT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8BFa263f5a1A0A44Af829F929d806A0Cb4e90544); // Marketing Address
    address payable public teamWalletAddress = payable(0x8BFa263f5a1A0A44Af829F929d806A0Cb4e90544); // Team Address
