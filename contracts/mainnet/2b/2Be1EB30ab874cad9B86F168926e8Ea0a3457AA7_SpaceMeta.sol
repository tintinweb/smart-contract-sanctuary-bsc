...
contract SpaceMeta is ERC20, Ownable, BaseToken {
  ...
  constructor(
    ...
    swapTokensAtAmount = totalSupply_.mul(3).div(10**6); // 0.003%
  ...
  function swapAndSendToMarketing(uint256 tokens) private {
    ...
    IERC20(uniswapV2Router.WETH()).transfer(
  ...
  function swapTokensForRewardsToken(uint256 tokenAmount) private {
  ...
  function swapAndSendDividends(uint256 tokens) private {
    swapTokensForRewardsToken(tokens);
