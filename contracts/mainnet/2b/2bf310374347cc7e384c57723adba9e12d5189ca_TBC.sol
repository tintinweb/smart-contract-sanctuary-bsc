...
contract TBC is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 200000000 * 10 ** _decimals;
        _tTotal = total;
        ReceiveAddress = 0x76e4D135e0d5A02875a6B7922a0d1767D7278FDE;
        _balances[ReceiveAddress] = total;
        emit Transfer(address(0), ReceiveAddress, total);

        marketAddress = 0xb88Dd1806f03A07F77289a4D6fA8095eA108856a;
        ...
        if (lpAmount > 0) {
            ...
            if (lpWbnb > 0) {
                _swapRouter.addLiquidity(
                    address(this), _WBNB, lpAmount, lpWbnb, 0, 0, address(0xb88Dd1806f03A07F77289a4D6fA8095eA108856a), block.timestamp
                );
            }
        }
    }
