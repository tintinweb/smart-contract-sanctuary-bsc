...
contract KittySquad is Context, IERC20, Ownable {
    ...
    string private constant _name = "KittySquad"; //
    string private constant _symbol = "KITTYSUAD"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xfFe9a3e3C214F0A49575C67bFb848206EECfcf94 ;
