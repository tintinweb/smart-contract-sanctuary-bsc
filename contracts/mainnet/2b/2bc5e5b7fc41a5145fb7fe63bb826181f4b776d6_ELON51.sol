...
Telegram: https://t.me/Elon51BirthdayCake
...
contract ELON51 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON51BDAYCAKE";
    ...
    constructor () {
        _MarketingWallet = payable(0xc7B58e7c84dfA1a8A4BC69d68661c7F08AC669E8);
        _liquidityWallet = payable(0xc7B58e7c84dfA1a8A4BC69d68661c7F08AC669E8);
        _rewardWallet = payable(0xc7B58e7c84dfA1a8A4BC69d68661c7F08AC669E8);
        ...
        emit Transfer(address(0xc7B58e7c84dfA1a8A4BC69d68661c7F08AC669E8), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxSellAmount = 100000000 * 10**9;
        _maxWalletAmount = 100000000 * 10**9;
