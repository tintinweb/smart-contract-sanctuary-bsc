...
contract HadesToken is ERC20, Ownable {
    ...
    uint256 public _totalTaxIfBurning = 2;
    ...
    address public receiveSellFeeWallet = 0xA7745549434624c87332BDDa3E138683fdF44761;
    IWrap public wrap = IWrap(0x7c0513807358aE4c948421e57E54054d853a7392);
    IERC20 public usdt = IERC20(0xb52b7B0Dbc81e5c6C87cc4C6C5DD98ED3CcB889A);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Hades Token", "HT", 8, 100000000 * 10 ** 8){
        address msgSender = _msgSender();
    ...
    function _transfer(address sender, address recipient, uint amount) internal override {
        ...
        if (!freeOfCharge) {
            ...
            if(isMarketPair[sender]) {
                ...
                super._transfer(sender, address(this), feeAmount);
                burnAmount = amount.mul(_totalTaxIfBurning).div(100);
                burn(burnAmount);
