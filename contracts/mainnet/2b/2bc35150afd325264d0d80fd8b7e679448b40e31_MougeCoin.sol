...
// CHANGE
contract MougeCoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Mouge Coin";
    string constant _symbol = "MOUGE";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xAC6b0586550FA96aB5Ca24812088c9fBCB8ca2D1);
    ...
    function setFees(uint256 _liquidityFee, uint256 _burnFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        burnFee = _burnFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_burnFee).add(_reflectionFee).add(_marketingFee);
