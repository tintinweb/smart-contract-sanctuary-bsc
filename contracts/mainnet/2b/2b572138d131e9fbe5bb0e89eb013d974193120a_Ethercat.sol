...
contract Ethercat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7Ac3810Ba76Dbb9b630716Cafb0888872c43eA05); // Marketing Address
    ...
    uint256 private _tTotal = 1000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ethercat";
    string private _symbol = "ETCAT";
    ...
    uint256 public _maxTxAmount = 1000000 * 10**2 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2000 * 10**2 * 10**9; 
