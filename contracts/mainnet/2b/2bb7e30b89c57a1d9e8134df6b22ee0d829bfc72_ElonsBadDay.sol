...
contract ElonsBadDay is IBEP20, Auth {
    ...
    uint256[] public _percentages = [20,20,20,20,10,10,0,0,0,0];                         // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        ...
        payable(0xc097cf7440de0bc62C9C6E887c9E14B9f3B2906d),                     
        payable(0x0651AeB95c05EAc05f906a09D784902E1F8f76Bd),                             
        payable(0x0651AeB95c05EAc05f906a09D784902E1F8f76Bd)                              
    ];
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
      ...
      function sendBNBToWallets() private {
     ...
     function _setPercentages(uint256[] calldata percentages) external onlyOwner() {
