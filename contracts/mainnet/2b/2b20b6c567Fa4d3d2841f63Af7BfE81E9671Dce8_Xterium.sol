...
TG: https://t.me/Xterium_official
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F66D2733b29Afe02E3900c2b5C362eB9aa28D11; // owner address
...
contract Xterium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Xterium";
    string private _symbol = unicode"XTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F66D2733b29Afe02E3900c2b5C362eB9aa28D11); // Marketing Address
    address payable public teamWalletAddress = payable(0x4F66D2733b29Afe02E3900c2b5C362eB9aa28D11); // Team Address
