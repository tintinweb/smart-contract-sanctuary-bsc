...
contract CoreContractUpdated is Project, IBEP20, Auth {
    ...
    function getShareholderRwrdInfo() external view returns (address) {
        return distributor.getShareholderRwrdInfo(msg.sender);
    }

    function getShareholderHasCustom() external view returns (bool) {
        return distributor.getShareholderHasCustom(msg.sender);
    }
