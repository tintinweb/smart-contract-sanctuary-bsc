...
contract LuoBoToken is IBEP20, Ownable {
    ...
    string _name = unicode"萝卜币";
    string _symbol = "LuoBo";
    uint8 _decimals = 6;
    ...
    uint256 public buyreflectionFee = 300;
    uint256 public buymarketfee = 300;
    uint256 public sellreflectionFee = 300;
    ...
    address public marketingFeeReceiver = 0x390A31Fd1Fa55E9Cc624CE7ca9469279A9958526;    
    ...
    constructor () Ownable(msg.sender) {        
        ...
        address _presaler = 0x390A31Fd1Fa55E9Cc624CE7ca9469279A9958526;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalFeeAmount = reflectionAmount + marketAmount ;
        if(totalFeeAmount > 0){
            totalFeeAmount = reflectionAmount  + marketAmount ;
            uint256 totalFeeAmount2 = reflectionAmount + marketAmount ;
