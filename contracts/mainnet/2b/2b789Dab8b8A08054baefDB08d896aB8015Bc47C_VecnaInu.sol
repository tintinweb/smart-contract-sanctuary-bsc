...
/*
Wᴇʟᴄᴏᴍᴇ ᴛᴏ Vᴇᴄɴᴀ Iɴᴜ

Vᴇᴄɴᴏᴍɪᴄs

100 billion $VINU Tokens
...
📣Telegram: https://t.me/VecnaInuAnn
*/
...
contract VecnaInu is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0x49c471B18932c2Ef0DF4F1A7Ab0A07135FBC179b;
    address public devFeeReceiver = 0x6d4D02d699ABfc4f6D899b0eE9a06d239784dff9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair && _coolDown[recipient] == 0) {
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        uint256 expired_cd = block.number.sub(_coolDown[sender]);
