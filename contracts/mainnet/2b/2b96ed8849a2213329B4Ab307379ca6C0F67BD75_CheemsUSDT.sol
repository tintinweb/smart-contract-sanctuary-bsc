...
contract CheemsUSDT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cheems USDT";
    string private constant _symbol = "chUSDT";
    ...
    constructor (address payable _marketingWallet) {
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address(0x55d398326f99059fF775485246999027B3197955)); // USDT
