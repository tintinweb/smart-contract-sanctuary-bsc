...
/*
PororoInu | Trending Pororo in Twitter 
BNBChain/BSC trend is a reflection of real life and twitter trend. It happens all the time in history from Doge, Shiba, and Floki hype.
PororoInu is the first token following the Pororo hype in twitter.

TG : https://t.me/pororoInuBSC
*/
...
contract PororoInu is Context, IERC20 { 
    ...
    uint256 private _tTotal = 8 * 10**12 * 10**_decimals;
    string private constant _name = "PororoInu"; 
    string private constant _symbol = "PororoInu"; 
