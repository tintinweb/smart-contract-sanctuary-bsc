...
contract FortunerInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fortuner Inu"; // 
    string private constant _symbol = "$FORTUNERINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x1291001D428749609541198C875f01a7d1132610;
