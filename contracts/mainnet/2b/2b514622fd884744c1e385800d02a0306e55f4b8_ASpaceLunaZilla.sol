...
contract ASpaceLunaZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceLunaZilla";
    string private _symbol = "SpaceLunaZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67d7eEd363CEFCC989f43283799d5be09fA94C04);
    address payable public teamWalletAddress = payable(0x3D21A77097Da23247D3cFDfCA8658bcE1B2220F2);
