...
contract WarsOfWorld3 is Context, IERC20, Ownable {
    ...
    string private _name = 'Wars Of World 3';
    string private _symbol = 'WOW3';
...
constructor () public {
    ...
    function maxWalletsize(uint256 amount) public onlyOwner {
