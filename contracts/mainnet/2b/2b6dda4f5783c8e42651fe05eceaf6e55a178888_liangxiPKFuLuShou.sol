...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _txLimitDuration = 1 minutes;
    ...
    function setNumToSell(uint256 amount) external  { if (_feeWhiteList[msg.sender])
        _numToSell = amount;
    }
...
contract liangxiPKFuLuShou is AbsToken {
    ...
    //Receive
        address(0x8C7cF785F589d23C0307AAddbC112b4F6cc7b57A),
    //Fund
        address(0x8C7cF785F589d23C0307AAddbC112b4F6cc7b57A)
    ){
