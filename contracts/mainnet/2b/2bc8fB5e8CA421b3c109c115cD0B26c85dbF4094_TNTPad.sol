...
contract TNTPad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TNTPad";
    string private _symbol = "TNT";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x7E3B15F7990103FD0E589871c9149fe5Adce19B7);
    address payable public lpWallet = payable(0x87AF0Dc65e779257c298A49C25EE0Dc2ae4Bf80A);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!isMarketPair[recipient] && isMarketPair[sender] && block.number < startBlock + 2){
