...
contract Dotcoin is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402); //Reward ETH
    ...
    constructor() public ERC20("Dotcoin", "Dotcoin") {
