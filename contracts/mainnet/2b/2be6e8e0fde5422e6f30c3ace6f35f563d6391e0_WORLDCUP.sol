...
/**
 TELEGRAM https://t.me/qatarversusecuador
 
 JUST MEM

 FIRST MACTH QATAR WORLDCUP 2022
 QATAR VS ECUADOR
*/
...
//string
    string private _name = "QATAR VS ECUADOR";
...
//uint
    ...
    uint public maxSellTxAmount = 5000000000 ;
    uint public minimumTokensBeforeSwap = 5000000000 * (10**9); 
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0x9F5566D155DC7d9BaE7Da51F2Bb356505127D4e5)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
