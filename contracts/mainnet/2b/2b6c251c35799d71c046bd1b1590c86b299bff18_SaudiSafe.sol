...
contract SaudiSafe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SaudiSafe";
    string private _symbol = "$SSAFE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02cc0548726f0bA411ae89b9b67f7e19F8B65ddE); // Marketing Address
    address payable public devWalletAddress = payable(0x02cc0548726f0bA411ae89b9b67f7e19F8B65ddE); // Dev Address
