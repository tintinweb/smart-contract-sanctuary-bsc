...
contract NewMetoshiToken is NewMetoshiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NewMetoshiTeam;
    address private CharityNewMetoshi;
    ...
    string public override name = "New Metoshi";
    string public override symbol = "New Metoshi";
    ...
    constructor(uint totalSupplyValue, address NewMetoshiTeamAddress, address CharityNewMetoshiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NewMetoshiTeam = NewMetoshiTeamAddress;
        CharityNewMetoshi = CharityNewMetoshiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NewMetoshiTeam] =  totalSupply * 4 / 100;
        balances[CharityNewMetoshi] = totalSupply * 4 / 100;
