...
contract dripBurner is Ownable {
  ...
  address public LIT = 0x79B2bc95344eFe31cb6a7B0Cf8A843a5eE125dFf;
  ...
  function buyAndSendToTaxVault(uint256 _amount) external onlyAuth {
    ...
    function buyAndSendToTaxVaultWithLit(uint256 _amount) external onlyAuth {
      swap(_router,LIT,BUSD,_amount);
      IERC20 busdToken = IERC20(BUSD);
      uint256 BUSDamount = busdToken.balanceOf(address(this));
      swap(_router,BUSD,DRIP,BUSDamount);
