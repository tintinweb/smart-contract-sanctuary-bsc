...
contract ceshi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x29C5d58b277ab439Cd0E62978Cd3060B2AA99394); 
    address payable public BurnedWalletAddress = payable(0x29C5d58b277ab439Cd0E62978Cd3060B2AA99394); 
    ...
    function changeBuyFee(uint256 LiquidityFee,uint256 MarketingFee,uint256 BurnedFee) public onlyOwner {
         _buyLiquidityFee = LiquidityFee;
         _buyMarketingFee = MarketingFee;
         _buyBurnedFee = BurnedFee;
    }
    bool openTrade;
    ...
    function changeSellFee(uint256 LiquidityFee,uint256 MarketingFee,uint256 BurnedFee) public onlyOwner {
         _sellLiquidityFee = LiquidityFee;
         _sellMarketingFee = MarketingFee;
         _sellBurnedFee = BurnedFee;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!openTrade){
            require(sender != uniswapPair,"not open");
            require(recipient != uniswapPair,"not open");
        }
