...
/**
   ...
   #PitbullGrow(PitG)
    written by Katie & developed by AdaM
...
contract Pitbull is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x0A75a4596BccCf19F406ADE654AbF93AaD5110D1 ;
    ...
    string private _name = "Pitbull Grow";
    string private _symbol = "PitG";
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**6 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 10000000000000 * 10**6 * 10**18;
