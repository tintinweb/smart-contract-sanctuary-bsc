...
contract NEWWWWW is Context, IERC20, Ownable {
    ...
    string private constant _name = "SaintDoge";
    string private constant _symbol = "STDOGE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xAFD89d9df028fCf2c65D22fd34B8B03B9c4d9480);
    address payable private _marketingAddress = payable(0x7eB2B93FcB2538b0E8c9E6ED59146993f4CC84eD);
    address payable private _autoLiquidityReceiver = payable(0x45b788b9f6cF8455addf6475380Ab84d9966e34b);
