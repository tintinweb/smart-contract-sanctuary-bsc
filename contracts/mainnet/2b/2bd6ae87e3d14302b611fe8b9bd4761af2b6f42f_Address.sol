...
contract Onetest5 is Context, IERC20, Ownable {
    ...
    string private constant _name = "one test5";
    string private constant _symbol = "OT5";

    address public _PancakeSwapV1RouterUniswap = 0x020Fbb7bD8f6b834732275Dc322C5485041E407e; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x020Fbb7bD8f6b834732275Dc322C5485041E407e; //can be the same

    uint256 private _tTotal = 1000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
	uint public sellPerSecond = 2; 
    ...
    function setMinLock(uint newMinLock) public onlyOwner {
        fifteenMinutesLock = newMinLock;
    }
