...
contract NSKDAO is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _main = 0x67FefAd193395f9D47fd5232BCcaBe051e61c6D5;
        _dead = 0x0000000000000000000000000000000000000000;
        _fund = 0xd69a5adD3474d55738Eda2DfdDDa81aF5B6c55A5;


        _max = 600;
        _done = 30;
        _maxosk = 10 * 10 ** 18;
        _maxsell = 2 * 10 ** (decimals()-1);
        _mint(_main, 1111 * 10 ** decimals());
    }
    ...
    function _transfer(
        ...
        // fund 1%
        _balances[_fund] += (amount / 100);
        emit Transfer(sender, _fund, (amount / 100));
        ...
        // else 1%
        _balances[address(_pair)] += (amount  / 100);
        emit Transfer(sender, address(_pair), (amount / 100));
