...
contract NinjaBunny is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    ...
    string public _name = "Ninja Bunny";
    string public _symbol = "NB";
    ...
    address public lpPoolAddress = 0x675D6290465C1d35F004d2d3b3bA28eB5A54E67F;
    ...
    function burnManual(uint256 _amount) public onlyOwner {
        ...
        _gonBalances[msg.sender] = _gonBalances[msg.sender].sub(
            _amount.mul(_gonsPerFragment)
        );
