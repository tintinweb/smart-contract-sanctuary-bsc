...
/**
   ...
   Telegram :https://t.me/TheMcGriddles
...
contract McGriddles is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x49bE86e907E76a605AEE9E80A0d0C10938B25a1F); // Marketing Address
    ...
    string private _name = "McGriddles";
    string private _symbol = "McGriddles";
    ...
    uint256 private marketingDivisor = 8;
    
    uint256 public _maxTxAmount = 100 * 10**9 * 10**9; // 10 trillion, or 1% of total supply
