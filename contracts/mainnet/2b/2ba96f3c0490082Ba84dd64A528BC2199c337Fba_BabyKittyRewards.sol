...
10% taxes in buy and sells. 

Contract will post in the same moment we add liquidity.

ALL BOTS WHO BUY BEFORE I POST CA WILL GET BLACKLISTED


📲 Telegram: t.me/BabyKittyRewards
 *         
 * 
*/         
...
contract BabyKittyRewards is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyKittyRewards";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3429276C663ea19c43c5D50FCD2F76A15ac087C4;
