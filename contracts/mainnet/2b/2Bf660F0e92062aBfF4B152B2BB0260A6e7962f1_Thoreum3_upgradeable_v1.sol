...
contract Thoreum3_upgradeable_v1 is Initializable, UUPSUpgradeable, AuthUpgradeable, ERC20Upgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("Thoreumv3 - Thoreum.Finance", "Test10");
        ...
        breakerPercent = 100; // activate at 1%
        breakerBuyFee = 300;  // buy fee 3%
        breakerSellFee = 3000; // sell fee 30%

        /** Auto Liquidity **/
        autoLiquidityCall = true;
        isTreasuryInBusd = true;
        version = 1;

        IDEXRouter _dexRouter = IDEXRouter(0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8); //pcs 3.1% lp fee, biswap  0.53%
        ...
        setTaxTreasury(0x0019d3590Fa4745910e171E24A2Ab477e9997B0b);


        setNukeTreasury(0x5013d1A5a6a0D8bc6Beb60B2A8E67E8aecE3cC80);
        setBusdTreasury(0x5013d1A5a6a0D8bc6Beb60B2A8E67E8aecE3cC80);

        setLiquidityParams(0x95Ac29134fB07e73DEc257cC72D800Ddf8AE76E2,autoLiquidityCall,busdToken);
