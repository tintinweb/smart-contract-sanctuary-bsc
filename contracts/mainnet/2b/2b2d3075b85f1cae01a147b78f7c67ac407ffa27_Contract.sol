...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Donghua Coin"; //
    string private constant _symbol = "DoCo"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4d1c8B74C6C09a6B0DB3bc76eE6EBe9e773d7456;
