...
contract PIGDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIGDAO";
    string private _symbol = "PIGDAO";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x3190FcEa56E9eDb8d9Bd795F2C9df7FC67Eeb2ab); 
    address payable public ttWal = payable(0x3190FcEa56E9eDb8d9Bd795F2C9df7FC67Eeb2ab); 
