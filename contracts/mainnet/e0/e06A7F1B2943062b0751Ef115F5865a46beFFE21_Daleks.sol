...
contract Daleks is ERC20 {
    ...
    constructor() ERC20("Daleks", "EXT") 
    {
        _maxSupply = 1000000000 * (10**18); //Max Supply
        _setOwner(msg.sender);
        maxWallet = _maxSupply * 1 / 100; // 2% Of total supply
        ...
        setSellTax(20); // set initial tax value here
        setTaxWallet(address(0xC6B03105CF49E8212D91d7B626009Cd5D3081971)); //set your wallet here
    ...
    */
    ...
    function setMaxWallet (uint256 amount) public onlyOwner {
        require (amount >= totalSupply() * 1 / 100, "NO rug pull");
        maxWallet = amount;
    }
    ...
    */
    ...
    function setSellTax(uint256 _newSellTax) public onlyOwner {
        require (_newSellTax <= 20, "Max Sell Tax Limit is 20%");
