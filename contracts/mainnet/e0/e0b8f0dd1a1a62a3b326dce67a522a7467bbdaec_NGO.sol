...
contract NGO is Context, IERC20, Ownable {
    ...
    string private _name = "NGO";
    string private _symbol = "NGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf539126BB0DF3C2fAda9250d534229a92535a8cB); // Marketing Address
    address payable public teamWalletAddress = payable(0xcd58db8d3b050ccF24B419ACa0F7Cf5e720F18f4); // Team Address
