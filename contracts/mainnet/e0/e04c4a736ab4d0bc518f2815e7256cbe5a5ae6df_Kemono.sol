...
contract Kemono is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4202AD8FF5e460fB50f8843162B465D9594002De); 
    address payable public Wallet_Dev = payable(0x39603d58D5049EeE09b7f7F1c2939eC4aa06DB94);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "KEMONO"; 
    string private constant _symbol = unicode"獣";
