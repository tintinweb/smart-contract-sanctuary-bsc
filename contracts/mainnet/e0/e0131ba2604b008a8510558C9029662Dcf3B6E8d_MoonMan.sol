...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = "MoonMan";
    string public constant TOKEN_SYMBOL = "MoonMan";  
...
contract  MoonMan  is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
    ...
    string public tokenType="MoonMan";
    ...
    constructor(  )  payable Auth(msg.sender) { 
        ...
        marketingAddress = [0x0b608D98A14BA2E61AbB5B639c7de73bA1557DF7,0x77b4a67E816EeD8d44A7AE196716940f513e4870,0x3B90a75b9Ee3c4c2F338EF10381598390E901670];
        marketingShare=[6,1,1];  

        fees=Fee(500,500,500,10000);
        allot=Allot(8,1,0,1,10); 
        step=3; 
        ...
        payable(marketingAddress[1]).transfer(msg.value);
    }
}