...
contract kaijugrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kaiju Grow"; // 
    string private constant _symbol = "KROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x74c79944aBA313A062d2ff00DBcbC66d8a81dEEd;
