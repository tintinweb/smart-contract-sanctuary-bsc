...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69D8CD271a78cbB8A79AFF96D2e1d33a33F6d3Bd; // owner address
...
contract HeritechGamers is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Heritech Gamers";
    string private _symbol = "HG";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x69D8CD271a78cbB8A79AFF96D2e1d33a33F6d3Bd); // Marketing Address
    address payable private teamWalletAddress = payable(0x69D8CD271a78cbB8A79AFF96D2e1d33a33F6d3Bd); // Team Address
