...
Portal: https://t.me/QatarMuuBsc
Website : https://twitter.com/qatarmuu
...
contract QatarMuu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QatarMuu";
    string private _symbol = "QatarMuu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1890808d44b2da0d641A09cE0961f6cd019e64B); // Marketing Address
    address payable public teamWalletAddress = payable(0xd1890808d44b2da0d641A09cE0961f6cd019e64B); // Team Address
