...
contract MuuInuCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0FbC4D4550a3B325BA90B01C1fe2be714FC4ad56); 
    ...
    string private _name = "Juan The Great";
    string private _symbol = "Muu Inu";
