...
contract Contract is Context, IERC20 {
    ...
    address payable public Wallet_Marketing = payable(0x447c6f2A5Ded8e9cFC9A01fA548212a22af633Ad);
    address payable public Wallet_Dev = payable(0x447c6f2A5Ded8e9cFC9A01fA548212a22af633Ad);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);
    address payable public constant Lp_Reciever = payable(0x447c6f2A5Ded8e9cFC9A01fA548212a22af633Ad);
    ...
    string private constant _symbol = unicode"OVERLORD";
    ...
    constructor () {
        ...
        _owner = 0x447c6f2A5Ded8e9cFC9A01fA548212a22af633Ad;
