...
Telegram: https://t.me/MarinKitagawaOfficial
...
contract MarinKitagawa is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6C198731819d5991D4AA5A95F2b6ED8d2d6e9466); 
    address payable public Wallet_Dev = payable(0x6C198731819d5991D4AA5A95F2b6ED8d2d6e9466);
    ...
    string private constant _name = "Marin Kitagawa"; 
    string private constant _symbol = unicode"MARINKITAGAWA"; 
    ...
    constructor () {
        ...
        _owner = 0x6C198731819d5991D4AA5A95F2b6ED8d2d6e9466;
