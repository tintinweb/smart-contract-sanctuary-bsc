...
// SPDX-License-Identifier: Sharif AlShaweesh @ Arab Network Teknowlogy
...
contract ArabCoin {
    ...
    string public name = "ARAB";
    string public symbol = "ARAB";
    uint public decimals = 18;
    
    event Transfer(address indexed from, address indexed to, uint value);
    event Approval(address indexed ArabNetwork, address indexed spender, uint value);
