...
contract UPWEGO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "UPWEGO";
    string constant _symbol = "UWG";
    ...
    address public marketingFeeReceiver = 0xbC4477bf92cf6C9bF8318c5416B8D5dBd1dc9Fb9;
    ...
    uint256 public swapThreshold = (_totalSupply * 100) / 100000; //0.1% of Total Supply
    ...
    constructor () Ownable(msg.sender) {
            ...
            routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        ...
        isFeeExempt[0xbC4477bf92cf6C9bF8318c5416B8D5dBd1dc9Fb9] = true;
        
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xbC4477bf92cf6C9bF8318c5416B8D5dBd1dc9Fb9] = true;
