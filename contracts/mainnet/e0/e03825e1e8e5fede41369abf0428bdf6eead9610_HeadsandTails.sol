...
/**
     ...
     Heads and Tails
A simple play to earn game on the BSC Network. 
...
contract HeadsandTails is Ownable {
    ...
    address private _houseFeeReceiver = address(0xa2b52495371EEd0bf260B056895077B09E7e2C84);
    uint8 private _houseFeePercentage = 40; // Base1000

    address private _devFeeReceiver = address(0xa2b52495371EEd0bf260B056895077B09E7e2C84);
    uint8 private _devFeePercentage = 5; // Base1000

    uint8 public _referrerFeePercentage = 5; // Base1000
    ...
    function setDevFeePercentage(uint8 newPercentage) external onlyOwner {
        ...
        require(newPercentage <= 10, "Cannot set dev fee percentage higher than 0.5 percent");
    ...
    function setReferrerFeePercentage(uint8 newPercentage) external onlyOwner {
        ...
        require(newPercentage <= 20, "Cannot set refer fee percentage higher than 2 percent");
