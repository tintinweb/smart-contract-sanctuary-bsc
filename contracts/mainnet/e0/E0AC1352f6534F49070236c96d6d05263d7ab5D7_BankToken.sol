...
contract BankToken is ERC20, Pausable, AccessControl, Accounting {
    ...
    constructor() ERC20("BankToken", "BT") {
        ...
        _mint(address(0x33fbDAcf4655432A2799AEe870896616661fbFB7), 50000000 * 10 ** decimals());
        _mint(address(0xf2D3992e3b980c53887D9585d107bA75cF6dfFbd), 50000000 * 10 ** decimals());
        setVestingTime(address(0xDd882b5BF5E3a902Ba607F28282c3d63105FB1c4), block.timestamp - 72 hours);
        setVestingTime(address(0x33fbDAcf4655432A2799AEe870896616661fbFB7), block.timestamp - 72 hours);
        setVestingTime(address(0xf2D3992e3b980c53887D9585d107bA75cF6dfFbd), block.timestamp - 72 hours);
    }
