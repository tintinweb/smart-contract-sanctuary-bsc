...
Backed by a based team, marketing strategy and lp locked this is an EZ hold!

And not to FORGET!
7% $BUSD REWARDS for holding!
...
Add: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 
To see your $BUSD Rewards

First 60 minutes after launch will have GREED MODE!

Sell taxes  upped     x1.5
Buy taxes lowered x1.5

Grab a bag and hold to save BSC
...
/* Token contract */
contract SAPIENCOIN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xd086E693AA8daBc7A395F86b564828136A89a5a0;
    ...
    // Name and symbol
    string constant _name = "SAPIENCOIN";
    string constant _symbol = "DNA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 4% or 2m tokens
    ...
    uint256 public swapThreshold = _totalSupply * 250 / 10000; // 2.5% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x39919C19ebC716090E8f1617ed6a096E69c860E1;
