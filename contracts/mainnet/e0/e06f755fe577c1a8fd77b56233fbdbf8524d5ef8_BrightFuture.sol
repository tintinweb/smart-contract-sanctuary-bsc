...
/*
A bright future is a token based on the BSC network and wants to have a crypto exchange in Shanghai

telegram : https://t.me/BrightFuture_Bsc
...
contract BrightFuture is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x584bC6f386dfAfDCad0a7213Ec60184F55f46E49); 
    address payable public Wallet_Dev = payable(0x70497d6Bd3135C21d836970A6C49A039773a5A32);
    ...
    string private constant _name = "BrightFuture"; 
    ...
    constructor () {
        ...
        _owner = 0x70497d6Bd3135C21d836970A6C49A039773a5A32;
