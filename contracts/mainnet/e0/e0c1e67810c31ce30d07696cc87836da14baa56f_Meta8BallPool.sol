...
contract Meta8BallPool is BEP20, Ownable {
    ...
    address public marketingWallet = 0xE5adB2c1326635249357d0CE5cF6BCF90Caf9059;
    address public devWallet = 0xE7F48795e4f42e6d0D3593c874E5781A65dD9470;
    ...
    Taxes public sellTaxes = Taxes(6, 2, 4);
    ...
    constructor() BEP20("Meta 8 Ball Pool", "MBP") {
    ...
    function SetSellTaxes(
        ...
        require(_dev >= 1,"Can't set Dev Tax lower than 1");
        require((_marketing + _liquidity + _dev) <= 25, "Must keep fees at 25% or less");
