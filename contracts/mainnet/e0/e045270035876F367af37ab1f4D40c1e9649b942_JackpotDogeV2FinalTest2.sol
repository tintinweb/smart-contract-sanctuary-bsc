...
contract JackpotDogeV2FinalTest2 is IBEP20 {
    string constant _name = "JackpotDogeFinalTest2";
    string constant _symbol = "JPDFinalTest2";
    ...
    uint256 public maxJackpotBalanceBeforeDistribute = 10 ether;
