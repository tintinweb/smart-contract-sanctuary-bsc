...
contract Xenovia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xenovia";
    string private _symbol = "XNVA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAb0d1817bb4Ab926d7204a84F42c478DE7f6c6c5);
    address payable public teamWalletAddress = payable(0x6B64c4E1Ab6781FB1703dd4999aeA788E3eC3a74); 
