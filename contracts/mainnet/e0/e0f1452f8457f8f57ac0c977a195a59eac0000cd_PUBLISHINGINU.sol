...
contract PUBLISHINGINU is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "PublishingArticlesInu";
   string constant _symbol = "PUBLISHINU";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 100 ) / 100; //
    uint256 public _maxSellTxAmount = ( _totalSupply * 10 ) / 100; // 
