...
Telegram:https://t.me/ordinal_paw_portal

Twitter: https://twitter.com/ordinal_paw

Website: https://www.opaw.live/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe8f542cFe909Ed26fF14D7Fd87D1cd0D509632c6; 
...
contract OrdinalPaw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OrdinalPaw";
    string private _symbol = "$OPAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8f542cFe909Ed26fF14D7Fd87D1cd0D509632c6); // 
    address payable public teamWalletAddress = payable(0xe8f542cFe909Ed26fF14D7Fd87D1cd0D509632c6); // 
