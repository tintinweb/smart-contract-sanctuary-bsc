...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BNBTIGRESS = IBEP20(0x19af1D634E02F6157bc0D0b3650Ac315cb65a606);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BNBTIGRESS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BNBTIGRESS);
        ...
        uint256 amount = BNBTIGRESS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BNBTIGRESS.transfer(shareholder, amount);
...
contract TigerCeo is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xBcCE766E9767dC17ed6EDe42628faDC6f6567068;

    string constant _name = "Tiger CEO";
    string constant _symbol = "TIGERCEO";
