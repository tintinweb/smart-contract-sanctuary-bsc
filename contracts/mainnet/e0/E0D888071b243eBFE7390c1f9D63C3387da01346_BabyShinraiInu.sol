...
// EASY MOONSHOT!
// TG: https://t.me/babyshinraiinuportal CALSI PORTAL
...
contract BabyShinraiInu is IERC20, Ownable {
    ...
    string _name = "Baby Shinrai Inu";
    string _symbol = "BSHINRAINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 3) / 1000;   // 1%
    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000;     // 1%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xdf01f130749FE0Cf8ade8bC074B62F2882d2E2c9;
        marketingFeeReceiver = 0xdf01f130749FE0Cf8ade8bC074B62F2882d2E2c9;
        devFeeReceiver = 0xdf01f130749FE0Cf8ade8bC074B62F2882d2E2c9;
