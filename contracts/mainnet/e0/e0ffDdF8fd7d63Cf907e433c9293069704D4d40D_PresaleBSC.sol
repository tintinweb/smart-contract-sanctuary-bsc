...
contract PresaleBSC is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
   ...
   */
  function initialize(address _oracle, address _usdt, uint256 _startTime, uint256 _endTime, uint256[1][2] memory _rounds, uint256[][2] memory _tokenQuantity, uint256[][2] memory _lockup, uint256 _defaultLockup, uint256 _initialClaimPercent) external initializer {
