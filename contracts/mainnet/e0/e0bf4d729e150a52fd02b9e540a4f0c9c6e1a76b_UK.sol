...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public maxTXAmount;//单钱包最大持仓数
    ...
    constructor (
        ...
        _feeWhiteList[address(0xbA5D1385AbC2041d3d1030342A59F6D17A9d08F9)] = true;	//白名单
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 12) {
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 51 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function _tokenTransfer(
        ...
        _balances[sender] = _balances[sender] - tAmount;
        uint256 feeAmount;
        uint256 holdbalance = balanceOf(recipient);
        ...
        if (takeFee) {
            ...
            if (isSell) {
				...
				require(holdbalance <= maxTXAmount);//单钱包限购
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint firstfundamount = fundAmount / 10;
        uint secfundamount = fundAmount - firstfundamount;
        address secFundAddress = 0xA42dc8546B121d5DacB8eb531000d6f18f005f34;//填营销;
...
contract UK is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE355746B7FCC71E85ef229749f57b5703f2F26aa),//0.5税做事奖励
    
        address(0xCd4703210325698d26Cf8e1390B4716Ea2e2be40)//管理员钱包
    ){
