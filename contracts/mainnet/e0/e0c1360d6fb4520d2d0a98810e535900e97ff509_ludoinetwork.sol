...
/*
 Introducing LudoI Network, the revolutionary new platform that uses artificial intelligence technology to automate the process of creating,
deploying and managing smart contracts on the blockchain. 
Gone are the days of manually coding and debugging smart contracts - with LudoI Network 
you in minutes without any coding experience can create and deploy smart contracts.
With our advanced artificial intelligence algorithms, managing and updating your contracts has never been easier. 
Start using LudoI Network today and take your blockchain projects to the next level.

http://ludoi.network/

http://docs.ludio.network/

https://t.me/LudoINetwork
*/
...
contract ludoinetwork is Context, IERC20, Ownable {
    ...
    string private _name = "LudoI Network";
    string private _symbol = "LDI";
    ...
    address public charityWallet = 0x149C4B5e0871E042d58CBf4a2c3E5823845A33BD;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 3100000 * 10**9;
    uint256 public _maxTxAmount = 310000000 * 10**9;
