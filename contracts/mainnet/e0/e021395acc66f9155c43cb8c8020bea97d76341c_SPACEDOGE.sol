...
contract SPACEDOGE is IBEP20, Auth {
    ...
    string constant private _name = "SpaceDoge";
    string constant private _symbol = "SDG";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setIsFeeExemptReward(address holder, bool exempt) external authorized {
