...
contract SQUIDNALDO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4009fe0DBF98904a82b8A17F4A0Ce2D8D9f6C2ed); 
    address payable public Wallet_Dev = payable(0x4009fe0DBF98904a82b8A17F4A0Ce2D8D9f6C2ed);
    ...
    string private constant _name = "SQUIDNALDO"; 
    string private constant _symbol = unicode"SQUIDNALDO"; 
    ...
    constructor () {
        ...
        _owner = 0x28eE70F82fFf691B89FD8dA009D2b52384ed3ace;
