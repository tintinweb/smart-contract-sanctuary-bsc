...
contract $TIMEgrow  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$TIMEgrow";
    string private _symbol = "$TIMEgrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfDCFF695e3928d5Bab218ED754C510dbb9b894c8);
    address payable public teamWalletAddress = payable(0xC1ceE808f0Cc0f410Bb42bbA07aC03a5a5C5BdF4);
    ...
    constructor () {
        ...
        emit Transfer(address(0x4AAd6A01068c2621545d087A3c5281837112585b), _msgSender(), _totalSupply);
    }
