...
contract ELONRETWEET is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON RETWEET";
    string private constant _symbol = "$ETWEE";
