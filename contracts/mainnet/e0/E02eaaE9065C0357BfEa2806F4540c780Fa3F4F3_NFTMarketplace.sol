...
contract NFTMarketplace is Ownable{
    ...
    mapping(uint256 => uint256) public priceFloor;
    address private tokenAddress;
 ...
 */
    ...
    modifier priceGreaterThanPriceFloor(uint256 tokenId, uint256 price) {
        uint256 _rarity = nftCollection.getRarityOfTokenId(tokenId);
        require(price >= priceFloor[_rarity], "Price must be greater than price floor!");
        _;
    }
 ...
 */
    ...
    function makeOffer(uint256 _id, uint256 _price)
        ...
        priceGreaterThanPriceFloor(_id,_price)
    {
...
================================================================
 */
    function changePriceFloor (uint256 _rarity, uint256 _price) public onlyAdmin{
        priceFloor[_rarity] = _price;
    }
    ...
    function changeFeeRate(uint256 rate) public onlyAdmin {
        feeRate = rate;
    }
