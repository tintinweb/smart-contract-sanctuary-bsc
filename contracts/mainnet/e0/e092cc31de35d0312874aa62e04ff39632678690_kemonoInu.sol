...
contract kemonoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kemono Inu"; // 
    string private constant _symbol = "$KENU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x088415059972CA109AF2Df1b61Bb9fa77c903AFD;
