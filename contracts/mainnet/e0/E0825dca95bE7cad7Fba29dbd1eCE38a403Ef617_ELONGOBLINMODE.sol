...
contract ELONGOBLINMODE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON GOBLIN MODE";
    string private constant _symbol = "$EGOBLIN";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0x6B22de9A1021Df9CeE802061BfA957C25e749334;
