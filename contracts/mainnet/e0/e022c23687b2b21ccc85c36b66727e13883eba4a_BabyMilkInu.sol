...
/**
   #Baby Milk Inu The New Community of Ape Token
    
   I make this #Baby Milk Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: Angel Shiba is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/BabyMilkInu
...
I will lock the pool for 60 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..
   ...
   Can we make #Baby Milk Inu 1000X ?
*/
...
contract BabyMilkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Milk Inu";
    string private constant _symbol = "BMILKI";
