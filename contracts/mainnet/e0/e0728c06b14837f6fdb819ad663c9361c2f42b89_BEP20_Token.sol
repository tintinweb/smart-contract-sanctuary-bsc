...
contract BEP20_Token is Context, IERC20, Ownable {
    ...
    string private _name = "Tradition";
    string private _symbol = unicode"传统";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d9e5a16A09eA51240eBB68b91f746623f067EC8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6d9e5a16A09eA51240eBB68b91f746623f067EC8); // BuyBack Address
