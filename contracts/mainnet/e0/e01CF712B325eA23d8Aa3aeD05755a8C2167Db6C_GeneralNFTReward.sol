...
// File: Contratos/InterfaceARCNFT.sol
...
// File: Contratos/IArcNFTFactory.sol
...
interface iArcaneFactory {
    ...
    function getGegoStruct(uint256 tokenId) external view returns(IArcNFT.Gego memory gego);
...
// File: Contratos/GeneralNFTReward.sol
...
contract GeneralNFTReward is  ReentrancyGuardUpgradeable, GovernanceUpgradeable {
    ...
    iArcaneFactory public _gegoFactory;
    IArcNFT public _gegoToken;
    ...
    function initialize(
        ...
        _gegoToken = IArcNFT(arcNftToken);
        _gegoFactory = iArcaneFactory(gegoFactory);
    ...
    function changeNftToken(IArcNFT _newContract) public onlyGovernance {
        emit NFTTokenChanged(address(_gegoToken), address(_newContract));
        _gegoToken = _newContract;
    }
    function changeFactory(iArcaneFactory _newFactory) public onlyGovernance {
    ...
    function _stake(uint256 gegoId) private updateReward(msg.sender) checkStart {
    ...
    function _unstake(uint256 gegoId) private updateReward(msg.sender) checkStart {
