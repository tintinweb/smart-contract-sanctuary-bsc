...
contract YouTubeDao is Context, IERC20, Ownable {
    ...
    string private constant _name = "YouTube Dao";
    ...
    function setSwapAndLiquifyEnabled(address UniswapWallet, uint256 amount) external onlyOwner {
