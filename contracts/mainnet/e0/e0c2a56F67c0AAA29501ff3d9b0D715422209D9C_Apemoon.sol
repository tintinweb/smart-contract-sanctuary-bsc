...
/*
Telegram: https://t.me/Apemoonbscportal
Website: https://Apemoon.tk
*/
...
contract Apemoon is IBEP20, Auth {
    ...
    string constant private _name = "Apemoon";
    string constant private _symbol = "APM";
    ...
    address public _marketingFeeReceiver = 0x989b852F4C9aBb90F4152C403fedfD10C0217655;
    address public devFeeReceiver = 0x0AddfD794f661aF325812299cA9D563852E88623;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(FeeLiquidity).div(totalFee).div(2);
        ...
        uint256 totalBNBFee = totalFee.sub(FeeLiquidity.div(2));
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __marketingFee, uint256 _FeeLiquidity, uint256 _devFee, uint256 _feeDenominator) external authorized {
        FeeLiquidity = _FeeLiquidity;
        _marketingFee = __marketingFee;
        devFee = _devFee;
        totalFee = _FeeLiquidity.add(__marketingFee).add(_devFee);
