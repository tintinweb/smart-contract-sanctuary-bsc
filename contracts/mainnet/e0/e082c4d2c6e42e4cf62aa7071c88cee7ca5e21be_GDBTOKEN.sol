...
contract GDBTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract GDBTOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    GDBTOKENDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = GDBTOKENDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GDBTOKENDividendTracker newDividendTracker = GDBTOKENDividendTracker(
            payable(newAddress)
        );
