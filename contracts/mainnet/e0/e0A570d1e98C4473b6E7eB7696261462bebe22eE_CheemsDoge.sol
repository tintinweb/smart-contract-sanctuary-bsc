...
|   :    / |  | ,'    |   :    ||   :    |   ;/          '--'.     / ;   :  .'      `----'   .'__/\_: ||   :    | 
 \   \ .'  `--''       \   \  /  \   \  /'---'             `--'---'  |   ,.'                 |   :    : \   \  /  
  `---`                 `----'    `----'                             '---'                    \   \  /   `----'   
                                                                                               `--`-'             
*/
//CheemsDoge Official Group---https://t.me/CheemsDogeCoin
//CheemsDoge Chinese Group---https://t.me/CheemsDoge_CN
...
contract CheemsDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xEA382Ad9C3F9f74477Cf095398393901f04B5140));
    address payable public _devwallet =
        payable(address(0x6FAcbdAE2f21452304E9Fa643244F3fbd6e7ED27));
    ...
    string private _name = "CheemsDoge";
    ...
    uint256 private numTokensSellToAddToLiquidity = 420000000000000 * 10**9;
    uint256 public _maxWalletSize = 4200000000000000 * 10**9;
