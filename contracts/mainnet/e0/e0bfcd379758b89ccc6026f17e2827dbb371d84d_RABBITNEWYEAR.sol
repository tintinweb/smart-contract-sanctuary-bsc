...
contract RABBITNEWYEAR is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xab1c5CDc8c3CA1f1EEa98d0Fbad5659e4a580127); 
    address payable private Wallet_Dev = payable(0xADA13b82842cc49AA05a19ba848Fe984178a89C2);
    ...
    string private constant _name = "Rabbit New Year"; 
    string private constant _symbol = unicode"RABBITNY"; 
    ...
    constructor () {
        ...
        _owner = 0xADA13b82842cc49AA05a19ba848Fe984178a89C2;
