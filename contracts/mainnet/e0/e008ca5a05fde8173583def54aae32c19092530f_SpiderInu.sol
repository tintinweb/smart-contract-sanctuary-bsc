...
contract SpiderInu is IBEP20, Ownable {
    ...
    address TEAM = 0x77AF057A534996d4b1f2002E071086D905bE504f;
    ...
    constructor () Ownable(msg.sender) {
        ...
        totalFee = liquidityFee.add(_sellFee).add(rewardsFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeApplicable = pair == recipient ? _sellFee : liquidityFee;
