...
// Flappy Floki
// Have you ever wanted flappy birds game combine with crypto currency token and also NFT Art ?
// Flappy Floki bring us to the new experience P2E Token and we have ‘RARE’ NFT available to be minted, not only play for fun but we expand it on blockchain and NFT Art.

// Telegram : t.me/FlappyFlokiBSC
// twitter : @FlappyFlokiBSC
// website : flappyfloki.com
...
contract FlappyFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF0D0792106965c97D8Ddda6c368E32Bd912C2790); 
    address payable public teamWalletAddress = payable(0xF0D0792106965c97D8Ddda6c368E32Bd912C2790); 
