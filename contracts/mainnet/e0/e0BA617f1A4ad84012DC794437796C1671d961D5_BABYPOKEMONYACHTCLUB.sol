...
// https://t.me/babypokemonyachtclub
...
contract BABYPOKEMONYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Pokemon Yacht Club";
    string private _symbol = "BABYPYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x175024148b20e7872C0645d4A1416215Ff217135);
    address payable public teamWalletAddress = payable(0x175024148b20e7872C0645d4A1416215Ff217135);
