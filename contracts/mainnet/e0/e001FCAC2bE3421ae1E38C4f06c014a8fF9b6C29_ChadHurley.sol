...
contract ChadHurley is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Chad Hurley";

    string private _symbol = "CHAD";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x8c7ED4D21F92C1f646774d01D0420CE9c26cf273;
