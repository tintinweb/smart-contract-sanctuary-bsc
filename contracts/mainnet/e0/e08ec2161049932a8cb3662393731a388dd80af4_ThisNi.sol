...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0xF6b17a1A4d0B5A945e6f40F0ECF5E0D467313059, newOwner);
        _owner = newOwner;
    }
...
contract ThisNi is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "Ho this ni***?";
