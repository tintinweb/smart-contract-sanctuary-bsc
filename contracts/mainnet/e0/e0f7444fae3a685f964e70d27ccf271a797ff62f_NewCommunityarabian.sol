...
contract NewCommunityarabian is Context, IERC20, Ownable {
    ...
    string private _name = "New Community Arabian";
    ...
    address payable public marketingWalletAddress = payable(0xc502E941B7b530230708a2f7DD7F32fDA2611246); // Marketing Address
    address payable public teamWalletAddress = payable(0xc502E941B7b530230708a2f7DD7F32fDA2611246); // Team Address
