...
contract ZhongQiuJie is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "ZhongQiuJie";
    string private _symbol = "ZQJ";
    ...
    function doubleInput(address account) external onlyOwner() {
