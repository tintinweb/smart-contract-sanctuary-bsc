...
contract BuilderTeam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CN Builder Team";
    string private _symbol = "CN Builder Team";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24FF384946b9e7A07ce42cC882E07426e193Fd71); // Marketing Address
