...
TELEGRAM: https://t.me/BULLISHPUMPKIN
*/
...
contract BullishPumpKing   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Bullish pumpking ";
    string private _symbol = " BPK "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaD91883AcF14759104140E858338eEFd9d4eE5CB); 
