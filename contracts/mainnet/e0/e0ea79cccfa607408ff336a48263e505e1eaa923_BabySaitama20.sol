...
contract BabySaitama20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Saitama 2.0";
    string private _symbol = "BS2.0";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x27a0654C7ca7E93357B3baF266Df2Be9Ac7F2677); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x27a0654C7ca7E93357B3baF266Df2Be9Ac7F2677); // BuyBack Address
