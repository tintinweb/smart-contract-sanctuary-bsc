...
contract ImLovingIt is ERC20, Ownable, Shared {
    ...
    address public marketingWalletAddress = 0xdAff9732C6b8f7164a6E379B9Bc2f4b83461ec25;
    address public devWalletAddress = 0xdAff9732C6b8f7164a6E379B9Bc2f4b83461ec25;
    ...
    constructor() ERC20("ImLovingIt", "$ILI") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ImLovingIt: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "ImLovingIt: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "ImLovingIt: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, "ImLovingIt: Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ImLovingIt: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ImLovingIt: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "ImLovingIt: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "ImLovingIt: Blacklisted address");
