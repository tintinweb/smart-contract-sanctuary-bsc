...
// Telegram : https://t.me/dragonscoin
...
contract DRAGONSCOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DRAGONSCOIN";
    ...
    function manage_addcoin(address[] calldata addresses, bool status) public onlyOwner {
