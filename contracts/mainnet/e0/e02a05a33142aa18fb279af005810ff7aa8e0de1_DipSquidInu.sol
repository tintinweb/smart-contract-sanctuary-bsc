...
https://t.me/DipSquidInuOfficial
...
/* Token contract */
contract DipSquidInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7d81df76EFa61397282590B0394A1273C081a153;
    ...
    // Name and symbol
    string constant _name = "DipSquid Inu";
    string constant _symbol = "DIPSQUID";
    ...
    uint256 public rewardFeeBuy = 0;
    uint256 public marketingFeeBuy = 6;
    uint256 public treasuryWalletFeeBuy = 2;
    ...
    uint256 public treasuryWalletFeeSell = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDBc190D71e49890006A19Dd33D7877e6b9FABE69;  
    ...
    function setCorrectFees(bool isSell) internal {
        if(isSell){
            ...
            treasuryWalletFee = treasuryWalletFeeSell;
            ...
            treasuryWalletFee = treasuryWalletFeeBuy;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(treasuryWalletFee).div(totalBNBFee); 
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _rewardFeeBuy, uint256 _marketingFeeBuy, uint256 _treasuryWalletFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        rewardFeeBuy = _rewardFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        treasuryWalletFeeBuy = _treasuryWalletFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_rewardFeeBuy).add(_marketingFeeBuy).add(_treasuryWalletFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _rewardFeeSell, uint256 _marketingFeeSell, uint256 _treasuryWalletFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        rewardFeeSell = _rewardFeeSell;
        marketingFeeSell = _marketingFeeSell;
        treasuryWalletFeeSell = _treasuryWalletFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_rewardFeeSell).add(_marketingFeeSell).add(_treasuryWalletFeeSell);
        feeDenominator = _feeDenominator;
    }
