...
contract BusdyGay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUSDY GAY";
    string private _symbol = "$BGAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e3da85B13894EBc8b53BcDfe37304ADBD1A3426); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3e3da85B13894EBc8b53BcDfe37304ADBD1A3426); // Team Address
