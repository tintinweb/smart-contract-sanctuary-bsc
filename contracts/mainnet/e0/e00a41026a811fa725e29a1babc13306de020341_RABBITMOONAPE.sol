...
contract RABBITMOONAPE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("RABBITMOON APE", "RABBITMOONAPE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RABBITMOONAPE";
    string private _symbol = "RABBITMOONAPE";
