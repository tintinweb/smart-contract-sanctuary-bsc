...
contract  K0DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "ShibBoss";
    string private _symbol = "SBS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x264B18E86a96D4236f9AF8c1573F7A2fE04998E3);
    address payable public teamWalletAddress = payable(0xE8b2220101EA5Ba186b01bA1AEB309fe1929Ab33);
