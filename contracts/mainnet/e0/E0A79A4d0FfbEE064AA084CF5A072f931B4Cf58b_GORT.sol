...
contract GORT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**7 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x46a376F003B1F0E37b2e4f73103204797Fad3db8));

    string private _name = "Gort Token";
    string private _symbol = "GORT";
