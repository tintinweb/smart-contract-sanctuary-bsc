...
contract PresaleSettings is Ownable {
    ...
    function editEarlyAccessTokens(address _token, uint256 _holdAmount, uint256 _level1Amount, uint256 _level3Amount, uint256 _level2Amount, uint256 _level4Amount, bool _ownedBalance, bool _allow) external onlyOwner {
        if (_allow) {
