...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1Bc3342BF2c0e39f343aCA32dCB7942Cf168FFE; // owner address
...
contract PusukeInu is Context, IERC20, Ownable {
    ...
    string private _name = "Pusuke Inu";
    string private _symbol = "$PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF1Bc3342BF2c0e39f343aCA32dCB7942Cf168FFE); // 
    address payable public teamWalletAddress = payable(0xF1Bc3342BF2c0e39f343aCA32dCB7942Cf168FFE); // 
