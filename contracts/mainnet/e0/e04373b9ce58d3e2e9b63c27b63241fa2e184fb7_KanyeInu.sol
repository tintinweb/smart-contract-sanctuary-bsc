...
/* Token contract */
contract KanyeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Mc Kanye West";
    string constant _symbol = "MCKAYNE";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 1 / 100;  // 1% max or 1M
    uint256 public _maxWalletToken = _totalSupply * 5 / 100; // 3% or 3M tokens
