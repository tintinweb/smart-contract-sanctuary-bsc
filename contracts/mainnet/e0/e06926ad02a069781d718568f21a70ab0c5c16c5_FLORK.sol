...
contract FLORK is ERC20, Ownable {
    ...
    constructor() ERC20("Florkinomics", "FLORK") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                if (sellStakingFee > 0) {
                    uint toStake = (fees * sellStakingFee) / sellTotalFees;
                    super._transfer(from, address(this), toStake);
                    fees -= toStake;
                }
            }
            // on buy
                ...
                if (buyStakingFee > 0) {
                    uint toStake = (fees * buyStakingFee) / buyTotalFees;
                    super._transfer(from, address(this), toStake);
                    fees -= toStake;
                }
            }
