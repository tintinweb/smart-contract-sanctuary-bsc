...
contract EngLand is ERC20 {
    ...
    uint256 fundRate = 3; uint256 ldxRate = 2;
    ...
    function _transfer(
        ...
        if (takeFee) {
			super._transfer(from, address(this), amount.div(100).mul(fundRate + ldxRate));
            ldxAmount = ldxAmount.add(amount.div(100).mul(ldxRate));
			
			amount = amount.div(100).mul(100 - fundRate - ldxRate);
        }
        super._transfer(from, to, amount);
    }
