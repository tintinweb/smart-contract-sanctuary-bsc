...
contract SquidValentine is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Valentine";
    string private constant _symbol = "$SQUIDVAL";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1000000 * 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply * 10**_decimals;
    uint256 public _maxWalletAmount = _totalSupply * 10**_decimals;
