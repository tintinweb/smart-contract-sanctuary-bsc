...
contract Metatiktok is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Meta tiktok";
    string private _symbol = "Meta tiktok";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x7D32543341d1C35d8C4fc67187Be3FeeB481df25);
