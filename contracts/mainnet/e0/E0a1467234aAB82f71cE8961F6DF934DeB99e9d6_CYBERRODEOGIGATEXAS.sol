...
contract CYBERRODEOGIGATEXAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CYBER RODEO INU";
    string private _symbol = "$CyberRodeo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41bF4Fa4FdEd013458Cc1a823997A1B403C6B956);
    address payable public teamWalletAddress = payable(0x41bF4Fa4FdEd013458Cc1a823997A1B403C6B956);
