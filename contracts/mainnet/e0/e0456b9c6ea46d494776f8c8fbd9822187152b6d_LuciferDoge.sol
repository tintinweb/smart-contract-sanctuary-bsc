...
//  LuciferDoge is the gem for MemeCoin Investors looking for hype around new moonshot low cap gem !
//  Contract will be renounced !! Join for 100xx
//  Telegram: https://t.me/LuciferDoge
//  Website: https://www.LuciferDoge.com/
//    
/**
...
contract LuciferDoge is ERC20, Ownable, Shared {
    ...
    uint256 public blacklistTimeout = 3000 minutes;
    ...
    address public marketingWalletAddress = 0xb00B37a7484EdCB23f881b3b896699f3290E2B68;
    address public devWalletAddress = 0xb00B37a7484EdCB23f881b3b896699f3290E2B68;
    ...
    constructor() ERC20("LuciferDoge", "LUCI") {
        ...
        */
        _mint(owner(), 666_666_666_666 * 10**18);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LUCI: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "LUCI: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "LUCI: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":LUCI Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LUCI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LUCI: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "LUCI: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "LUCI: Blacklisted address");
