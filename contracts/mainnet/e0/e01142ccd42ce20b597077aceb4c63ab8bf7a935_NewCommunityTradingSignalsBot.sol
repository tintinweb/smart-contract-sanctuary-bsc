...
//** https://t.me/+C9e2ElFRK1piZGQx
//** Paladio rug us, now Time to create a New Community 
...
interface IDEXRouter {
 ...
 contract NewCommunityTradingSignalsBot is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "NewCommunityTradingSignalsBot";
    string constant _symbol = "ncTSB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 70) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 70) / 100; 
    ...
    address public devFeeReceiver = 0x036f8eaBdC24038511708fAA969888Ae72050239;
    address public buybackFeeReceiver = 0x036f8eaBdC24038511708fAA969888Ae72050239;
