...
The Shibmosis team is excited to announce the inception of our decentralized exchange built on 
the binance smart blockchain. The Shibmosis platform will allow users to swap, earn and build 
directly on this exiciting new blockchain of Shibarium. We are committed to creating the leading 
decentralized exchange on the shibarium network and believe this new technology will lead 
the development within the shibarium ecosystem. 

Shibmosis ($SHIBMOSIS) will be stealth launched on Wednesday the 8th of March 2023, the launch 
time will be at random, and there was no IDO or private sale for $SHIBMOSIS, therefore, all tokens 
will be readily available to buy on market. The $SHIBMOSIS token has a 1% tax to the liquidity pool. 

That is all for now, expect us to be live soon.

Telegram: https://t.me/SHIBAMOSIS
*/
...
contract SHIBMOSIS is Context, ibep20, Ownable {
    ...
    string private _name = 'SHIBMOSIS';
    string private _symbol = 'SHIBMOSIS';
