...
contract tudundun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MNU2.0";
    string private _symbol = "MNU2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6119d4e9e1C0d46d79bE1061F73B5C47f511D051); 
    address payable public BurnedWalletAddress = payable(0x6119d4e9e1C0d46d79bE1061F73B5C47f511D051); 
    address public immutable deadAddress = 0xd2F4dd53c29f492e6171470e8BD341EC90dAC9c1;
