...
contract ORW is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0xCF9A10b829d95ffa312A70544920c93Cd31E76E9); // Team Wallet
    address public _projectWalletAddress = address(0xCF9A10b829d95ffa312A70544920c93Cd31E76E9); //Project Wallet
    ...
    constructor() ERC20("Orwellium", "ORW") {
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "ORW: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ORW: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ORW: Automated market maker pair is already set to that value");
