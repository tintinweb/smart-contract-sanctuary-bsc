...
contract busdgrow is IBEP20, Auth {
    ...
    address DEV = 0x9e34B8d08038eCaAcbE3fb6FDCc800dC924c1105;
    ...
    // Name and symbol
    string constant _name = "busd grow";
    string constant _symbol = "bgusd";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 20mill
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x481e17aa1557E98DD76D8bB8260e29E70Ff9E5AB;
