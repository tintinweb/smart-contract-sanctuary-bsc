...
TELEGRAM: https://t.me/WindowsXp2
*/
...
contract WindowsXp_inu is Context, IERC20, Ownable {
    ...
    string private constant _name = "windows Xp Inu"; // 
    string private constant _symbol = "WXI"; //    
