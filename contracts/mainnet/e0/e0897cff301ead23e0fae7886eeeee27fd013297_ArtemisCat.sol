...
TG https://t.me/ArtemisCat
Website https://artemiscatcoin.com/
*/
...
library Address{
 ...
 contract ArtemisCat is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 100_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xF6265Bf11084515B4AF469A255fF20aBA197C46a;
    address public donationWallet = 0xF6265Bf11084515B4AF469A255fF20aBA197C46a;

    string private constant _name = "Artemis Cat";
    string private constant _symbol = "ARTCAT";
    ...
    Taxes public taxes = Taxes(1, 6, 3, 3);
    Taxes public sellTaxes = Taxes(1, 6, 3, 3);
