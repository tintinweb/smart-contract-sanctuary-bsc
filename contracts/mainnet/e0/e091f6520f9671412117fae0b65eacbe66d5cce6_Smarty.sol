/*
    Smarty
    Wise-up Your Invesment

    Telegram: @smartyinvestments
    Website: https://smartyinvestments.com/
*/
...
contract Smarty is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0xd94a73d38E710F1ad0baEB856D2Bc2323C41c020); // Marketing Address
    
  address payable public maintenanceAddress =
    payable(0x58977dD729dfcDFB570B3152CA099D662d79217B); // Project Maintenance
    
  address payable public treasuryAddress =
    payable(0x51102B26cE51eF7C62Bf4A5f03359Edc02B54cE7); // Treasury
  ...
  string private _name = 'Smarty';
  string private _symbol = 'Smarty';
