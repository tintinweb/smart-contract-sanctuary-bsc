...
🔶
🔶
We are an independent forum supporting the implementation of a well-designed digital Pound.
🔶
🔶
https://digitalpoundfoundation.com/
https://digitalpoundfoundation.com/about
...
interface DigitalPoundTokenDeployer {
...
contract DigitalPoundTokenUK is DigitalPoundTokenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private DigitalPoundTokenTeam;
    address private CharityDigitalPoundToken;
    ...
    string public override name = unicode"Digital £";
    string public override symbol = unicode"Digital £";
    ...
    constructor(uint totalSupplyValue, address DigitalPoundTokenTeamAddress, address CharityDigitalPoundTokenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        DigitalPoundTokenTeam = DigitalPoundTokenTeamAddress;
        CharityDigitalPoundToken = CharityDigitalPoundTokenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[DigitalPoundTokenTeam] =  totalSupply * 4 / 100;
        balances[CharityDigitalPoundToken] = totalSupply * 4 / 100;
