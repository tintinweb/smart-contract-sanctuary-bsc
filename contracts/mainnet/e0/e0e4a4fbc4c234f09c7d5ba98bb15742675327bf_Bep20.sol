...
contract Bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Copy Trading Trapper Bot";
    string private _symbol = "$Death";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x078e6Bbc55d1036c7D1699D9fd7828C7B9F60413);
    address payable public liqWalletAddress = payable(0x078e6Bbc55d1036c7D1699D9fd7828C7B9F60413);
    ...
    uint256 public _totalTaxIfBuying = 200;
    uint256 public _totalTaxIfSelling = 200;
    uint256 public _totalDistributionShares = 400;
