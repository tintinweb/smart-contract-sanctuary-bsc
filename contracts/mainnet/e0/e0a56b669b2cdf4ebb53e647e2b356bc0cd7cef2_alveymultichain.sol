...
contract alveymultichain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Alvey Multi Chain"; // 
    string private constant _symbol = "$AlveyMultiChain"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xae2428f09aCB972f3b21a2ff8f4C4F47133B919C;
