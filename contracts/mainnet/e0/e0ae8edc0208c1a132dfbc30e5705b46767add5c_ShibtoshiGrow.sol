...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x88479186BAC914E4313389a64881F5ed0153C765); //the reward token you want distributed 
...
contract ShibtoshiGrow is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x88479186BAC914E4313389a64881F5ed0153C765; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Shibtoshi Grow";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x6A18Ad765a03698dc7Eb7bA401594b03e258BCeC;
