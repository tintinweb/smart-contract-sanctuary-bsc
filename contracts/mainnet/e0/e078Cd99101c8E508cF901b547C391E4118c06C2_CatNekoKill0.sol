...
contract CatNekoKill0 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5A238220691E2a414aABF09485fd0Beb6689b219); 
    ...
    uint256 private _tTotal = 8880000000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CatNekoKillO";
    string private _symbol = "CNKILLO";
    ...
    uint256 public _maxTxAmount = 888000000000000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 888000000000000000000 * 10**9; 
    uint256 private buyBackUpperLimit = 888000000000000000000000 * 10**18;
