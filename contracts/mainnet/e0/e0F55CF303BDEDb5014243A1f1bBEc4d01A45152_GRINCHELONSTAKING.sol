...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0xC52d731EaD9fbE213037d6D0E9126B44Dc995cb7);
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1;
        minimumTokenBalanceForDividends = 1 * (1**9); //must hold 10,000+ tokens
    }
...
contract GRINCHELONSTAKING is Ownable, ReentrancyGuard {
   ...
   struct UserInfo {
    ...
    function updateRewardsPerSecond(uint256 newRewardsPerSecond) external onlyOwner {
        ...
        updatePool(0);
        rewardsPerSecond = newRewardsPerSecond * 1e9;
    }
