...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92B6F66Be1F3F36B4Db1986f4acfb263513b089E; // owner address
...
contract MMxPP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MMxPP";
    string private _symbol = "MMxPP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92B6F66Be1F3F36B4Db1986f4acfb263513b089E); // Marketing Address
    address payable public teamWalletAddress = payable(0x92B6F66Be1F3F36B4Db1986f4acfb263513b089E); // Team Address
