...
//Telegram : https://t.me/PomeranianBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7ab60Cdaa7C6dCcb7D0Cb2a775D7859881b1430C; // owner address
...
contract PomeranianBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pomeranian BSC";
    string private _symbol = "$POM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7ab60Cdaa7C6dCcb7D0Cb2a775D7859881b1430C); // Marketing Address
    address payable public teamWalletAddress = payable(0x701383bA12Cb6aEa3cB522f4d0166FC410B17324); // Team Address
