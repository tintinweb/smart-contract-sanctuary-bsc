...
contract cAFA is Divine {
    ...
    constructor() Divine('Contributor AFA', 'cAFA', 9) {
    ...
    function _beforeTokenTransfer(
        ...
        require((_balances[to_] > 0 || isApprovedSeller[from_] == true), 'Account not approved to transfer cAFA.');
    }
