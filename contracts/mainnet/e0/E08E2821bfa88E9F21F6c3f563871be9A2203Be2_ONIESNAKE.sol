...
//telegram: https://t.me/Onisnakeportal
interface IERC20 {
...
contract ONIESNAKE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100e7 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 5_000_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 30_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 30_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 30_000_000 * 10**_decimals;

    address public marketingAddress = 0x886d76BA8188f1C2149E3b1c380b543061847475;
    address public devAddress = 0x886d76BA8188f1C2149E3b1c380b543061847475;

    string private constant _name = "ONIESNAKE";
    ...
    Taxes public sellTaxes = Taxes(0,6,6,0);
