...
contract ShibaDegen is Context, IERC20 { 
    ...
    string private constant _name = "Shiba Degen"; 
    string private constant _symbol = unicode"SHIGEN"; 
    ...
    uint256 public Percent_of_LP = 10;
    uint256 public Percent_Marketing = 80;    
    uint256 public Percent_of_burn = 5;             
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Percent_of_burn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Percent_of_LP / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_of_LP + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Percent_of_LP + Percent_Marketing + Percent_Dev);
