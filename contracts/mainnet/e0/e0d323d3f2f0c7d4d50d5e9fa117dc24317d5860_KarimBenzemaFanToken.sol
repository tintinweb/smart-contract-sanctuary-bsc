...
/**
 *https://t.me/KarimBenzemaFanToken
*/

// KB9 GOLDEN BALL WINNER
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7fDe44D6D8fbB3407d9EF4f5B23550Abf0d62Dfa); //BOBA
...
contract KarimBenzemaFanToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KarimBenzemaFanToken";
    string constant _symbol = "KB9";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7fDe44D6D8fbB3407d9EF4f5B23550Abf0d62Dfa;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xd2C7Ee81Ec174A3eeb927C14B93F9D0772297836;
