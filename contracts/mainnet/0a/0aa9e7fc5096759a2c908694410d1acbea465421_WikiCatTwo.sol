...
/**
Telegram https://t.me/wikicattwo
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9454DbaEC54561a016e90D093aE79476FE7BA3Df; // owner address
...
contract WikiCatTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Cat 2.0";
    string private _symbol = "WKC2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE36828F683d581c9F0fb9Dd66dd445eA33b1C2f5); // Marketing Address
    address payable public teamWalletAddress = payable(0x9454DbaEC54561a016e90D093aE79476FE7BA3Df); // Team Address
