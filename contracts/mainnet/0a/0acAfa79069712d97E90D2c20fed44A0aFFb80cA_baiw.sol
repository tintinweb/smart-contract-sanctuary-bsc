...
contract baiw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "815";
    string private _symbol = "815";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3cD92Dcc94aDae9A60e704f2074043C0B5887C5d);
    address payable public teamWalletAddress = payable(0x2D56f790d4A842595dCd9F65c724fc7214F5264c);
