...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8e5412221C47188c091B1AC3B89a98A96F05336C;
...
contract WillSmithBitchSlapCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBE4c237c442e68BB9eB4eAB3bA505dc660dc1331;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WillSmithBitchSlapCoin";
    string private _symbol = "WSBSC";
