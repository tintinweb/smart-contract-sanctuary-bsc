...
contract BatchSendErc20 is Ownable {
    ...
    function multiSendFixedTokenFromContract(
        IERC20 token,
        address[] memory recipients,
        uint256 amount
    ) public onlyOperator {
    ...
    function multiSendDiffTokenFromContract(
        IERC20 token,
        address[] memory recipients,
        uint256[] memory amounts
    ) public onlyOperator {
