...
contract TheChinaman is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TheChinaman';
    ...
    //
    address public TeamWallet=payable(0x958D78B0Aa1B84fE8d938E1dbE6a7C896bDf3f91);
    address public walletTwo=payable(0xc5C1a506DC48D0e3763b845bB2aEE075914683Dc);
    //
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 1500000000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*60) / 100);
        payable(walletTwo).transfer((amount*40) / 100);
    } 
