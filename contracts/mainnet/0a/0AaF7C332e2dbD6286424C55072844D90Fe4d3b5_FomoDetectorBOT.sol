...
contract FomoDetectorBOT is ERC20, Ownable {
    ...
    FomoDetectorBOTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("FomoDetector BOT", "FOMO") {
        marketingWallet = payable(0x17a34BD7E55cE8cCE9c7B141BB0ed2be0c7E52d8);
        devWallet = payable(0x17a34BD7E55cE8cCE9c7B141BB0ed2be0c7E52d8);
        ...
        dividendTracker = new FomoDetectorBOTDividendTracker(
            payable(this),
            router,
            0xbA2aE424d960c26247Dd6c32edC70B295c744C43,
            "FomoDetectorBOTTRACKER",
            "FomoDetectorBOTTRACKER"
        );
...
contract FomoDetectorBOTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    FomoDetectorBOT public FomoDetectorBOTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        FomoDetectorBOTContract = FomoDetectorBOT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "FomoDetectorBOT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "FomoDetectorBOT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FomoDetectorBOT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(FomoDetectorBOTContract);

            uint256 prevBalance = FomoDetectorBOTContract.balanceOf(address(this));
            ...
            {
                uint256 received = FomoDetectorBOTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    FomoDetectorBOTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
