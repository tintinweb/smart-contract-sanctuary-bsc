...
contract KISHUTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KISHU 2.0";
    string private _symbol = "KISHU 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x473A2Ab95D06b38AfFfDB19426055aDB0a58e331); // Marketing Address
    address payable public teamWalletAddress = payable(0x473A2Ab95D06b38AfFfDB19426055aDB0a58e331); // Team Address
    ...
    uint256 public _maxTxAmount = 2 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 3 * 10**6 * 10**6* 10**_decimals;
