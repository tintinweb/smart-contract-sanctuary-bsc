...
Telegram : https://t.me/HallowRise
...
contract HallowRise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hallow Rise";
    string private _symbol = "HR"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6f7B1dC92b8F26c8f0c929d1D0a123D7941A3FE1); // Marketing Address
    address payable public teamWalletAddress = payable(0x6f7B1dC92b8F26c8f0c929d1D0a123D7941A3FE1); // Team Address
