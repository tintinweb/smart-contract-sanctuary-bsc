...
contract PSTAR2 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 425200000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public constant name     = "P-S-T-A-R-2";
    string public constant symbol   = "PSTAR2";
