...
contract RonaldoReward is ERC20, Ownable {
    ...
    RonaldoRewardDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3c7E21C28Eec068841C44D79bbd9a1ABD7EC4A5f;
    ...
    constructor() ERC20("Ronaldo Reward", "RONALDOREWARD") {
        dividendTracker = new RonaldoRewardDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        RonaldoRewardDividendTracker newDividendTracker = RonaldoRewardDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "RonaldoReward: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "RonaldoReward: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "RonaldoReward: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "RonaldoReward: Cannot update gasForProcessing to same value"
        );
...
contract RonaldoRewardDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("RonaldoReward_Dividen_Tracker", "RonaldoReward_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "RonaldoReward_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "RonaldoReward_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "RonaldoReward_Dividend_Tracker: Cannot update claimWait to same value"
        );
