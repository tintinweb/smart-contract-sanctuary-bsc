...
contract DividendToken is ERC20, Ownable {
    ...
    constructor(
        ...
        address[6] memory addrs, // reward, router, marketing wallet, lp wallet, dividendTracker, base Token
        ...
        require(sellLiquidityFee+sellMarketingFee+sellRewardFee <= 300);
        require(buyLiquidityFee+buyMarketingFee+buyRewardFee <= 300);
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner {
        address tmp=_marketingWalletAddress;
        _marketingWalletAddress = wallet;
        emit MarketingWalletUpdated(_marketingWalletAddress, tmp);
    }
