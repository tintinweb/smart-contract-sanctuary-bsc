...
/**
🥛Welcome to Milk exchange 🥛

Milk Exchange Become Strong by Drinking The MILK !
Swap, farm, and collect Milk Nft all on one decentralized, community driven platform.
Welcome to the Milk Universe!
...
contract milkexchange is Context, IERC20, Ownable {
    ...
    string private constant _name = "Milk Exchange"; // 
    string private constant _symbol = "MILK X"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x648075D2501da967fBc5271B36f2c89C17E06e56;
