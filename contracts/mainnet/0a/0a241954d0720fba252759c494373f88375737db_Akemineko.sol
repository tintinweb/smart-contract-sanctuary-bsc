...
contract Akemineko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Akemineko";
    string private _symbol = "Akemineko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x105013fc67758188478007A0fc0b3F09bE468402);
    address payable public BuyBackWalletAddress = payable(0x105013fc67758188478007A0fc0b3F09bE468402);
