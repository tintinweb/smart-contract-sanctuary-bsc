...
contract Dogelon is Context, IERC20, Ownable {
    ...
    string private _symbol = "DogelonCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x093F815EA31135AF97B1c9ADDb2Ed5C3F2A3f72d);
    address payable public teamWalletAddress = payable(0x093F815EA31135AF97B1c9ADDb2Ed5C3F2A3f72d);
