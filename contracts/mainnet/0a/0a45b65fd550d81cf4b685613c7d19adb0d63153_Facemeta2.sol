...
contract Facemeta2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Face Meta 2.0";
    ...
    address payable public marketingWalletAddress = payable(0x1faBD414F898d4F5041d64C59088De1C2c14774e);
    address payable public teamWalletAddress = payable(0xF69932b53F69e181ede37B98b5F5fDc16fc6E2b0);
