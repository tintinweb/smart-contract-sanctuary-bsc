...
contract BabyQuantic is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Baby Quantic";
    string constant _symbol = "BabyQuantic";
    ...
    uint256 buyBuyBackFee = 5;
    uint256 buyTotalFee = buyMarketingFee+buyBuyBackFee;
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x2BF322496ec8Dbfd32DB2e4E0c635396214FAEcb;
    address private buybackFeeReceiver = 0x2BF322496ec8Dbfd32DB2e4E0c635396214FAEcb;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buyMarketingFee, uint256 _buyBuybackFee, uint56 _sellMarketingFee, uint256 _sellBuybackFee) external onlyOwner {
        ...
        sellTotalFee = _sellMarketingFee + _sellBuybackFee + _liquidityFee;
        buyMarketingFee = _buyMarketingFee;
        buyBuyBackFee = _buyBuybackFee;
        buyTotalFee = _buyMarketingFee + _buyBuybackFee;
    }
