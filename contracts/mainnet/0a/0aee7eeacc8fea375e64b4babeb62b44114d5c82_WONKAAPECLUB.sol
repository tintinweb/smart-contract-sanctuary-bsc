...
contract WONKAAPECLUB is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Wonka Ape Club';
    string private constant _symbol = '$WAC';
    ...
    //DevWallets
    address public Development=payable(0xA9161fB27fe46524Ad10f0E569733Ca6299C336F);
    address public Marketing=payable(0xe302268b65E68326130b8010a02Ce1011b7dC982);
    //MainNet
    ...
    //Sets Taxes, is limited by MaxTax(12%) to make it impossible to create honeypot
    function TeamSetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
        ...
        require(totalTax==12, "burn+liq+marketing needs to equal 100%");
