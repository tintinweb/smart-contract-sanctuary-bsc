...
/**
    ...
    Telegram: https://t.me/pigiinubsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x892E3E6415B2DA79A43aFb87C2701506974E1F9f; // owner address
...
contract PigiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Pigi Inu ";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x892E3E6415B2DA79A43aFb87C2701506974E1F9f); // Marketing Address
    address payable public teamWalletAddress = payable(0x892E3E6415B2DA79A43aFb87C2701506974E1F9f); // Team Address
