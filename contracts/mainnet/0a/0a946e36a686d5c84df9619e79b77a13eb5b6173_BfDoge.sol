...
contract BfDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BfDoge";
    string private _symbol = "BfDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBe9ab4EcbC4cFD7DBB84B57587058f21a02E4916);
    address payable public teamWalletAddress = payable(0xdF386B2Fdf2b961102B5C98f334c35f68b958Cb3);
