...
contract PigeLonMars is Context, IERC20, Ownable {
    ...
    string private constant _name = "PigeLon Mars"; //
    string private constant _symbol = "Pigelon"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x27031558348824629dcAF2C93890a9277CC346AB;
