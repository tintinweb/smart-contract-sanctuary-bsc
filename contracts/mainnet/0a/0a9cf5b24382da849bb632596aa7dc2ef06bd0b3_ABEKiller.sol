...
contract ABEKiller is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x50CF6dBB9AbE3E8492e4e6fFD6147b0aA4B8394f));
        marketingWalletAddress = payable(address(0x50CF6dBB9AbE3E8492e4e6fFD6147b0aA4B8394f));
