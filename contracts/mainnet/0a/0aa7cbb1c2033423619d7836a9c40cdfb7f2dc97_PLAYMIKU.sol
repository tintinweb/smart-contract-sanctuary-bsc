...
contract PLAYMIKU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PLAY MIKU";
    string private _symbol = "PLAY MIKU";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xd3f97D3A69c1208CF5cB17154bd72835A167dd8b); // MARKETING Address
    address payable public teamWalletAddress = payable(0xd3f97D3A69c1208CF5cB17154bd72835A167dd8b); 
