...
contract PrayForETC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pray For ETC"; // 
    string private constant _symbol = "PFE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xdB07bA4fe03668F8B492337dadDB2b9AeFD9A1d4;
