...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x017451a232a6A721f2D1477eA95C9467683103b6; // owner address
...
contract WIKISQUID is Context, IERC20, Ownable {
    ...
    string private _symbol = "WSQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x017451a232a6A721f2D1477eA95C9467683103b6); // 
    address payable public teamWalletAddress = payable(0x017451a232a6A721f2D1477eA95C9467683103b6); // 
