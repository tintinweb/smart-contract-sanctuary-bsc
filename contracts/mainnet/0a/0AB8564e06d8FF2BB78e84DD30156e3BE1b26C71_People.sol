...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        marketingAddress[0] = address(0x209d7Ed487d616c2d3F5C9741098641259301e1F);
...
contract People is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("People", "People") {
        ...
        address _initHolder = 0x845f41133379245314f7a29F4a0c0bF186E187c3;
        uint256 total = 5067200000;
