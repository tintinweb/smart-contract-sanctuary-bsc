 ...
 *
 */
contract LOLToken is Governed, ERC20, ERC20Burnable {
    using SafeMath for uint256;
     ...
     */
    constructor(uint256 _initialSupply) ERC20("LOL Token", "LOL") {
    ...
    function permit(
        ...
        require(_owner == recoveredAddress, "LOL: invalid permit");
        require(_deadline == 0 || block.timestamp <= _deadline, "LOL: expired permit");
