...
Community Token - token launched on BSC Smart Chain which main goal is to bring community together and we can all accomplish wealth. 
Initial LP is burned (1 BNB) to avoid any way for us to manipulate with your funds.
There is anti-whale policy and this not typical pump and dump token 
- there is not even one person who can manipulate the chart and destroy what community builded. 
This is not your typical everyday BSC coin - we wanna be there for community and we wanna get more and more of you.
This is not a sprint, we all gotta be patient, work as hard as we can, shill wherever we can to achieve our goals. 
There are also reflections so every loyal holder will be rewarded. 
...
TG: https://t.me/CommunityOfficial
...
contract Community is Context, IERC20, Ownable {
    ...
    payable(0xC075B0AC532A7d46802c1E54ac735D40f230640b);

    address payable public teamAddress =
    payable(0xC075B0AC532A7d46802c1E54ac735D40f230640b);

    address payable public liquidityAddress =
    payable(0x81E8D29D6092E607781a6462a1Ce49bff183ba59);
    ...
    uint256 private constant _tTotal = 100 * 1000 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "Community Token";
    string private constant _symbol = "CMT";
...
maxWalletAmount = _tTotal * 2 / 1000; // 0.2% maxWalletToken
...
earlyBuyPenaltyEnd = block.timestamp + 175 hours;
}
...
maxWalletAmount = _tTotal * maxwalletpercent / 1000;
}

function setMaxTx(uint256 maxtx) external onlyOwner {
maxTransactionAmount = _tTotal * maxtx / 1000;
}
