...
contract gen2 {
	...
	constructor(address payable wallet, address payable _developer , address payable _ref) public {
		...
		plans.push(Plan(14, 86, 180)); // 8,6% per day for 14 days (Withdrawl 6 Hours)
        plans.push(Plan(21, 76, 333)); // 7.6% per day for 21 days Withdrawl 12 Hours)
        plans.push(Plan(28, 75, 444)); // 7,5% per day for 28 days (Withdrawl 24 Hours)
        plans.push(Plan(28, 96, 555)); // 7% per day for 28 days (Withdrawl 96 Hours)
