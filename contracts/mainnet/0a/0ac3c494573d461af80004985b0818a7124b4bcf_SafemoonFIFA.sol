...
contract SafemoonFIFA is IBEP20, Auth {
    ...
    string constant _name = "Safemoon FIFA";
    string constant _symbol = "Safemoon FIFA";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 40000;
    bool inSwap;
