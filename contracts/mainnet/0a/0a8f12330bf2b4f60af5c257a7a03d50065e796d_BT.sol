...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb1FBa409BcDafc1A01DEEBDe3c3ed9C6b84F486c; // owner address
...
contract BT is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"PM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb1FBa409BcDafc1A01DEEBDe3c3ed9C6b84F486c); // 
    address payable public teamWalletAddress = payable(0xb1FBa409BcDafc1A01DEEBDe3c3ed9C6b84F486c); // 
