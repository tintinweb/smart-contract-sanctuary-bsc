...
contract APECOINNETWORK is IBEP20, Auth {
    ...
    string constant _name = "APECOIN NETWORK";
    string constant _symbol = "APECOINNETWORK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 200; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; //2%
    ...
    address private marketingFeeReceiver = 0xaBA633068623Ff1D1aB5477cA168baf6c82A0550;
    address private developmentFeeReceiver = 0x0ad73e8FE40294a168d33023a5cC0e6390a04445;
