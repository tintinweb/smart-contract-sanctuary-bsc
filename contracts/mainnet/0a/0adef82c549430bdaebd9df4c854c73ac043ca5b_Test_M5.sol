...
uint256 qwe = (rfgref2/rfgref)+1;
        ...
        plans.push(Plan(0.03 ether, 300, 333, true));
        plans.push(Plan(0.04 ether, 300, 333, true));
        plans.push(Plan(0.05 ether, 300, 333, true));
        plans.push(Plan(0.06 ether, 300, 333, false));
        plans.push(Plan(0.07 ether, 300, 333, false));
        plans.push(Plan(0.08 ether, 300, 333, false));
...
if (users[upline1].activeMainLevels[plan] =  users[referrer].activeMainLevels[plan]) {
				...
				if (upline1 != address(0)) {
					...
					users[upline1].bonus = users[upline1].bonus.add(amount);
					users[upline1].totalBonus = users[upline1].totalBonus.add(amount);
					emit RefBonus(upline1, msg.sender, 50, amount);
					upline1 = users[upline1].LevelReferrals1;
