...
/*    SpacePi Grow
            ...
            Telegram : https://t.me/SpacePiGrow
...
contract SPACEPIGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xf7EfCcf52e1bAd8d6594d500feE0dE438934e854);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**15 * 10**_decimals;
    string private constant _name = "SpacePiGrow"; 
    string private constant _symbol = unicode"SPIG"; 
