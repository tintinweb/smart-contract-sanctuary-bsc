...
contract CuteInu is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 100; // 1% 
    uint256 public maxTxAmountSell = _tTotal / 100; // 1% 
    ...
    string private constant _name = "Cute Inu";
    string private constant _symbol = "CUTEINU";
