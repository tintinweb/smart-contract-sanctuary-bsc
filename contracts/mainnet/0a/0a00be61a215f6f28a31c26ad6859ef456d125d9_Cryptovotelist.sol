...
contract Cryptovotelist is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptoVoteList";
    string private constant _symbol = "CVL";
