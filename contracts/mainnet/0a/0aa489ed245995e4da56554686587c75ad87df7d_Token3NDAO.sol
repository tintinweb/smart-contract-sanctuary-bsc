...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        lpRewardCondition = 2 * usdtDecimals;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transfer(fundAddress, newUsdt * fundFee / totalFee);
    }
...
contract Token3NDAO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        5000,
        address(0x43E46ef33D3E5a4004FA52DB101E40ce5fe38c9a),
        address(0x173157eCdcDeEee30b856d4dda60eDdd7FE73D0D)
    ){
