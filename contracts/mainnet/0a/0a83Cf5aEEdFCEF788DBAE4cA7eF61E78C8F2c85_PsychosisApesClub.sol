...
/*
   ___                                 _            __         
  / o |___ __  __ /7  _   __  ()__   .' \ _   __  ,'_/ /7    /7
 / _,'(c'\V /,','/ \,'o| (c' /7(c'  / o //o|,'o/ / /_ ///7/7/o\
/_/  /__) )/ \_\/n_/|_,'/__)///__) /_n_//_,'|_(  |__////__//_,'
         //                            //         
*/
...
contract PsychosisApesClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  */
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 marketShare = _amount.div(mintSplit);
      uint256 OwnerShare = _amount.sub(marketShare);
