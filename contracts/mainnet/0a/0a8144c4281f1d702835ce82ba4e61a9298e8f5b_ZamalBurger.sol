...
contract ZamalBurger is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    address public royaltyAddress = 0x53DF3eD43D4A9874E79520cf3454b918c104FeB6;
    uint public royalty = 800;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("ZamalBurger", "ZB") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
      ...
      require(supply + amount - 1 < maxSupply, "Error: TotalSupply reached");
        require(amount > 0 && amount <= maxPerTx, "Error: max 10per tx limit");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: Max 10 per address limit");
