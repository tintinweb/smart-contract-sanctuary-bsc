...
⚡ https://t.me/SinfiniteV2 ⚡

@theSinfinite
Sinfinite is a decentralized, community-centric, multi-chain yield farming protocol 
💎 We creating DeFi opportunities | 
Links: http://linktr.ee/sinfinite
Web3 
sinfinite.net
*/
...
contract Sinfinite is SinfiniteDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SinfiniteTeam;
    address private CharitySinfinite;
    ...
    string public override name = "Sinfinite";
    string public override symbol = "Sinfinite";
    ...
    constructor(uint totalSupplyValue, address SinfiniteTeamAddress, address CharitySinfiniteAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SinfiniteTeam = SinfiniteTeamAddress;
        CharitySinfinite = CharitySinfiniteAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SinfiniteTeam] =  totalSupply * 4 / 100;
        balances[CharitySinfinite] = totalSupply * 4 / 100;
