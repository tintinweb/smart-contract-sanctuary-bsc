...
//Telegram : https://t.me/medaltokenportal
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner =0xBe0cB95A462778d047e8eEC3B5aE007E3C305411;
...
/* Token contract */
contract MedalToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xBe0cB95A462778d047e8eEC3B5aE007E3C305411;
    ...
    // Name and symbol
    string constant _name = "Medal Token";
    string constant _symbol = "MDT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver=0x0333D795E8Daa7eaC1C9D8a3bBd026b01b9DF570;
