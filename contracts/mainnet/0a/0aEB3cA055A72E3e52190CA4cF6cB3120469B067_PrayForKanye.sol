...
/**
Telegram: https://t.me/PrayForKanye
*/
...
contract PrayForKanye is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PrayForKanyeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PrayForKanye", "RIPCOIN") {
        ...
        dividendTracker = new PrayForKanyeDividendTracker(
            payable(this),
            router,
            0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE,
            "PrayForKanyeTRACKER",
            "PrayForKanyeLASSICTRACKER"
        );
...
contract PrayForKanyeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PrayForKanye public PrayForKanyeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PrayForKanyeContract = PrayForKanye(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PrayForKanye_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PrayForKanye_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PrayForKanye contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PrayForKanyeContract);

            uint256 prevBalance = PrayForKanyeContract.balanceOf(address(this));
            ...
            {
                uint256 received = PrayForKanyeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PrayForKanyeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
