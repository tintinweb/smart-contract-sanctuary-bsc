...
/**
is the Cutest  family in cryptospace. 
is a Meme token project, just like the Inu token family, Our goal is to provide ease and freedom in transactions, holders will get good reflection, NFT project issuance and charitable donations to beach turtle volunteers.
based on Solid team and have experienced team, safe development team.
We are community driven token based on the strenght of Community and strong holder.
Become World's Best Community Driven Meme Coin.
*/

// TELEGRAM: https://t.me/Turtlemoonofficialbsc
...
contract TURTLEMOON is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xe3689ab7382362F7d8f3a46e15acbFA266a40996;

    string private constant _name = "TURTLEMOON";
    string private constant _symbol = "TURTLEMOON";
    ...
    Taxes public taxes = Taxes(3,7,2,0);
