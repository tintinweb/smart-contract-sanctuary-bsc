...
contract BabyShinaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD4dA904C32e3E3a2eDA8184613c6265a47924403); 
    address payable public Wallet_Dev = payable(0xD4dA904C32e3E3a2eDA8184613c6265a47924403);
    ...
    string private constant _symbol = unicode"Baby Shina"; 
    ...
    constructor () {
        ...
        _owner = 0xD4dA904C32e3E3a2eDA8184613c6265a47924403;
