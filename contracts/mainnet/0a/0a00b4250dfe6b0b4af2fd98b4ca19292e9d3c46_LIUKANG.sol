...
contract LIUKANG is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "LIUKANG";
    string constant _symbol = "LIUKANG";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x66BAA1877191A99Ef4Ee0C62A1d3f77AB622Fb04;
        marketingWallet = 0x47a8B7aF4EEfec28326F55eB6e5A96fee31feafa;
        Ecosystemwallet = 0x47a8B7aF4EEfec28326F55eB6e5A96fee31feafa;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newEcosystemwallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(Ecosystemwallet).call{value: anothermarketingShare, gas: 30000}("");
