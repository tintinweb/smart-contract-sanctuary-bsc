...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0x55d398326f99059fF775485246999027B3197955); //the reward token you want distributed 
...
contract BUSDLPBUSDLP is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0x55d398326f99059fF775485246999027B3197955; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
 address lpTOKEN = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x5136d3da11D3FebC5eA4E992A4147Af538481f81;
 address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
 string constant _name = "FML BUSD TEST";
 string constant _symbol = "FMLTEST";
 ...
 function swapBack(uint256 internalThreshold) internal swapping {
   ...
   try distributor.deposit{value: amountBNBReflection}() {} catch {}
    ...
    if(amountToLiquify > 0){
        ...
        IBEP20(lpTOKEN).approve(address(routerv2), lpTokenBalance);
