...
contract LiberaAngelsNFT is Context, ERC165, IERC721, IERC721Metadata, Auth {

    using Address for address;

    // Token name
    string private constant _name = "Libera Angels NFT";

    // Token symbol
    string private constant _symbol = "LIBERA-ANGELS";
    ...
    // current supply
    uint256 public currentTempSupplyCap = 1333;
    ...
    function setReflectAddress(address _newAdr) external onlyOwner {
    ...
    */
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        try IAngelsReflect(reflectAddress).registerNewMint( tokenId ) {} catch {}
