...
// 3% of the tax will go to charity/donations for the Ukrainian army
...
contract WW3Inu is Context, IERC20 {
    ...
    string private _name = "WW3 Inu";
    string private _symbol = "WW3 Inu";
