...
Max Transaction: 2% (2,000,000 Tokens)
...
contract BATINU is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BAT INU';
    string private constant _symbol = '$BAT INU';
    ...
    //DevWallets
    address public Development=payable(0x3C4a2589543CB043d152Be0539b5d5755085c0Cb);
    address public Marketing=payable(0x3C4a2589543CB043d152Be0539b5d5755085c0Cb);
    //MainNet
    ...
    function TeamWithdrawALLMarketingETH() public onlyOwner{
        ...
        payable(Marketing).transfer((amount*100) / 100);
    } 
