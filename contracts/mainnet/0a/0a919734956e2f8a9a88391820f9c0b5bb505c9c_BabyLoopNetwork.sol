...
// *Telegram : https://t.me/babyloopnetworkbsc
// 

// SPDX-License-Identifier: MIT
/*
    BabyLoopNetwork Token
    10% tax for buy and sell - 2% LP 8% marketing wallet!  NO DEV FEES
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9158d0dEb78b26cF0697B54B53edE7E738D1395c; // owner address
...
contract BabyLoopNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyLoopNetwork";
    string private _symbol = "BLN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd6364bf9c18A945b94C38Bf4663cE0FA21F976A4); // Marketing Address
    address payable public teamWalletAddress = payable(0xd6364bf9c18A945b94C38Bf4663cE0FA21F976A4); // Team Address
