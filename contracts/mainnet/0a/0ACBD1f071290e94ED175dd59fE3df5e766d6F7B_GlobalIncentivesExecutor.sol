...
// File contracts/base/interface/IGlobalIncentivesHelper.sol
...
// File contracts/base/GlobalIncentivesExecutor.sol
...
contract GlobalIncentivesExecutor is Controllable {
  ...
  function execute() external onlyNotifier {
    ...
    for (uint256 i = 0; i < tokens.length; i++) {
      uint256 globalIncentivesHelperBalance = IBEP20(tokens[i]).balanceOf(globalIncentivesHelper);
