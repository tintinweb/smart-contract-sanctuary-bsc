...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 buyback, uint16 lottery, uint16 tokens) external onlyOwner {
        ...
        _ratios.totalSwap = liquidity + marketing + buyback + lottery;
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 stakingBalance = (amtBalance * ratios.lottery) / ratios.totalSwap;
...
constructor(MuscleX _rwd, MuscleX _tether) public {
    rwd = _rwd;
    tether = _tether;
    owner = msg.sender;
    Total_Deposited = 0;
