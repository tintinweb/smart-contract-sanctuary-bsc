...
contract FpxToken is ERC20, Ownable {
    ...
    // Wallets
    address public marketingWallet = 0x8F4E30bc6A1498DDc4FB4a3DcCc177F23b18047c;
    address public developmentWallet = 0x8F4E30bc6A1498DDc4FB4a3DcCc177F23b18047c;
    ...
    constructor() ERC20("Fpx Token", "FPX") {
        ...
        _mint(owner(), 2e7 * (10**18)); //1 000 000 000 total supply
