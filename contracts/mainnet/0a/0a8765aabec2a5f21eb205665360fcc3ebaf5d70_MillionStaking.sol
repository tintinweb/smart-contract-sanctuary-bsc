...
contract MillionStaking {
	...
	uint constant public			PROJECT_FEE_PORC				= 30;					// % of fee 3%
	...
	function invest(address _referrer, uint8 _planIdx) public payable {
		...
		//transfer project fee - Total 6%
		uint pfeeporce3 = msg.value * PROJECT_FEE_PORC / PERCENTS_DIVIDER;

		// Wallets Devs%
		WALLET_PROJECT_1.transfer(pfeeporce3);
		emit ProjectFeePaid(pfeeporce3);
		WALLET_PROJECT_2.transfer(pfeeporce3);
		emit ProjectFeePaid(pfeeporce3);
