...
contract worGdiuqS is Context, IERC20, Ownable {
    ...
    string private constant _name = "worGdiuqS";
    string private constant _symbol = "worGdiuqS";
