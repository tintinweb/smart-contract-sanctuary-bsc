...
WELCOME TO META INU !!
META INU ($MINU) IS A COMMUNITY DRIVEN TOKEN.. $MINU IS THE NEXT REAL HYPE, LOW TAX, MASSIVE MARKETING, STRONG COMMUNITY !!!

NAME : META INU
SYMBOL : $MINU
SUPPLY : 1.OOO.000.000
TAX FEE :
   - BUY = 2%
   - SELL = 5%
...
contract METAINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**9 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable private _marketingAddress =
        payable(address(0x152af46d3e26Cd0d462239eA34aE5F48e8589aa2));
