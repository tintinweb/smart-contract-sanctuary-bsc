...
| (\/) || (\/) || :/\: || (\/) || (\/) ((5)) | :(): || :/\: || :/\: || :/\: || (\/) |
| :\/: || :\/: || :\/: || :\/: || :\/: |'-.-.| ()() || (__) || :\/: || :\/: || :\/: |
| '--'M|| '--'A|| '--'S|| '--'Y|| '--'A| ((1)) '--'F|| '--'L|| '--'O|| '--'K|| '--'I|
`------'`------'`------'`------'`------'  '-'`------'`------'`------'`------'`------'
All information can be found at MasyaFloki.com
*/
...
/* Token contract */
contract MasyaFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5Eed00DC106b8bEE16CD21107DCE745acdc56AF7;
    ...
    // Name and symbol
    string constant _name = "Masya Floki";
    string constant _symbol = "MasFlk";
