...
contract ABET7 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ABET7";
    string private _symbol = "ABET7";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a75811c3457C5b65d8aEebc667A75F3C8D59B2E);
    address payable public teamWalletAddress = payable(0x4a75811c3457C5b65d8aEebc667A75F3C8D59B2E);
