...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x590b12F1139c6daff1C6d33b2Cf2F6840fB7FF31;
...
contract Bicash is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE9c870019C93a7532239cB0f2Be0F66FF3c44f03;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BiCash";
    string private _symbol = "BCASH";
