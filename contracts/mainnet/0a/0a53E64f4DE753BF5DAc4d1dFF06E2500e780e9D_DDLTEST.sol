...
contract DDLTEST is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 10000000 * 10e9;
    
    address public marketingWallet = 0x67B7cbEe2c6D3856ca5d7c5784EB48D8d66c5ecF;
    ...
    constructor() ERC20("Ducker Delayed", "DDL") {
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity) external onlyOwner{
        require(_marketing + _liquidity <= 15, "Tax cannot be set to exceed 15%");
