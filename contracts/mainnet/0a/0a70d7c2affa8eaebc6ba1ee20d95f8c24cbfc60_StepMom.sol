...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0EEF3577f452FB37abFBFB01bec552EE4C42902a; // owner address
...
contract StepMom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StepMom";
    string private _symbol = "STM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24a0A3c5e6839CDAEd9cDF5D60e0f5945d355E68); // Marketing Address
    address payable public teamWalletAddress = payable(0x24a0A3c5e6839CDAEd9cDF5D60e0f5945d355E68); // Team Address
