...
contract ChickGrow is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 250000 * 10**9; //
    string private constant _name = "Chick Grow"; // 
    string private constant _symbol = "CHICKG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xbD5261322880265749C31c65541a0f25ee7C6363;
