...
contract StocksBSC {
    ...
    uint256 public GameLaunch = 1658141990;
   ...
   /*================================
    ...
    function sell(uint256 _amountOfTokens) onlyHolders() public {
        ...
        uint256 _dividends = SafeMath.div(_bnb, 5);
    ...
    function buyPrice() public view returns(uint256) {
        ...
        function ChangeFee(uint256 _ChangeFee) public {
    ...
    function purchaseTokens(uint256 _incomingBNB, address _referredBy) internal returns(uint256) {
        ...
        owner.transfer(_incomingBNB * ownerfee);
        players += 1;
        // prevents overflow
