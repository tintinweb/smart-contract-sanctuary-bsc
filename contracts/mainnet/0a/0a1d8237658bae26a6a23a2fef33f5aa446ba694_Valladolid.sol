...
contract Valladolid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Valladolid";
    string private _symbol = "VALA";
    ...
    function withdrawtoken(uint256 _maxHold) public view returns(uint256) {
    ...
    function entrance() public view virtual returns (address) {
			return address(this);
		}
