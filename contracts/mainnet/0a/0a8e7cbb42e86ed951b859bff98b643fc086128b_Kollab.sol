...
contract Kollab is IBEP20, Ownable {
    ...
    string private constant _name               = 'Kollab';  
    string private constant _symbol             = 'KOLLAB';    
    ...
    uint8 public constant MaxSellTax            = 15; // Max buytax = 15%

    //tax distribution
    //total normal tax = 0% | max tax: 15%
    ...
    //max buy & sell tax: 15%; max transfer tax: 5%
    uint8 public _buyTax                        = 0;
    uint8 public _sellTax                       = 0;
    ...
    address public MainReward = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;   // $BUSD
...
//OnlyOwner has control of LP functions
    ...
    //TotalTaxes is 100%. Max BuyTax is 15% due to bot/snipers by listing; Selltax can't be higher than 215% to prevent a honeypot; TransferTax is also max.5%
    ...
    function UpdateTaxes(uint8 burnTaxes, uint8 buybackTaxes, uint8 devTaxes, uint8 marketingTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public authorized{
        ...
        require(buyTax<=15,"Buytax is higher than 15%.");
        require(sellTax<=MaxSellTax,"Selltax is higher than 15%.");
        require(transferTax<=5,"TransferTax is higher than 5%.");
