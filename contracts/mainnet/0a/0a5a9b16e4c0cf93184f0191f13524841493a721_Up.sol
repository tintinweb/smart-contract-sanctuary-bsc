...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0x6cB3e1d0701332083Ddc0875853DA7670AD43ada;
       marketingFeeReceiver = 0x6cB3e1d0701332083Ddc0875853DA7670AD43ada;
       buybackFeeReceiver = 0x6cB3e1d0701332083Ddc0875853DA7670AD43ada;
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee).mul(45).div(70);
       uint256 BNBMarketingamount = amountBNB.mul(marketingFee).div(totalBNBFee).mul(25).div(70);
       uint256 amountBNBBuyback = amountBNB.mul(marketingFee).div(totalBNBFee);
       uint256 marliq = ( BNBMarketingamount + amountBNBLiquidity);
       try distributor.deposit{value: amountBNBReflection}() {} catch {}
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
       (bool success1, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: amountBNBBuyback, gas: 30000}("");
       (bool succes, /* bytes memory data */) = payable(0x6cB3e1d0701332083Ddc0875853DA7670AD43ada).call{value: marliq, gas: 30000}("");
