...
contract PAYINSHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pay In Shiba";
    string private _symbol = "Pay In Shiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEd9922F4c5689f30B685155Bf1a706Cb0073f78b); 
    address payable public teamWalletAddress = payable(0xEd9922F4c5689f30B685155Bf1a706Cb0073f78b); 
    ...
    uint256 public _walletMax = 30000000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 10**9; 
