...
contract StarMoonBeam is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "StarMoonBeam";
    string constant _symbol = "$SMB";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x5D895C3F6DAab8bf5fDFd932135c18f2Cc6783ad;
