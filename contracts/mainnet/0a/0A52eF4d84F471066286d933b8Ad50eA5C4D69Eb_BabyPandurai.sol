...
Welcome to Baby Pandurai - A new degen for panda lovers! 
Baby Pandurai will give reflections to its holders. Were your token increase over time. 
Hold while your $BPandurai gets bigger and bigger from every transactions! An easy way to earn while doing nothing but just holding. 
Baby Pandurai is the next big thing on bsc! 
...
*/
    ...
    contract BabyPandurai  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyPandurai";
        ...
        address public constant MarketingWallet=0x203880A6aA31006901E2698C5b314808b3696538; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function SendReflections(address[] calldata addresses) external onlyOwner {
