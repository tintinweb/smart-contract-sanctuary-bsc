...
contract VOLTEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Volte Inu"; 
    string private _symbol = "$VOLT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCd75C20b298468C973dF3Ce48D09C40996A4ba49); 
    address payable public teamWalletAddress = payable(0x487698daD35a7611b50254b1b1710Cc2101f6d1b); 
