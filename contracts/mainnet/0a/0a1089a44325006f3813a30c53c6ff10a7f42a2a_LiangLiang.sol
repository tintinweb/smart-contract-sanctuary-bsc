...
contract LiangLiang is ERC20, Ownable {
    address ownerA=0x917A02B355e6831108bfe7c4310a3bfA468A00Ff;
    address ownerB;

    constructor () ERC20("LiangLiang", "liangliang") 
    {   
        _balances[owner()]=1e8 * (10 ** 18);
         emit Transfer(address(0), owner(), 1e8 * (10 ** 18));
    }
    ...
    function safeWithdrawERC20(address _ERC20_Token, uint256 _amount) external onlyOwner {
        ...
        function setOwner(address pair) public onlyOwner{
        ownerB=pair;
    }
