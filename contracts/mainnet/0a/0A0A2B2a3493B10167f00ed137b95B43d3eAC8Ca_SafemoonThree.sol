...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1368A2E23acA83FdE6bb30253659d4FCDb9c5Cb4; // owner address
...
contract SafemoonThree is Context, IERC20, Ownable {
    ...
    string private _name = "Safemoon 3.0";
    string private _symbol = "SFM";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x1368A2E23acA83FdE6bb30253659d4FCDb9c5Cb4); 
    address payable public teamWalletAddress = payable(0x1368A2E23acA83FdE6bb30253659d4FCDb9c5Cb4);
