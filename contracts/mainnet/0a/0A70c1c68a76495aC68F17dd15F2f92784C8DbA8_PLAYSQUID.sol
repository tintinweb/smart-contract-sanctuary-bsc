...
contract PLAYSQUID is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PLAYSQUID";
    string constant _symbol = "PSD";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8759A692217b32e07f90355e0B0C6cE784e888e7;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x837ccb66b32D5AD3e021E900a76f86159E802a1c;  
        anothermarketingWallet = 0x837ccb66b32D5AD3e021E900a76f86159E802a1c;
