...
contract Upoint is ERC721Pausable, AccessControl, Ownable, IERC721Receiver {
    ...
    function activate(address _super,uint8 num) public {
    ...
    function buy(uint256 num) public onlyActivate {
        ...
        _usdt.transferFrom(_msgSender(), _first, price * num * 1000000000000000000);
        nextSaleId += num;
    }
