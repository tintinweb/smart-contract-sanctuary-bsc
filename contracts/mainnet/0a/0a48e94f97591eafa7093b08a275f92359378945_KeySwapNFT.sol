...
contract KeySwapNFT is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("KeySwap NFT", "KEYNFT") {}
        ...
        returns (string memory)
    {
        ...
        return
            bytes(_base_uri).length > 0
                ? string(abi.encodePacked(_base_uri, tokenId_.toString()))
                : _unreveal_uri;
    }
