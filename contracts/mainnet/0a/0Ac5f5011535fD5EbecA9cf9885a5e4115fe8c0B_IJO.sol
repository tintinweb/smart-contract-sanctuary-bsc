...
contract IJO is ReentrancyGuard {
  ...
  // merkle Root
  bytes32 public whiteList = 0xb3d792b889ef36b3534b5ad25364ef22e75a5a9990f32d1c1b030cfcbfe56717;
  ...
  function deposit(uint256 _amount , bytes32[] calldata _merkleProof) public {
    ...
    if (depositLimitPerWallet > 0) {
      require (userInfo[msg.sender].amount.add(_amount) <= depositLimitPerWallet, 'exceeded max deposit amount');
    }
