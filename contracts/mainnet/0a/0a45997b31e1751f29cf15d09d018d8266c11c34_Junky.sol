...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xC2A6D0902a33017931D545313de5a4966F0191d0;
...
contract Junky is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Junky Coin"; 
    string private constant _symbol = unicode"Junky"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xC2A6D0902a33017931D545313de5a4966F0191d0), BNB_Tot);
            }
