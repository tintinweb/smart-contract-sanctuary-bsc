...
TG: https://t.me/+ChgIbCDAhjpkNDM1
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x804564b90789D9353101bfce473B4c94557df45d; // owner address
...
contract Babylunaboy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Lunaboy";
    string private _symbol = "BBLB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x804564b90789D9353101bfce473B4c94557df45d); // Marketing Address
    address payable public teamWalletAddress = payable(0x804564b90789D9353101bfce473B4c94557df45d); // Team Address
