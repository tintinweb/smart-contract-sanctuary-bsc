...
contract DOUGRAMSEYINU is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DOUG RAMSEY INU';
    string private constant _symbol = 'BEYOND MEAT';
    ...
    //DevWallets
    address public Development=payable(0x93597D0B3e2A30D4E336FC21a8E7a611D05078C6);
    address public Marketing=payable(0xeB298a0FDDbFD2D7E5Eb1A413C289685C0558E1a);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //IF REWARDS ARE ENANBLED CONTRACT WILL SWAP WBNB TO THIS ADDRESS - SET AS BUSD.
