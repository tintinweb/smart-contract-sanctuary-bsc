...
/** telegram:
    https://t.me/bitcoin2009official

    /** Earn 8% BTC Rewards (round trip)
    tax 10/10
    max wallet 2%

    Dev remains a ongoing Bitcoin mystery
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  WBTC = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
...
/* Token contract */
contract BITCOIN2009 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8b9E3c018E694ca864B33105DF64b79189CB6456;
    ...
    // Name and symbol
    string constant _name = "BITCOIN2009";
    string constant _symbol = "BTC2009";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 100000 * (10 ** _decimals); // 20mill
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5E0edCbB0dD55721a0C5BF029EEe2936c54313BD;
