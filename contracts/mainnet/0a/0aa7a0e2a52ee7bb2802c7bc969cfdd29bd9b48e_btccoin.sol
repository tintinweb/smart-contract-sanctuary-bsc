...
contract btccoin is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6D87c716E3e805465073f018A42F7db6D715F7b2));
        marketingWalletAddress = payable(address(0x6D87c716E3e805465073f018A42F7db6D715F7b2));
