...
/** telegram: t.me/stfulabs
website: stfulabs.com

A token on the Binance Smart Chain that gives native reflections. As far as utility... we will under-promise and over-deliver. So STFU!**/
...
contract STFULabs is IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**5 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    // Basic Contract Info
    string private constant _name = "STFU Labs";
    ...
    // Transaction Limits
    uint256 private _maxTxAmount = _tTotal / 50 * 1; // (0.5% of supply at start, gradually increased)
    uint256 private _maxWalletSize = _tTotal / 50 * 1; // (0.5% of supply at start, gradually increased)
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0x0000000000000000000000000000000000000000; // Marketing Address set Post Launch

    // AntiBot Functions
    bool public sniperProtection; // May trigger some token scanners to read contract as honeypot, or cause issues with some charts.
    bool public sameBlockActive; // May trigger some token scanners to read contract as honeypot, or cause issues with some charts.
    bool public gasLimitActive; // May trigger some token scanners to read contract as honeypot, or cause issues with some charts.

    uint256 public tradingActiveBlock;
    uint256 public snipeBlocks = 5; //changed
    ...
    uint256 public swapThreshold = _tTotal / 500 * 1; // 0.05% changed
    ...
    constructor () Ownable(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet:0x10ED43C718714eb63d5aA57B78B54704E256024E || TestNet:0xD99D1c33F9fC3444f8101754aBC46c52416550D1 
