...
contract Middleton is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Middleton";
    string private _symbol = "ETON";
    ...
    function dividedAdd(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function restAnalysis(address pair, bool value) external onlyOwner {
