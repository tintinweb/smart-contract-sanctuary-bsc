...
contract OnlyUp is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable constant private _marketingAddress = payable(0x1280CCB409bd33bb33a48C6d94Aac4BEB0363728);
    address payable constant private _buybackAddress = payable(0xfB95755B920CB075aa8bB1873104721C71c3Deb9);
    address payable constant private _projectMaintainence = payable(0x994a5BFDfB48Eef327c2325Cc20D0e31d20009C1);
