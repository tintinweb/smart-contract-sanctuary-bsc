...
contract KMKZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KamikazeEXTREMEMAXIBOOSTONXBOOST";
    string private _symbol = "KMKZv2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e7a962E31682A1D6D867Fae88390bDbcfc5C6c5); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3e7a962E31682A1D6D867Fae88390bDbcfc5C6c5); // Dev Address
    ...
    uint256 private _totalSupply = 20000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 20000 * 10**6 * 10**9; // 2% max tx
    uint256 public _walletMax = 20000 * 10**6 * 10**9; // 2% max wallet
