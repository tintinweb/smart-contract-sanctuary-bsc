...
✨100% STEALTHLAUNCH.
✨ Max Wallet 7% / Max Tx 6%
✨ 4% on buys and sells at launch
✨ No team tokens
*/
...
contract FomoInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Fomo Inu";
    ...
    uint256 public _maxTxAmount = 60000000 * 10**9; //6
    uint256 public _maxWalletSize = 70000000 * 10**9; //7
