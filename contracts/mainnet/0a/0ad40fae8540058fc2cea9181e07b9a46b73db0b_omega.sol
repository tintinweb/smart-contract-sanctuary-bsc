...
contract omega is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0xb9dDD06856C196e5582489010b9E2EB80D7E2811;

    string private constant _name = "Zillamas";
    string private constant _symbol = "ZILLA";
    ...
    Taxes public taxes = Taxes(0, 7, 1);
    Taxes public sellTaxes = Taxes(0, 7, 1);
