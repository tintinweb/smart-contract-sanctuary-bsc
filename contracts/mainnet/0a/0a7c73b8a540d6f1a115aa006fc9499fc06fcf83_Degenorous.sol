...
/**
    ...
    $DTG - Degenorous Thanks Giving

    Gratitude can transform common days into thanksgivings, turn routine jobs into joy, and change ordinary opportunities into blessings.

    Give thanks to the crypto gods and ape what they have graciously given you for this opportunity.

    https://t.me/DegenorousPortal
...
contract Degenorous is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x13AA185e67dAB10D822470498107F362548d7070;
 
    string constant _name = "Degenorous";
    string constant _symbol = "$DTG";
