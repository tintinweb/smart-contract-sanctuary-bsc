...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb79Bdf7d6452B5Faf2F43f6fa3cc41F3ff056747; 
...
contract NiokoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nioko Inu";
    string private _symbol = "$Nioko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb79Bdf7d6452B5Faf2F43f6fa3cc41F3ff056747); // 
    address payable public teamWalletAddress = payable(0xb79Bdf7d6452B5Faf2F43f6fa3cc41F3ff056747); // 
    ...
    uint256 private _totalSupply = 2232232232 * 10**_decimals;
    uint256 public _maxTxAmount = 44644644 * 10**_decimals; 
    uint256 public _walletMax = 44644644 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2023 * 10**_decimals; 
