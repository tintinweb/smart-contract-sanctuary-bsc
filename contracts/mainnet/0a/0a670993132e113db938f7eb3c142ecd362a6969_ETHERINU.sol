...
contract ETHERINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ETHERINU", "$ETI") {
    	...
    	marketingWallet = address(0x6a3246c32CDc635a676999513ceb0a949F810b75); // set as marketing wallet
    	devWallet = address(0x6a3246c32CDc635a676999513ceb0a949F810b75); // set as staking wallet 
