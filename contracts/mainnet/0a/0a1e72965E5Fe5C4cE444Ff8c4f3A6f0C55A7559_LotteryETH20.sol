...
contract LotteryETH20 is Ownable, Pausable, ReentrancyGuard {
	...
	//fees
	uint256 public ticketPrice = 0.01 ether; //all prices are in Titano
	...
	uint256 public maxTicketsToBuy = 50;
	...
	constructor() {
		...
		setTicketStep(15 minutes, 13 minutes, 11 minutes, 9 minutes, 7 minutes, 5 minutes);
	 ...
	 */
	function buyTickets(uint256 qty, address affiliateAddress) external notContract whenNotPaused nonReentrant {
