...
contract ShibaLVGOLD is Context, IERC20 { 
    ...
    string private constant _name = "Shiba LV GOLD"; 
    string private constant _symbol = unicode"SLVG"; 
    ...
    function serMmaxWalletToken(uint256 _m) public onlyOwner{
