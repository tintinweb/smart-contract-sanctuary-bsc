...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyHoldDividendFee = 2;
    uint256 public _buyFundFee = 1;

    uint256 public _sellHoldDividendFee = 1;
    ...
    constructor (
        ...
        holderCondition = 30 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {//Buy
                swapAmount = tAmount * (_buyFundFee + _buyHoldDividendFee) / 100;
            } else {//Sell
                swapAmount = tAmount * (_sellFundFee + _sellLPFee + _sellHoldDividendFee) / 100;
                isSell = true;
            }
...
contract Portugal is AbsToken {
    ...
    //USDT
        ...
        1000000,
    //Receive，接收
        address(0x417E19af3B15E07B4705Ca8a6763b3C127C598Be),
    //Fund，营销
        address(0x74F65d09840cBCBF903BEc95ca6dddCd2f1B86Df)
    ){
