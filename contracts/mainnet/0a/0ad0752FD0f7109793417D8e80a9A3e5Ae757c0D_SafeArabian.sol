...
/*
  __   ___   ____  ____     ___  ____   ___  ____  __  ___  __  __
 (( \ // \\ ||    ||       // \\ || \\ // \\ || )) || // \\ ||\ ||
  \\  ||=|| ||==  ||==     ||=|| ||_// ||=|| ||=)  || ||=|| ||\\||
 \_)) || || ||    ||___    || || || \\ || || ||_)) || || || || \||

Telegram: https://t.me/SafeArabian
*/
...
contract SafeArabian is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safe Arabian";
