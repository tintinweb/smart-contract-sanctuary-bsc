...
contract Apetallica is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Apetallica";
    string private _symbol = "METAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x430fAcaa559C2941cB182eE8E56B7435657824BC); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6447183e9976fd76196D4dA149A5b692eF75570b); // Buyback Address
