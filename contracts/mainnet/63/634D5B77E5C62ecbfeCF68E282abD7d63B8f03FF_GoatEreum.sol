...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07a59C6CCEe018Fd2541Ad995690eEF56F6Bd2c9; // owner address
...
contract GoatEreum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goatereum";
    string private _symbol = "Goatereum";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07a59C6CCEe018Fd2541Ad995690eEF56F6Bd2c9); // Marketing Address
