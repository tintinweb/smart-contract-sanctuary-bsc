...
contract OneGoal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"OneGoal";
    string private _symbol = unicode"OneGoal";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0x0b7357CF2dBFD5DF70aC32CC31ecfB52B4648C51); 
    address payable public BurnedWalletAddress = payable(0x0b7357CF2dBFD5DF70aC32CC31ecfB52B4648C51); 
