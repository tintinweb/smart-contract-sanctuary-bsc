...
contract DFSMafia is DFSMafiaFlags, UsingBatchTransfer, UsingERC20WithStorage, UsingPermitWithStorage, UsingUUPS {
    ...
    function setBuyAllocations(uint128 liquidityAllocation_,  uint128 burnAllocation_, uint128 rewardsAllocation_) external requiresAdmin  {
        _setAllocations(_buyFee, liquidityAllocation_, burnAllocation_, rewardsAllocation_);
    }
    ...
    /// @param rewardsAllocation_ the allocation to rewards
    /// @dev note that the allocation is a percentage of the fee for example if the fee is 3% and allocations are evenly split it would be 33000, 33000, 34000
    function setSellAllocations(uint128 liquidityAllocation_,  uint128 burnAllocation_, uint128 rewardsAllocation_) external requiresAdmin  {
        _setAllocations(_sellFee, liquidityAllocation_, burnAllocation_, rewardsAllocation_);
    }
    ...
    /// @param rewardsAllocation_ the allocation to rewards
    /// @dev note that the allocation is a percentage of the fee for example if the fee is 3% and allocations are evenly split it would be 33000, 33000, 34000
    function setTransferAllocations(uint128 liquidityAllocation_,  uint128 burnAllocation_, uint128 rewardsAllocation_) external requiresAdmin  {
        _setAllocations(_transferFee, liquidityAllocation_, burnAllocation_, rewardsAllocation_);
    }
    ...
    function _setAllocations(Fee storage fee_, uint128 liquidityAllocation_,  uint128 burnAllocation_, uint128 rewardsAllocation_) internal  {
