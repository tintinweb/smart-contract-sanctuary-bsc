...
contract BeElonMusk  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x517BeCf47dA79096098baA70C3eb4Ce2a86Bb655); 
    address payable public Wallet_Dev = payable(0x517BeCf47dA79096098baA70C3eb4Ce2a86Bb655);
    ...
    string private constant _name = "BeElon Musk"; 
    string private constant _symbol = unicode"BEELONMUSK"; 
    ...
    constructor () {
        ...
        _owner = 0x517BeCf47dA79096098baA70C3eb4Ce2a86Bb655;
