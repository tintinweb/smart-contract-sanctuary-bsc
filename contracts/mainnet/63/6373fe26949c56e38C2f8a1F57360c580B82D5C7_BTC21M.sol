...
contract BTC21M is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC21M";
    string private _symbol = "BTC21M";
    uint8 private  _decimals = 8;
    address private immutable _owner;
    address payable public marketingWalletAddress = payable(0x059399B96349c8a2C9416B3BDaF9d978F006d414); 
    ...
    uint256 private _totalSupply = 2100* 10**12 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap =1* 10**12 * 10**_decimals;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapPair;
    uint256 public _maxTxAmount = 10* 10**12 * 10**_decimals;
