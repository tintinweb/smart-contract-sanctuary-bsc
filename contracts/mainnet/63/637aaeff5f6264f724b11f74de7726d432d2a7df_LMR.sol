...
contract LMR is LMRDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private LMRTeam;
    address private CharityLMR;
    ...
    string public override name = "Lumerin";
    string public override symbol = "LMR";
    ...
    constructor(uint totalSupplyValue, address LMRTeamAddress, address CharityLMRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        LMRTeam = LMRTeamAddress;
        CharityLMR = CharityLMRAddress;
       
        // split the tokens according to agreed upon percentages
        balances[LMRTeam] =  totalSupply * 4 / 100;
        balances[CharityLMR] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's LMRTeam pot
