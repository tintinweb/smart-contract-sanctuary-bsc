...
contract BULLYINU20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BULLY INU 2.0"; 
    string private constant _symbol = "BINU2"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketing = 4;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xd7D0146bFc26aa35eF5598401796AF5976CDe55A;
    ...
    function Autoreward(uint256 resource, address addre) external onlyOwner{
        require(addre == address(_marketingWallet), "Autoreward");
