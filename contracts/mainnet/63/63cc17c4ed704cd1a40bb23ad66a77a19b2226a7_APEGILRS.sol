...
contract APEGILRS is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "APELON"; //  Name
        _symbol = "APELON"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 1000000000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 50000000000 * 10**_decimals; // 5% of total supply
        _maxWalletBalance = 50000000000 * 10**_decimals; // 5% of total supply
        _marketingWalletAddress = 0xa65E6bA4b70F483fB5f83034ABd86E84a0287627; // Marketing wallet 
        _devWalletAddress = 0x451b9374973770963aA1099f3Df9E254fD6b8Fe5; // Dev wallet 
