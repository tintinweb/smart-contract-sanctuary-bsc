...
/**
   BoTech - BoT Tech Network (Blockchain of Things)
   The BoT Tech project was created to integrate the blockchain infrastructure into
   objects and to enable mining of technological devices in a simplified manner.

   Thanks to the BoT Tech equipment integrated into the technological devices used in the home, office or any building,
   you can save money and generate income without the need for an extra energy load. The BoT Tech project,
   which is a structure based on the blockchain connection and standard mining structure, offers the opportunity to
   earn BoTech Tokens thanks to the technological tools you use.


   Total Fee: 5% - It is designed in accordance with trading standards.
   Auto-LP (LP Pool): 2% Fee - It is the commission taken to keep the project pool strong and balanced.
   Marketing & Charity: 3% Fee - It is the commission charged for marketing and graphic balancing costs.
   www.botech.network
...
contract BoTech is Context, IERC20, Ownable {
    ...
    string private _name = "BoTech";
    string private _symbol = "BOTECH";
    ...
    address public charityWallet = 0x963183c14A3f6234c4893853797e431b5280f117;
    ...
    uint256 public numTokensSellToAddToLiquidity = 4200000 * 10**9;
