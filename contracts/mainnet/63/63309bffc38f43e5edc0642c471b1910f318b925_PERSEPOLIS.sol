...
PERSEPOLIS creates the first decentralized AppStore to drive dApps adoption,
a distributed ecosystem powered by a state-of-art cryptocurrency.

Website https://persepolis.digital

Telegram https://t.me/PersepolisDigital

Twitter https://mobile.twitter.com/PersepolisDGL
*/
...
contract PERSEPOLIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PERSEPOLIS DIGITAL";
    string private _symbol = "PERSEPOLIS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x255fDf7DE8b9735Cb40EE8DF03B30835Eb40f43b); 
    address payable public buyBackWalletAddress = payable(0x255fDf7DE8b9735Cb40EE8DF03B30835Eb40f43b); 
