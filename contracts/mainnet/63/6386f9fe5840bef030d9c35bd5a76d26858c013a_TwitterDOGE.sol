...
contract TwitterDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterDOGE2.0";
    string private _symbol = "TwitterDOGE2.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x216C8001885aaBad741007d8EEb8dd4cCcbA925a); 
    address payable public BurnedWalletAddress = payable(0x216C8001885aaBad741007d8EEb8dd4cCcbA925a); 
