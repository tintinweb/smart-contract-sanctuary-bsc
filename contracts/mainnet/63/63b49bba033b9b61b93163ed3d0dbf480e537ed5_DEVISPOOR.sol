...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DEVISPOOR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is Poor";
    string private _symbol = "DEVISPOOR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x526927A9f9924F1d286abd76FC954afde6A8195C);
    address payable public devWalletAddress = payable(0x526927A9f9924F1d286abd76FC954afde6A8195C);
