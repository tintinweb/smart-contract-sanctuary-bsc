...
contract DarkTavernToken is Ownable, ERC20 {
    using Address for address;

    IRouter public uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "Dark Tavern Token";
    ...
    function setMaxTransactionAmount(uint256 newValue, bool isBuy) external onlyOwner {
        require(newValue >= initialSupply * 50 / 10000, "DarkTavern: Max Transaction value must be greater than or equal to 0.5% of supply");
        if (isBuy) {
