...
contract CHPIG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "China Pig"; 
    string private _symbol = "CHPIG"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9c4775ea763eBbA5CE7975533B4A29a0201d1e78); 
    address payable public teamWalletAddress = payable(0x9c4775ea763eBbA5CE7975533B4A29a0201d1e78); 
