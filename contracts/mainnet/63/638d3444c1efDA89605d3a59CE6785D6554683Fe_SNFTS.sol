...
contract SNFTS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SNFTS";
    string private _symbol = "SNFTS";
    ...
    address private lpAddress = 0xd9A0601Efa0f20ef8476edF529162671887ee0eE;
