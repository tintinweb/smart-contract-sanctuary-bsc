...
/**               
Telegram : https://t.me/DipDetectorBotTG
*/
...
contract DipDetectorBOT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DipDetectorBot", "DIPBot") {
        marketingWallet = payable(0x00239C51De0f7308c441D4cD35F2c43BAc0ad4Eb);
        devWallet = payable(0x00239C51De0f7308c441D4cD35F2c43BAc0ad4Eb);
...
contract DipDetectorBOTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DipDetectorBOT public DipDetectorBOTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DipDetectorBOTContract = DipDetectorBOT(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DipDetectorBOT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DipDetectorBOT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DipDetectorBOTContract);

            uint256 prevBalance = DipDetectorBOTContract.balanceOf(address(this));
            ...
            {
                uint256 received = DipDetectorBOTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DipDetectorBOTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
