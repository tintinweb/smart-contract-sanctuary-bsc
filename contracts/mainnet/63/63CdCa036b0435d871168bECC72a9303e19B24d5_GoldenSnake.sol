...
contract GoldenSnake is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldenSnake"; // 
    string private constant _symbol = " $GSNAKE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x277ad2A17cbEe97b3965382BF69fB78648aD3592;
