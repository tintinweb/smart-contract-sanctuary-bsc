...
contract Oweis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oweis";
    string private _symbol = "Oweis";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd5543385d5D096b311EFDC66368Fa5F83B0AE5dD); 
    address payable public BurnedWalletAddress = payable(0xd5543385d5D096b311EFDC66368Fa5F83B0AE5dD); 
