...
contract RabbitDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7c725228eE89bDCa79F38B9c453f2DDFeD4c6eE2); 
    ...
    uint256 private _totalSupply = 10000 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 10000 * 10**9 * 10**9; 
    uint256 public _walletMax = 10000 * 10**9 * 10**9; 
