...
contract MinionInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000*1e6* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
 
    string private _name = "Minion Inu";
    string private _symbol = "MNI";
    ...
    address public  advertisementWallet = 0xcDA189ffd2bf363897E061625D06De0e94be320C;
    ...
    uint256 public _maxTxAmount = 100000*1e1  * 10**18;
    ...
    function changeAdvestisementWallets(address wallet) public onlyOwner{
        require(wallet != address(0) || wallet != DEAD_ADDRESS, "Invalid Address!");
     ...
     */
    function withdrawLeftoverBNBToAdvertisement(
    ...
    function withdrawLeftTokenToAdvertisement(
        address ct,
        address recipient
    ) public onlyOwner {
        IERC20 token = IERC20(ct);
        uint256 currentAmount = balanceOf(address(this));
        require(currentAmount > 0, "Invalid amount");
        token.transfer(recipient, currentAmount);
    }
    ...
    function setRouterAddress(address newRouter) public onlyOwner {
        ...
        ammPairs[pancakeswapV2Pair] = true;
