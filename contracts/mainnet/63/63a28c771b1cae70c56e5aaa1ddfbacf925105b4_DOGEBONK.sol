...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x564D74F216EAE26097CCe41c26fCB30141f9e1dF; // owner address
...
contract DOGEBONK is Context, IERC20, Ownable {
    ...
    string private _symbol = "DBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x564D74F216EAE26097CCe41c26fCB30141f9e1dF); // Marketing Address
    address payable public teamWalletAddress = payable(0xEE3E0EB997ccEd3E2540ed16F53A6eF5Fae9c59c); // Team Address
