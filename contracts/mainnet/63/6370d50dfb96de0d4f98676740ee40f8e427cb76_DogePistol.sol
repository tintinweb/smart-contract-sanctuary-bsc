...
contract DogePistol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Pistol Inu";
    string private _symbol = " DPISTOL "; 
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xab1D0A6F1F9F30A853d02551B0d9E9AD30df835C);
    address payable private teamWalletAddress = payable(0xab1D0A6F1F9F30A853d02551B0d9E9AD30df835C);
