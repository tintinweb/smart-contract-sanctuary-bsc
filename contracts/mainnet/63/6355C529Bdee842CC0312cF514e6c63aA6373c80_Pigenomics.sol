...
contract Pigenomics is Context, IERC20, Ownable {
    ...
    payable(0x05181183f1baDa0E57acf0a8373D903756395dF3);
    ...
    string private constant _name = "Pigenomics";

    string private constant _symbol = "PIGENOMICS";
