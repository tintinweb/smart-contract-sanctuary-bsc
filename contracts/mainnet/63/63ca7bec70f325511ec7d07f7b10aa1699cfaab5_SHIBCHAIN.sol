...
contract SHIBCHAIN is ERC20, Ownable {
    ...
    address public marketingWallet = 0x8792CDe6C59786A1Aa6957EE6BA8a36AD4FE2F7B;
    ...
    {       
        ...
        transferOwnership(0x5B0187833Da8D37B13491E833aCE9091Fb582A0B);
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 10 && _sellFee <= 15, "Max buy fee is 10% and max sell fee is 15%");
        require(
            (launchedAt > 0 && launchedAt + 14 days < block.timestamp) ||
            (_buyFee <= buyFee && _sellFee <= sellFee),
