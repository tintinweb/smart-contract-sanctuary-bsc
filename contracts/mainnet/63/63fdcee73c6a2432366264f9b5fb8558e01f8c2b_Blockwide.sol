...
/*
 Project Name: Blockwide Network
 Symbol: BWN
 Telegram : https://t.me/BlockwideNetwork
 Site: Blockwide.network
-----
 Web2 systems, called pre-blockchain, use World Wide Web (WWW) infrastructures known as standard network structure. 
 It provides access to 3rd parties after data transfers made within Web2 systems are transferred to a specific center. 
 Web2 systems are unreliable, audited by institutions, and data transfer is delayed. 
 The basis of the Block-Wide Network aims to provide this situation with one-to-one ties. Data is open for transmission over any decentralized blockchain chains.

 ✅ Much faster data transfer
 ✅ Full security with SHA256 encryption type

 Infrastructures that we will pioneer under the Block-Wide Network;
 BWN Chat: A chat platform created with Blockchain network structure and never controlled/monitored by 3rd parties.

 BWN Account: Bank, social media, cryptocurrency wallets protection and management application that is created with 
 the Blockchain network structure and can never be audited/monitored by third parties.
...
contract Blockwide is Context, IERC20, Ownable {
    ...
    string private _name = "Blockwide Network";
    string private _symbol = "BWN";
    ...
    address public charityWallet = 0xAfE01db0DE163607A416aE29FA9D32eedfA44266;
