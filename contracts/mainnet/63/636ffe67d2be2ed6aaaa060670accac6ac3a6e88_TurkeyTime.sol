...
contract TurkeyTime is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Turkey Time';
    string private constant _symbol = '$TURKEY';
    //uints
    uint public constant InitialSupply= 46000000 * 10**_decimals;
    ...
    address private projectWallet=0xF9422E5AbA8e360757c16b4F74B36673B515E8AF;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=6 minutes;
