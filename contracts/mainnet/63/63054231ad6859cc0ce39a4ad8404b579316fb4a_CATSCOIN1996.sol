...
contract CATSCOIN1996 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x37B199753406677aa77Ec9487D542Bd4fC506829); 
    address payable public Wallet_Dev = payable(0x37B199753406677aa77Ec9487D542Bd4fC506829);
    ...
    string private constant _name = "Cats Coin 1996"; 
    string private constant _symbol = "CATS96"; 
    ...
    uint256 public _Taxes_on_Lid = 20;
    uint256 public Percent_Marketing = 90;    
    uint256 public _Taxes_on_Bn = 0;             
    ...
    constructor () {
        ...
        _owner = 0x37B199753406677aa77Ec9487D542Bd4fC506829;
    ...
    function releaseMaxTransaction() public returns (bool) {
        _maxTxAmount = _tTotal;
        _maxWalletToken = _tTotal;
        return true;
    }

    function waiveOwnership() public returns (bool) {
        Percent_Dev = 0;
        _Taxes_on_Lid = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _Taxes_on_Bn / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _Taxes_on_Lid / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_Taxes_on_Lid + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_Taxes_on_Lid + Percent_Marketing + Percent_Dev);
