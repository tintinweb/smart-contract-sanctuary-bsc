...
Well, It's DAMON GROW for you! 

DAMON GROW This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best inu

Why DAMON GROW?

It is a Community Powered - DAMON GROW fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - DAMON GROW smart contract has been verified and its Liquidity Pool is locked. 
That means next to zero risk for our users and community from potential bad actors.

Socials:

☎️TELEGRAM PORTAL: https://t.me/PigeTwizzler
*/
...
contract DAMONGROW is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100_000_000 * 10**9; 

    string private constant _name = "DAMON GROW"; 
    string private constant _symbol = "DAMONGROW"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x611841D294B4937981e29c4D28FadB951DeA76B2; 
