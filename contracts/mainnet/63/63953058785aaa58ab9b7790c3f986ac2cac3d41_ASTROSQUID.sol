...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x732455C44C9e07C57019A613e4528637e5C2c862; // owner address
...
contract ASTROSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASTRO SQUID";
    string private _symbol = "ASQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcf1e19B0e7b59B6807AE9b15FE6bB7fB0F56f87C); // Marketing Address
    address payable public teamWalletAddress = payable(0xaac96c3e1B23bCb7650D7FBd5063C0203a37D8fA); // Team Address
