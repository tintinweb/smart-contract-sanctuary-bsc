...
contract QuadrigaCxSwap is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa0c22514f90AD2dDAC26B23dEFe41C1FC51FAc2D;

    string private constant _name = "QuadrugaCx Swap";
    string private constant _symbol = "QDRGASWP";
    ...
    Taxes public taxes = Taxes(2,3,2,2);
