...
contract Babynekocoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8985c4757129009626d0a299FeaD1828Cab548a6); // Marketing Address
    ...
    string private _name = "babynekos";
