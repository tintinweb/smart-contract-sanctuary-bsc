...
contract BBS is Context {
    ...
    constructor() {
        ...
        Descriptions = "Welcome to Binance Binary System (BBS). This is 100% decentralized. Sign up $ 100. You have two legs (left and right). You can invite two new users with your referral link. You will be awarded 1 reward for each new user on the left and right. You are allowed to receive up to 30 rewards per day.  The difference of the left and right are transferred to the next day. When you  flash out, difference will not be zero. 100% of all payments are sent to the contract and are paid to users every 24 hours by the Binance Binary System (BBS). The time of payment of rewards is determined by users. Users who receives at least one reward is allowed to write the reward payment order on the contract. The reward payment time is at least 24 hours after the previous reward payment. You will be paid 30 million tokens (BBS) when you register. Total 1ID revenue for token liquidity is paid to Pancakeswap. The smart contract will continue to work non-stop. There is no income outside the system for anyone. Enjoy BBS.";
        tokenAddress = 0xC71D8e2e05C9aa713c06498Ea7a517A86064ad30; 
