...
contract MMMPool is Context, Initializable {
    ...
    function initialize(string memory pname, string memory psymbol, uint8 pdecimals, uint256 poolType, uint256 ticketNumber, uint256 bonusRate, uint firstRoundNumber, address[] memory flks ) public initializer {
        _name = pname;
        _symbol = psymbol;
        _decimals = pdecimals;
        _owner = msg.sender;
