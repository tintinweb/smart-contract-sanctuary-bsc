...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x0F2420fC7ce2446C35CD37F514486aa88D703bC3);
...
/* Token contract */
contract CatKukai is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x0F2420fC7ce2446C35CD37F514486aa88D703bC3; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x5258622E00A038065276843cE810e2E67f4ed301;
    ...
    // Name and symbol
    string constant _name = "Cat Kukai";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 4% or 2m tokens
