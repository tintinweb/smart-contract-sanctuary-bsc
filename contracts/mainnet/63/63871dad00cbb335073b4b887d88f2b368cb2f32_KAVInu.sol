...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51A0EFe9A78441a099f1FF25209A990372AaFFaf; // owner address
...
contract KAVInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAV Inu";
    string private _symbol = "KAV"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x51A0EFe9A78441a099f1FF25209A990372AaFFaf); // Marketing Address
    address payable public teamWalletAddress = payable(0x51A0EFe9A78441a099f1FF25209A990372AaFFaf); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 24;  // original 12
