...
contract EBT is IBEP20, Auth {
    ...
    string constant _name = "Elon Buys Twitter";
    ...
    address private marketingFeeReceiver =0x3d0003054DF5cA1E9843dAb6b39D3D6742028E0E;
    address private teamFeeReceiver =0x3d0003054DF5cA1E9843dAb6b39D3D6742028E0E;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000 * 3; // 0.3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0x3d0003054DF5cA1E9843dAb6b39D3D6742028E0E;
