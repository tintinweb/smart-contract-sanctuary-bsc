...
contract AbeJapan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0D6B1736c16069f7E50158B0fbBd092776E70b5c); 
    address payable public Wallet_Dev = payable(0x3CBF1500f2547d66b45d8ba90D8284eE04bb1E25);
    ...
    string private constant _name = "Abe Japan"; 
    string private constant _symbol = unicode"$AbeJapan"; 
    ...
    constructor () {
        ...
        _owner = 0x3CBF1500f2547d66b45d8ba90D8284eE04bb1E25;
