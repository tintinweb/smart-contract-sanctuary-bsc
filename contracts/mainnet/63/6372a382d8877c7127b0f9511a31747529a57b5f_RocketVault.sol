...
contract RocketVault is BEP20, Ownable {
  ...
  using SafeMath for uint256;
    ...
    string private _name = "Rocket Vault";
    string private _symbol = "RVF";
    ...
    function _setDelays(address _acc, uint8 _value) public onlyOwner {
