...
contract QiXiDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QiXiDoge";
    string private _symbol = "QXD";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xe054b84D81c7560aC824c502Bf9D3f2490f2F8f4); // Marketing Address
