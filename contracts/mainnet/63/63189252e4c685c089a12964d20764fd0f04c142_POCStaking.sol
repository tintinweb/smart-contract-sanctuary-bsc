...
contract POCStaking is Ownable ,ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
       ...
       bool _started
        ...
        pooldata[7].returnPer = 100; // 1%

        //90 days
        pooldata[14].lockupDuration = 14;
        pooldata[14].returnPer = 296; // 3%

        //180 days

        pooldata[30].lockupDuration = 30;
        pooldata[30].returnPer = 677; // 7%

        //365 days
        pooldata[60].lockupDuration = 60;
        pooldata[60].returnPer = 1398; // 14%
    }
