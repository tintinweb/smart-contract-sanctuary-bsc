...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Bc877546A573aCe6655240dd84cbB30Ff58B50a;
...
contract DogeKingGrandson is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x1020117d1C9414F8524f998B38D52546dbD12F7a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge King Grandson";
