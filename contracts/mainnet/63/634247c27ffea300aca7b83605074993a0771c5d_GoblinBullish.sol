...
contract GoblinBullish is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoblinBullish";
    ...
    uint256 public swapTokenAtAmount = 100000000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0xe3f573eACEE30606a14eab50D36C9Bd75Bd0cD1F);
    address private liquidityReceiver = address(0xe3f573eACEE30606a14eab50D36C9Bd75Bd0cD1F);
