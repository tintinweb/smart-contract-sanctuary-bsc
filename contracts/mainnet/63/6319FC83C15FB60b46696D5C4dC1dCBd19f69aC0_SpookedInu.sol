...
contract SpookedInu is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 200000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Spooked Inu"; // token name
    string private _symbol = "SPOOKED"; // token ticker
    ...
    uint256 private minTokenToSwap = 2000000000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 2000000000000000 * 1e9;
    uint256 public minBuyLimit = 2000000000000000 * 1e9;
