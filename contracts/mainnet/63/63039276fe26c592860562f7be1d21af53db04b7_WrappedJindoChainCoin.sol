...
contract WrappedJindoChainCoin is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    WrappedJindoChainCoinDividendTracker public dividendTracker;
    ...
    address payable public _buybackWalletAddress = payable(0x7b26ce37915C20d1E3e70F89D9394B2e0DeE4313);
    ...
    constructor() BEP20("WrappedJindoChainCoin", "wJCC") 
    {
        dividendTracker = new WrappedJindoChainCoinDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "WrappedJindoChainCoin: The dividend tracker already has that address");
        WrappedJindoChainCoinDividendTracker newDividendTracker = WrappedJindoChainCoinDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "WrappedJindoChainCoin: The new dividend tracker must be owned by the WrappedJindoChainCoin token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "WrappedJindoChainCoin: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "WrappedJindoChainCoin: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "WrappedJindoChainCoin: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "WrappedJindoChainCoin: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "WrappedJindoChainCoin: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "WrappedJindoChainCoin: Cannot update gasForProcessing to same value");
...
contract WrappedJindoChainCoinDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("WrappedJindoChainCoin_Dividend_Tracker", "WrappedJindoChainCoin_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "WrappedJindoChainCoin_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "WrappedJindoChainCoin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WrappedJindoChainCoin contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "WrappedJindoChainCoin_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "WrappedJindoChainCoin_Dividend_Tracker: Cannot update claimWait to same value");
