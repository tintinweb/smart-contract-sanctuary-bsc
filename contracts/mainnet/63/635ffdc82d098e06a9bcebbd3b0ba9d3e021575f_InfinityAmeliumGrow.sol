...
/*
   ...
   Great  features:
   1% fee auto liquidity
   4% fee for marketing and buyback ( will hard marketing)
   5% rewards fee
...
contract InfinityAmeliumGrow is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Infinity Amelium Grow";
    string constant _symbol = "HTAMEL";
    ...
    uint256 _totalSupply = 1000000000 * 10**24;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xcA8Ed9aC0F56C6d5aBecF2CaA149E4731d5c576b;
