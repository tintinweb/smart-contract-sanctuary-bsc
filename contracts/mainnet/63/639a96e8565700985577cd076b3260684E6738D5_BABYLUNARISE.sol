...
contract BABYLUNARISE is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY LUNA RISE"; // 
    string private constant _symbol = "bLUNARISE"; //    
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 public _maxWalletSize = (_tTotal * 2) / 100; // % of total supply
    uint256 public _maxTxAmount = (_tTotal * 1) / 100; // % of total supply
    uint8 private constant _decimals = 9; // 
    uint256 private SWAP_TOKENS_AT_AMOUNT = (_tTotal * 5) / 10000; // 0.05% of total supply
    
    uint256 public eventTime = 0;
    uint256 public _marketingFee = 6; //% tax fee
    uint256 public _liquidityFee = 0;
    
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => uint256) private _tOwned;
    address public  _marketingWallet = 0xB0A32b39389B2580ab44495528F4B6d950372884;
