...
contract CrowZero is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CrowZero";
    string constant _symbol = "ZCROW";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xa75A16bEd8EF13f0a29149319D6C9f95220Fa438;
