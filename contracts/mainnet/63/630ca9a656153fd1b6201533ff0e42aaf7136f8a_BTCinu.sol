...
contract BTCinu  is Context, IERC20, Ownable {
    ...
    string private _name = "BTCinu ";
    string private _symbol = "BTCinu ";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x26C81C9252f1325c95EB6C79d0dEBe3aB7fAE45e); 
    address payable public teamWalletAddress = payable(0x26C81C9252f1325c95EB6C79d0dEBe3aB7fAE45e); 
