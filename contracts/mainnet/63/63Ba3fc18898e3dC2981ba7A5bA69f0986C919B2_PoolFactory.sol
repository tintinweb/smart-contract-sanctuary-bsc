...
contract Smartpad is Ownable {
    ...
    address public tokenAddress; // purchase token address - normally BUSD
        ...
        returns (bool)
    {
        ...
        require(
            tierInfo[userTier].totalFundRaised <= tierInfo[userTier].maxCap,
            "Total Raised amount greater than tier max allocation"
        );
