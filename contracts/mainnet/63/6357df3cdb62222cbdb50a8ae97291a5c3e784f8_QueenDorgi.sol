...
/**
👑Queen's Dorgi is a community-powered that aims to give people control of their finances through four key utility offerings:
...
We believe meme tokens are the future. Queen's Dorgi will be an extensible project, not just a meme. Staking! The first step is staking, then an easy-to-use DEX and then AMM.

Be part of our growing community, King's and Queen's:
🌐https://queensdorgi.xyz/
📲https://t.me/QueensDorgiChat
*/
...
contract QueenDorgi is IERC20, Ownable {
