...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59F9a0DA47c2274E5E956b3E81A7d7e90B7EcF37; // owner address
...
contract NitroBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Nitro Bunny";
    string private _symbol = unicode"NITBUN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59F9a0DA47c2274E5E956b3E81A7d7e90B7EcF37); // Marketing Address
    address payable public teamWalletAddress = payable(0x59F9a0DA47c2274E5E956b3E81A7d7e90B7EcF37); // Team Address
