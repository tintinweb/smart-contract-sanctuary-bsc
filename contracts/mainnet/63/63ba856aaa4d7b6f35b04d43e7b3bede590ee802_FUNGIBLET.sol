...
contract FUNGIBLET is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xcd93bCcab5933A057C836047699cd3afB8c2226F;

    string private constant _name = "FUNGIBLE TOKEN";
    ...
    Taxes public taxes = Taxes(0,20,2,0);
