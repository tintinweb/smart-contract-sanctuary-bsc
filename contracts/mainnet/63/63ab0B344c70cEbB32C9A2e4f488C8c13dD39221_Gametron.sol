...
📱 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/GametronPortal

🌐 𝗪𝗘𝗕𝗦𝗜𝗧𝗘: http://gametron.club

🐦 𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/GametronCrypto

𝙍𝙀𝘾𝙀𝙄𝙑𝙀 𝙂𝙄𝙁𝙏 𝘾𝘼𝙍𝘿𝙎 𝘽𝙔 𝙃𝙊𝙇𝘿𝙄𝙉𝙂 💰
...
contract Gametron is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gametron";  
    string private constant _symbol = "GAMETRON";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _GametronMarketingTax = 4; 
    uint256 public _GametronLiquidityTax = 4; 
    address public  _marketing = 0x814BdD1474402835dA0BA18B4Af0F619e557E715;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        uint256 marketingFee = amount * _GametronMarketingTax / 100; 
        uint256 liquidityFee = amount * _GametronLiquidityTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _GametronLiquidityTax / (_GametronMarketingTax + _GametronMarketingTax);
