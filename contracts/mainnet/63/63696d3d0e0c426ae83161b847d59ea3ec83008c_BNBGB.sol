...
contract BNBGB is ERC20, Ownable {
    ...
    uint256 public  gameVaultFeeOnBuy;
    uint256 public  gameVaultFeeOnSell;
    ...
    constructor () ERC20("BNB Game Box", "BNBGB") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        gameVaultFeeOnBuy  = 5;
        gameVaultFeeOnSell = 5;

        _totalFeesOnBuy    = liquidityFeeOnBuy  + marketingFeeOnBuy + gameVaultFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + gameVaultFeeOnSell;

        walletToWalletTransferFee = 10;

        marketingWallet = 0xd902078dD929C1EBDc9545FEE15543fA64075212;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 marketingShare = marketingFeeOnBuy + marketingFeeOnSell + gameVaultFeeOnBuy + gameVaultFeeOnSell;
