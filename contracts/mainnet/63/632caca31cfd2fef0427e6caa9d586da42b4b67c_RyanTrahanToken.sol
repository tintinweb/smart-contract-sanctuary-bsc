...
// File: @openzeppelin/contracts/token/ERC20/extensions/RyanTrahan.sol
 ...
 */
interface RyanTrahan is IERC20 {
    /**
...
contract ERC20 is Context, IERC20, RyanTrahan {
...
contract RyanTrahanToken is ERC20 {
    constructor(
        string memory name_,
