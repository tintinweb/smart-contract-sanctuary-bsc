...
/**
Telegram https://t.me/DogiInuBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x776Ba94bEAddF3fF267C31EB84E6E22B9d5A1bB0; // owner address
...
contract DogiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogi Inu";
    string private _symbol = "DINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x776Ba94bEAddF3fF267C31EB84E6E22B9d5A1bB0); // Marketing Address
    address payable public teamWalletAddress = payable(0x776Ba94bEAddF3fF267C31EB84E6E22B9d5A1bB0); // Team Address
