...
/**
 https://twitter.com/VenomCrypto_/status/1551726755324592129#m

 https://t.me/venomgrow
*/
...
contract VenomGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Venom Grow Coin";
    string private constant _symbol = "VenomGrow";
    ...
    uint256 public swapTokenAtAmount = 425000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x3595CD67DB831fB0b4a99942BFE7276117849cEa);
    address private liquidityReceiver = address(0x3595CD67DB831fB0b4a99942BFE7276117849cEa);
