...
contract AITesla is Context, IERC20, Ownable {
    ...
    string private constant _name = "AITesla"; // 
    string private constant _symbol = " $AITESLA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x7673Fdc73Fc720594EeBAb8b42b73f82F3E433d2;
