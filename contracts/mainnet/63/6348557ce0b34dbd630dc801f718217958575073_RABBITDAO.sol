...
/*
    电报: https://t.me/RabbitDaoBSC
    欢迎来到 Rabbit DAO！兔子以其快速的繁殖速度着称，这就是兔子道的思想和原则的来源。这是一个社区驱动的项目
    ，旨在使用 Rabbit Dao 代币或 RDAO 创建分散的生态系统。
    我们的目标是通过我们独特的令牌经济学和有趣的奖励系统来复制持有者并迅速发展我们的社区。今年是兔年，我们一起建设和成长的一年！
*/
...
contract RABBITDAO is ERC20, Ownable {
    ...
    constructor() ERC20("RABBIT DAO", "RDAO") {
        ...
        devWallet = address(0x5e977EF918ec58338095F74643FB1C1A2f977D9A); 
