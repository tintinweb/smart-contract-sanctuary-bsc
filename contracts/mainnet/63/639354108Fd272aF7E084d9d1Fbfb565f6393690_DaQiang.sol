...
contract DaQiang is ERC20 {
	...
	address payable _fundAddress = payable(address(0x4B90571d54E8D8Ac597821E03354AB26CC1d2AA2)); //团队钱包地址
    ...
    constructor(address tokenOwner) ERC20("SM", "SM") { //定义token 名称和代号
		...
		BORNTOKEN = IERC20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A); //LP分红哪一种币
    ...
    function swapTokensForBorn(uint256 tokenAmount) private {
        ...
        path[2] = address(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A); //LP分红哪一种币
