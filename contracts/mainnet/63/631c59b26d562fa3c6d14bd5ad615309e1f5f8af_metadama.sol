...
Join metadama for all the latest fair launches and stealth launches.
...
contract metadama is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "metadama"; 
    string private _symbol = "metadama";  
