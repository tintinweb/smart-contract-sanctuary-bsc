...
contract QUANTERRA {
	...
	uint256[] public REFERRAL_PERCENTS = [200, 100, 50, 50, 50];
    ...
    uint256 constant public NFT_BOXES_STEP = 1000 ether; //1000 BNB
	...
	constructor(address payable wallet, address payable _developer, address payable _primaryBenificiary ) public {
        ...
        plans.push(Plan(21, 110)); // 11% per day for 21 days (at the end)
