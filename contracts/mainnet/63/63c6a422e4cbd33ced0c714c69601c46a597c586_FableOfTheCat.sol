...
/**
Telegram : https://t.me/fableofthecatt
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F5139bFcEa069f3ED95ccA3DDb8365C42feb391; // owner address
...
contract FableOfTheCat is Context, IERC20, Ownable {
    ...
    string private _symbol = "FabCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5F5139bFcEa069f3ED95ccA3DDb8365C42feb391); // Marketing Address
    address payable public teamWalletAddress = payable(0x5F5139bFcEa069f3ED95ccA3DDb8365C42feb391); // Team Address
