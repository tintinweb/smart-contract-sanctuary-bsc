...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 LIVES = IBEP20(0x94d424c8309694A283a7B75267Ce8944af9bB1Ee);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LIVES.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LIVES);
        ...
        uint256 amount = LIVES.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LIVES.transfer(shareholder, amount);
...
/* Token contract */
contract Subaru is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address LIVES = 0x94d424c8309694A283a7B75267Ce8944af9bB1Ee; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Buyback = 0x74F30D6C6E36b61d55df5b9B5477ABA698312e67;
    ...
    // Name and symbol
    string constant _name = "IMPREZA";
    string constant _symbol = "$SUBARU";
