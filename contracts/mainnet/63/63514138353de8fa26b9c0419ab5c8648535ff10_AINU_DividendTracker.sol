...
contract Arb_Inu is ERC20, Ownable {
    ...
    AINU_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xbF38Df11ce20160a1F9421d1649dbf26a6155D5C;
    ...
    Taxes public buyTaxes = Taxes(3, 3, 0);
    ...
    constructor() ERC20("Arb Inu", "AINU") {
        dividendTracker = new  AINU_DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        AINU_DividendTracker newDividendTracker = AINU_DividendTracker(
            payable(newAddress)
        );
...
contract AINU_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("AINU_Dividen_Tracker", "AINU_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "AINU_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "AINU_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "AINU_Dividend_Tracker: Cannot update claimWait to same value"
        );
