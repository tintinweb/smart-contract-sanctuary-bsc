...
contract Dissdoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dissdoge";
    string private _symbol = "Dissdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08b4B051df8250246CAe03639fe65AF596dBBC9B);
    address payable public teamWalletAddress = payable(0x26496cb44D90413d7a8821b26E7f9C088c504009);
