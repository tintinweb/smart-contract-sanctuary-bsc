...
contract Spaceshib is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TKS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xCD5894EE1541B66Ed09BA2AcB47cB2CFEc8E49bD);
    address payable private _marketingAddress = payable(0xCD5894EE1541B66Ed09BA2AcB47cB2CFEc8E49bD);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 6, "Redis cannot be more than 6.");
