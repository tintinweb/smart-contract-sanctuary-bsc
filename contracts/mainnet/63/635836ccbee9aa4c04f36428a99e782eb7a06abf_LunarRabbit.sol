...
contract  LunarRabbit is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunar Rabbit";
    string private _symbol = "LUNAR RABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e27c9CfA47E83F234152101B304C16230263CC2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3e27c9CfA47E83F234152101B304C16230263CC2); // BuyBack Address
