...
contract NewCommunityGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Comunity Gold";
    string private _symbol = "NCGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2fC96231F3c902A3eE51A433ff302c6C6B9D19A4);
    address payable public BuyBackWalletAddress = payable(0x2fC96231F3c902A3eE51A433ff302c6C6B9D19A4);
