...
library Address{
 ...
 contract Stop is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB0a025C0f0a7E01576E72156ac4eF9F93e9B7CfC;
    address public donationWallet = 0xB0a025C0f0a7E01576E72156ac4eF9F93e9B7CfC;

    string private constant _name = "CancelPutin";
    string private constant _symbol = " Xputin ";
