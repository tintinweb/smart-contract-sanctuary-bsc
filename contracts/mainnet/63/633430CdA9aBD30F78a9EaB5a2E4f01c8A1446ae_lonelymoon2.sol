...
contract  lonelymoon2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lonelymoon2.0";
    string private _symbol = "lonelymoon2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc782c467Ba904F86f8E1b9D35026F0c129C11E68);
    address payable public teamWalletAddress = payable(0xc927aC9dFFfc21F921ADDD28B8570613B9651Aa5);
    ...
    uint256 public _sellTeamFee = 80;
