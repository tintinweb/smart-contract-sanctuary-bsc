...
// CHANGE
contract PepeChu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PEPE CHU";
    string constant _symbol = "PCHU";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x694bFF4Df9eb1357A22BcbB175a527318ee54cFa);
