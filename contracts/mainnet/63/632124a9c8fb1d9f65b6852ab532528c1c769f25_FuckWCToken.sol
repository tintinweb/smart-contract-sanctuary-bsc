...
contract FuckWCToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fuck WC Token";
    string constant _symbol = "FWCT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD1D4ef8F4995C6ec937043bB270FA90edE29E33D;
        ecosystemfeeReceiver = 0xBBFBDAD272a6b2Cc77E1e63976fBa359d2f3e7e5;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _ecosystemfee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/1, "Fees cannot be more than 100%");
    }
