...
contract AnbeiKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AbeKiller";
    string private _symbol = "ABK";
    uint8 private _decimals = 12;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE8ff123A797ff17bCF98805004fc8Ab3d82DfB1E);
