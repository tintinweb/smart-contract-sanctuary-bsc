...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd2533222dEde3DAd88BEf0f80c3541C7610A2739; 
...
contract FaceShibInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FACE SHIB INU";
    string private _symbol = "FSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd2533222dEde3DAd88BEf0f80c3541C7610A2739); // 
    address payable public teamWalletAddress = payable(0xd2533222dEde3DAd88BEf0f80c3541C7610A2739); // 
