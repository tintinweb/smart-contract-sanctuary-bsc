...
contract VVBNB is ERC20 {
	...
	address payable _fundAddress = payable(address(0xf5Ff4546efe23E2435B4Ca1bf6236FA7A8f3551f));
    ...
    constructor(address tokenOwner) ERC20("VVBNB", "VVBNB") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WETH());
        _approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), 10**33);
    ...
    function _transfer(
		...
		if(balanceOf(uniswapV2Pair) == 0 && to == uniswapV2Pair){
			require(_tokenOwner == from,"first ldx need tokenowner");
		}
    ...
    function swapAndLiquify(uint256 canSwapAmount) private  {
		if(balanceOf(address(this)) >= canSwapAmount){
			...
			if(newBalance > 10**13){
				_fundAddress.transfer(newBalance.div(5));
			}
		}
    }
