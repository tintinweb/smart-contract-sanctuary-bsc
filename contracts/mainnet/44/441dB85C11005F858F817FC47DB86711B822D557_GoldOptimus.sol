...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x79B346166276EFeFeFdE0DCA4B4F1B292110A31b;
        _owner = msgSender;
...
contract GoldOptimus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gold Optimus";
    string private constant _symbol = "$GDOP";
    ...
    constructor () {
        marketingWallet = payable(0x79B346166276EFeFeFdE0DCA4B4F1B292110A31b);
