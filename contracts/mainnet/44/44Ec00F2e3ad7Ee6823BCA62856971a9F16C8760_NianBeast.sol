...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 200 * 10 ** IERC20(DividendToken).decimals();
       
        holderCondition = 888 * tokenDecimals;

        addLpProvider(ReceiveAddress);
       
        _limitAmount = 5 * tokenDecimals;
        
        _numToSell = 3000 * tokenDecimals;
    }
...
contract NianBeast is AbsToken {
