...
contract Dogemas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogemas";
    string private _symbol = "DMAS";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x8De6c6d3A7F9bc3B34a3Aa22f8ce2d0636564360); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8De6c6d3A7F9bc3B34a3Aa22f8ce2d0636564360); // BuyBack Address
