...
contract TKNStake {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [1 days, 7 days, 30 days, 60 days];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0x1f10727c99297282c5420d8c702533eEe9cD28aB; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x9d2043547C57a4ce4Aebe19b1B4f283b6Ea38b51); // TKN Token address 
