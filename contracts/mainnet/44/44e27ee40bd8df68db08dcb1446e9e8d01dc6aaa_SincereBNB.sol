...
contract  SincereBNB is ERC20 {
   ...
   bool public swappingTwo;
    ...
    address public market = 0xea08B0bBF1631DF12562AED722b205896927B453;
    mapping(address => bool) public isbook;
      uint256 private _maxTxAmount = 1 * 10**6 * 10**2;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     address public owe = 0x3c09c611F45be53b4b162773aB80440b6385E8E8;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x4fA98337341A0Af99c11B43D478e2f244610e861;


    constructor() public ERC20("SincereBNB", "SincereBNB",2) {
