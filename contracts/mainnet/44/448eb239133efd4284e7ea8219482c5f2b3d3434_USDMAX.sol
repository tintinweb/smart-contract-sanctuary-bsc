...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x85e3c9C4B21De4a6fAe4804d55Ca3B8442A8e8EE;
        _owner = msgSender;
...
contract USDMAX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address public marketingAddress = 0x85e3c9C4B21De4a6fAe4804d55Ca3B8442A8e8EE; // Marketing wallet Address.
    ...
    uint256 private _tTotal = 130_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "USDMAX";
    ...
    uint256 public _maxTxAmount = 130_000_000 * 10**18;
