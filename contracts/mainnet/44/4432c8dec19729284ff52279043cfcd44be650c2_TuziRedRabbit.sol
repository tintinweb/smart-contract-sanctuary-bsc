...
/**
祝您在新的一年里好运，身体健康，事业有成，心情愉快。 2023 年农历新年快乐！
 # 社区 : https://t.me/TuziRedRabbit
...
contract TuziRedRabbit is Context, IERC20 { 
    ...
    mapping (address => bool) public _isOutcludedFromFee;
    ...
    address payable public constant dead = payable(0x000000000000000000000000000000000000dEaD);
    address payable public projectWallet = payable(0x66E5e64bFdd0de7378194FfAD90659939A983866);    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 6* 10**6 * 10**_decimals;
    string private constant _name = "Tuzi Red Rabbit"; 
    ...
    bool public maxTransactionLimit = true;
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0x66E5e64bFdd0de7378194FfAD90659939A983866;
    ...
    function _transfer(
        ...
        if (from != owner() && !_isExcludedMaxTransactionAmount[from]){
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            _tOwned[dead] = _tOwned[dead] + tokens_to_Burn;
            ...
            sendToWallet(projectWallet, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(projectWallet, BNB_Total);
    ...
    function sendTo(address recipient, uint256 tAmount) private{
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(projectWallet, removeRandom);
