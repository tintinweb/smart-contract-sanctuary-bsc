...
╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝╚══════╝╚══════╝     ╚═════╝ ╚═╝          ╚═════╝╚═╝  ╚═╝   ╚═╝   ╚═╝        ╚═╝    ╚═════╝      ╚═════╝ ╚══════╝╚═╝     ╚═╝╚══════╝
 ...
 ______        __                            _           
/_  __/ ___   / /__ ___   ___  ___   __ _   (_) ____  ___
 / /   / _ \ /  '_// -_) / _ \/ _ \ /  ' \ / / / __/ (_-<
/_/    \___//_/\_\ \__/ /_//_/\___//_/_/_//_/  \__/ /___/

- 1 % : Reflection (Anti Dump Mechanism)                                            
- 4 % : Marketing
- 1 % : Dev
- 9 Decimal 

TOTAL_SUPPLY : 5000000
swapTokensAtAmount : 5000;
maxBuyLimit = 5000
maxSellLimit = 5000000
maxWalletLimit = 5000000
...
//SLIPPAGE WALLETS
marketingWallet = 0xE608794bc746d1Feedb5A8396882ED68652489e4;
devWallet = 0xD290e769045be368A2FEe69D94C5fcb9abe4e84d;


FEATURES :
- ANTIBOT
- TRADING ON/OFF
- COOL DOWN TIMES + ON/OFF
- SWAP ON/OFF
...
contract MinesCryptoGems is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5e3 * 10**_decimals;
    uint256 public maxBuyLimit = 5e6 * 10**_decimals;
    uint256 public maxSellLimit = 5e6 * 10**_decimals;
    uint256 public maxWalletLimit = 5e6 * 10**_decimals;
    
     uint256 public genesis_block;

    address public marketingWallet = 0xE608794bc746d1Feedb5A8396882ED68652489e4;
    address public devWallet = 0xD290e769045be368A2FEe69D94C5fcb9abe4e84d;


    string private constant _name = "MinesOfCryptoGems";
    ...
    Taxes public taxes = Taxes(1, 4, 0, 1);
    ...
    function _takeDev(uint256 rDev, uint256 tDev) private {
        ...
        {
            _tOwned[address(devWallet)]+=tDev;
        }
