...
Telegram: https://t.me/onlywhaleofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xb8617705cAe1D41172453ec1b3e420C80c7fc4bf;
...
contract ONLYWHALES is Context, IERC20, Ownable {
    ...
    string private constant _name = "ONLY WHALES COIN"; // 
    string private constant _symbol = "$WCOIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xb8617705cAe1D41172453ec1b3e420C80c7fc4bf);
