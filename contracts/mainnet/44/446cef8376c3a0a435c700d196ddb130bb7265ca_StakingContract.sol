...
contract StakingContract is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _genToken, address _busdToken) initializer public {
        ...
        busdWallet = 0xebd2610D808e173098274d490c6857603f567E10;
        preSaleWallet = 0x6783db6859A1E971d07035fC2dA916b94c314E51;
        treasuryWallet = 0xebd2610D808e173098274d490c6857603f567E10;
    ...
    function sellAreenaByBusd(uint256 _tokenAmount) external {
        ...
        if ((busdToken.balanceOf(busdWallet) + (90000 * 1e18)) >= uppermileStone) {
            ...
            require(allowedAmount >= sendAmount, 
                "Owner must have allowed the contract 1 to spent that particular amount of BUSD coins.");           
