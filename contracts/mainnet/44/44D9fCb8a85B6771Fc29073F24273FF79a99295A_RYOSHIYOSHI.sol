...
/**
RYOSHIYOSHI IS A TAX FREE TOKEN
THERE WILL BE NO TG NEXT CONTACT WILL BE UNANNOUNCED BUT YOU WILL NOTICE IT!
...
contract RYOSHIYOSHI is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'RYOSHIYOSHI';
    ...
    uint256 swapThreshold = ( _totalSupply * 750 ) / 100000;
