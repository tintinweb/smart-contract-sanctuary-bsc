...
/**TG: https://t.me/TWITTERINU0FFICIAL
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  Binancegrow = IBEP20(0xa3EfA42205bBa588Cbde472B8690fA8252ba2Ef7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Binancegrow .balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Binancegrow);
        ...
        uint256 amount = Binancegrow.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Binancegrow.transfer(shareholder, amount);
...
contract Twitterinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xCD429360f2BF79669Af865984715a6674d848b99;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Twitter inu";
    string constant _symbol = "TWINU";
    ...
    uint256 public marketingFeeSell = 21;
    uint256 public devFeeSell = 7;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xBDcB55E087b41ed144E02bc7aA7f70fBD42df843;
