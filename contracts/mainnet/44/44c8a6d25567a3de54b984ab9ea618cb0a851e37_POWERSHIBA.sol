...
contract POWERSHIBA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0A77DFe9E000616fB702FC618255F361B8F2E708); 
    address payable public DevWalletAddress = payable(0xA0d07F86562d56df90d2230B617d360d215E8B2E); 
    ...
    uint256 public _walletMax = 20000000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 900000000000 * 10**9;
