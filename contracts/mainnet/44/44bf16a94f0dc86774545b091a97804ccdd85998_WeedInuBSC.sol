...
Weed Inu ($WEED) is a community-focused, decentralized cryptocurrency with its upcoming NFT, and utility aiming to establish global marketplace for cannabis Industry. We intend to facilitate a direct relationship between the buyer and the seller, cannabis store through the use of blockchain technology. Thereby creating unique opportunities for Cannabis farmers, and sellers in developing nations and these affected by macro economic factors.
...
contract WeedInuBSC is IERC20, Ownable {
