...
// File: https://github.com/tamerabdalftah/Solitidy-contracts/blob/03078f07727b75b480ce9415c7eae4ac2bc5af79/BULLSClub.sol
...
contract BULLSClub is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("BULLSClub", "BULLSC") { 
...
contract BULLSNFTStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, BULLSClub _token) { 
    nft = _nft;
    token = _token;
  }
...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = 50000 ether * (block.timestamp - stakedAt) / 86400 ;
