...
contract SMBStableSwapTwoPool is Ownable, ReentrancyGuard {
...
contract SMBStableSwapTwoPoolDeployer is Ownable {
    uint256 public constant N_COINS = 2;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SMBStableSwapTwoPool).creationCode;
        ...
        SMBStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
