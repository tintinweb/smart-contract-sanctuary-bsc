...
// CHANGE
contract BonzoInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Bonzo Inu";
    string constant _symbol = "BONZO";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xBEF6b5cF17A4A8adc693FC645Fb79B77BeD16765);
