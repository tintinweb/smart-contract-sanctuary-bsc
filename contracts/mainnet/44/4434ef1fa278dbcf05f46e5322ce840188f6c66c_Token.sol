...
contract FancyTribe is Ownable {
    using SafeMath for uint256;

    string constant public name = 'FancyTribe';

    string constant public symbol = 'TFTB';
    ...
    address public projectAddress = 0xe20A48efA9481b7CfEC61f79be00423B07A10DD6;
    ...
    function Launch() public onlyowneres {
        isLaunch = true;
    }
