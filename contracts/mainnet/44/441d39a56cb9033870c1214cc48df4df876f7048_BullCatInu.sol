...
contract BullCatInu is IBEP20, Auth {
    ...
    uint256 liquidityFee    = 3; // Auto Burn
    uint256 reflectionFee   = 2;
    uint256 public totalFee = 5; //Total Fee
    uint256 feeDenominator  = 100;

    uint256 liquidityFeeBuy    = 1; // Auto Burn
    ...
    uint256 liquidityFeeSell    = 1; // Auto Burn
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE1a897080b068c3e6269f50B58B63D3F3b097E16;
        teamFeeReceiver = 0xE1a897080b068c3e6269f50B58B63D3F3b097E16;
        giveawayFeeReceiver = 0xE1a897080b068c3e6269f50B58B63D3F3b097E16;
