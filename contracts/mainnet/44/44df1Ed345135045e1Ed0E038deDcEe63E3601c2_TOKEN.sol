...
//https://t.me/cryptoscamelontweet
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C81C5B730d6Ee2Bb94A1Cb9ECB82C087B4569eE;
...
contract TOKEN is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x5C81C5B730d6Ee2Bb94A1Cb9ECB82C087B4569eE);
    ...
    string private _symbol = "Crypto Scam";  
    ...
    uint256 private BLOK= 99; //BLOK 0
    ...
    function set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external authorized() {
        ...
        require((Buy_Fee + Sell_Fee) <= BLOK, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
