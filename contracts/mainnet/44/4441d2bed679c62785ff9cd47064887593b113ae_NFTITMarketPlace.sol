...
import "./NFTITERC721.sol";
import "../interface/IBEP20.sol";

contract NFTITMarketPlace is
    Initializable,
    PausableUpgradeable,
    ...
    IERC721ReceiverUpgradeable
{
    ...
    function initialize(
        ...
        tokenContract = NFTITERC721(_tokenAddress);
    }
    ...
    function finaliseFixedPriceAuction(uint256 orderId)
        external
				payable
        nonReentrant
        whenNotPaused
        isValidOrderId(orderId)
    {
        ...
        require(
            msg.value >= currFees + currAuctionOrder.price,
        ...
        //Transfer Fees to the feeAddress
				(bool feesSent,) = feeAddress.call{value:currFees}("");
				require(feesSent,"Fee Transfer Failed");

        //Transfer amount to seller after deducting loyalties
				(bool sellerSent,)=currAuctionOrder.seller.call{value:netSalePrice}("");
    ...
    function bidOnUnlimitedAuction(uint256 orderId)
        external
				payable
        nonReentrant
        whenNotPaused
        isValidOrderId(orderId)
    {
        ...
        require(
            currAuctionOrder.price <= msg.value,
        ...
        if (
            ...
            //Return to the last highest bidder
						(bool bidReturned,)=currBidDetails.bidderAddr.call{value:currBidDetails.bidAmount}("");
						require(bidReturned,"Error in Returning last bid");
        }

        //Update Minimum Bid value to the latest bid.
        currAuctionOrder.price = msg.value;
				auctionOrders[orderId]=currAuctionOrder;
        ...
        OnlySeller(orderId)
    {
        ...
        //Unlimited Auction cancel
            ...
            delete tokenBids[orderId];
						...
						(bool bidReturned,)=currBidDetails.bidderAddr.call{value:currBidDetails.bidAmount}("");
						require(bidReturned,"Error in cancelled auction bid");
        }
				tokenContract.safeTransferFrom(address(this), currAuctionOrder.seller, currAuctionOrder.tokenId);
