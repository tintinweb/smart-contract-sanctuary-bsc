...
contract QuizAI is ERC20, Ownable {
    ...
    function swapAndSendTokens(uint256 tokenAmount) private {
        uint256 initialBalance = address(this).balance;
        ...
        uint256 marketingShare = (marketingFeeOnBuy + marketingFeeOnSell) / tokenAmount;
