...
/*
  DroneX - DRNX Token
  Drone technologies and the Drone development sector, one of the leading technological
  structures of the future, are growing day by day. Drone developers have to keep their
  codes reliable. It is very important to use a reliable network structure, especially
  in military drone and defense industry drone technologies. DroneX is designed to make
  drone technologies 100% reliable by using the infrastructure of blockchain technology.
  Using the DroneX development libraries, developers can synchronize their drone programming
  with their blockchain infrastructure.

  Utility Token
  Total Fee: 5%
  Slippage: 6%

  Twitter: @DroneXOfficial
  Telegram: @DroneXOfficial
  Website: dronex.network
*/
...
contract DroneX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 330000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DroneX";
    string private _symbol = "DRNX";
    ...
    address public charityWallet = 0x49Ce7B3F4E9B4126EC1E6Ef293F01818Fc0037D5;
    ...
    uint256 public numTokensSellToAddToLiquidity = 3300000 * 10**9;
    uint256 public _maxTxAmount = 330000000 * 10**9;
