...
contract Xiaoc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(msg.sender); // Marketing Address
    ...
    uint256 public maxBuyAmount = 5000000000000;
    uint256 public maxSellAmount = 2000000000000;
    uint8 private constant _decimals = 18;
    
    string private constant _name = "Xiaoc";
    string private constant _symbol = "$Xiaoc";
...
//   Changeable /lower/higher after the launch  
 ...
 //  Changeable /lower/higher after the launch  
    ...
    uint256 public _maxWalletToken = 4000000000 * 4; // 4%
    uint256 public maxTxnAmount = 3000000000 * 3; // 3%
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x4f3838C3AEc3D56d791535051044296c09a5905A).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x4f3838C3AEc3D56d791535051044296c09a5905A).call{value: bnbForTeam2}("");
        ...
        onlyOwner
    {
        ...
        emit SetSellFee(sellMarketingFee, sellLiquidityFee, sellTaxFee, sellTeamFee);
         // this to control the dump during launch but it will be adjusted
    }
