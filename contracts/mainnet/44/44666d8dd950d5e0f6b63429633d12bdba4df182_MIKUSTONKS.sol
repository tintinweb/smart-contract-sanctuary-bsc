...
/**
MIKU STONKS | Namely Token Meme Project Based on Binance Smart Chain. We Adhere to the Anti Whale System and Deflationary tokens which are getting more valuable and rare by the day
...
contract MIKUSTONKS is Context, IERC20, Ownable {
    ...
    string private _name = "MIKU STONKS";
    string private _symbol = "MKS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x5EAA33a05B72fe8FB8F7A3f45ac4eBeAb5B2CBe6);
