...
/** 
    ...
    LunarWhale（月亮鲸）是一种基于币安智能链的代币，专为中国的加密货币经济社区而设计。 LunarWhale 的设计具有实用功能，因为它可以转换为 Lunar 智能链 dApp 和服务的高级会员级别。凭借其通货紧缩经济、流动性池和 DeFi 基础设施，LunarWhale 为中国加密货币市场的主流采用创造了途径。

    LunarWhale (月亮鲸) is an Binance Smart Chain based token designed to community of the cryptocurrency economy in China. LunarWhale is designed with a utility function as it can be converted into premium membership levels on Lunar Smart Chain dApps and services. With its deflationary economy, liquidity pools, and DeFi infrastructure, LunarWhale creates a pathway for mainstream adoption in the Chinese crypto market.

    https://t.me/LunarWhaleOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F1314c584Ad93928240DbFB7F3f2D24799956cb; // WHALES
...
contract LunarWhale is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LunarWhale";
    string private _symbol = unicode"月亮鲸";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2F1314c584Ad93928240DbFB7F3f2D24799956cb); // whales
    address payable public teamWalletAddress = payable(0x2F1314c584Ad93928240DbFB7F3f2D24799956cb); // whales
