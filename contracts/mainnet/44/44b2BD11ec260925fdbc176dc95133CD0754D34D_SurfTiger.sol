...
contract Ownable is Context {
    address private _owner = 0x83ba12f723B09048Eb91353D4Df3C248d1653187;
...
contract SurfTiger is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x199533FD7B90c895f089e1f3fe1eB609352694c9); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Surf Tiger"; // token name
    string private _symbol = "ST"; // token symbol
    ...
    uint256 public _liquidityFee = 10; // liquidity fee 5%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 5000 * 10**4 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
