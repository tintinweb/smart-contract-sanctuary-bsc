...
contract HIROKI is Context, IBEP20, Ownable {
    ...
    string public _name = "Hiroki"; // token name
    string public _symbol = "HIROKI"; // token ticker
    ...
    uint256 private minTokenToSwap = 10000000000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 1000000000000 * 1e9;
    uint256 private minBuyLimit = 1000000000000 * 1e9;
