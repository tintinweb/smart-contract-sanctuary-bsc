...
contract OnlyoneChina is Context, IERC20, Ownable {
    ...
    string private constant _name = "onlyoneChina";
    string private constant _symbol = "OnlyoneChina";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x892Aa67c27d5A8f1d8d5b875857271bC867c786C);
    address payable private _marketingAddress = payable(0x892Aa67c27d5A8f1d8d5b875857271bC867c786C);
