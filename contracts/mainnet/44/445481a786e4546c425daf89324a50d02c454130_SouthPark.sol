...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    bool initialized;
    uint8 public _taxFee = 100;
    uint8 public _previousTaxFee = 100;
    uint8 public _liquidityFee = 24;
    uint8 public _previousLiquidityFee = 24;
    uint8 public _rewardFee = 144;
    uint8 public _previousRewardFee = 64;
...
contract SouthPark is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'SouthPark';
  string private constant _symbol = 'SouthPark';
