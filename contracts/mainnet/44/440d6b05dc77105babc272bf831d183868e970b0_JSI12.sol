  ...
  struct UserData {
    ...
    function register(uint256 userid,uint256 upline) public {
        ...
        if(user.userid==0){
			...
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline3,amount.div(110).mul(10));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline4,amount.div(110).mul(5));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline5,amount.div(110).mul(5));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline6,amount.div(110).mul(5));
			IERC20(BUSD).transferFrom(address(msg.sender),user.upline7,amount.div(110).mul(5));
