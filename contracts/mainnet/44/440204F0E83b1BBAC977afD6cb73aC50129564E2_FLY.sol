...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function AMP(uint256 amount) public onlyOwner {
    AMP(msg.sender, amount);
    }
    ...
    function AMP(address account, uint256 amount) internal virtual {
...
contract FLY is ERC20 {
    ...
    uint tokenTotalSupply = 10000000000; //   Fly Coin FLY AMP
    
    constructor() public ERC20("Fly Coin", "FLY") {
        AMP(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}