...
contract MrBeastFandom is IBEP20, Ownable {
    ...
    string constant _name = "MrBeastFandom";
    string constant _symbol = unicode"MRBEAST";
    ...
    address private marketingWallet = 0xA1f6895eF9eC24355e2b2E7aB65406539984b886;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 6, 2, 0);
    Fees public sellFees    = Fees(1, 6, 2, 0);
