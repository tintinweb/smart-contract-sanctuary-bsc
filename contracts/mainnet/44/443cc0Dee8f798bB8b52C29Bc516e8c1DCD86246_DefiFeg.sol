...
contract DefiFeg is ERC20 {
	...
	address payable _receive = payable(address(0xb650e47Bcf0C220cc06C2C0c676DD0b5E2147468));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("SpaceX", "SpaceX") {
