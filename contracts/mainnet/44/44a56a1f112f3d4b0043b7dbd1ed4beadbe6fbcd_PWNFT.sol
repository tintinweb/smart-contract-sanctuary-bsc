...
private group: https://t.me/+TH7qjQdJT9c1ZDRl

PokeWorld NFT is a project committed for pokemon lovers. We will be making our very own NFT's that
will give out rewards when you hold them. Each NFT will start at the price of .1-.25 bnb depending 
on its rarity. The price of each NFT will increase the higher the demand it gets, this is to give 
more opporunity for the early investors who invested in the project.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x725Ebfa0eFaC2b90165E266B97f6B75b7fe5C2C1;
...
contract PWNFT is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x584a61ab9ff192c43d3C7203ded404d3c7f18916);
    ...
    */
    ...
    string private _name = "PokeWorld NFT"; 
    string private _symbol = "PWNFT";  
