...
contract GameFederation is Context, IERC20, Ownable {
    ...
    string private constant _name = "Game Federation";
    string private constant _symbol = "GFT";

    address public _PancakeSwapV1RouterUniswap = 0x9342f9e838445056F9F5E6609407B8cFD5c432fe; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x9342f9e838445056F9F5E6609407B8cFD5c432fe; //can be the same

    uint256 private _tTotal = 290000000 * 10**_decimals;
