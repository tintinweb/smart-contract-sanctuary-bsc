...
contract Nimbacoin is Context, IERC20, Ownable {
    string private _name = "NIMBACOIN";
    string private _symbol = "NIMBACOIN";
    uint8 private _decimals = 18;

    uint256 private _tTotal = 500000000  * 10**18;
    address private marketingWallet = 0x2cB0b1DeC7FBd203406C3551535B695bd5885f7E;
    ...
    function setMarketingFeeWallet(address newAdd) external onlyOwner() {
    ...
    function _takewallet(uint256 twallet) private {
        ...
        if(_isExcluded[marketingWallet])
            _tOwned[marketingWallet] = _tOwned[marketingWallet].add(twallet);
    }
