...
contract WhiskasInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whiskas Inu";
    string private _symbol = "WINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x963c409066b8779839334cCF9E12db75E8Bf786b); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x963c409066b8779839334cCF9E12db75E8Bf786b); // buyback Address
