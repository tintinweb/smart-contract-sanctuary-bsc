...
contract BUpgrade1 is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    IPancakeRouter02 private pancakeV2Router;
    address public pancakeswapPair;

    string private constant _name = "B Upgrade 1";
    string private constant _symbol = "BUpgrade1";
    ...
    function setExcludeFromFees(address _address) external  onlyOwner {
