...
// File contracts/Bell.sol

pragma solidity 0.8.9;



contract Bell is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the Bell ERC-20 contract.
     */
    constructor() ERC20("Bell", "Bell") {
        _mint(msg.sender, 100000000 ether);
    }

    /**
     * @notice Operator mints Bell to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of Bell to mint to
