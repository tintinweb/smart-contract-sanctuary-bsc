...
contract YFVDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YFVDAO";
    string private _symbol = "YFVDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x94Fd40Bf065A432a631cbfeEdc90f6854EdCAC66);
    address payable public teamWalletAddress = payable(0x94Fd40Bf065A432a631cbfeEdc90f6854EdCAC66);
    address public immutable deadAddress = 0x94Fd40Bf065A432a631cbfeEdc90f6854EdCAC66;
