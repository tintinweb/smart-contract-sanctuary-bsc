...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public starBlock = 1669816800;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.timestamp < starBlock + kb && !_swapPairList[to]) {
                    _BOTList[to] = true;
                }
                if (_swapPairList[to]) {
                    if (!inSwap) {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                if (block.timestamp < 1800 + starBlock) {
                    swapFee = 2000;
                } else {
                ...
                if (block.timestamp < 1800 + starBlock) {swapFee = 1000;} else {
    ...
    function multiBOT(address[] calldata addresses, bool value)
        public
        onlyOwner
    {
...
contract TOKEN is AbsToken {
    constructor()
        AbsToken(
            ...
            18,
            100000000000000,
            address(0x19B5a6a0fBC5d649835aC16493f24eD2547a6F7C),
            address(0x160fF25d28213AcBf8FB9ab1Bf8664a1C590F9eB)
        )
    {}
}