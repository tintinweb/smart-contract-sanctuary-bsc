...
IERC20 constant DDDDS = IERC20(0xB51db11D8a32450da0b842955d5dDad06dD05167);
...
contract Bank is Owned {
    ...
    function deposit(uint256 amount) external {
        ...
        uint256 dddsAmount = (amount * price) / 1 ether;
        if (dddsAmount > 0) {
            DDDDS.transferFrom(msg.sender, RECEIVER, dddsAmount);
        }
