...
/**
 *Submitted for verification at BscScan.com on 2022-03-012
*/

// Submitted for Telegram: https://t.me/birdscerealcoin
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BCCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Birds Cereal Coin ";
    string private _symbol = " BCCOIN' ";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfcA8DC2ede3f54750078695617A8B026AaA9BE38);
    address payable public teamWalletAddress = payable(0xfcA8DC2ede3f54750078695617A8B026AaA9BE38);
