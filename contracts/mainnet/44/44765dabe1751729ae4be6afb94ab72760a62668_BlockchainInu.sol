...
BlockChain Inu is an ambitious project dedicated to the establishment 
of a truly decentralized Internet and its infrastructure. 
BlockChain Inu  is the blockchain-based operating systems, 
 offers public blockchain support of high throughput, 
 high scalability, and high availability for all Decentralized Applications 
 (DApps) with BlockChain Inu token will be the core of whole ecosystem.


✅TAX 10% BUY/SELL
🌐Website: http://Blockchaininu.io
 *
*/
...
contract BlockchainInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Blockchain Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC9d3473Ef4d1994E103679e929abB44Af582EDAb;
