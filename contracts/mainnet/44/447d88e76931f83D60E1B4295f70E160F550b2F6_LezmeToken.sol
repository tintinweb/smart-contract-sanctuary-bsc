...
import "./supports/LezmeSupportToken.sol";

contract LezmeToken is ERC20, Ownable, LezmeSupportToken {
	constructor() ERC20("LEZME", "LEZME")
	{
	...
	override
	{
		...
		require(blackListWallet[from] == false, "ERC20: wallet from is blacklist");
		require(blackListWallet[to] == false, "ERC20: wallet to is blacklist");
...
abstract contract LezmeSupportToken is Ownable {
	...
	*/
	function clearUnknownToken(address _tokenAddress) public onlyOwner {
		uint256 contractBalance = ERC20(_tokenAddress).balanceOf(address(this));
		ERC20(_tokenAddress).transfer(address(msg.sender), contractBalance);
	}
