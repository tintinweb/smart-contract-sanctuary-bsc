...
/*
   ...
   3BNB Initial LP
   OWNERSHIP RENOUNCED
   TG GROUP：https://t.me/WeAreDegeners
...
contract WeAreDegeners is IBEP20, Ownable {
    ...
    string constant _name = "We Are Degeners";
    string constant _symbol = "DEGENERS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100;  //100% max tx
    ...
    address public marketingFeeReceiver = 0x046a835F053A76954B2d2E0587965Ac6B9aD6175;
