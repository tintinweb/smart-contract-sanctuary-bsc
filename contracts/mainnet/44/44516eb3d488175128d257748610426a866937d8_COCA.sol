...
// File: default_workspace/Cyber Soccer.sol
...
contract COCA is ERC20, Ownable{
    ...
    Taxes public sellTaxes = Taxes(1, 2);
    ...
    constructor() ERC20("Cyber Soccer", "COCA") {
        _mint(msg.sender, 48e11 * 10 ** decimals());
    ...
    function setBuyTaxes(uint128 _marketing, uint128 _liquidity) external onlyOwner{
        buyTaxes = Taxes(_marketing, _liquidity);
        totalBuyTax = _marketing + _liquidity;
    }

    function setSellTaxes(uint128 _marketing, uint128 _liquidity) external onlyOwner{
        sellTaxes = Taxes(_marketing, _liquidity);
        totalSellTax = _marketing + _liquidity;
    }
