...
/**
The first-ever NFT play to win game will have daily surprises for the lucky winners in BNB. With a built-in dapp, mint and marketplace the process will be fun and very transparent. A P2E game of its own kind.


TELEGRAM:  https://t.me/arabiankishu
*/
...
contract ARABIANKISHU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ArabianKishu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xFa3F86a4EE1d742B97C378b50D24Bc60c3Fc2bE3;
