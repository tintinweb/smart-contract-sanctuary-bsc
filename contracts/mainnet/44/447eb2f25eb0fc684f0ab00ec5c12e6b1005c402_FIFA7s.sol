...
⚽️ FIFA 7s ⚽️
FIFA 7s Is A Token With Lp Lock 77 years Renounced, Low Tax And Base On CZ Tweet.
...
contract FIFA7s is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8196315a7158331cF2a46629A049373D89dA11De); 
    address payable public Wallet_Dev = payable(0x8196315a7158331cF2a46629A049373D89dA11De);
    ...
    string private constant _name = "FIFA 7s"; 
    string private constant _symbol = unicode"7s"; 
    ...
    constructor () {
        ...
        _owner = 0x8196315a7158331cF2a46629A049373D89dA11De;
