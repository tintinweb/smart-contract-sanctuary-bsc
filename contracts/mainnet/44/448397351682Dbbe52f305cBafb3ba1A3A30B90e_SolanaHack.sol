...
/**
 *https://t.me/solanahackbsc

 https://twitter.com/solanahack
...
contract SolanaHack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SolanaHack";
    string private _symbol = "SolanaHack";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35e06e3687B85F5A1de81c7A487d7Ad4DA484525);
    address payable public teamWalletAddress = payable(0xAf9B1dbB17aD38F9c5EdEaAD84ffa84201387a83);
