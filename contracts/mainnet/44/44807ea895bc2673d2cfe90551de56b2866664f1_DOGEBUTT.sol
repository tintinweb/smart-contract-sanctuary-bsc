...
contract DOGEBUTT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEBUTT";
    string private _symbol = "DOGEBUTT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9AFa1f05A1e998c5C13ce2de6fF421b4ec12fb82); // Marketing Address
    address payable public DevWalletAddress = payable(0x5DF5Dce26650DE2187a7A1f422CdBE2a9357335a); // Dev fee
