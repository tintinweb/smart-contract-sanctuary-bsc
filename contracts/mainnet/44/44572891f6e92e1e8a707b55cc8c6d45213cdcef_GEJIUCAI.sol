...
contract GEJIUCAI is ERC20, Ownable {
    ...
    address public burnToken = 0x0065263073b38ae476eee248B0b393C44C8c2A1b;
    ...
    constructor() ERC20("GEJIUCAI", "GEJIUCAI") {
        if (block.chainid == 56) {
    ...
    function _swap() private lockSwap {
        ...
        swapTokensForSPACEDOGEQUEEN(balanceOf(address(this)), deadWallet);
    }
    ...
    function swapTokensForSPACEDOGEQUEEN(uint256 tokenAmount, address recipient)
        private
    {
        if (tokenAmount == 0) return;
        // generate the uniswap pair path of token -> weth
