...
contract FrogeCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x99b5dA30FD503e5B8816423f00bAF7339544f8a6); // Marketing Address
    ...
    uint256 private _tTotal = 1000000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FrogeCoin";
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**2 * 10**9;
