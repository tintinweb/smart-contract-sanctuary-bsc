...
contract GALAExclamation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GALA!!!";
    string private _symbol = "GALA!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5fDc07524A5af7226F04192E23bC9dF9F3907690); // Marketing Address
