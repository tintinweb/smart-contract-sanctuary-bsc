...
/**
 *  电报: https://t.me/xingyuninuofficial
    兔年到了，让我们一起庆祝。为今年的希望祈祷。市场胜利了，让我们用幸运兔的推出来庆祝吧。别忘了买！！！
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x21F21e24f41d90211469a58c4B356B96d6B93526; // owner address
...
contract XingyunInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XINGYUN INU";
    string private _symbol = unicode"幸运兔";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21F21e24f41d90211469a58c4B356B96d6B93526); // 
    address payable public teamWalletAddress = payable(0x21F21e24f41d90211469a58c4B356B96d6B93526); // 
