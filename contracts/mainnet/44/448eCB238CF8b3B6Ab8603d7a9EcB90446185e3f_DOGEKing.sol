...
contract DOGEKing is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "DOGE KING";
    ...
    address private marketingWallet = address(0x780d0Ae2ab7638Dc3D7A1EdB21a9BB8ae3154376);
    address private liquidityReceiver = address(0x780d0Ae2ab7638Dc3D7A1EdB21a9BB8ae3154376);
