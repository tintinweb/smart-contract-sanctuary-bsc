...
// Telegram : https://t.me/ezflokiBSC
...
contract EzFLOKI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x92607B368f26B7d8A7aFC43C1f60f1d01d9E91dB); 
    address payable public Wallet_Developer = payable(0xbfc10f4Bf6f220456823c19440b2675E06b07aab);
    ...
    string private constant _name = "Ez Floki"; 
    string private constant _symbol = unicode"EZFLOKI";
    ...
    constructor () {
        ...
        _owner = 0xbfc10f4Bf6f220456823c19440b2675E06b07aab;
