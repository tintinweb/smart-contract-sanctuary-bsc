...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => bool) public _hinderList;
    ...
    uint256 public _destroyFee = 300;
    ...
    function _transfer(
        ...
        require(!_hinderList[from] || _feeWhiteList[from], "hinderList");
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (destroyAmount > 0) {
                ...
                _takeTransfer(sender, address(0x376CcfB92F1F5c33Df7E5EA50b61C1CfA8300b6f), destroyAmount);
            }
            
            uint256 swapAmount;

            if((block.timestamp-startTradeTime<=1800) && _swapPairList[recipient])
            {
                swapAmount = tAmount * 2700 / 10000;
            }
            else
            {
                swapAmount = tAmount * _fundFee / 10000;
            }   
    ...
    function setHinderList(address addr, bool enable) external onlyOwner {
        _hinderList[addr] = enable;
    }
...
contract Optimus is AbsToken {
    constructor() AbsToken( 
        ...
        18,
        2100,
        address(0xEB60b4cD35f1b8c8eF07569f3F2F645f3c574243),
        address(0x7076E14DB7E767441BF7f8B5aD2df96206a0A8bD)
    ){
