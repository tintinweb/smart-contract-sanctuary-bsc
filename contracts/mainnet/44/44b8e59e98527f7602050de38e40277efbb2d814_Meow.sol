...
The question is, who let the cats out? Meow!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1bd6361df31129A6448C59C54f7e21A1ECc2EbFb; // owner address
...
contract Meow is Context, IERC20, Ownable {
    ...
    string private _name = "Who Let The Cats Out";
    string private _symbol = "Meow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1bd6361df31129A6448C59C54f7e21A1ECc2EbFb); // 
    address payable public teamWalletAddress = payable(0x1bd6361df31129A6448C59C54f7e21A1ECc2EbFb); // 
    ...
    uint256 private _totalSupply = 25742023 * 10**_decimals;
    uint256 public _maxTxAmount = 514840 * 10**_decimals; 
    uint256 public _walletMax = 514840 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2574 * 10**_decimals; 
