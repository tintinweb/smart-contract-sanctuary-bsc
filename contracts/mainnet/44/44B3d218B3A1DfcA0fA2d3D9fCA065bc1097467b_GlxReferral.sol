...
interface IGlxReferral {
    ...
    function referrers(address _referrer) external view returns (ReferrersInfo memory);
}
...
contract GlxReferral is IGlxReferral, Ownable {
    ...
    IGlxReferral public parentReferral = IGlxReferral(0x4d232cb752A6efCA5795CBCA84a48f308d81D0A6);
    ...
    function recordReferral(address _user, address _referrer) public override onlyOperator {
        parentReferral.recordReferral(_user, _referrer);
    }
    ...
    function getReferrer(address _user) public view override returns (address) {
        return parentReferral.referrers(_user).referrer;
    }
    ...
    function referrers(address _user) public view override returns (ReferrersInfo memory) {
        return parentReferral.referrers(_user);
    }
}