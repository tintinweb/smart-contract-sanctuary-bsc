...
TG https://t.me/worGdiuqS

only 8 token total supply. 1 for every tentacle of a squid. 1 for every million this will reach. yes, this squid can grow more tentacles if needed.

0.16 max wallet

Squid Grow.... but backwards.

Binance Pegged Ethereum Rewards

If you buy this token and ask when marketing, you're portfolio will be cursed for 7 years. 

built to make you rich. will cost more than bitcoin.

dev is middle class in America. Wealthy enough to not rug, too broke to be a billionaire, o.g in the space.
just buy it and spread the word. why sell before millionaire?
...
/* Token contract */
contract worGdiuqS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xcDefD2F7588eCD653e84152810DC34ac38772dce;
    ...
    // Name and symbol
    string constant _name = "worGdiuqS";
    string constant _symbol = "worGdiuqS";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 8 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (0.16 tokens)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (0.08 tokens)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (0.16 tokens)
