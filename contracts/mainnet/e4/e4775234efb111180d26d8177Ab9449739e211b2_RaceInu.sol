...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF);
...
contract RaceInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "RACE INU";
    string constant _symbol = "RACE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x9535B4F2956Fe9A698f5DDC2B7714154043513C1;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF;
    ...
    function manageBlacklist(address user, bool isAdd) public onlyOwner{
        blacklist[user] = isAdd;
    }
