...
contract DEGENERATE is ERC20, Ownable {
    ...
    constructor() ERC20("DEGENERATE", "DEGEN") {
        marketingWallet = payable(0x6f99c02873E0f12359EdB32706120137f3598f03); 
...
contract DEGENDividendTracker is DividendPayingToken, Ownable {
    ...
    DEGENERATE public DEGENContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DEGENContract = DEGENERATE(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DEGEN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DEGEN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DEGENContract);

            uint256 prevBalance = DEGENContract.balanceOf(address(this));
            ...
            {
                uint256 received = DEGENContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DEGENContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
