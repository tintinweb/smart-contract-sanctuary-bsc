...
// File: contracts/rabbusd.sol

//SPDX-License-Identifier: Unlicensed

 /**

TG : https://rabbusdglobal
...
contract RABBUSD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RABBUSD";
    string constant _symbol = "RABBUSD";
    ...
    uint256 distributorGas = 300000; //SABİT KALACAK
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x87857A5c5BD8cA676c5837eb6935213CFCdea4Ae;
        devWallet = 0xC6B18CAb7934f99669043F43a073A67AeC9eAa18;
