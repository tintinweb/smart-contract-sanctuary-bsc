    ...
    ReEntrancyGuard
{
    ...
    string public baseTokenURI = "https://mind-global-advisor.uc.r.appspot.com/walletProvider/global?id=";

    constructor() ERC721A("MIND GLOBAL ADVISOR", "MGA") {
        price = initial_price;
    }
