...
contract DegenTest is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "DegenTest";
    ...
    uint256 poolFeeOnBuying = 0;
    uint256 marketFeeOnBuying = 40;

    // sell tax fee
    uint256 reflectionFeeOnSelling = 0;
    uint256 liquidityFeeOnSelling = 10;
    uint256 poolFeeOnSelling = 0;
    ...
    constructor(
        ...
        marketFeeReceiver = payable(0x4c217D57476cdBF39E284e611Fa79b752aCF350d);// market wallet
        poolFeeReceiver =  payable(0xBCaDBdfe135CbbD00b464C86d12599e5D6404C11);//pool wallet
