...
contract TRUE is Context, IERC20, Ownable {
    ...
    string private _name = "TrueInu";
    string private _symbol = "TRUEINU";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6bdead2d8f7Dda9c723ad0F7e5424ab415fa7b13));
        marketingWalletAddress = payable(address(0x6bdead2d8f7Dda9c723ad0F7e5424ab415fa7b13));
