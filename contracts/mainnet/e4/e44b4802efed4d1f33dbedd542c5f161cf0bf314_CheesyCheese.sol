...
contract CheesyCheese is ERC20, Ownable {
    ...
    constructor() ERC20("CheesyCheese", "CheesePlx") {
        ...
        dividendTracker = new CheesyCheeseDividendTracker(payable(this), router, 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE,
    ...
    function getStakingBalance(address account) private view returns (uint256) {
        ...
        if (account == NFTRewardsContract) {
            stakingBalance = balanceOf(account).mul(275).div(100);
            return stakingBalance;
        }
