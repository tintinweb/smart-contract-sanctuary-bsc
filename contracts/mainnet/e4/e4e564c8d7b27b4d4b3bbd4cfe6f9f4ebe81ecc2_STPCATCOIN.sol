...
contract STPCATCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ST Patricks CatCoin";
    string private constant _symbol = "$STPCATCOIN";
    ...
    uint256 public _maxTxAmount = 1000000000; // 1% of max supply 
    ...
    constructor() {
        ...
        _MarketingWalletAddress = 0x9a32bB020dd645ae5932D1C59cFC4aCEDc22F0c7;
