...
/**
https://t.me/BabySheikhInuOfficial 


THE MAIN TOKEN HIT 1.5M 
Daddy Token is mooning so BABY token will moon too!! but this is lowtax no reward token
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcaF3568Df8fDd7780D4aE9B5845CFE9587EaACED; // owner address
...
contract BabySheikhInuOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabySheikh Inu";
    string private _symbol = "BSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcaF3568Df8fDd7780D4aE9B5845CFE9587EaACED); // Marketing Address
    address payable public teamWalletAddress = payable(0xcaF3568Df8fDd7780D4aE9B5845CFE9587EaACED); // Team Address
