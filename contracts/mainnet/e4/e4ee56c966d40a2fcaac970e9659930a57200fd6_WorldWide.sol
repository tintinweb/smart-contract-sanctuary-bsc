...
/**
 * WorldWide = The integrated Finance Token
 * A new type of contract that designed and implemented by TiFi Community
 */
contract WorldWide is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "WorldWide";
    string private constant _SYMBOL = "WIW";
