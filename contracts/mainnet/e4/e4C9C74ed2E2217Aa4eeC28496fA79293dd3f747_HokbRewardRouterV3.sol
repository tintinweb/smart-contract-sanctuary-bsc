...
contract HokbRewardRouterV3 is Context, Ownable {

  IDEXRouter public router;
  address pcv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

  IMINTER public minter;
  address public minterAddress = 0xe0F2dBfc2E1E09019942d07Dcc0f1B2C54553Cb9;
  ...
  function refill(uint256 tokenid,uint256 _days) public returns (bool) {
    ...
    IERC20(tokenAddress).transferFrom(msg.sender,minterAddress,amount*920/1000);
