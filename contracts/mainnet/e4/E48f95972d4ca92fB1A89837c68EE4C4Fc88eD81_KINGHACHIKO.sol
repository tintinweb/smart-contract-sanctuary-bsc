...
/**
   ...
   I will add 3 bnb as an initial liquidity, and after that i will lock the LP
   I make this #Hachikō to hand over it to the community, Join our Community https://t.me/kinghachiko

   Great features:
   For Buy 
   2% fee auto add to the liquidity pool
   2% fee auto add to Marketing. 
   I set 4% tax fee for our community.
   For Sell
   4% fee auto reward BUSD to all holder after 1 hour hold KingHachiko
   4% fee auto add to Marketing 
   3% fee auto add to the liquidity pool
   I set 11% Tax fee for Sell to reduce Jeet!
   */
...
contract KINGHACHIKO is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "KINGHACHIKO";
   string constant _symbol = "KHACHIKO";
