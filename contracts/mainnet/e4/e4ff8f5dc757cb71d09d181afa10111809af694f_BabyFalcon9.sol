...
contract BabyFalcon9 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 660000000 * 10**9;
    ...
    string private _name = "BabyFalcon9";

    string private _symbol = "BabyFalcon9";
    ...
    uint256 public _MarketingFee = 4; //hardcoded and unchangeable
    ...
    address payable public marketAddress = 0xC8A5240EE87F00e27F3EF2c8081ba8fE2Cb5B2A8; //Marketing
