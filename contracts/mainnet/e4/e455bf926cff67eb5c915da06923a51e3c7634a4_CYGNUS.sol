...
contract CYGNUS is Context, IERC20, Ownable {
    ...
    string private _name = "Cygnus";
    string private _symbol = "CYGNUS";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4F9d4EA2Ca4F6B5cc20F8c1326F04d10d923812d));
        marketingWalletAddress = payable(address(0x4F9d4EA2Ca4F6B5cc20F8c1326F04d10d923812d));
