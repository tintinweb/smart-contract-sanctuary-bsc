...
contract TiePatKay is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Tie PatKAy";
    string private _symbol = "Patkay";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x165cF4D2689fC877654A8FBFcf3ec15d6e2009B2);
    address payable public liqWalletAddress = payable(0x165cF4D2689fC877654A8FBFcf3ec15d6e2009B2);
    ...
    uint256 public _maxTxAmount =    26666666* 10**_decimals;
    uint256 public _walletMax =      35555555* 10**_decimals;
