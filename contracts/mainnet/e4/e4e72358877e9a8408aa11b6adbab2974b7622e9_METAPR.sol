...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfB668B4CA740F4a328FA5F084E6E1087Ed59011C; // owner address
...
contract METAPR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "METAPR";
    string private _symbol = "MEPR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F6DD75E7Ef568c79689d914A5e315EB5F577568); // Marketing Address
    address payable public teamWalletAddress = payable(0x54ADA8EF29a8bCA5518b10BE116Ecb211266F003); // Team Address
