...
contract RhinoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rhino Inu";
    string private _symbol = "RNI";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x895F46205237D2E1A74CE6b971fC08396e45b353); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x84469C9cE0f6e6470f28c9102E5A96d0Cf32d9a0); // BuyBack Address
