...
// File: contracts/myg/govenchure.sol
...
contract GoVenchure{
    ...
    constructor(address owner, address bonusContract, IERC20 depositToken, address payable _f, address payable _caller, address _payer, address _fundContract){
        _owner = owner;
    ...
    function changeFundAddress(address _fundContract) public onlyLegalCaller{
        fundContract = _fundContract;
    }
    ...
    function setPercent(uint percent) public onlyOwner{
        percentOfAmount = percent;
        emit ChangedPercent(percent);
    }
    ...
    function delivery(
        ...
        emit AddedToDeposit(user, amount, block.timestamp);
	}
