...
contract DUNKTANKGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dunk Tank Grow";
    string private _symbol = "DTG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x240572B3dA90719523b915A2EBa0C6e47050dfBf); 
    address payable public buyBackWalletAddress = payable(0x02ba2Df3e98DE5101994527738cC657E370bcBDB); 
