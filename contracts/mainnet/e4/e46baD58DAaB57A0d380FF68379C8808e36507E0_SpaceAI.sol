...
contract SpaceAI is Context, IERC20, Ownable {
    ...
    uint256 private _totalDistributionShares = 14;

    uint256 private _totalSupply = 6666666 * 10**_decimals;
    uint256 public _maxTxAmount = 133333 * 10**_decimals; 
    uint256 public _walletMax = 266666 * 10**_decimals;
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x3E9C42f95350B5F779Def798dB235DAC37BacFC3));
        ruinWalletAddress = payable(address(0x3E9C42f95350B5F779Def798dB235DAC37BacFC3));
        _name = coinName;
       _symbol = coinSymbol;
...
function _beforeTokenTransfer(
    ...
    function setMultipleWhitelist(address[] calldata accounts)
        external
        onlyOwner
    {
