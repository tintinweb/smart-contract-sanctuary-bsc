...
// TG: https://t.me/Doge1bscofficial

// Website : https://dogeonerocket.com
...
contract DOGE1 is IBEP20, Auth {
   ...
   string constant _name = "DOGE-1";
   string constant _symbol = "DOGE-1";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xE6fB4A8b97bcE3E5a2644276A647B8b603916c7C).call{value: BNBMarketingamount, gas: 30000}("");
