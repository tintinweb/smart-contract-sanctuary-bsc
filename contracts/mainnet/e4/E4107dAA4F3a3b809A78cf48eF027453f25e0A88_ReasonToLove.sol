...
contract ReasonToLove is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xcEA540A826Af114f54c5D4295Aec33a664c9E16B); // Marketing Address

    address payable public teamAddress =
        payable(0x2ff0f1E7400089367e5C137c785f5Db829B3EA1a); // Team Address

    address payable public liquidityAddress =
        payable(0x2ff0f1E7400089367e5C137c785f5Db829B3EA1a); // Liquidity Address
    ...
    string private constant _name = "ReasonToLove";
    string private constant _symbol = "RTL";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1000 / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 1000 / 1000; // 1% maxWalletToken
