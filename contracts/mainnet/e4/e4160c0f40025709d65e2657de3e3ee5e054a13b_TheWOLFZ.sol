...
/*
🐺🐺🐺WOLFZ🐺🐺🐺 is an Action-Adventure RPG P23 game where you will be earning $WOLFZ tokens
STORYLINE
During the era when the great wolves of old lived upon the ground, 
the clans of the southern realm grew huge in number 
and spread out across the land. Through time, the wolves of the 
clans gained insight and wisdom from the elemental to the arcane, 
passing this knowledge down from generation to generation.

Three wolf clans were born , ‘THE SCORN’, ‘THE MIGHTY’ and ‘THE KNIGHT’ 
were entwined in a battle of colossal scale called ‘The Howling War’.

The Howling War resulted in much loss of life, knowledge and power. 
The only remaining remnants of the war lay forgotten, scattered around 
the universe known as WOLFZ
*/
...
contract TheWOLFZ is Context, TheWOLFZBNB, Ownable {
    ...
    string private _name = 'TheWOLFZ';
    string private _symbol = 'WOLFZ';
