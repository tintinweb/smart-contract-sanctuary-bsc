...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Whole Mars";
    string private _symbol = "Whole Mars";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000000000000 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x5555488CFAd68BCBf91acEE50864522f98761b56);
    ...
    constructor() {
        ...
        _maxBalance = 30000000000000 * 10**_decimals;
