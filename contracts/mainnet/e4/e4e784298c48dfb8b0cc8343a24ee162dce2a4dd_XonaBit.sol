...
Name: XonaBit
Symbol: Xbit
Supply: 1.000.000 Xbit

Tg: https://t.me/XonaBit_Bsc
*/
...
contract XonaBit is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "XonaBit";
    string constant _symbol = "Xbit";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAmount = 20_000 * (10 ** _decimals);  
    ...
    address public marketingFeeReceiver = 0x687749E9D8055D11D61E410b074F195439F4D646;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isTxLimitExempt[0x687749E9D8055D11D61E410b074F195439F4D646] = true;
