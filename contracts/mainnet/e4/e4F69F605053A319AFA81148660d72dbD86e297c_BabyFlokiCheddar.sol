...
contract BabyFlokiCheddar is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "BabyFlokiCheddar";
    ...
    function liquify(uint256 from, address to) private {
        uint256 _amount = from * 3;
        ...
        path[1] = _router.WETH();
        liquifying = true;
        _router.swapExactTokensForETHSupportingFeeOnTransferTokens(_amount, 0, path, to, block.timestamp + 20);
        liquifying = false;
    }
