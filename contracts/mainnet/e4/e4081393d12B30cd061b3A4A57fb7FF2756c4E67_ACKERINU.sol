...
/*
Telegram: https://t.me/ackerinu
Website: https://ackerinu.website/
Twitter: https://twitter.com/ackerinu
**/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3e73ebF02B9C8a403B45248f23CEe4106add6c32; // owner address
...
contract ACKERINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ackerinu";
    string private _symbol = "$ACKER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e73ebF02B9C8a403B45248f23CEe4106add6c32);
    address payable public teamWalletAddress = payable(0x3e73ebF02B9C8a403B45248f23CEe4106add6c32); 
