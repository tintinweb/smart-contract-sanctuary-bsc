...
contract ZYS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "zhangyishan";
    string private _symbol = "zys";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x773ef0ae1062739b7187A4880DA03d35001F519D); // Marketing Address
