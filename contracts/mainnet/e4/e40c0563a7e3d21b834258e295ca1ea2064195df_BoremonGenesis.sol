...
abstract contract Ownable is Context {
    ...
    contract BoremonGenesis is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "";
  string private uriSuffix = ".json";
  string public hiddenMetadataUri = "ipfs://QmaohJ872zeXG82kfCeGe86uy5zYF3zsLUJSiwkm9Cwce8";

  uint256 public cost = 0.08 ether;
  uint256 public whiteListCost = 0.02 ether;

  uint8 public maxWLMintAmountPerTx = 2;  
  ...
  constructor() ERC721A("Boremon Genesis", "BGEN") {
