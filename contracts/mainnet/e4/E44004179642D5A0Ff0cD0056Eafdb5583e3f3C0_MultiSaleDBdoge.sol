...
contract MultiSaleDBdoge is BEP20, Ownable{
    ...
    function getBnbReserv() public view returns (address) {
        return bnb_reserv;
    }
    ...
    */
    function buyWithPartial(string memory tokenName, address tokenAddress, uint256 tokenPrice,  uint256 TPrice) public isPausable() {
        ...
        require(ContractAdd.transferFrom(msg.sender, _companyAdress, tokenPrice), "A transaction error has occurred. Check for approval.");
    ...
    function buyWithBNB(uint256 tokenPrice,  uint256 TPrice) public payable {
        require(tokenPrice > 0, "Insufficient amount for this transaction");
        ...
        require(TPrice > 0 && TPrice <= dexBalance, "Insufficient amount for this transaction");
        require(ContractToken.transferFrom(msg.sender, _companyAdress, TPrice), "A transaction error has occurred. Check for approval.");

        emit Received(msg.sender, tokenPrice, TPrice, "BNB");
    }
    ...
    */
    function getpriceBNB(uint256 amount) public view virtual returns (uint256) {
        ...
        IUniswapV2Pair _tokenPair = IUniswapV2Pair(bnb_reserv);
