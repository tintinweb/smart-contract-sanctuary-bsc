...
contract NekoGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neko Gold";
    string private _symbol = "NekoGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10506f90103d4Af6D7bA7a984f88e2cA8980d992);
    address payable public BuyBackWalletAddress = payable(0x10506f90103d4Af6D7bA7a984f88e2cA8980d992);
