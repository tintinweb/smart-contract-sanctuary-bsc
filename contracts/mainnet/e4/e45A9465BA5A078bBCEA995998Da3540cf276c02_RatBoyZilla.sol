...
contract RatBoyZilla
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "RatBoyZilla";
    string private _symbol = "RatBoyZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc0562a3f1d49Bbc2aBAe075bA250ECD4E8337713));
        _anotherA = payable(address(0xc0562a3f1d49Bbc2aBAe075bA250ECD4E8337713));
