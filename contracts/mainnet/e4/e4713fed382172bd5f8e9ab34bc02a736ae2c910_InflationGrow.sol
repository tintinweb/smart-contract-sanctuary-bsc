...
contract InflationGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Inflation Grow";
    string private constant _symbol = "InflationGrow";
