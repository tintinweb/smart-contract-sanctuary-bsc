...
contract CatJiru is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 4_000_0 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "CatJiru"; // 
    string private constant _symbol = "CatJiru"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xCdE61fA96f728a1A104c035345eFC89717bc04bc;
