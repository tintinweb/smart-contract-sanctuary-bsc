...
contract CR7Moon is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = (_tTotal * 25) / 10000; // 0.25%
    uint256 public maxBuyLimit = (_tTotal * 2) / 100; // 2%
    uint256 public maxSellLimit = (_tTotal * 2) / 100; // 2%
    uint256 public maxWalletLimit = (_tTotal * 2) / 100; // 2%
    
    uint256 private tTimer;
    
    address public marketingWallet = 0xd227139C335951b9dec96B8a1F1169E74A27B686;
    address public devWallet = 0x57c821C730af691d12a17ac7d066c527309D53eF; 
    ...
    string private constant _name = "CR7 Moon";
    string private constant _symbol = "SIUUUUUUUU";
    ...
    Taxes public taxes = Taxes(1, 5, 2, 1, 0, 0);
    Taxes public sellTaxes = Taxes(1, 5, 2, 1, 0, 0);
