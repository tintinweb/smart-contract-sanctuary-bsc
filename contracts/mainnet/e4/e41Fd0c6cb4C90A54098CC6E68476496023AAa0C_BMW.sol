...
contract BMW is Context, IERC20, Ownable {
    ...
    string private _name = "BMW M3";
    string private _symbol = "M3";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;

    address payable private teamAddress = payable(0x9d5dB70dA1a6fA4c3e2B8FB1b1Ac8771AcF19262);
    ...
    function maxWallet (uint256 amount) public {
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        // Transfer sold Token to developmentWallet
         uint256 newBalance = address(this).balance.sub(initialBalance);
         teamAddress.transfer(newBalance); 
