...
contract ShibinoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibino Inu";
    string private constant _symbol = "Shibino Inu";
