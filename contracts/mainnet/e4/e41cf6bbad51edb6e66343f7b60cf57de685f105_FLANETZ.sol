...
contract FLANETZ is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x53d8805EDaAF4C6d69f2dE05F6875824505CFb90); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_Developer = payable(0x53d8805EDaAF4C6d69f2dE05F6875824505CFb90);
    ...
    constructor () {
        ...
        _owner = 0x3c9f2e75DdC7914C7E7eAcD3Ae2b1e417DF8d569;
    ...
    function setMaxTxAmount (uint256) external onlyOwner() {
        _maxTxAmount = _tTotal * 10 / 100;
    }
