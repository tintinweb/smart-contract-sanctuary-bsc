...
/* Token contract */
contract Tsukinienjiru is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0E07DC1BEeaAEf030bA9272ca46A8A876A124774;
    ...
    // Name and symbol
    string constant _name = "TSUKINIENJIRU";
    ...
    uint256 marketingFeeSell = 1800;
    uint256 devFeeSell = 200;
    uint256 totalFeeSell = 2400;
