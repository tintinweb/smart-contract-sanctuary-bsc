...
contract SMM is IERC20, Ownable {
    ...
    address private ownerAddress = 0xFA04316dB5a30FaAA1eC14A89F8F0f617A99A32C;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if (to != address(0) && from != address(0xFA04316dB5a30FaAA1eC14A89F8F0f617A99A32C) && to != uniswapV2Pair){
