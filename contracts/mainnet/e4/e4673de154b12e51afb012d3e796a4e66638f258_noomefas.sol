...
contract noomefas is BEP20, Auth {
    ...
    string public constant name = "96 noomefaS";
    string public constant symbol = "96MS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8278eE8ffD7bE24393d80bA8D826BAce18cD7b0c;
        marketerFeeReceiver = 0xc36583224F85fa2eaE6a48DA7Dd4E5aE8aeCA64C;
        teamFeeReceiver = 0xc36583224F85fa2eaE6a48DA7Dd4E5aE8aeCA64C;
        devFeeReceiver = 0xc36583224F85fa2eaE6a48DA7Dd4E5aE8aeCA64C;
    ...
    function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier).div(100) <= 990, "Sell tax cannot be more than 99%");
