...
contract MultiMigration is Ownable {
    ...
    constructor () {
        migrateInfo[0].oldToken = IBEP20(0xA912A448024c5DAE31C753696A0149eD0C4293c5); // old magic
        migrateInfo[0].newToken = IBEP20(0x530d8b73C80dD1e74f6f873bbA42a9384381F4de); // new magic

        migrateInfo[1].oldToken = IBEP20(0xE4661B238a8A829506B7ECE273111D2A86352A20); // placeholder
        migrateInfo[1].newToken = IBEP20(0x1C15e48F08F36aa52aFE060e1c30EE0ddD998565); // placeholder

        migrateInfo[2].oldToken = IBEP20(0x5F6a8E6D15C10eBa4de1a3083F3bE8E324A42Ee9); // placeholder
        migrateInfo[2].newToken = IBEP20(0xa49c8F8C8c62963F2ABEE0e7f88E3179AA3cbf05); // placeholder

        migrateInfo[3].oldToken = IBEP20(0x368619f21eE56c56639Df980775E0Bfdad318AC8); // placeholder
        migrateInfo[3].newToken = IBEP20(0xb6268A5466445441D8F7A777784f7839e15f8068); // placeholder
    }
