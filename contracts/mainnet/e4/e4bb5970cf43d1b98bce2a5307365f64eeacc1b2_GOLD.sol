...
Telegram : https://t.me/runningmichael
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9d7531539990e173A35Af5b2De4EA307a90E5d7B;
...
contract GOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "RUNNING MICHAEL"; // 
    string private constant _symbol = "$RGM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0x457Bc93eCF6ac52FBE2d9cbb97BA935Efd100bd7);
