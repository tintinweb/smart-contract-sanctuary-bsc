...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA5205266CEfcae2f5D1F6B130676031644a76B17;
...
contract kryptodog is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x944D2585e3335D28B5303154962037207145f785;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "krypdog";
    string private _symbol = "kydog";
