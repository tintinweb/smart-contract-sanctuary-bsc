...
Website: https://babybunnygirlnft.com
...
contract 
BunnyGirlUniverseToken is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public ManualBuyback = 2;
  uint256 public distributionFee = 0;
  ...
  */
  function name() external override view returns (string memory) {
    return "Baby Bunny Girl Universe Token";
  }
