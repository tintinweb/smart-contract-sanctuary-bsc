...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFB54a0E917dE04307E4284c183C3aF25d7Aa9Ea4; // owner address
...
contract SpookyTweet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Tweet";
    string private _symbol = "$SpkyTwt";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x666dA3D591806906D6fA0192c6F1002b0CaC6131); // Marketing Address
    address payable public teamWalletAddress = payable(0x666dA3D591806906D6fA0192c6F1002b0CaC6131); // Team Address
