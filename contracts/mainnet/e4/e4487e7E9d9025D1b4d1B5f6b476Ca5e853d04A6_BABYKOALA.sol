...
contract BABYKOALA is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Koala Inu";
    string private _symbol = "BABYKOI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x1A2a36a00F4b6bd6c9C91905b3fE8ceAA998F9De);
    address public marketingWalletToken = 0x1A2a36a00F4b6bd6c9C91905b3fE8ceAA998F9De;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 40 * 10**9 * 10**_decimals;
        _maxBalance = 40 * 10**9 * 10**_decimals;
