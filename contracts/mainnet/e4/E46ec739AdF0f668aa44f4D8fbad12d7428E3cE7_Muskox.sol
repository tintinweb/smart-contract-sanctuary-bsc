...
contract Muskox is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityPercentage = 50; // 2/2 marketing,liq
    ...
    address payable public _devWallet = payable(0x45Bf981805494f359aF54C6A95AAF9755B26dD7d);
    ...
    constructor () {     
        ...
        _rOwned[_devWallet] = (_rTotal.div(100)).mul(5);  // 5% Supply for mktng
    ...
    function _transfer(
        ...
        if(!_isExcludedFromMaxTxAmount[to] && !_isExcludedFromMaxTxAmount[from]) {
