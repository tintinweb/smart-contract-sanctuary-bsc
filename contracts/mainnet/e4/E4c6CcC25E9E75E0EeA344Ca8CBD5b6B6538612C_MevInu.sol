...
/**
Mev Inu is a Decentralized Exchange and Automatic Market Maker built on the BSC. 
We aim to solve one of the fundamental problems in Decentralized Finance (DeFi), 
where the project’s native token rises in value at launch only to incrementally 
decrease in value day after day until it ultimately goes down to zero. 

We love dogs,especially Inu! We want to bring dog enthusiasts together through the power of decentralized cryptocurrency.
...
Telegram: https://t.me/MevInuPortal
Website: https://www.mevinu.com/
Twitter: https://twitter.com/Mev_Inu
Medium: https://medium.com/@inumev
*/
