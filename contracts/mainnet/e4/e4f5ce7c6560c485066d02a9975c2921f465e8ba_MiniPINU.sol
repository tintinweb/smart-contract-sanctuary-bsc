...
/* 
    ...
    🐷 Mini PIGE INU (MiniPINU) 🐷

    Telegram: https://t.me/MiniPINU

    Tokenomics: 6% on buy / 8% on sell
...
contract MiniPINU is Context, IERC20, Ownable {
    ...
    string private _name = "MINI PIGE INU";
    string private _symbol = "MiniPINU";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0x7DdCe7C966bfa370430Fec7b104f54ed7DE5d1b2);
    ...
    uint256 private minimumTokensBeforeSwap = 2500000;
