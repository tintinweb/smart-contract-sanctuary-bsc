...
contract CITTProtocol is Ownable, IERC20Metadata {
    ...
    string private _name = "FITT Protocol";
    string private _symbol = "FITT";
    ...
    uint256 private _maxDeals = 200 * 10 ** _decimals;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10 ** _decimals;
