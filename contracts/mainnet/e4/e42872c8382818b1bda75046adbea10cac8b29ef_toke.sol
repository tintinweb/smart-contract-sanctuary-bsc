...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xCef747eb0084d784a1AAF51013DB917746A7D80C;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0xCef747eb0084d784a1AAF51013DB917746A7D80C),//fund address
    
        address(0xCef747eb0084d784a1AAF51013DB917746A7D80C)//dev address
    ){
