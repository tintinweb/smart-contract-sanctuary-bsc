...
contract Lunchad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunchad";
    string private _symbol = "$LUNCHAD";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x21D8eAdd5c08b0486a005028Ad8c763610681A32);
    address payable public teamWalletAddress = payable(0xAA6CB8C412d04A999eb3Fd4F09a3E25a57218e08);
