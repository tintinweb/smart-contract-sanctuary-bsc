...
/** Telegram:  https://t.me/FireInuBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5d045B4d3f8Ea23b50c2b21dd5dc960E2Fb80ED; // owner address
...
contract Prisondokwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIRE INU";
    string private _symbol = "$FINU"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf5d045B4d3f8Ea23b50c2b21dd5dc960E2Fb80ED); // Marketing Address
    address payable public teamWalletAddress = payable(0xf5d045B4d3f8Ea23b50c2b21dd5dc960E2Fb80ED); // Team Address
