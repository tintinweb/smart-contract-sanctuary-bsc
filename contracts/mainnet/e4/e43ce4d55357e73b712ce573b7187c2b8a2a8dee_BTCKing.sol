...
contract BTCKing is Context, IERC20, Ownable {
    ...
    string private constant _name = " BTC King "; // 
    string private constant _symbol = " $BTCKING "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xCf34BC6dde08CB94F437fAFc2324aE018212F43a;
