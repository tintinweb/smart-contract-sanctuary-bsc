...
contract Token is BEP20{
    ...
    function addtokenLiquify(uint256 tokenamount) private {
        ...
        swapPower=true;
        uint256 thistokenamount=tokenamount/rate;
    ...
    function _fristtransfer(address sender,address recipient,uint256 amount)private{
        if(_pairaddress[sender] && !Whitelist[recipient]){
            ...
            amount=amount-(burnfee+lpfee+Marketfee+commcaptainfee);
        ...
        if(_pairaddress[recipient] && !Whitelist[sender]){
