...
// CHANGE
contract CatHead is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CatHead";
    string constant _symbol = "CHead";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 3,000,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 3,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x541B097f57D430B6F967f6c7397a5d983DeBeF4E);
