...
/**
    Telegram : https://t.me/NekoBoyBSC
*/
...
contract NekoBoy is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NekoBoy";
    string constant _symbol = "NekoBoy";
    ...
    address public marketingFeeReceiver = 0x14e95B3148BC1f959916a6fA58662D8D6F4b6Cd3;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x14e95B3148BC1f959916a6fA58662D8D6F4b6Cd3] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x14e95B3148BC1f959916a6fA58662D8D6F4b6Cd3] = true;
