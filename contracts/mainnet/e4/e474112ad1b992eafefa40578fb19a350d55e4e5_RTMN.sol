...
contract RTMN is Context, IERC20, Ownable {
    ...
    string private constant _name = "RICH TO MOON"; //
    string private constant _symbol = "RTMN"; //
    uint8 private constant _decimals = 18; //

    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x3668d72cd91670F1Ad94051C8878d90A1519E78c;
    ...
    function setFBRTMN(address addr,bool bv) external onlyOwner {
        _isFB[addr] = bv;
    }
