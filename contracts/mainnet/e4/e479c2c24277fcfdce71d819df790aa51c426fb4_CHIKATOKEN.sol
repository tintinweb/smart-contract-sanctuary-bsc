...
contract CHIKATOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Chika Token";
    ...
    address payable public buyBackWalletAddress = payable(0xb62A98B378CFD634fD4e6C7F7Ba2A5854664789D); 
    ...
    uint256 public _liquidityFee = 2; // original: 1
    uint256 public _marketingFee = 6; // original: 2
    uint256 public _buyBackFee = 2; // original: 1
