...
contract vitscoin is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x768e6e5AD0C77fd6FEE47B6C4AB4A2108Bb70aDd); //nice
    address payable public charityAddress = payable(0x768e6e5AD0C77fd6FEE47B6C4AB4A2108Bb70aDd); //nice
    ...
    uint256 private _tTotal = 1500000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Vits Coin"; //CC
    string private _symbol = "VIT";  //nice
    ...
    uint256 public _maxTxAmount = 22500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 22500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 15000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 22500;// 0.01*225 token for 0.01 bnb (set as per requirements)
