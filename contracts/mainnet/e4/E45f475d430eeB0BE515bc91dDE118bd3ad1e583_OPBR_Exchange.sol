...
/*
OPBRex is a BEP-20 Token that aims to promote the development of new technologies
 capable of promoting access to a good quality integration and transaction between Dexcentralized and Centralized, 
bringing ease of transaction in the Conventional Market, Banking and Exchange. For more information visit the link below:

🏦  https://opbr.org/exchange
...
contract OPBR_Exchange is Context, IERC20, Ownable {
    ...
    string private _name = "OPBR Exchange";
    string private _symbol = "OPBRex";
    uint8 private _decimals = 18; //decimals
    ...
    address public charityWallet = 0x3C4f8df0F9b6D3cA77AB2c8C5e2F23fdDD7d4A56;//project OPBR Exchange
    ...
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**3 * 10**18;
