...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe46bD94e2571E7F2aDB362CDF3c64Cba165029dc; // owner address
...
contract WIKISHIB is Context, IERC20, Ownable {
    ...
    string private _name = "WIKI SHIB";
    string private _symbol = "WS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5d3DC069120015c9A5eEe0d3a7187770A9e28225); // Marketing Address
    address payable private teamWalletAddress = payable(0xd8c75f3e2E93a35c955B6fE54BAcB858D688F17A); // Team Address
