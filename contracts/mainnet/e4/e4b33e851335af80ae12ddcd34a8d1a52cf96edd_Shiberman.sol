...
Token name: Shiberman
Token Symbol : $Shiber
In times of evil bear markets, the friendliest and toughest dogs appear who want to make the Oracle's world more interesting. SHIBERMAN!
...
📯Twitter : https://mobile.twitter.com/draculatheme

📯GitHub : https://github.com/dracula/dracula-theme

📯Reddit :
https://www.reddit.com/r/draculatheme

📯Telegram : https://t.me/Shiberman
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x254594dC6086C9Fcf99F503D77D45c0377df6837;
...
contract Shiberman is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiberman"; // 
    string private constant _symbol = "Shiber"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x06A80b6f48AB18f36cab8da6Ff3B44F7378A8654);
