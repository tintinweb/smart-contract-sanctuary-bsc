...
contract ZombiePetsToken is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x230Fc7AC500fe5bDFa090A0436B7165EC88eB330;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy <= 2, "MarketingFeeOnBuy should be less than or equal to 2%");
        marketingFeeOnBuy = _marketingFeeOnBuy;
        emit UpdateBuyFees(marketingFeeOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnSell <= 2, "MarketingFeeOnSell should be less than or equal to 2%");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 2, "Wallet to Wallet Transfer Fee cannot be more than 2%");
