...
contract CR7Inu2 is IBEP20, Ownable {
    ...
    string private _symbol = "CR7 Inu 2";
    uint256 private constant INITIAL_SUPPLY = 1_000_000_000 * 10**TOKEN_DECIMALS; 
    uint256 private _circulatingSupply;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //CR7 can never set tax higher than this value
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 60,
        rewards: 0
        //@CR7. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        CR7: 0x361EbA5260f19F805e183142B2C61B921b964D2a,
        Dev: 0x825e3DB0520878e974C8D7e4b61Ff2362Db9d8e5,
        marketing: 0x361EbA5260f19F805e183142B2C61B921b964D2a
    });
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event UpdateCR7Wallet(address newCR7Wallet);
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on CR7's chosen ratios
    ...
    //allows CR7 to change token name and symbol. 
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external authorized {
        ...
        //CR7 can never set sells below 0.1% of circulating/initial supply
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newCR7 + newLiquidity + newDev + newmarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newCR7, newLiquidity, newDev, newmarketing, newRewards);
    }
    ...
    function withdrawCR7() external authorized {
        ...
        uint256 amount = lostBalance ? CR7Balance + remaining : CR7Balance;
        CR7Balance = 0;
        _sendBnb(_taxWallet.CR7, amount);
    } 
...
///// OWNER FUNCTIONS /////  
    ...
    function setCR7Wallet(address payable addr) external onlyOwner {
        address prevCR7 = _taxWallet.CR7;
        _excluded.remove(prevCR7);
        _taxWallet.CR7 = addr;
        _excluded.add(_taxWallet.CR7);
        emit UpdateCR7Wallet(addr);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 CR7, uint256 Dev, uint256 marketing) {
        return (buybackBalance, CR7Balance, DevBalance, marketingBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 CR7Split = (bnbAmount*_taxRatios.CR7) / distributeRatio;
