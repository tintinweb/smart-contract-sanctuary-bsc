...
contract Token {
    ...
    string public constant name = "CEPEX Token";
    string public constant symbol = "CEPEX";
    ...
    function balanceOf(address own5) public view returns(uint256) {
        return balances[own5];
    }
