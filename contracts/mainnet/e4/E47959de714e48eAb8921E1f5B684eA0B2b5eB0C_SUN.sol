...
contract SUN is SUNDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SUNTeam;
    address private CharitySUN;
    ...
    string public override name = "Rising Sun";
    string public override symbol = "SUN";
    ...
    constructor(uint totalSupplyValue, address SUNTeamAddress, address CharitySUNAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SUNTeam = SUNTeamAddress;
        CharitySUN = CharitySUNAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SUNTeam] =  totalSupply * 4 / 100;
        balances[CharitySUN] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SUNTeam pot
