...
contract MaroiStep is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MaroiStep";
    string private _symbol = "MAROISTEP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20c7F9454A705BA8B04cFe647dB6eB0a3d3e12F2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x20c7F9454A705BA8B04cFe647dB6eB0a3d3e12F2); // BuyBack Address
