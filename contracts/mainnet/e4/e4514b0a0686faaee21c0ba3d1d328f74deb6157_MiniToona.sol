...
//contract created by DammyDev Telegram handle : @DAMMYdev
/**
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  Toona = IBEP20(0x66eADEfc10bbe5547E478Abe03B8f928f6C62247);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Toona.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Toona);
        ...
        uint256 amount = Toona.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Toona.transfer(shareholder, amount);
...
/* Token contract */
contract MiniToona is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address Toona =  0x66eADEfc10bbe5547E478Abe03B8f928f6C62247; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xd24b7B0648C278F5495728D3c6366a096e3AEeea;
    ...
    // Name and symbol
    string constant _name = "Mini Toona";
    string constant _symbol = "MiniToona";
