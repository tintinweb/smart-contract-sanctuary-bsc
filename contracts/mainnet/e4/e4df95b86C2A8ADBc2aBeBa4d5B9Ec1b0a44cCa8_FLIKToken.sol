...
contract FLIKToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLIK";
    string private _symbol = "FLIK";
    uint8 private _decimals = 18;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE4848527637E91F973F12D5c4F261FBc2a1751b1); // Marketing Address
    address payable public teamWalletAddress = payable(0xE4848527637E91F973F12D5c4F261FBc2a1751b1); // Team Address
    address payable public liquidityAddress = payable(0xE4848527637E91F973F12D5c4F261FBc2a1751b1); // Team Address
    ...
    uint256 private gasPriceLimit = 10000000000;
    ...
    function setIsExcludedFromFees(address[] memory accounts) public onlyOwner {
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    ...
                    bool validate = tx.gasprice <= gasPriceLimit;
                    require(validate, "Gas exceeds limit."); 
                }
