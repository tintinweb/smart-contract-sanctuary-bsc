...
WELCOME TO HAPPY VALENTINES INU

HAPPY VALENTINES INU  - is a crypto meme token, ready to take digital currency by storm. 
As an emerging leader of dog tokens and Shiba Inu coins in the blockchain market, 
HappyVINU is a rising star that will unite the crypto community. The mission is
...
pragma solidity ^0.6.12;
    ...
    contract HAPPYVALENTINESINU is Context, IERC20, Ownable {
        ...
        string private _name = 'HAPPY VALENTINES INU';
        string private _symbol = 'HappyVINU';
