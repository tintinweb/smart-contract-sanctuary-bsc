...
contract SoraINUTOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd6fa4355dC388376Ff54f307C19e0eAaDBADDe85);
    address payable public liqWalletAddress = payable(0xd6fa4355dC388376Ff54f307C19e0eAaDBADDe85);
    ...
    uint256 public _walletMax =     650000 * 10**_decimals;
