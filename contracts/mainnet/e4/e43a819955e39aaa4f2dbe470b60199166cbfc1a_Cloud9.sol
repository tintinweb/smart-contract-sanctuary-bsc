...
contract Cloud9 is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x53Bd1eEe0FDbf85eab017e83114b9b8dDA7214b8);
    ...
    string private constant _symbol = unicode"C9"; 
    ...
    uint256 public _maxWalletToken = _tTotal / 66;
