...
contract DogZilla69 is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogZilla69";
    string private constant _symbol = "DogZilla";
    ...
    Taxes public sellTaxes = Taxes(0, 8, 3, 1);

    address public DogZilla69_Marketing = 0x50Fa5ea292D0A081397d5570dB23D85695eBf025;
    address public DogZilla69_Team = 0x6e3eC0C75D42c351F61b7334e8a96540E34aFaF3;
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[DogZilla69_Marketing] = true;
        _isExcludedFromFee[DogZilla69_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[DogZilla69_Marketing] = true;
        allowedTransfer[DogZilla69_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(DogZilla69_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(DogZilla69_Team).sendValue(teamAmt);
        }
    }
    ...
    function DogZilla69_UpdateWallet(address newWallet) external onlyOwner{
        DogZilla69_Marketing = newWallet;
    }
    
    function DogZilla69_UpdateTeamWallet(address newWallet) external onlyOwner{
        DogZilla69_Team = newWallet;
    }
