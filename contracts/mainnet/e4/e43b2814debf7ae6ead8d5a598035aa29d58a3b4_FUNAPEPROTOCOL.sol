...
contract FUNAPEPROTOCOL is Context, IERC20, Ownable {
    ...
    string private constant _name = "FUNAPEPROTOCOL"; // 
    string private constant _symbol = "FUNAPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 8;
    address private  _marketingWallet = 0x7554336546e3A6dcfE470f8A520973943515CfB8;
