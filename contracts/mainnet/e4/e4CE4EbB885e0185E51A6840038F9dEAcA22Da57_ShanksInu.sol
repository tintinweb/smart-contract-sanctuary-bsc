...
contract ShanksInu  is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x402419C0fB90fBC0dB2a190798a0e0BdA1eAe1De); 
    address payable public Wallet_Dev = payable(0x7BC767b1412915be86961fF3CAAcf0086bFadb8f);
    ...
    string private constant _name = "ShanksInu"; 
    string private constant _symbol = unicode"$ShanksInu"; 
    ...
    constructor () {
        ...
        _owner = 0x7BC767b1412915be86961fF3CAAcf0086bFadb8f;
