...
contract GIFcoinNFT is IERC20, Ownable {
    ...
    address public _fundAddress = address(0x20D2b01a2C5D52AbBd9cacF2a44a4e9c5bB4Dad1);
	address public _rewardLpAddress = address(0x33cB9148C9e951EA50316ED18afAE9B8853bF7ee);
    address tokenOwner = address(0x136CEb2De724a5C0F0d0247CB372248d60B012Ac);
    ...
    constructor() {
        ...
        uint256 leaveAmount = 1050 * 10**_decimals;
