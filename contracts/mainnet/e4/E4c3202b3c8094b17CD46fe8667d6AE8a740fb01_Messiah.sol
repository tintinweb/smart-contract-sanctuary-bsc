...
contract Messiah is Context, IERC20, Ownable {
    ...
    string private _name = "Messiah";//Messiah
    string private _symbol = "Messiah";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c5206dC2B3d9aC4b2Ea1bbBB260Fc32e4e46051);
    address payable public NFTWalletAddress = payable(0x917CA352783f409777533e3f5D77Eaa05fFaE719);
    address public liquidityWalletAddress = 0xc08F134CA391CA0608B330A5920761dD44742c2b;
    ...
    uint256 private minimumTokensBeforeSwap = 100000000000000 * 5 **_decimals; 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNBLeft.mul(_marketingShare).div(_marketingShare.add(_NFTShare));

        uint256 amountBNBNFT = amountBNBLeft.sub(amountBNBMarketing);
