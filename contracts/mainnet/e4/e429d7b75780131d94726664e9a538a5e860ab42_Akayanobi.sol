...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25a720b24a1Ff8fD5406A6B91177fB8eAe8E49a3; // owner address
...
contract Akayanobi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Akayanobi inu";
    string private _symbol = "AKOBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25a720b24a1Ff8fD5406A6B91177fB8eAe8E49a3); // Marketing Address
