...
contract NonTesla is Context, IERC20, Ownable {
    ...
    string private _name = "Non-Tesla";
    string private _symbol = "$NTESLA";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000000 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x7307042FA703115782A91A55338D21B47b38ee56);
    ...
    constructor() {
        ...
        _maxBalance = 10000000 * 10**_decimals;
