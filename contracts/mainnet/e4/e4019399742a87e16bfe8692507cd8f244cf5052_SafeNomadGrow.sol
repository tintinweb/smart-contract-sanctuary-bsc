...
//Telegram : https://t.me/SafeNomadGrowBSC
...
contract SafeNomadGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeNomad Grow"; // 

    string private constant _symbol = "$SFNG"; // 
    ...
    address public  _marketingWallet = 0xB5Ae12662784e02eEA18F1E3bd6c17F3C5cB2b4B;
