...
contract StandardTokenAntiBot is IERC20, Ownable {
    ...
    constructor(
        address owner_,
        string[2] memory name_symbol,
        uint8 decimals_,
        uint256 totalSupply_,
        address whaleAntiBotAddress, //  whaleAntiBotAddress
        ...
        whaleAntiBot = IWhaleAntiBot(whaleAntiBotAddress);
        // Enable using whaleAntiBot in this contract
        antiBotEnabled = false;
        _whaleAntiBot = whaleAntiBotAddress;
