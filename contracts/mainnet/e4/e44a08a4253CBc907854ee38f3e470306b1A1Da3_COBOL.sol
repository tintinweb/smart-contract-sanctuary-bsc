...
contract COBOL is Context, IERC20, Ownable {
    ...
    string private constant _name = "PLUS COBOL"; // 
    string private constant _symbol = "PLUS COBOL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA2F9B0960248B9A0100DfE7fB51D87Ea58351C67;
