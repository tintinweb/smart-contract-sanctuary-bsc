...
TG: https://t.me/kingsatoshinakamoto
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf10383FdF0B0734b7934be3EBD090f670CcE70dc; // owner address
...
contract KingSatoshi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King SatoshiNakamoto";
    string private _symbol = "KINGBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf10383FdF0B0734b7934be3EBD090f670CcE70dc); // Marketing Address
    address payable public teamWalletAddress = payable(0xf10383FdF0B0734b7934be3EBD090f670CcE70dc); // Team Address
