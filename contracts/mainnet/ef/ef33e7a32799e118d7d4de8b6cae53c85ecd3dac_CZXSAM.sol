...
CZ X SAM
TELEGRAM: https://t.me/CZXSAM_LFG
...
contract CZXSAM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xb3A91D8bae54103de99A1fA0539864C3DE5C0285); // Marketing Address
        
    address payable public teamAddress =
        payable(0x2deD4c9C3Db4A0F5368B65Ddc7BFF835eA583f15); // Team Address
        
    address payable public liquidityAddress =
        payable(0xb3A91D8bae54103de99A1fA0539864C3DE5C0285); // Liquidity Address
    ...
    string private constant _name = "CZ X SAM";
    string private constant _symbol = "$CXS";
