...
We will stealth launch soon🚀🚀
So keep an eye on the chat and stay tuned.

E-sport Doge is a Memecoin under the Binance Smart Chain, fastest growing ecosystem in crypto, with thousands of projects spanning NFT, Web3, Play to Earn and more.

OUR PROJECT👇
➡️ E-SPORT DOGE STAKING
➡️ E-SPORT DOGE NFT
➡️ E-SPORT DOGE PLAY TO EARN
...
Telegram group : https://t.me/EsportDoge
Twitter : https://twitter.com/EsportDoge
Website: https://esportp2e.tech/
*/
...
contract EsportDoge is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 1e9; // KILL ZERO    
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Esport Doge"; // token name
    string public _symbol = "EDOGE"; // token ticker
    ...
    uint256 private minTokenToSwap = 12500000000000 * 1e9; 
    uint256 private maxHoldingAmount = 10000000000000000 * 1e9;
    uint256 private minBuyLimit = 10000000000000000 * 1e9;
    ...
    uint256 public liquidityFeeOnSelling = 50;
