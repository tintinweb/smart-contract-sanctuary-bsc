...
using Address for address;
  ...
  event SwapTokensForETH(uint256 amountIn,address[] path );
    ...
    address public teamWallet = 0x93cD1F36dd50037a437Ce5BD69fDB44f6C968f45;
    address public marktingWallet = 0x9668f6Eb0e16FE8ba10CD1FB6B0A1c1fAb9aDc05;
    ...
    function _transfer(address from , address to , uint256 amount) internal returns(bool) {
        ...
        if(_ismobility) {
           ...
           if(_lock){
            ...
            if(IERC20(cake).balanceOf(address(this)) >= minEthVal) {
