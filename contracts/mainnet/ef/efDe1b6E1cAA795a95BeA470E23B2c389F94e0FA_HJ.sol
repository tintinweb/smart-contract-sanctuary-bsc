...
contract HJ is IERC20, Ownable {
    ...
    TokenDistributor public _xDistributor;
    ...
    constructor (
        ...
        _x = 0x55d398326f99059fF775485246999027B3197955;
        ...
        fundAddress = 0xB98EC5928Ae244e717DB686E4576606799CEe155;
        devAddress = 0xB98EC5928Ae244e717DB686E4576606799CEe155;
        senondDevAddress = 0xB98EC5928Ae244e717DB686E4576606799CEe155;
        ...
        _xDistributor = new TokenDistributor(_x);
    }
    ...
    function swapUsdtForx() private  {
        ...
        _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            ...
            0,
            path,
            address(_xDistributor),
            block.timestamp
        );

        IERC20 x = IERC20(_x);

        x.transferFrom(address(_xDistributor), address(this), x.balanceOf(address(_xDistributor)));
    }
    ...
    function setDevAddress(address firstAddr,address secondAddr) external onlyOperator {
    ...
    function processReward(uint256 gas) private {
        ...
        uint256 balance = x.balanceOf(address(this));
