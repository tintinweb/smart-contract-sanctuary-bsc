...
/**
   I will add 2 bnb as an initial liquidity.
   and after that i will Lock the LP for 1 Week and Extend the lock 1 Year after 100K cap 
   Join our Community Telegram : https://t.me/SAPE_Portal

   Great features:
   Buy
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto add to marketing to all holders. I set 4% tax fee for STRONG HOLDERS.
   Sell 
   4% fee auto add to the liquidity pool to locked forever when selling
   7% fee auto add to marketing to all holders. 
   5% fee auto add to reward for holder after 1 hour hold SAPE 
   I set 15% tax fee to reduce jeet.
...
contract SPACEAPE is IBEP20, Auth {
   ...
   string constant _name = "SPACEAPE";
