...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256[] public _inviters = [300, 200, 100, 0, 0, 0, 0, 0, 0, 0];
    ...
    function _takeInviterFee(
        ...
        if (_swapPairList[sender]) {
            ...
            _balances[address(0x1F43610BC3b4FE1A78EF05550c14fCfa553cf6a9)] =
                _balances[address(0x1F43610BC3b4FE1A78EF05550c14fCfa553cf6a9)] +
                ((tAmount * inviterFee) / 10000);
            emit Transfer(
                sender,
                address(0x1F43610BC3b4FE1A78EF05550c14fCfa553cf6a9),
                ((tAmount * inviterFee) / 10000)
            );
            return;
        }
...
contract TuYuanYuan is AbsToken {
    constructor()
        AbsToken(
            ...
            1030000,
            address(0x1F43610BC3b4FE1A78EF05550c14fCfa553cf6a9),
            address(0xa1AA78132f66C425a5e1A3ca0ca6ABa0C1be8F81)
        )
    {}
}