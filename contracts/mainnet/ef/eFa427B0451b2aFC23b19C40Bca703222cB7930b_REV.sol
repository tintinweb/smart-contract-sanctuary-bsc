...
contract REV is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1A684379C2313Af61D911a30456EAAFFF3a1182D); // Marketing Address
    address payable public teamWalletAddress = payable(0x8a9A2C24320eb8b4b5055735C3d1A01a0EbfFB3E); // Team Address
