...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6395083927300804F9F41274a29a92Facc6DDEBd; // owner address
...
contract CEZZAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CEZZAR";
    string private _symbol = "CEZZAR"; 
