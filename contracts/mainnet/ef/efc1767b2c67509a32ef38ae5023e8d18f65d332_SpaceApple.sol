...
contract SpaceApple is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space Apple";
    string private _symbol = "SAPPLE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00F88C7d0EE9330dfBdBB08Dad7fa5B477e83A2D);
