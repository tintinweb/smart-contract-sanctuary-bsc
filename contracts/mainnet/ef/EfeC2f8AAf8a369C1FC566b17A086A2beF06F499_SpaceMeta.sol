...
// File: contracts/interfaces/IPinkAntiBot.sol
...
contract SpaceMeta is ERC20, Ownable, BaseToken {
  ...
  constructor(
    ...
    address[5] memory addrs, // reward, router, marketing, dividendTracker, pinkAntiBot
    ...
    // Dividend tracker initialization
    ...
    // UniswapV2Router initialization
    ...
    // PinkSale Anti-Bot initialization
  ...
  function _transfer(
    ...
    if (
      ...
      uint256 teamTokens = contractTokenBalance.mul(marketingFee).div(
        totalFees
      );
