...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE2EB3CA44E48dF53DceF4FDA610153BaFB306937; // owner address
...
contract SquidClausOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidClause";
    string private _symbol = "SC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE2EB3CA44E48dF53DceF4FDA610153BaFB306937); // Marketing Address
    address payable public teamWalletAddress = payable(0xE2EB3CA44E48dF53DceF4FDA610153BaFB306937); // Team Address
