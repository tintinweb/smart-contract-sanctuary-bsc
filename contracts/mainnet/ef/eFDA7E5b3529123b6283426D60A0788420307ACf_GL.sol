...
contract GL is Context, IERC20, Ownable {
    ...
    uint256 public _totalTaxBuy = _marketingFeeBuy;
    uint256 public _totalTaxSell = _marketingFeeSell;
    ...
    function updateMarketingBuyFee(uint256 value) external onlyOwner {
        _marketingFeeBuy = value;
        _totalTaxBuy = _marketingFeeBuy;
        require(_marketingFeeBuy <= 25, "Total buy fee is over 5%");
    }

    function updateMarketingSellFee(uint256 value) external onlyOwner {
        _marketingFeeSell = value;
        _totalTaxSell = _marketingFeeSell;
        require(_marketingFeeSell <= 25, "Total fee is over 5%");
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(tradeStart || isExcludedFromFee[sender] || isExcludedFromFee[recipient]);
