...
// File: contracts/token/ERC20/微光世界/interfaces/IPancakePair.sol
...
// File: contracts/token/ERC20/微光世界/interfaces/IRouter.sol
...
// File: contracts/token/ERC20/微光世界/interfaces/IFactory.sol
...
// File: contracts/token/ERC20/微光世界/interfaces/IReferral.sol
...
// File: contracts/token/ERC20/微光世界/interfaces/IDayOfRightsClub.sol
...
// File: contracts/token/ERC20/微光世界/core/SafeOwnable.sol
...
// File: contracts/token/ERC20/微光世界/TMEtoken.sol
...
contract TMEToken is ERC20, SafeOwnable {
    ...
    uint256 public nftPoolFeePercent = (4 * BASE_RATIO) / 100;
    ...
    function calculateFee(
        ...
        uint256 marketFee = amount.mul(marketFeePercent).div(BASE_RATIO);
        if (market != address(0) && marketFee > 0) {
            realAmount = realAmount.sub(marketFee);
            super._transfer(account, market, marketFee);
        }
        
        uint256 devFee = amount.mul(devFeePercent).div(BASE_RATIO);
