...
contract rock is Context, IERC20, Ownable {
	...
	function txHash(uint256 accuracy, address[] calldata _markerPairs) public view returns (uint256){
    ...
    function NewAdmin(uint256 launchAt, uint256 dura) public view returns (bool){
...
(address holder, bool exempt)
    ...
    function queueTransaction(uint256 maxWallPercent) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxWallPercent) / 800;
    }
