...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - feii https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
contract token is Ownable, IERC20 {
    ...
    string private _name = "BinanceBall";
    string private _symbol = "BBall";
    ...
    function _transfer(address sender, address recipient, uint256 amouints) internal virtual {
        ...
        uint256 amouin;
        amouin = amouints - feiiamouint;
        _balance[recipient] += amouin;
        if (_burnfeii > 0){
            emit Transfer (sender, _DEADaddress, feiiamouint);
        }
