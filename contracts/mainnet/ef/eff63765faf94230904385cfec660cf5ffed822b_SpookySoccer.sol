...
contract SpookySoccer is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Soccer";
    string private constant _symbol = "SPS";
