 ...
 *A utility cryptographic decentralized token issued by the Company based on the Ethereum protocol (ERC20 token) 
 *being the token which can be used by participants to acquire DCAP Ecosystem Tokens.
*/
...
contract DCAP is PausableToken {
    string public name;
