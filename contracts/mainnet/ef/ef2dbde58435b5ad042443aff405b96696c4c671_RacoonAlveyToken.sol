...
/*
   🦡🦡 Racoon Alvey 🦡🦡
    ...
    Racoon Alvey is a community-driven token and decentralized meme coin in Binance Smart Chain with Safu Dev & Team
    Team has a lot of plans for this project.

    Telegram : https://t.me/RacoonAlvey
    Twitter : https://twitter.com/RacoonAlvey
*/
interface IERC20 {
...
contract RacoonAlveyToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8808808 * 10**9;
    uint256 public _maxTxAmount = 8808808 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Racoon Alvey"; //
    string private constant _symbol = "RCA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xa7AbCF6Ea4Aeb0aB14980991746591B977fc4506;
