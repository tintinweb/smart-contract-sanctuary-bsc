...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaf146ab91f3B406934d12194Eb28fb0Fa8A3EaA8; // owner address
...
contract ZILLABONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZILLA BONK";
    string private _symbol = "ZLB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaf146ab91f3B406934d12194Eb28fb0Fa8A3EaA8); // 
    address payable public teamWalletAddress = payable(0xaf146ab91f3B406934d12194Eb28fb0Fa8A3EaA8); // 
