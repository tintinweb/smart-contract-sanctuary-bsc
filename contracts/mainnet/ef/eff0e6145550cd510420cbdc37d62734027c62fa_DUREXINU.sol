...
Durex inu aims to be one of the largest community tokens that will provide our holders with the best returns and lots of development for the long term.
Just Buy and Hold and you will get a lot of profit.
...
contract DUREXINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DUREX INU ";
    string private _symbol = "DURXINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35F6C874C166bCDD65B163Ae595e10b1e81f96A3);
    address payable public teamWalletAddress = payable(0x35F6C874C166bCDD65B163Ae595e10b1e81f96A3);
