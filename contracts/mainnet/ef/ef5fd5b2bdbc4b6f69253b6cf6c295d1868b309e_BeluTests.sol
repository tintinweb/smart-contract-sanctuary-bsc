...
contract BeluTests is ERC20, Ownable {
    ...
    PriceandliqAccounts public _priceandliqAccounts = PriceandliqAccounts({
        priceandliqaccount1: payable(_priceandliqAccount1),
        priceandliqaccount2: payable(_priceandliqAccount2),
        priceincrease: payable(_priceIncrease)
        });
