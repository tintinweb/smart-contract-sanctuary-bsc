...
//Telegram:https://t.me/Floki3bscOfficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32Fb8D2deB5759745FBd98482480ABD6F0C36969;
...
contract floki3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki 3.0"; // 
    string private constant _symbol = "$FLOKI 3.0"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x32Fb8D2deB5759745FBd98482480ABD6F0C36969);
