...
contract kashukhiinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "KashukhiInu"; // 
    string private constant _symbol = "$KAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xEa6EC14cE7F2a169CBa6F25ecFc212fEcf5fE4Ae;
