...
contract SnowflakeFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SnowflakeFlokiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Snowflake Floki", "SFLOKI") {
        marketingWallet = payable(0x551AaBc3C4429877D3e760FF541AC27DA47aAD5c);
        devWallet = payable(0x5f3295f1C026117dd3658209a783211994e10a95);
        ...
        dividendTracker = new SnowflakeFlokiDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "SnowflakeFlokiTRACKER",
            "SFLOKITRACKER"
        );
...
contract SnowflakeFlokiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SnowflakeFloki public SnowflakeFlokiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SnowflakeFlokiContract = SnowflakeFloki(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SnowflakeFloki_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SnowflakeFloki_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SnowflakeFloki contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SnowflakeFlokiContract);

            uint256 prevBalance = SnowflakeFlokiContract.balanceOf(address(this));
            ...
            {
                uint256 received = SnowflakeFlokiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SnowflakeFlokiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
