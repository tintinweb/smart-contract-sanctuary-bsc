...
//
// $LEVEL offers long term security and passsive income in BUSD.
//
// AUTOMATIC DIVIDEND YIELD PAID IN BUSD! With the auto-claim feature,
// simply hold $LEVEL and you receive BUSD automatically in your wallet.
// 
// Hold LEVEL and get rewarded in Busd on every transaction!
//
...
contract LevelTokenTrial2 is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() BEP20("Level Token Trial 2", "LEVELT2") {
