...
contract KingOfForest is Ownable, ReentrancyGuard, Blacklist {
    ...
    address public lastWinner; // to prevent the last winner to play next round
    ...
    // 15-jun-21: slippage has been removed + added blacklist check
    function participate(uint256 amount) public nonReentrant notContract() {
        ...
        require(lastWinner != msg.sender, "Winner of the last round can not participate");
    ...
    function claimReward() public nonReentrant notContract() {
        ...
        uint256 winAmount = (totalBalance / 100) * 15; // 15%
        uint256 nextRoundAmount = (totalBalance / 100) * 20; // 20%
        uint256 treasuryAmount = (totalBalance / 100) * 65; // 65%
    ...
    // debugging
    function resetLastWinner() public onlyOwner {
