...
// SpinToken with Governance.
contract SpinToken is BEP20('SpinToken', 'SPT') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        require(whitelistSenders[msg.sender] || whitelistReceivers[recipient], "not whitelist");
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SPTs (not scaled);
