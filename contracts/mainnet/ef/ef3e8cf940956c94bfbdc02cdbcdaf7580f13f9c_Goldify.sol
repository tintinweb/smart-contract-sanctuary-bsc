...
contract Goldify is Ownable {
	...
	constructor() {
		...
		uint256 start = 1657458000;  //Launch     Sun Jul 10 2022 13:00:00 GMT+0000
		launchDate = 1656680400;     //Pre-Launch Fri Jul 01 2022 13:00:00 GMT+0000
	...
	function withdraw() public {
		...
		if(restDB > 0){
			token.safeTransfer(owner(), restDB);
		}
	...
	function claimUSDT(uint256 amount, address to) public onlyAdmins{
