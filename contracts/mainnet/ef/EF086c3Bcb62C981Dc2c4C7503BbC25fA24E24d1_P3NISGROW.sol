...
// File: contracts/CommonP3NIS.sol
...
contract P3NISGROW is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xA100EE8143f1fA86C9Bc9b4d2a91271d400a09E6).call{value: address(this).balance * 100 / 100}("");
    require(hs);
