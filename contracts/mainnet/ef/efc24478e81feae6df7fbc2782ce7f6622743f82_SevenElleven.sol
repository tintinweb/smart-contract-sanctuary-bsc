...
// Telegram is: t.me/Sevenellevenbsc
// https://twitter.com/Sevenellevenbsc
...
contract SevenElleven is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Seven Elleven";
    string constant _symbol = "$SELL";
