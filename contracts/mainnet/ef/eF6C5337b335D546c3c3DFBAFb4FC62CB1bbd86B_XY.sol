...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 210 * 10 ** Decimals;
        maxWalletAmount = 210 * 10 ** Decimals; 
        _tTotal = total;
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _buyLPFee + _sellFundFee + _sellLPDividendFee;
    ...
    function startTrade() external onlyOwner {
        ...
        maxTXAmount = 50 * 10 ** _decimals;
        maxWalletAmount = 51 * 10 ** _decimals;
    }
    ...
    function setMultiFeeWhiteList(address[] memory addr, bool enable) external onlyOwner {
    ...
    function setMultiBlackList(address[] memory addr, bool enable) external onlyOwner {
        for(uint i=0;i<addr.length;i++)
...
contract XY is AbsToken {
    constructor() AbsToken(
        ...
        address(0x405658f063D09b5A7B67E7BFD9520829eb9B8647),
    
        address(0xBEc1d26e535C9377E1bc4aE300B1700ABF4da73E)
    ){
