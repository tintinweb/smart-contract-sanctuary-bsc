...
contract deadline is Context, IERC20, Ownable {
    ...
    string private _name = "Lunakiller";
    string private _symbol = "Lunakiller";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x74430B3301506D7B12db33b35BFA6352D1768C8B));
        marketingWalletAddress = payable(address(0x4e19c6a61c6a1978d864dEc71c1F7DcCfE254421));
