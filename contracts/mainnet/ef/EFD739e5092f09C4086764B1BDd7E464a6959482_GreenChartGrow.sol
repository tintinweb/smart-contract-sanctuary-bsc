...
TG portal https://t.me/GreenChartGrow
...
contract GreenChartGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Chart Grow";
    string private constant _symbol = "GCG";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000 * 10**_decimals;

    uint256 public _maxWalletAmount = 200* 10**_decimals;
    uint256 public _maxTxAmount = 200* 10**_decimals;
    uint256 public swapTokenAtAmount = 200 * 10**_decimals;
