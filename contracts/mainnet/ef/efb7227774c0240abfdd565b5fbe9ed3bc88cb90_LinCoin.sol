...
contract LinCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "LinCoin";
    string private _symbol = "LinCoin";
	...
	function getLinCoinFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
