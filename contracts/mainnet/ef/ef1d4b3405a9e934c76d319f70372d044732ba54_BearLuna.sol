...
contract BearLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BearLuna";
    string private _symbol = "BearLuna";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71296c1c658F23172A5928383E0C9841800A5C04); // Marketing Address
    address payable public teamWalletAddress = payable(0x77921aC28093CeAeF19FcEa32b51821483942796); // Team Address
