...
contract OmniInvisible is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 710;
    uint256 MAX_MINT_BSC = 1420;

    uint gasForDestinationLzReceive = 350000;

    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("OmniInvisible", "OI") { 
        _owner = msg.sender;
    ...
    function withdraw() external onlyOwner {
        ...
        require(sent, "Failed to withdraw BSC");
    }
