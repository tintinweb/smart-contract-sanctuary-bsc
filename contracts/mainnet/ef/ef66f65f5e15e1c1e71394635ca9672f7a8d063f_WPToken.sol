...
contract WPToken is ERC20, Ownable {
    ...
    uint256 public bonousFee;

    uint256 public AmountLiquidityFee;
    address public marketingWalletAddress;
    address public bonousWalletAddress;

    uint256 public AmountMarketingFee;
    uint256 public AmountbonousFee;
    ...
    constructor(
        ...
        bonousWalletAddress = bonousWalletAddr_;

        liquidityFee = feeSetting_[0];
        marketingFee = feeSetting_[1];
        deadFee = feeSetting_[2];
        tokenRewardsFee = feeSetting_[3];
        bonousFee = feeSetting_[4];

        require(liquidityFee.add(marketingFee).add(deadFee).add(tokenRewardsFee).add(bonousFee) <= 25, "Total fee is over 25%");
    ...
    function setbonousWallet(address payable wallet) external onlyOwner{
        bonousWalletAddress = wallet;
    }
    ...
    function setbonousFee(uint256 amount) public onlyOwner {
        bonousFee = amount;
    }
