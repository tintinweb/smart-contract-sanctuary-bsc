...
contract HHS is Context, IERC20, Ownable {
    ...
    string private _name = "HHS";
    string private _symbol = "HHS";
    ...
    uint256 public takeLPRewardAmount = 100000 * 10**18;
    ...
    address public developerAddress = address(0xd2dCC8C0F9446BD19423c462C488C8402Da637de);
    ...
    constructor() public {
        ...
        _isExcludedFromFee[address(0x3f2392E73f5DAE507b98fD1893f842381Fb361c7)] = true;
        _isExcludedFromFee[address(0x83724a543Dd74786DFC51d9daE438364cADA019E)] = true;
        _isExcludedFromFee[address(0x26336054E08f32E16Cd3215291947DF8AE6A7290)] = true;

        turnOffOwner[ownerAddress] = true;

        _totalSupply = 210000000 * 10**18;
        _balances[address(0x3f2392E73f5DAE507b98fD1893f842381Fb361c7)] = 194950000 * 10**18;
        _balances[address(0x83724a543Dd74786DFC51d9daE438364cADA019E)] =  15000000 * 10**18;
        _balances[address(0x26336054E08f32E16Cd3215291947DF8AE6A7290)] =     50000 * 10**18;

        emit Transfer(address(0), address(0x3f2392E73f5DAE507b98fD1893f842381Fb361c7), 194950000 * 10**18);
        emit Transfer(address(0), address(0x83724a543Dd74786DFC51d9daE438364cADA019E),  15000000 * 10**18);
        emit Transfer(address(0), address(0x26336054E08f32E16Cd3215291947DF8AE6A7290),     50000 * 10**18);

        doAddKol(address(0x4411121d83dA161854deee2B803Fe82aC92Dc9a0));
    }
