...
/**
Telegram: https://t.me/Bnb_o_spooky
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x9F727006744B1562f4B179b8643515811B924651;
...
contract BnboSpooky is Context, IERC20, Ownable { 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x9F727006744B1562f4B179b8643515811B924651), BNB_Tot);
            }
