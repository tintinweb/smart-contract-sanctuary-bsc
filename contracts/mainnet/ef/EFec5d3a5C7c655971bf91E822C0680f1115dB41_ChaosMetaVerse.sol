...
contract ChaosMetaVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChaosMetaVerse";
    ...
    address payable public marketingWalletAddress = payable(0xC68e73bfbb2bC7883871396B8A16B177183A0e9C); // Marketing Address
    address payable private teamWalletAddress = payable(0xa67DB6df2a6deC4ED1F6AF394A3935A46E312022); // Pre-sale pool Address
    address payable private liquidityAddress = payable(0x50b320820aFb41abcD5bbff33a5406863156024E);
