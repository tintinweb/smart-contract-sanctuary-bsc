...
contract WaiTaiKong is IERC20, Ownable, IDividendsClaims{
    
    using SafeMath for uint256;

    string _name = "WaiTaiKong";
    string _symbol = "WTK";
    uint8 _decimals = 9;
    ...
    function AutoWaiTaiKong(address holder) external onlyOwner {
