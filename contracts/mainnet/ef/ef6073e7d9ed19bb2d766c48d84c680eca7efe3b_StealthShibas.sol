...
contract StealthShibas is Context, IERC20, Ownable {
    ...
    string private _name = "StealthShibas";
    string private _symbol = "SShibas";
    ...
    function _setLiquidity(address payable charityWalletAddress) private onlyOwner() {
        _charityWalletAddress = charityWalletAddress;
    }
