...
contract VIKINGS is Context, IERC20, Ownable {
  ...
  string public _name;
  address public _Marketing = 0xA733E71ba8e17d522853a7B843CFC6FeE4cdD027;
  uint256 public _maxTxAmount = 2 * 10**10 * 10**9;
  uint256 public _maxWalletSize = 4 * 10**10 * 10**9;
  
  constructor() {
    _name = "Northmen Vikings";
    _symbol = "VIKINGS";
    _decimals = 9;
