...
contract BABYPEPAGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby PePa GPT";
    string private constant _symbol = "PEPAGPT";
