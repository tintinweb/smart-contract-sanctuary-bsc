...
welcome to Neymar the goat

telegram link
: https://t.me/neymarthegoat
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA9AA7130EA50B7C4C77931ca7ba8fEb0C2C2eE5B; // whatDOGE
...
contract NEYMARTHEGOAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neymar The Goat";
    string private _symbol = "NTG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA9AA7130EA50B7C4C77931ca7ba8fEb0C2C2eE5B); // Marketing Address
    address payable public teamWalletAddress = payable(0xA9AA7130EA50B7C4C77931ca7ba8fEb0C2C2eE5B); // Team Address
