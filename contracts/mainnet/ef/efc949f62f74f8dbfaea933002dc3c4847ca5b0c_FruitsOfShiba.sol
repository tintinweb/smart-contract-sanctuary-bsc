...
/**Very basic we have a ultra bullish name & a meta that's yet to hit 👀

 @fruitsofryoshi is sitting at 15m+ it launched yesterday lowcap on dogechain .
  For those of you here who don't know ryoshi is the shib dev. So we have fruits 
  of Shiba! Being this early into a new meta we have no ceiling. Early (pvt group 
  shilling organic word of mouth) paid calls start later fruits of ryoshi hardly had 
  any paid calls f.y.i
...
contract FruitsOfShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FruitsOfShiba";
    string private _symbol = "PLUM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbff9818A864b0E341DCc57760c665316E341224A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbff9818A864b0E341DCc57760c665316E341224A); // BuyBack Address
