...
contract TeslaKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeslaKiller";
    string private _symbol = "TeslaKiller";
    ...
    address payable private marketingWalletAddress = payable(0x3871077953592543B861731d2E9fAe1364fe7437);
