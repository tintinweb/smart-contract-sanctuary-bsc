...
//telegram:https://t.me/GrimaceTwoZero
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4322d5D78A005d2EbCA20528f49fC74607245b1B;
...
contract GrimaceTwoZero is Context, IERC20, Ownable {
    ...
    string private constant _name = "GrimaceCoin 2.0"; // 
    string private constant _symbol = "GRIMACE2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x4322d5D78A005d2EbCA20528f49fC74607245b1B);
