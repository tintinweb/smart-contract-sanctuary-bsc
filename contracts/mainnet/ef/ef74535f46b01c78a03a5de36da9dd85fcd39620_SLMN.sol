...
contract SLMN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SOLMOON";
    string private _symbol = "SLMN";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x631c0247FB00eDBE00BfC0bECec7f4e5F8D1b55a); // Marketing Address
    address payable public BuyBackWallet = payable(0x631c0247FB00eDBE00BfC0bECec7f4e5F8D1b55a); // Team Address
