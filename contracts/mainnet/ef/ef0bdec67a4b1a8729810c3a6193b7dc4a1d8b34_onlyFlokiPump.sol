...
/**
Only FlokiPump ( OFP ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future
...
WEB: https://OnlyFlokiPump.finance
TG:https://t.me/OnlyFlokipump
*/
...
contract onlyFlokiPump is IERC20, Ownable {
