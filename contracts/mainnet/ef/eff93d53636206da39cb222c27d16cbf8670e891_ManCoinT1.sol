...
contract ManCoinT1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ManCoin";
    string private _symbol = "ManCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc44dB78f3f97bCCE78c2D9989a0CC373424C89CC);
    address payable public teamWalletAddress = payable(0xa723512c13d6Ee58E47da7D97b535D9df292A878);
    ...
    uint256 public _walletMax =     50 * 10** 6 * 10**_decimals;
