...
/**
 ...
 Telegram: https://t.me/EmeraldShibaInu
 
 Twitter: https://twitter.com/EmeraldShibaInu
...
contract EMERALDSHIBAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Emerald Shiba Inu";
    string private _symbol = "EMERSHIB";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xAc69820894c25C443D4220c455E71ef9C6BA04cA);
    address payable public teamWalletAddress = payable(0xF3FEbBEe3C0E1DF0d0477a9747863f09D8b9f57d);
