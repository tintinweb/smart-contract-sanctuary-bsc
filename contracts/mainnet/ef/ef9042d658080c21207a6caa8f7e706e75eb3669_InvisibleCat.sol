...
contract InvisibleCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xDA01D00A7960dF8fA42feCf0B806A2c72D726028); // Marketing Address
    address payable public devWalletAddress = payable(0xDA01D00A7960dF8fA42feCf0B806A2c72D726028); // Dev Address
    ...
    string private _name = "InvisibleCat";
    string private _symbol = "InvisibleCat";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xDA01D00A7960dF8fA42feCf0B806A2c72D726028, 'We can not exclude Uniswap router.');
