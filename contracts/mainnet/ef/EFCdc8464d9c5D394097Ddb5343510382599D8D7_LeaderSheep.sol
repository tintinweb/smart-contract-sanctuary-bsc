...
contract LeaderSheep is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Leader Sheep";
    string private _symbol = "Leader Sheep";
    ...
    address payable public marketingWalletAddress = payable(0x288ac275295e45aF0565200390E11D5565319527);
    address public liquidityWalletAddress = 0x9aC0E1AFDc673d163061b9365f2E05D45B607388;
    ...
    function setLimitTransaction(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= _totalSupply.div(200));
    ...
    function setLimitAll(uint256 _newLimit) external onlyOwner{
        require(_newLimit * 10**_decimals >= _totalSupply.div(200));
    ...
    function setLimitWallet(uint256 newLimit) external onlyOwner {
        require(newLimit >= _totalSupply.div(200));
        _walletMax  = newLimit;
    }
    ...
    uint256 public deservedPercentSell = 85;
