...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28D1a85F067C0960416823A6BfA83479d0967Ceb; // owner address
...
contract CATAIBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT AI BURN";
    string private _symbol = "CATAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28D1a85F067C0960416823A6BfA83479d0967Ceb); // Marketing Address
    address payable public teamWalletAddress = payable(0x28D1a85F067C0960416823A6BfA83479d0967Ceb); // Team Address
