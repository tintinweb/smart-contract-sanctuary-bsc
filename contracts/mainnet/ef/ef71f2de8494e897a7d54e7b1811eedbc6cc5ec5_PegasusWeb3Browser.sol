...
/**
Pegasus Web3 Browser

Telegram : https://t.me/thepegasusofficial
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 12 Months");
...
contract PegasusWeb3Browser is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PegasusWeb3Browser";
    string private _symbol = "$PEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1131AF79b59F1451565cE3C3E5B57DE2Ec9bcF95); 
    address payable public buyBackWalletAddress = payable(0x1131AF79b59F1451565cE3C3E5B57DE2Ec9bcF95); 
