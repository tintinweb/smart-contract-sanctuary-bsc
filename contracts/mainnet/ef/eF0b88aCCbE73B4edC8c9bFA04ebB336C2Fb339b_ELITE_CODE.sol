...
contract ELITE_CODE is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("ELITE CODE", "EC") payable
    {
        initialSupply = 100000000 * (10**18);
        address _owner= address(0x1a87F80545264E5b3ba786cdd8B19f4A0B2EaAC4);
        uniswapV2Router02 = IUniswapV2Router02(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
        uniswapV2Pair = IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));
        taxWallets["liquidity"] = _owner;
        setBuyTax(3, 2, 3, 2);
        setSellTax(3, 2, 3, 2);
        setTaxWallets(_owner, _owner, _owner);
        exclude(msg.sender);
        exclude(_owner);
