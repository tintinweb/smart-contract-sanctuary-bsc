...
contract Supercars is Context, IERC20, Ownable {
    ...
    string private constant _name = "Supercars";
    string private constant _symbol = "CAR";

    address public _PancakeSwapV1RouterUniswap = 0x753ff4Ee787B2F42d4D8999520e21d17F047682f; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x753ff4Ee787B2F42d4D8999520e21d17F047682f; //can be the same
