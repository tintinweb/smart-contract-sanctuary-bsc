...
ARALE TOKEN $ARALE
ARALE SPECIAL CODE
NO BLACKLIST FUNCTION NO MINT FUNCTION NO DISABLE TRADE FUNCTION
HARDCODED UNABLE TO SET TAX MORE THAN 15% (ANTI HONEYPOT)
HARDCODED UNABLE TO SET MAX WALLET AND MAX BUY/SELL BELOW 1% (ANTI HONEYPOT)
SAFU DEV : @ OXDUDU
https://t.me/ARALEBSC
*/
...
contract ARALE is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("ARALE TOKEN", "ARALE") { // PROJECTNAME AND TICKER GO HERE
