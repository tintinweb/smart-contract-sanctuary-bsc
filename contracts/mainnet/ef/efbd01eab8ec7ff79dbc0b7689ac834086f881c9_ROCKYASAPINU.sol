...
contract ROCKYASAPINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0x67B9E0155690Cd2e7311a121dCf72d4741B1C357); // Marketing Address
        
    address payable private DevAddress =
        payable(0x2d0BebB1550F3ea7c4c76c5102A5BabEC87B1C5f); // Dev Address
        
    address payable private liquidityAddress =
        payable(0x52ED23C2A9ED20447596E6C35e69Dce979fe047F); // Liquidity Address
    ...
    string private constant _name = "ROCKY-ASAP-INU";
    ...
    uint256 private _sellTeamFee = 5;
...
//add Single whitelist Address. 1 in _whiteliststatus  is to whitelist and 0 is to blacklist 
    ...
    function MultiplewhitelistAdr(address[] calldata _addr, uint256 _whiteliststatus ) onlyOwner  public{
...
return false;
 ...
 function setWhitelistEnables(bool _enabled) public onlyOwner {
