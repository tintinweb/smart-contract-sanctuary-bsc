...
contract NEXUSPAD_PROTOCOL is ERC20, Ownable {
    ...
    constructor () ERC20("NEXUSPAD PROTOCOL", "NEXUS") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x1363C821c684C46B3147d14cfb5658Ef208A0769;
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || to != uniswapV2Pair) {
            _totalFees = 0;
        } else {
