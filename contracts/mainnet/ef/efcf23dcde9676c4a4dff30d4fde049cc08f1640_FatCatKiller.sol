...
contract FatCatKiller is Context, IERC20, Ownable {
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _name = "Fat Cat Killer";
        _symbol = "$killer";
        _decimals = 9;
        _totalSupply = 900000000000000 * 10**_decimals;
        _maxTxAmount = _totalSupply * 10/100; 
        _walletMax = _totalSupply * 20/100;
        minimumTokensBeforeSwap = _totalSupply *1/10;
