...
contract TripaSeca is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TriPaSeCa";
    string constant _symbol = "TRiPa";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 65; // 1,5%
    ...
    uint256 marketingSellFee = 1700;
    uint256 totalSellFee = 1900;
