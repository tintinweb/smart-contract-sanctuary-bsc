...
contract YFIC is YFICDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private YFICTeam;
    address private CharityYFIC;
    ...
    string public override name = "Yearn Cash";
    string public override symbol = "YFIC";
    ...
    constructor(uint totalSupplyValue, address YFICTeamAddress, address CharityYFICAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        YFICTeam = YFICTeamAddress;
        CharityYFIC = CharityYFICAddress;
       
        // split the tokens according to agreed upon percentages
        balances[YFICTeam] =  totalSupply * 4 / 100;
        balances[CharityYFIC] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's YFICTeam pot
