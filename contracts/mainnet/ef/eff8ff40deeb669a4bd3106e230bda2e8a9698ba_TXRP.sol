...
/*
TXRP，从 1,000 美元市值到 100,000 美元市值
🔥经济模式
1、共发行10亿枚，其中50%在线销毁。
2、滑点2%，加入流动性池1%，营销钱包1%
3.没有团队钱包
...
contract TXRP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TXRP";
    string private _symbol = "TXRP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07CAb1e06744162AF0Ea6Dfd85e6D31cF635346E); // Marketing Address
    address payable public teamWalletAddress = payable(0x07CAb1e06744162AF0Ea6Dfd85e6D31cF635346E); // Team Address
