...
The first MCDonalds Surge Fork!
...
contract mcsrg is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "mcSURGE";
    string private constant _symbol = "mcSRG";
    ...
    //Tax wallets
    address public teamWallet = 0xa924F771dB0067504A079638226B945de96EEbEF;
    address public treasuryWallet = 0x72311036d1E5535318a42D82C54EbFD1AE075d60;
    ...
    //trading parameters
    uint256 public liquidity = 25*10 * 3**_srgDecimals;
