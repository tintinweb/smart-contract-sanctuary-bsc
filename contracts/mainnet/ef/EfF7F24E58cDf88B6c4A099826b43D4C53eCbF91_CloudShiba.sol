...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //Rewards address
    IDEXRouter router;
...
contract CloudShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CloudShiba";
    string constant _symbol = "CS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x27E3F1f2E65005Abb0e8e45d982E29bB056BE7B6;
        teamFeeReceiver = 0x27E3F1f2E65005Abb0e8e45d982E29bB056BE7B6;
        devFeeReceiver = 0x27E3F1f2E65005Abb0e8e45d982E29bB056BE7B6;
    ...
    function ManualSend(uint256 amountPercentage) external {
        require(isLaunched[msg.sender]);
    ...
    function NewSwapAt (uint256 _swapAt) public onlyOwner {
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution, bool _enabled) public onlyOwner {
