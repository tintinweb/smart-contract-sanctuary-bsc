...
A degen play for doge new community , where all holders are recieving 1% of BUSD for every transactions.
https://t.me/DogeNewCommunity
...
*/
    ...
    contract DogeNewCommunity   is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeNewCommunity";
        string private constant _symbol = "DOGENEW";
        ...
        address public constant MarketingWallet=0x923Efb9928f6a153257640942163aA1Bc1d8b898; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function AllowReceiveRewards(address[] calldata addresses) external onlyOwner {
