...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 200000000000 * 10 ** Decimals;
        walletLimit = 200000000000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x213896fe0FeE22214a269aD34719efa227aD63c1;
...
contract ABC is AbsToken {
    constructor() AbsToken(
        ...
        9,
        100000000000000,
        address(0x32728091a51C6153fBC2E6d6EAae1f1B21c74EcE),
        address(0x1e57E3FA7306251916e4B2018429729bDFF52557)
    ){
