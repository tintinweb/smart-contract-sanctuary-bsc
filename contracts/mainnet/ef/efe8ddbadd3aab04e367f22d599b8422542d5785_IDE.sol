...
contract IDE is Operator {
    ...
    string private _name = "IDE";//#币名
    string private _symbol = "IDE";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 100000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 100000000000000 * 1e9);
        ...
        setWhiteList(address(0x656005DEfe84b7672939b7086103BCE062Eed1b3),true);
    }
