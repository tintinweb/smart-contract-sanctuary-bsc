...
contract CaesarVsVenom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CaesarVsVenom";
    string private _symbol = "CvsV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04cFd8D4cE20629c8dC6BcfEDA31Af88aEcFa42E); 
    address payable public BuyBackWalletAddress = payable(0x844AeA09AEb1cE61072e7DaC4e26dAD4Af8b4eB1); 
