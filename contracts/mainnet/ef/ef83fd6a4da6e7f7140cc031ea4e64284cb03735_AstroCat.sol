...
contract AstroCat is ERC20, Ownable {
    ...
    uint256 public marketingBuyFee = 9;
    uint256 public totalBuyFees = rewardBuyFee.add(liquidityBuyFee).add(marketingBuyFee);

    uint256 public rewardSellFee = 0;
    uint256 public liquiditySellFee = 3;
    uint256 public marketingSellFee = 12; // Set to 12% Initially (Anti-Jeet)
    uint256 public totalSellFees = rewardSellFee.add(liquiditySellFee).add(marketingSellFee);

    address payable public  marketingWallet = payable(0xf93310FAD5513295722DF6D9425600870a280a5b);
    ...
    constructor() ERC20("AstroCat", "ASTROCAT") {
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForMarketing = contractTokenBalance.mul(marketingSellFee).div(totalSellFees);
    ...
    function updateBuyFees(uint256 _rewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        rewardBuyFee = _rewardFee;
        liquidityBuyFee = _liquidityFee;
        marketingBuyFee = _marketingFee;
        totalBuyFees = rewardBuyFee.add(liquidityBuyFee).add(marketingBuyFee);
    }

    function updateSellFees(uint256 _rewardFee, uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        rewardSellFee = _rewardFee;
        liquiditySellFee = _liquidityFee;
        marketingSellFee = _marketingFee;
        totalSellFees = rewardSellFee.add(liquiditySellFee).add(marketingSellFee);
    }
