...
Telegram : https://t.me/dubaisafemoon
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1E0195Ca3F1Ba3B5fe46DEC8D81Fd75A3Fba8e13; 
...
contract DubaiSafemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dubai Safemoon";
    string private _symbol = "DSFM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1E0195Ca3F1Ba3B5fe46DEC8D81Fd75A3Fba8e13); // 
    address payable public teamWalletAddress = payable(0x1E0195Ca3F1Ba3B5fe46DEC8D81Fd75A3Fba8e13); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x1E0195Ca3F1Ba3B5fe46DEC8D81Fd75A3Fba8e13)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x1E0195Ca3F1Ba3B5fe46DEC8D81Fd75A3Fba8e13),removeRandom);
}}