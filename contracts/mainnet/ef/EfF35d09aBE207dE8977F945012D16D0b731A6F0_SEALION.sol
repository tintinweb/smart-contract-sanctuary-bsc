...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xecF00c390c7c24048eb600B73D891a2B0dd02763; // owner address
...
contract SEALION  is Context, IERC20, Ownable {
    ...
    string private _name = "SEA LION";
    string private _symbol = "SEA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xecF00c390c7c24048eb600B73D891a2B0dd02763); // Marketing Address
    address payable public teamWalletAddress = payable(0xecF00c390c7c24048eb600B73D891a2B0dd02763); // Team Address
