...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c6b8ddff6DC2164b4dB3bD5fd1D46C0207f82e2; // owner address
...
contract PigCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x21dE1f87888De67d4D584AE527eA96291f8643d9); // Marketing Address
    address payable public teamWalletAddress = payable(0x21dE1f87888De67d4D584AE527eA96291f8643d9); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 12;  // original 10
