...
//TILT Inu
 ...
 /**Elon hyped token - Boolish Name!

    https://twitter.com/elonmusk/status/1529545102447759366
    we just had to make this super quick from Elon tweet. 

    This is a real community driven token with 3% tax and SUPER HYPE!!, website in development, Elon tweet this.

    Features LIQUIDTY LOCKED, RENOUNCED OWNERSHIP, and no dev wallet.
...
contract TILTINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "TILT INU";
    string private constant _symbol = "$TILT";
    ...
    address private marketingWallet = address(0x49232CE3347e06c0a1076beE7e3181d071eB57C2);
    address private liquidityReceiver = address(0x49232CE3347e06c0a1076beE7e3181d071eB57C2);
