...
/**
TELEGRAM:  https://t.me/SquidGrow2BSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20a70064D5ea7D09a0b7cf15B6BA56f0Fbe8773f; //
...
contract SQUID is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 700000 * 10**9; //
    string private constant _name = "SquidGrow 2.0"; // 
    string private constant _symbol = "SQUIDGROW2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xCFc0238Eee2ACd771f911c36aB11DFC9308bC47c); //
