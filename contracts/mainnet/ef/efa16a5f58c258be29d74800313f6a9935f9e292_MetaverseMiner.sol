...
interface MetaverseMinerDeployer {
...
contract MetaverseMiner is MetaverseMinerDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MetaverseMinerTeam;
    address private CharityMetaverseMiner;
    ...
    string public override name = "Metaverse Miner";
    string public override symbol = "Metaverse Miner";
    ...
    constructor(uint totalSupplyValue, address MetaverseMinerTeamAddress, address CharityMetaverseMinerAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaverseMinerTeam = MetaverseMinerTeamAddress;
        CharityMetaverseMiner = CharityMetaverseMinerAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaverseMinerTeam] =  totalSupply * 4 / 100;
        balances[CharityMetaverseMiner] = totalSupply * 4 / 100;
