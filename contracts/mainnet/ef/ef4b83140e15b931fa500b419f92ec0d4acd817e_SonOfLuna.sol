...
THE DEGENS LAUNCH.DEGENS CHOOSING THIS TREND NAME
...
contract  SonOfLuna  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son Of Luna"; // 
    string private constant _symbol = "SOL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x203c04F3B1798a91F017cb20D582afAcA1844a0e;
