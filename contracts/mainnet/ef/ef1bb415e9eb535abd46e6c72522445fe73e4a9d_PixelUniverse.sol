...
contract PixelUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x695088Af54b92BE8d8D6299cCd45a65c45C0C439); // Marketing Address
    ...
    string private constant _name = "Pixel Universe";
    string private constant _symbol = "PIXEL";
