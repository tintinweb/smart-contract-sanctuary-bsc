...
/**
Baby shibu Inu is a MEME token with an upcoming NFT collection born to reward holders with $BUSD rewards on every sell.

Experienced SAFE DEV with well-known past projects.

High $BUSD Rewards (20% on sell)
*/
...
/* Token contract */
contract BabyShibu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x25442d6F582dc3Aa67cD03aF72eDa10B936395d9;
    ...
    // Name and symbol
    string constant _name = "Baby Shibu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (200 mil)
    ...
    uint256 public marketingFeeSell = 92;
    uint256 public devFeeSell = 0;
    uint256 public totalFeeSell = 94;
