...
contract THEWORLDWINToken is IBEP20 {
...
contract THEWORLDWINBUSD {
    address payable admin;
    THEWORLDWINToken public tokenContract;
    ...
    constructor(THEWORLDWINToken _tokenContract, uint256 _tokensSold)  {
