...
The first and only crypto to give back YEEZY merch to it's holders. 
...
contract YEEZY is IBEP20, Auth {
    ...
    string constant _name = "YEEZY";
    string constant _symbol = "YEEZY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2024* (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1200;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x358f226F1c39687FA75A09015FCc01DC9fF5C388;
        ecosystemfeeReceiver = 0xE9216D7ef766A197c8D25A8AA6602F446CE9EC4b;
