...
//OPPA INU COIN IS A COMMUNITY DRIVEN BECAUSE HYPED IS NOW THE OPPOSITE NAME  TOKEN HAS AN POTENTIAL TO BE THE NEXT MOONSHOOT AND A LOT OF CALLS WHEN THE RIGHT MCAP 🔥🔥🚀
//TELEGRAM: https://t.me/OppaInuCoinportal
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x599c81a10947D3b2073528788FC6e0ADCcEA8C8E;
...
contract oppa is Context, IERC20, Ownable {
    ...
    string private constant _name = "OPPA INU"; // 
    string private constant _symbol = "OPPAINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x599c81a10947D3b2073528788FC6e0ADCcEA8C8E);
