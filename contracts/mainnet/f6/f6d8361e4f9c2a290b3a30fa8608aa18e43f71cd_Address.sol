...
contract KIRBRI3 is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   DividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("KIBRI3", "KIRBRI") {
        _buyRewardsFee = 3;
        _buyLiquidityFee = 2;
		_buyMarketingFee = 5;
    ...
    function updatedividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "kirbri The dividend tracker already has that address");

        DividendTracker newdividendTracker = DividendTracker(payable(newAddress));

        require(newdividendTracker.owner() == address(this), "kibri: The new dividend tracker must be owned by the kibri token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "kirbri: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "kibri: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "kirbri: Account is already the value of 'excluded'");
