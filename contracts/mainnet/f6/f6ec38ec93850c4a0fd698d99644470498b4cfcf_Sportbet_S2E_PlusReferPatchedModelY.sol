...
contract Sportbet_S2E_PlusReferPatchedModelY is Ownable {
    ...
    external onlyOwner {
        ...
        require(_maxPoolSize >= 10 && _maxPoolSize <= 30*1e9 , "createGambling: _maxPoolSize should be between 10 S2K and 30 BILLION S2K (ATTENTION: the decimal digits in this contract is 9)!");
    ...
    function withdraw() external onlyOwner {
        ...
        chipToken.safeTransfer(msg.sender, balance);
    }
