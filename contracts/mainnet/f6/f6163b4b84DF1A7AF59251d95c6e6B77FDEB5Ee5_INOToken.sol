...
contract INOToken is ERC721PresetMinterPauserAutoId,ERC721URIStorage {
    ...
    constructor() public ERC721PresetMinterPauserAutoId(
        ...
        "https://ipfs.io/ipfs/QmRcb6Mpwxwnjr3d5hPiXj6vdi4hZv6WGeGQWYgib2BDpA")  {
            _tokenIdTracker._value = 10000000;        
        }
    ...
    function setMarket(address _contract) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "INO NFT: must have pauser role to unpause");
        market = _contract;
    }
}