...
contract Shiko is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax =     10000000000000 * 10**5;
    uint256 public _maxTxAmount =   10000000000000 * 10**5;  
    ...
    uint256 private numTokensSellToAddToLiquidity = 8000 * 10**5;
    ...
    function ExcludefromTxLimit(address holder, bool exempt) external onlyOwner {
    ...
    function setWalletmaxLimit(uint256 newLimit) external onlyOwner {
        _walletMax  = newLimit;
    }

    function enableWalletLimits(bool newValue) external onlyOwner {
       checkWalletLimit = newValue;
    }

    function ExcludefromWalletMaxLimit(address holder, bool exempt) external onlyOwner {
