...
contract SWIFT is Context, IERC20, Ownable {
    ...
    string private _name = "SWIFT";
    string private _symbol = "SWIFT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x198A733650CB40c39C31C410e5F6016c481D276d);
    address payable public teamWalletAddress = payable(0x3Edc487F0D54aeb6499ce40CD92ac2Ac194bEc83);
