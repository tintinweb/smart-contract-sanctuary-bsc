...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb421aDC3E115aba20cF56BBeEf93A1A711670d71; // owner address
...
contract SpookyFeg is Context, IERC20, Ownable {
    ...
    string private _symbol = "$Spkyfg";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF4b2CD22cf9Ef82923b8F65dfB9A52dc0343f635); // Marketing Address
    address payable public teamWalletAddress = payable(0xF4b2CD22cf9Ef82923b8F65dfB9A52dc0343f635); // Team Address
