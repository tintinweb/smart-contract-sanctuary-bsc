...
contract TigeBoy is IBEP20, Ownable {
    ...
    string constant _name = "TIGE BOY";
    string constant _symbol = unicode"TIGEBOY";
    ...
    address private marketingWallet = 0x396540C446dCA368BE721803Af332cfFbD14eEFB;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 5, 1, 0);
    Fees public sellFees    = Fees(1, 5, 1, 0);
