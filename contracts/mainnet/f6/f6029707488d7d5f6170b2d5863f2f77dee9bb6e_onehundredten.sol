...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x56b37a90511b961233D400b2F574aEd1cCB67203; // owner address
...
contract onehundredten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "110";
    string private _symbol = "110";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56b37a90511b961233D400b2F574aEd1cCB67203); // 
    address payable public teamWalletAddress = payable(0x56b37a90511b961233D400b2F574aEd1cCB67203); // 
    ...
    uint256 private _totalSupply = 110 * 10**_decimals;
