...
contract DogeJB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DogeJB";
    string private _symbol = "DogeJB";
    ...
    uint256 private _totalSupply = 1 * 10**8 * 10**8 * 10**8* 10**8 * 10**_decimals;
