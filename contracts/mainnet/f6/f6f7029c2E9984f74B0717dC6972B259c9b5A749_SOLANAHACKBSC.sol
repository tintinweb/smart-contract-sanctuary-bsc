...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8331fA6B435D2272E0203E22467AD6D9Ba507024; // owner address
...
contract SOLANAHACKBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solana Hack";
    string private _symbol = "SOLHACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8331fA6B435D2272E0203E22467AD6D9Ba507024);
    address payable public teamWalletAddress = payable(0x8331fA6B435D2272E0203E22467AD6D9Ba507024); 
    ...
    uint256 public _walletMax = 5_000_000_000 * 10**_decimals;
