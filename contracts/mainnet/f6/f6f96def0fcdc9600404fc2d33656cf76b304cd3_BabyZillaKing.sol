...
contract BabyZillaKing is Context, IERC20, Ownable {
    ...
    string private _name = "BabyZillaKing";

    string private _symbol = "BabyZillaKing";
    ...
    address payable public marketAddress = 0x4426b85F1aa08f12595a732fd2FA94858515B953 ; //Marketing
