...
contract DAO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBF420cF0550aB5C2Ff6E6a2F393bC7Ed0d1Ee2BA); // Marketing Address
    address payable public teamWalletAddress = payable(0x5ddEE016F35f88f787F8AF85cdfa313CccBF45e1); // Team Address
