...
contract TalkingDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TalkingDog";
    string private _symbol = "DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x008B6141b2285743EdC0a5DF03D8c9581d01aF31);
    address payable public teamWalletAddress = payable(0x008B6141b2285743EdC0a5DF03D8c9581d01aF31);
