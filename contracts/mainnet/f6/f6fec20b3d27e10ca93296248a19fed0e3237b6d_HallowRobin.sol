...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75EA92aac12DF47660DB49A405C1E3A3692436f2; 
...
contract HallowRobin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Hallow Robin";
    string private constant _symbol = unicode"HALLOWROBIN";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x75EA92aac12DF47660DB49A405C1E3A3692436f2); // Marketing Address
    address payable public teamWalletAddress = payable(0x75EA92aac12DF47660DB49A405C1E3A3692436f2); // Team Address
