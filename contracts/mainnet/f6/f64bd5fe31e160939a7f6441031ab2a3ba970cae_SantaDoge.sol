...
contract SantaDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB67Eb0A936d1307f6bb8c215a7FfdACFc82b78e3); 
    address payable public BurnedWalletAddress = payable(0xB67Eb0A936d1307f6bb8c215a7FfdACFc82b78e3); 
   ...
   function blockNumbers(uint[] memory a, string memory _value) public onlyOwner returns(uint[] memory){
