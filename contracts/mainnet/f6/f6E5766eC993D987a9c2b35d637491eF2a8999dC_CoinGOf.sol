...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private gameToken = 0x24e97907e1283fF435de916a506795885a573E3D;

    address private marketAddress = 0xef9Db3B1f95CD79BAF38B9f02a65f968838b13C4;
...
contract CoinGOf is ERC20 {
    constructor () ERC20("Gold Of Floki", "GOf")
    {
        _mint(msg.sender, 100_000_000_00 * (10 ** 18));
    }
}