...
contract RATS4_1_3 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "413 RATS";
    string constant _symbol = "413 RATS";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x55d398326f99059fF775485246999027B3197955; //tether

    uint256 _totalSupply = 4130 * (10 ** _decimals);
    uint256 public _maxTxAmount = 82 * (10 ** _decimals);
    uint256 public _walletMax = 82 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xb7e5Be1ca7425Fe5108dd3088Dd9FED650c2adC5;
        marketingWallet = 0xb7e5Be1ca7425Fe5108dd3088Dd9FED650c2adC5;
        devWallet = 0xb7e5Be1ca7425Fe5108dd3088Dd9FED650c2adC5;
