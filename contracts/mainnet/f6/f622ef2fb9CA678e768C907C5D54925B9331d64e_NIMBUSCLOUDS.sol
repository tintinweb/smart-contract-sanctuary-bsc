...
contract NIMBUSCLOUDS is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'NIMBUS CLOUDS';
    string private constant _symbol = 'NIMBUS CLOUDS';
