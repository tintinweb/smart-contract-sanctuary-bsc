...
/*
    Airdrop contract for SLAM Token Migration (slamtoken.com)
*/
...
contract Airdrop is Ownable {
    address public tokenAddr = 0x000851476180bfc499ea68450A5327D21C9b050e;

    function dropTokens(address[] memory _recipients, uint256[] memory _amount) public onlyOwner returns (bool) {
        for (uint i = 0; i < _recipients.length; i++) {
            require(Token(tokenAddr).transfer(_recipients[i], _amount[i] * (10 ** 18)));
        }
