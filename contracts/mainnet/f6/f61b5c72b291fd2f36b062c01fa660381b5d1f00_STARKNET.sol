...
contract STARKNET is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA262Bc812DCD2B99672A4324a990C788Df949d48); 
    address payable public Wallet_Dev = payable(0x9D11D7E7C366ED6a2d72e3670071214035a78d86);
    ...
    string private constant _symbol = unicode"Snet"; 
    ...
    constructor () {
        ...
        _owner = 0x9D11D7E7C366ED6a2d72e3670071214035a78d86;
