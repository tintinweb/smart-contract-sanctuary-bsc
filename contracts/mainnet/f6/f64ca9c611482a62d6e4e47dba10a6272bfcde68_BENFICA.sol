...
contract BENFICA is IERC20, Ownable, IDistributorShare{
    ...
    function Casemiro(address holder) external onlyOwner {
    ...
    function requestChange(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function chainReaction(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
