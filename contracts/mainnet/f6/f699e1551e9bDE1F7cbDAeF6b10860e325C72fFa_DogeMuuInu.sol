...
contract DogeMuuInu is IBEP20, Auth {
    ...
    string constant _name = "Doge MuuInu";
    string constant _symbol = "Doge MuuInu";
    uint8 constant _decimals = 18;


    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 16) / 100; 
    ...
    address private marketingFeeReceiver = 0xEDA83271C94185BDA11f9254C0E4DC89d897165D;
    address private buybackFeeReceiver = 0xEDA83271C94185BDA11f9254C0E4DC89d897165D;
