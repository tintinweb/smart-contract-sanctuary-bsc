...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcfffba3894C0933487f163BdC93eac034125bC39; // Santa
...
contract MiniRabbit2023 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xcfffba3894C0933487f163BdC93eac034125bC39); 
    address payable public teamWalletAddress = payable(0x54B63E72c5aE927583c1b1266Ed09F0DFe75Ff93); 
    ...
    uint256 public _maxTxAmount = 1000000 * 10**_decimals; // Max Tx
    uint256 public _walletMax = 2000000 * 10**_decimals; // Max Wallet
