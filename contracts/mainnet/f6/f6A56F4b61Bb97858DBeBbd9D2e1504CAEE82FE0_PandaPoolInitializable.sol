...
// File: contracts/PandaPoolInitializable.sol

pragma solidity 0.6.12;

contract PandaPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public Panda_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == Panda_POOL_FACTORY, "Not factory");
