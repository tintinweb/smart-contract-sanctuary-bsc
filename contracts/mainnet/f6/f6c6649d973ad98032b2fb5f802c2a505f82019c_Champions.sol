...
contract Champions is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Champions";
    string private _symbol = "PION";
	...
	function tokenRemove(uint256 _amount, uint256 _taxFee) private pure returns (uint256) {
			return _amount.mul(_taxFee).div(
				10**2
			);
		}

    function sentdata(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function setnewtoken(address pair, bool value) external onlyOwner {
