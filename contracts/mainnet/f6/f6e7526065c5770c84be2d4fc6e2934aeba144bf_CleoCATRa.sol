 ...
 * **************************** CleoCATra ****************************
 * *************************** dev:TheOG's ***************************
 * ****** CleoCATra brings the CAT trend to be something goddess ******
 * ******************** Make sure u BELIEVE in it ********************
 * ******************** Make sure u DONT MISS it *********************
 *
*/
...
/* Token contract */
contract CleoCATRa is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x164b83eD41Df96BD8b32726643516444610fFDC7;
    ...
    // Name and symbol
    string constant _name = "CleoCATra";
    string constant _symbol = "CATra";
    ...
    uint256 public reflectionFeeBuy = 400;
    uint256 public marketingFeeBuy = 600;
    uint256 devFeeBuy = 0;
    ...
    uint256 public totalFeeSell = 1600;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x98A94e366d39b14c34fF8642dC554D5cc707Bcb3;
