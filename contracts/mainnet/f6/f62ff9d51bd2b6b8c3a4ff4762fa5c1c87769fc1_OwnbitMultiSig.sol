...
contract OwnbitMultiSig {
  ...
  uint256 private spendNonce = 117;
  ...
  function _messageToRecover(address erc20Contract, address destination, uint256 value) public view returns (bytes32) {
  ...
  function _validSignature(address erc20Contract, address destination, uint256 value, uint8[] vs, bytes32[] rs, bytes32[] ss) public view returns (bool) {
