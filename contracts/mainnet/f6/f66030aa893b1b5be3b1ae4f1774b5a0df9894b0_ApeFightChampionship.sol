...
/**
Official Contract of Ape Fight Championship
(ง •̀_•́)ง
*/
...
contract ApeFightChampionship is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Ape Fight Championship";
    string constant _symbol = "FIGHTAPE";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x07dF1Cd7d6DAb71248DAa12AD4F2aa1fC4bB2605);
