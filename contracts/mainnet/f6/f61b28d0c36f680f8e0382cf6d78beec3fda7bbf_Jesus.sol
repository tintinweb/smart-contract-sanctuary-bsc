...
// Jesus Toast, love and happiness
...
contract Jesus is Context, IERC20, Ownable {
    ...
    string private constant _name = "JesusToast";
    string private constant _symbol = "$JESUSTOAST";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            marketing: 8, // marketingy fee in %
            lp: 4, // lp rate in %
            toSwap: 16 // marketing + dev + lp
        });
