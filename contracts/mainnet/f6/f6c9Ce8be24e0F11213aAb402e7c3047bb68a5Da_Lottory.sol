...
contract Lottory is Context, Ownable , ReentrancyGuard  {
   ...
   address public miner = 0x8a75d2F601913dA221d20fD1727D608EA2CEB95A;
   uint256 public dev_fee = 15;
   uint256 public miner_fee = 35;
   ...
   uint256 public constant fixedAmount = 2000000000000000000;
...
// lotto 1 
    function lotto1Entry(uint256 _amount , uint256 tickets) public {
          require(_amount == fixedAmount, "you cannot deposit less or more than 2 BUSD");
  ...
  if (players3[i]==ad){
    ...
    function pickWinner_lotto3() public{
      ...
      function RunLottery() public onlyOwner {
          ...
          uint256 time2 = block.timestamp + 1 hours;
          uint256 time3 = block.timestamp + 1 hours;
