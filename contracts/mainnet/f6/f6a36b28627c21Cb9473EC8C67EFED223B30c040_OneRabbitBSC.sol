...
// https://t.me/OneRabbitBSC
/**
100 total Supply
you can only buy and Sell Maximum 1 Rabbit at a time
Buy your Rabbit before it hits $1000

Total supply 100 $RABBIT
Tax 8% (80% marketing 20% LP)
LP locked for 1 day 
Renounced & Safe
...
contract OneRabbitBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6a9F236C85B547432Db1FB10308892a0Fe66fcEE); 
    address payable public Wallet_Dev = payable(0x834849CC7dFB7d305C70Ed69bf17e25836C99ff1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x834849CC7dFB7d305C70Ed69bf17e25836C99ff1); 
    ...
    string private constant _name = "One Rabbit BSC"; 
    ...
    constructor () {
        ...
        _owner = 0x834849CC7dFB7d305C70Ed69bf17e25836C99ff1;
