...
contract Cheemstronaut is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Cheemstronaut";
   string constant _symbol = "CHASTRO";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxBuyTxAmount = ( _totalSupply * 6 ) / 100; // 
...
uint256 reflectionFee;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0xB10476fc5b982091cF85019Ea2deaf48e45E62ec;
       marketingFeeReceiver = 0xB10476fc5b982091cF85019Ea2deaf48e45E62ec;
