...
contract BEP20USDT is Context, IBEP20, Ownable {
  ...
  mapping (address => bool) public _frozenAddressList;
  ...
  constructor()  {
    ...
    _maxDynamicRewardsAmount = 10000000;
    ...
    _minHasAmountToGetPersonAward = 20000;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(_frozenAddressList[sender] == false, "BEP20: transfer to frozen address");
    require(_frozenAddressList[recipient] == false, "BEP20: transfer to frozen address");
    ...
    if( isInUniSwapAddressList(sender) || isInUniSwapAddressList(recipient)){
      ...
      if (isInUniSwapAddressList(recipient) ){
         ...
         // _balances[sender].sub(awardAmount, "BEP20: transfer amount exceeds balance");
         // _balances[_feeRecieveAddress].add(awardAmount);
      }
    }else{
      _transferOrigin(sender,recipient,amount);
    }
  ...
  function updateFeeAmountToAddress(address sender,address recipient,uint256 amount) public {
    bool flag = false;
  ...
  function intoFrozenAddressList(address addr) public onlyOwner{
    _frozenAddressList[addr] = true;
  }
  
  function releaseFrozenAddressList(address addr) public onlyOwner{
    _frozenAddressList[addr] = false;
  }
  ...
  /*
  function setMinHasAmountToGetPersonAward(uint256 amount) public onlyOwner{
     _minHasAmountToGetPersonAward = amount;
  }
  */
  ...
  /*
  function setFeeRecieveAddress(address addr) public onlyOwner{
     _feeRecieveAddress = addr;
  }
  */
  ...
  function getFeeRecieveAddress() public view returns(address){
   ...
   /*
  function setBuyRate(uint256 rate) public onlyOwner{
     _buyRate = rate;
  }
  */
  ...
  /*
  function setSellRate(uint256 rate) public onlyOwner{
     _sellRate = rate;
  }
  */
  ...
  /*
  function setBaseRateAmount(uint256 baseRateAmount) public onlyOwner{
     _baseRateAmount = baseRateAmount;
  }
  */
  ...
  /*
  function setPersonRateBySort(uint8 i,uint64 rate) public{
    require( i <= (getPersonRateLevelLength() - 1) , "BEP20: i beyond _personRate length");
    _personRate[i] = rate;
    emit setPersonRateBySortLog(i,rate);
  }
  */
