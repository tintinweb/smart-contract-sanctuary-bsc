...
contract HTM is Context, IERC20, Ownable {
    ...
    string private _symbol = "HTM96";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xF97581f1a6Df63FF721F0af61dab7A5BEcB0D449); 
    address payable private teamWalletAddress = payable(0x7355D3E8FEed77ccfcaf02234D5c0C443C278f03); 
