...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc517F3A202B93f44ee674AB10b77b92d122e5e71; // owner address
...
contract RubyApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ruby Ape";
    string private _symbol = "RubyApe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc517F3A202B93f44ee674AB10b77b92d122e5e71); // Marketing Address
    address payable public teamWalletAddress = payable(0xc517F3A202B93f44ee674AB10b77b92d122e5e71); // Team Address
