...
contract Rektcity is IBEP20, Auth {
    ...
    address public _marketingFeeReceiver = 0x6BC1F6935794a76Ba36d0A771570deB9dBf162c0;
    address public devFeeReceiver = 0x9242Cc1c78693B4E65bbF767aF665Af8468fc1aB;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 __marketingFee, uint256 _liq_fee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        liq_fee = _liq_fee;
        _marketingFee = __marketingFee;
        devFee = _devFee;
        totalFee = _liq_fee.add(__marketingFee).add(_devFee);
