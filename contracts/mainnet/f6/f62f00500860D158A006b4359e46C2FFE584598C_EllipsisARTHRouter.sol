...
contract EllipsisARTHRouter is IEllipsisRouter {
  ...
  function sellARTHForExact(
    ...
    zap.remove_liquidity(pool, lp.balanceOf(me), amountsOut);
    ...
    // require(busd.balanceOf(me) <= amountBUSDOut, "not enough busd");
    // require(usdc.balanceOf(me) <= amountUSDCOut, "not enough usdc");
    // require(usdt.balanceOf(me) <= amountUSDTOut, "not enough usdt");
