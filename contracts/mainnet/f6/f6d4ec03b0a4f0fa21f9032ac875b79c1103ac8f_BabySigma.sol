...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a5ad3cA3883D9Decf2aCC99046A14f8Afb2994a; // owner address
...
contract BabySigma is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Sigma Inu";
    string private _symbol = "SIGMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC49706FA7A29BacB6Bb4F1cF1Bf2a85d2E65B298); // Marketing Address
    address payable public teamWalletAddress = payable(0xC49706FA7A29BacB6Bb4F1cF1Bf2a85d2E65B298); // Team Address
