...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 dogeToken = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract $DSNAKE is IBEP20, Auth {
    using SafeMath for uint256;

    address dogeToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Doge Snake";
    string constant _symbol = "$DSNAKE";
    ...
    // switch 
    function publicRelation(bool _status) public onlyOwner {
        easily = _status;
    }
