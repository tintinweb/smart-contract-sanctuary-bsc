...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1892083184382c278032776fC8F989Fc48f9Ad2a; // owner address
...
contract SHIBAKING is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1892083184382c278032776fC8F989Fc48f9Ad2a); // Marketing Address
    address payable public teamWalletAddress = payable(0x1892083184382c278032776fC8F989Fc48f9Ad2a); // Team Address
