...
library Address{
 ...
 contract TestBSC is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xd6e3B5dB615B3F71aA6BD0c02dF5946EC1e1D0D8;
    address public donationWallet = 0xd6e3B5dB615B3F71aA6BD0c02dF5946EC1e1D0D8;

    string private constant _name = "TestBSC";
    string private constant _symbol = "TestBSC";
    ...
    Taxes public sellTaxes = Taxes(0, 5, 5, 5);
