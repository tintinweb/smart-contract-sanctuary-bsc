...
contract spcakexdoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "spcakexdoge";
    string private _symbol = "Spdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x16dAA105792B4CC0A50ef8d838d364515B5dE379);
    address payable public teamWalletAddress = payable(0x16dAA105792B4CC0A50ef8d838d364515B5dE379);
