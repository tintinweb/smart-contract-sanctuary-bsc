...
contract HumanForScare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Human For Scale";
    string private _symbol = "HumanForScale";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5585Be8C0796FA98aB3308bFE5A5d81A9822f7a2);
    address payable public teamWalletAddress = payable(0x5585Be8C0796FA98aB3308bFE5A5d81A9822f7a2);
