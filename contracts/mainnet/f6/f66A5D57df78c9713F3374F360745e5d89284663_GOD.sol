...
contract GOD is IERC20, Ownable {
    ...
    address _fundAddress = address(0xC6b35F3439F7E77bc021998B5d5E704Ba6dB110D);//指定地址
    address _default = address(0x52955DB1372A64fFc8d0c1f37535eB2c8de6d677);//没有推荐人默认地址
	address _backAddress = address(0x52955DB1372A64fFc8d0c1f37535eB2c8de6d677);
    ...
    function _transfer(
        ...
        if(lpDtime.add(86400) < block.timestamp){
