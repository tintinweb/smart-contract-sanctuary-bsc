...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x6F48dF392b69b6cdd7C1C8F52568BDd7AddA88dD ; // owner address
...
contract Inu  is Context, IERC20, Ownable {
    ...
    string private _symbol = "Baby Inu"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe251dcDd72AD87C83ACb6572B216577da4b81723); // Marketing Address
    address payable public teamWalletAddress = payable(0xe251dcDd72AD87C83ACb6572B216577da4b81723); // Team Address
