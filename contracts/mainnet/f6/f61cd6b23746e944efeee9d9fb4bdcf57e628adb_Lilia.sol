...
contract Lilia is Ownable, Pausable, ERC721URIStorage, ERC721Enumerable {
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "Lilia: token transfer while paused");
    }
    ...
    function burn(uint256 tokenId) public {
        require(
            ...
            "Lilia: caller is not owner nor approved"
        );
        _burn(tokenId);
    }
