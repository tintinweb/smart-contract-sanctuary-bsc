...
contract SquidMeta is Context, IERC20 { 
    ...
    string private constant _name = "Squid Meta"; 
    string private constant _symbol = unicode"SQUIDMETA"; 
