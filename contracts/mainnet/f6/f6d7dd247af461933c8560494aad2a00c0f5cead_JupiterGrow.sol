...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07e3395e37d990C127D763352Ad3Aa6c8F739785; // owner address
...
contract JupiterGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jupiter Grow";
    string private _symbol = "JupiterGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07e3395e37d990C127D763352Ad3Aa6c8F739785); // 
    address payable public teamWalletAddress = payable(0x07e3395e37d990C127D763352Ad3Aa6c8F739785); // 
    ...
    uint256 private _totalSupply = 1900000000 * 10**_decimals;
    uint256 public _maxTxAmount = 57000000 * 10**_decimals; 
    uint256 public _walletMax = 57000000 * 10**_decimals;
