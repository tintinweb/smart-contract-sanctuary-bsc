...
contract ForeverApe is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ForAPE";
    ...
    uint256 public maxBuyAmount = (_tTotal / 1000) * 30; // 3% of Supply
    uint256 public maxSellAmount = (_tTotal / 1000) * 3; // 0,3% of Supply
    uint256 public maxWallet = (_tTotal / 1000) * 30; // 3% of Supply
