...
contract BOMBAY is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xa347a7e92Ef91E5DaD46FEB97b32bc9a57f3E581); // Marketing Address

    address payable public buybackAddress =
        payable(0xa347a7e92Ef91E5DaD46FEB97b32bc9a57f3E581); // Buyback Address

    address payable public liquidityAddress =
        payable(0xa347a7e92Ef91E5DaD46FEB97b32bc9a57f3E581); // Liquidity Address
    ...
    string private constant _name = "Test BMBY Coin";
    string private constant _symbol = "TBMBY";
    ...
    uint256 public _buybbFee = 2;

    uint256 private _buyTDFee = _buybbFee;

    uint256 private _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 6;
    uint256 public _sellBbFee = 2;

    uint256 private _sellTDFee = _sellBbFee;
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(buybackAddress).call{value: bnbForTeam}("");
    ...
    function setBuyFee(uint256 buyBBFee, uint256 buyLiquidityFee, uint256 buyMarketingFee, uint256 buyTeamFee)
        external
        onlyOwner
    {
        _buybbFee = buyBBFee;
        ...
        require(_buybbFee + _buyLiquidityFee + _buyMarketingFee <= 30, "Must keep taxes below 30%");
        emit SetBuyFee(buyMarketingFee, buyLiquidityFee, buyBBFee, buyTeamFee);
    }

    function setSellFee(uint256 sellBBFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellTeamFee)
        external
        onlyOwner
    {
        _sellBbFee = sellBBFee;
        _sellLiquidityFee = sellLiquidityFee;
        _sellMarketingFee = sellMarketingFee;
        require(_sellBbFee + _sellLiquidityFee + _sellMarketingFee <= 30, "Must keep taxes below 30%");
        emit SetSellFee(sellMarketingFee, sellLiquidityFee, sellBBFee, sellTeamFee);
    }
