...
contract CR7DOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CR7 Doge";
    string private _symbol = "CR7DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49a33C08f136A8741a8A3d057060B4aFd659DF5f); 
    address payable public buyBackWalletAddress = payable(0xfbe35847997b7F4CD30af8ce0c51022A7950a815);
