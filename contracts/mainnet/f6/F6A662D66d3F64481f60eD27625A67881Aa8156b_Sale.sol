...
contract Sale {
    ...
    // soft / hard cap
    uint256 public constant hardCap = 250_000 * 10**18;

    // exchange rates
    uint256 public constant exchangeRate = 20 * 10**18; // 1 BUSD => 20 Tokens => 0.05 BUSD/Token
    ...
    function whitelist(address[] calldata users) external onlyReceiver {
