...
contract Token is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        feeWallet = payable(0x6938F93b7110520B03d3c3A13cE3ebBf2C8C4853); // Marketing address used to pay for marketing
        feeWalletCharity = payable(0x6938F93b7110520B03d3c3A13cE3ebBf2C8C4853); // Charity address used for donaitions - as charity is set to 0% it is the same as the marketing wallter. If charity is set up wallet will be changed
        walletFeeInBNB = true;
        ...
        _maxWalletAmount = 2 * 10**13 * 10**12; // 40 trillion or 1% of total supply
