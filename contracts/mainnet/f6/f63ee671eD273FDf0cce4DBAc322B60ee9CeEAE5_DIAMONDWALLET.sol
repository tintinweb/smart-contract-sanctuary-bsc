...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA2598c945415ECC0dB20BC2b63f1E8a3316a06a1;
...
contract DIAMONDWALLET is Context, IERC20, Ownable {
    ...
    string private constant _name = "DIAMOND WALLET"; // 
    string private constant _symbol = "DWALLET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xA2598c945415ECC0dB20BC2b63f1E8a3316a06a1);
