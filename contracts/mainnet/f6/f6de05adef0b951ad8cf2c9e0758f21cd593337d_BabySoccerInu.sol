...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCFE680f3a99F66eA9daeEC7485a557B3f84cCD6c;
...
contract BabySoccerInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xAfE952F56C08C5d252695e45AE888980E90611bb);
    ...
    */
    ...
    string private _name = "Baby SoccerInu"; 
    string private _symbol = "Baby Soccer";  
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= 40, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
