...
contract Carrotking is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Carrotking";
    string private _symbol = "Carrotking";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3aCcf77272012df871995ed5f9bF5BA5BF73f629);
