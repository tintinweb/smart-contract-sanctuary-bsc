...
contract Hyworld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hyworld";
    string private _symbol = "Hyworld";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xeD01B18E0A82B4A93B1AcBdb5Ebd00F28102d6E5); // Marketing Address
    address payable private teamWalletAddress = payable(0x869a2567F786972ac5530171583B9311747eD9Eb); // Team Address
