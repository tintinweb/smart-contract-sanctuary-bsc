    ...
    AccessControlUpgradeable
{
    ...
    /**
     * @param _bnbX - Address of BnbX Token on Binance Smart Chain 0xf19460660740f6Bd7F1885308b0616C21C2799FA
    ...
    function initialize(
        ...
        emit SetManager(_manager); // 0x79a2ae748ac8be4118b7a8096681b30310c3adbe
        emit SetBotRole(_bot); // 0x90199e1bb29b3097bfe22231c00045b4f14b8c44
        emit SetBCDepositWallet(bcDepositWallet); // 0x217b717fd01576bb993a2b0370cd3cba7c70eaf1
        emit SetMinDelegateThreshold(minDelegateThreshold);
        emit SetMinUndelegateThreshold(minUndelegateThreshold);
        emit SetFeeBps(_feeBps); // 1000
    }
