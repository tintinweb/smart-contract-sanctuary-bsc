...
/**
Mage's Broken Keyboard  (MBK)

This one is for the Bill Murray Inu fans!  -  BMI launched last week and since their launch they have proven to be a force to reckon with in bsc and "bringing light back to crypto!"  I can personally say that I have been beyond impressed with the hard work and dedication of everyone involved; from the dev to the mods.  The entire community is phenomenal.  

However, one person stands out.  The dev; Old Crypto Mage.  For those of you that have spent time in one of his vc's, then you are familiar with the very bullish sound of Mage excitedly pounding away on his keyboard as he strategically pushes his beloved project.

It is without a doubt, that keyboard of his is TAKING A BEATING!  So we are donating 2% of every tx to the "MAGE'S BROKEN KEYBOARD FUND".  (In all reality, it is not for a keyboard.  We are just calling it that because it sounds funny.  It is being sent DIRECTLY TO THE BMI DONATION WALLET!  They have an awesome cause and desire to help others via charity and we would like to support them in doing so.
...
contract MagesBrokenKeyboard is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Mage's Broken Keyboard";
    string constant _symbol = "MBK";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xAC2c8844Ae302aCBBd5c48eD7fdd9CC034FCE93c;
        donationFeeReceiver = 0x85A669A58F85da2dAe63EA04C522EB6f069a05dE;
