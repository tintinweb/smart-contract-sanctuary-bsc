...
contract MetaMeerkat is MetaMeerkatDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MetaMeerkatTeam;
    address private CharityMetaMeerkat;
    ...
    string public override name = "MetaMeerkat";
    string public override symbol = "MetaMeerkat";
    ...
    constructor(uint totalSupplyValue, address MetaMeerkatTeamAddress, address CharityMetaMeerkatAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MetaMeerkatTeam = MetaMeerkatTeamAddress;
        CharityMetaMeerkat = CharityMetaMeerkatAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MetaMeerkatTeam] =  totalSupply * 4 / 100;
        balances[CharityMetaMeerkat] = totalSupply * 4 / 100;
