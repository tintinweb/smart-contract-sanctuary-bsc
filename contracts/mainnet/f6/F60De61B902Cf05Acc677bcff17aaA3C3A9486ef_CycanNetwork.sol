...
Telegram: https://t.me/cycannetworkofficial
Website: https://www.cycan.network/
...
contract CycanNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cycan Network";
    string private _symbol = "CYCANN";
