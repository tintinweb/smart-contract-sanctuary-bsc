...
contract OpenAIBNB is ERC20, Ownable {
    ...
    event ChainDevelopmentWalletChanged(address chainDevelopmentWallet);
    event UpdateBuyFees(uint256 marketingFeeOnBuy, uint256 chainDevelopmentFeeOnBuy);
    event UpdateSellFees(uint256 marketingFeeOnSell, uint256 chainDevelopmentFeeOnSell);
    event SwapAndLiquify(uint256 tokensSwapped,uint256 bnbReceived,uint256 tokensIntoLiqudity);
    event SwapAndSendMarketing(uint256 tokensSwapped, uint256 bnbSend);
    event SwapAndSendChainDevelopment(uint256 tokensSwapped, uint256 bnbSend);
    ...
    {   
        ...
        marketingWallet = 0xCC7D2786Bdad294730aA8eC622e623d20D51fB55;
        chainDevelopmentWallet = 0xEc5A428976821BcFf6777457987830c34FB33826;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        _isExcludedFromFees[chainDevelopmentWallet] = true;
    ...
    function updateSellFees(uint256 _marketingFeeOnSell, uint256 _chainDevelopmentFeeOnSell) external onlyOwner {
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 chainDevelopmentShare = chainDevelopmentFeeOnBuy + chainDevelopmentFeeOnSell;
            ...
            if (chainDevelopmentShare > 0) {
                uint256 chainDevelopmentTokens = contractTokenBalance * chainDevelopmentShare / totalFee;
    ...
    function swapAndSendChainDevelopment(uint256 tokenAmount) private {
        uint256 initialBalance = address(this).balance;
        ...
        emit SwapAndSendChainDevelopment(tokenAmount, newBalance);
    }
}