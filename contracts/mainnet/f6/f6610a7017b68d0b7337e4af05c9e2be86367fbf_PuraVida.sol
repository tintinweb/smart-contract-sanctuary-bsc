...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0207fEff25e16651C31c60c7fc791b8263951398;
...
contract PuraVida is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x58fE2F5E5278F428285CfDEEa5e8580C19504fC2);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000 * 10**6 * 10**9; //100M
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pura vida";
    ...
    //max wallet holding 20 * 10**6 * 10**9 is 2% of 1000 * 10**6 * 10**9 (total supply)
    ...
    //this is the maximum transaction amount (in tokens) at launch this is set to 300% of total supply
    ...
    //amount (in tokens) at launch set to 0.1% of total supply
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**6 * 10**9;
