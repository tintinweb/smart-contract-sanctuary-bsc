...
contract robot is Context, Ownable {
    ...
    Erc20Token public ERC20     = Erc20Token(0x9131066022B909C65eDD1aaf7fF213dACF4E86d0);
    ...
    function ERC20ForUsdt(uint256 tokenAmount) public onlyWhiteList {
        ...
        uint256 usdtBalance = usdt.balanceOf(address(WAddress));
 
        usdt.transferFrom(WAddress, address(this),usdtBalance);
...
function UsdtForERC20(uint256 tokenAmount) public onlyWhiteList {
    ...
    uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        uint256 ERC20Balance = ERC20.balanceOf(address(WAddress));

        ERC20.transferFrom(WAddress, address(this),ERC20Balance);
