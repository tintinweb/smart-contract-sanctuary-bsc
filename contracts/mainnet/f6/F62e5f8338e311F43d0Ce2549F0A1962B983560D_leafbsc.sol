...
contract leafbsc  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(
0x8d584E4eceA5C7eC0a2300c80F1FbE28Cc583D17); 
    address payable public Wallet_Dev = payable(0x50915f04F2c26B5Ed455a9D126187f1DaB919e6D);
    ...
    string private constant _name = "Leaf BSC"; 
    ...
    constructor () {
        ...
        _owner = 0x50915f04F2c26B5Ed455a9D126187f1DaB919e6D;
