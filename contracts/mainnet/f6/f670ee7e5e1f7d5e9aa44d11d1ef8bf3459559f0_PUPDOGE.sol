...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Pupdoge Coin';

    string constant public symbol = 'PUPDOGE';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 96000000000*10**uint256(decimals);
