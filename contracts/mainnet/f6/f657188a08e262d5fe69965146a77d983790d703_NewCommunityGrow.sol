...
contract NewCommunityGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Grow";
    string private _symbol = "NCGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x474780a0A235929C133163d48DB9A2b9e1894413);
    address payable public BuyBackWalletAddress = payable(0x474780a0A235929C133163d48DB9A2b9e1894413);
