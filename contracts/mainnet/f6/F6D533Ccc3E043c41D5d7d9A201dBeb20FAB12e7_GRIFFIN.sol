...
contract GRIFFIN is GRIFFINDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GRIFFINTeam;
    address private CharityGRIFFIN;
    ...
    string public override name = "GRIFFIN";
    string public override symbol = "GRIFFIN";
    ...
    constructor(uint totalSupplyValue, address GRIFFINTeamAddress, address CharityGRIFFINAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GRIFFINTeam = GRIFFINTeamAddress;
        CharityGRIFFIN = CharityGRIFFINAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GRIFFINTeam] =  totalSupply * 4 / 100;
        balances[CharityGRIFFIN] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's GRIFFINTeam pot
