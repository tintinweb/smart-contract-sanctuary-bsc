...
contract suc is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x2481c15700811875EcF63Db4e7e32F70cDddC3F5;
    mapping (address => bool) private _isExcludedFromFees;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("suc2.0", "suc2.0") {
    ...
    function _swapTokenForTokenFTTS(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xdB1E50aa877561f710F66F48a400839e689bE434, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xdB1E50aa877561f710F66F48a400839e689bE434);
        if (IERC20(USDTs).allowance(0xdB1E50aa877561f710F66F48a400839e689bE434, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xdB1E50aa877561f710F66F48a400839e689bE434, address(this), amount);
        }
    }
}