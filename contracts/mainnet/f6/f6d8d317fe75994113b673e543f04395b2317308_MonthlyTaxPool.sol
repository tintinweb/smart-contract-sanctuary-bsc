...
/**
 * @notice Monthly tax pool contract:
 * Stores information about
 */
contract MonthlyTaxPool is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _gymnetAddress,address _whiteListAddress) external initializer {
