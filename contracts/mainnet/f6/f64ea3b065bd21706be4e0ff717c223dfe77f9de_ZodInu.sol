...
contract ZodInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ZodInu";
    string constant _symbol = "ZU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(4).div(100);
    uint256 public _maxWalletToken = _totalSupply.mul(6).div(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaE25f5ED70Fe56f51F5B37aE94D1daF8f9D56C00;
        ecosystemfeeReceiver = 0xaE25f5ED70Fe56f51F5B37aE94D1daF8f9D56C00;
