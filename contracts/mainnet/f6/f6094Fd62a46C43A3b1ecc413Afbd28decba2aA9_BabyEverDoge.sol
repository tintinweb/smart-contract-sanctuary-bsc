...
🎉 NEW BEST TOKEN LAUNCH 5 MARCH , 13:00UTC
🥧 LIST ON PANCAKESWAP
🔥 LOW MCAP
🛰️ 💯 SAFU
✅ Contract Verified
...
contract BabyEverDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x84F9B3D091309c3a3AcBD83eCbc6058cC9E42873;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "BABY EVER DOGE";
    string constant _symbol = "$BED";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x59905f15E96cB9ef1460ac3dC42158Bd6b4D620e;
