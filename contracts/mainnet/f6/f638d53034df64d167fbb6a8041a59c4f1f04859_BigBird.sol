...
contract BigBird is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BigBird";
    string constant _symbol = "BBird";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xDb98d75Cad6266FBDEaca0a0E74487097028935b;
