...
contract Token235 is ERC20 {
    ...
    address _baseToken = address(0x55d398326f99059fF775485246999027B3197955); //0x55d398326f99059fF775485246999027B3197955
    IERC20 public USDT;
    IERC20 public pair;
    ...
    address private _fundAddress =
        address(0xE8F31FfEe193feAA150381F809fFE3A6AE40ebf8);
    ...
    constructor(address tokenOwner) ERC20("235", "235") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        uint256 total = 2350 * 10**18;
        _approve(
            address(this),
        ...
        maxTransactionAmount = 2 * 10**18; // 5% from total supply maxTransactionAmountTxn
        maxWallet = total; // 5% from total supply maxWallet
    ...
    function changeStart(uint256 newval) public onlyOwner {
        startTime=newval;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if (from == uniswapV2Pair) {
                ...
                require(
                    ...
                    uint256[] memory maxAmount=getAmount(50*10**18);
                    require(
                        amount <= maxAmount[0],
                        "Buy transfer amount exceeds the maxTransactionAmount."
                    );
        ...
        if (takeFee) {
            ...
            if (from != address(this)) {
                ...
                super._transfer(from, address(this), amount.mul(6).div(100));
    ...
    function getAmount(uint256 amountOut)public view returns(uint256[] memory amountIn){
        address[] memory path=new address[](3);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = _baseToken;
        amountIn=uniswapV2Router.getAmountsIn(amountOut, path);
    }
    ...
    function swapAndLiquify() private {
        ...
        if (allAmount > 5 * 10**18) {
            uint256 canswap = allAmount.div(6);
