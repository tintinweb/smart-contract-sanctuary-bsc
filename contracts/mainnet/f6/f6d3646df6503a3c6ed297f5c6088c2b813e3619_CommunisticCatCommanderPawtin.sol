...
//
// CommunisticCatCommanderPawtin ($CCCP) is a BUSD reflections token.
// Total Tax: 10% (Reflections: 7% | Liquidity: 3%)
//
// Website: TBA
// Telegram: http://t.me/CommanderCatPawtinCCCP
...
contract CommunisticCatCommanderPawtin is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string _name = "CommunisticCatCommanderPawtin";
    string _symbol = "CCCP";
    ...
    uint256 public totalFee = liquidityFee + reflectionFee; // Reflections fee - 7%, Liquidity fee - 3%
