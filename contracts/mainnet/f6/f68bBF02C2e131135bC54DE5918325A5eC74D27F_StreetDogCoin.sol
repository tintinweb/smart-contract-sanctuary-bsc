...
/**
 * StreetDogCoin ICO - Laravel CMS | Crypto BEP-20 Pre-Sale CMS (Crypto Fundraising) 
 ...
 * Telegram: https://t.me/StreetDogCoin
 */
...
contract StreetDogCoin is BEP20, Ownable, Pausable {
  ...
  function transferFrom(
    ...
    require(_value <= _allowed[_from][msg.sender], 'BEP20: transfer from value not allowed');
  ...
  function burn(
    ...
    require(_balances[msg.sender] >= _amount, 'BEP20: insufficient balance');
  ...
  function burnFrom(
    ...
    require(_amount <= _allowed[_from][msg.sender], 'BEP20: burn from value not allowed');
