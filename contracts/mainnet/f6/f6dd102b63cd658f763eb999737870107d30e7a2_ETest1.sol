...
interface IUniswapV2Factory {
    ...
    function gETESTair(address tokenA, address tokenB) external view returns (address pair);
...
contract ETest1 is ERC20, Ownable {
    ...
    constructor (address newOwner) ERC20("ETest1", "ETEST") 
    {   
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 1000, "SwapTokensAtAmount must be greater than 0.001% of total supply");
