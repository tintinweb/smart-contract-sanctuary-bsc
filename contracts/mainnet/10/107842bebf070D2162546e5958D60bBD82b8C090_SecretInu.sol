...
contract SecretInu is IBEP20, Auth {
    ...
    string constant _name = "Secret Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Secret Inu";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100;  // 1 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 4. 
    ...
    uint256 reflectionFee   = 0; // $ADA rewards
    uint256 marketingFee    = 20; // glorious female tax
