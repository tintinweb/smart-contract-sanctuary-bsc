...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66e1208eD3b5EaDCaCe4A0c70f5d0C8f2425Db42;
...
contract ValentineDoge is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x3Fe30628B80ABfB4faa1B079232fB07B7ab8cf59); 
    address payable private Wallet_Token_Burn = payable(0x30EFab94472c63e624C4F61C3198273a913ecd0f); 
    address payable private Wallet_Dev = payable(0xfBA6C7735C2320653aDDA41F73F2a873c417d089); 
    ...
    string private _symbol = "ValDoge";  
