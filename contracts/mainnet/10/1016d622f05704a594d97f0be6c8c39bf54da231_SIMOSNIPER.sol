...
/**
https://t.me/simosnipertokenbsc



What is Simo Sniper Token?

SIMO Sniper Token is a cutting edge revolutionary Sniping technology that is fully decentralized and UNTRACEABLE.  

This automated technology was designed and simplified so that the average novice user can implement and win consistently with ease.  

Full suite of unique tools will be revealed at launch to avoid copy cats.
 
What can I expect?

Lighting fast, low gas fees, BSC/ETH compatible, Anti-Rug Protection, Auto Sell set limits and more.  

Free for varified holders!  Tier system to unlock extra perks including a powerful Call Channel Sniping.

What is the goal?

With so many investors being left at a disadvantage when investing at launch.  We have built a technology to give the average investor the advantage over any other sniper.  This is a set it and forget it technology that anyone can use.

Give yourself the edge, increase your win %, take the guessing out and let the tools work for you.
...
contract SIMOSNIPER is IBEP20, Auth {
    ...
    string constant _name = "Simo Sniper Token";
    string constant _symbol = "SIMO";
    ...
    address public marketingFeeReceiver = 0xD28B62Cab65ECD360deBd6B87df4172e6ed19Ee1;
