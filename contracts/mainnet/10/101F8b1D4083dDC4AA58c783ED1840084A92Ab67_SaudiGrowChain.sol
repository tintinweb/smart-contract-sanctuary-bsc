...
❇️Saudi Grow Chain is a crypto engineering organization that has built a super-fast blockchain, which has +100k TPS and has zero cost gas fee.

❇️The Fastest Growing Ecosystem With Projects Spanning DeFi, NFTs, Web3 & Much More, Saudi Grow Chain Also Has Developed A SAUDI20/ERC20/BEP20 Supported Wallet on Android & iOS.

❇️Saudi Grow Chain is the only blockchain which has managed to build a zero-cost blockchain & gas fee are as low as $0.00000001 per transaction. 
...
✳️TAX FEE TRANSACTION 8%
💠Liquidity : 1%
💠Marketing : 5%
💠Development : 2%

🔥SAFE DEV & TEAM, HUGE MARKETING AFTER LAUNCH, LONG TERM PROJECT🔥
...
Medium: https://medium.com/@saudigrowchain
...
/* Token contract */
contract  SaudiGrowChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x1F0512a0174784685A1bDB363A916699Deca1B3C;
    ...
    // Name and symbol
    string constant _name = "SAUDI GROW CHAIN";
    string constant _symbol = "SGC";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 200000000 * (10 ** _decimals); // PIGE ZILLA KILL ZERO
