...
// Telegram : https://t.me/egoDgrowbsc
// Website  : TBA
...
contract egoDGrowBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCFD29C78351d52CD57792a11106cb02A422Be1Ae); 
    address payable public Wallet_Dev = payable(0x1C74B164320988d746EaBCa0D129008296cFfd41);
    ...
    string private constant _name = "egoD Grow"; 
    string private constant _symbol = unicode"EGROW"; 
    ...
    constructor () {
        ...
        _owner = 0x1C74B164320988d746EaBCa0D129008296cFfd41;
