...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketAddr = 0xA868732487EACC62Ae2f6b9181A5e0Eb97d8eE1D;
        ...
        returns (uint256)
    {
        ...
        super._transfer(sender, marketAddr, dividendAmount);

        uint256 burnAmount;
        if (balanceOf[address(0xdead)] <= 7800_0000) {
