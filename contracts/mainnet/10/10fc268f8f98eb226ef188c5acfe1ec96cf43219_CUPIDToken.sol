...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 1999 * 10**18;
    string private _name = "LOVE";
    string private _symbol = "LOVE";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xa864F45FBC5a819a10086a19eF52c05c8B444370);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 1999 * 10**18;
