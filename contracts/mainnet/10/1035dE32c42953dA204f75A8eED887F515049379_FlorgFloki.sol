...
contract FlorgFloki is IERC20, Ownable {
    ...
    string _name = "Florg Floki";
    string _symbol = "FFLOKI";
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x0F22c49756801229756Cf47702154e2C98372D74;
    ...
    function changeMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 1000000000000 * 10 ** _decimals * maxTx / 1000;
    }
