...
//------------------------------------------------------------------------------
contract CFToken is StandardToken,Ownable {
    using SafeMath for uint256;
    using SafeERC20 for ERC20;

    string public name = "CF";
    ...
    address public technologyAccount = 0x7d30584A7266443bfFe01f08ac6eF12C181A1576;//技术
    address public blackholeAccount = 0x0000000000000000000000000000000000000001;//黑洞地址

    address public projectAccount = 0x9f5080e43790861DcB7ea2395d0D055e35e82D1f;//项目方地址
    address public controlerAccount = 0x23B8F52f40C9E6Ce1d3F6fe282D609e7a4108C26;//初始合约控制账户
    ...
    constructor(
        ...
        controler = 0x23B8F52f40C9E6Ce1d3F6fe282D609e7a4108C26;
