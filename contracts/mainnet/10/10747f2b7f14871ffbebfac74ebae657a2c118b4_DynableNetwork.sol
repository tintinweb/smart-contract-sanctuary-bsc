...
/**
Dynable Network, Ethereum, Binance Smart Chain, Polygon, Avalanche, Solana, Fantom etc. It is a DApp development project that can combine all future blockchain networks on a single network.

Its main purpose is to provide maximum useful and efficient DApp development components for developers and project owners.
Dynable Network is BEP20 Token project built using Binance Smart Chain. The Dynable Network project carries the DYNAB symbol across all BSC networks.
...
contract DynableNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Dynable Network";
    string private _symbol = "DYNAB";
    ...
    address public charityWallet = 0xBa7C27Da2268860d80d92D8697ea0F6291de96bc;
