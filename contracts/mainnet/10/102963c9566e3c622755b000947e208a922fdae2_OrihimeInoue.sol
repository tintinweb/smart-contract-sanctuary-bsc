...
Welcome to Orihime Inoue Token!

Building Next generation token that will conquer BSC Network. Stealth launch and community driven token. We are establishing a new era that you will not want to miss.
No rebase, No reward. We are meme token.  


Telegram: https://t.me/OrihimeInoueTG

Website: https://orihimeinoue.site/
...
contract OrihimeInoue is Context, IERC20, Ownable {
    ...
    string private constant _name = "Orihime Inoue"; // 
    string private constant _symbol = "OIOUE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xAE65665ba84Ce361b9b5E4bd84b588EF190c8940;
