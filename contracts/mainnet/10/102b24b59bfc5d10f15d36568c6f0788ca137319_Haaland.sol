...
contract Haaland is Context, IERC20 { 
    ...
    address payable private DevWallet = payable(0x7C6E710AF174F4f60257157b45363d84446186c3);
    address payable private MarketingWallet = payable(0x349Ad432f9BA638C21b6f3977D5f16Bc75b3D990);
