...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"DARTMission";
    string private _symbol = unicode"DART";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xf7a4a03a3c75F6CfB0675fD87B47fd1eA1c916EA); 
    address payable public BurnedWalletAddress = payable(0xf7a4a03a3c75F6CfB0675fD87B47fd1eA1c916EA); 
