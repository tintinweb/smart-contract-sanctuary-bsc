...
██║     ██║  ██║██║ ╚████║██║  ██║██║ ╚═╝ ██║██║  ██║███████║██║  ██║██║██████╔╝██║  ██║
╚═╝     ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝╚═════╝ ╚═╝  ╚═╝
Panama Shiba worlds largest digital NFT marketplace for crypto collectibles and non-fungible tokens (NFTs). Buy, sell, and discover exclusive digital items.

WEBSITE: https://panamashiba.digital/

TELEGRAM: https://t.me/panamashiba
...
contract PANASHIBA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PANASHIBA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xA2875a3501Fd3BE895453cdb071EbF2685e064c0;
