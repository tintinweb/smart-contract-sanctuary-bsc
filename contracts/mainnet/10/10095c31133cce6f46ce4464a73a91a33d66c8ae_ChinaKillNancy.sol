...
contract ChinaKillNancy is IERC20, Auth {
    ...
    string private constant  _name = "China Kill Nancy 2022";
    string private constant _symbol = "CKN";
    ...
    address payable public marketingWallet = payable(0x0027EAA7f3840e224d2e80CC6AC4DD566B818a8d);
    ...
    function setFee (uint256 _sellFeeRate, uint256 _buyFeeRate) external onlyOwner {
        require (_sellFeeRate <= 1, "Fee can't exceed 1%");
        require (_buyFeeRate <= 1, "Fee can't exceed 1%");
