...
contract Cerium is Context, IERC20, Ownable {
    ...
    string private _name = "Cerium Protocol";
    ...
    function setLiquiditylock(uint256 burnFee) external onlyOwner() {
        _burnFee = burnFee;
    }    
    function setLiquidityUnlock(uint256 burnFee) external onlyOwner() {
        _burnFee = burnFee;
}
