...
contract MN2GEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI TWOGE INU";
    string private _symbol = "MN2GEINU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x9f5BaFb01D0B350c91EcE4247dB5678872178F71); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x9f5BaFb01D0B350c91EcE4247dB5678872178F71); // Team Address
