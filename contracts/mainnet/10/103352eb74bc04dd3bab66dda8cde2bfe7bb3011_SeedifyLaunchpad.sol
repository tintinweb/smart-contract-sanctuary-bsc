...
contract SeedifyLaunchpad is Ownable, Pausable {
    ...
    function buyTokens(
        ...
        require(totalRaised.add(amount) <= (totalSupply * nftPrice), "Exceeds total supply");
        ...
        require(userDetails[msg.sender].nftPurchased.add(units) <= allocation,"You have reached max allocation limit");
