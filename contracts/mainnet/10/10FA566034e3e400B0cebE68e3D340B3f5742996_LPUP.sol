...
contract LPUP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lollipup";
    string private _symbol = "LPUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd974f6a5dBF0F07229564b23319f375b73763cBA); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9C636b45435dBd747C875BBC7b28A1Ae77837200); // Team Address
