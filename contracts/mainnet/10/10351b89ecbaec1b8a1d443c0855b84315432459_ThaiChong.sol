...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B60DB208Cfb75Fcc074Bd9AB29B5a6b07Abd5F8; // owner address
...
contract ThaiChong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Thai Chong";
    string private _symbol = "ThaiChong";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2E5BB972c4ce4e95727AAba0b42A14aA6C16758c); // Marketing Address
    address payable public teamWalletAddress = payable(0xB61e638DE71A7f6068B86839D2f3e8CC00b86a03); // Team Address
