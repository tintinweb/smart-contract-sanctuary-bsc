...
contract Medals is ERC721, AccessControlEnumerable, ReentrancyGuard {
    ...
    mapping(uint256 => uint256) private tokenIdList;
    ...
    function _transfer(
        ...
        uint256 index = tokenIdList[tokenId];
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        uint256 _index = tokenIdList[tokenId];
        ...
        returns (uint256[] memory medalIds, uint256[] memory weights)
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            uint256 tokenId = tokenIdList[tokenIds[i]];
