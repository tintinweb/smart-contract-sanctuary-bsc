...
contract MiKuCha is Context, IERC20, Ownable {
    ...
    string private constant _name = "MikuChain"; // 
    string private constant _symbol = "MiKuCha "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x3BbBC1451C83d4E07EFb044928b1db54fb3249ce;
