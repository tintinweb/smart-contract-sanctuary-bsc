...
contract AiSquid is IBEP20, Ownable {
    ...
    string constant _name = "AiSquid";
    string constant _symbol = "AISQUID";
    ...
    address public marketingFeeReceiver = 0x7DFb19ca3CB72127A2F03FF161f2bE29aD698801;
    ...
    function isBot (address targetAddress, bool value) external onlyOwner {
        isBlacklisted[targetAddress] = value;
    }
