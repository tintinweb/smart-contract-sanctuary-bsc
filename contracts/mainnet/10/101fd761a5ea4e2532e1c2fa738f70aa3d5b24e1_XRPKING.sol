...
//Contract
contract XRPKING is IBEP20, Ownable {
    ...
    string private constant _name = 'XRPKING';  
    string private constant _symbol = 'XKING';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 100000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=100; //1% = 1,000
    uint16 private constant SellLimitDivider=100; //1% = 1,000
    ...
    uint8 private _marketingTax=45;
    ...
    uint256 public constant blacklistBlocks = 8;
