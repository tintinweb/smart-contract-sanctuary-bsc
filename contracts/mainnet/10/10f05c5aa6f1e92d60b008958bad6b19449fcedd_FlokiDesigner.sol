...
contract FlokiDesigner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiDesigner Coin";
    string private _symbol = "FlokiDesigner";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb9c2B3BBf17E6e4698aCd72E79Db3c065bcf3e97); 
    address payable public teamWalletAddress = payable(0xb9c2B3BBf17E6e4698aCd72E79Db3c065bcf3e97); 
