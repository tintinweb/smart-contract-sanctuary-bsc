...
contract BloodStone is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Legions Bloodstone", "BLST") {
        
        address newOwner = 0x139Ed0Ad7b9f44E2B12631D6E9E5980D6a927c51; // can leave alone if owner is deployer.
        ...
        // update these!
        operationsAddress = address(0x8627693F4364E4676b04434A679fc41D6F26Afd4);
        rewardsAddress = address(msg.sender);
        reserveAddress = address(0xDc67C1850d5Cd25cfC0356FaCF407482d0399FC2);
        liquidityAddress = address(0x139Ed0Ad7b9f44E2B12631D6E9E5980D6a927c51);
        futureOwnerAddress = address(0x139Ed0Ad7b9f44E2B12631D6E9E5980D6a927c51);
