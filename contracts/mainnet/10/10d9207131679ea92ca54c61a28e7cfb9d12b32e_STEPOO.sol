...
/* Token contract */
contract STEPOO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB8601bec9f827ae89F398dE5e64595d820A634a0;
    ...
    // Name and symbol
    string constant _name = "STEPOO";
    string constant _symbol = "STP";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000000 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 2%
