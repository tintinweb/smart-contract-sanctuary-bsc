...
contract RASIANPROToken is IBEP20 {
...
contract RASIANPROBUSD {
    address payable admin;
    RASIANPROToken public tokenContract;
    ...
    constructor(RASIANPROToken _tokenContract, uint256 _tokensSold)  {
