...
contract BBNK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Began Black Nolife King";
    string private _symbol = "BBNK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ae01Baf1dc31Bfc69c2E327Dda4f72897116584); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6ae01Baf1dc31Bfc69c2E327Dda4f72897116584); // Dev Address
    ...
    uint256 private _totalSupply = 1500 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 1500 * 10**6 * 10**9; // 2% max tx
    uint256 public _walletMax = 1500 * 10**6 * 10**9; // 2% max wallet
