...
contract shitang is Context, IERC20, Ownable {
    using SafeMath for uint256;  

    string private _name = "shitang";
    string private _symbol = "SHITANG";
    ...
    function updateMaxTx(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
