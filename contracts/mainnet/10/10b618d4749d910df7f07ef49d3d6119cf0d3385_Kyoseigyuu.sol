...
Kobe beef of the token, ultimate flavor. Next 100x. Based on most luxurious japanese meat.

https://t.me/KyoseigYuuBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  GEISHA = IBEP20(0x5d0273E6Be9Fb2Cb0e8C17866d35b9995f5749cD);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GEISHA.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(GEISHA);
        ...
        uint256 amount = GEISHA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GEISHA.transfer(shareholder, amount);
...
contract Kyoseigyuu is IBEP20, Auth {
    using SafeMath for uint256;

    address GEISHA = 0x5d0273E6Be9Fb2Cb0e8C17866d35b9995f5749cD; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x73c238257105792807a4383cE0902b12012905D5;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Kyoseigyuu";
    string constant _symbol = "KYO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x4182ECbda50E21BFca0E63776642649a40Fc9Fe8;
