...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 6688 * 10**18;
    string private _name = "Alpaca";
    string private _symbol = "Alpacs";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xc6Ce962C07792a926F1bBc910f2693F0d7AE0dBd);
    address public pointAddress = address(0xb54DeE3F4856Cb682D4FDCe40Ee247C5FDFC7dCF);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 6688 * 10**18;
