...
contract StonerGrow_TOKEN is Context, IERC20, Ownable {
    ...
    uint256 public tokenstosell = 10000000;
    ...
    string private constant _name = "StonerGrow";
    string private constant _symbol = "SGROW420";
