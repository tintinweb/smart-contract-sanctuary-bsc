...
// Join our Telegram Group: https://t.me/BRICSOFFICIALPORTAL 
...
contract BRICSCURRENCY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BRICS CURRENCY"; 
    string private _symbol = "$BRICS"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17B05c8A0B5449301DeAF5fAa39d969cF833D911); 
    address payable public teamWalletAddress = payable(0x8A07E1C2DA4cd863eB9A745D45619dDc123e125B); 
