...
contract RiddleMeThis is Ownable {
    uint256 public ticketCost = 0.36 ether;
    uint public count = 1;
    uint public round = 1;

    uint256 public firstPrize = 25 ether;
    uint256 public secondPrize = 10 ether;
    uint256 public thirdPrize = 5 ether;
    uint256 public fourthPrize = 1 ether;
    uint256 public refFee = 15;
    ...
    uint256 public totalPlayersPerRiddle = 650;
