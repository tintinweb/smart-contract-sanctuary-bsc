...
*/
 ...
 /** SQUID HILL
    ...
    With the recent trend of SQUID HILL, we brought it in the crypto world 
    as a community driven project with verified contract and big liquidity.

    Total Supply: 100billion tokens  
    Tax: 6% Buy/Sell 

    🔆Tokenomics🔆
    2% goes to Auto Liquidity
    4% goes to Massive Marketing  
    Total Supply: 100 Billion tokens
    Max Wallet / Trn  :    3% [3 billion tokens]

// TG: https://t.me/SQUIDHILL
...
contract SQUIDHILL is Context, IERC20, Ownable {
    ...
    string private constant _name = "SQUIDHILL";
    string private constant _symbol = "SQUIDHILL";
    ...
    address private marketingWallet = address(0xc56DF7D92BC7Cee4C90f72338d4C770c7a187042);
    address private liquidityReceiver = address(0xc56DF7D92BC7Cee4C90f72338d4C770c7a187042);
