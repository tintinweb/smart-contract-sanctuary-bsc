...
contract MetamaskWallet is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Metamask Wallet";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x080F7B19e0CF9611A8A2eD6aDD21BaD8548ed425;
