...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x64619f611248256F7F4b72fE83872F89d5d60d64);
...
contract QUINTGROW is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xE80455148f1102eD5489F7400051d8389d8e4AF1;

    string constant _name = "QUINT GROW";
    string constant _symbol = "QUINTG";
