...
import "./GoldRhinoTokenStorage.sol";
import {List} from  "../struct/RhinoTokenStructs.sol";

contract GoldRhinoToken is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, GoldRhinoTokenStorage {
    ...
    constructor(string memory baseURI_, address payee_) ERC721("GoldRhinoToken","GRT") {
        baseURI = baseURI_;
        payee = payee_;
    }
...
contract GoldRhinoTokenStorage {
