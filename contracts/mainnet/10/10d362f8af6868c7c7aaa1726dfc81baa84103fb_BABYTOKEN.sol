...
interface IERC20 {
    ...
    function setMarketingWalletAddress(address account) external returns (uint256);
...
contract BABYTOKEN is Context, IERC20 { 
    ...
    address payable public marketingAddress = payable(0x3d9FfF02cE2F2b516b5bBF28BBb9483EF434370C); 
    address payable public buyBackAddress = payable(0x0Dc6831ae249673631c3Ffefacdf575F21fa47aa);
    ...
    string private constant _name = "MoonShot Only"; 
    ...
    constructor () {
        ...
        _owner = 0x0Dc6831ae249673631c3Ffefacdf575F21fa47aa;
    ...
    function setMarketingWalletAddress(address marketingWallet) public OnlyOwner override returns (uint256) {
    ...
    function changeFees(uint256 _totalBuyTax, uint256 _totalSellTax) external onlyOwner {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 transferFEE = tAmount*totalBuyTax/100;
