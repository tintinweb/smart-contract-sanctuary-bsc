...
//
// FUDBNB proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/FUDBNB
//
...
contract FUDBNB is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FUDBNB", "FUDBNB") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FUDBNB";
    string private _symbol = "FUDBNB";
