...
contract LiveTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LiveTest", "LTEST") {
        ...
        lotterySellFee = 3;
        burnSellFee = 1;
        totalSellFees = rewardsSellFee + marketingSellFee + liquiditySellFee + lotterySellFee + burnSellFee;
        ...
        lotteryBuyFee = 2;
        burnBuyFee = 0;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee + lotteryBuyFee + burnBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0x3d54465f42Fe5ee06CF800c8D5cFa915899098D8); // set as marketing wallet
    	lotteryWallet = address(0xab6FCadE39216dAecA82d379DE365F2d325607e7); // set as lottery wallet

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x283642cb69cD2aE45dE62fb1C82753e3fAF71C33);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _lotteryFee, uint256 _burnFee) external onlyOwner {
        marketingBuyFee = _marketingFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        lotteryBuyFee = _lotteryFee;
        burnBuyFee = _burnFee;
        totalBuyFees = marketingBuyFee + rewardsBuyFee + liquidityBuyFee + lotteryBuyFee + burnBuyFee;
        require(totalBuyFees <= 20, "Must keep fees at 20% or less");
    }
    
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _lotteryFee, uint256 _burnFee) external onlyOwner {
        marketingSellFee = _marketingFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        lotterySellFee = _lotteryFee;
        burnSellFee = _burnFee;
        totalSellFees = marketingSellFee + rewardsSellFee + liquiditySellFee + lotterySellFee + burnSellFee;
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForLottery - ethForRewards;
