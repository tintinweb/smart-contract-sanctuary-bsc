...
contract ShanraiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shanrai Inu";
    string constant _symbol = "SHANRAI";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 999999999  * (10 ** _decimals);
    ...
    function setFees(uint256 _liquidityFee, uint256 _autoburnFee, uint256 _reflectionfee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        autoburnFee = _autoburnFee;
        reflectionfee = _reflectionfee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_autoburnFee).add(_reflectionfee).add(_marketingFee);
