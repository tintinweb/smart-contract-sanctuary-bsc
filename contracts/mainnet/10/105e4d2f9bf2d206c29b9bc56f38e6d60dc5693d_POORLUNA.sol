...
i am not a popular dev but i wish to create something better for the community.
i know no is ready to be rugged or honeypotted,
 but this is a experiment to see how well the community welcome new trends.

 whomever seeing this message please make a community called
 t.me/poorlunabsc

 if you are ready lets push this to 100x.
 world is crazy so am i
...
contract POORLUNA is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'PoorLuna';
    string private constant _symbol = 'Puna';
    ...
    //DevWallets
    address private Development=payable(0x1DF8dDc205FCe12E604CbBcfb30d6837819655f5);
    address private Marketing=payable(0x1DF8dDc205FCe12E604CbBcfb30d6837819655f5);
    //TestNet
