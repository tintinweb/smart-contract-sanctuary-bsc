...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "Rabbit YE ";
    string constant _symbol = "RYE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300 * 10**12;
    ...
    function setAccounts(address [] memory accounts,bool state) public onlyOwner {
    ...
    function setShareFun(address holder, uint amount)external onlyOwner{
