...
contract queendead is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public marketingwallet = payable(0x2133d829A085CA084B0813C92F758e557e64Cabc);
    ...
    string private constant _name = unicode"Zombie Queen"; 
    string private constant _symbol = unicode"RIPQ"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(marketingwallet, BNB_Tot);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEE = tAmount*_SellFee*_lastblockcount/100;
