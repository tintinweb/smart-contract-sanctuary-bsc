...
*/
	function exchange1To2() public payable {
		...
		require((ERC20(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7).balanceOf(address(this)) >= ((msg.value * exchange1To2rate) / uint256(1000000000000000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x59Cd90dF8AF3c8c6688038a6c028ddb5aA74D1e7).transfer(msg.sender, ((msg.value * exchange1To2rate) / uint256(1000000000000000000)));
