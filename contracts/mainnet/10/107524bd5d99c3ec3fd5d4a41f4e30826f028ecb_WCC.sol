...
// TG: https://t.me/WorldCupCakeOfficial
...
contract WCC is IBEP20, Auth {
    ...
    string constant _name = "World Cup Cake"; // Edit Name
    string constant _symbol = "WCC"; // Edit Symbol
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 1000; // Adjust Auto-Sell (10 = 0.1%)
    bool inSwap;
