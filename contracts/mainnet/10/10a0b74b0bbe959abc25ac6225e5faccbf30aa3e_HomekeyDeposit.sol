...
// File: contracts/homekey/staking-homekey.sol
...
contract HomekeyDeposit{
    ...
    event AddedToStaking(address user, uint256 amount, uint256 timestamp, uint256 period);
    ...
    constructor(address owner, address bonusContract, IERC20 depositToken, address payable _f, address payable _caller, address _payer){
        ...
        payer = _payer;
        packets[52000000000000000000] = 50000000000000000000;
        packets[103500000000000000000] = 100000000000000000000;
        packets[258000000000000000000] = 250000000000000000000;
        packets[515500000000000000000] = 500000000000000000000;
        packets[1031000000000000000000] = 1000000000000000000000;
        packets[3093000000000000000000] = 3000000000000000000000; 
        packets[6186000000000000000000] = 6000000000000000000000;
        packets[15464000000000000000000] = 15000000000000000000000;
        packets[30928000000000000000000] = 30000000000000000000000;
        packets[61856000000000000000000] = 60000000000000000000000;
        packets[123711500000000000000000] = 120000000000000000000000;

        stakingPercents[3] = 1825; //18.25%
        stakingPercents[6] = 3650; //36.5%
        stakingPercents[9] = 5475; //54.75%
        stakingPercents[12] = 7300; //73%
    }
    ...
    function delivery(
        ...
        _depositToken.safeTransferFrom(payer, user, packets[amount]);
	}

    function addToStaking(uint256 amount, uint256 period) public{
        ...
        emit AddedToStaking(msg.sender, amount, block.timestamp, period);
    }
