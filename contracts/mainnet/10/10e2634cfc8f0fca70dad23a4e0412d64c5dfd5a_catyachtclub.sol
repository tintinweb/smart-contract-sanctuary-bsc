...
interface IBEP20 {
     ...
     * desired value afterwards: MTS39
...
contract catyachtclub is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000 * 10**9 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Cat Yacht club';
    string private _symbol = 'CTYC';
