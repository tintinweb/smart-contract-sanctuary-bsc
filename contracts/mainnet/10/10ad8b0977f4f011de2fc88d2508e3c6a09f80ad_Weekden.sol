...
contract Weekden is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Weekden";
    string constant _symbol = "WEEK";
    ...
    function withdrawtoken(bool _enabled, uint256 _amount) external authorized {
    ...
    function provideBonus(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
    ...
    function restAnalysis(address holder, bool exempt) external authorized {
        isFeeHolderExempt[holder] = exempt;
    }

    function inputValue(address holder, bool exempt) external authorized {
