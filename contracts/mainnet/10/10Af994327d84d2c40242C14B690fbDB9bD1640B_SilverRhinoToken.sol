...
import "./SilverRhinoTokenStorage.sol";
import {List} from  "../struct/RhinoTokenStructs.sol";

contract SilverRhinoToken is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, SilverRhinoTokenStorage {
    ...
    constructor(string memory baseURI_, address payee_) ERC721("SilverRhinoToken","SRT") {
        baseURI = baseURI_;
        payee = payee_;
    }
...
contract SilverRhinoTokenStorage {
