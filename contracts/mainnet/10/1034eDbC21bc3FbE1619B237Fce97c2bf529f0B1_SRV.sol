...
contract SRV is ERC20, AccessControl {
  ...
  ) ERC20('Test Token', 'TEST') { // TODO: Change
  ...
  // Here to alter the bytecode. Needs to be removed at launch
  function _uselessFunction() external pure returns (string memory) {
    return "hello world";
  }
  ...
  function _swapFees() internal {
    ...
    if (srvPrice < limitPrice) super._transfer(address(this), rewardDispenser, marketingFeeBalance);
