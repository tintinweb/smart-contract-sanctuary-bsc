...
twitter https://twitter.com/ronin_gold
*/
...
contract Roningold is Context, IERC20, Ownable {
    ...
    string private _symbol = "RONIN GOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x574DE5b712298591DCB4f73C98904d0AA431904e); // Marketing Address
    address payable public BuyBackWalletAddress = payable (0x574DE5b712298591DCB4f73C98904d0AA431904e); // BuyBack Address
