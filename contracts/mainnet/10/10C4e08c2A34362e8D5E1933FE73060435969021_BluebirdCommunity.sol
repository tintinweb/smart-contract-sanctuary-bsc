...
contract BluebirdCommunity is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    address private _owner;

    string private constant _name = "Bluebird Community";
    ...
    address payable public DevWallet = payable(0xE8B1a958997db80ef39C7a0D90542dB54907DcB5);
    address payable public MarketingWallet = payable(0x05EeB9Ce3fc90Df74F7dAbAb312Dc81044a9a881);
    address payable private TeamWallet01 = payable(0x14a7ceDfafAfDE3a7fbEaE568FD861A01ccD12A7);
    address payable private TeamWallet02 = payable(0x9743944Ba4Ae9e1BeD48a6D4Fa5098080793597E);
    address payable private TeamWallet03 = payable(0x8a4B6AD2AcE8812601068622E42E557262892af3);
