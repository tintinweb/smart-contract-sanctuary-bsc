...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // BNB
...
contract VICBETS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("VICBETS", "VBETS") {
        
        address newOwner = address(0xFe8cc6A3cC88E5FfA76EB8FB0fc7d40cE1ba1f2a);
    
        uint256 totalSupply = 1000000000000 * 10**18;
        
        maxTransactionAmount = totalSupply * 1 / 200; // 0.5% max transaction in the first 24hours
        swapTokensAtAmount = totalSupply * 2 / 10000; // 0.02% swap tokens amount
        maxWallet = totalSupply * 9 / 200; // 4,5% max wallet
    	...
    	marketingWallet = address(0x9Ad837d4d83E68bcaF815389bcd64236B24954dA); // set as marketing wallet
    ...
    function updateMinimumToken(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        dividendTracker.updateMinimumToken(minimumTokenBalanceForDividends);
    }   
    ...
    function getMinimumToken() external view returns(uint256) {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xFe8cc6A3cC88E5FfA76EB8FB0fc7d40cE1ba1f2a),
            block.timestamp
        );
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 5000000000 * (10**18); //must hold 5,000,000,000 (0,5%) tokens
    }
    ...
    function updateMinimumToken(uint256 newMinBalance) external onlyOwner {
        require(newMinBalance > 0);
    	minimumTokenBalanceForDividends = newMinBalance * (10**18);
    }
