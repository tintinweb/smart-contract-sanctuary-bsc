...
/**
Telegram : https://t.me/NomadSafemoon_BSC
*/
...
contract NomadSAFEMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nomad SAFEMOON";
    string private _symbol = "nSAFEMOON";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9C80e6Afe8a1C2f75672dFc11Ff6FA0bD053fbfa); // MARKETING Address
    address payable public teamWalletAddress = payable(0x9C80e6Afe8a1C2f75672dFc11Ff6FA0bD053fbfa); 
