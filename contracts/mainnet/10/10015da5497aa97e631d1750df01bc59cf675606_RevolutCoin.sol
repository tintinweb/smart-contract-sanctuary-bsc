...
contract RevolutCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RevolutCoin";
    string private _symbol = "RVLT";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x6271474014417925626e9c6877Af8735B12146f7);
    address payable public teamWalletAddress = payable(0x6271474014417925626e9c6877Af8735B12146f7);
