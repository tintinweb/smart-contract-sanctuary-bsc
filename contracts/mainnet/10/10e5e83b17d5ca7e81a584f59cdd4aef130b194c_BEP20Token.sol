...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_exchangePoolAddress == sender) {// buy or remove liquitidy
            ...
            bool shouldSetInviter = _exchangePoolAddress != address(1) && recipient != _exchangePoolAddress
   ...
   */
    ...
    function setFourServiceAddress(address p10, address p3, address p25, address p55) public onlyOwner {
