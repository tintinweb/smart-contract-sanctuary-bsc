...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8182620CF88cf50B6DFEE2C56d1Ba3E28E8Ef671;
...
contract Anal1969 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anal 1969"; // 
    string private constant _symbol = "ANAL69"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x8182620CF88cf50B6DFEE2C56d1Ba3E28E8Ef671);
