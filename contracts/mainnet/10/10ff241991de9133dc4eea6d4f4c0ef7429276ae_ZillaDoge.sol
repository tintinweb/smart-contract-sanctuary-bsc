...
contract ZillaDogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DogeLeaderDividendTracker", "DogeLeader_DividendTracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "DogeLeaderDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DogeLeaderDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main ZillaDoge contract.");
    }
...
contract ZillaDoge is ERC20, Ownable {
    ...
    address public marketingWallet = 0xECA47e687CbF92532E2d55F3f6206Dd18E59a553;
    address public buybackWallet = 0x5CdEcc80a48fa158B6d08EbE2711eaBB4f51ca8F;
    ...
    constructor() ERC20("DogeLeader", "DogeLeader") {
        ...
        */
        _mint(owner(), 1 * 10**11 * (10**decimals()));
    ...
    function _transfer(
        ...
        if (!_isExcludedFromPeriodLimit[from]) {
            require(getAccountPeriodSellVolume(from).add(amount) <= balanceOf(from), "Sell limit!");
        }
        if (!_isExcludedFromPeriodLimit[from]) {
