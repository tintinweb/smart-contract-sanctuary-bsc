...
*TELEGRAM: https://t.me/SpankMyAssOfficial
*/
...
contract SpankMyAss is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spank My Ass"; 
    string private _symbol = "MYASS"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd122E703F1b200C17BdFDc998B8c0785794CA853); 
    address payable public teamWalletAddress = payable(0x192b89d1Fc9AfF5eE1b62710540B65510562c15D); 
