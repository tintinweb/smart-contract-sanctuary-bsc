...
contract BigPiXiu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BigPiXiu";
    string private _symbol = "BigPiXiu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1E2A94F17B89a4D2aBBe76E09e46c02976FBd598); 
    ...
    uint256 private _totalSupply = 10 *  10**19 * 10**_decimals;
