...
*TELEGRAM: https://t.me/SpookyDollars
*/
...
contract SDOLLARS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " SPOOKY DOLLARS ";
    string private _symbol = " $SDOLLARS "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb26c5dDD37C01E6859Eb4A9F5Cd0863D1348DA24); 
    address payable public teamWalletAddress = payable(0xb26c5dDD37C01E6859Eb4A9F5Cd0863D1348DA24); 
    ...
    uint256 private minimumTokensBeforeSwap = 111 * 10**_decimals;
