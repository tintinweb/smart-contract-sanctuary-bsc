...
library Address {
     ...
     *
     * https://diligence.consensys.net/posts/20118/018/stop-using-soliditys-transfer-now/[Learn more].
     *
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract CUZZ is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 652000000  * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CUZZCoin";
    string private _symbol = "CUZZ";
    ...
    uint256 public _maxTxAmount = 652000000  * 10**18; 
    uint256 private numTokensSellToAddToLiquidity = 2430  * 10**18;
    uint256 public _maxWalletToken = 652000000 * 10**18;
