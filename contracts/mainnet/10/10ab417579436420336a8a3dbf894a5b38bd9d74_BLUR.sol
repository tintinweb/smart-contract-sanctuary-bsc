...
contract BLUR is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x5C67E013A1753E54C81b8A8e7E5E86a7F5821164);
    address payable private _marketingAddress = payable(0x5C67E013A1753E54C81b8A8e7E5E86a7F5821164);
