...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress,address DevAddress,address BurnAddress, address ReceiveAddress,
...
contract TFX is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000000,
        address(0x6e5C5f965219cDcb1252458F7dbA6E6156534F45),
        address(0xB0C01E37dcC104D80fb393c66664C16a55c0844a),
        address(0xc92D8348B239661450b288c80f80fB793B19aF4D),
