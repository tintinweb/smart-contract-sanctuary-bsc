...
/**
Tg : https://t.me/AKfoursevenCatCoin
*/
...
contract AK47CatCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AK47 CatCoin";
    string private _symbol = "AK47CatCoin";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xE4aEAAe38f7BD7c57d2eF735eD4CC704DF154c00); // Marketing Address
    address payable public teamWalletAddress = payable(0x3CCf6FE4E1f09992020a6887B91Ae3f7C336D1A8); // Team Address
