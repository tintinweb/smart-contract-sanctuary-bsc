...
contract BoarInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Boar Inu";
    string private constant _symbol = "Boarrr";
    ...
    address private marketingWallet = address(0x3a2a85D4913C00a1daB826c95C176198d367B818);
    ...
    function Boar() public onlyOwner {
