...
contract BBRReflec is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xBA4f0A936b7E6A7fdB73ea95BF1ca2caeD2Ef5c3;
    address MARKETING = 0x53AC8956a01804A98d4fffEBA3EDC280F09Bb14f;

    string constant _name = "BitBurnReflect Reflec";
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[address(MARKETING)] = true;
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[address(DEV)] = true;
        isTxLimitExempt[address(MARKETING)] = true;

        isTimelockExempt[msg.sender] = true;
        isTimelockExempt[DEAD] = true;
        isTimelockExempt[address(this)] = true;
        isTimelockExempt[address(DEV)] = true;
        isTimelockExempt[address(MARKETING)] = true;
