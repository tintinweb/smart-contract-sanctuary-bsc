...
contract VEND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VEND";
    string private _symbol = "VEND";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC3ac61f2bD1905DBDf43283a23c4A23D95207a56); 
    address payable public BurnedWalletAddress = payable(0x8aa3EBd251284bA92611d0Dfe81216467c93f6f1); 
