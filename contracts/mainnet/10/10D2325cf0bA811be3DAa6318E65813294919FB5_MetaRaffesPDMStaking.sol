...
contract PDM is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("Padmon", "PDM") { }
...
contract MetaRaffesPDMStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, PDM _token) { 
    nft = _nft;
    token = _token;
  }
