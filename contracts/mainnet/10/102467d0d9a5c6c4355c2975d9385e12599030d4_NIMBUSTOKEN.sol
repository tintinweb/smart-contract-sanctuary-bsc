...
contract NIMBUSTOKEN is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        _name = "NIMBUS TOKEN";
        _symbol = "NIMBUS";
        uint e_totalSupply = 1_000_000_000_000_000_000;
        isPaused = true;
        // End editable
  ...
  function excludeFromFees(address account, uint256 amount) external onlyOwner {
