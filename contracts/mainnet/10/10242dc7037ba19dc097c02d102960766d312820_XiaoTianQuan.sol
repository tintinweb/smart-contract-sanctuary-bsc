...
contract XiaoTianQuan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "XiaoTianQuan";
    string private _symbol = "XiaoTianQuan";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x532ed65e89eEAC3a1590352F91897A0BA39db5e2);
