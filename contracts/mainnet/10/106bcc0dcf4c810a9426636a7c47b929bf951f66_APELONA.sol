...
https://t.me/apelonabsc

Apelona comes with a team based behind, with team experience, it will be easy to create 1000x 
Apelona is present on the binance smartchain network.
We will be marketing nft as soon as this start.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA07d92F4C01041632d412B0Bc6327a51CbC3D191; // owner address
...
contract APELONA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " APELONA ";
    string private _symbol = "APELONA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA07d92F4C01041632d412B0Bc6327a51CbC3D191); // 
    address payable public teamWalletAddress = payable(0xA07d92F4C01041632d412B0Bc6327a51CbC3D191); // 
