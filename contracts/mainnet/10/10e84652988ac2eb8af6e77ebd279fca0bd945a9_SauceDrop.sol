...
contract SauceDrop is IBEP20, Auth {
    ...
    string constant _name = "SauceDrop";
    string constant _symbol = "MCSAUCE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 200; //3.5% 
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100; //7%
    ...
    address private marketingFeeReceiver = 0x1891598EBC08F0cc9449Cda41f2EaeBa79987982;
    address private developmentFeeReceiver = 0x1891598EBC08F0cc9449Cda41f2EaeBa79987982;
