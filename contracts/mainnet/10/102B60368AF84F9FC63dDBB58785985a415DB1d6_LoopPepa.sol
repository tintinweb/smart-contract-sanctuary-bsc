...
contract LoopPepa is IBEP20, Auth {
    ...
    address constant DEV = 0x4D9f905f76bC3Ce8b43A45Edca32169D0503932C;


    string constant _name = "Loop PEPA";
    string constant _symbol = "$LPEPA";
