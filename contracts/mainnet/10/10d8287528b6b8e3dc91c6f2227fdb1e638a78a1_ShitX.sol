...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
...
contract ShitX is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShitX";
    string constant _symbol = "ShitX";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xB27ADAfFB9fEa1801459a1a81B17218288c097cc;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 33;
    uint256 public _walletMax = _totalSupply / 33;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xAf24083b3A7EBc5361A80721F15b9D9DB8F9CF80;
