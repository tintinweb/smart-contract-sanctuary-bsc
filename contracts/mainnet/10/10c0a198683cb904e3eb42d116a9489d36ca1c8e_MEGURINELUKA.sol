...
// Telegram : https://t.me/MegurineLukaBSC
...
contract MEGURINELUKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MEGURINE LUKA";
    string private _symbol = "MEGURINE LUKA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1e1977bA174bC95adb1f9fe3E0Aa434D676C7BB4); // Marketing Address
    address payable public teamWalletAddress = payable(0x1e1977bA174bC95adb1f9fe3E0Aa434D676C7BB4); // Team Address
