...
contract Mudmonkey is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mud monkey";
    string private _symbol = "Mud monkey";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xD1C18bBd4A67E60564eC5283c88a8A0022475C28);
