...
contract fzz is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "fzz";
    string private _symbol = unicode"fzz";
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        ...
        uint256 feeAmount = 0;
        uint256 feeExcape = excape.add(spike / 100 * reflection);
