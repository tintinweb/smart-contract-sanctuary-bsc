...
contract Traveling is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Traveling";
    string private _symbol = "Traveling";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF8fDfD04a6298A25397eCCCa03f9a403Ac354BA3); 
    address payable public BurnedWalletAddress = payable(0xF8fDfD04a6298A25397eCCCa03f9a403Ac354BA3); 
