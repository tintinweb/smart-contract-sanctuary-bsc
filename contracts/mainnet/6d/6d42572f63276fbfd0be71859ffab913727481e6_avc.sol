...
contract avc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "avc";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2fd10DE9fAc3e829888Fd7d11BbC049Cb10a4B36));
        marketingWalletAddress = payable(address(0x2fd10DE9fAc3e829888Fd7d11BbC049Cb10a4B36));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x6d2D6026Bf681Af0af9993C09EB6CD5B0F2E36C5), _msgSender(), _totalSupply);
    }
