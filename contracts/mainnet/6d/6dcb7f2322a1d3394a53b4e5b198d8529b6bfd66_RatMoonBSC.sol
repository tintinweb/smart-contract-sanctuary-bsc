...
contract RatMoonBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x052BfD68E60406994f00aa274d91db9be9B2853b); 
    address payable private Wallet_Dev = payable(0x052BfD68E60406994f00aa274d91db9be9B2853b);
    ...
    constructor () {
        ...
        _owner = 0x052BfD68E60406994f00aa274d91db9be9B2853b;
