...
contract Cxda is IERC20, Ownable {
    ...
    address private _fundAddress = address(0x1c6e3f022EEdc94085664Eaa2baf2513fAD40923);
    address private _projectAddress = address(0x6C9fC62433bd88f1aDe21f67E17B091833ea2B5b);
    address private _lpAddress = address(0x3B21D1Af94cF263c7ee3Fd6515a50E048c93E153);
    ...
    constructor(address tokenOwner){
        ...
        _name = "Constellation dog Alliance";
        _symbol = "Cxda";
        _decimals = 18;
    ...
    function _transfer(
        ...
        uint256 Fee ;        
        if(_isuniswapV2Pair[from] || _isuniswapV2Pair[to] ){
            if(from == _owner || to == _owner || from == _lpAddress || to == _lpAddress){
                Fee = 0;
            }else{
                Fee = _Fee;
            }
    ...
    function _tokenTransferBuy(
        ...
        if(tFee > 0){
            uint256 destroyFee = tFee.mul(3).div(10);
            uint256 projectFee = tFee.mul(3).div(10);
            uint256 fundFee = tFee.mul(4).div(10);
