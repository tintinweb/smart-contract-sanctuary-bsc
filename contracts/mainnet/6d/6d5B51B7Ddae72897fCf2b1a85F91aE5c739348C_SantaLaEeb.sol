...
contract SantaLaEeb is Context, IERC20 {
    ...
    string private constant _symbol = "SALA";
    ...
    address payable public DevWallet = payable(0x2dDDF24A7A4A082c7BF33Da1270A5eBF206C046e);
    address payable public MarketingWallet = payable(0x85d76C0C059f90F0E849bf679492d547aE8552fD);
    address payable private TeamWallet01 = payable(0x8605258167D2E37031c98D9f726583a914B66026);
    address payable private TeamWallet02 = payable(0xF6C6897A7E1cE31894E7521F71a76f4f74c83f3c);
    address payable private TeamWallet03 = payable(0xb6510327B26645576A7F5aFff82e62A9Fc29b878);
