...
contract WJJPreSale is Ownable {

    using SafeMath for uint256;

    IERC20 public WJJ = IERC20(0x36E768985848Cb502D30EfA1b7267a5F75e9F6c6);
    address public Recipient = 0x1931e0a8501A6E526DC201F54159A768217A441B;

    uint256 public tokenRatePerEth = 12500; // 12500 * (10 ** decimals) WJJ per eth
    uint256 public minETHLimit = 0.25 ether;
    uint256 public maxETHLimit = 200 ether;
    ...
    function deposit() public payable checkIfPaused {
        ...
        require(WJJ.transfer(msg.sender, tokenAmount), "Insufficient balance of presale contract!");
    ...
    function getTokensPerEth(uint256 amount) internal view returns(uint256) {
        return amount.mul(tokenRatePerEth).div(10**(uint256(18).sub(WJJ.decimals())));
    }
}