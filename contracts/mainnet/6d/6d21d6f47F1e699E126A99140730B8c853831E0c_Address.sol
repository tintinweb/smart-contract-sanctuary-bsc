...
// File: contracts/BaganCoinPaymentNetwork.sol


/*

Telegram: https://t.me/BaganPaymentNetwork

Website: https://BaganPaymentNetwork.com

Twitter: https://twitter.com/BaganPaymentNetwork
...
contract BaganPaymentNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bagan Payment Network Coin";  
    string private constant _symbol = "BPNC";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _MarketingTax = 3; 
    uint256 public _LiquidityTax = 4; 
    address public  _marketing = 0x42E7473D1888Cac4e0d4ca11171b699282D4c744;
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _LiquidityTax / (_MarketingTax + _MarketingTax);
