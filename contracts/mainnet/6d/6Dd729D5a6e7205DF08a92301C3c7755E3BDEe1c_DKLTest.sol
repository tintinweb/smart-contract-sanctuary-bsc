...
contract DKLTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DKLTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DKLTest", "DKLT") {
        marketingWallet = payable(0x7299336E094dd0f5a74f6bdCbfE7fECc401b81C4);
        treasuryWallet = payable(0x7299336E094dd0f5a74f6bdCbfE7fECc401b81C4);
        ...
        dividendTracker = new DKLTestDividendTracker(
            payable(this),
            router,
        ...
        maxTxAmount = totalTokenSupply / 200; // .5%
...
contract DKLTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DKLTest public DKLTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DKLTestContract = DKLTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DKLTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DKLTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DKLTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DKLTestContract);

            uint256 prevBalance = DKLTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = DKLTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DKLTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
