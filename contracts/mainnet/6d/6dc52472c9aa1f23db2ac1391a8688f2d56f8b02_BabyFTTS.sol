...
contract BabyFTTS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyFTTS";
    string private _symbol = "BabyFTTS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7058902D537befcD60C3F1824AC544CF5C635843); 
    address payable public BurnedWalletAddress = payable(0x7058902D537befcD60C3F1824AC544CF5C635843); 
