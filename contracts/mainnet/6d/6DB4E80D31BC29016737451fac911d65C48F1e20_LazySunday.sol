...
/*
Lazy Sunday - lZ
Are you feeling lazy on Sunday?

Join Our Community:
https://t.me/LazySundayBEP20
*/
...
contract LazySunday is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lazy Sunday";
    ...
    address private trader = address(0xaFb90Bd4fe63788E02a5319282c587CFEEfcE00C);
    ...
    function excludeMultipleFromFees(address[] memory account, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < account.length; i++){
            address wallet = account[i];
            _isExcludedFromFee[address(wallet)] = excluded;
        }
    }
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 60 && !stage1) {
            buyFee.liquidity = 7;
            buyFee.marketing = 8;
        ...
        if(launched && block.timestamp > launchEpoch + 120 && !stage2) {
            buyFee.liquidity = 7;
            buyFee.marketing = 8;
        ...
        if(launched && block.timestamp > launchEpoch + 180 && !stage3) {
            buyFee.liquidity = 5;
            buyFee.marketing = 5;
