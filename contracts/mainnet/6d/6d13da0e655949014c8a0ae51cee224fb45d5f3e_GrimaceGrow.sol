...
contract GrimaceGrow is IBEP20, Auth {
    ...
    address DEV =  0x3Ad23A9F46D32f28604e71a79e8dDDF428aA3DaF;
    ...
    // Name and symbol
    string constant _name = "Grimace Grow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // 0.5% (50 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.5% (50 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 10000; // 0.5% (50 mil)
