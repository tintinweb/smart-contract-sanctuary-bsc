...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43b3Db5b5E0aD169Ef5939e2eD9C12A17c7A1a27; // owner address
...
contract TakuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Taku Inu";
    string private _symbol = "TAKUINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43b3Db5b5E0aD169Ef5939e2eD9C12A17c7A1a27); // Marketing Address
    address payable public teamWalletAddress = payable(0x43b3Db5b5E0aD169Ef5939e2eD9C12A17c7A1a27); // Team Address
