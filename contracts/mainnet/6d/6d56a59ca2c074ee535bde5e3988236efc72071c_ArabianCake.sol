...
/**
Website www.arabiancake.com
Telegram https://t.me/arabiancake
*/
...
/* Token contract */
contract ArabianCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x595940D3ff0F8e9Ac200928FD36741572f1f8d4c;
    ...
    // Name and symbol
    string constant _name = "Arabian Cake";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% max buy
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% max sell
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% max wallet
