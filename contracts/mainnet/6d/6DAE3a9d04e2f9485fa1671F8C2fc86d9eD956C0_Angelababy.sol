...
contract Angelababy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angelababy";
    string private _symbol = "Angelababy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd3025272f92b96C091309238D5Ca5C64d9F96EF8); // Marketing Address
    address payable public teamWalletAddress = payable(0x9a190555F3c7B8E61e0Df42935FdbdD677A487cb); // Team Address
    ...
    uint256 public _maxTxAmount = 100 * 10**8 * 10**_decimals; 
    uint256 public _walletMax = 100 * 10**8 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100 * 10**8 * 10**3; 
