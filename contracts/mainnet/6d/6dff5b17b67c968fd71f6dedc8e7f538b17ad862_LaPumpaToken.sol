...
/**
Before the pump there was LA PUMPA. Community driven token.
Telegram: https://t.me/LaPumpaToken
Launched by Josh from The Jungle BSC.
*/
...
contract LaPumpaToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "La Pumpa Token";
    string constant _symbol = "LPT";
