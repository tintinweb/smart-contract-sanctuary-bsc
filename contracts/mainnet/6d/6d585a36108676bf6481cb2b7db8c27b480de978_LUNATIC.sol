...
contract LUNATIC is IBEP20, Auth {
    ...
    address DEV = 0xE30D35898F56394226768eB988d9bd06d49c36D5;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 4 / 100; // 4.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 2 / 100; // 3% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100; // 4% or 5m tokens
