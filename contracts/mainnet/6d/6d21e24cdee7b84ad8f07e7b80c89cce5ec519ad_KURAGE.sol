...
/* Token contract */
contract KURAGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xc05E58f1652A1B3c5a5E2ea0A8602E36b05102A0;
    ...
    // Name and symbol
    string constant _name = "SHOKUSHU";
    string constant _symbol = "KURAGE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 888888 * (10 ** _decimals); // 888,888
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc05E58f1652A1B3c5a5E2ea0A8602E36b05102A0;
