...
contract FaucetToken is ERC20Detailed, AdminRole {
    address public reserveTokensAddress;

    bool public tradingEnabled;

    constructor(address _reserveTokensAddress) public ERC20Detailed("FaucetToken", "FT", 6) {
        require(_reserveTokensAddress != address(0));

        reserveTokensAddress = _reserveTokensAddress;

        _mint(msg.sender, 100000000 * (10 ** uint256(decimals())));
        _mint(reserveTokensAddress, 1000000000 * (10 ** uint256(decimals())));
