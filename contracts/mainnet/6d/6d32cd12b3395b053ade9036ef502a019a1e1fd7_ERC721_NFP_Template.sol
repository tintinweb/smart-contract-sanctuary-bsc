...
import "../ERC/IERC721Receiver.sol";
 ...
 */
contract ERC721_NFP_Template is IERC721Mintable, IERC721Enumerable, IERC721Metadata {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual returns (bool) {
        return interfaceId == type(IERC721).interfaceId || interfaceId == type(IERC721Metadata).interfaceId || interfaceId == type(IERC721Enumerable).interfaceId;
    }
    /**
    ...
    function burn(uint256 tokenId) external {
        require(msg.sender == ownerOf(tokenId), "ERC721: burn caller is not owner");
        _burn(tokenId);
    }
