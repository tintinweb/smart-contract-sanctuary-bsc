...
contract YoshieInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YoshieInu";
    string private _symbol = "$YINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C34B5F6010588E847D2EC3E28485eca0EeBD1E3); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**9; //5 * 10**6 * 10**9 1% max tnx
