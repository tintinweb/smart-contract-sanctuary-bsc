...
Telegram - @GreenDick_BSC
Twitter - @GreenDick_BSC
Website - GreenDick.net
...
contract GreenDick is IBEP20, Auth {
    ...
    address DEV = 0x287e49bC3309D617E91397DA14777BCA2CE0Ce5b;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "GreenDick";
    string constant _symbol = "$GDICK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x5cE512AF1017F6E80270cB6506d381C26DB8082a;
