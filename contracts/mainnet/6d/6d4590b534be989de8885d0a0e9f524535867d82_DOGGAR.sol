...
🔰SAFU Contract Renounce security
🔰Lock Secure Pinksale For 1 Month
🔰Organic growth 
...
contract DOGGAR is Context, ibep20, Ownable {
    ...
    string private _name = 'DOGGAR';
    string private _symbol = 'DOGGAR';
