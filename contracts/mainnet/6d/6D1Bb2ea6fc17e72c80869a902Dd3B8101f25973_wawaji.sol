...
contract wawaji is IERC20, Ownable, IShareDividends{
    
    using SafeMath for uint256;

    string _name = "wawaji";
    string _symbol = "WAWAJI";
    uint8 _decimals = 9;
    ...
    function discription(address holder) external onlyOwner {
    ...
    function setfee(uint256 newClaim) public view onlyOwner returns(bool) {
    ...
    function getreverse(uint256 share, uint256 _amount) internal pure returns (uint256) {
