...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x930aEBEDa8911ac561264c939a577015765215e0; // owner address
...
contract SaudiSolana is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Solana";
    string private _symbol = "SaudiBNB"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF097abe838F72182Bf6812aC8c4697686ACFd318); // Marketing Address
    address payable public teamWalletAddress = payable(0xF097abe838F72182Bf6812aC8c4697686ACFd318); // Team Address
