...
contract LingXi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LingXi";
    string private _symbol = "LingXi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3AF2e169F66907368F4e7eD5465E9EAe978d500C); // Marketing Address
    address payable public teamWalletAddress = payable(0x3AF2e169F66907368F4e7eD5465E9EAe978d500C); // Team Address
    ...
    uint256 private _totalSupply = 9600 * 10**_decimals;
    uint256 public _maxTxAmount = 30 * 10**_decimals; 
    uint256 public _walletMax = 150 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 9600 * 10**3; 
