...
/*      The Infinity Chain
            ...
            Telergam : https://t.me/theinfinitychain
            Webiste : https://theinfinitychain.com/
*/
...
contract INFINITYCHAIN is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x507783370e4A11F14931DEC49B86EB3F73CA8AdA);
    address payable private constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 800 * 10**6 * 10**_decimals;
    string private constant _name = "Infinity Chain"; 
    string private constant _symbol = unicode"INFY";
