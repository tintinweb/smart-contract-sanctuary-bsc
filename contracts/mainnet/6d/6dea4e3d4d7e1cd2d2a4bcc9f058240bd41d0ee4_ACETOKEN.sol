...
contract ACETOKEN is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        burnAddress = payable(0x74d406f4916B339AC1F1365d7E69324d33e20E48);
        marketingAddress = payable(0x0e2Faa0A97b4b40F382ddc93655ec68fF24F9B83);
        safetyAddress = payable(0xF0600F03ffab67804B286A31771cDe5b54460176);
        daoAddress = payable(0xe0d1B591A4FB4e6D8CA0308492e3fc7216D75432);
        remainAddress = payable(0x115C1B7F8E50923d312987c8AE6822bDD2D6410A);
