...
contract ChiroInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chiro Inu";
    string private _symbol = "Chinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Ec1866266ff3EC073429BA7D3E784c666ea8b8B);
    address payable public BuyBackWalletAddress = payable(0x5Ec1866266ff3EC073429BA7D3E784c666ea8b8B);
