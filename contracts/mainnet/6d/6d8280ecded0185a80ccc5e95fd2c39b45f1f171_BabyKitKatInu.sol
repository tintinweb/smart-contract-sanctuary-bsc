...
/**
Telegram : https://t.me/babykitkatinu
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb00A4E5db393Ee476d465c86caC2161a0788AFAf; // owner address
...
contract BabyKitKatInu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby KitKat Inu";
    string private _symbol = "BKITKAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4ff1b50a1809E242d4112e812C69dDc3E205eB8a); // Marketing Address
    address payable public teamWalletAddress = payable(0x4ff1b50a1809E242d4112e812C69dDc3E205eB8a); // Team Address
