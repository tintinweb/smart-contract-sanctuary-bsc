...
contract MRToken is Context,IERC20,Ownable {
    ...
    // 营销分润地址
    address private lpAddress = 0xaCdFbC30f1B5F12994fb372b202c4799D3eDAB89;
    // 黑洞地址
    address private blackHole = 0xe02A0b11026a761069Db11D9720b1975407cF251;
    // USDT合约地址
    ...
    constructor() {
        ...
        // 发行代币一千万枚
        uint256 lianyou_num = 100000000000 * 10 ** uint256(_decimals);
        ...
        _isExcludedFromFee[address(_tokenDistributor)] = true;
