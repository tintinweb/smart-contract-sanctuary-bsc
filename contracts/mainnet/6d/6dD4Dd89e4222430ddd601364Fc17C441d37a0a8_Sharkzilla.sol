...
/**
STEALTH LAUNCH 
TG: https://t.me/+pKO9Smg8TXhkNjZl
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D87E341C4Cf02Fcb78f52Fd99cC2651dE7C1DC0; // owner address
...
contract Sharkzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SharkZilla";
    string private _symbol = "$SZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd2Dfb261ece62430B10802E59F4750f12E4b3cE); // Marketing Address
    address payable public teamWalletAddress = payable(0xFd2Dfb261ece62430B10802E59F4750f12E4b3cE); // Team Address
