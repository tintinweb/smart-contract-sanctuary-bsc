...
//https://t.me/SixNineRat - Who's the snitch? 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  CNOMAD = IBEP20(0xf6493A3cBE587c7Fa891E9828C5C9072616595b2);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CNOMAD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CNOMAD);
        ...
        uint256 amount = CNOMAD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CNOMAD.transfer(shareholder, amount);
...
contract six9ineRat is IBEP20, Auth {
    using SafeMath for uint256;

    address CNOMAD = 0xf6493A3cBE587c7Fa891E9828C5C9072616595b2; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x78fEfA01a458C32105BECb36F538cb0F43582E74;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "69RAT";
    string constant _symbol = "69RAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x21193B351D09a069048E9323523F1162E23287b8;
