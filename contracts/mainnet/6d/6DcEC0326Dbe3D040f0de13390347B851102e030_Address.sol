...
contract FLOKIBNBGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki BNB Grow"; // 
    string private constant _symbol = "FBNBGROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x78C4AA0a09eAdefa0aD265238082E54014545AD8;
