...
contract RastaInu is IBEP20, Auth {
    ...
    string constant _name = "RastaInu";
    string constant _symbol = "INU420";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 4200000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 420; 
    uint256 public _maxWalletSize = (_totalSupply * 4) / 420; 
    ...
    address public marketingFeeReceiver = 0xD764838768A2350C8ABb15FCc41D472DFa2E1BD2;
