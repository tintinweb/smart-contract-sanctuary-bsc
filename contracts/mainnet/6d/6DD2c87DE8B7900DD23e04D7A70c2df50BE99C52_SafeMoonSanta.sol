...
$$\   $$ |$$  __$$ |$$ |     $$   ____|$$ |\$  /$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |      $$\   $$ |$$  __$$ |$$ |  $$ | $$ |$$\ $$  __$$ |
\$$$$$$  |\$$$$$$$ |$$ |     \$$$$$$$\ $$ | \_/ $$ |\$$$$$$  |\$$$$$$  |$$ |  $$ |      \$$$$$$  |\$$$$$$$ |$$ |  $$ | \$$$$  |\$$$$$$$ |
 \______/  \_______|\__|      \_______|\__|     \__| \______/  \______/ \__|  \__|       \______/  \_______|\__|  \__|  \____/  \_______|                                                                                                                                                                                                                                                              
/**               

Telegram : https://t.me/SafeMoonSantaTG
Website : TBA
*/
...
contract SafeMoonSanta is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SafeMoonSantaDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 0; //default cooldown 1s
    ...
    constructor() ERC20("SafeMoonSanta", "SMSanta") {
        marketingWallet = payable(0x678396a873104ca8D72cE134f48aA1c20E73e439);
        devWallet = payable(0xBfE0f1f7c44df89eAF1062Fe0038143A0ee165D6);
        ...
        dividendTracker = new SafeMoonSantaDividendTracker(
            payable(this),
            router,
            0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5,
            "SafeMoonSantaTRACKER",
            "SafeMoonSantaTRACKER"
        );
...
contract SafeMoonSantaDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SafeMoonSanta public SafeMoonSantaContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SafeMoonSantaContract = SafeMoonSanta(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SafeMoonSanta_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SafeMoonSanta_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SafeMoonSanta contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SafeMoonSantaContract);

            uint256 prevBalance = SafeMoonSantaContract.balanceOf(address(this));
            ...
            {
                uint256 received = SafeMoonSantaContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SafeMoonSantaContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
