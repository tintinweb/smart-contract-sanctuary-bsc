...
/*
    ...
    ♦️ Website: https://ironshiba.net
    ♦️ Twitter: https://twitter.com/IronShibaBsc
    ♦️ Telegram: https://t.me/IronShiba
...
contract IRONSHIBA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "IRONSHIBA"; // Edit Name
    string constant _symbol = "ISHIB"; // Edit Symbol
    ...
    uint256 public marketingFee    = 6; // Edit Marketing Fee
