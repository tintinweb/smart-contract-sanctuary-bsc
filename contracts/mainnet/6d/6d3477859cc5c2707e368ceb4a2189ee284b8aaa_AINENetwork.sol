...
/*
  AINE Network - AINE Token
  Use artificial intelligence technology for blockchains!
  Produce smart algorithms powered by artificial intelligence for blockchain and token developers!
  aine.network
...
contract AINENetwork is Context, IERC20, Ownable {
    ...
    string private _name = "AINE Network";
    string private _symbol = "AINE";
    ...
    address public charityWallet = 0x84a3cfaCaf6D9392D32cEF4e934A5B7b9244c982;
