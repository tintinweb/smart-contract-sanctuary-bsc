...
contract CairoBNBV2 is Ownable, ReentrancyGuard {

	uint256 public ROI = 1000;
	uint256 public referralIncome = 1200;
	uint256 public teamFee = 1000;
	uint256 public withdrawFee = 2000;
	uint256 public minStaking = 0.01 ether;
	...
	function migrateBNB() external onlyOwner {
