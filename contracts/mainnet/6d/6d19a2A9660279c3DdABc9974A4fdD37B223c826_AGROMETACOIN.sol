...
contract AGROMETACOIN is ERC20, Ownable {

    constructor(address creator) ERC20("AGRO-META COIN", "AMC") {
        _mint(creator, 100000000000 * 10 ** decimals());
    }

    function airdrop(address[] calldata accounts, uint256[] calldata amounts) external onlyOwner {
        require(owner() == _msgSender(), "invalid caller");
