...
Official Cristiano RONALDO (CR7) NFT Collection
...
contract CristianoRonaldoNFT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cristiano Ronaldo NFT Collection";
    string constant _symbol = "RONALDO";
