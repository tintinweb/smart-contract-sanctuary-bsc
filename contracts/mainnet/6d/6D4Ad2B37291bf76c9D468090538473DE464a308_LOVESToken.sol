...
contract LOVESToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA40418782202bB0c4EcaCb8D4dc0825D8B873E67); 
    ...
    uint256 private _tTotal = 13140 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LOVES";
    string private _symbol = "LOVES";
    ...
    uint256 public _maxTxAmount = 13140 * 10**18;
    uint256 private minimumTokensBeforeSwap = 26 * 10**18;  
    ...
    function MultiDistribute(address[] memory receivers, uint256[] memory amounts) public {
