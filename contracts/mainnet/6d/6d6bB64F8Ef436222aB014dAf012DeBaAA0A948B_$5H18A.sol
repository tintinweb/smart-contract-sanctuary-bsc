...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x688683fE476ab0cBe41cBddc2528F699D5aa18B4; // owner address
...
contract $5H18A is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "5HI8A";
    string private _symbol = "5HI8A";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F64fC660974fd2b6ee2E97230bCCa8490871346); // Marketing Address
    address payable public teamWalletAddress = payable(0x688683fE476ab0cBe41cBddc2528F699D5aa18B4); // Team Address
