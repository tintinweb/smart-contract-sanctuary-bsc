...
/*
    Telegram: https://t.me/kittymoonboy
*/
...
contract KittyMoonBoy is IERC20, Ownable {
    ...
    string _name = "KittyMoon Boy";
    string _symbol = "KMBOY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);   // 10,000,000
    uint256 public _transferLimit = (_totalSupply * 50) / 100;   // 50% 
