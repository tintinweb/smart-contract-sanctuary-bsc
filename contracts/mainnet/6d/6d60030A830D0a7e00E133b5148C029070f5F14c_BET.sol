        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7cF971274e8E5Bb8c8284e37036CcD0B885a1424), block.timestamp
                );
            }
        }
    }
...
contract BET is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x7bB8EcC20Bd1254886d770161c534D8fBce55FFB),//FundAddress
        address(0x235D48DfA9654EC14225220330f7239dF330EB1d)//ReceiveAddress
    ){
    }
}