...
/**
#ALPHA LAUNCH - SAFE TEAM
Teams Prior Did 150k, Can We do Bigger this one?
...
contract TwitterDrive is Context, IERC20, Ownable {
    ...
    string private constant _name = "TwitterDrive";
    string private constant _symbol = "$TDRIVE";
