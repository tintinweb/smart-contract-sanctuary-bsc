...
contract TokenB is Ownable, ERC20 {
    ...
    string private constant _name = "TokenB"; //Brewlabs";
    string private constant _symbol = "TokenB"; //BREWLABS";
    ...
    address public dividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //USDC
    ...
    // Base taxes
    CustomTaxPeriod private _base = CustomTaxPeriod("base", 0, 0, 1, 1, 1, 1, 8, 8, 0, 0, 4, 4);
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        IRouter _uniswapV2Router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Mainnet
