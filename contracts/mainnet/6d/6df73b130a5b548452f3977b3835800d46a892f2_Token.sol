...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyBlackFee =3000;//买进销毁

    uint256 private _sellFundFee = 4000;  //卖出营销钱包费用  100等于1%
    uint256 private _sellLPDividendFee = 0;
    uint256 public _sellLPFee = 0;
    uint256 public _sellBlackFee = 0; //卖出销毁
    
    uint256 public numTokensSellToFund = 5000;  //营销钱包触发回流阈值
    ...
    constructor (
        ...
        maxTXAmount = 1000 * 10 ** Decimals;//单次限购
