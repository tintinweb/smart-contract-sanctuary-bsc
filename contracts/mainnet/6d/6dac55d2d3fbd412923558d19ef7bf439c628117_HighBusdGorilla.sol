...
High Busd Gorilla was born to compete with the jeet thinking that goes on at the BSC these days.
...
/* Token contract */
contract HighBusdGorilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "High Busd Gorilla";
    string constant _symbol = "HBG";
