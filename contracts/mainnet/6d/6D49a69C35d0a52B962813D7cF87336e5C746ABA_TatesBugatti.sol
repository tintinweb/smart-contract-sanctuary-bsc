...
/*  ==================================================== */
//  Telegram: https://t.me/tates_bugatti
//  TikTok: https://www.tiktok.com/@officialtatesbugatti
//  Twitter: https://twitter.com/tates_bugatti
/*  ==================================================== */

// I'm not just the best in the world at one thing, I'm the
// best in the world at multiple things. What are you good at?
...
contract TatesBugatti is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tates Bugatti";
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        require((newLiqFee + newRewardFee + newMarketingFee + newExtraSellFee) <= 10, "Total tax cannot exceed 10%");
    ...
    function importantMessageFromTeam(string memory input) external authorized {}
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 finalAmount = !isFeeExempt[sender] && !isFeeExempt[recipient] ? tateFee(sender, recipient, amount) : amount;
    ...
    function tateFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        
        uint256 feeApplicable = (pair == recipient || pair == sender) ? totalFee : noFee;
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(devWallet).call{value: anothermarketingShare, gas: 30000}("");
