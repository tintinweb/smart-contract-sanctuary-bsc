...
contract ShibaPump is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1a93E6204a47efA3Ad4b2f4F58098b863628DE47));
        marketingWalletAddress = payable(address(0x1a93E6204a47efA3Ad4b2f4F58098b863628DE47));
