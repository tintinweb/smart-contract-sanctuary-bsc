...
contract SafemoonTate is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xdd4C9249a8B1C5eA07e2D7044D9A639165e4c538;

    string constant _name = "Safemoon Tate";
    string constant _symbol = "SFMT";
