...
contract Catomania is Context, IERC20, Ownable {
    ...
    string private _name = "Catomania";
    string private _symbol = "Catomania";
    ...
    address payable private _marketingWallet = payable(0xFDa71859835508b4617EDf92Fdd84ffC3a18Ac12);
    address payable private _devWallet = payable(0x814b75C31c6333aF5fD5A9caCEC441A80556092a);
