...
contract DevIsHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is Hare";
    string private _symbol = "$DevHR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAaa2b219399AD9e9b33Ea3AB917Bd7998C3d9C32);
    address payable public BuyBackWalletAddress = payable(0xAaa2b219399AD9e9b33Ea3AB917Bd7998C3d9C32);
