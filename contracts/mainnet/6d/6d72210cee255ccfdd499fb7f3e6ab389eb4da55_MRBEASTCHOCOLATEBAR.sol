...
Telegram: https://t.me/mrbeastchocolate
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x530F170a904A70C562701c1b4e7B1858182aADcd;
...
contract MRBEASTCHOCOLATEBAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "MR BEAST CHOCOLATE BAR"; // 
    string private constant _symbol = "$MBCB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x530F170a904A70C562701c1b4e7B1858182aADcd);
