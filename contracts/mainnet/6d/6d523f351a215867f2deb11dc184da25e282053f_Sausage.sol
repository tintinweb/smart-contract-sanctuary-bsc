...
contract Ownable is Context, IERC165{  
    ...
    */
    ...
    function ChangeAgnes(address newOwner) external onlyOwner returns (bool) {
...
contract Sausage is Ownable {
    ...
    string public name = "Sausage";    
    string public symbol = "Sausage";
	...
	function calcSausageDevFee(uint256 _amount, uint256 _devFee) private pure returns (uint256) {
		return _amount.mul(_devFee).div(
			10**2
		);
	}
	
	function processSausageIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
