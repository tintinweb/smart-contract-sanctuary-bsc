...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8bB6B0b5D857d67Af57B23551e1f5B8Cce52BEDB;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x8bB6B0b5D857d67Af57B23551e1f5B8Cce52BEDB),//fund address
    
        address(0x8bB6B0b5D857d67Af57B23551e1f5B8Cce52BEDB)//dev address
    ){
