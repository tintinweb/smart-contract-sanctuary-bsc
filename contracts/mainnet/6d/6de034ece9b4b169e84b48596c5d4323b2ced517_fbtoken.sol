...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x5560bB9188a1d7fdc83Da2780B19d6EDf6dd752d;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x5560bB9188a1d7fdc83Da2780B19d6EDf6dd752d),//fund address
    
        address(0x5560bB9188a1d7fdc83Da2780B19d6EDf6dd752d)//dev address
    ){
