...
contract BabySpaceX is ERC20 {
	...
	address payable _fundAddress = payable(address(0xEabc84401e66a48dceC55F9D41f039148ad2DA83));
    ...
    constructor(address tokenOwner) ERC20("BabySpaceX", "BabySpaceX") {
    ...
    function _transfer(
        ...
        if (takeFee) {
			super._transfer(from, uniswapV2Pair, amount.div(100).mul(2));
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
		...
		if(allUsdt > haveUsdt){
			USDT.transfer(_fundAddress,(allUsdt.sub(haveUsdt)).div(2));
		}
    }
