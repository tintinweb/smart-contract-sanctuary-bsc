...
contract aa is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x6067F2b26E65325e0b1a2Ce0E9f1677A327677c7;
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000 * 10**18;
	  uint256 private numTokensBurn = 20000000 * 10**18;
    ...
    function fee(address account, bool val)  external onlyOwner() {
        _isExcluded[account] = val;
    }
