...
Telegram - https://t.me/cashcatbsc
*/
...
contract CASHCAT is Context, IBEP20, Ownable {
    ...
    function setFees_Liq(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _lpFeeBuy = lpFee;
    }

    function setFees_Mkt(uint taxFee, uint lpFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _lpFeeSell = lpFee;
    }
