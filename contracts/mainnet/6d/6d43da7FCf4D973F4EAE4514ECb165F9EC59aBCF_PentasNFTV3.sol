...
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
import "./Counters.sol";
import "./MarketplaceV3.sol"; // Not in use. Need to remain here due to contract upgrade.
    ...
    OwnableUpgradeable
{
     ...
     * @dev Marketplace contract
     */
    MarketplaceV3 private _marketplace; // Not in use. Need to remain here due to contract upgrade.
