...
EtherSOL NFT is a revolutionary & community-driven project based on the Binance smart chain that integrates the two biggest Blockchain coins – Ethereum & Solana – in the same project. Built on a combined eco-system of Utility & Passive Income, EtherSOL NFT dApp is a fork of Pancakeswap and will allow its Holders to Swap BEP-20 Tokens and benefit from the best Staking APY with EtherSOL NFT Staking platform. Moreover, Holders will enjoy 6% of $SOL & $ETH and a healthy chart with Buy-backs triggered every 24h
*/
...
contract EtherSOLNFT is Context, IBEP20, Ownable {
