...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb0dcf6E20E3133288F34D4f2534c5919f2401D7;
...
contract KingLaeeb is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5467CC109a17CB50946D84d4D644C5Fd57498Fae;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "King Laeeb";
    string private _symbol = "KingLaeeb";
