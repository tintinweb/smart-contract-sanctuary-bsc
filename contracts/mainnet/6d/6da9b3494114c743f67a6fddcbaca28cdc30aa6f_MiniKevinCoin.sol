...
contract MiniKevinCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RussianKevin";
    string private _symbol = "RSK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0fE4a63eB194C8d3216e04Dc878856B2b52F1103); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0fE4a63eB194C8d3216e04Dc878856B2b52F1103); // BuyBack Address
