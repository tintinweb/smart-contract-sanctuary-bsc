...
pragma solidity ^0.6.12;
    ...
    contract SafeRugV2 is Context, IERC20, Ownable {
        ...
        string private _name = 'SafeRugV2';
        string private _symbol = 'SafeRugV2';
        ...
        address payable public _Dev_Vacation_Wallet_LOL;
        ...
        constructor (address payable MarketingWalletAddress) public {
            _Dev_Vacation_Wallet_LOL = MarketingWalletAddress;
            ...
            _isExcludedFromFee[_Dev_Vacation_Wallet_LOL] = true;
        ...
        function sendETHToMarketing(uint256 amount) private {
            _Dev_Vacation_Wallet_LOL.transfer(amount.mul(3).div(8));
        ...
        function _setDevsVacationFee(uint256 MarketingFee) external onlyOwner() {
