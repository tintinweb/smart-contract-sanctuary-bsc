...
Welcome everyone ! Trump tweets will be launched in few minutes on bsc !

💹  5% Taxes
💹  NO TEAM TOKEN
💹  Renounce AFTER LAUNCH

💹  Fat Marketing wallet

Join the community!   https://t.me/TrumpTweets
...
contract TrumpTweets is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Trump Tweets";
    string constant _symbol = "3T";
    ...
    address public Owner=0xc4C7812D33f7C507d39003Db9AE2995bd38Fb323; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xc4C7812D33f7C507d39003Db9AE2995bd38Fb323;
