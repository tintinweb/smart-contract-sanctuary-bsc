...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x740BC8875587e11507b813f0FF696Aee3e46b4C8;
...
contract Wilmerco is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdFDaB37c8C95f6b6Db5C58D38333ACFE03A08798;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 25000000 * 25**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Wilmerco";
    string private _symbol = "WMRC";
