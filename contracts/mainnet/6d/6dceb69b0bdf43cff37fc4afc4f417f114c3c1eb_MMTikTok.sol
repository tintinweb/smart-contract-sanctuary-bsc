...
// @memecoinmission & @memecoinmission1 on TikTok
//
// Posting daily on each account, get on the moon ride now!
//
// 1000x Potential, Contract Renounced, Liquidity Locked
//
// 4% max tx & 6% max wallet
//
...
contract MMTikTok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MemecoinMission on TikTok";
    string private _symbol = "MMTikTok";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9E764006C3e46592E5d22fE89B47BEbB67BE1BcE); // Marketing Address
    address payable public developmentWalletAddress = payable(0x9E764006C3e46592E5d22fE89B47BEbB67BE1BcE); // Development Address
    ...
    uint256 public _sellDevelopmentFees = 11;
