...
contract DECENTRAWORLDTERRA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "DECENTRAWORLDTERRA";

    string private _symbol = "DWT";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0x1d750dd6e198De3F13e64740EbD06801C225E5C2;
