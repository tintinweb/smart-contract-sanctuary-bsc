...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MetaFLOKI";
    string internal constant SYMBOL = "MFLOKI";
    ...
    address internal charityAddress = 0x3261a976Bae9d20336273146fFacb60B8FF6472B;
    address internal marketingAddress = 0x3261a976Bae9d20336273146fFacb60B8FF6472B;

    address internal burnAddress = 0x0000000000000000000000000000000299792458;

    address internal tipToTheDev = 0x3261a976Bae9d20336273146fFacb60B8FF6472B;
...
abstract contract MetaFLOKIToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract MetaFLOKITokenV1 is MetaFLOKIToken{

    constructor() MetaFLOKIToken(Env.MainnetV2){
