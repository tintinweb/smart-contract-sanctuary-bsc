...
contract DAOverse is Context, IERC20, Ownable {
    ...
    string private _name = "DAOverse";

    string private _symbol = "DAOverse";
    ...
    address payable public marketAddress = 0xCc8D6F0FE4181752DEA1f1e590C9f3845171E8d8 ; //Marketing
