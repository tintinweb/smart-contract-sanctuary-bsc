  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    if(tokenWhitelist[msg.sender] == true || tokenWhitelist[_to] == true ){
      ...
      if(txFee > 0){
          ...
          uint256 DeflaionaryDecay = mulDiv(tempValue, txFee, 10000);
          balances[FeeAddress] = balances[FeeAddress].add(DeflaionaryDecay);
          emit Transfer(msg.sender, FeeAddress, DeflaionaryDecay);
          _value =  _value.sub(DeflaionaryDecay); 
      }
...
contract BillyCat is PausableToken {
    string public name;
