...
contract abekiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "abekiller";
    string private _symbol = "abekiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x61331314fa22629345be9b8886F5dBE15A6920Fe); // Marketing Address
    address payable public teamWalletAddress = payable(0x61331314fa22629345be9b8886F5dBE15A6920Fe); // Team Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public OwnerAddress =0x61331314fa22629345be9b8886F5dBE15A6920Fe;
