...
contract BrewlabsZapInApeSwap is Ownable {
    ...
    function settlePendingCake(
        ...
        if (_reward == address(cake)) {
            ...
            uint256 _amount = _performZapIn(lpToken[_pid], amountETH);
    ...
    function _token2Token(
        ...
        address pair = apeFactory.getPair(
            _FromTokenContractAddress,
            _ToTokenContractAddress
        );
        require(pair != address(0), "Brewlabs: No Swap Available");
