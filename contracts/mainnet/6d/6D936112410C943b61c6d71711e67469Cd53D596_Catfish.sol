...
contract Catfish is Context, IERC20, Ownable {
    ...
    string private _name = "Catfish";
    string private _symbol = "Catfish";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF9B37442Ed46C8B2441c77f01f7176c51616b3d5);
    address payable public teamWalletAddress = payable(0xB8A1853C7D3D5a480f7121f8C008E27E12CbF378);
