...
/**
If you still own SportomonGo, Then this is the token for you. 
*/
...
contract SportomonGoTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SportomonGoTwo";
    string private _symbol = "SportomonGo2.0";
