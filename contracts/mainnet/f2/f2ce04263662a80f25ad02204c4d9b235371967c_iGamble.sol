...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7940A14a0Cd1e4F9130305256132649B47Aa051d; 
...
contract iGamble is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "iGamble";
    string private _symbol = "iGamble";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7940A14a0Cd1e4F9130305256132649B47Aa051d); // 营销
    address payable public teamWalletAddress = payable(0x38F63149Bb3F295168210474fe4F0a56ebadaE14); // 团队
