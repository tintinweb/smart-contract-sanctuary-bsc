...
Yet another memecoin based on catboy!
This is a community token. 
SHILL YOUR BAGS SO WE CAN MOON

Easy 10-100x if we're dedicated.
...
contract StrayCatBoy is Context, IERC20, Ownable {
    ...
    string private constant _name = "StrayCatboy";
    string private constant _symbol = "SCB";
