...
contract SavEarth is Context, IERC20, Ownable {
    ...
    string private _name = "SavEarth";
    string private _symbol = "SAVEARTH";
    ...
    address public devWallet = 0xC7Eeb25cB95211b204A15BE9c93E1C576aB2b680;   // TODO: Change to the address which you use for deployment
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**18; //0.1% of total supply max allowed transaction
    uint256 private numTokensSellToAddToLiquidity = 1000000000000 * 10**18; 
    uint256 public _maxWalletToken = 10000000000 * 10**18; // max allowed 1% of total supply per wallet
    ...
    function setDistributionFee(uint256 disFee) external onlyOwner() {
       _taxFee = disFee;
    }
    function setDeveloperFee(uint256 devFee) external onlyOwner() {
       _devFee = devFee;
    }
    ...
    function setMaxWalletAmount(uint256 maxWalletAmount) public onlyOwner{
        ...
        _maxWalletToken = maxWalletAmount * 10**18;
    }
