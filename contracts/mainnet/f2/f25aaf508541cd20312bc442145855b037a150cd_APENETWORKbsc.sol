...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x620b88679Ae768E01335Cb19B77f87f96eB4f084;
...
contract APENETWORKbsc is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1C6089Fa7726Ac609c55e0869444760485d64eBd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "APENETWORKbsc";
    string private _symbol = "APENETWORKbsc";
