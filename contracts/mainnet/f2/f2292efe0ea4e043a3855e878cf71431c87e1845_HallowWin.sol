...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6cF62c698c74CB553b5C0089Fa86dE3600eb3606; // owner address
...
contract HallowWin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Hallow-Win!";
    string private _symbol = unicode"H-Win";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6cF62c698c74CB553b5C0089Fa86dE3600eb3606); // Marketing Address
    address payable public teamWalletAddress = payable(0x6cF62c698c74CB553b5C0089Fa86dE3600eb3606); // Team Address
