...
contract Spacewhalemoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Space Whale Moon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8D8B0Dc6C18751b690213c0713E9596b582D22cA));
        marketingWalletAddress = payable(address(0x8D8B0Dc6C18751b690213c0713E9596b582D22cA));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xA54882786f9328C18c2201F5cB853c00d618D1eF), _msgSender(), _totalSupply);
    }
