...
/**
 * Hello PoddleInu Community
 * 
 * TG: https://t.me/PoddleInu_BSC
 * 
 * 
 * PoddleInu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract PoddleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Poddle Inu";
    string constant _symbol = "Poddle";
