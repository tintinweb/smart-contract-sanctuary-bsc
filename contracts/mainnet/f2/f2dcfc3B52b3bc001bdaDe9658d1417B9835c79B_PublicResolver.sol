 ...
 * address.
 */
contract PublicResolver is Initializable,ABIResolver, AddrResolver, ContentHashResolver, DNSResolver, InterfaceResolver, NameResolver, PubkeyResolver, TextResolver {
    BNS bns;
   ...
   function __PublicResolver_i(BNS _bns, INameWrapper wrapperAddress) public initializer 
    {
        __PublicResolver_init(_bns,wrapperAddress);
    }    

    function __PublicResolver_init(BNS _bns, INameWrapper wrapperAddress) internal onlyInitializing 
    {   
        __PublicResolver_init_unchained(_bns,wrapperAddress);
    }

    function __PublicResolver_init_unchained(BNS _bns, INameWrapper wrapperAddress) internal onlyInitializing {
        bns = _bns;
