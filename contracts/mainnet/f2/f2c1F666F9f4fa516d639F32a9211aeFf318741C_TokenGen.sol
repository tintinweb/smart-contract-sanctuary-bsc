...
import {StandardERC20} from './ERC20.sol'; 
import './libraries/Ownable.sol';
import './interfaces/ITokenFactory.sol';

contract TokenGen is Ownable {
    ...
    function createToken(
        ...
        StandardERC20 newToken = new StandardERC20(name, symbol, decimals, totalSupply, owner);
...
contract StandardERC20 is ERC20 {
    constructor(
        ...
        address _tokenOwner) ERC20(_name, _symbol) {
            _mint(_tokenOwner, _tokenTotalSupply * 10 ** _tokenDecimals);
        }
}
