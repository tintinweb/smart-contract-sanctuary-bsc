...
/**
Shigaraki inu  will be partnering with prominent influencers in the space and will be donating to charities decided upon by the community.

With big 💎 hand investors & call group owners on board, you do not want to miss out on this moonshot!


The Grinch Inu ($Shigaraki) lives on the Ethereum Blockchain. It has several highly deflationary mechanisms and is made to maintain a stable liquidity over time. The core part of The Shigaraki inu ($Shigaraki) is a strong and vibrant community that loves to give back. Giving back to children in need touches the core values of the Grinch Inu.

The Shigaraki inu team are thinking long term and want to make sure there is always volume to back up further development of the project. A percentage of the marketing wallet will be invested into yield bearing assets to secure a steady and continuous development. The profits of these investments are reinvested back into $GINU and also back to the Grinch Inu NFT holders. The Grinch Inu DAO will make sure the community plays an important role in choosing what investments will be made. 
The DAO will also decide what charity we will donate to.

Max tx : 1% 
Tax : buy and sell 10%

tg : shegarakiinuofficil
*/
...
contract SHIGARAKI is IBEP20, Auth {
    ...
    string constant _name = "Shigaraki Inu";
    string constant _symbol = "SHIGARAKI";
    ...
    address public marketingFeeReceiver = 0x20AF96BD2dF24c427cda17894356892eb3e41bAd;
    address public devFeeReceiver = 0x20AF96BD2dF24c427cda17894356892eb3e41bAd;
