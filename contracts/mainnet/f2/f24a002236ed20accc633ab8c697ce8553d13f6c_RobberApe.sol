...
/**
NEXT TOKEN MOONSHOT
LOW TAX - SAFE CONTRACT - SAFE TEAM - LOCK LP - RENOUNCE OWNERSHIP  
Telegram : https://t.me/RobberApe
*/
...
contract RobberApe is IBEP20, Auth {
    ...
    string constant _name = "RobberApe";
    string constant _symbol = "ROAPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; //4% 
    ...
    address private marketingFeeReceiver = 0x6ef605303d786c68957cCef2bDf22F8157AECCB7;
    address private developmentFeeReceiver = 0x9621C43A42316C1aaC081EcF7e5D8ae18E6B5687;
