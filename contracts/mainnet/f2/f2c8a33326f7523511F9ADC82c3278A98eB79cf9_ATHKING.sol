 ...
 * Hello bsc Community
 * 
 * TG: https://t.me/ATHKING
 * 
 * 
 * ATH KING token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract ATHKING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ATH KING";
    string constant _symbol = "ATHKING";
