...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 1000_0000*(10**_decimals);

    uint256 public _maxSwap = 0;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    uint256 public swapTokensAtAmount = 10*(10**_decimals);
    ...
    uint256 public txSellFee = 500;
    uint256 public rewardBuyFee = 200;
    uint256 public rewardSellFee = 200;
    ...
    address _one;
    address public _protectAddr = 0x6Db927cc371E86d68403124b6111919495B9A39B;
    ...
    constructor() ERC20("WIN BNB", "WIN BNB") {
        if (block.chainid == 56) {
        ...
        excludeFromFees(address(_protectAddr), true);
    ...
    function setRewardSellFee(uint256 value) external onlyOwner {
        rewardSellFee = value;
    }
    ...
    function updateProtectAddr(address account) public onlyOwner {
        _protectAddr = account;
    }
