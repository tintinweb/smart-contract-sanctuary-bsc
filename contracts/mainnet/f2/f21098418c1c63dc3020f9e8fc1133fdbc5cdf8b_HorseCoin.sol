...
contract HorseCoin is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HorseCoin", "HORSE") {
        BNBRewardsFee = 6;
        liquidityFee = 1;
        extraFeeOnSell = 1;
        marketingFee = 3;
        marketingWallet = payable(0x3560E2b8F52f784C4cF1C84274AE08ff0f5Ad03f);
