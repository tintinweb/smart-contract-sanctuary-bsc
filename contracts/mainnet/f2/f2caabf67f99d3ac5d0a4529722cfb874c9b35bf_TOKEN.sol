...
contract TOKEN is Context, IBEP20, Ownable, LockToken {
    ...
    uint256 private _buyChairtyFee = 3;
    ...
    constructor() {
        ...
        _symbol = "$BACK";
        _decimals = 9;
        _tTotal = 300000000000 * 10**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 30000000 * 10**_decimals;
        _maxWalletBalance = 1500000000 * 10**_decimals; // 0.5% 
        _maxTxAmount = 600000000 * 10**_decimals; // 0.2%
        _marketingWalletAddress = 0x161c3c361dDa15fd9a2a7e9C1d6aBDA990d77341; 
        _charityWalletAddress = 0x91308e9240828f4D2D9a1b0EBfFA6D263Ee400AE; 
        ...
        _isExcludedFromMaxWallet[_charityWalletAddress] = true;
    ...
    function setSellFeePercent(
        ...
        require(totalSellFee <= 20, "Must keep fees at 20% or less");
    }
 ...
 // Withdraw stucked tokens 
    ...
    function swapBack(uint256 contractBalance) private lockTheSwap{
                ...
                uint256 ethForFloor = ethBalance * charityTokens / (totalTokensToSwap - (tokensForLiquidity/2));
                ...
                (success,) = address(_charityWalletAddress).call{value: ethForFloor}("");
