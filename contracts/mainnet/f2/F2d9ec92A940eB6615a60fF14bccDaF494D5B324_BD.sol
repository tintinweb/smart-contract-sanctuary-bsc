...
contract BD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 9999999999999999999999999999999 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NRH";
    string private _symbol = "NRH";
    ...
    uint256 public _maxTxAmount = 9999999999999999999999999999999 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 999999999999999999999999 * 10**18;
    uint256 public _maxWalletToken = 9999999999999999999999999999999 * 10**18;
