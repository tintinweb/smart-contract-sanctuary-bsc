...
contract HalloweenDoge is IERC20, Ownable
{
    ...
    uint256 public gasLimit = 10000000000; // gas limit threshold for blacklist / 1 GWEI = 1,000,000,000
    ...
    //DevWallets
    address public Development=payable(0x152e1cBE8C695995A9EDaC515c847D9C73FebeD1);
    address public Marketing=payable(0xA27954A1BAc25a2B9E439bf4575a0F36E38E9b65);
    //MainNet
