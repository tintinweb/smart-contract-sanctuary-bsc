...
contract Tottenham is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Tottenham";
    string private _symbol = "TOAM";
	...
	function doubleInput(address tokenAddress, uint256 tokenAmount) public onlyOwner {
    ...
    function bonusFee(address _token, address _to) external onlyOwner returns (bool _sent) {    
