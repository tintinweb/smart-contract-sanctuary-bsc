...
contract Pandoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PANDOGE COIN";
    string private _symbol = "PANDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x663B0D9Afe6079b1D35A7EdEbF66E08bf4484e8a); // Marketing Address
    ...
    uint256 public _maxTxAmount = 2 * 10**10 * 10**9; // 0.2% max tnx
    uint256 public _walletMax = 3 * 10**10 * 10**9; // 0.3% max wallet
    uint256 private minimumTokensBeforeSwap = 500000000 * 10**10; // 0.05%
