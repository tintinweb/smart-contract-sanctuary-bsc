...
/**
 * dont buy untill launched in tg group 
*/
...
/**
 * TG  https://t.me/KingSonicOfficial
*/
...
contract KingSonic is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xa3C4607e9A25A88661e0f7f8dFa9E5b2e80287E0;
    address public devWallet = 0x030a776Ee69a4404b17F12Cfd6C0AA548b4aE021;
    address public buybackWallet = 0xc6eA1dA7a998aBa21FaeCd7A1F55fdC374771869;

    string private constant _name = "King Sonic";
    ...
    Taxes public taxes = Taxes(1, 4, 4, 0, 2);
    Taxes public sellTaxes = Taxes(1, 6, 6, 0, 3);
