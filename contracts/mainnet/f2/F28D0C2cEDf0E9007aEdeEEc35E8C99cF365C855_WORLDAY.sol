...
Telegram: https://t.me/WorldEnvironment_Day
...
contract WORLDAY is Context, IERC20, Ownable {
    ...
    string private constant _name = "WorldEnvironmentDay";  
    string private constant _symbol = "WORLDAY";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 10; 
    uint256 public _DevFee = 0; 
    address public  _marketing = 0x012367f10d9BF8B435bFd92F8f40B4c8f25703f8;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _DevFee / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _DevFee / (_marketingAndLiquidityFee + _DevFee);
