...
contract ChinaNationalDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "China National Day";
    string private _symbol = "NATIONAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8A9F1dA6F80185418360E107DA5D04cd50d37219); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x8A9F1dA6F80185418360E107DA5D04cd50d37219); // BuyBack Address
    ...
    uint256 public _walletMax = 35 * 10**6 * 10**9;
