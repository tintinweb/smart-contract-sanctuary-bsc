...
Telegram : https://t.me/harakiriinu
*/
...
contract HirakiriINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HirakiriINU";
    string private _symbol = "HIRAKIRI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xbb13f10f67A4954D16112bC48fC2E071173308d7); // Marketing Address
    address payable public teamWalletAddress = payable(0xbb13f10f67A4954D16112bC48fC2E071173308d7); // Team Address
