...
Telegram : https://t.me/MinerMoon

 __  __  _  __  _  ____ _____     __  __  ____  ____  __  _ 
|  \/  || ||  \| || ===|| () )   |  \/  |/ () \/ () \|  \| |
|_|\/|_||_||_|\__||____||_|\_\   |_|\/|_|\____/\____/|_|\__|
...
contract MinerMoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MinerMoonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MinerMoon", "MinerMoon") {
        marketingWallet = payable(0x24cf2c9174891dC7F59aF5Af5B8786169Fd69687);
        buybackWallet = payable(0xecd2d82B25dC537b801c019b88f10431795BF2B3);
        ...
        dividendTracker = new MinerMoonDividendTracker(
            payable(this),
            router,
        ...
        _isExcludedFromFees[address(buybackWallet)] = false;
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + marketingFees + buybackFees);
...
contract MinerMoonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MinerMoon public MinerMoonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MinerMoonContract = MinerMoon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MinerMoon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MinerMoon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MinerMoon contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MinerMoonContract);

            uint256 prevBalance = MinerMoonContract.balanceOf(address(this));
            ...
            {
                uint256 received = MinerMoonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MinerMoonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
