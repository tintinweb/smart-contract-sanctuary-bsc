...
/**
 *Submitted for verification at BscScan.com on 13-11-2022
*/
...
contract WRONGHOLE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Wrong Hole";
    string constant _symbol = "OOH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69 * 10**6 * 10**_decimals;
