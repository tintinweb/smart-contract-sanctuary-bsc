...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80226468c0a2109C6fbAa0C110FB49f8D2E25fD4; // owner address
...
contract Bonkai is Context, IERC20, Ownable {
    ...
    string private _name = "Bonkai";
    string private _symbol = "$BONKAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80226468c0a2109C6fbAa0C110FB49f8D2E25fD4); // Marketing Address
    address payable public teamWalletAddress = payable(0x80226468c0a2109C6fbAa0C110FB49f8D2E25fD4); // Team Address
