...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x997a0BD1aB9893c563A47746dA0814a8De1dC641; // owner address
...
contract GoDCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoDCat";
    string private _symbol = "GoDCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x997a0BD1aB9893c563A47746dA0814a8De1dC641); // Marketing Address
    address payable public teamWalletAddress = payable(0x997a0BD1aB9893c563A47746dA0814a8De1dC641); // Team Address
