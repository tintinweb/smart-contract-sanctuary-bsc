...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24125758551641ab64108CC736fA6d1A551EE261; 
...
contract Panda is Context, IERC20, Ownable {
    ...
    string private _name = "Pandacoin";
    string private _symbol = "PANDAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24125758551641ab64108CC736fA6d1A551EE261); 
    address payable public teamWalletAddress = payable(0x24125758551641ab64108CC736fA6d1A551EE261); 
