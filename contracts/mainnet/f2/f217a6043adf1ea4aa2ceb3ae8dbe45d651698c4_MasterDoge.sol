...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbeF2f1970B4a552De8FB25704cd2A7A1ef07b5C1;
...
contract MasterDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbeF2f1970B4a552De8FB25704cd2A7A1ef07b5C1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Master Doge";
    string private _symbol = "MASGGE";
    ...
    uint256 public _maxTxAmount = 30000 * 10**18;
