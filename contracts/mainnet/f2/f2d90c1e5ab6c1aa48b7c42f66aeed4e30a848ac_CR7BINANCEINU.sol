...
contract CR7BINANCEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x53D5deC6a033c516F53950D52cdb8AB1Ca300f52); 
    address payable public Wallet_Dev = payable(0xCFe72D74836a93C48e2C1330f6e44221DB633b5F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0xA0FDe558e68369f08963E3037a229Bc30f97b800); 
    ...
    string private constant _name = "CR7BINANCEINU"; 
    string private constant _symbol = unicode"CR7BINANCEINU"; 
