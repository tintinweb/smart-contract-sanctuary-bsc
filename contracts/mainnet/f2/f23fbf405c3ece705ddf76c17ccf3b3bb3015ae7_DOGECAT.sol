...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x585577B548D4f3C0FfD8924E994eBF500B21c4a8; 
...
contract DOGECAT is Context, IERC20, Ownable {
    ...
    string private _name = "DOGECAT";
    string private _symbol = "$DOGECAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd87fdf72081359c123D940779b44f8c7eDDf5F2); 
    address payable public teamWalletAddress = payable(0xFd87fdf72081359c123D940779b44f8c7eDDf5F2); 
