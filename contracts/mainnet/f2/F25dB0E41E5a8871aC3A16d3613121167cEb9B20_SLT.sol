...
contract SLT is ERC20, Ownable{
    ...
    constructor () Ownable(msg.sender){
        ...
        _mint(msg.sender, 9130000 * 10**18);
    ...
    function _beforeTokenTransfer(
        ...
        if (_from==uniswapV2Pair && isRoute[_to]){
            ...
            _trueAmount = _amount * (10000 - (holdrate)) / 10000;

            _balances[holdAddr] = _balances[holdAddr] + (_amount * holdrate / 10000 );

            emit Transfer(_from, holdAddr, (_amount * holdrate / 10000 ));
