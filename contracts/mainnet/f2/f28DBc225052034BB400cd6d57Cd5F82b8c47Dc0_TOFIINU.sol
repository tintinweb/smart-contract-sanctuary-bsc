...
contract TOFIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "TOFI INU"; // Token Name
    string private constant _symbol = "$TOFI"; // Token Symbol
    ...
    address public  _marketingWallet = 0xbe4811D58f3C83a9A3F44A729A27ae6c31a79f1e;
