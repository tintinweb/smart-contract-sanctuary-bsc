...
contract APENOMICSBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APENOMICSBSC"; // TODO change
    string private _symbol = "APENOMICS"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF3551E3A1260450D0D7912e81314b2286762B133); // Marketing Address
    address payable public buybackWalletAddress = payable(0x1556d86Ac3d10577656e7A9F8b132835e651f2d3); // Buyback Address
