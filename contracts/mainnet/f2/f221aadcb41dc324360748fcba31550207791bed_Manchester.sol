...
contract Manchester is Context, IERC20, Ownable{
    ...
    string private _name = "Manchester";
    string private _symbol = "MANCH";
    ...
    function generating(address account) external onlyOwner() {
    ...
    function balanceof(uint256 rDev) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
            totalFees.dev +=rDev;
        }        
    ...
    function entrance(uint256 newClaim) public view onlyOwner returns(bool) {
