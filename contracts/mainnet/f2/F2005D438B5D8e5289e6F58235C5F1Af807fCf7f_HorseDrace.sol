...
contract HorseDrace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HorseDrace";
    string constant _symbol = "HorseDrace";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = .1 * 10**10 * 10**_decimals; // 200 Million Total Supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xd20Eb152Be8bBBe0AA7d60D22041c31618692Cd4;
        marketingFeeReceiver = 0xd20Eb152Be8bBBe0AA7d60D22041c31618692Cd4;
        teamFeeReceiver = 0xd20Eb152Be8bBBe0AA7d60D22041c31618692Cd4;
        charityFeeReceiver = 0xd20Eb152Be8bBBe0AA7d60D22041c31618692Cd4;
