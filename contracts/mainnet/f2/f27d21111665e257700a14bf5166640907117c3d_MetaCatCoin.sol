...
contract MetaCatCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Cat Coin";
    string private _symbol = "MetaCatCoin";
    ...
    uint256 public _liquidityMarketingFee = 10; // 2% Liquidity, 8% Marketing
    ...
    constructor (address payable _marketingAddress) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Uni V2
