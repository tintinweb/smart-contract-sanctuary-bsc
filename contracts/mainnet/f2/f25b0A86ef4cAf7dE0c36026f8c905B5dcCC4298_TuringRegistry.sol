...
// File: github/proofsys-tech/stake-reward-contracts/contracts/TuringRegistry.sol
 ...
 * @notice Implements a basic BEP20 staking token with incentive distribution.
 */
contract TuringRegistry is Ownable{

    string public name = "Turing Registry Token";
    string public symbol = "XREG";

    // configure EDIPI
    uint256 public lockPeriod = 1 seconds;
    uint256 public APY = 77; // 77% return per year for staking EDIPI
    uint256 public oneYear = 365 days; //77% return per year for staking EDIPI
    uint256 public maxSupply = 85_000_000 * 1e18; // 365 days //77% return per year for staking EDIPI
