...
Telegram: @GasperVladiBsc
Website: https://gaspervladi.site
...
contract GasperVladi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1481C1a87D8C66Bc8C228d5BAdb94c14162897c0); 
    address payable public Wallet_Dev = payable(0x48857f6773bd719ED4e7CaA90fd7b2aDd456Ed1f);
    ...
    string private constant _name = "Gasper Vladi Token"; 
    string private constant _symbol = unicode"GVT"; 
    ...
    constructor () {
        ...
        _owner = 0x48857f6773bd719ED4e7CaA90fd7b2aDd456Ed1f;
