...
contract DubaiJiru is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dubai Jiru";
    string constant _symbol = "DBJ";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _teamFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        teamFee = _teamFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_teamFee).add(_marketingFee);
