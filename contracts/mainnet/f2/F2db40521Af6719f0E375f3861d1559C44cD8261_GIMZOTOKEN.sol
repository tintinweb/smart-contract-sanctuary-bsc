...
// TELEGRAM : https://t.me/gimzotoken
...
contract GIMZOTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GIMZO TOKEN";
    string private _symbol = "$GIMZO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2921cff5e5c64229e9f6E9B584C727Be70A39f1A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2921cff5e5c64229e9f6E9B584C727Be70A39f1A); // BuyBack Address
