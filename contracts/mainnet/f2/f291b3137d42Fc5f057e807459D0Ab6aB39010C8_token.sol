...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = " Shiboween";
    string private _symbol = " Shiboween";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4c000d8de65fd757528290A907cD35c0DB489939); // Marketing Address
