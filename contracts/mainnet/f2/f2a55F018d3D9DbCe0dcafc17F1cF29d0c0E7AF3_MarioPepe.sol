...
TG: https://t.me/MarioPepeOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x979554874E36C0e753Cc26e475C795729ebED6eD; // owner address
...
contract MarioPepe is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Mario Pepe";
    string private _symbol = unicode"$MrPepe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x979554874E36C0e753Cc26e475C795729ebED6eD); // Marketing Address
    address payable public teamWalletAddress = payable(0x979554874E36C0e753Cc26e475C795729ebED6eD); // Team Address
