...
contract QJB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJB";
    string private _symbol = "QJB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2c1961e44776DD3b5258498b0dA70aA8fC84aE0B);
    address payable public teamWalletAddress = payable(0x2c1961e44776DD3b5258498b0dA70aA8fC84aE0B);
    address public immutable deadAddress = 0x2c1961e44776DD3b5258498b0dA70aA8fC84aE0B;
