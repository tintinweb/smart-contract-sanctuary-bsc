...
contract SwapPoolForClaimNFT is Ownable {
    ...
    function SwapToken(uint256 _tokenId) external {
        ...
        uint256 _token_id = userClaimNFT.tokenOfOwnerByIndex(address(this), 0);
        userClaimNFT.transferFrom(address(this), msg.sender, _token_id);
        emit claimNFT2(address(this), msg.sender, _token_id);
    }
