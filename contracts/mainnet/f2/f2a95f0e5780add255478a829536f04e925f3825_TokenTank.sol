...
contract TokenTank is BEP20, Whitelist {

    string public constant name = "Token Tank Liquidity Token";
     ...
     * @param min_liquidity Minimum number of POINTS sender will mint if total DEGREE supply is greater than 0.
     * @param max_tokens Maximum number of tokens deposited. Deposits max amount if total DEGREE supply is 0.
