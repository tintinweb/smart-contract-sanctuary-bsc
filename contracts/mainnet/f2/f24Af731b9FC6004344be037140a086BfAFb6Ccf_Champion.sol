...
/*
    ...
    Champion Community
    Telegram : https://t.me/Champion_cn
...
contract Champion is Context, IERC20, Ownable {
    ...
    string private _name = "Champion";//Champion
    string private _symbol = "Champion";
    uint8 private _decimals = 9;

    bool public isLaunch = false;
    uint public launchedBlock;
    uint private TaxBlock = 20;
    
    address payable public marketingWalletAddress = payable(0x9fd73e389563b7ceEa25faC8186Fd4c88A141608);
    address public liquidityWalletAddress = 0x21721A074718802eE8D9B53dC7B0Db6DEA50cF90;
    ...
    uint256 public deservedPercentBuy = 85;
    uint256 public deservedPercentSell = 80;
    function updateDeserve(uint valueBuy, uint valueSell) external onlyOwner{
        deservedPercentBuy = valueBuy;
        deservedPercentSell = valueSell;
    }
