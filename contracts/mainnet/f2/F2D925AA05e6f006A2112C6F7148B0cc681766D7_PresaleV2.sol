...
contract PresaleV2 is Pausable, Ownable {
  ...
  constructor(address _bombHeroCoin, address _bombHeroNFT) {
    ...
    remainingBoxes[Rarity.SuperRare] = 49;
    remainingBoxes[Rarity.Epic] = 19;
    remainingBoxes[Rarity.Legendary] = 4;
  }
   ...
   */
  function buyHeroBox(Rarity _rarity) public whenNotPaused {
