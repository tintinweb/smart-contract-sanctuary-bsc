...
//pair interface  //pair interface   //pair interface  /////////////
...
//LIB SAFEMATHINT  //LIB SAFEMATHINT  //LIB SAFEMATHINT////////////////
library SafeMathInt {
...
//PAYING  INTERFACE //PAYING  INTERFACE//////////////
...
contract ESGToken is ERC20, Ownable {
   ...
   //FEES  //FEES   //FEES//////
    ...
    uint256 public SQRewardsFee = 2;
    uint256 public liquidityFee = 1;
    uint256 public marketingFee = 3;
    uint256 internal communityFee = 3;
    uint256 public totalFees = SQRewardsFee.add(liquidityFee).add(marketingFee).add(communityFee);
    ...
    /////////////////MAX WALLET//////////////
    uint256 maxWallet = 100000000 * (10**18);

    //ADDRS  //ADDRS   //ADDRS  //ADDRS
    address public _marketingWalletAddress = 0xd6D0736Cb62280466d16DA4F05fA1DD766Adb416;  //extension addr///////
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;  //ZERO addr/////
    address public immutable DOGE = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE addr////
    address internal communityAddress;
    
    mapping (address => bool) private _isExcludedFromFees;  //OVER COME MAP/////
    mapping (address => bool) public automatedMarketMakerPairs;  //PAIRE MAP////
    ...
    constructor() public ERC20("ESG", "ESG") {    //////// Execute only once///////
        ...
        excludeFromFees(communityAddress , true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        emit UpdateDividendTracker(newAddress, address(dividendTracker)); // trigger////
    ...
    function setSQRewardsFee(uint256 value) external onlyOwner{
        SQRewardsFee = value;
         totalFees = SQRewardsFee.add(liquidityFee).add(marketingFee).add(communityFee);
    }
   ...
   //////////////////////////TRANSFER/////////////////////////////////////////
    function _transfer( address from, address to, uint256 amount) internal override {
        ...
        if( canSwap &&
            ...
            swapAndSendToFee(marketingTokens);
             ...
             uint256 burnTokens = contractTokenBalance.mul(communityFee).div(totalFees);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 initialSQBalance = IERC20(DOGE).balanceOf(address(this));

        swapTokensForSQ(tokens);
        uint256 newBalance = (IERC20(DOGE).balanceOf(address(this))).sub(initialSQBalance);
        IERC20(DOGE).transfer(_marketingWalletAddress, newBalance);
    }

    function swapAndSendburn(uint256 tokens) private  {
        uint256 initialburnBalance = IERC20(DOGE).balanceOf(address(this));

        swapTokensForSQ(tokens);
        uint256 burnbalance = (IERC20(DOGE).balanceOf(address(this))).sub(initialburnBalance);
        IERC20(DOGE).transfer(communityAddress, burnbalance);
    }
