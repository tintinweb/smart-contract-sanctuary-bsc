...
TG: https://t.me/babyyspacesnake
TAX: 10%, 1LP 3REWARDS 6MARKETING
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9B88493902F76a492d4cf616b3A56145b16cBC7a; // owner address
...
contract BabySpacesnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babyy SpaceSnake";
    string private _symbol = "Bby";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFD421b74A8F57aFB1B0D8375A906e9cec605dCfE); // Marketing Address
    address payable public teamWalletAddress = payable(0xFD421b74A8F57aFB1B0D8375A906e9cec605dCfE); // Team Address
