...
//telegram:https://t.me/Drunkenshiba
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x865dE456CbE3A506a4C2fcc1785045830f8eF7C6;
...
contract Drunkenshiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "DRUNKEN SHIBA"; // 
    string private constant _symbol = "DSHIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0x865dE456CbE3A506a4C2fcc1785045830f8eF7C6);
