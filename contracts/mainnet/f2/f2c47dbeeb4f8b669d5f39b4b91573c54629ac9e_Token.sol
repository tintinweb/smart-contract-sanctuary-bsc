...
// BLUE MOON is the new Future of BlockChain Technology.
// Born to be trusted within the community, max capped at 10M, Blue Moon is a Community driven Society Project.
// The aim is to maximize and protect each Investor gains by bringing the project to the dream: the Blue Moon! 
// You definitely want to be part of it! The future is here.
...
contract Token is ERC20 {
    ...
    constructor () public ERC20("Blue Moon", "BLUEMOON") {
