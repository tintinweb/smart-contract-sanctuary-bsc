...
contract DbbDogeToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        address dividendTracker_, // dividendTracker
        uint256 minimumTokenBalanceForDividends_
    ) payable ERC20("Distribute Bonus Doge", "DbbDoge") {
        
        uint256 totalSupply_ = 100000000000 * 10**18;
        rewardToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        _marketingWalletAddress = 0x57c7A3D1B145FcFc6b439B8Ce967482DA1796B1b;
        require(
        ...
        burnFee = 2;
        marketingFee = 2;
        totalFees = tokenRewardsFee.add(burnFee).add(marketingFee);
