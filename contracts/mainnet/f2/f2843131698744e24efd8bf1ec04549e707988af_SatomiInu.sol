...
contract SatomiInu is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 90;
    uint256 public marketingFeeOnSell = 90;

    address public marketingWallet = 0x881c583E446c6BdA69Ee3FFEeb945dB5fE2b1919;
    ...
    constructor () ERC20("Satomi Inu", "SINU") 
    {   
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 91, "Marketing fee on buy cannot be more than 91%");
        require(_marketingFeeOnSell <= 91, "Marketing fee on sell cannot be more than 91%");
