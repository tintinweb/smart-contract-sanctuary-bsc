...
contract ShibaBaguette is IERC20Metadata, Ownable {
    ...
    address public marketingWallet = 0x654f44dd25B4D54d7999E7819294ED88aCC98DC6;
    address private devWallet = 0x4931DE010deB6cdcD8426B5494d2FcF57B241b30;
    address public teamWallet = 0x32091bd571dfe6cD16F079db56C25D3425eA1A24;
    
    string constant _name = "SHIBABAGUETTE";
    string constant _symbol = "SHIBABAGUETTE";
    uint8 constant _decimals = 18;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 internal constant _totalSupply = 100000000000 * (10**18);
    ...
    uint256 private devFee = 50; // 5%
    uint256 public teamFee = 1; // 1.5%
    uint256 public lpFee = 10; // 1%
    uint256 public totalFee = rfiFee.add(marketingFee).add(devFee).add(teamFee).add(lpFee);
    
    // Total = 100% (1000)
    uint256 public marketingPortionOfSwap = 200; // 20%
    uint256 private devPortionOfSwap = 400; // 40%
    uint256 public teamPortionOfSwap = 200; // 20%
