...
contract RatBeast is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RatBeast Token";
    string private _symbol = "RatBeast";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A8E192F310DA6714a23bAac9a8b284c2A5e813a);
    address payable public BuyBackWalletAddress = payable(0x1A8E192F310DA6714a23bAac9a8b284c2A5e813a);
