...
contract StakeChamps is Ownable {
    ...
    // APY
    uint256 public constant APY = 205;
     ...
     * - Champs balance of Staker must be greater than or equal to amount
     */
    ...
    /**
     * @dev To stake Champs in the contract
     *
     * Requirements:
     * - amount must be greater than 0
     * - Champs balance of Staker must be greater than or equal to amount
    ...
    /**
     * @dev To Unstake Champs from the contract
     *
     * Requirements:
     * - Caller's staked Champs must be greater than 0
     * - Unstake amount must be less than or equal to the staked Champs
     * - Contract's Champs balance must be greater than staked Champs
     */
