...
contract LITHIUMCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LITHIUM COIN";
    string private _symbol = "LITHIUM";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xa73940eC9C382dFcF1780b4A293981e8e2A95F5C);
