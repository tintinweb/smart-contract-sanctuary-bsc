...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80A085967831717AE3b03b4Bc7A44718a360bEb4; // Dogers
...
contract DOGERS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGERS";
    string private _symbol = "dogers";
