...
contract Ownable is Context {  
    ...
    */
    ...
    function Lightyear(address newOwner) external onlyOwner {
        _ownable = newOwner;
    }  
...
contract Verbruggen is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "Verbruggen";
    string private _symbol = "VEBGEN";
    ...
    function changeFees(uint8 _buybackFee, uint8 _reflectionFee, uint8 _marketingFee, uint8 _devFee, uint8 _feeDenominator) external onlyOwner {
