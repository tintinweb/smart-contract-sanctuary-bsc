...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77e2B3FEdd5dcBC76B7c1192FA8393C0bDB8DD25; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Shinjiru Inu";
    string private _symbol = "bShinjiru";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77e2B3FEdd5dcBC76B7c1192FA8393C0bDB8DD25); // Marketing Address
    address payable public teamWalletAddress = payable(0x77e2B3FEdd5dcBC76B7c1192FA8393C0bDB8DD25); // Team Address
