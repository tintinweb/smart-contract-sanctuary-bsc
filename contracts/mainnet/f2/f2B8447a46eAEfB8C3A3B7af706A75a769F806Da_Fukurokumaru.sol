...
contract Fukurokumaru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fukurokumaru";
    string private _symbol = "FKRKMR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4447c052a94135519E5847F3C65135858790A2f); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD4447c052a94135519E5847F3C65135858790A2f); // Team Address
