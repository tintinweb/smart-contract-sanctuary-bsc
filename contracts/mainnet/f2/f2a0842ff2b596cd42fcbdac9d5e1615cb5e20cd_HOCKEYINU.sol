...
/**
Telegram : https://t.me/hockeyinubsc
...
contract HOCKEYINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOCKEYINU";
    string private constant _symbol = "HOCKEY";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 300000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1250000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0x0D9Bbe8AA03406A3f97C047213958f7a7407f1e3);
    ...
    function ICES() public onlyOwner {
