...
contract Rule is Context, Ownable {
    ...
    address[] public _pooladdr=[
        0xE9ad064CE8B31D35f57f806008c23C2623b71201,
        0xF7DEa556bdd968257F675A6CE2ea52c75c18Ff34,
        0x09AA4d1c1Cc02c0871450c9f2B6f67cf6682a433,
        0xC30B4549CEF7d1D7586e7285a482e8E2e58ccc8C,
        0x0Ee9e4Abc08FEAd3d7418981180A41803d9A2290
    ];
    uint256[] public _prate=[10,40,10,10,10];
    constructor () public {
  ...
  function buy( address u, uint256 a) private returns(uint256 sy) {
        ...
        for (uint256 i = 0; i < 5; i++) {
            sy-=addBalanceWithLog(u,_pooladdr[i],a*_prate[i]/1000);
        }
