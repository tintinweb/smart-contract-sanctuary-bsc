...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x17E65E6b9B166Fb8e7c59432F0db126711246BC0);
...
contract TifiInu is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x17E65E6b9B166Fb8e7c59432F0db126711246BC0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Tifi Inu";
    string constant _symbol = "TIFIINU";
