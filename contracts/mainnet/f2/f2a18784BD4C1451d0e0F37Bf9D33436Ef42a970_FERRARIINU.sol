...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f6b9e5D84c5c0e9BF815C17ad8C5bafD4753b63; 
...
contract FERRARIINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2f6b9e5D84c5c0e9BF815C17ad8C5bafD4753b63); // 
    address payable public teamWalletAddress = payable(0x2f6b9e5D84c5c0e9BF815C17ad8C5bafD4753b63); // 
    ...
    uint256 public _totalTaxIfBuying = 20; //normal low tax
    uint256 public _totalTaxIfSelling = 20; //normal low tax
    uint256 public _totalDistributionShares = 55;  
    uint256 private _totalSupply = 1929 * 10**_decimals;
    uint256 public _maxTxAmount = 39 * 10**_decimals; 
    uint256 public _walletMax = 39 * 10**_decimals;
