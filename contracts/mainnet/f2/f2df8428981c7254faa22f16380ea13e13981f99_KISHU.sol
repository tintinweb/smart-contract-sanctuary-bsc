...
/* charity Begins */
 ...
 function charity(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to charity");
