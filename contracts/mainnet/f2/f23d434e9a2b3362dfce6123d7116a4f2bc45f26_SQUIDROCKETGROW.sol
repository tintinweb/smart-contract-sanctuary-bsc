...
/**
 *Telegram: https://t.me/SquidRocketGrow 
 *Fair launch
 *Initial liquidity=1BNB
 *Buyback and burn=0.50BNB+3% buy/sell tax
 *Buy/Sell 6% (3% Liquidity 3% Buyback and burn)
 *LP locked
 *Ownership Renounced
 *Max wallet=5%
*/
...
contract SQUIDROCKETGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Rocket Grow";
    ...
    address payable public teamWalletAddress = payable(0xBD823873901E43F0d54e4F4b87DdECd199487883); 
