...
contract NUCTOKEN{
    ...
    uint256 private _totalSupply = 1000000000000000000000000000; // 18 decimals
    string private _name = "NUCTOKEN";
    string private _symbol = "NUCT";
    ...
    uint256 private _referEth =     3500; //35%
