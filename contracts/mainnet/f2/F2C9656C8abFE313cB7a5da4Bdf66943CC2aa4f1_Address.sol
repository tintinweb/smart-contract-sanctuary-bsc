...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe2f6250E95a5C4a5B6e740EBf3b351DAF17FD418;
...
contract FRPX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0A985079EA55BF19fd2C599Bb3b81DADd0C6C5c1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Fuck Rug Pullers";
    string private _symbol = "FRUGS";
