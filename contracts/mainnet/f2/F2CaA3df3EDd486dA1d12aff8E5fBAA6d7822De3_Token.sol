...
contract Ownable is Context {
    address private _owner =  0xDE4dAD463962b9eF75b4eE090b184C2F137Dd57f; 
...
contract Token is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0xc80F8fCfE09Ec65DF6fc1d2300c626314D6D8E91); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "d(he)ll"; 
    string private _symbol = "d(he)ll";
    uint8 private _decimals = 9; 

    uint256 private _tTotal = 1000 * 10**5 * 10**_decimals;
    ...
    uint256 public _marketingBNBFee =70; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 3 * 10**5 * 10**_decimals; 
