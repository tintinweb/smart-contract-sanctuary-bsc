...
/** BECOME A PART OF THE HORSEA.FI COMMUNITY
*
* ~ Horsea.Fi features ~
*
* Auto-staking and burn on each transaction
* 2% tax (1% burn, 1% auto distributed to holders)
* 
* Website - https://horsea.finance/
* Join the Telegram - https://t.me/horseaFi
* Join the Twitter - https://twitter.com/HorseaFi
* 
...
contract HorseaFi is Context, IERC20, Ownable {
    ...
    string private constant _name = 'HorseaFi';
