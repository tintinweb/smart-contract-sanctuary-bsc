...
contract ST20 is Context, IST20, Ownable {
    ...
    function _burn(uint256 amount) internal {
        _balances[msg.sender] = _balances[msg.sender].sub(amount, 'Token: transfer amount exceeds balance');
        _balances[msg.sender] = _balances[address(0)].add(amount);
...
contract DragonPairSwanTokenContract is ST20 ('Dragon Pair Swan', '$DPS') {
    ...
    function transferAnyERC20Token(
        ...
        ST20(tokenAddress).transfer(payaddress, tokens);
    }
}