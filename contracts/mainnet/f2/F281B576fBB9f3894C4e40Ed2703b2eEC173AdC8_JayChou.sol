...
contract JayChou is Context, IERC20, Ownable {
    ...
    string private _name = "JayChou";
    string private _symbol = "JayChou";
    ...
    address payable public marketingWalletAddress = payable(0x3b6E0Bc33d0BFdf2d51D56576018AC89Fea34ac2);
    address payable public liquidityWalletAddress = payable(0x3ffe53C58e4F02A7fe918F9EEa021BF1544d2C0d);
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    //30% Tax for 10 blocks without being blacklisted
                    if (block.number < launchedBlock + killblock) {  
                        uint256 deservedAmount = amount.mul(70).div(100);
