...
contract SuperSaiya is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperSaiya2";
    string private _symbol = "Saiya2";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x999985a2Fc1E7d6218C877288b3282FFb2059999); // Marketing Address
    address payable public teamWalletAddress = payable(0x999985a2Fc1E7d6218C877288b3282FFb2059999); // Team Address
