...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x945EC1272055282874e22A4C43Edb6E98b88E1aE; // owner address
...
contract BIRDTRUMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bird Trump";
    string private _symbol = "bTrump";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x945EC1272055282874e22A4C43Edb6E98b88E1aE); // Marketing Address
    address payable public teamWalletAddress = payable(0x945EC1272055282874e22A4C43Edb6E98b88E1aE); // Team Address
