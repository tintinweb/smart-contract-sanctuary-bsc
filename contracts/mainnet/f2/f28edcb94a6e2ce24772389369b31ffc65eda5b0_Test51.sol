...
contract Test51 is ERC20Detailed, Ownable {
    ...
    string public _name = "TestSubject";
    string public _symbol = "T51";
    ...
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(burnFee);
    ...
    constructor() ERC20Detailed("Test subject", "51", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = payable(msg.sender);
        treasuryReceiver = 0xbb3D487015Ab555f59a90E9DE051b8818dae9Fcc;
        competitionReceiver = 0x8D764a95a687EdB799f1B09b8155F9c9378Ac05D;
        ...
        _maxTxAmountBuy = _totalSupply / 1000;
        _maxTxAmountSell = _totalSupply / 1000;
        _maxWalletAmount = _totalSupply / 500;
    ...
    function setFees(               // New code
        ...
        totalFee = liquidityFee.add(treasuryFee).add(burnFee);
 ...
 function setMaxTransactionAmount(
        ...
        _maxTxAmountBuy = _totalSupply / _maxTxAmountBuyPct; // 100 = 1%, 50 = 2% etc. The number you input in BSCScan is the divider
        _maxTxAmountSell = _totalSupply / _maxTxAmountSellPct; // 100 = 1%, 50 = 2% etc. so 50 = 2%, 20 = 5%
    }
    
    function setMaxWalletAmount(uint256 _maxWalletAmountPct) external onlyOwner {
        _maxWalletAmount = _totalSupply / _maxWalletAmountPct; // 100 = 1%, 50 = 2% etc.
    ...
    function rebase() internal {
        ...
        uint rebaseRate = 85 * 10**18;
        uint minuteRebaseRate = 1700 * 10**18;
        uint hourRebaseRate = 102000 * 10**18;
        uint dayRebaseRate = 18880000 * 10**18;
            //orig values deno **7 rRate 858, mrRRate 17100, hrRate 1000000, dRrate 188800000
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(competitionFee);
