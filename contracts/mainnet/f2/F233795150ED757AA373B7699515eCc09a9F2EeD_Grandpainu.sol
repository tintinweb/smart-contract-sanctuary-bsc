...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCdA85a6fF394EB47799A79889C5f1478E303EC12;
...
contract Grandpainu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcD87Ec82700dC0cfDab58FFc99C342ec478E5381;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Granpainu";
    string private _symbol = "GPU";
