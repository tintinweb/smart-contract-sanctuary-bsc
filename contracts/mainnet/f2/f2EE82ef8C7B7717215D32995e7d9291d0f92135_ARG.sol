...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x1da3F3383340D801c4abd7b13d84d9292Ba9B93C;
...
contract ARG is AbsToken {
    constructor() AbsToken(
        ...
        address(0x03fA0A164A936853B44A3C3A8DCDcE463ab87120),
    
        address(0x50AbcE51DCbbe3BeBBb50146073D7566024622DC)
    ){
