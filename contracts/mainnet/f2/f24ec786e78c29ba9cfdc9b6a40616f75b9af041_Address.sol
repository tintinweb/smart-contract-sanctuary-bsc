...
contract DOGEBEERINU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xf09F77025848d8C1e6590cc1FE65cD619316074a);
    ...
    */
    ...
    string private _name = "DOGE BEER INU"; 
    string private _symbol = "BEERINU";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/100000000000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/100000000000;
    }
