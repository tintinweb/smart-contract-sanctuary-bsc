...
// SPDX-License-Identifier: Unlicensed https://t.me/crogecoin https://twitter.com/Croge_CRO
...
contract  SonOfCroge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son Of Croge";
    string private _symbol = "SOC";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x6233022F0be346Cff0c0b0fA412cCBBb142E97B3);
