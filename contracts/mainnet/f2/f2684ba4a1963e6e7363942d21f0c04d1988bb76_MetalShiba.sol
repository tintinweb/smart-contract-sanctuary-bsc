...
Welcome to t.me/babymetalshiba
MetalShiba Rewards
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0x5A88DE4d715a0655b3f662e86D0c18eba81faa3e); // () Rewards
...
contract MetalShiba is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x5A88DE4d715a0655b3f662e86D0c18eba81faa3e; // () REWARDS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Metal Shiba";
    string constant _symbol = "BMETAL";
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x41564A5A293aB3236D4FfC59F6fa52f21A215548;
        ...
        marketingFeeReceiver = 0x41564A5A293aB3236D4FfC59F6fa52f21A215548;
        teamFeeReceiver = 0x41564A5A293aB3236D4FfC59F6fa52f21A215548;
        giveawayFeeReceiver = 0x41564A5A293aB3236D4FfC59F6fa52f21A215548;
