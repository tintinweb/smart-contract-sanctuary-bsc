...
/**
Telegram : https://t.me/silvermoon_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaF7619bdE9083189e7C71500ad0Ad4E30223A984; // owner address
...
contract Silvermoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Silver Moon";
    string private _symbol = "SMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc998A9EEF36D228992b3c3242c869807e4212Fc2); // Marketing Address
    address payable public teamWalletAddress = payable(0xc998A9EEF36D228992b3c3242c869807e4212Fc2); // Team Address
