...
contract ElonSafeLuna is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_tTotal * 2) / 100; // % of total supply
    ...
    string private constant _name = "ELON SAFE LUNA"; // 
    string private constant _symbol = "ESL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public eventTime = 0;

    uint256 public _marketingFee = 8; //% tax fee
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA017226a90691a7114E1a2aF3566d7e53c5AfAC7;
