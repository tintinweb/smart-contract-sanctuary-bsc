...
contract SuperMoonAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUPER MOON AI";
    string private constant _symbol = "AIBEP20";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 60000 * 10**_decimals;
    uint256 public _maxTxAmount = 1800 * 10**_decimals;
    uint256 public _maxWalletAmount = 1800 * 10**_decimals;
