...
LOOP APE
OWNERSHIP RENOUNCED AND LOW TAX
https://t.me/loopape
...
contract LoopApe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xacFe7a283eCA269DCABCBf6457E89Ce4518Ac8fe); 
    address payable public Wallet_Dev = payable(0xacFe7a283eCA269DCABCBf6457E89Ce4518Ac8fe);
    ...
    string private constant _name = "LOOP APE"; 
    string private constant _symbol = unicode"LOOP APE"; 
    ...
    constructor () {
        ...
        _owner = 0xacFe7a283eCA269DCABCBf6457E89Ce4518Ac8fe;
