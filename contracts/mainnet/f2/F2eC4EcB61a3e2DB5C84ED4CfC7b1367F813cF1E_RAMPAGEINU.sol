...
contract RAMPAGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "RAMPAGEINU";

    string private _symbol = "RINU";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0x580A3D814960265B216EDE24365b653987038997;
