...
// https://t.me/safuustclassicgroups
// https://t.me/safuustclassic
...
contract SafuUstClassic is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Safu Ust Classic";
    string private constant _symbol = unicode"sfUST";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0x831078BF8447d8f386A435EFA156AA0CBaD745c3);
    address payable private MarketingWallet = payable(0x831078BF8447d8f386A435EFA156AA0CBaD745c3);
