...
//Telegram : https://t.me/ENJINUOfficial
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        require(address(this).balance >= amount, "Enjoy Hare Inu Address: insufficient balance");
        (bool success,) = recipient.call{value : amount}("");
        require(success, "Enjoy Hare Inu Address: unable to send value, recipient may have reverted");
    }

    function functionCall(address target, bytes memory data) internal returns (bytes memory) {
        return functionCall(target, data, "Enjoy Hare Inu Address: low-level call failed");
    }
    ...
    function functionCallWithValue(address target, bytes memory data, uint256 value) internal returns (bytes memory) {
        return functionCallWithValue(target, data, value, "Enjoy Hare Inu Address: low-level call with value failed");
    }

    function functionCallWithValue(address target, bytes memory data, uint256 value, string memory errorMessage) internal returns (bytes memory) {
        require(address(this).balance >= value, "Enjoy Hare Inu Address: insufficient balance for call");
        require(isContract(target), "Enjoy Hare Inu Address: call to non-contract");
        (bool success, bytes memory returndata) = target.call{value : value}(data);
        return _verifyCallResult(success, returndata, errorMessage);
    }

    function functionStaticCall(address target, bytes memory data) internal view returns (bytes memory) {
        return functionStaticCall(target, data, "Enjoy Hare Inu Address: low-level static call failed");
    }

    function functionStaticCall(address target, bytes memory data, string memory errorMessage) internal view returns (bytes memory) {
        require(isContract(target), "Enjoy Hare Inu Address: static call to non-contract");
    ...
    function functionDelegateCall(address target, bytes memory data) internal returns (bytes memory) {
        return functionDelegateCall(target, data, "Enjoy Hare Inu Address: low-level delegate call failed");
    }

    function functionDelegateCall(address target, bytes memory data, string memory errorMessage) internal returns (bytes memory) {
        require(isContract(target), "Enjoy Hare Inu Address: delegate call to non-contract");
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf64f9cB22Fa2D2D122be1D013AA2A13e15199E50;
...
contract ENJINU is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xf64f9cB22Fa2D2D122be1D013AA2A13e15199E50);
    ...
    */
    ...
    string private _name = "Enjoy Hare Inu";
    string private _symbol = "ENJINU";
