...
contract LooBrGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "LooBr Grow";
    string private constant _symbol = "LBGROW";
