...
contract JX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xdf6A50402F301a17e33e705A30230729B17e5286); // Marketing Address
    address payable public teamWalletAddress = payable(0xb1A6C3EE88DD6220a928B014962c87cED9A54784); // Team Address
    ...
    uint256 public _walletMax = 6666 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6666 * 10**12; 
