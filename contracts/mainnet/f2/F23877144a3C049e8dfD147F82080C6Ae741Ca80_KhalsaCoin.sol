...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4928dA86725a71C5a4A7fe9a0f86E0676B8F990A;
...
contract KhalsaCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x21F5ED4E93cB5ce233c80F238eF3eB61d061e794;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Khalsa Coin";
    string private _symbol = "SIKH";
