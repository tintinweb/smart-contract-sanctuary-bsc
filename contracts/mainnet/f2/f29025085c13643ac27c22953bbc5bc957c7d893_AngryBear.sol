...
contract AngryBear is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angry Bear";
    string private _symbol = "ANGRYBEAR";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xf584Cd372723660A7783D6a77b0C522fbdd6C672);
