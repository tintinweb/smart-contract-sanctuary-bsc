...
/**
 Telegram : https://t.me/Angel_505_Official
*/
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 is returned        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
...
contract ANGEL505 is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x0A692cd803F5c8149C6564848479D5eEbea39C32;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Angel 505";
    string private _symbol = "505";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 505 * 1e18;
    ...
    constructor () {
        address tokenOwner = 0x37E015eC715b33Ff432a8AFf533De2aEBaE3D2b5;
