...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 310000000 * 10**6 * 10**7;
    ...
    uint256 public _maxTxAmount = 10000000 * 10**6 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**6 * 10**7;
