...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF750f692FB7369816b81e73F5330a9A5fA0A35b6;
...
contract newcommunitygala is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY GALA";
    string private _symbol = "NCGL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF750f692FB7369816b81e73F5330a9A5fA0A35b6); 
    address payable public teamWalletAddress = payable(0x45ac32f20215Ab39cf6f486Fb64c90Bc0641bB94); 
