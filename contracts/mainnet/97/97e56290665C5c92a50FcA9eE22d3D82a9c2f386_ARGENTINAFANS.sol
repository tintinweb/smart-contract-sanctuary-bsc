...
/* 
AFF BURNED LP
telegram : https://t.me/argentinafanscommunity
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbCa4E2bcD84406E5a9DcA54cd1a26c9917C91a18; // whatDOGE
...
contract ARGENTINAFANS is Context, IERC20, Ownable {
    ...
    string private _name = "Argentina Fans";
    string private _symbol = "AFA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbCa4E2bcD84406E5a9DcA54cd1a26c9917C91a18); // Marketing Address
    address payable public teamWalletAddress = payable(0xbCa4E2bcD84406E5a9DcA54cd1a26c9917C91a18); // Team Address
