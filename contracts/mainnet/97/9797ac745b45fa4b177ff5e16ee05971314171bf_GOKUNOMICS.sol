...
contract GOKUNOMICS is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GOKUNOMICS";
    string constant _symbol = "GOKUNOMICS";
    ...
    address public marketingFeeReceiver = 0x86bDa757e02Ae7A2D6163D4B86631F405187c0d6;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x86bDa757e02Ae7A2D6163D4B86631F405187c0d6] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x86bDa757e02Ae7A2D6163D4B86631F405187c0d6] = true;
