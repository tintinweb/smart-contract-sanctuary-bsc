...
// 
//
// 📱 Telegram:https::https://t.me/+rAL17L1056BhNjk1
/*
...
contract GrimaceNewYear is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("GrimaceNew Year", "GrimaceNewYear") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "GrimaceNewYear";
    string private _symbol = "GrimaceNewYear";
