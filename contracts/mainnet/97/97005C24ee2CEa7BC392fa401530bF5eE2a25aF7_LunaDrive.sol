...
contract LunaDrive is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LunaDrive";
    string constant _symbol = "LDRIVE";
    ...
    address public Owner=0xf3B727cc9dAC95a74f6d7c18826E1e868365c385; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xf3B727cc9dAC95a74f6d7c18826E1e868365c385;
