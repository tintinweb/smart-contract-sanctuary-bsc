...
contract  BnbGo is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**16;
    uint256 public _maxTxAmount = 1000000 * 10**16; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**16; //
    string private constant _name = unicode"BNBGo"; // 
    string private constant _symbol = unicode"BNBG"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x739EECF83Fc39aACA61C616eA14cC53f0212af4f;
