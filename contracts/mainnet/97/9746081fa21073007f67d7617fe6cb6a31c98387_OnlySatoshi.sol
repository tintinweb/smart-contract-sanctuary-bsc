...
// Telegram: https://t.me/onlysatoshibsc
...
contract OnlySatoshi is IBEP20, Auth {
    ...
    string constant _name = "Only Satoshi";
    string constant _symbol = unicode"ONLYSATOSHI";
    ...
    // Exclude bots
    function AddBlacklist(address _address, bool _value) public onlyOwner{
