...
//Twitter : https://twitter.com/SquidBoy1000X
//Website : https://squidboy.finance
...
contract SquidBoy is IBEP20, Auth {
    ...
    string constant _name = "Squid Boy";
    ...
    uint256 public totalFee        = developmentFee + marketingFee + liquidityFee + buybackFee + stakingFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0xAa02Cd8237d594df9727D1D3C513991D9050057F; 
        ...
        marketingFeeReceiver = 0xAa02Cd8237d594df9727D1D3C513991D9050057F;
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
        marketingFee = _marketingFee;
        buybackFee = _buybackFee;
        stakingFee = _stakingFee;
        totalFee = _liquidityFee.add(_developmentFee).add(_marketingFee).add(_buybackFee).add(_stakingFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Buy Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _stakingFeeReceiver, address _developmentFeeReceiver) external authorized {
