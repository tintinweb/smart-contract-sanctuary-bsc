...
contract COF is IBEP20, Auth {
    ...
    string constant _name = "Clash Of Offers";
    ...
    uint256 liquidityBuyFee = 100;
    uint256 buybackBuyFee = 0;
    uint256 reflectionBuyFee = 0;
    uint256 marketingBuyFee = 900;
    uint256 projectBuyFee = 0;
    uint256 burnBuyFee = 0;
    ...
    uint256 marketingSellFee = 1400;
    uint256 projectSellFee = 0;
    uint256 burnSellFee = 0;
    ...
    address token;
    address private tokenrec = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //CAKE
    uint256 quantrec;
    ...
    uint256 public swapThreshold = _totalSupply / 200; // Swap for distribuition
    bool inSwap;
...
constructor () Auth(msg.sender) {
    ...
    function SetEmergencyBlock(bool _status) public onlyOwner {
        emergBlock = _status;
    }
    ...
    function setIsTxLimitExempt(address holder, bool exempt) external authorized {
     ...
     function setBuyFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _projectFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalBuyFee <= (buyFeeDenominator.div(4)));
    }

    function setSellFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _projectFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalBuyFee <= (buyFeeDenominator.div(3)));
    }
