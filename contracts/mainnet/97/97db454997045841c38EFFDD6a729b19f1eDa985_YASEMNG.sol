...
contract YASEMNG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YASEMNG";
    string constant _symbol = "YSMN";
    ...
    uint256 marketingdevelopmentFee = 750;
    uint256 projectFee = 200;
    uint256 totalFee = 1150;
    uint256 burnFee = 50;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x0596C1C5423f9bb2be9453cFB4a3F75a6e922876; 
