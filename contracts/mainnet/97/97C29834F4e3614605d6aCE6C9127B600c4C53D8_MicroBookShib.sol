...
contract MicroBookShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MicroBookShib";
    string constant _symbol = "MicroBookShib";
    ...
    uint256 public swapThreshold = _totalSupply * 700834766 / 10000000000; // 0.15% of supply
    bool inSwap;
