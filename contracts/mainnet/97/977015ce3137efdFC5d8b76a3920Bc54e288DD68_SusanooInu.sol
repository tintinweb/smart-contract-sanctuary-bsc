...
Inu is still a legend until now. If you missed Zoro Inu, Shinrai Inu,
Onigami Inu,... don't worry, come and join with us - Susanoo Inu.
We have a big marketing plan line up and see who will come. I believed
that you will be surprised for that lol :) Let's be a smart investor
with us and yahh, chill for this moment.

📍 Website: https://www.susanooinu.pro/
📍 Telegram: https://t.me/SusanooInu
📍 Twitter: https://twitter.com/susanooinu
...
/* Token contract */
contract  SusanooInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xd39427CE2141939769BCCBAa1DAF9Ba6Fc4aCCa3;
    ...
    // Name and symbol
    string constant _name = "Susanoo Inu";
    string constant _symbol = "SINU";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 500000000000 * (10 ** _decimals); // 100 Million
    ...
    uint256 private marketingFeeBuy = 7;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd39427CE2141939769BCCBAa1DAF9Ba6Fc4aCCa3;
