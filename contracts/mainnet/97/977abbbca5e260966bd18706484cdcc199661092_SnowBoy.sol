...
contract SnowBoy is Context, IERC20 { 
    ...
    string private _name = "Snow Boy";
    string private _symbol = unicode"SNOWBOY";
    ...
    uint256 public _maxWalletToken = _tTotal * 1 / 300;

    uint256 public _swapTrigger = 5;
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 222;

    address payable public DevWallet = payable(0xA40f0d19e1D60A09Bed6b9EC80693eC1fbDF6DBf);
    address payable public MarketingWallet = payable(0xA40f0d19e1D60A09Bed6b9EC80693eC1fbDF6DBf);
    ...
    function TokenInfo(bool true_or_false) external onlyOwner {
