...
/*
🐲WELCOME TO 🐲Tatsu🐲 BSC🐲 THE PYRO DRAGON🐲

🐲WHY CHOOSE TATSUO
$TATSUO is a decentralized token built on the ethereum network with a strong and solid community

🐲TOKENOMICS
There is a 5% tax on every Buy/Sell Transaction
🐲3% Reflection Rewards
🐲2% BUYBACK Burn
🐲$TATSUO Slippage: Set slippage at 3-5% (so no MEV bots can sandwich you).

🐲https://t.me/TatsuoToken
🐲website : https://tatsueth.com/
...
contract TatsuoToken  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Tatsu';
    string private _symbol = 'Tatsuo';
