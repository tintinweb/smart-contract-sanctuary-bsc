...
contract PennyMoon is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    uint256 public constant SHAREDIVISOR = 70;

    //Known Wallets
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;

    //trading parameters
    uint256 public liquidity = 379000 * 10**_srgDecimals;
    ...
    //migration wallet
    address constant public MIGRATION_WALLET = 0x694981b6F83fea88C2Bbd1b7BAEEd9FA2330e5b4;

    // initialize supply
    constructor() {
        _balances[address(this)] = _totalSupply - 875301129496366*10**6;
        _balances[MIGRATION_WALLET] = 875301129496366*10**6;
        ...
        emit Transfer(address(0), MIGRATION_WALLET, 875301129496366*10**6);
    }
