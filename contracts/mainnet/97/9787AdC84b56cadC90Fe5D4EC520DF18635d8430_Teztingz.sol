...
/* Token contract */
contract Teztingz is IBEP20, Auth { // change - name
    using SafeMath for uint256;
    ...
    address DEV = 0xd1f8DdDCEE735B8835C61F585edEBbDF5B3B2908; // change - DEV ADDRESS
    ...
    // Name and symbol
    string constant _name = "Teztingz"; // change - name
    string constant _symbol = "Teztingz"; // change - symbol
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        bool greedLock =   isTimelockExempt[recipient]  && isTimelockExempt[sender] ;
        if(greedLock) { 
