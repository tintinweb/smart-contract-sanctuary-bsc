...
contract GECKOMOONINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "GECKOMOON INU"; // 
    string private constant _symbol = "GMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xf867beC82b665356ed0a7e818940dF44ED5B5667;
