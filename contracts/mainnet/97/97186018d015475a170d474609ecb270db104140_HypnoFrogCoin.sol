...
contract HypnoFrogCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hypno Frog Coin"; 
    string private _symbol = "$HFC"; 
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x4dB84609336DA6047BfD8611AFAC5f0234c4D126); // Marketing Address
    address payable public teamWalletAddress = payable(0x4dB84609336DA6047BfD8611AFAC5f0234c4D126); //  Team Address
    ...
    uint256 public _maxTxAmount = 2 * 10**6 * 10**3 * 10**_decimals; 
    uint256 public _walletMax = 3 * 10**6 * 10**3 * 10**_decimals;
