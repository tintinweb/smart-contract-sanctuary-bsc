...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C5Acd09a694dbfee52D844c3C9De6bcd1c4AF16; // owner address
...
contract CHINOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CHINOGE";
    string private _symbol = "$CHINOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5C5Acd09a694dbfee52D844c3C9De6bcd1c4AF16); // Marketing Address
    address payable public teamWalletAddress = payable(0x5C5Acd09a694dbfee52D844c3C9De6bcd1c4AF16); // Team Address
