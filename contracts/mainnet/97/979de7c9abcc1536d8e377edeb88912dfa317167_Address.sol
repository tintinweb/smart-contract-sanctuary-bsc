...
contract Dogeyecoin is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "dog Eye Coin";
    string private _symbol = "DEC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC83a2889b467b502535a997559d573e9a147Fc95); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xC83a2889b467b502535a997559d573e9a147Fc95); // BuyBack Address
