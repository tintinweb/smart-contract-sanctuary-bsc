...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (2 ** 12);
...
/* Token contract */
contract BunnyEscape is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Bunny Escape";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x52B54865Cc4085dADCDbCE39759C1ea521E99523;
