...
/**
Telegram https://t.me/babykochiofc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x903d63A6e8C0B10bF119bfecC363C043aFe578b2;
...
contract BabyKochiKen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Kochi Ken";
    string private _symbol = "BKOCHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x903d63A6e8C0B10bF119bfecC363C043aFe578b2);
    address payable public teamWalletAddress = payable(0x903d63A6e8C0B10bF119bfecC363C043aFe578b2);
