...
contract GasLight is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8E44d450DC93B2ad2276DeD456cBb0B8ffc7C70d); // Marketing Address
    ...
    uint256 private buyBackUpperLimit = 3000000 * 10**9;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(3000000 * 10**9)) {
