...
/**
    ...
    We are a token created specifically for the community with low taxes, do sell or buy without having to worry about taxes
    Brick on Mario is the best solution at this time
...
contract Brick_On_Mario is IERC20, Ownable {
