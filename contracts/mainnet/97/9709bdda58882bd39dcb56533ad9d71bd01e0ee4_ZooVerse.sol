...
contract ZooVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZooVerse";
    string private _symbol = "$ZooV";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xDBC5BE54BF476E2E599A40897Ee466CF45A3A518); // Marketing Address
    address payable public teamWalletAddress = payable(0xDBC5BE54BF476E2E599A40897Ee466CF45A3A518); // Team Address
