...
// CHANGE
contract FuckLuna is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Fuck Luna";
    string constant _symbol = "FLuna";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x549b3F6b29B2a761983ff03b5c7535B1C9EfDCEe);
