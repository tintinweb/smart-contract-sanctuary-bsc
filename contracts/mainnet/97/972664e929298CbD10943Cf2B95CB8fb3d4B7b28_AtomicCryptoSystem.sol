...
/*
Telegram / https://t.me/AtomicPortal
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract AtomicCryptoSystem is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Atomic Crypto System";
    string private _symbol = "ATOMIC";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0x7624EBDABF3c91D0495a4CEe67F7e88d4ba5AE4b);
    address payable public devWalletAddress = payable(0x48A45477a47c62efe420D4e0af0F0CCeFCD72B8C);
