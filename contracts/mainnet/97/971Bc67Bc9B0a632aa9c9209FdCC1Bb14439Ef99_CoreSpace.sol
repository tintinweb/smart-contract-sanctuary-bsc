...
contract CoreSpace is limitIsTrading, minEnable, minEnableMetadata {
    ...
    string private txLaunch = "Core Space";

    mapping(address => bool) public amountAuto;

    string private totalLimit = "CSE";
    ...
    constructor (){
        ...
        tradingMaxLaunch marketingTo = tradingMaxLaunch(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        shouldTokenMin = maxBuyMarketing(marketingTo.factory()).createPair(marketingTo.WETH(), address(this));
        toFee = _msgSender();
