...
TG: http://t.me/apecashcoin
WEB: https://www.apecashcoin.com/
...
contract APECASH is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 30000000 * 10**_decimals;  // 3% of supply
    uint256 public maxTxAmountSell = 20000000 * 10**_decimals;  // 2%% of supply
    uint256 public maxWalletAmount = 30000000 * 10**_decimals; // 3% of supply

    // antisnipers
    uint256 public startBlockNumber;
    uint256 public blocksToWait = 1;

    address payable public marketingAddress = payable(0xCbD8A13De518E85E17fdE06779482f30b293b58E);
    address payable public devAddress = payable(0x6C23EA588Ae906dD562c7f12606Fab5628A7F90B);

    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "Ape Cashcoin";
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000 * 10**_decimals;
    ...
    constructor() {
        IUniswapV2Router02 _UniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Pancakeswap V2
        ...
        _isAllowedDuringDisabled[marketingAddress] = true;
        _isAllowedDuringDisabled[devAddress] = true;
    ...
    function _transfer(
        ...
        if (takeFee) {
            if (isAutomatedMarketMakerPair[from]) {
                if (block.number < startBlockNumber + blocksToWait) {
                    isBot[to] = true;
    ...
    function setMaxTransactionAmount(
        ...
        maxTxAmountBuy = _maxTxAmountBuyPct * 10**_decimals;
        maxTxAmountSell = _maxTxAmountSellPct * 10**_decimals;
    }
