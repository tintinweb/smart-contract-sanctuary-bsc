...
/*
   ...
   -Gandalf-
   Website : https://gandalfinu.com/
   Telegram : https://t.me/gandalfinubsc
...
contract GANDALFINU is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0xeb4d4552F0aa66d29260a7970120A645BB8Edd5E);
    address payable private _marketingWalletAddress = payable(0xeb4d4552F0aa66d29260a7970120A645BB8Edd5E);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(totalFees <= 99, "Max fee 99% to prevent sniper bots in early");
    }
