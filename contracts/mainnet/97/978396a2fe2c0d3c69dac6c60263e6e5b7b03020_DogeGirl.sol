...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0xCD14250C3685b39F3691226573f10deb0B952731); // REWARD Token
...
contract DogeGirl is ERC20, Ownable {
    ...
    constructor() ERC20("DogeGirl", "DogeGirl") {
        address newOwner = address(0x7943cbD099807ab7776C67A0d5650B5Cbe39A4a8);
