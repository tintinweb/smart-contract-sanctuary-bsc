...
contract Octo_Moon_BSC is IBEP20, Auth {
    ...
    string constant _name = "Octo Moon BSC";
    string constant _symbol = "Octo Moon";
    ...
    address public marketingFeeReceiver = 0x9b17aA961cF005c1c5Dd695b23d27F3F41fb3C75;
    ...
    uint256 public swapThreshold = _totalSupply / 100 * 100; // 1.00%
    bool inSwap;
