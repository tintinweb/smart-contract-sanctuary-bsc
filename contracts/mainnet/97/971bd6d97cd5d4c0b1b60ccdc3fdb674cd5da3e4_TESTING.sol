...
contract TESTING is IERC20 {
    ...
    string constant private _symbol = "testing";
    ...
    address payable public marketingWallet = payable(0xf3996aaF021C579A45598E956dEF11A304fBe5B1);
    ...
    uint256 private _maxTxAmount = (_tTotal * 1) / 200;
    uint256 private _maxWalletSize = (_tTotal * 2) / 200;
