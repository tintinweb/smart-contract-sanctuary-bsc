...
contract MILESQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MILE SQUID";
    string private _symbol = "MLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb128c34Dc35cDE506D82777DC3A7841eB19d9dB7); // Marketing Address
    address payable public teamWalletAddress = payable(0xb128c34Dc35cDE506D82777DC3A7841eB19d9dB7); // Team Address
