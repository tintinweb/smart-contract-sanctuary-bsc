...
contract MiloDestiny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Milo Destiny"; 
    string private _symbol = "MiloDestiny";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x745b5d55693E71a6811994f456B30832328eAbCC);
    address payable public teamWalletAddress = payable(0x745b5d55693E71a6811994f456B30832328eAbCC);
