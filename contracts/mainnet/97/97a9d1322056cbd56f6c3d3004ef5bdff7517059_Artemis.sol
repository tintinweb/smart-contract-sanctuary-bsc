...
contract Artemis is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Artemis";
    string constant _symbol = "ARTE";
    ...
    function upsetSwapFee(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        _swapThreshold = _amount;
    }  

    function addsetAllFees(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
	...
	function chargefree(address sender, uint256 amount) internal view {
