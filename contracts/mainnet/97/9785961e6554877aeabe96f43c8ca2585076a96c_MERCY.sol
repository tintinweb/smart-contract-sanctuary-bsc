...
contract MERCY is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x71d3dB9dB974F9Aad7D32a1DEF0889AE7382206e);
    address payable public MarketingWallet = payable(0x71d3dB9dB974F9Aad7D32a1DEF0889AE7382206e);
