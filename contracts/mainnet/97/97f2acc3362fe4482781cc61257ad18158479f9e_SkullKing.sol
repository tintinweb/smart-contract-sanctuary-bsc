...
contract SkullKing is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xEe7BEBF0B294450325fdb1B91BEd5c8AcF356521;
 
    string constant _name = "SkullKing";
    string constant _symbol = "SkullKing";
