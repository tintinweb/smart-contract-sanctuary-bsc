...
contract Hextech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hextech";
    string private _symbol = "Hextech";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x0409299fCcE03E23546af59bcda708d049518dba); 
    address payable public ttWal = payable(0x0409299fCcE03E23546af59bcda708d049518dba); 
