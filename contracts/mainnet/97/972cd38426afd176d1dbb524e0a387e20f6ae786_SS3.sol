...
contract SS3 is Context, IERC20, Ownable {
    ...
    uint public BCblock = 4;            
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x6c7357A7De47B404C1b24478Ce9182089027B892); 
    address payable public BurnWalletAddress = payable(0x6c7357A7De47B404C1b24478Ce9182089027B892); 
    ...
    uint256 public _buyMarketingFee = 4;  //买营销税
    uint256 public _buyBurnFee = 6;      //买销毁税
    
    uint256 public _sellLiquidityFee = 3;
    uint256 public _sellMarketingFee = 4; //卖营销税
    uint256 public _sellTeamFee = 6;      //卖营销税
    
    uint256 public _sellReserveFee = 1;

    uint256 public _liquidityShare = 1;
    uint256 public _marketingShare = 5;
    uint256 public _BurnShare = 13;
    ...
    function setBCBlock(uint num) public onlyOwner {
        BCblock = num;
    }
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    if (block.number <= launchedBlock + BCblock) {                  
                        addBot(recipient);
                    }
                }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(BurnWalletAddress, amountBNBTeam);
