...
contract qaz is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1588";
    string private _symbol = "1588";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x291FE4EacF47bdFF9Fe302753E0eb1338Dd76B36);
    address payable public teamWalletAddress = payable(0x291FE4EacF47bdFF9Fe302753E0eb1338Dd76B36);
    ...
    uint256 private _totalSupply =  1588 * 10**_decimals;
