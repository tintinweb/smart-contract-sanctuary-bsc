...
contract GNS is IERC20Metadata, Ownable, Operator {
    ...
    string private _name = "GNS"; // GNS
    string private _symbol = "GNS"; // GNS
    ...
    address public nftFeeAddress = 0x6b6E7ec013AF1A93261EdF66bFf9A250E3f5a3c2;
    ...
    constructor (){
        ...
        lpFeeAddress = 0x079E7272d505Db5dA03aF9baD117b75DE2B94EA3;
    ...
    event ParamEvent(address indexed sender, address indexed to, uint256 tLpFee, uint256 tNftFee, uint256 tTransferAmount,string a);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, Param memory param) private {
        ...
        if( param.takeFee ){
            emit ParamEvent(sender, recipient, param.tLpFee, param.tNftFee, param.tTransferAmount,"takeFee true");
