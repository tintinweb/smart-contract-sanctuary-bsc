...
contract BNB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x06a548eD88D1d280330e5016340CCE4218D770a2); 
    address payable public Wallet_Dews = payable(0xa3765bc6c25827d3d0bd4b7c30CF44210f67F625);
    ...
    string private constant _name = "Life is Good But BNB Better"; 
    ...
    constructor () {
        ...
        _owner = 0xa3765bc6c25827d3d0bd4b7c30CF44210f67F625;
