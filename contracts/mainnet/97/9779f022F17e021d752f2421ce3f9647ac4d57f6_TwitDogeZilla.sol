...
contract TwitDogeZilla is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "TwitDogeZilla";
  string private _symbol = "TwitDogeZilla";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x9d410991d31168735a37467368db8D4A76A4fE34);
  address payable public teamWallet = payable(0x9d410991d31168735a37467368db8D4A76A4fE34);
