...
contract HasContractURI is ERC165 {
    ...
    constructor() public {
        contractURI = "https://www.plsnft.me/contractMetadata/{address}";
...
contract MintableToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function mint(address _to,string memory tokenIPFSPath) public returns(uint256 tokenId) {
        
        require(msg.sender==market,"not seller");
        ...
        //console.log(__tokenId);

        Fee[] memory fees=new Fee[](0);
        _mint(_to,__tokenId,fees);
