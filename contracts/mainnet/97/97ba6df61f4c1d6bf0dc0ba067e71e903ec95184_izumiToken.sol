...
pragma solidity ^0.8.0;
contract  izumiToken is ERC20, Ownable {
    ...
    constructor() ERC20("izumi Token", "iZi") {
        _mint(msg.sender, 4000000*10**decimals());
        _mint(address(this), 1996000000*10**decimals());
        startSale(block.number, 999999999, 0,700000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,700*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
