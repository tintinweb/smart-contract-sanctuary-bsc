...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb72C630b69685aA829e9B861c6276C82ba7eF54D; // owner address
...
contract BabyMetaShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby MetaShib";
    string private _symbol = "BabyMetaShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb72C630b69685aA829e9B861c6276C82ba7eF54D); // 
    address payable public teamWalletAddress = payable(0xb72C630b69685aA829e9B861c6276C82ba7eF54D); // 
