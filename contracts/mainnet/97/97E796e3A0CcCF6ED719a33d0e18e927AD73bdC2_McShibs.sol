...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C7F4F04b83d3256D6c969f9b81bb2a720d36482; // owner address
...
contract McShibs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McShibs";
    string private _symbol = "McShibs";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA2E4a32eB3425d528B8392ee35D9F8eeE2C64d1a); // Marketing Address
    address payable private teamWalletAddress = payable(0xA2E4a32eB3425d528B8392ee35D9F8eeE2C64d1a); // Team Address
