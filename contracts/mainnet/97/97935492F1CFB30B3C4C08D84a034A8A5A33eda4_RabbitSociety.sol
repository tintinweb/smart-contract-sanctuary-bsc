...
contract RabbitSociety is Context, IERC20, Ownable {
    ...
    string private constant _name = "RABBIT SOCIETY";
    string private constant _symbol = "$RSOCIETY";
