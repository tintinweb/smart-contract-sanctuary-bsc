...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Elon = IBEP20(0x09B89680183d106E00121C9D6befFD2Ce80d2eFA);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Elon.balanceOf(address(this));
        ...
        uint256 amount = Elon.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Elon.transfer(shareholder, amount);
...
contract Musk is IBEP20, Auth {
    using SafeMath for uint256;

    address Elon = 0x09B89680183d106E00121C9D6befFD2Ce80d2eFA;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Elon Currency";
