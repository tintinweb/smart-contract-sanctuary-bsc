...
contract ShibaHunter is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ShibaHunter"; //name of token
    string constant _symbol = "FALQOM"; //tiCKER of token
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;  //marketingwallet of shiba hunter
        anothermarketingWallet = 0x150f0F35E9DCEC4A6b2de9B525e05E602d0761D2;
