...
contract SpmartBuy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Smart Buy";
    string private _symbol = "SMARTBUY";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x571EFf64222358Ae5178fbb24e853ecD5b090123));
        marketingWalletAddress = payable(address(0x571EFf64222358Ae5178fbb24e853ecD5b090123));
