...
contract HoneyBlue is ERC20, Ownable {
    ...
    constructor () ERC20("Honey Blue", "HBLU") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        swapTokensAtAmount = totalSupply() / 5_00000000;

        maxWalletAmount = totalSupply() * 10 / 100000000; // 1%
    }
