...
contract UpGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UPGROW";
    string private _symbol = "$UG";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x50D1e091BEEfeffE62d343296f8cdf9f401A0E8a); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x50D1e091BEEfeffE62d343296f8cdf9f401A0E8a); // Team Address
