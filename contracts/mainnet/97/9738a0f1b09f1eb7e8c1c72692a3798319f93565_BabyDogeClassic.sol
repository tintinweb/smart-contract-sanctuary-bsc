...
contract BabyDogeClassic is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Doge Classic", "BDC") {
        
        address newOwner = 0x3Fb4cEbd235Fe0ba1EAce1F15bF3c53853662EbB; // can leave alone if owner is deployer.
        ...
        operationsAddress = address(0x3Fb4cEbd235Fe0ba1EAce1F15bF3c53853662EbB);
        liquidityAddress = address(0x3Fb4cEbd235Fe0ba1EAce1F15bF3c53853662EbB);
    ...
    function excludePresale(address presale) external onlyOwner {
        excludeFromFees(presale, true);
        _excludeFromMaxTransaction(presale, true);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != lpPair, "The initial pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(limitsInEffect){
            if (from != owner() && to != owner() && to != address(0xdead) && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]){
                //when buy
