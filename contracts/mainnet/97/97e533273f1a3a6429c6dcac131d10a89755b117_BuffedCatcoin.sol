...
/**
   ...
   Welcome to BuffedCatcoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @BuffedCatcoin
   ...
   Can you make #BuffedCatcoin 10000X? 
...
contract BuffedCatcoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0E217163F97F46ec3A7285fE817dC523E8FeDD62); // Marketing Address
    ...
    string private _name = "Buffed Catcoin";
