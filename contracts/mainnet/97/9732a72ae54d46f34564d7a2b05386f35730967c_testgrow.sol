...
contract testgrow is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    string _name = "test grow";
    string _symbol = "$really just a test";
    ...
    uint256 constant liquidityFee = 30; 
    uint256 constant charityFee = 0; 
    uint256 constant devFee = 0;     
    uint256 constant totalFee = 120;  
