...
//
// https://elonsgames.com

pragma solidity ^0.8.7;

import "./library/TradableErc20.sol";
import "./library/Console.sol";

contract ElonsGames is TradableErc20 {
    constructor()
        TradableErc20("Elons Games", "ELONS")
    {
        tradingEnable=true;
    }
...
abstract contract MaxWalletDynamic is Ownable {
    uint256 totalSupply_ = 1e21;
    uint256 internal maxWallet = totalSupply_ * 2 / 100;
    uint256 internal maxTx = totalSupply_ * 5 / 1000;
    ...
    function checkMaxTx(uint256 txSize) internal view {
        require(txSize <= getMaxTx(), "max transaction limit");
    }
