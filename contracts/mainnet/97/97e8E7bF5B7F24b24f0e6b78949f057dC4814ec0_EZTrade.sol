...
/**
Telegram : https://t.me/EZTradeBSC

EZ Trade will make trading easier and safer for everyone with it's sort of unique utilities, all of them at hand in an easy to use DApp

This is just a summary of what EZ Trade will have:

EZSwap with StopLoss, Take Profit, Sell Orders, Buy Orders and more!
Automatic Rug Checker
Copy Trading
EZ Trends Dashboard
EZ Portfolio Tracker
EZ Sniper
and more!
...
/* Token contract */
contract EZTrade is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xf52686e7eABFaD7ecb5a89A307BccDa9ACD4bDF5;
    ...
    // Name and symbol
    string constant _name = "EZ Trade";
    string constant _symbol = "EZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa7D9FaA724BA80bc2d93402DC6004B6466931FEE;
