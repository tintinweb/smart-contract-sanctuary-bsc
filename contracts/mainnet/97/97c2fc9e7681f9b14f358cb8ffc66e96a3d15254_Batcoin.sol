...
/*
Hell yea sniper get fucked in the booty with  this one right here boy 
I hate em all
*/
...
//Contract
contract Batcoin is IBEP20, Ownable {
    ...
    string private constant _symbol = 'Batcoin';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=50; //1% = 10,000,000
    uint16 private constant SellLimitDivider=100; //1% = 10,000,000
    uint8 public constant MaxTax=99;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    uint8 private _devTax=30;
    ...
    uint256 public constant blacklistBlocks = 9;
...
//constructor
    constructor () {
        ...
        MarketingWallet= 0x5bb0F6E5C8Cfc16a1Cf6c28E7a8f5719919fDa8D;
        ...
        _excluded.add(0xEE8CE22018F7591644627C4106163bca149B3Fcf);
...
/////////////////////////////   STAKING REWARDS  /////////////////////////////////////////
    ...
    uint16 public AutoLPThreshold=35;
