...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc19e7D90b63D6a25733C018B00C815fcCc15070B; // owner address
...
contract BabyDinoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDinogeInu";
    string private _symbol = "BABYDINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc19e7D90b63D6a25733C018B00C815fcCc15070B); // Marketing Address
    address payable public teamWalletAddress = payable(0xc19e7D90b63D6a25733C018B00C815fcCc15070B); // Team Address
