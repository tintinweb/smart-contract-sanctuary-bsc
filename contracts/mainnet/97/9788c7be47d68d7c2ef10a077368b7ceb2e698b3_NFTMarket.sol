...
contract NFTMarket is ERC721,  ERC721Enumerable, ERC721URIStorage{
    ...
    mapping (uint256 => string) private _tokenURIs;
    address ad = 0x411BAC95FabE14E8a47d384AC9C9dCDf915C4Fa7;
    mapping(uint256 => bool) private isMintNft;
    
    string private _baseURIextended;
 
    constructor () ERC721("Star Atlas NFT", "StarAtlasNFT") {
    	owner = msg.sender;
	}
    ...
    function mintNFT(address _to,string memory tokenURI_,uint256 orderId) public returns  (uint256) {
        require(msg.sender == ad && !isMintNft[orderId],"mint fail");
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _mint(_to, newItemId);
        _setTokenURI(newItemId, tokenURI_);
        isMintNft[orderId] = true;
        return newItemId;
    }
