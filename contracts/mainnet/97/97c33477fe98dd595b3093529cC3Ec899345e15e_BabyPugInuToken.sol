...
//////////
//Discord: https://discord.gg/yRx3tBw
//Telegram: https://t.me/BabyPugInuOfficial
//////////
...
contract BabyPugInuToken is IBEP20, Auth {
    ...
    string constant _name = "Baby PugInu";
    string constant _symbol = "Baby PugInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 100; //1% 
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; //2%
    ...
    address private marketingFeeReceiver = 0xfE2B60093c59C0d90742A64a13D8A06eb3b61B6F;
    address private developmentFeeReceiver = 0xDa312D7d1ee3285881D7ffdc1Dd11BF9A09d24fE;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setBuyback(uint256 _liquidityFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
