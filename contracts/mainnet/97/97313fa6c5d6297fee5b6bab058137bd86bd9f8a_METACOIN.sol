...
/**
Meta Coin (META) by Moondevx

Tax: 10/10
Locked: ✅🔑

Tg: https://t.me/MetacoinBSC

Moondevx social media:
Twitter : @MoonDevX 
IG: @moondevx
Tiktok: @moondevx
*/
...
contract METACOIN is IBEP20, Auth {
    ...
    string constant _name = "Meta Coin";
    ...
    address public marketingFeeReceiver = 0x1B05e323Fb95A97d09172569Cf9aba51D0E9D3A9;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
     ...
     function setSellMultiplier(uint256 amount) external onlyOwner {
        _sellMultiplier = amount;
        require (_sellMultiplier <= 3);
    }
