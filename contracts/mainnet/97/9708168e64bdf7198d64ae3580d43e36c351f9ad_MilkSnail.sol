...
/**
MilkSnail
TELEGRAM- https://t.me/MilkSnail
WEB- www.MilkSnail.finance
...
contract MilkSnail is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MilkSnail";
    string private _symbol = "$MSNAIL";
