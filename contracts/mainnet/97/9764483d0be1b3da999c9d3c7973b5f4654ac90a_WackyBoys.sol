...
//https://twitter.com/wackyboys_bsc

/*税 2，2 税率分配模式：

每日12点提取25%营销钱包资金进行分配
...
1.每天将会在官方推特下展开一个话题，公开评论三天，点赞前10名且真实优质原创评论，将奖励结束当天营销钱包共计10%，通过抄袭作弊机刷将取消获奖资格。

2.评论要求：#反骨仔 +爆料[email protected]三位好友+留下地址（仅限于持币地址参加）

3.所有投稿，优质评论一经核实，将以销毁方式 在hash备注信息中上链，将这些大️割一辈子钉在区块链历史的耻辱柱上 ，永不磨灭。
...
contract WackyBoys is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "WackyBoys";
    string private _symbol = "WackyBoys";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x65350A39C3f4D4A6BFfF8Cb8f4DA4c528AD875f9);
    address payable public liqWalletAddress = payable(0x000000000000000000000000000000000000dEaD);
