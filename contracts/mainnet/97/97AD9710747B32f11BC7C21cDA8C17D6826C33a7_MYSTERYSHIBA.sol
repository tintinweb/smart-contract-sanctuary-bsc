...
Telegram: https://t.me/MysteryShib
...
contract MYSTERYSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "MysteryShiba";
    string private _symbol = "MYSTERYSHIBA";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable public marketing =
        payable(0xEA86db718f76983A038598A2a7d85B95A4C1D389);
