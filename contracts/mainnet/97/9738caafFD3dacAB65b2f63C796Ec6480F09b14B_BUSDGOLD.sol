...
/**TG: https://t.me/BUSDGOLDOFFICIAL
*/
...
contract BUSDGOLD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x3db8B24fd3600C20b4F46bd0e7eD80B94a9B8241;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "BUSD GOLD";
    string constant _symbol = "$BUSDGOLD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xAeC3F21ecd3124E07283739953E80f12Ba4fF596;
