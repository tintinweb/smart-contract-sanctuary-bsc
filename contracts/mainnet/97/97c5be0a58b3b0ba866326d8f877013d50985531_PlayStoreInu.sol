...
contract PlayStoreInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Play Store Inu"; // 
    string private constant _symbol = "PSI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x5dD4B7ceaCbCf90Cc62FDE9e369dE1b8Dfcfc1B7;
