...
contract YYDM is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private _name = "YYDM";
    string private _symbol = "YYDM";
    uint256 private _decimals = 1;
    uint256 private _totalSupply = 1000000000000000 * 10 ** _decimals;
    uint256 private _maxTxtransfer = 10000000000000000000000000000000000000000000000 * 10 ** _decimals;
