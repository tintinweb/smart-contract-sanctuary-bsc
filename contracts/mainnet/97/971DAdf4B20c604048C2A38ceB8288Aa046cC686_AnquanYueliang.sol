...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62df3086940EEf93B8B8FbB087ac2b40eCaAF6ec; // owner address
...
contract AnquanYueliang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anquan Yueliang";
    string private _symbol = "AY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62df3086940EEf93B8B8FbB087ac2b40eCaAF6ec); // 
    address payable public teamWalletAddress = payable(0x62df3086940EEf93B8B8FbB087ac2b40eCaAF6ec); // 
