...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01e9B2BAE2841AEBD07D50EfCF001F367fdC6128;
...
contract GOLDD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdC06e7cFFF3B99b6054F33038C994da8a269830c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _GOLDD = "Comfy Rocket";
    string private _GLD = "COMF";
