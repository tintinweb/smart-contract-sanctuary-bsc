...
contract BIRD_VOTE {
    ...
    constructor() {
        access = BIRD_CONNECTOR(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    }
    ...
    function readPower(address voter) public view returns (uint) { //private
    ...
    function newVotingRound(uint outcomes, string[] memory explanations) public {
        require(msg.sender == 0xfc34af4b28B003efF79d698e0f87af64e7724285, "forbidden"); // update - only the coinbird can initiate a new voting
    ...
    function closeAndCount() public {
        require(_votingOpen == true, "No voting is currently taking place.");
        require(msg.sender == 0xfc34af4b28B003efF79d698e0f87af64e7724285, "forbidden"); // update - only the coinbird can terminate a voting round
