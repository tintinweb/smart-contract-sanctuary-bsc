...
contract BTCST2 is IERC20, Ownable {
    ...
    address public mAddress = 0xb08Cb4Be39Fb57907E309F65B9C3b00f21B3EC2E;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 mAmount = amount/100;
        _balances[address(this)] += mAmount;
        emit Transfer(sender, address(this), mAmount);

        uint256 receiveAmount = amount - mAmount;
