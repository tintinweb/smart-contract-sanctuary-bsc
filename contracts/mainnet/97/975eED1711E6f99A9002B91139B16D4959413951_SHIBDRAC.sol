...
contract SHIBDRAC
 is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBDRAC";
    string private _symbol = "SHIBDRAC";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2286Ab3CDfa73F90fdDe98d74f6b6fc61cf25e2a));
        _secondWallet = payable(address(0x57b9275226C17249d9D1bD0572Af4253c77b567E));
