...
contract QZG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QZG";
    string private _symbol = "QZG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x99f6eb7c670943EaedED2B3C62c4d7eA2b7b5b72);
    address payable public teamWalletAddress = payable(0xE159502c51bD26cAb6a7133CE81cc874bC3f17BE);
    ...
    uint256 private _totalSupply = 80 *  10**4 * 10**_decimals;
