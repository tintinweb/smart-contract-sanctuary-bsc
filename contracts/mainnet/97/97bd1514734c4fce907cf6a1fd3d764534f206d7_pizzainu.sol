...
https://t.me/Pizza_inu


LP locked 🔥✅
MAX transaction and wallet ✅
Bullish name 🍕
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Pizza Inu';

    string constant public symbol = 'pizzainu';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 109000000*10**uint256(decimals);
...
contract  pizzainu is BaseToken {
