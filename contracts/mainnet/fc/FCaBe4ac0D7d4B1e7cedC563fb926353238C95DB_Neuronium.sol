...
TG: https://t.me/NeuroniumOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe5b83A9aD6bf1B1b17BeBe94C4d69E713104B830; // owner address
...
contract Neuronium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Neuronium";
    string private _symbol = unicode"NEURON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe5b83A9aD6bf1B1b17BeBe94C4d69E713104B830); // Marketing Address
    address payable public teamWalletAddress = payable(0xe5b83A9aD6bf1B1b17BeBe94C4d69E713104B830); // Team Address
    ...
    uint256 private _totalSupply = 3500000 * 10**_decimals;
    uint256 public _maxTxAmount = 35000 * 10**_decimals; 
    uint256 public _walletMax = 35000 * 10**_decimals;
