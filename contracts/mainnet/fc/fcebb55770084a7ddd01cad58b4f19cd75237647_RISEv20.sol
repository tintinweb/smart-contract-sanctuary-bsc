...
contract RISEv20 is Context, IERC20, Ownable {
    ...
    uint8 public maxBuybackFee = 100; // During launching to punish snipers! 
    //This will be restored to 10 upon the official announcement of CA.
    ...
    // Taxes are initially set this way to punish snipers! 
    // This will be restored to normal tokenomics upon the official announcement of CA.
    ...
    uint8 public _walletFee = 100; // During launching to punish snipers!
