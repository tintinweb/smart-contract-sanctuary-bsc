...
contract iPhoneINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "iPHONE INU"; //
    string private constant _symbol = "iPNU"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x98620963f501CF68a1C2788Ca4A63DA7291F11f2;
