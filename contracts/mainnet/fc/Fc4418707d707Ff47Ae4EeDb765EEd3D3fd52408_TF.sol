...
contract TF is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0x14C2939b5873fb4CaCCA6371C55A33e21557C838; // Marketing Address
	address payable public burningAddress = 0x0000000000000000000000000000000000000000; // burn Address
	address payable public devAddress = 0x80594a3e1907Cf9e48D215d26054F861D054badB; // Dev Address
    ...
    string private constant _name = "TiFo Token";
