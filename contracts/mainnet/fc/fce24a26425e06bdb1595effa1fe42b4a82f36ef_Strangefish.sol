...
contract Strangefish
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Strange Fish";
    string private _symbol = "Strange Fish";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD724458DB01A16f33a5D075741E4C6BD0312AB42);
    address payable public teamWalletAddress = payable(0xD724458DB01A16f33a5D075741E4C6BD0312AB42);
    address public immutable deadAddress = 0xD724458DB01A16f33a5D075741E4C6BD0312AB42;
    ...
    uint256 public _walletMax =     2100000000 * 10**_decimals;
