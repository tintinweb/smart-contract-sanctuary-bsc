...
contract CCC is Context, IERC20, Ownable {
    ...
    string private _name = "Cash Cow Coin";
    string private _symbol = "CCC";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x73A58936B29641d03017a14F88462cd0deCAa63b); //做市商地址
    address payable public BurnedWalletAddress = payable(0x73A58936B29641d03017a14F88462cd0deCAa63b); //手续费奖励地址
    ...
    address payable public toAddress1 = payable(0x73A58936B29641d03017a14F88462cd0deCAa63b); //发行到哪里
