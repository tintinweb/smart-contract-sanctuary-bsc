...
contract NEWCASTLE is NEWCASTLEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private NEWCASTLETeam;
    address private CharityNEWCASTLE;
    ...
    string public override name = "NEWCASTLE";
    string public override symbol = "NEWCASTLE";
    ...
    constructor(uint totalSupplyValue, address NEWCASTLETeamAddress, address CharityNEWCASTLEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        NEWCASTLETeam = NEWCASTLETeamAddress;
        CharityNEWCASTLE = CharityNEWCASTLEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[NEWCASTLETeam] =  totalSupply * 4 / 100;
        balances[CharityNEWCASTLE] = totalSupply * 4 / 100;
