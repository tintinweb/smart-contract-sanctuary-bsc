...
contract DollarBeans is Context, Ownable {
    ...
    address BUSD = 0x1fFD93F8c3d99bDAA4A012A0Fc26868F00Cfa5c2;
    address public DEV_ADDRESS = 0x5E0C7Ab8C3B3E7D183B7f3c7DAd1C643Ff8a3824;
    address public MARKETING_ADDRESS = 0xb207BC06bA619E1A41C7Fc3bae71b1eD774a2fB6;
    address public CEO_ADDRESS = 0xb207BC06bA619E1A41C7Fc3bae71b1eD774a2fB6;
    address public GIVEAWAY_ADDRESS = 0xb207BC06bA619E1A41C7Fc3bae71b1eD774a2fB6;
    ...
    uint256 MIN_DEPOSIT = 10 ether; // 1000000 BUSD
    uint256 MIN_BAKE = 1 ether; // 100000 BUSD
    uint256 MAX_WALLET_TVL_IN_BNB = 100000 ether; // 10000000000 BUSD
    uint256 MAX_DAILY_REWARDS_IN_BNB = 6500 ether; // 650000000 BUSD
    uint256 MIN_REF_DEPOSIT_FOR_BONUS = 150 ether; // 15000000 BUSD
    ...
    function handleBake(bool onlyRebaking) private {
        ...
        require(hasInvested(baker.adr), "Must be invested to WHALE");
        if (onlyRebaking == true) {
            require(
                beansToBnb(rewardedBeans(baker.adr)) >= MIN_BAKE,
                "Rewards must be equal or higher than 100000 WHEXDAO to BLOW"
            );
        }
