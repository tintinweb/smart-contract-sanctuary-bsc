...
contract StepUpFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x62Aa66a54aeB5F7d0f7a486B05E3e7F0E472a2bb); // Marketing Address
    ...
    string private _name = "Step Up Finance";
