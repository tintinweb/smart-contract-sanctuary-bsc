...
Laika was a Soviet space dog who became one of the first animals in space, 
and the first animal to orbit the Earth. Laika, a stray mongrel from the streets of Moscow, 
was selected to be the occupant of the Soviet spacecraft Sputnik 2 that was launched into 
low orbit on 3 November 1957. 

https://t.me/laikainu_portal
...
contract LAIKAINU is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Laika INu";
    string constant public symbol = "LAIKA";
