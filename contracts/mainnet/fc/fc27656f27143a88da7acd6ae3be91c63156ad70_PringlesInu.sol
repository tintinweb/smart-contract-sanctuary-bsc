...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x98C6aBC11dDf15FA28E96ffcFF4246706C49afF8; // owner address
...
contract PringlesInu is Context, IERC20, Ownable {
    ...
    string private _name = "Pringles Inu";
    string private _symbol = "PRINGLES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98C6aBC11dDf15FA28E96ffcFF4246706C49afF8); // Marketing Address
    address payable public teamWalletAddress = payable(0xdAdce75d9C7dfA43278Bc279f0ca01142DBf56b2); // Team Address
