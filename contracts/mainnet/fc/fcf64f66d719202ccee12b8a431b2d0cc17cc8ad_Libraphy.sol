...
contract Libraphy is Context, IERC20, Ownable {
using SafeMath for uint256;
using Address for address;


address payable public marketingAddress = payable(0x113849883Fd9Cf1dF8D3e9B8AA8589756901A983);
address payable public developmentAddress = payable(0x113849883Fd9Cf1dF8D3e9B8AA8589756901A983);
address payable public charityAddress = payable(0x113849883Fd9Cf1dF8D3e9B8AA8589756901A983);
address payable public vaultRewardAddress = payable(0x113849883Fd9Cf1dF8D3e9B8AA8589756901A983);
...
string private constant _name = "Libraphy";
string private constant _symbol = "LBH";
...
uint256 public _liquidityFee = 1; // liquidity + all team fees
