...
Telegram: https://t.me/christmascash

 ___  _         _        _                     ___           _   
|  _>| |_  _ _ <_> ___ _| |_ ._ _ _  ___  ___ |  _> ___  ___| |_ 
| <__| . || '_>| |<_-<  | |  | ' ' |<_> |<_-< | <__<_> |<_-<| . |
`___/|_|_||_|  |_|/__/  |_|  |_|_|_|<___|/__/ `___/<___|/__/|_|_|
...
/* Christmas Cash Token Contract */
contract ChristmasCash is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x997C724D2A64FFee93E324277890d6b43E495Eef;
    ...
    // Name and symbol
    string constant _name = "Christmas Cash";
    string constant _symbol = "CHRISTMASCASH";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 100k 
