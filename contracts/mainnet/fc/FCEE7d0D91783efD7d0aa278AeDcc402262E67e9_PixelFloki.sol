...
abstract contract Auth {
    ...
    /**
     * Function modifier to require caller to be contract owner YES 
     */
    modifier onlyOwner() {
...
contract PixelFloki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pixel Floki";
    ...
    uint256 public _walletMax = _totalSupply * 36 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xf0F626bAaa7349f97C58303239F7DD31Ba05E8E0;
