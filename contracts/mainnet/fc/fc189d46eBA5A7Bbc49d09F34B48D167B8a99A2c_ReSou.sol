...
contract ReSou is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x1f309B1645eEfe532ce0a9dfAA5285E842C626C6));
        ruinWalletAddress = payable(address(0x1f309B1645eEfe532ce0a9dfAA5285E842C626C6));
        _name = coinName;
       _symbol = coinSymbol;
