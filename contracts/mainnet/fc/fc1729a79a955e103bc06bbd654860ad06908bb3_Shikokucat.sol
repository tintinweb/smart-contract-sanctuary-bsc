...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6FEe70288c54580D03Ac94B8f1b41bDf11B26b52; // owner address
...
contract Shikokucat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikoku CAT";
    string private _symbol = "SHIKCAT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC8c48a70BB54b4DB74eff089FC28c46e399DebeD); // Marketing Address
    address payable private teamWalletAddress = payable(0x6FEe70288c54580D03Ac94B8f1b41bDf11B26b52); // Team Address
