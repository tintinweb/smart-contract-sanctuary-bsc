...
contract S11 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "S11";
    string private _symbol = "S11";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x5Ef84553B3673E4Dd9b44C54309002994b39d3AF);
    ...
    function setMarketingFee(uint256 value) external onlyOwner {
        _marketingFee = value;
        _totalTax = _marketingFee;
        require(_marketingFee <= 10, "Total fee is over 10%");
    }
