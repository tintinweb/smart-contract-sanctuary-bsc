...
contract BabyCHH
 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCHH";
    string private _symbol = "BabyCHH";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCd185bB032dFD1E5baFeE0a006c5B35B3dF9cAF6));
        _secondWallet = payable(address(0xCd185bB032dFD1E5baFeE0a006c5B35B3dF9cAF6));
