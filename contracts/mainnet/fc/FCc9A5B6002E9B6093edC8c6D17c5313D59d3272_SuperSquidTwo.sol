...
/* Token contract */
contract SuperSquidTwo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xAAddF999AD6e2e17B1E136003C19d6cfbC43280e; 
    ...
    // Name and symbol
    string constant _name = "SUPER SQUID TWO";
    string constant _symbol = "SUPERSQD2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xAAddF999AD6e2e17B1E136003C19d6cfbC43280e;  
