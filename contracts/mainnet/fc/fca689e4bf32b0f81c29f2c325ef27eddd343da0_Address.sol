...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x058eE6e3a1894A73693544727d5AB09117213bB2;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcF42721728bc8dE320d71b163dC5346D4E245155;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Foyda Coin";
    string private _symbol = "FOYDA";
