...
interface CreateToken0 {
function createToken0(string memory setname, string memory setsymbol,uint256 unitsNumber,address usd,uint256 multiple,uint256 _Capitalpror,uint256 _commissionRate)external returns (address,address);
function Qaddress() external view returns (address,address);
}
