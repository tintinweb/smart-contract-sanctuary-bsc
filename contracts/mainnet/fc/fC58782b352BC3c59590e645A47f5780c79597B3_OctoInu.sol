...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9820BbB098d37873fa955F36548103B2067b56d6; // owner address
...
contract OctoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Octo Inu";
    string private _symbol = "OCTINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9820BbB098d37873fa955F36548103B2067b56d6); // Marketing Address
    address payable public teamWalletAddress = payable(0x9820BbB098d37873fa955F36548103B2067b56d6); // Team Address
