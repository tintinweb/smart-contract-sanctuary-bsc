...
contract Booge is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xef3676e6c5e2248e22f9849638959F99c815e55E);
    address public liquidityreceiverWallet = 0xC266bD7fDA8957FA214364E869F1c94979e54175;

    string private _name = "Booge";
    ...
    function _isAddressExcludedFromWalletLimit(address Account,bool status) external onlyOwner(){
    ...
    function setNumTokens(uint256 NumToken) public {
