...
/**
  Telegram  : https://t.me/Optimusgirl
...
contract OptimusGirl is Context, IERC20 { 
    ...
    */
    ...
    Wallet_OPTG: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_OPTG = payable(0xe9267c98D0c4Bf42D7B9CE327EDAf20F006cA35D); 
    address payable public Wallet_LP = payable(0xe9267c98D0c4Bf42D7B9CE327EDAf20F006cA35D);
    address payable public Wallet_Tokens = payable(0xe9267c98D0c4Bf42D7B9CE327EDAf20F006cA35D); 
    ...
    string private constant _name = "Optimus Girl"; 
    string private constant _symbol = unicode"OPTG"; 
    ...
    uint256 public Percent_OPTG = 95;
    ...
    constructor () {
        ...
        _owner = 0xe9267c98D0c4Bf42D7B9CE327EDAf20F006cA35D;
        ...
        */
        ...
        _isLimitExempt[Wallet_OPTG] = true; 
        ...
        _isExcludedFromFee[Wallet_OPTG] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 OPTG_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((OPTG_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_OPTG = OPTG_Wallet;
    ...
    */
    ...
    //Update the OPTG wallet
    event updatedOPTGWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_OPTG(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedOPTGWallet(Wallet_OPTG,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_OPTG] = false; 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_OPTG != 0){

            // Calculate how many tokens need to be swapped for BNB (OPTG BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_OPTG / 100;
            ...
            uint256 split_M = Percent_OPTG * 100 / (Percent_AutoLP + Percent_OPTG);
            ...
            // Send BNB to OPTG wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_OPTG, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_OPTG != 0){

            // Swap tokens for BNB and send to OPTG Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_OPTG / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_OPTG, BNB_M);
            ...
            // Create the Auto LP if OPTG is 0
