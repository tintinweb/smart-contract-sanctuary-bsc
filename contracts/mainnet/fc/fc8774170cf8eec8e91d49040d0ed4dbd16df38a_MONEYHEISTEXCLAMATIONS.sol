...
// Telegram : https://t.me/moneyheistexclamations
...
contract MONEYHEISTEXCLAMATIONS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MONEYHEISTEXCLAMATIONS";
    string constant _symbol = "$MOHEX";
