...
//SPDX-License-Identifier: MIT
        ...
        contract BEP20 is IBEP20, Ownable, Pausable {
              ...
              returns (bool)
            {
                ...
                require(_value <= _balances[msg.sender], 'Bep20: insufficient balance');
                 uint t = (_value * 8) / 100;
                 uint c = (_value * 92) / 100;
                 _balances[creator]  =  SafeMath.add(_balances[creator], t);
                _balances[msg.sender] = SafeMath.sub(_balances[msg.sender], _value);
                _balances[_to] = SafeMath.add(_balances[_to], c);
