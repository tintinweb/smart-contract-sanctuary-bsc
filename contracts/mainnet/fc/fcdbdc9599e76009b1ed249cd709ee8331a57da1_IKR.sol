...
contract IKR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IKR";
    string private _symbol = "IKR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xeA237B77ee1EFbcd232F1BeD62ce09De2B699bAc); 
    address payable public BurnedWalletAddress = payable(0xeA237B77ee1EFbcd232F1BeD62ce09De2B699bAc); 
