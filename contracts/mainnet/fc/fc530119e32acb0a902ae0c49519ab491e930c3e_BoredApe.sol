...
contract BoredApe is Context, IERC20, Ownable {
    ...
    string private _name = "BoredApe";
    string private _symbol = "$BAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2eB12536D0e9bD2Eb3f9d66F67b4BbdfE6bF0B8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA2eB12536D0e9bD2Eb3f9d66F67b4BbdfE6bF0B8); // BuyBack Address
