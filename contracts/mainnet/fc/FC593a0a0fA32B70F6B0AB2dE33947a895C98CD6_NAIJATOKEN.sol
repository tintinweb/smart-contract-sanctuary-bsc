...
/*
*
* Telegram: https://t.me/officialnaijatoken
* Twitter : https://twitter.com/Off_NaijaToken
* Website : www.naijatoken.org
*/
...
contract NAIJATOKEN is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   NaijaTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Naija Token", "NAT") {
        _buyRewardsFee = 1;
        _buyLiquidityFee = 1;
		_buyMarketingFee = 1;
        _buyDevFee = 1;
    	...
    	dividendTracker = new NaijaTokenDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x698795e114dc33E194bd24e7E91E6c7d9900A7dD);
        _devWallet = payable(0x99B9735DE28F1566FB8a53AEa3E88B3F6a82f344);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "NaijaToken: The dividend tracker already has that address");

       NaijaTokenDividendTracker newDividendTracker = NaijaTokenDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "NaijaToken: The new dividend tracker must be owned by the NaijaToken token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "NaijaToken: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "NaijaToken: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NaijaToken: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "NaijaToken: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "NaijaToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NaijaToken: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "NaijaToken: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "NaijaToken: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "NaijaToken: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "NaijaToken: Cannot update gasForProcessing to same value");
...
contract NaijaTokenDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("NaijaToken_Dividend_Tracker", "NaijaToken_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "NaijaToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NaijaToken contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "NaijaToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "NaijaToken_Dividend_Tracker: Cannot update claimWait to same value");
