...
contract SFM is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SafeMeown";
    ...
    uint256 private _gasPriceLimitS=10;
    ...
    address payable  _marketingAddress = payable(0xcdC4f108BFF01511a792d1731Fcf08614823A8F2);
    address payable constant  _projectMaintainence = payable(0xcdC4f108BFF01511a792d1731Fcf08614823A8F2);
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal.div(200); // 0.5%
        _maxWalletAmount = _tTotal.div(200); // 0.5%
    ...
    require(BuyGas > 7, "Max gas for buying must be higher than 7 gwei");
    require(SellGas > 7, "Max gas for selling must be higher than 7 gwei");
