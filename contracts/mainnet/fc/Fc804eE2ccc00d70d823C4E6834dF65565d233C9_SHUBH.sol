...
contract SHUBH is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**12 * (10**9); 

    uint256 public maxBuyAmount = 2 * 10**16 * 10**9; // 1% of the supply
    uint256 public maxSellAmount = 1 * 10**16 * 10**9; // 1% of the supply
    uint256 public maxWalletAmount = 5 * 10**16 * 10**9; // 5% of the supply
    ...
    address payable _marketingWallet = payable(address(0x06C87EfDBE8baC0Af371245E9c16481e19080c96)); // MarketingWallet
    ...
    constructor() ERC20("Shubh Inu", "SHUBH") {
        ...
        */
        _mint(owner(), 1 * 10**18 * (10**9)); //  1 QuadTrillion Tokens
    }
