...
contract GrowCity is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GrowCity";
    string private _symbol = "GROWCITY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x37dDEbAec98EEd40023ECe4dC165EF76d00cDef1); 
    address payable public teamWalletAddress = payable(0x37dDEbAec98EEd40023ECe4dC165EF76d00cDef1); 
