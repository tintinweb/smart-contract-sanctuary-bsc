...
/*
    ...
    TG: https://t.me/WEARE_DIAMONDHANDS
*/
...
contract DIAMONDHANDS is IERC20, Ownable {
    ...
    string _name = "DIAMOND HANDS";
    string _symbol = "DHS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 1000;   // 100% 
