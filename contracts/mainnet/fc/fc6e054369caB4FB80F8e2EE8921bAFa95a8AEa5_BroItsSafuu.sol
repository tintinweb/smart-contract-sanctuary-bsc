...
contract BroItsSafuu is ERC20Detailed, Ownable {
    ...
    string public _name = "BroItsSafuu";
    string public _symbol = "BISAFUU";
    ...
    constructor() ERC20Detailed("BroItsSafuu", "BISAFUU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xc8A592b8F1BF94462AC9091D7b87BdA76434b351;
        treasuryReceiver = 0xc8A592b8F1BF94462AC9091D7b87BdA76434b351;
        safuuInsuranceFundReceiver = 0xc8A592b8F1BF94462AC9091D7b87BdA76434b351;
        firePit = 0x6feAD5E455810739e2A0Ab5e9a0fD4Bc17e10b9c;
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (365 days)) {
            ...
            rebaseRate = 211;
        } else if (deltaTimeFromInit >= ((1 * 365 days) / 10)) {
            rebaseRate = 14;
