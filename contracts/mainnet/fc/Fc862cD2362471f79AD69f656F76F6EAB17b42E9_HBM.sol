...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 9999999 / 10000000;
    ...
    function setFee(uint256 lpDividendFee, uint256 fundFee) external onlyOwner {
...
contract HBM is AbsToken {
    ...
    //USDT
        ...
        21000000,
    //Fund
        address(0x4b3102e460AC1e9C7D6865c698B0f2C4f90fdc1c),
    //Receive
        address(0x237873d5733e2E2b1E14065EB3Ec972c598aD314)
    ){
