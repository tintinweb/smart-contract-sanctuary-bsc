...
/**
* telegram : https://t.me/babyPorcupine
* 
*
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfD76233EB1b75A4874530f49D77F5F8b11ff207a;
...
contract BabyPorcupine is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0D13ea6Cbe326F65e9C9704FFcBc55804151Ff90;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Porcupine";
    string private _symbol = "BabyP";
