...
contract MetaPex is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaPex";
    string private _symbol = "MetaPex";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x187C47c0d6a5a8Dbe676006126416c28EA42eD80); // Marketing Address
    address payable public teamWalletAddress = payable(0x0c04F4F8328823943Ad5FEd924232d76BCb8A0B1); // Team Address
    ...
    uint256 public _walletMax = 100000000 * 10 ** 18;
