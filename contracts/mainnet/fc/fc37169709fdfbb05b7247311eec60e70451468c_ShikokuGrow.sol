...
contract ShikokuGrow is IBEP20, Auth {
    ...
    string constant _name = "Shikoku Grow";
    ...
    address private marketingFeeReceiver = 0x99B6a46C0b7cAa315ED233323Ab8Ea42df1B0EcE;
    address private buybackFeeReceiver = 0x99B6a46C0b7cAa315ED233323Ab8Ea42df1B0EcE;
    ...
    uint256 public swapThreshold = 100 * 10**12 * (10 ** _decimals); // 0.3%
    bool inSwap;
