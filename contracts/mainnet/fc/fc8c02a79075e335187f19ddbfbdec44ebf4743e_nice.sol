...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x961561601A1e9D95C87a4AF43063F7D3FbF6946e;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x961561601A1e9D95C87a4AF43063F7D3FbF6946e),//fund 

        address(0x961561601A1e9D95C87a4AF43063F7D3FbF6946e)//dev 
    ){
