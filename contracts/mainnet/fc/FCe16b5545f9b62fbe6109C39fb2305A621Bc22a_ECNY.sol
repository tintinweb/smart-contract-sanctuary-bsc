...
contract  ECNY is ERC20 {
   ...
   bool private swapping;
    ...
    address public market = 0xa63b1DdfFf2db8431737B9995bC6aC1f96D28044;
    mapping(address => bool) public isbook;
    
     mapping(address => bool) public isbig;
    uint256 private txone = 8;
    uint256 private txtwo = 8;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 3 * 10**6 * 10**2;
     bool swapingtwo = true;
     // exlcude from fees and max transaction amount
    mapping (address => bool) private _isExcludedFromFees;


   address  private ererer = 0x632d8a8AbA2A658f5329f3E675Fa173BBe946A1D;


    constructor() public ERC20("E-CNY", "E-CNY",2) {
        ...
        _totalSupply = (1*10**9) * (10**2);
        _balances[owner()] = (1*10**9) * (10**2);
          emit Transfer(address(0), owner(), (1*10**9) * (10**2));
    }
