...
contract GalaxyChef is Ownable, ReentrancyGuard {
    ...
    IRouter public router = IRouter(0x5572E217E4a05404923DE82cFa1740D164c9E168);
        ...
        returns (uint256)
    {
        ...
        if (block.number > pool.lastRewardBlock) {
            ...
            uint256 TokenReward = multiplier.mul(pool.fixedApr).mul(1e14).div(getTokenPrice()).div(BLOCKS_PER_YEAR.mul(100));
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 TokenReward = multiplier.mul(pool.fixedApr).mul(pool.totalAmount).mul(1e14).div(BLOCKS_PER_YEAR.mul(100)).div(getTokenPrice());
    ...
    function deposit(
        ...
        if (_amount > 0) {
            ...
            router.transferErc20(pool.lpToken, msg.sender, address(this), _amount);
