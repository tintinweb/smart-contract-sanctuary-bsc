...
contract tantanhu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "tantanhu";
    string private _symbol = "TANTAN";
    ...
    function shareaddress(address shareholder, uint256 _amount) internal {    
   ...
   function totalamount(address shareholder, uint256 totalDividends, uint256 totalExcluded) public pure returns (uint256) {
