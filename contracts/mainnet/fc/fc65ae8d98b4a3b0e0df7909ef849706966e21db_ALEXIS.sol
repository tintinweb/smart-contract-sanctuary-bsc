...
contract ALEXIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alexis Network";
    string private _symbol = "Alexis";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb24178a7F2443cf9aF8365909D51Fd4deA2A600E); 
    address payable public DevelopmentWalletAddress = payable(0x00B8AD2B6485584BBE4eA1bc2A4aFF3BD117D2b2); 
    ...
    uint256 public _maxTxAmount = 20 * 10**6 * 10**9; // 2% MAX
    uint256 public _walletMax = 20 * 10**6 * 10**9; // 2% MAX
