...
contract DONTBUY is Context, IERC20, Ownable {
    ...
    uint256 private constant _reduceSellTaxAt=4;
    uint64 private _ST=10;
    uint64 private _FST=70;
    uint128 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    uint256 public _tx = 1000000000 * 10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount.mul((_buyCount>_reduceBuyTaxAt)?_finalBuyTax:5).div(100);
