    ...
    IDividendPayingTokenOptional
{
    ...
    address public dividendToken = 0x156ab3346823B651294766e23e6Cf87254d68962;
...
contract LuncRewardToken is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _dividendToken = 0x156ab3346823B651294766e23e6Cf87254d68962;
    ...
    LuncrTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Lunc Reward Token", "LUNCR") {
        dividendTracker = new LuncrTokenDividendTracker();

        teamWallet = 0x4BD60D7378de771EfB3cAe8520Cce2aA2797fcF7;
        lotteryWallet = 0xFB3928e88356A9151d57A76fc863B8A67Efe6f86;
        marketingWallet = 0x9A755F2533Da2da90F9581C3e892b6930CeE27bd;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "LUNCR: The dividend tracker already has that address"
        );

        LuncrTokenDividendTracker newDividendTracker = LuncrTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "LUNCR: The new dividend tracker must be owned by the LUNCR token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "LUNCR: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "LUNCR: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "LUNCR: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "LUNCR: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "LUNCR: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "LUNCR: Cannot update gasForProcessing to same value"
        );
...
contract LuncrTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("LUNCR_Dividend_Tracker", "LUNCR_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "LUNCR_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "LUNCR_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LUNCR contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "LUNCR_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "LUNCR_Dividend_Tracker: Cannot update claimWait to same value"
        );
