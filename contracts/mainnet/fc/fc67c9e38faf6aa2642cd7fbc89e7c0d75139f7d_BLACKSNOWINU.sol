...
contract BLACKSNOWINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Snow Inu";
    string private _symbol = "BSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x74e1515672EF2b31C587D11c87C1b4a8f52539A2); // Marketing Address
    address payable public devFee = payable(0x108eC2e773def3DECda5CC6d074cbD5aC5901452); // devFee
