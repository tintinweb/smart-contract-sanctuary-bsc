...
contract KatBoyCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KatBoyCoin";
    string private _symbol = "KATBOY";
    uint8 private _decimals = 15;

    address payable public marketingWalletAddress = payable(0x8fB5C50A54551C28085997Ffe988Ea2Af1c2840D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xb271fbB0BA40696ad699136d8f733Fe0b7A9c98a); // BuyBack Address
