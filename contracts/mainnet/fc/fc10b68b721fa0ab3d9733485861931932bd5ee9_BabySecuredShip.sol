...
contract MoonshotMechanism is IMoonshotMechanism {
    ...
    constructor() public {
        ...
        admin = 0xD9E4CA3181D3D0c3B93F8607EfD36a2c00b41A10;
...
contract BabySecuredShip is IPYE, Context, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySecuredShip";
    ...
    constructor() public {
        ...
        _defaultFees = Fees(
            ...
            1000,
            0,
            0xB1A4AF052386E6CE9836Ab6c7139e0f11f30Cfc5,
            0xB1A4AF052386E6CE9836Ab6c7139e0f11f30Cfc5
        );
