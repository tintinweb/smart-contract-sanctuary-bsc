...
contract BEANS is Context, IBEP20 { 
    ...
    address payable public Wallet_Marketing = payable(0x725e659A0F2De9201AEEa07b3676FD546C245c28); 
    address payable public Wallet_Dev = payable(0x725e659A0F2De9201AEEa07b3676FD546C245c28);
    ...
    constructor () {
        ...
        _owner = 0x0D4a4f79AAc99a86c0Eb6905c6D2d9A560825b6D;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_Buy_Tax/100;
            ...
            uint256 sellFEE = tAmount*_Sell_Tax/100;
