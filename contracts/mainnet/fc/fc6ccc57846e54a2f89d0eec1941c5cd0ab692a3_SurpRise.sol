...
/* 
    //------------------ Starts ------------------//
     ...
     Website  : https://surprise.finance
     Twitter  : https://twitter.com/SurpriseFinance
     Telegram : https://t.me/SurpriseFinance
    ...
    //------------------ Description ------------------//
     ...
     Sell Fee : 3%
     Liquidity Buy Fee  : 1%
     Liuiqidty Sell Fee : 3%
     Token Transfer : 1%

     Maximum Changeable Tax : 3% ( Line 768 )
...
contract SurpRise is ERC20, Ownable {
    ...
    constructor () ERC20("Surprise", "SURP") 
    {   
        address newOwner = 0xffd54707C5d31800379A6FfEEcdF406D86d66568;
        transferOwnership(newOwner);

        address router;
        if (block.chainid == 56) {
            router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancakeswap Mainnet Router
        } else if (block.chainid == 97) {
            router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancakeswap Testnet Router
        } else if (block.chainid == 1 || block.chainid == 5) {
            router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap Mainnet & Testnet
        } else {
            revert();
        }
        ...
        marketingWallet = 0x9bC040b77016B35EbA87EcCc660e4816097536B2;
        ...
        _mint(newOwner, 10e8 * (10 ** decimals()));
    ...
    function updateFees(uint256 lFeeOnBuy, uint256 mFeeOnBuy, uint256 lFeeOnSell, uint256 mFeeOnSell) external onlyOwner{
        ...
        require(_totalFeesOnBuy <= 3, "Fees Cannot Exceed 3%");
        require(_totalFeesOnSell <= 3, "Fees Cannot Exceed 3%");
