...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37102d849E452Aea2F37d3a267CbB8C82f31EC17; // owner address
...
contract AnalDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anal Doge";
    string private _symbol = "AD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x135D6c8505EF51AfDB717DfC07Bfd35e26BD36Bb); // Marketing Address
    address payable public teamWalletAddress = payable(0x135D6c8505EF51AfDB717DfC07Bfd35e26BD36Bb); // Team Address
