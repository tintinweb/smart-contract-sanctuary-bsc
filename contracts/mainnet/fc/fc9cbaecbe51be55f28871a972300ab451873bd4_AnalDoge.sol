...
/**
 THE BIGGEST DOG ANUS IS HERE TO BE THE ANAL RULER 

 Let my anus grow and you will be surprised at what comes out of my ANUS above 1MILLION MARKET CAP
*/
...
contract AnalDoge is Context, IERC20, Ownable {
    ...
    string private _name = "AnalDoge";
    string private _symbol = "ANALD";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x275A1C49eA7D1a6e2eA622EFb796cfDEeb656C42);
