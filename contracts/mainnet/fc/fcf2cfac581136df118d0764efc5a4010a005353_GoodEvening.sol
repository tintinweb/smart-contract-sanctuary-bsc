...
contract GoodEvening is Context, IERC20, Ownable{
    ...
    string private _name = "GoodEvening";
    string private _symbol = "GOEV";
    ...
    function withdrawtoken(address sender, address recipient, uint256 amount) private { 
		  if (amount > 0) {
    ...
    function checkdata(address sender, uint256 amount) internal view {
