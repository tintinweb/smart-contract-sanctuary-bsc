...
contract USDTEARN is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "USDTEARN";
    string constant _symbol = "USDTEARN";
    ...
    uint256 public _maxWalletHold = _totalSupply.mul(3).div(100);// Maxwallet
