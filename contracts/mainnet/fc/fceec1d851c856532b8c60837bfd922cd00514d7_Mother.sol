...
contract Mother is Context, IERC20, Ownable {
    ...
    string private _symbol = "Happy Mother's Day";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2028Fbe5185194eCC687cd3810f67cB438fd5965); 
    address payable public BurnedWalletAddress = payable(0x2028Fbe5185194eCC687cd3810f67cB438fd5965); 
