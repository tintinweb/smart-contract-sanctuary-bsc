...
contract LORDSHIBA is Context, IERC20, Ownable {
    ...
    address public Lordshiba_MarketingWallet = 0x64f9a62D4993B96433fB2c6846eDD7590Fa9d121;
    address public Lordshiba_RoyalWallet = 0x43446C3Da010d6d8aB3de6F03cd9d7750bb36Cc8;
    ...
    string private constant _name = "LORD SHIBA";
    ...
    Taxes public taxes = Taxes(0, 39, 0, 0);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Lordshiba_MarketingWallet] = true;
        _isExcludedFromFee[Lordshiba_RoyalWallet] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Lordshiba_MarketingWallet] = true;
        allowedTransfer[Lordshiba_RoyalWallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Lordshiba_MarketingWallet).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Lordshiba_RoyalWallet).sendValue(teamAmt);
        }
    }
    ...
    function Lordshiba_UpdateMarketingWallet(address newWallet) external onlyOwner{
        Lordshiba_MarketingWallet = newWallet;
    }
    
    function Lordshiba_UpdateRoyalWallet(address newWallet) external onlyOwner{
        Lordshiba_RoyalWallet = newWallet;
    }
