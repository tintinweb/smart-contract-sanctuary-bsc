...
contract OPTIMUSPRIME is Context, IERC20, Ownable {
    ...
    string private _symbol = "OPTIMUSPRIME";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xcb20925fE6488CB56039EBa0221B1f06c0aB2542); // Marketing Address
    address payable public teamWalletAddress = payable(0xcb20925fE6488CB56039EBa0221B1f06c0aB2542); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xcb20925fE6488CB56039EBa0221B1f06c0aB2542),
            block.timestamp
        );
    }
