...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7CD228bEcc1C9579B41c5b5AEb9e9dc85d473cfB;
...
contract Koreanpop is Context, IERC20, Ownable { 
    ...
    address private _developmentWalletAddress = 0x9C0435A2F02E6C61e24dF43959874dbAe97790b9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 7000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "korean pop";
    string private _symbol = "kpop";
