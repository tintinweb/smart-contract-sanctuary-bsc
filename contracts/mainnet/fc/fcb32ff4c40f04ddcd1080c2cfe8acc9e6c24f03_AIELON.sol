...
contract AIELON is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xc5042A6eE536946c9eFc2b05aa4D749945945fA4;
    address public developmentAddress = 0xa3f2c1BeFbCeC493BcFC4C7381244e4A02059fB5;
    ...
    Taxes public sellTaxes = Taxes(0,2,76,2);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _development, uint256 _liquidity) public onlyOwner {
        taxes.rfi = _rfi;
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _development, uint256 _liquidity) public onlyOwner {
        sellTaxes.rfi = _rfi;
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi, to_return.rMarketing, to_return.rDevelopment, to_return.rLiquidity) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.tRfi-s.tMarketing-s.tDevelopment-s.tLiquidity;
        return s;
    }

    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi,uint256 rMarketing, uint256 rDevelopment, uint256 rLiquidity) {
        ...
        rTransferAmount =  rAmount-rRfi-rMarketing-rDevelopment-rLiquidity;
        return (rAmount, rTransferAmount, rRfi,rMarketing,rDevelopment,rLiquidity);
    }
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        uint256 denominator = (sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.development) * 2;
    ...
    function updateDevelopmentWallet(address newDevelopmentWallet) external onlyOwner{
        developmentAddress = newDevelopmentWallet;
    }
    ...
    // Owner cannot transfer out AI ELON from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out AI ELON!");
