...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf87b95630802Bc121DF3D8DFD4F09bfa271fe634;
...
contract ANGRYCROGETOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANGRY CROGE TOKEN"; // 
    string private constant _symbol = "$A-CROGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x4306399A14BA7704dF07f9E6E243654D9C0e29d9);
