...
contract VICTORIOUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VICTORIOUS";
    string private _symbol = "VICTORIOUS";
    ...
    uint256 public _maxTxAmount = 50 * 10**6 * 10**9; // max tx
    uint256 public _walletMax = 50 * 10**6 * 10**9; // max wallet
