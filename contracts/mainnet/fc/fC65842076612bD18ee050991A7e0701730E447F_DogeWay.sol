...
Telegram : https://t.me/Thedogeway
...
contract DogeWay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DogeWayDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DogeWay", "DOGEWAY") {
        marketingWallet = payable(0xfe43e07925c0eFE4D475ECa5585Ba85095478D41);
        devWallet = payable(0x1295ce857958377Ab9208e659626B98910e16148);
        ...
        dividendTracker = new DogeWayDividendTracker(
            payable(this),
            router,
...
contract DogeWayDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    DogeWay public DogeWayContract;
    ...
    constructor(
        ...
        defaultToken = token;
        DogeWayContract = DogeWay(mainContract);
    ...
    function _transfer(
        ...
        require(false, "DogeWay_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DogeWay_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DogeWay contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(DogeWayContract);

            uint256 prevBalance = DogeWayContract.balanceOf(address(this));
            ...
            {
                uint256 received = DogeWayContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    DogeWayContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
