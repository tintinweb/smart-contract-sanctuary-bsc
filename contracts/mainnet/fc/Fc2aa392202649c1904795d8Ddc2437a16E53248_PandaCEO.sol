...
contract PandaCEO is ERC20 {
	...
	address public _fundAddress = address(0x89707B78080b8e26CD75f92F3F8F284E94f2A441);
	address public _luckAddress = address(0xFfE06F280eF0f486A3540aF7a980b6aCbb07b2C8);
    ...
    constructor(address tokenOwner) ERC20("PandaCEO", "PandaCEO") {
	...
	uint256 public ldxRate = 0;
	uint256 public fundRate = 7;
    function changeRate(uint256 _ldxRate,uint256 _fundRate) public onlyOwner {
        ldxRate = _ldxRate;
		fundRate = _fundRate;
    }
	
	uint256 public oneTimeAmount = 25 * 10**22;
	uint256 public maxAmount = 25 * 10**22;
	...
	function changeSwapWarp(PandaCEOWarp _warp) public onlyOwner {
        warp = _warp;
