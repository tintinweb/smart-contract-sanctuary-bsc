...
contract sBNB is Context, IERC20, Ownable {
    ...
    string private _name = "Binance Smart Bonk";
    string private _symbol = "BNBonk";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x70D67559B9d0ACC16644E2912ed3B50c9827c487); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x70D67559B9d0ACC16644E2912ed3B50c9827c487); // Development Address
    ...
    uint256 private _totalSupply = 3000* 10**6 * 10**12;
