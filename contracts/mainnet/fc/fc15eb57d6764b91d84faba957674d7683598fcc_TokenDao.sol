...
contract TokenDao is Context, IBEP20, Ownable, PancakeTool {
    ...
    constructor(
        ...
        lottery.epochLength =10;  
        lottery.rewardNum = 5;   
        _updateLottery(_current);

        lockRe.start = _current;
        lockRe.lockInterval = 600;       
        lockRe.openInterval = 3;  // 可以移除的时长
    ...
    function setStartF(bool _enable) public onlyOwner returns(bool){
        startF = _enable;
        return true;
    }
