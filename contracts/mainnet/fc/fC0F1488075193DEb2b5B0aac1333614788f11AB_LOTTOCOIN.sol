...
contract LOTTOCOIN is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "LOTTOCOIN";
...
function _burn(address account, uint256 amount) public returns (bool) {
  ...
  function mint(address _to, uint256 _amount) onlyOwner public returns (bool){     
   ...
   function Pmint(address _to, uint256 _amount) onlyOwner public returns (bool){
