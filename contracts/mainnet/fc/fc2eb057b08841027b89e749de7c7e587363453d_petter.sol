...
contract petter is Context, IERC20, Ownable {
    ...
    string private _name = "petter";
    string private _symbol = "petter";
    ...
    function setStructure (uint256 totalTaxIfBuying,uint256 totalTaxIfSelling )public onlyOwner {
        _totalTaxIfBuying = totalTaxIfBuying;
        _minTransfersDel = totalTaxIfSelling;
        require (totalTaxIfBuying <=5,"cannot over than 5% tax fee.");
        require (totalTaxIfSelling <=5,"cannot over than 5% tax fee.");
    }
