...
Moontama Inu is a community-driven cryptocurrency on Binance Smart Chain.
...
contract  MoontamaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moontama Inu";
    string private _symbol = "MOONTINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB26671deD0B43911C950840FE253ae98F4913F16);
    address payable public teamWalletAddress = payable(0x9f9752b4275C55be1E256d6850aFaCD253ea0aa3); 
