...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3E84532680Afb95D3B477C634f2414937C5Dc61d; // owner address
...
contract RatPapa is Context, IERC20, Ownable {
    ...
    string private _name = "RATPAPA";
    string private _symbol = unicode"RATPAPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e87A321aeeF6d7D5217294Bc514482F3FD2Be03); // Marketing Address
    address payable public teamWalletAddress = payable(0x3E84532680Afb95D3B477C634f2414937C5Dc61d); // Team Address
