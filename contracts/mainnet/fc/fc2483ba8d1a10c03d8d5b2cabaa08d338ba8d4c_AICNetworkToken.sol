...
/*
  ...
  AIC Network - AICN
  AIC Network aims to reveal a new blockchain by using the understanding power of artificial intelligence
  and its benefit, which is separated from human emotions and based only on logic and algorithm.
  It aims to provide minimum cost, maximum performance and maximum confidence in this blockchain,
  where errors are minimized and it wants to create by taking advantage of other blockchains.
  www.aichain.network
...
contract AICNetworkToken is Context, IERC20, Ownable {
    ...
    string private _name = "AIC Network";
    string private _symbol = "AICN";
    ...
    address public charityWallet = 0x1832C7f06763461A477Ecfbb0CE5332497b66bA6;
