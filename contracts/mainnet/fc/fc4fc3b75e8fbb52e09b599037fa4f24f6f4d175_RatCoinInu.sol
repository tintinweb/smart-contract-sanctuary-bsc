...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢉⣉⡉⠉⠉⠉⠉⠉⠉⠉⠉⠛⠛⠿⢿⠿⠿⡿⠿⠿⡛⠉⠀⠀⠀⠀
   ...
   I make this #Rat Coin Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: Rat Coin  is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/NewRatCoin
...
I will lock the pool for 365 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..
   ...
   Can we make #Rat Coin Inu  1000X ?
*/
...
contract RatCoinInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rat Coin Inu";
