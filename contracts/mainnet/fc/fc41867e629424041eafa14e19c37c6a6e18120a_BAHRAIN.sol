...
/**
BAHRAIN SmartContract

https://t.me/Bahraincoin
...
contract BAHRAIN is ERC20, Ownable {
    ...
    BAHRAINDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HIDDEN GEM", "BAHRAIN") {
        marketingWallet = payable(0x384cA54F6436027926217d01D6e15Db556059a97);
        ...
        dividendTracker = new BAHRAINDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 20000; // 2%
        swapTokensAtAmount = totalTokenSupply / 5000; // 0.5%;
    ...
    function updateFees(
        ...
        require(totalSellFees <= 90 && totalBuyFees <= 90, "total fees cannot exceed 90% sell or buy");
...
contract BAHRAINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BAHRAIN public BAHRAINContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BAHRAINContract = BAHRAIN(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BAHRAIN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BAHRAIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BAHRAIN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BAHRAINContract);

            uint256 prevBalance = BAHRAINContract.balanceOf(address(this));
            ...
            {
                uint256 received = BAHRAINContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BAHRAINContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
