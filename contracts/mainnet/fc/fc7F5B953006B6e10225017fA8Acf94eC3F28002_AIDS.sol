...
contract AIDS is IBEP20, Auth {
    ...
    string constant _name = "DRAGONS WITH LAZERS INU";
    string constant _symbol = "ELON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 80) / 100; //1% 
    ...
    address private marketingFeeReceiver = 0x9A51d8A493F933215C197a0BCCca78f79207fD6c;
    address private developmentFeeReceiver = 0x9A51d8A493F933215C197a0BCCca78f79207fD6c;
