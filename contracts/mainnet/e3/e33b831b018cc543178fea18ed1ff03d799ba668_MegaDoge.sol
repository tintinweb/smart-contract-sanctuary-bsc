...
contract MegaDoge is MegaDogeDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MegaDogeTeam;
    address private CharityMegaDoge;
    ...
    string public override name = "MegaDoge";
    string public override symbol = "MegaDoge";
    ...
    constructor(uint totalSupplyValue, address MegaDogeTeamAddress, address CharityMegaDogeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MegaDogeTeam = MegaDogeTeamAddress;
        CharityMegaDoge = CharityMegaDogeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MegaDogeTeam] =  totalSupply * 4 / 100;
        balances[CharityMegaDoge] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's MegaDogeTeam pot
