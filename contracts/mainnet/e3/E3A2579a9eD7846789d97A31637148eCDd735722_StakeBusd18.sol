...
contract StakeBusd18 is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public constant min = 15 ether;
    uint256 public constant max = 15000 ether;
    uint256 public roi = 18;
    uint256 public constant fee = 10;
    uint256 public constant withdraw_fee = 8;
    uint256 public constant ref_fee = 16;
    ...
    function withdrawal() public noReentrant {
       ...
       uint256 aval_withdraw2 = SafeMath.mul(SafeMath.div(aval_withdraw,100),50); // aval_withdraw2 receives 50%
       uint256 aval_withdraw3 = SafeMath.mul(SafeMath.div(aval_withdraw,100),50); // aval_withdraw3 receives 50%
       ...
       approvedWithdrawal[msg.sender] = userWithdrawal(msg.sender,0); // Updated to 0 as the 50% available is re-invested
    
       //50% is re-invested without any tax.
