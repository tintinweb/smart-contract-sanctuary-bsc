...
contract GASGOLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GALA IS GOLD";
    string private _symbol = "GASGOLD";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x926A0C841ccC3E7A0198DAc7e9b75c54ac65BD29); // Marketing Address PF
    address payable public BuyBackWallet = payable(0x926A0C841ccC3E7A0198DAc7e9b75c54ac65BD29); // Team Address
