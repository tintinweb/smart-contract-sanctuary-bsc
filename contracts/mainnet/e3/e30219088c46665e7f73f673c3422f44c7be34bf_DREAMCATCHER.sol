...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x659D1a00eCC5bF09c7c16af2a40c79083efE07cb;
...
contract DREAMCATCHER is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Dream Catcher"; 
    string private constant _symbol = unicode"$DCatch"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x659D1a00eCC5bF09c7c16af2a40c79083efE07cb), BNB_Tot);
            }
