...
/*
    .d8888.  .d88b.  db    db d888888b d8888b.
    88'  YP .8P  Y8. 88    88   `88'   88  `8D
    `8bo.   88    88 88    88    88    88   88
      `Y8b. 88    88 88    88    88    88   88
    db   8D `8P  d8' 88b  d88   .88.   88  .8D
    `8888Y'  `Y88'Y8 ~Y8888P' Y888888P Y8888D'


    db    db d88888b d8888b. .d8888. d88888b   d888888b d8b   db db    db
    88    88 88'     88  `8D 88'  YP 88'         `88'   888o  88 88    88
    Y8    8P 88ooooo 88oobY' `8bo.   88ooooo      88    88V8o 88 88    88
    `8b  d8' 88~~~~~ 88`8b     `Y8b. 88~~~~~      88    88 V8o88 88    88
     `8bd8'  88.     88 `88. db   8D 88.         .88.   88  V888 88b  d88
       YP    Y88888P 88   YD `8888Y' Y88888P   Y888888P VP   V8P ~Y8888P'

    telegram      : https://t.me/SquidVerseInu
    twitter       : https://twitter.com/SquidVerseInu

    Squid Verse Inu will be listed on PancakeSwap (Stealth Launch). Let's stay tuned and be well-prepared for it.
...
contract SquidVerseInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Verse Inu"; //
    string private constant _symbol = "SVI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xBfe9A90f284B44Ce6C93dF69f98fA0E1c1c5a615;
