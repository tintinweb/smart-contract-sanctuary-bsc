...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x91D6AC1223d20291e27f31E954b109fB95ba6294; 
...
contract FourteenBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "14BNB";
    string private _symbol = "14BNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x91D6AC1223d20291e27f31E954b109fB95ba6294); 
    address payable public teamWalletAddress = payable(0xd94fc28e979c6804A07Fa4c830cED59530191A8A); 
