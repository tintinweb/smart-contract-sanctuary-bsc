...
contract UniDog is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA5f66b2189AA844E0CA426de76B9c28550B9750a;

    string private constant _name = "UniDog";
    string private constant _symbol = "UDOG";
    ...
    Taxes public taxes = Taxes(0, 4, 2);
    Taxes public sellTaxes = Taxes(0, 8, 4);
