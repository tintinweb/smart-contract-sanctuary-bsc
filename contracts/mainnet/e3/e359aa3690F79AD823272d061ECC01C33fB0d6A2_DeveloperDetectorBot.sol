...
//$DDB Bot helps you to follow up what dev do! Bot is LIVE 🔥 Easy to use
//🤖 DDB Functionality

//🔎Show which previous token deployments are related to the wallet
//🔎Dev Launch Alert System
//🔎You get a notification of dev buybacks, transfers from MW, transfers from developer wallet, etc
...
contract DeveloperDetectorBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DeveloperDetectorBot";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xcBE97BD033E6ac5cc5E812630d8f927e7e6A7Fe5));
        marketingWallet = payable(address(0x98C101e467F3f821bf4c7fe2C6a536FDDaC64955));
