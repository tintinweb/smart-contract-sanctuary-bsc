...
contract MarvinInuGrow is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 4_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x8A9EcD6Eb0FA83e9214e7598941cBDb63f262A9C;
    address public devAddress = 0x8A9EcD6Eb0FA83e9214e7598941cBDb63f262A9C;

    string private constant _name = "MarvinInuGrow";
    string private constant _symbol = "MarvinInuGrow";
    ...
    // Owner cannot transfer out MarvinInuGrow from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out MarvinInuGrow!");
