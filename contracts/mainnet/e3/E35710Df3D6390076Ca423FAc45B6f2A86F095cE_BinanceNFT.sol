...
contract BinanceNFT is ERC721Pausable, AccessControl, Ownable {
    ...
    function mintByZC(string memory _tokenURI) public returns (uint256 tokenId) {
        bool bol = ZCToken.transferFrom(msg.sender, 0x0000000000000000000000000000000000000001, 100000000000000000000);
    ...
    function updateZcAddress(address add) public onlyOwner {
        ZCTokenAddress = add;
        ZCToken = ERC20(ZCTokenAddress);
    }
