...
/*
Eleven Inu
Twitter: https://twitter.com/eleveninubsc
Telegram: https://t.me/eleveninuportal
*/
...
contract ElevenInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Eleven Inu";
    string private constant _symbol = "EVIN";
    ...
    address private marketingWallet = address(0xA65d6cD5Fc2304D6D273e49D71E79a964D168562);
    ...
    function setSellMultiplier(uint256 newLiquidityFee, uint256 newMarketingFee) public onlyOwner {
    ...
    function setMaxTx(uint256 newMaxTxPercent) public onlyOwner {
