...
// File contracts/Boardroom/BoardroomETH.sol
...
*/
contract BoardroomETH is ContractGuard {
    ...
    function initialize(IERC20 _token, IERC20 _share, ITreasury _treasury) public notInitialized {
        token = _token;
        share = _share;
        treasury = _treasury;
