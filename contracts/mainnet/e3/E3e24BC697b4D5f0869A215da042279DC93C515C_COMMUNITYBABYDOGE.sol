...
/**
IN CELEBRATION OF BABYDOGE 1 YEAR ANNIVERSARY ME BEING A EARLY BABY DOGE INVESTOR AND MAKING A KILLING
WANTS TO GIVE BACK TO THE BABYDOGE AND ALL COMMUNITIES.
I PRESENT TO YOU COMMUNITY BABYDOGE 
I WILL NOT BE MAKING A TG OR CHANNEL
I SUGGEST U MAKE ONE LIKE @COMMUNITYBABYDOGE

THE TAX IS 3% ALL GOIN TO LP ON BUYS AND 6% ALL GOING TO LP ON SELLS 
I WILL NOT KEEP TEAM TOKENS I WILL JUST BUY ON LAUNCH LIKE EVERYONE ELSE I REALLY DONT NEED TO GAIN ANYTHING FROM THIS 
MUCH LOVE,
BABYDOGE WHALE!

CONTRACT FULLY RENOUNCED AND LP BURNT!
*/
...
contract COMMUNITYBABYDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'COMMUNITY BABYDOGE';
    string private constant _symbol = 'COMMUNITY BABYDOGE';
