...
/**
           Join and help us on this mission : https://t.me/UkraineMetaVerse 🚀🇺🇦

          Website : https://ukrainemetaverse.site/

          Twitter : https://twitter.com/UkraineMetaVer1
*/
...
contract UKRAINEMETAVERSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UkraineMetaverse";
    string private _symbol = "MetaUkraine";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEF88342B3BA224d15084fCE1c6edfEF86f3A870D); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa452B59b84dEf1133a3eE4d9A171678B0C8718EC); // Team Address
