...
/**
Animals Token, a meme coin compiled by an experienced team,
and has a clear plan to get the targets that have been set.
JEET GET REKT
https://t.me/AnimaltokenBsc
ALWAYS BE DYOR
FUCK YOUR SNIPER T_T
*/
...
contract ANIMALSTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"AnimalsToken";
    string private _symbol = unicode"ATN";
    ...
    uint256 public _maxTxAmount = 450000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1700000 * 10**9; 
