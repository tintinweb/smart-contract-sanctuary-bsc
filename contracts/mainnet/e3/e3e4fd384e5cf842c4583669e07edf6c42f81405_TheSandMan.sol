...
/*
 * Netflix theme based Meme to break all BSC MEME's and degens and 
*  let's push Sandman to the MOON
 * After years of imprisonment, Morpheus — the King of Dreams — 
 * embarks on a journey across worlds to find what was stolen from him and restore his power.
 * https://t.me/thesandmanlaunch
 */
...
contract TheSandMan is Ownable, IERC20 {
    ...
    string private _name = "TheSandMan";
    string private _symbol = "SMan";
    uint256 public _decimals = 4;
    uint256 public _totalSupply =    100000000 * 10 ** _decimals;
    uint256 public _maxBuyAmount =      250000 * 10 ** _decimals;
    uint256 public _maxSellAmount =     250000 * 10 ** _decimals;
    uint256 public _BFee = 25;
    uint256 public _SFee = 25;
    address public constant _mWallet = 0x5A096d87fb48B90Ad823f17401d398E04Ec2d562;
