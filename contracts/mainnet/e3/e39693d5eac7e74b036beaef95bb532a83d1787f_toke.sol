...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x76BE199ef92Ce851F937eFbbAeDeb9B4e7ac04b3;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0x76BE199ef92Ce851F937eFbbAeDeb9B4e7ac04b3),//fund address
    
        address(0x76BE199ef92Ce851F937eFbbAeDeb9B4e7ac04b3)//dev address
    ){
