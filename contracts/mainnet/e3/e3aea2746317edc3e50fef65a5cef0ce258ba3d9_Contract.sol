...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C9f25558D6F210e3A6b982618D69b1ABDc537b9; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "9/12";
    string private _symbol = "9/12";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5C9f25558D6F210e3A6b982618D69b1ABDc537b9); // Marketing Address
    address payable public teamWalletAddress = payable(0x5C9f25558D6F210e3A6b982618D69b1ABDc537b9); // Team Address
    ...
    uint256 private _totalSupply = 912000 * 10**_decimals;
    uint256 public _maxTxAmount = 912000 * 10**_decimals;
    uint256 public _walletMax = 912000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 912000 * 10**9;
