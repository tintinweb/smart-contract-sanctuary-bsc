...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x91e9FACbd8DA2A451f44260b697AFf694Fa11D73;
...
contract JUSTCUBE is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Just Cube"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x91e9FACbd8DA2A451f44260b697AFf694Fa11D73), BNB_Tot);
            }
