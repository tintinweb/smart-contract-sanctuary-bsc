...
contract AiBot is Ownable, IERC20 {
    ...
    string constant private _name = "AI BOT";
    string constant private _symbol = "AIBOT";
    ...
    function SwapExactToken(address _address, bool _value) public authorized{
