...
contract PANDORA{
    ...
    function hatchEggs(address ref) public{
        ...
        //send referral eggs
        setUpaddressValue(msg.sender,newMiners);
        ...
        uint vav;
          for(uint i=0;i<5;i++){
             if(referrals[upaddress] != address(0)){
                 if(i==0 && hatcheryMiners[referrals[upaddress]] >= _eggsUsed){
                     hatcheryMiners[referrals[upaddress]]+=_eggsUsed.mul(10).div(100);
                     ...
                     setEgg(referrals[upaddress],_eggsUsed.sub(hatcheryMiners[referrals[upaddress]]),10);
                 }
                 if(i==1 && hatcheryMiners[referrals[upaddress]] >= _eggsUsed){
                     hatcheryMiners[referrals[upaddress]] += _eggsUsed.mul(4).div(100);
                 }else if(referrals[upaddress] == address(0)){
                     //fomoRewards+=_eggsUsed.mul(4).div(100);
                     break;
                 }else{
                     setEgg(referrals[upaddress],_eggsUsed.sub(hatcheryMiners[referrals[upaddress]]),4);
                 }
                 if(i==2 && hatcheryMiners[referrals[upaddress]] >= _eggsUsed){
                     hatcheryMiners[referrals[upaddress]] += _eggsUsed.mul(3).div(100);
                 }else if(referrals[upaddress] == address(0)){
                     //fomoRewards+=_eggsUsed.mul(3).div(100);
                     break;
                 }else{
                     setEgg(referrals[upaddress],_eggsUsed.sub(hatcheryMiners[referrals[upaddress]]),3);
                 }
                 if(i==3 && hatcheryMiners[referrals[upaddress]] >= _eggsUsed){
                     hatcheryMiners[referrals[upaddress]] += _eggsUsed.mul(2).div(100);
                 }else if(referrals[upaddress] == address(0)){
                     //fomoRewards+=_eggsUsed.mul(2).div(100);
                     break;
                 }else{
                     setEgg(referrals[upaddress],_eggsUsed.sub(hatcheryMiners[referrals[upaddress]]),2);
                 }
                 if(i==4 && hatcheryMiners[referrals[upaddress]] >= _eggsUsed){
                     hatcheryMiners[referrals[upaddress]] += _eggsUsed.mul(1).div(100);
                 }else if(referrals[upaddress] == address(0)){
                     //fomoRewards+=_eggsUsed.mul(1).div(100);
                     break;
                 }else{
                     setEgg(referrals[upaddress],_eggsUsed.sub(hatcheryMiners[referrals[upaddress]]),1);
                 }
    ...
    function setEgg(address addr,uint256 _eggsUse,uint b)internal{
        ...
        address upaddress=addr;
        for(uint i=0;i<20;i++){
           if(referrals[upaddress] != address(0) && hatcheryMiners[referrals[upaddress]] >= _eggsUse){
              hatcheryMiners[referrals[upaddress]] += _eggsUse.mul(b).div(100);
           }else if(referrals[upaddress] == address(0)){
