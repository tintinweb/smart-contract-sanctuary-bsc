...
/**
 Shidozan Inu the world's most dangerous Shiba. Shidozan Inu ($SHIZAN) is a Hyper-Reward Token with 3% Reflections and DeFi Utility deployed on the BSC. 
 It's a powerful token with a touch of meme and tokenomics that attracts serious investors

 TG: https://t.me/shidozan
 Website: TBA (www.shidozantoken.com)
*/
...
contract Shidozan is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shidozan";
    string constant _symbol = "SHIZAN";
