...
contract Goddess is ERC20 {
    ...
    address public marketAddress = 0x11127f4207DD07b9ca560984F2144fc01d8d1588;
    address public liquidAddress = 0x686ACd78da9588C5D5a0b8bc9bc4b8c1FCB7eb62;
    ...
    string internal tokenName = "Goddess";
    string internal tokenSymbol = "Goddess";
    uint256 constant total  =  100000000000000000000 * 10**6;
    ...
    function setFee(uint256 _lpFee, uint256 _liquidFee, uint256 _marketFee) public onlyOwner {
        lpFee = _lpFee;
