...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x4D0cC4786b383e2C7846bA994546B85954924802);
...
/* Token contract */
contract BabyLucro is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x4D0cC4786b383e2C7846bA994546B85954924802; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xcBA71eF890A4A0ca6CC8A9659AFf5BF3F877CB01;
    ...
    // Name and symbol
    string constant _name = "Baby Lucro";
    string constant _symbol = "$Baby Lucro";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 4% 
    ...
    uint256 public totalFeeSell = 90;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xcBA71eF890A4A0ca6CC8A9659AFf5BF3F877CB01;
