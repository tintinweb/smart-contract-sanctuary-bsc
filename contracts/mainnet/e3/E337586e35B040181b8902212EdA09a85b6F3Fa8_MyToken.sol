...
contract MyToken is ERC20, Ownable
{
    ...
    constructor () ERC20("CORDERO", "CRU")
    {
        ...
        wallet_a_fee_percentages.push(8); // Buy  fee 500 is 5.00%
        wallet_a_fee_percentages.push(8); // Sell fee 500 is 5.00%
        wallet_a_fee_percentages.push(8);  // Buy  fee 500 is  5.00%

        wallet_b_fee_percentages.push(12); // Buy  fee 1000 is 10.00%
        wallet_b_fee_percentages.push(12); // Sell fee 1500 is 15.00%
        wallet_b_fee_percentages.push(12);  // Buy  fee 500 is  5.00%

        wallet_c_fee_percentages.push(7); // Buy  fee 1000 is 10.00%
        wallet_c_fee_percentages.push(7); // Sell fee 1500 is 15.00%
        wallet_c_fee_percentages.push(7); // Buy  fee 500 is  5.00%

        wallet_d_fee_percentages.push(3); // Buy  fee 1000 is 10.00%
        wallet_d_fee_percentages.push(3); // Sell fee 1500 is 15.00%
        wallet_d_fee_percentages.push(3); // Buy  fee 500 is  5.00%
        // End edit
