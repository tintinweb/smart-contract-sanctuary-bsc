...
contract ValentineShiba is BEP20, Auth {
    ...
    string public constant  name = "ValentineShiba"; 
    string public constant symbol = "$VHIB";
    ...
    uint256 public liquidityFee = 10; //1% liquidityfee
    uint256 public marketingFee = 90; //9% marketingfee
    ...
    function update_fees() internal {
            ...
            require(totalFee.mul(buyMultiplier).div(100) <= 1000, "Buy tax cannot be more than 100%");
            require(totalFee.mul(sellMultiplier).div(100) <= 1000, "Sell tax cannot be more than 100%");
