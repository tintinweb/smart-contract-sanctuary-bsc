...
contract FreMiner is ReentrancyGuard {
    ...
    address private _freaddr = address(0xAcB380b6514d1981221b6F1e5507380608cD7079);
    address private _fretrade = address(0xC4cBa0A0fAEBD956674B1A3F1dEfcb4fa272A58f);
    ...
    uint256[8] _vipbuyprice = [0, 50, 100, 200, 300, 400, 500, 600];
