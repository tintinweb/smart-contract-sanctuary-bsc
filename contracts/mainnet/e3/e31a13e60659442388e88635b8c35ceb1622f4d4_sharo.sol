...
contract sharo is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "sharo: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
...
contract sharoDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("sharo_Dividend_Tracker", "sharo_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "sharo_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
