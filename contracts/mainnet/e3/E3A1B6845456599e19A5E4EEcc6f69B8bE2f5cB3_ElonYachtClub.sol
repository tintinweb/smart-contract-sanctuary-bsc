...
contract ElonYachtClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Yacht Club";
    string private _symbol = "$ELONYACHTCLUB";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xE2DdD0810Aab56534809Bed0E7b09C0Dfa8BDA59);
