...
contract MuuMeowInu is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;
  string private _name = "Muu Meow Inu";
  string private _symbol = "$MUUMEOWINU";
  uint8 private _decimals = 9;
  address payable public marketingWalletAddress = payable(0x7f9c4e28b0c0B487D7Ea8b1C3881642653749125); // Marketing Address
  address payable public DevelopmentWalletAddress = payable(0x7f9c4e28b0c0B487D7Ea8b1C3881642653749125); // Development Address
