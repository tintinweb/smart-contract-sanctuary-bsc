...
contract Dontbetheclown is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dont be the clown on the clown car!";
    string private constant _symbol = "Dont be the clown";
    ...
    uint256 public swapTokenAtAmount = 350000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x3e4ee3B108aa254Ce88621aa385B9b448834d38b);
    address private liquidityReceiver = address(0x3e4ee3B108aa254Ce88621aa385B9b448834d38b);
