...
// PROJECT TG: https://t.me/helpingshiba

// CONTRACT DEVELOPED BY: https://t.me/AnoopSafuDeveloper (https://t.me/legitlaunchbsctokens - Known Developer in the space with more than 100+ SAFU Launches)
...
library Address{
 ...
 contract HELPINGSHIBA is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_000_000 * 10**9; // 0.1%
    uint256 public maxBuyLimit = 5_000_000 * 10**9; // 0.5%
    uint256 public maxSellLimit = 5_000_000 * 10**9; // 0.5%
    uint256 public maxWalletLimit = 5_000_000 * 10**9; // 0.5%
    
    uint256 public genesis_block;

    address public marketingWallet = 0xa5221fd31465Eef07a5854Dd052F9808143aef5C;
    address public donationWallet = 0x9aE5155F69Bc6070b89dDF5aD3f32Cf8E982A1F5;

    string private constant _name = "Helping Shiba";
    string private constant _symbol = "HEBA";
    ...
    Taxes public taxes = Taxes(1, 2, 5, 4);
    Taxes public sellTaxes = Taxes(1, 2, 5, 4);
