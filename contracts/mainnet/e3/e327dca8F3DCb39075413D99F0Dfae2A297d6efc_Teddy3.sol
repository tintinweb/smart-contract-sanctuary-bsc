...
contract Teddy3 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint amount) internal virtual {
        ...
        if ( ( DEXs[sender] || DEXs[recipient] ) &&
            ...
            // sale and buy rate 2%
            _balances[taxAddress] += amount * 2 / 100;
            emit Transfer(sender, taxAddress, amount * 2 / 100);
            uint256 onePercent=amount * 1 / 100;
            // fluxility  1%
            _balances[address(this)] += onePercent;
            emit Transfer(sender, address(this), onePercent);
            // burn 1%
            _burn(sender, onePercent);
