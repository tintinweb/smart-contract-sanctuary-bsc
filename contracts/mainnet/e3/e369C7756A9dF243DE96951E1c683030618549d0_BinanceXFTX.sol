...
contract BinanceXFTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binance X FTX ";
    string private _symbol = "BINANCEXFTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2E994C6511E61DBF515Beb3749a7F99A34Fe787);
    address payable public teamWalletAddress = payable(0xA2E994C6511E61DBF515Beb3749a7F99A34Fe787);
