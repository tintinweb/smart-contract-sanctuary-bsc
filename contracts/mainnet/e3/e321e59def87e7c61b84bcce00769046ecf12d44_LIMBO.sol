...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEB2147406028547a246EBDA07f2e96D5E6982eC6;
...
contract LIMBO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x38035846Ea5044Bb87067e48a5a86238Ac39Ad70;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Limbo Token";
    string private _symbol = "LIM";
