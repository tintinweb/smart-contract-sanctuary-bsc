...
//
//
//Free Ukraine token will use es a utility token, and a vote token, 
//     in the site FreeUkraine.tech JOIN US 
// 
...
//
//       o those who can hear me,
//            I say - do not despair.
//                The misery that is now upon us
//                    is but the passing of greed - the bitterness of men
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA8Ad30e687182E70c6040Da5A28a9DA558817D35;
...
contract FREEUKRAINE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3C277066618aAc8f1393bbc4DBC802b37c1CA5D2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Stop War Free Ukraine";
    string private _symbol = "FREEUKRAINE";
