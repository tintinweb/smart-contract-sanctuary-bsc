...
contract VRFManager is Ownable, VRFConsumerBase, IVRFManager {
    ...
    uint256 public chainlinkFee = 0.0001 ether;

    uint256 public maxBetsPerVRF = 15;
    ...
    uint256 public nextReqBlocks = 9;
    ...
    function setMaxBetsPerVRF(uint256 _maxBetsPerVRF) external onlyOwner {
        maxBetsPerVRF = _maxBetsPerVRF;
    }

    function setNextReqBlocks(uint256 _nextReqBlocks) external onlyOwner {
