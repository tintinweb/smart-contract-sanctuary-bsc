...
contract TWINKLE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9DB7f25B93bf137F65251DD3D7163da3846816a7); // Marketing Address

    address payable public StakeAddress =
        payable(0xC798837FC9A25c3490dD045e62Af02C6964b0244); //  Development Address

    address payable public liquidityAddress =
        payable(0x35aAF5fFd69CF528dA73A1E8A4b7BB9BC4a45b2c); // Liquidity Address
    ...
    string private constant _name = "TWINKLE";
    string private constant _symbol = "TWNKL";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 30 / 1000; // 2% maxWalletToken
