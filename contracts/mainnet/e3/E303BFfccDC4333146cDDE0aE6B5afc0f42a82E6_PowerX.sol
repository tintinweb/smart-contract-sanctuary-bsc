...
contract PowerX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2000000 * 10**6 * 10**9;
    ...
    string private constant _name = "Power X";
    string private constant _symbol = "PWX";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x6593dB753Fe6630F55285f5D7eFEee95C57f4A2f);
    address payable private _marketingAddress = payable(0xaBca25FbBA20D2d74Bd10b2B5425C531ffa77872);
