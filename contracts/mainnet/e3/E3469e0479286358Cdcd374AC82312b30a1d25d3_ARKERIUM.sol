...
=== 'ARKERIUM' Token contract with following features ===
    => BEP20 Compliance
...
contract ARKERIUM is owned {
    
    using SafeMath for uint256;

    string constant private _name = "ARKERIUM";
    string constant private _symbol = "ARKM";
