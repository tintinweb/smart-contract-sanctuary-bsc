...
contract WorldCupSanta is Context, IERC20, Ownable {
    ...
    string private constant _name = " World Cup Santa "; // 
    string private constant _symbol = " $WCSanta "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x92DC72d7C029B9Af6fc28f0F5d31bdb768dE49eA;
