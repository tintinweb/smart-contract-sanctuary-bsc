...
contract HareGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hare Gold";
    string private _symbol = "HareGold";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe2b4b9f76411Ccb579315f75a5Eda949a3C93Cf);
    address payable public BuyBackWalletAddress = payable(0xEe2b4b9f76411Ccb579315f75a5Eda949a3C93Cf);
