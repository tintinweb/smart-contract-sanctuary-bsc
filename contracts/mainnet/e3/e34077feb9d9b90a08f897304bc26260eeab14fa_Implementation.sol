...
contract BSCPresale is Owned  {
   ...
   bool public isSuccess = false;
    ...
    address payable public fundReciever = 0xdFa5e2D210a9a34eE3288E98852085bc5f01ECdd;
...
function contribute(uint256 buyamount) public payable{
  ...
  function claimTokens() public{
    ...
    function finalizeSale() public onlyOwner{
        ...
        ownerAddress = payable(IPresaleProxy(PROXY).getfundReciever());
        uint256 feeAmount = earnedCap.mul(fee).div(100);

        // set tokenpereth
            if(LaunchpadType){
            tokenRatePerEth = earnedCap / hardCap; 
            }
