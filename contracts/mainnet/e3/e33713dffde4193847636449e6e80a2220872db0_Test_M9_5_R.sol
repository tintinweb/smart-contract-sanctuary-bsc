...
//////
 ...
 //bool public activTORSREF_REWARD;//bool activate
	...
	struct User {
       ...
       bool  activTORSREF_REWARD1;
       bool  activTORSREF_REWARD2;
       bool  activTORSREF_REWARD3;
...
*/
 	...
 	function getUserDiv(address userAddress) public view returns (bool) {
		User storage user = users[userAddress];
...
if(users[msg.sender].levels[0] >=1  )
{
...
{user.activTORSREF_REWARD == false;}
 	...
 	function getUserDiv1(address userAddress) public view returns (bool) {
		User storage user = users[userAddress];
//user.deposits[index].start
...
if(users[msg.sender].levels[0] <=1  )
{
    user.activTORSREF_REWARD1 == true;
}
else 
{user.activTORSREF_REWARD1 == false;}

		return user.activTORSREF_REWARD1;
	}



     	function getUserDiv2(address userAddress) public view returns (bool) {
		User storage user = users[userAddress];
//user.deposits[index].start
...
if(users[msg.sender].checkpoint <= user.checkpointLVR1RefBonus  )
{
    user.activTORSREF_REWARD2 == true;
}
else 
{user.activTORSREF_REWARD2 == false;}

		return user.activTORSREF_REWARD2;
	}

     	function getUserDiv3(address userAddress) public view returns (bool) {
		User storage user = users[userAddress];
//user.deposits[index].start
...
if(users[msg.sender].checkpoint >= user.checkpointLVR1RefBonus  )
{
    user.activTORSREF_REWARD3 == true;
}
else 
{user.activTORSREF_REWARD3 == false;}

		return user.activTORSREF_REWARD3;
	}
