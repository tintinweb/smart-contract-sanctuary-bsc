...
contract CateGrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xD5513a40d91B61ADB46E1aBE1eEdEC215237Ff3e;
    address public devWallet = 0x7c6f0C6e1143FEc721209c341322077Ba1DEa7b9; 
    ...
    string private constant _name = "CateCoinGrow";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 1, 0, 0); // 8%
    Taxes public sellTaxes = Taxes(0, 10, 2, 0, 0, 0);// 15%
