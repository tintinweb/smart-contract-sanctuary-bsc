...
contract presale {
    ...
    IERC20 public MXST = IERC20(0x2BB7De3e633293F03760aaF087b7823751a4C9B4); //mainnet address
    IERC20 public BUSD = IERC20(0x55d398326f99059fF775485246999027B3197955); //Busd ddress
    ...
    constructor() {
        owner = payable(0x5E4Cf6aCe91F797cdbD277f6773d8a1EFb029530);
        // mainnet BSC
    ...
    function getArrLength() public view returns (uint256 _length) {
        _length = uniqueTokenAddress.length;
    }
