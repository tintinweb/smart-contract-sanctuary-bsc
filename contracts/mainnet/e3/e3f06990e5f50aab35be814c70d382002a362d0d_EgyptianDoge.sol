...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x70286a1EaFC66fc76991bD6862BDaAc3be456802; // owner address
...
contract EgyptianDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Egyptian Doge";
    string private _symbol = "ED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6eb11e6cC4183279dCB61F1E81B40e12171d6D25); // Marketing Address
    address payable public teamWalletAddress = payable(0xc836724F0D646a50c2eeCFeFCE2321C23D07ad06); // Team Address
