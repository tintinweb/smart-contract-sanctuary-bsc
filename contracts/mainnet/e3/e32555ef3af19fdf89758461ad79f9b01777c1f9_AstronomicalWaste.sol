...
/**
Welcome to AW. Together we will celebrate!
Join the TG https://t.me/astronomicalwaste
...
contract AstronomicalWaste is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AstronomicalWaste";
