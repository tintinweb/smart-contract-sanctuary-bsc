...
contract KITOS is IERC20 {
    string public name = "KITOS";
    string public symbol = "KTO";
     ...
     */
    constructor() {
        balance[msg.sender] = 1000000000 * (10**9);
        owner = msg.sender;
    ...
    function _approve(address own, address spender, uint256 amount) private {
        require(own != address(0), "ERROR: Approve from the zero address.");
        require(spender != address(0), "ERROR: Approve to the zero address.");

        allow[own][spender] = amount;
    ...
    function transferFrom(
        ...
        uint256 currentAllowance = allow[_from][msg.sender];
        require(currentAllowance >= _value, "ERROR: Transfer amount exceeds allowance.");
