...
contract FireHelp {
    ...
    address private constant ApeSwapROUTER = 0x8317c460C22A9958c27b4B6403b98d2Ef4E2ad32;  
    ...
    function GetAmountOut(address tokenAddress, address routerAddress) public view returns (uint256) {
        
        address[] memory swapPath = new address[](2);
        swapPath[0] = WBNB;
        swapPath[1] = tokenAddress;

        return ISwapRouter(routerAddress).getAmountsOut(1 ether, swapPath)[1];
    }
