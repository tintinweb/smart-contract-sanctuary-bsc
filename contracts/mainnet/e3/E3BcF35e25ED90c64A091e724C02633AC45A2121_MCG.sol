...
contract MCG is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MCGREEN";
    ...
    uint256 _totalSupply = 1000001 * (10 ** _decimals);
    ...
    uint256 public marketingFee = 95;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x445c6d4ac43617433e0F4aa5D65a1FBD68B3D66c;
