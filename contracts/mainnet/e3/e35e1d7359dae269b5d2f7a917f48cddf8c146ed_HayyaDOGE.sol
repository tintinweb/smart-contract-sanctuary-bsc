...
contract HayyaDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08C49696108cf345Ae5b0BdB235fad1699d4A40B); 
    address payable public Wallet_Dev = payable(0x08C49696108cf345Ae5b0BdB235fad1699d4A40B);
    ...
    string private constant _name = "Hayya Doge"; 
    string private constant _symbol = unicode"HAYDOGE"; 
    ...
    constructor () {
        ...
        _owner = 0x08C49696108cf345Ae5b0BdB235fad1699d4A40B;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _burning / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _liquidity / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_liquidity + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_liquidity + Percent_Marketing + Percent_Dev);
