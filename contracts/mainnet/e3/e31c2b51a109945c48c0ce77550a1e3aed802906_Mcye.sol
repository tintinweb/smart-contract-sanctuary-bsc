...
// CHANGE
contract Mcye is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "McYe";
    string constant _symbol = "$MCYE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 0.5% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 1% MAX 300,000
