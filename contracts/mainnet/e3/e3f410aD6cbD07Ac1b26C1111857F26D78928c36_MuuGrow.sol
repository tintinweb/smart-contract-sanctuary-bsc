...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8); //the reward token you want distributed 
...
contract MuuGrow is IBEP20, Auth {
    ...
    address MATIC = 0xEA5E9F39F4B4Bc2684e49A0E43127F7f6F6be3b8; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MuuGrow";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "MOW";
