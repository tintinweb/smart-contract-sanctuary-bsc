...
contract TIGER is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xF1b2dC2C41edCF8170B03176b7D3167EDA3d7611));
        marketingWalletAddress = payable(address(0xF1b2dC2C41edCF8170B03176b7D3167EDA3d7611));
