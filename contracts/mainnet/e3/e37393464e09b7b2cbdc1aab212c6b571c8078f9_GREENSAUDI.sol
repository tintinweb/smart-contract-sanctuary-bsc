...
Saudi National Team
GREEN SAUDI
https://twitter.com/hashtag/GreenFalcons
Saudi National Team
@SaudiNT_EN
The official account of Saudi Arabia national football team Fan TOKEN
@SaudiNT
...
contract GREENSAUDI is Context, GREENSAUDIECO, Ownable {
    ...
    string private _name = 'Saudi National Team';
    string private _symbol = unicode'الأخضرالسعودي';
