...
contract GreatDaneSquid is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "GreatDane Squid";

    string private _symbol = "GreatDane Squid";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x0816D00E39D55384671BF642d677282b37f4141A;
