...
library Address{
 ...
 contract AIBUNNY is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x4D3D30485B582172514274fcB1e3B9AB4f6B5c3a;
    address public donationWallet = 0x4D3D30485B582172514274fcB1e3B9AB4f6B5c3a;

    string private constant _name = "AI BUNNY";
    string private constant _symbol = "AIBUNNY";
    ...
    Taxes public taxes = Taxes(1, 12, 1, 1);
    Taxes public sellTaxes = Taxes(1, 12, 1, 1);
