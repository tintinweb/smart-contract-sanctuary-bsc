...
contract HackerToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hacker";
    string private _symbol = "Hacker";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5D16858660ccDD0952BbC959476FfE12c2Ef12E3);
    address payable public teamWalletAddress = payable(0x0454F48A000c1B6942D003C9337f1409D43d3BBe);
