...
abstract contract baseToken is IERC20, Ownable {
    ...
    uint256 public _sellLPDividendFee = 5;
    uint256 public _sellMakingFee = 5;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 fundAmount = BNBBalance * (_buyMarketingFee + _sellMakingFee) / totalFee;
...
contract Token is baseToken {
    constructor() baseToken(
        ...
        address(0x1f0DCf933412f5A8177219c654B20C469f66f35e),
        "\u72ec\u884c\u6708\u7403",
        "\u72ec\u884c\u6708\u7403",
        9,
        1 * 10 ** 15
