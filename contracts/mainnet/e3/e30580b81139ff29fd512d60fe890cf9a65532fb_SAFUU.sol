...
library SAFUUeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SAFUUeMath: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SAFUUeMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SAFUUeMath: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SAFUUeMath: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "SAFUUeMath: modulo by zero");
    }
...
contract SAFUU is Context, IBEP1SAFUU, Ownable {
    using SAFUUeMath for uint256;
    ...
    string private _name = 'SAFUU DAO';
    string private _symbol = 'SAFUU DAO';
