...
contract YQDAO is Ownable {
 ...
 ///////////////////////////////// constant /////////////////////////////////
    ...
    //config
    uint public _invite1 = 25;
    uint public _invite2 = 15;
    uint public _invite3 = 10;
    uint public _invite4 = 10;
    ...
    function setInvite1(uint _value) external onlyOwner {
        _invite1 = _value;
    }

    function setInvite2(uint _value) external onlyOwner {
        _invite2 = _value;
    }

    function setInvite3(uint _value) external onlyOwner {
        _invite3 = _value;
    }

    function setInvite4(uint _value) external onlyOwner {
        _invite4 = _value;
    }
    ...
    function Oxfm2t198b97(address _inviteAddr1,address _inviteAddr2,address _inviteAddr3,uint _type) external payable {
        ...
        IERC20(WETH_ADDRESS).safeTransfer(MARKET_ADDRESS, payAmount);
    ...
    function inviteAllocation(uint payAmount, uint _amount, address _inviteAddr, uint _inviteNum, uint _type)internal returns (uint) {
        ...
        IERC20(WETH_ADDRESS).safeTransfer(_inviteAddr, _inviteAddrAmount);
    ...
    function mintNFT(uint _type)external{
