...
| ▓▓  \▓▓\ ▓▓      \▓▓    ▓▓ ▓▓    ▓▓  \▓▓  ▓▓\▓▓    ▓▓
 ...
 Official Telegram : https://t.me/KryptoSuperDogVerify
 Website :  https://kryptosuperdog.org/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Kryptosuperdog is Context , IERC20, Ownable {
    ...
    string private _name = "Krypto Super Dog";
    ...
    uint256 public _liquidityFee = 1; // 5% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 0;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _devFee = 5;  // 5% to marketing fee
    address public devWallet = 0x1E9Cf63e6fE11F809B745D2784Ab1cbEDBF28384; // development wallet
    ...
    uint256 public _maxTxAmount = 3 * 10**9 * 10**9; //3% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 6 * 10**9 * 10**9; //6% of total supply
