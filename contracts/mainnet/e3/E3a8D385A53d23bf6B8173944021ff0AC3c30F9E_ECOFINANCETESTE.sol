...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant DOGE = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //DOGE
...
contract ECOFINANCETESTE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private constant DOGE = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //DOGE

    uint256 public swapTokensAtAmount = 2 * 10**5 * (10**9);
    uint256 public maxTxAmount = 75 * 10**9  * 10**9;
    
    mapping(address => bool) public _isBlacklisted;

    uint8 public DOGERewardsFee = 14;
    
    uint8 public marketingFee = 5;
    uint16 public totalFees = DOGERewardsFee  + marketingFee;

    address public _marketingWallet = address(0xF0A39782c83FCAc5672Ba3d48fEd22D823d59c29); 
    ...
    constructor() ERC20("ECO FINANCE TESTE", "ECOFTESTE") {
        ...
        */
        _mint(owner(), 75 * 10**9 * (10**9)); //75000000000 Tokens
