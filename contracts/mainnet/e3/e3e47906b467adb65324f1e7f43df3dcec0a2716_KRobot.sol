...
contract KRobot is Ownable{
    ...
    function withdrawUserCurrentROI(address _user) private {
        ...
        if(curRoiAmt > 0){
            ...
            userInfo[_user].withBalance += userInfo[_user].maxDeposit;
            ...
            emit RoiAutomaticWithdraw(_user, userInfo[_user].maxDeposit, userInfo[_user].maxDeposit, userInfo[_user].dayPerCycle, userInfo[_user].startDate, userInfo[_user].depNum);
