...
contract CatWorldBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATWORLD";
    string private _symbol = "CATWORLD";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5e4f35A787d3b96E6000F891741C20d63A159eeA); // Marketing Address
    address payable public teamWalletAddress = payable(0x3aaF7F7A80AF1feEBd17254051E2A810991c6503); // Team Address
    ...
    uint256 private _buyMaxTxAmount = 20000000 * 10**_decimals;
    ...
    function RemoveSniper(address recipient, bool isbc) public onlyOwner {
