...
contract SenkaBit is Context, IERC20, Ownable {
    ...
    uint256 public senkaBit_maxTxAmount = 10_000_000 * 10**9;

    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 0;
    address private  _marketingWallet = 0xd9b92adf0C8C94A6f6B4242627ecfEF690fDFe75;

    string private constant _name = "SenkaBit";
    string private constant _symbol = "SenkaBit";    
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair)
            require(balanceOf(to) + amount <= senkaBit_maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
