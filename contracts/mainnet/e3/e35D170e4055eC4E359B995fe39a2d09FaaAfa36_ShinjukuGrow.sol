...
contract ShinjukuGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinjuku Grow";
    string private constant _symbol = "SHINJUKU";
