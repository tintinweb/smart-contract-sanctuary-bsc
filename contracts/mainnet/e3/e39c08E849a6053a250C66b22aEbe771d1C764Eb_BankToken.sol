 ...
 */
contract BankToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "Bank Token";
    ...
    uint256 public SEND_REWARD = 10; // 1%
    uint256 public RECV_CHARGE = 20; // 2%
    uint256 public BUY_RATE = 10; // 1%
    uint256 public SELL_RATE = 20; // 2%
    uint256 public RFLX_RATE = 600; // 60% of (charge - reward)
    uint256 public BURN_RATE = 200; // 20% of (charge - reward)
    uint256 public CMTY_RATE = 200; // 20% of (charge - reward)
