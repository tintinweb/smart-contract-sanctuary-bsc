...
import "./interfaces/IIDOV2Primary.sol";
...
contract IDOV2Primary is IIDOV2Primary, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint public estimatedTotalRaiseInBuyToken;
    ...
    /// @notice Ask for unique seed and setup allocations. Only admin can call this function
    /// @param _openRoundMaxAllocationInBuyToken New open round allocation
    /// @param _allocationPerTicketInBuyToken New allocation per ticket
    function requestSeed(uint _openRoundMaxAllocationInBuyToken, uint _allocationPerTicketInBuyToken) external override onlyRole(DEFAULT_ADMIN_ROLE) nonReentrant {
...
interface IIDOV2Primary {
    ...
    function requestSeed(uint, uint) external;
