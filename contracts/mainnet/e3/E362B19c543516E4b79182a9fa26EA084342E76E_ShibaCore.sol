...
Shiba Core is the Core of the future shiba token and will bring new hype 

Developed by an expert dev and secure contract will make this token fly to the moon 
Telegram: https://t.me/ShibaCoreGlobal
...
contract ShibaCore is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Core"; // 
    string private constant _symbol = "SC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xa0042d723ed371f888C3729f1D3434106a2Dc3Ce;
