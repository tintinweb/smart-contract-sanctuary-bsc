...
contract binlang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "binlang";
    string private _symbol = "binlang";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x9624a6A8dA69d5e4f8d0835B1f1F5bF8D3030E0E);
    address payable public teamWalletAddress = payable(0x9624a6A8dA69d5e4f8d0835B1f1F5bF8D3030E0E);
