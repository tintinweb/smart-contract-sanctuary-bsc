...
contract CCPC is IBEP20, Auth {
    ...
    string constant _name = "CryptoCloud";
    string constant _symbol = "CCPC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 20000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x342E24c61B6bc5D5B71FBdfa8Fe64571849c1ABf;
