...
contract LinkedInu is Context, IERC20, Ownable {
    ...
    string private _name = "LinkedInu";
    string private _symbol = "LinkedInu";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x31f0e2826a929ecb7FdCE099dDa053F6A0081145); // Marketing
    address payable public BuyBackWalletAddress = payable(0xD75ab9e5b181A2209d70A98985310EA5DD3261Df); // BuyBack 
