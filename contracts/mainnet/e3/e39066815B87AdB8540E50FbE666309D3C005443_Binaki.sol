...
contract Binaki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Binaki"; // 
    string private constant _symbol = "Binaki"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xFDc2B1e8caDD9Ac64ff1ACcB5e00aC085935737C;
