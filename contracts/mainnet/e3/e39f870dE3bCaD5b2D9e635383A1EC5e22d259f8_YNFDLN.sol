...
contract YNFDLN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YNFDLN";
    string private _symbol = "YNFDLN";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x6AAD8CFE429908AaFE2A545dAa03FA311BE285D6);
