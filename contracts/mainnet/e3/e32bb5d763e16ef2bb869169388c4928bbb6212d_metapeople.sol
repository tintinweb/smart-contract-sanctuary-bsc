...
contract metapeople is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Meta people";
    string private _symbol = "Metapeople";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x661036bd17620bdd196b2ffcD73E90B18E499935);
