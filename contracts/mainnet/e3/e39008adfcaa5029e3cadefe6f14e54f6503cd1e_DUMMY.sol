...
contract DUMMY is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 1e9; // 100 m total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DUMMY"; // token name
    string private _symbol = "$DUMB"; // token ticker
    ...
    uint256 public maxHoldingAmount = 1000000 * 1e9;
    uint256 public maxBuyLimit = 250000 * 1e9;
    ...
    uint256 public liquidityFeeOnBuying = 40;
