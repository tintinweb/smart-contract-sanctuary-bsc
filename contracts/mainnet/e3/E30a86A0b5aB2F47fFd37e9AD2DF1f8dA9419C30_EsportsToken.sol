...
// File contracts/metaverse/AntiBotHelper.sol
...
// File contracts/metaverse/FeeHelper.sol
...
contract FeeHelper is Ownable {
    ...
    constructor() {
        ...
        _tokenFees[TX_CASE.TRANSFER].donationFee = 0;
        _tokenFees[TX_CASE.TRANSFER].burnFee = 0;

        _tokenFees[TX_CASE.BUY].marketingFee = 800;
        _tokenFees[TX_CASE.TRANSFER].donationFee = 50;
     ...
     * @param marketingFee: fee percent for donating
        ...
        returns (bool feeApplied, TX_CASE txCase)
    {
        ...
        // Buying tokens
            ...
            feeApplied =
                (buyFee.marketingFee + buyFee.donationFee + buyFee.burnFee) > 0;
            txCase = TX_CASE.BUY;
        }
        // Selling tokens
            ...
            feeApplied =
                (sellFee.marketingFee + sellFee.donationFee + sellFee.burnFee) >
                0;
            txCase = TX_CASE.SELL;
        }
        // Transferring tokens
...
// File contracts/metaverse/EsportToken.sol
...
contract EsportsToken is AntiBotHelper, FeeHelper, ERC20, Operatable {
    ...
    function viewDonationWallet() external view returns (address) {
    ...
    function _tokenTransfer(
        ...
        if (feeApplied) {
            ...
            uint16 donationFee = _tokenFees[txCase].donationFee;
            uint16 burnFee = _tokenFees[txCase].burnFee;

            uint256 burnFeeAmount = (amount * burnFee) / 10000;
            uint256 donationFeeAmount = (amount * donationFee) / 10000;
            ...
            if (donationFeeAmount > 0) {
                super._transfer(sender, _donationWallet, donationFeeAmount);
                amount -= donationFeeAmount;
            }
