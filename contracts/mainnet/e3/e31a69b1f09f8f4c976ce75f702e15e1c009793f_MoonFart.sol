...
contract MoonFart is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public _name = "MOON FART";
    string constant public _symbol = "FART";
    ...
    constructor (
        ...
        marketingFeeReceiver = 0x2A347FF59239D185fe5782795933dfC2F4c9be12;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!isTxLimitExempt[sender] && !isTxLimitExempt[recipient]){
            ...
            if (recipient != pair) {
                    ...
                    require(contractBalanceRecepient + (amount-((amount*totalFee)/feeDenominator)) <= _maxWalletAmount,
    ...
    function PaybackTime(uint256 amount) external authorized {
 ...
 //   }
    ...
    function TransferBNBfromContract(uint256 amount, address payable receiver) external authorized {
        uint256 contractBalance = address(this).balance;
        require(contractBalance > amount,"Insufficient BNB");
