...
*
WELCOME TO OGSHIB
Telegram : https://t.me/ogshibportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfAcA70241AaaBE0a5764C73a605CFA2E65301394; // owner address
...
contract OGSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "OGSHIBA";
    string private _symbol = "OGSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfAcA70241AaaBE0a5764C73a605CFA2E65301394); // Marketing Address
    address payable public teamWalletAddress = payable(0xfAcA70241AaaBE0a5764C73a605CFA2E65301394); // Team Address
