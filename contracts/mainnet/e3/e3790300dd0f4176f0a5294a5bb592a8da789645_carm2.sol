...
// OFFICIAL TELEGRAM CHANNEL - catarm2
...
contract carm2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATARM 2.0";
    string private _symbol = "CATARM 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1101b460a452Cea508648BE2344FCC1FB90E9744); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1101b460a452Cea508648BE2344FCC1FB90E9744); // buyback Address
