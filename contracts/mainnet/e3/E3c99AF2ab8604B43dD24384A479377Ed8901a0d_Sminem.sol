...
contract Sminem is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Sminem BUSD 500";
    string constant _symbol = "SB500";
    ...
    uint256 public _maxHold = _totalSupply / 33;
    address public marketingFeeReceiver = 0x871492DfFbC7f33F0Abf26cA1A58Ff37c678CCBc;
    address public buybackFeeReceiver = 0x871492DfFbC7f33F0Abf26cA1A58Ff37c678CCBc;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    address liqReceiver = 0x1dB1F1cE56640A762072dD79B28772f9929c13D7;
    ...
    constructor () Ownable(msg.sender) {
		...
		autoLiquidityReceiver = liqReceiver;
        ...
        isDividendExempt[liqReceiver] = true;
        isMaxHoldExempt[liqReceiver] = true;
