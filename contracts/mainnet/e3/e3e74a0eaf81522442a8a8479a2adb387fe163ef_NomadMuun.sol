...
contract NomadMuun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nomad Muun";
    string private _symbol = "NMuun";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x1d23c7025b40d58312A9991b85b13EEed2191CDc); // Marketing Address
