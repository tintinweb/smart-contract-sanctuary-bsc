...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFc7DB0CcEC86e22ED32AeAADfF13Ba2853162135;
...
contract KRUSTY is Context, IERC20, Ownable {
    ...
    string private constant _name = "KRUSTY MERGE"; // 
    string private constant _symbol = "$Krusty"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x1A3d21Ca996371DeE0C38c75BDEEc15415438fca);
