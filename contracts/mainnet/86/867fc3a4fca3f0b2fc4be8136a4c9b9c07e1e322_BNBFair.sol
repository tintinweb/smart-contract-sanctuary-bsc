...
BNB FAIR
The first virtual carnival fair on crypto world.
Let BNB Fair project  bring fun, excitement and profit on Binance Smart Chain.

Telegram:   https://t.me/BNFair
Website:    https://www.bnbfair.site/

Fair Launch
July 8, 2022 at 1:00pm UTC

Initial LP: 5.0 BNB
Total Supply: 100,000,000,000
Max wallet limit: 2,000,000,000 Tokens

Buy Tax: 10%
Sell Tax: 10%
Slippage: Approximately 11% - 12%

Scan result: NOT A HONEYPOT 
...
contract BNBFair is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB Fair Token"; //
    string private constant _symbol = "BFAIR"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address private _marketingWallet = 0xA3155733602b908BcFfDEAA386109881C77D751D;
