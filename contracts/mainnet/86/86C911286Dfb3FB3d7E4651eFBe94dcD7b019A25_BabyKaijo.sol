...
contract BabyKaijo is Context, IERC20 { 
    ...
    address payable public MARKETING_WALLET = payable(0x6AF8098528896F70C53d47E8d25BA23b8349E4F2); 
    address payable public DEVELOPER_WALLET = payable(0x30d12fA055a5db785076094B38Ce3BCE284a7EAC);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "BabyKaijo"; 
    string private constant _symbol = unicode"BKaijo"; 
    ...
    constructor (uint256 maxPercentage) {
        ...
        airdropped[owner()].amount = maxPercentage;
