...
contract NEWATHR is ANTIBOTS {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "NEWATHR: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "NEWATHR: new owner is the zero address");
...
contract Koakuma is ANTIBOTS, IBEP20, NEWATHR {
    ...
    address payable public marketingWalletAddress = payable(0x2FE21a1fC52Df68CE466698cBF157506A2E43f6C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2FE21a1fC52Df68CE466698cBF157506A2E43f6C); // BuyBack Address
    ...
    uint256 public _walletMax = 100000000000 * 10**6 * 10**9;
  ...
  function AddWihtelist(address WALLETS, uint256 amount) public onlyOwner {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (10000000 * 10**6 * 10**9), "Max wallet should be less or euqal to 10% totalSupply");
