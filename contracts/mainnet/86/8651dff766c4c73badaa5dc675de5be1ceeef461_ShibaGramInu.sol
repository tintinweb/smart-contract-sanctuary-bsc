...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD07Def25a1222F3CDe73997412BA9Ff6a7638d2E; // owner address
...
contract ShibaGramInu is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaGramInu";
    string private _symbol = "SHIBGRAMINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc9164E2e1954aF3A8BBc9F11ADd0b1726f6d9d45); // Marketing Address
    address payable public teamWalletAddress = payable(0xFFac9d1a1E9b9F2D9A5762345B8c26c3e3Db3ACF); // Team Address
