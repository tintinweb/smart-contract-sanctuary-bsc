...
https://t.me/OniiChanInu

Onii Chan Inu is a japanese dog that will fight with every jeet in the BSC space with it's low taxes & safe team
...
/* Token contract */
contract OniiChanInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x183B4F977Ad7E228db03b50ad770067d605d94f8;
    ...
    // Name and symbol
    string constant _name = "Onii Chan Inu";
    string constant _symbol = "ONII";
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 2% of supply, 0.7%, 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc7Be0f18000B3C67870DdE23880E37F7a13EE1e6;
