...
contract FIFABOY is Context, IERC20, Ownable {
    ...
    string private _name = "FIFA BOY";
    string private _symbol = "$FIFABOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA63b9Dc8A66A099498c3AD1040Dd6C60899A6cc1); // Marketing Address
