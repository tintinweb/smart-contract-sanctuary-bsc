...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C252Ae7170d0e06e45336a613126aec838a6738;
...
contract Burna is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1b865F78D3F300711d931d902315F08802179311;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Burna";
    string private _symbol = "BURNA";
