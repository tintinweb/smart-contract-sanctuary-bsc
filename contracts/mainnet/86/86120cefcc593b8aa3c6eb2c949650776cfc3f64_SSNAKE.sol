...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BBBR = IBEP20(0x639CF44b66D02F822c57F97dabAF3547462f0CE9);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BBBR.balanceOf(address(this));
        ...
        uint256 amount = BBBR.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BBBR.transfer(shareholder, amount);
...
contract SSNAKE is IBEP20, Auth {
    using SafeMath for uint256;

    address BBBR = 0x639CF44b66D02F822c57F97dabAF3547462f0CE9;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBrelfection = amountBNB.mul(rewardFee).div(totalBNBFee);
