...
YUKI INU is ownerless, fully decentralized and supported by its community of enthusiasts. 
Everyone can participate in every step of YUKI INU growth!

long Term vision is to dominate the token ecosystem . We plan to have Land in the various 
ecosystems on Binance Smart Chain and other blockchains, 
Develop unique experiences, and generate revenue from advertising on said lands

Telegram : https://t.me/Yukinuglobal
Website  : https://yukiinu.com/

Tokenomics 
Tax 7% for

1% each sell will sent to burn address to decrease supply & increase price.
1% of each transaction (BUY/SELL) is transformed into liquidity pool (to increase price floor).
5% of each transaction (BUY/SELL) is transformed into marketing wallet 
   so we've massive marketing campaign.
...
contract YUKIINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x14045533b5e059bCE2ebB7616d7d8c19691A54F5); 
    address payable public Dev_Wallet = payable(0x14045533b5e059bCE2ebB7616d7d8c19691A54F5);
    ...
    string private constant _symbol = unicode"YUKI INU"; 
    ...
    constructor () {
        ...
        _owner = 0x14045533b5e059bCE2ebB7616d7d8c19691A54F5;
