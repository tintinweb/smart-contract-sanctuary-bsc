...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46bf2176C66a14721D67c9348f6FcFC85EBc5084; // owner address
...
contract KongZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kong Zilla";
    string private _symbol = "Kzilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3e8170eFE2935Fc00ea2caeD4dEA895F99043008); // Marketing Address
    address payable public teamWalletAddress = payable(0x3e8170eFE2935Fc00ea2caeD4dEA895F99043008); // Team Address
