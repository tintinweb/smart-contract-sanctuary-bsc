...
contract ZhaogeKing is Context, IERC20, Ownable {
    ...
    string private constant _name = "ZhaogeKing"; // 
    string private constant _symbol = " $ZHAOKING"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x61c6DbC9e088A074fF2c2d1a37B3D6abba688507;
