...
contract ShibaroToken is ContextBinanceArt, BinanceArt, OwnableBinanceArt {
    ...
    string private _name = 'Shibaro';
    string private _symbol = '$Shibaro';
