...
contract TRCBSC is Context, IERC20, Ownable {
    ...
    string private _name = "FEGRISE";
    string private _symbol = "FEGRISE";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x076249170eFf92228ce20A1320DBcA493d7f68F5));
        marketingWalletAddress = payable(address(0x076249170eFf92228ce20A1320DBcA493d7f68F5));
