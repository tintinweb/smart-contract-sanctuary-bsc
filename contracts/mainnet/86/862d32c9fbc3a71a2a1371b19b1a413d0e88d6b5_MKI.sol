...
contract MKI is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Kart Inu";
    string private _symbol = "MKI";
    ...
    address payable public marketingWallet = payable(0x12E1D178e7ae736CdDbD1a78aDdA51697B0d2a7b);
    ...
    function _transfer(
        ...
        if (
            ...
            if(overMinTokenBalance) {
                ...
                //add liquidity, swap for marketing and buyback
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_marketingFee).add(_buybackFee));
        uint256 marketingAndBuybackShare = contractTokenBalance.sub(liquidityShare);
        ...
        swapTokensForEth(marketingAndBuybackShare);

        uint256 balanceAfterSwap = address(this).balance.sub(balanceBeforeSwap);

        uint256 marketingEthShare = balanceAfterSwap.mul(_marketingFee).div(_marketingFee.add(_buybackFee));
