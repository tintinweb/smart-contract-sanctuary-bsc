...
contract MondayShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MondayShiba";
    string private _symbol = "MondayShiba";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3D7b393Bc6B55a088781b71f7c852AA93Cb77D5c);
