...
Stealth Launch Today At 3PM-4PM UTC

✅Lock LP 2 Month
✅Ownership Renounce 
✅BullishName 
✅Our Utilities Live
https://swap.kishudogeinu.com/


For more information, please visit us on:
Telegram :
https://t.me/kishudogeinu
Twitter:
https://twitter.com/kishudogeinu
Website :
https://www.kishudogeinu.com/
*/
...
contract KishuDogeInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Kishu Doge Inu"; // token name
    string private _symbol = "$KIDO"; // token ticker
    ...
    uint256 public maxHoldingAmount = 1000000000 * 1e9;
