...
//   📱Website :: https://www.bsc.news/post/floki-launches-redesigned-flokicom-website
/*
...
contract Floki100 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Floki100", "Floki100") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Floki100";
    string private _symbol = "Floki100";
