...
/** 
                CyberBull token
   Grow And Spend Your Money Like Never Before...


 Website    : https://CyberBull.finance
 Telegram   : https://t.me/CyberBullNews
 Twitter    : https://twitter.com/CyberBullToken
...
contract CyberBullToken is Context , IERC20, Ownable {
    ...
    string private _name = "CyberBull";
    string private _symbol = "CyBull";
    ...
    address public marketingWallet = 0x8Dd1A3b2e5eF36bdB84E7235e67074DcFe6DD05b; 
    ...
    function totalLiqudity() public view returns (uint256) {
    ...
    function updateFee(uint256 taxFee,uint256 burnFee,uint256 marketingfee ) external onlyOwner() {
        _taxFee = taxFee;
        _burnFee = burnFee;
        _marketingFee = marketingfee;
	}

    function LiquidityPercent(uint256 LiquidityFee) external onlyOwner() {
