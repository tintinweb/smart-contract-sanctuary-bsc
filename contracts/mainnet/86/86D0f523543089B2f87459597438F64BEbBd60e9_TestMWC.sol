...
contract TestMWC is ContextUpgradeable, IERC20Upgradeable, OwnableUpgradeable,UUPSUpgradeable {
    ...
    // address public performancePoolWallet;
    ...
    function initialize(address _router, string memory name_, string memory symbol_, uint8 decimals_) initializer public {
        ...
        taxFeeTotal =0;
        enableAllFee= false;
        // performancePoolWallet=address(0);
    ...
    function removeERC20() public onlyOwnerAndAdmin {
        IERC20Upgradeable(address(this)).transfer(_msgSender(),IERC20Upgradeable(address(this)).balanceOf(address(this)));
    }
}
