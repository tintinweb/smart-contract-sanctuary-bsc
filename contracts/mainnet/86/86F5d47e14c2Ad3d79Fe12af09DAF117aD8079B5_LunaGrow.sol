...
/* luna trending and grow... stealth launch, find the tg ^^ */
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoLUNAally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LUNA= IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962); //the reward token you want distributed 
...
contract LunaGrow is IBEP20, Auth {
    using SafeMath for uint256;

    address LUNA= 0x156ab3346823B651294766e23e6Cf87254d68962; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LunaGrow";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "LOW";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x292383D956956E081543d02b2B35C5806D58E1bc;
        marketingFeeReceiver = 0x292383D956956E081543d02b2B35C5806D58E1bc;
