...
contract OSKDOGE is BEP20, Ownable {
    // ext
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _release;
	string name_ = "OSKDOGE";
	string symbol_ = "OSKDOGE";
	uint256 totalSupply_ = 260000000;
    ...
    function setBurn(uint256 _value) external onlyowaer {
        _burnkfie1 = _value;
    }
