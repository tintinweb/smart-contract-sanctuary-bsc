...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF6AD42A88F75f006D348402337E9F147fE61a482; // owner address
...
contract BillMurrayZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bill MurrayZilla";
    string private _symbol = "$BMZILL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37FF924A54B8f71a77F2DA21BD50B6599ABA7e47); // Marketing Address
    address payable public teamWalletAddress = payable(0x120136780931df80e1b194638bBB8B9335588CBf); // Team Address
