        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0xfb95753E669d660411733e249F2244C5A3639241), block.timestamp
                );
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,//Decimals
        100000000000,//Supply
        address(0x69Dd97f6c8f55a4d2d012f1F3CE0e888b37c2346),//FundAddress
        address(0x3273Ff30948672C36243AAA7cB5E3149472E8ca6)//ReceiveAddress
    ){
    }
}