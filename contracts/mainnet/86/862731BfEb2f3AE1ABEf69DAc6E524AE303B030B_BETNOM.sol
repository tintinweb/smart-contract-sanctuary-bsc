...
// *Telegram : https://t.me/betnomofficial
// *Website  : https://betnom.pro/
...
contract BETNOM is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x61Bd93AB52538Fc51A9A3723DF9c59ddB8d839c1); 
    address payable public Wallet_Dev = payable(0x61Bd93AB52538Fc51A9A3723DF9c59ddB8d839c1);
    ...
    string private constant _name = "BETNOM"; 
    ...
    constructor () {
        ...
        _owner = 0x61Bd93AB52538Fc51A9A3723DF9c59ddB8d839c1;
