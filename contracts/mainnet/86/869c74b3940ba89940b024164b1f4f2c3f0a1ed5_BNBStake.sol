...
contract BNBStake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BNB Stake Cave";
    ...
    uint256 private _totalSupply = 1800000 * 10**_decimals;
    uint256 public _maxTxAmount = 1800000 * 10**_decimals; 
    uint256 public _walletMax = 1800000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc4aA8f1cD470c0dFBe238A73201E249944AE986F));
        marketingWalletAddress = payable(address(0xc4aA8f1cD470c0dFBe238A73201E249944AE986F));
