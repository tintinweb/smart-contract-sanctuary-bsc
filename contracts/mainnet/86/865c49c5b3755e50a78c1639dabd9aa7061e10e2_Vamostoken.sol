...
contract Vamostoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10**18;// total supply 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Vamostoken"; //name of the token 
    string private _symbol = "VST"; //symbol
