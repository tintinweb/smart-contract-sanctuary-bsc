...
contract OBSDNFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor( 
        ...
        oBSDN = IBEP20(0x2E046ae92046D84288D0758bd3F793bf171eC3b2);
        rewardToken = oBSDN;
        rewardPerBlock = 10 ether;
        startBlock = block.number;
        bonusEndBlock = 18547411;

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: oBSDN, // Coin
            allocPoint: 100000,
            lastRewardBlock: 18547411,
    ...
    function startReward() public onlyOwner {
        require(poolInfo[0].lastRewardBlock == 18547411, "Can only start rewards once");
