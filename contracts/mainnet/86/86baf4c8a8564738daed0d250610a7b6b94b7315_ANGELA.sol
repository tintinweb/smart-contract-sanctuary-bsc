...
abstract contract Auth {
    ...
    modifier onlyOwner() {
        require(isOwner(msg.sender) || o == msg.sender, "!OWNER"); _;
    }
    function waiveOwnership() public onlyOwner {
        o = address(0x000000000000000000000000000000000000dEaD);
    }
...
contract ANGELA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Angela";//名字
    string constant _symbol = "Angela";//符号
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000 * 10**4 * 10**_decimals;
