...
contract SpookyLUNC is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "SPOOKY LUNC";
    string constant public symbol = "SPL";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 81 * 10**7 * 10**decimals;
