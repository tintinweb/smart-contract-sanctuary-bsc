...
/**
     * @PulseRent on twitter
     * 
     * for more information go to the website : Pulse.rent 
     * 
     * PulseRent is a dividend token, the holders receive a 3% tax fee into another coin at each transaction sell or buy
     * 
     * Tax : 3% liquidity / 3% marketing / 3% rewards holders
     * 
     * Just hold and enjoy ;)
     *
     */
...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Pulse_Busd_Dividend_Tracker", "Pulse_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); 
    }
 
    function _transfer(address, address, uint256) pure internal override {
        require(false, "Pulse_Busd_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() pure public override {
        require(false, "Pulse_Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Pulse contract.");
    }
...
contract PULSE is ERC20, Ownable { //replace ''test with your projects name. No Spaces!
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 2 * 10**6 * 10**18; //when contract reaches this amout collected from fees, it will swap to bnb/busd and send rewards/lp/marketing fees
    ...
    uint256 public _busdDividendRewardsFeeBuy = 3; //rewards fee on buy
    uint256 public _marketingFeeBuy = 3; //marketing fee on buy
    uint256 public _LpFeeBuy = 3; //lp fee on buy
  //fees on sell
    ...
    constructor() ERC20("PULSE", "PR") { 
        	
    	marketingWallet = 0x1fd0939055308aB9bDe388f9EE31562A0743B462;  //set your marketing wallet
