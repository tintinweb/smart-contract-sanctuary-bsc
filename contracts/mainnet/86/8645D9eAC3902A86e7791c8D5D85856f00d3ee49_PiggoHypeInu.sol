...
/*
   ITS ALL ABOUT TEAM WORK AND COMMUNITY!
   A Launch BY mysterymoonlaunch's Team    
...
contract  PiggoHypeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Piggo Hype Inu";
    string private _symbol = "PHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8C898CfA02d61c64981BAb9399CE4D9d56316be);
    address payable public teamWalletAddress = payable(0xD719C3e9ACEACDE94D926C75C916557209738Fa4); 
