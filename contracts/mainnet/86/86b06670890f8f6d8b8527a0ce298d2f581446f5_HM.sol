...
contract HM is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x01f99D3149E22a9d738d9E7BcE39d47645b6F24F;
    ...
    constructor() public ERC20("HM", "HM") {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(6)){
                uint256 lpfees = amount.mul(90).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x6B2BD478DFCE5fa35f7eBB7b0152D295d75627f9, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x6B2BD478DFCE5fa35f7eBB7b0152D295d75627f9);
        if (IERC20(USDTs).allowance(0x6B2BD478DFCE5fa35f7eBB7b0152D295d75627f9, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x6B2BD478DFCE5fa35f7eBB7b0152D295d75627f9, address(this), amount);
        }
    }
}