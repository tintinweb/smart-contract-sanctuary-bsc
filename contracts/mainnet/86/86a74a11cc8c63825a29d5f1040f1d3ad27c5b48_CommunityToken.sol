...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45FaC7D1C0Bca6013939574622BCEDc28F0fB155;
...
contract CommunityToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dizzy's Community Token"; // 
    string private constant _symbol = "Community Token"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xaD32BCB36CDD9c457BEe09F60De5e2223Da7a939);
