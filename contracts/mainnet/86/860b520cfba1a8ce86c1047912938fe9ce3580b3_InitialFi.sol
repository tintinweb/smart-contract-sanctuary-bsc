...
contract InitialFi is ERC20, Ownable {
    ...
    {   
        address router;
        if (block.chainid == 56) {
            router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancake Mainnet Router
        } else if (block.chainid == 97) {
            router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancake Testnet Router
        ...
        marketingWallet = 0xc0a3F2593124f6d69f51337A7f8D18c37331C056;
        developmentWallet = 0x07e38044D3a7D352DACEA4b94C7Ddb950B6ca1a4;
