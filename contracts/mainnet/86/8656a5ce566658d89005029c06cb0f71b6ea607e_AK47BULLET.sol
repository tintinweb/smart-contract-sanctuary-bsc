...
contract AK47BULLET is Context, IERC20, Ownable {
    ...
    string private _name = "AK47 BULLET";
    string private _symbol = "$47";
    ...
    address payable public marketingaddress = payable(0x2ECa0aEc47A1c5b4d3b825c71fe34133e0Af4539);
