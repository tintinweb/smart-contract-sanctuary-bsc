...
contract Pi is ERC20 {
	...
	address public _fundAddress = address(0x6F627e2E1280E9F6e8edcF14f01991C03935eebD);
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			super._transfer(from, address(this), amount.div(1000).mul(40));
			amount = amount.div(1000).mul(960);
        }
        super._transfer(from, to, amount);
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
		    ...
		    USDT.transfer(_fundAddress,newAmount.div(40).mul(35));	
		}
    }
