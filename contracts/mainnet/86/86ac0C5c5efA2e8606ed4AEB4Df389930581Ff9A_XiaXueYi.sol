...
contract  XiaXueYi is Context, IERC20, Ownable {
    ...
    string private _name = "XiaXueYi";
    string private _symbol = "XiaXueYi";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC5E483A2E5764Df7bCa2D3511e99C0068022c032));
        ruinWalletAddress = payable(address(0xC5E483A2E5764Df7bCa2D3511e99C0068022c032));
