...
/*
   _____ _     _ _              _____       _                   
  / ____| |   (_) |            / ____|     (_)                  
 | (___ | |__  _| |__   __ _  | (___   __ _ _ _   _  __ _ _ __  
  \___ \| '_ \| | '_ \ / _` |  \___ \ / _` | | | | |/ _` | '_ \ 
  ____) | | | | | |_) | (_| |  ____) | (_| | | |_| | (_| | | | |
 |_____/|_| |_|_|_.__/ \__,_| |_____/ \__,_|_|\__, |\__,_|_| |_|
                                               __/ |            
                                              |___/             
With power and might, the warriors fight
To save the earth and the universe in sight
Dragon Ball Z, the anime we adore
With epic battles, we can't ignore

From Goku to Vegeta, Piccolo to Frieza
Each character shines with their own aura
The action and drama, the comedy and tears
Dragon Ball Z for years and years

But now, a new age is upon us
Shiba Saiyan, the successor of Dragon Ball Z, trust
With a new cast of characters and a fresh story
We'll be on the edge of our seats, in awe and glory
*/


//Telegram: https://t.me/ShibaSaiyanBSC
...
contract ShibaSaiyan is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Saiyan", "SHIBSAIYAN") {
        ...
        uint256 _sellbBackFee = 9;

        uint256 totalSupply = 100_000_000 * 1e18;

        maxTransactionAmount = (totalSupply/100) * 2; // 2% from total supply maxTransactionAmountTxn
        ...
        marketingWallet = address(0xBCC0E205d63f02bFbd17e3369163AB6E27f7Dd68); // set as marketing wallet
        buybackWallet = address(0xBCC0E205d63f02bFbd17e3369163AB6E27f7Dd68); // set as dev wallet
