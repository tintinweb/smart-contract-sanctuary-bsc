...
contract dilireba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "dilireba";
    string private _symbol = "DILI";
    ...
    function maxfee(address sender, uint256 amount) internal view {
        require(
