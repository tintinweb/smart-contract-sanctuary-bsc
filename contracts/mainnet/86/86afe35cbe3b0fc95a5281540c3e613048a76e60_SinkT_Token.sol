...
contract SinkT_Token is Context, IERC20 { 
    ...
    address payable public wallet_dev = payable(0x1DC6B493D7c24c5e18B2907849E3E0F7D5D7BFeC);
    address payable public wallet_marketing = payable(0x0f07050eB6C2ceFeC1155ec7BaB66E9cd6Bf77CD);     

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5 * 10**3 * 10**_decimals;
    string private constant _name = "Sink Twitt Token"; 
    string private constant _symbol = unicode"SinkT"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public TAX_ON_BUY = 5;
    uint256 public TAX_ON_SELL = 5;
    ...
    constructor () {
        ...
        _owner = 0x9C05aBc93697f3E3069E653DFe710F44CB05a78c;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        // uniswap mainnet 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        // BSC testnet 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        // pcs test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1

        //pcs testnet app 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*TAX_ON_BUY/100;
            ...
            uint256 sellFEE = tAmount*TAX_ON_SELL/100;
