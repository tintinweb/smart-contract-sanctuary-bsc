...
//telegram will be private for now 
interface IERC20 {
...
contract MCFLURRYSPOON is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 1_500_000 * 10**_decimals;
    uint256 public maxBuyAmount = 100_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 100_000_000 * 10**_decimals;

    address public marketingAddress = 0xa63893c8774C91eE7ef5ccD9096Deb5758868a0f;
    address public devAddress = 0xa63893c8774C91eE7ef5ccD9096Deb5758868a0f;

    string private constant _name = "MC FLURRY SPOON";
    string private constant _symbol = "$MCFLUS";
