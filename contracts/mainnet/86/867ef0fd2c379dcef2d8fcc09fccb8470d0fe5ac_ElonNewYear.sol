...
contract ElonNewYear is Context, IERC20, Ownable {
    ...
    string private _name = "Elon New Year";
    string private _symbol = "ELONY";
    ...
    address payable public marketingWallet = payable(0xeD8A255c662861286C1C6Ba29F07767A0823CD18);
