...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB1e699Abb7e0a88BbA38Ca338274f9b025045370; // owner address
...
contract GODZILADOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GODZILADOGE";
    string private _symbol = "GodzDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB1e699Abb7e0a88BbA38Ca338274f9b025045370); // Marketing Address
    address payable public teamWalletAddress = payable(0xB1e699Abb7e0a88BbA38Ca338274f9b025045370); // Team Address
