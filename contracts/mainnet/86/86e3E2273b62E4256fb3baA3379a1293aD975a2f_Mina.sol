...
contract Mina is IERC20, Auth {
    ...
    address payable public devWallet = payable(0x17597398164e1a2C724C88bAb41853710AB61A90);
    address payable public marketingWallet = payable(0x17da8B319970161e857C5af4Bf40CE21959F374c);
