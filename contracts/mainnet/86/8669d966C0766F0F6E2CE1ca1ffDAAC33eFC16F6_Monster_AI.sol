...
contract Monster_AI is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('Monster AI', 'MAC') {
        require(
            feeAccount != address(0),
            'Monster_AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'Monster_AI: incorrect fee percent');
        require(owner != address(0), 'Monster_AI: incorrect owner address');
        require(mintToAddr != address(0), 'Monster_AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'Monster_AI: transfer from the zero address');
        require(recipient != address(0), 'Monster_AI: transfer to the zero address');
