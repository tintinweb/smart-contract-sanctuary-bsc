...
/**
 #Dapps Project by https://solcard.finance/ SolCard $SOL
 Deploy on UI : https://solcard.finance/bnbstake/
 From 7.8 to 17% Daily ROI
...
contract SolCardBNBSTAKE {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [15, 10, 5, 2, 1]; 
