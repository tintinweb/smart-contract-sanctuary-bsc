...
contract LifeCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888888888888888888 * (10**9);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Life Coin";
    ...
    address public marketingWallet = 0x8Aba12183549d4E6743FdC4af087cf7dfD1097da;

    uint256 public _charityFee = 2;
    uint256 private _previousCharityFee = _charityFee;
    address public charityWallet = 0x42ed1dF7c0D4aaDA245Fbc1c1EA5323A4060EA74;

    uint256 public _buybackFee = 4;
    uint256 private _previousBuybackFee = _buybackFee;

    uint256 public buybackDivisor = 20;
    uint256 private buyBackUpperLimit = 1 * 10**17; // 0.1 bnb
    ...
    uint256 public _maxTxAmount = 888888888888888888 * 10**9;
    uint256 public maxWalletToken = 888888888888888888 * 10**9;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _buybackFee==0 && _marketingFee==0 && _charityFee==0) return;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_buybackFee));
    ...
    function setBuybackDivisor(uint256 newValue) external onlyOwner() {
     ...
     function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 buybackFee, uint256 marketingFee, uint256 charityFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(buybackFee).add(marketingFee).add(charityFee) <= 14, "tax too high");
        _taxFee = taxFee;
