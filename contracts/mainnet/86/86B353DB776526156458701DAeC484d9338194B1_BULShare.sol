...
contract BULShare is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BULSHARE", "BULSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 BUL Share for initial pools deployment
