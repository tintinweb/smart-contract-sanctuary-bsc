...
contract AtaLira is Context, IERC20, Ownable {
    ...
    string private _name = "ATA LIRA";
    string private _symbol = "ATALIRA";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xf6151Ca884DCDfCBade42ae719713fFd522e5830);
