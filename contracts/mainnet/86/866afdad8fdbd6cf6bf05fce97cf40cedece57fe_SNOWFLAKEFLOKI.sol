...
/**
Welcome to Snowflake Floki❄️🐕
Snowflake Floki is a Christmas based token focused on bringing joy and a merry time during this Holiday Season to the BSC Community Space. 
You can hold your bags all the way thru the holiday season into the New Year and allow yourself to make real gains while the team constantly pushes the project forward everyday.

TG: https://t.me/SnowflakeFloki
Twitter: https://twitter.com/SnowflakeFloki

Sell tax will be 35% for the beginning of the launch for any paperhands or bots that will sell. This will only feed our Marketing and LP Funds.

Taxes will then be set to normal.
Taxes will be 9/9
*/
...
contract SNOWFLAKEFLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "SNOWFLAKE FLOKI";
    string private _symbol = "$SFLOKI";
    uint8 private _decimals = 4;

    address public marketingWallet = 0x1dE83D0d66d31E3b54687b225Dfec43074737e26;
    address public developmentWallet = 0x1dE83D0d66d31E3b54687b225Dfec43074737e26;
    ...
    uint256 _sellDevelopmentFee = 100;
