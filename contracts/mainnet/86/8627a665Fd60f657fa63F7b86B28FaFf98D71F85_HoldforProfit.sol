...
//Welcome to HOLD FOR PROFIT
//Market cap no way we will dominate all the charts when you have 
//any trouble check the contract and don't ask stupid things Just Hold our marketing is our name!
pragma solidity ^0.8.5;


// SPDX-License-Identifier: MIT

//https://t.me/HOLDFORPROFITBSC
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f5d6242ceE346a4CF1f1e9D36295e15fDe03b6A;
...
contract HoldforProfit is Context, IERC20, Ownable {
    ...
    string private constant _name = "HOLD FOR PROFIT"; // 
    string private constant _symbol = "$HOLD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x0f5d6242ceE346a4CF1f1e9D36295e15fDe03b6A);
