...
contract FIFAPIG   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " FIFA PIG ";
    string private _symbol = " FFP "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89e929Ad6f487052C5332355f3446E2f2F5f2bF2); 
