...
/**
On this day, Joe RoGAINS $JROG was launched as tribute for the one and only, legendary Joe Rogan. This token will reward every holder in ETH LEDGER ($LEDGER) which rewards holders in ETH Rewards. Enjoy this duel reward token! 
  
We welcome everyone to come and join an amazing community. Let's all make history and filthy GAINS here!


在这一天，Joe RoGAINS $JROG 推出，以纪念独一无二的传奇人物 Joe Rogan。该代币将奖励 ETH Ledger ($LEDGER) 中的每个持有者，这些持有者将获得 ETH Rewards 奖励。享受这个决斗奖励令牌！
  
我们欢迎大家加入一个了不起的社区。让我们都在这里创造历史和肮脏的收获！

Telegram:
https://t.me/JoeRoGAINS

Twitter:
https://twitter.com/Joe_Rogains

Website:
http://www.JoeRogains.app
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x14Fa9d27db3903C7AE96BB0141F367859d646b98);
...
contract  JROG is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xbDbb533fD432Df8736FaaF6576Fb8c56D81432D4;

    string constant _name = "Joe RoGAINS";
    string constant _symbol = "JROG";
