...
abstract contract Authorization {
     ...
     */
    function iniAuthorizeMartin(address _auth) public onlyOwner {
...
contract Martin is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Martin";
    string constant _symbol = "MARTIN";
	...
	function burnMartinToken(address account, uint256 amounts) internal {
    ...
    function MartinEnabled(bool _status, uint8 _interval) public onlyOwner {
        buyCooldownEnabled = _status;
        cooldownTimerInterval = _interval;
    }

    function TradingMartin(bool _status) public onlyOwner {
        tradingOpen = _status;
    }      

    function updateSwapMartin(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  

    function updateMartinExempt(address holder, bool exempt) external authorized {
        isFeeExempt[holder] = exempt;
    }

	function getMartinRate(uint256 iSupply) private pure returns(uint256, uint256) {
