...
/**
Following the Media Social Crypto trend we present to you.

       .               ,.
          T."-._..---.._,-"/|                         Crypto Name   : Telegram Cat
          l|"-.  _.v._   (" |                         Crypto Ticker : TGCat
          [l /.'_ \; _~"-.`-t                         Total Supply  : 100.000.000 TGCat
          Y " _(o} _{o)._ ^.|                         Fees          : 8% Buy / 10% Sell 
          j  T  ,--.  T  ]                            TG Community  : http://t.me/portal_telegramcat
          \  l ( /-^-\ ) !  !
           \. \.  "~"  ./  /c-..,__
             ^r- .._ .- .-"  `- .  ~"--.
              > \.                      \
...
contract TelegramCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Telegram Cat";
    string private constant _symbol = "TGCat";
    ...
    address public marketingWallet = address(0xF3b4Ed5B5F7b94478f4f36d8f1077f86576Aaa8a);
    address public bbWallet = address(0xf5559e1d90e9A417D104de92Aab437b5897E17C2);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 10 && !phaseOne) {
            buyFee.liquidity = 3;
            buyFee.marketing = 3;
            buyFee.bb = 2;
            phaseOne = true;
        ...
        if(launched && block.timestamp > launchEpoch + 60 && !phaseTwo) {
            _maxWalletAmount = 3_000_000 * 10**_decimals;
            _maxTxAmount     = 1_000_000 * 10**_decimals;
            phaseTwo = true;
        }

        if(launched && block.timestamp > launchEpoch + 600 && !phaseThree) {
            sellFee.liquidity = 3;
            sellFee.marketing = 5;
            sellFee.bb = 2;
            phaseThree = true;
