...
contract Token is IERC20, Ownable {
    ...
    string constant _name = "MiloCatcoin";
    string constant _symbol = "MiloCatcoin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; // 0.5% MAX 100,000
    ...
    uint256 devFee = 6; // 
    uint256 totalFee = 14; // liquidityFee + reflectionFee + devFee
