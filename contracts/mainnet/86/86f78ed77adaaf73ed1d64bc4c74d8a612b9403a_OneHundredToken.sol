...
contract OneHundredToken is Context, IERC20 { 
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            require((heldTokens + amount) <= _previousMaxWalletToken,"Over wallet limit.");}
        ...
        if (to != owner() &&
            ...
            to != uniswapV2Pair &&
            from != 0x9BbBe25a92fafA101966C13E9f36EFCBE4e87e21)
            require(amount <= _previousMaxTxAmount, "Over transaction limit.");
