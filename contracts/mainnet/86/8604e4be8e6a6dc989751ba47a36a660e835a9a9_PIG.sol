...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbE171752920aFB9e64e05B878dD6bFC8FbEE5Dce;
...
contract PIG is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xbE171752920aFB9e64e05B878dD6bFC8FbEE5Dce;

    // Set the owner address at line 200
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dirty Pig";
