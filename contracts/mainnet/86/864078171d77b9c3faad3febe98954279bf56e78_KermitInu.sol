...
interface IRouter {
    ...
    contract KermitInu is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 250_000_000_000 * 10**18;
    ...
    address private marketingWallet = 0x6BD536F157c51F57bEDF4E67A22fe01F138BBB6C;
    address private devWallet = 0x3e4088966CFB38e4B7ad41fcbABB0c025c9Db57A;
    address private charityWallet = 0xAe1A97F2838eE28ccFb1Ddd6A0D2BcF291772A13; 
    ...
    Taxes private taxes = Taxes(0, 2, 0,  0);
    ...
    constructor(address routerAdd) ERC20("Kermit Inu", "KTI") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        taxes = Taxes(_marketing, _charity,_liquidity, _dev);
        require((_marketing + _charity + _liquidity + _dev) <= 15, "Must keep fees at 15% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _charity,_liquidity, _dev);
        require((_marketing + _charity + _liquidity + _dev) <= 30, "Must keep fees at 30% or less");
    }
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxBuyTxLimit(uint256 maxBuy) external onlyOwner {
        ...
        require(maxBuy >= 100_000_000_000, "Cannot set max buy amount lower than 0.1% of tokens");
    }

    function updateMaxSellTxLimit(uint256 maxSell) external onlyOwner {
        maxSellLimit = maxSell * 10**decimals();
        require(maxSell >= 100_000_000_000, "Cannot set max sell amount lower than 0.1% of tokens%");
    }

    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 100_000_000_000, "Cannot set max wallet amount lower than 0.1% of tokens");
