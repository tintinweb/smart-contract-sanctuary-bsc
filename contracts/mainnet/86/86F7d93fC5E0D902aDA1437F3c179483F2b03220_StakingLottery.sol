...
contract StakingLottery {
    ...
    uint256 public daysUntilEnd = 7;
    uint256 public stakingOpenForDays = 1;
    ...
    function openStaking(uint256 stakingJackpotPrize, uint256 _howManyWinners) external onlyOwner {
        ...
        lastChanceToStake = block.timestamp + (stakingOpenForDays * 1 days);
        stakingEnds = block.timestamp + (daysUntilEnd * 1 days);
