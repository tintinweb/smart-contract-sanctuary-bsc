...
import "./XdogeStakingV5.sol";

contract ManageStakingV5 is Ownable {
    using SafeMath for uint256;

    mapping(address => XdogeStakingV5) public pools;
    ...
    struct PoolParams {
        ...
        uint256 claim1stlockTime;
        uint256 claimLastlockTime;
    ...
    function generateNewPool(
        ...
        XdogeStakingV5 newPool = new XdogeStakingV5();
        ...
        onlyOwner
    {
        pools[_pool].initializePool(
            ...
            _poolParams.claim1stlockTime,
            _poolParams.claimLastlockTime
        );
        pools[_pool].setNFTToken(
            _poolParams.nftTokenAddress,
            _poolParams.nftTokenId,
            _poolParams.nftDepositLimit
        );
    }
