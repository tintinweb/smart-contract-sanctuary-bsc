...
/**
Yooshi Worldcup ( YWC ) is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and rn for community. Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future
...
contract YooshiWorlcup is IERC20, Ownable {
