...
/**
 ...
 FifaShark is low tax play, with a best combination between fifa and shark 
 $FS the next community-driven token who reach more than thousands MCAP

 Telegram: https://t.me/FifaSharkbsc
...
contract FifaShark is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FifaShark";
    ...
    address payable public marketingWalletAddress = payable(0x1C13A1F3cC1f32A5A5E79c5334748070D4195015); // Marketing Address
    address payable public teamWalletAddress = payable(0x298Cf0B2e8D924f488D991F1D94B95184413B9EF); // Team Address
    ...
    uint256 private _buyMaxTxAmount = 3000000 * 10**_decimals;
    uint256 private _sellMaxTxAmount = 3000000 * 10**_decimals; 
