...
contract RFLX_Bonus_CKIO {
    ...
    uint256 public MAX_LOTTERY_TICKET = 10000; /** 10000 ticket max = 1 000 000 CKIO **/
	/** Si 10000 alors il faut multiplier par le prix de Tickets et penser à modifier le MAX_BUY ci dessus**/
