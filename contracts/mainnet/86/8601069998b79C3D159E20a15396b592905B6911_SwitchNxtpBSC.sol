...
contract SwitchNxtpBSC is SwitchBSC {
    ...
    function transferByNxtpWithParaswap(
        TransferArgsNxtp calldata transferArgs,
...
contract SwitchBSC is SwitchRootBSC {
    ...
    function setParaswapProxy(address _newParaswapProxy) external onlyOwner {
        paraswapProxy = _newParaswapProxy;
    }

    function setAugustusSwapper(address _newAugustusSwapper) external onlyOwner {
        augustusSwapper = _newAugustusSwapper;
    }
