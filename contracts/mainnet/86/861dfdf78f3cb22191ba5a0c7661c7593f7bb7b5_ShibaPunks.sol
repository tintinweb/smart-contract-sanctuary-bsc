...
contract ShibaPunks is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1b445A8c1acAFa18DcE535ef60E93dBE592cDb49));
        marketWall = payable(address(0x1b445A8c1acAFa18DcE535ef60E93dBE592cDb49));
