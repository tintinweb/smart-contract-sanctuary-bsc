...
contract RecordDelegation {
    ...
    mapping(string => mapping(string => mapping(string => uint256))) private delegationInfo;
    mapping(string => mapping(string => string[])) private delegatorInfo;
    mapping(string => mapping(string => string[])) private userValidatorInfo;
    mapping(string => mapping(string => mapping(string => bool))) private delegatorExist;
    mapping(string => mapping(string => mapping(string => bool))) private userValidatorExist;
