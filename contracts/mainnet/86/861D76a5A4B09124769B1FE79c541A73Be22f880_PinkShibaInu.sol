...
TELEGRAM: https://t.me/pinkshibainuofficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
...
contract PinkShibaInu is IBEP20, Ownable {

    using SafeMath for uint256;

    string constant _name = "Pink Shiba Inu";
    string constant _symbol = "PINU";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x6F85DD6Dd8bdBC0546fC4cCFfA1da60eFE49BaBc;
    ...
    constructor () Ownable(msg.sender) {
        ...
        totalFee = taxFeeVar.add(_marketingFee).add(rewardsFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external onlyOwner {
        taxFeeVar = newLiqFee;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 feeApplicable = pair == recipient ? _marketingFee : taxFeeVar;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(taxFeeVar).div(totalFee).div(2);
        ...
        uint256 totalBNBFee = totalFee.sub(taxFeeVar.div(2));

        uint256 amountBNBLiquidity = amountBNB.mul(taxFeeVar).div(totalBNBFee).div(2);
