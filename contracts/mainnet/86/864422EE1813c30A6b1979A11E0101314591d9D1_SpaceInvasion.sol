...
// Based on the Future
// We present a community driven meme token : Space Invasion
// Telegram : https://t.me/SpaceInvasion
// Website : https://bit.ly/spaceinvasi0n
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeC3F9Ac4fC91B0C23bAC4E7FA1A8b4252D26Fae6; // owner address
...
contract SpaceInvasion is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPACE INVASION";
    string private _symbol = "SPACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B7Bb63F1b19B1CF337C1f5a090050970AE3F51E); // Marketing Address
    address payable public teamWalletAddress = payable(0x8BFEAF7D2A1D69654A21a372193759Fa1dd67887); // Team Address
    ...
    uint256 public _walletMax = 500000000000000000 * 10**_decimals;
