...
// ETChain $ETC // BLOCKCHAIN PROJECT

// https://t.me/ETChain_Official
// https://etchain.tech
...
contract ETChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETChain";
    string private _symbol = "$ETC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4bFD643816d49d11A980501286c2c0f13D2ec308); // Marketing Address
