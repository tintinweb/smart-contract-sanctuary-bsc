...
contract BEP20New is IBEP20, Auth {
    using SafeMath for uint256;
    
	address MARKETING = 0x5741cef3fB54088A7B0Bf73F500d73eAa462f3a6;
    address LIQUIDITY = 0x5741cef3fB54088A7B0Bf73F500d73eAa462f3a6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

    string constant _name = "BEP20New";
    string constant _symbol = "BEPN";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        fee = amount.mul(totalFee).div(feeDenominator);
        _basicTransfer(recipient,address(this),fee);
        }
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _liquidityFeeReceiver) external authorized {
