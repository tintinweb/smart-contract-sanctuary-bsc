...
contract Shibaxmas is Context, IERC20, Ownable {
    ...
    address payable public DonationsAddress = payable(0x1601fcB004a80c7d511272b764B8C09038C0eB0D);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 0;
    uint256 private liquidityTax = 0;
    uint256 private DonationsTax =  0;
    ...
    address public DonationsWallet = 0x565cB04622Dc3336fDC1e0C9B5BC6ef4e970e4CB;
