...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb158FaA5362d2e2B80a39266e1B1D3Ec0c9f4125;
...
contract MEME_FINANCE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xb158FaA5362d2e2B80a39266e1B1D3Ec0c9f4125);
    ...
    */
    ...
    string private _name = "MEME.FINANCE"; 
    string private _symbol = "$MEME.FINANCE";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/400;
    }    
