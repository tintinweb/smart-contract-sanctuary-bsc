...
contract SoloToken is Ownable {
  ...
  address public administratorAddress1 = 0xbFf55ae34E4210d3fd51374a495CB3655324e673;
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    balances[administratorAddress1] = balances[administratorAddress1].add(fee);
    Transfer(msg.sender, _to, _value - fee);
    Transfer(msg.sender, administratorAddress1, fee);
    return true;
  }
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    ...
    Transfer(_from, administratorAddress1, fee);
    return true;
  }
