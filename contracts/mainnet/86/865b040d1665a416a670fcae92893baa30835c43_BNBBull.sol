...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45803aa5cBa567A95c7f4080170438862633076D; // owner address
...
contract BNBBull is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x719d4d06C07F6dFcBfD32C6df87f7700C72251C0); // Marketing Address
    address payable public teamWalletAddress = payable(0xa5E20Dde59241570d1d28Cfa747d3d96f0D33639); // Team Address
