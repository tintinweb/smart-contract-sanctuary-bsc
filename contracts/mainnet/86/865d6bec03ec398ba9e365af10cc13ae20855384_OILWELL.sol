...
contract OILWELL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OILWELL";
    string private _symbol = "OWL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Bd656caB1A1F2982Db819Ac46F0603e1Bb61d69); // Marketing Address
    address payable private teamWalletAddress = payable(0x0Bd656caB1A1F2982Db819Ac46F0603e1Bb61d69); // Team Address
    ...
    uint256 public minimumTokensBeforeSwap = 1 * 10**6 * 10**_decimals; 
