...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _symbol = "nBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9638fD27c22De0B0D0a842db7Fe1fF1B9d8dE56b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9638fD27c22De0B0D0a842db7Fe1fF1B9d8dE56b); // BuyBack Address
