...
Telegram: https://t.me/UMBProtocolGlobal
...
contract UmbrellaProtocol  is Ownable, IERC20 {
    ...
    uint256 public _maxTxAmount = 960000000 * 10 ** _decimals;

    uint256 public _fee = 5;

    string private _name = " Umbrella Protocol ";

    string private _symbol = "UMBP";
