...
contract TEST2 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    function _buy(
        ...
        if(!isDividendExempt[msg.sender]){ try distributor.setShare(msg.sender, _balances[msg.sender]) {} catch {} }
   ...
   /** Sends Tokens to the buyer Address */
    ...
    function _sell(
        ...
        uint256 amountdiv = (amountTax * rewardsShare) / SHAREDIVISOR;
        uint256 SRGtoSend = amountSRG - amountTax -amountdiv;
      
       try distributor.deposit{value:amountdiv}() {} catch {}
