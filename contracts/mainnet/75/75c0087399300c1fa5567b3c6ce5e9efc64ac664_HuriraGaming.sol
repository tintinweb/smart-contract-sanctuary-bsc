...
contract HuriraGaming is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HuriraGaming";
    string constant _symbol = "$HG";
    ...
    uint256 public swapThreshold = _totalSupply * 33 / 10000;
