...
library SafeMath {
 ...
 contract cryptoastronaut is IERC20, Ownable {
    ...
    constructor (
        ...
        _name = 'CryptoAstronaut';
        _symbol = 'TKR';
        _decimals = 9;
        
        launchTime= 1670348869;
       ...
       /*  ISwapRouter swapRouter = ISwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); */
        ...
        MarketingAddress = 0x2561eAF487fbd446a0bc0ad1443F614F603d301A;
        RepoAddress = 0x2073ea36F768033c3D807f1655144Acace63Df1E;
    ...
    function swapTokenForETH(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 MarketingAmount = balance.mul(_sellMarketingFee).div(_totalSellFee);
        uint256 RepoAmount = balance.mul(_sellRepoFee).div(_totalSellFee);
