...
/* 
Inspired by the recent  SILOS Coin
...
contract SilosBlack is Context, IERC20, Ownable {
    ...
    string private constant _name = "SILOS Black";
    string private constant _symbol = "S-BLACK";
