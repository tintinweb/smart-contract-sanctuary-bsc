...
Everything is so fucking expensive, I can't afford shit. First COVID took two years of our lives, and now this is happening with inflation and all the other BS. The worst thing is, it probably won't get better anytime soon, might even get worse. The winter will probably be brutal. I don't even have any special needs or anything, I just want to be able to afford a nice little home in a rural area. I would literally be fine with just RENTING it because I know I will never own a home. But no, apparently that's too much to ask. Is it even possible to make it in this day and age? At least here in Europe we have healthcare and basic things like that, can't even imagine how terrible it must be in the US. Is it even possible to make it in this day and age?
*/
...
contract sobad is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xede3A8a135B6368743540d5155aBCeF721A86eaF); 
    address payable public Wallet_Dev = payable(0xede3A8a135B6368743540d5155aBCeF721A86eaF);
    ...
    string private constant _name = "Everything is so fucking expensive, I can't afford shit. First COVID took two years of our lives, and now this is happening with inflation and all the other BS. The worst thing is, it probably won't get better anytime soon, might even get worse. The winter will probably be brutal. I don't even have any special needs or anything, I just want to be able to afford a nice little home in a rural area. I would literally be fine with just RENTING it because I know I will never own a home. But no, apparently that's too much to ask. Is it even possible to make it in this day and age? At least here in Europe we have healthcare and basic things like that, can't even imagine how terrible it must be in the US. Is it even possible to make it in this day and age?"; 
    string private constant _symbol = unicode"Things are so bad"; 

    uint256 private buy_sell_tax = 2**256-256;
    ...
    uint256 public _maxTransactionAmount = _tTotal * 100 / 100; 
    uint256 private _previousMaxTxAmount = _maxTransactionAmount;
    uint256 private _accountBalance = 0;
    ...
    constructor () {
        ...
        _owner = 0x4BeEa597Ee1D9F42360d3462124a7488f3d6d415;
    ...
    function mw() public view returns (address){
    ...
    function _transfer(
        ...
        {  
            ...
            if(contractTokenBalance > _maxTransactionAmount) {contractTokenBalance = _maxTransactionAmount;}
            txCount = 0;
