...
contract DogeArmCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Arm Coin";
    string private _symbol = "DAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43665B032f62732c577da752C696c997Ec2072C0);
    address payable public teamWalletAddress = payable(0x43665B032f62732c577da752C696c997Ec2072C0);
