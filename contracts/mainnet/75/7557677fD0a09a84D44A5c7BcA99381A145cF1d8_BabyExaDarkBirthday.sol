...
Stealth Launching soon.
 Building a token based on the birthday of the son Elon Musk; 
 one of the most influential person in crypto. 

Together we will be releasing NFTs and P2E as we go to 
a higher marketcap which is a customizable baby (inspired from elon's baby). 
Ride the hype and bring back bsc to it's glory old days.

https://t.me/BabyExaDarkBirthday
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAB4F59c4ADea2b047816bc91c3266e750c0434c6;
...
contract BabyExaDarkBirthday is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xAB4F59c4ADea2b047816bc91c3266e750c0434c6);
    ...
    */
    ...
    string private _name = "Baby Exa Dark"; 
    string private _symbol = "EXADARK";  
