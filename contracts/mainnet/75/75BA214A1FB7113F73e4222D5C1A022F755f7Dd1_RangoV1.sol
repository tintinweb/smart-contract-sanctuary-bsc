...
contract RangoV1 is BaseContract, RangoCBridgeProxy, RangoAnyswap {
...
contract RangoCBridgeProxy is BaseContract {
    ...
    function cBridgeIMInternal(
        ...
        (, uint out) = onChainSwapsInternal(request, calls, isNative);
...
contract RangoAnyswap is BaseContract {
    ...
    function anyswapOut(
        ...
        (, uint outputAmount) = onChainSwapsInternal(request, calls, false);
