...
Telegram: https://t.me/BabyKingBscOfficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x582d4F32cf6f031246f8b8665E95DF538cCae018;
...
contract BABYKING is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY KING"; // 
    string private constant _symbol = "BKING"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x7699F3d6C70aF1f7Fb9AD54db7B4aefCDDDf45e4);
