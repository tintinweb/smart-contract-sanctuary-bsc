...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3b43D722F3680263288E2cE832F86F5e3C7aB85F; // whatDOGE
...
contract TSUYURIKANAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tsuyuri Kanao";
    string private _symbol = "TSKANAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b43D722F3680263288E2cE832F86F5e3C7aB85F); // Marketing Address
    address payable public teamWalletAddress = payable(0x3b43D722F3680263288E2cE832F86F5e3C7aB85F); // Team Address
