...
contract KimochiSquid is Context, IERC20, Ownable {
    ...
    string private _name = "Kimochi Squid"; 
    string private _symbol = "KIMOCHI"; 
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x68cfC37b4965Eb87Da1DcD477e28f389D70D803A); // Marketing Address
    address payable public teamWalletAddress = payable(0x68cfC37b4965Eb87Da1DcD477e28f389D70D803A); //  Team Address
    ...
    uint256 public _maxTxAmount = 3 * 10**6 * 10**3 * 10**_decimals; 
