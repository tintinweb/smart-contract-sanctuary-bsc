...
contract GoldRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "GoldRabbit";
    string private _symbol = "GoldRabbit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xDbeed01417Cb24ca51d4D130487904A2682D9d5E); 
    address payable private teamWalletAddress = payable(0x8Bfe664c6B8fe30F3946c042CA9b3957cc88B965); 
