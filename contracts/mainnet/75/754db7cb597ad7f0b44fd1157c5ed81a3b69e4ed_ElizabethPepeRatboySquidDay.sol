...
/**
Name : ElizabethPepeRatboySquidDay
Symbol : $EPRS
...
ElizabethPepeRatBoySquidDay a token meme with the hype in its name merge at the time of its launch.
It is hereby recreating some of its combinations, which will lead investors to the best pumpa.
...
TG : @ElizabethPepeRatBoySquidDay

TG : https://t.me/ElizabethPepeRatBoySquidDay
...
contract ElizabethPepeRatboySquidDay is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3529B1cF8Eb7EecDc7BFCb8284D08abEa5431b48); 
    address payable public Wallet_Dev = payable(0x3529B1cF8Eb7EecDc7BFCb8284D08abEa5431b48);
    ...
    string private constant _name = "ElizabethPepeRatboySquidDay"; 
    string private constant _symbol = unicode"🏎️$EPRS🏎️"; 
    ...
    constructor () {
        ...
        _owner = 0x3529B1cF8Eb7EecDc7BFCb8284D08abEa5431b48;
