...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbFa22a613b0FfC2DC6D65Fb7E30c4Fb2F4E93f8E;
...
contract goldnekosachs is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x45F2fA827F6bC30b29AE5D917c9360B91716ffa4);
    ...
    string private _name = "Gold Neko Sachs"; 
    ...
    function blacklistAddress(address[] calldata addresses) external onlyOwners {
    ...
    function removeBlacklistedAddress(address[] calldata addresses) external onlyOwners {
