...
contract CATKARYL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatKaryl";
    string private _symbol = "$CATKARYL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7FdaA18e6Abf8a6e6E274FB035556C8fE695D9Ea); 
    address payable public TeamWalletAddress = payable(0xcb8A9Bbbb3CAB3C80A8080f4EE29a6e8c818e5BE); 
