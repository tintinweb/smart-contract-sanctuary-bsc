...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xc8ee0700481cE0B59e5128A01f68B605Cc96aeD7;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0xc8ee0700481cE0B59e5128A01f68B605Cc96aeD7),//fund 

        address(0xc8ee0700481cE0B59e5128A01f68B605Cc96aeD7)//dev 
    ){
