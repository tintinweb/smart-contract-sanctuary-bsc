...
contract MultiVesting is Ownable {
    ...
    function getStartDate(address _beneficiary, uint256 _vestingId)
        public
        view
        returns (uint256)
    {
    ...
    function getTotalAmount(address _beneficiary, uint256 _vestingId)
        public
        view
        returns (uint256)
    {
    ...
    function getStepsAmount(address _beneficiary, uint256 _vestingId)
        public
        view
        returns (uint256)
    {
    ...
    function getAvailableAmountAtTimestamp(
        ...
        uint256 stepsPassed = _timestamp.sub(vesting.startedAt).div(STEPS_SIZE);
