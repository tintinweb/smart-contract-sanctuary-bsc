...
contract Maximum_Token is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    event LogRebase(uint256 indexed epoch, uint256 totalSupply);
    string public _name = "Maximum v3";
    ...
    address public MAXIMUMinsurance;
    ...
    constructor() ERC20Detailed("Maximum v3", "MAXIMUM", uint8(DECIMALS)) Ownable() {
        ...
        MAXIMUMinsurance = 0xcfF1ac6BfceA71F3aA05122C9c9a742cde5A4316;
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(MAXIMUMinsurance).call{
            value: amountETHToTreasuryAndSIF.mul(MAXIMUMinsuranceFee).div(
                treasuryFee.add(MAXIMUMinsuranceFee)
            ),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(address _MAXIMUMAutoLiquidityEngine, address _treasuryReceiver, address _MAXIMUMinsurance, address _theBlackHole) external onlyOwner {
        MAXIMUMAutoLiquidityEngine = _MAXIMUMAutoLiquidityEngine;
        treasuryReceiver = _treasuryReceiver;
        MAXIMUMinsurance = _MAXIMUMinsurance;
