...
library Address{
 ...
 contract WIZBA is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3_000_000 * 10*15;
    uint256 public maxBuyLimit = 10_000_000 * 10**15;
    uint256 public maxSellLimit = 5_000_000 * 10**15;
    uint256 public maxWalletLimit = 10_000_000 * 10**15;
    
    uint256 public genesis_block;
    
    address private marketingWallet = 0x0e3D89997762Bc31ec995467104Ae9381f2dF2f4;
    address private donationWallet = 0x0e3D89997762Bc31ec995467104Ae9381f2dF2f4;
    address private buybackWallet = 0x0e3D89997762Bc31ec995467104Ae9381f2dF2f4;

    string private constant _name = "Wizard Shiba";
    string private constant _symbol = "WIZBA";
    ...
    Taxes private taxes = Taxes(0, 10, 0, 0, 0);
    Taxes private sellTaxes = Taxes(0, 10, 0, 0, 0);
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(donationAmt > 0){
            payable(this).sendValue(donationAmt);
        }
    ...
    function updateSwapTokensStuck(uint256 weiAmount, address _to) external onlyOwner{
