...
contract SANJI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAb63b8363A90100a58AF095eF84649D12Cc58129); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xAb63b8363A90100a58AF095eF84649D12Cc58129); // Development Address
    ...
    uint256 private _totalSupply = 333 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 333 * 10**6 * 10**9;
    uint256 public _walletMax = 333 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 333 * 10**6 * 10**9;
