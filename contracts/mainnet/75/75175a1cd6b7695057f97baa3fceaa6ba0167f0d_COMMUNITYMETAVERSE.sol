...
contract COMMUNITYMETAVERSE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**0;
    uint256 public _maxTxAmount = 50000 * 10**0; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000000 * 10**0; //
    string private constant _name = "COMMUNITY METAVERSE"; // 
    string private constant _symbol = " CMETA "; //    
    uint8 private constant _decimals = 0; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x8A42Ac207abAA1a1Cd79bcBd0b40F018Aa5eACdE;
