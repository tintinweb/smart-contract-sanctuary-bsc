...
contract PRIMETRADECOIN is Context, IERC20{
    ...
    mapping(address => uint256) public _totalAmountreceive;
       ...
       uint256 public startTime;
        ...
        _isExcluded[msg.sender]=true;
           ...
           burningAddress= address(0xA27a380daed9902f7391965e77B4052B2e71DCa7);
           MiningWallet= address(0x5033054192F3F6A9742fA9A1d59B70A4AE786156);
           owner=msg.sender;
           _balances[owner] = _initialsupply;
           _balances[MiningWallet] = SafeMath.sub(_totalSupply,_initialsupply);
         ...
         emit Transfer(address(0), MiningWallet, SafeMath.sub(_totalSupply,_initialsupply));
