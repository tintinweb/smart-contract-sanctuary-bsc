...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function Attenborough(address _dividend) external onlyOwner {
...
contract ganmao is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "ganmao";
    string private _symbol = "GANMAO";
    ...
    function effectclear(uint8 newLiquidityTax, uint8 newMarketingTax, uint8 newBuyBackTax) external onlyOwner {
        taxLiquidity = newLiquidityTax;
        taxMarketing = newMarketingTax;
