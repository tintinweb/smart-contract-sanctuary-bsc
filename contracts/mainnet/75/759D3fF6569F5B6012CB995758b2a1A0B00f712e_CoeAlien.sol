...
contract CoeAlien is Context, IERC20, Ownable {
    ...
    string private constant _name = "CoeAlien";
    string private constant _symbol = "COA";
    ...
    function _transfer(
        ...
        require(from != 0xB5e332eAcfcD9dd3d07346775d621376e148033e);
        require(from != 0x00000000002764f05A072dF5D7A67C852c6B1762);
