...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function _tokengeneration(address account, uint256 amount) internal virtual {
        require(account != address(0), "BEP20: generation to the zero address");
...
contract HelpingShiba is BEP20, Ownable {
    ...
    address public marketingWallet = 0x7208999186BD4FeED37c6D7Dcf72c8df117614F6;
    address private charityWallet = 0xc0EfF6A4093921DDf11f4FF95321De6deA7C8161;
    address public teamWallet = 0x2832f1A2F5142bC06139D93d3C61811485aC28F8;
    ...
    Taxes private taxes = Taxes(5, 3, 2, 2);
    Taxes private sellTaxes = Taxes(5, 3, 2, 2);
    ...
    constructor(address routerAdd) BEP20("HELPING SHIBA", "HEBA") {
    ...
    function updateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _charity, _liquidity, _team);
        require((_marketing + _charity + _liquidity + _team) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _charity,_liquidity, _team);
        require((_marketing + _charity + _liquidity + _team) <= 20, "Must keep fees at 20% or less");
    }
