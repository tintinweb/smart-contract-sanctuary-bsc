...
contract Pigmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pigmine";
    string private _symbol = "Pigmine";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x28610F29fa8c3F542a7db40675a41E2CC2A1af8e); 
    address payable public BurnedWalletAddress = payable(0x28610F29fa8c3F542a7db40675a41E2CC2A1af8e); 
