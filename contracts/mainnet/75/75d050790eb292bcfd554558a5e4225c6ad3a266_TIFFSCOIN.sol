...
contract TIFFSCOIN is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 0.0005 * 10**9; //
    string private constant _name = "TIFFS COIN"; // 
    string private constant _symbol = "TIFFS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x716ea32812aEf4F949e3e1EEE67CeF47A6dF4ce1;
