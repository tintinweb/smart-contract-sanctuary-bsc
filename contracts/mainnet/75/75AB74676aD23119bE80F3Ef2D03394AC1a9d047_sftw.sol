...
contract sftw is Context, IERC20, Ownable {
    ...
    string private _name = "sftw";
    string private _symbol = "sftw";
	...
	// fee list end
	address public ownerAddress = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);
    
	address public marketAddress = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);

    address public marketAddress2 = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);
	
	address public lpAddress = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);

    address public lpAddress2 = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);
	
	address public nftAddress = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);

    address public oskAddress = address(0xC5db5aFee4C55DfAD5F2b8226C6ac882E6956a0A);

    address public backAddress = address(0x1b8b1ef84fdeEF52dFD5a9c84268727dF70c16cC);
