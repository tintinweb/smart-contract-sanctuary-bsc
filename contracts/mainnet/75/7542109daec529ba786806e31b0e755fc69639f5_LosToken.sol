...
contract LosToken is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000;   //10 LOS tokens
    // Trading bool
    ...
    /**z
     * @notice Constructs the LOS token contract.
     */
    constructor(address _feeWallet, address _router) public BEP20("lotteonstore", "LOS") {
        operator = _msgSender();
        emit OperatorTransferred(address(0), operator);
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(address(_router));
    ...
    /// @dev overrides transfer function to meet tokenomics of LOS
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if( 
            ...
            super._transfer(sender, feeWallet, minSwapAmount);
        }
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "LOS::transferOperator: new operator is the zero address");
