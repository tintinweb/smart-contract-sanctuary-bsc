...
contract oFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "October Floki"; //
    string private constant _symbol = "O-Floki"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address private _marketingWallet = 0xdFb6C8e4597BECc70B4adcd33213561B6A8431e5 ;
