...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'TXTD';
    string private _symbol = 'TXTD';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x27D9813A31d49aC63453d93b471C217D11256a09);
    ...
    constructor () public {
        _rOwned[0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a] = _rTotal;
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a] = true;

        
        emit Transfer(address(0), 0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a, _tTotal);
    }
