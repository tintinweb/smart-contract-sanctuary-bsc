...
contract MARSDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "Mars Doge";
    string private _symbol = "$MD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9A54b370B3a4504fB6B179a3D4C571C7EA10cD66);
    address payable public teamWalletAddress = payable(0x9A54b370B3a4504fB6B179a3D4C571C7EA10cD66);
