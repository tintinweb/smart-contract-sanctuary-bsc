...
contract Sinceredoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "SincereBabyDoge";
    string private constant _symbol = "SBabyDoge";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xA5598956aeffE53E4835e6E88733634E5eE1bA2C);
    address payable private _marketingAddress = payable(0xA5598956aeffE53E4835e6E88733634E5eE1bA2C);
