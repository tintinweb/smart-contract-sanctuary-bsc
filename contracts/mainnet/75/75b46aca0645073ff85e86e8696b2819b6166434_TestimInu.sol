...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Testim Inu";
    string internal constant SYMBOL = "TESTIMNU";
...
abstract contract SafeCinuAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract TestimInu is SafeCinuAbstract {
    constructor() SafeCinuAbstract(Env.MainnetV2) {
