...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public MetaFlokiAvatarsLottery;
     ...
     * @param _seed: seed provided by the MetaFlokiAvatarsSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == MetaFlokiAvatarsLottery, "Only MetaFlokiAvatarsLottery");
    ...
    /**
     * @notice Set the address for the MetaFlokiAvatarsLottery
     * @param _MetaFlokiAvatarsLottery: address of the MetaFlokiAvatarsSwap lottery
     */
    function setLotteryAddress(address _MetaFlokiAvatarsLottery) external onlyOwner {
        MetaFlokiAvatarsLottery = _MetaFlokiAvatarsLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPancakeSwapLottery(MetaFlokiAvatarsLottery).viewCurrentLotteryId();
    }
}