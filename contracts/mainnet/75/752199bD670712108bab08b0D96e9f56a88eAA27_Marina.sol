...
pragma solidity ^0.6.2;
contract Marina is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    uint256 public swapTokensAtAmount = 1000 * (10**18);
    address public _marketingWalletAddress = 0xfd7FcC937325d3e6e8Ae5b14F2b622977385e452;
    ...
    constructor() public ERC20("Marina", "Marina") {
    ...
    function _swapAndLiquid() private {
        ...
        if (balances > swapTokensAtAmount) {
            ...
            (bool success,) = address(_marketingWalletAddress).call{value: forBuyback}("");
            if(success) {}
