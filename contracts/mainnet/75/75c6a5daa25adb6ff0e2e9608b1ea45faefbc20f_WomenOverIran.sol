...
//WomenOverIran ($WIN)
//It is a decentralized finance (DeFi) token on the Binance Smart Chain (BSC).

//$WIN is a binance smart chain token that will stealth launch. The total supply will be 85 030 000 million coins which 
//is the population of Iran. The circulating supply will be the same as the number of Iranian women, 42 120 000. 
//While the burned tokens will be the same as the Iranian men 42 910 000. 
//One of the key functionalities is that it is a decentralised finance protocol.


pragma solidity ^0.8.4;
import "./Libraries.sol";
contract WomenOverIran is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'WomenOverIran';
    string private constant _symbol = 'WIN';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply=  85030000* 10**_decimals;
...
//One of the key functionalities is that it is a decentralised finance protocol.
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        if(isSell){  
            ...
            uint BuyTaxDuration=180 seconds;
