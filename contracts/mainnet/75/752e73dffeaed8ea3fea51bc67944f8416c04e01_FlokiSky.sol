...
contract FlokiSky is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAc09274D90129959980B7D7a82B75405038D6d18); 
    address payable private Wallet_Dev = payable(0xAc09274D90129959980B7D7a82B75405038D6d18);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Floki Sky"; 
    string private constant _symbol = unicode"FlokiSky"; 
    ...
    constructor () {
        ...
        _owner = 0xAc09274D90129959980B7D7a82B75405038D6d18;
