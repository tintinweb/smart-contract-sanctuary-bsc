...
contract ShakitaInuWorlCupNFT is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable  {
    ...
    mapping (bytes32 => bool) hashedMessages;

    uint256 public priceToken = 200000000000000000000000;

    uint256 public priceLuckyNative = 100000000000000000;

    
    uint256 public priceNative = 250000000000000000;

    uint256 public priceLuckyToken = 25000000000000000000000;
    ...
    address tokenContract = 0x76E08e1c693D42551dd6ba7C2A659F74ff5Ba261;

    address developmentAddress = 0x8104d38d2Cb8e7F16E7B4B9bb4901AF09e86cA75;
 
    constructor() ERC721("Shakita Inu World Cup NFT", "SHAKITAINUNFT") {}
    ...
    function VerifyMessage(bytes32 _hashedMessage, uint8 _v, bytes32 _r, bytes32 _s) internal returns (address) {
        require (hashedMessages[_hashedMessage] != true, "Hash message the same!");
        hashedMessages[_hashedMessage] = true;
