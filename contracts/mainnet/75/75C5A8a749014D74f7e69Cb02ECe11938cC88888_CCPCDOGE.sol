...
contract CCPCDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "CCPCDOGE";
    string private _symbol = "CCPCDOGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xcB8c749962DfcB04097F5e40051094695039af3D);
