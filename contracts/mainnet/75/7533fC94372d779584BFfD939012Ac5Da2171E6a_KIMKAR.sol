...
// MAKE YOUR CRYPTO WALLET AS BIG AS KIM KARDASHIAN's ASS
// Karda$$wap Launch at J+1,  High Apy Staking, NFT collaboration on OPENSEA
// BAYC holder teams
// FRENCH x CHINA PARTNERSHIP
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1878423e8958D786e64c4b1Cd2E18cD26e46C518;
...
contract KIMKAR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5cdd26231b56B562509d2551071804b2b4A24646;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kim KardASS";
    string private _symbol = "KIMKAR";
