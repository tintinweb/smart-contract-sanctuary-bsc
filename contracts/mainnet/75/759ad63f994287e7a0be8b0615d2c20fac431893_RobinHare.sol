...
contract RobinHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RobinHare";
    string private _symbol = "Robinhare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6718024BB14aBe80faF2FF7972c46CeC7812A26E);
    address payable public BuyBackWalletAddress = payable(0x6718024BB14aBe80faF2FF7972c46CeC7812A26E);
