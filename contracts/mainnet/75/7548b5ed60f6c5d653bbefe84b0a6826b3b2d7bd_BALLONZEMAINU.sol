...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x82f3D903c760B643864Fc90Dc96ae90646A38E8C;
...
contract BALLONZEMAINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Ballonzema Inu"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x82f3D903c760B643864Fc90Dc96ae90646A38E8C), BNB_Tot);
            }
