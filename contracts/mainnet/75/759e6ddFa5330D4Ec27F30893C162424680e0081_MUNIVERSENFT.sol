...
// File: contracts/MUNIVERSENFT.sol
...
contract MUNIVERSENFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public maxMint = 1111;
    uint256 public normalPrice = 0.3 ether;
    ...
    constructor(string memory _baseURI) ERC721("Muniverse NFT", "MuniverseNFT") {
        baseUrl = _baseURI;
    }
