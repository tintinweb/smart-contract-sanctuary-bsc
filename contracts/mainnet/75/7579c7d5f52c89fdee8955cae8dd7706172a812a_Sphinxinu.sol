...
//
//
//   📱Telegram::https://t.me/SphinxInuPortal
//   📱Website ::https://sphinxinu.space/
/*
...
contract Sphinxinu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Sphinxinu", "Sphinxinu") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Sphinxinu";
    string private _symbol = "Sphinxinu";
