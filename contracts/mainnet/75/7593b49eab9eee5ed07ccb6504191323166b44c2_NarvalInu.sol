...
/**
   #Narval Inu The New Community of Ape Token
    
   I make this #Narval Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: Narval Inu is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/NarvalInuPortal
...
contract NarvalInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Narval Inu";
    ...
    address private marketingWallet = address(0x53d4DeDaB5fB77698Eca194D3A5f5F2Cb3EdfD09);
