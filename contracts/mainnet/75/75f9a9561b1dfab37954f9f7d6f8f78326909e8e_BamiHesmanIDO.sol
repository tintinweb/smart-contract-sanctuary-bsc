...
contract BamiHesmanIDO is Ownable, ReentrancyGuard {
    ...
    // Token
    ERC20 public hesmanToken; // Hesman
    ...
    // claim
    function claimIdoPool1() public nonReentrant isRun {
        ...
        require(hesmanPool1.paidIdoMap(msg.sender), "Not paid IDO");
    ...
    function claimIdoPool2() public nonReentrant isRun {
        ...
        require(hesmanPool2.paidIdoMap(msg.sender), "Not paid IDO");
    ...
    function claimIdoPool3() public nonReentrant isRun {
        ...
        require(hesmanPool3.paidIdoMap(msg.sender), "Not paid IDO");
    ...
    function setVestingUser(address _pool, address[] calldata _userList, uint256 _vesting) public onlyOwner {
        for (uint256 index = 0; index < _userList.length; index++) {
            vestingMap[_pool][_userList[index]] = _vesting;
        }
    }
