...
contract Token is ERC20, Ownable {
    ...
    modifier isAuth() {
        // if contract is renounced then noone is authorized to make changes
    ...
    constructor() ERC20("EsQo", "EsQo") {
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        address _owner = 0x17976aB5E9b3D1E19F4165f7c393Bf8322276CbC;
    	...
    	marketingWallet = address(0x17976aB5E9b3D1E19F4165f7c393Bf8322276CbC); // set as marketing wallet
    	devWallet = address(0x17976aB5E9b3D1E19F4165f7c393Bf8322276CbC); // set as dev wallet
    	buyBackWallet = address(0x17976aB5E9b3D1E19F4165f7c393Bf8322276CbC); // set as buyBackWallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(0x17976aB5E9b3D1E19F4165f7c393Bf8322276CbC, true);
    ...
    function updateMaxAmount(uint256 newNum) external isAuth {
        require(newNum >= (totalSupply() * 3 / 100)/1e18, "Cannot set maxTransactionAmount lower than 3%");
        maxTransactionAmount = newNum * (10**18);
    }
    
    function updateMaxWallet(uint256 newNum) external isAuth {
        require(newNum >= (totalSupply() * 3 / 100)/1e18, "Cannot set maxTransactionAmount lower than 3%");
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _buyBackFee) external isAuth {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _buyBackFee) external isAuth {
