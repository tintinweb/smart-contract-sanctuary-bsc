...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50E414EBd213c6f5b777580B75aEc69B8Fe9D918;
...
contract OneDollarMillionaire is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAb088E78AA46eb0F6c4B09a0F28b34C966Dc3f0C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "One Dollar Millionaire";
    string private _symbol = "1$M";
