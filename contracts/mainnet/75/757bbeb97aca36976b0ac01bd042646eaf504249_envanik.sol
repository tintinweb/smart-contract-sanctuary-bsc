...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xB0EeB0632bAB15F120735e5838908378936bd484);
        _token = msg.sender;
    }
...
contract envanik is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //autoshark
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = uint256(-1);

        distributor = new DividendDistributor(0xB0EeB0632bAB15F120735e5838908378936bd484);
        ...
        marketingFeeReceiver = 0x8A2Cb0a20f6F7e03a3204171383e68E60E9E32cF;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        teamFee = _teamFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee;
