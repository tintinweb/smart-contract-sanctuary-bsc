...
contract PeopleSwar is ERC20 {
	...
	address _fund1Address = address(0x2757078e88396b9657983256057EfCb5D298A3fF);
	address _fund2Address = address(0x458593222f8a8A92e592C3BB60B35360736C05A2);
    ...
    constructor(address tokenOwner) ERC20("WDOGE", "WDOGE") {
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
		...
		if(newbalance>0){
			USDT.transfer(_fund1Address,newbalance.div(10).mul(3));
			USDT.transfer(_fund2Address,newbalance.div(10).mul(2));
		}
    }
