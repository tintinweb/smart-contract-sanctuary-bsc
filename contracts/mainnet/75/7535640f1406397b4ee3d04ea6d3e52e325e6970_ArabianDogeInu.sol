...
contract ArabianDogeInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000_000 * 10**1;
    uint256 public _maxTxAmount = 100_000_000_000 * 10**1; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100 * 10**1; //
    string private constant _name = "Arabian Doge Inu"; // 
    string private constant _symbol = "ARABIANDOGE"; //    
    uint8 private constant _decimals = 4; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xE79a45639779Fa7EBc2B0E256BDD2278939671A1;
