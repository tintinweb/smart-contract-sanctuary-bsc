...
contract SoCalStaking is Ownable, ReentrancyGuard, Pausable{
    ...
    require(IERC20(STAKECONTRACTADDRESS).totalSupply() <= MAXMARKETCAP,"Market Cap Reached threshold cannot calculate reward");
