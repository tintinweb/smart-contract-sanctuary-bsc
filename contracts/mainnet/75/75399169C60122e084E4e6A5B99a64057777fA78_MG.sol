...
contract MGDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MG contract."
        );
    }
...
contract MG is ERC20, Ownable {
    ...
    MGDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        _marketingWalletAddress = 0xCA1561eD05159e67df213613e262e2F5a9E7F9d4;
        _fundWalletAddress = 0xAC87C1DaCae2c65FD3895688d95B52132221e1DF;
        ...
        dividendTracker = MGDividendTracker(
            payable(Clones.clone(0xA8e904A9BC8D4EC411C6e954904c181d2F714157))
        );
        ...
        excludeFromFees(0xb860a5d68f1707d424428e7604b818E408440122, true);
        _mint(0xb860a5d68f1707d424428e7604b818E408440122, totalSupply-1 * (10**18));
