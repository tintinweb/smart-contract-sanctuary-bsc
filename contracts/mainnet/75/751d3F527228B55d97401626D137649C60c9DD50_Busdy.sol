...
/**
 * Busdy (BUSDY)
 * Official Telegram Group for the $BUSDY Token.
 * Home of the Most Bodacious BUSD Rewards on BSC (15%), Join us for Boobs, Beer & BUSD!
 * https://t.me/OfficialBUSDY
 *
 */
...
contract Busdy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Busdy";
    string private constant _symbol = "BUSDY";
