...
Website: https://t.me/mysterylaunchstones
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x73436905d4E0c4A135D6101055286A2846FDF7fC; // owner address
...
contract GOATINU2V  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goat Inu 2.0";
    string private _symbol = "GOAT2V"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73436905d4E0c4A135D6101055286A2846FDF7fC); // Marketing Address
    address payable public teamWalletAddress = payable(0x73436905d4E0c4A135D6101055286A2846FDF7fC); // Team Address
