...
contract LILTSUKA is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Lil Tsuka";
    string private constant _symbol = unicode"LILTSUKA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xe573FBB04120CD33dd39Ef8867706784d9e91c46);
    address payable public MarketingWallet = payable(0xff86314F3Eef9c7dCeDcccF3e4c0B48FEbD534aB);
