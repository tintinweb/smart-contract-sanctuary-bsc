...
contract ELaunch is IERC20 {
    ...
    string constant private _name = "E-Launch";
    string constant private _symbol = "ELNCH";
...
//===============================================================================================================
    ...
    function setBuyLimits(uint256 buyVal, uint256 buyMult) external onlyOwner {
        maxCurrencyBuy = buyVal * 10**buyMult;
        require(maxCurrencyBuy >= 5 * 10**17);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if (tradingLimitsEnabled) {
                if(buy) {
                    require(ethBalance <= maxCurrencyBuy);
                }
            }
        }
