...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDF61747bd3418900A3986d06cfB751bcD16ee1E6; // owner address
...
contract ShibaWhales is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Whales";
    string private _symbol = "$SHELS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable (0x75B0EC399044cAc1A6a5755bc5BEd0446799cdF6); // Marketing Address
    address payable public teamWalletAddress = payable (0xF3e059CAD46180016DC86400e189B8A47B0c0E0f); // Team Address
