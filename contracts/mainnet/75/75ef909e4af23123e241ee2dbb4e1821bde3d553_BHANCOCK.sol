...
|TELEGRAM: https://t.me/SnakePrincessbsc
*/
...
contract BHANCOCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Snake Princess ";
    string private _symbol = " $BHANCOCK "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39FEd9143960342dDb6798499238BC9167086D34); 
    address payable public teamWalletAddress = payable(0xfb640459841f4AE7e48ABA37a21Daf39aE970765);
