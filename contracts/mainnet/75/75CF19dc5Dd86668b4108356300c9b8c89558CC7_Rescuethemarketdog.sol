...
contract Rescuethemarketdog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rescue the market dog";
    string private constant _symbol = "Rdoge";
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =  10000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 10000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 10000000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 10000000000000 * 10**_decimals;

    address public marketingWallet = address(0xBC5703a67dF4a335bbd7D2fb163d37AC5799268C);
    address public devWallet = address(0xBC5703a67dF4a335bbd7D2fb163d37AC5799268C);
