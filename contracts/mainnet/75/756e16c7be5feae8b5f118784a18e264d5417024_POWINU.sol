...
/*
            ...
            WELCOME TO POWER INU
    🛡 Website: https://powerinu.site/
    🛡 Twitter: https://t.me/powerinuportal
    🛡 Telegram: https://twitter.com/power_inu
...
contract POWINU is IBEP20, Auth {
    ...
    string constant _name = "Power Inu";
    string constant _symbol = unicode"POWINU";
    ...
    function EnableTrading(bool state) public onlyOwner {
        tradingOpen = state;
    }
    ...
    // Exclude bots
    function BlacklistWalletAddress(address _address, bool _value) public onlyOwner{
