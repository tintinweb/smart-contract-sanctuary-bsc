...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //SHIBA
...
contract FanZhiYi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x999e7dfb5561261e3B4E2F124D3CC96Fb297e417)); //marketing wallet
    ...
    constructor() ERC20("FanZhiYi", "FZY") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("FanZhiYi_Dividend_Tracker", "FanZhiYi_Dividend_Tracker")
    {
        claimWait = 1;
        minimumTokenBalanceForDividends = 2000000 ; //must hold 20000+ tokens
    }
