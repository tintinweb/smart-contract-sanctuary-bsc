...
contract Lunamikro is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Mikro";
    string private constant _symbol = "LUNAMIKRO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0978bcC3dbdd306f5b99e5Fa5071578365c58463);
    address payable private _marketingAddress = payable(0x0978bcC3dbdd306f5b99e5Fa5071578365c58463);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnBuy < 3, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 6, "Tax cannot be more than 8.");
