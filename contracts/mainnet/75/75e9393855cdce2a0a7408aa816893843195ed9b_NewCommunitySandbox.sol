...
contract NewCommunitySandbox is Context, IERC20, Ownable {
    ...
    string private constant _symbol = " $cSAND "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x380C4a1317534A3C91d84197806d03aB829cce77;
