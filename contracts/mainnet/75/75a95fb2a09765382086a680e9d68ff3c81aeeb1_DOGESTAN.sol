...
contract DOGESTAN   is ERC20 {
 
    constructor(string memory __name, string memory __symbol, address _charity, address _owner, uint8 _decimal, uint256 _totalSup, uint256 _swapAndLiquify, uint256 _number) {
