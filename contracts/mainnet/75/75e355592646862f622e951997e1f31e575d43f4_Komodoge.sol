...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9281FCd0787005AE5D083B564D98072f6C46d009; // owner address
...
contract Komodoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Komodoge";
    string private _symbol = "Komodoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb13Aa1287D938b1f8ed217eF0d2d31a37C765a21); // Marketing Address
    address payable public teamWalletAddress = payable(0xb13Aa1287D938b1f8ed217eF0d2d31a37C765a21); // Team Address
    ...
    uint256 public _sellLiquidityFee = 80;
