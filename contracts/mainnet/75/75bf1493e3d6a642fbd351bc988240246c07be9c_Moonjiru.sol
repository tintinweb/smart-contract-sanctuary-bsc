...
contract Moonjiru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonjiru";
    string private _symbol = "Moonjiru";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbE9Ee30fCd321c03D0d4826BDB5Fe1D2F9f94a03);
    address payable public BuyBackWalletAddress = payable(0xbE9Ee30fCd321c03D0d4826BDB5Fe1D2F9f94a03);
