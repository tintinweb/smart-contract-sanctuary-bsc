...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6850b5dC78343abFe2f70CA5F034b190D8a19D0d; // owner address
...
contract BabyChihuahua is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Chihuahua";
    string private _symbol = "BabyChihuahua";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96351D4C6a40f2Ba481cE83d5dDaF8526edDcC2f); // Marketing Address
    address payable public teamWalletAddress = payable(0x6850b5dC78343abFe2f70CA5F034b190D8a19D0d); // Team Address
