...
contract  IBEP2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "685";
    string constant _symbol = unicode"六百八十五";
    ...
    uint256 _totalSupply = 685 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x412B6EB43C4f0d25e9E99556df8B85F89546eC9E;
        marketingWallet = 0x412B6EB43C4f0d25e9E99556df8B85F89546eC9E;
        devWallet = 0x412B6EB43C4f0d25e9E99556df8B85F89546eC9E;
