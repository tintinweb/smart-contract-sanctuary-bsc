...
TG : https://t.me/RaccoonDogTanuki

Raccoon Dog or Tanuki is a beloved icon in Japan, and it is also a symbol of good luck and fortune. Today, we are witnessing the birth of RaccoonDog in BSC, which will also bringing luck for peoples who are trusting it.

By having RaccoonDog, it will also giving all holders reflection as a token of gratitude.

1) Supply : 1 Trillion
2) Tax Fees : 9%
3) Starting MC : $260 (1 BNB)
*/
...
contract RaccoonDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "RaccoonDog"; // 
    string private constant _symbol = "RACCOONDOG"; //    
