...
contract sToken is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2722b23ef144E327CA8966AB2E5df8973bE6ba95);
    address payable private _marketingAddress = payable(0x2722b23ef144E327CA8966AB2E5df8973bE6ba95);
    ...
    function rescueForeignTokens(address _tokenAddr, address _to, uint _amount) public virtual onlyOwner {
        emit tokensRescued(_tokenAddr, _to, _amount);	
        Token(_tokenAddr).transfer(_to, _amount);
    }
    
    event devAddressUpdated(address indexed previous, address indexed adr);
    function setNewDevAddress(address payable dev) public virtual onlyOwner {
    ...
    function setNewMarketingAddress(address payable markt) public virtual onlyOwner {
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public virtual onlyOwner {
    ...
    function toggleSwap(bool _swapEnabled) public virtual onlyOwner {
