...
contract Interest is Ownable {
    ...
    constructor(address _tokenAddress) {
        tokenAddress = _tokenAddress;
        minimumTokenBalanceForDividends = 5 * (10 ** 18); //must hold 10000+ tokens
    }
...
contract FcnToken is ERC20, Ownable {
    ...
    constructor( 
        ...
        excludeFromAllLimits(address(inviterTracker), true);
        ...
        */
        _mint(address(inviterTracker), 29950 * 10 ** 18);
        _mint(address(dividendTracker), 30000 * 10 ** 18);
        _mint(owner(), 6716 * 10 ** 18);
    }
