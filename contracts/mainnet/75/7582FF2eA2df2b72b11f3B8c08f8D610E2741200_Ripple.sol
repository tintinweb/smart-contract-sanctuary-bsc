 ...
 * telegram: https://t.me/NewRipple
 ...
 15% Reflections Paid in XRP.
 Auto Staking Contract 
...
contract Ripple is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ripple";
    string constant _symbol = "RIPPLE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 7770 * 10**_decimals;
