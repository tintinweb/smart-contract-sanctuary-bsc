...
contract TRICK_OR_TREAT  is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x17f3A098b36d6A6a3E8EA820a81eAB64785f9240);
    address payable public MarketingWallet = payable(0x0087Aaa5163A12234fC470A931689F0F22256743);
    address payable private feereceiver01 = payable(0xdb4a05E226E72C553E2374701b5bEc21141D6059);
    address payable private feereceiver02 = payable(0x06E6Cd13987332Ee573f1b1D272A7bd0133A45E4);
    address payable private feereceiver03 = payable(0x27eb145Ff150b9220C19484140e4Af0845Ffa319);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (tradingActiveBlock + 5 <= block.timestamp) {limitInEffect = false;}
        if (tradingActiveBlock + 5 <= block.timestamp) {transferDelay = false;}
