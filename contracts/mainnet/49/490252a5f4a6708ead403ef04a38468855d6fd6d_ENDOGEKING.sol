...
contract ENDOGEKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ENDOGEKING";
    string private _symbol = "ENDOGEKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6e1115b6cABe5891aDF12db3d253a37b58F39da1);
    address payable public teamWalletAddress = payable(0x6e1115b6cABe5891aDF12db3d253a37b58F39da1);
