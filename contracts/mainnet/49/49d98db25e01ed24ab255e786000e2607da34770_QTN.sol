...
contract QTN is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0xA8A6f24A0feC76bD115B9Ea19924523740ABD0aE;

    string private _name = "Q8 Token";
    ...
    uint256 public _maxTxAmount = 1000000 * 10**18; // 1%
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Mainne
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee.add(marketingFeePercent)).div(
            10**2
        );
    }
