...
*/
 ...
 /** Flatulence Earther Inu - Elon hyped Token


    With the recent tweet of Elon Musk, 
    we brought it in the crypto world as a community driven project with verified contract.
    ...
    Max Trn   :     4% (4,000,000,000)

// TG: https://t.me/FlatulenceEartherInu
*/
...
contract FlatulenceEartherInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flatulence Earther Inu";
    string private constant _symbol = "$FLEI";
    ...
    address private marketingWallet = address(0xAaafd4430b0Af6e91a428f6371eFe26c95d5f723);
    address private liquidityReceiver = address(0xAaafd4430b0Af6e91a428f6371eFe26c95d5f723);
