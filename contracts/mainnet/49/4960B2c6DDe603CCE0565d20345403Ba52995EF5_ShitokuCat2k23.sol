...
/**
Shitoku Cat 2K23 "SHIK2K23"

Socials:
https://t.me/shib2k23portal
*/
...
contract ShitokuCat2k23 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shitoku Cat 2k23";
    string constant _symbol = "SHIK2K23";
   ...
   function BLBots(address[] memory bots_, bool status) public onlyOwner {
    ...
    function setFees(uint256 _MarketingFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(marketingFee <= 15 && sellMarketingFee <= 15, "Must keep fees at 15% or less");
    }
    ...
    event AutoLiquify(uint256 amountETH, uint256 amountOfToken);
}