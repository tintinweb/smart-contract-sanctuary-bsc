...
Fueled by a motivated & solid organic community and deep developer talented, is built to enable a new wealthy generations                                                              

The Last Samurai ミームバースラボ

Twitter: https://twitter.com/MemeTowers

Telegram: https://t.me/MemeverseL
...
contract TheLastSamurai is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    
    address payable public marketingAddress = payable(0x2457Ff3CcD6643214BE09574F608407dF22C72Bf); 
    address payable public devAddress = payable(0x2457Ff3CcD6643214BE09574F608407dF22C72Bf); 
    ...
    uint256 private _tTotal = 10000000000000 * 10**18; // 10 trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "The Last Samurai";
    string private _symbol = unicode"ラストサムライ";
    uint8 private _decimals = 18;


    uint256 public _taxFee = 0;  // 0% reflect 
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public marketingDivisor = 20; // 2% marketing
    uint256 public devDivisor = 10; // 1% dev
    uint256 public autoLpDivisor = 40; //4% liquidity
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**18; // 100 billion 
    uint256 private minimumTokensBeforeSwap = 10000 * 10**6 * 10**18; // 10 billion
    ...
    constructor () {        
        ...
        _isExcludedFromFee[0x2457Ff3CcD6643214BE09574F608407dF22C72Bf] = true; 
    ...
    function updateFeeDivisor(uint256 newAutoLpDivisor, uint256 newDevDivisor, uint256 newMarketingDivisor) external onlyOwner {
        ...
        require( newTotalFee <= 1000, "cant set fees to more than 100%");
