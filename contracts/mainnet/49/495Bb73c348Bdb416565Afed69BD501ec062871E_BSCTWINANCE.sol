...
contract BSCTWINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Twinance";

    string private _symbol = "$Twinance";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x6fCa900594A5EAEF7B080D7eE9260195EDE96981;
