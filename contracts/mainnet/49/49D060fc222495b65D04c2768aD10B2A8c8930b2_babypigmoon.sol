...
contract babypigmoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babypigmoon";
    string private _symbol = "babypigmoon";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x620FE446bdA82c97DD21D12096d84FB6F2d072DB); 
    address payable public ttWal = payable(0x620FE446bdA82c97DD21D12096d84FB6F2d072DB); 
