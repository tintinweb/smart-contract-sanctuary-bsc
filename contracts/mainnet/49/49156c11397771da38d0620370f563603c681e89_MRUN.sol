...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89Bf29E6dC4BF8B76c6a9962260A4839C221f6B9;
...
contract MRUN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666666666000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MOON RUN";
    string private _symbol = "MRUN";
    uint256 private _buybackstart = 40 / 100 * 0;
    ...
    uint256 public _dogerewards = 1;
    uint256 private _previousdogerewards = _dogerewards;
