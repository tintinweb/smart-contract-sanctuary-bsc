...
contract NAIC  is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "$NAICHA";
    string private _symbol = "NAIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3C685F6838d0d92CdF51a90ADE96EF670E76751); // Marketing Address
    address payable public teamWalletAddress = payable(0xee3567dF1B6e18c77786A8Ab62Aa3fDda051C15A); // Team Address
...
//        testnet 0x66fC7207b0D32acBd0B1bdcaF12c4c3ffa4b8A6c
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x66fC7207b0D32acBd0B1bdcaF12c4c3ffa4b8A6c);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(tokensForTeam > 0){
            ...
            _balances[address(this)] = _balances[address(this)].sub(tokensForTeam);
