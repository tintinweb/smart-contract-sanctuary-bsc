...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xdf2879423091F24F0Fe7EEAefEeF12e84c6D9654;
...
contract StrangerToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x58b645Cc97B262F102db1652E7Db6806f3Ccd4A9; 
    address payable public marketingAddress = payable(0x58b645Cc97B262F102db1652E7Db6806f3Ccd4A9); 
    ...
    string private _name = "StrangerToken";
    ...
    uint256 public _maxBuyAmount = 1 * 10**10 * 10**9;
    uint256 public _maxSellAmount = 1 * 10**10 * 10**9;
    uint256 public _maxWhaleAmount = 2 * 10**10 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**9 * 10**9;
    uint256 public numTokensMinimumSellToAddToLiquidity = 5 * 10**10 * 10**9;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x58b645Cc97B262F102db1652E7Db6806f3Ccd4A9)] = true;
        _isExcludedFromFee[address(0xFDDe039DCeb98a02A2E20F08fD1537b5352487Ef)] = true;
