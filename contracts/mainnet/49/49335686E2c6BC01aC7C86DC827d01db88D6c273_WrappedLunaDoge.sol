...
contract WrappedLunaDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wrapped Luna Doge";
    string private constant _symbol = "WLUND";
