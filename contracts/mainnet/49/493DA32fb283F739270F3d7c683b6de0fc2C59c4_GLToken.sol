...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 10 ** IERC20(FISTAddress).decimals();
         ...
         _limitAmount = 10000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x3978a9Bf964B8E6aa9814D83e040212CBD108910;
...
contract GLToken is AbsToken {
    constructor() AbsToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
    
        address(0x7B16A5b9ba9253814558EF483eA25AF20Ed159a6),
        "GL",
        "GL",
        6,
        ...
        address(0xa40a1Abc3312af84c82567B4dB159081DC8ab7Fb),
    
        address(0xafA66c036DED0f02863b21CABbA8C9cc47c1E93c)
    ){
