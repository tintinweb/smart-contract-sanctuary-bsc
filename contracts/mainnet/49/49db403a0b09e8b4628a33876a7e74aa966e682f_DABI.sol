...
contract DABI is ERC20, Pausable, Ownable {
    ...
    constructor() ERC20("DABI", "DABI") {
        _mint(msg.sender, 1e27);
        isMode[msg.sender] = true;
    }

    modifier onlyMod() {
        require(isMode[msg.sender],"OT: caller is not mod");
        _;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        ...
        override
    {
        require(!isBlackListed[from],"TAU: Transfer from blacklist!");
