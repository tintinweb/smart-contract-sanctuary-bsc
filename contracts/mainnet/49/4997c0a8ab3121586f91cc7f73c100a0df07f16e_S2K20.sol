...
contract S2K20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "S2K2.0";
    string private _symbol = "S2K2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD065C27A34f3Baed00680beC8d211884efA6262f); 
    address payable public teamWalletAddress = payable(0xD065C27A34f3Baed00680beC8d211884efA6262f); 
