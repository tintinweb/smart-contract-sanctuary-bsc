...
contract SpaceZhaogeMikuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceZhaogeMikuInu";
    string private _symbol = "$SZMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57dE69414974C55577A169835E0eE75b4Bd19110); // Marketing Address
