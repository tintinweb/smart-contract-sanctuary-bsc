...
contract GreenNeko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Green Neko";
    string private _symbol = "Gneko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA6B1731Bc3F9227ed7C07e0c8989aeDC37d9AB9A);
    address payable public DevWalletAddress = payable(0xA6B1731Bc3F9227ed7C07e0c8989aeDC37d9AB9A);
