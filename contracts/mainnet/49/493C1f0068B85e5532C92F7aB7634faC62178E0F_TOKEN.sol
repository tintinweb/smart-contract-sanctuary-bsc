...
abstract contract NameToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 2 * 10** Decimals;
        maxSellAmount = 1 * 10** Decimals;
        walletLimit =  2 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x84520c7eb95E03E26D13981Fca7A80e0dAa0d8F5;//
...
contract TOKEN is NameToken {
    constructor() NameToken(
        ...
        unicode"2024-1",//Name
        unicode"2024-1",//Symbol
        9,//Decimals
        202401,//Supply
        address(0x84520c7eb95E03E26D13981Fca7A80e0dAa0d8F5),//FundAddress
        address(0x84520c7eb95E03E26D13981Fca7A80e0dAa0d8F5)//ReceiveAddress
    ){
    }
}