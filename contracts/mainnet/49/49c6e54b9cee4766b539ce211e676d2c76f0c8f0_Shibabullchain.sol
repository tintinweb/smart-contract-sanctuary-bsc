...
contract Shibabullchain is IBEP20, Auth {
	...
	address private marketingFeeReceiver = 0x5F8050c404D33d9dde2D59A352fAE087259595C9;
 
    string constant _name = "Shibabullchain";
    string constant _symbol = "SBULL";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //5% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 5) / 100;  //5% max wallet
