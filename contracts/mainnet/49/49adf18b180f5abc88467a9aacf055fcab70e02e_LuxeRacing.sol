...
contract LuxeRacing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Luxe Racing";
    string private _symbol = "LUXERACING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA17d21dF35af965cdD4fb488cbE9796D17868300); 
    address payable public teamWalletAddress = payable(0xA17d21dF35af965cdD4fb488cbE9796D17868300); 
