...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2aA8c89fC55A9cE8071Ec9D54AdC7E3856fa50Da; // owner address
...
contract FIFAQatar2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " FIFA Qatar2022 ";
    string private _symbol = " $FIFAQATAR22 ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2aA8c89fC55A9cE8071Ec9D54AdC7E3856fa50Da); // Marketing Address
    address payable public teamWalletAddress = payable(0x2aA8c89fC55A9cE8071Ec9D54AdC7E3856fa50Da); // Team Address
