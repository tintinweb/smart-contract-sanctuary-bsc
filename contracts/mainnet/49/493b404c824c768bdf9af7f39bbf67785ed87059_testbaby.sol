...
contract testbaby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

 
    address public MARKETING = 0x2A1D6a63C0e0060644865B1De12a1Ac59CD60647;
    ...
    string private _name = "testbaby";
    string private _symbol = "testbaby";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            _tokenTransfer(from, MARKETING, mktAmount, false);
