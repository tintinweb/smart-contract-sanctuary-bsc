...
contract TOKENS is ERC20, Ownable {
    ...
    uint public removeApplistEnable = 1 * (10**18);
    uint public removeApplistClose = 2 * (10**18);
    ...
    constructor() public ERC20("Workers", "Workers") {
    ...
    function setRemoveApplistEnable(uint value, uint ApplistClose) public onlyOwner {
