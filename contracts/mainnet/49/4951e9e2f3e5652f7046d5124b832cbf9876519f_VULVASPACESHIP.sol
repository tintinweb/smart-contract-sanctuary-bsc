...
I make this #VULVASPACESHIP to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/VULVASPACESHIP
   ...
   I will renounce the ownership to burn addresses to transfer #VVSS to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #VVSS 10000000X? 
...
contract VULVASPACESHIP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "VULVASPACESHIP";
    string private _symbol = "VVSS";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x1f8869cDC79F44f955740795303a1Db79E18eF4E));
        marketingWalletAddress = payable(address(0x1f8869cDC79F44f955740795303a1Db79E18eF4E));
