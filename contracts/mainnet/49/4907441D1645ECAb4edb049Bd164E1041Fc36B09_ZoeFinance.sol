...
contract ZoeFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "Zoe Finance";
    string public _symbol = "ZF";
    ...
    constructor() ERC20Detailed("Zoe Finance", "ZF", uint8(DECIMALS)) Ownable() {
        ...
        blackHole = 0x390a305f21Efc430Ba02320Bd77D586aC2230f1a;
        ...
        _initRebaseStartTime = MAX_UINT256;
        _lastRebasedTime = MAX_UINT256;
        _autoRebase = true;
    ...
    function startRebase() public onlyOwner{            
    ...
    function rebase() internal {
        ...
        if ( inSwap ) return;
        if(_initRebaseStartTime == MAX_UINT256) return;
        uint256 rebaseRate;
