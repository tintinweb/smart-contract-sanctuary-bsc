...
abstract contract Token is IERC20, Ownable {
    ...
    uint256 public _lpFee = 100;    //回流的税费比例
    uint256 public _destroyFee = 0;  //销毁的手续费比例
    uint256 public _lpDividendFee = 300;  //LP分红的手续费比例
  ...
  //设置LP分红的费
    ...
    //设置营销1和营销2的占比
    function setMK(uint256 a,uint256 b ) external onlyOwner {
        mk1=a;
        mk2=b;
    }
   //设置黑名单 防止机器人等恶意攻击
...
contract token is Token {
    constructor() Token(
        ...
        18,
        2023,
        address(0xE43289711dE01cca28219f753f770f1915d69A9C),  //营销1  3%手续费
        address(0x85682C44Ef2Bf0953E4A85C30b7ecD1062fAd527),   //营销地址2  2%手续费
        address(0xF1eDA8db2989563c483da5930974e3980039fAe4),   //接收代币的地址
        0 //限购数量
    ){
