...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BLST = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
/* Token contract */
contract BabyCryptoLegionsBloodstone is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BLST = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xE14C02F50f1FE2ee08A01bAB2deeE7E9b8088e20;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0214f375587C194313727B9639a393D89faEf596;
