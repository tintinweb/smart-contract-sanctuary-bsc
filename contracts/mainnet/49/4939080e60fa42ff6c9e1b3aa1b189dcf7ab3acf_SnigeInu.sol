...
🐍WELCOME TO SNIGE INU🐍

STEALTH LAUNCH

Snige Inu is a community-focused, decentralized cryptocurrency that aims to become the first and only bullish snake in the BSC. Snoge Inu - created for people that recognizes the power of the community and believes that together we can achieve great things.
🐍Safu Dev
🐍LP Locked
🐍Experienced Team
🐍Bullish name & logo
...
contract SnigeInu is IBEP20, Auth {
    ...
    string constant _name = "Snige Inu";
    string constant _symbol = "SNIGE";
    ...
    address private marketingFeeReceiver = 0xa0150B138170a795550e2A1AD858868e233483eC;
    address private developmentFeeReceiver = 0xa0150B138170a795550e2A1AD858868e233483eC;
