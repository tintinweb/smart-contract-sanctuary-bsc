...
//Telegram: https://t.me/secretsafe_launch
...
contract TheChineseRabbit is Context, IBEP20, Ownable {
    ...
    string private _name = "TheChineseRabbit";
    string private _symbol = "$TCR";
    ...
    uint256 public marketFeeOnBuying = 80; // 8% will be added to the market address
    uint256 public devFeeOnBuying = 10; // 1% will be added to the development address
    uint256 public liquidityFeeOnBuying = 10; // 1% will be added to the liquidity

    uint256 public marketFeeOnSelling = 80; // 8% will be added to the market address
    uint256 public devFeeOnSelling = 10; // 1% will be added to the development address
    ...
    function setMaxHoldLimit(uint256 _amount) external onlyOwner {
        require(_amount >= _totalSupply.div(1000), "should be greater than 0.1%");
    ...
    function setBuyFeePercent(
        ...
        require(
            _marketFee.add(_devFee).add(_lpFee) <= percentDivider.mul(3).div(10),
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            require(amount <= maxTxnLimit,"BEP20: max txn limit exceeds");
        }
