...
Telegram :     https://t.me/ProfessorBullChadBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x61F0cD8AC194851c07C725473B883A2057196F29;
...
contract ProfessorBullChad is Context, IERC20, Ownable {
    ...
    string private constant _name = "Professor Bull Chad"; // 
    string private constant _symbol = "$PBC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x61F0cD8AC194851c07C725473B883A2057196F29);
