...
contract JackpotDogeTest3 is IBEP20 {
    string constant _name = "JackpotDogeTest3";
    string constant _symbol = "JPDTest3";
    ...
    uint256 private maxJackpotBalanceBeforeDistribute = 2 ether;
    ...
    address public marketingWallet = 0x4A7Ccd75a4cE2F7BD39547e33a7E6584f5542557;
    address public buyBackWallet = 0x4A7Ccd75a4cE2F7BD39547e33a7E6584f5542557;
...
/////////////////// ADMIN FUNCTIONS ///////////////////////////////////////////////////////////////////////
    ...
    function rescueAnyToken(address token) external onlyOwner {
        require(token != address(this), "Can't rescue JPD");
