...
/**
Taroverse is a multi-game metaverse of play-to-earn games where players around the globe will be able to interact with one another in realtime through their 3d digital avatars using features like voice chat , emotes etc. Taroverse will be the first cross platform metaverse platform and will support android , ios , windows and macOS.
Players will be able to explore taroverse together , attend live shows performed by various artists , participate in treasure hunts and play multiple play2earn games built within the platform , thus bringing unique and fun experiences along with the perks of GameFi and DeFi in one single app. Taroverse will launch 3 games initially :
Tactics Royale
Monster Bash
Taro Gem Quest
Being a single token economy , players will be able to use $TARO tokens and NFT's across all the games and metaverse in the Taroverse and hence bringing max utility and value to both tokens as well as NFT's.
*/
