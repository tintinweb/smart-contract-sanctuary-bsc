...
/*! msvpbnbfinance.sol | (c) 2022 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | SPDX-License-Identifier: MIT License */
...
contract msvpbnbfinance is Ownable, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
...
contract Sync is msvpbnbfinance {
