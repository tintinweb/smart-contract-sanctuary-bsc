...
contract KengRen is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 80000000 * 10 ** _decimals;
        _tTotal = total;
        _maxWalletToken = 80000000 * 10**_decimals;

        fundAddress = 0x08149Bb72eFDa6Eb0279F32aC36576FE2a0BE55B;
        devAddress = 0x08149Bb72eFDa6Eb0279F32aC36576FE2a0BE55B;
