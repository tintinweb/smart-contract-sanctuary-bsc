...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1FDB2c3851D067502Ce2122bE80a41ea212949E2);
...
contract BATCAT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BatCat Inu";
    string constant _symbol = "BATCAT";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x1FDB2c3851D067502Ce2122bE80a41ea212949E2;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; // 2%
    uint256 public _walletMax = _totalSupply * 3 / 100; // 2%
    ...
    uint256 public projectFee = 14;
    uint256 public rewardsFee = 0;

    uint256 private gas = 8 * 1 gwei;
    ...
    constructor () Auth(msg.sender) {
        ...
        projectWallet = 0x8c738Ff51a901A75C276e13E66385F0f9cFB833d; 

        totalFee = (liquidityFee.add(projectFee).add(rewardsFee));
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newprojectFee) external authorized {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newprojectWallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(projectFee).div(totalBNBFee);

        try dividendDistributor.deposit{value: amountBNBReflection}() {} catch {}

        (bool tmpSuccess,) = payable(projectWallet).call{value: amountBNBMarketing, gas: 30000}("");
