...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf23b85a20c89aEABAC833204B7b4f2774bA63E46; // owner address
...
contract DipEater is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DipEater";
    string private _symbol = "DipEater";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf23b85a20c89aEABAC833204B7b4f2774bA63E46); // Marketing Address
    address payable public teamWalletAddress = payable(0xf23b85a20c89aEABAC833204B7b4f2774bA63E46); // Team Address
