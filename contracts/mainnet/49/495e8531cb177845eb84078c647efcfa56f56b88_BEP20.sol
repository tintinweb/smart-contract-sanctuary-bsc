...
// All subsequent code will be inside this block
	...
	constructor() {
        name = "Renata"; // Sets the name of the token, i.e BNB
        symbol = "RNT"; // Sets the symbol of the token, i.e BNB
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 36900000; // Holds an initial supply of coins
