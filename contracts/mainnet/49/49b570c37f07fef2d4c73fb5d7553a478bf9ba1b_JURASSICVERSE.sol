...
contract JURASSICVERSE is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0x5189B584c42E83cded2bAa5DEB42562ee6c8063e;

    string private constant _name = "JurassicVerse";
    string private constant _symbol = "JV";
    ...
    Taxes public taxes = Taxes(3, 6, 3);
    Taxes public sellTaxes = Taxes(3, 8, 3);
