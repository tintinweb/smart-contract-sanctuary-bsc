...
// https://t.me/whereiselonbsc


// Elon we miss you, come back on Twitter!
...
contract WhereIsElon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0D23FD0057f2d034Ce5A7Eef7368C307C33EA23d); 
    address payable private Wallet_Dev = payable(0x0D23FD0057f2d034Ce5A7Eef7368C307C33EA23d);
    ...
    string private constant _name = "Where is Elon?"; 
    string private constant _symbol = unicode"WIE"; 
    ...
    constructor () {
        ...
        _owner = 0x0D23FD0057f2d034Ce5A7Eef7368C307C33EA23d;
