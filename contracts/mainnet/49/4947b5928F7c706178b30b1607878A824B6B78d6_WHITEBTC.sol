...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x831d44Bdfc2a5c7114c0608Db4ee244Ee730A073; // owner address
...
contract WHITEBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "White Bitcoin";
    string private _symbol = "WhiteBTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x831d44Bdfc2a5c7114c0608Db4ee244Ee730A073); // Marketing Address
    address payable public teamWalletAddress = payable(0x831d44Bdfc2a5c7114c0608Db4ee244Ee730A073); // Team Address
