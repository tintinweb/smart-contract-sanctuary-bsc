...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A); //Tether
    ...
    uint256 public minDistribution = 1000000000000000000000000000000 * (10 ** 18);
...
contract Token is IBEP20, Auth {
    ...
    string constant _name = "Save Little Fist";
    string constant _symbol = "SLF";
    ...
    uint256 _totalSupply = 1000000000000000000000000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xa30eb188e1203811e4ef550FE118c1B5fE084dbB;  // marketingwallet
        burnFeeReceiver = 0x000000000000000000000000000000000000dEaD;  // burn 
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newburnFee) external onlyOwner {
