...
contract PishuInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pishu Inu";
    string constant _symbol = "PISHU";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x96F484e23E9835f0B34ed578bed44ABCd73e36C6;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(9).div(9);
