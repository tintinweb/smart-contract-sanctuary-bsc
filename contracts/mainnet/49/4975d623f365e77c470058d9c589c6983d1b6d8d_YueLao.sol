...
contract YueLao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YueLao";
    string private _symbol = "YL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D3bec98678e3DccfecDdcE738B8f801564aCd9F);
    address payable public teamWalletAddress = payable(0x6380abEEE5FE5789cA27FB4D282be3D865817240);
    ...
    uint256 private _totalSupply =  6900000 * 10**_decimals;
    uint256 public _maxTxAmount =   6900000 * 10**_decimals; 
    uint256 public _walletMax =     6900000 * 10**_decimals;
