...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = " test";       //Full name
    string public symbol_ = "testfist";      //abbreviation
    ...
    constructor(
        ...
        uint256 totalSupply = 100000000000000000000000000000 ;       //Supply
        swapTokensAtAmount = totalSupply.mul(1).div(1000); // 0.0001
