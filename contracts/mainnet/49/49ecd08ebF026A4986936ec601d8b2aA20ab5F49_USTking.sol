...
contract USTking is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "USTking";
    string private _symbol = "USTking";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x70445C86d82ee7848B3e6D615b1585D7bee49575); 
    address payable private teamWalletAddress = payable(0x2Ed809a2288f2fe7d943Da44E3899AB7b0DE30B6); 
    ...
    uint256 private _totalSupply = 1 * 1000 * 10**_decimals;
