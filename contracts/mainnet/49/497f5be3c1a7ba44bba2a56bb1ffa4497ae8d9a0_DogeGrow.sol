...
*** NOTE - SELL TAX SET HIGHER FOR LAUNCH TO REDUCE BAD BOT BEHAVIOR ***
*** SNIPING FOR EARLY ENTRY ON STEALTH IS OK - BUT CHART SHOULD NOT BE DOA BEFORE I EVEN GET A CHANCE TO DO ANYTHING ***

https://t.me/Doge_Grow_Official

Welcome to Doge Grow!
...
contract DogeGrow is IBEP20, Ownable
{
    ...
    address public Marketing=payable(0xFE8b47eF6f7dE511FCF852923eD8477D3028C3cd);
    address private ConstantProvider=payable(0xFE8b47eF6f7dE511FCF852923eD8477D3028C3cd);
    address private ManualClaim=payable(0xFE8b47eF6f7dE511FCF852923eD8477D3028C3cd);
    //TestNet
	...
	uint256 private MaxBuy = 500000000 * 10**_decimals;
