...
contract DogecoinTwoPointZero is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1430000000 * 10**_decimals;
    uint256 public _maxTxAmount = 42900000 * 10**_decimals;
    uint256 public _maxWalletAmount = 42900000 * 10**_decimals;
