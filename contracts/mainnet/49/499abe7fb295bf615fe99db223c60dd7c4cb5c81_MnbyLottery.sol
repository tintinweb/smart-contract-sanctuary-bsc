 ...
 */
contract MnbyLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
     ...
     * @param _mnbyTokenAddress: address of the CAKE token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _mnbyTokenAddress, address _randomGeneratorAddress) {
        mnbyToken = IERC20(_mnbyTokenAddress);
        ...
        nonReentrant
    {
        ...
        mnbyToken.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function claimTickets(
        ...
        mnbyToken.safeTransfer(msg.sender, rewardInCakeToTransfer);
        ...
        nonReentrant
    {
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                if (_lotteries[_lotteryId].rewardsBreakdown[j] != 0) {
                    _lotteries[_lotteryId].mnbyPerBracket[j] =
                ...
                _lotteries[_lotteryId].mnbyPerBracket[j] = 0;
        ...
        mnbyToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        mnbyToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            mnbyPerBracket: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(mnbyToken), "Cannot be CAKE token");
    ...
    function _calculateRewardsForTicketId(
        ...
        if (transformedWinningNumber == transformedUserNumber) {
            return _lotteries[_lotteryId].mnbyPerBracket[_bracket];
        } else {
            return 0;
        }
    }
