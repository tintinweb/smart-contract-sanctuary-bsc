...
pragma solidity ^0.6.12;
    ...
    contract CZDOGE is Context, IERC20, Ownable {
        ...
        string private _name = 'CZ Doge';
        string private _symbol = 'CZDOGE';
        ...
        uint256 private _MarketingFee = 90;
        ...
        uint256 private _numOfTokensToExchangeForMarketing = 5 * 10**8 * 10**9;

        address payable private TrustFloki_Marketing_Wallet;
        ...
        constructor (address payable MarketingWalletAddress) public {
            TrustFloki_Marketing_Wallet = MarketingWalletAddress;
            ...
            _isExcludedFromFee[TrustFloki_Marketing_Wallet] = true;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x413D7525Efc8F9d81cAf0cbF9BB79bD8A947F2aB, 'We can not exclude Uniswap router.');
        ...
        function sendETHToMarketing(uint256 amount) private {
            TrustFloki_Marketing_Wallet.transfer(amount.mul(3).div(8));
