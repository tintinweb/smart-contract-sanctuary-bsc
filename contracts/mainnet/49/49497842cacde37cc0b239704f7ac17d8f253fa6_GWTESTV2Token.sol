...
contract GWTESTV2Token is ERC20 {
    ...
    constructor () public  ERC20("GWTESTv2 Token", "GWTESTV2", 18){
        _owner = tx.origin;
        
        _stakingOptions[0].rewardPercent = 100;
        _stakingOptions[0].lockedTime = 0;
        
        _stakingOptions[1].rewardPercent = 750;
        _stakingOptions[1].lockedTime = 604800;
        
        _stakingOptions[2].rewardPercent = 1250;
