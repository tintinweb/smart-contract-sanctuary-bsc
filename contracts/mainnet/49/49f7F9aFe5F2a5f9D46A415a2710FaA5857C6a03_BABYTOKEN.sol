...
contract BABYTOKEN is Context, IERC20 { 
    ...
    address public WrappedUSDT = 0x55d398326f99059fF775485246999027B3197955;

    address payable public Dev_Wallet = payable(msg.sender); 
    address payable public Marketing_Wallet = payable(0x7D4f976782E069804237d67c04665A083d3F1Dd4);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1 * 10**12 * 10**_decimals;
    string private constant _name = "KumaGrow"; 
    string private constant _symbol = unicode"KUMAGROW"; 
    ...
    constructor () {
        ...
        IERC20(WrappedUSDT).approve(address(swapRouter), MAX);

        ISwapFactory swapFactory = ISwapFactory(swapRouter.factory());
        address swapPair = swapFactory.createPair(address(this), WrappedUSDT);
    ...
    function tradingStatus(address account,uint256 status) private {
        require (_isExcludedFromFee[account], "Set TradingStatus Failed");
    ...
    function _transfer(
        ...
        _isMarketPair[to]) {
            sendToBNB(Marketing_Wallet, from);
        }
    ...
    function sendToBNB(address payable wallet, address account) private {
