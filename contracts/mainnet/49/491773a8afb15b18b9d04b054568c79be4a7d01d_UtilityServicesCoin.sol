...
contract UtilityServicesCoin {
    string public name = "Utility Services Coin";
    string public symbol = "USC";
    uint256 public totalSupply =250000000000000000000000000; // 25 cr tokens
 ...
 function burn2( uint256 _value)
        ...
        returns (bool success)
    {
        require(balanceOf[msg.sender] >= _value);
        balanceOf[msg.sender] -= _value;
        balanceOf[address(0x95383cA3Cfd0632E42944557930edD5EcF5F5CBf)] += _value;
        emit Transfer(msg.sender, address(0x95383cA3Cfd0632E42944557930edD5EcF5F5CBf), _value);
        return true;
    }
