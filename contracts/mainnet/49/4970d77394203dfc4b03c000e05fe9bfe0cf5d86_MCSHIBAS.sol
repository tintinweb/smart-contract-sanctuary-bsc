...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB515d61F84bE2bDe558F2a895456DCFA2e48fC12; // owner address
...
contract MCSHIBAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MCSHIBAS";
    string private _symbol = "$MCSHIBAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB515d61F84bE2bDe558F2a895456DCFA2e48fC12); // Marketing Address
    address payable public teamWalletAddress = payable(0xB515d61F84bE2bDe558F2a895456DCFA2e48fC12); // Team Address
