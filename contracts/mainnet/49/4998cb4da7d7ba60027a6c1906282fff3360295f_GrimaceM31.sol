...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08ea4C6Fc8f45d4293910231b244610C9B80885f;
...
contract GrimaceM31 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x08ea4C6Fc8f45d4293910231b244610C9B80885f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GrimaceM31";
    string private _symbol = "GrimaceM31";
