    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                dividendFee = _sellLPDividendFee;
            } else {
                fundFee = _buyFundFee;
                dividendFee = _buyLPDividendFee;
            }
...
contract DL is AbsToken {
    constructor()
        AbsToken(
            ...
            18,
            30000,
            address(0x19DbA5A64152c0Fa765F1FfE691E9dDC4E30f608), //fund
            address(0x1Df938a39f53827A339978e1F1e5a282579C7eBE) // receive
        )
    {}
}