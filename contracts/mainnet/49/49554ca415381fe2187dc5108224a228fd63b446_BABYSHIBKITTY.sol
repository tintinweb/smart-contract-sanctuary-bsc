...
contract BABYSHIBKITTY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYSHIBKITTY";
    string private _symbol = "BABYSHIBKITTY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1DD27477736E7BDAc8275104c4ff085410F42935); // Marketing Address
    address payable public buybackWalletAddress = payable(0x1DD27477736E7BDAc8275104c4ff085410F42935); // Buyback Address
