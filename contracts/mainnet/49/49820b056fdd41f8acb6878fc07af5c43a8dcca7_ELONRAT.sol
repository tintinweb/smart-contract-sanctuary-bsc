...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract ELONRAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elon Rat";
    string private _symbol = "ER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x958C00E5C837Eb4BBcd3Ab168865008896e4eEE9);
    address payable public devWalletAddress = payable(0xf1BfBa813e87f6132b29A4225215eEcF0cB4944a);
