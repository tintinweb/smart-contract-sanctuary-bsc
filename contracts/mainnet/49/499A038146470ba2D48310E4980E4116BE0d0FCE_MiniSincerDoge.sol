...
contract MiniSincerDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini SincerDoge";
    string private _symbol = "MSD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x122F4F2D79eD5278a41CF1A7cc87136ddE777232); 
    address payable public BuybackWalletAddress = payable(0x122F4F2D79eD5278a41CF1A7cc87136ddE777232); 
