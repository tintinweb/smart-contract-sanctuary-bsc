...
contract TEST is IBEP20, Auth {
    ...
    address MKT  = 0x116614066a1A288d8cc29657752f69883deB00ef;
    ...
    uint256 public transferTaxRate        = 12;
    ...
    uint256 public totalFee               = liquidityFee.add(reflectionFee).add(marketingFee).add(burnFee);
    ...
    function setFeeDistribution(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee,  uint256 _burnFee, uint256 _feeDenominator) external authorized {
