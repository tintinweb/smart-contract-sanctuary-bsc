...
Axerium network bring in faster and reliable
Technologies (Blockchain, Metaverse, NFT) with our 
best skills and a keen understanding of the role 
of technology in business.Axerium Network is a High 
end-level of solution enabling the equitable and decentralized 
...
Website :testnet-axerium.live
tg : https://t.me/Axeriumnetwork
*/
...
contract AxeriumNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AxeriumNetwork";
    string private _symbol = "Axerium";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x692914fb4b2f9A9cA2B744180C4be7336793888d);
