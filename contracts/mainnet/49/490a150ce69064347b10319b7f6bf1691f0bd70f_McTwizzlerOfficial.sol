...
contract McTwizzlerOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McTwizzler";
    string private _symbol = "$MCTwiz";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x538E3edc19B2D9A06EA89fFdeB79aC20629738d8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x538E3edc19B2D9A06EA89fFdeB79aC20629738d8); // Team Address
