...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC62433fd9E6C74b125c81a1D2cb9466C1Dce695B; // owner address
...
contract CEOAIINU is Context, IERC20, Ownable {
    ...
    string private _name = "CEO AI INU";
    string private _symbol = "AI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xACca17f7373769CE94ABd439F568118dCF006508); // Marketing Address
    address payable private teamWalletAddress = payable(0xACca17f7373769CE94ABd439F568118dCF006508); // Team Address
