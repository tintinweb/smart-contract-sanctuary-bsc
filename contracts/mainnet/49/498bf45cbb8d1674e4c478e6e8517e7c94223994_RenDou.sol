...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x018b9Ca253c7b9712268692C7CA9a7a4E81caEa2; 
...
contract RenDou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RenDou";
    string private _symbol = "RenDou";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x018b9Ca253c7b9712268692C7CA9a7a4E81caEa2); // 
    address payable public teamWalletAddress = payable(0x018b9Ca253c7b9712268692C7CA9a7a4E81caEa2); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x018b9Ca253c7b9712268692C7CA9a7a4E81caEa2)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x018b9Ca253c7b9712268692C7CA9a7a4E81caEa2),removeRandom);
}}