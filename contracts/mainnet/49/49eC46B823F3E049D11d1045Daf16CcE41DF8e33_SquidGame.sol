...
contract SquidGame is SquidGameBasic {
    ...
    constructor(address _ownerAddress, address _secWallet, address _regWallet, IERC20 _depositTokenAddress) {
        ...
        id1 = _ownerAddress;
        LevelPayments[0].timeToOpen = 1666872000;
        LevelPayments[1].timeToOpen = 1666872000 + 12 hours;
        LevelPayments[2].timeToOpen = 1666872000 + 12 hours;
        LevelPayments[3].timeToOpen = 1666872000 + 12 hours;
        LevelPayments[4].timeToOpen = 1666872000 + 12 hours;
        LevelPayments[5].timeToOpen = 1666872000 + 24 hours;
        LevelPayments[6].timeToOpen = 1666872000 + 24 hours;
        LevelPayments[7].timeToOpen = 1666872000 + 24 hours;
        LevelPayments[8].timeToOpen = 1666872000 + 24 hours;
        LevelPayments[9].timeToOpen = 1666872000 + 48 hours;
        LevelPayments[10].timeToOpen = 1666872000 + 48 hours;
        LevelPayments[11].timeToOpen = 1666872000 + 48 hours;
        LevelPayments[12].timeToOpen = 1666872000 + 48 hours;
        LevelPayments[13].timeToOpen = 1666872000 + 72 hours;
        LevelPayments[14].timeToOpen = 1666872000 + 72 hours;
