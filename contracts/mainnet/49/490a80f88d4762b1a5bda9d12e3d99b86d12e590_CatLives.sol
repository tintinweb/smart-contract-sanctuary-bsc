...
contract CatLives is ERC20, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**6 * 10**18;

    uint256 public maxBuyAmount = 1 * 10**6 * 10**18;
    uint256 public maxSellAmount = 1 * 10**2 * 10**18;
    ...
    constructor() ERC20("(9CatLives)", "9CATLIVES") {
        router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        // mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
        CatLivesNFTs = IERC721(
            0xB78D15571e5e680765f24b1d88b18A5b1343b8Df
        ...
        returns (uint256 _baseDelta)
    {
        ...
        for (uint256 i = claimed; i < loops; i++) {
            ...
            uint256 userNFT = CatLivesNFTs.balanceOf(userInd);
