...
contract DigichainBNB is IERC20 {
    ...
    string private _name = 'Digichain Wrapped BNB'; 
    string private _symbol = 'DigiBNB';
    ...
    constructor () {
        op = address(0x71D1aDF9dB8f8BAE6F1c68A35f007717780c1725);
        op2 = op;
