...
/* Token contract */
contract BusdGrow2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xF66085c0352858Cb998F4A2CB60E6554458Eab6c;
    ...
    // Name and symbol
    string constant _name = "BusdGrow 2.0";
    string constant _symbol = "$Grow2";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 1% on launch or 1M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x49d23E5419Ef9e1662Dd94ACb8422f63265ae3d9;
