...
contract SistaCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sista Coin";
    string constant _symbol = "Sista";
    uint8 constant _decimals = 4;
 
    uint256 _totalSupply = 500 * 10**7 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        ecosystemfeeReceiver = 0x4dB5214F2846a54F1C7f50b9c75609195740eaa0;
