...
contract shib is Context, IERC20, Ownable {
    ...
    string private _name = "Bill Murray Shib";
    string private _symbol = "BMShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB731EFDbc7A49f369cF4ba6EA8aBa2b36f0E8B6d); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0xB731EFDbc7A49f369cF4ba6EA8aBa2b36f0E8B6d); // Developmental Address
