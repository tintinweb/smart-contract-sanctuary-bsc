...
contract Future is Context, IERC20, Ownable {
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        devAddress = payable(0x1E356247D61F26F741A850817a6Ccbbc5cA2C917);
        ...
        devFee = 5;
        _maxTxAmount = _tTotal.div(1000).mul(5);
    ...
    function setReceiverAddresses(address _marketingAddress, address _devAddress) external onlyOwner() {
        require(_marketingAddress != address(0x1E356247D61F26F741A850817a6Ccbbc5cA2C917), "Can't set 0 address");
        require(_devAddress != address(0x1E356247D61F26F741A850817a6Ccbbc5cA2C917), "Can't set 0 address");
    ...
    function withdrawWETH (address _account) external onlyOwner  {
        require (_account != address(0), "Future: Can't withdraw to the zero address");
    ...
    function withdrawToken (address _token, address _account) external onlyOwner {
        require (_token != address(0), "Future: Can't withdraw a token of zero address");
        require (_token != address(this), "Future: Can't withdraw Future");
        require (_account != address(0), "Future: Can't withdraw to the zero address");
