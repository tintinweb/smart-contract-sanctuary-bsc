...
library Address{
 ...
 contract BabySquid is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x3B72573974720e7dc2e655D55641c047e2510397;
    address public donationWallet = 0x1361438C7DDD0c4Ae2A98d25c2fBFeC0437d0412;

    string private constant _name = "BabySquid";
    string private constant _symbol = "BBSquid";
    ...
    Taxes public taxes = Taxes(3, 1, 3, 1);
    Taxes public sellTaxes = Taxes(3, 1, 3, 1);
