...
/**
ShotguNoid is a meme token created on the bsc network, this token was created because it was inspired by "the noid" we have plans to add utilities in it such as P2E games, NFT, etc.
...
// Telegram : https://t.me/shotgunoid
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDAd50db308aAA830Da89e0E03B4ba8ff9707FB0D;
...
contract ShotGuNoid is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xDAd50db308aAA830Da89e0E03B4ba8ff9707FB0D);
