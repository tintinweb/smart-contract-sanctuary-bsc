...
contract MadDoggie is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibqisjcuvckjfdpw4hosv4clpk4vgnj22csterpzin6u6t6atndfq/", Strings.toString(tokenId), ".json")
            );
    }
