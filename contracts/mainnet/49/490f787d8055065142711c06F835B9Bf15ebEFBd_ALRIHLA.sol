...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderCondition = 4000 * 10 ** Decimals;
    }
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (!inSwap && _swapPairList[to]) {
                    ...
                    if (contractTokenBalance > 0) {
                        uint256 swapFee = _lpFee + _dividendFee;
...
contract ALRIHLA is AbsToken {
    constructor() AbsToken(
        ...
        10000000,
    //Fund
        address(0xDb0d6513Fa0aD78f14614e1fFcF9a0a06E4adFeb),
    //Receive
        address(0x90464C41044e7Dff166436b348e6117ed3FeBa39)
    ){
