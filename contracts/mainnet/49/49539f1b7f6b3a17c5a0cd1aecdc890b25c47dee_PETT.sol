...
contract PETT is
    ...
    BEP20Burnable
{
    string constant private _name = "PETT";
    string constant private _symbol = "PETT";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "PETT/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "PETT/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "PETT/approve : Should not approve zero address"
        );
