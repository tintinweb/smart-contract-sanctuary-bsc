...
contract difi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "difi";
    string private _symbol = "difi";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 30;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x74BB3947034CbC04920E8cd94658c6Cdc24eADeb); // Marketing Address
    address payable private teamWalletAddress = payable(0x74BB3947034CbC04920E8cd94658c6Cdc24eADeb); // Team Address
