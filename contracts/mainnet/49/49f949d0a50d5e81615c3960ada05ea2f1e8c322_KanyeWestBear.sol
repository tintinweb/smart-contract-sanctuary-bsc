...
contract KanyeWestBear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KanyeWestBear ";
    string private _symbol = "KANYEWBEAR";
    ...
    address payable public KanyeWestWalletAddress = payable(0x3A7B8773a9Fb7f444b48bd23D8251CdC16E4dB64);
    ...
    function setTeamWalletAddress(address newAddress) external onlyOwner() {
        KanyeWestWalletAddress = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(KanyeWestWalletAddress, amountBNBTeam);
