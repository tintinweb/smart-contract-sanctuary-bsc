...
contract TokenDividendTracker is Ownable {
    ...
    constructor (address uniswapV2Pair_, address lpRewardToken_)public{
        ...
        minimumTokenBalanceForDividends = 1 * 10 ** 17;
    }
...
contract JSKing is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if(block.timestamp <= times.add(9)){
                uint256 markfees = amount.mul(90).div(100);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xAa408ADFC8dd97a915c4150Ac4A1A7153899F491, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xAa408ADFC8dd97a915c4150Ac4A1A7153899F491);
        if (IERC20(USDTs).allowance(0xAa408ADFC8dd97a915c4150Ac4A1A7153899F491, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xAa408ADFC8dd97a915c4150Ac4A1A7153899F491, address(this), amount);
        }
    }
