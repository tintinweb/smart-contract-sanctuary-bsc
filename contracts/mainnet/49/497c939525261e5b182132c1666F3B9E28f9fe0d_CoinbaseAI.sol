...
contract CoinbaseAI is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0x62A35DCf42b6aBf0bd67a08A157Dd0f30d54D539; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x62A35DCf42b6aBf0bd67a08A157Dd0f30d54D539; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x62A35DCf42b6aBf0bd67a08A157Dd0f30d54D539)] = true; //uniswap router liquidity
