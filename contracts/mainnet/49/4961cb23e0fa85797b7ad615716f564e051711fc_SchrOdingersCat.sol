...
Baby Schrödinger’s Cat Want's some Milk. :(
    XOXO 
...
contract SchrOdingersCat is IBEP20, Auth {
    ...
    address DEV = 0x00e26cFc052Fc9A4B19446e70576122351D43381;
    ...
    // Name and symbol
    string constant _name = " SchrOdinger's Cat";
    ...
    uint256 _totalSupply = 1000000 * 10**0 * (10 ** _decimals);
     ...
     // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1.5% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1 or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4f1141490131da353F1359C44159020F8bBD997A;
