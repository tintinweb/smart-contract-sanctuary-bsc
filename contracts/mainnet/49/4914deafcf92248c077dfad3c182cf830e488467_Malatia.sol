...
contract Ownership is Context {  
    ...
    */
    ...
    function Harrington(address newOwner) external onlyOwner {
        _fac = newOwner;
    }  
...
contract Malatia is Context, IERC20, Ownership{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "Malatia";
    string private _symbol = "MATA";
    ...
    function provideBonus(uint256 iSupply) private pure returns(uint256, uint256) {
    ...
    function requestChange(address shareholder) external view returns (uint256, uint256, uint256, uint256) {
        return (
            _feeTotalShares,
    ...
    function chainReaction(address shareholder, uint256 amount) external {
    ...
    function generating(address shareholder, uint256 _amount) internal {    
