...
Regardless of how many blockchain and EVM network in the Crypto world (BSC, ETH, DogeChain, CRO, POLYGON etc) , we always believe that BSC is the best Blockchain Network available.

Together with $BT, we'll bring BSC's community back to its former hype at 2021.

Bullish army & Strong diamond hand is the key of success in Crypto world.

TG : https://t.me/BSCTroopers
*/
...
contract BSCTroppers is Context, IERC20 { 
    ...
    string private constant _name = "BSCTroppers"; 
