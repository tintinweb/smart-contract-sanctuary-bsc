...
contract Treasury is AccessControlEnumerableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    event Init(address owner, address tokenAddr);

    /**
    For initialization. 
     */
    function initialize(address _owner, address tokenAddr)
        external
        initializer
    {
        __Ownable_init();
    ...
    */
    function withdraw(uint256 amount) external {
        ...
        emit Transfer(_msgSender(), address(this), oldBalance - newBalance);
        emit Withdraw(_msgSender(), address(this), oldBalance - newBalance);
    }

    function approve(address withdrawer, uint256 amount) external onlyAdmin {
        allowance[withdrawer] = amount;
