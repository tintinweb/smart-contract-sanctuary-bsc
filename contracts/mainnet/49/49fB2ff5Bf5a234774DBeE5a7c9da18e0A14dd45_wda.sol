...
contract wda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "wda";
    ...
    address payable public marketingWalletAddress = payable(0x21792ecA20427f80b334f37F4441833735174b38); // Marketing Address
    address payable public teamWalletAddress = payable(0x21792ecA20427f80b334f37F4441833735174b38); // Team Address
    address payable public liquidityAddress = payable(0x21792ecA20427f80b334f37F4441833735174b38); // Team Address
