...
contract Helloween is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HELLOWEEN";
    string private _symbol = "$WEEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A02F01FA58b92E2FA754aC3Eb0d11B66Ad06229);
    address payable public BuyBackWalletAddress = payable(0x26b8844A0e20B64eB7FCA838b8ef69343FFe04C9); 
