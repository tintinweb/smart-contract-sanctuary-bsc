...
/**
  __  ___                                 
  /  |/  /__ __ _  ___ ___ ____ ___ _  ___ 
 / /|_/ / -_)  ' \/ -_) _ `/ _ `/  ' \/ -_)
...
- MaxWallet: 2%
- max fees you can set is equal or less than 10%
- 2lp, 4marketing, 4 dev
- SetTargetLP: 25
- SwapThreshold = .3%
*/
...
contract MEMEGAME is ERC20, Auth {
    ...
    string constant _name = "Memegame";
    ...
    uint256 private liquidityFee    = 1; //set fees here 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC21fD2f2a959ef80dc29058F22c491887826bDB7;
        devFeeReceiver = 0xfFC4A7c695Ef885CEEF1217EAd200CE9855ed9E8;
