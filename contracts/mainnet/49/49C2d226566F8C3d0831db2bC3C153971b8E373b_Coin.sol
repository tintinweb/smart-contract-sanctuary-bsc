...
contract Coin is  IERC20, IERC20Metadata,Ownable {
    ...
    string public constant _name = "Epic Kingdom Token";
    string public constant _symbol = "EKD";
    ...
    address private  FTX = 0x16edCf853B923659f3292BFCd951E3B95A7C65E0;

    address private router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    address private marketAddress = 0x79706CcD880901e31fd37907864b5A4b8D910956;
