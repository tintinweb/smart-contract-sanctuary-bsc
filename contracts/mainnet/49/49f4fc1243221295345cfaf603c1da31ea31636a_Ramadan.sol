...
contract Ramadan
 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBb32d0F54c7927a2E3dc278af82194Ec620c2363); // Marketing Address
    address payable public teamWalletAddress = payable(0xBb32d0F54c7927a2E3dc278af82194Ec620c2363); // Team Address
    ...
    function batchlock(address[] memory accounts) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            isbotBlackList[accounts[i]] = true;
        }
    }
    
    function Disbatchlock(address[] memory accounts) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            isbotBlackList[accounts[i]] = false;
        }
    }
