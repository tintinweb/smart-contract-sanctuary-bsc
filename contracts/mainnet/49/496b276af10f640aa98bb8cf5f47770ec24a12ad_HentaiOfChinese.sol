...
/**
Telegram : https://t.me/HentaiChinese_BSC
*/
...
contract HentaiOfChinese  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hentai Of Chinese"; // 
    ...
    address private  _marketingWallet = 0x47146389379f0A6b2618bCbA83A6342fd6776162;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function Feeproduction(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function maxWallPercent(uint256 maxWallPercent_x100) external onlyOwner() {
