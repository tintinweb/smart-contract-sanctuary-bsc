...
|    |   |  |/    \  / ___\|    |   |  |/    \  / ___\ 
|    |___|  |   |  \/ /_/  >    |___|  |   |  \/ /_/  >
|_______ \__|___|  /\___  /|_______ \__|___|  /\___  / 
        \/       \//_____/         \/       \//_____/  

TG: @LingLingCommunity
TW: @Ling_Ling
WEB: LingLing.com
-----------------------------------------------------------
*/
...
contract LingLing is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Ling_Ling";
    string private _symbol = "LING";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xAc32791494471d8Dc6b120242F20cEC42C82e8Cc);
    address payable public liqWalletAddress = payable(0xAc32791494471d8Dc6b120242F20cEC42C82e8Cc);
