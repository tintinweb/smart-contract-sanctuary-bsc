...
contract aiqiyi is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "aiqiyi";
    string constant _symbol = "aiqiyi";
    ...
    function removebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
    ...
    function setchargefee(uint256 iSupply) private pure returns(uint256, uint256) {
