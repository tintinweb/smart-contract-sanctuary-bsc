...
contract Tadashinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tadashi Inu";
    string private _symbol = "Tadashinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7903b6148aaCbbF805743a9CE82ED13814abE5c5);
    address payable public BuyBackWalletAddress = payable(0x7903b6148aaCbbF805743a9CE82ED13814abE5c5);
