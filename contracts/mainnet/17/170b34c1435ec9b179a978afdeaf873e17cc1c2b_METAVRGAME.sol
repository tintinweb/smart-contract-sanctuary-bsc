...
contract METAVRGAME is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "METAVRGAME";
    string private _symbol = "METAVR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x2D9AE874Db672EbCE3b1202fFE8aC8266D09Ad29);
