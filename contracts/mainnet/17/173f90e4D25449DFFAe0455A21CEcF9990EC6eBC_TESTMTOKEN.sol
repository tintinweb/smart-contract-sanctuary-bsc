...
contract TESTMTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "TestM TOKEN";
    ...
    uint256 public maxTxnLimit = _totalSupply.div(1); // this is the max transaction limit
    ...
    constructor() {
        ...
        marketingWallet = address(0x35Eb40016f8f83fA573968c1859dFCF982354C48);
        NFTRewardWallet = address(0xB55a90e86b071f04a59ef0077B136826a1B5cF3e);
