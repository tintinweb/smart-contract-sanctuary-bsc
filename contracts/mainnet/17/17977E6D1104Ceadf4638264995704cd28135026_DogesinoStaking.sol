...
/**                                                                                                                                                                                                                                                                                                                               
                The Doge Casino that rewards you $DOGE when you hold $DOGESINO or Play Casino.
                                         Telegram:  https://t.me/dogesino_chat
                                         Twitter:   https://twitter.com/dogesino_global
                                         Website:   Dogesino.io
...
contract DogesinoStaking is Ownable {
    using SafeMath for uint256;
    address payable public distributor;
    IERC20 public token = IERC20(0xE34Df8B4d864579B9ADcFdEfe82Ea4e7aDBA3BF0); // token
    IPair public liquidityPair = IPair(0x64F240533fe32015D5528F1e6F7bEDb567676147); // lp
    ...
    uint256 public tokenReward = 60000;
    uint256 public lpReward = 70000;
