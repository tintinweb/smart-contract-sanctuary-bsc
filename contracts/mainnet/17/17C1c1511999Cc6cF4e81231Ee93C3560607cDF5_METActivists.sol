...
contract METActivists is ERC721A, Ownable {
    ...
    string public baseURI_ = "https://gateway.pinata.cloud/ipfs/QmRs4u89sw2PJ2m2kxDLT3kbhJXo784jFK13opsagL58WZ";
    ...
    function reserveClaim(
        ...
        require(_verify(_leaf(msg.sender, _reservedAmount), rootReserve, _proof),"Invalid merkle proof");
