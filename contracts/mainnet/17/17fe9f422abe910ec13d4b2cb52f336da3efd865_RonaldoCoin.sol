...
pragma solidity ^0.6.12;
    ...
    contract RonaldoCoin is Context, IERC20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        mapping (address => bool) public _is_Jeet_or_bot;
        ...
        string private _name = 'RonaldoCoin';
        string private _symbol = 'RonaldoCoin';
        ...
        address payable public _Marketing_Wallet;
        ...
        constructor (address payable MarketingWalletAddress) public {
            _Marketing_Wallet = MarketingWalletAddress;
            ...
            _isExcludedFromFee[_Marketing_Wallet] = true;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            require(!_is_Jeet_or_bot[sender] && !_is_Jeet_or_bot[recipient], "This address is blacklisted");
        ...
        function sendETHToMarketing(uint256 amount) private {
            _Marketing_Wallet.transfer(amount.mul(3).div(8));
        ...
        function _setMarketingwallet_but_never_use_it(address payable MarketingWalletAddress) external onlyOwner() {
            _Marketing_Wallet = MarketingWalletAddress;
	    ...
	    //removeFromBlackList
        function removeFromJeetList(address account) external onlyOwner{
        _is_Jeet_or_bot[account] = false;
        }

         //adding multiple address to the blacklist - used to manually block known bots and scammers
        function addToJeetorBotList(address[] calldata  addresses) external onlyOwner {
        for(uint256 i; i < addresses.length; ++i) {
            _is_Jeet_or_bot[addresses[i]] = true;
            }
        }
