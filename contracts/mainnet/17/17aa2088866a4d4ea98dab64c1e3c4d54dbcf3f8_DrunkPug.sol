...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2B720df5e577F0520800fB68f979b92e0dA9F7eE;
...
contract DrunkPug is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9638689BEEACeF0C202528cF78FAe07BcB87F0D7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Drunk Pug";
    string private _symbol = "DKPG";
