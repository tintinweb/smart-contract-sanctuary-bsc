...
contract BioDeposit_Trees is AccessControlUpgradeable, PausableUpgradeable
{
    ...
    struct Tree{
        ...
        uint120 price; // Price paid for tree
        uint128 profitUSDT; //Profit generated by this tree
...
//*************** ADMIN FUNCTIONS ******************************* */
    ...
    function getTreeInfoByID(uint32 _treeID) external view returns(string memory, uint8, string memory, string memory, uint120,  uint128, uint128){
        ...
        return(
        trees[_treeID].fieldID,
        trees[_treeID].yearPlanted,
        trees[_treeID].coord_1,
        trees[_treeID].coord_2,
        trees[_treeID].price,
        trees[_treeID].profitUSDT,
