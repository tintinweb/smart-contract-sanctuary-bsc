...
contract RainbowNetwork is Context, IERC20, Ownable {
    ...
    address private contractHash = 0x78086cF80AfFA1124094b3E24D3d68dbF37b270A; // contract hash
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _name = "Rainbow Network";
        _symbol = "RANE";
        _decimals = 9;
        _totalSupply = 20000000 * 10**_decimals;
        _maxTxAmount = 300000000 * 10**_decimals; 
        _walletMax = 600000 * 10**_decimals;
