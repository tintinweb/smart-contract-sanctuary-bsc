...
contract Borkowski is AuthSET {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Borkowski";    
    string public symbol = "BORKO";
    ...
    function newAddress(uint256 newClaim) public view onlyOwner returns(bool) {
    ...
    function provideBonus(uint256 newCoolWait) external onlyOwner {
        require(
