...
contract TEST is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x54a34BD303dd83a2e36E726DE6a1DcA36c9C2c8C); 
    address payable public Wallet_Dev = payable(0x6386f94aAE8D626b8F0DeDb8c970a6BF2A9a4cD3);
    ...
    string private constant _symbol = unicode"TST23"; 
    ...
    constructor () {
        ...
        _owner = 0x6386f94aAE8D626b8F0DeDb8c970a6BF2A9a4cD3;
