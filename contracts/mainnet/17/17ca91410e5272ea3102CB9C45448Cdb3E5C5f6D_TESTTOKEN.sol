...
contract TESTTOKEN is IBEP20, Auth {
    ...
    function myTickets(address spender) external view override returns (uint256) {
        uint256 _myTickets = _dailyPrizeEntries[rewardDay][spender];
         return _myTickets; 
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        else
        {
            ...
            _dailyPrizeEntries[rewardDay][sender] = _dailyPrizeEntries[rewardDay][sender] + 1;
