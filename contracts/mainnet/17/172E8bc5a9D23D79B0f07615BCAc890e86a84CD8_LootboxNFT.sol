...
contract LootboxNFT is Ownable, ERC721Min, ReentrancyGuard {
    ...
    string private _tokenBaseURI = "https://pi-protocol3.mypinata.cloud/ipfs/QmQq4kws7ii9Y9AYrbEv14cyhCrqqaFxGzSSe189vwaxgU";
    ...
    uint256 public price = 0.095 ether; // BNB
    uint256 public priceForThree = 0.285 ether; // BNB

    constructor() ERC721Min("JPIC Lootbox", "JPICL") {}
