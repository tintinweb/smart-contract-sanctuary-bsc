...
contract goatCR7inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "goatCR7inu";
    string private _symbol = "GoatCR7";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27B8930b6446023082B21E1644E54E2fb9A324Bd);
    address payable public teamWalletAddress = payable(0x27B8930b6446023082B21E1644E54E2fb9A324Bd);
