...
contract BetCoinTwo is IBEP20, Ownable {
    ...
    string constant _name = "BetCoinTwo";
    string constant _symbol = unicode"BetCoin2.0";
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 4, 2, 0);
    Fees public sellFees    = Fees(1, 4, 2, 0);
