...
contract SaudiR8 is IBEP20, Auth {
    ...
    string constant _name = "Saudi R8";
    string constant _symbol = "R8";
    ...
    uint256 public totalFee        = ecoFee + marketingFee + liquidityFee + treasuryFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5196ab480c6341aD625F4A36343a2C4610772f4A;
        treasuryFeeReceiver = 0xBE582B91B97802F5A657AFC1142121d6c532a569;
        ecoFeeReceiver = 0xBE582B91B97802F5A657AFC1142121d6c532a569;
    ...
    function setFees(uint256 _liquidityFee, uint256 _ecoFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        ecoFee = _ecoFee;
        marketingFee = _marketingFee;
        treasuryFee = _treasuryFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_ecoFee).add(_marketingFee).add(_treasuryFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _treasuryFeeReceiver, address _burnFeeReceiver, address _ecoFeeReceiver) external authorized {
