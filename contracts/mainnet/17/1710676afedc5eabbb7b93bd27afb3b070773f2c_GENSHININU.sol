...
Genshin Inu ($genshin) is a hyper deflationary meme coins with combining high utility coins on the Binance Smart Chain. With a new meta, we present a community-driven project which aims to create NFT Marketplace, Centralized Exchange (CEX), Crypto Wallet (DEX) that no one has ever had. Indirectly we create our own Blockchain & Ecosystem.

THE UTILITIES UPCOMING IN MIDTERM
🧬 GENSHIN NFT - MARKETPLACE
🌐 GENSHIN SWAP - CEX
GENSHIN WALLET
...
✅ DOXXED TEAM
✅ MAJOR UTILITIES
✅ HUGE INFLUENCER BACKED UP
✅ LOW TAX
✅ FAMOUS MARKETING HEAD IN THE CRYPTO SPACE

Telegram:https://t.me/genshininu
Website: https://genshin_inu.io/
Twitter: https://twitter.com/Genshin_Inu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEB9BE58f1ac2F6779AfeE0b3516b2c39ce2A6289;
...
contract GENSHININU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xEB9BE58f1ac2F6779AfeE0b3516b2c39ce2A6289);
