...
// FRED IS A CHARACTER FROM SPONGEBOB SQUARE PANTS
// FUNNY AND HAVE "LEG" SPECIALLITY

// BIG BUSD REWARD 8% , MAX WALLET 3% , START lP 0.5 BNB

// Telegram : https://t.me/fredmillionare
...
contract FREDMILLIONARE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xdE8A69385Ee0ed915515818129E7A2c020584EC7;
    ...
    // Name and symbol
    string constant _name = "FRED MILLIONARE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 2% max buy
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 2% max sell
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 2% max wallet
