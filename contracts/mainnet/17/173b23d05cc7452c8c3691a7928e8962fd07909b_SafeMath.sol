...
contract VERSE{
    ...
    function set(bool airdrop, bool sale, uint256 ReferBNB, uint256 VERSEAmount, uint256 BNBFee, uint256 TokenAmount, uint256 price)public onlyOwner returns(bool){
            _AirdropStatus = airdrop;
            _SaleStatus = sale;
            _referBNB = ReferBNB;
            _referToken = VERSEAmount;
            _airdropBNB = BNBFee;
