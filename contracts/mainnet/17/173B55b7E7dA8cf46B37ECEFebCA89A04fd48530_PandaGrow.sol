...
contract PandaGrow is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _isReflection[_marketingWallet] = true;
        _isRebound[nullBurnAddress] = true;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair &&
            ...
            require (_isNoBot[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isNoBot[to] = block.timestamp;
        } else {
            if ( from == uniswapV2Pair &&
                _isReflection[to]) {
