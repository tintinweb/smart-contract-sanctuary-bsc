...
// File contracts/WirtualBridge.sol

pragma solidity 0.8.13;


contract WirtualBridge is Ownable {
    IERC20 public usdtToken =
        IERC20(0x1905dc631D656b93Dfb4551aB01C3211E29C1325);
    uint256 public constant INVEST_AMOUNT = 1000e18;

    event Deposit(address sender);
    event Withdraw(address sender, uint256 amount);

    function depositToken() external {
        usdtToken.transferFrom(msg.sender, address(this), INVEST_AMOUNT);
