...
contract YMBTokenForPool is Ownable {
    using SafeMath for uint256;
    ...
    // address constant public pankFactory = 0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc;
    // address constant public pankRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    function swapAndAddLiquidity() public onlyControler {
    ...
    function addLiquidity(
        ...
        uint amountAMin,
        uint amountBMin
    ) public onlyControler {
        IPancakeRouter(pankRouter).addLiquidity(tokenAddressA,tokenAddressB,amountADesired,amountBDesired,amountAMin,amountBMin,address(this),getNowTime()+60);
    }

    function buy(uint256 num) private onlyControler {
    ...
    function sale(uint256 num) public onlyControler {
        address[] memory path = new address[](2);
