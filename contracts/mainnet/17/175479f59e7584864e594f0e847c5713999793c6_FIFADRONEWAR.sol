...
Fifa Drone War. The first of its kind shooter game based on Elon Tweet.

App project launching soon.
...
contract FIFADRONEWAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa Drone War";
    string private _symbol = "FIFA DRONE WAR";
