...
contract Internet_Money is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7c6A4c2D428f330C6280152BfbA61cF0016656B2); 
    address payable public Wallet_Dev = payable(0x0642Be3635F0AA5af83Ed1039eFa58db86eeb5e6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Internet Money"; 
