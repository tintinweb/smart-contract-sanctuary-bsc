...
contract SquidMinion is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidMinion";
    ...
    function ManualSend() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
