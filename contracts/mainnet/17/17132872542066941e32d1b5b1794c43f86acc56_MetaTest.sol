...
contract MetaTest is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaTest";
    string private constant _symbol = "MetaTest";
    ...
    function setBuyFee(
        ...
        require(
            _buyTaxFee + _buyLiquidityFee + _buyTeamFee <= 15,
    ...
    function setSellFee(
        ...
        require(
            _sellTaxFee + _sellLiquidityFee + _sellTeamFee <= 15,
