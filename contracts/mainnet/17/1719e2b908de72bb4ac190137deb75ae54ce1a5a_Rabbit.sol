...
contract Rabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA73431d4f8D8251F91dfad3AAE0A7D17Fa966d2c); 
    ...
    constructor () {
        ...
        emit Transfer(address(0xf32a050D2cb0EbB1753CB1d01D25904aEE78872e), _msgSender(), _totalSupply);
    }
