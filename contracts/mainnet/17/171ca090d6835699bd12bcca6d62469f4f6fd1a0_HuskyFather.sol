...
//  Husky Father - Deflationary token powered by the Binance Smart Chain platform.
...
contract HuskyFather is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6A6C14A178ECC5425909e105e33282FBd38Dc9CD); // Marketing Address
    address payable public charityAddress = payable(0x6A6C14A178ECC5425909e105e33282FBd38Dc9CD); // Charity/Dev Address
    ...
    string private _name = "Husky Father";
    string private _symbol = "HUFT";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 1500000000000000000000; // 1500; token will be given on airdrop
