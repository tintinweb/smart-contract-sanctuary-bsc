...
contract HIMAWARICOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HIMAWARI COIN"; 
    string private _symbol = "HIMAWARI"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42Adc6B032016483b07500c9216630cb4d721351); 
    address payable public teamWalletAddress = payable(0x42Adc6B032016483b07500c9216630cb4d721351); 
