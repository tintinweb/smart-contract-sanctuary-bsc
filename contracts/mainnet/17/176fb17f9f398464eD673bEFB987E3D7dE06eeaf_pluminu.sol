...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x109c911D1B119f72390f1538df594642a54135f3; // owner address
...
contract pluminu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Plum Inu";
    string private _symbol = "PLINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x109c911D1B119f72390f1538df594642a54135f3); // Marketing Address
    address payable public teamWalletAddress = payable(0x109c911D1B119f72390f1538df594642a54135f3); // Team Address
