...
// Telegram: https://t.me/dollardog
// Twitter: https://twitter.com/DOLLARDOGBSC
// Website https://www.dollardog.live
...
/* Token contract */
contract DollarDog is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8aE3bdA30cBa0493fACcDecb523d6e3EBB260d24;
    ...
    // Name and symbol
    string constant _name = "DOLLAR DOG";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 1% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 1% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8aE3bdA30cBa0493fACcDecb523d6e3EBB260d24;
