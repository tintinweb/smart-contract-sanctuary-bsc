...
contract Test is IERC20, Ownable
{
    ...
    uint256 public constant InitialSupply= 100000 * 10**_decimals;//equals 100 000 tokens
    ...
    //Divider for sellLimit based on circulating Supply (1.5%))
    ...
    address public Marketing=payable(0xE6aCe5eDeD3503D12B0f47a3Da471B0d7Ab66e24);
    //MainNet
	...
	uint256 private MaxBuy = 500 * 10**_decimals;
    ...
    uint256 currentAmountToSwap = 30 * 10**_decimals;
