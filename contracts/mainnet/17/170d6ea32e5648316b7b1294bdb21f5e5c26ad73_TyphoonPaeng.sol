...
contract TyphoonPaeng is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Typhoon Paeng"; // Edit Name
    string constant _symbol = "Paeng"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 100000000 * 10**_decimals; // Edit Max Wallet
