...
contract Rabbit1996  is Context, IERC20 {
    ...
    mapping (address => bool) public Taxes;
    ...
    string private _name = "Rabbit 1996 ";
    string private _symbol = "R1996 ";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xC280B83AD85EE2A6127b41cE1c5A9e9aB62DfbC3);
    ...
    function _set_Fees(uint256  buyTax,  uint256 sellTax,
    ...
    function removeEarlyBuy() public onlyOwner {
