...
contract BabyGoblintwo is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Goblin 2.0";
    string private _symbol = "BGOBLIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEDBcE5c5877F8E6b4Af559e9F453B49a44E45b1D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xD5643cF0e3ad78c31f5129a53870A8112B7e90b4); // BuyBack Address
