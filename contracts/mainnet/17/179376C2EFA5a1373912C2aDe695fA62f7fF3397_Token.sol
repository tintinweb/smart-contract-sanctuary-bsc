...
contract Token is IERC20, Ownable {
    ...
    address private sat = 0x55d398326f99059fF775485246999027B3197955;
    address private projectAddress = 0x000000000000000000000000000000000000dEaD;
   

    uint256 private _tFeeTotal;

    string private _name = "Perfect space dog";
    string private _symbol = "Dogb";
    ...
    uint256 public _projectAddressFee = 0;
    uint256 private _previouprojectAddressFee;
    ...
    constructor() {
        _tOwned[0x182F050AB69a2B4d9c39038C604e71acbB981f1A] = _tTotal;
        ...
        _isExcludedFromFee[0x182F050AB69a2B4d9c39038C604e71acbB981f1A] = true;
        _isExcludedFromFee[projectAddress] = true;
        _isExcludedFromFee[address(this)] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        
        emit Transfer(address(0), 0x182F050AB69a2B4d9c39038C604e71acbB981f1A, _tTotal);
    }
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function removeAllFee() private {
        ...
        _previouprojectAddressFee = _projectAddressFee;

        _burnFee = 0;
        _LPFee = 0;
        _inviterFee = 0;
        _satFee = 0;
        _projectAddressFee = 0;
    ...
    function restoreAllFee() private {
        ...
        _projectAddressFee = _previouprojectAddressFee;
    }
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 1* 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 8000 * 10**9)_burnFee = 0;
    ...
    function _takeprojetFee(address sender, uint256 tAmount) private {
        if(_projectAddressFee == 0) return;
    ...
    function _takesatFee (
        ...
        //     block.timestampa
        // );
        // uint256 initialBalance_eth = address(this).balance;
        // swapTokensForEth(tAmount);
        // uint256 newBalance_eth = address(this).balance.sub(initialBalance_eth);//换到的ETH

        // swapEthForToken(newBalance_eth,getsat);//用一半ETH换SAT  
    ...
    function _transferStandard(
        ...
        _takeprojetFee(sender,tAmount.div(10000).mul(_projectAddressFee));

      
       _takesatFee(sender, recipient,tAmount.div(10000).mul(_satFee));
