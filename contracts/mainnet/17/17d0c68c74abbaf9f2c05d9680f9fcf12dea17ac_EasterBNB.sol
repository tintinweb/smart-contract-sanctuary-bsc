...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa21dFF9839DfFE179b792F56b3FB9a14C03C5de3;
...
contract EasterBNB is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xaA883Cb4eCC4635dB81025BD85d72f51232a61C2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Easter BNB";
    string private _symbol = "EasterBNB";
