...
contract BNBReversal is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x2A7E1B7863bb58A7258aAe5DcaE14B2A19E20804); 
    address payable private Wallet_Dev = payable(0x2A7E1B7863bb58A7258aAe5DcaE14B2A19E20804);
    ...
    string private constant _name = "BNB Reversal"; 
    string private constant _symbol = unicode"BRV"; 
    ...
    constructor () {
        ...
        _owner = 0x2A7E1B7863bb58A7258aAe5DcaE14B2A19E20804;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2A7E1B7863bb58A7258aAe5DcaE14B2A19E20804); // Testnet
