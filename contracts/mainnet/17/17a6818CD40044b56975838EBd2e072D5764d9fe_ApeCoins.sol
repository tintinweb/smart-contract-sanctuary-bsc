...
contract ApeCoins is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeCoins";
    string private constant _symbol = "Ape";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xFB496be65d02390F6dAC5FB42E63fFb3574388be);
    address payable private _marketingAddress = payable(0xFB496be65d02390F6dAC5FB42E63fFb3574388be);
