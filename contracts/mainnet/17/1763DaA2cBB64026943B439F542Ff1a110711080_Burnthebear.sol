...
contract Burnthebear is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BUTBCDividendtracker public dividendTracker;
    ...
    constructor() ERC20("Burn The Bear", "BUTBC") {
        marketingWallet = payable(0x065C6BDB96C9eC9B34bAC659A45A5A025834e0C2);
        devWallet = payable(0x065C6BDB96C9eC9B34bAC659A45A5A025834e0C2);
        ...
        dividendTracker = new BUTBCDividendtracker(
            payable(this),
            router,
...
contract BUTBCDividendtracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Burnthebear public BurnthebearContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BurnthebearContract = Burnthebear(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Burnthebear_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Burnthebear_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Burnthebear contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BurnthebearContract);

            uint256 prevBalance = BurnthebearContract.balanceOf(address(this));
            ...
            {
                uint256 received = BurnthebearContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BurnthebearContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
