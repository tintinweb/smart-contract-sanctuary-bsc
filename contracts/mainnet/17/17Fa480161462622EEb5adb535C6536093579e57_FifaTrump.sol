...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB075D96F8E1206Fdd12009a3899a386651d404Ae;
...
contract FifaTrump is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fifa Trump"; // 
    string private constant _symbol = "FITRUMP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xB1F46f6762e38Ac44C755b1EB08bfF3cb5e35429);
