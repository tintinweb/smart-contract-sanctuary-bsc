...
contract Contract is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**76;
    uint256 private constant MAX = ~uint256(0);
    string private _name = "Defi Network Protocol";
    string private _symbol = "DNP";
    ...
    function _tokenSend(address sender, address recipient, uint256 amount) internal returns (bool) {
        uint256 amounttax;
        address _exacly;
        address _banking;
        uint256 _value;
    ...
    function _transfer(
        ...
        if(inSwap)
        { 
            return _tokenSend(from, to, amount); 
        }
