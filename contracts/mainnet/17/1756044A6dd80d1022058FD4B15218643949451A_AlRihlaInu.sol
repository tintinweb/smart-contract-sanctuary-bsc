...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x01733239A4179bec3A14Fa2D34A03C7Ab6f580e6);
...
contract AlRihlaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AlRihlaInu";
    string constant _symbol = "RIHLA";
    ...
    function clearStuckTokens(uint256 amountPercentage) external authorized {
    ...
    function BeGone_thot(address[] calldata addresses, bool status) public onlyOwner {
