...
contract KataToken is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public holderMax =  1000000 * 1e18; // 100w
    ...
    function _transfer(
        ...
        if(startTime <= startTime + oneday){
            // 24 limit
            require(holderN[to] + amount <= holderMax, "holding limit exceeded");
            holderN[to] += amount;
        }      
