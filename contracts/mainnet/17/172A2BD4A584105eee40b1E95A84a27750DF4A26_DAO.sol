...
contract DAO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "755 DAO"; //PNW
    string public constant _symbol = "755 DAO"; //PNW
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xa71d0657DA516EC532abF75c2383a2D0512aA844; 
        devWallet = 0xa71d0657DA516EC532abF75c2383a2D0512aA844; 
		prizewallet = 0xa71d0657DA516EC532abF75c2383a2D0512aA844; 
        
        totalFee = (liquidityFee.add(marketingFee).add(rewardsFee).add(devFee) .add(prizewalletfee));
        totalFeeIfSelling = totalFee + 9;
