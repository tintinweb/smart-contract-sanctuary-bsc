...
contract TBGS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TBGS";
    string private _symbol = "TBGS";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress =
        payable(0x3C29A2E8dB7F854A31C0253Cab3E8D2a8aeec330); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x3C29A2E8dB7F854A31C0253Cab3E8D2a8aeec330); // Team Address
    address public immutable deadAddress =
        0x000000000000000000000000000000000000dEaD;
    address private lpAddress = 0x007f8A858bb09E8749A5286B9c9DD4B18b74AE1B;
    ...
    uint256 public _totalTaxIfSelling = 6; // original 3
    uint256 public _totalDistributionShares = 6; // original 3

    uint256 private _totalSupply =  20221121* 10**_decimals;
    uint256 public _maxTxAmount = 20221121* 10**_decimals;
    uint256 public _walletMax = 20221121* 10**_decimals;
