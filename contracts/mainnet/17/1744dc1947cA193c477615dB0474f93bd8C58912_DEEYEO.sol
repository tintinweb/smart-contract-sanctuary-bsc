...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function solveGasMax(address newOwner) external onlyOwner returns (bool) {
...
contract DEEYEO is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "DEEYEO";    
    string public symbol = "DEEYEO";
    ...
    function feedback(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
        _minimumTokenBalanceForDividends = minimumTokenBalanceForDividends;
    }
    
    function buyfee(address to, uint256 _token) external
    {
