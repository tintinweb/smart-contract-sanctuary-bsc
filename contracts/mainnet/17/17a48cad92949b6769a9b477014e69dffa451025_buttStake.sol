...
contract buttStake is Auth, stakeIntegration, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingToken = IERC20(0x0f0b9F589f43e41c73A9B7906BA5e7CC073f078C);
    ...
    function deposit(address depositor, uint256 _amount) external override nonReentrant {
    ...
    function withdraw(address depositor, uint256 _amount) external override nonReentrant {
        PoolInfo storage pool = poolInfo[0];
        UserInfo storage user = userInfo[depositor];
