...
/**
 * Cat Coin Inu (CCI)
 * https://t.me/CatCoinInu
 * CCI token is specifically the new and only token in the BSC network.
...
contract CatCoinInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Coin Inu"; //
    string private constant _symbol = "CCI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x43E25bfCa9447149703917FdD9436BAd378F0201;
