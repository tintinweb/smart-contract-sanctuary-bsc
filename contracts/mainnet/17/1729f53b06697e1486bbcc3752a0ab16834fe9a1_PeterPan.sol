...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    bool initialized;
    uint8 public _taxFee = 200;
    uint8 public _previousTaxFee = 100;
    uint8 public _liquidityFee = 122;
    uint8 public _previousLiquidityFee = 32;
    uint8 public _rewardFee = 54;
    uint8 public _previousRewardFee = 94;
    address ZERO = 0x0000000000000000000000000000000000000000;

    constructor () {}   
    
    function implement(uint256 share) internal view returns (uint256) {}  
    ...
    function beginning() external returns (bool) {}
...
contract PeterPan is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'PeterPan';
