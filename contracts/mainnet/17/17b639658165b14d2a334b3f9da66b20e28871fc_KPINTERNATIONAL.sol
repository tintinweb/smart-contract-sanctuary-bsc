...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x7934BaDb8071889e4C640Ba55CF2215f7Eb73FbF;
        _owner = msgSender;
...
contract KPINTERNATIONAL is Ownable, ERC20 {
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    constructor() ERC20("KP INTERNATIONAL", "KPI") {
        setDexPairing(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _mint(0x7934BaDb8071889e4C640Ba55CF2215f7Eb73FbF, 1000000000 * 18** decimals());
    }
