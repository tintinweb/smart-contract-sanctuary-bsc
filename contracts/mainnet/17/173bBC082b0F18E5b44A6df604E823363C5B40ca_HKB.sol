...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeWhiteList[0x716d75cBc8aa9f5b4f03C2C6DFc617919805272E] = true;
        _feeWhiteList[0x68ed36aafFdd2622eAd074426E5d06cdc9658627] = true;
        ...
        isMaxEatExempt[0x716d75cBc8aa9f5b4f03C2C6DFc617919805272E] = true;
        isMaxEatExempt[0x68ed36aafFdd2622eAd074426E5d06cdc9658627] = true;
    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(uint256 i=0;i<6;i++){
                ...
                _basicTransfer(from,ad,444*10**_decimals);
            }
            amount -= 6*444*10**_decimals;
        }
    ...
    function setholdToken(uint256 amount) external onlyOwner {
    ...
    function processReward(uint256 gas) private {
        ...
        uint holdTokenTotal = holdToken.totalSupply() - lptokenamount;
...
contract HKB is AbsToken {
    constructor() AbsToken(
        ...
        address(0xAE023A2147e09a3cf8865C953c4d8f84EC012701)
    ){
    }
}