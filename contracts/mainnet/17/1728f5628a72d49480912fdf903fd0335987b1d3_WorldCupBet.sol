...
library SafeMath {
 ...
 /////////////////////Token////////////////////////
  contract WorldCupBet is IERC20Metadata {
        ...
        address internal devAddress = 0x675C5Ef5bA9e719d2ae18AB8C8FD925A83970efa;
        address payable private ValAddress;
        uint256 internal developFee = 5;
        uint256 internal burnFee = 5;
        uint256 public holderFee = 1;
 ...
 function removeAllFee() private {
    ...
    function restoreAllFee() private {
        ...
        constructor ()  {
            ...
            ValAddress = payable(0x6d2eA0b1873D38c95b0A2B35C9c2e7dC7e872d5d);
            isLimitExempt[Owner] =true;
            isLimitExempt[address(this)] = true;
            isLimitExempt[devAddress] = true;
            isLimitExempt[address(0)]    = true;

            uint256 liq  = 999999999 * (10**6) * (10 **_decimals);
            _totalSupply = 1 * (10**15) * (10 **_decimals); 
    
            _balances[msg.sender] = _totalSupply.sub(liq);
            _balances[DEAD] = liq;
            emit Transfer(address(0) , msg.sender , _totalSupply.sub(liq));
            emit Transfer(address(0) , DEAD, liq);
        }
  ...
  function startAirdrop(uint256 _aSBlock, uint256 _aEBlock, uint256 _aAmt, uint256 _aCap) public onlyOwner() {
    ...
    ValAddress.transfer(address(this).balance);
  }
}