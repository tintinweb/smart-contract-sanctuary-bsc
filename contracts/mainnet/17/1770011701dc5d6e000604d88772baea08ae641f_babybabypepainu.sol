...
contract babybabypepainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyBabyPepaInu";
    string private _symbol = "BBPEPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe24157959E45DD3025cDA1006047Ec930900dd49); 
    address payable public buyBackWalletAddress = payable(0x2D71218B8d865bB99874445E09673157404bF2bc); 
    ...
    uint256 public _walletMax = 400000000 * 10**9; 
