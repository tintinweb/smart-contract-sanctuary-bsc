...
/**
TG : https://t.me/babybullybsc
5% Burn forever
5% Marketing, Promotion and exchanger listing
2% Team
3% Developer
70% Liquidity
🌐Website : http://babybullyinu.com//*/
...
contract BABYBULLYINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYBULLYINU";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (10000 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
