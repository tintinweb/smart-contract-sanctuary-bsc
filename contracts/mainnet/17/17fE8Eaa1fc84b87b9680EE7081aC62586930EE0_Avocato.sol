...
contract Avocato is Context, IERC20, Ownable {
    ...
    uint256 private _maxTxAmount = 1000000000 * 10 ** 12;
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _pancakeswapv2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // bsc pcs v2
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        //if both account belongs to _isExcludedFromFee account then remove the fee
