...
Telegram Chat   : https://t.me/bitishit
Twitter         : https://twitter.com/Bitishit
Website         : https://bitishit.io/
*/
...
contract Bitishit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bitishit"; // 
    string private constant _symbol = "BTS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 0;
    address private  _marketingWallet = 0x86aF23930A810728DfD0D35A7fAD091b8bF9fB75;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 liquidityFee = amount * _liquidityFee / 2; 
