...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF5c46C1dC7a69FFa47B5fF5078CdF0FF09bDc56E; // owner address
...
contract oghayyaaa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG HAYYAAA";
    string private _symbol = "OG HAYYAAA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xF5c46C1dC7a69FFa47B5fF5078CdF0FF09bDc56E); // Marketing Address
    address payable public teamWalletAddress = payable(0xF5c46C1dC7a69FFa47B5fF5078CdF0FF09bDc56E); // Team Address
