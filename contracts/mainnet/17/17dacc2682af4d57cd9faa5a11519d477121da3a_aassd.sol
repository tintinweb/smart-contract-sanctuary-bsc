...
contract aassd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "asd";
    string private _symbol = unicode"asd";
    ...
    address payable public marketingWalletAddress = payable(0xc0E5b6F4bF4Bec3E7424644040c4425303744009); 
    address payable public BurnedWalletAddress = payable(0xc0E5b6F4bF4Bec3E7424644040c4425303744009); 
