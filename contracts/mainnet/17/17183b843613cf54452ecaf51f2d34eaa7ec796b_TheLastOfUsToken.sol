...
//https://t.me/LastOfUsToken
//https://twitter.com/LastOfUsToken
//https://lastofustoken.xyz
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57433DDEF42f89D7024859cE599aDbdB139481Ab;
...
contract TheLastOfUsToken is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_RND = payable(0x57433DDEF42f89D7024859cE599aDbdB139481Ab);
    ...
    address public DEVELOPMENT = 0x57433DDEF42f89D7024859cE599aDbdB139481Ab;
    ...
    */
    ...
    string public _name = "The Last Of Us Token"; 
    ...
    */
    ...
    This contract cant set until 99%-100%
    */
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/300;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/300;
    }
