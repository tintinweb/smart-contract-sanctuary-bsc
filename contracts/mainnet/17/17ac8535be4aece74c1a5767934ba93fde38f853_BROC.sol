...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ROC = IBEP20(0xaA8F550ED21aE4ecE978f4141c4551D1Deb7390A);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ROC.balanceOf(address(this));
        ...
        uint256 amount = ROC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ROC.transfer(shareholder, amount);
...
contract BROC is IBEP20, Auth {
    ...
    string constant _name = "BabyRocketRaccoon";
    string constant _symbol = "BROC";
