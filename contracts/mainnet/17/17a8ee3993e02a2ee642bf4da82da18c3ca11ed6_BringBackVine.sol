...
/**
We will renounce after launch + burn the LP 
Elon will bring back VINE and then we will moon
Telegram: https://t.me/MAKE_MONEY_ARMY
...
contract BringBackVine is Ownable, IBEP20 {
    ...
    string constant _name = "Bring Back Vine";
    string constant _symbol = "Vine";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x4cC88433B29DE55088786b777A5AD7f0843553e7;
        marketingWallet = 0x4cC88433B29DE55088786b777A5AD7f0843553e7;
        hiWallet = 0x4cC88433B29DE55088786b777A5AD7f0843553e7;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(hiFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBHi = amountBNB.mul(hiFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(hiWallet).call{value : amountBNBHi, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newHiFee, uint256 extraSellFee) external onlyOwner {
