...
contract babyYESzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babyYESzilla";
    string private _symbol = "babyYESzilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xE9B48824D41C2D2186E4C834BcbE807145b1A224); 
    address payable public ttWal = payable(0xE9B48824D41C2D2186E4C834BcbE807145b1A224); 
