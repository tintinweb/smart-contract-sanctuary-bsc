...
contract DefiChina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DefiChina";
    string private _symbol = "DefiChina";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB697A2A33071dD2dcFe89a34653939CAe60f96e8); 
    address payable public teamWalletAddress = payable(0x9cb67dd3923e7E8ffd0410988fDb9F7e429b7bd4); 
