...
contract ReflectionStakingPool is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function getEarningsForUser(address _user) external view returns(uint256) {
        return earnedAmount[_user];
    }
    ...
    function swapTokens() external {
        ...
        */
        for (uint i = 0; i < userSet.length(); i++) {
            ...
            earnedAmount[userSet.at(i)] = earnedAmount[userSet.at(i)].add(purchasedTokens.mul(currentBalance).div(totalStaked));
        }
