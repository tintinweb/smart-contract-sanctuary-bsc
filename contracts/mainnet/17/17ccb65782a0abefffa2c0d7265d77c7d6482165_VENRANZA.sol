...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xc7077A02716E07244F13fCF483bC2A6EB028d211;
...
contract VENRANZA is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"VENOM CARRANZA COIN"; 
    string private constant _symbol = unicode"VENRANZA"; 
    ...
    uint256 public _BuyFee = 50; // in 0.1% units
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xc7077A02716E07244F13fCF483bC2A6EB028d211), BNB_Tot);
            }
