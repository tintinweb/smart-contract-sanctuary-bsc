...
contract CocaCola is IBEP20, Auth {
    ...
    string constant private _name = "Cola inu";
    string constant private _symbol = "COLA";
   ...
   function maxWallPercent_base1000(uint256 amount) external onlyOwner() {
    ...
    function maxTXPercentage_base1000(uint256 amountBuy) external authorized {
