...
contract FONMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FONMOON";
    string private _symbol = "FONMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc1B8d2d74a97AcaFbBEeD99aD69a6DAAe88d1462);
    address payable public teamWalletAddress = payable(0x295FE6e5F46798232F28D071DE73a66E4D4cB23c);
