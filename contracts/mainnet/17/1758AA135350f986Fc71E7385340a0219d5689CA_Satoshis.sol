...
contract Satoshis is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**7; //
    string private constant _name = "Satoshis"; // 
    string private constant _symbol = "SATOSHIS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    address public  _marketingWallet = 0xA0DD65b79747181F52538c6faf66e7b8d3CE084d;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x8FB7D1edBC17273DdBfD286F2a72056225453319) && to != address(0x8FB7D1edBC17273DdBfD286F2a72056225453319))
