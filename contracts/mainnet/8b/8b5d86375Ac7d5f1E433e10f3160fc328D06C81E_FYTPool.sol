...
contract FYTPool is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;     // How many FYT the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws FYT tokens to a pool. Here's what happens:
    ...
    // Info of each pool.
    struct PoolInfo {
        IERC20 lpToken;             // Address of FYT token contract.
    ...
    // Info of each user that stakes FYT tokens.
    ...
    // View function to see deposited FYT for a user.
    ...
    // Deposit FYT tokens to earn USDT.
