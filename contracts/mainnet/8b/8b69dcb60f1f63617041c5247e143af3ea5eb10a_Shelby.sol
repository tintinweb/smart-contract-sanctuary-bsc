...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c993daFaFaC9b5738DE43cF5f3cA855FdE4E032; // owner address
...
contract  Shelby is Context, IERC20, Ownable {
    ...
    string private _name = "Shelby Mafia";
    string private _symbol = "SM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcBcB8FaaAec1105fD8AAddd0D2f81b1021587bEe); // Marketing Address
    address payable public teamWalletAddress = payable(0xcBcB8FaaAec1105fD8AAddd0D2f81b1021587bEe); // Team Address
