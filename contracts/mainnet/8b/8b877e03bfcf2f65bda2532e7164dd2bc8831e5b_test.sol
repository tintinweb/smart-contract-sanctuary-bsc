...
contract test is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0xa5017aEF3354762b263bF5044ED9FADa25050C1A);
    address payable public MarketingWallet = payable(0x38A024a6E90142467F0373faE2383c0F17f07F50);
    address payable private TeamWallet01 = payable(0x38A024a6E90142467F0373faE2383c0F17f07F50);
