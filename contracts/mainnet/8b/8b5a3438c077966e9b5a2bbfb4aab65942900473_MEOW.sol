...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf6e787DF556854e48CB0db12095668280b4e66F6; // owner address
...
contract MEOW is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf6e787DF556854e48CB0db12095668280b4e66F6); // Marketing Address
    address payable public teamWalletAddress = payable(0xf6e787DF556854e48CB0db12095668280b4e66F6); // Team Address
