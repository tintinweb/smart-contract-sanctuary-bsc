...
// 
//
// 📱 Telegram:https::https://t.me/SQUIDNETWORK
/*
...
contract SQUIDNETWORK is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("SQUIDNETWORK", "SQUIDNETWORK") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SQUIDNETWORK";
    string private _symbol = "SQUIDNETWORK";
