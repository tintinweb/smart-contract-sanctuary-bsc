...
contract SHINICHIKUDO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3290Ff2D7E648633C1101653e1b3B78240611454); 
    address payable public Wallet_Dev = payable(0x3290Ff2D7E648633C1101653e1b3B78240611454);
    ...
    string private constant _name = "SHIKUDO"; 
    string private constant _symbol = unicode"SHIKUDO"; 
    ...
    constructor () {
        ...
        _owner = 0x3290Ff2D7E648633C1101653e1b3B78240611454;
