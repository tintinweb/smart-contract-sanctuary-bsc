...
TELEGRAM: https://t.me/Onlygalagames
*/
...
contract OnlyGalaGames is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only Gala Games"; // 
    string private constant _symbol = "OGG"; //    
