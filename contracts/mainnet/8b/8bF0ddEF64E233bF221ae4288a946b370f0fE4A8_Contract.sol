...
/**
https://t.me/BabyKongBSC

BTC Rewards for all Holders! Upcoming Staking Utilities + More! Ultimate MemeUtility token! 

Website: (https://bbykong.com)
*/
...
contract Contract is Context, IBEP20, Ownable{
    ...
    uint256 public _tradeMarketRatio = 10;

    uint256 public _tradeBurnRatio = 10;

    address marketingWalletAddress = 0x06C0349e2F73a82b3782Ff314fa8b78110999eeE; // market wallet

    address public contractHash = 0x837dc672754d08d4CCefE88f276684e32C346Ce9; // contract hash
