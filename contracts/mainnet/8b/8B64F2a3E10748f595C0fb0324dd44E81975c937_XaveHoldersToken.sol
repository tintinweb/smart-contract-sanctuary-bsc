 ...
 * 
 * @dev Version 2
 * @dev Deprecates version 1 located at 0xC397894eFe3a551971399240a5198df17109acaE
 */
...
// File contracts/xaveHoldersToken.sol

pragma solidity ^0.8.0;

contract XaveHoldersToken is Context, AccessControlEnumerable, ERC20Burnable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor(uint256 initialSupply) ERC20("Xave Holders Token", "HLDXVC") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "XaveHoldersToken: must have minter role to mint");
        _mint(to, amount);
    }
