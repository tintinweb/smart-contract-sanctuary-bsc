...
Telegram : https://t.me/TwizzlerinuPortal
Website : TBA *under construction
Twitter : TBA
...
contract TwizzlerInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9b135D4BD39d5CB4322955765d0CBe7314E164b7); 
    address payable public Wallet_Dev = payable(0x9b135D4BD39d5CB4322955765d0CBe7314E164b7);
    ...
    string private constant _name = "Twizzler Inu"; 
    string private constant _symbol = unicode"Twizzler"; 
    ...
    constructor () {
        ...
        _owner = 0x9b135D4BD39d5CB4322955765d0CBe7314E164b7;
        emit OwnershipTransferred(address(0), _owner);

        

        _tOwned[Wallet_Marketing] = _tTotal;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * _Burntax / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * _LiqPool / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (_LiqPool + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (_LiqPool + Percent_Marketing + Percent_Dev);
