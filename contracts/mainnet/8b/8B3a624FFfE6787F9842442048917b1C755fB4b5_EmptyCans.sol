...
contract EmptyCans is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EmptyCans";
    string private _symbol = "$EmptyCans";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x4CbEd165824b7f7ea09124957B73030d808Ad083); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4CbEd165824b7f7ea09124957B73030d808Ad083); // BuyBack Address
