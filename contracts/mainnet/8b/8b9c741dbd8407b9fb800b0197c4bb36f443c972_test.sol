...
contract test is ERC20Burnable, Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    bytes32 keyHash = 0x17cd473250a9a479dc7f234c64332ed4bc8af9e8ded7556aa6e66d83da49f470; //0xff8dedfbfa60af186cf3c830acbc32c05aae823045ae5ea7da1e45fbfaba4f92;
    ...
    function _transfer(address from, address to, uint256 amount) internal override  {       
        ...
        if (taxOn && 
            ...
            if (lottoTax > 0) {
                ...
                generatedLottoTicket = toHex(keccak256(abi.encodePacked(to, block.timestamp)));
