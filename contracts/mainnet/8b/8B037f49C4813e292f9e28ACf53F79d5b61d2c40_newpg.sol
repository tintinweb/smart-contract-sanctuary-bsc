...
contract newpg is Ownable, ReentrancyGuard {
  ...
  function withdrawal() public nonReentrant {
    ...
    safeTransfer(msg.sender, _earnings[msg.sender]);
  ...
  function deposit() public nonReentrant {
    ...
    if(_earnings[msg.sender] > 0) {
      ...
      if (_earnings[msg.sender] >= amount) {
        safeTransfer(mk_address, amount.mul(3).div(10));
        safeTransfer(burnAddress, amount.mul(2).div(10));
        ...
        safeTransfer(mk_address, contractAmount.mul(3).div(10));
        safeTransfer(burnAddress, contractAmount.mul(2).div(10));

        IERC20(USDT).transferFrom(msg.sender, mk_address, paidAmount.mul(3).div(10));
        IERC20(USDT).transferFrom(msg.sender, address(this), paidAmount.mul(5).div(10));
        IERC20(USDT).transferFrom(msg.sender, burnAddress, paidAmount.mul(2).div(10));
      ...
      IERC20(USDT).transferFrom(msg.sender, address(this), amount.mul(5).div(10));
      IERC20(USDT).transferFrom(msg.sender, burnAddress, amount.mul(2).div(10));
      _earnings[result] = _earnings[result].add(amount.mul(5).div(10));
