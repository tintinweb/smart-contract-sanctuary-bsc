...
contract NewCommunitySnake is BEP20, Auth {
    ...
    string public constant name = "NewCommunitySnake";
    string public constant symbol = "$NCS";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 10 * 10**11 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 33;
    uint256 public _maxWalletToken = totalSupply / 33;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketerFeeReceiver = 0xaDcaA073C1D25B98E8FEbD5E491F30a71930Bcf4;
        teamFeeReceiver = 0xaDcaA073C1D25B98E8FEbD5E491F30a71930Bcf4;
        devFeeReceiver = 0xaDcaA073C1D25B98E8FEbD5E491F30a71930Bcf4;
