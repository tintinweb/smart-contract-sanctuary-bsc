...
contract Binance_Binary_System is Context {
    ...
    Descriptions = "Welcome to Binance Binary System (BBS). This is 100% decentralized. Sign up $100. You have two legs (left and right). Invite two new users. You will be awarded 1 commission for each new user on the left and right up to 30 commissions per day.  The difference of the left and right are transferred to the next day. When you flash out, difference will not be zero. 100% of all deposit payments are sent to the contract and are paid to users every 24 hours. The time of payment of commissions is determined by users. Users who receives at least one commission is allowed to write the commission payment order on the contract. The payment time is at least 24 hours after the previous payment. You will be paid 30 million BBS when you register. Total 1ID revenue for BBS liquidity is paid to Pancakeswap. The smart contract will continue to work non-stop. There is no income outside the system for anyone. Enjoy BBS.";
        tokenAddress = 0x1d957Fe98DC9F1360772c41064E66759E93Ec8cf; 
