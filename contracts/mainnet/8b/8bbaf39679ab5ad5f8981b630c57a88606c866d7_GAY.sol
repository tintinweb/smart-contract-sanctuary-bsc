...
contract GAY is Context, IERC20, Ownable {
    ...
    string private _name = "Gay Cat";
    string private _symbol = "GCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF25D675C75BC7116FaF685c21100343acf4C9918); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x12DE27C4E7ca63629Bd5bED9002C4880f24A6412); // BuyBack Address
