...
contract DinogeTwo is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DinogeTwo";
    string private _symbol = "DINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd1f1de8CC5820aB194B7ceE0372Df89f8A5BD698); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xd1f1de8CC5820aB194B7ceE0372Df89f8A5BD698); // BuyBack Address
