...
contract MyDiamondTeamV2 {
    ...
    */
	...
	function V1Feed(address userAddress, address upline, string memory name) external {
        require(msg.sender == address(0xa3d732dB58fb8FC56d6F62603D99d34deB048467), "Admin use only");
        
        uplinesOld[userAddress] = upline;
        name = _toLower(name);
        nicknames[userAddress] = name;
    }
