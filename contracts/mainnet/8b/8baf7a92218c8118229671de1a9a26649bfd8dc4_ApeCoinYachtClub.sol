...
/**
 *https://t.me/apecoinyachtclub_official
*/
...
contract ApeCoinYachtClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeCoinYachtClub";
    string constant _symbol = "$ACYC";
    ...
    uint256 private ApeBankFee      = 2;
    uint256 private burnFee         = 0;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + burnFee + ApeBankFee;
    ...
    address private ApeBankFeeReceiver;
    ...
    uint256 public swapThreshold = _totalSupply * 480 / 10000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9025Fc4A2B7626bef028CE75EEeB86C5e071A405;
        teamFeeReceiver = 0x9025Fc4A2B7626bef028CE75EEeB86C5e071A405;
        ApeBankFeeReceiver = 0x2dea9890866514A364e987DDB915396dae483c2d;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB.mul(ApeBankFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
        (tmpSuccess,) = payable(ApeBankFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _ApeBankFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        ApeBankFee = _ApeBankFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _burnFee + _ApeBankFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _ApeBankFeeReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        burnFeeReceiver = _burnFeeReceiver;
        ApeBankFeeReceiver = _ApeBankFeeReceiver;
    }
