...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 8 * 10** Decimals;
        maxSellAmount = 8 * 10** Decimals;
        walletLimit =  168 * 10** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xcc02C783805aAC8C86194645d6677724801b51Fc;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        unicode"168 Dao",//Name
        unicode"168Dao",//Symbol
        9,//Decimals
        168,//Supply
        address(0xcc02C783805aAC8C86194645d6677724801b51Fc),//FundAddress
        address(0xcc02C783805aAC8C86194645d6677724801b51Fc)//ReceiveAddress
    ){
    }
}