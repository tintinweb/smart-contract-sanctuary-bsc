...
contract JH is Ownable, IBEP20 {
    ...
    mapping(address => address) public refer;  //上级
    mapping(address => uint) public preemptions;  //是否优先购买
    ...
    constructor() {
        ...
        _mint(0x116a5052Cc0A2787cf4aeB64f89255feb1390995, 10000000 * 1e18);

        setWhite(0x116a5052Cc0A2787cf4aeB64f89255feb1390995, true);
        setWhite(adds["burnPay"], true);
