...
//maxtxpercent = apply pada sell je. buy unlimited
...
contract TestV1 is Context, IERC20 {
    ...
    string constant private _name = "testv1";
    ...
    address payable private _marketingWallet = payable(0xcc530d8393B609d6214267d9bd15fcF939c018fa);
    address payable private _developmentWallet = payable(0xcc530d8393B609d6214267d9bd15fcF939c018fa);
    address payable private _buybackWallet = payable(0xcc530d8393B609d6214267d9bd15fcF939c018fa);
    
    bool inSwap;
    bool public contractSwapEnabled = true;

    uint256 private maxTPercent = 1; //percent : 1 divisor : 100 000 = 1000token
    uint256 private maxTDivisor = 10000000;
