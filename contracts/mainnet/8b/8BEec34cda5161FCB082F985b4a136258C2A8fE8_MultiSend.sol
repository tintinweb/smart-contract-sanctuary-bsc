...
library Address {
    ...
    // Check if the contract has enough balance to send the amount.
    require(address(this).balance >= amount, "Insufficient balance in the contract");

    // Call the recipient address and transfer the amount of ether.
    // Disable linter warnings for low-level calls and call with value.
    (bool success, ) = recipient.call{value: amount}("");
    require(success, "Unable to send ether to the recipient");
}
