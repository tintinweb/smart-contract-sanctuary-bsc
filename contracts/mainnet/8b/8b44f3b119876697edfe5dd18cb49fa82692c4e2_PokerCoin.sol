...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(auth[_msgSender()], "Ownable: caller is not the owner");
        _;
    }
...
contract PokerCoin is ERC20, Ownable {
    ...
    constructor() ERC20("PokerCoin", "PKR") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.
        //mainnet pancakeSwapRouter: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        // testnet pancakeSwapRouter: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        IDexRouter _dexRouter = IDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        marketingAddress = 0x961cbf20d77894A209D20ffc22110CcED9108503;
        ...
        devAddress = 0x17fcB0935Bab6651351A464d06781Ce8Deb339f4;
    ...
    function enableTrading() external onlyOwner {
        ...
        blockForPenaltyEnd = tradingActiveBlock + 2;
        emit EnabledTrading();
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(blockForPenaltyEnd > 0){
            require(!boughtEarly[from] || to == address(0xdead), "Bots cannot transfer tokens in or out.");
        }
