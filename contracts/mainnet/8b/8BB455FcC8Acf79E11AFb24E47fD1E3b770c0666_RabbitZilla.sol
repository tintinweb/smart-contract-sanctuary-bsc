...
contract RabbitZilla is Context, IERC20, Ownable {
    ...
    address payable private _appAddress = payable(0xE34D7251ff9B08DE5CC8e096975D79a9371CbE58);
    address payable private _marketingAddress = payable(0xE34D7251ff9B08DE5CC8e096975D79a9371CbE58);
    address payable private _buybackAddress = payable(0xE34D7251ff9B08DE5CC8e096975D79a9371CbE58);
    address payable private _burnAddress = payable(0xE34D7251ff9B08DE5CC8e096975D79a9371CbE58);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 devAmount = amount.mul(1).div(5);
        uint256 mktAmount = amount.mul(3).div(5);
        uint256 buybackAmount = amount.mul(1).div(5);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 2, "Redis cannot be more than 5.");
	    require(redisFeeOnSell < 2, "Redis cannot be more than 5.");
	    require(taxFeeOnBuy < 25, "Tax cannot be more than 11.");
	    require(taxFeeOnSell < 25, "Tax cannot be more than 11.");
