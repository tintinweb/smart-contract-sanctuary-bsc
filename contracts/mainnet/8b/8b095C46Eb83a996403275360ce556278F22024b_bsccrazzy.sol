...
contract bsccrazzy is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "BSC CRAZZY";
    string constant _symbol = "BSCRZY";
