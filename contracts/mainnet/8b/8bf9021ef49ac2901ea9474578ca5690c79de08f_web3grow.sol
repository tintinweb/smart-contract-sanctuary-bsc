...
6% marketing
2% LP
2% rewards The Web3 Project (TWEP)
sell tax : 10%
breakdown sell tax :
6% marketing
2% LP
...
max wallet : 2%
max tx : 2%
TG : https://t.me/THEWEB3GROW
twitter : will be announced in the Telegram
website : will be announced in the Telegram
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TWEP = IERC20(0x1AEb3f66d96bFaF74fCBD15Dc21798De36F6F933);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TWEP.balanceOf(address(this));
        ...
        uint256 amount = TWEP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TWEP.transfer(shareholder, amount);
...
contract web3grow is IERC20, Ownable {
    using SafeMath for uint256;

    
    address TWEP = 0x1AEb3f66d96bFaF74fCBD15Dc21798De36F6F933;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Web3 Grow";
    string constant _symbol = "TWEPGROW";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x72B9Ce25cf1A63b1b572e4951b6a17303c9cfDE9);
        marketingFeeReceiver = address(0x72B9Ce25cf1A63b1b572e4951b6a17303c9cfDE9);
