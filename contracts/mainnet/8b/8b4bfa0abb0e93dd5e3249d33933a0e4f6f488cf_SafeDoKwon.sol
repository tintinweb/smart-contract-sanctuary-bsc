...
contract SafeDoKwon is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Safe Do Kwon";
    string private constant _symbol = unicode"sDOKWON";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0xAc8bc57A4730e38d95161e233fd268E66f669FFF);
    address payable private MarketingWallet = payable(0xAc8bc57A4730e38d95161e233fd268E66f669FFF);
