...
// File: contracts/RatzPoolInitializable.sol

pragma solidity 0.6.12;

contract RatzPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public Ratz_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == Ratz_POOL_FACTORY, "Not factory");
