 ...
 *      https://t.me/DogCowBSC
        
        Brought to you by DrDre (DogCoin DEV 700K+)
        @DresReviews - SAFU PLAYS
...
contract DogCow is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "DogCow";
    string private _symbol = "MUUF";
    uint256 private _decimals = 10;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _burnTokenfee = 1;
    address private _burnaaddress = 0xde1aE4bBdE2Dd2ff08a91242bfC73E948a8A167A;
