...
// Dependency file: contracts/baby/UpToYouTokenDividendTracker.sol
...
contract UpToYouTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UpToYouToken contract."
        );
    }
...
// Root file: contracts/baby/UpToYouToken.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/UpToYouTokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract UpToYouToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    UpToYouTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = UpToYouTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "UpToYouToken: The dividend tracker already has that address"
        );

        UpToYouTokenDividendTracker newDividendTracker = UpToYouTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "UpToYouToken: The new dividend tracker must be owned by the UpToYouToken token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "UpToYouToken: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "UpToYouToken: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "UpToYouToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "UpToYouToken: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "UpToYouToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "UpToYouToken: Cannot update gasForProcessing to same value"
        );
