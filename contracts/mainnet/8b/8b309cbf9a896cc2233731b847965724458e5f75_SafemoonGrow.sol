...
contract SafemoonGrow is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Safemoon Grow';
    ...
    //DevWallets
    address public BuyBack=payable(0x705Ae2250744164830A129C64AE112Bd4627e63C);
    address public Marketing=payable(0x705Ae2250744164830A129C64AE112Bd4627e63C);
    //MainNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==BuyBack||addr==Marketing;
    }
    ...
    uint256 currentAmountToSwap = 3000000000 * 10**_decimals;
    ...
    function CollectMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(BuyBack).transfer((amount*20) / 100);
    ...
    function REL() public onlyOwner {
        ...
        liquidityToken.transfer(BuyBack, amount);
    ...
    function TeamCollectRemainingBNB() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =BuyBack.call{value: (address(this).balance)}("");
        require(sent);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //external//////////////////////////////////////////////////////////////////////////////////////////////
