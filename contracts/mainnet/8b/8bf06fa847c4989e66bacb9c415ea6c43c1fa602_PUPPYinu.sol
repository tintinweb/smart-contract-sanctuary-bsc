...
interface IUniswapV2Router02 {
 ...
 contract PUPPYinu is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x973bd64be394184008F8fc5E10084949BdbcAbdB);
    address payable private _twdmkt = payable(0x973bd64be394184008F8fc5E10084949BdbcAbdB);
