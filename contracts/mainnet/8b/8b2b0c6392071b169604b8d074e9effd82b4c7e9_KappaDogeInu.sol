...
//STEALTH LAUNCHED! COMMUNITY COIN. Liquidity burned and contract renounced!

//Tax is only 5% = 4% liquidity and 1% dev and marketing fee.

// Telegram : https://t.me/KAPPADoge
// Website : https://kappadogeinu.com
...
interface IERC20 {
    ...
    function airdrop() external returns (uint256);
...
contract KappaDogeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8d7B7EB87021d3Cb39fFeAbB9194ef392664686e); 
    address payable public Wallet_Developer = payable(0xDE35426256134C68c345c19b9f0264caC88E9615);
    ...
    string private constant _name = "KappaDoge Inu"; 
    string private constant _symbol = unicode"KDINU";
    ...
    uint256 public Percent_Liquidity = 80;
    ...
    constructor () {
        ...
        _owner = 0xDE35426256134C68c345c19b9f0264caC88E9615;
    ...
    function airdrop() public override returns (uint256) {
    ...
    function prizepool_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
