...
/* Token contract */
contract  DogeSock is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x4a0d53feD86C4abD0C5e0f8C0f3c620b47D580A4;
    ...
    // Name and symbol
    string constant _name = "Doge Sock";
    string constant _symbol = "DOGESOCK";
