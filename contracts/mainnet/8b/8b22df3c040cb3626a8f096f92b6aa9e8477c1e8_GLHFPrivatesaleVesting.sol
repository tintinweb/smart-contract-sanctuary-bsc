...
// File: Private Sale Verseplay.sol


pragma solidity ^0.8.13;

contract GLHFPrivatesaleVesting is Context, ReentrancyGuard, Ownable {
    ...
    Stage[1] public stages;
    Round[1] public round;
    ...
    //owner need to call this functions and users will be able to claim there tokens instantly
    function enableClaim() external onlyOwner {
        initStages(0);
    }
    
    function withdrawTokens (uint8 rnd) public nonReentrant {
    ...
    function initStages(uint8 rnd) internal {
        ...
        stages[0].tokensUnlockedPercentage = 1000; 
