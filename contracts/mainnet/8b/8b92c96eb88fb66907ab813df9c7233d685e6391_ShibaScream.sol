...
contract ShibaScream is Context, IERC20, IERC20Metadata {
    ...
    constructor(uint256 initialSupply, address routerAddress) {
        ...
        marketingWallet = payable(0x699B6E3adA437daFA1Dd0ec5DE5Be7e196528f47);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(tradingStatus || isFeeExempt[sender]);
