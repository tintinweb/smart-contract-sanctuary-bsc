...
contract GIANTNETWORK is Context, IERC20, Ownable { // ganti nama token 
    ...
    uint256 private _tTotal = 100_000_000 * 10**9; // TOTAL SUPPLY
    uint256 public _maxTxAmount = 1_500_000 * 10**9; // MAX TX 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 15_000 * 10**9; // MINIMAL SUPPLY YANG DIMILIKI UNTUK SWAP
    string private constant _name = "Giant Network"; // NAMA TOKEN
    string private constant _symbol = "GNET"; // SIMBOL TOKEN
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7; // TAX MARKETING
    uint256 public _liquidityFee = 2; // TAX LIQUIDITY 
    address private _marketingWallet = 0xA21A219847B43d88EE5406b4cF9a8126a927A498 ; //MARKETING WALLET
