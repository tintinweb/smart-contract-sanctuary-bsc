    ...
    WithLevelsSale
{
    ...
    function voidAndRefund(address payable account, bool refund) external onlyOwnerOrAdmin {
...
interface ILevelManager {
    struct Tier {
        string id;
        uint256 multiplier; // 4 decimals. 1x = 10000
    ...
    struct Pool {
        ...
        // Final tier multiplier = level.multiplier * multiplierBoost. 10% = 100
