...
contract Play4CashToken is ERC20, Ownable {
    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public projectFee = 2;
    address public projectWallet = 0xEE80133ad168815e4D9f40C4a0DDC47dAD2E0459;
    ...
    constructor () ERC20("Play4Cash", "P4C") 
    {   
        transferOwnership(0xeFAb7E75eE317b57be9006BFe59C03Dd51Dca04d);
    ...
    function changProjectWallet(address _projectWallet) external onlyOwner {
    ...
    function swapAndSendProject(uint256 tokenAmount) private {
        ...
        sendBNB(payable(projectWallet), newBalance);
    ...
    function _transfer(
        ...
        if (antibotEnabled && launchTime > 0 &&
            ...
            if (launchTime + 1 days > block.timestamp) 
            {
                if(from == uniswapV2Pair) {
                    ...
                    require(
                        ...
                        "You need to wait 15 seconds before selling during antibot"
                    );
