...
SNOKI TOKENOMICS
5% Taxes for Marketing
4% Game
1% Buyback
2% Team
3% Auto Liquidity to Stabilise the Token Floor Price
15% Buy/Sell Taxes in Total 

Maximum Buy/Sell Taxes Capped at 15%
...
Smart Contract Deployed by (Telegram) - @imfrodobaggins
...
contract SIXTH is Context, IERC20, Ownable {
    ...
    string private _name = "SIXTH";
    string private _symbol = "SIXTH";
