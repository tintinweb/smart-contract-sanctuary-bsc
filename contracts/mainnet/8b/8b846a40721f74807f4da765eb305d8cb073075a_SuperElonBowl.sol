...
contract  SuperElonBowl is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SuperElonBowl";
    string constant _symbol = "SuperElonBowl";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xDBb9A39071773248C6A77Df9c0A87062ece04Bd9;
