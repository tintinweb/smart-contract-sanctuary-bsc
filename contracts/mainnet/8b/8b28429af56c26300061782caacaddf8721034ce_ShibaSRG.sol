...
contract ShibaSRG is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "ShibaSRG";
    string private constant _symbol = "$SSRG";
    ...
    //Tax wallets
    address public teamWallet = 0x6217D69A2644068AFd1E02a61eA23156A18E70B3;
    address public treasuryWallet = 0x70D4830e7B5b6132690930bB9b48579D1065BbA2;
    ...
    //trading parameters
    uint256 public liquidity = 8**5 * 10**_srgDecimals;
