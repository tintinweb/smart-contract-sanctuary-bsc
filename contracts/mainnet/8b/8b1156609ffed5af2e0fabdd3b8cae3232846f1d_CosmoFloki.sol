...
contract CosmoFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cosmo Floki";
    string private _symbol = "COF";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x924Cc7D9b424ee83072B54ADab511803c3E3032A); 
    address payable public buyBackWalletAddress = payable(0x924Cc7D9b424ee83072B54ADab511803c3E3032A); 
    ...
    uint256 private minimumTokensBeforeSwap = 168 * 10**18; 
