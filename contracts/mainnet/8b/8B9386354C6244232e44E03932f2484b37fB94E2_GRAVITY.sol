...
// File: RewardTokens/contracts/interfaces/IBEP20.sol
...
// File: RewardTokens/contracts/interfaces/IPYESwapRouter01.sol
...
// File: RewardTokens/contracts/interfaces/IPYESwapRouter.sol
...
// File: RewardTokens/contracts/interfaces/IPYESwapPair.sol
...
// File: RewardTokens/contracts/interfaces/IPYESwapFactory.sol
...
// File: RewardTokens/contracts/interfaces/IWETH.sol
...
// File: RewardTokens/contracts/libs/BEP20.sol
...
// File: RewardTokens/contracts/Gravity.sol
...
contract GRAVITY is Context, Ownable, AccessControl, ERC20 {
    using SafeMath for uint256;
    using Address for address;
    ...
    string constant _name = "Gravity";
    string constant _symbol = "GRAVITY";
    ...
    function excludeFromFee(address account) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "GRAVITY: NOT_ALLOWED");
    ...
    function setBuybackPercent(uint256 _buybackFee) external {
        require(hasRole(FEE_SETTER_ROLE, msg.sender), "GRAVITY: NOT_ALLOWED");
    ...
    function mint(address _to, uint256 _amount) public {
        require(hasRole(MINTER_ROLE, msg.sender), "GRAVITY: NOT_ALLOWED");
        require(totalSupply().add(_amount) <= MAX_SUPPLY, "GRAVITY: REACHED_MAX_SUPPLY");
    ...
    */
    ...
    external
    {
        ...
        require(signatory != address(0), "GRAVITY::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "GRAVITY::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "GRAVITY::delegateBySig: signature expired");
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "GRAVITY::getPriorVotes: not yet determined");
    ...
    internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying GRAVITY (not scaled);
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "GRAVITY::_writeCheckpoint: block number exceeds 32 bits");
