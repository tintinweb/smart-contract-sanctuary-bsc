...
// Telegram : Telegram : https://t.me/TwitterSinkHQ
...
contract TwitterSink69 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf75B54d7cbCc169c08681A90B1526D256b457e00); 
    address payable public Wallet_Utility = payable(0xfe933e01a7F0A1C81B50644f949C788Dd09159c2);
    ...
    string private constant _name = "6.9 Twitter Sink HQ or 6.9 Elon CZ"; 
    string private constant _symbol = unicode"6.9 ETH";
    ...
    constructor () {
        ...
        _owner = 0xfe933e01a7F0A1C81B50644f949C788Dd09159c2;
