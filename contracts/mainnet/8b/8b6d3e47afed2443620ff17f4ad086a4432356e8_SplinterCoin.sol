...
contract SplinterCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Splinter Coin";
    string private _symbol = "Splinter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12FDF3499f711c2e8aeF7Ed79091D8220a6Bc9BD); 
    address payable public buyBackWalletAddress = payable(0x12FDF3499f711c2e8aeF7Ed79091D8220a6Bc9BD); 
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**10 * 10**9; 
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax, uint256 extraFeeOnSell) external onlyOwner() {
