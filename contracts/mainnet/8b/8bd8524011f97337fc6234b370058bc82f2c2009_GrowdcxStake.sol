...
contract GrowdcxStake {
	...
	uint256 public MAX_WITHDRAW = 100000000 ether;
	uint256 public WALLET_LIMIT = 100000000 ether;
    ...
    uint public startTime = 1677340800; //  Feb 25th 4pm UTC
	...
	constructor(address payable _dev1, address payable _mkt) {require(!isContract(_dev1) && !isContract(_mkt));
        ...
        plans.push(Plan(1000,3, 10000 ether, 100000000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(500, 5, 100000 ether, 100000000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(200, 10,1000000 ether,100000000 ether, 0, 0, 0, 0, true));
	}
