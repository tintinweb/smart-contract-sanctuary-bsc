...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  VIC = IBEP20(0x53F542f581cA69076eB2c08f8E2aab97C07d21Dd);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = VIC.balanceOf(address(this));
        ...
        uint256 amount = VIC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            VIC.transfer(shareholder, amount);
...
/* Token contract */
contract BabyVicStep is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address VicStep = 0x53F542f581cA69076eB2c08f8E2aab97C07d21Dd; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0CD6737C1b9877E326D5Ba32B18efe647f4D9aF0;
    ...
    // Name and symbol
    string constant _name = "BabyVicStep";
    string constant _symbol = "BabyVIC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xb047053844603531279Bc4E94d0ca84Ae480D4CB;
