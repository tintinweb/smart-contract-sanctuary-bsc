...
contract ABE is ERC20, Ownable {
    ...
    address public incomeAddr = 0x0D0f95CA419FB129dcA1ED87FEC99E0959F9f779;
    ...
    uint256 public buyIncomeFee = 300;

    uint256 public buyFee = buyIncomeFee;

    uint256 public sellIncomeFee = 300;

    uint256 public sellFee = sellIncomeFee;
    ...
    function setBuyFee(uint256 _buyIncomeFee) public onlyOwner {
        uint256 buyTotal = _buyIncomeFee;
        require(buyTotal < _totalFeeRatio, "grant than total ratio");
        buyIncomeFee = _buyIncomeFee;
        buyFee = buyTotal;
    }

    function setSellFee(uint256 _sellIncomeFee) public onlyOwner {
        uint256 sellTotal = _sellIncomeFee;
    ...
    //设置黑名单
    function setBlackList(address account, bool flag) public {
    ...
    function _transfer(
        ...
        if (
            ...
            if (AmountIncomeFee > 0) {
                swapLUsdtTokenIncomeAddr(AmountIncomeFee);
                AmountIncomeFee = 0;
            }
    ...
    function swapLUsdtTokenIncomeAddr(uint256 tokenAmount) private {
