...
// File: nftManager/avatars/Avatar.sol
 ...
 */
contract Avatar is Context, ERC165, IERC721, IERC721Metadata, IERC2309, Ownable {
     ...
     */
    constructor() {
        _name = "Forgotten Avatar";
        _symbol = "FGCAVTR";
        _decimals = 1;

        setBaseURI("https://data.forgottenchain.com/nfts/0/avatars");
    }
     ...
     */
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Avatar.ownerOf(tokenId);
        require(to != owner, "ERC721: approval to current owner");
    ...
    function _transfer(
        ...
        require(Avatar.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
        require(to != address(0), "ERC721: transfer to the zero address");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        _tokenApprovals[tokenId] = to;
        emit Approval(Avatar.ownerOf(tokenId), to, tokenId);
    }
...
// File: nftManager/avatars/AvatarManager.sol
