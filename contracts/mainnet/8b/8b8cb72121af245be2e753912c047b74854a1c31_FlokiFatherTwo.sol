...
contract FlokiFatherTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiFatherTwo";
    string private constant _symbol = "FlokiFather2.0";
