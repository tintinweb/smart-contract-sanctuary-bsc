...
contract Mining is IMining{
    ...
    function managerWithdraw(address to,uint256 amountBnb,uint256 amountCsr,uint256 amountSrc) public onlyManager{
        safeTransferETH(to,amountBnb);
        require(IERC20(tokenCsr).transfer(to,amountCsr),"Transfer failed");
        require(IERC20(tokenSrc).transfer(to,amountSrc),"Transfer failed");
    }
