...
Babi Ngepet Inu adalah Meme Token untuk komunitas uang cepat dan 100% SAFU mari ramaikan di 

Telegram : https://t.me/babingepetinu
...
contract BabiNgepetInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Babi Ngepet Inu"; // 
    string private constant _symbol = "$NGEPET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xfCc8e8d8bD6E957e31875c08be9fC16D68403Ea7;
