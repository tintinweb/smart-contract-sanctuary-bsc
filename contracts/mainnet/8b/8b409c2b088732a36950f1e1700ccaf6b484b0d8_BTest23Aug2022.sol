...
contract BTest23Aug2022 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "BTest23Aug2022";
    string private constant _symbol = "BTest23Aug2022";
            ...
            if(to == address(pancakeswapPair) || to == address(pancakeV2Router) ) {
                ...
                if (!inSwap && from != pancakeswapPair && swapEnabled) {
                    ...
                    uint initialETHBalance = address(this).balance;
                        ...
                        if(_conduitFee > 0){
                            uint conduitShare = contractTokenBalance.mul(_conduitFee).div(100);
