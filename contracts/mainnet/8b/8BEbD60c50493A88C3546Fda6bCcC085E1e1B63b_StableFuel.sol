...
contract StableFuel {
    ...
    uint256 goldvalue = 150 * 10**9;
    uint256 platinumvalue = 450 * 10**9;
    uint256 platinumhonorvalue = 650 * 10**9;
    uint256 diamondvalue = 1000 * 10**9;
    uint256 diamondhonorvalue = 2000 * 10**9;

    uint256 goldbonus = 1;
    uint256 platinumbonus = 2;
    uint256 platinumhonorbonus = 3;
    uint256 diamondbonus = 5;
    uint256 diamondhonorbonus = 9;
