...
contract WealthMountainEA is Ownable, ReentrancyGuard {
    ...
    function DepoMiscProfits(address maddy, uint256 pw) public noReentrant {
    ...
    function DepoEAProfits(uint256 pamt) public noReentrant {
        ...
        require(pamt >= 5000 ether, "Your distribution is too low!");
    ...
    function WithdrawEAProfits(uint256 pnum) public noReentrant {
        ...
        require(user.pendingWithdraw == 0, "You have unclaimed Custom rewards!");
    ...
    function calcEAProfits(address calcaddy, uint256 profnum)
        public
        view
        returns (uint256)
    {
        ...
        if (
            user.entryDate < profit.eatimestamp &&
            EaProfTaken[msg.sender][profnum] == false
        ) {
    ...
    function returnWDList(address waddy)
        public
        view
        returns (uint256[] memory wlist)
    {
