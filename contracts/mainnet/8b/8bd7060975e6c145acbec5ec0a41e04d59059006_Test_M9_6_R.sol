...
//////
    ...
    mapping(uint => address) public userIds_Dep_ADR;
...
userIds_Dep_ADR[1] = users[user.LevelReferrals1].referrer;
...
adres22 = user.DEP_REF_activatesReferADR ;
    ...
    function get_userIds_Dep_ADR(address userAddress)
        public
        view
        returns (address)
    {
       // userIds_Dep_ADR[1] = users[userAddress].referrer;
