...
tg: https://t.me/DaddyApeToken

Buy: 8% (4 marketing, 2lp, 2 dev)
Sell: 25% (15 marketing, 5lp, 5dev) for 24 hours then goes to 8% for buys and sells
*/
...
contract Daddyape is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        uniswapV2Pair = IUniswapV2Factory(_ruter.factory())
        ...
        _isExcludedFromAutoLiquidity[address(ruter)] = true;

        _isExcludedFromAntiWhale[owner()]                  = true;
        _isExcludedFromAntiWhale[address(this)]            = true;
        _isExcludedFromAntiWhale[uniswapV2Pair]            = true;
        _isExcludedFromAntiWhale[address(ruter)] = true;
...
//Remove from Blacklist
    ...
    function setUniswapRouter(address r) external onlyOwner {
        IUniswapV2Router02 _ruter = IUniswapV2Router02(r);
        ruter = _ruter;
    }
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(ruter)) {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private returns (uint256, uint256) {
        ...
        // add the liquidity
        (uint amountToken, uint amountETH, ) = ruter.addLiquidityETH{value: bnbAmount}(
            address(this),
            tokenAmount,
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == uniswapV2Pair && recipient != address(ruter);
