...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xd0023964Af1b18b5509B96EeDeA7f48Fb643A567;
...
contract RABBITBLACK is Context, IERC20, Ownable {
    ...
    string private constant _name = "RABBIT BLACK"; // 
    string private constant _symbol = "RABIB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xd0023964Af1b18b5509B96EeDeA7f48Fb643A567);
