...
contract  SPOOKED is IBEP20, Auth {
    ...
    address DEV =  0x3c8036bc5045bE637825F3F3c22b01bedEED3542;
    ...
    // Max wallet and TX
    uint256 private _maxBuyTxAmount = _totalSupply * 300 / 1000; // 3% 
    uint256 private _maxSellTxAmount = _totalSupply * 300 / 1000; // 3% 
    uint256 private _maxWalletToken = ( _totalSupply * 600 ) / 1000; // No max wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3c8036bc5045bE637825F3F3c22b01bedEED3542;
