...
contract FatSats is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = ( _tTotal * 4 ) / 100; // 3%

    uint256 public _maxWalletToken = ( _tTotal * 4 ) / 100; // 4%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "FatSats"; // 
    string private constant _symbol = "FatSats"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x183ec4D5B9D5e1C9cDAA530eddD02DfCedcB67cd;
