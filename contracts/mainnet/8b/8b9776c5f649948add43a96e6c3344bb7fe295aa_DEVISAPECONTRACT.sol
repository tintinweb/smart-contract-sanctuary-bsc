...
/**
Welcome to FlokiCyborg

DevIsApe $DEVISAPE is a token meme with a small tax!! 
DevIsApe $DEVISAPE has a feature with rewards in the form of $APE,
hold DevIsApe and earn $APE every hour.
...
Telegram : https://t.me/DevIsApe
Twitter  : https://twitter.com/DevIsApe_BSC
Website  : https://devisapeswap.finance
*/
...
contract DEVISAPECONTRACT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dev Is Ape";
    string private _symbol = "DEVISAPE";
    ...
    uint256 public _maxTxAmount = 800 * 10**7 * 10**9;
    uint256 public _walletMax = 800 * 10**7 * 10**9;
