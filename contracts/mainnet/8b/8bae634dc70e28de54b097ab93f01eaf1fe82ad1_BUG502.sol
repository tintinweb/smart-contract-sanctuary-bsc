...
The technological BUG502 is a hypothetical point in time at which technological growth will become radically faster and uncontrollable, resulting in unforeseeable changes to human civilization. According to the most popular version of the BUG502 hypothesis, an upgradable intelligent agent will eventually enter a “runaway reaction” of self-improvement cycles, each new and more intelligent generation appearing more and more rapidly, causing an “explosion” in intelligence and resulting in a powerful superintelligence that qualitatively far surpasses all human intelligence.
$BUG502 will be marked by exponential growth through technological innovation.
...
contract BUG502 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BUG502", "BUG502") {
        ...
        devWallet = payable(0x9f738a35a6510fba359531f295A91A2BB4Fc80b9);
    ...
    function setlimitsInEffect() external onlyOwner returns(bool) {
        limitsInEffect = true;
        return true;
    }
    ...
    function setboughtEarly(bool YN) external onlyOwner(){
        boughtEarly = YN;    
    }
