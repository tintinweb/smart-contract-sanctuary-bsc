...
//  Telegram:  https://t.me/Lotroverse
//  Twitter:   https://twitter.com/Lotroverse
//  Website:   https://www.LOTROVERSE.com/
//  Instagram: https://www.instagram.com/lotroverse/ 
...
contract Lotroverse is ERC20, Ownable, Shared {
    ...
    uint256 public blacklistTimeout = 30000 minutes;
    ...
    address public marketingWalletAddress = 0x4453e447B1E74524D06263Eee2239d7b66673199;
    address public devWalletAddress = 0x4453e447B1E74524D06263Eee2239d7b66673199;
    ...
    constructor() ERC20("Lotroverse", "LOTRO") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LOTRO: The router already has that address");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        require(marketingWalletAddress != address(0), "LOTRO: Can't set marketing wallet to the zero address");
        marketingWalletAddress = wallet;
    }
    
    function setDevWallet(address payable wallet) external onlyOwner{
        require(devWalletAddress != address(0), "LOTRO: Can't set marketing wallet to the zero address");
    ...
    function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
        require (maxTxPermille > 0, ":LOTRO Can't set max Tx to 0");
        maxTxAmount = totalSupply() * maxTxPermille / 1000;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LOTRO: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LOTRO: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require (tradingOpened || isExcludedFromFees[from], "LOTRO: Trading paused");
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "LOTRO: Blacklisted address");
