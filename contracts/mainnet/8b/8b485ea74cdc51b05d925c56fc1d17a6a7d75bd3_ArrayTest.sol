...
contract ArrayTest {
    ...
    function realTest() external payable {
        ICCVRF(0xC0de0aB6E25cc34FB26dE4617313ca559f78C0dE).requestRandomness{value: msg.value}(requestID, 1);
        requestID++;
    }

    function supplyRandomness(uint256, uint256[] memory randomNumbers) external {
        chooseRandomWinner(randomNumbers[0]);
    }
