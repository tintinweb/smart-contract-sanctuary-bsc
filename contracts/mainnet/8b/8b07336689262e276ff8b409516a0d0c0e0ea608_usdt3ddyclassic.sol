...
contract usdt3ddyclassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "USDT3ddy Classic"; // 
    string private constant _symbol = "$usdt3ddyclassic"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x614C5EB8ad4Cae97c9fD8d37d74BcfDA84Ec4356;
