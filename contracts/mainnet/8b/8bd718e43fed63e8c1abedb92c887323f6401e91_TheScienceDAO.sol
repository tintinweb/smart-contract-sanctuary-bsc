...
https://thesciencedao.io
 ...
 |_____/ \___|_|\___|_| |_|\___\___|_____/_/    \_\____/ 
...
contract TheScienceDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TheScienceDAO";
    string private _symbol = "$ScienceDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7Ec079bB7Acc7710b4e8B0a231853d5CdDA11760); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7Ec079bB7Acc7710b4e8B0a231853d5CdDA11760); // BuyBack Address
