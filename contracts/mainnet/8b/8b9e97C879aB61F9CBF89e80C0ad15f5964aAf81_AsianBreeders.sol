...
//          2%  =>  Goes to rewards pool
//
//  Sell Tax: 10%
//  WHERE: 
//          1%  =>  Goes to marketing
//          3%  =>  Goes to liquidity pool
//          6%  =>  Goes to rewards pool
//*
...
contract AsianBreeders is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Asian Breeders Token";
        _symbol = "ABT";
        _decimals = 9;
        _totalSupply = 88_888_888 * (10 ** decimals());
    ...
    */
    function setTxLimits(uint _buyLimit, uint _sellLimit, uint _cooldown) external onlyOwner {
        require(_buyLimit >= _totalSupply.div(100), "Buy transaction limit is too low!"); // 0.5%
