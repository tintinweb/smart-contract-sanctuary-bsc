...
contract MTAW is Context, IERC20, Ownable {
    ...
    string private _name = "MTAW";
    string private _symbol = "MTAW";
    ...
    constructor () {
        ...
        _balances[0x2710cB42Bc3B6a0DdA47342DB6c479De71da9c45] = _totalSupply;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(liquidityLaunched && block.number <= lastSnipeTaxBlock && !isFirstLaunch){
            ...
            _basicTransfer(sender,liquidityContractAddress, botFeeAmount);
