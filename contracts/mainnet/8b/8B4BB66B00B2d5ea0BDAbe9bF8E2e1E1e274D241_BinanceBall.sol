...
contract BinanceBall is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 202200000000 * 10**_decimals;

    string private _name = "BinanceBall";
    string private _symbol = "BinanceBall";
    ...
    uint256 public numTokensSellToAddToLiquidity = 15000000 * 10**_decimals;

    address public _market = 0x030688697f43a42D0C4D1B3d9a488cf7925BC7Fe;
