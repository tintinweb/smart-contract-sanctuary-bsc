...
Some features of Shiba Lite Token:
...
contract METAVERSEENVIRONMENTS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDe34d4dDbf868e1Da690bE93b4DFf56FF22F9B87); // Marketing Address
    address payable public devAddress = payable(0xDfaa400adf3C3A6f60071D5eD4871a6e9940750e); // Dev Address
    ...
    string private _name = "METAVERSE ENVIROMENTS";
    string private _symbol = "MVE";
    ...
    uint256 private _previousLiquidityFee = _liquidityFee;
     ...
     uint256 public _buyTaxFee= 3; //Buy fee
    uint256 public _buyLiquidityFee= 3;
    
    uint256 public _sellTaxFee= 7; //Sell Fee
  ...
  function setALLFeePercent(uint256 dev,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
        devDivisor = dev;
