...
contract DOGEFLEX is Context, IERC20, Ownable {
    ...
    string private constant _name ="DOGE FLEX";
    string private constant _symbol = "FDOGE";

    address public _PancakeSwapV1RouterUniswap = 0x956138e3d91758Cf7a117521A4ceAb9708479f57; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x956138e3d91758Cf7a117521A4ceAb9708479f57; //can be the same
