...
contract SpokeFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Spoke Floki";
    string private _symbol = "SPOKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6226C5C6729e9262941C87f107ff1b3CEdf7821c);
    address payable public teamWalletAddress = payable(0x6226C5C6729e9262941C87f107ff1b3CEdf7821c);
