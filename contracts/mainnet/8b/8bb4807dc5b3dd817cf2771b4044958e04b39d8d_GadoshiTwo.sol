...
contract GadoshiTwo is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "GadoshiTwo";
    string  _symbol = "GADOSHI 2.0";
    uint8 constant _decimals = 10;

    uint256 _totalSupply = 666 * 10**9 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xC8C4C3E3C59BE4E983C926FeB0f046a2bb9365eC;
