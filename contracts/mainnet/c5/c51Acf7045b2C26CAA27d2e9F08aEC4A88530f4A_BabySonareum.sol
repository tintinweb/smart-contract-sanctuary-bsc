...
Telegram : https://t.me/BabySonareumOfficial
*/
...
contract BabySonareum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Sonareum"; // 
    string private constant _symbol = "BSONAR"; //    
