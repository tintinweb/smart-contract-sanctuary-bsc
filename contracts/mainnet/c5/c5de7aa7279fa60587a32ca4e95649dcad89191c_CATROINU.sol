...
contract CATROINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT RONIN INU";
    string private _symbol = "CATROINU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x58C68486Bb67e742CD9A65A8C1A5647AF5afF33b); // Marketing Address
    address payable public BuyBackWallet = payable(0x58C68486Bb67e742CD9A65A8C1A5647AF5afF33b); // Team Address
