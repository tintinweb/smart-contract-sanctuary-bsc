...
contract Armycoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Armycoin";
    string private _symbol = "ARM";
    uint8 private _decimals = 3;

    address payable private marketingWalletAddress = payable(0xa85a7028b9a92c279aE02a6e71599023C8B22222); 
    address payable private teamWalletAddress = payable(0xa85a7028b9a92c279aE02a6e71599023C8B22222); 
