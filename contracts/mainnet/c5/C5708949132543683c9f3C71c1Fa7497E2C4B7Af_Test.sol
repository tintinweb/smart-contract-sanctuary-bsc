...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x698d3200082060C31a80eeb340890a5860D407B5); 
    address payable public Wallet_Utility = payable(0xE4981E3DA64F1b8d1F7AC6D848EF71011e66d101);
    ...
    constructor () {
        ...
        _owner = 0xE4981E3DA64F1b8d1F7AC6D848EF71011e66d101;
