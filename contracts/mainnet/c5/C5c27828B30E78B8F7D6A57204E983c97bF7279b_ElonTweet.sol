...
contract ElonTweet is IBEP20, Auth {
    ...
    string constant _name = "Reasons to hate are remembered better than reasons to love";
    string constant _symbol = "Reasons to hate are remembered better than reasons to love";
