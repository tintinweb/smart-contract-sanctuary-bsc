...
/**
https://t.me/OfficialBabyOptimusInu
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN RISE
    IBEP20  RISE = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
/* Token contract */
contract BabyOptimusInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RISE = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x713229f6Bc7214BB4859D39C418F79814158dCD4;
    ...
    // Name and symbol
    string constant _name = "Baby Optimus Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 2%
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // 3% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x713229f6Bc7214BB4859D39C418F79814158dCD4;
