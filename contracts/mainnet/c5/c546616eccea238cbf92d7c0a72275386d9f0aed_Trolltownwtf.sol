...
/**
   Twitter: https://twitter.com/troll_town_wtf
...
//this is a new token 
contract Trolltownwtf is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trolltownwtf";
    string private constant _symbol = "Troll";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x97404cdF9F261fa4f272cfbD30ac40e98F13f699);
    address payable private _marketingAddress = payable(0xB662d2F672Cc384d40F221a5ee08A43FE3276DAf);
    ...
    function allowance(address owner, address spender) public view override returns (uint256) {
     ...
     function nouse2() public pure returns (string memory) {
    }
