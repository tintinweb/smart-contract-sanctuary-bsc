...
contract A_OKCToken is Context, IERC20, Ownable {
  ...
  address private _usdtAddress      = address(0x1Ad2403b98E2195A537089eD3aD8b257Fb3C6D89);
  //address private _marketingAddress = address(0x8A5eA893a78b7248eC14e980b5568496A0baBA03);
  address private _marketingAddress = address(0x400a8FcF256aD15dC19B73DE3fc7f6927afF6858);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    uint256 destoryAmount   = 0;          //销毁数量
    uint256 marketingAmount = 0;          //转营销数量
