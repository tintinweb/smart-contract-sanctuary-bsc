...
contract HoneyDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HoneyDoge";
    string constant _symbol = "HDOGE";
    ...
    function setFees(uint256 _liquidityFee, uint256 _HCP, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        HCP = _HCP;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_HCP).add(_reflectionFee).add(_marketingFee);
