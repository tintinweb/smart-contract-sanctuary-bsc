...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9950F16E47886e3059055b173bb0FAB22b70073f; // owner address
...
contract Milk is Context, IERC20, Ownable {
    ...
    string private _name = "ADAsMilkBSC";
    string private _symbol = "ADAsMilk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8114136e3717eee2946e200817c72af906A7943d); // Marketing Address
    address payable public teamWalletAddress = payable(0x8114136e3717eee2946e200817c72af906A7943d); // Team Address
