...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xf28F545C739B07dA436b21Bc59F32eb66258d8bf;
...
contract HXZX is AbsToken {
    constructor() AbsToken(
        ...
        9,
        288,
        address(0x498bfFbd49B57668E84D1D7d139Cc58c33A3E518),
        address(0x6eC616413863278F6F3bfFFDa0b09eba4F52db3D)
    ){
