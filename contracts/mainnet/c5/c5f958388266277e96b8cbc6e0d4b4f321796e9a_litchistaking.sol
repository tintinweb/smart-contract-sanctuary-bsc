...
contract litchistaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x03B7914A31Bb05905d9418b2ebeE2936e380D867);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 23380031, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 23380031){
            return 0;
        }
