...
contract AskWorld is Ownable {
    ...
    function multisendBud(address payable[]  memory  _contributors, uint256[] memory _balances, uint256 membcode, uint256 rcode, uint64 plan) public payable {
    ...
    function multisendAsk(address _senderads, uint256 _amttoken, uint256 membcode, uint256 rcode, uint64 plan) public {
       // uint256 total = msg.value;
