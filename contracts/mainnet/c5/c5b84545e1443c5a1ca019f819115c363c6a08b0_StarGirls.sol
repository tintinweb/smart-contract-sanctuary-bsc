...
contract StarGirls is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "StarGirls";
    string private _symbol = "SG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xecCC3B35a9555f8fe6479641508F9cD592ca9357); 
    address payable public teamWalletAddress = payable(0x938Ad60010f1Acc063224CB690C8C404FC018181); 
