...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeConfigs.push(FeeConfig(800000000 * tokenDecimals, 20, 20, 0));
        _feeConfigs.push(FeeConfig(700000000 * tokenDecimals, 75, 75, 0));
        _feeConfigs.push(FeeConfig(600000000 * tokenDecimals, 20, 20, 0));
        _feeConfigs.push(FeeConfig(500000000 * tokenDecimals, 35, 35, 0));
        _feeConfigs.push(FeeConfig(0, 150, 150, 0));
...
contract AAA is AbsToken {
    ...
    //Receive
        address(0xbB200BE565470554bDD0eebfc8C9b495560165e1)
    ){
