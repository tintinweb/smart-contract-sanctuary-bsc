...
contract ECOUNSIL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Elon Counsil ";
    string private _symbol = " ECOUNSIL "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfA00500e72F082e6f6d806999F7ba6BdE53D8e0B); 
    address payable public teamWalletAddress = payable(0xfA00500e72F082e6f6d806999F7ba6BdE53D8e0B); 
