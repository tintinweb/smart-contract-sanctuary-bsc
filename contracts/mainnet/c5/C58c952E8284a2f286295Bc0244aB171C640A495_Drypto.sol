...
contract Drypto is IBEP20, Auth {
    ...
    string constant _name = "Drypto";
    string constant _symbol = "DRYP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100; //2% max tnx
    uint256 public _maxWalletSize = (_totalSupply * 40) / 100; //4% max wallet
