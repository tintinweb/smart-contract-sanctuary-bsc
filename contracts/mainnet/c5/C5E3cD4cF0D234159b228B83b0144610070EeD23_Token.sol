...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public LPreceiveAddress = 0xDBEB42b5DACCd28E57C074b5C3d8629447b84EaD;
    ...
    constructor (
        ...
        _inviteFee[7] = 0;
        _inviteFee[8] = 0;
        _invitorCondition = 100000000000000 * tokenUnit;
...
function setdAddHolder(address newAddress) external onlyOwner() {
		addHolder(newAddress);
    }
    ...
    function setLpRewardThreshold(uint256 newValue) external onlyOwner {
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000000000000,
        address(0x2a60D9be1bB76ED5784042A5B7DBB94B08a12140),
        address(0x2a60D9be1bB76ED5784042A5B7DBB94B08a12140),
        address(0x6A1989cd182EA75b9C4F29f8b10f51E1532a067F),
        0,
        0,
        0
    ){
