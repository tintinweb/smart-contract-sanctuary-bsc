...
contract SHIBONK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2359B46741686d356f15D71ea0f2290Dec1A30f6;
    ...
    uint256 _totalSupply = 420000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xFFBA2C1ABbbb0A0ccA902bEe054032d6F2c52d7E;
    ...
    function tradingSTARTforSBONK(bool) public onlyOwner {
        tradingOpen = true;
        launch();
    }
