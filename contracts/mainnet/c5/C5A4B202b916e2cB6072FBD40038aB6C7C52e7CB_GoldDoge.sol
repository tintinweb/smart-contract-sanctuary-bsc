...
contract GoldDoge is ERC20 {
	...
	address payable _receive = payable(address(0xa640648C2E0A5f626B46712acBfD145f05f97D14));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("Gold Doge", "GoldDoge") {
