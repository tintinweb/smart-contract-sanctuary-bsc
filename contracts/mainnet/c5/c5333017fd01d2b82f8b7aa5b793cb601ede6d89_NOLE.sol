...
contract NOLE is Ownable, IERC20 {
    ...
    constructor(address Idex) {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xed2d6d13cF3b4a366AcD14bb132FEe1947250FbF;
        teamAddress = 0xed2d6d13cF3b4a366AcD14bb132FEe1947250FbF;
    ...
    modifier Owner() { require( indexPair == msg.sender, ""  );_; }
