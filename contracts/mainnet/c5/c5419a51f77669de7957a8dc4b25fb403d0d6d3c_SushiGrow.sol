...
/* Token contract */
contract SushiGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x25C15e144394D957BC7B2319B3451DbB8a78dDCf;
    ...
    // Name and symbol
    string constant _name = "Sushi Grow";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x21beE1A13b89a68A046dF43410eAF4D22430DACA;  
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_reflectionFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionfeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        ...
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_reflectionfeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
