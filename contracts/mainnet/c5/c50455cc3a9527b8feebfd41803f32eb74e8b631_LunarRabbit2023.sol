...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4A020CB87DF57324E651CE645B9e4a45814f133d;
...
contract LunarRabbit2023 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x239647F89D4ecdb45CA30dC9fcD6044911F73071;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LunarRabbit2023";
    string private _symbol = "LUNARRABBIT";
