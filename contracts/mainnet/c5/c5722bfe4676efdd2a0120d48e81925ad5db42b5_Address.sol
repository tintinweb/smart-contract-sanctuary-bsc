...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xeC89ecD20c4c2a5b30e4611052143C240d015E5A ;
...
contract Quantclasic is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x1004E90d288698a566666fd53D897aE70838Dc8A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Apple finance";
    string private _symbol = "A finance";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x555C55AE26c488a8469Bc842d742cc4A9b6FbBa2);
