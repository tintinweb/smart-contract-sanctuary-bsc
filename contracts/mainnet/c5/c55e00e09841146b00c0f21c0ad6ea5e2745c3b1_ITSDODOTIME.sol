...
// Telegram: https://t.me/ItsDoDoTime

// Twitter: https://twitter.com/itsdodotime
...
contract ITSDODOTIME is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Doge Doge";
   string constant _symbol = "DODO";
   ...
   // Buy Fees
    ...
    uint256 marketingFeeBuy = 800; // 6% Marketimg 2% Dev & Team
    ...
    uint256 marketingFeeSell = 800; // 6% Marketimg 2% Dev & Team
