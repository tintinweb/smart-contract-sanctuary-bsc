...
contract HallowZoro is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HallowZoro";
    string constant _symbol = "HallowZoro";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xDE927479fFDf1ee2B82e5Bc4670CA02E37845eeA;
