...
/*
🌑THENULL🌑 is an open source, non-custodial, 
...
🌫️Safe ❔
💭Yes 🌫️scan audits green 🌫️

🕸️Set slippage to 4-5% 🕳️4% to Holders as rewards🕳️ 1% tax for Marketing 

👁️‍🗨️Telegram: https://t.me/TheNULLToken
👁️‍🗨️https://nullswap.netlify.app
👁️‍🗨️https://thenull.world/
...
abstract contract Contextbep20THENULL {
...
contract Ownablebep20THENULL is Contextbep20THENULL {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20THENULL: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20THENULL: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract THENULLTOKEN  is Contextbep20THENULL, bep20THENULL, Ownablebep20THENULL {
    ...
    string private _name = 'THE NULL';
    string private _symbol = 'THE NULL';
