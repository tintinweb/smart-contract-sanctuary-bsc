...
contract arbitrage_bot {
    ...
    function uniswap_TokensForTokens(address tokenIn, address tokenOut, uint amount) public{
        ...
        path[0] = tokenIn;
        path[1] = tokenOut;
        apeswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(amount,0,path,to,block.timestamp);
    }
    ...
    function apeswap_TokensForTokens(address tokenIn, address tokenOut, uint amount) public{
        ERC20 TOKEN = ERC20(tokenIn);
        TOKEN.approve(router2,amount);
    ...
    function buyApeSellUni(address token, address pairedToken_uni, address pairedToken_ape, uint amount_eth) public owner{
        ...
        uint amount_token = balance_new - balance;
            uniswap_TokensForTokens(token, pairedToken_uni, amount_token);
