...
contract SSK is SSKDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private SSKTeam;
    address private CharitySSK;
    ...
    string public override name = "Shinsekai";
    string public override symbol = "SSK";
    ...
    constructor(uint totalSupplyValue, address SSKTeamAddress, address CharitySSKAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        SSKTeam = SSKTeamAddress;
        CharitySSK = CharitySSKAddress;
       
        // split the tokens according to agreed upon percentages
        balances[SSKTeam] =  totalSupply * 4 / 100;
        balances[CharitySSK] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SSKTeam pot
