...
contract PCSxETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PCSxETH";
    string private _symbol = "PCSxETH";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0059808f5A106631d78B01Dc2701Af602c707Fb1); 
    address payable public BurnedWalletAddress = payable(0x0059808f5A106631d78B01Dc2701Af602c707Fb1); 
