...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x718D0Ec0b1dc425E1f709782C6df8E533f0a0282;
...
contract SnakeRocket is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6205142a2ffF76Ef429571fF30826D42c6B999bc;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SnakeRocket";
    string private _symbol = "SnakeRocket";
