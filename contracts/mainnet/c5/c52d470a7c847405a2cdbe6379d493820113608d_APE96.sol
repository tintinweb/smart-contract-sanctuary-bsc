...
contract APE96 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APE COIN 1996";
    string private _symbol = "APE96";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xC7bF02618077A4b2B3026F9a13802Ff74b2cdab5); // Buy Back Address
