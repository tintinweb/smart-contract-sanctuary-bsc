...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB870B9f8f92089cEb7F1168B52feFD485ea07A5f; // owner address
...
contract Flokiak47 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki AK-47";
    string private _symbol = "Floki47";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB870B9f8f92089cEb7F1168B52feFD485ea07A5f); // Marketing Address
    address payable public teamWalletAddress = payable(0xB870B9f8f92089cEb7F1168B52feFD485ea07A5f); // Team Address
