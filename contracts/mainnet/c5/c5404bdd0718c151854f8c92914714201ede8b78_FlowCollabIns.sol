...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xC943c5320B9c18C153d1e2d12cC3074bebfb31A2);
...
contract FlowCollabIns is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xfB08cD5DEBBba50AB0937dBfDeC5178945691C8B;

    string constant _name = "FlowCollabIns";
    string constant _symbol = "FLOWC";
