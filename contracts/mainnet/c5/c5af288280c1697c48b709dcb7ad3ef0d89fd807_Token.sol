...
contract Token {
    ...
    string public constant name = "Rabbit Token2";
    string public constant symbol = "RBT2";
    ...
    function balanceOf(address own2) public view returns(uint256) {
        return balances[own2];
    }
