...
contract GROGU is ERC20, Ownable {
    ...
    address public marketingWallet = 0xdfd69Af9A0c0d796266a94BbA2aA06Cbf1AB6B0D;
    ...
    constructor(address routerAdd) ERC20("Grogu Inu", "GROGU") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require((TotalBuyFee) <= 5, "Must keep fees at 5% or less");
    ...
    function SetSellTaxes(
        ...
        require((TotalSellFee) <= 5, "Must keep fees at 5% or less");
