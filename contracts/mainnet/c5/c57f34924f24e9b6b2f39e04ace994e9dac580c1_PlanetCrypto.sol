...
contract PlanetCrypto is Context, IERC20, Ownable {
    ...
    string private constant _name = "Planet Crypto";
    string private constant _symbol = "PLCRYPTO";
