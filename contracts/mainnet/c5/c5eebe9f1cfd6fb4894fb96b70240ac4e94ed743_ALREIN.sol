...
/*
Website : https://alreinetwork.live/
Telegram : https://t.me/alreinetwork
*/
...
contract ALREIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALREIN NETWORK";
    string private _symbol = "ALREIN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xcA1a1A1208C1b0295667f99C732a7814e3bC8D7D); // Marketing Address
    address payable public teamWalletAddress = payable(0x4f1BEbAE51267E4ccd0714B222D70b1730F00531); // Team Address
