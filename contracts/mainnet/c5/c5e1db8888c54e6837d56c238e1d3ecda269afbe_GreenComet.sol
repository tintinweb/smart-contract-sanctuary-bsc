...
/*
https://t.me/GreenCometBSC
https://twitter.com/GreenComet_BSC

The Green Comet is coming to BSC before it passes Earth. Once every 50,000 years the legendary Comet
will pass the globe and become viral across all socials. Our plan is to moon the token using this hype
and continue a utility plan.
*/
...
contract GreenComet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe4256288749308e279706d36475Cd454688F3B1b); // Marketing Address
        
    address payable public teamAddress =
        payable(0x05DfC9F97D6470a17527705b656Fe5fd5290a707); // Team Address
        
    address payable public liquidityAddress =
        payable(0x05DfC9F97D6470a17527705b656Fe5fd5290a707); // Liquidity Address
    ...
    string private constant _name = "Green Comet";
    ...
    function _transfer(
     ...
     if(limitsInEffect || !_isExcludedMaxTransactionAmount[to] || !_isExcludedMaxTransactionAmount[from]){
