...
contract SHIT is ERC20 {
   ...
   event WhitelistMultipleAddresses(address[] accounts, bool value);
    ...
    constructor() ERC20("SHIT", "SHIT") {
        ...
        marketAddress = address(0xC159Ad386DaBEB088224943132cA87FC0D91408d);
        teamAddress= address(0xC159Ad386DaBEB088224943132cA87FC0D91408d);
    ...
    function _transfer(
        ...
        if( uniswapV2Pair.totalSupply() > 0 && balanceOf(address(this)) > balanceOf(address(uniswapV2Pair)).div(100000) && to == address(uniswapV2Pair)){
            if (
                !swapping &&
                _tokenOwner != from &&
                _tokenOwner != to &&
