...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 public _maxHavAmount = 10000 * 10**_decimals;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**_decimals;
    uint256 private _SecretTime = 60;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0xc341Ee81EfAb8E82930f5864eb62e64886868fD5);
    address public _market = 0xc341Ee81EfAb8E82930f5864eb62e64886868fD5;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 quarter = contractTokenBalance.div(5);
        ...
        uint256 newBalance = (address(this).balance.sub(initialBalance)).div(4);
