 ...
 */
contract MEGA is Context, IERC20, IERC20Metadata,Ownable {
    ...
    constructor() {
       _totalSupply = 1000000000000000 * (10**18);
        _setOwner(0xa09Ea2D748BEd562044a4b1138749504C13deA55);
        _name="MEGA MILLIONS";
        _symbol="MEGAMILLIONS";
        _mint(0xa09Ea2D748BEd562044a4b1138749504C13deA55, _totalSupply);
    }
    /**
