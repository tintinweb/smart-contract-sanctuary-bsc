...
🗺 Clear Roadmap
💯 SAFU
📄Contract Address : 0xc51192377fe44dbe8aa4e168daa127c07e4ec4bd
 
 https://poocoin.app/tokens/0xc51192377fe44dbe8aa4e168daa127c07e4ec4bd
...
contract AIPALM is AIPALMDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private AIPALMTeam;
    address private CharityAIPALM;
    ...
    string public override name = "AIPALM";
    string public override symbol = "AIPALM";
    ...
    constructor(uint totalSupplyValue, address AIPALMTeamAddress, address CharityAIPALMAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        AIPALMTeam = AIPALMTeamAddress;
        CharityAIPALM = CharityAIPALMAddress;
        
        // split the tokens according to agreed upon percentages
        balances[AIPALMTeam] =  totalSupply * 4 / 100;
        balances[CharityAIPALM] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's AIPALMTeam pot
