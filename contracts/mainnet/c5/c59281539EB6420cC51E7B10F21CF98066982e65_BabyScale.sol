...
/**
 TG Group : https://t.me/BabyScaleToken
*/
...
contract BabyScale is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "BabyScale";
    string constant _symbol = "BabyScale";
    uint8 constant _decimals = 9;

    // Supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000 Tokens
    uint256 _burntSupply = (_totalSupply * 60) /100;
    uint256 _liqSupply = (_totalSupply - _burntSupply);

    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;  // 4% MaxWallet - 400,000 Tokens
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100;  // 2% Max Transaction - 200,000 Tokens  
    ...
    uint256 _initialSellMarketingFee = 7;
    uint256 _initialSellBuybackFee = 5;
    ...
    // Fee receivers
    address private marketingFeeReceiver = 0x0AeA392dff50792ebE7ed583426a59bCcE1e2E20;
    address private buybackFeeReceiver = 0x0AeA392dff50792ebE7ed583426a59bCcE1e2E20;
