...
Twitter: @Inuko_Finance
Telegram: Inuko Finance
...
contract InukoCoin is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 10 / 200; // 5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 10 / 200; // 5% maxWalletToken
