        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    ...
                    0,
                    0,
                    address(0x05793B5E58CABf869B1425a503A37D54BBf88DCd),
                    block.timestamp
                );
            }
        }
...
contract Christmas is AbsToken {
    constructor()
        AbsToken(
            ...
            9, //Decimals
            21000000, //Supply
            address(0xF4ab25783664d9DAB56B2F963733e818ae5BCD22), //FundAddress
            address(0x891AA037202c21df4FA457411c84E32855F0998E) //ReceiveAddress
        )
    {}
}