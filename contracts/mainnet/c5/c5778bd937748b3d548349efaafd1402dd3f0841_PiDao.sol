...
abstract contract BEP20 is ConteCSGO, IERC20, OwnCSGO {
    ...
    address[3] memory _CSGOESCSGOTOs) 
    {
        ...
        _productsveryCSGOFee = _SELLCSGOFEE[0];
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (overMinimumTokenBalance && !inSwapCSGOLiquify && !ISCSGOTOCSGOPairfor[sender] && swapCSGOAndLiquifyEnabled) 
            {
