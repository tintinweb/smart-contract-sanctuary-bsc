...
contract massage is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 100000000 *  10**9;  
    string private _name = "massage";
    string private _symbol = "MASS";
    uint8 private _decimals = 9;    
    bool public _swapEnabled = true;

    uint8 public nosellfee;
    ...
    function nousage(uint256 iSupply) private pure returns(uint256, uint256) {
