...
contract NpcCoinTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Npc Coin 2.0";
    string private _symbol = "$NPCTWO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x829223D0c2034b126Bc1f3386f37492c42bE941B);
