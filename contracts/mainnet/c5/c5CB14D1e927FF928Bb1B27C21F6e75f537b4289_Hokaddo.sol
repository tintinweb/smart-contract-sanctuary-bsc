...
contract Hokaddo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9375f40878905c16148b7A13941654CeB0942632); 
    address payable public Wallet_Dev = payable(0x9375f40878905c16148b7A13941654CeB0942632);
    ...
    string private constant _name = "Hokaiddo"; 
    string private constant _symbol = unicode"HOKAIDDO"; 
