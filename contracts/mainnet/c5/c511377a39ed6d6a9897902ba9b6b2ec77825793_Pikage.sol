...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEC71409c849d70B88a30DF0499692f536266f7D7; // owner address
...
contract Pikage is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pikage";
    string private _symbol = "Pikage";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEC71409c849d70B88a30DF0499692f536266f7D7); // 
    address payable public teamWalletAddress = payable(0xEC71409c849d70B88a30DF0499692f536266f7D7); // 
