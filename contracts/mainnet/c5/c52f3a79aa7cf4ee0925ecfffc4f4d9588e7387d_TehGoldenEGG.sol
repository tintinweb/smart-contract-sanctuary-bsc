...
abstract contract ContextTehGoldenEGGBNB {
...
contract OwnableTehGoldenEGGBNB is ContextTehGoldenEGGBNB {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableTehGoldenEGGBNB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableTehGoldenEGGBNB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TehGoldenEGG  is ContextTehGoldenEGGBNB, TehGoldenEGGBNB, OwnableTehGoldenEGGBNB {
    ...
    string private _name = 'Teh Golden EGG';
