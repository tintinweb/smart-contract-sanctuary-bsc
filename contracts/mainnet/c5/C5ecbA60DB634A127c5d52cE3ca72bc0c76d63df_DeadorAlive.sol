...
contract DeadorAlive is Context, IERC20, Ownable {
    ...
    uint private _wDuration = 120;
    bool private _watchDogEnded = false;

    uint8 private constant _decimals = 9; 
    uint256 private _tTotal = 1_000_000 * (10**_decimals);
    uint256 private maxTxAmount = 15_000 * (10**_decimals);
    uint256 private maxWallet =  30_000 * (10**_decimals);
    uint256 private _swapThreshold = 7500 * (10**_decimals); 

    string private constant _name = "Dead or Alive"; 
    string private constant _symbol = "DOA";    
    
    uint256 private _buyTax = 8;
    uint256 private _sellTax = 20;
    uint8 private _treasuryRatio = 8;
    uint8 private _lpRatio = 2; 
    address public treasuryWallet = 0x018Ad47819D1A872F192e510C63Db1B02F78d736;
