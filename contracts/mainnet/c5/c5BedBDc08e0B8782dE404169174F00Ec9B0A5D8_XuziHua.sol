...
contract XuziHua is Context, IERC20, Ownable {
    ...
    uint256 public maxSupply = 1 * 11000 * (10 ** _decimals);
    uint256 private minSupply = 1 * 100 * (10 ** _decimals);
