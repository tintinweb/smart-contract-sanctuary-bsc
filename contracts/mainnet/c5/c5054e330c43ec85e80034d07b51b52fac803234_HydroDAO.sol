...
contract HydroDAO is Context, IERC20, Ownable {
  ...
  IPanusdtRouter02 public panusdtRouter;
  address public usdt ;
  ...
  constructor() public {
    ...
    _symbol = "HDD";
    _decimals = 18;
    _totalSupply = 531441000  * 10 ** uint256(_decimals);
    _balances[msg.sender] = _totalSupply;
   
    emit Transfer(address(0), msg.sender, _totalSupply);

    burnRate = 20;
    panusdtRouter = IPanusdtRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    usdt = 0x55d398326f99059fF775485246999027B3197955;
   
    address panUsdtPair = IPanusdtFactory(panusdtRouter.factory())
    .createPair(address(this), usdt);
    isPair[panUsdtPair] = true;
