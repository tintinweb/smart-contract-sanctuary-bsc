...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8264bD045a6F329d3615F1D9EE134546A8C5D636;
...
contract VenomTheBull is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8dCFa8d5EC15E015817C60741F1425b7606D8D1e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VenomTheBull";
    string private _symbol = "VENTB";
