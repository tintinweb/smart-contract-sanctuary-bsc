...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63847215564F1AADd4A3A3C7C10bf587d2b87547; 
...
contract Shiranai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiranai Inu";
    string private _symbol = "Shira";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63847215564F1AADd4A3A3C7C10bf587d2b87547); 
    address payable public teamWalletAddress = payable(0x3B1903a1B3a890fB32d0b197ECCC5Caa07bDdcA8); 
