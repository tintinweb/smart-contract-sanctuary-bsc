...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60950fd097014B104fcd0B06Be8428ec6B92718E; // owner address
...
contract RastaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rasta Inu";
    string private _symbol = "Ranu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60950fd097014B104fcd0B06Be8428ec6B92718E); // Marketing Address
    address payable public teamWalletAddress = payable(0x60950fd097014B104fcd0B06Be8428ec6B92718E); // Team Address
