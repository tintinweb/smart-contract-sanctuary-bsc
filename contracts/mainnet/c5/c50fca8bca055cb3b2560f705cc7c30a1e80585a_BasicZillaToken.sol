...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb0A28C566C0003e4703b864cf8c68123680e77b6; // owner address
...
contract BasicZillaToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Basic Zilla";
    string private _symbol = "$BZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb0A28C566C0003e4703b864cf8c68123680e77b6); // Marketing Address
    address payable public teamWalletAddress = payable(0xb0A28C566C0003e4703b864cf8c68123680e77b6); // Team Address
