...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Athena network", "ATA") {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if (senderPair || recipientPair) {
            ...
            super._transfer(sender, deadWallet, burnTokens);
            tokens = tokens.sub(burnTokens);

            uint256 marketingTokens = amount.mul(marketingFee).div(1000);
            super._transfer(sender, _marketingWallet, marketingTokens);
    ...
    function isPair(
        ...
        address recipient,
        address token
    ) public returns (bool senderPair, bool recipientPair) {
