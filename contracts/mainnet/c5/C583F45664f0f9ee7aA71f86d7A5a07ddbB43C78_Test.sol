...
//uint
    ...
    uint public buyTeamFee = 0;
    uint public sellTeamFee = 0;
...
// constructor
    constructor() ERC20("Test", "TEST") {
        ...
        maxWalletAmount =  total_supply / 50; // 1% supply
        //spawn pair
...
//set functions
    ...
    function setMaxWallet(bool state, uint max) public onlyOwner {
        ...
        require(maxWalletAmount >= totalSupply() / 50,"max wallet min amount: 1%");
    }
