...
contract RNG is Context, IERC20, Ownable {
    ...
    string private _name = "Royal Never Give Up";
    string private _symbol = "RNG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49Fc0E7dbCFCBf96b00dCc1DFd1D089A9B6E3768); // Marketing Address
    address payable public teamWalletAddress = payable(0x4330D77bEa8AAE3e3A3377Cfa2137a82171a219e); // Team Address
