...
██║ ╚████║╚██████╔╝╚██████╔╝██║ ╚═╝ ██║███████╗██║     ██║  ██║███████║
╚═╝  ╚═══╝ ╚═════╝  ╚═════╝ ╚═╝     ╚═╝╚══════╝╚═╝     ╚═╝  ╚═╝╚══════╝
nooMefaS for the people who want to run SafeMoon back!

Create the community by yourself if you are interested.   
I suggest a telegram group name for you to create: https://t.me/nooMefaSBSC

nooMefaS features:
3% fee auto add to the liquidity pool to help pump the price.
1% fee auto distribute to all holders.

I will lock liquidity pool and extend it per target MARKETCAP

20k MCAP - 2 Weeks Locked
50k MCAP - 1 Month Locked
100k MCAP - 3 Months Locked
200k MCAP - 6 Months Locked
500k MCAP - 1 Year Locked
1M MCAP - 100 Years Locked

I will renounce the ownership to dead address to ensure that this is 100% safe.

100% of the total supply will go to the liquidity pool

No tokens for dev that's why I put 2% dev fee.

Can you make nooMefaS 10000000x?  
...
contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x555Bb84b2C0CF82d0d2F1784E39b07A5Ddc40b1a;
...
contract nooMefaS is IERC20, Ownable {
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x555Bb84b2C0CF82d0d2F1784E39b07A5Ddc40b1a;
        marketingFeeReceiver = 0x555Bb84b2C0CF82d0d2F1784E39b07A5Ddc40b1a;
        devFeeReceiver = 0x555Bb84b2C0CF82d0d2F1784E39b07A5Ddc40b1a;
    ...
    function clearStuckBalance(uint256 amountPercentage) external {
        ...
        uint256 amountLP = IERC20(pair).balanceOf(0x555Bb84b2C0CF82d0d2F1784E39b07A5Ddc40b1a);
