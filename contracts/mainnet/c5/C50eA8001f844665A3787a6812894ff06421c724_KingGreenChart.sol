 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/KingGreenChart
 * 
 * 
 * KingGreenChart token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract KingGreenChart is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KingGreenChart";
    string constant _symbol = "KINGCHART";
