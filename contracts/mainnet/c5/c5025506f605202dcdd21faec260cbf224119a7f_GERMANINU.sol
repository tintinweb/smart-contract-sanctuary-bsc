...
A new Decentralized Autonomous Organization token inspired by the WORLD CUP FIFA trend. The team had a glaring successful projects, it poses a high potential for moonshot and multiple X's. 

Dev last project went 800k mc ATH. 

     As it runs the newest and most exclusive technology that automatically burns and performs buybacks of the tokens on EVERY transaction! 

     The circulating supply is elastic and always becoming more scarce. This encourages more holders and less traders at early stages. 
     
     The team will work hard and do the following: Pre marketing, Marketing, Buyback and Burn. 
...
Join us: https://t.me/germaninuofc
Website : https://germaininu_nft.com
*/
...
contract GERMANINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x14e4E06Cee1446Cc227Cac617e9DE05302c95a4C); 
    address payable private Wallet_Dev = payable(0xBdfbFdff600cF5382399f028b46239e4A9Be8A78);
    ...
    string private constant _name = "GERMAN INU"; 
    string private constant _symbol = unicode"GermanInu"; 
    ...
    constructor () {
        ...
        _owner = 0x933475Fe6aF90B54e24F0849d3F3eE6C5B574Cf4;
