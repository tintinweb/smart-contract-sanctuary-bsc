...
Telegram: https://t.me/magictoken_bsc
🔮Magic Token BSC 🔮
Magic token brings old days of BSC with low tax and renounced ownership.

🔮Magician says magic token will do at least 1000x, jump in while early.

🎩 Low tax helps Magic Token to grow organic and steady.
🎩 Liquidity lock for one month
🎩 Magic stories and growth
...
contract MagicToken is Ownable {
    constructor(
        string memory _NAME,
