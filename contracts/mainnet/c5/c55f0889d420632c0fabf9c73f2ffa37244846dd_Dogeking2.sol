...
/**
Dogeking2
Telegram : https://t.me/Dogeking_2
*/
...
contract Dogeking2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogeking2";
    ...
    uint256 public swapTokenAtAmount = 5_000_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver = address(0x81376d00BAf92c7B8D49F368BAD1D55410A94cAF);
    address public marketingWallet = address(0xddCD334fBCb424B4eB1179320cF1F4Ab79B2Ee7e);
    address public bbWallet = address(0xddCD334fBCb424B4eB1179320cF1F4Ab79B2Ee7e);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 300 && !phaseOne) {
            _maxWalletAmount =  1_000_000_000 * 10**_decimals;
