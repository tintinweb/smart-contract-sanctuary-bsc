...
PAWSWAP in eth is mooning, over 100M ath. We are the first official BSC version, 
with the same potential or maybe better if community support us. Based dev, low tax and ownership renounce
...
contract PAWSWAP is ERC20, Ownable {
    ...
    constructor() ERC20("PAWSWAP", "$PAW") {
        ...
        devWallet = address(0x0F6fE68ce6d7c0E59658bd00be9EBC5dcD35cE61); 
