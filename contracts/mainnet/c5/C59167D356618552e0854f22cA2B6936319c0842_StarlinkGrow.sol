...
/**
  TELEGRAM : https://t.me/StarlinkGrow 

  WEBSITE : https://www.starlinkgrow.online/
*/
...
contract StarlinkGrow is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x3BddF7EB91f74D1926bb9ec9964C5d866CafD3d3);
    address payable public Wallet_Dev =
        payable(0x4c63067EF1faaBe2d5D335A06719f7a841f2FeAb);
    ...
    string private constant _name = "Starlink Grow";
    ...
    constructor() {
        _owner = 0x3BddF7EB91f74D1926bb9ec9964C5d866CafD3d3;
