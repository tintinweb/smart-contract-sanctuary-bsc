...
// 
//
// 📱 Telegram:https::https://t.me/RippleInuVerify
...
contract RIPPLEINU is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("RIPPLE INU", "RIPPLEINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RIPPLEINU";
    string private _symbol = "RIPPLEINU";
