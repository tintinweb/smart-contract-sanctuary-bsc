...
// Telegram - https://t.me/SquidGrowSnake
...
contract SquidGrowSnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidGrow Snake";
    string private _symbol = "SGSNAKE"; 
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xff4081C0Fe2519c454a899ea0B0B9A48CCD5f710);
    address payable private teamWalletAddress = payable(0xff4081C0Fe2519c454a899ea0B0B9A48CCD5f710);
