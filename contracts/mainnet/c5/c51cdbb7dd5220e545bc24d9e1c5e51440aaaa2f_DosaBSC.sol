...
/**
Dosa BSC, you didnt think we would forget the BSC side did you?

https://t.me/Dosa_Bsc_Official
...
contract DosaBSC is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Dosa BSC';
    string private constant _symbol = 'Dosa';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 1 000 000  tokens

    //Used for anti-bot autoblacklist
    uint256 private tradingEnabledAt; //DO NOT CHANGE, THIS IS FOR HOLDING A TIMESTAMP
	uint256 public autoBanTime = 5; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    //DevWallets
    address public Development=payable(0x20D0FC0c982378D95e1B2ad39B7E88b54aC9eE99);
    address public Development2=payable(0x0Cb4aCEF4DE411531AF2d53b5627DA36Bda00E3A);
    address public Marketing=payable(0x0Cb4aCEF4DE411531AF2d53b5627DA36Bda00E3A);
    //MainNet
	...
	uint256 private MaxBuy = 15000000 * 10**_decimals;
   ...
   //tracks auto generated ETH, useful for ticker etc
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 3500000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(Development2).transfer((amount*20) / 100);
    ...
    function TeamChangeDevelopment2(address newDevelopment2) public onlyOwner{
      Development2=payable(newDevelopment2);
    }
    ...
    function TeamExtendLiquidityInSeconds(uint256 secondsUntilUnlock) public onlyOwner{
    ...
    function TeamReleaseFinal() public onlyOwner {
    ...
    function TeamRemoveFinal(bool addToStaking) public onlyOwner{
        //Only callable if liquidity Unlock time is over
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
