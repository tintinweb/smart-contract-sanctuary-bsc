...
contract LIBERTYGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LIBERTY GROW";
    string private _symbol = "LIGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8fa73a5D2b6685e16C732c7A5D75d0CA0E03F400); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x8fa73a5D2b6685e16C732c7A5D75d0CA0E03F400); // Team Address
