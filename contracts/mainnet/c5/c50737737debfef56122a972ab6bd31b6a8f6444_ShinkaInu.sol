...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0a9C54cbE6929bFe8CDeC5311a156335a02A9b66; 
...
contract ShinkaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shinka Inu";
    string private _symbol = "SHINKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0a9C54cbE6929bFe8CDeC5311a156335a02A9b66); // 
    address payable public teamWalletAddress = payable(0x0a9C54cbE6929bFe8CDeC5311a156335a02A9b66); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x0a9C54cbE6929bFe8CDeC5311a156335a02A9b66)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x0a9C54cbE6929bFe8CDeC5311a156335a02A9b66),removeRandom);
}}