...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3B76757ea1c2Eb082A8C3224ee9079faD9c9c8c0;
...
contract $SuperManElon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x43CD2Ebc05692066694efdA3aD8AC378a0EA66b1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "$SuperManElon";
    string private _symbol = "$SMELON";
