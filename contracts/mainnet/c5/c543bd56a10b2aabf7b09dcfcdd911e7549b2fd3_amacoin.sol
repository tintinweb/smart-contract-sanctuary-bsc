...
/**
 * Visita nuestra página web: https://amacointoken.com/ y sorprendete con nuestro proyecto
 */

import "./amacoin-imports.sol";

/**
 * Junto y de la mano cambiemos el mundo "AMACOIN". 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Amacoin";
    string internal constant SYMBOL = "AMA";
     ...
     * 
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 10; // % of the total supply
    ...
    address internal fundacion = 0x298c241192E2b0f2265b5Df6fe067c8720c9F589;
