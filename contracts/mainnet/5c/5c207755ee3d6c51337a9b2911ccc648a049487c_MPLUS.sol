...
//
// WEBSITE : https://www.moonplustoken.com
// Telegram : t.me/moonplustoken
...
contract MPLUS is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 9;  
    ...
    constructor() {
        _name = "MoonPlus+"; //  Name
        _symbol = "MPLUS"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 100000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 5000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 40000000 * 10**_decimals; // 1% of total supply
        _maxWalletBalance = 100000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0x866010276CC7733548851BeA0CD10Fd6b80Cd256; // Marketing wallet 
        _devWalletAddress = 0x866010276CC7733548851BeA0CD10Fd6b80Cd256; // Burn Token 
