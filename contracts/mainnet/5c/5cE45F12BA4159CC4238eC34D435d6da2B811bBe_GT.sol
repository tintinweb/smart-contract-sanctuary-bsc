...
contract GT is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "GT";       //Full name
    string public symbol_ = "GT";      //abbreviation
    ...
    address public lpRewardToken = 0x6598463D6cBe4b51e9977437bf1200df4c45286C;      //Dividend tokens
    ...
    address public marketingWalletAddress = 0x269EaE58fc0B8c28185DCe01b00570B22C7c54D0;  //Marketing address
    ...
    constructor(
        ...
        uint256 totalSupply = 88 * (10**18);       //Supply
