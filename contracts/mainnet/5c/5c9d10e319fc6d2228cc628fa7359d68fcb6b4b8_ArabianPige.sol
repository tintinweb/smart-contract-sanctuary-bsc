...
contract ArabianPige is Context, IERC20, Ownable {
    ...
    string private _name = "Arabian Pige";
    string private _symbol = "ArabPige";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x032bEDc788675d25bc3abB4f14E42521f001CaEe); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x032bEDc788675d25bc3abB4f14E42521f001CaEe); // BuyBack Address
