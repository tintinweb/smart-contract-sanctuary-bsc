...
contract PESINU is IBEP20, Auth {
    ...
    uint256 public totalFee        = utilityFee + marketingFee + liquidityFee + ecoFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8a58e84A29bB9d992bAe167480Edc575a19cdc48;
        ecoFeeReceiver = 0x4cA8fC3019f085d42aFfC89341e7D0a5d56F0eB8;
        utilityFeeReceiver = 0xEe30FC3118b4EEc40064F64c19c17a6745C96Ebe;
    ...
    function setFees(uint256 _liquidityFee, uint256 _utilityFee, uint256 _marketingFee, uint256 _ecoFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        utilityFee = _utilityFee;
        marketingFee = _marketingFee;
        ecoFee = _ecoFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_utilityFee).add(_marketingFee).add(_ecoFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecoFeeReceiver, address _burnFeeReceiver, address _utilityFeeReceiver) external authorized {
