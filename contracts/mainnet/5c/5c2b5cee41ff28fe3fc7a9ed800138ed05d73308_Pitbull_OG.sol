...
contract Pitbull_OG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pitbull OG";
    string private _symbol = "OGPITBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD724c57E1Bf1f9Fc9EDA2f8350944D2C38D3ccc0); // Marketing Address
    address payable public teamWalletAddress = payable(0x30dA7EB97001BAaf8752a26A8c7eD589B592707d); // Team Address
