...
contract SMToken is ERC20, SafeOwnable {
    ...
    constructor() ERC20("Test Sarmat", "TSMT") {
    ...
    function calculateFee(
        ...
        if (pairs[from]) {
            uint256 tradeFeeToPairReward = amount
                ...
                .div(1e6);
            if (pairRewardDispatch != address(0)) {
