...
contract MonsterProtocol is BEP20, Ownable {
    ...
    address public marketingWallet = 0x5Fcd48451b949D2e53af714E28D07764cFaa59D3;
    address public P2EWallet = 0x93e5370f718d9199de1e810743009FB36DaA2Ac2;
    address public opsWallet = 0x277bC79aa779Af17d8Da1b6079E7c57AE3D9Be9A;
    ...
    Taxes public taxes = Taxes(2, 2, 1, 1, 0);
    Taxes public sellTaxes = Taxes(2, 2, 1, 1, 0);
    ...
    constructor() BEP20("Monster Protocol", "MST") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 P2EAmt = unitBalance * 2 * swapTaxes.P2E;
            if (P2EAmt > 0) {
                payable(P2EWallet).sendValue(P2EAmt);
            }
