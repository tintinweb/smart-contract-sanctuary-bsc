...
IF YOU MISSED MIKU THEN DON'T MISS MIKUCHAN

TG: https://t.me/MikuChanToken
...
contract MikuChan is Context, IERC20 {
    ...
    address payable public _Marketing =
        payable(0xc794c85DcAcDA535C296e82a5Ee2fdC1D7Ee2E45);
    address payable public _Dev =
        payable(0xc794c85DcAcDA535C296e82a5Ee2fdC1D7Ee2E45);

    string private constant _name = "MikuChan";
    string private constant _symbol = unicode"MKCN";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    uint256 public _Buy__Fee = 5;
    uint256 public _Sell__Fee = 5;
    ...
    constructor() {
        _owner = 0xc794c85DcAcDA535C296e82a5Ee2fdC1D7Ee2E45;
