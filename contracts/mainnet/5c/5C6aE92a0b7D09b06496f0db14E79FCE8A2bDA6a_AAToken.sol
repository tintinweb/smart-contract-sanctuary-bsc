...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundUsdt > 0) {
            uint256 perFundUsdt = fundUsdt / 3;
            USDT.transferFrom(address(_tokenDistributor), fundAddress, perFundUsdt);
            USDT.transferFrom(address(_tokenDistributor), fundAddress2, perFundUsdt);
            USDT.transferFrom(address(_tokenDistributor), fundAddress3, perFundUsdt);
        }
...
contract AAToken is AbsToken {
    constructor() AbsToken(
        ...
        18,
        100000,
        address(0x086C4a084393635333a7021cC93Dc4a5ad1f33b0),
        address(0x3241776D632982813c4d6087903aA4cc14AC2099),
        address(0x3241776D632982813c4d6087903aA4cc14AC2099),
