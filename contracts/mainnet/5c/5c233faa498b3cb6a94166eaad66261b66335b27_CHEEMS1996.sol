...
contract CHEEMS1996 is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"CHEEMS1996";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x2AED9930a7232DA4727D758d4C38b530bce28942);
    address payable public MarketingWallet = payable(0x683BC0eF361282cc8Daf43077F902a2673633988);
