...
/**
 ...
 TG: https://t.me/StableInu
 Website: https://stableinu.trade
 Twitter: https://twitter.com/stable_inu


 Hodl $STABLE and get BUSD automatically in your wallet every hour or so!
 $BUSD: 0xe9e7cea3dedca5984780bafc599bd69add087d56
 
 Total Supply of Tokens: 100,000,000,000 (100 Billion)
 
 Reflection: 9% in BUSD
 
 Buy Slippage: 10% (10-12% should be OK)
 Sell Slippage: 20% (20-21% sholde be OK)

 *** 50% Of total supply is burned before launch ***
...
// Contract
contract STABLEINU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Stable INU";
    string constant _symbol = "STABLE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 10% MAX 10,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 30) / 100; // 30% MAX 30,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xaBa370C5e40D56f006E99C937Ad23883778c8FeB);
