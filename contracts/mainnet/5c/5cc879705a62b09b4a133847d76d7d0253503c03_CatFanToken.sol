...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfcf0414513A8D00Ee8F53B87Cd55B833495cF088; // owner address
...
contract CatFanToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Cat Fan Token ";
    string private _symbol = " $CFT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfcf0414513A8D00Ee8F53B87Cd55B833495cF088); // Marketing Address
    address payable public teamWalletAddress = payable(0xfcf0414513A8D00Ee8F53B87Cd55B833495cF088); // Team Address
