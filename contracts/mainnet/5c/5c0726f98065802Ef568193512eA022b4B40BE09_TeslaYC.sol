...
contract TeslaYC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tesla Yacht Club";
    string private _symbol = "TeslaYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11eBf01f4BCcD94b8F5acAcEA6f7bac92128CE55); // Marketing Address
