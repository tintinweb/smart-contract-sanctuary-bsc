...
contract USDTBEP20 is Ownable {
    ...
    uint256 public feePercents = 300; 
    uint256 public minDeposit = 100e18;
    uint256 public maxDeposit = 5000e18;
    uint256 public baseDeposit = 1000e18;
    uint256 public splitPercents = 2100;
    uint256 public lotteryPercents = 900;
    uint256 public transferFeePercents = 1000;

    uint256 private constant timeStep = 1 days;
    uint256 public dayPerCycle = 15 days; 
    uint256 public dayRewardPercents = 150;
    uint256 public maxAddFreeze = 15 days;
    uint256 public referDepth = 15;
    uint256[15] public invitePercents = [500, 100, 200, 300, 100, 100, 100, 100, 100, 100, 50, 50, 50, 50, 50];
    uint256[5] public levelDeposit = [100e18, 1000e18, 2000e18, 3000e18, 5000e18];
    uint256[5] public levelInvite = [0, 10000e18, 20000e18, 30000e18, 100000e18];
    uint256[5] public levelTeam = [0, 30, 50, 100, 300];

    uint256[3] public balReached = [100e22, 500e22, 1000e22];
    uint256[3] public balFreezeStatic = [70e22, 300e22, 500e22];
    uint256[3] public balFreezeDynamic = [40e22, 150e22, 200e22];
    uint256[3] public balRecover = [150e22, 500e22, 1000e22];
    uint256 public poolPercents = 50;
    uint256 public luckMinDeposit = 500e18;
    uint256 public lotteryDuration = 30 minutes;
    uint256 public lotteryBetFee = 10e18;
    mapping(uint256=>uint256) private dayLotteryReward; 
    uint256[10] public lotteryWinnerPercents = [3500, 2000, 1000, 500, 500, 500, 500, 500, 500, 500];
    uint256 public maxSearchDepth = 3000;
    ...
    function updateContractData(
        uint256 _feePercents,
        uint256 _minDeposit,
        uint256 _maxDeposit,
        uint256 _baseDeposit,
        uint256 _splitPercents,
        uint256 _lotteryPercents,
        uint256 _transferFeePercents,
        uint256 _dayPerCycle,
        uint256 _dayRewardPercents,
        uint256 _maxAddFreeze,
        uint256 _referDepth
    ) public onlyOwner{
        ...
        splitPercents=_splitPercents;
        lotteryPercents=_lotteryPercents;
        transferFeePercents=_transferFeePercents;
        dayPerCycle=_dayPerCycle;
        dayRewardPercents=_dayRewardPercents;
        maxAddFreeze=_maxAddFreeze;
        referDepth=_referDepth;
    }

    function updateInvitePercents(uint256[15] memory _invitePercents) public onlyOwner{
        invitePercents = _invitePercents;
    }

    function updateLevelDeposit(uint256[5] memory _levelDeposit) public onlyOwner{
        levelDeposit = _levelDeposit;
    }

    function updateLevelInvite(uint256[5] memory _levelInvite) public onlyOwner{
        levelInvite = _levelInvite;
    }

    function updateLevelTeam(uint256[5] memory _levelTeam) public onlyOwner{
        levelTeam = _levelTeam;
    }

     function updateBalances(uint256[3] memory _balReached , uint256[3] memory _balFreezeStatic , uint256[3] memory _balFreezeDynamic , uint256[3] memory _balRecover  ) public onlyOwner{
        balReached = _balReached;
        balFreezeStatic = _balFreezeStatic;
        balFreezeDynamic = _balFreezeDynamic;
        balRecover = _balRecover;
    }

    function updatePoolData(uint256 _poolPercents,uint256 _luckMinDeposit,uint256 _lotteryDuration,uint256 _lotteryBetFee,uint256 _maxSearchDepth) public onlyOwner{
        poolPercents = _poolPercents;
        luckMinDeposit = _luckMinDeposit;
        lotteryDuration = _lotteryDuration;
        lotteryBetFee = _lotteryBetFee;
        maxSearchDepth = _maxSearchDepth;
    }

    function updateLotteryWinnerPercents(uint256[10] memory _lotteryWinnerPercents) public onlyOwner{
        lotteryWinnerPercents = _lotteryWinnerPercents;
    }
}