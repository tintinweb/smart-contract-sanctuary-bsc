...
/**
  ...
  //🔶🔥Bring Back BSC is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous sytem that build and run for community.
  //Our Main target fo are to make big utility that govern our farm and our new chain in upcoming future.

  //Tg : https://t.me/BringBackBSC
...
contract BSCBACK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bring Back BSC"; // 
    string private constant _symbol = "$BSCBACK "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xf4B4B659659b5907198386A45669AaBB622Af03D;
