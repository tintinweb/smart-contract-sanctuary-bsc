...
// Telegram : https://t.me/BabyShihTzuInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x74d00122a5d038914EAe062af8174C888F3166Dc); // ShihTzuInu
...
contract BabyShihTzuInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Shih Tzu Inu";
    string constant _symbol = "$BabyShih";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x74d00122a5d038914EAe062af8174C888F3166Dc; // ShihTzuInu
    ...
    address public anothermarketingWallet;
    ...
    constructor () Auth(msg.sender) {
		...
		marketingWallet = 0xee40ADAee54A9b41E7D5847b1a5297a073740f8C;
        anothermarketingWallet = 0xee40ADAee54A9b41E7D5847b1a5297a073740f8C;
