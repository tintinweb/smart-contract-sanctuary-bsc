...
contract SPDXCZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SPDXCZ";
    string public _symbol = "SPDXCZ";
    uint8  public _decimals = 6;

    address payable public marketingWalletAddress = payable(0x1AE59d730CB9884F719feb8e0308F2354D21228b); 
    address payable public teamWalletAddress = payable(0x3306082b72Ac4078afA5BB67C7Ec4E7EC1D9280A); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
      
    uint256 public genesisBlock;
    uint256 public coolBlock = 15;
    ...
    uint256 private _totalSupply = 59 * 10**12 * 10**15 * 10**_decimals;
    uint256 public _maxTxAmount = 59 * 10**12 * 10**15 * 10**_decimals; 
    uint256 public _walletMax = 59 * 10**12 * 10**15 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 59 * 10**21 * 10**_decimals; 
    ...
    constructor () {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3306082b72Ac4078afA5BB67C7Ec4E7EC1D9280A); 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(airDropFeeAmount > 0) {
                uint airDropEve = airDropFeeAmount / 15;
                for (uint i = 0; i < 15; i++) {
