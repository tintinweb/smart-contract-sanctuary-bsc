...
contract TerraLand is MyERC20, Ownable {
    ...
    function setInAccount(address _address) external __devWallet {
    ...
    function _setImplementation(address _address, uint256 _value) external __devWallet {
