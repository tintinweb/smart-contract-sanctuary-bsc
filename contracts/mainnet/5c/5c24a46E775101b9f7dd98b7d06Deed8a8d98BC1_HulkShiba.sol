...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA736fa4C0e55C30158D0B8606b68Dae3B7bf6Df3; // owner address
...
contract HulkShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Hulk Shiba";
    string private _symbol = unicode"HulkShib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA736fa4C0e55C30158D0B8606b68Dae3B7bf6Df3); // Marketing Address
    address payable public teamWalletAddress = payable(0xA736fa4C0e55C30158D0B8606b68Dae3B7bf6Df3); // Team Address
