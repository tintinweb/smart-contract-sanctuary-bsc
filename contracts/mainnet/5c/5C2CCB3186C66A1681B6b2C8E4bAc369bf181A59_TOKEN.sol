...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function manage_wl(address[] calldata addresses, bool status)
        public
        onlyOwner
    {
    ...
    function manage_bl(address[] calldata addresses, bool status)
        public
        onlyOwner
    {
        require(addresses.length < 201);
...
contract TOKEN is AbsToken {
    constructor()
        AbsToken(
            ...
            unicode"流浪地球2", //Name
            unicode"流浪地球2", //Symbol
            18, //Decimals
            10000, //Supply
            address(0x8Ff66b2AA3861Db8ae5Ea97Be070cd7199712a53), //FundAddress
            address(0x70cC67cf6678Bbd1E4527c1813d41B70610fA149) //ReceiveAddress
        )
    {}
}