...
contract token is ERC20 {
    ...
    address public marketAddress = address(0x2570D4922A5fd981Fd49F5A3485EDe90666F6AA9);
    ...
    uint256 public maxWalletAmount = 100 * 100000000 * 10**18;

    address private fromAddress;
    address private toAddress;
    mapping (address => uint256) shareholderIndexes;

    string internal tokenName = "tokenname";
    string internal tokenSymbol = "TN";
