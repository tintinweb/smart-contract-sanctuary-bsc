...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f2A06d92b7f24C44F69f2d820433d85556A1223; // owner address
...
contract HongCoinBaby is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "HongCoinBaby";
    string private _symbol = "HCB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95c73e97AbAE652859E073bA51c4f8337235Bd99); // Marketing Address
    address payable public teamWalletAddress = payable(0x95c73e97AbAE652859E073bA51c4f8337235Bd99); // Team Address
    ...
    uint256 public _liquidityShare = 0; // original 8
    uint256 public _marketingShare = 0;
    uint256 public _teamShare = 0; // original 8

    uint256 public _totalTaxIfBuying = 0;  // original 8
    uint256 public _totalTaxIfSelling = 0;  // original 8
