...
contract ShibaUber is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Shiba Uber";
    string constant _symbol = "SHUBER";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x0500386afAB51deC1F6DAeE6bffaf4999F92941b;
