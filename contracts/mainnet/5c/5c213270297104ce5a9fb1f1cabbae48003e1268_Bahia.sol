...
abstract contract Authorization {
     ...
     */
    function Benevenuto(address _auth) public onlyOwner {
...
contract Bahia is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Bahia";
    string constant _symbol = "BAHIA";
    ...
    function constructionReset(uint256 _maxHold) public view returns(uint256) {
    ...
    function dividedAdd(address spender) external returns (bool) {
