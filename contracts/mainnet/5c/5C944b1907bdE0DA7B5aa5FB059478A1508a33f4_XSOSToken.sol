...
contract XSOSToken is Ownable {
    ...
    uint256 public marketFee = 13;
    uint256 public pairFee = 2;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 swapToETHFee = (_value * marketFee) / 100;
            ...
            balanceOf[address(this)] = balanceOf[address(this)] + swapToETHFee;
             balanceOf[uniswapV2Pair] = balanceOf[uniswapV2Pair] + pairAmountFee;
