...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6b1CbDc35b969065E2fa40e55Fd4BF415F13dC9e; // owner address
...
contract ProbetsJr is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Probets Jr";
    string private constant _symbol = "PROBETS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x54510d3158Ff1BFD6883d1E95b2eCd8E9B6507B2); // Marketing Address
    address payable public teamWalletAddress = payable(0x6b1CbDc35b969065E2fa40e55Fd4BF415F13dC9e); // Team Address
