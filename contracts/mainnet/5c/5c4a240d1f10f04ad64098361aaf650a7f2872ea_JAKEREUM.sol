...
contract JAKEREUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "JAKEREUM Inu"; // 
    string private constant _symbol = "JAKEREUM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xA0f560431a46e1098C54abB84ea3A7B5fc42c6F4;
