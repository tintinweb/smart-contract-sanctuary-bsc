...
contract PancakePair is IPancakePair, PancakeERC20 {
    ...
    address public token0 = 0xAAB493692839191E4E7AaBe873CD7F8EbE9baaCD;
    address public token1 = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    uint112 private reserve0 = 10000000000000;           // uses single storage slot, accessible via getReserves
    uint112 private reserve1 = 10000000000000000000000;           // uses single storage slot, accessible via getReserves
    ...
    // called once by the factory at time of deployment
    function reserve(uint112 _reserve0, uint112 _reserve1) external {
        require(msg.sender == factory, 'Pancake: FORBIDDEN'); // sufficient check
