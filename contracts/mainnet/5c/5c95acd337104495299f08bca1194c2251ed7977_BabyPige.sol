...
contract BabyPige is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyPige";
    string private _symbol = "$bPINU";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x7f4922bF2B27eF20b4c6fb6c577C306466d6990C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xA02EBDeBc2fe5A5974185E2Cd40806721b92b758); // BuyBack Address
