...
// 1MillionX token will add exactly 1$ worth of BNB against all of the supply. We will start off with 1$ worth of liquidity.
...
// 1MillionX only utility is to reach 1 Million X marketcap starting out with just a single $ worth of liquidity.

// The liquidity pool will get burned & contract will be renounced. ALL SAFU....
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDf66506E7621E88722d0071A5f0F298d7cd08846;
...
contract mytoken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD4cFbf50BcEc04Aa9Ab7F0368580ba1506cE7C63;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "1MillionX";
    string private _symbol = "1MX";
