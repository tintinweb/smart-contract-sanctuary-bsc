...
contract DogeKingDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeKingDAO";
    string private _symbol = "DogeKingDAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x2b0D1adcfC0b1EE814a31B5211f639eB870B1dc6); 
    address payable private teamWalletAddress = payable(0xC96EcFDE3546CA4A0403b36fEcde236CFFAb2A6d); 
    ...
    uint256 private _totalSupply = 1 * 999*  10**_decimals;
