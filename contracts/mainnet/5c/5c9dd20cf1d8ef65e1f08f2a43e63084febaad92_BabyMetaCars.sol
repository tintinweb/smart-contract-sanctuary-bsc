...
/*
Telegram: https://t.me/babymetacars
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xDF779aE4CbB7C45882c3521F0574d86D3bb95B5f);
...
/* Token contract */
contract BabyMetaCars is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address MC = 0xDF779aE4CbB7C45882c3521F0574d86D3bb95B5f; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xeC7cCC354C998D44C31F2BB99AB02666B79399F1;
    ...
    // Name and symbol
    string constant _name = "Baby Meta Cars";
    string constant _symbol = "BabyMetaCars";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 30 / 1000; // 3% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 30 / 1000; // 3% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 1000; // 3% or 1m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x3e8949ca79CF21939cae324D89eEa3D70dFAa494;
