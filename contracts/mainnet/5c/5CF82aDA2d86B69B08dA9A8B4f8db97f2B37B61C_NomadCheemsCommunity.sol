...
/* Token contract */
contract NomadCheemsCommunity is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x919e7fa9Df92287a2a3E08392d56b2FC2351A8d1;
    ...
    // Name and symbol
    string constant _name = "NomadCheems Community";
    string constant _symbol = unicode" cNOMAD ";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10
