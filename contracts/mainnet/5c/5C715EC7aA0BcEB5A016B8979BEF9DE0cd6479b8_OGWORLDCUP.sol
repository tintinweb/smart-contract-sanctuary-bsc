...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x65d9E31399Af8073DbEfC1129163a670103EF9c5; // owner address
...
contract OGWORLDCUP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG WORLDCUP";
    string private _symbol = "OGWP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x65d9E31399Af8073DbEfC1129163a670103EF9c5); // Marketing Address
    address payable public teamWalletAddress = payable(0x65d9E31399Af8073DbEfC1129163a670103EF9c5); // Team Address
