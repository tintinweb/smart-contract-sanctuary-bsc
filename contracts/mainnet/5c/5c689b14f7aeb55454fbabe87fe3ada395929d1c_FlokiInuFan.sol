...
/*
Official link of Floki Inu Fan Token: 
 TG :: t.me/FlokiInuFan_chat
 TW :: twitter.com/FlokiInu_Fan
*/
...
contract FlokiInuFan is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "FlokiInuFan";
    string constant _symbol = "FlokiInuFan";
