...
contract CoinToken is ERC20, Ownable {
    ...
    constructor(string memory name_,string memory symbol_,uint256 totalSupply_,address[4] memory addrs,uint256[4] memory buyFeeSetting_, uint256[4] memory sellFeeSetting_,uint256 tokenBalanceForReward_
