...
contract SnufflesHalf is Context, IERC20, Ownable {
    ...
    string private constant _name = "Snuffles Half"; // 
    string private constant _symbol = "SN0.5"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x74Ff7D4A83f7329aD655eed686aA2E507C411F45;
    ...
    function includeInFee(address account) public onlyOwner {
       ...
       function nf(uint256 nmf, uint256 nlf) public onlyOwner {
        _marketingFee = nmf;
        _liquidityFee = nlf;
        
    }

    function UpdateMaxTransactions(uint256 max ) public onlyOwner {
