...
contract PowerStationWhaleV2 is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x5Efe9c3e5b43580328104Da18A091cE6a3D40651); // token contract address
        ...
        returns (uint256 rate) 
    {
        ...
        rate = (perDay * 1e4) / 28800; // removed 2 decimals so 1 = 0.01 
