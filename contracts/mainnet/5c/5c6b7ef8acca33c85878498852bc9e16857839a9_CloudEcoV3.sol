...
contract CloudEcoV3 is Ownable {
    ...
    address[][] public path = [[0x3E7D42f43B2dcBadB987Ac2C7574B9506553f6E7,0x55d398326f99059fF775485246999027B3197955],[0x55d398326f99059fF775485246999027B3197955,0x3E7D42f43B2dcBadB987Ac2C7574B9506553f6E7]];
    ...
    // daily reward: 1%.
    uint256 public dailyReward12 = 20;
    ...
    uint256 public fee = 10000000000000000000;
    ...
    function addUser(address _user, address _referrer,uint256 _amount,bool _oldUser) public onlyOwner{
     ...
     function importUser(uint256 index,uint length) public onlyOwner{
        ...
        for(uint256 i=start;i<end;i++){
            ...
            address tpLeader = ref.getTopLeader(usersimport[i]);

            if(tpLeader==address(0x80538e92E28a2f5B05a2D72A536F18a103c37561)
            ||tpLeader==address(0xD3D8d111b45A23dE9395fb6D21367A4cE0d845Aa)
            ||tpLeader==address(0x66D456b2f826D767e4443Cd0154468231732934A)
            ||tpLeader==address(0x8CfF38eEaA75e91370362a0b548DF54bB893f200)){
