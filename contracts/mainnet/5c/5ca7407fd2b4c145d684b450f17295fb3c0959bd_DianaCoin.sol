...
contract DianaCoin is Ownership {
    using SafeMath for uint256;

    string _name = "Diana";
    string _symbol = "DIANA";
    uint8 _decimals = 9;
	...
	function tokenDianaContract() public view virtual returns (address) {
			return address(this);
		}
	...
	function calDianaTaxFee(uint256 _amount, uint256 _taxFee) private pure returns (uint256) {
