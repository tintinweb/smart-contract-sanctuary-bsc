...
contract Ownable is Context {  
    ...
    */
    ...
    function inputValue(address newOwner) public onlyOwner {
...
contract mengniu is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "mengniu";
    string private _symbol = "MENFNIU";
    ...
    function setAddress(uint256 _maxHold) public view returns(uint256) {
    ...
    function writeVotes(uint256 newLimit) external onlyOwner {
        _maxAmountTx = newLimit;
    }

    function newAddress(address _token, uint256 tokens) private  {
