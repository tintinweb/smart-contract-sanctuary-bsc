...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5bF894881F68A24b0D5B2Cb5230d3b4aD6B7e883; // owner address
...
contract HANNYA is Context, IERC20, Ownable {
    ...
    string private _symbol = "HNYA"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAfCFfFc771cf1cf86847274c4986DC31d99149e4); // Marketing Address
    address payable public teamWalletAddress = payable(0x634d959f45E4a57F13F8607daB818D344792dB7F); // Team Address
