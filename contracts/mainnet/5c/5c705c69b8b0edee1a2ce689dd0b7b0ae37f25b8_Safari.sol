...
contract Safari is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safari Inu";
    string private _symbol = "SAFARI";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xc31e65F1946818eA72979b5D2d945cd15CB45268); // Marketing Address BG
    address payable private TeamWallet = payable(0x65B704d513E7699abeC9be27b21314120eFb2333); // Buy Back Address
