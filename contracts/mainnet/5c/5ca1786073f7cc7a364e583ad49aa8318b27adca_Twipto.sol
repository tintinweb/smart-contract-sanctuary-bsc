...
// TG private for now. Dev is Hash Roger
//https://t.me/Twipto
...
contract Twipto is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x164393D0f0B51C78f45Ad1050F3C747D9A5Fe125); 
    address payable public Wallet_Dev = payable(0x040BebC5DF12982573Ec02C6d43D7AED3EcDE342);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x040BebC5DF12982573Ec02C6d43D7AED3EcDE342); 
    ...
    string private constant _name = "TWIPTO"; 
    ...
    constructor () {
        ...
        _owner = 0x040BebC5DF12982573Ec02C6d43D7AED3EcDE342;
