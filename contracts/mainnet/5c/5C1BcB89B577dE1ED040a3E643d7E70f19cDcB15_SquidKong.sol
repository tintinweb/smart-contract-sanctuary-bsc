...
contract SquidKong is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SquidKong";
    string constant _symbol = "SQDKONG";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xF9051a4e5CE8b93826438aE39822A9B69cd80F4F;
