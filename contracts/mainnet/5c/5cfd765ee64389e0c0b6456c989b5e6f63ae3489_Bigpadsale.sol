...
/**
   ...
   2% auto stake distributed ETH to all token holders
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract Bigpadsale is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bigpad Token";
    string constant _symbol = "BIG";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000000000 * 10**6 * 10**9;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDb725f04c4a0834391c5ec2f8598E12A92e8e55F;
