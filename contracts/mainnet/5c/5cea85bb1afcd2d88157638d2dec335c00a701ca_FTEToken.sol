...
contract FTEToken is BEP20('FTE', 'FTE') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "FTE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "FTE::delegateBySig: invalid nonce");
        require(now <= expiry, "FTE::delegateBySig: signature expired");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying FTEs (not scaled);
