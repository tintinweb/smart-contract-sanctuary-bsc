...
contract CCR is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress =
        payable(0x31634918535a1eCB83f8Bb06F76B70b73f345c67); // Marketing Wallet Address
    address payable public ecosystemWalletAddress =
        payable(0x31634918535a1eCB83f8Bb06F76B70b73f345c67); // ecosystem Wallet Address
    ...
    uint256 private _tTotal = 500_000_000 gwei;
    uint256 private _tFeeTotal;

    string private constant _name = "CloudChat reloaded";
    string private constant _symbol = "CCR";
