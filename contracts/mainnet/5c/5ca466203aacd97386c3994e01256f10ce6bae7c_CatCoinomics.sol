...
contract CatCoinomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatCoinomics";
    string private _symbol = "CCnomics";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x7351d80ABFEC2cb51229677346854ddF59E4E696); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7351d80ABFEC2cb51229677346854ddF59E4E696); // BuyBack Address
