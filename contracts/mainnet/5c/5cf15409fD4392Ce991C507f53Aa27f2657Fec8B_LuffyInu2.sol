...
/*
Luffy Inu 2.0, the first super-Meme on Mainnet bridging together the Defi, NFT and DApp communities.
    TG: https://t.me/Luffy_Inu2
    Website: http://www.luffyinu2.space/
*/
...
contract LuffyInu2 is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LuffyInu2";
    string constant _symbol = "LuffyInu2"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 1 * 10**14 * 10**_decimals;
    uint256 _rTotal = _tTotal * 10**7;   
    ...
    uint256 public _maxWalletSize = _tTotal * 500 / 10000; //Initial 3%

    // Fees Receivers
    address public devFeeReceiver = 0x5079C24078dE0D69522F7705EfB29E419f58455C;
    address public marketingFeeReceiver = 0x5079C24078dE0D69522F7705EfB29E419f58455C;
    address public liquidityFeeReceiver = 0x5079C24078dE0D69522F7705EfB29E419f58455C;
    ...
    function Holdbottom(address account, bool status) public onlyOwner {
