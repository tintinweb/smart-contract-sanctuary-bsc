...
//Telegram: https://t.me/TrendDetectorBotbsc
//Bot: https://t.me/Trend_Detector_Bot
//Notifications of the new top trending pairs on BSC/ETH depending on their volume and % to ATH
//Be the first to buy new TRENDS with $TDB bot 
...
contract TrendDetector is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TrendDetectorBot";
    string private _symbol = unicode"TDB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xa6638F8930eC33f100231De053709b827801D886));
        marketingWallet = payable(address(0x5fAcf570B1D4B1DE2086Af853a3b1cD2343cd8e1));
