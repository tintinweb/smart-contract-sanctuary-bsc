...
contract AncientChineseZeros  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Ancient Chinese Zeros';
    string private constant _symbol = 'ACZ';
