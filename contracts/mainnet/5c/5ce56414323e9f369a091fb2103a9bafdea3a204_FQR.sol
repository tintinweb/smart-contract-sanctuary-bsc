...
contract FQR is ERC20, Ownable {
    ...
    constructor () ERC20("Floki Qatari", "FQR") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xadcAA08Ea63D83bB1c7839234A635A7C47de6e03;

        maxWalletLimitEnabled = true;
        maxWalletAmount       = 500_000 * (10 ** decimals()); // 2%

        maxTransactionLimitEnabled = true;
        maxTransactionAmountBuy    = 25_000_000 * (10 ** decimals());
        maxTransactionAmountSell   = 25_000_000 * (10 ** decimals());
        ...
        _mint(owner(), 25_000_000 * (10 ** decimals()));
