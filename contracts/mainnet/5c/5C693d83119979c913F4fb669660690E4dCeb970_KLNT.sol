...
contract KLNT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KLNT2";
    string private _symbol = "KLNT2";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1dEFF210a3B27e1CEF12D58c3F3e85E1A486E21F); 
    address payable private teamWalletAddress = payable(0xFA68C92a3dF5667928f269f93A4e71804137f8b9); 
    ...
    uint256 private _totalSupply = 2 *  10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 1  * 10**3* 10**_decimals; 
