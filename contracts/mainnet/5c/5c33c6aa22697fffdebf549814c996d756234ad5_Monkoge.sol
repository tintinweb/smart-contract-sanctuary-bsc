...
Monkoge Inu Stealth Launch, LP locked for 1 month.
...
contract Monkoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5B6C783C4901C23AA4c9dB061db001463cF6D2AD); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5B6C783C4901C23AA4c9dB061db001463cF6D2AD); // Team Address
    ...
    string private constant _name = "Monkoge";
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 15, "Must keep taxes below 30%");
