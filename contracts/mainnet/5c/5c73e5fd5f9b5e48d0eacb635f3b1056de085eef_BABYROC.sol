...
contract BABYROC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYROC";
    string private _symbol = "BABYROC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x41A6049b6B9d219a1f1E35396795E7D6Ae82A983); // Marketing Address
    address payable public teamWalletAddress = payable(0x5Da877352BE88C4AA41354c0E2273DC713Ba3a55); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x74C7AFE8Adc66B21Fc8AB558D412727D101743B1),
            block.timestamp
        );
    }
