...
interface IPoolManager {
  function isPoolGenerated(address wallet) external view returns(bool);
}
interface ILock {
  function lock(
    address owner,
...
contract CoinageLock is ILock, OwnableUpgradeable, UUPSUpgradeable {
