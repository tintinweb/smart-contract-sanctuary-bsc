...
Welcome Poo Bear Inu Community! We have all heard of the cute & well known little bear named “Poo Bear”, so our team has decided to invite him into the cryptocurrency space with hopes to turn this into the next big meme coin. 
We welcome everyone to come grab a bag and help us spread the word! 
...
Telegram: https://t.me/PooBearInu
...
contract PBEAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "Poo Bear Inu";
