 ...
 *Submitted for verification at BscScan.com on 2022-12-07
    ...
    https://t.me/HumanVoiceAI
  
    we've built a complex AI system that incorporates AI, Cloud, and the Blockchain.
    Our platform has many use cases that can be used by the average user to companies that need to generate text to Human-like speech, or transcribe their Youtube videos, Podcasts, Phone meetings and more!

    Bringing Cloud and AI to the blockchain! Our HumanVoiceAI token will be launched on the BSC Network
...
contract HumanVoiceAI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x67aF4581ea3780087167A2772CD5c23E004357bF;
 
    string constant _name = "Human Voice AI";
    string constant _symbol = "HVAI";
