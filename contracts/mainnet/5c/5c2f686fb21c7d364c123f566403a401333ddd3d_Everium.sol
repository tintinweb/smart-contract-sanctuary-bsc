...
contract Everium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Everium";
    string private _symbol = "Everium";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F0C9B72ac4705aEEBcDe17292A0A80e2D25b825);
    address payable public teamWalletAddress = payable(0x9F0C9B72ac4705aEEBcDe17292A0A80e2D25b825);
