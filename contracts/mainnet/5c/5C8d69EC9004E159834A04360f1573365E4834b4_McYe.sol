...
contract McYe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string  constant _name = unicode"Mc ￥E";
    string constant _symbol = unicode"Mc ￥E";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x2E07182C57ddf62b0a2ce17503531451FB1A1129;
