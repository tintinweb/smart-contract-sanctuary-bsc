...
contract TokenReward is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("CHRONODAO", "CHRD", uint8(DECIMALS)) Ownable() {
        ...
        riskFreeValueReceiver = 0x639670bEc0d40fD8A32e2f591C956dEDeb880FA3;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHMarketing = amountETH.mul(treasuryFee).div(
            totalETHFee
        );
   ...
   antiBotEnabled = _enable;
    ...
    function setFees(
        ...
        sellFee = _sellFee;
        totalFee = liquidityFee.add(treasuryFee).add(firePitFee).add(sellFee);
