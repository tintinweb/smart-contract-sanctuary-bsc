...
// 
//
// 📱 Telegram:https::https://t.me/SphinxGold
//
...
contract SphinxGold is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Sphinx Gold", "SphinxGold") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SPHINXGOLD";
    string private _symbol = "SPHINXGOLD";
