...
"Let's get 'em bread"
100% Safe
We bake with fresh ingredients so it is safe to digest and invest!
https://t.me/SHREADBONK
✅Contract Address : 0x5CDE9282834a1408BfF8D4fdee36248753a14d7b
💰https://poocoin.app/tokens/0x5CDE9282834a1408BfF8D4fdee36248753a14d7b
👔LP LOCK
👔Safe 
👔Tax 3%
👔Rewards 3 % $SHREAD
✅https://t.me/SHREADBSC
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextBepSHREAD {
...
contract OwnableBepSHREAD is ContextBepSHREAD {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBepSHREAD: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBepSHREAD: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SHREADtoken is ContextBepSHREAD, BepSHREAD, OwnableBepSHREAD {
    ...
    string private _name = 'SHREAD';
    string private _symbol = 'SHREAD';
