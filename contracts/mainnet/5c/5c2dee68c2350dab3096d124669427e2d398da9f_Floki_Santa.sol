...
contract Floki_Santa is ERC20, Ownable {
    ...
    address payable public teamWallet = payable(0x5ED0d45D427A3925bcdB71EBa80a919D321426d2);
    address payable public marketingWallet = payable(0x1a6E715f606Fb0c45a0B17B774e4b11e1B9169EC);
    ...
    uint256 public maxWalletLimit = 1_000_000_000_000 * 10**18; // 10%
