...
/**
Twitter: twitter.com/spacebeasties
Website: spacebeasties.io
Telegram: t.me/spacebeasties
*/
...
contract Spacebeasties is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress;     // 0x993c38F56b34b90D9Ac75FaA0D17aab15fE057Fe
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress,address tokenOwner,address service) public payable {
        ...
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
        _tTotal = 777000000 * 10 ** _decimals;
