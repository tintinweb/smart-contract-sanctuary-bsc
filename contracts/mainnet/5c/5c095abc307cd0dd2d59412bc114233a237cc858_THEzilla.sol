...
contract THEzilla is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "THEzilla";
  string private _symbol = "THEzilla";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x686C961373ffBEd7083c69D1205708329F63638C);
  address payable public teamWallet = payable(0x686C961373ffBEd7083c69D1205708329F63638C);
