...
contract NewpolitonDog  is Context, IERC20, Ownable {

    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewpolitonDog";
    string private _symbol = "NewpolitonDog";
    uint8  private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x292341B3bF95d9fddE129c754460f6819b6258Ba
); 
