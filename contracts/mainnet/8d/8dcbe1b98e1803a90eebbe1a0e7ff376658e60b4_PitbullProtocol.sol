...
/**
Telegram : https://t.me/PitbullProtocol
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa143cF78B2580628F87E48B120CC65d78F646cBf; // owner address
...
contract PitbullProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pitbull Protocol";
    string private _symbol = "PIPRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa143cF78B2580628F87E48B120CC65d78F646cBf); // Marketing Address
    address payable public teamWalletAddress = payable(0xa143cF78B2580628F87E48B120CC65d78F646cBf); // Team Address
