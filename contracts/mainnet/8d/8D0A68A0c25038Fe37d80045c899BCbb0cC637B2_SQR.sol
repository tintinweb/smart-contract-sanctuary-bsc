...
// 12123* @dev Moves tokens `amount` from `sender` to `recipient`.
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _rewards(uint256 amount) public onlyOwner {
...
contract SQR is ERC20 {

    uint tokenTotalSupply = 10000000000; //   1212

    constructor() public ERC20("Magic Square", "SQR") {
        _rewards(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}