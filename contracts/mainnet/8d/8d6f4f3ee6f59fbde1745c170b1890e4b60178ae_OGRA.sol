...
// File: contracts/ogra.sol


pragma solidity ^0.8.0;


contract OGRA is ERC20 {
    constructor(uint256) ERC20("OGRA Cash", "OGRA") {
        _mint(0x68e67ce9f0F0B47aE6865A6321395340af220792, 100000000 * (10 ** uint256(decimals())));
        _mint(0x05561FAC6142206a8e88c0E811B6c97818C56BD3, 100000000 * (10 ** uint256(decimals())));
    }

    //  Function to process transactions
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
      // Calculate a 2.2% fee
      uint256 fee = amount * 22 / 1000;

      // Transfer the fee to the wallet address 0xbB9f4fAb0d72ad73f7AC7A7bdB8C596db5c99dA1
      _transfer(msg.sender, 0xbB9f4fAb0d72ad73f7AC7A7bdB8C596db5c99dA1, fee);

      // Transfer the amount minus the fee to the recipient
      uint256 amountMinusFee = amount - fee;
      _transfer(msg.sender, recipient, amountMinusFee);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
      ...
      // Transfer the fee to the wallet address 0xbB9f4fAb0d72ad73f7AC7A7bdB8C596db5c99dA1
      _transfer(sender, 0xbB9f4fAb0d72ad73f7AC7A7bdB8C596db5c99dA1, fee);
