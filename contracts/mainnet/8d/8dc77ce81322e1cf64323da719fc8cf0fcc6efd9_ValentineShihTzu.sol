...
contract ValentineShihTzu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ValentineShihTzu";
    string private _symbol = "VST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71655E98f8d8216796055f213D94bcd7443A6980); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x71655E98f8d8216796055f213D94bcd7443A6980); // BuyBack Address
