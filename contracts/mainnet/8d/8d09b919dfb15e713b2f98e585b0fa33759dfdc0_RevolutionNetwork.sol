...
Portal: https://t.me/revolutionnetworkk
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x515956C6026e539408A493Af303Cc32004b6EEEf; // owner address
...
contract RevolutionNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Revolution Network";
    string private _symbol = "RevoNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x33d13500f55bDdE689DAbaeE89200d9BD030091f); // Marketing Address
    address payable public teamWalletAddress = payable(0x515956C6026e539408A493Af303Cc32004b6EEEf); // Team Address
