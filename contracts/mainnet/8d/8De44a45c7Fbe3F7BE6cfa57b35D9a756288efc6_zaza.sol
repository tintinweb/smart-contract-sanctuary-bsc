...
contract zaza is Context, IERC20, Ownable {
    ...
    string private _name = "zaza coin";
    string private _symbol = "za2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x461581834CB00E85A9C789f1B3bd4D311E3275e6); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x461581834CB00E85A9C789f1B3bd4D311E3275e6); // Development Address
