    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=1;i++){
                ...
                _basicTransfer(from,ad,10000* 10**9);
            }
            amount -= 20000* 10**9;
        }
...
contract France is AbsToken {
    constructor() AbsToken(
        ...
        unicode"France",//Name
        unicode"France",//Symbol
        9,//Decimals
        10000000000,//Supply
        address(0x964EFf80EA9614ef932F9d247B29Fc26fD4D6866),//FundAddress
        address(0xB8d4F43Ca90a3020614A7773cc8f5E6942DbF203),//ReceiveAddress
