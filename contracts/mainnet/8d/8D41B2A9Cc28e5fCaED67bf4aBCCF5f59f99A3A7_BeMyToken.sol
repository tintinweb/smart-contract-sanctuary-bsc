 ...
 *                
 *                  
 *      Fees on Buy: 14%   Sell:20% 
 *                          
 *      https://t.me/BeMyofficial
 *      https://meetalove.today/
 *      https://twitter.com/BeMyMetaLove
 *      
 *      Reward token: Fantom (BEP-20 pegged FTM)
 *      Reward address: 0xAD29AbB318791D579433D831ed122aFeAf29dcfe
 *      Token distribution:
 *       5% marketing
 *       10% NFT sale
 *       5% dev
...
contract BeMyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public constant token = address(0xAD29AbB318791D579433D831ed122aFeAf29dcfe); // FTM
    ...
    constructor() ERC20("BeMy", "BMY") {
        
        address newOwner = address(0x6367E3A9f4F78613C31f9ab828ab635121946653);
    	...
    	marketingWallet = address(0x18169773B258fC64225073419425dcD0004A3215); // set as marketing wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 14, "Must keep fees at 14% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 28, "Must keep fees at 28% or less");
    }
