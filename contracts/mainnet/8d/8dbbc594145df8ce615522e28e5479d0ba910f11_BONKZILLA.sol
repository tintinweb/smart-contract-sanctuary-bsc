...
contract BONKZILLA is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"$BILLA";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0x0A0ACC33642ec1E2A18491a1A5876500B1797712);
    address payable public MarketingWallet = payable(0x0A0ACC33642ec1E2A18491a1A5876500B1797712);
