...
Portal: https://t.me/SchrodingersCatInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD59b24b6046b49AD618cd1C93cC82EbA54E63eCe; // owner address
...
contract SCHRODINGERSCATINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCHRODINGERS CAT INU";
    string private _symbol = "$SCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6A869CD47642D763AD3630E74af6ECe4FD380d2f); // Marketing Address
    address payable public teamWalletAddress = payable(0xD59b24b6046b49AD618cd1C93cC82EbA54E63eCe); // Team Address
