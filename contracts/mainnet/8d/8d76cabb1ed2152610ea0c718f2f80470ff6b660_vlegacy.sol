...
contract vlegacy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VIRTUAL LEGACY";
    string private _symbol = "VLEGACY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x240160E1A338eE81dBB883f6E008c10Af2B98Bd6); // Marketing Address
    address payable public BuyBackWalletAddress = payable (0x240160E1A338eE81dBB883f6E008c10Af2B98Bd6); // BuyBack Address
