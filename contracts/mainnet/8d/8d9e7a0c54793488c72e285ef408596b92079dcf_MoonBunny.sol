...
Welcome To MoonBunny $BUNNY  HOLD $BUNNY and Earn BTC Rewards TG https://t.me/moonbunnybsc
...
contract MoonBunny is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonBunny";
    string constant _symbol = "$BUNNY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 888 * 10**12 * 10**_decimals;
