...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Transfers ownership of the contract to a new account (`newRatGoldOwner`).
...
contract RatGold_TOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "RatGold";
    string private constant _symbol = "$RatG";
