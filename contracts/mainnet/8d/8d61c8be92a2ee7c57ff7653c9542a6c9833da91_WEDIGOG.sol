...
contract WEDIGOG is Context, IERC20 {
    ...
    string private _name = "Wednesday Go";
    string private _symbol = "WEDIGOG";
    ...
    constructor (address _abb)  {
        ...
        Wallet_Marketing = payable(0xD2e548edb3B0e15866BE3705Fe18DaA6151952D1);
        abb = BHT(_abb);
