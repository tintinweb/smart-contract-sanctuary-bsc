...
// TG :https://t.me/fifaqatar1  Tax : 8/8 ,  CA will be Renounced .    
...
contract  FifaQatar is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa Qatar";
    string private _symbol = "$FIQA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5061B6275667504D2F5fDd2A90f21C58CA9fe52e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5061B6275667504D2F5fDd2A90f21C58CA9fe52e); // BuyBack Address
