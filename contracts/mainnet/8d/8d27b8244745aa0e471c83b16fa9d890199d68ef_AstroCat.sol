...
// File: contracts/interfaces/IAstroCat.sol
...
contract AstroCat is ERC20, Ownable {
    ...
    uint256 constant TOTAL_SUPPLY = 1_000_000_000_000 * BASE; // 1 Trillion Supply
    ...
    uint256 public maxTx = TOTAL_SUPPLY;
    function setMaxTx(uint256 maxTx_) external onlyOwner {maxTx = maxTx_;}
    
    uint256 public maxBalance = TOTAL_SUPPLY;
    ...
    constructor(
        ...
        // set Distributor
        hodlRewardDistributor = new HODLRewardsDistributor(wbnb_);


        hodlRewardDistributor.excludeFromRewards(wbnbPair);
        hodlRewardDistributor.excludeFromRewards(swapRouter_);
        hodlRewardDistributor.excludeFromRewards(autoLP_);
        hodlRewardDistributor.excludeFromRewards(marketing_);
