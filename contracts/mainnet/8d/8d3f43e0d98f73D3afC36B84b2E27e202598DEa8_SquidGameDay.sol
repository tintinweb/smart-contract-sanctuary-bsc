...
contract SquidGameDay is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5900 * 10**15 * 10**15;
    ...
    string private constant _name ="Squid Game Day";
    string private constant _symbol = "Squid Game Day";
    uint8 private constant _decimals = 0;
    mapping (address => bool) private _isSniper;
    address payable private _marketingAddress = payable(0x81F9AaBf5cFEF6E06d4B1cEa52E00f844Aa8F57A);
    address payable private _marketingAddress2 = payable(0xA941d2578946aa616fB7e0067E53A34EeDDd24ED);
