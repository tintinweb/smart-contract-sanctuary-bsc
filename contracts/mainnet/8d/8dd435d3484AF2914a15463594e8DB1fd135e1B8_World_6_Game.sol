...
contract World_6_Game is Authorized, ERC20 {
  ...
  // Fees
  uint256 public feeDevelopmentWallet = 700; // 7%
  uint256 public feeStakePool1 = 200; // 2%
  ...
  function setfeeDevelopmentWallet(uint256 _taxa) public onlyOwner {
    require(_taxa<700,"Rates must be below 7%");
    feeDevelopmentWallet = _taxa;
  }

  function setfeeStakePool1(uint256 _taxa) public onlyOwner {
    require(_taxa<200,"Rates must be below 2%");
    feeStakePool1 = _taxa;
  }
  // Special Wallets
  ...
  function setnft_address(address account) public onlyOwner {nft_address = account;}
  ...
  constructor()ERC20(_name, _symbol) {
    ...
    nft_address = 0x24297E6501E31E547a45AF8244bFC3Bfb37c69c5;

    exemptFee[developingWallet] = true;
    exemptFee[stakeAddress1] = true;
    exemptFee[nft_address] = true;
