...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBe901c0B7581f21FA187f6eE01Ca5daCc7480ed1; // owner address
...
contract RABBITBOY is Context, IERC20, Ownable {
    ...
    string private _symbol = "$RABBIT BOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBe901c0B7581f21FA187f6eE01Ca5daCc7480ed1); // Marketing Address
    address payable public teamWalletAddress = payable(0xBe901c0B7581f21FA187f6eE01Ca5daCc7480ed1); // Team Address
