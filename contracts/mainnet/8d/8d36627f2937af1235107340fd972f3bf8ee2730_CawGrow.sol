...
/**
       Telegram : https://t.me/cawgrow

*/

// SPDX-License-Identifier: UNLICENSED

// Community Low tax token with the hype of caw
...
contract CawGrow is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Caw Grow";
    string  _symbol = "$CAWGROW";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 666 * 10**12 * 10**_decimals;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x831ab610035843d3D6Df6c7Bf9474841D0E199F4;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0x0F48FF9A1925FF96d9154051C005082264Ef3De1;
