...
📢Announcement   - @BBBannounce
🤖Portal         - @BiggestBuyTechBSC
🐦Twitter        - BBB_Tech
🔗Website        - www.biggestbuy.tech
...
contract  BiggestBuyBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BiggestBuyBot";
    string private _symbol = "BBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE2D4a2bA065084D8164067d1F9e9E2149611a6c1);
    address payable public teamWalletAddress = payable(0x355C4F26Ed6441587b9b5ad0Cb1dD439E0cF12ca); 
    ...
    uint256 public _walletMax =    90000000000 * 10**_decimals;
