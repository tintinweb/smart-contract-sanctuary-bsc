...
// https://www.thekrakencoin.net

// https://t.me/BabyKrakensBsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeD321657f698D71fE66964BD06BD761D48F5Eed8;
...
contract BabyKrakens is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x88Ae5Fc27bd1825794D0F6C374C974146169a8e8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Krakens";
    string private _symbol = "BabyKrakens";
