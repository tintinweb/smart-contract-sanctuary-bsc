...
contract publis is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "COVIDSHIB";
    string private _symbol = "COVIDSHIB";
    ...
    uint256 private _totalSupply = 20220000 * 10**_decimals;
    uint256 public _maxTxAmount = 20220000 * 10**_decimals; 
    uint256 public _walletMax = 20220000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd1DD55fac4636B72be5CCA905EFe0850eFeaDC69));
        marketingWalletAddress = payable(address(0x110CE14cEa2E87d6a65c71634eEBe4Bb5aA8c237));
