...
// https://twitter.com/animateinfo
// SPDX-License-Identifier: MIT

pragma solidity ^0.8.17;

interface Anime2023Official {
...
contract Anime2023OfficialToken is Anime2023Official {
    ...
    string public override name = unicode"缶バッジ";
    string public override symbol = unicode"缶バッジ";
