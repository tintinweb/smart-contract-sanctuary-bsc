...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xe4B4Fab1A944C8Dd7C43cf6f848c4692B16B867A;//fund address
...
contract LaFiDao is Token {
    constructor() Token(
        ...
        address(0x123eDb0213D2D2E8349E099f169b58a4E3bAD92b),//fund address
    
        address(0xf41061EBE20908BA1A7F1D87aa816dbC27d99518)//dev address
    ){
