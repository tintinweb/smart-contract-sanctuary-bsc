...
contract BoxingInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BoxingInu";
    string private _symbol = "BI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x867158Eab37a40468c4e6c87cB1eABA56b88e501); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x31FfbcFd0E0Bccf31C3F3d2Ce6d789ac250F0bB1); // BuyBack Address
