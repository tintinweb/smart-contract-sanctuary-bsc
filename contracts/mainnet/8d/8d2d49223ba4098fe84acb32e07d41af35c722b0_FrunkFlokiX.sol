...
Safu 100%, LP will be lock a year,
Trusted Dev, Dev is going to video dox on Telegram, active community and team,
Strong marketing incoming! Join US

Website  : https://www.frunkflokix.com
Telegram : https://t.me/frunkflokix
Twitter  : https://twitter.com/frunkflokix
...
contract FrunkFlokiX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FrunkFlokiX";
    string constant _symbol = "FFLOKIX";
    ...
    uint256 liquidityFee = 200; // 2% for liquiditypool
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0;
    uint256 marketingFee = 400; // 4% for marketingwallet
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x171b8D2A2a82CB223Ea8da1c06A8AbaEe9720eB1;
