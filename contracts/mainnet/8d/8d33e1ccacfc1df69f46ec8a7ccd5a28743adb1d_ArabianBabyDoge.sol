...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x5cB7e2dC122b33c7b191799ca7E23d5b4A15fBD0); //the reward token you want distributed 
...
contract ArabianBabyDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x5cB7e2dC122b33c7b191799ca7E23d5b4A15fBD0; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ArabianBabyDoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "ABDOGE";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100;  // 3 is the percentage of max wallet. if you want smaller or bigger max wallets just adjust. 
