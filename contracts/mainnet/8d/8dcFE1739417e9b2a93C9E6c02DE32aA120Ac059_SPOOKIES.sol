...
contract SPOOKIES is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory name, string memory symbol, string memory baseTokenURI) ERC721(name, symbol) {
      ...
      // Save dev wallet
        wallet1 = 0x7d85b649E016f0A9e7A85a08c00aF114D6C45c9d;
        wallet2 = 0x6a7Ea0Fc3ECfaa9552fA61F5c77543c0A84aC015;
        wallet3 = 0x6a5262aD0Ed89D2e4074Ed006c0A42eAc81a6577;
        wallet4 = 0xe32952D2ed11cac9a70cDe455d35e8Dd25ed0Fba;
        wallet5 = 0x1057a936a87cb28674956a62C43C546998912323;
        wallet6 = 0xfF33DF742269A75122827Dad2cAFC7806A253445;
  ...
  function mint(uint256 _mintAmount) public payable {
    // Checks
    require(!paused, "SPOOKIES: minting has not started yet");
    require(_mintAmount > 0, "SPOOKIES: you have to mint at least one");
    require(_mintAmount <= maxMintAmount,  "SPOOKIES: you can only mint 10 at a time");
    require(lastSupply >= _mintAmount,  "SPOOKIES: the collection is sold out");
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "SPOOKIES: total cost isn't match");
    }
    // Minting
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    // Checks
    require(_winner != address(0), "SPOOKIES: zero address");
    require(_amount > 0, "SPOOKIES: you have to mint at least one");
    require(lastSupply != 0,  "SPOOKIES: the collection is sold out");
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory){
    require(_exists(_id),"SPOOKIES: URI query for nonexistent token");
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 wallet2Share = _amount.mul(5).div(100);
      uint256 wallet3Share = _amount.mul(7).div(100);
      uint256 wallet4Share = _amount.mul(15).div(100);
      uint256 wallet5Share = _amount.mul(5).div(100);
