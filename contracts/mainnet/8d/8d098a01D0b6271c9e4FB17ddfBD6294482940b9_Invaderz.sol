...
contract Invaderz is Ownable, ERC721, ERC721Enumerable {
    ...
    uint private _mintSharesReflect = 250;
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xE3Af2fb66c545b77BFD7Bfc10F5FaE3fEbdEeFC4).transfer((p*33)/100);
        payable(0x9032D542eCf4DB9Cc2c62178753c0248332aC79a).transfer((p*33)/100);
        payable(0xBCEbBd7351293C08E971bFd9200CFC668CA0d3f5).transfer((p*5)/100);
        payable(0xB2f9701c886439501f9695d6c98A9aE8d08C6a5f).transfer((p*4)/100);
        _balanceTeam = 0;
    }
