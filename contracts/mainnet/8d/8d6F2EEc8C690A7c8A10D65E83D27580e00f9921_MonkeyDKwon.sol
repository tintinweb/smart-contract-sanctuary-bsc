...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB28628d62587cA195817860b2714A993a590aaCd; // owner address
...
contract MonkeyDKwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkey D Kwon";
    string private _symbol = unicode"mdKNOW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2798B02eBaE520eaEa6ac0BDb23A543ADE2b4Ac4); // Marketing Address
    address payable public teamWalletAddress = payable(0x2798B02eBaE520eaEa6ac0BDb23A543ADE2b4Ac4); // Team Address
