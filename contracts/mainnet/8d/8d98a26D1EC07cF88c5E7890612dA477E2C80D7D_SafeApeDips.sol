...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2BaB4F76B9ceA68900b6b3ECb5D41bC4804A2EbB; // owner address
...
contract SafeApeDips is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafeApeDips";
    string private _symbol = "SafeApeDips";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x96Be3C64C0d576DBf56ce1e1dfec3476298D252C); // Marketing Address
    address payable public teamWalletAddress = payable(0x96Be3C64C0d576DBf56ce1e1dfec3476298D252C); // Team Address
    ...
    uint256 public _teamShare = 3; // original 2

    uint256 public _totalTaxIfBuying = 6;  // original 10
    uint256 public _totalTaxIfSelling = 8;  // original 10
