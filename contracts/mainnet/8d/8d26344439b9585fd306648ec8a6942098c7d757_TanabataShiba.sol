...
contract TanabataShiba is Context, IERC20, Ownable {
    ...
    string private _name = "TanabataShiba";
    string private _symbol ="TanabataShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8443a8D2bc9dD933010b274259E3dFd3eE1410DA);
    address payable public teamWalletAddress = payable(0x8443a8D2bc9dD933010b274259E3dFd3eE1410DA);
