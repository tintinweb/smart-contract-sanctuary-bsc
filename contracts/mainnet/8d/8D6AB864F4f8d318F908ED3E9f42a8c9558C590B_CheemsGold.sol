...
abstract contract Auth {
    ...
    address BuyBackWallet = 0x101d94C89287967db593cBc7835dC08EA60c215c;
...
contract CheemsGold is BEP20, Auth {
    ...
    string public constant name = "Cheems Gold";
    ...
    uint256 public swapThreshold = totalSupply / 2500;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf1980007Db07b2B72895F5c38E3187Cc6860edee;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0xf1980007Db07b2B72895F5c38E3187Cc6860edee;
        devFeeReceiver = 0xf1980007Db07b2B72895F5c38E3187Cc6860edee;
