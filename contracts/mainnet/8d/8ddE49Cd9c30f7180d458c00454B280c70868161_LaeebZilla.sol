...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        string memory Name, string memory Symbol, uint8 Decimals, uint256 _supply,
        uint256 LPFee, uint256 DividendFee,
    ...
    function _transfer(
        ...
        if (from == mainPair || to == mainPair) {
            if (0 == startTradeBlock) {
                require(_feeWhiteList[from] || _feeWhiteList[to], "!Trade");
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                uint256 numTokensSellToFund = amount / 30;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        swapTokensForETH(halfAmount);
        uint256 newBalance = address(this).balance - initialBalance;
        addLiquidityETH(halfAmount, newBalance);
    }
...
contract LaeebZilla is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        "LaeebZillacoin",
        "LaeebZilla",
        0,
        6900000000000000 * 10 ** 8,
        1,
        1,
        address(0xfB4121CF43d4999329E16407fF20706772983F08),
        address(0xB73640F0349aAAfd58731BC3724928979Ac0899D)
    ){
