...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8E9f8cDf43696Cb1c23E4e3d2B64c87c641087B4; // owner address
...
contract MarioMusk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mario Musk";
    string private _symbol = "MMK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8E9f8cDf43696Cb1c23E4e3d2B64c87c641087B4); // Marketing Address
    address payable public teamWalletAddress = payable(0x8E9f8cDf43696Cb1c23E4e3d2B64c87c641087B4); // Team Address
