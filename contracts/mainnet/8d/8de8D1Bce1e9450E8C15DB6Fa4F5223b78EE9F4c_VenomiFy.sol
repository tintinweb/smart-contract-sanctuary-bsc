...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x189c3A283AfD8A18C3F0496BE040af27Cf022251;
...
contract VenomiFy is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8d6763cFCF143E10E47a9dFa514E778bF11D138B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 69000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VenomiFy";
    string private _symbol = "VNMF";
    ...
    uint256 private numTokensSellToAddToLiquidity = 69000000 * 10**18;
