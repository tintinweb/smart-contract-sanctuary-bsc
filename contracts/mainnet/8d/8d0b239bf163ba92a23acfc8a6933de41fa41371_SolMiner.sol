...
contract SolMiner is BEP20, Auth {
    ...
    string public constant name = "solminer";
    string public constant symbol = "solminer";
    ...
    uint256 public swapThreshold = totalSupply / 7000;
