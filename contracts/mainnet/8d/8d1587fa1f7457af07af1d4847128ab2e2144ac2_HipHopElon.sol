...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A66068BCD9bAe8c871A3A397C0584536F014551; // owner address
...
contract HipHopElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HipHopElon";
    string private _symbol = "HHE";
