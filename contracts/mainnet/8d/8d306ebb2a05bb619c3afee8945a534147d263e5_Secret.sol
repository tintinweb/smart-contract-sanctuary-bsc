...
contract Secret is Context, IERC20, Ownable {
    ...
    string private constant _name = "Secret Ecosystem";
    string private constant _symbol = "Secret";

    address public _PancakeSwapV1RouterUniswap = 0x762aBCD255287b6C91D34a86e7be08D939fbdABa; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x762aBCD255287b6C91D34a86e7be08D939fbdABa; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x762aBCD255287b6C91D34a86e7be08D939fbdABa)] = true; //uniswap router liquidity
