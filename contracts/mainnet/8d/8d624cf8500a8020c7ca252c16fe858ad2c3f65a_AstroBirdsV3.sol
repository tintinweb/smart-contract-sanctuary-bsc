...
contract AstroBirdsV3 is AstroBirdsV2{
      mapping (address => bool) public isBlacklisted;
         bool public coolDownEnabled;
     uint256 public coolDownTime;
     mapping(address => uint256) private _lastSell;
function initialize() public initializer {
AstroBirdsV2.initialize(
    "AstroBirdz",
    "ABZ",
    payable(0x29A25D6E75013d05609c83596d7Daa3d573b0C0c),
    payable(0x34ED0F528ee4A23296b3B1e38DE7AA2A55b85B0F),
    0x6e70194F3A2D1D0a917C2575B7e33cF710718a17,
    0x50056881B16887501534c994d6A2c9Fee7677662,
