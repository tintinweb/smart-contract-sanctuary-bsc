...
contract Rouletto is Ownable {
    ...
    address public _houseFeeReceiver = address(0x8F0Cd750ec151337C8A1E996fF877Addd1a1a7af);
    uint8 public _houseFeePercentage = 40; // In 0.1% increments

    address public _devFeeReceiver = address(0x6859a0BfEf2E063475501C9E00Fc5221b0940b42);
