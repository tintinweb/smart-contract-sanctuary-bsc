...
contract  Giant is ERC20 {
   ...
   bool public swapping;
    ...
    address public market = 0xC477BEE06F78Cae331d0601a9d92Bef64d4EC47d;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 5*10**4 * 10**9;
    ...
    constructor() public ERC20("Dora Giant", "Giant",9) {
        ...
        _balances[owner()] = (1*10**7) * (10**9);
          emit Transfer(address(0), owner(), (1*10**7) * (10**9));
    }
