...
contract LFGdoge is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "LFGdoge";
    string private _symbol = "LFGdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAaD1f1cC7bf07b69a0faa9EE76fDDc903B6992D0);
