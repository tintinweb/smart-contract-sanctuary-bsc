...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x964ED7dEFBF6a498AB2326B27ccA4db37fEC124C; // owner address
...
contract ShishimaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shishimaru Inu";
    string private _symbol = "SHINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x964ED7dEFBF6a498AB2326B27ccA4db37fEC124C); 
    address payable public teamWalletAddress = payable(0x964ED7dEFBF6a498AB2326B27ccA4db37fEC124C); 
