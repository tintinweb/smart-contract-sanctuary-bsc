...
contract SINUCommonNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_SUPPLY = 321;
    uint256 public MAX_TX_MINT = 10;
    uint256 public PRICE_PER_MINT = 0.1 ether;

    // Users could hold specific number of tokens in order to be eligibles for discounts
    IERC20 public token = IERC20(0x5Efe9c3e5b43580328104Da18A091cE6a3D40651);
    HolderDiscount[] public holdDiscounts;
    bool public holdDiscountsEnabled = true;
    ...
    constructor() ERC721("SINU NFT", "SINUNFT") {
        // Discounts for holding tokens
        holdDiscounts.push(HolderDiscount(2500, 5));
        holdDiscounts.push(HolderDiscount(5000, 10));
        holdDiscounts.push(HolderDiscount(10000, 20));
    }
    ...
    */
    ...
    function getMintPriceByAddress(address _address) public view returns (uint256 price) {
        uint256 discount = getEligibleDiscount(_address);
        if(discount > 0 && holdDiscountsEnabled) {
