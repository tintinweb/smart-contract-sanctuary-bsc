...
contract NanoSquidGamev2 is Context, IERC20, Ownable {
    ...
    string private _name = "NanoSquidGame 2.0";
    string private _symbol = "NanoSquidGame2.0";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xc84f9E0846EADa05eC7643d8ac33Ce40Ac9b3B0E);
