...
contract bruceinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bruce Inu"; // 
    string private constant _symbol = "$BINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x526fC51d4E5D12Bfb48dfa4b309f4956BFa217e1;
