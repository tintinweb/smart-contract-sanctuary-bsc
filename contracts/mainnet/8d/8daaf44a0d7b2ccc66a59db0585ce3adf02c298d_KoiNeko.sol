...
/**
    ...
    We are a community-based token inspired by the anime series based on NekoKoi shounen manga.  
    The series is an adaptation of the best Romance and Comedy on Manga,one of the most popular mangas in the world today.

// https://t.me/KoiNekoBSC
*/
...
contract KoiNeko is Context, IERC20, Ownable {
    ...
    string private constant _name = "Koi Neko";
    string private constant _symbol = "$KOINEKO ";
    ...
    address private marketingWallet = address(0xD861d260D32155599236Dc2506B5d5C1dC1da9dF);
    address private liquidityReceiver = address(0xD861d260D32155599236Dc2506B5d5C1dC1da9dF);
