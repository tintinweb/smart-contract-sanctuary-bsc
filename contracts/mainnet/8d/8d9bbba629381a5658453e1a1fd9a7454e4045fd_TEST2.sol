    ...
    Freezable
{
    ...
    string constant private _symbol = "TEST2";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "TEST2/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "TEST2/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "TEST2/approve : Should not approve zero address"
        );
