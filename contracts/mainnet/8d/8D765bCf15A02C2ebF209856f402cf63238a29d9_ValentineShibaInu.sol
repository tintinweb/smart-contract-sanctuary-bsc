...
contract ValentineShibaInu is Ownable, IERC20 {
    ...
    string private _name = "Valentine Shiba Inu";
    string private _symbol = "$VSI";
    ...
    uint256 public _maxWallet = 1000 * 10 ** _decimals;
