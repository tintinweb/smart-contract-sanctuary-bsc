...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (block.number < TradingBlock + kb && !_swapPairList[to]) {
                    if (!_blackList[to]) _blackList[to] = true;
                }
    ...
    function openTrade(uint256 killBlock) external onlyOwner {
        require(0 == TradingBlock, "trading");
...
contract LUNCBURN is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//PancakeSwap RouterAddress
        address(0x55d398326f99059fF775485246999027B3197955),//USDTAddress
        "LUNCBURN",//Name
        "LUNCBURN",//Symbol
        9,//Decimals
        10000000,//Supply
        address(0x0D93F6401Dd62237310071e8F9380F1bDFe94c1E)//FundAddress
        ){
    }
}