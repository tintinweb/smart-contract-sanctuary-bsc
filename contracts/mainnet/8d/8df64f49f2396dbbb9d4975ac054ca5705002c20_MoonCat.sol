...
contract MoonCat is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MoonCat";
    string constant _symbol = "MOONCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x866a9889BCEBD2A323dAF9a74020cC838d52eEDb;
