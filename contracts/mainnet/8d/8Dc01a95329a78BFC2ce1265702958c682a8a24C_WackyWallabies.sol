...
contract WackyWallabies is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    event CreateWackyWallabies(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("Wacky Wallabies", "WackyWallabies") {
        setBaseURI(baseURI);
        pause(true);
    }
