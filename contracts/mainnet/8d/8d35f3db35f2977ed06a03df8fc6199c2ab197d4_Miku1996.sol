...
Telegram : https://t.me/miku1996bsc
*/
...
contract Miku1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Miku 1996";
    string private _symbol = "$MIKU96";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x681DC9E583dade53294F787fb3028933AD04a96f); // Marketing Address
    address payable public teamWalletAddress = payable(0x681DC9E583dade53294F787fb3028933AD04a96f); // Team Address
