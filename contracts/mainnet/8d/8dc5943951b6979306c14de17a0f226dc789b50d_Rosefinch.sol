...
contract Rosefinch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x72C4E90AD7729074681EFD2ba1A05A25a87d567E); // Marketing Address
    ...
    string private _symbol = "Rosefinch";
