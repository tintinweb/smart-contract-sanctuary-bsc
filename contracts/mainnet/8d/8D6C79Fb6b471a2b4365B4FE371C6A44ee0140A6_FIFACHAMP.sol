...
8% Buy/Sell Taxes in Total 

Maximum Buy/Sell Taxes Capped at 20%

FIFA 2022 CHAMPION SOCIALS
Telegram: https://t.me/Fifa2022champion
Website: http://fifachamp.tech/
...
contract FIFACHAMP is Context, IERC20, Ownable {
    ...
    string private _name = "FIFACHAMP";
    string private _symbol = "$CHAMP";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x94953E43DC6EAE2918D4ee60c8B96d287eed6151);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 5 * 10**4 * 10**_decimals;
        _maxBalance = 10 * 10**6 * 10**_decimals;
