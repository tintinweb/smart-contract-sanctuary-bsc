...
contract SaudiHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Hare";
    string private _symbol = "SHARE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfD306BFf16A4826cce41F09AfC26e458565a0Da9);
    address payable public BuyBackWalletAddress = payable(0xfD306BFf16A4826cce41F09AfC26e458565a0Da9);
