...
contract PumpMeDaddy is Context, IERC20 { 
    ...
    string private constant _name = "PUMP ME DADDY"; 
    string private constant _symbol = unicode"PumpMeDaddy"; 
