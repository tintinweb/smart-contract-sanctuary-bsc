...
library Address{
 ...
 contract SquidDiamond is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x45E2ACC9770501aDB5100410638628082508655b;
    address public donationWallet = 0x45E2ACC9770501aDB5100410638628082508655b;

    string private constant _name = "Squid Diamond";
    string private constant _symbol = "Squid Diamond";
