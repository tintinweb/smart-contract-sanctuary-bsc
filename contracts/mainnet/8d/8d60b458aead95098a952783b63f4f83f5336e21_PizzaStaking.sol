...
contract PizzaStaking is Ownable {
    ...
    function withdraw() external {
        ...
        if (whiteList[msg.sender]) {
            ...
            player.total_invested += SafeMath.div(amount, 500); // CAMBIO RECIENTE

            BUSD.safeTransfer(msg.sender, SafeMath.div (amount, 500)); // CAMBIO RECIENTE
            /*BUSD.safeTransfer(msg.sender, amount);*/
            
            emit Withdraw(msg.sender, SafeMath.div (amount, 500)); // CAMBIO RECIENTE
