...
/**
 ...
 Telegram https://t.me/bitstakeBSC
 Website https://bitstake.homes/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8aD728365800f27B5f855682BF8e888bD2e0DFBb;
...
contract BitStake is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x8aD728365800f27B5f855682BF8e888bD2e0DFBb);
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Holding(uint256 maxWallPercent_x100) external onlyOwner() {
