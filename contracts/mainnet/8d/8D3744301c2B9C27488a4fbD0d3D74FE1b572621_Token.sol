...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, address diamond_,uint256 totalsupply_) {
        ...
        _symbol = symbol_;
        _diamond = diamond_;
        _mint(msg.sender,totalsupply_.sub(totalsupply_.div(10).mul(4).add(totalsupply_.div(10))));
        _mint(0x000000000000000000000000000000000000dEaD,totalsupply_.div(10));
        _mint(0x0C89C0407775dd89b12918B9c0aa42Bf96518820,totalsupply_.div(10).mul(2));
        _mint(0x0D0707963952f2fBA59dD06f2b425ace40b492Fe,totalsupply_.div(10).mul(2));
    }
