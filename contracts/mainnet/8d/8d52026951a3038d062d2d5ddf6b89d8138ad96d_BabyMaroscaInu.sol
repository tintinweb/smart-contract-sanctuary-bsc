...
contract BabyMaroscaInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Marosca Inu";
    string constant _symbol = "$BBYMAROSCA";
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet = 0x5F45CF313D2f5BC190dF9C20Ee8d5b41426F1121;  // team
