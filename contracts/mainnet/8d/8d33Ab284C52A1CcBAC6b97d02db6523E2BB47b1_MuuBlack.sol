...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3d79bf2B5FFb439906C63f4740dFFB44dE7531fc;
...
contract MuuBlack is Context, IERC20, Ownable {
    ...
    string private constant _name = "Muu Black"; // 
    string private constant _symbol = "MuuBlack"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xBBdAAF6dEDc0d0D9725b43524d42D92fF514F9d8);
