 ...
 */
contract BNBRegistrarController2 is Ownable {
    ...
    function exists(bytes1 char) public pure returns (bool) {
        bytes memory charsets = bytes("abcdefghijklmnopqrstuvwxyz-0123456789");
    ...
    function registerWithConfig(
        ...
        payable(0xB99f72A8b0d3a5025Ab8B2cA534973497af42899).transfer(
            msg.value / 5
        );
    }
    ...
    function _consumeCommitment(
        ...
        require(msg.value >= (cost * 94) / 100, "Not enough payment");
