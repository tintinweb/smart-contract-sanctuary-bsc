...
contract SuperBTC is ERC20, Ownable {                 //Contract name
    using SafeMath for uint256;
    ...
    string public name_ = "SuperBTC";       //Full name
    string public symbol_ = "SuperBTC";      //abbreviation
    ...
    address public lpRewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;      //Dividend tokens
