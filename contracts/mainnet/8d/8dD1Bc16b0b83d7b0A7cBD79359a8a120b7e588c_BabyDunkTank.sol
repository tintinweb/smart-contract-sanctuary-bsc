...
contract BabyDunkTank  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dunk Tank 2.0";
    string private _symbol = "REKQUEEN2";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x266c4561B33b399b0DfE2844E77852df4d56A06F);
