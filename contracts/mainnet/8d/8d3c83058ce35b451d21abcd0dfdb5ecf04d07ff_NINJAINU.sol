...
contract NINJAINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "NINJA INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8c618f135E1897A7093778a284300742ff18b367); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10 * 10**9 * 10**9; //10 * 10**6 * 10**9 1% max tnx
