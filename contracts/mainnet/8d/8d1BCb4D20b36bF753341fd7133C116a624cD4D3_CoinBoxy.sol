...
contract Operator {
    ...
    modifier onlyOperator() {
        require(msg.sender == operator, 'CoinBoxy: operator error');
        _;
    }
...
contract CoinBoxy is ERC721A, Ownable, Operator {
    ...
    function mintByContract(uint16 _num, address recipient) public onlyOperator{
        require(totalSupply() + _num <= maxTotal,"Exceeds maximum supply");
        _safeMint(recipient, _num);
    }
