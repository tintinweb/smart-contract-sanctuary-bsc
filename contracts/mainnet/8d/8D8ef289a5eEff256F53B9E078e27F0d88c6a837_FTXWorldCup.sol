...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82C4D253FaCE24e5352BF09Dd65749fAB31F502a; // owner address
...
contract FTXWorldCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX World Cup";
    string private _symbol = "FTXWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeb9fD5B30D4E1f33FFFfF3fb4B298B42c7b14af9); // Marketing Address
    address payable public teamWalletAddress = payable(0x9a26Fcef935E98A6cac186D887db21Eaf1cE1815); // Team Address
    ...
    uint256 public _teamShare = 4; // original 2
