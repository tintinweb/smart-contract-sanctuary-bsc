...
contract GoldHitomi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldHitomi";
    string private _symbol = "GH";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0x2BFF550B91ddE3A157aA4D817d221086B3A21b42); 
