...
contract f1f4worldcat is Context, IERC20, Ownable {
    ...
    string private constant _name = "f1f4Worldcat"; // 
    string private constant _symbol = "$f1f4worldcat"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xc2e5e1e9534bd35bb07720D3E6F5272758a0288A;
