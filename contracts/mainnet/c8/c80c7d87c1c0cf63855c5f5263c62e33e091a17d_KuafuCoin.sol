...
contract KuafuCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kuafu";
    string private constant _symbol = "KF";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xAFa45942f791986862Af5E4e4Eb06F73a35C36AE);
    address payable private _marketingAddress = payable(0x97E6Ddb779CD7f3dC271f9adb57C58F5be3D2544);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 21, "Tax cannot be more than 21.");
