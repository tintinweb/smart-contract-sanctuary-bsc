...
contract RATSQUID is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1_500 * 10**18;
    ...
    address public marketingWallet = 0x138b721814271E8B18FB8447820db48c5A4104d6;
    ...
    Taxes public taxes = Taxes(6, 2, 2);
    ...
    constructor(address routerAdd) ERC20("Rat Squid", "RSQUID") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        TotalBuyFee = _marketing + _liquidity + _dev;
    ...
    function SetSellTaxes(
        ...
        TotalSellFee = _marketing + _liquidity + _dev;
