...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = "PotongBEBEKANGSA";
    string private _symbol = "Potong";
    ...
    address public devWallet = 0xd86Aa64A7004B0715542D9eF6eBD78D9c7cefB70; //1% for marketing ,1% for giveaways
    ...
    uint256 public _maxTxAmount = 5000 * 10**3 * 10**9; //0.5% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2154 * 10**3 * 10**9;
    uint256 public _maxWalletToken = 10000 * 10**3 * 10**9;
