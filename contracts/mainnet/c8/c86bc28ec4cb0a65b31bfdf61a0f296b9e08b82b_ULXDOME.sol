...
ULXDOME
@ULXDOME_io
ULXDOME is creating the most hyper-realistic #metaverse.
 Bringing brands and users together in a digital-life meets real-world experience. 
 http://t.me/ULXDOME
Technology CompanyMetaverse
ULXDOME.io
*/
...
contract ULXDOME is ULXDOMEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private ULXDOMETeam;
    address private CharityULXDOME;
    ...
    string public override name = "ULX DOME";
    string public override symbol = "ULX DOME";
    ...
    constructor(uint totalSupplyValue, address ULXDOMETeamAddress, address CharityULXDOMEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ULXDOMETeam = ULXDOMETeamAddress;
        CharityULXDOME = CharityULXDOMEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ULXDOMETeam] =  totalSupply * 5 / 100;
        balances[CharityULXDOME] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's ULXDOMETeam pot
