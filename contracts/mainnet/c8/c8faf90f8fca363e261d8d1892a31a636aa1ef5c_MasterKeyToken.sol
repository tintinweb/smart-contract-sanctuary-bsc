...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        platformAddress[address(0xcBCB895Bd0967B1fe48221a43E856217bB0977f8)] = true;//Flex
    }
...
*/
    ...
    constructor() ERC20Detailed("MasterKey Finance", "MKF", uint8(DECIMALS)) Ownable() {
        ...
        setMarketDividend(0xcBCB895Bd0967B1fe48221a43E856217bB0977f8); //Flex Contract
        canTransferBeforeTradingIsEnabled[address(0xcBCB895Bd0967B1fe48221a43E856217bB0977f8)] = true;  
