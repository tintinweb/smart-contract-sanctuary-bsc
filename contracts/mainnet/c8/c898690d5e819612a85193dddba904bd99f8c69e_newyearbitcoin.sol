...
/**
Telegram : https://t.me/newyearbitcoinn
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02493b8a619Fa3E7A83A94C307BBC9252b48a52d; // owner address
...
contract newyearbitcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Year Bitcoin";
    string private _symbol = "NYBITCOIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02493b8a619Fa3E7A83A94C307BBC9252b48a52d); // Marketing Address
    address payable public teamWalletAddress = payable(0x02493b8a619Fa3E7A83A94C307BBC9252b48a52d); // Team Address
