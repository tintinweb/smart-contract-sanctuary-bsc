...
contract Aerodactyl is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aerodactyl";
    string private _symbol = "Aerodactyl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5a432E3BbEc08168092f5fBBe496998518e4B420); 
    address payable public buyBackWalletAddress = payable(0x5a432E3BbEc08168092f5fBBe496998518e4B420); 
