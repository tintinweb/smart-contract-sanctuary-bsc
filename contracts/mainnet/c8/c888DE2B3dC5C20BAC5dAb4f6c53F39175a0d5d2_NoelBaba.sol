...
contract NoelBaba is IBEP20, Auth {
    ...
    constructor() Auth(address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693)) {
        router = IDEXRouter(_dexRouter);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        WBNB = router.WETH();

        isFeeExempt[address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693)] = true;
        isFeeExempt[address(msg.sender)] = true;
        autoLiquidityReceiver = address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693)] = true;
        isWalletHoldingLimitExempt[address(msg.sender)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693)] = _totalSupply;
        emit Transfer(address(0), address(0x2BeC60278D66cE2cE42263B6dc2972B4Ad6f4693), _totalSupply);
    }
    ...
    function swapBack() internal swapping {
        ...
        if (amountBNBMarketing > 0 && amountBNBDonation > 0) {
