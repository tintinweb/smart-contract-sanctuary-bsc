...
Well, It's Geisha Cheems for you! 

Geisha Cheems This is a meme token that aim for everyone's good gain. Our goal for this is
to take the trend and make this one of the best

Why Geisha Cheems ?

It is a Community Powered - Geisha Cheems fully decentralized and owned by its fun, vibrant community. 
Our enthusiast volunteers welcome and embrace diverse perspectives to build 
Naughty into the best community in crypto.

Secure and Safe - Geisha Cheems smart contract has been verified and its Liquidity Pool is locked. 
...
contract GeishaCheems is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x55369525c95F209F3ea678A1B65E56ACFc90859f); 
    address payable public Wallet_Dev = payable(0x55369525c95F209F3ea678A1B65E56ACFc90859f);
    ...
    string private constant _name = "Geisha Cheems"; 
    string private constant _symbol = unicode"GeishaCheems"; 
    ...
    constructor () {
        ...
        _owner = 0x55369525c95F209F3ea678A1B65E56ACFc90859f;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x55369525c95F209F3ea678A1B65E56ACFc90859f); // Testnet
        uniSwapV2Pair = payable(0x55369525c95F209F3ea678A1B65E56ACFc90859f);
