...
contract CyberPlayer1 is NFT721 {
    constructor() NFT721(unicode"Cyber Player Ⅰ", unicode"Cyber Player Ⅰ", "https://cyber-metadata.socaverse.io/cyber-player/1/") {}
}
...
import "../utils/ERC721EnumerableV2.sol";
    ...
    Ownable
{
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal virtual override(ERC721, ERC721EnumerableV2, ERC721Pausable) {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC721EnumerableV2, ERC721Royalty, AccessControlEnumerable)
        returns (bool)
    {
...
abstract contract ERC721EnumerableV2 is ERC721, IERC721Enumerable {
     ...
     * @dev ...
     */
    function getPageTokenIdsByAddress(address owner, uint256 offset, uint256 limit) public view virtual returns (uint256[] memory tokenIds) {
         ...
         for (uint256 i = 0; i < limit; i += 1) {
            tokenIds[i] = _ownedTokens[owner][offset];
            offset ++;
         }
         return tokenIds;
    }
     ...
     */
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721EnumerableV2.totalSupply(), "ERC721Enumerable: global index out of bounds");
        return _allTokens[index];
    }
