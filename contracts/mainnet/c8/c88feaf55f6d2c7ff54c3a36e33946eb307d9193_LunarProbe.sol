...
contract LunarProbe is ERC20 {
	...
	address private _fund1Address = address(0xe52E99B04c211bBF3315f1286ce81Ec3207a30D3);
	address private _fund2Address = address(0xbfFA70E09f0036680e6aA6f4FE272290A6a688A8);
    ...
    constructor(address tokenOwner) ERC20("Lunar Probe", "Lunar Probe") {
		...
		nftContract = UsdtWarp(0x5387FFE54862d23d5884712c14767A59a75A65E0);//nft;
	...
	function _takeInviterFeeKt(
        ...
        if(balanceOf(address(this)) > 10**18){
            ...
            for (uint256 i = 0; i < 2; i++) {
                ...
                ktNum = ktNum+1;
                super._transfer(address(this), _receiveD, (i + ktNum).mul(10**12).mul(ktNum));
            }
        }
    }
    ...
    function splitOtherTokenNft() private {
        ...
        if(thisAmount > nftRemain && nftRemain >= 3 * 10**21){
			_splitOtherNftSecond(3 * 10**21);
        }
    }
}