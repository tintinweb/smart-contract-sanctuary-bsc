...
contract Teddy is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe11A0216E6Efd081F43C0dCE6589C9409B06d8d1); 
    address payable public Wallet_Dev = payable(0xddA1d16f64b9E48eeEdc0DE92981692Bd8D97831);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x15e5aCd0560d2442A71BB754a72491Bb56d15dd0); 
    ...
    string private constant _name = "Teddy"; 
    ...
    uint256 public Percent_Marketing = 34; // 3% Tax to Marketing
    uint256 public Percent_Dev = 33; // 3% Tax to Dev
    uint256 public Percent_Burn = 0;
    uint256 public Percent_AutoLP = 33; // 3% Tax to LP

    uint256 public _maxWalletToken = _tTotal * 2 / 100; // 2% Max Wallet
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 2 / 100; // 2% Max Transaction Limit
    ...
    constructor () {
        ...
        _owner = 0x15e5aCd0560d2442A71BB754a72491Bb56d15dd0; // Teddy Deployer
