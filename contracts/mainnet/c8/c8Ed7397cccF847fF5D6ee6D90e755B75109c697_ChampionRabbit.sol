...
contract ChampionRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChampionRabbit";
    string private _symbol = "ChampionRabbit";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x17Edf1D652731a5a3E962258ea359109f4808033); 
    address payable private teamWalletAddress = payable(0x5C5eA141cf953581264Ea61F1e32352969a9df04); 
