 ...
 *Submitted for verification at BscScan.com on 2022-09-26
*/
//submitted for Telegram: https://t.me/TsukaTrustPortall
/*
...
contract TTRUST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Tsuka Trust ";
    string private _symbol = " $TTRUST "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x382b341065165a3E1C80d1b2aE2AdB0Bd6dF9840); 
    address payable public teamWalletAddress = payable(0x382b341065165a3E1C80d1b2aE2AdB0Bd6dF9840);
    ...
    uint256 private minimumTokensBeforeSwap = 252525  * 10**_decimals;
