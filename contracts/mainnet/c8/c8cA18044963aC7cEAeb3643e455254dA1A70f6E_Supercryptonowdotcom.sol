...
contract Supercryptonowdotcom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Supercryptonow.com";
    string private _symbol = "SuperCrypto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC08A5586387Ce227431E5274F284e2A337A88453);
    address payable public teamWalletAddress = payable(0xC08A5586387Ce227431E5274F284e2A337A88453);
    ...
    uint256 private _totalSupply =  15000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   15000000000 * 10**_decimals;     
    uint256 public _walletMax =     15000000000 * 10**_decimals;      
