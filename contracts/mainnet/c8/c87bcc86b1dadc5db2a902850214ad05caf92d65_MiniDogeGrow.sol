...
contract MiniDogeGrow is Context, IBEP20, Ownable {
    ...
    string private constant _name = "MiniDogeGrow";
    string private constant _symbol = "MiniDogeGrow";
    ...
    constructor () {
        _MarketingWallet = payable(0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928);
        _liquidityWallet = payable(0x0778C5edD1cb3a5fa483cc946c95898Ae1C27928);
        _devWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6);
