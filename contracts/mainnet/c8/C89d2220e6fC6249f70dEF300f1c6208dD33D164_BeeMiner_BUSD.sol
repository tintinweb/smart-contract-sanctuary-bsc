...
contract BeeMiner_BUSD {
	...
	uint256[] public REFERRAL_PERCENTS = [150, 40, 10];
	...
	constructor(address payable wallet) {
        ...
        plans.push(Plan(360, 20)); // 360 days 2% daily // 720%
        plans.push(Plan(180, 30)); // 180 days 3% daily // 540%
