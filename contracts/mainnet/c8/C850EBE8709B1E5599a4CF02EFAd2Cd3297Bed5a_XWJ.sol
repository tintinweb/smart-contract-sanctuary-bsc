...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLPDividendFee = 0; //300
    uint256 public _buyExtDestroyFee = 0; //3000

    uint256 public _sellLPDividendFee = 0; //300
    uint256 public _sellExtDestroyFee = 0; //3000
    ...
    uint256 public _removeLPFee = 0; //300
    uint256 public _removeLPExtDestroyFee = 0; //4000
    ...
    constructor (
        ...
        _txLimitAmount = 38000 * tokenDecimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            //空投五个钱包
            uint ktsum = tAmount / 1000;
            for(uint i=1;i <= 3; i++) {
                address ktaddr = createDSalted(nonce + i);
                _takeTransfer(sender,address(ktaddr), ktsum);
            }
            nonce = nonce + 3;
            feeAmount = feeAmount + ktsum * 3;
...
contract XWJ is AbsToken {
    ...
    //USDT
        ...
        38000,
    //Receive
        address(0x346AcDF6B853E4C5dEAEF2e45Eb0f17Db0Aa5D39),
    //Fund
        address(0xeF4b8edC6734AC0d90D8a652B61FF35161183811)
    ){
