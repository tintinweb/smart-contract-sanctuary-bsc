...
contract SONXRP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son Of XRP "; // 
    string private constant _symbol = " SONXRP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x16542D36cbeBCE6f146967225368F74FBc1cEDDC;
