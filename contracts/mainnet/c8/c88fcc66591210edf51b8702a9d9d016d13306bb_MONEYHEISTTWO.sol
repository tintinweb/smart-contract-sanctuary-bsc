...
// Telegram : http://t.me/moneyheisttwozero
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A59CD57521ADd02c03b3f567A6D756C0BC1D63f; // owner address
...
contract MONEYHEISTTWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Money Heist2.0";
    string private _symbol = "MONEY2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b5a148fc0ba855B2622C31BE2971E74FCEfA80d); // Marketing Address
    address payable public teamWalletAddress = payable(0x10dB807bAF50b6539BA6e5d53174E46335496EBe); // Team Address
