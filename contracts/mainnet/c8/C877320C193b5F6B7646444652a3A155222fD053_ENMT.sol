...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) {
        _marketWallet = 0x5c1a18a119cd8Cdf9754C93Fa78656E936fc7845;
    ...
    function initBlockNum(uint256 blocks) public view onlyOwner returns (uint256) {
        uint256 nowBlock = block.timestamp + blocks;
        return nowBlock;
    }
