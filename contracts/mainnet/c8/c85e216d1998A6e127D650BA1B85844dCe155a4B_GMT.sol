...
address constant marketAddr = 0xBCF53625837349C1B0aCedB6fc03381c64B47A85; //营销地址
...
abstract contract DexBaseUSDT {
    ...
    constructor() {
        ...
        distributor = new DividendDistributor(SHIB, 100, 20 ether);
    }
}
    ...
    InviteFee
{
        ...
        InviteFee()
    {
        ...
        addBlackList(0xF765F6590fE0d2533225dF11E32564797B504020);
        addBlackList(0xCd7A1b9a7479b9714B794eD93aA66178e69CdEeB);
    }
