...
contract sBULL is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 45,000 sBULLs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 36000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) ERC20("sBULL", "sBULL") {
        _mint(msg.sender, 1 ether); // mint 1 sBULL for initial pools deployment
