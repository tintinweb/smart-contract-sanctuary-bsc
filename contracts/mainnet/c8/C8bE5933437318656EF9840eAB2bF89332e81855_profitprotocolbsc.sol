...
contract profitprotocolbsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Profit Protocol"; // 
    string private constant _symbol = "PP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x334442f1C3dB28938caecD7CE8B1B50a551f9f80;
