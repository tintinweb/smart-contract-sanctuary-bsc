...
contract GoldenCat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5634F42f032e77Ac2D95FD24836318c19Ddf1DDD); 
    address payable public Wallet_Dev = payable(0x5634F42f032e77Ac2D95FD24836318c19Ddf1DDD);
    ...
    constructor () {
        ...
        _owner = 0x5634F42f032e77Ac2D95FD24836318c19Ddf1DDD;
    ...
    function Percent_M_D_B_A(uint256 NEW_Percent_Marketing, uint256 NEW_Percent_Dev,uint256 NEW_Percent_Burn, uint256 NEW_Percent_AutoLP) external onlyOwner() {
