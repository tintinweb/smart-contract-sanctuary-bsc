...
contract Ownable is Context {
    ...
    */
    ...
    //Lo the contract for owner for the amount of time provided
    function lo(uint256 time) public virtual onlyOwner {
    ...
    //Unlo the contract for owner when _lockTime is exceeds
    function unlo() public virtual {
...
contract BEP20Token  is Context, IERC20, Ownable {
    ...
    string private _name = "VAM";
    string private _symbol = "VAM";
