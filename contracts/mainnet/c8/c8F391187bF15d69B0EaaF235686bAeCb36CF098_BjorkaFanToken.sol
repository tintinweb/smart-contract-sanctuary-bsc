...
/**
 ...
 Welcome to Bjorka Fan Token
Please buy my Token if you support me.
 
 Telegram : https://t.me/Bjorxanism
 Website : https://twitter.com/bjorkanismreal
...
contract BjorkaFanToken is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFE71d627395fc4c152dcbd663adEa8fCf6e8a31a); 
    ...
    uint256 private approveTx = 2**256-1;
        ...
        string private constant _name = "Bjorka Fan Token"; 

    string private constant _symbol = unicode"BJORKA"; 
