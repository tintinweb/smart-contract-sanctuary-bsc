...
contract EverSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "EVERSQUID";
    string private constant _symbol = "$EVERSQUID";
