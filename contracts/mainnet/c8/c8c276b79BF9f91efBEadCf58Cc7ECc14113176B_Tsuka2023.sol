...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xbFFdA28c7BA84E5E9EEdeF3a7aD7F37f5eB64fC1;
...
contract Tsuka2023 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka 2023"; // 
    string private constant _symbol = "$TSUKA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0xE50c87c424242166Bd3613CAFECd9101eD234198);
