...
//                (uint price0Cumulative, uint price1Cumulative,) = BSWOracleLibrary.currentCumulativePrices(pairs[i]);
                ...
                observation.price0Cumulative = IBiswapPair(pairs[i]).price0CumulativeLast();//price0Cumulative;
                observation.price1Cumulative = IBiswapPair(pairs[i]).price1CumulativeLast();//price1Cumulative;
            } else {
