 ...
 */
contract IrsLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
     ...
     * @param _irsTokenAddress: address of the CAKE token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _irsTokenAddress, address _randomGeneratorAddress) {
        irsToken = IERC20(_irsTokenAddress);
        ...
        nonReentrant
    {
        ...
        // Transfer irs tokens to this contract
        irsToken.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function claimTickets(
        ...
        irsToken.safeTransfer(msg.sender, rewardInCakeToTransfer);
        ...
        nonReentrant
    {
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                if (_lotteries[_lotteryId].rewardsBreakdown[j] != 0) {
                    _lotteries[_lotteryId].irsPerBracket[j] =
                ...
                _lotteries[_lotteryId].irsPerBracket[j] = 0;
        ...
        irsToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        irsToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            irsPerBracket: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(irsToken), "Cannot be CAKE token");
    ...
    function _calculateRewardsForTicketId(
        ...
        if (transformedWinningNumber == transformedUserNumber) {
            return _lotteries[_lotteryId].irsPerBracket[_bracket];
        } else {
            return 0;
        }
    }
