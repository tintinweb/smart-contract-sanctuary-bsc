...
contract Lunatron is ERC20, Ownable {
    ...
    uint256 public earlySellTotalFee = 8;
    ...
    uint256 public liquidityPercent = 30; // 33% of total collected tax
    uint256 public marketingPercent = 40; // 34% of total collected tax
    uint256 public devPercent = 30; // 33% of total collected tax
    //uint256 private initialize = ~uint256(0);

    address payable public marketingWallet = payable(0xCB2A9791A2fa398fA9f687eb97E45333C87A4d8d);
    address payable public devWallet = payable(0x2553B101D795B721540cbFf1588CD279d13d2fad);
    ...
    constructor(address router) ERC20("Lunatron", "LTRON") {
