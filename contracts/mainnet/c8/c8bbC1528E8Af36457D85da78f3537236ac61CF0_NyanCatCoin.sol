...
/*
🌐 Website - https://nyancat.in
🐥 Twitter - https://twitter.com/NyanCatCoin_BSC
🐱 Telegram - https://t.me/NyanCatCoin

📚 Token Features :

Tax: 15% Buy and 15% Sell
...
Liquidty Lock for 6 Month
80% total Amount burn!

🚫🐳Anti-Wahle dump mode: Certain method was used to prevent huge dump from whales which may cause panic sells.

🤖 Anti robot mode: Can't public before launch. But don't worry, we had mechanism anti bot
*/
...
contract NyanCatCoin is Ownable, IERC20 {
    ...
    uint public _marketingFee = 5;
    uint public _reflectionFee = 5;
    uint256 public _totalFee = _liquidityFee + _marketingFee + _reflectionFee;
    ...
    constructor() {
        ...
        _balances[address(0)] = _totalSupply * 80 / 100;
    ...
    function setMarketingFeePercent(uint256 value) external onlyOwner {
        require(value < 10);
        _marketingFee = value;
    }

    function setReflectionFeePercent(uint256 value) external onlyOwner {
        require(value < 10);
        _reflectionFee = value;
    }
