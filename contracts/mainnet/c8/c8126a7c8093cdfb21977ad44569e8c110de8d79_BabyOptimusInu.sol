...
// Elon Based Memecoin 
// Rewards in Optimus Inu
// Telegram: https://t.me/babyoptimusinu
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x674aA28Ac436834051fff3fC7b6e59D6f9c57a1c);
    PCSRouter router;
...
contract BabyOptimusInu is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Baby Optimus Inu";
    string constant public symbol = "BOI";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 6 / 1000;
    uint256 public _maxWalletToken = totalSupply * 6 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2Ff5087B929E3d3a4e4570bfFf4C1DC7687b2334;
        devFeeReceiver = 0x2Ff5087B929E3d3a4e4570bfFf4C1DC7687b2334;
