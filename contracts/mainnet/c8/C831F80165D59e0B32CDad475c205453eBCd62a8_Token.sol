        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x44119cEEabA727ED7D6af0a75ed358096b99c3c5), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        "BNB Industry recovery fund",//Name
        "BNBF",//Symbol
        9,//Decimals
        21000000,//Supply100000
        address(0x067776A7E58d238a0810A853cbEc0EFd21C85506),//FundAddress
        address(0xe6Eda189C4311c9008D56F9287388cE2Ca574BFd)//ReceiveAddress
    ){
    }
}