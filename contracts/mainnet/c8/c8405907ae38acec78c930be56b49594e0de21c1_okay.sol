...
contract okay is Context, IERC20, Ownable {
	...
	function mixMaxHold(uint256 _maxHold) public view returns(uint256) {
	...
	function newTanChuangIndex(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
