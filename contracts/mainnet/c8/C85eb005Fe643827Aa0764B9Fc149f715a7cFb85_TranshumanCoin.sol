...
/**
    ...
    Decimal = 9
    25% of each transaction to the liquidity pool
    25% of each transaction to the marketing wallet
    20% of each transaction to holders
*/
...
contract TranshumanCoin is Context, IBEP20, Ownable {
    ...
    string private _name     = "Kuwaiti Dinar";
    string private _symbol   = "KWD";
    ...
    uint256 private _minTokenBalance = 10000 * 10**12;
