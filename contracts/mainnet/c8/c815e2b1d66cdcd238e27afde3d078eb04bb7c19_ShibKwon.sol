...
contract ShibKwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibKwon";
    string private _symbol = "SKWON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x705Ea08899BEC9d810D38a429413C55Cca2A2299); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x705Ea08899BEC9d810D38a429413C55Cca2A2299); // BuyBack Address
