...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd08C63d0BbE8C21EcC42E1801C936115d35055BC; // owner address
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "303";
    string private _symbol = "303";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0424b4Cc5684BBcA0579F8Ca0d8597A6DcC7310C); // Marketing Address
    address payable public teamWalletAddress = payable(0x0424b4Cc5684BBcA0579F8Ca0d8597A6DcC7310C); // Team Address
    ...
    uint256 private _totalSupply = 3030 * 18**_decimals;
    uint256 public _maxTxAmount = 3030 * 18**_decimals; 
    uint256 public _walletMax = 3030 * 18**_decimals;
    uint256 private minimumTokensBeforeSwap = 3030 * 18**3; 
