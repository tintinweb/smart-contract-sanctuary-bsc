...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFc422549d01805bba1dc6D8090ed506cCF9d61e7; // owner address
...
contract SMINU  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Sminiem inu  ";
    string private _symbol = " SMINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFc422549d01805bba1dc6D8090ed506cCF9d61e7); // Marketing Address
    address payable public teamWalletAddress = payable(0xFc422549d01805bba1dc6D8090ed506cCF9d61e7); // Team Address
