 ...
 *  |   |    |   |  * \ \____| |___/ /  *
    |*  |    |   |     \____________/       *
        ...
        ---------------------------------
        TG:     https://t.me/CZClaus
        ----------------------------------

         __True Stealth - Very Christmas__

        Changpeng Zhao, CEO of Binance,
         Becomes Santa Claus once a year,
          With his token called CZClaus,
           He gives huge crypto profits to everyone near.

        He flies around the world with a big red bag,
         Filled with gifts for those who hold his tag,
          With a twinkle in his eye and a jolly old cheer,
           CZClaus spreads joy and profits far and near.

        So if you want to get in on the fun,
          Hold on tight to your CZClaus, it's time to run,
           Join the crypto craze and watch your profits grow,
            Thanks to CZClaus, the Santa of the crypto world, Ho Ho Ho!
...
contract CZCLAUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CZ Claus";
    string private _symbol = "CZC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9d29ba9841e72608ee24c0e055A3b91aFC54aBC7);
    address payable public devFee = payable(0x9d29ba9841e72608ee24c0e055A3b91aFC54aBC7);
