...
contract MEDALFINANCE  is Context, IERC20 { 
    ...
    function SetFeeBuy (uint256 Buy) public onlyOwner {
        _Tax_On_Buy = Buy;
    }

    function SetFeeSell (uint256 Sell) public onlyOwner {
        _Tax_On_Sell = Sell;
    }
    ...
    function claimStuckTokens(address token, uint256 value) external onlyOwner {
        ...
        ERC20token.transfer(_msgSender(), value);
    }
