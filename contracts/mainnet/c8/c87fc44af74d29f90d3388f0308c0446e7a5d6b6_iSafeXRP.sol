...
contract iSafeXRP is Context, IERC20, Ownable {
    ...
    string private constant _name = "iSafe XRP"; // 
    string private constant _symbol = " $iSAFEXRP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x485d1Dbb1d29E1eBA7559De862963Af42aba9fdC;
