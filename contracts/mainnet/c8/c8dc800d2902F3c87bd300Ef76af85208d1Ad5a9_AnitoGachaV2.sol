...
contract AnitoGachaV2 is Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(address _anitoNFT, address _busdAddress, address _treasuryAddress, address _anitoGachaV1, address _signer){
        ...
        wlTotalMintedPerCategory[COMMON] = anitoGachaV1.wlTotalMintedPerCategory(COMMON);
        wlTotalMintedPerCategory[EPIC] = anitoGachaV1.wlTotalMintedPerCategory(EPIC);
        wlTotalMintedPerCategory[LEGENDARY] = anitoGachaV1.wlTotalMintedPerCategory(LEGENDARY);

        wlMaxMintPerCategory[COMMON] = anitoGachaV1.wlMaxMintPerCategory(COMMON);
        wlMaxMintPerCategory[EPIC] = anitoGachaV1.wlMaxMintPerCategory(EPIC);
        wlMaxMintPerCategory[LEGENDARY] = anitoGachaV1.wlMaxMintPerCategory(LEGENDARY);
...
interface IAnitoGacha {
    ...
    function wlTotalMintedPerCategory(uint256 category) external view returns(uint256);
    function wlMaxMintPerCategory(uint256 category) external view returns(uint256);
}
