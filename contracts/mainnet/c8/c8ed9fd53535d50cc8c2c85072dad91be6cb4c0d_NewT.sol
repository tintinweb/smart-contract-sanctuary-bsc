...
contract NewT is IBEP20, Ownable {
 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    string constant _name = "NewT"; // 
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 500000}("");
        require(MarketingSuccess, "receiver rejected WBNB transfer");
        (bool buybackSuccess,) = payable(buybackFeeReceiver).call{value: amountBNBbuyback, gas: 500000}("");
        require(buybackSuccess, "receiver rejected WBNB transfer");
        (bool devSuccess,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 500000}("");
