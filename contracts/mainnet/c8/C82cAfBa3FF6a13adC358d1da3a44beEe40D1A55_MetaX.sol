...
contract MetaX is ERC20, Ownable {
    ...
    address private poolAddr = 0x26fefcEE64A04657280643fc083960b76c697232;
    address private communityAddr = 0xf41415A0E7c9496b1FD2D6dcB3e58AfF3c33b7B6;
    address private fundAddr = 0x09119c14cC5D64d2Fd1072E7817F15432eFd9eCD;

    IPancakeRouter02 public uniswapV2Router;
    address public uniswapV2Pair;
    mapping(address => bool) public uniswapPairAddrs;

    //constructor(address token) ERC20("MetaX", "MAX") {
    constructor() ERC20("TextX", "T") {
        ...
        _mint(poolAddr, 21000000 * 10 ** decimals());
    }
    ...
    function _transfer(
        ...
        if (uniswapPairAddrs[from] || uniswapPairAddrs[to]) {
            ...
            uint256 communityFee = amount.div(100);
            uint256 fundFee = amount.div(100);
            uint256 _amount = amount.sub(poolFee).sub(communityFee).sub(
                fundFee
            );
            super._transfer(from, poolAddr, poolFee);
            super._transfer(from, communityAddr, communityFee);
