...
contract AISafeMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = " AI SafeMoon "; // 
    string private constant _symbol = " $AISMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xEb6A9DA2453dB0A42d3151C9996825978A3aa14c;
