...
contract BlackMarket is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Black Market";
    string private _symbol = "Black Market";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5f43f76D331EE7a62D537e47b43dE2848DA6945E); // Marketing Address
    address payable public teamWalletAddress = payable(0x5f43f76D331EE7a62D537e47b43dE2848DA6945E); // Team Address
