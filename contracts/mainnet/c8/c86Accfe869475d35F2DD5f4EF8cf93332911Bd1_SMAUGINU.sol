...
contract SMAUGINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Smaug INU";
    string private constant _symbol = "SMAUGI";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        ...
        require(newLiquiditySellFee.add(newMarketingSellFee) <= 10, "Sell fee can't go higher than 10");
