...
contract MetaYuanXiao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MetaYuanXiao";
    string private _symbol = "MetaYuanXiao";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x2F01291517D10F35f985f38708647cC8102c0f9C);
