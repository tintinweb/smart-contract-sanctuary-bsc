...
contract RMBDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RMBDAO";
    string private _symbol = "RMBDAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0x785fB83957fb4404C11466207F2Fd4fC873553f4); 
    address payable private teamWalletAddress = payable(0x0A3AD9dDC04dF01e14E0A9991Df5c96800F49d0E); 
    ...
    uint256 private _totalSupply = 14 * 100000000 * 10**_decimals;
