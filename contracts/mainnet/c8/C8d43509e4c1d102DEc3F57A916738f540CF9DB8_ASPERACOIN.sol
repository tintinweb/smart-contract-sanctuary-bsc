...
contract ASPERACOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASPERA COIN";
    string private _symbol = "$AS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a1Abe7574AcdDc791574D1Caa7c93B8C76F0CEd);
    address payable public teamWalletAddress = payable(0x1a1Abe7574AcdDc791574D1Caa7c93B8C76F0CEd);
