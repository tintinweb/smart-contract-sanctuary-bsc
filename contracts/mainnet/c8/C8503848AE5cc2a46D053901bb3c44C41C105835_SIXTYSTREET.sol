...
contract SIXTYSTREET is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "SIXTYSTREET";
    string _symbol = "SIXTY";
    uint8 _decimals = 9;
    ...
    function Datalimit(address holder) external onlyOwner {
    ...
    function gasfee(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
