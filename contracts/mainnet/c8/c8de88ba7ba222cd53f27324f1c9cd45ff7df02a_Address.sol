...
contract TestGolding5 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x020Fbb7bD8f6b834732275Dc322C5485041E407e); // Marketing Address
    address public immutable deadAddress = 0x020Fbb7bD8f6b834732275Dc322C5485041E407e;
    ...
    string private _name = "Test Golding 5";
    string private _symbol = "TT5";
    ...
    function setRewardPool(address account) public onlyOwner {
    ...
    function distributeRewards(uint256 sellTaxFee, uint256 sellLiquidityFee) external onlyOwner {
