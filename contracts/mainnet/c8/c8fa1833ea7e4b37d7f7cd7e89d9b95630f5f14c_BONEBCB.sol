...
BONEBCB
Fan Token
Welcome to the Blockchain Bets!
One stop for decentralized sports betting & Online Casinos. Play your favorite games and earn big.
Welcome to the Official Twitter Account for the Shiba Inu Ecosystem. $SHIB 
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextBEP20PROXY {
...
contract OwnableBEP20PROXY is ContextBEP20PROXY {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20PROXY: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20PROXY: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract BONEBCB is ContextBEP20PROXY, BEP20PROXY, OwnableBEP20PROXY {
    ...
    string private _name = 'BONE BCB';
    string private _symbol = '$BONEBCB';
