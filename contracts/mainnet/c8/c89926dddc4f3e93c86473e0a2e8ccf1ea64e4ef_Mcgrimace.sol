...
/**
MCgrimace
🔐 Locked LP for 30 days
Total Fee : 10%
telegram = https://t.me/somethingaboutgrimace
*/
...
/* Token contract */
contract Mcgrimace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Mc Grimace";
    string constant _symbol = "Mcgrimace";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 200 / 10000;  // 3% max or 2M
