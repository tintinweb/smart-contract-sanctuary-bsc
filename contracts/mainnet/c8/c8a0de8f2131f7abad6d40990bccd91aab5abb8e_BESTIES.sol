...
contract BESTIES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Burger Besties Inu";
    string private _symbol = "BESTIES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc48CeB05EE0c18748a2354feB8409E3360F2159F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xFb917298E74945dB0551431BeE1990d70A5B7E53); // buyback Address
    ...
    uint256 public _walletMax = 3 * 10**9; 
