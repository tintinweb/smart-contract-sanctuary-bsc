...
contract PantherToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50_000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 500 * 10**9; //
    string private constant _name = "Panther Token"; // 
    string private constant _symbol = "PANTHER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    address public  _marketingWallet = 0x056afE90E002745c2f9b5bcB43C65D89C10A1273;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair)
            require(balanceOf(to) + amount <= ((_tTotal / 100)*3), "Transfer amount exceeds the max wallet amount.");
