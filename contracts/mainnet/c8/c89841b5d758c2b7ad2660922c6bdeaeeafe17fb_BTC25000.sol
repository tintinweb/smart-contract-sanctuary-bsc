...
/*
    No telegram for community driven token. If someone wanna create, I suggest @BTC25000Community
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAE17928a1461374aeD8b7FBADB2AaB2eDf640f72; // owner address
...
contract BTC25000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTC25000";
    string private _symbol = "BTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAE17928a1461374aeD8b7FBADB2AaB2eDf640f72); // Marketing Address
    address payable public teamWalletAddress = payable(0xAE17928a1461374aeD8b7FBADB2AaB2eDf640f72); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 25 * 10**_decimals; 
