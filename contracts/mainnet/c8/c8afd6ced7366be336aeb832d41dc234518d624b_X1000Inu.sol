...
/**
 *https://t.me/X1000Inuportal     https://twitter.com/x1000Inu    https://x1000inu.com/
*/

//X1000Inu$ is new token with utility and huge marketing push hard to make sure we will hit x1000
//
...
contract X1000Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X1000Inu";
    string private _symbol = "XK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable (0xefB656d06cCD74FffEff52702bd368eee379a95f); // Marketing Address
    address payable public teamWalletAddress = payable (0xefB656d06cCD74FffEff52702bd368eee379a95f); // Team Address
