...
contract NLZN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1D6fE0D16dB7d2FA416A062ef37F3f65A6ec6952); // Marketing Address
    address payable public teamWalletAddress = payable(0x12a2E496D74C07f8664162168299Cee30F8211c9); // Team Address
    ...
    uint256 private _totalSupply = 1777 * 10**_decimals;
    uint256 public _maxTxAmount = 1777 * 10**_decimals; 
    uint256 public _walletMax = 1777 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1777 * 10**12; 
