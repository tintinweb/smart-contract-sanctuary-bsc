...
contract LittleSantaRabbit is ERC20 {
    ...
    uint ratio;
    address private marketAddress = 0x721c6A23024cBA7977EA141149231BC26fCBD2AB;
	address payable _fundAddress = payable(address(0x00d8Aa9a2112AE1B9127d8c098a062812914a020));
    ...
    constructor() ERC20("Little Santa Rabbit", "LSR") {
        ...
        uint256 total = 241313170*10**decimals();
