...
contract CSSSARR is IERC20, Ownable {
    ...
    string private _name = "CSSSARR001";
    string private _symbol = "CSSSARR001";
    uint8 private _decimals = 18;

    uint256 public _burnFee = 130;
    uint256 private _previousburnFee;

    uint256 public _LPFee = 130;
    uint256 private _previousLPFee;

    uint256 public _marketFee = 130;
    ...
    // IERC20 public EPT = IERC20(0x2804ca0dE453AF8b99cf8773b101276Cb39AD148);
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(EPT));
  ...
  modifier onlyowManager() {
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _toburnFee(address sender,
        uint256 tAmount
    ) private {
        if (_burnFee == 0) return;
        _tOwned[address(this)] = _tOwned[address(this)].add(tAmount);
    ...
    function _transferStandard(
        ...
        _tOwned[sender] = _tOwned[sender].sub(tAmount);
         ...
         _toburnFee(sender, tAmount.div(10000).mul(_burnFee));
