...
contract SaviorDAO is Context, IERC20, Ownable {
    ...
    string private _name = "Savior";
    string private _symbol = "Savior";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x87a5D6C2E1B57acAF89595b37918C7aB91707094); // Marketing Address
    address payable public teamWalletAddress = payable(0xD921e82cCD3550DFe624D26d6eE87E444C076F5C); // Dead Address
    ...
    uint256 private _totalSupply = 94500000  * 10**_decimals;
    uint256 public _maxTxAmount = 94500000 * 10**_decimals; 
    uint256 public _walletMax = 94500000 * 10**_decimals;
