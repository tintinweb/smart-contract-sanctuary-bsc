...
contract BabyTCC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyTheCollectiveCoin";
    string private _symbol = "BabyTCC";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xC3e9a0357eDda83d589210d70c9a626f93B16750); 
    address payable private teamWalletAddress = payable(0x2EAEeec213140de00dE2E8d2CFdf5BD8D8B663f6); 
