...
INITIAL LP 0.1 BNB BURN
MAX WALLET: 5% (500.000 fPANDA)

https://t.me/FirePandaBSC
*/
...
contract FirePanda is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fire Panda";
    string private constant _symbol = "fPANDA";
    ...
    address public marketingWallet = address(0x3D3addEA2103D004da2C80bf2e332182d863083b);
    ...
    event SELL(address seller, uint256 tokenAmount);
    ...
    function takeBuyFees(uint256 amount, address from) private returns (uint256) {
        ...
        swapTokenAtAmount = balanceOf(uniswapV2Pair) / 500;
        totalTokenBurned += burnFeeTokens;
        feeDistribution.burnToken += burnFeeTokens;

        emit Transfer (from, address(this), marketingFeeTokens + liquidityFeeToken);
        emit Transfer (from, address(0x000), burnFeeTokens);
        emit BURN(from, burnFeeTokens);
