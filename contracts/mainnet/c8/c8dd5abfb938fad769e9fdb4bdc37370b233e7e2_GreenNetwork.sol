...
/**
    Telegram : https://t.me/GreenNetworkBSC
*/
...
contract GreenNetwork is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Green Network";
    string private _symbol = "Green";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9EE782E75f3Aa5a3196bb09bC98C8058603A89AF);
    address payable public DevelopmentWalletAddress = payable(0x9EE782E75f3Aa5a3196bb09bC98C8058603A89AF);
    ...
    uint256 private _totalSupply = 8000000 * 10**9;
    uint256 public _maxTxAmount = 8000000 * 10**9;
    uint256 public _walletMax = 8000000 * 10**9;
