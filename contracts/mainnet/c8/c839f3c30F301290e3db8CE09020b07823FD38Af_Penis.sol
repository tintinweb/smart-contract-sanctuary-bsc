...
contract Penis is Context, IERC20, Ownable {
    ...
    string private _name = "Penis";
    string private _symbol = "23CM";
    ...
    address public ownerAddres = address(0x458a3AD4A7A95dfbFf13999c30af814Bb5D261da);
    address public devAddress = address(0xaa74d6441C6d35B7F79160d5aCbbBf0b10F9D611);
