...
contract PureCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pure Coin";
    string constant _symbol = "PUR";
    ...
    bool public BPEnabledForever = false;
    ...
    function setBotProtectionEnabledForever() external onlyOwner{
        require(BPEnabledForever == false);
        BPEnabledForever = true;
    }
}
