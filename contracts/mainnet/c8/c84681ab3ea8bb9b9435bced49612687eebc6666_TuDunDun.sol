...
contract MktCap is Ownable {
    ...
    constructor(address ceo_, address baseToken_, address router_) {
        ...
        autoSell = autoConfig(true, 1, 10000, 1000000000);
        allot = Allot(750, 0, 250, 1000);

        address[] memory marketingAddress = new address[](1);
        marketingAddress[0] = address(0x134C450557269Fea1b32572DeD67Ef4f6D557AF4);
...
contract TuDunDun is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint;
    MktCap public mkt;
    ...
    constructor() ERC20("TuDunDun", "TuDunDun") {
        ceo = _msgSender();
        ...
        address _initHolder = 0xd62319338E8dD8Eb9cf87515FcFcDE9B7911E9d3;
