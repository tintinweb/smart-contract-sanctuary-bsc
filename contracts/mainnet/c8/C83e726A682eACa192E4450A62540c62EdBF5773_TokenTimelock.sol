...
// Locked for Radar Token  VBC.DAO
...
contract TokenTimelock {
    ...
    constructor(
        ...
        require(address(token_).isContract(),"TokenTimelock: token_ not ContracAddress");
        _token = token_;
    ...
    function releaseTime() public view virtual returns (uint256) {
        (uint256 year,uint256 month,uint256 day) = DateTimeLibrary.timestampToDate(_releaseTime);
