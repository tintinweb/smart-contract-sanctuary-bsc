...
contract lockeystaking1 is Auth, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public totalLOKIv2Deposited;
    ...
    uint256 public totalLOKIv2ClaimedRewards;
    ...
    constructor() Auth(msg.sender) {
        stakingToken = IBEP20(0xFb16Bb010d901679cAFF22Da5bA810Ee6c0606AE);
        ...
        poolInfo.push(PoolInfo({
            ...
            accTokensPerShare: 1500
        }));

        totalAllocPoint = 300000;

    }

    receive() external payable {totalLOKIv2Deposited = totalLOKIv2Deposited + msg.value;}
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                ...
                totalLOKIv2ClaimedRewards = totalLOKIv2ClaimedRewards + pending;
            }
        }
