...
/* Token contract */
contract ApeElk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address private marketingFeeReceiver = 0x90F4b3Da60Ef9A899D87D537558CdD6B58aB9B5b;
 
    // Name and symbol
    string constant _name = "ApeElk";
    string constant _symbol = "ApeElk";
