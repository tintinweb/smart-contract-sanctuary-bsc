...
contract BetGosuToken is ERC20, Ownable {
    ...
    uint256 public immutable liquidityFeeOnBuy;
    uint256 public immutable liquidityFeeOnSell;
    ...
    constructor () ERC20("BetGosu", "$GOSU") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x1A561e43f264952D7b4F25Fb4967122c87618Beb;
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 marketingTokens = (contractTokenBalance * 4) / 5;
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]|| swapping) {
            ...
            if(launchTime + 1 hours > block.timestamp) {
                _totalFees = 5;
            } else {
                _totalFees = 0;
            }
