...
contract DecentraWorldInu is Context, IERC20, Ownable {
    ...
    string private _name = "DecentraWorld Inu";
    string private _symbol = "$DewoInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe6a5fff20a6be93B960613BC9073A5b27870FC44); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xe6a5fff20a6be93B960613BC9073A5b27870FC44); // Team Address
