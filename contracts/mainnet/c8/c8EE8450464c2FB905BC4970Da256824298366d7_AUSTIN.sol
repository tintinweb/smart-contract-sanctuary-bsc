...
contract AUSTIN is ERC20, Auth {
    ...
    string constant _name = "AustinPowers Inu";
    string constant _symbol = "AUSTIN";
    ...
    uint256 public liquidityFee    = 3; //set fees here 
    ...
    uint256 public sellMultiplier  = 100; //set sell tax here 100 = 100% of buy tax, 200% = 200% / 2x etc
    ...
    uint256 public swapThreshold = _totalSupply * 3 / 1000; //total amount of tokens contract will sell each time
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8e64C8a0024D24373F61868ABd45198aaC469bE6;
        devFeeReceiver = 0x8e64C8a0024D24373F61868ABd45198aaC469bE6;
    ...
    function set_sell_multiplier(uint256 _multiplier) external onlyOwner{ //change sell tax here 100 = 100% of buy tax, 200% = 200% / 2x
