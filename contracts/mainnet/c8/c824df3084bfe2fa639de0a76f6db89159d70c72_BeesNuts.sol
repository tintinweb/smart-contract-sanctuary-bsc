...
contract BeesNuts is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BeesNuts";
    string private _symbol = "BsNUTS";
    uint8 private _decimals = 5;

    address payable public marketingWalletAddress = payable(0xf31ec4334fb2E4B6A7c486B1b37bf80A97244294); 
    address payable public BuybackWalletAddress = payable(0x824D5e81157cf17B037839A45413F316f8B25fd2); 
