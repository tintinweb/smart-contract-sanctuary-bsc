...
// *Telegram : https://t.me/mcchocolatemilk
...
contract mcchoco is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x7cF325BD4Aa835B07B55331f4C81C309E00fa67A));
    address payable public devWallet =
        payable(address(0x7cF325BD4Aa835B07B55331f4C81C309E00fa67A));
    address public liquidityReceiver =
        0x7cF325BD4Aa835B07B55331f4C81C309E00fa67A;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "MCChocolateMilk";
    string private _symbol = "$MCCM";
