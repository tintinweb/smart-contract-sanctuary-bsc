...
contract SpookyTwitter is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Twitter"; // 
    string private constant _symbol = "SPOTER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x57897AACfDeEfCCf63616fEa315dd6e64bc6242f;
