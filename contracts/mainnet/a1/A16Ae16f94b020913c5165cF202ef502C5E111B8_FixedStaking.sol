...
// File Contracts/FixedStaking.sol
...
contract FixedStaking is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function initialize(address _treasury, address _treasuryAdmin) public initializer {
    ...
    function getUserInfo(address _user) public view returns(InfoFront[] memory info, uint32 currentDay){
