...
contract Staking is ReentrancyGuard{
    ...
    function restake() external updateReward(msg.sender) {
        ...
        uint[] memory amounts = router.swapExactTokensForETH(token1amount, 0, path, address(this), 9999999999);

        (, , uint liquidity) = router.addLiquidityETH{value : amounts[0]}(rewardAddr, token2amount, 0, 0, address(this), 9999999999);
