...
contract YoujizzCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Youjizz Coin";
    string private constant _symbol = "SEX";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 6969 * 10**_decimals;
    uint256 public _maxTxAmount = 209 * 10**_decimals;
    uint256 public _maxWalletAmount = 209 * 10**_decimals;
