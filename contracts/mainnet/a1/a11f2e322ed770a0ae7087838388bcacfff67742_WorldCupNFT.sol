...
// File: contracts/WorldCupNFT.sol
...
contract WorldCupNFT is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) public ERC721("WorldCup NFT", "WC") {
        _setBaseURI(_baseURI);

        string[32] memory teams = ["Netherlands", "Ecuador", "Senegal", "Qatar", "England", "Wales", "USA", "Iran", "Poland", "Argentina", "Mexico", "Saudi Arabia", "France", "Denmark", "Australia", "Tunisia", "Spain", "Germany", "Costa Rica", "Japan", "Belgium", "Croatia", "Canada", "Morocco", "Serbia", "Cameroon", "Switzerland", "Brazil", "Portugal", "Uruguay", "Korea Republic", "Ghana"];
        for(uint8 i=0;i<32;i++){
            bunnyNames[i] = teams[i];
        }
    }
