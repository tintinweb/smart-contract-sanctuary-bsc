...
Name: Elfloki
Telegram: https://t.me/elflokibsc
...
contract Elfloki is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 50 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 2 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xB390CC4882FFbbf81EAF9a03D16d4eCCC700557E; //

    string private constant _name = "ELFLOKI"; //
    string private constant _symbol = "ELFLOKI"; //
