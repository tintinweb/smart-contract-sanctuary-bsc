...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 300; //买入的营销钱包分红
    uint256 public _buyLPDividendFee = 100; //添加LP的人分红
    uint256 public _sellLPDividendFee = 100; //卖出时的lp持有者分红
    uint256 public _sellFundFee = 300;//卖出营销钱包分红
    uint256 public _sellLPFee = 200;//回流
