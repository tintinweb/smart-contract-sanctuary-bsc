...
contract Cell4680 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cell4680";
    string private _symbol = "$Cell4680";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71FBa7D09a5C4A8f9fd081508Bec37fC1e2884a8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x71FBa7D09a5C4A8f9fd081508Bec37fC1e2884a8); // BuyBack Address
