...
contract GeneratorCopyright {
    string private constant _GENERATOR = "http://www.cryptoworld.in.net";
...
// File: contracts/token/BEP20/GMTCBEP20.sol
...
/**
 * @title CommonBEP20 - GMTCBEP20
 * @dev Implementation of the GMTCBEP20
 */
contract GMTCBEP20CappedMintBurn is BEP20Capped, BEP20Mintable, BEP20Burnable, Pausable, GeneratorCopyright("v1.0.0") {
        ...
        BEP20Capped(cap)
    {
        ...
        uint256 finalBalance = initialBalance * 10 ** BEP20.decimals();

        _mint(_msgSender(), finalBalance);
    }
