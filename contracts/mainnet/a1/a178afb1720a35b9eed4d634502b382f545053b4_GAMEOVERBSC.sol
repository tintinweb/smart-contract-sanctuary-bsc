...
contract GAMEOVERBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "gameover";
    string private _symbol = "gameover";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4a94B5d35c307E06b6A2DAA29B148A88aC18d88B); 
    address payable public BurnedWalletAddress = payable(0x4a94B5d35c307E06b6A2DAA29B148A88aC18d88B); 
