...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc90Ad711Efe664E6f862d8DCab7D448D415589e1; // owner address
...
contract PEPECEOBURN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE CEO BURN";
    string private _symbol = "$PECOBURN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc90Ad711Efe664E6f862d8DCab7D448D415589e1); // Marketing Address
    address payable public teamWalletAddress = payable(0xc90Ad711Efe664E6f862d8DCab7D448D415589e1); // Team Address
