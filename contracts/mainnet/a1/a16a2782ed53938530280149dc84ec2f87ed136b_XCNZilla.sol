...
/**
    ...
    XCN Zilla is a community-driven token and decentralized coin in Binance Smart Chain
    Destined for a millions market cap
    Team has a lot of plans for this project
    Get in early for an easy 1000X

    Telegram : https://t.me/XCNZilla
*/
...
contract XCNZilla is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "XCN Zilla";
    string private _symbol = "XCN Zilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32392Ccf30f93C0b572B612eDc4C62E2Fac60a64); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x32392Ccf30f93C0b572B612eDc4C62E2Fac60a64); // Development Address
