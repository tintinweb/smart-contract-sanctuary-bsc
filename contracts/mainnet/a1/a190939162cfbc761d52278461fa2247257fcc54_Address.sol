...
contract Amazing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8158bf2443fa59178adf5b9384E6089Cecd1A2BF);
    address payable public teamWalletAddress = payable(0x2b46C9D795487CdBA977dF32247e893a258Cfad6);
    ...
    uint256 private _totalSupply =  5880000 * 10**_decimals;
    uint256 public _maxTxAmount =   5880000 * 10**_decimals; 
    uint256 public _walletMax =     5880000 * 10**_decimals;
