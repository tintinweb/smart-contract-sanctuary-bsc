...
7% Rewards on each tx ! 

Community project to earn more BECH ! 

Echelon is a new blockchain and we want to bring more & more people, all people need to know what's Echelon ! 

If you are with us, join us and shill it everywhere ! 


Organics growth + marketing step.


Experienced Dev. Don't Jeet it and let's growth the Echelon Community, this is our goal !!


Telegram : https://t.me/BabyEchelonPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x00EaFc9C1fb1b7f7889c7E91441ab62dE0259ad5);
...
contract BabyEchelon is IBEP20, Auth {
    using SafeMath for uint256;
   
    address REWARD   = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address WBNB     = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyEchelon";
    string constant _symbol = "BBECH";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 3 ) / 100 ; // 3%

    //max wallet holding of 15%
    ...
    uint256 public swapThreshold = ( _totalSupply * 5 ) / 1000; // 0.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xE5b19713D092F5C68ADC7f88966576Dd0483CeD2; 
