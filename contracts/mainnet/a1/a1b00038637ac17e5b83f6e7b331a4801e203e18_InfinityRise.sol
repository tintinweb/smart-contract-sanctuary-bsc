...
Telegram : https://t.me/InfinityRiseTG
...
contract InfinityRise is ERC20, Ownable {
    ...
    InfinityRiseDividendTracker public dividendTracker;
    ...
    constructor() ERC20("InfinityRise", "InfinityRise") {
        marketingWallet = payable(0xBdeF4134A209E95e3DD01989116fD07e78C1360D);
        buybackWallet = payable(0xD05f464278a32c5D1149F82efaF74667E80cCC91);
        ...
        dividendTracker = new InfinityRiseDividendTracker(
            payable(this),
            router,
...
contract InfinityRiseDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    InfinityRise public InfinityRiseContract;
    ...
    constructor(
        ...
        defaultToken = token;
        InfinityRiseContract = InfinityRise(mainContract);
    ...
    function _transfer(
        ...
        require(false, "InfinityRise_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "InfinityRise_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main InfinityRise contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(InfinityRiseContract);

            uint256 prevBalance = InfinityRiseContract.balanceOf(address(this));
            ...
            {
                uint256 received = InfinityRiseContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    InfinityRiseContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
