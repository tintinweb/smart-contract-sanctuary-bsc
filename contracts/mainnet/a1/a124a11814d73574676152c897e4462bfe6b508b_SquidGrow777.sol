...
contract SquidGrow777 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77dCE7db9d7566902C511595dCeAbA6482Eef060); 
    address payable public Dev_Wallet = payable(0x77dCE7db9d7566902C511595dCeAbA6482Eef060);
    ...
    string private constant _name = "SQUID GROW 777"; 
    string private constant _symbol = unicode"SG7"; 
    ...
    constructor () {
        ...
        _owner = 0x77dCE7db9d7566902C511595dCeAbA6482Eef060;
