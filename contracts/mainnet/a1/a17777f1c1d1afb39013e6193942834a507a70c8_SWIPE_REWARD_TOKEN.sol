...
contract Ownable is Context {
    ...
    constructor() {
        address msgSender = 0x00b02fc803e0c9B7e930155101a9791CdAD27bA7;
        _owner = msgSender;
...
contract SWIPE_REWARD_TOKEN is Context, IBEP20, Ownable {
    using SafeMath
    for uint256;
    ...
    constructor(address account) {
        _name = "SWIPE REWARD TOKEN";
        _symbol = "SRT";
        _decimals = 8;
        _totalSupply = 51000000000000000;
