...
contract ASU is Context, IERC20, Ownable {
    ...
    string private _name = "Advanced Swap Utility";
    ...
    uint256 public _marketingFee = 7; // 5% To Marketing And 2% To Development
    address public marketingWallet = 0xA88651112cbA28AC6804aad4Ea96815A14c119Ce;
    ...
    uint256 public _maxWalletToken = 30 * 10**6 * 10**9; // 3% of total supply
