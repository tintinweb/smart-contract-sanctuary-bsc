...
contract ShibaDogeToken is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaDogeToken";
    string private _symbol = "SDOG";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xedE2dd138714755AAA2F8Ed340e5DF5d3B75c509);
