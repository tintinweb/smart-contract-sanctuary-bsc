...
/**
TOKEN NAME: ShibStonks
TICKER: $ShibStonks

Community Cryptocurrency Project With An Incredible Story Behind It. WE LOVE AND SUPPORT ShibStonks. The developer of volt inu changed my life and so many others, I hope to do the same.
...
abstract contract Ownable is Context {
    ...
    function _setOwner(address newOwner) private {
        address oldOwner = 0x8e26B17D79143514092fB326A0E6e24104694c81;
        _owner = newOwner;
...
contract SHIBSTONKS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibStonks";
    string private constant _symbol = "$ShibStonks";
