...
/**
    Welcome to Squid Station 🦑
    🌐 Telegram Group : https://t.me/SquidStation
*/
...
contract SQUIDSTATION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Station";
    string private constant _symbol = "SQUIDSTATION";
    ...
    mapping (address => uint256) private _isgetReflect;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isgetReflect[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isgetReflect[to] = block.timestamp;
        }
