...
contract SOCADOGE
 is Context, IERC20, Ownable {
    ...
    string private _name = " SOCADOGE";
    string private _symbol = " SOCADOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x22E8C0b5cb6Ba301d8B05cd8D800122a1EBE46f6);
    address payable public teamWalletAddress = payable(0x22E8C0b5cb6Ba301d8B05cd8D800122a1EBE46f6);
    address public immutable deadAddress = 0x22E8C0b5cb6Ba301d8B05cd8D800122a1EBE46f6;
