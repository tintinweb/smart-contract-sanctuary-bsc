...
contract Optimu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OPTIMUU"; // 
    string private constant _symbol = "$OPTIMUU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6a97509B89c8980fD0a706A9EF24A04f72A2E5B6;
