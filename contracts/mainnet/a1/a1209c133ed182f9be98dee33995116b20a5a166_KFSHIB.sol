...
contract KFSHIB  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KFSHIB ";
    string private _symbol = "KFSHIB ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xfd27b42Ae0E3b63DbA5027d60CC09d6D9bd2A92D);
    address payable public teamWalletAddress = payable(0xfd27b42Ae0E3b63DbA5027d60CC09d6D9bd2A92D);
