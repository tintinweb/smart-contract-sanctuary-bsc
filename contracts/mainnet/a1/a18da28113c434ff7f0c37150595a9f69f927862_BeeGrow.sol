...
contract BeeGrow is Context, IERC20, Ownable {
    ...
    string private _name = "BeeGrow";
    string private _symbol = "$BeeGrow";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72E90B3bC2c9378F97f6720626Fc34F3fFC78064); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x72E90B3bC2c9378F97f6720626Fc34F3fFC78064); // BuyBack Address
