...
contract SYL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sylvania Finance";
    string private _symbol = "SYL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55241F239602D729571B9fbd70fc86848a0A4311);
    address payable public teamWalletAddress = payable(0xd35cFb7e6581619Cf30ff90774EB6990434eC13b);
