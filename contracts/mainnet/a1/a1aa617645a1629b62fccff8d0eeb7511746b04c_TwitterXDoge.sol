...
Twitter X Doge is a unique token meme, because Elon Musk bought Twitter and he always supports doge,
that's why we created Twitter X Doge,
big potential with push marketing will happen, so don't forget this hype!

☎️ Telegram: https://t.me/TwitterXDogeCoin
🐦 Twitter: https://Twitter.com/TwitterXDogeCoin
*/
...
contract TwitterXDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xACFAf30a9adA55bC6aFae5B7a762fbDD2dA7a8dc));


    string private _name = "Twitter X Dogecoin";
