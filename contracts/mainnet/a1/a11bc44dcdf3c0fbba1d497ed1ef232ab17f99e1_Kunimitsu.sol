...
contract Kunimitsu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kunimitsu Inu";
    string private _symbol = "Kunimitsu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5A70e755Dc33EcCbe224d1437a2A9bcb658E13f0); 
    address payable public buyBackWalletAddress = payable(0x5A70e755Dc33EcCbe224d1437a2A9bcb658E13f0); 
