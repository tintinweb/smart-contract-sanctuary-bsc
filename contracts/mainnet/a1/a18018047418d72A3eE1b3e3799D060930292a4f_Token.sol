...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "KPL";
    string private _symbol = "KPL";
    ...
    address public ownerAddres = address(0xB5aCeF693421bDA274824C6fE06F598CdF71CD5a);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);  //bep20 usdt
    ...
    uint256 public _maxTxAmount = 27000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 8 * 10 **17;
    uint256 public  maxBurn = 13500 * 10 **18;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[to] && to != uniswapV2Pair){
            require((balanceOf(to)+amount) <= 10* 10**18);
        }
        if(from == uniswapV2Pair && !_isExcludedFromFee[to]){
             _taxFee = 0;
             _liquidityFee = 4;
