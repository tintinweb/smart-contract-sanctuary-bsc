...
/**
   #$SZKU The New Community of Ape Token
    
   I make this #$SZKU to hand it over to the community.
   I suggest a Telegram group name for you to create: $SZKU is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/SuzakuBurn
...
contract Suzaku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Suzaku";
    string private constant _symbol = "$SZKU";
