...
contract NFTZP is Base{
    ...
    function BlindBoxOpen(uint256 NFTID,uint256 condition) public  payable {
        ...
        NFT.safeBatchTransferFrom(msg.sender,address(this),_asSingletonArray(NFTID),_asSingletonArray(1),"0x00");
        ...
        NFT.safeBatchTransferFrom( address(this),msg.sender,_asSingletonArray(Num),_asSingletonArray(Num),"0x00");
    ...
    function playerwinning(address playeraddress,uint256 winningNum,uint256 condition) private   returns(uint256)   {
            if( winningNum ==1 ){
                if( condition ==3){
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(9),_asSingletonArray(2),"0x00");
                }
                else if( condition ==2){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(5),_asSingletonArray(2),"0x00");
                }
                else{  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(4),_asSingletonArray(1),"0x00");
                }
            }
            if( winningNum ==2 ){
                if( condition ==3){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(10),_asSingletonArray(2),"0x00");
                }
                else if( condition ==2){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(6),_asSingletonArray(2),"0x00");
                }
                else{  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(1),_asSingletonArray(3),"0x00");
                }
            }
            if( winningNum ==3 ){
                if( condition ==3){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(11),_asSingletonArray(2),"0x00");
                }
                else if( condition ==2){ 
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(8),_asSingletonArray(1),"0x00");
                }
                else{  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(3),_asSingletonArray(1),"0x00");
                }
            }
            if( winningNum ==4){
                if( condition ==3){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(12),_asSingletonArray(1),"0x00");
                }
                else if( condition ==2){  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(7),_asSingletonArray(2),"0x00");
                }
                else{
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(2),_asSingletonArray(2),"0x00");
                }
            }
            if( winningNum ==5 ){
                if( condition ==3){
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(8),_asSingletonArray(2),"0x00");
                }
                else if( condition ==2){ 
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(11),_asSingletonArray(1),"0x00");
                }
                else{  
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(7),_asSingletonArray(1),"0x00");
                }
            }
            if( winningNum ==6 ){
                if( condition ==3){ 
                    PNDV.transfer(USDTaddress, 500);
                }
                else if( condition ==2){ 
                    NFT.safeBatchTransferFrom( address(this),playeraddress,_asSingletonArray(4),_asSingletonArray(2),"0x00");
                }
                else{ 
                    PNDV.transfer(USDTaddress, 1);
                }
            }
            if( winningNum ==7 ){
                if( condition ==3){  
                    PNDV.transfer(USDTaddress, 1000);
                }
                else if( condition ==2){
                    PNDV.transfer(USDTaddress, 5000);
                }
                else{  
                    PNDV.transfer(USDTaddress, 10);
                }
            }
            if( winningNum ==8 ){
                if( condition ==3){  
                    PNDV.transfer(USDTaddress, 10000);
                }
                else if( condition ==2){
                    PNDV.transfer(USDTaddress, 10);
                }
                else{  
                    PNDV.transfer(USDTaddress, 200);
                }
            }
    } 
    ...
    function tbNFT(uint256 NFTID,uint256 amount) public  onlyOwner  {
        NFT.safeBatchTransferFrom(address(this),address(this),_asSingletonArray(NFTID),_asSingletonArray(amount),"0x00");
