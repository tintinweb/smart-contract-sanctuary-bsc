...
contract Sinceredoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**3 * 10**9;
    ...
    string private constant _name = "Qing Hua";
    string private constant _symbol = "Qing Hua";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x68664dfB8F013e3E8eE31BcF910be5450aB75C41);
    address payable private _marketingAddress = payable(0x68664dfB8F013e3E8eE31BcF910be5450aB75C41);
