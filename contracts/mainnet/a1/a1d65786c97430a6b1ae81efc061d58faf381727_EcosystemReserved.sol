...
contract EcosystemReserved is Ownable {
	...
	/* the balances (in INERY) of all ecosystem members */
	mapping(address => uint256) public balanceOfINERY;

	/* the whitelist of the Ecosystem Reserved */
    ...
    function locked(address addr) external afterClosed {
