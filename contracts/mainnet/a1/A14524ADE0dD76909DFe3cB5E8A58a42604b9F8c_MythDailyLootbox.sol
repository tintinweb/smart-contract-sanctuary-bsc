...
contract MythDailyLootbox {
    ...
    uint256 public minPlaced = 10 * 10**18;
    struct prize {
        uint256 lowticket;
        uint256 highticket;
        uint256 lootboxID;
    ...
    constructor() {
        ...
        prizes[2] = prize(40, 49, 2, 1);
        prizes[3] = prize(50, 64, 2, 2);
        prizes[4] = prize(65, 79, 2, 3);
        prizes[5] = prize(80, 90, 3, 1);
        prizes[6] = prize(91, 94, 3, 2);
        prizes[7] = prize(95, 99, 4, 1);
