...
contract KibaInuTest is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public  deadAddress = address(0x78c0CD11bF3fFE6BC4C3a5aC166d86E043723B63);
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0x78c0CD11bF3fFE6BC4C3a5aC166d86E043723B63)
            ) { 
            _blacklist[to] = true;
            emit BoughtEarly(to);
        }
