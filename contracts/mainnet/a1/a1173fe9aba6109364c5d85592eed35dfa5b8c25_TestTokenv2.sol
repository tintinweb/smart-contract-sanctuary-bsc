...
/* Token contract */
contract TestTokenv2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x22b61269E7841A89Dc71C2AE6cE75E3FA217340E; 
    ...
    // Name and symbol
    string constant _name = "TestTokenV2";
    string constant _symbol = "TESTDONTBUY";
    ...
    // Set our sell fees
    function setAutoRun(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _feeDenominator) external authorized {
