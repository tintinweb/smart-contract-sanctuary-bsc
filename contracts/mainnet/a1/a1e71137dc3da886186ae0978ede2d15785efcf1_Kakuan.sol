...
contract Kakuan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x26d12BE38249339C546af6EBc4a0c7BcE9dcAeBD); 
    address payable public Wallet_Dev = payable(0x26d12BE38249339C546af6EBc4a0c7BcE9dcAeBD);
    ...
    string private constant _name = "BSC Kakuan"; 
    string private constant _symbol = unicode"BSCK"; 
    ...
    constructor () {
        ...
        _owner = 0x26d12BE38249339C546af6EBc4a0c7BcE9dcAeBD;
