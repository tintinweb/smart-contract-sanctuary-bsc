...
*/
//fLOKI 2.0 is the fresh launch, working on the biggest hypes right now.
//https://t.me/Flokitwopoinzero
//
...
contract flokitwo is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"FLOKItwo";
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 2, 0, 0);
    Fees public sellFees    = Fees(1, 2, 0, 0);
