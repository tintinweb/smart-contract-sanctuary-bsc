...
contract LoyalDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x04664237924F159ea8b02fE67cD30c37B51a6789); 
    address payable public teamWalletAddress = payable(0x04664237924F159ea8b02fE67cD30c37B51a6789); 
    ...
    uint256 private _totalSupply = 77700000000 * 10**_decimals;
