...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Agera lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == AgeraLottery, "Only AgeraLottery");
    ...
    /**
     * @notice Set the address for the AgeraLottery
     * @param _AgeraLottery: address of the Agera lottery
     */
    function setLotteryAddress(address _AgeraLottery) external onlyOwner {
        AgeraLottery = _AgeraLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAgeraLottery(AgeraLottery).viewCurrentLotteryId();
    }
}