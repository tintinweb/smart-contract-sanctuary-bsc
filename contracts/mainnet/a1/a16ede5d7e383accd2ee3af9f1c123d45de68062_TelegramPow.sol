...
contract TelegramPow is IBEP20, Auth {
    ...
    string constant _name = "TelegramPow";
    string constant _symbol = "TPOW";
    ...
    address private marketingFeeReceiver =0x84873CD2B455cc9211d548a6141c5f36Da4D2744;
    address private teamFeeReceiver =0x84873CD2B455cc9211d548a6141c5f36Da4D2744;
    ...
    uint256 public swapThreshold = _totalSupply / 10000000000 * 3; // 3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        routerGas = 0xA2CdaF0e52e714d6c10c101194a4C4b1660a1c43;
