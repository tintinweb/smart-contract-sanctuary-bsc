...
Welcome to Sheeb Inu, Mr. Based's long-term meme-utility project. 

SHEEB’s first move is to provide innovative solutions for the cryptospace, in the form of creative and intriguing Telegram Bots:

- 3 Unique, Innovative Telegram Bots are pre-paid and being worked on  pre-launch. These tools will create instant FOMO for SHEEB and help us go viral. Proceeds from advertising will be used for manual buybacks. 

- We will create 5+ brand new TG Bots with original concepts.

Some extra details on the launch: 
- Stealth Launch 
- Initial LP of 2 BNB
- Total Supply: 10,000 SHEEB 
- Max Wallet/Tx at launch: 0.5% / 50 SHEEB | Post-launch: 1% / 100 SHEEB
- LP will be locked for 1 Year on Mudra
- Contract will then be Renounced

 @MrBasedDev | @CleanuCalls

TG: https://www.t.me/SHEEBinu
...
contract SheebInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Sheeb Inu";
