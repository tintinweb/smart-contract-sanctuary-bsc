...
contract NewCommunityTwoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Twoge";
    string private _symbol = "NTwoge";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x35ae3Cf01BCA3C2C27e7533855a8b44E7E7a7efA); // Marketing Address
    address payable public teamWalletAddress = payable(0x35ae3Cf01BCA3C2C27e7533855a8b44E7E7a7efA); // Team Address
