...
contract SANTAGALA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SANTAGALA";
    string private _symbol = "$STG";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x74120F2e2Acf1fe1A145aD1696f019fF714E41F2); // Marketing Address
    address payable private TeamWallet = payable(0x2cB366F2E62613Fe75a5e59baaBf006a80CEb081); // Buy Back Address
