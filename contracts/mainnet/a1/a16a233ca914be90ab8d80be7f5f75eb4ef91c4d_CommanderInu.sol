...
// Telegram https://t.me/CommanderInu_official
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e96B8F594E6cd9b413615FFBE0F5D45B44ab869; // owner address
...
contract CommanderInu is Context, IERC20, Ownable {
    ...
    string private _name = "CommanderInu";
    string private _symbol = "CommanderInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e96B8F594E6cd9b413615FFBE0F5D45B44ab869); // Marketing Address
    address payable public teamWalletAddress = payable(0x2e96B8F594E6cd9b413615FFBE0F5D45B44ab869); // Team Address
