...
contract OneCoin is Context, IERC20, Ownable {
    ...
    string private _name = unicode"OneCoin";
    string private _symbol = unicode"OneCoin";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xAC84DEf21C514c138aE3fcB8cB8A2771A7465459); 
    address payable public BurnedWalletAddress = payable(0xAC84DEf21C514c138aE3fcB8cB8A2771A7465459); 
