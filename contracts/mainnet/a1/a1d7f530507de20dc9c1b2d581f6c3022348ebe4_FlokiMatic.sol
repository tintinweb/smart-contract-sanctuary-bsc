...
contract FlokiMatic is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BabyChikuInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("FlokiMatic", "FLOKIMATIC") {
		...
		contractTokenBalanceAmount = 100000000000 * 10**18;
		...
		marketingWallet = payable(0x53fD83c9b05D0b74311a69AeDd663789475C862f);
        _devWallet = payable(0x53fD83c9b05D0b74311a69AeDd663789475C862f);
	...
	function letsGoLive() external onlyOwner() {
        updateBuyFees(1,1,1,1);
        updateSellFees(1,1,1,96);
