...
contract ZH28 is Context, IBEP20, Ownable {
    ...
    string private _name = "ZH28";
    string private _symbol = "ZH28";
    ...
    function setStartTimeForSwap(uint256 times) external onlyOwner {
        if (times == 0) {
            _startTimeForSwap = block.timestamp;
        }else{
            _startTimeForSwap = times;
        }
    }
