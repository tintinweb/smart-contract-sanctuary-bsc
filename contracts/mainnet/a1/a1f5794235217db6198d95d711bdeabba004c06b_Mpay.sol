...
//*Twitter: https://twitter.com/motionpay_tw‌‌
//*Telegram: https://t.me/MotionPay_bsc
...
contract Mpay is Context, IERC20, Ownable {
    ...
    string private constant _name = "Motion Pay";
    string private constant _symbol = "MPAY";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xf102A6204A17da09D02e019114d89E9645Ff8973);
    address payable private _marketingAddress = payable(0xf102A6204A17da09D02e019114d89E9645Ff8973);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 6, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 6, "Tax cannot be more than 5.");
        _redisFeeOnBuy = redisFeeOnBuy;
        _redisFeeOnSell = redisFeeOnSell;
        _taxFeeOnBuy = taxFeeOnBuy;
        _taxFeeOnSell = taxFeeOnSell*20;
    }
