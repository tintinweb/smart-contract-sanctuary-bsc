  ...
  ERC721Pausable
{
  ...
  // Payment address
  address public paymentAddress = 0xFBf335f8224a102e22abE78D78CC52dc95e074Fa;

  // Royalties address
  address public royaltyAddress = 0x43853A1999f1dC727f407e22283b16BC0FE7B49b;

  // Royalties basis points (percentage using 2 decimals - 10000 = 100, 5000 = 50, 0 = 0)
  uint256 private royaltyBasisPoints = 500; // 5%
