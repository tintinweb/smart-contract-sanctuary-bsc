...
Telegram: https://t.me/Fukurocoinbsc
...
contract FUKUROCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUKURO COIN";
    string private _symbol = "FUKURO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x778A1DAd9baEC508D4fE0BA275D026E2C3Cb9B82); 
    address payable public DevelopmentalWalletAddress = payable(0x6359dC6Ae899d54dCA87029f90F6eE51f88d735F); 
