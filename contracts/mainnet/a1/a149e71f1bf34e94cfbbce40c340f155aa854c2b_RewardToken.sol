...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RnS = IBEP20(0x58aB32E7C2458428668beD3A4becb275553bc1dF);
    ...
    uint256 public minDistribution = 1000000000 * (10**9); // 1,000,000,000 RnS minimum auto send
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RnS.balanceOf(address(this));
        ...
        uint256 amount = RnS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            RnS.transfer(shareholder, amount);
...
contract RewardToken is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public _maxWallet = 4500000000 * (10**_decimals);
    ...
    uint256 totalFee = burnFee.add(reflectionFee).add(marketingFee).add(charityFee);
    uint256 feeDenominator = 10000;

    string constant _name = "RewardTest";
    string constant _symbol = "RewTest";
    ...
    function _transferFrom(
        ...
        checkMaxWalletLimit(sender, amount);
    ...
    function checkMaxWalletLimit(address recipient, uint256 amount) internal view {
        uint256 contractBalanceRecepient = balanceOf(recipient);
        
        require(
            contractBalanceRecepient + amount <= _maxWallet || excludeMaxWallet[recipient],
    ...
    function swapBack() internal swapping {
            ...
            )
        {
            ...
            payable(charity).call{value: amountBNBCharity, gas: 30000};
            //payable(marketing).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function setFees(
        ...
        totalFee = _burnFee.add(_reflectionFee).add(_marketingFee).add(_charityFee);
    ...
    function setCharityWallet(address _charity) external onlyOwner {
        charity = _charity;
    }
