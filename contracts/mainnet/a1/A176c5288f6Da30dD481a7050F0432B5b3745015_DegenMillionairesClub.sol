...
contract DegenMillionairesClub is Context, IERC20, Ownable {
    ...
    uint256 public _totalReducedSellTax = 5;
    ...
    modifier onlyStaker() {
        require(_msgSender() == staker, "Ownable: caller is not the owner");
        _;
    }
    ...
    function includeAccountInt(address account) internal {
    ...
    function _setTotalReducedBuyTax(uint256 totalReducedBuyTax) external onlyOwner() {

        require(totalReducedBuyTax <= _maxSellTax, "Reduced sell tax too high");

        _totalReducedBuyTax = totalReducedBuyTax;
    }

    function _setTotalReducedSellTax(uint256 totalReducedSellTax) external onlyOwner() {

        require(totalReducedSellTax <= _maxSellTax, "Reduced sell tax too high");

        _totalReducedSellTax = totalReducedSellTax;
    }
