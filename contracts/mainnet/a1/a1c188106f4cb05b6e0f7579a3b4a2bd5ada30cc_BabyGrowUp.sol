...
Telegram Chat : https://t.me/babygrowup
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06466B3E24579dB81Cc6C06FD9e562e723030e42; // owner address
...
contract BabyGrowUp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Grow Up";
    string private _symbol = "BGROWUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06466B3E24579dB81Cc6C06FD9e562e723030e42); // Marketing Address
    address payable public teamWalletAddress = payable(0x06466B3E24579dB81Cc6C06FD9e562e723030e42); // Team Address
