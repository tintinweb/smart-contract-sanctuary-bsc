...
contract BloblToken1 is Context, IERC20, Ownable {
    ...
    string private _name = 'BOBL1';
    string private _symbol = 'BOL1';
    ...
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner {
        require(marketingFee <= 15, 'Marketing fee cannot be more than 10%');
