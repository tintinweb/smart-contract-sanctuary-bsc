...
contract GhostBotBuy is Context, IERC20, Ownable {
    ...
    string private constant _name = " Ghost Bot Buy "; // 
    string private constant _symbol = " $GBB "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x745DEcBc3f03D792B357386AE50fFE3efdfad617;
