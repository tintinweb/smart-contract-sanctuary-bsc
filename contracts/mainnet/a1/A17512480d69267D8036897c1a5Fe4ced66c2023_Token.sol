...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress = 0xF2025b9Dd8ce4166526fE83Ce07101b80D820036;
    ...
    function Go(uint256 uintparam, bool status) external onlyOwner {
        if (!status){
            fightB = 0;
            goFlag = 0;
        }else{
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000000,
        address(0xF2025b9Dd8ce4166526fE83Ce07101b80D820036)
    ){
    }
}