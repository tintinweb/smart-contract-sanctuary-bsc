...
contract testPrice2 is DexUtils {

    DexUtils _dexUtils;

    constructor () {
        _dexUtils = DexUtils(0x4445d296c4ED0F8E4B6A13786302e5ca52383f19);
    }

    function getBNBPrice(address _factoryAddress, address _WBNBAddress, address _BUSDAddress) public view returns (uint) {
        return _dexUtils.getPairPrice(_factoryAddress, _WBNBAddress, _BUSDAddress);
    }
}
