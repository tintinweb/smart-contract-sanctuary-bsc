...
// ENGLISH TG PORTAL: https://t.me/babydejitarubsc
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    uint256 private _token1DividendRewardsFee = 2;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("BabyDejitaruTsuka", "Btsuka", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract BabyDejitaruTsuka is Main {

    constructor() Main (
        "BabyDejitaruTsuka",       // Name
        "Btsuka",        // Symbol
        9,                  // Decimal
        0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,     // Reward 1
        0xd72Ae35A51856d84AfCe84d0e8ceb78ce482Ce6e,     // Marketing address
        0xd72Ae35A51856d84AfCe84d0e8ceb78ce482Ce6e,     // Team address AND DEV
        0xd72Ae35A51856d84AfCe84d0e8ceb78ce482Ce6e,     // Multi Use address 
