...
contract OnlyPOD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only Proof of Degen"; // 
    string private constant _symbol = "$ONLYPOD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x0e128825c492164CbE6ea0a671903A2B25F840Ff;
