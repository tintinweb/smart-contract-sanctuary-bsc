...
contract BinanceGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BinanceGrow";
    string private _symbol = "BinanceGrow";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5AF93603248BC7C73B33D01a7c353e1dce6DD3d7); // Marketing Address
    address payable public teamWalletAddress = payable(0x5AF93603248BC7C73B33D01a7c353e1dce6DD3d7); // Team Address
