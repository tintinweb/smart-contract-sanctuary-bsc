...
contract CA is Context, IERC20, Ownable {
    ...
    string private _name = "LIFTON!";
    string private _symbol = "LIFTON!";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x823f04084F8bDc6bd6c24226B98f55f18e389Fa9));
        marketingWalletAddress = payable(address(0xd1d19389b99c73c88c49115bE6a8ba93D69c16Be));
