...
contract banana is Context, IERC20, Ownable {
    ...
    uint256 private _marketingFee = 1000;
    uint256 public _totalTax = (_liquidityFee * 100) +(_taxFee * 100) + _marketingFee;
    ...
    uint256 public _maxTxAmount = _tTotal / 100;      // 1.0%
    uint256 public _maxWallet = _tTotal / 25;  // 4%%
    ...
    constructor () {
        ...
        IPYESwapPair(pyeSwapPair).updateTotalFee(_marketingFee);
    ...
    function _transfer(
        ...
        if(from == pyeSwapPair && to != marketingWallet) {
