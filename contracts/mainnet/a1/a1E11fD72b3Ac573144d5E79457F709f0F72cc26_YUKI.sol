 ...
 * Oficial Yuki Inu, stripped down to just add/sub/mul/div
 */
library SafeMath {
...
contract  YUKI is IBEP20, Auth {
    ...
    address DEV =  0x28453B11E869430560f6E7F6256aBbB63e6c6F73;
    ...
    // Total supply
    uint256 _totalSupply = 600000000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 600 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 600 / 1000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE7D85C0473327606D28a119FFF895FAeB7532c0B;
