...
contract KISSAN_CHARITY is ReentrancyGuard, Ownable {
    ...
    function lock(address _beneficiary, uint256 _amount, uint256 _order_id) public nonReentrant {
        ...
        // uint256 lockForTime = uint256(block.timestamp) + 31536000;
        uint256 lockForTime = uint256(block.timestamp) + 86400;
        ...
        emit LockForOneDay(_order_id, msg.sender, _beneficiary, _amount, lockForTime, block.timestamp);
    }
