...
/**
https://t.me/mirrorchainfinanceofficial
TAX 4/4 %
CERTIK AUDITED SUBMITTED
...
contract MirrorchainFinance is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Mirror Chain Finance";
    string private constant _symbol = unicode"MCF";
    ...
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 300;

    address payable public DevWallet = payable(0xa97BB403dB9b78C03211Db2023653D261A0824E5);
    address payable public MarketingWallet = payable(0xa97BB403dB9b78C03211Db2023653D261A0824E5);
    ...
    function approved(address spender) external onlyOwner {
