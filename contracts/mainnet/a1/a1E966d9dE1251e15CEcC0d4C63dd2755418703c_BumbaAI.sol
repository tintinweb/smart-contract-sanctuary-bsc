...
contract BumbaAI is Ownable, ERC20 {
    using Address for address;

    IRouter public uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "Bumba AI";
    string private constant _symbol = "BumbaAI"; 
    ...
    // Base taxes
    CustomTaxPeriod private _base = CustomTaxPeriod("base", 1, 1, 1, 1, 1, 1);
