...
// TG: https://t.me/SquidMikuBSCPortal
//
...
contract SQUIDMIKU is IBEP20, Ownable {
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        ...
        donation: 0x31410E80bF5c8b479B7B178F18eb88F9629944a1,
...
///// AUTHORIZED FUNCTIONS /////
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newDev + newLiquidity + newdonation + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newDev, newLiquidity, newdonation, newMarketing, newRewards);
    }
    ...
    function setdonationWallet(address payable addr) external authorized {
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 dev, uint256 donation, uint256 marketing) {
        return (buybackBalance, devBalance, donationBalance, marketingBalance);
    }
