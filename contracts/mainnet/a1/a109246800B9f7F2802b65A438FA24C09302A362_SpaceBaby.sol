...
contract SpaceBaby is Context, IERC20, Ownable {
    ...
    string private constant _name = "Space Baby"; // 
    string private constant _symbol = "Space Baby"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x73Cb7AFB581f3ED9e945399765565AbE998982c7
);
