...
// Telegram: https://t.me/HariboInu

// Twitter: https://twitter.com/HariboInu
...
contract HariboInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x84e4265CF059F3Fd34c21F1E9FDddD6e0F8381dA); 
    address payable public Wallet_Team = payable(0xf676084bF72240cBD10c179d117CE1727f8fE932);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x08Ced33A88c0E343E54A0Ac716Ca853872a975CC); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Haribo Inu"; 
    string private constant _symbol = unicode"HARIBO"; 
    ...
    constructor () {
        ...
        _owner = 0x08Ced33A88c0E343E54A0Ac716Ca853872a975CC;
