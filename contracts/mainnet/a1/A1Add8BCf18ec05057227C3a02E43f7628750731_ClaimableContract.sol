...
contract ClaimableContract {
    ...
    uint256 public amountPerUser = 12500 ether;
    ...
    function Airdrop(address[500] memory participants) public onlyOwner {
    ...
    function changeToken(uint256 _amount) external onlyOwner {
