...
contract Superalleluia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Superalleluia";
    string private _symbol = "Superalleluia";
    uint8 private _decimals = 0;

    address payable private marketingWalletAddress = payable(0x114061e2a2f677D5902AB5B35706c3394C7195B9); 
    address payable private teamWalletAddress = payable(0x114061e2a2f677D5902AB5B35706c3394C7195B9); 
    ...
    uint256 private _totalSupply = 59 * 10**25;
    uint256 public _maxTxAmount = 59 * 10**25; 
    uint256 public _walletMax = 59 * 10**25;
    uint256 private minimumTokensBeforeSwap = 59 * 10**25;
