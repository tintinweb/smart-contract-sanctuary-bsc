...
contract GERMA66Inu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xd46f11E49A45F84fDF730998CFaF6cDbff3d5138;
    string constant _name = "Germa66 Inu";
    string constant _symbol = "GERMA 66";
