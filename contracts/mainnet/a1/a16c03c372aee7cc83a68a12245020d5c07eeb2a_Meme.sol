...
contract Meme is Context, IERC20, Ownable {
    ...
    address payable public sweepWalletAddress = payable(0x13EAe66bE1f5f4E8DB49ce1cBbA74fd106C11e9a); // Marketing Wallet Address
    address payable public devWalletAddress = payable(0x3fB5De05f5B0676aa4569feAC0A66dB5b9070e94); // dev Wallet Address
    ...
    uint256 public _sweepFee = 2; 
    uint256 private _previousSweepFee = _sweepFee;    

    uint256 public totalSwapableFee = _liquidityFee + _devFee +  _sweepFee;

    uint256 _saleTaxFee = 2;
    uint256 _saleLiquidityFee = 2;
    uint256 _saleSweepFee = 2;
    uint256 _saleDevFee = 1;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleSweepFee;


    uint256 public liquidityTokensCollected = 0;
    uint256 public devTokensCollected = 0;
    uint256 public sweepTokensCollected = 0;
    ...
    constructor () {
        address _owner = 0x3fB5De05f5B0676aa4569feAC0A66dB5b9070e94;
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + sweepTokensCollected;

        uint256 ethForMarketing = (newBalance * sweepTokensCollected)/walletsTotal;
        
        uint256 ethForDev = (newBalance * devTokensCollected) / walletsTotal;

        transferToAddressETH(sweepWalletAddress, ethForMarketing);
        
        transferToAddressETH(devWalletAddress, ethForDev);

        liquidityTokensCollected = 0;
        devTokensCollected = 0;
        sweepTokensCollected = 0;
    ...
    function setSaleFee() private {
        ...
        _devFee = _saleDevFee;
        _sweepFee = _saleSweepFee;
        totalSwapableFee = _liquidityFee + _devFee + _sweepFee; 
    }
    ...
    function countUpFeeShare(uint256 amount) private
    {
        ...
        sweepTokensCollected += (amount *_sweepFee)/100;
    ...
    function setMarketingWalletAddress(address _marketingWallet) external onlyOwner() {
        ...
        sweepWalletAddress = payable(_marketingWallet);
        emit AuditLog("We have Updated the MarketingWallet:", sweepWalletAddress);
    }
