...
// File: contracts/lootBox/LootboxLegendary.sol
...
contract LootboxLegendary is Ownable {
  ...
  constructor(IMintToken _nftAddress, address _router, uint _secondaryParamsCount) public {
    ...
    uint[] memory jackets = new uint[](7);
    jackets[0] = 10;
    jackets[1] = 10;
    jackets[2] = 10;
    jackets[3] = 9;
    ...
    uint[] memory gradients = new uint[](4);
    gradients[0] = 10;
    gradients[1] = 10;
    gradients[2] = 10;
    gradients[3] = 10;
    ...
    uint[] memory accessories = new uint[](5);
    accessories[0] = 10;
    accessories[1] = 10;
    accessories[2] = 9;
    accessories[3] = 8;
