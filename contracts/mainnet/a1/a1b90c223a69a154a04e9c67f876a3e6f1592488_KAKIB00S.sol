...
contract KAKIB00S is Context, IERC20, Ownable {
    ...
    string private constant _name = "KAKIBOOS";
    string private constant _symbol = "KAKIBOOS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xa3881805FdC350613570F56A8142B628D64D3D30);
    address payable private _marketingAddress = payable(0xa3881805FdC350613570F56A8142B628D64D3D30);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 7, "Redis cannot be more than 7.");
	    require(redisFeeOnSell < 96, "Redis cannot be more than 96.");
	    require(taxFeeOnBuy < 7, "Tax cannot be more than 7.");
