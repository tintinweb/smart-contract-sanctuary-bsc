...
// IJRI/SAM ----> Moneda Digital SicloAr
...
contract SicloArERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("SicloAr", "SAR", 18) 
    ERC20Permit("SicloAr") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 70000000000000000000000000000); 
