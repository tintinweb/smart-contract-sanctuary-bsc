...
contract Token is ERC20 {
    ...
    constructor()  payable ERC20("whaa token", "WHAA") {
       ...
       //address routerContract=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;//pancake router-bnbtest
        ...
        //excludeFromFees(_swapContract1,true);
        excludeFromFees(address(_tokenDistributor),true);
        
        _totalFeeAddress=0xEf67a16874A28D64cF883D0F723C3888f8028E1D;
    ...
    function _transfer(
        ...
        if(swapTime>0 ){
            ...
            else if(_automatedMarketMakerPairs[from] ){//&& to!=address(this)
            ...
            else if(_automatedMarketMakerPairs[to] ){//&& from!=address(this)
        ...
        if (leftToLiquify>0 && enableLiquify && !inSwapAndLiquify && _automatedMarketMakerPairs[to] && !_isExcludedFromFees[from] ) {
