...
contract LOGE is IERC20 {
    ...
    string constant private _name = "LOGE";
    string constant private _symbol = "LOGE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xbcE9Fa31875b5C916964DFea62E40801F34858D0),
        operations: payable(0x1196211081878CAdC4ddad3A0A57c9BCb2959F23),
        liquidity: 0x5795C51DF566AB650Cac68857Eb9208905C000Ba
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 operations) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.operations = operations;
        _ratios.totalSwap = liquidity + marketing + operations;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable operations, address payable liquidity) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 marketingBalance = amtBalance - operationsBalance;
