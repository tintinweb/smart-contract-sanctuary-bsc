...
contract THROTTLE is Ownable {
    ...
    constructor () {
        address _tokenAddr = 0xf7e6A1C9b55002d101FC90E9187D7f68E306d319; 
    ...
    function TTL(address[] dests, uint256[] values) external whenDropIsActive onlyOwner {
        uint i = 0;
