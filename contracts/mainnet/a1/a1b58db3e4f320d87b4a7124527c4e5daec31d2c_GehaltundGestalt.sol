...
//Gehalt und Gestalt is a community token with safe code
contract GehaltundGestalt is IERC20, Ownable {
    ...
    string _name = "Gehalt und Gestalt";
    string _symbol = unicode"GnG";
