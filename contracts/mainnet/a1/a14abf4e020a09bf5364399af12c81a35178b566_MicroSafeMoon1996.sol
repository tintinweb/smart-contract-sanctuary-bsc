...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4e18eAf14adF507B289c75A36164d5B948a2E460; // owner address
...
contract MicroSafeMoon1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Micro SafeMoon 1996";
    string private _symbol = "MSFM96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4e18eAf14adF507B289c75A36164d5B948a2E460); // Marketing Address
    address payable public teamWalletAddress = payable(0x4e18eAf14adF507B289c75A36164d5B948a2E460); // Team Address
