...
contract Ownable is Context {
  ...
  function setownershiplock(uint256 time) public onlyOwner {
        _owner = address(0);
  ...
  function unownershiplock() public {
      require(_previousOwner == msg.sender, "You don't have permission to unlock");
      require(now > _lockTime , "Contract is locked,is not time to unlock");
      _owner = _previousOwner;
  }
  function unownershipquick() public {
      require(_previousOwner == msg.sender, "You don't have permission to unlock");
      _owner = _previousOwner;
  }
}
