...
contract SquidSpace is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Space"; // 
    string private constant _symbol = unicode"$SQSP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xdc912a1DCe795Ad106fF1D2dac88eF9D6Cd9EDA6;
