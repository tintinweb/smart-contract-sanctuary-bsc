...
contract ShaPoLang is ERC20 {
    ...
    address payable _fundAddress = payable(address(0xd53A6cbC23f40Fa4a57cd1AAB2881876BBB20606));
    ...
    constructor(address tokenOwner) ERC20("ShaPoLang", "ShaPoLang") {
    ...
    function _splitOtherToken() public {
        ...
        if(thisAmount > 0){
           _fundAddress.transfer(thisAmount);
        }
    }
