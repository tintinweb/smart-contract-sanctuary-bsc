...
interface IRouter {
    ...
    contract ArabianShiba is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 150_000_000 * 10**18;
    uint256 public maxSellLimit = 150_000_000 * 10**18;
    ...
    address public marketingWallet = 0x1317Ec2080923bbAA25f0d15f366EB921754b8eE;
    ...
    constructor(address routerAdd) ERC20("Arabian Shiba", "ASHIB") {
