...
contract Only8 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only 8"; // 
    string private constant _symbol = "O8"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC499e0da833823a4011628A60b0eF8FDF284facC;
