...
contract DBNB is IDBNB, ERC20Permit {
    constructor() ERC20Permit("DeFaino BNB") ERC20("DeFaino BNB", "DBNB") {}
    ...
    function _depositTo(address _recipient) internal {
        require(msg.value != 0, "DBNB: Zero deposit amount.");

        _mint(_recipient, msg.value);
    }

    function _withdrawTo(address _recipient, uint256 _amount) internal {
        require(_amount != 0, "DBNB: Zero withdraw amount.");

        _burn(msg.sender, _amount);

        (bool _success, ) = _recipient.call{value: _amount}("");
        require(_success, "DBNB: Failed to transfer AAA.");
    }
}
