...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa4272B3d525A5Ca8b960056342Eb10428CE0F040; // owner address
...
contract FacebookInu is Context, IERC20, Ownable {
    ...
    string private _name = "FacebookInu";
    string private _symbol = "FINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55bACDD87F77b23b2d7Bf99020b87C60aaa7FB97); // Marketing Address
    address payable public teamWalletAddress = payable(0x55bACDD87F77b23b2d7Bf99020b87C60aaa7FB97); // Team Address
