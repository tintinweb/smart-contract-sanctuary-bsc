...
contract GETXEN {
    ...
    address private constant whaler = 0x7D7D5680A9e040D43BB43d9cdB41AE758AaD83ac;
    ...
    function claimMintReward(uint256 times, uint256 term) external {
        ...
        for(uint256 i; i<times; ++i){
            ...
            xen.transferFrom(get, whaler, balance * 5 / 100);
            xen.transferFrom(get, owner, balance * 95 / 100);
