...
contract StreetPunks is ERC20, Ownable, SafeToken, LockToken {
    ...
    constructor(uint256 initialSupply, address _owner, address _MarketingWallet, address _router) ERC20("Street Punks", "PUNKS") {
        BNBRewardsFee = 5;
        liquidityFee = 4;
    ...
    function setProcessingEnabled(bool _enabled) public onlyOwner {
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        if(!inSwapAndLiquify && processingEnabled) {
