...
contract SummerFlokiInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe2b970DC52d64F256Ec28ce0830bf1b776Bf04d9); // Marketing Address
        
    address payable public teamAddress =
        payable(0xD41f1cB16daFC10A2f3C5F6112684f98edFb48E4); // Team Address
        
    address payable public liquidityAddress =
        payable(0xe2b970DC52d64F256Ec28ce0830bf1b776Bf04d9); // Liquidity Address
    ...
    string private constant _symbol = "smFlokInu";
