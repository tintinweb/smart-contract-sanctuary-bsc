...
Shikba Inu is a new meme project that intends to combine the powers of two strong projects that have been sold out by Vitalik.

💹 Telegram https://t.me/SHIKBABSC
...
contract SHIKBA is Context, Bep20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100000 * 10**9 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Shikba Inu';
    string private _symbol = 'SHIKBA';
