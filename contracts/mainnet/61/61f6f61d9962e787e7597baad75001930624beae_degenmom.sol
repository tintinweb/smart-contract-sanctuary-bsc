...
contract degenmom is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "DegenMOM";                                          // name
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xF7c51AC36721D545148269603539F250da9CCea5),                             // 
        payable(0xB1F7CED839ECf23Fc774aa083b8628d1Ccc651EF)                              // Marketing wallet
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x9613180A6cbEccd7a0C1d91001A6fa7A2Ec82050, 'We can not exclude Uniswap router.');
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "DegenMOM is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "DegenMOM is not live yet");
