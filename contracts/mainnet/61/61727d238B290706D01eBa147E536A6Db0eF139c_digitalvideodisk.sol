...
contract digitalvideodisk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "digitalvideodisk";
    ...
    function sendgas(uint256 _amount) private view returns (uint256) {
    ...
    function choosetoken(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function supplyamount(uint256 maxWallPercent) external onlyOwner {
