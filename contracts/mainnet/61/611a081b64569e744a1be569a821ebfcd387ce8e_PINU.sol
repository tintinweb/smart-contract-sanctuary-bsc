...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE236a12EF47995619232Aa5b904AfD1d1cBE5e3c; 
...
contract PINU is Context, IERC20, Ownable {
    ...
    string private _name = "PINK INU";
    string private _symbol = "PINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE236a12EF47995619232Aa5b904AfD1d1cBE5e3c); // 
    address payable public teamWalletAddress = payable(0xE236a12EF47995619232Aa5b904AfD1d1cBE5e3c); // 
