...
contract THEDRAGONKING is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "THE DRAGON KING";
    string private _symbol = "THE DRAGON KING";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3BB1BB8Aa03D66BfeDe1BbED3dd780853CbD6962);
