...
// 
//
// 📱 Telegram:https::https://t.me/+xADNd1OPOVk2M2E1
...
contract $DEVISDOKWON is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("DEVISDOKWON", "DEVISDOKWON") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "DEVISDOKWON";
    string private _symbol = "DEVISDOKWON";
