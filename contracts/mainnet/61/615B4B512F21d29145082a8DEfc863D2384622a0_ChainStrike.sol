...
/**               
ChainStrike 
💥An action-packed shooter game that enables players to collect resources from the gameplay 💥
Telegram : https://t.me/ChainStrikeFPS
Website : https://chainStrike.io
...
contract ChainStrike is ERC20, Ownable {
    ...
    ChainStrikeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ChainStrike", "CStrike") {
        marketingWallet = payable(0x6F1881c77F2e17C65824a81354f677B7b8bdD9CF);
        devWallet = payable(0x43Bf3525a98B47aB508CF0843E4fe6a49B393481);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 0;
        sellMarketingFees = 95;
        buyLiquidityFee = 0;
        sellLiquidityFee = 0;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new ChainStrikeDividendTracker(
            payable(this),
            router,
...
contract ChainStrikeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ChainStrike public ChainStrikeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ChainStrikeContract = ChainStrike(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ChainStrike_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ChainStrike_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ChainStrike contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ChainStrikeContract);

            uint256 prevBalance = ChainStrikeContract.balanceOf(address(this));
            ...
            {
                uint256 received = ChainStrikeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ChainStrikeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
