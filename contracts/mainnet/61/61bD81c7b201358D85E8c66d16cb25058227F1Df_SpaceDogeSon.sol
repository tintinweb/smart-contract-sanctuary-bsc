...
contract BaseToken is Ownable {
    ...
    string constant public name = 'SpaceDogeSon';

    string constant public symbol = 'SpaceDogeSon';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 10000000000000*10**uint256(decimals);

    uint256 public constant MAXSupply = 100000000000000000 * 10 ** uint256(decimals);
...
contract SpaceDogeSon is BaseToken {
