...
contract SupremoFinance is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    // buy tax fee
    uint256 public reflectionFeeOnBuying = 20; // 5% will be distributed among holder as MATIC divideneds
    uint256 public liquidityFeeOnBuying = 40; // 3% will be added to the liquidity pool
    ...
    // sell tax fee
    uint256 public reflectionFeeOnSelling = 20; // 8% will be distributed among holder as MATIC divideneds
    uint256 public liquidityFeeOnSelling = 40; // 3% will be added to the liquidity pool
