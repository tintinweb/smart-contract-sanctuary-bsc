...
contract Mdate is NFToken {
    ...
    mapping(uint256 => uint256[]) public typeToIds;
    ...
    internal  validNFToken(_tokenId)  {
        all[_tokenId] =  starall(_uri,_type);
        typeToIds[_type].push(_tokenId);
    }
    function totalSupply() external view returns (uint256) {
...
contract zNFTCONTRACT is Mdate,Ownable{
        ...
        onlyManager
    {
        ...
        super._mint(_to, _tokenId);
        super._setTokenstarall(_tokenId,_uri,_type);
    }
