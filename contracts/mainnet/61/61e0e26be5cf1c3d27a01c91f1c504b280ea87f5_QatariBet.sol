...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 private RWRD = IERC20(0x55d398326f99059fF775485246999027B3197955);
...
//
contract QatariBet is IERC20, Ownable {

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private DEV = 0xC726Ac99258552bFa2AbaABA47126a8335400299;

    string constant _name = "Qatari Bet";
    string constant _symbol = "QB";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply = 202_220_222_022_202_000 * 10**_decimals;
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + betFee + devFee;
    ...
    address payable private betFeeReceiver;
    ...
    constructor () {
        ...
        marketingFeeReceiver = payable(0x96Ca41338fC91d81544eF5DD6b6B7BF6b0154190);
        devFeeReceiver = payable(0xA8a2b666D1A9b7aF88EdDC520a92653fF9A99A2b);
        betFeeReceiver = payable(0x35dA534dF2c07f83ea04172Cf72e51b245CcEcC3);

        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        isDividendExempt[marketingFeeReceiver] = true;
        isDividendExempt[devFeeReceiver] = true;
        isDividendExempt[betFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbetFee = amountBNB * (betFee) / (totalBNBFee);
        ...
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
            ...
            if(amountBNBbetFee > 0){
                (bool cexSuccess,) = payable(betFeeReceiver).call{value: amountBNBbetFee, gas: 30000}(""); 
                cexSuccess = false;
            }
    ...
    function setFeeReceivers(address _cexReceiver, address _marketingFeeReceiver, address _devFeeReceiver) external onlySafuDeveloper {
        require(!cannotChangeMore,"Owner has locked fees");
        betFeeReceiver = payable(_cexReceiver);
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external onlySafuDeveloper {
        distributor.setDistributionCriteria(_minPeriod, _minDistribution);
    }

    function setDistributorSettings(uint256 gas) external onlySafuDeveloper {
