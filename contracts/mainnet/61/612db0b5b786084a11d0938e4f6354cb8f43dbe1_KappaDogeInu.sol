...
contract KappaDogeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Developer = payable(0x28242f9894d1d7d8ecc6f91Ebc598b38D8558Bf7);
    ...
    uint256 public Percent_Liquidity = 50;

    uint256 public _maxWalletToken = 1 * 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x28242f9894d1d7d8ecc6f91Ebc598b38D8558Bf7;
