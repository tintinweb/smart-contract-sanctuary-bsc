...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9CF5Ef0fd4532242C83ef3A5568fDb2a37E05ceE;
...
contract ELONGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON GOLD"; // 
    string private constant _symbol = "$ELONGOLD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x9CF5Ef0fd4532242C83ef3A5568fDb2a37E05ceE);
