...
Smart contract audit:Spade Solidity
Locked LP: 900 Days
You can buy tokens on PancakeSwap

Tokenomics: 

Total Supply: 100,000,000 mCAT
Liquidity Pool PancakeSwap: 80,000,000 mCAT
For Primary Staking Pool: 5,000,000 mCAT
LABS: 5,000,000 mCAT
Prize Pool: 5,000,000 mCAT
Road Map: 5,000,000 mCAT

Provision Liquidity Pool - 2%
Phase II - 3%
Burn - 2%
Slippage when buying 7-9% (sometimes more).

Web site: https://www.metacaT.finance/
Documentation: https://docs.metacaT.finance/

Telegram: https://t.me/MetaCAT_Platform
Telegram Bot and Referral Program: https://t.me/MetaCAT_bot
...
contract MetaCAT is Context, IERC20, Ownable {
    ...
    address private IDO_FOUNDATION;
    ...
    uint256 minTokensBeforeSwap = 50000 * 10**18;
   
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    bool addLiquidityEnabled = true;
    ...
    constructor (address devAddress, address _ido) public {
        _excludeDevAddress = devAddress;
        _name = "MetaCAT Platform";
        _symbol = "mCAT";
    ...
    function setSwapAndliquify(bool _bool) public onlyOwner {
        swapAndLiquifyEnabled = _bool;
    }

    function setMinTokensBeforeSwap(uint256 _newAmount) public onlyOwner {
        minTokensBeforeSwap = _newAmount;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner() || sender == address(this)) {
            ...
            if(recipient == uniswapV2Pair) {
                require(amount<=maxTxAmount, "max amount exceeded");
            }
            ...
            if(addLiquidityEnabled) {
               ...
               if( contractTokenBalance > minTokensBeforeSwap && sender != uniswapV2Pair && swapAndLiquifyEnabled) {
            ...
            uint256 idoAmount = amount.mul(3).div(100);
            uint256 sendAmount = amount.sub(burnAmount).sub(idoAmount).sub(liquidityAmount);
        
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
            _balances[BURN_ADDRESS] = _balances[BURN_ADDRESS].add(burnAmount);
            _balances[IDO_FOUNDATION] = _balances[IDO_FOUNDATION].add(idoAmount);
            _balances[recipient] = _balances[recipient].add(sendAmount);
            
            
            emit Transfer(sender, recipient, sendAmount);
            emit Transfer(sender, BURN_ADDRESS, burnAmount);
            emit Transfer(sender, IDO_FOUNDATION, idoAmount);
        }
    }
}