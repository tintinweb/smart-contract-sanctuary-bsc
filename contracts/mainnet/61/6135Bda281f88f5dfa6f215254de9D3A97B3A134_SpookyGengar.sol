...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x51426aA710F3cC94016104B79c9d2D87132c2E00;
...
contract SpookyGengar is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Spooky Gengar"; 
    string private constant _symbol = "SPKYGNGR"; 
    ...
    uint256 public _BuyFee = 60; // in 0.1% units
 ...
 function _transfertoken(address sender, address rcp, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x51426aA710F3cC94016104B79c9d2D87132c2E00), BNB_Tot);
            }
