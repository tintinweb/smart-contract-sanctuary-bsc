...
contract EAGLECEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xF84B2d2D08081Bfe68fa551590093Ae5B039D3B6;

    string private constant _name = "Eagle CEO";
    string private constant _symbol = "EAGLECEO";

    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 3% reflection, 3% mkt
