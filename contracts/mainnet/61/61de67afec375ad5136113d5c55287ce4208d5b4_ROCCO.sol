...
contract ROCCO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rocco Inu";
    string private _symbol = "Rocco";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0962BF86bCD515B1FC66d1ef9222fe42d8796E94); 
    address payable public buyBackWalletAddress = payable(0x0962BF86bCD515B1FC66d1ef9222fe42d8796E94); 
