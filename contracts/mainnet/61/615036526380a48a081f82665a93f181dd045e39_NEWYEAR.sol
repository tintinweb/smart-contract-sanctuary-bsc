...
contract NEWYEAR is Context, IERC20, Ownable {
    ...
    string private _name = "CHIMEESE NEW YEAR"; 
    string private _symbol = "CHIMEESE"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4eD04E4B4Bd0AF48535EC03CC691eBac908b1d84); 
    address payable private teamWalletAddress = payable(0x8C540cCd25F9AB64966BceD531b58b6cCfDD62be); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 30 / 1000;
