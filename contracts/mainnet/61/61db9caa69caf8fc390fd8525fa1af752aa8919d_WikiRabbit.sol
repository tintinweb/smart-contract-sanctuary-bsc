...
//
//
//   📱Telegram::https://t.me/WikiRabbit
//   📱Website ::https://en.wikipedia.org/wiki/Rabbit
/*
...
contract WikiRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Wiki Rabbit", "WikiRabbit") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WikiRabbit";
    string private _symbol = "WikiRabbit";
