...
/**
 * 
WEBSITE : https://dogejeets.space/
TELEGRAM: https://t.me/DogeJeetsBSC

HODL AND RECEIVE DOGE REWARDS

d ss      sSSSs     sSSSs   d sss                d d sss   d sss   sss sssss   sss. 
S   ~o   S     S   S     S  S                    S S       S           S     d      
S     b S       S S         S                    S S       S           S     Y      
S     S S       S S         S sSSs               S S sSSs  S sSSs      S       ss.  
S     P S       S S    ssSb S            d       P S       S           S          b 
S    S   S     S   S     S  S             S     S  S       S           S          P 
P ss"     "sss"     "sss"   P sSSss        "sss"   P sSSss P sSSss     P     ` ss'  
...
contract  DogeJeets is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeJeets";
    string constant _symbol = "DJEET";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x30fd011b1c3FA4C7bE80575318920a49a5D289AC; //WALLET DEV
