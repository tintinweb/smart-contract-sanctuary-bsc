...
contract MiloYachtClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Milo Yacht Club";
    string constant _symbol = "MYC";
    ...
    uint256 public totalFeeSell = 4; //Total Fee
    ...
    uint8 public cooldownTimerInterval = 60; // In Seconds
