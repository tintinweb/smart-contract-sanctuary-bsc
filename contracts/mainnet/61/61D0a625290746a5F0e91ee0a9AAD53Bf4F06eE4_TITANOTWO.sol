...
contract TITANOTWO is Context, IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Titano 2.0";
    string constant _symbol = "TITANOTWO"; 
    ...
    uint256 public _maxTxAmount = _tTotal * 50 / 10000; //Initial 0.5%
    uint256 public _maxWalletSize = _tTotal * 100 / 10000; //Initial 1%

    // Fees Receivers
    address public devFeeReceiver = 0x57c21B91D2424B17522E80C5587c331d604b78d7;
    address public marketingFeeReceiver = 0x57c21B91D2424B17522E80C5587c331d604b78d7;
    address public liquidityFeeReceiver = 0x57c21B91D2424B17522E80C5587c331d604b78d7;
    ...
    uint256 public maxSwapSize = _tTotal * 50 / 10000; //0.01%
