...
contract ChengInu is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x263FaE0bC4238d729E34D1DC884E35Cddd1e1ab7;
    address public devAddress = 0x8bF95fD0A31EB1af2D32E1Ff54C04D259D67fbd2;

    string private constant _name = "Cheng Inu";
    string private constant _symbol = "CHENGINU";
    ...
    Taxes public taxes = Taxes(1,0,5,2);
    Taxes public sellTaxes = Taxes(1,0,5,2);
    ...
    // Owner cannot transfer out CHENG from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out CHENG!");
