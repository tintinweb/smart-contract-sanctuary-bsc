...
contract AIDayDoge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "AI Day Doge";
    string private constant _symbol = unicode"AIDG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xd7D20c7CbF494cfa65BCDC300C04e080101e6738);
    address payable public MarketingWallet = payable(0xc7349FCAb65779a476Eb6f68E0BBae9594b78875);
