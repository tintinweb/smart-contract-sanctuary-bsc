...
contract TridentGroup is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TridentGroup";
    string private _symbol = "TRDT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x20D815e42eCDEfF5cC14B142DF817825B15b88dD);
