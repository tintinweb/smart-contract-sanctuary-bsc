...
// CHANGE
contract NAPOcontract is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "NAPOLEON";
    string constant _symbol = "$NAPO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 4,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x925337f8221927fDb2FAb61A5af196b1efa0f904);
