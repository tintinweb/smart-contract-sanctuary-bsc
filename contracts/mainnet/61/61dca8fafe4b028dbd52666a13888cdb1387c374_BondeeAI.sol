...
/*
A BRANDNEW DIGITAL WORLD
Bondee AI
@BondeeAi
We aspire to bridge the gap between the Web2 audience and Web3 participants — one step at a time.
Bondee is a virtual avatar social app 
created by Singapore-based tech firm Metadream.
Users can chat and interact with each other on this 
social platform via its meta-universe environment.
Bondee's aim is to "live with your friends" 
through a virtual world home setting.
...
contract BondeeAI  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Bondee AI';
