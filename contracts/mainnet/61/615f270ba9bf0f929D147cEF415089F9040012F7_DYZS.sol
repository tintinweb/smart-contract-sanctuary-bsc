...
contract DYZS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 33333 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DYZS";
    string private _symbol = "DYZS";
    ...
    address public ownerAddres = address(0x31c7B74d2CCDDB5EFE3e8e4E77F4907b6e340F4f);
    address public devAddress = address(0x31c7B74d2CCDDB5EFE3e8e4E77F4907b6e340F4f);
    ...
    uint256 public _maxTxAmount = 33333 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 33333 * 10 **18;
