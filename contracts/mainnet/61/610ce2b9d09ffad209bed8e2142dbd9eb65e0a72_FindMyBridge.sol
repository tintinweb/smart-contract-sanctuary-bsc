...
contract FindMyBridge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Find My Bridge";
    string private _symbol = "FMB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8239b4819167b0C179F7F9AD7D61a814709DfA27);
    address payable public teamWalletAddress = payable(0x8239b4819167b0C179F7F9AD7D61a814709DfA27);
