...
contract LunaMyAss is IBEP20, Auth {
    ...
    address DEV = 0x275742ad76cBfDDE7C5E685800f81A3D2515F078;
    ...
    // Name and symbol
    string constant _name = "LunaMyAss";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 700 / 10000; // 7% 
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 3% 
    uint256 public _maxWalletToken = ( _totalSupply * 700 ) / 10000; // 7% 
