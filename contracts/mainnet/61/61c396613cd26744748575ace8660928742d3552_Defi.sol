...
contract Defi is Ownable {
    ...
    uint256 public minDeposit = 1 * 10 ** 17;
    ...
    function staking(uint256 amountIp) public returns(bool ) {
        ...
        if(_users[msg.sender].ref != 0x0000000000000000000000000000000000000000 ){
            ...
            _users[_users[msg.sender].ref].commission += (amountIp * 5 / 100);
        }

        if(amounts < 1 * 10 ** 18 ){
            types = 0;
            pt = 5;
        }else if(amounts >= 1 * 10 ** 18 && amounts < 10 * 10 ** 18 ){
            types = 1;
            pt = 6;
        }else if(amounts >= 10 * 10 ** 18 && amounts < 30 * 10 ** 18 ){
            types = 2;
            pt = 7;
        }else if(amounts >= 30 * 10 ** 18 && amounts < 100 * 10 ** 18 ){
            types = 3;
            pt = 8;
        }else if(amounts >= 100 * 10 ** 18 && amounts < 500 * 10 ** 18 ){
            types = 4;
            pt = 9;
        }else{
            types = 5;
    ...
    function withdraw() public returns(bool ) {
        ...
        address ref1 = addCmmBrand(amountsRec * 30 / 100, msg.sender);
        address ref2 = addCmmBrand(amountsRec * 10 /100, ref1);
        address ref3 = addCmmBrand(amountsRec * 5 /100, ref2);
        address ref4 = addCmmBrand(amountsRec * 5 /100, ref3);
        address ref5 = addCmmBrand(amountsRec * 5 /100, ref4);
        address ref6 = addCmmBrand(amountsRec * 5 /100, ref5);
        address ref7 = addCmmBrand(amountsRec * 5 /100, ref6);
        address ref8 = addCmmBrand(amountsRec * 5 /100, ref7);
        address ref9 = addCmmBrand(amountsRec * 5 /100, ref8);
        addCmmBrand(amountsRec * 5 /100, ref9);
