...
contract EthereumSilver is Context, IERC20, Ownable {
    ...
    string private constant _name = " Ethereum Silver "; // 
    string private constant _symbol = " $ETHSILVER "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x47C15E3CC3DC283b8B8D0e998688E4531a04e5AF;
