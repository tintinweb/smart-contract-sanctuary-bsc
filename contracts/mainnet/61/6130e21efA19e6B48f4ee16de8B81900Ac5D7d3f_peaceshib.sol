...
contract peaceshib is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "peace shib";
  string constant _symbol = "peace shib";
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0x5344770294A8eaF1891891f034952aF76dDFA123;
    devFeeReceiver = 0xF2e0c9B1C150F6b7CfEC7AfCc3116BD9b8D6F848;
