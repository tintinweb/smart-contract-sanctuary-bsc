...
contract BoredSpace is IERC20 {
    ...
    string constant private _name = "BoredSpace";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xca6657509efC60b7678f87d3062C0dE6B72cf289),
        tokenTax: 0x5e81363CA42F873c9c89CA7B16E943ACdb838030
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 tokenTax, uint16 liquidity, uint16 marketing) external onlyOwner {
    ...
    function setWallets(address payable marketing, address tokenTax) external onlyOwner {
