...
Shira is Shira Network's native asset, 
built on the Binance Smart Chain, 
providing utility to the ever-evolving web 3.0 ecosystem.
Shira Games is utilizing Shira and the 
Shira Network to develop unforgetable games
 and in-game NFTS for its growing community.

https://t.me/ShiraNetwork
*/
...
contract ShiraNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shira Network"; // 
    string private constant _symbol = "$SHIRA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xC89D3748654dadf90C3a52817601100F0b12F9C2;
