...
contract Pacman is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(address(0x2D22b1ab3E8BD8A09a15Db95433c5b3E743DDE9F));
        devFeeReceiver = payable(address(0x2D22b1ab3E8BD8A09a15Db95433c5b3E743DDE9F));
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percentage_base100000) external authorized {
        ...
        swapThreshold = rSupply.div(100000000000).mul(_percentage_base100000);
    }
