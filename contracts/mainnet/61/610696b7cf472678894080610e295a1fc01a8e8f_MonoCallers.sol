...
/* Token contract */
contract MonoCallers is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address private marketingFeeReceiver = 0x6b51f7FC3d5DE484547d2A453ca6A5E4810EEAb2;
 
    // Name and symbol
    string constant _name = "MonoCallers";
    string constant _symbol = "MonoC";
