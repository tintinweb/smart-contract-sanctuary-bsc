...
contract ToStar is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 202300000000 * 10**_decimals;
    uint256 public _maxTxAmount = 202300000000 * 10**_decimals; 
    uint256 public _walletMax = 202300000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 202300 * 10**_decimals; 
    ...
    constructor (
        ...
        teamWalletAddress = payable(address(0x3986841337195786dD50A6A9Ee1501ECa1ebdF0F));
        ruinWalletAddress = payable(address(0x3986841337195786dD50A6A9Ee1501ECa1ebdF0F));
        _name = coinName;
       _symbol = coinSymbol;
