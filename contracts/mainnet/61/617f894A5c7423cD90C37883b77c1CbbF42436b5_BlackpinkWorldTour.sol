...
/* 
https://t.me/blackpinkworldtourportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1eBA3CEE5eC9Eac1CDB2050151B09e61080D500; // whatDOGE
...
contract BlackpinkWorldTour is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackPink World Tour";
    string private _symbol = "BORNPINK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA1eBA3CEE5eC9Eac1CDB2050151B09e61080D500); // Marketing Address
    address payable public teamWalletAddress = payable(0xA1eBA3CEE5eC9Eac1CDB2050151B09e61080D500); // Team Address
