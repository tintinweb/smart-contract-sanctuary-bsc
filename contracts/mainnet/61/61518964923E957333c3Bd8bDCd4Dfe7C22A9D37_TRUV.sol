...
contract TRUV is Context, IERC20, Ownable {
  ...
  constructor(uint256 _snipeBlockAmt) {
    ...
    _isExcludedAntiwhale[msg.sender] = true;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(amount > 0, "Transfer amount must be greater than zero");
     ...
     require((amount <= _maxTxAmount ) || _isExcludedAntiwhale[sender] || _isExcludedAntiwhale[recipient] , "Transfer amount exceeds the maxTxAmount.");
