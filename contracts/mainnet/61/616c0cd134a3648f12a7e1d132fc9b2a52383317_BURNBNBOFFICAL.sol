...
TELEGRAM: https://t.me/Burnbnboffical
*/
...
contract BURNBNBOFFICAL   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BURN BNB OFFICAL ";
    string private _symbol = " BBO "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFa7B37ce461aD06be8477464764002B01Cff64da); 
    address payable public teamWalletAddress = payable(0xB827cFbF2d43a9242FdfdE4D3aaC21b64FCFfe5F); 
