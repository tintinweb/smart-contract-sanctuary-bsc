...
/** Stealth extreme Telegram @inunetworkbsc
...
library Address{
 ...
 contract InuNetwork is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x8ba726B5eA49d6be004b80348bAEE47A0C64efED;
    address public donationWallet = 0x8ba726B5eA49d6be004b80348bAEE47A0C64efED;

    string private constant _name = "InuNetwork";
