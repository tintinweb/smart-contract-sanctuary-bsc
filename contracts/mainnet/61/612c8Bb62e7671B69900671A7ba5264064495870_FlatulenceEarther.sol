...
contract FlatulenceEarther  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flatulence Earther";
    string private constant _symbol = "Flatulence Earther";
    ...
    uint256 public swapTokenAtAmount = 2000000000 * 10**_decimals;
    ...
    address private marketingWallet = address(0x165F541F726d17aBEC1C72D52b2b8414Bd1dF377);
    address private liquidityReceiver = address(0x165F541F726d17aBEC1C72D52b2b8414Bd1dF377);
