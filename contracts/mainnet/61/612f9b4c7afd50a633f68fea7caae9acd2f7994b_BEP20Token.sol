...
contract BEP20Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "901 Token";
    string private constant _symbol = "901";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 9010 * 10**_decimals;
    uint256 public _maxTxAmount = 91 * 10**_decimals;
    uint256 public _maxWalletAmount = 91 * 10**_decimals;
