...
contract RippleRocketTrading is Context, Ownable, IERC20 {
    ...
    uint16[3] private ref_bonuses = [80, 40, 30]; 
    ...
    constructor() {
	    _name = "RippleRocketTrading Token";
        _symbol = "$RRT";
        _decimals = 18;
        ...
        tarifs[0] = Tarif(36135, 108405); //  36135, 108405 =3%       36135 seconds to 1 day, 72270 = 2%    
        dev = payable(msg.sender);		
		USDT = IERC20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    }
	
    function Invest(address _upline, uint256 amount) external {
        
        require(amount >= 5 ether, "Minimum Buy is 5 XRP!");
