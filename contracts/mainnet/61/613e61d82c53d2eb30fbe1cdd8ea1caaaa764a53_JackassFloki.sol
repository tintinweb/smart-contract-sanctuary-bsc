...
Telegram: https://t.me/jackassfloki
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76Faa67209E8a6C072ADa96fD1a706305f17f459; // owner address
...
contract JackassFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jackass Floki";
    string private _symbol = "A$$"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76Faa67209E8a6C072ADa96fD1a706305f17f459); // Marketing Address
    address payable public teamWalletAddress = payable(0x76Faa67209E8a6C072ADa96fD1a706305f17f459); // Team Address
