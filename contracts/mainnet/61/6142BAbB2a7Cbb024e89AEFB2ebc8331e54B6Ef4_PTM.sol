...
contract PTM is Context, IERC20, Ownable {
    ...
    string private _name = "PTM";
    string private _symbol = "PTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3C0cB344B66E87687448f6E596CAF586FB93a51); // Marketing Address
    address payable public teamWalletAddress = payable(0x1bB3C8B4C5F7Cb51F38BE0ff8452Fe0B1005E471); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 5 * 10**3;
