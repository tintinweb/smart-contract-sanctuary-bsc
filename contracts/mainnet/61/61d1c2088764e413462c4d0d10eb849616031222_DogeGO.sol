...
*/
// *Telegram : https://t.me/dogegocoin
// 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55DC84B8F695fdD7B93548b126d3907582b4F69D; // owner address
...
contract DogeGO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x853B0baeb192917B485D895Af8a310cF137fe543); // Marketing Address
    address payable public teamWalletAddress = payable(0x703C5C240f0e66b733Dc74C1AA76d6e2fA6a975d); // Team Address
