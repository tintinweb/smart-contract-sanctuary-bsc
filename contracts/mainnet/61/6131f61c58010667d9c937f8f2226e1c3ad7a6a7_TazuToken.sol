...
// Root file: contracts/TazuToken.sol
...
contract TazuToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "TAZU";
    string private constant _symbol = "TAZU";
    ...
    //total supply
    uint256 private constant _tTotal = 1_000_000_000_000 ether; // 1 trillion
    ...
    modifier isAuthorized() {
        require(
            ...
            "TAZU Token: not authorized user"
        );
        _;
    }
