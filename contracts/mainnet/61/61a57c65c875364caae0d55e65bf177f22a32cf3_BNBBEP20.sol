...
contract BNBBEP20 is Context, IERC20, Ownable {
    ...
    string private constant _name = " BNB BEP20 "; // 
    string private constant _symbol = " $BNBBEP20 "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x63FfC7D77d2D9272fAE47E47699Ae1d4DD553f3B;
