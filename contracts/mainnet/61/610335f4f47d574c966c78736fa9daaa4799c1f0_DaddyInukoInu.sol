...
contract DaddyInukoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Daddy InukoInu"; // 
    string private constant _symbol = "$DINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xB66f68dA49efd90d0A59a2791416468Aa15539cf;
