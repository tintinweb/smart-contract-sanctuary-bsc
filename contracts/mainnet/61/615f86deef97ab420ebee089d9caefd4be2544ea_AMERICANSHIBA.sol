...
contract AMERICANSHIBA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x54d08f553eEE0d70CAb1FbcE4e7982bb4c130d2C); // Marketing Address
    address payable public teamWalletAddress = payable(0x54d08f553eEE0d70CAb1FbcE4e7982bb4c130d2C); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 40000 * 5 **_decimals; 
