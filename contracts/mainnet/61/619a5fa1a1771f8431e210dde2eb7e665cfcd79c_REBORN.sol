...
contract REBORN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x22b0E039Dc2A23d0dCeEA53211B7B94fc46D7604); 
    address payable public Wallet_Dev = payable(0x22b0E039Dc2A23d0dCeEA53211B7B94fc46D7604);
    ...
    string private constant _name = "BTC REBORN"; 
    string private constant _symbol = unicode"REBORN"; 
    ...
    constructor () {
        ...
        _owner = 0x22b0E039Dc2A23d0dCeEA53211B7B94fc46D7604;
