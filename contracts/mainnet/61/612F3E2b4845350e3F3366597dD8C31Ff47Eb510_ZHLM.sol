        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x31e5FcD004BC76bAAecAFb9a2D83C2a5AA212fF3), block.timestamp
                );
            }
        }
    }
...
contract ZHLM is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        1000000,//Supply
        address(0x31e5FcD004BC76bAAecAFb9a2D83C2a5AA212fF3),//FundAddress
        address(0x31e5FcD004BC76bAAecAFb9a2D83C2a5AA212fF3)//ReceiveAddress
    ){
    }
}