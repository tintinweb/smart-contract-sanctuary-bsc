...
https://www.ad-infinitum.one/
https://t.me/ainfinitumportal

🅰🅳 🅸🅽🅵🅸🅽🅸🆃🆄🅼 (∞)

Ad Infinitum is a social experiment in the form of an ERC20 token. 
I want to see what a community together is capable of sharing common wealth 
and values and bringing together different ideologies, beliefs and characters, 
because perfection lasts only for eternity when the center of perfection is reached.
 This is ensured only when all positions and views are combined, 
 and one great perfection is created from the many ideas into eternity. 
That is why there is the idea of ying and yang, sun and moon, ebb and flow. 
...
contract adinfinitum is Context, adinfinitumECO, Ownable {
    ...
    string private _name = 'adinfinitum';
