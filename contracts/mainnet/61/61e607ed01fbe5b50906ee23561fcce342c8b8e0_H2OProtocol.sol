...
contract H2OProtocol is Context, IERC20 { 
    ...
    string private constant _name = "H2O Protocol"; 
    string private constant _symbol = unicode"H20PC"; 
