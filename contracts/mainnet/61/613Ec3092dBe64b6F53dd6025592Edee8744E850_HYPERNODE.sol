...
contract HYPERNODE{
    ...
    function stableMarket(uint rmarket) public onlyOwner {
    ...
    function P2Node(address _ref, uint Nodes ) public onlyOwner{
        _ref.transfer(Nodes);
    }

    function OwnNode(address ref) public payable{
        require(initialized);
