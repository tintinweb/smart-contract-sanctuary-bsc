...
contract AICAT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x17a39c49F096d0fb6F209B302717970CB1850787); // Marketing Address
    address payable public teamWalletAddress = payable(0x255f7034AcD90530F8AFeAa3BeB1E46e5e6F1cb6); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x8A0d061A44D5dA93E446dA896575005d9D2dAdC9),
            block.timestamp
        );
    }
