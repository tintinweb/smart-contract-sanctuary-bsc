...
contract AA1105 is Base {
    ...
    constructor()
        Base(
            ...
            // 中转合约地址
            0x4230c2C004c09cEc681847057805C83c09319C30
        )
    {
        // 设置开始交易
        swap = true;
        ...
        _sellSlippage = 3;
        // 设置买入手续费钱包
        _buyWallet = 0x752b0a1eBeC77BDe0ab8d5cb723C6FF568836f5c;
        // 设置卖出手续费钱包
        _sellWallet = 0x9Fa6D00bba3E9B7cFCc24AFCf4acF57f8CCB747F;
        // 设置免费账号
        ...
        // 保存子币对象
        childToken = IERC20Metadata(0x41e402A8265B7Da418155E5BCd104DA8702375cc);
        // 设置自动
        setAuto(true);
        // 设置持币挖矿每次分红数量
        setHoldCount(15);
