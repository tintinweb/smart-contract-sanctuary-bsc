...
Bored Cat Yacht Club is a Meme Token with upcoming utilities riding the hype of Cat tokens. This would be the next big thing in the Cat era.

Our complete list of details and whitepaper can be found on our website.

         Website: https://boredcatyachtclub.com

         Twitter: https://twitter.com/BoredCatYC

         Telegram: https://boredcatyachtclub
...
contract BOREDCATYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bored Cat Yacht Club";
    string private _symbol = "BCYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01b830223F7f12c946E06A464FfaE8239bE1a792); 
    address payable public buyBackWalletAddress = payable(0x8A824631dC62C141443f3EA391454dc0219bfb74); 
