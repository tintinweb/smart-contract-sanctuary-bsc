...
contract LifeToken is IERC20, Ownable {
    ...
    constructor(
        ...
        _nft = 0x7f8cd4a968D9937cA0EBCDeACbd6899bC0dA0f5C;
        _ido = 0x89e15C16381496E521BcaB2847d4e8Fdb8C72440;
    ...
    function _transfer(
        ...
        if (canSwap && _sonAddress != address(0) && from != address(this) && from != address(this) && to != uniswapV2Pair && from != uniswapV2Pair && from != owner() && to != owner()) {
