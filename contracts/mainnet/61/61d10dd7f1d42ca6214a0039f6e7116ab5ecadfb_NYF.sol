...
contract NYF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Year Floki";
    string private _symbol = "NYF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xee8C105a501a5BCB32a0b50AF00eC419e626Bf4f); // marketing wallet
    address payable lotteryWallet = payable(0xB14dD3Aa6758E8e9A7D0a0290C4e19ed72Ee049e);  // lotterywallet
    ...
    uint256 public  _walletMax =     _totalSupply * 10 / 100;
