...
contract Stepncate is Context, IERC20, Ownable {
    ...
    string private _name = "Stepncate";
    string private _symbol = "STEPNCATE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1000 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xe97c361A7bcC7c76C4f8D1A6877b5B8D8a4278c7);
