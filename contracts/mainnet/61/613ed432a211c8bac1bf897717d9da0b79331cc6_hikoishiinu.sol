...
// *Telegram : https://t.me/HIKOISHIINU
...
contract hikoishiinu is Context, IERC20, Ownable {
    ...
    string private constant _name = " Hikoishi Inu"; // 
    string private constant _symbol = " $HIKONU"; //    
