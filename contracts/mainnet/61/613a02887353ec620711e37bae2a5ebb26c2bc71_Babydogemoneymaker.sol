...
// TG :https://t.me/Babydogemoneymakerbsc
...
contract Babydogemoneymaker is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDoge MOneyMaker";
    string private _symbol = "BDMM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc207AB045d9F2d109dDEEF9676A2bD8C182277EB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE872C56B4f017894046919057aAf6fCd64af7478); // BuyBack Address
