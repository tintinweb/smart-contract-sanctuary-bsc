...
contract BabyAnalDust is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x65e61A915aCb0456C200849c9dfbb4B412E050e4); 
    address payable public Wallet_Dev = payable(0xc81eFD2Fb428748bf496383835fEa53f7C9AfEc8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "BABY ANAL DUST"; 
    string private constant _symbol = unicode"BabyAnalDust";
    ...
    uint256 public _maxWalletToken = _tTotal * 35 / 1000;
