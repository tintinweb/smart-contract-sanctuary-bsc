...
/* Token contract */
contract SaudiPige is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x041473e0863A2e3233CAFBCC8F369a37CeCA686E;
    ...
    // Name and symbol
    string constant _name = "Saudi Pige";
    string constant _symbol = "SPige";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (300 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (300 mil)
