...
/*
MoonDip
A BSC token that gather groups of Crypto believers that all the dip that is happening right now is a process to make all blue chip cryptos to moon even higher!

With all the positive vibes in the community, MoonDip will moon all the way up in BSC. Launching soon in few hours, contract address to be shared on launch.

Tokenomics:
~ 1 Billion of Supply
~ Low tax : 5%
~ Starting with low MC : 1 BNB

Join MoonDip in TG : https://t.me/MoonDipBSC
*/
...
contract MoonDip is Context, IERC20 { 
    ...
    string private constant _name = "MOONDIP"; 
