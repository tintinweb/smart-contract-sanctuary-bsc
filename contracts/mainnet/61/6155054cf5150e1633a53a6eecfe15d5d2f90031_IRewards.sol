...
contract IRewards is ERC20, Ownable {
    ...
    constructor() ERC20("I-REWARDS", "I-RWRD") {
        ...
        IcoinhubWallet = address(0x0Cbf199086AbCd4F2602eE5a8970214d8690b86C); // set as dev wallet
    ...
    {
        require(
            newAmount >= (totalSupply() * 2) / 10000,
            "Swap amount cannot be lower than 0.02% total supply."
        );
        require(
            newAmount <= (totalSupply() * 5) / 10000,
            "Swap amount cannot be higher than 0.05% total supply."
        );
