...
contract BABYHMT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BABYHMT";
    string private _symbol = " BABYHMT ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23a8D47F69A772ba936135742AD0E8Da993d4c0C);
    address payable public teamWalletAddress = payable(0x23a8D47F69A772ba936135742AD0E8Da993d4c0C);
