...
Firs 10 minutes sell tax will be 29% to shake BOTS

TG https://t.me/BlindCatCoin
...
/* Token contract */
contract BlindCAT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xB6F9a0E4B4079E3051ac2AfDA188e79C38f48Ca2;
    ...
    // Name and symbol
    string constant _name = "BlindCat";
    string constant _symbol = "BLCT";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 3% (100 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 3% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% (100 mil)
    ...
    uint256 public marketingFeeSell = 27;
    uint256 public devFeeSell = 1;
    uint256 public totalFeeSell = 29;
