...
contract POPMARSINU is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 2; // 10% of supply
    ...
    string private constant _name = "PopulationOfMars Inu";
    string private constant _symbol = "POPMARS INU";
