...
/**
   tg: https://t.me/Bullishapecoin
   website: https://bullishapecoin.web.app/#
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2B66741066edA699e4aC66fA85EB31Fe5CE557A4; // owner address
...
contract BULLISHAPE is Context, IERC20, Ownable {
    ...
    string private _name = "BULLAPE Token";
    string private _symbol = "BA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B66741066edA699e4aC66fA85EB31Fe5CE557A4); // Marketing Address
    address payable public teamWalletAddress = payable(0x2B66741066edA699e4aC66fA85EB31Fe5CE557A4); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 9;  // original 8
    uint256 public _totalTaxIfSelling = 9;  // original 8
    uint256 public _totalDistributionShares = 9;  // original 8
