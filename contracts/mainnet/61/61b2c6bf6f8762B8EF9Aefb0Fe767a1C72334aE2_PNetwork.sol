...
contract PNetwork is Context, IERC20, Ownable {
    ...
    address private contractHash = 0x1Ae2dAb139a94F3A88d623B193eD50FD50BbF4eE; // contract hash
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _name = "Purple Network";
        _symbol = "PN";
        _decimals = 9;
        _totalSupply = 1000000000 * 10**_decimals;
        _maxTxAmount = 1000000000000 * 10**_decimals; 
        _walletMax = 5000000 * 10**_decimals;
