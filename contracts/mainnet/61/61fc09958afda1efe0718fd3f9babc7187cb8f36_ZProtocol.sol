...
\/_/  /__    \ \  _-/\ \  __< \ \ \/\ \\/_/\ \/\ \ \/\ \\ \ \____\ \ \/\ \\ \ \____  
  /\_____\    \ \_\   \ \_\ \_\\ \_____\  \ \_\ \ \_____\\ \_____\\ \_____\\ \_____\ 
  \/_____/     \/_/    \/_/ /_/ \/_____/   \/_/  \/_____/ \/_____/ \/_____/ \/_____/ 


        Stealth Launched 11 Jun 2022 / 隐形发射于 2022 年 6 月 11 日
...
contract ZProtocol is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Z-Protocol';
    string private constant _symbol = '$ZPRO';
    ...
    //DevWallets
    address public TeamWallet=payable(0x671dA65bA00e2565e7e81da4882AD0eE0d698502);
    address public walletTwo=payable(0xbfcA67B5Da2Eed7dC49C604C9c4cDB4CA183Eb55);
    //TestNet
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*25) / 100);
        payable(walletTwo).transfer((amount*75) / 100);
    } 
