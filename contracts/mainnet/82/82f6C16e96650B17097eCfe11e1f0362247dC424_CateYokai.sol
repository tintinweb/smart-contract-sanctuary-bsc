...
🔥🚀 STEALTH LAUNCH AT TODAY

Cate Yokai is a memecoin with real utility and also provides a reflection of each transaction to its holders. A truly Cate Yokai ecosystem that aims to reward all holders.

👨‍💼Based SAFU Dev, Experienced Based Team.
🌔 1000x MoonShot
🔒 LP Locked For 1 Month
💰Utility Staking Pool, NFT Marketplace
💎 Tax 5% (Low Tax)
...
Telegram Group: https://t.me/CateYokai

Twitter
https://twitter.com/CateYokai
*/
...
contract CateYokai is Context, IBEP20, Ownable {
    ...
    string private _name = "CATE YOKAI"; // token name
    ...
    uint256 public minTokenToSwap = 10000000000000 * 1e9;
