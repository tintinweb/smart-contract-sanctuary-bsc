...
contract BON is ERC20, Ownable {
    ...
    address public _marketingAddress1 = 0x4178739A1c2241b84542d17a5cE683322c79e1d6;
    address public _marketingAddress2 = 0xd5B53eb1B6D912C7526b16eC5c1B79caBE33a176;
    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public fistRouter = 0x1B6C9c20693afDE803B27F8782156c0f892ABC2d;
    ...
    constructor(
        ...
        wrapRouter = _wrap;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(fistRouter);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                // inviterFee
                InviterFee = amount.mul(_inviterFee).div(10000);
                fees = LFee.add(MFee).add(DFee).add(InviterFee);
            }
            ...
            // inviter
            if (InviterFee > 0) _takeInviterFee(from, to, amount);

            amount = amount.sub(fees);
            if(DFee > 0) super._transfer(from, deadWallet, DFee);

            super._transfer(from, address(this), fees.sub(InviterFee).sub(DFee));
    ...
    function _takeInviterFee(
        ...
        if (sender == uniswapPair) {
            ...
            super._transfer(sender, _marketingAddress2, tAmount.div(10000).mul(_inviterFee));
            return;
        }
        ...
        super._transfer(sender, _marketingAddress2, tAmount.div(10000).mul(_inviterFee.sub(accurRate)));
    }

    // send marketing
    function swapAndSendToFee() private {
        uint256 tokens = AmountMarketingFee;
        swapTokensForUsdt(tokens,_marketingAddress1);
        AmountMarketingFee = AmountMarketingFee - tokens;
    }

    function swapTokensForUsdt(uint256 tokenAmount,address _marketing) private {
