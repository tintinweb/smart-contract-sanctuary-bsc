...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7134fA87033433060a819A5c09e07c9C52480540; // owner address
...
contract GRIMREAPER is Context, IERC20, Ownable {
    ...
    string private _name = "GRIM REAPER";
    string private _symbol = "$DEATH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7134fA87033433060a819A5c09e07c9C52480540); // Marketing Address
    address payable public teamWalletAddress = payable(0x7134fA87033433060a819A5c09e07c9C52480540); // Team Address
