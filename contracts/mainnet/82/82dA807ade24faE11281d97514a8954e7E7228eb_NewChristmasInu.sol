...
/**
Welcome to New Christmas Inu!
Join our telegram chat at: @ChristmasInu
*/
...
contract NewChristmasInu is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    string constant _name = "New Christmas Inu";
    ...
    uint256 public BuytotalFee  = BuydevFee;

    uint256 public SelldevFee  = 8;
    uint256 public SelltotalFee = SelldevFee;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender != owner && recipient != address(this) && recipient != address(0x000000000000000000000000000000000000dEaD) && recipient != pair || isTxLimitExempt[recipient]){
