...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64e5e0113b274b2Ff379Cd60b9b877b38B2C237f; // owner address
...
contract GyokuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gyoku Inu";
    string private _symbol = "$GYOKU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64e5e0113b274b2Ff379Cd60b9b877b38B2C237f); // 
    address payable public teamWalletAddress = payable(0x64e5e0113b274b2Ff379Cd60b9b877b38B2C237f); // 
