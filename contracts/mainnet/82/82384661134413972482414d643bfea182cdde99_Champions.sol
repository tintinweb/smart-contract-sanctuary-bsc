...
contract Champions is Context, IERC20, Ownable {
    ...
    string private _symbol = "Champions";

    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0xBadde8311C3Fd3EAd1070333C4B1E7D079f61eD8); 
    address payable public BurnedWalletAddress = payable(0x2671008902060972E0B84b71A025191c861C11B9); 
