...
abstract contract Auth {
    ...
    address public adminOne      = 0x4200B7c50D26400957b23b8e4693873d4e664130;
...
contract ABACATE is IBEP20, Auth {
    // LIBRARIES
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // MAIN WALLET ADDRESSES
    address private MKT            = 0xea74001A5d64cdc64ac34d47Bf9132303785935e;
    address private PROJECT        = 0xB482D71B6EA1DD1d6a77628449B9A1fbdf5AD3D8;
    address private SPONSOR        = 0x53f243cCB8BcAf360687Ba9887608160b67e1984;

    // TOKEN GLOBAL VARIABLES
    string constant _name = "Abacate Token";
    string constant _symbol = "ABACATE";
    ...
    function postpone(uint256 _time) external onlyOwner {
        ...
        doNotBuy = doNotBuy.add(calculate);
    }
