...
contract ChadP2E is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Chad P2E";
    string constant _symbol = "Chad P2E";
    ...
    uint256 marketingFee = 490;
    uint256 totalFee = liquidityFee + marketingFee;
    uint256 feeDenominator = 1000;

    address public marketingFeeReceiver = 0xeE88C166be69f41fE989B01439B5738aC54d4BEb;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xeE88C166be69f41fE989B01439B5738aC54d4BEb] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xeE88C166be69f41fE989B01439B5738aC54d4BEb] = true;
