...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 tokenReward = IBEP20(0x337C4930B612FA27072abB7b8fDE693e9D129405);
...
contract Snakenomics is IBEP20, Auth {
    using SafeMath for uint256;

    address tokenReward = 0x337C4930B612FA27072abB7b8fDE693e9D129405;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Snakenomics";
    string constant _symbol = "$Snakenomics";
    ...
    // switch 
    function snakenomics(bool _status) public onlyOwner {
        easily = _status;
    }
