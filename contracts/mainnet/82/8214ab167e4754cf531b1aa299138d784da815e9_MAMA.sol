...
contract MAMA is Context, IBEP20, Ownable {
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _chart + _spin + _charity ) <= 3, "Must keep fees at 3% or less");
    ...
    function setSellTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _chart + _spin + _charity ) <= 7, "Must keep fees at 7% or less");
