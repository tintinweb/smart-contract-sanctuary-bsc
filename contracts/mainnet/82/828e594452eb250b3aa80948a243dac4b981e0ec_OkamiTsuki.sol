...
/**
 the word ōkami (狼) means "wolf" and the word tsuki  (つき) means "moon"
 Telegram: https://t.me/OkamiTsukibsc
 Website: https://okamitsuki.online/
*/
...
contract OkamiTsuki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Okami Tsuki";
    ...
    address payable public marketingWalletAddress = payable(0x5f038fD937eCD551A69e87f8493CFde4f89c3B7a); // Marketing Address
    address payable public teamWalletAddress = payable(0x4757f5919d6c37f5f76814bC530015A8780D4978); // Team Address
    ...
    uint256 private _buyMaxTxAmount = 10000000 * 10**_decimals;
    uint256 private _sellMaxTxAmount = 10000000 * 10**_decimals; 
    ...
    function setMaxTxAmount(uint256 buyMaxTxAmount, uint256 sellMaxTxAmount) external onlyOwner() {
    ...
    function BlacklistBot(address recipient, bool isbc) public onlyOwner {
