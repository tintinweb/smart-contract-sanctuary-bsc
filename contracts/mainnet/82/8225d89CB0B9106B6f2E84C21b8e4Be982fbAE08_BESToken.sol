...
contract BESToken is Ownable{
    string public name = "BES";
    string public symbol = "BES";
    uint8  public decimals = 18;
    uint256 public totalSupply = 130000000 * 10 ** 18;
    ...
    address public MarketingAddr = address(0x57C36Eb24762cFf10Db5E6CfA577aF737E2D11DE);
    ...
    function _transfer(address _from,address _to, uint256 _value) private {
        ...
        if(isPairCon[_to]){
            if(isExcludedFromFee[_from]){
                ...
                uint256 _toMarketingAddr = _value * SellFee / 100;
        ...
        if(isContract(_from) && isContract(_to)){
            ...
            (bool success2,) = address(_to).call(abi.encodeWithSignature("token0()"));
            (bool success3,) = address(_to).call(abi.encodeWithSignature("token1()"));
