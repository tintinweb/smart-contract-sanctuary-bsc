...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDA5ce66C5A09D1626cc0412a431f35c1b318036F; // owner address
...
contract TwitterGirl is Context, IERC20, Ownable {
    ...
    string private _name = "Twitter Girl";
    string private _symbol = "TwiGirl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDA5ce66C5A09D1626cc0412a431f35c1b318036F); // Marketing Address
    address payable public teamWalletAddress = payable(0xDA5ce66C5A09D1626cc0412a431f35c1b318036F); // Team Address
