...
contract RoboCatGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "RoboCarGirl"; // 
    string private constant _symbol = "RcGirl"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xAcb95af3B5BA91dCC5e3A64626CA073067C3B7B8;
