...
contract BackToTesting4 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BackToTesting4DividendTracker public dividendTracker;
    ...
    mapping(address => uint256) public _holderBuy1Timestamp;
    ...
    constructor() ERC20("BackToTesting4", "BTTT4") {
        ...
        dividendTracker = new BackToTesting4DividendTracker(payable(this), router, 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
                                                   "BackToTesting4TRACKER", "BTTT4TRACKER");
...
contract BackToTesting4DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BackToTesting4 public BackToTesting4Contract;
    ...
    constructor(address payable mainContract, address router, address token, string memory _name,
        ...
        defaultToken = token;
        BackToTesting4Contract = BackToTesting4(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(false, "withdrawDividend disabled. Use the 'claim' function on the main BackToTesting4 contract.");
    }
    ...
    function _reinvestDividendOfUser(address account) private returns (uint256) {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BackToTesting4Contract);

            uint256 prevBalance = BackToTesting4Contract.balanceOf(address(this));
            ...
            {
                uint256 received = BackToTesting4Contract.balanceOf(address(this)).sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BackToTesting4Contract.transfer(account, received);
                } 
                else {
                    success = false;
                }
