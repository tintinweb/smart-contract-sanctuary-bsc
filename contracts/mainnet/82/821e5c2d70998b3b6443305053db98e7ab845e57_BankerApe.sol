...
contract BankerApe is ERC20Detailed, Ownable {
    ...
    string public _name = "Banker Ape";
    string public _symbol = "BApe";
    ...
    constructor() ERC20Detailed("Banker Ape", "Banker Ape", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x6BdBCd6893D08D8FBdDd94b28618Db81E1C8439f;
        treasuryReceiver = 0xe653157447b9Bc23Ce8C1882e09Ea17f84Fe5f1f; 
        safuuInsuranceFundReceiver = 0xDe65FD2ae3a5ec44Dc5685237f4AB70cFC1202bF;
        firePit = 0x49a33Ada7b123ab553c48532f2e25e08c230F6c5;
