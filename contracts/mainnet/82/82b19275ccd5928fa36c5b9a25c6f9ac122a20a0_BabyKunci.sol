...
/**
Telegram - https://t.me/babykunciportal
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN KUNCI
    IBEP20  KUNCI = IBEP20(0x6cf271270662be1C4fc1b7BB7D7D7Fc60Cc19125);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = KUNCI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(KUNCI);
        ...
        uint256 amount = KUNCI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            KUNCI.transfer(shareholder, amount);
...
/* Token contract */
contract BabyKunci is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address KUNCI = 0x6cf271270662be1C4fc1b7BB7D7D7Fc60Cc19125; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x54607F4bE34EE9dfA65403e10D422Bde5c336B34;
    address MARKETING = 0x54607F4bE34EE9dfA65403e10D422Bde5c336B34;
    ...
    // Name and symbol
    string constant _name = "Baby Kunci Coin";
    string constant _symbol = "BABY KUNCI";
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (!authorizations[sender] && recipient != owner && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != MARKETING){
