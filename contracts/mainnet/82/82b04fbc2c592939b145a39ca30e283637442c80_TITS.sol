...
contract TITS is Context, IERC20, Ownable {
    ...
    string private _name = "BRO IM IN LOVE WITH YOUR MOMS HUGE TITS, I HATE A FACT THAT HES HAVING FLAT ASS BUT THE TITS BRO......... ITS FUCKING AMAZING HOW THEY BOUNCE WHEN HES ON TOP OF ME, I WILL NEVER EVER GET BORED OF THEM, MAN I'D GIVE HER EVERY SINGLE BNB I GOT IM MY METAMASK WALLET JUST TO SEE HOW GOOD SHE LOOKS WITH MY CUM ON THEM, YOUR MOM IS AN AMAZING WOMAN, I WILL MEET THESE HUGE TITTIES AGAIN TODAY";
    string private _symbol = "TITS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62a0C7399C770103C5cC8496A1BEf625f1242Ac9); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x62a0C7399C770103C5cC8496A1BEf625f1242Ac9); // buyback Address
    ...
    uint256 public _maxTxAmount = 500000000000000 * 10**9; // 1.5%
    uint256 public _walletMax = 500000000000000 * 10**9; // 2.5%
