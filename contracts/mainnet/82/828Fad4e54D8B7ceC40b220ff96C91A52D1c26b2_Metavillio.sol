...
contract Metavillio is IERC20 {
    ...
    string constant private _name = "Metavill.io";
    string constant private _symbol = "MV";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x0DA4F33f1Bc5FE1B88070061957Ebb4291677a9C),
        buyback: payable(0x0DA4F33f1Bc5FE1B88070061957Ebb4291677a9C),
        staking: 0x0DA4F33f1Bc5FE1B88070061957Ebb4291677a9C
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 staking, uint16 buyback, uint16 marketing) external onlyOwner {
    ...
    function setWallets(address payable marketing, address payable buyback, address staking) external onlyOwner {
        require(marketing != address(0) && staking != address(0) && buyback != address(0), "Cannot be zero address.");
