...
contract StratX_pancakeLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant earnedAddress =
        0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //bsw
    ...
    //address public  fundManager = address(0x2D267Ee1262bCdB29a4866527ff15eb845715503); 
    ...
    uint256 public buyBackRate = 4400;
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                //IERC20(wbnb).safeTransfer(fundManager, fee.mul(65).div(100));
                //IERC20(wbnb).safeTransfer(fundManager2, fee.mul(12).div(100));
                IERC20(wbnb).safeTransfer(receiveFee, fee);//.mul(100).div(100));
