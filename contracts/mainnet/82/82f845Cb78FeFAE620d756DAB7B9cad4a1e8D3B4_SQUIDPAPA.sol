...
contract SQUIDPAPA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Papa";
    string private _symbol = "SQUIDPAPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE414A4b470f1149447D611B3F21ea680DDE98672); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE414A4b470f1149447D611B3F21ea680DDE98672); // Treasury / Buyback
