...
contract TxDogeShibMoon is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "TxDogeShibMoon";
  string private _symbol = "TxDogeShibMoon";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x167858731E332fE0F560D5be2C57736f87020BE1);
  address payable public teamWallet = payable(0x167858731E332fE0F560D5be2C57736f87020BE1);
