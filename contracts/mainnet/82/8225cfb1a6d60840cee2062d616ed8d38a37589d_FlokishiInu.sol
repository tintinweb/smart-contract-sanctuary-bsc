...
contract FlokishiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flokishi Inu";
    string private _symbol = "FI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfB9Bd0147619195C4141a9A6b8923CaE1568285c); 
    address payable public teamWalletAddress = payable(0xfB9Bd0147619195C4141a9A6b8923CaE1568285c); 
