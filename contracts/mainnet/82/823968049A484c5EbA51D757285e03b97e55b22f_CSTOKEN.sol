...
contract CSTOKEN is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        burnAddress = payable(0x364a967152795fcf944fa96598BD20c51A081E46);
        marketingAddress = payable(0xB2Df0E71819d366F81Ca2C67702e0620cD749835);
        safetyAddress = payable(0xd66386C1e50dA43569938c3C8Fe9b3b549B761Fc);
        daoAddress = payable(0x20ef723cc01C11f11F6e8332a0B953160D36EA42);
        remainAddress = payable(0xaAa026df6605a3BF874dD7F01786C87418a7AF36);
    ...
    function setToolContract(address _val) public onlyOwner{
        toolContract = _val;
