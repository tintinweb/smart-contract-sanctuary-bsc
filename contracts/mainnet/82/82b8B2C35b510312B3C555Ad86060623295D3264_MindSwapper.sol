...
contract MindSwapper {

    // Token
    IERC20 public constant token = IERC20(0xDa7c8b7374f600b229Be7B7A237ad178329530b9);

    // Recipients Of Fees
    address public recipient = 0x4602ACb365e32B3d386b4eA82667F6C75c192801;
    ...
    function buyTokenForRecipientWithMinOut(address recipient_, uint minOut) external payable {
        _buyToken(recipient_, msg.value, minOut);
    }

    function buyTokenForRecipient(address recipient_) external payable {
    ...
    function sellForRecipient(uint256 amount, address recipient_, uint minOut) external {
