...
/**
 https://t.me/mutantamongus
 https://www.mutantam0ngus.com/ */
...
contract mutantamongus is Context, IERC20, Ownable {
    ...
    string private _name ="Mutant Among US";
    string private _symbol = "MAU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xDb1A0874734e0337747BAb2162f987C3639bb854);
    address payable private taxWallet2 = payable(0xDb1A0874734e0337747BAb2162f987C3639bb854);
    ...
    uint256 public _walletMax = _totalSupply*1/25;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 10000000000)
