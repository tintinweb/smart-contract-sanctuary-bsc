...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4750fEABd59C192BC303EE07E6bE067Dc2584644; // owner address
...
contract FIFACATAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA CAT-AR";
    string private _symbol = "FCR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4750fEABd59C192BC303EE07E6bE067Dc2584644); // Marketing Address
    address payable public teamWalletAddress = payable(0x4750fEABd59C192BC303EE07E6bE067Dc2584644); // Team Address
