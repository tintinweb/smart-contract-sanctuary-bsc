...
contract DancingQueenInu is Context, IERC20, Ownable {
    ...
    string private _name = "Dancing Queen Inu";
    string private _symbol = "DANCEQUEEN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0xa7A7C0431251c05014515F36F4A1CeD7AcB57752);
