...
/*
Gonk Adventure is a meme game about adventures of three friends, Gonk , Bonk and Shib
$Gonk Features 🦧
...
🦧Renounce
🦧CA - SOON
🦧TG: https://t.me/GonkFeatures
🆗Contract Address : 0x8244130baA3D8937199276A8941D386588818210
🦧🦧🦧BSC🦧Renounce🦧LP LOCK🦧Tax 3%🦧
🦧🦧🦧
🦧 Gonk GLOBAL
🦧 CREATED BY WHALES,
TO MAKE MORE WHALES, BY 🦧
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextBEP20Gonk {
...
contract OwnableBEP20Gonk is ContextBEP20Gonk {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20Gonk: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20Gonk: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract Gonk is ContextBEP20Gonk, BEP20Gonk, OwnableBEP20Gonk {
    ...
    string private _name = 'Gonk';
    string private _symbol = 'Gonk';
