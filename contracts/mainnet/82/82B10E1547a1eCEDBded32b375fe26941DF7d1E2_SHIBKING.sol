...
https://t.me/xShibaKing
The automatic tax lowering system!
...
contract SHIBKING is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x112795A1fefE25098EA88F453FB70625EdE1b92B; 
    address public constant marketing_receiver =0x112795A1fefE25098EA88F453FB70625EdE1b92B;
    address public constant liquidity_receiver = 0x112795A1fefE25098EA88F453FB70625EdE1b92B;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(10 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(6000);}
        if(launchTime.add(60 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(2000);}
