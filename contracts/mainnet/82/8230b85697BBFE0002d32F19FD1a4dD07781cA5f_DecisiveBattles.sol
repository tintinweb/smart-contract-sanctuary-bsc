...
/*
Tokenomics:
5% of each buy will goes to liquidity.
5% of each buy goes to future incubation projects.
10% of each sell goes to liquidity.
https://t.me/Decisive_Battles
*/
...
contract DecisiveBattles is Ownable, IERC20 {
    using SafeMath for uint256;

    uint public _liquidityFee = 5;
    uint public _marketingFee = 5;

    uint public _liquiditySellFee = 10;
    ...
    string private _name = "Decisive Battle Inu";
    ...
    uint256 public _maxWallet = 200000000000 * 10 ** _decimals;
