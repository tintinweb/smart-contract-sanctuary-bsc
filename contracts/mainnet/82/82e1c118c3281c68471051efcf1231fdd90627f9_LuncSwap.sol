...
contract LuncSwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "LuncSwap";
    string private constant _symbol = "LUNASIC";
    ...
    uint256 public sellTreasuryFee = 100;
    uint256 private _previousSellTreasuryFee = sellTreasuryFee;
    uint256 public sellOpsFee = 50;
    ...
    address payable private _treasuryWallet = payable(0x35721C299A5c0aFff936799c999895F0d99aBCa4);
    address payable private _opsWallet = payable(0xC4d0b96614A7818294e7134EdBf08A6faa9961Eb);
