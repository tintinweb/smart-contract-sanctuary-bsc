...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8dD5B5d0A627eF70909Fc99ECCFae18c43De153D;
...
contract QoinPeToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCC4bCbAEbf124a0463fa0C26A3487ACE7B1365b7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "QoinPe";
    string private _symbol = "QPE";
