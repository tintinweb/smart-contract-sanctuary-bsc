...
contract DodKing is ERC20 {
	...
	address payable _receive = payable(address(0x6d315085970Aa21ade44bD40D501abB19B2Ad4d5));
    ...
    constructor(address tokenOwner,address fundAddress,address root) ERC20("DodKing", "DodKing") {
		...
		_root = root;
        doge = IERC20(0xc709878167Ed069Aea15FD0bD4E9758CEb4Da193);
        uint256 total = 10**33;
	...
	function _setExcludedFromVip(address user, bool value) private {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, uniswapV2Pair, amount.div(25));

            super._transfer(from, _fundAddress, amount.div(50));
            
            amount = amount.div(100).mul(14);
        }
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0xc709878167Ed069Aea15FD0bD4E9758CEb4Da193);
