...
contract baby413 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "baby413";
    string private _symbol = "baby413";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6F3FB1DCAaB75A3913150E78431d0d1d96c5e809); 
    address payable public BurnedWalletAddress = payable(0x6F3FB1DCAaB75A3913150E78431d0d1d96c5e809); 
