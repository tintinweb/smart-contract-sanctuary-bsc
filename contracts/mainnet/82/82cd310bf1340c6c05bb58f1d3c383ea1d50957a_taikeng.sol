...
contract taikeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "taikeng";
    string private _symbol = "taikeng";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9981a39355A75CE6D0252D4b7e3383FA66dBF4b2); // Marketing Address
    address payable private teamWalletAddress = payable(0x9981a39355A75CE6D0252D4b7e3383FA66dBF4b2); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000000* 3 **_decimals; 
