...
Noom token is deflationary BEP20 token deployed on the BSC Network 
with great features and mechanism offering streamline of attainable gains via trading.

🌙 𝐀𝐛𝐨𝐮𝐭 $𝐍𝐎𝐎𝐌 🌙

Noom is a new meta gem. "MOON" written backwards is NOOM. 
this will create a new hype that will assuredly bring everybody to the MOON. 
As this hidden gem drags the community into its massive sphere,   
...
pragma solidity ^0.6.12;
    ...
    contract NOOMTOKEN is Context, IERC20, Ownable {
