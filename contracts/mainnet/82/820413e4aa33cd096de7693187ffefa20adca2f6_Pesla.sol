...
contract Pesla is Context, iBEP20, Ownable {
  ...
  modifier onlyMasterChef() {
      require(smartChef[msg.sender] == true, "Only Smart Contract can call this function");
      _;
  }
  ...
  constructor() public {
    ...
    _symbol = 'PESLA';
    _decimals = 8;
    _totalSupply = 5_000_000 *(10**_decimals);
