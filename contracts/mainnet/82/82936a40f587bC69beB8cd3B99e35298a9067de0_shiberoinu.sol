...
contract shiberoinu is Context, IERC20, Ownable {
    ...
    string private constant _name = " Shibero Inu"; // 
    string private constant _symbol = " $SHINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0x03Bc73703F682A08Aab07be8824a7CcF37EE8a63;
