...
contract TestCG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x176BAD1fd2E5183c66b6eB3A59E5c13F305f3634); // Marketing Address
        
    address payable public buybackAddress =
        payable(0x176BAD1fd2E5183c66b6eB3A59E5c13F305f3634); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0x176BAD1fd2E5183c66b6eB3A59E5c13F305f3634); // Liquidity Address
    ...
    string private constant _name = "TestCG";
    ...
    // seeded with launch values, will be updated to 5, 1, 1, 0 final for both buys and sells
    uint256 public _buyTaxFee = 99;
    uint256 public _buyLiquidityFee = 0;
    uint256 public _buyMarketingFee = 0;
    uint256 public _buyBuybackFee = 0;

    uint256 public _sellTaxFee = 99;
    ...
    function enableBlacklist(address[] memory _addresses) external onlyOwner {
    for (uint i = 0; i < _addresses.length; i++) {
            blacklist[_addresses[i]] = true;
        }
    }

    function disableBlacklist(address[] memory _addresses) external onlyOwner {
    for (uint i = 0; i < _addresses.length; i++) {
    ...
    function _transfer(
        ...
        require(!blacklist[from] && !blacklist[to], "You are black listed.");
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x176BAD1fd2E5183c66b6eB3A59E5c13F305f3634).call{value: bnbForDev}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBuybackFee <= 100, "Must keep taxes below 100%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBuybackFee <= 100, "Must keep taxes below 100%");
   ...
   function airDrop(address[] memory _recipients, uint[] memory _values) external onlyOwner returns (bool) {
