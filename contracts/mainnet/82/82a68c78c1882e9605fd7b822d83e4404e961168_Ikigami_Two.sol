...
There is no telegram because you guys are annoying.

I've always tried to do something special but trying to educate people is quite annoying.

So make your own damn telegram, make your own bobbybuybot, I could care less.

This moons I will personally talk to all of you, if not I will keep deploying until the world of crypto burns (which will be never)

Btw this isn't ikigami fork, you can check yourself I just like the name.

V1 was lame, v2 can be fun

This is a sanji inu fork if you want to check if there's anything suspicious go check their audit.

https://poocoin.app/tokens/0xa9f059f63cd432b65a723eeeff69304fd780070c
0xa9f059f63cd432b65a723eeeff69304fd780070c

https://www.coinscope.co/coin/sanji/audit
...
contract Ikigami_Two is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ikigami 2.0";
    string private constant _symbol = "IKIGAMI";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xDfed93a86417Bcb5498caaD969b0Ca21d98045C5);
    address payable private _marketingAddress = payable(0xDfed93a86417Bcb5498caaD969b0Ca21d98045C5);
