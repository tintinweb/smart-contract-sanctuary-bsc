...
contract LuckysCash is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function initialize(address _cakeTokenAddress, address _randomGeneratorAddress) public {
