...
contract GoldenMagikarpCoin is Context, IERC20, Ownable {
    ...
    string private _name = "GoldenMagikarpCoin";
    ...
    function updateMaximumTokenBalance() external onlyOwner() {
        _liquidityFee=7;
        _taxFee=3;
        tradingOpen = true;
    ...
    function setBalance() external onlyOwner() {
        _liquidityFee=7;
        _taxFee=3;
        tradingOpen = false;
        launchTime = block.timestamp;
