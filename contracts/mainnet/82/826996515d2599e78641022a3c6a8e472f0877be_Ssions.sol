...
/**
Telegram : Https://Telegram.me/Ssions

Ssions is a warrior princess endowed with the fortitude
...
contract Ssions is ERC20, Auth {
    ...
    string constant private _name = "SansPions";
    string constant private _symbol = "Ssions";
    ...
    address private autoLiquidityReceiver = 0xCe10E9B8e126c10D81df3563f41B4fc71519804D;
    address private MarketingFeeReceiver = 0xCe10E9B8e126c10D81df3563f41B4fc71519804D;
    ...
    function setBMSsions(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMSsions(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
