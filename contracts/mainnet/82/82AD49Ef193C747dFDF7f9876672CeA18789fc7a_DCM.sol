...
contract DCM is IERC20, Ownable {
    ...
    string constant _name = "Decom Credit";
    string constant _symbol = "$DCM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 142000 * (10**_decimals);
    ...
    constructor() {
        ...
        address deployer = 0x6743E0dbdB2AB1014044486f1Fa4cb9a73ef2fbe;

        isFeeExempt[deployer] = true;

        isAuthorized[deployer] = true;
        devFeeReceiver = 0x3cBf6FCb57E87CECFeeA0e1525a72E81B0451b15;
