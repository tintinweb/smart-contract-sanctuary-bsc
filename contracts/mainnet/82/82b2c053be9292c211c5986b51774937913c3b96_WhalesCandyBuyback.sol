...
contract WhalesCandyBuyback {
    ...
    address payable public _dev = payable (0x2096aFDaA68EEaE1EbF95DFdf565eE6d9B1fbA37); // TODO (able to set the contract)
    ...
    address public addressToken1 = 0x0A05EBf48790070EdEa55cD687E75c34f234F084; //test wcVelas // TODO must be WC on BSC
    address public addressToken2 = 0x2c55E80dc507018ab0B8Ad18e312A629f4607dfA; // TODO must should be DRIP

    address public constant _pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    IPancakeRouter02 _pancakeRouter;

    uint256 public BUSDbal;

    uint8 public share1 = 50;
    uint8 public share2 = 50;
    ...
    uint256 public LAUNCH_TIME = 1675285200;
    uint256 public oneWeek = 7 days; // TODO write  "7 days" for 1 week
    ...
    function setBuyBackShatre(uint8 _share1, uint8 _share2) external onlyDev {
      require(_share1 + _share2 <= 10, "Share1 + Share2 can`t be more than 100!");
        share1 = _share1;
        share2 = _share2;
    }
    ...
    function burnAndBuyback () public {   
        ...
        BUSDbal = IERC20(addressBUSD).balanceOf(contrAddr);
        ...
        if (BUSDbal > 1000000) {  // check if there is an usable amount of BUSD in the contract
          ...
          if (buyBackShare2 > 100000) {
            uint256 token2BalBefore = IERC20(addressToken2).balanceOf(contrAddr);
              ...
              path2[0] = addressBUSD;
              path2[1] = _pancakeRouter.WETH();
              path2[2] = addressToken2;
