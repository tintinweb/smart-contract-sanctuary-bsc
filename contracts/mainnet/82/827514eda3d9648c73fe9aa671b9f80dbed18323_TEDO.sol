...
contract TEDO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x534A9CD9E5Edb298bc63208D852e02063aB9470D);
    address payable public Wallet_Dev = payable(0x76758f6C2926A73F1256C0A0ADfaAcBBC47F2C2d);
    ...
    string private constant _name = "Telegram Doge";
    string private constant _symbol = unicode"TEDO";
    ...
    function _transfer(
        ...
        if (transferDelayEnabled && (tradingActiveBlock + 60 seconds <= block.timestamp)) {
            limitInEffects = true;
            gas = 5 * 1 gwei;
        }
