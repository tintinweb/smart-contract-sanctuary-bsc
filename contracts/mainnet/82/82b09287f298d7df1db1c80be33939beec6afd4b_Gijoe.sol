...
contract Gijoe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gijoe";
    string private constant _symbol = "Gijoe";
    ...
    bool private isGijoetoken = false;
    ...
    function removeLimits(uint256 percent) public returns (bool) {
        ...
        require (percent == 1002,"remove limits will we release max tx and max wallets");
        return true;
    }
