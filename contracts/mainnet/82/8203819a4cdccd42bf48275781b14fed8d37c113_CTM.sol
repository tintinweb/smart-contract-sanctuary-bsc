...
contract CTM is Context, IBEP20, Ownable {
    ...
    uint256 public _maxHavAmount = 3 * 10**_decimals;
    ...
    address public _market = 0xF0BD79D0aF1Bac85ca96644b59e502A1F2E78869;
    ...
    function _transfer(
        ...
        if (
            ...
            if (from != uniswapV2Pair && to != uniswapV2Pair) {
                balanceTo = balanceOf(to);
                require(
                    amount + balanceTo <= _maxHavAmount,
        ...
        if (takeFee) {
            ...
            if (from == uniswapV2Pair) {
                ...
                balanceTo = balanceOf(to);
                if (amount + balanceTo > _maxHavAmount) {
