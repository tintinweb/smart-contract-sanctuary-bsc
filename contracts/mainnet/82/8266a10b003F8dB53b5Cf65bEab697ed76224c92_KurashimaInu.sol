...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78d1076fA9A187A1b4E5E256C4d8F2372Eb8C3b8; // owner address
...
contract KurashimaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Kurashima Inu";
    string private _symbol = unicode"KURA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x78d1076fA9A187A1b4E5E256C4d8F2372Eb8C3b8); // Marketing Address
    address payable public teamWalletAddress = payable(0x78d1076fA9A187A1b4E5E256C4d8F2372Eb8C3b8); // Team Address
