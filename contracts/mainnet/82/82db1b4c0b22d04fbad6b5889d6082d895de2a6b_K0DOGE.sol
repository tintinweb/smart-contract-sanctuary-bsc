...
contract  K0DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "CYYS";
    string private _symbol = "CYYS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe0e8f7774E89A97d3a9B0E17A98f0B0093360168);
    address payable public teamWalletAddress = payable(0xC4B96081230F71761B89FF22437339436Ca357a1);
