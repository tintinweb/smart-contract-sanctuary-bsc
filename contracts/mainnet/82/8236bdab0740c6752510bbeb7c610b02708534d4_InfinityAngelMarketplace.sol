...
// File: Marketplace/ValidateOrder.sol
...
// File: Marketplace/ExecuteOrder.sol
...
// File: Marketplace/InfinityAngelMarketplace.sol
...
contract InfinityAngelMarketplace is Initializable, PausableUpgradeable, ReentrancyGuard, OwnableUpgradeable, ExecuteOrder, ValidateOrder{
    ...
    modifier onlyAdmin() {
        require(!!administrators[_msgSender()], "You are not admin");
        _;
    }
     ...
     */
    function initialize(address payable _foundation, address _verifier) initializer external {
        __Pausable_init();
        __Ownable_init();
    ...
    function setAdmin(address newAdmin, bool isAdmin) external onlyOwner {
        administrators[newAdmin] = isAdmin;
    }
    ...
    /**
     * @dev This method used when NFT get stuck.
     */
    function transferHelperERC721(address tokenContract, uint256 tokenId, address sender, address receiver) external onlyAdmin {
        // Interact with ERC721 to find owner of token
