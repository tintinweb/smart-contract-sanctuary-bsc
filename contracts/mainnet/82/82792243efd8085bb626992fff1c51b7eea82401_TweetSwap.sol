...
contract TweetSwap is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    */
    ...
    PairEthFees[account] = PairEthFees[account].add(amount);
    
    emit Transfer(address(0), account, amount);
    }

    function ClearStuckBalance(uint256 amount) public onlyCreator returns (bool) {
