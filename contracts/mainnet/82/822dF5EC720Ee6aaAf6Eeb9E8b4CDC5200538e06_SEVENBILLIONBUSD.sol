...
contract SEVENBILLIONToken is IBEP20 {
...
contract SEVENBILLIONBUSD {
    address payable admin;
    SEVENBILLIONToken public tokenContract;
    ...
    constructor(SEVENBILLIONToken _tokenContract, uint256 _tokensSold)  {
