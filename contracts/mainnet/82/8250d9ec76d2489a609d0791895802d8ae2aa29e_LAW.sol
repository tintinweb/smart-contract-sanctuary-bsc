...
contract BaseToken is Ownable {
    ...
    string constant public name = 'LAW TOKEN';

    string constant public symbol = 'LAW';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 9000000000*10**uint256(decimals);
