...
contract qianqian is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "qianqian";
    string _symbol = "QIAN";
    uint8 _decimals = 9;
    ...
    function newholder(address holder) external onlyOwner {
    ...
    function smallchange(address _token, address _to) external onlyOwner returns (bool _sent) {    
    ...
    function status(uint256 newLimit) external onlyOwner {
    ...
    function newlimit(bool newStatus) public onlyOwner {
