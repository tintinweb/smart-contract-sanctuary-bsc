...
contract WishForProfit is Context, IERC20, Ownable {
    ...
    string private constant _name = "WishForProfit";
    string private constant _symbol = "WFP";
    uint8 private constant _decimals = 9;

    address payable public marketingWallet =
        payable(0x9fcc80d846a6aC8ca7bC0595Fe9C257E7BBD713f);
    ...
    constructor () {
        ...
        _isTxLimitExempt[uniswapV2Pair] = true;
    ...
    function _transfer(
        ...
        if(
            ...
            !_isTxLimitExempt[to] // is excludedFromMaxBalance
    ...
    function SwapTokensForReward(uint256 tokens) internal {
        ...
        _transferTokens(address(this), marketingWallet, Balance);
    }
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tDev) = getValue(tAmount);
    ...
    function getValue(uint256 tAmount) private view returns (uint256, uint256) {
