...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A132a389407704Dc58fC0D810D52B2E5565F3A6; // owner address
...
contract sGALA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3A132a389407704Dc58fC0D810D52B2E5565F3A6); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A132a389407704Dc58fC0D810D52B2E5565F3A6); // Team Address
