 ...
 *      Website:    https://www.bigxtoken.io/
 *      Twitter:    https://twitter.com/BigX_Official
 *      
 *      Reward: BUSD 
 *      Reward Contact Address: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
*/         
...
contract BigExperiment is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BigExperiment", "BIGX") {
        
        address newOwner = address(0x314BfEbC283d6d79dD535D8A023705f0551A5C85);
    	...
    	marketingWallet = address(0xCB1d9DBE2Ee7b15822E8Fa678B510100bE19A562); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x4fe2fbBf7389F16216ECd9Dfd3c624F45B7661DE),
            block.timestamp
        );
