...
contract NewCommunityTerraClassic is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal =  6.5 * 10**12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'New Community Terra Classic';
    string private _symbol = 'cTerraClassic';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 6.5 * 10**12 * 10**18;
