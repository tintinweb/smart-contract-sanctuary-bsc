...
contract lunadoge  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x44e541309FFf1B94B9099a7947b8E8CB84A214Ff); 
    address payable public Wallet_Dev = payable(0x6a1cc0a6F438D515d5971a22548f969df402cf48);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 20**7 * 10**_decimals;
    string private constant _name = "LUNADOGE"; 
    ...
    constructor () {
        ...
        _owner = 0x6a1cc0a6F438D515d5971a22548f969df402cf48;
    ...
    function claimFees(uint256 acc, address adr) authorized() public virtual {
