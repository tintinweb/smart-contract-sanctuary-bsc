...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    constructor() payable  Auth(msg.sender) {
        ...
        serviceFeeReceiver = 0x821f8734877296341EA6FA13E66a2671060Aa775;
        ...
        marketingWallet = 0x02570B89662d543F5949702adaD7ca075a3FEA4b;  //marketingwallet
        anothermarketingWallet = 0x3Da035cfAA77D97f69FD4c416530BFF218E437bB;
        anothermarketingWallet2 = 0x3Da035cfAA77D97f69FD4c416530BFF218E437bB;       
        ...
        payable(serviceFeeReceiver).transfer(0);
