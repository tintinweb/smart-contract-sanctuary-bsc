...
//Pray For Trump is a meme token that will utilize the hyped of both Trump tokens and Pray trend.
//It aims to be one of the largest communtiy-driven initiatives in the universe.
//The team ensure to be transparent for every transaction that will happen in the near future.

//Tg : https://t.me/PrayForTrumpbsc
...
contract PrayForTrump is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pray For Trump"; // 
    string private constant _symbol = "$PFT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0xb3Fd9Fb7DDAB534d482A9F88D2D8D5B9c5072E40;
