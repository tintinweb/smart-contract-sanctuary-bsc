...
contract MaoCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mao Coin";
    string private _symbol = "MCoin";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x3c5CCbD0A4Cc950AFB6C66E8A6C77b9053a2e76b); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xC0F148fBbeDD8d3C20a0e61A6c8400EA071b2399); // buyback Address
    ...
    uint256 public _maxTxAmount = 2500000 * 10**9; // 0.1%
    uint256 public _walletMax = 5000000 * 10**9; // 2%
