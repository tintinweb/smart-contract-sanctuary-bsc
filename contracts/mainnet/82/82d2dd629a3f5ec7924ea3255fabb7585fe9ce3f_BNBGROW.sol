...
contract BNBGROW is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BNBGROWDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BNBGROW", "BNBGROW") {
        _buyRewardsFee = 4;
        _buyLiquidityFee = 2;
		_buyMarketingFee = 5;
        _buyDevFee = 1;
		...
		marketingWallet = payable(0xE958B4BA6d92b4a7120A71af8D8B333941671EDa);
        _devWallet = payable(0xD18B8Da330FaE392E2D76954EA63a8F2A9251f23);
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "BNBGROW: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BNBGROW: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "BNBGROW: Account is already the value of 'blacklisted'");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "BNBGROW: The marketing wallet is already this address");
...
contract BNBGROWDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BNBGROW_Dividend_Tracker", "BNBGROW_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "BNBGROW_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
