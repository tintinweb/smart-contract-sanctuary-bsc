...
library Address{
 ...
 contract MooneyTunes is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC00f9225075EEe72203B0961E70209977Bb32ec1;
    address public developmentWallet = 0xC00f9225075EEe72203B0961E70209977Bb32ec1;

    string private constant _name = "MooneyTunes";
    string private constant _symbol = "MOOTUNES";
    ...
    Taxes public taxes = Taxes(3, 4, 1, 1);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isWhitelisted[from] && !_isWhitelisted[to], "You are a bot");
    ...
    function bulkIsWhitelisted(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _isWhitelisted[accounts[i]] = state;
