...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function removeblack(address addr) public onlyOwner{
        blacklist[addr] = false;
    }
    
    function checkblack(address addr) public view returns(bool){
    ...
    function burn(uint256 tAmount) public {
        ...
        emit Transfer(msg.sender, BurnAddress, tAmount);
    }
