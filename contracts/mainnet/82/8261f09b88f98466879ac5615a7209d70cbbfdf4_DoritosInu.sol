...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52E3ee03bC04dE95A4c4E05C9A27E7114CDdbca5; // owner address
...
contract DoritosInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doritos Inu";
    string private _symbol = "DORITOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52E3ee03bC04dE95A4c4E05C9A27E7114CDdbca5); // Marketing Address
    address payable public teamWalletAddress = payable(0xc069CA87691daAB5E24fE3C8AAEA94cA4e1596ac); // Team Address
