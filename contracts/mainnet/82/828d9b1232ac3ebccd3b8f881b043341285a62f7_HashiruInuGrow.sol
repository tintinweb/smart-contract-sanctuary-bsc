...
contract HashiruInuGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hashiru Inu Grow";
    string private _symbol = "HASHIGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa4f5f94F717f9a315cA13cDD4D0aa51BeD27cF5A); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa4f5f94F717f9a315cA13cDD4D0aa51BeD27cF5A); // Team Address
