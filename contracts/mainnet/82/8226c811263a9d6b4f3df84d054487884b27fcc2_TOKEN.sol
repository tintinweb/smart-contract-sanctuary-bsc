...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "NopeApe"; //  Name
        _symbol = "NopeApe"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 5000000000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 10000000000000 * 10**_decimals; // 1% of total supply
        _maxWalletBalance = 10000000000000 * 10**_decimals; // 1% of total supply
        _marketingWalletAddress = 0xe44cFD9F5C3680F463e51308d9a09959aD69aAd1; // Marketing wallet 
        _devWalletAddress = 0x6c1C321Eee8ac65f15f4f76201faf0219626AD2b; // Dev wallet 
