...
contract ELIZABETH is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08B37d43Dc0b8032a5d47346a88B88A18Af89784); 
    address payable public Wallet_Dev = payable(0x08B37d43Dc0b8032a5d47346a88B88A18Af89784);
    ...
    string private constant _name = "Rest In Piece Queen Elizabeth"; 
    string private constant _symbol = unicode"ELIZABETH"; 
    ...
    constructor () {
        ...
        _owner = 0x08B37d43Dc0b8032a5d47346a88B88A18Af89784;
