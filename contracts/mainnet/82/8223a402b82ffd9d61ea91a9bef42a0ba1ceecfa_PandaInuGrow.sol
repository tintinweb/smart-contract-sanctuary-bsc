...
WANT TO SEE YOUR INVESTMENT GROW? PANDA INU IS HERE FOR YOU.

┌─┐┌─┐┌┐┌┌┬┐┌─┐  ┬┌┐┌┬ ┬  ┌─┐┬─┐┌─┐┬ ┬
├─┘├─┤│││ ││├─┤  │││││ │  │ ┬├┬┘│ ││││
┴  ┴ ┴┘└┘─┴┘┴ ┴  ┴┘└┘└─┘  └─┘┴└─└─┘└┴┘

Twitter: https://twitter.com/PandaInuGrow

Telegram: https://t.me/PandaInuGrow
...
contract PandaInuGrow is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Panda Inu GROW';
    string private constant _symbol = '$PIGROW';
    ...
    address public Marketing=payable(0x23114E2d03262d0dfa2085CC578FA878DA93648d);
    address private LiquidityRouter=payable(0x23114E2d03262d0dfa2085CC578FA878DA93648d);
    address private RedistributionCordination=payable(0x23114E2d03262d0dfa2085CC578FA878DA93648d);
    //TestNet
	...
	uint256 private MaxBuy = 1000000000 * 10**_decimals; // 1,000,000,000 tokens
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==LiquidityRouter||addr==RedistributionCordination;
    }
    ...
    constructor () {
        ...
        _excluded.add(RedistributionCordination);
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(RedistributionCordination).transfer((amount*2)/5);
    } 
    ...
    function TeamChangeRedistributionCordination(address newRedistributionCordination) public onlyOwner{
      RedistributionCordination=payable(newRedistributionCordination);
    }
