...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF9Ae5612AD219d3150426E6a1e92e69e2d02b859; // owner address
...
contract RabbitFinance is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x74a18723e199212E81a75A32CCD95e4300A4a676); // Marketing Address
    address payable public teamWalletAddress = payable(0xF9Ae5612AD219d3150426E6a1e92e69e2d02b859); // Team Address
    ...
    uint256 private _totalSupply = 990000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 990000000000 * 10**_decimals; 
    uint256 public _walletMax = 990000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 99000000 * 10**_decimals; 
