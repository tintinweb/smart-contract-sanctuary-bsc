...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5f26A810Db6091752917F7643730048195F3Fb8E
); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000000 * 10**6 * 10**9; 
    uint256 private buyBackUpperLimit = 10000000000000 * 10**18;
