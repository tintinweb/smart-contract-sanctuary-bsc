...
contract AngelBSC is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Angel Boobs";
    string private _symbol = "AngelBoobs";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4Fb6B12A8753a5231e9d7C8B7f8833fe48E4581b); // Marketing Address
    address payable teamWalletAddress = payable(0xf3aBDaD64c0d2aBcC89CC692c21d81C5663Fd023); //
    ...
    uint256 public _maxTxAmount = 1 * 10**10 * 10**9; //1 * 10**6 * 10**9;
    uint256 public _walletMax = 1 * 10**10 * 10**9;
