...
contract KinashiKitten is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KinashiKitten";
    string private _symbol = "KINASHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCd1b4b8FFf6685Ec61a5eE180148cE9166B4D704);
    address payable public teamWalletAddress = payable(0xCd1b4b8FFf6685Ec61a5eE180148cE9166B4D704);
