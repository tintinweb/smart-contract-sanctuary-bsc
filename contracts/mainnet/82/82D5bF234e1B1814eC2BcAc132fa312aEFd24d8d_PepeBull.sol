...
/*
PepeBull
Inspired by Pepe, one of the hot meme character, PepeBull aim to become one of the popular meme token in BSC. 

PepeBull is building a DApp where all holders that has sufficient tokens are getting chances to do lucky draw & get other popular coins! 

PepeBull has a powerful tokenomics which designed to protect the chart & yet also rewarding:
1) 1,000,000,000,000 of supply (1 trillion)
2) 9% of tax fees, which allocated into:
~ 3% for development & marketing
~ 3% PepeBull reflection
~ 3% back to LP
3) Initial LP : 1 BNB

Join PepeBull now!
TG : https://t.me/PepeBull
*/
...
contract PepeBull is Context, IERC20 { 
    ...
    string private constant _name = "PEPEBULL"; 
    string private constant _symbol = "PPBULL"; 
