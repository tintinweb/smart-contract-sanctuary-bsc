...
contract Mudra is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mudra SCAM";
    string private _symbol = "Mudra";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x3f5cDC030fAb8933D9FE7435bB28f0183eC3eF0b); // Marketing Address
