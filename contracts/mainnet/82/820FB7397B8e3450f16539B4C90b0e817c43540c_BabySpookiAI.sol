...
contract BabySpookiAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Spooki AI";
    string private constant _symbol = "BSAI";
