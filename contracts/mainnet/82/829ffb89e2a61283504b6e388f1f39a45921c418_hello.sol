...
contract hello is IBEP20, Auth {
    ...
    address public donationfeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        (bool devSuccess, /* bytes memory data */) = payable(donationfeeReceiver).call{value: amountBNBdev, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _devFeeReceiver) external onlyOwner {
        ...
        donationfeeReceiver = _devFeeReceiver;
    }
