...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x3002b67f2d01bce35cD4F97ce2EC306Cf99dD99a;
    }
}
...
contract FXTD is Context, IBEP20, Ownable {
    ...
    string private _name     = "FXTD SWAP";
    string private _symbol   = "WFXTD";
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        // uniswap
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x0951DFa4bc355FEe666Ad7cf140452f7443E30Ad);
