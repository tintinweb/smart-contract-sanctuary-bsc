...
contract TaxCollector is Ownable {
  ...
  uint256 public teamPercentage = 3350; address public teamWallet = 0xcf4f214cde21080fE9C5278f77F38Ee43da8e9F1;
  function setTeam (uint256 percent_, address wallet_) public onlyOwner { teamPercentage = percent_; teamWallet = wallet_; }
  
  uint256 public partnershipPercentage = 1650; address public partnershipWallet = 0xcf4f214cde21080fE9C5278f77F38Ee43da8e9F1;
  ...
  uint256 public rndPercentage = 5000; address public rndWallet = 0xcf4f214cde21080fE9C5278f77F38Ee43da8e9F1;
  ...
  , IERC20Metadata
{
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "BCL: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "BCL: transfer from the zero address");
    require(recipient != address(0), "BCL: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "EBCLRC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "BCL: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "BCL: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "BCL: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "BCL: approve from the zero address");
    require(spender != address(0), "BCL: approve to the zero address");
