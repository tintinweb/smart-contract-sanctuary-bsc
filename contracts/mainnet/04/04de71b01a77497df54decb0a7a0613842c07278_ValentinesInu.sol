...
contract TaxCollect is Ownable {
  ...
  uint256 public marketingPercentage = 2000; address public marketingWallet = 0xC276D4D41105c31c076789ED24F3186f7F5abFaE;
  ...
  uint256 public buybackandburnPercentage = 8000; address public buybackandburnWallet = 0xF93C7919A0383f1f1b217C2bA5E501b2DCf9de9D;
  ...
  function distribute() public onlyOwner swapping {
    require(marketingPercentage + buybackandburnPercentage == maxPercent, "The sum of percentage isn't 100.");
    require(
    ...
    (bool sent_1, ) = payable(marketingWallet).call{value: (amount * marketingPercentage / maxPercent), gas: 30000}(""); require(sent_1, "Transfer wallet_2 error."); balance = address(this).balance;
    (bool sent_2, ) = payable(buybackandburnWallet).call{value: (amount * buybackandburnPercentage / maxPercent), gas: 30000}(""); require(sent_2, "Transfer wallet_3 error."); balance = address(this).balance;
  }
  ...
  , IERC20Metadata
{
  ...
  string private _symbol = "LOVESINU";
