...
contract BatFlokii is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BAT FLOKI";

    string private _symbol = "$BATFLOKI";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xE7824C12f6E3984094D098c046C041F6fF681E05;
