 ...
 */
contract McGriddlesTOKEN is ERC20Detailed, Ownable {
    ...
    uint256 public numTokensSellDivisor = 999;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("McGriddles", "McGriddles", uint8(DECIMALS))
        payable
        public
    {
  ...
  event Sender(address sender);
   ...
   returns (bool)
   {
        ...
        returns (bool)
    {
      ...
      uint256 numTokensSell =value.mul(10).div(100);
