...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public REWARD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // temp safemoon
...
contract GAT is IERC20, Taxable {
    using SafeMath for uint256;
    ...
    string _name = "GREEN CAT INU";
    string _symbol = "$GAT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);     // 100,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 5000;  // 5% 
