...
Raijin (雷神) is the Japanese god of thunder, lightning, and storms.
Telegram: https://t.me/raijinbsc
Twitter: https://twitter.com/RAIJINBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF699E6EF6A3c7d741081A41320D965841c602B3e; // owner address
...
contract RAIJINGHOST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RAIJIN";
    string private _symbol = "RJN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e6FadA094544f232AF03E7581164D58Cd72B8eF); // Marketing Address
    address payable public teamWalletAddress = payable(0xA24f28DEa7c9614d6d5eBA4d8e4B7b782c16AdF4); // Team Address
