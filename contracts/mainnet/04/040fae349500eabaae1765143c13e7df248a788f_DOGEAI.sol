...
Doge AI ($DOAI) is an smart doge that is connected to the Open AI system, 
which is integrated with ChatGPT and will assist us in achieving our objectives. 
The blockchain ecosystem will also be cycled using the open AI concept. 
The first thing we will do is create our own NFT platform, 
which will convert photographs from ChatGPT to NFT automatically 
and allow us to sell them on any nft marketplace platform.

Telegram https://t.me/DogeAIEntry
...
contract DOGEAI is ERC20, Ownable {
    ...
    constructor() ERC20("Doge AI", "DOAI") {
        ...
        marketingWallet = address(0x389b3b91066088369AD16D9CDF6bb5b310861b19); // set as marketing wallet
        devWallet = address(0x389b3b91066088369AD16D9CDF6bb5b310861b19); // set as dev wallet
