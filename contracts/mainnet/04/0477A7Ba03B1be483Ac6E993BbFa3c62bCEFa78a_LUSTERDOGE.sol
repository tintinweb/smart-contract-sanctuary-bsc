...
library Address{
 ...
 contract LUSTERDOGE is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 50_000_000 * 10**9; //0.5%
    uint256 public maxSellLimit = 5_000_000 * 10**9; //0.5%
    uint256 public maxWalletLimit = 100_000_000 * 10**9; //1%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x07c1FF36D8B296bF884955d619915b9D05Aa11D8;
    address public buybackWallet = 0x07c1FF36D8B296bF884955d619915b9D05Aa11D8;

    string private constant _name = "LUSTERDOGE";
    string private constant _symbol = "$LUSTERDOGE";
