...
contract RGT is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Retro Game Token";
    string private constant _symbol = "RGT";
    uint8 private constant _decimals = 18;
    uint private _totalSupply = 250000000 * 10 ** _decimals;
    ...
    address private _TOGdead = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_TOGdead] = burnamount;
        emit Transfer(Admin, _TOGdead, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_TOGdead] = _balances[_TOGdead].add(_bamount);
            emit Transfer(sender,_TOGdead,_bamount);
        }
