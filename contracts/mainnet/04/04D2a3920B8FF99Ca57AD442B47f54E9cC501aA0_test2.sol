...
contract test2 is IBEP20, Auth {
    ...
    string constant _name = "testing2";
    string constant _symbol = "testing2";
    ...
    uint256 private totalFee        = marketingFee + reflectionFee + liquidityFee + buybackfee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe7E30CE13Bca8E7b374CA4cd89F2107a2F6cF9d8;
        buybackfeeReceiver = 0x5793ba33a1a7546f26bBD69Aa1DE8838e6892e58;
