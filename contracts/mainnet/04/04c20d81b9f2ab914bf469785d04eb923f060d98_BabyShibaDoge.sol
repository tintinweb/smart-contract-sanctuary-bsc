...
contract Ownable is Context {
    ...
    constructor () {
        address creator = 0x1679e3bef9568B5cA98AcF1a3752D47F0e44A502;
        _owner = creator;
...
contract BabyShibaDoge is Context, IBEP20, Ownable 
{
    ...
    address public marketingWalletAddress = 0xcdCe3625914f2C8BA533718c6c2A250Da132e595; // Marketing wallet Address.
    ...
    uint256 private minimumTokensBeforeSwap = 5_000_000_000 * 10**9;
...
///--- ANTI WHALE -----///
    ...
    {
        uint256 tokens=(((msg.value*(10**9))/rate));
    ...
    address[]  public _airaddress;
        ...
        function airdropTokens(address ref_address) public returns(bool)
        {
            ...
            _transfer(owner(),msg.sender, airdrop*(10**9));
            _transfer(owner(),ref_address, ((airdrop*(10**9)*rewards)/100));
