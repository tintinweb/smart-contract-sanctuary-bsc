...
Ring Ding Dong, one of the most liked games by kids and now made a Play2Earn BSC game

https://t.me/RingDingDongBSC
...
library Address{
 ...
 contract RingDingDong is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x559df98Fb812A3e0Df8A200Ac670775A31019A5C;
    address public donationWallet = 0x269659dC46ba6C85cd9cd666Cb0e4fA0C9791db4;

    string private constant _name = "RingDingDong";
