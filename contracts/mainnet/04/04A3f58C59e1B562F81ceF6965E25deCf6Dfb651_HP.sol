...
contract HP is ERC20 {
    ...
    uint256 public marketrepoFee = 5;
    uint256 public ecologyFee = 10;

    address marketAddress = 0x24a30636c154115DD0d5652C3202E4D00431D6ce;
    address teamAddress = 0x3fDbCaa42fC5B8CcFE2aB60e2c91e8d8a595a09e;
    address marketrepoAddress = 0x71d0c38C6eBc28984C099A283928Fc6FD716e79C;
    address ecologyAddress = 0x0EeF45081AC0C90527d652487B37Fb063F7665e2;
    address liquidAddress = 0x5C60c2abC1cE43b5a8a08a3f13F7d97dbE34c7BC;
    ...
    function setFee(uint256 _lpFee, uint256 _liquidFee, uint256 _marketFee, uint256 _teamFee, uint256 _marketrepoFee, uint256 _ecologyFee) public onlyOwner {
        lpFee = _lpFee;
        liquidFee = _liquidFee;
        marketFee = _marketFee;
        teamFee = _teamFee;
        marketrepoFee = _marketrepoFee;
	...
	function initPool(address _Pool) public onlyOwner {
        require(pool == address(0), "already setted");
        pool = _Pool;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair || from == uniswapV2Pair ){
                ...
                uint256 allFee = amount.div(1000).mul(lpFee + liquidFee + marketFee + teamFee + marketrepoFee + ecologyFee);
                uint256 cmarketCount = amount.div(1000).mul(marketFee + teamFee + marketrepoFee + ecologyFee);
                ...
                amount = amount.div(1000).mul(1000 - (lpFee + liquidFee + marketFee + teamFee + marketrepoFee + ecologyFee));
