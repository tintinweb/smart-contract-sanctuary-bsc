...
contract Moonshot is IBEP20, Auth {
    ...
    string constant _name = "Moonshot";
    string constant _symbol = "Moonshot";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(2).div(1000);
    uint256 public _maxWalletToken = _totalSupply.mul(2).div(1000);
    ...
    uint256 public feeDenominator  = 110;
    ...
    constructor () Auth(msg.sender) {
        ...
        address routerV2 = 0x807bAf352cfD82e07bD94eFfb1Cf288896B8245E; 
        ...
        marketingFeeReceiver = 0x36c7dF6C87Ef0954e8df54AF09Df7929C32E9ecd;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0xf27296011c3c3D9221F77745EF8059084C4C54Df;
    ...
    function enable_Launch(bool _status) external authorized {
        LaunchMode = _status;
