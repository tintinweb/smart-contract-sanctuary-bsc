...
// IJRI/SAM ----> Moneda Digital SicloCoin Gold
...
contract SicloCoinERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("SicloCoin", "Siclo", 18) 
    ERC20Permit("SicloCoin") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 7000000000000000000000000000); 
