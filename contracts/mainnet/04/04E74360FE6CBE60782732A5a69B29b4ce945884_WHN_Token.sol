...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public sellLpAddr = 0xBCCc55d2059Ed457b83153746Cc449996Bd97c1C;
    ...
    function swapAndToDividend() internal lockTheSwap {
        ...
        uint256 _totalFee_ = buylpFee + sellLpFee;
        uint256 toLpAmount = (theSwapAmount * buylpFee) / _totalFee_;
        uint256 toSellMarket = theSwapAmount - toLpAmount;

        try
            distributor.transferUSDT(IERC20(USDT), address(this), toLpAmount)
        {} catch {}
        try
            distributor.transferUSDT(IERC20(USDT), sellLpAddr, toSellMarket)
        {} catch {}
    }
