...
SAUDI SHIBA INU FANS 

- Reward 4% SAUDI SHIBA !!!

https://t.me/SAUDISHIBAINUFANS
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2d6F3Dc5b202ccd91Db114B592872BCA32a7e292);
...
contract SaudiShibaInuFans is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SAUDI SHIBA INU FANS";
    string constant _symbol = "SAUDISHIBFANS";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2d6F3Dc5b202ccd91Db114B592872BCA32a7e292;
    ...
    uint256 public swapThreshold = 2500 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3B1377A8f12F61f01F2E6075474F77cFda2ce2d3;
        marketingWallet = 0x9d01b64acdbef3E0DB64B2f4bFC092a68218b2F3;
        devWallet = 0x3B1377A8f12F61f01F2E6075474F77cFda2ce2d3;
