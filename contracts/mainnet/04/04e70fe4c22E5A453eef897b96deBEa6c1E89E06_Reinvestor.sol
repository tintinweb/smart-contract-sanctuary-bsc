...
contract Reinvestor {
    ...
    function launchpoolReinvest(
        ...
        (,, uint128 reward, uint256 claimedReward) = StakingService(stakingService).stakers(msg.sender);
        uint128 reinvestAmount = reward - uint128(claimedReward);
        ...
        IERC20(nmx).safeTransfer(msg.sender, reinvestAmount);
        StakingService(stakingService).stakeFrom(msg.sender, reinvestAmount);
    }
