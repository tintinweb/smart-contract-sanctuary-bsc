...
//TELEGRAM: https://t.me/shenlong_official
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);//Binance-Peg Ethereum
...
contract SHENLONG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHENLONG";
    string constant _symbol = "SHEN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x31B3DeB660991030e8aE2044C0fB99DBAE8F2284; //change;
