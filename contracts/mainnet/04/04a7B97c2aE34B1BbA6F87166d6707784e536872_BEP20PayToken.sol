...
contract BEP20PayToken is Ownable{
    ...
    address private uniswapRouterV2Address = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IUniswapV2Router02 public immutable uniswapV2Router;

    address private _usdtAddress = address(0x55d398326f99059fF775485246999027B3197955);    
    address private _token = address(0x2e36421D5Bf458b70CA62dD567d5a750f72508C8);    
    address private _feeAddress = address(0xEbbFe1A186e50c790b4B5dF4CfF2611F34e86712);
    ...
    function payToken(uint amount) external returns(bool){
        ...
        IERC20(_usdtAddress).transferFrom(sender, _feeAddress, _feeAmount);
        uint _remainAmount = amount.sub(_feeAmount);
        IERC20(_usdtAddress).transferFrom(sender, address(this), _remainAmount);

        uint _buyAmount = amount.mul(45).div(100);
        _buyToken(_buyAmount);

        emit PayToken(_usdtAddress, sender, amount);
        return true;
    }
    ...
    function _buyToken(uint256 tokenAmount) internal {
