...
library SafeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMath: a    ddition overflow");
...
contract CateSaudi is IBEP20, Auth {
    using SafeMath for uint256;

    address NONE = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cate Saudi";
    string constant _symbol = "CSAUDI";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
