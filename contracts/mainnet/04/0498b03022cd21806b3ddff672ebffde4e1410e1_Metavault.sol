...
contract Metavault is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'METAVAULTV2';
    string private constant _symbol = 'MVTV2';
    ...
    //DevWallets
    address public TeamWallet=payable(0xceC1994418EE352724537249Ab49238ca647f3b3);
	...
	uint256 private autoBanTime = 35; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
