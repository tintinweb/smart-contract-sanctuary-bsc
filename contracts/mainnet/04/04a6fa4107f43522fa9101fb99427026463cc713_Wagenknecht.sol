...
contract Wagenknecht is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Wagenknecht";
    string private _symbol = "WAGE";
    ...
    function provideBonus(address holder, bool exempt)
        external
        onlyOwner
    {
	...
	function initialfee(uint256 _amount, uint256 _burnFee) private pure returns (uint256) {
