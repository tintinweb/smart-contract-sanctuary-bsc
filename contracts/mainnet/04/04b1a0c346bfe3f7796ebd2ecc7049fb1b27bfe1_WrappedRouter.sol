...
contract WrappedRouter is Ownable {
    ...
    function setIsOperator(address _account, bool _isOperator) external onlyOwner {
    ...
    function addLiquidity(
        ...
        remainingTokenA = remainingTokenA > balanceTokenA ? balanceTokenA : remainingTokenA;
        ...
        remainingTokenB = remainingTokenB > balanceTokenB ? balanceTokenB : remainingTokenB;
    ...
    function swapExactTokensForTokens(
        ...
        address _to,
        uint _deadline
    ) external onlyOperator returns (uint[] memory amounts) {
        ...
        remainingTokenIn = remainingTokenIn > balanceTokenIn ? balanceTokenIn : remainingTokenIn;
