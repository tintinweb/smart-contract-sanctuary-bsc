...
contract UAW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "UAW SLOGAN";
    string constant _symbol = "UAW";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x283651626ACE171Cde895e575F2Dcebdd02E9474;
