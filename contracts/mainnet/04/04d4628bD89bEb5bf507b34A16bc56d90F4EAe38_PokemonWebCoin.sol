...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2161328D71A3eA7ee4c0494B2D1a2124F4d5e889; // owner address
...
contract PokemonWebCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pokemon Web Coin";
    string private _symbol = "PWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2161328D71A3eA7ee4c0494B2D1a2124F4d5e889); // Marketing Address
    address payable public teamWalletAddress = payable(0x2161328D71A3eA7ee4c0494B2D1a2124F4d5e889); // Team Address
