...
import "./ERC1155Advanced.sol";
import "common-contracts/contracts/Governable.sol";

contract DrunkRobotsLootBoxes is ERC1155Advanced, Governable {
    constructor(
        string memory _name,
        string memory _symbol,
        string memory _baseUri
    ) ERC1155Advanced(_name, _symbol, _baseUri) {}

    function setBaseURI(string memory newuri) public onlyGovernance {
        _setBaseURI(newuri);
    }
...
/// @notice ERC1155 contract based on solmate, with ERC1155Supply (OZ) functionality + concatenated uri + symbol + name
abstract contract ERC1155Advanced {
