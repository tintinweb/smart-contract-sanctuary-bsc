...
contract SkydoAI is ERC20, Ownable {
    ...
    constructor() ERC20("AI-Skynet Doge", "AI-SKYDO") {
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x9d4FfdC4E47bAC87bB76AD7BD8CBA1C4D9D20b26;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner {
        require(
            newAmount > totalSupply() / 100_000_000,
