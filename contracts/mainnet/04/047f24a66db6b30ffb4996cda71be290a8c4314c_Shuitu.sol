...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81F117bEAe162081895b33ecB3B62337d3C24b63; 
...
contract Shuitu is Context, IERC20, Ownable {
    ...
    string private _name = "Kronoid";
    string private _symbol = "Kronoid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81F117bEAe162081895b33ecB3B62337d3C24b63); // 
    address payable public teamWalletAddress = payable(0x81F117bEAe162081895b33ecB3B62337d3C24b63); // 
