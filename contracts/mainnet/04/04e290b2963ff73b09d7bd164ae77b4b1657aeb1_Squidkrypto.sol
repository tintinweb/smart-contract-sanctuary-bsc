...
Telegram: https://t.me/Squidkrpyto

Squid Krypto a Squid Game community, decentralized Exchange Platform with Auto-Compounding & Staking Protocol Providing Investors with profitable income.
...
contract Squidkrypto is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA1EB71E41b0e47863C0F7B754BaC32c513b7e5B6); 
    address payable public Wallet_Dev = payable(0xA1EB71E41b0e47863C0F7B754BaC32c513b7e5B6);
    ...
    string private constant _name = "Squid Krpyto"; 
    string private constant _symbol = unicode"SK"; 
    ...
    constructor () {
        ...
        _owner = 0xA1EB71E41b0e47863C0F7B754BaC32c513b7e5B6;
