...
contract RARE is IERC20 {
    ...
    string constant private _name = "Rarety";
    string constant private _symbol = "RARE";
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            dexRouter = IRouter02(0xa06df99E41BDA7cEaAbCb5AB4574eCa9aeeE3893);
        } else if (block.chainid == 1 || block.chainid == 4 || block.chainid == 3) {
            dexRouter = IRouter02(0x9638500b9611862808964c9b1E31B7EbCA899854);
            //Ropstein DAI 0xaD6D458402F60fD3Bd25163575031ACDce07538D
        } else if (block.chainid == 43114) {
            dexRouter = IRouter02(0xC0026dC98Fc3385b2Ab6d563b34F4Cdd670ea00e);
        } else if (block.chainid == 250) {
            dexRouter = IRouter02(0x160efe555b5e737586d15B1Dfa66A20F021157eE);
        } else {
            revert();
        }
