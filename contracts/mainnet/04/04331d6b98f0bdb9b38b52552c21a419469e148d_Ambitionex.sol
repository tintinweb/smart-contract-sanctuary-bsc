...
contract ERC20 is Context, IERC20, IERC20Metadata, ReentrancyGuard {
    ...
    string private _name = "Ambitionex";
...
contract Ambitionex is ERC20, Ownable {
    ...
    address internal constant ambitionexTeam_addr_1 = 0xe1c5Aa89BfA85a7449Fe3D822fAD7242312D1a04; // 39%
    address internal constant ambitionexTeam_addr_2 = 0x975a790e68B03D91B623A08bF6792b13B89a9B2d; // 35%
    address internal constant ambitionexTeam_addr_3 = 0x37dEDcfdCB1D5F4e0c3ACD12515B5e761C59FA0d; // 10%
    address internal constant ambitionexTeam_addr_4 = 0x09A48236139633BdbFE7D07FCe7B8D0ca621F10C; // 16%
    address internal marketing_addr = 0x747B464A6bBDe95D855bc816B016E5b80C5417C6;
    address internal buyBack_addr = 0x34B65e1422b04DbF1a241F2ec4719f4B4A7E0693;
    ...
    /* % from every day's lobby entry dedicated to ambitionex team, marketing and buy back */
    uint256 internal constant DM_ambitionexTeam_percentage = 4;      
    ...
    function flushFirstDayLobbyEntry() external onlyOwner() nonReentrant {
        ...
        payable(ambitionexTeam_addr_1).transfer((lobbyEntry[1] * 94) /100);  
    }
    ...
    uint256 internal constant LAUNCH_TIME = 1664409600;   
    uint256 currentDay;
    ...
    /* Gets called once a day and withdraws ambitionex team's share for the privious day of lobby */ 
    function _sendDevShare() internal nonReentrant {
        require(currentDay > 0);

        // ambitionexTeamPercentage = 4% of every day's lobby entry
        uint256 ambitionexTeamPercentage = (lobbyEntry[currentDay - 1] * DM_ambitionexTeam_percentage) /100;
        
        // [39%, 35%, 10%, 16%] 
        payable(ambitionexTeam_addr_1).transfer((ambitionexTeamPercentage * 39) /100);
        payable(ambitionexTeam_addr_2).transfer((ambitionexTeamPercentage * 35) /100);
        payable(ambitionexTeam_addr_3).transfer((ambitionexTeamPercentage * 10) /100);
        payable(ambitionexTeam_addr_4).transfer((ambitionexTeamPercentage * 16) /100);
    }
     ...
     * @param amount Amount of AMB tokens to stake
    ...
    function EnterStake(uint256 amount, uint256 stakingDays) external {
        ...
        /* On stake AMB tokens get burned */
    ...
    /**
     * @dev Calculating a stakes Bonus AMB tokens based on stake duration and stake amount
     * @param StakeDuration The stake's days
     * @param StakeAmount The stake's AMB tokens amount
     */
