...
contract FlokidogeInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKI DOGE INU"; // 
    string private constant _symbol = "FDI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x7643B07172f2E1B36d128a5B40BB9F6a17AcF585;
