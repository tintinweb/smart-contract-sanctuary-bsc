...
//  ------------------------------------------------------
//  ------------------------------------------------------
//  --	   JOIN THE ROYAL TREE COMMUNITY TODAY			-- 
//  --     https://t.me/RoyalTree	  				    --
//  --     https://twitter.com/RoyalTree  				--
//  --     LET'S PLANT MORE TREES FOR A BETTER WORLD    --
//  --     https://RoyalTree.finance        			--
//  ------------------------------------------------------
//  ------------------------------------------------------
//────────────────────────────────────────────────────────────────────────────────
//
...
contract Ownable is Context {
    ...
    */
    constructor () {
      ...
      _marketing = 0x0ABEca0425Bf82F4A3d70fD96A805f2f47E4B85a;
      _web = 0x824963594b9692506ad332e4EBede318CFD26587;
    }
...
contract RoyalTree is Context, Ownable {
    using SafeMath for uint256;


    uint256 private TREE_TO_MINE_1MINERS = 1020000; //for final version should be seconds in a day

    uint256 private PSN = 10000;
    uint256 private PSNH = 5000;

    uint256 private devFeeVal = 1; // not implemented
    uint256 private marketingFeeVal = 1; // not implemented


    uint256 private webFeeVal = 5;
    ...
    mapping (address => uint256) public claimedTree;
    mapping (address => uint256) private lastHarvest;
    mapping (address => address) public referrers; // user address => referrer address
    mapping(address => uint256) public referralsCount; // referrer address => referrals count
    uint256 public marketTree;
    uint256 public uniqueUsers; // number of active users

    event ReferralRecorded(address indexed ref);
