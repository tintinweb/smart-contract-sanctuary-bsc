...
library SafeAVEDAO {
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAVEDAO: addition overflow");

    return c;
  }

  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAVEDAO: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAVEDAO: multiplication overflow");

    return c;
  }

  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAVEDAO: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAVEDAO: modulo by zero");
  }
...
contract AVEDAOOWNABLE is AVEDAOCONTEXT {
  ...
  modifier onlyOwner() {
    require(_owner == _msgSender(), "AVEDAOOWNABLE: caller is not the owner");
    _;
  }
  ...
  function _transferOwnership(address newOwner) internal {
    require(newOwner != address(0), "AVEDAOOWNABLE: new owner is the zero address");
    emit OwnershipTransferred(_owner, newOwner);
    _owner = newOwner;
  }
}

contract AVEDAO is AVEDAOCONTEXT, AVEDAOTOKEN, AVEDAOOWNABLE {
  using SafeAVEDAO for uint256;
  mapping(address => bool) public isAVEDAO;
