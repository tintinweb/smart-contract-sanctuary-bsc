...
contract ChangDoge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Chang Doge";
    string private constant _symbol = unicode"CD";
    uint256 private constant MAX = ~uint256(0);
    uint256 private econstan = 9;
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevAddress = payable(0xaF90f1949e20b46c35A5FD3EE78E9eE38Cc44E06);
    address payable private MarketingAddress = payable(0xaF90f1949e20b46c35A5FD3EE78E9eE38Cc44E06);
    ...
    uint256 public _maxWalletToken = _tTotal * 2 / 10;
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (!transferDelay){ require(!_isExcludeds[from]);}
