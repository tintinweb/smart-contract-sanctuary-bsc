...
contract poocatecoin is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Poocate Coin";
    string private constant _symbol = "POOCATE";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10 * 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x58B4c786B4D65cb354F4972C6AF56B9B4FcAD79a);
    address payable public MarketingWallet = payable(0x58B4c786B4D65cb354F4972C6AF56B9B4FcAD79a);
