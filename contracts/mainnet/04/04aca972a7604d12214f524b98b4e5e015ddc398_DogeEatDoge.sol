...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address public _ceo=0x13458D5e98A7AaAdf0a16eAc73ee1eC0914Cb868;
    ...
    modifier onlyOwner() {
        require(_ceo == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function _transfer(
        ...
        require(isLaunch || from==_ceo|| to==_ceo||isExcludedFromFee[from]||isExcludedFromFee[to]  , "Swap not open");
