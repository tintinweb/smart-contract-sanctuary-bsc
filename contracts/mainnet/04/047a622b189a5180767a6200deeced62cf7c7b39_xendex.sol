...
Telegram https://t.me/XendexBscProject
website https://xendex.tech/
*/
...
contract xendex is Context, IERC20, Ownable {
    ...
    string private _name = "XENDEX";
    string private _symbol = "$XNDX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x196A819d2aA04941B783D765b5649C464884774C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x196A819d2aA04941B783D765b5649C464884774C); // BuyBack Address
