...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x204B4abB541895E3371DFBc5669D4F6060CFD7F3; // owner address
...
contract TWITRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twit Rabbit";
    string private _symbol = "$TWTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x204B4abB541895E3371DFBc5669D4F6060CFD7F3); // 
    address payable public teamWalletAddress = payable(0x204B4abB541895E3371DFBc5669D4F6060CFD7F3); // 
