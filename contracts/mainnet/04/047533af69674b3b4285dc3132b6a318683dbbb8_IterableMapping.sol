...
contract BobbyHillToken is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor(uint256 initialSupply, address _owner, address _MarketingWallet, address _router) ERC20("BobbyHillToken", "BHT") {
        BNBRewardsFee = 5;
        liquidityFee = 4;
