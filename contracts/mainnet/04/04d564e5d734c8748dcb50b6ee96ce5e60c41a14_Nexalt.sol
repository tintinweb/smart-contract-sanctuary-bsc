...
contract Nexalt {
    ...
    constructor() {
        ...
        _decimals = 0; // Sets the number of decimal places
        uint256 _initialSupply = 42500000; // Holds an initial supply of coins
        uint256 _maxSupply = 100800000; // Holds an initial supply of coins
