...
/* Token contract */
contract BusdGrow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xaa7F4795bAb763aAB94f360Be0EbD43f21672dB7;
    ...
    // Name and symbol
    string constant _name = "BusdGrow";
    string constant _symbol = "BusdGrow";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; //2%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 10000; // 2%
