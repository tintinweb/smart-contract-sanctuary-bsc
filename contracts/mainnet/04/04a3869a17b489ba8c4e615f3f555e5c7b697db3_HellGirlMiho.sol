...
Telegram: https://t.me/HellGirlMihoOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48A15458cC54B1956adBf5EE73C43629F33e2913; // owner address
...
contract HellGirlMiho is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hell Girl Miho";
    string private _symbol = "$HGM"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x48A15458cC54B1956adBf5EE73C43629F33e2913); // Marketing Address
    address payable public teamWalletAddress = payable(0x48A15458cC54B1956adBf5EE73C43629F33e2913); // Team Address
