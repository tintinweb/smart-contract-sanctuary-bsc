...
contract LowTax is Context, IERC20, Ownable {
    ...
    string private constant _name = "LOW TAX 1%"; // 
    string private constant _symbol = "LOW-TAX 1%"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xc06108E64498aB6ebde4Bba6ea4B6DaC171d4bE9;
