...
/**
STEALTH LAUNCH AT 80-100 MEMBERS Based DEV
TG: https://t.me/Mysterymombsc
TAX: 
BUY : 10% 
SELL: 12%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa1720201B9483bDb8D1B0F1ff53e76c5B3F3939A; // owner address
...
contract MotherDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Mother Doge";
    string private _symbol = "MothersDay";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x831622c3DC335869cd555c1Be926b0c05F095BFB); // Marketing Address
    address payable public teamWalletAddress = payable(0x831622c3DC335869cd555c1Be926b0c05F095BFB); // Team Address
