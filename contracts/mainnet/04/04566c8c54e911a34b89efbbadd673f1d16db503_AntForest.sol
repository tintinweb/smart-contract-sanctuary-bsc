...
contract AntForest is Context, IERC20, Ownable {
    ...
    string private _name = "Ant Forest";
    ...
    address public burnAddress = address(0xA190eAfa0cd5C708c5B9a65F9d024A073521abc9);
    address public ownerAddres = address(0x2C80a2b88458dc21C571F3438a579d450b32cd0d);
    address public devAddress = address(0x8bF742D85D16200b000C12C8c9f34578fB38abc8);
    ...
    uint256 private numTokensSellToAddToLiquidity = 10 * 10 **8;
