...
//Telegram: https://t.me/BurnSafeMoon
...
contract BurnSafeMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Burn SafeMoon"; // 
    string private constant _symbol = unicode"BSFM"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _CreatorWallet = 0x136230a6c9b96aC7268c0079a2E37a7B5a8B4dFd;
