...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA41A4cbe7f9Cdd77f57b376Ff10d63518f2716DC;
...
contract Weeber is Context, IERC20, Ownable {
    ...
    0x8531Fd22227801D81b68Ac3eA72fb3aD3F34c163;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Weeber";
    string private _symbol = "WBR";
