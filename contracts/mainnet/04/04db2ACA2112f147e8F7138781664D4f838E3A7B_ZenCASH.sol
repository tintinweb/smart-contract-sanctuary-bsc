...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa4Ff2de35DB1c8ec7fd106725100062C1da7A3f1;
...
contract ZenCASH is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8Ee00dADa5f763483CaaBF52bF8fa63E5CffB739;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZenCASH";
    string private _symbol = "ZCH";
