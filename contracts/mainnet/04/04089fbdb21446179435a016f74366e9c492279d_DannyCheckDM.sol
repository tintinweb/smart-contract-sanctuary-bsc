...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1f582e971Af2015f3E165dc0a08a7f1380a39d80; // owner address
...
contract DannyCheckDM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DannyCheckDM";
    string private _symbol = "$DM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc882Bb292E3B1252820A4f0fe6FAbb366AD7418f); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f582e971Af2015f3E165dc0a08a7f1380a39d80); // Team Address
