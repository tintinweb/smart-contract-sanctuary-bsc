...
contract PriceAndPremiumOracle {
    ...
    function getPremium() public view returns(uint256) {
        return getRewardUsd() * 2 / 3  * 9 / 10 / ebContract.totalShareCount() / 1e12 * 1e12; // 33% of reward is used for auto re-investment, 10% goes to sale tax. Don't care about the decimals corresponding to after .yy
    }
}