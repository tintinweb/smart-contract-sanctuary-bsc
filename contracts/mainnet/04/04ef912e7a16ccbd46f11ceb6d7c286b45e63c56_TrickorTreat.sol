...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 ONLYCHADS = IBEP20(0x813D435c321f2497437363A6aaB7972c9eb74438);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ONLYCHADS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ONLYCHADS);
        ...
        uint256 amount = ONLYCHADS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ONLYCHADS.transfer(shareholder, amount);
...
/* Token contract */
contract TrickorTreat is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses    
    address ONLYCHADS = 0x813D435c321f2497437363A6aaB7972c9eb74438; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0F9dA380614F5dCe3978A7cE7F1FE8578ADafdEB;
    ...
    // Name and symbol
    string constant _name = "Trick or Treat";
