...
contract ShinobiVerse is Context, IERC20, Ownable {
    ...
    string private _name = "ShinobiVerse";
    string private _symbol = "SHINO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19dB46de5433c13f0F164C8C0064dbe125df9D6B); // Marketing Address
    address payable public DevWalletAddress = payable(0x19dB46de5433c13f0F164C8C0064dbe125df9D6B); // Dev Address
