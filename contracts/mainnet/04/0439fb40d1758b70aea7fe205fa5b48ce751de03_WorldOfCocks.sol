...
contract WorldOfCocks is WOCDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private WOCTeam;
    address private CharityWOC;
    ...
    string public override name = "WorldOfCocks";
    string public override symbol = "WOC";
    ...
    constructor(uint totalSupplyValue, address WOCTeamAddress, address CharityWOCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        WOCTeam = WOCTeamAddress;
        CharityWOC = CharityWOCAddress;
       
        // split the tokens according to agreed upon percentages
        balances[WOCTeam] =  totalSupply * 5 / 100;
        balances[CharityWOC] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's WOCTeam pot
