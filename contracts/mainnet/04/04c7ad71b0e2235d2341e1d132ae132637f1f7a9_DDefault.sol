...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "ApeDoge Coin";
    string private _symbol = "ApedogeCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B62BCCb4d37978Eb909746eDed00bc1709A9A56); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf63247B8C4147E1499B211305Be23B489Ce56751); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 9999 * 10**6 * 10**9;
    uint256 public _walletMax = 9999 * 10**6 * 10**9;
