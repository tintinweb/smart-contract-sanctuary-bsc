...
// Telegram: https://t.me/NovemberBullRun
// Dont we all miss last novembers bull run :) 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb3433bBf3FB06Ba1E7114304934157e39EAC7884; // owner address
...
contract NOVEMBER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NOVEMBER BULL RUN";
    string private _symbol = "NOVEMBER";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x57298A8C699275BaD1587be6a7ff9B091469C5e1); 
    address payable public teamWalletAddress = payable(0x57298A8C699275BaD1587be6a7ff9B091469C5e1);
    ...
    uint256 public _walletMax = 20000000000000000 * 10**_decimals;
