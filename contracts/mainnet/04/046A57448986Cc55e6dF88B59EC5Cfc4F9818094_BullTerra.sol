...
contract BullTerra is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "BullTerra";

    string private _symbol = "BTERRA";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xAaA6E61Fe189B1941E110d68B996B5C161c6066B;
