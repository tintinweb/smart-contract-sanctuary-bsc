...
contract YOOSHIVERSE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YOOSHIVERSE";
    string private _symbol = "YOSVERSE";
    ...
    uint256 public minimumTokensBeforeSwap = 1 * 10**7* 10**_decimals; 
