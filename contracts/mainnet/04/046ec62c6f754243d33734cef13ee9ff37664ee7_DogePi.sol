...
contract DogePi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc34270F558d3927823810e3D2A3C82a8EEF2aABa); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x94eF2FDbC8ce529f6B65586cf5B4ab6F9aCABB58); // Buyback Wallet Address
    ...
    uint256 public _walletMax = 4000000000 * 10**9; // 4%
