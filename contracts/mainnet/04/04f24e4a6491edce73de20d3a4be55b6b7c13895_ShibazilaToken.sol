...
contract ShibazilaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBAZILA"; //
    string private constant _symbol = "SHIBAZILA"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x75337C2aB1CA0F4dfE9F04524CBE332EE0E80FD7;
