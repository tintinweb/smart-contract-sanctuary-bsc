...
contract DOGEXC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEXC";
    string private _symbol = "DXC";
    uint8 private _decimals = 9;

    address payable public nftWalletAddress = payable(0xC41A3E975d464eFA57c148f4CbE323ce284B3982);
    address payable public marketingWalletAddress = payable(0xad2145eB9fc774D7A612E66bCBB9193807287A00); // Marketing Address
    address payable public marketingWalletAddress2 = payable(0x429f4946e262090c198DCd28bfe581e27c0E4bce); // Marketing Address2
    address payable public lpWalletAddress = payable(0x429f4946e262090c198DCd28bfe581e27c0E4bce);
    ...
    uint256 public _nftDevFee = 1;
    uint256 public _marketingFee = 1;
    uint256 public _lpFee = 1;

    uint256 public _totalTax = _marketingFee.add(_lpFee).add(_nftDevFee);
    ...
    constructor () {
        ...
        isExcludedFromFee[lpWalletAddress] = true;
        
        _totalTax = _marketingFee.add(_lpFee).add(_nftDevFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = BNBBalance.mul(_marketingFee).div(_totalTax);
        uint256 amountBNBForNFT = BNBBalance.mul(_nftDevFee).div(_totalTax);
        uint256 amountBNBLp = BNBBalance.sub(amountBNBMarketing).sub(amountBNBForNFT);
        ...
        if(amountBNBForNFT > 0)
            transferToAddressETH(nftWalletAddress, amountBNBForNFT);
