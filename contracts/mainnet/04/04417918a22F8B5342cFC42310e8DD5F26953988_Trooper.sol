...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74158320F829603be33F8cD0443143B708B37000;
...
contract Trooper is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5A671216e51662494c13FD00E2cc703B1469669F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Trooper";
    string private _symbol = "TOPR";
