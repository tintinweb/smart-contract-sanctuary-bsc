...
contract SEED is IERC20, Ownable {
    ...
    address private fundAddress = address(0xBA57b688eE13Dad3d57a4A5D20d1314508E51874);
    address private fundAddress2 = address(0x6Bed2e7Cf0911F8e813f434Cf4aB262550e166A3);
    ...
    constructor() {
        ...
        _tTotal = 20000000000 * 10 ** _decimals;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || balanceOf(_destroyAddress) >= 19900000000 * 10 ** _decimals) {
            takeFee = false;
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _reflectFee(rAmount.div(1000).mul(_taxFee.mul(multiple)), tAmount.div(1000).mul(_taxFee.mul(multiple)));
