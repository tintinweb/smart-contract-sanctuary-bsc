...
contract MOONPIGE is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MoonPige";
    string private _symbol = "MPIGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB21EC0119eFd5223fD09fdF9d59CcceE77e1d8B4);
    address payable public TeamWalletAddress = payable(0x1f580f56c59DF04bB6A6ee270af8739ec850be09);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (5 * 10**6 * 10**9), "Max wallet should be more than or euqal to 0.5% totalSupply");
