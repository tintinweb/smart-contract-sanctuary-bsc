...
contract BabyGoblinTown is IERC20, Ownable {
    ...
    constructor(
        ...
        _maxWalletSize = 30000000000000; //%1
        ...
        numTokensSellToAddToLiquidity =  2000000000000; // 0.2% of an CRO
    ...
    //    address router_=0x10ED43C718714eb63d5aA57B78B54704E256024E;
        ...
        marketingAddress=payable(0x8112ED3f446BCDce6C44DE22af358e35C1D16706);

        treasuryAddress=payable(0xf67B9323f32ad297416B8cDdb605CDd937E78DE1);
    ...
    function updatemarketingAddress(address payable _newmarketingAddress) external onlyOwner { 
