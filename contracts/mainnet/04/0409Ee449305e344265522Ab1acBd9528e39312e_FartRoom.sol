...
contract FartRoom is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    constructor (
        ...
        stakeAdmin = 0x352f98689695A2fAE89AA9FB4e439380DA05aC57;
    }
    ...
    updateReward(msg.sender)
    {
        ...
        uint256 pinuFee = amount.mul(3).div(100);
         _totalSupply = _totalSupply.add(amount - pinuFee);
        _balances[msg.sender] = _balances[msg.sender].add(amount - pinuFee);
        stakingToken.safeTransferFrom(msg.sender, address(this), amount);
        emit Staked(msg.sender, amount - pinuFee);
    }
