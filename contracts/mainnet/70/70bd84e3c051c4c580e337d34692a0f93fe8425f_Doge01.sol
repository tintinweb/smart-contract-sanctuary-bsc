...
| |   | || |   | || | ____ |  __)     | (/ /) |     | | 
| |   ) || |   | || | \_  )| (        |   / | |     | | 
| (__/  )| (___) || (___) || (____/\  |  (__) | _ __) (_
(______/ (_______)(_______)(_______/  (_______)(_)\____/

Welcome to Doge 0.1! The unique Meme Token started from 0.1 BNB
...
contract Doge01 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge 0.1";
    string constant _symbol = "DogeZeroOne";
