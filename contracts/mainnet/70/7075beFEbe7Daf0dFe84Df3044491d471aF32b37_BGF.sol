 ...
 */
 ...
 contract BGF is IBEP20, Ownable {
...
string constant _name = "BNB Gun Fire BGF";
...
marketingFeeReceiver = 0xd320ae466a12Cc837f263Fea36989C09f1909E80;


//MAINnet
//       rewardFeeReceiver = 0xb20DCf543a13c477326d94E9C8aD79EAfcdE0b9c;

//TESTnet (Colin Test Wallet)
rewardFeeReceiver = 0xd320ae466a12Cc837f263Fea36989C09f1909E80;
...
function swapBack(address sender, address recipient) internal swapping {
    ...
    if (amountLiquidity > 0 && amountBNBLiquidity > 0) {
