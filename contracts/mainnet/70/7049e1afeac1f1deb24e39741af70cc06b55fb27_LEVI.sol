...
contract LEVI is Operator {
    ...
    string private _name = "LEVI";//#币名
    string private _symbol = "LEVI";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0xef9602B9ab9AEc055EB2D343AE31Ec48EA037062),true);
    }
