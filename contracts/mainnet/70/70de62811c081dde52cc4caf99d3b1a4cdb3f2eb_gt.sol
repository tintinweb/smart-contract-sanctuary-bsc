...
//GoatTrust is a BEP-20 token avoiding the small-cap liquidity crisis by directing 100% of trading fees to the LP. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x292Ae000F741BD31cE5bFf3a253a52E19a22ecC0;
...
contract gt is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"🐐GOATTRUST🐐"; 
    string private constant _symbol = unicode"GT"; 

    uint256 public P_DR = 0;
    uint256 public Part_AutoLiquidity = 100; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x292Ae000F741BD31cE5bFf3a253a52E19a22ecC0), BNB_Tot);
