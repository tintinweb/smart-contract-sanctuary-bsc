...
/**
 telegram group : https://t.me/TeddyShib
*/
...
contract TeddyShib is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAeedf1d45A4D99870144fA934f095C5dA2998988); 
    address payable public Wallet_Dev = payable(0xECDd6188D0b705059f488fEFee80c0A23060AC6b);
    ...
    string private constant _name = "Teddy Shib"; 
    ...
    uint256 public Percent_AutoLP = 39; 
    ...
    constructor () {
        ...
        _owner = 0xECDd6188D0b705059f488fEFee80c0A23060AC6b;
