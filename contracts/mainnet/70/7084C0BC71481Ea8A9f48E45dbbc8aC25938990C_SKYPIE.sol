...
contract SKYPIE is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xB8F65B68ee09220458FC11359221a612aa6d0dfb);
    ...
    uint256 private _tTotal = 20e9 * (10 ** _decimals);
    string private constant _name = "Skypie Finance"; 
    string private constant _symbol = unicode"SKYPIE"; 
    ...
    uint256 public _maxWalletToken = 20e8 * (10 ** _decimals);
