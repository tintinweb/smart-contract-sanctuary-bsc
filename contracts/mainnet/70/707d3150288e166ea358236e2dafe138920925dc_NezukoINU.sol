...
/**
 ...
 SUPER STEALTH LAUNCH BY UNKNOWN APE TEAM!!

 NEZUKO INU is a decentralized token project on the BSC Space.

 Anime season has arrived and so has NEZUKO INU.  
 
 She is a demon in the anime world and will be looking to go demonic on the charts

 
 Telegram : https://t.me/NezukoInuCoin
...
contract NezukoINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nezuko Inu";
    ...
    address private marketingWallet = address(0xB13d8eE4E03f928c5C3dbD77dbbb94476fCB87f9);
    address private liquidityReceiver = address(0xB13d8eE4E03f928c5C3dbD77dbbb94476fCB87f9);
