...
contract CopeKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cope King";
    string private _symbol = "COPEKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeC5D3dF121db860e1C8661EB0CFfFF4f80221Cc1); 
    address payable public buyBackWalletAddress = payable(0xeC5D3dF121db860e1C8661EB0CFfFF4f80221Cc1); 
