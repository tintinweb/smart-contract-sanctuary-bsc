...
contract BNBYACHTCLUB is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "BNBYACHTCLUB";
    string private _symbol = "BYC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3E3b2354e566c5485D8a6bdD2FafD7d585048E24);
