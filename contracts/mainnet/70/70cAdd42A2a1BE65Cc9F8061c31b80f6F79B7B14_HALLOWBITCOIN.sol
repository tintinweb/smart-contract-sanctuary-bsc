...
TELEGRAM: https://t.me/HallowBitcoin
|
*/
...
contract  HALLOWBITCOIN  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Hallow BitCoin ";
    string private _symbol = " HBC "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8BfABc1497D8Fb08170d29348B0ddcD854C38dB6); 
