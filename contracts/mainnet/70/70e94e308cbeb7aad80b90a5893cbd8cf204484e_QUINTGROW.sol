...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB29537457D74bB21F5EF57eE9453b5e3610320B7; // owner address
...
contract QUINTGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUINT GROW";
    string private _symbol = "QUINTGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB29537457D74bB21F5EF57eE9453b5e3610320B7); // Marketing Address
    address payable public teamWalletAddress = payable(0xB29537457D74bB21F5EF57eE9453b5e3610320B7); // Team Address
