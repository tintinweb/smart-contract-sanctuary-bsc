...
contract PizzaDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PizzaDao";
    string private _symbol = "PizzaDao";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xE482Af97a1340F018d0ec4AA6BD2C373f36d2922);
    address payable public teamWalletAddress = payable(0xE482Af97a1340F018d0ec4AA6BD2C373f36d2922);
