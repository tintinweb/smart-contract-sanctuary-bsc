...
contract BaseToken is Ownable {
    ...
    string constant public name = 'CryptoGodz';

    string constant public symbol = 'GODZ';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 74000000*10**uint256(decimals);
