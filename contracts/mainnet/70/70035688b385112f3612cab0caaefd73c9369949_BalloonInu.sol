...
contract BalloonInu is ERC20, Ownable{
    ...
    address public marketingWallet = 0x01019661eE4277cf4222d7FF1c2ce83A2562A725;
    address public devWallet = 0x01019661eE4277cf4222d7FF1c2ce83A2562A725;
    ...
    Taxes public taxes = Taxes(0,0,4);
    Taxes public sellTaxes = Taxes(0,0,4);
    ...
    constructor() ERC20("Balloon INU | t.me/balloonINU","BLIMP") {
