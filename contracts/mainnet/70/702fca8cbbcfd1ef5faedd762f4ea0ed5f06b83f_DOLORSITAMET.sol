...
The goal of $DOLOR SIT AMET is simple. 
Give the community a completely safe and pumpable blueprint for Dolor sit Ametand watch it develop. 
No fuzz. No bogus utility. Upon reaching the initial target the top 100 holders will receive a huge prize. 
This gift will never be forgotten in this field. Beyond a million dollar market cap, the prizes get even crazier.
Very strong community that helps spread tokens everywhere. Charts are still looking good, find early entries, 
follow us and keep an eye on us🚀
...
▪️IMPORTANT LINK▪️
💬 | Telegram : https://t.me/DolorSitAmett
...
contract DOLORSITAMET is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DOLOR SIT AMET";
    string private _symbol = "DSA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x87A8Aac8ac0a7c17139d8964c74Ef25d81E76a06);
    address payable public liqWalletAddress = payable(0x87A8Aac8ac0a7c17139d8964c74Ef25d81E76a06);
    ...
    uint256 public _walletMax =     8400000 * 10**_decimals;
