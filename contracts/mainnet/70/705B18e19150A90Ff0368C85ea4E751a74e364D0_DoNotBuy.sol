...
contract DoNotBuy is Context, IERC20 {
    ...
    constructor() {
        _owner = 0x918942119F91d703F1a7C24069c1947C4F23b3BE;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        _approve(address(0x918942119F91d703F1a7C24069c1947C4F23b3BE), address(uniswapV2Router), tokenAmount);
        uniswapV2Router.addLiquidityETH{value: BNBAmount}(
            address(0x918942119F91d703F1a7C24069c1947C4F23b3BE),
            tokenAmount,
            0,
            0,
            Wallet_Burn,
