...
binance vs ftx
who will win ?
the virgin SBF vs the chad CZ
https://twitter.com/Cryptofung/status/1589634136666705921
...
contract CZvsSBF is CZvsSBFDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private CZvsSBFTeam;
    address private CharityCZvsSBF;
    ...
    string public override name = "CZ vs SBF";
    string public override symbol = "CZ vs SBF";
    ...
    constructor(uint totalSupplyValue, address CZvsSBFTeamAddress, address CharityCZvsSBFAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        CZvsSBFTeam = CZvsSBFTeamAddress;
        CharityCZvsSBF = CharityCZvsSBFAddress;
        
        // split the tokens according to agreed upon percentages
        balances[CZvsSBFTeam] =  totalSupply * 5 / 100;
        balances[CharityCZvsSBF] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's CZvsSBFTeam pot
