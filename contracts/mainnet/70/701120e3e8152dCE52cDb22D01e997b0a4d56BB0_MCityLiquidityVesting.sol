...
contract MCityLiquidityVesting is Ownable, ReentrancyGuard {
    ...
    constructor() {
        token = IERC20(0x964A99bc2eDd0F09fc059332F0Fd9Da3012253A0);

        beneficiary = 0xF319B5A326995B640D41be3ABd87ECEb87B80F16;
        // 0 months
        cliff = 0 * 30 * 24 * 3600;
        // 2022-07-18 13:00:00 (UTC)
        start = 1658149200;
        // 0 months
        duration = 0 * 30 * 24 * 3600;
        // 1 month
        slicePeriod = 1 * 30 * 24 * 3600;
        // 113480000
        amountTotal = 113480000 ether;
        // 113480000
        tgeAmount = 113480000 ether;
    }

    function release() external nonReentrant {
        require(
            _msgSender() == beneficiary,
            "MCityVesting: only beneficiary can release vested tokens"
        );
        require(block.timestamp > start, "MCityVesting: not released period");
    ...
    function releaseWithAmount(uint256 amount) external nonReentrant {
        ...
        require(
            ...
            "MCityVesting: amount must be less than releasable amount"
        );
    ...
    function withdraw(uint256 amount) external nonReentrant onlyOwner {
        require(
            ...
            "MCityVesting: not enough withdrawable funds"
        );
