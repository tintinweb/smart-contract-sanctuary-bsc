...
contract SHINIGAMIBSC is IBEP20, Auth {
    using SafeMath for uint256;
    string constant _name = "SHINIGAMIBSC";
    string constant _symbol = "SHINIGAMIBSC";
    ...
    uint256 public _walletMax = 200 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x7F3185645E32a1D5c7b797572E52Ad42b42A7A5D;
        devWallet = 0x2a13E96360Dd1eAc09E98D3AabcF33f6E1825039;
