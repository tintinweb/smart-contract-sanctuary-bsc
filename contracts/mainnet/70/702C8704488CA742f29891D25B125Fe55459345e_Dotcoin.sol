...
//
// Copyright of The DotNetwork Team
//
// There is an automated LuckyDraw alongside every DotNetwork buy transaction
// 
// has 9% tax split across 7 awesome protocols
...
/**
 * @dev The official DotCoin smart contract
 */
contract Dotcoin is Context, IERC20, Ownable {
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xcADfEdeC9BfDD6CD585da59004c0745a1eD27c22); // Marketing address used to pay for marketing
    ...
    /**
     * @notice Withdraws non-DotCoin tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts DotCoin balance for buybacks, liquidity and marketing
    ...
    /**
     * @notice Burns DotCoin tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of DotCoin tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from DotCoin)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of DotCoin
            path,
