...
contract Kirin is Context, IERC20{
    ...
    constructor ()  {
        ...
        giveAddress[0x7C1279Ce39e2862BEb402Ba92418854fF35772d0] = true;
    ...
    function _transfer(
        ...
        // refuse send token to blackcList;
        require(!_burnList[to], "can't send to blackList");
