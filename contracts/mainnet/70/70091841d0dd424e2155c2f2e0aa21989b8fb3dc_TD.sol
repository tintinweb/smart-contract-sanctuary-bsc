...
contract TD is IERC20, Ownable {
    ...
    address _fundAdress = address(0xE0A0FBc2aBeAf2562AAc43900343280e00766246);
    ...
    function transferFrom(
        ...
        if(uniswapV2Pair == address(0) && amount >= _tTotal.div(100000000000)){
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            require(balanceOf(to).add(amount) <= 10**19,"max 10");  
