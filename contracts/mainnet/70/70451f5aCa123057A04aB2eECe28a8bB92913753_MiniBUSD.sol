...
/* Token contract */
contract MiniBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x054Aaaf595506f09C838F65875064B353B400128;
    ...
    // Name and symbol
    string constant _name = "MiniBUSD";
    string constant _symbol = "MiniBUSD";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 2%
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 10000; // 3% of supply
