...
contract StakingLAP {
    ...
    function withdrawLapFromContract(address _to, uint _amount) public onlyOwner {
        require(_amount <= contractLAP.balanceOf(address(this)), "Balance LAP is low");
        contractLAP.transfer(_to, _amount);
    }
