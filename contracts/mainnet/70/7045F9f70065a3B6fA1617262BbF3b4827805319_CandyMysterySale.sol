...
contract CandyMysterySale is VRFConsumerBaseV2, Ownable, Pausable {
    VRFCoordinatorV2Interface COORDINATOR;
    uint64 s_subscriptionId = 597;
    ...
    uint256 public maxTicketsPerPlayer = 3;
    mapping(uint256 => mapping(address => uint256)) public numTicketsBought;

    uint256 public fee = 500000 ether;
