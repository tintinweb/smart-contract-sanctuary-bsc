...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHIBA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // Set To Reward
...
contract ShibaChrome is IBEP20, Auth {
    using SafeMath for uint256;

    address SHIBA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShibaChrome";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "SCHROME";
    ...
    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 3 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
