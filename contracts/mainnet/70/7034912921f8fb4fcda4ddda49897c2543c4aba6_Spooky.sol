...
Liquidity will be burnt & ownership renounced. Clean, no bullshit contract. 
...
Telegram: https://t.me/SpookyCoinBSC
...
contract Spooky is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Coin"; // 
    string private constant _symbol = unicode"🎃"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x69194d3b6a939F3e70eA0b631001FBF35ed4D977;
