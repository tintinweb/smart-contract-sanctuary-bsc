...
/*
New Hype Trend Token launch in BSC base on the The recent launch of a nonfungible token (NFT) protocol on the Bitcoin mainnet
...
NFTs Are Bloating Bitcoin, Creating Risks And Opportunities For Investors

Let's Create a Community where we will be the first of them all

₿ League of   NFTS ₿
₿Announcing The Launch of NFBTC On Binance Smart Chain
💎$NFBTC
💎Hype Trend
💎Bullish Name
💎Fomo
...
contract NonFungibleBitcoin  is ContextBep20NFT, Bep20NFT, OwnableBep20NFT {
    ...
    string private _name = 'Non Fungible Bitcoin';
    string private _symbol = 'NFBTC';
