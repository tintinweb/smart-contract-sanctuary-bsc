...
Telegram: https://t.me/pepecommunityBSC
...
contract PEPE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 5 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 2 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xB19e5129E317f71fbB4D9c378f2aBC4a78F817B6; //
    ...
    Taxes public taxes = Taxes(1,5,2,0); //
