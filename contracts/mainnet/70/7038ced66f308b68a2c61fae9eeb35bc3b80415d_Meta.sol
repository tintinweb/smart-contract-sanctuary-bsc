...
contract Meta is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _minimumTokensBeforeSwap = supply.mul(1).div(10**6) * 10**_decimals; 
        marketingWalletAddress= payable(0x22fD5AB22CA8Bcdace5Ce7D6468E40750b9573BD) ;//营销钱包
        teamWalletAddress=  payable(0x22fD5AB22CA8Bcdace5Ce7D6468E40750b9573BD);//营销钱包2
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //测试网路由地址
    ...
    //写好了上面，就开始在转账方法中判断这个地址是不是黑名单，转账方法是这个_transfer
