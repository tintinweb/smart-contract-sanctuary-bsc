...
contract TodayDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "TodayDoge";
    string private _symbol = "TodayDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x765A0824A4D6Db5f6A695F8E5B95E7189ea5a131));
        m = payable(address(0x765A0824A4D6Db5f6A695F8E5B95E7189ea5a131));
