...
//DO NOT SNIPE. IF THE CONTRACT GETS SNIPED, I WILL REDEPLOY OR BLACKLIST SNIPERS. BE WARNED.
...
contract safuu is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x437991e3e9b0974257Ce2DBF2dCAb8525d814F7F;
    address DevWallet       = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;

    string constant _name = "Safuu ExaDarkSiderael";
    string constant _symbol = "SEDS";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 30000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 30000000000 * (10 ** _decimals);
    ...
    uint256 public sellMultiplier  = 500;
