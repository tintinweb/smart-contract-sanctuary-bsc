...
contract BBDogeFarm is Ownable {
    using SafeMath for uint256;

    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 100;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 100;

    uint256 private constant MIN_WITHDRAW = 0.02 ether;
    uint256 private constant MIN_INVESTMENT = 0.01 ether;
    ...
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 60;
	...
	uint256 private constant TOTAL_REF = 170;
	uint256[] private REFERRAL_PERCENTS = [100, 40, 20, 5, 5];
    ...
    function _invest(address _addr, address _ref, uint256 _amount ) private returns (bool){
        require(msg.value >= MIN_INVESTMENT, "Minimum investment is 0.01 BNB");
