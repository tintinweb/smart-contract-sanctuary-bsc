...
https://t.me/BrazilBoyOfficial

8% Marketing Fee + Contract Renounced
...
contract BrazilBoy is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Brazil Boy";
    string constant _symbol = "BRAZBOY";
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xcF1F748bda7e5f11f4e88720065b44A4C98ac5F4;  
        anothermarketingWallet = 0x59Fba63BdF3974c260Fe1fDdBcc4736F5ce0C579;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(1).div(8);
