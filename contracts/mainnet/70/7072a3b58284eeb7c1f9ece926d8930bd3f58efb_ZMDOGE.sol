...
contract ZMDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "ZMDOGE";
    string private _symbol = "ZMDOGE";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x1c1236A2B1D32620bf930DC8f5C7f9047B031c53); 
    address payable public teamWalletAddress = payable(0x1c1236A2B1D32620bf930DC8f5C7f9047B031c53); 
