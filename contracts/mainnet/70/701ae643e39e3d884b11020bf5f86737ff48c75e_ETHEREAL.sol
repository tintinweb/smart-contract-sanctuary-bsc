...
contract ETHEREAL is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Ethereal Doge';
    ...
    //DevWallets
    address public Development=payable(0x6C82974f17003002979c679E89cb541C850C808C);
    address public Marketing=payable(0x6C82974f17003002979c679E89cb541C850C808C);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; //ETH Rewards
