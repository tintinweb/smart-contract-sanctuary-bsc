...
contract Henceut is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Henceut", "Henceut", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xBd069D64e4eED7839bBe72De66B50818E3fBE949;
        treasuryReceiver = 0x892bB698E6aff20BB1D62A0C847e71c857f25Aab;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Henceut token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
