...
// debug functions
    ...
    function updateDumperShieldTokenImplementation() external onlyOwner {

        DumperShieldTokenImplementation = address(0x847642FC481a6e8B68d9A5f9F18Fc6761ec1b723);
...
// end debug
    ...
    function getLastSellOrder(address seller) external view returns(uint256 orderId)
    ...
    function getLastBuyOrder(address buyer) external view returns(uint256 orderId)
    ...
    function getLastOrderToConfirm(address confirmatory) external view returns(uint256 orderId) {
