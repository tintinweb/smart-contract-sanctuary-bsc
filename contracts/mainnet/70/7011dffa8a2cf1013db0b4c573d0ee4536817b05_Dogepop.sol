...
contract Dogepop is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGEPOP";
    string private _symbol = "Dogepop";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xed2c99501Aa45E62006Ad83429DC2CA1AACb2963);
    address payable public teamWalletAddress = payable(0xed2c99501Aa45E62006Ad83429DC2CA1AACb2963);
