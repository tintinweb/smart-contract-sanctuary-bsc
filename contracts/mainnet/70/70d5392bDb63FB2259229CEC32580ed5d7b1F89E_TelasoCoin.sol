...
contract TelasoCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TelasoCoin";
    string constant _symbol = "$Telaso";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1adfc350b8D323F8805ECBCe335a837D511C4547;
