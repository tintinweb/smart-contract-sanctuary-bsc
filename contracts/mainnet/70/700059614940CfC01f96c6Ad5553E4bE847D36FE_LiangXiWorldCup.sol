...
contract LiangXiWorldCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "LiangXiWorldCup";
    string private constant _symbol = "LXWC";
