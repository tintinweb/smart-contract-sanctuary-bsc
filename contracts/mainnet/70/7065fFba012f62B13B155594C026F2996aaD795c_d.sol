...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 1100  * 10** Decimals;
        walletLimit =  1100 * 10** Decimals;
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _bFFee + _buyLPDividendFee + _sFFee + _sellLPDividendFee + _sLPFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee;
            if (isSell) {
                swapFee = _sFFee + _sellLPDividendFee + _sLPFee;
            } else {
                swapFee = _bFFee + _buyLPDividendFee;
...
contract d is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        110011,//Supply
        address(0xbd356baB1Ef212A1E55ff9328113D93A746819C0),//FundAddress
        address(0xbd356baB1Ef212A1E55ff9328113D93A746819C0)//ReceiveAddress
    ){
