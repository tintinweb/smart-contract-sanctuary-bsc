...
contract Cryptokingz is Ownable, ERC721A, ReentrancyGuard {

    uint256 public maxToken = 7777;
    uint256 public price = 0.4 ether;

    string private _baseTokenURI= "ipfs://QmWefUKhwKeBiyH4t8BSrJkyoNDUtjfitxF4F1LhpvtMKM/";
    string public _extension = ".json";
    bool public publicSale = false;
    constructor()  ERC721A("Cryptokingz Nft", "CK", 100, maxToken)
    {}
