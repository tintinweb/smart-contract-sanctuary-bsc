...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x305b0883dC3b6Aa447bf630Ed054AD5D6Ad7C805);
...
contract FLASH2 is IBEP20, Auth {
    using SafeMath for uint256;
   
    address REWARD   = 0x305b0883dC3b6Aa447bf630Ed054AD5D6Ad7C805;
    address WBNB     = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "Flash 2.0";
    string constant _symbol = "FLASH";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 50

        //max wallet holding of 3%
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 100; // 300
    ...
    uint256 public swapThreshold = _totalSupply / 400; //25
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 100000}("");
        require(success, "receiver rejected ETH transfer");
        
        (bool success2, /* bytes memory data */) = payable(projectFeeReceiver).call{value: amountBNBProject, gas: 100000}("");
