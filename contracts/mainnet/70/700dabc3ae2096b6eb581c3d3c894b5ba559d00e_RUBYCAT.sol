...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02B1e270f79a7dEeFEC7064f5cEd1e46AbC8bdf2; // owner address
...
contract RUBYCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RUBY CAT";
    string private _symbol = "RUBYCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf534E210E4d07488D450023eD7C8e80b99938AAE); // Marketing Address
    address payable public teamWalletAddress = payable(0x02B1e270f79a7dEeFEC7064f5cEd1e46AbC8bdf2); // Team Address
