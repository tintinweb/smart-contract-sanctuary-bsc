...
contract EnglandHero is Context, IERC20, Ownable {
    ...
    string private constant _name = "England HERO"; // 
    string private constant _symbol = "ENGLANDHERO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xb135c61FB16A1e21db97AEf953ff5A8557eFD61F;
