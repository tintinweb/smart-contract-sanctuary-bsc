...
contract Testagain is IERC20 {
    ...
    string constant private _name = "7testagain";
    string constant private _symbol = "7testagain";
...
//===============================================================================================================
    ...
    function enableTrading() public onlyOwner {
        ...
        tradingEnabled = true;
        swapThreshold = (balanceOf(lpPair) * 2) / 10000;
        swapAmount = (balanceOf(lpPair) * 1) / 10000;
    }
