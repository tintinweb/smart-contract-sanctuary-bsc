...
contract SWGT is ERC20 {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                swapAndLiquifyV3(haveAmount.div(12).mul(7));
                swapAndLiquify(haveAmount.div(12).mul(5));
                swapping = false;
            }
        }
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
        ...
        if(allAmount > dogeAmount){
            DOGE.transfer(_fundAddress,(allAmount.sub(dogeAmount)).div(7).mul(2));
        }
    }
