...
拿着这个令牌，把它放在你的钱包里，几个小时后就能看到

TELEGRAM : https://t.me/babycake25
...
contract BabyCake25 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50 * 10**8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xc8BEc0065539B466ED10C2d95E6C1681DF778e4c));


    string private _name = "Baby Cake 2.5";
    string private _symbol = "BC25";
