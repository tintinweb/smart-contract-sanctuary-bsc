...
🐓DegenCockCoinBSC Stealth launching!🐓

Always having trouble with your unmotivated cock? This token is for you!

A digital, decentralized Online Betting platform aiming to connect cockfighters,
 gamblers and cockfight fanatics  using a simple online interface ran for the first time ever on the Binance Smart Chain.
  It connects customers with Cockfighting Arenas that offer Online Gambling within a specific area through the use of block chain technology of BSC.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x211092dA2553402ACe7b666764f1F784D2d13ca7;
...
contract CockCoinToken is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x211092dA2553402ACe7b666764f1F784D2d13ca7);
