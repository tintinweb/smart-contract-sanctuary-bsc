...
/*
888888ba   .88888.   .88888.   88888888b dP         .88888.  888888ba  
88    `8b d8'   `8b d8'   `88  88        88        d8'   `8b 88    `8b 
88     88 88     88 88        a88aaaa    88        88     88 88     88 
88     88 88     88 88   YP88  88        88        88     88 88     88 
88    .8P Y8.   .8P Y8.   .88  88        88        Y8.   .8P 88     88 
8888888P   `8888P'   `88888'   88888888P 88888888P  `8888P'  dP     dP 
                                                                       
                                                                       
d888888P dP   dP   dP  88888888b  88888888b d888888P                   
   88    88   88   88  88         88           88                      
   88    88  .8P  .8P a88aaaa    a88aaaa       88                      
   88    88  d8'  d8'  88         88           88                      
   88    88.d8P8.d8P   88         88           88                      
   dP    8888' Y88'    88888888P  88888888P    dP                      
                                                                       
                                                                        
                                                                                             
//
// Telegram: https://t.me/DogelonTweet
// Twitter: https://twitter.com/dogelontweet
// Website: https://www.dogelontweet.com
// 
*/
...
contract DogelonTweet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xAbb71F318cA4164Cb214cecD3458cEb8e2d6f362); // Marketing Address
    address payable public featurePaymentAddress =
        payable(0xAe7eB479cDB55144a5Af7959a87e31bDA6a06d9e); // Address for paying for product features.
    ...
    uint256 private constant _tTotal = 44 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Dogelon Tweet";
    ...
    uint256 public _maxTxAmount = 132 * 10**6 * 10**9; // 132,000,000 ELONT
    uint256 private minimumTokensBeforeSwap = 88 * 10**5 * 10**9;
    ...
    bool public constant _isEnabledBuyBackAndBurn = false;

    uint256 private _preSaleEndTime;
    bool private _preSaleFeesEnded = false;
    uint256 public constant _intervalMinutesForEndPreSaleRate = 5 * 60 seconds;
