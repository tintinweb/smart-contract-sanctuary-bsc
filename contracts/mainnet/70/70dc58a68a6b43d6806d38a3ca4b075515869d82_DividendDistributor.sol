...
contract DividendDistributor is IDividendDistributor {
    ...
    address immutable public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // With `dividendsPerShareAccuracyFactor`, we can properly distribute dividends even if the amount of received amount is small.
    ...
    event UpdateDistributionCriteria(uint256 newMinPeriod, uint256 newMinDistribution);
    ...
    function setDistributionCriteria(
        ...
        require(_minPeriod >= 1800 && _minPeriod <= 3600, "min distribution period should be between 30 minutes and 1 hour");
        require(minDistribution >= 10**9, "can not be less than lowest bound");
