...
contract CBETProtocol is Ownable, IERC20Metadata {
    ...
    string private _name = "CCVC";
    string private _symbol = "CCVC";
    ...
    uint256 public rebaseRate = 2083;
    ...
    function _fee(address from, address to, uint256 amount) private view returns (uint256) {
