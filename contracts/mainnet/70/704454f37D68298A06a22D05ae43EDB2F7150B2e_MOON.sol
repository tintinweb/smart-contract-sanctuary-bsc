...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    uint256 public constant buybackFee = 2;
    address public constant marketingAddr = 0x981586c6925120A08e2769b8De6bcbAF3f796d2d;
    address public constant buybackAddr = 0xc7fc55a13303D25AEDC5bd1dB1C6eED2F3BE29d8;
...
contract MOON is ExcludedFromFeeList, DividendFee {
    uint256 private constant _totalSupply = 10_0000 * 1e18;
    ...
    constructor() ERC20("MOON", "MOON", 18) DividendFee() {
    ...
    function process(uint256 gas) private {
        ...
        uint256 nowbananceThis = balanceOf[address(distributor)];
        uint256 gasUsed = 0;
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if(amountThis > 0) { super._transfer(address(distributor), theHolder, amountThis); }
            unchecked {
