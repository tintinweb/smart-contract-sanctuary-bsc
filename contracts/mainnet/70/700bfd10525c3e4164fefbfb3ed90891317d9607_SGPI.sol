...
contract SGPI is Context, IERC20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x29375C70Ad57af02BBEb8CA857566Bf65e7c4a07);
    ...
    string private _name    = "SGPI";
    string private _symbol  = "SGPI";
    ...
    uint256 public _reflectionFee           = 40;
    uint256 private _previousReflectionFee  = _reflectionFee;

    uint256 public _externalFee             = 80;
    ...
    uint256 public _maxTxAmountBuy                  = 1000000000 * 10**12 * 10**_decimals;
    uint256 public _maxTxAmountSell                 = 1000000000 * 10**12 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 10 * 10**12 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 100 * 10**12 * 10**_decimals;

    address public constant BUSD = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; //change this
    ...
    constructor () {
        ...
        autoLiquidityReceiver = payable(0xeDE58BA42BF08B154936615C2bEE7C99e96F86b8);
