 ...
 * is concerned).
 *
 * This contract is only required for intermediate, liFFbrary-like contracts.
 */
...
is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	...
	string private constant _name = "TrungToken";
	...
	uint256 private constant _totalTokens = 1000000000000 * 10**_decimals;	
	...
	// SUPPORT UKAINIAN
	address payable private constant _charityAddress = payable(0xaD9610BFDEDbE2c2570eCD4C1dc31Ff2570a0C70); // A percentage of the BNB pool will go to the charity address
	...
	// CLAIM BNB 
	address payable private constant _buybackAddress = payable(0xaD9610BFDEDbE2c2570eCD4C1dc31Ff2570a0C70); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM & airdrop
	address payable private constant _teamAddress = payable(0xaD9610BFDEDbE2c2570eCD4C1dc31Ff2570a0C70);
