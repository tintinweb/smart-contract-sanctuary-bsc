...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0406c1aA299fb4e5d17e009fBCC9D44BeD787b51;
...
contract ThorEdgePrime is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0406c1aA299fb4e5d17e009fBCC9D44BeD787b51;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ThorEdge Prime";
    string private _symbol = "TEP";
