...
contract GALASHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GALASHIB";
    string private _symbol = "$GALASHIB";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xBD0435D43aCf251B635F1FF87E3ae2e8459180Fe); // Marketing Address
    address payable private TeamWallet = payable(0x7ffA78a51a1a0d20Ae79847A91D256715e6C9C68); // Buy Back Address
