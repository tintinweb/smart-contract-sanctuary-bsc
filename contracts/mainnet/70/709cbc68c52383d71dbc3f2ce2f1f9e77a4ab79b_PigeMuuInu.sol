...
contract PigeMuuInu is IBEP20, Auth {
    ...
    address MARK = 0xc4a25d536BcCD72AB88866F663C5045433b2a4d5;

    string constant _name = "PigeMuuInu";    
    string constant _symbol = "PigeMuuInu";
