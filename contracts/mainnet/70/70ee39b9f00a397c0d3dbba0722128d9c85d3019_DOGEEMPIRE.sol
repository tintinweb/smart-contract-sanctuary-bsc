...
pragma solidity ^0.6.12;
    ...
    contract DOGEEMPIRE is Context, IERC20, Ownable {
        ...
        string private _name = 'DogeEmpire';
        string private _symbol = 'DOGEEMPIRE';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x0780dAB1E6D3d67948241edBdDAa4A5273aBb9D2, 'We can not exclude Uniswap router.');
