...
abstract contract UYScutiToken is IERC20, Ownable {
    ...
    uint256 public _buyLPDividendFee = 100;//100为购买加池子LP分红税费1%
    uint256 public _buyLPFee = 0;//
    uint256 public _sellFundFee = 200;//200为卖出营销钱包税费2%
    uint256 public _sellLPDividendFee = 100;//100为卖出加池子LP分红税费1%
...
contract UYScuti is UYScutiToken {
    constructor() UYScutiToken(
    
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),  //路由器地址
        address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56),  //USDT地址

       // 测试：address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),  //路由器地址
       // 测试：address(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd),  //USDT地址

       // 正式：0x10ED43C718714eb63d5aA57B78B54704E256024E 路由器
       // 正式：0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 USDT
        ...
        address(0xBFDfD57d6c82D65de35a477a9A96933EAecA3332),  //营销钱包地址
        address(0xBFDfD57d6c82D65de35a477a9A96933EAecA3332)   //部署代币地址
    ){
