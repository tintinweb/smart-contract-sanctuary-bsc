...
contract Falcon9 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x053D1f399a79C67Ac69e8a6974248cEa91034cf3); // Marketing Address
    address payable public teamWalletAddress = payable(0x5EbA3939DbF493F2Cb20E80C0a2127F4A89a763A); // Team Address
    ...
    uint256 public _walletMax = 150000000000000 * 10**_decimals;
