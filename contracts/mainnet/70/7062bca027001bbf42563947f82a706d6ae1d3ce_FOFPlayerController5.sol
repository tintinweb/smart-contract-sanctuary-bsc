...
contract FOFPlayerRaceQuery is Ownable {
    ...
    address public FOF = 0x2F63578d2b1f755BC2D35041D1202cAECfda1282;
    ...
    function getUserClubDividends(address user) public view returns(uint256,uint256) {
...
contract FOFPlayerController5 is Ownable {
    ...
    constructor() {
        ...
        // FPC2 = FOFPlayerController2(payable(0xE3547B03613503261C7649ad36Fd159C9A2651b2));
        FPN = FOFPlayerNFT(0x25894eA4eE6576623Fd8383d6D023dc5219E0553);
        FPC1 = FOFPlayerController1(payable(0x50E79435Bb54564E8F6d0BBa2B841027C77B8824));
        FPC2 = FOFPlayerController2(payable(0x3c9ffD06fa3adE6bCBb7B409d66741a2A52f094d));
        FPRD = FOFPlayerRaceData(0x574B8A24Ac72dA402F770061703E7249d3701415);
        FPRQ = FOFPlayerRaceQuery(0x93A27a22df02D3DAf340644Bc0efd31e6D98CF52);
        FOF = FOFToken(payable(0x2F63578d2b1f755BC2D35041D1202cAECfda1282));
    }
    ...
    function signUpRankRace(uint256 tokenId) public payable {
        ...
        if(FPRD.userTodayRaceTimes(msg.sender) >= 20){
            ...
            FPRD.setUerRaceTotalTimes(msg.sender, 10 + FPRD.uerRaceTotalTimes(msg.sender));
        }
