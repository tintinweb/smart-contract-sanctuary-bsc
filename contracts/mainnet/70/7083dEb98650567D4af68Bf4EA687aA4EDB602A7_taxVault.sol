...
contract taxVault is Ownable {
    ...
    IGDS public gds = IGDS(0x5Abf65C1d152244c6Bd4ad0a5eB92DB00e403BdB);
    ILIT public lit = ILIT(0x79B2bc95344eFe31cb6a7B0Cf8A843a5eE125dFf);
    ...
    function setTaxCollectorAddressGDS(address _taxCollectorAddress) public onlyOwner {
        gds.setTaxCollectorAddress(_taxCollectorAddress);
    }

    function setTaxRateGDS(uint256 _taxRate) onlyOwner public {
        gds.setTaxRate(_taxRate);
    }

    function setTaxCollectorAddressLIT(address _taxCollectorAddress) public onlyOwner {
        lit.setTaxCollectorAddress(_taxCollectorAddress);
    }

    function setTaxRateLIT(uint256 _taxRate) onlyOwner public {
        lit.setTaxRate(_taxRate);
    }
