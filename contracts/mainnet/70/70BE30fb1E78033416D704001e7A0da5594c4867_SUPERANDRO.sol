...
/*    SUPERANDRO
        Telegram : https://t.me/SuperAndro
*/
...
contract SUPERANDRO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUPER ANDRO"; // 
    string private constant _symbol = "SUPERANDRO"; //    
