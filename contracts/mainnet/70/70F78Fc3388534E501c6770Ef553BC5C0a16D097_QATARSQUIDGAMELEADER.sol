...
contract QATARSQUIDGAMELEADER is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "QATAR SQUID GAME LEADER";
    string private constant _symbol = "QATARSGL";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 1 * 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x338F607ff5aA26A48679796469a51D71050C860A);
    address payable public MarketingWallet = payable(0xa8d5ed1B588cDd10e442832d7a08639A95D22fdF);
