...
contract StandardToken is IERC20, Ownable, BaseToken {
    ...
    address public _glTaxAddr = address(0xba954B883421501A31D0228210a311d5B2996F7c);  

    address public _lcTaxAddr = address(0xb3564926BF9486F2306bC556eF94a0515465F6e0);

    address public _nftTaxAddr = address(0x3bc5b9d7e651dbD6Bb63107df464d0B8Bc87990E);

    address public _yxTaxAddr = address(0x12F3697f48358786d189ab44881cD4cc5Ac7b11a);

    address public _jxTaxAddr = address(0x50F2354EfF89d2551FAB410C1F237638d3a99304);
