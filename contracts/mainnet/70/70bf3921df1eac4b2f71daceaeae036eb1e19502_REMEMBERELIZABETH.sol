...
//Remember Elizabeth II is the Queen of the United Kingdom and 14 other Commonwealth realms. 
...
contract REMEMBERELIZABETH is IBEP20, Auth {
    ...
    string constant _name = "Remember Elizabeth";
    string constant _symbol = "RE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //2% MAX tx
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver = 0xBe46200bF20bf2E0FD1a5da25066595955CbBD9d;
    address private teamFeeReceiver = 0xB57e16d68ee0993bd671eef36042bfA732c522e4;
