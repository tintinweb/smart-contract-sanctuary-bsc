...
contract GROVERCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Grover Coin";
    string private _symbol = "$GROC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6F7C22716691277d08182E0de14506ce991Fbb15); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x6F7C22716691277d08182E0de14506ce991Fbb15); // Team Address
