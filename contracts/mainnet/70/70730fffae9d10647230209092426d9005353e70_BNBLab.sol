...
contract BNBLab {
	...
	uint constant public			PROJECT_FEE						= 100;					// project fee 5% of deposit
	uint constant public			MARKETING_FEE					= 100;					// marketing fee 10% of deposit
	...
	uint constant public			INSURANCE_PERCENT				= 300;					// insurance fee 10% of claim
