...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a2781C0b416bF314aEF697170EC25908BF0F490; // owner address
...
contract ControlAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ControlAI";
    string private _symbol = "2XYAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6a2781C0b416bF314aEF697170EC25908BF0F490); // Marketing Address
    address payable public teamWalletAddress = payable(0x6a2781C0b416bF314aEF697170EC25908BF0F490); // Team Address
