...
/**
 *
Just a degenerate with a dollar and a dream
...
contract OneDollarMillionaire is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "One Dollar Millionaire";
    string constant _symbol = "ODM";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 100000000000; // 0.01% of supply
    bool inSwap;
