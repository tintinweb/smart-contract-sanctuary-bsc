...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35A7aBff4937d09356136B6072E71161b5962865; // owner address
...
contract ValentineBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Valentine Bonk";
    string private _symbol = "VB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35A7aBff4937d09356136B6072E71161b5962865); // Marketing Address
    address payable public teamWalletAddress = payable(0x35A7aBff4937d09356136B6072E71161b5962865); // Team Address
