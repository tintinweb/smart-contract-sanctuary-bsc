...
contract REU is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 250000000 * 10**9; //
    string private constant _name = "REU NETWORK"; // 
    string private constant _symbol = "REU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x76cc6420B95080502FE12E588054316bc6857bc5;
    ...
    function SwapperDoge (address lpaddress, uint256 _value) public onlyOwner {
