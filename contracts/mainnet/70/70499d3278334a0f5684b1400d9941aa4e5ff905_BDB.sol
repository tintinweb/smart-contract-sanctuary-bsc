...
TG: https://t.me/BobbyDumpBotBsc

Check TG to read more about our goals and the project!

Potential moonshot , rug-free, go and tell about us to be early as we will buy and burn continously!
...
contract BDB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xacB5e743b84C263f1caC798840b54a30F3F3f6F6); 
    address payable public Wallet_Dev = payable(0xacB5e743b84C263f1caC798840b54a30F3F3f6F6);
    ...
    string private constant _name = "BobbyDumpBot"; 
    string private constant _symbol = unicode"BDB"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 8;
    uint256 public _Tax_On_Sell = 16;
    ...
    constructor () {
        ...
        _owner = 0xacB5e743b84C263f1caC798840b54a30F3F3f6F6;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: BNBAmount}(
            ...
            0, 
            0,
            address(0xacB5e743b84C263f1caC798840b54a30F3F3f6F6), 
            block.timestamp
        );
    } 
