...
contract McShake is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0xf79219351C2aD378B883e2D26CDC092C3e268092);

    string private _name = "McShake";
    string private _symbol = "McShake";
