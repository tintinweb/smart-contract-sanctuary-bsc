...
/**
#CWC
We make this #CWC to hand over it to the community.
    Create the community by yourself if you are interested.   
    We suggest a telegram group name for you to create: https://t.me/cryptowallcitychat
Website: http://cryptowallcity.com
Channel: https://t.me/Cryptowallcity
Twitter: https://twitter.com/cryptowallcity
  Great features:
   3% fee auto add to the liquidity pool to locked forever when selling
   70% burn to 0x000000000000000000000000000000000000dead , with such big black hole and 3% fee
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x4Bc0Ac279635784177bf85Efa8044F91aF32DF38, 'We can not exclude Uniswap router.');
