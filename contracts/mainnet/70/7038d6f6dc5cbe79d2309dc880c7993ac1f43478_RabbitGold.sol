...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf10cEaD5c034d244b75e5036f810024C8c2B408E;
...
contract RabbitGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Rabbit Gold ";
    string private _symbol = " RG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46368103F47636094fbb861d01f80468c7c9129D);
    address payable public teamWalletAddress = payable(0xa0977FE217e48CD06C018bb0b68df8214AE240Ec);
