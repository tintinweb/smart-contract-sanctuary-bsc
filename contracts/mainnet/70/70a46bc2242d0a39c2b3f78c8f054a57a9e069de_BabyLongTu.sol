...
// https://t.me/BabyLongTu
// Tax: 5% buy 5% sell | 1% max txn 1% wallet LP Locked & Renounced
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x262D3e4913138d6056c3c394120eAC67E9a6fB35; // owner address
...
contract BabyLongTu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Long Tu";
    string private _symbol = "$BABYTU";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xF7Ae9E6BfAb0b24208CcD1260A2840c9A32e1302); 
    address payable public teamWalletAddress = payable(0xF7Ae9E6BfAb0b24208CcD1260A2840c9A32e1302);
