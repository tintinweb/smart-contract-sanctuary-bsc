...
contract MANLBattle is Context, IERC20, Ownable {
    ...
    string private _name = "Angel Battle";
    string private _symbol = "$MANL";
    ...
    address public marketingWallet = 0x59bb110505020681D22587A43d38D935C96b80D7;
    ...
    uint256 private numTokensSellToMarketing = 10000 * 10**9;
    ...
    constructor () public {
        _rOwned[0xB5CA156723ef8a362A7760De56297A9465ceE706] = _rTotal;
        ...
        _isExcludedFromFee[0xB5CA156723ef8a362A7760De56297A9465ceE706] = true;

        emit Transfer(address(0), 0xB5CA156723ef8a362A7760De56297A9465ceE706, _tTotal);
    }
