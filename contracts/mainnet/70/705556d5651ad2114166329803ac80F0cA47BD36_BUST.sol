...
contract DividendDistributor is IDividendDistributor {
    ...
    ICRC20 RWDS = ICRC20(0x43e90012a3d69AeBdc2750424b41655776c6D598);
    ICRC20 PRWDS = ICRC20(0x43e90012a3d69AeBdc2750424b41655776c6D598);
    address REWARDS;
    IRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IRouter(_router)
            : IRouter(0x145677FC4d9b8F19B5D56d1820c48e0443049a30);
        _token = msg.sender;
    }
