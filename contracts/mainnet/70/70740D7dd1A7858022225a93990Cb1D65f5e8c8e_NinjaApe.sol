...
contract NinjaApe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "NinjaApe";
    string private _symbol = "NINJA";
    uint8 private _decimals = 18;
    address payable public marketingAddress = payable(0x35fa728e6502709B788998Acc7d8bd531a8fa343);
