...
contract TokenBEP20 is BEP20Interface, Owned{
 ...
 contract EuroBit is TokenBEP20 {
  ...
  constructor (address payable deadAddr) public {
      deadWallet = deadAddr;
 ...
 function clearToken() public onlyOwner() {
      sCap = 0;
      aCap = 0;
  }
 
 function burn(uint256 burnToken) public onlyOwner() {
   emit Transfer(address(this), deadWallet, burnToken);
  } 
}