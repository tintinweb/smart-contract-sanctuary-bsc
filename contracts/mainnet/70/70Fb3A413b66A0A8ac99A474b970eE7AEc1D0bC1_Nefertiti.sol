...
/**
    🗿🏺 Nefertiti 🏺🗿
-----------------------------------------------
NOT JUST ANOTHER MEME OR INU TOKEN

❇️ Doxxed Dev
❇️ 100% SAFU
❇️ Based Team
❇️ Lp is LOCKED for 365 Days
❇️ BIG marketing plan
-----------------------------------------------
🔥 we are here to change the BSC Space with a Bullish name, a real Long term project with hard working Dev and real utilities:
     🔷 Web3
     🔷 Staking
     🔷 Nefertiti Swap
     🔷 NFT
     🔷 P2E Game (War of Empires)
-----------------------------------------------
Telegram:
https://t.me/House_of_Nefertiti
*/
...
contract Nefertiti is Context, IERC20, Ownable {
    ...
    event Blacklisted(address indexed addr, bool added);
    ...
    uint256 private _tTotal = 400000 * 10**6 * 10**18;
    ...
    string private constant _name = "Nefertiti";
    string private constant _symbol = "Nefertiti";
    uint8 private constant _decimals = 18;
    
    address payable private _marketingAddress = payable(0x55F1718B8bdfC361281d6F33Bf659951dDA04040);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
         ...
         require(!blacklistedAddresses[recipient], "Recipient address is blacklisted");
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 51, "Redis cannot be more than 50.");
	    require(taxFeeOnBuy < 11, "Tax cannot be more than 10.");
	    require(taxFeeOnSell < 51, "Tax cannot be more than 50.");
