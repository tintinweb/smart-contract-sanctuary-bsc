...
contract ZELON is IBEP20, Ownable {
    ...
    //Token Info
    string private constant _name = "ZELON";
    string private constant _symbol = "ZELON";
    uint8 private constant _decimals = 18;
    uint256 public constant InitialSupply = 4000 * 10**6 * 10**_decimals; //equals 4,000,000,000 token
    uint256 public MaxWallet=InitialSupply*15/1000;
    ...
    function SetupLaunchTimestamp(uint timestamp) public onlyTeam {
