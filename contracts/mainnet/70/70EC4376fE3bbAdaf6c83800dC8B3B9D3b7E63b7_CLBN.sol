...
contract CLBN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    mapping(address => bool) public list;
    string private _name = "CLBN";
    string private _symbol = "CLBN";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC104e2E4C7318c2A9d45dC367dB67d92e9830000));
        ruinWalletAddress = payable(address(0xC104e2E4C7318c2A9d45dC367dB67d92e9830000));
