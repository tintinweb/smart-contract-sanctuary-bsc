...
contract FireBSC is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2e2 * 10**18;
    uint256 public maxBuyLimit = 2e3 * 10**18;
    uint256 public maxSellLimit = 2e3 * 10**18;
    uint256 public maxWalletLimit = 2e3 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 6;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xBa75CF49a7A5b462fE19181DBDF26058a59B4e95;
    address public devWallet = 0x42aE29643901Bd73E5193592975392Ae6a1AcC71;
    ...
    constructor(address routerAdd) ERC20("FireBSC", "FIRE") {
