...
contract Tiredoftheapes is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Tired of the Apes";
    string constant _symbol = "TApes";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x07A31113966af549EfD20834286FDc66a55ccf7D;
