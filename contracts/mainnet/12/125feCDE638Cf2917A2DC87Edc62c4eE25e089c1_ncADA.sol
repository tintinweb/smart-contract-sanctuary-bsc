...
contract ncADA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New community ADA";
    string private _symbol = "ncADA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3684e3c7b1a285F30038e68884450eE922e8720f);
    address payable public teamWalletAddress = payable(0xCa7A4a72823295066583079061EB0697Fe744C26); 
