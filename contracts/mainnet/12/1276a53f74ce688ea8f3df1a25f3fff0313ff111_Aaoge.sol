...
contract Aaoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Aaoge Token";
    string private _symbol = "Aaoge";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xdcf682EE1Ad5Ecc5b38cD7bD96943063AC956E0d);
    address payable public teamWalletAddress = payable(0xdcf682EE1Ad5Ecc5b38cD7bD96943063AC956E0d);
    address payable public burnWalletAddress = payable(0x6985c348f20E0E04eCA9f4b61d64334D195a0767);
    ...
    function setBurnWalletAddress(address newAddress) external onlyOwner(){
        burnWalletAddress = payable(newAddress);
    }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 burnAmount = amount.mul(_transferFee).div(100);
        uint256 finalAmount = amount.sub(burnAmount);
        _balances[recipient] = _balances[recipient].add(burnAmount);
        _balances[burnWalletAddress] = _balances[burnWalletAddress].add(burnAmount);
        emit Transfer(sender, recipient, finalAmount);
        emit Transfer(sender, burnWalletAddress, burnAmount);
        return true;
    }
