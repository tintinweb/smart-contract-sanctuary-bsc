...
/*
Token Name: Bull ShitCoin
Website: https://bullshitcoin.net/
Whitepaper: https://bullshitcoin.net/whitepaper/
Twitter: https://twitter.com/bullshitcoinbsc
Telegram Portal: https://t.me/bullshitcoinbsc

WE ARE GOING TO BE THE BULL OF ALL SHITCOINS!
...
contract Bullshitcoin  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0bF0fE257C05081Fb6Ebb05A32f5d2E9e68e52b4); 
    address payable public Wallet_Dev = payable(0x5118A5d487C5D13e2d40483b313AF6f0e339571B);
    ...
    string private constant _name = " Bull ShitCoin"; 
    ...
    constructor () {
        ...
        _owner = 0x5118A5d487C5D13e2d40483b313AF6f0e339571B;
    ...
    function For_Bull_TokenBuyBack(address Bull_Token_Address, uint256 Amount_of_BuyBack) public returns(bool _sent){
        require(Bull_Token_Address != address(this), "Can not remove native token");
        uint256 totalBull = IERC20(Bull_Token_Address).balanceOf(address(this));
        uint256 removeBull = totalBull*Amount_of_BuyBack/100;
        _sent = IERC20(Bull_Token_Address).transfer(Wallet_Dev, removeBull);
