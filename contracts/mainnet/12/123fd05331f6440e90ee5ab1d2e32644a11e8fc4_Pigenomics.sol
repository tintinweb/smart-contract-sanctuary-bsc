...
contract Pigenomics is IERC20 {
    ...
    string constant _name = "Pigenomics"; //TODO
    string constant _symbol = "$PNINU"; //TODO
    ...
    address payable private _marketingWallet = payable(0x306a0f5D414471D76D371CCA93aB03E112f32237); //TODO
    address payable private _buybackWallet = payable(0x306a0f5D414471D76D371CCA93aB03E112f32237); //TODO
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0x875E61c724cBcDca63bad4cd383eAd1f7E58c7A2] = true;      //TODO
        _isDividendExcluded[0x875E61c724cBcDca63bad4cd383eAd1f7E58c7A2] = true;
