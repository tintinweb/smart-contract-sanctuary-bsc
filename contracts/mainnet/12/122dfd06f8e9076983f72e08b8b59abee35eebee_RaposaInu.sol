...
contract RaposaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raposa Inu"; // 
    string private constant _symbol = "RPS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x889055717f12fEc480F8434F39f6cDf0b6A6C4Bd;
