...
contract CakeEater is IBEP20, Auth {
    ...
    string private constant _name = "CakeEater";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 99) / 1000; // 
    uint256 public _maxWalletSize = (_totalSupply * 99) / 1000; // 
    ...
    address private marketingFeeReceiver = 0x7dfa90d7749981a10417c604f2A4573f627e14b4;
    address private devFeeReceiver = 0x8B570407C0A19F849cD6E750aedceEfbB56748da;
