...
contract Spacepishib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spacepishib";
    string private _symbol = "Spacepishib";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbAb9488d0D4Bbe992E78412119578C4b1128f6c4); 
