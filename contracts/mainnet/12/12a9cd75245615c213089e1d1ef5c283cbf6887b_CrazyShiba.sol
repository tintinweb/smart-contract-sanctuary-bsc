...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA3fE26E74653dB6535c704eFBAcAe654aD316d5A; // owner address
...
contract CrazyShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crazy Shiba";
    string private _symbol = "CrazyShiba";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa289630830086c3be14AB0E2aadcaF05ed7d5C39); // Marketing Address
    address payable public teamWalletAddress = payable(0xfa36BF911Cc8c310dcee7caA1B1d43C56D808552); // Team Address
