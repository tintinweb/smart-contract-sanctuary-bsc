...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAF9947265a5f36AB157F660a99f8443f3A9129Cc; // owner address
...
contract ShinamaruInu is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Shinamaru Inu";
    string private _symbol = unicode"SHINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAF9947265a5f36AB157F660a99f8443f3A9129Cc); // Marketing Address
    address payable public teamWalletAddress = payable(0xAF9947265a5f36AB157F660a99f8443f3A9129Cc); // Team Address
