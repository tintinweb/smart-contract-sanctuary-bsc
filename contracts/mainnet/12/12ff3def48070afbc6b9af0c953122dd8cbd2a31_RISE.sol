...
Twitter: https://twitter.com/risebscwtf
Telegram: https://t.me/risebscwtf
Medium: https://medium.com/@risebscwtf
...
contract RISE is IBEP20, Auth {
    ...
    string constant _symbol = unicode"上升";
    ...
    function BlacklistBot() external onlyOwner{
    ...
    function Launch(bool state) public onlyOwner {
        tradingOpen = state;
    }
    ...
    // Exclude bots
    function BlacklistBot(address _address, bool _value) public onlyOwner{
