...
contract  BlueIceToken is IERC20, Ownable {
    ...
    function _transferStandard(
        ...
        uint256 recipientRate = 10000 - _marketingFee;

        _tOwned[recipient] = _tOwned[recipient].add(
            tAmount.div(10000).mul(recipientRate - _marketingFee)
        );
        emit Transfer(sender, recipient, tAmount.div(10000).mul(recipientRate- _marketingFee));
    }
