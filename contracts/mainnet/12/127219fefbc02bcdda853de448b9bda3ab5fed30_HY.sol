...
contract HY is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("HY", "HY") {
    ...
    function _transfer(
		...
		if(from == address(this) || to == address(this) || from == address(wrap) || to == address(wrap)){
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx) {
            ...
            if(from== uniswapV2Pair){
                require(startTime.add(86400) < block.timestamp);
