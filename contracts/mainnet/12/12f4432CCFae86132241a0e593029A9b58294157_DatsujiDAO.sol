...
contract DatsujiDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DatsujiDAO";
    string private _symbol = "DDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9746687bFD032F596DA56f63fa960B18c48D925b); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x9746687bFD032F596DA56f63fa960B18c48D925b); // Team Address
