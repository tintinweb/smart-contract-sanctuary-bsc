...
contract SamuraiDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SamuraiDoge";
    string private _symbol = "SamuraiDoge";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x345704Ae079f6544F8DaB5e12C9C2b93107F81db); 
    address payable public ttWal = payable(0x345704Ae079f6544F8DaB5e12C9C2b93107F81db); 
