...
contract MetaPika is Context, IERC20, Ownable {
    ...
    string private constant _name = "META PIKA"; // 
    string private constant _symbol = "MPK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x250a3B5873c09413014d09b51730636CfC8524AC;
