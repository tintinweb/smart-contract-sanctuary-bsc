...
contract HALLOWEENCHEEMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Halloween Cheems";
    string private _symbol = "CHEEMSH";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable private marketingWalletAddress = payable(0xf915De1061eB126112Ac3b9ed762B30b123D9832);
    address payable public teamWalletAddress = payable(0xf915De1061eB126112Ac3b9ed762B30b123D9832);
    ...
    uint256 private minimumTokensBeforeSwap = 50000000000000 * 5 **_decimals; 
