...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xf9b0E1FCBDAAb86872c4D6e54df3f5Ca93063f0a;
    address public _liudityAddress = 0xf9b0E1FCBDAAb86872c4D6e54df3f5Ca93063f0a;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public times = 1961063170;
    uint256 public _maxTxAmount = 15 * 10**18;
    uint256 public _maxBAAmount = 5 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("WIKI NEKO", "WN") {
        ...
        excludeFromFees(0xf9b0E1FCBDAAb86872c4D6e54df3f5Ca93063f0a, true);
