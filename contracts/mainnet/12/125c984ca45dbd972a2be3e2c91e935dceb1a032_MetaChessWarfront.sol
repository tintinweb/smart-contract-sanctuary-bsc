...
// AUTHOR: UNDERSCORE SECURITIES AND TECHNOLOGIES INT'L
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return
            interfaceId == type(IERC1155).interfaceId || interfaceId == 0x2a55205a ||
...
contract MetaChessWarfront is ERC1155, Ownable, ReentrancyGuard {
    ...
    uint256 public royaltyFee = 700; // 7%
    ...
    // total Supply for Each collection
