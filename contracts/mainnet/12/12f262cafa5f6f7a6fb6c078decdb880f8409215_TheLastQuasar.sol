...
contract TheLastQuasar is ERC20, Ownable {
    ...
    uint16 public feeliq_sell = 7; // Fee is initially set to 99% to avoid sniperbots
    ...
    constructor() ERC20("The Last Quasar", "TLQ") {
