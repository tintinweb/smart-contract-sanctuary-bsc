...
contract WhaleShark is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 60 seconds; // Cooldown 60Minutes
    ...
    uint256 private _tTotal = 1e9 * 10**_decimals; // 1 Billion Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1_500_000 * 10**9; // Swap Threshold 0.15%
    uint256 public maxBuyLimit = 20_000_000 * 10**9; // Max Buy 2%
    uint256 public maxSellLimit = 20_000_000 * 10**9; // Max Sell .5%
    uint256 public maxWalletLimit = 20_000_000 * 10**9; // Max Hold 2%
    ...
    string private constant _name = "Whale Shark";
    string private constant _symbol = "WSHARK";
    ...
    Taxes public sellTaxes = Taxes(0, 15, 0, 0, 0);
