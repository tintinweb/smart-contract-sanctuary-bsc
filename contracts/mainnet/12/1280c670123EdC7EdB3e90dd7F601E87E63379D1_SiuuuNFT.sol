...
contract SiuuuNFT is AccessControlEnumerableUpgradeable, ERC721BurnableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    mapping(uint256 => bool) public blacklistToken;
    mapping(address => bool) public blacklistUser;

    function initialize() public initializer {
        __ERC721_init("SiuuuNFT", "SIN");
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklistToken[tokenId], "this NFT is in blacklist");
        require(!blacklistUser[from], "this address is in blacklist");
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function setTokensLock(uint256[] memory _tokensId, bool _bool) public onlyAdmin {
        for (uint256 index = 0; index < _tokensId.length; index++) {
            blacklistToken[_tokensId[index]] = _bool;
        }
    }

    function setUsersLock(address[] memory _users, bool _bool) public onlyAdmin {
        for (uint256 index = 0; index < _users.length; index++) {
            blacklistUser[_users[index]] = _bool;
        }
    }
