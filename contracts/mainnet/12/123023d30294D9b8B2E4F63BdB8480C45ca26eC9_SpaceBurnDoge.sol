...
contract SpaceBurnDoge is IERC20, Ownable {
    ...
    uint256 public numTokensSell = 10**23;

    address public marketAddress = 0x43e84D18E220671CbAFEca3Bf485506FE651a400;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        emit Transfer(sender, address(this), marketAmount);

        uint256 burnAmount = 7*amount/100;
