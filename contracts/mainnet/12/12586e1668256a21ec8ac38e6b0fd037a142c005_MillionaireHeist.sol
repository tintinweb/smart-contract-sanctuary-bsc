...
contract MillionaireHeist is Context, IERC20, Ownable {
    ...
    string private constant _name = "MILLIONAIRE HEIST"; //
    string private constant _symbol = "$MHT "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0xd11f7bcbaA322A754909287401Fbd8aA264ef8ea ;
