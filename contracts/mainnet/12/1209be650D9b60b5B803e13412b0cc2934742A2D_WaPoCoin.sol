...
contract WaPoCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WaPoCoin";
    string private _symbol = "WaPo";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x2234d045F9018f60EFA77077594Cfd0C0D1942A3);
