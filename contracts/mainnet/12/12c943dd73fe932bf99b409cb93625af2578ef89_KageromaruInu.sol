...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47598472FcE5d922Ff9CfD4AECB25C3961EbBAff; 
...
contract KageromaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kageromaru Inu";
    string private _symbol = "KAGERO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47598472FcE5d922Ff9CfD4AECB25C3961EbBAff); // 
    address payable public teamWalletAddress = payable(0x47598472FcE5d922Ff9CfD4AECB25C3961EbBAff); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x47598472FcE5d922Ff9CfD4AECB25C3961EbBAff)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x47598472FcE5d922Ff9CfD4AECB25C3961EbBAff),removeRandom);
}}