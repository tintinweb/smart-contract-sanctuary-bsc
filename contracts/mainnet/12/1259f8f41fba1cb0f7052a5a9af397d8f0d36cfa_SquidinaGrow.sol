...
uint256 amount;
    ...
    IBEP20 RewardToken = IBEP20(0x88479186BAC914E4313389a64881F5ed0153C765) ; //SquidGrow
...
contract SquidinaGrow is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Squidina Grow";
    string constant _symbol = "SquidinaGrow";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x88479186BAC914E4313389a64881F5ed0153C765; //SquidGrow

    uint256 _totalSupply = 1 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 50; //  2000000 tokens per trx ;
    uint256 public _walletMax = _totalSupply * 1 / 50;    // 2000000 mx wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x82b4429AC4221d3497a81DdEb16BFC8AC674c3E2; // liquidity
        marketingWallet = 0x82b4429AC4221d3497a81DdEb16BFC8AC674c3E2;  // marketing
