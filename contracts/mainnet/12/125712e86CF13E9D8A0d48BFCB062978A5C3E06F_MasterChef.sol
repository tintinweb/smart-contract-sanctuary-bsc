...
contract MeowToken is BEP20('Meow Finance', 'Meow') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Meow (not scaled);
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function pendingMeow(uint256 _pid, address _user) external view returns (uint256) {
        ...
        if (block.number > pool.lastRewardBlock && pool.lpSupply != 0 && totalAllocPoint > 0) {
            ...
            accMeowPerShare = accMeowPerShare.add(MeowReward.mul(1e12).div(pool.lpSupply));
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.accMeowPerShare = pool.accMeowPerShare.add(MeowReward.mul(1e12).div(pool.lpSupply));
        pool.lastRewardBlock = block.number;
    }
