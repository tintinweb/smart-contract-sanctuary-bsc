...
contract LuckyRabbit2023 is ERC20, Ownable {
    ...
    Taxes public taxes = Taxes(4, 1, 4);
    Taxes public sellTaxes = Taxes(4,1,4);

    uint256 public TotalBuyFee = taxes.marketing + taxes.liquidity + taxes.ecosystem;
    uint256 public TotalSellFee = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.ecosystem;
    ...
    constructor(address routerAdd) ERC20("LuckyRabbit2023", "LRGO") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        TotalBuyFee = _marketing + _liquidity + _ecosystem;
        require((TotalBuyFee) <= 10, "Must keep fees at 10% or less");
        taxes = Taxes(_marketing,_liquidity, _ecosystem);
    }
    ...
    function SetSellTaxes(
        ...
        TotalSellFee = _marketing + _liquidity + _ecosystem;
        require((TotalSellFee) <= 15, "Must keep fees at 15% or less");
        sellTaxes = Taxes(_marketing,_liquidity, _ecosystem);
    }
   ...
   function enableTrading() external onlyOwner {
    ...
    function updatedeadline(uint256 _deadline) external onlyOwner {
        ...
        require (_deadline < 10,"Deadline should be less than 5");
        deadline = _deadline;
    }
