...
FTXNOMICS JOIN TELEGRAM https://t.me/ftxnomics
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6522Fc7C8a626b81B420Ca003233E0D9743e1EB7; // owner address
...
contract FTXNOMICS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FTX NOMICS";
    string private _symbol = "FTTN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6522Fc7C8a626b81B420Ca003233E0D9743e1EB7); // Marketing Address
    address payable public teamWalletAddress = payable(0x6522Fc7C8a626b81B420Ca003233E0D9743e1EB7); // Team Address
    ...
    uint256 private _totalSupply = 328895112 * 10**_decimals;
    uint256 public _maxTxAmount = 6577902 * 10**_decimals; 
    uint256 public _walletMax = 6577902 * 10**_decimals;
