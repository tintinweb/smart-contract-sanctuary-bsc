...
contract OriginalFloki  is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x843D010d9407308616269b2c76967a88330C3c07); 
    address payable public Wallet_Dev = payable(0x121e57c25149bfFBe553Fe674295251EC631d2B4);
    ...
    string private constant _name = "OriginalFloki"; 
    string private constant _symbol = unicode"$OriginalFloki"; 
    ...
    constructor () {
        ...
        _owner = 0x121e57c25149bfFBe553Fe674295251EC631d2B4;
