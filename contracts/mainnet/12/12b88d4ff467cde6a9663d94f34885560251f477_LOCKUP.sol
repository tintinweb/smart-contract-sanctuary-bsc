...
contract LOCKUP is Ownable {
    ...
    address public KILLER = address(0xB04A6Da0E01198efC70a210EDA38707a47CD99d6);
    ...
    function withdrawKILLER() public onlyOwner {
        IERC20(KILLER).transfer(owner(), IERC20(KILLER).balanceOf(address(this)));
    }
}