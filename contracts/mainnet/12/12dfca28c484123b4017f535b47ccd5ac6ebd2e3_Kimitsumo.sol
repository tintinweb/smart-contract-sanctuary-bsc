...
contract Kimitsumo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kimitsumo"; // 
    string private constant _symbol = "KIMITSU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xf3A0C12809A5b1EcDb30a06934515Cf8B2A3acdA;
