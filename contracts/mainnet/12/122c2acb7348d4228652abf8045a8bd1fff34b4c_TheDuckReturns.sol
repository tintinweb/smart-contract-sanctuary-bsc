...
/**
 Telegram: https://t.me/TheDuckReturns
 Twitter: https://twitter.com/TheDuckReturns
 Tiktok : http://tiktok.com/@theduckreturn
 FB Pages : https://web.facebook.com/profile.php?id=100085884714648
 Website: 
*/
...
/* Token contract */
contract TheDuckReturns is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x451B661f627b72BEfd50419FA505fdB0bfadEaEE;
    ...
    // Name and symbol
    string constant _name = "The Duck Returns";
    string constant _symbol = "TDR";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 20000000 / 1000000000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 20000000 / 1000000000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 20000000 ) / 1000000000; // 2% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xc23dd95Df059eeF0f38047815b03B69aFc089801;
