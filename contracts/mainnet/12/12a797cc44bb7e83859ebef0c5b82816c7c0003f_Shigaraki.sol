...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0aC9c88D5959fe12A17e195cC4311e83866633eA; // owner address
...
contract Shigaraki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shigaraki inu";
    string private _symbol = "Shigaraki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB00d380F769A573E82eA2d9227282dc8ba90435a); // Marketing Address
    address payable public buybackWalletAddress = payable(0xB00d380F769A573E82eA2d9227282dc8ba90435a); // Buyback Address
