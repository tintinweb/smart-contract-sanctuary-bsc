...
contract SQUIDAPE is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x8Ba6204d4E865edA883C72A035Fecd1C93eE0c86;
    address DevWallet       = 0x8Ba6204d4E865edA883C72A035Fecd1C93eE0c86;

    string constant _name = "Squid Ape BSC";
    string constant _symbol = "SQUIDAPE";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 50000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 50000000 * (10 ** _decimals);
    uint256 public _maxSell = 50000000 * (10 ** _decimals);
