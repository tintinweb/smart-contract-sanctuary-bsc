...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BULLS = IBEP20(0x4BD1027C5c83dAc320B096868cd1AbEd8b4e9Bc7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BULLS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BULLS);
        ...
        uint256 amount = BULLS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BULLS.transfer(shareholder, amount);
...
/* Token contract */
contract Kamijirou is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x4BD1027C5c83dAc320B096868cd1AbEd8b4e9Bc7; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB363762d56f17872A708733ff592c0C0f344ddd4;
    ...
    // Name and symbol
    string constant _name = "Kamijirou";
    string constant _symbol = "KAMIJIROU";
