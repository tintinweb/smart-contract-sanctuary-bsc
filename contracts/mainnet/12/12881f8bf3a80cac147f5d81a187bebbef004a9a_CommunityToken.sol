...
// https://t.me/MakeTGYourself, this is 100% Community Token, driven fully by community
// No Scam
// No Mint Function
// 100% Safe
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x05f8274DdEa8247608Be685004734Ce3CE047644;
...
contract CommunityToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd6e3BAC3bcCB28631a015623537990311E50037B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100 * 10**42 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Berlin Rockstar";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**18 * 10**9;
