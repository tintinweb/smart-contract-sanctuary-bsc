...
contract FoxGames is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fox Games";
    string private constant _symbol = "FOX";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress = payable(0x245E7F6DF9529360A9560AeC090D068b60eb8909);
    address payable private _marketingAddress = payable(0x2B577DF3C512234aa28aE33e979227417439B2FF);
   ...
   //     require(rAmount <= _rTotal, "Amount must be less than total reflections");
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 7, "");
	    require(redisFeeOnSell < 7, "");
