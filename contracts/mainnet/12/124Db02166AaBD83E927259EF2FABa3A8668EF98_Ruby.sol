...
contract Ruby is ERC20, AccessControl{
    ...
    constructor(address creator, address _usdtAddress, address _median) ERC20("Ruby Coin", "RUBY") {
        ...
        excludedFromFee[address(uniswapV3Router)] = true;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 usdtAmount) internal {
        ...
        _approve(address(this), address(uniswapV3Router), tokenAmount);
        IERC20(usdtAddress).approve(address(uniswapV3Router), usdtAmount);

        // add the liquidity
        uniswapV3Router.addLiquidity(
            address(this),
            usdtAddress,
            tokenAmount,
            usdtAmount,
