...
contract LGO is ERC20 {
	...
	address public _fundAddress = address(0xF8cdf806318E1733C37a9F26d025eb94B1a545A9);
	address public _luckAddress = address(0xedFf5FfD12d57fFBa9918e0Ea21d22ef32f0F137);
    ...
    constructor(address tokenOwner) ERC20("LGO", "LGO") {
        ...
        _mint(tokenOwner, total.div(10).mul(7));
		_mint(_luckAddress, total.div(10).mul(3));
