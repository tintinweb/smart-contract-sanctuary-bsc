...
contract SHIBK is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBK";
    string private _symbol = "SHIBK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C0f7DF61cCf0E782bc728D328E4589651271671);
    address payable public teamWalletAddress = payable(0x1C0f7DF61cCf0E782bc728D328E4589651271671);
    address public immutable deadAddress = 0x1C0f7DF61cCf0E782bc728D328E4589651271671;
