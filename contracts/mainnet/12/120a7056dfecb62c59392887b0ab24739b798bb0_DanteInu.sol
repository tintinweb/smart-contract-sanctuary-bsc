...
contract DanteInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "DanteInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2B48c592BD9a13fC09CD7620B7AF746DE0cC6464);
    address payable public BuyBackWalletAddress = payable(0x2B48c592BD9a13fC09CD7620B7AF746DE0cC6464);
