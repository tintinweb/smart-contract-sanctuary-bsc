...
contract SHIROSUKI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = unicode"Shirosuki白好き";
    string private constant _symbol = unicode"Shirosuki";
    ...
    address payable public DevWallet = payable(0x57494d11ed2B7cEa32FCe04307c0459d2fBaa9dB);
    address payable public MarketingWallet = payable(0x57494d11ed2B7cEa32FCe04307c0459d2fBaa9dB);
