...
contract FuckTheMerge is IBEP20, Auth {
    ...
    string constant _name = "FuckTheMerge";
    ...
    address private marketingFeeReceiver =0xC526F5f02ca216fb9575cb72150Acc095888975C;
    address private teamFeeReceiver =0xC526F5f02ca216fb9575cb72150Acc095888975C;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 100; // 100%
    bool inSwap;
