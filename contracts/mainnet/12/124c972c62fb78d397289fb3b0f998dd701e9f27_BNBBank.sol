...
// Telegram : https://t.me/BNBBank_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A9668D991987c18b4C1cCd60cC0392aacCdFc3f; // owner address
...
contract BNBBank is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB Bank";
    string private _symbol = "BNBB";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3A9668D991987c18b4C1cCd60cC0392aacCdFc3f); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A9668D991987c18b4C1cCd60cC0392aacCdFc3f); // Team Address
