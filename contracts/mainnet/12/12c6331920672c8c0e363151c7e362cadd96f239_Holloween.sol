...
contract Holloween is IBEP20, Auth {
    ...
    string constant _name = "Haro-in Neko";
    string constant _symbol = "HaNe";
    ...
    address public marketingFeeReceiver = 0x03fDD0F9E13A7581dC22731253efBdf4A166c70A;
    ...
    uint256 public swapThreshold = _totalSupply / 500 * 100; // 0,3.00%
    bool inSwap;
