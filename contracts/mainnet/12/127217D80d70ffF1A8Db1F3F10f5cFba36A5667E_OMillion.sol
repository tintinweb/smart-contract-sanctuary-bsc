...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/Official_OneInAMillion

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://onemillion.vip 

𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/OneMillionBSC
...
contract OMillion is Context, IERC20, Ownable {
    ...
    string private constant _name = "One in a Million";  
    string private constant _symbol = "OMillion";     
    uint8 private constant _decimals = 9;  
    
    uint256 public _marketingAndLiquidityFee = 6; 
    uint256 public _OMillionTax = 4; 
    address public  _marketing = 0x1861994BA9842B93c09e83087e5070ffd4d82b5C;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) { 
        ...
        uint256 liquidityFee = amount * _OMillionTax / 100; 
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _OMillionTax / (_marketingAndLiquidityFee + _OMillionTax);
