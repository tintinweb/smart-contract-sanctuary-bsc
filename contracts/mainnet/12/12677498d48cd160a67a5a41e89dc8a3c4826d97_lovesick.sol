...
contract lovesick is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Love Sick";
    string private _symbol = "Love Sick";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xdea0357808E2B897776cad6e20345aa5bD3ea429);
