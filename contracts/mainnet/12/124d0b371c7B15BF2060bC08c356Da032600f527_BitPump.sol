...
//sweet bitcoin rewards.. marketing ...mooner in your net
//get it lfg  telegram: t.me/Bit_Pumpofficial
...
/* Token contract */
contract BitPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address REWARDSPOOL = 0xfdcd345E467a2A76B659AfDA0f52F59DFFA7a71B;
    ...
    // Name and symbol
    string constant _name = "Bit Pump";
    string constant _symbol = "BITP";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2 percent
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1 percent
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2 percent
    ...
    constructor () Auth(msg.sender) {
        ...
        isTimelockExempt[REWARDSPOOL] = true;
