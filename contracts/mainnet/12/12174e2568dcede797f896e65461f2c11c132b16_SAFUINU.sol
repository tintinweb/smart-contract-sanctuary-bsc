...
/**https://t.me/SafuInuBsc
/**
/**SAFU INU launch is inspired to be the next 100X gem to your crypto wallet.
...
contract SAFUINU is Context, IERC20, Ownable {
    ...
    string private _name = "SAFUINU";
    string private _symbol = "$SAFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe7238370FE1eAd105A74cf51F90Fc5e0A27d9C0A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xe7238370FE1eAd105A74cf51F90Fc5e0A27d9C0A); // BuyBack Address
