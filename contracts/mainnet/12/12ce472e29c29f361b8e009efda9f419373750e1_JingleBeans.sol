...
Telegram : https://t.me/jinglebeansbnb 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0d70d541d92610eB3a296081EBc7689445d8F7a6; // owner address
...
contract JingleBeans  is Context, IERC20, Ownable {
    ...
    string private _name = "JingleBeans";
    string private _symbol = "JB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68a8C17712A4C86556bD225261C1Ef6D7fd9A04d); 
    address payable public lotteryWalletAddress = payable(0x68a8C17712A4C86556bD225261C1Ef6D7fd9A04d); 
