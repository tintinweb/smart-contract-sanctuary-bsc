...
// File contracts/szi/SpaceZoroinu.sol
...
contract SpaceZoroinu is IBEP20, Auth {
    ...
    string constant _name = "Space Zoroinu";
    ...
    // fee: 10% buy, 15% sell
    // split fee 50% team, 30% reward, 20% liquidity
    uint256 buyFee = 1000;
    uint256 sellFee = 1500;
    uint256 feeDenominator = 10000;

    uint256 teamFeeShare = 50;
    uint256 liquidityFeeShare = 50;
    uint256 totalFeeShare = 100;
    ...
    function setFeeShares(uint256 _teamFeeShare, uint256 _liquidityFeeShare) external authorized {
