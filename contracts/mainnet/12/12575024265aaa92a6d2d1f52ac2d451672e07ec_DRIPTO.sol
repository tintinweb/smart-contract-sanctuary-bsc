...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA260be9b89e672e70E33269DC85C94BF875a745f;
...
contract DRIPTO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF1d9447B235AD84C4F03BF12eF0c179376036b49;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Dripto";
    string private _symbol = "DRIPT";
