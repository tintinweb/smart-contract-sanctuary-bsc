...
Millionaire Yatch CLub

           -is a Community based Token builded to provide Smoother and Trouble-free transaction on BSC Network with also built-in Automated Rewards Farming (ARF) system. $MYC ecosystem where anyone can make money from holding our token. The two sides of the ecosystem are Frictionless and Non-Frictionless. 
...
pragma solidity ^0.6.12;
    ...
    contract MillionaireYatchClub is Context, IERC20, Ownable {
        ...
        string private _name = 'Millionaire Yatch Club';
