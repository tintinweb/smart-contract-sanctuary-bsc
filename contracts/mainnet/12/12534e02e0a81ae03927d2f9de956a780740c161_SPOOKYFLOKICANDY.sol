...
Telegram : https://t.me/spookyflokicandy
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x369204dC0Db0108b20dd663864309629eFcBc0E2;
...
contract SPOOKYFLOKICANDY is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPOOKY FLOKI CANDY"; // 
    string private constant _symbol = "$SFLOKIC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x369204dC0Db0108b20dd663864309629eFcBc0E2);
