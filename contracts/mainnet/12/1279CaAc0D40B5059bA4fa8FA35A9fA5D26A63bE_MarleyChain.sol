...
/**           
R.I.P MARLEY WE MADE THIS FOR YOU <3   
Telegram : https://t.me/MarleyChain
...
contract MarleyChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MarleyChainDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Marley's Chain", "RastaChain") {
        marketingWallet = payable(0x39Fcf62D856D3e26B5564dc638A04DAC7e2A46b1);
        devWallet = payable(0xc36F0E10480E961688b28282D7F17de97BFf3335);
        ...
        dividendTracker = new MarleyChainDividendTracker(
            payable(this),
            router,
...
contract MarleyChainDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    MarleyChain public MarleyChainContract;
    ...
    constructor(
        ...
        defaultToken = token;
        MarleyChainContract = MarleyChain(mainContract);
    ...
    function _transfer(
        ...
        require(false, "MarleyChain_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MarleyChain_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MarleyChain contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(MarleyChainContract);

            uint256 prevBalance = MarleyChainContract.balanceOf(address(this));
            ...
            {
                uint256 received = MarleyChainContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    MarleyChainContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
