...
/**               
Links                                                                             
Telegram : https://t.me/WaifuMagik
Website : https://WaifuMagik.com
Twitter : https://twitter.com/waifuMagik
...
contract WaifuMagik is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WaifuMagikDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WaifuMagik", "MAGIK") {
        marketingWallet = payable(0x17a34BD7E55cE8cCE9c7B141BB0ed2be0c7E52d8);
        devWallet = payable(0x84762bdA70D33AaA03fbda0D8a7dfBB597643305);
        ...
        dividendTracker = new WaifuMagikDividendTracker(
            payable(this),
            router,
...
contract WaifuMagikDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WaifuMagik public WaifuMagikContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WaifuMagikContract = WaifuMagik(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WaifuMagik_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WaifuMagik_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WaifuMagik contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WaifuMagikContract);

            uint256 prevBalance = WaifuMagikContract.balanceOf(address(this));
            ...
            {
                uint256 received = WaifuMagikContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WaifuMagikContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
