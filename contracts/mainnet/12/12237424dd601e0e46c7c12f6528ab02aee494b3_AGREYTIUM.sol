...
contract AGREYTIUM is Context, IERC20, Ownable {
    ...
    string private _name = "AGREYTIUM NETWORK";
    ...
    address payable public BuyBackWalletAddress = payable(0x6523a584f413217f121d608aF2b642d97Ea4bd66); // BuyBack Address
    ...
    uint256 public _walletMax = 400 * 10**5 * 10**9;
