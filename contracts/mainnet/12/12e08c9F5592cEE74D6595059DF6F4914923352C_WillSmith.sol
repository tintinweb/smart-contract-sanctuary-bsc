 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/WillSmithBSC
 * 
 * 
 * Will Smith token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract WillSmith is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Will Smith";
    string constant _symbol = "WILLS";
