...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public BNB =
        IERC20Extended(0x6fE8424Af31a422e3088b4D08637E5A193279D6F);
    ...
    uint256 public minDistribution = 1 * (10**BNB.decimals());
...
// main contract
contract ValentineBnbToken is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Valentine Bnb";
    string private constant _symbol = "$VBNB";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * 10**_decimals;

    address public BNB = 0x6fE8424Af31a422e3088b4D08637E5A193279D6F;
