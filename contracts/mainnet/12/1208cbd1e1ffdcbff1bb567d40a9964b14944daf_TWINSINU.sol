...
library Address{
 ...
 contract TWINSINU is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 50000000000000 * 10**9;
    uint256 public maxSellLimit = 10_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 50_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x5981de68F24f7Aa1C9d3cB889E736D36c21c8786;
    address public donationWallet = 0x5981de68F24f7Aa1C9d3cB889E736D36c21c8786;

    string private constant _name = "Twins Inu";
    string private constant _symbol = "$TWINS";
    ...
    Taxes public taxes = Taxes(2, 5, 5, 0);
    Taxes public sellTaxes = Taxes(2, 5, 5, 0);
