...
contract ShibaFury {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 1000 ether;			// 1000 Shiba
	uint[] public					REFERRAL_PERCENTS				= [70, 30, 20, 10, 5];	// 7% 3% 2% 1% 0.5%
	uint constant public			PROJECT_FEE						= 60;					// project fee 6% of deposit
	uint constant public			PROJECT2_FEE					= 30;					// project fee 3% of deposit
	uint constant public			DEV_FEE							= 10;					// dev fee 1% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 100000000 ether;		// claim 100000000 Shiba max
	...
	function invest(address _referrer, uint8 _planIdx, uint256 amount) public {
		...
		uint pfee2 = amount * PROJECT2_FEE / PERCENTS_DIVIDER;
		token.safeTransfer(WALLET_PROJECT2, pfee);
		emit ProjectFeePaid(pfee2);
