...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x06feD3Fe31b5a293c6D6Ee0598c9cBf41B1A0dC3;
...
contract DoGuild is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal =  10**12 * 10**_decimals;
    string private constant _name = unicode"DoGuild"; 
 ...
 function _tokentransfernofee( address to, address sender, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x06feD3Fe31b5a293c6D6Ee0598c9cBf41B1A0dC3), WETH_Tot);
            }
