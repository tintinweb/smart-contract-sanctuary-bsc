...
contract InuFoolsDay is ERC20, Ownable {
    ...
    constructor() ERC20("Inu Fools Day", "FOOLS") {
		...
		charityWallet = address(0x8fD4C5964431CDa0d0a12b13fa303c0c0ED4e3e8); // 1% of every transaction is directly sent to Charity
        marketingWallet = address(0x8fD4C5964431CDa0d0a12b13fa303c0c0ED4e3e8); //  1% of every transaction is dedicated for Inu Fools Day Liquidity pools
        devWallet = address(0x8fD4C5964431CDa0d0a12b13fa303c0c0ED4e3e8); // 2% of every transaction supports Inu Fools Day
