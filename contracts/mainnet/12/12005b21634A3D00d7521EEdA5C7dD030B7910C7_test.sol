...
//address
    ...
    address public marketingAddress = 0x41E7C2852f624f166fFA87Eb90c9cA5B257d3841;
    address public devAddress = 0x41E7C2852f624f166fFA87Eb90c9cA5B257d3841;
    address public teamAddress = 0x41E7C2852f624f166fFA87Eb90c9cA5B257d3841;
    address public liquidityAddress = 0x41E7C2852f624f166fFA87Eb90c9cA5B257d3841;
//uint
...
// constructor
    constructor() ERC20("test", "test") {
        ...
        maxSellTxAmount = total_supply / 1; // 1% supply
        maxBuyTxAmount = total_supply / 1; // 1% supply
        //spawn pair
...
//set functions
    ...
    function setSwapAndLiquify(bool _state, uint _intervalSecondsForSwap, uint _minimumTokensBeforeSwap, uint _tokensToSwap) external onlyOwner {
        ...
        require(tokensToSwap <= totalSupply() / 200,"token to swap limited to 0.1% supply");
