...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BLST = IBEP20(0x9887E2D2748AAD35fF5DE80bFB7AD6Aa7711fCA9);
...
/* Token contract */
contract DefaultSHIBA is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BLST = 0xD47e0DC8b27CD13735eE4995aA24083Ef1DBE81F; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xD47e0DC8b27CD13735eE4995aA24083Ef1DBE81F;
    ...
    // Name and symbol
    string constant _name = "DefaultSHIBA";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% or 10k tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD47e0DC8b27CD13735eE4995aA24083Ef1DBE81F;
