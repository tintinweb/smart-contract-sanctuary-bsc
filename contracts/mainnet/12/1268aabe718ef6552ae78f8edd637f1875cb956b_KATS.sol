...
contract KATS
 is Context, IERC20, Ownable {
    ...
    string private _name = "KATS2.0";
    string private _symbol = "KATS2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x941832EC0B149166f147C370789BF274CCBBAbAf);
    address payable public teamWalletAddress = payable(0x941832EC0B149166f147C370789BF274CCBBAbAf);
    address public immutable deadAddress =0x941832EC0B149166f147C370789BF274CCBBAbAf;
