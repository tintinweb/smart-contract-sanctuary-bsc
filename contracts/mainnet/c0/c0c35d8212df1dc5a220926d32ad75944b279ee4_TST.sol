...
contract TST is ERC20, Ownable, LockToken {
    ...
    address payable private marketingWallet = payable(0x591A14EdC83C2533015A494B0e335ef46cf34c7f);
    address payable private communityWallet = payable(0xd295fbAC9946b03b1B5aE6d924CFdd14F13c9cFA);
    address payable private operationsWallet = payable(0x5ad8576802B75E64BCb9D939511Be37bB5d67863);
    address payable private devWallet = payable(0x7FDACD7A7a00737a5d1006F64645F92AC5843D07);
    ...
    constructor() ERC20("The Sphynx Token", "TST") {
