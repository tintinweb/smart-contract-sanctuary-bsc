...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3688275305fAe435c1f6C4C065B0AF153B17F9d7;
...
contract MetaverseBull is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa1F1608Ad1A652143576967e360e1faFe273Fd48;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Metaverse Bull";
    string private _symbol = "MetaverseBull";
