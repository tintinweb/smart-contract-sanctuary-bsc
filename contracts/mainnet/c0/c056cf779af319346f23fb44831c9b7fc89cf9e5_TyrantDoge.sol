...
/* Token contract */
contract TyrantDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb06Bba8fbd863A65325aE7A66AeC0976EC9818E8;
    ...
    // Name and symbol
    string constant _name = "Tyrant Doge";
    string constant _symbol = "TYR";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 150 ) / 5000; // 3% or 3m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb06Bba8fbd863A65325aE7A66AeC0976EC9818E8;
