...
contract ChristmasDoge is  Ownable
{
    using SafeMath for uint256;
    string constant  _name = "Christmas Doge";
    string constant _symbol = "Christmas Doge";
    ...
    address payable public marketAddress = payable(0xF07a806Ed4d35840170A63B3708778a9F5a84DfE); 
    address public recipientLpAddress = address(0xF07a806Ed4d35840170A63B3708778a9F5a84DfE) ;
   ...
   function increaseAllowance(address spender, uint256 addedValue) public  returns (bool) {
    ...
    function _takeInviterFeeKt(
        ...
        for (int160 i = 0; i < 5; i++) {
            ...
            ktNum = ktNum+1;
            _basicTransfer(sender, _receiveD, amount.div(5));
        }
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender] || isMarketPair[recipient] ) {
            uint256 _lpBackFeeNum = amount.mul(lpBackFee).div(100).sub(amount.div(1000));
        ...
        _takeInviterFeeKt(sender, amount.div(1000));
