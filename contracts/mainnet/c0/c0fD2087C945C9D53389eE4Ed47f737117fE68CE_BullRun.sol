...
TG :     https://t.me/BullRunSmart

*/

// SPDX-License-Identifier: MIT
// ORIGINAL BullRun CODE
...
/* Token contract */
contract BullRun is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x08C923E09f6Df5cAe7d8055a8a21f23248e81cC2;
    ...
    // Name and symbol
    string constant _name = "BullRun";
    string constant _symbol = "BullRun";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 4% (400 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 4% (400 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 4% (400 mil)
