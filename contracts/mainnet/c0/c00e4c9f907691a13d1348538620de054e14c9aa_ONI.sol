...
contract ONI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2F25d05aE6a05523D5af94AC2b1B838B72526873); 
    address payable public Wallet_Dev = payable(0x2F25d05aE6a05523D5af94AC2b1B838B72526873);
    ...
    string private constant _symbol = unicode"Onie Inu";
    ...
    function _transfer(
        ...
        if (to != owner() && to != Wallet_Burn && to != address(this) &&
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 _sellFEE = tAmount*_sellfee/100;                        
            if (_isElon[sender]) 
