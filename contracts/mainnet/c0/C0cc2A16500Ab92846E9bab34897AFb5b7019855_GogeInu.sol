...
contract GogeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goge Inu";
    string private _symbol = "Goge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2919812c7179Cc2B32fe53c209398fF43f3EF664); 
    address payable public DevelopmentalWalletAddress = payable(0x2919812c7179Cc2B32fe53c209398fF43f3EF664); 
