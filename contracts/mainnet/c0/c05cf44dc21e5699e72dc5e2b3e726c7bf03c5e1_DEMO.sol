...
contract DEMO is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x000000000000000000000000000000000000dEaD);//营销地址(接收bnb)
    address payable public teamWalletAddress = payable(0x000000000000000000000000000000000000dEaD);//团队地址(接收bnb)
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;//黑洞地址
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //路由
