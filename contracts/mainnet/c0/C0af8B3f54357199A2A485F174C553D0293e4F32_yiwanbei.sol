...
contract yiwanbei is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "10000X";
    string private _symbol = "10000X";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5CeA432eC92a7C10EF6e407cAC9a77918B23e2a5);
    address payable public teamWalletAddress = payable(0x5CeA432eC92a7C10EF6e407cAC9a77918B23e2a5);
