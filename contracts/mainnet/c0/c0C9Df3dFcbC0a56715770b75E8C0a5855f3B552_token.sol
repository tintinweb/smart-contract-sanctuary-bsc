...
contract token is ERC20 {
    ...
    uint256 public blpFee = 15;
    uint256 public bliquidFee = 20;

    uint256 public slpFee = 15;
    uint256 public sliquidFee = 20;
    
    uint256 public transferFee = 60;

    address public burnAddress = address(0xdead);
    address public liquidAddress = 0xedda6693F9Ee36d3daB8F49ec58ACBbb397121a6;
    ...
    string internal tokenName = "LuckyRabbit";
    string internal tokenSymbol = "LuckyRabbit";
    uint256 constant total  =  8686 * 10**18;
    ...
    function setBuyFee(uint256 _lpFee, uint256 _liquidFee) public onlyOwner {
        blpFee = _lpFee;
        bliquidFee = _liquidFee;
    }

    function setSellFee(uint256 _lpFee, uint256 _liquidFee) public onlyOwner {
        slpFee = _lpFee;
    ...
    function setTradeStart() public onlyOwner {
        require(startTime == 0, "already setted");
    ...
    function _transfer(
        ...
        if(LPCount > swapTokensAtAmount && block.timestamp >= (LPcurrentTime.add(lpIntervalTime))){
            if (
                ...
                swapping = true;
                whichway = 1;              
                swapAndLiquifyV3(LPCount.div(100).mul(99));
                LPcurrentTime = block.timestamp;
                LPCount = 0;
                swapping = false;
            }
