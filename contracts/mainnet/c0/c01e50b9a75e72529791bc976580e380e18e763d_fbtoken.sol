...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xC0407BE8287350c20b900622F6B8A5f85Aa31d6B;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xC0407BE8287350c20b900622F6B8A5f85Aa31d6B),//fund address
    
        address(0xC0407BE8287350c20b900622F6B8A5f85Aa31d6B)//dev address
    ){
