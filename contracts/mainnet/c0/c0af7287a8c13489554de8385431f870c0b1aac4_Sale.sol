...
/**
 * @title DEMOLSPVFT | Landshare Holdings LLC - Landshare Parkview Drive - Series 2
 * @author Stobox Technologies Inc.
 * @dev DEMOLSPVFT BER20 Token | This contract is opt for digital securities management.
 */
...
contract Sale is Ownable {
    ...
    function getLANDPrice() public view returns(uint256) {
       ...
       uint res2 = reserve2*(10**IBEP20(TOKEN).decimals());
       uint256 price_land = res2 / reserve3;
       return price_land;
    }
