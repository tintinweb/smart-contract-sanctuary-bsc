...
contract LShareRewardPool {
    ...
    modifier onlyTreasury() {
        require(treasury == msg.sender || address(this) == msg.sender, "LShareRewardPool: caller is not the treasury");
        _;
    }
    ...
    function safeLShareTransfer(address _to, uint256 _amount) public onlyTreasury {
