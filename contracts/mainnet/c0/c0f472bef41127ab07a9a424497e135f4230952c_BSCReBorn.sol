...
contract BSCReBorn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSCReBorn";
    string private _symbol = "$BSCRB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd9c7e839250E5BB6A9E9dE66fc7449B275ebe0Ce); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xd9c7e839250E5BB6A9E9dE66fc7449B275ebe0Ce); // BuyBack Address
