...
contract Footballstar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Footballstar";
    string private _symbol = "FBS";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0xD95c48a2a22e85F7D846c7D0853A4cc5Bb73A3b1); 
    address payable public BurnedWalletAddress = payable(0xD95c48a2a22e85F7D846c7D0853A4cc5Bb73A3b1); 
