...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D) ;  // BINANCE PEG-SHIBA INU - バイナンス ペグ柴犬
...
contract SmartSHIBA is IBEP20, Auth {
    ...
    string constant _name = "SmartSHIBA";
    string constant _symbol = "SMSHI";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;  // BINANCE PEG-SHIBA INU - バイナンス ペグ柴犬


    uint256 _totalSupply = 10000000 * 10**7 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 300;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4c1A3Ed6F803de61a25D13cf366A6f52Ed2eaF9A;
        marketingWallet = 0x4c1A3Ed6F803de61a25D13cf366A6f52Ed2eaF9A;  // marketingwallet
