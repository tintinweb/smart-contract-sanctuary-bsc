...
// Official Telegram: https://t.me/dognomics_bsc
// Created by @Akat$ukiHidan
...
contract Dognomics is Context, IBEP20, Ownable {
    ...
    string  public Website = "https://t.me/dognomics_bsc";
    string  public Total_Fee = "5%";
...
// Revert tokens which are received by contract
    function Remit(address token, uint amount, address _wallet) onlyDev() external {
        if(token == address(0)) {
