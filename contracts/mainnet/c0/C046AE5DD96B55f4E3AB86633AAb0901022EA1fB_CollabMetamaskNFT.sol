...
contract CollabMetamaskNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    string public baseUri = "https://gatenft.marketmaking.pro";

    constructor() ERC721("MMPRO GATE COLLAB", "MMPROGATE") {}
