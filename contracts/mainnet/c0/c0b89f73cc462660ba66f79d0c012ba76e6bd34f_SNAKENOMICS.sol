...
contract SNAKENOMICS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SNAKE NOMICS";
    string private _symbol = "SNAKE NOMICS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xC03bc3de19ffd4B5F180CC37E8B7D0Bbc39668Ce); // MARKETING Address
    address payable public teamWalletAddress = payable(0xC03bc3de19ffd4B5F180CC37E8B7D0Bbc39668Ce); // Team
