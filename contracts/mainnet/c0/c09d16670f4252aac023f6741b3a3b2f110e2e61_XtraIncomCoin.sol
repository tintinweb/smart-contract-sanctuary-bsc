...
contract XtraIncomCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x951354a57af864C0F6e24E821C7436b8dfbd6616); // Marketing Address
    address payable public charityAddress = payable(0x2Af580A62E83df79d344c4B8794D614Fa31798c3); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external  onlyOwner {
   ...
   function clearStuckBalance(uint256 amountPercentage) external  onlyOwner{
    ...
    function AIRDROPEND(bool _status) public onlyOwner {
        welcome = _status;
    }
