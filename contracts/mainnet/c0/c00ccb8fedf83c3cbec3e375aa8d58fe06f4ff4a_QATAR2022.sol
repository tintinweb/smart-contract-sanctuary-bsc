...
/**
    ...
    As we count down to the start of the global showpiece in Qatar on 20 November, QATAR 2022 Token will be the part of the great NFTs Marketplace in FIFA World Cup history.

    Website   : https://qatar2022bsc.com/

    Telegram  : https://t.me/Qatar2022Portal
*/
...
contract QATAR2022 is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x38492187d93Cd248a60c6F8235c17De9F401DA83);
    address payable public teamWalletAddress = payable(0x34ccD284073323FBb572F4429926AD870A53b3f8);
    ...
    string private _name = "QATAR 2022";
    string private _symbol = "QATAR";
