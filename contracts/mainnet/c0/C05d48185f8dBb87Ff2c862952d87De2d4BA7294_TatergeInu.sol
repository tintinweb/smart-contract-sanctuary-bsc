...
contract TatergeInu is Context, IERC20, Ownable {
    ...
    string private _name = "Taterge Inu";
    string private _symbol = "TATINU";
    ...
    address payable public marketingWallet = payable(0xAD11dd5EC6B3A54E231Fdf5Eb00f02f555183e2d);
    address payable public devWallet = payable(0xAD11dd5EC6B3A54E231Fdf5Eb00f02f555183e2d);
