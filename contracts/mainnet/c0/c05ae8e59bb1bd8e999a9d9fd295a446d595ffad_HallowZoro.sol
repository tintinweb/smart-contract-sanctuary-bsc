...
contract HallowZoro is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Hallow Zoro";
    string private constant _symbol = unicode"HZORO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0x516D234a234CD2d6Ec2A2D5f571D13ce735BEE4E);
    address payable private MarketingWallet = payable(0x3cD5C6BD00Cd51770aD64d317Db81208DDCcB54b);
