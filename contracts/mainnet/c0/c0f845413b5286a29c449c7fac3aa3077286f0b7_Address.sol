...
library Address{
 ...
 contract CST is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xCE4dcb2046024cE6396b00C0659517bcf667237f;
    address public donationWallet = 0xdCf6CF5c179244F9eA34d106DE06443d69b7Ae86;

    string private constant _name = "King Money";
    string private constant _symbol = "KSM";
    ...
    Taxes public taxes = Taxes(0, 90, 9, 0);
