...
contract ElonToken is IBEP20, Auth {
    ...
    string constant _name = unicode"Cat Dick"; //Bitcoin
    string constant _symbol = "CD"; //(BTC/BNB)
    ...
    address public marketingFeeReceiver = 0x636eC58d17af00859322af557E040F29500D50Bb;
    address public devFeeReceiver = 0x636eC58d17af00859322af557E040F29500D50Bb;
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        //total fee cant be bigger then  33%
