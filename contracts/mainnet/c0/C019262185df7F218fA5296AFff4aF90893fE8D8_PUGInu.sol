...
contract PUGInu is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 4000000000 * _decimalFactor; // Supply Token
    ...
    uint256 public maxWalletBalance = 4000000000 * _decimalFactor; // 1% do Supply
    uint256 public maxBuyAmount = 4000000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 4000000000 * _decimalFactor; // 1% do Supply
