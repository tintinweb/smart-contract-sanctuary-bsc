...
/**
 * Week 2022\26\ Happy 4th of July Elon
...
contract Happy4thOfJulyElon is IERC20, Ownable
{
    ...
    string _name             = "Happy 4th of July Elon";
    string _symbol           = "H4JELON";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(4).div(1000);
    uint256 largeSwapThreshold = _totalSupply.mul(6).div(1000);
