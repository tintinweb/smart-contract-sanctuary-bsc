...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yasushi Inu"; //
    string private constant _symbol = "YI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x433ac92e9566139f4A1C59b43e2512C44750A578;
