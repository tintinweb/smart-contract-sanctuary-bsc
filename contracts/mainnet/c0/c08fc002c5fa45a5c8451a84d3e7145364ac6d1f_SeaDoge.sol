...
contract SeaDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "SeaDoge";
    string private constant _symbol   = "seaDOGE";
    ...
    uint256 public  _maxTxAmount     = _tTotal * 10 / 10000;
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x8670a42A7D1B25047eD05bc85ab4a96c30b7a4E4;
        _marketingWallet = 0x9a84A2fbda792f4B9279DB6010790c215F27f22a;
