...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaF854AB7d792b214C53D1bef3808f0C034cECe9f; //
...
contract SAFEMOONCEO is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5000000000 * 10**18; //
    string private constant _name = "GOMOONCAT(CEO)"; // 
    string private constant _symbol = "GMC"; //    
    uint8 private constant _decimals = 18; // 
    
    uint256 public _marketingFee = 8; //
    uint256 public _liquidityFee = 8; //
    address payable public  _marketingWallet = payable(0xaF854AB7d792b214C53D1bef3808f0C034cECe9f); //
