...
$BurnAK47 is the newest, truest, and fastest hyper-deflationary, hyper-burning token on the BNB smart chain.
...
contract BurnAk47 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Burn AK47Inu';
    string private constant _symbol = '$BurnAK47';
    ...
    //DevWallets
    address public MarketingWallet=payable(0x72e05fb12eb88F8e3ce490666edf6bb16a4Cf948);
    address public Development=payable(0xfc70E06fe71dFC13Fa01C70BfC86253e44e5943c);
    //TestNet
