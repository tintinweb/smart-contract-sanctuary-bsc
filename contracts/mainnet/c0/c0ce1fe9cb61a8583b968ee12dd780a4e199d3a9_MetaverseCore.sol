...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0169c627C762C065c87dF4312BA0210D4CDc25b6;
...
contract MetaverseCore is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0AEE6bd5d141264A0ec350f70a9C02bEB3EbB43e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 666666666 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MeterverseCore";
    ...
    uint256 public _maxTxAmount = 666666666 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 66666666 * 10**18;
