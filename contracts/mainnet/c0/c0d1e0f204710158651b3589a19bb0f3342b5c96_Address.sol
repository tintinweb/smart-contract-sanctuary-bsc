...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa9F7cdF11734B71F1979CD1f8e02CDc4477C0906;
...
contract BNJTOKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x335C2ebf9f2544D7FBDbdefcAc2df4fa927676F1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BNJTOKEN";
    string private _symbol = "BNJ";
