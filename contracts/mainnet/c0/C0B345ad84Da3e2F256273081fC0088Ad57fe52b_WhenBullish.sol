...
// Telegram : https://t.me/whenbullish
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAa8837DC7e1ecAd4dD2839760718fb4143d529ca;
...
contract WhenBullish is Context, IERC20, Ownable {
    ...
    string private constant _name = "When Bullish"; // 
    string private constant _symbol = "WBULLISH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xC87CDC347d6111AB8d9A92503F258d7fE2eAAD7B);
