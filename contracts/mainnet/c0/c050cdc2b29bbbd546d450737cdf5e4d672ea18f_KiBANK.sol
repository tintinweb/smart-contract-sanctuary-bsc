...
King Blanka (KIBANK) is Token the hero in the game we will launch it in the project at bsc
Nft marketplace platform Planned

Telegram https://t.me/kingblanka
...
contract KiBANK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("King Blanka", "KIBANK") {
        ...
        swapTokensAtAmount = totalSupply * 30 / 10000; // 3% swap wallet
        ...
        marketingWallet = address(0x8A9F5D958E55aaBcBf3cfc42674d07b6a3B87726); // set as marketing wallet
        devWallet = address(0x8A9F5D958E55aaBcBf3cfc42674d07b6a3B87726); // set as dev wallet
