...
/*
    https://t.me/KINGTakedaShingen
    KINGTakedaShingen は、暗号通貨の進化に追いつくためにコミュニティ トークンを作成することを目指しています。
        分散型ミームトークンがスマートチェーンでローンチされました。
...
contract TAKEDASHINGEN is ERC20, Ownable {
    ...
    constructor() ERC20("KING TAKEDASHINGEN", "KTKD") {
        ...
        devWallet = address(0x9db5E40Bbf0FAE418A1d866561394456DCf6A9a1); 
