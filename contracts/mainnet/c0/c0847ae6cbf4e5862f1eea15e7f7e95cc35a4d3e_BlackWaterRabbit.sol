...
contract BlackWaterRabbit is Context, IERC20 { 
    string private _name = "Black Water Rabbit";
    string private _symbol = unicode"BWR";
    ...
    address payable public MarketingWallet = payable(0x2eF01456137E858C44c7bf974eab56396a5108A7);
