...
contract MTM is ERC20, ERC20Detailed, Pausable {
    ...
    constructor()
    ERC20Detailed("Metamorfo", "MTM", 18)
    {
        _isExcluded[msg.sender] = true;
        _mint(owner(),3000000*(10**18));
        lockingContract = 0x5341BF117722FE1186565224914222BCe7Af470D;
        _isExcluded[lockingContract] = true;
        _mint(lockingContract, 7000000*(10**18));
    }
