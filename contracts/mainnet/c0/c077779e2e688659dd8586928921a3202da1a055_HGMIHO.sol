...
contract HGMIHO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Hell Girl Miho ";
    string private _symbol = " $GHMIHO "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B8cBc3f85B4fdD1c944f0e2987C25e88dE112F4); 
    address payable public teamWalletAddress = payable(0x1B8cBc3f85B4fdD1c944f0e2987C25e88dE112F4); 
