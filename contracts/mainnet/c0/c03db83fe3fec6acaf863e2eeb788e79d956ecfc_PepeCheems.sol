...
contract PepeCheems is ERC20, Ownable {
    ...
    address payable private devWallet = payable(0xb184949C38506896969A2f320c8701C507e97E27);
    ...
    constructor() ERC20("PepeCheems", "PEPS") {
        ...
        */
        _createInitialSupply(owner(), 5000000 * (10**18));
    }
