...
contract SQUIDPIZZA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SQUID PIZZA";
    string private _symbol = "SQUID PIZZA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA25832325AeF98Aa340d42Fb6461348dfDA279B5);
    address payable public DevelopmentWalletAddress = payable(0xA25832325AeF98Aa340d42Fb6461348dfDA279B5);
    ...
    uint256 private _totalSupply = 800000 * 10**9;
