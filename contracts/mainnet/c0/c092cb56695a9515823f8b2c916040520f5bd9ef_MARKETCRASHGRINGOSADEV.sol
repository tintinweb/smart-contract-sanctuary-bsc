...
Welcome to our project “Market Crash” 
It was created to provide investors a safe place to buy and join a legit low tax community in the BSC Space.
Due to these hard volatile times. We created this token for people that enjoy community driven tokens. 
Tg will be locked until we reach a certain marketcap. And as we work in the background to provide website and socials.
We as a team will be anonymous for now. We are a safe team and known by many. 

During our Launch Phase we will work on socials, information, and website. 
Community will shill and raid to help create a Based Community. Feel free to help in anyway possible. 
Marketing will come but for us Community comes first. 
So let’s build the community and become the best mooning token while the Market is Crashing.

TG: https://t.me/MarketCrash_BSC
...
/* Token contract */
contract MARKETCRASHGRINGOSADEV is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Market Crash";
