...
contract GenesisDefi is ERC20, Ownable {
    ...
    constructor () ERC20("Genesis Defi", "GenF") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x3a0E3a8aD11D8e2BE0115911066771AEA28ec5C7;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy <= 10, "MarketingFeeOnBuy should be less than or equal to 10");
        marketingFeeOnBuy = _marketingFeeOnBuy;
        emit UpdateBuyFees(marketingFeeOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnSell <= 10, "MarketingFeeOnSell should be less than or equal to 10");
