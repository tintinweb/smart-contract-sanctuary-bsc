...
// Telegram : https://t.me/BlackSantaAIBotDetectorZilla
...
contract BlackSantaBOT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xDefF5D1c24e19251983D1eEb51c09A3Ac8491945); 
    address payable public Wallet_Dev = payable(0xf044EE6c8FF0097a2b921Dbc58836d85f7fd25bA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "BLACK SANTA AI DETECTOR BOT ZILLA"; 
    string private constant _symbol = unicode"blacked"; 
    ...
    constructor () {
        ...
        _owner = 0xf044EE6c8FF0097a2b921Dbc58836d85f7fd25bA;
