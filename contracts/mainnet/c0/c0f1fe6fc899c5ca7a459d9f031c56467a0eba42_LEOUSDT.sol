...
contract Ownable is Context {
    address private _owner = 0x8B81C2Da621e20B3B594C4Fcc6F98819b70e7aEd;
...
contract LEOUSDT is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xc37B0B1ACbD41d6a1ec9B0863996f512BC6B5D28); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "LEOUSDT"; // token name
    ...
    uint256 public _minTokensSwapToAndTransferTo = 9 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(500); // Max number of tokens that an address can hold 5% of total supply
