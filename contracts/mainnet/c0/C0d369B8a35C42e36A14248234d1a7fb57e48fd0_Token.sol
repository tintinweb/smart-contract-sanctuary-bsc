        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x6D3797c7E2c6f2089ce613BF71966e05571938bc), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x0961dc58D81Eb155CC8296e26e7918aFc9bC5Fb6),//FundAddress
        address(0xD8eFD28E54b61744a6FC334640D9a74C38FecB02)//ReceiveAddress
    ){
    }
}