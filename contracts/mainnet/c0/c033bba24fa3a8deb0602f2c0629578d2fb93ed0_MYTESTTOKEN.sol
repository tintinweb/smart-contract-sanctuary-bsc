...
// MYTESTTOKEN IS HERE, MAKE MONEY WHILE SLEEPING, HEALTH IS WEALTH
...
contract MYTESTTOKEN is IBP20, Ownable {
    ...
    uint256 public giveawayFee = 20;
    uint256 public devmarketingFee = 60;
    ...
    uint256 public sellPercent = 500;
    uint256 public sellPeriod = 1 minutes;

    uint256 public antiDumpTax = 100;
    uint256 public antiDumpPeriod = 100 minutes;
    uint256 public antiDumpThreshold = 1000000000;
    bool public antiDumpReserve0 = true;
