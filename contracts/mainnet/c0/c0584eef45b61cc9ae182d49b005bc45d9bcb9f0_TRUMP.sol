...
TRUMP on ETH is mooning!
Can we do better?

Renounced, LP Locked, Tax 5/5, 2% Max Wallet
No TG, No Twitter
...
contract TRUMP is ERC20, Ownable {
    ...
    constructor() ERC20("Donald", "TRUMP") {
    	...
    	marketingWallet = address(0xf9a8cc3e5b771933B36cCCDE59Db59B5D1DB29fc); // set as marketing wallet
    ...
    function setMaxWalletTokend(uint256 _maxToken) external onlyOwner {
  	    require(_maxToken <= totalSupply() * 2 / 100, "Smax token cannot be lower than 1% total supply.");
