...
We start a new life without negativity 
on the side of us all. make the world
better with smart algorithm. Our social
network will support your activities to
interact in cyberspace, more easily and
be on the blockchain network, because 
we know everything will be blockchain
in time. Blockchain enhancements are 
on screen 1 , and are used by all agencies
and companies for their business continuity.
 Even make something that you never imagined before.

Website : https://Menzochain.Live
Channel : https://t.me/Menzochain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51E4B73480A43312E5C4925AFe23D40baad1A728;
...
contract Menzochain is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x51E4B73480A43312E5C4925AFe23D40baad1A728);
    ...
    */
    ...
    string private _name = "MenzoChain"; 
    string private _symbol = "MenzoChain";  
