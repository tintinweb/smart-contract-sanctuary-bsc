...
// Telegram : https://t.me/ratQuestionMark3x
...
contract RAT is Context, IERC20, Ownable {
    ...
    string private _name = "RAT???";
    string private _symbol = "RAT???";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6CbaE31f2927521c5e8c67fd2044863e0BF14BA); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xE6CbaE31f2927521c5e8c67fd2044863e0BF14BA); // buyback Address
    ...
    uint256 public _maxTxAmount = 400000000000 * 10**9; // 2%
