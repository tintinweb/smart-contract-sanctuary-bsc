...
contract FlokiMimics is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address DEAD                                = 0x000000000000000000000000000000000000dEaD;
    address ZERO                                = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver         = 0x9606B681317bc392671268fC8477E7d6e3A806Df;

    string  _name                               = "FlokiMimics";
    string  _symbol                             = "BULL4";
