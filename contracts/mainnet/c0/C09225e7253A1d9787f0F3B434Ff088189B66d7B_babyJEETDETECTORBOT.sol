...
contract babyJEETDETECTORBOT is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 25000000 * (10**9);
    ...
    address payable public MarketingWallet = payable(0x962f814c73908b37678a622B50dE7818E63c174C);
    address payable private devWallet = payable(0x4A3137a8309bc180c9d92f80926040aA33F6aaeD);
    ...
    constructor() ERC20("Baby Jeet Detector Bot", "bJDB") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Baby Jeet Detector Bot: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Baby Jeet Detector Bot: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Baby Jeet Detector Bot: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Baby Jeet Detector Bot: Automated market maker pair is already set to that value");
