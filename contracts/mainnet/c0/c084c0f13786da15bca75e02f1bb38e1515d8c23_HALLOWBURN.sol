...
// ██║░╚██╗██║░░██║░░░██║░░░██║░░░░░░░░██║░░░╚█████╔╝  ░░░██║░░░███████╗██║░░██║██║░╚═╝░██║
// ╚═╝░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░░░░░░░╚═╝░░░░╚════╝░  ░░░╚═╝░░░╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚═╝
// TG FOR HALLOWBURN : t.me/hallowburn_bsc
// DEVS CHANNEL: t.me/kryptolaunchs
// WEBSITE: hallowburn.com
*/
...
contract HALLOWBURN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HALLOWBURNDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HALLOWBURN", "HBURN") {
        marketingWallet = payable(0xE1045f5fA97f94a7849982B22D605487080C637F);
        devWallet = payable(0xD51f07862dF1F0fd176c3C7f523Ed20bfBfAeCf8);
        ...
        dividendTracker = new HALLOWBURNDividendTracker(
            payable(this),
            router,
...
contract HALLOWBURNDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HALLOWBURN public HALLOWBURNContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HALLOWBURNContract = HALLOWBURN(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HALLOWBURN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HALLOWBURN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HALLOWBURN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HALLOWBURNContract);

            uint256 prevBalance = HALLOWBURNContract.balanceOf(address(this));
            ...
            {
                uint256 received = HALLOWBURNContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HALLOWBURNContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
