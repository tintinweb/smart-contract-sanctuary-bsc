...
contract SPHINXCATTOKEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SPHINXCAT TOKEN", "SPHINXCATTOKEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SPHINXCATTOKEN";
    string private _symbol = "SPHINXCATTOKEN";
