...
library SafeMath {
 ...
 contract FlokiSanta is IERC20, Ownable {
    ...
    uint256 public _totalBuyFee = 4;
    uint256 public _totalSellFee = 4;
    ...
    constructor (
        ...
        //改钱包
        MarketingAddress = 0x33450babB8ab8fB9261b31fa9b2AAE8E46aEED25;
        RepoAddress = 0xC3850c30239ac3Bb95FD4aaF4FBc682e0C6aa1f0;
        ...
        _totalBuyFee = _buyMarketingFee.add(_buyRepoFee);
        _totalSellFee =_sellMarketingFee.add(_sellRepoFee);
    ...
    function swapTokenForETH(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 MarketingAmount = balance.div(2);
        payable(MarketingAddress).transfer(MarketingAmount);

        uint256 repoAmount = balance.sub(MarketingAmount);
    ...
    function setBuyFee(uint256 buyMarketingFee,uint256 buyRepoFee) external onlyOwner {
        _buyMarketingFee=buyMarketingFee;
        _buyRepoFee=buyRepoFee;
        _totalBuyFee = _buyMarketingFee.add(_buyRepoFee);
    }

    function setSellFee(uint256 sellMarketingFee,uint256 sellRepoFee) external onlyOwner {
