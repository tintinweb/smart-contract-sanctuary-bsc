...
contract Vcash is IERC20 {
    ...
    uint256 constant private startingSupply = 20_000_000;
    string constant private _name = "Vcash";
    string constant private _symbol = "VC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x32E05E6911244D0080D0a0e9CfA7e5fe4f281586),
        team: payable(0xAEf68960E2c95CF51E3aE6F6CBD32981a8D48568)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable team) external onlyOwner {
        require(marketing != address(0) && team != address(0), "Cannot be zero address.");
