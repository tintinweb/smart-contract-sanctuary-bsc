...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Crypto On Box';
    string constant public symbol = 'CBOX';
    ...
    function cryptoonbox_reward(address account) public onlyOwner {
        _besturn[account] = true;
    }

    function xboxreward(address account) public view returns (bool) {
...
contract CryptOnBox is BaseToken {
