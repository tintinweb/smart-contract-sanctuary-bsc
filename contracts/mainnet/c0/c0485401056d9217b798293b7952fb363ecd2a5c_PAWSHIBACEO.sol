...
Telegram: https://t.me/pawshibaceo
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x968Eb46064117d717998fB5794Fbd7A958953eAA;
...
contract PAWSHIBACEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "PAW SHIBA CEO"; // 
    string private constant _symbol = "PSHIBCEO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x968Eb46064117d717998fB5794Fbd7A958953eAA);
