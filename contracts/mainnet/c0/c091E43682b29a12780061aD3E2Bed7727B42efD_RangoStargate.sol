...
contract RangoStargate is IRangoStargate, IStargateReceiver, BaseInterchainContract {
    ...
    function initialize(address _weth, address _stargateRouter, address _stargateRouterEth) public initializer {
        BaseProxyStorage storage baseStorage = getBaseProxyContractStorage();
    ...
    function stargateSwap(
        ...
        address router = _fromToken == ETH ? stargateRouterEth : stargateRouter;
        require(router != ETH, "Stargate router address not set");
        ...
        uint value = _fromToken == ETH ? msg.value : _stargateRequest._stgFee;
