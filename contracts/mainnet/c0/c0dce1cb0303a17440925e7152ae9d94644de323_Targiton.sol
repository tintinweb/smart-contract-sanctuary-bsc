...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32B6bC7B29D29Bc602CEfb55B0DaAe884F0fd09b;
...
contract Targiton is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcCBDC220D17e75517003E7C20B83269D628f0601;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Targiton";
    string private _symbol = "TARG";
