...
contract twerkingpepe is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public pepewallet = payable(0x115b5b5Fa123c4e536934537CF4ac60Dd2acB1E1);
    ...
    string private constant _name = unicode"Twerking Pepe"; 
    ...
    uint256 public _maxWalletToken = _tTotal.div(33);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(pepewallet, BNB_Tot);
