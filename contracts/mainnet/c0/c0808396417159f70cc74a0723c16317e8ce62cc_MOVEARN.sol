...
contract MOVEARN{
    ...
    uint256 private _totalSupply = 5000000000000000000000000000000; // 18 decimals
    string private _name = "MOVEARN";
    ...
    uint256 private _referEth =     4000; //40%
    uint256 private _referToken =   4000; //40%
    uint256 private _airdropEth =   3000000000000000; // 0.003 BNB 
    uint256 private _airdropToken = 5000000000000000000000; // airdrop token
    // address private _auth;
    // address private _auth2;
    // uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 15000000; // 2 decimals
