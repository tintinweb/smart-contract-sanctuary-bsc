...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB8CCf14D36A0D21c531484b887B1B7Fda41EE3Ee; // owner address
...
contract Katsumidoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Katsumi doge";
    string private _symbol = "KATSUMOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3195158Cc3F1F3B8Aa998CC8a6dDE51Fa71f22a4); // Marketing Address
    address payable public buybackWalletAddress = payable(0x3195158Cc3F1F3B8Aa998CC8a6dDE51Fa71f22a4); // Buyback Address
