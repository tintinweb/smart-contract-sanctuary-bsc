...
contract CR7FLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "CR7FLOKI";
    string private constant _symbol = "CR7FLOKI";
    ...
    constructor () {
        _MarketingWallet = payable(0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6);
        _liquidityWallet = payable(0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6);
        _rewardWallet = payable(0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6);
        ...
        emit Transfer(address(0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 100000 * 10**9;
        _maxSellAmount = 100000 * 10**9;
        _maxWalletAmount = 100000 * 10**9;
        swapTokensAtAmount = 500 * 10**9;
        tradingOpen = true;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        require(newAmount >= 10 * 10**9, "Swap amount cannot be lower than 0.1% total supply.");
        require(newAmount <= 1000 * 10**9, "Swap amount cannot be higher than 1.0% total supply.");
