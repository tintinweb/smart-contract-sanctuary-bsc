...
contract Test_M1{
    ...
    uint256[] public REFERRAL_PERCENTS = [50,30, 20];//10% referal reward
...
//////
    ...
    constructor(address payable wallet) public {
        ...
        plans.push(Plan(0.01 ether, 5 minutes, 1000));
        plans.push(Plan(0.02 ether, 5 minutes, 1000));
        plans.push(Plan(0.03 ether, 5 minutes, 1000));
        plans.push(Plan(0.04 ether, 5 minutes, 1000));
        plans.push(Plan(0.05 ether, 5 minutes, 1000));
        plans.push(Plan(0.06 ether, 5 minutes, 1000));
        plans.push(Plan(0.07 ether, 1, 10));
        plans.push(Plan(0.08 ether, 1, 15));
        plans.push(Plan(0.09 ether, 1, 20));
