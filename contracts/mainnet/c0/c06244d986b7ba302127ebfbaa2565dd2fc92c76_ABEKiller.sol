...
contract ABEKiller is Context, IERC20, Ownable {
    ...
    string private constant _name = "ABEKiller";
    string private constant _symbol = "ABEKiller";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x654545C78F81DFEc51b6B90E1B574001a47E0128);
    address payable private _marketingAddress = payable(0x7139b1624f8B923A4a97a2f6662AE7393067A635);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 0, "Redis cannot be more than 0.");
	    require(redisFeeOnSell < 0, "Redis cannot be more than 0.");
	    require(taxFeeOnBuy < 0, "Tax cannot be more than 0.");
	    require(taxFeeOnSell < 0, "Tax cannot be more than 0.");
