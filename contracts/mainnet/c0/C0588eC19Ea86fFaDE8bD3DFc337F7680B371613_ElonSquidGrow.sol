...
//$ElonSquid Grow is a meme token on the Binance Smart Chain Network that never stops growing through marketing techniques that will be implemented gradually to form a strong Community to grow and grow to be big.
...
contract ElonSquidGrow  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1C281667B6Cc78DB78636f7E4DF44d90Eb547A46); 
    address payable public Wallet_Dev = payable(0x588951F566636790aD91DefdfBA7eA6E90D400Cf);
    ...
    string private constant _name = "ElonSquid Grow"; 
    string private constant _symbol = unicode"ESGROW"; 
    ...
    constructor () {
        ...
        _owner = 0xC0cbd71419E1C8BC68271818799f270740f5A52b;
