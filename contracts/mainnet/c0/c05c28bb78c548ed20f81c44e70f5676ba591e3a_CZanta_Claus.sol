...
contract CZanta_Claus is Context, IBEP20, Ownable {
    ...
    string private constant _name = "CZanta Claus ";
    string private constant _symbol = "CZHA HO HO";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  25000000000  * 10**_decimals;

    uint256 public _maxWalletAmount = 750000000 * 10**_decimals;
    uint256 public _maxTxAmount = 750000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 250000000 * 10**_decimals;
