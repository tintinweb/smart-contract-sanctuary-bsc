...
//owner: 0x2Bdb1A570Cba40908c4500F0511aE598Ae29f637
...
contract RationCash is Context, IBEP20, Ownable {
    address private _ultimateOwner = 0x2Bdb1A570Cba40908c4500F0511aE598Ae29f637;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;

    string private constant _name = "RationCash";
    string private constant _symbol = "RAON";
    ...
    constructor() Ownable(_ultimateOwner) {
        _totalSupply = 126e6 * 10 ** uint256(decimals());
