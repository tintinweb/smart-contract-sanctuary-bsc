...
//Project: XENTHIUMCOIN (XTC)
//Web: https://xenthiumnetwork.com
...
contract XTC is Context, Ownable, IBEP20, BEP20Detailed {
    ...
    address payable public marketingaddress =
        payable(0x36d2C7F3C19517f1f9B2C87DB6b07f161D855d42);
    ...
    constructor() BEP20Detailed("XENTHIUMCOIN", "XTC", 18) {
        _owner = msg.sender;
    ...
    {
        require(
            _numTokensSellToFee >= 1000 * 10**18 &&
                _numTokensSellToFee <= 6000000 * 10**18,
            "Threshold must be set within 1,000 to 1,000,000 tokens"
        );
