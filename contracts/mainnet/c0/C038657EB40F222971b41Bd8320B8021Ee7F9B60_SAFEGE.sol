...
/*      Safege Inu 
            Safege inu is the name of the dog lovers of safemoon and doge coin,
             they gather and form one strong community,
              name is Safege inu

            Telegram : https://t.me/safegeinu
            Webiste : https://safegeinu.com/
*/
...
contract SAFEGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Safege Inu";
    string private _symbol = "SAFEGE";
    uint8 private _decimals = 9;

    address payable private developmentAddress = payable(0xA81Aa985d6381B9784bbBEf0e514A4Ae45Ca1b9C);
    address payable private marketingWalletAddress = payable(0xA81Aa985d6381B9784bbBEf0e514A4Ae45Ca1b9C);
