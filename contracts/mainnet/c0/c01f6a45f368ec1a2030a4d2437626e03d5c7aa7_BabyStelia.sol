...
// Telegram : https://t.me/babysteliafinance
// Twitter : https://twitter.com/SteliaBaby
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  STELIA = IBEP20(0x0019450b0FB021ad2e9f7928101B171272cd537C);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = STELIA.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(STELIA);
        ...
        uint256 amount = STELIA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            STELIA.transfer(shareholder, amount);
...
/* Token contract */
contract BabyStelia is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8842154048e571B2d512D99Ee3AF00d6fFE4aF9f;
    ...
    // Name and symbol
    string constant _name = "Baby Stelia";
    string constant _symbol = "BABYSTELIA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xDf370Ed1C8FBe695e5B891ded5822A11D6605680;
        burnFeeReceiver =0xC7a0238b4B0D23FCdd8d4BFBe807626E4bE44593;
        ...
        isDividendExempt[burnFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        (bool successBurn, /* bytes memory data */) = payable(burnFeeReceiver).call{value: amountBNBBurn, gas: 30000}(""); 
        require(successMarketing, "marketing receiver rejected ETH transfer");
        require(successDev, "dev receiver rejected ETH transfer");
        require(successBurn, "burn receiver rejected ETH transfer");
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _burnFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        reflectionFeeBuy = _reflectionFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        devFeeBuy = _devFeeBuy;
        burnFeeBuy = _burnFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_reflectionFeeBuy).add(_marketingFeeBuy).add(_devFeeBuy).add(_burnFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _burnFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        reflectionFeeSell = _reflectionFeeSell;
        marketingFeeSell = _marketingFeeSell;
        devFeeSell = _devFeeSell;
        burnFeeSell = _burnFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_reflectionFeeSell).add(_marketingFeeSell).add(_devFeeSell).add(_burnFeeSell);
        feeDenominator = _feeDenominator;
    }
