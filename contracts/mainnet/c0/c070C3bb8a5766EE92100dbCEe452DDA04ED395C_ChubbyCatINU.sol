...
//Telegram : https://ChubbyCatInuBSC
// Website : Coming soon
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x45EfDa9029D182D4B1A68A231a7aea842D4984B3;
...
/* Token contract */
contract ChubbyCatINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x45EfDa9029D182D4B1A68A231a7aea842D4984B3;
    ...
    // Name and symbol
    string constant _name = " Chubby Cat Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x182C7f1a24af5f199FF8004d92bCb71B8Fb3f835;
