...
contract StonkyInu is IBEP20, Auth {
    ...
    string constant _name = "Stonky Inu";
    string constant _symbol = "STNKYINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; //4% 
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; //4%
    ...
    address private marketingFeeReceiver = 0xAdf42A9ecC89319E747CD5aBCa8eF6066342e510;
    address private developmentFeeReceiver = 0x266178D7293EB0c979D4faa0174A89Bd7e1F3Cca;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 31;
    bool inSwap;
