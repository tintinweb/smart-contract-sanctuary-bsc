...
contract YiTuoDaBian is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"大便福";
    string private _symbol = "YiTuoDaBian";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x66eCf81C12d5b0548F3E587DA5bCb4979078E0F4);
    ...
    uint256 private _totalSupply = 8888888888 * 10**8 * 10**_decimals;
