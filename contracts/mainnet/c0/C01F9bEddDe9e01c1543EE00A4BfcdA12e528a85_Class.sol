...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C42d1957B1713c5437A9a95d04B1Bb44d103BB3;
...
contract Class is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0C42d1957B1713c5437A9a95d04B1Bb44d103BB3);
    ...
    */
    ...
    string private _name = "Class"; 
    string private _symbol = "Cls";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 10000000000 * 10**4;
    ...
    */
    ...
    // Max wallet holding (7% at launch)
  ...
  IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
    ...
    */
    ...
    Max total fee is limited to 26% (for buy and sell combined)
    Launch fees are set to 10% buy 16% sell
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/700;
    }    
