...
contract BABYcatcher is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYcatcher";
    string private _symbol = "BABYcatcher";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2D56f790d4A842595dCd9F65c724fc7214F5264c);
