...
TG      : https://t.me/FuckingStableCoin
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6CC3a54128A2dBb200D3cAAE404a2Cf9116A0029; // owner address
...
contract FuckingStableCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"fuckingStableCoin";
    string private _symbol = unicode"FSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6CC3a54128A2dBb200D3cAAE404a2Cf9116A0029); // Marketing Address
    address payable public teamWalletAddress = payable(0x6CC3a54128A2dBb200D3cAAE404a2Cf9116A0029); // Team Address
