...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x884bF6C25D8f702282e43eA3B4104Eea8c3a1a54; // 
...
contract SantaFrance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa France";
    string private _symbol = "$SF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x884bF6C25D8f702282e43eA3B4104Eea8c3a1a54); // Marketing Address
    address payable public teamWalletAddress = payable(0x884bF6C25D8f702282e43eA3B4104Eea8c3a1a54); // Team Address
