...
// TG: https://t.me/octagonnetwork
// Website: https://octagonnetwork.tech
...
contract OCTAGON is Context, IERC20, Ownable {
    ...
    string private _name = "OCTAGON NETWORK";
    string private _symbol = "OCTAGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8580f205AeafDF67507446A06191Da803E9E8adc); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xA99d5C3Cf1A8385E475069ff81D77A3F7f848755); // Development Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
