...
contract HAPPYBIRTHDAYTOCHINATOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
    ) payable ERC20("Happy Birthday To China","HBTC")  {
        rewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
        _marketingWalletAddress = payable(0x1f2a00FC4B7A23b1fEf36aB8f87A3717331b7d15);
        _lpWalletAddress=payable(0x6EE01f031B3D029Dcd9ed96489975a1fB21088B7);
        HBTCTracker =0x642B97BCe05bB766f1119A6Ca1F80F9a8318F7DA;
        ...
        IUniswapV2Router02 _uniswapV2Router =IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pro
        ...
        _mint(_lpWalletAddress, totalSupply);
    }
    ...
    function setSellOpen(bool value) public onlyOwner {
        openSell = value;
    }
    function setOpenShare(bool value) public onlyOwner {
        openShare = value;
    }
