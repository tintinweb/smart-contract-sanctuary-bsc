...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76B4D3A9960aB1d691B012417cBDBfb22E00766B; // owner address
...
contract bitcoingold is Context, IERC20, Ownable {
    ...
    string private _symbol = "BTCGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76B4D3A9960aB1d691B012417cBDBfb22E00766B); // Marketing Address
    address payable public teamWalletAddress = payable(0x76B4D3A9960aB1d691B012417cBDBfb22E00766B); // Team Address
