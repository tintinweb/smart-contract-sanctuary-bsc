...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0617e9e0B5059e41D1898E3409500217b301A4D0; // owner address
...
contract SnickersInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snickers Inu";
    string private _symbol = "SNICKERS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0617e9e0B5059e41D1898E3409500217b301A4D0); // Marketing Address
    address payable public teamWalletAddress = payable(0x8c946ACcF9C2b448E5607Fe8892495bC117CA47B); // Team Address
