...
contract LinkDao_SeedSale {
    ...
    constructor(uint ADD_T, BEP20 ADD_T1, address ADD_T2) {
        ...
        token2 = ADD_T2;
        minLimit = 495 * 10**18;
        maxLimit = 10000 * 10**18;
        maxCollectionLimit = 100000 * 10**18;
        buyPrice = 25;
        buyPriceDecimal = 100;
    ...
    function deposit(uint amount) public {
        ...
        claim[sender].claimTimes.push(time + 210 days);
        claim[sender].claimTimes.push(time + 240 days);
        claim[sender].claimTimes.push(time + 270 days);
