...
// Telegram : https://t.me/surge777_bsc
...
contract Surge777 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Surge777";
    string private _symbol = "S777";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA164b97391cf38FD0a068cEd353a1EDfEede0e26); // Marketing Address
    address payable public teamWalletAddress = payable(0xA164b97391cf38FD0a068cEd353a1EDfEede0e26); // Team Address
