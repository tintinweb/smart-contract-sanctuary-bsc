...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        ceoList[0xa95fDf00918B4Cad7c707e7F2aadA95922110Ba6] = true;
...
function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
    ...
    function setBuyFee(
         uint256 fundFee,uint256 buyLPFee,uint256 HoldDividendFee,uint256 burnfee
    ) external onlyOwner {
        _buyFundFee = fundFee;
        _buyLPFee = buyLPFee;
    ...
    function setSellFee(
        uint256 fundFee,uint256 sellLPFee,uint256 HoldDividendFee,uint256 burnfee
    ) external onlyOwner {
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x1A88285cbE6ce5b59F1F80F743Ac703f7506326f)
