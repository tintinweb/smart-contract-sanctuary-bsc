...
abstract contract ContextBEP20AlveyChain {
...
contract OwnableBEP20AlveyChain is ContextBEP20AlveyChain {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEP20AlveyChain: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEP20AlveyChain: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract AlveyChain is ContextBEP20AlveyChain, BEP20AlveyChain, OwnableBEP20AlveyChain {
    ...
    string private _symbol = 'Alvey Chain';
