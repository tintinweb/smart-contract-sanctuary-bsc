 ...
 */
contract REDEFi is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant _tTOTAL = 20000 * 1e6 * 10**_DECIMALS;
     ...
     * construction.
     */
    string private constant _NAME = "REDEFi Token";
    string private constant _SYMBOL = "REDEFi";
    uint8 private constant _DECIMALS = 18;
    
    /**
     * @dev Percentage of the holder's reward fee.
     */        
    ...
    /**
     * @dev Percentage of the marketing shares and wallet
     */   
    uint256 public _marketingFee = 2;
    address public marketingWallet = 0x18E16f6d8F63203591b3C690B055359Ad4E4f247;
     ...
     * Whale actions. 1% (200 million)
     */       
    uint256 public _maxTxAmount = 200 * 1e6 * 10**_DECIMALS;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn address and marketing wallet
        _transferStandard(sender, address(0), burnAmt);
        _rTotal = _rTotal.sub(burnAmt);
    ...
    /**
     * @dev Call this function if required to set a different Marketing 
     * wallet address.
     *
     * Requirements:
     *
     * The marketing wallet cannot be the zero address.
     */
