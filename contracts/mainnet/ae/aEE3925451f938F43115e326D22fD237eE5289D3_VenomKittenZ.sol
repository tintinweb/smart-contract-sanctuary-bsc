 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/VenomKittenZ
 * 
 * 
 * VenomKittenZ token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract VenomKittenZ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Venom Kitten Z";
    string constant _symbol = "VITTENZ";
