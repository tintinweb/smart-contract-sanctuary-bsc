...
contract LITTLESAFEGOAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "LITTLE SAFE GOAT COIN"; // 
    string private constant _symbol = "LTSG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x602e582eb170fea80CB41EAFc96437ADec1A1eA3;
