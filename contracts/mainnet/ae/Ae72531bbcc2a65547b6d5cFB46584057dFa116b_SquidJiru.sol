...
contract SquidJiru is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidJiru";
    string private constant _symbol = "SQUIRU";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 200000 * 10**_decimals;
    uint256 public _maxTxAmount = 6000 * 10**_decimals;
    uint256 public _maxWalletAmount = 6000 * 10**_decimals;
