...
Escaping the Matrix is everywhere in the news nowadays, but what actually is it?
...
That brings us to Matrix.. the first dog to ever escape.

🖥 Tax: 7%

🟩 Website: https://matrixinu.tech/

🖥 Portal: https://t.me/MatrixInuPortal 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8e263c33dE36f5E317f1923a5E1d27E8f55F0613; // owner address
...
contract MatrixInu is Context, IERC20, Ownable {
    ...
    string private _name = "MatrixInu";
    string private _symbol = "MATRIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e263c33dE36f5E317f1923a5E1d27E8f55F0613); // 
    address payable public teamWalletAddress = payable(0x8e263c33dE36f5E317f1923a5E1d27E8f55F0613); // 
