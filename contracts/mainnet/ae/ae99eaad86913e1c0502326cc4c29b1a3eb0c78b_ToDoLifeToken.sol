...
contract ToDoLifeToken is Context, IERC20, Ownable {
    ...
    address private _ToDoLifeInvestmentFund = 0xE9288BF09ff830b3fA82b33453A7e1D9Fe2bA233;
    address private _donationWalletAddress = 0x82c60E6b0D5293447D90857Ef4B537101feC9F83;
    address private _ToDoLifeWinWalletAddress = 0x5e64c1643617256cDe1855DCe868542A7411280A;
    address private _serviceWalletAddress = 0x55Ba0fC9e7Be710623c82Dd1473f1083B382d864;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_ToDoLifeInvestmentFund] = true;
        _isExcludedFromFee[_donationWalletAddress] = true;
        _isExcludedFromFee[_ToDoLifeWinWalletAddress] = true;
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_ToDoLifeInvestmentFund] = _rOwned[_ToDoLifeInvestmentFund].add(rDev);
        if(_isExcluded[_ToDoLifeInvestmentFund])
            _tOwned[_ToDoLifeInvestmentFund] = _tOwned[_ToDoLifeInvestmentFund].add(tDev);
    }
