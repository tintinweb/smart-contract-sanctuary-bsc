...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0cd097Fca2A81e2D9E06EDBACE6D36b9Db7773b;
...
contract DogeSpaghetti is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd54dFE8b1274Df64986AD5D1C20b6f2d3edceA73;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge Spaghetti";
    string private _symbol = "Spage";
