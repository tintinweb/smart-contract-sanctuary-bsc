...
contract dividendcontract is BEP20, Ownable {
    ...
    bool public swapAndLiquifyBACKLBd = false;
    ...
    constructor(
        ...
        _marketingWalletAddress2 = marketingWalletAddr2_;
    ...
    function setMarketing2Wallet(address payable wallet) external onlyOwner{
    ...
    function  mint(address account, uint256 amount) public onlyOwner {
        _mintToken(account,amount * (10**18));
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(RFee > 0) super._transfer(from, _marketingWalletAddress2, RFee);
