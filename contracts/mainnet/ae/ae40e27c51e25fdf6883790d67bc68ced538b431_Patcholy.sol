...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6DFDeedE11Cd673631567C1E5b6F7591C6aEde52;
...
contract Patcholy is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdCFc0504EB3207e89325B1eACC54372786C6173e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Patcholy";
    string private _symbol = "PATY";
