...
contract ScoobyInu is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "Scooby Inu";
    string private constant TOKEN_SYMBOL = "SCOOB";
    ...
    address public rewardPool = 0x56bCd69b7924493F2f8625B49a1d40C19eD73a60;
    ...
    uint256 private swapThreshold = (_tTotal * 10) / 10000;
    uint256 private swapAmount = (_tTotal * 10) / 1000;
...
//===============================================================================================================
    ...
    function replenishRewards( uint256 amount) external onlyOwner {
        require(amount <= _tTotal, "amount cannot be more than supply");
