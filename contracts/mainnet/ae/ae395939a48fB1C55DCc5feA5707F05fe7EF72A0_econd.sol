...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 6912 * 10 ** Decimals;
        maxWalletAmount = 6912 * 10 ** Decimals;
        _tTotal = total;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapAmount = tAmount * swapFee / 500;
            if (swapAmount > 0) {
...
contract econd is AbsToken {
    constructor() AbsToken(
       ...
       18,
        ...
        address(0xCEB3F22C872331826D0b09CBd976Ad76180c34a0),
        address(0xCEB3F22C872331826D0b09CBd976Ad76180c34a0),
