...
contract MINISQUIDGROW is Context, IERC20 {
    ...
    string private constant _name = "Mini SquidGrow";
    string private constant _symbol = unicode"MiniSquidGrow";
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;

    uint256 public _Buy__Fee = 9;
    uint256 public _Sell__Fee = 9;

    uint256 public _MiniSquidGrow_maxWallet = (_tTotal * 6) / 100;
    uint256 private _previousMaxWalletToken = _MiniSquidGrow_maxWallet;

    uint256 public _MiniSquidGrow_maxTx = (_tTotal * 3) / 100;
    uint256 private _previousMaxTxAmount = _MiniSquidGrow_maxTx;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    address payable public __Dev__Wallet =
        payable(0x16a501eb4b0d450CF4735E593180CA8c306D306E);
    ...
    constructor() {
        _owner = 0x16a501eb4b0d450CF4735E593180CA8c306D306E;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                (heldTokens + amount) <= _MiniSquidGrow_maxWallet,
                "Over wallet limit."
            );
        }

        if (from != owner())
            require(amount <= _MiniSquidGrow_maxTx, "Over transaction limit.");
        ...
        if (
            ...
            if (contractTokenBalance > _MiniSquidGrow_maxTx) {
                contractTokenBalance = _MiniSquidGrow_maxTx;
            }
            txCount = 0;
