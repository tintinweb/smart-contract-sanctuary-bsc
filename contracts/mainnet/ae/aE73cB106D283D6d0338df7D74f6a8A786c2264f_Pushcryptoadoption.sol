...
TG      : https://t.me/pushcryptoadoptionbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe4aD84175fB65b5B735174e15Bf75a437D5Ece2d; // owner address
...
contract Pushcryptoadoption is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Push Crypto Adoption";
    string private _symbol = unicode"PCAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe4aD84175fB65b5B735174e15Bf75a437D5Ece2d); // Marketing Address
    address payable public teamWalletAddress = payable(0xe4aD84175fB65b5B735174e15Bf75a437D5Ece2d); // Team Address
