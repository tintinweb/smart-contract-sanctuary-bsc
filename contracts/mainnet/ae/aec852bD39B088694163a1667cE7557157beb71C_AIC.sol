...
contract AIC is Context, IERC20, Ownable {
    ...
    string private _name = "AI Content";
    string private _symbol = "AIC";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x6e46d9a6Abb8296bC9DA2851813752482E4DBE6f); 
    address payable public teamWalletAddress = payable(0x6e46d9a6Abb8296bC9DA2851813752482E4DBE6f); 
