...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1f985F86b15EA523B3010cd4411DC136aa592B17; // owner address
...
contract MoxbitEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Moxbit Ecosystem";
    string private _symbol = unicode"MOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f985F86b15EA523B3010cd4411DC136aa592B17); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f985F86b15EA523B3010cd4411DC136aa592B17); // Team Address
    ...
    uint256 public _maxTxAmount = 900 * 10**_decimals; 
    uint256 public _walletMax = 900 * 10**_decimals;
