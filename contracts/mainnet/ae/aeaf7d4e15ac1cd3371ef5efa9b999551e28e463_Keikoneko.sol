...
contract Keikoneko is Context, IERC20, Ownable {
    ...
    string private _name = "Keikoneko";
    string private _symbol = "Keikoneko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57a2Ee78b8A0D941BF11DDb4458263E3a3BAd440);
    address payable public BuyBackWalletAddress = payable(0x57a2Ee78b8A0D941BF11DDb4458263E3a3BAd440);
