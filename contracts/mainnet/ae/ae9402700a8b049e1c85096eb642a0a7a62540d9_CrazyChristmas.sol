...
contract CrazyChristmas is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xd0e6bbedf15Bd76De06E358053A2262F76192A7e;

    string constant _name = "Crazy Christmas";
    string constant _symbol = "CrazyC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 240 * 10**6 * 10**_decimals;
