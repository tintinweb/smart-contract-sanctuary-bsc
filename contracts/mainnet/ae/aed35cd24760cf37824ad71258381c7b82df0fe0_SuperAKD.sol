...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9700EEE3adA3D024340349E61F6e365b66f6EC17;
...
contract SuperAKD is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0FF9687c72b71f064645C810eB2917c72DeA3849);
    ...
    */
    ...
    string private _name = "SuperAKD"; 
    string private _symbol = "SuperAKD";  
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(2000).div(1000000);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (4% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(1000).div(1000000); 
