...
contract ERC20 is IERC20, Owned {
    ...
    function toggleSale() public onlyOwner{
     ...
     function changeisWhiteList(address holder, bool exempt) external onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(saleEnd){
            require(isWhiteList[recipient], "only transfer to whitelisted recipient");
        }
...
contract XMAStoken is ERC20 {
    ...
    string constant public name = "XMAS";
