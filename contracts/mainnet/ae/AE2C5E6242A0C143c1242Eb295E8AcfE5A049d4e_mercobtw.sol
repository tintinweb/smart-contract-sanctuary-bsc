...
contract mercobtw is Context, IERC20, Ownable {
    ...
    string private constant _name = "Osi Inu";
    string private constant _symbol = "Os INU";
    ...
    function _takeFee(uint256 amount, address from) private returns (uint256) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            transferAmount = _takeFee(amount, from);
        }
