...
contract NewCommunityESG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunityESG";
    string private _symbol = "NCESG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAfFd31865cf883578d2f4425286375e3dAa3Dad2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xAfFd31865cf883578d2f4425286375e3dAa3Dad2); // BuyBack Address
