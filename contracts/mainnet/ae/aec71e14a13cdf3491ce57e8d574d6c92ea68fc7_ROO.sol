...
contract ROO is BEP20, Ownable {
    ...
    constructor() BEP20("ROO", "ROO") {
        _tokenSupply(msg.sender, 1e7 * 10**decimals());
    ...
    function claimBNB(uint256 weiAmount) external onlyOwner {
        payable(owner()).transfer(weiAmount);
    }

    function claimBSC20(address tokenAdd, uint256 amount) external onlyOwner {
