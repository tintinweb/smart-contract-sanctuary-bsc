...
contract contractgalaxybnb is Owned {
    ...
    function invest(address referrer) public payable {
        require(started, "Galaxybnb: not launched");
        
        require(msg.value >= INVEST_MIN_AMOUNT, "Galaxybnb: Deposit value is too small");
        require(msg.value <= INVEST_MAX_AMOUNT, "Galaxybnb: Deposit limit exceeded");
        require(planCurrent < plans.length, "Galaxybnb: Invalid plan");
    ...
    function withdrawreferalsbonus() public {
        ...
        require(referralBonus > 0, "Galaxybnb: User has no referal payments");
        require(contractBalance > referralBonus , "Galaxybnb: No enought balance. Try later");
    ...
    function withdrawdeposit(uint256 index) public {
        ...
        require(amount > 0, "Galaxybnb: No deposit amount");
