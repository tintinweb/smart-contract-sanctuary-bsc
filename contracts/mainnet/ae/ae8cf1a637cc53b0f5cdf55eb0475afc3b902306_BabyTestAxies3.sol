...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public userCurrentRewardToken = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0;
  ...
  function updateDividendUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyTestAxies3: The router already has that address");
  ...
  function swapETHForTokens(
        ...
        bool swapSuccess;
        IERC20 token = IERC20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
...
contract BabyTestAxies3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyTestAxies3DividendTracker public dividendTracker;
    ...
    uint256 public liquidityFee = 7; // This fee must be a TOTAL of LP, Operations Fee AND Buyback fee (Note, Buyback has been disabled)
    ...
    constructor() ERC20("BabyTestAxies3", "BabyTestAxies3", 18) {

        dividendTracker = new BabyTestAxies3DividendTracker();

        liquidityWallet = owner();
        operationsWallet = 0xe7747a365ACc270DC423036eF90C46107eaD6617;
        buyBackWallet = owner();
    ...
    function setWhiteListAMM(address ammAddress, bool isWhiteListed) external onlyOwner {
      require(isContract(ammAddress), "BabyTestAxies3: setWhiteListAMM:: AMM is a wallet, not a contract");
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyTestAxies3: The dividend tracker already has that address");

        BabyTestAxies3DividendTracker newDividendTracker = BabyTestAxies3DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyTestAxies3: The new dividend tracker must be owned by the BabyTestAxies3 token contract");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "BabyTestAxies3: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) external onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyTestAxies3: The liquidity wallet is already this address");
    ...
    function updateOperationsWallet(address newOperationsWallet) external onlyOwner {
        require(newOperationsWallet != operationsWallet, "BabyTestAxies3: The operations wallet is already this address");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "BabyTestAxies3: The buyback wallet is already this address");
    ...
    function updateFees(uint256 bnbRewardPerc, uint256 liquidityPerc, uint256 operationsPerc, uint256 buyBackPerc) external onlyOwner {
        require (operationsPerc.add(buyBackPerc) <= liquidityPerc, "BabyTestAxies3: updateFees:: Liquidity Perc must be equal to or higher than operations and buyback combined.");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyTestAxies3: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyTestAxies3: Cannot update gasForProcessing to same value");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyTestAxies3: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require(!_isIgnoredAddress[to] || !_isIgnoredAddress[from], "BabyTestAxies3: To/from address is ignored");
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        if(liquidityFee > 0){ // dividing by 0 is not fun.
            ...
            if(operationsFee > 0){
                ...
                require(success, "BabyTestAxies3: SwapAndLiquify:: Unable to send BNB to Operations Wallet");
            }
            ...
            if(buyBackFee > 0){
                ...
                require(success, "BabyTestAxies3: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet");
            }
...
contract BabyTestAxies3DividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BabyTestAxies3_Dividend_Tracker", "BabyTestAxies3_Dividend_Tracker", 9) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 100000+ tokens to get divs
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "BabyTestAxies3_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "BabyTestAxies3_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main  contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyTestAxies3_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
