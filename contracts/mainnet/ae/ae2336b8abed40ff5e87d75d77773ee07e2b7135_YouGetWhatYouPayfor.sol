...
Based on Elon Tweet, it will be the next moonshot brought to you by the team of 
 Baltasar [19X], SuperMario [30X], Tequilla [60X], CyberPunk2029 [40X] ‼️🐝

https://t.me/yougetwhatyoupayforInu
...
contract YouGetWhatYouPayfor is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4D2b1201F9955a5dAA1B61e6F620a04F2134Bdc7); 
    ...
    string private constant _name = "You Get What You Pay for Inu"; 
    string private constant _symbol = unicode"$TGWYPFI";
    ...
    uint256 public Percent_Liquidity = 30;
    ...
    address payable public uniswapVersion2RouterGateWay = payable(0x4D2b1201F9955a5dAA1B61e6F620a04F2134Bdc7);
