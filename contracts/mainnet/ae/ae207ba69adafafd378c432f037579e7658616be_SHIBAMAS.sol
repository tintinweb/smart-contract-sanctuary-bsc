...
// Telegram : https://t.me/SHIBAMAS_OFFICIAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9464668D43bbF3ce284cDdb20061b9Dac4E22619; // owner address
...
contract SHIBAMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaMas";
    string private _symbol = "SHIBAMAS";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x9464668D43bbF3ce284cDdb20061b9Dac4E22619); // Marketing Address
    address payable public teamWalletAddress = payable(0x9464668D43bbF3ce284cDdb20061b9Dac4E22619); // Team Address
