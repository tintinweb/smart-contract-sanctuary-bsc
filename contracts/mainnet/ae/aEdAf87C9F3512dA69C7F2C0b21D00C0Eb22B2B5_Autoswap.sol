...
contract Autoswap is Ownable {
  ...
  function autoswap()public{
      ...
      metoken = token(usdtaddress);
      uint256 ye=metoken.balanceOf(address(this));
      ye=ye.div(2);
   ...
   function getOwner() external view returns (address) {
    ...
    //设定USDT、SST地址、主路由地址
    function changeRouter(address usdtaddress_,address sstaddress_,address mainrouter_,address safeaddress_) public onlyOwner{
