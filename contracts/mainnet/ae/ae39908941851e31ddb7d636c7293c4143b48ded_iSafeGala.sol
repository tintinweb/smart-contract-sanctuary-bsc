...
contract iSafeGala is Context, IERC20, Ownable {
    ...
    string private constant _name = "iSafe Gala"; // 
    string private constant _symbol = "$ISAFEGALA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 1;
    address private  _marketingWallet = 0xBF5Ff0ac62ED6a0E30799bF93197bD2B6D66b019;
