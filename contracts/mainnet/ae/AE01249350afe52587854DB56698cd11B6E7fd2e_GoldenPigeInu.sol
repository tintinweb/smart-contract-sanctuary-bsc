...
contract GoldenPigeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Golden Pige Inu";
    string private _symbol = "GOLDENPIGEINU";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x63Ed093f608b50003A785A98e45DF3710fc698E0);
    address payable public teamWalletAddress = payable(0x146c123f007048F6A25B115b2892D301EeCd3161); 
    ...
    uint256 public _walletMax =    800000000 * 10**_decimals;
