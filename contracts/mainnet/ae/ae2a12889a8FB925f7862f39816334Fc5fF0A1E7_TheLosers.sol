...
contract TheLosers is ERC20, Ownable {
    ...
    constructor(address wallet1_)
        payable
        ERC20("The Losers", "LOSERS")
    {
        uint256 totalSupply_ = 1_000_000_000_000;
        buyFee = 6;
        sellFee = 10;

        wallet1 = address(wallet1_);
        autoSwapEnable = true;
    ...
    function claimStuckBNB() external onlyOwner {
        sendBNB(payable(wallet1), address(this).balance);
    }
    ...
    function changewallet1(address _wallet1)
        external
        onlyOwner
    {
        require(_wallet1 != wallet1, "Marketing wallet is already that address");
        wallet1 = _wallet1;
        emit wallet1Changed(wallet1);
    }
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 newBalance = address(this).balance - initialBalance;
        sendBNB(payable(wallet1), newBalance);
    }
