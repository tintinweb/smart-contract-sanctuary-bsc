...
// 
//
// 📱 Telegram:https::https://t.me/WhalesTrust
...
contract WhalesTrust is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Whales Trust", "WhalesTrust") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "WhalesTrust";
    string private _symbol = "WhalesTrust";
