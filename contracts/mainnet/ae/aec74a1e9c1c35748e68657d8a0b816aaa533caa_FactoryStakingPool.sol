...
contract StakePoolBNBForToken is States, Ownable {
    ...
    function setTokens(uint256 _apy, uint256 _earlyUstakeFee, IBEP20 _rewardingToken, address _rewardingTokenWallet, uint256 _lockPeriod, uint256 _maxReward, uint256 _earlyRewardUstakeFee, bool _autoCompund, bool _earlyUstake) public onlyOwner {
        apyTier = _apy;
    ...
    function setData(uint256 _apy, uint256 _days, address _rewardingTokenWallet, uint256 _maxReward, uint256 _earlyRewardUstakeFee, uint256 _earlyUstakeFee) public onlyOwner {
        apyTier = _apy;
        lockPeriod = _days;
        rewardingTokenWallet = _rewardingTokenWallet;
        earlyUstakeFee = _earlyUstakeFee;
...
contract FactoryStakingPool is Ownable{
    ...
    function createBNBForToken(address ownerAddress, uint256 _apy, uint256 _earlyUstakeFee, IBEP20 _rewardingToken, address _rewardingTokenWallet, uint256 _lockPeriod, uint256 _maxReward,  uint256 _earlyRewardUstakeFee, bool _autoCompund, bool _earlyUstake) public onlyOwner returns (address)
    {
        StakePoolBNBForToken toDeploy = new StakePoolBNBForToken();
        toDeploy.setTokens(_apy, _earlyUstakeFee, _rewardingToken, _rewardingTokenWallet, _lockPeriod, _maxReward, _earlyRewardUstakeFee, _autoCompund, _earlyUstake);
