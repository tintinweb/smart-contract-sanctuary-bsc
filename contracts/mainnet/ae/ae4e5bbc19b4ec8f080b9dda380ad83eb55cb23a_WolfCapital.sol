...
contract WolfCapital is Ownable {
    ...
    function updateTeam(address _user, uint256 _amount) private {
        ...
        uint256 amountIndex = team.teamAmount / (requiredTeamAmount[0] * 10 ** busd.decimals());
    ...
    function withdraw(uint256 _index) public {
        ...
        busd.transfer(msg.sender, userStake.amount);
    ...
    function SetTeamName(string memory _name) external {
        ...
        require(msg.sender == team.teamLead, "Not a leader");
        team.teamName = _name;
    }
