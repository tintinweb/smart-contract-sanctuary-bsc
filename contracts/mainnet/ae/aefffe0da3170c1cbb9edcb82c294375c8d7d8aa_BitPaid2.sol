...
contract BitPaid2 {
    string public name = "Bit Paid2";
    string public symbol = "BPT2";
  ...
  //
    ...
    constructor(address _charityAccount,address _developerTeamAccount,address _ownerCommissionAccount) {
        ...
        availableforadmin =7000000000000000000000000000;
   ...
   function setdeveloperTeamCommisionPercnt(uint _developerTeamCommisionPercnt) public onlyAdmin returns (bool){
    ...
    {
         remainingminebale =SafeMath.sub(availableforadmin,expendingminebale);  	     
         require(_amountOfTokens <= remainingminebale,"Limit over"); 
		 
         address payable _customerAddress =payable(msg.sender);
		 require(_amountOfTokens <= allowance[owner][_customerAddress]*10**18,"Not Approved Amount");    		 
        ...
        allowance[owner][msg.sender] -= _amountOfTokens/10**18;
        
         emit Transfer(owner, _customerAddress, _amountOfTokens); 
         return true;
    }
        ...
        returns (bool success)
    {
        ...
        require(TransferControl[msg.sender] ==1,"You are blocked ,Please contact to admin");
