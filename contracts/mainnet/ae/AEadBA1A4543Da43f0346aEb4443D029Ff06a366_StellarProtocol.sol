...
abstract contract DividendFee is Owned, DexBase, ERC20 {
    ...
    address public marketingAddr = address(0x6B08FA489Db21e60599b390200D28940567B8c44);
...
contract StellarProtocol is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 600 * 1e18;

    uint256 badBlock = 9;
    uint256 public launchedAt;
    uint256 public launchedAtTimestamp;

    uint256 public _maxHavAmount = _totalSupply / 600; // 1%
