...
contract PiDaoKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PiDaoKing";
    string private _symbol = "PiDaoKing";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x30358FC21347b099B538c59Ef8e05d94987BB508); 
