...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x2DEeea2105910BCd7B9EB6f8784c2e5d2D9C33a2; // owner address
...
contract Spicyinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpicyINU";
    string private _symbol = "Spicy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2DEeea2105910BCd7B9EB6f8784c2e5d2D9C33a2); // Marketing Address
    address payable public teamWalletAddress = payable(0x2DEeea2105910BCd7B9EB6f8784c2e5d2D9C33a2); // Team Address
