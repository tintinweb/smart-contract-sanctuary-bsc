...
contract CKTOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCeF44CF31aFcCdaECA3Ff061e5518f9A2E438c23); 
    address payable public Wallet_Dev = payable(0xd7059Cc4b82425A2C909047ed1FFea1a3567a452);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1888 * 10**_decimals;
    string private constant _name = "CK"; 
    ...
    constructor () {
        ...
        _owner = 0xd05189B56B55A0E11586953508b0423cdb4F420a;
