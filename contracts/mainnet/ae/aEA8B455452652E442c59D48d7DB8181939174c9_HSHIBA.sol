...
// OFFCIAL CODE HUNTER-SHIBA
// https://t.me/HunterShiba
...
contract HSHIBA is Context, IBEP20, Ownable {
    ...
    string public _name = "Hunter Shiba"; // token name
    string public _symbol = "HSHIBA"; // token ticker
    ...
    uint256 private minTokenToSwap = 1000000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 private maxHoldingAmount = 1000000000 * 1e9;
    uint256 private minBuyLimit = 1000000000 * 1e9;
