...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95Fdce99c83bcb3968fA33946751BFd9feE05A30; // owner address
...
contract DONUTDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6bEc42511C3924c55815C503FF84CBCAebaff84B); // Marketing Address
    address payable public teamWalletAddress = payable(0x6bEc42511C3924c55815C503FF84CBCAebaff84B); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 20000000000000000 * 10**_decimals; 
