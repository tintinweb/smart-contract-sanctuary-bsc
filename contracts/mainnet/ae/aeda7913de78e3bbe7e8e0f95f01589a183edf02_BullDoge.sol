...
contract BullDoge is IBEP20, Ownable {
    ...
    string constant _symbol = unicode"BULLDOGE!!!";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply     = 1000000000000 * 10**_decimals;
    uint256 public _maxTxAmount     = 25000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 25000000000 * 10**_decimals;

    address private deadWallet      = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0x1e0b797E1d74f55Cdf880aA539942245c76F4566;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 2, 2, 1);
    Fees public sellFees    = Fees(1, 5, 1, 1);
