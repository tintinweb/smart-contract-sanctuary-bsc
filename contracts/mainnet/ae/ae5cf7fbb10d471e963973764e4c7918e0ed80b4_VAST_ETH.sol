...
contract VAST_ETH is ReentrancyGuard, INativeVAST {
    
    using SafeMath for uint256;
    using Address for address;

    // token data
    string constant _name = "VAST-Ethereum";
    string constant _symbol = "V-ETH";
    ...
    // Underlying Asset
    address public constant _token = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; //Insert token here//
