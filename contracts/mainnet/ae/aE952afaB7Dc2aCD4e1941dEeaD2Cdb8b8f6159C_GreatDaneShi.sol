...
/**
Great Dane Shi🐕‍ 
👉The English name of the Great Dane Shi is translated from the French name "giant Dane Shi". Also known as the German Mastiff in mainland Germany, it is known as the "Sun God" among dogs. The Great Dane Shi is largest dog in the world. 👈
...
💪 Great Dane Shib will set up a unique anti-war fund, the anti-war fund association will organize to help the oppressed weak and neutral countries.💪
...
contract GreatDaneShi is Context, IERC20, Ownable {
    ...
    string private constant _name = "GreatDaneShi";
    string private constant _symbol = "GreatDaneShi";
