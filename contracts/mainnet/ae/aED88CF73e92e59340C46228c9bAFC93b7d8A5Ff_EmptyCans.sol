...
contract EmptyCans is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8525311b726cF6b2aEef9Ca7c2382AD8b8BA52E0); // Marketing Address
    address payable public teamWalletAddress = payable(0xb7007afffd3a2D845de4A74eB8E967E8eA61e52F); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xb7007afffd3a2D845de4A74eB8E967E8eA61e52F),
            block.timestamp
        );
    }
