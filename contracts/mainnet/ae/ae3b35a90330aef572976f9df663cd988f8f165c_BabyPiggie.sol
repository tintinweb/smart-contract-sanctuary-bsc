...
contract BabyPiggie is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Piggie";
    string private _symbol = "BabyPiggie";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8cbF0Cf2993087a62fab1e735623439B46e1431b); 
    address payable public buyBackWalletAddress = payable(0x8cbF0Cf2993087a62fab1e735623439B46e1431b); 
