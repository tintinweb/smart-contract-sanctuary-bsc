...
contract PrideMonth is Ownership {
    using SafeMath for uint256;

    string _name = "PrideMonth";
    string _symbol = "PrideMonth";
    uint8 _decimals = 9;
    ...
    function changeSwapPrideMonth(uint8 fee) external onlyOwner {
        _swapTokensFee = fee;
    }

    function changePrideMonthFee(uint8 liquidityFee) external onlyOwner {
        _liquidityFee = liquidityFee;
    }
   
    function changePrideMonthMarke(uint8 marketingFee) external onlyOwner {
