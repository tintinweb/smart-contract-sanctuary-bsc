...
contract newtoken is Context, IERC20, Ownable {
    ...
    string private _name = "AnaDeCoin";
    ...
    function changeAutomated(address pair, bool value) external onlyOwner {
    ...
    function changeDistribution(
        ...
        uLiquidityShare = newLiquidityShare;
        uMarketingShare = newMarketingShare;
        uTeamShare = newTeamShare;
    }
    ...
    function feeMultiplied() public view returns (uint256) {
        uint256 remainingTime = multiplierTriggeredAt + multiplierLength - uLiquidityShare;
        uint256 feeIncrease = uLiquidityShare * multiplierNumerator / multiplierDenominator;
        return uLiquidityShare + feeIncrease * remainingTime / multiplierLength;
    }
