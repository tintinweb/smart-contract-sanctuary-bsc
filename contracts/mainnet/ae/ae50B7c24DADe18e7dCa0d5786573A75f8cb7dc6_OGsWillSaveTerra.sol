...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public RWRD = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
/* Token contract */
contract OGsWillSaveTerra is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Baby Terra";
    string constant _symbol = "BABY LUNA";
    ...
    uint256 public _maxWalletToken = (_totalSupply * 200) / 10000; // 2% or 2ok tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xB38636646de576e495c04975c55aCB4a4527A647;
