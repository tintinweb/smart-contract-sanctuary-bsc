...
// TELEGRAM : https://t.me/babydogeking_BSC
...
contract BABYDOGEKING is Context, IERC20, Ownable {
    ...
    string private _symbol = "BDKING";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x983aee98d52E911E612B03eF81E763aFba26834A); // Marketing Address
    address payable public teamWalletAddress = payable(0x983aee98d52E911E612B03eF81E763aFba26834A); // Team Address
