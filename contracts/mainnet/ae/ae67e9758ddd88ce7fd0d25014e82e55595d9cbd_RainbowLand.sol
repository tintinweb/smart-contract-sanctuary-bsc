...
contract RainbowLand is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RainbowLand";
    string private _symbol = "RainbowLand";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 4;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x54667E0080fEBcd65472b26dA580dd07E4A42300); // Marketing Address
    address payable public teamWalletAddress = payable(0x54667E0080fEBcd65472b26dA580dd07E4A42300); // Team Address
    address payable public liquidityAddress = payable(0x54667E0080fEBcd65472b26dA580dd07E4A42300); // Team Address
    ...
    uint256 private _totalSupply = 6*10**6*10**uint(_decimals);
