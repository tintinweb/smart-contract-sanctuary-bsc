...
contract DECENTRAWORLD20 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = " DecentraWorld 2.0";
    string private _symbol = "$DEWO 2.0";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xd39660fCC3146FaF64D8fD0b40C33E3130950C06;
