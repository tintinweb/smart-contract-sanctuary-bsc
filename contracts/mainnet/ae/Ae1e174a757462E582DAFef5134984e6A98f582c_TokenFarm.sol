...
contract TokenFarm {
    ...
    uint256[5] public Duration = [30 days, 90 days, 180 days, 270 days, 360 days];  // these are locking period of token we can also place  no of seconds here
    uint256[5] public Bonus = [21, 50, 175, 300, 450]; // these four bonus variable is related to duration and the amount will be multiply by 10 like we have to set 10 percent then put 100
    ...
    function getRatio(uint256 val) public view returns (uint256){
        ...
        address TOKEN_WBNB = 0x622209Fb779f9920495e914fd437A40f6cDB010d; // Token_WBNB pancake pool address
    ...
    function withdrawBaseCurrency(uint256 val) public onlyowner {
       
        require(val > 0, "does not have any balance");
