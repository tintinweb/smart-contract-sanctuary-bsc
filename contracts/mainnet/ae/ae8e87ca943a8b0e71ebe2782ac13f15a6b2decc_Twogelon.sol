...
contract Twogelon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twogelon Inu";
    string private _symbol = "TWOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3A16D2918BDE3495493c0448F9eB12bCD255CB5); 
    address payable public BuyBackWalletAddress = payable(0x4FF9c596B036cd68EC2DFb57503719BbfEe75d35); 
