...
contract Owned {
    ...
    constructor()  {
        owner = 0x97F154939Bfb24A2e51831d6fdB61E925a61EF19;
    }
...
contract presaleJKT is IERC20, Owned, SafeMath {
 ...
 constructor() {
        name = "Presale Jinken Token";
        symbol = "pJKT";
        decimals = 18;
        _totalSupply = 10000000000e18;         // 10,000,000,000 pJKT
        address owner = owner;
