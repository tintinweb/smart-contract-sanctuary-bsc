...
// OFFCIAL CODE TARTARUS INU
// https://t.me/TartarusINU
...
contract TARTARUS is Context, IBEP20, Ownable {
    ...
    string public _name = "Tartarus Inu"; // token name
    string public _symbol = "TARTARUS"; // token ticker
