...
//   📱Website ::https://rabbitbone.space/
/*
...
contract RabbitBone is ERC20 {

    uint tokenTotalSupply = 100000; // 100 Million Token Supply

    constructor() public ERC20("RabbitBone", "RabbitBone") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RabbitBone";
    string private _symbol = "RabbitBone";
