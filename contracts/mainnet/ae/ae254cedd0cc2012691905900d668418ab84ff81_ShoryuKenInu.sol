...
Telegram Chat : https://t.me/shoryukeninu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90e8ddaBd3A2985d89d8038E0eC17E1Fa6781edC; // owner address
...
contract ShoryuKenInu is Context, IERC20, Ownable {
    ...
    string private _name = "Shoryuken Inu";
    string private _symbol = "ShoryuKen inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x080ff196C47E83Fe430abe60faaf84b9F0a29b8c); // Marketing Address
    address payable public teamWalletAddress = payable(0x90e8ddaBd3A2985d89d8038E0eC17E1Fa6781edC); // Team Address
