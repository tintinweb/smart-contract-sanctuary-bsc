...
contract Falcon  is StandardToken {
    ...
    string constant public name = "SAITAREALTY";
    string constant public symbol = "SAITAREALTY";
    ...
    function addtoMultiWhiteList(address[] memory receivers) public onlyOwner {
          for (uint256 i = 0; i < receivers.length; i++) {
            whiteList[receivers[i]] = true;
        }
    }
