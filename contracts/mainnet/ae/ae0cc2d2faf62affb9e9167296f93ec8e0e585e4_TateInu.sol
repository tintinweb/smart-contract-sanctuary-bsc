...
contract TateInu is BaseErc20, AntiSniper, Burnable, Taxable, Dividends {
    using SafeMath for uint256;

    constructor () {
        configure(0x7B5C72D408feF66B42B59f5936d7333F1DeBabdF);
        ...
        taxDistributor.createBurnTax("Burn", 50, 50);
        taxDistributor.createWalletTax("Marketing", 500, 500, 0xB8a0ca0F438d70AA1db912025b62Bb38F10f41dc, true);
        taxDistributor.createWalletTax("HTF", 200, 200, 0x2f15F07BD4Ce8F870d3A322E3CdC5933D53Bd5d4, true);
        ...
        _totalSupply = _totalSupply.add(10_000_000 * 10 ** decimals);
