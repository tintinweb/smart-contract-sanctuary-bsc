...
Telegram : https://t.me/atlasnavibsc
*/
...
contract AtlasNaviBsc is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ATLAS NAVI BSC", "AVI") {
        marketingWallet = payable(0xDdBB9b6f97BE5c5F9A63da106d0b021970Ba8AAd);
        devWallet = payable(0xDdBB9b6f97BE5c5F9A63da106d0b021970Ba8AAd);
...
contract XmasXRPDividendTracker is DividendPayingToken, Ownable {
    ...
    AtlasNaviBsc public AtlasNaviBscContract;
    ...
    constructor(
        ...
        defaultToken = token;
        AtlasNaviBscContract = AtlasNaviBsc(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(AtlasNaviBscContract);

            uint256 prevBalance = AtlasNaviBscContract.balanceOf(address(this));
            ...
            {
                uint256 received = AtlasNaviBscContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    AtlasNaviBscContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
