...
contract MWD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini White Doge";
    string private _symbol = "MWD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24eAc9c65C06dC01537e0185bE482896017Cc3bb);
    address payable public teamWalletAddress = payable(0x43317693da141FbfA39916e8866064e558ff4e4B);
