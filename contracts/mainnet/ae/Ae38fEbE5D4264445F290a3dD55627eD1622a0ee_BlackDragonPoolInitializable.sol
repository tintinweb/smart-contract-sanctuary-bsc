...
// File: contracts/BlackDragonPoolInitializable.sol

pragma solidity 0.6.12;

contract BlackDragonPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public BlackDragon_POOL_FACTORY;
    ...
    constructor() public {
        BlackDragon_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == BlackDragon_POOL_FACTORY, "Not factory");
