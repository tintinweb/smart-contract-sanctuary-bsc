...
Safu project, low tax, contract renounced, just degen plays DYOR
LP lock 4 days
If the lock time is short, we will make an announcement for all holders to sell their tokens. We don't want anyone to lose in this project.
*/
...
contract GOTOTHEMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOTO THEMOON"; // 
    string private constant _symbol = "GOTO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xdbF75292f4722234Cd8E478842612B70542f7502;
