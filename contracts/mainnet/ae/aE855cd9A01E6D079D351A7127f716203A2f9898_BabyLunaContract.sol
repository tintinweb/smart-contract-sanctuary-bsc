...
import "../baby/BaseToken.sol";
import "../baby/BABYTOKENDividendTracker.sol";

import "./DesertEagleNormalFees.sol";
//import "./DesertEagleSpecFees.sol";
//import "./DesertEagleOverwriteFees.sol";
//import "./DesertEagleLovingSciFees.sol";
import "./DesertEagleContribute.sol";
//import "./DesertEaglePermitTransfer.sol";

contract BabyLunaContract is
ERC20,
Ownable,
BaseContractPayable,
BaseContractUniswap,
...
BaseErc721Uniswap,
BaseToken,
DesertEagleNormalFees,
    //DesertEagleSpecFees,
    //DesertEagleOverwriteFees,
    //DesertEagleLovingSciFees,
DesertEagleContribute
    //DesertEaglePermitTransfer
{
    ...
    constructor(
        ...
        address[6 + 1 + 1] memory batchAddresses,
        uint256[3 + 1 + 1 + 3 + 3 + 3 + 1 + 1] memory batchUint256s,
        bool[8] memory batchBooleans
        ...
        //        canContributeErc20 = batchBooleans[6];
        canDoContribute = batchBooleans[7];
        contributeAddress = batchAddresses[6];
        contributeErc20Token = batchAddresses[7];

        setNormalFees(batchUint256s[0], batchUint256s[1], batchUint256s[2]);
        ...
        // 0.01%
        swapTokensAtAmount = totalSupply_.mul(1).div(10 ** 4);
        ...
        //        setIsUsePermitTransfer(batchBooleans[5]);
        ...
        //        setPermitTransfer(_marketingWalletAddress, true);
    ...
    function _transfer(
        ...
        uint256 totalFees_ = tokenRewardsFee_ + liquidityFee_ + marketingFee_;
...
contract DesertEagleNormalFees is
Ownable
{
    uint256 public normalTokenRewardFee;
    uint256 public normalLiquidityFee;
    uint256 public normalMarketingFee;
    uint256 public normalTotalFees;

    function setNormalFees(
        uint256 normalTokenRewardFee_,
        uint256 normalLiquidityFee_,
        uint256 normalMarketingFee_)
    public
    onlyOwner
    {
        normalTokenRewardFee = normalTokenRewardFee_;
        normalLiquidityFee = normalLiquidityFee_;
        normalMarketingFee = normalMarketingFee_;

        normalTotalFees = normalTokenRewardFee + normalLiquidityFee + normalMarketingFee;

        require(normalTotalFees <= 100, "Total fee is over 100%");
    }
}
...
abstract contract DesertEagleContribute is
Ownable
{
    ...
    function doContribute(uint256 index, address referrer, uint256 requestErc20Amount) virtual public;

    //    function contributeErc20(uint256 index, address referrer, uint256 requestErc20Amount) virtual public;
