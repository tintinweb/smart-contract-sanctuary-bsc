...
contract EsgChainlinkOracle is PriceOracle {
    ...
    function getPrice(EToken eToken) internal view returns (uint price) {
        ...
        uint decimalDelta = uint(18).sub(uint(eToken.decimals()));
...
contract EToken is ETokenInterface, Exponential, TokenErrorReporter {
    ...
    function _reduceReservesFresh(uint reduceAmount) internal returns (uint) {
        ...
        // doTransferOut reverts if anything goes wrong, since we can't be sure if side effects occurred.
        doTransferOut(0x853CF4DA306B321bFAcA8CEC068Dd4aC6BA29BDE, reduceAmount);

        emit ReservesReduced(0x853CF4DA306B321bFAcA8CEC068Dd4aC6BA29BDE, reduceAmount, totalReservesNew);
