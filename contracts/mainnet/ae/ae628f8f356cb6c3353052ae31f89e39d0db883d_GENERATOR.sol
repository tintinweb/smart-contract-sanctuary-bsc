...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/GeneratorOfficial

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: https://www.generator.cam

𝗧𝗪𝗜𝗧𝗧𝗘𝗥: https://twitter.com/GenerateCrypto

𝙍𝙀𝘾𝙀𝙄𝙑𝙀 $𝘽𝙐𝙎𝘿 𝙍𝙀𝙒𝘼𝙍𝘿𝙎 𝘽𝙔 𝙃𝙊𝙇𝘿𝙄𝙉𝙂 $𝙂𝙀𝙉𝙀𝙍𝘼𝙏𝙊𝙍
...
/* Token contract */
contract GENERATOR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xdE43fF806eeA00529C4413d091385Bcf6fF3Ca12;
    ...
    // Name and symbol
    string constant _name = "Generator";
    string constant _symbol = "GENERATOR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x222eb51722334f8EB80DEFcE6E70d429a675C48e;
