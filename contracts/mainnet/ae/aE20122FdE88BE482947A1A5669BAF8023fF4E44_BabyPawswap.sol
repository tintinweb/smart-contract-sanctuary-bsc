...
/**
https://t.me/babypawswapbsc
Ath 100M in pawswap ethereum network
...
contract BabyPawswap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Baby Pawswap";
    string private _symbol = "Baby Pawswap";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xA5eaB7f50258A8d1eE9eAFe5ef266d8a97b0745b);
    ...
    uint256 private _totalSupply = 69000000 * 10**8 * 10**_decimals;
