...
contract FroggiesGameBank is Ownable, Pausable {
    ...
    function fundAddress(address box, uint amount) public payable onlyOwner whenNotPaused {
        // TODO add event emission
        balances[box] = amount + balances[box];
    }

    function getBalanceAtAddress(address box) public view returns (uint) {
        return balances[box];
    }
