...
// M::::::M               M::::::M      T:::::::::T      D:::::::::::::::DD   
// M::::::M               M::::::M      T:::::::::T      D::::::::::::DDD     
// MMMMMMMM               MMMMMMMM      TTTTTTTTTTT      DDDDDDDDDDDDD       
...
contract IDO is Ownable,Pausable, ReentrancyGuard{
    ...
    constructor(
        ...
        tarifs.push(Tarif(2, 1000000000000000000000));
        tarifs.push(Tarif(102,500000000000000000000));
        tarifs.push(Tarif(497, 300000000000000000000));
        tarifs.push(Tarif(1202, 100000000000000000000));
        tarifs.push(Tarif(9999939,30000000000000000000));
    }
    ...
    function _div(uint256 _refNumber,uint256 _USDT,address _upline,address _FoundationWallet) private {
                uint256 _userAmount = _USDT.mul(_refNumber).div(100);  // Upline 收益            
                uint256 _FoundationWalletAmount = _USDT.mul(50).div(100) - _userAmount; //联盟收益 50% - upline 收益
    ...
    function _divreflow(uint256 _refNumber,uint256 _USDT,address _upline,address _FoundationWallet) private {
                ...
                uint256 _userAmount = _USDT.mul(_rate).div(100);  // Upline 收益            
                uint256 _FoundationWalletAmount = _USDT.mul(50).div(100) - _userAmount; //联盟收益 50% - upline 收益
                IERC20(USDT).transferFrom(msg.sender,address(this),_USDT);
                IERC20(USDT).transfer(_upline,_userAmount);
                IERC20(USDT).transfer(_FoundationWallet,_FoundationWalletAmount);
