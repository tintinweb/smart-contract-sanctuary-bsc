...
//Telegram:https://t.me/AIElon_Bsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEA14A3ecc4EF0129a2f1B1E69F529A48f0170f4D;
...
contract Aielon is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI ELON TOKEN"; // 
    string private constant _symbol = "AI-ELON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xEA14A3ecc4EF0129a2f1B1E69F529A48f0170f4D);
