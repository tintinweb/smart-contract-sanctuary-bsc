...
contract Hrmes is Context, IBEP20, Ownable {
    ...
    // 回流钱包
    address public walletFund = 0xa3AaE7285c892927c1CF37108e695b18eE1877ed;
    // 市场钱包
    address public walletMarket = 0x11bE14AF2638863aD14C9873b5C09598A4dFB19D;
    // 销毁钱包
    ...
    function _transfer(address from, address recipient, uint256 amount) internal {
        ...
        if( canSwap &&
            ...
            if(AmountLiquidityFee > 0){
                try dividendTracker.swapAndLiquify(AmountLiquidityFee) {} catch {}
