...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xaef02249070B3dE8B5eD1D5072C38767dacfac99);
    address payable public teamWalletAddress = payable(0xaef02249070B3dE8B5eD1D5072C38767dacfac99);
    ...
    function setBuy(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlymint() {
        _buyLiquidityFee = newLiquidityTax;
        _buyMarketingFee = newMarketingTax;
        _buyTeamFee = newTeamTax;
    ...
    function setSell(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlymint() {
        _sellLiquidityFee = newLiquidityTax;
        _sellMarketingFee = newMarketingTax;
        _sellTeamFee = newTeamTax;
