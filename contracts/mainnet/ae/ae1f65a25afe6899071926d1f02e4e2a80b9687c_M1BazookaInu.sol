...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x924A4507Fe551E5D8916A33E4A415Ca01efFf321; // owner address
...
contract M1BazookaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "M1 Bazooka Inu ";
    string private _symbol = "$M1B";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x924A4507Fe551E5D8916A33E4A415Ca01efFf321); // Marketing Address
    address payable public teamWalletAddress = payable(0x924A4507Fe551E5D8916A33E4A415Ca01efFf321); // Team Address
