...
contract CrogeshiInu is IBEP20, Auth {
    ...
    string constant _name = "Crogeshi Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 1000;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x014Df69D9B9CE05d8Ad6eEC0b90039f0c4cD437C;
        marketingFeeReceiver = 0x014Df69D9B9CE05d8Ad6eEC0b90039f0c4cD437C;
