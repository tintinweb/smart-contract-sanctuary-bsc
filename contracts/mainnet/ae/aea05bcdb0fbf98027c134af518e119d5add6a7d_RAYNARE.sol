...
contract RAYNARE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RAYNARE";
    string private _symbol = "RAYNARE";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x872Cda1A029aD8cE1c24f3605D392242C19716D7); // Marketing Address SPZ
    address payable private TeamWallet = payable(0xAb388b183F2820E5B740Dd1667bF5f0da7bD5a5b); // Buy Back Address
    ...
    bool private GwBL = true; //Auto gw bl on
    uint256 public endtime = 5; //set the end time
    uint256 private feeTXtime;
    uint256 private GWEI = 9 * 1 gwei; //set the gwei
    ...
    //manage address
    function setBlackAdd(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function EndTime1Min() external onlyOwner{
        endtime = block.timestamp + 60;
    }

    function UpdateGW (uint256 _GW, bool _GWBL) public onlyOwner {
               GWEI = _GW * 1 gwei; 
               GwBL = _GWBL;
    }
}