...
//
//
//   📱Telegram::https://t.me/+NbJGNxetL_E4MDg9
//   📱Website ::https://shibpaw.space/
/*
...
contract ShibPaw is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Shib Paw", "ShibPaw") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ShibPaw";
    string private _symbol = "ShibPaw";
