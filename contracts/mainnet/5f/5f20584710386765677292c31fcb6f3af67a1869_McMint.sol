...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaE8F7a9309D2bd099d271b6d338940155EcC019b;
...
contract McMint is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xaE8F7a9309D2bd099d271b6d338940155EcC019b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "McMint";
    string private _symbol = "$McMint";
