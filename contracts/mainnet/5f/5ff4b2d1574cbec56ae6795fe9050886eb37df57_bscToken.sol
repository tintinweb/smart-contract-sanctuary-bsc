...
contract bscToken {
    ...
    uint256 public minHold = 0;
       ...
       constructor (address _uniswapV2RouterAddr, address _pancakev3Server) {
        ...
        owner = msg.sender;
		whitelist[0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c] = true;
  ...
  /* 
    ...
    function FulfillOrdernumber( Order storage o, uint256 index, uint256 amountiny ) internal  {
      ...
      */
        ...
        function SwapETHForExactTokenFeeOnTransfer(address oct,  uint256 minout) external  payable {

        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();	 
        path[1] = oct;

        try uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{ value: msg.value }(
            minout,
            path,
            msg.sender,
            block.timestamp
    ...
    function swapExactETHForTokensSupportingFeeContract(address oct, address busdandusdt, uint256 minout) external payable  {
