...
contract T1 is Context, IERC20, Ownable {
    ...
    string private _name = "keng king";
    string private _symbol = "kengking";
    ...
    address payable public marketingWalletAddress = payable(0x913d2829717abCE8d0ba996589cD91ae2CF6685F);
    address payable public liquidityWalletAddress = payable(0x913d2829717abCE8d0ba996589cD91ae2CF6685F);
