...
/**
https://t.me/ChristmasDogeOFFICIAL
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9f49eB5258250Ada18EDDE3d3b9CfDce1E3D1973; // owner address
...
contract ChristmasDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas Doge";
    string private _symbol = "XMASDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC2dDb4a5DCcddc4a53436eC3Afe3c5c2Cb668862); // Marketing Address
    address payable public teamWalletAddress = payable(0xC2dDb4a5DCcddc4a53436eC3Afe3c5c2Cb668862); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 16;  // original 12
