...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DZ = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
contract BabyLunaInu is IBEP20, Auth {
    using SafeMath for uint256;

    address DZ = 0x156ab3346823B651294766e23e6Cf87254d68962;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY LUNA INU";
    string constant _symbol = "BLI";
    ...
    constructor () Auth(msg.sender) {
        ...
        devDeployReceiver = 0xb9fe332c333252b57e2265EA292A26C20ba109Fd;
        marketingFeeReceiver = 0xb9fe332c333252b57e2265EA292A26C20ba109Fd;
