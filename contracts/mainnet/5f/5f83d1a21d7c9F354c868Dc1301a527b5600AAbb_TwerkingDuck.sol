...
contract TwerkingDuck is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TwerkingDuck";
    string constant _symbol = "TwerkingDuck";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x6d1583636dD361d24383db6cce294782b4C6bBa3;
