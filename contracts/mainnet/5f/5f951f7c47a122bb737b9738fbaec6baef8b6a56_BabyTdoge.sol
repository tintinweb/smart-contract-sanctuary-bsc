...
contract BabyTdoge is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0xD0632D2931a9C9aFd1284f77f6AA80e416D2Afb0;
    address public receiveSellFeeWallet = 0xD0632D2931a9C9aFd1284f77f6AA80e416D2Afb0;
    IWrap public wrap = IWrap(0xD0632D2931a9C9aFd1284f77f6AA80e416D2Afb0);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Baby TDOGE", "BTDOGE", 8, 10000 * 10 ** 8){
        address msgSender = _msgSender();
