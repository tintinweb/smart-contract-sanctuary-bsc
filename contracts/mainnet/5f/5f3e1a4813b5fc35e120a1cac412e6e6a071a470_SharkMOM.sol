...
SHARKMOM - The Future of DeFi.
Trade and earn. Mom shark holders receive SHARKMOM rewards and share fees; most profitable decentralized platform.
Fair launch!!
Be the first to buy cheap $SharkMOM

SharkMOM Token Contract: Soon
...
(Farms and ponds will be available after token launch)
Trade tokens at the best prices on the Binance blockchain.
https://t.me/Sharkmomchannel
...
contract SharkMOM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shark MOM";
    string private _symbol = "$SHMOM";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x44FC1c7dEc13939AaBC321557C7A9acC7C68Dc80;
    address public developerWallet = 0x44FC1c7dEc13939AaBC321557C7A9acC7C68Dc80;
