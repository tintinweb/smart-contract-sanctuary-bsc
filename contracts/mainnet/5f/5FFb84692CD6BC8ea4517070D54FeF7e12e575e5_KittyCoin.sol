...
contract KittyCoin is Context, IERC20, Ownable {
    ...
    // Adresses
    address payable public marketingWallet = payable(0xB293ae0A5B135082b5180462A9E7954E737FFb90); 
    ...
    // Max wallet and TX
    uint256 public maxTransactionAmount = _tTotal * 100 / 10000;  
