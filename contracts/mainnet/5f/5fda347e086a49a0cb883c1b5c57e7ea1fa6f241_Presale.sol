...
contract Presale is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator) public {
    ...
    PRESALE_SETTINGS = IPresaleSettings(0xd59Ee0F02c7DbB54e0cE2aE49BFD98e8b48050ad);
    PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0x1595886eE03B6294f31D3aB8caB3917dDDb1F352);
    MOON_FORCE_FEE_ADDRESS = 0x13Ccd2fa8af0439492401DE2f0a29180ba03d421;
  }
