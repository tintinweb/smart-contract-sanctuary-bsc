...
contract PIGBURN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6750afdF8B1e21993fcFB965Ad9F856712be04Ba); // Marketing Address
    ...
    string private _name = "PIGBURN";
    string private _symbol = "PIGBURN";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x6750afdF8B1e21993fcFB965Ad9F856712be04Ba);
    }
