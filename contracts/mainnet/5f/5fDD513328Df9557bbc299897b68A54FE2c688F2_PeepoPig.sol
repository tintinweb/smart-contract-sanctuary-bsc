...
contract PeepoPig is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEEPO PIG";
    string private _symbol = "PEEPOPIG";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x7b746AD7E144EC094EC3Baa2E0Ce30F72973aAA5);
