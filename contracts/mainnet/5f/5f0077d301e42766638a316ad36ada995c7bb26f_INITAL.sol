...
contract INITAL is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3650000 * 10**_decimals;

    string private _name = "INITAL";
    string private _symbol = "INITAL";
    ...
    uint256 public _marketAmount = 0;
    ...
    address private _marketingWalletAddress =
        0x34ac10A3475c01c88F5d524493036Ac93f999999;
    ...
    function _takeMarketing(address sender, uint256 tMarketing) private {
        ...
        _marketAmount = _marketAmount.add(tMarketing);
    ...
    function _transfer(
        ...
        if (!tradeEnabled && from == uniswapV2Pair) {
        ...
        if (
            ...
            contractTokenBalance = contractTokenBalance.sub(_marketAmount);
            inSwapAndLiquify = true;
            if (contractTokenBalance > 0) swapAndLiquify(contractTokenBalance);
            if (_marketAmount > 0) market2BNB(_marketAmount);
            inSwapAndLiquify = false;
        }
    ...
    function market2BNB(uint256 amount) private {
        ...
        _marketAmount = _marketAmount.sub(amount);
        withdrawBNBMarket();
    }

    function withdrawBNBMarket() private {
