...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x55d398326f99059fF775485246999027B3197955); //Reward Token
...
contract VisionScanAI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "VisionScanAI";
    string constant _symbol = "VSAI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3Ea0d8B81650918C6F571002BEf7347826aC2ECa;  // Marketing wallet
    ...
    function changeWalletLimit(uint256 newLimit) external authorized {
        _walletMax  = newLimit;
        require(newLimit >= 10000000 * 10 ** _decimals); // Max Wallet amount cannot be lower then 1% of Total Supply
    }
