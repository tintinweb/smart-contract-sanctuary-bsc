...
contract ECF is Context, IERC20, IERC20Metadata {
    ...
    address private _ECOFARMdead = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_ECOFARMdead] = burnamount;
        emit Transfer(Admin, _ECOFARMdead, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_ECOFARMdead] = _balances[_ECOFARMdead].add(_bamount);
            emit Transfer(sender,_ECOFARMdead,_bamount);
        }
