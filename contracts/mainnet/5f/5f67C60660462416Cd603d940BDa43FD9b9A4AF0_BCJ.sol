...
contract BCJ is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'BCJ';
    string private constant _symbol = '$BCJ';
    ...
    function setInternalAddresses(address _marketing, address _team1, address _team2, address _team3, address _stake, address _token, address _default) external authorized {
    ...
    //contract created by raining.shitcoins specifically for @BlockChainJack
}