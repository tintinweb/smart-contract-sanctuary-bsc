...
contract TerraSea is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TerraSea";
    string constant _symbol = "LUNS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xB9aAb5266C1ccD8379F4458fe612706B369F7Eb8 ;
