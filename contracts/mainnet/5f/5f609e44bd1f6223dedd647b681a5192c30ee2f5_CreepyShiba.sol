...
contract CreepyShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CreepyShiba";
    string private _symbol = "CRIBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x450C803741bA40f885f5B320521eCA6bdB854a3B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4976ab4a078C3CdC6B90B268cc2d447982B99535); // BuyBack Address
