...
contract SharksPresaleStake {
    ...
    constructor() {
        ...
        SHARKS = IERC20(0x2eD8ae766fcf20f582011221F7f1d1F736eE44D0);
    }
    ...
    function deposit(uint8 _tarif, address _upline, uint256 amount) external {
        ...
        require(amount >= 5 wei, "Minimum deposit amount is 5 SHARKS");

        SHARKS.safeTransferFrom(msg.sender, address(this), amount);
        ...
        SHARKS.safeTransfer(dev, amount / 10);
    ...
    function withdraw() external {
        ...
        SHARKS.safeTransfer(msg.sender, amount);
    ...
    function invest(address to, uint256 amount) external payable {
      ...
      SHARKS.safeTransferFrom(msg.sender, to, amount);
    }
