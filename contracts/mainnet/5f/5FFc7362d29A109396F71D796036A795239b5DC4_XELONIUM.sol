...
contract XELONIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XELONIUM";
    string private _symbol = "XELO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xebEe4f3f7AD59DaAafF26532C4cFd2bd2e2A2Bc8); 
    address payable public BurnedWalletAddress = payable(0xebEe4f3f7AD59DaAafF26532C4cFd2bd2e2A2Bc8); 
