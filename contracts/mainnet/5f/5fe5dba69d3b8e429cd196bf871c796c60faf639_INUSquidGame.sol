...
contract INUSquidGame is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "INU Squid Game";
    string private _symbol = "INUSG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0D36015197E8F067806BC59c3F87b0AA5997Da0B);
    address payable public teamWalletAddress = payable(0xF0409594B196818D47A2ef2440F1a4c7A82932A0);
