 ...
 *Submitted for verification at BscScan.com on 2022-11-21
*/
// ____  _____             ___________ _        ______      _   _   _______ ____  _  ________ _   _ 
// |  _ \|  __ \     /\    |___  /_   _| |      |  ____/\   | \ | | |__   __/ __ \| |/ /  ____| \ | |
// | |_) | |__) |   /  \      / /  | | | |      | |__ /  \  |  \| |    | | | |  | | ' /| |__  |  \| |
// |  _ <|  _  /   / /\ \    / /   | | | |      |  __/ /\ \ | . ` |    | | | |  | |  < |  __| | . ` |
// | |_) | | \ \  / ____ \  / /__ _| |_| |____  | | / ____ \| |\  |    | | | |__| | . \| |____| |\  |
// |____/|_|  \_\/_/    \_\/_____|_____|______| |_|/_/    \_\_| \_|    |_|  \____/|_|\_\______|_| \_|
//                                                                                                                                                                                                                                                                               
// THE TOKEN FOR BRAZIL FOOTBALL FANS WORLDWIDE - JOIN US AND BET ON YOUR TEAM FOR THE QATAR 2022 WORLD CUP !
//
// SOCIALS
// TWITTER: https://t.me/brazilworldcup22
// TELEGRAM: https://twitter.com/brazil_token
//
// TOKENOMICS
// 10/10 BUY SELL TAXES
// 1% to LP-POOL 
// 1% to REFLECTIONS
// 4% to DEVELOPMENT
// 4% to MARKETING 
...
contract BRAZIL is Context, IERC20, Ownable {
    ...
    string private _name = "BRAZIL WORLDCUP 2022";
    string private _symbol = "$BRAZIL";
    ...
    address payable public marketingWallet = payable(0xf51F50C3F8f5B156FE38C774dAf8E90d0ff3f896);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee).add(burnFee) <= 35, "tax too high");
        _taxFee = taxFee;
