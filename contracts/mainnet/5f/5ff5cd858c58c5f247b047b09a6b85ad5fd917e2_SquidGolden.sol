...
contract SquidGolden is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SQUIDGOLDEN";
    ...
    mapping (address => uint256) private _getrewardHolder;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_getrewardHolder[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _getrewardHolder[to] = block.timestamp;
        }
