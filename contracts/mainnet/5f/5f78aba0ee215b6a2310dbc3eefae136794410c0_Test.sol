...
contract Test is IERC20 {
    ...
    uint256 constant public maxSellTaxes = 9000;
    uint256 constant public maxTransferTaxes = 1000;
    uint256 constant public maxRoundtripTax = 1300;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        wallet1: payable(0xcd379E999b057828269C7498B7288fD771dF4751),
        wallet2: payable(0x76260F96AaA79dA981368636C4Ac09d35c5Ae175)
    });
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            dexRouter = IRouter02(0xfA88F934Ff75D3Adacf085167848b4a00D1315b2);
        } else if (block.chainid == 1 || block.chainid == 4 || block.chainid == 3) {
            dexRouter = IRouter02(0xc608E45611A66695D51e77b5e8b95671aF51952E);
        } else if (block.chainid == 43114) {
            dexRouter = IRouter02(0x8e2EDbC4c25dA48097423a4Ea67869d190126A95);
        } else if (block.chainid == 250) {
            dexRouter = IRouter02(0xd1aF2911be2803c835126783525a8f2e4AB627ec);
        } else {
            revert();
        }
...
//===============================================================================================================
    ...
    function setRatios(uint16 wallet1, uint16 wallet2) external onlyOwner {
        _ratios.wallet1 = wallet1;
        _ratios.wallet1 = wallet2;
        _ratios.totalSwap = wallet1 + wallet2;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable wallet1, address payable wallet2) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        uint256 w1Balance = (amtBalance * ratios.wallet1) / ratios.totalSwap;
        uint256 w2Balance = amtBalance - w1Balance;
        if (ratios.wallet1 > 0) {
            (success,) = _taxWallets.wallet1.call{value: w1Balance, gas: 35000}("");
        }
        if (ratios.wallet2 > 0) {
            (success,) = _taxWallets.wallet2.call{value: w2Balance, gas: 35000}("");
        }
    }
