    ...
    *******     ***** **  ******         **     ***** **    *** *   ***   ***   *   ****    ** * **     **  ***** **   *****     
      ***        ***   ** **                     ***   **    ***     ***   *** *     **      **   **    **   ***   **   ***      
                          ...
                          **                                                    **                     *                         
                           **                                                                         *                          
                                                                                                     *                                                                                                                                                           
    Telegram - https://t.me/CaptainAhabBSC
    Website  - https://captainahab.io
*/


// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/7f6a1666fac8ecff5dd467d0938069bc221ea9e0/token/utils/math/SafeMath.sol
...
contract PreSail is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        */
        ...
        feeExempt[airdropAddress] = true;
        txLimitExempt[airdropAddress] = true;
        feeExempt[taxAddress] = true;
        txLimitExempt[taxAddress] = true;

        /**
            Set default buy/sell tx fees (no tax on transfers)
            - marketing, dev, liqudity, airdrop
        */
        txFees["marketingBuy"] = 1;
        txFees["devBuy"] = 1;
        txFees["liquidityBuy"] = 2;
        txFees["airdropBuy"] = 1;

        txFees["marketingSell"] = 10;
        txFees["devSell"] = 10;
        txFees["liquiditySell"] = 20;
        txFees["airdropSell"] = 10;
        ...
        */
        ...
        address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  // BSC
    ...
    */
    ...
    function setFees(
        ...
        require(_airdropBuy <= 8, "airdrop fee is too high!");
    ...
    */
    function setTaxAddress(address _airdropAddress, address _taxAddress) external onlyOwner {
    ...
    */
    function getTokenPrice(uint _amount) public view returns(uint) {
        ...
        return((_amount.mul(res0)).div(Res1)); // returns how much presail you will get on that eth amount
    }
    ...
    function _transfer(
        ...
        if(hasFees && (to == pair || from == pair)) {
            ...
            TokenFees.forairdrop = amount.mul(airdropFee).mul(100 - taxDiscount).div(10000);

            uint totalFees =
                TokenFees.forMarketing
                .add(TokenFees.forLiquidity)
                .add(TokenFees.forDev)
                .add(TokenFees.forairdrop);

            amount = amount.sub(totalFees);

            _balances[airdropAddress] += TokenFees.forairdrop; // airdrop pool
            emit Transfer(from, airdropAddress, TokenFees.forairdrop);

            _balances[taxAddress] += totalFees.sub(TokenFees.forairdrop); // dev, lp, marketing fees
            emit Transfer(from, taxAddress, totalFees.sub(TokenFees.forairdrop));
        }
