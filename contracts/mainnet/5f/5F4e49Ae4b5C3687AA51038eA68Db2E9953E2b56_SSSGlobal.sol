...
contract SSSGlobal {
    ...
    uint256 private constant royaltyStep = 10 days;
    ...
    uint256[6] private balRecover = [12e22, 35e22, 60e22, 110e22, 510e22, 1100e22];
    ...
    function claimRoyalty() public {
        ...
        require(lastRoyaltyClaimed[msg.sender] + royaltyStep <= block.timestamp, "Can't claim yet");
