...
/** MARIN KITAGAWA HAS COME TO THE BSC BLOCKCHAIN TO GIVE PEOPLE A HAPPY ENDING
    JOIN MARIN KITAGAWA FOR A HAPPY ENDING
    TELEGRAM:
...
contract CRACK is IBEP20, Auth {
    ...
    string constant _name = "MARIN KITAGAWA";
    string constant _symbol = "MAKI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; //8% 
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100; //8%
    ...
    address private marketingFeeReceiver = 0x041569fc7ef0004Ee6fF7402aEaBC05c302bD111;
    address private developmentFeeReceiver = 0x041569fc7ef0004Ee6fF7402aEaBC05c302bD111;
