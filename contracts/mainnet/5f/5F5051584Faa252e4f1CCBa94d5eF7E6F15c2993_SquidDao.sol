...
contract SquidDao is Context, IERC20, Ownable {
    ...
    string private _name = "SquidDao";
    string private _symbol = "SquidDao";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xe0ca308FB800663C07975C0DCFC270aB134B33d6); 
    address payable private teamWalletAddress = payable(0x34Eb9b4C0f71A3811C22D36d035a926daA3F6078); 
