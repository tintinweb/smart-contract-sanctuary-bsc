...
contract SugiwaInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Sugiwa Inu";
    string private _symbol = "SUGI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5A778d5aCF8338F6efF98b1Ed1Dd764a430b6729);
    address payable public liqWalletAddress = payable(0x5A778d5aCF8338F6efF98b1Ed1Dd764a430b6729);
