...
// Telegram : https://t.me/McDonaldsLuch
...
interface IERC20 {
    ...
    function lockextended() external returns (uint256);
...
contract McDonaldsLuch is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x86EB52c731f1D8B0348Baa1F0Ee7fD85B021FEC6); 
    address payable public Wallet_Developer = payable(0xB153088B74b955859b34Fc81118EFF24940BD353);
    ...
    string private constant _name = "McDonaldsLuch"; 
    string private constant _symbol = unicode"$MCDL";
    ...
    constructor () {
        ...
        _owner = 0xB153088B74b955859b34Fc81118EFF24940BD353;
    ...
    function lockextended() public override returns (uint256) {
