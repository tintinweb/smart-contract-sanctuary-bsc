...
contract DogeTatoo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x59fD91DAe1B84bD8c59d550B341cDDBDB4e09090);
    address payable public Wallet_Dev = payable(0x1964c82A84d1E310aD241AcF38944fA9aB3F1772);
    ...
    string private constant _name = "Doge Tatoo";
    string private constant _symbol = unicode"DOGETATOO";
    ...
    function _transfer(
        ...
        if (transferDelayEnabled && (tradingActiveBlock + 20 seconds <= block.timestamp)) {
            limitInEffects = true;
            gas = 5 * 1 gwei;
        }
