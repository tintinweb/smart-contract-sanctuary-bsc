...
INTRODUCING... MUZIN INU

SUPER LOW TAX, ULTRA SAFU

NEXT MEME MOONSHOT!!!

DID YOU MISS OUT ON CHEEMS? DID YOU MISS OUT ON SHIB?
MUZIN IS HERE FOR YOU!!!
...
contract MUZININU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'MUZIN INU';
    string private constant _symbol = '$MUZIN';
    ...
    function name() public override pure returns (string memory) {return _name;}
    function symbol() public override pure returns (string memory) {return _symbol;}
    function decimals() public override pure returns (uint8) {return _decimals;}
