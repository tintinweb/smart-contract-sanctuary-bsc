...
contract YearRabbit2K23 is IERC20, Ownable {
    ...
    string _name = "YearRabbit2K23";
    string _symbol = "$YR20K23";
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalFee < 99, "Fees must be less than 99%");
    }
