...
/**
    BuGe || Stealth Launch
BuGe was born from the Pige and ChangPump Zhaoge concept
BuGe is a combination of Bunny and Doge made for the community
the team will deliver and the community must be solid.

  Telegram: https://t.me/BuGePortal
  Website: TBA
*/
...
contract BuGe is Context, IERC20 { 
    ...
    */
    ...
    Wallet_BuGe: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_BuGe = payable(0xD0c1cd7B3e143006BcdF1A16d9572E63599dF3Ea); 
    address payable public Wallet_LP = payable(0xD0c1cd7B3e143006BcdF1A16d9572E63599dF3Ea);
    address payable public Wallet_Tokens = payable(0xD0c1cd7B3e143006BcdF1A16d9572E63599dF3Ea); 
    ...
    string private constant _name = "BuGe"; 
    ...
    uint256 public Percent_BuGe = 95;
    ...
    uint256 public constant _Tax_On_Buy_MAX = 50; 
    uint256 public constant _Tax_On_Sell_MAX = 50;
    ...
    constructor () {
        ...
        _owner = 0xD0c1cd7B3e143006BcdF1A16d9572E63599dF3Ea;
        ...
        */
        ...
        _isLimitExempt[Wallet_BuGe] = true; 
        ...
        _isExcludedFromFee[Wallet_BuGe] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 BuGe_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((BuGe_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_BuGe = BuGe_Wallet;
    ...
    */
    ...
    //Update the BuGe wallet
    event updatedBuGeWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_BuGe(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedBuGeWallet(Wallet_BuGe,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_BuGe] = false; 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_BuGe != 0){

            // Calculate how many tokens need to be swapped for BNB (BuGe BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_BuGe / 100;
            ...
            uint256 split_M = Percent_BuGe * 100 / (Percent_AutoLP + Percent_BuGe);
            ...
            // Send BNB to BuGe wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_BuGe, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_BuGe != 0){

            // Swap tokens for BNB and send to BuGe Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_BuGe / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_BuGe, BNB_M);
            ...
            // Create the Auto LP if BuGe is 0
