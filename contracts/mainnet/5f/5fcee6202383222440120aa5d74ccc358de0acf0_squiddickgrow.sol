...
library Address{
 ...
 contract  squiddickgrow is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 50000_000 * 10**9;    
    uint256 public maxSellLimit = 50000_000 * 10**9;
    uint256 public maxWalletLimit = 50000_000 * 10**9;
    ...
    string private constant _name = "squid dick grow";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 1, 0);
