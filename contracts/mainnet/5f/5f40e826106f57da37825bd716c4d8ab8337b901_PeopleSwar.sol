...
contract PeopleSwar is ERC20 {
	...
	address payable _fundAddress = payable(address(0xc2f54E0FaB3587A296FDFe4067760a7E8bC08F79));
    ...
    constructor(address tokenOwner) ERC20("peoples war", "peoples war") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(from == uniswapV2Pair){
                ...
                super._transfer(from, address(this), amount.div(100).mul(79999).div(10**4));
                _takeInviterFeeKt(from, amount.div(10**6));//7
    ...
    function _takeInviterFeeKt(
        ...
        for (int160 i = 0; i < 10; i++) {
            ...
            ktNum = ktNum+1;
            super._transfer(sender, _receiveD, amount.div(10));
        }
    }
