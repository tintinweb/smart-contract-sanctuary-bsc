...
contract FoxCoinTwo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5220E8Af4a68e9D6f9e5e7BDFe4284c7315c0f4C); 
    address payable public Wallet_Dev = payable(0x5220E8Af4a68e9D6f9e5e7BDFe4284c7315c0f4C);
    ...
    string private constant _name = "FOXCoin2.0"; 
    string private constant _symbol = unicode"FOXS2"; 
    ...
    constructor () {
        ...
        _owner = 0x5220E8Af4a68e9D6f9e5e7BDFe4284c7315c0f4C;
