...
contract FWS is Ownable, IBEP20 {
    ...
    address private usdt = 0x55d398326f99059fF775485246999027B3197955;
    address public daoAddr = 0xF69845065e3Ab75Dbc6C48ab6B4099B26B613Fa2;
    ...
    uint256 private numTokensSellToAddToLiquidity = 2 * (1e18);
    uint256 public  _feeToLP;
    uint256 public lastProcessedIndex = 1;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint fee;
        if((sender == pair || recipient == pair) && !exemptFee[sender] && !exemptFee[recipient]) { 
    ...
    function setLpDividendFee(uint256 value) external onlyOwner { 
        lpDividendFee = value;
    }
