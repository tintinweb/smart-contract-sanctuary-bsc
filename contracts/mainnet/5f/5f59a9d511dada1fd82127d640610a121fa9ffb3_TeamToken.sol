...
contract TeamToken is Context, IERC20, Ownable {
    ...
    string private _name = "BabyCr7";
    string private _symbol = unicode"BabyCr7";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x0AF2B238172F3763078698038F5AB767C7d2c9BD));
        marketingWallet = payable(address(0x0AF2B238172F3763078698038F5AB767C7d2c9BD));
