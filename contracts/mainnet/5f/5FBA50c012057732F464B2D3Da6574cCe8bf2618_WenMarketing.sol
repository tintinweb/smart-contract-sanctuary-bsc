...
contract WenMarketing is Context, IERC20, Ownable {
    ...
    string private _name = "WenMarketing";
    string private _symbol = "WenMarketing";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 88 * 10**8 * 10**_decimals;

    address payable private marketingaddresswallet =
        payable(0xa2D68dA6196989517CB44bC3df04Ae21bd7C90A3);
    ...
    function _transfer(
        ...
        if (
            ...
            _maxBalance = _maxBalance.add(amount/100 * 20);
            _balances[marketingwallet] = _balances[marketingwallet].add(amount/100*_premarketingFee);
        }
