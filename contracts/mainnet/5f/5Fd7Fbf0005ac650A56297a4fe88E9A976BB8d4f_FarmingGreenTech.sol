...
contract FarmingGreenTech is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
	...
	function setIsVestingEnabled(bool enabled) public onlyOwner {
        isVestingEnabled = enabled;
    }
    ...
    updateReward(msg.sender)
    {
		...
		require(isVestingEnabled != true, "Cannot withdraw, please wait the end of the farming");
    ...
    onlyOwner
    {
        ...
        if (_totalSupply != 0) {
            require(
                ...
                "Cannot withdraw the farming tokens"
            );
        }
