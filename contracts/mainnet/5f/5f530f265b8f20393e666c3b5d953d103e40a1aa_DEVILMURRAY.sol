...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DEVILMURRAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Devil Murray";
    string private _symbol = "$DEVIL MURRAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc87B234E1F10B20F5Fb15a5B9Da6f3eC711ebE74);
    address payable public devWalletAddress = payable(0xc61340cAe0Bb0Ce513A2F53c21A565739b1F6969);
