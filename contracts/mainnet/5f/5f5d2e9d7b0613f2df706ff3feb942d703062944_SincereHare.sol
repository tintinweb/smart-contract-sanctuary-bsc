...
contract SincereHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereHare";
    string private _symbol = "SincereHare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1e3FCbb54D347A3871D58533f60dfB0A44106247);
    address payable public teamWalletAddress = payable(0x1e3FCbb54D347A3871D58533f60dfB0A44106247);
