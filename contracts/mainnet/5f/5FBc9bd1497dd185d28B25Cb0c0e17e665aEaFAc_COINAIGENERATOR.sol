...
contract COINAIGENERATOR is Context, IERC20, Ownable {
    ...
    constructor (string memory userinput_token_symbol,string memory userinput_token_name,address userinput_marketingWallet,uint256 userinput_totalsupply) {
