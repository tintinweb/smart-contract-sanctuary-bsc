...
library Address{
 ...
 contract DESTACKING is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 650 * 10**9;
    ...
    address public marketingWallet = 0xf018437D4a7FD75514cC1E857F5f7a8Bb404A344;
    address public buybackWallet = 0xf018437D4a7FD75514cC1E857F5f7a8Bb404A344;

    string private constant _name = "DESTACKING";
    string private constant _symbol = "DESTACK";
    ...
    Taxes public taxes = Taxes(1, 4, 2, 6);
