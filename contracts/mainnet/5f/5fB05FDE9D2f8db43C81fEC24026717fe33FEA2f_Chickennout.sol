...
contract Chickennout  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc4b2637372F33BD6511F30811743Af0BDBCFb576); 
    address payable public Wallet_Dev = payable(0x3503B5cbe91654E50344900b6d499D604f8A58D1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private _authorized = 0xBa0A3389d1A3C8ceC1C903D46dCEC39f3c67cB08;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**8 * 10**_decimals;
    string private constant _name = "Chickennout"; 
    string private constant _symbol = unicode"CKNOUT"; 
    ...
    constructor () {
        ...
        _owner = 0xBa0A3389d1A3C8ceC1C903D46dCEC39f3c67cB08;
