...
contract CakeMonster is ERC20SnapshotUpgradeableCustom, OwnableUpgradeable {
  ...
  function upgrade(address _vaultManager) public onlyOwner {
    RESERVE = _vaultManager;
  }
