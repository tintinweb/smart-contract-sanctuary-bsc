...
abstract contract Token is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 2500000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x371c6330595849B81eff22ea532C141A63abc43f;//   营销
...
contract CCDDSS is Token {
    constructor() Token(
        ...
        address(0x371c6330595849B81eff22ea532C141A63abc43f),//fund address
    
        address(0x371c6330595849B81eff22ea532C141A63abc43f)//dev address
    ){
