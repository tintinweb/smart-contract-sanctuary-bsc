...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xC1c53b3D30Cfbce8Aa65923708b4d28Db9d2C9dc;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0xC1c53b3D30Cfbce8Aa65923708b4d28Db9d2C9dc),//fund address
    
        address(0xC1c53b3D30Cfbce8Aa65923708b4d28Db9d2C9dc)//dev address
    ){
