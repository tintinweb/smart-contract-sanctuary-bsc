...
contract SantaFlokiDOGE is IBEP20, Auth {
    ...
    string constant _name = "SantaFlokiDoge Protocol";
    string constant _symbol = "SFDP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100000; 
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100000; 
    ...
    address public marketingFeeReceiver = 0x3679b8FF6eC8724a72DA88748Ccb23521603945B;
    address public devFeeReceiver = 0x3b2765e3D20cD56671615Ca522fb43e397864b42;
