...
/**
*/
/** NODESWAP || NODES || Decentralized Excgange on Bsc
Telegram: https://t.me/nodeswap
Website: https://nodeswap.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0D5cf7916D56433DD00f41dc5471e959312C6A9b; // owner address
...
contract NODESWAP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NodeSwap Token";
    string private _symbol = "NODES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0D5cf7916D56433DD00f41dc5471e959312C6A9b); // 
    address payable public teamWalletAddress = payable(0x0D5cf7916D56433DD00f41dc5471e959312C6A9b); // 
