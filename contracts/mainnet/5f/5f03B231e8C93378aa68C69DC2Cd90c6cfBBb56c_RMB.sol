...
contract RMB is Context, IERC20, Ownable {
  ...
  address payable private _buybackWallet = payable(0xd874E44C5df8559Ad9BCB0652fB60F6d89665733);
  address payable private _marketingWallet = payable(0xeb26839ee27E344Dc2e3B4d3A9cc9195e1cC8329);
  ...
  uint256 private _numTokensForSwap = 10000 * 10**_decimals;
