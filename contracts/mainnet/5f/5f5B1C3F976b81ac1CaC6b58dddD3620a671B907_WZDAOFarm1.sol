...
import "./interfaces/ISCFarm.sol";

contract WZDAOFarm1 is Ownable, ReentrancyGuard, ISCFarm {
    ...
    address public immutable wzDaoWhitelist;
        ...
        nonReentrant
    {
        ...
        require(wzDao.balanceOf(user) >= _amount, "Insufficient balance");
        wzDao.safeTransferFrom(user, wzDaoWhitelist, _amount);
        _stake(user, _amount);
    ...
    function withdraw() external updateReward(msg.sender) nonReentrant {
        ...
        wzDao.safeTransferFrom(wzDaoWhitelist, user, amount);
