...
TELEGRAM : https://t.me/denmarkBSC
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD51d25047a501a3a627cA37bb630BAdB8c9304E7; // owner address
...
contract Denmark is Context, IERC20, Ownable {
    ...
    string private _symbol = " $DBU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD51d25047a501a3a627cA37bb630BAdB8c9304E7); // Marketing Address
    address payable public teamWalletAddress = payable(0xD51d25047a501a3a627cA37bb630BAdB8c9304E7); // Team Address
