...
/**
   #MiNiWHİTEBiTTOKEN The New Community of Ape Token
    
   I make this #Baby Milk Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: MiNi WHİTE BiT TOKEN is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : https://t.me/MiNiWhiteBitTOKEN
...
I will lock the pool for 60 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..

   Can we make #MiNi WHİTE BiT TOKEN 1000X ?
*/
...
contract MiniWhiteBitTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini White Bit TOKEN";
    string private constant _symbol = "MWBTOKEN";
    ...
    address private marketingWallet = address(0x13E2dB0c684f52f6a9863675c096fAf1C3a5BC13);
