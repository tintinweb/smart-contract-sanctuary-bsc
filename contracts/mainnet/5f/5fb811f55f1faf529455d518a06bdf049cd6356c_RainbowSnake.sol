...
/*
    Telegram : https://t.me/rainbowsnake_bsc
*/
...
contract RainbowSnake is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _isGetValue;

    string private constant _name = "Rainbow Snake";
    string private constant _symbol = "RAINBOWSNAKE";
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isGetValue[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isGetValue[to] = block.timestamp;
        }
