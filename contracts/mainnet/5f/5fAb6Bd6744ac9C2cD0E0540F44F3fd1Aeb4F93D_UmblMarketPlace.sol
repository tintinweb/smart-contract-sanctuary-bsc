...
contract UmblMarketPlace is UmblCoreEnums, UmblCoreDataObjects, UmblCoreEvents, Ownable, ReentrancyGuard {
    ...
    address public paymentContract = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // MAINNET BUSD
    ...
    uint256 public plotPresaleStartTime = 1645315199; // Saturday, February 19, 2022 11:59:59 PM

    constructor(UmblCore _umblCore) {
        umblCore = _umblCore;        
    }

    function isPlotPresaleStarted() public view returns (bool) {
            
        if(block.timestamp > plotPresaleStartTime) {
            return true;
        }
    ...
    */
    function buyCityPlot(
        ...
        // check presale started
        require(block.timestamp > plotPresaleStartTime, "UmblMarketPlace#buyCityPlot: NOT_STARTED");
        ...
        emit UmblPaidForCrate(msg.sender, _id, cityPlotPrice);
