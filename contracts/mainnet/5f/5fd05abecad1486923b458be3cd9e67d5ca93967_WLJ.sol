...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress){
        ...
        _balances[address(0xE837e5A7cd9f62e09159303B902CB82278a3aaF1)] = _tTotal;
        emit Transfer(address(0), address(0xE837e5A7cd9f62e09159303B902CB82278a3aaF1), _tTotal);
...
contract WLJ is AbsToken {
    constructor() AbsToken(
        ...
        address(0xA703C6F599e9D7b60d3eC3e667696F8E89b8D0C7)
    ){
