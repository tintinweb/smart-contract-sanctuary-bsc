...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x583c82045F5a80a3414fc0884261665eD73473e4; // owner address
...
contract SocialOfBitcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Social Of Bitcoin";
    string private _symbol = unicode"SOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x583c82045F5a80a3414fc0884261665eD73473e4); // Marketing Address
    address payable public teamWalletAddress = payable(0x583c82045F5a80a3414fc0884261665eD73473e4); // Team Address
