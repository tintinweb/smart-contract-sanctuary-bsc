...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92Cb83913996D42eb1A8100D3b1D7ae517C00df9; // owner address
...
contract AXEREUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AXEREUM";
    string private _symbol = "AXR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92Cb83913996D42eb1A8100D3b1D7ae517C00df9); // Marketing Address
    address payable public teamWalletAddress = payable(0x92Cb83913996D42eb1A8100D3b1D7ae517C00df9); // Team Address
    ...
    uint256 public _liquidityShare = 8; // original 8
