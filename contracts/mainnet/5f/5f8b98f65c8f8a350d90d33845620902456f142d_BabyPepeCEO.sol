...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public PepeCEO =
        IERC20Extended(0x33678c7B2a58480Ef599Ce73AD0D002dC6b6f7Dc);
    ...
    uint256 public minDistribution = 1 * (10**PepeCEO.decimals());
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PepeCEO.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(PepeCEO);

        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: msg.value
        }(0, path, address(this), block.timestamp);

        uint256 amount = PepeCEO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            PepeCEO.transfer(shareholder, amount);
...
// main contract
contract BabyPepeCEO is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Baby PepeCEO";
    string private constant _symbol = "$BPEO";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * 10**_decimals;

    address public PepeCEO = 0x33678c7B2a58480Ef599Ce73AD0D002dC6b6f7Dc;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0xc880534ad1f7FF81372DE6B2AACC99016F329C4a;
