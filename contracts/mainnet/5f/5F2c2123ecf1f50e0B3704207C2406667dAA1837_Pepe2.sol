...
contract Pepe2 is IBEP20, Auth {
    ...
    address private devFeeReceiver       = 0x065702caCB84872aC3c4797884DCCf5d279437C1; 
    address private marketingFeeReceiver = 0x065702caCB84872aC3c4797884DCCf5d279437C1;
    address public autoLiquidityReceiver;

    string constant _name               = "Pepe2";
    string constant _symbol             = "Pepe2";
    uint8 constant _decimals            = 9;

    uint256 _totalSupply                = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount         = _totalSupply.mul(40).div(100);
    uint256 public _maxWalletToken      = _totalSupply.mul(40).div(100);
