...
contract HappyAnimalTreat is Tokenlock {
    /// @notice BEP-20 token name for this token
    string public constant name = "Happy Animal Treat";
    ...
    uint public constant totalSupply = 500000000e18; // 500 million $HAT
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) public validLock {
        ...
        require(now <= expiry, "$HAT::delegateBySig: signature expired");
