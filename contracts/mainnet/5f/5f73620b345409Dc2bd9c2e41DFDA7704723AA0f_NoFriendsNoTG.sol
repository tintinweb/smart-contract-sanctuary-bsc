...
Lets see if someone can even actually dyor and see this words, give bsc a new hope!
Its a concept, will extend LP or even burn if the vibe catchs on.
In case there is money in the marketing wallet it will be used towards the LP and ads!
Spread the word, you never know what could be the next thing.
...
contract NoFriendsNoTG is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'NoFriendsNoTG';   // Name
	string constant _symbol = 'NFNTG';    // Symbol
    ...
    constructor ( address _dexRouter ){
        ...
        autoLiquidityReceiver = 0xFB96CbecCc53Dfcc5F7989d114196A347BB7a8fF;
        marketingFeeReceiver = 0xFB96CbecCc53Dfcc5F7989d114196A347BB7a8fF;
