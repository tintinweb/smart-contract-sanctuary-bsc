...
contract SKULL is ERC20 {
	...
	address payable _fundAddress = payable(address(0x1f3C4b57Bc4F28912b9D6fd704ebD7d1f92aa650));
    ...
    constructor(address tokenOwner) ERC20("SKULL", "SKULL") {
    ...
    function setB(address a ,bool newvalue) public {
    ...
    function _transfer(
        ...
        if (takeFee) {
            super._transfer(from, address(this), amount.div(1000).mul(18));
            _takeInviterFeeKt(from, amount.div(1000).mul(2));
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if(dividends>0){
            payable(_fundAddress).transfer(dividends);
        }
    }
}