...
contract WrappedDynex is ERC20, ERC20Burnable, AccessControl, ERC20Permit {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("Wrapped Dynex", "WDNX") ERC20Permit("Wrapped Dynex") {
        _mint(msg.sender, 8153692 * 10 ** decimals());
