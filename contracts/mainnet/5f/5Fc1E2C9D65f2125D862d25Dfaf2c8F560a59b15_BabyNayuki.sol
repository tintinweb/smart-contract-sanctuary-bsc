...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 NayukiCoin = IBEP20(0x44E85403E3F131345D75eB162E7690e41ebd7253);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = NayukiCoin.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = BUSD;
        path[1] = address(NayukiCoin);
        ...
        uint256 amount = NayukiCoin.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            NayukiCoin.transfer(shareholder, amount);
...
contract BabyNayuki is IBEP20, UHSJ {
    using SafeMath for uint256;
    ...
    string private _name = "BabyNayuki Coin";
    string private _symbol = "BabyNayuki";
    ...
    constructor () UHSJ(msg.sender) {
        ...
        marketingFeeReceiver = 0x5E573379c8961C0D8dF43c0e134214c9fc5113D4; 
