...
contract SonofTeddy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Son of Teddy";
    string private constant _symbol = "T-$on";
    ...
    address private marketingWallet = address(0x848425953D2c990b3fFED28fA6d5C1D6E526F3Dd);
