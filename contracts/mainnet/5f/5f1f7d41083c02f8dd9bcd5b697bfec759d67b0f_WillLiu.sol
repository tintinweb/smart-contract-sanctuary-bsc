...
contract WillLiu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Will Liu";
    string private _symbol = "liu";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xb1687d1544d7D5a80dC4d9eAD0875EcF8D355836);
    address payable public teamWalletAddress = payable(0xb1687d1544d7D5a80dC4d9eAD0875EcF8D355836);
