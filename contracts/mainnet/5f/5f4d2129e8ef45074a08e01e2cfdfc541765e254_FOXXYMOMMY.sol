...
/**
 🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥
THAT LOW LP HARD HITTING MOONSHOT YOU BEEN LOOKING FOR!

Tokenomics:

https://t.me/FoxxyMommyPortal
...
contract FOXXYMOMMY is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FOXXYMOMMY';
    string private constant _symbol = '$FMOM';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;//equals 2000000 token
    ...
    address public Marketing=payable(0x2891c481ff8b84029d8Cb7036b0B5F7654fd38E5);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing;
    }
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*4)/4);
    } 
