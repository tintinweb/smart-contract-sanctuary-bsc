...
🐱 GreenCat2.0 IS THE NEWEST TOKEN ON THE BSC NETWORK

Let's build a new and stronger community.
The community which has the potential for 100X. 

❇️REWARDS ❇️
2% $BUSD for the holders

❇️LIQUIDITY ❇️
2% for Rising Price Floor

💹MARKETING 💹
4% Funds for Continuous Growth
...
Telegram : https://t.me/GreenCatTwo
*/
...
contract GreenCat2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreenCat2.0";
    string constant _symbol = "GREENCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xab1e592B8BfA613841824Ba0370a19b2110bcEAf;
        devFeeReceiver = 0xab1e592B8BfA613841824Ba0370a19b2110bcEAf;
