...
abstract contract ContextYuanCNBep20 {
...
contract OwnableYuanCNBep20 is ContextYuanCNBep20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableYuanCNBep20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableYuanCNBep20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DigitalYuanTokenFanClub is ContextYuanCNBep20, YuanCNBep20, OwnableYuanCNBep20 {
    ...
    string private _name = 'Digital Yuan Fan Token';
    string private _symbol = 'Digital Yuan Fan Token';
