...
contract FLY is Context, IERC20, Ownable {
    ...
    string private _name = "FLYNAR";
    string private _symbol = "FLY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x765bcb39d9356400D4eB7a68dd93046adD1A1C56); 
    address payable public teamWalletAddress = payable(0x0Cd46fB581080109D16dd663809FD6CE304D815e); 
