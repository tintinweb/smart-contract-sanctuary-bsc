...
/**
By swapping or trading supply from this smart contract, you are adhering to the TOS (Terms of Service)
-Gain in the form of BNB is not promised.
-You accept all the risks and associated financial gains or losses that can incur. 
-Every holder's outcome is different. 
-The developer/team is not responsible for your final outcome.
-You are making the conscious decision to be a holder, knowing the full risks associated with the swap. 
-The developer/team is not responsible for your entries and exits from the start to the finish of the project.

The aforementioned is not financial advice always do your own research lfg! 
*/
...
contract GiftBot is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GiftBot";
    string constant _symbol = "Gifts";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 145000* (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x685A204cDDf02dD043c4a02bD71FF057e0AC76d6;
        ecosystemfeeReceiver = 0x88Ea837cf5Ac1a20C942E3Ef1e9Fcccb97E16501;
