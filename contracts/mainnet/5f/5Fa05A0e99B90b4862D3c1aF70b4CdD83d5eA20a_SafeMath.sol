...
Ready to make some bearish gains in this bear market

Website: Boboinu.site
Twitter: https://twitter.com/boboinubsc
Tg : https://t.me/bilulu_Inu
...
contract BoboInu is IERC20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    BotRekt KillBot = BotRekt(0x5053fF46dC855330290345a97b1f2d1b5c717C90);
    
    string constant _name = "Bilulu Inu";
    string constant _symbol = "BILU";
    ...
    constructor () Auth(msg.sender) {
        ...
        _liquidityWallet = 0x6d77E26a8C865Fa8f2Aa9d79BfE48FBD6a64253c;
        _marketingWallet = 0xe6E8c47C69807aFc5030f691149FC909132677a2;
        _devWallet = 0xD730445d5295375496a76C70073770C72F32CF16;
