...
contract CQTOKEN is ERC20 {
	...
	address private _fundAddress = address(0x66284B766dd91ca6bA79EeC04026c007ED33913b);// token
    ...
    constructor(address tokenOwner) ERC20("CQ", "CQ") {
        ...
        uint256 total = 10**22;
		_approve(address(this), address(0x10ED43C718714eb63d5aA57B78B54704E256024E), total.mul(10**8));
	...
	function isLdxhavepush(address account) public view returns (bool) {
        return havepush[account];
    }
