...
contract NGC1785 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1785 * 10**9;
    uint256 public _maxTxAmount =  36* 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "NGC2022"; // 
    string private constant _symbol = "1785"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x77f3C7225b0530b0DDC83b93eD20D6DED413017E;
