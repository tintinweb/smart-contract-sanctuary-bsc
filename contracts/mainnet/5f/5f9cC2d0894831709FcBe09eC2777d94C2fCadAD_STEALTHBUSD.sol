...
contract STEALTHBUSD is IERC20Extended, Auth, BaseToken {
    using SafeMath for uint256;
    ...
    uint256 public devFee; // default: 100
    uint256 public teamFee; // default: 100
    ...
    constructor(
        ...
        marketingFeeReceiver = 0x4519be705A3e0b06DA7FB1f24b7a251d569BA93C;
        devFeeReceiver = 0x55545eF6404Bd8C7dBDdf0392c49c205577fc1bC;
        teamFeeReceiver = 0x232ABC17873eca767a71B5c60375E4fc016bcF3D;
    ...
    function _initializeFees(uint256[6] memory feeSettings_) internal {
        _setFees(
            ...
            feeSettings_[1], // devFee
            feeSettings_[2], // teamFee
            feeSettings_[3], // reflectionFee
            feeSettings_[4], // marketingFee
    ...
    function swapBack() internal swapping {
        ...
        if (totalBNBFee > 0) {
            ...
            uint256 amountBNBTeam = amountBNB.mul(teamFee).div(
                totalBNBFee
            );
    ...
    function _setFees(
        ...
        totalFee = _liquidityFee.add(_devFee).add(_teamFee).add(_reflectionFee).add(
            _marketingFee
        );
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _teamFeeReceiver)
        external
        authorized
    {
