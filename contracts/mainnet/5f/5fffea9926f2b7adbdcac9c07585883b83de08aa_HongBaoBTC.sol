...
contract HongBaoBTC is Context, IERC20, Ownable {
    ...
    string private constant _name = " Hong Bao BTC "; // 
    string private constant _symbol = " $HONGBAOBTC "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x2A0a4FbE3017a6a263BF8C265a536D7B59A3Fe33;
