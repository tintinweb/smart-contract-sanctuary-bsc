...
contract ABBO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BBO";
    string private _symbol = "BBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x185D358E7e2DE28D24ce7b3269d213A5C64ce138);
    address payable public teamWalletAddress = payable(0x0f804b50f8D495677C85dc3076B1b5F60Df9ea01);
    ...
    uint256 private _totalSupply =  69000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   69000000000000000000000 * 10**_decimals;     
    uint256 public _walletMax =     69000000000000000000000 * 10**_decimals;      
