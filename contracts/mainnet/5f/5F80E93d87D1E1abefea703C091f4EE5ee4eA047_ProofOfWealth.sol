...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0657771fc16E325efd8888Ad05890514fE50fbAc; // chng owner
...
contract ProofOfWealth is Context, IERC20, Ownable {
    ...
    string private _name = "Proof Of Wealth";
    string private _symbol = "miniBNB";

    uint256 public _taxFee = 30; // 3%
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 0;
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 60; // 6%
