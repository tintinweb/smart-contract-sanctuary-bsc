...
// File: @champagneswap/champagne-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/ChampagneProfile.sol

pragma solidity ^0.6.0;

/** @title ChampagneProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract ChampagneProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public champagneToken;
    ...
    uint256 public numberChamToReactivate;
    uint256 public numberChamToRegister;
    uint256 public numberChamToUpdate;
    ...
    constructor(
        IBEP20 _champagneToken,
        uint256 _numberChamToReactivate,
        uint256 _numberChamToRegister,
        uint256 _numberChamToUpdate
    ) public {
        champagneToken = _champagneToken;
        numberChamToReactivate = _numberChamToReactivate;
        numberChamToRegister = _numberChamToRegister;
        numberChamToUpdate = _numberChamToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends CHAM to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer CHAM tokens to this contract
        champagneToken.safeTransferFrom(
            _msgSender(),
            address(this),
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer CHAM token to this address
        champagneToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberChamToUpdate
    ...
    /**
     * @dev Claim CHAM to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        champagneToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of CHAM to register
     * Callable only by owner admins.
     */
    function updateNumberCham(
        uint256 _newNumberChamToReactivate,
        uint256 _newNumberChamToRegister,
        uint256 _newNumberChamToUpdate
    ) external onlyOwner {
        numberChamToReactivate = _newNumberChamToReactivate;
        numberChamToRegister = _newNumberChamToRegister;
        numberChamToUpdate = _newNumberChamToUpdate;
    }
