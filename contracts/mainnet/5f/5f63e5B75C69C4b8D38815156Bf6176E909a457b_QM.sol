    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        if (lpUsdt > 0) {
            _swapRouter.addLiquidity(
                address(this), usdt, firstlpAmount, lpUsdt, 0, 0, _receiveAddress, block.timestamp
            );
            _swapRouter.addLiquidity(
...
contract QM is AbsToken {
    constructor() AbsToken(
        ...
        6,
        1000000,
        address(0x83dD0A3ea4997a7197Ba087c3f3fDeEE67B1CDda),
        address(0x83dD0A3ea4997a7197Ba087c3f3fDeEE67B1CDda),
        address(0x8142fF0BbA0d7a4f5D55E3A2A521c1b35C9700EF),
        0,
        0
    ){
