...
/**
    Telegram : https://t.me/ShinjuroInu

    We destined for a market cap in the millions!
...
contract ShinjuroInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shinjuro Inu";
    string private _symbol = "Shinjuro Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA26bAD13Bc2f6b1A75C45334c4cEE0d05a5d457F); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xA26bAD13Bc2f6b1A75C45334c4cEE0d05a5d457F); // Development Address
    ...
    uint256 private _totalSupply = 9 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 9 * 10**6 * 10**9;
    uint256 public _walletMax = 9 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 9 * 10**6 * 10**9;
