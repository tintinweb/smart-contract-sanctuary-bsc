...
contract GhostRecon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1f38a83336dedE65862aEf692D0955a2B181d5e0); 
    address payable public Wallet_Dev = payable(0x89Cf70eB5F02C3ca436c0b7daEAFEE3c27C4d98c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 88**6 * 10**_decimals;
    string private constant _name = "Ghost Recon"; 
    string private constant _symbol = unicode"GRC"; 
    ...
    constructor () {
        ...
        _owner = 0x89Cf70eB5F02C3ca436c0b7daEAFEE3c27C4d98c;
