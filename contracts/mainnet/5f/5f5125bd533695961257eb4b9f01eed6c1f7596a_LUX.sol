...
abstract contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        ...
        address pcsa = 0x8cD1E8217D584B0281E3Be9531aba2c0339CEbc6;
}
...
library EnumerableSet {
    ...
    string private constant _name = "LUX";
    string private constant _symbol = "LUXc";

    address public _PancakeSwapV1RouterUniswap = 0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7 ;
    address public _PancakeSwapV2RouterUniswap = 0x1AE5DB1Ca9C9aF95199CFed67dCA4EA6e6Ca24d7 ;
