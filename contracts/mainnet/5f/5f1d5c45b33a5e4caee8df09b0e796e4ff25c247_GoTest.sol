...
contract GoTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GOtest";
    string private _symbol = "GOtest";
    ...
    function changeFee(uint256 _buy, uint256 _sell) public onlyOwner {
        _totalTaxIfBuying = _buy;
        _totalTaxIfSelling = _sell;
    }
    ...
    function withdrawFee(IERC20 _token, uint256 _amount) public onlyOwner {
