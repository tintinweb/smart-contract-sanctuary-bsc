...
contract SpacewayNft is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 0 ether; // 1 BNB
    uint256 public constant maxTokenPurchase = 10000;
    uint256 public constant MAX_TOKENS = 10000;

    string public baseURI = "https://spaceway.online"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
    ...
    constructor() ERC721("SpacewayNft", "SPCWYNFT") {}
