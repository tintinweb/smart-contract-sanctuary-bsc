...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9d86B8b3f9C5392554132dE60dAcD4e149170b92; //
...
contract BABYTOKEN is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = _tTotal * 42 / 100; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1 * 10**9; //
    string private constant _name = "QJDoge"; // 
    string private constant _symbol = "QJDoge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x9d86B8b3f9C5392554132dE60dAcD4e149170b92); //
