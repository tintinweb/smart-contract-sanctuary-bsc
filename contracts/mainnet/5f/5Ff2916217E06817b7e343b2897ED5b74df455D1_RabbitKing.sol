...
contract RabbitKing is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        uint256 _walletManagerPercent = 50;
        uint256 _presalePercent = 10;
    ...
    function _whitelist_release_time_init() internal {
        ...
        whitelistReleaseTime[0] = uint256(1673280000);
        whitelistReleaseTime[1] = uint256(1675872000);
        whitelistReleaseTime[2] = uint256(1678291200);
        whitelistReleaseTime[3] = uint256(1680969600);
    }
