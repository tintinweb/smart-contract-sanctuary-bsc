...
/**
Contract Name: Babushka
https://t.me/+fDmanJRX4g8wMDQ0
*/
...
contract Babushka is IBEP20, Auth { // NAME OF YOUR TOKEN
    ...
    string constant _name = "Babushka"; // NAME OF YOUR TOKEN SAME AS LINE 184
    string constant _symbol = "BAB"; // SYMBOL FOR TOKEN
    uint8 constant _decimals = 8; // DECIMALS (1 TO 9)

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100;  // 2% MAX TX ALLOWED
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100;  // 2% MAX WALLET ALLOWED
    ...
    uint256 marketingFee = 5; // MARKETING FREE 
    uint256 totalFee = 7; // TOTAL OF FEES 
    uint256 feeDenominator = 100; // DEFAULT - NO NEED TO CHANGE
    
    address private marketingFeeReceiver =0x7A17c81083D83Ad1dbBECcDFE3AeD7496CA45939; // MARKETING WALLET 
    address private teamFeeReceiver =0x7A17c81083D83Ad1dbBECcDFE3AeD7496CA45939; // TEAM WALLET (USE MARKETING WALLET IF NO TEAM FEES)
