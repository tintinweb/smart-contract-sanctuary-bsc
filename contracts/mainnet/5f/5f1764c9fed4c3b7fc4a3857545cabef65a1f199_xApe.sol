...
contract xApe is XPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private XPTeam;
    address private CharityXP;
    ...
    string public override name = "xApe";
    string public override symbol = "XP";
    ...
    constructor(uint totalSupplyValue, address XPTeamAddress, address CharityXPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        XPTeam = XPTeamAddress;
        CharityXP = CharityXPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[XPTeam] =  totalSupply * 45 / 100;
        balances[CharityXP] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's XPTeam pot
