...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa0B14541F05222460134F1AaE3AFfDEc9B8DbA76; // owner address
...
contract TwitterCommitment is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterCommitment";
    string private _symbol = "$TWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa0B14541F05222460134F1AaE3AFfDEc9B8DbA76); // Marketing Address
    address payable public teamWalletAddress = payable(0xa0B14541F05222460134F1AaE3AFfDEc9B8DbA76); // Team Address
