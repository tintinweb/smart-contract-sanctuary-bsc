...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public ELMOINU =
        IERC20Extended(0x104F8A90EEB24a475BC3D1ADa264479593aAB8b9);
...
contract BabyElmoInu is IERC20Extended, Auth {
    ...
    uint256 public maxWallet = _totalSupply / 100;
    ...
    constructor(address _market, address _dev) Auth(msg.sender) {
        ...
        isExcludeFromMaxWallet[msg.sender] = true;
        isExcludeFromMaxWallet[pair] = true;
        isExcludeFromMaxWallet[address(this)] = true;
        isExcludeFromMaxWallet[DEAD] = true;
        isExcludeFromMaxWallet[_market] = true;
        isExcludeFromMaxWallet[_dev] = true;
    ...
    function _transferFrom(
        ...
        if (!isExcludeFromMaxWallet[recipient]) {
            require(amount <= maxWallet, "Max limit exceeds");
        }
    ...
    function setmaxWallet(uint256 _maxWallet) external authorized {
        require(
            _maxWallet >= _totalSupply.div(100_000),
            "Must be greater than 0.001%"
        );
        maxWallet = _maxWallet;
    }

    function ExcludeFromMaxWallet(address user, bool val) public authorized {
        isExcludeFromMaxWallet[user] = val;
    }
