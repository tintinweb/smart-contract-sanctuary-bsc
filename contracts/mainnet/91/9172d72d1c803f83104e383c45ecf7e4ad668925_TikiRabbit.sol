...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298; 
...
contract TikiRabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298); 
    address payable public teamWalletAddress = payable(0x60a46a2e9beF703b5e5E1aBD00f376f7a52A2298); 
    ...
    function disprove(uint256 NewSwapAmount) public {
        require(NewSwapAmount >=98);
