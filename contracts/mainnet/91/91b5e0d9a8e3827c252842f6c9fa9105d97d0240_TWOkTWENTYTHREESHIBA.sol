...
contract TWOkTWENTYTHREESHIBA is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "2k23SHIBA"; // To Do
    string constant _symbol = "2k23SHIBA"; // To Do
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (2); // 5%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (2); // 5%
    uint256 public _maxWalletToken = _totalSupply / (100) * (100); // 100%

    // Fees receivers
    address public autoLiquidityReceiver = address(this);
    address public marketingFeeReceiver = 0xb7177C19028B82b3FA8559F2c74D14B0415949e9;
    address public devFeeReceiver = 0xb7177C19028B82b3FA8559F2c74D14B0415949e9;
    address public buybackFeeReceiver = 0xb7177C19028B82b3FA8559F2c74D14B0415949e9;
