...
contract SPKY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "SpookyRabbit";

    string private _symbol = "SPKY";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xAa749d1c6E003b6f9cf3E1076262d1B81463Aaa3;
