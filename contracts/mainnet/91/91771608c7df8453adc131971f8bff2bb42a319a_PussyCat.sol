...
contract PussyCat is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e15 * 10**_decimals; // 1 Quadrillion Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1_500_000_000_000 * 10**9; // Swap Threshold 0.15%
    uint256 public maxBuyLimit = 5_000_000_000_000 * 10**9; // Max Buy 0.5%
    uint256 public maxSellLimit = 2_500_000_000_000 * 10**9; // Max Sell .25%
    uint256 public maxWalletLimit = 20_000_000_000_000 * 10**9; // Max Hold 2%
    ...
    Taxes public sellTaxes = Taxes(0, 10, 3, 3, 0);
