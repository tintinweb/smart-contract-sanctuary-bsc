...
/*
Official Telegram: https://t.me/BabyDogeCEO_Official
*/
...
contract BABYDOGECEO is Ownable, IBEP20 {
    ...
    uint256 public BabyDogeCEO_MaxTx = 8400000000000000 * 10**_decimals;
    uint256 public BabyDogeCEO_MaxWallet = 8400000000000000 * 10**_decimals;
    ...
    uint256 private marketingFee   = 23;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xa9577acE832d0d92e7F4858b2a0873b0b5a11CE0;
    ...
    function setMaxHolderSize(uint256 maxWallPercent_base1000) external onlyOwner {
        ...
        BabyDogeCEO_MaxWallet = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }
    ...
    function setMaxSell(uint256 maxTXPercentage_base1000) external onlyOwner {
        ...
        BabyDogeCEO_MaxTx = (_totalSupply * maxTXPercentage_base1000 ) / 1000;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != burnFeeReceiver && recipient != devFeeReceiver && recipient != marketingFeeReceiver && !isTxLimitExempt[recipient]){
            ...
            require((heldTokens + amount) <= BabyDogeCEO_MaxWallet,"Total Holding is currently limited, you can not buy that much.");}
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(amount <= BabyDogeCEO_MaxTx || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
