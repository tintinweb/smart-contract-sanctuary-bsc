        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x80CedCb0566581C04E6c909e8E1C9727c3598399), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000,//Su
        address(0x80CedCb0566581C04E6c909e8E1C9727c3598399),//
        address(0x80CedCb0566581C04E6c909e8E1C9727c3598399)//
    ){
    }
}