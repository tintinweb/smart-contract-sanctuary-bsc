...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract S6Ix9Ine is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "S6ix9ine";
    string private _symbol = "69";
    uint8 private _decimals =  12;

    address payable public marketingWalletAddress = payable(0x8f56DC9083E9d2BA7581a4A29B5EC5F558521b3A);
    address payable public devWalletAddress = payable(0x316ba66c1645462899BE911250ad401a417f636c);
