...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x789FA44981a0D765Cc2a5D34A903E53d41550D8c; // owner address
...
contract HOLLANDCHAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HOLLAND CHAD";
    string private _symbol = "HOLLANDCHAD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x789FA44981a0D765Cc2a5D34A903E53d41550D8c); // Marketing Address
    address payable public teamWalletAddress = payable(0x789FA44981a0D765Cc2a5D34A903E53d41550D8c); // Team Address
