...
A meme and innovation business expanding blockchain memes for a happier tomorrow

The BUSDOGE Protocol is a community focused DeFi token.
simple functions occur during each trade
Reflections - 8% is Redistributed in BUSD to all existing holders
Marketing - 6% will be used for marketing to grow BUSDOGE
LP - 1% 

15% tax for buy and sell
Telegram: https://t.me/BUSDOGEBSC
*/
...
contract BUSDOGE is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x01fccF65414db0EC6D4fB4AEA42004C565cdAaA5;
        devFeeReceiver = 0x01fccF65414db0EC6D4fB4AEA42004C565cdAaA5;
