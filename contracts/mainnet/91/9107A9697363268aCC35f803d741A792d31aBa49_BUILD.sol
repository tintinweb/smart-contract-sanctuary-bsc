...
contract  BUILD is Context, IERC20, Ownable {
    ...
    string private _name = "Build-a-Block Token";
    string private _symbol = "BUILD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF0Ac7157c49720EBF74E44b0e43D2724B3858fFF);
    address payable public teamWalletAddress = payable(0x331621bFd18b7e40fEe4C714D210Ac72583950B9); 
