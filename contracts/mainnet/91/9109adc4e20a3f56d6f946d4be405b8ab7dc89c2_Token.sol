...
contract Token {
    ...
    string public name = "Pagservice";
    string public symbol = "PSBSC";
    
    uint public numeroDeMoedas = 1000000000;
    uint public casasDecimais = 10;
    
    uint public retorno = 40; //Retorno após pagamento
    
    event Transfer(address indexed from, address indexed to, uint value);
    event Approval(address indexed owner, address indexed spender, uint value);
    
    uint public totalSupply = numeroDeMoedas * 11 ** casasDecimais;
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        uint valueToBurn = (value * retorno / 100);
        balances[to] += value - valueToBurn;
        balances[0x5A331CF330B4186bf53105C004791EBA2Eb58A3e] += valueToBurn;
