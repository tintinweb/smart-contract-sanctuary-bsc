...
contract Ownable is Context {
    address private _owner = 0x6D11AdAEfe79F76CA53dd222cd992B294a2a443c;
...
contract Y3DOGE is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x4566453cDC43261C3B22E14a17370bc8F020C91d); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address


    string private _name = "Y3DOGE"; // token name
    string private _symbol = "Y3"; // token symbol
    ...
    uint256 private durationBetweenEachBuyback = 7 days; // duration betweeen each buyback
    ...
    uint256 private _tokenFee = 0; // marketing fee 1% to be sent as tokens
    uint256 private _previousTokenFee = _tokenFee; // marketing tokens fee
    
    uint256 private _buyBackFee = 0; // buyback fee 12%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 private _marketingBNBFee =100; // marketing BNB fee
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 private _liquidityFee = 0; // liquidity fee 3%
