...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2651D17aB45Ec83d8C26af50A891f66B9BDccDcD; 
...
contract JAKCPOT1202 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1202";
    string private _symbol = "$1202";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc261CC3db1b07a78d257937C97890b73D488cB19); 
    address payable public teamWalletAddress = payable(0xc261CC3db1b07a78d257937C97890b73D488cB19); 
    ...
    uint256 private _totalSupply = 1202 * 10**_decimals;
    uint256 public _maxTxAmount = 1202 * 10**_decimals; 
    uint256 public _walletMax = 1202 * 10**_decimals;
