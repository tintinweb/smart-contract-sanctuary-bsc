...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5Dcd33a1b1257CcF5c6fe7E55d27B3abC4027748; // owner address
...
contract UsagiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Usagi Inu ";
    string private _symbol = " GINU ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5Dcd33a1b1257CcF5c6fe7E55d27B3abC4027748); // Marketing Address
    address payable public teamWalletAddress = payable(0x5Dcd33a1b1257CcF5c6fe7E55d27B3abC4027748); // Team Address
