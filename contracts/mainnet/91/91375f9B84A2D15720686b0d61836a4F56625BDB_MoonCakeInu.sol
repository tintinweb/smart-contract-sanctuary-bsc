...
MOONCAKE INU is a social meme token
with goals to contribute in social and creativity movement all around the world through your favorite toys: Mooncake Inu.
...
contract MoonCakeInu is IBEP20, Auth {
    ...
    string constant _name = "MoonCakeInu";
    string constant _symbol = "MCI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10000) / 200;
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 100;
    ...
    address private marketingFeeReceiver = 0x8016668467B358F7B687493b5228051f9B441a42;
    address private developmentFeeReceiver = 0x0f11AbA5C6CBc1A3251a3cb1712D3a5c93cD87cB;
