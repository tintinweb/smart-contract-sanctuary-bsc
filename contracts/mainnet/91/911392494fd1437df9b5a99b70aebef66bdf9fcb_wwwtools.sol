...
contract wwwtools is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x375ccEb2318B1bC13Ab653ca80171E68b875aD7f);
    address payable private _twdmkt = payable(0x375ccEb2318B1bC13Ab653ca80171E68b875aD7f);
    
    string private constant _name = "WWW TOOLS";
    string private constant _symbol = "WWWT";
