        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xE6c770eFDD7D01B5370910b81267C449550aA33C), block.timestamp
                );
            }
        }
    }
...
contract OSK is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x293115e9b7ff05C83E3031B8E5903911077e2bAb),//FundAddress
        address(0xD2568495FddD6a257Dbb887FDE907032C1FcA2FC)//ReceiveAddress
    ){
    }
}