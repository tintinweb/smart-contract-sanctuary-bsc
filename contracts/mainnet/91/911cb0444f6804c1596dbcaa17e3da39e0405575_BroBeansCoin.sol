...
contract BroBeansCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "BroBeansCoin"; // token name
    string private _symbol = "BBC"; // token ticker
    ...
    uint256 public minTokenToSwap = 0; // Amount will trigger the swap and add liquidity
