...
contract  LGBTQ is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xAD30956c44F2554fFC8541B481A009f1148858B4);
    address payable public teamWalletAddress = payable(0xEede774a67987297A65EEae59f6278f16Ba9DA98); 
    ...
    uint256 public _maxTxAmount =  1 * 5**_decimals; 
