...
contract kittensatoshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kitten Satoshi"; // 
    string private constant _symbol = "kittensatoshi"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xc1898774636319d967AdE982fe24DA1B3282C3BC;
