...
contract WokeWar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Woke War";
    string private _symbol = "Woke War";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x139ecD471CcE80DCAE68b14fbd070b3C717DBe76); 
    address payable public ttWal = payable(0x139ecD471CcE80DCAE68b14fbd070b3C717DBe76); 
