...
contract CawSecret is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // Multisig Protocol Wallets
    address payable public projectAddress = payable(0x93D5Da218815F5D1FFC38278F6f56D8A8f587090);  
    ...
    address payable private vaultRewardAddress = payable(0xF6402B889A7E94c15C35B2338faf522726f9bE15);
    ...
    string private constant _name = "CawSecret";
    ...
    uint256 public _liquidityFee = 2; // liquidity + all team fees
    ...
    uint256 public _buyVaultFee = 3;
    uint256 public _buyLiquidityFee = 2;
    
    uint256 public _sellTaxFee = 5;
    uint256 public _sellVaultFee = 3;
    ...
    uint256 public _bMaxTxAmount = 20000  * 10**9;
    uint256 public _sMaxTxAmount = 20000  * 10**9;
    uint256 private _trigger = 20000  * 10**9;
    uint256 private minimumTokensBeforeSwap = 500  * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**3;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(projectAddress, convertedBalance.div(_liquidityFee).mul(marketingDivisor));
    ...
    function setMarketingAddress(address _projectAddress) external onlyOwner {
    ...
    function afterPreSale() external onlyOwner {
        ...
        _vaultFee = 3;
        _liquidityFee = 2;
        _bMaxTxAmount = 80000 * 10**9;
        _sMaxTxAmount = 30000 * 10**9;
        setTradingOpen(true);
    }
    ...
    //Create additional liquidity using ShibaInuCola tokens in contract
