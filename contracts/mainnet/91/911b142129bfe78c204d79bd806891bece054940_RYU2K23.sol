...
// telegram : https://t.me/Ryu2k23Official
...
contract RYU2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RYU 2K23";
    string private _symbol = "RYU 2K23";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xF0A7740c8d5cF99F29371731342C8f9050F94F19); // Marketing Address
    address payable private developmentWalletAddress = payable(0xF0A7740c8d5cF99F29371731342C8f9050F94F19); // Development Address
