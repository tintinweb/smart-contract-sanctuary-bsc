...
contract STAKE is Owner {
	...
	function buy_nft_1(uint256 value) public  lock returns(uint256 usdt_amount) {
	...
	function buy_nft_2(uint256 value) public  lock returns(uint256 amountA,uint256 amountB) {
