...
/*   Telegram : https://https://t.me/xinbsc
        tax 3/3
*/
...
contract XIN is Context, IERC20, Ownable {
    ...
    string private _name = "Xin Coin";
    string private _symbol = "XIN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0A6416e7B21Ec67d6D225339F63353d30dA1bBBe);
    address payable public liqWalletAddress = payable(0x0A6416e7B21Ec67d6D225339F63353d30dA1bBBe);
    ...
    uint256 private _totalSupply =  200e12 * 10**_decimals;
    uint256 public _maxTxAmount =   20e12 * 10**_decimals;
    uint256 public _walletMax =     20e12 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 200e11 * 10**_decimals;
