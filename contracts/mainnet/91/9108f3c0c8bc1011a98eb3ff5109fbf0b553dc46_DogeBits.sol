...
/*
$DogeBits hands out bits of $DOGE rewards to its holders!
The ultimate MemeReward + Soon Utility Token!

Telegram t.me/DogeBitsBSC
...
contract DogeBits is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x9d50178706A6028C6b9340a188fAf4E21538B55E;

    string constant _name = "DogeBits";
    string constant _symbol = "DogeBits";
