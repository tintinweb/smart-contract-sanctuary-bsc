...
contract BLASTOISEINU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x025C656aEAB971A4E5dF4e10d642fF2B4129BAAE); // Marketing Address
    address payable public airdropAddress = payable(0xe2ff26d8F90f99912E27C592F6C4A4f45E8a1122); // Airdrop Address
    ...
    string private _name = "BLASTOISEINU";
    string private _symbol = "BLTSINU";
