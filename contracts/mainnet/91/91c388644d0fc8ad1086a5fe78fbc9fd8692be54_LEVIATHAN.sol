...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15d4883Fc586EcFCF25D5A3CB857cD013a3A3F5e; // owner address
...
contract LEVIATHAN is Context, IERC20, Ownable {
    ...
    string private _name = "Leviathan Inu";
    string private _symbol = "LevInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2498B9Fd0AD08069AF7cdE4116706689eD34EA29); 
    address payable public teamWalletAddress = payable(0x4CA53E05b7c09F0Fffc6eEfC12e92B50e0041fa1); 
