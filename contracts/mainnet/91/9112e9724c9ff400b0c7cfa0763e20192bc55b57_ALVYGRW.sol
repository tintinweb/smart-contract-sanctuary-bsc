...
contract ALVYGRW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alvey Grow";
    string private _symbol = "ALVYGRW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x36D1834F4a4e42E813B66e024C36636B82Ec2d8c); // Marketing Address
    address payable private TeamWallet = payable(0x36D1834F4a4e42E813B66e024C36636B82Ec2d8c); // Buy Back Address
