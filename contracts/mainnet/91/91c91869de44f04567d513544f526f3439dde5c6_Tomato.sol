...
contract Tomato is Context, ITRC20, Ownable {
    ...
    string private _symbol = 'Tomato';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 6660000 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 666000 * 10**uint256(_decimals);
