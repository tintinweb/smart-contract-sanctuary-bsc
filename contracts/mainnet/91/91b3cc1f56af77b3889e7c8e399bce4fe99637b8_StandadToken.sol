...
contract StandadToken is Context, IERC20, Ownable {
    ...
    string private _name = "ScurityApe";
    ...
    payable(address(0x0625385a491B7F6aa2559d5F60fD78e0A53156AE));
