...
contract MuuBurn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Muu Burn";
    string private _symbol = "MUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcfcA53a196Ea02e7528808B47d501337f91e2Be6); // 
