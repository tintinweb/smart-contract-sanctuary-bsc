...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7EAAd1C6DD5B0Aacb84C250d6c3c36676Aaf306E; // owner address
...
contract babyjailkwon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby jailkwon";
    string private _symbol = "Baby jail";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7EAAd1C6DD5B0Aacb84C250d6c3c36676Aaf306E); // Marketing Address
    address payable public teamWalletAddress = payable(0x7EAAd1C6DD5B0Aacb84C250d6c3c36676Aaf306E); // Team Address
