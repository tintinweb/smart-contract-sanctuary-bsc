...
contract Doge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3032094314A1fF2cB599DbA6Cb6918525354FdDD));
        marketingWalletAddress = payable(address(0x3032094314A1fF2cB599DbA6Cb6918525354FdDD));
