...
/* Token contract */
contract BabyUhhhhhhhhh is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xE2E9f299f5B55f69033fd14873C64De31C6aB7A4;
    ...
    // Name and symbol
    string constant _name = "Baby Uhhhhhhhhh";
    string constant _symbol = "BUhhh";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 9000 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 9000  / 10000; 
    ...
    uint256 public swapThreshold = _totalSupply * 1000 / 10000; // 0.1% of supply
