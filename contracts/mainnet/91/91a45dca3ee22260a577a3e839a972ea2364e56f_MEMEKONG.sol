...
/*
                Telegram:https://t.me/Memekongtokenbsc
...
contract MEMEKONG  is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x6377a5bBCF54A927183D62FD471CA5de4623B7f6;

    string constant _name = "MEMEKONG";
    string constant _symbol = "Memekong";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 3000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 4000000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0xdeE6cE5196897604ab7a04B66564Eb0887476c43;
