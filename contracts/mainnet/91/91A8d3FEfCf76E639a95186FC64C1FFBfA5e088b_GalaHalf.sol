...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3b658017e3435a501e37f8F1265090dce12eff3A;
...
contract GalaHalf is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gala Half"; // 
    string private constant _symbol = "Gala Half"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x3b658017e3435a501e37f8F1265090dce12eff3A);
