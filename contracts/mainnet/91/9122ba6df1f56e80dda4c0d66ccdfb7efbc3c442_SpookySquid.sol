...
contract SpookySquid is ERC20, Ownable {
    ...
    constructor(address _marketingWallet) ERC20("Spooky Squid", "SSquid", 9) {
        ...
        swapTokensAtAmount = (_totalSupply * 5) / 10000; // 0.05% swap tokens amount || 50000 tokens
