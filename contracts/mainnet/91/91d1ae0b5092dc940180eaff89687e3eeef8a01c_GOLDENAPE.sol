...
contract GOLDENAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GoldenApe";
    string private _symbol = "GAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA75eecb74E2bE24dF9F1ea7E7138518aA5dF6216); 
    address payable public DevelopmentalWalletAddress = payable(0xA75eecb74E2bE24dF9F1ea7E7138518aA5dF6216); 
