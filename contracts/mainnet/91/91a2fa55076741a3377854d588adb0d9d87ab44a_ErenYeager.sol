...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe790293cF2e020189025Fb8393E9B629144956c0;
...
contract ErenYeager is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x42b1204f3cB212cF599cf421308E381CF9605bb2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ErenYeager";
    string private _symbol = "EREN";
