...
/**
Named after Elon Musks' Tweet.
Will Renounce the ownership, and lock the liquidity asap as things going. 
100% community, no BS.  
*/
...
contract CriticsInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc84E7Bd4429358151db97ad65B245E14dE2d666b);
        
    address payable public teamAddress =
        payable(0xAB7FCb00cE7E092C5F938BB4E96eb574F1da9FB3); 
    ...
    string private constant _name = "CriticsInu";
