...
contract NFT is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://www.cryptodnf.net/json";
    address private openSeaProxyRegistryAddress = 0x12c564247EB2382278474c2571295D18702E2382;
    ...
    string public hiddenMetadataUri = "https://www.cryptodnf.net/logo.jpg";
...
//   }
    ...
    constructor(
    ) ERC721A("Cypto DNF NFT", "CyptoDNF", 300, maxSupply) {
    }
  ...
  function tokensOfOwner(address _owner) external view returns(uint256[] memory) {
    ...
    function PublicNums(uint256 _min)
        external
        onlyOwner
    {
