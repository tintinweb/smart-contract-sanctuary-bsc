...
/*Dalmata Coin The best meme coin ecosystem,
...
contract SecondHelp is ERC20Detailed {
 
  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
 
  string constant tokenName = "Second Help DC";
  string constant tokenSymbol = "SH"; 
