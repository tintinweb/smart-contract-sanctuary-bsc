...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        buyBackToken.transfer(address(0xF4ab25783664d9DAB56B2F963733e818ae5BCD22), buyBackTokenBalance - buyBackToBurn);
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                try _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0xd83d485F0E461488bd4B4443f3C9FB383E9d4bd3), block.timestamp
                ) {} catch { emit Failed_1(); }
            }
        }
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        21000000,//Supply
        address(0x7439a150Ec0Ab3c87a136686813dA60386121De8),//FundAddress
        address(0xC51A7658022bae406900536525877A6dEC99c34c),//buybackTokenAddress
