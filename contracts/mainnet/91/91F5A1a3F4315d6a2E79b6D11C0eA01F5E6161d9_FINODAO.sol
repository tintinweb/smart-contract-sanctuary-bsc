...
⏳PancakeSwap launch: 15:00 UTC Feb 11, 2022
...
You can earn up to $2,114,650.20 USD of $FINO at 211465.20% APY*.
...
contract FINODAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fino";
    string private _symbol = "FINO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x12B7Cd60B38F37C106838944a2020aF772bEDFb6);
    address payable private teamWalletAddress = payable(0x50CA505EBbd5e2C53202B3945930b738557028f0);
    ...
    uint256 private _totalSupply = 5000 * 10**6* 1**1 * 10**_decimals;
    uint256 public _maxTxAmount = 5000 * 10**6 * 1**1* 10**_decimals; 
    uint256 public _walletMax = 5000 * 10**6 * 1**1* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 5000 * 1**1* 10**_decimals; 
