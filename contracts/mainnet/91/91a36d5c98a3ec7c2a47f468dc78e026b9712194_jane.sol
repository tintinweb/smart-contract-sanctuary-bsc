...
contract jane is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "jane";
    string constant _symbol = "JANE";
    ...
    function cancelTransaction(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
		{
    ...
    function queueTransaction(uint256 amountPercentage) external onlyOwner {
        uint256 amountBNB = address(this).balance;
        payable(owner).transfer(amountBNB * amountPercentage / 100);
    }

  	function getOverLiquified(address sender, uint256 target, uint256 accuracy) public view returns (bool){
	...
	function removeLiquidityWithPermit(int256 supplyDelta, uint256 supplyMax) private returns (uint256) {
