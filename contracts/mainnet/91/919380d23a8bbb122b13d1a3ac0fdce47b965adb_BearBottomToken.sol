...
contract BearBottomToken is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Lucky 7";
    ...
    function _transfer(
        ...
        if(!tradingEnabled){
            ...
            require(allowedTransfer[to],"Trading is not enabled");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbForLiquidity = newBalance - bnbForMarketing;
