...
/**
        ...
        HALLOWEEN APE OFFICIAL CONTRACT

Halloween Ape it's a meme token based of Binance Smartchain.
Halloween Ape has several systems in it. Halloween Ape comes with reflection to all holders! With low tax too.
We will launch with low mcap and we are preparing some marketing for the initial launch!
such as Telegram Channel influencers.
Let's make moonshoot today!!!

Telegram : https://t.me/HalloweenApe
Twitter  : https://twitter.com/HalloweenApe
Website  : https://halloweenape.com
...
contract HALLOWEENAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Halloween Ape";
    string private _symbol ="HALLAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07257E67c9AC3c2F1cCc5084185700F4406a5a34); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x07257E67c9AC3c2F1cCc5084185700F4406a5a34); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 50 * 10**7 * 10**9;
