...
DOKWON CHAIN $DKC
BLOCKCHAIN? nah
- $DKC IS NOT DESIGNED TO POWER THE WEB3/L2 REVOLUTION
- MARKETING FOCUSED - toDEmoonFI - SAFUc
https://t.me/DOKWONCHAIN
*/
...
contract DKC is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("DOKWON CHAIN", "DKC") { // PROJECTNAME AND TICKER GO HERE
