...
/** 
 *  SourceUnit: /smart-contracts/contracts/Staking/QuintStakingPool.sol
*/
...
////import {OwnershipManager} from "../lib/OwnershipManager.sol";
...
contract QuintStakingPool is OwnershipManager {
    ...
    uint256 public rewardMultiplier = 476;
    ...
    function stake(uint256 amount) external {
        ...
        uint256 unsettledRewards = calculateTokenReward(account);
        ...
        stakingDetails[account].tokenAmount += amount + unsettledRewards;
        ...
        accountDetails[account].totalStakedTokens += amount + unsettledRewards;

        // Update global staking pool details.
        totalStakedTokens += amount + unsettledRewards;
    ...
    function compound() external {
        ...
        require(
            unsettledRewards != 0,
            "QuintStakingPool: no rewards to compound"
        );
        ...
        // Update global account staking details.
        accountDetails[account].totalStakedTokens += unsettledRewards;

        // Update global staking pool details.
        totalStakedTokens += unsettledRewards;
    ...
    function harvest() external {
        ...
        require(
            unsettledRewards > 0,
            "QuintStakingPool: no rewards to harvest"
        );
        ...
        // Update global staking pool details.
        totalHarvestedRewards += unsettledRewards;

        // Log successful activity.
        emit Harvested(account, unsettledRewards);
    }
    ...
    function unstake() external {
        ...
        accountDetails[account].totalHarvestedRewards += unsettledRewards;
