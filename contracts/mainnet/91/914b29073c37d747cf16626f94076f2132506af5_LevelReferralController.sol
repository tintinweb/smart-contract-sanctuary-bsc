...
contract LevelReferralController is Initializable, OwnableUpgradeable {
    ...
    /// @dev user -> referralEpoch
    mapping(address => uint256) public referralEpochs;
    ...
    function claimable(uint256 _epoch, address _user) public view returns (uint256) {
        ...
        uint256 referrerTier = getUserTier(_epoch, _getReferrerBy(_epoch, _user));
    ...
    function setReferrer(address _referrer) external {
        ...
        referralEpochs[msg.sender] = currentEpoch;
    ...
    function _getReferrerBy(uint256 _epoch, address _user) internal view returns (address) {
        return referralEpochs[_user] > _epoch ? address(0) : referralRegistry.referredBy(_user);
    }
