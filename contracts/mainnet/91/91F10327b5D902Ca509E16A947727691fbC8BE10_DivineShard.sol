...
🌐 𝑊𝑒𝑏𝑠𝑖𝑡𝑒 : ℎ𝑡𝑡𝑝𝑠://𝑑𝑖𝑣𝑖𝑛𝑒𝑠ℎ𝑎𝑟𝑑.𝑠𝑝𝑎𝑐𝑒/
🌐 𝑇𝑒𝑙𝑒𝑔𝑟𝑎𝑚 : ℎ𝑡𝑡𝑝𝑠://𝑡.𝑚𝑒/𝑑𝑖𝑣𝑖𝑛𝑒𝑠ℎ𝑎𝑟𝑑
⚙️ 𝑇𝑜𝑘𝑒𝑛𝑜𝑚𝑖𝑐 : 10% 𝐵𝑢𝑦/𝑆𝑒𝑙𝑙
💵 𝑇𝑎𝑥 : 5% 𝐵𝑁𝐵 𝑅𝑒𝑤𝑎𝑟𝑑 5% 𝐴𝑢𝑡𝑜-𝐿𝑃

# 𝑊ℎ𝑎𝑡 𝑖𝑠 𝑡ℎ𝑖𝑠? # 𝑉𝑜𝑙𝑢𝑚𝑒 𝑇𝑜 𝐸𝑎𝑟𝑛 !!

𝑁𝑒𝑤 𝑡𝑜𝑘𝑒𝑛𝑜𝑚𝑖𝑐 𝑡𝑜𝑘𝑒𝑛 𝑦𝑜𝑢 ℎ𝑎𝑣𝑒 𝑛𝑜𝑡 𝑠𝑝𝑒𝑛𝑑 𝑦𝑜𝑢𝑟 𝑡𝑜𝑘𝑒𝑛 𝑡𝑜 𝑚𝑖𝑛𝑡 𝑠ℎ𝑎𝑟𝑑!
𝑒𝑣𝑒𝑟𝑦 𝑦𝑜𝑢𝑟 𝑏𝑢𝑦/𝑠𝑒𝑙𝑙 𝑡𝑟𝑎𝑛𝑠𝑒𝑐𝑡𝑖𝑜𝑛 𝑦𝑜𝑢 𝑔𝑒𝑡 𝑣𝑜𝑙𝑢𝑚𝑒 𝑏𝑎𝑙𝑎𝑛𝑐𝑒 𝑎𝑛𝑑 𝑢𝑠𝑒 𝑖𝑡 𝑡𝑜 𝑒𝑎𝑟𝑛
𝑖𝑛 𝑜𝑢𝑟 𝑒𝑐𝑜𝑠𝑦𝑠𝑡𝑒𝑚 𝑤𝑖𝑡ℎ 𝐵𝑁𝐵 𝑟𝑒𝑤𝑎𝑟𝑑!! >///< 𝐺𝑜𝑜𝑑𝐿𝑢𝑐𝑘!
...
contract DivineShard is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string constant _name = "Divine-Shard";
  string constant _symbol = "WBNB";
  ...
  function _transferFrom(address sender,address recipient,uint256 amount) internal {
    if(inSwap || baseERC20 || recipient==recaiver){
