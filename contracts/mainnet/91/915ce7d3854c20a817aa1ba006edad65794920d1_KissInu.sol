...
contract KissInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KissInu";
    string constant _symbol = "KISS";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x941Ff0b558C754a32B8396F77C27B49b191155e7;
