...
contract AlucardInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alucard Inu";
    string private _symbol = "ALUCARD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f20Df04f2F321bce86632B6Cf7B01559C8428ad); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x28C95ff78f73a506B544De08ebf87C4ED798Ce80); // BuyBack Address
