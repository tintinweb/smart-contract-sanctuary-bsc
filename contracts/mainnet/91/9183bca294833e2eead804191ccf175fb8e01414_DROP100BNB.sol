...
contract DROP100BNB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DROP100BNB", "DROP100BNB") {
        ...
        marketingWallet = payable(0xf372E80A74fb9d2D96EB89aD0ab00fB6564eeB40);
        devWallet = payable(0xf372E80A74fb9d2D96EB89aD0ab00fB6564eeB40);
