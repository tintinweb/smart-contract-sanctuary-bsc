...
contract DOGGOINU is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0xB3b0C5975b24E8edABEEb61AFc333aDFF0BE8E17);
    address public DevelopmentWallet =
        0xB3b0C5975b24E8edABEEb61AFc333aDFF0BE8E17;
    ...
    string private constant _symbol = "DOGNU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**12 * 10**18;
    uint256 public _maxTxAmount = 15 * 10**12 * 10**18;
    uint256 public _maxWalletHoldingLimit = 15 * 10**12 * 10**18;
