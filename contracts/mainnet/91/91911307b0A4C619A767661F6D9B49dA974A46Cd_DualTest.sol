    ...
    constructor() ERC20("DualTest", "DT") {
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new DualTestDividendTracker(
            payable(this),
            router,
            0x192841023fAEFCfe45a6dBA9513d3b9CcbF4D474,
            "DualTestTRACKER",
            "DTTRACKER"
        );
...
contract DualTestDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        tokens.push(Token({contractAddress: IERC20(0xdD8B490001D081eD065239644dae8D1a77b8A91F), percentage: 50, active: true}));
        permitedTokens[0x192841023fAEFCfe45a6dBA9513d3b9CcbF4D474] = true;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DualTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main YIN contract."
        );
    }
