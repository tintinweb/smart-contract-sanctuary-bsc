...
contract Trial7 is ERC20Detailed, Ownable {
    ...
    string public _name = "YUF";
    string public _symbol = "T57";
...
//split liq to 2
    ...
    constructor() ERC20Detailed("YUF", "T57", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xF3f719EA2E8E944467A62Acf8460a79529E08A04;
    ...
    function excludeFromMaxWallet(address account, bool excluded) //also exclude from max tx
        external
        onlyOwner
    {
        require(
