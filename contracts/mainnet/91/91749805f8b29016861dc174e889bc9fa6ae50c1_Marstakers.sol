 ...
 *Submitted for verification at BscScan.com on 2022-02-26
 Visit marstakers.com for more information about this project
*/
...
contract Marstakers is Token {
    
    uint256 public totalUsers; 
    uint256 public totalStaked; 
    uint256 public totalTokenStaked;
        
    uint8[] private REF_BONUSES = [100, 50, 10, 10, 10];
	uint256 private constant CEO_FEE = 90;
	uint256 private constant DEV_FEE = 10;

    uint256 private constant MIN_STAKE  = 0.047 ether;
    ...
    function stake(address referrer) public payable {
        ...
        require (msg.value >= MIN_STAKE, "min stake is 0.047 BNB");
