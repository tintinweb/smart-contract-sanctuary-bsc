...
contract CatcoinClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "Catcoin Classic";
    string private constant _symbol = "CATC";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xE3A08fB7DCDCcdcbd6bE81495776FAd4AD607d2c);
    address payable private _marketingAddress = payable(0xE3A08fB7DCDCcdcbd6bE81495776FAd4AD607d2c);
