 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata,WhiteList {
    using SafeMath for uint256;
    mapping(address => uint256) _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 internal _totalSupply = 20000000000 * 10 ** 18;
     ...
     * construction.
     */
    constructor(address addr,address usdtAddress,address routerAddress) {
        _name = "Bon Test";
        _symbol = "Bont";
    ...
    */
    ...
    function setMarketRatio(uint16 marketRatio)public onlyOwner{
        _marketRatio = marketRatio;
    }
    ...
    function _transfer(
        ...
        if((uniswapV2Pair == sender || uniswapV2Pair == recipient) 
            ...
            uint256 feeAmount = amount.mul(_marketRatio).div(10 ** 2);
            _balances[_marketAddress] += feeAmount;
            toAmount -= feeAmount;
            emit Transfer(sender, _marketAddress, feeAmount);
        }
