...
contract Holidoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xC327F50F097D7b00EA346Dea4c4C2F8faD4c5c48); // Marketing Address
        
    address payable public teamAddress =
        payable(0xcc73AfAE0fd7Ca5A7366CE6623EE7E93F0C2fD7d); // Team Address
        
    address payable public liquidityAddress =
        payable(0xAB9B79753Baf3cFD8ceCC8f768790a3a449F0C61); // Liquidity Address
    ...
    string private constant _name = "Holidoge";
    string private constant _symbol = "Holidoge";
