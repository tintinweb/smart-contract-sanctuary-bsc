...
contract LEOBNB is Context, IBEP20, Ownable { // contract name
    ...
    uint256 public _minTokensSwapToAndTransferTo = 27 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
