...
contract OptimusGrimace is Context, IERC20, Ownable {
    ...
    string private constant _name = "Optimus Grimace "; //
    string private constant _symbol = "OG "; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x327b8A91c4508de4DA5ddd869FCC0f4e16923140;
