...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93190a4C4691982Dfa00dfD79E72f76aFaea3d7f;
...
contract MuskRocks is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x97b0e6f27f9E1fd5377c5143F6BDE81097a8E67E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Musk Rocks";
    string private _symbol = "MuskRocks";
