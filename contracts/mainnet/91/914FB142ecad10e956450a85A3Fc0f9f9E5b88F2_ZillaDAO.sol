...
/*
ZillaDAO is a new BSC token with DAO concept. Together, by having a vision to take & make ZillaDao to be known worldwide, we will create a solid DAO to make it happen.

As we know, DAOs are used to make decisions in a bottoms-up management approach. For every next action in ZillaDAO, we will allow community to votes in the group & make decisions together.

The smart contract will be set with tokenomics below:
- 100 Trillion of Supply
- 10% of Tax Fees
- 3% of Max Wallet

Join us now on TG : https://t.me/ZillaDAOBSC
*/
...
contract ZillaDAO is Context, IERC20 { 
    ...
    string private constant _name = "ZillaDAO"; 
    string private constant _symbol = "ZillaDAO"; 
