...
contract LoveMeTender is IBEP20, Auth {
    ...
    string constant _symbol = "LoveMeTender";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 16) / 200; // 8% TX
    uint256 public _maxWalletSize = (_totalSupply * 16) / 100; // 16% MW
    ...
    address private marketingFeeReceiver = 0xC4e80c76Efb90ad2560aEF62540106Da6029f5FD;
    address private developmentFeeReceiver = 0x5c55F87cE9d3B191045238163d61B7fBb258654C;
