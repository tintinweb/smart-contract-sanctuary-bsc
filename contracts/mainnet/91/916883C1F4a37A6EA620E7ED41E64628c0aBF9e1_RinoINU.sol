...
contract RinoINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rino INU";
    string private _symbol = "RINU";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x54e51F3818cE95e4fD0f84a13370f886714538F2);
