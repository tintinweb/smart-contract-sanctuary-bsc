...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x4B6Cb2bF1F0B594D0211c4Df2B0DD1aA4C7A1892);
...
contract BabyAkiInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x6090314EfFA7c0B0cfe183490FcCA0BD965232C1;

    string constant _name = "Baby Aki Inu";
    string constant _symbol = "BAKIINU";
