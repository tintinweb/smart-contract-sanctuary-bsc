...
contract Ownable is Context, MagnitudeShare{  
    ...
    */
    ...
    function shareZHGDividend(address _dividend) external onlyOwner {
...
contract ZhaoHeGold is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "ZhaoHeGold";
    string private _symbol = "ZHG";
    ...
    uint8 public taxBurnZHG;
    uint8 public taxLimit;
    uint8 public taxUpper;
    uint8 public taxTotalZHG;
    ...
    function clearAllFees() external onlyOwner {     
        taxLiquidity = 3;
        taxMarketing = 1;
        taxSellBack = 7;
        taxBuyBack = 7;
