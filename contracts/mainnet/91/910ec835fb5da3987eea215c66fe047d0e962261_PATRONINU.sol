...
contract PATRONINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Patron Inu";
    string constant _symbol = "PATRON";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x8Aa2F5ccBC37910830E14376eE49481EF39c1736;
