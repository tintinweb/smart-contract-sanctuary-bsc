...
// TG: https://t.me/goldenpitbullheist
library SafeMath {
...
contract GoldPitbullHeist is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Golden Pitbull Heist"; // Edit Name
    string constant _symbol = "GOLD PITBULL HEIST"; // Edit Symbol
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**_decimals; // Edit Supply

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 30000 * 10**_decimals; // Edit Max Wallet
    ...
    uint256 public liquidityFee    = 0; // Edit Liquidity Fee
    uint256 public reflectionFee   = 5; // Edit BUSD Reward Fee
    uint256 public marketingFee    = 8; // Edit Marketing Fee
    uint256 public devFee          = 0; // Edit Dev Fee
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000; // Adjust Auto-Sell (10 = 0.1%)
    bool inSwap;
