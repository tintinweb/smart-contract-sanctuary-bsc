...
contract BTCDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTCDAO";
    string private _symbol = "BTCDAO";
    ...
    uint256 public _maxTxAmount =   2100 * 10**_decimals; 
    uint256 public _walletMax =     2100 * 10**_decimals;
