...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2C86079C7055AE0EeE66b12464506FC369767514; // owner address
...
contract NitroDNAChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Nitro DNA Chain";
    string private _symbol = unicode"NDNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C86079C7055AE0EeE66b12464506FC369767514); // Marketing Address
    address payable public teamWalletAddress = payable(0x2C86079C7055AE0EeE66b12464506FC369767514); // Team Address
