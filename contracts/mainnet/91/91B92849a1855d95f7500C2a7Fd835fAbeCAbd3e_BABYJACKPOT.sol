...
/*
    Website: https://babyjackpot.io
    Telegram: https://t.me/official_Baby_Jackpot
    Donate: 0x4816fEC583401c2117e924dC95BF21d37819FbD0
    Discord: https://discord.gg/ep29yETXFC
    Contract Audited By: https://www.rugfreecoins.com/
    Contract Presale will be in https://www.babyjackpot.io/.
    Contract Version: 1.00
...
contract BABYJACKPOT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY JACKPOT";
    string constant _symbol = "BJP";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * 10**_decimals ; //250B
    ...
    */
    ...
    uint256 totalPoolStaked = 0;
    uint256 stakeRewardBalance = 10000000 * 10**18;
    ...
    function calculateProfit(uint256 amount) public view returns (uint256){
        return (amount * stakeRewardBalance ) / totalPoolStaked;
    }
    ...
    function unstake(uint256 _id) public {
        ...
        uint256 _amount = allInvestment[_id].amountTokenInvested;
        uint256 totalEarned = calculateProfit(_amount);
        allInvestment[_id].totalTokenEarned = _amount + totalEarned;
    ...
    uint totalTokenToEarned = 0;//calculateProfit(amount);
    ...
    uint256 public minStake = 100000000000000000;
    uint256 public cherryBombMax = 20000000000000000000;
    uint256 public jackpotMaxBalance = 10000000000000000000;
    uint256 public startingJackpot = 10000000000000000000;
    ...
    function buybackJackpot() public{   
        ...
        require(_jackpotPoolAmount >= cherryBombMax,'Buyback cannot occur!' );
    ...
    function nextJackpot() internal{
        string memory _jackpotName = string.concat('Jackpot Round ', uint2str(jackId)) ;
            address _winner = address(0x0);
            jackPots.push(JACKPOT(jackId, _jackpotName, minStake, cherryBombMax, jackpotTimer, 0, 0,_winner,false,getCurretTimestamp()));
    }
