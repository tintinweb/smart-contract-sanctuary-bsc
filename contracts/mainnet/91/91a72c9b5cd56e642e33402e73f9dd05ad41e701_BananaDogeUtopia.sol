...
visit website : https://bananadoge.co/
Tokenomic : 5% Buy/Sell Tax
Marketing : 3.5% in BUSD
Lquidity : 1.5% in BUSD
Total Supply : 1,000,000,000,000 BNDGE

100% Community driven and owned. All decisions will come from our community. DAO.
Coin for the people. Payment gateway via our own app. BNDOGE is ownerless,
fully decentralizedand supported by its community of enthusiasts. Everyone can participate
in every step of it’s growth!
...
contract BananaDogeUtopia is IBEP20, Auth {
  using SafeMath for uint256;

  string constant _name = "Banana Doge";
  string constant _symbol = "BNDGE";
