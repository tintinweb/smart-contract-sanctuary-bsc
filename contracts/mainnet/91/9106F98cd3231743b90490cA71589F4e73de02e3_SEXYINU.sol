...
Telegram: https://t.me/sexyinu
Website: https://sexyinu.tech/                      
Twitter: https://twitter.com/sexy_inu
...
contract SEXYINU is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 700_000_000_000 * 10**_decimals;
    ...
    address public marketingAddress = 0xD8724BC984E056a6b84b176E646a16e505A310a2;
    address public devAddress = 0xE1241838abd7647972EE3AC32746aFe32B2a37aE;

    string private constant _name = "SEXY INU";
    string private constant _symbol = "SEXYI";
    ...
    Taxes public taxes = Taxes(0,0,7,2);
    Taxes public sellTaxes = Taxes(0,0,9,3);
    ...
    // Owner cannot transfer out SEXYI from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SEXYI!");
