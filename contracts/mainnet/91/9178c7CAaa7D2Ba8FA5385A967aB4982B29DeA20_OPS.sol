...
contract OPS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x5521f2b1FB5fc44c84F1d4fcBF07B926617F6F9c); 
    address payable public developmentAddress = payable(0x5521f2b1FB5fc44c84F1d4fcBF07B926617F6F9c); 
    address payable public charityAddress = payable(0x5521f2b1FB5fc44c84F1d4fcBF07B926617F6F9c); 
    address payable public vaultRewardAddress = payable(0x5521f2b1FB5fc44c84F1d4fcBF07B926617F6F9c); 
    address payable public liquidityWallet = payable(0x5521f2b1FB5fc44c84F1d4fcBF07B926617F6F9c); 
    ...
    string private constant _name = "Octopus Protocol";
    ...
    uint256 public _sellTaxFee = 45;
    uint256 public _sellVaultFee = 45;
