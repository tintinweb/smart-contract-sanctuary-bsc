...
contract OpenCoinToken is Context, IERC20, Ownable {
    ...
    event SetNumTokensSellToAddToLiquidity(uint256 swapNumber);

    event ClaimTokens(address account,uint256 amount);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 swapNumber) public onlyOwner {
        ...
        emit SetNumTokensSellToAddToLiquidity(swapNumber);
    }
    ...
    function claimTokens() public onlyOwner {
            ...
            emit ClaimTokens(_owner,address(this).balance);
    }
