...
contract Babyvim is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babyvim";
    string private _symbol = "Babyvim";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC44E2F30F65F3e8877bd2cBDB3bdBf3DC3cF5099); 
    address payable public BurnedWalletAddress = payable(0xC44E2F30F65F3e8877bd2cBDB3bdBf3DC3cF5099); 
