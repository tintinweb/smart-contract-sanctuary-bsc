...
abstract contract Token is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 2023000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x4a566A74E2832d420A9334990674F7b316b5Da17;//   营销
...
contract Contract is Token {
    constructor() Token(
        ...
        address(0x4a566A74E2832d420A9334990674F7b316b5Da17),//fund address
    
        address(0x4a566A74E2832d420A9334990674F7b316b5Da17)//dev address
    ){
