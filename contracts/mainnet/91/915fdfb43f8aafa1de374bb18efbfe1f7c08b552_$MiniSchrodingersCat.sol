...
// 
//
// 📱 Telegram:https::https://t.me/MiniSchrodingerr
//
...
contract $MiniSchrodingersCat is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("MiniSchrödinger’sCat", "MiniSchrödinger’sCat") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "MiniSchrödinger’sCat";
    string private _symbol = "MiniSchrödinger’sCat";
