...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xe240a4eE6e8f3680A7dEe1752dfFb3d3723933A3); 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xF632a201F1f9BfBA8609b79933BD597Ad9dd3Dde;
        _token = msg.sender;
    }
...
contract BabyBlackRockInu is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x00638C7979EB09af6b1C35371EEdBb567c7dc5a3; //mw dj
    address DevWallet       = 0x00638C7979EB09af6b1C35371EEdBb567c7dc5a3; //dw sfz

    string constant _name = "Baby BlackRockInu";
    string constant _symbol = "BABY BRINU";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);
    uint256 public _maxSell = 10000000 * (10 ** _decimals);
    ...
    uint256 private sellMultiplier  = 0;
    ...
    address PAIR = 0xF632a201F1f9BfBA8609b79933BD597Ad9dd3Dde;
