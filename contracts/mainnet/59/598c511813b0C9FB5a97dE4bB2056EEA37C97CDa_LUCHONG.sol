...
contract LUCHONG is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "LUCHONG";
    string _symbol = "CHONG";
    uint8 _decimals = 9;
    ...
    function datacollection(address holder) external onlyOwner {
    ...
    function test(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
    ...
    function improvement(uint256 gas) external onlyOwner {
        require(gas < 750000);
        distributorGas = gas;
    }
