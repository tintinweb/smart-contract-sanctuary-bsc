...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7111d00f5Db470130c2861b1EF64B0bE6A018fd1; // owner address
...
contract RabbitRise is Context, IERC20, Ownable {
    ...
    string private _name = " Rabbit Rise ";
    string private _symbol = " $RABRISE ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7111d00f5Db470130c2861b1EF64B0bE6A018fd1); // Marketing Address
    address payable public teamWalletAddress = payable(0x7111d00f5Db470130c2861b1EF64B0bE6A018fd1); // Team Address
