...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2C13D4616182Dda744aCb33d3EebB350745A6A91;
...
contract OSINCOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6062a9E3eddAD5BAD039c8A6bC158E9fc0B55C17;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OSIN COIN";
    string private _symbol = "$OSIN";
