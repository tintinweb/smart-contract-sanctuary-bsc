...
contract SQUIDCREW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x534BF6DC945A1ef2C485Be92856aC3B3120ad114);
    address payable public Wallet_Dev = payable(0x534BF6DC945A1ef2C485Be92856aC3B3120ad114);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "SQUID CREW"; 
    string private constant _symbol = unicode"SQUID CREW";
    ...
    constructor () {
        _owner = 0x534BF6DC945A1ef2C485Be92856aC3B3120ad114;
