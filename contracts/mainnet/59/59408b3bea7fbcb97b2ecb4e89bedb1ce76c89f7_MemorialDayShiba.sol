...
*/
 /** 
    Memorial Day is of the biggest holiday weekends in the U.S.
    ELON MUSK loves to tweet about holidays and dress up Shiba during them 👀
    Memorial Day Shiba $MDS is a charity token designed to raise funds to gift service animals to survivors of war and their families. 
    Tokenomics 
    - 5% Buy/Sell Tax 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //SHIBA REWARDS 
...
contract MemorialDayShiba is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // SHIBA REWARDS
    ...
    address _marketingAdr = 0xF663AA3eB10e7EB2F0b1cF976638026e0C6337AC;
 
    string constant _name = "Memorial Day Shiba";
    string constant _symbol = "$MDS";
