...
contract DONTBUYS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private _symbol = "TESTDONTBUY";
...
// BNB FEES ARE COLLECTED HERE GUYS 
    ...
    function setREWARDSTOKENs (address newdefault1,address newdefault2, address newdefault3, address newdefault4) external authorized {
    distributor.setREWARDSTOKEN(newdefault1);//Meme
    distributor1.setREWARDSTOKEN(newdefault2);//Meme
    distributor2.setREWARDSTOKEN(newdefault3);//Stable
    distributor3.setREWARDSTOKEN(newdefault4);//Stable
    } 
