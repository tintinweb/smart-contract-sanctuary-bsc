...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        walletLimit = 108000 * 10 ** Decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x178C3892677ee9AB48Bd457AEE482424b27835Bb;
...
contract FON is AbsToken {
    constructor() AbsToken(
        ...
        address(0xAC1C4707cf1c093a0f3195c02d9C2562018EE1DB),
    
        address(0x36729e7864537EC03D3C35f545f28c9d53A3Db90)
    ){
