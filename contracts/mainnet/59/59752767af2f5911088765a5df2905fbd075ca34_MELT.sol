...
pragma solidity ^0.8.15;
    ...
    contract MELT is Context, IERC20, Ownable {
        ...
        uint256 public __Marketing__Fee = 4;
        ...
        address payable public Marketing__Wallet;
        ...
        constructor (address payable MarketingWalletAddress){
            Marketing__Wallet = MarketingWalletAddress;
            ...
            _isExcludedFromFee[Marketing__Wallet] = true;
        ...
        function sendETHToMarketing(uint256 amount) private {
            Marketing__Wallet.transfer(amount.mul(3).div(8));
        ...
        function _setMaxTxAmount(uint256 amountPercent) external onlyOwner() {
            MaxTxAmount = (_tTotal * amountPercent ) / 100;
        }
