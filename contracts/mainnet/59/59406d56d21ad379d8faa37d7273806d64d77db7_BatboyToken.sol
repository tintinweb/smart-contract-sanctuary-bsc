...
contract BatboyToken is IBEP20, Auth {
    ...
    string constant _symbol = "BATBOT";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x44Ad745F009410F645A97C7781156a264954D094;
        marketingWallet = 0x8A2723806E03dc8F041b978757604a6C60332b03;  // marketingwallet
        teamWallet = 0x1744b16685C3EC7BF1EFAaD6FE952E65dCc7C7b9;  // team
    ...
    function setFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newTeamFee, uint256 extraSellFee) external authorized {
    ...
    function setDistributionCriteria(uint256 newinPeriod, uint256 newMinDistribution) external authorized {
