...
Portal: https://t.me/twitter_x_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1f3A5B2CECAEcaD2cf32Ebe514b0Ad89D4d9aEAf; // owner address
...
contract twitterx is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter X";
    string private _symbol = "APP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f3A5B2CECAEcaD2cf32Ebe514b0Ad89D4d9aEAf); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f3A5B2CECAEcaD2cf32Ebe514b0Ad89D4d9aEAf); // Team Address
