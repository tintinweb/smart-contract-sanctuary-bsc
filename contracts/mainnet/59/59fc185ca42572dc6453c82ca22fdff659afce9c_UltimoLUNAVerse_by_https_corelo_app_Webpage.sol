...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe464FcE0311466AfEF2f2A6860515438E6095AaB;
...
contract UltimoLUNAVerse_by_https_corelo_app_Webpage is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD366f1F124d45096Ba42DE68B7cDc760c083067D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ultimo Luna Verse";
    string private _symbol = "ULV";
