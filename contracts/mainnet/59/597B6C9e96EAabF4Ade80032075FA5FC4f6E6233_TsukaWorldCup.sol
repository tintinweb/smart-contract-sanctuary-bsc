...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6a912F64C71050aa41153BEBEfba5Cc9864c9834;
...
contract TsukaWorldCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka World Cup"; // 
    string private constant _symbol = "TSUKAWC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable private  _marketingWallet = payable(0x71f93b14004ca4f1660D96086CeFbeA191FfFFf2);
