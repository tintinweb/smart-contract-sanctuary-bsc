...
/**
Welcome to Baby Green Network

Telegram: https://t.me/babygreenetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1e199036E0e6E493A62dD1460e13F03934C791B; // owner address
...
contract BabyGreenNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGreen Network";
    string private _symbol = "BGN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7619B46BD9a8B17d1b2e58c2EaeDb7199C0E5d94); // Marketing Address
    address payable public teamWalletAddress = payable(0x5C7be35870857af3FCF1163b29249531a0206d9b); // Team Address
    ...
    uint256 public _teamShare = 3; // original 15

    uint256 public _totalTaxIfBuying = 10;  // original 10
    uint256 public _totalTaxIfSelling = 10;  // original 13
    uint256 public _totalDistributionShares = 10;  // original 13

    uint256 private _totalSupply = 1000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 10000000 * 10**_decimals; 
    uint256 public _walletMax = 20000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 6000000 * 10**_decimals; 
