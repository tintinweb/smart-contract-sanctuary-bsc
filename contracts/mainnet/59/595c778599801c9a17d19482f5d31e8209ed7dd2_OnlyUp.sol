...
The contract buys back with 100% of it's value randomly every 5-10 minutes, buying the dip!
...
contract OnlyUp is ERC20, Ownable {
    ...
    uint256 private buybackpercent = 100;
    ...
    uint256 public totalSellFees = 50;
    ...
    constructor() ERC20("ONLYUP", "UP") {
    	...
    	marketingWallet = 0xE90a90Dc06edA1aE3E142958d8Da7741290fa9F9;
    	rewardsWallet = 0xE90a90Dc06edA1aE3E142958d8Da7741290fa9F9;
