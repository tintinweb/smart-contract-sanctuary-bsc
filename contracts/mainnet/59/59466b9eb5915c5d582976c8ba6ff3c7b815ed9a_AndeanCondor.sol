...
contract AndeanCondor is ERC20 {
    using SafeMath for uint256;
	...
	address payable _receive = payable(address(0xED03452883dcE734E04d11FA0f03A0fB9461bD92));
    ...
    constructor(address tokenOwner) ERC20("Andean Condor", "Andean") {
