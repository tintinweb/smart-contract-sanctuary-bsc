...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x50D7fAAcD2620cDa20B1675fDa0cCFCD89e78696; 
...
contract GenesisNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Genesis Network";
    string private _symbol = "$GEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50D7fAAcD2620cDa20B1675fDa0cCFCD89e78696); // 
    address payable public teamWalletAddress = payable(0x50D7fAAcD2620cDa20B1675fDa0cCFCD89e78696); // 
