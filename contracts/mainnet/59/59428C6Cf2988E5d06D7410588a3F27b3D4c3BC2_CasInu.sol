...
contract CasInu is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        // 
        _TeamWallet       = 0x000000000000000000000000000000000000dEaD;
        ...
        _isExcludedFromAntiWhale[address(0x000000000000000000000000000000000000dEaD)]            = true; // <--- Add Deployer Address
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x000000000000000000000000000000000000dEaD)] = true; // <--- Add Deployer Address
