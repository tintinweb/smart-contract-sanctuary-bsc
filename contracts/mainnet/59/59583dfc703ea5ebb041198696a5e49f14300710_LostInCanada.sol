...
// File: LostInCanada.sol
pragma solidity >=0.8.9 <0.9.0;

contract LostInCanada is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public currentMaxSupply = 150;
  ...
  constructor(
  ) ERC721A("Lost In Canada", "LOST") {
      setHiddenUri("ipfs://Qme5SUsnPKfNpvqqf1hDPCXRrkhKCZ1So2753iFjhozYrB/Canada.json");
