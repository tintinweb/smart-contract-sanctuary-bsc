...
contract GDTEST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GDTEST";
    string private _symbol = "GDTEST";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5302aF1EC0E8D20BcF3e9C9cDD3ced8e16415F41); // Marketing Address
    address payable public teamWalletAddress = payable(0x960bF47E3929F15581AAb9f771f5a9735cef7B98); // Dead Address
