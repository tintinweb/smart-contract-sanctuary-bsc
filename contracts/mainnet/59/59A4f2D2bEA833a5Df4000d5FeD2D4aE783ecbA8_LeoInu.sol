...
contract LeoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Leo Inu";
    string private _symbol = "LEOINU";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xaB3e1005f9bE2D031875457f899F2732e256b07D);
    address payable public teamWalletAddress = payable(0xaB3e1005f9bE2D031875457f899F2732e256b07D);
