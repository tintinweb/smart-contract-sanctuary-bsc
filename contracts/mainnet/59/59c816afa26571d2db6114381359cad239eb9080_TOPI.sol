...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    address internal prize = address(0);
...
contract TOPI is ERC20 {
	...
	function initPrizePool(address _prizePool) public onlyOwner {
        require(prize == address(0), "already set");
        prize = _prizePool;
    }
    ...
    function _transfer(
		...
		if(from == address(this) || to == address(this) || feeswitch){
