...
contract PigeStaking is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant MAX_PERFORMANCE_FEE = 0;
    uint256 public constant MAX_UNSTAKE_FEE = 1000; // 10%

    uint256 public performanceFee = 0;
    uint256 public earlyUnstakeFee = 1000; //10%
