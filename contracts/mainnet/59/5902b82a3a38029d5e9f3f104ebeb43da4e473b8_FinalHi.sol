...
contract FinalHi is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    function setFeeReceivers(address _liquidityReceiver, address _buybackReceiver, address _NFTdevReceiver, address _GLCLPReceiver) external onlyWhitelisted {
    ...
    function setFees(uint256 _liquidityFee, uint256 _NFTdev, uint256 _buybackFee, uint256 _sellFeebuybackAdded, uint256 _sellFeeNFTdevAdded, uint256 _feeDenominator) external onlyWhitelisted {
        require(
