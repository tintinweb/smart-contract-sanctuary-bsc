...
contract SXToken is Context, IERC20, Ownable {
    ...
    function setaddLQswitch(bool _addLQswitch)external onlyOwner{
        addLQswitch = _addLQswitch;
    }
    ...
    function _transfer(
        ...
        if( isAddLiquidity && !_isExcludedFromFee[from] ){
            require(addLQswitch,"not open");
        }
