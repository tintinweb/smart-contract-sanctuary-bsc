...
contract WORLDPEACESHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WorldPeaceShiba";
    string private _symbol = "WPSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4af9c5185CE363b93D7Daa471EB0B773a22d32e0); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x82939E72f58A4a977733986EAb57615Cea3f733f); // Developmental Address
