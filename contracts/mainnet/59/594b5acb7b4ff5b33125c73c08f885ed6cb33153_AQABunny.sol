...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2EE211aABa1DD30C08C16bb6aA55e57E13Ae6b0D; // owner address
...
contract AQABunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AQABunny";
    string private _symbol = "AQABunny";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2EE211aABa1DD30C08C16bb6aA55e57E13Ae6b0D); // Marketing Address
    address payable public teamWalletAddress = payable(0x2EE211aABa1DD30C08C16bb6aA55e57E13Ae6b0D); // Team Address
