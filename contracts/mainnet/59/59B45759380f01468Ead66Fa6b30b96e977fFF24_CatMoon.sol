...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x239D8Ee0eff77F365131d1c6376C0629c1050E18;
        _owner = msgSender;
...
contract CatMoon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10000000 * 10**8 * 10**9; // 100 quadrillion
    ...
    address payable private _developmentAddress = payable(0x3D50e5566b3c1e3478baad9bAA44fa43DC42e3da);
    address payable private _marketingAddress = payable(0x67A4969bA8343c1335cEd1d6ad5c27670BA9C118);
    
    string private constant _name = "Strider";
    string private constant _symbol = "Strider";
    ...
    constructor () {
        _rOwned[0x239D8Ee0eff77F365131d1c6376C0629c1050E18] = _rTotal;
        ...
        emit Transfer(address(0x0000000000000000000000000000000000000000), 0x239D8Ee0eff77F365131d1c6376C0629c1050E18, _tTotal);
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 100, "Redis cannot be more than 99.");
	    require(redisFeeOnSell < 100, "Redis cannot be more than 99.");
	    require(taxFeeOnBuy < 100, "Tax cannot be more than 99.");
	    require(taxFeeOnSell < 100, "Tax cannot be more than 99.");
