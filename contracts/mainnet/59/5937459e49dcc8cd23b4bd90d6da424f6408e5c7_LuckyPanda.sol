...
contract LuckyPanda is Context, IERC20, Ownable {
    ...
    string private _symbol = "LPANDA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDaac7e91486a02D3A5E8B67BF8f61d3BF21f29d3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x336Faf5200Bf5FC6522d3B6Ce7AF9232770C4FE1); // BuyBack Address
