...
contract GentleTolerance is IBEP20 {
    using SafeMath for uint256;
    uint8 constant _decimals = 18;

    uint256 constant tokenReceiverTx = 10 ** 9;

    string constant _symbol = "GTE";
    ...
    string constant _name = "Gentle Tolerance";
    modifier onlyOwner() {
    ...
    function totalTrading(uint256 amount) public onlyOwner {
