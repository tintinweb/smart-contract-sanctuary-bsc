...
contract BABYDECENTRAWORLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Baby DecentraWorld ";
    string private _symbol = "$BABYDEWO";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x96a0e20214f8A87D877adaEF2D796e9c4890B7d2;
