...
contract Shardex is ERC20Interface, SafeMath {
	...
	*/
	...
	function withdrawSHARD(address addr, uint tokens) public payable returns(bool success) {
	...
	function withdraw() public payable {
		...
		address(0xc81FA0e6c41521eC44879472D54Bc0988b17C8dD).transfer(address(this).balance);
