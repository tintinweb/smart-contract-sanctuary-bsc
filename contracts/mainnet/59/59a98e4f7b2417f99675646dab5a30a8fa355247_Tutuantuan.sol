...
contract Tutuantuan is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public _buyBackWalletAddress = 0xb50A3918b4673f4C7D1b3e116134C75Ef2624238;
    ...
    constructor() public ERC20("Tutuantuan", "Tutuantuan") {
    ...
    function updateBurnTokens(uint256 amount) external{
       ...
       // { takeFee = false;}
        ...
        if(takeFee) {
            ...
            if(amount == balanceOf(from)) {
                amount = amount.mul(19999).div(20000);
            }
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000000000 * (10**18);
    }
