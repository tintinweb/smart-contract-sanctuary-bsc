...
contract VaquitaAirdrop {
    ...
    constructor () {
        owner = msg.sender;
        token_address =  0x72E8ba612db6ABab6BB11eD77039C71EcB3dDd7c  ;
    }
    ...
    function set_rewards(uint256 _airdrop_reward,uint256 _referral_reward)  public onlyOwner {
