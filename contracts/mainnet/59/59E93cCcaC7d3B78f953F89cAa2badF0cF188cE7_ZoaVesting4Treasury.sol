...
contract ZoaVesting4Treasury is ZoaVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "ZoaVesting4Treasury: zero token address");
        require(_mercleRoot != bytes32(0), "ZoaVesting4Treasury: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "ZoaVesting4Treasury: wrong TGE timestamp");
