...
/*
Website: https://www.eggroll.app/
Twitter: https://t.me/eggroll_official/
*/
...
contract EggRollSwap is Context, IERC20, Ownable {
    ...
    address public Eggroll_Marketing = 0x5c0d89d225D313291f26BB2031fefE47118b95B1;
    address public Eggroll_Team = 0xF4d2D98fD23e82Ca4b0f3C34AcE079dCF46501A2;


    string private constant _name = "EGGROLL SWAP";
    ...
    Taxes public taxes = Taxes(0,47,1,1);
    Taxes public sellTaxes = Taxes(0,47,1,1);
    ...
    constructor (address routerAddress) {
        ...
        _isExcludedFromFee[Eggroll_Marketing] = true;
        _isExcludedFromFee[Eggroll_Team] = true;
        
        allowedTransfer[address(this)] = true;
        allowedTransfer[owner()] = true;
        allowedTransfer[pair] = true;
        allowedTransfer[Eggroll_Marketing] = true;
        allowedTransfer[Eggroll_Team] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(Eggroll_Marketing).sendValue(marketingAmt);
        }
        uint256 teamAmt = unitBalance * 2 * temp.team;
        if(teamAmt > 0){
            payable(Eggroll_Team).sendValue(teamAmt);
        }
    }
    ...
    function Eggroll_MpdateMarWallet(address newWallet) external onlyOwner{
        Eggroll_Marketing = newWallet;
    }
    
    function updateEggroll_Team(address newWallet) external onlyOwner{
        Eggroll_Team = newWallet;
    }
