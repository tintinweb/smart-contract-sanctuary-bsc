...
contract StoneToken is ERC20,  Ownable{
  constructor() ERC20("InsuranceBeats", "IB") {}

    address public newmanWallet = 0xAE49aB6c4C131C3c871b1f57832c3f51608B99A6;
    address public contractWallet = 0xf43d86D3af365ed5C42fA925Bebd49eF0f56b974;
    uint256 public mintRate = 300000000000000000 wei;
 ...
 function mint(uint256 amount)
    ...
    function withdraw() public onlyOwner {
        ...
        payable(contractWallet).transfer(address(this).balance / 2);
        payable(owner()).transfer(address(this).balance/3);
        payable(newmanWallet).transfer(address(this).balance);
    }
