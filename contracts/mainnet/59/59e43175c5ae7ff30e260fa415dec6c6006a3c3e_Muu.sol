...
/*
MiniMuu $MUU will provide different utility cases, starting with an own Swap. Another utility case is charity – with MiniMuu we would like to raise money through the transactions, which we donate to non-profit organizations working for animal welfare. Just for holding your tokens and going to the moon with us, you’ll be rewarded with 3% Muu Inu rewards which will be automatically distributed to your wallet.
...
- 3% MuuInu rewards 
- 1% LP
- 1% Donation to animal welfare 

Max buy/sell 2% 

Telegram: @MiniMuuBSC
Twitter: http://twitter.com/MiniMuuBSC
Web: http://MiniMuu.org
*/
...
contract Muu is Context, IBEP20, Ownable {
