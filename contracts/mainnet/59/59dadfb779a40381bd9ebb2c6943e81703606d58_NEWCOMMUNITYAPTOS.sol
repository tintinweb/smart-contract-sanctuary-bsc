...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32b6B47B5c4Ee726d6c8f4730c348d45eFFff22a; // Owner
...
contract NEWCOMMUNITYAPTOS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEW COMMUNITY APTOS";
    string private _symbol = "NCA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32b6B47B5c4Ee726d6c8f4730c348d45eFFff22a); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x60543Da3970f600833EB01A5D511aF8fad5D1424); // Team Wallet
