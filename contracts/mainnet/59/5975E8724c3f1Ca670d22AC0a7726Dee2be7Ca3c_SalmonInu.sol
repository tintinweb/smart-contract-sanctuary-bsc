...
contract SalmonInu is IERC20 {
    ...
    string constant private _name = "SalmonInu";
    string constant private _symbol = "SMN";
    ...
    uint256 constant public maxBuyTaxes = 400;
    uint256 constant public maxSellTaxes = 400;
    uint256 constant public maxTransferTaxes = 400;
    ...
    address public developerWallet = 0xCa8deb5CE3B0f1E73262AD62bc82bD6B93C4F914;
...
//===============================================================================================================
    ...
    function setWallets(address developer) external onlyOwner {
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (feeAmount > 0) {
            _tOwned[developerWallet] += feeAmount;
            emit Transfer(from, developerWallet, feeAmount);
        }
