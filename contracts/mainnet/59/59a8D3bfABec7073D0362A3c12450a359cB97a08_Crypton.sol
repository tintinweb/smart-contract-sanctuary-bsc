...
contract Crypton is Ownable, ReentrancyGuard {
    ...
    function setPricingToken(IERC20 pricingToken_) public onlyOwner {
        _pricingToken = pricingToken_;
    }
    ...
    function placeTokens(uint256 nonce, uint256 price, IERC20 token, uint256 initialVolume, bytes memory signature) public {
        ...
        require(signers[signer], "Crypton: Invalid signature");
    ...
    function withdrawFees() public onlyOwner {
        _pricingToken.safeTransfer(owner(), collectedFees);
        collectedFees = 0;
    }
}
