...
contract Ratchild is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rat Child";
    string private _symbol = "WENMOON?";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xc223970adf74a44bF7Bc9eE990fef459af3C001F);
