...
contract Commanderpig is IERC20, Ownable {
    ...
    constructor(
        ...
        _name = "Commander pig";
        _symbol = "Commander pig";
        _decimals = 18;

        _tTotal = 500 * 10**8 * 10**_decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeFee(
                sender,
                _destroyAddress,
                tAmount.div(100).mul(15),
                currentRate
            );

            _tTotalDestroy = _tTotalDestroy.add(tAmount.div(100).mul(15));
