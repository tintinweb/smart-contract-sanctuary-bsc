...
contract PresaleFactory is OwnableUpgradeable {
    ...
    function  initialize ()  public initializer {
        ...
        tokenPrice_USD = 66 * 10 ** 16;

        bsc01Router = IDEXRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        iihAddress = IERC20(0xafB527C62fd6D4f121Ef8e49bef5eFD848076bFe);
    ...
    function buyTokensByUSDT(uint256 _amountPrice) external {
        ...
        // transfer IIH token to user
        iihAddress.transfer(msg.sender, decimalTokenAmount);
    ...
    function withdrawToken() public onlyOwner returns (bool) {
        ...
        uint256 balance = iihAddress.balanceOf(address(this));
        return iihAddress.transfer(msg.sender, balance);
    }
