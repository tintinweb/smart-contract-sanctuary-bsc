...
STEALTH AS A CAT, SMART AS A PIG

Picat lives on a farm in the middle of a Kazakhstan field, he shares the farm whit a dog named Thuna and a lot of sheeps and cows. 

Make sure to be patient and hype will make your bags fly to the moon

Defi will be bullish again!

TOTAL SUPPLY: 100 000 000
MAX WALLET: 2% - 2 000 000
MAX TRANSACTION: 1% - 1 000 000
TAX: 9%

https://t.me/Picatofficial
...
contract Picat is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Picat';
    ...
    uint256 currentAmountToSwap = 650000 * 10**_decimals;
    ...
    //DevWallets
    address public MarketingWallet=payable(0x0527269B08bc87e123B900bEc4a22d4b4E80Be08);
    address public Development=payable(0x0527269B08bc87e123B900bEc4a22d4b4E80Be08);
    //Testnet
    ...
    function TeamWithdrawALLMarketingBNB() external onlyOwner{
        ...
        emit Transfer(address(this), MarketingWallet, (amount*75) / 100);
