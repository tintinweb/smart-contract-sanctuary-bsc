...
contract Power  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Power to the People";
    ...
    address private marketingWallet = address(0x82631Ad5ff89BD55f91aeD039645f0AbfCDB0e4A);
    address private liquidityReceiver = address(0x82631Ad5ff89BD55f91aeD039645f0AbfCDB0e4A);
