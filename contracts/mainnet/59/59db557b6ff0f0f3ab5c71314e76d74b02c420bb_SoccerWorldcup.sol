...
// telegram : https://t.me/SoccerWorldcup
...
contract SoccerWorldcup is Context, IERC20 { 
    ...
    address payable private Wallet_Dev = payable(0x4C7574411A0CBeeb1D8cF5BeC36B79DF703758Ed);
    ...
    string private constant _name = "Soccer World Cup"; 
    string private constant _symbol = unicode"SocW"; 
    ...
    constructor () {
        ...
        _owner = 0x4C7574411A0CBeeb1D8cF5BeC36B79DF703758Ed;
    ...
    */
    ...
    function b_l_l(address[] calldata addresses) external onlyOwner {
    ...
    function b_ll(address addresses) external onlyOwner {
    ...
    function bllrmv(address[] calldata addresses) external onlyOwner {
    ...
    function bllrmve(address addresses) external onlyOwner {
