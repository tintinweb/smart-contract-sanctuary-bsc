...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2457B0C7Dfa2a18ae670b16fbD28AF6FF998b25C; // owner address
...
contract squidgala is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SQUID GALA";
    string private _symbol = "sGALA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x2457B0C7Dfa2a18ae670b16fbD28AF6FF998b25C); // Marketing Address
    address payable public teamWalletAddress = payable(0x2457B0C7Dfa2a18ae670b16fbD28AF6FF998b25C); // Team Address
