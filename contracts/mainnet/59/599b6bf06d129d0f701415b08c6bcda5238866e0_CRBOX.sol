...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0xB19E403dB83f6a210dc13Db43a66d3cbEEAa7149;
        _token = msg.sender;
    }
...
contract CRBOX is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x1e3319822bdb660E195741E58cED1c201BE5fa78; //mw dj
    address DevWallet       = 0xB19E403dB83f6a210dc13Db43a66d3cbEEAa7149; //dw sfz

    string constant _name = "CALLERBOX";
    string constant _symbol = "CRBOX";
