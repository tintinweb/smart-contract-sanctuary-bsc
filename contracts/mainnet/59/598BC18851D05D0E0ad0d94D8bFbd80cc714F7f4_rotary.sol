...
/**
ROTARY TOKEN was created by Safe Dev and supported by diamond hands crypto enthusiast.
This is not only Meme Token,but this project also designed to have some utilities so that can beat the other Token in Crypto Industries.

Telegram: https://t.me/RotaryTokenPortal
Website: https://www.rotarytoken.com
*/
...
contract rotary is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rotary Token"; //
    string private constant _symbol = "ROTARY"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x8a0E75C64188b221D80C501a6A63D6EDb379Bc69 ;
