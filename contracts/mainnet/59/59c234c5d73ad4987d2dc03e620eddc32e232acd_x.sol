...
contract x is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * (10**21) * (10**9);
    ...
    address payable private _appAddress = payable(0xb742Cc7580C94bb9DFEF8e325C2c08Df6d6982e0);
    address payable private _marketingAddress = payable(0xE6a8e8E1EA93d1e1Ca5bA0A767a380544Eb68A8F);
    address payable private _buybackAddress = payable(0x2408d52d4b68Bf21FE90d4325B2AcE3D6Be9F5bd);
    address payable private _burnAddress = payable(0x359fbc7FB5ed94F2EC4987F893428eE56148F772);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 devAmount = amount.mul(0).div(1);
        uint256 mktAmount = amount.mul(1).div(1);
        uint256 buybackAmount = amount.mul(0).div(1);
