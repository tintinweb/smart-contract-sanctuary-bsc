...
contract Ownable is Context {
    address private _owner = 0x113D928a982Ad42129D817c8292b8020032edC92;
...
contract ChangKongDaDui is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xF310B6a77764aBB66C1B53f58C298a6456bb5320); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "ChangKong DOGE"; // token name
    string private _symbol = "ChangK DOGE"; // token symbol
    ...
    uint256 public _buyBackFee = 50; // buyback fee 5%
