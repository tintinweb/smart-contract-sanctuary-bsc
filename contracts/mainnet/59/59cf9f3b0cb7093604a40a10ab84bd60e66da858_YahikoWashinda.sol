...
/*Yahiko (弥彦, Yahiko) was a shinobi who hailed from Amegakure and the original founder of Akatsuki before his death. However, Yahiko's corpse became a vessel for Nagato, who henceforth acted under the name Pain, 
Nagato's Deva Path of the Six Paths of Pain.
https://t.me/yahikowashinda
https://twitter.com/yahikowashinda
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C6cb67d421d063db3Ff269f7920eFDC87F88d80; 
...
contract YahikoWashinda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yahiko Washinda";
    string private _symbol = "PAIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C6cb67d421d063db3Ff269f7920eFDC87F88d80); 
    address payable public teamWalletAddress = payable(0x4C6cb67d421d063db3Ff269f7920eFDC87F88d80); 
    ...
    uint256 public _marketingShare = 149;
