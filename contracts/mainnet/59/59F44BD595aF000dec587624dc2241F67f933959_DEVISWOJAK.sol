...
//telegram: https://t.me/DEVISWOJAK 
interface IERC20 {
...
contract DEVISWOJAK is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 3_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 3_000_000 * 10**_decimals;

    address public marketingAddress = 0xe33D64B07D8b154a5780CC3c1bb6EC6a4AA447F1;
    address public devAddress = 0xe33D64B07D8b154a5780CC3c1bb6EC6a4AA447F1;

    string private constant _name = "DEV IS WOJAK";
    string private constant _symbol = "$DIW";
    ...
    Taxes public sellTaxes = Taxes(0,3,4,0);
