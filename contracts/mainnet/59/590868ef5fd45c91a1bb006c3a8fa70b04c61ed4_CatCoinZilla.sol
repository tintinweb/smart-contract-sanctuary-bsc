...
contract CatCoinZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "CatCoinZilla"; 
    string private constant _symbol = "CATCZ"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet = 0x1a5d7C9CBB4926a6a2bDCFBf1e3f11D2393A5fFe; 
