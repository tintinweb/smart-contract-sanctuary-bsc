...
contract Defiex is ERC20Detailed, Ownable, ReentrancyGuard{
    ...
    uint256 public rewardYield = 120000000;
    //Value 120000000 to get 1.2% weekly 
    //Value 100000000 to get 1.0% weekly 
    //Value  50000000 to get 0.5% weekly
    //Value  rewardYield / rewardYieldDenominator = Value Reward based on rebaseFrequency (below)
  
    
    uint256 public rewardYieldDenominator = 10000000000;

    uint256 public rebaseFrequency = 604800;
   // Value  604800 to get weekly
   // Value   86400 to get daily 
   // Value    3600 to get Hourly
    ...
    uint256 public constant MAX_FEE_BUY = 0;
    uint256 public constant MAX_FEE_SELL = 0;
    uint256 private constant MAX_REBASE_FREQUENCY = 604800;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY =
        10 * 10**8 * 10**DECIMALS;
      //  23 * 10**8 * 10**DECIMALS;
//idea che viene da amplephort per evitare che col tempo la totale supply superi il max di UINT256= 2 alla 256 -1
...
//MMonaco to change RECEIVER 
    address public liquidityReceiver =
        0x0744775a694bF22709823DabBAc4a3e2AB0F530a;
   ...
   address public usdtToken = 0x55d398326f99059fF775485246999027B3197955; //mainnet
    //address public usdtToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; //BSC testnet
   // address public usdtToken = 0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD; //Rinkeby testnet 
    ...
    constructor() ERC20Detailed("DEFIEX Token", "DEFIEX", uint8(DECIMALS))
    {
        router = IDEXRouter(0x2Bf55D1596786F1AE8160e997D655DbE6d9Bca7A); //mainnet
       // router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //rinkeby
...
function _burn(address account, uint256 amount) internal virtual {
   ...
   // _beforeTokenTransfer(account, address(0), amount);
   uint256 value=amount.mul(_gonsPerFragment);
  _gonBalances[account] = _gonBalances[account].sub(value, "ERC20: burn amount exceeds balance");
  _totalSupply -= amount;
    emit Transfer(account, address(0), amount);
