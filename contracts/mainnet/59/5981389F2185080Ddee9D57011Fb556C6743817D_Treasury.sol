...
contract Treasury is ERC721Holder, ReentrancyGuard, AccessControlEnumerable {
    ...
    uint256 public acc;
    address public token = 0x17A3D3C4302f8732Ad093059C75fF3Da4D25e623;
    address public medals = 0xdbde4CB32e7138EB1B2F4EC53488C2d390f765a6;
    ...
    function deposit(uint256[] calldata tokenIds) external nonReentrant {
        ...
        for(uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if(msg.sender == owner) {
                ...
                ERC721(medals).safeTransferFrom(msg.sender, address(this), tokenIds[i]);
            }
        }
        if(depositEffect > 0) {
    ...
    function withdraw(uint256[] calldata tokenIds) external nonReentrant {
        ...
        for(uint256 i = 0; i < tokenIds.length; i++) {
            ...
            ERC721(medals).safeTransferFrom(address(this), msg.sender, tokenIds[i]);
            userMedalCount[msg.sender][medalIds[i]] -= 1;
