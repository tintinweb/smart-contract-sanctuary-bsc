...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function belongsTo(address owner) public view virtual returns (uint256) {
        uint256 tokenId = _belongsTo(owner);
        return tokenId; // Returns 0 if address holds no token
    }
     ...
     */
    function _belongsTo(address owner) internal view virtual returns (uint256) {
