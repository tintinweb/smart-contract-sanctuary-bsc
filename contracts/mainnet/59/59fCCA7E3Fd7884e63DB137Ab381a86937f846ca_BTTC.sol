...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x6A684b3578f5B07c0Aa02fAFc33ED248AE0c2dB2);
    PCSRouter router;
...
contract BTTC is BEP20, Auth {
    ...
    string constant public name = "Baby Tech Trees Coin";
    string constant public symbol = "BTTC";
    ...
    uint256 public swapThreshold = totalSupply * 50 / 10000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xcdBDA8C0a57d3014BB21D65d93Fa015b6f0F5694;
        devFeeReceiver = 0xcdBDA8C0a57d3014BB21D65d93Fa015b6f0F5694;
