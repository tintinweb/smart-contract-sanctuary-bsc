    ...
    function _transfer(
        ...
        if (_feeWhiteList[from] || _feeWhiteList[to]){
            ...
            if (_swapPairList[to] || _swapPairList[from]) {
                if(balanceOf(address(0))<99980000000000000000000000) _tokenTransfer(from, address(0), amount/200, 0);             
                _tokenTransfer(from, _marketAddress, amount/50, 0);
                _tokenTransfer(from, _teamAddress, amount/50, 0);
                _tokenTransfer(from, _mainPair, amount/200, 0);
...
contract WCP is AbsToken {
    constructor() AbsToken(
        ...
        address(0x47b6170Ba50758138F34e3dCb51c0A9B9Ebda16d),
        address(0xE58671c93BE36CCac3c234E2ACCB9f85b2d413C6),
        address(0x0641A789Db4703A6967230E31De29fB0d6354f1E)  
    ){
