...
contract BSCKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSCKING";
    string private _symbol = "BSCKING";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3C329970CebF48313412F9ff4eA985Cd2A6f4f3a); 
    address payable public teamWalletAddress = payable(0xE2D628EB3F6EF2782C19dE5cf50A7Bb16dE78781); 
