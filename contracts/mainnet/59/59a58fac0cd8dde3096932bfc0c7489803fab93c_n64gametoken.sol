...
contract n64gametoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "N64 Game Token"; // 
    string private constant _symbol = "N64"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xE6EfB4045E3C419e48e6e3a3c3dd05Ec03831aA1;
    ...
    function _transfer(
        ...
        //if any account belon gs to _isExcludedFromFee account then remove the fee
