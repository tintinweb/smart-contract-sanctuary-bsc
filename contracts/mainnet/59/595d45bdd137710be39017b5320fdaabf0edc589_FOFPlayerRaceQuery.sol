...
contract FOFPlayerRaceQuery is Ownable {
    ...
    address public pancakeswapV2Pair = 0x1C4Fa53c39aF429D98AA8b85246feb8428c1Fe49;
    ...
    function sort2(uint256[] memory arr, uint256[] memory vehicleIds) public pure returns(uint256[] memory,uint256[] memory) {
