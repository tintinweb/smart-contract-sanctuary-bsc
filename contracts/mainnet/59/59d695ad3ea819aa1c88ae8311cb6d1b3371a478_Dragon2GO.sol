...
contract Dragon2GO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x14Eaac86f80C03D0929f71aE2190f99b5fE4ae08); 
    address payable public Wallet_Dev = payable(0x6e480119dC344A02Fa721026668bf7a2331E130c);
    ...
    string private constant _name = "Dragon2GO"; 
    string private constant _symbol = unicode"DRAG2GO"; 
    ...
    constructor () {
        ...
        _owner = 0x13AAb67839b77B89Db96ee79F5C80442e632343d;
