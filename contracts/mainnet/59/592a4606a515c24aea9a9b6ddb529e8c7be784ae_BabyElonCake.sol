...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0xB104a776fdA9836Cd25a22B0a9B74A14354b9473);
...
contract BabyElonCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyElonCake";
    string constant _symbol = "ElonCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x822F4E120a1086B474B541aaeA1Ceb4379cDAd7f; //change;
