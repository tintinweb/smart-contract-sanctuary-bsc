...
https://t.me/Kakashi_Inu_Official
...
contract KakashiInu is IBEP20, Auth {   
    using SafeMath for uint256;
    ...
    string constant _name = "Kakashi Inu";
    string constant _symbol = "KAINU";
    ...
    function setFees(uint256 _liquidityFee, uint256 _sellFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        sellFee = _sellFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_sellFee).add(_reflectionFee).add(_marketingFee);
