...
contract FLOKI is Context, IERC20, Ownable {
    ...
    string private _name = "Longterm Floki Inu";
    string private _symbol = "FLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF60671aB8359e551b9A2513EDD98e6aFA32561B4); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF60671aB8359e551b9A2513EDD98e6aFA32561B4); // BuyBack Address
