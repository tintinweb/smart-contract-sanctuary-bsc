...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x55Ed56e7A9466AE8a969549Cb7f4Be673fd98d4b;
...
contract KILLOINU is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x55Ed56e7A9466AE8a969549Cb7f4Be673fd98d4b;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 89000000000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KILL0 INU";
    string private _symbol = "KILL0INU";
