...
contract RCTTEST4 is Context, Ownable, IERC20 { 
    ...
    string private constant _name = "RCTTEST4"; 
    string private constant _symbol = unicode"$RCT4"; 
    ...
    uint256 public autoLiquidityTaxPercent = 20;
    ...
    function setMaxTxPercent(uint256 value) public onlyOwner {
        require(value >= 2 && value <= 10, "Max tx percent must be between 2 and 10");
    ...
    function setTaxPercents(uint256 developmentPercent, uint256 marketingPercent, uint autoLiquidityPercent) public onlyOwner {
        require(developmentPercent + marketingPercent + autoLiquidityPercent == 100, "Sum of tax percents must be equals to 100");
        ...
        require(autoLiquidityPercent >= 20, "Auto liquidity tax percent must be greater than or equals 20");
