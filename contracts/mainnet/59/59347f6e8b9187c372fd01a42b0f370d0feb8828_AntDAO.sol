...
contract AntDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x2dB31C8676234C0635bc3dB4F14cCe7B845f5dF1;
    address public receiveSellFeeWallet = 0x836d243b854a921028BA514aa0Ba23bbba655278;
    IWrap public wrap = IWrap(0x79215b67D0D6A4B478B70142ccf1eAbfE40878DE);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Ant DAO", "AD", 18, 310000000 * 10 ** 18){
        address msgSender = _msgSender();
