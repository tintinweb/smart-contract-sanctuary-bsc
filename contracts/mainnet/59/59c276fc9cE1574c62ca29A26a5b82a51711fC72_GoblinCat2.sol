...
/* Token contract */
contract GoblinCat2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3DdDaa632800B325b793DB54A4B2a0C3B052B858;
    ...
    // Name and symbol
    string constant _name = "Goblin Cat 2.0";
    string constant _symbol = "GCAT2";
