...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A798a89D3A8bb9EFd58E05fC964463fB0e96688; // owner address
...
contract eightbluetick is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "8$ Blue Tick";
    string private _symbol = "8 Usd";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x3A798a89D3A8bb9EFd58E05fC964463fB0e96688); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A798a89D3A8bb9EFd58E05fC964463fB0e96688); // Team Address
