...
contract CATSCEO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CATS CEO";
    string constant _symbol = "CATSCEO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 420000000000 * 10**_decimals;

    uint256 public _maxTxAmount = 420000000000 * 10**_decimals;
    uint256 public _maxWalletToken = 420000000000 * 10**_decimals;
    ...
    uint256 public swapThreshold = 4200000000 * 10**_decimals;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD3a7B0ADc758EB483dbaAa9F885E377C63096836;
        marketingFeeReceiver = 0xD3a7B0ADc758EB483dbaAa9F885E377C63096836;
        devFeeReceiver = 0xD3a7B0ADc758EB483dbaAa9F885E377C63096836;
