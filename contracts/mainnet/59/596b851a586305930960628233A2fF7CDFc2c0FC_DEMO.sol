...
contract BaseToken is Ownable {
    ...
    string constant public name = 'LoverDoge';

    string constant public symbol = 'LoverDoge';
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muul(_taxFIEE).div(100)+0;
        uint256 burn =  value.muul(_burnFIEE).div(100)+0;
