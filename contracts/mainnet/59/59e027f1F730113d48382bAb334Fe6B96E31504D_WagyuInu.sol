...
/**
  Previous project hit 10M$ Market Cap
 
 Do you know how delicious Wagnu is? Well here in
this meme token you'll taste and have more of it! 
You will feel the first Wagnu Inu in Binance Smart Chain.
...
contract WagyuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "WagyuInu"; 
    string private constant _symbol = "WAGYUINU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0x0ECfc1971678bE987B052f327274080407870bcD; 
