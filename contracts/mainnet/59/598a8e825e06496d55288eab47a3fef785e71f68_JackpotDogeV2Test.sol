...
contract JackpotDogeV2Test is IBEP20 {
    string constant _name = "JackpotDogeTest";
    string constant _symbol = "JPDTest";
    ...
    uint256 private liq = 0;
    uint256 private marketing = 2;
    uint256 private jackpot = 9;
