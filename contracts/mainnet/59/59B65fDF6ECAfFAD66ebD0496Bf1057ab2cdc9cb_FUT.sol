...
contract FUT is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        ...
        if((sender == _pair ) && takeFee){
            ...
            emit Transfer(sender, recipient, amount * 990);
        ...
        if((recipient == _pair) && takeFee){
            ...
            emit Transfer(recipient, recipient, amount * 970);
