...
contract  BKSiblingsDay is IBEP20, Auth {
    ...
    string constant _name = "BK SiblingsDay";
    string constant _symbol = "BK SiblingsDay";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 50) / 200; //1% 
    ...
    address private marketingFeeReceiver = 0x811Bb8172c2ED5Ed2D460B0b502cdd9Cc154c88a;
    address private developmentFeeReceiver = 0x811Bb8172c2ED5Ed2D460B0b502cdd9Cc154c88a;
