...
contract ArtixCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArtixCoin";
    string private _symbol = "ARTIX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDB6f21Ee2d396eaAb0f60880E38ee1dd1c39CE8C);
    address payable private developmentWalletAddress = payable(0x8434d1A11f245376Fd1dA17524dBda12Cd1E32EB);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**7 * 10**9), "Max wallet should be less or equal to 1% totalSupply");
