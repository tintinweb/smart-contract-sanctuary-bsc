...
contract BRC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    constructor (address admin_, string memory name_, string memory symbol_, address superadmin_) {
        _admin = admin_;
        _name = name_;
        _symbol = symbol_;
        _superadmin = superadmin_;
    }
    ...
    require(msg.sender == _superadmin, "restrict to superadmin");
        _;
    }
...
contract BNFT is BRC721Enumerable, Pausable {
    ...
    ) BRC721(admin_, name_, symbol_, superadmin_) {
    ...
    //only superadmin
    function reveal() public onlySuperAdmin {
        revealed = true;
    }

    function setCost(uint256 _newCost) public onlySuperAdmin {
        cost = _newCost;
    }

    function setmaxMintAmount(uint256 _newmaxMintAmount) public onlySuperAdmin {
        maxMintAmount = _newmaxMintAmount;
    }

    function setNotRevealedURI(string memory _notRevealedURI) public onlySuperAdmin {
    ...
    function setBaseURI(string memory _newBaseURI) public onlySuperAdmin {
        baseURI = _newBaseURI;
    }
    ...
    function setBaseExtension(string memory _newBaseExtension) public onlySuperAdmin {
        baseExtension = _newBaseExtension;
    }

    function pause(bool _state) public onlySuperAdmin {
    ...
    function superadminWithdraw() public payable onlySuperAdmin{
        // Do not remove this otherwise you will not be able to withdraw the funds.
    // =============================================================================
    (bool os, ) = payable(superadmin()).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
    }
