...
fanoria gives holders access to a variety of fan-related membership perks
 like voting on club decisions, rewards, and merchandise designs

https://twitter.com/FanoriaToken
 TG > https://t.me/FANORIA
http://www.FANORIA.ORG/ 
 ...
 * the owner.
 */
contract FANOwnable is FANContext {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "FANOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FANOwnable: new owner is the zero address");
...
contract FANORIA is FANContext, BEP20, FANOwnable {
    ...
    string private constant _name = "$FANORIA"; // 
    string private constant _symbol = "$FANORIA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x2B700E05b2309cfAE940014E48A1596951782852;
