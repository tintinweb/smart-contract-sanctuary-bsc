...
contract ASCENSION is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xcFF2445af45eEAfac89fa8fB4d643210415D0660);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xcFF2445af45eEAfac89fa8fB4d643210415D0660); 
    address payable public treasuryWallet = payable(0xcFF2445af45eEAfac89fa8fB4d643210415D0660); 
