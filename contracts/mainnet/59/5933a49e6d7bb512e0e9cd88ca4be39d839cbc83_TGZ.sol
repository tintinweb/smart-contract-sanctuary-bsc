...
contract TGZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Telegram Zilla";
    string private _symbol = "TGZ";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address BG
    address payable private TeamWallet = payable(0xC1c61f54797Bce3d0c8a62F2D54036594777924e); // Buy Back Address
