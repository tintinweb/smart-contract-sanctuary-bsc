...
contract WhenBinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "WhenBinance";
    string private constant _symbol = "$WHENBNB";
