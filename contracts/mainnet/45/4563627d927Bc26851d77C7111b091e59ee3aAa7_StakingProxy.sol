...
contract StakingProxy is Ownable {
    ...
    constructor(
        address _PAL, // PAL Token contract address
        address _sPAL, // sPAL Token contract address
    ...
    function stake(uint _amount, address _recipient) external returns (bool) {
        ...
        claims[_recipient] = Claim({
            ...
            gons: claimInfo.gons.add(IsPAL(sPAL).gonsForBalance(_amount)),
    ...
    function claim(address _recipient) public {
        ...
        IERC20(sPAL).transfer(_recipient, IsPAL(sPAL).balanceForGons(claimInfo.gons));
    }
