...
//PROJEC:HALLOW BAT COIN = DEV

pragma solidity ^0.8.5;

//https://twitter.com/HallowBatCoin
//https://t.me/HallowBatCoinBSC
...
contract hallowbatCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLOW BAT COIN"; // 
    string private constant _symbol = "HBC"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xF3928aEc7fe8B11390a60Bfe525656A2F44db18A);
