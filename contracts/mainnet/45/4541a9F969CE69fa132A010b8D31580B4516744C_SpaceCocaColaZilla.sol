...
contract SpaceCocaColaZilla is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x4e7068f8c04548dD026e64A5BEC00bCB15862159);
    ...
    string private constant _name = "SpaceCocaColaZilla"; 
    string private constant _symbol = unicode"$SCCZ"; 
    ...
    constructor () {
        ...
        _owner = 0x12cD3dA75dCF008DBe244d7518328AE4d0C46CBD;
