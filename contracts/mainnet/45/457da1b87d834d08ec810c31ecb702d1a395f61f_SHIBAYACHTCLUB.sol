...
contract SHIBAYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Yacht Club";
    string private _symbol = "SYCLUB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F41749f6756A3d91d19e04080cC16Da31335FEC); 
    address payable public DevelopmentalWalletAddress = payable(0x82425D891c65664253D2706b39909fd9D5c67F82); 
    ...
    uint256 public _walletMax = 50000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2500000000 * 10**9; 
