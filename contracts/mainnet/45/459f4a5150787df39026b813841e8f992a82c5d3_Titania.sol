...
contract Titania is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Titania";
    string constant _symbol = "Titania";
    ...
    uint256 public sellMultiplier  = 141;
    ...
    constructor (address newOwner) Auth(newOwner) {
        ...
        mooninsuranceFeeReceiver = 0x3c5CCbD0A4Cc950AFB6C66E8A6C77b9053a2e76b;
    ...
    function set_sell_multiplier(uint256 Multiplier) external onlyOwner{
        ...
        require(Multiplier < 141, "Sell Fees cannot exceed more than 20% of the buy tax");  
    }
