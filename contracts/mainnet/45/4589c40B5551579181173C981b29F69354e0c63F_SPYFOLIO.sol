...
contract SPYFOLIO is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0xAD8CD7B535B9CE534ff3C20D60588661fAd6277c);
    ...
    string private constant _name = "Spyfolio";
    ...
    function collectFees() external onlyOwner()  {
        ...
        _basicTransfer(address(this), _marketingWallet, developmentTokensToSell );
    }
