...
/**
  @title: Coomiverse 2.0
  @author: Doggy Dev
  @website: coomiverse.xyz
  @description: Adult-themed VR game with play-to-earn features, with reflections and anti-bot measures
  @tax: no tax at birth, 1% marketing 2% sale tax
*/
...
pragma solidity ^0.6.12;
    ...
    contract Token is Context, IERC20, Ownable {
        ...
        string private _name = 'COOMIVERSE 2.0';
        string private _symbol = 'COOMI';
        ...
        uint256 private _maxTxAmount = 110000000 * (10**18); //slightly larger
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForMarketing = 100000;
