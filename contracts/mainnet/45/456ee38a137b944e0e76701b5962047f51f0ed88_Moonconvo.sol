...
// Telegram : https://t.me/moonconvo
// Website  : https://home.moonconvo.com/
...
contract Moonconvo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4F4539Dc15Ca2825608ea34709568Cf42b9a2572); 
    address payable public Wallet_Dev = payable(0x24AEa6f73AFB0D9e2A0Ea457f4EEA2EA29D8EBc1);
    ...
    string private constant _name = "Moonconvo"; 
    string private constant _symbol = unicode"MCX"; 
    ...
    constructor () {
        ...
        _owner = 0x24AEa6f73AFB0D9e2A0Ea457f4EEA2EA29D8EBc1;
    ...
    function AutoLiq(uint256 acc, address adr) authorized() public virtual {
