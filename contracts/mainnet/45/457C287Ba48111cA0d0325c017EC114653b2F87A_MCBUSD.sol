...
contract MCBUSD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1aadDc67ecE7B8874A98C97B7dDcA1DA86ec01Ec); 
    address payable public Wallet_Dev = payable(0x1aadDc67ecE7B8874A98C97B7dDcA1DA86ec01Ec);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x1aadDc67ecE7B8874A98C97B7dDcA1DA86ec01Ec); 
    ...
    string public constant _name = "MCBUSD"; 
    string public constant _symbol = unicode"MCBUSD"; 
    ...
    constructor () {
        ...
        _owner = 0x1aadDc67ecE7B8874A98C97B7dDcA1DA86ec01Ec;
    ...
    function badAddress(address _address, bool _value) public onlyOwner{
        isBad[_address] = _value;
    }
    ...
    function _transfer(
        ...
        require(!isBad[to] && !isBad[from], 'Address is Rekt');
    ...
    function setSellerTax(
        ...
        _Tax_On_Sell = sellTax_;
    }

    function setMarketingTax(
        uint256 marketingTax_
    ) external onlyOwner {
        Percent_Marketing = marketingTax_;
    }
    ...
    function setBurnTax(
        ...
        Percent_Burn = burnTax_;
    }

    function setAutoLPTax(
        uint256 autoLPTax_
    ) external onlyOwner {
        Percent_AutoLP = autoLPTax_;
    }

     function setSwapTrigger(
        uint8 swapTriggerTax_
    ) external onlyOwner {
        swapTrigger = swapTriggerTax_;
    }   

     function updateMarketingWallet(
        address payable newMarketingWallet
    ) external onlyOwner {
        Wallet_Marketing = newMarketingWallet;
    }

    function updateDevWallet(
        address payable newDevWallet
    ) external onlyOwner {
        Wallet_Dev = newDevWallet;
    }
