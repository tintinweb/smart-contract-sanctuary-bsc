...
contract PaypalxMeta is Context, IERC20, Ownable {
    ...
    string private constant _name = "Paypal x Metamask";
    string private constant _symbol = "PxM";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 1000 * 10**8 * 10**8;
    uint256 private constant _swapTokenAmount = 1 * 10**8 * 10**8;
