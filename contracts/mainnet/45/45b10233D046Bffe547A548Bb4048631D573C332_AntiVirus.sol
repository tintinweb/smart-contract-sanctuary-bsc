...
contract AntiVirus is Ownable, IERC20 {
    ...
    string private _name = "AntiVirus";
    ...
    function setSellLiquidityFee(uint256 amount) external onlyOwner {
        require(amount < 10);
        _liquiditySellFee = amount;
    }
    function setSellMarketingFee(uint256 amount) external onlyOwner {
        require(amount < 10);
        _marketingSellFee = amount;
    }
    function setMarketingWallet(address wallet) external onlyOwner {
        _marketingWallet = wallet;
    }
    function setLiquidityReceiver(address wallet) external onlyOwner {
        _liquidityReceiver = wallet;
    }
