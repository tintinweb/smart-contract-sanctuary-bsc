...
// Telegram : https://t.me/SamuraiBlue_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f657556FF2488EA659686207388352c8F9ae100; // owner address
...
contract samblue is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Samurai Blue";
    string private _symbol = "sBlue";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x8f657556FF2488EA659686207388352c8F9ae100); // Marketing Address
    address payable public teamWalletAddress = payable(0x8f657556FF2488EA659686207388352c8F9ae100); // Team Address
