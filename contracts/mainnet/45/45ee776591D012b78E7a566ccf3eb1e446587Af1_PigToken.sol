...
contract PigToken is IBEP20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalFeeAmount = lpAmount + marketAmount;
        if(totalFeeAmount > 0){
            ...
            totalFeeAmount = lpAmount + marketAmount ;
            uint256 totalFeeAmount2 = lpAmount.div(2) + marketAmount ;
