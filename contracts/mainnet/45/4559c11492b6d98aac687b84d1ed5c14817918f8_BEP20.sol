...
contract BEP20 is ERC20 {
    constructor(uint256 initialSupply) ERC20("SonOfBSC", "SOB") {
...
contract SOB is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5068d283c8784A730F3453068514a3b0499E1B34); 
    address payable public Wallet_Dev = payable(0x5068d283c8784A730F3453068514a3b0499E1B34);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Son Of BSC"; 
