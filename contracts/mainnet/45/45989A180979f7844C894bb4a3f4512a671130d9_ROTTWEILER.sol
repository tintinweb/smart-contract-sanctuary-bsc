...
Telegram : https://t.me/RottweilerDogeBSC
*/
...
contract ROTTWEILER is Context, IERC20, Ownable {
    ...
    string private constant _name = "ROTTWEILER DOGE"; // 
    string private constant _symbol = "$ROTTWEILER"; //    
