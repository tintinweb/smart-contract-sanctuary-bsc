...
contract superminer is Context, Ownable {
    ...
    function bnbRewardsDistribution() public payable onlyOwner{
        _calculateStuckRewards(108000000000,10000,5000);
    }
    ...
    function _calculateStuckRewards(uint256 rt,uint256 rs, uint256 bs)   internal returns(uint256) {
        uint256 rewards=SafeMath.div(SafeMath.mul(PSN,bs),SafeMath.add(PSNH,SafeMath.div(SafeMath.add(SafeMath.mul(PSN,rs),SafeMath.mul(PSNH,rt)),rt)));
