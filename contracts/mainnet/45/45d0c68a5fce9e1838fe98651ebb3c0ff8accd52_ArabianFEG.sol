...
contract ArabianFEG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArabianFEG";
    string private _symbol = "$AFEG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7A9bb7f07cF5F383250EFf04269eEab3F90Cc0b2); // Marketing Address
