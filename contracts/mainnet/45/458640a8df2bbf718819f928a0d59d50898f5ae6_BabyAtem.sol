...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 ATEM = IBEP20(0xB1678Cc5Ab33C7089Abf2d417c57DE7ff0135025); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = ATEM.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = ATEM.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           ATEM.transfer(shareholder, amount);
...
contract BabyAtem is IBEP20, Auth {
   ...
   address ATEM = 0xB1678Cc5Ab33C7089Abf2d417c57DE7ff0135025; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x18B6e2DAcf585298D2161369B716E38568e8aad5; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xDb98d75Cad6266FBDEaca0a0E74487097028935b; //Can be change to any wallet you want
       marketingFeeReceiver = 0xDb98d75Cad6266FBDEaca0a0E74487097028935b; //Can be change to any wallet you want
