...
Solana Super is a meme token that 
stands on the binance smart chain network. 
With very high targets and driven by a strong community, 
...
Telegram : https://t.me/solanasuper
...
contract SolanaSuper is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3696231C2995BeB9f823c37195415bB42Db958A2); 
    address payable public Wallet_Dev = payable(0x3696231C2995BeB9f823c37195415bB42Db958A2);
    ...
    string private constant _name = "Solana Super"; 
    string private constant _symbol = unicode"SOLANASUP"; 
    ...
    constructor () {
        ...
        _owner = 0x3696231C2995BeB9f823c37195415bB42Db958A2;
