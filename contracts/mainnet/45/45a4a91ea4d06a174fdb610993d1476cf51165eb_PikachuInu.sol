...
library Address{
 ...
 contract PikachuInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xcCCE151161851E62234fdfbe0F47118C16Be36f7;
    address public donationWallet = 0xcCCE151161851E62234fdfbe0F47118C16Be36f7;

    string private constant _name = "Pikachu Inu";
    string private constant _symbol = "Pikachu Inu";
    ...
    Taxes public taxes = Taxes(2, 20, 0, 0);
    Taxes public sellTaxes = Taxes(2, 20, 0, 0);
