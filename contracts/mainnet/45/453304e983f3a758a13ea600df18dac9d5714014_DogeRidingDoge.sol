...
contract DogeRidingDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10001 * 10**9;
    ...
    address payable private _dev = payable(0xe6fC97Ff01D8eaf6521671D329F3C545BD2D3Bd8);
    address payable private _mw = payable(0xe6fC97Ff01D8eaf6521671D329F3C545BD2D3Bd8);
    
    string private constant _name = "DogeRidingDoge";
    string private constant _symbol = "DRD-1";
