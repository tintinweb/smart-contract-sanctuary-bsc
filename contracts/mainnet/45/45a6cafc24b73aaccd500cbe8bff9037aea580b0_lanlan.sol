...
contract lanlan is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "lanlan";
    string constant _symbol = "LAN";
    ...
    function _getTradeStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
    }    
    
    function _getSwapSettings(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  

    function _getFeeExempt(address holder, bool exempt) external authorized {
        isFeeExempt[holder] = exempt;
    }

    function iniOwnership(address shareholder, uint256 _amount) internal {    
