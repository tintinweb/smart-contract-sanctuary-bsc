...
contract CypherminerERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("CHELACOIN", "CHELA", 18) 
    ERC20Permit("CHELACOIN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 42000000000000000000000000); 
