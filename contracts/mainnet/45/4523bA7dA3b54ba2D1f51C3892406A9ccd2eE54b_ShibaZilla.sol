...
将在群组满30人时发射，不要错过2.0，我们会拥有强大的流量从SHIBAZILLA获得
...
contract ShibaZilla  is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaZilla2.0"; 
    string private constant _symbol = "SZ2.0";
    ...
    address public treasuryWallet = 0x3aEad659199DCC2B8Fbe7cbDf6332A4E60B9F2e1;
    address public devWallet = 0x3aEad659199DCC2B8Fbe7cbDf6332A4E60B9F2e1;
