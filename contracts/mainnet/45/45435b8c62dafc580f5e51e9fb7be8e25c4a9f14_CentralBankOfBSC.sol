...
contract CentralBankOfBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Central Bank Of Binance Chain Coin";
    ...
    address public privateSalersFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x28e68303358f7F283B26e80eC9F66b7cda6a0A42;
        teamFeeReceiver = 0xf6eEADf2e48B6ADAd4cB8144ce46e08079579933;
        privateSalersFeeReceiver = 0xf715fe05A096291fC47BB54dbe030f9b0b273f2D;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != teamFeeReceiver && recipient != privateSalersFeeReceiver && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBprivate = amountBNB.mul(privateFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
        (tmpSuccess,) = payable(privateSalersFeeReceiver).call{value: amountBNBprivate, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _privateSalersFeeReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        burnFeeReceiver = _burnFeeReceiver;
        privateSalersFeeReceiver = _privateSalersFeeReceiver;
    }
