...
contract Migrator is Context {
  ...
  IStakingService constant _nomiswapStakingService = IStakingService(0xD2C5A61e09387283E4a647661CafD89B067d2801);
  ...
  function migrate(MigratePayload calldata payload) public returns(uint256 amount0Refund, uint256 amount1Refund) {
    ...
    (uint256 amount0,) = removeLiquidity(payload.unstakeSignedAmount);
    uint256 amount1 = IERC20(_nmxAddress).balanceOf(address(this));
