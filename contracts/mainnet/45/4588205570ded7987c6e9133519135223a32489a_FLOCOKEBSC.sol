...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf9D8b8Ecb91f22E61D52d8d00247b3003E72c835; // owner address
...
contract FLOCOKEBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOCOKE";
    string private _symbol = "FLOCOKE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf9D8b8Ecb91f22E61D52d8d00247b3003E72c835); // Marketing Address
    address payable private teamWalletAddress = payable(0xf9D8b8Ecb91f22E61D52d8d00247b3003E72c835); // Team Address
