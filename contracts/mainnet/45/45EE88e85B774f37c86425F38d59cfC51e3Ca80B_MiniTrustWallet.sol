...
contract MiniTrustWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Trust Wallet";
    string private constant _symbol = "MTWT";
