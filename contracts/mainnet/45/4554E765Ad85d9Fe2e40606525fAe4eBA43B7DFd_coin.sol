...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "KENG DIE";
    string private _symbol = "KENGDIE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xA96af1F30aA82f12916B92F17f92e7a867157E6c); // Marketing Address
    address payable private teamWalletAddress = payable(0xB1c5D424Cb2161f6CAC4411C32326E7f3151910F); // Team Address
    address payable public liquidityAddress =payable(0xA96af1F30aA82f12916B92F17f92e7a867157E6c); // Liquidity Address
