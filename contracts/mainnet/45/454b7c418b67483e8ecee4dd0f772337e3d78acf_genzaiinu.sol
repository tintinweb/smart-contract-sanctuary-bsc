...
contract genzaiinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "GENZAIINU"; // 
    string private constant _symbol = "$GENZAI"; //    
