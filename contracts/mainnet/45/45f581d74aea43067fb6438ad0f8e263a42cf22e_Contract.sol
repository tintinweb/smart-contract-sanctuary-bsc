...
/*
    ...
    $OG token is specifically the new and only token in the BSC network.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23dCb207acAC7B1744dA7a9847c4AE6b61848086; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x23dCb207acAC7B1744dA7a9847c4AE6b61848086); // Marketing Address
    address payable public teamWalletAddress = payable(0x23dCb207acAC7B1744dA7a9847c4AE6b61848086); // Team Address
