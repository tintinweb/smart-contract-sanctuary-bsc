...
contract BabyMetaBlaze is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = ( _tTotal * 80 ) / 100; // 3%

    uint256 public _maxWalletToken = ( _tTotal * 80 ) / 100; // 4%

    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    
    string private constant _name = "BabyMetaBlaze"; // 
    string private constant _symbol = "BabyMetaBlaze"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0x1C474E003F8066a269275e7ff037d909403b76ea;
