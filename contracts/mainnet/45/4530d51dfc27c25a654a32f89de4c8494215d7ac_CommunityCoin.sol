...
contract CommunityCoin  is Context, IERC20, Ownable {
    ...
    //change that
    uint8 public maxLiqFee = 5;                // Transaction fee % Steigerung Liquidity des Community Pool 
    uint8 public maxTaxFee = 3;                // Transaction fee % für alle Halter & Supporter der Community
    uint8 public maxBurnFee = 0;               // Transaction fee % Keine Coins werden verbrannt
    uint8 public maxWalletFee = 2;             // Transaction fee % für Community Projekte & das Team
    //change that
