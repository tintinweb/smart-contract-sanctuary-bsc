...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xCaF122238a2C546e9e9d56B58EE26fF8b1546748;    
...
contract TJToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0xc5a0c38A77D11FE9c00ECE9e58EaF3cFE252bD3D),  //
    
        address(0x234F340C3e34A6D63157af0D5232482B679c3f22) //开发
    ){
