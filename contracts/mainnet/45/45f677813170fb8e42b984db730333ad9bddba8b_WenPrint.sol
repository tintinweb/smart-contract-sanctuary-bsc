...
contract WenPrint is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wen Print";
    string private constant _symbol = "PRINTING";
