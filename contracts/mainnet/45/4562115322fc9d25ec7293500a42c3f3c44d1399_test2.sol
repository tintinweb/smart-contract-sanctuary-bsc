...
contract test2 is Context, IERC20, Ownable {
    ...
    address payable public Marketing = payable(0x8B958D7749E604847F1AC08f3aAf2FaDc161B481);
    address payable public Dev = payable(0x12C91000117F2C7A2954a2C86005EDc54c3d673F);
    ...
    uint256 private _totalSupply = 10 * 10**8 * 10**9;
    uint256 public _maxTxAmount = 10 * 10**8 * 10**9;
    uint256 public _walletMax = 10 * 10**8* 10**9;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(Dev, amountBNBBuyBack);
