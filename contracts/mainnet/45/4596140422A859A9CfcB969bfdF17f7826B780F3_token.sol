...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "DracKing";
    string private _symbol = "DracKing";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xaC6AF4FC558522b36aA3B7da3b6E65BBA6Fa7C2e); // Marketing Address
    ...
    uint256 private _totalSupply = 3 * 5**_decimals;
    uint256 public _maxTxAmount = 3 * 5**_decimals; 
    uint256 public _walletMax = 3 * 5**_decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 0**_decimals; 
