...
contract MINIZILLA is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0x0F75b219587aB739d5bECcC2a8e5B0aeAABfa381);
    address private liquidityReceiver = address(0x0F75b219587aB739d5bECcC2a8e5B0aeAABfa381);
