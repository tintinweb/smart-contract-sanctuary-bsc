...
contract GoldRushToken is Context, IERC20, Ownable {
  ...
  string private constant _name = "GoldRushToken";
  ...
  uint256 private constant _total = 1 * 10**9 * 10**18;
  ...
  function excludeFromFee(address account) external onlyOwner {
    require (_isExcludedFromFee[account] == false, "This account was already excluded");
    _isExcludedFromFee[account] = true;
    emit ExcludedFromFee(account);
  }
  
  function includeInFee(address account) external onlyOwner {
    require (_isExcludedFromFee[account] == true, "This account was already included");
