...
contract BiswapDnxStrategyAddTwoSidesOptimal is
  OwnableUpgradeSafe,
  ...
  IStrategy
{
  ...
  function initialize(IBiswapRouter02 _router, IVault _vault)
    external
    initializer
  {
  ...
  function execute(
    ...
    IBiswapLiquidityPair lpToken = IBiswapLiquidityPair(
      address(worker.lpToken())
    );
