...
contract BABYINUKOSTAKINGLOCKED is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0x7601aD31506D085109e4680010E988F765783CCa);
        rewardToken = IERC20(0x7601aD31506D085109e4680010E988F765783CCa);

        dividendTracker = new DividendTracker();

        rewardsPerSecond = 0.155 * 1e18;
    ...
    function updatePool(uint256 _pid) internal {
        ...
        if(USDT.balanceOf(address(this)) > 0){
            USDT.transfer(address(dividendTracker), USDT.balanceOf(address(this)));
        }
