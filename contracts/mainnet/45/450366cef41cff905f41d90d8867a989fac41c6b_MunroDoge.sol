...
/**
   ...
   Degen play, I will not take any token. If you want to create a telegram I suggest to name it to @MunroDoge
...
contract MunroDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Munro Doge";
