...
contract RacDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RacDao";
    string private _symbol = "RacDao";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x401606141444C6a4E0fa021b8f9D60C88F05a010); // Marketing Address
    address payable public teamWalletAddress = payable(0x401606141444C6a4E0fa021b8f9D60C88F05a010); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x401606141444C6a4E0fa021b8f9D60C88F05a010),
            block.timestamp
        );
    }
