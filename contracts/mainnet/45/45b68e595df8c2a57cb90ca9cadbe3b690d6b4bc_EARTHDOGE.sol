...
contract EARTHDOGE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC8C15f38385Cd92Cd581E2190975e1840dc11676;

    string private constant _name = "EarthDoge";
    string private constant _symbol = "EarthDoge";
    ...
    Taxes public taxes = Taxes(0,46,0,0);
