...
contract BlueCheckmark is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x91f9AAc60D2447f83219CC2104090722d885AfFE;
    address public DevelopmentWallet = 0x91f9AAc60D2447f83219CC2104090722d885AfFE;
    ...
    Taxes public taxes = Taxes(0, 3, 2, 2);
    Taxes public sellTaxes = Taxes(0, 3, 2, 2);
