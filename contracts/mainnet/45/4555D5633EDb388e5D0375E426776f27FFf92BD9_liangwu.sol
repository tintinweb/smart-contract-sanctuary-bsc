...
contract liangwu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "liangwu";
    string private _symbol = "LIANG";
    ...
    function test(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function losecontrol(uint256 _lastRebasedTime, uint256 _tSupply) internal view returns (uint256) {
