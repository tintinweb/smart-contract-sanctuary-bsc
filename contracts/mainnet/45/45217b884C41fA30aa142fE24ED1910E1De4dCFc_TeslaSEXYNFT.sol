...
contract TeslaSEXYNFT is ERC721 {
    ...
    constructor()
        ERC721("Tesla SEXY Collection", "TSC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihuzbn3y6csqouufgplr3b5lhfpcpinxoloqksi5i2f3xoce4gy3m/", Strings.toString(tokenId), ".json")
            );
    }
