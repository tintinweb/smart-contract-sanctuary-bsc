...
// This is a Ponzi smart contract that was used in the www.ponzi.trade project. The main difference between this Ponzi project and others is that in this project the admin does not have any access to your funds. When you want to withdraw your profit, 20% of the amount will be paid to the admin wallet with the address [0x6d898B537673ABdf773F13f7569a1DD5c49CCAe5]. And 10% will be paid to your referrer. As long as the project has new investors, you can withdraw your profits, and if not, you should wait for new investors to join.
...
contract TokenStaking is Ownable {
    ...
    address  private tt=0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
