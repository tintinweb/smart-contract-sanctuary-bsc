...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2b2cFB60431dFEc430Eaa390CCb11Df311f85269;
...
contract CryptoGPTCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoGPT CEO";
    string private _symbol = "GPTCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b2cFB60431dFEc430Eaa390CCb11Df311f85269);
    address payable public teamWalletAddress = payable(0x2b2cFB60431dFEc430Eaa390CCb11Df311f85269);
