...
contract LoveBank is ReentrancyGuard, AccessControlEnumerable {
    ...
    constructor() {
        ...
        iAccount = IAccount(0x56294C50882f36fa6b1f88E1d4C9a7c2Af1F431A);
    ...
    function setBaseRate(uint8 rate) external  onlyRole(OPERATOR_ROLE) {
        baseRate = rate;
    }
    ...
    function setTopBonus(uint8 amount) external onlyRole(OPERATOR_ROLE) {
        topBonusPercent = amount;
    }
    ...
    function setCommentRate(uint8 rate) external onlyRole(OPERATOR_ROLE) {
        commentRate = rate;
    }
