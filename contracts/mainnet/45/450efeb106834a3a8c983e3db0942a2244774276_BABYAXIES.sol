...
contract BABYAXIES is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdEdBC8a689b2E67d1e9d03919a5654eD6A1A0FC9); // Marketing Address
    address payable public charityAddress = payable(0xdEdBC8a689b2E67d1e9d03919a5654eD6A1A0FC9); // Charity/Dev Address
    ...
    uint256 private _tTotal = 210000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BABY AXIES";
    string private _symbol = "BBAX";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000; // 200,000; token will be given on airdrop
    ...
    uint256 private salePrice = 149000000;// 0.01*149,000,000 = 1,490,000 token for 0.01 bnb (set as per requirements)
