...
contract BusdMiner is Ownable {
    ...
    address public oldminer;

	constructor() {
		dev1Address = payable(0x1c72cAAc86BFef423CFC229459eFD03279127462);
		dev2Address = payable(0x1c72cAAc86BFef423CFC229459eFD03279127462);
		prjAddress = payable(0x1c72cAAc86BFef423CFC229459eFD03279127462);
		mrkAddress = payable(0x1c72cAAc86BFef423CFC229459eFD03279127462);

        oldminer = address(0x2c9571De16B18Efc973146C187470156836A7236);
	}
	...
	function buyEggs(address ref, uint256 amount) external initializer {		
        ...
        if(oldminer != address(0)){
            (,uint256 oldTotalDeposit,,,) = BUSDminer(oldminer).userInfo(msg.sender); 
