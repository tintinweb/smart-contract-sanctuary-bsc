...
USDC GROW is a new hype meme token that build on Binance smart Chain as a Decentrallized and autonomous system that build for community
...
//Telegram: https://t.me/usdcgrowbsc
...
contract USDCCOINGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x555DfFe841B043A8260Fa6C696eF6DDF52a7683B); 
    address payable public Wallet_Dev = payable(0x555DfFe841B043A8260Fa6C696eF6DDF52a7683B);
    ...
    string private constant _name = "USDC COIN GROW"; 
    string private constant _symbol = unicode"$USDC GROW💹"; 
    ...
    constructor () {
        ...
        _owner = 0x555DfFe841B043A8260Fa6C696eF6DDF52a7683B;
