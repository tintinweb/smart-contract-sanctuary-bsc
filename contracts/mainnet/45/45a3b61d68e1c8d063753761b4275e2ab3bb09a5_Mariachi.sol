...
contract Mariachi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Mariachi Coin";
    string constant _symbol = "Mariachi";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x84561c0A7737B556AC081Bce8537adBee83bBa4f;
