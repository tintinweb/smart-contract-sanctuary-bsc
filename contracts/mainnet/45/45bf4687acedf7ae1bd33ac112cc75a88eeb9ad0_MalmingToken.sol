...
/**
   ...
   Beli, Hold dan nyangkut.

   Bikin happy aja, bukan koin untuk masa depan.

   Bersatu kita teguh, bercarai kita sangkut bareng.
...
contract MalmingToken is Context, IERC20, Ownable {
    ...
    string private _name = "Malming Token";
    string private _symbol = "MALMING";
