...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x878f35Bfb35Ac5E5F69836C02b1dE94F65ED7120;
...
contract AJR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2F5a12fe87ed1a95906e6a37F46f5e8C07551aB5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AJRANA";
    string private _symbol = "AJR";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 700;
