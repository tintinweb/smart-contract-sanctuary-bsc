...
Tired of dogechain drama? Slow withdraws? Trading bots wrecking the chart? Let's do it the classic way.
...
https://t.me/DogeClassicBSCofficial

Launch date: 19th Aug. 6pm UTC on PancakeSwap
...
contract ClassicDogeBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CLDoge";
