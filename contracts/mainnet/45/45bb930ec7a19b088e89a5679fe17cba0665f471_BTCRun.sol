...
contract BTCRun is Context, IERC20, Ownable {
    ...
    string private constant _name = " BTC Run "; // 
    string private constant _symbol = " $BTCRUN "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xB7a6dDcb2D4529E3489173F223763aD40386fE17;
