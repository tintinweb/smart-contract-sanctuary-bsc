...
contract VALENTINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Valent Inu"; // 
    string private constant _symbol = "VALENTINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0xBe229985632E379870aC206Fec3A8f0B526976fA;
