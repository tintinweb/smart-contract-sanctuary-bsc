...
contract CGOPTIMUS is Context, IBEP20, Ownable {
    ...
    string public _name = "CatGirl Optimus"; // token name
    string public _symbol = "CGOPTIMUS"; // token ticker
    ...
    uint256 private minTokenToSwap = 1000 * 1e9; // 100k amount will trigger the swap and add liquidity
