...
contract SPAE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPAE";
    string private _symbol = "SPAE";
    uint8 private _decimals = 0;

    address payable private marketingWalletAddress = payable(0xCF06Fb332A2bfdfA466bAc4a25caE39248D09B71); 
    ...
    uint256 private _totalSupply = 59 * 10**32;
    uint256 public _maxTxAmount = 59 * 10**32; 
    uint256 public _walletMax = 59 * 10**32;
    uint256 private minimumTokensBeforeSwap = 59 * 10**32;
