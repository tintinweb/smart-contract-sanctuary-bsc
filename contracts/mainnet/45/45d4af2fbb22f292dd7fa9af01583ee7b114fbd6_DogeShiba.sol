...
contract DogeShiba is Context, IBEP20, Ownable { // change name 
    ...
    string private constant _name     = "420Doge"; // change name
    string private constant _symbol   = "420Doge"; // change ticker
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xE533DCebF9cD3EC6A0D412F696988ddc37fdD3eA; 
        _buybackWallet = 0x9CA6b39E1Ef908b19E678d2f385f5C60eb5c6210; 
        ...
        _isExcludedFromAntiWhale[address(0x70eC56374d5c4AeeF895eDd43d6394D654E1982a)] = true; 
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x70eC56374d5c4AeeF895eDd43d6394D654E1982a)] = true; 
...
//Remove from Blacklist 
    ...
    function setAddresses(address teamWallet, address buybackWallet) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if ( bnbForMarketing != 0 ) {
            emit MarketingSent(_buybackWallet, bnbForMarketing);
            payable(_buybackWallet).transfer(bnbForMarketing);
        }
