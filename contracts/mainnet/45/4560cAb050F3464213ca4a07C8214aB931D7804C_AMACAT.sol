...
contract AMACAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AMACAT";
    string private _symbol = "AMACAT";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x571eDD702f75bF65317832E92c84B788faf3A2d0); 
    address payable private teamWalletAddress = payable(0x210fA42F2065786e19f63C99B05D96D38A7E02F6); 
