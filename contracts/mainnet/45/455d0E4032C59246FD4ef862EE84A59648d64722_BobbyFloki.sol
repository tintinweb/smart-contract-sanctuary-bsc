...
contract BobbyFloki is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BobbyFloki";
    string constant _symbol = "BOBBYFLOKI";
    ...
    uint256 public _walletMax = _totalSupply * 100 / 100; // 100%
