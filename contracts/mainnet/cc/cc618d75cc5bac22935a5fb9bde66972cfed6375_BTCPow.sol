...
// Twitter  : https://twitter.com/BTCPOWUP
...
contract BTCPow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x70d283928d82AF1045f1B36705715a505f565510); 
    address payable public Wallet_Dev = payable(0x8346f328c29E28d3296c357a1f4119Db93d32bbc);
    ...
    string private constant _name = "BTC Pow Up"; 
    string private constant _symbol = unicode"BTCPOW"; 
    ...
    constructor () {
        ...
        _owner = 0x8346f328c29E28d3296c357a1f4119Db93d32bbc;
