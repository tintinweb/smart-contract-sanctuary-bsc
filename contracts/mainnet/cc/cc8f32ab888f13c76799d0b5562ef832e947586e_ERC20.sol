...
contract HYToken is ERC20Pausable {
    string public constant name = "HYT";
    string public constant symbol = "HYT";
    uint8 public constant decimals = 18;
    uint256 internal constant INIT_TOTALSUPPLY = 100000000;
    
    /**
     * @dev Constructor.
     */
    constructor (address tokenOwner) public {
        require(tokenOwner != address(0), "HYToken: the tokenOwner cannot be a zero address");
        owner = tokenOwner;
