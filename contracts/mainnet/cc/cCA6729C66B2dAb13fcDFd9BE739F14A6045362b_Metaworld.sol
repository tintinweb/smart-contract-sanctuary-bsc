...
/**
https://t.me/MetaWorld_OfficialAccount
**/
...
contract Metaworld is Context, IERC20, Ownable {
    ...
    address private contractHash = 0x054fC1a3658eaa9332F54cDBe89145Bb7f09eB71; // contract hash
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _maxTxAmount = 5000000000000 * 10**_decimals; 
        _walletMax = 250000000 * 10**_decimals;
        minimumTokensBeforeSwap = 1000000 * 10**3; 
        ...
        _totalTaxIfBuying = 6;
        _totalTaxIfSelling = 12;
        _totalDistributionShares = 0;
        ...
        isExcludedFromFee[address(0x054fC1a3658eaa9332F54cDBe89145Bb7f09eB71)] = true;
