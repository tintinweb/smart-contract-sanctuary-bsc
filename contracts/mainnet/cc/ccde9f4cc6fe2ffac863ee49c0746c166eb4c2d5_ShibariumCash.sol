...
contract ShibariumCash is Context, iBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10000000000000000 * 10**9;
    uint256 private _rTotalsupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Shibarium Cash';
    string private _symbol = 'SHIBCH';
