...
contract KongeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Konge Inu";
    string private _symbol = "KINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31234A5D46AFB68Bd81f3AB2dac393c44c3629a0); // Marketing Address
    address payable public teamWalletAddress = payable(0x31234A5D46AFB68Bd81f3AB2dac393c44c3629a0); // Team Address
