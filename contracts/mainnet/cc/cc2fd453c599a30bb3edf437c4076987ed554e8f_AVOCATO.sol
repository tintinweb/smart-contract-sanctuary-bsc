...
contract AVOCATO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x8672b80C4b01cfE8eD254D453276baA132d6aC50); // Marketing Address
        
    address payable public buybackAddress =
        payable(0x7a050cFC611Fbcbce0F859Febfb70FAb2F048284); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0x7a050cFC611Fbcbce0F859Febfb70FAb2F048284); // Liquidity Address
    ...
    uint256 private constant _tTotal = 69 * 1e6 * 1e4;
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xB277e9f8eDEB880576C144bFe732b4c5d23d64B0).call{value: bnbForDev}("");
