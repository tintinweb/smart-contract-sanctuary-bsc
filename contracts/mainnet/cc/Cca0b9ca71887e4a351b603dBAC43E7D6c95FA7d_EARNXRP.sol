...
/** 
  _____      _      ____    _   _  __  __  ____    ____    
 | ____|    / \    |  _ \  | \ | | \ \/ / |  _ \  |  _ \   
 |  _|     / _ \   | |_) | |  \| |  \  /  | |_) | | |_) |  
 | |___   / ___ \  |  _ <  | |\  |  /  \  |  _ <  |  __/   
...
contract EARNXRP is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "EARNXRP";
    string constant _symbol = "EXRP";
    ...
    uint256 _totalSupply = 100000 * 10**9;
    uint256 public _maxTxAmount =  _totalSupply * 10 / 200;
    uint256 public _walletMax = _totalSupply * 10 / 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4955A66005a12e58aA3430133D0b8C11B88fB839;
        buybackWallet = 0x4955A66005a12e58aA3430133D0b8C11B88fB839;
