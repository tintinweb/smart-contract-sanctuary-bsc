...
contract KaidoInuTwoZero is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Kaido Inu 2.0 ";
    string private _symbol = " $KINU2.0 "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE6F58734649FCdC6ec30F3bde02c2cCe5881F7A7); 
    address payable public teamWalletAddress = payable(0xF08e8b83EBc5010b2A97e7915a57bf3D30DF098E);
