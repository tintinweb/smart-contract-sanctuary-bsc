...
// File: pancakeswap_interface/IPancakeFactory.sol
...
// File: pancakeswap_interface/IPancakeRouter.sol
    ...
    function _transfer(
        ...
        if (to == DEAD_ADDRESS) {
            ...
            if (block.timestamp > startTime + 1 days) {
                ...
                if (
                    IStakePool(stakingPoolAddress).updateReward(
                        dayDestroyAmount
                    )
                ) {
        ...
        if (to != pairAddress && from != pairAddress) {
            ...
            if (feeWhitelist[from]) {
                ...
                if (
                    ...
                    emit Transfer(from, to, toInviterFee);
                } else {
