...
contract KDogeZilla
 is Context, IERC20, Ownable {
    ...
    string private _name = "KDogeZilla";
    string private _symbol = "KDogeZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x818F90093aaE8bC902f702043d9B6fD07172A496));
        _anotherA = payable(address(0x818F90093aaE8bC902f702043d9B6fD07172A496));
