...
// * play.olympians.games - fair games that pay BNB. Version 1.
//
//
...
//
// * Refer to https://play.olympians.games/ for detailed description and proofs.

contract OlympiansMiniGames {
    /// *** Constants section
    ...
    // 4 and 6; for games with modulos higher than threshold (Olympiaroll), a simple
    ...
    // threshold. On rare occasions play.olympians.games croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of play.olympians.games operation.
    ...
    //                    by the olympians.games croupier bot in the settleBet transaction. Supplying
    ...
    function placeBet(uint betMask, uint modulo, uint commitLastBlock, uint commit, bytes32 r, bytes32 s) external payable {
        ...
        if (modulo <= MAX_MASK_MODULO) {
            ...
            // the play.olympians.games whitepaper.
    ...
    // in a situation like this, just contact the play.olympians.games support, however nothing
