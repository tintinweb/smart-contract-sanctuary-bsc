...
contract twitterceoinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter CEO Inu";
    string private _symbol = "TWITTERCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC330462A735C8147Aaa099f62fD12609262C1c60); 
    address payable public buyBackWalletAddress = payable(0x8b961FE63eD74237f2282449E2E89cC3dE01889C); 
