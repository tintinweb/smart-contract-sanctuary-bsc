...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if (_transfersCount > 1)
    {
      if (sender != _panCakeSwapRouter)
      {
          uint256 deadline = _accounts[sender].lastTransferIn + 5 minutes;
          require(now >= deadline, "BEP20: Not possible to sell right now, please wait 5 minutes");
      }
    }
    ...
    _accounts[recipient].lastTransferIn = now;
