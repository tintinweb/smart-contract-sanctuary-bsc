...
Shibrahimovic is meme token from combination of two great characters. Shiba inu and Ibrahimovic.
We know that Shiba Inu is one of famous token meme and have strong community. 
And then, Ibrahimovic is one of the football players from Sweden who plays as a Sticker.
He has a lot of experience and titles. Ibrahimovic has also played for Malmo, Ajax, Juventus, Inter Milan, 
Barcelona, AC Milan, Manchester United, LA Galaxy and Paris Saint Germany.

Join with Our Community on :
Telegram https://t.me/shibrahimovic
Website : TBA
...
contract Shibrahimovic is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibrahimovic";
    string private constant _symbol = "IBRA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x25F1752B250bbE16A7F9dAc9f3aB65E321a07513);
    address payable private _marketingAddress = payable(0x4C11078c25fd2DC5EDbE001c42C712041337d4c8);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 9, "Redis cannot be more than 8.");
	    require(redisFeeOnSell < 9, "Redis cannot be more than 8.");
