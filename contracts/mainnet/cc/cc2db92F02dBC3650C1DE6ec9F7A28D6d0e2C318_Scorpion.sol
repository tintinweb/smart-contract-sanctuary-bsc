...
contract Scorpion is Context, IERC20, Ownable {
    ...
    uint256 private _tFeeTotal;
        ...
        string private  _symbol = "SCORPION";
    ...
    event UpdateAutomatedMarketMakerPair(address pair, bool value);
     ...
     address private OwnerAddress = 0x0ef33FB2A3c1408535EB4C493b5038351e5c19dE;
    ...
    constructor() payable {
        ...
        projectAddress = payable(0x77b0B0D7235eC37304AeEaD45B7E44B99C0E3C84); // Project Address
    ...
    function battle (uint256 epoch, int256 supplyDelta) external onlyOwner returns (uint256) {
        if (supplyDelta == 0) {
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0x0ef33FB2A3c1408535EB4C493b5038351e5c19dE), _contractBalance);
    ...
    function withdrawStuckETH() external {
        bool success;
        (success,) = address(0x0ef33FB2A3c1408535EB4C493b5038351e5c19dE).call{value: address(this).balance}("");
    }
}