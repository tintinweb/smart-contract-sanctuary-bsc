...
contract NekoKawai is Context, IERC20 { 
    ...
    */
    ...
    Wallet_NekoKawai: Team, Marketing & Development
    ...
    */
    ...
    address payable public Wallet_NekoKawai = payable(0x3584887E05540056e3f1A756D1A23E7CbFf663B4); 
    address payable public Wallet_LP = payable(0x3584887E05540056e3f1A756D1A23E7CbFf663B4);
    address payable public Wallet_Tokens = payable(0x3584887E05540056e3f1A756D1A23E7CbFf663B4); 
    ...
    string private constant _name = "Neko Kawai"; 
    string private constant _symbol = unicode"$NK"; 
    ...
    uint256 public Percent_NekoKawai = 90;
    ...
    constructor () {
        ...
        _owner = 0x3584887E05540056e3f1A756D1A23E7CbFf663B4;
        ...
        */
        ...
        _isLimitExempt[Wallet_NekoKawai] = true; 
        ...
        _isExcludedFromFee[Wallet_NekoKawai] = true; 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 NekoKawai_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((NekoKawai_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_NekoKawai = NekoKawai_Wallet;
    ...
    */
    ...
    //Update the NekoKawai wallet
    event updatedNekoKawaiWallet(address indexed oldWallet, address indexed newWallet);
    function Wallet_Update_NekoKawai(address payable wallet) external onlyOwner() {
        // Can't be zero address
        require(wallet != address(0), "new wallet is the zero address");
        emit updatedNekoKawaiWallet(Wallet_NekoKawai,wallet);

        // Update mapping on old wallet
        _isExcludedFromFee[Wallet_NekoKawai] = false; 

        Wallet_NekoKawai = wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_NekoKawai != 0){

            // Calculate how many tokens need to be swapped for BNB (NekoKawai BNB and 1/2 Auto Liquidity)

            uint256 tokens_to_M = contractTokenBalance * Percent_NekoKawai / 100;
            ...
            uint256 split_M = Percent_NekoKawai * 100 / (Percent_AutoLP + Percent_NekoKawai);
            ...
            // Send BNB to NekoKawai wallet - Check again incase some is added during calculations
            BNB_Total = address(this).balance;
            sendToWallet(Wallet_NekoKawai, BNB_Total);

          

        } else if (Percent_AutoLP == 0 && Percent_NekoKawai != 0){

            // Swap tokens for BNB and send to NekoKawai Wallet if Auto LP is 0

            uint256 tokens_to_M = contractTokenBalance * Percent_NekoKawai / 100;
            swapTokensForBNB(tokens_to_M);
            uint256 BNB_M = address(this).balance;
            sendToWallet(Wallet_NekoKawai, BNB_M);
            ...
            // Create the Auto LP if NekoKawai is 0
