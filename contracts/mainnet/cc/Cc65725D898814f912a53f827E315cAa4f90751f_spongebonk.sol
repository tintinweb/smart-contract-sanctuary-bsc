...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8D2490cc22a54Dc78C0Fe824Cbfcc8f12a83Bb9A; // owner address
...
contract spongebonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPONGEBONK";
    string private _symbol = "SPONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x67620E68319db3F298857b7f2597AEe601176132); // Marketing Address
    address payable public teamWalletAddress = payable(0x67620E68319db3F298857b7f2597AEe601176132); // Team Address
