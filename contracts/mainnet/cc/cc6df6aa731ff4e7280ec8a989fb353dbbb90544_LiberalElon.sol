...
contract LiberalElon is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x8098d66dACC02DA53De862A40Fc2855354b178e8;
    address DevWallet       = 0x16120D1deD0B73398eEFC46a5AC238BE92E3A73A;

    string constant _name = "LiberalElon";
    string constant _symbol = "LIBERAL";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 40000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 40000 * (10 ** _decimals);
