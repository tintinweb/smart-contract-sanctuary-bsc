...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SINU = IBEP20(0x91011693694BCb5838DdBC8cb328E6aF340b1F13);
...
contract WizardzV2 is IBEP20, Auth {
    ...
    address SINU = 0x91011693694BCb5838DdBC8cb328E6aF340b1F13;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Wizardz V2";
    string constant _symbol = "WIZ";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(ecosystemFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _ecosystemFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        ecosystemFee = _ecosystemFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_ecosystemFee).add(_marketingFee);
