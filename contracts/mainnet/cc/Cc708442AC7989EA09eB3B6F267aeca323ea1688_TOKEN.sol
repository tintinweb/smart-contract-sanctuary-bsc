...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_Against[from]){
            require(_rewardUserCanTransferTo[to],"against");
        }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000,
        address(0xFf0570D07B14a4A0c2f57655fECd468b9B8f6561),//fund1
        address(0x3deE1efA27ab0F9b454622f9F19794B0Feb0655F),//fund2 = reward
        address(0xD878f169257ee874C1C70abd9DcCdE1b712Df0aF)//claim & receiver
    ){
    }
}