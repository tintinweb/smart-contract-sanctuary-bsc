...
//
//
//   📱Telegram::https://t.me/+1iaU4-Sr1z9jZWY1
//   📱Website :: https://publicholidays.sg/chinese-new-year/
/*
...
contract RabbitChinese is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Rabbit Chinese", "RabbitChinese") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RabbitChinese";
    string private _symbol = "RabbitChinese";
