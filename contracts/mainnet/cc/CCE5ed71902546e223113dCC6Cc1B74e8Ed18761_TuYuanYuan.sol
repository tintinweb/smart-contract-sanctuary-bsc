...
contract TTTDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract TuYuanYuan is ERC20, Ownable {
    ...
    TTTDividendTracker public dividendTracker;
    ...
    address public funsWalletAddress;
    ...
    constructor(
        ...
        _marketingWalletAddress = 0xA7a3a9327232545EBaD9490A8656d4AF4aa86b28;
        funsWalletAddress = 0x6B1e450347131f0493327358476399c971e866b2;

        buyTokenRewardsFee = 300;
        buyMarketingFee = 300;
        sellTokenRewardsFee = 300;
        sellMarketingFee = 300;
        uint256 totalSupply = 100000000000 * (10**9);
        swapTokensAtAmount = 50000000 * (10**9);

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        dividendTracker = TTTDividendTracker(
            payable(Clones.clone(0x07E2a4b8b12f63f47D44DD55C77B1551ad9098C9))
        );
        ...
        excludeFromFees(funsWalletAddress, true);
        excludeFromFees(_marketingWalletAddress, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x16c7C6bEbB7dA81A12CE35388561Ca51aeBa10FF, true);
        _mint(0x16c7C6bEbB7dA81A12CE35388561Ca51aeBa10FF, totalSupply);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(rewardToken).transferFrom(address(_tokenDistributor),_marketingWalletAddress, newBalance);
