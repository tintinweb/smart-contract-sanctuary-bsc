...
contract LuuxNetwork990 is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x995F1409346724883f75414ef10AF28f58925d72);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 50**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x995F1409346724883f75414ef10AF28f58925d72;
