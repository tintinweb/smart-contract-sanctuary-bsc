...
contract MBP_SHOOTER_IDO is Context, Ownable {
    ...
    address private IDO_TOKEN_ADDRESS = 0xBaf928369Eb10c71461Cda6972F35eEDe6D2F5FD;
    ...
    uint256 public MINIMUM_MBP_HOLDING = 25_000 * (10**18);
    uint256 public MINIMUM_INVESTMENT = 50 * (10**18);
    uint256 public MAXIMUM_BUY_AMOUNT = 200 * (10**18);
    ...
    uint256 public HARDCAP = 20_000 * (10**18);
