...
contract  FOOTBALLDOG is IBEP20 , Auth { 
    using SafeMath for uint256;
    string internal _name;
    string internal _symbol;
    uint8   internal _decimals;
    uint256 internal _totalSupply;
    string public tokenType="FOOTBALLDOG";
    ...
    constructor(  
        ...
        _name ="FOOTBALL DOG";
        _symbol = "FOOTBALL DOG";
        _decimals=18; 
        _totalSupply = 10* 10**12 * 1 ether;
        ...
        marketingAddress = [0x505a0dF4b6Ce0b4C0602eB229cE8FB58f8A704B3,0xfdb05cB0F552325f4C2b911618e71C8B7B888888];
        marketingShare=[5,1];  

        fees=Fee(700,700,700,10000);
        allot=Allot(6,1,0,7); 
