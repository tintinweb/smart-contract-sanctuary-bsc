...
contract BabyCloudChat is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'Baby CloudChat';
    string private constant _symbol = 'Baby CLoudChat';
