...
contract LovelyFlokiInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Lovely Floki Inu";
    ...
    uint256 public _walletMax = _totalSupply * 52 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x13E06Ef8247aB98539eB0B71ae006C1e7569c9b7;
