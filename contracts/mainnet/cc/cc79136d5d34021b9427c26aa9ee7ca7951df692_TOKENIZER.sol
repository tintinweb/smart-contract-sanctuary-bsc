...
contract TOKENIZER is Context, IERC20, Ownable {
    ...
    string private constant _name = "TOKENIZER";
    string private constant _symbol = "TOKENIZER";
    ...
    constructor () {
        _feeAddrWallet = payable(0x6CE32AECedF59f2D6B43455D1f5f09E548E10EfB);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] && cooldownEnabled) {
                ...
                cooldown[to] = block.timestamp + (200 seconds);
            }
