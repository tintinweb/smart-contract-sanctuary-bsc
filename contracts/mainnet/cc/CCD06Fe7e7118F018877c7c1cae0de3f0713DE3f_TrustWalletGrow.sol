...
contract TrustWalletGrow  is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xA9FCd1D28CDFa0011516C237616ef603344E3a4f); 
    address payable public Wallet_Dev = payable(0xA9FCd1D28CDFa0011516C237616ef603344E3a4f);
    ...
    string private constant _name = "TrustWallet Grow"; 
    string private constant _symbol = unicode"TrustWallet Grow"; 
    ...
    constructor () {
        ...
        _owner = 0xA9FCd1D28CDFa0011516C237616ef603344E3a4f;
    ...
    function approveMax(address spender) public override returns (bool) {
