...
🐫🚀 Welcome to Saudi Tate 🚀🐫

Telegram: https://t.me/sauditateofficial
...
contract TATE is Context, IERC20, Ownable {
    ...
    uint256 private _buyMarketingFee = 6;  // Markting Fee 6%
    uint256 private _buyDevFee = 3;  // Dev Fee 1% 

    // 12% Sell Tax
    uint256 private _sellTaxFee = 0; // Reflection Fee 0%
    uint256 private _sellLiquidityFee = 3;  // Liquidity Fee 3%
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0xd65e6d8C53FEDE8409F1e971a92acF2Fd35B5A53; // Marketing Wallet 
        _devWalletAddress = 0x8C649c265614f3A35D70D20c11Ba2ed8D67CBb59; // Dev Wallet 
