...
/**
İtachi inu is from the famous Naruto series, Itachi Uchiha,
is a character in Masashi Kishimoto's manga Naruto. 
Portal https://t.me/itachinuportal
...
contract Itachinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe258Bbd5663B5A217819C89D374cFA0Ad0787bBa); 
    address payable public Wallet_Team = payable(0xe258Bbd5663B5A217819C89D374cFA0Ad0787bBa);
    ...
    string private constant _name = "ITACHINU"; 
    string private constant _symbol = unicode"IINU"; 
    ...
    constructor () {
        ...
        _owner = 0xe258Bbd5663B5A217819C89D374cFA0Ad0787bBa;
