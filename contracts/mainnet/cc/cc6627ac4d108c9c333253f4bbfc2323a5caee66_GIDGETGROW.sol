...
*//* Gidget Grow
    ...
    🌮 The Taco Bell dog 🌮 LIVES ON through memes!

    🐕 Gidget Grow was once the mascot of Taco Bell. 🔔 We had legendary MEME dogs in BSC such as Cheems, Doge, Walter, and more! 

    Now it's time for Gidget the famous Chihuahua to shine!

    🌮 Gidget Grow tokenomics
    TOTAL TAX = 7% in / out

    Tax breakdown:
    🌯 - 2% Liquidity
    🌯 - 4% Marketing
    🌯 - 1% Charity (For the owner of GidgetGrow)

    🐕Max wallet 3% 🐕

    https://t.me/GidgetGrow
...
contract GIDGETGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "GIDGET GROW";
    string private constant _symbol = "$GIDGETGROW";
    ...
    address private marketingWallet = address(0xFd8D73C6a59C2B785ed72c52fcAAAE3Ec50bf827);
    address private liquidityReceiver = address(0xFd8D73C6a59C2B785ed72c52fcAAAE3Ec50bf827);
