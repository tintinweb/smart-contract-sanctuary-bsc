...
contract SquidBirthdayToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SquidBirthday";
    string private _symbol = "SquidBirthday";
    ...
    function setLiquidityWalletAddress(address newAddress) public onlyOwner() {
