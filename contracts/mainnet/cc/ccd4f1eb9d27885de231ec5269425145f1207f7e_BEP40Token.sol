...
contract BEP40Token is Context, IBEP40, Ownable {
     ...
     * allowance.
     *
     * See {BEP40-_burn} and {BEP40-allowance}.
     *
     * Requirements:
     *
    ...
    function extractBEP40(address token) public onlyOwner {
        IBEP40 _ibep40 = IBEP40(token);
        _ibep40.transfer(owner(), _ibep40.balanceOf(address(this)));
    }
}