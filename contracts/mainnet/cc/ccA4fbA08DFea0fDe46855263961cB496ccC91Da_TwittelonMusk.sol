...
contract TwittelonMusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twittelon Musk";
    string private _symbol = "TWITTELON";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xa7BAa08e9eAAf5Ba41539596f46B8ef46c493860);
    ...
    uint256 private _totalSupply =  44000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 22000000000 * 10**_decimals;
    uint256 public _walletMax =  4400000000 * 10**_decimals; 
    uint256 public _maxTxAmount =  4400000000 * 10**_decimals;  
    ...
    uint256 public _endRewardSupply = 44000000000000;
