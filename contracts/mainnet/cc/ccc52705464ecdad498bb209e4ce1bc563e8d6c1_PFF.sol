...
Telegram    : https://t.me/prayforFTT
Website     : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8B84D87845be23Fa6a9235a20Ecf709440380990; // owner address
...
contract PFF is Context, IERC20, Ownable {
    ...
    string private _name = " Pray For FTT ";
    string private _symbol = " PFF ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8B84D87845be23Fa6a9235a20Ecf709440380990); // Marketing Address
    address payable public teamWalletAddress = payable(0x8B84D87845be23Fa6a9235a20Ecf709440380990); // Team Address
