...
contract Punisher is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Punisher";
    string constant _symbol = "PUNISHER";
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 0.4%    
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[devWl] = true;
        isTxLimitExempt[devWl] = true;
        isTimelockExempt [devWl] = true;
        ...
        autoLiquidityReceiver = 0xAc49810E89c1934A314265B54b7a2CB85EF835f4;
        marketingFeeReceiver = 0x01d21E2F68B78c7E63646937ba9bFa7a09e591fE;
        teamFeeReceiver = 0x01d21E2F68B78c7E63646937ba9bFa7a09e591fE;
        charityFeeReceiver = 0x01d21E2F68B78c7E63646937ba9bFa7a09e591fE;
        devWl = 0xAc49810E89c1934A314265B54b7a2CB85EF835f4;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != teamFeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver && recipient != devWl ){
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _charityFeeReceiver, address _devWl) external authorized {
