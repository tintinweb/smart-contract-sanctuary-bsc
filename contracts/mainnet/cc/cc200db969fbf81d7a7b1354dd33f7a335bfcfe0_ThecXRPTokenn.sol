...
/**
   #cXRP The New Community XRP Token
    
   I make this #cXRP to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityXRP
   ...
   I will renounce the ownership to burn addresses to transfer #cLuna to the community and ensure it's 100% safe.

   Can you make #cXRP 10000000X? 
*/
...
contract ThecXRPTokenn is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Community XRP";
    string private constant _symbol = "cXRP";
    ...
    address private marketingWallet = address(0xBC5958D4cfad3985438eec3A273B13B9456D9C6C);
