...
contract KuCheUnik is Context, IERC20, Ownable {
    using SafeMath for uint256;  

    string private _name = "KuCheUnik";
    string private _symbol = "KCUK";
    ...
    function updateKuCheUnikFee(address account) external onlyOwner {
    ...
    function _getKuCheUnikRate() private view returns(uint256) {
    ...
    function updateKuCheUnikMaxTx(uint256 max) external onlyOwner {
        _maxTxAmount = max;
    }
