...
contract FlokiSnake is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FlokiSnake";
    ...
    address private marketingWallet = address(0x4e2B9DF4ADDBACDb8a687d496a8D041679C51270);
    address private liquidityReceiver = address(0x4e2B9DF4ADDBACDb8a687d496a8D041679C51270);
