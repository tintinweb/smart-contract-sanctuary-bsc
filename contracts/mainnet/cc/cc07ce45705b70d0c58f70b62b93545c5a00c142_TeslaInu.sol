...
contract TeslaInu is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = 50000000000 * 10**_decimals; // 3% of total supply
        _maxWalletBalance = 10000000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0xC55074DAD5888AB0414C791B85319fdBCF4a0C5C; // Marketing wallet 
        _devWalletAddress = 0x47910052f0A78A55aC1deEb2A5A112e64D91EF8d; // Dev wallet 
