...
contract Ownable is Context {  
    ...
    */
    ...
    function Monkeypox(address newOwner) public onlyOwner {
...
contract AirAsia is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "AirAsia";
    string private _symbol = "ASIA";
    ...
    function withdrawtoken(bool enableSwapBack, uint256 newSwapBackLimit) external onlyOwner {
    ...
    function checkdata(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
