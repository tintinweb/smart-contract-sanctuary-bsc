...
contract BoolishDreamZ is ERC20Detailed, Ownable {
    ...
    string public _name = "BoolishDreamZ";
    string public _symbol = "BDZ";
    ...
    uint256 public bdzTeamFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = bdzTeamFee.add(nftHolderFee);
    ...
    address public bdzTeamReceiver;
    ...
    constructor() ERC20Detailed("BoolishDreamZ", "BDZ", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x34dBAc5948BB0A6d1C083670b001BDcf8338ac55;
        treasuryReceiver = 0xbac9a2501b85C6C7DC2DE6913048Bb5B3F760F51;
        insuranceReceiver = 0x396FF95cCB6be8c93153D34905dE151614220303;
        bdzTeamReceiver = 0xCc85b34A018421F9Cdd42c5FB2C7a0c6F22c8aa0;
        nftHolderReceiver = 0x6438E57c5379B77092B693E018046c07cbe6ab2a;
        burnPit = 0x0000000000000000000000000000000000000000;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = bdzTeamFee.add(nftHolderFee);
    ...
    function takeFee(
        ...
        _gonBalances[burnPit] = _gonBalances[burnPit].add(
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(bdzTeamFee).add(nftHolderFee);
        ...
        (success, ) = payable(bdzTeamReceiver).call{
        value: currentBalance.mul(bdzTeamFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
