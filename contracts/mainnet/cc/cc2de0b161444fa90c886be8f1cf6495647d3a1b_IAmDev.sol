...
contract IAmDev is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "I Am Dev";
    string private _symbol = "Dev";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x8905d0D34d36b5aeE27094B8b4b0937Fa6Ac3C1C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0f2F397a14DAE7D67721A93D18aEF02d9B79f0fb); // BuyBack Address
