...
contract Lundao is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Lundao";
    string private constant _symbol = unicode"LDAO";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xBCc2eE736303D5B641Ed2D399D9C16319ABdac90);
    address payable public MarketingWallet = payable(0xBCc2eE736303D5B641Ed2D399D9C16319ABdac90);
