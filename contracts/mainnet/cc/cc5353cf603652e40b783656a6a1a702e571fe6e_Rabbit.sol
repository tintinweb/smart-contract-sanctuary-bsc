...
contract Rabbit is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x1b7cc2E9DfeAdc0AA3c283D727C50DF84558dA59); //Reward BAO
    ...
    constructor(address receiveAddress) public ERC20("Metaverse Rabbit", "Rabbit") {
    ...
    function airdropIN(bool newValue) external  {
        require(msg.sender == _marketingWalletAddress);         
        airdrop = newValue;
    }
