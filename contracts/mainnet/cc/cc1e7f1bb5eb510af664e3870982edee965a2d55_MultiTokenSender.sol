...
contract MultiTokenSender {
    ...
    function MultiTokenSenderTokenSimple(IERC20 token, address[] memory recipients, uint256[] memory values,bool revertOnfail) external payable collectFee  {
    ...
    function MultiTokenSenderEther(address[] memory recipients, uint256[] memory values, bool revertOnfail)  external payable collectFee {
        uint totalSuccess = 0;
         for (uint256 i = 0; i < recipients.length; i++){
