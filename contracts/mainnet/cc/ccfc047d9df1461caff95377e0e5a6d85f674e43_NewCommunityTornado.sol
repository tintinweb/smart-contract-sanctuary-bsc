...
JUST IN: Tornado Cash DAO website is now offline.

Telegram : https://t.me/NewCommunityTornadoOfficial
...
contract NewCommunityTornado is Ownable, IBEP20 {
    ...
    string constant _name = "NewCommunityTornado";
    string constant _symbol = "NCT";
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 10);
        require (newTotalSell < 10);
