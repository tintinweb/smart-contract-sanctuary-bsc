...
contract UGCStaking {
    ...
    function seteligibility(
        ...
        if (
            users[upline].teamturnover >= TEAM_TURNOVER_AMOUNTS_MONTHLY[0] &&
        ...
        if (
            users[upline].teamturnover >= TEAM_TURNOVER_AMOUNTS_MONTHLY[1] &&
        ...
        if (
            users[upline].teamturnover >= TEAM_TURNOVER_AMOUNTS_MONTHLY[2] &&
        ...
        if (
            users[upline].teamturnover >= TEAM_TURNOVER_AMOUNTS_MONTHLY[3] &&
