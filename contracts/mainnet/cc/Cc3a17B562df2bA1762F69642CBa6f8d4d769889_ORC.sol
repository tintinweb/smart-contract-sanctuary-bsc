...
contract ORC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Orion Cash";
    string private constant _symbol = "ORC";

    address public _PancakeSwapV1RouterUniswap = 0x7BB55cA0A4D61d4e3C35dcE3767DFCAFecC127D0; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x7BB55cA0A4D61d4e3C35dcE3767DFCAFecC127D0; //can be the same
