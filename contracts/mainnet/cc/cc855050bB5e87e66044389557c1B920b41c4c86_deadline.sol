...
contract deadline is Context, IERC20, Ownable {
    ...
    string private _name = "Killer egg";
    string private _symbol = "Killer egg";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x47E9337EEcB26EBc8e29253Db379FF5Afa4f7Fa4));
        marketingWalletAddress = payable(address(0xFEa5034395bf8c0Fcb1e6cbe0C4a4cb30d830cbE));
