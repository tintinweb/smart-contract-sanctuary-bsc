...
contract NancyPelosiPump is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x7E094c80044ECb97f60D8746F14DEE81fe94108d); // Marketing Address
        
    address payable public teamAddress =
        payable(0xc50E563757429C35C76641D1D8E4217875A1E681); // Team Address
        
    address payable public liquidityAddress =
        payable(0x1756Ff7903BCd210BF09E609d0E026efC57eF609); // Liquidity Address
    ...
    string private constant _name = "NancyPelosiPump";
    ...
    uint256 private constant TRANSFER = 50;
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 12, "Must keep taxes below 12%");
