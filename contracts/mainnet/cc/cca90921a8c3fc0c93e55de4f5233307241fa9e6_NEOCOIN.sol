...
contract NEOCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5F0fC9371B421818Bf5D12BAEea4004e550E1928); 
    address payable public teamWalletAddress = payable(0x5F0fC9371B421818Bf5D12BAEea4004e550E1928); 
    ...
    uint256 public _walletMax =  1_000_000_000_000_000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 500_000_000 * 10**9; 
