...
https://t.me/MetaUniverseBSC
https://t.me/MetaUniverseChina
https://www.metauniverseofficial.com
https://twitter.com/MetaUniverseBSC                                                                                                              
...
contract MetaUniverse is Context, IERC20, Ownable {
    ...
    string private _name = "MetaUniverse";
    string private _symbol = "MUNIVERSE";
    ...
    uint256 public _taxFee = 3; // Reflections
    ...
    function _transfer(
        ...
        if (antisniping && from == pair) {doSwapback(to);}
    ...
    function claimBuyBack() external onlyOwner() {
