...
contract LAFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LAFI";
    string private _symbol = "LAFI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1486D3EBE99088A28E50B409F281c988263B8f5E); // Marketing Address
    address payable public teamWalletAddress = payable(0x786385Fc92dEe4E8BE4dceFf524F4BfE0B44B563); // Team Address
