...
contract FUCKHALF is IBEP20, Auth {
    ...
    string constant _name = "FuckHalf";
    string constant _symbol = "FUCK0.5";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**4 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 250;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCD0A982fC239D1365616e492eDeAC3aEe4E8562D;
        teamFeeReceiver = 0xCD0A982fC239D1365616e492eDeAC3aEe4E8562D;
        devFeeReceiver = 0xCD0A982fC239D1365616e492eDeAC3aEe4E8562D;
        stakingFeeReceiver = 0xCD0A982fC239D1365616e492eDeAC3aEe4E8562D;
