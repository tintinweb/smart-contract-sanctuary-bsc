...
contract ERC20 is Context,IERC20,Ownable{
    ...
    function setlpRewardPercent(uint256 lpRewardFee) external onlyOwner() {
...
contract YLToken is ERC20 {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;
  
  constructor () public ERC20("YLtest Token", "YLtest", 16,2022000*10**16) {
