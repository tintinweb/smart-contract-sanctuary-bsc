...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF3102Fed9f2573b6454C036e318dA370113530e8; // owner address
...
contract StarbucksFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Starbucks Floki";
    string private _symbol = "SBF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93eA0bfDc91799C6Ed0A310C9F92cC59181F8BFA); // Marketing Address
    address payable public teamWalletAddress = payable(0xd7A3FF768df65cAf7050A715AF22c34124Ae6604); // Team Address
