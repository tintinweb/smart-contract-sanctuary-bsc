...
contract jTokenGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "J Token Girl"; //
    string private constant _symbol = "GJ1"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 8;
    address private _marketingWallet = 0x0366f2ea05D0095dD2967F4cfADA99fb0Cef8096;
    ...
    function _setFee(uint256 _fee) onlyOwner public {
        _marketingFee = _fee;
        _liquidityFee = _fee;
    }
