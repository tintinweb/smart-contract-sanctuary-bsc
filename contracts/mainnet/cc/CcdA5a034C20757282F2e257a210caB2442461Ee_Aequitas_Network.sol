...
library AequitasMath {

    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "AequitasMath: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "AequitasMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) 
    {
        ...
        uint256 c = a * b;
        require(c / a == b, "AequitasMath: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "AequitasMath: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "AequitasMath: modulo by zero");
    }
...
contract Aequitas_Network is Context, IERC20, Ownable 
{
    using AequitasMath for uint256;
    ...
    uint256 private _tTotal = 133700000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Aequitas Network";
    string private _symbol = "AEQ";
