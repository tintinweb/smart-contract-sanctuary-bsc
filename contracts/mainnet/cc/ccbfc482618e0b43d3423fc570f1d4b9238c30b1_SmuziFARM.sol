...
contract SmuziFARM {
    ...
    address smuzi = 0xA9703e9846fc958fEC2543218EBd9f7Ff12Ea3E3;
    uint256 public constant INVEST_MIN_AMOUNT = 25000000 ether;
    ...
    function withdraw() public {
		...
		uint256 contractBalance = IBEP20(smuzi).balanceOf(address(this));
    ...
    function getContractBalance() public view returns (uint256) {
        return IBEP20(smuzi).balanceOf(address(this));
    }
