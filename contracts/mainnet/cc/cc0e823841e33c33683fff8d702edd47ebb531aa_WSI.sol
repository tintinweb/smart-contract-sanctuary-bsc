...
https://twitter.com/Willsmithinu
KEEP MY WIFE NAME OUT YA FUCKIN MOUF
WILL SMITH INU is the next hottest crypto meme this bull run! We are an experienced DeFi native team, 
a community of chads; and most importantly the NEXT bullish meme in the hottest bull market of 2022! $WSI to the moon! 
WSI
*/
...
contract WSI is WSIDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private WSITeam;
    address private CharityWSI;
    ...
    string public override name = "Will Smith Inu";
    string public override symbol = "WSI";
    ...
    constructor(uint totalSupplyValue, address WSITeamAddress, address CharityWSIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        WSITeam = WSITeamAddress;
        CharityWSI = CharityWSIAddress;
       
        // split the tokens according to agreed upon percentages
        balances[WSITeam] =  totalSupply * 4 / 100;
        balances[CharityWSI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's WSITeam pot
