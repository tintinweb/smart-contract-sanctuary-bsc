...
contract CatJump is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;

    address public marketingAddress = 0x5fE57Ce813a8e7D7E2597C1f4AF24468f0faa9Ae; // Marketing wallet Address.
    address public ecosystemAddress = 0xA45E72d049BCAA046A76439547A820521A4c663d; // Ecosystem wallet address. 
    ...
    string private _name = "CatJump";
    string private _symbol = "CATJUMP";
    ...
    constructor () 
    {
        ...
        _isExemptFromTxLimit[ecosystemAddress] = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 ecosystemTokens = amount.mul(_ecosystemFee).div(100);
        amount = amount.sub(marketingTokens).sub(ecosystemTokens);
        ...
        if(ecosystemTokens>0) { _transferStandard(sender, ecosystemAddress, ecosystemTokens); }
        restoreAllFee();
    }
    ...
    {
        _amount = _amount.mul(100).div(100-_marketingFee-_ecosystemFee);
    ...
    function setSaleFee() private {
        ...
        _ecosystemFee = _saleEcosystemFee;
    }
    
    function setAllBuyFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 ecosystemFee) external onlyOwner() 
    {
    ...
    function setAllSaleFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 ecosystemFee) external onlyOwner() 
    {
