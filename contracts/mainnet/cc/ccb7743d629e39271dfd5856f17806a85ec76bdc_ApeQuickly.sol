...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("ApeQuickly_Track", "AQ", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract ApeQuickly is Main {
    ...
    constructor() Main (
        ...
        0x1A2EDB5d9f4841167875D0DD998e7C90d2C2B168,     // Marketing address
        0x1A2EDB5d9f4841167875D0DD998e7C90d2C2B168,     // Team address AND DEV
        0x1A2EDB5d9f4841167875D0DD998e7C90d2C2B168,     // Multi Use address (CHARITY)
