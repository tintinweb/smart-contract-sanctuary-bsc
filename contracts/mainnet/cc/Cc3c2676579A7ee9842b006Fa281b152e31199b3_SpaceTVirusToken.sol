...
contract SpaceTVirusToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceTVirus";
    string private _symbol = "SpaceTVirus";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x73Ab21B3377582EA0F4B6bC6f0429FaBB80b570b); 
