...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x59eB96F0B6f5838021f0E8f412Afe65D1Bf44A02);
...
contract PICATINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PICATINU";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x59eB96F0B6f5838021f0E8f412Afe65D1Bf44A02;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x2878675457C397658B22ec90445997ED16E8E816;
        marketingWallet = 0x3D51BF93CceeE59aD6c1203300709f00f5447340;
        teamwallet = 0x3D51BF93CceeE59aD6c1203300709f00f5447340;
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess1,) = payable(teamwallet).call{value: anothermarketingShare, gas: 30000}("");
