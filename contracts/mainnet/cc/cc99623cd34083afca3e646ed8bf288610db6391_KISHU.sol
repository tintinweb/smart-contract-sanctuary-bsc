...
KISHU is a meme token that was taken from the name hype . This token is community based and an experienced team in the crypto field . 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6F8685509256FD990bdeC9C2512bEE9bdbc97Bfb;
...
contract KISHU is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x6F8685509256FD990bdeC9C2512bEE9bdbc97Bfb);
    ...
    */
    ...
    // Default is true
    function set_Auto_Reward(bool true_or_false, uint256 _uint) external onlyOwner {
