...
//100% liquidity burn 
//Tokenomics 3% Auto Add liquidity 4% Marketing
//Max wallet 2% = 20 Billion PooMoon of supply from 1 wallet
//Tottal Supply 1,000,000,000,000

pragma solidity ^0.8.4;
// SPDX-License-Identifier: MIT

//TG Community - https://t.me/PooMoonofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x419cA5F8F6eFc7430Df00e7edA5A80B41Eb32C83;
...
contract POOMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = "Poo Moon"; // 
    string private constant _symbol = "$PooMoon"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 3;
    address payable public  _marketingWallet = payable(0x419cA5F8F6eFc7430Df00e7edA5A80B41Eb32C83);
