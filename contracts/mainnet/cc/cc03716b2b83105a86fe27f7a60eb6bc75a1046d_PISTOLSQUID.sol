...
/**
    pistol squid
    Telegram : https://t.me/pistolsquid
*/
...
contract PISTOLSQUID is Context, IERC20, Ownable {
    ...
    string private constant _name = "PISTOL SQUID";
    string private constant _symbol = "$PISTOLSQUID";
