...
RoosterCoin
Telegram : https://t.me/Rooster_Coin
...
contract RoosterCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rooster Coin";
    string private _symbol = "rooster";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6C2e6c8C3cd26b9FFCa3Ba5c21474045C560F688); 
    address payable public donationWalletAddress = payable(0x6C2e6c8C3cd26b9FFCa3Ba5c21474045C560F688); 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee).add(_donationFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBuyBack = amountReceived.mul(_donationFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBLiquidity).sub(amountBNBBuyBack);

        transferToAddressETH(marketingWalletAddress, amountBNBMarketing);
        transferToAddressETH(donationWalletAddress, amountBNBBuyBack);
