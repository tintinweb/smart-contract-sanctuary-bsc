...
contract Racb is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("Racb", "1Racb") {
		...
		Doge = IERC20(0x265f8a96dAc545a6423E175541D1c3ff5EBAC4C1);
	...
	function _splitOtherDogeToken() private {
        ...
        if(thisAmount >= 10**18){
            _splitOtherTokenDogeSecond(thisAmount.div(5).mul(4));
        }
    }
