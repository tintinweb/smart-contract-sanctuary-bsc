...
contract STELLARMUSK is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 510000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'STELLAR MUSK';
    string private constant _symbol = 'STELLARMUSK';

    uint256 private _taxFee = 700;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 510000000000 ether;
