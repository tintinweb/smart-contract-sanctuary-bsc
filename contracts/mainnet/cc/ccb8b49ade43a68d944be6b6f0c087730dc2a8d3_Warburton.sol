...
contract Warburton is Context, IERC20, Ownable{
  ...
  string private _name = "Warburton";
  string private _symbol = "Warburton";
  uint8 private _decimals = 9; 

  uint8 public liquidityShare;
  uint8 public marketingShare;
  uint8 public buyBackShare;
  uint8 public totalTaxBuy;
  ...
  function TomasMan(address[] calldata accounts) external onlyOwner {
