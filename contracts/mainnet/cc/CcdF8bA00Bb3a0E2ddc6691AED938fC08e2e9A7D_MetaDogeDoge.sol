...
contract BaseToken is Ownable {
    ...
    string constant public name = "MetaDogeDoge";

    string constant public symbol = "MetaDogeDoge";
    ...
    address public projectAddress = 0xa9a8c36EAc2d39Cd1767F6Cd3b5CdfC6845402d7;
...
contract MetaDogeDoge is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0xa9a8c36EAc2d39Cd1767F6Cd3b5CdfC6845402d7;
