...
contract FLOKISuperSAIYAN is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public __getETHBalance = 983444146345003;
  uint256 public _getTaxFee = 0;
  uint256 public _getMaxTxAmount = 2;
  uint256 public _setTaxFee = 5;
  uint256 public _setMarketingFee = 1;

  constructor() public {
    _totalSupply = 1 * 10**17 * 10**9;
