...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xF6F2B7850a63bE9f1A15251C4De636fa3BC2aBe3);// Rewards
    IDEXRouter router;
...
contract MUDRAPRO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mudra Pro";
    string constant _symbol = "MUDRAPRO";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**7 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 33;//3%
    uint256 public _maxWalletToken = _totalSupply / 33;//3%
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + buybackFee + burnFee + developmentFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xcEc753ebFa103EBf5730809d7F6EAcdd3A0767Bb;
        marketingFeeReceiver = 0x9c7A9d80336406aE7BDEE244D14dE59c2a051a40;//mkt
        buybackFeeReceiver = 0x9c7A9d80336406aE7BDEE244D14dE59c2a051a40;//11
        developmentFeeReceiver = 0x9c7A9d80336406aE7BDEE244D14dE59c2a051a40;//11
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _developmentFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _buybackFee + _burnFee + _developmentFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _burnFeeReceiver, address _developmentFeeReceiver ) external authorized {
