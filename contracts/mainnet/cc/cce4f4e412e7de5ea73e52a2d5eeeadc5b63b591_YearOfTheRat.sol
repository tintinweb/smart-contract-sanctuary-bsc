...
// TG : https://t.me/Yearoftherat_official
...
contract  YearOfTheRat is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Year OF The Rat";
    string private _symbol = "RAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF4deB90a4F6A0BAC7B7b425aaee64fe4291455DD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF4deB90a4F6A0BAC7B7b425aaee64fe4291455DD); // BuyBack Address
