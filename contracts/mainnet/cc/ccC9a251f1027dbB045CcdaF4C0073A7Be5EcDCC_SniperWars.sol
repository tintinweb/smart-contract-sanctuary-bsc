...
/**
Congrats, You Found The Real Ca, Snipe it.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0A735BcA4cF10810d5CE02885e326c272D74fe93; // owner address
...
contract SniperWars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sniper Wars";
    string private _symbol = "SniperWars";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9584432339057897A867752736D76625637C582B); // Marketing Address
    address payable public teamWalletAddress = payable(0x9584432339057897A867752736D76625637C582B); // Team Address
    ...
    uint256 public _liquidityShare = 4; // original 2
    uint256 public _marketingShare = 4;
    uint256 public _teamShare = 2; // original 2

    uint256 public _totalTaxIfBuying = 3;  // original 10
    uint256 public _totalTaxIfSelling = 25;  // original 10
