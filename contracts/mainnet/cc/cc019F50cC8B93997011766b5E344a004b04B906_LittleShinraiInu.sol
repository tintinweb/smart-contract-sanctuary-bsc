...
contract LittleShinraiInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Little Shinrai Inu "; // token name
    string private _symbol = "SHINRAI"; // token ticker
