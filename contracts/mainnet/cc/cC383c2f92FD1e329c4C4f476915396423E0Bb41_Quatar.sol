...
contract Quatar is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quatar";
    string private constant _symbol = "Quatar";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7BF9561326934D0B92abb8b018b67c25E1531Ef2);
    address payable private _marketingAddress = payable(0x8205448919ef119F0229b7bB9b447b38569FB8af);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBot[from] && !_isBot[to], "To/from address is BOT!");
    ...
    function addantiBot(address account, bool value) public onlyOwner {
