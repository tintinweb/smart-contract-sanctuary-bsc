...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8D579D613AEe04eAa0153eE3AdA2e4baf16A54ce;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        6666,//Supply
        address(0xD7a3D369CCb5d18018bC04a95f4636875CE5A6Bf),//FundAddress
        address(0xD7a3D369CCb5d18018bC04a95f4636875CE5A6Bf)//ReceiveAddress
    ){
    }
}