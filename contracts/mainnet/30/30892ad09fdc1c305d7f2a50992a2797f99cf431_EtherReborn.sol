...
contract EtherReborn is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHER REBORN";
    string private _symbol = "ETHER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x352e34f95cF2912Ffd5cD33E4dcE00a5268b5c06); // Marketing Address
    address payable public teamWalletAddress = payable(0x352e34f95cF2912Ffd5cD33E4dcE00a5268b5c06); // Team Address
