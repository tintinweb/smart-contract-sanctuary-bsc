...
contract LIFTOFFDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LiftoffDoge";
    string private _symbol = "LIFTOFFDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFDC43479cfCbc95DCcE4E57550FCFACfeb449534); 
    address payable public buyBackWalletAddress = payable(0x17F509770A778ECe2a815495c7dc4Adc358f4AF9); 
