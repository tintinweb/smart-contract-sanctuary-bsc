...
contract xZilla is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "X Zilla";
    string private _symbol = "xZilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB415D77651FD1c012282F8f712369b5400354385));
        marketingWalletAddress = payable(address(0xB415D77651FD1c012282F8f712369b5400354385));
