...
/**
This token driven by community
Owner : @lexzsonofluch
LP BURN
1/1 TAX
...
contract NINETYNINE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6199891dDF6BcbABefFAF3ca93630DB3a95533B2); // Marketing Address
    address payable public teamWalletAddress = payable(0x6199891dDF6BcbABefFAF3ca93630DB3a95533B2); // Team Address
