...
contract BikeRom is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BikeRom";
    string private _symbol = "BRC";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x0405377bEBa83b93587C3342b15235856E6acEE8); 
    address payable public teamWalletAddress = payable(0x0405377bEBa83b93587C3342b15235856E6acEE8); 
