...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1655CD0a377b18E95D9E7f2913243097C9D78E78;
...
contract PKEN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94C1c10A5f41DC4424829263bd250FD23a117A5c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3000000000* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PKEN";
    string private _symbol = "PKEN";
