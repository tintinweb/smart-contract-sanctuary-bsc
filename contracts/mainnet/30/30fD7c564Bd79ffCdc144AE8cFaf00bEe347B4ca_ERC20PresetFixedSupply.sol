...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) admin;//管理员地址

    uint256 public _swapRate_to_burn = 5;//通缩销毁比例
    uint256 public _swapRate_to_NFt = 5;//NFT分红比例
    address public _NFt_address;//NFT contract address
    uint256 public _swapRate_to_Tsr = 3;//LP分红:3%
    address public _swapRate_to_Tsr_address;//LP分红地址
    uint256 public _swapRate_to_marketing = 2;//营销
    address public _marketing_to_splitter_address;//营销地址
    uint256 public _total_swapSell_amount;//交易所卖总量
    uint256 public _total_swapBuy_amount;//交易所买总量
    uint256 public _total_swapT_amount;//交易总量
    uint256 public _total_swap_amount_to_burn;//通缩销毁总量
    uint256 public _total_swap_amount_to_NFt;//NFT分红总量
    uint256 public _total_swap_amount_to_Tsr;//LP分红总量
    uint256 public _total_swap_amount_to_marketing;//营销总量
    uint256 public _underlying_Supply =10000000 * 1000000000000000000;//
    ...
    unchecked {
        ...
        if(_totalSupply > _underlying_Supply){
            ...
            } else if (_isSwapInclude[to]) {//交易所卖
