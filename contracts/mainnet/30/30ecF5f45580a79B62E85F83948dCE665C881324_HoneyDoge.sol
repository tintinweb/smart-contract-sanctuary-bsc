...
Welcome to HoneyDoge!
Join our social channels: 
TG - http://t.me/honeydogebsc
Website: https://honeydoge.app/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  RWRD = IBEP20(0x7324c7C0d95CEBC73eEa7E85CbAac0dBdf88a05b);
...
contract HoneyDoge is IBEP20, Auth {
    ...
    // Addresses
    address RWRD = 0x7324c7C0d95CEBC73eEa7E85CbAac0dBdf88a05b; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xa42e410d8F7CC0b5896afC3aeeFbA546D09d9338;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 2.5% 
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 1,5% 
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 2.5% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2bfc79A5ac7643D75df80510b74Ed80aDB88223a;
