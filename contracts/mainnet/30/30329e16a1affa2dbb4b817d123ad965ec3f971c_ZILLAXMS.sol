...
contract ZILLAXMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zilla XMAS";
    string private _symbol = "ZILLAXMS";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xCC77AC4BE1FDAb38cB84977967CA7BF19220F722); // Buy Back Address
