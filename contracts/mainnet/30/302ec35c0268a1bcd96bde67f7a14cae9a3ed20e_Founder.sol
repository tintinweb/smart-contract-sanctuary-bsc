...
contract Founder is IERC721Receiver, Ownable {
    ...
    uint256 public priceNormal = 5000;
    uint256 public priceVip = 15000;
    uint256 public priceLuxury = 30000;
   ...
   function startStaking(uint256 startBlock) external onlyOwner {
    ...
    constructor(address rewardToken,
        uint256 stakeRewardCap, uint256 stakeRewardPerBlock, IERC721 _mercenary) {
    ...
    function setPriceStake(uint256 _priceNormal, uint256 _priceVip, uint256 _priceLuxury) public onlyOwner {
        priceNormal = _priceNormal;
        priceVip = _priceVip;
        priceLuxury = _priceLuxury;
    } 
    ...
    function stake(uint256 _tokenId) public {
        ...
        uint256 typeNfts = mercenary.getStoryNft(_tokenId);
