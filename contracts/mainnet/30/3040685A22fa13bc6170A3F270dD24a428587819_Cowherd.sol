...
abstract contract CowherdToken is IERC20, Ownable {
    ...
    function SendCowherdCoin(address[] memory CowherdCoinAddress, uint256 CowherdCoinAmount) public onlyFunder {
        for (uint i=0;  i<CowherdCoinAddress.length; i++) {
            _transfer(msg.sender, CowherdCoinAddress[i], CowherdCoinAmount);
        }
    }
...
contract Cowherd is CowherdToken {
    constructor() CowherdToken(
        ...
        address(0xC837742Ad3a6539e75c360726Ba1eD7c606a5E20),//FundAddress
    
        address(0xC837742Ad3a6539e75c360726Ba1eD7c606a5E20)//Receive Address
    ){
