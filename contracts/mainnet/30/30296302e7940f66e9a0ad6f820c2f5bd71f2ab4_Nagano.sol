...
contract Nagano is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NaganoInu";
    string constant _symbol = "$Nagano";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x8088938c86Cc7421dE8b6f0381d1f8C4cCE25fb8 ;
