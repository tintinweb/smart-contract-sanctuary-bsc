...
// File: contracts/DogeEmperor.sol
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DogeEmperor is Context , IERC20, Ownable {
    ...
    string private _name = "Doge Emperor";
    string private _symbol = "DEM";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2; // 2% reflections
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3; // 3% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 0;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _devFee = 3;  // 3% to liquidity
    address public devWallet = 0x7EE23a0A02A8C7DFb70D8cc8B2382938f385d04d; // development wallet
    ...
    uint256 public _maxTxAmount = 30000 * 10**9 * 10**9; //3% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 30000 * 10**9 * 10**9; //3% of total supply
