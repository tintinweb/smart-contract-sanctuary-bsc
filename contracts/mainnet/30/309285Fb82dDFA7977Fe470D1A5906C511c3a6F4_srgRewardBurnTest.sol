...
contract srgRewardBurnTest is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "srg Reward Burn Test";
    ...
    uint256 public sellMul = 86;
    uint256 public buyMul = 86;
    ...
    // Tax Split
    uint256 public teamShare = 357;
    uint256 public treasuryShare = 357;
    uint256 public rewardShare = 142;
    uint256 public burnShare = 142;
