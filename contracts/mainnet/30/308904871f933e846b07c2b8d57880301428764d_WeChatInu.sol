...
library Address{
 ...
 contract WeChatInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x07bFBdbb8384ec3Dac00E9FD68b540129aC651C6;
    address public donationWallet = 0x07bFBdbb8384ec3Dac00E9FD68b540129aC651C6;

    string private constant _name = "WeChat Inu";
    string private constant _symbol = "WCINU";
