...
*/
/** BonkMINE 矿兔
BonkMined礦場是在BSC網絡上推出的社區代幣。偉大的營銷將在這裡進行，以創建一個未來的項目，讓您在投資中感到舒適和安全。
https://t.me/BonkMINE_Bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAD2D3d4631B76be6f35506567a6aa1cF2ad87728; // owner address
...
contract Bonkmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bonkmine ";
    string private _symbol = "BONKMINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCCC36C13b9994580240E10609D4dA16366a7Bcf8); // 
    address payable public teamWalletAddress = payable(0xCCC36C13b9994580240E10609D4dA16366a7Bcf8); // 
