...
contract FLASHBURN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Flash Burn";
    string constant _symbol = "FLASHB";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 1,000

        //max wallet holding of 5%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 5,000
    ...
    uint256 marketingdevelopmentFee = 600;
    ...
    uint256 public swapThreshold = _totalSupply / 100; //1,000
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x2f86Df3D84aBDc4b9216679c5aa4AdFdA3E05526; 
