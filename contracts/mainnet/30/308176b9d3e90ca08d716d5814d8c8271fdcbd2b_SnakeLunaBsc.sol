...
//
// 
//  Snake Luna Bsc - $SLUNA - 
//  Don't miss Snake and Luna hyped Token
...
contract SnakeLunaBsc is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("SnakeLuna", "SLUNA") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SNAKE LUNA BSC";
