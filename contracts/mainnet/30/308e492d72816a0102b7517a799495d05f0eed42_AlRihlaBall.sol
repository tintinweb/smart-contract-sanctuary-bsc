...
contract AlRihlaBall is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Al Rihla Ball";
    string private _symbol = "ALRIHLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFC2dd0E9Cdcd43Fe72c2E26a668DA1361eB90C5A); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xdcC51c8dEc142B6a1E33d8Ef275C5E8Db9a5FB67); // Development Address
