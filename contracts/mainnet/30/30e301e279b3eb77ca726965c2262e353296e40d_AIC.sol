...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e7d2D0f7dF74b011954cf85f3628b5056D32bBA; 
...
contract AIC is Context, IERC20, Ownable {
    ...
    string private _name = "AI Community";
    string private _symbol = "AIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e7d2D0f7dF74b011954cf85f3628b5056D32bBA); 
    address payable public teamWalletAddress = payable(0x3489Da7fba82133b3B8657D4a76B72C9F9890b90); 
