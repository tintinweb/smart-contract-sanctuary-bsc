...
contract IkigamiTwo  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ikigami 2.0";
    string private _symbol = "Ikigami Two";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xF5976Ef1B0E4F20C7d45537D24B80fbCA1C88cf9);
