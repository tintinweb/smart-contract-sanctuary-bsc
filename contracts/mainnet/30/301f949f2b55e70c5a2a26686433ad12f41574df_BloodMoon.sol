...
contract BloodMoon is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 100000 * 10**decimals();
    uint256 public maxWalletLimit = 8000000 * 10**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0x0Dce722b3304829c20f3b37e54Ee3F1a662BdE16;
    address private devWallet = 0xfB4296588Ebd2605860410F19a25EC5Ab3CF0167;
    ...
    constructor(address routerAdd) ERC20("BloodMoon", "BMoon") {
    ...
    function UpdateBuyTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 30, "Buy taxes up to 30% only");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 30, "Sell taxes up to 30% only");
    }
    ...
    function rescueBSCTokens(address tokenAdd, uint256 amount) external onlyOwner {
        require(tokenAdd != address(this), "Can't remove blood tokens");
