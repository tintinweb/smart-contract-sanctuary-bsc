...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress1 = 0x098a0A6e28B9199b665cB0c6ff52d18CaaC02Fe0;//地址1
    address public _marketingWalletAddress2 = 0xA7BbE7A7e0D98B9A54312043d299f53B2289b578;//地址2
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public _maxBAAmount = 10 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("dart", "dart") {
    ...
    function _swapAndLiquid() private {
        ...
        if (balances > swapTokensAtAmount) {
            ...
            uint256 forBuyback = balance.div(2);
            uint256 forDividends = balance.sub(forBuyback);

            (bool success,) = address(_marketingWalletAddress1).call{value: forBuyback}("");
            if(success) {}
            (success,) = address(_marketingWalletAddress2).call{value: forDividends}("");
            if(success) {}
        }
    }
}