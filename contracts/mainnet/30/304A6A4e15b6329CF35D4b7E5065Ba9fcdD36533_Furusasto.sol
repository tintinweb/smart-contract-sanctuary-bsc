...
contract Furusasto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Furusasto";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x34a47A22E2271bDc38E84AD27C7722727f3F21ed));
        _anotherA = payable(address(0x34a47A22E2271bDc38E84AD27C7722727f3F21ed));
