...
contract QatarChampion2022 is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x9AdC66BF05F6002FC58b3BD296Be5a1D06FaA6e1);
    address payable private _twdmkt = payable(0x742a9425B1b97563B1C08c986535714C5a70A82C);
    
    string private constant _name = "QatarChampion2022";
    string private constant _symbol = "QAC2022";
