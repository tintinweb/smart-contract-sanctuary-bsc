...
contract OxyO2CommunityAndTeam is Ownable {
    ...
    function addCoreMember(address member,uint value) public onlyOwner {
        uint timestamp = block.timestamp;
    ...
    function subtractCoreMember(address member) public onlyOwner {
