...
contract PGZILLA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PGZILLA";
    string private _symbol = "PGZILLA";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x62d8C1912de672be8d409d38961A2a8410C94308); // Marketing Address
    address payable private teamWalletAddress = payable(0x62d8C1912de672be8d409d38961A2a8410C94308); // Team Address
