...
to restore the lost privacy
of the blockchains by ushering 
in the era of Arcane.

The Privacy First Blockchain revolution starts now!

Telegram: https://t.me/arcanefoundation
Website: https://arcane.foundation
...
abstract contract Ownable is Context {
    ...
    function _transferOwnership(address newOwner) internal virtual {
        ...
        contract Arcane_FoundingFathers is ERC721A, Ownable {
        using Strings for uint256;

            // Name & Symbol of Project in Constructor 
            constructor() ERC721A("Arcane Founding Fathers", "ARCFF") {}

            //max supply is set to 100
            uint16 public constant maxSupply = 100;
            // uriPrefix is the BaseUri
            string public uriPrefix = "ipfs://QmakNADDPjkYbLAFVJoDQNc7RP9SBJRRaW3AQGyHgwmanj/";
            string public uriSuffix = ".json";
            string public hiddenURL = "ipfs://QmakNADDPjkYbLAFVJoDQNc7RP9SBJRRaW3AQGyHgwmanj/" ;
            //cost for Pulic Mint
        ...
        // Function Whitelist mint, Whitelist sale max tokens are 50
        //Contract will switch to Public Mint once 50 tokens are minted
          ...
          _safeMint(msg.sender , _mintAmount);
           ...
           // WhiteList-Sale  will be automatically paused after 50 NFTs are minted in this phase
