...
/*
    Welcome to KeepHustling

    Somewhere we belong, yet somewhere we’ve never been, just because we havent hustled enough .
    
    Find Us On TG : https://t.me/keephustlingbsc
  Lets hustle together through every new ATHs, making our way to MILLIONS
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaDfA125bfb61457b103784AfbD75386585506FD6;
...
contract HUSTLE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x644e908618E12F8bF79a5519adF6431a66D8836a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Keep Hustling";
    string private _symbol = "HUSTLE";
