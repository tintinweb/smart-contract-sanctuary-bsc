...
contract ETHEREUMMARGE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ETHEREUM MARGE";
    string constant _symbol = "SIMPSON";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xC78515D7e088517ea85474EE2cb5D1744cF5d8d7;
