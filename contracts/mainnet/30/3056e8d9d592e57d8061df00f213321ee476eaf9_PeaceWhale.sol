...
contract PeaceWhale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "PeaceWhale";
...
//address
    ...
    address public _MarketingWalletAddress = 0x575E2206593C97f9156f9669BdC444AC1bE4Fa7C;
    address public _TeamWalletAddress = 0xC9795583c6c25D2c8D1FbF669Ff470aC6B815F99; 
    address public _BuybackWalletAddress = 0xb6A2bFAEA483ECC2D0571c588deedeF4930A693A;
...
//uint
    ...
    uint public timeToWait = 0;
    uint public maxBuyTxAmount;
    uint public maxSellTxAmount;
    uint public startTime;
    uint public maxWallet = 1 * (10 ** 18); //1% supply
...
// constructor
    ...
    function setMaxTxPercent(uint buy, uint sell) external onlyOwner() {
        require( ((_tTotal * sell) / 10**1) <= 1, "max sell tx limited to 1% of the supply" );
        maxBuyTxAmount = (_tTotal * buy) / 10**1;
        maxSellTxAmount = (_tTotal * sell) / 10**1;
    }
