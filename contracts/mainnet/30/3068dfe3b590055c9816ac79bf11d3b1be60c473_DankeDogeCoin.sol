...
/*
Danke Doge is a community-driven token on Binance Smart Chain with low tax.
hold Danke Doge in your wallet for Doge rewards
let's participate with this launch to get big profit🚀

Telegram: https://t.me/dankedoge
Twitter: https://twitter.com/dankedoge
*/
...
contract DankeDogeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DankeDogeCoin";
    string private _symbol = "$DDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7CdF6606e06Ab81639a819765dD8d39f0ed0474); 
    address payable public teamWalletAddress = payable(0xB7CdF6606e06Ab81639a819765dD8d39f0ed0474); 
