...
contract TECHNOPAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " TECHNO PAD ";
    string private _symbol = " TECHNO PAD "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6541f840d46317FBe08EdCa7427E28027d2eD296); 
    address payable public teamWalletAddress = payable(0x6541f840d46317FBe08EdCa7427E28027d2eD296); 
