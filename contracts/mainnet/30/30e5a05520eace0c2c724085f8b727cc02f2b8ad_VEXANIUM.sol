...
/**
 Telegram https://t.me/vexaniumannounchement
 Website https://vexanium.online
...
contract VEXANIUM is IBEP20, Auth {
    ...
    string constant _name = "Vexanium";
    string constant _symbol = "Vexa";
    ...
    address private marketingFeeReceiver = 0xEE27A0d05a95DCec2536B30afF3Bbd4689A6F53d;
    address private buybackFeeReceiver = 0x2B8A9442CC54EeA17FE85F6437cf0c933966c145;
    ...
    uint256 public swapThreshold = 200 * 10**3 * (10 ** _decimals); // 0.3%
    bool inSwap;
