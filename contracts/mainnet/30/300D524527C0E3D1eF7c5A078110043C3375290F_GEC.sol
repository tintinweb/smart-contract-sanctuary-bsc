...
contract GEC is ERC20, Ownable {
    ...
    address public feeWallet = 0xDA86c2504B79cf21e94eC280324e161eE2aC1f34;
    ...
    uint256 public _protectTime = 6 hours;

    mapping(address => bool) public blackList;
    mapping(address => bool) public _isExcludedFromFees;

    constructor() ERC20("GEC", "GEC") {
        uint256 totalSupply = 3900000 * (10**18);
    ...
    function takeBuyFee(address from, uint256 amount) private returns (uint256 amountAfter) {
        ...
        if (BFee > 0) super._transfer(from, feeWallet, BFee);
    ...
    function setFeeWallet(address address_) public onlyOwner {
        feeWallet = address_;
    }
