...
/*
    Telegram : https://t.me/rubledogecoin
*/
...
contract RubleDogeCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Ruble Doge Coin";
    string private _symbol = "RUBLEDOGE";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xeCF39Aa8D73B02813Fc90bcDd87d2F6C9E32804C);
    ...
    mapping (address => bool) private _isExcludedFromMaxBalances;
    ...
    constructor () {
        ...
        _isExcludedFromMaxBalances[owner()] = true;
        _isExcludedFromMaxBalances[address(this)] = true;
        _isExcludedFromMaxBalances[uniswapV2Pair] = true;
        ...
        _liquifyThreshhold = 3 * 10**9 * 10**_decimals;
        _maxBalances = 10000 * 10**9 * 10**_decimals;
    ...
    function _transfer(
        ...
        if(
            ...
            !_isExcludedFromMaxBalances[to]  // is excludedFromMaxBalance
        ){
            require(
