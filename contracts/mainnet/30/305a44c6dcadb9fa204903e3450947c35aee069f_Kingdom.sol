...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x66815eB1eA984FE992DE57b9c5AbeAa358fcfDF1; // owner address
...
contract Kingdom is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x66815eB1eA984FE992DE57b9c5AbeAa358fcfDF1); // Marketing Address
    address payable public teamWalletAddress = payable(0x66815eB1eA984FE992DE57b9c5AbeAa358fcfDF1); // Team Address
