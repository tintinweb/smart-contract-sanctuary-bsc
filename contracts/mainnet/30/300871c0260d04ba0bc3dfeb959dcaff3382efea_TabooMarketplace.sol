...
contract TabooMarketplace is Ownable, ReentrancyGuard {
    uint256 public tabooPercentageCut;
    ...
    constructor(
        ...
        uint256 _tabooPercentageCut
    ) {
        platformLazyNFT = _platformLazyNFT;
        royaltyStorage = _royaltyStorage;
        tabooPercentageCut = _tabooPercentageCut;
    }
    ...
    function _payout(
        ...
        _amount = _amount - (_amount * tabooPercentageCut) / 10000;
    ...
    function _purchaseAndTransfer(
        ...
        uint totalAmount = _highestBid -
            (tabooPercentageCut * _highestBid) /
            10000;
    ...
    /// @dev When taboo token is transferred then there is an inherrent tax that
    /// is sent to other wallet
    function setTabooPercentageCut(uint256 _tabooPercentageCut)
        external
        onlyOwner
    {
        tabooPercentageCut = _tabooPercentageCut;
