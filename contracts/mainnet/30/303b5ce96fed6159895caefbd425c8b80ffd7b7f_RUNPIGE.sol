...
contract RUNPIGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "RUNPIGE"; // 
    string private constant _symbol = "RUPI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address private  _marketingWallet = 0x84a802Cf08cCafec8eC686a73f21557DCEC77ECd;
