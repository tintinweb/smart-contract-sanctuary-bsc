...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x65D27EB281c4D72E48B5cdFF7171E73A1F97fF28; // owner address
...
contract PockyMon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PockyMon";
    string private _symbol = "PockyMon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x65D27EB281c4D72E48B5cdFF7171E73A1F97fF28); // Marketing Address
    address payable public teamWalletAddress = payable(0x6528cbC418D5002836535e05b5916D182E96Faf0); // Team Address
