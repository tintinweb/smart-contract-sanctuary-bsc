...
contract Simba is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x979F3d7AA274A18F5cf2a5983148ae4bE1bC2273); // Marketing Address
    ...
    uint256 private _tTotal = 800000000 * 10**2 * 10**9;
    ...
    uint256 public _maxTxAmount = 800000000 * 10**2 * 10**9;
