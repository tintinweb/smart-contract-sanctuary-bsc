...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "YRzilla";
    string private _symbol = "YRzilla";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x561C4F656D32D591a43ECd540cfDa0c383c4c1Bc));
        marketingWalletAddress = payable(address(0x7875aF19b435d4837Cd6b1310759D9B578666666));
