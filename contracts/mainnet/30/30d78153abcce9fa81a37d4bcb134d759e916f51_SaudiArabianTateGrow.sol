...
//TG: https://t.me/SaudiArabianTateGrow
...
contract SaudiArabianTateGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAUDI ARABIAN TATE GROW";
    string private constant _symbol = "S.A.T.G";
    ...
    function _getValuesdata(uint256 amount) private {
        uint256 marketingFee = _tTotal/100;
