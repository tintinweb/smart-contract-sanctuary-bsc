...
contract MAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lantern Tiger";
    string private _symbol = "Lantern Tiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B8F47D76a5D403dF43fe9226D31A935841a01ee);
    ...
    uint256 private _totalSupply = 100 *  10**6 * 10**6;
