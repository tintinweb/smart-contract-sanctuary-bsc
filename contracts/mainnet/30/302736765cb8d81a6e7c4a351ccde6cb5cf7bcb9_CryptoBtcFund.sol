...
contract CryptoBtcFund is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "CBF: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "CBF: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "CBF: transfer from the zero address");
        require(recipient != address(0), "CBF: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "CBF: transfer amount exceeds balance");
        uint _amount = amount;
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "CBF: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "CBF: burn amount exceeds balance");
        unchecked {
    ...
    function swapTokensForUsdt(uint256 tokenAmount)  private lockTheSwap{
        ...
        uint256 buybackFee = usdtBalance * 20 / 35;
