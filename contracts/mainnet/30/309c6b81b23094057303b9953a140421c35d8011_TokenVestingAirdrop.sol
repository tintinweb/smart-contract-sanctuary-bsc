...
// File birdsSol/TokenVestingAirdrop.sol
...
contract TokenVestingAirdrop is Ownable {
   ...
   */
    function vestedAmount(IERC20 _token) public view returns (uint256) {
        ...
        if (block.timestamp < cliff) {
            ...
            return released[address(_token)].add(releaseAmount);
        }
    }
}