...
contract AiDayInu   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Ai Day Inu ";
    string private _symbol = " AIDINU "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF6F811b61414d97D162e6C1aE4bab5b2e99F669E); 
