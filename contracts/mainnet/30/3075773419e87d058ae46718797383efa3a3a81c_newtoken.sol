...
contract newtoken is Context, IERC20, Ownable {
    ...
    string private _name = "DelveyCoin";
    string private _symbol = "DELVEY";
    ...
    function updateMaxOption(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }

    function updateAutoDelveyCoin(address pair, bool value) external onlyOwner {
    ...
    function updateDelveyCoinOption(uint8 numerator, uint8 denominator, uint8 length) external onlyOwner {
