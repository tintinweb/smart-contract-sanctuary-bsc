...
contract HackerDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HackerDOGE";
    string private _symbol = "DOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a14bCC35F55963b5f4eFb1fB436d4Ab68daEFac);
    address payable public teamWalletAddress = payable(0x3a14bCC35F55963b5f4eFb1fB436d4Ab68daEFac);
