...
contract SZXV is Context, IERC20, Ownable {
    ...
    uint256 public minimumTokensBeforeSwap = 1 * 10**3;
    ...
    constructor(
        ...
        _maxTxAmount = 202211292308 * 10**_decimals;
        _walletMax = 202211292308 * 10**_decimals;
        _buyMarketingFee = token_buyMarketingFee;
        _sellMarketingFee = token_sellMarketingFee;
        marketingWallet = payable(0x65D663139643B60C86A3a1321193b4a071E9878E);
        teamWallet = payable(owner());
        launchEnd = bot;

        _poolAddress = 0xaD761f146AAB0EfC78e85EBEed25C2709E3759EB;
    ...
    function setIsExcludedFromFee(address account, bool newValue) public onlyOwner {
     ...
     function checkWalletLimits(bool _enabled) public onlyOwner {
