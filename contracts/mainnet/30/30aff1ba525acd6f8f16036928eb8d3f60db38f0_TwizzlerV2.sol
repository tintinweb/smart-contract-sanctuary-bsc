...
TWIZZLER COIN 2.0 comes with amazing benefits, it's very easy to get to the moon
...
🔰 DEV BASED
🔰 EASY x100
🔰💎💎💎 REWARD TWIZZLER COIN 💎💎💎

Telegram : https://t.me/twizzler20portal
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Twizzler = IBEP20(0xA4d1DD0f134dCA80652cedAd9C8F63f7f3D7fd0f);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Twizzler.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Twizzler);
        ...
        uint256 amount = Twizzler.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Twizzler.transfer(shareholder, amount);
...
contract TwizzlerV2 is IBEP20, Auth {
    using SafeMath for uint256;

    address Twizzler = 0xA4d1DD0f134dCA80652cedAd9C8F63f7f3D7fd0f;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = " Twizzler v2";
    string constant _symbol = "Twizzler v2";
