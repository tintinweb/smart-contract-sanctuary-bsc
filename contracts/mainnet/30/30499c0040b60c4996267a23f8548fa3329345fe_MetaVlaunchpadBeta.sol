...
/******************************************************************************
Token Name : MetaVlaunchpadBeta
Short Name/Ticker : MVLPB
Total Supply : 250000000
Decimal : 18
Platform : BEP20 
Project Name : MetaVlaunchpadBeta
Website Link : 
********************************************************************************/
...
contract MetaVlaunchpadBeta is Context, IERC20, Ownable,Initializable {   
    ...
    function Initialize(address _marketingwallet,address router) onlyOwner external initializer {
        ...
        _tTotal = 250000000 * 10**18;
        _name = "MetaVlaunchpadBeta";
        _symbol = "MVLPB";
        _decimals = 18;
