...
/*
https:https://t.me/ZapdosProtocol
https://twitter.com/ZapdosProtocol
*/
...
contract ZapdosProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZapdosProtocol";
    string private _symbol = "ZAPDOS";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x864c3f74d02d69DcEc0D8024A60d05fbbb309aa9); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x864c3f74d02d69DcEc0D8024A60d05fbbb309aa9); // Team Address
