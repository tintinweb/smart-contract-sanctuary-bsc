...
contract NabaluDefi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " NabaluDefi Token";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + buybackFee + burnFee + charityFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8749A0c57e895896522C42A251D89F73861dA8a0;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        charityFeeReceiver = 0xff405B953B632b7cEF260068F74f381aa9f05405;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _charityFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _buybackFee + _burnFee + _charityFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _burnFeeReceiver, address _charityFeeReceiver ) external authorized {
