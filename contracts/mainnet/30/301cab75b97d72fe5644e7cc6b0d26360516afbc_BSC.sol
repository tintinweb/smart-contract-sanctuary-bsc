...
contract BSC is IERC20, Ownable {
    ...
    uint256 private _totalSupply = 7770 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 770; // 10000;
    uint256 private _maxTransferPercent = 770;
    uint256 private _maxWalletPercent = 770;
    ...
    uint256 private swapThreshold = ( _totalSupply * 75 ) / 770;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 770;
    modifier lockTheSwap {swapping = true; _; swapping = false;}


    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0xe124063f3061dad319eC7E43CdB8DDDE081D3509; 
    address internal constant marketing_receiver = 0xe124063f3061dad319eC7E43CdB8DDDE081D3509;
    address internal constant liquidity_receiver = 0xe124063f3061dad319eC7E43CdB8DDDE081D3509;
