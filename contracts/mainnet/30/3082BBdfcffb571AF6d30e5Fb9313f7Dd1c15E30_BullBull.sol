...
contract BullBull is BullBullDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private BullBullTeam;
    address private CharityBullBull;
    ...
    string public override name = "BullBull";
    string public override symbol = "BullBull";
    ...
    constructor(uint totalSupplyValue, address BullBullTeamAddress, address CharityBullBullAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        BullBullTeam = BullBullTeamAddress;
        CharityBullBull = CharityBullBullAddress;
       
        // split the tokens according to agreed upon percentages
        balances[BullBullTeam] =  totalSupply * 4 / 100;
        balances[CharityBullBull] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's BullBullTeam pot
