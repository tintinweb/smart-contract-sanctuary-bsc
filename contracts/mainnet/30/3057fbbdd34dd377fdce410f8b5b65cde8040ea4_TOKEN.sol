...
/*   
    No TG , TAX 2%  Communitty driven Token 
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Lightning doge king";
    string private _symbol = "LIGDOGEKING";
    uint8 private _decimals = 9;
    uint256 private _totalSupply =  1000000000000000 * 10**_decimals;

    address payable private marketing =
        payable(0xd1d19389b99c73c88c49115bE6a8ba93D69c16Be);
    ...
    constructor() {
        ...
        _marketingFee = 1;
        _premarketingFee = _marketingFee * 1000000000000000;
        _totalFeesToContract = _liquidityFee.add(_marketingFee);

        _liquifyThreshhold = _totalSupply / 10000000000000 * 1000000000000000;
