...
/* Token contract */
contract NextAlpha is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBe21BAAC89129F71c127C7f7ff0770BD5e782614;
    ...
    // Name and symbol
    string constant _name = "Next Alpha";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1/2 / 100; 
    uint256 public _maxSellTxAmount = _totalSupply * 1/2 / 100; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa15261B4138E9a281E43c82aCAF4E53b9C180493;  
