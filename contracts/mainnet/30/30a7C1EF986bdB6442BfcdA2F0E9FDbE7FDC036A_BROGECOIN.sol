...
//SPDX-License-Identifier: MIT     May all my Broge brothers and sisters in BSC get rich AF
...
/* Token contract */
contract BROGECOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BROGE COIN";
    string constant _symbol = "BROGE";
