...
contract Rebase is ERC20Detailed, Ownable, MinterRole {
    ...
    string constant _name = "Rebase";
    string constant _symbol = "RBS";
    uint8 constant _decimals = 18;
    uint256 private constant MAX_UINT256 = ~uint256(0);

    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 38655781002000000000000000000;

    uint256 liquidityFee = 200;
    uint256 Treasury = 300;
    uint256 RiskFreeValue = 400;
    uint256 sellFee = 100;
