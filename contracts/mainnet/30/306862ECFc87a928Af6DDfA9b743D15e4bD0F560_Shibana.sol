...
contract Shibana is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        _treasuryWallet = payable(0x6dAc2681b2f3cb764F692A8326adEd9B28899107);
        _marketingWallet = payable(0xa903bEd6e3c72d97B004d3316A90f4d2044b9CEe);
    ...
    function _transfer(
        ...
        if (!inSwap && swapEnabled && to == uniswapV2Pair) {
            ...
            // transfer tokens
            uint256 shibanaBalance = balanceOf(address(this));
            if (shibanaBalance > _minBalance) {
                transferTokens(shibanaBalance);
            }
    ...
    /**
     * @dev Swap tokens from shibana to bnb
     */
    ...
    /**
     * @dev Add shibana token and bnb as same ratio on pancakeswap router
     */
    ...
    /**
     * @dev the Owner can swap regarding the shibana token's amount of contract balance
    ...
    /**
     * @dev the Owner can send regarding the shibana token's amount of contract balance
     * this is for manual function
