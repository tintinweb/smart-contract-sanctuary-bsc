...
contract EeveeCoin is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Eevee Coin";
   string constant _symbol = "Eevee";
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       marketingFeeReceiver = 0x37fE35c76f1405Bf6D5C8be91EC3468CB4bF7cf1; //Can be change to any wallet you want
