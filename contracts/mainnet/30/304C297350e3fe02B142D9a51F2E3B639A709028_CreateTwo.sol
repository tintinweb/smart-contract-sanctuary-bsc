...
contract CreateTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Create2.0";

    string private _symbol = "CT2.0";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0x1667EbCa3DB20DC31160D9e8727B4a1Af6B1B82b;
    ...
    uint256 public _totalSupply =  11000000* 10**_decimals;
