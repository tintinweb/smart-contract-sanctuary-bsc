...
/**
   ...
   Cloudy Inu is about to fly through the dense sky of Growth on Binance Smart Chain.
   Join us & hodl your dense bags of Cloudy Inu to make it rain!
 
   Telegram: https://t.me/CloudyInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);
...
contract CloudyInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Cloudy Inu";
    string constant _symbol = "CLOUDY";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x81FD7F4971e1382db8Cd03536311063406f131c5;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xCC42724C6683B7E57334c4E856f4c9965ED682bD;
