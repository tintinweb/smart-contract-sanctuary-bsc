...
contract Banana is ERC20("ApeParadise Banana", "BANANA"), Ownable {
    ...
    uint256 public NUM_BANANA_AVAX_LP;
    ...
    bool public avaxLPBananaMinted = false;
    ...
    function mintAvaxLPBanana() external onlyOwner {
        require(!avaxLPBananaMinted, "avax banana LP has already been minted");
        avaxLPBananaMinted = true;
        _mint(owner(), NUM_BANANA_AVAX_LP * ONE_BANANA);
    }
    ...
    function setNumBananaAvaxLp(uint256 _numBananaAvaxLp) external onlyOwner {
        NUM_BANANA_AVAX_LP = _numBananaAvaxLp;
    }
