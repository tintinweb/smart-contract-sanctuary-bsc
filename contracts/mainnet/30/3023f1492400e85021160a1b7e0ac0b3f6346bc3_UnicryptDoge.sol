...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59e71D3784df362978B0c3ABeb1aC39fCC2d8926; // Owner
...
contract UnicryptDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Unicrypt Doge";
    string private _symbol = "UDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59e71D3784df362978B0c3ABeb1aC39fCC2d8926); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x914202e082E7cee42F00347908b559c699805D93); // Team Wallet
