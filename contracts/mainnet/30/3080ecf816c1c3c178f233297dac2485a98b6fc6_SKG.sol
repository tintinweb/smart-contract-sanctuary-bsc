...
contract SKG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceKangaroo";
    ...
    address payable public marketingWalletAddress = payable(0x2001958A8cf76AC2782dd68DCcbC939877669aa1);
    address payable public teamWalletAddress = payable(0xA5b1166527778497A83cB9E3d59633D23397bE1e); 
    ...
    uint256 private _totalSupply = 8000 * 10**7 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 8000 * 10**4 * 10**_decimals; 
