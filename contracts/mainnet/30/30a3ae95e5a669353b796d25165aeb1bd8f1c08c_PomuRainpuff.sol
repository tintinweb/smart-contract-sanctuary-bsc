...
contract PomuRainpuff is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pomu Rainpuff";
    string private _symbol = unicode"POMU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x601c0Fa94Ac43a9Aedd9303956156804a9b6C5cc); 
    address payable public buyBackWalletAddress = payable(0x601c0Fa94Ac43a9Aedd9303956156804a9b6C5cc); 
    ...
    uint256 public _walletMax = 5e8 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 5e8 * 10**9; 
