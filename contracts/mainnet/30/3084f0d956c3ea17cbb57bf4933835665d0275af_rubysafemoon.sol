...
contract rubysafemoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ruby Safemoon"; // 
    string private constant _symbol = "$RSFM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xb09590ab508F6b6b604E906782860328807b0b9C;
