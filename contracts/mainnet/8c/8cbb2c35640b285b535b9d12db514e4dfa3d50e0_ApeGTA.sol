...
// 
//
// 📱 Telegram:https::https://t.me/ApeGTA
...
contract ApeGTA is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Ape GTA", "ApeGTA") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ApeGTA";
    string private _symbol = "ApeGTA";
