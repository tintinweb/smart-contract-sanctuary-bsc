...
contract Ownable is Context {
    address private _owner = 0xAbcd76a81A5Eb6a8B55775aDbf6025D85F5B08B8;
...
contract Keng is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0x66c179ADaBb35010dba51D32d6B1c87600C9622C); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Keng"; 
    string private _symbol = "Keng";
    uint8 private _decimals = 9; 

    uint256 private _tTotal = 2023 * 10**4 * 10**_decimals;
    ...
    uint256 public _minTokensSwapToAndTransferTo = 10 * 10**4 * 10**_decimals; 
