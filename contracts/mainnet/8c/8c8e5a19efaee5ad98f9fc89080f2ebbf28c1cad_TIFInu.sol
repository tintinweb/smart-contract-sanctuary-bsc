...
contract TIFInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TIFInu";
    string private _symbol = "TIFINU";
    uint8 private _decimals = 9;


    address payable public marketingWalletAddress = payable(0xB93E2eF7791CeEac07888B42b3A869206D5Aa259);
    address payable public teamWalletAddress = payable(msg.sender);
    ...
    uint256 public _maxTxAmount =   1000 * 10**9 * 10**_decimals;
    uint256 public _walletMax =     2000 * 10**9 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 10**9 * 10**_decimals;
