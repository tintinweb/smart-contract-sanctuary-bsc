...
contract YLJ is IERC20, Ownable {
    ...
    constructor() {
        ...
        //mainnet 
         ...
         fundAddress = 0x7Eb613aC9EE2D36aA3F35D6993Ff3da067841e94;

        currency = 0x55d398326f99059fF775485246999027B3197955; //USDT
        ISwapRouter swapRouter = ISwapRouter(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        ); //router
        address ReceiveAddress = 0x7Eb613aC9EE2D36aA3F35D6993Ff3da067841e94;
        ETH = 0x55d398326f99059fF775485246999027B3197955; //usdt 
         lpRewardAddress = 0x7Eb613aC9EE2D36aA3F35D6993Ff3da067841e94;
        //mainnet end
        //testnet  
        ...
        lpRewardLimit = 1000 * 10**_decimals;
    ...
    function swapTokenForFund() public lockTheSwap {
        ...
        if (contractTokenBalance > lpRewardLimit) {
            ...
            {} catch {
             ...
             try
              IReward(lpRewardAddress).updateReward() 
               {} catch {
                emit Failed_swapExactTokensForTokensSupportingFeeOnTransferTokens(
                    contractTokenBalance
                );
