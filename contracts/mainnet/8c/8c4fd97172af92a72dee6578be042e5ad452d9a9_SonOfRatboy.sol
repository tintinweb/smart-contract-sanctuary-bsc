...
contract SonOfRatboy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SonOfRatboy";
    string private _symbol = "SOR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc1F03aBe3a89225cEE2f0AfEd71e31bDABA1c66b); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x8171A65D80C36214d4Cc200b5c98027102005D0e); // Buyback Wallet Address
    ...
    uint256 public _maxTxAmount = 40000 * 10**9; // 2%
    uint256 public _walletMax = 40000 * 10**9; // 4%
