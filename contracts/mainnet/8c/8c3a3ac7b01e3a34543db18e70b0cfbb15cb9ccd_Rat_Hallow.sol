...
contract Rat_Hallow is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xd42FA36c19Dc158bA211ff9B5a7bd4CE161cfE5d); 
    ...
    string private constant _name = "Rat Hallow"; 
    string private constant _symbol = unicode"RHLW"; 
