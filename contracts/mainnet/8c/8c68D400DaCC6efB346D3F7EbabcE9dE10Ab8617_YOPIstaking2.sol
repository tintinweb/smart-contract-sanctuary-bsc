...
contract YOPIstaking2 is Ownable {
    ...
    address public constant tokenAddress = 0xCC77212164C2f398e5BBB9D9C12B2bAcCA29e148;
    // burn address
    address public constant burnAddress = 0x0000000000000000000000000000000000000000;
    
    // reward rate 49.00% per year
    uint public constant rewardRate = 4900;
    uint public constant rewardInterval = 60 days;
    
    // staking fee 0 percent
    uint public constant stakingFeeRate = 0;
    
    // unstaking fee 5.00 percent
    ...
    function withdraw(uint amountToWithdraw) public {
        ...
        require(Token(tokenAddress).transfer(burnAddress, fee), "Could not transfer withdraw fee.");
    ...
    // Admin cannot transfer out YOPI coin from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out YOPI coin!");
