...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private gameToken =0xb431A4303B6AaE4d94b430CC36C507669835a268 ;

    address private marketAddress = 0x8875e4E4fb985779df1214aF6878D41C8f1C02c9;

    address private burnAddress = 0x4f67b492ceD05e76A158E3c14a05614cbd606dc9;
...
contract CoinGDOGE is ERC20 {
    constructor () ERC20(" Voyager Token", "VGX")
    {
        _mint(msg.sender, 278_482_214 * (10 ** 18));
    }
}