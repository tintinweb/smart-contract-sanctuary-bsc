...
Telegram: https://t.me/admiralryokugyuofficial

Admiral Ryokugyu is a One Piece community based meme toket
that gives a free and safe play for everyone with key feature,
anti-Dump Mechanism Protocol implemented to Protect Investors Against pump & dump
as well as and the sustainability of the protocol
...
contract ADMIRALRYOKUGYU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Admiral Ryokugyu"; //
    string private constant _symbol = "RYO"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xE7e3117AA91f7e18679e16E5942745b8ecF272Eb ;
