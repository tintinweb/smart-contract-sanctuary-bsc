...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        sellfundAddress = address(0xFA55ef1d36CcF15d00Af133c0a063F831DA137C5);
        buyfundAddress = address(0xF9392BC1Fab675C08ef69E1c72d2C606A41d20fB);
        ...
        minTokenAmount = 20000 * 10 ** Decimals;
                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee =  _buyLPDividendFee + _sellLPDividendFee + _sellLPFee + _buyLPFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                fundFee = tAmount * _sellFundFee / 10000;
                _takeTransfer(sender, sellfundAddress, fundFee);
            } else {

                swapFee = _buyLPDividendFee + _buyLPFee ;
                fundFee = tAmount * _buyFundFee / 10000;
                _takeTransfer(sender, buyfundAddress,  fundFee);
                // burnAmount = tAmount * _buyBurnFee / 10000 ;
                // if((_tTotal - burnAmount ) < minTokenAmount){
                //     burnAmount = 0;
                // }else{
                //     _tTotal -= burnAmount;
        ...
        _takeTransfer(sender, recipient, tAmount - feeAmount - fundFee);
    }
    ...
    function setbuyFundAddress(address addr) external onlyFunder {
        buyfundAddress = addr;
    }

    function setsellFundAddress(address addr) external onlyFunder {
...
contract AECToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0x586fAb8aa0eC6dA5cb1F71B3463Def2638F3a413),
