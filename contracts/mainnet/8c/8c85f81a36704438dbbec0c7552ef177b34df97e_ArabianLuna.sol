...
contract ArabianLuna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arabian Luna";
    string private _symbol = "ALUNA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaefa9D165f11eD0e13d9b161068327c3EdF8A1dD); 
    address payable public buyBackWalletAddress = payable(0xaefa9D165f11eD0e13d9b161068327c3EdF8A1dD); 
    ...
    uint256 public _walletMax = 2000000000 * 10**9; 
