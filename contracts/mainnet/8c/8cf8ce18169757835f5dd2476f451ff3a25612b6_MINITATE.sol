...
contract MINITATE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xCBAAa3EABC028b1Ad644C2DF1Cd1bD5c14756768); 
    address payable public Wallet_Dev = payable(0xCBAAa3EABC028b1Ad644C2DF1Cd1bD5c14756768);
    ...
    string private constant _name = "Mini Tate"; 
    string private constant _symbol = unicode"Mini Tate"; 
    ...
    constructor () {
        ...
        _owner = 0xCBAAa3EABC028b1Ad644C2DF1Cd1bD5c14756768;
