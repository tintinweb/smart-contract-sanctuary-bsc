...
/* Token contract */
contract ELONBULLY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xD126B9aA314C8286968748b0800724b495C30de8;
    ...
    // Name and symbol
    string constant _name = "ELON BULLY";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 150 / 10000; // 3% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 3% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 3% or 2m tokens
    ...
    // Dead blocks
    uint256 deadBlocks = 20;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 75 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xD126B9aA314C8286968748b0800724b495C30de8;
