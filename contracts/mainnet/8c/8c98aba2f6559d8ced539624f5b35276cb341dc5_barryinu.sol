...
1. Coinlisting with added security wherein dev needs to KYC in order to get listed and link their official social media account. (Reported rugged projects reveals the details of the dev upon going into project profile)
...
Telegram : t.me/barryinu_bsc
Twitter : https://twitter.com/barryinu_bsc
Website : https://barryinu.com
FB: https://www.facebook.com/barryinu/
Reddit: https://www.reddit.com/barryinu
Medium: https://medium.com/@barryinu
Tiktok: https://www.tiktok.com/@barryinu
...
contract barryinu is ERC20, Auth {
    ...
    string constant private _name = "Barry Inu";
    string constant private _symbol = "BARRY";
    ...
    uint256 public sellFeeOps = 1;
    uint256 public sellFeeDev = 1;
    uint256 public sellFeeBurn = 2;
