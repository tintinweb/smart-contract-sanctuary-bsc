...
contract Netac is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Netac Inu";
    string private _symbol = "Netac";
    uint8 private _decimals = 18;

    address payable public MKTWALLET = payable(0xFf90baF878703437febAF658A7D066C1F920dDC2); 
    address payable public BurnedWalletAddress = payable(0xFf90baF878703437febAF658A7D066C1F920dDC2); 
