...
interface IERC20 {
     ...
     * that someone may use both the old and the new allowance by unLionDogete
...
contract Token is ERC20, Ownable {
    ...
    uint256 private _total = 100 * (10**18) * (10**18);
    ...
    uint256 public TokenRewardsFee = 100;
    ...
    constructor() ERC20("Killer2.0", "Killer2.0") {
        if (block.chainid == 56) {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "LionDoge: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "LionDoge: The new dividend tracker must be owned by the LionDoge token contract"
        );
    ...
    function updateRewardCoin(address newRewardCoin) public onlyOwner {
        ...
        require(
            ...
            "LionDoge: The RewardCoin already has that address"
        );
        RewardCoin = newRewardCoin;
        ...
        onlyOwner
    {
        require(
            ...
            "LionDoge: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "LionDoge: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "LionDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "LionDoge: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "LionDoge: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "LionDoge: Cannot update gasForProcessing to same value"
        );
