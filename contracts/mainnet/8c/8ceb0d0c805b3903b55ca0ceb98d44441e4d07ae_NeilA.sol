...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE32BD3bf3f1b8D2b9F7c296d255Ee63ae051D779; // owner address
...
contract NeilA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NeilA";
    string private _symbol = "$NEILA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE32BD3bf3f1b8D2b9F7c296d255Ee63ae051D779); // Marketing Address
    address payable public teamWalletAddress = payable(0xE32BD3bf3f1b8D2b9F7c296d255Ee63ae051D779); // Team Address
