...
//Contract
contract MOONKNIGHTINU is IBEP20, Ownable {
    ...
    string private constant _symbol = 'MOKI';    
    ...
    uint8 public constant MaxTax=42;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
