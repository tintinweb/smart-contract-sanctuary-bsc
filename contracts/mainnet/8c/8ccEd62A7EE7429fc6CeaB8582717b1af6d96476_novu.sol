...
contract novu is Context, IERC20 {
    ...
    address payable public _Marketing =
        payable(0xc48C1F29F75d80DA464852dee3b7BD6F471345bf);
    address payable public _Dev =
        payable(0xc48C1F29F75d80DA464852dee3b7BD6F471345bf);

    string private constant _name = "NovuFi";
    string private constant _symbol = unicode"NOVU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    uint256 public _Buy__Fee = 12;
    ...
    constructor() {
        _owner = 0xc48C1F29F75d80DA464852dee3b7BD6F471345bf;
