...
Telegram Chat : https://t.me/soccerflokiportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8F37Fe71f80B42A923385ad16CDf46b4b90B1B8C; // owner address
...
contract SoccerFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Soccer Floki";
    string private _symbol = "SoccerFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8454E43BaF9901cF1Bf2Fa48e629763C45467572); // Marketing Address
    address payable public teamWalletAddress = payable(0x8F37Fe71f80B42A923385ad16CDf46b4b90B1B8C); // Team Address
