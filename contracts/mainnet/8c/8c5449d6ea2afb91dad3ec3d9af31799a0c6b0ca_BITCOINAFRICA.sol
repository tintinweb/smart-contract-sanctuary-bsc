...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTCB = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTCB
    address WBNB;
    IDexRouter router;
...
// BITCOIN AFRICA CONTRACT
contract BITCOINAFRICA is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Bitcoin Africa"; // Name
    string constant _symbol = "BA"; // Symbol
    ...
    // buy tax fee
    uint256 public reflectionFeeOnBuying = 50; // 5% will be distributed among holder as BTC divideneds
    ...
    // sell tax fee
    uint256 public reflectionFeeOnSelling = 50; // 8% will be distributed among holder as BTC divideneds
