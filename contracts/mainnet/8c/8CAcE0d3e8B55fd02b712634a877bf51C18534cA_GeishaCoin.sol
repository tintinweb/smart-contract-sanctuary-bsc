...
//Website : http://geishacoin.com/ 
//DEX     : http://swap.geishacoin.com/
//NFT     : http://nft.geishacoin.com/ 
//Twitter : https://twitter.com/GeishaCoinBSC
*/
...
library Address{
 ...
 contract GeishaCoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xE87a278C2d911254555fDc0c38EF6DaA52256F89;
    address public NFTWallet = 0xE87a278C2d911254555fDc0c38EF6DaA52256F89;

    string private constant _name = "GeishaCoin";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 2);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _NFT) public onlyOwner {
       taxes = Taxes(_rfi,_marketing,_liquidity,_NFT);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _NFT) public onlyOwner {
       sellTaxes = Taxes(_rfi,_marketing,_liquidity,_NFT);
        emit FeesChanged();
    }
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rNFT) = _getRValues2(to_return, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.trfi-s.tMarketing-s.tLiquidity-s.tNFT;
        return s;
    }
    ...
    function _getRValues1(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rrfi,uint256 rMarketing, uint256 rLiquidity){
        ...
        rTransferAmount =  rAmount-rrfi-rMarketing-rLiquidity-rNFT;
        return (rAmount, rTransferAmount, rrfi,rMarketing,rLiquidity);
    }
    
    function _getRValues2(valuesFromGetValues memory s, bool takeFee, uint256 currentRate) private pure returns (uint256 rNFT) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(sender, address(this), s.tLiquidity + s.tMarketing + s.tNFT);
        }
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.NFT) * 2;
