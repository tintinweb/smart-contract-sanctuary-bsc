...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x89bFEe3d46D4010fde3CeE60C4Ad8E7B24c428b2;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0x89bFEe3d46D4010fde3CeE60C4Ad8E7B24c428b2),//fund 

        address(0x89bFEe3d46D4010fde3CeE60C4Ad8E7B24c428b2)//dev 
    ){
