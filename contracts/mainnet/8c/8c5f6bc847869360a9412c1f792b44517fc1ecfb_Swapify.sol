...
contract Swapify is Context, IERC20, Ownable {
    ...
    string private constant _name = "Swapify";
    string private constant _symbol = "SWIFY";

    address public _PancakeSwapV1RouterUniswap = 0x2138299Ed24B10D623a41D664EF0Eeb6e5D0eEeF; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x2138299Ed24B10D623a41D664EF0Eeb6e5D0eEeF; //can be the same
