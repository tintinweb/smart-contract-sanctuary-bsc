...
contract SLKKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SLKKING";
    string private _symbol = "SLKKING";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0b3BB9D23F3fF26EA319c07f68a13cd79A1c368b); // Marketing Address
    address payable public teamWalletAddress = payable(0x86644DA2506d3c3ddc52eb3214cDb7B83E84BB0d); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xcA1ba55aFB97D7a0acC1f116D33b204a81e8c014),
            block.timestamp
        );
    }
