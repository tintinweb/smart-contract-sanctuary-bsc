...
contract RedKing is ERC20, Ownable {
    ...
    string private name_ = "XIN";
    string private symbol_ = "XIN";
    ...
    uint256 public maxTxBuyAmount = 100 * 10 ** 18;
    uint256 public maxHolderAmount = 200 * 10 ** 18;

    address public rewardToken = 0x55d398326f99059fF775485246999027B3197955;
    uint256 private tokenBalanceForReward_ = 1 * 10**18;

    address public _marketingWalletAddress = 0x00000000000000000000000000000000000dead2;
    address public lpReceiveWallet = 0x00000000000000000000000000000000000deAD3;
