...
contract AssetPool is Ownable, ERC1155URIStorage {
    ...
    constructor(address owner) ERC1155("") {
        mint(owner, asset.APi, 1000000, "");
        mint(owner, asset.APii, 1000000, "");
        mint(owner, asset.APiii, 25000000, "");
        mint(owner, asset.APiv, 1000, "");
        mint(owner, asset.APv, 1000, "");
    ...
    function totalSupply(asset id) public view returns (uint256) {
        uint256 assetSupply = _totalSupply[uint256(id)];
        return assetSupply;
    }
}