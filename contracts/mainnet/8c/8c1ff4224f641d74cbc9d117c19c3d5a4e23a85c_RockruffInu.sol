...
contract RockruffInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xcC6AF766eE70585D9B8bd9f51a0D1249E5eB5c72); // Marketing Address

    address payable public teamAddress =
        payable(0xcC6AF766eE70585D9B8bd9f51a0D1249E5eB5c72); // Team Address

    address payable public liquidityAddress =
        payable(0x6beBAe02904D11167bc292Ae5364cA54d4418607); // Liquidity Address
    ...
    string private constant _name = "Rockruff Inu";
