...
contract DUCKEREUM is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DUCKEREUM";
    string constant _symbol = "DUCKEREUM";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xA811AE3b4fc78c7e26D7E2d93Cb43B112bdd2aD5);
        marketingFeeReceiver = address(0xFa8Fc559141C458c8f8e5A43C11709A1DcdF3629);
