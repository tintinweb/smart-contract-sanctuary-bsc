...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  1000000000000000000 * 10** Decimals;
...
contract WokeStasi is AbsToken {
    constructor() AbsToken(
        ...
        unicode"Woke Stasi",//Name
        unicode"Woke Stasi",//Symbolet et 
        9,//Decimals
        1000000000000000000,//Supply
        address(0x38c5bbd9a4E5b348B78efd74A71E074bb8e7AA99),//FundAddress
        address(0x38c5bbd9a4E5b348B78efd74A71E074bb8e7AA99)//ReceiveAddress
    ){
    }
}