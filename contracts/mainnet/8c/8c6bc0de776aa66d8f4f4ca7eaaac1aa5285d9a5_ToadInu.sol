...
/**
 ...
 _\.'_'      _.-'   TOADINU    `-._      `_`./_
( \`. )    //\` LEAP TO THE MTVRS  '/\\    ( .'/ )
 \_`-'`---'\\__, t.me/toadinuBSC  ,__//`---'`-'_/
  \`        `-\                  /-'        '/
   `                                         '   
https://t.me/toadinubsc
https://toadinu.com/
Toad Inu ($TDI) is a milestone driven token that is grown with the community and memes. Once we have reached critical mass, holders will get granted access to the Toad NFT in addition to the release of the Memeaverse -- a Pepe based metaverse.  
