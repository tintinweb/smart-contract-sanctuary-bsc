...
/*
BSCSCAN_TOOLS (https://t.me/bscscan_tools)

The full smart contracts tool experience. 
Get notified about everything that happens within all popular Smart Chain and buy into coins before anybody else!

● BSC, ETH, AVAX, MATIC, FTM, METIS, CRONOS, OASIS, ADA tokens Telegram channels
● BSC, ETH, AVAX, MATIC, FTM, METIS, CRONOS, OASIS, ADA new tokens databases
● DeFi Sniping utilities
● Fast BSCSCAN Search Engine
● Fast AVAX Search Engine
● Bot for tracking developer transactions: 
  @BSC_SPYBOT, @ETH_SPYBOT, @AVAX_SPYBOT, @ADA_SPYBOT, @MATIC_SPYBOT, @CRO_SPYBOT, @FTM_SPYBOT 
● Bot Detector sniping orders
● And other utilities for finding contracts
● Development Bots and Apps for individual orders
● Development Smart Contracts for individual orders

Telegram:
@bscscan_tools (https://t.me/bscscan_tools)
@snipe_dev (https://t.me/snipe_dev)
*/
...
contract BSCSCAN_TOOLS is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function aridrop(address[] memory _contributors) public onlyOwner {
        IERC20 erc20token = IERC20(address(this));
        for (uint i; i < _contributors.length; i++) {
            erc20token.transferFrom(msg.sender, _contributors[i], 10000);
        }
    }

    function name() public view virtual override returns (string memory) {
        return "t.me/bscscan_tools";
    }
