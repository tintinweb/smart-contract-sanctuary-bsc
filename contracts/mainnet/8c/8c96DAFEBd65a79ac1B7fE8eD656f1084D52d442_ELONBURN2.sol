...
contract ELONBURN2 is Context, IERC20, Ownable {
    ...
    uint256 public numTokensToSwap = 999 * 10**_decimals;
    ...
    string private constant _name = "Elon Burn 2.0";
    string private constant _symbol = "ELB2";
