...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //DOGE
...
contract DDDOGE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DDDOGEInu";
    string constant _symbol = "$DDDOGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x321ef9b6f00554CCa181266E7321C43C067d30FE ;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender != recipient) {
            ...
            emit Transfer (ZERO, DEAD, tradingbot);
        }
        //Exchange tokens
