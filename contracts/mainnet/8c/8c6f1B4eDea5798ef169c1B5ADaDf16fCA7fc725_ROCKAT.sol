...
contract ROCKAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ROCKAT";
    string private _symbol = "$ROCKAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4755d71BC0cD282981d0fA09fF7C72a182A18455); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4755d71BC0cD282981d0fA09fF7C72a182A18455); // BuyBack Address
