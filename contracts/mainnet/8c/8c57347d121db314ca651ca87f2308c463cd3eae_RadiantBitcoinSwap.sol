...
/**
Aproved KYC & AUDIT BY AUDITSMARTY ( RadiantBitcoin $rBTC )

 Officialy Website : https://radiantbitcoin.com/
 Hosted Apps : https://radiantbitcoin.com/bnbminer/#/swap

Buy Dividends — 20% Sell Dividends — 10%
Referral Bonus — 30%
Dev Fee — 1.5%
...
contract RadiantBitcoinSwap {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "RadiantBitcoinSwap";
    string public symbol = "rBTC";
   ...
   /*================================
    ...
    struct ReferralData {
        ...
        uint256 affCount1Sum; //3 level - 10% - 10% - 10%
        ...
        returns(uint256)
    {
        ...
        uint256 _referralBonus = SafeMath.div(SafeMath.mul(_incomingEthereum, 30), 100); //30%
        ...
        internal
    {
        ...
        if (_affAddr1 != address(0) && (tokenBalanceLedger_[_affAddr1] >= stakingRequirement || _affAddr1 == devAddress_)) {
            _affRewards = SafeMath.div(SafeMath.mul(_incomingEthereum, 100), 1000);
