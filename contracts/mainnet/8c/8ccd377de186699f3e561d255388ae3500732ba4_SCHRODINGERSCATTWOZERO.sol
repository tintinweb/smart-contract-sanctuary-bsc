...
contract SCHRODINGERSCATTWOZERO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SchrodingersCat 2.0";
    string private _symbol = "SCAT2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30fAB4cf167b32975adC5b4A0E33eb58014C86a3); 
    address payable public buyBackWalletAddress = payable(0xa785a8cC73AA0702c829A1dfceE7FaA7494c1AEa); 
