...
contract MegaBUSD is IBEP20, Auth {
    ...
    address DEV = 0x0Ee302F7AAca48f21F9861Be2Ea9243C7b710f1C;
    ...
    string constant _symbol = "MegaBUSD";
    ...
    uint256 public rewardFeeSell = 7;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4446ADC55135e7B41d042b8c4f6893aE39285f43;  
    ...
    // Set our buy fees
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _rewardFeeBuy, uint256 _marketingFeeBuy, uint256 _developmentFeeBuy, uint256 _feeDenominator) external authorized {
        liquidityFeeBuy = _liquidityFeeBuy;
        buybackFeeBuy = _buybackFeeBuy;
        rewardFeeBuy = _rewardFeeBuy;
        marketingFeeBuy = _marketingFeeBuy;
        developmentFeeBuy = _developmentFeeBuy;
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_rewardFeeBuy).add(_marketingFeeBuy).add(_developmentFeeBuy);
        feeDenominator = _feeDenominator;
    }

    // Set our sell fees
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _rewardFeeSell, uint256 _marketingFeeSell, uint256 _developmentFeeSell, uint256 _feeDenominator) external authorized {
        liquidityFeeSell = _liquidityFeeSell;
        buybackFeeSell = _buybackFeeSell;
        rewardFeeSell = _rewardFeeSell;
        marketingFeeSell = _marketingFeeSell;
        developmentFeeSell = _developmentFeeSell;
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_rewardFeeSell).add(_marketingFeeSell).add(_developmentFeeSell);
        feeDenominator = _feeDenominator;
    }
