...
contract QJTS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "QJTS";
    string private _symbol = "QJTS";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x16ED4AB9C7F71aa8dAd2d67a715a3f3393989673));
        marketingWalletAddress = payable(address(0x6117C454803e6420e74DbA2e98Ff7A99C71Cd337));
