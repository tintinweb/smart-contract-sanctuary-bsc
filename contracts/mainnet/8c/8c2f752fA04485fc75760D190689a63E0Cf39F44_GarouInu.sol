...
Garou hates those who are popular, as he believes the popular ones will always win in the end. This is because as a child, he had no friends and the popular children at school enjoyed abusing him both physically and verbally, particularly a boy named Tacchan. They forced him to play Heroes where Tacchan would beat up Garou Garou noticed how everyone liked Tacchan but hated him.
Garou Inu is designed as a meme token paying tribute to the so-called “monster” but the real hero Garou. He may acts like a villain and considered evil by most, he possesses a sense of morality; he fights heroes in a way without killing them also he has a soft spot for children, as shown when he converses with Tareo in the park. 

We pay tribute to Garou since he is even more respectable than some hypocrite so-called Hero. 
...
https://t.me/PortalGarouInu

Web https://garouinu.com/
...
contract GarouInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "GarouInu"; // 
    string private constant _symbol = "GarouInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xcC039ecD57123424d59cC9E7ADB01eA5e2ad581b;
