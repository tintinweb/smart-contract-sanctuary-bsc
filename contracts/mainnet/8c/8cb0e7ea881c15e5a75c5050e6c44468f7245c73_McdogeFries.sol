...
contract McdogeFries is Context, IERC20, Ownable {
    ...
    string private _name = "Mcdoge Fries";
    string private _symbol = "Mcdoge Fries";
    ...
    uint256 public _boostedMarketingFee = 100;
    ...
    address payable private _marketingWallet = payable(0x057043C8179E95cfCC9894c2328665805f74Fb9a);
    address payable private _devWallet = payable(0x6BdBCd6893D08D8FBdDd94b28618Db81E1C8439f);
