...
// Telegram : https://t.me/BrainWashedLGBTQ
...
contract BrainwashedLGBTQ is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x90BF170e25D46351EE879751db6B75F59A0Aca5d); 
    address payable public Wallet_Dev = payable(0x56973f2A54cd9A918Ac2d1b8DE7D85D3eae2072F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Brainwashed LGBTQ"; 
    string private constant _symbol = unicode"BLGBTQ";
    ...
    constructor () {
        ...
        _owner = 0x56973f2A54cd9A918Ac2d1b8DE7D85D3eae2072F;
