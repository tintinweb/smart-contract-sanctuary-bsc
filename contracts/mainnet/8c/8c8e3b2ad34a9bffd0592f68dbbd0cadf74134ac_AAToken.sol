...
contract AAToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    address usd = 0x55d398326f99059fF775485246999027B3197955;

    string private _name= "SUPERSHARK COIN";
    string private _symbol= "SUPERSHARK";
    uint8 private _decimals=9;
    uint256 supply=200000;
    address payable public marketingWalletAddress = payable(0xa5Fee07Eb9dd794cbdB471F084e9aE36F880f978);
    ...
    uint256 public _buyDestroyFee = 3;
    ...
    uint256 public _maxTxAmount=supply * 10**_decimals;
    uint256 public _walletMax=supply * 10**_decimals;
    ...
    constructor () payable {
        ...
        _owner = 0x5033e3d3D6b26149455Eea10FFF2410b1C46eFF9;
