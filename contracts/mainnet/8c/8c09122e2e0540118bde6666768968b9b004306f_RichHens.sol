...
/*
Rich Hens Airdrop   Active 9 days left
Rich Hens is a mobile game that combines play-to-earn and GameFi elements. In the game, 
players collect eggs laid by NFT hens that contain HEN tokens of varying values.
These tokens can be used to upgrade game characters or withdraw from the game. 
Players can also mint new NFT chickens and buy and sell them on the in-app marketplace.
Rich Hens is airdropping $10 worth of HEN tokens to participants for completing listed tasks.
https://t.me/richhens
https://twitter.com/rich_hens

Step by step guide
1
Open Rich Hens's Airdrop Form
https://www.airdropbob.com/link/2099
2
Follow Rich Hens's Twitter Page and retweet the following tweet
3
Like Rich Hens's Facebook Account and share the following video
4
Join Rich Hens's Telegram Announcement Channel
5
Follow Rich Hens's Reddit Channel
6
Like Rich Hens's Medium Page
7
...
contract RichHens  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'RichHens';
    string private _symbol = 'RichHens';
