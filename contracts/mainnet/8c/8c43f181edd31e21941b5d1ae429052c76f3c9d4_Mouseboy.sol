...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7229C77d49C5A9906fcA58F766119715EF21e67a; // owner address
...
contract Mouseboy is Context, IERC20, Ownable {
    ...
    string private _name = "Mouseboy";
    string private _symbol = "MBY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0c0bcB2688E5705D349a237fd5DcDEc94760b902); // Marketing Address
    address payable public teamWalletAddress = payable(0x6E9123d3329F7D3dc62fBc34700B28e6702F4871); // Team Address
