...
SISTOKEN
A SIBLING WITH BRO TOKEN BSC
WE LOADING FOR THE MOON
...
contract SISTOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SUSTOKEN";
    //change the token symbol
    string constant _symbol = "SISTA";
    //dont change that
    ...
    uint256 public _maxTxAmount = _totalSupply * 2 / 1000000000;

    //one wallet can only hold 2% of all token
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 1000000000;
    ...
    address public marketingFeeReceiver = 0x7138667045d1C5902Ff8d793e4B55FA404d81293;
