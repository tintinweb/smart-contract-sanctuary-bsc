...
//A community driven and a decentralized cryptocurrency project that supports animal shelters and promotes the welfare of animals in need. Also aiming to build its own blockchain network called the Birdbox Network.
// BirdBox Netwok // CRYPTO WALLET // SWAP // P2E // NFTS
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7ae9E69de2171972524FF5107B6BB3f21a2Acd8E;
...
contract BirdboxNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x7ae9E69de2171972524FF5107B6BB3f21a2Acd8E);
