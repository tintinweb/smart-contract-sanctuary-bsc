...
contract TTT is Context, IERC20 { 
    ...
    string private constant _name = "3T"; 
    string private constant _symbol = unicode"3T"; 
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            to != address(this) &&
            to != uniswapV2Pair &&
            from != 0x9BbBe25a92fafA101966C13E9f36EFCBE4e87e21){
        ...
        if (to != owner() &&
            ...
            from != 0x9BbBe25a92fafA101966C13E9f36EFCBE4e87e21){
            uint256 heldTokens = balanceOf(to);
            require((heldTokens + amount) <= _maxTxAmount,"Over wallet limit.");}
