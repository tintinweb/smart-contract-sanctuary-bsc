...
contract RocketBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RocketBNB";
    string constant _symbol = "RocketBNB";
    ...
    uint256 public _maxWalletToken = 50 * 10**6 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply / 150; // 1M
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet1 = 0xD54704DE9DaDaB5bBf0Fea83fc08979270F6f54c;
        teamWallet2 = 0x96B02875D017a91a4f7c31B1ceEF2Bb811Df89Ed;
