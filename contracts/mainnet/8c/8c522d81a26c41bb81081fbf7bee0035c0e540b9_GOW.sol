...
contract GOW is ERC20 {
    ...
    string internal tokenName = "God of War";
    string internal tokenSymbol = "GOW";
    uint256 constant total  = 1000 * 10**8 * 10**18;
    uint256 constant mintotal  = 1000 * 10**8 * 10**18;
