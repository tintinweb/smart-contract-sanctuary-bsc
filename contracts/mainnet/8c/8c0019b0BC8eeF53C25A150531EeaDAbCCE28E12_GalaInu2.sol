...
contract GalaInu2 is ERC20, Ownable {
    ...
    address public marketingFeeReceiver = 0xab736c3B9035fE80f8850D3f8215eFA7a4331966;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xab736c3B9035fE80f8850D3f8215eFA7a4331966] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xab736c3B9035fE80f8850D3f8215eFA7a4331966] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xab736c3B9035fE80f8850D3f8215eFA7a4331966,
                block.timestamp
            );
