...
contract CrunchyrollInu is IBEP20, Auth {
    ...
    string constant _name = "Crunchyroll Inu";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xE5B272b3c5c7ED3EDA188fa14D44Dbbeee01CeE7;
        marketingFeeReceiver = 0x0d8C449dA5f13864e71d25AeFb50846eb4Dbd331;
