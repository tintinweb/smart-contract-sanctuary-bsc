...
contract DiDogeToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e33;

    string private _name = "DigitalDoge";
    ...
    constructor (
        ...
        lpAwardCondition = LpAwardCondition(1e29,1e29);
        holder = _holder;
