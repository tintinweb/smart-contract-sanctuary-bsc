...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb8f9A428Cf72F022C0BE0Ca8eAd66Aa6BB3c5666; // owner address
...
contract EZTyrant is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " EZ Tyrant ";
    string private _symbol = " EZrant ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb8f9A428Cf72F022C0BE0Ca8eAd66Aa6BB3c5666); // Marketing Address
    address payable public teamWalletAddress = payable(0xb8f9A428Cf72F022C0BE0Ca8eAd66Aa6BB3c5666); // Team Address
