...
contract PTuffy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PTuffy";
    string private _symbol = "PTuffy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e785300dE06c1C02C757BfEDAA1421Fcc17c6d2);
    address payable public BuyBackWalletAddress = payable(0x9e785300dE06c1C02C757BfEDAA1421Fcc17c6d2);
