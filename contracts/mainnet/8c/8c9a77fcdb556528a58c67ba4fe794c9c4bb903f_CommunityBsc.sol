...
// Bsc Community 
// Lp lock for 1 day// 50k Lock for 1 week// 100k Lock for 1 month// 250k Renounced and burn LP
// No jeet in your community
// If you create a telegram i doxx in 200k
// Starting lp 3BNB 

// Community Token No telegram, no twitter, no website. [Community can make this]
...
contract CommunityBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Community Bsc";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x0cE9d472f10f3BB3aBad3b5d2304688C1d8484A7;
        marketingFeeReceiver = 0x0cE9d472f10f3BB3aBad3b5d2304688C1d8484A7;
