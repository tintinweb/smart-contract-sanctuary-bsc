...
contract BearCoin is Context, IERC20, Ownable {
    ...
    uint256 private constant JACKPOT_BIGBANG_MIN = 10000 * 10**USDT_DECIMALS;
    ...
    // Buy fees
    // 1% liquidity
    uint256 public bLiquidityFee = 200;
    // 2% marketing
    uint256 public bMarketingFee = 500;
    // 2% dev
    uint256 public bDevFee = 300;
    // 2% jackpot
    uint256 public bJackpotFee = 300;

    // Sell fees
    // 1% liquidity
    uint256 public sLiquidityFee = 200;
    // 5% marketing
    ...
    function setJackpotHardFeatures(
        ...
        require(
            ...
            "Jackpot hard value limit for the big bang needs to be between 10K and 250K USD"
        );
    ...
    function transferStandard(
        ...
        emit Transfer(sender, recipient, tTransferAmount.sub(tFees));
    }
