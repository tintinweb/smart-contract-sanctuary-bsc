...
contract SRG20 is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string private constant _name = "FEET SURGE";
    string private constant _symbol = "FeetSrg";
    ...
    //Tax wallets
    address public teamWallet = 0x744B23424d21355998523643FdA20f39942B90a4;
    address public treasuryWallet = 0xbdAb08f28B691f1B40B6273752B997B6257e6e37;
