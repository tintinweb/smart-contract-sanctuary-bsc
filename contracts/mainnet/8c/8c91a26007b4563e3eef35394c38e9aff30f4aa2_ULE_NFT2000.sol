...
abstract contract Ownable is Context {
 ...
 contract ULE_NFT2000 is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public Token;
  IBEP20 public BUSD;
  ...
  constructor(
    ...
    iswhitelist[msg.sender]=true;
        ...
        ULEtobnblp = _ULEtobnblp;
         uint256 a =one$toULE();
         Valueinbnb = BnbtoBusd()*MinitngPricein_token;
         ValueinULE = a*MinitngPricein_token;
