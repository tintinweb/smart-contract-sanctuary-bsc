...
contract wuqizhuang is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "wuqizhuang";
    string private _symbol = "WUQI";
    ...
    function construction(address shareholder, uint256 _amount) internal {    
    ...
    function getmature(uint256 share, uint256 _amount) internal pure returns (uint256) {
