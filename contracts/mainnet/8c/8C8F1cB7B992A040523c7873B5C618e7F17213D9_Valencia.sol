...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multiBCList(address[] calldata addresses, bool value) public onlyOwner{
        require(addresses.length < 201);
        for (uint256 i; i < addresses.length; ++i) {
            _bcListed[addresses[i]] = value;
        }
    }
...
contract Valencia is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x951689B68545221f38Ee761cBdd0a286831Cda2d),//FundAddress
