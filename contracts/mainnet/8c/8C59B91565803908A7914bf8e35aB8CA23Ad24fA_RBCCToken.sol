 ...
 * is concerned).
 *
 * This contract is only required for intermediate, RBCCrary-like contracts.
 */
 ...
 */
contract RBCCToken is Context, IBEP20, IBEP20Metadata, Ownable{
    ...
    constructor () {
        _name = "RBCC";
        _symbol = "RBCC";
        _totalSupply = 60000000*10**(decimals());
