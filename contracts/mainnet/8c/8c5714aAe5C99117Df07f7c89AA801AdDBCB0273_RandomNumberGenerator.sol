...
// File: contracts\Interface8\IOpensaleFinanceLottery.sol


pragma solidity ^0.8.4;

interface IOpensaleFinanceLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in ODC per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in ODC token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInOdc: price of a ticket in ODC
...
// File: contracts\Interface8\IRandomNumberGenerator.sol
...
// File: contracts\Lib8\VRFRequestIDBase.sol
...
// File: contracts\Interface8\LinkTokenInterface.sol
...
// File: contracts\Lib8\VRFConsumerBase.sol
