...
contract BabyRpDoge is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby rpDoge";
    string private _symbol = "BRPDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07996df16d8a6850bf60398589FE0ef9d224784E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x239f7866056a47AC34b7c14b45ACfFe45F09dC27); // BuyBack Address
