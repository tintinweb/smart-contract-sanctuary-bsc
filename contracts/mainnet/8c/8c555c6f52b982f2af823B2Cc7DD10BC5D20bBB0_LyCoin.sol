...
contract LyCoin is ERC20Detailed, Ownable {
    ...
    string public _name = "LyCoin";
    string public _symbol = "LyCoin";
    ...
    uint256 public sellbuyFee = 15;


    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(sellbuyFee);      
    ...
    uint256 public rewardYield = 4800000;
    ...
    constructor() ERC20Detailed("LyCoin", "LyCoin", uint8(DECIMALS)) Ownable() {
    ...
    function takeFee(
        ...
        uint256 _sellbuyFee = sellbuyFee;
        ...
        _gonBalances[devAddress] = _gonBalances[devAddress].add(
            gonAmount.div(feeDenominator).mul(_sellbuyFee)
        );
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(devAddress).call{
            value: amountETH.mul(sellbuyFee).div(
                totalFee
            ),
            gas: 30000
        }("");
    ...
    function setFees(
        ...
        totalFee = liquidityFee.add(treasuryFee).add(20);
