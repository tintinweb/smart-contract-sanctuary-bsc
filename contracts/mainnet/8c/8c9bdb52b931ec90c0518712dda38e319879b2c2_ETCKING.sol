...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x55d398326f99059fF775485246999027B3197955);//分红什么币就填那个币的合约
...
contract ETCKING is IBEP20, OWNABLE {
    using SafeMath for uint256;
    ...
    string constant _name = "KING";//名字
    string constant _symbol = "KING";//符号
