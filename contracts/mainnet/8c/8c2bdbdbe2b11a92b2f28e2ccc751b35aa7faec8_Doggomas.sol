...
/**
*Every tax that comes in will be donated to abandoned dogs out there!
Let's save abandoned dogs!
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8A3a5D50806A5577bD5016a30746c2FeA26Ef06F; // owner address
...
contract Doggomas is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doggomas";
    string private _symbol = "Doggomas";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8A3a5D50806A5577bD5016a30746c2FeA26Ef06F); // Marketing Address
    address payable public teamWalletAddress = payable(0x8A3a5D50806A5577bD5016a30746c2FeA26Ef06F); // Team Address
