...
contract SpearowCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xCcEC9Ac8B59892451995109BB3f6872ee8e7F401;
    string constant _name = "SpearowCoin";
    string constant _symbol = "SPEAROW";
