...
TELEGRAM: https://t.me/PORTALCATTOOLS
CAT TOOLS CAN USE TO SNIPE GOOD PROJECT NANOCAPS
...
contract CATTOOLS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " CATTOOLS ";
    string private _symbol = " CATTS "; 
