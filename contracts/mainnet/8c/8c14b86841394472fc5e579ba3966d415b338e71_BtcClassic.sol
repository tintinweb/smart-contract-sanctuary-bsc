...
contract BtcClassic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF0c59C1Bee5e7E9d6A47768eEa3A96CAeC005354); // Marketing Address
    ...
    string private _name = "BTC Classic";
