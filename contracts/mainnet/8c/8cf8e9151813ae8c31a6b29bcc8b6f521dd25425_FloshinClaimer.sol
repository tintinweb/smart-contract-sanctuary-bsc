...
contract FloshinClaimer is Ownable, ReentrancyGuard {
    ...
    function getMinfloshinNeeded() public view onlyOwner returns (uint) { 
    ...
    function claim() public  nonReentrant{ 
        ...
        uint256 amountAirdr = (balanceFloshin * (percentage/100)); 
    ...
    function getFloshinPrice() public view onlyOwner returns (uint) {
        return getTokenPriceInUSD(0xc9EAbA24483eFbdC3af6874598D5bAD4Dc4C995D, 0x1B96B92314C44b159149f7E0303511fB2Fc4774f);
    }

    function setPercentage(uint percent, uint _minDollars, uint _maxDollars) public onlyOwner  {
        require(percent > 1 && minDollars > 1 && maxDollars < 256);
        percentage = percent;
