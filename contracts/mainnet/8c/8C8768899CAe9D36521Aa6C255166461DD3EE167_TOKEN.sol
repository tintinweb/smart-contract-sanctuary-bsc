...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f; // owner address
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "dajiji";
    string private _symbol = "dajiji"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f); // Marketing Address
    address payable public teamWalletAddress = payable(0x5C5028cb10A3206387091281fb6b8bd8a19Fc68f); // Team Address
