...
contract MyCo is Context, IERC20, Ownable {
    ...
    string private _name = "MyCommunity";
    string private _symbol = "MyCo";
    ...
    address payable public marketingWallet = payable(0x130eD276D7345e0A1590d409C7dcd9723d7b7E7C);
    address payable   devWallet = payable(0x130eD276D7345e0A1590d409C7dcd9723d7b7E7C);
