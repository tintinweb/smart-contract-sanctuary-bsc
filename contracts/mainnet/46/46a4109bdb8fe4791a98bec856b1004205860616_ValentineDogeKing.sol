...
//Telegram : https://t.me/ValentineDogeKing
...
contract ValentineDogeKing is Context, IERC20, Ownable {
    ...
    address private _marketinhWalletAddress = 0x8fFF679564b933B0C4b12cF6a11A5d12f95FF4dF;
    ...
    string private _name = "Valentine Doge King";
    string private _symbol = "VDK";
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	...
  	function setMarketingWallet(address _marketingWallet) external onlyOwner{
  	    _marketinhWalletAddress = _marketingWallet;
  	}
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_marketinhWalletAddress] = _rOwned[_marketinhWalletAddress].add(rCharity);
        if(_isExcluded[_marketinhWalletAddress])
            _tOwned[_marketinhWalletAddress] = _tOwned[_marketinhWalletAddress].add(tCharity);
    }
