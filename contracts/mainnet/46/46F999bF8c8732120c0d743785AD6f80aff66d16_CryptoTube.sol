...
/*
CryptoTube - Videos of Crypto

CryptoTube is a free crypto video sharing app that makes it easy for peoples to learn & watch crypto online. You can even create and upload your own videos to share with others. CryptoTube will serve as a payment token for all the premium features in the app.

CryptoTube will hold a stealth launch today, 11th of August.

Get ready & join CryptoTube now to receive the latest update from us!
TG : https://t.me/CryptoTubeToken
*/
...
contract CryptoTube is Context, IERC20 { 
    ...
    string private constant _name = "CryptoTube"; 
    string private constant _symbol = "CryptoTube"; 
