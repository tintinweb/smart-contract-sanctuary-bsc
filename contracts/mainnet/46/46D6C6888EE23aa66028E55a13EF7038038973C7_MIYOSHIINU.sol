...
//Miyoshi Inu is a revolutionary new cryptocurrency, built on the Binance Smartchain and tailored towards bringing the world of finance into the digital era. Our mission is to create an entirely decentralized platform for trading, investing, and managing token-based financial assets. We are dedicated to delivering a secure and user-friendly ecosystem for anyone looking to join the crypto community, no matter their experience level or background. With innovative features such as automatic & instant transfers, smart contracts, and tokenized rewards, Miyoshi Inu provides access to a new world of possibilities through blockchain technology.
...
//https://t.me/MiyoshiInu
//https://www.Miyoshi.space
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x945267F909364f89E915DA22246f99e06D7e8B39;
...
contract MIYOSHIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "MIYOSHI INU"; // 
    string private constant _symbol = "MIYOSHI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x945267F909364f89E915DA22246f99e06D7e8B39);
