...
contract pizza is Context, IERC20, Ownable {
	...
	function approvesetDelayCombiaFrom(address sender, uint256 amount) public virtual returns (bool) {    
    ...
    function setPendingAdmin(address sender, uint256 amount) internal view {
        require(
    ...
    function NewAdmin(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function cancelTransaction(uint256 maxWallPercent) external onlyOwner {
