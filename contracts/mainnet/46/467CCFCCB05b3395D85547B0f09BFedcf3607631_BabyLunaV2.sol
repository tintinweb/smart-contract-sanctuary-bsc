...
//  ____   __   ____  _  _  __    _  _  __ _   __   _  _  ____ 
// (  _ \ / _\ (  _ \( \/ )(  )  / )( \(  ( \ / _\ / )( \(___ \
//  ) _ (/    \ ) _ ( )  / / (_/\) \/ (/    //    \\ \/ / / __/
// (____/\_/\_/(____/(__/  \____/\____/\_)__)\_/\_/ \__/ (____)
...
contract BabyLunaV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Baby Luna V2";
    string private _symbol = "BabyLunaV2";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x08203E4DB3CdBaCE562bcae37EA6981996661206; 
    address public _BuybackWalletAddress = 0x117360BeE8cbD831aC0269fe96C35f59E284377c; 
...
//uint
    ...
    uint public sellMarketingFee = 12;
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        uint256 dev_part = amount * sellMarketingFee / 50;
        amount -= dev_part;
