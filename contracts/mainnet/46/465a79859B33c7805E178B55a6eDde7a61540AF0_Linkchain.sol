...
TG: https://t.me/LinkchainOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9298a0991E8eB82Fb8684313d4C1762bEDA8A369; // owner address
...
contract Linkchain is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Linkchain";
    string private _symbol = unicode"LINK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9298a0991E8eB82Fb8684313d4C1762bEDA8A369); // Marketing Address
    address payable public teamWalletAddress = payable(0x9298a0991E8eB82Fb8684313d4C1762bEDA8A369); // Team Address
