...
contract AnonymousDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Anonymous Dog";
    string private _symbol = "AnonDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90404a913b7836327eeC471c0F983FC53953d53D);
    address payable public DevWalletAddress = payable(0x90404a913b7836327eeC471c0F983FC53953d53D);
    ...
    uint256 private minimumTokensBeforeSwap = 300 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (_totalSupply * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
