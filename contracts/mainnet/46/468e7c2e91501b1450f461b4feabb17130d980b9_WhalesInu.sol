...
contract WhalesInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhalesInu";
    string private _symbol = "WINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25FD17a7C825043b11a37F48Ca1BcA06dCBE03CC); 
    address payable public DevelopmentWalletAddress = payable(0x3C808c42C954410ae92F975cF04A75b3884135c2); 
