...
contract token is ERC20 {
    ...
    string internal tokenName = "TYD";
    string internal tokenSymbol = "TYD";
    uint256 constant total  =  1000000000000 * 10**18;
    address public marketAddress = address(0xf3F7Ab15f279062f4b69Bf2a3C455913369161eb);
    uint256 buyFee = 20;
    uint256 sellFee = 960;
