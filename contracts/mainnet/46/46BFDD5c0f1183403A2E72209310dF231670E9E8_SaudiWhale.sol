...
contract SaudiWhale is Ownable, IERC20 {
    ...
    string public _name = "Saudi Whale";
    string public _symbol = "SWHALE";

    uint public _liquidityFee = 1;
    uint public _marketingFee = 7;
    ...
    uint256 public _maxWallet =   60000000 * 10 ** _decimals;
