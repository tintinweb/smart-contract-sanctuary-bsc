...
contract ConservativeElon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0x00E17B94FF25930898355627ea6f02D6EBE10E96); // Marketing Address
    ...
    string private _name = "Conservative Elon";
    string private _symbol = "CONELON";
