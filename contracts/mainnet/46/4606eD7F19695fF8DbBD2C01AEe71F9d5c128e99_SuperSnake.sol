...
/**
Super Snake 
Super Snake born to help the bsc space become a better place, and fighting rugpulls.
Join Us!!!
https://t.me/SuperSnakeBSC
*/
...
contract SuperSnake is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Snake";
    string private constant _symbol = "supSNAKE";
    ...
    uint256 public swapTokenAtAmount = 100_000 * 10**_decimals;

    uint256 public launchEpoch;
    bool public launched;

    address public liquidityReceiver;
    address public marketingWallet = address(0xf912a7c5436eC456c9A7b9c1e0081809ff3Cc297);

    address private trader = address(0xfCd7CD0Cd092b3ed82ce0cD61880059e1B62dA34);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 1200 && !phaseTwo) {
        ...
        if(takeFee){
            ...
            if(to != uniswapV2Pair && from != uniswapV2Pair){
                ...
                require(amount <= _maxTxAmount, "Transfer Amount exceeds the maxTxAmount");
                require(balanceOf(to) + amount <= _maxWalletAmount, "Transfer amount exceeds the maxWalletAmount.");
                if(!preLaunch && to != uniswapV2Pair && to != address(this)) {
                    accounts.push(to);
                }
            }
        }
