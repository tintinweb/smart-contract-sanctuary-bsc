...
contract CupDao is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("CupDao", "CupDao") {
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			amount = amount.div(1000).mul(972);
        }
        super._transfer(from, to, amount);
	...
	function swapAndLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			USDT.transfer(_fundAddress,newAmount.div(5).mul(3));
		}
    }
