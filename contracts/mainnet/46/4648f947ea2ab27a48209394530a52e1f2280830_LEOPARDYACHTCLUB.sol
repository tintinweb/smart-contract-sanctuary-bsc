...
contract LEOPARDYACHTCLUB is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("LEOPARDYACHT CLUB", "LEOPARDYACHTCLUB") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "LEOPARDYACHTCLUB";
    string private _symbol = "LEOPARDYACHTCLUB";
