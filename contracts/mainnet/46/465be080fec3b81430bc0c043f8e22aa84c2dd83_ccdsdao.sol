...
contract ccdsdao
 is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xcc3BEDb5AAcFd76ec9dAb2F20B580386df399034));
        _babywallet = payable(address(0xcc3BEDb5AAcFd76ec9dAb2F20B580386df399034));
