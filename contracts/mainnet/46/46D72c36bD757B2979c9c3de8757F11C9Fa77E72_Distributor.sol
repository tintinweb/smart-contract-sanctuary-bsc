...
import "./types/ShibDoshAccessControlled.sol";

contract Distributor is IDistributor, ShibDoshAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        require(_bone != address(0), "Zero address: BONE");
        bone = IERC20(_bone);
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return bone.totalSupply().mul(_rate).div(rateDenominator);
    }
...
import "../interfaces/IShibDoshAuthority.sol";
