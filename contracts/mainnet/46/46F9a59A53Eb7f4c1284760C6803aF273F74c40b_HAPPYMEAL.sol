...
/**
Telegram : https://t.me/Happymeal20
*/
...
contract HAPPYMEAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Meal 2.0"; // Token Name
    string private constant _symbol = "HP"; // Token Symbol
    uint8 private constant _decimals = 9; // Total Decimal Number
    
    uint256 public eventTime = 0;

    uint256 public _marketingFee = 1; 
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x046Cf53813B6ba6BBe82A1283Acd13Addc6cA63A;
