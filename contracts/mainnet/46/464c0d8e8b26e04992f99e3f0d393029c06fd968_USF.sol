...
contract USF is BEP20, Ownable {
    ...
    address public marketingWallet = 0xAe893288637EaabD056A92B7b7346610183F113e;
    address public opsWallet = 0x22869d0d590C38FBaB64c52e365FFaE0323b9e56;
    address public w2eWallet = 0x3B36d29e62a3CdDa487be631f5f46Abfc006A56E;
    address public devWallet = 0xADfd0329695F505f8E53fd97bE22003b0d3F55DF;
    ...
    Taxes public taxes = Taxes(2, 0, 1, 1, 1);
    Taxes public sellTaxes = Taxes(2, 0, 1, 1, 1);
    ...
    constructor() BEP20("Universal Sports Finance", "USF") {
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 w2eAmt = unitBalance * 2 * swapTaxes.w2e;
            if (w2eAmt > 0) {
                payable(w2eWallet).sendValue(w2eAmt);
            }
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _ops,  _w2e, _dev);
        require((_marketing + _liquidity + _ops + _w2e + _dev) <= 10, "Must keep fees at 10% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _ops,  _w2e,  _dev);
        require((_marketing + _liquidity + _ops + _w2e + _dev) <= 10, "Must keep fees at 10% or less");
    }
    ...
    function updateW2EWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0),"Fee Address cannot be zero address");
        w2eWallet = newWallet;
    }
