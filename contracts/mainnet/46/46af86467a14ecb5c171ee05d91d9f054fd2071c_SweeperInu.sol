...
/**
I know the bear market has been tough on you anon, but its time to get to the floors and start sweeping these discounts while they last 🧹

https://t.me/SweeperInu

6/6 Tax - 4 Broomstick Closet (Treasury), 1 LP, 1 Dev

2% max wallet

Website realeased at 15k MC... 

It's up to you anon, fade this, or get sweeping... It's time to return to valhalla...
...
contract SweeperInu is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "SweeperInu";
    string constant _symbol = "SWEEP";
    ...
    address public devFeeReceiver = 0x09862C751135c79f2E47d8C3B21eD646Ab77356a;
    address public buybackFeeReceiver = 0xbD1a46ab4E1Bf35B1FFbDE315dc21820827bE11e;
