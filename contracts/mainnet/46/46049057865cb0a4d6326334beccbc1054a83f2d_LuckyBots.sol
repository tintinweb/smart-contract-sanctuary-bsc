...
contract LuckyBots is ERC20, Ownable {
    ...
    constructor() ERC20("LuckyBots", "LUCKY") {
        ...
        swapTokensAtAmount = totalTokenSupply / 2000000; // 2%;
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= _totalSupply / 50000, "max wallet cannot be set to less than 0.5%");
        maxWallet = value;
    }
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 0, "zero transfer fees forever");
...
contract LuckyBotsDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(
        ...
        minimumTokenBalanceForAutoDividends = 100000_000000000000000000; // 100 tokens
