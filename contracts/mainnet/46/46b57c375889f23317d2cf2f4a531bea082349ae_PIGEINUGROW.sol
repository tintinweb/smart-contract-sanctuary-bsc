...
contract PIGEINUGROW is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x280703cb2A7E44B0F9A4E9902309822Bd16fdd14); 
    address payable public Wallet_Dev = payable(0x280703cb2A7E44B0F9A4E9902309822Bd16fdd14);
    ...
    string private constant _symbol = unicode"PINUGROW"; 
    ...
    constructor () {
        ...
        _owner = 0x280703cb2A7E44B0F9A4E9902309822Bd16fdd14;
