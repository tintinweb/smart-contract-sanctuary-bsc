...
contract TooManyJeets is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5eb3fd65e101CeB50588514c6745Ba6b8f1100d6;
    address public devWallet = 0xda23C47836e5e998180CfEfCa72937f66A1cb550;
    address public buybackWallet = 0x8c7798f51D20b3f5E327D964333E6cCaA14121FA;

    string private constant _name = "CheemsYachtClub";
    string private constant _symbol = "CheemsYC";
    ...
    Taxes public taxes = Taxes(0, 6, 4, 1, 2);
    Taxes public sellTaxes = Taxes(0, 6, 4, 1, 2);
