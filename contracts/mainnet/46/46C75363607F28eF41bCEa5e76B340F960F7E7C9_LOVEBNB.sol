...
contract LOVEBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "LOVE BNB";

    string private _symbol = "LOVE BNB";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xE67d37bd5A31e6091529070023947fF4Ec303b2D;
    ...
    uint256 public _totalSupply =  163276974 * 10**_decimals;
