...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe85cf740825fDCa69235F7357477FcCB782CA69D; // owner address
...
contract FIFABOY is Context, IERC20, Ownable {
    ...
    string private _symbol = "$FBOY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe85cf740825fDCa69235F7357477FcCB782CA69D); // Marketing Address
    address payable public teamWalletAddress = payable(0xe85cf740825fDCa69235F7357477FcCB782CA69D); // Team Address
