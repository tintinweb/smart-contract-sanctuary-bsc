...
/*
EpicInu is a new BSC token with P2E game with pet concept. By using EpicInu, you are able to buy your favorite pet & feed them, and after your pet has raise to a certain level, they are able to go out & get random tokens for you! 

1) Gem token with P2E concept
2) Pet will grow & get random tokens for you
3) EpicInu reflection by holding the tokens
4) A combination of both experienced dev & programmers

Tokenomics:
- 1 quadrillion of supply (1,000,000,000,000,000)
- 8% of tax fees
- 1 BNB as initial LP

Play for the maximum benefits you can get now!
Join us on TG : https://t.me/EpicInu
*/
...
contract EpicInu is Context, IERC20 { 
    ...
    string private constant _name = "EpicInu"; 
