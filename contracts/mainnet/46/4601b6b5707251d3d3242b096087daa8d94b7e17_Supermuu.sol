...
contract Supermuu is IBEP20, Auth {
    ...
    string constant _name = "Super Muu";
    string constant _symbol = "SMUU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x69256952dC9e23578785e214460e65Ee9BC97824;
        treasuryFeeReceiver = 0xC6f2948c0b916a077500b8890932813A7dB26011;
        devFeeReceiver = 0xC6f2948c0b916a077500b8890932813A7dB26011;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 2000;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) / 2000;
    }
