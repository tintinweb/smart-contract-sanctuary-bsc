...
Now is the era of anime on bsc! Kunoichi Tsubaky is going  to make his step towards moon!
By giving every holders $BUSD for every hour. BUSD rewards will depends on your $TSUBAKY Holds.
Marketing plan is not just an ordinary callers but also have 4chan to attract mostly chinese investors.
Get ready your bags cause we're about to launch 🌕.

4% Marketing
4% Liquidity
4% BUSD

In total of 12% slippage ( Buy : 5% | Sell : 12% ) 
...
*/
    ...
    contract KunoichiTsubaky  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Kunoichi Tsubaky";
        ...
        address public constant MarketingWallet=0xa993540940774EDd9CFF5997D90380eEe224458A; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function BUSDManualClaim(address[] calldata addresses) external onlyOwner {
