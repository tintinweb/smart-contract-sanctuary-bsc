...
/*
    ...
    Telegram : https://t.me/MsTweetBSC
...
contract MsTweet is Context, IERC20 { 
    ...
    address[] w_L = [payable(0x6973d8F0b750431375A9fE5BB34058b60eD571dd)];

    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0xE1F95091fD6D87cb0a20fF3DED3511D50bd1cB13); 
    address payable public Wallet_Dev = payable(0xE294732DE33d652C775aA7d33B87688Be8762aD8);
    ...
    constructor () {
        ...
        _owner = 0xE294732DE33d652C775aA7d33B87688Be8762aD8;
