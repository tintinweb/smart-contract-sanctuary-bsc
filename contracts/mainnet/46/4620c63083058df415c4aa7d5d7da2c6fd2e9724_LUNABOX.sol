...
contract  LUNABOX is ERC20 {
   ...
   bool public swapping;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 public swapTokensAtAmount = 65 * 10**6 * 10**9;
  ...
  address  private ererer = 0x149D9bCb1ae46D37A69144aCd53102dA78D8b523;
    ...
    constructor(
    ...
    ) public ERC20("LUNABOX", "LUNABOX",9) {
        ...
        _balances[owner()] = (13*10**9) * (10**9);
          emit Transfer(address(0), owner(), (13*10**9) * (10**9));
    }
  ...
  function  setswapTokensAtAmount(uint256 amount)public pauseOwner(){
