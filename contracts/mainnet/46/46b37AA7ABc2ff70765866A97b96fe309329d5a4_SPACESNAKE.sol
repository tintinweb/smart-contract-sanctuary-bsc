...
contract SPACESNAKE is IERC20, Ownable {
    ...
    string _name = "SpaceSnake";
    string _symbol = "SSNAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100;   // 1% will beincreased to 3%
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x309375a0527DC8D7b3C74f3aeD6F4c3401752f7D;
        marketingFeeReceiver = 0x309375a0527DC8D7b3C74f3aeD6F4c3401752f7D;
        devFeeReceiver = 0x309375a0527DC8D7b3C74f3aeD6F4c3401752f7D;
