...
Time changes and most are leaving BSC loudly. 
We decided to stay!
Made ourselves comfortable with the silence of this space. Many of us grew into the crypto world through BSC. So it's time to moon here together. A strong community and a humble team turn this to a GEM. 

Regularly check the "getAnnouncement" and "getHint" function of our contract!

Join SilentProtocol. Less talk, more moon.
...
interface IBEP20 {
    ...
    function getMysteryOwner() external view returns (address);
...
contract SilentProtocol is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SilentProtocol";
    ...
    function getMysteryOwner() external view override returns (address) { return owner; }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // We dont want bots here, get the fuck off !"
        if(ByeByeBots){
    ...
    // Mystery
    function _setAnnouncement(string memory _value) external authorized {
    Announcement = _value;
    }

    function _setHint(string memory _value) external authorized {
    Hint = _value;
    }
