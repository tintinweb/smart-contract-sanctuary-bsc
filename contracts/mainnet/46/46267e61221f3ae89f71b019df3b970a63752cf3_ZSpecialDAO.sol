...
contract ZSpecialDAO is ZSpecialETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtZSpecialETR;
    address private CharityZSpecialETR;
    ...
    string public override name = "ZorbsZoraSpecial";
    string public override symbol = "ZSpecial";
    ...
    constructor(uint totalSupplyValue, address TeamtZSpecialETRAddress, address CharityZSpecialETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtZSpecialETR = TeamtZSpecialETRAddress;
        CharityZSpecialETR = CharityZSpecialETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtZSpecialETR] = totalSupply * 4 / 100;
        balances[CharityZSpecialETR] = totalSupply * 4 / 100;
