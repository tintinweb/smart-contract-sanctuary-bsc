...
contract VIPdoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "VIPdoge";
    string private _symbol = "VIPdoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73f339aa37C0676c25c25fc1047A458CbE180b81);
    address payable public teamWalletAddress = payable(0x73f339aa37C0676c25c25fc1047A458CbE180b81);
    ...
    uint256 private _totalSupply =  180000000 * 10**_decimals;
    uint256 public _maxTxAmount =   180000000 * 10**_decimals; 
    uint256 public _walletMax =     180000000 * 10**_decimals;
