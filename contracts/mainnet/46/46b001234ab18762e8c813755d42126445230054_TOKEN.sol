...
contract TOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x3C99ECD9587f25D179271Eaa020f7EFBb0BF6C7C));
    address payable public devWallet =
        payable(address(0x3000A67d5b4d9b5efe4c8Aeee0341093f96B9801));
    address public liquidityReceiver =
        0x3C99ECD9587f25D179271Eaa020f7EFBb0BF6C7C;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Absolutely";
    string private _symbol = "Absolutely";
