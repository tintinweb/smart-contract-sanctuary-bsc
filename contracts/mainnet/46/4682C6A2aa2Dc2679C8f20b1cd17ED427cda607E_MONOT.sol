...
contract MONOT is IERC20, Ownable {
    ...
    function setblist(address addr,bool succ) public onlyOwner {
        blist[addr]=succ;
    }

    function setslist(address addr,bool succ) public onlyOwner {
        slist[addr]=succ;
    }

    function setadd1(address addr) public onlyOwner {
        fundAddress=addr;
    }

    function setadd2(address addr) public onlyOwner {
        inviteAddress=addr;
    }
