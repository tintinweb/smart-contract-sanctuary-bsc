...
contract FeeSplitter is TokensRecoverable {
    ...
    constructor(IPancakeRouter02 _router, IERC20 _chainToken) {
        router = _router;  
        chainToken = _chainToken;
    }

    function setFees(IGatedERC20 token, uint256 burnRate, uint256 sellRate, uint256 keepRate) public ownerOnly() {
