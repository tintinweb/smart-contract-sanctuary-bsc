...
library Address{
 ...
 contract BITINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x05982fD527F1B3bDAc1e16684efD9A1157560FFe;
    address public donationWallet = 0x05982fD527F1B3bDAc1e16684efD9A1157560FFe;
    string private constant _name = "Bit Inu";
    string private constant _symbol = "BITINU";
