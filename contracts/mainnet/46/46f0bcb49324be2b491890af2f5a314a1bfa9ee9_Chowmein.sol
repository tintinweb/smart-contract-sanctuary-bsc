...
/**
炒面社区是中国最大的会员群，也是每日最活跃的头部社区电报群，对TG中国有着不可否认的宣传和影响力。 竞赛

TG：https://t.me/chowmeintoken
...
contract Chowmein is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private _name = "Chowmein";
    string private _symbol = "chowmein";
