...
// Telegram : https://t.me/ElonsEnemy   *TAX : 5/5    *RENOUNCED CONTRACT
...
contract ElonsEnemy is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elons Enemy";
    string private _symbol = "ELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45574d25fad7d47090F0106be08EfC562B825665); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x45574d25fad7d47090F0106be08EfC562B825665); // BuyBack Address
