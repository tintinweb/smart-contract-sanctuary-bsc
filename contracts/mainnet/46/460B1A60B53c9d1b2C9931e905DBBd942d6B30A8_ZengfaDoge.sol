...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "ETHSlr";
    string private _symbol = "ETHSlr";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0BeBe80DF3C578bDB312bc8AC7E140CfA1F27ea1));
        marketingWalletAddress = payable(address(0x0BeBe80DF3C578bDB312bc8AC7E140CfA1F27ea1));
