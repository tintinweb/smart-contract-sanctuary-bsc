...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F7C2DDd3c848A60360B61B52B456c24FB1e1fC7; // owner address
...
contract PRAYFORBSC is Context, IERC20, Ownable {
    ...
    string private _symbol = "StandwithBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3F7C2DDd3c848A60360B61B52B456c24FB1e1fC7); // Marketing Address
    address payable public teamWalletAddress = payable(0x3F7C2DDd3c848A60360B61B52B456c24FB1e1fC7); // Team Address
