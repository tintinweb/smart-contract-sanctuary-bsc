...
contract LuckyStar is ERC20 {
    ...
    uint256 private lpIntervalTime = 30 * 60;    
    ...
    string internal tokenName = "LuckyStar";
    string internal tokenSymbol = "LuckyStar";
    uint256 constant total  =  868686 * 10**18;

    address private swapRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    IERC20 private RewardToken = IERC20(0xc0C9Df3dFcbC0a56715770b75E8C0a5855f3B552);
    address private pairToken = address(0xc0C9Df3dFcbC0a56715770b75E8C0a5855f3B552); 
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(from == uniswapV2Pair ){
                ...
                uint256 allFee = amount.div(1000).mul(blpFee + bliquidFee);
                uint256 cliquidCount = amount.div(1000).mul(bliquidFee);
                ...
                amount = amount.div(1000).mul(1000 - (blpFee + bliquidFee));
                
            }else if(to == uniswapV2Pair){
                uint256 allFee = amount.div(1000).mul(slpFee + sliquidFee);
                uint256 cliquidCount = amount.div(1000).mul(sliquidFee);
                super._transfer(from, address(this), allFee);
                liquidCount =liquidCount.add(cliquidCount);
                LPCount = LPCount.add(allFee.sub(cliquidCount));
                amount = amount.div(1000).mul(1000 - (slpFee + sliquidFee));
