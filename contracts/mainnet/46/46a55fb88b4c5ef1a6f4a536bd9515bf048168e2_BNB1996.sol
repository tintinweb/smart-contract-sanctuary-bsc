...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0A700c8796ac588f7a843C55C9Bc0E9A3d008866; // owner address
...
contract BNB1996 is Context, IERC20, Ownable {
    ...
    string private _symbol = "$BNB96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0A700c8796ac588f7a843C55C9Bc0E9A3d008866); // Marketing Address
    address payable public teamWalletAddress = payable(0x0A700c8796ac588f7a843C55C9Bc0E9A3d008866); // Team Address
