...
import "./BabyCloudChatERC20.sol";
import "./UniSwap.sol";
 
import "./SafeMath.sol";


contract BabyCloudChat is BabyCloudChatERC20  {
    ...
    address public constant PRESALE_ADDRESS            = 0xF5518B2aD233A10dc667dd8e4CcCA9036e52360E ;     
    address public constant MARKETING_ADDRESS          = 0xdCad2DFdfc0077d9784c13288b9784cCeF15D3Ba;
    address public constant PARTNERS_ADVISORS_ADDRESS  = 0x091FB18b719c6efBCaCDc8d3B15ad4cc4622eC13 ;
    address public constant DEV_ADDRESS                = 0xc9C2C88Dd076fB76F75e4D2C73774059578c33Ac;
    address public constant PRIVATESALE_ADDRESS        = 0x3D7587093388DDea66F1ac2A92E2b4e095a4312c;
    address public constant REWARD_POOL_ADDRESS        = 0x444403608311DD3395Fd76D9464ed354A6D5Bc84;

    address public taxAddress                = 0xaaA166Bb423955BE988faA43928E6FFD417C3151;

    event TaxAddressChanged(address oldAddress, address newAddress);

    constructor(
        string memory name, 
        string memory symbol,
        address pancakeRouterAddress
    ) BabyCloudChatERC20(name, symbol) {
        
        uint256 decimal = 10**decimals();
        uint256 totalSupply = 10 ** 9 * decimal ;

        _mint(PRESALE_ADDRESS           , (totalSupply * 30).div(100)); // 30%
    ...
    function setTaxAddress(address addr) external onlyOwner {
        ...
        address oldAddress = taxAddress;
        taxAddress = addr;
        emit TaxAddressChanged(oldAddress, addr);
    }
}
...
contract BabyCloudChatERC20 is  ERC20, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    function setTransferFeeRate(uint256 sellFee, uint256 buyFee ) external onlyOwner {
        sellFeeRate = sellFee;
        buyFeeRate = buyFee;
        emit FeesChanged(sellFee, buyFee);
    }
