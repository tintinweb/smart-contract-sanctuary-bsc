...
contract Minenan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Minenan";
    string private _symbol = "Minenan";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x071ecD729556102c12E61F814B75A9a0CFBCd96A);
