...
/* ApexNetwork -  APEXNetwork is APEX-Backed Digital assets for a stable currency with Binance Smart Chain Network. APEXNetwork Will become The world’s only enterprise blockchain solution for global payments
...
contract ApexNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf788a383d16cC0903F8113fEa1aAd8cA650e7C8D); // Marketing Address
    address payable public charityAddress = payable(0xf788a383d16cC0903F8113fEa1aAd8cA650e7C8D); // Charity/Dev Address
    ...
    string private _name = "ApexNetwork";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 800000000000000000000000000; // 500,000,000; token will be given on airdrop
