...
\ \/  \/ / _ \/ _ \/ _` |  /__\/// _` | '_ \ / _ \/ __|
 \  /\  /  __/  __/ (_| | / \/  \ (_| | |_) |  __/\__ \
  \/  \/ \___|\___|\__,_| \_____/\__,_|_.__/ \___||___/
                                                       


https://t.me/weedbabes
...
contract WeedBabes is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WeedBabesDividendTracker public dividendTracker;
    ...
    constructor() ERC20("WeedBabes", "WEEDBABES") {
        marketingWallet = payable(0xC95A8a2aAbcEAF6F21895dc1f473407D25178B2E);
        devWallet = payable(0xCAb87D4770D3804D5Bd55f61D558C17EB6D8574A);
        ...
        dividendTracker = new WeedBabesDividendTracker(
            payable(this),
            router,
...
contract WeedBabesDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WeedBabes public WeedBabesContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WeedBabesContract = WeedBabes(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WeedBabes_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WeedBabes_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WeedBabes contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WeedBabesContract);

            uint256 prevBalance = WeedBabesContract.balanceOf(address(this));
            ...
            {
                uint256 received = WeedBabesContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WeedBabesContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
