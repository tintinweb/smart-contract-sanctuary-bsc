...
/**     
❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆
Project -Snow Chain Protocol ❆
Name - Snow CHAIN            ❆
Symbol - SNOW                ❆  
❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆❆
Telegram : https://t.me/SnowChainProtocol
Twitter : https://twitter.com/SnowChainProtocol
Website : tba 
...
contract SnowChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SnowChainDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Snow Chain Protocol", "SNOW") {
        marketingWallet = payable(0x5682b1A72ddaa94A828EDc409aF4c4e00156d5A7);
        devWallet = payable(0xABE9e1f690201247521e1d724cA296760DeB706c);
        ...
        dividendTracker = new SnowChainDividendTracker(
            payable(this),
            router,
...
contract SnowChainDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SnowChain public SnowChainContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SnowChainContract = SnowChain(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SnowChain_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SnowChain_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SnowChain contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SnowChainContract);

            uint256 prevBalance = SnowChainContract.balanceOf(address(this));
            ...
            {
                uint256 received = SnowChainContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SnowChainContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
