...
contract KibaGold is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kiba Gold";
    string private _symbol = "KIBAGOLD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x51422D799a5578f0c79e0db6A230300a63916cf3);
    address payable public BuyBackWalletAddress = payable(0x51422D799a5578f0c79e0db6A230300a63916cf3);
