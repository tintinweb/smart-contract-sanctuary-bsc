...
library Address{
 ...
 contract TalesofSpyro is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xfC2A9359E1280da3Bc656BB210FC663cda5A2764;
    address public donationWallet = 0xfC2A9359E1280da3Bc656BB210FC663cda5A2764;

    string private constant _name = "Tales of Spyro";
    ...
    Taxes public sellTaxes = Taxes(0, 8, 0, 0);
