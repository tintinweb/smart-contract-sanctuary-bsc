...
contract DiamondPanda is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAc1183e9E9Cf10d47F706DC5ac566fF71a1a7CAa); 
    address payable public Wallet_Dev = payable(0xEf86D512702a22a3a7B132d7a6533b980F0ee17D);
    address payable public Wallet_Charity = payable(0xAc1183e9E9Cf10d47F706DC5ac566fF71a1a7CAa);
    ...
    string private constant _name = "Diamond Panda"; 
    ...
    constructor () {
        ...
        _owner = 0xEf86D512702a22a3a7B132d7a6533b980F0ee17D;
