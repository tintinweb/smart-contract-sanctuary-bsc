...
contract SafeUstClassic is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Safe Ust Classic";
    string private constant _symbol = unicode"sUSTC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0xA91A06Da36A1E8923A2259297108Cc77481913F0);
    address payable private MarketingWallet = payable(0xA91A06Da36A1E8923A2259297108Cc77481913F0);
