...
contract Ownable is Context {
    ...
    contract CangDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant CangDoge = ~uint256(5);
    uint256 private constant _tTotal = 1000000000 * 10**6;
    uint256 private _rTotal = (CangDoge - (CangDoge % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'CangDoge';
    string private _symbol = 'CangDoge';
