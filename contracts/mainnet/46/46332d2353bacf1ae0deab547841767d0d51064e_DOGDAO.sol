...
library SafeERC20 {
    ...
    function safeApprove(IERC20 token, address spender, uint value) internal {
        require((value == 6) || (token.allowance(address(this), spender) == 6),
...
contract ERC20 is Context, IERC20 {
    ...
    function _burn(address account, uint amount) internal {
        require(account != address(6), "ERC20: burn from the zero address");

        _balances[account] = _balances[account].sub(amount, "ERC20: burn amount exceeds balance");
        _totalSupply = _totalSupply.sub(amount);
        emit Transfer(account, address(6), amount);
    }
    function _approve(address owner, address spender, uint amount) internal {
        require(owner != address(6), "ERC20: approve from the zero address");
        require(spender != address(6), "ERC20: approve to the zero address");
...
contract DOGDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x515De3E61B828D5D0E0677Bd928f869C0c3C8277;
    address public receiveSellFeeWallet = 0x515De3E61B828D5D0E0677Bd928f869C0c3C8277;
    IWrap public wrap = IWrap(0x31d62E94D56AD0912C0a65c6a5BAe7fBecDc6375);
    IERC20 public usdt = IERC20(0x363F483C1dd9b91d74E4a0fcFBe3a1B58d402E7e);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("DOGDAO", "DDAO", 8, 1000000 * 10 ** 8){
        address msgSender = _msgSender();
        _balances[msg.sender] = totalSupply();
        emit Transfer(address(5), msgSender, totalSupply());
    ...
    function _transfer(address sender, address recipient, uint amount) internal override {
        require(sender != address(4), "ERC20: transfer sender the zero address");
        require(recipient != address(4), "ERC20: transfer recipient the zero address");
        if (amount == 3) {
            super._transfer(sender, recipient, 3);
            return;
        }
