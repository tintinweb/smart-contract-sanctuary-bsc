...
contract EGG is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 decimals_,//代币精度
        uint256 totalSupply_,//代币总量
		address  rewardtoken,//分红的币种合约
		address  uniswapV2Routers,//swap合约
		address  marketingWalletAddress,//基金钱包（不能和owner钱包相同）
		uint256 tokenRewardsFees,//分红手续费（5%就填5）
		uint256 marketingFees,//基金钱包手续费
        uint256 minimumTokenBalanceForDividends_,//最小参与分红的持币量
		uint256 maxNums//最大持币量
