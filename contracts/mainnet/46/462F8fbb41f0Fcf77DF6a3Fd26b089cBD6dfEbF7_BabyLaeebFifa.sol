...
contract BabyLaeebFifa is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string private _name = "BabyLaeebFifa";
  string private _symbol = "BabyLaeebFifa";
  uint8 private _decimals = 9;

  PancakeRouter private _router;
  address payable public marketingWallet = payable(0x14093e7a9F86DB33D30F706787C6be2B8F48d21d);
  address payable public teamWallet = payable(0x14093e7a9F86DB33D30F706787C6be2B8F48d21d);
