...
Telegram: https://t.me/CyborgCatToken
Twitter: https://twitter.com/CyborgCatToken
*/
...
contract CyborgCatToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cyborg Cat Token";
    string private _symbol = "CCT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f44Ce35590e7CC26420710a659a7EbacD1FA3ca); 
    address payable public buyBackWalletAddress = payable(0x0f44Ce35590e7CC26420710a659a7EbacD1FA3ca); 
