...
5% rewards - Tech Trees Coin
2% burn
1% marketing
1% dev
1% LP

 TG:https://t.me/TechTreesBurn
 Web: http://techtreesburn.com/
...
contract TechTreesBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TechTreesBurn", "TTB") {
        marketingWallet = payable(0x8A1D74D8499015bafabEbC610f53C23808dB7202);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    TechTreesBurn public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = TechTreesBurn(mainContract);
