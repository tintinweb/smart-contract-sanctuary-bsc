...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d4fA1F6ac1ddFfb7cb977DCa62940b23c1A4967;
...
contract HappyBirthdayJared is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8d4fA1F6ac1ddFfb7cb977DCa62940b23c1A4967;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HappyBirthdayJared";
    string private _symbol = "HBDJared";
