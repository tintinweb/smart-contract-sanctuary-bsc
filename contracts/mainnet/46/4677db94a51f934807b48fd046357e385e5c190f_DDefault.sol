...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "BITCOIN 69.0";
    string private _symbol = "BITCOIN 69.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9AFc8938a43040439E74B67de04cFB1D73304a47); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc41493E846534b5b613279247C6Dd0dE24eB2C5A); // BuyBack Address
    ...
    uint256 private _totalSupply = 69 * 10**9;
    uint256 public _maxTxAmount = 100 * 10**7;
    uint256 public _walletMax = 100 * 10**7;
