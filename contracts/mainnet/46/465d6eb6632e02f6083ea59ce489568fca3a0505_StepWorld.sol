...
contract StepWorld is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Address for address payable;

    string private _name = "STEPWORLD";
    string private _symbol = "STEPWORLD";
    ...
    address public _MarketingWallet = 0x8007f76109C5754B3de45d900eD95F2FC80e1ab3;
