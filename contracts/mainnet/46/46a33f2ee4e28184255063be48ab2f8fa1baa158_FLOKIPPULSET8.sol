...
contract FLOKIPPULSET8 is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xabc4611E7929d368A1c89B4d726778548BdeFc79;
    address public operationsAddress = 0xC0c6735044FE0a3a6191852CBDd1c6B434cb4fB8;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Floki PulseT8";
    string private constant _symbol = "FPULSET8";
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSale) private {
        ...
        emit Transfer(sender, address(this), s.tLiquidity + s.tOperations + s.tBuyback + s.tMarketing);
