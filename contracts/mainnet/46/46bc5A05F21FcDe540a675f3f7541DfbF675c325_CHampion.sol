...
contract CHampion is ERC20 {
    ...
    address public marketAddress = 0x4e5979C01f1A2564AF0E2b52302E4FdD12B1aC24;
    ...
    string internal tokenName = "CHampion";
    string internal tokenSymbol = "CHampion";
    ...
    function setFee(uint256 _lpFee, uint256 _marketFee) public onlyOwner {
        lpFee = _lpFee;
    ...
    function transReward(bytes memory data) private {
