...
contract BTG is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 518 * 10**18;
    ...
    address public ownerAddres = address(0x88FdaEeC06D216F29D073f4E1c3aDA5F22c009C8);
    address public devAddress = address(0x44b9341Bb4c27Fd27aa58E5556d0429900027A19);
    ...
    uint256 public _maxTxAmount = 518 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 0.05 * 10 **18;
