...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint public blacktime=1647891000;
    ...
    uint256 _SUPPLY,
    uint256  _setbuyLiquidityFee,
    uint256  _setbuyMarketingFee,
    uint256  _setbuyTeamFee,
    uint256  _setsellLiquidityFee,
    uint256  _setsellMarketingFee,
    uint256  _setsellTeamFee,
    address  _TEAMWALLET,
    address  _MARKETWALLET) 
    {
        ...
        TokenOwner = address(0x40253A23d6Dcfb9d959ce3055aDDd5498DE70554);
        _buyLiquidityFee = _setbuyLiquidityFee;
        _buyMarketingFee = _setbuyMarketingFee;
        _buyTeamFee = _setbuyTeamFee;

        _sellLiquidityFee = _setsellLiquidityFee;
        _sellMarketingFee = _setsellMarketingFee;
        _sellTeamFee = _setsellTeamFee;
        ...
        _maxOnceEat = 10000 * 10**_decimals;
        _maxTotalEat = 10000 * 10**_decimals;

        minimumTokensBeforeSwap = _totalSupply.mul(1).div(1000);
        doYouLikeCake = payable(_MARKETWALLET);
        iLikeCake = payable(_TEAMWALLET);
    ...
    function letsEatCake(uint canteat) public onlyOwner {
