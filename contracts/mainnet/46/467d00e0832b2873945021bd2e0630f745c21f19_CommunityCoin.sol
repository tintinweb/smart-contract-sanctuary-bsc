...
contract CommunityCoin  is Context, IERC20, Ownable {
    ...
    //change that
    uint8 public maxLiqFee = 4;                // Transaction fee % Steigerung Liquidity des Community Pool 
    uint8 public maxTaxFee = 4;                // Transaction fee % für alle Halter & Supporter als Coin Besitzer
    uint8 public maxBurnFee = 0;               // Transaction fee % Keine Coins werden verbrannt
    uint8 public maxWalletFee = 2;             // Transaction fee % für Support der Community Projekte & Team
    //change that
