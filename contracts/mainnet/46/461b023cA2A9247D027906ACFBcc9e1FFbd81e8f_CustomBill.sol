...
contract CustomBill is Initializable, PolicyUpgradeable {
    ...
    event BillPriceChanged(uint256 internalPrice, uint256 indexed debtRatio);
    ...
    event TermsSet(PARAMETER parameer, uint input);
    ...
    /** 
     *  @notice allows or disalows a third party address to redeem bills on behalf of user
