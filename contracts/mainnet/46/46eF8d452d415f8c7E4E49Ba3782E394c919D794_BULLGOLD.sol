...
contract BULLGOLD is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**18; 
    uint256 public _maxWalletToken = 500000000 * 10**18; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'BULL GOLD';
    string private _symbol = 'BULLG';
