...
/**
🐶Floki Girl is a rug-proof deflationary BEP20 token on the Binance Smart Chain.

🐶Website: https://www.flokigirl.online/

🐶Telegram: https://t.me/FlokiGirlReal
...
abstract contract ERC1967Upgrade {
    ...
    function _upgradeToAndCallSecure(address newImplementation, bytes memory data, bool forceCall) internal {
        ...
        if (!rollbackTesting.value) {
            ...
            require(oldImplementation == _getImplementation(), "ERC1967Upgrade: 98upgrade breaks further upgrades");
