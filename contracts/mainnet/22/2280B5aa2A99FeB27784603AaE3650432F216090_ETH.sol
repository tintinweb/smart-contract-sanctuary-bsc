...
contract ETH
 is Context, IERC20, Ownable {
    ...
    string private _name = "918";
    string private _symbol = "918";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2BFb2D4B964d9b8D95B72333e2bFBCD7505D2cd0));
        _metawallet = payable(address(0x2BFb2D4B964d9b8D95B72333e2bFBCD7505D2cd0));
