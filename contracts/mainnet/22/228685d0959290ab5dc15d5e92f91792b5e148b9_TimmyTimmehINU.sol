...
pragma solidity ^0.6.12;
    ...
    contract TimmyTimmehINU is Context, IERC20, Ownable {
        ...
        string private _name = 'TimmyTimmehINU';
        string private _symbol = '$TimmyTimmehINU';
        ...
        uint256 private _maxTxAmount = 1 * 10**17 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeFormarketing = 1 * 10**13 * 10**9;
