...
contract OTBOrderbookSetupFacet {
     ...
     * Offers has property price and volume.
     */
    function getOpenOrders(bytes32 _pairName) internal view returns (OrderBookStorage.UserOrder[] memory) {
        OrderBookStorage.OrderBook storage ds = OrderBookStorage.orderBookStruct();
    ...
    {
        OrderBookStorage.UserOrder[] memory _allOpenOrders = getOpenOrders(_pairName);
        uint256 count = 0;
