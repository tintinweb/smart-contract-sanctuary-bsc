...
contract AkameInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Akame Inu";
    string private _symbol = "AKAMEINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD97EbDaC35057587FCD242f37C30afd285856728);
    address payable public BuyBackWalletAddress = payable(0xD97EbDaC35057587FCD242f37C30afd285856728);
