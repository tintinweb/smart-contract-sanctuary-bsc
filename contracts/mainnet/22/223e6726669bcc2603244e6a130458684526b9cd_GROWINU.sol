...
library Address{
 ...
 contract GROWINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x75abf540D3e6D0146dF9d16B9556fF684C6c4467;
    address public donationWallet = 0x5CB7b8DcD2761678F7995800A257a3eF6C0cDe56;

    string private constant _name = "GROW INU";
    string private constant _symbol = "GROWS";
    ...
    Taxes public taxes = Taxes(0, 60, 39, 0);
    Taxes public sellTaxes = Taxes(0, 16, 2, 2);
