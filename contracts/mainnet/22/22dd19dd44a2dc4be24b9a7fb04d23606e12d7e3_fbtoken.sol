...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x41311077395d82A5c147A5e23B1CB9B6E5A1A67C;//   营销
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x41311077395d82A5c147A5e23B1CB9B6E5A1A67C),//fund address
    
        address(0x41311077395d82A5c147A5e23B1CB9B6E5A1A67C)//dev address
    ){
