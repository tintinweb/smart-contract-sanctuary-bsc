...
// FrogZilla V2 P2E Contract 
// https://t.me/frogzillav21
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBee1124FC2014907E3A42578FeB4F604DAE6E145;
...
contract FrogZillaV2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x395D5e23407150c66aDfEd8A3430253E731749D4;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(_developmentWalletAddress)] = true;
		isTxLimitExempt[owner()] = true;
		isTxLimitExempt[address(this)] = true;
		isTxLimitExempt[address(_developmentWalletAddress)] = true;	
		isTimelockExempt[owner()] = true;
		isTimelockExempt[address(this)] = true;
		isTimelockExempt[address(_developmentWalletAddress)] = true;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee <= 50, "Tax fee cannot Exceed 5%");
        _taxFee = taxFee;
    }
    function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
        require(developmentFee <= 50, "Development fee cannot Exceed 5%");
        _developmentFee = developmentFee;
    }
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <= 50, "Liquidity fee cannot Exceed 5%");
        _liquidityFee = liquidityFee;
    }
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent <= 1, "MaxTxPercent cannot be less than 1%");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && !isTxLimitExempt[from])
