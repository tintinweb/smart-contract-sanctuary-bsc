...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8F6e5A4c94fa615C1BEb014a2db10f703aB37202;
...
contract CHILIINU413  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x6D859Cf9C43BB2da39EDE5E06AB00B6675d4b3B2;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 4130 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CHILI 413";
    string private _symbol = "CHIL 413";
