...
contract BABY_SHIJA is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY SHIJA";
    string private constant _symbol = "$bSHIJA";
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 15 minutes && !stage3) {
