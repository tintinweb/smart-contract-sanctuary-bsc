...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintAdminOneWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        require(tokenId < 5000);
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/json/1");
        return true;
    }
    function mintAdminTwoWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        require(tokenId > 5000 && tokenId < 100000);
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/json/2");
        return true;
    }
    function mintThreeWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/json/3");
        return true;
    }
	function mintFourWithTokenURI(address to, uint256 tokenId) public onlyMinter returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, "https://meizhao-1256662691.cos.ap-chengdu.myqcloud.com/json/4");
        return true;
    }
}
...
contract NoahNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("NoahNFT", "Noah") {
