...
kyoukai
@kyoukai40402635
I'm Kyoukai, be kyoukai!
https://www.instagram.com/kyoukai2608/saved/
💡 Unique first Time 🆕
💡Bullish Name 🆕
💡Confident Name 🆕
...
abstract contract Contextbep20KYOKAI {
...
contract Ownablebep20KYOKAI is Contextbep20KYOKAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownablebep20KYOKAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownablebep20KYOKAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract KYOKAI  is Contextbep20KYOKAI, bep20KYOKAI, Ownablebep20KYOKAI {
    ...
    string private _name = 'KYOKAI';
    string private _symbol = 'KYOKAI';
