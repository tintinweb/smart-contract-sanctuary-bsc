...
// ZombieCat is making a purge of jeets, he dont want pussies in the project. 

// ⚡️ Tokenomics :

// 6% Buy Tax
// Sell Tax auto adjust depending volume ( Maximum 15% in sell tax, normaly between 3/6 )

// 🌀This is amazing mechanism that make fill the MW really good so we are able to push this token through calls , influencers, banners, poocoin ads..

// 30% of supply gonna be burn into dead address at launch 🔥

// TG: https://t.me/zombiecat_bsc

// Website: https://zombie-cat.com

// Twitter: https://twitter.com/tokenzombiecat
...
pragma solidity ^0.6.12;
    ...
    contract ZombieCat is Context, IERC20, Ownable {
        ...
        string private _name = 'ZombieCat';
        string private _symbol = 'ZCAT';
