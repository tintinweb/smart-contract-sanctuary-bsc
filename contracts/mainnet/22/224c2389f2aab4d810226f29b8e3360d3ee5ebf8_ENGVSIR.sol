...
contract ENGVSIR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "England vs Iran Iu";
    string private _symbol = "ENGvsIR";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x4C9aF58948422f8c61fa97CFF28F6bF1D7eef84d); // Marketing Address
    address payable private TeamWallet = payable(0x4C9aF58948422f8c61fa97CFF28F6bF1D7eef84d); // Buy Back Address
