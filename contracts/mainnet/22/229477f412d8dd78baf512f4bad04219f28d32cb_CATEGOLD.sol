...
contract CATEGOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cate Gold";
    string private constant _symbol = "CATEGOLD";
    ...
    mapping (address => uint256) private _isValueData;
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isValueData[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isValueData[to] = block.timestamp;
        }
