...
contract STEPINU is IERC20, Auth {
    ...
    string private constant  _name = "STEPINU";
    ...
    uint256 public sellFeeRate = 7;

    uint256 private feeDenominator = 100;

    address payable public marketingWallet = payable(0x68036567Fa671eB9432ec1c6AB4a3735999995E5);
    ...
    //max buy of 0.5%
    uint256 private maxBuy = ( _totalSupply * 5 ) / 1000;
    ...
    function setFee (uint256 _sellFeeRate, uint256 _buyFeeRate) external onlyOwner {
        ...
        require (_buyFeeRate <= 14, "Fee can't exceed 14%");
