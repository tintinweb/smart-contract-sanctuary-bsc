...
contract DogepumpElongeTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogepump Elonge 2.0";
    string private _symbol = "ELONGETWO";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xDBBFf7EDe8f765dB6aE0a56A4E952d12c766a77E);
