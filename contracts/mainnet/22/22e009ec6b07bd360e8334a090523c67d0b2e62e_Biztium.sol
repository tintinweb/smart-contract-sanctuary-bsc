...
/* 
    ...
    Website: https://www.biztium.net/  
    Contract Name: Biztium 
    Telegram: https://t.me/biztium 
    Contract Supply: 120,000,000 
    Contract Tokenomics: 
...
contract Biztium is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingBiztiumAddress =
        payable(0x24946DfA9eA5ebc8Bb8bd58C518E003186bb738a); // Marketing Biztium Address
    address payable public teamBiztiumAddress =
        payable(0x14B69f67ad26FF105b55127b7936C15bA69EdD5D); // team Biztium Address
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address private biztiumDeployer = 0x2A670E079A18dEEFaf138FE9D007bcA6418b5B84;
    ...
    uint256 private _tTotal = 120_000_000 gwei;
    uint256 private _tFeeTotal;

    string private constant _name = "Biztium";
    string private constant _symbol = "BIZTI";
    ...
    constructor() {
        require(msg.sender == biztiumDeployer, "Your not the deployer of this contract");
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        transferToAddressETH(marketingBiztiumAddress, ethForMarketing);
        transferToAddressETH(teamBiztiumAddress, ethForteam);
        ...
        onlyOwner
    {
        ...
        marketingBiztiumAddress = payable(_marketingWallet);
        emit AuditLog(
            "We have Updated the MarketingWallet:",
            marketingBiztiumAddress
        );
    }
    ...
    function setteamWalletAddress(address _teamWallet) external onlyOwner {
        ...
        teamBiztiumAddress = payable(_teamWallet);
        emit AuditLog("We have Updated the teamWallet:", teamBiztiumAddress);
    }
    ...
    function recoverETHfromContract() public virtual onlyOwner {
        payable(marketingBiztiumAddress).transfer(address(this).balance);
        emit AuditLog(
    ...
    function recoverTokensFromContract(address _tokenAddress, uint256 _amount) external onlyOwner {                               
        IERC20(_tokenAddress).transfer(marketingBiztiumAddress, _amount);
