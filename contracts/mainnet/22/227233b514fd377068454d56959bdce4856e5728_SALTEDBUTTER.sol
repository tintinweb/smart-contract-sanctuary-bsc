...
Telegram : https://t.me/SaltedButterBSC
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93DA381aB8730f2368939884Ab54b6840192d642;
...
contract SALTEDBUTTER is Context, IERC20, Ownable {
    ...
    string private constant _name = "SALTED BUTTER"; // 
    string private constant _symbol = "$SB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x93DA381aB8730f2368939884Ab54b6840192d642);
