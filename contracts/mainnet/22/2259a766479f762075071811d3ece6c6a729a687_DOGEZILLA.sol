...
contract DOGEZILLA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6900 * 10**9 * 10**9;
    ...
    address public marketingTokenFeeWallet = 0xE5923876894104F98C408Ca71D00C9e0bdE1acC0;
    address public marketingETHFeeWallet = 0xE5923876894104F98C408Ca71D00C9e0bdE1acC0;
    ...
    uint256 public _maxTxAmount = 690 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 6900 * 10**6 * 10**9, "Cannot set transaction amount less than 0.1 percent of initial Total Supply!");
