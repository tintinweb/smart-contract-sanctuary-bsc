...
contract BABYSHENGWEIHU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Shengweihu";
    string private _symbol = "Baby Shengweihu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc270A65E76e6a1a3D3b696BD39F2F66bb0181FAD); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3940c3F75f8DCE90CE8E3b3038EfB0e542497454); // buyback Address
