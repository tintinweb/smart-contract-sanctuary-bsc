...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable ETH = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD
...
contract GIFTDOGE is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 500 * (10**4) * (10**18); 
  ...
  //  uint256 public extraFeeOnSell = 4;
    ...
    uint256 public maxWalletToken = 100 * (10**5) * (10**18); //1%
    ...
    function setSellFees(uint256 sellEthRewardFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellDevFee) external onlyOwner
    {
        ...
        require(_SellTotalFees >= 0 && _SellTotalFees <= 50, "Fees are exceeding the limits");
    }
