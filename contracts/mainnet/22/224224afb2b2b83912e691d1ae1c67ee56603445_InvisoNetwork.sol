...
contract InvisoNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inviso Network";
    string private _symbol = "$IVNET";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xdEF5D4531E3bF723603c62d3850A658B0137a0b2);
