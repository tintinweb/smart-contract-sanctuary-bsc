...
// SPDX-License-Identifier: Unlicensed
    ...
    contract CYFpreminterclaims is ReentrancyGuard {
        ...
        CYFpreminterclaims internal PREVIOUS = CYFpreminterclaims(0xA4Ec314065AaF7682DadcCa5a09ABa8a2dffc4E1);
        ...
        function claimMinterPack() public{
            ...
            (bool claimed_private, bool claimed_presale, bool claimed_public, , , , ,) = PREVIOUS.minters(msg.sender);
            require(!claimed_private || !claimed_presale || !claimed_public, 'AlreadyClaimed');
        ...
        function claimCommunityReward() public {
            ...
            (, , , ,bool claimed_one, , ,) = PREVIOUS.minters(msg.sender);
            require(!claimed_one, 'AlreadyClaimed');
        ...
        function claimFromStake() public {
            ...
            if(!minters[_user].claimed_farm && _isStaker){
                // Prevent Those who have already claimed from previous preminter
                (, , ,bool claimed_farm, , , ,) = PREVIOUS.minters(msg.sender);
                require(!claimed_farm, 'AlreadyClaimed');
                // Prevent Staked from after 1669030892
                uint256 _lastCheckPoint = 1669030892;
                uint256 _checkpoint = checkNewV4De(_user);
                require(_checkpoint <= _lastCheckPoint, 'NotAllowed');
