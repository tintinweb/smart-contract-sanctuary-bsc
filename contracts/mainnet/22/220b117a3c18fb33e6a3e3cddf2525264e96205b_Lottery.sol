...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3DA1F716E4F4C553939FB5B8900AB2A624E5a420;
...
contract Lottery is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7A8fc6dc7d224b07eA1F2A3BBc09ef6bb3bd8F16;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Lottery";
    string private _symbol = "LTTY";
