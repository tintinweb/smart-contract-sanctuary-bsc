...
contract KC3 is BEP20, Auth {
    using SafeMath for uint256;
    address immutable WBNB;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    string public constant name = "King Charles Spaniel";
    string public constant symbol = "Charles III";
    uint8 public constant decimals = 18;
    uint256 public constant totalSupply = 3 * 10**5 * 10**decimals;
...
event config_SwapAndSendFeeSettings(uint256 Amount, bool Enabled);
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0x89Af55645D64bd5Be268b7ec64ACa29DeAC01ebC;
        devFeeReceiver = 0x89Af55645D64bd5Be268b7ec64ACa29DeAC01ebC;
