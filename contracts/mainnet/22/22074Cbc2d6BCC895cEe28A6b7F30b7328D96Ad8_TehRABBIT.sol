...
contract TehRABBIT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20023 * 10**9;
    uint256 public _maxTxAmount = 20023 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Teh Rabbit"; // 
    string private constant _symbol = "Teh Rabbit"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x7f90bfB54b5D4B599E92cF8A36F7cD457445e830;
