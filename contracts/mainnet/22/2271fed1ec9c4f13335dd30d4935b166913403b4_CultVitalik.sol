...
Cult Vitalik
Tax 10/10
Telegram : https://t.me/CultalikBSC
Website  : https://twitter.com/CultVitalik
*/
...
contract CultVitalik is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cult Vitalik";
    string private _symbol = "Cultalik";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x20eD9b4a33818275a7905b622A3B4736a7c45F7b); // Marketing Address
    address payable public teamWalletAddress = payable(0x6eb7Fc2b4151DA575C90205e0F1876D4bFc55Dd4); // Team Address
