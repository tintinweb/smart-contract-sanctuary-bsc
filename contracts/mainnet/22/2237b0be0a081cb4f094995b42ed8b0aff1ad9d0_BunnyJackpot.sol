...
contract BunnyJackpot is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x5B59ECB3D46dc3d144468284e8BA9F7Aba9f72Dd);
    ...
    function EnableLottery() public view returns (bool) {
        return enableLottery;
    }

    function lotteryPool() public view returns (address) {
        return address(LotteryPoolAddress);
    }
