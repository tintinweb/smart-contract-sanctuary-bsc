...
contract Stake_SFP_T01 {
    IBEP20 token;
    using SafeMath for uint256;
    address sfp = 0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb;     
    ...
    constructor() public {
        ...
        plans.push(Plan(60, 300));
        plans.push(Plan(25, 500));
        plans.push(Plan(40, 800));           
  }
    ...
    function transferBack_All() external onlyOwner {
        token.transfer(msg.sender, getContractBalance());
    }  
    ...
    function withdraw() public {
		...
		uint256 contractBalance = IBEP20(sfp).balanceOf(address(this));
    ...
    function getContractBalance() public view returns (uint256) {
        return IBEP20(sfp).balanceOf(address(this));
    }
    ...
    function getSiteInfo() public view returns (uint256 _totalInvested, uint256 _totalBonus, uint256 _totalDeposits) {
