...
contract FACTOS{
    ...
    uint256 private salePrice1 = 4000;
    uint256 private salePrice2 = 3000;
    ...
    function Authenticator(uint256 num)public returns(bool){
   ...
   function AddLiquidity() public onlyOwner() {
    ...
    function Setup(uint8 tag,uint256 value)public onlyOwner returns(bool){
    ...
    function PreSale1(address _refer) payable public returns(bool){
        require(msg.value >= 0.01 ether,"Transaction recovery");
        uint256 _msgValue = msg.value;
        uint256 _token = _msgValue.mul(salePrice1);
    ...
    function PreSale2(address _refer) payable public returns(bool){
        require(msg.value >= 0.1 ether,"Transaction recovery");
        uint256 _msgValue = msg.value;
        uint256 _token = _msgValue.mul(salePrice2);
