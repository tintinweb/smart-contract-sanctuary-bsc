...
contract PANDORA{
    ...
    function update(address addr)public{
        ...
        }else if(PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).AlreadyInvolved(addr) && !AlreadyInvolved[addr]){
          AlreadyInvolved[addr]=true;
          hatcheryMiners[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).hatcheryMiners(addr);       
          claimedEggs[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).claimedEggs(addr);
          lastHatch[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).lastHatch(addr);
          numRealRef[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).numRealRef(addr);
          InvestmentCountdown[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).InvestmentCountdown(addr);
          balanceOf[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).balanceOf(addr);
          referrals[addr]=PCD(0x51d1a9d0A323ae3E280B96E197268CB5e0DcE44e).referrals(addr);
       }
