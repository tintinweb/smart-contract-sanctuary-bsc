...
abstract contract FSToken is IERC20, Ownable {
...
contract FS is FSToken {
    constructor() FSToken(
        ...
        18,//Decimals
        2100,//Supply
        address(0x04a4200c0B1C05959070c1b90eFc3F720d20b1A2),//FundAddress
        address(0x0BB614614055E22FaD6779AD017B22586ab707eF)//ReceiveAddress
    ){
