...
contract catecoin2pointzero is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 40; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 40; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 20; // 4% of supply
    ...
    string private constant _name = "CateCoin 2.0";
