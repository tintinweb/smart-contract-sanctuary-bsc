...
contract SpaceBaby is Context, IERC20, Ownable {
    ...
    string private _symbol = "SpaceBaby";
    ...
    uint256 public _MarketingFee = 3; //hardcoded and unchangeable
    ...
    address payable public marketAddress = 0x2456e2D8769f92c234253C974C1B9a1F849e0395; //Marketing
