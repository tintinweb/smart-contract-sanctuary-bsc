...
contract DEGENGANG is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50000 / 10000; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 50000 / 10000; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 50000 ) / 10000; // 3% or 5m tokens
