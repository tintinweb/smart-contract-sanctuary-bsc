...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        emit Transfer(address(0xf32a050D2cb0EbB1753CB1d01D25904aEE78872e), ReceiveAddress, total);
...
contract HARE is AbsToken {
    constructor() AbsToken(
        ...
        0,
        10**30,
        address(0x259e0080072CCA998A66e7B68C69282e755Fe9B3),
        address(msg.sender),
        address(msg.sender)
    ){
    }
