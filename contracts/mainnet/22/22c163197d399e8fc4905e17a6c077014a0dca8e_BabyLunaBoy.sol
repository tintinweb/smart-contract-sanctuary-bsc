...
library Address{
 ...
 contract BabyLunaBoy  is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x01c34b201A9b6D78375b805b01e4308B73463684;
    address public donationWallet = 0x01c34b201A9b6D78375b805b01e4308B73463684;

    string private constant _name = "BabyLunaBoy";
    string private constant _symbol = "BabyLunaBoy";
    ...
    Taxes public taxes = Taxes(0, 7, 3, 7);
    Taxes public sellTaxes = Taxes(0, 7, 3, 7);
