...
contract SONICFORCES is BEP20 {
    ...
    /**
     * @notice Constructs the SONIC FORCES contract.
     */
    ...
    */
    ...
    uint256 private _airdropToken = 3050000000000000000000; // 3050 token will be given on airdrop
    ...
    uint256 private salePrice = 1050000;// 0.01*100000000=10,000 token for 0.01 bnb (set as per requirements)
