...
contract TISSOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TISSOT";
    string private _symbol = "TISSOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDc294fa220d4CfF678B88880CDCA50B1cdCcC945); // Marketing Address
    address payable public teamWalletAddress = payable(0xE3Fc01085e8Ee892FB0Ddb5f487B5F9ac664039E); // Team Address
	address public OwnerAddress =0x0c6A7B514EF5EAafAFdb69795763977948dCE730;
