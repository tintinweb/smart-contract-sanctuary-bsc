...
contract SOM_COIN_STAKING{
    ...
    uint256 public tokenRate=7574;  //0.02 BUSD
    uint public  MINIMUM_BUY = 10 ;
    uint public  MAXIMUM_BUY = 1000000 ;
    uint public  JoinMinAmt = 50;
    ...
    function NewRegistration(string memory referral,uint investmentBusd) public payable
	{
      ...
      uint256 investmentToken=investmentBusd*tokenRate;
     require(investmentBusd>=JoinMinAmt,"Invalid Joinging Amount");
		require(BUSD.balanceOf(msg.sender)>=investmentBusd*1e18);
		require(BUSD.allowance(msg.sender,address(this))>=investmentBusd*1e18,"Approve Your Token First");
	    BUSD.transferFrom(msg.sender ,owner, investmentBusd*1e18);
