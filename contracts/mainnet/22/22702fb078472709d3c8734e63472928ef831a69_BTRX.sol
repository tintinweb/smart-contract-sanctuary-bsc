...
/**
    ...
    2% fee auto add to the liquidity pool to locked forever 
    2% fee auto distribute to all holders
    1% fee auto add to the Team Wallet

    https://t.me/BscBabyTron
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14E1aC2a22743Cc4b8974a8dCe93B92Deec80D9b;
...
contract BTRX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x14E1aC2a22743Cc4b8974a8dCe93B92Deec80D9b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
	
    string private _name = "Baby Tron";
    string private _symbol = "BTRX";
    ...
    uint256 public _maxTxAmount = _maxTxAmount = 50000000 * 10**6 * 10**9;
