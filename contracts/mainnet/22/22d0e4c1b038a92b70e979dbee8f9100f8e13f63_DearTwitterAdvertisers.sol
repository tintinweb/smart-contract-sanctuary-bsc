...
contract DearTwitterAdvertisers is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dear Twitter Advertisers";
    string private constant _symbol = "ADVERTISERS";
