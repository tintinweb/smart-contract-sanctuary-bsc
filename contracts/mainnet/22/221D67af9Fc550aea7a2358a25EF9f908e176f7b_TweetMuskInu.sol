...
/* 
    ...
    - 7% fee per transaction auto add to the liquidity pool
    - 5% send to dev/marketing wallet and burn free.

    https://t.me/TweetMuskInu
...
contract TweetMuskInu is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0x847c4c25FDA200a601f4060BAdA5Dd00b362a158;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "TweetMuskInu";
