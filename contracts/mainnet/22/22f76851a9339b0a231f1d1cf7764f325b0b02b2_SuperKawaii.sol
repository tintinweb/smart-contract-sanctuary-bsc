...
contract SuperKawaii is Context, IERC20, Ownable {
    ...
    string private _name = "SuperKawaii";
    string private _symbol = "KAWAII";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x5A7FA39615a8cCe8302bc8D7b96b65F569FaF70D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9fA283eBF85F75EDa243bf627CA6cc64d960103D); // BuyBack Address
