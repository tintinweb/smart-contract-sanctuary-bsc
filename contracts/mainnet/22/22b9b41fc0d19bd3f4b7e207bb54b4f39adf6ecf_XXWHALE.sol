...
//
//
//   📱Telegram::https://t.me/xxwhale
//   📱Website ::https://xxwhales.io/
/*
...
contract XXWHALE is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("XXWHALE", "XXWHALE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "XXWHALE";
    string private _symbol = "XXWHALE";
