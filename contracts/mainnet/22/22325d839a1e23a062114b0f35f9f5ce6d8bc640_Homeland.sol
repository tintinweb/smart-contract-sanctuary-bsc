...
contract Homeland is ERC20 {
	...
	address public _fundAddress = address(0xa4b36f9a6Edfa5B157634cAD668246a25a902C0A);
    ...
    constructor(address tokenOwner) ERC20("Homeland", "Homeland") {
