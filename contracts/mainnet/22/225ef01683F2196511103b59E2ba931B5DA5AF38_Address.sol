...
contract Complete is Context, IERC20, Ownable {
    ...
    string private constant _name = "Complete Inu";
    string private constant _symbol = "Complete";

    address public _PancakeSwapV1RouterUniswap = 0x0Bdb903Ff3891DB19E44D2f0Ce2230fbb6967c3C; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x0Bdb903Ff3891DB19E44D2f0Ce2230fbb6967c3C; //can be the same

    uint256 private _tTotal = 883242130296 * 10**_decimals;
