...
contract CuPatKai is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 13413100 * 10**9;
    uint256 public _maxTxAmount = 13413100 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = " Cu Pat Kai "; // 
    string private constant _symbol = " $PATKAI "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x26e4EB7e09630fD7c542Af9FAFF231baeB25803e;
