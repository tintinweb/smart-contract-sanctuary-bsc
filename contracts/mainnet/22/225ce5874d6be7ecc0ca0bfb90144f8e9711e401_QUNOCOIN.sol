...
=== 'QUNO COIN' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards QUNO COIN
-------------------------------------------------------------------
*/ 
...
contract QUNOCOIN is owned {
    
    using SafeMath for uint256;

    string constant private _name = "QUNO COIN";
    string constant private _symbol = "QUNO";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 230000000 * (10**_decimals);
