...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1dfd4006820d54a5d5A8E3009A27Ef9134C11005; // owner address
...
contract CV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CV";
    string private _symbol = "VC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaC49b91BF0572EFbCc668072b84005E4E8838976);
    address payable public teamWalletAddress = payable(0x48d61E5Eb99190b4abe2cD75d28170e20B9c2879);
