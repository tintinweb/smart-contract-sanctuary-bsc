...
contract WikiCatV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wiki Cat 2.0";
    string private constant _symbol = "WikiCat2.0";
