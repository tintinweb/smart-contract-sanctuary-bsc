...
contract ProtocolOfMetaVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Protocol Of MetaVerse";
    string private _symbol = "$POM";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x371484E4C505F3de693C59D7bc14380b84262dAc); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x371484E4C505F3de693C59D7bc14380b84262dAc); // Team Address
