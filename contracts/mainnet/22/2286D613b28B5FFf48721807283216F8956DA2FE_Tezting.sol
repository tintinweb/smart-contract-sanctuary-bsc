...
/* Token contract */
contract Tezting is IBEP20, Auth { // change - name
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Tezting"; // change - name
    string constant _symbol = "Tezting"; // change - symbol
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 900 / 10000; // change - 9%
    uint256 public _maxSellTxAmount = _totalSupply * 900 / 10000; // change - 9%
    uint256 public _maxWalletToken = ( _totalSupply * 900 ) / 10000; // change - 9%
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        GREEDDuration = GREEDDuration.mul(1000); // Must be below 1%
