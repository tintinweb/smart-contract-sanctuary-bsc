...
contract  TokenV is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcluded;
    string private _name = "MoveZ";
    string private _symbol = "MoveZ";
    uint256 private _decimals = 9;
    uint256 private feeburn = 5;
    address private dev = msg.sender;
    uint256 private _totalSupply = 10000000000000 * 10 ** _decimals;
    uint256 private _maxTxtransfer = 10000000000000 * 10 ** _decimals;
    address public deadadress = 0x000000000000000000000000000000000000dEaD;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 amountburn = feeAmount;
             if (amountburn >= 0 && amount >0){
                 emit Transfer(sender,deadadress, amountburn);
             }
            uint256 amounts = amount.sub(feeAmount);
