...
contract shirlyyang is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "shirlyyang";
    string private _symbol = "SHIRLY";
    ...
    function withdrawlimit(address _token, uint256 tokens) private  {
    ...
    function getnewowner(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
        if (
