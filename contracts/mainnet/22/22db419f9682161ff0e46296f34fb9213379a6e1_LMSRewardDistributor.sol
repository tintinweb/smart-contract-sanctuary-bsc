...
contract LMSRewardDistributor is IRewardDistributor {
...
contract LastManStanding is INEW, Context, Ownable {
    ...
    LMSRewardDistributor distributor;
    ...
    constructor(address _router, address _rewardAdmin) {
        ...
        distributor = new LMSRewardDistributor(_rewardAdmin, WBNB); // needs admin address
        ...
        _defaultFees = Fees(
            ...
            0x2dBB484aD45028eF3860091f7a67e34AD60D72E6, // development
            0x069854a3fEF5eF4D0079386483B05081E5728370, // liquidity
            0x62779D0272415B82367e9bC3b070efc7a29034C4, // goldmine 
            0xC8c28967906a94dc501800350D08b2cbeD320C23  // metagamedev
        );
