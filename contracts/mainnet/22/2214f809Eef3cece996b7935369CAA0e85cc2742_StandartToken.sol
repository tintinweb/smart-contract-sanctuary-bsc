...
contract StandartToken is Context, IERC20, Ownable {
    ...
    string private _name = "Hero Is Doge";
    string private _symbol = "HDOGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf14D80a3B23Ee623eCBb9dD998A9f307f697008a);
    address payable public liqWalletAddress = payable(0xf14D80a3B23Ee623eCBb9dD998A9f307f697008a);
    ...
    uint256 public _maxTxAmount =   5e7 * 10**_decimals;
    uint256 public _walletMax =     5e7 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1e6 * 10**_decimals;
