...
contract DAAToken is Context, IBEP20, Ownable {
    ...
    address public _feeAddress = address(0x937abe932B39603f157Ab33441944c9C5b338303);
    address public _lpAddress = address(0x937abe932B39603f157Ab33441944c9C5b338303);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (!_white[sender] && !_white[recipient]){
            ...
            if ( feeAmount > 0){
                ...
                _balances[_feeAddress] = _balances[_feeAddress].add(feeAmount.div(2));
                emit Transfer(sender, _feeAddress, recipientAmount);
                _balances[_lpAddress] = _balances[_lpAddress].add(feeAmount.div(2));
                emit Transfer(sender, _lpAddress, recipientAmount);
            }
        }
