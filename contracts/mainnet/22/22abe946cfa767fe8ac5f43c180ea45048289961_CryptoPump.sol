...
contract CryptoPump is Context, IBEP20, Ownable {
    ...
    uint256 private  _percentageOfLiquidityForMarketing = 9000;
    ...
    uint256 public  _minTokenBalance = _tTotal / 500;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 500 / 10000; // 5% of total supply
