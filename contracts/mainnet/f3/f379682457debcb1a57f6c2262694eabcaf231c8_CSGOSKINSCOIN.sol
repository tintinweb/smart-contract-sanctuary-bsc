...
contract CSGOSKINSCOIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CSGOSKINSCOIN";
    string constant _symbol = "CSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xE461B2AF763382A26d7E7dCF71EC2Eb3B40EE6E3;
