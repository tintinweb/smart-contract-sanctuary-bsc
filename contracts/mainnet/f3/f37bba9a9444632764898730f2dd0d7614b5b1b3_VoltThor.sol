...
🚀Get Volt Inu Token And THORSwap  As one $VOLTTHOR

$VOLTTHOR is fan meme token 🥇
🔥Born to Kill Zeros
You don’t want to be disappointed and be sure to lose join us and don’t miss this Stealth Launch Soon 🧐 
...
contract VoltThor is Context, BinanceGaming, Ownable {
    ...
    string private _name = 'VOLTTHOR inu';
    string private _symbol = 'VOLTTHOR';
