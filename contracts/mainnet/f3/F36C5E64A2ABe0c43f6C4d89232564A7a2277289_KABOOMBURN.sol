...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF7a1f03964959cdDd98bD1279e946919381FAd9b;
...
contract KABOOMBURN is Context, IERC20, Ownable {
    ...
    string private constant _name = "KABOOM!! BURN"; // 
    string private constant _symbol = "$KABOOM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xF7a1f03964959cdDd98bD1279e946919381FAd9b);
