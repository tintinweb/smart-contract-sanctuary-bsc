...
/* Token contract */
contract Ethereum30 is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; // Binance-Peg ETH Coin 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xeF93C55d8de3854F96932F52a9f517fFef9d4958;
    ...
    // Name and symbol
    string constant _name = "Ethereum3.0";
    string constant _symbol = "ETH3.0";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; 	 // max % transactions on buy
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; 	 // max % transactions on sell
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // max % wallet in general
