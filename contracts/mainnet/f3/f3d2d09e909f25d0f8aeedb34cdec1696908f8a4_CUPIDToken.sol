...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 10000 * 10**18;
    string private _name = "SOCCER";
    string private _symbol = "SOCCER";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x8A2bB762aE77794B47fC618C051120c8Bf701b49);
    address public pointAddress = address(0xe354a97B79C61A3572a08bcBB7Acf2fc204AEa21);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 10000 * 10**18;
