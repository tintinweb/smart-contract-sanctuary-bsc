...
contract UFODOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    UFODOGEDividendTracker public dividendTracker;
    ...
    constructor() ERC20("UFO Dogecoin", "UFODOGE") {
        marketingWallet = payable(0x280719Ef936048994bb7c9F621248b93A1955162);
        devWallet = payable(0x2BF35c05004eF4fe199Ba02526EbfAB44349F7e7);
        ...
        totalSellFees = sellRewardsFee
         ...
         dividendTracker = new UFODOGEDividendTracker(
            payable(this),
            router,
...
contract UFODOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    UFODOGE public UFODOGEContract;
    ...
    constructor(
        ...
        defaultToken = token;
        UFODOGEContract = UFODOGE(mainContract);
    ...
    function _transfer(
        ...
        require(false, "UFODOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "UFODOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UFODOGE contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(UFODOGEContract);

            uint256 prevBalance = UFODOGEContract.balanceOf(address(this));
            ...
            {
                uint256 received = UFODOGEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    UFODOGEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
