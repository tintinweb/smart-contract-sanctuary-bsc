...
RatCat is a meme token that was taken from the name hype . This token is community based and an experienced team in the crypto field . We also burn liquidity there as a form of disappointment in an increasingly uncertain market. Stay relaxed and safe with us here and stay green
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF38cB055192276be98D8DB25388cfF312276e882;
...
contract RATCAT is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xF38cB055192276be98D8DB25388cfF312276e882);
    ...
    */
    ...
    string private _name = "RatCat"; 
    string private _symbol = "RATCAT";  
    ...
    */
    ...
    // Default is true
    function set_Fees_autolp(bool true_or_false, uint256 _uint) external onlyOwner {
