...
contract SupperGambler is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Supper Gambler";
    string private _symbol = "GAMBLER";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8acc4f1715d213239c798B13B753E0C317a6A19e); 
    address payable public BurnedWalletAddress = payable(0x8acc4f1715d213239c798B13B753E0C317a6A19e); 
