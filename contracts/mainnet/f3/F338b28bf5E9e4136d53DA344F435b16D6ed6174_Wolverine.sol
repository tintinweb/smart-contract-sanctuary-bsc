...
contract Wolverine is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   WolverineDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Wolverine", "WLVR") {
        _buyRewardsFee = 0;
        _buyLiquidityFee = 1;
		_buyMarketingFee = 5;
    	...
    	dividendTracker = new WolverineDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0xd6f8402F9745eFe7ce79E9C86c1Ff2D58e21447B);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        WolverineDividendTracker newDividendTracker = WolverineDividendTracker(payable(newAddress));
...
contract WolverineDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("WLVR_Dividend_Tracker", "WLVR_Dividend_Tracker") {
    	claimWait = 1800;
