...
Telegram Portal: https://t.me/ElonaPad
Website: TBA
Twitter: @ElonaPadToken
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
contract EPAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elona Pad";
    string private constant _symbol = "EPAD";
