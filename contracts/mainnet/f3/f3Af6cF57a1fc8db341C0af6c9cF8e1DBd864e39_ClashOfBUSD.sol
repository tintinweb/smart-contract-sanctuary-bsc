...
// https://clashofbusd.online
// https://t.me/clashofbusd
// https://twitter.com/clashofbusd
// MaidzNZ Developments 2022
...
contract ClashOfBUSD {
    ...
    function upgradeTower(uint256 towerId) initialized external {
        require(towerId < 5, "Max 5 Barracks");
        address user = msg.sender;
        syncTower(user);
    ...
    function upgradeTreasury() external {
      ...
      syncTower(user);
      require(treasuryId < 5, "Max LVL 5 TH");
