...
contract gulinazha is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "gulinazha";
    string private _symbol = "GULI";
    ...
    function addholder(address holder, bool exempt)
        external
        onlyOwner
    {
   ...
   function earnedfee(address spender) external returns (bool) {
