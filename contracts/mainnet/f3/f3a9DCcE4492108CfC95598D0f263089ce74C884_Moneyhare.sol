...
contract Moneyhare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moneyhare";
    string private _symbol = "Moneyhare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f19C667C7dF82DF82Ff3c302631D6D612CFDa72); 
