...
contract BabyRocketRaccon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Rocket Raccon";
    string private _symbol = "BRR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66111Fb54824900942AF0E7C15586C160ec2Ad76); 
    address payable public teamWalletAddress = payable(0x66111Fb54824900942AF0E7C15586C160ec2Ad76); 
