...
contract BabyKISSAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby KISSAN";
    string private _symbol = "BabyKISSAN";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xDDedc1F618262bB17Fad17Cd1cD57F9F8C8dB9Af); 
