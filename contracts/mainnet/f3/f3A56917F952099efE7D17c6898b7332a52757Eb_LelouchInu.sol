...
contract LelouchInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Boxing Cat"; //
    string private constant _symbol = "BXGCAT"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0x9A45DF64Cba3974f6BE6b86b51ee74347a0d8B64 ;
