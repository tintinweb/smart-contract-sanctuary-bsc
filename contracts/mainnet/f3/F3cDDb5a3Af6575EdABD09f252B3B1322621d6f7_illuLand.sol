...
contract illuLand is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "illu Land";
    string private _symbol = "illu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4abC876df500F842de027Dde429E944486274DA9);
    address payable public teamWalletAddress = payable(0x4abC876df500F842de027Dde429E944486274DA9);
