...
contract BabyAptosCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Aptos Coin";
    string private _symbol = "BAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x84B61cE3Ca48cF1097FF22EDCB676EEAfB7Ccf63);
    address payable public teamWalletAddress = payable(0x84B61cE3Ca48cF1097FF22EDCB676EEAfB7Ccf63);
