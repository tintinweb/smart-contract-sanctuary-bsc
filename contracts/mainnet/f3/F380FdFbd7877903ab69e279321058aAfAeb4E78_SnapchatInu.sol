...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf1BC518a358398C9F3238f9E067342B85B7e32c4;
...
contract SnapchatInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Snapchat Inu"; // 
    string private constant _symbol = "SnapchatInu"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x1441888b07ebB6414fC4773650a234d036716f77);
