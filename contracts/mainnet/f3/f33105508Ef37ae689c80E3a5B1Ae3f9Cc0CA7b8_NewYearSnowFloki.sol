...
/**               
TOKENOMICS
8% Buy TAX | 4% Marketing 2% Buy Backs 2% Liquidity
8% Sell TAX | 4% Marketing 2% Buy Backs 2% Liquidity
Telegram : https://t.me/NewYearSnowFloki
Website TBA
...
contract NewYearSnowFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NewYearSnowFlokiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("New Year SnowFloki", "NYSNOKI") {
        marketingWallet = payable(0x9b4D28AB7478320D97BE43a9a865Db21138b3929);
        devWallet = payable(0x14606fb0e07bbB1893EAbA933264f1CdD4556A63);
        ...
        dividendTracker = new NewYearSnowFlokiDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "NewYearSnowFlokiTRACKER",
            "NewYearSnowFlokiTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 25; // 2%
...
contract NewYearSnowFlokiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    NewYearSnowFloki public NewYearSnowFlokiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        NewYearSnowFlokiContract = NewYearSnowFloki(mainContract);
    ...
    function _transfer(
        ...
        require(false, "NewYearSnowFloki_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "NewYearSnowFloki_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NewYearSnowFloki contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(NewYearSnowFlokiContract);

            uint256 prevBalance = NewYearSnowFlokiContract.balanceOf(address(this));
            ...
            {
                uint256 received = NewYearSnowFlokiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    NewYearSnowFlokiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
