...
Website: GrowBiden.com

Stickers: t.me/addstickers/GrowBiden

Medium: medium.com/@GrowBiden

Twitter: twitter.com/GrowBiden
*/
...
contract $GROWBIDEN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Grow Biden';
    string private constant _symbol = '$GROWBIDEN';
    ...
    //DevWallets
    address public TeamWallet=payable(0x965CA2DbbFCb2B8f1848f33797D79ff3426331aa);
    address public walletTwo=payable(0x65eC3F9F60029942a4474555Fa6929F2865A628B);
    //TestNet
