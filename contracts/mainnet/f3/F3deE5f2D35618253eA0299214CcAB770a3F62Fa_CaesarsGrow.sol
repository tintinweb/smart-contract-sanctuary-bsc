...
contract CaesarsGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Caesars GROW";

    string private _symbol = "CAESARSGROW";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x929a56810E4CcdB10014A56dAA11bc4B7dD93A29;
