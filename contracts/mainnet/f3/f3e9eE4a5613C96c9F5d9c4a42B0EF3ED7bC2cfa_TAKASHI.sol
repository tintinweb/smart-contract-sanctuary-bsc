...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract TAKASHI is ERC20, Ownable {
        ...
        string private    _name = "TAKASHI";
        string private  _symbol = "TAKASHI";
    ...
    uint256 public _maintenanceFee = 12; 
   ...
   address payable maintenanceWallet = payable(0xF7234F7AbDEf394F57B8bcdB5E8C88674Ba16CD2);
    ...
    function _transfer(
        ...
        {
         require(amount+_balances[to]<=20000000 * 10**8,"cannot hold more than 20 m");
        }
