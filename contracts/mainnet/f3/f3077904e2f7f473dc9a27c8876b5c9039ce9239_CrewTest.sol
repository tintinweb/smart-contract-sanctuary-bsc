...
contract CrewTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CrewTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CrewTest", "CT") {
        marketingWallet = payable(0x52f2eFCe98387ba11eD7d8f47E196e537Ca41A14);
        devWallet = payable(0xB78994FD1b8dc82B3d0BF74b7ea0669B82f959c8);
        ...
        dividendTracker = new CrewTestDividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(devBuy <= 3 && devSell <= 3, "Dev fees can't exceed 3%");
...
contract CrewTestDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    CrewTest public CrewTestContract;
    ...
    constructor(
        ...
        defaultToken = token;
        CrewTestContract = CrewTest(mainContract);
    ...
    function _transfer(
        ...
        require(false, "CrewTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CrewTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CrewTest contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(CrewTestContract);

            uint256 prevBalance = CrewTestContract.balanceOf(address(this));
            ...
            {
                uint256 received = CrewTestContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    CrewTestContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
