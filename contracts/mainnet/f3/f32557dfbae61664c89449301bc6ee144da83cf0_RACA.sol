...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Radio Caca V2';

    string constant public symbol = 'RACA';
   ...
   address public pair;
    ...
    uint256 public totalSupply = 2681467241*10**uint256(decimals);
