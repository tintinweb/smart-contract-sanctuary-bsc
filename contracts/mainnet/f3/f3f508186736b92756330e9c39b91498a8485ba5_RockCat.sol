...
contract RockCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RockCat";
    string private _symbol = "RockCat";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf731e00d41A3D9Cb98595105A3761178bF24B2E6);
    address payable public teamWalletAddress = payable(0xCE70724A7b5bE10E2E37F6C6Ccf36307997F2B3d);
    ...
    constructor () {
        ...
        emit Transfer(address(0x1997830B5beB723f5089bb8fc38766d419a0444d), _msgSender(), _totalSupply);
    }
