...
contract MobToken is IERC20, Ownable {
    ...
    constructor() {
        ...
        _totalSupply = 15850000 * 10 ** uint(_decimals);
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[sender]) {
            ...
            (address [] memory slippageAddresses, uint256 [] memory slippageAmounts) = MobiusSlippage(slippageAddress).slippage(amount);
    ...
    /*
     * @dev Set up | Creator call | Set the Mobius slippage contract address
     * @param contractAddress  Configure the Mobius slippage contract address
     */
    function setMobiusSlippageContract(address contractAddress) public onlyOwner {
