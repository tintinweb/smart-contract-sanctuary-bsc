...
MagicMIB is Usability
We aim to build a bot that will be detected by fake smart contracts and it's first on the Binance network, 
it's already in development and an official announcement is coming once it's done and ready to be tested

Website  : https://Magicmib.cc

Twitter  : https://twitter.com/MibMagic

Medium   : https://medium.com/@MagicMIB

Reddit   : https://www.reddit.com/user/MagicMIB

YouTube  : https://www.youtube.com/@magicmib/videos

Telegram : https://t.me/MagicMIB
*/
...
contract MagicMIB is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MAGIC MIB";
    string private _symbol = "MMIB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xEa703bEaa8FA1Ec4b23b5B92EB2f864a9FdB2BFA);
    address payable public liqWalletAddress = payable(0xEa703bEaa8FA1Ec4b23b5B92EB2f864a9FdB2BFA);
