...
contract SwapContract is AccessControlEnumerable, Pausable, ECDSAOffsetRecovery
{
        ...
        whenNotPaused
    {
        ...
        uint256 fraction = feeFractionOfBlockchain[numOfThisBlockchain];
        uint256 fee = amountWithFee * fraction / 100;
    ...
    /** 
      ...
      */
    function setfeeFractionOfBlockchain(uint128 blockchainNum, uint256 fraction) external onlyOwnerAndManager
    {   
