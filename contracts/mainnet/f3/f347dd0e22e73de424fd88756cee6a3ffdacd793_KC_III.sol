...
library Address{
 ...
 contract KC_III is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA24f28DEa7c9614d6d5eBA4d8e4B7b782c16AdF4;
    address public donationWallet = 0x2e6FadA094544f232AF03E7581164D58Cd72B8eF;



    string private constant _name = "KING CHARLES III";
    string private constant _symbol = "$KC3";
