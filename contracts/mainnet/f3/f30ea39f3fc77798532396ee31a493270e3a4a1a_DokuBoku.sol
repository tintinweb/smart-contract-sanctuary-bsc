...
contract DividendDistributor is IDividendDistributor {
    ...
    event Deposit(uint256 amountBNB, uint256 amountBTC);
...
contract DokuBoku is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DokuBoku";
    string constant _symbol = "DOKUBOKU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000000 * (10 ** _decimals); // 1,000,000,000,000,0
    uint256 public _maxTxAmount = _totalSupply / 10; //1000 0.1% 
    uint256 public _maxWallet = _totalSupply / 10; // 2%
