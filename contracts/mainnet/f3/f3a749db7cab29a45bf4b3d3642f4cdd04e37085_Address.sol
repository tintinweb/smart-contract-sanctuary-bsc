...
contract SQUIDToken2 is ERC20, Ownable {
    ...
    function initialize() public initializer {
        ...
        ERC20.__ERC20_init("Squid Game2.0", "SQUID2.0");
        _setupDecimals(DECIMALS);
        _totalSupply = 0;
        
        _mint(msg.sender, INITIAL_TOTAL_SUPPLY);
        
        uniswapV2Router = IUniswapV2Router02(0x410c3B684F3535e335495d421FCd5713a0A4db10);
