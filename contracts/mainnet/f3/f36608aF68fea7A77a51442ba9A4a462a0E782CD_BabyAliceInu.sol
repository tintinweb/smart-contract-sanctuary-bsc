...
/**
https://t.me/BabyAliceInu
SAFE CONTRACT AND SAFE DEV FOR YOU KNOW
NEXT TWEET ELON LOL
*/
...
contract BabyAliceInu is IBEP20, Auth {
    ...
    string constant _name = "BabyAliceInu";
    string constant _symbol = "BAINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 200; //4% 
    uint256 public _maxWalletSize = (_totalSupply * 5) / 400; //4%
    ...
    address private marketingFeeReceiver = 0x70A21b6861320dCd71ea7FdDDA1a843b50D44F90;
    address private developmentFeeReceiver = 0x678430E63215a95c735E7308325A5eA1e52DCBC7;
