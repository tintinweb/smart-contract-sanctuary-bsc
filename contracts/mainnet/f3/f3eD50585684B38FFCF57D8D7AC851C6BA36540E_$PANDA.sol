...
contract $PANDA is Context, IERC20, Ownable {
    ...
    string private _name = "PANDAMOON COIN";
    string private _symbol = "$PANDA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC96401c69054889ADdb3651e541eA4916D10a15F); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1cb05c9B7FcA2D556c678d48F251Aa9C498db4B0); // Team Address
