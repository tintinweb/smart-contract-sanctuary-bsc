...
contract LunarRabbitBillionaire is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunar Rabbit Billionaire";
    string private constant _symbol = "#LRBILLIONAIRE";
