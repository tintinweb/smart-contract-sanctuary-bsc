...
contract Catminini is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9B4621F05e3fEc8c34036255D9A69D06e8Cc8171); 
    address payable public Wallet_Dev = payable(0x57AE7A9dd45f6fd5B62a8d6217bA4573c40Df54a);
    address payable public constant Wallet_Burn = payable(0x8dd2C169Cd6bDa8641a9e2041cb193be5b6DA7F9); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Catminini"; 
    string private constant _symbol = unicode"cmn"; 
