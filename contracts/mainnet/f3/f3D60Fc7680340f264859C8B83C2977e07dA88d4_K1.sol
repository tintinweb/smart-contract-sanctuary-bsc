...
contract K1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "K1";
    string private _symbol = "K1";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x0000000000000000000000000000000000001000));
        marketingWalletAddress = payable(address(0x0000000000000000000000000000000000001000));
