...
/**
 * Whitepaper https://degen-zoo.gitbook.io/degen-zoo-whitepaper/
 * Telegram https://t.me/DegenzooBscportal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA8Dcb994989BAE68bB91BFF38D1170AbfF399999; // owner address
...
contract DegenZoo is Context, IERC20, Ownable {
    ...
    string private _name = "Degen Zoo coin";
    string private _symbol = "DGZ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x90365333E39Aa9f5A834DD92FcCE6ca8868bCf43); // Marketing Address
    address payable public buybackBurnAddress = payable(0x3ccAf6ee0A8408A5e5a87C33eA3460eED8B8bc04); // BuybackBurn Address
    ...
    uint256 private minimumTokensBeforeSwap = 20000000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        isExcludedFromFee[buybackBurnAddress] = true;
        ...
        isWalletLimitExempt[buybackBurnAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[marketingWalletAddress] = true;
        isTxLimitExempt[buybackBurnAddress] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyback > 0)
            transferToAddressETH(buybackBurnAddress, amountBNBBuyback);
