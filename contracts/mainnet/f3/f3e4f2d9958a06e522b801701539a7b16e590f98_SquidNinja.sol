...
/*
SoMe 
tg: https://t.me/SoMe_Inu
twitter: htts://twitter.com/GetSoMeInu
...
contract SquidNinja is Context, IERC20, Ownable {
    ...
    string private _name = "SoMe Inu";
    string private _symbol = "SoMe";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xA09a739fafbf8DC3d327672BBd1F771f13A197DE);
    address payable public teamWalletAddress = payable(0xE391d883d34BA82201aA9019B61152ff0E6D0E97);
