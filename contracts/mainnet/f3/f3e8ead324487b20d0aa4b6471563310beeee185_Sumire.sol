...
/*
*  https://t.me/SumireYoshizawa_BSC
*/
...
contract Sumire is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x783bf0D30969f9b411A7FbAD829e8a50c4F64331; 
    address public devWallet = 0xDEA668813526C0f54f821fAC381329ba6A1aB202; 
    address public operationWallet = 0xDEA668813526C0f54f821fAC381329ba6A1aB202; 
    address public charityWallet = 0xDEA668813526C0f54f821fAC381329ba6A1aB202;

    string private constant _name = "Sumire Yoshizawa";
    string private constant _symbol = "SUMYOSHI";
    ...
    Taxes public sellTaxes = Taxes(0, 0, 0, 0, 0, 0);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 6 minutes;
    }
