...
/**
 * THE FINAL SOLUTION HIGHEST FINANCE 
*/
...
contract HighestFinanceB is ERC20Detailed, Ownable {
    ...
    string public _name = "HighestFinanceB";
    string public _symbol = "HGTB";
    ...
    uint256 public castleFee = 40;
    uint256 public reserveFee = 20;
    uint256 public pawnpromoFee = 20;

    uint256 public sellFee = reserveFee.add(pawnpromoFee);
    uint256 public burnFee = 10;
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(castleFee).add(burnFee);
    ...
    address public pawnpromoReceiver;

    address public lpReceiver;
    address public treasuryReceiver;
    address public castleReceiver;
    address public checkMate;
    ...
    constructor() ERC20Detailed("Highest Finance B", "HGTb", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x2AED1cBB465C6EC5c2A4Ef8E5458c7BBA9d0D9d7;
        treasuryReceiver = 0x722ADa1D41b9F2708253e1B76FBb304Ed9e48f76;
        castleReceiver = 0xf6272dAB1Ed884370D54910b14696467090b6d46;
        reserveReceiver = 0xDd41e238F544638019c600217397EDac0fa64ca1;
        pawnpromoReceiver = 0xB4e8EFacCe2F64C1C1D5E14c00744d5F0aB660b5;
        checkMate = 0x0000000000000000000000000000000000000000;
    ...
    function setDefaultFees() external onlyOwner {
        ...
        sellFee = reserveFee.add(pawnpromoFee);
        totalFee = liquidityFee.add(treasuryFee).add(castleFee).add(burnFee);

    }
    function setA1Fees() external onlyOwner {
        liquidityFee = 10;
        treasuryFee = 20;
        castleFee = 20;
        reserveFee = 20;
    ...
    function setA2Fees() external onlyOwner {
        liquidityFee = 10;
        treasuryFee = 30;
        castleFee = 30;
        reserveFee = 40;
    ...
    function setE1Fees() external onlyOwner {
        liquidityFee = 10;
        treasuryFee = 10;
        castleFee = 10;
        reserveFee = 120;
    ...
    function takeFee(
        ...
        _gonBalances[checkMate] = _gonBalances[checkMate].add(
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(castleFee).add(reserveFee).add(pawnpromoFee);
        ...
        (success, ) = payable(castleReceiver).call{
        value: currentBalance.mul(castleFee).div(
            _currentFee
        ),
        gas: 30000
        }("");

        (success, ) = payable(reserveReceiver).call{
        value: currentBalance.mul(reserveFee).div(
            _currentFee
        ),
        gas: 30000
        }("");

        (success, ) = payable(pawnpromoReceiver).call{
        value: currentBalance.mul(pawnpromoFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _castleReceiver,
        address _pawnpromoReceiver,
        address _reserveReceiver
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        castleReceiver = _castleReceiver;
        pawnpromoReceiver = _pawnpromoReceiver;
