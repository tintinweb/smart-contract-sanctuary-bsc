...
/* Purple Network
Telegram : https://t.me/NikaNetwork
*/
...
contract NikaNetwork is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000 * 10**4 * 10**7;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'NikaNetwork';
