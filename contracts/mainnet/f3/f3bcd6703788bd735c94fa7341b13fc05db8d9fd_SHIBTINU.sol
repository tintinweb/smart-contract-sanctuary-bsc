...
contract SHIBTINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Tesla Inu";
    string private _symbol = "SHIBTINU";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x4f6a2561F1981e1C7b80AAeE0110d0818343b7cf); // Marketing Address
    address payable private TeamWallet = payable(0x4f6a2561F1981e1C7b80AAeE0110d0818343b7cf); // Buy Back Address
