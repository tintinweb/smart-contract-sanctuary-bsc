...
contract DOJINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOJ INU";
    string private constant _symbol = "$DOJINU";
    ...
    address private marketingWallet = address(0xEa3BED08A9F9985374CA3D92E9A2d4Daacbf4413);
    address private liquidityReceiver = address(0xEa3BED08A9F9985374CA3D92E9A2d4Daacbf4413);
