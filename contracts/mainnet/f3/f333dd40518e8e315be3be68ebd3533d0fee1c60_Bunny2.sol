...
contract Bunny2   is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    address public MarketingWallet = 0xf33E34BeBE46A849B09fF6f1Ce5EA45CB4d1CD31;
    string private _name = "Bunny2.0";
    string private _symbol = "Bunny22.0";
