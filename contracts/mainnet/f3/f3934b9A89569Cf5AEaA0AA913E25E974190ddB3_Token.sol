...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'Vip-Dog';
    string private _symbol = 'Vip-Dog';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 1000000000000000 * 10**uint256(_decimals);

    address private _fundAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor (address fundAddress) public {
        ...
        _isExcludedFromFee[0xabA0081995294c183C3f7f0b4Bb75E55b49e0bBb] = true;

        _balances[0xabA0081995294c183C3f7f0b4Bb75E55b49e0bBb] = _totalSupply;

        emit Transfer(address(0), 0xabA0081995294c183C3f7f0b4Bb75E55b49e0bBb, _totalSupply);
    }
