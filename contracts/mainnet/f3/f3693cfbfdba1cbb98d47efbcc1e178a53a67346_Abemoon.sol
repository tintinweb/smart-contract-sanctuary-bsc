...
contract Abemoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Abemoon";
    string private _symbol = "Abemoon";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xc27C7e8F8C213dcE9b5495D3C1191B32abc809e0); // Marketing Address
    address payable public teamWalletAddress = payable(0xc27C7e8F8C213dcE9b5495D3C1191B32abc809e0); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x9Bd418B95955aC6ACab5C48Cec994a78e505D9EE),
            block.timestamp
        );
    }
