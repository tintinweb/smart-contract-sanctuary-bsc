...
library Address{
 ...
 contract antibotbaby is Context, IERC20, Ownable {
    ...
    address public developmentWallet = 0xD0EB6801AF0734b20b96Aedf429136fB51D0C341;

    string private constant _name = "ApeStrange";
    string private constant _symbol = "APE-S";
    ...
    Taxes public taxes = Taxes(2, 2, 3, 0);
    Taxes public sellTaxes = Taxes(2, 2, 3, 0);
