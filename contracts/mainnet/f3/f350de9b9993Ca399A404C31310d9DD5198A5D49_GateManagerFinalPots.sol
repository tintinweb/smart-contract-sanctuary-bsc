...
contract GateManagerFinalPots is ReentrancyGuardUpgradeable, Ownable {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;

    // deposit token
    address public constant underlying = address(0x3Fcca8648651E5b974DD6d3e50F61567779772A8);
    ...
    /// @notice Supplies underlying token.
        ...
        updateReward(address(0))
    {
        ...
        if (info.rewardToken == address(underlying)) {
