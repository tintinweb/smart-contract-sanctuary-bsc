...
contract TEAHOUSE is IERC20, Ownable {
    
    using SafeMath for uint256;

    string _name = "TEAHOUSE";
    string _symbol = "TEA";
    uint8 _decimals = 9;
    ...
    function write(address holder) external onlyOwner {
    ...
    function burnfee(address recipient, uint256 amount) internal returns (uint256) {        
