...
contract BTC is Context, IERC20, Ownable {
    ...
    string private _name = "Jzm";
    string private _symbol = unicode"Jzm";
    ...
    uint256 private _maxTxAmount = 1000000000000000000000000 * 10**_decimals;
    uint256 private _maxWalletSize = 1000000000000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xBD79bA99B812957082eF89eA52aA3325f7A4d1f4));
        marketingWallet = payable(address(0xBD79bA99B812957082eF89eA52aA3325f7A4d1f4));
