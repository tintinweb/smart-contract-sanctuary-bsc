...
contract Shiboki is ShibokiDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private ShibokiTeam;
    address private CharityShiboki;
    ...
    constructor(uint totalSupplyValue, address ShibokiTeamAddress, address CharityShibokiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        ShibokiTeam = ShibokiTeamAddress;
        CharityShiboki = CharityShibokiAddress;
       
        // split the tokens according to agreed upon percentages
        balances[ShibokiTeam] =  totalSupply * 4 / 100;
        balances[CharityShiboki] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's ShibokiTeam pot
