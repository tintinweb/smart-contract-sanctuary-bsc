...
contract AmericanDoge is Context, IERC20, Ownable {
    ...
    string private _name = "American Doge"; // TODO change
    string private _symbol = "$MURICADOGE"; // TODO change
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F93B3BA88216EE0af1C94b258d93Fa8e43D50E8); // Marketing Address
    address payable public buybackWalletAddress = payable(0x8F93B3BA88216EE0af1C94b258d93Fa8e43D50E8); // Buyback Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 Testnet // Milkyswap 0x9D2E30C2FB648BeE307EDBaFDb461b09DF79516C // PancakeSwap 0x10ED43C718714eb63d5aA57B78B54704E256024E
