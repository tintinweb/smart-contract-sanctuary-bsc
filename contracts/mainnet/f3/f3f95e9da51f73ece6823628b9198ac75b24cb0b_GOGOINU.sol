...
//Telegram : https://t.me/GOGOINUOfficial
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        require(address(this).balance >= amount, "GOGO Hare Inu Address: insufficient balance");
        (bool success,) = recipient.call{value : amount}("");
        require(success, "GOGO Hare Inu Address: unable to send value, recipient may have reverted");
    }

    function functionCall(address target, bytes memory data) internal returns (bytes memory) {
        return functionCall(target, data, "GOGO Hare Inu Address: low-level call failed");
    }
    ...
    function functionCallWithValue(address target, bytes memory data, uint256 value) internal returns (bytes memory) {
        return functionCallWithValue(target, data, value, "GOGO Hare Inu Address: low-level call with value failed");
    }

    function functionCallWithValue(address target, bytes memory data, uint256 value, string memory errorMessage) internal returns (bytes memory) {
        require(address(this).balance >= value, "GOGO Hare Inu Address: insufficient balance for call");
        require(isContract(target), "GOGO Hare Inu Address: call to non-contract");
        (bool success, bytes memory returndata) = target.call{value : value}(data);
        return _verifyCallResult(success, returndata, errorMessage);
    }

    function functionStaticCall(address target, bytes memory data) internal view returns (bytes memory) {
        return functionStaticCall(target, data, "GOGO Hare Inu Address: low-level static call failed");
    }

    function functionStaticCall(address target, bytes memory data, string memory errorMessage) internal view returns (bytes memory) {
        require(isContract(target), "GOGO Hare Inu Address: static call to non-contract");
    ...
    function functionDelegateCall(address target, bytes memory data) internal returns (bytes memory) {
        return functionDelegateCall(target, data, "GOGO Hare Inu Address: low-level delegate call failed");
    }

    function functionDelegateCall(address target, bytes memory data, string memory errorMessage) internal returns (bytes memory) {
        require(isContract(target), "GOGO Hare Inu Address: delegate call to non-contract");
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5E986cBBd5B6df3453bfc71A33fE2c3b1519A06A;
...
contract GOGOINU is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x5E986cBBd5B6df3453bfc71A33fE2c3b1519A06A);
    ...
    */
    ...
    string private _name = "GOGO Hare Inu";
    string private _symbol = "GOGOINU";
