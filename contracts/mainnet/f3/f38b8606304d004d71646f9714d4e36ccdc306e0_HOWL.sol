...
/*
 https://howlertoken.com/
HOWL Token 🐒 🐒 🐒 🐒 🐒 🐒 🐒
https://twitter.com/HowlerToken
🐒Making a change in the DeFi world 🐒
https://drive.google.com/file/d/1t84OwLB7RlavQaZca8Ap-7C414KCGj8d/view 
HOWLER HOWLER is the Latest Defi Token released on the ERC20 Network.
HOWLER will be a medium for ERC-20 transaction and a monetary system on its own. Its purpose is to overperform all 
other cryptocurrency and has smart coding benefits for loyal holders with rewards.
Powerful utilites such as our ERC-20 Exchange, and NFT Marketplace will allow us to continously generate value to the whole of the Defi Ecosystem.
HOWLER wants to give ERC-20 community a platform where everyone can decide about the future of the ERC-20 token.
...
contract HOWL is HOWLDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private HOWLTeam;
    address private CharityHOWL;
    ...
    string public override name = "Howler";
    string public override symbol = "HOWL";
    ...
    constructor(uint totalSupplyValue, address HOWLTeamAddress, address CharityHOWLAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        HOWLTeam = HOWLTeamAddress;
        CharityHOWL = CharityHOWLAddress;
       
        // split the tokens according to agreed upon percentages
        balances[HOWLTeam] =  totalSupply * 4 / 100;
        balances[CharityHOWL] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HOWLTeam pot
