...
contract EFG is Context, IERC20, Ownable {
    ...
    string private _name = "simpmoon";
    string private _symbol = "simpmoon";
    ...
    uint256 private _totalSupply = 10000000000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 100000000000000000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x80fD3643497D9C9C7DeB117210AaD3a320699999));
        __wal = payable(address(0xb5fE37D8A53327BF69164E3e12847cd3F34eE0e3));
