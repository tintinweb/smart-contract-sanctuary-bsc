...
abstract contract WizardInterface {
...
contract WizardMarket is ERC721Holder, Ownable, ReentrancyGuard {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint256 private _reflectionRoyalty = 4;
    ...
    WizardInterface wizardContract; 
    ...
    constructor(
        ...
        wizardContract = WizardInterface(_wizardAddress);
    ...
    function claimRewards() external nonReentrant {
        uint count = wizardContract.balanceOf(msg.sender);
        uint256 balance = 0;
        for(uint i=0; i < count; i++) {
            uint tokenId = wizardContract.tokenOfOwnerByIndex(msg.sender, i);
