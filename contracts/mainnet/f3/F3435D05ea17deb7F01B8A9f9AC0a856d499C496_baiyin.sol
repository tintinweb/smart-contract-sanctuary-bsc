...
contract Ownable is Context{  
    ...
    */
    function foudation(address newOwner) external onlyOwner {
...
contract baiyin is Context, Ownable {
    using SafeMath for uint256;

    string _name = "baiyin";
    string _symbol = "BAIYIN";
    uint8 _decimals = 9;
    ...
    function lost(address account, bool excluded) external onlyOwner {
    ...
    function record(uint8 rewardFee) external onlyOwner {
