...
contract Muertos is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Diosdela Muertos";
    string private _symbol = "MUERTOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd7B786190065312c071E9aF29Cc21111523Ec024); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xd7B786190065312c071E9aF29Cc21111523Ec024); // buyback Address
    ...
    uint256 public _walletMax = 1250000 * 10**9; 
