...
contract GasToken is ERC20, ReentrancyGuard, AccessControlEnumerable, ERC20Burnable {
    ...
    address public lp = 0xc93bA3c9f8451330541b22C33d769aDa2D414FdE;
    address public token = 0x3BDCAfdD30Ef527A90c1b1812600cFAb1b3e9F29;
    address public lpStake = 0xA415A3Df10904D186C702005BA5382340E3e9f89;
    address public treasury = 0xa52b60f262a8bB8d14B7427D01499CD95224d232;
    address public constant usdt = 0x9948a363C8CD2442156824Fe7600290183588c29;


    function baseInit(address _lp, address _token, address _lpStake, address _treasury) external onlyRole(OPERATOR_ROLE) {
        lp = _lp;
        token = _token;
        lpStake = _lpStake;
        treasury = _treasury;
    ...
    function wrapByUsdt(uint256 amount) external nonReentrant {
        require(amount % (swapBase * baseNum) == 0 , "GasSwap: incorrect amount.");
        IERC20(usdt).safeTransferFrom(msg.sender, address(this), amount);
        IERC20(usdt).safeApprove(lpStake, amount);
        ILpStake(lpStake).recharge(amount);
    ...
    function wrapByBank(address bank, uint256 amount) external nonReentrant {
        ...
        require((gasAmount + swapInfo.swaped) <= swapInfo.limit, "BankSwap: amount exceeded.");
