...
contract T1 is Context, IERC20, Ownable {
    ...
    string private _name = "magpie bridge";
    string private _symbol = "magpie bridge";
    ...
    address payable public marketingWalletAddress = payable(0x5b0b21a1B9f96F03dcecB2803e2a323CfDA0b1eb);
    address payable public liquidityWalletAddress = payable(0x5b0b21a1B9f96F03dcecB2803e2a323CfDA0b1eb);
