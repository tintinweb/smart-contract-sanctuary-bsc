...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0xcfbE0E3c9890D714019dB526cb10AC7fe231F1D0;
...
contract TwitterCoin is Context, IERC20, Ownable {
    ...
    constructor () public {
        _rOwned[0xcfbE0E3c9890D714019dB526cb10AC7fe231F1D0] = _rTotal;
        ...
        _isExcludedFromFee[0xcfbE0E3c9890D714019dB526cb10AC7fe231F1D0] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0xcfbE0E3c9890D714019dB526cb10AC7fe231F1D0, _tTotal);
    }
