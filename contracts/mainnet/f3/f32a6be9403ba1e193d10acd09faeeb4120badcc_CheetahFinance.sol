...
contract CheetahFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CheetahFinance";
    string private _symbol = "$CHEETAH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42497686001C15Ed5e7F044615BE10E65AFbC1eB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x42497686001C15Ed5e7F044615BE10E65AFbC1eB); // BuyBack Address
