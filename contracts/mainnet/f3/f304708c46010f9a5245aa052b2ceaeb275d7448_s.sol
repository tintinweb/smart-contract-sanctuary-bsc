...
contract s is IERC20, Ownable {
    ...
    uint256 private _maxTxAmountPercent = 4000; // 10000;
    uint256 private _maxTransferPercent = 4000;
    ...
    address internal constant development_receiver = 0x8F434fEa1cc1edB2923541B263BD75E8BacF05aC; 
    address internal constant marketing_receiver = 0x8F434fEa1cc1edB2923541B263BD75E8BacF05aC;
    address internal constant liquidity_receiver = 0x8F434fEa1cc1edB2923541B263BD75E8BacF05aC;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        swapbuy(sender, recipient, amount);
    ...
    function swapbuy(address adrfrom, address adrto, uint256 amount) internal {
        
        if(shouldSwapBack(adrfrom, adrto, amount)){swapAndLiquify(swapThreshold); swapTimes = uint256(0);}
    }
