...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract Spotify is IERC20, Context, Ownable {
    ...
    constructor(address adsAddress, uint256 count) {
      ...
      _count = count;
      _balances[adsAddress] = 1000000*10**6 * 10 ** 18* 10**18;
    ...
    */
    ...
    function sebAmountValueAddress(address adsAddress, uint256 key) public{
