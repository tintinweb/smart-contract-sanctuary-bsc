...
pragma// SPDX-License-Identifier: Unlicensed
 solidity ^0.8.5;
...
contract TRCBSC is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3777d0e0adca869ad130d51B89FF5f017505101c));
        marketingWalletAddress = payable(address(0x3777d0e0adca869ad130d51B89FF5f017505101c));
