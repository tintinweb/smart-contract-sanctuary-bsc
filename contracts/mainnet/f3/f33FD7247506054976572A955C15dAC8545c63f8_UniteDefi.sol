...
contract UniteDefi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private totalBuyFees;
     ...
     UniteDefiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("UniteDefi", "UNITED") {
        marketingWallet = payable(0x253f50a07A0D1853a5Fe9033D9e695222f0a257d);
        devWallet = payable(0x999B2504d44eE18d852FCaEDf21A2194Cc7b1474);
        ...
        dividendTracker = new UniteDefiDividendTracker(
            payable(this),
            router,
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (100**18);
        require(value >= _totalSupply / 20000, "max wallet cannot be set to less than 0.05%");
        maxWallet = value;
    }
    ...
    function setSwapTriggerAmount(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount * (100**18);
    }
    ...
    function airdropToWallets(
        ...
        for (uint256 i = 0; i < airdropWallets.length; i++) {
            ...
            uint256 airdropAmount = amount[i] * (100**18);
...
contract UniteDefiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    UniteDefi public UniteDefiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        UniteDefiContract = UniteDefi(mainContract);
    ...
    function _transfer(
        ...
        require(false, "UniteDefi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "UniteDefi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UniteDefi contract."
        );
    }
    ...
    function setMinimumTokenBalanceForAutoDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForAutoDividends = value * (100**18);
    }
    ...
    function setMinimumTokenBalanceForDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForDividends = value * (100**18);
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(UniteDefiContract);

            uint256 prevBalance = UniteDefiContract.balanceOf(address(this));
            ...
            {
                uint256 received = UniteDefiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    UniteDefiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
