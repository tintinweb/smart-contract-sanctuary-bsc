...
/**
A unique DeFi where you are surrounded in 8bit vibes! Wallet, Swap, Farming and Staking platform, Testnet is in the works!
...
COLOSSEUM BRIDGE
Telegram : https://t.me/ColosseumBridge
Website : TBA
...
contract COLOSSEUMBRIDGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "COLOSSEUM BRIDGE";
    string private constant _symbol = "CBRIDGE";
    uint8 private constant _decimals = 9;
    
    uint256 private _marketingFee = 6;
    uint256 private _liquidityFee = 1;

    address private  _marketingWallet = 0x00556E507468a07aE4A4a064Da5202F08Ef46fb2;
    ...
    function swapAndLiquidity(uint256 tokens) private {
        uint256 BNBtosend = tokens*10000;
