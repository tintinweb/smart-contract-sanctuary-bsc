...
Total Supply : 1 000 000 000 CHEEMSNEKO Tokens
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x26720BA650AA4Fc324aC43417e2351c6cE86A2D3;
...
contract CHEEMSNEKO is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x3212728F37BC81322B4D8912D20b7b1ac9f6D164);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CHEEMSNEKO";
