...
contract TATSUKIINU is IBEP20, Auth {
    ...
    string constant _name = "TATSUKI INU";
    string constant _symbol = "TATSUKI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 10 / 1000; // 1%
    uint256 public _maxTxAmountSell = _totalSupply * 10 / 1000; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x2B8ddB6981fCb9f4dc350497df408d68527Bc44C;
        marketingFeeReceiver = 0x2B8ddB6981fCb9f4dc350497df408d68527Bc44C;
