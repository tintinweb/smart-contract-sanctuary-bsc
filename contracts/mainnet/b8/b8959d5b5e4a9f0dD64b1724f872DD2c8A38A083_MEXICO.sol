...
Telegram : https://t.me/MexicosWorldcup
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93a70c9Fe79B8c65eb8E6bc5aBb745EDa0ecAD6B;
...
contract MEXICO is Context, IERC20, Ownable {
    ...
    string private constant _name = "MEXICO WORLD CUP"; // 
    string private constant _symbol = "$MexicoWP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x93a70c9Fe79B8c65eb8E6bc5aBb745EDa0ecAD6B);
