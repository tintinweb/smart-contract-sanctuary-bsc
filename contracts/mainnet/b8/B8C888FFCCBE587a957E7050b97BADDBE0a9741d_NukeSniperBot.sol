...
TG: https://t.me/NukeSniperBotChannel
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD15b8d55e25B1082Cd6E01cA9e948aE3c1E8b7BC; // owner address
...
contract NukeSniperBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Nuke Sniper Bot";
    string private _symbol = unicode"NUKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD15b8d55e25B1082Cd6E01cA9e948aE3c1E8b7BC); // Marketing Address
    address payable public teamWalletAddress = payable(0xD15b8d55e25B1082Cd6E01cA9e948aE3c1E8b7BC); // Team Address
