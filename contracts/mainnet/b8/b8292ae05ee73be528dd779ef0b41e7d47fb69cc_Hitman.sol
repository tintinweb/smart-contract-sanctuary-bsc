...
contract Hitman is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xb0Cd3ADd7843CA7DCb54C6281f88eB4F37B7FDA4;//other than ownership adress
    ...
    string private _name = "Hitman"; //name of the token 
    string private _symbol = "HTM"; //symbol
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**18; //it will restric transaction according to amount
