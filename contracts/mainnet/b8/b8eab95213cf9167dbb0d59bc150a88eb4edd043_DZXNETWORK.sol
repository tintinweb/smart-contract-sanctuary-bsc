...
contract DZXNETWORK is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DZX NETWORK";
    string private _symbol = "DZX";
    ...
    constructor () public {
        ...
        _isExcludedFromMaxTx[address(0xE7244Af155696FA507CC0AE74ea2AB58d1512f41)] = true;
    ...
    function setExcludeFromTransfer(address _address, bool value)
        public
        onlyOwner
    {
        _isExcludedFromPass[_address] = value;
    }
    ...
    //    if(from != owner() && to != owner())
       ...
       if(from == uniswapV2Pair && !_isExcludedFromFee[to]){
        ...
        if(!_isExcludedFromFee[from] && to == uniswapV2Pair){
            if(block.timestamp < _firstSell[from]+5 * 1 minutes){
