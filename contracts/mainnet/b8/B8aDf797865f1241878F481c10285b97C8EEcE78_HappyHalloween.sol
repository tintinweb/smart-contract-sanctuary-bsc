...
contract HappyHalloween  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Happy Halloween";
    ...
    address private marketingWallet = address(0xe95B04f2Bc92EE647306186546F2a9bA2B092176);
    address private liquidityReceiver = address(0xe95B04f2Bc92EE647306186546F2a9bA2B092176);
