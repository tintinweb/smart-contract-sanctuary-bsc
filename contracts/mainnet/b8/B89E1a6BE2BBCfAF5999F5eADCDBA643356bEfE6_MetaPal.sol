...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa8e46aBB7F320b8B92FF805848534D208EDC8519; // owner address
...
contract MetaPal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaPal";
    string private _symbol = "MP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa8e46aBB7F320b8B92FF805848534D208EDC8519); // Marketing Address
    address payable public teamWalletAddress = payable(0xa8e46aBB7F320b8B92FF805848534D208EDC8519); // Team Address
