...
/*
    ...
    Basic Sanji is here to conquer the meme market from the depths of crypto winter.
    Many have tried before to capture the essence of the most memable sanji in the world.
    We are keeping this truly classic.
    6% Tax, no dev fee.
    All holders are encouraged to use their rewards to grow the project.
    Let's make $BS a household name.


    https://t.me/basicsanji
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eAace8A8EFb72A4B6BA13afb043ED77c8CC480f; // owner address
...
contract BasicSanjiToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Basic Sanji";
    string private _symbol = "$BS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0eAace8A8EFb72A4B6BA13afb043ED77c8CC480f); // Marketing Address
    address payable public teamWalletAddress = payable(0x0eAace8A8EFb72A4B6BA13afb043ED77c8CC480f); // Team Address
