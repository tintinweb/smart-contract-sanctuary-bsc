...
contract Fench is Context, IERC20, Ownable {
    ...
    uint256 private _liqTx=1;
    uint256 public _dvTx=1;
    uint256 private _brnTx=1;
    uint256 private _promTx=1;
    uint256 private _liqBuyTx=1;
    uint256 private _liqSelTx=1;
    uint256 private _dvBuyTx=1;
    uint256 private _dvSelTx=1;
    uint256 private _brnBuyTx =1;
    uint256 private _brnSelTx=1;
    uint256 private _promBuyTx =1;
    uint256 private _promSelTx=1;
