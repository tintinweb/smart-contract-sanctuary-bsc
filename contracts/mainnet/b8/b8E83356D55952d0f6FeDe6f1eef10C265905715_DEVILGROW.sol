...
// https://t.me/devilgrow

/**
Devil Grow is a coin launched with the binance smart chain network.
 Devil grow will be the next hype with several utility packages. 
 With his Strength and the cool genre, we aim for the moon and beyond!
*/
...
contract DEVILGROW is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 500_000_000 * 10**_decimals;
    uint256 public maxWalletAmount = 3_000_000_000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xc22E2eD93Ab5fFF1e640b9EC0Ac4c920F4990f50;

    string private constant _name = "Devil Grow";
    string private constant _symbol = "DEVILGROW";
    ...
    Taxes public taxes = Taxes(2,6,0,0);
