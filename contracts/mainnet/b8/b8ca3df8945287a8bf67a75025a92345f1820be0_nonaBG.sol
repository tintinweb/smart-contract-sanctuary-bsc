...
contract BEP20 is Ownable, IBEP20, IBEP20Metadata {
    ...
    function _transfer(
        ...
        require(transferWithLock == false,"transfer is in locked state");
        }
...
contract nonaBG is BEP20, BEP20Burnable {



    constructor() BEP20("9(Nona) Block Game", "9BG") {
         isExcluded[owner()] = true;
         isExcluded[0x9C82C1380f225231db037FCff131e5e4a8e230BF]= true;
    ...
    **/
    ...
    function setTransferWithLock (bool value) external onlyOwner {
        transferWithLock = value;
    }
    ...
    **/
    function excludeAddressFromTransferLock (address add, bool value) external onlyOwner {
