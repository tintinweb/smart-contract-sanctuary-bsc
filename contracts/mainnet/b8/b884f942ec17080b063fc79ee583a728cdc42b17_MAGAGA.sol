...
// MAKE AMERICA GREAT AND GLORIOUS AGAIN - COMMUNITY TOKEN - FEEL FREE TO LAUNCH SOCIALS
...
contract MAGAGA is BEP20, Auth {
    ...
    string public constant name = "Make America Great And Glorious Again";
    string public constant symbol = "MAGAGA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF75f7e7E136FAeaDB79601DeF4d34C2f8F0FfE4B;
        operationsFeeReceiver = 0xF75f7e7E136FAeaDB79601DeF4d34C2f8F0FfE4B;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(antibot && (firstbuy[sender] > 0)){
            require( firstbuy[sender] > (block.number - 10), "Bought before contract was launched");
        }
    ...
    function goLive_seriouslythistime() external onlyOwner {
    	tradingOpen = true;
    	antibot = false;
    }
