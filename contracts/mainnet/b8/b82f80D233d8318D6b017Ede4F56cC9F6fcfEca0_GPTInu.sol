...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0b18Aad2Ad9c86D00c179c3C46b648120F03f12b; // owner address
...
contract GPTInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "GPTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0b18Aad2Ad9c86D00c179c3C46b648120F03f12b); // Marketing Address
    address payable public teamWalletAddress = payable(0x0b18Aad2Ad9c86D00c179c3C46b648120F03f12b); // Team Address
