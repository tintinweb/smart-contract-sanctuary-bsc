...
contract JZDAOToken is Context, IERC20, Ownable {
    ...
    string private _name = "JZDAO";
    string private _symbol = "JZDAO";

    uint public buyFee = 30;
    uint public sellFee = 70;
    ...
    struct Param{
     ...
     function _initParam(uint256 tAmount,Param memory param) private view  {
        ...
        if( param.takeFee ){
            if( param.isBuy ){
                param.tFee = tAmount * buyFee / 1000;
                tFee = param.tFee;
            }else{
                param.tFee = tAmount * sellFee / 1000;
                tFee = param.tFee;
            }
        }
    ...
    function _takeFee(Param memory param,address from)private {
        if( param.tFee > 0 ){
            _take(param.tFee, from, receiver);
        }
    }
