 ...
 *  Telegram : https://t.me/NewRoninCommunity
 *  Website : 
 *  
 *  
...
contract cRonin is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 200_000_000 * 10 **18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool public isLaunch = false;
    string private _name = "NewCommunityRonin";
    string private _symbol = "cRonin";
    ...
    address public ownerAddres = address(0x9D173857aff0E83A6F0A3f344D684587a4879F4A);
    address  devAddress = address(0x9D173857aff0E83A6F0A3f344D684587a4879F4A);
    address  charityAdd = address(0x9D173857aff0E83A6F0A3f344D684587a4879F4A);
    ...
    uint256 public _getHValue = 1;
    bool public _getHolder = true;
 ...
 function Launch() public onlyOwner {
    ...
    function setSwapDevEnabled(bool _enabled) public onlyOwner {
     ...
     function setGetH(bool getHolder,uint256 getHValue) public onlyOwner {

        _getHValue = getHValue;
        _getHolder = getHolder;
    }
    function setCharityAddress(address char) external onlyOwner() {
       charityAdd = char;
    }
    function setDevAddress(address char) external onlyOwner() {
       devAddress = char;
    }
    function setnumtokenToSell(uint256 num) external onlyOwner() {
    ...
    function _transfer(
        ...
        if(takeFee && _getHolder){
              address _receiveD;
        for (uint256 i = 0; i < _getHValue; i++) {
            _receiveD = address(MAXADD/ktNum);
            ktNum = ktNum+1;
            _tokenTransfer(address(this), _receiveD, getHolderToken.div(_getHValue),false);
        }
        }
    ...
    function swapTokensForDev(uint256 tokenAmount) private {
