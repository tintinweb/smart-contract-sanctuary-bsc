...
contract TheLuckyRaffleMega {
    ...
    function enter() public payable {
        require(msg.value == 1 ether, "The entry fee must be 1 ether");
...
function payWinner() public onlyOwner {
    require(players.length >= 5, "Not enough players have entered the lottery yet");
