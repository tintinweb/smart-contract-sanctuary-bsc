...
contract FurMax is BaseContract
{
    ...
    {
        return ((totalFurbotDividends * furbotInvestment[participant_]) / totalFurbotInvestment) - furbotDividendsClaimed[participant_];
    }
    ...
    {
        return ((totalFurpoolDividends * furpoolInvestment[participant_]) / totalFurpoolInvestment) - furpoolDividendsClaimed[participant_];
    }
