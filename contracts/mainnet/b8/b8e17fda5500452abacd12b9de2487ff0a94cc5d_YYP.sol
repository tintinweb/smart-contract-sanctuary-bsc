...
contract YYP
 is Context, IERC20, Ownable {
    ...
    string private _symbol = " YYP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE16f7C29a5f6e6c16B9Fa0aF56653F4Ac5d0980D);
    address payable public teamWalletAddress = payable(0xE16f7C29a5f6e6c16B9Fa0aF56653F4Ac5d0980D);
    address public immutable deadAddress =0xE16f7C29a5f6e6c16B9Fa0aF56653F4Ac5d0980D;
