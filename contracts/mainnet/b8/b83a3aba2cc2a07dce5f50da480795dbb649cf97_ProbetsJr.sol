...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6); //Pro Bets
...
contract ProbetsJr is IBEP20, Auth {
    ...
    string constant _symbol = "PBTJR";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x577a5ccf5967a0721a8B0F97Ec58acE03A36C4B6; // Pro Bets
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3c57d2Afde7D39d5Fcd0f0F20bAa10AcAAfbd329; 
        devWallet = 0xfe867B3dA417Dc459b3206171f8af69d05805963; 
