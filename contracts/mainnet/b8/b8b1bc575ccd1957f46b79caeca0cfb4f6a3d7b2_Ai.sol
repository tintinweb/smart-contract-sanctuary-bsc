...
contract Ai is Context, IERC20, Ownable {
    ...
    string private _name = "303ai";
    string private _symbol = "303ai";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xE245d221C0c94Da7EACc6e06F1aF2b9c6b6296D4); // Marketing Address
    address payable public teamWalletAddress = payable(0xE245d221C0c94Da7EACc6e06F1aF2b9c6b6296D4); // Team Address
