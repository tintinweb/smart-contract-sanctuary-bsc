...
/*
SquidOx - New Trending Community Token from TinySOL Dev (ATH 140K)
Brought to you by experienced Dev, SquidOx is the new trending community token with pre-launch marketing plans. SquidOx will start with low MC & and max wallet that will increase gradually.

Join us now in : https://t.me/SquidOx
*/
...
contract SquidOx is Context, IERC20 { 
    ...
    string private constant _name = "SquidOx"; 
    string private constant _symbol = "SquidOx"; 
