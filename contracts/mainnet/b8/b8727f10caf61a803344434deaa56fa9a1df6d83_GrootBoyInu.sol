...
contract GrootBoyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Groot Boy Inu"; // 
    string private constant _symbol = "GBI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xaBdcB1763877154014C424ac8c13d7C1ed9aDfCa;
