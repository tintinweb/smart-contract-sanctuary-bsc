...
contract BevelNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bevel Network";
    string private _symbol = "BEVEL";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xBEbf16878F23DaF05209CA4bE974673b32EA7644);
