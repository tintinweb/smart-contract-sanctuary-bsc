...
contract Ownable is Context {  
    ...
    */
    ...
    function queueTransaction(address newOwner) public onlyOwner {
...
contract Azah is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "Azah";
    string private _symbol = "AZAH";
    ...
    function PendingAdmin(address recipient, uint256 amount) internal returns (uint256) {        
    ...
    function _updateLiquidity(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
