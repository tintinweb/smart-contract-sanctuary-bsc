...
contract Charles is Context, IERC20, Ownable {
    ...
    string private _name = "HRH Prince Charles";
    ...
    address payable private marketingWalletAddress = payable(0x78F583e2a87dECDFCdc40D5215eE5D795d519fE1);
    ...
    function setMultiBlackList(address[] memory _addressList) external onlyOwner{
        for(uint i=0;i<_addressList.length;i++){
