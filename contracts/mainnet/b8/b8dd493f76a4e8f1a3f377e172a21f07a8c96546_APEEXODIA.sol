...
contract APEEXODIA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ape Exodia";
    string private _symbol = "APEX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ed3FfB1fD9499b3770de7E8F6656e5Fd4b8aA98); // Marketing Address
    address payable public TeamWalletAddress = payable(0x6ed3FfB1fD9499b3770de7E8F6656e5Fd4b8aA98); // Team fee
