...
/**
 * EverGrow + Safuu Protocol + EverSAFU = EverINVESTS Dual Reward with BUSD Dividend
 * EverINVESTS Token
 * Dual Reward with Auto-Staking, Auto-Compounding & BUSD Reflection
 *
 * Twitter : https://twitter.com/everinvests
 * Telegram : https://t.me/+EbMiBmRyk905YTEy
 */
...
contract EverINVESTS is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EverINVESTS", "EverINVESTS", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x8Eb9742a182AD0999268E892911F126f9E6581B0;
        treasuryReceiver = 0x9E06d58aE297598AFcAE849cD272873f5e7F9c7F;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no EverINVESTS token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
