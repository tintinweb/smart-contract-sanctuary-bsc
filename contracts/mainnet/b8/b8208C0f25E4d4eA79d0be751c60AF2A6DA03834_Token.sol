...
contract Token is ERC20, Ownable {
    ...
    address public receiveAddr = 0x9075995C4e2404217a699d489b69a51d4DdEC426;
    ...
    address public _marketingWalletAddress =
        0x9AE26Ddb4049427ECF8c05a3Eb09d80d3BeBA570;
    ...
    constructor() public ERC20("CPDD", "CPDD") {
        ...
        */
        _mint(receiveAddr, 200000000 * (10 ** 18));
    }
        ...
        if (takeFee) {
            ...
            if (
                ...
                if (
                    ...
                    fees = amount.mul((_fee + _liqFee + _rewardFee)).div(100);
                    ...
                    fees = amount
                        .mul((_fee + _liqFee + _rewardFee + _burnfee))
                        .div(100);
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken("CPDD_Dividen_Tracker", "CPDD_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 160000 * (10 ** 18); //must hold 20000+ tokens
    }
