...
*/
 ...
 /** X Token - $X
    ...
    SBF_FTX Conditional burn is better imo. Recipient should have the right to force you to burn $X (or donate it to charity), 
    but if the recipient is happy with your message it should cost nothing.

    With the recent tweet of Vitalik, we brought it in the crypto world as a community driven project with verified contract and big liquidity.
