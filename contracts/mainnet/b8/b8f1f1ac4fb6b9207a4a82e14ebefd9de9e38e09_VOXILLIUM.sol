...
contract VOXILLIUM is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB967b33fbf5A844DD59267753Bc39902b723CB50); // Marketing Address
    address payable public teamWalletAddress = payable(0xB967b33fbf5A844DD59267753Bc39902b723CB50); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 40000000 * 5 **_decimals; 
