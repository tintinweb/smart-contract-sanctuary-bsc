...
contract Token is Context, IERC20, Ownable{
    ...
    constructor () public{
        _balanceOf[msg.sender] = 1600000000000000000000000;            // Give the creator all initial tokens
        _totalSupply = 1600000000000000000000000;                    // Update total supply
        name = 'ENG';                                 // Set the name for display purposes
