...
contract NaughtiusMaximus is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0xD97Af796Cb426Cfd265218F665299FCFF0a6f72B;
    ...
    constructor () public {
        ...
        maxTxAmountSell = totalSupply() * 60 / 1000; // 6% maxTx for sell
        _maxWalletSize = totalSupply() * 60 / 1000; // 6% maxWallet
