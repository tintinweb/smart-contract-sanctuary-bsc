...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xE0Ff02ac707af0944Db789dfF0d551653Ce3c516;
...
contract ZAMORIA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE40266FD6348994E0aa069474E7F451A0f126d78;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 300000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZAMORIA";
    string private _symbol = "ZAM";
