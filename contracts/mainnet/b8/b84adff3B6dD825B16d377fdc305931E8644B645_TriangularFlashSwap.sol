...
contract TriangularFlashSwap is IERC3156FlashBorrower {
    ...
    function testFunction() public returns (address) {
        ...
        console.log("TriangularFlashSwap.sol testFunction");
        return WBNB;
    }
    ...
    function placeTrade(
        ...
        // console.log("TriangularFlashSwap.sol BREAKPOINT 3");
    ...
    function startArbitrage(
        ...
        IERC20(BUSD).safeApprove(address(DEX_ROUTER), 0);
        ...
        // TO AVOID ERROR:  SafeERC20: approve from non-zero to non-zero allowance
        if (A != BUSD && B != BUSD && C != BUSD) {
            IERC20(BUSD).safeApprove(address(DEX_ROUTER), MAX_INT);
        }
    ...
    function onFlashLoan(
        ...
        (uint256 loanAmount, address[6] memory adressesArray) = abi.decode(
            data,
            (uint256, address[6])
        );
        console.log(
            "TriangularFlashSwap.sol EQZ Loan in A",
        ...
        console.log("TriangularFlashSwap.sol loanAmount= ", loanAmount);
        console.log("TriangularFlashSwap.sol flashFee= ", flashFee);
        console.log(
            "TriangularFlashSwap.sol amountToRepay= loanAmount + flashFee = ",
            amountToRepay
        );
        ...
        // Place Trades
        console.log(
            "TriangularFlashSwap.sol DO ARBITRAGE ",
            adressesArray[0],
            adressesArray[1],
            adressesArray[2]
        );
        ...
        console.log("TriangularFlashSwap.sol A to B  = ", B_amount);
        ...
        console.log("TriangularFlashSwap.sol B to C  = ", C_amount);
        ...
        console.log("TriangularFlashSwap.sol C to A = ", A_amount);

        // Check Profitability
        bool profCheck = checkProfitability(amountToRepay, A_amount); // 100.03 < 102, Cnatidad final > prestamo + interes
        console.log("TriangularFlashSwap.sol  profCheck= ", profCheck);

        // require(profCheck, "Arbitrage not profitable"); //////////////////////////////////////////////////////////////////////////
        // PAY YOUSELF
        A_amount = getBalanceOfToken(adressesArray[0]);
        console.log("TriangularFlashSwap.sol A balance  = ", A_amount);

        IERC20 otherToken = IERC20(adressesArray[0]);
        console.log(
            "TriangularFlashSwap.sol A Income  = ",
        ...
        console.log(
            "TriangularFlashSwap.sol A amountToRepay  = ",
            amountToRepay
        );
        A_amount = getBalanceOfToken(adressesArray[0]);
        console.log("TriangularFlashSwap.sol A balance  = ", A_amount);
        console.log("BREAKPOINT DEX_CALL 1");
        console.log("TriangularFlashSwap.sol PAY FLASH LOAN BACK");

        // PAY FLASH LOAN
        // IERC20(adressesArray[0]).safeApprove(msg.sender, MAX_INT);
        // IERC20(adressesArray[0]).safeApprove(address(msg.sender), 0);
        IERC20(adressesArray[0]).safeApprove(address(msg.sender), A_amount);
        //PAY IN WBNB

        console.log("TriangularFlashSwap.sol onFlashLoan END");
