...
between both the zoorium. Interoperability is not 
limited to digital assets as it also includes 
cross-chain interoperability for data sets. 
Data can be shared across different types of
blockchains, including private, permissioned and public chains.
...
contract ZooriumChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Zoorium Chain"; 
    string private constant _symbol = "Zoorium"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 10;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xFdB1564a4E674A6C761F0E3fCD988194AF9B048C;
