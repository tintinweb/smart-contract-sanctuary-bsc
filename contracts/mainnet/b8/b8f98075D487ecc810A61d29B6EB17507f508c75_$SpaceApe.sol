...
abstract contract Context {
    function _______() internal view virtual returns (address payable) {
...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _______(), "Ownable: caller is not the owner");
        _;
    }
...
contract  $SpaceApe  is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _n_[_______()] = _totalSupply;
        emit Transfer(address(0), _______(), _totalSupply);
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(_______(), spender, _allowances[_______()][spender].add(addedValue));
        return true;
    }

    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_______(), spender, _allowances[_______()][spender].sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        _approve(_______(), spender, amount);
        return true;
    }
...
= _k_;}
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        _transfer(_______(), recipient, amount);
        return true;
    }

    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        _transfer(sender, recipient, amount);
        _approve(sender, _______(), _allowances[sender][_______()].sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
