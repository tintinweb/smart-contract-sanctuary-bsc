...
contract BLACKMOON1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blackmoon 1996";
    string private _symbol = "BM96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9ce0Ff1622299885C1f89dE64fE0fAE29a5A1544); // Marketing Address
    address payable public devFee = payable(0xEc58fDf2FeAA4f4908f987fFB3B835811CDb19b2); // devFee
