...
contract SINBOToken is IERC20, Ownable {
    ...
    address public projectAddress = 0x06F932C644f41B434a0e12f623abC087d6A351B1;
    address public agentAddress;
    address public immutable rewardToken = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    uint256 private _tTotal = 8848;

    uint256 public baseRate = 10000;

    uint256 public minTokenNumberToSell = 1; // 0.001%
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 marketingTokens = contractTokenBalance.mul(200).div(baseRate);
    ...
    function _takeInviterFee(
        ...
        uint256 tFee = amount.mul(0).div(baseRate);
        address cur;
