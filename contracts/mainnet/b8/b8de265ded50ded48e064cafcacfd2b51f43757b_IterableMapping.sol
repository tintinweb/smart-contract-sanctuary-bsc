...
contract ChocolateSwap is ERC20, Ownable {
    ...
    address public marketingWallet = 0x6468D69025832b21658396771d25b9321a16C4F4;
    address public operatorWallet = 0xC7784B6f33c1b4dE64a8A2911fB1516e81f24A01;
    ...
    constructor() ERC20("ChocolateSwap", "Chocolate") {
        
        address newOwner = 0x83f28278F8cfC6686Df4f5C17d94dD39CB6996c9;
    	dividendTracker = new DividendTracker(20000, rewardToken);
        ...
        _mint(newOwner, 990_000_000 * (10 ** 18));
    }
    ...
    function setWhiteListedContract (address account, bool value) external onlyOwner {
        require(account != address(this), "Owner cannot remove token contract whitelist");
    ...
    function updateBuyFees(uint256 _buyRewardFee, uint256 _buyMarketingFee, uint256 _buyLiquidityFee) external onlyOwner {
        require(_buyRewardFee + _buyMarketingFee + _buyLiquidityFee <= 25, "Fees must be less than 25%");
    ...
    function updateSellFees(uint256 _sellRewardFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) external onlyOwner {
        require(_sellRewardFee + _sellMarketingFee + _sellLiquidityFee <= 25, "Fees must be less than 25%");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(LiquidityShare > 0){
                ...
                uint256 LiquidityToken = contractTokenBalance * LiquidityShare / 100;
