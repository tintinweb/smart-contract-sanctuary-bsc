...
contract ProofOfDegens is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x498B4F3d79230C0a04AF76F6406a1c8598F037cb); 
    address payable public Wallet_Dev = payable(0x0D8D7851cb0E8526B642942DA9d9D930DaF92E4f);
    ...
    string private constant _symbol = unicode"PODs"; 
    ...
    constructor () {
        ...
        _owner = 0x0D8D7851cb0E8526B642942DA9d9D930DaF92E4f;
