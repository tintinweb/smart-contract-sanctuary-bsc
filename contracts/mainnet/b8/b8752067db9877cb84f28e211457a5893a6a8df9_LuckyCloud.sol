...
/** LUCKY CLOUD - $LUCKY
    ...
    🍀🤞Lucky Cloud ☁️🎰 by @luckycalls Team
 
    🚀Launch is coming.
    🟩Marketing after Launch.
    🟩Call Channels
    🟩Community Project. You know what that means. 
    🟢Diamond Hands needed. 
    🟢Shilling needed. 
    🟢Community Power needed. 
    🎁Giveaways coming 
        -Biggest Buy Giveaway  
        -Best Shiller Giveaway 
    And a lot more 🚀🚀

    ✅ Tokenomics ✅
    🔥1% Liquidity for stable
    🐢3% Marketing 
*/

// TG: https://t.me/LuckyCloudPortal
...
contract LuckyCloud is Context, IERC20, Ownable {
    ...
    string private constant _name = "LUCKY CLOUD";
    string private constant _symbol = "$LUCKY";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 4000000000* 10**_decimals; // 4% Max Wallet
    uint256 public _maxTxAmount = 2000000000* 10**_decimals; // 2% Max Buy/Sell
    ...
    address private marketingWallet = address(0x7bD127Cf02672124961Ca82e6D35faadA11cf792);
    address private liquidityReceiver = address(0x7bD127Cf02672124961Ca82e6D35faadA11cf792);
    ...
    constructor () {
        ...
        buyFee.marketing = 3; //3% Marketing
        buyFee.liquidity = 1; //1% LP

        sellFee.marketing = 3; //3% Marketing
        sellFee.liquidity = 1; //1% LP
