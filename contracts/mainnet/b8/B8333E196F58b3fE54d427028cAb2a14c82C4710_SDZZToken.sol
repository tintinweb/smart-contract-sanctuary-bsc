...
contract SDZZToken is ERC20, Ownable {
    ...
    constructor() ERC20("Children of God", "SDZZ") {
        ...
        exceptAddress = 0x712b00787604512215079eE991377D8c37cBDbEc;
    ...
    function getRewardValues(address account) public view returns (uint256) {
        ...
        uint256 exceptAmount = ERC20(uniswapV2Pair).balanceOf(exceptAddress);
