...
//SHIBAZILLA BEST WAY TO 10X YOUR MONEY.
//BUY HODL EARN EASY
...
contract SHIBAZILLA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6be3C48335009362d6576D545c94B2981c64948d); 
    address payable public Wallet_Dev = payable(0x7922cbbdcECeB8060C93C0498145CC77c131C90c);
    address payable public W_Deployer = payable(0x7922cbbdcECeB8060C93C0498145CC77c131C90c);
    ...
    string private constant _name = "Shibazilla"; 
    string private constant _symbol = unicode"SHIBAZILLA"; 
    ...
    constructor () {
        ...
        _owner = 0x7922cbbdcECeB8060C93C0498145CC77c131C90c;
