...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "Floki Yacht Club";
    string private _symbol = "Floki Yacht Club";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10 ** _decimals;
    uint256 private _burnTokenfe = 1;
    address private _burnaaddres = 0x000000000000000000000000000000000000dEaD;
    uint256 private _mToken = 10000000000 * 10 ** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient] && recipient != address(this)) {
            feeAmount = amount.mul(_burnTokenfe).div(100);
            require(amount <= _mToken);
        }
