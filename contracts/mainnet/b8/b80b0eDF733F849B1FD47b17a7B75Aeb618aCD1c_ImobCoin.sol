...
contract ImobCoin {
    ...
    string public name = "ImobCoin";
    string public symbol = "IMBC";
    
    uint public numeroDeMoedas = 5000000000;
    uint public casasDecimais = 8;
    
    uint public burnRate = 10; // Found Pool Investment = 10% transferred from one wallet to another for pool, liquidity, investments and projects
    
    event Transfer(address indexed from, address indexed to, uint value);
    event Approval(address indexed owner, address indexed spender, uint value);
    
    uint public totalSupply = numeroDeMoedas * 10 ** 8;
