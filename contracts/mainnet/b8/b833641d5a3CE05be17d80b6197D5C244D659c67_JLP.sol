...
contract JLP is ERC20Mintable {
    constructor() public ERC20Mintable("Falcon LP", "FLP", 0) {
    }
...
contract ERC20Mintable is ERC20, IMintable {
    address public gov;

    event SetGov(address newGov);

    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _initialSupply
    ) public ERC20(_name, _symbol, _initialSupply) {
        gov = msg.sender;
    }

    modifier onlyGov() {
        require(msg.sender == gov, "ERC20Mintable: forbidden");
        _;
    }
