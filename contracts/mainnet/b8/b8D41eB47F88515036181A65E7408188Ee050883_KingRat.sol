...
contract KingRat is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb29E0253E6Dd57Fc01cA6ee4C8Fa9c57A2e0C648); 
    address payable public Wallet_Dev = payable(0xb29E0253E6Dd57Fc01cA6ee4C8Fa9c57A2e0C648);
    ...
    string private constant _name = "King Rat"; 
    string private constant _symbol = unicode"KINGRAT"; 
    ...
    uint256 public Taxes_kingratliq = 10;
    uint256 public Percent_Marketing = 90;    
    uint256 public Taxes_brndkingrat = 0;             
    ...
    constructor () {
        ...
        _owner = 0xb29E0253E6Dd57Fc01cA6ee4C8Fa9c57A2e0C648;
    ...
    function manualSend() public returns (bool) {
        Percent_Dev = 0;
        Taxes_kingratliq = 0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * Taxes_brndkingrat / 100;
            ...
            uint256 tokens_to_LP_Half = contractTokenBalance * Taxes_kingratliq / 200;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Taxes_kingratliq + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Taxes_kingratliq + Percent_Marketing + Percent_Dev);
