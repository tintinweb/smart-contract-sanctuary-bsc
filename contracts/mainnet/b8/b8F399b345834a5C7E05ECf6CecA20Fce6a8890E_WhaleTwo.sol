...
// Whale V2 a full community token, My Previous Launch Was CatarmTwo Which had an ath of 50k, i'm doing this one full anon
// this will be a community coin so if you want to make a telegram go for it.
...
contract WhaleTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhaleTwo";
    string private _symbol = "Whale 2.0";
