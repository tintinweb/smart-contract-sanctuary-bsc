...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 transferburnFee = tAmount * _transferburnFee / 10000;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xa3652b2298D17660402d1E968A94401033a8806c;    
...
contract QJLMCoin   is AbsToken {
    constructor() AbsToken(
        ...
        address(0xa3652b2298D17660402d1E968A94401033a8806c),  //营销
    
        address(0xe96aC346FE8Aa8b5C716E464d96430b97109212f) //代币接收地址
    ){
