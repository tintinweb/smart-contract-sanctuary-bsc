...
contract MoneyAIToken is MoneyAIIBEP20 {
    ...
    string public override name = "MoneyAI";
    string public override symbol = "MoneyAI";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 48 / 100;
        balances[foundersPot] = totalSupply * 48 / 100;
        
        balances[owner] = totalSupply * 4 / 100;
    }
