...
contract HotDogeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xad22f2BBdEf8cDeD063896BfC9022e762Ed672D1); // Marketing Address
    address payable public devWalletAddress = payable(0xad22f2BBdEf8cDeD063896BfC9022e762Ed672D1); // Dev Address
    ...
    string private _name = "Hot Doge Grow";
    string private _symbol = "$HDGROW";
