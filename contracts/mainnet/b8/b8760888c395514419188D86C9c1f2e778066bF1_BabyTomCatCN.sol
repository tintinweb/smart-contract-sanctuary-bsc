...
contract BabyTomCatCN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyTomCatCN";
    string private _symbol = "BabyTomCatCN";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x4aE6e12Ec0a52216009B0D5CDa18864dF7640f9f); 
    address payable public ttWal = payable(0x4aE6e12Ec0a52216009B0D5CDa18864dF7640f9f); 
