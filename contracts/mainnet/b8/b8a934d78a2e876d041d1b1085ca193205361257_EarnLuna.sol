...
/* 
   ...
   I will add 4 BNB and all the total supply to the pool.
   We can make bLuna 1000x easy
...
contract EarnLuna is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "EarnLuna";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x393C9a30Dd5C0674F37e4B78042CE2a3e942394C;
        buybackWallet = 0x393C9a30Dd5C0674F37e4B78042CE2a3e942394C;
