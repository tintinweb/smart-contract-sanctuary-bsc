...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x01577E32d211bAFBc4989f05167b4B302e5E87c8; // owner address
...
contract Safemoonmasbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAFEMOONMAS";
    string private _symbol = "SFMASS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01577E32d211bAFBc4989f05167b4B302e5E87c8); // Marketing Address
    address payable public teamWalletAddress = payable(0x01577E32d211bAFBc4989f05167b4B302e5E87c8); // Team Address
