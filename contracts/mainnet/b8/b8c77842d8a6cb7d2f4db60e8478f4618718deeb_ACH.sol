...
contract ACH is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address ADMIN_WALLET_1 = 0x3eB47c126f094d836F85755946D9044547D52FBC; 
    address ADMIN_WALLET_2 = 0xF01C2B13C1DAF74B0C46C04C25062F9a84B50242; 
    address ADMIN_WALLET_3 = 0x3934f820D445984bcfdEbcb027C40371C4aee6a9; 

    address PUBLIC_OFFERING_ADDRESS = 0x50493e3A339c187D7eabf0AcdA1889c7f6579690; 
    address OWNER_ADDRESS = 0xde59227C1e2F852594810f6c891b4939000B569E; 
    address DEVELOPMENT_ADDRESS = 0xc99D84B068Da4B15B6C12a53D3E98BBaA454D764; 
    address MARKETING_ADDRESS = 0xEB5fE5EbE95bC816cA50F09acCb52694D5424e21; 
    address PRIVATE_INVESTORS_ADDRESS = 0xa36f02D9c6f637f8333A90bFF661C0300892D4E9; 
    ...
    constructor() {
        ...
        // Private 
        phaseDetails['PHASE_1'] = Phase(1655078400,1656115199,3000000000 * 1e18,3000000000 * 1e18,false,275697284381); 
        // Presale 
        phaseDetails['PHASE_2'] = Phase(1656115200,1656633599,3000000000 * 1e18,3000000000 * 1e18,false,321646831778);  
        // ICO
        phaseDetails['PHASE_3'] = Phase(1656633600,1688169600,3000000000 * 1e18,3000000000 * 1e18,false,321646831778);  

        
        adminDetails['ADMIN_1'] = Admin(payable(ADMIN_WALLET_1),3);
        adminDetails['ADMIN_2'] = Admin(payable(ADMIN_WALLET_2),0);
        adminDetails['ADMIN_3'] = Admin(payable(ADMIN_WALLET_3),0);
    }
    ...
    function buyACHToken() external payable returns(bool)
    {
        ...
        uint256 _admin_commision_amount_1 = 0; 
        uint256 _admin_commision_amount_2 = 0; 
        uint256 _admin_commision_amount_3 = 0; 

        // Assign All Amount Initially
        uint256 amount = msg.value;        
        uint256 _grossValue = amount;

        // Admin Commision 1
        if(_admin_commission_1.adminCommission > 0)
        {
            _admin_commision_amount_1 = amount.mul(_admin_commission_1.adminCommission).div(100);
            _admin_commission_1.adminWallet.transfer(_admin_commision_amount_1);   

            _grossValue = _grossValue.sub(_admin_commision_amount_1); 
        }

        // Admin Commision 2
        if(_admin_commission_2.adminCommission > 0)
        {
            _admin_commision_amount_2 = amount.mul(_admin_commission_2.adminCommission).div(100); 
            _admin_commission_2.adminWallet.transfer(_admin_commision_amount_2);   

            _grossValue = _grossValue.sub(_admin_commision_amount_2); 
        }

        // Admin Commision 3
        if(_admin_commission_3.adminCommission > 0)
        {
            _admin_commision_amount_3 = amount.mul(_admin_commission_3.adminCommission).div(100);   
            _admin_commission_3.adminWallet.transfer(_admin_commision_amount_3);   

            _grossValue = _grossValue.sub(_admin_commision_amount_3);  
        }
        ...
        // Decimalize 
        _userTransfer = _userTransfer.mul(1e18);
