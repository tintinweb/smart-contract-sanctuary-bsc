...
contract EclipseDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eclipse Doge";
    string private _symbol = "ED";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x89D7A074F4F1aBD09EEE009D8fbEF952299Cd273);
    address payable private BuyBackAddress = payable(0x043fd7d0E307792a014246EB54F0707F72087B4E);
