...
SPOOKY PEPE !
First 12 hours of taxes
💧 Liqudity - 3%
📉 Marketing - 5%
❔In order to bring in more holders, we need to do big promotions.
⏰ After 12 hours, we will evaluate and consider enabling rewards for holders (DOGE COIN)
...
contract SpookyPepe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Spooky Pepe";
    string constant _symbol = "SPOOKYPEPE";
    ...
    address public Owner=0x3bC96F5Ac9d220772648d19d310F221Bc7E4Bb2b; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3bC96F5Ac9d220772648d19d310F221Bc7E4Bb2b;
