...
You want an entry, but you are not always watching the chart...
DCA BOT will always be there to dynamicaly get your buys in on time using our lightning fast nodes! 

Telegram:
https://t.me/DCABOTofficial

Website:
DCABOT.app 

Twitter:
https://twitter.com/dcabotofficial?s=21&t=dqDopkEWBk_APNAdqJvcBA
*******************************&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
contract DCA is Context, IERC20, Ownable {
    ...
    string private constant _name = "DCA BOT";
