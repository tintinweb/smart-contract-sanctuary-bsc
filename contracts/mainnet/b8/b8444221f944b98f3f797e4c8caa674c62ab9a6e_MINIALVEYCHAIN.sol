...
contract MINIALVEYCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Alvey Chain";
    string private _symbol = "mwALV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xec2B640749e0B6E29084f25652cAba2c4c309c94); 
    address payable public buyBackWalletAddress = payable(0x1Dc96dDFd0C650E5169D10B864C2f96C9EC7e1cD); 
