...
//https://t.me/PurranormalCativity
//https://PurranormalCativity.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x5728c183b634cD5d35a1ddaaBc00a4220c38e0E9;
...
contract purr is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"PurranormalCativity"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x5728c183b634cD5d35a1ddaaBc00a4220c38e0E9), BNB_Tot);
            }
