...
contract TaisekiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Taiseki Inu"; // 
    string private constant _symbol = "$TAISEKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x8951458CB9892d8bc2846f9eB53591eE66bCccDd;
