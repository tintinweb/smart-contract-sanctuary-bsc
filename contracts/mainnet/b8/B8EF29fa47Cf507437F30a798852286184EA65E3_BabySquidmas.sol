...
/**
 ...
 ____    _    ______   __  ____   ___  _   _ ___ ____  __  __    _    ____  
| __ )  / \  | __ \ \ / / / ___| / _ \| | | |_ _|  _ \|  \/  |  / \  / ___| 
|  _ \ / _ \ |  _ \\ V /  \___ \| | | | | | || || | | | |\/| | / _ \ \___ \ 
| |_) / ___ \| |_) || |    ___) | |_| | |_| || || |_| | |  | |/ ___ \ ___) |
|____/_/   \_|____/ |_|   |____/ \__\_\\___/|___|____/|_|  |_/_/   \_|____/ 
                                                                            
Rewarding BUSD instead of squidmas, this should make this play long term!
TG: https://t.me/BabySquidmasBsc
*/
...
contract BabySquidmas is IBEP20, Auth {
    ...
    address DEV = 0xA57BdC50a72f776A8be17F2fcD8f098c1539887f;
    ...
    string constant _symbol = "BABYSMAS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA57BdC50a72f776A8be17F2fcD8f098c1539887f;
    ...
    function blacklistAddress(address[] memory accounts, bool state) external onlyOwner {
