...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x11390f980135018cC057D0F383ad6b4099A2399E;//fund address
...
contract YB is Token {
    constructor() Token(
        ...
        address(0x11390f980135018cC057D0F383ad6b4099A2399E),//fund address
    
        address(0x7815712767eBdDDcf20b151537a98439De1f0c11)//dev address
    ){
