...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2CC753B9E73C3F3E43cAE5b894CD7edFEAcC4704); 
...
contract NewCommunityFTX is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "New Community FTX";
    string constant _symbol = "NCFTX";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0x2CC753B9E73C3F3E43cAE5b894CD7edFEAcC4704;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xdd2B5Aae1D327D5D58Fa4966c03Ef304D58fb652;  
        anothermarketingWallet = 0x5A10CD66430B63c10314c2484cC8d224723e52Bc;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(1).div(5);
