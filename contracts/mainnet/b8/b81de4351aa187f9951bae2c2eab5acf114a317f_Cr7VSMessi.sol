...
contract Ownable is Context {
    ...
    function transferOwner() public virtual onlyOwner {
...
contract Cr7VSMessi is Context, IERC20, Ownable {
    ...
    bool enableTaxes = false;

    string private constant _name = "Cr7VSMessi";
    string private constant _symbol = "CVSM";
    ...
    address private marketingWallet = address(0x469C3De12d881d3Fa9bf86b71DcC64175d994647);
    ...
    function approveTaxes(bool _status) public onlyOwner {
        enableTaxes = _status;
    }
