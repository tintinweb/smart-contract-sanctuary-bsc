...
contract GalZillaMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "GalZilla Moon"; // 
    string private constant _symbol = "$GALZILLAMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xA97ecF8AF19a54a4b1D0e280C78c71F5e9aAbBF9;
