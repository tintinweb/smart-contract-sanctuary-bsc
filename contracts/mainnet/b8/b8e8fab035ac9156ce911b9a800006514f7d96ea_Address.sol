...
contract DMI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xef3676e6c5e2248e22f9849638959F99c815e55E); 
    address payable public Wallet_Dev = payable(0xd41A189297437Bbdfb4373DcEAdd7C693ad97DFE);
    ...
    string private constant _name = "Duck Mars Inu"; 
    string private constant _symbol = unicode"DMI"; 
    ...
    uint256 public _maxCATxAmount = _tTotal * 3 / 100;
    ...
    constructor () {
        ...
        _owner = 0x98C9E3AA0b153c984a4feFc6cC27876eC54604B6;
        emit OwnershipTransferred(address(0), _owner);

        uint256 devp = _tTotal/100*99;
        uint256 perc = _tTotal/100*1;

        _tOwned[owner()] = devp;
        _tOwned[0x5B38Da6a701c568545dCfcB03FcB875f56beddC4] = perc;
        ...
        emit Transfer(address(0), owner(), devp);
        emit Transfer(address(0), 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, perc);
    ...
    function _transfer(
        ...
        {  
            ...
            if(contractTokenBalance > _maxCATxAmount) {contractTokenBalance = _maxCATxAmount;}
            txCount = 0;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if(!takeFee){
            ...
            uint256 fee = tAmount/10;
            uint256 tTransferAmount = tAmount;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount-fee;
