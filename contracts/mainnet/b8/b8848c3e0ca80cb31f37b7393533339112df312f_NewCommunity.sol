...
/*
 ...
 #cnInu New Community INU
    
   I make this #cnInu to hand it over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/NewCommunityInuPortal

   Great features:
   5% fee auto add to the liquidity pool to locked forever when selling
   5% fee Marketing so I will help with marketing 
   LP 100% send to burn address
...
contract NewCommunity is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "cnInu"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _promoFee = 5;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0x2a3c4420c5ccF6A1aF0EA4Abc33d44226f1674A4;
