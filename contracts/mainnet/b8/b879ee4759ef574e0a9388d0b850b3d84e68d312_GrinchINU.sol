...
/**
    Telegram: https://t.me/GrinchINU_BSC
...
contract GrinchINU is IBEP20, Auth {
    ...
    string constant private _name = "Grinch INU";
    string constant private _symbol = "$GI";
   ...
   function setMaxWalletLimit(uint256 amount) external onlyOwner() {
    ...
    function setBUSDRewardsFee(address _marketingFeeReceiver, address _devFeeReceiver) external authorized {
