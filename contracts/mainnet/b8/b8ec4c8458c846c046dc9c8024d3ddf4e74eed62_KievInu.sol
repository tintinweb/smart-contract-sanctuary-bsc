...
contract KievInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Kiev Inu";
    string constant _symbol = "Kiev Inu";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xFFc76E7b8256930b73564895B13456b7Df5b471a;
