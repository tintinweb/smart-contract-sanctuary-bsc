...
contract Sheep is ERC20 {
    bool public inSwapAndLiquify;
    bool public swapAndLiquifyEnable = true;
    address public marketAddress = 0xDF120df463EAbD218c25D2caA26963164227A143;
    ...
    constructor(address tokenOwner) ERC20("Sheep", "Sheep")  {
    ...
    function setDividendDistributor(address _dividendDistributor) public onlyOwner {
        marketAddress = _dividendDistributor;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            if (sender == uniswapV2Pair) {
                require(block.timestamp >= startTime + 1 * 60, "not start time");
        ...
        if (takeFee && sender != uniswapV2Pair && recipient != uniswapV2Pair) {
            ...
            require(2000 * 10 ** decimals() >= totalAmount, "exceed max amount");
        }
        ...
        if (takeFee) {
            ...
            uint256 fee = amount * marketPercent/ divBase;
            totalFee += fee;
