...
//address
    ...
    address public marketingAddress = 0x52a53fd104896042F82CE5234A9A2b9E9e17596D;
    address public devAddress = 0x760B39344412a975E84A509760629e9B7FF5F799;
    address public teamAddress = 0xa7563c9eBE9b659FfD6bA5b692894eF8f7159d38;
    address public liquidityAddress = 0x52a53fd104896042F82CE5234A9A2b9E9e17596D;
//uint
                ...
                if(!excludedFromFees[to]) {
                    ...
                    if(limitBuys) {
                        ...
                        if(marketActiveAt + 0 < block.timestamp) {
                            require(marketActiveAt + 5 < block.timestamp,"You cannot buy at launch.");
