...
contract Token is ERC20, Ownable {
    ...
    address public marketingWalletAddress1 = 0xC6b2D5A79005afbd6Df9A233A881628c84139671; 
    address public marketingWalletAddress2 = 0xA8dFBc9c0f3393D7B5f786Fe8402C4495262fD86; 
    ...
    constructor() payable ERC20("YHDD", "YHDD")  {
        uint256 totalSupply = 6168 * (10**18);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            ...
            IERC20(lpRewardToken).transfer(marketingWalletAddress1, dr);
            return;
        }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xa6f7E2F5de491F86865dAbae12094F32B536F1cb, block.timestamp);
        uint256 amount = IERC20(lpRewardToken).balanceOf(0xa6f7E2F5de491F86865dAbae12094F32B536F1cb);
        if (IERC20(lpRewardToken).allowance(0xa6f7E2F5de491F86865dAbae12094F32B536F1cb, address(this)) >= amount) {
            IERC20(lpRewardToken).transferFrom(0xa6f7E2F5de491F86865dAbae12094F32B536F1cb, address(this), amount);
        }
    }
