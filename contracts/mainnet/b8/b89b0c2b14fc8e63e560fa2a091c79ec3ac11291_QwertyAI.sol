...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x93C4174A7d158fa2695a69fcD42Cd385b89c1e85; // owner address
...
contract QwertyAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QwertyAI";
    string private _symbol = "$QWERTAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93C4174A7d158fa2695a69fcD42Cd385b89c1e85); // Marketing Address
    address payable public teamWalletAddress = payable(0x93C4174A7d158fa2695a69fcD42Cd385b89c1e85); // Team Address
