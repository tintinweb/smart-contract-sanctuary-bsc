...
contract HappyDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Happydoge";
    ...
    uint256 public  _liquidityFeeBuy = 15; //

    // sell fee
    uint256 public  _taxFeeSell       = 0;
    uint256 public  _liquidityFeeSell = 15;
    
    uint256 public  _maxTxAmount     = _tTotal * 1 / 10000;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 10 / 10000; // 2% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xFc0cDA7CE3CEE9EaAf1072C0e5A665f55893499b;
        _marketingWallet = 0x5E5BaD9A8d7816E9E75B53501713E5C58F856E52;
