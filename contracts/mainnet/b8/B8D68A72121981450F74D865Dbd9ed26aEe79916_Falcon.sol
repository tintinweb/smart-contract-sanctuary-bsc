...
contract Falcon is ERC20, Ownable {
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        swapTokensAtAmount = 21000000 * (10*18); 
        ...
        _burn(owner(),totalSupply.mul(80).div(100));
    }
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function setCanTransfer(bool val) public onlyOwner {
        canTransfer = val;
    }
    ...
    function _transfer(
        ...
        if(from != owner()){
            require(canTransfer,"not allow transfer");
        }
