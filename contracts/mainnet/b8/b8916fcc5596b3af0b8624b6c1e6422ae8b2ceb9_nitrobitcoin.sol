...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C973203fC1abD39Abd010d95d49663f04976ED4; // owner address
...
contract nitrobitcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nitro Bitcoin";
    string private _symbol = "NITROBTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C973203fC1abD39Abd010d95d49663f04976ED4); // Marketing Address
    address payable public teamWalletAddress = payable(0x1C973203fC1abD39Abd010d95d49663f04976ED4); // Team Address
