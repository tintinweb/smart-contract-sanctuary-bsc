...
contract SAVITACOIN is BEP20 {
    using SafeMath for uint256;
    constructor(string memory coinName, string memory symbol, uint256 initialSupply, uint256 totalSupply, uint8 decimal) BEP20(coinName, symbol, initialSupply, totalSupply, decimal) {
