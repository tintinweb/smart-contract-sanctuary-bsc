...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbBf81DE00676649595C08BE4Cb185181DC86fcDe; // owner address
...
contract BabyDripto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDripto";
    string private _symbol = "BabyDripto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbBf81DE00676649595C08BE4Cb185181DC86fcDe); // Marketing Address
    address payable public teamWalletAddress = payable(0xbBf81DE00676649595C08BE4Cb185181DC86fcDe); // Team Address
    ...
    uint256 public _teamShare =2 ; // original 10
