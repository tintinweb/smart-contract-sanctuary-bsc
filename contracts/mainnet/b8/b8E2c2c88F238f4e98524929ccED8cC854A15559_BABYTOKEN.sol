...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function setHolderRaeward(address addr, uint256 enable) public onlyFunder {
...
contract BABYTOKEN is TOKEN {
    ...
    constructor() TOKEN(
        ...
        511, //totalsupply
        address(0x1fdb5AD70Bda67b00e43d927AFd978592687DFf4), //DEVWALLET
        address(0x1fdb5AD70Bda67b00e43d927AFd978592687DFf4) //MARKETING
    ){
