...
contract ShiBunny is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShiBunny";
    string constant _symbol = unicode"🐇SHIBUNNY";
    ...
    address public MarketingFeeReceiver =
        0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39;
    ...
    constructor() Auth(address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39)) {
        ...
        isFeeExempt[address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39)] = true;
        isTxLimitExempt[address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39)] = _totalSupply;
        emit Transfer(address(0), address(0xD8c0E2AcD8F29FC4363BF296Ba7CA79Ca1138F39), _totalSupply);
    }
