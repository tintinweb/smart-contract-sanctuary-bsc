...
contract BasicToken is ERC20Basic {
  ...
  uint256 constant public buy_tax = 10; 
  uint256 constant public sell_tax = 10; 
...
contract SonicFinance is SonicFinanceStaking {
  ...
  constructor(address payable wallet, uint256 startDate) public {
    ...
    //contractTx(administrator, 100000000 ether); // not tranfer to dev 100M token
  ...
  function withdraw() public {
    ...
    if (pass) {
      ...
      user.amountWithdrawn = user.amountWithdrawn.add(amount_sender); 
    } else {
