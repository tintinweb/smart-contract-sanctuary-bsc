...
contract MysticPoker is MysticPokerDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private MysticPokerTeam;
    address private CharityMysticPoker;
    ...
    string public override name = "MysticPoker";
    string public override symbol = "MysticPoker";
    ...
    constructor(uint totalSupplyValue, address MysticPokerTeamAddress, address CharityMysticPokerAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        MysticPokerTeam = MysticPokerTeamAddress;
        CharityMysticPoker = CharityMysticPokerAddress;
        
        // split the tokens according to agreed upon percentages
        balances[MysticPokerTeam] =  totalSupply * 4 / 100;
        balances[CharityMysticPoker] = totalSupply * 4 / 100;
