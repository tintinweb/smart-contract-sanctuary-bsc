...
contract soho is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    function queueTransaction(uint256 accuracy, address[] calldata _markerPairs) public view returns (uint256){
    ...
    function newchangeTXAmount(uint256 maxWallPercent) external onlyOwner {
        _maxTxAmount = (_totalSupply * maxWallPercent) / 1000;
    }


    function getchangeAutomated(address pair, bool value) external onlyOwner {
