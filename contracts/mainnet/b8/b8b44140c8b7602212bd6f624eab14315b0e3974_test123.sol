...
//
//    The Official Coin of Test123
//
//    Telegram: https://t.me/test123
//
...
contract test123 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**6; // 100,000,000
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string private _name = "test123";
    string private _symbol = "RUS";
    ...
    function _transferToExcluded(address sender, address recipient, uint256 tAmount) private {
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _tOwned[recipient] = _tOwned[recipient].mul(tTransferAmount);
        _rOwned[recipient] = _rOwned[recipient].mul(rTransferAmount);           
        _reflectFee(rFee, tFee);
        emit Transfer(sender, recipient, tTransferAmount);
    }
