...
contract sYugaToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Yuga", "sYuga", 9) ERC20Permit() {
    ...
    /**
        @notice increases sYuga supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sYuga
