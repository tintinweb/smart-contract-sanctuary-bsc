...
contract Test is IBEP20, Auth {
    ...
    address MarketingWallet = 0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6;
    address DevWallet       = 0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6;
    address CharityWallet   = 0xD9ee54C926a30Eb184f443a679A8c0AB520Ba7f6;
    ...
    uint256 public _maxWalletToken = 1000000000000 * (10 ** _decimals);
    ...
    uint256 public totalFee = marketingFee + liquidityFee + devFee + charityFee;
    ...
    function setTxLimit(uint256 amount) external authorized {
        _maxTxAmount = amount;
        require(amount > (_totalSupply/1000)*1, "Cannot set to zero");
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _charityFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        devFee = _devFee;
        charityFee = _charityFee;
        totalFee = _liquidityFee.add(_marketingFee).add(_devFee).add(_charityFee);
        feeDenominator = _feeDenominator;
        require(totalFee < 20);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _charityFeeReceiver) external authorized {
