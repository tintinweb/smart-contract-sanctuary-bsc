...
contract EscanorKun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EscanorKun";
    string private _symbol = "ESCANORKUN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x075C8d990662756EDb44B0e2645AF0dbdb689d5D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x075C8d990662756EDb44B0e2645AF0dbdb689d5D); // BuyBack Address
