...
contract SQUIDJIRU is ERC20, Auth {
    ...
    string constant _name = "SquidJiru";
    string constant _symbol = "SQDJRU";
    ...
    uint256 public swapThreshold = _totalSupply * 200 / 1000; //total amount of tokens contract will sell each time
    bool inSwap;
