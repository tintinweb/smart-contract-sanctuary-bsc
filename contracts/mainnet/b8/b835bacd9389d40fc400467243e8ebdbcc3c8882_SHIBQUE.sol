...
contract SHIBQUE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShibQueen";
    string private _symbol = "SHIBQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x052826aD1A807A2960dE67ed458450bF340063e9); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x5e629D1083fc47e23380f4fE52D99Be981c7C0C9); // Development Address
