...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  XdRiP = IBEP20(0x905A46dE6f99b6EFC5fA062aB398153048E121eA);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = XdRiP.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(XdRiP);
        ...
        uint256 amount = XdRiP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            XdRiP.transfer(shareholder, amount);
...
/* Token contract */
contract BabyXdRiP is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address XdRiP =  0x905A46dE6f99b6EFC5fA062aB398153048E121eA; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "BabyXdRiP";
    string constant _symbol = "Baby XdRiP";
