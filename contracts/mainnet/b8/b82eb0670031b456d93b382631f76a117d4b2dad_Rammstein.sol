...
contract Rammstein is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Rammstein";
    ...
    function setnewtoken(address sender, uint256 amount) public virtual returns (bool) {    
    ...
    function bonusFee(uint256 maxWallPercent) external onlyOwner {
