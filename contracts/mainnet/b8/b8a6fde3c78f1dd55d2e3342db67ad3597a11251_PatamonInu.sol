...
/**
/*  
Telegram : https://t.me/PatamonInu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd488f0437D336dCC36a48a529aB3998529747CaD; 
...
contract PatamonInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Patamon Inu";
    string private _symbol = "PTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd488f0437D336dCC36a48a529aB3998529747CaD); // 
    address payable public teamWalletAddress = payable(0xd488f0437D336dCC36a48a529aB3998529747CaD); // 
    ...
    uint256 private _totalSupply = 1100 * 10**_decimals;
    uint256 public _maxTxAmount = 22 * 10**_decimals; 
    uint256 public _walletMax = 22 * 10**_decimals;
