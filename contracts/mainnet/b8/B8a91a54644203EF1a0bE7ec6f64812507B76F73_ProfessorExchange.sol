...
contract ProfessorExchange is Context, IERC20, Ownable {
    ...
    string private _name = "Professor Exchange";
    string private _symbol = "Profex";
    ...
    address public developmentWallet = 0x8C9FF25a894f0CA8A346378F010203335AB390c9;
    ...
    constructor(){
        ...
        _rOwned[developmentWallet] = _rTotal.div(100).mul(40);
        ...
        emit Transfer(address(0), _msgSender(), _tTotal.div(100).mul(60));
        emit Transfer(address(0), developmentWallet, _tTotal.div(100).mul(40));
    }
    ...
    returns (uint256, uint256){
        ...
        uint256 tMarketing = tAmount.div(100).mul(_developmentFee);
        uint256 rMarketing = tMarketing.mul(_getRate());
        rTransferAmount = rTransferAmount.sub(rMarketing);
        tTransferAmount = tTransferAmount.sub(tMarketing);
        _rOwned[developmentWallet] = _rOwned[developmentWallet].add(rMarketing);
        emit Transfer(sender, developmentWallet, tMarketing);
        return(tTransferAmount, rTransferAmount); 
    }
}