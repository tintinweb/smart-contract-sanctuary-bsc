...
abstract contract RSunAuth {
    ...
    mapping(address => mapping(uint256 => bool)) public authorizations; // uint256 is permission index
...
contract Simba is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 10 * 10 ** 10 * (10 ** _decimals); // 100 billion
