...
contract GreenField is Context, IERC20, Ownable {
   
    using SafeMath for uint256;
    using Address for address;
   
    string private _name = "BNB GreenField";
    string private _symbol = "GreenField";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8459262F2930ACF69765Cbb3FA8A49D0F95C5a69); // Marketing Address
    address payable public teamWalletAddress = payable(0x8459262F2930ACF69765Cbb3FA8A49D0F95C5a69); // Team Address
    ...
    uint256 public _maxTxAmount =  100 *  10**9 * 10**_decimals;
    uint256 public _walletMax =  100 *  10**9 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap =  100 *  10**1 * 10**_decimals;
