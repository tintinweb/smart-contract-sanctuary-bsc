...
contract TestToken is Context, IERC20, Ownable {
    ...
    uint256 public _buyBonusFee = 0;
    
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMarketingFee = 0;
    uint256 public _sellBonusFee = 0;
    uint256 public _liquidityShare = 0;
    uint256 public _marketingShare = 0;
    uint256 public _bonusShare = 0;
 ...
 constructor () {
    ...
    _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyBonusFee);
    _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellBonusFee);
    _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_bonusShare);
 ...
 function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) 
{
 ...
 function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBonusTax) external onlyOwner() {
    _buyLiquidityFee = newLiquidityTax;
    _buyMarketingFee = newMarketingTax;
    _buyBonusFee = newBonusTax;
    _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyBonusFee);
 }
 function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBonusTax) external onlyOwner() {
    _sellLiquidityFee = newLiquidityTax;
    _sellMarketingFee = newMarketingTax;
    _sellBonusFee = newBonusTax;
    _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellBonusFee);
 }
 
 function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newBonusShare) external onlyOwner() {
    _liquidityShare = newLiquidityShare;
    _marketingShare = newMarketingShare;
    _bonusShare = newBonusShare;
    _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_bonusShare);
 }
 ...
 function setBot(address _address, bool _value) public onlyOwner{
