...
contract CEEKLandGate is ERC165, ReentrancyGuard, Context, IERC721TokenReceiver {
    ...
    function beforeBuyCheck0(uint256 tokenId, uint256 price, bytes memory ceekUserIdParam, EIP20 payment_token) private returns(bool) {
        bool result = false;
    ...
    function buy(uint256 tokenId, uint256 price, bytes memory ceekUserIdParam, EIP20 payment_token) public payable nonReentrant {
        ...
        bool resBeforeBuyCheck0 = beforeBuyCheck0(tokenId, price, ceekUserIdParam, payment_token);
