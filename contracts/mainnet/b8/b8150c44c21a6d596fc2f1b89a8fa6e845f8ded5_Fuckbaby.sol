...
/*
 Website: TBA
 TELEGRAM: https://t.me/fuckingbabydoge
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4D1c401655f62EAf94A94a4A1d46c858Ee12c66b; // owner address
...
contract Fuckbaby is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCKING BABYDOGE"; 
    string private _symbol = "FUCKBABY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1dd1F2EE220C42d28B8bf486709d1fc5e63FbB21); // Marketing Address
    address payable public teamWalletAddress = payable(0x4D1c401655f62EAf94A94a4A1d46c858Ee12c66b); // Team Address
