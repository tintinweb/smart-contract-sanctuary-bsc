...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x955b10931a1806878912E46e04a7Ff10776CB374; // owner address
...
contract BIRDMANCLASSIC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIRDMAN CLASSIC";
    string private _symbol = "BIRDMANC";
