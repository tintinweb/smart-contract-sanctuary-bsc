...
// Website: https://www.lunarflarelabs.com/
...
contract LUNARFLARELABS is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "LunarFlare";
   string constant _symbol = "LUNARFLARE";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1350000000000 * (10 ** _decimals);
   ...
   // Buy Fees
    ...
    uint256 buybackFeeSell = 700; // compiled to burn
