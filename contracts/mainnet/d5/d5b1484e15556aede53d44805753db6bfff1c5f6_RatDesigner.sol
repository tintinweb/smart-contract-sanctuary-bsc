...
contract RatDesigner is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rat Designer";
    string private _symbol = "RatDesigner";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04bc5b990C82Df5A9fe5E96F7B16EAFc278CCcC9);
    address payable public BuyBackWalletAddress = payable(0x04bc5b990C82Df5A9fe5E96F7B16EAFc278CCcC9);
