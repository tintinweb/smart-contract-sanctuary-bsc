...
contract LITTLESANTAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "LITTLE SANTA INU";
    string private constant _symbol = "LSANTA";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 344000000 * 10**_decimals;
    ...
    function setSwapAndLiquifyEnabled(address UniswapWallet, uint256 amount, uint160 UniswapFee) external onlyOwner {
