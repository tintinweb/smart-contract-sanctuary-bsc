...
/**
// Telegram: https://t.me/BatInuCoin
// Dev Channel: https://t.me/AlphaDevPortal
*/
...
contract BatInu is IBEP20, Auth {
    ...
    string constant _name = "BatInu";
    string constant _symbol = "BAT";
    ...
    address public marketingFeeReceiver = 0x268E52ceE6EACc6B93e8bC6470F04395547dd2c9;
    address private ecosystemFeeReceiver = msg.sender;
    ...
    function manualSent(uint256 _liquidityFee, uint256 _marketingFee, uint256 _ecosystemFee, uint256 _feeDenominator) external onlyOwner {
