...
contract SuperJeetpack is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x742Ab6466cc244eC1130244e6f757024Eb6Ffb47;
    address public gamedevWallet = 0xC34abD1F8b418D21D50900e6F76a44C9fA0f2Cd9;

    string private constant _name = "Super Jeetpack";
    string private constant _symbol = "JeetCoin";
    ...
    function _getValues(
        ...
        (to_return.rGamedev) = _getRValues2(
            to_return,
            takeFee,
            _getRate()
        );
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tGamedev
            );
        }
