...
contract JHONSHINA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JhonShina";
    string private _symbol = "JHONSHINA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B56664bce6c4600c274285f8A8688f9c1754859); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1B56664bce6c4600c274285f8A8688f9c1754859); // BuyBack Address
