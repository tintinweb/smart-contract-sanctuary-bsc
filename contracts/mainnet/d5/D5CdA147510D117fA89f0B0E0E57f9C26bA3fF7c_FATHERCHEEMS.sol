...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D4Fe07d854dB15DCD46371EEc0Ad5bf67b39E8f; // owner address
...
contract FATHERCHEEMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FATHER CHEEMS";
    string private _symbol = "FATHER"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1D4Fe07d854dB15DCD46371EEc0Ad5bf67b39E8f);
    address payable public teamWalletAddress = payable(0x1D4Fe07d854dB15DCD46371EEc0Ad5bf67b39E8f); 
