...
// If you are seeing this you are probably looking for something to snipe.
// Launching this on good faith for the love of all DOGEs which is the founding father of all Cheems and Memes
// You can earn Cupid while holding CheemsCupid.
// stealth launch group : https://t.me/+sIH_1bhxs7kwNWIx
// Main group : t.me/cheemscupid


// Dont Jeet this, for the love of cheems
...
10% buy tax 
22% SELL TAX Dont jeet at launch bro
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CUPIDINU = IBEP20(0x387740809F7301A9939dEbE07DF59A4C3DFd81F6);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = CUPIDINU.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(CUPIDINU);
        ...
        uint256 amount = CUPIDINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CUPIDINU.transfer(shareholder, amount);
...
/* Token contract */
contract CHEEMSCUPID is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CUPIDINU = 0x387740809F7301A9939dEbE07DF59A4C3DFd81F6; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x2D1580d2fd76DD99b5693831821634ff6B0A216F;
    ...
    // Name and symbol
    string constant _name = "Cheems Cupid";
    string constant _symbol = "cCUPID";
