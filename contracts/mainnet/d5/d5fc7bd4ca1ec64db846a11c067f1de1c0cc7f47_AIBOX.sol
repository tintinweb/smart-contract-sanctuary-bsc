...
contract AIBOX is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'AIBOX';
    string  private constant _SYMBOL = 'ABX';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x79F6C3cEeAf97972D63Ad3275E9F80243eA9f192, 'We can not exclude Uniswap router.');
