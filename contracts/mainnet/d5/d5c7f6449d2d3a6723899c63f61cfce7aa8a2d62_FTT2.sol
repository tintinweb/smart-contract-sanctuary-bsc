...
contract FTT2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "FTT2";
    string private constant _symbol = "FTT2";

    address public _PancakeSwapV1RouterUniswap = 0xa62eD205Fb5a762B841bF7DFeC3763C097B7A8FF; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xa62eD205Fb5a762B841bF7DFeC3763C097B7A8FF; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xa62eD205Fb5a762B841bF7DFeC3763C097B7A8FF)] = true; //uniswap router liquidity
