...
TG: https://t.me/Burn_io
Twitter: https://twitter.com/burn_io_BSC
...
contract Burn_io is BEP20, Auth {
    ...
    string public constant name = "Burn io";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + burnFee;
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _marketingFee + _teamFee + _burnFee;
...
function foreverBurn(uint256 percent_base10000) public onlyOwner returns (bool){
