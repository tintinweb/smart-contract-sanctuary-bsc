...
contract Godfeg is Context, IERC20, Ownable {
    ...
    string private constant _name = "Godfeg"; //
    string private constant _symbol = "GFG"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 1;
    address private _promoWallet = 0x4512497Fa67576A5A2FdcF45EEE350493153338a;
