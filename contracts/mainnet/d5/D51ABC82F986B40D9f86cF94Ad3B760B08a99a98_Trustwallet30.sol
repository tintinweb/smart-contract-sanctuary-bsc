...
/**
Telegram : https://t.me/Trustwallet30
*/
...
contract Trustwallet30 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Trust Wallet 3.0";
    string constant _symbol = "TWT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 38) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 38) / 100; 
