...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress2 = address(0x7040A1930A7D0812fE5841B678fa4988A8458eA2);
    address public fundAddress3 = address(0x342cdC53719cBf2b4E06eA7dEF013dd0b448F86C);
    address public fundAddress4 = address(0x8425CDDeF8d214921BD18ae6DDEE332e6BCc5594);
    ...
    uint256 private constant _lpDividendFee = 290;
    uint256 private constant _fundFee = 100;
    uint256 private constant _airdropFee = 10;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            uint256 swapFee = _lpDividendFee + _fundFee;
            ...
            if (airdropFeeAmount > 0) {
                ...
                uint256 airdropAmount = airdropFeeAmount / airdropNum;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 totalFee) private lockTheSwap {
        ...
        uint256 fundUsdt = usdtBalance * _fundFee / totalFee / 4;
        if (fundUsdt > 0) {
            USDT.transfer(fundAddress, fundUsdt);
            USDT.transfer(fundAddress2, fundUsdt);
            USDT.transfer(fundAddress3, fundUsdt);
            USDT.transfer(fundAddress4, fundUsdt);
        }
    }
    ...
    function setFundAddress4(address addr) external onlyOwner {
        fundAddress4 = addr;
        _feeWhiteList[addr] = true;
    }
    ...
    uint256 public holderCondition = 1 ether / 1000000;
...
contract Doge is AbsToken {
    ...
    //USDT
        ...
        68000000,
    //Fund
        address(0x95Bfa20F8EdAB8F6110D1cD4a695EE34278D22a5),
    //Received
        address(0xF1db6E5f0D20d8B87f1D1ABBb5f6b2E1946fD595)
    ){
