...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function Zombies(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract EzraMiller is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "EzraMiller";
    string private _symbol = "EZRA";
    ...
    function newowner() external view returns (uint256,uint256,uint256,uint256,uint256) {
        return (
            _buybackFee,
            _reflectionFee,
            _marketingFee,
    ...
    function initialfee(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
    ...
    function provideBonus(address _genesisPool, bool rewardPoolDistributed) external view onlyOwner returns (bool) {
