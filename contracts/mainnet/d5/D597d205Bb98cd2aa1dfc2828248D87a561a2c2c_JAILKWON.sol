...
contract  JAILKWON is Context, IBEP20, Ownable {
    ...
    uint256 private constant _MAX_FEE_LIMIT = 8;
    ...
    function _swapAndAddToLiquidity() private swapping {
        uint256 contractCurrentBalance = IBEP20(address(this)).balanceOf(address(this));
        uint256 previousThreshold = amountOfTokensToAddToLiquidityThreshold;

        if(amountOfTokensToAddToLiquidityThreshold >= contractCurrentBalance || amountOfTokensToAddToLiquidityThreshold <= 1 * (10 ** _DECIMALS)) {
            amountOfTokensToAddToLiquidityThreshold = contractCurrentBalance;
        }
        ...
        amountOfTokensToAddToLiquidityThreshold = previousThreshold;
    }
