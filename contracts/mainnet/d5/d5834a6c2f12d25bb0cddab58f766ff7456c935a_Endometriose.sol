...
contract Endometriose is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Endometriose";
    ...
    function reducedata(uint256 _rTotal, uint256 _tTotal) private pure returns(uint256, uint256) {
	...
	function newAddress(uint256 _amount, uint256 _devFee) private pure returns (uint256) {
