...
// File: mintpass/erc721/ERC721Whitelist.sol
...
// File: mintpass/erc721/ERC721Reservable.sol
...
// File: mintpass/erc721/ERC721Base.sol
...
/**
 * @title Yugeno Labs Mint Pass Contract
 */
contract YugenoLabsMintPass is ERC721Base, ERC721Reservable, ERC721Whitelist, ReentrancyGuard {
    ...
    uint256 public immutable maxMintsPerWallet = 10;
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(tokensMinted[msg.sender] + _amount <= maxMintsPerWallet, "Only 2 mints allowed per wallet");
    ...
    function mintFor(address _to, uint256 _amount) external payable {
        ...
        require(tokensMinted[_to] + _amount <= maxMintsPerWallet, "Only 2 mints allowed per wallet");
