...
contract dragonix  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88e10AcC0FC204e492a863d3C8F65f230Bc467a1); 
    address payable public Wallet_Dev = payable(0xD85e7F86e5977A8f01026FDa7446fD11A5B00a53);
    ...
    string private constant _name = "DRAGONIX"; 
    string private constant _symbol = unicode"$GONIX"; 
    ...
    constructor () {
        ...
        _owner = 0xD85e7F86e5977A8f01026FDa7446fD11A5B00a53;
    ...
    function _setFees(uint256 Buy_Fee, uint256 Sell_Fee) external authorized() {
