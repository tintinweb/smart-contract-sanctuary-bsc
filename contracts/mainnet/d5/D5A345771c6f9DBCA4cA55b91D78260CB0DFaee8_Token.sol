...
contract Token {
    ...
    string public name = "Steel Meta";
    string public symbol = "STEEL";
    uint public qtdTokens = 1000000000; // 1 bilhão de Tokens
    uint public qtdDecimals = 9;

    event Transfer(address indexed from, address indexed to, uint value);
    event Approval(address indexed owner, address indexed spender, uint value);

    uint public totalSupply = qtdTokens * 10 ** qtdDecimals;
    uint public decimals = qtdDecimals;
