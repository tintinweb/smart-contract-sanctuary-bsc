...
contract Shirokuma is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shirokuma";
    string private _symbol = "Shirokuma";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75B0E5D97CFAE0E625398FbB9E85969DE33D026c); 
    address payable public buyBackWalletAddress = payable(0x75B0E5D97CFAE0E625398FbB9E85969DE33D026c); 
    ...
    uint256 private minimumTokensBeforeSwap = 1500 * 10**9; 
