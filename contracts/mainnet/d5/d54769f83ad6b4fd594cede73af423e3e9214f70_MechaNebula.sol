...
contract MechaNebula is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mecha Nebula";
    string private _symbol = "Mecha Nebula";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3adB6448740412e6016eE1C52323cb7933900e2e); // Marketing
    address payable public BuyBackWalletAddress = payable(0x966Cd3546baC52Cc584Aad021142bA673efA1802); // BuyBack 
