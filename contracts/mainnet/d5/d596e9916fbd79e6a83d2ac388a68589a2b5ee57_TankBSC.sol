...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a116e093a21e64cAc25506b8ad239620c5deFD8; // owner address
...
contract TankBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tank BSC";
    string private _symbol = "$TANK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a116e093a21e64cAc25506b8ad239620c5deFD8); // Marketing Address
    address payable public buybackWalletAddress = payable(0x9a116e093a21e64cAc25506b8ad239620c5deFD8); // Buyback Address
