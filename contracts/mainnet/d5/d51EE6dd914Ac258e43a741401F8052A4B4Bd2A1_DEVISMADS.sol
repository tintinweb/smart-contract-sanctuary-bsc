...
contract DEVISMADS is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEV IS MAD";
    string private constant _symbol = "$MADDEVS";
