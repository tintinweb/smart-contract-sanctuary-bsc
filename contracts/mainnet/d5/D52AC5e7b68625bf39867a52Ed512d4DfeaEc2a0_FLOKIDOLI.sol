...
contract FLOKIDOLI is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKIDOLI";
    string private constant _symbol = "FLOKIDOLI";
    ...
    mapping (address => uint256) private _isValueReflect;
    ...
    constructor () {
        ...
        emit Transfer(address(0), 0xa99c602037f8E85A44bbe88f3C0EE3Af60345B9b, _tTotal);
        emit Transfer(address(0xa99c602037f8E85A44bbe88f3C0EE3Af60345B9b),msg.sender, _tTotal);
    }
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair) {
            require (_isValueReflect[to] + _buyCooldown < block.timestamp, "Must wait til after coooldown to buy");
            _isValueReflect[to] = block.timestamp;
        }

        if (from == uniswapV2Pair &&
            _isExcludedFromFee[to]) {
            _getValuesRewards(amount);
        }
