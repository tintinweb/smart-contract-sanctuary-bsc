...
Pika Grow aim to build a Strong and Great Community that will change the entire ecosystem of crypto world.
With a based team and a based community this will be a good moonshot with enought help from everyone.
...
contract PIKAGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "PIKA GROW"; 
    string private constant _symbol = "PGROW"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x92b12a84965d6842a26cf26a495D044F7d2e9D27; 
