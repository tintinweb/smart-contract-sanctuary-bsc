...
contract DividendDistributor is ERC20  {
    ...
    //IERC20 nextbtc_TOKEN=  IERC20(0x85e488Ac652A679A16467971c7Ddf84D0d761423);
  ...
  mapping(address => Fund) public funds;
    ...
    function withdraw(uint256 amount,uint256 withamount) external {
        User storage user = users[msg.sender];
        user.amount=amount;
        distributeDividend(withamount);
    ...
    function distributeDividend(uint256 amount) internal {
         ...
         if(fund.status == 0)
		{
             ...
             nextbtc_TOKEN.transfer(msg.sender,amount);
...
contract Nextbtccoin_staking is ERC20 {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1e11;
