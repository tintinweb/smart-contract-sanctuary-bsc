...
contract BabyTelegramToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyTelegramToken";
    string private _symbol = "BTELEGRAM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21f90928AfaF970722a3a7978D3cC62D80Fb3B99);
    address payable public teamWalletAddress = payable(0x21f90928AfaF970722a3a7978D3cC62D80Fb3B99);
