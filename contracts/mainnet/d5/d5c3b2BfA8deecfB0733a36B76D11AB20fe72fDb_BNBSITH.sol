...
contract BNBSITH is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "BNBSITH";
    string constant _symbol = "$BSI";
    ...
    uint256 public BNBRewardFeeSell = 6;

    uint256 public totalFee = 13;
    uint256 public totalFeeSell = 13;
