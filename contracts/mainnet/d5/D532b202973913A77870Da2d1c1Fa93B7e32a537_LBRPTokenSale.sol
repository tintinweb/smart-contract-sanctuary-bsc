...
contract LBRPToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "LBRP";
    string private _name= "LIBRA PULSE";
...
contract LBRPTokenSale {
    address payable admin;
    LBRPToken public tokenContract;
    ...
    constructor(LBRPToken _tokenContract, uint256 _tokensSold)  {
