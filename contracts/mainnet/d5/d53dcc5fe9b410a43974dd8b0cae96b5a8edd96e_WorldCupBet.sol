...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0Fc83bd46F73246eA6934E73BAff3C2F4dfC5441; // owner address
...
contract WorldCupBet is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "WCB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF34D221b0659bD865ffec66F8Bd21f49c9605fd4); // Marketing Address
    address payable public teamWalletAddress = payable(0x0Fc83bd46F73246eA6934E73BAff3C2F4dfC5441); // Team Address
