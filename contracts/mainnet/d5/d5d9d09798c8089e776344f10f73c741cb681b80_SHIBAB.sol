...
contract SHIBAB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Binance Account Bound Token";
    string private _symbol = "SHIBAB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBd08ef74fcb49A7023f6624A2355C577Ae6D7220); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xBd08ef74fcb49A7023f6624A2355C577Ae6D7220); // Team Address
