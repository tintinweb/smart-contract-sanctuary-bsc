...
/**
    Starbucks USDT REWARDS
    Telegram : https://t.me/StarbucksToken
    Twitter : https://twitter.com/StarbucksBSC 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    //u1
    IBEP20 USDTpeg = IBEP20(0x55d398326f99059fF775485246999027B3197955);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = USDTpeg.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(USDTpeg);
        ...
        uint256 amount = USDTpeg.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            USDTpeg.transfer(shareholder, amount);
...
//u2
contract StarbucksCrypto is IBEP20, Auth {
    using SafeMath for uint256;

    address USDTpeg = 0x55d398326f99059fF775485246999027B3197955;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Starbucks";
    string constant _symbol = "STARBUCKS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 120000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
		 
    uint256 public _maxWalletToken = _totalSupply / 40; // holder max wallet: 2.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x686C30D312144425E3A97b617bC37D1eeDbae913;
        ...
        marketingFeeReceiver = 0x686C30D312144425E3A97b617bC37D1eeDbae913;
