...
contract ZBIT is IERC20,Context,Ownable,Pausable{
    ...
    uint256 public AllTotal = (6*24*365*4*9*100) * 10**18;//All Total Supply
    // 50% totalSupply In BNB Network , 18% totalSupply in ETH , 16% totalSupply in MATIC , 16% totalSupply in TRX

    uint256 public _tTotal = (AllTotal*50)/100;
    ...
    address public CharityWallet = 0x2D422F7b379432328EF261b3D90cc23a2119b76c;
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal/2 ;
    ...
    function mint(uint256 total) private onlyOwner() {
        _tTotal = _tTotal.add(total);
        _rOwned[owner()] = _rOwned[owner()].add(total);
    }
    /////////////
    ...
    function setSwapLock(bool _enable) public onlyOwner{
        inSwapAndLiquify = _enable;
    }
