...
contract Babywater is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Water Tiger";
    string private _symbol = "BABYWTT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeE3d36463ee4c7c2109d21B1d2e0Da00Bb508F8C); 
    address payable public teamWalletAddress = payable(0x7ff0d73956436E00681B78F1688FeA087e028303); 
