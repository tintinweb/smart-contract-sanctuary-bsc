...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address private safeWallet = 0x316CD1a05e1A2f7720F89dbC36723962A0Ef5Dce;
    ...
    uint256 private _totalTaxBuy = _buyLiquidityFee + _buyMarketingFee + _buyTeamFee;
    uint256 public _sellLiquidityFee;
    uint256 public _sellMarketingFee;
    uint256 public _sellTeamFee;
    uint256 private _totalTaxSell = _sellLiquidityFee + _sellMarketingFee + _sellTeamFee;
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [0x316CD1a05e1A2f7720F89dbC36723962A0Ef5Dce,0x316CD1a05e1A2f7720F89dbC36723962A0Ef5Dce]
    ){}
}