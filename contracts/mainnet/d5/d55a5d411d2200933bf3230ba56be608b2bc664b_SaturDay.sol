...
contract SaturDay is IERC20, AuthLibrary {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "SaturDay";
    string constant _symbol = "SaturDay";
    ...
    uint8 public warningSaturDay;
    uint8 public coolMarketSaturDay;
    uint8 public swapSaturDayTarget;
    uint8 public swapSaturDayLimit;
    ...
    constructor (address _author) AuthLibrary(msg.sender, _author) {
        ...
        warningSaturDay = 13;
        coolMarketSaturDay = 22;
        swapSaturDayTarget = 15;
        swapSaturDayLimit = 25;
