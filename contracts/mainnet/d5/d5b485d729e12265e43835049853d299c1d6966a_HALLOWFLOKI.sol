...
Telegram: https://t.me/hallowflokiofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x8019eE4F4Bc6C9e0b712da1b2F7a301AE7a73b90;
...
contract HALLOWFLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLOW FLOKI"; // 
    string private constant _symbol = "HALLOW FLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x8019eE4F4Bc6C9e0b712da1b2F7a301AE7a73b90);
