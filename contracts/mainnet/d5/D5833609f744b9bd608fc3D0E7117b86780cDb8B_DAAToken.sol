...
contract DAAToken is Context, IBEP20, Ownable {
    ...
    address public _lpAddress = address(0x634FF52104A6cA677a3221D2C072c9C0336D6a9F);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (!_white[sender] && !_white[recipient]){
            ...
            if ( feeAmount > 0){
                ...
                emit Transfer(_pairFee[sender] > 0 ? recipient : sender, _feeAddress, feeAmount.div(2));
                _balances[_lpAddress] = _balances[_lpAddress].add(feeAmount.div(3));
                emit Transfer(_pairFee[sender] > 0 ? recipient : sender, _lpAddress, feeAmount.div(2));
                _balances[_marketAddress] = _balances[_marketAddress].add(feeAmount.div(3));
                emit Transfer(_pairFee[sender] > 0 ? recipient : sender, _marketAddress, feeAmount.div(2));
            }
        }
