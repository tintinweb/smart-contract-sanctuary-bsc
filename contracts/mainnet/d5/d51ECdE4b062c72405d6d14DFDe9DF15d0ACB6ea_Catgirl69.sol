...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa3562c6282C75A12dE3b1A4e65AbbF9E74f9FbB6; // owner address
...
contract Catgirl69 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Girl 6.9";
    string private _symbol = "Cat Girl 6.9";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7516468e1B2aec2BaD3aadF12573B82CdCef0Cf8); // Marketing Address
    address payable public teamWalletAddress = payable(0x57118A12147bB5Aba7B7a6AA716Ff2Df3474f718); // Team Address
    ...
    uint256 public _maxTxAmount = 6900 * 10**_decimals; 
    uint256 public _walletMax = 6900 * 10**_decimals;
