...
contract QuackInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Quack Inu";
    string private _symbol = "$QUACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB0bbf2b4036192C887B611C57FDd3ed681D211d); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbB0bbf2b4036192C887B611C57FDd3ed681D211d); // BuyBack Address
