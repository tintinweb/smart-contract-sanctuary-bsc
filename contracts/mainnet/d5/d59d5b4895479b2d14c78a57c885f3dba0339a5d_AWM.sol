...
contract AWM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AWM Inu";
    string private _symbol = "AWM";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address OBD
    address payable public BuyBackWallet = payable(0xA598b4cEb900D08CBB7c29b9a2846B5a045371b3); // Team Address
