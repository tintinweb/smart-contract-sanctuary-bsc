...
contract BUSDWEEDv2 is Initializable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function initialize() public initializer {
        __Ownable_init();
        BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /* Binance: BUSD Stablecoin */
        BusdInterface = IERC20(BUSD);
        min = 1 ether; // 1 BUSD
        max = 100000 ether; // 100k BUSD
        roi = 25;
        fee = 3;
        withdraw_fee = 3;
        ref_fee = 15;
    ...
    function deposit(address _ref, uint256 _amount) public nonReentrant {
        ...
        require(
            ...
            "Amount must be between 10 and 100000 BUSD"
        );
    ...
    function getUserBalance(address _user) public view returns (uint256) {
        return BusdInterface.balanceOf(_user);
    }
}