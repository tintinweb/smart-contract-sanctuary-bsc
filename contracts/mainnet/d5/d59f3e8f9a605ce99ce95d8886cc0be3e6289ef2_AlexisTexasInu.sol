...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1511B2Ed226455dc07975A10D735e3c69d0d593c; // owner address
...
contract AlexisTexasInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alexis Texas Inu";
    string private _symbol = "$ALEXIS"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB53459253636F31ff9FAf0B6C7AD097FF5e02A1); // Marketing Address
    address payable public teamWalletAddress = payable(0xA903e9Eeca1655AdDb3F170678FB80202d23A294); // Team Address
