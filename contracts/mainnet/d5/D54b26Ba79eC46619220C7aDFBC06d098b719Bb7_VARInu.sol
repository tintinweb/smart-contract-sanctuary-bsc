...
/**
VAR Inu Smart Contract on Binance Smart Chain
...
contract VARInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    VARInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("VAR Inu", "VAR") {
        marketingWallet = payable(0xAF8930041865e06D43e8436E8c3e72aD36B0bBe0);
        devWallet = payable(0x751710fA46A60651d33871E751D7F5AA3A727469);
        ...
        dividendTracker = new VARInuDividendTracker(
            payable(this),
            router,
...
contract VARInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        VARInuContract = VARInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "VARInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "VARInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main VARInu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(VARInuContract);

            uint256 prevBalance = VARInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = VARInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    VARInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
