...
/*
Telegram : https://t.me/ncoinchannel
Website : https://ncoin.network
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5ea157A140e629e33e13AFfA3C07E3150D9E30C5;
...
contract NCoin is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0x5ea157A140e629e33e13AFfA3C07E3150D9E30C5);
    ...
    */
    ...
    uint256 private _tTax = 30;
    uint256 public _bTax = 10;
    uint256 public _sTax = 30;


    // 'Previous fees' are used to keep track of fee settings when removing and restoring fees
    uint256 private _previousTotalFee = _tTax; 
    uint256 private _previousBuyFee = _bTax; 
    uint256 private _previousSellFee = _sTax; 
    ...
    */
    ...
    uint256 public _maxWallet = _tTotal.mul(1).div(1000);
    uint256 private _pMaxW = _maxWallet;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTx = _tTotal.mul(1).div(1000); 
    uint256 private _pMaxT = _maxTx;
    ...
    */
    ...
    function _setFeeT(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    // Update main wallet
    function Update_Wallet_Dev(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    function set_Max_Tx(uint256 maxTxPercent) external onlyOwner() {
        _maxTx = _tTotal*maxTxPercent/100;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wl(uint256 maxWallPercent) external onlyOwner() {
    ...
    function removeAllFee() private {
        if(_tTax == 0 && _bTax == 0 && _sTax == 0) return;


        _previousBuyFee = _bTax; 
        _previousSellFee = _sTax; 
        _previousTotalFee = _tTax;
        _bTax = 0;
        _sTax = 0;
        _tTax = 0;
    ...
    _tTax = _previousTotalFee;
    _bTax = _previousBuyFee; 
    _sTax = _previousSellFee; 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_tTax = _bTax;} else if (to == uniswapV2Pair){_tTax = _sTax;}
    ...
    */
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tDev = tAmount*_tTax/100;
