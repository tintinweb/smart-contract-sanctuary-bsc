...
contract FINDDOKWON is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Find Dokwon";
    string private constant _symbol = unicode"FINDDOKWON";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0xf26a2E60A09a0850A07ae6B21c66d5Dc9d76Ce2f);
    address payable public MarketingWallet = payable(0xEDe47deb31b56F21eBE919059A0734DEc8A62ad5);
