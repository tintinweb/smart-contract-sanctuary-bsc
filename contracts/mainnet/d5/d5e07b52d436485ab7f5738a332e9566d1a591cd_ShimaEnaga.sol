...
// Telegram : https://t.me/Shimaenagabsc
// Web : https://shimaenagatoken.com
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75e97859a8FA5670a15DAb3bB8A7CC3a9f611242; // owner address
...
contract ShimaEnaga is Context, IERC20, Ownable {
    ...
    string private _name = "SHIMA ENAGA";
    string private _symbol = "$SHIMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x75e97859a8FA5670a15DAb3bB8A7CC3a9f611242); // Marketing Address
    address payable public teamWalletAddress = payable(0x75e97859a8FA5670a15DAb3bB8A7CC3a9f611242); // Team Address
