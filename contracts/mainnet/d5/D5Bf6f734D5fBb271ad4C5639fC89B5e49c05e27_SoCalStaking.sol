...
contract SoCalStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    address public taxAddress = 0x6A72934d2c454227E6364DF775e9c2e5a8e2D6c3;
    ...
    function stakeSoCal(uint256 _amount, uint256 _locktime) public {
        ...
        uint256 tax = _amount.mul(Tax).div(10**2);
        _amount = _amount - tax; 
        ...
        IERC20(STAKECONTRACTADDRESS).transferFrom(msg.sender,taxAddress ,tax);
