...
contract DutyOfLeader is Context, IERC20, Ownable {
    ...
    string private _name = "The duty of a leader";
    string private _symbol = "DutyOfLeader";
    ...
    uint256 public _buyLiquidityFee = 8; //MARKETING 1% + BUYBACK 1%
    
    uint256 public _sellTaxFee = 2; //TO HOLDER
    uint256 public _sellLiquidityFee = 8; //MARKETING 1% + BUYBACK 1%
    ...
    uint256 public marketingDivisor = 7; //% FROM %LP
    
    uint256 public _maxTxAmount = 1000000 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100000 * 10**9 * 10**9; 
    uint256 public buyBackSellLimit = 10000 * 10**9;
