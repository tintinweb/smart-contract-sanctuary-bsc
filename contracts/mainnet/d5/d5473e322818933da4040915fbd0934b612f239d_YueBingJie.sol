...
contract YueBingJie is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "YueBingJie";
    string private _symbol = "YUE";
    ...
    function initialfee(uint256 _maxHold) public view returns(uint256) {
