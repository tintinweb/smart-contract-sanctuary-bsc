...
░░░░░░░░░░   ░░░░░  ░░░░░░░░ ░░░░░ ░░░ ░░░░░  ░░░░░░  ░░░░ ░░░░░  ░░░░░░░░    ░░░░░   ░░░░ ░░░░░ ░░░░░░  ░░░░ ░░░░░   ░░░░░░░░ 
   ...
   Website: https://diamondkishu.com/
   Telegram: https://t.me/dkishutest
...
contract DiamondKishu is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress = payable(0x1962C0e710Eda8981383F34E82887EC6201c33E3);
    address payable public buyBackAddress = payable(0x000000000000000000000000000000000000dEaD);

    uint256 public numTokensToSell = 500 * 10**6 * 10**9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    string private constant _name = "Diamond Kishu Inu";
    string private constant _symbol = "DMNDKISHU";
    ...
    uint256 public _treasuryFee = 200;
    uint256 private _prevTreasuryFee = _treasuryFee;

    uint256 public _buyBackFee = 100;
    ...
    uint256 private constant MIN_BUY_AMOUNT = 3 * (10 ** 18); // 3 bnb
    ...
    event SwapForTreasury(uint256 amount);
    ...
    event SetFees(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newTreasuryFee, uint256 newBuyBackFee);
    ...
    constructor () public {
        ...
        _totalLiqFee = _liquidityFee.add(_treasuryFee).add(_buyBackFee);
    ...
    function rescueDMNDKISHU(uint256 amount) public onlyOwner returns (bool) {
   ...
   function setFees(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newTreasuryFee, uint256 newBuyBackFee) external onlyOwner() {
        require( (newRewardFee.add(newLiquidityFee).add(newTreasuryFee).add(newBuyBackFee)) <= 1000, "Total fees must be <= 1000" );
        ...
        emit SetFees(newRewardFee, newLiquidityFee, newTreasuryFee, newBuyBackFee);
    }
    ...
    function setSpecialFee(address from, address to) private returns (bool) {
        ...
        uint256 totalFee = _taxFee.add(_liquidityFee).add(_treasuryFee).add(_buyBackFee);
        if( totalFee == 0 ) {
        ...
        _treasuryFee = fee.mul(_treasuryFee).div( totalFee );
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _treasuryFee > 0) 
        {
            // sell tokens for BNB and send to DAO Treasury
            uint256 initialBalance = address(this).balance;
            swapTokensForBNB(forWallets);

            uint256 newBalance = address(this).balance.sub(initialBalance);
            transferToAddressBNB(treasuryAddress, newBalance);

            emit SwapForTreasury(newBalance);
        }
