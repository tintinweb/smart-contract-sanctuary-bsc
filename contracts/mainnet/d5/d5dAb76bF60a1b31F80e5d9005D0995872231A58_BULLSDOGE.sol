...
/**
BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE 
BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE
BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE BULLS DOGE
🔥🦬🐶 BULLS DOGE🐶 🦬🔥
...
contract BULLSDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    mapping(address => uint256) private _rOwned;
    mapping(address => uint256) private _tOwned;
    mapping(address => bool) private _BannedBot;
    ...
    uint256 private _tTotal = 6900000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    address payable private marketingAddress =
        payable(address(0x07c84674ed36DECc6A0628aBC278119511Fd1964));
    address payable private devWallet =
        payable(address(0x07c84674ed36DECc6A0628aBC278119511Fd1964));
    address private liquidityReceiver =
        0x07c84674ed36DECc6A0628aBC278119511Fd1964;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "BULLS DOGE";
    string private _symbol = "BULDOG";
    ...
    BuyFee private buyFee;
    SellFee private sellFee;
    ...
    bool public TradingIsOn = false;
    mapping(address => bool) public AcceptedOnTrading;

    uint256 public _maxTxAmount = 345000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 34500000 * 10**9;
    uint256 public _maxWalletSize = 345000000 * 10**9;
    ...
    function BannedBot(address account, bool value) external onlyOwner{
        _BannedBot[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!_BannedBot[from] && !_BannedBot[to], 'Blacklisted address');
        ...
        if (TradingIsOn && from == uniswapV2Pair && !_isExcludedFromFee[to]) {
