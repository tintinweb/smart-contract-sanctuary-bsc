...
TELEGRAM : https://t.me/setokaibainujapan
*/
...
contract SETOKAIBAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SETO KAIBA INU";
    string private constant _symbol = "$SETOKAIBAINU";
