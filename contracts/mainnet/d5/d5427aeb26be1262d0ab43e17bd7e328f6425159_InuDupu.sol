...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);  // BUSD
...
/* Token contract ------------------------------------------------------------------------------------- */   
contract InuDupu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xa9Cb43d1958197FEEbA97832DfA2f4918384d117;  // DEV WALLET
    ...
    // Name and symbol
    string constant _name = "Inu Dupa";
    string constant _symbol = "INDU";
    ...
    uint256 public marketingFeeBuy = 800;
    uint256 devFeeBuy = 0;
    uint256 public totalFeeBuy = 120;
  ...
  // Sell fees
    ...
    uint256 public totalFeeSell = 250;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x139830C7F01d14F2Dd22d957914Efd696BBd99f2; // MARKETING WALLET
