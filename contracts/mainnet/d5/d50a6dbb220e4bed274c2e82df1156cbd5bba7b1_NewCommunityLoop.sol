...
/*
    ...
    Take a journey with us on millions market cap!
    Get in early for an easy 1000X.

    Telegram : https://t.me/NewCommunityLoop
*/
...
contract NewCommunityLoop is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "New Community Loop";
    string private _symbol = "ncLoop";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA657C652028A89CdBF08184d40A486fa7bd09473); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xA657C652028A89CdBF08184d40A486fa7bd09473); // Development Address
