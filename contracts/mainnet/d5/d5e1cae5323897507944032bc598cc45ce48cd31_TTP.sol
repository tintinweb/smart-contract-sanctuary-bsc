...
*/
/**
Hi, ill do 1/1 fee to liq and lock. I hope we can catch eth version.
*/
...
contract TTP is Context, IERC20, Ownable {
    ...
    string private _name = "The Tennis Protocol";
    string private _symbol = "TTP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x846dEe416C889d22Df9A1B3d2B1B16599DeEFd6b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x846dEe416C889d22Df9A1B3d2B1B16599DeEFd6b); // BuyBack Address
