...
Telegram: https://t.me/EggGrow

Egg Grow is Decentralized Meme with Auto-Compounding & Auto-Staking Protocol Providing Investors with profitable gains.

Egg Grow have Anti-Dump Mechanism Protocol implemented to Protect Investors Against pump & dump as well as and the sustainability of the protocol.


Key Features

Anti-Dump Protocol : Safe Guard Againts Pump & Dump
Insurance Low Risk Investment Protocol Backing Rebase Algorithm
Dexswap
...
contract EggGow is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = (_tTotal * 5) / 100; // 5%
    uint256 public maxSellLimit = (_tTotal * 5) / 100; // 5%
    uint256 public maxWalletLimit = (_tTotal * 5) / 100; // 5%
    
    uint256 private tTimer;
    
    address public marketingWallet = 0x7253cA275e44c54cD8900288F355EBe3cdfe50f4;
    address public devWallet = 0x01792A14A1e02985ac716683a3Ccd8FeF2ADd136; 
    ...
    string private constant _name = "Egg Grow";
    string private constant _symbol = "EggGrow";
    ...
    Taxes public taxes = Taxes(0, 8, 1, 0, 0, 0); // 9%
    Taxes public sellTaxes = Taxes(0, 8, 1, 0, 0, 0);// 9%
