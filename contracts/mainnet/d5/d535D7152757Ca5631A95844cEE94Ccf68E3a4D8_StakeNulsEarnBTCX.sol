...
contract StakeNulsEarnBTCX is ReentrancyGuard{
    address public owner;
    address payable public wallet;
    uint256 public baseFee = 2000000000000000; //wei

    uint256 public penalty = 5;
    uint256 public totalStakedAmount;
    uint256 public totalRewardSent;
    uint256 public totalStakers;
    uint256 public maxLimitPerUser = 200000000000;
    ...
    uint256 public rewardPerBlock = 4000000000000000000; //4 BTCX/Block
    uint256 public baseShare = 20000000000; //200 nuls
    ...
    function doStake(uint256 amount) external nonReentrant{
        ...
        require(stakeBalances[msg.sender] <= maxLimitPerUser, "limit reached");       
