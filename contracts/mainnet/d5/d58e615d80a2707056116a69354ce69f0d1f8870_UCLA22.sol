...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function AutoUCLA22upship(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract UCLA22 is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "UCLA22";
    string private _symbol = "UCLA22";
	...
	function getUCLA22Fees(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
