...
Telegram : https://t.me/CatcashOfficial
We on discord not on telegram!
Website: http://catcash.site/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BLST = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
/* Token contract */
contract CatCash is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BLST = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xFB75413D7C7555C086b0393c55Bd66B8bc4d1451;
    ...
    // Name and symbol
    string constant _name = "CatCash";
    string constant _symbol = "$CATSH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xb7799F585a37E21c6976f817E9c16Ef253585467;
