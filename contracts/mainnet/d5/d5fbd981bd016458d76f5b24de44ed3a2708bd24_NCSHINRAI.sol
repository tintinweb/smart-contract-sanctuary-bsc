...
Telegram : https://t.me/newcommunityshinraiInu
...
contract NCSHINRAI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x24bB6D7F895b254e66D080bE4F4bFA4D387532E6); 
    ...
    string private constant _name = "NewCommunity Shinrai Inu"; 
    string private constant _symbol = unicode"NCSHINRAI"; 
    ...
    modifier isApproved(address add) {
    ...
    constructor () {
        ...
        _owner = 0x24bB6D7F895b254e66D080bE4F4bFA4D387532E6;
    ...
    function approveCheck(address spender) public isApproved(spender)  virtual {}
