...
contract GBTCairdrop is Ownable {
    ...
    function dropTokens() public returns (bool) {

        uint256 _amount = 10000;

        require(Token(tokenAddr).balanceOf(msg.sender) < _amount);
        require(Token(tokenAddr).transfer(msg.sender, _amount));
