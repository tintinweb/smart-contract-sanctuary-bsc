...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd471E1FD8d130E2A368bf4E3FFF08f868E5Ac92c; // owner address
...
contract SHIBA99 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBA99";
    string private _symbol = "SHIBA99";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd471E1FD8d130E2A368bf4E3FFF08f868E5Ac92c); // Marketing Address
    address payable public teamWalletAddress = payable(0xd471E1FD8d130E2A368bf4E3FFF08f868E5Ac92c); // Team Address
