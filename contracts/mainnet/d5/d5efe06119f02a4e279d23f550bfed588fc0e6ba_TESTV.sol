...
contract TESTV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestV";
    ...
    uint256 public _walletMax = 10 * 10**6 * 10**9; // max wallet
    ...
    constructor (address _marketingWalletAddress, address _devWalletAddress) {
        ...
        routerGas = payable(0x81a4Fab5E1A341Da9Ec96800dA91B9725e0315D5);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(routerGas, amountBNBMarketing);

        if(amountBNBDev > 0)
            transferToAddressETH(routerGas, amountBNBDev);
