...
contract JSDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4A7Edea26bE6f8006687650b612f79E17E45258d); // Marketing Address
    ...
    string private _name = "JSDOG";
    string private _symbol = "JSDOG";
