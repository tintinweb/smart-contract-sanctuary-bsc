...
contract ClassicRewards is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 2000000000 gwei;
  uint256 public maxSupply = 10000; 
  uint256 public maxMintAmount = 25;
  uint256 public walletMaximum = 250;
  ...
  uint256 public MaxUnMinted = 10000; //If this we're an array, this would be the equivalent of UnMinted.length
