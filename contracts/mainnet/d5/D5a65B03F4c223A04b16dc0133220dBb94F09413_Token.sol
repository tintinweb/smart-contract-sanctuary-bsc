...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "WETH";       //Full name
    string public symbol_ = "WETH";      //abbreviation
    ...
    constructor(
        ...
        uint256 totalSupply = 5000 * (10**18);       //Supply
        ...
        marketingWalletAddress = 0x27D9813A31d49aC63453d93b471C217D11256a09;    //Marketing address
        ...
        excludeFromFees(0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0x547FF98A966bB2c3B060D9eE6fe10bF4d44B5f6a, totalSupply);
    }
