...
//Baby token for Maral. Rewards ca: 0x8b876e2d04f28ef36784874b7b2e048a4570c7bd
//2% rewards in mother token
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x8b876e2d04F28eF36784874B7b2E048A4570c7bd);
...
/* Token contract */
contract BabyMaral is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "BabyMaral";
    string constant _symbol = "$BMARA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x722E1DdF1604cc450e8fE41d438C308a740BA563;
