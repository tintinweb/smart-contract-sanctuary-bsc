...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7122e71a51b205686981df018fCb5295056752C; // owner address
...
contract SquidPepe is Context, IERC20, Ownable {
    ...
    string private _name = "SquidPepe";
    string private _symbol = "Spepe";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8f35D651549C21bfd3ab2f3c0e6d7b70b58Fe449); // Marketing Address
    address payable private teamWalletAddress = payable(0x8f35D651549C21bfd3ab2f3c0e6d7b70b58Fe449); // Team Address
