...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDDD0fA4c9BCd4F731B0deB9D2aa91635CB938276; // owner address
...
contract BABYFREEDOMPROTOCOL is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xDDD0fA4c9BCd4F731B0deB9D2aa91635CB938276);
    address payable public teamWalletAddress = payable(0xDDD0fA4c9BCd4F731B0deB9D2aa91635CB938276); 
