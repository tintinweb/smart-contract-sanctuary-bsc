...
contract SplashieGovernor is Governor, GovernorCompatibilityBravo, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("SplashieGovernor")
    ...
    function votingDelay() public pure override returns (uint256) {
        return 86400; // 3s * 20 = 60 per minute = 3600 per hour = 86400 per day
    }
