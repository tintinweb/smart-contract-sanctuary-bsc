...
contract PerryThePlatypus is Context, IBEP20, Ownable {
    ...
    string private _name = "Perry the Platypus";
    string private _symbol = "PPLATYS";
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(unirouter)) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        bool isBuy  = sender == uniswapV2Pair && recipient != address(unirouter);
