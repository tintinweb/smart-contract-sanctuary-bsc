...
// File: YellowRabbit.sol

// contracts/YellowRabbit.sol
...
contract YellowRabbit is ERC20Capped, ERC20Burnable {
    address payable public owner;
    uint256 public blockReward;


    constructor(uint256 cap, uint256 reward) ERC20("YellowRabbit", "YRAB") ERC20Capped(cap * 10 ** decimals()){
    ...
    modifier onlyOwner {
        require(msg.sender == owner, "Only the almighty Owner can call this function");
        _;
    }
}