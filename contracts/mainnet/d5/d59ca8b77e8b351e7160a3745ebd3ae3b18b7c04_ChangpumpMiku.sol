...
contract ChangpumpMiku is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "Changpump Miku"; //  Name
        _symbol = "CHAMIKU"; //  Symbol
        ...
        _maxTxAmount = 50000000000000 * 10**_decimals; // 4% of total supply
        _maxWalletBalance = 50000000000000 * 10**_decimals; // 4% of total supply
        _marketingWalletAddress = 0x1A9F698639367FA2f6e9229FAC42a89D9d6F4A2c; // Marketing wallet 
        _devWalletAddress = 0xA8db4a8394135419d797A5dE79cA0881f3a97d8C; // Dev wallet 
