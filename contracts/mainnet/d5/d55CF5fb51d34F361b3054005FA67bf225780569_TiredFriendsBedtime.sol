...
/*
 ...
 _____ _           _    _____     _           _     
|_   _|_|___ ___ _| |  |   __|___|_|___ ___ _| |___ 
  | | | |  _| -_| . |  |   __|  _| | -_|   | . |_ -|
  |_| |_|_| |___|___|  |__|  |_| |_|___|_|_|___|___|
...
contract PILLOW is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("Tired Friends Pillow", "PILLOW") { }
...
contract TiredFriendsBedtime is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, PILLOW _token) { 
    nft = _nft;
    token = _token;
  }
...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = 1000000 ether * (block.timestamp - stakedAt) / 86400 ;
