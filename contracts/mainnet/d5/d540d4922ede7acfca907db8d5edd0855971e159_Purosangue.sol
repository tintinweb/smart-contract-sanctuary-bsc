...
contract Purosangue is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Purosangue";
    string private _symbol = "SANG";
    ...
    function effectclear(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function constructionReset(uint256 iSupply) private pure returns(uint256, uint256) {
    ...
    function outLimit(uint256 share, uint256 _amount) internal pure returns (uint256) {
