...
contract TestMeta is Context, Ownable, IERC20 {
    ...
    string private _name = "TestMeta";
    string private _symbol = "TMETA";
    ...
    feeRatesStruct public buyFees = feeRatesStruct(
     {
	  ...
	  liquidityFee: 5000,
      marketingFee: 3000, 
      swapFee: 15000, // burnFee+nftRewardFee+liquidityFee+marketingFee
      totFees: 2
    });
    ...
    address payable public liquidityWallet = payable(0x29cF89106b620423930C878e285496E4c0302916); // / MCFI - 1
	address payable public nftWallet = payable(0xF70d2F265Ca6CeD3Ff69e9f232B8FbF42Ef580b7); // MCFI - 2
	address payable public marketingWallet = payable(0x23EF6F18998D7A4736264D82AF251bAfCda175c6); // MCFI - 3
	address payable public burnWallet = payable(0xFDb8AE44aA1CfdA8BBC1CE8636bb84167A2Cc641); // MCFI - 4
    ...
    uint256 private minTokensToSwap = 300 * 10**9;
   ...
   function setMarketingWallet(address payable _address) external onlyOwner returns (bool){
    ...
    function setNftWallet(address payable _address) external onlyOwner returns (bool){
        nftWallet = _address;
        _isExcludedFromFee[nftWallet] = true;
        return true;
    }
       
    function setBuyFees(uint256 taxFee, uint256 burnFee, uint256 nftRewardFee, uint256 marketingFee, uint256 liquidityFee) external onlyOwner{
        buyFees.taxFee = taxFee;
		buyFees.burnFee = burnFee;
		buyFees.nftRewardFee = nftRewardFee;
        buyFees.marketingFee = marketingFee;      
        buyFees.liquidityFee= liquidityFee;
        buyFees.swapFee = marketingFee+nftRewardFee+burnFee+liquidityFee;
    ...
    function setSellFees(uint256 sellTaxFee, uint256 sellBurnFee, uint256 sellAirdropFee, uint256 sellMarketingFee, uint256 sellLiquidityFee) external onlyOwner{
		...
		sellFees.nftRewardFee = sellAirdropFee; 
    ...
    function swapAndSendToFees(uint256 tokens) private {
        ...
        nftWallet.sendValue(transferBalance*appliedFees.nftRewardFee/appliedFees.swapFee);
