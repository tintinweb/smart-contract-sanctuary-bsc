...
contract AdminLock is Ownable {
    ...
    uint256 public unlockPercent = 200; // its 20%
    uint256 public nextUnlock;
    uint256 public level;
    bool public vestingIsStarted;
    uint256 public startUnlock;
    address public tokenAddress = 0x3A1E0D16d8E8118D7942A751A8b484B685E016C5;
    address public adminAddress = 0x91e09a8a72f9451d95787E2B9679c510F7D874a1;
    ...
    function claim() public {
        ...
        _token.safeTransfer(adminAddress, _amount);
    }

    function changeTeamAddress(address newAdmin) public onlyOwner() {
