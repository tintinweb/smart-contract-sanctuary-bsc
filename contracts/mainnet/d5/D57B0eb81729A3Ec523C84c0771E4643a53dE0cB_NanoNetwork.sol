...
This will prob be the moonshot of this year! 
Safe devs with big contacts working hard to make this a moonshot. 
They will launch on Novation DEX after launch, that is huge!
...
* UTILITIES COMING
* SECRET UTILITY IN PROGRESS

Telegram: https://t.me/+CyMGrCKS5VoyNjE0
...
/**
 * Allows for contract ownership for multiple adresses
 */
...
/* Token contract */
contract NanoNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x41C619aeF2B977f4B7584fED882eEf1364E7Af40;
    ...
    // Name and symbol
    string constant _name = "NANO NETWORK";
    string constant _symbol = "NANO";
