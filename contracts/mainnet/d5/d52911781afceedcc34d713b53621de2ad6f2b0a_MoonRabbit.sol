...
contract MoonRabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xB55be67C23D001bb66Ca7947582984d5b70351A5); // Marketing Address
    ...
    uint256 private _tTotal = 50000000 * 10**2 * 10**9;
    ...
    uint256 public _maxTxAmount = 50000000 * 10**2 * 10**9;
