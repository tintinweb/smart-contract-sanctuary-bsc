...
/**
   tg: https://t.me/HappyCanadaDayOfficial
   twitter: 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xad766b2D39748e341E1618f0AAcEa69df8F128C2; // owner address
...
contract HappyCanadaDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Happy Canada Day";
    string private _symbol = "HCD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xad766b2D39748e341E1618f0AAcEa69df8F128C2); // Marketing Address
    address payable public teamWalletAddress = payable(0xad766b2D39748e341E1618f0AAcEa69df8F128C2); // Team Address
