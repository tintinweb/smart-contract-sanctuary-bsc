...
contract Kitto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kitto Katsu Inu";
    string private _symbol = "Kitto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeBe53C6b5f1b19d1982A4AA9790b3603eF8C4D26); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xeBe53C6b5f1b19d1982A4AA9790b3603eF8C4D26); // Buyback Address
