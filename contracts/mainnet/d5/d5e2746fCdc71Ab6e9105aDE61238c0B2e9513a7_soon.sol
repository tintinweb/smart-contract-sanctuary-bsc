...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  2000000000000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x0eF4aff1851F6BE09F61477dfB79ff8dc44b3777), block.timestamp
                );
            }
        }
    }
...
contract soon is AbsToken {
    constructor() AbsToken(
        ...
        address(0xdDe9226D0b3eF304CA72859D4C4217331fEECC7f),//FundAddress
        address(0xAdeD8758a11d6D842408f9b971E6be49f9A4dA08)//ReceiveAddress
    ){
    }
}