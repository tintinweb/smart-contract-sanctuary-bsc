...
//
//
//   📱Telegram::https://t.me/SafemoonCupid
//   📱Website ::https://SafeMoonCupid.club/
/*
...
contract SafeMoonCupid is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SafeMoon Cupid", "SafeMoonCupid") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMoonCupid";
    string private _symbol = "SafeMoonCupid";
