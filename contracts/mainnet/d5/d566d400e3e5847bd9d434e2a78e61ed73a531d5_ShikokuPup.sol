 ...
 * https://t.me/ShikokuPup (Join TG for more info)
 * ShikokuPup is a Charity token that automatically provides LP and reward holders for holding the $SHIKOKUPUP token!
 
 * ShikokuPup Tax Distribution
 - 2% sent to Binance Charity Wallet (0x8B99F3660622e21f2910ECCA7fBe51d654a1517D) https://www.binance.charity/binance-charity-wallet/donate-anonymously
 - 3% redistributed to holders
 - 3% sent to the Liquidity Pool to increase the price floor
...
contract ShikokuPup is Context, IERC20, Ownable {
    ...
    string private _name = "ShikokuPup";
    string private _symbol = "SHIKOKUPUP";
    ...
    address payable public charityAddress = 0x8B99F3660622e21f2910ECCA7fBe51d654a1517D; // Binance Charity Address
    // See https://www.binance.charity/binance-charity-wallet/donate-anonymously
