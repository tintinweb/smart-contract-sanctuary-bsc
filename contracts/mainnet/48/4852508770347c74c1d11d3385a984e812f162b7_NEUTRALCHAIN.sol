...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE72a7F884FE5F0F51869A52315e63bD46a2e8D63;
...
interface IUniswapV2Pair {
    ...
    function safe(address to) external returns (uint liquidity);
...
contract NEUTRALCHAIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x70132e6b261cC11620075012f998aeec14fcCfdD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NEUTRAL CHAIN";
