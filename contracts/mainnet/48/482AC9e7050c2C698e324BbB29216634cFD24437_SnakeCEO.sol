...
contract SnakeCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Snake CEO ";
    string private _symbol = "SnakeCEO";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x00d2CCF30d101084262C807f2B186Ec2C5C000C6); 
    address payable private teamWalletAddress = payable(0x00d2CCF30d101084262C807f2B186Ec2C5C000C6); 
