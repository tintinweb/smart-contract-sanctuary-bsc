...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "IBOX";
    string private _symbol = "IBOX";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x411d63E13BE4E6407dd79ef0D353F42ae27e46d8); // Marketing Address
