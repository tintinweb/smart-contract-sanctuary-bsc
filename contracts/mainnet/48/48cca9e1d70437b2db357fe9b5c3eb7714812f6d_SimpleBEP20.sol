...
contract SimpleBEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FTX Classic";
    string private _symbol = "FTXC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d8dbC6bb7eaC30180c92D5448c9b4a0ED368B1A); 
    address payable public DevelopmentWalletAddress = payable(0x3C038B97995a5Ee1Da299F0767F12ca0112c8258); 
