...
contract BNBMETA2023 is Context, IERC20, Ownable {
    ...
    string private _symbol = "BNBMETA23"; // 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE579be8bD06af51f96f37de505C79d44236a368c); // 
    address payable public teamWalletAddress = payable(0xC75F80d4ec9C39d009ea0c75469d440465D92EF8); // 
