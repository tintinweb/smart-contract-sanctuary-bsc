...
contract ELON100M is Context, IERC20, Ownable {
    ...
    string private constant _name = "ELON 100M FOLLOWERS";
    string private constant _symbol = "E100M";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 500000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 500000000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 12500000000 * 10**_decimals;

    address public liquidityReceiver;
    address private marketingWallet = address(0xbd30e8c2349E0F3E8d3162AaF18CdbB8F041aE6A);
