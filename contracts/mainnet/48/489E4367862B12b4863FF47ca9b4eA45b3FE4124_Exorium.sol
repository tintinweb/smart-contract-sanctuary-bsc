...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x63139662054eDCf1343f27726FC0063342513497; // owner address
...
contract Exorium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Exorium";
    string private _symbol = "EXR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x63139662054eDCf1343f27726FC0063342513497); // Marketing Address
    address payable public teamWalletAddress = payable(0x63139662054eDCf1343f27726FC0063342513497); // Team Address
