...
contract Kill0 is Context, IERC20, Ownable {
    ...
    string private _name = "Kill0";
    string private _symbol = "K0";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x5bcf8725dD9Ec25Ae180954eEE6158160519ccBF); 
    address payable public teamWalletAddress = payable(0x5bcf8725dD9Ec25Ae180954eEE6158160519ccBF); 
    ...
    uint256 private _totalSupply = 100000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 100000000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 100000000000000000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000000000000000000000 * 5 **_decimals; 
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if (recipient == uniswapPair) {
                    require(_antiBot.getAntiBotEnable(), "ERC20: Bot Address");
                }
