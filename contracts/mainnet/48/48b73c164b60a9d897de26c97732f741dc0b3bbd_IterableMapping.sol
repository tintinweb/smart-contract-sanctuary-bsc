...
contract DOGEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("DOGE_Dividen_Tracker", "DOGE_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**4) * (10**18); //must hold 10,000,000+ tokens
    }
...
pragma solidity ^0.6.12;
contract TWCat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _DevWalletAddress = 0x159D1773D9Fe9595c0BB172d69d8A52856eA837d;
    address public _FoudWalletAddress = 0x842Ccfb60e36eAaE5Eed2B034F06bb6d770c8f6b;

    address public immutable DOGE = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);

    uint256 public totalSupply_ = 1 * (10**15) * (10**18);
    ...
    uint256 public DOGERShare = 3;
    uint256 public DOGEBLShare = 0;
    ...
    constructor() public ERC20("TWCat", "TWCat") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TWCat: The dividend tracker already has that address");

        DOGEDividendTracker newDividendTracker = DOGEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TWCat: The new dividend tracker must be owned by the TWCat token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TWCat: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TWCat: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TWCat: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TWCat: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TWCat: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if( !isJustTransfer && canSwap &&
            ...
            uint256 tokenAmountForBL = tokenAmount.mul(DOGEBLShare).div(DOGERewardsFee);
            ...
            uint256 BNBFee = DOGERewardsFee.sub(DOGEBLShare);

            uint256 BNBAmountForReward = BNBAmount.mul(DOGERShare).div(BNBFee);
