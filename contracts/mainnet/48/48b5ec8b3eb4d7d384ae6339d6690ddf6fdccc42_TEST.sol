...
contract TEST is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xd1E359A794D0ffe3eF7eD4c559F78958157e381B),
        development: payable(0xd1E359A794D0ffe3eF7eD4c559F78958157e381B),
        buyback: payable(0xd1E359A794D0ffe3eF7eD4c559F78958157e381B)
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 liquidity, uint16 development, uint16 marketing, uint16 buyback) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.development = development;
        _ratios.marketing = marketing;
        _ratios.buyback = buyback;
        _ratios.totalSwap = liquidity + buyback + development + marketing;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable development, address payable buyback, address payable marketing) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 buybackBalance = amtBalance - (marketingBalance + developmentBalance);
