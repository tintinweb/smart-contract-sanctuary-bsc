...
contract papapigeinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4320295c2ccAE0Cf5B6eAE2f6815044cA33a06d0); 
    ...
    string private constant _name = "Papa Pige Inu"; 
    string private constant _symbol = unicode"$Papapige"; 
    ...
    constructor () {
        ...
        _owner = 0xfe3D67866aEca3271FACFBa25aC94E397dDc84d7;
