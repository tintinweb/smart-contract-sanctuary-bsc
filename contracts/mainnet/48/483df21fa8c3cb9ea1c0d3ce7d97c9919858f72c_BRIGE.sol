...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8745dB4fD46e75C3BaE05B874D1Bd5aa0B8ff5E2; // owner address
...
contract BRIGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlackRock Doge";
    string private _symbol = "BRIGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8745dB4fD46e75C3BaE05B874D1Bd5aa0B8ff5E2); // Marketing Address
    address payable public teamWalletAddress = payable(0x8745dB4fD46e75C3BaE05B874D1Bd5aa0B8ff5E2); // Team Address
