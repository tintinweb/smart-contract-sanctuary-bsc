...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0112346e608DE2E4466C3E5f6a5946df65A8dff6; //
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "1M Token"; // 
    string private constant _symbol = "$1M"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5; //
    uint256 public _liquidityFee = 1; //
    address payable public  _marketingWallet = payable(0x0112346e608DE2E4466C3E5f6a5946df65A8dff6); //
