...
contract HolyChickens is Token {
    uint256 public startTime = 1644670801;
    uint256 public MIN_INVEST_AMOUNT = 5 ether;
    uint256 public SELL_LIMIT = 40000 ether;
    uint256 public BUSD_DAILYPROFIT = 40;
    uint256 public TOKEN_DAILYPROFIT = 70;
    ...
    uint256 private constant ADMIN_FEE = 100;
    ...
    constructor() public {
        token = IERC20(busd);
        ADMIN = msg.sender;
        MARKETING = 0x4F9c32aD15d07BA2BBD88b714D5F49A7D924E676;
        _mint(msg.sender, 100000 ether);
        _mint(MARKETING, 50000 ether);
    }
    modifier onlyOwner() {
    ...
    function stakeBUSD(address referrer, uint256 _amount) public payable {
        ...
        uint256 fee = _amount.mul(ADMIN_FEE).div(PERCENT_DIVIDER); 
