...
contract YALLAbsc is Context, IERC20, Ownable {
    ...
    string private constant _name = "YALLA"; // 
    string private constant _symbol = "Y'allaaaaaaa"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x63270B2f63A0d58E6547657C1d1C251570F397Ec;
