...
contract FLOKIDODE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x71A8eD92998515b2C2B9c97596669460d35f7E2e); // Marketing Address
    address payable public teamWalletAddress = payable(0x71A8eD92998515b2C2B9c97596669460d35f7E2e); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10 * 5 **_decimals; 
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x71A8eD92998515b2C2B9c97596669460d35f7E2e),
            block.timestamp
        );
    }
