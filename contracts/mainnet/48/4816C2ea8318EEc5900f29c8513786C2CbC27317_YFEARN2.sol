...
Yfearn 2.0 HOLD WHILE EARNING

The greatest hit is coming in the market. Earn while your away. Introducing Yfearn 2.0 
...
contract YFEARN2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YFEARN2.0";

    string constant _symbol = "$YFTWO";
    ...
    address public marketingFeeReceiver = 0x415006ed68A03b8054e4c4343E4843A648a32F22;
