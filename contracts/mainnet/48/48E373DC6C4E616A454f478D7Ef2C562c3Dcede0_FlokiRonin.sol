...
contract FlokiRonin is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Floki Ronin";
   string constant _symbol = "FlokiRonin";
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x271374F1133E268654b8EfDC595fC9D2e41Dc6d3; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x271374F1133E268654b8EfDC595fC9D2e41Dc6d3; //Can be change to any wallet you want
       marketingFeeReceiver = 0x34b1c60879Eb278C97F958F637a76A176f58FC4D; //Can be change to any wallet you want
