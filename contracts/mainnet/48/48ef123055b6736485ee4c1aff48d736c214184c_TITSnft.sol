...
contract TITSnft is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3_000_000_000 * 10**9; //
    string private constant _name = "TITS NFT"; // 
