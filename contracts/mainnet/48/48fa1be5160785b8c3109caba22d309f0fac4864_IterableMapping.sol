...
contract AnonFlokiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("AnonFloki_Dividend_Tracker", "AnonFloki_Dividend_Tracker", 9) {
    	claimWait = 3600; // in seconds
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 1 000 000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "AnonFloki_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "AnonFloki_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AnonFloki contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "AnonFloki_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "AnonFloki_Dividend_Tracker: Cannot update claimWait to same value");
...
contract AnonFlokiInuv2 is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    AnonFlokiDividendTracker public dividendTracker;
    ...
    constructor() public BEP20("MESK SmartDeFi", "MESK", 9) {
    	...
    	dividendTracker = new AnonFlokiDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        AnonFlokiDividendTracker newDividendTracker = AnonFlokiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "AnonFloki: The new dividend tracker must be owned by the AnonFloki token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "AnonFloki: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "AnonFloki: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "AnonFloki: The liquidity wallet is already this address");
