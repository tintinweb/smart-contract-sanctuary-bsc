...
contract ValuableCoins is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 60100 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'ValuableCoins';
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee <= 1000, "Tax Fee should be less than 1000");
        _taxFee = taxFee;
    }

    function _setBurnFee(uint256 burnFee) external onlyOwner() {
        require(burnFee <= 1000, "Burn Fee should be less than 1000");
        _burnFee = burnFee;
    }

    function _setDevFee(uint256 devFee) external onlyOwner() {
        require(devFee <= 1000, "Dev Fee should be less than 1000");
        _devFee = devFee;
    }
