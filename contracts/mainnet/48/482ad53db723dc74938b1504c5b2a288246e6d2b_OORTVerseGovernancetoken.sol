...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xBD149d291444D0F0554f7319892805a523134e98);//5% OORT.Money (R2E) Rewards
    IDEXRouter router;
...
contract OORTVerseGovernancetoken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OORT Verse";
    string constant _symbol = "OORT";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 21 * 10**7 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaDfF5E97aCb9A35B87A5a9f4C40A57DA786f7808;//47
        buybackFeeReceiver = 0xaDfF5E97aCb9A35B87A5a9f4C40A57DA786f7808;//47
        teamFeeReceiver = 0xaDfF5E97aCb9A35B87A5a9f4C40A57DA786f7808;//47
