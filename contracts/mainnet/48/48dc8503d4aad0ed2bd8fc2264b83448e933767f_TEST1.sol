...
contract TEST1 is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("TEST1", "test") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x7196D852104a94fF05983d85bd9437262b71c11a); // CHANGE THIS TO YOURS
        devWallet = payable(0xAcd24D8D50a22502eB3F93561905654243b91503); // CHANGE THIS TO YOURS
