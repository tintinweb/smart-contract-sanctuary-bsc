...
contract DOGETER is Ownable, ERC20 {

    uint256 public maxSup = 1000 * 10**9 * 10**18; // 1000.000.000.000
    uint256 public minSwapAmount = 500 * 10**6 * 10**18; // 500.000.000

    address public mktAddress;
    uint256 public buyRate = 7;
    ...
    constructor() ERC20("DOGETER", "DOGETER") {
        ...
        mktAddress = 0xbD28AeDfcCd8aDf57705914F715A0484Fe6780B2;
    }
    ...
    function setFeeRate(uint256 _sellRate, uint256 _buyRate) public onlyOwner {
        require(_sellRate < 10, "Sell fee alway below 15%, so this contract never can lock sell");
        require(_buyRate < 10, "Buy fee alway below 15%");
        sellRate = _sellRate;
        buyRate = _buyRate;
    }
