...
contract Twogger is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Twogger";
    string constant _symbol = "TWG";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xEfb124B4a2f62C873DAE5BA2Fa7Def33a4963427;
