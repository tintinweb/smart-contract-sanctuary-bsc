...
/* Token contract */
contract DogeValentine  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x381aCB5556F351E359429596814Cd02435F9f0AE;
    ...
    // Name and symbol
    string constant _name = "Doge Valentine";
    string constant _symbol = "DogeV";
    ...
    uint256 public swapThreshold = _totalSupply * 3 / 1000000; // 0.003% of supply
