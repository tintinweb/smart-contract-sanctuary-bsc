...
contract DECIDER is IBEP20, Auth {
   ...
   constructor () Auth(msg.sender) {
       ...
       buybackFeeReceiver = 0xC3878b27D13d9D16925B9441B5671879a0a5021e; 
       RollFeeReceiver = 0x9Eb73ed80EAcaBCcAAc36416Ab61ecEfa482e46F; // RollFee Wallet
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(5).div(6);
       uint256 amountBNBBuyback = (amountBNB.mul(buybackFee).div(totalBNBFee)).mul(3).div(4);
       uint256 amountleft = (amountBNBMarketing.div(6)).add(amountBNBBuyback.div(4));
...
function shouldAutoBuyback() internal view returns (bool) {
   ...
   function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _RollFeeReceiver) external authorized {
       autoLiquidityReceiver = _autoLiquidityReceiver;
       marketingFeeReceiver = _marketingFeeReceiver;
       buybackFeeReceiver = _buybackFeeReceiver;
       RollFeeReceiver = _RollFeeReceiver;
   }
