...
contract GreenChangpump is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Changpump";
    string private constant _symbol = "Green Changpump";
