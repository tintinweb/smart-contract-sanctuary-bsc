...
/**
MEME NATION 2.0
Is a Community driven meme cryptocurrency on binance smart chain. The next meme coin to set a new trend for crypto. If you missed the  MEME NATION, you shouldn't be left behind with this
TAX : 10/10
Telegram : https://t.me/MemeNationTwo
*/
...
contract MemeNationtwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MEME NATION 2.0";
    string private _symbol = "MEME NATION 2.0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x31FdCe0c06826bdDcE5274Bd8a2c03198BeDD733); // Marketing Address
    address payable public teamWalletAddress = payable(0x31FdCe0c06826bdDcE5274Bd8a2c03198BeDD733); // Team Address
