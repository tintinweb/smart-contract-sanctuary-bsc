...
📱 TELEGRAM : https://t.me/mikugoldofficial
🌎 WEBSITE : https://mikugold.space
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F6b818aef17a8cA771E8888d857ca4F0DFfAC9c;
...
contract MikuGold is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0x9Cc983D98583DFee9D2599829AB7AEDb71C79179);
    ...
    */
    ...
    string private _name = "MikuGold"; 
    string private _symbol = "$MikuGold";  
    ...
    */
    ...
    function _set_Fees(uint256 tax_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((tax_Fee + Sell_Fee) <= maxPossibleFee, "Fee is too high!");
        _sellFee = Sell_Fee;
        _taxFee = tax_Fee;
