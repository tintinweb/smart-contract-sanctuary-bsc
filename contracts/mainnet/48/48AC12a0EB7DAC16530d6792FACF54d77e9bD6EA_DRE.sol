...
contract DRE is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 1880000000000000;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0x52f14310E0648662b5D1Fe7d55CC414Ec47D042B;
        devAddress = 0x52f14310E0648662b5D1Fe7d55CC414Ec47D042B;
        ...
        ceoList[0x52f14310E0648662b5D1Fe7d55CC414Ec47D042B] = true;
                ...
                if (_swapPairList[to]) {
                    ...
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _sellFundFee + _sellLPDividendFee + _sellDevFee+_buyLiquidityFee+_sellLiquidityFee;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapFee;
            if (isSell) {
                swapFee = _sellFundFee + _sellLPDividendFee + _sellDevFee+_sellLiquidityFee;
            } else {
        ...
        _takeTransfer(sender, recipient, tAmount - feeAmount);
        _takeLiquidity(sender, tAmount - feeAmount); 
    }
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 takeLiquiditys = fistBalance*(_sellLiquidityFee+_buyLiquidityFee) /swapFee;
        ...
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAmount - devAmount -takeLiquiditys);
    }
