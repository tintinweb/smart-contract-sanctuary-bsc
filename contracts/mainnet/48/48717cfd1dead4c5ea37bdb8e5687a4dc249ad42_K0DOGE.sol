...
contract  K0DOGE is Context, IERC20, Ownable {
    ...
    string private _name = "Supercandy";
    string private _symbol = "Supercandy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x42c8C1e7a20248Bea1175c6ADA327D7D1c350C59);
    address payable public teamWalletAddress = payable(0x76f935958FBE00c1E0D9503DB0C1d0bA8bE6B4aC);
