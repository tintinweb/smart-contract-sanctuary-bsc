...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3f59ab369C2E9Eb459dF7d2A484B2EB5EC750350; // owner address
...
contract Catnese is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Catnese";
    string private _symbol = "CAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f59ab369C2E9Eb459dF7d2A484B2EB5EC750350); // Marketing Address
    address payable public teamWalletAddress = payable(0x3f59ab369C2E9Eb459dF7d2A484B2EB5EC750350); // Team Address
