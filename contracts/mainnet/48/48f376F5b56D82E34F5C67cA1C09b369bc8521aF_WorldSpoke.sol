...
contract WorldSpoke 
{
    ...
    uint[] public arrReqDirects = [0,1,2,3,5,7,10,14,19,25,33,43,55,69,85];
    uint[] public arrReqNonWorkingAmt = [5,10,20,40,80,120,180,270,405,810,1620,3240,6480,12960,25920];
    uint[] public arrReqWorkingAmt = [5,10,20,40,80,120,240,540,810,1620,3240,6480,12960,25920,51840];
    ...
    mapping(uint => address) public placementToAddress;
     ...
     constructor()  {
        ...
        contractOwner=0xE6167bA416D9EF5c19eD38732289a886F45D8148;
