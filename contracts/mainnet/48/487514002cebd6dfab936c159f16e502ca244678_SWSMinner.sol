...
contract SWSMinner is Ownable {
    ...
    function setRecomCFG(uint256 _recomNeed,uint256 _rate,uint256 _rate1,uint256 _rate2,uint256 _rate3,uint256 _rate4) public onlyOwner {
    ...
    function setLevelCFG(uint256 _level1,uint256 _level2,uint256 _level3,uint256 _marketrate,uint256 _levelNeed1,uint256 _levelNeed2,uint256 _levelNeed3) public onlyOwner {
        level1 = _level1;
        level2 = _level2;
        level3 = _level3;
    ...
    function shareUsdt(uint256 shareUsdtAmount) external onlyOwner{
        ...
        for (uint256 i = 0; i < shareholders.length; i++) {
            ...
            if (userTokenDeposit>0){
                userUsdt[shareUser] = userUsdt[shareUser].add(userTokenDeposit.mul(shareUsdtAmount).div(platTotalAmountLP));
            }else{
