...
contract GoldMoon
 is Context, IERC20, Ownable {
    ...
    string private _symbol = "GoldMoon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x003E34DDbbefeF688085082E29380EB9ABC21843));
        _anotherA = payable(address(0x003E34DDbbefeF688085082E29380EB9ABC21843));
