...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06997b16318713291734E11C5e0Da4ad188D866E;
...
contract OGFINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "OG FIFA INU"; // 
    string private constant _symbol = "$OGFINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable private _marketingWallet = payable(0x9CE773eA0b1D40F9e6AC06f414585cE7E432A5fA);
