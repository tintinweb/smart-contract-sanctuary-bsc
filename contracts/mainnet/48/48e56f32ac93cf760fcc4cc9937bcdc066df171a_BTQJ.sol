...
contract BTQJ is ERC20 {
	...
	address public _fundAddress = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);
    ...
    constructor(address tokenOwner) ERC20("B1TQJ", "B1TQJ") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
			...
			if(from == uniswapV2Pair){
                ...
                if(startTime.add(600) > block.timestamp){require(balanceOf(to).add(amount) <= 15 * 10**19,"max amount");}
