...
/**
 *It has been a green day after the bloodbath. Invest in this if you feel like it
*/
...
contract BULLISHDAY is BEP20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory BULLISHDAY_,
        string memory BULL_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable BEP20(BULLISHDAY_, BULL_) ServicePayer(feeReceiver_, "BULLISHDAY", signature_, _msgSender()) {
