...
Flona - ($FLONA)
My Lovely Flona, 
For so long I have been waiting to introduce you to the world…
*/

// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.17;

abstract contract ContextFlonaLovesFloki {
...
contract OwnableFlonaLovesFloki is ContextFlonaLovesFloki {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableFlonaLovesFloki: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableFlonaLovesFloki: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract FLONA  is ContextFlonaLovesFloki, FlonaLovesFloki, OwnableFlonaLovesFloki {
    ...
    string private _name = 'Flona Loves Floki';
    string private _symbol = '$FLONA';
