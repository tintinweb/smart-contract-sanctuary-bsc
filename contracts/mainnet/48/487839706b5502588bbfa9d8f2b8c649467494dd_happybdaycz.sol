...
/**
This token is created to great CZ a "Happiest Birthday"
Fully community driven token LP will be burned and contract renounced
Fot you who ape this do fucking work for your bags don't just fucking sit there watching
the chart and thinking when to jeets!

Use think link in making the group  https://t.me/happybdaycz

If marketing will be filled will do some secret marketing behind
Let's fucking moon this
...
contract happybdaycz is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Birthday CZ"; // 
    string private constant _symbol = "CZBIRTHDAY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xd8dD8a465871BF95a07d249d1F9aC9667d998943);
