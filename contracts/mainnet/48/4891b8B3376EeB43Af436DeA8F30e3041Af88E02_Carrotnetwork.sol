...
// File: contracts/Carrotnetwork.sol
...
contract Carrotnetwork is Context, IERC20, Ownable {
    ...
    payable(0x979924E59e8C18625C540dBAA78e501791e6C768);
    ...
    uint256 private constant _tTotal = 100 * 1e3 * 1e18;
    ...
    string private constant _name = "Carrot Network";
