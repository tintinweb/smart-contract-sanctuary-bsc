...
// BABY TERRA
// LET'S GET TERRA LUNA BACK UP TO THE PEGGED DOLLAR BY FOMO HYPE!
...
contract BabyTerra is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyTerra";
    string private _symbol = "LUNA";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x023C583653F4B0fcdE198DbA652Fe55172d45C30);
