...
contract EBCToken is Context, IERC20, Ownable {
  ...
  string private _name = "Electronic-Business-Chain";
  ...
  uint256 public _nodeFee = 2;
  address public nodeAddress;


  uint256 public _shareFee = 1;
  uint[] internal shareConfig = [1];
  ...
  function setLimitGas(uint _gas) public onlyOwner {
    limitGas = _gas;
  }
  function setLimitCount(uint _count) public onlyOwner {
    limitCount = _count;
  }
  ...
  function _initParam(uint256 tAmount,Param memory param) private view  {
    ...
    param.tNode = tAmount * _nodeFee / 100;
  ...
  function _transfer(
    ...
    if( address(uniswapV2Pair) != address(0) ){
      ...
      if (
        ...
        && uniswapV2Pair.totalSupply() > limitGas ) {
