...
BLACK SHARD ASTRO Crypto
Like many of you, the founders of BLACK SHARD ASTRO have been scammed, rugged, 
and intentionally misled while investing in other tokens and altcoins. 
At BLACK SHARD ASTRO, we will give our backers solid and transparent information to make their investment decisions.
Always do your own research.

Website : https://blackshardastro.digital
*/
...
contract BLACKSHARDASTRO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BLACK SHARD ASTRO";
    string private _symbol = "SHARD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D3A6bB78d185cd6cDb61CF6e3bFfA9DAb7C9c06); 
    address payable public buyBackWalletAddress = payable(0x7D3A6bB78d185cd6cDb61CF6e3bFfA9DAb7C9c06); 
