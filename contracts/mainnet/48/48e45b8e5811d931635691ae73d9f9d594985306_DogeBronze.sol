...
contract DogeBronze is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Bronze";
    string private _symbol = "DOGE BRONZE";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x6B531272f072E21B66361F69042265D78909D3d7);
