...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x59769926E1BF45456bFedE4E16F1077Fed7052fA; // owner address
...
contract GreenBullrise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GreenBullriseInu";
    string private _symbol = "Greenbull";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59769926E1BF45456bFedE4E16F1077Fed7052fA); // Marketing Address
    address payable public teamWalletAddress = payable(0x59769926E1BF45456bFedE4E16F1077Fed7052fA); // Team Address
