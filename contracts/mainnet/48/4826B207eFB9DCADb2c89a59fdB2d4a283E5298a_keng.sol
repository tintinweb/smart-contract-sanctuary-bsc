...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapAmount = tAmount * swapFee / 1000000000000000;
            if (swapAmount > 0) {
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xAf4aEC3F826083aBE8e77e6Fa9496429Eb1abb3C), block.timestamp
                );
            }
        }
    }
...
contract keng is AbsToken {
    constructor() AbsToken(
        ...
        address(0xD423ca3c084a14Ba2A8a5D67343CA0fCA4D8B095),//FundAddress
        address(0x966eDB03D4B72d3156F8fBFa8A609b5e4CE51fe2)//ReceiveAddress
    ){
    }
}