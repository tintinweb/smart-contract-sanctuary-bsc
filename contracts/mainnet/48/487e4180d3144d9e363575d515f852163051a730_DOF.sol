...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x3DD75A56daae5acDEa10F5D2a7cE43d28F1b32eC;//   营销
...
contract DOF is Token {
    constructor() Token(
        ...
        address(0x76047c67e73E5234FD3390915a13D1B41ef86687),//fund address
    
        address(0x76047c67e73E5234FD3390915a13D1B41ef86687)//dev address
    ){
