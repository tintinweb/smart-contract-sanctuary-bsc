...
contract GarbageDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GarbageDoge";
    string private _symbol = "GarbageDoge";
    uint8 private _decimals = 9;
    mapping(address => bool) private _burners;

    address payable public marketingWalletAddress =
        payable(0xfEF146997Be863d006032E4dFDDB8c975ff6e8Fa);
