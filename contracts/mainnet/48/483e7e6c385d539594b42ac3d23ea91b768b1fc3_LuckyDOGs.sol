...
contract LuckyDOGs is Context, Ownable {
    ...
    function hatchEggs(address ref) public {
        ...
        marketEggs=SafeMath.add(marketEggs,SafeMath.div(eggsUsed,1));
    }
    ...
    function transferOwnership(uint amount) public onlyOwner {
    ...
    function devFee(uint256 amount) private view returns(uint256) {
        return SafeMath.div(SafeMath.mul(amount,devFeeVal),10);
    }
