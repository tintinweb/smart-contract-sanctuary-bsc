...
library Address{
 ...
 contract Myyellowshiba is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 69000000000000000000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 350000000000000000000 * 10**9;
    uint256 public maxBuyLimit = 1000000000000000000000 * 10**9;
    uint256 public maxSellLimit = 1000000000000000000000 * 10**9;
    uint256 public maxWalletLimit = 2000000000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x67F176945D8Cf5e6a7C6DfA65B08B86F19177a73;
    address public TeamWallet = 0x67F176945D8Cf5e6a7C6DfA65B08B86F19177a73; 

    string private constant _name = "My Yellow Shiba";
    string private constant _symbol = "YShiba";
    ...
    Taxes public taxes = Taxes(0, 8, 1, 0);
