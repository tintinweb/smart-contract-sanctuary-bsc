...
contract DOGEWHALE is Initializable {
    ...
    //Current Taxes
    function whatIsTaxNow() public view returns (uint256, uint256, uint256) {
        if (Drawdown < painThreshold*10**16 && panicOverride == true) {
            return (500*10**13, 800*10**14, 125*10**14);    //  buy: 0.5%, sell: 8%, trasnfer: 1.25%
        } else {
            return (buytax, selltax, transfertax);
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    function correctSnapshot(uint256 _snapNumberToCorrect) public virtual onlyOwner returns (bool) {
        snapshotNumber = _snapNumberToCorrect;
        return true;
    }
...
- 28/01/2023 - Added function to view taxes on-chain
*/