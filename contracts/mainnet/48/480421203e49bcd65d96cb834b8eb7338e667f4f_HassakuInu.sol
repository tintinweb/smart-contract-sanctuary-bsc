...
library Address{
 ...
 contract HassakuInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7221b566Ca759D3D1867533fCB9Fd64442A37505;
    address public donationWallet = 0x7221b566Ca759D3D1867533fCB9Fd64442A37505;
    string private constant _name = "Hassaku Inu";
    string private constant _symbol = "HASSAKU";
    ...
    Taxes public sellTaxes = Taxes(1, 2, 1, 2);
