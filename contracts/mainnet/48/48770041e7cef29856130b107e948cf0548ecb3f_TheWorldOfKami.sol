...
contract TheWorldOfKami is Context, IERC20, Ownable {
    ...
    string private _name = unicode"TheWorldOfKami";
    string private _symbol = unicode"KAMI";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xB7960b6d50B026fdE5443D663A5B97403A30a0Ce); 
    address payable public BurnedWalletAddress = payable(0xB7960b6d50B026fdE5443D663A5B97403A30a0Ce); 
