...
/*
Elon Musk, the tech entrepreneur and CEO of Tesla, is determined to create a revolution in artificial intelligence. His latest project is Optimus Zilla, a robot that he has engineered to be able to learn and evolve on its own. With this ambitious goal, he hopes to grow AI far beyond anything seen before and use it to take over the world.

He believes this could become an integral part of the future of AI development and could achieve massive benefits for humanity if harnessed correctly. While there are definitely risks associated with this major undertaking, the possibilities are endless. The journey starts now with Optimus Zilla!


🕘Stealth laucnh today with Low MC and Low Tax.

🔔 Launch time: 09:30 UTC
🟢 Initial LP: 1.5BNB 

Ready for next alpha 👇👇👇

♻️ Telegram 💥 Twitter 🇨🇳 Website ♨️
*/
...
contract OptimusZilla is Ownable, IBEP20 {
    ...
    string constant _name = "Optimus Zilla";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x417Ebb5977eC587d5a289a7F25d1590c9Dd6bf22;
        marketingWallet = 0x417Ebb5977eC587d5a289a7F25d1590c9Dd6bf22;
