...
TG: https://t.me/headlesshorsemanbsc
...
contract HeadlessHorseman is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HeadlessHorseman";
    ...
    function headless_list_off(bool _status) public onlyOwner {
        blacklistMode = _status;
    }

    function headless_bot_list(address[] calldata addresses, bool status) public onlyOwner {
