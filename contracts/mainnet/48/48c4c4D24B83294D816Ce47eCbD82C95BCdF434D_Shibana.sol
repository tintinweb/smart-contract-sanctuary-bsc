...
contract Shibana is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe824E82c59C6746832aD38CB3c6219FCa5c9b0a3); 
    address payable public Dev_Wallet = payable(0x826F5B857A0433a19079b59965C0A42f4d514BFe);
    ...
    string private constant _symbol = unicode"Shibana"; 
    ...
    constructor (uint256[] memory configs) {
        ...
        _owner = 0x826F5B857A0433a19079b59965C0A42f4d514BFe;
