...
contract CumSpaceTop is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyAmount = 500000000 * 10**9;
    uint256 public maxSellAmount = 500000000 * 10**9; 
    ...
    address public  _marketingWallet = payable(address(0x1530988FAebEeFa132ad0e6A0504eC2a1860Aa17)); //change youyr marketing wallet
    ...
    constructor() ERC20("Cum Space Top", "CST") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CumSpaceTop: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "CumSpaceTop: The new dividend tracker must be owned by the CumSpaceTop token contract"
        );
    ...
    require(newAddress != address(uniswapV2Router), "CumSpaceTop: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CumSpaceTop: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "CumSpaceTop: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CumSpaceTop: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CumSpaceTop: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CumSpaceTop: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        require(from != address(0), "CumSpaceTop: transfer from the zero address");
        require(to != address(0), "CumSpaceTop: transfer to the zero address");
        require(
...
contract CumTokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("CumSpaceTop_Dividend_Tracker", "CumSpaceTop_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "CumSpaceTop_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CumSpaceTop_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CumSpaceTop contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "CumSpaceTop_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "CumSpaceTop_Dividend_Tracker: Cannot update claimWait to same value"
        );
