...
contract Dexinu is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**9 * 10**9; //billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DexInu";
    ...
    address public devWallet = 0xa06cf875A78402e9FD636f928a5e0c490159C1c2; 
    ...
    uint256 public _maxTxAmount = 5 * 10**8 * 10**9; //5%
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**8 * 10**9;
    uint256 public _maxWalletToken = 10 * 10**8 * 10**9; //10%
