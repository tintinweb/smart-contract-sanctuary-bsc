...
/**
VALENTINE SHIBA following Valentine hype and rewards contract

dev previous projects was good, safu and now we are trying to make a cool meme coin with huge Shiba Inu rewards for our investor while turning your investment to worth millions!
...
- Telwgram : https://t.me/Valentine_Shiba
*/
...
contract ValentineShiba is  Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Valentine Shiba"; //    
