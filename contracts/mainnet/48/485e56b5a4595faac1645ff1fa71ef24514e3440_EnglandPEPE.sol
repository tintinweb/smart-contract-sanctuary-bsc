...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x27373BfD61347B5962bB7DEC8A1Afe07d0342467; // owner address
...
contract EnglandPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ENGLAND PEPE";
    string private _symbol = "ENGLANGPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x27373BfD61347B5962bB7DEC8A1Afe07d0342467); // Marketing Address
    address payable public teamWalletAddress = payable(0x27373BfD61347B5962bB7DEC8A1Afe07d0342467); // Team Address
