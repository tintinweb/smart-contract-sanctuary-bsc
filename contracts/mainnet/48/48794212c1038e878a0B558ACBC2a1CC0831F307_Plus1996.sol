...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4ce9Ea21fFe087294583d71E854DfBDA9B8E474c; // owner address
...
contract Plus1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "+1996";
    string private _symbol = "+1996";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xea8f148159eCf027A1B3442feCEd2087068e9065); // Marketing Address
    address payable public teamWalletAddress = payable(0xea8f148159eCf027A1B3442feCEd2087068e9065); // Team Address
    ...
    uint256 public _totalDistributionShares = 40;  // original 12
