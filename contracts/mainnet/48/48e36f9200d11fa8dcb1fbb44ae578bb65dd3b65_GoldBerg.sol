...
abstract contract Authorization {
     ...
     */
    function inGoldBergrize(address _auth) public onlyOwner {
...
contract GoldBerg is IERC20, Authorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "GoldBerg";
    string constant _symbol = "GBerg";
    ...
    function updateTargetGoldBerg(uint8 _target, uint8 _denominator) external authorized {
        _targetLiquidity = _target;
        _targetLiquidityDenominator = _denominator;
    }    

    function updateGoldBergSettings(bool _enabled, uint256 _amount) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _amount;
    }  
	
	function getGoldBergFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
	...
	function swapAndGoldBergToFee(address _token, uint256 tokens) private  {
    ...
    function GoldBergFees(uint8 liquidityFee, uint8 reflectionFee, uint8 marketingFee, uint8 feeDenominator) external authorized {
    ...
    function updateFeeGoldBerg(address holder, bool exempt) external authorized {
        isFeeExempt[holder] = exempt;
    }

    function updateGoldBergExempt(address holder, bool exempt) external authorized {
