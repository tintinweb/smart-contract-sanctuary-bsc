...
/* Token contract */
contract SpookySick is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address OWNERDEV = 0xcf90dc44293618664C62DAED081D089F5aED2951; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xcf90dc44293618664C62DAED081D089F5aED2951;
    ...
    // Name and symbol
    string constant _name = "Spooky Sick";
    string constant _symbol = "SSICK";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1m 
