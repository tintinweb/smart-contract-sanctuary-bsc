...
contract shabkeinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShabakeInu"; // 
    string private constant _symbol = "SHABAKE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x570dD82eDaB023bbB6BdDDBf38d7AfB8ec5cB335;
