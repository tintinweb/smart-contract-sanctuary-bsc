...
contract FUDPROTOCOL is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"NO FUD";
    ...
    address payable public DevWallet = payable(0xA9A39aB485B8cfEC03a06a4d4C4fD3652A33d286);
    address payable public MarketingWallet = payable(0x8E3081ca58B02F1644edC36898e8c1B2a1473549);
