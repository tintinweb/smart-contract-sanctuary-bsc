...
contract Ownable is Context {
    ...
    constructor() {
        _owner = 0xa97232a9FCAaA645Cc188Ef8B5B8dA720e103475;
...
contract INSURGENT is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    string private constant _symbol = "IRGT";
    ...
    //Tax wallets
    address public teamWallet = 0xb81d4bc85FF9DA2a6bB760192c6Cbd309bAff455;
    address public treasuryWallet = 0xa2B8b8BA7815b068b38910d4eB554C033159956B;

    // Tax Split
    uint256 public teamShare = 142;
    uint256 public treasuryShare = 428;
    uint256 public rewardShare = 428;
