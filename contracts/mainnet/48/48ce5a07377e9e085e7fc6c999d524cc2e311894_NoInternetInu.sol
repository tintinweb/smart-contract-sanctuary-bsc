...
contract NoInternetInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "No Internet Inu"; // Edit Name
    string constant _symbol = "No Internet"; // Edit Symbol
