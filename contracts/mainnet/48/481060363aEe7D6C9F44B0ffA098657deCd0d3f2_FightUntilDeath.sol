...
//Join Fight Until Death telegram: @fightuntildeath
//Website: FightUntilDeath.com
//Twitter: @FUDOfficial
//Twitch: @FUDOfficial
// Join The Best Community Today!  BUSD rewards for all of our holders!
...
/* Token contract */
contract FightUntilDeath is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x65A6D4dAE91042aD7E345Cf5f815aE1F8d78679f;
    ...
    // Name and symbol
    string constant _name = "FightUntilDeath";
    string constant _symbol = "FUDOFF";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3F389e95bEB6cd0168615AE4E5dCc5e6FaD8eb91;
...
// Brought to you by FUD OFFICIAL