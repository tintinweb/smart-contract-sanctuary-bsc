...
contract CATSTARCOIN is Context, IERC20, Ownable {
    using Address for address;  
    using SafeMath for uint256;

    string private _symbol = "CSC";   
    uint8 private _decimals = 9;
    string private _name = "CatStarCoin";
    ...
    address payable public BuyBackWalletAddress = payable(0x802dedb77B037B6cdDEB090060591d4B38F559bc); // BuyBack Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWalletAddress = payable(0x48a39243aA4d18104a56a5267147349c50a40FBD); // Marketing Address
