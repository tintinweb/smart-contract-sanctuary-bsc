...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x77418197ba256004876ca4cB47Ced17268832016;
...
contract ShenLong is AbsToken {
    constructor() AbsToken(
        ...
        address(0x9eEecC93b114a016257199F85489c608234F422A),
        ...
        address(0xe3E01b0e8104D73fCa20ea2114Ca926A414881a2),
    
        address(0x4aeA995af0FdC651265d5372aa6BF465c15f76b1)
    ){
