...
contract DOGARM is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DOGARM';
    string private constant _symbol = '$DOGGIES';
    ...
    //DevWallets
    address public TeamWallet=payable(0xE5F5E43571E2B0648bA0bc5B3B3524cedACaEfCe);
    address public walletTwo=payable(0xDc3f224d11E779Eb2B36c6F6e82824C3b3d34D92);
    //TestNet
    ...
    function Californication(bool enabled) external onlyOwner{
        gas_enabled=enabled;
        }
