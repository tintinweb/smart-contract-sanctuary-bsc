...
contract Emma is IERC20, Ownable, IDistributorShare{
    ...
    function Dorfman(address holder) external onlyOwner {
    ...
    function updateAllFees(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
