...
contract MuuBoy is IBEP20, Auth {
    ...
    string constant _name = "MuuBoy";
    string constant _symbol = "MuuBoy";
    ...
    uint256 public totalTransferFee = 10;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x79f51D1bB523Fb963f061d37DaD45452f0E22e9d;
        BuyBackFeeReceiver = 0x53FFe4812902026c7e5634D75e325Df0301D6a9f;
    ...
    function swapBack() internal swapping {
        ...
        require(tmpSuccess2, "BuyBack not sent.");
    }
    ...
    function setFees(
        ...
        require(_totalFee <= 26 && _totalSellFee <= 26 && _totalTransferFee <= 20);
        totalFee = _totalFee;
