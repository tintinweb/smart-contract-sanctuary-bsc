...
contract Private1Lock is Ownable {
    using SafeERC20 for IERC20;
    mapping(address => uint256) public balance;
    mapping(address => uint256) public claimedByUser;
    mapping(address => uint256) public balanceInBUSD;
    uint256 public tokenPriceBUSD = 12e14;
    uint256 public maxBusdAmount = 5000e18;
    uint256 public minBusdAmount = 1000e18;
    uint256 public avalableToClaimGlobal;
    uint256 public unlockPeriod = 2592000; // 2592000 - 30 days in seconds
    uint256 public unlockPercent = 60; // 60 its 5%
    uint256 public cliff = 3;
    ...
    address public tokenAddress = 0xD5D7d581517755A091714C024C28d1346cab3B6B; // TOKEN CONTRACT ADDRESS
    address public marketingAddress = 0xf9e6a427cB81a9533F083F816877B2D5FEB2fF11;
    address public teamAddress = 0x21D456ad06714FB8Fb54b559403E2eA3110b2c5f;
    uint256 public marketingPercent = 167;
    uint256 public teamPercent = 139;
    uint256 public liquidityPercent = 694;
    ...
    function startVesting() public onlyOwner() {
        ...
        _token.safeTransfer(address(0xdead), burnAmount);
    ...
    function claim() public {
        ...
        if (block.timestamp > nextUnlock) {
            level += 1;
            if (level == 2) unlockPercent = 50;
            if (level == 3) unlockPercent = 60;
