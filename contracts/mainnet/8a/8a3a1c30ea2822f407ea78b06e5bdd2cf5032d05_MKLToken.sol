...
contract MKLToken is Context, IERC20, Ownable {
    ...
    address public _fundAddr = address(0x742499427a41087532dF277A0B9581F90cA2e78F);
    address public _nftAddr = address(0x97796166de3548c4ce50a247F1dCB7B49acbb451);
    address public _fomoAddr = address(0xC6023EeC6A80cDbF484C4C34a5BFEb07E252D011);
