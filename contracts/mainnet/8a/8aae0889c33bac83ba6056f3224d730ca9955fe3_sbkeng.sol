...
contract sbkeng is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SB坑";
    string private _symbol = unicode"SB坑";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x9f1aF41760F0Cb9007b7b542D4186fdd6eF55adF); 
    address payable private teamWalletAddress = payable(0x9f1aF41760F0Cb9007b7b542D4186fdd6eF55adF); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**1 * 10**_decimals;
