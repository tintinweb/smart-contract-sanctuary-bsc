...
contract EnglandInu is Context, IERC20, Ownable {
    ...
    string private constant _name = " England Inu "; // 
    string private constant _symbol = " $ENGNU "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xFe7C47790e2E7F5e954d3F0120c338EC8Edb15cA;
