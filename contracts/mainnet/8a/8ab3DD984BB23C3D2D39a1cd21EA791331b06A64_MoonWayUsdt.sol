...
/**
 ...
 //Community : https://t.me/Moonwayusdt
       Great features:
       ...
       it's the best part of the #Moonwayusdt idea, increasing the liquidity pool automatically, 
...
contract MoonWayUsdt is Context, IERC20, Ownable {
    ...
    string private _name = "MoonWayUsdt";
    string private _symbol = "MoonWayUsdt";
    ...
    uint256 private minimumTokensBeforeSwap = 3000000 * 10**6 * 10**9; 
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0xC03638AE1bB5b0d88765C0DAc6fc6AF454740817;
