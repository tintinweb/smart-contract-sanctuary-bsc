...
/**
         ...
         // CrypTok - CT // Streaming Flatform // Rewards BUSD
/*  
Telegram : https://t.me/CryptokCN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07ac1F685CB19FAc6a1C52AAE76164C0a2Dc01ed; 
...
contract CrypTok is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrypTok";
    string private _symbol = "CT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07ac1F685CB19FAc6a1C52AAE76164C0a2Dc01ed); // 
    address payable public teamWalletAddress = payable(0x07ac1F685CB19FAc6a1C52AAE76164C0a2Dc01ed); // 
