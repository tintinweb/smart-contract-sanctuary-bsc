...
contract PontusArk is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1e9 * 10**18; // 0.1%
    uint256 public maxBuyLimit = 1e10 * 10**18; // 1%
    uint256 public maxSellLimit = 1e10 * 10**18; // 1%
    uint256 public maxWalletLimit = 1e10 * 10**18; // 1%

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x0f908e5897a638736ae2623d7Cf8f0428Daf3100;
    ...
    constructor() BEP20("PontusArk", "PARK") {
       _tokengeneration(msg.sender, 200 * 10**6);
        ...
        exemptFee[0x0f908e5897a638736ae2623d7Cf8f0428Daf3100] = true;
