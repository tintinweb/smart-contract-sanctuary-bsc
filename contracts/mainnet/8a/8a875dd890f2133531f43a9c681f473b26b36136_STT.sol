...
abstract contract AbsToken is ERC20, Ownable {
    ...
    uint256 private _buyBurnFee = 200;
    uint256 private _sellFundFee = 500;

    uint256 private numTokensCanSwap = 20000 * 10**18;
    ...
    function setNumTokenForReward(uint256 _numTokensCanSwap) external onlyOwner {
        numTokensCanSwap = _numTokensCanSwap;
    }
...
contract STT is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//RouterAddress
        "STT",//Name
        "STT",//Symbol
        90000000 * 10**18,//Supply
        address(0x46552DB55c5aF10057f34283AD9e9CdC42c3A73b),//FundAddress
        address(0x9249E2d331C87D5ee616B4a208505C3585EFBD7B)//ReceiveAddress
    ){
