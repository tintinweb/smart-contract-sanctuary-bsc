...
/**
Welcome to Cloud Chat Burn, Where we buy Cloud chat tokens and burn them. 
Telegram: https://t.me/cloudchatburn
Twitter:    
*/
...
contract Cloudchatburn is IBEP20, Auth {
    ...
    string constant _name = "Cloud Chat Burn";
    string constant _symbol = "CCB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;  // max tx
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;  // max wallet
    ...
    address private marketingFeeReceiver =0xE821dD752EABa0C65f2C425924622DcE2739946B;
    address private teamFeeReceiver =0xE821dD752EABa0C65f2C425924622DcE2739946B;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xE821dD752EABa0C65f2C425924622DcE2739946B;
