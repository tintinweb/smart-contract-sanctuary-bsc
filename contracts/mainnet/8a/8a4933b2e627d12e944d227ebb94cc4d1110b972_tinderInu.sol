...
Name    : tinder Inu - Show your love and go 69!
Symbol  : $TININU
Supply  : 69, the unique number of exotic love

Let me seduce you and come to me in my TG! Many scams don't know love. 
That is why they invariably mention their so-called ''TG group" in the introduction.
Later you discover that you have just been taken in your crypto hole...

So: just type "tinder Inu official" and you'll find me!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20  RWRD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $BUSD reward asset
...
contract tinderInu is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address public marketingFeeReceiver     = 0x1f1e35d82D87d153Ba58262731A62fEA74470313;
    ...
    uint256 public _maxBuyTxAmount          = _totalSupply * 200 / 10000;       // 2% = 1,38 token
    uint256 public _maxSellTxAmount         = _totalSupply * 100 / 10000;       // 2% = 0,69 token
    uint256 public _maxWalletToken          = ( _totalSupply * 200 ) / 10000;   // 2% = 1,38 token
