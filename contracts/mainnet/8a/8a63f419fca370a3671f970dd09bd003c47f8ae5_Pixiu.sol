...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2431304Ad110088B685B510321A280A39DB7BFc7;
...
contract Pixiu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xCEd967D80ecC96d01a66fB37AeE361811bCca452);
    ...
    */
    ...
    // Toggle on and off to auto process tokens to TX wallet 
    ...
    // This function is required so that the contract can receive TX from pancakeswap
    ...
    */
    ...
    Fees are added to the contract as tokens, these functions exchange the tokens for TX and send to the wallet.
    One wallet is used for ALL fees. This includes liquidity, marketing, development costs etc.

    */


    // Send TX to external wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForTX(contractTokenBalance);
        uint256 contractTX = address(this).balance;
        sendToWallet(Wallet_Dev,contractTX);
    }
    ...
    // Swapping tokens for TX using PancakeSwap 
    function swapTokensForTX(uint256 tokenAmount) private {
