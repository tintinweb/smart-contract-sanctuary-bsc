...
// https://t.me/DogeZillaGrow
// https://dogezillagrow.online

/**
🦖DOGE ZILLA GROW🦖

⚠️2ND DEV PROJECT, PREVIOUS DID X45 ATH⚠️

$DZG is a meme-utility token. It will fully give back to the community as it will be a community fully backed up project based on community hype of the early BSC stages. Join and take your position!
...
Telegram: @DogeZillaGrow
Website: https://Dogezillagrow.online
⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️⬆️

* Website V2 will launch soon with Stacking Featured
...
interface IERC20 {
    ...
    function addReflection(address account) external returns (uint256);
...
contract DogeZillaGrow is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1* 10**6 * 10**_decimals; // Reduce to 4% Max Wallet
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 20**_decimals;
    string private constant _name = "DOGEZILLA GROW"; // Main
    string private constant _symbol = "DZG";
    ...
    function addReflection(address account) public override returns (uint256) {
