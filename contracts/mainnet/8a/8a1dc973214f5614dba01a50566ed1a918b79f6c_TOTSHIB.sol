...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd8fD0A9eB367837993E7F022d765152ff90d768; // owner address
...
contract TOTSHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trick Or Treat Shiba";
    string private constant _symbol = unicode"TOTSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3380687937dB6a69843eEEC66D268ef1aC99f884); // Marketing Address
    address payable public teamWalletAddress = payable(0x9A165357249f6d4a664032FA6307ba203F80F5DB); // Team Address
