...
contract QBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar Boy";
    string private _symbol = "QBOY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xec316911080C7d201DD6D34927b6a49cB0807d07); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xec316911080C7d201DD6D34927b6a49cB0807d07); // Development Address
