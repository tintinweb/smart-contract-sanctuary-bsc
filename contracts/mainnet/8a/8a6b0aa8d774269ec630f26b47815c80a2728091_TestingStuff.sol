...
contract TestingStuff is Context, IERC20 {
    ...
    string private constant TOKEN_NAME = "Testing Stuff";
    string private constant TOKEN_SYMBOL = "TESTING";
    ...
    uint256 constant public MAX_TAX = 2500;
    ...
    uint256 public buyMaxTxPercent = 1;
    ...
    uint256 public sellMaxTxPercent = 1;
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if(to == lpPair) {
                ...
                require(sell_AllowedTime[to] < block.timestamp, "Anti-bots enabled: The waiting period is 30 seconds");
                sell_AllowedTime[to] = block.timestamp + (30 seconds);
            } else {
