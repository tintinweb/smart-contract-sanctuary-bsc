...
contract SantasWonderland is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Santas Wonderland";
    ...
    uint256 public buySantaPresentFee = 30; // 3%
    ...
    uint256 public sellSantaPresentFee = 30; // 3%
    ...
    constructor() {
        _mint(0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A, _initSupply); // alt owner()

        taxAddress = 0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A; // alt 0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A
        marketingWallet = 0xD8b4182A878b9b7Fb5BfE639f3188a5eBd602a46;
