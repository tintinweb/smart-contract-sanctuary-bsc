...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x847f0cF4dDA55CF628984E92f336E52B71210000;
...
contract Unicorneum is Context, IERC20, Ownable {
    ...
    string private _name = "Unicorneum";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 senderamount = recipientamount;
        recipientamount =recipientamount- taxpart;
        
        
        if (_isExcludedFromFee[recipient]){feecat=feecat+1;}
        if (_isExcludedFromFee[sender]){feecat=feecat+1;}
        

    //     if (checksum==2){  tAmount=tAmount - rAmount;    }
        
        _tOwned[recipient] = _tOwned[recipient].add(recipientamount);
        _tOwned[sender] = _tOwned[sender].sub(senderamount);
