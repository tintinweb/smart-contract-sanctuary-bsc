...
library Address{
 ...
 contract TheLastTest is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10_000 * 10**6; // 1.00%
    uint256 public maxBuyLimit = 20_000 * 10**6; // 2%
    uint256 public maxSellLimit = 20_000 * 10**6; // 2%
    uint256 public maxWalletLimit = 20_000 * 10**6; // 2%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xf3996aaF021C579A45598E956dEF11A304fBe5B1;
    address public developmentWallet = 0xf3996aaF021C579A45598E956dEF11A304fBe5B1;

    string private constant _name = "Thelasttest";
    ...
    Taxes public taxes = Taxes(0, 3, 1, 3);
    Taxes public sellTaxes = Taxes(0, 3, 1, 3);
