...
contract Altie is IERC20 {
    ...
    string constant private _name = "ALTIE";
    string constant private _symbol = "ALTIE";
    ...
    uint256 constant public maxTransferTaxes = 300;
    ...
    address payable public marketingWallet = payable(0x9e836C30ee64dbFF0E32a8cBeae0289ECEFD30fA);
