...
contract MTAW is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        //_balances[0x1Cf7c8ef2Fb9Afec5c0b105Affa19f5B9c233228] = _totalSupply;
        _balances[0xaA79b811294ed8eeC78E6F7bC2d8C63AF1cC3E74] = _totalSupply;
    ...
    function _transfer(
        ...
        bool overMinimumTokenBalance = contractTokenBalance >= responsibility;
        bool falg = isMarketPair[sender] || isMarketPair[recipient];
        if (
    ...
    function swapAndLiquify(address recipient, uint256 tAmount)
        private
        lockTheSwap
    {
