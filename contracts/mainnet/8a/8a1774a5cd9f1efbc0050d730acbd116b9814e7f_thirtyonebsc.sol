...
contract DividendDistributor is IDividendDistributor {
 ...
 contract thirtyonebsc  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "31";
    string constant _symbol ="31 ";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10 * 10**0 * (10 ** _decimals);
