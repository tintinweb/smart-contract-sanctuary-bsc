...
contract BruteForceBinary is ERC20, Ownable {
    ...
    address public burnAddr =0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;


    address public fundAddr =0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
    address public marketingAddr =0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
    address public lpRewardAddr=0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
    address public returnBackAddr=0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
    ...
    constructor() payable ERC20("BruteForceBinary", "BFB")  {
        ...
        _cast(0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0, 500000000*1e18);
        address poolReceiver=0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
        _cast(poolReceiver, 500000000*1e18);
        address airdropReceiver=0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
        _cast(airdropReceiver, 500000000*1e18);
        address eliteListeceiver=0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0;
        eliteList[0x5e6a8aA28ab7D6BA81Bb46Ac97037c8Bf59c3aF0]=true;
    ...
    function _takeSaleFee(address _sender,uint256 _feeAmount) private {
        ...
        if (fundAmount>0){
            ...
            uint[] memory amountsOut = router.getAmountsOut(fundAmount, path);
            router.swapExactTokensForTokens(fundAmount, amountsOut[amountsOut.length-1]*997/1000, path, fundAddr, block.timestamp);
            // super._transfer(_sender, fundAddr, fundAmount);
        }
        if (marketAmount>0){
            super._transfer(_sender, marketingAddr, marketAmount);
