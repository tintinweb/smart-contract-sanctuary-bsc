...
contract SOKUINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x9D38FC234418CE4E9B02034F7707F540Eb97453c); 
    address payable public vaultRewardAddress = payable(0x9D38FC234418CE4E9B02034F7707F540Eb97453c); 
    address payable public _owner = payable(0x9D38FC234418CE4E9B02034F7707F540Eb97453c);
    ...
    string private constant _name = "SOKU INU";
    string private constant _symbol = "SOKUINU";
    ...
    // Protocol Fees
    uint256 public _bMaxTxAmount = 10000000  * 10**18;
    uint256 public _sMaxTxAmount = 10000000  * 10**18;
