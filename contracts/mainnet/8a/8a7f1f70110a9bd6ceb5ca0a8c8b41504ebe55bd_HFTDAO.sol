...
contract HFTDAO is HFTDAODeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HFTDAOTeam;
    address private CharityHFTDAO;
    ...
    string public override name = "HFTDAO";
    string public override symbol = "HFTDAO";
    ...
    constructor(uint totalSupplyValue, address HFTDAOTeamAddress, address CharityHFTDAOAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HFTDAOTeam = HFTDAOTeamAddress;
        CharityHFTDAO = CharityHFTDAOAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HFTDAOTeam] =  totalSupply * 5 / 100;
        balances[CharityHFTDAO] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's HFTDAOTeam pot
