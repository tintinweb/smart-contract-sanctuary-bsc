...
contract KINGDOMBULLDOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "KINGDOM BULLDOG"; // 
    string private constant _symbol = "$KDBD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xd624E2D5537591aAB4482488fEf0c673d113C270;
