...
contract babysgdoge is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balance;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private _name = "Baby struggle doge";
    string private _symbol = "Baby SGDOGE";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 11000000000 * 10 ** _decimals;
    uint256 private _Tokenss = 11000000000 * 10 ** _decimals;
