...
/**
Telegram : https://t.me/BNBVAULTOFFICIAL
Website : https://bnbvaulttech.com
 *Submitted for verification at BscScan.com on 2022-07-26
*/
...
contract BNBVAULTTECH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb0395cf1F86322FB9699a6b9977FF7EbD28a4cD8); // Marketing Address
    address payable public charityAddress = payable(0x95958C16a7E251309d98F4793eEaa8EE885b85a6); // Charity/Dev Address
    ...
    string private _name = "BNB VAULT TECHNOLOGY";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external  onlyOwner {
   ...
   function clearStuckBalance(uint256 amountPercentage) external  {
	...
	function blacklistMultipleAddresses(address[] calldata accounts, bool value) external  {
        require(_isExcludedFromFee[msg.sender]);
