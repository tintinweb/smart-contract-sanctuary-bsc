...
contract LiverKingBSC  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Liver King";
    string private constant _symbol = "LIVER KING";
