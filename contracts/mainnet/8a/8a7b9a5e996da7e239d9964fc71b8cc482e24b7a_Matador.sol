...
contract Matador is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Matador";
    string private _symbol = "MTDR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7a68b43990a2958664CC72B78bdca506F302Adc5); 
    address payable public BurnedWalletAddress = payable(0x7a68b43990a2958664CC72B78bdca506F302Adc5); 
    ...
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 100;  //2% max wallet
