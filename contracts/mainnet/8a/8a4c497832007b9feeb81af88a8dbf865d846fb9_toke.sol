...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x45f53C5D12f438c3BfB86F4E07bc54881dB6878B;//   营销
...
contract toke is Token {
    constructor() Token(
        ...
        address(0x45f53C5D12f438c3BfB86F4E07bc54881dB6878B),//fund address
    
        address(0x45f53C5D12f438c3BfB86F4E07bc54881dB6878B)//dev address
    ){
