...
contract SwageBoy is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xEa741B8967b4AA6fb6440D8C3A55B123155422a1); 
    address payable private Wallet_Dev = payable(0xEa741B8967b4AA6fb6440D8C3A55B123155422a1);
    ...
    string private constant _name = "Swage Boy"; 
    string private constant _symbol = unicode"SWAGE"; 
    ...
    constructor () {
        ...
        _owner = 0xEa741B8967b4AA6fb6440D8C3A55B123155422a1;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEa741B8967b4AA6fb6440D8C3A55B123155422a1); // Testnet
