...
contract BUSDPosiVaultOld is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, VestingScheduleLogic {
    ...
    */
    ...
    function getTwapPipAvailable(uint256 itv) public view returns (uint256){
    ...
    function _convertEarnedTokenToPOSI(uint256 _baseAmount) private view returns (uint256){
        ...
        // Twap 3 days
        uint256 _twapPip = getTwapPipAvailable(259200);
...
library TwapLogic {
    ...
    function push(ReserveSnapshot[] storage reserveSnapshots, uint128 pip, uint64 timestamp, uint64 blockNumber) internal {
