...
contract THREEDCAT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "3D CAT";
    string private _symbol = "3DC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8182e2cbCa5E7e19be00232B14684f8571F27F77);
    address payable public liqWalletAddress = payable(0x8182e2cbCa5E7e19be00232B14684f8571F27F77);
