...
contract v2e is ERC20 {
	...
	address private _marketAddress = address(0xF8cdf806318E1733C37a9F26d025eb94B1a545A9);
	address private _downAddress = address(0x1a9d292Ae0A383D07079F9E92c054550148c035f);//下跌10%后的收币
	...
	uint256 total;
	uint256 maxTotal;
    constructor(address tokenOwner) ERC20("v2e", "v2e") {
	...
	function getUserCanMint(address account) public view returns (uint256){
		...
		if(userStartTime> 0 && haveAmount >= 10**20 && tokenStartTime < block.timestamp && maxCanMint && managerCanMint){
			uint256 secondAmount = haveAmount.div(100).div(600);
