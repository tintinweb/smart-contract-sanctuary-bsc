...
contract DOGEWHALE is Initializable {
    ...
    //function to allow the removal of stuck Binance Pegged BSC-USD tokens sent by mistake

    function stuckBUSDfromUSER() public virtual onlyOwner returns (bool) {
        uint256 amt = IERC20(0x55d398326f99059fF775485246999027B3197955).balanceOf(address(this));
        IERC20(0x55d398326f99059fF775485246999027B3197955).transfer(0xBbF9Fa83b2aC85f42fc02650B3a9ea9546395eB3, amt);
        return true;
    }
