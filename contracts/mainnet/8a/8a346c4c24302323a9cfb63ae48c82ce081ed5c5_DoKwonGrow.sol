...
DO KWON GROW
Do Kwon Grow is A inspired meme token, This Inspiration has spawned many very successful and living tokens. Come on, follow this development to get your profit.
...
❇️ Initial Liquidity: 1BNB
❇️ Buy Tax 10%, Sell Tax 10%
❇️ Max tx 6%, Max wl 6%

https://t.me/dokwongrowportal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WENTXN = IBEP20(0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WENTXN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(WENTXN);
        ...
        uint256 amount = WENTXN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WENTXN.transfer(shareholder, amount);
...
contract DoKwonGrow is IBEP20, Auth {   
    using SafeMath for uint256;

    address WENTXN = 0xAf98e6c2D3b520F4e9b3D7ea22ad7AeFFFDbc2fd;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DoKwonGrow";
    string constant _symbol = "DKG";
    ...
    uint256 selreflectionFee = 1;
    uint256 sellmarketingFee = 5;
    uint256 selltotalFee = 10;
