...
Griva Inu $GRIVA - Grimace Valentine
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29ba604f5D9022894308a24B5Da9e67966F741d1; 
...
contract GrivaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Griva Inu";
    string private _symbol = "GRIV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29ba604f5D9022894308a24B5Da9e67966F741d1); // 
    address payable public teamWalletAddress = payable(0x29ba604f5D9022894308a24B5Da9e67966F741d1); // 
