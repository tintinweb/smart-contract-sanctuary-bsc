...
contract messi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA4A4D834832a0C5EBcdB05BdDFCd5D17022D9f3D);
    address payable public teamWalletAddress = payable(0x2E0fF217439784B4ba7309257C8Db089F4897734);
    ...
    uint256 public _walletMax =     75000000 * 10**_decimals;   //3%   
