...
contract KM is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 100000;
	
	uint256 public MAX_MINT_SALE = 1000;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 1000;
	
	uint256 public SALE_PRICE = 0.02* 10**18;
    ...
    uint256 public amount = 50000000000000000000;

    constructor(address _tokenAddress, address _tokenOwner) ERC721P('KISS ME', 'KM') {
	...
	function mintSaleNFT(uint256 _count) public payable{
        ...
        tokenAddress.transferFrom(tokenOwner, msg.sender, amount * _count);
    }
