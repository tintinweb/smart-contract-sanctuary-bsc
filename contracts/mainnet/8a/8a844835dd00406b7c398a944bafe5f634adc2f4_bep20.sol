...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f6ef8B686868b8C04E7e338ec0EFe3a00b44C4f; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Rabbit 2023";
    string private _symbol = "metarabbit2023";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f6ef8B686868b8C04E7e338ec0EFe3a00b44C4f); // Marketing Address
    address payable public teamWalletAddress = payable(0x2f6ef8B686868b8C04E7e338ec0EFe3a00b44C4f); // Team Address
