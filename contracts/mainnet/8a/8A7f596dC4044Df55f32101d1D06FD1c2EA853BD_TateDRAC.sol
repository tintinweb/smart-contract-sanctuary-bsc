...
contract TateDRAC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "TateDRAC";

    string private _symbol = "TD";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xcfd705EefB9664fD9dAE784918B4a54df07223Eb;
