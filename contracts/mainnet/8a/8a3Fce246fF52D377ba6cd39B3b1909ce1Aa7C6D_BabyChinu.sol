...
WHY THE TAX SO HIGH YOU ASK?
ITS A REWARDS TOKEN HOW DO YOU EXPECT TO GET REWARDS!
*/
...
contract BabyChinu is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Baby CHungus Inu';
    string private constant _symbol = 'BabyChinu';
