...
// Telegram: https://t.me/WagmiNewYear
// https://medium.com/@wagminy/wagmi-new-year-b2b172a146e0
...
contract WAGMINEYYEAR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WAGMI NEY YEAR";
    string private _symbol = "$WAGMINY";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0xD4D1C3830E9302acB29BC9FDA765bCe2CE893048); // Marketing Address
    address payable private TeamWallet = payable(0x8eEdd96E6aD011E3cD3E463Ca742Bd8fFFef862c); // Buy Back Address
