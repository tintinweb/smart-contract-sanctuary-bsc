...
// Telegram : https://t.me/catsdogINU
...
contract CATSDOGINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATSDOG INU";
    string private _symbol = "CATSDOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7b5EC51185363e30dBf172b62aF8CC104a2F6e30); 
    address payable public teamWalletAddress = payable(0x7b5EC51185363e30dBf172b62aF8CC104a2F6e30); 
    ...
    uint256 public _maxTxAmount = 5 * 10**6 * 10**_decimals; //(5%)
    uint256 public _walletMax = 6 * 10**6 * 10**_decimals; //(5%)
