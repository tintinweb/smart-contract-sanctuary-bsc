...
/*      Inurai - Meme Token - 100% driven By Community - Potential explotion

            Telegram : https://t.me/Inuraiportal
            Website : https://inurai.org/
...
contract INURAI is Context, IERC20 { 
    ...
    string private constant _name = "Inurai Coin"; 
    string private constant _symbol = unicode"INURAI"; 
    ...
    function _transfer(
        ...
        _tokenTransfer(from, to, amount, takeFee, isBuy, isBuyDev);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy, bool isBuyDev) private {
