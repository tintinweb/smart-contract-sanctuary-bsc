...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x195DB3B2710f9c057B5c3DCf124eA4e2A049ffFC; 
...
contract qingrenjie is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "qingrenjie";
    string private _symbol = "qj";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x195DB3B2710f9c057B5c3DCf124eA4e2A049ffFC); // 
    address payable public teamWalletAddress = payable(0x195DB3B2710f9c057B5c3DCf124eA4e2A049ffFC); // 
