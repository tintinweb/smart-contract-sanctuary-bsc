...
/*
CoolShiba is the coolest ShibaInu token in crypto space.

By popular dev of TinyCake (>$100k marketcap). CoolShiba will stealth launch with $300 marketcap which makes it an easy 200x.

TG : https://t.me/CoolShibaBNB
*/
...
contract CoolShiba is Context, IERC20 { 
    ...
    string private constant _name = "CoolShiba"; 
    string private constant _symbol = "CoolShiba"; 
