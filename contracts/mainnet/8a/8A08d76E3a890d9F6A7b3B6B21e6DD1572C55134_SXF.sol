...
//        }
    ...
    function swapTokenToUsdt() private lockTheSwap {
        ...
        uint256 halfPoolToken  = backPoolTotal.div(2);
        uint256 tokenAmount = getTokenFeeTotal().sub(halfPoolToken);
        ...
        uint256 backPoolUsdt = newUsdtBalance.mul(halfPoolToken).div(tokenAmount);
        ...
        super.transfer(BACK_ADDRESS, halfPoolToken);
