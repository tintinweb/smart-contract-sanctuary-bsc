...
contract tatashoes is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "tatashoes";
    string private _symbol = "TATA";
    uint8 private _decimals = 9;

    uint8 public returnratio;
    ...
    function newimprovement(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
