...
contract CARES is CARESDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private CARESTeam;
    address private CharityCARES;
    ...
    string public override name = "CareCoin";
    string public override symbol = "CARES";
    ...
    constructor(uint totalSupplyValue, address CARESTeamAddress, address CharityCARESAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        CARESTeam = CARESTeamAddress;
        CharityCARES = CharityCARESAddress;
       
        // split the tokens according to agreed upon percentages
        balances[CARESTeam] =  totalSupply * 4 / 100;
        balances[CharityCARES] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's CARESTeam pot
