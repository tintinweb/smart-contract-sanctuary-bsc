...
contract Ownable is Context {
    ...
    function OwnershipRenounced() public virtual onlyOwner {
...
contract COINDEX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Milky ShibaZilla";



    string public _symbol = "MilktShibaZilla";
    ...
    uint256 public _totalSupply =  69000000000000000000 * 10**_decimals;
