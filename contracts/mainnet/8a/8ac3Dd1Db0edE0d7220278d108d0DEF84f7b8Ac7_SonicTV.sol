...
/**
*SONIC TV BSC . THE NEXT MOONSHOOT
Telegram: https://t.me/SONICTVBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x723bD1d4d356A802Ece268B7408aa36a64Eb8c77; // owner address
...
contract SonicTV is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sonic-TV";
    string private _symbol = "STV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x723bD1d4d356A802Ece268B7408aa36a64Eb8c77); // Marketing Address
    address payable public teamWalletAddress = payable(0x723bD1d4d356A802Ece268B7408aa36a64Eb8c77); // Team Address
