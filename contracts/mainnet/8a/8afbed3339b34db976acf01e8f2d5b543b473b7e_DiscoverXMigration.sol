...
// Main Contract
contract DiscoverXMigration is Ownable, ReentrancyGuard {
    ...
    IBEP20 public tokenV1 = IBEP20(0x4AC32178097c1f62beadCC2D215B54D6915013ee);
    ...
    function claimV2() public nonReentrant{
        require(address(tokenV2) != address(0) && tokenV2.balanceOf(tokenV2Pair) > 0, "DXT token hasn't launched yet");
        ...
        uint256 claimAmount = userInfo[msg.sender].depositeddAmountV1;
        tokenV2.transfer(msg.sender, claimAmount);
        userInfo[msg.sender].claimed = true;
    }

    function isClaimable() public view returns (bool){
        if(address(tokenV2) != address(0) && tokenV2.balanceOf(tokenV2Pair) > 0)
            return true;
        else
            return false;
    }
    ...
    function claimableV2Amount(address account) public view returns (uint256) {
        ...
        return userInfo[account].depositeddAmountV1;
    }
    ...
    function switchStatus() public onlyOwner{
        openForDeposit = !openForDeposit;
    }

    function setupV2(address v2Adress, address v2Pair) public onlyOwner{
        tokenV2 = IBEP20(v2Adress);
        tokenV2Pair = v2Pair;
    }
    ...
    function withdrawV2(uint256 amount) public onlyOwner{
