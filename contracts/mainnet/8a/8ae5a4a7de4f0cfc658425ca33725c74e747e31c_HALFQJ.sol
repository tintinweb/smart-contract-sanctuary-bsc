...
contract HALFQJ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HALF QJ";
    string private _symbol = "HALFQJ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c7740A5D96fdd3312D5C77A070C862C197191f3); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x6c7740A5D96fdd3312D5C77A070C862C197191f3); // Developmental Address
