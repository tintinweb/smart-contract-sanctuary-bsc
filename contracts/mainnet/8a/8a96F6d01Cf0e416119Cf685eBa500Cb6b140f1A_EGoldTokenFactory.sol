...
contract EGoldTokenFactory is AccessControl {
    ...
    function createToken(
        ...
        ctr = ctr.add(1);
        EGoldToken MWH = new EGoldToken( name_ , symbol_ , to_ ,  msg.sender );
...
contract EGoldToken is AccessControl, ERC20Snapshot, Pausable, ReentrancyGuard {
    ...
    function setCoolDown(uint256 _limit , bool _limitSwitch ) external virtual onlyRole(DEFAULT_ADMIN_ROLE) returns (bool) {
        limit = _limit;
    ...
    function _beforeTokenTransfer(
        ...
        if ( to.isContract() == true && isWhitelist == true ) {
            ...
            if( holdLimitSwitch == true ){
                require( balanceOf(to) <= holdLimit, "ERC20Blockable: HoldLimit Exceeded" );
            }
            if ( limitSwitch == true ){
