...
contract DogeSharkzilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeSharkzilla";
    string private _symbol = "DogeSharkzilla";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x33c6F558632b5C503e41a992961d9F905aF0A479); // Marketing Address
    address payable private teamWalletAddress = payable(0x33c6F558632b5C503e41a992961d9F905aF0A479); // Team Address
    ...
    uint256 public _walletMax = 1000000000000000000000 * 10**_decimals;
