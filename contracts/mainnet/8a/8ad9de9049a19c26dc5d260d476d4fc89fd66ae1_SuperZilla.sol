...
//telegram: https://t.me/superzilla_bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDa9916910D3E11149E97b7b5b1798958b194646C;
...
contract SuperZilla is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xDa9916910D3E11149E97b7b5b1798958b194646C);
    ...
    */
    ...
    string private _name = "Superzilla"; 
    string private _symbol = "Superzilla";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/1000000000000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/1000000000000;
    }
