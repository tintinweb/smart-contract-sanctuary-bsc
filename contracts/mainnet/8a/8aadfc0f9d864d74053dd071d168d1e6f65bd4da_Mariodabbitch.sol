...
/**
Telegram: https://t.me/mariodabbitch 
*/
...
contract Mariodabbitch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x248A453061219f8EB54Ff4A3C8922D1D46e955Db); // Marketing Address
        
    address payable public teamAddress =
        payable(0x248A453061219f8EB54Ff4A3C8922D1D46e955Db); // Team Address

    address payable public liquidityAddress =
        payable(0x248A453061219f8EB54Ff4A3C8922D1D46e955Db); // Liquidity Address
    ...
    string private constant _name = "Mario Dab Bitch";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x248A453061219f8EB54Ff4A3C8922D1D46e955Db).call{value: bnbForDev}("");
