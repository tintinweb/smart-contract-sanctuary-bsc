...
// Telegram: t.me/moonsterfinance
// Website: https://www.moonster-finance.com
// Twitter: @moonsterfinance
// To begin your journey, MoonsterFinance offers you a 10% rewards in the current asset from every transaction!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x5159bD194Bfe0B44123650A13c8ee17798B830eC);
...
contract MOONFI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Moonster-Finance.com";
    string constant _symbol = "MOONFI";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 500000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 150; // 12500

    //max wallet holding of 15%
    uint256 public _maxWalletToken = ( _totalSupply * 15 ) / 100;//30000
    ...
    uint256 marketingdevelopmentFee = 800;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x7Af09b34346Ecc51aB85fd76c330E55318eD07E1; 
