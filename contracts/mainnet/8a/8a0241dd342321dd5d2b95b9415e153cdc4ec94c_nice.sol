...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xE0A0156640174680Ac3CDe953B8F2a5D8d381336;//   营销
...
contract nice is Token {
    constructor() Token(
        ...
        address(0xE0A0156640174680Ac3CDe953B8F2a5D8d381336),//fund 

        address(0xE0A0156640174680Ac3CDe953B8F2a5D8d381336)//dev 
    ){
