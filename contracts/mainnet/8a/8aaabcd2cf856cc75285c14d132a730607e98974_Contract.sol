...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Blue Lock World Cup"; //
    string private constant _symbol = "Blue Lock"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xB2ACD6c25b12bd97cBE000e2D4EbA7A930DcB4FD;
