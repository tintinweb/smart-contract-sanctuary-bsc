...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 80 * 10** Decimals;
        walletLimit =  120* 10** Decimals;
...
contract syp is AbsToken {
    constructor() AbsToken(
        ...
        "Su Youpeng girl",//Name
        "syp",//Symbol
        5,//Decimals
        120000,//Supply
        address(0x4607d36A73524B3d569198583E7F4F14960BD520),//FundAddress
        address(0x5856F46fE5279a5eB8DCF755297F74f4073a7c79)//ReceiveAddress
    ){
