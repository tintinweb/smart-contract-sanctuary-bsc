...
contract INURAI is Context, IERC20 { 
    ...
    bool private TradingOption = false;
    ...
    function _transfer(
        ...
        _tokenTransfer(from, to, amount, takeFee, isBuy, isBuyDEV, buyFee);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy, bool isBuyDEV, bool buyFee) private {
