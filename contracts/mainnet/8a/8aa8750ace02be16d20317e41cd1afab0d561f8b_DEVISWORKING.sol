...
Telegram: https://t.me/devisworking
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0xe5FeFc0b0835a46A9e04dFfd2A27572437386568;
...
contract DEVISWORKING is Context, IERC20, Ownable {
    ...
    string private constant _name = "DEV IS WORKING"; // 
    string private constant _symbol = "$DEVWORK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0xe5FeFc0b0835a46A9e04dFfd2A27572437386568);
