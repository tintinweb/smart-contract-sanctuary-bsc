...
/* Token contract */
contract MUUROCKET is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "MUU ROCKET";
    string constant _symbol = "MROCKET";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 3% or 1M tokens
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 23; 
