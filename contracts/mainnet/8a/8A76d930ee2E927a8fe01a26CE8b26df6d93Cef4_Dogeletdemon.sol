...
contract Dogeletdemon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dogeletdemon";
    string private _symbol = "Dogeletdemon";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x90eCC470d1446CF4058eD14cf5e93627A0a451c5); 
    address payable private teamWalletAddress = payable(0xB7fca1C6dAaa77F54Ed2aDBd25b024490055745a); 
