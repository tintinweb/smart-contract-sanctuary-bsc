...
Telegram : https://t.me/CrogePowBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x666ab4B4BF0edAF05CFFd0dfaB11D4c5f098BE3D;
...
contract Croge is Context, IERC20, Ownable {
    ...
    string private constant _name = "CROGEPoW"; // 
    string private constant _symbol = "$CPoW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x666ab4B4BF0edAF05CFFd0dfaB11D4c5f098BE3D);
