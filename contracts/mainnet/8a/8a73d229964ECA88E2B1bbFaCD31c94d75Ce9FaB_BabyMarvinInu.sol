...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 MARVIN = IBEP20(0x71aB195498b6dC1656aBb4D9233f83Ae5F19495B); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = MARVIN.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(MARVIN);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = MARVIN.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           MARVIN.transfer(shareholder, amount);
...
contract BabyMarvinInu is IBEP20, Auth {
   ...
   address MARVIN = 0x71aB195498b6dC1656aBb4D9233f83Ae5F19495B; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby Marvin Inu";
   string constant _symbol = "BMarvin";
...
uint256 reflectionFee = 5;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x96C5872CB4F1f08a55a17F21d2765E6a595819b6; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x96C5872CB4F1f08a55a17F21d2765E6a595819b6; //Can be change to any wallet you want
       marketingFeeReceiver = 0x96C5872CB4F1f08a55a17F21d2765E6a595819b6; //Can be change to any wallet you want
