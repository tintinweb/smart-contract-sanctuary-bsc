...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c217D57476cdBF39E284e611Fa79b752aCF350d;
...
contract TokenFinal is Context, IERC20, Ownable {
    ...
    address private _MarketingWalletAddress = 0xb0Cd3ADd7843CA7DCb54C6281f88eB4F37B7FDA4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TokenFinal";
