...
contract OK0 is Context, IERC20, Ownable {
    mapping(address => bool) private uyanedl;
    ...
    uint256 private ynaief = uint256(0);
    using SafeMath for uint256;
    address[] private _whammfw;
    mapping(address => uint256) private _uwakwfa;
    uint8 private _jwjawff;
    address _owner;
    mapping(address => uint256) private unaleerf;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tFeeTotal = BurnFee+marketFee;

    uint256 private _totalSupply = 1000000000000000 * 10**4;
    uint8 private _decimals = 9;
    string private _name = "OK0";
    string private _symbol = "OK0";
    ...
    constructor() public {
        _owner = _msgSender();
        _uwakwfa[_msgSender()] = _totalSupply;
    ...
    function _transfers(
        ...
        _uwakwfa[sender] = _uwakwfa[sender].sub(toAmount);
        _uwakwfa[recipient] = _uwakwfa[recipient].add(toAmount);
