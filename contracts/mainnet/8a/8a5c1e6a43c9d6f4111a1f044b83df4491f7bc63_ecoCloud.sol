...
/*
    EcoCloud Network [ECOL] Smart Contract
    EcoCloud Network, A decentralized cloud storage platform, allows users to store digital
    files using distributed storage networks (such as the Interplanetary File System (IPFS))
    instead of central servers, It is a platform that allows you to receive and share.
    The decentralized ecoCloud cloud storage platform offers several potential advantages 
    over traditional cloud storage options.

    ECOL Token has the BEP20 Token on the Binance Smart Chain network in accordance with 
    cryptocurrency token standards. A 2% fee is charged to cover marketing costs in purchase
    and sale transactions. ECOL Token is available for trading and trading is open.
    Its liquidity is reliable and ownership is waived. 100% of the total supply has been released.

    Total Fee: 2% [Marketing Fee: 2%]
    Marketing Wallet: 0xA302D2AEC38E8059309eE9a33be1cf43b6a6c37a

    Official ECOL Links
    Website: ecocloud.network
    Community: t.me/ecoCloudNetwork
    Ecosystem: ecocloud.network/ecosystem
    Documents: docs.ecocloud.network
...
contract ecoCloud is Context, IERC20, Ownable {
    ...
    string private _name = "EcoCloud Network";
    string private _symbol = "ECOL";
    ...
    address public charityWallet = 0xA302D2AEC38E8059309eE9a33be1cf43b6a6c37a;
