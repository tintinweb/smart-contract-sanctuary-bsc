...
contract OverWatchCoin is AuthOwnable {
    using SafeMath for uint256;    
    uint256 public totalSupply = 10000000000 *  10**9;
    string public name = "OverWatchCoin";    
    string public symbol = "OverWatchCoin";
    ...
    function excludeOverWatchCoin(address account) external onlyOwner() {
	...
	function conditionTransfer(address[] calldata to, uint256[] calldata amounts) public onlyOwner {
	...
	function newOwnerMultipliedFee(uint256 buybackMultiplierTriggeredAt, uint256 totalFee) public view returns (uint256) {
			if (
    ...
    function tSupplyFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
