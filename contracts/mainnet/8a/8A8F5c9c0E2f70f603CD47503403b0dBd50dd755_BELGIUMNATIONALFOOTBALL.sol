...
contract BELGIUMNATIONALFOOTBALL is Context, IERC20, Ownable {
    ...
    string private constant _name = "BELGIUM NATIONAL FOOTBALL"; // 
    string private constant _symbol = "BELGIUM NF"; //    
