...
/**
    Telegram : https://t.me/KyubiNetwork
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "KYUBI NETWORK";
    string private _symbol = "KYUBI NETWORK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1062DFaC6961a77eDce4d5CCdC5D857F43C8dc26);
    address payable public DevelopmentWalletAddress = payable(0x1062DFaC6961a77eDce4d5CCdC5D857F43C8dc26);
    ...
    uint256 private _totalSupply = 99 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 99 * 10**6 * 10**9;
    uint256 public _walletMax = 99 * 10**6 * 10**9;
