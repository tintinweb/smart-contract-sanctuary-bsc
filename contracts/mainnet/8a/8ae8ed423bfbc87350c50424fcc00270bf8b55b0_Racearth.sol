...
contract Racearth is IERC20, Ownable {
    bool public tradingEnabled;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string public constant name = "Racearth";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "Racearth: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "Racearth: transaction fee percentage equals 0");
