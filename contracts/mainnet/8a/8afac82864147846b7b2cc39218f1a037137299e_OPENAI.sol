...
// TG: https://t.me/OPENAIBSC

/** OPENAI BSC

    Elon / vitalik / CZ been talking about this AI for a week, 
    they built their own TG bot with this AI will be the next moonshot brought to you by the Alphabee Team  🐝🚀🔶

    💎DOGE Rewards: 5% 🐕💰

    🔥BURN: 50%
    🧳 Initial LP: 1-3 BNB🔒✔️

    Community cooperation is the key as proven in my previous projects;  
    Just like how Baltasar Gracian Inu [19X], 
    Super Mario Inu  [30X], Tequila  [61X],
    CyberPunk2029  [40X] Maradona [12X] did on Previous.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  DOGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // 5% Rewards
...
/* Token contract */
contract OPENAI is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address DOGE = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // 5% Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x67aF4581ea3780087167A2772CD5c23E004357bF;
    ...
    // Name and symbol
    string constant _name = "OPENAI BSC";
    string constant _symbol = "OPENAI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 5 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4f97E06815Ed1D76ae9588fdAA0Cd302f0987f17;
