...
contract catonyacht is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat On Yacht";
    string private constant _symbol = "COY";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 950;
