...
// SPDX-License-Identifier: MIT
    ...
    contract DESIR is ERC20 {
        ...
        constructor(address _tokenOwner) ERC20("DESIR", "DESIR",_decimals) {
            _mint(_tokenOwner, total);
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
            address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xeFA37c8A6Fa11b7f10330616CC1C57C31Cbc8e53));
            uniswapV2Router = _uniswapV2Router;
            uniswapV2Pair = _uniswapV2Pair;

            operateWallet = address(0x4b2d072D301a0fB29060A68A3D77CFe15C4F8b84);
            communityWallet = address(0x4b2d072D301a0fB29060A68A3D77CFe15C4F8b84);
            lpWallet = address(0x4b2d072D301a0fB29060A68A3D77CFe15C4F8b84);        
            nodeRewardWallet = address(0x4b2d072D301a0fB29060A68A3D77CFe15C4F8b84);
            isExcludedFromFees[_tokenOwner] = true;
        ...
        function _transfer(
            ...
            //交易开始时间
            if(_to == _uniswapV2Pair && balanceOf(_uniswapV2Pair) == uint256(0) && openTime == uint256(0)){
