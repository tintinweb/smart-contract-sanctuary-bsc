...
contract RShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 120,000 rSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 80000 ether;
    uint256 public constant TREASURY_FUND_POOL_ALLOCATION = 20000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _treasuryFund, address _devFund) public ERC20("Rhodium Shares", "RSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Rhodium Share for initial pools deployment
    ...
    /**
     * @dev Claim pending rewards to community, treasury and dev fund
     */
