...
/**
Telegram : https://t.me/WhenIDNworldcup
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D82e9e98af6f9B5d1d2d5d67C6EAc33D69b5E0e; // owner address
...
contract WhenIndonesiaWolrdCup is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "When Indosesia World Cup";
    string private _symbol = "IDNCUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D82e9e98af6f9B5d1d2d5d67C6EAc33D69b5E0e); // Marketing Address
    address payable public teamWalletAddress = payable(0x6D82e9e98af6f9B5d1d2d5d67C6EAc33D69b5E0e); // Team Address
