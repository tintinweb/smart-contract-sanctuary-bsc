...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x247b55bAe1835B5cd97549d57E0f442e10f7c5C0;
...
contract MarvelNFT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x757B6B91c6f8504DAE69B4ab2961F9a563D90444;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MarvelNFT";
    string private _symbol = "MNF";
