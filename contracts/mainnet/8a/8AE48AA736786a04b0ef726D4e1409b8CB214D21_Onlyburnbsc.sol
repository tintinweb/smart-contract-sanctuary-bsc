...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbC77e09BbbC2861723d2Bb9f361f781107338632; // owner address
...
contract Onlyburnbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Onlyburnbsc";
    string private _symbol = unicode"ONLY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbC77e09BbbC2861723d2Bb9f361f781107338632); // Marketing Address
    address payable public teamWalletAddress = payable(0xbC77e09BbbC2861723d2Bb9f361f781107338632); // Team Address
