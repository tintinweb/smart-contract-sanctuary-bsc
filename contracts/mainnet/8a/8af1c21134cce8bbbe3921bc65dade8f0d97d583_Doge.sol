...
contract Doge is Context, IERC20, Ownable {
    ...
    string private _name = "61Doge";
    string private _symbol = "61Doge";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x737913Fa6C1Df92b52CffDEBcDa49280B70a6228);
    address payable public teamWalletAddress = payable(0x737913Fa6C1Df92b52CffDEBcDa49280B70a6228);
    ...
    uint256 private _totalSupply =  6100000000 * 10**_decimals;
    uint256 public _maxTxAmount =   61000000 * 10**_decimals;     
    uint256 public _walletMax =     61000000*3* 10**_decimals;      
