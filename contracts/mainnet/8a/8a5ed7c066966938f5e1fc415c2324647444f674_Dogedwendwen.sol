...
contract Dogedwendwen is ERC20 {
    using SafeMath for uint256;
	...
	address payable _receive = payable(address(0x5c1d89c649E5164aB5357e6963dE8B9FB8f7626a));
    ...
    constructor(address tokenOwner) ERC20("Dogedwendwen", "Dogedwendwen") {
