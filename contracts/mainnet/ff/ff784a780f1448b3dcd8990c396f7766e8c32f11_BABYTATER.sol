...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x999f54Faf83824509371Ad7D4864Ed23EA64A927); //Binance-Peg BUSD Token (BUSD)
    IBEP20 PRWDS = IBEP20(0x999f54Faf83824509371Ad7D4864Ed23EA64A927); //PancakeSwap Token (CAKE)
    address REWARDS;
    IRouter router;
...
contract BABYTATER is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'BABY TATER';
    ...
    uint256 rewards_divisor = 27;
    uint256 marketing_divisor = 27;
    uint256 liquidity_divisor = 27;
    uint256 contract_divisor = 19;
