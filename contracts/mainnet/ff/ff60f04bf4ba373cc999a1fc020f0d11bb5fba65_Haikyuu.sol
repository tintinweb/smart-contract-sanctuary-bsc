...
contract Haikyuu is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = _tTotal.mul(3).div(20**2);
    ...
    address private marketingWallet = address(0x7f88BA813733829A802Aa9251c7d1505A59E06C6);
    address private liquidityReceiver = address(0x7f88BA813733829A802Aa9251c7d1505A59E06C6);
