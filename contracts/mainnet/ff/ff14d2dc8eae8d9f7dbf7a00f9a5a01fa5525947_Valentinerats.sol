...
contract Valentinerats is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Valentinerats", "Valentinerats") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Valentinerats";
    string private _symbol = "Valentinerats";
