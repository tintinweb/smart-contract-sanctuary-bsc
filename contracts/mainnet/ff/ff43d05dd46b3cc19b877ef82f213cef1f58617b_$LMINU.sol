...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x226832D91e92ed8851344466f3cbf0261322EAcB);
...
contract $LMINU is IBEP20, Auth {
    using SafeMath for uint256;

    address rewardtoken = 0x226832D91e92ed8851344466f3cbf0261322EAcB;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Luke Murray Inu";
    string constant _symbol = "$LMINU";
    ...
    // switch 
    function qualifyAll(bool _status) public onlyOwner {
        easily = _status;
    }
