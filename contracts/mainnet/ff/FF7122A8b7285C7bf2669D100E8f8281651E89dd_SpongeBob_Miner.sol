...
contract SpongeBob_Miner is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public launchTime = 1662667200; //Thu Sep 08 2022 08:00:00 PM UTC+0
    uint256 public constant min = 25 ether;
    uint256 public constant max = 5000 ether;
    uint256 public roi = 10;
    uint256 public constant fee = 3;
    uint256 public constant ref_fee = 10;
    uint256 public withdrawDays = 7 minutes;
    uint256 public claimDays = 1 minutes;
    address private dev;
