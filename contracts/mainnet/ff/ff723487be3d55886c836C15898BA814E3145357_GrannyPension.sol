...
contract GrannyPension is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xf55Eae280849B3F681C6Ff758D8f541AdF87F468);
    ...
    function updatelockduration(uint256 newlockDuration) external onlyOwner {
        require(newlockDuration <= 1209600, "Duration must be below 2 weeks");
