...
/*
     https://BABYQATAR.com/
    Total Fees: 14%
    2% fee is added to the BABYQATAR developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the BABYQATAR marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    string private _name = "BABYQATAR";
    string private _symbol = "BQ";
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x08fA0CB897Ca024DeB4311bccb10477eC8DD10AE;
        _developerAddress = 0x44efd7B2d6AB56E19Cc56eaF9E6DCf61B4422B70;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "BABYQATAR: cannot burn from zero address");
    require(_balances[account] >= amount, "BABYQATAR: Cannot burn more than the account owns");
