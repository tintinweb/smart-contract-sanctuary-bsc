...
contract TokenFarm {
    ...
    uint256[5] public Duration = [7 days, 30 days, 60 days, 90 days, 180 days];  // these are locking period of token we can also place  no of seconds here
    uint256[5] public Bonus = [15, 20, 25, 30, 50]; // these four bonus variable is related to duration and the amount will be multiply by 10 like we have to set 10 percent then put 100
    ...
    function getRatio(uint256 val) public view returns (uint256){
        ...
        address TOKEN_WBNB = 0xd9Ac6D3742fBD50bD8dd3c117834Bb52b5eb4f03; // Token_WBNB pancake pool address
