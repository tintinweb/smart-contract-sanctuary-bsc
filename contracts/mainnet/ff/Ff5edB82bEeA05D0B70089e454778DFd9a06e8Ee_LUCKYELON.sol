...
contract LUCKYELON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private devWallet = 0xe47fe8B7b37d8CAFc28c2B468D8B353fae49b82b;

    DividendTracker public dividendTracker;
    LotteryContract public lotteryContract;
    
    uint256 public lotteryFireAmount = 100000000000000000;
    ...
    uint256 public eligibleAmountForLottery = 100 * 10 ** 6 * 10 ** 9;
    ...
    constructor() public ERC20("LUCKYELON", "$LUCKY") {
    ...
    function changeFees (uint256 newmarketingfee, uint256 newlotteryfee, uint256 newliquidityfee, uint256 newBNBRewardsfee) public onlyOwner {
        marketingfee = newmarketingfee;
        lotteryFee = newlotteryfee;
        liquidityFee = newliquidityfee;
        BNBRewardsFee = newBNBRewardsfee;
        totalFees = newmarketingfee + newlotteryfee + newliquidityfee + newBNBRewardsfee;
    }    
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 marketingBNB = address(this).balance.div(totalFees - liquidityFee).mul(marketingfee);
