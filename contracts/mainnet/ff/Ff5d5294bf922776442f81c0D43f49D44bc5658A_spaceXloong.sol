...
contract spaceXloong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "spaceX loong";
    string private _symbol = "spaceX loong";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x844d62D32473f9a9aA4E867E68CeeD7e9e046aF2); // Marketing Address
    address payable public teamWalletAddress = payable(0x7927dBb8270F328892d82b03B4d0EFdeE25fE68C); // Team Address
