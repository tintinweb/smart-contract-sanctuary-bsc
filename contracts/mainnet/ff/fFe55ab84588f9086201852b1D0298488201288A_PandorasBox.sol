...
contract PandorasBox is IERC20 {
    ...
    uint256 constant private startingSupply = 88_888_888;

    string constant private _name = "Pandoras Box";
    string constant private _symbol = "UNBOX";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xab741cA895463b14C21BC418B83D4fF053f2173a),
        treasury: payable(0x986c42e2E373FC55056F28F682Baa12B7543d3F3),
        team: payable(0x6973DF7D8D678758a5DB21Cb72F43F05dda88Ce4),
        txTax: 0x3d3fAf7D281aD91061dc89Ba7E2ab3E5AEfB5912
    });
...
//================================================ BLACKLIST
    ...
    function setWallets(address payable marketing, address payable treasury, address payable team, address payable txTax) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.treasury = payable(treasury);
        _taxWallets.team = payable(team);
        _taxWallets.txTax = payable(txTax);
    }
    ...
    function setRatios(uint16 rewards, uint16 marketing, uint16 treasury, uint16 team) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.marketing = marketing;
        _ratios.treasury = treasury;
        _ratios.team = team;
        _ratios.total = rewards + marketing + treasury + team;
    ...
    function takeTaxes(address from, uint256 amount, bool buy, bool sell, bool other) internal returns (uint256) {
        ...
        address receiver;
        if (other) {
            receiver = _taxWallets.txTax;
        } else {
            receiver = address(this);
        }

        _tOwned[receiver] += feeAmount;
        emit Transfer(from, receiver, feeAmount);
