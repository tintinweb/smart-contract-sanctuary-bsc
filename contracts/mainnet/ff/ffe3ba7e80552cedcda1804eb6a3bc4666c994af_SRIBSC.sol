...
//https://t.me/SantaReindeerInuBsc
...
contract SRIBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SANTA REINDEER INU BSC";
    string private _symbol = "SRIBSC";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x49585f334B8d306f0EDA0800D6fE8135DEb0Dc74); // Marketing Address
    address payable public BuyBackWallet = payable(0x49585f334B8d306f0EDA0800D6fE8135DEb0Dc74); // Team Address
