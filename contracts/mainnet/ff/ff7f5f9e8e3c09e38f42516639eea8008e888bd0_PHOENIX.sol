...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /** @dev Creates `amount` tokens and assigns them to owner at the time of deployment
     */
...
contract PHOENIX is ERC20, Ownable {
    ...
    uint256 public swapThreshold = 500000000 * (10**18);
    uint256 public maxTransactionAmount = 20000000000 * (10**18);
    ...
    constructor() ERC20("Phoenix Inu", "PHOENIX") {
        ...
        */
        _createInitialSupply(owner(), 1_000_000_000_000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(
            ...
            uint256 fees = amount*(liquidityFee)/100;
            amount = amount-fees;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // capture the contract current ETH balance.
    ...
    function updateSwapThreshold(uint256 _newAmount) public onlyOwner {
    ...
    function decreaseFee(uint256 _liqFee) public onlyOwner {
        require(_liqFee <= 5, "tax too high");
