...
contract Moon is Context, IERC20, Ownable {
    ...
    string private _name = "$8Moon";
    string private _symbol = "$8Moon";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x52a006F93941a6e7E2cCa6CDB745D8973d825D02); 
    address payable private teamWalletAddress = payable(0xa9eD589BBe237b22adFDcAeB56d38C5aAcD36d76); 
