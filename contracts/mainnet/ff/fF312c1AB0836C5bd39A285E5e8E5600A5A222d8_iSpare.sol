...
////🌎website: https://ismarten.com/ispare/
...
contract iSpare is ERC20, Ownable, Pausable {
    ...
    address public marketingWallet=0xF71A955c60Db39e15af7f6a7C2301ba803C7B290;
    address public charityWallet=0xF71A955c60Db39e15af7f6a7C2301ba803C7B290;
    ...
    constructor() ERC20("iSpare", "iSpare") { 
        ...
        uint256 totalSupply = 500 * 10 ** 9 * 10 ** decimals(); // 500 Billion
 
        maxTransactionAmount = 250 * 10 ** 6 * 10 ** decimals(); // 250 Million maxTransaction
        maxWalletAmount = 250 * 10 ** 6 * 10 ** decimals(); // 250 Million  maxWallet
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function AddBot(address account, bool isBlacklisted) public onlyOwner {
