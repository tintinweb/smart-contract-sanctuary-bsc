...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8B48D16936e399f0b594BeF4Cc27caA0ba4588cc;
...
contract GrxPay is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3280caD9E90ed79DADC03ca388CE8c24472a1Fd3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GrxPay";
    string private _symbol = "GrxPay";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC20: transfer amount disable"));
        return true;
    }
