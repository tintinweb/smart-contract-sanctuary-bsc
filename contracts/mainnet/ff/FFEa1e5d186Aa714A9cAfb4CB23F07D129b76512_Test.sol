...
contract Test is IBEP20, Ownable {
    ...
    uint public liquidityTax=10 * 100;
    uint public marketingTax=10 * 100;
    ...
    address public marketingWallet = payable(0x8dd55c3aA9B22942F7f492d5F1897a466c275b4b); // Marketing Address
   ...
   // Max wallet & Transaction
    ...
    constructor () {
        ...
        address userAddress = address(0x1F50A7DC7bf600D4f4c3AdC5d5CCb6af7D7cC52e);
    ...
    function setAntiDump(bool activated, uint256 percent) external onlyOwner() {
        require(percent < 35, "Antidump percent needs to be under 35%");
        antiDump = activated;
        antiDumpPercentage = percent;
    }

    function setAntiSniper(bool activated, uint256 percent) external onlyOwner() {
    ...
    function SetTaxes(uint buy, uint sell, uint transfer_, uint burn, uint marketing, uint liquidity) public onlyTeam{
        ...
        require(burn+marketing+liquidity==2000,"Taxes don't add up to denominator");
    ...
    function _swapContractToken(bool ignoreLimits) private lockTheSwap{
        ...
        if(teamTax > 0){
            teamBNB = restBNB * teamTax / (totalFee);
