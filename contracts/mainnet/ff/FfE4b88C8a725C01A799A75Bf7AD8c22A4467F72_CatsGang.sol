...
contract CatsGang is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatsGang";
    string private _symbol = "CATSGANG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbCF0a6aCfBfEc3a94a76A7755a8C6DF5Acb83901);
    address payable public teamWalletAddress = payable(0xbCF0a6aCfBfEc3a94a76A7755a8C6DF5Acb83901);
