...
contract BEP20ANTIDaoToken is PausableToken, MintableToken {
    // public variables
    string public name = "ANTI DAO";
    string public symbol = "ANTI DAO";
    uint8 public decimals = 9;

    constructor() public {
        totalSupply_ =  142857 * (10 ** uint256(decimals));
    }
