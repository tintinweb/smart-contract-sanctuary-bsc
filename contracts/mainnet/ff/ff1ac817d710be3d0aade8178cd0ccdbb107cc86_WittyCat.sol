...
interface IRouter {
    ...
    uint256 public maxWalletLimit = 20_000_000_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0xB2d3Eb95D7d3F212D3f6D16ab12ABd11FCEc125d;
    address private opsWallet = 0xB7072118F616002F489d4b77133775321A3ea89C;
    address private buybackWallet = 0x449165Ae5522AA5277AfaB5B136ef147044829f1;
    address private ecoWallet = 0xCa202F40BE87a1eccAA3e4359BfF3AC89A86d35E;
    ...
    Taxes public taxes = Taxes(0, 0, 0, 12, 0);
    Taxes public sellTaxes = Taxes(4, 2, 1, 4, 1);
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 ecoAmt = unitBalance * 2 * swapTaxes.eco;
            if (ecoAmt > 0) {
    ...
    function UpdateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity, _ops,  _eco, _buyback);
        require((_marketing + _liquidity + _ops + _eco + _buyback) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity, _ops, _eco, _buyback);
        require((_marketing + _liquidity + _ops +  _eco + _buyback) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 1_000_000_000_000, "Cannot set max wallet amount lower than 0.1%");
