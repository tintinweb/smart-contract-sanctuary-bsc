...
pragma solidity ^0.8.8;
    ...
    uint256 private maxSupply = 77 * 10 ** 8 * (10**9);
    ...
    // marketing wallet 
    address payable public marketingWallet = payable(address(0x1AfaF3b2cc7504abb3B5278dc62268E6BA154f1e)); //marketing wallet

    // liquidity wallet
    address payable public liquidityWallet = payable(address(0xaB2eBf59d1B433756a73C6DE371C4F5C5CE5C614));
    ...
    function setLiquidityWallet(address payable newLiquidityWallet) external onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Whale: The liquidity wallet is already this address");
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("WHALE_Dividend_Tracker", "WHALE_Dividend_Tracker")
    {
        claimWait = 3600;
