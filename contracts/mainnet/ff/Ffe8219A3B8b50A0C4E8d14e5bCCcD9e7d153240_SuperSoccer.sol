...
contract SuperSoccer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Super Soccer";
	...
	address public OwnerAddress = 0x897ACf4939F0CB1580085Ea2142fAB18b0a6cB07;
    ...
    uint256 private _totalSupply = 2022 * 10**4 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 2022 * 10**_decimals; 
    ...
    function removeBlackList(address[] memory _blackList) external onlyOwner {
        for (uint256 i=0; i<_blackList.length; i++) {
            isBlackListed[_blackList[i]] = false;
        }
    }
