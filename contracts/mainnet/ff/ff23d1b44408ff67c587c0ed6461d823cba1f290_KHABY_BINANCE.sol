...
KhabyGrow the real moonshot 👐 
TELEGRAM: https://t.me/khabygrow_bsc
TWITTER: https://twitter.com/khaby_grow
...
contract KHABY_BINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KHABY GROW";
