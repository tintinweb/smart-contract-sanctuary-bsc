...
contract VAST_BTC is ReentrancyGuard, INativeVAST {
    
    using SafeMath for uint256;
    using Address for address;

    // token data
    string constant _name = "VAST-Bitcoin";
    string constant _symbol = "V-BTC";
    ...
    // Underlying Asset
    address public constant _token = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //Insert token here//
