...
TELEGRAM : https://t.me/fableofthecat
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCCbDE17F60B64274205E1E5300FC022d95535C56; // owner address
...
contract FableOfTheCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Fable Of The Cat ";
    string private _symbol = " FOTC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCCbDE17F60B64274205E1E5300FC022d95535C56); // Marketing Address
    address payable public teamWalletAddress = payable(0xCCbDE17F60B64274205E1E5300FC022d95535C56); // Team Address
