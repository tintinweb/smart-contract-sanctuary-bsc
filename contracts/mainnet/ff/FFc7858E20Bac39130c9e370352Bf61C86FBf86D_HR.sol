...
Telegram : https://t.me/Hrprotocol
Medium : https://link.medium.com/mse56fXMJwb
Twitter : https://twitter.com/Hrprotocol7?t=w6CyFfrtFJaJ0KOVKnAJ2A&s=09


 Supply 2,000,000,000
 Taxes 8% Buy 8% Sell
 Launch January 23st 2023
...
contract HR  is ERC20, Ownable {
    ...
    HRDividendTracker public dividendTracker;
    ...
    constructor() ERC20("HRProtocol", "$HR") {
        marketingWallet = payable(0x13cACE9a8F584062031ecDfAE873c9C6FB05443E);
        devWallet = payable(0xA7cf7bE6344839564a15ae44E6b8f2C0030Db8B3);
        ...
        dividendTracker = new HRDividendTracker(
            payable(this),
            router,
...
contract HRDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "HR_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HR_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HR contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HRsContract);

            uint256 prevBalance = HRsContract.balanceOf(address(this));
            ...
            {
                uint256 received = HRsContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HRsContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
