...
// Bigold Coin Telegram https://t.me/bigoldcoin
// Bigold Coin Website www.bigold.net
...
contract BIGOLDCOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2B77C4dC14354133295A209b5CE8632C18e03AE7); 
    address payable public Wallet_Dev = payable(0xd8C1eB13971605dC4F48605495Ccd9f2fe7dFC78);
    ...
    string private constant _name = "BIGOLD COIN"; //token name
    string private constant _symbol = unicode"BIGOLD"; //symbol

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 9; // buy tax
    uint256 public _Tax_On_Sell = 9; // sell tax

    uint256 public Percent_Marketing = 80; // mkt wallet 
    uint256 public Percent_Dev = 5; // project development
    uint256 public Percent_Burn = 5; // autoburn
    uint256 public Percent_AutoLP = 10; // autolp
    ...
    constructor () {
        ...
        _owner = 0xd8C1eB13971605dC4F48605495Ccd9f2fe7dFC78;
