...
contract MAXAM is ERC20, Ownable {
    ...
    constructor() ERC20("MAXAM Performance Token", "MAXAM") {
        ...
        uint256 totalSupply = 989448046000000 * 1e18;
 
        maxTransactionAmount = 989448046000000 * 1e18; // 100% maxTransactionAmountTxn
        maxWallet = 989448046000000 * 1e18; // 100% maxWallet
