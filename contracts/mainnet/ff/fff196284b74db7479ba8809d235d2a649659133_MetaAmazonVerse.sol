 ...
 */
contract MetaAmazonVerse is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    string private constant _name         = "MetaAmazonVerse";
    string private constant _symbol       = "MAV";
    ...
    uint256 public sellBurnFee  = 2;  // 2% Fee to Burn wallet on sell
    uint256 public otherBurnFee = 2;  // 2% Fee to Burn wallet on other transaction

    uint256 public buyRewardsFee   = 2;  // 2% Fee to Rewards wallet on buy
    uint256 public sellRewardsFee  = 3;  // 3% Fee to Rewards wallet on sell
    uint256 public otherRewardsFee = 2;  // 2% Fee to Rewards wallet on other transaction

    uint256 public buyMarketingFee   = 2;  // 2% Fee to Marketing wallet on buy
    uint256 public sellMarketingFee  = 5;  // 5% Fee to Marketing wallet on sell
    uint256 public otherMarketingFee = 2;  // 2% Fee to Marketing wallet on other transaction
    ...
    // Dev's wallets
    address payable public constant marketingWallet = payable(0xCF8288937625A5ce7DCF0BdD2f3F6139563B7C4D);
