...
/**
Welcome to Titano 2.0. Together we will celebrate the Titano Days!
Join the TG https://t.me/TitanoTWO
...
contract TitanoTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TitanoTwo";
    string private _symbol = "Titano2.0";
