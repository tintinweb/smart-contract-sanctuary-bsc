...
contract BabyDogCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby DogCoin";
    string private _symbol = "Baby DogCoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc1b6B0EEea02456585312E14Aec083eb18702649);
    address payable public teamWalletAddress = payable(0xc1b6B0EEea02456585312E14Aec083eb18702649);
