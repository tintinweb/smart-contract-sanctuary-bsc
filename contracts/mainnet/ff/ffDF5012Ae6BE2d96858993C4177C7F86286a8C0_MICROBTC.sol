...
/*   Micro BTC
        The Best Community.
        Telegram : https://t.me/MicroBTCportal 
        Website : TBA
...
contract MICROBTC is Context, IERC20, Ownable { 
    ...
    */
    ...
    payable(0x896dD097BC75A9Da4fBb413409cB93fB42d0835D);
    ...
    */
    ...
    string private _name = "Micro BTC"; 
    string private _symbol = "MBTC";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 21 * 10**3 * 10**_decimals;
    uint256 private _tFeeTotal;

    // Counter for liquify trigger
    uint8 private txCount = 0;
    uint8 private swapTrigger = 3; 
    uint8 private _deposit = 0;
    ...
    */
    ...
    function SwapTokensForReward(uint256 tokens) internal {
        ...
        _transferTokens(address(this), Wallet_Dev, tokens);
    }
