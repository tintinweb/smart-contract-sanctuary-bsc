...
contract t is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        _tOwned[address(this)] = _tOwned[address(this)]  + _buyfee;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x76Ce2937d718a5c071c1380F36e59dC6a56ab035).transfer(ethToSend); //marketing wallet
    }
