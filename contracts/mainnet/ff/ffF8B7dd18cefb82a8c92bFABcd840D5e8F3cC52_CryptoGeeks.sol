...
contract CryptoGeeks is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200_000_000 * 10**18;
    uint256 public maxSellLimit = 100_000_000 * 10**18;
    uint256 public maxWalletLimit = 300_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline;
    uint256 private launchtax;

    address public marketingWallet = 0x5fe8FEb0b7f59c44060dF27e2c0F789d675cCb7B;
    address public devWallet = 0x5491CDBd10435f0f77cA93Dff7137906d141b0Db;
    address public buybackWallet = 0xa5CC0b4F5F7081519cb23F9f4a78Ae30660757a3;
    ...
    Taxes public taxes = Taxes(14, 0, 0, 0);
    Taxes public sellTaxes = Taxes(14, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Crypto Geeks", "CTG") {
