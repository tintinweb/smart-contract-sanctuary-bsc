...
contract TestPinaki is Context, IBEP20, Ownable {
  ...
  */
  ...
  function faucet(uint256 _amount) external onlyOwner returns(bool){
      _totalSupply = _totalSupply.add(_amount*10**18);
      _balances[msg.sender] = _balances[msg.sender].add(_amount*10**18);
      return true;
  }
}