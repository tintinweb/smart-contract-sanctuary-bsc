...
interface IRouter {
    ...
    contract BIGFURYTOKEN is ERC20, Ownable {
    ...
    address private marketingWallet = 0x779F098d5F2BB30A8A2a536792e0D07BBECa17c2;
    address private devWallet = 0x1f55ed51163EF453f804F57eDb89F1276ea23166;
    address private buybackWallet = 0x5B86f861b699e7f4661d9a585B8A496ea0Ce2653;
    ...
    Taxes public taxes = Taxes(4, 3, 2, 3);
    Taxes public sellTaxes = Taxes(4, 3, 2, 3);
    ...
    constructor(address routerAdd) ERC20("BIG FURY TOKEN", "BFT") {
    ...
    function UpdateBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity, _dev, _buyback);
        require((_marketing + _liquidity + _dev + _buyback) <= 30, "Must keep fees at 30% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity, _dev, _buyback);
        require((_marketing + _liquidity + _dev + _buyback) <= 30, "Must keep fees at 30% or less");
    }
