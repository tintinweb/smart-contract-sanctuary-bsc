...
/* Token contract */
contract AlPacino is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd9E5e0eEAd52289bcedc4FFecb57e2fC921731C7;
    ...
    // Name and symbol
    string constant _name = "Al Pacino";
    string constant _symbol = "PACINO";
