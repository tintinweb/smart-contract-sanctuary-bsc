...
contract HXJ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HXJ";
    string private _symbol = "HXJ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x864951E643e61e8E5fE76B2097f825F5E47C1be6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x864951E643e61e8E5fE76B2097f825F5E47C1be6); // BuyBack Address
