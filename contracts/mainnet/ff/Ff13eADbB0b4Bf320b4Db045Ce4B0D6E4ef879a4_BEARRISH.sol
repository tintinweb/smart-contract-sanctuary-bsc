...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23e6554B5B998b054e66F9E6cA7A46BcF1cE9cfE; // owner address
...
contract BEARRISH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BEARRISH";
    string private _symbol = "$BEARISH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x23e6554B5B998b054e66F9E6cA7A46BcF1cE9cfE); // Marketing Address
    address payable public teamWalletAddress = payable(0x23e6554B5B998b054e66F9E6cA7A46BcF1cE9cfE); // Team Address
