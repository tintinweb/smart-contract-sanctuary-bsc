...
contract BasicChad is Context, IERC20, Ownable {
    ...
    string private constant _name = "Basic Chad"; //
    string private constant _symbol = "BC"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0x04A62aaCc04b4B77758b82c7a824115dB859F70f ;
