...
Telegram: https://t.me/santaapeofficial
...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x402d9baAaCb276F0D6FfDe05C1F6A455EC99365A;
...
contract SANTAAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SANTA APE"; // 
    string private constant _symbol = "SAPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x402d9baAaCb276F0D6FfDe05C1F6A455EC99365A);
