...
contract ShinaGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "ShinaGrow";

    string private _symbol = "ShinaGrow";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x4523F9255fCEcD5FaF8CDE0F95AB00726fc82375;
