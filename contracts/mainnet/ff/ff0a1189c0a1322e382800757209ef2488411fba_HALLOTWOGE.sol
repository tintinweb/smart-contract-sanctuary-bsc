...
contract HALLOTWOGE is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x315a421c1CbFAe77d46d120434d4228EDE0b5c81;
    address public DevelopmentWallet = 0xfACc168DE818eb619CA6A8a83f0E5548461b1f4D;

    string private constant _name = "Halloween TWOGE";
    string private constant _symbol = "HALLOTWOGE";
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _Development ) <= 20, "Must keep fees at 20% or less");
