...
contract MoneyRabbit is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"MoneyRabbit";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x65b3FE967aaA226dB3b0c724f390A9c7baCE8A3f));
        marketingWallet = payable(address(0x65b3FE967aaA226dB3b0c724f390A9c7baCE8A3f));
