...
contract MiloKitten is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Milo Kitten"; 
    string private _symbol = "Milo Kitten"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd6810D0819AF2b756adA955e9F847b087a24EbcE); // Marketing Address
