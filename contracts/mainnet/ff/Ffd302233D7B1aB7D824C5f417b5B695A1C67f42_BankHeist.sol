    ...
    ManageableUpgradeable
{
    ...
    function unstake(uint256 lockId) public {
        ...
        lockedTokens[_msgSender()][lockId] = lockedTokens[_msgSender()][
            lockedTokens[_msgSender()].length
        ];
        delete lockedTokens[_msgSender()][lockedTokens[_msgSender()].length]; // need to verify that this does what it's intented to do
    ...
    function unstake(address user, uint256 lockId) public onlyOwner {
        ...
        lockedTokens[user][lockId] = lockedTokens[user][
            lockedTokens[user].length
        ];
        delete lockedTokens[user][lockedTokens[user].length]; // need to verify that this does what it's intented to do
