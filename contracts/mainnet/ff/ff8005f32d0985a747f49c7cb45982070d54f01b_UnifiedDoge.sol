...
contract UnifiedDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UnifiedDoge";
    string private _symbol = "UnifieDoge";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0xc18404255B4b558B439836C44365C7626c478593);
    address payable public teamWalletAddress = payable(0xc18404255B4b558B439836C44365C7626c478593);
