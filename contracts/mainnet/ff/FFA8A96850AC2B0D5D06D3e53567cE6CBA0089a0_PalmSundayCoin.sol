...
contract PalmSundayCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PalmDayToken";
    string constant _symbol = "Preach";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x2A1601c59606eb8DB275B7556bB2BcBDb1805200;
