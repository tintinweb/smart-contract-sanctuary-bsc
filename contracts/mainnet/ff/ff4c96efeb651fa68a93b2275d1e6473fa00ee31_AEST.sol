...
contract AEST is ERC20, Ownable {
    ...
    uint256 public constant LP_SUPPLY = 2000000 * 10**18;
    uint256 public constant OTHER_SUPPLY = 79000000 * 10**18;
    ...
    function swapTokenAndFees(
        ...
        uint256 otherAmount = amount.mul(7).div(100); 
        amount = amount.sub(feeAmount);
        super._burn(from, burnAmount);
        super._transfer(from, to, amount);
        super._transfer(from, feeAddr, otherAmount);
    }
