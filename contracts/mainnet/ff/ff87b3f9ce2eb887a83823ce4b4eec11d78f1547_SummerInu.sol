...
contract SummerInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Summer Inu";
    string private _symbol = "SummerInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26c6039380A56d48DBB7d0EE0e0e4e7e38Aeb2a0);
    address payable public BuyBackWalletAddress = payable(0x26c6039380A56d48DBB7d0EE0e0e4e7e38Aeb2a0);
