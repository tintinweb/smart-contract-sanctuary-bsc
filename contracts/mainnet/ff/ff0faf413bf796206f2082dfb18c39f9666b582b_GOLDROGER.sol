...
Telegram: https://t.me/GoldRogerbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8fC885333f00c47A2163c5ef9e88B36fAc309C3f;
...
contract GOLDROGER is Context, IERC20, Ownable {
    ...
    string private constant _name = "GOLD ROGER"; // 
    string private constant _symbol = "$GOLDROGER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x8fC885333f00c47A2163c5ef9e88B36fAc309C3f);
