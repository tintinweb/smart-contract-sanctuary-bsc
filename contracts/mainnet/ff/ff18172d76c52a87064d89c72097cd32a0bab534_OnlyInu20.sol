...
//Telegram : https://t.me/onlyinu_20
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x37ADe3853cdC75e66Ee393cd0CA38f810bDeE558;
...
contract OnlyInu20 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Only Inu 2.0"; 
    string private constant _symbol = unicode"onlyinu 2.0"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x37ADe3853cdC75e66Ee393cd0CA38f810bDeE558), BNB_Tot);
            }
