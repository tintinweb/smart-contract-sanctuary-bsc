...
contract BaseToken is Ownable {
    ...
    string constant public name = "to star";

    string constant public symbol = "to star";
    ...
    address public projectAddress = 0xCafB9C3619e02F6c19Ba3523C5A9b75D63ec40c2;
...
contract tostar is BaseToken {

    constructor() public {
        balanceOf[msg.sender] = totalSupply;
        emit Transfer(address(0), msg.sender, totalSupply);

        WoDe = 0xCafB9C3619e02F6c19Ba3523C5A9b75D63ec40c2;
