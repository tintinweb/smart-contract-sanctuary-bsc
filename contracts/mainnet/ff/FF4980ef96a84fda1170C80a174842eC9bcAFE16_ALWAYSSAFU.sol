...
contract ALWAYSSAFU is ERC20Detailed, Auth {
    ...
    uint256 public minAmounttoSwap = 20 * 10**DECIMALS;
    ...
    function _transferFrom(address sender,address recipient,uint256 amount) internal returns (bool) {
        require(!isBlacklist[sender] && !isBlacklist[recipient], "in_isBlacklist");
    ...
    function setSwapBackAmounts(uint256 _amount, uint256 _minAmount) external authorized {
        swapThreshold = _totalSupply * _amount / 100000;
        minAmounttoSwap = _totalSupply * _minAmount / 100000;
    }   
    ...
    function setisBlacklist(address _botAddress, bool _enabled) external authorized {
        isBlacklist[_botAddress] = _enabled;    
    }
