...
/**                               
                  Ecstasy Coin is made for those adrenaline lovers in the crypto world.
           This will be an experience that you will never forget, have fun and earn money now.

Telegram: https://t.me/EcstasyCoinBSC
...
contract EcstasyCoin is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x139F9Be46fbEB88aA4f98D5Bd223884C93e23768));


    string private _name = "Ecstasy Coin";
    string private _symbol = "ECSTASY";
