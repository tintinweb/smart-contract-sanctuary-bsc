...
contract DiamondGems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Diamond Gems Network";
    string private _symbol = "DIGEMSNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAaE9BA8A51C7a351908A15b1e2fA4AC731Eb112C); 
    address payable public buyBackWalletAddress = payable(0x0a8F14865229d664aD11081BE419087cd71B8C63); 
    ...
    uint256 private _totalSupply = 888000 * 10**9;
    uint256 public _maxTxAmount = 58800 * 10**9; 
    uint256 public _walletMax = 800000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 2880 * 10**9; 
