...
contract METASAFEETH is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        _name = "METASAFEETH";
        _symbol = "META SAFEETH";
        _decimals = 9;

        marketWallet = payable(0x6d6536A7bAb815a5C4dC1EcE081f49EF2E3a2bC1);
        teamWallet= payable(0x0b604a81FeBE170CB0837d2482c29709B2AEF5Ff);
        ...
        _maxTxAmount = 40000000 * 10**_decimals;
