...
contract whalefall is ERC20 {
	...
	address private _fundAddress = address(0x3bA721D69045E86ca615b13616dCE1f734926b6b);
	address private _maketAddress = address(0x3bA721D69045E86ca615b13616dCE1f734926b6b);
    ...
    constructor(address tokenOwner) ERC20("whalefall", "whalefall") {
        ...
        swapTokensAtAmount = total.div(40000000);
            ...
            if(totalAmount>0){
                ...
                if(buySize >10){
                    for(uint256 i=0;i<10;i++){
                        ...
                        if(rate>0){
                            BTC.transfer(user,btcPerAmount.mul(rate).div(1000000000));
                            ETH.transfer(user,ethPerAmount.mul(rate).div(1000000000));
                        }
                        startIndex += 1;
                    }
                }else{
