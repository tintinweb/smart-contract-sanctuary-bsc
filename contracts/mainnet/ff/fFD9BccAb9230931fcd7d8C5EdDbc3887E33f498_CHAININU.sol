...
contract  CHAININU is Context, IERC20, Ownable {
    ...
    string private _name = "CHAIN INU";
    string private _symbol = "CHINU";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0x94617e186A0D66d526D9A5c618d5Cc84C02d0484);
    address payable public teamWalletAddress = payable(0x940221659b2978B367b79c8f84d034aBc3A65e20); 
