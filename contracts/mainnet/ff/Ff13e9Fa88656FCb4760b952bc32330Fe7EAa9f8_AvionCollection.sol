...
contract AvionCollection is ERC721EnumerableUpgradeable, OwnableUpgradeable, VRFConsumerBaseUpgradable {
    ...
    mapping(bytes32 => VRFStruct) public NewVRFRequests;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        tokenTier[NewVRFRequests[requestId].tokenID] = tier;
    ...
    function _mint(uint256 _amount, uint256 _price) internal {
        ...
        for (uint256 i; i < _amount; i++) {
            ...
            NewVRFRequests[getRandomNumber()] = VRFStruct(msg.sender, currentSupply);
        }
    }
