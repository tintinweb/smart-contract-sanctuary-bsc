...
contract TaxContract is Ownable {
    ...
    uint256 constant maximumPercentage = 500; // 5% maximum
    struct Tax {
        uint256 from;
        uint256 to;
