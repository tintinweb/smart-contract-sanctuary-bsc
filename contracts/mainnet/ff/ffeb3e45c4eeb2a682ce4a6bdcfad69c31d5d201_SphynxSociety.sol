...
contract SphynxSociety is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sphynx Society";
    string private _symbol = "SPHYNX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEEc0376B4ba9Bd9226E1F63C685ced4BDd52fCDA); 
    address payable public buyBackWalletAddress = payable(0xEEc0376B4ba9Bd9226E1F63C685ced4BDd52fCDA); 
