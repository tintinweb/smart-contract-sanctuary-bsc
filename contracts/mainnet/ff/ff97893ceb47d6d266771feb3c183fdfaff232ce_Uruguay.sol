...
contract Uruguay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Uruguay";
    string private _symbol = "Uruguay";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x005Cb1fe99a4ce5B37EE2b567B57Da08a140DEdc); 
    address payable public BurnedWalletAddress = payable(0x005Cb1fe99a4ce5B37EE2b567B57Da08a140DEdc); 
