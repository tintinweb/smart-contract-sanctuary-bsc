...
contract LpProxy is Ownable {
    ...
    function addLiquide(
        ...
        emit console(token0,token1,token0Amount,token1Amount);
        IERC20(token0).transferFrom(_msgSender(), address(this), token0Amount);
        ...
        (, , uint256 liquidity) = IUniswapV2Router02(router).addLiquidity(
         ...
         emit console(token0,token1,token0Amount,liquidity);
    }
