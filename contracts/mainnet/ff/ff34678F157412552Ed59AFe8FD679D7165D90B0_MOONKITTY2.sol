...
/* Token contract */
contract MOONKITTY2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xe8082E4A25C2F8AaC8f6d55DA14b95E8a1f593e8;
    ...
    // Name and symbol
    string constant _name = "Moon Kitty 2.0";
    string constant _symbol = "MK2";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2000 tokens
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1000 tokens
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2000 tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5Be4337CFAa7438219a9E4D5e49256b112f3534c;
