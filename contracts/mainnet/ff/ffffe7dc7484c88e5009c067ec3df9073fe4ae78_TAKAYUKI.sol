...
Takayuki is dog god spirits serve their masters loyalty, performing tasks just like a faithful dog. They are loyal to one person or one family only
these spirits can be passed down from generation to generation like an heirloom.
...
contract TAKAYUKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Takayuki Inu";
    string private _symbol = "TAKAYUKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc6FdDFb720189C3DB665F094D9A660fC96CFb094); 
    address payable public buyBackWalletAddress = payable(0xa6bFaEfFaEc1802D1844ab70c6e6eDaD1476A723); 
