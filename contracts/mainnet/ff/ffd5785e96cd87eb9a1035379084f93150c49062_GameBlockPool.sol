...
$$ |  $$ |$$  __$$ |$$ | $$ | $$ |$$   ____|      $$ |  $$ |$$ |$$ |  $$ |$$ |      $$  _$$<  
\$$$$$$  |\$$$$$$$ |$$ | $$ | $$ |\$$$$$$$\       $$$$$$$  |$$ |\$$$$$$  |\$$$$$$$\ $$ | \$$\ 
 \______/  \_______|\__| \__| \__| \_______|      \_______/ \__| \______/  \_______|\__|  \__|
*/
...
contract GameBlockPool is Context, Ownable {
    ...
    function emergencyMigrationBlocks(address to) external onlyOwner {
        require(initialized);
        recAdd = payable(to);
