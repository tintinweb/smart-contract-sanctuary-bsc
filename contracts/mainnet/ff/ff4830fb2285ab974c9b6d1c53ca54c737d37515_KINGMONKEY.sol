...
/**
🦍🦍King Monkey Coin Relaunch🦍🦍


The King of Bsc Forest is here make way for King Monkey Coin.
The Meme Coin with a Usecase

Prev Project of the Dev hit x125
...
contract KINGMONKEY is Context, IERC20, Ownable {
    ...
    string private constant _name = "KING MONKEY COIN"; // 
    string private constant _symbol = "KING MONKEY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x047Fc677931cD894708ddF75c40a0F2DDdf95189;
