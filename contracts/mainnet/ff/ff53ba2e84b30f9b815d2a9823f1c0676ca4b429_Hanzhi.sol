...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C2436DBaf9513B39D32De92dC9173deEc6e1cB7; // owner address
...
contract Hanzhi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hanzhi";
    string private _symbol = "HZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C2436DBaf9513B39D32De92dC9173deEc6e1cB7); // Marketing Address
    address payable public teamWalletAddress = payable(0x4C2436DBaf9513B39D32De92dC9173deEc6e1cB7); // Team Address
