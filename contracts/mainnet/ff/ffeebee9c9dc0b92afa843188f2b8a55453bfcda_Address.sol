...
contract coin is Context, IERC20, Ownable {
    ...
    string private _name = "Moontok";
    string private _symbol = "Moontok";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x46b209C0B6961f42D8EdFe5FA12D21d5a8001B1C); // Marketing Address
    address payable private teamWalletAddress = payable(0xadE69dde9Bbc8943c95Cf6dD9142ceBBE199Df26); // Team Address
