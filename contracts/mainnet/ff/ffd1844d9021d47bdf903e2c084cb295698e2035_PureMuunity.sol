...
// Pure Muunity - PUMUU
// Nanocap plays, Pure Muunity token, LP will be burned
// Muunity token, i suggest u to create the tg with @MuunityToken name
...
contract PureMuunity is Context, IERC20 { 
    ...
    string private constant _name = "Pure Muunity"; 
    string private constant _symbol = unicode"PUMUU"; 
