...
contract RatGirl is ERC20, Ownable {
	...
	constructor (
        ...
        maxTransactionRateBuy      = 30;
        maxTransactionRateSell     = 30;
        maxWalletAvailable         = true;
        maxWalletLimitEnabled      = true;
        maxWalletLimitRate         = 30;
		...
		uint256 _supply = 100000000 * (10 ** 9);
		
        swapTokensAtAmount = _supply / 5000;
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 4 && _sellFee <= 4, "Fees must be less than 4%");
        buyFee = _buyFee;
        sellFee = _sellFee;
