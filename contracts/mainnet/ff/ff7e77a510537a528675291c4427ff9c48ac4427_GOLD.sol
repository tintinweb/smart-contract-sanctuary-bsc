...
contract GOLD is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 10000000000 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("GOLD", "GOLD", uint8(DECIMALS)) Ownable() {
