...
contract CATBOYPROTOCOL is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 100 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 3 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x3c6E7308592a55f6F67Ba4B4a178095C7b345321; //

    string private constant _name = "Catboy Protocol"; //
