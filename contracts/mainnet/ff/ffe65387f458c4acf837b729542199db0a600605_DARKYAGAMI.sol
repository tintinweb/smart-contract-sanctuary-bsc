...
Telegram : https://t.me/darkyagamiportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77a98EB17217DAF4eF842D734Cd4c5117d4b8688; // owner address
...
contract DARKYAGAMI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DARK YAGAMI";
    string private _symbol = "DRY"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d7a69A3709AA0F140c694480C95c9bd3CbA1266); // Marketing Address
    address payable public teamWalletAddress = payable(0xbeB31CABd4404e21277cb079F1685936C4E274ec); // Team Address
