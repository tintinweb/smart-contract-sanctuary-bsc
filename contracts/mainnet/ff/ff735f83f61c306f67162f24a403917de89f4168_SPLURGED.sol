...
/**
    SPLURGE
    https://t.me/SplurgeSRG
    2% Buy Tax
    2% Sell Tax
    SO GO AHEAD AND SPLURGE

    UNLOCKABLE LIQUIDITY USING SURGE PROTOCOL

    This token is not available to purchase through Pancake Swap or Poocoin
    It is only available to purchase using Surge through Surge Protocol at https://swap.surgeprotocol.tech/
    Visit https://surgeprotocol.io/ for more information
 */
...
contract SPLURGED is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SPLURGED";
    ...
    uint256 public maxBag = _totalSupply * 3 / 100;
    ...
    //Tax wallets
    address public teamWallet = 0x227b32fadD9375A8004abED5d77feeF0DA6319c4;
    address public treasuryWallet = 0x0ae89a640b81E2D873d5Ef23556bae76B710938C;
    ...
    uint256 public constant SHAREDIVISOR = 200;
