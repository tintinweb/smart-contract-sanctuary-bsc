...
// @CryptDash - Blockchain-based Gamers NFT Marketplace                                           
//
...
contract CryptDash is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //router swap 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 (pancakeswap testnet)
        ...
        devDeployReceiver = 0x9634380F66e6Bd130E53b23FA8D8D4f8348d8109;
        marketingFeeReceiver = 0xE078EfbD66fe4C2b748cCEC6cAea4a4C9478fd59;
    ...
    function setTokenPrize(address newDZ) external authorized {
        DZ = newDZ;
    }
