...
contract ThoreumMiner_upgradeable_v1 is Initializable, UUPSUpgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        bankWallet = 0x6A963573b9A7AaEf9CB9EEE747E1b6B2c21b0520;

        AUTO_CONTRACT = IAutoMiner(0x0691882AFAC623631202713e5F34D720eC87208c);
        ...
        MARKET_EGGS_DIVISOR_COMPOUND = 3; // 33%
        MARKET_EGGS_DIVISOR_SELL = 1; // 100%

        MIN_INVEST_LIMIT = 1 * 1e18; // 1 LP ~ 16 usd
        WALLET_DEPOSIT_LIMIT = 3000 * 1e18; /** 3000 LP ~ 50000 usd **/
        ...
        WITHDRAW_TAX = 200; // 20%
        WITHDRAW_LIMIT = 120 * 1e18; // 120 LP ~ 2000 usd
        ...
        AUTO_TAX = 100; // 10%
        AUTO_ENABLED = true;
        AUTO_MIN_DEPOSIT = 60 * 10**18; // 60 LP ~ 1000 usd
        WHALE_TAX_MULTIPLIER=5;

        BIGGEST_BUYER_PERCENTAGE = 10; // 1%
        BUYING_POWER_STEP_PERDAY = 3; // 0.3%
