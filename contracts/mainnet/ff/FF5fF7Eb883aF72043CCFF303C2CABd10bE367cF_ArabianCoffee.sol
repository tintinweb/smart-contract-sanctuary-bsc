...
library Address{
 ...
 contract ArabianCoffee is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7fd2De233CdAd21A9e63d30D93AC76a222B6478d;
    address public donationWallet = 0x7fd2De233CdAd21A9e63d30D93AC76a222B6478d;

    string private constant _name = "ArabianCoffee";
    string private constant _symbol = "ARCO";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 4);
    Taxes public sellTaxes = Taxes(1, 3, 2, 4);
