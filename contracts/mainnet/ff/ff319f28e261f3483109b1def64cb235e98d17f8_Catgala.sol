...
contract Catgala is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Gala";
    string private _symbol = "$Catgala";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa36292BCbEBc13ac3D1e0A48d8e03268b1926E62); // Marketing Address
    address payable public teamWalletAddress = payable(0xa36292BCbEBc13ac3D1e0A48d8e03268b1926E62); // Team Address
