...
contract Blackdog is Context, IERC20, Ownable {
    ...
    string private _name = "Black dog";
    string private _symbol = "Black dog";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x5C61F3C7713A28539C5FCc55b2eAB2ea688A9271);
    address payable public teamWalletAddress = payable(0x5C61F3C7713A28539C5FCc55b2eAB2ea688A9271);
