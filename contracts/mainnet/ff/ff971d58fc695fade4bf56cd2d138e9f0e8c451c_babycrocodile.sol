...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37d1FF0C072b9638B17126b1E1a8c27eCAf55E28; // owner address
...
contract babycrocodile is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Crocodile";
    string private _symbol = "BCRO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x37d1FF0C072b9638B17126b1E1a8c27eCAf55E28); // 
    address payable public teamWalletAddress = payable(0x37d1FF0C072b9638B17126b1E1a8c27eCAf55E28); // 
