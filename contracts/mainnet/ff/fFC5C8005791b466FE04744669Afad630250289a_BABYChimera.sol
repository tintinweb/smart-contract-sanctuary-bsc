...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x666bf9727459e600E92040cD58C2880Aa4dCaADf);
...
/* Token contract */
contract BABYChimera is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x666bf9727459e600E92040cD58C2880Aa4dCaADf; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x6C709bd3A26A8C8F64600b85c544B24D779Cd529;
    ...
    // Name and symbol
    string constant _name = "Baby Chimera";
    string constant _symbol = "BABYChimera";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6C709bd3A26A8C8F64600b85c544B24D779Cd529;
