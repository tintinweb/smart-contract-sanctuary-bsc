...
interface IERC721UpgradeableRoyalty is IERC721Upgradeable {
    /**
...
import "@openzeppelin/contracts-upgradeable/token/ERC721/IERC721Upgradeable.sol";
import "./IERC721UpgradeableRoyalty.sol";

contract PrivateListing is
    Initializable,
    ContextUpgradeable,
    OwnableUpgradeable
{
    ...
    /**
     * @dev To map tokenId to whitelist address
     */
    mapping(uint256 => address) private _tokenWhitelist;
     ...
     * @param buyer Buyer address (whitelist)
    ...
    function setSalePrice(
        ...
        // Check for approval
        require(
            IERC721Upgradeable(nftContract).getApproved(tokenId) ==
                address(this),
        ...
        require(
            ...
            "Marketplace: Caller must be a token owner"
        );
        ...
        // Assign buyer address
        _tokenWhitelist[tokenId] = buyer;
    ...
    /**
     * @dev Getter for whitelist buyer.
     * @param tokenId Token ID.
     */
    function buyerAddress(uint256 tokenId) external view returns (address) {
        return _tokenWhitelist[tokenId];
    }
    ...
    function purchase(address nftContract, uint256 tokenId) external payable {
        ...
        // Only whitelist buyer is allow to purchase
        require(
            _tokenWhitelist[tokenId] == _msgSender(),
            "Marketplace: Caller is not whitelisted"
        );
        ...
        uint256 netRoyalty;
        address minter;
        (minter, netRoyalty) = IERC721UpgradeableRoyalty(nftContract)
        ...
        // Reset buyer whitelist
        _tokenWhitelist[tokenId] = address(0);
