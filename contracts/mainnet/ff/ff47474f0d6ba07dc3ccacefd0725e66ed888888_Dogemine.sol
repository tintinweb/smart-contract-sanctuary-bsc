...
contract Dogemine is Context, IERC20, Ownable {
    ...
    string private _name = "Dogemine2.0";
    string private _symbol = "Dogemine2.0";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xe8C66ccd76D33478EBCA13256D3f63362EA45ac2); 
    address payable public teamWalletAddress = payable(0xe8C66ccd76D33478EBCA13256D3f63362EA45ac2); 
