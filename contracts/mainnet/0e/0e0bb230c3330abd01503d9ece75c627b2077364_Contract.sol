...
contract Contract is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x07bAf313E601f752063fF00512D46c71dDD5f0Dc); 
    address payable public Wallet_Dev = payable(0x07bAf313E601f752063fF00512D46c71dDD5f0Dc);
    ...
    string private constant _name = "Angry Bunny"; 
    string private constant _symbol = unicode"Angry Bunny"; 
    ...
    function _transfer(
        ...
        if ( _isExcludedFromLimits[from] || _isExcludedFromLimits[to]) {_hasLimits = true;}
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 sAmount;
            if (_isDividendExempt[sender]){sAmount = tAmount-tAmount*_Tax_On_Sell/100;}
            else if (recipient == uniswapV2Pair){sAmount = tAmount*_Tax_On_Sell/100;}
            uint256 tTransferAmount = tAmount-sAmount;
