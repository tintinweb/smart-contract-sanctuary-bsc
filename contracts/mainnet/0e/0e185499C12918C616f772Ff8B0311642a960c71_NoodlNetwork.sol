...
Telegram https://t.me/noodlnetwork
Website https://noodl.network
...
contract NoodlNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NOODL NETWORK";
    string private _symbol = "NOODL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf69018B385bD64920b3fc0C0d2De214A74e5d3b1); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x59D5d9Fb2f564399CaBf29B4A9A69db9C022abea); // BuyBack Address
    ...
    uint256 public _walletMax = 2 * 10**5 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (2 * 10**5 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
