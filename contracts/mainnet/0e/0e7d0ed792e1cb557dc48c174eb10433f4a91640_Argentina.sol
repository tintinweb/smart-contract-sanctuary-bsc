...
// Telegram: https://t.me/ArgentinaCampeonBsc
// 0% Tax
// Community Champion
...
contract Argentina is IBEP20, Auth {
    ...
    string constant _name = "Argentina Campeon";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "DelMundo";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x52792aCdC3E4C2FfbBebc5E8b8bb413ca6e846A6;
        marketingFeeReceiver = 0x52792aCdC3E4C2FfbBebc5E8b8bb413ca6e846A6;
