...
/**
TELEGRAM: https://t.me/lippotium
WEBSITE: https://lippotiumnetwork.com/
*/
...
contract LippotiumNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lippotium Network"; // 
    string private constant _symbol = "lippo"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xC006d13Ca47004EE99237243E0887ac9B4818689;
    ...
    function BlackListed (address Account) public onlyOwner {
    ...
    function _transfer(
        ...
        require( !_isblacklisted[from] && !_isblacklisted[to], "Your address blacklist : Transfer Failed");
