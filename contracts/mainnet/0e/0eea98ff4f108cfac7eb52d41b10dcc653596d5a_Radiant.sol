...
contract Radiant is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"$RADIANT";
    ...
    address payable public DevWallet = payable(0x647126276189A9611B19E7E131879B901B763489);
    address payable public MarketingWallet = payable(0x8bFc7f431615811399C506D4798199511A0D4c30);
