...
contract NomadCheems is Context, IERC20, Ownable {
    ...
    string private _name = "NomadCheems";
    ...
    uint256 public _boostedMarketingFee = 600;
    ...
    address payable private _marketingWallet = payable(0x79f233ac2c20B189D7a9E9f2D84dd0C2b0deFc32);
    address payable private _devWallet = payable(0xa23BF76fe4c7cD2408243C3895c4D7aA2cE0C6Dd);
