...
contract e2pEscrow is Stoppable, SafeMath {
  ...
  uint public commissionFeePercentage = 20000000000000000;
   ...
   * @param _amount deposit amount without commission fee
    ...
    returns(bool)
  {
    ...
    // log deposit event
    emit LogDeposit(msg.sender, _transitAddress, _amount, commissionFee);
    return true;
  }
