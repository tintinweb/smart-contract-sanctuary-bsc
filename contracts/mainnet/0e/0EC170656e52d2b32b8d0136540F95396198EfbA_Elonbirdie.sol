...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x4c41F89C82670052702758FC249DEb24cFcccae3; // carteira principal
...
// nome contrato
contract Elonbirdie is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x3B484bDF52c5BEBd2d794F9CAd4bc5662C4Bb6F7 ; // carteira dev
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Elonbirdie"; // nome
    string private _symbol = "ELONBI"; // simbolo
    uint8 private _decimals = 18;
    uint256 public _taxFee = 50; //3% percentagem fee
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 50; //2% percentagem carteira dev
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 0; //2% percentagem liquidez
