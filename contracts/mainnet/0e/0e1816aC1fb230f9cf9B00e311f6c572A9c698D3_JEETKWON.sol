...
contract JEETKWON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kwon Jeet";
    string private _symbol = "JEETKWON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9cC675e538127b545b35baF066e7419A01E2e06a); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9cC675e538127b545b35baF066e7419A01E2e06a); // BuyBack Address
    ...
    uint256 public _walletMax = 3 * 10**5 * 10**9;
