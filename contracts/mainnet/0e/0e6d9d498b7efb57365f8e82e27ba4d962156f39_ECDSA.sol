...
contract Token is ERC20, Ownable, WhiteList, ECDSAMock {
    ...
    IERC20 USDT = IERC20(0xC1dEF56795F23B339D32C785E336f6AfA5bae8F8);
    ...
    constructor(address owner) ERC20("BKO", "BKO", 18) {
        _mint(owner, 10000000000 * 10**decimals());
        _rewardTokensAtAmount = 10**18;
        _burnLeft = 1000000000 * 10**decimals();
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(
                address(this),
                address(0xC1dEF56795F23B339D32C785E336f6AfA5bae8F8)
            );
