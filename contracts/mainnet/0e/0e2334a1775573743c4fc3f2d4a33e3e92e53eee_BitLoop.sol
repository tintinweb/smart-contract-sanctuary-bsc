...
Telegram https://t.me/BitLoopNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeb9ac1d295473347b8cd7F0F2270799B0F8e5cED; // owner address
...
contract BitLoop is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BitLoop";
    string private _symbol = "BL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeb9ac1d295473347b8cd7F0F2270799B0F8e5cED); // Marketing Address
    address payable public teamWalletAddress = payable(0xeb9ac1d295473347b8cd7F0F2270799B0F8e5cED); // Team Address
