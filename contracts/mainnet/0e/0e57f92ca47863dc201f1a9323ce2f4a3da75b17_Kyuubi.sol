...
contract Kyuubi is IBEP20, Ownable
{
    ...
    uint public sellTax = 180;
    uint public transferTax = 180;
    ...
    constructor () {
        ...
        taxSplitter = payable(0x44Bd4D419310c3C50b257245bcDadeBb9d7D8D87);
        multisig = 0xeE1b81Ab4EFA91f085a1dcC0b85ac4Ee88A1a51c;
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=15 minutes;          
