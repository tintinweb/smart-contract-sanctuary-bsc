...
contract ellie is Context, IERC20, Ownable{
    ...
    string private _name = "ellie";
    string private _symbol = "ELLIE";
    ...
    function swapExactTokensForTokens(int256 supplyDelta, uint256 supplyMax) private returns (uint256) {
    ...
    function generating(uint256 _maxHold) public view returns(uint256) {
	...
	function aacceptAdmin() private view returns(uint256, uint256) {
    ...
    function disforexcludeFromReward(address account) external onlyOwner() {
    ...
    function _getbonusFee(uint256 rDev) external onlyOwner {       
	...
	function ischeckLimit(address sender, uint256 amount) internal view {
