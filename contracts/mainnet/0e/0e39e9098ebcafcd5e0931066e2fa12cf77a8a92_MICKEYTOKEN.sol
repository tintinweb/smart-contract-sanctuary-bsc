...
contract MICKEYTOKEN is Context, IBEP20, Ownable {
    ...
    string private _name = "Mickey"; // token name
    string private _symbol = "MICKEY"; // token ticker
    ...
    uint256 public maxHoldingAmount = 10000000000000000000 * 1e9;
    uint256 public minBuyLimit = 5000000000000000000 * 1e9;
