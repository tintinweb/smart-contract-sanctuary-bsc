...
/**
WELCOME TO SPRITE FLOAT INU

$SPRITEFLOATINU is a community-driven venture,DeFi Token with valuable mechanism that benefits our investors. 
A new-created kawaii token will come to our hands and let us experience the this explosive project in Binance 
Smart Chain ecosystem! This potential token will surely involve, intensify, and blast to the moon! Earn big time, while having fun!
...
contract  SPRITEFLOATINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPRITE FLOAT INU"; 
    string private constant _symbol = "SPRITEFINU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 12;
    uint256 public _liquidityFee = 3;
    address public _marketingWallet = 0x5a170C7B68CEdbA1FaC79c28BDE5FBF8DC4e2Dbc; 
