...
/*
Welcome to DogeTV!
Watch Movies, Sports, International Channels & Payperviews together!
DogeTV is an innovative deflationary ecosystem born on the BNB 
Blockchain (ERC20). By bringing TV and Web3 technology together in a revolutionary way, 
DogeTV presents to you an elite entertainment service, tied to a deflationary token ecosystem. 
DogeTV holders will have the opportunity to secure their own portion of the membership taxes, 
using our unique profit sharing system by minting an exclusive NFT
...
contract DogeTV is DogeTVDeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private DogeTVTeam;
    address private CharityDogeTV;
    ...
    string public override name = "Doge-TV";
    string public override symbol = "$DGTV";
    ...
    constructor(uint totalSupplyValue, address DogeTVTeamAddress, address CharityDogeTVAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        DogeTVTeam = DogeTVTeamAddress;
        CharityDogeTV = CharityDogeTVAddress;
       
        // split the tokens according to agreed upon percentages
        balances[DogeTVTeam] =  totalSupply * 45 / 100;
        balances[CharityDogeTV] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's DogeTVTeam pot
