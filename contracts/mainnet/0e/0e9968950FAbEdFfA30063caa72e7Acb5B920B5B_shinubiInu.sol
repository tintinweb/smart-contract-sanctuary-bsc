...
//Shinubi inu Utility is a powerful solution that allows users to easily access and manage their data with precision and accuracy. Our advanced features provide an intuitive, user-friendly experience that allows users to quickly make changes, store information, and ensure data consistency. With Shinubi Inu, you can be confident that your valuable data is always up-to-date and secure
//Tokenomics:

    //Total supply: 100,000,000
    //Max Tx and Wallet: 3% (3,000,000)
    //Tax 5/5 Buy&Sell
    //30Days Lock
...
contract shinubiInu is IBEP20, Ownable {
    ...
    address public marketingFeeReceiver = 0x4dFaee969653fa3c188987b9Fb5850076dC98f1E;
