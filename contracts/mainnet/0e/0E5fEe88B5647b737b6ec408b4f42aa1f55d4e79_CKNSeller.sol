...
contract CKNSeller is Context, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    function buyCKNwithBNB() public payable nonReentrant {
    ...
    function buyCKNwithBUSD(uint256 amount) public nonReentrant {
        address beneficiary = _msgSender();
        require(amount != 0, "Amount is 0");
