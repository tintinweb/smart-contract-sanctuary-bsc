...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB7BD8B09E5a2332289094A5e518966DeAE982521; // owner address
...
contract BullNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BullNetwork";
    string private _symbol = "BULLNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB7BD8B09E5a2332289094A5e518966DeAE982521); // Marketing Address
    address payable public teamWalletAddress = payable(0xB7BD8B09E5a2332289094A5e518966DeAE982521); // Team Address
