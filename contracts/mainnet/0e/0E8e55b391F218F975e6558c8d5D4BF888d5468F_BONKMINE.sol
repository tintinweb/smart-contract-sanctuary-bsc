...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e4f27362C635FdA56abfFa00103F7bBEc8cDF72; // owner address
...
contract BONKMINE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BONKMINE";
    string private _symbol = unicode"BMINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1e4f27362C635FdA56abfFa00103F7bBEc8cDF72); // Marketing Address
    address payable public teamWalletAddress = payable(0x1e4f27362C635FdA56abfFa00103F7bBEc8cDF72); // Team Address
