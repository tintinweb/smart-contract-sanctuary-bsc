...
contract babySharkDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babySharkDoge";
    string private _symbol = "babySharkDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd93827B84f0Cf07c049963e3343c85C9bb02f73);
    ...
    constructor () {
        ...
        emit Transfer(address(0x5aF142d8a46dE3aD25FDADAF5983D133EF5798Ef), _msgSender(), _totalSupply);
    }
