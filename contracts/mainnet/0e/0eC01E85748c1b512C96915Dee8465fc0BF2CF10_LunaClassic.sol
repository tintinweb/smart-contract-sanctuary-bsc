...
contract LunaClassic is Context, IBEP20, Ownable {
    ...
    string private _name = "Luna Classic Token"; // token name
    string private _symbol = "LUNC"; // token ticker
    ...
    uint256 public reflectionFeeOnBuying = 10; // 1% will be distributed among holder as token divideneds
    ...
    uint256 public reflectionFeeOnSelling = 10; // 1% will be distributed among holder as token divideneds
    uint256 public liquidityFeeOnSelling = 20; // 2.5% will be added to the liquidity pool
