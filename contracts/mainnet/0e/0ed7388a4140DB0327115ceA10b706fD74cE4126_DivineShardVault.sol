...
contract DivineShardVault is Ownable {
  ...
  constructor() Ownable(msg.sender) {
    rewardToken = 0xD2984fA7F3eA4B060f06bD2B205c64CFBD351B76;
  ...
  function getMessageHash(address _to,uint256 _amount,uint256 _nonce) public pure returns (bytes32) {
  ...
  function verify(address _signer,address _to,uint256 _amount,uint256 _nonce,bytes memory signature) public view returns (bool) {
