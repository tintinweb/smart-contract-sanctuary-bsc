...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a6D05a1daF728F89116fb014E1D3333b29B0cf1;
...
contract OXEZN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9AF0229d24BeC8DA34f6978d6EE301fa2a4e3cEE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OXEZN";
    string private _symbol = "OXEZN";
