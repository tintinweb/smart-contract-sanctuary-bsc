...
/**
A token created to express regret FTX, RIP !
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85bCCF5719A145029B48462ed798123913915591; // owner address
...
contract FTXBURN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x85bCCF5719A145029B48462ed798123913915591); // Marketing Address
    address payable public teamWalletAddress = payable(0x85bCCF5719A145029B48462ed798123913915591); // Team Address
