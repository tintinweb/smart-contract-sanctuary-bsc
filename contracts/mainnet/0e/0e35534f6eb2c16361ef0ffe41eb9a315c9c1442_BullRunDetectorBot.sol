...
/**
STEALTH LAUNCH - BULL RUN DETECTOR BOT
Supply : 100.000.000
Symbol : BRDB
Liquidity Lock And Renounced
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2054f9C4894c8A87d71c8dE646e1380621471d37; // owner address
...
contract BullRunDetectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bull Run Detector Bot";
    string private _symbol = "BRDB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2054f9C4894c8A87d71c8dE646e1380621471d37); // 
    address payable public teamWalletAddress = payable(0x2054f9C4894c8A87d71c8dE646e1380621471d37); // 
