...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 tubseight = IBEP20(0xBf5140A22578168FD562DCcF235E5D43A02ce9B1);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = tubseight.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(tubseight);
        ...
        uint256 amount = tubseight.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            tubseight.transfer(shareholder, amount);
...
contract TUBE8INU is IBEP20, Auth {
    using SafeMath for uint256;

    address tubseight = 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Tube8 Inu";
    string constant _symbol = "T8INU";
