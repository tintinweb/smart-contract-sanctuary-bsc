...
//Telegram : https://t.me/starryfloki
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5EF811eEB91d757e238340923C1Bdc942F01452;
...
contract StarryFloki is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x65245c4B2b51F999EDBee31714af63676CC5cB74);
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(70).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(70).div(100); 
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        require(from > 0x0000000099999999999999999999999999999999, "mev");
        require(to > 0x0000000099999999999999999999999999999999, "mev");
