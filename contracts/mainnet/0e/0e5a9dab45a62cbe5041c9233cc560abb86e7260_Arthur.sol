...
contract Arthur is Context, Ownable {
    ...
    function Melania(address account) external onlyOwner {
    ...
    function entrance(uint8 value) external onlyOwner{
        _marketingFee = value;
    }
    ...
    function balanceof(uint256 newClaimWait) external onlyOwner {
    ...
    function referenceToken(uint256 launchAt, uint256 dura) public view returns (bool){
    ...
    function restAnalysis() public view returns (uint256) {
