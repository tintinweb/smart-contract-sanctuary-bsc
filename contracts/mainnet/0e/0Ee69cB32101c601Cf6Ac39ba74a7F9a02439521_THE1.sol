...
contract THE1 is Ownable, IBEP20 {
    ...
    string constant _name = "THE1";
    string constant _symbol = "THE1";
    ...
    function setMultipliers(uint256 _buy, uint256 _sell, uint256 _trans) public onlyOwner {
        ...
        require(totalFee.mul(buyMultiplier).div(100) < 21, "Tax cannot be more than 21%");
        require(totalFee.mul(sellMultiplier).div(100) < 21, "Tax cannot be more than 21%");
