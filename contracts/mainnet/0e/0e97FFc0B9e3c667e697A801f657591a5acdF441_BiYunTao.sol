...
contract BiYunTao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BiYunTao";
    string private _symbol = unicode"避孕套";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xf1f5c5232E082e7A8c11926f02FD661613c00000); // Marketing Address
    address payable public teamWalletAddress = payable(0xf1f5c5232E082e7A8c11926f02FD661613c00000); // Team Address
