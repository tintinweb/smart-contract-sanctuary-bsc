...
/**
TELEGRAM:  https://t.me/DeployerAI
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcA8dAc15220Ae00088d4B2123d09e6a5cC24A66e; //
...
contract DAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Deployer AI"; // 
    string private constant _symbol = "$DAI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x908732A9496eAe2162366C17859b353f8730FcA2); //
