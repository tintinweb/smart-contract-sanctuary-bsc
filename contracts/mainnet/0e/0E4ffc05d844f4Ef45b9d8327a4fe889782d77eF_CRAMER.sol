...
contract CRAMER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cramer Coin";
    string private constant _symbol = "CRAMER";

    address public _PancakeSwapV1RouterUniswap = 0x5786e6BBA7EE85bCa6E95f748A13340e1DFa206E; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x5786e6BBA7EE85bCa6E95f748A13340e1DFa206E; //can be the same
