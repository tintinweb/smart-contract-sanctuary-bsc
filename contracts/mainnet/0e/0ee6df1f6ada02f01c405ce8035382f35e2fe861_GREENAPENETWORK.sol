...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19Ff02664C1555B29Da4C66EF8348c537a4a43C8; // owner address
...
contract GREENAPENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Green Ape Network";
    string private _symbol = "Green Ape Network";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19Ff02664C1555B29Da4C66EF8348c537a4a43C8); // Marketing Address
    address payable public teamWalletAddress = payable(0x19Ff02664C1555B29Da4C66EF8348c537a4a43C8); // Team Address
    ...
    uint256 public _buyLiquidityFee = 90;
