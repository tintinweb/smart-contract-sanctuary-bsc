...
contract JoyMilk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JoyMILK";
    string private _symbol = "$JM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58aD3B3B57a868071a3a3472d10A9d07D55C1237); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x58aD3B3B57a868071a3a3472d10A9d07D55C1237); // Team Address
