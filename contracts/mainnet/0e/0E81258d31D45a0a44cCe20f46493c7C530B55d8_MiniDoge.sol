            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > 1000000000000000) {
...
contract MiniDoge is AbsToken {
    constructor() AbsToken(
        ...
        address(0x25e26155056A2d754727e615609d7d1612b42D81),//fund address
        address(0x25e26155056A2d754727e615609d7d1612b42D81)//receiver address
    ){
