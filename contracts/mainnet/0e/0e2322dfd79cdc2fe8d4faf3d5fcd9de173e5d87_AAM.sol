...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x520152836324d92B90dAD5268AF381a79714e1A6;
...
contract AAM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4949A65cb1bb08b2A487b4ffcAB21A72Bd73F55d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Avatanium";
    string private _symbol = "AAM";
