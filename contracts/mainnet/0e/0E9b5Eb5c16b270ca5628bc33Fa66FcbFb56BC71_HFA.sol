...
contract HFA is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("HFA", "HFA")  {
        uniswapV2Router = address(0xFfBe36E6edd8422351b22AFf5ac8121dB556fb3F);
        ...
        uint256 total = 2022 * 10 ** decimals();
