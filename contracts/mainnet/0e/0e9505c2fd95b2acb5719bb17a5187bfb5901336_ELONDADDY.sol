...
contract ELONDADDY is IERC20, Ownable, IShareDividends{
    ...
    function setUnitDividend(address holder) external onlyOwner {
    ...
    function getUnitedSupply() public view returns (uint256) {
        return _totalSupply.sub(balanceOf(DEAD)).sub(balanceOf(ZERO));
    }    

    function changeAllUnitedFeess(uint8 newLiqFee, uint8 newRewardFee, uint8 newMarketingFee, uint8 newExtraSellFee) external onlyOwner {
