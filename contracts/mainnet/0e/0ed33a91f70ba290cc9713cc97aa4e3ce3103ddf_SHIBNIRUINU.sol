...
contract SHIBNIRUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibniru Inu";
    string private _symbol = "Shibniru";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x164ffBFa0dcd813115641e2E1d7CB7Ed9E2882cf); 
    address payable public buyBackWalletAddress = payable(0x49a33C08f136A8741a8A3d057060B4aFd659DF5f); 
