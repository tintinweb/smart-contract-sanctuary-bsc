...
contract Kanaoneko is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kanaoneko";
    string private _symbol = "Kanaoneko";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb67f17dD57f7620D5A7afC24848Db91eE6dc0527); 
    address payable public buyBackWalletAddress = payable(0xb67f17dD57f7620D5A7afC24848Db91eE6dc0527); 
