...
contract BlockTradeReward is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Block Trade Reward";
    string private _symbol = "BTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb8AA5b71345e083189F69E5f77eF21FDeC1797F9); 
