...
contract LibriumSwapper is ReentrancyGuard {
    ...
    event BoughtWithToken(address); //sender, token
    constructor () {
        owner=msg.sender;
    ...
    function buyWithToken(uint amt, IBEP20 token) internal nonReentrant {
        ...
        try
            ...
            emit BoughtWithToken(msg.sender);
        }
        catch {
            revert("Error swapping to Librium.");
        }
    }
}