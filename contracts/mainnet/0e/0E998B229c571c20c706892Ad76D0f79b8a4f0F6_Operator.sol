...
contract Operator is Context, Ownable {
    ...
    uint256 private _commonPrice = 20000 * 10 ** ERC20(_tokenReward).decimals();
    uint256 private _rarePrice = 50000 * 10 ** ERC20(_tokenReward).decimals();
    uint256 private _legendaryPrice = 60000 * 10 ** ERC20(_tokenReward).decimals(); 

    uint256 private _price;

    uint256 private _priceCombine = 10000 * 10 ** ERC20(_tokenReward).decimals();
