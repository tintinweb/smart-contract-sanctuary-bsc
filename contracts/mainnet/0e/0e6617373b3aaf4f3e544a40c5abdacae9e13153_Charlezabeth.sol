...
library Address{
 ...
 contract Charlezabeth is Context, IERC20, Ownable {
    ...
    uint256 private maxSellLimit = 10_000_000_000_000 * 10**9;
    uint256 private maxWalletLimit = 10_000_000_000_000 * 10**9;
    ...
    string private constant _name = "Charlezabeth";
    string private constant _symbol = "CHABETH";
    ...
    Taxes private sellTaxes = Taxes(1, 90, 2, 1);
    ...
    constructor (address routerAddress, address _marketingWallet, address _donationWallet) {
        ...
        allowedTransfer[_donationWallet] = true;
