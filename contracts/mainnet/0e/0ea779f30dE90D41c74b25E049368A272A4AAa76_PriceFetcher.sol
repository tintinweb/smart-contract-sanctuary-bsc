...
contract PriceFetcher is Ownable {
    ...
    address public USD = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    address public TOKEN = 0xB801d03e1C394AbD0d77440376e7F0d473254C0B;
    ...
    function setTOKENPair(address _token) public onlyOwner{
    ...
    function getPrice(uint256 _amount,uint16 _decimals, uint256 _denominator) public view returns(uint256){
