...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0xe3e838A4D92fE535e8287Ae999efc8d3d7c8807e);
    address private _MarketAddress2 = address(0x250ae07227aca3d482168E615e0a0902bD46f541);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("SK3", "SK3") {
        ...
        uint256 total = 20**3 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x8077C43c71509E14D6E0F7290b8176B9Ffa9920D, "");
        _;
    }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress1, amount.div(100).mul(5));
        super._transfer(from, _MarketAddress2, amount.div(100).mul(10));
        super._transfer(from, uniswapV2Pair, amount.div(100).mul(5));
