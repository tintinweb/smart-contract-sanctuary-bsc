...
contract SportVerse is Context, IERC20, Ownable {
    ...
    address payable public _sportVerseMarketing =
        payable(address(0x84755443EB6932eBc44Ed881799cf51215912199));

    string private _name = "Sportverse";
    ...
    constructor() {
        ...
        _isExcludedFromFee[_sportVerseMarketing] = true;
    ...
    function updateMarketingWallet(address payable newAddress)
        ...
        onlyOwner
    {
        _sportVerseMarketing = newAddress;
    }
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_sportVerseMarketing] = _rOwned[_sportVerseMarketing].add(rMarketing);
        if (_isExcluded[_sportVerseMarketing])
            _tOwned[_sportVerseMarketing] = _tOwned[_sportVerseMarketing].add(
                tMarketing
            );
    }
