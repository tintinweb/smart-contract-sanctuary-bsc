...
contract LFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ListenFi";
    string private _symbol = "LFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9297388db12F9Fcd6783687e5740994007A4F2A0);
    address payable public buyBackWalletAddress = payable(0x9297388db12F9Fcd6783687e5740994007A4F2A0);
