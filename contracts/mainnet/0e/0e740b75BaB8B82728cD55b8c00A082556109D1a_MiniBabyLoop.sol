...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BabyLoop = IBEP20(0xeC13736FFB2A50F3A4817E5797C8A8A777A147CB);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BabyLoop.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BabyLoop);
        ...
        uint256 amount = BabyLoop.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BabyLoop.transfer(shareholder, amount);
...
/* Token contract */
contract MiniBabyLoop is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address TweetN = 0xeC13736FFB2A50F3A4817E5797C8A8A777A147CB; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC6F507F48ca98bd7082A18E24785B7010c5BE278;
    ...
    // Name and symbol
    string constant _name = "MiniBabyLoop" ;
    string constant _symbol = "$MBL";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 4% or 5M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC6F507F48ca98bd7082A18E24785B7010c5BE278;
