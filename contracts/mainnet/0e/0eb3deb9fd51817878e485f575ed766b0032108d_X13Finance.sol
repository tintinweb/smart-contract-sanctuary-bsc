...
contract X13Finance is ERC20Detailed, Ownable {
    ...
    string public _name = "X13 Finance";
    string public _symbol = "X13";
    ...
    uint256 public x13BankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = x13BankFee.add(nftHolderFee);
    ...
    address public x13BankReceiver;
    ...
    constructor() ERC20Detailed("X13 Finance", "X13", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x93D4BfCA3AA3153272e6b79fE6A5f822a6044c5D;
        treasuryReceiver = 0x791cdF95181e67E2A31A0bF6CA49545Dc5424Fa7;
        insuranceReceiver = 0x497D5aE329c918EE775f274594402A781F571774;
        x13BankReceiver = 0x80797c39c3a722615d7E0b3F1ca2Ee84f0e40710;
        nftHolderReceiver = 0x7394350B0dC9e49b7Af467407f4F7e90ADA4d44A;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = x13BankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(x13BankFee).add(nftHolderFee);
        ...
        (success, ) = payable(x13BankReceiver).call{
        value: currentBalance.mul(x13BankFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
