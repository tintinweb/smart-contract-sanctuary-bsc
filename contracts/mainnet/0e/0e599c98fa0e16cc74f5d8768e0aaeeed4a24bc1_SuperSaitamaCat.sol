...
contract SuperSaitamaCat is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 642246 * 10**_decimals;
    uint256 public maxTxAmount = 100000000 * 10**_decimals;
    uint256 public maxWalletAmount = 100000000 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x639fb0fb8cC4e414A4d746688cd86b102eCaf46B;

    string private constant _name = "SUPER SAITAMA CAT";
    ...
    Taxes public taxes = Taxes(1,6,1,0);
