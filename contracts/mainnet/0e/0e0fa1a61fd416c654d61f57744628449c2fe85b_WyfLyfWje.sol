...
contract WyfLyfWje
 is Context, IERC20, Ownable {
    ...
    string private _name = "WyfLyfWje";
    string private _symbol = "WyfLyfWje";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3F0e63e3FA7b6A1F0Be6788fC4068fFD0F35F0A);
    address payable public teamWalletAddress = payable(0xb3F0e63e3FA7b6A1F0Be6788fC4068fFD0F35F0A);
    address public immutable deadAddress = 0xb3F0e63e3FA7b6A1F0Be6788fC4068fFD0F35F0A;
