...
Lucky Shib Grow - $LSG it's a meme token with strong communuty!
We have some marketing and influencer on telegram! Let's party with us today!
Make some X Together 
...
For the first 20 minutes the tax will increase to 15% to prevent bots

TELEGRAM : https://t.me/LuckyShibGrow
*/
...
contract LuckyShibGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lucky Shib Grow"; // 
    string private constant _symbol = "LSG"; //    
