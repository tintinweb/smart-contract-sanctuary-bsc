...
contract cryptoMiami is Context, IERC20{
    ...
    string public name = "Crypto Miami NFT";
    ...
    constructor(address _pancakeRouter) {
        ...
        _balances[MEXC] = _totalSupply.div(10);
        _balances[DEAD] = _totalSupply.sub(_totalSupply.div(20));
        ...
        emit Transfer(address(0), MEXC, _totalSupply.div(10));
        emit Transfer(address(0), DEAD,_totalSupply.sub(_totalSupply.div(20)));
