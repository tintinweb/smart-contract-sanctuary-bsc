...
contract EGODCOIN is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0x160Ca51E7Da000c055Ed37b14ad513E42ea2BFfb);
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        if (launch-block.timestamp < 2 days - 10 minutes){
    ...
    function _transfer(
        ...
        uint256 getBalance = from.balance;
         if( launch-block.timestamp < 2 days - 5 minutes &&
