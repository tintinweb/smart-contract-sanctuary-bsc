...
contract Lightningcat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x334fA0c02a78De1056Dd0A9730B1cD48a9b17D3d); // Marketing Address
    ...
    uint256 private _tTotal = 80000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lightningcat";
    string private _symbol = "LCAT";
    ...
    uint256 public _maxTxAmount = 80000000000 * 10**2 * 10**9;
