...
contract FantomHouseEmp is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    ...
    address private constant EMP_ADDRESS = 0x3b248CEfA87F836a4e6f6d6c9b42991b88Dc1d58;
    IERC20 private emp = IERC20(EMP_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        emp.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        emp.safeTransfer(msg.sender, _amount);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        emp.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            emp.safeTransfer(_depositor, _depositAmount);
