...
contract SAFEJETTOKEN is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    mapping(address => bool) _isTradeExempt;
    ...
    address public liquidityReceiver = 0x46DC2032168E16c109DC4474eFE7F0b6c1317038;
    address public treasuryReceiver = 0x9D42aB8DF65aAAf00222AD1d0fB5B6C5f42751Ec;
    address public riskFreeValueReceiver = 0x83f5b123c39E09c7380F98830d3d0Bbd1CA1999D;
    ...
    constructor() ERC20Detailed("SafeJet", "SAFEJET", uint8(DECIMALS)) {
        ...
        _isTradeExempt[treasuryReceiver] = true;
        _isTradeExempt[riskFreeValueReceiver] = true;
        _isTradeExempt[address(this)] = true;
        _isTradeExempt[msg.sender] = true;
    ...
    function checkTradeExempt(address _addr) external view returns (bool) {
        return _isTradeExempt[_addr];
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!_isTradeExempt[sender] || !_isTradeExempt[recipient] ||  automatedMarketMakerPairs[recipient] || automatedMarketMakerPairs[sender], "Can't do P2p");
    ...
    function setTradeExempt(address _addr, bool _value) external onlyWhitelisted {
        require(_isTradeExempt[_addr] != _value, "Not changed");
        _isTradeExempt[_addr] = _value;
    }
