...
contract Inugami is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x616Cebe0158aCAeb3c7F0D4BE40638C7F5283Dee;
    address public devWallet = 0xd919A11F954445154452B2F588b76F28A7d54Abc; 
    address public operationWallet = 0x000000000000000000000000000000000000dEaD; 
    address public charityWallet = 0x000000000000000000000000000000000000dEaD; 

    string private constant _name = "Inugami";
    string private constant _symbol = "INUGI";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 0, 1, 0);
    Taxes public sellTaxes = Taxes(0, 7, 2, 0, 1, 0);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 5 minutes;
    }
