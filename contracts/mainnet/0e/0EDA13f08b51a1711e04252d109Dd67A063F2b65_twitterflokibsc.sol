...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd2818e677014d4e92bDe0f8a4Eb916C95b3e16b9; // owner address
...
contract twitterflokibsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Floki";
    string private _symbol = "$Twitfloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x137A02dA6a48a4166e0b70161D1Fa79e414d112f); // Marketing Address
    address payable public teamWalletAddress = payable(0x137A02dA6a48a4166e0b70161D1Fa79e414d112f); // Team Address
