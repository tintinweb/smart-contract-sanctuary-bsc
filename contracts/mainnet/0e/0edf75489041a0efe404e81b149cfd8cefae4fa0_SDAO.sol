...
contract SDAO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SincereDogeDAO";
    string private _symbol = "SDAO";
    uint8 private _decimals = 18;

    address public treasuryAddress;
    address payable public teamWalletAddress =payable(0x04c808c18186575A16Bedc164A2D997760abA93D);
    ...
    uint256 public _treasuryShare = 2;
