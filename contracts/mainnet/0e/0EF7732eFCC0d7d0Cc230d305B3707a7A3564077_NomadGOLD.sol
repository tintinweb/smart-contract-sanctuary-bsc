...
contract NomadGOLD is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x033B8E9bB8Bb3B5cdb89d7124C3D5Ba2246781Bc);
        teamWallet= payable(0x033B8E9bB8Bb3B5cdb89d7124C3D5Ba2246781Bc);
