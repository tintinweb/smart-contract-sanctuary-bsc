...
HERE WE AIM AT MAKING APLATFORM THAT WILL HELP EVERYDAY TRADERS NOTICE TRENDS AND STUFF IN THE MARKET!
WE WILL BE RELEASING A CHART DAPP WITH EXTREME ANALYSIS!

WE HAVE HIRED OVER 5 CHART EXPERTS TO HELP US POST CHART ON THE DAPP AND GIVE ADVICE!

THIS WILL BE FA!
KEEP UP WITH THE HOTTEST TRENDS IN THE MARKET AND MUCH MUCH MORE!
...
contract FAINU is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'FA INU';
