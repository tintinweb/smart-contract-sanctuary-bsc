...
contract FiftyFIftyT_withdrawal is Ownable{
 ...
 bool private _paused;
  ...
  address public sub_owner;
   ...
   function changeTax(uint256 amount) external onlyOwner 
   {
       tax = amount;
   }
         ...
         function GetCoin() external  payable 
   {
    ...
    function claimAirdrop(uint256 _dolAmt) external {
        ...
        uint256 taxValue = (tax.mul(_dolAmt)).div(100);
        uint256 orignalValue = _dolAmt.sub(taxValue);
        (uint256 claimable_in_bnb,uint256 claimable_in_token)=value(orignalValue);
        require(claimable_in_token>=0,"You are not claimer");
        require(Token.balanceOf(address(this))>=claimable_in_token,"Contract is ran out of funds!");
        require(block.timestamp>=lastClaim[msg.sender]+time,"Can't claim twice in given one epoch!");
        Token.transfer(msg.sender, claimable_in_token);
        payable(msg.sender).transfer(claimable_in_bnb);
...
//........................................price.....................................................................
    ...
    {
        uint256 a = _amt/2;
        uint256 bnbamount = (BnbtoBusd().mul(a)).div(1e18);
        uint256 tokenamount = a.mul(one$toToken()).div(1e18);
