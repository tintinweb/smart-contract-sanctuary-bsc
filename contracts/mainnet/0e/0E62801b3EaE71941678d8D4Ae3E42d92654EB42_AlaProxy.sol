...
// File: contracts/gov/AlaProxy.sol

pragma solidity =0.6.12;

contract AlaProxy is TransparentUpgradeableProxy {

    constructor(address _logic, address admin_) public TransparentUpgradeableProxy(_logic, admin_, ""){

    }
    
    function nShowAdmin() public view returns(address) {
        return _admin();
    }
    
    function nShowImplementation() public view returns(address) {
