...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee2 = 11400;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE00Fd507e41610329543fCEE7e4463Bf83B6Fe2b),

        address(0x567534800d3150926a86F0D3808149d56d8377f7),

        address(0xBfff2ADC82B6e2af34d6A9C8f5BabB4559682f17)
    ){
