...
contract BabyScat
 is Context, IERC20, Ownable {
    ...
    string private _name = "BabySchrodinger";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xF534bD3bc2a3a5c5479178eD55cdBFF841eE4ec4));
        _anotherA = payable(address(0xF534bD3bc2a3a5c5479178eD55cdBFF841eE4ec4));
