...
contract AkiraInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "AkiraNu";
    ...
    uint256 private maxBuyTranscationAmount = 50000000 * 10**6 * 10**9;
    uint256 public maxSellTransactionAmount = 50000000 * 10**6 * 10**9;
    uint256 private _maxWalletToken = 50000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 6518763 * 10**6 * 10**9; 
