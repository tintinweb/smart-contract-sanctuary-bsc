...
contract DragonFly is Context, IERC20, Ownable {
    ...
    function walletMax (uint256 amount) public {
    ...
    function takeDividend() public lockTheSwap {
