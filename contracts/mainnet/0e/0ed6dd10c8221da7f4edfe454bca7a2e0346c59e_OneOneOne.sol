...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function iniOwnership(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract OneOneOne is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 1000000 *  10**9;        
    
    string private _name = "OneOneOne";
	...
	function _tokenNoFee(address sender, address recipient, uint256 amount) private { 
		  if (amount > 0) {
