...
contract DragonNetwork is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xc43DcbABEA2a9468a7Ab4Ac3931539cdDDfcAAD4;
    string constant _name = "DragonNetwork";
    string constant _symbol = "DragonNet";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 1 * 7**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 25;
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 50;
