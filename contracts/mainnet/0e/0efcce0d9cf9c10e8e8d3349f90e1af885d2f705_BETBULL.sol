...
/* Token contract */
contract BETBULL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb24Ed58527756E4C3e469c8C63e52Eb5A124023c;
    ...
    // Name and symbol
    string constant _name = "BET Bull";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 1000; // 2% (200 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 1000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 1000 ) / 1000; // 2% (200 mil)
