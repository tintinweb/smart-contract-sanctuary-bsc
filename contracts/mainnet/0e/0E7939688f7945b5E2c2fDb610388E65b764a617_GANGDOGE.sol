...
################################       LAUNCH ON      #######################################
#																							#
#							  MAIO 05, 2022 at 23:00 UTC                                    #
#                                                                                           #
################################  COUNTDOWN FOR LAUNCH  #####################################
################################         SITE          ######################################
#																							#
#						    Site: http://www.lottobusd.com.br								#
#																							#
################################ TELEGRAM : PORTUGUESE ######################################
#																							#
#							  https://t.me/Lottobusdoficial									#
#																							#
#############################################################################################
*/
...
contract GANGDOGE is Context, IERC20, Ownable {
    ...
    uint256 public _maxRxAmount = 1000 * 10**_decimals;
    uint256 public _minLottoBalance = 10 * 10**_decimals;
    uint256 public numTokensToSwap = 1000 * 10**_decimals;
    
	uint public sellPerSecond = 1800;    					                     
    uint public buyPerSecond = 10;                          
    uint public TokensFee1 = 1000 * 10**_decimals;                          
    uint public taxaFee1 = 30;                              
    uint public TokensFee2 = 1500 * 10**_decimals;
    uint public taxaFee2 = 60;    
    uint public TokensFee3 = 2000 * 10**_decimals;
    uint public taxaFee3 = 90;    
    ...
    string private constant _name = "GANG DOGE";
    string private constant _symbol = "GDG";
    ...
    bool public _transferForm = false;
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0xB47ab3318e5F10Dc9c9D8B3cd70f203330128184);
        systemAddress = payable(0x81521f818A2F6F19568177Ee009AbEDCBAA00D05);        
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[marketingAddress] = true;
        _isExcludedFromFee[systemAddress] = true;        
        ...
        _isExcludedFromLottery[systemAddress] = true;        
        _isExcludedFromLottery[wallet_presale] = true;    
    ...
    function setTrandingOn(bool _enable) public onlyOwner {
        Trading = _enable;
    }
    ...
    function excludeFromlockPreSale(address account) public onlyOwner {
        ...
        if(sender == pancakeswapV2Pair || recipient == pancakeswapV2Pair) {
            ...
            if(takeFee) {
                ...
                if(sender == pancakeswapV2Pair) {
                    ...
                    if(sender != owner() && recipient != owner() && recipient != wallet_presale && sender != wallet_presale && recipient != address(1)){	
