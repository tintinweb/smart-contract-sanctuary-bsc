...
contract Fifa is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x5a5597b925d26b0f59327e525a8d83557e5377f3);
    address payable public teamWalletAddress = payable(0x459f182f06Dfc3AcB5424F1C7Ca70fdE673EB7d1); 
    ...
    uint256 private minimumTokensBeforeSwap = 40 * 10**4 * 10**_decimals; 
