...
Telegram https://t.me/LEXONEECOSYSTEM
Website http://lexoneecosystem.tech/
*/
...
contract LEXONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LEXONE ECOSYSTEM";
    string private _symbol = "$L1ECO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a9F2221BB690c24Dc901945132cB2Cdc29f03bE); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1a9F2221BB690c24Dc901945132cB2Cdc29f03bE); // BuyBack Address
    ...
    uint256 private _totalSupply = 200 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 400 * 10**4 * 10**9;
    uint256 public _walletMax = 400 * 10**4 * 10**9;
