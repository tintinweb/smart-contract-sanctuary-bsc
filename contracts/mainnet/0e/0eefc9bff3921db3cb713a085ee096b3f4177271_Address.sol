...
$MITSU is a Meme coin on the Binance Smart Chain Network, $KITSU is designed to build easy, secure and affordable transactions for decentralized crypto exchanges. It uses rollup technology to group transaction batches to save on gas costs.

$MITSU will be developed with the latest strategies, such as the Dex Swap and Bridge and we will also develop the NFT Market in the future.
...
contract MitsuneInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb52ccE9868E3F77a74443d128675864b2eb478D1); 
    address payable public Wallet_Dev = payable(0xb52ccE9868E3F77a74443d128675864b2eb478D1);
    ...
    string private constant _name = "Mitsune Inu"; 
    string private constant _symbol = unicode"MITSU"; 
    ...
    constructor () {
        ...
        _owner = 0x32214Cc41D0af6704783f77D972d2E6bC5C5cf65;
