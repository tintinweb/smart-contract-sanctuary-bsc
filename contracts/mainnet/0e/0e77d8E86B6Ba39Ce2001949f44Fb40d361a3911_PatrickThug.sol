...
/*
PatrickThug
BSC token that featured Patrick's thug life in form of NFTs.
PatrickThug is designed to serve as NFT governance token with only 1% of buy tax & 8% of sell tax.

TOKENOMICS
1) 100 Trillion of Supply
2) 1% Buy Tax
3) 4% Sell Tax
4) 4% of Max Wallet
5) Initial LP : 1 BNB

Stealth launch soon on Binance Smart Chain, 21st of September 2022.
TG : https://t.me/PatrickThug
*/
...
contract PatrickThug is Context, IERC20 { 
    ...
    string private constant _name = "PatrickThug"; 
    string private constant _symbol = "PATHUG"; 
