...
contract KingGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Grow"; // 

    string private constant _symbol = "King Grow"; // 
    ...
    address private  _marketingWallet = 0x0Cd69cF03AaAadED401294940C3B0Ab4D9791498; //market
