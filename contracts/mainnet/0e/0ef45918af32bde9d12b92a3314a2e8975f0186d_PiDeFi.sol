...
contract PiDeFi is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("PiDeFi", "PiDeFi") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(from == uniswapV2Pair){
                super._transfer(from, address(this), amount.div(50).mul(3));
    ...
    function swapAndLiquify() private  {
		...
		if(balanceOf(address(this)) >= canSwapAmount && canSwapAmount > 10**19){
