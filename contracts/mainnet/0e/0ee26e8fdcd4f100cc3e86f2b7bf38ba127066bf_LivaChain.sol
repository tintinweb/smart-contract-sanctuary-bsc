...
contract LivaChain is Context, IERC20 { 
    ...
    address[] w_L = [payable(0x6528cbC418D5002836535e05b5916D182E96Faf0)];

    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0xFa5D861E400B5bC444e3Dbdddd4Ee752d22CBC45); 
    address payable public Wallet_Dev = payable(0x3b45851ECc3B1D5C6813f677C9FAc56D3B060126);
    ...
    string private constant _name = "Liva Chain"; 
