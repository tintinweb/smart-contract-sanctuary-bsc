...
contract JFU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Justice for Ukraine";
    string private _symbol = "JFU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x872f520d54b79a06B85cD86Ed29f2ddeb58A8B30); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x872f520d54b79a06B85cD86Ed29f2ddeb58A8B30); // Dev Address
    ...
    uint256 private _totalSupply = 2000000000000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 2000000000000 * 10**6 * 10**9; // 2% max tx
    uint256 public _walletMax = 2000000000000 * 10**6 * 10**9; // 2% max wallet
