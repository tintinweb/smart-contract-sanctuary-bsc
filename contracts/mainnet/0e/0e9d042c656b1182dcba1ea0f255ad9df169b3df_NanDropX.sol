...
contract NanDropX is Context, ReentrancyGuard {
  ...
  constructor(
    ...
    require(maxClaimed_ > 0, "NANXA: maxClaimed is zero");
    require(maxDownline_ > 0, "NANXA: maxDownline is zero");
    require(amountPerClaim_ > 0, "NANXA: amountPerClaim is zero");
    require(amountPerClaim_ <= maxClaimed_, "NANXA: amountPerClaim exceeds maxClaimed");
  ...
  function _preProcess(
    ...
    require(referral_ != claimer_, "NANXA::_preProcess: referral can not be sender");
    require(claimer_ != address(0), "NANXA::_preProcess: claimer is the zero address");
    require((_claimed[claimer_] + amount_) <= _maxClaimed, "NANXA::_preProcess: exceeds maximum claimed amount");
  }
