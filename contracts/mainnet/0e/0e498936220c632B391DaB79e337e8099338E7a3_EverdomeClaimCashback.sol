...
contract EverdomeClaimCashback is ProofsVerifier {
    ...
    function claimCashback(uint256 amount, address owner, bytes32[] calldata proof) public {
        require(claimed[owner] == false, "already claimed");
        require(block.timestamp< claimEnd, "too-late");
        bytes32 leaf = getNode(amount, owner);
