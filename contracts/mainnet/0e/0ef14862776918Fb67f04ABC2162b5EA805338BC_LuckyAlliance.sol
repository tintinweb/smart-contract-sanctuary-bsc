...
contract LuckyAlliance is IERC20, CommunityRole {
    ...
    uint256 private _tTotal = 19800 * 10**4 * 10**18;
    string private _name = "LC";
    string private _symbol = "LC";
    uint8 private _decimals = 18;
    uint256 public _maxTxAmount = 19800 * 10**4 * 10**18;
    

    address deadWallet = 0x362e9E46185Dc5F991CCeb0a2a3cba951A4c2269;

    address USDT = 0x55d398326f99059fF775485246999027B3197955;
    IERC20 che = IERC20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);
    IERC20 hby = IERC20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);
    

    address marketingWalletAddress = 0x000000000000000000000000000000000000dEaD; 
    address communityAddress = 0xA93820859C51646eAFf269D3E49D8b6fD17F8dcf;


    uint256 public _lpsFee = 300;
    uint256 public _backflowsFee = 100;
    uint256 public _marketingsFee = 100;
    ...
    constructor() {
        ...
        _isExcludedFromFee[address(communityAddress)] = true;
        _isExcludedFromFee[address(marketingWalletAddress)] = true;
        _isExcludedFromFee[address(0x78aC94fC8fd627f5Ca3dFe566b0be30c444cF7c3)] = true;
        _isExcludedFromFee[address(0x1970F168B23f29E29d9a6aa05A8c941977d809B0)] = true;
        ...
        isDividendExempt[address(marketingWalletAddress)] = true;
