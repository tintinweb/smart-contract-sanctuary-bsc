    ...
    ,Pausable
{
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal
            override(ERC20 ,ERC20Burnable ,ERC20Taxable ,ERC20Team ,ERC20Liquidity) returns(uint256) {
        return super.takeFee(sender, recipient, amount);
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override onlyWhitelisted whenNotPaused {}
