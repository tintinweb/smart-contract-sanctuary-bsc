...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd063995fA37d36f89AF69B605E60e49983B87868;
...
contract Tesla3 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf84Cd6217154203C7CF6FFac304F579cAE366139;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tesla3";
    string private _symbol = "TES3";
