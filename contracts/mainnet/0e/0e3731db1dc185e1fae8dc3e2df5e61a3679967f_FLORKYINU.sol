...
contract FLORKYINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Florky Inu";
    string private _symbol = "FINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6359dC6Ae899d54dCA87029f90F6eE51f88d735F); 
    address payable public buyBackWalletAddress = payable(0xB19d077d5d81B9c083Cb222148C8D7773090782b); 
