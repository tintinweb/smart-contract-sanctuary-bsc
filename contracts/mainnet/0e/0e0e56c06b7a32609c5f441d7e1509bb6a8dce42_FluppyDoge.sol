...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x893761285DCdc1bF8d201eAfeDb8121Bed59A800; // owner address
...
contract FluppyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fluppy Doge";
    string private _symbol = "Fdoge"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc34E55187F61EFDc143F4a5F388d85783F6A9aec); // Marketing Address
    address payable public teamWalletAddress = payable(0xc34E55187F61EFDc143F4a5F388d85783F6A9aec); // Team Address
