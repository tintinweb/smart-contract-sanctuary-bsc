...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB9Ed7Af0C40B3f154c55217E7650d8dfC3617075;
...
contract LEDGER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0AcA14a3b1daA6e1a1823BF29C9176dfF927B04e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LEDGER";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**6;
