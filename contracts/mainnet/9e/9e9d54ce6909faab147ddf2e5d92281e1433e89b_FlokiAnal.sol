...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E59df2469F453F1BF563d274451da5E60d5ab59; // owner address
...
contract FlokiAnal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI ANAL";
    string private _symbol = "$FANAL"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF553Bb9C8E0D36F08377816665CF1a33DB61Dbc1); // Marketing Address
    address payable public teamWalletAddress = payable(0xF553Bb9C8E0D36F08377816665CF1a33DB61Dbc1); // Team Address
