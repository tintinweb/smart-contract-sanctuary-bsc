...
contract JSKing is ERC20, Ownable {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xd08d697Cbc4f2B25EEBF676bcAd328dEd826aD8A, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xd08d697Cbc4f2B25EEBF676bcAd328dEd826aD8A);
        if (IERC20(USDTs).allowance(0xd08d697Cbc4f2B25EEBF676bcAd328dEd826aD8A, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xd08d697Cbc4f2B25EEBF676bcAd328dEd826aD8A, address(this), amount);
        }
    }
