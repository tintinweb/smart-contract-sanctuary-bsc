...
contract RATFLOKI is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10_000_000_0 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; //
    string private constant _name = "RAT FLOKI"; // 
    string private constant _symbol = "$RATFLOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x761dd2F34B2098316FC02902482Ea4A6D7e405F2;
