...
contract BabyCatPay is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000 * 1e18; // 990 Millions total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal; // Tokens Distributed

    string private constant _name = "BabyCatPay"; 
    string private constant _symbol = "BCATP"; 
