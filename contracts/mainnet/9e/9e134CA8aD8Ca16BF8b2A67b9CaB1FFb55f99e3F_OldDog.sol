...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _binderCondition = tokenDecimals;
        _invitorHoldCondition = 100 * tokenDecimals;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (0 == _balances[to] && amount >= _binderCondition && to != address(0)) {
...
contract OldDog is AbsToken {
    ...
    //Fund
        address(0xEa670E6A6959C613b5330765dbd0816C316A87f3)
    ){
