...
contract UnicornMarket is IERC721Receiver, WhiteList, UnicornFee {
    ...
    constructor(IERC20 _SOO,uint _feeRate,address _feeOwner) UnicornFee(_SOO,_feeRate,_feeOwner) {}
...
contract UnicronAuction is Ownable {
    ...
    constructor(IUnicorn _unicorn, IURC20 _SOO)  {
        unicorn = _unicorn;
        SOO = _SOO;
    }
    ...
    function setSoo(IURC20 _SOO) public onlyOwner {
        SOO = _SOO;
    }
    ...
    function bid(uint tokenId, uint bidPrice) public {
        ...
        SOO.safeTransferFrom(msg.sender,address(this),bidPrice);
    ...
    function redeemBid(uint bidId) public {
        ...
        SOO.safeTransfer(owner,amount);
        
        reward = reward.mul(100-BURN_RATE)/100;
        
        SOO.safeTransfer(owner,reward);
    ...
    function finishAuction(MintLib.MintData memory mintData) public {
        ...
        SOO.safeTransfer(DEAD, burnAmount);
