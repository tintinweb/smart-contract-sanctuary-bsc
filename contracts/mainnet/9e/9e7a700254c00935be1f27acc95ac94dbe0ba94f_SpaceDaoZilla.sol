...
contract SpaceDaoZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceDaoZilla";
    string private _symbol = "$DaoZilla";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xdA5493B2FF75D9d74823763b399db444B1531C1B);
    ...
    uint256 public _TreasuryFeeBuy = 8;
