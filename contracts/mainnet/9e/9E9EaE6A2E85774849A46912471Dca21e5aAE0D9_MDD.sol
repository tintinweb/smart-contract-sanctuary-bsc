...
contract MDD is Context, IERC20 {
    ...
    string private constant _name = "Moon Du Dinh";
    string private constant _symbol = unicode"MDD";

    uint8 private txCount = 0;

    uint256 public maxBuy = 5000000000000000;
    ...
    function _transfer(
        ...
        if (
            ...
            require(amounts[1] <= maxBuy, "Reverted");
        }
    ...
    function updateMaxBuy(uint256 value) public onlyOwner {
        maxBuy = value;
    }
}