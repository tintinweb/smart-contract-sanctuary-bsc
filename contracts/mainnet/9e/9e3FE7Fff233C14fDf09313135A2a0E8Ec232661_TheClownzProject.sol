...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD Rewards for Holders:)
...
contract TheClownzProject is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "The Clownz Project";
    string constant _symbol = "$TCP";
