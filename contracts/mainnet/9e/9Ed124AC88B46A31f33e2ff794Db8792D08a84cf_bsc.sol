...
contract bsc is Context, IERC20, Ownable {
    ...
    string private _name = "Guimao rabbit";
    string private _symbol = "Guimao rabbit";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8A65908EEfC61d7498FEe21840090d9F7b63B52c); // Marketing Address
    address payable private teamWalletAddress = payable(0x8A65908EEfC61d7498FEe21840090d9F7b63B52c); // Team Address
