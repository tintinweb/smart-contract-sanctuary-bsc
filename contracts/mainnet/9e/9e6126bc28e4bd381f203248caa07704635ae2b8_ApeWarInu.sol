...
contract ApeWarInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 300_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7_000 * 10**9; //
    string private constant _name = "ApeWarInu"; //
    string private constant _symbol = "AWI"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 4;
    address private _marketingWallet = 0xcd7203b4D7BC3f0a451ce8A17802A43e2Df87Ed7 ;
