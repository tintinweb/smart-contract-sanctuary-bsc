...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x9f33C13dB079E94cAa0937d3FE3a1081a56c2FCD);
 ...
 contract $PUMP is IBEP20, Auth {
    ...
    string constant _name = "Pump University";
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _ecosystemfee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemfeeReceiver, address _burnFeeReceiver ) external onlyOwner {
