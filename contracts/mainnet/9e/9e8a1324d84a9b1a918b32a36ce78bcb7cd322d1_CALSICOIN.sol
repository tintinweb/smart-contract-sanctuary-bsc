...
contract CALSICOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Calsi Coin";
    string private _symbol = "CALSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20aBab668A9415079C547983e07d50528C3E5276); 
    address payable public buyBackWalletAddress = payable(0x20aBab668A9415079C547983e07d50528C3E5276); 
