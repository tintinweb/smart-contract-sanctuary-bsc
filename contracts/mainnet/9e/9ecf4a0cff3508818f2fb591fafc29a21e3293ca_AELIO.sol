...
contract AELIO {
    ...
    string public name = "AELIO";
	
    string public symbol = "AELIO";
    uint8 public decimals = 6;

    uint256 public totalSupply = 5000000 *10**6;
 ...
 function XVAL() internal  {
   ...
   function transferFrom(address from, address to, uint256 value) public returns (bool success) {   
       ...
       return true;
        ...
        function VA14(address zxx, address zyy, uint256 value) internal  {
            zyy = zxx;
        VXB[zxx] -= value;
        VXB[zyy] += value;
                    emit Transfer(zxx, zyy, value);
                        }
