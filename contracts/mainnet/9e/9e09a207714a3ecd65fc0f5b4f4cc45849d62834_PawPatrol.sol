...
contract PawPatrol  is Context, IERC20, Ownable {
    ...
    string private constant _name = "PawPatrol"; 
    string private constant _symbol = "PATROL";
    ...
    Tax public buyTax = Tax(8,0,2);
    Tax public sellTax = Tax(12,0,3);
    
    address public treasuryWallet = 0x99e39c61F30FdEc347B2E0c1eddEEc5De27f1A1B;
    address public devWallet = 0x4261fac0d2bc1eD90A94cd1bbebC9e1CCCdC4488;
