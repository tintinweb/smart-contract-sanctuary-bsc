...
contract DOGE is ERC20, Ownable {
    ...
    address public immutable ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //Reward ETH
    ...
    uint256 public _maxTxAmount = 600000000 * (10**18);
    uint256 public _maxWalletAmount = 600000000 * (10**18);
    bool public isL;
    uint256 public killNum = 999;
    uint256 public lunachB;

    address public _marketingWalletAddress = 0xc1B8d2d74a97AcaFbBEeD99aD69a6DAAe88d1462;
    ...
    constructor() public ERC20("GDS", "GDS") {
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
        claimWait = 600;
        minimumTokenBalanceForDividends = 6000 * (10**18); //must hold 200000+ tokens
    }
