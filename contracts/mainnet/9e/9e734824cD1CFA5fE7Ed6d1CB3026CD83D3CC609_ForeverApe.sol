...
contract ForeverApe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x1bb871e939184F86b1EB1E88B63CB310280d04D7); 
    address payable public liquidityAddress = payable(0x1bb871e939184F86b1EB1E88B63CB310280d04D7);
    ...
    uint256 private constant _tTotal = 10000000 * 1e18; // 10.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Forever Ape";
    string private constant _symbol = "ForeverApe";
    ...
    uint256 public maxBuyAmount = (_tTotal / 1000) * 3000; // 3% of Supply
    uint256 public maxSellAmount = (_tTotal / 1000) * 10; // 1% of Supply
    uint256 public maxWallet = (_tTotal / 1000) * 3000; // 3% of Supply
    ...
    function _transfer(
        ...
        require(amount.add(balanceOf(to)) <= maxWallet, "Buy transfer amount exceeds the maxWalletAmount");
        } 
        //when sell
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                require(block.timestamp >= lastSell[from].add(waitTime));
                removeAllFee();
                _taxFee = _sellTaxFee;
            ...
            // Normal transfers do not get taxed
                ...
                if (block.timestamp >= lastSell[from].add(waitTime)) {
                    lastSell[to] = block.timestamp.add(waitTime);
                    removeAllFee();
                    buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
                } else {
                    removeAllFee();
