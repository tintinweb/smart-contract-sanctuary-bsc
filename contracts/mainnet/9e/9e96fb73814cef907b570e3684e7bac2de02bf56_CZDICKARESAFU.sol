...
contract CZDICKARESAFU is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZDick are SAFU"; // 
    string private constant _symbol = "CZDick"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7864B46dB96c9C0bf5e9f2E9E8dCAeD6812c07DE;
