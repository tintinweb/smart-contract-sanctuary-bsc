...
library Address{
 ...
 contract  panthergrow is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF18b222cEFf304BBdAf55393938988D1B8Ce35Ec;
    address public donationWallet =0x1a92E71F646C6a522c561184663459e1219Ba63a ;

    string private constant _name = "panther grow";
    string private constant _symbol = "pgw";
    ...
    Taxes public sellTaxes = Taxes(0, 13, 2, 0);
