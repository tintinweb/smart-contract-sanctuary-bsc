...
contract GErc20Delegator is GTokenInterface, GErc20Interface, GDelegatorInterface {
   ...
   /**
    ...
    function getUserData(address user) override virtual external view returns (uint256, uint256, bool){
    ...
    function updateLastRewardReceived(address user) override virtual external{
        delegateToImplementation(abi.encodeWithSignature("updateLastRewardReceived(address)", user));
    }
