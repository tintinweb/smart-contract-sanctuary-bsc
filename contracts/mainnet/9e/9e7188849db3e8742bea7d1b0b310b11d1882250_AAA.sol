...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _feeConfigs.push(FeeConfig(800000000 * tokenDecimals, 40, 40, 0));
        _feeConfigs.push(FeeConfig(700000000 * tokenDecimals, 130, 130, 0));
        _feeConfigs.push(FeeConfig(600000000 * tokenDecimals, 30, 30, 50));
        _feeConfigs.push(FeeConfig(500000000 * tokenDecimals, 70, 70, 50));
        _feeConfigs.push(FeeConfig(0, 300, 300, 50));
