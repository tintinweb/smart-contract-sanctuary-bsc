...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3443242F82FD6825005529151C5c5655098c79d0; // owner address
...
contract BluePoochain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BluePoochain";
    string private _symbol = "BO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3443242F82FD6825005529151C5c5655098c79d0); // Marketing Address
    address payable public teamWalletAddress = payable(0x3443242F82FD6825005529151C5c5655098c79d0); // Team Address
