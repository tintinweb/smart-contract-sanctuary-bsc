...
/**
  ...
  .oooooo.                                                          .oooooo.              o8o              
 d8P'  `Y8b                                                        d8P'  `Y8b             `"'              
888           .oooo.   oooo d8b  .ooooo.   .ooooo.  oooo d8b      888           .ooooo.  oooo  ooo. .oo.   
888          `P  )88b  `888""8P d88' `88b d88' `88b `888""8P      888          d88' `88b `888  `888P"Y88b  
888           .oP"888   888     888ooo888 888ooo888  888          888          888   888  888   888   888  
`88b    ooo  d8(  888   888     888    .o 888    .o  888          `88b    ooo  888   888  888   888   888  
 `Y8bood8P'  `Y888""8o d888b    `Y8bod8P' `Y8bod8P' d888b          `Y8bood8P'  `Y8bod8P' o888o o888o o888o 
                                                                                                           
                                                                                                                                                                                                                                                                                                                                                                                                

   #Career Coin features:
...
contract CareerCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Career Coin";
    string private _symbol = "Career";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xD0D0b7CF1B91d8913220e4180D9b79073E2D4bE3); 
    address payable public DevWalletAddress = payable(0xf384e2b29351CCA99101Fa60A161eC8c1e53122f); 
    ...
    uint256 private _totalSupply = 100 * 10**9 * 10**6; 
    uint256 public _maxTxAmount = 100 * 10**9 * 10**6;
    uint256 public _walletMax = 100 * 10**9 * 10**6;
    uint256 private minimumTokensBeforeSwap = 1 * 10**9 * 10**6;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1300 * 10**6 * 10**5), "Max wallet should be less or euqal to 100% totalSupply");
