...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract CloudGaming is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public gasForProcessing = 220000;
    ...
    constructor() ERC20("DogeCloud", "CG") {
        
        address newOwner = address(0xb6A942412Ace66a7ae723C5157A2f8336CD07550);
    	...
    	marketingWallet = address(0xb6A942412Ace66a7ae723C5157A2f8336CD07550); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xb6A942412Ace66a7ae723C5157A2f8336CD07550),
            block.timestamp
        );
