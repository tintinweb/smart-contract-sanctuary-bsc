...
contract FIFAFLOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFA Floki Inu";
    string private _symbol = "FIFLOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1ACf09EF7fEA9E341e8eF46A30e3E84664B07ca8); // Marketing Address
    address payable public PrizeWalletAddress = payable(0x36ea79032DF8F1a60E15b36182800f3C4C4Dad0e); // Prize Wallet
    ...
    function setPrizeWalletAddress(address newAddress) external onlyOwner() {
        PrizeWalletAddress = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(PrizeWalletAddress, amountBNBBuyBack);
