...
contract DogeZilla is Context, IERC20 { 
    ...
    uint256 private _tTotal = 6900000000000 * 10**_decimals;

    uint256 public _tax_On_Buy = 5;
    uint256 public _tax_On_Sell = 5;

    uint256 public _maxBuy = _tTotal *5 / 1000;
    uint256 public _maxSell = _tTotal * 5 / 1000;
    uint256 public _maxWalletToken = _tTotal * 15 / 1000;

    uint256 public _swapTrigger = 5;
    uint256 public _swapTokenAtAmount = _tTotal * 1 / 200;

    address payable public DevWallet = payable(0xFC61f860c237CcF143Be51A05673f0f8b45971bb);
    address payable public MarketingWallet = payable(0x606e820B43314cC6DDdF1c1a6E65434fc5fdF2ea);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap { 
            uint256 _tokenForMarketing = contractTokenBalance * 5 / 100;
            uint256 _tokenForDevelopment = contractTokenBalance * 95 / 100;
            ...
            uint256 _BMarketing = _BTotal * 5 / 100;
            uint256 _BDevelopment = _BTotal * 95 / 100;
