...
contract CardNFT is ERC721, AccessControl, Pausable {
    ...
    event CardMintedWithType(uint256 newTokenId, address receiver, uint256 cardType);

    constructor() ERC721("Card NFT | Wizarre", "CWNFT") {
        _baseURIString = "https://nft.wizarre.io/c/";
    ...
    function mint(address receiver, uint256 cardType) external returns (uint256) {
        ...
        emit CardMintedWithType(newTokenId, receiver, cardType);
