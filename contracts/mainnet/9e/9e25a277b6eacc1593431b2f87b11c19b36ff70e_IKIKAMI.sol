...
Telegram:   https://t.me/IkiKamiPortal
Website:    https://ikikami.com/
...
contract IKIKAMI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "IKIKAMI";
    string private constant _symbol = unicode"IKIKAMI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable private DevWallet = payable(0x57F038b92c29F3a347b38087516C023f6dCd7f30);
    address payable private MarketingWallet = payable(0x234435E07cE1c7Fe996BFeCfd1fc7af801a24CF5);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap { 
            uint256 _tokenForMarketing = contractTokenBalance * 5 / 10;
            uint256 _tokenForDevelopment = contractTokenBalance * 4 / 10;
            ...
            uint256 _BMarketing = _BTotal * 5 / 10;
            uint256 _BDevelopment = _BTotal * 4 / 10;
