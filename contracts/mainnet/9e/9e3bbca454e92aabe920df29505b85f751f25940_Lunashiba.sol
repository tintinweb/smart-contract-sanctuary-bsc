...
// Telegram / https://t.me/lunashibacommunity
// 3% Max wallet / Taxes: 9 percent buy, 10 percent sell
// DONT SNIPE
...
contract Lunashiba is IBEP20, Auth {
    ...
    string constant private _name = "LunaShiba";
    string constant private _symbol = "SLUNA";
    ...
    address public varMarketingFeeReceiver = 0xA59FF1c30F4bc620419EE02a6Cf6fd1A78F610e1;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _varMarketingFee, uint256 _taxLiquidity, uint256 _devFee, uint256 _feeDenominator) external authorized {
        taxLiquidity = _taxLiquidity;
        varMarketingFee = _varMarketingFee;
        devFee = _devFee;
        totalFee = _taxLiquidity.add(_varMarketingFee).add(_devFee);
