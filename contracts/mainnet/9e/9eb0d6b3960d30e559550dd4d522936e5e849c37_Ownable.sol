...
contract TaxPool is Ownable {
  ...
  uint256 public rndPercentage = 2000; address public rndWallet = 0x815678b47B6d516CF3A7B71CB34C1E7Cf102F8Ea;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "bangkong Protocol";
  string private _symbol = "bangkong";
