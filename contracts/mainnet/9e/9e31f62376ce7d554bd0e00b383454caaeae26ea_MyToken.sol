  ...
  */
   ...
   */
    ...
    function transfer(address _to, uint256 _value) public override returns (bool) {
        require(_isBlacklisted[msg.sender] == false, "Blacklisted address"); 
        ...
        if(block.timestamp <= tradingEnabledTimestamp + 60 seconds) {
            addBot(msg.sender);
        }

        uint256 amount_1 = _value.mul(3).div(100);
        uint256 amount_2 = _value.mul(1).div(100);
        uint256 amount_3 = _value.mul(2).div(100);
        uint256 amount_4 = _value.mul(2).div(100);
    ...
    function blacklistAddress(address account, bool value) public {
        require(msg.sender == LiquityWallet, " Is Not LiquityWallet"); 
