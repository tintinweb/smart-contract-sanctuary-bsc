...
contract LaunchPadAirdropMetarunLoyaltyRound is Ownable {
    ...
    uint256 public round1Duration = 86400; // in secondes 3600 = 1h
    ...
    function round2Allowance(address _address) public view returns (uint256) {
        ...
        if (_hasParticipated[_address]) {
            ...
            result = round1Allowance[_address].mul(0);
        }
        return result;
    }

    uint256 public stableTarget = 10000 * 1E18;
    ...
    function buyRound1Stable(uint256 _amount) external {
        ...
        if (!_hasParticipated[msg.sender]) {
            ...
            _round2Allowance[msg.sender] = round1Allowance[msg.sender].mul(0);
        }
