...
contract CharizardCoin is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x37155aA768a719bbD0b6A5C02ebB4E0b1527FE28);
    address payable private _marketingAddress = payable(0x37155aA768a719bbD0b6A5C02ebB4E0b1527FE28);
    
    string private constant _name = "Charizard Coin";
    string private constant _symbol = "Charizards";
