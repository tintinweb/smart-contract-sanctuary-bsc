...
/**
      ___  _______  _______  ___      _______  ___   _  ___  
     |   ||       ||       ||   |    |       ||   | | ||   | 
     |   ||   _   ||    ___||   |    |   _   ||   |_| ||   | 
     |   ||  | |  ||   |___ |   |    |  | |  ||      _||   | 
  ___|   ||  |_|  ||    ___||   |___ |  |_|  ||     |_ |   | 
 |       ||       ||   |    |       ||       ||    _  ||   | 
 |_______||_______||___|    |_______||_______||___| |_||___|                                                                                                                                                                                                                                               
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x98555820bD02fEfe8EAcFFF8159ef8E27bbe68c2; 
...
contract JoFlokiBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JoFloki";
    string private _symbol = "$JOKI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x131557a3b4aD1F57EdcEbfAA42d368653d372a93); // MW
    address payable private teamWalletAddress = payable(0x98555820bD02fEfe8EAcFFF8159ef8E27bbe68c2); // DEPLOYER
