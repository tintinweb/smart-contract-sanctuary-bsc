...
contract CallersInu is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Callers Inu";
    string private _symbol = "CI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEe62760173a2F4bF994d0718610Cd51E26d923A0); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xEe62760173a2F4bF994d0718610Cd51E26d923A0); // BuyBack Address
