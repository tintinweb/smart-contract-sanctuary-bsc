...
contract FourThreeThree is ERC20, Ownable {
    ...
    constructor () ERC20("433 Token", "433") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x168ffDE6e666936eC898Af42b67037f2F0459126;
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_marketingFeeOnBuy <= 10, "Total Fees cannot exceed 10%");
    }

    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        marketingFeeOnSell = _marketingFeeOnSell;
        require(_marketingFeeOnSell <= 10, "Total Fees cannot exceed 10%");
    }

    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 10, "Wallet to Wallet Transfer Fee cannot exceed 10%");
