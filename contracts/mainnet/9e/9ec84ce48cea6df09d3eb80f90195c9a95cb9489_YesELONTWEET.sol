...
contract YesELONTWEET is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0x31115e168A0bf6D7A17F3711D16770302aD1Ef4e;

    string private constant _name = "Yesss!!!";
    string private constant _symbol = "YESELON";
    ...
    Taxes public taxes = Taxes(2, 3, 2);
    Taxes public sellTaxes = Taxes(2, 3, 2);
