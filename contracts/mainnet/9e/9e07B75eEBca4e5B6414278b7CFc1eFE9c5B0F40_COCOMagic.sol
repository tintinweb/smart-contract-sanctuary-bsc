...
contract COCOMagic is Context, IERC20, Ownable {
    ...
    string private _symbol = "COCOMagic";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc2f09383C6496e678EF0b9ECb18f9a948cCAd62C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x14a8181e0D84015Bfa23517e28223Bceb79B50c4); // BuyBack Address
