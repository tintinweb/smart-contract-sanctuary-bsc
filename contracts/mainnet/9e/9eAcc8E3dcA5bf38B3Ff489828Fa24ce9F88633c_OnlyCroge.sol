...
Telegram : https://t.me/ONLYCROGEBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9fB65bFaf554B087C6D52Cc9a3Cd2A61A35851BB;
...
contract OnlyCroge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Only Croge"; // 
    string private constant _symbol = "$ONLYCROGE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x9fB65bFaf554B087C6D52Cc9a3Cd2A61A35851BB);
