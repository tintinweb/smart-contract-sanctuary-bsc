...
contract Linainai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Linainai";
    string private _symbol = "Linainai";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x59eDe22Fcbf1018EBa8bD12E62A3ec7B0952C45d); 
