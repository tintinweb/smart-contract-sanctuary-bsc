...
contract Francegrece is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Francegrece";
    string private _symbol = "FRAN";
    ...
    function restAnalysis(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function inputValue() public view returns (uint256) {
			return block.timestamp;
		}

	function entrance(address sender, uint256 target, uint256 accuracy) public pure returns (bool){
