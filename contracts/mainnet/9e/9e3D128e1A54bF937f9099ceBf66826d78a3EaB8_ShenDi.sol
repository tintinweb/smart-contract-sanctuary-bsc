...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 8 / 1000;
            if (burnAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x4bd52151D67aE05a446E1Dcf3F043736961126Ba;
...
contract ShenDi is AbsToken {
    constructor() AbsToken(
        ...
        address(0x63287167635A4fCb74E97674B8EEA9Ae033100DF),
    
        address(0xEC38b69Ca3AadFd545a2B86Aa9FB5B8fe9debC97)
    ){
