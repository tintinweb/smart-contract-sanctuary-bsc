...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2baE293e19E7dC0c68D2b8F47b07C2B1c7758931; // owner address
...
contract SantaDust is Context, IERC20, Ownable {
    ...
    string private _name = "SantaDust";
    string private _symbol = "SD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2baE293e19E7dC0c68D2b8F47b07C2B1c7758931); // Marketing Address
