...
contract ODINDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3BF3746718046c513aC9BB24634E1088DB88704e); // Marketing Address
    ...
    uint256 private _tTotal = 30000000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ODINDOGE";
    string private _symbol = "ODINDOGE";
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**2 * 10**9;
