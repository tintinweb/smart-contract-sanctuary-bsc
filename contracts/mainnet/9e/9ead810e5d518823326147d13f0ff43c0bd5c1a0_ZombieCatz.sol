...
contract ZombieCatz is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20_000_000_000_000 * 10**9;
    uint256 public _maxTxAmount = 20_000_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100_000_000_000 * 10**9; 

    string private constant _name = "ZombieCatz"; 
    string private constant _symbol = "MEUUH"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x8BF5fC48670056FeC2D98a79b58B4CCfA1F1618a; 
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 160; 
        uint256 liquidityFee = amount * _liquidityFee / 120; 
