...
contract ProofOfReserve is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 25_000 * (10**_decimals);
    uint256 public maxSellLimit = 12_500 * (10**_decimals);
    uint256 public maxWalletLimit = 25_000 * (10**_decimals);
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0x07891b3B48eAA7Ea5c2De18088642922b71905A1;
    address public devWallet = 0x5a8646D89c246210e7EBD97fE6F84BE552bC30a6; 
    address public operationWallet = 0x07891b3B48eAA7Ea5c2De18088642922b71905A1;
    address public charityWallet = 0x07891b3B48eAA7Ea5c2De18088642922b71905A1; 
    ...
    Taxes public sellTaxes = Taxes(0, 20, 2, 20, 0, 0);
