...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3953D2BDEBC0A8749897fB9ea40EB3307F9e0b69;
...
contract BlanchGroupToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE2c800b3Fb249C5e2f170E13b83478266251DB4d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 148560202341602000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BlanchGroupToken";
    ...
    uint256 public _maxTxAmount = 148560202341602000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 148560202341602000000 * 10**18;
