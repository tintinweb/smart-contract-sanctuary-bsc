...
contract twitterdogeblack is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twitter Doge Black"; // 
    string private constant _symbol = "TDOGEBLACK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x16eAac0e9eD4d6Ac8a25bE0076C0a14BCdc2A4Cc;
