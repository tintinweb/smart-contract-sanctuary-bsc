...
contract WKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wakanda Inu";
    string private _symbol = "WKI";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x73C304E05a020132178450c51fcD7BAaC40a581E); // Marketing Address
    address payable public BuyBackWallet = payable(0x73C304E05a020132178450c51fcD7BAaC40a581E); // Team Address
