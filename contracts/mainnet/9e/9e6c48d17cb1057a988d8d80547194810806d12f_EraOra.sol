...
contract EraOra is ERC20, Ownable {
    ...
    uint256 private _totalFeesOnBuy = liquidityFeeOnBuy + projectFeeOnBuy + marketingFeeOnBuy;
    uint256 private _totalFeesOnSell = liquidityFeeOnSell + projectFeeOnSell + marketingFeeOnSell;
    ...
    constructor (address newOwner)ERC20("ERAORA",  "$EOT"){  

        _mint(newOwner, 9_000_000_000 * (10 ** 18));

        operator = msg.sender;
        marketingWallet = 0x35096d07c0FA7A8BB68353f5275913C381882f22;//Mainnet
        projectWallet = 0x8f3bb93A2557c7307119C86d13199C87160dE821;//Mainnet
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _projectFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _projectFeeOnBuy <= 10,
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _projectFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _projectFeeOnSell <= 10,
            "Fees must be less than 10%"
        );
