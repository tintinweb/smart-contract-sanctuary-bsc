...
contract BabyFlokiZilla is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyFlokiZilla";
    uint8 private _decimals = 9;

    IAntiBot private _antiBot;
    address payable public marketingWalletAddress = payable(0x4677fA93e336010A7b7679F9d75f8ca3bcF13198); 
    address payable public teamWalletAddress = payable(0x4677fA93e336010A7b7679F9d75f8ca3bcF13198); 
