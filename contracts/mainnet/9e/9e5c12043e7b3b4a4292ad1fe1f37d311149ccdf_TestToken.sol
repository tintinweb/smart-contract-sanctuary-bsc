...
abstract contract Token is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x472C2d8fBb0013a882a8b556D0D99B232164ff8b;//fund address
...
contract TestToken is Token {
    constructor() Token(
        ...
        address(0x472C2d8fBb0013a882a8b556D0D99B232164ff8b),//fund address
    
        address(0x53CCaeF88593A0087509CEB4895061FdAF8B6e42)//dev address
    ){
