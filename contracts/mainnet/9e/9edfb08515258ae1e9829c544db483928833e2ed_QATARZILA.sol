...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x905e9e2CC623253a5f1F65a4cB5fCe92A8fECc1a;
...
contract QATARZILA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0xA61AffeF8faf7c31456C3712ccf8A671e9174Ba8 ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Qatarzila";
    string private _symbol = "Qzila";
