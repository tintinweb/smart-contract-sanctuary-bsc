...
/*
  Swiss Bridge Network - XSBN Token
  The Swiss Bridge Network project is a bridge finance earning system for BNB and other major cryptocurrencies.
  As Swiss Bridge Network (XSBN) uses tokens, it aims at a Financial service where you can get a share of BNB and USDT swap commissions.

  You can join the financial pool by purchasing Swiss Bridge Network tokens on PancakeSwap.
  A total of 7% commission is requested from you in purchasing and selling transactions for
  the growth of the project and the completion of the market costs.
*/
...
contract SwissBridgeNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Swiss Bridge Network";
    string private _symbol = "XSBN";
    ...
    address public charityWallet = 0x832D418e4cC8F2f15392948d4452Bf3ccA90aBb9;
