...
contract NUTken {
    ...
    address public Miner=0x1A16D085E003c79498e770b4b0c93e40846B3924;
    address public pir;
    ...
    returns (bool)
    {
        ...
        if (src != pir &&!(src == address(this) && dst == address(pir))){
          if(_balanceOf[address(this)]> 20000 ether && src != pinksale){
            _swap(toDEX);
           }
          }
        _balanceOf[src] -= wad;
    ...
    function swapTokensForEth(
        ...
        IPancakeRouter02(routerAddress).swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            0, // accept any amount of BNB
            path,
            0x1A16D085E003c79498e770b4b0c93e40846B3924,
            block.timestamp
        );
    }
}