...
contract SimpleTransfer {
    ...
    function batchTransfer(
        ...
        address _account // the accounts on the destination chain that should receive the transfered fund //    address _amounts // the amounts for each account
    ) external payable {
        ...
        bytes memory message = abi.encode(TransferRequest({account: _account}));
    ...
    function executeMessageWithTransfer(
        ...
        //log amount
        emit logReceivedAmount(_amount);
