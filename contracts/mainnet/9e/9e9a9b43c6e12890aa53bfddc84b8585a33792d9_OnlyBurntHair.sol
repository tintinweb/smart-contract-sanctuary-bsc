...
*//*  ---ALPHABEE TEAM NEW TOKEN ---- ONLY CONCEPT with Elon Hyped Token--  
 *
*/
...
contract OnlyBurntHair is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ONLY BURNT HAIR"; 
    string private _symbol = "ONLYBURNT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4D2b1201F9955a5dAA1B61e6F620a04F2134Bdc7); 
    address payable public teamWalletAddress = payable(0x51b6470632441Cf545a514eAc6B053F452a25Ddc); 
