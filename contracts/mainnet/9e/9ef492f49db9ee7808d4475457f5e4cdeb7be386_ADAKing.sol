...
contract ADAKing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc9401dB2235A747E7c8Cfde43D4b3538df8c2E8A); 
    address payable public teamWalletAddress = payable(0xc0a3FAF685A11D7bA4b69F1AC66481528934950D); 
    ...
    uint256 private _totalSupply = 2537 * 10**_decimals;
    uint256 public _maxTxAmount = uint (1000000000); 
    uint256 public _walletMax = uint (5000000000);
    uint256 private minimumTokensBeforeSwap = uint (100000); 
