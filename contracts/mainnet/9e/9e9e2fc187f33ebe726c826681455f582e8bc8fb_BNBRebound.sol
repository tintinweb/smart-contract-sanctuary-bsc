...
contract BNBRebound is Context, IERC20, Ownable {
    ...
    string private constant _name = "BNB Rebound"; // 
    string private constant _symbol = "REBOUND"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x132e55889C2eDd31AeCD2CF86B9DBdced0b3A554;
