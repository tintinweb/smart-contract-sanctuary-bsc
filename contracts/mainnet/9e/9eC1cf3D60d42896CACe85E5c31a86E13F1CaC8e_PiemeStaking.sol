...
contract PiemeRewardVault is PiemeVault, IPiemeRewardVault {
    ...
    uint256 public constant MONTHS24 = 720 days; // 5,000,000
    uint256 public constant DAILYRWD = 80375514403292000; // 6944.4444 daily

    constructor(address token_, address owner_) PiemeVault(token_, owner_) {
        refreshed = 1657192137; // Thu Jul 07 2022 11:08:57 GMT+0000
    }
