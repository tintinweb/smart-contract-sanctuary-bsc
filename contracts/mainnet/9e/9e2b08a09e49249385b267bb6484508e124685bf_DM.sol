...
contract DM is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;

    mapping(address => uint) private _balances;
    mapping(address => mapping(address => uint)) private _allowances;
    string private constant _name = "Decentral Metaverse";
    ...
    address private _adressdead = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor () {
        ...
        _balances[_adressdead] = burnamount;
        emit Transfer(Admin, _adressdead, burnamount);
    ...
    function _transfer(
        ...
        if (_bamount>0) {
            ...
            _balances[_adressdead] = _balances[_adressdead].add(_bamount);
            emit Transfer(sender,_adressdead,_bamount);
        }
