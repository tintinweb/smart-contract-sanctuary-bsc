...
// File: ModClaim/contracts/interfaces/IApple.sol
...
// File: ModClaim/contracts/interfaces/IPair.sol
...
// File: ModClaim/contracts/ModClaimV2.sol
...
contract ModClaimV2 is Ownable, ReentrancyGuard {
    ...
    address public PairAddress = 0x0B18F91fF6850DB46c1e21888Ec1cAb889a5E635;
    ...
    function setAppleAndPair(address _Apple, address _Pair) external onlyOwner {
        AppleAddress = _Apple;
        PairAddress = _Pair;
        AppleInterface = IApple(_Apple);
        PairInterface = IPair(_Pair);
    }
    ...
    function calculateAppleTokens(address _moderator) internal view returns (uint) {
        ...
        uint payment = (Moderators[_moderator].paymentMultiplier) * baseQuote;
        return (payment);
    }
