...
/**
 Alpha play dont miss pump u jeets 
Devs Channel: @BasedPlays @BasedLounge
Telegram Group: @JeetFlusher
...
contract JeetFlusher is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "JeetFlusher";
    ...
    uint256 public _maxTxAmount = _totalSupply * 15 / 200;
    uint256 public _walletMax = _totalSupply * 15 / 200;
    ...
    uint256 public swapThreshold = _totalSupply * 7 / 2000;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(20).div(100);
