...
contract AIBunny is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x97553757dCf24efB97390acBe7fE7FFDE4Ec82Bb); // Marketing Wallet Address
    address public burnWalletAddress = 0x000000000000000000000000000000000000dEaD; // burn Wallet Address
    ...
    uint256 public totalSwapableFee = _liquidityFee + _burnFee + _marketingFee;

    uint256 _saleTaxFee = 3;
    uint256 _saleLiquidityFee = 0;
    uint256 _saleBurnFee = 0;
    uint256 _saleMarketingFee = 0;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleBurnFee + _saleMarketingFee;
    ...
    {   
        ...
        uint256 totalTokensToSwap = liquidityTokensCollected + burnTokensCollected + marketingTokensCollected;
        bool success;
        ...
        uint256 burnTokens = contractBalance * burnTokensCollected / totalTokensToSwap;
        uint256 amountToSwapForETH = contractBalance - liquidityTokens - burnTokens;

        if (burnTokens > 0){
            _tokenTransfer(address(this), burnWalletAddress, burnTokens, false);
            burnTokensCollected = 0;
        }
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee + _burnFee + _marketingFee; 
    }
    ...
    function restoreAllFee() private {
        ...
        function setAllFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 marketingFee) 
    external onlyOwner() 
    {
        ...
        totalSwapableFee = _taxFee + _liquidityFee + _burnFee + _marketingFee ; 
    ...
    function setSaleFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 marketingFee) 
    external onlyOwner() 
    {
        ...
        totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleBurnFee + _saleMarketingFee;
        require( totalSwapableFee + totalSwapableSaleFee <= 20, "Must be less than 20% total");
