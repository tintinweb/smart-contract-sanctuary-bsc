...
contract CROnonrivalBSC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CRO non-rival BSC";
    string private _symbol = "non-rival";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd157bE8F42fFEd71a6D140b2700a70E0b1B63aD5);
    address payable public teamWalletAddress = payable(0xd157bE8F42fFEd71a6D140b2700a70E0b1B63aD5);
