...
contract catgrowmoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT GROW MOON";
    string private _symbol = "CGM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x69b1442b75f682739722670c62c4DA9DEE32fC4e);
    address payable public teamWalletAddress = payable(0x69b1442b75f682739722670c62c4DA9DEE32fC4e);
