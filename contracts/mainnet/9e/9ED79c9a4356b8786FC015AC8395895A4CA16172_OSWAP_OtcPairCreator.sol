...
contract OSWAP_OtcPair is IOSWAP_OtcPair, OSWAP_PausablePair {
    ...
    bytes32 constant MAX_DUR = "OtcPair.maxDur";
    ...
    function addLiquidity(bool direction, uint256 index) external override lock {
        ...
        offer.originalAmount = offer.originalAmount.add(amountIn);
