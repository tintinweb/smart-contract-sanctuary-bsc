...
// ENGLISH TG PORTAL: @greenpandabsc
// 
//WEBSITE: https://greenpanda.godaddysites.com/
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimal_, address reward1_, address marketing_, address team_, address multiuse_, uint256 supply_, uint256 dispatch_, uint8 maxtaxes_) BEP20(name_, symbol_) {
        ...
        dividendTracker1 = new DIVIDENDTracker1("GreenPanda_Track", "GP", Token1Adress, minTokenBalanceForDividends, decimal, Creator);
...
contract GreenPanda is Main {
    ...
    constructor() Main (
        ...
        0x21b655FffC4bDdE4A862D55566eE0a9520cF9600,     // Marketing address
        0x47326FB346816151cE9b4f69C1C02d1d5545DCb3,     // Team address AND DEV
        0x41491A8d0fDC65B309f01406C008beba26F278f3,     // Multi Use address (CHARITY)
