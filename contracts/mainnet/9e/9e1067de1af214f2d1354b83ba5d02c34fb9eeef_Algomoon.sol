...
contract Algomoon is Context, IERC20, Ownable {
    ...
    uint256 public algomoonFee;
    uint256 private previousAlgomoonFee;
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0xD96aBaA135B630a41F6854C2edd4996dC60f3f3a);
        
        _taxFee = _tax;
        _previousTaxFee = _taxFee;
        algomoonFee = _bb;
        previousAlgomoonFee = algomoonFee;
        marketingFee = _mkt;
    ...
    function restoreAllFee() private {
        ...
        algomoonFee = previousAlgomoonFee;
    ...
    function setAlgomoonFee(uint256 _algomoonFee) external onlyOwner() {
        algomoonFee = _algomoonFee;
        _liquidityFee = algomoonFee.add(marketingFee);
    }
