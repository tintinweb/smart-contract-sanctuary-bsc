...
contract ETHC is Operator {
    ...
    string private _name = "ETHC";//#币名
    string private _symbol = "ETHC";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0xF1B01E5C3B3192c9D13075C08717EaF210E66FD3),true);
    }
