...
contract AlveyIDO is Ownable {
    ...
    uint256 public startDate = 1663416000; // When to start IDO - Sep 17, 2022 12:00:00 UTC
    uint256 public endDate = 1663934400; // When to end IDO - Sep 23, 2022 12:00:00 UTC
    ...
    uint256 public minPerTransaction = 0.01 ether; // min amount per transaction
