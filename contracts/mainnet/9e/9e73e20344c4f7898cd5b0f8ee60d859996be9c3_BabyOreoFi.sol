...
//Missed out on OreoFi? Baby OreoFi is here with fat OreoFi rewards. 
//Community Telegram: https://t.me/BabyOreoFi
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xF28Db5d3DDaa505937CfE27eE52D91dA73B1D740); //OreoFi $OREO Rewards
...
contract BabyOreoFi is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Baby OreoFi";
    string constant _symbol = "bOREO";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xF28Db5d3DDaa505937CfE27eE52D91dA73B1D740 ; //OreoFi $OREO Rewards
    ...
    uint256 public rewardsFee = 5; //Rewards might be turned on at higher marketcap to reduce gas fees
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0xcF0F80Ca33Bb9F12B7bea4bB1815DF358fA52C91;  
        anothermarketingWallet = 0xcF0F80Ca33Bb9F12B7bea4bB1815DF358fA52C91;
