...
https://t.me/SantaSquid

Santa Squid aims to be the biggest Christmas coin on the BSC network this year. 

LP Locked initially for 1 Week [will be increased until Christmas at 10k market cap]

With clean graphics, a dedicated team and a side of BUSD Rewards.

12% Buy / 12% Sell 
8% Marketing
4% BUSD Rewards

THIS CONTRACT IS 100% SAFE ONCE RENOUNCED!
...
contract SantaSquid is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Santa Squid";
    string constant _symbol = "SANSQUID";
