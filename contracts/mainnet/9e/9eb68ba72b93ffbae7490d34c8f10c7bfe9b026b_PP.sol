...
contract PP is Context, IERC20, Ownable {
    ...
    string private _name = "PP Coin";
    string private _symbol = "PP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdFe33e3f14B07aE83e2d4B2F8f1867B7D6b28688);
    address payable public teamWalletAddress = payable(0x777C29425e13697F53a4ed73ef7adC06Ad19ac0b);
