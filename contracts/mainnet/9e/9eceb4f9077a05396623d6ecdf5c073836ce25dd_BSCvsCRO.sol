...
contract BSCvsCRO is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 5_000_000 * 10**9; // 0.5%
    uint256 public maxBuyLimit = 10_000_000 * 10**9; //1%
    uint256 public maxSellLimit = 10_000_000 * 10**9; //1%
    uint256 public maxWalletLimit = 20_000_000 * 10**9; //2%
    ...
    string private constant _name = "BSC vs CRO Token";
    string private constant _symbol = "BVC";
    ...
    Taxes public taxes = Taxes(0, 6, 2, 2, 0);
    Taxes public sellTaxes = Taxes(0, 6, 2, 2, 0);
