...
contract BUSDilloinaire is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "BUSDilloinaire";
    string  _symbol = "$BUSDR";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x15D074102508B50cd178813b038E002DC9A64536;
        teamFeeReceiver = msg.sender;
        devFeeReceiver = 0xF7e8c93D0195F22f5c7FF31232bf55f8107A2aA5;
