 ...
 * AL RIHLA INU 
 *
 * The Most Revolutionary FIFA World Cup Memecoin! New and Innovative Tax Fee System
 * 
 * FEES:
 *
 *  8% tax fee (6% Back to the Liquidity Pool, 1%  Redistributed to Holders, 1% Burned From Supply)
 * 
 * Total Supply 8,888,888,888 AL RIHLA INU Tokens 
 * Max amount permited per wallet  888,888,888 AL RIHLA INU Tokens 
 * Max transaction size            888,888,888 AL RIHLA INU Tokens 
 * 
 * Official Telegram Account: https://t.me/AlRihla_Inu
 */
...
contract AlRihlaInu is Context, IBEP20, Ownable {
    ...
    string private _name = "Al Rihla Inu";
    ...
    uint256 public _maxTxAmount = 888888888 * 10**9;   // Max Tx Size: (10%)
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**9;  // numTokensSellToAddToLiquidity (1%)
    uint256 public _maxWalletToken = 888888888 * 10**9; // Max Wallet: (10%)
