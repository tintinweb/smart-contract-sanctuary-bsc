...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6F78b384D8620B4A0E8987a9A1461228A60aDcf5; // owner address
...
contract SaudiGoat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Saudi Goat";
    string private _symbol = "SGT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1b39e5c7C465363920cf20BCDef2CA77e946094a); // Marketing Address
    address payable public teamWalletAddress = payable(0xAe6c327942bf156Cf2d0D4AB620A218868e47316); // Team Address
