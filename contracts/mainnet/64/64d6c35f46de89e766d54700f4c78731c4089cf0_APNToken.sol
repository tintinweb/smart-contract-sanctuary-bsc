...
abstract contract LpFee is Owned, DexBase, ERC20 {
    ...
    function process(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (amount >= 1e12 && balanceOf[address(distributor)] >= amount) {
...
abstract contract MarketFee is Owned, ERC20 {
    ...
    address public constant marketingAddr =
        0xCed0869cA8aD314F0C826Bb79Ddf932e08341846;
...
abstract contract LiquidityFee is Owned, DexBase, ERC20 {
    ...
    uint256 public numTokensSellToAddToLiquidity = 21 * 1e18;
...
contract APNToken is ExcludedFromFeeList, MarketFee, LpFee, LiquidityFee {
    uint256 private constant _totalSupply = 210_0000 * 1e18;
        ...
        returns (uint256)
    {
        if (sender == uniswapV2Pair) {
            ...
            return amount - lpAmount - marketingAmount;
        } else {
            //sell
            uint256 liquidityAmount = _takeliquidityFee(sender, amount);
            uint256 marketingAmount = _takeMarketing(sender, amount);
            return amount - liquidityAmount - marketingAmount;
        }
    }
