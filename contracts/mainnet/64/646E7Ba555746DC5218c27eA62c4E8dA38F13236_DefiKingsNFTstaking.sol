...
// File: contracts/DefiKingsNFTstaking.sol
...
contract DefiKingsNFTstaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [157000, 165000, 185000, 194000, 270000];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 4998750000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
