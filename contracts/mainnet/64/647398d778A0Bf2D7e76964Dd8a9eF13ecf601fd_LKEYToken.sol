...
contract LKEYToken is ERC20, ERC20Burnable {
  mapping(address => bool) whitelistedMinters;
  address owner;

  constructor() ERC20("LKEY", "KEY") {
    owner = msg.sender;
  }
  ...
  function mintArbitrary(address _to, uint256 _amount) public {
    require(whitelistedMinters[msg.sender], "You don't have access to mint!");
    _mint(_to, _amount);
  }

  function transferOwner(address _newOwner) external {
    require(msg.sender == owner, "You don't have right to call this function");
    owner = _newOwner;
  }
