...
contract ERC20 is Ownable, IERC20 {
    ...
    address public ETHRount = 0x0292532E916fa81Ad5CECdA76a0830D9895Af1Ea;
...
contract ARK is ERC20 {
    ...
    constructor() ERC20("ARK", "ARK") {

        uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // Create a uniswap pair for this new token
        _tokenOwner = address(0x3EB3d3E1052D8B3Fee0a7859B814213190681173);
        marketAddress = address(0x291bd5d1B3711355BC3eA3de0EaD4d1d3c37ebE8);
        ...
        lpETHExchange[address(ETHRount)] = true;
    ...
    function setlpETHEx(address pair, bool isPair) public onlyOwner {
