...
contract GODOFCHEEMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GODOFCHEEMS";
    string private _symbol = "GODCHEEMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4be6b5a0001714a7E83d0a2823456cA47506eE00); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4be6b5a0001714a7E83d0a2823456cA47506eE00); // BuyBack Address
