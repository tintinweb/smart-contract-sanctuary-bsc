...
Website：https://patrickstar.life
Twitter: https://twitter.com/PatrickStarI
TG:: https://t.me/PatrickStarToken
TG:: https://t.me/PatrickStarCN
...
contract PATRICK is Context, IERC20, Ownable {
    ...
    uint256 private _buyLiquidityFee = 0;  // Liquidity Fee 1%
    uint256 private _buyMarketingFee = 3;  // Markting Fee 6%
    uint256 private _buyDevFee = 2;  // Dev Fee 1% 

    // 7% Sell Tax
    uint256 private _sellTaxFee = 0; // Reflection Fee 0%
    uint256 private _sellLiquidityFee = 0;  // Liquidity Fee 3%
    uint256 private _sellMarketingFee = 3;   // Markting Fee 6%
    uint256 private _sellDevFee = 2; // Dev Fee 3%
    ...
    constructor() {
        _name = "Patrick Star"; //  Name
        _symbol = "Patrick Star"; //  Symbol
        ...
        _marketingWalletAddress = 0x9000140961d226c2222901A00dc71CaCEc5Ed9c5; // Marketing Wallet 
        _devWalletAddress = 0x9000140961d226c2222901A00dc71CaCEc5Ed9c5; // Dev Wallet 
