...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf909a33cC6f06e285883369fc4d68F5A9f7E4377;
...
contract GANGSTERKWON is Context, IERC20, Ownable {
    ...
    string private constant _name = "GANGSTER KWON"; // 
    string private constant _symbol = "$GKWON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xf909a33cC6f06e285883369fc4d68F5A9f7E4377);
