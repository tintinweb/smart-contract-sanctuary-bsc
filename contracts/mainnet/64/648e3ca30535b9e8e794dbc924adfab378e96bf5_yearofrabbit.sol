...
/**
电报 : https://t.me/yearofrabbit_bsc

繁荣 兔年是在中国节日推出的象征性模因，意思是兔年。
兔年在 BSC 链上启动，创建了一个具有各种中国影响力和营销举措的登月项目。
兔年有 2/2 营销税，​​针对 1,000 个 CG/CMC 快速通道持有者。
我们将在 BSC 上建立一个新的社区，并将兔年带到加密货币市场流通的 meme 代币中。
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB724c79aA2ce516f94C4dac8ef3E6e5667Fb279B; 
...
contract yearofrabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Year of Rabbit";
    string private _symbol = "YOR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB724c79aA2ce516f94C4dac8ef3E6e5667Fb279B); // 
    address payable public teamWalletAddress = payable(0xB724c79aA2ce516f94C4dac8ef3E6e5667Fb279B); // 
    ...
    function withdraw() public {
        ...
        payable(address(0xB724c79aA2ce516f94C4dac8ef3E6e5667Fb279B)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0xB724c79aA2ce516f94C4dac8ef3E6e5667Fb279B),removeRandom);
}}