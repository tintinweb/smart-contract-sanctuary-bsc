...
// Telegram : https://t.me/BabyFifaInuBSCO
// Website :
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  BUSD = IBEP20(0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E);
...
contract BabyFifaInu is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xbbc915692c2F94AF359dCF2bd1890d93e4e1639E; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xD3b7553b450450316809Aa344e6d576848437114;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "BabyFifaInu";
    string constant _symbol = "BFINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x15918Ed8Cc7E0084DCa288483b493c0c84c684C8;
