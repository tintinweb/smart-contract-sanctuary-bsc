...
Bubble up, here we go!

7/7 tax tokenomics with small TXN & wallet.

Socials:

TG: @BubbaApe
Twitter: @BubbaApe
Website: www.bubbaape.xyz
...
contract BubbaApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "$BUBBA";
    string constant _symbol = "Bubba Ape";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x565C21408Ee84d69Ec75CBAEF28E070374399387;
        teamFeeReceiver = 0x565C21408Ee84d69Ec75CBAEF28E070374399387;
