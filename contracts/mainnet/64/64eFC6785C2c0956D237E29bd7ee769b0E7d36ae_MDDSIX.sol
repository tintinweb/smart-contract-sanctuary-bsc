...
contract MDDSIX is Context, IERC20, Ownable {
    ...
    address payable public _taxPool =
        payable(address(0xDC8507E13247c4C39F77bc6C363D3385CdeBc6De));

    string private _name = "MDDSIX";
    string private _symbol = "MDDSIX";
    ...
    uint256 public _MddSixMaxTx = 5 * 10**10 * 10**18;
    uint256 public _MddmaxWallet = 2 * 10**11 * 10**18;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        ...
        _MddSixMaxTx = _tTotal.mul(maxTxPercent).div(10**3);
    }
        ...
        onlyOwner
    {
        ...
        _MddmaxWallet = _tTotal.mul(maxWalletSize).div(10**3);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            if (!_isExcludedFromLimit[from] && !_isExcludedFromLimit[to]) {
                ...
                if (to != uniswapV2Pair) {
                    require(
                        amount + balanceOf(to) <= _MddmaxWallet,
