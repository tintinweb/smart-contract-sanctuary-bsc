...
contract DugongeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC63b6bEc42C2cC8988e05e286f2eA7d5D640D861); 
    address payable public Wallet_Dev = payable(0x0CCac944E69190b78cF433AF1eC11E7b289D0159);
    ...
    string private constant _name = "Dugonge Inu"; 
    string private constant _symbol = unicode"DINU"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 8; 
    ...
    constructor () {
        ...
        _owner = 0x9b45AEDF57579894438592b4c607597Da5946bB2;
    ...
    function setMaxTxPercent(uint256 value) public onlyOwner {
        _maxTxAmount = _tTotal * value / 100;
    }

    function setMaxWalletPercent(uint256 value) public onlyOwner {
        _maxWalletToken = _tTotal * value / 100;
    }
