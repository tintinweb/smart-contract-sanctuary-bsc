...
contract RocketRaccoonDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rocket RaccoonDAO";
    string private _symbol = "ROCDAO";
    uint8 private _decimals = 9;

    address payable private _anotherA = payable(0xEcb4f983297dFb1e13D7C79a396F89874AB297e3); 
    address payable private teamWalletAddress = payable(0xbb62Df92C39a5cE9Ca60697515a4f3081e101cFC); 
