...
contract TILTINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x49232CE3347e06c0a1076beE7e3181d071eB57C2;
 
    string constant _name = "TILT INU";
    string constant _symbol = "$TILT";
