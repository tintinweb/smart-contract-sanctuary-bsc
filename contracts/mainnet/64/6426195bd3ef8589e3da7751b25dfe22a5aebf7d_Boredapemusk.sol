...
/**
STEALTH LAUNCH AT 30-400 MEMBERS Based DEV
TG: https://t.me/BoredApeMusk
TAX: 
BUY : 12% 
SELL: 12%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5a91C294599aa18B7acdAF428D95f9479b6Bf07D; // owner address
...
contract Boredapemusk is Context, IERC20, Ownable {
    ...
    string private _name = "Bored Ape Musk";
    string private _symbol = "Ape musk";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21887f217901af6A7369C0DfA3469F444Da9c980); // Marketing Address
    address payable public teamWalletAddress = payable(0x21887f217901af6A7369C0DfA3469F444Da9c980); // Team Address
