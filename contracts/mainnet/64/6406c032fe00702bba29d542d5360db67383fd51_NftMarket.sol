...
contract NftMarket is ReentrancyGuard {
    ...
    constructor(ERC20 feeToken,address feeAddress) {
    ...
    function setConfig(ERC20 feeToken,address feeAddress) public 
    {
    ...
    function getTokenFee() private view returns(uint256)
    {
        return _fee;
    }
    ...
    function createMarketItem(
        ...
        uint256 allowAmount=_ttcToken.allowance(msg.sender,address(this));
        require(allowAmount>=getTokenFee(), "is not approval"); // 判断当前用户是否授权代币        
 
        //划转手续费
        require(_ttcToken.transferFrom(msg.sender, _feeAddress,getTokenFee()),'fee error') ;

        require(price > 0, "Price must be at least 1 ttc"); // 防止免费交易
        require(_ttcToken.transferFrom(msg.sender, address(this),price),'20001') ;
    ...
    function createMarketSale(
        ...
        _ttcToken.transferFrom(address(this),idToMarketItem[itemId].seller,price);
