...
/**
SpikeClassic
The legendary dog from Tom & Jerry, SpikeClassic is build as an utility token for its NFT marketplace. SpikeClassic is set to be launch by 12th of September.

SpikeClassic TG : https://t.me/SpikeClassic

Below are SpikeClassic's Tokenomics:
1) 100,000,000,000 of supply
2) 8% tax fees
3) Starting with low MC : $300

Experienced Dev team with post-marketing plans

Join SpikeClassic now to be alert for all the updates!
*/
...
contract SpikeClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpikeClassic"; // 
    string private constant _symbol = "SPIKEC"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0xF4023609Be5a0CEfa8BE6BE52baED16B26Dcf4Fc;
