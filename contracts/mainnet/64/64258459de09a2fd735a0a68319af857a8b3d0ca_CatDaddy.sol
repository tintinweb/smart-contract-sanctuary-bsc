...
contract CatDaddy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CatDaddy";
    string constant _symbol = "CatDaddy";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1000 / 1000; // 0.5%
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.15% of supply
    bool inSwap;
