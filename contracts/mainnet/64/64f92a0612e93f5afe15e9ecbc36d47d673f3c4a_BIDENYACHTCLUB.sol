...
contract BIDENYACHTCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "M31CatClub";
    ...
    Taxes public taxes = Taxes(1, 1, 8, 1);
    Taxes public sellTaxes = Taxes(1, 1, 9, 1);
