...
https://t.me/BlackCryptoDEFI

Website under coming ASAP
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Black Crypto DEFI", "BLACK") {
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        address _owner = 0x780683c3A0cBC5C5AbbbE7b5Dc8A35F89Ec31C02;
    ...
    function updateMaxWallet(uint256 newNum) external isAuth {
        require(newNum >= (totalSupply() * 4 / 100)/1e18, "Cannot set maxTransactionAmount lower than 4%");
