...
/**
         ...
         @@%*                                                   .    (@     
                    ...
                    LuckyCat is taken from the maneki neko statue of a cat that brings luck,
         LuckyCat will be a token meme that has a plan to make as much luck as possible for all cat lovers,
            and for tokenomic we have compiled using all low tax, and for liquidity we take from Our lucky number is 0.7
            according to the month of July, so liquidity is 0.7BNB and there will be a buyback and the token will be burned again.

Portal  :https://t.me/LuckyCatKey  
Room    :https://t.me/LuckyCatRoom
Twitter :https://twitter.com/LuckyCatKey
Website :https://LuckyCat.io/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9496b9908a1A6B3E20CD7BEC6d724d4A24d3d4c2;
...
contract LuckyCat is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "LuckyCat"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xdb955Bb021b98F1f5507BD2a24CB5512D2a8Cbeb);
