...
contract Madebi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Madebi";
    string private _symbol = "Madebi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x246E0b61fC61F2DB00f1549093FA3e3848c732bf); 
