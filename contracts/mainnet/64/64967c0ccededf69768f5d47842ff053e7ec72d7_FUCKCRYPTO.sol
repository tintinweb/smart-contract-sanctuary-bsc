...
contract FUCKCRYPTO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FUCK CRYPTO FUD BSC"; // TODO change
    string private _symbol = "FUCKCRYPTO"; // TODO change
