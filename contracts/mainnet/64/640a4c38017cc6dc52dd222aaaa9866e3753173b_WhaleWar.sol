...
contract WhaleWar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Whale War";
    string private _symbol = "WhaleWar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd72A6750e094c1028027296021F0Fd457497D7Da);
    address payable public DevWalletAddress = payable(0xd72A6750e094c1028027296021F0Fd457497D7Da);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000000 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
