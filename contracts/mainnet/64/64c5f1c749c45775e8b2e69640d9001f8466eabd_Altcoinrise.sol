...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e5D59d06F9ade0Bc930d6B8743AFC12B3faa3EB; // owner address
...
contract Altcoinrise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Altcoin Rise";
    string private _symbol = "ALTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e5D59d06F9ade0Bc930d6B8743AFC12B3faa3EB); // 
    address payable public teamWalletAddress = payable(0x0e5D59d06F9ade0Bc930d6B8743AFC12B3faa3EB); // 
