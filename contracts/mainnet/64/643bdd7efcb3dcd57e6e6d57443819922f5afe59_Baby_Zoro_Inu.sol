...
contract Baby_Zoro_Inu is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Baby Zoro Inu';
    string  private constant _SYMBOL = 'BZORO';
