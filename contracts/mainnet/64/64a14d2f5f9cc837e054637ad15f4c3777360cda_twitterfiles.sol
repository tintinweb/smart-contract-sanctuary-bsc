...
*/
////https://t.me/TwitterFilesBSc
//https://twitter.com/elonmusk/status/1607996451614822404
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xC343e24Db7e0EF932610960Bc7D4A392C149bD12;
...
contract twitterfiles is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Twitter Files"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xC343e24Db7e0EF932610960Bc7D4A392C149bD12), BNB_Tot);
            }
