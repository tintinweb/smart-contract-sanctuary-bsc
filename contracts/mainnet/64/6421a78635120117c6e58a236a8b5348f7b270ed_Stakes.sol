...
/*  
		STAKES
		Crypto sports betting & casino platform.
		Prediction-to-earn sports & esports games.
        Initial LP: 2 BNB LOW TAX:6/6 OWNERSHIP RENOUNCED
        Telegram: https://t.me/stakesportal
        Twitter : https://twitter.com/Stakes_official
        The project party reserves 5%  
        LOW TAX:6/6
        1LP 5Marketing  LOW TAX
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9D7C21dc1938A29B798E004695F0813ddDF2Fba9; 
...
contract Stakes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stakes";
    string private _symbol = "STAKES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9A422E489F82a22A89EcAAE5567106490eE46F61); // 
    address payable public teamWalletAddress = payable(0x9A422E489F82a22A89EcAAE5567106490eE46F61); // 
    ...
    uint256 public _totalTaxIfSelling = 62;  
    uint256 public _totalDistributionShares = 61;  
    uint256 private _totalSupply = 923811536 * 10**_decimals;
    uint256 public _maxTxAmount = 18476230 * 10**_decimals; 
    uint256 public _walletMax = 18476230 * 10**_decimals;
