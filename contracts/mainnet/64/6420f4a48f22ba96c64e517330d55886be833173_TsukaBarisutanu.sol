...
contract TsukaBarisutanu is Context, IERC20, Ownable {
    ...
    string private _name = "Tsuka Barisutanu";
    string private _symbol = unicode"バリスタ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc912073Db08bd5A2507c4DA974C5e04668c91982); 
    address payable public buyBackWalletAddress = payable(0xc912073Db08bd5A2507c4DA974C5e04668c91982); 
