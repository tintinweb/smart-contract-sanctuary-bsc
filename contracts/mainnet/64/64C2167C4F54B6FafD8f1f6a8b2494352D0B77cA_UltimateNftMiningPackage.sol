...
// File contracts/Packages/Packages/UltimateNftMiningPackage.sol
...
contract UltimateNftMiningPackage is Package, Pausable, Ownable {
    mapping ( address => bool ) private  allowedContracts;
    ...
    constructor() {
        name = "The Ultimate NFT Mining Package";
        content = "1 NFT + 65 GetFit + 65 Vroom + 475 GFAM";
        nftCon = VAB(0x95C1B791d5C76ef25eE87815B8FaC68182eD3880);
        tokenAddress = 0x95C1B791d5C76ef25eE87815B8FaC68182eD3880;
        ...
        getfitAmount = 65 * (10 ** 18);
        vroomAmount = 65 * (10 ** 18);
        gfamAmount = 475 * (10 ** 18);
        limitAction = 5000;
