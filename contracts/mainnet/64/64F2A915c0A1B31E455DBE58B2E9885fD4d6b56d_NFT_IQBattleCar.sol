...
contract NFT_IQBattleCar is ERC721URIStorage, Ownable, Authorized {
  ...
  constructor(address marketplaceAddress) ERC721("NFT IQBattle", "NFTIQB") {
...
contract MarketPlace_IQBattleCar is ReentrancyGuard, Ownable , Authorized{
...
//STORE ITEM
  ...
  constructor() {
      ...
      //IQB 18 decimals
      tokenBEP20[1] = 0x9537b2368BCa0BF8662aadB125A3DD53c52dbFE1;
  }
