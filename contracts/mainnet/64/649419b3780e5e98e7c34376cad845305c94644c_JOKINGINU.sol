...
contract JOKINGINU is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Jo King Inu";
    string constant _symbol = "JOKING";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x1271C36631b06562a161B037AE63975a3a36D514;  // teamwallet
        lotteryWallet = 0x1271C36631b06562a161B037AE63975a3a36D514;  // lotterywallet
