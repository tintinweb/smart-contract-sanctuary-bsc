...
Twitter : https://twitter.com/BullishTokenBSC
Telegram : https://t.me/BullishDestiny
Website : https://bullishtokens.com

Taxes 5/5
Supply 100,000,000
Max wallet ( 1.75% ) 1,750,000
...
contract Bulli$h_Destiny is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Bulli$h_DestinyDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Bulli$h Destiny", "Destiny") {
        marketingWallet = payable(0x2cac7130b24A686749c7e374ddd69cdA64DcF4AE);
        devWallet = payable(0x99f9F8f924110012fbaEea0f3E6244801Af67fe0);
        ...
        dividendTracker = new Bulli$h_DestinyDividendTracker(
            payable(this),
            router,
            0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
            "Bulli$h_DestinyTRACKER",
            "DestinyTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 57; // 0.10%
        swapTokensAtAmount = totalTokenSupply / 570; // 0.10%;
...
contract Bulli$h_DestinyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Bulli$h_Destiny public Bulli$h_DestinyContract;
    ...
    constructor(
        ...
        defaultToken = token;
        Bulli$h_DestinyContract = Bulli$h_Destiny(mainContract);
        minimumTokenBalanceForAutoDividends = 175000_000000000000000000; // 175,000 tokens
    ...
    function _transfer(
        ...
        require(false, "Bulli$h_Destiny_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Bulli$h_Destiny_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Bulli$h_Destiny contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Bulli$h_DestinyContract);

            uint256 prevBalance = Bulli$h_DestinyContract.balanceOf(address(this));
            ...
            {
                uint256 received = Bulli$h_DestinyContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Bulli$h_DestinyContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
