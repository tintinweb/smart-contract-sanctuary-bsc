...
/*
Telegram: https://t.me/kuramanokyuubibsc
*/
...
contract KURAMANOKYUUBI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kurama No Kyuubi"; //
    string private constant _symbol = "KNK"; //
