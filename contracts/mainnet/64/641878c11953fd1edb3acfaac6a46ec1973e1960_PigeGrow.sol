...
contract PigeGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "PigeGrow";

    string private _symbol = "PIGEGROW";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xBD03d3E4A3c53f9F47Bb46D535516347700e8C22;
