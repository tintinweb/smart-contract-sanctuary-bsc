...
/**
    ...
    The new dog has born!
    We bringing big dreams and many future project with us!
    With 4% taxes both on buys and sells, experienced team that has taken projects came with community driven.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x029d6B57755a715CBc4D23168aA8A353bD6aa596;
...
contract GrogeInu is Context, IERC20, Ownable {
    ...
    */
    address payable private Wallet_Dev = payable(0x029d6B57755a715CBc4D23168aA8A353bD6aa596);
    ...
    */
    ...
    string private _name = "Groge Inu";
    string private _symbol = "GGI";
