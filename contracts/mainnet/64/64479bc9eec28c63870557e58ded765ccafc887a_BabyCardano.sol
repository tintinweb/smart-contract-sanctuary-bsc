...
contract BabyCardano is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Cardano";
    ...
    uint256 public sellMultiplier  = 10; //1x i.e 10x1= 10% on Sell
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10 * 10**11 * 10**_decimals;
    ...
    uint256 public _maxWalletToken = rSupply.div(50);    //2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbFB5F8586a5fdfC5796A3cDD0c466A241b287580;
        BuyBackFeeReceiver = 0xbFB5F8586a5fdfC5796A3cDD0c466A241b287580;
