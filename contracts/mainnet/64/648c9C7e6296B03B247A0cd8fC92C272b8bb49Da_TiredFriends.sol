...
contract TiredFriends is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  address public token = 0x44951A3A9995AE3B9C5Cfd11054D7c7C266fb55c;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    transferToken(_to, _mintAmount * tokenAmount);
  }
  ...
  function randomGiveaway(address _winner, uint256 _amount) external onlyOwner {
    ...
    transferToken(_winner, _amount * tokenAmount);
  }
  ...
  */
  ...
  function handleMintReward(uint256 _amount) private {
      ...
      uint256 pillowShare = marketShare.mul(2);
      // Send shares
      payable(0x3C90f909e981B0F731ed8E1c14C3A461f3164888).transfer(mintShare);
      payable(0x2Ac5e9bb7421496Bb55Cb215C33B705C7a4aA28c).transfer(mintShare);
      payable(0xb60AE3810417C447580b467AD5617020fc0F989c).transfer(marketShare);
      payable(0x015518C74bdc36FD17A47e531954372ef5227925).transfer(marketShare);
      payable(0xf9D9E627E0cE5Cc93E0013ff068008a279a8D8FB).transfer(pillowShare);
  }
