...
Keep up with Web3 innovation across chains and verticals.


Early access to
new products

Stakers can be early users, contributors, and evangelists for promising projects.


Exclusive features
on Alpha products

Unlock special rewards for using Alpha products.
A community of daring individuals who aspire to shape the future of Web3 by reinventing how dApps are built, contributed and owned.
*/
...
contract AlphaVentureDao  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'AlphaVentureDao';
