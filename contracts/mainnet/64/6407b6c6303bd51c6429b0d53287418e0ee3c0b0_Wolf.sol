...
contract Wolf is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Wolf";
    string private _symbol = "Baby Wolf";
    ...
    address payable public marketingWalletAddress = payable(0x82f8178a6471b369fDf6C545C4B355A88bfb9586);
    address payable public teamWalletAddress = payable(0x82f8178a6471b369fDf6C545C4B355A88bfb9586);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(launchAt.add(2) >= block.number || launchAt == 0) {
