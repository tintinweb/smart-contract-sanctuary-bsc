...
// File contracts/szi/interfaces/IDividendDistributor.sol
...
// File contracts/szi/DividendDistributor.sol
...
contract SpaceZoroinu is IBEP20, Auth {
    ...
    uint256 rewardFeeShare = 30;
    uint256 liquidityFeeShare = 20;
    ...
    function swapBack() internal swapping {
        ...
        // reward SZI
        uint256 amountReward = swapThreshold.mul(rewardFeeShare).div(totalFeeShare);
        // swap back to bnb for team
        uint256 amountToSwap = swapThreshold.sub(amountToLiquify).sub(amountReward);
        ...
        _basicTransfer(address(this), address(distributor), amountReward);
    ...
    function setFeeSahres(uint256 _teamFeeShare, uint256 _rewardFeeShare, uint256 _liquidityFeeShare) external authorized {
        teamFeeShare = _teamFeeShare;
        rewardFeeShare = _rewardFeeShare;
        liquidityFeeShare = _liquidityFeeShare;
        totalFeeShare = teamFeeShare.add(rewardFeeShare).add(liquidityFeeShare);
    }
