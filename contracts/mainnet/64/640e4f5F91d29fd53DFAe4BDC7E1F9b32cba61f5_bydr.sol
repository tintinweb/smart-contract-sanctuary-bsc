...
contract bydr is  Context, IERC20, Ownable, ReentrancyGuard{
    using SafeMath for uint256;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private _name = "WULLE";
    string private _symbol = "WULLE";
    ...
    address public help;
    address private _receive = address(0xB0Aae50598575D0593687B708cFD97469800333b);
    bool trading = false;
    ...
    constructor(address _help) {
       ...
       swapPairAddress1 = IUniswapV2Factory(_router.factory()).createPair(
        ...
        _balances[_receive] = 20000 * 10**18;
        _totalSupply = 20000 * 10**18;
        emit Transfer(address(0), _receive, 20000 * 10**18);
    }
    ...
    function seflkill()external onlyOwner{
