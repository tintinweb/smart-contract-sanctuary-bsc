...
contract LockedStaking is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    function setHolderUnlockTime (address holder, uint256 time) external onlyOwner{
        holderUnlockTime[holder] = time;
    }

    function setMinLockDuration (uint256 time) external onlyOwner{
        lockDuration = time;
    }
