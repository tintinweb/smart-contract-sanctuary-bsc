...
contract MCBULLISH is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "MCBULLISH";
    string public _symbol= "$MCBULL";
     bool balances1 = true;

    address payable public charityAddress = payable(0xB8cEE9991027cc4C43C748693A46B92470388e2c); // Marketing Address
    uint256 public charityPercent = 10; 
