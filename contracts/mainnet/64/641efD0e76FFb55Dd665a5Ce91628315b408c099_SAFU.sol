...
contract  SAFU is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 88 * 10**32;
    uint256 public _maxTxAmount = 88 * 10**32; 
    uint256 public _walletMax = 88 * 10**32;
    uint256 private minimumTokensBeforeSwap = 88 * 10**32;
