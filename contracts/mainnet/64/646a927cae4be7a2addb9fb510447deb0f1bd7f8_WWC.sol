...
contract WWC is BEP20, Ownable {
    ...
    uint256 public maxSellLimit = 200_000_000 * 10**18;
    uint256 public maxWalletLimit = 200_000_000 * 10**18;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;

    mapping(address => bool) public whitelist;

    constructor() BEP20("WhaleWorldCup Token", "WWC") {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxWallet >= 100_000_000, "Cannot set max wallet amount lower than 1%");
