...
He's not really our pet... but since we're always together... we're friends.

Website: https://wanta.live 
TG: https://t.me/wantainu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5597aD865Dc60A0e207B0b28e695De73b0C68Ef7;
...
contract WANTAINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1E2BC973D7cD38188Ec9AFB7Cf65E99C21eF6bc8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Wanta Inu";
    string private _symbol = "Wanta";
