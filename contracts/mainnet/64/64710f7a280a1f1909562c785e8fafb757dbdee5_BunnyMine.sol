...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1818868DFF60EF708Af76A8023d14F169619d6d1; // owner address
...
contract BunnyMine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BunnyMine";
    string private _symbol = "BUNNIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1818868DFF60EF708Af76A8023d14F169619d6d1); // 
    address payable public teamWalletAddress = payable(0x1818868DFF60EF708Af76A8023d14F169619d6d1); // 
