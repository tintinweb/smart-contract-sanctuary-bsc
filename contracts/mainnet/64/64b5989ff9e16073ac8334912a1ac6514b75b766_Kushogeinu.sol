...
1 Trillion Supply of Kushoge inu

10% Buy and 10% Sell Tax
-5% Marketing
-3% Doge Rewards
-2% LP

Enjoy Doge Rewards for all Diamond Holders!

TG : https://t.me/kushogeinu
...
// CHANGE
contract Kushogeinu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Kushoge inu";
    string constant _symbol = "Kogeinu";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xDdf5b55F9831142576b42090179E7895bbE92192);
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 newExtraSellFee, uint256 _feeDenominator) external onlyOwner {
