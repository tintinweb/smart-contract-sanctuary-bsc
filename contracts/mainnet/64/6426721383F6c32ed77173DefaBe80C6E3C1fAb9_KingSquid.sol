...
Inspired by SquidGame2.0 for its million marketcap, SquidKing is is the king of all squid in crypto world. 🦑
Our goal is to make a difference, be the best Squid variant in crypto!
...
contract KingSquid is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "K$Q"; //    
    uint8 private constant _decimals = 9; // 
		
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x44a0c16eE84cFd95FCc89f681Fef7A05797E9254;
