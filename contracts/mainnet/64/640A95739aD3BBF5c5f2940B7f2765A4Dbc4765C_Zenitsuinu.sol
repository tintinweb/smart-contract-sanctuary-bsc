...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc7a221B31b7f4d497d38F47372B74E879e51FBB7; // owner address
...
contract Zenitsuinu is Context, IERC20, Ownable {
    ...
    string private _symbol = "ZENITSU INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0E3daCbf7e1d741f4B2C06e268AB3e7dE2bb750a); // Marketing Address
    address payable public buybackWalletAddress = payable(0x0E3daCbf7e1d741f4B2C06e268AB3e7dE2bb750a); // Buyback Address
