...
contract HJSQ is Context, IERC20, Ownable {
    ...
    string private constant _name = "HJSQ";
    string private constant _symbol = "HJSQ";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 88888 * 10**_decimals;
    uint256 public _maxTxAmount = 2667 * 10**_decimals;
    uint256 public _maxWalletAmount = 2667 * 10**_decimals;
