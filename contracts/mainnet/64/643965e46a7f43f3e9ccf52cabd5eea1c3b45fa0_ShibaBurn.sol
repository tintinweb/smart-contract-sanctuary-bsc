...
contract ShibaBurn is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   ShibaBurnDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("ShibaBurn!!!", "ShibaBurn!!!") {
        _buyRewardsFee = 4;
        _buyLiquidityFee = 2;
		_buyMarketingFee = 5;
        _buyDevFee = 1;
		...
		marketingWallet = payable(0xBb3361b44f987936f0200B0651332Ea62Edd3e99);
        _devWallet = payable(0xE02A07D59C231BF538Eec3B09B4deff242dF6A83);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "ShibaBurn: The dividend tracker already has that address");

        ShibaBurnDividendTracker newDividendTracker = ShibaBurnDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ShibaBurn: The new dividend tracker must be owned by the ShibaBurn token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "ShibaBurn: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ShibaBurn: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ShibaBurn: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "ShibaBurn: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ShibaBurn: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ShibaBurn: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "ShibaBurn: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "ShibaBurn: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ShibaBurn: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ShibaBurn: Cannot update gasForProcessing to same value");
...
contract ShibaBurnDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("ShibaBurn_Dividend_Tracker", "ShibaBurn_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "ShibaBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ShibaBurn contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "ShibaBurn_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ShibaBurn_Dividend_Tracker: Cannot update claimWait to same value");
