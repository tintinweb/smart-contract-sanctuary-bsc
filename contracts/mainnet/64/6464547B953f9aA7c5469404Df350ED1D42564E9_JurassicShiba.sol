...
Telegram: https://t.me/jurassicshiba

Enter the Jurassic World with JurassicShiba!
...
contract JurassicShiba is Context, IERC20, Ownable {
    ...
    string private _name = "JurassicShiba";
    string private _symbol = "JRS";
    ...
    address payable public marketingWallet = payable(0x04a077a28a070eD0cf548DDB44Ca9De0D4D80Ff1);
    address payable public devWallet = payable(0x04a077a28a070eD0cf548DDB44Ca9De0D4D80Ff1);
    ...
    uint256 public maxWalletToken = _tTotal.mul(100).div(100);
