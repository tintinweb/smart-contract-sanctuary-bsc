...
contract ELONOMAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elonomad";
    string private _symbol = "ELONOMAD";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address ddy
    address payable private TeamWallet = payable(0xEF8B09a98c741CA0431Cd001629230Cc8Ef12512); // Buy Back Address
    ...
    uint256 private _totalSupply = 100 *  10**13 * 10**_decimals;
