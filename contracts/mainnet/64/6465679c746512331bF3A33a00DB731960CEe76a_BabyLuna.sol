...
contract BabyLuna is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x16B8768CAB56d2BE52E04a4102269A7C677c7418); // Marketing Address
    address payable public charityAddress = payable(0x043DD86Fab8e5A5bFA8686cEe1Be47947b47a32a); // Charity/Dev Address
    ...
    string private _name = "Baby Luna";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 700000000000000000000000; // 700,000; token will be given on airdrop
    ...
    uint256 private salePrice = 100000000000000; //0.01*100000000000=10,000,000,000 token for 0.01 bnb (set as per requirements)
