...
contract Apemania is Context, IERC20, Ownable {
    ...
    uint256 public _boostedReflectFee = 100;
    ...
    uint256 public _boostedMarketingFee = 9000;
    ...
    address payable private _marketingWallet = payable(0x50B8D6256fd45ADf4eDbE75de52A619C1511Af6c);
    address payable private _devWallet = payable(0xEa6Ac0d4D6F1a388bD43C8E3bBbE0a3B2425ed60);
