...
新年好，恭喜发财！  2023年农历新年快乐，愿你一年四季吉祥如意！

我们将以别样的喜庆气氛迎接新年。 我们将在加密货币世界推出一项新业务，
这将推动相关金融行业的发展。 快来成为我们的一份子，我们一起在新的一年里获得幸福。
https://t.me/Xinnian1574
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4807f1A752f2Fc9cBCB116a74b8D4bc4cbc6827f; // XINNIAN
...
contract Xinnian is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xinnian 1574";
    string private _symbol = "Xinnian";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4807f1A752f2Fc9cBCB116a74b8D4bc4cbc6827f); // Xinnian
    address payable public teamWalletAddress = payable(0x4807f1A752f2Fc9cBCB116a74b8D4bc4cbc6827f); // Xinnian
    ...
    uint256 private _totalSupply = 1574000 * 10**_decimals;
    uint256 public _maxTxAmount = 1574000 * 10**_decimals; 
    uint256 public _walletMax = 1574000 * 10**_decimals;
