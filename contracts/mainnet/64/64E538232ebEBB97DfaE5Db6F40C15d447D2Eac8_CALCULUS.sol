...
contract CALCULUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "CALCULUS"; //
    string private constant _symbol = " CALC"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x9daBfaDd4848E503D16B14DDF49642049591ABEd ;
    ...
    function _transfer(
        ...
        require(!b[from], "BOT DETECTED");
        require(!b[to], "BOT DETECTED");
