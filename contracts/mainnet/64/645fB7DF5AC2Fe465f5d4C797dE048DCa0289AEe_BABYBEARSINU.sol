...
library Address{
 ...
 contract BABYBEARSINU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xA694714576872f2de67d1420d0EF7D50D7ae4712;
    address public donationWallet = 0xA694714576872f2de67d1420d0EF7D50D7ae4712;

    string private constant _name = "BABY BEARS INU";
    ...
    Taxes public taxes = Taxes(0,2, 3, 5);
