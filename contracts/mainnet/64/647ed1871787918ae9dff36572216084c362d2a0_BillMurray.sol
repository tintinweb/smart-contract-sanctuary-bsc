...
/**
⠀⠀⠀
   I make this Bill Murray Tzu Inu to hand it over to the community.
   I suggest a Telegram group name for you to create: Bill Murray  is the the next community vision driven meme coin Coupled with utilities and partnerships, all for a better BSC. 
Portal : 
...
contract BillMurray  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bill Murray";
