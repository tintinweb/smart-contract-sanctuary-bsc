...
contract ONE is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public buyMarketingFee = 23;
    uint256 public buyLiquidityFee = 2;
    uint256 public buyTotalFee = buyLiquidityFee.add(buyMarketingFee);
    uint256 public _maxTxAmount = 1 * (10**9);
    uint256 public _maxWallet = 3 * (10**9);
    address payable public marketingAddress = payable(0x7B339B9E43BA7a002dC72bec612e0B24CA6F4242);
    ...
    constructor () ERC20Detailed("OneAI", "OneAI", 9) {
    
    _totalSupply = 3000 * (10**9);
    ...
    function setBuyFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 25, "Fee is crossing the boundaries");
    }
    ...
    function setSellFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 25, "Fee is crossing the boundaries");
    }
