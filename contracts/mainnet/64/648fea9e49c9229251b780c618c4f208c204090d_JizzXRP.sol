...
contract JizzXRP is ERC20, Ownable {
    ...
    JizzXRPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Jizz XRP", "JIZZXRP") {
        ...
        dividendTracker = new JizzXRPDividendTracker(
            payable(this),
            router,
...
contract JizzXRPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "JizzXRP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "JizzXRP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main JizzXRP contract."
        );
    }
