...
contract BabyLunaBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyLunaBSC"; // 
    string private constant _symbol = "BLUNA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x313Fc3ef05Ff46D9a4f2D63182BbDB4F9fB29AeA;
