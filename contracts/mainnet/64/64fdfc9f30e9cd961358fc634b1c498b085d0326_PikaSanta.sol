...
contract PikaSanta is Context, IERC20 { 
    ...
    string private constant _name = "PIKA SANTA"; 
    string private constant _symbol = unicode"PikaSanta"; 
