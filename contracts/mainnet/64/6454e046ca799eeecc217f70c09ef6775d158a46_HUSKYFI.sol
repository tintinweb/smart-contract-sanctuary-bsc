...
contract HUSKYFI is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HUSKYFI ";
    string private _symbol = "$HFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x94725246039d7D5991AC48Ec751807EE01DFE268);
    address payable public TeamWalletAddress = payable(0x16bCf20113a0B1CFC2bc60637A4d0e88F5AAc7f8);
