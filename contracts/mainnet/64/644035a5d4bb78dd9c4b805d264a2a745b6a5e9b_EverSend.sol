...
Max Wallet: 30,000,000 (4%)

Max Transaction: 20,000,000 (2%)

Initial LP will be BURNED. Contract Ownership will be RENOUNCED

Community driven token with Marketing Wallet receiving BNB from the tax, instead of tokens.

Send it... FOREVER!

https://www.eversendcrypto.com/

https://twitter.com/eversendcrypto
...
contract EverSend is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'EverSend';
    string private constant _symbol = 'EverSend';
