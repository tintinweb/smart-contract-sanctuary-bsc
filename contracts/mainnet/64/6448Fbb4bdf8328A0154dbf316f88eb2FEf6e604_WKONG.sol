...
contract WKONG is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public TotalFeeMax = 990000000 * 10 ** decimals();
    address public _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address public _fundAddress = 0x5a2CCEE42Bf6C7006b7789A63b1466895af0e5e4;
    address public _LPAddress = 0x6D57FfB74b907A92CA9b1418a4269CD1E8a97187;

    constructor() ERC20("WKONG", "WKONG"){
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_fundAddress] = true;
        _isExcludedFromFee[_LPAddress] = true;
        _isExcludedFromFee[0x5eFa2CB9FBabC530370a0928b847cE30A9B67570] = true;
        _isExcludedFromFee[0xbA3896bd02eA147122996488Bc234F21EbddaEcb] = true;

        _mint(0x5eFa2CB9FBabC530370a0928b847cE30A9B67570, 900000000 * 10 ** decimals());  
        _mint(0xbA3896bd02eA147122996488Bc234F21EbddaEcb, 100000000 * 10 ** decimals());    
    }
    ...
    function setAddress(address _newfun, address _newLP) public onlyOwner {
        _fundAddress = _newfun;
        _LPAddress = _newLP;
    }
    ...
    function _transfers(address from,address to,uint256 amount) private {
        ...
        if(_feePair[from] || _feePair[to]){
            if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || destroyAmount >= TotalFeeMax){
                _transfer(from, to, amount);
            }else{
                uint256 feeAmount = amount.div(100); 
                if (destroyAmount >= TotalFeeMax) {
                    _transfer(from, _LPAddress, feeAmount);
                } else {
                    _transfer(from, _destroyAddress, feeAmount);
                }
                
                _transfer(from, _fundAddress, feeAmount);
                _transfer(from, _LPAddress, feeAmount.mul(3));
