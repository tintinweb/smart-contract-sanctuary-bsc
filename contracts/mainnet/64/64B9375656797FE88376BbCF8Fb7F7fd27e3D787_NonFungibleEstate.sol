...
contract NonFungibleEstate is IERC20 {
    mapping (address => uint256) private _tOwned;
    mapping (address => bool) lpPairs;
    uint256 private timeSinceLastPair = 0;
    mapping (address => mapping (address => uint256)) private _allowances;

    mapping (address => bool) private _developmentHolders;
    ...
    string constant private _name = "NON FUNGIBLE ESTATE";
    string constant private _symbol = "NFE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(address(0)), // placeholder
        development: payable(address(0)) // placeholder
    });
    ...
    constructor () payable {
        ...
        _developmentHolders[_owner] = true;
    }
...
//===============================================================================================================
    ...
    function setOperator(address newOperator) external {
        ...
        if (oldOperator != address(0)) {
            _developmentHolders[oldOperator] = false;
            setExcludedFromFees(oldOperator, false);
        }
        operator = newOperator;
        _developmentHolders[newOperator] = true;
...
//===============================================================================================================
    ...
    function excludePresaleAddresses(address router, address presale) external onlyOwner {
        ...
        if (router == presale) {
            _developmentHolders[presale] = true;
            presaleAddresses[presale] = true;
            setExcludedFromFees(presale, true);
        } else {
            _developmentHolders[router] = true;
            _developmentHolders[presale] = true;
    ...
    function _hasLimits(address from, address to) internal view returns (bool) {
        return from != _owner
            && to != _owner
            && tx.origin != _owner
            && !_developmentHolders[to]
            && !_developmentHolders[from]
            && to != DEAD
            && to != address(0)
            && from != address(this)
