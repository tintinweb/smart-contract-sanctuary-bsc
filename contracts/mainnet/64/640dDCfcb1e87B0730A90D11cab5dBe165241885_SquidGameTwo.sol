...
contract SquidGameTwo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xFbedc6ed607619e000CcC56Fc7ed60059349319B); 
    address payable public Wallet_Dev = payable(0x7f4449380D0F36054E4135DC6257D27706E7DC87);
    ...
    uint256 public _maxTxAmount = _tTotal * 1 / 200; 
    ...
    constructor () {
        ...
        _owner = 0xb5f553021C8A67009B6BbfE986E8966d856ac20a;
    ...
    function changeMaxTxAmount(uint256 tAmount) external onlyOwner{
        _maxTxAmount = tAmount;
    }

    function changeMaxWallet(uint256 tAmount) external onlyOwner{
        _maxWalletToken = tAmount;
    }
