...
//MC DONALD DUCK INU MEME PROJECT
//LOWTAX LOCK 3 MONTHS SAFE
//Telegram: https://t.me/McDonaldDuckinu
...
contract McDonaldDuckInu is Context, IERC20 { 
    ...
    address payable public Marketing_Wallet = payable(0x4b41B31521aa2539e1eDf2468A6C1f1add5AdDeE); 
    address payable public Wallet_Dev = payable(0x96E9CD59d723B7294f2775a9df1c5E8a4e7BCDdf);
    ...
    string private constant _name = "McDonald Duck Inu"; 
    string private constant _symbol = unicode"MCDONALDDUCKINU"; 
    ...
    constructor () {
        ...
        _owner = 0x96E9CD59d723B7294f2775a9df1c5E8a4e7BCDdf;
