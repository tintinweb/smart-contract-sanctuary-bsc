...
contract Wukong2D is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  uint256 public cost = 0.08 ether;
  string public baseURI = "https://ipfs.io/ipfs/bafybeidq4tkuhwmf4xv6tegmwtsfyptrj7jdmxed5ily2jvczvz2jc6ywi/";
  uint256 public maxMintAmount = 10;
  uint256[14]  mintedID = [uint256(3114) , 2477, 528, 1844, 3178,3134,3159,2135,1774,968,1281,3263,2147];

  constructor() 
    ERC721("Wukong2D", "WKG2D")
    RandomlyAssigned(3332,0)
    {
      mintSelf(msg.sender);
    }
  ...
  function mintSelf(address _to) public onlyOwner{
    for (uint256 a = 1; a < mintedID.length; a++) {
        uint256 id = mintedID[a];
        _safeMint(_to, id);
        currentSupply++;
        }
  }
