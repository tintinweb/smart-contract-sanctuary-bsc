...
/**
                             ...
                             &#^:^[email protected]&#BGP5YJJ???JJJY5PGB&&&@&&@#7:^::7?7B&
                               P!5GBPPGGG5J7~^:::::::::::::::::^~!&[email protected]^::::^7775
                               &BYJPBP?~:::::^^^^^^^^^^^^^^^^^^^:[email protected]:P&7^^^:~77!5
                            &#JJGG?^.::^^^^^^^^^^^^^^^^^^^^^^^^^^P&7:5&57!!777!B
                            GBG!.:^^^^::::::::::::::::::::::^^^^7P&[email protected]&&
                        &@#7..::^^~!77?JJYY555555555YYJ?77!!!!77?GBPYY5PGGGG5#&
                        &@G::!?Y5PPP55YJJ??77777777???JYY5PPGGGGP5YY5PGGPPPPPB#
                    &@@5PG5J?!~^::::::::::::::::::::::::^[email protected]&
                    &B5?~::::::^^~~~!!7777777777!!~~^^^:::[email protected]&
                    &Y~:.::^!?J5PGGBBBBBBBBBBBBBBBBBBBBGGP555YJJ??7777777?J5GBPYB&
                    #^.:~?5GBBBGPP555YYYYYYYYYYYYYYYYYY555PPGGBBBBBGPYJ?7777777YG#@&
                  &@!:?G#BG55YYYYYJ~^^^!7YYYYYYYYYYYYYYYY5YJJ?JYY55PGBB#BPYJ7777775&
                  B7B&G5YYYYYYYYYJ!^:.  .7YYYYYYYYYYYYYJ!:.. .~YYYYYYY5PGB#BPJ?7777B
                 &&BYYYYYYYYYYGBP5YYJ?7!?YYYYYYYYYYYYY:..^~7?YYYYYYYYYYYYYPG##PJ777&&
                &@BYYYYYYYYYYYP&@&#BP555YYYYYYYYYYYYYYJJYYY55PGBGYYYYYYYYYYYYP#&GJ!&&
                &@[email protected]@@G5&&PYYYYYYYYYYYYYYYY5PG#&@@@#5YYYYYYYYYYYYY5G#&[email protected]&
                &5YYYYYYYYYYY&@@@J~&[email protected]!#@@@[email protected]&
                &YYYYYYYYYYYYP&@@@@&[email protected]&@@@[email protected]&
                &[email protected]@@@@[email protected]&
                &@5YYYYYYYYYYYYYYYYYYYY5&@#[email protected]@&[email protected]&
                &@PYYYY55YYY5PYYYYYYYYYY5B&@@&[email protected]&
                #YYYY5GPP##BGPP5YYYYYYYY555YYYYYYYYYYYYYYY5P555YYYYYYYYYYY5PPPP#
                &@B5YYYYYYGBGGGBGGPP555YYYYYYYY55555PPPPPGGB#[email protected]&
                &@B5YYYYYYPGPPPGGGGGGGGGGGGGGGGGGGGPPPPPGBBGP5Y5YYYYYYY5PPPPPG&&
                 &@#P55YYYY5PGGPPPPGGGGGGGGGGGGGGGGGGGBBBG5YYYYYYYYYY5PPPPPPG&&
                  &&&BPP555YYY55PPPGGGGGGGGGGGGGGGGGGGP5YYYYYYYYY55PPPPPPPPB&&
                    &&BGPPP5555YYYYYYYY55555555555YYYYYYYY5555PPPPPPPPPGB&&
                            &#BGPPPPPPPP555555555555555555PPPPPPPPPPPPPPPGB#&
                                &&#BBGGPPPPPPPPPPPPPPPPPPPPPPPPPPPPPGGB##&
                                    &&&###BBBGGGGGGGGGGGGGBBBB###&&&

Telegram : https://t.me/FloPepes
Twitter : https://twitter.com/FloPepesBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3e367060b284Ff8030177F51091bC4dFCAd40b96;
...
contract FLOPEPES is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x3e367060b284Ff8030177F51091bC4dFCAd40b96);
    ...
    */
    ...
    function setFees(uint256 marketing_LiquidityBuyFees, uint256 marketing_LiquiditySellFees) external onlyOwner() {

        require((marketing_LiquidityBuyFees + marketing_LiquiditySellFees) <= maxPossibleFee, "Fee is too high!");
        _sellFee = marketing_LiquiditySellFees;
        _buyFee = marketing_LiquidityBuyFees;

    }

    // Update main wallet
    function UpdateWallet(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    function setNumberLiquifyTrigger(uint8 number_of_transactions) public onlyOwner {
    ...
    */
    ...
    function blacklistBots(bool true_or_false) public onlyOwner {
    ...
    */
    ...
    // Default is true
    function setTransferFees(bool true_or_false) external onlyOwner {
    ...
    */
    ...
    function maxTransaction(uint256 maxTxPercent_x100) external onlyOwner() {
    ...
    */
    ...
    function swapManual (uint256 percent_Of_Tokens_To_Process) public onlyOwner {
    ...
    */
    ...
    function newRouterPair(address newRouter) public onlyOwner() {
    ...
    // Set new router
    function newRouterAddress(address newRouter) public onlyOwner() {
        IUniswapV2Router02 _newPCSRouter = IUniswapV2Router02(newRouter);
        uniswapV2Router = _newPCSRouter;
    }
    
    // Set new address - This will be the 'Cake LP' address for the token pairing
    function newPairAddress(address newPair) public onlyOwner() {
