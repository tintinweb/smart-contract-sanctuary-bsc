...
contract FanToken is IERC20, Ownable, BaseToken {
    ...
    constructor() {
        string memory name_ = "Fan Token";
        string memory symbol_ = "FBT";
        uint256 totalSupply_ = 1 * 10**9 * 10**9;
        address router_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        address charityAddress_ = 0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47;
        uint16 taxFeeBps_ = 600; // reflection to holders
        uint16 liquidityFeeBps_ = 200; // liquidity
        uint16 charityFeeBps_ = 100; // to marketing wallet
        ...
        _rOwned[0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47] = _rTotal;
        ...
        _isExcludedFromFee[0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47] = true;
        _isExcludedFromFee[address(this)] = true;

        emit Transfer(address(0), 0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47, _tTotal);

        emit TokenCreated(
            0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47,
            address(this),
            TokenType.liquidityGenerator,
            VERSION
        );

        transferOwnership(0x49867adC3BED07281Ecf9CE437a3eb8DdaC91B47);
