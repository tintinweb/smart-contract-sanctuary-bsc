...
Telegram : https://t.me/+yUF3KIgf4d82MTg0
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C89fA72E4010654EE7df1Db19B590d8D5c00fF3;
...
contract THE$CHADS is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE $ CHADS"; // 
    string private constant _symbol = "$CHADS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x60c74a52bd106877b4bc964Ba5d6C270294C4af9);
