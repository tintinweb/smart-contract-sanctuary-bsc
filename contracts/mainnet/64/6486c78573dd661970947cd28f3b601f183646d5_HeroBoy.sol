...
contract HeroBoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0fCA640F4Bd266F01A8c6e38A5cC27Ce9CED1473); // Marketing Address
        
    address payable public teamAddress =
        payable(0xBda8e56da18dE4Ed1082e1A40649d0855C68d635); // Team Address
        
    address payable public liquidityAddress =
        payable(0x0fCA640F4Bd266F01A8c6e38A5cC27Ce9CED1473); // Liquidity Address
    ...
    string private constant _name = "HeroBoy";
