...
/**
ONLY GROW!!!
✅low tax (2/2), lock & renounce
✅Big marketing after list
✅Safu dev, strong community
Telegram : https://t.me/onlygrow_trending 
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xb4eC17FfbCa054f0bCF9747Ee3D67C43Ef81453E;
...
contract ONLYGROW is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"ONLY GROW"; 
    string private constant _symbol = unicode"ONLY GROW"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xb4eC17FfbCa054f0bCF9747Ee3D67C43Ef81453E), BNB_Tot);
            }
