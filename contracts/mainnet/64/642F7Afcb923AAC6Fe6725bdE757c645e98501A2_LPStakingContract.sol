    ...
    ReentrancyGuardUpgradeable
{
    ...
    function deposit(address recipient, uint256 amount) public nonReentrant {
        require(amount > 0, "Error: amount can't be 0");
        ...
        if (prestakeTimestamp > block.timestamp) {
            ...
            depoTimestamp = block.timestamp;
            lastClaimedTimestamp = block.timestamp;
            depoClaimTimelock = block.timestamp + claimingTimelock;
        }
