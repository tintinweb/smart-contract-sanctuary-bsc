 ...
 * TG : https://t.me/SurgeCore 
 Discover SurgeCore, our new and exciting project launching on Surge BSC! 🔥

SurgeCore is an AI-based Telegram bot that responds like ChatGPT. We plan to add features such as generating images, music, videos, and voices from text, as well as generating text from voice.

Join us to revolutionize the way we interact with technology. 💻
 */
