...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07cc3A5a07cadFCacbfDd8544f53529d8A4b4b09;
...
contract DeFace is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6aBD24FC660F834B797327dfE3d29e46E81EAaED;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DeFace";
    string private _symbol = "DFCE";
