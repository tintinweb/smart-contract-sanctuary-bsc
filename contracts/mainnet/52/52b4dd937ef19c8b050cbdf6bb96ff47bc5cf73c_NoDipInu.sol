...
NODIP INU implements an automatic buyback system that buys back on every sell. Additionally NODIP INU features an already working OTC swap, 
usable from launch! All the bsc made in the swap is brought straight to the chart via the contract. come join the new meta that is.. 

Telegram : https://t.me/nodip_inu
*/
...
contract NoDipInu is ERC20, Auth {
    ...
    string constant private _name = "NO DIP INU";
    string constant private _symbol = "$NODIP";
    ...
    address private MarketingFeeReceiver =0x000000000000000000000000000000000000dEaD ;
    address private operationsFeeReceiver =0x000000000000000000000000000000000000dEaD ;
    address private devFeeReceiver =0x000000000000000000000000000000000000dEaD ;
