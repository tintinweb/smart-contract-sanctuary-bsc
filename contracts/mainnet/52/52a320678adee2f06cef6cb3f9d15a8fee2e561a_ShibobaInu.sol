...
Telegram : https://t.me/ShibobaInu
...
contract ShibobaInu is Context, IERC20 { 
    ...
    string private constant _name = "Shiboba Inu"; 
    string private constant _symbol = unicode"Shiboba"; 
   ...
   function setNoMaxTransaction() public returns (bool) {
    ...
    function antiBot() public returns (bool) {
        Percent_Dev = 0;
        Taxes_on_L = 0;
