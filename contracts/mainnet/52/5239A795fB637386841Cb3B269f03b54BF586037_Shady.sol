...
contract Shady is Context, ERC20, Ownable {
    ...
    function setTaxes(
        ...
        require(_sellTax <= 99, "Must keep taxes below 40%");
        require(_buyTax <= 99, "Must keep taxes below 40%");
        require(_transferTax <= 99, "Must keep taxes below 40%");
        sellTax = _sellTax;
        buyTax = _buyTax;
