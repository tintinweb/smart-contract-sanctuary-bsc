...
//    }
    ...
    {
        uint sessionDuration = checkMinimum(86400, block.timestamp - users[user].lastActionTimestamp);
    ...
    function sellPower(uint amount) external
    {
        ...
        require(amountRequested <= computeFraction(address(this).balance, 50), "SolarGuard: Amount is greater than 5% maximum sell!");
