...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xBCC1AE526d8BeBAB02af19945A866dDC0DF80F37);
...
contract BabySlothClimb is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x7BE2b42DF3bD8B431879828dc4Fe9901E4567a19;

    string constant _name = "BABY SLOTH CLIMB";
    string constant _symbol = "$BSLOTH";
