...
contract RedFEGAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RedFeg-Ai";
    string private _symbol = "RedFeg-Ai";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8294BA6eFa6D9d4935D3B4e40c13ED64ccdB6655);
    address payable public teamWalletAddress = payable(0xc6153E61282084039924621E2f6B54EcD662907E); 
    ...
    function hereWeGo() public onlyOwner {
        isLaunch = true;
        launchedBlock = block.number;
    }

    function plsStop() public onlyOwner {
        isLaunch = false;
    }
