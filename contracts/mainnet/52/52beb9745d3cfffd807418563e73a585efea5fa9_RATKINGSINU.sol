...
TELEGRAM:  https://t.me/ratkingsinu
*/
...
contract RATKINGSINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "RATKINGS INU"; // 
    string private constant _symbol = "RAT INU"; //    
