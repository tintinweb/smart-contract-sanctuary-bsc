...
contract SuperChinaMoon is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xddA3D1a4f9020916f0d593AC635622e9E654b58B);
    ...
    constructor () BEP20Detailed("SuperChinaMoon", "SuperChinaMoon", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000000 * 10**18 && _numTokensSellToFee <= 100000000 * 10**18, "Threshold must be set within 1,000,000 to 100,000,000 tokens");
