...
contract purpleangel is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "purpleangel";
    string private _symbol = "PUAN";
   ...
   function Changesubject(bool _flag, uint256 val) external view returns(uint256) {
        uint256 _autoRebase;
        if (_flag) {            
