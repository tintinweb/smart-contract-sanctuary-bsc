...
contract WEDINAL is Context, IERC20 {
    ...
    string private _name = "Wednesday Infernal";
    string private _symbol = "WEDINAL";
    ...
    constructor (address _abb)  {
        ...
        Wallet_Marketing = payable(0xE51BA591F0AE7E20a2fB41417df7C5F01519f797);
        abb = BHT(_abb);
