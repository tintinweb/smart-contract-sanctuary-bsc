...
contract AXECHAIN is Context, IERC20, Ownable {
    ...
    string private _name = "Axechain";
    string private _symbol = "axechain";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private marketing =
        payable(0xE54F39801dDf03f45bB7e134c8ED1250F9855b99);
