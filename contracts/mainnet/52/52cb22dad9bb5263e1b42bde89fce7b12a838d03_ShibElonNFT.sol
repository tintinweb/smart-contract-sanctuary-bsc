...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract ShibElonNFT is ERC721Enumerable, Ownable {
        ...
        uint256 public price = 0.0025 ether; //0.25 BNB
        string baseTokenURI;
        ...
        constructor(string memory baseURI) ERC721("ShibElon NFT", "SHIBELON") {
            ...
            baseTokenAddress = 0xC183062db25FC96325485ea369C979CE881Ac0eA;
        ...
        function swapNativeCoinWithBaseToken() public payable returns(bool) {
            uint256 swapAmount = (msg.value * 10) / 100;
