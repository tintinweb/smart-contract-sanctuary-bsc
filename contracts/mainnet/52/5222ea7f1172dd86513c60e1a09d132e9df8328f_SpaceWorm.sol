...
🔥 Telegram: https://t.me/SpaceWormBSC

🐦 Twitter: https://twitter.com/SpaceWorm
...
contract SpaceWorm is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x580b84f34Afe71cF61c2c4f8D134f2dCF21729a6; 
    address DevWallet       = 0x580b84f34Afe71cF61c2c4f8D134f2dCF21729a6; 

    string constant _name = "SpaceWorm";
    string constant _symbol = "$WORM";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20000000 * (10 ** _decimals);
    uint256 public _maxSell = 2000000 * (10 ** _decimals);
