...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDB54A1D574821b968504b00A3758e8f2A50ef82F; // owner address
...
contract BNB2K23 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BNB2K23";
    string private _symbol = unicode"BNB2K23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDB54A1D574821b968504b00A3758e8f2A50ef82F); // Marketing Address
    address payable public teamWalletAddress = payable(0xDB54A1D574821b968504b00A3758e8f2A50ef82F); // Team Address
