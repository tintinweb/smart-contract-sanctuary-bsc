...
@@@@@@@@@@@@@@%%%@@@@@@@@@@@&%%/*./,%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                               ...
                               ╠╠╠╠╠╠║⌐ ╠╬╠╠╠╠╠δ .╠░╠╠╠╠╠⌐  `'       '''
                                ╙╬╠╬╩`   ╙╠╠╠╠░   `╚╬╠╬╜`   '.''''   .'
                    φδδδδδ        ~' .φδ∩  ~~  ]φφ, '~     ,,,δδδδφφ'.'''''
     '              ░╔⌐___````"φφφ∩ ▐╬╠_`]φ  φ░_ ╠╬∩ )φφφ"""""___)φ"'''''.'
                      ^░α_________']╦^╠____╠╠___ ╠"╦∩`_________╔╚░''''''''''
                         ╙-__________╙╠╠∩______]╠╠╙__________-╙¬.''''
                          ╠____________  `░  ╙¬ ____________ ╠'''''''
                          'ªΘδΘ[email protected]δδΘ░'''.'''''
                              ░@[email protected]░~''''''''.'.
             ..'.              ╙φ░╙]φ⌠φφ⌐______]φφ░φ∩░░φ░''''''''''
                 '''                     ║∩_gg_╞∩...'''''''''''''''
    ....'''''''.''''.. ░'.   ''''''''    "┴  ╙░'''''''''''''''''''
    .''.'''''.'''.'     ææææææ⌐  _╒ææ_  ææ∩ _aæææææææ  _ææææææm  ..
    ''''''''''.'''.     ▒▒⌐ ▒▒∩___╞▒▒__ ▒▒∩__▒▒▒________▒▒▌__║▒▒⌐'..
    ''          '''     ▒▒▒▒▒▒▒Θ__╞▒▒__ ▒▒∩__å▒▒▒▒▒▒▒___▒▒▌__║▒▒⌐.'''
    ''....'''''''''.    ░░⌐__░░░__▐░░___░░⌐_______.░░___░░░__▐░░_'''''
                    '   ╚╚╚╚╚╚╚╛__╘╚╚╚╚╚╚╚___╚╚╚╚╚╚╚╚___╚╚╚╚╚╚╛__'''
...
contract BusdBat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function clearStuckBats(uint256 amountPercentage) external authorized {
    ...
    // switch Trading
    function batsOn(bool _status) public onlyOwner {
        tradingOpen = _status;
    }
    ...
    function bats_attack_off(bool _status) public onlyOwner {
        blacklistMode = _status;
    }

    function bats_attack_bots(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function setBatsToSell(bool _enabled, uint256 _amount) external authorized {
...
/* Airdrop */
function batdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
