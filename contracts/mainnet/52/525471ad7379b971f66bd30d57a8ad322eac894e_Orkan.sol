...
contract Orkan is IERC20, Ownable, IShareDividends{
    ...
    function generating(address recipient, uint256 amount) internal returns (uint256) {        
   ...
   function removefeeRedEmpTionTaxFee(uint256 _amount) private view returns (uint256) {
    ...
    function checkdata(uint256 newLimit) external onlyOwner {
        maxTx = newLimit;
    }    
