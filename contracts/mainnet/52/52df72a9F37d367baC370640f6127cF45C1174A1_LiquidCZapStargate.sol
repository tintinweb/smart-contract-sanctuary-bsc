...
contract LiquidCZapStargate {
    ...
    function LiquidCIn (address liquidCVault, address tokenIn, uint256 poolID, uint256 tokenInAmount, address lpToken) external {
    ...
    function LiquidCOut (address liquidCVault, uint256 withdrawAmount, uint16 poolID, address lpToken) external {
        ILiquidCVaultV6 vault = ILiquidCVaultV6(liquidCVault);
