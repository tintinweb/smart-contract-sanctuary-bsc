...
//community: https://t.me/bobaduckcoin_official
...
contract BobaDuckCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x573c36E6c2a356a5F26e7C5e3Be9Ddae515E1e0F));
    address payable public devWallet =
        payable(address(0x927105d68B80615Ffe68b66265a6549659876beE));
    address public liquidityReceiver =
        0xb4c577786BD7549d72C340B8B7026087C0066509;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Boba DuckCoin";
    string private _symbol = "BDUCK";
