...
contract GFCCoin is ERC20, Ownable {
    using SafeMath for uint256;
    address public marketingWallet = 0x0Fc194435823793B6aB74d0C7870Fd63e99461B9;
    uint256 public marketingFee = 3;
    mapping (address => bool) public isMarketPair;
    mapping (address => bool) isExcludedFromFee;

    constructor () ERC20("GFC Coin","GFCC") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address pancakePair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
    ...
    function setMarketingFee( uint256 newMarketingFee) external onlyOwner() {
        require(newMarketingFee <= 10, "Marketing fee is over 10%");
    ...
    function shouldTakeFee(address sender, address recipient) private view returns(bool) {
        ...
        return (isMarketPair[sender] || isMarketPair[recipient]) && marketingFee > 0;
    }
