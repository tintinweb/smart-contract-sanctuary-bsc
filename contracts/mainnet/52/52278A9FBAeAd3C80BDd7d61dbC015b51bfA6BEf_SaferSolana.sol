...
There is an active security incident on Solana. Many (7000+ and counting) wallets are drained of SOL & USDC. 

We always love Solana project.  However SOLANA need a safer relaunch. SSOL is a token in BSC / BNB Chain. As the world's biggest exchange , Binance is always a safer ecosystem for Solana. Buy SSOL and go to the moon 🚀🚀🚀

Supply : 500,000,000
Tax : 3%
TG : https://t.me/SaferSolana
*/
...
contract SaferSolana is Context, IERC20 { 
    ...
    string private constant _name = "SaferSolana"; 
    string private constant _symbol = "SSOL"; 
