...
contract ANIMEGAME{
    ...
    string private _name = "ANIMEGAME";
    ...
    uint256 private _referEth =     2500; //BNB
    uint256 private _referToken =   7000; //TOKEN
    uint256 private _airdropEth =   4000000000000000; // 0.004 BNB 
    uint256 private _airdropToken = 800000000000000000000; // airdrop token
    // address private _auth;
    // address private _auth2;
    // uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 2000000; // 2 decimals
