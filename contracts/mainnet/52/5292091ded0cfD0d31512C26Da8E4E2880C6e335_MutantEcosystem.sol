...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3187DF16F3d9A43f3EE5408A10c57B8474D8a797; // owner address
...
contract MutantEcosystem is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Mutant Ecosystem";
    string private _symbol = unicode"MTNT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3187DF16F3d9A43f3EE5408A10c57B8474D8a797); // Marketing Address
    address payable public teamWalletAddress = payable(0x3187DF16F3d9A43f3EE5408A10c57B8474D8a797); // Team Address
