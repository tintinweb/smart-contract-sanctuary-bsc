...
contract SMARTBANK_FINANCE is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 100; //per thousand
    uint256 public constant MARKETING_RATE = 100; //per thousand	
    ...
    bool public started;
	address payable public owner = 0xC9D4e7a68753669A321B0ECc855C45d243711039;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(75, 45*60*60*24)); //45 days
        investmentPlans_.push(Objects.Plan(85, 25*60*60*24)); //25 days
        investmentPlans_.push(Objects.Plan(150, 18*60*60*24)); //18 days
    }
