...
contract ZMKing is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("ZMKing", "ZMKing") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
			...
			if(from == uniswapV2Pair){
                ...
                if(startTime.add(60) > block.timestamp){require(balanceOf(to).add(amount) <= 15 * 10**19,"max amount");}
