...
contract WomenKing is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 38000000 * (10**18);
    ...
    uint256 public _maxTxAmount = 3800000000 * (10**18);
    uint256 public _maxWalletAmount = 3800000000 * (10**18);

    address public _marketingWalletAddress = 0x35633DE6E42687C259e6f22056d3014db9607C18;
    ...
    constructor() public ERC20("Women King", "Women King") {
        ...
        */
        _mint(owner(), 380000000000 * (10**18));
    }
...
contract ETHBackDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("ETHBack_Dividen_Tracker", "ETHBack_Dividend_Tracker") {
    	claimWait = 600;
        minimumTokenBalanceForDividends = 380000000 * (10**18); //must hold 200000+ tokens
    }
