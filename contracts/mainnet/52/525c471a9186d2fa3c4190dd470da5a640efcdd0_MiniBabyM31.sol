...
contract MiniBabyM31 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniBabyM31";
    string private _symbol = "MiniBabyM31";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDaeFC6000da77a6255BA85f16Ec5fd82d2203cC3); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xDaeFC6000da77a6255BA85f16Ec5fd82d2203cC3); // BuyBack Address
