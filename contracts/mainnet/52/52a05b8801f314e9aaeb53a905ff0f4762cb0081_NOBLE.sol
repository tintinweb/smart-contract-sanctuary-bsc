...
contract NOBLE is Context, IERC20, Ownable {
    ...
    uint256 private _rTotal = 27999999999000000;
    string private _name = "Noble Gift Token";
    string private _symbol = "NOBLE";
    uint8 private  _decimals = 0;
    uint256 public MaxTaxPerM = 50;
    uint256 public TaxPerM = 1;
    ...
    function _transferStandard(address sender, address recipient, uint256 _amount) private {
        ...
        uint256 tfee = _amount.mul(TaxPerM).div(1000);
        ...
        if(tfee>0) {
        _balance[address(0)] = _balance[address(0)].add(tfee);
        }
