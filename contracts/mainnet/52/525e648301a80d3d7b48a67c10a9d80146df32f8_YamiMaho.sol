...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5Ef4dBd5390841fEA10C8027DEA9E62c0fDd1ab1; // owner address
...
contract YamiMaho is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yami Maho";
    string private _symbol = "YAM";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x0651ADDc135D8145c20d4864c64b3f12CC7a443d); 
    address payable public teamWalletAddress = payable(0x0651ADDc135D8145c20d4864c64b3f12CC7a443d);
