...
contract SMBStableSwapLP is ERC20 {
    address public minter;

    constructor() ERC20("SMB StableSwap LPs", "Stable-LP") {
        minter = msg.sender;
    }
...
contract SMBStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(SMBStableSwapLP).creationCode;
        ...
        SMBStableSwapLP(lpToken).setMinter(_minter);
