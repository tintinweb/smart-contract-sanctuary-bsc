...
contract IGOClaim is Context, ReentrancyGuard {
    ...
    function notifyVesting (uint256 percentage) external onlyVault {
    ...
    function setToken (address _token, uint256 _decimal) public onlyVault {
        token = _token;
        decimal = _decimal;
    }
