...
contract LZDAO is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress, address DevAddress, address FundAddress2
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        holderRewardCondition = 100000000000000 * 10 ** IERC20(USDTAddress).decimals();
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.div(3));
        USDT.transferFrom(address(_tokenDistributor), fundAddress2, fundAmount.div(3));
        USDT.transferFrom(address(_tokenDistributor), devAddress, fundAmount.div(3));
