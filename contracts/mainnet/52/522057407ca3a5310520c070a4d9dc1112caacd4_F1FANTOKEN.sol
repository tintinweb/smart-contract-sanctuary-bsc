...
contract F1FANTOKEN is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "F1 FAN TOKEN";
    string constant _symbol = "F1T";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 1000; 
    uint256 public _maxWalletSize = (_totalSupply * 7) / 1000; 
    ...
    address public devFeeReceiver = 0xE5cA225DaCDbB96bBee73F1afc84Dd3e85489Bf2;
    address public buybackFeeReceiver = 0x915896bB07f7c0E573E8F8696518df9966904EC1;
