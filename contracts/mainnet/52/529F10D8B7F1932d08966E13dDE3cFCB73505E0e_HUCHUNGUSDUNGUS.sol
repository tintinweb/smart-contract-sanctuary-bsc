...
/**
WELCOME TO HUCHUNGUS DUNGUS THE NEXT MEME MONSTER TO HIT THE STREETS 
YOU ALREADY KNOW WHAT A CHUNGUS IS COME SEE WHAT HIS DUNGUS DOES!
...
contract HUCHUNGUSDUNGUS is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'HUCHUNGUS DUNGUS';
