...
contract MetaBank is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaBank";
    string private constant _symbol = "MetaBank";
    ...
    address private marketingWallet = address(0xb51A238960ae3D56fFFB497cE7d3336e5D48B572);
    address private liquidityReceiver = address(0xb51A238960ae3D56fFFB497cE7d3336e5D48B572);
    ...
    function changeswapTokenAtAmount(uint256 newswapTokenAtAmount) public onlyOwner {
        swapTokenAtAmount = newswapTokenAtAmount * 10**_decimals;
