...
contract Banluna is Context, IERC20, Ownable {
    ...
    payable(0x9c6C60Ce394375e6Bf1AC9b0A1E7b227C2c6f66a);
    ...
    string private constant _name = "BanLUNA";

    string private constant _symbol = "WORMHOLE";
...
maxWalletAmount = _tTotal * 40 / 1000; // 4% maxWalletToken
