 ...
 */
 ...
 //WEBSITE: https://www.sushiinu.ml/
 // TELEGRAM: https://t.me/sushi_inu_official
...
interface IPancakeV2Router {
    ...
    string internal constant NAME = "SushiInu";
    string internal constant SYMBOL = "SUSHI";
    ...
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY  ; // 2% of the total supply
    
    
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY  ; // 2% of the total supply
    ...
    address internal marketingAddress = 0xedAb962d943cDa32089A1e4fb408142B8c989E65;

    
    address internal burnAddress = 0x000000000000000000000000000000000000dEaD;

    
    address internal tipToTheDev = 0x97A8C201940Dc65cF31009B591e2A5AcbecD80E3;
...
abstract contract SushiInu is BaseRfiToken, Liquifier, Antiwhale {
...
contract SushiInuV1 is SushiInu{

    constructor() SushiInu(Env.MainnetV2){
