...
TATE SQUID THE NEXT MOONSHOT X1000
MYSTERY LAUNCH 666

https://t.me/tatesquidofficial
...
contract TateSquid is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x680C0c3De6DB6e913529C1C26160a9D0527D142C); 
    address payable public Wallet_Dev = payable(0x680C0c3De6DB6e913529C1C26160a9D0527D142C);
    ...
    string private constant _name = "Tate Squid"; 
    string private constant _symbol = unicode"TSQ"; 
    ...
    constructor () {
        ...
        _owner = 0x680C0c3De6DB6e913529C1C26160a9D0527D142C;
