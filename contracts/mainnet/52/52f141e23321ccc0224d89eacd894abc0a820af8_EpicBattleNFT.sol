...
// File: contracts/epicbattlearena.sol
    ...
    contract EpicBattleNFT is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 50000000; // 0.05 BNB 
      uint256 public constant PresalePrice = 50000000; // 0.05 BNB
      ...
      function presaleEpic(uint256 numberOfTokens) external payable {
