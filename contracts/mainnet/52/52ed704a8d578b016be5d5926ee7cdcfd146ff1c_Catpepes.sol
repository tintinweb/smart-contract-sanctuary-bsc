...
contract Catpepes is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Pepes";
    string private _symbol = "CPEPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x926d9D0f966f941EA2caD5Be1DDef2fB8C24cdb7); // Marketing Address
    address payable public teamWalletAddress = payable(0x926d9D0f966f941EA2caD5Be1DDef2fB8C24cdb7); // Team Address
