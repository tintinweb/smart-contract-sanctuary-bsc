...
contract SCAM is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SCAM INU";
    string private constant _symbol = "SCAM INU";
    ...
    //Tax wallets
    address public teamWallet = 0x1B687C953A55ca5f7A55493b98AaA081198C9A1a;
    address public treasuryWallet = 0x1B687C953A55ca5f7A55493b98AaA081198C9A1a;
