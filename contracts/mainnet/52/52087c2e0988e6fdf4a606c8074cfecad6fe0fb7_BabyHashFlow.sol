...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x44Ec807ce2F4a6F2737A92e985f318d035883e47); // Hashflow Token
...
contract BabyHashFlow is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyHashFlow", "BabyHFT") {
    	...
    	marketingWallet = address(0x1730308AC2dD2ff7B296b053637220fC142C5b60); // set as marketing wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 1e6 * (10**9); //must hold tokens
    }
