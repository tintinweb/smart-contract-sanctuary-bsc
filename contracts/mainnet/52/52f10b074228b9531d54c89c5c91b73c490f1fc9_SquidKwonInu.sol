...
|TELEGRAM: https://t.me/SquidKwonInuOfficial
*/
...
contract SquidKwonInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Squid Kwon Inu  ";
    string private _symbol = " $SKwonInu "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x46dE50Ea7bDa7D6E23c55079Aef181A2A18E636B); 
    address payable public teamWalletAddress = payable(0x46dE50Ea7bDa7D6E23c55079Aef181A2A18E636B);
