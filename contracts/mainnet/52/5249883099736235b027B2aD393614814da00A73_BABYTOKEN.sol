...
contract BABYTOKEN is ERC20, Ownable {
    ...
    constructor(
        ...
        excludeFromFees(lpAddress_, true);
        ...
        isTxLimitExempt[lpAddress_] = true;


        _mint(lpAddress_, totalSupply);
    ...
    function _transfer(
        ...
        if (!swapping && AmountTokenRewardsFee >= 1 ** 18 && from != address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
