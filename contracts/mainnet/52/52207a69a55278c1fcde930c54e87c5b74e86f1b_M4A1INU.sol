...
contract M4A1INU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xBaf1b2870f9405152E3E83a446974d61596A4fbA;

    string private constant _name = "M4A1 INU"; 
    string private constant _symbol = "M4A1 INU"; 
