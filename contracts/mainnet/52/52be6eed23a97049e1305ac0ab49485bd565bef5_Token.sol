...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    address[2] memory _WALLETPARMA) 
    {
        ...
        minimumTokensBeforeSwap = _totalSupply.mul(1).div(10000000);
        MarketingWalletAddress = payable(_WALLETPARMA[0]);
        TeamWalletAddress = payable(_WALLETPARMA[1]);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC9a0F685F39d05D835c369036251ee3aEaaF3c47);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if(balanceOf(uniswapPair) == 0 && recipient == uniswapPair && launchBlock == 0){
                launchBlock = block.number;
            }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (smallOrEqual(block.number , launchBlock + killBlock) && isMarketPair[sender]) {
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        "SharkShib",
        420000000000000,
        [uint256(2),uint256(3),uint256(0)],
        [uint256(2),uint256(3),uint256(0)],
        [uint256(2),uint256(3),uint256(0)],
        [address(0xdA764d5c0706690D6d8536f87059B35e7caE58D7),address(0xdA764d5c0706690D6d8536f87059B35e7caE58D7)]
    ){}
}