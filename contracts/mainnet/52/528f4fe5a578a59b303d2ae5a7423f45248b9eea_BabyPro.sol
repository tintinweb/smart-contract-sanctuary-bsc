...
contract BabyPro is IBEP20, Auth {
    ...
    string constant _name = "Baby Pro Dev Inu";
    string constant _symbol = unicode"BPDI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000000 * (10 ** _decimals);
