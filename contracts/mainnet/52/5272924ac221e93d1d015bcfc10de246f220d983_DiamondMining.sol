...
contract DiamondMining {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;
    
    IERC20 public token = IERC20(0x6D18a376163871c3e7bB925Ecd3Fb01705154325); //mainnet

	uint256 constant public INVEST_MIN_AMOUNT = 1000000000 ether; // 1000000000 T0KEN
	uint256[] public REFERRAL_PERCENTS = [120, 50, 30];
	uint256 constant public DEV_FEE = 0;
	uint256 constant public MARKETING_FEE = 0;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
    
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 1000000000000 ether; // 1000000000000 TOKEN 
    uint256 constant public WITHDRAW_COOLDOWN = 4 * 60 * 60; // 4 HOURS 4 * 60 * 60
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(180, 50)); // 180 days 5% daily // 210%
        plans.push(Plan(90, 50)); // 90 days 5% daily // 160%
        plans.push(Plan(60, 45)); // 60 days 4.5% daily // 135%
        plans.push(Plan(30, 40)); // 30 days 4% daily // 120%
	}
