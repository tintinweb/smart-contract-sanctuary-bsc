...
contract VIPER is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "VIPER INU";
    string constant _symbol = "VIPER INU";
    ...
    uint256 _totalSupply = 65000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x1DaCBB3fAc8f2bAd31BF9B83009a4D4007B6B61C; //LP receiver
        marketingWallet = 0x1DaCBB3fAc8f2bAd31BF9B83009a4D4007B6B61C;  //marketing wallet
        taxMan = msg.sender;  
