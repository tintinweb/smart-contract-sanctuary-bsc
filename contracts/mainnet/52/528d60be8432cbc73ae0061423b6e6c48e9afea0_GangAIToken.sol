...
Community tokens, or community coins, are created by organizations or by a group of people to market their respective brands to followers. 
Similar to members of a club, token holders can get exclusive benefits reserved for that particular community
*/
...
contract GangAIToken is Context, GangAIECO, Ownable {
    ...
    string private _name = 'GangAI';
    string private _symbol = 'GangAI';
