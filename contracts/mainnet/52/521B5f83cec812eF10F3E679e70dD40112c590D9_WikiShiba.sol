...
contract WikiShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf89f03FD2d2Afadd93614F16d2a81C16a38b0FEA); 
    address payable public Wallet_Dev = payable(0xf89f03FD2d2Afadd93614F16d2a81C16a38b0FEA);
    address payable public constant Wallet_Burn = payable(0xf89f03FD2d2Afadd93614F16d2a81C16a38b0FEA); 
    ...
    string private constant _symbol = unicode"WIKISHIBA"; 
    ...
    constructor () {
        ...
        _owner = 0xf89f03FD2d2Afadd93614F16d2a81C16a38b0FEA;
