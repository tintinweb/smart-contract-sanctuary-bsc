...
contract CroyachtclubV3 is Context, IERC20, Ownable {
    ...
    string private _name = "CroYachtClubV3";
    string private _symbol = "CYCV3";
    ...
    function checkBigWallet(address _wallet, uint256 _amount) public view returns(bool) {
        if(_wallet == charityWallet || _wallet == owner() || _wallet == uniswapRouterAddress || _wallet == uniswapV2Pair)
            return false;
