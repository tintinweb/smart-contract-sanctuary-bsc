...
Twitter: https://twitter.com/TheOneCat_BSC
TG: https://t.me/TheONECat


Initial Supply: 100 tokens
Max Wallet: 1 Token (1%)
Max buy TX: 1 Token (1%)
Max Sell TX: .25 Token (.25%) + Cool Down


The initial cost per token will be small, but soon each token will be worth a furtune!!
...
contract TheONECat is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'The ONE Cat';
    string private constant _symbol = 'ONECat';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100 * 10**_decimals;//equals 100 tokens
    ...
    //DevWallets
    address public Development=payable(0x155c4774dF5b2e7Ae2eb5987575887EEdc93aDf3);
    address public Marketing=payable(0x42dF4F8b6147940C338d2d8F43e0872aa8aeE4D9);
    //TestNet
	...
	uint256 private MaxBuy = 1 * 10**_decimals;
