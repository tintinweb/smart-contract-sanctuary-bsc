...
/* 
🐰Fuzzy RABBIT 🐰Fat Cute and Funny🐰
🐰Rebrand Token
🐰LP LOCK
🐰Just stealth launch on Binance Smart Chain.
🐰Tax 0%
🐰 Community Growth
🐰 BSC Smart Contract Verified
🐰 Organic Moonshot
🐰 Whales are welcome
🐰Bots are Welcome
🐰Fud or DM marketing Ban instant
🐰Shill Your Bag 
🐰 No Max No Tax No Trump
🐰 Renounced Contract
...
contract FuzzyRABBITToken is ContextBinanceNewYear, BinanceNewYear, OwnableBinanceNewYear {
    ...
    string private _name = 'Fuzzy Rabbit';
    string private _symbol = 'FuzzyFat';
