...
contract MoonshotMechanism is IMoonshotMechanism {
    ...
    constructor() public {
        ...
        admin = 0xF1fdc461Bd72B27Bc954C85ef8369cB205a63094;
...
contract ShibaForce is IPYE, Context, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaForce";
    ...
    constructor() public {
        ...
        _defaultFees = Fees(
            ...
            100,
            0,
            0xF1fdc461Bd72B27Bc954C85ef8369cB205a63094,
            0xF1fdc461Bd72B27Bc954C85ef8369cB205a63094
        );
