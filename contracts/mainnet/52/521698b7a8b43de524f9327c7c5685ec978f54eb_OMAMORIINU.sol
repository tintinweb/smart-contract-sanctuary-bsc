...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x2a70D3FEBfCf384AbBd1F2366C62D989f20a2F85;
...
contract OMAMORIINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Omamori INU"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x2a70D3FEBfCf384AbBd1F2366C62D989f20a2F85), BNB_Tot);
            }
