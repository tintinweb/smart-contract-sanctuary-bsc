...
library Address{
 ...
 contract SushiInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 800_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0x9700e01f3877408c591057c5827f68610A775754;
    address public donationWallet = 0x9700e01f3877408c591057c5827f68610A775754;

    string private constant _name = "Sushinu Inu";
    ...
    Taxes public taxes = Taxes(0, 4, 2, 1);
