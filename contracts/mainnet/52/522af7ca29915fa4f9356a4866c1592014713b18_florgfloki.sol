...
contract florgfloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Florg Floki"; // 
    string private constant _symbol = "$FLORGKI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x3e53278F6c6f2F4e1C1Ce33cF09Fad2d6BF06751;
