...
contract LIFETToken is IERC20, Ownable {
    ...
    constructor()  {
        ...
        _sonAddress = 0x671C50ADaF4F85F13E578fbc8F51210877b90003;
    ...
    function _takeInviterFee(
        ...
        if (_inviterFee == 0 || _ido == address(0)) return;
        address cur;
    ...
    function addNftMarketBalance(uint256 value) external onlyOwner {
        _nftMarketBalance += value;
    }
    ...
    function setNftFee(uint256 nftFee) external onlyOwner {
        _nftFee = nftFee;
    }
    ...
    function setInviters(uint256[] memory inviters) external onlyOwner {
        _inviters = inviters;
    }
