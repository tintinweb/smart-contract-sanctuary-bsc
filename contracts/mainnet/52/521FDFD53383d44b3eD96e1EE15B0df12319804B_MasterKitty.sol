...
We are safe. Decent callers we will contact soon . Community is organic. Jeets out. Team will start marketing after launch, I hope we'll get some x's from here.

https://t.me/MasterKittybsc
*/
...
contract MasterKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MasterKitty";
    string private _symbol = "MK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34a8D70acF739071B3ace6aB9DaEfdc09a71AC20); // 
    address payable public teamWalletAddress = payable(0x34a8D70acF739071B3ace6aB9DaEfdc09a71AC20); // 
