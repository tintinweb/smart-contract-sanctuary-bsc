...
// WARNING!! This token is a ADS. DONT BUY!!!

/*
What is the TruthGpt Coin
TruthGpt is a cryptocurrency that utilizes an artificial intelligence model called Elon Musk AI. 
This model is designed to analyze various cryptocurrencies and provide users with insights and suggestions for investment opportunities. 
TruthGpt aims to provide users with a secure and reliable platform for cryptocurrency trading and investment.
...
contract ADS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BasedAI";
    string private _symbol = "BSAI";
