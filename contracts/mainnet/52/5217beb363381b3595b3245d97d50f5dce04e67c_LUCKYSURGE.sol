...
//lucky surge yo this is T L T based as fuck
...
contract LUCKYSURGE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "LUCKY SURGE";
    string private constant _symbol = "LKY";
    ...
    // Total Supply
    uint256 public constant _totalSupply = 10**6*189* _DECMULTIPLIER;
    ...
    //Tax wallets
    address public developmentwallet = 0x0b21F13eD6BA6EdDA7E0E219625aaf63b6c7A222;
    address public treasuryWallet = 0x26961e0b3818Bb981c1ADFdF96BB6214461282a4;
    ...
    //trading parameters
    uint256 public liquidity = 197179 * 10**_srgDecimals;
