...
contract QJJDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJJDAO";
    string private _symbol = "QJJDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a68245E40c2564AC579b6BC7764b61159dD1B1D);
    address payable public teamWalletAddress = payable(0x4a68245E40c2564AC579b6BC7764b61159dD1B1D);
    address public immutable deadAddress = 0x4a68245E40c2564AC579b6BC7764b61159dD1B1D;
