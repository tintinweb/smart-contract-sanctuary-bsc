...
contract BIGNFTPresale is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor(uint _startTime, uint _endTime) {
        ...
        baseDecimals = (10 ** 18);
        salePrice = 1 * (10 ** 18); //USD
        hardcapSize = 25_000_000;
        totalTokensForPresale = 25_000_000;
        minimumBuyAmount = 10;
    ...
    function calculatePrice(uint256 _amount) internal view returns (uint256 totalValue) {
        ...
        require((totalSold + _amount) <= hardcapSize, "Hardcap reached");
