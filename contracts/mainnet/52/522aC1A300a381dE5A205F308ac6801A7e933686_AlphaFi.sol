...
/**
  ⭐️Welcome to AlphaFi ⭐️

AlphaFi
Universe & Metaverse: We are developing a system that ties the metaverse and the universe together.

Alphaverse: A marketplace where users can buy, sell, and exchange actual goods using NFTs and Cryptocurrencies.

 https://t.me/AlphaFiOfficial

 https://alphafi.finance/
...
pragma solidity ^0.6.12;
    ...
    contract AlphaFi is Context, IERC20, Ownable {
        ...
        string private _name = 'AlphaFi';
        string private _symbol = 'ALF';
