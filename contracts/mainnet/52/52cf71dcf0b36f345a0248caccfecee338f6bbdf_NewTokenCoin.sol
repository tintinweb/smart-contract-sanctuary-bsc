...
contract NewTokenCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "XiaoHongHua";
    string private _symbol = "XHH";
	...
	function swapXiaoHongHuaFees(address _token, uint256 tokens) private  {
