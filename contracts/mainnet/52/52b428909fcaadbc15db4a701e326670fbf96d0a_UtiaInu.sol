...
/**
    the ugliest duck in town *quack*
    https://t.me/utiaofficial
*/
...
contract UtiaInu is IBEP20, Auth {
    ...
    string constant _name = "Utia Inu";
    string constant _symbol = "*QUACK*";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 200;     //0.5%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;   //1%
    ...
    address private marketingFeeReceiver = 0x3c9a75E8D857c0947eddB7e98475324467a3599f;
    address private teamFeeReceiver = 0x3c9a75E8D857c0947eddB7e98475324467a3599f;
