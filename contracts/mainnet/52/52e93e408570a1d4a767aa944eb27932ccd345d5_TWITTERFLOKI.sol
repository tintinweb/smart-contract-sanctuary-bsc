...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    PCSRouter router;
    ...
    uint256 public minDistribution = 2 * (10 ** 7);
...
contract TWITTERFLOKI is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string public constant name = "Twitter Floki";
    ...
    uint256 public swapThreshold = totalSupply * 1 / 2000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x77347F46d1AD15fB95C222ecF2Bf2547a27E48dF;
        devFeeReceiver = 0x87a97252882f64da4588bfA6F9Af2c9959e0679a;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            if(whitelistMode){
                require(isWhitelisted[sender] || isWhitelisted[recipient], "Error 460");
            }
        }
