...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x876ACAb96e62C74cd8559feB6CD63e69509541eD;
...
contract ZetaToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x876ACAb96e62C74cd8559feB6CD63e69509541eD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 520000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Zeta Token";
    ...
    uint256 public _maxTxAmount = 520000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 520000 * 10**18;
