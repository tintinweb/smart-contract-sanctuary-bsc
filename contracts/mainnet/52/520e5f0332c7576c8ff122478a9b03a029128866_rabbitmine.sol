...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDC651dcccE7fd76c6383DEC564C68fB8a972eB30;
...
contract rabbitmine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RABBITMINE";
    string private _symbol = "RABBITMINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2eD8DBe28a6f30a13af3A44F2f447196eBcf060d);
    address payable public teamWalletAddress = payable(0xDC651dcccE7fd76c6383DEC564C68fB8a972eB30);
