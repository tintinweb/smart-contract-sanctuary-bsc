...
contract NanoLunc is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 10 / 1000; //1% max transaction
    uint256 public _walletMax = _totalSupply * 10 / 1000; //1% max wallet
    ...
    string constant private _name = "Nano Lunc";
    string constant private _symbol = "NLUNC";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xCd9F27408fCcd38dD38Bd8DDA7cAf93C14A2952b;
        marketingWallet = 0xBC37170ED9cC96Fe83734F5F1f4c1c843FC0e9ac;
        devWallet = 0xCd9F27408fCcd38dD38Bd8DDA7cAf93C14A2952b;
        charityWallet = 0x6fA956EC2e3e3B18fc05574df5E9942cF27123Ea;
        nftWallet = 0xCd9F27408fCcd38dD38Bd8DDA7cAf93C14A2952b;
