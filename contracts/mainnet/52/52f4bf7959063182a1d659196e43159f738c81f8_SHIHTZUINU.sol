...
// TG: https://t.me/Shihtzu_Inu_Portal
// Website: http://shihtzuinu.space
...
contract SHIHTZUINU is IBEP20, Ownable {
    ...
    string private _name = "SHIHTZU INU";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x632cFf645139a5002c1a7893e8232c290a21722C,
        team: 0x632cFf645139a5002c1a7893e8232c290a21722C,
        marketing: 0x632cFf645139a5002c1a7893e8232c290a21722C
    });
...
///// AUTHORIZED FUNCTIONS /////
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newDev + newLiquidity + newteam + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newDev, newLiquidity, newteam, newMarketing, newRewards);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 dev, uint256 team, uint256 marketing) {
        return (buybackBalance, devBalance, teamBalance, marketingBalance);
    }
