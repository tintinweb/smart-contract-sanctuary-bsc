...
contract Pow_Chain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pow Chain";
    ...
    address payable public marketingWalletAddress = payable(0x713DEF7eBd9aE47b60D2BfA793481719A0a26749); // Marketing Address
    address payable private teamWalletAddress = payable(0x713DEF7eBd9aE47b60D2BfA793481719A0a26749); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 25000 * 5 **_decimals; 
