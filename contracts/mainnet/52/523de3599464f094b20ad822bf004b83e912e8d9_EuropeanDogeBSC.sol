...
contract EuropeanDogeBSC  is Context, IERC20, Ownable {
    ...
    string private constant _name = "EuropeanDoge"; // 
    string private constant _symbol = "euDoge"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x67Fc84AB4bcBd53BC4dE8EAb3C02f10E6144a488;
