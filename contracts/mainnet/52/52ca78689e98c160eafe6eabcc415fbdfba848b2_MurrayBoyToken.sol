...
/*
    ...
    COME AND BE PART OF MURRAY BOY

    telegram    : https://t.me/murrayboy
    twitter     : https://twitter.com/murrayboy
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFDaF87E2E58d4225219BE8C6e6F00b3d26215043; // owner address
...
contract MurrayBoyToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Murray Boy";
    string private _symbol = "$MB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFDaF87E2E58d4225219BE8C6e6F00b3d26215043); // Marketing Address
    address payable public teamWalletAddress = payable(0xFDaF87E2E58d4225219BE8C6e6F00b3d26215043); // Team Address
