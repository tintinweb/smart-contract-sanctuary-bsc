...
!!! DO NOT SNIPE THIS YOU WILL GET REKT !!!
...
contract SNAKEP2E is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 3; // 100% of supply
    uint256 public maxTxAmountSell = _tTotal / 1; // 100% of supply
    uint256 public maxWalletAmount = _tTotal / 3; // 100% of supply
