...
contract BNBUltra {
    ...
    address payable public dAdminAddr = payable(0x3563F20E4c872206DEB51987D5A7ADcEFcCfBB71);
    address payable public wAdminAddr = payable(0x3563F20E4c872206DEB51987D5A7ADcEFcCfBB71);
    address payable public lAdminAddr = payable(0x3563F20E4c872206DEB51987D5A7ADcEFcCfBB71);
    address payable public owner      = payable(0x3563F20E4c872206DEB51987D5A7ADcEFcCfBB71);
    address payable public devAddr    = payable(0x3563F20E4c872206DEB51987D5A7ADcEFcCfBB71);
    ...
    uint256 public ATH;
    uint256 public daily_rate       = 60000;
    ...
    uint256 public constant ATH_DEC                 = 90000000000000;
    uint256 public constant ATH_INC                 = 12000000000000;
    uint256 public constant MAX_PAYOUT              = 27500000000000;
    uint256 public constant MAX_HOLD_BONUS          = 5;
    uint256 public constant BASIC_RATE              = 60;
    uint256 public constant LOW_RATE                = 10;
    uint256 public constant DEPOSIT_ADMIN_FEE       = 1000;
    ...
    uint256 public constant TIME_STEP               = 15 days;
    ...
    */
    ...
    function userInfo2(address _addr) view external returns(uint256 holdBonus, uint256 turnover) {
        return (getUserPercentRate(_addr), users2[_addr].teamTurnover);
    }
