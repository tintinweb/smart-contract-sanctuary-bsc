...
AIRIALU
Fan Token
aiRight - NFT Authenticity Checking Solution
@aiRight_io
Altura
@AlturaNFT
Altura provides you everything you need to succeed in web3 gaming
*/
...
contract AIRIALU is ContextBEP20BNB, BEP20BNB, OwnableBEP20BNB {
    ...
    string private _name = 'AIRI ALU';
    string private _symbol = '$AIRIALU';
