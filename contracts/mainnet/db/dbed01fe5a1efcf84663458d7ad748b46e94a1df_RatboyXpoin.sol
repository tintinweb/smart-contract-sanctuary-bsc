...
----------------------------------------------------------------------------------------------------------------
Welcome To Ratboy!!!,
Ratboy!!! is a true defi platform that brings the power back to swapping, Bridge , Staiking and more. 
...
Website: 
Telegram : https://t.me/RatboyXclamation
...
contract RatboyXpoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "RATBOY!!!";
    string private constant _symbol = "RATBOY!!!";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            Marketing: 17, // Marketing fee in %
            lp: 9, // lp rate in %
            toSwap: 29 // Marketing + dev + lp
        });
