...
Developed for the King himself, Elon Musk
Built for the Community that stands behind him

Community Elon's sole purpose is to be built for the community as low tax and
super safe, with the main utility of making the community money

Telegram and any Socials will be placed in the hands of the community,
please feel free to create, promote and manage these groups and members
We reserved a TG for the community (https://t.me/CommunityElon), but ultimately 
the community can decide.

The Community will be a haven for Free Speech Abolitionists
Just as Elon would want...

The cElon contract was developed with the community in mind.
The contract is clean, simple, and safe.

cElon will be launching the evening of May 20th (EST)
No Launch Warning will be given, be ready...
...
2% Max Wallet
1% Max Tx
LP will be burned at launch
Auto Generated LP will be continually burned
Ownership will be fully renounced
2% Dev Wallet
2% Contract Allotment to help build initial LP
...
contract cElon is IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Community Elon';
    string private constant _symbol = 'cElon';
