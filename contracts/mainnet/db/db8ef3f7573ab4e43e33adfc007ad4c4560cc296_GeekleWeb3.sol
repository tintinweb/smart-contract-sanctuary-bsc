...
contract GeekleWeb3{
    ...
    constructor() public {
        _devAddress = 0x9DBC83bEa4b7961a8D6709633B113930335218BC; // LA
        ...
        _mint(_presaleAddress, 200000000*10**18);

    
        _mint(_devAddress,700000000 *10**18);

    
        _mint(_BurnAddress,1000000*10**18);
    }
