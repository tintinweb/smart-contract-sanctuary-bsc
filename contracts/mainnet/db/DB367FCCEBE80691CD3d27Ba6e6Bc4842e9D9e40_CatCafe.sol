...
contract CatCafe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CatCafe";
    string constant _symbol = "CATCAFE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8CE15241EA0D85eb81595Fb6d86AD1a5a00e61bD; //Where the 5% marketing fee will be sent
