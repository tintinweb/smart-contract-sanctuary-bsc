...
contract fundoge is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FUNDOGE";
    string private constant _symbol = unicode"$FUNDOGE";
    ...
    address payable public DevWallet = payable(0x95745bAd9AD7cA95eba9B758119b577F35A51e75);
    address payable public MarketingWallet = payable(0xb21b7BdA541Bd93A90Db8fDd140d924A8DE570a0);
