...
contract LongTaiTou is ERC20, ReentrancyGuard, Ownable, system, BotKiller {
    ...
    address public DogeContract = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
//    address router_ = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    uint256 dogePrizeThreshold = 100000 ether;
    ...
    uint256 limitBuyAmount = 200000000000 ether;
    uint256 limitSeconds = 5 * 60;
    uint256 burnRate = 0;
    event DistributeDogeToken(address user, uint256 dogeAmount);
    constructor(address _router, address _reward, address[] memory addrs) ERC20("Long Tai Tou", "LTT") {
        router_ = _router;
        DogeContract = _reward;
