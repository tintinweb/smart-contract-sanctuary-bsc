...
contract BscRiseUp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BscRiseUp";
    string private _symbol = "BRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBC5703a67dF4a335bbd7D2fb163d37AC5799268C);
    address payable public teamWalletAddress = payable(0xBC5703a67dF4a335bbd7D2fb163d37AC5799268C);
    ...
    uint256 private _totalSupply =  65000000000000 * 10**_decimals;
    uint256 public _maxTxAmount =   65000000000000 * 10**_decimals; 
    uint256 public _walletMax =     65000000000000 * 10**_decimals;
