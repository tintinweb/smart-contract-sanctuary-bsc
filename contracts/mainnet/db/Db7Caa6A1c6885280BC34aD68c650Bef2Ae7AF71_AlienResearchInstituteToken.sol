...
contract AlienResearchInstituteToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Alien Research Institute";
    string private _symbol = "ARL";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xfc6F12c3F149A30176C8FBD73a2D8B8E134594d0));
