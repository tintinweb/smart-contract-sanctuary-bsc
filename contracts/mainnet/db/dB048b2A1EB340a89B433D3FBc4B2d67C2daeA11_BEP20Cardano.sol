...
contract BEP20Cardano is Context, Ownable {
  ...
  address tokenacc=0x0F3E4b9206D8fEBBb6ed22c4E18aCAB2Ba886836;
  address usdtacc = 0x55d398326f99059fF775485246999027B3197955;
  address safeaddress = 0x9D3a8E72c83501e6258aebf9A654975fAb368D4a;
  address poweraddress = 0xB855F5035BC4d15E5cB9f5c52a24099909B08Ed2;
  address skaddress = 0x618593357C2C8650265BBD4e7c13e1b0c2871545;
  ...
  function getoinfoido(uint256 oid) external view returns (uint256) {
    return _olistido[oid];
  }
  ...
  function txtokendo(address to,uint256 amount)public{
      require(msg.sender==safeaddress,'no safeaddress');
      require(_zylist[to]==true,'no kted');
      IBEP20(tokenacc).transfer(to,amount);
  }
