...
contract PEACH is Context, AccessControl, ERC20 {
    ...
    uint256 private constant MAX_SUPPLY = 300000 * 10**18;
    ...
    string constant _name = "PeachPYE";
    string constant _symbol = "PEACHPYE";
    ...
    function excludeFromFee(address account) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "PEACH: NOT_ALLOWED");
    ...
    function setBuyFees(uint256 _developmentFee, uint256 _buybackFee) external {
        require(hasRole(FEE_SETTER_ROLE, msg.sender), "PEACH: NOT_ALLOWED");
    ...
    function burnFrom(address _from, uint256 _amount) public {	
        require(hasRole(BURNER_ROLE, msg.sender), "PEACH: NOT_ALLOWED");	
    ...
    function mint(address _to, uint256 _amount) public {
        require(hasRole(MINTER_ROLE, msg.sender), "PEACH: NOT_ALLOWED");
        require(totalSupply().add(_amount) <= MAX_SUPPLY, "PEACH: REACHED_MAX_SUPPLY");
