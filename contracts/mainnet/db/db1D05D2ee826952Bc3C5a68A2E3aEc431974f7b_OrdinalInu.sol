...
TG: https://t.me/OrdinalInuofficialBep20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e3dba9d3F4846CcDC9292fd0a175a9e8B356383; // owner address
...
contract OrdinalInu is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Ordinal Inu";
    string private _symbol = unicode"Oinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e3dba9d3F4846CcDC9292fd0a175a9e8B356383); // Marketing Address
    address payable public teamWalletAddress = payable(0x9e3dba9d3F4846CcDC9292fd0a175a9e8B356383); // Team Address
