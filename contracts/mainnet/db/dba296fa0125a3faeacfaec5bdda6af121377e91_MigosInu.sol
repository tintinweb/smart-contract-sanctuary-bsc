...
contract MigosInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Migos Inu";
    string private _symbol = "$MIGOS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a2864359093dD9c710B2417E86F447e053887da); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x3a2864359093dD9c710B2417E86F447e053887da); // Developmental Address
