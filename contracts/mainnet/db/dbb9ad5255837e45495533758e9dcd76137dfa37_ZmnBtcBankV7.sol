...
contract ZmnBtcBankV7 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function manualEditHistoryRate(
        ...
        require(_rid < rates.length, "No data");
    ...
    // ZmnStakeAuto sent zmn on behaveof user
    // ZmnStakeAuto receive btcb on behaveof user
    function bulkBorrowFor(
        ...
        for (uint16 i = 0; i < loopLimit; i++) {
            ...
            // add to user list
            uint256[] storage _loanAgreementsByUser = loanAgreementsByUser[_to];
            _loanAgreementsByUser.push(_loan.loanId);
        ...
        // send btcb to caller (ZmnStakeAuto)
