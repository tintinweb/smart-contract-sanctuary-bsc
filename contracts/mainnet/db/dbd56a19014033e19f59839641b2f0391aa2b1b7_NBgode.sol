...
contract NBgode is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "liuYM";
    string private _symbol = "liuYM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFC11B899150aB4E8Cf07a575e49EAE34fF866666); // Marketing Address
    address payable public teamWalletAddress = payable(0xEec0d33FF8626450d9d4F6e7Ea624ddB68888888); // maxTxAmount
	address public OwnerAddress =0x40D5e4f7d0De81Ce3A9cf1bE140CB6C8278cf32D;
