...
contract DinosaurDog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DinosaurDog";
    string private _symbol = "DinosaurDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x248243933CE170EA95dE9CdF1e415FE65c4ED17b);
    address payable public teamWalletAddress = payable(0x0f8bC04d08277e372b3532bbEBbc6377E00CdaBA);
