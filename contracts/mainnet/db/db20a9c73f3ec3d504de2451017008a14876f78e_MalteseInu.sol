...
coin: https://t.me/malteseinu_bsc
...
contract MalteseInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3cf30d933593F11a48AB8fa0e6b28E6090C24a8A); 
    address payable public Wallet_Dev = payable(0x79C40fF5dEcb9894a6A2BA22Db803E9168A56CBf);
    ...
    string private constant _symbol = unicode"Maltese"; 
    ...
    constructor () {
        ...
        _owner = 0x79C40fF5dEcb9894a6A2BA22Db803E9168A56CBf;
