...
contract AKAMARUINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd1B2822ffeD5D91aB60726B5B1F7CC4e029C78E5); 
    address payable private Wallet_Dev = payable(0xd1B2822ffeD5D91aB60726B5B1F7CC4e029C78E5);
    ...
    string private constant _symbol = unicode"AKAMARUINU"; 
    ...
    constructor () {
        ...
        _owner = 0xd1B2822ffeD5D91aB60726B5B1F7CC4e029C78E5;
