...
contract DoliKoi is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DoliKoi";
    string private _symbol = "DL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x766D09D8ed12a20cAe6190F8AF9f7745D6B92a7e);
