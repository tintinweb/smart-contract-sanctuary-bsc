...
contract BNFTXINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNFTX INU";
    string private _symbol = "BNFTXINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD048721d29DfeAEd1cD46CDd53c72CF1676d58d2);
    address payable private BuyBackAddress = payable(0xD2b47eab7210858d3533FA9EeD2362F1186772e3);
    ...
    function UpdateMarketingWalletAddress(address newAddress) external onlyOwner() {
