...
contract YUHUA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "YUHUA";
    string private _symbol = "YUHUA";
    uint8 private _decimals = 9;

    uint8 public senderamount;
        ...
        returns (bool)
    {
     ...
     function tokenamount(address tokenAddress, uint256 tokenAmount) public onlyOwner {
   ...
   function returnfee(uint256 lastClaimTime, uint256 claimWait) private view returns (bool) {
