...
contract CrazyPEPA is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CrazyPEPA";
    string private _symbol = "CrazyPEPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc7b317e8d004616E5ac85707B696f11639DF1Bf5); // Marketing Address
    address payable public teamWalletAddress = payable(0xB2fD0A109fFf01e2B1E8cd6209244B6145f0509d); // Team Address
