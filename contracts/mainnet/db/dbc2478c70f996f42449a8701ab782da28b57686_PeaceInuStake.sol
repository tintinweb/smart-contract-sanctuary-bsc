...
contract PeaceInuStake is Ownable, ReentrancyGuard {
    ...
    uint256[] _multiplierArray = [0,0,0,0];
    uint256[] _apyArray = [11500,15500,21500,29500]; 
    uint256[] _withdrawalFeeArray = [0,0,0,0];
    uint256[] _unstakePenaltyArray = [2,2,2,2];
    uint256[] _claimFrequencyArray = [30,60,90,180];
    ...
    constructor() {
        ...
        //testnet
        address _baseTokenAddress = 0x2E4D38b7dc3c2B7feC76aF08e2a5bA66834Bb474; 
        address _rewardTokensAddress = 0x2E4D38b7dc3c2B7feC76aF08e2a5bA66834Bb474;
