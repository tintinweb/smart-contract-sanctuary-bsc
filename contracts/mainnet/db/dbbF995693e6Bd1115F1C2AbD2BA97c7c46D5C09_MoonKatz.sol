...
contract MoonKatz is IERC20 {
    ...
    string constant _name = "Moon Katz"; //TODO
    string constant _symbol = "$MKATZ"; //TODO
    ...
    address payable private _marketingWallet = payable(0xaAfC7792eF65432b83490C4341ea4C94492bD749); //TODO
    address payable private _buybackWallet = payable(0x3C8460BDE5378Bc07FcfDddBab2C2883B6Fe6642); //TODO
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0xF34A0027cE3511484250813753bE42ad189Dd268] = true;      //TODO
        _isDividendExcluded[0xF34A0027cE3511484250813753bE42ad189Dd268] = true;
