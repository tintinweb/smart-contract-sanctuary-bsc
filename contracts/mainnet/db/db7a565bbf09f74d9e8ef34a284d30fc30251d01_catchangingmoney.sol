...
/**
t.me/catchangingmoney

6% marketing (of which 25% probably goes to anothermarketingwallet which I will use as devwallet) 4% autoliq. That's it I guess? Not in a long story mood today kek.
...
contract catchangingmoney is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Cat changing money";
