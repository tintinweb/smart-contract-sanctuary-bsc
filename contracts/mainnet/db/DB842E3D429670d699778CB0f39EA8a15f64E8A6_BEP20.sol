...
// ENGLISH TG PORTAL: https://t.me/BabyLunaOfficiall
// 
//WEBSITE: Coming Soon!!!
...
contract Main is BEP20, SharedOwnable, SafeToken {
    ...
    function Launch(uint256 Blocks) external onlySharedOwners {
        ...
        require(Blocks <= 10, "Not more than 1mn");
        tradingEnabled = true;
...
contract BabyLuna is Main {
    ...
    constructor() Main (
        ...
        0x990bA572Fe5e30cf2A2A3AeC2D8c9b507020DfCC,     // Marketing address
        0x990bA572Fe5e30cf2A2A3AeC2D8c9b507020DfCC,     // Team address AND DEV
        0x990bA572Fe5e30cf2A2A3AeC2D8c9b507020DfCC,     // Multi Use address (CHARITY)
