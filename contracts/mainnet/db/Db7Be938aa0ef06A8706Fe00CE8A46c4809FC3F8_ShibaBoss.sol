...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcD957ac2D0E3d573C029E6cDFB2B313cb97FE1F4; // owner address
...
contract ShibaBoss is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Boss";
    string private _symbol = "SHIBOSS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4447A71125349C72d61Adc319a9fD4E05F1f8e8e); // Marketing Address
    address payable public teamWalletAddress = payable(0x2068e476eE3D427C19F654105F7186fB00AE000b); // Team Address
