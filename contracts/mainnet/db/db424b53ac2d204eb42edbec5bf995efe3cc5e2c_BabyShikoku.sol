...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8ce64DBe0c4A3474d4a290A5CBadD72DE28c04a5; // owner address
...
contract BabyShikoku is Context, IERC20, Ownable {
    ...
    string private _symbol = "$BBYSHIK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa86D6C1E000E2Ac3010Ff8dDA12919583EfA90aC); // Marketing Address
    address payable private teamWalletAddress = payable(0x8ce64DBe0c4A3474d4a290A5CBadD72DE28c04a5); // Team Address
