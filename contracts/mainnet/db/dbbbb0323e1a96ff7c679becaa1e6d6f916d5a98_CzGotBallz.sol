...
contract CzGotBallz is IERC20, Ownable
{
    ...
    //DevWallets
    address public Development=payable(0xefF4245Ab4FFDD0aa49DC2b7a72D135a75eb532C);
    address public Marketing=payable(0x97C825432F46c3eC75A155cc208CDA0E62DF4CdE);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB Rewards
