...
contract ZILLAKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZillaKing";
    string private _symbol = "ZillaKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa026c58dCa6C414053Df495a152328bca5A56b5b); 
    address payable public buyBackWalletAddress = payable(0x686e3672001602D81b8943f53CeDB1571f51D48c); 
