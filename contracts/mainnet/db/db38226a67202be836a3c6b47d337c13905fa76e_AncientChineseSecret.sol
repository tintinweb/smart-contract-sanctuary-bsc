...
https://t.me/AncientChineseSecretBSC
...
//Ancient Chinese Secret Contract /////////////

contract AncientChineseSecret is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Ancient Chinese Secret';
    string private constant _symbol = '$SECRET';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 50000 * 10**_decimals;//equals 500B tokens

    //Divider for the MaxBalance based on circulating Supply (2%)
    uint8 public constant BalanceLimitDivider=50;
    //Divider for sellLimit based on circulating Supply (0.4%))
    ...
    //DevWallets
    address public TeamWallet=payable(0x85e8137FF49a0b7423fd6071D576829C4B1D8D45);
    address public walletTwo=payable(0x85e8137FF49a0b7423fd6071D576829C4B1D8D45);
    //TestNet
	...
	uint256 private antiWhale = 200 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 50 * 10**_decimals;
