...
// SHIBORG INU
// Telegram: https://t.me/ShiborgInu
...
contract wROSE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 340 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Wrapped ROSE (Wormhole)";
    string private _symbol = "wROSE";
