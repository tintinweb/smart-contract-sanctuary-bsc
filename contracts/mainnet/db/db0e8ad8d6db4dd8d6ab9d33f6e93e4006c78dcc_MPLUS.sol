...
contract MPLUS is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "MoonPlus+ Token"; //  Name
        _symbol = "MPLUS"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 100000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 500000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 1500000 * 10**_decimals; // 1% of total supply
        _maxWalletBalance = 3000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0x866010276CC7733548851BeA0CD10Fd6b80Cd256; // Marketing wallet 
        _devWalletAddress = 0xa7122B95Df89237248c20AD2798f8048f39A55c0; // Burn Token 
