...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    address public marketAddr = 0xb9114eFd217646dBD385d4a3859b1Be424444444;
...
contract TetherQueen is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 100000 * 1e18;
    uint256 public _maxHavAmount = 100000* 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) public isbuy;
    uint256 public count = 0;

    constructor() ERC20("Tether Queen", "TQ", 18) DividendFee(1e17, true, USDT, 1) {
