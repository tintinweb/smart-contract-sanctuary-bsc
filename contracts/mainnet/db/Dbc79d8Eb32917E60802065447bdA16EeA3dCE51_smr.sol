...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _limitAmount = LimitAmount * 3 ** Decimals;
    ...
    function setLimitAmount(uint256 amount) external onlyFunder {
        _limitAmount = amount * 3 ** _decimals;
    }
...
contract smr is AbsToken {
    constructor() AbsToken(
        ...
        18,
        288,
        address(0x3A5651E1172067E1AA964c39Cd6cEfaf79570309),
        address(0x370bF69b33caf953Ee7CBdeC5F6159547BAc56C3),
        address(0xE8BFfB548dBd08e15188851432903f5f33a339f8),
        10
    ){
