...
/**
Telegram : https://t.me/ShibaVision
...
/* Token contract */
contract ShibaVision is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address SHIB = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x62D632794c5135Ae77344Fd2d3497940e6Ac2420;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x3576e94317A54B87f2C96ECffed58967CB0223B1;
    ...
    // Name and symbol
    string constant _name = "ShibaVision";
    string constant _symbol = "SHIV";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 150 / 10000; // 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 2500 ) / 10000; // 2%
