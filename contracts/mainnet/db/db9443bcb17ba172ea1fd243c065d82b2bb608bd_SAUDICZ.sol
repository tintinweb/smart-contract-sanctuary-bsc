...
contract SAUDICZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAUDI CZ"; // 
    string private constant _symbol = "SCZ"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xAa4e0ebD79BCBe257798540FECAA93572229D2Ed;
