...
contract ERNIEBOT is Context, IERC20, Ownable {
    ...
    string private _name = unicode"文心一言";
    string private _symbol = "ERNIE BOT";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x7782b0964Eb7664dAf5F57B98F6ad5cCFaF76323); 
    address payable public teamWalletAddress = payable(0x7782b0964Eb7664dAf5F57B98F6ad5cCFaF76323); 
