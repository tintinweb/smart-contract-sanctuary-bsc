...
contract DAO511 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "511 DAO";
    string private _symbol = "511";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xE66958bcFe31B77d5DcC0C3Dd63e4d58352d6Ef8);
