...
contract TRONDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "TRON DOGE";
    string private constant _symbol = "TDOGE";

    address public _PancakeSwapV1RouterUniswap = 0x3bBeac7B325bC1ce632CA2Fa1092b3fBE691e4E0; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x3bBeac7B325bC1ce632CA2Fa1092b3fBE691e4E0; //can be the same
