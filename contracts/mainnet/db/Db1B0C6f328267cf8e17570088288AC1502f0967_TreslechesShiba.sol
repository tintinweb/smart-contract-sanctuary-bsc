...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x74c4d6D7d1cC46d001e1302F2b4D3dE6Daa8B745; // whatDOGE
...
contract TreslechesShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Treshleches Shiba";
    string private _symbol = "TSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x74c4d6D7d1cC46d001e1302F2b4D3dE6Daa8B745); // Marketing Address
    address payable public teamWalletAddress = payable(0x74c4d6D7d1cC46d001e1302F2b4D3dE6Daa8B745); // Team Address
