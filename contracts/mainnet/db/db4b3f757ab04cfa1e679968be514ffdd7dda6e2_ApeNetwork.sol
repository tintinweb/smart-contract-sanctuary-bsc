...
/**
    Telegram : https://t.me/ApeNetworkBSC
*/
...
contract ApeNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "APE NETWORK";
    string private _symbol = "APE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2ac1E53DBFa18924F2833f146Ad36941E969C234);
    address payable public DevelopmentWalletAddress = payable(0x2ac1E53DBFa18924F2833f146Ad36941E969C234);
    ...
    uint256 private _totalSupply = 2000000 * 10**9;
    uint256 public _maxTxAmount = 20000 * 10**9;
    uint256 public _walletMax = 60000 * 10**9;
