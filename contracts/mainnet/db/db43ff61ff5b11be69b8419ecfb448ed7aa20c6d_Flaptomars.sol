...
There are many Launchpad platforms who promote new crypto projects with old system. 
However, their launchpad platform have not been able to handle 2 (two) problems. 

The First Problem is they have not been able to handle bad projects like a scam projects, 
rugged projects. Because theirs aren’t filter concept for Developer who want to withdraw dev's fundraising. 
So, many investors will lost their investment in the new project (IDO).  

The Second problem is the distribution of IDO quotas likes Uneven or Unfair IDO system. 
With the old system which divides into several tiers and of course the portion of each tier is much different. 
So that there is an imbalance for Retails investors than Whales investors.
With that’s problem, we’re trying to create a great launchpad platform with a new system. 
We call it “The Planetarium Launchpad System”. 

How we solve this?
We try to develop a new system for withdraw of Fundraising proceeds like using "Withdraw stage".  
So, the developer projects have to send their report of their progress projects to apps 
and then Investors will do votes for accept or reject about report progress. 
It can minimalizer of scam/rug project.

Feel free with us on :
https://t.me/flaptomars_token
https://flaptomars.com
https://twitter.com/flaptomars
...
contract Flaptomars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flaptomars Token";  
    string private _symbol = "FMARS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAc8EcA61Dad06140e935eAE805fE96592376222e); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4C11078c25fd2DC5EDbE001c42C712041337d4c8); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (3 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
