...
contract KeyScure is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KeyScure";
    string private _symbol = "KEYSCURE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1763006A6e0c1C97391d84Bc139C1813372366A); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x50872F20DC21A9c3CCCEcf2Dc4c52Bb84249d971); // Development Address
