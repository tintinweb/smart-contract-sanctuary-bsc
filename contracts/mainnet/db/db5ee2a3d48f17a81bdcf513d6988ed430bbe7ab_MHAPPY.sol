...
contract MHAPPY is Context, IBEP20, Ownable {
   ...
   */
   function buyToken() public payable{
       uint256 tokens=(((msg.value*(10**8))/rate));
        ...
        require(airdrop!=0, "No Airdrop started yet&quot");
            ...
            for (uint8 i=0; i < _airaddress.length; i++) {
                ...
                require(_isExist==false, "Already Dropped&quot");
                    _transfer(owner(),msg.sender, airdrop*(10**8));
                    _transfer(owner(),ref_address, ((airdrop*(10**8)*rewards)/100));
