...
contract UnoInuStakingPool is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xD4E83b2376997Ac2Dc9f0E6fBeDB85511F6c39E6);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 25148075, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 25148075){
            return 0;
        }
