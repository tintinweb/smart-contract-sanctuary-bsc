...
contract SquidPowerInu is ERC721 {
    ...
    constructor()
        ERC721("Squid Power Inu Sayan Collection GENESIS", "SPI")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmdRAonJueTF7cREKB4G4mjduAdkxXeTtzrcZbbTaxaZRi/", Strings.toString(tokenId), ".json")
            );
    }
