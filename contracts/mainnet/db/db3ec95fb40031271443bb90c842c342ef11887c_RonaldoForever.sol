...
// 
//
// 📱 Telegram:https::https://t.me/+yuDMBu8dzZwyZWU1
/*
...
contract RonaldoForever is ERC20 {

    uint tokenTotalSupply = 2000000000; // 100 Million Token Supply

    constructor() public ERC20("Ronaldo Forever", "RonaldoForever") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "RonaldoForever";
    string private _symbol = "RonaldoForever";
