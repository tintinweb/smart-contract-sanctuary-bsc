...
contract FoorpFoDiuqS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Foorp Fo DiuqS";
    string private constant _symbol = "FFDS";
