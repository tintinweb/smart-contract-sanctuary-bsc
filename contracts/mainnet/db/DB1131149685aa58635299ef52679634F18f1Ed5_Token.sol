...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0x5D4B44775e961BEA6CC7B02F8B1fFC4BDb7e4491);
    string private _name = "FTTS DAO";
    string private _symbol = "FTTSDAO";
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapAmount = tAmount * swapFee / 8000;
            if (swapAmount > 0) {
