...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x95Cc00260Da5517301B76C33600fAeb9e8c121dF; // owner address
...
contract FLOKIMON is Context, IERC20, Ownable {
    ...
    string private _name = unicode"FLOKIMON";
    string private _symbol = unicode"FLOKIMON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x95Cc00260Da5517301B76C33600fAeb9e8c121dF); // Marketing Address
    address payable public teamWalletAddress = payable(0x95Cc00260Da5517301B76C33600fAeb9e8c121dF); // Team Address
