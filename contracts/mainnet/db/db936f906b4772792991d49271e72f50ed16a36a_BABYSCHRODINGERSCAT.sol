...
pragma solidity ^0.8.4;
    ...
    // tg: https://t.me/BabySchrodingersCatBSC
...
contract BABYSCHRODINGERSCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Baby Schrödinger's Cat";
    string private _symbol = "BSCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30fAB4cf167b32975adC5b4A0E33eb58014C86a3); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa785a8cC73AA0702c829A1dfceE7FaA7494c1AEa); // buyback Address
