...
Just launched, hype "Goblin Grow" we create Goblin Grow. 
ca renounced and lp burned, safe here.

 **Website : http://goblingrow.org
 **Twitter: https://twitter.com/realgoblingrow
...
60% add to liquidity --
initial LP 10 bnb (market cap 5k) will be burned
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x115008BC275E5b4001e152EB13433dD2c83F3aBD; // owner address
...
contract GoblinGrow is Context, IERC20, Ownable {
    ...
    string private _name = "Goblin Grow";
    string private constant _symbol = unicode"GOBLIN💹";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x115008BC275E5b4001e152EB13433dD2c83F3aBD); // Marketing Address
    address payable public teamWalletAddress = payable(0x115008BC275E5b4001e152EB13433dD2c83F3aBD); // Team Address
