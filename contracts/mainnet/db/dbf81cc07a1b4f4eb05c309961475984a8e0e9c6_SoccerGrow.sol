...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x548F6e13AEfb5181a8cEAD5A5c7b137eC61BD0Bc; // owner address
...
contract SoccerGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SOCCER GROW";
    string private _symbol = "SOCCER GROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x548F6e13AEfb5181a8cEAD5A5c7b137eC61BD0Bc); // Marketing Address
    address payable public teamWalletAddress = payable(0x548F6e13AEfb5181a8cEAD5A5c7b137eC61BD0Bc); // Team Address
