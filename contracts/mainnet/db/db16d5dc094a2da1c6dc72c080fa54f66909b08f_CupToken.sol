...
contract CupToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address public lpPoolAddress;
    string private _name = "CUP";
    string private _symbol = "CUP";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 300000000 * 10**18;
    address public feeAddr = 0xeE88be9E7Fd8D6B47e915E6F35aDf68DFBfa95Ff;
