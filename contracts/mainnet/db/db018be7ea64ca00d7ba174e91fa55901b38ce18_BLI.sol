...
/**
 *  Taxes : 8% Buy | 8% Sell                          
 *  Telegram : https://t.me/babyluffyinu_vn
 *  Twitter : https://twitter.com/BaBy_luffy_inu
*/         
...
contract BLI is Context, IERC20, Ownable {
   ...
   // uint256 public _maxWalletAmount =80_000_000 * 10 **18;
    ...
    string private _name = "BabyLuffyInu";
    ...
    uint256 public _liquidityFeeBack = 5;
    ...
    address public ownerAddres = address(0x80c6B7e928B7C1D8469246823eCF844fCbA61588);
    address public devAddress = address(0xe981a5FFB163223cea37cc8C705C162433A37D26);
    address charityAdd = address(0xb0C68500f614E72dF3932b6a64F4FC5A10958261);
