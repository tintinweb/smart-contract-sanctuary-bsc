...
contract GucciPiggy is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gucci Piggy";
    string private _symbol = "GP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDb8a21249098B275C96318a814E0023a5fF39B4b); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xDb8a21249098B275C96318a814E0023a5fF39B4b); // BuyBack Address
