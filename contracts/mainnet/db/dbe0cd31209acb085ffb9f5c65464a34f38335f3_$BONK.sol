...
contract $BONK is IERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BONK 3.0";
    string constant _symbol = "$BONK 3.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x2B6b7ba2cC2593f3cD67b390F289b006e715b126;  // teamwallet
        lotteryWallet = 0x45ccd7e5F20c82C9d23555E88B4dB5DB20071EdF;  // lotterywallet
