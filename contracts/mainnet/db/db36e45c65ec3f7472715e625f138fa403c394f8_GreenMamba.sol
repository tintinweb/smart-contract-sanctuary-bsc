...
contract GreenMamba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Green Mamba";
    string private _symbol = "GNBA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb7a09e024668319036cCA5eE5191c015a1f960fe);
    address payable public BuyBackWalletAddress = payable(0xb7a09e024668319036cCA5eE5191c015a1f960fe);
