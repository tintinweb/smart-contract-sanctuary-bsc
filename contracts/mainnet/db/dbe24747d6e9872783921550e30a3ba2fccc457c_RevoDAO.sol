...
contract RevoDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RevoDAO";
    string private _symbol = "$RVD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1763D95a5072BE4795DEdd410BC23A618408EDBe); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x1763D95a5072BE4795DEdd410BC23A618408EDBe); // Team Address
