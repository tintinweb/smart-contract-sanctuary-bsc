...
//https://t.me/BonkZilla

/**

The mighty monster king is back and he's wielding a bat 🏏👑
Safe & transparent team, cleanest code you can find and a dedicated community. 
@BonkZilla is the the beast that's ready to bonk over the BSC market
Join our Telegram and let's get Bonking! 🐊

🏏 Bonkonomics
 
🦖 Total Supply: 1 000 000 000 $BZILLA
🦕 Max Wallet: 40 000 000 $BZILLA
🐲 Tax distribution: Buy 8% / Sell 8% which is distributed as follows:
25% liquidity + 75% marketing

The BonkZilla token is a strictly a meme token in any jurisdiction and is not and can not be considered as a security or
...
contract bonkzilla is Context, IERC20, Ownable { 
    ...
    address payable public BonkzillaMW = payable(0x3C18C434303efE5E8257553E5B3407ac27102A39);
    ...
    uint256 public P_DevReward = 75;
    uint256 public Part_AutoLiquidity = 25; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(BonkzillaMW, BNB_Tot);
