...
// Telegram: https://t.me/teddygrowportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a008a003bF5d834d79d015b39Dc7bedDBEF5713; // owner address
...
contract TEDDYGROW is Context, IERC20, Ownable {
    ...
    string private _name = "Teddy Grow";
    string private _symbol = "TEDDY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a008a003bF5d834d79d015b39Dc7bedDBEF5713);
    address payable public teamWalletAddress = payable(0x9a008a003bF5d834d79d015b39Dc7bedDBEF5713); 
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyRewardBUSDFee);
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellRewardBUSDFee);
        _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_RewardBUSDShare);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBTeam = amountReceived.mul(_RewardBUSDShare).div(totalBNBFee);
