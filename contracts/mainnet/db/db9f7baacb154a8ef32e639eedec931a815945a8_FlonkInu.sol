...
/*  
💛Welcome to this Flonk, FLONK BSC was born because of seeing the crazy increase in flonk in the SOL network,
that's why we made it on the BSC network! with the same potential, at a low price you can get big profits too!

Renounced + Lp locked 

Telegram: https://t.me/FlonkInu
Twitter: https://twitter.com/FlonkInu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe68C0026e23c8836d4363C4810f27d8Fa2997890; 
...
contract FlonkInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlonkInu";
    string private _symbol = "FLONK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xe68C0026e23c8836d4363C4810f27d8Fa2997890); // 
    address payable public teamWalletAddress = payable(0xe68C0026e23c8836d4363C4810f27d8Fa2997890); // 
