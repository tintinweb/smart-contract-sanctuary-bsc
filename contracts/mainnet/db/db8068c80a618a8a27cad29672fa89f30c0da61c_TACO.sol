...
/**
 * SPACE TACO TOKEN
 * Taxes: 6% (2% Dev, 2% Marketing + Buyback, 2% Charity)
 * Max Wallet: 1% (1'000'000 $TACO)
...
contract TACO is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    uint256 public charityShare = 33;
    ...
    function changeTaxDistribution(
        ...
        require(
            newteamShare + newtreasuryShare + newcharityShare == SHAREDIVISOR,
    ...
    function withdrawTaxBalance() external nonReentrant onlyOwner {
        ...
        bool temp2 = SRGIE.transfer(
            ...
            charityWallet,
            (taxBalance * charityShare) / SHAREDIVISOR
        );
