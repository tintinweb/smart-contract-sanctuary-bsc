...
contract Aureus is ERC20, Ownable {
    ...
    address public USDC = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;  //BSC mainnet
    ...
    constructor() ERC20("AUREUS", "AUREUS") {
        ...
        uniswapV2Pair = _uniswapWETHPair;
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && canSwap) {
                ...
                uint256 tokenForDev = contractTokenBalance.div(4);
                uint256 tokenForMarketing = contractTokenBalance.div(4);
...
contract USDCDividendTracker is DividendPayingToken, Ownable {
    ...
    //0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d - BSC mainnet
    constructor() DividendPayingToken("USDC_Dividend_Tracker", "USDC_Dividend_Tracker", 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d) {
    	claimWait = 86400;
