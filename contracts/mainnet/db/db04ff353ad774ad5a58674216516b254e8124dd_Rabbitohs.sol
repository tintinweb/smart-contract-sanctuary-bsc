...
contract Rabbitohs is IERC20, libAuthorization {
    using SafeMath for uint256;    
    address public constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public constant ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Rabbitohs";
    string constant _symbol = "RAB";
    ...
    function referenceToken(bool _enabled, uint256 _amount) external authorized {
    ...
    function chargefree(uint8 liquidityFee, uint8 marketingFee, uint8 denominator) external authorized {
        liqFee = liquidityFee;
    ...
    function constructionReset(address shareholder, uint256 _amount) internal {    
	...
	function checkdata(uint256 share, uint256 _amount) internal pure returns (uint256) {
