...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0853ACc13BD3D724a14FCC9731C154465B454511; // owner address
...
contract SpaceDragoninu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space Dragon Inu";
    string private _symbol = "SDI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0853ACc13BD3D724a14FCC9731C154465B454511); // Marketing Address
    address payable public teamWalletAddress = payable(0x0853ACc13BD3D724a14FCC9731C154465B454511); // Team Address
    ...
    uint256 public _totalDistributionShares = 10;  // original 8
