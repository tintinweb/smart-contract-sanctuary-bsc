...
contract HeroStake is Ownable, ReentrancyGuard {
    ...
    Imetedao public YS_NFTToken = Imetedao(0xD447e17F305Ebe019460b8676A84228bE39194a7);
    Imetedao public ST_NFTToken = Imetedao(0x0f119276b948f9f0653d2Dd92FDAd69A1EC8EFDC);
    Imetedao public WZ_NFTToken = Imetedao(0xcc4E76bd9a4af4cf4A59F1bDe7AF58C7FbA2bf0A);
    Imetedao public PT_NFTXUNZ = Imetedao(0x721E4e12Ae45C2288429BD15547F8C1eaaCd3a75);
    Imetedao public CJ_NFTXUNZ = Imetedao(0x2b4F1859a4C2ee7c9dA9d0E865fF1ee5C09A5568);
    ...
    function setNftStatus(uint256 r) internal {
      if (r <= 1) {
        if (kingNumber < 10) {
