...
contract SQUIDHIGH is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1D40f80aff5a6b7a203C9Fc9972a80f69465365c); 
    address payable public Wallet_Dev = payable(0xB14a9DFd4dA89271f97b378771a5c6d8dd946173);
    address payable public W_Deployer = payable(0xB14a9DFd4dA89271f97b378771a5c6d8dd946173);
    ...
    constructor () {
        ...
        _owner = 0xB14a9DFd4dA89271f97b378771a5c6d8dd946173;
