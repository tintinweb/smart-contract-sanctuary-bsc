...
contract SHOPEECOIN is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xa4A8b9Abcc9381F94Edc5D4A6a92F9c6BeBAc36E));


    string private _name = "SHOPEE COIN";
    string private _symbol = "SHOPEE";
