...
contract Stakedar {
    ...
    uint256[4] public Duration = [30 minutes];
    uint256[4] public Bonus = [120];
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 DAOVAL = getPriceinUSD();
        uint256 rewardtokenPrice = (amount.mul(DAOVAL)).div(1e18);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address DAO_WBNB = 0xd9Ac6D3742fBD50bD8dd3c117834Bb52b5eb4f03; // DAO_WBNB pancake pool address
        IERC20 DAOTOKEN = IERC20(0x642C6F1b8678a118AB89e771E5A9D75aCd63c6cC); // DAO Token address 

        uint256 WBNBSUPPLYINDAO_WBNB =(WBNBTOKEN.balanceOf(DAO_WBNB));
        uint256 DAOSUPPLYINDAO_WBNB = (DAOTOKEN.balanceOf(DAO_WBNB));

        uint256 DAOUSDVAL = (((WBNBSUPPLYINDAO_WBNB.mul(1e18)).div((DAOSUPPLYINDAO_WBNB))).mul(BNBPRICE)).div(1e18);
        return DAOUSDVAL;
    }
