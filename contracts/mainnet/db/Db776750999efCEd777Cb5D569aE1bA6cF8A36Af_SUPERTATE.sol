...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE951EF150A4403be017101b28cc9A580EfA5B163;
...
contract SUPERTATE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPERTATE INU";
    string private _symbol = "STATE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE951EF150A4403be017101b28cc9A580EfA5B163); // Marketing Address
    address payable private teamWalletAddress = payable(0xE951EF150A4403be017101b28cc9A580EfA5B163); // Team Address
