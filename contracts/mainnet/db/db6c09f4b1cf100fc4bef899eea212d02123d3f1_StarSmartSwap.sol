...
contract StarSmartSwap is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x7690D745d3715acfEF8533BBa578280641b9dC93); // Marketing Address
    address payable public teamWalletAddress = payable(0x62C06b517962868DF22CBe477Dc9aD0a2536f738); // Team Address
