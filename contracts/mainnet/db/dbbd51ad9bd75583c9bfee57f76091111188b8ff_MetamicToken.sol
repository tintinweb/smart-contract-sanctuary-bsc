...
contract BEP20Detailed {
    string private _name = "Metamic E-Sports Games";
...
contract MetamicToken is Context, Ownable, IBEP20 {
  ...
  using SafeMath for uint256;
    ...
    address public marketingaddress = 0xD0E2E99452b456cCe0AC336Bd5Fa0C2063B5f6E6;
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 15, "Buy fee should be less than 15%");
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 15, "Sell fee should be less than 15%");
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        /* we will apply sell tax for transfer
        ...
        */
        ...
        if(takeFee)
        {
            ...
            _balances[marketingaddress] = _balances[marketingaddress].add(taxAmount);
            emit Transfer(sender, recipient, TotalSent);
            emit Transfer(sender, marketingaddress, taxAmount);
        }
        else
        {
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
