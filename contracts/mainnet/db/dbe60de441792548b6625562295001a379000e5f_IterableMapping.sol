...
contract GOK is ERC20, Ownable {
    ...
    constructor() ERC20("GHOST OF KYIV", "GOK"){
        address newOwner = address(0x24acc9b0643b665aEA2F2CEa8Ad4A67A096b53B2);
        ...
        liquidityPenaltySellFee = 500;
        charityPenaltySellFee = 500;
    	...
    	marketingWallet = address(0xc4ec5c183B1f22f21aD10fbCA7F49dB9a070Dd9E); // set as marketing wallet
        liquidityWallet = address(0xc4d6526Fc196b24acB5ab1EEc0d857dD1dFcF687); // set as liquidity wallet
