...
//u2
contract SaudiUsdt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Saudi Usdt";
    string constant _symbol = "SaudiUsdt";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 120000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 24; // 2%
		 
    uint256 public _maxWalletToken = _totalSupply / 24; // holder max wallet: 2
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x661FFED51b85840410969427987d0d5f617143d3;
        ...
        marketingFeeReceiver = 0x661FFED51b85840410969427987d0d5f617143d3;
