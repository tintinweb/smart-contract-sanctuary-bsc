...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 96000 * 10**18;
    string private _name = "QB96";
    string private _symbol = "QB96";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xf3B718C728372C857faDB501F4FF9CC6165C7A7C);
    address public pointAddress = address(0x44E26F5a40147babF2DFd7c80b3BCBF7edE4D7Cf);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 96000 * 10**18;
