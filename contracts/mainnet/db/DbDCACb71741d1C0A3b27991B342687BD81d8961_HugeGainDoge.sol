...
contract HugeGainDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HugeGainDoge", "HGD") {
        address newOwner = address(0xc37541bE13771E7c2CF3D8d21B15974321e182d0); // owner address
    	...
    	marketingWallet = address(0x113f885E81E72b46D2De8416FA3ac0b81cc1602C); // set as marketing wallet

      autoLiquidityReceiver = address(0xc37541bE13771E7c2CF3D8d21B15974321e182d0);
