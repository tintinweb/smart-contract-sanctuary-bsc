...
contract VECNA_INU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0Db294944E6223010fd2491C4158C327292A79cd); 
    address payable public Wallet_Dev = payable(0x0Db294944E6223010fd2491C4158C327292A79cd);
    ...
    string private constant _name = "VECNA INU"; 
    string private constant _symbol = unicode"VECNA INU"; 
    ...
    constructor () {
        ...
        _owner = 0x0Db294944E6223010fd2491C4158C327292A79cd;
