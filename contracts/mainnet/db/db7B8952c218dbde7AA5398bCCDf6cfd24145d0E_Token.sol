...
contract  Token  is baseContract { 
    ...
    function setFees(uint buy, uint sell, uint transferFee, uint part) public onlyOwner{
        fees=Fee(buy,sell,transferFee,part);
    }
    ...
    constructor(  address deployer ) payable Auth(msg.sender) { 
        ...
        marketingAddress = [0xb8FF8aF9fA162e4454B73C2A33bB428B83a69789,0xcb14e74072bA7219B4eF64954b3d8A5eF83316aD,0x1EB927DCD9f88c084D6F706B3d30420500b3DF66];
        marketingShare=[1,1,1];
        //    struct Fee{uint buy; uint sell;uint transfer; uint part;}
