...
contract HIMURACOIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x713ea7922529239980f3Fa09e11f0558364D574E); 
    address payable private Wallet_Dev = payable(0xb32AE337Ae919e4830FDC5CF8AB6f7EDeAc3EDF1);
    ...
    constructor () {
        ...
        _owner = 0xb32AE337Ae919e4830FDC5CF8AB6f7EDeAc3EDF1;
