...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x4fc551f17e12560fCcDA0863C2e4b69350f50E90;
...
contract ccgds is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal =  148917112 * 10**_decimals;
    string private constant _name = unicode"CCGDS 2.0"; 
    string private constant _symbol = unicode"CCGDS"; 
    ...
    uint256 public _maxWalletToken = 2 * _tTotal.div(1000);
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x4fc551f17e12560fCcDA0863C2e4b69350f50E90), BNB_Tot);
            }
