 ...
 */
        ...
        returns (uint256)
    {
        ...
        emit LuckyNFTOpened(recipient, recipient);
        return res;
    }
...
================================================================
 */
    function changeMaxLuckyNFT(uint256 _maxNFT) public onlyAdmin {
        maxLuckyNFT = _maxNFT;
    }
 ...
 */
    ...
    event LuckyNFTOpened(address user, address recipient);
    event EventStarted(address user, uint256 status);
    event EventStopped(address user, uint256 status);
    event WithDraw(uint256 amount);
}