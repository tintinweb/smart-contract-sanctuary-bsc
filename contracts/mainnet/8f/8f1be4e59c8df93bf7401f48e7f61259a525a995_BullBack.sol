...
contract BullBack
 is Context, IERC20, Ownable {
    ...
    string private _name = "BullBack";
    string private _symbol = "BullBack";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f358Ee9D887c7e585b589b5cA3d1Dff9D3a91b9);
    address payable public teamWalletAddress = payable(0x3f358Ee9D887c7e585b589b5cA3d1Dff9D3a91b9);
    address public immutable deadAddress =0x3f358Ee9D887c7e585b589b5cA3d1Dff9D3a91b9;
