...
library Address{
 ...
 contract SQUISHU is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_900_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0x97A7b2C30348ad0F9c9Af6376e08631446aaAb6b;
    address public donationWallet = 0x858442e88C76D6c663CA04FB36545e56FD3A8052;

    string private constant _name = "Squishu";
    string private constant _symbol = "SISHU";
    ...
    Taxes public sellTaxes = Taxes(0, 10, 2, 3);
