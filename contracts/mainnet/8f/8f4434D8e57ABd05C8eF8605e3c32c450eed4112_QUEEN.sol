...
contract QUEEN is Context, IERC20, Ownable {
    ...
    string private _name = "DCEC";
    string private _symbol = "DCEC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf1D0125f689a319D6ac2F798583a4188533c8BA5); // Marketing Address
    address payable public teamWalletAddress = payable(0xf1D0125f689a319D6ac2F798583a4188533c8BA5); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 2;  // original 3
    uint256 public _totalDistributionShares = 0;  // original 3

    uint256 private _totalSupply = 52000000000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 52000000000 * 10 ** _decimals;
    uint256 public _walletMax = 52000000000 * 10 ** _decimals;
