...
contract TokensTest_REFLECTIONS_TOKEN is Context {

    address payable private FeeCollectorContract = payable(0x1b243B7C79319dfa1b3c2c3278b22F8164eBBaf1);
    uint256 private constant PayNowFEE = 1*10**17; // Set Pay Now Fee to 0.1 BNB
...
contract Contract is Context, IERC20 { 
    ...
    address payable public constant feeCollector = payable(0x1b243B7C79319dfa1b3c2c3278b22F8164eBBaf1); 
