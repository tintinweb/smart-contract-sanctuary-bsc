...
*/
	...
	function updateFees(uint256 _pid, uint256 _depositFee, uint256 _withdrawalFee) external onlyOwner
	{
		require(_depositFee <= 100e16, "invalid rate");
		require(_withdrawalFee <= 100e16, "invalid rate");
		PoolInfo storage _poolInfo = poolInfo[_pid];
		_poolInfo.depositFee = _depositFee;
		_poolInfo.withdrawalFee = _withdrawalFee;
	}
