...
contract KKI is ERC20Detailed, Ownable {
    ...
    string public _name = "KaitoKidInu";
    string public _symbol = "KKI";
    ...
    uint256 public AssetbackedFee = 30;
    uint256 public Sellpenalty = 30;
    ...
    address public KKIOWNER = 0xef50963e504F7948f812f11d2F881Bb21CB99441;
    ...
    uint256 private constant MAX_SUPPLY = 10000000000 * 10**3 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Kaito Kid Inu", "KKI", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration 
        ...
        autoLiquidityReceiver = 0xfcDaB5E9bc5d2FCe3328C2F0CF4747257D501C13; //Liquidity Reciever will get LP tokens
        Treasuryreceiver = 0xef50963e504F7948f812f11d2F881Bb21CB99441; //Treasury Receiver
        AssetbackedReceiver = 0x961f210F179C301e56403306568B2813879794D2; //Backed asset Receiver
        Sellfee = 0x3Ab0e43E5A700bE73b2978bea1D08dba8E054c42; //Sell penalty
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no KKI token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
