...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        uint256 total = Supply * 20 ** Decimals;
        maxTXAmount = 1 * 20 ** Decimals;
        maxWalletAmount = 1 * 20 ** Decimals;
        _tTotal = total;
...
contract BEP20 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x59B6260c4A4ecFb1AEDD2D9B20Ef963FF0c6696a),
        address(0x0C36A30CF93379d5a8f6Bead05f87ec2E351C327),
    
        address(0x7351Cae65204534eBAeFE348eef2563d51CDE63e)
    ){
