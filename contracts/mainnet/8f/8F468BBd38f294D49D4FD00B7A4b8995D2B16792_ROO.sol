...
contract ROO is BEP20, Ownable {
   ...
   using Address for address payable;
    ...
    bool public RomanSafuEnabled = false;
    ...
    constructor() BEP20("ROO", "ROO") {
        ...
        _tokengeneration(msg.sender, 72 * 10**6 * 10**decimals());
   ...
   function EnableRomanSafu() external onlyOwner {
        require(!RomanSafuEnabled, "Cannot re-enable romanSafu");
        RomanSafuEnabled = true;
    }
