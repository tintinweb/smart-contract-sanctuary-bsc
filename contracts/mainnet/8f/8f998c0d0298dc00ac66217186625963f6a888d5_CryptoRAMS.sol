...
contract CryptoRAMS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoRAMS";
    string private _symbol = "RAMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3E2F6ae222d44819424f90e2252147035b582C75); 
    address payable public DevOutsourceWallet = payable(0x2348829E3F9CD4E6C10A6eF1f5F8079e78171686); 
