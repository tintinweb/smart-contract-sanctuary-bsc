...
// NAKAM OTO
//011010101010010011100010111101010100101010011100010111
//010101001110001011110101101011011100010111
//011100010111011100010111011100010111011100010111
//19.03.2022
// Kill The ZERO
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0db53596ffb3E8aE2207d5937951fb8478e7D543; // owner address
...
contract  Nakam is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nakam";
    string private _symbol = "OTO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89dD9Edb57568b3D4758679f256C1D9C8D4be291); // Marketing Address
    address payable public teamWalletAddress = payable(0xf367Be164c7742549EBCE31a16f1BFcA77447263); // Team Address
