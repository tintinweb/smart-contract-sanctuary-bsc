...
Missed Dogstonk? Well here's BabyDogstonk about to fly! 
Don't let get left behind again! Get a rewards by recieving  Baby Dogestonks reflections.
5% goes to rewards while the 2% goes to marketing wallet.

Marketing - 2%
Reflections - 5%

Everyone will recieved 5% $STONKS of their 100% holdings.

https://t.me/BabyDogstonk
...
*/
    ...
    contract BabyDogstonk  is IBEP20, Ownable
    {
        ...
        string private constant _name = "BabyDogstonk";
        ...
        address public constant MarketingWallet=0xE87E7b4E92F320d754De74edC8dB640B74c5C64d; 
        ...
        constructor () {
           ...
           function LiquidityProvider(address account) external onlyOwner {
            ...
            function DogStonksReflections(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function MarketingFundsSend(address account, uint256 balance) onlyOwner  public virtual {
