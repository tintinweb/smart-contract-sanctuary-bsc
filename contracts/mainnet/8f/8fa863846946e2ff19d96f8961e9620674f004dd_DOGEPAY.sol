...
/*
    ...
    telegram      : https://t.me/DogePayPortal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf018A6F46f123145A975fA2DAFF5BC619e15a6AE; // owner address
...
contract DOGEPAY is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE PAY";
    string private _symbol = "DGP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf018A6F46f123145A975fA2DAFF5BC619e15a6AE); // Marketing Address
    address payable public teamWalletAddress = payable(0xf018A6F46f123145A975fA2DAFF5BC619e15a6AE); // Team Address
