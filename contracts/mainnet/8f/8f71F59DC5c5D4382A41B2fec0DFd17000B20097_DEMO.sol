...
contract BaseToken is Ownable {
    ...
    string constant public name = 'DogeKing0.5';

    string constant public symbol = 'DogeKing0.5';
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muul(_taxFEII).div(100)+0;
        uint256 burn =  value.muul(_burnFEII).div(100)+0;
