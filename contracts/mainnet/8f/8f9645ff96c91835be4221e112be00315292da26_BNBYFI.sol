...
contract BNBYFI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3356FC5D0Daaaa8c9d736d2da741fdeB101d6efC);
    address payable public teamWalletAddress = payable(0x3356FC5D0Daaaa8c9d736d2da741fdeB101d6efC);
    address public immutable deadAddress = 0x3356FC5D0Daaaa8c9d736d2da741fdeB101d6efC;
