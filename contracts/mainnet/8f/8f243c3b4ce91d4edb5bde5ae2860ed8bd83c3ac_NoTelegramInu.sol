...
“Dont make any telegram, respect the project"
Verified and 100% Safe, liquidity will be lock.
Dev reveal in $100k MC.
If you believe this project to reach $1m MCAP, please do hold your bags.
...
contract NoTelegramInu is IBEP20, Auth {
    ...
    string constant _name = "NO TELEGRAM INU";
    string constant _symbol = "NTI";
    uint8 constant _decimals = 18;


    uint256 _totalSupply = 400000000000 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0x058D46b7561179cC725C233506F2B50C065Fa282;
    address private devFeeReceiver = 0x058D46b7561179cC725C233506F2B50C065Fa282;
