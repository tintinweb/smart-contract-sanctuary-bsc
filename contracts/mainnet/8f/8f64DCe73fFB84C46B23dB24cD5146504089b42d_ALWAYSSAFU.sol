...
contract ALWAYSSAFU is ERC20Detailed, Auth {
    ...
    uint256 public swapThreshold = 1000 * 10**DECIMALS;
    ...
    function _transferFrom(address sender,address recipient,uint256 amount) internal returns (bool) {
        require(!isBot[sender] && !isBot[recipient], "in_isBot");
    ...
    function viewDeadStatistics() public view returns (uint256, uint256){
        ...
        uint256 Dpercentage = Dbalance.div(_totalSupply).mul(1000);
        return(Dbalance, Dpercentage);
    }
