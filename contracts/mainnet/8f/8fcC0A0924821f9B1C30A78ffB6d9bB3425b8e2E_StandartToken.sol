...
/*   Telegram : https://t.me/GreenRabbitGlobal
...
contract StandartToken is Context, IERC20, Ownable {
    ...
    string private _name = "Green Rabbit";
    string private _symbol = "GRBT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xCacE45d563c724285E4Ac200AbB6fD4d3F2b5674);
    address payable public liqWalletAddress = payable(0xCacE45d563c724285E4Ac200AbB6fD4d3F2b5674);
    ...
    uint256 public _maxTxAmount =   3e6 * 10**_decimals;
    uint256 public _walletMax =     3e6 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100e3 * 10**_decimals;
