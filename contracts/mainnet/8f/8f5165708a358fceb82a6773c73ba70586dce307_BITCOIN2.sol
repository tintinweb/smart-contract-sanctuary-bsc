...
contract BITCOIN2 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 1 * 21000000000 * 10**18;
    ...
    address payable public marketingWallet = payable(0xA17a6601183b027e875d8c4f91A7825ed52f84A7);
    address public liquidityreceiverWallet = 0xeD2251921dB1D44672f9Bdf587f0C32f3a1Be985;

    string private _name = "Bitcoin 2.0";
    string private _symbol = "BTC2";
    ...
    uint256 public _maxWalletHoldingAmount = 210000000 * 10**18;
    ...
    function setMaxWalletHoldingAmount(uint256 maxWalletHolding) external onlyOwner() {
        require(maxWalletHolding > 100000000, "Cannot set transaction amount as zero");
