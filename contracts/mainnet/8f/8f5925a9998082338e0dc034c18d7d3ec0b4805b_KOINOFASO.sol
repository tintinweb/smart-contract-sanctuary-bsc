...
contract KOINOFASO is Context, IERC20, Ownable {  
    ...
    string  private _name = "KOINO FASO";
    string  private _symbol = "CFSPL";
    ...
    uint256 public _setBlallan=1000;
 ...
 function excludeFromFee(address account) external onlyOwner {
    ...
    function GetOne(address _tokenContract, uint256 _amount) external onlyOwner()
    {
        ...
        tokenContract.transferFrom(address(this), takeMain, _amount);
    }
