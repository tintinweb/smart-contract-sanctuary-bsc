...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x811C849eEda468aE0E0C3308fF2DA22c9D52AA16;
...
contract ShibagamiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibagami Inu";
    string private _symbol = "SHIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8dd6CE89D01B6Dc6038467399612Fcb401A5cb5);
    address payable public teamWalletAddress = payable(0x811C849eEda468aE0E0C3308fF2DA22c9D52AA16);
