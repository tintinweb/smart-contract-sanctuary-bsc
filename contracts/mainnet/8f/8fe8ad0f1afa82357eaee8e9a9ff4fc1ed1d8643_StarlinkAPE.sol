...
// CHANGE
contract StarlinkAPE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Starlink Ape";
    string constant _symbol = "STLA";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xc8991687632c1d037Ca26A6E26fcC058f42dC27F);
