        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x7118fAcbDCb68d22511201cD87dBAF1146918717), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        100000,//Su
        address(0x7118fAcbDCb68d22511201cD87dBAF1146918717),//
        address(0x7118fAcbDCb68d22511201cD87dBAF1146918717)//
    ){
    }
}