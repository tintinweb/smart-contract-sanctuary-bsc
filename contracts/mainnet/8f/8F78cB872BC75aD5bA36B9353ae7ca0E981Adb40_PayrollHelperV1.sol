...
contract PayrollInstanceV1 is Ownable, Pausable, Initializable, Multicall {
    ...
    function setEmployee(address employee, Employee calldata data, bool skipPayment) external whenNotPaused onlyOwner {
        ...
        require(
            ...
            'PayrollInstanceV1(setEmployee): employee.period must be greater than 0'
        );
        require(
    ...
    function pay(address employee) public whenNotPaused {
        ...
        require(amount > 0, 'PayrollInstanceV1(pay): too low amount');
    ...
    function renounceOwnership() public virtual override onlyOwner {
        require(false, 'PayrollInstanceV1(renounceOwnership): not allowed');
    }
}
