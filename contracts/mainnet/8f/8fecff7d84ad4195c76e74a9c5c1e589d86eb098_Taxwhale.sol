...
contract Taxwhale is Context, IERC20, Ownable{
    ...
    uint256 public swapTokensAtAmount = 1_250_000_000 * 10**9;
    uint256 public maxBuyLimit = 30_000_000_000 * 10**9;
    uint256 public maxSellLimit = 8_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 30_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x4890d7052b5CbD2F45143DFF3ef1fDedbC74C1Bb;
    address public devWallet = 0xFAe5B1Ab29b94c0D4a0C22F4BeC9FBCaFaE0A5F5;
    address public buybackWallet = 0x4890d7052b5CbD2F45143DFF3ef1fDedbC74C1Bb;

    string private constant _name = "Taxwhale";
    string private constant _symbol = "Taxwhale";
    ...
    Taxes public taxes = Taxes(0, 6, 4, 0, 0);
    Taxes public sellTaxes = Taxes(0, 10, 8, 1, 1);
