...
/**
  🔥Welcome to the next trend on bsc $MoonshiGrow

MoonshiGrow is a deflationary reflective farming protocol. 
For each transaction, there is a 9% fee. This allows holders 
of $MoonshiGrow to get more by just holding, this is similar to the idea of auto-compound farming. 
...
contract MoonshiGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoonshiGrow"; 
    string private constant _symbol = "MoonshiGrow"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0x7bAf75D01B9fFe8eCfEb817A9F648f4F10F5F8Ba; 
