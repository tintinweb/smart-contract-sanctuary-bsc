...
contract YourContract is Context, IERC20, Ownable {
    ...
    string private _name = "TTC";
    string private _symbol = "Tesla Tai Class";
    ...
    address payable public marketingWalletAddress = payable(0x901BAd7421e535Ab24ea72626A5551fB1C1Fd041);
    address payable public liquidityWalletAddress = payable(0xbB8c128696C90910D2fC19C056ad90c644C8e37C);
    ...
    uint256 private _totalSupply = 210700000 * 10**_decimals;
    uint256 public _maxTxAmount = 210700000 * 10**_decimals; 
    uint256 public _walletMax = 210700000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 210700000 * 5 **_decimals; 
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    // block.number <= launchedBlock + killblock
