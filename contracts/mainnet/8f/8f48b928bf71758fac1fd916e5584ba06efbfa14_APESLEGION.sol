...
Apes Legion is a meme token with bullish upcoming utility on BSC,
presenting our community with a platform where users
will be able to stake their $APES tokens and access our dapp to track
famous dev's wallets, having early access to hyped launches.

Telegram : https://t.me/ApesLegionBSC
...
contract APESLEGION is Ownable, IBEP20 {
    ...
    string constant _name = "Apes Legion";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xA48789a972b4047B39c59Fb7bBf97109d844773F;
        marketingWallet = 0xA48789a972b4047B39c59Fb7bBf97109d844773F;
    ...
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas > 6, "Max gas should be higher than 6 gwei");
        gas = newGas * 1 gwei;
    }
