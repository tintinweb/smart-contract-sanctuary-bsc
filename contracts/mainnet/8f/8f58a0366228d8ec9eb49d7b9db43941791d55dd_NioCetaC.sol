...
contract NioCetaC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NioCetaC";
    string private _symbol = "NioCetaC";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9316C70E1db6476Ad47F57E83d2Aa1Ef4387F8AA); // MARKETING Address
    address payable public teamWalletAddress = payable(0x9316C70E1db6476Ad47F57E83d2Aa1Ef4387F8AA); 
