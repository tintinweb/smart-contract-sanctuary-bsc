...
contract RabbitMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x412CEdad60a0F672201A68df55EF452691528FAa);
    address payable public teamWalletAddress = payable(0xFF140628Df6ADA25f8e7d0B65a56A68d7bf7BC62); 
    ...
    uint256 private _totalSupply = 100000 * 10**7 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 100000 * 10**4 * 10**_decimals; 
