...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88820D2393C0f0E1F9465414A66da6C22aC87310; // owner address
...
contract RedClifford is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TuYuanYuan413";
    string private _symbol = "TuYuanYuan413";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88820D2393C0f0E1F9465414A66da6C22aC87310); // Marketing Address
    address payable public teamWalletAddress = payable(0x88820D2393C0f0E1F9465414A66da6C22aC87310); // Team Address
    ...
    uint256 private _totalSupply = 413 * 10**_decimals;
    uint256 public _maxTxAmount = (_totalSupply * 1) ; 
    uint256 public _walletMax = (_totalSupply * 1) ;
    uint256 private minimumTokensBeforeSwap = (_totalSupply * 2) / 100;
