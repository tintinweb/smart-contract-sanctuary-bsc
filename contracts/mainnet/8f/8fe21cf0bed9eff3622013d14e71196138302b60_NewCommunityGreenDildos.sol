...
contract NewCommunityGreenDildos is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'New Community Green Dildos';
    string private constant _symbol = 'GreenDildos';
