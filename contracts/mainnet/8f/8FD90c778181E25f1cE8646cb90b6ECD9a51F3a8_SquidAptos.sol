...
Our target is to get it to the Moon.
It will be shared on Telegram Group BSC self mesaggeç Follow me.
...
contract SquidAptos is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Squid Aptos";
    string private constant _symbol = "SQAPTOS";
    ...
    address internal constant development_receiver = 0xcFCa1EEb1a4A8ce774cF307180b0bAAcA3F2b573; 
    address internal constant marketing_receiver = 0xcFCa1EEb1a4A8ce774cF307180b0bAAcA3F2b573;
    address internal constant liquidity_receiver = 0xcFCa1EEb1a4A8ce774cF307180b0bAAcA3F2b573;
