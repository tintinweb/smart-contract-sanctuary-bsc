...
contract NuclearInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x624E92920f03927819182F89F8A32AACCF1524b9); 
    address payable private Wallet_Dev = payable(0x624E92920f03927819182F89F8A32AACCF1524b9);
    ...
    string private constant _name = " Nuclear Inu"; 
    string private constant _symbol = unicode"Nuclear"; 
    ...
    constructor () {
        ...
        _owner = 0xA0e5a0F60B35E54F86F5F301065A18e357B183cD;
