...
// File: contracts/RareApepeYC.sol
...
contract MoonPepe is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _hiddenMetadataUri) ERC721A("Moon Pepe", "MOONPEPE") {
        setHiddenMetadataUri(_hiddenMetadataUri);
    }

    function mint(uint256 _mintAmount) public payable nonReentrant {
        if (msg.value == 0) {
            require(totalSupply() < freeSupply, "Free supply exceeded!");
        }
        ...
        if (totalSupply() == freeSupply - 1) {
            setCost(0.0047 ether);
