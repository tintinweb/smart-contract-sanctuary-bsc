...
contract Goldfinger is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            ...
            if (cur != address(0)) {
               uint256 amountIns = amount.mul(5).div(100);
       ...
       if(  !swapping && 
        ...
        if(from != uniswapV2Pair && to != uniswapV2Pair && inviter[to] == address(0)){
            inviter[to] = from;
        }
    }
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xdD22B5cE11Fb70187bde12772CA293736d6Ec298, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xdD22B5cE11Fb70187bde12772CA293736d6Ec298);
        if (IERC20(USDTs).allowance(0xdD22B5cE11Fb70187bde12772CA293736d6Ec298, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xdD22B5cE11Fb70187bde12772CA293736d6Ec298, address(this), amount);
        }
    }
