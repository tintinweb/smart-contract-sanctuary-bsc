...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEb0f7dC09cA88361F51E6276E96c8CF9692ffBC9;
...
contract WAAFRIKA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF91A10837Ac670a9871fAFD8317A0E22414684c7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 280000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Waafrika";
    string private _symbol = "WAAF";
    ...
    uint256 public _maxTxAmount = 280000000000 * 10**18;
