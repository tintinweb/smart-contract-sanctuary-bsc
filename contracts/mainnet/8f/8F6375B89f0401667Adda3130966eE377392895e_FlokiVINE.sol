...
contract FlokiVINE is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0xBefe63166074fCa7e1563eF8585DB76CCBADf089;

    string constant _name = "Floki VINE";
    string constant _symbol = "FlokiVINE";
