...
contract ElonsTweeet20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon's Twitter 2.0";
    string private constant _symbol = "ET 2.0";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x740dCEeB16f37a39a4C712666Ca24dcE4B3d0aFF);
    address payable private _marketingAddress = payable(0x740dCEeB16f37a39a4C712666Ca24dcE4B3d0aFF);
