...
contract Santacoingrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santa Coin Grow"; // 
    string private constant _symbol = "GROW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x32B4c24679DE733bbB17b145b7D0B477FF2C2920);
