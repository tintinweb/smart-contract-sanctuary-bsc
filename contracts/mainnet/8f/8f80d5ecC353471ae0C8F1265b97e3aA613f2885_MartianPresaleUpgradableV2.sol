...
contract MartianPresaleUpgradableV2 is
    Initializable,
    PausableUpgradeable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    address public MartianContractAddress;
    ...
    function initialize() public initializer {
        ...
        // BNBPriceContractAddress = 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE; //BSC Mainnet
        BNBPriceContractAddress = 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526; //BSC Testnet
        // MartianContractAddress = 0x3ceac5F44c9287dAF2C5C8CCE0faE10897E356d1; //BSC Mainnet
        MartianContractAddress = 0x90eFD316Bf87040E8d59e96f36E16ab419a367e6; //BSC Testnet
        // TokenOwnerAddress = 0xDDd93aE691176984591f1dd787305D86d4D39fA6; //Mainnet Deployer
        TokenOwnerAddress = 0x7a0DeC713157f4289E112f5B8785C4Ae8B298F7F; //Testnet Deployer
        PricePerUSDT = 13330000000000000000;
        MinContributionInUSDT = 90;
        DECIMALS = 18;
    }
    ...
    function BuyWithBNB(uint256 _msgValue) private {
        ...
        IERC20Upgradeable(MartianContractAddress).transferFrom(
            TokenOwnerAddress,
            msg.sender,
            tokenValue
        );
    ...
    function ChangeMartianContractAddress(address _address) external onlyOwner {
        MartianContractAddress = _address;
    }
    ...
    function WithdrawAll(uint256 _value) external onlyOwner {
