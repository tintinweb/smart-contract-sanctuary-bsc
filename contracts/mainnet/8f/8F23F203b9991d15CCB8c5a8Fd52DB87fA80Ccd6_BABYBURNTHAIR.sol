...
Telegram :  https://t.me/BABYBURNTHAIR_BSC
*/
...
contract BABYBURNTHAIR is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY BURNT HAIR"; // 
    string private constant _symbol = "$BBHAIR"; //    
