...
contract InfinityYachtClub is Context, ERC165, IERC721, IERC721Metadata, ReentrancyGuard, Ownable {
    using Address for address;
    using SafeMath for uint256;

    // Token name
    string private constant _name = "Infinity Yacht Club";

    // Token symbol
    string private constant _symbol = "INFYC";
    ...
    // base URI
    string private baseURI = "https://ipfs.io/ipfs/QmQpeqDCgukjFm3rUA3WvqRz46veVrxpNBjDcC8eaB3fTT/";
    string private ending = ".json";

    // cost for minting NFT in mintToken
    uint256 public cost = 610 * 10**18;

    // Enable Trading
    bool public tradingEnabled = false;

    // Reward Token
    IERC20 public constant mintToken = IERC20(0xfc62b18CAC1343bd839CcbEDB9FC3382a84219B9);
    IERC20 public constant rewardToken = IERC20(0x0557a288A93ed0DF218785F2787dac1cd077F8f3);
    ...
    function mint(uint256 numberOfMints) external nonReentrant {
        ...
        uint received = _transferIn(mintToken, reqCost);
        require(
            received >= ( reqCost * 95 ) / 100,
            'Invalid Received'
        );
