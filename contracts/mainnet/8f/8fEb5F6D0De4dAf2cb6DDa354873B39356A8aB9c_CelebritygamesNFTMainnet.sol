...
contract CelebritygamesNFTMainnet is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Celebritygames.net Mainnet", "Celebritygames.net Mainnet"){
        commissionRate=10;
