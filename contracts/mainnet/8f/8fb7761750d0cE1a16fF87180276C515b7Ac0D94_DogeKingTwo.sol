...
contract DogeKingTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Doge King 2.0";

    string private _symbol = "DK2.0";

    uint8 private _decimals = 9;

    address public MarketingAddress = 0xa9C9f59aFe66f191BB8B819823FD321f4887Dbc9;
