...
contract RoyalQueenInu is Context, IERC20, Ownable {
    ...
    string private _name = "Royal Queen Inu";
    string private _symbol = "ROYALQUEEN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;

    address payable private developmentAddress =
        payable(0x0C4367050Add1919CA8b51aF83344b819985A827);
