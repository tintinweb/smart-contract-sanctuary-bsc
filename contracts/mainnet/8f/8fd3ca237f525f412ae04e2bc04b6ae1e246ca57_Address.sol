...
contract TestTokenProva is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0xd1cccEFB802C3aF2B5290588E3ac30A228876aF4); 
    address payable public developmentAddress = payable(0x67B404ABf29660B00e6f6ADd93f35E7Ea80D3b33); 
    address payable public charityAddress = payable(0x5E95516c4bb918a4f339302862d4ea64b4FB00A5); 
    address payable public vaultRewardAddress = payable(0x4FbA357BE584c289Af7C882C5C49966420fC27a9); 
    ...
    string private constant _name = "TestTokenProva";
    string private constant _symbol = "TESTPROVA";
