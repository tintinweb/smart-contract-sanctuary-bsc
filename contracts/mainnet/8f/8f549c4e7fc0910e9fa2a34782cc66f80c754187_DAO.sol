...
contract DAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1230000 * 10 ** _decimals;

    string private _name = "DAO";
    string private _symbol = "DAO";
    
    uint256 public _lPFee = 2;
    uint256 public _mkFee = 1;
    uint256 public _mk2Fee = 2;
    ...
    function _initParam(uint256 tAmount,Param memory param) private view  {
        ...
        param.mk1 = tAmount * _mkFee / 100;
        param.mk2 = tAmount * _mk2Fee / 100;
    ...
    function _takeFee(Param memory param,address from)private {
      ...
      if( param.mk1 > 0 ){
        _take(param.mk1, from, address(0xBC379712a760aAE631a09526003F924D9907437b));
      }
      if( param.mk2 > 0 ){
        _take(param.mk2, from, address(0xb7a3A03c6DFb21Ec5c053344B691BF3E2df25D80));
      }
    }
