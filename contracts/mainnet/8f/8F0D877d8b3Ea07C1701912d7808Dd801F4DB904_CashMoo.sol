...
/**
Socials https://t.me/CashMooOfficial

Dev https://t.me/SmitsPlays
...
/* Token contract */
contract CashMoo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xd2c147A95523dC14B0Fd1BE6b6d4E60f8D55d82A;
    ...
    // Name and symbol
    string constant _name = "CashMoo";
    string constant _symbol = "CMOO";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 1M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 4% or 3m tokens
