...
contract BACQ is IERC20, Ownable {
        ...
        returns (bool)
    {
        ...
        if(msg.sender != uniswapV2Pair && balanceOf(recipient) == 0 && inviter[recipient] == address(0)) {
    ...
    function transferFrom(
        ...
        if(recipient == uniswapV2Pair) {
            _tokenSellTransferFee(sender, recipient, amount);
        }else{
    ...
    function _tokenSellTransferFee(
        ...
        if(fee){
            ...
            _takeTransfer(
                sender,
                _destroyAddress,
                tAmount.div(100).mul(_destroyFee.add(10).sub(ratesum)),
                currentRate
            );
        ...
        _rOwned[recipient] = _rOwned[recipient].add(rAmount.div(100).mul(74));
        emit Transfer(sender, recipient, tAmount.div(100).mul(74));
    }
