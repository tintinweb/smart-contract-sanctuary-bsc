...
contract TateToken is IERC20 {
    ...
    uint256 constant private startingSupply = 250_000_000;
    string constant private _name = "Tate Token";
    string constant private _symbol = "TOPG";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        tokensTax: 0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 tokensTax) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: address(this).balance, gas: 35000}("");
        }
    }
