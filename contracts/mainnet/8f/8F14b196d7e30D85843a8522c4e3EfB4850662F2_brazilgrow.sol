...
contract brazilgrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "brazilgrow";
    string private _symbol = "brazilgrow";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x651A1f18F256ee85232668EEb025B70c515B3706 ); 
    address payable public BurnedWalletAddress = payable(0x651A1f18F256ee85232668EEb025B70c515B3706 ); 
