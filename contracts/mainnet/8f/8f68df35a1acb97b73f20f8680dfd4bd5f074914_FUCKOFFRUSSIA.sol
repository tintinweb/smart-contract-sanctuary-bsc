...
// SPDX-License-Identifier: MIT
  ...
  contract DividendDistributor is IDividendDistributor{  
    ...
    function comeonprocess(uint256 gas) external returns (bool) {}
    function Distribute(address shareholder) internal view returns (bool) {}
    function buteDividend(address shareholder) internal returns (bool) {}
    function aimDividend() external returns (bool) {}
    function tiveDividends(uint256 share) internal view returns (uint256) {}
...
contract FUCKOFFRUSSIA is Context, IERC20, DividendDistributor, Ownable{
  ...
  string private constant _name = 'FUCKOFFRUSSIA';
  string private constant _symbol = 'FUCKOFFRUSSIA';
  ...
  uint8 public liquidityFee = 25;
  uint8 public treasuryFee = 13;
  uint8 public buyFeeRFV = 25;
  uint8 public sellFeeTreasuryAdded = 12;
  uint8 public sellFeeRFVAdded = 25;
  uint8 public totalBuyFee = 48;
  uint8 public totalSellFee = 48;
  uint8 public feeDenominator = 200; 	
