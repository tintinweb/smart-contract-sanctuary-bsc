...
contract KibaCroCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KibaCroCoin";
    string private _symbol = "KibaCro";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x75c7cAC1eAcA296d596333Ed51Cf2D0f72c379DB);
