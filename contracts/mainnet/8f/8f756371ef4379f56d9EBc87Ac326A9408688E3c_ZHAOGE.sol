...
contract ZHAOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZHAOGE";
    string private _symbol = "ZOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6dDdE2F5C568577ec2cc8cd6bfa3e5EC0dCA7899);
    address payable public BuyBackWalletAddress = payable(0x6dDdE2F5C568577ec2cc8cd6bfa3e5EC0dCA7899);
