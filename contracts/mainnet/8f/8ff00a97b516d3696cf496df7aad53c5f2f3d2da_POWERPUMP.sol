...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC129C615081CAf7858E50Df3d12fbFb5612f3961; // owner address
...
contract POWERPUMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POWER PUMP";
    string private _symbol = "PP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x770bF157c4f4765a14A6E052657936086Ac25a3c); // Marketing Address
    address payable public teamWalletAddress = payable(0x97E757665BF0c8e27a3B8123ab86e367F0a2509e); // Team Address
