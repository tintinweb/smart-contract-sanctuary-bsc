...
contract CONNECTOR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


	string private _name = "Connector Coin";
    string private _symbol = "CONNECTOR";
    uint8 private _decimals = 9;
	
	
	
    uint256 private constant MAX = ~uint256(0);
    uint256 private _rTotal = 1000000000000 * 10**9;
