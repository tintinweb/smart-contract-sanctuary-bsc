...
contract qee is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'qee';
    string private constant _symbol = 'qee';
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(20 minutes) <= block.timestamp){totalFee = uint256(2000); sellFee =uint256(5000);}
