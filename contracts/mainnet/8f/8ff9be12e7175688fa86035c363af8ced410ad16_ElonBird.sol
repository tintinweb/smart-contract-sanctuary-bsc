...
contract ElonBird is IBEP20, Auth {
    ...
    string constant _name = "Elon Bird";
    string constant _symbol = "EB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 100;  //25% max tx
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100;  //25% max wallet
    ...
    address private marketingFeeReceiver = 0x0AaA024Bf2472b5A644f3f8fc149A75f2bfB82EB;
    address private developmentFeeReceiver = 0x0AaA024Bf2472b5A644f3f8fc149A75f2bfB82EB;
