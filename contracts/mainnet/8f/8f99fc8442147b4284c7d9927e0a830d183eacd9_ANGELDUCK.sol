...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45273b96B9D36190E032870c453970aA94947426; 
...
contract ANGELDUCK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ANGELDUCK";
    string private constant _symbol = unicode"ANGELDUCK";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0xB76C9137C3C51dD4a0774af143fef65E9D408C29); // Marketing Address
    address payable public teamWalletAddress = payable(0xB76C9137C3C51dD4a0774af143fef65E9D408C29); // Team Address
    ...
    uint256 public _buyTeamFee = 17;
    
    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 35;
    uint256 public _sellTeamFee = 35;
    ...
    uint256 public _walletMax = _totalSupply * 2 / 1000;
