...
/*
    https://t.me/GongXiFaCaiInu
    快过年了，恭喜发财。恭喜發財狗 是基于社区的令牌，位于 Binance 智能链网络上。
    有了强大的社区，我们将在未来构建有用的实用程序.恭喜發財 ,新年快樂 , 萬事如意 , 吉慶有餘
...
contract GXFCINU is ERC20, Ownable {
    ...
    constructor() ERC20("GONGXIFACAI INU", "GXFCINU") {
