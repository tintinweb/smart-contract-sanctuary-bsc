...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0B90DD6A344BbA2dc3641E38f2bE778633f2cBA2; // owner address
...
contract Vitalikpantstoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vitalik Pants Token";
    string private _symbol = "VPT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x570fa446AF1b469362Ee12c1B39B07B4a09ee2e2); // Marketing Address
    address payable public teamWalletAddress = payable(0x7F55BE94C90d2391a33a628cF5D729eb21ddd05f); // Team Address
