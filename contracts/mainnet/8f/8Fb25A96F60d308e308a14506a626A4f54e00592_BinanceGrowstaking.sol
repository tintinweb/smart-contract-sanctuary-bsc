...
contract BinanceGrowstaking {
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 BNGVAL = getPriceinUSD();
        uint256 rewardtokenPrice = (amount.mul(BNGVAL)).div(1e18);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BNG_WBNB = 0x42356717c0E30D796f4924A680c7EEB86Eb7DABA;
        
        IERC20 BNGTOKEN = IERC20(0xa3EfA42205bBa588Cbde472B8690fA8252ba2Ef7);
        IERC20 WBNBTOKEN = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
        
        uint256 BNGSUPPLYINBNG_WBNB = BNGTOKEN.balanceOf(BNG_WBNB);
        uint256 WBNBSUPPLYINBNG_WBNB = WBNBTOKEN.balanceOf(BNG_WBNB);
        
        uint256 BNBPRICE = (BNGSUPPLYINBNG_WBNB.mul(1e18)).div(WBNBSUPPLYINBNG_WBNB);
        ...
        uint256 BNGUSDVAL = (((WBNBSUPPLYINBNG_WBNB.mul(1e9)).div((BNGSUPPLYINBNG_WBNB))).mul(BNBPRICE)).div(1e18);
        return BNGUSDVAL;
    }
