...
contract GravitationallyBoundAURA is GRAVIAURADeployer, Context, Ownable {
 
    // common addresses
    address private _owner;
    address private GRAVIAURATeam;
    address private CharityGRAVIAURA;
    ...
    string public override name = "Gravitationally Bound AURA";
    string public override symbol = "GRAVIAURA";
    ...
    constructor(uint totalSupplyValue, address GRAVIAURATeamAddress, address CharityGRAVIAURAAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
       
        // designate addresses
        _owner = msg.sender;
        GRAVIAURATeam = GRAVIAURATeamAddress;
        CharityGRAVIAURA = CharityGRAVIAURAAddress;
       
        // split the tokens according to agreed upon percentages
        balances[GRAVIAURATeam] =  totalSupply * 45 / 100;
        balances[CharityGRAVIAURA] = totalSupply * 45 / 100;
