...
TG: https://t.me/KoalaWorldPortal
...
contract KoalaWorld is Context, IERC20, Ownable {
    ...
    string private constant _name = "Koala World";
    string private constant _symbol = "KWORLD";
    ...
    address private marketingWallet = address(0x4C7Cb3b5a35dA1732B2EBc490809d1fDa43A662a);
    ...
    function forMarketing() public onlyOwner {
