...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC4ddF78b3C0EC90F952D81E793953FEE472fc03A; // owner address
...
contract UFOToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UFO Token";
    string private _symbol = "UFO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC4ddF78b3C0EC90F952D81E793953FEE472fc03A); // Marketing Address
    address payable public teamWalletAddress = payable(0xC4ddF78b3C0EC90F952D81E793953FEE472fc03A); // Team Address
