...
contract BABYONLY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Only Inu";
    string private _symbol = "BABYONLY";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x714368630e07A9Cca22F9CCd598891E471D5726C); // Buy Back Address
