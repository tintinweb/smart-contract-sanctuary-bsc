...
contract LaboonInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "LaboonInu"; // 
    string private constant _symbol = "$Labin"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0xb6efAaa29c2bF8ae78d757C13dae03A22361381C;
