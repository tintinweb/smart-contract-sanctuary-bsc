...
🐕DogeFlix🐕
 ...
 Previous x50 | Bullish Name | Hyped Community | 100X Potential | Experienced Team

$DogeFlix will send and take over the BSC Meme scene. 
Low tax token and holders are rewarded with reflections per transaction, paid out automatically.

🔵Marketing on TikTok and Tg after launch
🔵NFT/NFT Market Place Future
🔵Gaming Future
🔵Low Tax Buy/Sell
🔵Reflections $DogeFlix

 🔵Tokenomics :

🔵Supply 10,000,000,000,000,000
🔵Burn  50% (as Dogea inu footsteps)
...
contract DogeFlix is Context, DogeFlixECO, Ownable {
    ...
    string private _name = 'DogeFlix';
    string private _symbol = 'DogeFlix';
