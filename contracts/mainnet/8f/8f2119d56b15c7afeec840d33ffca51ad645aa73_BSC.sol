...
contract BSC is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x527f1e5BA791e255c8d64a95Ed9467a3EC17B7C9);
        teamWallet= payable(0xFf3AeE2c2CA6803ba95CBa64aA5617869E6c5eB8);

        marketingFee = 2;
        liquidityFee = 1;
        _totalTax = marketingFee + liquidityFee; 

        _totalSupply = 95270000 * 10**_decimals;
        _maxOnceEat = 95270000 * 10**_decimals;
        _maxTotalEat = 95270000 * 10**_decimals;
