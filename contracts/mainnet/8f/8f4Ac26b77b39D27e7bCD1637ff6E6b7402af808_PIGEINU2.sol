...
contract PIGEINU2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIGEINU2.0"; 
    string private _symbol = "PIGE2"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4e0f47aa72c91977bBB27eb94446bC3a3E5B8dA8); 
    address payable public teamWalletAddress = payable(0x4e0f47aa72c91977bBB27eb94446bC3a3E5B8dA8); 
