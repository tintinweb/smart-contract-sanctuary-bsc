...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17Ae3c2C860DeDb709aB8E5E7f79a912847F8AF6; 
...
contract OrdinalPoo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ordinal Poo";
    string private _symbol = "$oPOO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17Ae3c2C860DeDb709aB8E5E7f79a912847F8AF6); // 
    address payable public teamWalletAddress = payable(0x17Ae3c2C860DeDb709aB8E5E7f79a912847F8AF6); // 
