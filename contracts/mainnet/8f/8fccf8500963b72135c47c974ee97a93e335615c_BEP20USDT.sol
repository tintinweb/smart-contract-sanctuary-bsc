...
contract BEP20USDT is Context, IBEP20, Ownable {
  ...
  address[] public  _uniswapSendAddressList;
  mapping (address => address) public _leaderAddressList;
  uint64 public _checkSetLeaderTransferAmount;
  uint64[] public _personRate;
  bool public _isCreateDynamicRewards;
  uint256 public _maxDynamicRewardsAmount;

  uint256 public _minHasAmountToGetPersonAward;
  address public _feeRecieveAddress;
  uint256 public _buyRate = 60;
  uint256 public _sellRate = 60;
  uint256 public _buyRateAfterDynamicRewardsOver = 20;
  uint256 public _sellRateAfterDynamicRewardsOver = 20;
  uint256 public _baseRateAmount = 1000;
  ...
  */
  ...
  function updateFeeAmountToAddress(address sender,address recipient,uint256 amount) public {
    ...
    string memory tipStr = "";
    if( isInUniSwapAddressList(sender) ){ flag = true; feeSubAddress=recipient; tipStr="BuyFee"; }
    if( isInUniSwapAddressList(recipient) ){ flag = true; feeSubAddress=sender; tipStr="SellFee"; }
    if(flag == true){
