...
contract DOGECHEF is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGE CHEF";
    string private constant _symbol = "DOGECHEF";

    address public _PancakeSwapV1RouterUniswap = 0xE4cFf37ABe7cAEBac16DfFAA9FE14234B12AF967; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xE4cFf37ABe7cAEBac16DfFAA9FE14234B12AF967; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0x0a5C15D5B4a2BA93CBf2b0440f2036137C0b8959)] = true; //uniswap router liquidity
