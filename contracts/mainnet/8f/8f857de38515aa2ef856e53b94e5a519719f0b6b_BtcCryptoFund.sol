...
contract BtcCryptoFund is Context, IERC20, IERC20Metadata, Ownable{
    ...
    address public buyback = 0xa285CAD1c3518473f66D097376b11a6C5e773B55;
    address public subtoken = 0xc070c3916B1F398120ef78944F025A04F7223A93;
    ...
    constructor () {
        _mint(0xaE55B1cA9Ee4Ba23680F44914517932d9d090370, 210000000000 * 1e18);
        ...
        isPair[address(0xaE55B1cA9Ee4Ba23680F44914517932d9d090370)] = true;
        DEXs[address(uniswapV2Pair)] = true;
        _tokenDistributor = new TokenDistributor(usdtAddress);
    }

    function name() public view virtual override returns (string memory) {
        return "BtcCryptoFund";
    }
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "BCF: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "BCF: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "BCF: transfer from the zero address");
        require(recipient != address(0), "BCF: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "BCF: transfer amount exceeds balance");
        uint _amount = amount;
        ...
        if ((( DEXs[sender] && recipient != address(uniswapV2Router)) || DEXs[recipient]) &&
            ...
            _balances[address(this)] += amount * 35 / 1000;
            emit Transfer(sender, address(this), amount * 35 / 1000);
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "BCF: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "BCF: burn amount exceeds balance");
        unchecked {
    ...
    function swapTokensForUsdt(uint256 tokenAmount)  private lockTheSwap{
        ...
        uint256 buybackFee = usdtBalance * 15 / 35;
        uint256 subTokenFee = usdtBalance * 10 / 35;
