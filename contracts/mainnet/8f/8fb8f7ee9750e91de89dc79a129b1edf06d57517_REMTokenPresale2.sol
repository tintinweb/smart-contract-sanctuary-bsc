...
/*
* Web - https://renewable-energy-mining.com/
* This is the contract for the REM Presale Round 2. For the first round, see below:
* 0x671b34ED96a3dCA44743aBAb2FBbAc9d4fC1Ba83
*/ 
...
contract REMTokenPresale2 is Ownable {
    ...
    constructor() {
        tokenAddr = 0xdA524d01298dd9605Dd1C66a4b2d8885b05A46C9;
        tokenDecimal = 18;
        bnbDecimal = 18;
        tokenPriceBnb = 40000000000000; // 1 BNB = 25k REM
        minContribution = 1e17;         // 0.1 BNB min
        maxContribution = 10e18;        // 10 BNB min
        hardCap = 50000e18;             // 50k BNB hardcap
    }

    function enablePresale() public onlyOwner {
        require(!presaleEnabled, "Presale already enabled");
        presaleEnabled = true;
    }

    /* This Function Will Airdrop BNB to Multiple Users */
    function airdropCrypto(uint256[] memory amounts, address payable[] memory receivers) payable public  onlyOwner returns (bool){
        uint total = 0;
