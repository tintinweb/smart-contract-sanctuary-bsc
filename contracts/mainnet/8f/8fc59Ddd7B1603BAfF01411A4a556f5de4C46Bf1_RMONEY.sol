...
contract RMONEY is IBEP20, Ownable {
    ...
    string private _name = "REAL MONEY";
    string private _symbol = "RMONEY";
    uint256 private constant INITIAL_SUPPLY = 10_000_000_000 * 10**TOKEN_DECIMALS; 
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x23EDebcafC6e60C8d5772D4E8c8Eaeb06a3Df1E4,
        lottery: 0x202ce9FC58E64B816321703507d0b1BDAd2d3a47,
        marketing: 0xf0050CCd6Ebc5f662321Eb97B4b236CEa66e4241
    });
    ...
    uint16 private targetLiquidityRatio = 25; //target liquidity out of 100

    uint16 public swapThreshold = 50; //threshold that contract will swap. out of 1000
    bool public manualSwap;

    //change this address to desired reward token. miscReward is custom chosen by holder
    address public mainReward = 0xa839B915c4b2cD0e458bE0CbF39c7d1b13FC374a;
...
///// AUTHORIZED FUNCTIONS /////
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newDev + newLiquidity + newLottery + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newDev, newLiquidity, newLottery, newMarketing, newRewards);
    }
    ...
    function withdrawLottery() external authorized {
    ...
    function setLotteryWallet(address payable addr) external authorized {
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 dev, uint256 lottery, uint256 marketing) {
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        ...
        uint256 lotterySplit = (bnbAmount*_taxRatios.lottery) / distributeRatio;      
