...
contract NinjaBot{
    ...
    event newDeposit(address sender, uint256 amount, uint256 balance); 
    ...
    function buyBot(uint256 amount) public payable{
        ...
        emit newDeposit(msg.sender, amount, address(this).balance);
    }
    ...
    function withdraw(uint256 _amount) public onlyOwner{
        USDT.safeTransfer(owner,(_amount * 67 / 100));
        USDT.safeTransfer(markaddress,(_amount * 33 / 100));
