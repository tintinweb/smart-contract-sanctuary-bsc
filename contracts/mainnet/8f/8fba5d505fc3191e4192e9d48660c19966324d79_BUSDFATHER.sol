...
//Telegram : https://t.me/BusdFather
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x7c675B1ac9403cD0Cc0A7A8317BAc5c3C5efA989;
...
/* Token contract */
contract BUSDFATHER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x7c675B1ac9403cD0Cc0A7A8317BAc5c3C5efA989;
    ...
    // Name and symbol
    string constant _name = "Busd Father";
    string constant _symbol = "Buf";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5% on launch or 10M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% or 10M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 5% or 10M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 25 / 10000; // 5% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x35aE5dfD5011ffC1ee8Dfb115EDa7880d4348ccD;
