...
contract ShioriInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x143c20f3016FD724900Ed2Fb50CcF9be66E16A60); 
    address payable public Dev_Wallet = payable(0x143c20f3016FD724900Ed2Fb50CcF9be66E16A60);
    ...
    string private constant _name = "Shiori Inu"; 
    string private constant _symbol = unicode"ShioriInu"; 
    ...
    constructor (
        ...
        _owner = 0x143c20f3016FD724900Ed2Fb50CcF9be66E16A60;
