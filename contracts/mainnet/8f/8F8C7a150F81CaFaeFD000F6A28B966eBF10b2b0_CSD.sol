...
contract CSD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "CSD";
    string private _symbol = "CSD";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc9a4Df7972ecbB8a0D88dac73Bee1fa6AB634A8f));
        marketingWalletAddress = payable(address(0x733B8bC1FC0eB49e4f626585a9c4d3B398885f0c));
