...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3ff7EFcf9a3138f0A4DAfcE69Fe214064C5Ff38d; // owner address
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "Shift Floki";
    string private _symbol = "SFC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3ff7EFcf9a3138f0A4DAfcE69Fe214064C5Ff38d); // 
    address payable public teamWalletAddress = payable(0x3ff7EFcf9a3138f0A4DAfcE69Fe214064C5Ff38d); // 
