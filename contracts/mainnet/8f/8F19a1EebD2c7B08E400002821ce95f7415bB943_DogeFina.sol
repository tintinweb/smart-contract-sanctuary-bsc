...
contract DogeFina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeFina";
    string private _symbol = "DOGFINA";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x18Bd9eb6B1bfecCAc51D38fB85EC7438287128c7);
    address payable public teamWalletAddress = payable(0xbAF75eDcBA9e4492135491144Ea4A5fF29AfB21D);
