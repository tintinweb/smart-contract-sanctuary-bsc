...
Eat The Dip ( $EDIP ) is a movement. A meme coin that is based on the most commonly used phrase in all of crypto!


Total Supply: 1,000,000,000
Max Wallet: 2% ( 20,000,000 Tokens)
Max Transaction: 2% ( 20,000,000 Tokens)
Buy / Sell Tax: 9%
Marketing: 5%
LP: 3%
Development: 1%

https://t.me/EatTheDipBSC
...
contract EatTheDip is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EatTheDip";
    string private _symbol = "$EDIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x969b96E8cCC2924ff2A9B14db9401fDea3b1a044); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x969b96E8cCC2924ff2A9B14db9401fDea3b1a044); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (50 * 10**6 * 10**9), "Max wallet should be less or euqal to 5% totalSupply");
