...
contract GOONSNFT is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _maxSupply = 10000000;
  string private _symbol = "GOB";
  string private _name = "GOONSNFT";
...
//   }
  ...
  function mint(address _to, uint256 _amount) onlyOwner public returns (bool){
    require(!paused , "can't mint when the smart contract is paused");
    require(_to != address(0), "can't mint for the zero address");
    require(_totalSupply.add(_amount) <= _maxSupply, "can't mint more than max supply");
