...
contract smallcock is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public minMxTxPercentage = 15;         // Transaction allowed as % of supply (1-100). Anti-Whale mechanics
    uint8 public minMxWalletPercentage = 15;     // The maximum supply % that a wallet can hold (1-100). Anti-Whale mechanics
