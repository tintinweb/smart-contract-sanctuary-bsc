...
contract ClassicSquidGrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "ClassicSquidGrow";
    string private constant _symbol = "ClassicSquidGrow";
