...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1aE49fB3319e579feB86a615Bd431A7F419985fb;
...
contract RabbitWinter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " RabbitWinter ";
    string private _symbol = " RABWIN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE15bFb45839dF43153E3e22dbdbF0915F6d08Cf0);
    address payable public teamWalletAddress = payable(0xE15bFb45839dF43153E3e22dbdbF0915F6d08Cf0);
