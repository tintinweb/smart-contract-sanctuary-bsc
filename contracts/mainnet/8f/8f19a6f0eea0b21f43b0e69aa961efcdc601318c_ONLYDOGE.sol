...
@OnlyDogePortal This is the portal you'll find.

Only Inu is 1% tax, why? 

The Only Inu you will ever need. This contract is renounced and burn liquidity forever.

Only Doge led by a small group of whales. We truly believe in a space where we can make wonderful projects without greedy teams profiting off of it with high taxes.
*/
...
contract ONLYDOGE is IBEP20, Auth {
    ...
    string constant _name = "Only Doge";
    string constant _symbol = "ONLY DOGE";
    ...
    address private marketingFeeReceiver = 0x5BAD64885495b57C98A760a98e86F1c74F69C593;
    address private teamFeeReceiver = 0xb1bC2961bbDFD68C8D3C0e466b8896c362a30198;
