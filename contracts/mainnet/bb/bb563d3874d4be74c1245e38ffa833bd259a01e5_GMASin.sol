...
/* Token contract */
contract GMASin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x92525755cbb4d097C5A162FB800ECb768252418E;
    ...
    // Name and symbol
    string constant _name = "Gamestop Inu";
    string constant _symbol = "GMEInu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 3% (300 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 3% (300 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3% (300 mil)
