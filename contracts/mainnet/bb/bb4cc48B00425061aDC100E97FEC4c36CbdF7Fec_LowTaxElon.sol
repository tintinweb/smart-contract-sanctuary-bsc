...
contract LowTaxElon is IBEP20, Auth {
    ...
    string constant _name = "LowTaxElon";
    string constant _symbol = "LowTaxElon";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 40) / 200; //1% 
    ...
    address private marketingFeeReceiver = 0x3a9E214e2f1a8BB8A63035497b2561477D6B31B0;
    address private developmentFeeReceiver = 0x3a9E214e2f1a8BB8A63035497b2561477D6B31B0;
