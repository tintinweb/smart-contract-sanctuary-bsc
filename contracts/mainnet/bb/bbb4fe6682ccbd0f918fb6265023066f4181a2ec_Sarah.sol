...
contract Sarah is Ownable, ReentrancyGuard {
    ...
    constructor ( ) {
        allowedToken[0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56] = true;
        allowedToken[0x55d398326f99059fF775485246999027B3197955] = true;
        feeAddress = msg.sender;

        packages[0] = Package(100,  1000, true);
        packages[1] = Package(200,  5000, true);
        packages[2] = Package(350, 10000, true);
        packages[3] = Package(500, 20000, true);
    }
