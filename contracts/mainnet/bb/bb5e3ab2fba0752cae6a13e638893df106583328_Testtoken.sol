...
contract Testtoken is IBEP20, Auth {
    ...
    address private devWallet = 0xe79858b33F5aB730D753AFADd593135c172A0EdD;
	...
	uint256 public lockdays = 14 days;
    ...
    function setmaxWalletAmountRateDenominator1000(uint256 _val) public onlyOwner {
        require(_val > 9, "Max wallet percentage cannot be lower than 0.1%");
        maxWalletRate = _val;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		if(isVested[sender] && blocksSinceStart < lockdays){
                revert("Vested wallets cannot send for 14 days");
            }
