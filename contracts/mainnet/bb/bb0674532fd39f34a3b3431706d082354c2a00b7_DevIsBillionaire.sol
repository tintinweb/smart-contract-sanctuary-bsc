...
contract DevIsBillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DevIsBillionaire";
    string private _symbol = "BILLIONAIRE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB33bf52149a1013C18d0C111B84f10767b3B6899); // Marketing Address
    address payable public devWalletAddress = payable(0xB33bf52149a1013C18d0C111B84f10767b3B6899); // Dev Address
