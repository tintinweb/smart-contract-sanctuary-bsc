 ...
 */
contract WORLDFOOTBAL{
    using SafeMath for uint256;

    uint256 private _totalSupply = 55000000000000000000000000;
    string private _name = "WORLD FOOTBALL";
    string private _symbol = "WOF";
    ...
    uint256 private _airdropEth =   20000000;
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referToken = _airdropToken.mul(_referToken).div(5000);
