...
contract RatBoyMoon
 is Context, IERC20, Ownable {
    ...
    string private _name = "RatBoyMoon";
    string private _symbol = "RatBoyMoon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB280379d80807128BC7FA17CCB2E97F612f135eB));
        _anotherA = payable(address(0xB280379d80807128BC7FA17CCB2E97F612f135eB));
