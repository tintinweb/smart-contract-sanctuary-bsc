...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x193F40aEde82537AB439E7308c28cbac079d1Ed2; // Owner
...
contract BaseNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Base Network";
    string private _symbol = "Dynamic";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x193F40aEde82537AB439E7308c28cbac079d1Ed2); // Marketing Wallet
    address payable public teamWalletAddress = payable(0x94193A3735d64e4Be0415cA6a2396d8789fae60c); // Team Wallet
