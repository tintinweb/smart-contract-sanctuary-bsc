...
contract ONEDOLLARSHIBA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**4;
    uint256 public _maxTxAmount = 4 * 10**4; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**_decimals; //
    string private constant _name = unicode"ONE DOLLAR SHIBA"; // 
    string private constant _symbol = unicode"1$ SHIBA"; //    
    uint8 private constant _decimals = 4; // 
    
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x7ec5fA61622130EC4194024442CA7D574E749803;
