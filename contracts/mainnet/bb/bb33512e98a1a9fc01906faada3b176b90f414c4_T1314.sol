...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 1314000 * 10 ** Decimals;
        _tTotal = total;

        minTokenAmount = 13140 * 10 ** Decimals;
...
contract T1314 is AbsToken {
    constructor() AbsToken(
        ...
        address(0x9e1bAD9EAFEefd6072d8FCe8B407e29165aAD78A),
    
        address(0xd0B947ca04a3333053f7FdAe188be476D22cC1B3)
    ){
