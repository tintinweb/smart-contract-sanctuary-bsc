...
contract relationship is Ownable{
    ...
    address public defaultReferrerAddress=0x57181E62000F929c500329C71b88E277638C4Ef3;
    ...
    modifier onlyPoolOwner() {
        require(pools[msg.sender]==true, "Ownable: caller is not the owner");
        _;
    }
    ...
    function bind(address _referrerAddress) public{
        ...
        if (!isExists){
            ...
            playerInfo[_referrerAddress].totalNumberOfSubordinates+=1;
    ...
    function getReferralRelationship(address user) public view returns(Player memory){
    ...
    function undatePlayerInfo(address user,uint256 amount)public onlyPoolOwner(){

             playerInfo[user].totalConsumptionOfSubordinates=playerInfo[user].totalConsumptionOfSubordinates.add(amount);
