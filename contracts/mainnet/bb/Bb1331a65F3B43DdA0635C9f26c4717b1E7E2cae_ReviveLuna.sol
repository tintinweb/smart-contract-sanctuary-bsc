...
/**
 *Contract Created for the Community of https://t.me/ReviveLuna by @donotkwon
*/
...
contract ReviveLuna is Context, IERC20, Ownable {
    ...
    string private constant _name = "ReviveLuna";
    string private constant _symbol = "rLuna";
    ...
    constructor() {
        address newOwner = address(0x50f456B6b43b590695d540200922191a7C0C7Ab5); // 0x50f456B6b43b590695d540200922191a7C0C7Ab5
        ...
        marketingAddress1 = payable(0xf8ba69965f342e00781a8c7fDb0C4058748fEa1a); // Marketing 1 Address
        marketingAddress2 = payable(0xFd5eF70f09bF98f76109fFe49f4B6980E9Aa308C); // Marketing 2 Address
        marketingAddress3 = payable(0xa813aF18CEFb2435d8d08524d9C1598ea64086eD); // Marketing 3 Address 
