...
/* 
    ...
    ***Main features***
    ...
    Telegram: https://t.me/UtilityTokenBSC -- THE ONLY CONTRACT, ALWAYS VERIFY ON THE TELEGRAM. VMU IS A SCAMMER.
    After the telegram username @vmudream stole the marketing wallet of the previous launch at 20k mc, a final 
    launch as been decided to be executed by the community to make sure that the UTILITY experiment to create
    the world's first triangular token is a success. Always verify the contract address on the telegram.
 */
...
contract Utility is Context, IERC20, Ownable {
    ...
    string private constant _name = "Utility";
    string private constant _symbol = "UTILITY";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address private _marketingWallet = 0xA56db216d76dE181721B37653A80209BC2154c36;
