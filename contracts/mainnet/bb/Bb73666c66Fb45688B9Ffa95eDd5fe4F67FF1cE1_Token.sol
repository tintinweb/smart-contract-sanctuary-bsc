...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _buyFundFee = 0;
    uint256 private _buyLPDividendFee = 350;
    uint256 public _buyLPFee = 50;
    uint256 public _buyBlackFee = 100;

    uint256 private _sellFundFee = 0;
    uint256 private _sellLPDividendFee = 350;
    uint256 public _sellLPFee = 50;
    uint256 public _sellBlackFee = 100;
    
    uint256 public numTokensSellToFund = 500000000;
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x0A09cdCE3122DB2c346b15Af7E27Dd3C8b888888)
    ){
