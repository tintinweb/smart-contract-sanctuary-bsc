...
/*
SuperEx is the !rst Web3.0 based cryptocurrency
exchange and is developing the fastest and most
secure cryptocurrency exchange in the world. We
are creating the most intuitive user experience for
everyone.
Our mission is to create a Web 3.0 based
business concept that enables decentralization,
DAO management, community decentralization,
and let billions of users have hands-on access to
cryptocurrencies. SuperEx will provide smooth
interoperability between the real and vi"ual
worlds, the metaverse and the universe, Ea"h and
other planets. We are creating the world's most
transparent, secure, stable and decentralized
digital asset trading pla#orm.

📱Telegram :  http://t.me/SuperExOfficial
🌍Website : http://superexcom/
🤖Discord : https://discord.com/invite/superex  
🐦Twitter  :  https://twitter.com/SuperExet
   Instagram : https://www.instagram.com/superexdex/   
 Apps : https://play.google.com/store/apps/details?id=com.superex.ex  
*/
...
contract superextoken is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountSell = _tTotal / 10; // 10% of supply
    ...
    string private constant _name = "Extraterrestrial Token";
