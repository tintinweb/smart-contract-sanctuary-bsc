...
contract LMEOW is Context, IERC20, Ownable {
    ...
    string private _name = "LMEOW";
    string private _symbol = "LMEOW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x914430AC29451107eB76CaC47d48A7588fC16602); 
    address payable public BurnedWalletAddress = payable(0x914430AC29451107eB76CaC47d48A7588fC16602); 
