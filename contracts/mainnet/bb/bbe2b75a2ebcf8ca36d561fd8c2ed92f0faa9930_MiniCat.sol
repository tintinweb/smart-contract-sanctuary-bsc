...
4% marketing 
3% lp 
FUN FACT: CONVERT TOTAL SUPPLY FROM ASCII TO LETTER  :)
*/
...
contract MiniCat is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniCat";
    string constant _symbol = "MC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 109105110105 * (10 ** _decimals);
    ...
    uint256 public _sellMultiplierNumerator = 300;
