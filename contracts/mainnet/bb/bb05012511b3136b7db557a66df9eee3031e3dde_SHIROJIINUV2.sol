...
contract SHIROJIINUV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIROJI INU";
    string private _symbol = "SHIROJI INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6739ffAad448E90E0C0443C437eE6Caf09797553); // Marketing Address
    address payable public teamWalletAddress = payable(0x7aA1a06c57F7225991b14fB40E4bE497010c8Bab); // Team Address
