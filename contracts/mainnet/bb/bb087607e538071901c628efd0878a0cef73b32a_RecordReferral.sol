...
// File: contracts/RecordReferral.sol
...
// File: contracts\libs\IGalaxyReferral.sol

pragma solidity 0.6.12;

interface IGalaxyReferral {
    /**
     * @dev Record referral.
     */
...
contract RecordReferral is Ownable {
    ...
    IGalaxyReferral public galaxyReferral;
    
    function addReferral(address _referrer) external {
        galaxyReferral.recordReferral(_msgSender(),_referrer);
    }
    
    function setGalaxyReferral(IGalaxyReferral _galaxyReferral) external onlyOwner {
