...
// Telegram Group : https://t.me/okxzilla
...
contract OKXZilla is Context, IERC20, Ownable {
    ...
    string private _name = "OKX Zila";
    string private _symbol = "OKXZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x910F02d2df9BF512321724f8a66da69Ad6D192dB); // Marketing Address
    address payable public developmentWalletAddress = payable(0x3d7eEa11c25F834A34D90E3412a16125ffd6B18a); // Development Address
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 totalBNBFee = _totalDistributionShares.sub(_liquidityShares.div(2));
        
        uint256 amountBNBLiquidity = amountReceived.mul(_liquidityShares).div(totalBNBFee).div(2);
        uint256 amountBNBDevelopment = amountReceived.mul(_developmentShares).div(totalBNBFee);
