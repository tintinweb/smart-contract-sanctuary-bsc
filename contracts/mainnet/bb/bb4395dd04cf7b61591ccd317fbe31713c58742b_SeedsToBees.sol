...
contract SeedsToBees is Context, IERC20, Ownable {
    ...
    address payable private _growthWallet = payable(0x764C98CF39b3D95b1B5F79aAf101121fe1a53312);
    ...
    function exemptFromLimits(address wallet, bool exempted) public onlyOwner() {
        _exemptFromLimits[wallet] = exempted;
    }
    ...
    function recoverBNB() external onlyOwner {
        ...
        require(success, 'recoverBNB/BNB-transfer-failed');
    }
