...
contract MuskRat is BEP20, Auth {
    ...
    string public constant name = "MuskRat";
    string public constant symbol = "$MRAT";
    uint8 public constant decimals = 9;

    uint256 public constant totalSupply = 10000 * 10**6 * 10**decimals;
