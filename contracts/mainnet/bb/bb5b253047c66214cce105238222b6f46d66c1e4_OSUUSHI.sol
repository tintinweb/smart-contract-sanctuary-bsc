...
/**
OSUUSHI
https://t.me/OsuushiETH
For every dark day in crypto there will always be bullish days ahead. 雄牛
*/
...
contract OSUUSHI is OSUUSHIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private OSUUSHITeam;
    address private CharityOSUUSHI;
    ...
    string public override name = "Tsuyoki no Kisetsu";
    string public override symbol = "OSUUSHI";
    ...
    constructor(uint totalSupplyValue, address OSUUSHITeamAddress, address CharityOSUUSHIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        OSUUSHITeam = OSUUSHITeamAddress;
        CharityOSUUSHI = CharityOSUUSHIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[OSUUSHITeam] =  totalSupply * 4 / 100;
        balances[CharityOSUUSHI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's OSUUSHITeam pot
