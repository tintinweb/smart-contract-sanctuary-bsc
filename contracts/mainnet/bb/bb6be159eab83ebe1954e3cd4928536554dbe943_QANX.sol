...
contract QANX is Context, IERC20, Ownable {
    ...
    string private _name = unicode"QANX2.0";
    string private _symbol = unicode"QANX2.0";
    uint8 private _decimals = 0;

    address payable public marketingWalletAddress = payable(0xAc3AE7456E8bc17DEF4DE94DFa94395DCB3d2D04); 
    address payable public BurnedWalletAddress = payable(0xAc3AE7456E8bc17DEF4DE94DFa94395DCB3d2D04); 
    ...
    uint256 private _totalSupply = 3333333000 * 10**_decimals;
