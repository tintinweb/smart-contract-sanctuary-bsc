...
/*
    Inucoin - $INU
    https://t.me/inucoin_bsc
    Inucoin is a decentralized meme token inspired by other popular dog coins like Dogecoin, Shiba,
    Floki, Baby Dogecoin, Cheems, Saitama, Dogebonk and Dogelon Mars.
    It will be the main currency and governance token of the Inuverse, a diverse multi-chain ecosystem offering
    a range of investment opportunities and services that will attract thousands of new investors.
...
contract Inucoin is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = 2500000 * 10**_decimals; // 2% of sp
    uint256 public maxTxAmountSell = 2500000 * 10**_decimals; // 2% of sp
    uint256 public maxWalletAmount = 7500000 * 10**_decimals; // 2% of sp
