...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x20225238d5a4a1E5325aAC557018971E8744c48c;
...
contract wsh is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public mwallet = payable(0x20225238d5a4a1E5325aAC557018971E8744c48c);
    ...
    string private constant _name = unicode"WallStreetHoge"; 
    string private constant _symbol = unicode"WSH"; 
