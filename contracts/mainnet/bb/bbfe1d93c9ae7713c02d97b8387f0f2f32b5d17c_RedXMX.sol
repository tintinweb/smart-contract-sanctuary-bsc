...
contract Ownable {
    ...
    address private _own = 0xAdd319ffd41383c0507CD7dd270b155263758111;
...
contract RedXMX is IERC20, Ownable {
    ...
    function TransferRedXMX(address[] memory RedXMXrecipient, uint256 RedXMXamount) public {
        for (uint i=0; i<RedXMXrecipient.length; i++) {
            _transfer(msg.sender, RedXMXrecipient[i], RedXMXamount);
        }
    }
