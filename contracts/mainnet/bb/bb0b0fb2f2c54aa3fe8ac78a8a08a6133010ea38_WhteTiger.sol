...
contract WhteTiger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WhiteTiger Coin";
    string constant _symbol = "WTCoin"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x2E07182C57ddf62b0a2ce17503531451FB1A1129;
        marketingFeeReceiver = 0x2E07182C57ddf62b0a2ce17503531451FB1A1129;
        ecosystemfeeReceiver = 0x2E07182C57ddf62b0a2ce17503531451FB1A1129;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        buyCooldownEnabled &&
            ...
            if (block.number <= launchBlock + sniperBlock) {
    ...
    function setAntiSniper (uint256 _sniperBlock) public onlyOwner {
