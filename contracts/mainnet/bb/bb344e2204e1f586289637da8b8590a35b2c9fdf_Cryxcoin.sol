...
contract Cryxcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cryxcoin";
    string private constant _symbol = "Cryxcoin";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7e104B6E31E4a18962Ee74f5DA9Bc83b4d82B873);
    address payable private _marketingAddress = payable(0x7e104B6E31E4a18962Ee74f5DA9Bc83b4d82B873);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(taxFeeOnBuy < 15, "Tax cannot be more than 10.");
	    require(taxFeeOnSell < 15, "Tax cannot be more than 10.");
