...
contract STORM is BEP20, MinterRole {
    ...
    address public feeWallet = 0x99BfB9E235A601aE6D24E0a682266119CC0d56da;
    
    uint256 public buyFee = 5;
    uint256 public sellFee = 5;   // default 5%
    uint256 public minTransferAmount = 50000000000000000000;   // 50 STORM Token

    // Trading bool
    bool public tradingOpen;
    bool private _inTransferForSTORM;

    bool public transferForSTORMEnabled = true; // INMUTABLE
    ...
    modifier lockTheTransfer {
        _inTransferForSTORM = true;
        _;
        _inTransferForSTORM = false;
    }

    /**z
     * @notice Constructs the STORM token contract.
     */
    constructor() public BEP20("Tornado Cash", "STORM") {
    ...
    /// @dev overrides transfer function to meet tokenomics of STORM
    ...
    function enableSwapTokenForSTORM(bool _enabled) public onlyOwner {
        transferForSTORMEnabled = _enabled;
    }
