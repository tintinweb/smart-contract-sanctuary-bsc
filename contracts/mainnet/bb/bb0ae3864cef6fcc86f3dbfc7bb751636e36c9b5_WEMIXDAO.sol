...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _fundAddress2 = 0x010da938EC7D30f8058b6B3b2B7e7EB09037cB59;
    ...
    constructor (
        ...
        maxBuyAmount = 1 * 18** Decimals;
        walletLimit =  1 * 18** Decimals;
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 550 / 1000;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount2 = usdtBalance * 150 * 2 / swapFee;
...
contract WEMIXDAO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        130000000,
        address(0xb383d2a4eC94CBc881C6B2Bdca439d63E54f564F),
        address(0xeE88299685005875239dd7F37c06C8e76a26163b)
    ){
