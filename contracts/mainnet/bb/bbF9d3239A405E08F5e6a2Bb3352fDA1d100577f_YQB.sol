...
contract YQB is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x000000000000000000000000000000000000dEaD

));
        marketingWalletAddress = payable(address(0x000000000000000000000000000000000000dEaD
));
