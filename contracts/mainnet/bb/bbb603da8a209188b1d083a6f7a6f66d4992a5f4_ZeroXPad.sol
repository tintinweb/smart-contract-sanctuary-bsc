...
contract ZeroXPad is ERC20, ERC20Capped, ERC20Burnable, Ownable {
    ...
    constructor(
        ...
        _transferOwnership(0x0A78302a382Ffe54b02BC85416099d9e63D10B6d);

        treasury_ = treasury;
        if (initialMint > 0) _mint(0x0A78302a382Ffe54b02BC85416099d9e63D10B6d, initialMint);
    ...
    function excludeFromFees(address holder) public onlyOwner {
        ...
        isExcludedFromFees_[holder] = true;
    }
    ...
    function includeInFees(address holder) public onlyOwner {
        ...
        isExcludedFromFees_[holder] = false;
    }
    ...
    function _transfer(
        ...
        if (isExcludedFromFees_[from] || isExcludedFromFees_[to] || msg.sender == owner()) {
