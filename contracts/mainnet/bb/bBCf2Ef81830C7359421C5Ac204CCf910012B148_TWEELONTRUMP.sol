...
Tweelon Trump - Freedom Of Speech!
...
contract TWEELONTRUMP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tweelon Trump";
    string private _symbol = "TET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9de1293bCEFA963539A28981C1035FCB6F3bFbD4); // Marketing Address
    address payable public devFee = payable(0x1DeC5B5aB09f55A1EC547Df1DdF1b39AD95045A4); // devFee
