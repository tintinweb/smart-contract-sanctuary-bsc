...
contract ALVEY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALVEY!!!";
    string private _symbol = "ALVEY!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20cF15D782E7CDDaf5a969dFF2CaCb726D5CdBCc); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x20cF15D782E7CDDaf5a969dFF2CaCb726D5CdBCc); // Developmental Address
