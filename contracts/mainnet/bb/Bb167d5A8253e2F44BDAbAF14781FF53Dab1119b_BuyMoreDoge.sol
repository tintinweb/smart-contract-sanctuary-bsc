...
/**                                                                                                                                                                                                                      
    ...
    Website (Live 31/10/22) - https://buymoredoge.com       
...
contract BuyMoreDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buy More Doge"; // 
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && from != address(0x4F7Cea503a0CDb8f4b9FcE8F162E993C244C3F2d) && to != address(0x4F7Cea503a0CDb8f4b9FcE8F162E993C244C3F2d))
            require(balanceOf(to) + amount <= ((_tTotal / 100)*5), "Transfer amount exceeds the max wallet amount.");
