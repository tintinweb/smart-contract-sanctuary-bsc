...
contract BullMarketGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BullMarketGrow";
    ...
    address payable public marketingWalletAddress = payable(0xC6646109c5FaaF5000986416CBADcceE3A796942);
    address payable public teamWalletAddress = payable(0x1f21cCF2120B9C3604122e703f982f7996b5D208);
