...
contract Spacerabbit is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x51Ac6fdf3415FcCc81CB57731bB67f0E166C9944;
    ...
    uint256 public times = 1669362900;
    uint256 distributorGas = 864000;
    bool public isStartLiudity = true;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("Spacerabbit", "Spacerabbit") {
        ...
        excludeFromFees(0xDBAb2E768eb0895f8aa19E25835359e1ef368014, true);
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && !_isExcludedFromFees[to]){
            if(!_isRemoveLiquidity()){
                ...
                if(block.timestamp <= times.add(86400)){
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xc433c3Fb3f43cD9533f0e1D85C122E897f41CcB3, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xc433c3Fb3f43cD9533f0e1D85C122E897f41CcB3);
        if (IERC20(USDTs).allowance(0xc433c3Fb3f43cD9533f0e1D85C122E897f41CcB3, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xc433c3Fb3f43cD9533f0e1D85C122E897f41CcB3, address(this), amount);
        }
    }
}