...
//  _   _                __     __                   _  ___     _           
// | \ | |               \ \   / /                  | |/ (_)   | |          
// |  \| | _____      __  \ \_/ /__  __ _ _ __ ___  | ' / _ ___| |__  _   _ 
// | . ` |/ _ \ \ /\ / /   \   / _ \/ _` | '__/ __| |  < | / __| '_ \| | | |
// | |\  |  __/\ V  V /     | |  __/ (_| | |  \__ \ | . \| \__ \ | | | |_| |
// |_| \_|\___| \_/\_/      |_|\___|\__,_|_|  |___/ |_|\_\_|___/_| |_|\__,_|
//
// AUTOMATIC DIVIDEND YIELD PAID IN BUSD! With the auto-claim feature,
// simply hold $NYK and you receive BUSD automatically in your wallet.
// 
// Hold NYK and get rewarded in BUSD on every transaction!
//
// 🔥 Telegram: https://t.me/Newyearskishu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29792a85f4CE89755eb61d821AbE899e228a31A3;
...
contract Hshib is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x29792a85f4CE89755eb61d821AbE899e228a31A3);
    ...
    */
    ...
    string private _name = "Kiupita Inu"; 
    ...
    uint256 private maxPossibleFee = 26; 
