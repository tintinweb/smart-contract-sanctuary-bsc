...
contract  SHIBY2K is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shiba Y2K"; // 
    string private constant _symbol = unicode"SHIBY2K"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x4Be69F07bEecFBF7D2f4dB653821e5d9d95D2DB5;
