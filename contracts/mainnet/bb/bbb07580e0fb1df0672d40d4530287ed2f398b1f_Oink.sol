...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x374b011CE9d02AC550aAAf5871e9F080f38231Cf; // owner address
...
contract Oink is Context, IERC20, Ownable {
    ...
    string private _name = "ApeOink";
    string private _symbol = "Ape"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF819e2A987d5CBAE740DE857F8398fF21a9d612D); // Marketing Address
    address payable public teamWalletAddress = payable(0xF819e2A987d5CBAE740DE857F8398fF21a9d612D); // Team Address
