...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0c10fAD60D72f3f86C9F03b014Df7b53D70f817; // owner address
...
contract TsukaWorldcup is Context, IERC20, Ownable {
    ...
    string private _name = "Tsuka Worldcup";
    string private _symbol = unicode"$TWCUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7944D59bB303414b0488E9902bA0F5d22684e54D); // Marketing Address
    address payable public teamWalletAddress = payable(0xF0c10fAD60D72f3f86C9F03b014Df7b53D70f817); // Team Address
