...
Coin Guy - the coin for guys that like coins
...
contract CoinGuy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "CoinGuy";

    string private _symbol = "CoinGuy";

    uint8 private _decimals = 9;

    address public MarketAddress = 0xBB7911B0FE24453A80D11148790CA63F32dEC303;
