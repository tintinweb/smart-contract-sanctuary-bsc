...
contract TRUMP is IBEP20, Auth {
    ...
    address DEV = 0x5048eB632b2Db45951DaFf397076373e76E03594;
    ...
    uint256 discountFactor = 1;  // 2 means all fees are divided by 2.
    ...
    uint256 public earlybuyBlocks = 10;  // for $whitelist holders to buy early
    uint256 public holdingThreshold = 1;  // 1 basis point, i.e., 1 is 0.01%

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.1% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        whitelist = IBEP20(0x8f1caDA04a0854501cd10f5B724107eff15DbC22);  // whitelist contract
    ...
    function _hasDiscount(address sender) internal view returns (bool) {
        return whitelist.balanceOf(sender) >= whitelist.totalSupply() * holdingThreshold / 10000;
    }
