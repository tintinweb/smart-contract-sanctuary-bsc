...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x69B32F02Fc9386308813f1C8674A2b26452afF71;
...
contract NUREONNA is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Nure Onna"; 
    string private constant _symbol = unicode"YOKAI"; 
...
*/
    function _transfer(
        ...
        {  
            ...
            sendToWallet(payable(0x69B32F02Fc9386308813f1C8674A2b26452afF71), ETH_Tot);
        }
    }
        bool takeFee = true;
        bool isBuy;   
