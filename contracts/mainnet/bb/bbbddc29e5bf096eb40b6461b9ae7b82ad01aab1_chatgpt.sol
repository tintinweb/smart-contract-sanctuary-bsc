...
contract chatgpt is Context, IBEP20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1e13 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 3;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xEc6598554BB054044070720544c92a5973bEa8c5
;
    address public opsWallet = 0xc8A6591f0B4a44e8C6CEc7A864a9DDBE5087D60B;
    address public devWallet = 0x070498D058a35d324d79bF22Bcc1350bced0d078
;
    ...
    Taxes public taxes = Taxes(3, 3, 2, 0, 2);
    Taxes public sellTaxes = Taxes(3, 3, 2, 0, 2);
