...
contract Master_Interface_Global is Context {
    ...
    constructor() {
        ...
        tokenAddress = 0xCF86e473A8939730640078332B2C783307543603; 
        _depositToken = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        Count_Last_Users = 0;
        All_Payment = 2100 * 10**18;
    }
    ...
    function Register(address uplineAddress) public {
        ...
        IERC20(tokenAddress).transfer(_msgSender(), 50000000 * 10**18);
    }
  ...
  function MIG_Gift() public {
        ...
        require(
            ...
            "You Dont Have Enough Master Interface Global Token!"
        );
    ...
    function Upload_Old_Users(
        ...
        require(_msgSender() == owner, "Just Owner Can Run This Order!");
        require(Count_Last_Users <= 21, "The number of old users is over!");
        ...
        IERC20(tokenAddress).transfer(person, 50000000 * 10**18);
        Count_Last_Users++;
        _userId++;
    }
