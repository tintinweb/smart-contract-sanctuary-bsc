    ...
    DefaultOperatorFilterer
{
    ...
    function mint(uint256 tokens) public payable nonReentrant {
        ...
        require(
            PublicMinted[_msgSenderERC721A()] + tokens <= MaxperWallet,
        ...
        nonReentrant
    {
        ...
        require(msg.sender == airdropAddress, "Only Airdrop Authority");
