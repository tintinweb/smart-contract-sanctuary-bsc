...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x56D6cBc8D633eB057381503A5eC70453a54C4B4B; // owner address
...
contract SincereCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereCat";
    string private _symbol = "SINCERECAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1fAdCa353A7BD67c7b790932f15Fbf96C06b040a); // Marketing Address
    address payable public teamWalletAddress = payable(0x1fAdCa353A7BD67c7b790932f15Fbf96C06b040a); // Team Address
