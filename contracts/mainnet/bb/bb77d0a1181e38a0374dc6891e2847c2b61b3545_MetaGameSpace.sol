...
╚═╝     ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝╚══════╝╚═╝     ╚═╝  ╚═╝ ╚═════╝╚══════╝
                        ...
                        ╚██████╗╚██████╔╝██║ ╚████║   ██║   ██║  ██║██║  ██║╚██████╗   ██║                      
                         ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝   ╚═╝                      
                             ...
                             Official Contract for MetaGameSpace.
...
contract MetaGameSpace is Context, IERC20 {
    ...
    string constant private _name = "MetaGameSpace";
    string constant private _symbol = "METAGS";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xfd9EdEB2FfC3779488536086fA0C1bb4654343D8),
        development: payable(0x1E4C37BF536d43FaF73F927D3012d910bd582501),
        liquidity: 0x5ABCBa326711288410537D8b9d9bdFCa17c7983E
        });
    ...
    uint256 private _maxWalletSizePercent = 1;
