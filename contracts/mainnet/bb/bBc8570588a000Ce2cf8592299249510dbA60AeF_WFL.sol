...
contract WFL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "warrior for love";
    string private _symbol = "WFL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x803E004FaA930c388F724b5651A0fB469FE71cbB); 
    address payable public BurnedWalletAddress = payable(0x803E004FaA930c388F724b5651A0fB469FE71cbB); 
    ...
    uint256 private minimumTokensBeforeSwap = 4880000000 * 10**_decimals; 
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x6c8A2b97A8224d23748f3900F226a3bA89DeabBA),
            block.timestamp
        );
    }
