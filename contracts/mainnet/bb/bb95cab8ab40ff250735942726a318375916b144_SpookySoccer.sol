...
/*
     spooky soccer is a meme token with the name bola , which stands on the binance network , Our name will fly after we launch, what are you waiting for join us

    ⚙️Tax : 10/10
    ⚙️Safe dev 👍
    ⚙️Max 4%
    ⚙️Liquidity lock one month
    ⚙️Initial lp 1 bnb

    📲 : https://t.me/spookysoccer
...
contract SpookySoccer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Spooky Soccer";
    string constant _symbol = "spookysoccer";
