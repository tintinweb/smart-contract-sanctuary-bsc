...
contract ProofofChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ProofofChain"; // 
    string private _symbol = "ProChain"; // 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8476c311923Ca661309e96CAaC43154138f1F19e); // 
    address payable public teamWalletAddress = payable(0xAb7DE597537a9BED21Bc6e5A9e0E6431D23F8553); // 
