...
The coin that will end the bear market and slow down miners on the network due to heavy traffic


https://t.me/bearmarketend
*/ 
...
contract BearMarketEnd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BearMarketEnd";
    string private _symbol = "$BMEND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2D6aBC41177CB4c58fE2Db50981a4ce156ed35EC); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2D6aBC41177CB4c58fE2Db50981a4ce156ed35EC); // BuyBack Address
