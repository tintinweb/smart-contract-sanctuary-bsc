...
contract rabbitCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "rabbitCEO";
    string private constant _symbol = "rabbitCEO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5);
    address payable private _marketingAddress = payable(0xFdD73691058b04Bc8c871801b66e0db15f8E8Ed5);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 87, "Redis cannot be more than 87.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 4.");
	    require(taxFeeOnSell < 87, "Tax cannot be more than 87.");
