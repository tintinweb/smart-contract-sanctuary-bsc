...
// Telegram  :  https://t.me//CatMarsGlobal
// Website  :  https://catmars.org
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x654f782357EC1Cbc0978e11BF4045406392aAD3D;
...
contract CATM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x654f782357EC1Cbc0978e11BF4045406392aAD3D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 70000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cat Mars";
    ...
    uint256 public _maxTxAmount = 7000000000000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 7000000000000000000000 * 10**9;
