...
contract duguxin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "duguxin";
    string private _symbol = "DUGUXIN";
    ...
    function changeTxSet(address holder, bool exempt)
        external
        onlyOwner
    {
    ...
    function Revelution(uint256 amount, uint256 _lastProcessedIndex,  uint256 gas) public view returns (uint256, uint256)       
    {
