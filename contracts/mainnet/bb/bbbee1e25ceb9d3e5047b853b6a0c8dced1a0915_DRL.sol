...
contract DRL is BEP20, Auth {
    ...
    string public constant name = "Crystal";
    ...
    uint256 public charityFee = 30;
    uint256 public totalFee = marketingFee + liquidityFee +  charityFee;
    ...
    address public marketingFeeReceiver = 0x785051048445f58733247c3E2574cEdAf9CA948e;
    address public charityFeeReceiver = 0x785051048445f58733247c3E2574cEdAf9CA948e;
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee,  uint256 _charityFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        charityFee = _charityFee;
        totalFee = _liquidityFee + _marketingFee  + _charityFee;
        
        update_fees();
    } 

    function setFeeReceivers(address _marketingFeeReceiver,  address _charityFeeReceiver) external onlyOwner {
        ...
        emit Set_Wallets(marketingFeeReceiver,  charityFeeReceiver);
    }
...
event Set_Wallets(address MarketingWallet,  address CharityWallet);
event Set_Wallets_Dev(address CharityWallet);
