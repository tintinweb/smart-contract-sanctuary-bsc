...
/**
 *Submitted for verification at BscScan.com on 2022-2-01
*/
...
contract dontbuy is Context, IBEP20, Ownable {
    ...
    string private _name = "DontBuy"; // token name
    string private _symbol = "DontBuy"; // token ticker
    ...
    bool public antiBotStopEnabled = true;
