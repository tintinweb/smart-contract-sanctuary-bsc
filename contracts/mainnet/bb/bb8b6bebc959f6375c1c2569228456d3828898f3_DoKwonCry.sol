...
contract DoKwonCry is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DoKwonCry";
    string private constant _symbol = unicode"DKWCRY";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**8 * 10**_decimals;

    address payable private DevWallet = payable(0x3dD97f89fC17D61709F37F5C45F627C0E275d61f);
    address payable private MarketingWallet = payable(0x3dD97f89fC17D61709F37F5C45F627C0E275d61f);
