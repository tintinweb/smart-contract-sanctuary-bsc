...
//SPDX-License-Identifier: MIT              https://t.me/Mrdegens
...
/* Token contract */
contract MrDegens is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2864DaE8423Bc879cf89914D055be201243C510f;
    ...
    // Name and symbol
    string constant _name = "MrDegens";
    ...
    uint256 public swapThreshold = _totalSupply * 500 / 10000; // 2% of supply
