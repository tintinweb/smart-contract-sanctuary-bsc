...
contract CAPCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAPTAIN CAT";
    string private _symbol = "CAPCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfe6086Bf98c1A09d6A624240Eb032860Ae6c1859);
    address payable public teamWalletAddress = payable(0x6093112Fdd552634EC7028534b30F82F5Ce486B0); 
