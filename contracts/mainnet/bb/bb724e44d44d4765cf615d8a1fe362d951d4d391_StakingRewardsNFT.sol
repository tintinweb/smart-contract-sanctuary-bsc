...
contract StakingRewardsNFT is Initializable, OwnableUpgradeable, RewardsDistributionRecipient, ReentrancyGuardUpgradeable, PausableUpgradeable , TokensRecoverableUpg {
    ...
    function resetStakingParams(address _rewardsToken, address _stakingERC1155Token) external onlyOwner{
        rewardsToken = IERC20(_rewardsToken);
        stakingToken = IERC1155(_stakingERC1155Token);
    }
