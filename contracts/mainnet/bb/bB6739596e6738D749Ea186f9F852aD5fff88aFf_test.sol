...
contract test is Context, IERC20, Ownable {
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function setFeeRates(uint256 _operations, uint256 _marketing) external onlyOwner {
        feeRates.operations = _operations;
        feeRates.marketing = _marketing;
        emit FeesChanged();
    }

    function setSellFeeRates(uint256 _operations, uint256 _marketing) external onlyOwner{
