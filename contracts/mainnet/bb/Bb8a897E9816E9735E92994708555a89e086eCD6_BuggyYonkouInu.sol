...
contract BuggyYonkouInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Buggy Yonkou Inu"; // 
    string private constant _symbol = "Buggy Yonkou Inu"; //    
