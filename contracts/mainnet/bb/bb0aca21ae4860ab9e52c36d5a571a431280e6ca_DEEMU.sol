...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD477E36f58E6609Db263b073652547BF5264c847;
...
contract DEEMU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x88E36a4bE988B26354F000002adab437667a94FF;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DEEMU";
    string private _symbol = "DMU";
