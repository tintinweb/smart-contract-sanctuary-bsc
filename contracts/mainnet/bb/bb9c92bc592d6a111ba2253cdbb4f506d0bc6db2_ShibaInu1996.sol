...
contract ShibaInu1996  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaDcEC8882662cD70BA146A88E29e3fab1119A5fa); 
    address payable public Wallet_Dev = payable(0x968DF0bFA97f6B4f5516F2C8b7cC041c190925C0);
    ...
    string private constant _name = "ShibaInu1996"; 
    string private constant _symbol = unicode"Shib96"; 
    ...
    constructor () {
        ...
        _owner = 0x3992a8e3512802DDA369cA1e014f163F0A48c84c;
