...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "Interest/Distributor already exists"
        );
        ...
        returns (bool)
    {
        require(
            distributorsMapping[_BEP_TOKEN].exists,
            "Interest/Distributor not found"
        );
...
contract Interest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Interest";
    ...
    function permit(
        ...
        require(holder != address(0), "Interest/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "Interest/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "Interest/permit-expired"
        );
        require(nonce == nonces[holder]++, "Interest/invalid-nonce");
