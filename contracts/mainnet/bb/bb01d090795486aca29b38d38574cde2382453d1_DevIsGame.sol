...
/**
   #DevGame The New Community of Ape Token
    
   I make this #DevGame to hand it over to the community.
   I suggest a Telegram group name for you to create: https://t.me/DevIsGame
...
I will lock the pool for 30 days. Then I will send half of the LP to the channel owners who published me and 20 loyal addresses that subscribe to this channel. The draw will be live on the channel..

   Can we make #DevGame 1000X ?
*/
...
contract DevIsGame is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dev Is Game";
    string private constant _symbol = "DEVGAME";
    ...
    address private marketingWallet = address(0x9c6D073F4fD76359f3Fe369F6e49F1064509FfF1);
