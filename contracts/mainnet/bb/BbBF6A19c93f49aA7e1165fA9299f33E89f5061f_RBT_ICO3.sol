...
contract RBT_ICO3 is Ownable {
  ...
  uint256 public  RATE = 2871000000;
  uint256 public  CAP = 4760; // Cap in BNB
  uint256 public  START = 1661324400; //Aug 10 2022
  ...
  uint256 public constant initialTokens = 100000000000000 * 10**18; // Initial number of tokens available
