...
contract CloseUpFaces is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_HATCHIES = 10001; // 1 extra above current supply of 5092
    bool public hasSaleStarted = false;
    
    string public METADATA_PROVENANCE_HASH = "";
    
    constructor() ERC721("CloseUpFaces","CUF")  {
        setBaseURI("https://closeupfaces.com/api/token/"); // https://closeupfaces.com/api/token/
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply >= 9500) { // < 100%
            return 100000000000000000;
        } else if (currentSupply >= 8500) { // < 95%
            return 50000000000000000;
        } else if (currentSupply >= 7500) { // < 85%
            return 40000000000000000;
        } else if (currentSupply >= 5000) { // < 75%
            return 30000000000000000;
        } else if (currentSupply >= 2500) { // < 50%
            return 20000000000000000;
        } else if (currentSupply >= 1000) { // < 25%
   ...
   function claim(uint256 maxHatchies) public payable {
        require(totalSupply() < MAX_HATCHIES, "Sale has already ended");
