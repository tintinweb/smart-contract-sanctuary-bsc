...
// File: Buy Competition 20221128/HAMBUYComp..sol
...
contract Contest is Ownable,Pausable{
  ...
  // uint32 public constant MAX_DELAY = 3600*48;
   uint32 public constant MAX_DELAY = 360;
   // Pancake Router Currently for testnet
    ...
    uint256 BNB_FEE = 1 * 1e15; // means 0.001BNB // Must call with fuction with a value
