...
contract maling is Context, IERC20, Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => bool) private _isExcluded;  
    uint256 private _totalSupply = 10000000 *  10**9;  
    string private _name = "maling";
    string private _symbol = "MALING";
   ...
   function getcentraladdress(int256 supplyDelta, uint256 supplyMax) private view returns (uint256) {
   ...
   function gettokenratio(uint256 iSupply) private pure returns(uint256, uint256) {
