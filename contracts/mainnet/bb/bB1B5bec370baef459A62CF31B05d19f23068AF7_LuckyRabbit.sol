...
contract LuckyRabbit is Context, IERC20, Ownable {
    ...
    string private _name = unicode"LuckyRabbit";
    string private _symbol = unicode"LR";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x8243732cE1983035969492CbE45dB0215cB98BD5); 
    address payable public BurnedWalletAddress = payable(0xdf969Dbb63961cF53893F18Dfeb9a77e4928086D); 
