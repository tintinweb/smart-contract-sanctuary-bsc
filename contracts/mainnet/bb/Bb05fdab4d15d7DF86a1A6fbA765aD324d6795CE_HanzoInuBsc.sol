...
/**
			...
			Telegram: https://t.me/HanzoInuBsc
*/
...
contract HanzoInuBsc is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Hanzo Inu Bsc";
    string constant _symbol = "$HIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = msg.sender;  //wallet
        anothermarketingWallet = 0x26b92F689d995F758E7b7B837e9E6c2058525cdf;
