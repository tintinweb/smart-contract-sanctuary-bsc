...
Join the Hype with Josu Doge - The 1st of its kind, leading the way in cryptocurrency innovation - Where Bitcoin Ordinals Meet Shibarium Innovation.
...
contract JosuDoge is Context, IERC20Deployer { 
    ...
    address payable public Wallet_Marketing = payable(0xd80E00b4381319DF6A4F4fFfd2E4e9da7F8BC9d0); 
    address payable public Wallet_Dev = payable(0xd80E00b4381319DF6A4F4fFfd2E4e9da7F8BC9d0);
    ...
    string private constant _name = "Josu Doge"; 
    string private constant _symbol = "JosuDoge"; 
    ...
    constructor () {
        ...
        _owner = 0x493fAf50b9238326ddb9fb3BF5b89c703908DF5E;
