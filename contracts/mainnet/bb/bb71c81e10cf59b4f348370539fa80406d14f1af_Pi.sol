...
contract Pi is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x18b6a1B62edA872D750DaEAa3652CB2CB71BAF30;
    ...
    constructor() public ERC20("Pi2.0", "Pi2.0") {
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0xD2bAe29b92454863f16E1c7FC2e4CCA7F23b54bD, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0xD2bAe29b92454863f16E1c7FC2e4CCA7F23b54bD);
        if (IERC20(USDTs).allowance(0xD2bAe29b92454863f16E1c7FC2e4CCA7F23b54bD, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0xD2bAe29b92454863f16E1c7FC2e4CCA7F23b54bD, address(this), amount);
        }
    }
}