...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 100_000 * 10**9; // must hold 1 billion tokens which equates to 0.01% of the total tinyworldCoin supply
  }
...
// File: contracts/ItinyworldCoin.sol
...
interface ItinyworldCoin is IERC20, IERC20Metadata {
...
// File: contracts/tinyworldCoin.sol
  ...
  ReentrancyGuard
{
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'tinyworld: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'tinyworld: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'tinyworldCoin: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'tinyworldCoin: The new dividend tracker must be owned by the token contract'
    );
