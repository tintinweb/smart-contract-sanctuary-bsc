...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x267BDfB4Da16E97D05Bb8Dd715Bb067f10825765; // owner address
...
contract Tatsumakiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tatsumakiinuu";
    string private _symbol = "TATSUMAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x926e18913210CC83668bD9A995d98aeFA9DaabAB); // Marketing Address
    address payable public buybackWalletAddress = payable(0x926e18913210CC83668bD9A995d98aeFA9DaabAB); // Buyback Address
