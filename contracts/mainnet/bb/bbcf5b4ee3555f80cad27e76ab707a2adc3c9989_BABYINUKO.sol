...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCbf99F1159aD3EE908275dc8cd3aA7E257F62E8F;
...
contract BABYINUKO is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xCbf99F1159aD3EE908275dc8cd3aA7E257F62E8F);
    ...
    */
    ...
    string private _symbol = "BABYINUKO";  
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= 99, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
