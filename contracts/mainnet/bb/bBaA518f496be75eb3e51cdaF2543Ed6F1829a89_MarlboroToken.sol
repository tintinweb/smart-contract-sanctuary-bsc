...
contract MarlboroToken is Context, IERC20, Ownable {
    ...
    address payable public _W3MarlboroMarketing =
    ...
    constructor() {
        ...
        _isExcludedFromFee[_W3MarlboroMarketing] = true;
    ...
    function updateMarketingWallet(address payable newAddress)
        ...
        onlyOwner
    {
        _W3MarlboroMarketing = newAddress;
    }
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_W3MarlboroMarketing] = _rOwned[_W3MarlboroMarketing].add(rMarketing);
        if (_isExcluded[_W3MarlboroMarketing])
            _tOwned[_W3MarlboroMarketing] = _tOwned[_W3MarlboroMarketing].add(
                tMarketing
            );
    }
