...
contract RIP_TAKEOFF {
    ...
    constructor() {
        name = "RIP Takeoff"; // Sets the name of the token, i.e Ether
        symbol = "RTO"; // Sets the symbol of the token, i.e ETH
        decimals = 18;
        uint256 _initialSupply = 14922720000000000000000000; // Holds an initial supply of coins
