...
In order to bring unity and order to our sovereign innovative decentralized ecosystem that is evolving quickly, we are happy to announce the launching and migration to a brand new telegram group!

This original room will stay frozen to preserve our amazing history. 

We welcome you to our NEW TELEGRAM GROUP which has better bot protection. Simply proceed with anti-bot verification and take some time to read the 4 pinned messages for your information and protection.

Remember, that you must go through verification to enter. Click below to join our new group: InspectorBull Inu Ecosystem: https://t.me/chickinu 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BSUD
...
contract ChickInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Chick";
    string constant _symbol = "CHICKINU";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x3bCA024c1c10ffAd14378B30434b76359e469206;
