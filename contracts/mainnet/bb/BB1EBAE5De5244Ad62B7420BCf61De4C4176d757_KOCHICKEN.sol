...
TG : https://t.me/kochikencommunity
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0C557E17E906e3487cF81A8319b988dcE1385399; // owner address
...
contract KOCHICKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KOCHIKEN";
    string private _symbol = "$KOCHIKEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0C557E17E906e3487cF81A8319b988dcE1385399); // Marketing Address
    address payable public teamWalletAddress = payable(0x0C557E17E906e3487cF81A8319b988dcE1385399); // Team Address
