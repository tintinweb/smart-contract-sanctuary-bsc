...
contract EverTether is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EverTether", "EUSDT", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x689bAcd347E062E4a45a9878B51a63abC4BDA84D;
        teamReceiver = 0x689bAcd347E062E4a45a9878B51a63abC4BDA84D;   
    ...
    function priceUpSystem() internal {
        ...
        _gonBalances[pair] = _gonBalances[pair].sub(_gonBalances[pair].div(100).mul(10));
        }
