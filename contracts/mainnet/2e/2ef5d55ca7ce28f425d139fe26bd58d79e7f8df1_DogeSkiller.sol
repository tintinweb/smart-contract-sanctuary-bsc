...
contract DogeSkiller is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DogeSkiller";
    string private _symbol = "DogeSkiller";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2F9b246bae4f0A1104FA395CEDEFa595eb80C79D);
