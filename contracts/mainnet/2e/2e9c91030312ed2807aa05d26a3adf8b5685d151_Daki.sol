...
contract Daki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Daki Inu";
    string private _symbol = "DAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7DEB2aEe380628BED40B3653b6aDe50dafD8BCC2); 
    address payable public buyBackWalletAddress = payable(0x7DEB2aEe380628BED40B3653b6aDe50dafD8BCC2); 
