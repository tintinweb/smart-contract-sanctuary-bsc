...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setPinkAntiBot(address addr) external onlyOwner {
        pinkAntiBot =  IPinkAntiBot(addr);
    }
...
contract dazaxie is AbsToken {
    constructor() AbsToken(
        ...
        6,
        1000,
        address(0x5aFFa2e469c3e95839800CCa0f556068eAaA7745),
        address(0x0f894E5A6b1a236F1a32B952F48501C8F93cC474),
