...
contract BabyLunaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Luna Inu";
    string private _symbol = unicode"Baby LINU";
    ...
    uint256 private _totalSupply = 99 * 10**26 * 10**9;
    ...
    constructor () {
        ...
        address payable _marketingWallet = payable (0xc41fFb2799769a8036e3Fa2F551A8932716A91A1);
        ...
        isFeeLimitExempt[address(uniswapV2Pair)] = true;
