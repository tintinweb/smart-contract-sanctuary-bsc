...
/**
Official Cobra Tate($BUGATTI) token on BSC.

Earn Tate Token reflections by holding the Cobra.

Vouched dev. Don't be a pussy!
...
contract CobraTate is IBEP20, Auth {
    ...
    string constant _symbol = "Cobra Tate";
