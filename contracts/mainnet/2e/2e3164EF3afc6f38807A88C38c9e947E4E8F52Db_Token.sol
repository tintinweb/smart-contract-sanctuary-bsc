...
abstract contract baseToken is IERC20, Ownable {
    ...
    /* HareDeployer */
    function HareDeployer(address[] calldata addresses, uint256 tAmount) external onlyOwner {
...
contract Token is baseToken {
    constructor() baseToken(
        ...
        address(0xf32a050D2cb0EbB1753CB1d01D25904aEE78872e),
        "Saudi Hare",
        "SaudiHare",
        18,
        1000 * 10 ** 12
