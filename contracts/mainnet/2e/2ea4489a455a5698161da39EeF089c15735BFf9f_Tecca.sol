...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    symbol = "TCC"; //Изменяем на буквенное сокращенное название токена (пример - BTC)
    name = "Tecca"; //Изменяем на буквенное название токена (пример - Bitcoin)
...
contract Tecca is TokenBEP20 { //Изменяем слово "Name" на название своего токена
