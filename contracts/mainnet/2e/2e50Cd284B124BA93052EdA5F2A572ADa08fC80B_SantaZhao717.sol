...
contract SantaZhao717 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Santa Zhao 717"; // 
    string private constant _symbol = unicode"ZHAO717"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x203c5f1526a9D88Ea1bDc5563a1F6Bb6a33B515c;
