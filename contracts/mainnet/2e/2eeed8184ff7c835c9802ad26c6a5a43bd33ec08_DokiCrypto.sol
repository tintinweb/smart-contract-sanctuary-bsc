...
contract DokiCrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doki Crypto";
    string private _symbol = "DCR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8f9C454A6E06fdf8333449cCaa0f6C8915952f70);
    address payable public teamWalletAddress = payable(0x8f9C454A6E06fdf8333449cCaa0f6C8915952f70);
