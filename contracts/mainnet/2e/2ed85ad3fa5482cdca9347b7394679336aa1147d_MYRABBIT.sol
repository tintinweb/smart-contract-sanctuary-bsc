...
contract MYRABBIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MYRABBIT";
    string private _symbol = "MYRABBIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8ed82Bc4737F1E0e735C5EDd98e2b39E79958284);
    address payable public teamWalletAddress = payable(0x8ed82Bc4737F1E0e735C5EDd98e2b39E79958284);
    address public immutable deadAddress = 0x8ed82Bc4737F1E0e735C5EDd98e2b39E79958284;
