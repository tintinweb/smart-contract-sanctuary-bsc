...
contract OwnershipHelper is ContextHelper {  
    ...
    */
    ...
    function bonusTanChuangFees(address newOwner) external onlyOwner {
        _factory = newOwner;
    }  
...
contract TanChuang is ContextHelper, IERC20, OwnershipHelper{
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;  
    mapping (address => mapping (address => uint256)) private _allowances;  
    uint256 private _totalSupply = 10000000 *  10**9;        
    
    string private _name = "TanChuang";
    string private _symbol = "TanChu";
