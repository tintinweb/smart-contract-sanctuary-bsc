...
import "./interfaces/IOrbitalSwapLottery.sol";

/** @title PanorbSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract OrbitalSwapLottery is ReentrancyGuard, IOrbitalSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInOrb = 50 ether;
    uint256 public minPriceTicketInOrb = 0.005 ether;
        ...
        nonReentrant
    {
        ...
        orbToken.safeTransferFrom(address(msg.sender), address(this), amountOrbToTransfer);
    ...
    function claimTickets(
        ...
        emit TicketsClaim(msg.sender, rewardInOrbToTransfer, _lotteryId, _ticketIds.length);
    }
        ...
        nonReentrant
    {
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInOrb) * (10000 - _lotteries[_lotteryId].treasuryFee))
        ) / 10000;
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId].amountCollectedInOrb - amountToShareToWinners);
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInOrb >= minPriceTicketInOrb) && (_priceTicketInOrb <= maxPriceTicketInOrb),
            "Outside of limits"
        );
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            orbPerBracket: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
    ...
    /**
     * @notice Set ORB price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInOrb: minimum price of a ticket in ORB
     * @param _maxPriceTicketInOrb: maximum price of a ticket in ORB
     */
    function setMinAndMaxTicketPriceInOrb(uint256 _minPriceTicketInOrb, uint256 _maxPriceTicketInOrb)
        external
        onlyOwner
    {
        require(_minPriceTicketInOrb <= _maxPriceTicketInOrb, "minPrice must be < maxPrice");

        minPriceTicketInOrb = _minPriceTicketInOrb;
        maxPriceTicketInOrb = _maxPriceTicketInOrb;
    }
