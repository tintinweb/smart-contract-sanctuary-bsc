...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc5A83f2642a40035F510A52D661B94F5658366aB; // owner address
...
contract TWENTY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "20$ TO A MILLION";
    string private _symbol = "$20";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xc5A83f2642a40035F510A52D661B94F5658366aB); 
    address payable public teamWalletAddress = payable(0xc5A83f2642a40035F510A52D661B94F5658366aB);
