...
"Too Many Zeros" was established and created 
to mock the crypto currency market, and the 
infatuation with buying crypto with too many 
zeros after the decimal. There seems to be an 
obsession with finding a coin with a "utility, 
NFTs, play to earn, Metaverse adaptation." We at 
team TMZ decided to finally put you out of your 
misery by offering you a token that is upfront 
and honest by not offering you anything more 
than an open market to trade this shit with 
TOO MANY ZEROS!
...
contract twomanyzero is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 690000000000000000000 * 10**9;
    uint256 public maxBuyLimit = 690000000000000000000 * 10**9;
    uint256 public maxSellLimit = 690000000000000000000 * 10**9;
    uint256 public maxWalletLimit = 690000000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x147B56EABCa15CC1ba802a053EC7Ffb8eE5eCDB5;
    address public devWallet = 0x0f021E87E1Cf5DF92ccC3BfFEadDb350ed5EB364;
    address public buybackWallet = 0x6d0242b90c7200657B007505cFC8979C3626065c;

    string private constant _name = "TMZ";
    ...
    Taxes public taxes = Taxes(1, 4, 3, 0, 2);
    Taxes public sellTaxes = Taxes(1, 5, 4, 0, 2);
