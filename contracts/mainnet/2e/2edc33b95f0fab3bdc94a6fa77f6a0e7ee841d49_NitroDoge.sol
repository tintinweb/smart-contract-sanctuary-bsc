...
/* Token contract */
contract NitroDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x75b15E44d2BB02DcBe70321948443Be89dc96166;
    ...
    // Name and symbol
    string constant _name = "Nitro Doge";
    string constant _symbol = "NITRODOGE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 5000 / 10000; // 5 %
    uint256 public _maxSellTxAmount = _totalSupply * 3000 / 10000; // 3 %
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 10000; // 5 %
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external authorized {
        _maxBuyTxAmount = _totalSupply.mul(maxBuyTxPercent).div(1000000);
    }

    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external authorized {
        _maxSellTxAmount = _totalSupply.mul(maxSellTxPercent).div(1000000);
    }
