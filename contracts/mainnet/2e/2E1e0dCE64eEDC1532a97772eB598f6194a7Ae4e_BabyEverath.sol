...
// Telegram: https://t.me/officialbabyeverath
...
contract BabyEverath is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Cat Katana";
   string constant _symbol = "Catana";
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x1274488972089ACEf410a573B5d94268f415229d; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x1274488972089ACEf410a573B5d94268f415229d; //Can be change to any wallet you want
