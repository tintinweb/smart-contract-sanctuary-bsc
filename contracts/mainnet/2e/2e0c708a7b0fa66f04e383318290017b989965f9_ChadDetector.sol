...
contract ChadDetector is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Chad Detector';
    ...
    //DevWallets
    address public Development=payable(0x263D9F0c05F2d0784911cf7119E0357e229F89cd);
    address public Marketing=payable(0x39756fC5ed21cfAf5fd410ed7786C262dDc5742f);
    //MainNet
	...
	uint256 private MaxBuy = 15000 * 10**_decimals;
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //CAKE Rewards
