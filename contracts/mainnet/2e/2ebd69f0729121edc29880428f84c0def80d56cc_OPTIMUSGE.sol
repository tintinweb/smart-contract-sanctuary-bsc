...
/*
    ...
    📣📣 Big MeMe& Massive #OPTIMUSGE 🔥🔥

Optimus Doge, A cryptocurrency project created to support and honor Doge's friends, Elon Musk, and Optimus. Optimusge is being developed by Optimus. with a plan to change the way we live and work forever. Our project is designed to pay tribute to the Optimus Bot with our own blockchain and AI innovation.
        https://t.me/Optimusge
https://optimusge.gitbook.io/optimusge/
...
contract OPTIMUSGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "OPTIMUSGE";
    string private _symbol = "OGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x78D15F4cD1d742A0490BDE22630b85bfC5e33959);
