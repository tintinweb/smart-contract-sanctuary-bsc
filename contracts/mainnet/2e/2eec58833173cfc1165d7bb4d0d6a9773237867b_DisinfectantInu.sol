...
*/
/**
Sunlight is the best disinfectant - Elon Tweet

 Launching very soon. it can be moonshot! 
 Do you miss for ElonaCoin, BerlinRocks, etc..? so, dont missed for the new one!
*/

// telegram : https://t.me/DisinfectantInu
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xF25182973903C7B440D433DC583964b734445C23);
...
contract DisinfectantInu is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REWARDS = 0xF25182973903C7B440D433DC583964b734445C23; 
    ...
    address _marketingAdr = 0x0cf34B1730786EA3416C1045B8A976021378585f;
 
    string constant _name = "Disinfectant Inu";
    string constant _symbol = "$DINU";
