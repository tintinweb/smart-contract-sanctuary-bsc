...
/**
 * MR BIT PULL GEMS PRESENT PIGE INU 0.5 HALF
 T.ME/PIGEINUHALF // TWITTER.COM/PIGEINUHALF 
 5% TAXES
 3% PIGE INU $PINU REWARDS
*/
...
contract PigeInuhalf is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0x0fF023abF3583526EdAB19392f807414e5e87F36);
        marketingFeeReceiver = address(0xBcD42B4d2A76252fDd31c0153a51025275dCac04);
