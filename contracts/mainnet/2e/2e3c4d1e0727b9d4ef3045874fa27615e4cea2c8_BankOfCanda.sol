...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe28E413587E984876c8FDA1bfb7dfd149c1D40aa;
...
contract BankOfCanda is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x95E6192C32f2B99F1b94F90F74150d0e8a350682;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BankOfCanda";
    string private _symbol = "CAD$";
