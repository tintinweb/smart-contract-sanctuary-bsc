...
contract MICHUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MICHUINU";
    string private _symbol = "MINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8e4d1493694961cEDB21984A2028Ad5c7961cdb0); 
    address payable public teamWalletAddress = payable(0xbC49F69a5cB2cd95D7041483B56D03b414268687); 
