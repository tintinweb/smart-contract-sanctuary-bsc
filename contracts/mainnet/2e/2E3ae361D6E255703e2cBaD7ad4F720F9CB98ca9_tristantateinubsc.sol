...
/*
*
*  Official Tristan Tate Inu contract
*  Fees: 9% buy/sell
*  TG: https://t.me/tristantateinubsc
*
*  #2K22 MOONSHOT
*
*/
...
contract tristantateinubsc is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "TristanTateINU";
    ...
    address public burnAddress = 0x67a7B2dD01cF249279B3A6821D5E51fca113D0de;
    address payable private _marketingWallet = payable(0x67a7B2dD01cF249279B3A6821D5E51fca113D0de);
    address payable private _devWallet = payable(0x67a7B2dD01cF249279B3A6821D5E51fca113D0de);
