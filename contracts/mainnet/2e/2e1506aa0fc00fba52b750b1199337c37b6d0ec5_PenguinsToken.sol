...
contract BEP20 is Context, IBEP20, Ownable {
    uint256 private constant _preMineSupply = 13500000 * 1e18;
    uint256 private constant _maxSupply = 2000000000 * 1e18; 
...
// Penguins token with Governance.
contract PenguinsToken is BEP20('Penguins Finance', 'PNG') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying PNGs (not scaled);
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "PNG: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "PNG: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "PNG: index out of bounds");
