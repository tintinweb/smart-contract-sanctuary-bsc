...
contract FUD_Protocol is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "FUD Protocol";
    ...
    address payable private DevWallet = payable(0xDAEa68CC8bD1A85B82A6B15E2039eFe40cccCE3f);
    address payable private MarketingWallet = payable(0xD0a70ED0eCF2e1ac037DB862eFFe33336a8Ad2Bd);
