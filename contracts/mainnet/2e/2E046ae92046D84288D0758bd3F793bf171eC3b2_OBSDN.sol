...
// TOKEN: OBSIDIAN NETWORK
// Web: https://www.0bsidian.newtork
// Swap: https://www.osbdnet.app (or via main web site)
// Farm:  https://www.osbdnet.farm (or via main web site)
...
contract OBSDN is ERC20, Ownable {
    ...
    uint256 private gasPriceLimit = 80 * 1 gwei; // do not allow over x gwei for launch
    
     // Anti-bot and anti-whale mappings and variables
    mapping(address => uint256) private _holderLastTransferTimestamp; // to hold last Transfers temporarily during launch
    bool public transferDelayEnabled = true;
    uint256 public tradingActiveBlock = 3;
    ...
    constructor() ERC20("Obsidian Network", "OBSDN", 18) {
    	...
    	marketingWallet = address(0xD67e8440832cCDAE0450b799735Eb3b95318DF55); // set as marketing wallet
    	liquidityWallet = address(0xB71A9f43b33637dB4b680a4E7455b43eEd914FB4); // set as liquidity wallet
        stakingAddress = address(0xf03f1E5bBa117d2eD1C3d909F0C4f7C35722aD61); // set as staking wallet / contract
        jumpStartWallet = address(0xCff53D52B940314340F101a4a1Bb7157928fC6Cd); // set as Jump Start wallet
        utilityWallet = address(0xEff06E74d3330995c889904f6086cFCB481fDa37); // set as utility wallet
