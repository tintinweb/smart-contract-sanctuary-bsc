...
contract PepeGrow is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   PepeGrowDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("PepeGrow", "PepeGrow") {
        ...
        marketingWallet = payable(0x54D7fa98C86b388Ef781f319e5C9Acfe9034546E);
        _devWallet = payable(0xa9917792B2845ab368a0CEF2e11DFB44633A666F);
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "PepeGrow: The router already has that address");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "PepeGrow: Account is already the value of 'blacklisted'");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PepeGrows: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "PepeGrow: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "PepeGrow: The marketing wallet is already this address");
...
contract PepeGrowDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("PepeGrow_Dividend_Tracker", "PepeGrow_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "PepeGrow_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
